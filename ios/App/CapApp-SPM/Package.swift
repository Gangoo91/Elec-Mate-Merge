...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "RevenuecatPurchasesCapacitorUi", path: "../../../node_modules/.deno/@revenuecat+purchases-capacitor-ui@12.3.2/node_modules/@revenuecat/purchases-capacitor-ui")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
