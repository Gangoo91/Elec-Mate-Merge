...
const ESSENTIAL_TOOL_NAMES = [
  ...
  'get_overdue_jobs',
  'get_jobs_starting_soon',
  'search_jobs',
  'create_job',
  'update_job_status',
  'update_job_progress',
  'assign_worker_to_job',
  'remove_worker_from_job',
  'archive_job',
  'get_job_photos',
  'get_job_documents',
  'get_job_timeline',
  ...
  // Client (6)
  'get_client_portal_status',
  'send_client_portal_invite',
  'send_job_update_to_client',
  'share_photos_with_client',
  ...
  // AI Quote Helpers (3)
  'get_quote_suggestions',
  'generate_quote_from_description',
  'generate_tender_estimate',
];
