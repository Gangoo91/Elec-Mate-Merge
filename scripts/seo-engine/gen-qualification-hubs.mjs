...
const QUAL_META = {
  ...
  '601/7345/2': { display: 'EAL Level 3 Electrotechnical Qualification', body: 'EAL Level 3 Electrotechnical Qualification (601/7345/2) — knowledge and performance units', level: 'Level 3', awarding: 'EAL', regulated: 'Ofqual', who: 'apprentices and adult learners on the EAL electrotechnical pathway (the EAL alternative to C&G routes)', endPoint: 'Knowledge assessments plus workplace performance evidence; AM2 where applicable', duration: '2-4 years depending on route', leadsTo: 'JIB Approved Electrician + ECS Gold Card eligibility', funding: 'Apprenticeship-funded on the apprenticeship route; otherwise employer- or self-funded — check current funding with your training provider', slug: 'eal-electrotechnical-qualification' },
  '610/1335/3': { display: 'EAL Level 3 Electrotechnical in Dwellings', body: 'EAL Level 3 Electrotechnical Qualification in Dwellings (610/1335/3) — the EAL dwellings pathway', level: 'Level 3', awarding: 'EAL', regulated: 'Ofqual', who: 'learners working primarily on electrical installations in domestic dwellings (the EAL equivalent of the C&G 5393-03 dwellings pathway)', endPoint: 'Knowledge assessments plus workplace performance evidence in dwellings', duration: '2-4 years depending on route', leadsTo: 'Domestic electrician roles and scheme membership eligibility', funding: 'Check current funding with your training provider', slug: 'eal-level-3-dwellings' },
};
