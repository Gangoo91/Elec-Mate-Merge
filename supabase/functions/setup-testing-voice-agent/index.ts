...
const TESTING_TOOLS = [
  {
    ...
    parameters: [
      ...
      { name: 'circuit_type', type: 'string', required: false, description: 'Type of circuit when adding', enumValues: ['lighting', 'ring', 'radial', 'cooker', 'shower', 'immersion', 'smoke_alarm', 'ev_charger', 'boiler', 'socket', 'spur', 'other'] },
      ...
      { name: 'value', type: 'string', required: false, description: 'Value to set. For polarity use "correct" or "incorrect". For cable sizes use "1.5mm", "2.5mm", "4.0mm", "6.0mm", "10mm". For test values use numbers like "0.45" for Zs or "200" for insulation.' },
  ...
  },
  {
    ...
    parameters: [
      { name: 'field', type: 'string', required: true, description: 'Field name to update on all circuits', enumValues: ALL_FIELD_NAMES },
      { name: 'value', type: 'string', required: true, description: 'Value to set on all circuits. For polarity: "correct". For cable sizes: "1.5mm", "2.5mm", "4.0mm", "6.0mm", "10mm". For insulation voltage: "500". For test button: "pass".' },
