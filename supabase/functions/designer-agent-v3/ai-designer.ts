...
export class AIDesigner {
  ...
  private buildSystemPrompt(
    ...
    parts.push('40A=0.55Ω, 50A=0.44Ω, 63A=0.35Ω, 80A=0.27Ω, 100A=0.22Ω, 125A=0.17Ω');
    parts.push('');
    parts.push('⚠️ CRITICAL: Only Type D has 5s values. Types B and C use 0.4s ONLY (final circuits).');
    parts.push('');
    ...
    parts.push('');
    parts.push('📊 BS88 FUSE STANDARD RATINGS: 6, 10, 16, 20, 25, 32, 40, 50, 63, 80, 100, 125, 160, 200, 250A');
    parts.push('');
