...
export class AIDesigner {
  ...
  private buildSystemPrompt(
    ...
    parts.push('');
    parts.push('=== COMMERCIAL CONTAINMENT SELECTION (DETAILED) ===');
    ...
    parts.push('');
    parts.push('🔧 OFFICE AREAS (general distribution):');
    parts.push('  • Cost-effective: PVC trunking for surface-mounted runs');
    parts.push('  • High-traffic: Steel trunking for corridors and busy areas');
    parts.push('  • Ceiling voids: Perforated cable tray or cable basket');
    parts.push('  • Floor distribution: Dado trunking for power and data');
    parts.push('');
