        ...
        try {
          ...
          if (updateError) {
            ...
            if (isUnicodeError(updateError)) {
              ...
              if (retryError) {
                logger.error('❌ Retry failed - marking job as failed', {
          ...
          const installationAgentTask = supabase.functions
            .invoke('design-installation-agent', {
              body: {
                jobId,
          ...
          setTimeout(async () => {
            try {
              ...
              if (
                ...
                currentJob?.installation_agent_status !== 'complete'
              ) {
          ...
          if (jobId) {
            try {
              ...
              logger.error('Failed to mark job complete after installer failure', {
                error: markErr,
              });
            }
          }
