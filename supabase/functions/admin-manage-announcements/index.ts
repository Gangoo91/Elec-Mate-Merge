  ...
  try {
    ...
    switch (action) {
      ...
      case 'update': {
        ...
        if (announcement.target_roles !== undefined)
          updateData.target_roles = announcement.target_roles;
    ...
    await captureException(error, { functionName: 'admin-manage-announcements', requestUrl: req.url, requestMethod: req.method });
