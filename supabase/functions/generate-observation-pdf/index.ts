...
serve(async (req) => {
  ...
  try {
    ...
    const html = observationTemplate(record, branding);
    ...
    await captureException(error, { functionName: 'generate-observation-pdf', requestUrl: req.url, requestMethod: req.method });
