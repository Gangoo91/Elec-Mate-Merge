...
serve(async (req) => {
  ...
  try {
    ...
    const html = accidentTemplate(record, branding);
    ...
    await captureException(error, { functionName: 'generate-accident-pdf', requestUrl: req.url, requestMethod: req.method });
