...
Deno.serve(async (req) => {
  ...
  try {
    console.log('[CANCEL-HS] Function started');
    ...
    console.log('[CANCEL-HS] User authenticated:', user.id);
    ...
    console.log('[CANCEL-HS] Cancelling job:', jobId);
    ...
    console.log('[CANCEL-HS] Job cancelled successfully:', jobId);
    ...
    console.error('[CANCEL-HS] ERROR:', errorMessage);
