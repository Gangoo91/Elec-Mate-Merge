...
const TEMPLATE_ID = 'C916A5C0-4626-4CC9-8EE0-9782C40A489A';
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    console.log('[generate-limitation-notice-pdf] Ref:', formData.reference_number);
    ...
    await captureException(error, { functionName: 'generate-limitation-notice-pdf', requestUrl: req.url, requestMethod: req.method });
    console.error('[generate-limitation-notice-pdf] Error:', error);
