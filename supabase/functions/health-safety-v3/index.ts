...
serve(async (req) => {
  ...
  const executionPromise = (async (): Promise<Response> => {
    try {
      ...
      const _oldSystemPrompt = `You are a UK electrical safety expert specialising in BS 7671:2018+A4:2026.

**REGULATION-GROUNDED RISK ASSESSMENT:**
Always ground your risk assessment in BS 7671:2018+A4:2026 requirements:
