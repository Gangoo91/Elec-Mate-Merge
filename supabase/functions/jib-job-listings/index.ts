        ...
        formats: [
          {
            type: 'json',
            prompt:
              'Extract ALL electrical industry job listings visible on the page. These are jobs for qualified electricians, electrical engineers, and electrical apprentices. Include up to 50 jobs if available.',
            schema: {
              title: 'JobListings',
              type: 'object',
              properties: {
