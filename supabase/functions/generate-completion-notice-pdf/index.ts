...
const TEMPLATE_ID = '3DF2CE99-3EC9-4CBB-8C47-969AC8F597E2';
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    console.log('[generate-completion-notice-pdf] Ref:', formData.reference_number);
    console.log('[generate-completion-notice-pdf] Items:', formData.completed_count, '/', formData.total_items);
    ...
    await captureException(error, { functionName: 'generate-completion-notice-pdf', requestUrl: req.url, requestMethod: req.method });
    console.error('[generate-completion-notice-pdf] Error:', error);
