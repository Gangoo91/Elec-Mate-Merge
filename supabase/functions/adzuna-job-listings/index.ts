        ...
        formats: [
          {
            type: 'json',
            prompt:
              'Extract ALL job listings visible on the page. Include up to 50 jobs if available. Capture every job posting with its complete details including salary information.',
            schema: {
              title: 'JobListings',
              type: 'object',
              properties: {
