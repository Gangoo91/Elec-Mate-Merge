...
const TOOLSTATION_CATEGORIES = [
  'https://www.toolstation.com/electrical/cables-cable-accessories/c504',
  'https://www.toolstation.com/electrical/consumer-units-accessories/c507',
];
...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Starting Toolstation scrape...');
    ...
    for (const categoryUrl of TOOLSTATION_CATEGORIES) {
    ...
    console.error('Error scraping Toolstation:', error);
    return new Response(JSON.stringify({ 
