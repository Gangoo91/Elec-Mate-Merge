...
serve(async (req) => {
  ...
  try {
    ...
    const PRICE_TO_TIER: Record<string, string> = {
      ...
      price_1T6DUx2RKw5t5RAmpb177NJV: 'business_ai', // £29.99/month (legacy — existing subs)
      price_1T6DUy2RKw5t5RAmo9HgAukW: 'business_ai_yearly', // £299.99/year (legacy — existing subs)
      // Employer
