...
const CEF_CATEGORIES = [
  'https://www.cef.co.uk/catalogue/products/cables-cable-management',
  'https://www.cef.co.uk/catalogue/products/distribution-protection',
];
...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Starting CEF scrape...');
    ...
    for (const categoryUrl of CEF_CATEGORIES) {
    ...
    console.error('Error scraping CEF:', error);
    return new Response(JSON.stringify({ 
