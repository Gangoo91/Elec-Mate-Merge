...
export const pvEarthingRequirement: PVSystemRequirement = {
  ...
  requirement:
    'Earthing of ONE live conductor of DC side permitted IF simple separation between AC and DC',
...
export const pvDCSafetyWarning: PVSystemRequirement = {
  ...
  requirement:
    'DC side equipment ALWAYS considered energized, even when AC disconnected or inverter off',
...
export const ringFinalCircuitOptions: CircuitDesignOption[] = [
  {
    ...
    loadLimitation:
      'Load current in ANY part of ring should not exceed cable capacity (27A for 2.5mm²) for LONG PERIODS',
    notes: [
