...
export const EARTHING_SYSTEMS: EarthingSystem[] = [
  {
    ...
    earthingConnection:
      'Main earthing terminal connected to earthed point of source via distributor',
...
export const SUPPLEMENTARY_BONDING_REQUIREMENTS: SupplementaryBondingRequirement[] = [
  ...
  },
  {
    ...
    connectsBetween: ['Simultaneous touchable exposed and extraneous-conductive-parts'],
    regulation: '415.2',
...
export const CPC_SIZING_METHODS: CPCSizingMethod[] = [
  {
    ...
    calculation:
      'S = √(I²t) / k  where I=fault current, t=disconnection time, k=factor from Tables 54.2-54.6',
...
export function getEarthingSystem(systemType: string): EarthingSystem | undefined {
  return EARTHING_SYSTEMS.find((s) =>
    s.systemType.toLowerCase().includes(systemType.toLowerCase())
  );
}
