...
export const TEMPERATURE_FACTORS_AIR: Record<number, { pvc70: number; xlpe90: number }> = {
  ...
  30: { pvc70: 1.0, xlpe90: 1.0 }, // Reference temperature
  ...
  60: { pvc70: 0.5, xlpe90: 0.71 },
  65: { pvc70: 0.35, xlpe90: 0.65 },
  70: { pvc70: 0.0, xlpe90: 0.58 },
  75: { pvc70: 0.0, xlpe90: 0.5 },
  80: { pvc70: 0.0, xlpe90: 0.41 },
  85: { pvc70: 0.0, xlpe90: 0.29 },
  90: { pvc70: 0.0, xlpe90: 0.0 },
};
...
export interface GroupingFactorData {
  ...
  arrangementCategory:
    | 'enclosed'
    | 'clipped-direct-touching'
    | 'clipped-direct-spaced'
...
export const GROUPING_FACTORS_ENCLOSED: GroupingFactorData[] = [
  { numberOfCircuits: 1, arrangementCategory: 'enclosed', factor: 1.0 },
  { numberOfCircuits: 2, arrangementCategory: 'enclosed', factor: 0.8 },
  { numberOfCircuits: 3, arrangementCategory: 'enclosed', factor: 0.7 },
  { numberOfCircuits: 4, arrangementCategory: 'enclosed', factor: 0.65 },
  { numberOfCircuits: 5, arrangementCategory: 'enclosed', factor: 0.6 },
  ...
  { numberOfCircuits: 9, arrangementCategory: 'enclosed', factor: 0.5 },
...
export const GROUPING_FACTORS_CLIPPED_TOUCHING: GroupingFactorData[] = [
  { numberOfCircuits: 1, arrangementCategory: 'clipped-direct-touching', factor: 1.0 },
  ...
  { numberOfCircuits: 9, arrangementCategory: 'clipped-direct-touching', factor: 0.7 },
];
...
export function calculateOverallCorrectionFactor(params: {
  ...
  const tempResult = getTemperatureFactor(
    params.ambientTemp,
