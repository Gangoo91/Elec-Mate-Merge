...
serve(async (req) => {
  ...
  try {
    ...
    await captureException(error, { functionName: 'parse-calculations-basic', requestUrl: req.url, requestMethod: req.method });
