...
const fallbackTools = [
  // Testers (8)
  {
    ...
    productUrl:
      'https://uk.rs-online.com/web/c/test-measurement/electrical-testers/installation-testers/?searchTerm=fluke+1653b',
  ...
  },
  {
    ...
    productUrl:
      'https://www.screwfix.com/c/electrical/electrical-test-equipment/cat830007?searchterm=martindale+voltage+indicator',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://cpc.farnell.com/c/test-measurement/electrical-testers-meters?searchTerm=megger+mft1741',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://www.toolstation.com/c/electrical/electrical-test-equipment?searchterm=kewtech+insulation',
  ...
  },
  {
    ...
    productUrl:
      'https://www.screwfix.com/c/electrical/electrical-test-equipment/cat830007?searchterm=socket+tester',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://uk.rs-online.com/web/c/test-measurement/electrical-testers?searchTerm=fluke+t6',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://cpc.farnell.com/c/test-measurement/electrical-testers-meters?searchTerm=seaward+pat',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://uk.rs-online.com/web/c/test-measurement/electrical-testers/installation-testers?searchTerm=metrel',
    stockStatus: 'In Stock',
  ...
  // Hand Tools (8)
  {
    ...
    productUrl:
      'https://www.screwfix.com/c/tools/hand-tools/screwdrivers/cat910043?searchterm=wiha+vde',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://cpc.farnell.com/c/tools-production-supplies/hand-tools/electricians-tools?searchTerm=knipex+wire+stripper',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://www.toolstation.com/c/tools/hand-tools/pliers?searchterm=ck+tools+side+cutters',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://uk.rs-online.com/web/c/tools-production-supplies/hand-tools/electricians-tools?searchTerm=klein+cable+cutters',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://cpc.farnell.com/c/tools-production-supplies/hand-tools/electricians-tools?searchTerm=weidmuller+crimping',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://www.screwfix.com/c/tools/hand-tools/knives-blades/cat910111?searchterm=stanley+fatmax',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://www.toolstation.com/c/electrical/cable-conduit-trunking/conduit-benders?searchterm=conduit+bender',
    stockStatus: 'Low Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://cpc.farnell.com/c/tools-production-supplies/hand-tools?searchTerm=bahco+adjustable+wrench',
    stockStatus: 'In Stock',
  ...
  // Power Tools (8)
  {
    ...
    productUrl:
      'https://www.toolstation.com/c/power-tools/cordless-tools/makita?searchterm=makita+dhr202',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://www.screwfix.com/c/tools/power-tools/dewalt/impact-drivers?searchterm=dewalt+dcd796',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://www.toolstation.com/c/power-tools/angle-grinders/bosch?searchterm=bosch+gws+7',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://cpc.farnell.com/c/tools-production-supplies/power-tools?searchTerm=milwaukee+m18+reciprocating',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://uk.rs-online.com/web/c/tools-production-supplies/power-tools/rotary-hammers?searchTerm=hilti+te+7',
    stockStatus: 'In Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://www.toolstation.com/c/power-tools/multi-tools/festool?searchterm=festool+osc',
    stockStatus: 'Low Stock',
  ...
  },
  {
    ...
    productUrl:
      'https://cpc.farnell.com/c/tools-production-supplies/specialist-tools?searchTerm=greenlee+cable+puller',
  ...
  },
  {
    ...
    productUrl:
      'https://uk.rs-online.com/web/c/tools-production-supplies/power-tools?searchTerm=ridgid+pipe+threader',
    stockStatus: 'In Stock',
...
Stock options: "In Stock", "Low Stock", "Out of Stock"`,
    ...
    const validTools = toolsData
      .filter((tool: any) => tool.name && tool.category && tool.price && tool.supplier)
      .map((tool: any, index: number) => ({
        ...
        productUrl:
          tool.productUrl ||
          `https://www.${tool.supplier.toLowerCase().replace(/\s+/g, '')}.com/search?q=${encodeURIComponent(tool.name)}`,
        stockStatus: tool.stockStatus || 'In Stock',
        highlights: Array.isArray(tool.highlights)
          ? tool.highlights.slice(0, 3)
          : ['Professional grade', 'BS 7671 compliant', 'UK specification'],
      }));
