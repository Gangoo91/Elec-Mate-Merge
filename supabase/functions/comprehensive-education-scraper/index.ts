    ...
    fallback: [
      {
        ...
        courseUrl:
          'https://www.manchester.ac.uk/study/undergraduate/courses/2024/00678/beng-electrical-and-electronic-engineering/',
      },
      {
    ...
    fallback: [
      {
        ...
        courseUrl:
          'https://www.bath.ac.uk/courses/postgraduate-2024/taught-postgraduate-courses/msc-electrical-power-systems/',
      },
      {
        ...
        employmentRate: 94,
        courseUrl:
          'https://www.ed.ac.uk/studying/postgraduate/degrees/index.php?r=site/view&id=866',
      },
      {
  ...
  },
  {
    ...
    fallback: [
      ...
      },
      {
        ...
        courseUrl:
          'https://www.ilm.com/qualifications/leadership-and-management/ilm-qualifications/',
      },
      {
  ...
  },
  {
    ...
    fallback: [
      ...
      },
      {
        ...
        employmentRate: 90,
        courseUrl:
          'https://www.aat.org.uk/qualifications-and-courses/professional-diploma-accounting',
      },
      {
        title: 'Mini MBA',
...
function transformToEducationProgramme(
  raw: any,
  batch: (typeof EDUCATION_BATCHES)[0],
  index: number
): EducationProgramme {
  ...
  return {
    ...
    description:
      raw.description ||
      `${raw.title} - A comprehensive programme for professionals seeking to advance their career in ${batch.category.toLowerCase()}.`,
    ...
    entryRequirements: raw.entryRequirements || [
      'Relevant experience recommended',
      'English language proficiency',
    ],
    keyTopics: raw.keyTopics ||
      raw.topics || ['Core Theory', 'Practical Applications', 'Industry Standards'],
    progressionOptions: raw.progressionOptions || [
      'Career advancement',
      'Higher qualifications',
      'Professional registration',
    ],
    fundingOptions: raw.fundingOptions || [
      'Student Finance',
...
function generateAnalytics(programmes: EducationProgramme[]) {
  const categories = programmes.reduce(
    (acc, p) => {
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (singleBatch && singleBatch >= 1 && singleBatch <= EDUCATION_BATCHES.length) {
      ...
      const programmes = rawProgrammes.map((raw, i) =>
        transformToEducationProgramme(raw, batch, i)
      );
