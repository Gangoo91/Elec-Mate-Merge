...
const TOOLS = [
  {
    ...
    function: {
      ...
      description:
        'Calculate the required cable size based on load, length, and installation method using BS 7671 standards. Returns cable size, derating factors, and voltage drop.',
      parameters: {
        type: 'object',
        properties: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Validate voltage drop compliance for a given cable size and installation. Returns voltage drop percentage and compliance status.',
      parameters: {
        type: 'object',
        properties: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Recommend the appropriate MCB/RCBO rating and type based on load and cable size, ensuring discrimination and compliance with BS 7671 Chapter 43.',
      parameters: {
        type: 'object',
        properties: {
          current: { type: 'number', description: 'Design current in amps' },
          ...
          rcdType: {
            ...
            enum: ['AC', 'A', 'B'],
            description:
              'RCD type if required (AC for resistive loads, A for electronics, B for EV/solar)',
          },
        },
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Apply diversity factors per BS 7671 Appendix A for multiple circuits/loads to determine realistic maximum demand.',
      parameters: {
        type: 'object',
        properties: {
          loads: {
            ...
            items: {
              ...
              properties: {
                type: {
                  type: 'string',
                  description: 'Load type (lighting, sockets, cooker, etc.)',
                },
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Check requirements for special locations (bathrooms, outdoor, etc.) per BS 7671 Part 7. Returns IP ratings, cable types, and protection requirements.',
      parameters: {
        type: 'object',
        properties: {
          location: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Estimate material costs based on cable size, length, and accessories using real UK wholesaler prices.',
      parameters: {
        type: 'object',
        properties: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Design a complete consumer unit with appropriate main switch, RCDs, and circuit breakers based on all circuits.',
      parameters: {
        type: 'object',
        properties: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Add a validated circuit to the current installation design with all calculated parameters.',
      parameters: {
        type: 'object',
        properties: {
          circuitName: {
            type: 'string',
            description: "Circuit identifier (e.g., 'Shower Circuit')",
          },
  ...
  switch (toolName) {
    ...
    case 'estimate_material_costs':
      return {
        cableCost: 85.5,
        deviceCost: 45.0,
        accessoriesCost: 25.0,
        totalMaterials: 155.5,
        estimatedLabour: 280.0,
        totalCost: 435.5,
        breakdown: [
          { item: '6mm² T&E cable (25m)', cost: 85.5 },
          { item: '32A RCBO Type A', cost: 45.0 },
          { item: 'Accessories (isolator, clips, etc.)', cost: 25.0 },
          { item: 'Labour (approx 3.5 hours)', cost: 280.0 },
        ],
      };
