...
const eicCircuitSchema = z.object({
...
const eicDistributionBoardSchema = z.object({
...
const eicObservationSchema = z.object({
  id: z.string().default(''),
...
const eicChecklistItemSchema = z.object({
  id: z.string().default(''),
...
export const eicPayloadSchema = z.object({
  ...
  test_instrument_details: z.object({
