...
const boardWithScheduleSchema = z.object({
...
const additionalBoardSchema = z.object({
...
const inspectionSectionItemSchema = z.object({
  id: z.string().default(''),
  item_number: z.string().default(''),
  item: z.string().default(''),
  clause: z.string().default(''),
...
const circuitPlanningSchema = z.object({
  id: z.string().default(''),
...
export const eicrPayloadSchema = z.object({
  // ── Nested objects ──────────────────────────────────────────────
