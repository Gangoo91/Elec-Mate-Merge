...
const luminaireSummarySchema = z.object({
...
const monthlyTestSchema = z.object({
...
const annualTestSchema = z.object({
  date: z.string().default(''),
...
export const emergencyLightingPayloadSchema = z.object({
  // Nested objects
