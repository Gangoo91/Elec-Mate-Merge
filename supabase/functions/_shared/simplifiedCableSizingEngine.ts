import { getTemperatureFactor, getGroupingFactor } from './bs7671-data/temperatureFactors.ts';
import { getCableCapacity, CableType } from './bs7671-data/cableCapacities.ts';
import { getReferenceMethod } from './bs7671-data/installationMethodFactors.ts';
...
export const calculateSimplifiedCableSize = (
  inputs: SimplifiedCableSizingInputs
): SimplifiedCableSizingResult | null => {
  const {
    current,
    installationType,
    ambientTemp = 30,
