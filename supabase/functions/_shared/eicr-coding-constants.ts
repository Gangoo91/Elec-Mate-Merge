...
export const BPG4_CLASSIFICATION_CODES = {
  C1: {
    ...
    action:
      'The person ordering the work must be advised IMMEDIATELY in writing. The installation or affected part(s) should be isolated until remedial action is taken.',
  ...
  C2: {
    ...
    action:
      'The person ordering the work must be advised as soon as possible in writing. Urgent attention required within 28 days.',
    reportResult: 'UNSATISFACTORY',
    color: 'orange',
    urgency: 'URGENT',
  ...
  C3: {
    ...
    definition:
      'Does not comply with current BS 7671 but not immediately dangerous. Improvement recommended.',
    action:
      'The person ordering the work should be advised that improvements would enhance safety, though not urgent.',
  ...
  FI: {
    ...
    definition:
      'Cannot confirm safety without further investigation. Requires immediate attention.',
    action:
      'Further investigation required without delay to determine if C1, C2, or C3 classification is appropriate.',
    ...
    examples: [
      {
        ...
        visualIndicators: [
          'bare conductors visible',
          'missing accessory covers',
          'damaged enclosures with live parts visible',
        ],
        bpg4Page: 11,
      },
      {
        ...
        visualIndicators: [
          'metal parts showing voltage',
          'visible damage to protective conductor',
          'corrosion or damage to earthing',
        ],
        bpg4Page: 11,
      },
      {
      ...
      },
      {
        ...
        visualIndicators: [
          'missing knockouts in enclosures',
          'broken accessory fronts',
          'exposed terminals',
        ],
        bpg4Page: 12,
      },
  ...
  C2_POTENTIALLY_DANGEROUS: {
    ...
    examples: [
      ...
      },
      {
        ...
        visualIndicators: [
          'test results show excessive Zs',
          'long cable runs',
  ...
  C3_IMPROVEMENT_RECOMMENDED: {
    ...
    examples: [
      ...
      },
      {
        ...
        regulation: '443.4',
        description:
          'Installations from 2019 onwards should have SPD (unless risk assessment shows otherwise)',
    ...
    examples: [
      {
        ...
        regulation: '313.1',
        description:
          'Cannot verify supply parameters (voltage, frequency, prospective fault current)',
...
export const CONTEXT_ESCALATION_RULES = {
  rcdAbsence: {
    ...
    escalations: [
      {
        context: 'bathroom zone 0 or 1',
        escalateTo: 'C1',
        reason: 'Immediate shock risk in wet location',
      },
      {
        context: 'bathroom zone 2',
        escalateTo: 'C2',
        reason: 'Wet location requires RCD protection',
      },
      {
        context: 'outdoor socket',
        escalateTo: 'C2',
        reason: 'Outdoor circuits require RCD per 411.3.3',
      },
      {
        context: 'general indoor socket',
        classification: 'C3',
        reason: 'Improvement recommended per BPG4 page 15',
      },
    ],
  },
  cableSheath: {
    ...
    escalations: [
      {
        context: 'conductors accessible to touch',
        escalateTo: 'C2',
        reason: 'Risk of contact with live parts',
      },
      {
        context: 'conductors not accessible',
        classification: 'C3',
        reason: 'Poor workmanship but not dangerous',
      },
    ],
  },
  bonding: {
    ...
    escalations: [
      {
        context: 'no main protective bonding at all',
        escalateTo: 'C1',
        reason: 'Complete absence creates immediate danger',
      },
      {
        context: 'undersized bonding conductors',
        classification: 'C2',
        reason: 'May not carry fault current',
      },
    ],
  },
};
