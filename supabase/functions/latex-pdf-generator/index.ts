...
\\textbf{Date:} & \\today \\\\
\\textbf{Compliance:} & BS 7671:2018+A4:2026 \\\\
\\end{tabular}
...
serve(async (req) => {
  ...
  try {
    const {
      ...
      watermark = 'BS 7671:2018+A4:2026 Compliant',
    ...
    await captureException(error, { functionName: 'latex-pdf-generator', requestUrl: req.url, requestMethod: req.method });
