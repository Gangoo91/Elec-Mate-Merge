  ...
  try {
    ...
    const payload = {
      ...
      projectMetadata: methodData.projectMetadata || {
        ...
        reviewDate:
          methodData.projectMetadata?.reviewDate ||
          new Date(Date.now() + 90 * 24 * 60 * 60 * 1000).toLocaleDateString('en-GB'),
        companyName: methodData.projectMetadata?.companyName || '',
        contractor: methodData.projectMetadata?.contractor || methodData.contractor || '',
        siteManagerName:
          methodData.projectMetadata?.siteManagerName || methodData.siteManagerName || '',
        siteManagerPhone:
          methodData.projectMetadata?.siteManagerPhone || methodData.siteManagerPhone || '',
        firstAiderName:
          methodData.projectMetadata?.firstAiderName || methodData.firstAiderName || '',
        firstAiderPhone:
          methodData.projectMetadata?.firstAiderPhone || methodData.firstAiderPhone || '',
        safetyOfficerName:
          methodData.projectMetadata?.safetyOfficerName || methodData.safetyOfficerName || '',
        safetyOfficerPhone:
          methodData.projectMetadata?.safetyOfficerPhone || methodData.safetyOfficerPhone || '',
