  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        'ios-title-large': [
          '34px',
          { lineHeight: '41px', letterSpacing: '-0.01em', fontWeight: '700' },
        ],
        'ios-title-1': [
          '28px',
        ...
        'ios-title-3': [
          '20px',
          { lineHeight: '25px', letterSpacing: '-0.01em', fontWeight: '600' },
        ],
        'ios-headline': [
          '17px',
        ...
        'ios-callout': [
          '16px',
          { lineHeight: '21px', letterSpacing: '-0.01em', fontWeight: '400' },
        ],
        'ios-subhead': [
          '15px',
        ...
        'ios-caption-2': [
          '11px',
          { lineHeight: '13px', letterSpacing: '0.01em', fontWeight: '400' },
        ],
      },
      letterSpacing: {
        'ios-tight': '-0.01em',
