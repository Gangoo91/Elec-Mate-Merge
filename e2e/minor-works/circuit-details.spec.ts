...
test.describe('Minor Works - Additional Protection Checkboxes', () => {
  ...
  test('8. RCD checkbox shows RCD fields when checked', async ({ page }) => {
    const rcdCheckbox = page
      .locator('input[type="checkbox"][name*="rcd" i], [role="checkbox"][id*="rcd" i]')
      .first();
    ...
    if (await rcdCheckbox.isVisible({ timeout: 3000 })) {
      ...
      const hasRcdFields = await rcdFields
        .first()
  ...
  test('9. RCBO checkbox shows RCBO fields when checked', async ({ page }) => {
    const rcboCheckbox = page
      .locator('input[type="checkbox"][name*="rcbo" i], [role="checkbox"][id*="rcbo" i]')
      .first();
  ...
  test('10. AFDD checkbox shows AFDD fields when checked', async ({ page }) => {
    const afddCheckbox = page
      .locator('input[type="checkbox"][name*="afdd" i], [role="checkbox"][id*="afdd" i]')
      .first();
  ...
  test('11. SPD checkbox shows SPD fields when checked', async ({ page }) => {
    const spdCheckbox = page
      .locator('input[type="checkbox"][name*="spd" i], [role="checkbox"][id*="spd" i]')
      .first();
