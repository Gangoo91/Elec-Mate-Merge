...
test.describe('Apprentice Hub', () => {
  ...
  test.describe('Main Hub', () => {
    test('apprentice hub page loads', async ({ page }) => {
      ...
      await expect(page.getByText(/apprentice|learning|training|course/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  ...
  test.describe('Toolbox Section', () => {
    test('apprentice toolbox page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/toolbox|tool|guide|resource/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('apprenticeship expectations page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/expectation|year|apprentice/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('portfolio building page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/portfolio|evidence|build/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('communication skills page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/communication|skill|speak/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  ...
  test.describe('On-Job Tools', () => {
    ...
    test('electrical installation guides page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/install|electrical|guide/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('calculations page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/calculat|formula|ohm/i).first()).toBeVisible({ timeout: 10000 });
    });
    ...
    test('workplace culture page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/workplace|culture|team/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('supervisor knowledge page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/supervisor|knowledge|senior/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('flashcards page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/flashcard|card|quiz|learn/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  });
  ...
  test.describe('Calculators', () => {
    test('calculators page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/calculat|formula|tool/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  });
  ...
  test.describe('Professional Development', () => {
    test('professional development page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/professional|develop|career/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  });
  ...
  test.describe('BS7671 Inspection & Testing', () => {
    test('BS7671 inspection testing page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/BS7671|inspection|test|regulation/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
