...
test.describe('Inspection & Testing', () => {
  ...
  test.describe('Inspection Hub', () => {
    test('inspection testing index page loads', async ({ page }) => {
      ...
      await expect(page.getByText(/inspection|test|certificate|EICR|EIC/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('legacy certificates page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/certificate|legacy|old|previous/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  });
  ...
  test.describe('Certificate Types', () => {
    test('EICR form accessible via query param', async ({ page }) => {
      ...
      await expect(page.getByText(/EICR|condition|report|inspection/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('EIC form accessible via query param', async ({ page }) => {
      ...
      await expect(page.getByText(/EIC|installation|certificate/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('Minor works form accessible via query param', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/minor|work|certificate/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  });
...
test.describe('Upskilling & CPD', () => {
  ...
  test.describe('Upskilling Hub', () => {
    test('upskilling main page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/upskill|CPD|course|training/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  });
...
test.describe('Study Centre', () => {
  ...
  test.describe('Study Centre Hub', () => {
    test('study centre page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/study|course|learn|training/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  });
