...
test.describe('Electrician Hub', () => {
  ...
  test.describe('Main Hub', () => {
    test('electrician hub page loads', async ({ page }) => {
      ...
      await expect(page.getByText(/electrician|hub|tool|workshop/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  });
  ...
  test.describe('Materials & Tools', () => {
    test('materials marketplace page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/material|supplier|price/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  ...
  test.describe('Safety Shares', () => {
    ...
    test('safety resources page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/resource|safety|guide/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  ...
  test.describe('Career Progression', () => {
    test('career progression page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/career|progress|pathway/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  });
  ...
  test.describe('AI Tools / Workshop', () => {
    ...
    test('circuit designer page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/circuit|design|electrical/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('installation specialist page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/install|specialist|guidance/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('health and safety page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/health|safety|RAMS|risk/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('commissioning page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/commission|test|handover/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('project manager page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/project|manage|plan/i).first()).toBeVisible({ timeout: 10000 });
    });
    ...
    test('maintenance page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/maintenance|repair|service/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('method statement page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/method|statement|procedure/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('install planner page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/install|planner|plan|consult/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
