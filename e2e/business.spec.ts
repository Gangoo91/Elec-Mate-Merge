...
test.describe('Business Hub & Tools', () => {
  ...
  test.describe('Business Hub', () => {
    test('business hub page loads', async ({ page }) => {
      ...
      await expect(page.getByText(/business|admin|manage/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  ...
  test.describe('Quote Builder', () => {
    ...
    test('quote builder create page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/quote|create|new|customer/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  ...
  test.describe('Invoice Builder', () => {
    ...
    test('invoice builder create page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/invoice|create|new|customer/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('quote invoice dashboard page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/dashboard|quote|invoice|overview/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  });
  ...
  test.describe('Business Development', () => {
    test('business development page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/business|develop|grow/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('startup guide page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/startup|start|business|new/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('managing apprentices page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/apprentice|employ|hire|train/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('managing electricians page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/electrician|employ|staff|team/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('customer management page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/customer|client|manage/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('business templates page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/template|document|form/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('debt recovery page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/debt|recover|payment|chase/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  });
  ...
  test.describe('Business Calculators', () => {
    test('business calculators hub page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/calculator|tool|business/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('job profitability calculator loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/profit|job|margin/i).first()).toBeVisible({ timeout: 10000 });
    });
    ...
    test('capacity planning tool loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/capacity|plan|schedule/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
    ...
    test('quote variance tracker loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/quote|variance|track/i).first()).toBeVisible({ timeout: 10000 });
    });
    ...
    test('minimum charge calculator loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/minimum|charge|callout/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  ...
  test.describe('Customers Page', () => {
    test('customers list page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/customer|client|contact/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  });
  ...
  test.describe('Certificate Expiry', () => {
    test('certificate expiry page loads', async ({ page }) => {
      ...
      await expect(page.locator('body')).toBeVisible();
      await expect(page.getByText(/certificate|expiry|renew/i).first()).toBeVisible({
        timeout: 10000,
      });
    });
  });
