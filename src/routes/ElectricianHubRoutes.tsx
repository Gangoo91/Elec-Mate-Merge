...
const ElectricianHubRoutes = () => (
  <Routes>
    ...
    />
    <Route
      path="materials/supplier/:supplierSlug"
      element={
        <LazyRoute>
          <SupplierMaterials />
        </LazyRoute>
    ...
    />
    <Route
      path="safety-shares/alerts-enhanced"
      element={
        <LazyRoute>
          <SafetyAlertsEnhanced />
        </LazyRoute>
      }
    />
    <Route
      path="safety-shares/news"
      element={
        <LazyRoute>
          <IndustryNews />
        </LazyRoute>
    ...
    />
    <Route
      path="safety-shares/resources-enhanced"
      element={
        <LazyRoute>
          <SafetyResourcesEnhanced />
        </LazyRoute>
      }
    />
    <Route
      path="safety-shares/lfe"
      element={
        <LazyRoute>
    ...
    />
    <Route
      path="invoice-builder/create"
      element={
        <LazyRoute>
          <InvoiceBuilderCreate />
        </LazyRoute>
      }
    />
    <Route
      path="quote-invoice-dashboard"
      element={
        <LazyRoute>
          <QuoteInvoiceDashboard />
        </LazyRoute>
      }
    />
    ...
    />
    <Route
      path="business-development/startup"
      element={
        <LazyRoute>
          <BusinessStartup />
        </LazyRoute>
    ...
    />
    <Route
      path="business-development/apprentices"
      element={
        <LazyRoute>
          <BusinessApprentices />
        </LazyRoute>
    ...
    />
    <Route
      path="business-development/electricians"
      element={
        <LazyRoute>
          <BusinessElectricians />
        </LazyRoute>
      }
    />
    <Route
      path="business-development/growth"
      element={
        <LazyRoute>
          <BusinessGrowth />
        </LazyRoute>
    ...
    />
    <Route
      path="business-development/customers"
      element={
        <LazyRoute>
          <BusinessCustomers />
        </LazyRoute>
    ...
    />
    <Route
      path="business-development/templates"
      element={
        <LazyRoute>
          <BusinessTemplates />
        </LazyRoute>
    ...
    />
    <Route
      path="business-development/tax-finances"
      element={
        <LazyRoute>
          <TaxFinances />
        </LazyRoute>
    ...
    />
    <Route
      path="business-development/debt-recovery"
      element={
        <LazyRoute>
          <DebtRecovery />
        </LazyRoute>
    ...
    />
    <Route
      path="business-development/tools/job-profitability"
      element={
        <LazyRoute>
          <JobProfitabilityCalculator />
        </LazyRoute>
      }
    />
    <Route
      path="business-development/tools/business-cost"
      element={
        <LazyRoute>
    ...
    />
    <Route
      path="business-development/tools/cash-flow"
      element={
        <LazyRoute>
          <CashFlowPlanner />
        </LazyRoute>
    ...
    />
    <Route
      path="business-development/tools/pricing-strategy"
      element={
        <LazyRoute>
    ...
    />
    <Route
      path="business-development/tools/roi-calculator"
      element={
        <LazyRoute>
    ...
    />
    <Route
      path="business-development/tools/hourly-rate"
      element={
        <LazyRoute>
    ...
    />
    <Route
      path="business-development/tools/capacity-planner"
      element={
        <LazyRoute>
    ...
    />
    <Route
      path="business-development/tools/tax-estimator"
      element={
        <LazyRoute>
          <TaxNIEstimator />
        </LazyRoute>
    ...
    />
    <Route
      path="business-development/tools/break-even"
      element={
        <LazyRoute>
          <BreakEvenCalculator />
        </LazyRoute>
    ...
    />
    <Route
      path="business-development/tools/staff-cost"
      element={
        <LazyRoute>
          <StaffCostCalculator />
        </LazyRoute>
    ...
    />
    <Route
      path="business-development/tools/quote-variance"
      element={
        <LazyRoute>
          <QuoteVarianceTracker />
        </LazyRoute>
      }
    />
    <Route
      path="business-development/tools/minimum-charge"
      element={
        <LazyRoute>
          <MinimumChargeCalculator />
        </LazyRoute>
      }
    />
    <Route
      path="business-development/tools/vat-scheme"
      element={
        <LazyRoute>
          <VATSchemeComparison />
        </LazyRoute>
    ...
    />
    <Route
      path="business-development/tools/cis-drc"
      element={
        <LazyRoute>
          <CISDRCHelper />
        </LazyRoute>
