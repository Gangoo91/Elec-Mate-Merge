...
const BestApprenticeAppPage = lazy(() => import('@/pages/seo/BestApprenticeAppPage'));
const BestCableSizingAppPage = lazy(() => import('@/pages/seo/BestCableSizingAppPage'));
const BestEICRSoftwareUKPage = lazy(() => import('@/pages/seo/BestEICRSoftwareUKPage'));
const BestElectricalTrainingAppPage = lazy(
  () => import('@/pages/seo/BestElectricalTrainingAppPage')
);
const BestQuotingAppPage = lazy(() => import('@/pages/seo/BestQuotingAppPage'));
...
const ElecMateVsEasyEICRPage = lazy(() => import('@/pages/seo/ElecMateVsEasyEICRPage'));
...
const ElectricianAppForAndroidPage = lazy(() => import('@/pages/seo/ElectricianAppForAndroidPage'));
...
/**
 * Returns all SEO page routes as JSX elements.
 * Usage in AppRouter: {getSEORoutes()}
 */
export function getSEORoutes() {
  return (
    <>
      ...
      />
      <Route
        path="/guides/18th-edition-exam-tips"
        element={
          <LazyRoute>
            <EighteenthEditionExamTipsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/2391-exam-tips"
        element={
          <LazyRoute>
            <CityGuilds2391ExamTipsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/agricultural-electrical-installations"
        element={
          <LazyRoute>
            <AgriculturalInstallationsPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/am2-simulator-guide"
        element={
          <LazyRoute>
            <AM2SimulatorGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/appendix-4-tables-bs-7671"
        element={
          <LazyRoute>
            <AppendixFourTablesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/apprentice-assessment-guide"
        element={
          <LazyRoute>
            <ApprenticeAssessmentGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/apprentice-electrician-salary"
        element={
          <LazyRoute>
      ...
      />
      <Route
        path="/guides/apprentice-flashcards-tool"
        element={
          <LazyRoute>
            <ApprenticeFlashcardsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/apprentice-mental-health"
        element={
          <LazyRoute>
            <ApprenticeMentalHealthPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/apprentice-rights-pay-uk"
        element={
          <LazyRoute>
            <ApprenticeRightsPayPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/apprentice-safety-cases"
        element={
          <LazyRoute>
            <ApprenticeSafetyCasesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/apprentice-toolbox-guide"
        element={
          <LazyRoute>
            <ApprenticeToolboxGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/apprentice-workplace-culture"
        element={
          <LazyRoute>
            <ApprenticeWorkplaceCulturePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/arc-flash-protection"
        element={
          <LazyRoute>
            <ArcFlashProtectionPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/become-electrician-no-experience"
        element={
          <LazyRoute>
            <BecomeElectricianNoExperiencePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/best-electrical-books"
        element={
          <LazyRoute>
            <BestElectricalBooksPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/bonding-in-bathroom"
        element={
          <LazyRoute>
            <BondingInBathroomPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/borrowed-neutral-explained"
        element={
          <LazyRoute>
            <BorrowedNeutralPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/bs-5266-emergency-lighting-standard"
        element={
          <LazyRoute>
            <BS5266EmergencyLightingStandardPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/bs-5839-fire-alarm-standard"
        element={
          <LazyRoute>
      ...
      />
      <Route
        path="/guides/bs-7671-18th-edition-guide"
        element={
          <LazyRoute>
            <BS7671EighteenthEditionGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/bs-7671-amendment-3-changes"
        element={
          <LazyRoute>
            <BS7671Amendment3Page />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/bs-7671-amendment-4-2026"
        element={
          <LazyRoute>
            <BS7671Amendment4Page />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/burning-smell-from-socket"
        element={
          <LazyRoute>
            <BurningSmellFromSocketPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/cable-colour-codes-uk"
        element={
          <LazyRoute>
            <CableColourCodesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/calculations-for-apprentices"
        element={
          <LazyRoute>
            <CalculationsForApprenticesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/caravan-park-electrical"
        element={
          <LazyRoute>
            <CaravanParkElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/cdm-2015-electricians"
        element={
          <LazyRoute>
            <CDM2015ElectriciansPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/chapter-44-overvoltage-protection"
        element={
          <LazyRoute>
            <Chapter44OvervoltageProtectionPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/circuit-breaker-keeps-tripping"
        element={
          <LazyRoute>
            <CircuitBreakerTrippingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/cis-for-electricians"
        element={
          <LazyRoute>
            <CISForElectriciansPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/commercial-eicr-guide"
        element={
          <LazyRoute>
            <CommercialEICRGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/commercial-electrician-guide"
        element={
          <LazyRoute>
            <CommercialElectricianGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/commercial-lighting-installation"
        element={
          <LazyRoute>
            <CommercialLightingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/commissioning-electrical-installation"
        element={
          <LazyRoute>
            <CommissioningGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/competent-person-scheme-electrical"
        element={
          <LazyRoute>
            <CompetentPersonSchemePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/construction-site-electrical-safety"
        element={
          <LazyRoute>
            <ConstructionSiteSafetyElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/construction-site-safety"
        element={
          <LazyRoute>
            <ConstructionSiteSafetyPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/construction-site-temporary-supply"
        element={
          <LazyRoute>
            <ConstructionSiteTemporarySupplyPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-upgrade"
        element={
          <LazyRoute>
            <ConsumerUnitUpgradePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-upgrade-cost-guide"
        element={
          <LazyRoute>
            <ConsumerUnitUpgradeCostGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-upgrade-labour-and-materials"
        element={
          <LazyRoute>
            <ConsumerUnitUpgradeLabourAndMaterialsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-upgrade-price-breakdown"
        element={
          <LazyRoute>
            <ConsumerUnitUpgradePriceBreakdownPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/continuity-testing-r1-r2"
        element={
          <LazyRoute>
            <ContinuityTestingR1R2Page />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/contractor-vs-employee-electrician"
        element={
          <LazyRoute>
            <ContractorVsEmployeePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/cooker-circuit-guide"
        element={
          <LazyRoute>
            <CookerCircuitGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/correction-factors-bs-7671"
        element={
          <LazyRoute>
            <CorrectionFactorsGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/cpd-for-electricians"
        element={
          <LazyRoute>
            <CPDForElectriciansPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/data-cabling-installation"
        element={
          <LazyRoute>
            <DataCablingInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/dead-vs-live-testing"
        element={
          <LazyRoute>
            <DeadVsLiveTestingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/debt-recovery-electricians"
        element={
          <LazyRoute>
            <DebtRecoveryElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/digital-vs-paper-certificates"
        element={
          <LazyRoute>
            <DigitalVsPaperCertificatesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/distribution-board-wiring"
        element={
          <LazyRoute>
            <DistributionBoardWiringPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/domestic-electrician-guide"
        element={
          <LazyRoute>
            <DomesticElectricianGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/domestic-vs-commercial-electrician"
        element={
          <LazyRoute>
            <DomesticVsCommercialElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/earth-electrode-testing"
        element={
          <LazyRoute>
            <EarthElectrodeTestPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/earth-fault-loop-impedance-calculation"
        element={
          <LazyRoute>
            <EarthFaultLoopImpedancePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/earth-fault-loop-impedance-explained"
        element={
          <LazyRoute>
            <EarthFaultLoopExplainedPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/earth-fault-loop-impedance-too-high"
        element={
          <LazyRoute>
            <EarthFaultLoopTooHighPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/earth-loop-impedance-too-high"
        element={
          <LazyRoute>
            <EarthLoopTooHighPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/earthing-fault-diagnosis"
        element={
          <LazyRoute>
            <EarthingFaultDiagnosisPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ecs-card-types"
        element={
          <LazyRoute>
            <ECSCardTypesPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/eicr-fail-rented-property"
        element={
          <LazyRoute>
            <EICRFailRentedPropertyPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/eicr-for-landlords"
        element={
          <LazyRoute>
            <EICRForLandlordsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/eicr-limitations"
        element={
          <LazyRoute>
            <EICRLimitationsPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/eicr-client-handover-guide"
        element={
          <LazyRoute>
            <EICRClientHandoverGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/eicr-common-mistakes"
        element={
          <LazyRoute>
            <EICRCommonMistakesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/eicr-observation-codes-explained"
        element={
          <LazyRoute>
            <EICRObservationCodesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/eicr-what-to-include"
        element={
          <LazyRoute>
            <EICRWhatToIncludePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/fire-risk-assessment"
        element={
          <LazyRoute>
      ...
      />
      <Route
        path="/guides/eicr-schedule-of-inspections"
        element={
          <LazyRoute>
            <EICRScheduleOfInspectionsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/eicr-vs-eic-difference"
        element={
          <LazyRoute>
            <EICRvsEICPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/elecsa-registration"
        element={
          <LazyRoute>
            <ELECSARegistrationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electric-car-charging-at-home"
        element={
          <LazyRoute>
            <ElectricCarChargingAtHomePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electric-shock-from-tap"
        element={
          <LazyRoute>
            <ElectricShockFromTapPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electric-shower-installation"
        element={
          <LazyRoute>
            <ElectricShowerInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-acronyms-glossary"
        element={
          <LazyRoute>
            <ElectricalAcronymsGlossaryPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-apprenticeship-cost"
        element={
          <LazyRoute>
            <ElectricalApprenticeshipCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-apprenticeship-employer-guide"
        element={
          <LazyRoute>
            <ElectricalApprenticeshipEmployerPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-apprenticeship-guide"
        element={
          <LazyRoute>
            <ElectricalApprenticeshipGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-careers-school-leavers"
        element={
          <LazyRoute>
            <ElectricalCareersForSchoolLeaversPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-certificate-retention"
        element={
          <LazyRoute>
            <ElectricalCertificateRetentionPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-certificate-types-uk"
        element={
          <LazyRoute>
            <ElectricalCertificateTypesPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/electrical-contractor-guide"
        element={
          <LazyRoute>
            <ElectricianContractorGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-design-guide"
        element={
          <LazyRoute>
            <ElectricalDesignGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-emergency-what-to-do"
        element={
          <LazyRoute>
            <ElectricalEmergencyPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-fault-finding-guide"
        element={
          <LazyRoute>
            <ElectricalFaultFindingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-handover-documentation"
        element={
          <LazyRoute>
            <ElectricalHandoverDocumentationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-inspection-checklist"
        element={
          <LazyRoute>
            <ElectricalInspectionChecklistPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-maintenance-contract"
        element={
          <LazyRoute>
            <ElectricalMaintenanceContractPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-maintenance-guide"
        element={
          <LazyRoute>
            <ElectricalMaintenanceGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-project-planning"
        element={
          <LazyRoute>
            <ElectricalProjectPlanningPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-qualifications-pathway"
        element={
          <LazyRoute>
            <ElectricalQualificationsPathwayPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-quality-assurance"
        element={
          <LazyRoute>
            <ElectricalQualityAssurancePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-regulations-timeline-uk"
        element={
          <LazyRoute>
            <ElectricalRegulationsTimelinePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-safety-at-home"
        element={
          <LazyRoute>
            <ElectricalSafetyAtHomePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-safety-landlord-checklist"
        element={
          <LazyRoute>
            <ElectricalSafetyLandlordPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-safety-on-site"
        element={
          <LazyRoute>
            <ElectricalSafetyOnSitePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-safety-tips"
        element={
          <LazyRoute>
            <ElectricalSafetyTipsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-site-manager"
        element={
          <LazyRoute>
            <ElectricalSiteManagerGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-specialisations"
        element={
          <LazyRoute>
            <ElectricalSpecialisationsPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/electrical-testing-cost-uk"
        element={
          <LazyRoute>
            <ElectricalTestingCostUKPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-tool-calibration"
        element={
          <LazyRoute>
            <ElectricalToolCalibrationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-union-membership"
        element={
          <LazyRoute>
            <ElectricalUnionMembershipPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-wiring-regulations-history"
        element={
          <LazyRoute>
            <ElectricalWiringRegulationsHistoryPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/electrical-work-pricing-guide"
        element={
          <LazyRoute>
            <ElectricalWorkPricingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-career-progression"
        element={
          <LazyRoute>
            <ElectricianCareerProgressionPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-cv-guide"
        element={
          <LazyRoute>
            <ElectricianCVGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-day-rates-uk"
        element={
          <LazyRoute>
            <ElectricianDayRatesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-insurance-uk"
        element={
          <LazyRoute>
            <ElectricianInsurancePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-interview-questions"
        element={
          <LazyRoute>
            <ElectricianInterviewQuestionsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-job-vacancies"
        element={
          <LazyRoute>
            <ElectricianJobVacanciesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-rates-per-hour-uk"
        element={
          <LazyRoute>
            <ElectricianRatesPerHourPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-salary-uk"
        element={
          <LazyRoute>
            <ElectricianSalaryUKPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-study-tips"
        element={
          <LazyRoute>
            <ElectricianStudyTipsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-tax-guide-uk"
        element={
          <LazyRoute>
            <ElectricianTaxGuidePage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/electrician-working-abroad"
        element={
          <LazyRoute>
            <ElectricalWorkingAbroadPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electricity-at-work-regulations"
        element={
          <LazyRoute>
            <ElectricityAtWorkRegsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/emergency-lighting-certificate-guide"
        element={
          <LazyRoute>
            <EmergencyLightingCertificateGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/epa-simulator-guide"
        element={
          <LazyRoute>
            <EPASimulatorGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/epa-what-to-expect"
        element={
          <LazyRoute>
            <EPAWhatToExpectPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/ev-charger-certificate-requirements"
        element={
          <LazyRoute>
            <EVChargerCertificateRequirementsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/fire-alarm-certificate-requirements"
        element={
          <LazyRoute>
            <FireAlarmCertificateRequirementsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/first-aid-electrical-shock"
        element={
          <LazyRoute>
            <FirstAidElectricalShockPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/first-fix-electrical"
        element={
          <LazyRoute>
            <FirstFixElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/flashcards-for-electrical-exams"
        element={
          <LazyRoute>
            <FlashcardsElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/fluke-vs-megger"
        element={
          <LazyRoute>
            <FlukeVsMeggerPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/functional-testing"
        element={
          <LazyRoute>
            <FunctionalTestingGuidePage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/garden-lighting-regulations"
        element={
          <LazyRoute>
            <GardenLightingRegsPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/gs-38-proving-dead"
        element={
          <LazyRoute>
            <GS38ProvingDeadPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/high-earth-resistance"
        element={
          <LazyRoute>
            <HighEarthResistancePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/high-electricity-bill-causes"
        element={
          <LazyRoute>
            <HighElectricityBillPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/hmo-electrical-requirements"
        element={
          <LazyRoute>
            <HMOElectricalRequirementsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/hospital-electrical-systems"
        element={
          <LazyRoute>
            <HospitalElectricalSystemsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/hourly-rate-calculator-electrician"
        element={
          <LazyRoute>
            <HourlyRateCalculatorGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/how-ai-helps-electricians"
        element={
          <LazyRoute>
            <HowAIHelpsElectriciansPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/how-electricity-works"
        element={
          <LazyRoute>
            <HowElectricityWorksPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/how-to-become-an-electrician"
        element={
          <LazyRoute>
            <HowToBecomeElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/how-to-become-electrician"
        element={
          <LazyRoute>
            <HowToBecomeElectricianPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/how-to-find-electrician-uk"
        element={
          <LazyRoute>
            <HowToFindAnElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/how-to-read-electrical-drawings"
        element={
          <LazyRoute>
            <HowToReadElectricalDrawingsPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/hse-inspections-electrical"
        element={
          <LazyRoute>
            <HSEInspectionsElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/iet-code-of-practice-ev"
        element={
          <LazyRoute>
            <IETCodeOfPracticeEVPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/industrial-electrician-guide"
        element={
          <LazyRoute>
            <IndustrialElectricianGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/initial-verification"
        element={
          <LazyRoute>
            <InitialVerificationGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/insulation-resistance-testing"
        element={
          <LazyRoute>
            <InsulationResistanceTestPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/intermittent-electrical-faults"
        element={
          <LazyRoute>
            <IntermittentElectricalFaultsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/kitchen-wiring-guide"
        element={
          <LazyRoute>
            <KitchenWiringGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/led-downlight-installation"
        element={
          <LazyRoute>
            <LEDDownlightGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/lights-flickering-causes"
        element={
          <LazyRoute>
            <LightsFlickeringPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/limited-company-electrician"
        element={
          <LazyRoute>
            <LimitedCompanyElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/lock-off-loto-procedure"
        element={
          <LazyRoute>
            <LockOffLOTOPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/loose-neutral-symptoms"
        element={
          <LazyRoute>
            <LooseNeutralSymptomsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/low-insulation-resistance"
        element={
          <LazyRoute>
            <LowInsulationResistancePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/marina-electrical-installations"
        element={
          <LazyRoute>
            <MarinaElectricalInstallationsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/max-demand-calculation-guide"
        element={
          <LazyRoute>
            <MaxDemandGuidePage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/maximum-zs-values-bs-7671"
        element={
          <LazyRoute>
            <MaximumZsValuesPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/mcb-types-b-c-d-explained"
        element={
          <LazyRoute>
            <MCBTypesBCDPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/method-statement-electrical"
        element={
          <LazyRoute>
            <MethodStatementElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/method-statement-electricians"
        element={
          <LazyRoute>
            <MethodStatementGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/minor-works-vs-eic"
        element={
          <LazyRoute>
            <MinorWorksVsEICPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/mock-exams-electrical"
        element={
          <LazyRoute>
            <MockExamsElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/multifunction-tester-guide"
        element={
          <LazyRoute>
            <MultifunctionTesterGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/napit-registration"
        element={
          <LazyRoute>
            <NAPITRegistrationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/near-miss-reporting"
        element={
          <LazyRoute>
            <NearMissReportingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/new-build-electrical"
        element={
          <LazyRoute>
            <NewBuildElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/new-build-electrical-standards"
        element={
          <LazyRoute>
            <NewBuildStandardsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/niceic-certificate-requirements"
        element={
          <LazyRoute>
            <NICEICCertificateRequirementsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/niceic-registration"
        element={
          <LazyRoute>
      ...
      />
      <Route
        path="/guides/no-power-to-sockets"
        element={
          <LazyRoute>
            <NoPowerToSocketsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/non-notifiable-electrical-work"
        element={
          <LazyRoute>
            <NonNotifiableWorkPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/notifiable-electrical-work"
        element={
          <LazyRoute>
            <NotifiableWorkGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/nuisance-tripping"
        element={
          <LazyRoute>
            <NuisanceTrippingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/nvq-level-3-electrical"
        element={
          <LazyRoute>
            <NVQLevel3ElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/off-job-training-hours"
        element={
          <LazyRoute>
            <OffJobTrainingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/off-the-job-training-hours"
        element={
          <LazyRoute>
            <OffJobTrainingHoursPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ojt-evidence-guide"
        element={
          <LazyRoute>
            <OJTEvidenceGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/on-the-job-training-guide"
        element={
          <LazyRoute>
            <OJTHubGuidePage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/overloaded-circuit-signs"
        element={
          <LazyRoute>
            <OverloadedCircuitPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/pat-testing-frequency"
        element={
          <LazyRoute>
            <PATTestingFrequencyPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/periodic-inspection"
        element={
          <LazyRoute>
            <PeriodicInspectionGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/permit-to-work-electrician"
        element={
          <LazyRoute>
            <PermitToWorkPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/polarity-testing-guide"
        element={
          <LazyRoute>
            <PolarityTestingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/power-cut-what-to-do"
        element={
          <LazyRoute>
            <PowerCutWhatToDoPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/power-going-off-randomly"
        element={
          <LazyRoute>
            <PowerGoingOffPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/ppe-for-electricians"
        element={
          <LazyRoute>
            <PPEForElectriciansPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/professional-development-electrician"
        element={
          <LazyRoute>
            <ProfessionalDevelopmentElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/prospective-fault-current-explained"
        element={
          <LazyRoute>
            <ProspectiveFaultCurrentGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/protective-earthing-bonding"
        element={
          <LazyRoute>
            <ProtectiveEarthingBondingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/radial-circuit-explained"
        element={
          <LazyRoute>
            <RadialCircuitGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rams-template-electricians"
        element={
          <LazyRoute>
            <RAMSTemplateGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rcbo-vs-rcd-mcb"
        element={
          <LazyRoute>
            <RCBOvsRCDMCBPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/rcd-testing-procedure"
        element={
          <LazyRoute>
            <RCDTestingProcedurePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/reference-methods-cable-installation"
        element={
          <LazyRoute>
            <ReferenceMethodsGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/regulation-530-3-201"
        element={
          <LazyRoute>
            <Regulation530Page />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/residual-current-monitoring"
        element={
          <LazyRoute>
            <ResidualCurrentMonitoringPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/restaurant-electrical-requirements"
        element={
          <LazyRoute>
            <RestaurantElectricalRequirementsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/retail-electrical-installation"
        element={
          <LazyRoute>
            <RetailInstallationGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rewire-cost-uk"
        element={
          <LazyRoute>
            <RewireCostUKPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/ring-circuit-fault-finding"
        element={
          <LazyRoute>
            <RingCircuitFaultFindingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ring-main-explained"
        element={
          <LazyRoute>
            <RingMainExplainedPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/risk-assessment-electrical-work"
        element={
          <LazyRoute>
            <RiskAssessmentElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/risk-assessment-electricians"
        element={
          <LazyRoute>
            <RiskAssessmentElectriciansPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/schedule-of-test-results"
        element={
          <LazyRoute>
            <ScheduleOfTestResultsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/safe-isolation-procedure"
        element={
          <LazyRoute>
            <SafeIsolationProcedurePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/school-electrical-inspection"
        element={
          <LazyRoute>
            <SchoolElectricalInspectionPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/second-fix-electrical"
        element={
          <LazyRoute>
            <SecondFixElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/site-diary-apprentice"
        element={
          <LazyRoute>
            <SiteDiaryGuidePage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/site-diary-for-apprentices"
        element={
          <LazyRoute>
            <SiteDiaryApprenticeGuidePage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/smart-meter-installation"
        element={
          <LazyRoute>
            <SmartMeterInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/smoke-alarm-regulations-2022"
        element={
          <LazyRoute>
            <SmokeAlarmRegs2022Page />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/smoke-detector-wiring"
        element={
          <LazyRoute>
            <SmokeDetectorWiringPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/solar-pv-certificate-requirements"
        element={
          <LazyRoute>
            <SolarPVCertificateRequirementsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/spd-surge-protection-guide"
        element={
          <LazyRoute>
            <SPDGuidePage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/special-locations-part-7-bs-7671"
        element={
          <LazyRoute>
            <SpecialLocationsPart7Page />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/spur-socket-regulations"
        element={
          <LazyRoute>
            <SpurSocketRegsPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/supplementary-bonding"
        element={
          <LazyRoute>
            <SupplementaryBondingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/swimming-pool-electrical-regulations"
        element={
          <LazyRoute>
            <SwimmingPoolElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/temporary-installations-bs-7909"
        element={
          <LazyRoute>
            <TemporaryInstallationsBS7909Page />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/test-instruments-guide"
        element={
          <LazyRoute>
            <TestInstrumentsGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/testing-procedures-apprentices"
        element={
          <LazyRoute>
            <Year2ElectricalApprenticePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/testing-procedures-for-apprentices"
        element={
          <LazyRoute>
            <TestingProceduresForApprenticesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/testing-three-phase-installation"
        element={
          <LazyRoute>
            <TestingThreePhasePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/three-phase-calculations"
        element={
          <LazyRoute>
            <ThreePhaseCalculationsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/three-phase-installation"
        element={
          <LazyRoute>
            <ThreePhaseInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/toolbox-talks-electrical"
        element={
          <LazyRoute>
            <ToolboxTalksElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/troubleshooting-electrical-problems"
        element={
          <LazyRoute>
            <TroubleshootingElectricalProblemsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/underfloor-heating-electrical"
        element={
          <LazyRoute>
            <UnderfloorHeatingElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/unsatisfactory-eicr-what-next"
        element={
          <LazyRoute>
            <UnsatisfactoryEICRPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/voltage-too-high-or-low"
        element={
          <LazyRoute>
            <VoltageTooHighLowPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/what-is-a-circuit-breaker"
        element={
          <LazyRoute>
            <WhatIsACircuitBreakerPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/what-is-an-rcd"
        element={
          <LazyRoute>
            <WhatIsAnRCDPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/what-to-expect-electrical-apprentice"
        element={
          <LazyRoute>
            <WhatToExpectAsApprenticePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/why-choose-niceic-electrician"
        element={
          <LazyRoute>
            <WhyChooseNICEICPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/women-in-electrical-trade"
        element={
          <LazyRoute>
            <WomenInElectricalTradePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/year-1-apprentice-guide"
        element={
          <LazyRoute>
            <Year1ApprenticeGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/year-2-electrical-apprentice"
        element={
          <LazyRoute>
            <Year2ApprenticeGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ze-values-uk"
        element={
          <LazyRoute>
            <ZeValuesUKPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/tools/ai-client-explainer"
        element={
          <LazyRoute>
            <AIClientExplainerPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/ai-commissioning-specialist"
        element={
          <LazyRoute>
            <AICommissioningSpecialistPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/tools/ai-diagram-builder"
        element={
          <LazyRoute>
            <AIDiagramBuilderPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/ai-fault-diagnosis"
        element={
          <LazyRoute>
      ...
      />
      <Route
        path="/tools/ai-installation-specialist"
        element={
          <LazyRoute>
            <AIInstallationSpecialistPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/tools/ai-maintenance-specialist"
        element={
          <LazyRoute>
            <AIMaintenanceSpecialistPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/ai-method-statement-generator"
        element={
          <LazyRoute>
            <AIMethodStatementPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/ai-project-manager"
        element={
          <LazyRoute>
      ...
      />
      <Route
        path="/tools/ai-regulations-lookup"
        element={
          <LazyRoute>
            <AIRegulationsLookupPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/ai-report-writer"
        element={
          <LazyRoute>
            <AIReportWriterPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/tools/ai-wiring-instructions"
        element={
          <LazyRoute>
            <AIWiringInstructionsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/apprentice-training-app"
        element={
          <LazyRoute>
            <ApprenticeTrainingAppPage />
          </LazyRoute>
        }
      />
      <Route
        ...
        element={
          <LazyRoute>
            <BatteryBackupCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/board-scanner"
        element={
          <LazyRoute>
            <BoardScannerToolPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/tools/minimum-charge-calculator"
        element={
          <LazyRoute>
            <MinimumChargeCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/busbar-sizing-calculator"
        element={
          <LazyRoute>
            <BusbarSizingCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/business-analytics-electrician"
        element={
          <LazyRoute>
            <BusinessAnalyticsElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/business-cost-calculator"
        element={
          <LazyRoute>
            <BusinessCostCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/cable-derating-calculator"
        element={
          <LazyRoute>
            <CableDeratingCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/cable-tray-sizing-calculator"
        element={
          <LazyRoute>
            <CableTrayCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/cable-volt-drop-three-phase"
        element={
          <LazyRoute>
            <CableVoltDropThreePhasePage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/capacity-planning-calculator"
        element={
          <LazyRoute>
            <CapacityPlanningCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/circuit-breaker-sizing-calculator"
        element={
          <LazyRoute>
            <CircuitBreakerSizingCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/college-tutor-dashboard"
        element={
          <LazyRoute>
            <CollegeTutorDashboardPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/customer-management-electrician"
        element={
          <LazyRoute>
            <CustomerManagementElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/cv-builder-electrician"
        element={
          <LazyRoute>
            <CVBuilderElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/digital-certificates-app"
        element={
          <LazyRoute>
      ...
      />
      <Route
        path="/tools/disconnection-time-calculator"
        element={
          <LazyRoute>
            <DisconnectionTimeCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/earth-rod-resistance-calculator"
        element={
          <LazyRoute>
            <EarthRodResistanceCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/elecid-professional-card"
        element={
          <LazyRoute>
            <ElecIDProfessionalCardPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/electrical-app-with-ai"
        element={
          <LazyRoute>
            <ElectricalAppWithAIPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/electrical-load-schedule"
        element={
          <LazyRoute>
            <ElectricalLoadSchedulePage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/electrical-project-cost-estimator"
        element={
          <LazyRoute>
            <ElectricalProjectCostEstimatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/electrician-app-iphone"
        element={
          <LazyRoute>
            <ElectricianAppForIPhonePage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/employer-electrical-platform"
        element={
          <LazyRoute>
            <EmployerElectricalPlatformPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/tools/ev-charger-load-calculator"
        element={
          <LazyRoute>
      ...
      />
      <Route
        path="/tools/learning-videos-electrician"
        element={
          <LazyRoute>
            <LearningVideosElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/lighting-lux-calculator"
        element={
          <LazyRoute>
            <LightingLuxCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/mental-health-hub"
        element={
          <LazyRoute>
            <MentalHealthHubPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/tools/motor-starting-current-calculator"
        element={
          <LazyRoute>
            <MotorStartingCurrentCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/offline-electrical-app"
        element={
          <LazyRoute>
            <OfflineElectricalAppPage />
          </LazyRoute>
        }
      />
      <Route
        ...
        element={
          <LazyRoute>
            <PowerConsumptionCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/pricing-strategy-electrician"
        element={
          <LazyRoute>
            <PricingStrategyElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/project-management-electrician"
        element={
          <LazyRoute>
            <ProjectManagementElectricianPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/tools/solar-panel-sizing-calculator"
        element={
          <LazyRoute>
            <SolarPanelSizingCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/staff-cost-calculator"
        element={
          <LazyRoute>
            <StaffCostCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/tools/study-centre-online-courses"
        element={
          <LazyRoute>
      ...
      />
      <Route
        path="/tools/transformer-sizing-calculator"
        element={
          <LazyRoute>
            <TransformerSizingCalculatorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tools/vat-scheme-comparison"
        element={
          <LazyRoute>
            <VATSchemeComparisonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/asbestos-awareness"
        element={
          <LazyRoute>
            <AsbestosAwarenessCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/bs-7671-amendment-3-course"
        element={
          <LazyRoute>
            <BS7671Amendment3CoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/confined-spaces"
        element={
          <LazyRoute>
            <ConfinedSpacesCoursePage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/training/data-cabling"
        element={
          <LazyRoute>
            <DataCablingCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/domestic-installer"
        element={
          <LazyRoute>
            <DomesticInstallerCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/electrical-science-fundamentals"
        element={
          <LazyRoute>
            <ElectricalScienceFundamentalsCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/energy-efficiency"
        element={
          <LazyRoute>
            <EnergyEfficiencyCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/environmental-sustainability"
        element={
          <LazyRoute>
            <EnvironmentalSustainabilityCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/ev-charger-installation"
        element={
          <LazyRoute>
            <EVChargingCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/fire-alarm-systems"
        element={
          <LazyRoute>
            <FireAlarmSystemsCoursePage />
          </LazyRoute>
        }
      />
      <Route
        ...
        element={
          <LazyRoute>
            <FireSafetyCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/first-aid-electrical"
        element={
          <LazyRoute>
            <FirstAidCoursePage />
          </LazyRoute>
      ...
      />
      <Route
        path="/training/hnc-electrical"
        element={
          <LazyRoute>
            <HNCElectricalCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/instrumentation-course"
        element={
          <LazyRoute>
            <InstrumentationCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/leadership-on-site"
        element={
          <LazyRoute>
            <LeadershipOnSiteCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/mental-health-awareness"
        element={
          <LazyRoute>
            <MentalHealthAwarenessCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/renewable-energy"
        element={
          <LazyRoute>
            <RenewableEnergyCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/scaffolding-awareness"
        element={
          <LazyRoute>
            <ScaffoldingAwarenessCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/smart-home-automation"
        element={
          <LazyRoute>
            <SmartHomeAutomationCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/working-at-height"
        element={
          <LazyRoute>
            <WorkingAtHeightCoursePage />
          </LazyRoute>
        }
      />
      ...
      {/* Batch 2 — previously missing routes */}
      <Route
        path="/guides/afdd-arc-fault-detection"
        element={
          <LazyRoute>
            <AFDDGuidePage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/ai-tools-for-electricians"
        element={
          <LazyRoute>
            <AIToolsForElectriciansPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/bathroom-electrical-regulations"
        element={
          <LazyRoute>
            <BathroomElectricalRegsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/compare/best-apprentice-app"
        element={
          <LazyRoute>
            <BestApprenticeAppPage />
          </LazyRoute>
        }
      />
      <Route
        path="/compare/best-cable-sizing-app"
        element={
          <LazyRoute>
            <BestCableSizingAppPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/best-eicr-software-uk"
        element={
          <LazyRoute>
            <BestEICRSoftwareUKPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/best-electrical-training-app"
        element={
          <LazyRoute>
            <BestElectricalTrainingAppPage />
          </LazyRoute>
        }
      />
      <Route
        path="/compare/best-quoting-app-electricians"
        element={
          <LazyRoute>
            <BestQuotingAppPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/bs-7671-run-through"
        element={
          <LazyRoute>
            <BS7671RunThroughPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/cable-sizing-guide-bs-7671"
        element={
          <LazyRoute>
            <CableSizingGuideBS7671Page />
          </LazyRoute>
        }
      />
      <Route
        path="/training/cdm-regulations-course"
        element={
          <LazyRoute>
            <CDMRegulationsCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-change"
        element={
          <LazyRoute>
            <ConsumerUnitChangePage />
          </LazyRoute>
        }
      />
      <Route
        path="/compare/elec-mate-vs-easy-eicr"
        element={
          <LazyRoute>
            <ElecMateVsEasyEICRPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-bim-guide"
        element={
          <LazyRoute>
            <ElectricalBIMGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-types"
        element={
          <LazyRoute>
            <ElectricalBoardTypesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-conduit-guide"
        element={
          <LazyRoute>
            <ElectricalConduitsGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/customer-service-electricians"
        element={
          <LazyRoute>
            <ElectricalCustomerServicePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/house-extension-electrics"
        element={
          <LazyRoute>
            <ElectricalExtensionGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-load-assessment"
        element={
          <LazyRoute>
            <ElectricalLoadAssessmentPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/marketing-tips-electricians"
        element={
          <LazyRoute>
            <ElectricalMarketingTipsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-noise-interference"
        element={
          <LazyRoute>
            <ElectricalNoiseAndInterferencePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-retrofit-guide"
        element={
          <LazyRoute>
            <ElectricalRetrofitGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-safety-audit"
        element={
          <LazyRoute>
            <ElectricalSafetyAuditPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-site-induction"
        element={
          <LazyRoute>
            <ElectricalSiteInductionPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-subcontracting"
        element={
          <LazyRoute>
            <ElectricalSubcontractingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-test-certificate"
        element={
          <LazyRoute>
            <ElectricalTestCertificatePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-accounting-software"
        element={
          <LazyRoute>
            <ElectricianAccountingSoftwarePage />
          </LazyRoute>
        }
      />
      <Route
        path="/compare/electrician-app-android"
        element={
          <LazyRoute>
            <ElectricianAppForAndroidPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/emergency-electrical-repairs"
        element={
          <LazyRoute>
            <EmergencyElectricalRepairsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/emergency-lighting-testing"
        element={
          <LazyRoute>
            <EmergencyLightingTestingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ev-charger-installation"
        element={
          <LazyRoute>
            <EVChargerInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/fp200-cable-guide"
        element={
          <LazyRoute>
            <FP200CableGuidePage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/future-of-electrical-trade"
        element={
          <LazyRoute>
            <FutureOfElectricalTradePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/going-self-employed-electrician"
        element={
          <LazyRoute>
            <GoingSelfEmployedElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/house-rewire-guide"
        element={
          <LazyRoute>
            <HouseRewireGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/how-to-fill-in-minor-works"
        element={
          <LazyRoute>
            <HowToFillInMinorWorksPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/how-to-price-electrical-jobs"
        element={
          <LazyRoute>
            <HowToPriceElectricalJobsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/insulation-resistance-minimum-values"
        element={
          <LazyRoute>
            <InsulationResistanceMinimumValuesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/landlord-electrical-safety"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/led-lighting-guide"
        element={
          <LazyRoute>
            <LEDLightingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/mewp-course"
        element={
          <LazyRoute>
            <MEWPCoursePage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/mock-exams-electrician"
        element={
          <LazyRoute>
            <MockExamsElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/napit-certificate-guide"
        element={
          <LazyRoute>
            <NAPICertificateGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/networked-fire-alarm-system"
        element={
          <LazyRoute>
            <NetworkedFireAlarmPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/outdoor-electrical-installations"
        element={
          <LazyRoute>
            <OutdoorElectricsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/pat-testing-guide-uk"
        element={
          <LazyRoute>
            <PATTestingGuideUKPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rcd-keeps-tripping"
        element={
          <LazyRoute>
            <RCDKeepsTrippingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rcd-keeps-tripping-causes-and-fixes"
        element={
          <LazyRoute>
            <RCDKeepsTrippingCausesAndFixesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rcd-keeps-tripping-test-sequence"
        element={
          <LazyRoute>
            <RCDKeepsTrippingTestSequencePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rcbo-keeps-tripping-causes-and-fixes"
        element={
          <LazyRoute>
            <RCBOKeepsTrippingCausesAndFixesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rcbo-keeps-tripping-guide"
        element={
          <LazyRoute>
            <RCBOKeepsTrippingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rcd-types-explained"
        element={
          <LazyRoute>
            <RCDTypesExplainedPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/smoke-alarm-regulations-uk"
        element={
          <LazyRoute>
            <SmokeAlarmRegsPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/solar-panel-installation"
        element={
          <LazyRoute>
            <SolarPanelInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/spd-surge-protection"
        element={
          <LazyRoute>
            <SPDSurgeProtectionPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/starting-an-electrical-business"
        element={
          <LazyRoute>
            <StartingElectricalBusinessPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/swa-cable-installation"
        element={
          <LazyRoute>
            <SWACableInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/trunking-installation-guide"
        element={
          <LazyRoute>
            <TrunkingInstallationGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ups-installation-guide"
        element={
          <LazyRoute>
            <UPSInstallationGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/voltage-drop-limits-bs-7671"
        element={
          <LazyRoute>
            <VoltageDropGuideBS7671Page />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/when-is-eic-required"
        element={
          <LazyRoute>
            <WhenIsEICRequiredPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/wiring-colours-uk"
        element={
          <LazyRoute>
            <WiringColoursUKPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/1930s-semi-consumer-unit-upgrade"
        element={
          <LazyRoute>
            <Semi1930sConsumerUnitUpgradePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/1930s-semi-eicr-guide"
        element={
          <LazyRoute>
            <Semi1930sEICRGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/1930s-semi-electrical-requirements"
        element={
          <LazyRoute>
            <Semi1930sElectricalRequirementsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/eic-client-handover-guide"
        element={
          <LazyRoute>
            <EICClientHandoverGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/eic-common-mistakes"
        element={
          <LazyRoute>
            <EICCommonMistakesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/eic-digital-vs-paper"
        element={
          <LazyRoute>
            <EICDigitalVsPaperPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/eic-what-to-include"
        element={
          <LazyRoute>
            <EICWhatToIncludePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/eicr-example-and-template"
        element={
          <LazyRoute>
            <EICRExampleAndTemplatePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/eicr-when-you-need-one"
        element={
          <LazyRoute>
            <EICRWhenYouNeedOnePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/full-rewire-cost-guide"
        element={
          <LazyRoute>
            <FullRewireCostGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/full-rewire-labour-and-materials"
        element={
          <LazyRoute>
            <FullRewireLabourAndMaterialsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/full-rewire-price-breakdown"
        element={
          <LazyRoute>
            <FullRewirePriceBreakdownPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/minor-works-certificate-common-mistakes"
        element={
          <LazyRoute>
            <MinorWorksCertificateCommonMistakesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/minor-works-certificate-how-to-fill-in"
        element={
          <LazyRoute>
            <MinorWorksCertificateHowToFillInPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/minor-works-certificate-what-to-include"
        element={
          <LazyRoute>
            <MinorWorksCertificateWhatToIncludePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/partial-rewire-cost-guide"
        element={
          <LazyRoute>
            <PartialRewireCostGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/partial-rewire-labour-and-materials"
        element={
          <LazyRoute>
            <PartialRewireLabourAndMaterialsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/partial-rewire-price-breakdown"
        element={
          <LazyRoute>
            <PartialRewirePriceBreakdownPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rcbo-keeps-tripping-common-causes"
        element={
          <LazyRoute>
            <RCBOKeepsTrippingCommonCausesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rcbo-keeps-tripping-test-sequence"
        element={
          <LazyRoute>
            <RCBOKeepsTrippingTestSequencePage />
          </LazyRoute>
        }
      />
      <Route
        path="/training/workplace-safety-course"
        element={
          <LazyRoute>
            <WorkplaceSafetyCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/access-control-installation"
        element={
          <LazyRoute>
            <AccessControlInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ac-vs-dc-earthing-solar-ev"
        element={
          <LazyRoute>
            <ACVsDCEarthingPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/air-source-heat-pump-electrical"
        element={
          <LazyRoute>
            <AirSourceHeatPumpElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/am2-assessment-preparation"
        element={
          <LazyRoute>
            <AM2AssessmentPrepPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/annex-electrical-installation"
        element={
          <LazyRoute>
            <AnnexElectricalInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/apprentice-first-year-revision"
        element={
          <LazyRoute>
            <ApprenticeFirstYearRevisionPage />
          </LazyRoute>
        }
      />
      <Route
        path="/apprentice-maths-electrician"
        element={
          <LazyRoute>
            <ApprenticeMathsElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/apprentice-portfolio-building-tips"
        element={
          <LazyRoute>
            <ApprenticePortfolioBuildingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/armoured-cable-installation"
        element={
          <LazyRoute>
            <ArmaCableInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/atex-hazardous-area-electrical-installations"
        element={
          <LazyRoute>
            <ATEXHazardousAreaElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/barn-conversion-electrics"
        element={
          <LazyRoute>
            <BarnConversionElectricsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/basement-conversion-electrical"
        element={
          <LazyRoute>
            <BasementConversionElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/bathroom-electrical-cost"
        element={
          <LazyRoute>
            <BathroomElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/bathroom-electrical-zones-bs7671"
        element={
          <LazyRoute>
            <BathroomZoneElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/battery-storage-installation"
        element={
          <LazyRoute>
            <BatteryStorageInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/best-cable-detector-2026"
        element={
          <LazyRoute>
            <BestCableDetector2026Page />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/best-label-printer-electricians"
        element={
          <LazyRoute>
            <BestLabelPrinterElectriciansPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/best-multifunction-tester-2026"
        element={
          <LazyRoute>
            <BestMultifunctionTester2026Page />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/best-thermal-imaging-camera-electricians"
        element={
          <LazyRoute>
            <BestThermalImagingCameraElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/best-van-racking-electricians"
        element={
          <LazyRoute>
            <BestVanRackingElectriciansPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/building-management-systems-bms-electrical"
        element={
          <LazyRoute>
            <BuildingManagementSystemsElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/building-regulations-electrical"
        element={
          <LazyRoute>
            <BuildingRegulationsElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/bungalow-rewire-cost"
        element={
          <LazyRoute>
            <BungalowRewireCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/cable-detector-buying-guide"
        element={
          <LazyRoute>
            <CableDetectorBuyingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/car-park-lighting-cost"
        element={
          <LazyRoute>
            <CarParkLightingCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/cash-flow-management-electricians"
        element={
          <LazyRoute>
            <CashFlowManagementElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/cctv-installation-electrical-cost"
        element={
          <LazyRoute>
            <CCTVInstallationCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/compare/checkatrade-vs-mybuilder-vs-bark"
        element={
          <LazyRoute>
      ...
      />
      <Route
        path="/guides/christmas-lighting-safety"
        element={
          <LazyRoute>
            <ChristmasLightingSafetyPage />
          </LazyRoute>
        }
      />
      <Route
        path="/circuit-breaker-types"
        element={
          <LazyRoute>
            <CircuitBreakerTypesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/city-guilds-2365-electrical"
        element={
          <LazyRoute>
            <CityGuilds2365GuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/city-guilds-2365-unit-201"
        element={
          <LazyRoute>
            <CityGuilds2365Unit201Page />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/city-guilds-2365-unit-202"
        element={
          <LazyRoute>
            <CityGuilds2365Unit202Page />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/city-guilds-2382-exam-guide"
        element={
          <LazyRoute>
            <CityGuilds2382ExamGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/city-guilds-2396-design-course"
        element={
          <LazyRoute>
            <CityGuilds2396DesignCoursePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/clamp-meter-guide-electricians"
        element={
          <LazyRoute>
            <ClampMeterGuideElectriciansPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/clean-room-electrical-installation"
        element={
          <LazyRoute>
            <CleanRoomElectricalInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/commercial-rewire-cost"
        element={
          <LazyRoute>
            <CommercialRewireCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/competent-person-scheme-guide"
        element={
          <LazyRoute>
            <CompetentPersonSchemeGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/compex-qualification-guide"
        element={
          <LazyRoute>
            <CompExQualificationGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-replacement-birmingham"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementBirminghamPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-replacement-bristol"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementBristolPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-replacement-cost"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/consumer-unit-replacement-coventry"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementCoventryPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-replacement-edinburgh"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementEdinburghPage />
          </LazyRoute>
        }
      />
      <Route
        path="/consumer-unit-replacement-exeter"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementExeterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-replacement-glasgow"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementGlasgowPage />
          </LazyRoute>
        }
      />
      <Route
        path="/consumer-unit-replacement-hull"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementHullPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-replacement-leeds"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementLeedsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/consumer-unit-replacement-liverpool"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementLiverpoolPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-replacement-london"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementLondonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/consumer-unit-replacement-manchester"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementManchesterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/consumer-unit-replacement-newcastle"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementNewcastlePage />
          </LazyRoute>
        }
      />
      <Route
        path="/consumer-unit-replacement-plymouth"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementPlymouthPage />
          </LazyRoute>
        }
      />
      <Route
        path="/consumer-unit-replacement-sheffield"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementSheffieldPage />
          </LazyRoute>
        }
      />
      <Route
        path="/consumer-unit-replacement-southampton"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementSouthamptonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/consumer-unit-replacement-wolverhampton"
        element={
          <LazyRoute>
            <ConsumerUnitReplacementWolverhamptonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/continuity-testing-guide"
        element={
          <LazyRoute>
            <ContinuityTestingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/continuity-testing-electricians-guide"
        element={
          <LazyRoute>
            <ContinuityTestingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/cooker-connection-cost"
        element={
          <LazyRoute>
            <CookerConnectionCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/copper-vs-aluminium-cable"
        element={
          <LazyRoute>
            <CopperVsAluminiumCablePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/cscs-vs-ecs-card-comparison"
        element={
          <LazyRoute>
            <CSCSvsECSCardPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/data-cabling-installation-cost"
        element={
          <LazyRoute>
            <DataCablingInstallationCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/data-centre-electrical-installation"
        element={
          <LazyRoute>
            <DataCentreElectricalInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/data-centre-electrical-installation"
        element={
          <LazyRoute>
            <DataCentreElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/dental-surgery-electrical-cost"
        element={
          <LazyRoute>
            <DentalSurgeryElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/dividend-vs-salary-electrician"
        element={
          <LazyRoute>
            <DividendVsSalaryElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/doorbell-not-working"
        element={
          <LazyRoute>
            <DoorbellNotWorkingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/drill-guide-electricians-sds-cordless"
        element={
          <LazyRoute>
            <DrillGuideElectriciansPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/earth-fault-loop-impedance-testing"
        element={
          <LazyRoute>
            <EarthFaultLoopImpedanceTestingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/earthing-system-fault-finding"
        element={
          <LazyRoute>
            <EarthingSystemFaultFindingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/earthing-systems-guide"
        element={
          <LazyRoute>
            <EarthingSystemsGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/eca-membership-guide"
        element={
          <LazyRoute>
            <ECAMembershipGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ecs-card-types-explained"
        element={
          <LazyRoute>
            <ECSCardTypesExplainedPage />
          </LazyRoute>
        }
      />
      <Route
        path="/edwardian-house-electrical"
        element={
          <LazyRoute>
            <EdwardianHouseElectricalPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/eicr-commercial-property"
        element={
          <LazyRoute>
            <EICRCommercialPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/eicr-for-commercial-premises"
        element={
          <LazyRoute>
            <EICRForCommercialPremisesPage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/eicr-stoke-on-trent"
        element={
          <LazyRoute>
            <EICRStokeOnTrentPage />
          </LazyRoute>
        }
      />
      <Route
        path="/eicr-sunderland"
        element={
          <LazyRoute>
            <EICRSunderlandPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/eicr-wolverhampton"
        element={
          <LazyRoute>
            <EICRWolverhamptonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/eicr-york"
        element={
          <LazyRoute>
            <EICRYorkPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/electrical-business-plan-template"
        element={
          <LazyRoute>
            <ElectricalBusinessPlanPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electrician-business-website"
        element={
          <LazyRoute>
            <ElectricalBusinessWebsitePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-estimating-guide"
        element={
          <LazyRoute>
            <ElectricalEstimatingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-fault-finding-methodology"
        element={
          <LazyRoute>
            <ElectricalFaultFindingMethodologyPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-fire-prevention-uk"
        element={
          <LazyRoute>
            <ElectricalFirePreventionPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-handover-documentation-guide"
        element={
          <LazyRoute>
            <ElectricalHandoverDocumentationGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-project-handover-guide"
        element={
          <LazyRoute>
            <ElectricalProjectHandoverPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-safety-checks-new-home"
        element={
          <LazyRoute>
            <ElectricalSafetyChecksNewHomePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-science-revision"
        element={
          <LazyRoute>
            <ElectricalScienceRevisionPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrical-work-notification-part-p"
        element={
          <LazyRoute>
            <ElectricalWorkNotificationGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/aberdeen"
        element={
          <LazyRoute>
            <ElectricianAberdeenPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/barrow-in-furness"
        element={
          <LazyRoute>
            <ElectricianBarrowPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/basingstoke"
        element={
          <LazyRoute>
            <ElectricianBasingstokePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-bath"
        element={
          <LazyRoute>
            <ElectricianBathPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/electrician-belfast"
        element={
          <LazyRoute>
            <ElectricianBelfastPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-birmingham"
        element={
          <LazyRoute>
            <ElectricianBirminghamPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/blackpool"
        element={
          <LazyRoute>
            <ElectricianBlackpoolPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/bolton"
        element={
          <LazyRoute>
            <ElectricianBoltonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-bournemouth"
        element={
          <LazyRoute>
            <ElectricianBournemouthPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/bradford"
        element={
          <LazyRoute>
            <ElectricianBradfordPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-brighton"
        element={
          <LazyRoute>
            <ElectricianBrightonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-bristol"
        element={
          <LazyRoute>
            <ElectricianBristolPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-business-insurance"
        element={
          <LazyRoute>
            <ElectricianBusinessInsurancePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-cambridge"
        element={
          <LazyRoute>
            <ElectricianCambridgePage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/canterbury"
        element={
          <LazyRoute>
            <ElectricianCanterburyPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-cardiff"
        element={
          <LazyRoute>
            <ElectricianCardiffPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-career-ladder-uk"
        element={
          <LazyRoute>
            <ElectricianCareerLadderPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/carlisle"
        element={
          <LazyRoute>
            <ElectricianCarlislePage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/chelmsford"
        element={
          <LazyRoute>
            <ElectricianChelmsfordPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/cheltenham"
        element={
          <LazyRoute>
            <ElectricianCheltenhamPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/chester"
        element={
          <LazyRoute>
            <ElectricianChesterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/colchester"
        element={
          <LazyRoute>
            <ElectricianColchesterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-coventry"
        element={
          <LazyRoute>
            <ElectricianCoventryPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-crawley"
        element={
          <LazyRoute>
            <ElectricianCrawleyPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/cumbria"
        element={
          <LazyRoute>
            <ElectricianCumbriaPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-derby"
        element={
          <LazyRoute>
            <ElectricianDerbyPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/doncaster"
        element={
          <LazyRoute>
            <ElectricianDoncasterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/dundee"
        element={
          <LazyRoute>
            <ElectricianDundeePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-edinburgh"
        element={
          <LazyRoute>
            <ElectricianEdinburghPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-exeter"
        element={
          <LazyRoute>
            <ElectricianExeterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-glasgow"
        element={
          <LazyRoute>
            <ElectricianGlasgowPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/gloucester"
        element={
          <LazyRoute>
            <ElectricianGloucesterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/guildford"
        element={
          <LazyRoute>
            <ElectricianGuildfordPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/harrogate"
        element={
          <LazyRoute>
            <ElectricianHarrogatePage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/hull"
        element={
          <LazyRoute>
            <ElectricianHullPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/electricians/inverness"
        element={
          <LazyRoute>
            <ElectricianInvernessPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-ipswich"
        element={
          <LazyRoute>
            <ElectricianIpswichPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/lancaster"
        element={
          <LazyRoute>
            <ElectricianLancasterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-leeds"
        element={
          <LazyRoute>
            <ElectricianLeedsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-leicester"
        element={
          <LazyRoute>
            <ElectricianLeicesterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/lincoln"
        element={
          <LazyRoute>
            <ElectricianLincolnPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-liverpool"
        element={
          <LazyRoute>
            <ElectricianLiverpoolPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-london"
        element={
          <LazyRoute>
            <ElectricianLondonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/luton"
        element={
          <LazyRoute>
            <ElectricianLutonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/maidstone"
        element={
          <LazyRoute>
            <ElectricianMaidstonePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-manchester"
        element={
          <LazyRoute>
            <ElectricianManchesterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-mental-health-support"
        element={
          <LazyRoute>
            <ElectricianMentalHealthSupportPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/middlesbrough"
        element={
          <LazyRoute>
            <ElectricianMiddlesbroughPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-milton-keynes"
        element={
          <LazyRoute>
            <ElectricianMiltonKeynesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-newcastle"
        element={
          <LazyRoute>
            <ElectricianNewcastlePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-northampton"
        element={
          <LazyRoute>
            <ElectricianNorthamptonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-norwich"
        element={
          <LazyRoute>
            <ElectricianNorwichPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-nottingham"
        element={
          <LazyRoute>
            <ElectricianNottinghamPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-oxford"
        element={
          <LazyRoute>
            <ElectricianOxfordPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-pension-self-employed"
        element={
          <LazyRoute>
            <ElectricianPensionGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/peterborough"
        element={
          <LazyRoute>
            <ElectricianPeterboroughPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-plymouth"
        element={
          <LazyRoute>
            <ElectricianPlymouthPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/preston"
        element={
          <LazyRoute>
            <ElectricianPrestonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-reading"
        element={
          <LazyRoute>
            <ElectricianReadingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-retirement-planning-uk"
        element={
          <LazyRoute>
            <ElectricianRetirementPlanningPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/rotherham"
        element={
          <LazyRoute>
            <ElectricianRotherhamPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-salary-birmingham"
        element={
          <LazyRoute>
            <ElectricianSalaryBirminghamPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electrician-salary-bristol"
        element={
          <LazyRoute>
            <ElectricianSalaryBristolPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-salary-london"
        element={
          <LazyRoute>
            <ElectricianSalaryLondonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-salary-manchester"
        element={
          <LazyRoute>
            <ElectricianSalaryManchesterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-sheffield"
        element={
          <LazyRoute>
            <ElectricianSheffieldPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/slough"
        element={
          <LazyRoute>
            <ElectricianSloughPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-southampton"
        element={
          <LazyRoute>
            <ElectricianSouthamptonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-stoke-on-trent"
        element={
          <LazyRoute>
            <ElectricianStokeOnTrentPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/sunderland"
        element={
          <LazyRoute>
            <ElectricianSunderlandPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-swansea"
        element={
          <LazyRoute>
            <ElectricianSwanseaPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/swindon"
        element={
          <LazyRoute>
            <ElectricianSwindonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/from-electrician-to-electrical-contractor"
        element={
          <LazyRoute>
            <ElectricianToContractorPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-tool-insurance"
        element={
          <LazyRoute>
            <ElectricianToolInsurancePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-van-setup-guide"
        element={
          <LazyRoute>
            <ElectricianVanSetupGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/warrington"
        element={
          <LazyRoute>
            <ElectricianWarringtonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/whitehaven"
        element={
          <LazyRoute>
            <ElectricianWhitehavenPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/wigan"
        element={
          <LazyRoute>
            <ElectricianWiganPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-wolverhampton"
        element={
          <LazyRoute>
            <ElectricianWolverhamptonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/worcester"
        element={
          <LazyRoute>
            <ElectricianWorcesterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-working-abroad-uk"
        element={
          <LazyRoute>
            <ElectricianWorkingAbroadPage />
          </LazyRoute>
        }
      />
      <Route
        path="/electricians/workington"
        element={
          <LazyRoute>
            <ElectricianWorkingtonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electrician-york"
        element={
          <LazyRoute>
            <ElectricianYorkPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/electric-shower-fault-finding"
        element={
          <LazyRoute>
            <ElectricShowerFaultFindingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electric-shower-keeps-tripping"
        element={
          <LazyRoute>
            <ElectricShowerTrippingRCDPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/electric-underfloor-heating-cost"
        element={
          <LazyRoute>
            <ElectricUnderfloorHeatingCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/emergency-lighting-installation-cost"
        element={
          <LazyRoute>
            <EmergencyLightingCostPage />
          </LazyRoute>
        }
      />
      <Route
        ...
        element={
          <LazyRoute>
            <EmergencyLightingInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ev-charger-error-codes"
        element={
          <LazyRoute>
            <EVChargerErrorCodesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ev-charger-installation-birmingham"
        element={
          <LazyRoute>
            <EVChargerInstallationBirminghamPage />
          </LazyRoute>
        }
      />
      <Route
        path="/ev-charger-installation-brighton"
        element={
          <LazyRoute>
            <EVChargerInstallationBrightonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ev-charger-installation-bristol"
        element={
          <LazyRoute>
            <EVChargerInstallationBristolPage />
          </LazyRoute>
        }
      />
      <Route
        path="/ev-charger-installation-cardiff"
        element={
          <LazyRoute>
            <EVChargerInstallationCardiffPage />
          </LazyRoute>
        }
      />
      <Route
        ...
        element={
          <LazyRoute>
            <EVChargerInstallationCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ev-charger-installation-edinburgh"
        element={
          <LazyRoute>
            <EVChargerInstallationEdinburghPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ev-charger-installation-glasgow"
        element={
          <LazyRoute>
            <EVChargerInstallationGlasgowPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ev-charger-installation-leeds"
        element={
          <LazyRoute>
            <EVChargerInstallationLeedsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ev-charger-installation-liverpool"
        element={
          <LazyRoute>
            <EVChargerInstallationLiverpoolPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ev-charger-installation-london"
        element={
          <LazyRoute>
            <EVChargerInstallationLondonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ev-charger-installation-manchester"
        element={
          <LazyRoute>
            <EVChargerInstallationManchesterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/ev-charger-installation-newcastle"
        element={
          <LazyRoute>
            <EVChargerInstallationNewcastlePage />
          </LazyRoute>
        }
      />
      <Route
        path="/ev-charger-installation-norwich"
        element={
          <LazyRoute>
            <EVChargerInstallationNorwichPage />
          </LazyRoute>
        }
      />
      <Route
        path="/ev-charger-installation-nottingham"
        element={
          <LazyRoute>
            <EVChargerInstallationNottinghamPage />
          </LazyRoute>
        }
      />
      <Route
        path="/ev-charger-installation-oxford"
        element={
          <LazyRoute>
            <EVChargerInstallationOxfordPage />
          </LazyRoute>
        }
      />
      <Route
        path="/ev-charger-installation-reading"
        element={
          <LazyRoute>
            <EVChargerInstallationReadingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/ev-charger-installation-sheffield"
        element={
          <LazyRoute>
            <EVChargerInstallationSheffieldPage />
          </LazyRoute>
        }
      />
      <Route
        path="/ev-charger-installation-southampton"
        element={
          <LazyRoute>
            <EVChargerInstallationSouthamptonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/ev-charger-not-working"
        element={
          <LazyRoute>
            <EVChargerNotWorkingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/ev-charging-legislation"
        element={
          <LazyRoute>
            <EVChargingLegislationUKPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/house-extension-electrical-cost"
        element={
          <LazyRoute>
            <ExtensionElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/extractor-fan-not-working"
        element={
          <LazyRoute>
            <ExtractorFanNotWorkingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/factory-electrical-installation"
        element={
          <LazyRoute>
            <FactoryElectricalInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/finding-commercial-electrical-work"
        element={
          <LazyRoute>
            <FindingCommercialWorkPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/fire-alarm-installation-cost"
        element={
          <LazyRoute>
            <FireAlarmInstallationCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/how-to-get-first-electrical-customer"
        element={
          <LazyRoute>
            <FirstElectricalCustomerPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/fixed-wiring-vs-flexible-wiring-standards"
        element={
          <LazyRoute>
            <FixedVsFlexibleWiringPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/flat-rewire-cost"
        element={
          <LazyRoute>
            <FlatRewireCostPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/flood-damaged-electrics"
        element={
          <LazyRoute>
            <FloodDamagedElectricsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/fuse-keeps-blowing"
        element={
          <LazyRoute>
            <FuseKeepsBlowingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/garage-conversion-electrical-cost"
        element={
          <LazyRoute>
            <GarageConversionElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/garage-conversion-electrical"
        element={
          <LazyRoute>
            <GarageConversionElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/garage-conversion-electrics"
        element={
          <LazyRoute>
            <GarageConversionElectricsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/garage-electrical-cost"
        element={
          <LazyRoute>
            <GarageElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/garden-electrical-wiring-regulations"
        element={
          <LazyRoute>
            <GardenElectricalWiringPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/garden-lighting-installation-cost"
        element={
          <LazyRoute>
            <GardenLightingCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/gdpr-for-electricians"
        element={
          <LazyRoute>
            <GDPRForElectriciansPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/gold-card-requirements-electrician"
        element={
          <LazyRoute>
            <GoldCardRequirementsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/google-my-business-electrician"
        element={
          <LazyRoute>
            <GoogleMyBusinessElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ground-source-heat-pump-electrical"
        element={
          <LazyRoute>
            <GroundSourceHeatPumpElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/gym-electrical-cost"
        element={
          <LazyRoute>
            <GymElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/hair-salon-electrical-cost"
        element={
          <LazyRoute>
            <HairSalonElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/health-safety-policy-electrician"
        element={
          <LazyRoute>
            <HealthSafetyPolicyElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/heat-pump-electrical-fault"
        element={
          <LazyRoute>
            <HeatPumpElectricalFaultPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/heat-pump-electrical-requirements"
        element={
          <LazyRoute>
            <HeatPumpElectricalRequirementsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/high-voltage-electrical-work-uk"
        element={
          <LazyRoute>
            <HighVoltageElectricalWorkPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/hiring-first-employee-electrician"
        element={
          <LazyRoute>
            <HiringFirstEmployeePage />
          </LazyRoute>
        }
      />
      <Route
        path="/holiday-let-electrical"
        element={
          <LazyRoute>
            <HolidayLetElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/home-office-electrical-setup"
        element={
          <LazyRoute>
            <HomeOfficeElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/hospital-electrical-installation"
        element={
          <LazyRoute>
            <HospitalElectricalInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/hot-tub-electrical-connection"
        element={
          <LazyRoute>
            <HotTubElectricalConnectionPage />
          </LazyRoute>
        }
      />
      <Route
        path="/house-extension-electrical-cost"
        element={
          <LazyRoute>
            <HouseExtensionElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/house-extension-electrical-guide"
        element={
          <LazyRoute>
            <HouseExtensionElectricalGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/humming-noise-from-consumer-unit"
        element={
          <LazyRoute>
            <HummingNoiseFromConsumerUnitPage />
          </LazyRoute>
        }
      />
      <Route
        path="/immersion-heater-fault-finding"
        element={
          <LazyRoute>
            <ImmersionHeaterFaultFindingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/immersion-heater-not-working"
        element={
          <LazyRoute>
            <ImmersionHeaterNotWorkingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/insulation-resistance-testing-guide"
        element={
          <LazyRoute>
            <InsulationResistanceTestingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/insulation-resistance-testing-bs7671"
        element={
          <LazyRoute>
            <InsulationResistanceTestingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/interwar-property-electrical"
        element={
          <LazyRoute>
            <InterwarPropertyElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/intruder-alarm-installation"
        element={
          <LazyRoute>
            <IntruderAlarmInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/jib-grading-explained"
        element={
          <LazyRoute>
            <JIBGradingExplainedPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/kitchen-electrical-regulations"
        element={
          <LazyRoute>
            <KitchenElectricalRegulationsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/kitchen-island-power-supply"
        element={
          <LazyRoute>
            <KitchenIslandPowerPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/kitchen-rewire-cost"
        element={
          <LazyRoute>
            <KitchenRewireCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/landlord-electrical-safety-checklist"
        element={
          <LazyRoute>
            <LandlordElectricalChecklistPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/landlord-electrical-safety-birmingham"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyBirminghamPage />
          </LazyRoute>
        }
      />
      <Route
        path="/landlord-electrical-safety-brighton"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyBrightonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/landlord-electrical-safety-bristol"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyBristolPage />
          </LazyRoute>
        }
      />
      <Route
        path="/landlord-electrical-safety-cambridge"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyCambridgePage />
          </LazyRoute>
        }
      />
      <Route
        path="/landlord-electrical-safety-cardiff"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyCardiffPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/landlord-electrical-safety-edinburgh"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyEdinburghPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/landlord-electrical-safety-glasgow"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyGlasgowPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/landlord-electrical-safety-leeds"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyLeedsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/landlord-electrical-safety-liverpool"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyLiverpoolPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/landlord-electrical-safety-london"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyLondonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/landlord-electrical-safety-manchester"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyManchesterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/landlord-electrical-safety-newcastle"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyNewcastlePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/landlord-electrical-safety-nottingham"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyNottinghamPage />
          </LazyRoute>
        }
      />
      <Route
        path="/landlord-electrical-safety-oxford"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyOxfordPage />
          </LazyRoute>
        }
      />
      <Route
        path="/landlord-electrical-safety-reading"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyReadingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/landlord-electrical-safety-sheffield"
        element={
          <LazyRoute>
            <LandlordElectricalSafetySheffieldPage />
          </LazyRoute>
        }
      />
      <Route
        path="/landlord-electrical-safety-southampton"
        element={
          <LazyRoute>
            <LandlordElectricalSafetySouthamptonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/landlord-electrical-safety-wolverhampton"
        element={
          <LazyRoute>
            <LandlordElectricalSafetyWolverhamptonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/led-vs-fluorescent-commercial-lighting"
        element={
          <LazyRoute>
            <LEDVsFluorescentCommercialPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/level-4-electrical-qualification"
        element={
          <LazyRoute>
            <Level4ElectricalQualificationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/lightning-protection-guide"
        element={
          <LazyRoute>
            <LightningProtectionGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/lights-dimming-when-appliance-turns-on"
        element={
          <LazyRoute>
            <LightsDimmingWhenApplianceTurnsOnPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/listed-building-rewire-cost"
        element={
          <LazyRoute>
            <ListedBuildingRewireCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/lockout-tagout-guide"
        element={
          <LazyRoute>
            <LockoutTagoutGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/loft-conversion-electrical-cost"
        element={
          <LazyRoute>
            <LoftConversionElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/loft-conversion-electrical-guide"
        element={
          <LazyRoute>
            <LoftConversionElectricalGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/marina-mooring-electrical"
        element={
          <LazyRoute>
            <MarinaMooringElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/master-electrician-uk"
        element={
          <LazyRoute>
            <MasterElectricianUKPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/mcb-vs-rcbo"
        element={
          <LazyRoute>
            <MCBVsRCBOComparisonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/multifunction-tester-buying-guide"
        element={
          <LazyRoute>
            <MFTBuyingGuidePage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/mileage-claims-electricians"
        element={
          <LazyRoute>
            <MileageClaimsElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/mod-defence-site-electrical-work"
        element={
          <LazyRoute>
            <MODDefenceSiteElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/motor-starters-installation"
        element={
          <LazyRoute>
            <MotorStartersInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/multimeter-guide-electricians"
        element={
          <LazyRoute>
            <MultimeterGuideElectriciansPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/mvhr-electrical-installation"
        element={
          <LazyRoute>
            <MVHRElectricalInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/new-build-electrical-cost-per-m2"
        element={
          <LazyRoute>
            <NewBuildElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/niceic-vs-napit-comparison"
        element={
          <LazyRoute>
            <NICEICvsNAPITComparisonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/niceic-vs-napit-vs-elecsa-comparison"
        element={
          <LazyRoute>
            <NICEICvsNAPITvsELECSAPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/no-electricity-in-part-of-house"
        element={
          <LazyRoute>
            <NoElectricityInPartOfHousePage />
          </LazyRoute>
        }
      />
      <Route
        path="/nuclear-site-electrical"
        element={
          <LazyRoute>
            <NuclearSiteElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/nuclear-site-electrical-work"
        element={
          <LazyRoute>
            <NuclearSiteElectricalWorkPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/nursery-electrical-cost"
        element={
          <LazyRoute>
            <NurseryElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/nvq-level-2-electrical-portfolio"
        element={
          <LazyRoute>
            <NVQLevel2PortfolioGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/off-grid-electrical-system"
        element={
          <LazyRoute>
            <OffGridElectricalSystemPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/offshore-electrical-work-uk"
        element={
          <LazyRoute>
            <OffshoreElectricalWorkPage />
          </LazyRoute>
        }
      />
      <Route
        path="/outbuilding-electrical-cost"
        element={
          <LazyRoute>
            <OutbuildingElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/outbuilding-electrical-supply-guide"
        element={
          <LazyRoute>
            <OutbuildingElectricalSupplyPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/outdoor-entertaining-area-electrical"
        element={
          <LazyRoute>
            <OutdoorEntertainingAreaElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/outdoor-light-not-working"
        element={
          <LazyRoute>
            <OutdoorLightNotWorkingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/outdoor-socket-installation-cost"
        element={
          <LazyRoute>
            <OutdoorSocketInstallationCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/partial-power-loss-fault-finding"
        element={
          <LazyRoute>
            <PartialPowerLossPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/partnership-vs-sole-trader-vs-ltd-electrician"
        element={
          <LazyRoute>
            <PartnershipVsSoleTraderPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/part-p-building-regulations-electrical"
        element={
          <LazyRoute>
            <PartPBuildingRegulationsGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/pat-testing-cost"
        element={
          <LazyRoute>
            <PATTestingCostPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/poe-lighting-installation"
        element={
          <LazyRoute>
            <PoELightingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/polarity-testing-guide-bs7671"
        element={
          <LazyRoute>
            <PolarityTestingPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/pricing-electrical-work-per-point"
        element={
          <LazyRoute>
            <PricingPerPointGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/pub-electrical-cost"
        element={
          <LazyRoute>
            <PubElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/pvc-vs-xlpe-vs-lsoh-cable"
        element={
          <LazyRoute>
            <PVCvsXLPECablePage />
          </LazyRoute>
      ...
      />
      <Route
        path="/quote-writing-guide"
        element={
          <LazyRoute>
            <QuoteWritingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rail-electrical-work-uk"
        element={
          <LazyRoute>
            <RailElectricalWorkPage />
          </LazyRoute>
        }
      />
      <Route
        path="/rcd-testing-guide"
        element={
          <LazyRoute>
            <RCDTestingGuidePage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/rcd-types-a-b-f-explained"
        element={
          <LazyRoute>
            <RCDTypesComparisonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/rcd-types-guide"
        element={
          <LazyRoute>
            <RCDTypesGuidePage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/regulation-314-division-of-circuits"
        element={
          <LazyRoute>
            <Regulation314CircuitDivisionPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/regulation-411-automatic-disconnection"
        element={
          <LazyRoute>
            <Regulation411AutoDisconnectionPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/regulation-418-supplementary-protection"
        element={
          <LazyRoute>
            <Regulation418SupplementaryProtectionPage />
          </LazyRoute>
        }
      />
      <Route
        path="/restaurant-electrical-cost"
        element={
          <LazyRoute>
            <RestaurantElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/restaurant-kitchen-electrical-cost"
        element={
          <LazyRoute>
            <RestaurantKitchenElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rewire-cost-birmingham"
        element={
          <LazyRoute>
            <RewireCostBirminghamPage />
          </LazyRoute>
        }
      />
      <Route
        path="/rewire-cost-bristol"
        element={
          <LazyRoute>
            <RewireCostBristolPage />
          </LazyRoute>
        }
      />
      <Route
        path="/rewire-cost-cardiff"
        element={
          <LazyRoute>
            <RewireCostCardiffPage />
          </LazyRoute>
        }
      />
      <Route
        path="/rewire-cost-edinburgh"
        element={
          <LazyRoute>
            <RewireCostEdinburghPage />
          </LazyRoute>
        }
      />
      <Route
        path="/rewire-cost-glasgow"
        element={
          <LazyRoute>
            <RewireCostGlasgowPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rewire-cost-leeds"
        element={
          <LazyRoute>
            <RewireCostLeedsPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/rewire-cost-liverpool"
        element={
          <LazyRoute>
            <RewireCostLiverpoolPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rewire-cost-london"
        element={
          <LazyRoute>
            <RewireCostLondonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/rewire-cost-manchester"
        element={
          <LazyRoute>
            <RewireCostManchesterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/rewire-cost-nottingham"
        element={
          <LazyRoute>
            <RewireCostNottinghamPage />
          </LazyRoute>
        }
      />
      <Route
        path="/rewire-cost-plymouth"
        element={
          <LazyRoute>
            <RewireCostPlymouthPage />
          </LazyRoute>
        }
      />
      <Route
        path="/rewire-cost-southampton"
        element={
          <LazyRoute>
            <RewireCostSouthamptonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/ring-vs-radial-circuits"
        element={
          <LazyRoute>
            <RingVsRadialCircuitsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/safe-isolation-procedure-electricians"
        element={
          <LazyRoute>
            <SafeIsolationProcedureGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/sauna-electrical-installation"
        element={
          <LazyRoute>
            <SaunaElectricalInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/school-electrical-cost"
        element={
          <LazyRoute>
            <SchoolElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/section-701-bathrooms-complete-guide"
        element={
          <LazyRoute>
            <Section701BathroomsGuidePage />
          </LazyRoute>
        }
      />
      <Route
      ...
      <Route
        ...
        element={
          <LazyRoute>
            <Section722EVChargingGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/security-alarm-electrical-fault"
        element={
          <LazyRoute>
            <SecurityAlarmElectricalFaultPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/security-lighting-installation-cost"
        element={
          <LazyRoute>
            <SecurityLightingCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/shed-electrical-installation"
        element={
          <LazyRoute>
            <ShedElectricalInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/shop-fit-out-electrical-cost"
        element={
          <LazyRoute>
            <ShopFitOutElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/single-phase-vs-three-phase"
        element={
          <LazyRoute>
            <SinglePhaseVsThreePhasePage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/smart-home-lighting-installation"
        element={
          <LazyRoute>
            <SmartHomeLightingInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/smart-home-wiring-cost"
        element={
          <LazyRoute>
            <SmartHomeWiringCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/smart-switch-vs-smart-bulb"
        element={
          <LazyRoute>
            <SmartSwitchVsSmartBulbPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/smoke-detector-beeping"
        element={
          <LazyRoute>
            <SmokeDetectorBeepingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/socket-sparking-when-plugging-in"
        element={
          <LazyRoute>
            <SocketSparkingWhenPluggingInPage />
          </LazyRoute>
        }
      />
      <Route
        path="/solar-battery-storage-installation"
        element={
          <LazyRoute>
            <SolarBatteryStorageInstallationPage />
          </LazyRoute>
        }
      />
      <Route
        path="/solar-panel-fault-finding"
        element={
          <LazyRoute>
            <SolarPanelFaultFindingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/solar-panel-installation-birmingham"
        element={
          <LazyRoute>
            <SolarPanelInstallationBirminghamPage />
          </LazyRoute>
        }
      />
      <Route
        path="/solar-panel-installation-bristol"
        element={
          <LazyRoute>
            <SolarPanelInstallationBristolPage />
          </LazyRoute>
        }
      />
      <Route
        path="/solar-panel-installation-cardiff"
        element={
          <LazyRoute>
            <SolarPanelInstallationCardiffPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/solar-panel-installation-electrical-cost"
        element={
          <LazyRoute>
            <SolarPanelInstallationCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/solar-panel-installation-leeds"
        element={
          <LazyRoute>
            <SolarPanelInstallationLeedsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/solar-panel-installation-london"
        element={
          <LazyRoute>
            <SolarPanelInstallationLondonPage />
          </LazyRoute>
        }
      />
      <Route
        path="/solar-panel-installation-manchester"
        element={
          <LazyRoute>
            <SolarPanelInstallationManchesterPage />
          </LazyRoute>
        }
      />
      <Route
        path="/solar-panel-installation-sheffield"
        element={
          <LazyRoute>
            <SolarPanelInstallationSheffieldPage />
          </LazyRoute>
        }
      />
      <Route
        path="/solar-pv-maintenance"
        element={
          <LazyRoute>
            <SolarPVMaintenancePage />
          </LazyRoute>
        }
      />
      <Route
        path="/solar-pv-system-design"
        element={
          <LazyRoute>
            <SolarPVSystemDesignPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/specialist-electrician-routes-uk"
        element={
          <LazyRoute>
            <SpecialistElectricianRoutesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/split-load-vs-rcbo-consumer-unit"
        element={
          <LazyRoute>
            <SplitLoadVsRCBOBoardPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/sssts-smsts-site-supervisor-guide"
        element={
          <LazyRoute>
            <SSSMTSGuidePage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/storage-heater-not-working"
        element={
          <LazyRoute>
            <StorageHeaterNotWorkingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/storm-damage-electrical-safety"
        element={
          <LazyRoute>
            <StormDamageElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/supervising-electrical-apprentices"
        element={
          <LazyRoute>
            <SupervisingApprenticesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/swimming-pool-electrical-installation"
        element={
          <LazyRoute>
            <SwimmingPoolElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/tender-writing-electrician"
        element={
          <LazyRoute>
            <TenderWritingElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        ...
        element={
          <LazyRoute>
            <TestingSequenceGuidePage_v2 />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/thermal-imaging-electrical-inspections"
        element={
          <LazyRoute>
            <ThermalImagingElectricalPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/three-phase-installation-cost"
        element={
          <LazyRoute>
            <ThreePhaseInstallationCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/earthing-systems-tns-tncs-tt-explained"
        element={
          <LazyRoute>
            <TNSvsTNCSvsTTPage />
          </LazyRoute>
      ...
      />
      <Route
        path="/guides/trip-switch-keeps-going-off"
        element={
          <LazyRoute>
            <TripSwitchKeepsGoingOffPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/troubleshooting-high-earth-leakage"
        element={
          <LazyRoute>
            <TroubleshootingHighEarthLeakagePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/underfloor-heating-electrical-cost"
        element={
          <LazyRoute>
            <UnderfloorHeatingElectricalCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/underfloor-heating-fault-finding"
        element={
          <LazyRoute>
            <UnderfloorHeatingFaultFindingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/usb-socket-not-charging"
        element={
          <LazyRoute>
            <USBSocketNotChargingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/utr-number-electrician"
        element={
          <LazyRoute>
            <UTRNumberElectricianPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/vehicle-to-grid-installation"
        element={
          <LazyRoute>
            <V2GInstallationGuidePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/victorian-terrace-consumer-unit-upgrade"
        element={
          <LazyRoute>
            <VictorianTerraceConsumerUnitUpgradePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/victorian-terrace-electrical-requirements"
        element={
          <LazyRoute>
            <VictorianTerraceElectricalRequirementsPage />
          </LazyRoute>
        }
      />
      <Route
        path="/victorian-house-rewire"
        element={
          <LazyRoute>
            <VictorianHouseRewirePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/warehouse-lighting-cost"
        element={
          <LazyRoute>
            <WarehouseLightingCostPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/warm-plug-or-socket"
        element={
          <LazyRoute>
            <WarmPlugOrSocketPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/working-with-other-trades-electrician"
        element={
          <LazyRoute>
            <WorkingWithOtherTradesPage />
          </LazyRoute>
        }
      />
      <Route
        path="/workplace-ev-charging"
        element={
          <LazyRoute>
            <WorkplaceEVChargingPage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/year-3-electrical-apprentice"
        element={
          <LazyRoute>
            <Year3ElectricalApprenticePage />
          </LazyRoute>
        }
      />
      <Route
        path="/guides/year-4-electrical-apprentice"
        element={
          <LazyRoute>
            <Year4ElectricalApprenticePage />
          </LazyRoute>
        }
      />
      <Route
      ...
      />
      <Route
        path="/guides/poe-structured-cabling-hub"
        element={
          <LazyRoute>
            <PoEStructuredCablingHubPage />
          </LazyRoute>
        }
      />
      <Route
