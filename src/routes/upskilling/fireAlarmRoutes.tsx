...
export const fireAlarmRoutes = (
  <>
    ...
    {/* Module 1: Categories of Fire Alarm Systems (4 sections) */}
    <Route path="fire-alarm-course/module-1" element={<FireAlarmModule1 />} />
    <Route path="fire-alarm-course/module-1/section-1" element={<FireAlarmModule1Section1 />} />
    <Route path="fire-alarm-course/module-1/section-2" element={<FireAlarmModule1Section2 />} />
    <Route path="fire-alarm-course/module-1/section-3" element={<FireAlarmModule1Section3 />} />
    <Route path="fire-alarm-course/module-1/section-4" element={<FireAlarmModule1Section4 />} />

    {/* Module 2: Detectors, Call Points & Devices (5 sections) */}
    <Route path="fire-alarm-course/module-2" element={<FireAlarmModule2 />} />
    <Route path="fire-alarm-course/module-2/section-1" element={<FireAlarmModule2Section1 />} />
    <Route path="fire-alarm-course/module-2/section-2" element={<FireAlarmModule2Section2 />} />
    <Route path="fire-alarm-course/module-2/section-3" element={<FireAlarmModule2Section3 />} />
    <Route path="fire-alarm-course/module-2/section-4" element={<FireAlarmModule2Section4 />} />
    <Route path="fire-alarm-course/module-2/section-5" element={<FireAlarmModule2Section5 />} />

    {/* Module 3: System Design & Zone Planning (6 sections) */}
    <Route path="fire-alarm-course/module-3" element={<FireAlarmModule3 />} />
    <Route path="fire-alarm-course/module-3/section-1" element={<FireAlarmModule3Section1 />} />
    <Route path="fire-alarm-course/module-3/section-2" element={<FireAlarmModule3Section2 />} />
    <Route path="fire-alarm-course/module-3/section-3" element={<FireAlarmModule3Section3 />} />
    <Route path="fire-alarm-course/module-3/section-4" element={<FireAlarmModule3Section4 />} />
    <Route path="fire-alarm-course/module-3/section-5" element={<FireAlarmModule3Section5 />} />
    <Route path="fire-alarm-course/module-3/section-6" element={<FireAlarmModule3Section6 />} />

    {/* Module 4: Power Supply, Backup & Cabling (5 sections) */}
    <Route path="fire-alarm-course/module-4" element={<FireAlarmModule4 />} />
    <Route path="fire-alarm-course/module-4/section-1" element={<FireAlarmModule4Section1 />} />
    <Route path="fire-alarm-course/module-4/section-2" element={<FireAlarmModule4Section2 />} />
    <Route path="fire-alarm-course/module-4/section-3" element={<FireAlarmModule4Section3 />} />
    <Route path="fire-alarm-course/module-4/section-4" element={<FireAlarmModule4Section4 />} />
    <Route path="fire-alarm-course/module-4/section-5" element={<FireAlarmModule4Section5 />} />

    {/* Module 5: Installation & Commissioning (6 sections) */}
    <Route path="fire-alarm-course/module-5" element={<FireAlarmModule5 />} />
    <Route path="fire-alarm-course/module-5/section-1" element={<FireAlarmModule5Section1 />} />
    <Route path="fire-alarm-course/module-5/section-2" element={<FireAlarmModule5Section2 />} />
    <Route path="fire-alarm-course/module-5/section-3" element={<FireAlarmModule5Section3 />} />
    <Route path="fire-alarm-course/module-5/section-4" element={<FireAlarmModule5Section4 />} />
    <Route path="fire-alarm-course/module-5/section-5" element={<FireAlarmModule5Section5 />} />
    <Route path="fire-alarm-course/module-5/section-6" element={<FireAlarmModule5Section6 />} />

    {/* Module 6: Testing, Servicing & Certification (6 sections) */}
    <Route path="fire-alarm-course/module-6" element={<FireAlarmModule6 />} />
    <Route path="fire-alarm-course/module-6/section-1" element={<FireAlarmModule6Section1 />} />
    <Route path="fire-alarm-course/module-6/section-2" element={<FireAlarmModule6Section2 />} />
    <Route path="fire-alarm-course/module-6/section-3" element={<FireAlarmModule6Section3 />} />
    <Route path="fire-alarm-course/module-6/section-4" element={<FireAlarmModule6Section4 />} />
    <Route path="fire-alarm-course/module-6/section-5" element={<FireAlarmModule6Section5 />} />
    <Route path="fire-alarm-course/module-6/section-6" element={<FireAlarmModule6Section6 />} />

    {/* Module 7: Regulatory Compliance & BS 5839 (4 sections) */}
    <Route path="fire-alarm-course/module-7" element={<FireAlarmModule7 />} />
    <Route path="fire-alarm-course/module-7/section-1" element={<FireAlarmModule7Section1 />} />
    <Route path="fire-alarm-course/module-7/section-2" element={<FireAlarmModule7Section2 />} />
    <Route path="fire-alarm-course/module-7/section-3" element={<FireAlarmModule7Section3 />} />
    <Route path="fire-alarm-course/module-7/section-4" element={<FireAlarmModule7Section4 />} />

    {/* Mock Exam */}
    <Route path="fire-alarm-course/mock-exam" element={<FireAlarmMockExam />} />
  </>
);
