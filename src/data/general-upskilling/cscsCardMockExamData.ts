...
export const cscsCardQuestionBank: StandardMockQuestion[] = [
  ...
  },
  {
    ...
    options: ['Gold', 'White', 'Black', 'Green'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['CPCS', 'CISRS', 'ECS/JIB', 'IPAF'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['NICEIC and NAPIT', 'JIB and SELECT', 'IET and BSI', 'CITB and HSE'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Yellow triangle', 'Blue circle', 'Green rectangle or square', 'Red circle'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Mandatory sign', 'Warning sign', 'Prohibition sign', 'Fire equipment sign'],
    correctAnswer: 2,
    explanation:
  ...
  // Questions 101-200 (CSCS Card Preparation)
  {
    ...
    options: [
      ...
      'It does not require an anchor point',
      'It can be shared between multiple workers simultaneously',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It is the fear of heights that develops after a fall',
      'It is bruising caused by harness straps during a fall',
      ...
      'It is the psychological impact of witnessing a colleague fall',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only walk on the roof purlins and avoid the sheeting',
      'Install crawling boards or stagings spread across the roof structure and use fall arrest equipment',
      'Test the surface by applying weight gradually before walking on it',
      'Only access the roof during dry weather conditions',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Tag it for repair by the manufacturer',
      'Continue using it if the metal components are undamaged',
      'Remove it from service immediately and arrange for disposal or return to manufacturer',
      'Reduce the maximum working load by 50%',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'The horizontal distance a worker can travel while attached to a lanyard',
  ...
  },
  {
    ...
    options: [
      'Only if the roof is more than 3 metres high',
      'Only when work is being carried out within 2 metres of the edge',
      'Whenever there is a risk of a person falling from the edge, regardless of height',
      'Only during wet or windy weather conditions',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Train the worker in correct lifting technique and allow them to continue',
      'Provide a mechanical lifting aid such as a vacuum lifter or pallet to workbench height conveyor',
      'Ask two workers to share the lifting throughout the day',
      'Reduce the number of lifts to fewer than 10 per hour',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Ban all hazardous substances from the workplace',
      'Assess and control exposure to hazardous substances to prevent ill health',
      'Provide gas masks to all employees',
      'Report all chemical purchases to the HSE',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only the price and supplier details of the chemical',
      'Hazard identification, first aid measures, handling and storage, exposure controls, and disposal information',
      'A list of alternative products that could be used instead',
      'The date the substance was manufactured and its expiry date only',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The maximum number of hours a worker can be exposed to any hazard',
      ...
      'The minimum ventilation rate required in an enclosed workspace',
  ...
  },
  {
    ...
    options: [
      'To provide fresh air for workers in a confined space',
      'To capture airborne contaminants at or near the source before they spread into the workplace',
      'To cool down hot work areas during summer months',
      'To remove odours from welfare facilities',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A skin condition caused by contact with asbestos fibres',
      'A cancer of the lining of the lungs or abdomen almost exclusively caused by asbestos exposure',
      'A respiratory infection common among construction workers',
      'An allergic reaction to asbestos dust',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'An infection of the lungs caused by inhaling asbestos',
      'A temporary irritation of the airways that resolves after exposure stops',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Try to clean it up quickly using a dustpan and brush',
      'Stop work immediately, warn others, evacuate the area, and report to your supervisor',
      'Wet the material down and place it in a black bin bag',
      'Continue working but put on a dust mask',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To keep the site looking tidy for client visits',
      'To reduce airborne dust levels and protect workers from respiratory diseases such as silicosis',
      'To prevent dust from damaging machinery',
      'To comply with planning permission conditions only',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It will cause flooding downstream',
      'It is highly alkaline and toxic to aquatic life, and can block fish gills',
      'It will increase the water temperature',
      'It will improve the water clarity by settling out particles',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'In a single-skinned tank on bare ground near the watercourse for easy access',
      'In a double-skinned (bunded) tank with a capacity of 110% of the stored volume, sited away from drains and watercourses',
      'In open-top drums covered with tarpaulin',
      'In underground tanks that do not require any secondary containment',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Employing more than 10 workers on a construction site',
      'Activities that may pollute the environment, such as waste operations, water discharges, or certain industrial processes',
      'Any work within 50 metres of a residential property',
      'Using power tools after 6 pm on weekdays',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Relocate the species to the nearest park',
      'Stop work in the affected area immediately and seek advice from a qualified ecologist',
      'Continue working but avoid the area for 24 hours',
      'Report the discovery to the local council and continue work',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Persistent headaches after using vibrating tools',
  ...
  },
  {
    ...
    options: [
      ...
      'It must be a full-face mask regardless of the hazard',
  ...
  },
  {
    ...
    options: [
      ...
      'Orange with a black skull symbol',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To record the names of workers who have been exposed to asbestos',
      'To document the location, type, and condition of known or presumed asbestos-containing materials in the building',
      'To list all licensed asbestos removal contractors',
      'To record the dates of annual asbestos air monitoring tests',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To calculate the cost of purchasing hazardous substances',
      ...
      'To decide which workers should be assigned to work with chemicals',
      'To comply with fire safety regulations for chemical storage',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Ordering trench sheets and props',
      'Identifying the location of underground services using plans, a CAT scanner, and trial holes',
      'Hiring a banksman to direct excavation machinery',
      'Applying for a road closure permit',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To cut through underground cables safely',
      'To detect the presence and approximate position of underground cables and pipes',
      'To measure the voltage of buried electrical cables',
      'To provide a physical barrier over underground services',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "It powers the CAT scanner's batteries",
      'It applies a detectable signal to a specific service, making it easier for the CAT to locate',
      'It automatically maps all underground services in the area',
      'It neutralises electrical current in buried cables to make them safe',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Posting a banksman at each end of the overhead line',
      'Installing goal posts (barrier gates) with a visible height restriction to prevent tall plant from passing underneath',
      'Painting a line on the ground beneath the cables',
      'Issuing a written warning to all drivers',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Dewatering, compaction, and grouting',
      'Concreting, piling, and sheet stacking',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Any worker entering the excavation',
      'A competent person, at the start of each shift and after any event likely to have affected stability',
      'The site manager once per week',
      "The client's health and safety adviser at monthly intervals",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Any room smaller than 10 square metres',
      ...
      'Any underground chamber regardless of ventilation',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only oxygen levels need to be checked',
      'Oxygen, flammable gases, and toxic gases must all be tested using a calibrated multi-gas detector',
      'A visual inspection of the air quality is sufficient',
      'Monitoring is only needed if the space has been sealed for more than 24 hours',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      '110 V tools are lighter and easier to handle',
      'In a fault condition, the maximum voltage to earth is only 55 V, reducing the risk of fatal electric shock',
      '110 V tools cannot produce sparks',
      '110 V cables are waterproof',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'That all electrical work is carried out by a qualified electrician',
      'That all electrical systems are constructed, maintained, and used to prevent danger, so far as is reasonably practicable',
      'That all workplaces switch to 110 V supply',
      'That electrical equipment is replaced every 5 years',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A minor cut that requires only a plaster',
      'A worker taking 2 days off work due to a workplace injury',
      'A fracture of any bone (other than fingers, thumbs, or toes) caused by a workplace accident',
      'A near miss that did not result in any injury',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A worker slipping on a wet floor but not being injured',
      'The collapse or partial collapse of a scaffold over 5 metres in height',
      'A delivery lorry arriving late to site',
      'A worker receiving a verbal warning for not wearing PPE',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Grab them and pull them away from the source immediately',
      ...
      'Pour water on the person to break the electrical circuit',
      'Wait for the electricity to trip out automatically before approaching',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Traffic congestion and public complaints',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To record who has entered the space for payroll purposes',
      ...
      'To allow workers to enter the space without a supervisor present',
      'To waive the requirement for atmospheric monitoring',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The most senior manager on the construction site',
      ...
      'The first person to enter the confined space to check it is safe',
      'The person who signs the permit to work',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'A point where the fire brigade will set up their command post',
      'A secure area where flammable materials are stored',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Working on electrical equipment that is faulty but still connected to the supply',
      'Working overnight when electrical demand is lowest',
  ...
  },
  {
    ...
    options: [
      'A mini excavator with a toothed bucket',
      'Hand digging using non-metallic tools (hand tools or vacuum excavation)',
      'A mechanical excavator with a flat-bladed bucket',
      'A road saw to cut a trench through the surface',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only the name and telephone number of the fire brigade',
      ...
      'Only the date of the last fire drill',
      "The site manager's home telephone number and a map of the nearest fire station",
    ],
    correctAnswer: 1,
    explanation:
