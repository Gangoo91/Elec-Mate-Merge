...
export const firstAidQuestionBank: StandardMockQuestion[] = [
  ...
  },
  {
    ...
    options: ['2–3 cm', '3–4 cm', '5–6 cm', '7–8 cm'] as [string, string, string, string],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Consciousness', 'Cervical spine', 'Catastrophic bleeding', 'Circulation'] as [
      string,
      string,
      string,
      string,
  ...
  },
  {
    ...
    options: ['Laceration', 'Incision', 'Abrasion', 'Contusion'] as [
      string,
      string,
      string,
      string,
...

  {
    ...
    options: ['5 minutes', '10 minutes', '20 minutes', '30 minutes'] as [
      string,
      string,
      string,
      string,
  ...
  },
  {
    ...
    options: ['1%', '9%', '18%', '36%'] as [string, string, string, string],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['18%', '27%', '36%', '45%'] as [string, string, string, string],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['18%', '27%', '36%', '54%'] as [string, string, string, string],
    correctAnswer: 2,
    explanation:
  ...
  // --- HYPOTHERMIA (basic / intermediate / advanced) ---
  {
    ...
    options: ['Below 37°C', 'Below 36°C', 'Below 35°C', 'Below 33°C'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "Both reasons are correct. A hypothermic casualty may have reduced sensation and cannot feel burns from direct heat. Additionally, rapid peripheral rewarming causes vasodilation, which floods the core with cold blood from the extremities. This sudden drop in core temperature — called 'afterdrop' — can trigger fatal cardiac arrhythmias.",
    section: 'Module 4',
    difficulty: 'advanced' as const,
    topic: 'Hypothermia Treatment',
    category: 'Medical Emergencies' as const,
  ...
  },
  {
    ...
    options: ['1 employee', '5 employees', '10 employees', '25 employees'],
    correctAnswer: 2,
    explanation:
