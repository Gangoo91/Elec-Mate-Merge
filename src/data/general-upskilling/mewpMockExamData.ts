...
export const mewpQuestionBank: StandardMockQuestion[] = [
  ...
  // --- intermediate (16) ---
  {
    ...
    options: [
      'The MEWP manufacturer for the lifetime of the machine',
      'The employer or person who controls the equipment',
      'The individual operator using the machine that day',
  ...
  },
  {
    ...
    options: [
      'Greater ground clearance for crossing rough construction terrain',
      'A higher maximum working height than any diesel equivalent',
      'A larger fuel tank giving longer continuous run times outdoors',
  ...
  },
  {
    ...
    options: [
      ...
      'The defect can be noted on the report and repaired at the next service',
      'The operator may use the machine if they avoid the affected function',
      'The machine must be taken out of service immediately',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Humidity, air pressure, pollen count, and UV index',
      'Cloud cover, sunrise time, moon phase, and tide times',
      'Dust levels, background noise, vibration, and odour',
    ],
    correctAnswer: 0,
    explanation:
  ...
  // --- advanced (6) ---
  {
    ...
    options: [
      'Use spreader pads to stay within the 30-tonne limit',
      'Do not position the machine on the deck',
      'Remove the counterweights to get below 30 tonnes',
      'Drive on quickly so each point is loaded only briefly',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Continue working at the same height, as 11 m/s is within the safe limit',
      'Increase to maximum height quickly to finish before the wind rises',
      'Carry on but ask a banksman to watch the platform for excessive sway',
      'Prepare to cease operations and lower the platform to a safe position',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Every 12 months or in accordance with an examination scheme',
      'Every 6 months or in accordance with an examination scheme',
      'Every 3 months without exception',
      'Only before the machine is hired out to a new user',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A restraint system is used only in scissor lifts, while a fall arrest system is used only in boom lifts',
      'A restraint system uses a longer lanyard with an energy absorber, while a fall arrest system uses a short fixed lanyard',
      'A restraint system is worn over clothing, while a fall arrest system must be worn against the body underneath',
      'A restraint system prevents the wearer from reaching the platform edge; a fall arrest system stops a fall in progress',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'They must be kept available and any defects recorded',
...

  {
    ...
    options: [
      'The machine may continue in use as no visible damage was caused',
      'A thorough examination must be carried out before the machine is used again',
      'Only a pre-use visual inspection by the operator is required before further use',
      'The machine can be used until its next scheduled six-monthly examination',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Whether the surface is paved, since a paved area will carry the outrigger loads',
      'Whether there are underground voids, buried services, slopes, or soft ground',
      'The distance to the nearest building line and any overhead obstruction',
      'That the ground has been dry for 24 hours and shows no standing water',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Every 6 months',
      'Every 3 years',
      'When visible damage is noticed',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Waterproof overalls, knee pads, a dust mask, and ear plugs',
      'Hard hat, high-visibility clothing, safety boots, and gloves',
      'A face shield, chemical apron, rubber boots, and barrier cream',
      'Welding gauntlets, a respirator, sun cream, and a back support belt',
    ],
    correctAnswer: 1,
    explanation:
...

  {
    ...
    options: [
      'Use the machine, as a thorough pre-use inspection by the operator can stand in place of the examination',
      'Use the machine for the urgent task only, then arrange the thorough examination immediately afterwards',
      'Carry out a pre-use inspection and proceed if no faults are found, recording it in the machine logbook',
      'Refuse to use the machine; under LOLER the thorough examination must be current before it can be used to lift persons',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Obtain ground bearing data and consult a structural engineer before siting',
      'Deploy the outriggers and elevate slowly, watching for any sign of the surface cracking',
      'Use the largest available spreader pads, as these guarantee the basement roof will hold',
      'Position the machine over the strongest-looking part of the pavement and proceed',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The defect may be noted and the machine used for two more weeks as the competent person advised',
      'The defect should be monitored daily and the machine kept in use until the repair is scheduled',
      'The defect must be recorded in the report and the machine must be taken out of service immediately',
      'The competent person can issue a temporary permit allowing reduced-load use until repair',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'No, because fall arrest lanyards should never be used in boom lifts',
      'Yes, because 6.5 metres of fall distance fits under a 9-metre platform',
      'Yes, because the energy absorber limits the arrest force to a safe level',
      'No, because a shorter fall arrest lanyard should be fitted instead',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To operate the ground controls at all times while the platform is elevated',
      'To guide the operator, watch for hazards, and communicate using hand signals or radio',
      'To record the running hours of the machine for hire and billing purposes each day',
      'To hold the base of the MEWP steady while the boom is slewed or extended',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Both arms held straight out horizontally to the sides',
      'One arm pointing down towards the ground repeatedly',
      'Both hands rotating in circles above the head',
  ...
  },
  {
    ...
    options: [
      ...
      'A single warning sign placed at the entrance to the site',
      'A verbal warning to drivers given by the operator from the platform',
      'Reducing the speed of the MEWP while it travels along the road',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only the weight of the operators, as tools are excluded from the SWL',
      'The heaviest single item being lifted onto the platform',
      'The weight of all persons, tools, materials, and equipment on the platform',
      'The weight of the materials only, since the platform is rated for two people',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Entrapment is the boom seizing in position; it is prevented by regular hydraulic servicing',
      'Entrapment is the operator being locked out of the controls; it is prevented by carrying a spare key',
      'Entrapment is the platform sticking at height; it is prevented by testing the descent before work',
      'Entrapment is when the operator or platform is crushed between the MEWP and a fixed structure',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A full exclusion zone with barriers set by the fall zone and risk assessment, warning signs, and a banksman to manage public access',
      'A single line of cones placed around the machine, with the operator watching for pedestrians approaching the fall zone',
      'A verbal request to passers-by to keep clear of the area whenever the platform is elevated above head height',
      'Working only during quiet periods such as early morning, when physical barriers are not needed',
    ],
    correctAnswer: 0,
    explanation:
      'Working in public areas requires enhanced precautions including a full exclusion zone with barriers positioned to cover the machine’s fall/drop zone and reach (the distance set by the risk assessment, not a single fixed figure), clearly visible warning signs, and a dedicated banksman to manage public access and prevent entry into the danger zone. The public cannot be expected to understand MEWP hazards, so physical barriers are essential.',
    section: 'Module 4',
    difficulty: 'basic',
    topic: 'Public areas',
    category: 'Safe Operation',
  ...
  },
  {
    ...
    options: [
      'The manufacturer specifies maximum elevated travel speeds',
      'There is no limit; the operator judges a safe elevated speed',
      'The same speed as stowed travel is permitted when elevated',
      'Half road speed is permitted once the platform is raised',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Emergency stop, retry auxiliary lowering, then summon assistance from ground',
      'Climb down the boom structure to the ground as quickly as possible before the platform drops',
      'Wait quietly in the platform for a repair engineer to arrive the following morning',
      'Tie a rope to the guardrail and abseil down to the ground without specialist equipment',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A sudden loss of grip strength caused by fatigue while working at height',
      'Blood pooling in the legs when a person is suspended in a harness',
      'Disorientation caused by the platform swaying in high winds at height',
      'Muscle cramp brought on by standing in a confined platform for long periods',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Current guidance (Resuscitation Council UK / HSE) is to lay a rescued suspension-trauma casualty flat, keep them still and treat as a medical emergency, calling 999. The older advice to keep the casualty upright or semi-recumbent (to avoid a sudden "reflow" of pooled blood) is no longer recommended, as it is not supported by the evidence and can delay treatment of shock. If unresponsive and not breathing normally, start CPR.',
    section: 'Module 5',
    difficulty: 'intermediate',
    topic: 'Suspension trauma',
    category: 'Emergency & Rescue',
  ...
  },
  {
    ...
    // The stem asks for a DIFFERENCE, but the key described only one of the two
    // devices ("The APU provides powered hydraulic control") — half an answer to
    // a comparison question, and pre-existing in HEAD rather than introduced by
    // the distractor work. The second half is restored from this question's own
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'With an unresponsive operator suspended in a harness, the priority is speed — suspension trauma is a recognised risk if rescue is delayed. The rescue team must lower the casualty to the ground as quickly as possible using ground controls or emergency lowering and call for immediate medical assistance (999). Once down, lay the casualty flat and treat as a medical emergency; if unresponsive but breathing normally, use the recovery position, and if not breathing normally start CPR. (Current Resuscitation Council UK / HSE guidance no longer recommends keeping the casualty upright.) Evidence gathering is secondary to saving life.',
    section: 'Module 5',
    difficulty: 'advanced',
    topic: 'Suspension trauma',
    category: 'Emergency & Rescue',
  ...
  },
  {
    ...
    options: [
      'Continue moving the boom in different directions until the operator comes free',
      'Lower the platform fully and drive the machine away from the steel beam',
      'Leave the controls and climb up to the platform to free the operator by hand',
      'Emergency stop to halt movement, call 999, then use ground-level controls',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Zone-specific rescue procedures naming method, trained people and equipment',
      'A single generic rescue procedure applied identically to every zone regardless of its hazards',
      'A note stating that the emergency services will deal with any rescue across all zones',
      'A rescue plan covering only the highest-risk zone, since the others are lower priority',
    ],
    correctAnswer: 0,
    explanation:
...

  {
    ...
    options: [
      ...
      'A bruise sustained when knocking against the platform rail',
      'A sprained wrist that heals within three days off work',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A flat tyre discovered during the pre-use inspection before the machine was taken into use',
      'A minor hydraulic oil leak found and repaired before the machine was used on the site',
      'An operator forgetting to clip on their harness lanyard while working in a scissor lift',
...

  {
    ...
    options: [
      'Take no action yet, as near-misses by definition caused no harm and may not recur',
      'Ban all MEWP use on site permanently to remove the overturn risk entirely',
      'Wait until a fourth near-miss occurs before deciding whether action is justified',
      'Analyse the near-misses for root cause and act before harm occurs',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Report to the HSE immediately by phone, in writing within 10 days',
      'Report in writing within 15 days, then return the machine to service',
      'Notify the hire company and insurer; the coroner tells the HSE',
      'Clear the scene to reopen the site and report at the next safety meeting',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Issue a single company memo reminding operators to be careful near structures',
      'Fit secondary guarding across the whole boom fleet and retrain operators',
      'Rely solely on operators holding valid PAL cards, as training alone prevents entrapment',
      'Fit secondary guarding to new machines only, leaving the existing fleet unchanged',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Operator error alone, as the operator exceeded the rated capacity of the platform',
      'Bad weather alone, since the heavy rain was an unforeseeable act of nature',
      'A management system failure across supervision, ground assessment and planning',
      'A mechanical fault alone, as the outriggers should have deployed automatically',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Present both figures in a lessons learnt briefing and act on the entrapment trend',
      'Share only the 26% fatality decrease with the workforce, as positive news improves morale',
      'Take no action, since the figures are global and may not reflect your own sites',
      'Wait for an entrapment incident on one of your sites before reviewing any controls',
    ],
    correctAnswer: 0,
    explanation:
  ...
  {
    id: 211,
    question: 'In the fall protection hierarchy for work at height, how is a MEWP best classified?',
    options: [
      'Work equipment that can prevent a person falling',
      'Personal protective equipment for arresting a fall',
      'A means of minimising the distance of a fall',
      'A last resort where no other access is possible',
    ],
    correctAnswer: 0,
    explanation:
      'HSE guidance on selecting and using MEWPs places them among the work equipment that prevents a fall, because the operator works from inside a guarded platform and is never allowed to reach a fall position. Calling a MEWP a last resort is the attractive wrong answer, but that label belongs to personal fall arrest, which only limits the consequences once a fall has already started. Collective prevention such as a MEWP or a scissor lift is chosen ahead of personal protection.',
    section: 'Module 2',
    difficulty: 'basic',
  ...
  {
    id: 212,
    question: 'Who is responsible for carrying out the basic daily or pre-use function check on a MEWP?',
    options: [
      'The competent person doing the thorough examination',
      'The hire company engineer on the day of delivery only',
      'The trained operator who is going to use the machine',
      'The site manager before the machine is signed for',
    ],
    correctAnswer: 2,
    explanation:
      'HSE guidance is explicit that the trained operator carries out the basic daily or pre-use function check, and that records of those checks should be kept. The thorough examination is a separate legal duty carried out by a competent person at long intervals, so relying on it confuses a periodic engineering assessment with the daily check that catches a fault before this shift. A delivery inspection also does not help on day five of a three week job.',
    section: 'Module 3',
    difficulty: 'basic',
    topic: 'Pre-Use Inspection',
    category: 'Inspections & Setup',
  ...
  {
    id: 213,
    question: 'In a boom-type MEWP, what is the purpose of wearing a full body harness with a short lanyard?',
    options: [
      'To arrest a fall once the operator has left the basket',
      'To restrain the operator so a fall position is not reached',
      'To allow the operator to abseil down if the boom fails',
      'To secure tools and materials carried in the basket',
    ],
    correctAnswer: 1,
    explanation:
      'The harness and lanyard in a boom MEWP form a work restraint system. The lanyard is deliberately short so the wearer physically cannot get to a position from which a fall is possible, which matters because the real hazard is being catapulted out of the basket when the boom jolts or tilts. Treating it as fall arrest is the dangerous misconception, because arrest assumes the person leaves the platform and then swings or drops, and a basket at height is no place to be dangling on a line.',
    section: 'Module 6',
    difficulty: 'basic',
    topic: 'Harness and Restraint',
    category: 'Safety & Best Practice',
  },
  {
    id: 214,
    question: 'Why is a boom-type MEWP often less suitable than a scissor lift for installing long containment runs?',
    options: [
      'Boom machines cannot be driven while the platform is raised',
      'Boom baskets are smaller and the platform can bounce at height',
      'Boom machines are only rated for use inside a finished building',
      'Boom machines have no facility to carry a second person aloft',
    ],
    correctAnswer: 1,
    explanation:
      'HSE guidance notes that boom MEWPs generally have smaller baskets and lower lift capacities than scissor types, and that the platform can bounce at height as the boom structure flexes, which makes them a poor choice for long, heavy or bulky material. The suggestion that a boom cannot travel elevated is the plausible trap, because many booms can be driven raised within their rated limits, so it is basket size, capacity and platform stability that decide the selection here.',
    section: 'Module 2',
    difficulty: 'advanced',
    topic: 'Machine Selection',
    category: 'Legislation & Types',
  ...
  {
    id: 215,
    question: 'An operator manoeuvres upward through steelwork while crouched over the control panel. Why is this dangerous?',
    options: [
      'Crouching can hold the control lever on and drive the platform into steel',
      'Crouching moves the load outside the marked safe working load of the basket',
      'Crouching stops the tilt alarm from sensing the angle of the work platform',
      'Crouching prevents the boom from slewing through its full working arc',
    ],
    correctAnswer: 0,
    explanation:
      'HSE guidance states plainly that manoeuvring the basket while crouched over the control panel to duck an overhead obstruction is dangerous and should not be done. The body can press and hold the control on, so the platform keeps rising and pins the operator against the structure with no way to release it, which is the classic sustained involuntary operation entrapment. Overload is the attractive wrong answer, but posture does not change the weight in the basket, and the overload system would not detect a crushing hazard anyway.',
    section: 'Module 6',
    difficulty: 'advanced',
    topic: 'Entrapment',
    category: 'Safe Operation',
  ...
  {
    id: 216,
    question: 'MEWPs use proportional controls. What should the operator expect if the controls are released abruptly near a structure?',
    options: [
      'The platform stops instantly and the brakes lock the boom in position',
      'The platform may continue to move briefly before it comes to rest',
      'The platform automatically reverses away from the nearest obstruction',
      'The platform drops to creep speed and the overload alarm operates',
    ],
    correctAnswer: 1,
    explanation:
      'Proportional controls give smooth movement, but HSE guidance warns of run-on, where the platform carries on moving for a short time after the controls are let go. Close to a beam or soffit that residual travel is exactly what closes the gap and crushes the operator, so movement near structures must be slow and stopped early. Assuming an instant stop is the dangerous belief, because no MEWP guarantees it and the machine has no sensor that steers you away from an obstruction.',
    section: 'Module 6',
    difficulty: 'advanced',
    topic: 'Entrapment',
    category: 'Safe Operation',
  ...
  {
    id: 217,
    question: 'What is the purpose of a secondary guarding device fitted to a MEWP work platform?',
    options: [
      'To stop the machine being used by anyone who is not authorised',
      'To cut the engine if the machine is parked on too steep a slope',
      'To warn the ground crew that the safe working load is exceeded',
      'To prevent or reduce the consequences of trapping and crushing',
    ],
    correctAnswer: 3,
    explanation:
      'Where there are adjacent or overhead structures an operator could be trapped or crushed against, HSE guidance says to consider selecting a MEWP fitted with a secondary guarding device that prevents that outcome or reduces its severity. It exists solely because entrapment injuries are serious and often fatal. Confusing it with the overload alarm is the common error, because that device protects machine stability from too much weight, not the person from the structure overhead.',
    section: 'Module 6',
    difficulty: 'advanced',
    topic: 'Entrapment',
    category: 'Legislation & Types',
  ...
  {
    id: 218,
    question: 'Before any electrician is lifted in a MEWP on site, what must the emergency and rescue plan already identify?',
    options: [
      'Nominated trained people at ground level who can lower the platform',
      'The nearest hospital with a specialist crush injury treatment unit',
      'The name of the person who will call the emergency services first',
      'The maximum time an operator may remain in a raised work platform',
    ],
    correctAnswer: 0,
    explanation:
      'HSE guidance requires the emergency and rescue plan to name trained, site-based people who are available to lower the platform using the ground controls or emergency descent system if the operator aloft gets into difficulty, and those people should practise it. The plan has to exist before the first lift, not be improvised during one, because a trapped operator can be suspended against their own chest in minutes. Knowing the nearest hospital is sensible but treats the aftermath rather than getting the person down.',
    section: 'Module 6',
    difficulty: 'advanced',
    topic: 'Rescue',
    category: 'Emergency & Rescue',
  ...
  {
    id: 219,
    question: 'A method statement says that if an operator is trapped, the fire and rescue service will be called to recover them. What is wrong with this?',
    options: [
      'The fire and rescue service will not attend a private work site',
      'Only the machine supplier is permitted to lower a raised platform',
      'A rescue plan must not rely entirely on the emergency services',
      'The emergency services must be told before any lift takes place',
    ],
    correctAnswer: 2,
    explanation:
      'HSE work at height guidance says to plan for emergencies and rescue and not to rely entirely on the emergency services in that plan. Someone trapped against a beam or slumped in a harness needs to come down in minutes, and a response time cannot be guaranteed. The idea that only the supplier may lower the platform is the plausible distractor, but the ground and emergency descent controls are provided precisely so that trained site personnel can recover the platform themselves.',
    section: 'Module 6',
    difficulty: 'advanced',
    topic: 'Rescue',
    category: 'Emergency & Rescue',
  ...
  {
    id: 220,
    question: 'Where are the emergency lowering controls on a MEWP normally found, and who needs to be able to reach them?',
    options: [
      'In the work platform, reached by the operator who is working aloft',
      'At the base of the machine, reached by trained ground based staff',
      'Inside a locked chassis panel, reached by a visiting service engineer',
      'On a remote handset, reached by the site manager in the site office',
    ],
    correctAnswer: 1,
    explanation:
      'The ground controls and emergency descent system sit at the base of the machine so that nominated trained personnel can bring the platform down when the person aloft cannot. That is the whole point of the arrangement, and those people must be included in the familiarisation for the specific machine on site. Relying on the platform controls is the trap, because an operator who is crushed against the controls or unconscious is exactly the person who cannot operate them.',
    section: 'Module 6',
    difficulty: 'advanced',
    topic: 'Rescue',
    category: 'Emergency & Rescue',
  ...
  {
    id: 221,
    question: 'LOLER places a specific duty about someone trapped in the carrier of equipment used for lifting persons. What is it?',
    options: [
      'A trapped person must be recovered using a second lifting machine',
      'A trapped person must not be exposed to danger and can be freed',
      'A trapped person must be reported at once to the enforcing body',
      'A trapped person must be lowered within a fixed number of minutes',
    ],
    correctAnswer: 1,
    explanation:
      'The LOLER requirement for lifting equipment for lifting persons is that a person trapped in any carrier is not thereby exposed to danger and can be freed, and the MEWP platform is expressly named as a carrier. That duty is what forces a workable rescue arrangement to exist before the lift. LOLER sets no fixed number of minutes, so choosing a time limit invents a figure the law does not give, and reporting to the enforcing authority relates to defects found at examination, not to a live rescue.',
    section: 'Module 1',
    difficulty: 'advanced',
    topic: 'Rescue',
    category: 'Legislation & Types',
  ...
  {
    id: 222,
    question: 'Under LOLER, how often must a MEWP be thoroughly examined by a competent person as a minimum?',
    options: [
      'At least every three months while it remains available for hire',
      'At least every six months, or to a written examination scheme',
      'At least every twelve months, as for other lifting equipment',
      'At least once before each new project on which it is deployed',
    ],
    correctAnswer: 1,
    explanation:
      'LOLER requires lifting equipment for lifting persons to be thoroughly examined at least every six months, or in accordance with an examination scheme drawn up by a competent person, and HSE MEWP guidance repeats the six month figure. Twelve months is the attractive wrong answer because that is the interval for other lifting equipment that only lifts loads. Anyone hiring a machine in should ask for and keep the report of thorough examination before allowing it on site.',
    section: 'Module 7',
    difficulty: 'intermediate',
    topic: 'Thorough Examination',
    category: 'Inspections & Setup',
  ...
  {
    id: 223,
    question: 'Why is a MEWP examined at a shorter interval than a materials hoist used only to raise goods?',
    options: [
      'Because a MEWP is mobile while a materials hoist stays in one place',
      'Because a MEWP is usually hired in and a materials hoist is owned',
      'Because a MEWP is powered and a materials hoist is raised by hand',
      'Because a MEWP lifts persons, which LOLER treats as a higher risk',
    ],
    correctAnswer: 3,
    explanation:
      'LOLER splits the interval by what is being lifted, not by how the machine is obtained or driven. Equipment for lifting persons is examined at least every six months, other lifting equipment at least every twelve, because a failure with a person in the carrier is far more likely to kill. Mobility feels like the right reason and does affect wear and stability, but it is not the distinction the regulation draws, and ownership makes no difference to the duty at all.',
    section: 'Module 7',
    difficulty: 'advanced',
    topic: 'Thorough Examination',
    category: 'Legislation & Types',
  ...
  {
    id: 224,
    question: 'In normal circumstances, within what period should the competent person issue the report of thorough examination?',
    options: [
      'Within seven days of the thorough examination being carried out',
      'Within 28 days of the thorough examination being carried out',
      'Within three months of the thorough examination being carried out',
      'Within six months of the thorough examination being carried out',
    ],
    correctAnswer: 1,
    explanation:
      'The LOLER guidance says the competent person should normally complete and forward the report within 28 days of the thorough examination. Where defects must be put right inside a stated timescale, the report should go sooner so the employer can act in time. Six months is the trap because it echoes the examination interval, but the interval between examinations and the deadline for issuing the paperwork are two different things.',
    section: 'Module 7',
    difficulty: 'intermediate',
    topic: 'Thorough Examination',
    category: 'Inspections & Setup',
  ...
  {
    id: 225,
    question: 'An operator finds the platform tilt alarm does not sound during the pre-use check. What should happen next?',
    options: [
      'Isolate the controls, tag the machine and report it to the person in control',
      'Use the machine at low level only until the hire company can attend site',
      'Complete the shift and record the defect on the check sheet at the end',
      'Reset the alarm at the ground controls and continue if it then sounds',
    ],
    correctAnswer: 0,
    explanation:
      'HSE guidance expects the operator to know the procedure their employer wants followed when a fault is found, and that procedure is to isolate the controls, tag the machine and report the defect to the person in control. The tilt alarm is a safety device, so a machine with a dead one is not fit to use. Working at low level sounds like a sensible compromise but leaves a machine with a defeated safety device in service, and recording the fault at the end of the shift means everybody who used it that day was unprotected.',
    section: 'Module 3',
    difficulty: 'advanced',
    topic: 'Pre-Use Inspection',
    category: 'Inspections & Setup',
  ...
  {
    id: 226,
    question: 'Familiarisation on a specific make and model of MEWP must always cover which of the following?',
    options: [
      'The emergency lowering procedure and function of each safety device',
      'The whole syllabus of the basic operator training course repeated',
      'The ground bearing capacity figures for every part of the site',
      'The manual handling weights for materials taken into the basket',
    ],
    correctAnswer: 0,
    explanation:
      'Familiarisation follows on from basic training and covers the manufacturer instructions and warnings, the features and controls of that particular model, the function of each safety device and the emergency lowering procedures, and it should be recorded. Repeating the basic course is the plausible answer but misses the point, since familiarisation exists because a card that lists a category of machine does not tell you where the emergency descent valve is on this one.',
    section: 'Module 3',
    difficulty: 'intermediate',
  ...
  {
    id: 227,
    question: 'What does a MEWP operator training certificate or card record about the person holding it?',
    options: [
      'The maximum working height the holder may work safely at',
      'The sites on which the holder has been approved to work at',
      'The categories of machine the holder is trained to operate',
      'The rescue qualification that the holder currently holds',
    ],
    correctAnswer: 2,
    explanation:
      'After successful training and assessment the operator is issued a certificate or card identifying them and listing the categories of MEWP they are trained to operate, and it can be updated as they train on further types. It says nothing about a maximum height, which is a property of the machine and the risk assessment rather than the person, so reading a height limit into a card is a mistake. Familiarisation on the specific model is still needed on top of the card.',
    section: 'Module 3',
    difficulty: 'intermediate',
    topic: 'Training and Competence',
    category: 'Legislation & Types',
  ...
  {
    id: 228,
    question: 'Besides the categories listed on it, what else should be checked on an operator training card?',
    options: [
      'That the card carries the logo of the site principal contractor',
      'That the card has not gone past the expiry date printed on it',
      'That the card shows the serial number of the machine on site',
      'That the card was issued in the same county as the work site',
    ],
    correctAnswer: 1,
    explanation:
      'HSE guidance says to check the expiry date of the training certificate or card, because operator competence is treated as something that has to be refreshed rather than held for life. Expecting a machine serial number on the card is the tempting error, since the card covers a category of machine and not one specific unit, and it is familiarisation, recorded separately, that ties the operator to the particular make and model in use.',
    section: 'Module 3',
    difficulty: 'intermediate',
    topic: 'Training and Competence',
    category: 'Legislation & Types',
  ...
  {
    id: 229,
    question: 'When should an employer consider training beyond basic operator training for someone using a MEWP?',
    options: [
      'When the operator has held the training card for over a year',
      'When the operator is working away from the home depot area',
      'When the operator will be lifted with a second person aboard',
      'When the operator will work where entrapment risk is increased',
    ],
    correctAnswer: 3,
    explanation:
      'HSE guidance tells employers to check whether basic training is enough for operators who must work where the risk of entrapment is raised by nearby or overhead structures, and to arrange additional training aimed at those higher risk environments. Length of time since certification is the plausible distractor, but it is the nature of the work position, not the age of the card, that drives the extra training, although the card expiry date is still checked separately.',
    section: 'Module 3',
    difficulty: 'advanced',
    topic: 'Training and Competence',
    category: 'Legislation & Types',
  ...
  {
    id: 230,
    question: 'What decides whether spreader plates are needed under the outriggers of a vehicle mounted MEWP?',
    options: [
      'The ground bearing capacity compared with the maximum point load',
      'The overall weight of the machine compared with the load in the basket',
      'The working height that will be reached at the furthest outreach',
      'The width of the outrigger pads fitted by the machine manufacturer',
    ],
    correctAnswer: 0,
    explanation:
      'Planning a MEWP position means asking what the ground bearing capacity is at the work position and what maximum point load appears under a wheel, outrigger or jack pad, and spreader plates are used where the ground cannot safely support that point load. Total machine weight is the attractive wrong answer, because a light machine on a small outrigger foot can still punch through soft ground while a heavier one on large plates does not. Pad width matters only as part of the point load calculation.',
    section: 'Module 4',
    difficulty: 'advanced',
    topic: 'Ground Conditions',
    category: 'Inspections & Setup',
  ...
  {
    id: 231,
    question: 'A street lighting repair needs the boom to swing across a running carriageway. What does MEWP guidance say?',
    options: [
      'Booming over live traffic is acceptable if a banksman is watching',
      'Booming over live traffic is acceptable outside of peak traffic hours',
      'Booming over live traffic must never be done, so the road is managed',
      'Booming over live traffic is acceptable if the basket is above five metres',
    ],
    correctAnswer: 2,
    explanation:
      'HSE guidance states without qualification that you must never boom over live traffic, so the answer is to arrange traffic management, a lane closure or a permit rather than to find conditions that make it acceptable. A banksman is the tempting answer because it helps with reversing and blind spots on site, but no amount of watching stops a vehicle striking a boom that is hanging over a running lane, and height above the road does not remove the risk of a high sided vehicle.',
    section: 'Module 5',
    difficulty: 'advanced',
  ...
  {
    id: 232,
    question: 'How large an area around a boom MEWP should be barricaded where other workers or vehicles are present?',
    options: [
      'The footprint of the base structure with the outriggers deployed',
      'The area directly beneath the basket at its highest work position',
      'A fixed corridor between the machine and the site access gateway',
      'The whole work area based on the outreach the job will require',
    ],
    correctAnswer: 3,
    explanation:
      'HSE guidance says the entire MEWP work area, based on the outreach distances the job requires and not just the base structure footprint, should be barricaded with cones and warning signs. Coning the chassis footprint is the common and inadequate practice, because a boom that reaches out several metres will slew, swing its counterweight and drop tools well outside that little rectangle, so the barrier has to describe the swept area rather than the parked machine.',
    section: 'Module 5',
    difficulty: 'advanced',
    topic: 'Safe Operation',
    category: 'Inspections & Setup',
  ...
  {
    id: 233,
    question: 'Which risk to people on the ground arises specifically when a boom-type MEWP slews?',
    options: [
      'They can be trapped between the counterweight and a nearby structure',
      'They can be struck by the outriggers retracting into the chassis',
      'They can be exposed to arcing from the machine earth connection',
      'They can be drawn into the wheels as the machine changes direction',
    ],
    correctAnswer: 0,
    explanation:
      'Slewing swings the counterweight at the tail of the machine through an arc at ground level, and HSE guidance asks directly whether there is a risk of trapping other workers between that counterweight and an adjacent structure. It is easy to focus only on the basket at height and forget that the dangerous moving part is at waist height behind you. Outriggers are a hazard when being deployed or stowed, not while the machine slews with the platform aloft.',
    section: 'Module 5',
    difficulty: 'advanced',
    topic: 'Entrapment',
    category: 'Safe Operation',
  ...
  {
    id: 234,
    question: 'A MEWP has to travel beneath an overhead line to reach the work position. What does the guidance require?',
    options: [
      'The line is treated as dead because it feeds a farm building',
      'Sufficient clearance is confirmed and the area is demarcated',
      'The boom is stowed and the machine driven at walking pace',
      'A spotter walks ahead with an insulated pole to test the line',
    ],
    correctAnswer: 1,
    explanation:
      'MEWP planning asks whether the machine will pass beneath any overhead power lines and, if so, whether there is enough clearance and whether the area has been demarcated, with the network operator consulted and HSE guidance on overhead lines followed. Assuming a rural line is dead is the killer, since lines feeding farms are commonly at eleven thousand volts and can sag lower in hot weather. Nobody should ever be testing an overhead line with a pole from the ground.',
    section: 'Module 5',
    difficulty: 'advanced',
  ...
  {
    id: 235,
    question: 'A MEWP boom contacts a live overhead line. What is the correct immediate action for the operator?',
    options: [
      'Climb down the boom quickly before the machine catches on fire',
      'Jump clear of the machine so both feet land at the same moment',
      'Stay in the platform, warn others to keep clear and call for help',
      'Reach out and push the conductor away with a dry timber batten',
    ],
    correctAnswer: 2,
    explanation:
      'While contact is maintained the machine and everything on it may be live, so the safest place is where you already are, in the platform, keeping everyone else well away and getting the network operator to isolate. Climbing down or otherwise touching the machine and the ground at the same time bridges the potential difference and is how people are killed. Jumping clear with the feet together is the last resort taught only for abandoning a machine that is on fire, not the default response.',
    section: 'Module 5',
    difficulty: 'advanced',
    topic: 'Overhead Hazards',
    category: 'Emergency & Rescue',
  ...
  {
    id: 236,
    question: 'In what circumstances may a MEWP be used to let an operator exit the basket at height?',
    options: [
      'Whenever the operator clips a fall arrest lanyard to the structure',
      'Only where a rigorous risk assessment shows it is the safest means',
      'Whenever the platform is level with a permanent guarded walkway',
      'Where the machine has been fitted with a secondary guarding device',
    ],
    correctAnswer: 1,
    explanation:
      'MEWPs are designed to lift people, let them work from the platform and return them to the starting level, so exiting at height must be strictly controlled and only done where a rigorous risk assessment carried out when planning the job shows it is the safest and most effective way to reach that place. Clipping on to the structure is the tempting answer, but transferring a lanyard while stepping across is the exact moment people fall, and secondary guarding addresses crushing, not transfers.',
    section: 'Module 5',
    difficulty: 'advanced',
    topic: 'Safe Operation',
    category: 'Safe Operation',
  ...
  {
    id: 237,
    question: 'Why is a MEWP not an acceptable substitute for a stair tower to move people between floors?',
    options: [
      'A MEWP cannot be raised while any person is standing in the basket',
      'A MEWP loses stability whenever the platform is loaded off centre',
      'A MEWP is designed to lift and return people to the starting level',
      'A MEWP is not covered by the work at height regulations at all',
    ],
    correctAnswer: 2,
    explanation:
      'HSE guidance is clear that MEWPs are not intended to transfer people from one level to another, only to raise them, allow work from the platform and bring them back down. Using one as a lift between floors turns every trip into an unplanned transfer at height. The stability answer is superficially attractive because off centre loading does matter, but a MEWP within its rated capacity is stable, and a MEWP is very much work equipment under the work at height regulations.',
    section: 'Module 2',
    difficulty: 'advanced',
    topic: 'Safe Operation',
    category: 'Safe Operation',
  ...
  {
    id: 238,
    question: 'The platform overload alarm sounds and the movement functions cut out. What is the correct response?',
    options: [
      'Bypass the overload system so the platform can be lowered',
      'Remove the overload before attempting to recover the machine',
      'Boom in fully so the load moves back over the machine base',
      'Add ballast to the chassis to restore the machine stability',
    ],
    correctAnswer: 1,
    explanation:
      'HSE guidance says never to disable the platform overload system, and that where the alarm has operated or the functions have cut out the overload should be removed if possible before any attempt is made to recover the machine. Bypassing the system is the shortcut that turns a protected overload into an overturn. Adding ballast is not an operator decision either, because the counterweight arrangement is set by the manufacturer and altering it changes the certified stability of the machine.',
    section: 'Module 5',
    difficulty: 'intermediate',
    topic: 'Safe Operation',
    category: 'Safe Operation',
  ...
  {
    id: 239,
    question: 'When judging whether a MEWP basket is within its safe working load, what has to be counted?',
    options: [
      'The people only, since tools are allowed for in the rating',
      'The heaviest single item that will be lifted into the basket',
      'The people and materials, but not hand tools or fixings',
      'The people, tools, materials and any handling device carried',
    ],
    correctAnswer: 3,
    explanation:
      'HSE guidance states that all people, tools, materials and material handling devices add to the safe working load of the machine, so everything in and on the platform is counted. Assuming the rating already allows for tools is the dangerous shortcut, because two electricians with a heavy drill, a coil of cable and a box of fixings can pass the limit on a small basket without anything looking unusual. The rated capacity is a total, not a headcount.',
    section: 'Module 2',
    difficulty: 'intermediate',
    topic: 'Machine Selection',
    category: 'Legislation & Types',
  ...
  {
    id: 240,
    question: 'An electrician wants to rest a length of cable tray across the basket handrails. What is the correct position?',
    options: [
      'Acceptable if the tray is tied to the rails with a soft strap',
      'Acceptable if the tray does not project beyond the basket edge',
      'Not acceptable, so use a second machine or a handling device',
      'Acceptable if a second operative steadies the tray at all times',
    ],
    correctAnswer: 2,
    explanation:
      'HSE guidance says materials should never be balanced on the handrails of a MEWP, and suggests instead a second boom MEWP, a scissor lift, a crane or a telehandler with a suitable material handling attachment, with the MEWP used for access only. Strapping the tray down is the plausible compromise, but a load on the rails still tempts the operator to lean or overreach, obstructs the controls and can fall on people below.',
    section: 'Module 2',
    difficulty: 'advanced',
    topic: 'Machine Selection',
    category: 'Safe Operation',
  ...
  {
    id: 241,
    question: 'How should the wind limit for outdoor use of a particular MEWP be established on site?',
    options: [
      'From the shipping forecast issued for the region that morning',
      'From the point at which the operator starts to feel unsteady',
      'From the manufacturer stated maximum wind speed for that machine',
      'From a fixed figure that applies to all machine types equally',
    ],
    correctAnswer: 2,
    explanation:
      'Planning a MEWP means asking what the manufacturer maximum wind speed is for the machine being used, how the wind speed will be checked, usually with an anemometer, and by whom. The limit belongs to the machine, so there is no single figure that covers every type, and a scissor with a large platform area behaves very differently from a compact boom. Waiting until the operator feels unsteady is far too late, because by then the platform is already being loaded beyond its design assumption.',
    section: 'Module 4',
    difficulty: 'intermediate',
    topic: 'Ground Conditions',
    category: 'Inspections & Setup',
  ...
  {
    id: 242,
    question: 'A machine rated for indoor use only is to be used inside a partially clad building. What is the concern?',
    options: [
      'The machine will not have a valid thorough examination report',
      'The machine tyres are not suitable for a concrete floor slab',
      'The machine batteries will discharge faster in cold weather',
      'The machine may be exposed to wind that it is not rated for',
    ],
    correctAnswer: 3,
    explanation:
      'HSE guidance warns that a machine rated indoor only can still meet real wind exposure in a partially clad building, or in a fully clad one where large doors are open at both ends and air funnels through. Being under a roof is not the same as being sheltered. The thorough examination answer is a distractor, because that duty follows the machine and its use for lifting persons and is not altered by whether the work happens indoors or outdoors.',
    section: 'Module 4',
    difficulty: 'advanced',
    topic: 'Ground Conditions',
    category: 'Inspections & Setup',
  ...
  {
    id: 243,
    question: 'Why does operating a MEWP in the gap between two tall buildings need extra care in windy weather?',
    options: [
      'Radio signals to the ground controls are blocked by the walls',
      'Wind speed and turbulence can both increase between buildings',
      'Ground bearing capacity is always lower between two buildings',
      'Daylight levels fall so the control markings cannot be read',
    ],
    correctAnswer: 1,
    explanation:
      'HSE guidance singles out MEWPs operated between buildings, where increased wind speed and turbulence can be a particular problem, so a reading taken in the open may badly understate what the platform actually experiences in the gap. Assuming the buildings give shelter is the intuitive mistake. Ground bearing capacity is a real siting question but it depends on the make up of the ground, not on whether there happen to be structures either side.',
    section: 'Module 4',
    difficulty: 'intermediate',
    topic: 'Ground Conditions',
    category: 'Inspections & Setup',
  ...
  {
    id: 244,
    question: 'Besides machine stability, what other wind related effect should the MEWP plan take account of?',
    options: [
      'Wind noise setting off the platform overload warning alarm',
      'Wind pressure altering the reading of the machine tilt sensor',
      'Wind chill reducing operator dexterity and concentration',
      'Wind drying the hydraulic seals and causing them to leak',
    ],
    correctAnswer: 2,
    explanation:
      'HSE guidance asks about the potential for wind chill, which affects the dexterity and concentration of the operator, alongside the questions about maximum wind speed and how it will be measured. Cold hands on proportional controls near steelwork is a direct contributor to entrapment, so the human effect matters as much as the stability calculation. Wind does not trigger the overload alarm, which responds to weight in the platform rather than to weather.',
    section: 'Module 4',
    difficulty: 'intermediate',
    topic: 'Safe Operation',
    category: 'Inspections & Setup',
  ...
  {
    id: 245,
    question: 'A MEWP is to work on a newly cast concrete slab. What must be checked with the person in control of the site?',
    options: [
      'The date the slab was tested for surface flatness tolerance',
      'The type of reinforcement mesh used in the top of the slab',
      'The colour coding applied to the slab by the site engineer',
      'The slab loading limits and whether the concrete has cured',
    ],
    correctAnswer: 3,
    explanation:
      'Where a MEWP is to operate on a precast or cast in-situ slab, HSE guidance says to request the slab loading limits from the person in control of the site, compare them with the maximum weight and maximum point load of the machine, and ask whether enough time has been allowed for the concrete to cure. Flatness matters for levelling the machine but tells you nothing about whether the slab will carry the point load, which is what causes a punch through and an overturn.',
    section: 'Module 4',
    difficulty: 'advanced',
    topic: 'Ground Conditions',
    category: 'Inspections & Setup',
  ...
  {
    id: 246,
    question: 'Which siting risk must be controlled when a MEWP works near the edge of a ground floor slab?',
    options: [
      'The machine picking up debris in the tyre tread patterns',
      'The machine running off the slab edge onto softer ground',
      'The machine losing radio contact with the ground controls',
      'The machine drawing damp up into the chassis from the slab',
    ],
    correctAnswer: 1,
    explanation:
      'HSE guidance asks specifically whether the risk of a MEWP running off the edge of a ground floor slab onto soft ground, or off the edge of an elevated slab, has been considered and how it will be controlled, using edge protection, wheel stops or exclusion. It is a sudden and violent overturn with a person raised aloft. Debris in the treads is untidy but is not what puts the machine over, and MEWP ground controls are hard wired at the base rather than radio linked.',
    section: 'Module 4',
    difficulty: 'advanced',
    topic: 'Ground Conditions',
    category: 'Inspections & Setup',
  ...
  {
    id: 247,
    question: 'Which ground feature is most likely to cause a MEWP to overturn while it is being positioned?',
    options: [
      'A painted line marking a former parking bay on the tarmac',
      'A shallow layer of gravel spread over a compacted sub base',
      'A cellar or drainage culvert hidden beneath the paved surface',
      'A drainage channel grating set flush into the concrete slab',
    ],
    correctAnswer: 2,
    explanation:
      'MEWP planning lists subterranean hazards such as tanks, cellars, culverts, inspection covers, sewers and service trenches, because a paved surface can look perfectly sound and still collapse under a wheel or outrigger point load. The person in control of the site should supply information on ground bearing capacity and localised features like uncompacted backfill. A flush grating and a painted line are visible and largely harmless by comparison.',
    section: 'Module 4',
    difficulty: 'advanced',
    topic: 'Ground Conditions',
    category: 'Inspections & Setup',
  ...
  {
    id: 248,
    question: 'When is a banksman or vehicle marshaller most likely to be needed for a MEWP on site?',
    options: [
      'When the machine is on charge overnight in a secure compound',
      'When the platform is being used within a fully enclosed room',
      'When the thorough examination report is due to be renewed soon',
      'When operator visibility is limited while travelling or reversing',
    ],
    correctAnswer: 3,
    explanation:
      'HSE guidance asks whether a banksman or vehicle marshaller is required when moving the MEWP across the site to its work position, and separately whether the operator has limited visibility, particularly when reversing. A charging machine is parked with the platform lowered and the brakes applied, so it needs security rather than a marshaller, and the timing of the thorough examination has nothing to do with how the machine is guided across the ground.',
    section: 'Module 4',
    difficulty: 'intermediate',
    topic: 'Safe Operation',
    category: 'Inspections & Setup',
  ...
  {
    id: 249,
    question: 'People must work beneath a MEWP that cannot be moved. What is the first priority and the fallback control?',
    options: [
      'Issue hard hats first, then place a warning sign at the machine base',
      'Post a lookout first, then stop all work whenever the boom is moved',
      'Keep people out of the area first, then use controls like tool lanyards',
      'Sheet the basket floor first, then restrict the platform to one person',
    ],
    correctAnswer: 2,
    explanation:
      'HSE guidance says the first priority is to keep people out of the area, and only if people must work where they could be struck by a falling object are further control measures such as tool lanyards put in place. That order matters because it is exclusion first and mitigation second. Handing out hard hats first inverts the hierarchy by starting with personal protection against an impact rather than removing anyone from the drop zone.',
    section: 'Module 5',
    difficulty: 'advanced',
    topic: 'Safe Operation',
    category: 'Safe Operation',
  ...
  {
    id: 250,
    question: 'MEWP work near an airfield needs permission from the airfield manager in which situation?',
    options: [
      'Within 2 km of an aerodrome using any type of boom type machine',
      'Within 6 km of an aerodrome using any machine fitted with a boom',
      'Within 10 km of an aerodrome using a machine over 6 m in height',
      'Within 6 km of an aerodrome using a machine over 10 m in height',
    ],
    correctAnswer: 3,
    explanation:
      'HSE guidance asks whether you are working within six kilometres of an aerodrome or airfield using a MEWP in excess of ten metres in height, and if so says to contact the airfield manager for permission to work in that airspace. Both parts of the test have to be met, so distance alone or machine type alone is not the trigger, and picking an option that ignores the height threshold turns a specific check into a blanket restriction on every boom near an airfield.',
    section: 'Module 5',
    difficulty: 'advanced',
    topic: 'Safe Operation',
    category: 'Inspections & Setup',
  ...
  {
    id: 251,
    question: 'What is a MEWP pre-use check mainly intended to confirm before work begins that day?',
    options: [
      'That the machine has a current thorough examination report',
      'That the operator holds a valid category on the training card',
      'That the site risk assessment has been signed by the manager',
      'That the controls, safety devices and machine condition work',
    ],
    correctAnswer: 3,
    explanation:
      'The daily or pre-use check is a function check carried out by the trained operator on the machine itself, confirming that the controls respond, that each safety device operates and that the structure, tyres, guard rails and emergency descent are in serviceable condition. The thorough examination report is the attractive wrong answer because it is also about the machine, but it is a six monthly engineering assessment and cannot tell you that a hose split or a control stuck since it was written.',
    section: 'Module 3',
    difficulty: 'intermediate',
    topic: 'Pre-Use Inspection',
    category: 'Inspections & Setup',
  ...
  {
    id: 252,
    question: 'What should happen to the records of the daily pre-use function checks on a MEWP?',
    options: [
      'They are destroyed once the machine has left the site safely',
      'They take the place of the LOLER thorough examination report',
      'They are kept, as records of these checks should be retained',
      'They are sent to the enforcing authority at the end of the job',
    ],
    correctAnswer: 2,
    explanation:
      'HSE guidance states that records of the daily and pre-use checks, and of the basic maintenance required by the manufacturer, should be kept. They show a fault was found and acted on, and they are the trail an inspector follows after an incident. They do not replace the report of thorough examination, which is a separate document produced by a competent person, and routine check sheets are not sent to the enforcing authority as a matter of course.',
    section: 'Module 3',
    difficulty: 'advanced',
    topic: 'Pre-Use Inspection',
    category: 'Inspections & Setup',
  ...
  {
    id: 253,
    question: 'Which statement best describes how PUWER and LOLER both apply to a MEWP in use on site?',
    options: [
      'PUWER covers only the chassis and LOLER covers only the boom',
      'PUWER covers stability and use, LOLER covers lifting of persons',
      'PUWER applies to hired machines and LOLER to owned machines',
      'PUWER applies indoors and LOLER applies to outdoor operations',
    ],
    correctAnswer: 1,
    explanation:
      'PUWER requires the risks from using work equipment to be controlled and focuses on the overturning risks of mobile work equipment such as MEWPs, which is why ground, environmental and operating conditions matter so much. LOLER adds the duties that apply because the machine lifts people, including planning by a competent person and thorough examination. Splitting them by ownership or by indoor and outdoor use is invented, since both sets of regulations apply to the same machine at the same time.',
    section: 'Module 1',
    difficulty: 'intermediate',
    topic: 'Legislation',
    category: 'Legislation & Types',
  ...
  {
    id: 254,
    question: 'Under the work at height regulations, what must be considered before a MEWP is selected at all?',
    options: [
      'Whether a ladder would be cheaper than hiring a powered machine',
      'Whether the client has agreed to pay for the machine hire cost',
      'Whether the machine can be delivered before the shift starts',
      'Whether the work can be done without working at height at all',
    ],
    correctAnswer: 3,
    explanation:
      'The regulations require an assessment before any work at height, and if it shows the work can be done in a way that avoids working at height then that must be done, for example by assembling or terminating at ground level. Only when there is no alternative does the job move on to planning by a competent person and choosing the most suitable equipment. Cost comparisons come nowhere in that sequence, and choosing a ladder because it is cheaper reverses the hierarchy entirely.',
    section: 'Module 1',
    difficulty: 'intermediate',
    topic: 'Legislation',
    category: 'Legislation & Types',
  ...
  {
    id: 255,
    question: 'A working platform used for construction work from which a person could fall more than 2 metres must be inspected how often?',
    options: [
      'At intervals not exceeding seven days, and after events affecting it',
      'At intervals not exceeding six months, and after every relocation',
      'At intervals not exceeding three months, and after heavy rainfall',
      'At intervals not exceeding twelve months, and after any overload',
    ],
    correctAnswer: 0,
    explanation:
      'HSE work at height guidance requires such a platform to be inspected after assembly in any position, after any event liable to have affected its stability, and at intervals not exceeding seven days. Six months is the tempting answer because it is the LOLER thorough examination interval for equipment lifting persons, but that is a different duty with a different purpose, and both can apply to the same MEWP without either one replacing the other.',
    section: 'Module 1',
    difficulty: 'intermediate',
    topic: 'Legislation',
    category: 'Inspections & Setup',
  ...
  {
    id: 256,
    question: 'A MEWP is repositioned several times a day on the same construction site. What does that mean for inspection?',
    options: [
      'A new inspection report is needed each time it is repositioned',
      'A new inspection report is not needed for each move on that site',
      'A new inspection report is needed at the start of every shift',
      'A new inspection report is needed whenever the operator changes',
    ],
    correctAnswer: 1,
    explanation:
      'HSE guidance says that where the platform is mobile, a new inspection and report is not required every time it is moved to a new location on the same site, which is what makes a MEWP practical for work that follows a run of containment across a building. That does not remove the operator pre-use check or the need to reassess ground conditions at each new position, and an inspection is still triggered by any event liable to have affected stability.',
    section: 'Module 1',
    difficulty: 'intermediate',
    topic: 'Legislation',
    category: 'Inspections & Setup',
  ...
  {
    id: 257,
    question: 'LOLER requires the lifting operation involving a MEWP to be planned. By whom must that planning be done?',
    options: [
      'By the hire company representative who delivered the machine',
      'By any operator who holds a current MEWP operator training card',
      'By a competent person, with appropriate supervision arranged',
      'By the principal contractor site manager for that work area',
    ],
    correctAnswer: 2,
    explanation:
      'LOLER requires all lifting operations to be planned by a competent person, and MEWP guidance adds that depending on the activity a competent person may also be needed to supervise the operations on site. Holding an operator card is not the same thing, since it shows a person can drive a category of machine, not that they can assess ground bearing capacity, entrapment risk and rescue arrangements. The hire company delivers and examines the machine but does not plan your job.',
    section: 'Module 1',
    difficulty: 'advanced',
    topic: 'Training and Competence',
    category: 'Legislation & Types',
  ...
  {
    id: 258,
    question: 'An operator clips a fall arrest lanyard to a steel beam outside the basket instead of the basket anchor. Why is this wrong?',
    options: [
      'The steel beam will not be strong enough to hold a falling person',
      'The lanyard would then be too short to allow the work to be done',
      'The beam anchor removes the need to wear a full body harness',
      'The anchor point for the lanyard must be the one on the platform',
    ],
    correctAnswer: 3,
    explanation:
      'A MEWP work restraint system is a full body harness connected by a lanyard to an anchor point on the MEWP basket, and that is where it stays. Anchoring to the structure ties the operator to something that does not move while the platform does, so if the machine is struck, driven or lowered the operator can be dragged out of the basket or crushed against the rail. Beam strength is not the issue and is the answer people reach for by analogy with scaffold anchors.',
    section: 'Module 6',
    difficulty: 'advanced',
    topic: 'Harness and Restraint',
    category: 'Safety & Best Practice',
  ...
  {
    id: 259,
    question: 'What determines the correct lanyard length in a MEWP work restraint system?',
    options: [
      'It must be long enough to reach the ground if a fall happens',
      'It must be short enough to stop the person reaching a fall point',
      'It must match the working height selected for the task that day',
      'It must equal the height of the basket guard rail above the floor',
    ],
    correctAnswer: 1,
    explanation:
      'From the anchor point on the basket, the lanyard length must be short enough to prevent the wearer reaching a position from which they could fall, which is the defining feature of restraint rather than arrest. Sizing it to the working height is the misconception that gives an operator enough slack to go over the rail and hang outside the platform, where the rescue problem starts. An energy absorber may be present, but it is still only part of a restraint system.',
    section: 'Module 6',
    difficulty: 'advanced',
    topic: 'Harness and Restraint',
    category: 'Safety & Best Practice',
  ...
  {
    id: 260,
    question: 'What does HSE MEWP guidance say about retractable type fall arresters used in a work platform?',
    options: [
      'They are the preferred device for all boom type work platforms',
      'They replace the need for a work restraint system in a scissor',
      'They should not be used unless tested for that manner of use',
      'They must be fitted to every anchor point in the work platform',
    ],
    correctAnswer: 2,
    explanation:
      'HSE guidance says retractable type fall arresters should not be used unless they are suitable and have been specifically tested in the proposed manner of use, because a device that pays out line lets the wearer reach a fall position, which is the opposite of restraint. Treating them as the preferred option is the dangerous assumption, since the preferred approach in a MEWP is a fixed short lanyard from the basket anchor that keeps the person inside the platform.',
    section: 'Module 6',
    difficulty: 'intermediate',
    topic: 'Harness and Restraint',
    category: 'Safety & Best Practice',
