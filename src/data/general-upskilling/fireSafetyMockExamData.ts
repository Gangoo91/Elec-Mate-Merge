...
export const fireSafetyQuestionBank: StandardMockQuestion[] = [
  ...
  },
  {
    ...
    options: ['Water', 'Carbon dioxide', 'Chemical chain reaction', 'Smoke'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Class B', 'Class C', 'Class A', 'Class F'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Class C', 'Class D', 'Class F', 'Class B'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Oxygen', 'Carbon dioxide', 'Carbon monoxide', 'Nitrogen'],
    correctAnswer: 2,
    explanation:
  ...
  // Questions 101-200 (Fire Safety & Fire Marshal)
  {
    ...
    options: [
      ...
      'To notify the fire brigade directly',
    ],
    correctAnswer: 1,
    explanation:
      'A manual call point (MCP) allows any person who discovers a fire to manually trigger the fire alarm system by pressing or breaking the glass element. They are typically located at exit points and along escape routes as required by BS 5839 Part 1.',
  ...
  },
  {
    ...
    options: [
      'To record voice messages from fire marshals',
      'To provide spoken evacuation instructions instead of or alongside tonal alarms',
      'To allow two-way communication with the fire brigade',
      'To amplify the standard fire alarm tone',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It detects smoke and heat',
      'It receives signals from detection devices and controls the alarm outputs',
      'It provides emergency lighting',
      'It automatically extinguishes fires',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To create fireproof zones in a building',
      'To divide a building into defined areas so the location of a fire can be quickly identified',
      'To restrict access to certain parts of a building during a fire',
      'To control ventilation systems in different zones',
    ],
    correctAnswer: 1,
    explanation:
      'Fire alarm zoning divides a building into distinct areas, each with its own zone indicator on the control panel. This allows responding personnel and the fire brigade to quickly identify the location of an alarm activation and direct their response accordingly.',
    section: 'Fire Alarm Systems',
    difficulty: 'basic',
    topic: 'Zoning',
    category: 'Fire Prevention & Detection',
  ...
  },
  {
    ...
    options: [
      'A legal requirement to investigate every fire alarm activation',
      'A programmed response that triggers specific actions based on which devices are activated',
      'A method of determining the root cause of a fire',
      'A training exercise for fire marshals',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Having too many manual call points',
      'Using addressable rather than conventional systems',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To fight fires until the fire brigade arrives',
      'To assist with the safe evacuation of people and carry out fire prevention duties',
      'To maintain and repair fire alarm systems',
      'To conduct formal fire risk assessments',
    ],
    correctAnswer: 1,
    explanation:
      "A fire marshal's primary role is to assist with the safe and orderly evacuation of people from the building during an emergency. They also carry out routine fire prevention tasks such as checking escape routes, fire doors, and extinguisher locations.",
  ...
  },
  {
    ...
    options: [
      'Extinguishing fires and rescuing trapped persons',
      'Conducting routine checks of escape routes, fire doors, and extinguisher availability',
      "Inspecting the building's structural fire resistance",
      'Repairing faulty fire alarm systems',
    ],
    correctAnswer: 1,
    explanation:
      'Before an emergency, fire marshals carry out routine fire prevention duties including checking escape routes are clear and unobstructed, verifying fire doors close correctly, ensuring extinguishers are in place and accessible, and reporting any fire safety concerns.',
    section: 'Fire Marshal Duties',
    difficulty: 'basic',
  ...
  },
  {
    ...
    options: [
      ...
      'Shutting down all electrical systems',
  ...
  },
  {
    ...
    options: [
      'The fire marshal replaces the responsible person',
      'The fire marshal acts on behalf of the responsible person to assist with fire safety duties',
      'The fire marshal supervises the responsible person',
      'There is no formal relationship between the two roles',
    ],
    correctAnswer: 1,
    explanation:
      'Fire marshals are appointed by and act on behalf of the responsible person. Under Article 18 of the RRFSO, the responsible person must appoint competent persons to assist in implementing fire safety measures. Fire marshals help fulfil this obligation.',
    section: 'Fire Marshal Duties',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    options: [
      'By wearing a specific uniform at all times',
      'By wearing high-visibility vests or armbands, often in a distinct colour',
      'By carrying a megaphone',
      'By standing at the fire alarm panel',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'That the route has been recently redecorated',
      'That the route is clear of obstructions, well lit, and fire doors are operational',
      'That CCTV cameras are functioning along the route',
      'That the route has appropriate carpeting',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Moving occupants upwards to the roof for helicopter rescue',
      'Moving occupants horizontally through fire-resisting barriers into an adjacent safe compartment',
      'Evacuating all occupants through the main entrance only',
      'Moving occupants to the basement level',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Using fire extinguishers to stop the fire spreading',
      'Occupants remain in their fire-resistant compartment unless directly threatened',
      'Barricading doors during an active fire',
      'Fire marshals defend their zone against intruders',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only whether the drill was successful or not',
      'The names of all employees who participated',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Two fire marshals always working together',
      'Pairing a person who needs assistance with a designated colleague who will help them evacuate',
      'A system where employees check on each other after evacuation',
      'Two fire wardens sharing responsibility for the same zone',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A room where firefighters store equipment',
      'A protected area within a stairway enclosure where a disabled person can wait for assisted evacuation',
      'An underground bunker for extreme emergencies',
      'A designated room with fire suppression systems',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only by trained firefighters',
      'By trained personnel to evacuate people who cannot use stairs independently',
      'Only during fire drills, never in real emergencies',
      'By any employee without training',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Visitors do not need to be accounted for',
      'Through the visitor sign-in register, which should be taken to the assembly point',
      'By asking employees if they saw any visitors',
      'Visitors are the responsibility of the fire brigade',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Each employee calls 999 individually',
      'Fire marshal reports to incident controller, who liaises with fire and rescue service',
      'The responsible person personally contacts every occupant',
      'Communication is not necessary; just evacuate',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To prevent theft during the emergency',
      'To ensure no one returns to a potentially dangerous environment before it is declared safe',
      'To make the roll call easier',
      'To allow the fire brigade unimpeded access',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'None; the same procedures apply',
      'Escape routes change frequently, fire detection may be limited, and workers may be unfamiliar with the layout',
      'Construction workers do not need to evacuate as they work outdoors',
      'Construction sites are exempt from fire safety legislation',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Fire marshals are only needed on the day shift',
      'Sufficient fire marshals should be available on every shift, including nights and weekends',
      'One fire marshal is enough regardless of shift pattern',
      'Fire marshals are only needed during office hours',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'No further duties once the alarm is silenced',
      'Assisting with the debrief, recording lessons learned, and checking the area before reoccupation',
      'Repairing any damage caused by the fire',
      'Immediately resuming normal work without further action',
    ],
    correctAnswer: 1,
    explanation:
      'After an emergency, fire marshals should participate in the debrief, provide feedback on any issues encountered during the evacuation, assist with recording observations and lessons learned, and help check their zone is safe before reoccupation is authorised.',
    section: 'Fire Marshal Duties',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    options: [
      'Carry the person down the stairs without equipment',
      'Guide them to a designated refuge and ensure the fire service is informed of their location',
      'Tell them to use the lift',
      'Leave them and evacuate immediately',
    ],
    correctAnswer: 1,
    explanation:
      "The fire marshal should guide the wheelchair user to the nearest designated refuge area within a protected stairway. They should then ensure the person's location and details are communicated to the incident controller and the fire and rescue service for assisted evacuation.",
    section: 'Evacuation Procedures',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    options: [
      ...
      'Only a mobile phone',
      'Full firefighting personal protective equipment',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Physically force them to leave',
      'Clearly advise them of the danger, make a note of their location, and report it to the incident controller',
      'Ignore them and continue evacuating others',
      'Call the police immediately',
    ],
    correctAnswer: 1,
    explanation:
      'If a person refuses to evacuate, the fire marshal should clearly inform them of the potential danger and strongly encourage them to leave. If they still refuse, the marshal should note their location and name (if known) and immediately report this to the incident controller.',
    section: 'Evacuation Procedures',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    options: [
      'A longer warranty period from the manufacturer',
      'A more thorough overhaul carried out at intervals of 5 or 10 years depending on extinguisher type',
      'An additional service carried out after every use',
      'Extended opening hours at the service centre',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Protecting furniture from fire damage',
      'Providing thermal insulation during evacuation',
      'Shielding fire marshals from radiant heat',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'They sound an alarm but do not release water',
      'Individual sprinkler heads activate when heated to their threshold, releasing water directly over the fire',
      'All sprinkler heads activate simultaneously throughout the building',
      'They release foam rather than water',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Every fire must be reported regardless of severity',
      ...
      'Only when the fire causes more than £10,000 in damage',
      'Fires do not need to be reported under RIDDOR',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Calculating the financial cost of damage',
      'Preserving the fire scene and any evidence for investigation',
      'Resuming business operations as quickly as possible',
  ...
  },
  {
    ...
    options: [
      'Determining the financial root of the loss',
      'A systematic process to identify the underlying causes that led to the fire occurring',
      'Finding out who started the fire for disciplinary action',
      'Analysing the root structure of burnt materials',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Only the building's insurance company",
  ...
  },
  {
    ...
    options: [
      ...
      'Only after the fire investigation is complete',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'No support is necessary as fires are expected workplace risks',
      'Psychological support and debriefing, recognising potential trauma',
      'Only medical treatment for physical injuries',
      'A day off work only',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'None; electrical systems are fire resistant',
      'Full inspection, testing, and re-certification of the electrical installation',
      'Only replacing visibly damaged cables',
      'Switching the power back on and testing each circuit',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Throw the blanket from a distance onto the pan',
      'Turn off the heat source, hold the blanket as a shield, and gently place it over the pan from front to back',
      'Wrap the blanket around the pan and carry it outside',
      'Fan the blanket over the pan to smother flames',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'They are only designed for outdoor use',
      'The powder cloud severely reduces visibility, can cause breathing difficulties, and leaves residue',
      'They are less effective indoors',
      'They can trigger sprinkler systems',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'That they have permission from the fire marshal',
      'That they have a clear escape route behind them, the fire is small enough, and they have the right extinguisher',
      'That the fire alarm has been silenced',
      'That the fire brigade is already on the way',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To provide water for cleaning after a fire',
      'To provide a continuous water supply for first-aid firefighting by trained building occupants',
      'To supply water to the fire brigade only',
      "To test the building's water pressure",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Any fire that requires an extinguisher to be used',
      'An uncontrolled explosion or fire in a workplace causing a stoppage of normal work for more than 24 hours',
      'A fire that triggers the fire alarm',
      'Any fire in a commercial kitchen',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Reinstating the fire alarm system only',
      'The process of restoring the building and its systems to a safe and operational condition after a fire',
      'Reinstating staff who were dismissed after the fire',
      'Re-installing sprinkler systems',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'At eye level (approximately 1.7 metres)',
      'At any height as long as they are visible',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only whether the extinguisher is present',
      'Location, type, condition, pressure gauge reading (if applicable), seal integrity, and any damage or obstruction',
      'Only the serial number and expiry date',
      'Nothing; monthly checks are not required',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'To prevent the public from seeing the damage',
  ...
  },
  {
    ...
    options: [
      ...
      'Wait for new fire extinguishers to be delivered',
      'Hold a company-wide meeting before allowing anyone back',
    ],
    correctAnswer: 1,
    explanation:
