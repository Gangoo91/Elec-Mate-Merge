...
export const coshhQuestionBank: StandardMockQuestion[] = [
  ...
  },
  {
    ...
    options: ['Wood dust', 'Lead', 'Silica dust', 'Welding fume'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Ingestion', 'Injection through wounds', 'Inhalation', 'Skin absorption'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Around 500', 'Around 2,000', 'Around 8,000', 'Around 20,000'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['The heart only', 'The liver and kidneys', 'The bones and joints', 'The eyes only'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Regulation 4', 'Regulation 6', 'Regulation 9', 'Regulation 12'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Every month', 'Every 6 months', 'At least every 14 months', 'Every 2 years'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['5 years', '10 years', '30 years', '40 years from the date of the last entry'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Regulation 7', 'Regulation 9', 'Regulation 13', 'Regulation 15'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Polychlorinated biphenyls only',
      'Carbon monoxide',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It is a respiratory sensitiser',
      'It is a simple asphyxiant that displaces oxygen',
      'It causes chemical burns on contact',
      'It is carcinogenic',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A cash bonus for hazardous work',
      'Suitable and sufficient information, instruction and training',
      'Only written safety data sheets',
      'Verbal warnings at the start of each shift',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Dust particles visible to the naked eye',
      'Airborne particles small enough to reach the gas exchange region of the lungs (alveoli)',
      'Only fibrous dust such as asbestos',
      'Dust that settles on surfaces within one hour',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'They are only required for substances classified as explosive',
      'The supplier must provide them and the employer must make them accessible to employees',
      'They are optional guidance documents with no legal standing',
      'Only the site safety officer needs access to them',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To check the colour matches their overalls',
      "To ensure an adequate seal between the facepiece and the wearer's face",
      'Face-fit testing is only recommended, not required',
      "To measure the wearer's lung capacity",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Any tight-fitting respirator one size larger',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only for carcinogenic substances',
  ...
  },
  {
    ...
    options: [
      'To regulate the transport of explosives on public roads',
      'To protect workers from risks of fire and explosion from dangerous substances in the workplace',
      'To control the sale of fireworks',
      'To regulate the mining industry only',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The temperature rating of electrical equipment',
      'The likelihood and duration of an explosive atmosphere occurring in an area',
      'The maximum number of workers allowed in an area',
  ...
  },
  {
    ...
    options: [
      'It prevents theft of chemicals',
      'It contains leaks and spills to prevent environmental contamination and spread',
      'It keeps chemicals at the correct temperature',
      'It provides fire resistance only',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only paper towels and a dustpan',
  ...
  },
  {
    ...
    options: [
      'All filters protect against all substances equally',
      'Different filter types protect against different classes of substance; the wrong filter provides no protection',
      'Filters are only needed for dust, not gases',
      'The filter type only affects comfort, not protection',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To measure the exact concentration of contaminant inside the mask',
      'To check if the wearer can detect the test aerosol through the facepiece, indicating a leak',
      "To calibrate the respirator's filters",
      "To determine the wearer's lung capacity",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'It can be performed by the wearer without supervision',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'The full text of the COSHH Regulations',
      'A training course provided by the HSE',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The PPE has been tested by the employer',
      'The PPE conforms to the relevant essential health and safety requirements and standards',
      'The PPE was manufactured in the UK',
      'The PPE is suitable for all hazards',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Half-face respirator with particle filter',
  ...
  },
  {
    ...
    options: [
      ...
      'Category IV — catastrophic risks',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Aerosols are always non-hazardous',
      'Aerosol generation increases the concentration of airborne particles and the risk of inhalation exposure',
      'Aerosols only affect the eyes, not the lungs',
      'Spray application reduces the hazard of a substance',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'To reduce the cost of PPE',
      'To improve the appearance of the workplace',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'PPE only needs replacing when it breaks',
      'PPE must be maintained in an efficient state, in efficient working order, and in good repair',
      'Employees are solely responsible for maintaining their own PPE',
      'PPE maintenance is only required annually',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Standard prescription spectacles',
      'Safety spectacles with side shields only',
  ...
  },
  {
    ...
    options: [
      'Natural ventilation is always sufficient',
      'Adequate ventilation must be provided to prevent accumulation of hazardous vapours or gases',
      'Ventilation is only needed if flammable substances are stored',
      'Sealed rooms with no ventilation are preferred to contain fumes',
    ],
    correctAnswer: 1,
    explanation:
  ...
  // ===== MONITORING, SURVEILLANCE & EMERGENCIES — 40 questions (id 161-200) =====
  {
    ...
    options: [
      'Only when an employee complains about smells',
      'When the COSHH assessment identifies it as necessary to maintain adequate control or protect health',
      'Only for substances with no WEL',
      'Every Monday morning as routine',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To count bacteria in the workplace',
      "To measure the level of a substance or its metabolite in a worker's body (e.g., blood, urine)",
      'To monitor wildlife near the workplace',
      'To test the biological resistance of PPE materials',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'For all employees regardless of exposure',
      ...
      'Only for employees over 50 years old',
      'Only when an employee has been off sick',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Setting maximum room temperatures',
      'Providing a benchmark to help interpret biological monitoring results for groups of workers',
      'Determining the price of PPE',
      'Calculating overtime pay for hazardous work',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Nothing, as long as the employee can still work',
      'Only record it in the health surveillance file',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To provide clean air for the wearer',
  ...
  },
  {
    ...
    options: [
      'Rush in immediately to pull them out',
      'Enter the space with a wet cloth over your face',
  ...
  },
  {
    ...
    options: [
      'Apply an eye pad and wait for the ambulance',
      'Irrigate the eye immediately with clean water for at least 15-20 minutes, then seek medical attention',
      'Rub the eye to stimulate tears',
      'Apply neutralising drops immediately',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Just the postcode of the site',
      'Only the name of the person who called',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Nothing specific beyond general fire procedures',
      'Emergency procedures including appropriate first aid, and warning and communication systems',
      'Only a telephone number for the fire brigade',
      'A suggestion box for employees to report concerns',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Cover it with newspaper and leave it',
  ...
  },
  {
    ...
    options: [
      'To increase the workload of safety officers',
      ...
      'To generate paperwork for HSE inspections only',
      'Reviews are not required once the initial assessment is completed',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only a written memo about spill procedures',
      'Training is only needed for managers',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Take a break and recheck in 30 minutes',
      'The reading is below 100% so it is safe',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'To monitor the efficiency of heating systems',
  ...
  },
  {
    ...
    options: [
      'A precise laboratory analysis',
      'A spot or short-term measurement giving an approximate indication of gas concentration',
      'A biological monitoring technique',
      'A method for measuring noise levels',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'No action is required if it was only exceeded briefly',
      'The employer must identify and implement additional control measures immediately to reduce exposure below the WEL',
      'Simply record the result and continue',
      'The employee must pay for their own RPE',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Apply moisturiser and ignore it',
      'Report it to their employer and seek occupational health assessment',
      'Self-diagnose and self-treat with over-the-counter creams',
      'Wait until it becomes severe before mentioning it',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Brush off the residue and continue wearing it',
      ...
      'Leave it on to prevent further exposure',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only a signature sheet is needed',
      'Records are only required for new employees',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Training is only required once when first employed',
      ...
      'Training is only needed after an accident',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "A list of employees' phone numbers only",
      'Details of the nearest pub for evacuation',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To record employee holiday dates',
      ...
      'To track purchase orders for office supplies',
      'To log visitor details',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'No additional action is needed if they had general COSHH training previously',
      'Provide specific information, instruction, and training on the new substance and its controls before exposure begins',
      'Give them the safety data sheet to read in their own time',
      'Wait until the next annual training session',
    ],
    correctAnswer: 1,
    explanation:
