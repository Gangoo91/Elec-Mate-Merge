...
export const legislationSection: SectionData = {
  ...
  description:
    'Understanding the key legislation that governs health and safety in electrical work',
  content: {
    introduction:
      'This section covers the key legislation and regulations that govern health and safety in electrical work, along with the roles and responsibilities of different stakeholders.',
    subsections: [
      {
        id: '1.1',
        ...
        keyPoints: [
          ...
          'Practical application to work activities',
        ],
      },
      {
        id: '1.2',
        ...
        keyPoints: [
          ...
          'Relationship to electrical work',
        ],
      },
      {
        id: '1.3',
