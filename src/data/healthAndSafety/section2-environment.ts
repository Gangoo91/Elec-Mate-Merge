...
export const safeWorkingEnvironmentSection: SectionData = {
  ...
  content: {
    introduction:
      'This section covers emergency procedures, proper documentation and reporting practices, and environmental considerations for electrical work.',
    subsections: [
      {
        id: '1',
      ...
      },
      {
        ...
        content:
          'Impact of electrical work on the environment and appropriate mitigation measures.',
