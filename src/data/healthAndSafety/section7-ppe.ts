...
export const ppeAndManualHandlingSection: SectionData = {
  sectionNumber: '7',
  title: 'Carry Out Safe Working Practices (Practical Unit)',
  description:
    'Assessment of practical skills in safe working procedures within electrical installation environments',
  content: {
    introduction:
      'This section is assessed through practical assignments demonstrating your ability to work safely in simulated or real electrical installation environments.',
    subsections: [
      {
        id: '7.1',
      ...
      {
        id: '7.3',
        title: 'Safe Execution and Emergency Procedures',
        content:
