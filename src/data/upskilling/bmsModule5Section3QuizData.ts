export const bmsModule5Section3QuizData = [
  {
    question: 'What type of protocol is Modbus (master–slave or peer-to-peer)?',
    options: ['Peer-to-peer', 'Master–slave', 'Client-server', 'Mesh network'],
  ...
  {
    question: 'How many devices are typically supported per RTU segment?',
    options: ['16 devices', '32 devices', '64 devices', '128 devices'],
    correctAnswer: '32 devices',
  },
  {
  ...
  {
    question: 'Name one type of equipment that commonly uses Modbus.',
    options: ['Fire alarm panels', 'Energy meters', 'Security cameras', 'Door access readers'],
    correctAnswer: 'Energy meters',
  },
  {
