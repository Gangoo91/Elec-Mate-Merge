...
export const emergencyEscapeRouteQuizData: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['BS 7671', 'BS 5839', 'BS 5266', 'BS 6008'],
    correctAnswer: 2,
    explanation:
      'BS 5266 sets out the requirements for emergency lighting systems in the UK. BS 5266-1 specifically covers the code of practice for emergency lighting design and installation.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Escape route lighting must be installed near each exit door and at changes of direction. Other mandatory locations include intersections, staircases, and near fire-fighting equipment.',
  },
  {
    id: 5,
    ...
    correctAnswer: 2,
    explanation:
      'Fire-fighting equipment must be illuminated to ensure it can be quickly located and accessed during emergencies. Poor visibility of extinguishers, alarm call points, and other safety equipment can delay emergency response.',
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      'Functional tests should be carried out monthly. These tests check that all escape route lights switch to emergency supply and operate correctly, ensuring the system is ready for use during an emergency.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'Escape route lighting must typically remain on for 3 hours during mains failure. This duration allows sufficient time for evacuation and for emergency services to complete their work.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Maintained exit signs are important in public buildings because they remain visible at all times, even when mains lighting is working. This ensures occupants are always aware of exit locations.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      "After alterations to a building's layout, escape route lighting coverage must be reassessed. New routes may need additional lighting, and existing routes may require modification to maintain compliance.",
  },
  {
    id: 10,
    ...
    correctAnswer: 2,
    explanation:
      'A common mistake is creating gaps in illumination through excessive spacing between luminaires. This can create dark zones where occupants may become disoriented, compromising evacuation safety.',
  },
];
