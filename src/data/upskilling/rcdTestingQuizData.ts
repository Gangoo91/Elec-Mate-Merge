export const rcdTestingQuizData = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      '40ms is the product-standard figure for a non-delay device at 5 × IΔn; the equivalent for an S-type (time-delay) device is 150ms. Both describe the device under BS EN 61008/61009 rather than the test BS 7671 requires — Amendment 4 deleted Table 3A of Appendix 3, and Regulation 643.8 now verifies effectiveness with a single AC test at IΔn.',
  },
  {
    question:
    ...
    correctAnswer: 1,
    explanation:
      'Amendment 4 simplified this considerably. Table 3A (time/current performance criteria for RCDs) has been deleted from Appendix 3, and Regulation 643.8 now calls for an alternating current test at the rated residual operating current (IΔn) to verify effectiveness, regardless of RCD type — AC, A, F or B. The ½ × and 5 × tests are no longer part of the required sequence, though 5 × remains useful when fault-finding. The integral test button checks the mechanism only and has never been a substitute for an instrument test.',
  },
  {
