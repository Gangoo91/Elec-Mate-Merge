...
export const bmsModule2Section5QuizData: QuizQuestion[] = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'I/O modules expand the capacity of BMS controllers by providing additional connection points for sensors and actuators without replacing the main controller.',
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'Digital input modules connect devices that provide on/off or binary status signals, such as switches, contacts, and alarm devices.',
  },
  {
    id: 3,
    ...
    correctAnswer: 3,
    explanation:
      'Digital output modules control devices that require on/off switching, such as pump starters, fan relays, lights, and other binary control devices.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Installing expansion modules close to the equipment they serve reduces cable runs, lowers installation costs, and improves signal quality by minimising cable lengths.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Clear wiring and comprehensive labelling are essential for easy identification, maintenance, and troubleshooting, especially in I/O panels that contain many terminations and connections.',
  },
  {
    id: 10,
    question:
