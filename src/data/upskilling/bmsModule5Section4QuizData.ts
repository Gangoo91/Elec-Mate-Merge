export const bmsModule5Section4QuizData = [
  ...
  },
  {
    ...
    options: ['12V DC', '24V DC (29V nominal)', '48V DC', '240V AC'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Lighting dimmer', 'PIR occupancy detector', 'Blind actuator', 'Power supply'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Wall switch', 'Temperature sensor', 'Lighting dimmer actuator', 'Motion detector'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Router', 'Line coupler', 'Gateway', 'Switch'],
    correctAnswer: 1,
    explanation:
