...
export const dataCablingMockExamQuestions: QuizQuestion[] = [
...
export const getRandomDataCablingMockExamQuestions = (count: number): QuizQuestion[] => {
  const shuffled = [...dataCablingMockExamQuestions].sort(() => 0.5 - Math.random());
