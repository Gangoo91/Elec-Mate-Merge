...
export const bmsModule2Section1QuizData: QuizQuestion[] = [
  {
    ...
    options: ['Digital Input', 'Direct Interface', 'Data Integration', 'Device Installation'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Data Output', 'Digital Output', 'Direct Operation', 'Device Override'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Door contact sensor', 'Flow switch', 'Temperature sensor', 'Alarm contact'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['0-5V and 0-1A', '0-10V and 4-20mA', '12-24V and 1-5A', '0-1V and 10-50mA'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Analog Output', 'Automatic Operation', 'Advanced Override', 'Alternative Option'],
    correctAnswer: 0,
    explanation:
