...
export const insulationResistanceQuizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['5 seconds minimum', '30 seconds minimum', '1 minute minimum', '5 minutes minimum'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Air pressure', 'Humidity and moisture', 'Electromagnetic interference', 'Altitude'],
    correctAnswer: 1,
    explanation:
