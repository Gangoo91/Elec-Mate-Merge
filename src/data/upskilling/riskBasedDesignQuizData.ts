...
export const riskBasedDesignQuizQuestions: QuizQuestion[] = [
  {
    ...
    correct: 1,
    explanation:
      'Every building presents unique challenges including different occupant types, building functions, and hazards that generic minimum standards may not adequately address for true safety.',
  },
  {
    id: 2,
    ...
    correct: 1,
    explanation:
      'Occupant profile (familiar vs unfamiliar, vulnerable groups) and building function (hazardous activities, security sensitivity) are key factors that influence lighting requirements beyond basic standards.',
  },
  {
    id: 3,
    ...
    correct: 1,
    explanation:
      'Elderly residents in care homes often have reduced vision and mobility, requiring higher lux levels (3-5 lux vs 1 lux minimum) to navigate safely during evacuation.',
  },
  {
    id: 4,
    question:
      'What is the standard lux level for escape routes, and why might it need to be increased?',
    options: [
    ...
    correct: 1,
    explanation:
      'The standard minimum is 1 lux for escape routes, but this may need increasing to 3-10 lux for vulnerable occupants, complex layouts, or hazardous environments.',
  },
  {
    id: 5,
    ...
    correct: 1,
    explanation:
      'Theatres need wayfinding lighting that maintains low background levels to avoid disrupting audience dark adaptation while still providing adequate guidance during evacuation.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      'Staff may need to re-enter evacuated areas to safely shut down hazardous equipment, secure valuable items, or assist emergency services, requiring extended lighting duration.',
  },
  {
    id: 8,
    ...
    correct: 1,
    explanation:
      'Disabled occupants need enhanced lighting at refuge points where they may wait for assistance, accessible escape routes including ramps, and evacuation lift controls.',
  },
  {
    id: 9,
    ...
    correct: 1,
    explanation:
      'The Responsible Person under the Fire Safety Order (typically the building owner or manager) is responsible for the fire risk assessment, though electricians should use its findings to inform design.',
  },
  {
    id: 10,
    question:
      "Why is 'designing to the bare minimum' a poor practice in emergency lighting design?",
    options: [
    ...
    correct: 1,
    explanation:
      'Minimum standards provide a baseline but may not address specific building risks, vulnerable occupants, or unique hazards. Designing to actual safety needs ensures genuine protection during emergencies.',
  },
];
