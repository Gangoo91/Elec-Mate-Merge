...
export const renewableEnergyQuestionBank: StandardMockQuestion[] = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Thin-film panels have lower manufacturing costs and better performance in high temperatures.',
    section: 'Solar PV Technology',
    difficulty: 'intermediate',
    topic: 'Panel Types',
    category: 'Solar PV',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Export limitation requires appropriate devices, smart metering, and DNO compliance.',
    section: 'Grid Connection',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'G99 applications require completion of ENA forms, DNO-specific applications, and technical schedules.',
    section: 'Grid Connection',
    difficulty: 'intermediate',
    topic: 'G99 Regulations',
    category: 'Grid Connection',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Complete documentation including test certificates, performance calculations, and handover documents is required.',
    section: 'Testing',
    difficulty: 'basic',
    topic: 'Documentation',
    category: 'Testing & Commissioning',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Comprehensive maintenance includes checking all electrical connections and monitoring systems.',
    section: 'Maintenance',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'All safety aspects including ventilation, temperature control, and fire suppression are crucial.',
    section: 'Energy Storage',
    difficulty: 'basic',
  ...
  },
  {
    ...
    options: [
      'Performance increases with temperature',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Grid-tied and off-grid systems differ in battery requirements, grid connection, and component sizing.',
    section: 'System Design',
    difficulty: 'basic',
    topic: 'System Types',
    category: 'System Design',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Bifacial panels can generate power from both front and rear surfaces, increasing total output.',
    section: 'Solar PV Technology',
    difficulty: 'intermediate',
    topic: 'Panel Types',
    category: 'Solar PV',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Monitoring serves legal, technical, and commercial purposes for solar installations.',
    section: 'Maintenance',
    difficulty: 'basic',
    topic: 'Monitoring',
    category: 'Maintenance',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'MLPE improves both performance optimization and safety through module-level control.',
    section: 'System Design',
    difficulty: 'intermediate',
    topic: 'MLPE',
    category: 'System Design',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Inverter placement must consider aesthetics, accessibility for maintenance, and temperature control.',
    section: 'Installation',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Distributed generation reduces transmission losses by generating power close to consumption.',
    section: 'Introduction',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Module grounding serves safety, performance, and electromagnetic compatibility purposes.',
    section: 'Installation',
    difficulty: 'intermediate',
    topic: 'Grounding',
    category: 'Installation & Safety',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Battery sizing must consider daily consumption, peak demand, and required backup duration.',
    section: 'Energy Storage',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Distributed MPPT allows individual panel optimization, improving overall system performance.',
    section: 'System Design',
    difficulty: 'intermediate',
    topic: 'MPPT',
    category: 'System Design',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Performance ratios are used for cost analysis, system comparison, and fault detection.',
    section: 'Testing',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Data logging supports performance tracking, fault diagnosis, and warranty requirements.',
    section: 'Maintenance',
    difficulty: 'basic',
    topic: 'Monitoring',
    category: 'Maintenance',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Long-term performance depends on initial efficiency, quality components, and regular maintenance.',
    section: 'Maintenance',
    difficulty: 'basic',
    topic: 'System Performance',
    category: 'Maintenance',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'LiFePO4 batteries typically offer the longest cycle life, often exceeding 6,000 cycles.',
    section: 'Energy Storage',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Microinverters provide module-level monitoring and optimization, reducing the impact of shading on individual panels.',
    section: 'System Design',
    difficulty: 'intermediate',
    topic: 'Inverter Types',
    category: 'System Design',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Capacity factor is the ratio of actual energy output to the theoretical maximum if operating at rated power continuously.',
    section: 'Wind Energy',
    difficulty: 'intermediate',
  ...
  },
  {
    id: 105,
    question:
      'What is the typical depth of discharge (DoD) recommendation for lead-acid batteries to maximize lifespan?',
    options: ['90%', '80%', '50%', '20%'],
    correctAnswer: 2,
    explanation:
      'Lead-acid batteries should typically not be discharged below 50% to maximize their operational lifespan.',
    section: 'Energy Storage',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Round-trip efficiency measures the percentage of energy that can be retrieved from a storage system compared to what was stored.',
    section: 'Energy Storage',
    difficulty: 'intermediate',
    topic: 'Battery Efficiency',
    category: 'Energy Storage',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Lithium-ion batteries contain toxic metals like cobalt and nickel that can contaminate soil and water if not properly recycled.',
    section: 'Energy Storage',
    difficulty: 'intermediate',
    topic: 'Environmental Impact',
    category: 'Energy Storage',
  },
  {
    ...
    options: [
      'Vertical axis',
      'Horizontal axis with upwind rotor',
      'Horizontal axis with downwind rotor',
      'Darrieus turbine',
    ],
    correctAnswer: 1,
    explanation:
      'Horizontal axis turbines with upwind rotors are the most common design for utility-scale wind installations.',
    section: 'Wind Energy',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    options: [
      'System voltage',
      'Power extraction from panels',
      'Battery charging',
      'Grid synchronization',
    ],
    correctAnswer: 1,
    explanation:
      'MPPT controllers optimize the operating point of solar panels to extract maximum available power under varying conditions.',
    section: 'System Design',
    difficulty: 'intermediate',
    topic: 'MPPT',
    category: 'System Design',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "Distributed generation reduces transmission losses by generating power closer to where it's consumed.",
    section: 'Introduction',
    difficulty: 'intermediate',
    topic: 'Distributed Generation',
    category: 'Introduction',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'The BMS monitors cell voltages, temperatures, and currents to ensure safe operation and optimize battery performance.',
    section: 'Energy Storage',
    difficulty: 'intermediate',
    topic: 'BMS',
    category: 'Energy Storage',
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'The intermittent and variable nature of renewable sources creates challenges for grid stability and reliability.',
    section: 'Grid Connection',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Wake effect refers to the reduction in wind speed and increased turbulence downwind of operating turbines.',
    section: 'Wind Energy',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Cut-in wind speed is determined by blade aerodynamics, generator characteristics, and overall turbine design.',
    section: 'Wind Energy',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Perovskite solar cells offer potential for low-cost manufacturing, high efficiency, and simple production processes.',
    section: 'Solar PV Technology',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Power optimizers provide module-level MPPT, reducing the impact of shading and module mismatch on system performance.',
    section: 'System Design',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Pitch control adjusts blade angle to control speed, optimize power, and protect the turbine in high wind conditions.',
    section: 'Wind Energy',
    difficulty: 'intermediate',
    topic: 'Pitch Control',
    category: 'Wind Energy',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Multi-junction concentrator cells hold the world record for solar cell efficiency, exceeding 47%.',
    section: 'Solar PV Technology',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Vertical axis turbines can capture wind from any direction without needing to orient themselves into the wind.',
    section: 'Wind Energy',
    difficulty: 'intermediate',
    topic: 'VAWT',
    category: 'Wind Energy',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'C-rate indicates how fast a battery charges or discharges relative to its capacity (1C = full capacity in 1 hour).',
    section: 'Energy Storage',
    difficulty: 'intermediate',
    topic: 'C-Rate',
    category: 'Energy Storage',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Solar panel degradation is influenced by temperature cycling, UV exposure, humidity, and other environmental factors.',
    section: 'Solar PV Technology',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Firm capacity is the amount of power a renewable source can reliably deliver during peak demand periods.',
    section: 'Grid Connection',
    difficulty: 'advanced',
    topic: 'Firm Capacity',
    category: 'Grid Connection',
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Irradiance forecasting helps grid operators plan for variable solar output and optimize system operations.',
    section: 'Grid Connection',
    difficulty: 'intermediate',
    topic: 'Forecasting',
    category: 'Grid Connection',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'HJT cells offer higher efficiency and better temperature coefficients compared to conventional silicon cells.',
    section: 'Solar PV Technology',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    options: [
      'Installation cost',
      'Operating cost',
      'Total lifetime cost per kWh',
      'Replacement cost',
    ],
    correctAnswer: 2,
    explanation:
      'LCOS represents the total cost of a storage system divided by the total energy delivered over its lifetime.',
    section: 'Financial',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Modern utility-scale wind turbines typically have hub heights of 120-160 meters to access better wind resources.',
    section: 'Wind Energy',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Solar irradiance, system costs, and electricity prices all significantly impact the economic viability of solar projects.',
    section: 'Financial',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    options: [
      'Lower costs',
      'Higher efficiency due to cooling',
      'Land preservation',
      'All of the above',
    ],
    correctAnswer: 3,
    explanation:
      'Floating solar offers cost benefits, efficiency gains from water cooling, and preserves valuable land resources.',
    section: 'Solar PV Technology',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Water depth, wind resource quality, and grid connection distance are all critical factors in offshore wind siting.',
    section: 'Wind Energy',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'State of charge indicates the percentage of available capacity remaining in the battery.',
    section: 'Energy Storage',
    difficulty: 'basic',
    topic: 'SOC',
    category: 'Energy Storage',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Land use is the primary environmental concern for utility-scale solar installations, though impacts can be minimized.',
    section: 'Introduction',
    difficulty: 'intermediate',
    topic: 'Environmental Impact',
    category: 'Introduction',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Combiner boxes safely combine multiple DC string circuits from solar panels before sending power to the inverter.',
    section: 'System Design',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Modern wind turbines typically produce noise levels of 35-45 dB at 500 meters, similar to a quiet library.',
    section: 'Wind Energy',
    difficulty: 'intermediate',
    topic: 'Noise Levels',
    category: 'Wind Energy',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Solar panel recycling faces challenges from high costs, technical complexity, and handling of some hazardous materials.',
    section: 'Solar PV Technology',
    difficulty: 'intermediate',
    topic: 'Recycling',
    category: 'Solar PV',
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'System design, component quality, and environmental conditions all significantly impact the performance ratio.',
    section: 'Testing',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'The nacelle cover provides weather protection, contributes to aerodynamics, and helps reduce noise.',
    section: 'Wind Energy',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Renewable integration needs, grid stability requirements, and decreasing costs all drive storage growth.',
    section: 'Energy Storage',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Heterojunction technology offers both higher efficiency and superior temperature coefficients.',
    section: 'Solar PV Technology',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'State of health compares the current maximum capacity to the original rated capacity of the battery.',
    section: 'Energy Storage',
    difficulty: 'intermediate',
    topic: 'SOH',
    category: 'Energy Storage',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Agrovoltaics can increase crop yields, reduce water usage through shading, and maximize land productivity.',
    section: 'Solar PV Technology',
    difficulty: 'intermediate',
    topic: 'Agrovoltaics',
    category: 'Solar PV',
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Initial cost, cycle life, and efficiency all significantly impact the economics of battery storage systems.',
    section: 'Financial',
    difficulty: 'intermediate',
    topic: 'Storage Economics',
    category: 'Financial',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'V2G faces challenges from technical complexity, potential battery impacts, and grid integration requirements.',
    section: 'Energy Storage',
    difficulty: 'advanced',
    topic: 'V2G',
    category: 'Energy Storage',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Modern solar panels typically have energy payback times of 1-2 years in favorable climates.',
    section: 'Introduction',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Modular systems offer scalability and flexibility, allowing capacity to be added incrementally as needed.',
    section: 'Energy Storage',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Pitch systems control blade angle to optimize efficiency, regulate power, and reduce noise when needed.',
    section: 'Wind Energy',
    difficulty: 'intermediate',
    topic: 'Pitch System',
    category: 'Wind Energy',
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'DC optimizers provide module-level power optimization, safety features, and detailed monitoring capabilities.',
    section: 'System Design',
    difficulty: 'intermediate',
    topic: 'DC Optimizers',
    category: 'System Design',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Seasonal storage faces challenges from technical complexity, extremely high costs, and significant efficiency losses.',
    section: 'Energy Storage',
    difficulty: 'advanced',
