...
export const smartHomeSection2QuizQuestions: QuizQuestion[] = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The five main benefits are convenience (automating tasks), energy efficiency (optimising usage), safety and security (integrated protection), accessibility (assistive technology), and comfort and lifestyle (customisable environments).',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Zoning in HVAC systems refers to dividing the house into different areas that can be independently temperature-controlled, allowing for customised comfort and improved energy efficiency.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "Video doorbell systems provide two-way communication, allowing homeowners to see and speak with visitors in real-time, whether they're at home or away.",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Daylight harvesting sensors automatically adjust artificial lighting brightness based on available natural light levels, maintaining consistent illumination while minimising energy consumption.',
  },
  {
    id: 10,
    ...
    correctAnswer: 2,
    explanation:
      'Smart HVAC zoning allows heating or cooling only the areas that are occupied or need climate control, significantly reducing energy waste and lowering utility costs while maintaining comfort.',
  },
];
