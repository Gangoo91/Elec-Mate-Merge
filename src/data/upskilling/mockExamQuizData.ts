...
export const mockExamQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['(r1 + r2) ÷ 2', '(r1 + r2) ÷ 4', '(r1 × r2) ÷ (r1 + r2)', 'r1 + r2'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['R1 + R2', 'Ze + R1', 'Ze + (R1 + R2) × 1.67', '1.67 × (R1 + R2)'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['EIC only', 'MEIWC only', 'Both EIC and EICR', "Designer's records only"],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['10 minutes', '4 minutes', '1 minute', '30 seconds'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['High temperature', 'Wet or damp conditions', 'Windy conditions', 'Bright sunlight'],
    correctAnswer: 1,
    explanation:
