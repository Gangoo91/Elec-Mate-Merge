...
export const smartHomeQuestionBank: StandardMockQuestion[] = [
  ...
  },
  {
    ...
    options: [
      'Indoor Optimisation Technology',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'AI learns from user behaviour patterns and environmental conditions to automatically adjust settings and create personalized automation without manual programming.',
    section: 'Smart Home Fundamentals',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    options: [
      ...
      'Understanding usage patterns for optimisation',
      'Encrypting all communication between devices',
      'Extending the wireless range of the hub',
    ],
    correctAnswer: 1,
    explanation:
      'Smart home analytics analyse usage patterns to optimize system performance, energy efficiency, and user comfort through data-driven insights.',
    section: 'Smart Home Fundamentals',
    difficulty: 'intermediate',
    topic: 'Analytics',
    category: 'Fundamentals',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'BLE typically provides a range of 10-30 metres in indoor environments, though this can vary based on obstacles and device implementation.',
    section: 'Communication Protocols',
    difficulty: 'basic',
    topic: 'Bluetooth',
    category: 'Protocols',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Different protocols excel in different areas - using multiple protocols allows optimisation for specific use cases (e.g., Wi-Fi for high bandwidth, Zigbee for sensors).',
    section: 'Communication Protocols',
    difficulty: 'intermediate',
  ...
  {
    id: 59,
    question: "Which colour temperature is typically used for 'warm white' lighting?",
    options: [
      '7000K+',
      '4000K-4500K',
      '5000K-6500K',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Circadian lighting adjusts colour temperature and brightness throughout the day to support natural human circadian rhythms and improve sleep quality.',
    section: 'Lighting Control',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    options: [
      ...
      'Colour temperature and adequate brightness',
    ],
    correctAnswer: 3,
    explanation:
      'Task lighting requires appropriate colour temperature (typically cooler, 4000K+) and adequate brightness levels to support visual tasks effectively.',
    section: 'Lighting Control',
    difficulty: 'intermediate',
    topic: 'Task Lighting',
    category: 'Lighting',
  ...
  },
  {
    ...
    options: [
      'Lights that can change between different white colour temperatures',
    ...
    correctAnswer: 0,
    explanation:
      'Tunable white lighting can adjust colour temperature from warm (2700K) to cool (6500K) whites, supporting circadian rhythms and different activities.',
    section: 'Lighting Control',
    difficulty: 'intermediate',
    topic: 'Tunable White',
    category: 'Lighting',
  ...
  },
  {
    ...
    options: [
      'Learning algorithms that adapt to occupant behaviour',
    ...
    correctAnswer: 0,
    explanation:
      'Learning algorithms analyse occupant behaviour patterns and preferences to optimize both comfort and energy efficiency automatically.',
    section: 'HVAC Control',
    difficulty: 'intermediate',
    topic: 'AI Learning',
    category: 'HVAC',
  ...
  },
  {
    ...
    options: [
      ...
      'Automatically adjusting comfort settings based on occupant feedback and behaviour',
    ...
    correctAnswer: 1,
    explanation:
      'Adaptive comfort automatically adjusts environmental settings based on occupant feedback, behaviour patterns, and external conditions.',
    section: 'HVAC Control',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    options: [
      ...
      'Analysing user interface interactions',
  ...
  },
  {
    ...
    options: [
      'Intuitive mobile apps with logical organisation',
    ...
    correctAnswer: 0,
    explanation:
      'Intuitive mobile apps with logical organisation make it easy for users to monitor, control, and configure their smart home systems.',
    section: 'Hubs & Voice Assistants',
    difficulty: 'basic',
    topic: 'User Interface',
    category: 'Hubs',
  ...
  },
  {
    ...
    options: [
      ...
      'Analysing network topology and optimizing device placement',
    ],
    correctAnswer: 3,
    explanation:
      'Analysing mesh topology and optimizing device placement ensures proper signal paths and eliminates coverage gaps.',
    section: 'Troubleshooting & Maintenance',
    difficulty: 'intermediate',
    topic: 'Mesh Networks',
    category: 'Maintenance',
