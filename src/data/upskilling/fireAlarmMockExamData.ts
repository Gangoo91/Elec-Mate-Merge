...
export const fireAlarmQuestionBank: StandardMockQuestion[] = [
  ...
  // Module 2 - Detectors, Call Points, and Alarm Devices (25 questions)
  {
    id: 21,
    question:
      'BS 5839-1:2025 limits detector coverage by distance, not by area. On a flat ceiling, how far may any point in a protected area be from the nearest smoke detector?',
    options: [
      '5.3 m',
      '7.5 m',
      '10.6 m',
    ...
    correctAnswer: 1,
    explanation:
      'Clause 21.2.1a): the horizontal distance between any point in a protected area and the nearest smoke detector should not exceed 7.5 m (21.2.1b) gives 5.3 m for a heat detector. BS 5839-1 sets no coverage area per detector at all, so any m² figure is a manufacturer or rule-of-thumb convention rather than a recommendation of the standard. 10.6 m is the related but different figure: it is the centre-to-centre spacing the 7.5 m radial limit works out at on a square grid.',
    section: 'Module 2',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Clause 19.8: manual call points should be fixed at a height of 1.4 m +0.2/-0.3 m above finished floor level, measured to the centre of the operating face — so anywhere from 1.1 m to 1.6 m. The tolerance is asymmetric, not the ±0.1 m often quoted.',
    section: 'Module 2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Clause 21.2.1b): no point in a protected area should be more than 5.3 m from the nearest heat detector. 7.5 m is the smoke detector figure and is the classic trap. Heat detectors sit closer together because a heat detector only responds once the fire is large enough to drive hot gases across the ceiling, so the standard gives it less distance to cover.',
    section: 'Module 2',
    difficulty: 'advanced',
    topic: 'Detector Coverage',
    category: 'Detectors & Devices',
  ...
  },
  {
    id: 36,
    question:
      'How does BS 5839-1:2025 specify the number and distribution of visual alarm devices?',
    options: [
      'No more than 30 m apart',
      'Sufficient to be readily visible from all normally accessible locations',
      'One per detection zone',
      'No more than 25 m apart',
    ],
    correctAnswer: 1,
    explanation:
      'Clause 16.2 sets a performance requirement rather than a spacing: visual alarm devices should be sufficient in number and distribution to be readily visible from all normally accessible locations throughout the area they serve, under normal ambient lighting. BS 5839-1 gives no maximum distance between devices — coverage comes from the device\'s BS EN 54-23 coverage rating. Clause 16.1 is what triggers their use: ambient noise above 90 dB(A), or areas where hearing protection is normally worn.',
    section: 'Module 2',
    difficulty: 'intermediate',
    topic: 'Visual Alarms',
    category: 'Detectors & Devices',
  ...
  // Module 3 - System Design and Zone Planning (20 questions)
  {
    ...
    correctAnswer: 1,
    explanation:
      'BS 5839-1 places no limit on the number of detectors in a zone. A zone is bounded by floor area (2 000 m², clause 12.3a) and by search distance (60 m, clause 12.3b) — both concerned with how quickly someone responding can locate the fire, not with device counts. Figures like 32 per zone or 99 per loop are panel and loop-card constraints set by the manufacturer, not recommendations of the standard.',
    section: 'Module 3',
    difficulty: 'intermediate',
    topic: 'Zone Design',
  ...
  },
  {
    id: 47,
    question:
      'Where should the sensitive element of a ceiling-mounted smoke detector sit relative to the ceiling?',
    options: [
      'At least 600 mm below the ceiling',
      'Between 25 mm and 600 mm below the ceiling',
      'Between 25 mm and 150 mm below the ceiling',
      'Flush with the ceiling surface',
    ],
    correctAnswer: 1,
    explanation:
      'Clause 21.2.4a): the sensitive element of a smoke detector should be between 25 mm and 600 mm below the ceiling; 21.2.4b) gives 25 mm to 150 mm for a heat detector. 600 mm is the maximum depth, not a minimum. The 25 mm lower bound keeps the element out of the stagnant boundary layer held against the ceiling itself, and the upper bound keeps it inside the layer of hot smoke spreading beneath it.',
    section: 'Module 3',
    difficulty: 'advanced',
    topic: 'Installation Heights',
    category: 'Design & Zoning',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Clause 43.3.5: a functional test should be carried out on every detector within the 12-month period that clause 43.3 covers — 100%, not a sample. There is no 25% rule and no four-year cycle anywhere in BS 5839-1. The only quarterly item in the inspection clauses is 43.1, the examination of vented batteries, which is usually where the "quarterly percentage" idea comes from.',
    section: 'Module 6',
    difficulty: 'intermediate',
    topic: 'Detector Testing',
    category: 'Testing & Maintenance',
  ...
  {
    id: 112,
    question: 'What does BS 5839-1:2025 say about how long fire alarm records should be kept?',
    options: [
      'At least 2 years',
      'It sets no retention period — the logbook records events as they occur',
      'At least 5 years',
      'At least 1 year',
    ],
    correctAnswer: 1,
    explanation:
      'BS 5839-1 sets no retention period. Clause 48 recommends that a logbook be kept, recording all events in respect of the system, kept up to date and available for inspection, in either paper or digital form. Any fixed retention figure comes from the responsible person\'s duties under fire safety legislation or from an insurer, not from BS 5839-1.',
    section: 'Module 6',
    difficulty: 'intermediate',
