...
export const smartHomeModule6Section3QuizQuestions: QuizQuestion[] = [
  {
    ...
    correct: 1,
    explanation:
      'A routine is a pre-set sequence of actions that can be triggered automatically by commands, schedules, or events, saving time and improving efficiency.',
  },
  {
    id: 2,
    ...
    correct: 1,
    explanation:
      "A 'Good morning' routine typically includes multiple actions like turning on lights, starting the kettle, and adjusting heating to prepare the home for the day.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      'This represents a conditional automation rule using IF-THEN logic where motion detection triggers the light to turn on automatically.',
  },
  {
    id: 5,
    ...
    correct: 1,
    explanation:
      'A single command routine is triggered by one phrase but can control multiple devices and perform various actions simultaneously.',
  },
  {
    id: 6,
    ...
    correct: 2,
    explanation:
      'Event-based routines are triggered automatically by events like geofencing (arriving home), sensors, or schedules rather than voice commands.',
  },
  {
    id: 7,
    ...
    correct: 1,
    explanation:
      'Conditional routines can include multiple factors like temperature thresholds and time conditions to create more intelligent heating control.',
  },
  {
    id: 8,
    ...
    correct: 1,
    explanation:
      "Clear device names like 'Kitchen light' instead of 'Device 1' ensure voice commands work properly and users can easily identify and control devices.",
  },
  {
    id: 9,
    ...
    correct: 1,
    explanation:
      "Over-complicating routines can confuse end users. It's better to start simple and add complexity gradually as clients become more comfortable.",
  },
  {
    id: 10,
    ...
    correct: 1,
    explanation:
      "The phrase 'Hey Google, we're off' triggered the comprehensive leaving home routine that controlled lights, heating, locks, and security cameras.",
  },
];
