...
export const bmsModule4Section3QuizData: QuizQuestion[] = [
  {
    ...
    correct: 1,
    explanation:
      'Access control integrated with BMS can trigger lighting and HVAC activation only when authorised personnel enter areas, significantly reducing energy consumption in unoccupied zones.',
  },
  {
    id: 2,
    ...
    correct: 2,
    explanation:
      'Door relays receive signals from readers or the BMS and switch the lock power accordingly, controlling electromagnetic locks or electric strikes.',
  },
  {
    id: 3,
    ...
    correct: 1,
    explanation:
      'Fail-safe locks release when power is cut (used for fire exits), while fail-secure locks stay locked without power (used in high-security areas).',
  },
  {
    id: 4,
    ...
    correct: 1,
    explanation:
      'Electromagnetic locks (maglocks) provide very strong holding force (often 300kg+) and can be retrofitted to existing doors without major modifications to the door frame.',
  },
  {
    id: 5,
    ...
    correct: 1,
    explanation:
      'BS 7273 requires that access control systems integrate with fire alarms to ensure all secured doors unlock automatically during fire emergencies, allowing safe evacuation.',
  },
  {
    id: 6,
    question: 'At what height are card readers typically mounted?',
    options: ['0.9m', '1.2m', '1.5m', '1.8m'],
    correct: 1,
    explanation:
      'Card readers are typically mounted at 1.2m height to be accessible for all users, including those in wheelchairs, while being at a comfortable height for standing users.',
  },
  {
    id: 7,
    ...
    correct: 1,
    explanation:
      'Access control uses low-voltage data signals that can be affected by electromagnetic interference from mains cables, potentially causing communication errors or false readings.',
  },
  {
    id: 8,
    ...
    correct: 1,
    explanation:
      'Access control systems require UPS or battery backup to ensure locks operate correctly during power outages, maintaining both security and safety functions.',
  },
  {
    id: 9,
    ...
    correct: 1,
    explanation:
      'Emergency release units provide a manual override mechanism that allows immediate exit during emergencies, ensuring occupant safety even if the electronic systems fail.',
  },
  {
    id: 10,
    ...
    correct: 2,
    explanation:
      'The electricians installed maglocks but failed to integrate them with the fire alarm system, meaning doors remained locked during fire alarm activation, preventing safe evacuation.',
  },
];
