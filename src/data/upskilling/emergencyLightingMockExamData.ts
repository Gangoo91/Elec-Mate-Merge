...
export const emergencyLightingQuestionBank: StandardMockQuestion[] = [
  // MODULE 1: Introduction to Emergency Lighting (50 questions)
  {
    ...
    options: [
      'To provide decorative ambient lighting after normal working hours have ended',
      ...
      'To reduce energy costs by replacing part of the normal lighting installation entirely',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The Building Regulations Part B on its own',
      'The Regulatory Reform (Fire Safety) Order 2005 alone',
      'Both Building Regulations and Fire Safety Order',
      'The Health and Safety at Work Act 1974 on its own',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'The photometric performance levels such as illuminance and uniformity ratios on escape routes',
      'The wiring regulations that apply to fixed electrical installations in all types of building',
      'The construction and the fire-resistance ratings of escape route doors and their door frames',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Maintained, non-maintained, and sustained lighting types',
      'Escape route, open area (anti-panic), and high-risk task area',
      'Self-contained, central battery, and slave luminaire installations',
      'Internal, external, and stairwell lighting classifications',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Lights that illuminate only when the normal supply fails completely',
      'Lights that are switched on manually by the responsible person for the premises',
      'Lights energised continuously, operating from normal and emergency supplies',
      'Lights that gradually fade out once the battery has begun to discharge itself',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Lighting that operates only when the normal mains supply fails completely',
      'Lights that can be switched between maintained and non-maintained modes',
      'Lighting that is energised continuously from the normal mains supply alone',
      'Lighting that is powered exclusively from a remote central battery system',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Because the batteries lose their capacity faster overnight in cooler conditions',
      'Because sleeping occupants are exempt from monthly testing requirements',
      'Because three hours is the standard recharge time for the batteries',
  ...
  },
  {
    ...
    options: [
      ...
      'A luminaire fed from a remote central battery bank through fire-resistant cable',
      'A luminaire powered solely from the normal lighting circuit of the area',
      'A luminaire that relies on a photoluminescent material rather than on a battery',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A system where each luminaire contains its own integral battery and gear',
      'A system where all luminaires are powered from a central battery bank',
      'A system where the luminaires charge themselves from daylight during the day',
      'A system where the luminaires run directly from a standby generator only',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Lower initial cost and quicker installation in smaller premises',
      'No requirement at all for fire-resistant cabling running to the luminaires',
      'Each luminaire fails independently without affecting the others',
  ...
  },
  {
    ...
    options: [
      ...
      'Small single-storey retail units with only a single escape route',
      'Domestic dwellings and individual residential flats or maisonettes',
      'Temporary site cabins and portable welfare unit blocks',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Luminaires containing their own integral battery and test facilities',
      'Luminaires powered by the central battery without their own battery',
      'Luminaires that charge up from daylight and glow during a mains failure',
      'Luminaires energised only when they are manually switched on by staff',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Higher running temperature and a much shorter overall service life in use',
      'Greater power draw, which reduces the achievable battery duration in use',
      'Higher efficacy, longer battery life, reduced maintenance, and better performance',
      'Slower start-up, requiring a long warm-up period before full light output is reached',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'A written warning only, with no financial penalty or custodial sentence at all',
      'A fixed penalty notice capped at £1,000 for each premises inspected',
      'Loss of the buildings insurance cover, with no enforcement action taken at all',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Escape route lighting that guides the occupants along the escape route to the final exit door',
      'Emergency lighting to enable normal activities to continue in the event of supply failure',
      'Fire-fighting equipment lighting that illuminates the extinguishers and the call points too',
      'Anti-panic lighting that provides open area illumination in order to reduce disorientation',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'To reduce the size of the battery required for the rated duration',
      'To allow the lighting to be tested without having to isolate the mains supply',
      'To remove the need for any fire-resistant cabling on the circuits',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The emergency lamp must give at least 50% of its normal light output throughout',
      'Battery voltage must not fall below 50% of nominal at end of rated duration',
      'Only 50% of the luminaires need to be tested at each annual inspection visit',
      'The battery must recharge to 50% of its capacity within the first hour',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A photocell that responds to the falling daylight levels outside',
      'A manual test key operated by the responsible person for the site',
      'A control circuit that continuously monitors mains voltage',
      'A thermal sensor that detects the heat from a developing fire',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Zinc-carbon (dry cell type)',
      'Lithium-ion (cobalt oxide chemistry)',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      '4 hours maximum under BS 5266-1',
      '24 hours maximum as per BS 5266-1',
      '48 hours maximum under BS 5266-1',
      '72 hours maximum under BS 5266-1',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To prevent the standby batteries from discharging while the whole building is left unoccupied',
      'To deter intruders by simulating continued occupation of the empty premises overnight',
      'Fire service, maintenance personnel, and security staff still require safe escape routes',
      'To satisfy the buildings insurance conditions that apply to any vacant commercial property',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'They are simply two different names used for exactly the same thing in every type of building',
      'Escape route lighting is the overall category; emergency escape lighting is a specific subtype',
      'Escape route lighting applies only outdoors, and emergency escape lighting applies only indoors',
  ...
  },
  {
    ...
    options: [
      ...
      'Slightly higher electricity costs, with the evacuation safety wholly unaffected by the shortfall',
      'A purely cosmetic shortfall that carries no enforcement or insurance consequences at all',
      'Reduced battery life and a shorter duration, but with the evacuation safety unchanged',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only the manufacturer\'s datasheet for each of the luminaires that are fitted',
      'Design calculations, layout drawings, certificates, and maintenance records',
      'Just the date on which the system was first energised and handed over',
      'A copy of the building insurance policy and the total floor area of the site',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Changes of level are exit points and so they need only exit signage there',
      'Changes of level reflect more light and so they need less illumination',
      'Changes of level present trip hazards requiring adequate illumination',
      'Changes of level require lighting purely for architectural emphasis alone',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To recharge the call point batteries during a mains supply failure',
      'To indicate which of the call points has already been activated first',
      'To provide task lighting for resetting the fire alarm control panel afterwards',
  ...
  },
  {
    ...
    options: [
      ...
      'Emergency lighting is only required where the ceilings exceed 2.5 metres in overall height',
      'Emergency lighting is only required where the ceilings exceed 4 metres in height',
      'Emergency lighting is only required within single-storey buildings and their open spaces',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To allow the security staff to monitor who enters and leaves the building',
      'To ensure exits are clearly visible and accessible during evacuation',
      'To provide decorative illumination of the door furniture and the frames',
      'To keep the door magnetic locks energised throughout a supply failure',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Internal lighting must be maintained, while the external lighting is non-maintained',
      'External lighting requires a longer rated duration than the internal lighting does',
      'External lighting uses weather-resistant luminaires and covers external escape routes',
      'Internal lighting always uses LED, while external lighting must use fluorescent lamps only',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Very bright lighting startles the occupants into evacuating the building more quickly',
      'It allows occupants to read the printed evacuation instructions that are displayed on walls',
      'It signals to the occupants that the fire service has already arrived at the premises outside',
  ...
  },
  {
    ...
    options: [
      ...
      'Toilets are always classified as high-risk task areas under BS EN 1838 in every case',
      'Toilets must be lit so that the cleaning work can continue during a mains power failure',
      'The toilet extract fans must be kept running from the emergency lighting supply as well',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Because the assessment sets the battery duration that is required for each luminaire fitted',
      'Because the assessor must physically test every single luminaire on the site in turn',
      'Emergency lighting is a critical fire safety measure that must be assessed for adequacy',
      'Because the risk assessment replaces the need for all routine maintenance work on site',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To allow the passenger lift to be used for evacuation during a fire in the building',
      'To keep the lift call buttons and the floor indicators illuminated for normal daily use',
      'To provide high-risk task lighting for the engineers who are servicing the lift motor',
  ...
  },
  {
    ...
    options: [
      ...
      'How to carry out the monthly functional test on each of the luminaires fitted',
      'How to replace any failed batteries and lamps in the luminaires themselves',
      'The detailed photometric design calculations for the whole of the building',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To recharge the defibrillator batteries during a mains supply failure',
      'To ensure first aid can be located and given safely during a power failure',
      'To keep the first aid room ventilation running from the emergency lighting supply',
      'To illuminate the first aid signage so that it glows in the dark later',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The fire alarm system draws all of its power from the emergency lighting battery',
      'Emergency lighting must be physically wired into each of the smoke detector heads directly',
      'Emergency lighting can be triggered by fire alarm activation as well as supply failure',
      'Emergency lighting and fire detection are required to share the same final circuit always',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Because refurbishment work automatically voids the original commissioning certificate',
      'Because any new luminaires always use a completely different battery chemistry inside',
      'Because the testing frequency must be reset after any building work is carried out',
  ...
  },
  {
    ...
    options: [
      ...
      'The first doorway encountered after leaving any occupied room',
      'The point at which a corridor changes direction toward a stair',
      'Any internal door that is fitted with a green running-man exit sign above',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To keep the sprinkler pumps running throughout any mains power failure on site',
      'To ensure fire extinguishers, hoses, and equipment remain visible and accessible',
      'To recharge the batteries fitted inside each of the portable fire extinguishers there',
      'To provide decorative highlighting of the fire point signage on the corridor wall',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To power the lift serving the refuge area so that it can still be used during a fire evacuation',
      'To keep the refuge area intercom and its display lit for the use of the marshalling staff only',
      'Refuge areas must be illuminated to provide safety and communication while awaiting rescue',
      'To provide high-risk task lighting so that normal work can continue within the refuge area itself',
    ],
    correctAnswer: 2,
    explanation:
  ...
  // MODULE 2: System Categories and Lighting Types (50 questions)
  {
    ...
    options: [
      'To provide anti-panic illumination across large open floor areas of a building',
      'To allow any dangerous processes to be shut down safely on failure of the normal supply',
      'To enable normal work activities to continue during a failure of the supply',
  ...
  },
  {
    ...
    options: [
      'It reduces the number of luminaires that are needed along the whole route',
      'It allows a lower battery duration to be specified for the system',
      'To prevent dark spots that could impair vision and cause disorientation',
      'It makes the exit signs appear much brighter to the occupants passing by',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'At the final exit door of each of the escape routes, but not at any intermediate points along it',
      'Only where the escape route passes a window, a rooflight or any other source of borrowed daylight',
      'At the mid-point of each straight section of every corridor in the building, and nowhere else at all',
  ...
  },
  {
    ...
    options: [
      ...
      'To enable normal work activities to continue during a failure of the mains supply',
      'To allow any dangerous machinery to be shut down safely on failure of the normal supply',
      'To highlight the direction of travel along narrow corridors and passageways',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Lighting that marks the direction of travel to the nearest available exit door',
      'Lighting that provides anti-panic illumination right across all the large open areas',
      'Lighting that keeps the exit signs visible to all occupants within unfamiliar premises',
  ...
  },
  {
    ...
    options: [
      'Open-plan offices, reception areas, meeting rooms, and general corridors',
      'Corridors, stairwells, lift lobbies, and the main building entrance halls',
      'Plant rooms, laboratories, industrial processes, and operating theatres',
      'Toilets, storage cupboards, and unoccupied roof spaces and ceiling voids',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To provide the minimum 1 lux illuminance along the whole of the escape route floor',
      'To keep the fire-fighting equipment illuminated during a supply failure',
      'To act as anti-panic lighting within the large open areas of a building',
  ...
  },
  {
    ...
    options: [
      ...
      'Self-contained and central battery types',
      'Photoluminescent and reflective types',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'To provide anti-panic illumination for the large open stair landings only',
      'To keep the fire-fighting equipment on the stair illuminated at all times',
      'To allow the stair to be used as a high-risk task area during a failure',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To keep the external CCTV cameras operating during a supply failure',
      'To deter intruders from approaching the building during the night',
      'To ensure doors can be located, identified, and operated during evacuation',
      'To provide anti-panic lighting out in the external car park area',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To reduce the number of luminaires required along the escape route',
      'To allow a shorter battery duration to be specified for the system',
      'To make the exit signs along the route appear much brighter still',
  ...
  },
  {
    ...
    options: [
      ...
      'To provide task lighting for resetting the fire alarm control panel',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To keep the sprinkler pumps running throughout a mains power failure',
      'To recharge the batteries fitted inside portable fire extinguishers',
      'To provide decorative highlighting of the fire point signage nearby',
  ...
  },
  {
    ...
    options: [
      'To keep the servers running on the emergency lighting supply during a failure',
      'To enable safe shutdown of critical systems and safe evacuation during power failures',
      'To provide anti-panic lighting only, since server rooms are treated as large open areas',
      'To illuminate the room solely for routine maintenance access by the engineers',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'High-risk task area lighting throughout the whole of the floor area',
      'Exit signs only, with no general illumination of the floor at all',
      'Combination of escape route and open area (anti-panic) lighting',
      'Standby lighting so that work can continue during a failure',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Windowless rooms always have much higher fire loads than the other rooms nearby',
      'Windowless rooms are always classified as high-risk task areas under the standard',
      'Windowless rooms must keep their ventilation running from the battery supply too',
  ...
  },
  {
    ...
    options: [
      ...
      'To power the refuge area lift so that it can be used during any fire evacuation',
      'To provide high-risk task lighting so that normal work can continue within the refuge area',
      'To keep the refuge area intercom screen lit for use by the marshalling staff only',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'High-risk task area lighting across the whole of the parking deck area',
      'Escape route lighting at pedestrian walkways, exits, and stair access',
      'Standby lighting so that vehicles can continue to be parked there',
      'Anti-panic lighting only, with no marked escape routes anywhere at all',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To recharge the luminaire batteries from the local stair lighting circuit nearby',
      'To classify the whole of the stair as a high-risk task area under the standard',
      'To ensure clear visibility when entering and exiting stairs, preventing falls',
      'To provide anti-panic lighting on the open stair landings and nowhere else at all',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'High-risk task area lighting in every storage area without any exception',
      'Standby lighting so that stock can be located during a failure',
  ...
  },
  {
    ...
    options: [
      ...
      'A high 100:1 max-to-min ratio that makes each exit stand out from the approach corridor',
      'Switching the exit luminaire over to non-maintained operation so as to increase contrast',
      'Mounting all the escape route luminaires at floor level close to the exit door',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'To reduce the running cost of the whole lighting installation',
      'To allow a smaller battery to be specified for each unit',
      'To improve the appearance of the escape route corridor',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To provide decorative lighting for the whole space',
      'To illuminate the outdoor parking areas',
      'To allow safe shutdown of dangerous processes',
      'To provide general lighting in the room',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'To reduce the number of luminaires required overall',
      'To allow a shorter battery duration to be used instead',
      'To make the exit signs appear much brighter',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To warn of the high-risk task areas within the building',
      'To indicate the route to follow to reach final exits',
      'To identify the location of the fire-fighting equipment',
      'To mark the boundary of the anti-panic lighting zones',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    question: 'Why must exit signs operate in maintained mode in public buildings?',
    options: [
      'To conserve the battery capacity until a supply failure occurs',
      'To reduce the day-to-day running cost of the exit signs fitted',
      'To ensure continuous visibility, especially to unfamiliar occupants',
      'To allow the staff to switch the signs off whenever they are not needed',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To allow the lift to be used for evacuation during a fire alarm event',
      'To provide safe holding areas and guide occupants to staircases',
      'To keep the lift call buttons illuminated for normal everyday use',
      'To provide task lighting for the lift maintenance engineers',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    question: 'What is the purpose of emergency lighting near fire alarm call points?',
    options: [
      'To recharge the call point battery during a mains supply failure on site',
      'To indicate which of the call points have already been activated on site',
      'To ensure call points remain visible and operable during power failures',
      'To provide task lighting for resetting the fire alarm control panel later',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Because the original certificate is then automatically voided',
      'Because any new luminaires always use a different battery type',
      'Because the testing frequency must restart once any building work is done',
  ...
  },
  {
    ...
    options: [
      ...
      'The first internal door that is fitted with a green exit sign',
      'The mid-point of the longest corridor within the whole building',
      'Any door at all that leads into a protected stairwell',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    question: 'What is the purpose of emergency lighting above fire safety equipment?',
    options: [
      'To keep the sprinkler pumps running during a mains power failure',
      'To ensure visibility and accessibility during emergencies',
      'To recharge the batteries inside the portable extinguishers',
      'To provide decorative highlighting of the equipment nearby',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To power the refuge lift so that it can still be used during a fire',
      'To provide high-risk task lighting within the refuge area',
      'To provide safety and reassurance while awaiting assisted rescue',
      'To keep the refuge area intercom lit for staff use only',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'High-risk task area lighting across the whole of the parking deck',
      'Standby lighting so that vehicles can continue to be parked there',
  ...
  },
  {
    ...
    options: [
      ...
      'To classify the whole stair as a high-risk task area under the standard',
      'To recharge the luminaire batteries from the local stair circuit nearby',
      'To provide anti-panic lighting on the stair landings and nowhere else',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    question: 'What is the purpose of emergency lighting in storage areas?',
    options: [
      'To provide high-risk task lighting in every storage area used',
      'To provide escape route lighting if the area is regularly occupied',
      'To keep the stock illuminated for stocktaking during a supply failure',
      'To provide anti-panic lighting regardless of the occupancy',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Lighting that guides the occupants to the final exit of the building',
      'Lighting that illuminates the fire-fighting equipment along the escape route',
      'Lighting that provides anti-panic illumination within the large open areas',
  ...
  },
  {
    ...
    options: [
      'Battery voltage must not fall below 50% of nominal at end of rated duration',
      'Only 50% of the luminaires need to be tested at each annual inspection visit',
      'The lamp must still give at least 50% of its normal light output throughout it',
      'The battery must recharge to 50% of its rated capacity within the first hour',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Logging the run time of the luminaire for the maintenance records',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Zinc-carbon (dry primary cells)',
      'Flooded lead-acid (vented wet cells)',
      'Lithium Iron Phosphate (LiFePO4)',
      'Alkaline (non-rechargeable cells)',
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    question: 'What is the purpose of emergency lighting near fire alarm call points?',
    options: [
      'To recharge each call point battery during a mains supply failure on site',
      'To indicate which of the call points have already been used in the building',
      'To provide task lighting for resetting the fire alarm panel again afterwards',
  ...
  },
  {
    ...
    options: [
      'To provide safety and reassurance while awaiting assisted rescue',
      'To power the refuge area lift for use during a fire in the building',
      'To provide high-risk task lighting within the refuge area',
      'To keep the refuge area intercom lit for the staff alone',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'Standby lighting so that vehicles can keep being parked',
      'Anti-panic lighting only, with no marked escape routes at all',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    question: 'Why must emergency lighting be provided at the top and bottom of staircases?',
    options: [
      'To classify the whole stair as a high-risk task area',
      'To ensure visibility and prevent falls at level transitions',
      'To recharge the luminaire batteries from the local stair circuit',
      'To provide anti-panic lighting on the stair landings only',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    question: 'What is the purpose of emergency lighting in storage areas?',
    options: [
      'To provide high-risk task lighting in every storage area in the building',
      'To keep the stock illuminated for stocktaking during a supply failure',
      'To provide escape route lighting if the area is regularly occupied',
      'To provide anti-panic lighting regardless of the occupancy level',
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      ...
      'Lighting that guides the occupants towards the final exit door',
      'Lighting that illuminates the fire-fighting equipment on site',
      'Lighting that provides anti-panic illumination in the open areas',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    question: "What is the '50% rule' in emergency lighting battery testing?",
    options: [
      'The lamp must still give at least 50% of its normal luminous output throughout',
      'Battery voltage must not fall below 50% of nominal at end of rated duration',
      'Only 50% of the luminaires need be tested in any one annual test visit',
  ...
  },
  {
    ...
    question: 'What is the role of the control circuit in self-contained luminaires?',
    options: [
      'Detecting the daylight levels and dimming the lamp output accordingly',
      'Boosting the lamp output during normal mains supply operation',
      'Voltage monitoring and automatic switching to battery on failure',
      'Logging the luminaire run time for the annual maintenance records',
    ],
    correctAnswer: 2,
    explanation: 'Control circuits monitor mains voltage and switch to battery on failure.',
    section: 'Module 3',
  ...
  },
  {
    ...
    options: [
      'It reduces the total length of the cable that is required on site',
      'To prevent a single fault from disabling all emergency lighting',
      'It allows a smaller battery capacity to be specified overall',
      'It removes the need for any fire-resistant cable on site',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'To test the lamp brightness alone',
      'To check battery capacity and autonomy',
      'To check the wiring integrity of the circuit',
      'To test the control circuits and changeover',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'To provide decorative lighting effects in the space',
      'To control the general lighting levels in the area',
  ...
  },
  {
    ...
    options: [
      'To reduce the installed cost of the final circuit wiring work',
      'To maintain circuit integrity so the lighting works during a fire',
      'To allow the circuit to share a trunking with the mains lighting circuits',
      'To remove the need for the annual full duration discharge test',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'To reduce the total length of the cable that is required on site',
      'To allow a smaller battery capacity to be specified for it',
      'To remove the need for any fire-resistant cable anywhere on the job',
      'To prevent a single fault from disabling all emergency lighting',
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      ...
      'To power the lamp directly instead',
  ...
  },
  {
    ...
    options: [
      'To simulate mains failure and verify changeover to battery',
      'To recharge the battery more quickly after a test',
      'To switch between the maintained and the non-maintained modes',
      'To isolate the lamp for cleaning without any tools',
    ],
    correctAnswer: 0,
    explanation: 'Test switches allow simulation of mains failure to verify operation.',
    section: 'Module 4',
  ...
  },
  {
    ...
    question: 'What is the purpose of a full duration discharge test?',
    options: [
      'To check the wiring integrity',
      'To test the lamp brightness',
  ...
  },
  {
    ...
    question: 'Why is fire resistance important for emergency lighting cables?',
    options: [
      'To reduce the installed cost of the cable containment and its fixings',
      'To allow a lower rated battery pack to be fitted instead of it',
      'To maintain circuit integrity so the lighting works during a fire',
      'To remove the need for the annual discharge test altogether',
    ],
    correctAnswer: 2,
    explanation: 'Fire resistance ensures emergency lighting remains operational during fire.',
    section: 'Module 4',
  ...
  },
  {
    ...
    options: [
      'To prevent a single fault from disabling all emergency lighting',
      'To reduce the overall length of cable that is required',
      'To allow a smaller battery capacity to be specified overall',
      'To remove the need for any fire-resistant cable on site',
    ],
    correctAnswer: 0,
    explanation: 'Segregation prevents a single fault from disabling all emergency lighting.',
    section: 'Module 4',
  ...
  },
  {
    ...
    options: [
      'To test the lamp brightness alone',
      'To check the wiring integrity of the circuits',
      'To test the control circuits and changeover',
      'To check battery capacity and autonomy',
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: [
      'To replace the batteries before the system is handed over to the client',
      'To train the occupants in the use of the fire extinguishers on site',
      'To register the system with the local fire and rescue authority first',
  ...
  },
  {
    ...
    options: [
      'To fully discharge the battery to confirm the rated duration',
      'To measure the illuminance against BS EN 1838 levels',
      'To replace the battery and the lamp preventively',
  ...
  },
  {
    ...
    options: [
      ...
      'To check the wiring integrity of the circuits',
      'To test the lamp brightness and output',
    ],
    correctAnswer: 1,
    explanation: 'Full duration tests verify battery capacity and autonomy.',
    section: 'Module 5',
  ...
  },
  {
    ...
    options: [
      'To replace the need for routine functional testing entirely',
      'To provide evidence of compliance and maintenance history',
      'To record the illuminance measured at each of the luminaires',
      'To register the system with the local fire and rescue authority',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Only the original commissioning certificate for the system',
      'Just the manufacturer\'s datasheet for each luminaire',
      'Test results, faults, repairs, replacements, and inspections',
      'The names of all the occupants trained in the evacuation drills',
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      'To verify correct installation and operation against the design',
      'To train the occupants in the evacuation procedures for the site',
      'To replace all of the batteries before the handover to the client',
      'To register the system with the local fire and rescue authority first',
    ],
    correctAnswer: 0,
    explanation: 'Commissioning ensures the system meets design and regulatory requirements.',
  ...
  },
  {
    ...
    options: [
      'To verify changeover and operation under simulated failure',
      'To fully discharge the battery and confirm the rated duration',
      'To measure the illuminance against BS EN 1838 levels',
      'To replace both the battery and the lamp preventively',
    ],
    correctAnswer: 0,
    explanation: 'Functional tests simulate mains failure to verify operation.',
    section: 'Module 5',
  ...
  },
  {
    ...
    question: 'What is the purpose of documentation in emergency lighting maintenance?',
    options: [
      'To satisfy the manufacturer\'s warranty conditions and no more',
      'To set the battery duration required for each of the luminaires',
      'To provide evidence of compliance and maintenance history',
      'To confirm the design illuminance level at the time of handover',
    ],
    correctAnswer: 2,
    explanation: 'Documentation provides evidence of compliance and maintenance history.',
    section: 'Module 5',
  ...
  },
  {
    ...
    options: [
      'Only the original commissioning certificate for the system',
      'Just the manufacturer\'s datasheet for each luminaire',
      'A list of all the occupants trained in the evacuation procedures',
      'Test results, faults, repairs, replacements, and inspections',
    ],
    correctAnswer: 3,
    explanation: 'Comprehensive records are required for compliance.',
  ...
  },
  {
    ...
    options: [
      'The code of practice for the installation and the maintenance',
      'The wiring rules that apply to the emergency lighting circuits',
      'Photometric performance requirements for emergency lighting',
      'The fire-resistance ratings for escape route doors and frames',
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      'A British Standard that sets out the photometric performance levels',
      'A code of practice for installing emergency luminaires on site',
      'A product standard for self-contained emergency luminaires',
  ...
  },
  {
    ...
    options: [
      'To design the emergency lighting layout for the whole building',
      'To carry out the monthly functional tests of the system',
      'To evaluate fire safety measures including emergency lighting',
      'To train the staff in the use of the fire extinguishers on site',
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      'Only the original commissioning certificate issued for the whole system',
      'Just the manufacturer\'s datasheet for each of the luminaires installed',
      'The names of all of the staff who are trained in evacuation procedures',
  ...
  },
  {
    ...
    options: [
      ...
      'To record the date on which the next functional test is due',
      'To register the installation with the local fire and rescue authority',
      'To list the occupants trained in the evacuation procedures',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      'To design the emergency lighting',
      'To enforce fire safety regulations',
      'To install the emergency luminaires',
      'To maintain the emergency luminaires',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'To set out the photometric illuminance and uniformity levels required on site',
      'To define the wiring rules that apply to the emergency lighting circuits',
      'To specify the fire-resistance ratings of the escape route doors and frames',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      'It sets out the photometric illuminance levels that are required',
      'It covers the electrical installation and wiring requirements',
      'It defines the testing and maintenance regime for the system',
      'It specifies the exit sign pictogram that must be used',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'Emergency lighting design rules',
  ...
  },
  {
    ...
    options: [
      'It sets out the photometric levels required for emergency lighting',
      'It defines the testing intervals required for emergency lighting',
      'It specifies the wiring rules for the emergency lighting circuits',
  ...
  },
  {
    ...
    options: [
      ...
      'To set out the photometric levels that are required for emergency lighting',
      'To define the testing intervals for the emergency lighting system',
      'To specify the exit sign pictogram that must be used throughout',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'To verify correct installation and operation against the design',
      'To replace all of the batteries before the handover to the client',
      'To hand the maintenance logbook over to the occupier of the premises',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'To fully discharge the battery and confirm the rated duration',
      'To verify changeover and operation under simulated failure',
      'To measure illuminance against the BS EN 1838 levels',
      'To replace both the battery and the lamp preventively',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    question: 'What is the purpose of functional testing?',
    options: [
      'To run the full rated duration discharge to prove the capacity',
      'To measure illuminance against the BS EN 1838 levels',
  ...
  },
  {
    ...
    options: [
      'It draws no current at all from the mains while the film is running',
      ...
      'It doubles as the general room lighting used by the cleaning staff',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'That the battery still holds its full rated duration in use',
      'That the illuminance on the floor still meets the design level',
      'That the charging circuit draws the correct mains current at all',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Across the full width, less a border of 0.5 m on each side of the route',
  ...
  },
  {
    ...
    options: [
      ...
      '15 lux, since that fixed value always governs the task areas',
      '4 lux, being 1 per cent of the normal maintained value',
      '1 lux, the same figure as is used for all the escape routes',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Where the building has a sprinkler system fitted throughout all of it',
      'Where the building is single storey and has two or more final exits',
      'Where the luminaires are all of the maintained type in every area',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'It sets the cable sizes and the protective devices that are used',
  ...
  },
  {
    ...
    options: [
      'So that the stair can be used as a high risk task area too',
      'So that the stair luminaire can be fed from a local final circuit',
      'So that each tread receives direct light and shadow is avoided',
      'So that the handrail itself is illuminated to at least 15 lux too',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Each socket outlet used by the cleaning staff along the escape route',
      'Each fire alarm call point and each piece of firefighting equipment',
      'Each window that overlooks the external areas of the building outside',
      'Each luminaire forming part of the normal lighting installation there',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'One that runs for longer than three hours on its own internal battery',
  ...
  },
  {
    ...
    options: [
      'The final circuits no longer need any fire resisting cable at all now',
      'No monthly function testing of the whole installation is then required',
  ...
  },
  {
    ...
    options: [
      ...
      'The two sources to be permanently paralleled through one common busbar chamber',
      'The generator to be connected by means of a plug and socket arrangement alone',
      'The changeover contactor to be fitted with an RCD on each and every one of its poles',
    ],
    correctAnswer: 0,
    explanation:
