...
export const dataCablingModule1Section3Quiz: QuizQuestion[] = [
  {
    ...
    correct: 2,
    explanation:
      'Passive components like cables, connectors, and patch panels do not require electrical power and simply provide physical pathways for signals to travel through the network.',
  },
  {
    id: 2,
    ...
    correct: 1,
    explanation:
      'Active components like switches and routers provide network intelligence, including traffic management, routing decisions, security features, and remote monitoring capabilities.',
  },
  {
    id: 3,
    ...
    correct: 2,
    explanation:
      'Passive infrastructure like cabling typically lasts 15-25 years with minimal maintenance, whilst active equipment needs replacement every 3-7 years due to technology advancement and component wear.',
  },
  {
    id: 4,
    ...
    correct: 1,
    explanation:
      'Harsh environments with dust, temperature extremes, and potential electrical interference favour passive components because they are more reliable and require no power or active cooling.',
  },
  {
    id: 5,
    ...
    correct: 2,
    explanation:
      'Modern networks typically use a hybrid approach: passive infrastructure provides the reliable foundation, whilst active components are strategically placed where network intelligence and management are needed.',
  },
];
...
export const dataCablingModule1Section4Quiz: QuizQuestion[] = [
  {
    ...
    correct: 1,
    explanation:
      'Bandwidth represents the maximum theoretical capacity of a network connection, whilst throughput is the actual amount of data successfully transmitted, which is often lower due to various factors.',
  },
  {
    id: 2,
    question: 'Which Ethernet standard supports 10 Gbps over copper cable?',
    options: ['1000BASE-T', '100BASE-TX', '10GBASE-T', '40GBASE-T'],
    correct: 2,
    explanation:
      '10GBASE-T is the Ethernet standard that supports 10 Gbps transmission over copper cables, typically requiring Cat 6A or higher category cabling.',
  },
  {
    id: 3,
    question:
      'When planning for future network capacity, what growth rate should you typically consider?',
    options: [
    ...
    correct: 2,
    explanation:
      'Network bandwidth requirements historically double every 2-3 years. Planning for 10x growth over 5 years provides adequate headroom for most business scenarios and emerging technologies.',
  },
  {
    id: 4,
    ...
    correct: 2,
    explanation:
      '4K video streaming requires 25-100 Mbps per stream, making it one of the highest bandwidth applications in typical business environments, far exceeding email, VoIP, or basic file sharing needs.',
  },
  {
    id: 5,
    ...
    correct: 1,
    explanation:
      'Installing higher-grade cabling (like Cat 6A instead of Cat 6) is crucial for future-proofing because the passive infrastructure typically lasts 15-25 years and supports multiple generations of active equipment upgrades.',
  },
];
