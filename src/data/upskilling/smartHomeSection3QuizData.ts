...
export const smartHomeSection3QuizQuestions: QuizQuestion[] = [
  {
    ...
    correct: 1,
    explanation:
      'Sensors are input devices that detect changes in the environment (like motion, temperature, light) and send signals to controllers.',
  },
  {
    id: 2,
    ...
    correct: 2,
    explanation:
      'Environmental sensors include smoke detectors, CO₂ sensors, and flood detection sensors that monitor safety conditions.',
  },
  {
    id: 3,
    ...
    correct: 2,
    explanation:
      'Actuators are output devices that carry out physical actions when instructed by controllers, such as switching lights or locking doors.',
  },
  {
    id: 4,
    ...
    correct: 1,
    explanation:
      'Motors (for dampers and fans) and valves (for water and gas flow) are key actuators used in HVAC control systems.',
  },
  {
    id: 5,
    ...
    correct: 2,
    explanation:
      'Controllers are decision-makers that process sensor data and determine what actions actuators should perform based on programmed rules.',
  },
  {
    id: 6,
    ...
    correct: 1,
    explanation:
      'False. A smart lock is an actuator (output device) that performs the physical action of locking/unlocking when instructed by a controller.',
  },
  {
    id: 7,
    ...
    correct: 1,
    explanation:
      'The flow is: Sensor detects change → Controller interprets signal → Actuator performs action → Feedback loop provides status.',
  },
  {
    id: 8,
    ...
    correct: 1,
    explanation:
      'Compatibility issues arise when different brands use different protocols (Zigbee, Z-Wave, Wi-Fi) that may not work together seamlessly.',
  },
  {
    id: 9,
    ...
    correct: 2,
    explanation:
      'AI-driven controllers could predict user behaviour patterns and automatically optimise energy usage without manual programming.',
  },
  {
    id: 10,
    ...
    correct: 1,
    explanation:
      'In security applications, actuators like smart locks must work instantly and reliably to ensure safety and security are not compromised.',
  },
];
