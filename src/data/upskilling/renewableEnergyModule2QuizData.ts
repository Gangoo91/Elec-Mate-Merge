...
export const section1Questions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['Monocrystalline', 'Polycrystalline', 'Thin-film', 'PERC panels'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Higher efficiency', 'Better aesthetics', 'Lower cost per watt', 'Longer warranty'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Voltage rating', 'Temperature coefficient', 'Panel thickness', 'Frame material'],
    correctAnswer: 1,
    explanation:
...
export const section3Questions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['Voltage', 'Current', 'Power factor', 'Frequency'],
    correctAnswer: 1,
    explanation:
...
export const section5Questions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['The combiner box', 'The DC isolator', 'The inverter', 'The generation meter'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['IEC 60364', 'BS 7909', 'ISO 9001', 'EN 50110'],
    correctAnswer: 0,
    explanation:
...
export const section4Questions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['Steel', 'Aluminium', 'Plastic composite', 'Stainless steel'],
    correctAnswer: 1,
    explanation:
...
export const section2Questions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['Solar pathfinder', 'Digital multimeter', 'Oscilloscope', 'Power meter'],
    correctAnswer: 0,
    explanation:
