...
export const instrumentationMockExamQuestions: StandardMockQuestion[] = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A reading slightly below 4mA typically indicates high loop resistance, loose connections, or partial short circuit.',
    section: 'Module 8',
    difficulty: 'intermediate',
    topic: 'Signal Faults',
    category: 'Fault Finding',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Zero suppression shifts the measurement range so that the 4mA output represents a value above the actual lower range limit.',
    section: 'Module 6',
    difficulty: 'advanced',
    topic: 'Transmitter Configuration',
    category: 'Calibration & Testing',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Turndown ratio is the ratio of maximum to minimum flow rates that can be accurately measured (e.g., 10:1 turndown).',
    section: 'Module 2',
    difficulty: 'intermediate',
    topic: 'Flow Measurement',
    category: 'Sensors & Transmitters',
  ...
  },
  {
    ...
    options: ['Highest accuracy', 'Lowest cost', 'Non-contact measurement', 'Fastest response'],
    correctAnswer: 2,
    explanation:
  ...
  // Additional 50 questions for expanded coverage (76-125)
  {
    ...
    correctAnswer: 2,
    explanation:
      "Pneumatic transmitters are inherently intrinsically safe as they don't use electrical energy that could cause ignition in explosive atmospheres.",
    section: 'Module 5',
    difficulty: 'intermediate',
    topic: 'Hazardous Areas',
    category: 'Wiring & Installation',
  ...
  },
  {
    ...
    options: ['Thermocouple', 'Accelerometer', 'RTD', 'Pressure transmitter'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0-15 psi', '3-15 psi', '0-20 psi', '5-25 psi'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['RS-232', 'Profinet/EtherNet/IP', '4-20mA', 'HART'],
    correctAnswer: 1,
    explanation:
