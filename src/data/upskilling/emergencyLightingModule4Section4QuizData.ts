export const circuitSegregationQuizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Emergency lighting circuits must be segregated to prevent faults in normal circuits from affecting emergency operation, ensure circuit integrity during fire conditions, and maintain clear identification for safe maintenance. This segregation is fundamental to life-safety system reliability.',
  },
  {
    id: 2,
    question:
  ...
  },
  {
    id: 3,
    question:
      'Which BS 7671 regulation specifically requires escape route circuits to be protected against premature collapse and prohibits plastic-only cable fixings?',
    options: [
      'Regulation 314.1',
      'Regulation 433.1.1',
    ...
    correctAnswer: 2,
    explanation:
      'Regulation 521.10.202 requires escape route circuits to be protected against premature collapse during fire conditions. This includes using non-combustible fixings (metal clips or saddles), enhanced fire-resistant cables, and adequate mechanical protection throughout the installation.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Dedicated containment (separate conduits, trunking, or trays exclusively for emergency circuits) is the preferred and most effective segregation method. This provides complete physical separation, prevents any cross-connection, and ensures maximum protection against fire spread from other circuits.',
  },
  {
    id: 5,
    question:
      'Why is it important to label emergency lighting circuits clearly throughout the installation?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "Clear labelling (every 3 metres and at all access points) ensures safe testing and fault-finding, prevents unauthorised connections to emergency circuits, allows quick identification during maintenance, and confirms segregation is maintained throughout the installation's operational life.",
  },
  {
    id: 6,
    question:
      'What are the primary benefits of using LSZH (Low Smoke Zero Halogen) cables in emergency lighting installations?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'LSZH cables reduce smoke production by up to 80% compared to PVC and eliminate toxic halogen gases (chlorine, fluorine). This improves visibility during evacuation, reduces respiratory hazards, and complies with building regulations for public and high-occupancy buildings.',
  },
  {
    id: 7,
    question:
      'Where should emergency lighting circuits ideally NOT be routed, even with enhanced protection?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Emergency lighting circuits should avoid high-risk areas such as commercial kitchens, boiler and plant rooms, chemical storage areas, and locations with high-temperature processes or flammable materials. Where unavoidable, enhanced protection (MICC cable, steel conduit, fire-rated enclosures) is essential.',
  },
  {
    id: 8,
    question:
      'What is the main risk of using plastic trunking alone for emergency lighting circuits?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Plastic trunking will melt and collapse under fire conditions, destroying the emergency lighting circuits it contains. This violates BS 7671 Regulation 521.10.202 and BS 5266-1 requirements for circuit integrity. Only metal containment (steel conduit, trunking, or trays) is acceptable for emergency circuits.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Dedicated distribution boards (or clearly marked dedicated sections) ensure complete segregation, provide independent overcurrent and earth fault protection, allow clear identification for maintenance, and prevent any accidental cross-connection with normal power circuits. This is best practice for larger and high-risk installations.',
  },
  {
    id: 10,
    question:
      'In the London office refurbishment case study, what was the main compliance problem that caused the installation to fail inspection?',
    options: [
