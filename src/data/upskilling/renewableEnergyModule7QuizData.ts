...
export const section1Questions = [
  {
    ...
    correct: 1,
    explanation:
      'DC systems must be proven dead and at 50V or below before work commences. Visual confirmation alone is insufficient - electrical testing is required.',
  },
  {
    id: 2,
    ...
    correct: 1,
    explanation:
      'UV-rated cables with proper strain relief, adequate bend radius, and drip loops prevent water ingress and mechanical stress damage.',
  },
  {
    id: 3,
    ...
    correct: 1,
    explanation:
      'Earth bonding provides a low-impedance path for fault currents, ensuring protective devices operate quickly to maintain safety.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correct: 2,
    explanation:
      'DC positive and negative conductors of the same circuit should be run together to minimise magnetic fields and ensure proper circuit operation.',
  },
];
...
export const section2Questions = [
  {
    ...
    correct: 1,
    explanation:
      'BS 7671 requires a minimum insulation resistance of 1 MΩ for PV installations when tested at 500V DC.',
  },
  {
    id: 7,
    ...
    correct: 1,
    explanation:
      'Safety systems including shutdown and isolation procedures must be verified first before any other testing to ensure safe operation.',
  },
  {
    id: 8,
    ...
    correct: 0,
    explanation:
      'A healthy string should measure close to the sum of individual panel Voc values under testing conditions, indicating all connections are secure.',
  },
  {
    id: 9,
    ...
    correct: 1,
    explanation:
      'Incorrect DC polarity can cause serious equipment damage, fire risk, and safety hazards, making verification essential.',
  },
  {
    id: 10,
    ...
    correct: 2,
    explanation:
      'BS 7671 requires an Electrical Installation Certificate along with a detailed commissioning report documenting all tests and measurements.',
  },
];
...
export const section3Questions = [
  {
    ...
    options: ['Weekly', 'Monthly', 'Annually', 'Only when faults occur'],
    correct: 1,
    explanation:
      'Monthly visual inspections help identify issues early before they affect performance or create safety hazards.',
  },
  {
    id: 12,
    ...
    correct: 2,
    explanation:
      'Annual insulation resistance testing is essential to verify the electrical integrity of the system and detect deterioration.',
  },
  {
    id: 13,
    ...
    correct: 1,
    explanation:
      'Manufacturer notifications about security patches, bug fixes, or performance improvements indicate when firmware updates are needed.',
  },
  {
    id: 14,
    question: 'What is the target performance ratio (PR) for a well-maintained PV system?',
    options: ['Greater than 50%', 'Greater than 65%', 'Greater than 80%', 'Greater than 95%'],
    correct: 2,
    explanation:
      'A well-maintained PV system should achieve a performance ratio greater than 80%, indicating good system health and minimal losses.',
  },
  {
    id: 15,
    ...
    correct: 1,
    explanation:
      'Thermal imaging identifies hotspots, failing diodes, and poor connections that may not be visible during normal inspections.',
  },
];
...
export const section4Questions = [
  {
    ...
    correct: 1,
    explanation:
      'Always start with monitoring data and error codes to understand the fault symptoms before physical investigation.',
  },
  {
    id: 17,
    ...
    correct: 1,
    explanation:
      'Normal voltage with zero current typically indicates an open circuit fault, such as a broken connector or cable.',
  },
  {
    id: 18,
    ...
    correct: 1,
    explanation:
      'Ground fault detection indicates insulation breakdown, allowing DC current to flow to earth, creating a safety hazard.',
  },
  {
    id: 19,
    ...
    correct: 1,
    explanation:
      'Battery systems store significant energy and require specific isolation procedures and PPE to work safely on fault conditions.',
  },
  {
    id: 20,
    ...
    correct: 1,
    explanation:
      'Communication faults present as loss of monitoring data, inability to access inverter remotely, and missing performance data.',
  },
];
...
export const section5Questions = [
  {
    ...
    correct: 1,
    explanation:
      'PV systems require meters rated for high DC voltages with appropriate safety categories (CAT III or IV) for the measurement environment.',
  },
  {
    id: 22,
    ...
    correct: 1,
    explanation:
      'Irradiance measurements allow correlation of electrical performance with solar conditions, enabling accurate assessment of system health.',
  },
  {
    id: 23,
    ...
    correct: 1,
    explanation:
      'I-V curve testing reveals panel health, degradation levels, shading effects, and various fault conditions affecting performance.',
  },
  {
    id: 24,
    ...
    correct: 1,
    explanation:
      'PV analysers provide detailed performance analysis, I-V curves, and advanced fault diagnosis capabilities beyond basic multimeter measurements.',
  },
  {
    id: 25,
    ...
    correct: 1,
    explanation:
      'PV systems remain live during daylight hours, requiring appropriate PPE, safe working procedures, and equipment rated for the voltage levels present.',
  },
];
...
export const section6Questions = [
  {
    ...
    correct: 1,
    explanation:
      'DC current can sustain arcs more easily than AC, requiring different isolation techniques and specifically rated DC switching devices.',
  },
  {
    id: 27,
    ...
    correct: 1,
    explanation:
      'Live working is only acceptable for essential testing and fault-finding activities using appropriate safety procedures, PPE, and qualified personnel.',
  },
  {
    id: 28,
    ...
    correct: 1,
    explanation:
      'Working near energised PV systems requires arc-rated clothing, insulated gloves rated for the voltage, safety glasses, and other appropriate PPE.',
  },
  {
    id: 29,
    ...
    correct: 1,
    explanation:
      'Emergency shutdown must be simple, clearly marked, and accessible to emergency services to ensure rapid system isolation during emergencies.',
  },
  {
    id: 30,
