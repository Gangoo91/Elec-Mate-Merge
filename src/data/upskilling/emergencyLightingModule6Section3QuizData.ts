...
export const riskAssessmentQuizQuestions: RiskAssessmentQuizQuestion[] = [
  {
    ...
    correct: 1,
    explanation:
      'The fire risk assessment identifies specific hazards and occupant characteristics that determine where emergency lighting is needed, how long it must operate, and what illuminance levels are required for safe evacuation.',
  },
  {
    id: 2,
    ...
    correct: 2,
    explanation:
      'Interior decoration colours are not relevant to fire risk assessment. The assessor must focus on safety-critical factors: occupant characteristics, building use, layout complexity, and environmental hazards.',
  },
  {
    id: 3,
    question:
      'What standard defines how fire risk findings are applied to emergency lighting design?',
    options: ['BS 7671', 'BS 5266-1', 'BS 5839', 'BS 6423'],
    correct: 1,
    explanation:
      'BS 5266-1 is the Code of Practice for emergency lighting that translates fire risk assessment findings into specific technical requirements for illuminance, duration, and coverage.',
  },
  {
    id: 4,
    ...
    correct: 0,
    explanation:
      'BS 5266-1 specifies 0.5 lux for open areas (anti-panic lighting), 1 lux for escape routes, and 15 lux for high-risk task areas.',
  },
  {
    id: 5,
    question: 'What duration is typically required for high-risk premises such as hospitals?',
    options: ['30 minutes', '1 hour', '2 hours', '3 hours minimum'],
    correct: 3,
    explanation:
      'High-risk premises such as hospitals, care homes, and theatres require a minimum 3-hour duration to account for evacuation complexity, vulnerable occupants, and potential delays.',
  },
  {
    id: 6,
    ...
    correct: 2,
    explanation:
      'Risk assessments must be reviewed at least annually, and whenever there are changes to building use, layout, occupancy, or after incidents. Waiting 5 years or only after a fire is non-compliant.',
  },
  {
    id: 7,
    ...
    correct: 1,
    explanation:
      'Early engagement with the fire risk assessor ensures the emergency lighting design aligns with the identified risks, occupant needs, and building characteristics, preventing costly redesigns and compliance failures.',
  },
  {
    id: 8,
  ...
  },
  {
    ...
    correct: 1,
    explanation:
      'Ignoring risk assessment findings breaches the Regulatory Reform (Fire Safety) Order 2005, which can result in improvement notices, prohibition notices, fines, or prosecution. In serious cases, it can lead to imprisonment.',
  },
  {
    id: 10,
    ...
    correct: 1,
    explanation:
      "The Derby warehouse ignored the fire risk assessment's high-risk classification and installed a cheaper 1-hour system instead of the required 3-hour system with enhanced cabling. This led to forced redesign at double the original cost.",
  },
];
