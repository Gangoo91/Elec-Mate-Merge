...
export const emergencyLightingModule6Section2QuizData: QuizQuestion[] = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The Regulatory Reform (Fire Safety) Order 2005 (RRO) is the primary legislation governing fire safety, including emergency lighting, in England and Wales. It places legal duties on the Responsible Person to ensure adequate emergency lighting for safe evacuation. Similar legislation applies in Scotland (Fire Scotland Act 2005) and Northern Ireland (Fire Safety Regulations NI 2010).',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "The fire risk assessment (FRA), required under Article 9 of the RRO, determines specific emergency lighting requirements. The FRA evaluates building type, occupancy, evacuation complexity, vulnerable persons, and fire hazards to establish what provision is 'suitable and sufficient.' Emergency lighting design must align with FRA findings. BS 5266-1 and EN 1838 then define how to achieve the required provision technically.",
  },
  {
    id: 6,
    question:
    ...
    correctAnswer: 2,
    explanation:
      'Fire and Rescue Authorities (FRAs) — typically local Fire and Rescue Services — enforce the RRO in England and Wales. Fire Safety Officers have powers to enter premises, inspect fire precautions, request documentation, issue Enforcement Notices and Prohibition Notices, and prosecute non-compliance. Similar arrangements exist in Scotland and Northern Ireland under their respective legislation.',
  },
  {
    id: 7,
