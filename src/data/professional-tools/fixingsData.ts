...
export const boltTypes: BoltType[] = [
  ...
  },
  {
    ...
    description: 'Fully threaded rod cut to length. Used with nuts and washers at each end.',
    whenToUse:
  ...
  },
  {
    ...
    whenToUse: 'Clamping conduit or pipes to cable tray, securing cable bundles to unistrut.',
...
export const conduitSizes: ConduitSize[] = [
  ...
  },
  {
    ...
    commonAccessories:
      'Saddles, bends (90/135), tees, couplers, through boxes, terminal boxes, reducers',
    standard: 'BS 4568 / BS EN 61386',
  },
  {
    size: '32mm',
    ...
    methods: [
      {
        ...
        maxLoad: '5-80kg',
        description:
          'Standard expansion plug — drill, insert plug, drive screw. The most common fixing in electrical work.',
      ...
      },
      {
        ...
        maxLoad: '200kg+',
        description:
          'Two-part resin injected into a drilled hole with a threaded stud. Bonds chemically to the masonry.',
      ...
      },
      {
        ...
        maxLoad: '25kg',
        description:
          'Spring-loaded wings that open behind hollow blocks. For when standard plugs spin in the cavity.',
      ...
      },
      {
        ...
        maxLoad: '30-50kg',
        description:
          'One-piece plug and screw driven through the item being fixed and into the wall. Very fast to install.',
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        maxLoad: '15kg',
        description:
          'Metal sleeve that expands behind plasterboard when tightened, creating a solid anchor point.',
      ...
      },
      {
        ...
        description:
          'Innovative UK design — wings rotate behind the board and distribute load over 8x the area of a toggle.',
      ...
      },
      {
        ...
        maxLoad: 'Structural',
        description:
          'Find the timber noggin behind the plasterboard using a stud finder or magnet, and screw directly into it.',
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        maxLoad: '100kg+',
        description:
          'Flush-mounted female thread set into concrete. A setting tool expands the anchor in the hole.',
      ...
      },
      {
        ...
        maxLoad: '200kg+',
        description:
          'Heavy-duty expansion bolt that grips concrete by expanding a cone against a sleeve when tightened.',
      ...
      },
      {
        ...
        maxLoad: '500kg+',
        description:
          'Highest strength available. Resin bonded threaded studs for maximum pull-out resistance.',
    ...
    methods: [
      {
        ...
        maxLoad: '20-50kg',
        description:
          'Hardened screws with a drill-point tip that drill, tap and fasten in one operation through steel.',
      ...
      },
      {
        ...
        maxLoad: '10-20kg',
        description:
          'Permanent fastener installed from one side using a rivet gun. Creates a clean, flush fixing.',
      ...
      },
      {
        ...
        maxLoad: '50-100kg',
        description:
          'Threaded insert installed into a drilled hole from one side. Creates a permanent captive nut.',
      ...
      },
      {
        ...
        maxLoad: 'Structural',
        description:
          'Traditional bolt-through with nut and washer. Requires drilling through the steelwork.',
      ...
      },
      {
        ...
        maxLoad: '100kg+',
        description:
          'Clamp-on fixings that grip steel beams without drilling. Available in various sizes for different flange widths.',
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        maxLoad: '50-100kg',
        description:
          'Large hex-headed woodscrews (M8-M12) for heavy-duty timber fixings. Driven with a socket or spanner.',
      ...
      },
      {
        ...
        maxLoad: '10-20kg',
        description:
          'Stainless steel or coated screws designed for outdoor use. Resist corrosion from moisture and treated timber.',
...
export const screwHeadTypes: ScrewHeadType[] = [
  {
    ...
    commonUses:
      'Older installations, brass screws, electrical accessories (BS 1363 socket faceplates). VDE insulated screwdriver required for electrical work.',
  },
  {
    name: 'Phillips (#)',
    driverSizes: '#0, #1, #2, #3',
    identificationTip:
      'Simple cross shape with slightly rounded corners. Designed to cam out (slip) at a set torque to prevent over-tightening.',
    commonUses:
      'Machine screws, some consumer unit covers, imported equipment. Less common in UK electrical work.',
  },
  {
    name: 'Pozidriv (PZ)',
    driverSizes: 'PZ0, PZ1, PZ2, PZ3',
    identificationTip:
      'Cross shape WITH extra marks (tick lines) between the cross arms at 45 degrees. This is the key difference from Phillips.',
    commonUses:
      'The dominant screw type in UK electrical accessories — sockets, switches, back boxes, isolators. PZ2 is used most.',
  },
  {
    name: 'Torx (T / TX)',
    driverSizes: 'T10, T15, T20, T25, T30, T40',
    identificationTip:
      'Six-pointed star shape. Much better torque transfer and virtually no cam-out.',
    commonUses:
      'Modern switch plates, MCBs, some consumer unit bus bar screws. Becoming more common in new electrical products.',
  },
  {
    name: 'Hex (Allen)',
    ...
    commonUses:
      'Grub screws, set screws in cable glands, busbar connections, terminal blocks in industrial equipment.',
  },
  {
    name: 'Robertson (Square)',
    driverSizes: '#1 (yellow), #2 (red), #3 (black)',
    identificationTip:
      'Square recess in the head. Excellent grip — the screw stays on the driver without holding it.',
    commonUses:
      'Less common in UK. Found on some North American equipment and decking screws. Very popular in Canada.',
  },
];
...
export const screwCategories: ScrewCategory[] = [
  {
    ...
    description:
      'Hardened screws that cut their own thread into pre-drilled holes in metal or plastic. Thread-forming or thread-cutting types available.',
    whenToUse:
      'Fixing into sheet metal enclosures, plastic junction boxes, thin metal brackets. Pre-drill a pilot hole first.',
    commonSizes: '#6 x 13mm, #8 x 19mm, #10 x 25mm',
  },
  {
    name: 'Self-Drilling (TEK) Screws',
    description:
      'Screws with a drill-point tip that drill, tap and fasten in one operation through steel. The point length determines the maximum steel thickness.',
    whenToUse:
      'Fixing directly to steel — cable tray to brackets, enclosures to steel frames. No pre-drilling needed.',
    commonSizes:
      '#10 x 16mm (TEK 1 for 1mm steel), #12 x 25mm (TEK 3 for 3mm steel), #14 x 38mm (TEK 5 for 5mm steel)',
  },
  {
    name: 'Woodscrews',
    description:
      'Coarse-threaded pointed screws designed to grip timber fibres. Available in countersunk or round head, various materials.',
    whenToUse:
      'Fixing cable clips, back boxes, brackets to timber joists and battens. Countersunk for flush finish.',
    commonSizes: '#6 x 25mm, #8 x 32mm, #8 x 40mm, #10 x 50mm',
  },
  {
    name: 'Machine Screws',
    description:
      'Precision screws with a consistent thread pitch (fine or coarse). Designed for tapped holes or use with a nut.',
    whenToUse:
      'Electrical equipment, consumer unit covers, switch mechanisms, terminal connections. Often found in M3.5 and M4.',
    commonSizes: 'M3.5 x 25mm, M4 x 16mm, M4 x 25mm, M5 x 20mm',
  },
  {
    name: 'Coach Screws',
    description:
      'Large hex-headed screws (M8-M12) driven with a socket or spanner. Very high pull-out resistance in timber.',
    whenToUse:
      'Heavy-duty fixing to timber — DB boards, heavy cable tray brackets, outdoor equipment mounting.',
    commonSizes: 'M8 x 60mm, M10 x 80mm, M10 x 100mm, M12 x 100mm',
  },
  {
    name: 'Chipboard Screws',
    description:
      'Deep-threaded screws with a sharp point. Coarser thread than woodscrews for better grip in chipboard, MDF and softwood.',
    whenToUse:
      'Fixing to chipboard, MDF, OSB, softwood battens. The deep thread gives good grip in manufactured boards.',
    commonSizes: '3.5 x 25mm, 4.0 x 40mm, 4.5 x 50mm, 5.0 x 60mm',
  },
  {
    name: 'Drywall Screws',
    description:
      'Fine-threaded black phosphate screws with a bugle head. Designed for plasterboard to timber or metal stud.',
    whenToUse:
      'Fixing plasterboard (not common in electrical work, but useful to know for identifying noggin positions).',
...
export const vanStockEssentials: VanStockItem[] = [
  ...
  },
  {
    ...
    approxCost: '£3-5',
    notes:
      'Socket and switch faceplates. The screws that come with accessories are often poor quality.',
  },
  {
