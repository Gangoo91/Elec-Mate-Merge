...
export const brandComparison = [
  {
    brand: 'Fluke',
    strengths:
      'Industry gold standard, excellent build quality, advanced features (Bluetooth, cloud sync). Best for fault finding and commercial work.',
  ...
  },
  {
    brand: 'Megger',
    strengths:
      'The original insulation tester manufacturer. Robust, trusted by utilities and commercial contractors. Excellent MFTs.',
  ...
  },
  {
    brand: 'Kewtech',
    strengths:
      'Best value for money. UK designed. All essential features at a lower price point. Popular with domestic electricians.',
  ...
  },
  {
    brand: 'Metrel',
    strengths:
      'Slovenian manufacturer with advanced features. Auto-sequence testing saves significant time on large installations.',
