...
export const ppeItems: PPEItem[] = [
  // ─── Daily Essentials ──────────────────────────────────────────────────
  {
    ...
    replacementFrequency:
      'Every 6-12 months or when sole is worn, toe cap exposed, or waterproofing fails',
    price: '£55-130',
    group: 'daily',
    apprenticeTip:
  ...
  },
  {
    ...
    replacementFrequency:
      'Replace when dirty/faded (reflective tape loses effectiveness) or damaged',
    price: '£5-25',
    group: 'daily',
    apprenticeTip:
  ...
  },
  {
    ...
    replacementFrequency:
      'Replace every 3-5 years (UV degrades the plastic), immediately after an impact, or if cracked',
    price: '£5-20',
    group: 'daily',
    apprenticeTip:
  ...
  // ─── Task-Specific PPE ─────────────────────────────────────────────────
  {
    ...
    replacementFrequency:
      'Inspect before every use. Replace every 6 months or if any signs of damage, cracks, or discolouration',
    price: '£45-90',
    group: 'task-specific',
    apprenticeTip:
  ...
  },
  {
    ...
    replacementFrequency:
      'Muffs: replace cushions every 6 months. Plugs: disposable or clean reusable daily',
    price: '£5-30',
    group: 'task-specific',
    apprenticeTip:
  ...
  },
  {
    ...
    replacementFrequency:
      'Disposable: replace after each use or when breathing becomes restricted. Reusable: replace filters as per manufacturer',
  ...
  },
  {
    ...
    replacementFrequency:
      'Inspect before every use. Replace after a fall arrest event. Maximum service life: 5-10 years per manufacturer',
    price: '£50-150',
    group: 'task-specific',
    apprenticeTip:
