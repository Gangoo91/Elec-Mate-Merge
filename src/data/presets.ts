...
export const getAppliancesForEnvironment = (
  environment: string
): Record<string, AppliancePreset> => {
...
export const getCategoriesForEnvironment = (
  environment: string
...
export const getAppliancesForCategory = (
  environment: string,
  categoryKey: string
): Record<string, AppliancePreset> => {
  const env = environmentPresets[environment];
