...
export const enhancedRiskDatabase: EnhancedRiskConsequence[] = [
  // ⚡ Critical Electrical Hazards
  {
    ...
    controlMeasures: {
      elimination: [
        'Design out live work through pre-planning',
    ...
    costOfFailure:
      'Fatal injury: £1.5-3M+ fine, imprisonment, business closure. Serious injury: £500k+, HSE investigation, reputation damage, loss of contracts.',
    hseGuidanceRef: [
  ...
  },
  {
    ...
    bs7671References: [
      ...
      '701.415.2 - Supplementary bonding',
    ...
    costOfFailure:
      'Serious injury risk: £100k+ fine. Death: £1M+ fine, manslaughter charges. Insurance invalidation on properties without proper earthing.',
  ...
  },
  {
    ...
    costOfFailure:
      'Fatality: £3M+ fine, imprisonment up to 2 years. Cable damage alone: £50k-500k repair + compensation. DNO claims can reach £10M for major outages.',
    hseGuidanceRef: [
      'HSG47 - Avoiding danger from underground services',
      'HSE Guidance on Cable Strikes',
    ],
    lastUpdated: '2025-01-15',
  },
  {
    ...
    costOfFailure:
      'Electrical fire: £50k-5M+ property damage. Fatality from arc flash: £1-3M fine, imprisonment, business closure. Production downtime: £10k-100k per day. Insurance premiums increase 200-500% after electrical fire. HSE prosecution for inadequate maintenance: £500k+ fine.',
    hseGuidanceRef: [
      'HSG85 - Electricity at work: Safe working practices',
  ...
  },
  {
    ...
    costOfFailure:
      'Fatality: £1-3M fine, imprisonment up to 2 years, business closure. Serious injury: £500k-1M fine, lifelong disability compensation £2-5M, HSE prosecution, reputational damage.',
    hseGuidanceRef: [
      'Work at Height Regulations 2005',
  ...
  },
  {
    ...
    consequence:
      'Asphyxiation, toxic gas exposure, drowning, entrapment, electric shock, fire/explosion',
    likelihood: 2,
    severity: 5,
    riskRating: 10,
    controlMeasures: {
    ...
    relatedHazards: ['elec-shock-001', 'asbestos-001', 'manual-handling-001', 'heat-stress-001'],
    costOfFailure:
      'Fatality: £1-3M fine, up to 2 years imprisonment, corporate manslaughter charges. Serious injury: £500k+ fine. Prosecutions have 90%+ conviction rate for confined space fatalities. Business closure common.',
    hseGuidanceRef: [
      'Confined Spaces Regulations 1997',
  ...
  },
  {
    ...
    consequence:
      'Mesothelioma (fatal lung cancer), asbestosis, lung cancer, pleural disease - 20-50 year latency',
    likelihood: 4,
    severity: 5,
    riskRating: 20,
    controlMeasures: {
    ...
    costOfFailure:
      'Fatal mesothelioma: £1-3M fine, unlimited compensation (£200k-500k typical), imprisonment up to 2 years, corporate manslaughter charges. HSE prosecutions have 95%+ conviction rate. Lifetime business prohibition for directors. Victim compensation: £200k-500k per person. Investigation costs: £50k-200k.',
    hseGuidanceRef: [
      'Control of Asbestos Regulations 2012',
  ...
  // 🚀 NEW ENHANCED ELECTRICAL HAZARDS FOR COMPREHENSIVE SAFETY
  {
    ...
    controlMeasures: {
      engineering: [
        'Type A RCD protection (30mA)',
        'DC isolation devices',
        'Surge protection devices',
        'Load monitoring systems',
      ],
      administrative: [
        'DNO notification for loads >7kW',
        'Electrical capacity calculations',
        'Installation certification',
        'User training on safe operation',
      ],
  ...
  },
  {
    ...
    controlMeasures: {
      engineering: [
        ...
        'Isolated smart circuits',
        'Proper earthing for data systems',
      ],
      administrative: [
    ...
    bs7671References: [
      'Part 4 - Protection for safety',
      'Section 444 - Protection against electromagnetic disturbances',
    ],
    category: 'electrical',
  ...
  },
  {
    ...
    controlMeasures: {
      ...
      engineering: [
        ...
        'Fire suppression in battery areas',
        'DC isolation at multiple points',
        'Ventilation for battery rooms',
      ],
      administrative: [
        'Manufacturer training',
        'Emergency response procedures',
        'Regular thermal monitoring',
        'G99 grid connection compliance',
      ],
      ppe: [
        'Arc flash protection',
        'Breathing apparatus for battery areas',
  ...
  },
  {
    ...
    consequence:
      'Critical system failure, electric shock from high-density power, business interruption',
    likelihood: 2,
    severity: 5,
    riskRating: 10,
    controlMeasures: {
  ...
  },
  {
    ...
    controlMeasures: {
      engineering: [
        ...
        'LED conversion for safety',
      ],
      administrative: [
        'Highway authority coordination',
      ...
      ppe: [
        ...
        'Fall protection for column work',
      ],
    },
  ...
  },
  {
    ...
    controlMeasures: {
      engineering: [
        'RCD protection on all temporary circuits',
        'Armoured cables',
    ...
    bs7671References: [
      ...
      'Section 411 - Protective measures',
    ],
  ...
  },
  {
    ...
    consequence:
      'Livestock electric shock, fire in agricultural buildings, equipment damage from harsh environments',
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
  ...
  // ⚡ Modern Electrical Systems
  {
    ...
    consequence:
      'Electric shock from refrigerant contactors, incorrect wiring causing efficiency loss, fire risk',
    likelihood: 3,
    severity: 3,
    riskRating: 9,
    controlMeasures: {
      engineering: [
        ...
        'Dedicated circuit with correct cable sizing',
        'Outdoor-rated isolator',
      ],
      administrative: [
  ...
  },
  {
    ...
    consequence:
      'Phase rotation issues causing equipment damage, electric shock from contactors, fire from overload',
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
  ...
  },
  {
    ...
    consequence:
      'Data loss, system conflicts, electric shock from control panels, fire from incorrect wiring',
    likelihood: 2,
    severity: 3,
    riskRating: 6,
    controlMeasures: {
    ...
    bs7671References: [
      '444 - Protection against electromagnetic disturbances',
      '528 - Proximity to other services',
    ],
  ...
  },
  {
    ...
    consequence:
      'False alarms causing evacuation, system failure in emergency, electric shock from panels',
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
  ...
  },
  {
    ...
    bs7671References: [
      '443 - Protection against overvoltage',
      '522 - Selection and erection of wiring systems',
    ],
    category: 'security-systems',
    workType: ['installation', 'maintenance'],
  ...
  },
  {
    ...
    bs7671References: [
      'Part 4 - Protection for safety',
      '331 - Assessment of general characteristics',
    ],
    category: 'industrial',
    workType: ['installation', 'commissioning', 'maintenance'],
    environment: ['industrial', 'commercial'],
  },
  {
    ...
    consequence:
      'Backfeed to utility grid, carbon monoxide poisoning, fire from fuel leaks, electric shock',
    likelihood: 2,
    severity: 5,
    riskRating: 10,
    controlMeasures: {
      ...
      administrative: [
        'G59/3 compliance for grid connection',
        'Building Control notification',
        'Commissioning tests',
        'Load bank testing',
        'Regular maintenance',
  ...
  },
  {
    ...
    controlMeasures: {
      engineering: [
        ...
        'Maintained/non-maintained configuration',
  ...
  },
  {
    ...
    consequence:
      'Grid instability, islanding hazards, reverse power flow, synchronization failures',
    likelihood: 2,
    severity: 4,
    riskRating: 8,
    controlMeasures: {
      ...
      administrative: [
        'G98/G99 applications',
        'DNO approvals',
        'Commissioning procedures',
        'Export limitation agreements',
      ],
  ...
  },
  {
    ...
    controlMeasures: {
      engineering: [
        ...
        'Firewall protection',
        'Quality certified devices only',
        'Surge protection',
      ],
      administrative: [
  ...
  // 🏥 Specialist Environments
  {
    ...
    consequence:
      'Patient electrocution, life-support system failure, cardiac arrest from micro-shock',
    likelihood: 1,
    severity: 5,
    riskRating: 5,
    controlMeasures: {
      engineering: [
        'Medical IT systems (isolated supply)',
      ...
      administrative: [
        ...
        'Medical electrical safety training',
        'Regular testing schedules',
        'Permit to work in clinical areas',
      ],
  ...
  },
  {
    ...
    controlMeasures: {
      engineering: [
        '30mA RCD protection',
        'SELV for underwater lighting (max 12V AC)',
        'Zone protection (0, 1, 2)',
        'Equipotential bonding of all metalwork',
      ],
      administrative: [
        'BS 7671 Section 702 compliance',
        'Annual electrical testing',
        'Water conductivity testing',
        'Lifeguard notification',
      ],
  ...
  },
  {
    ...
    consequence:
      'Electric shock in wet environment, fire from equipment overload, RCD nuisance tripping',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
  ...
  },
  {
    ...
    consequence:
      'Falls from rigging work, electric shock from dimming systems, fire from overheating',
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
      engineering: [
        ...
        'Thermal cutouts',
        'Emergency lighting separate circuits',
        'DMX isolation',
      ],
      administrative: [
        'LOLER inspections',
  ...
  },
  {
    ...
    consequence:
      'Hypothermia, equipment failure causing stock loss, electric shock in freezing conditions',
    likelihood: 3,
    severity: 3,
    riskRating: 9,
    controlMeasures: {
      engineering: [
        'Low-temperature rated cable',
        'Condensation-resistant equipment',
        'Emergency lighting',
        'Alarm systems for door lockout',
      ],
      administrative: [
  ...
  // 🔧 Common Maintenance Hazards
  {
    ...
    costOfFailure:
      'Death or serious injury: £500k-2M fine. Loss of insurance cover for live work without proper training and procedures. Professional qualification revoked.',
    hseGuidanceRef: [
      'GS38 - Electrical test equipment for use on low voltage electrical systems',
      'HSG85 - Electricity at work: Safe working practices',
    ],
  ...
  },
  {
    ...
    consequence:
      'Rushed work causing errors, electric shock from inadequate assessment, fatigue-related accidents',
    likelihood: 4,
    severity: 4,
    riskRating: 16,
    controlMeasures: {
      ...
      administrative: [
        ...
        'Risk assessment even under time pressure',
        'Backup personnel',
  ...
  },
  {
    ...
    consequence:
      'Cutting corners on safety, missed isolation steps, inadequate testing, non-compliance',
    likelihood: 5,
    severity: 3,
    riskRating: 15,
    controlMeasures: {
      ...
      administrative: [
        ...
        'Client education on safety timescales',
      ],
  ...
  },
  {
    ...
    consequence:
      'Public electric shock, disruption to business, damage to customer property, fire risk',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      ...
      administrative: [
        'Customer liaison and notifications',
        'Out-of-hours working where appropriate',
        'Clear communication of isolation periods',
  ...
  },
  {
    ...
    consequence:
      'Unknown cable routes causing damage, asbestos exposure, absence of modern protection, fire from overloading',
    likelihood: 4,
    severity: 4,
    riskRating: 16,
    controlMeasures: {
  ...
  },
  {
    ...
    controlMeasures: {
      ...
      ppe: [
        'High-voltage PPE (tested to 33kV)',
        'Arc flash suit (ATPV rated)',
        'HV gloves and tools',
      ],
    },
  ...
  // 📋 REGULATORY COMPLIANCE HAZARDS (10 new)
  {
    ...
    consequence:
      'HSE prosecution (up to £20k fine), project delays, legal liability, insurance invalidation',
    likelihood: 3,
    severity: 3,
    riskRating: 9,
    controlMeasures: {
      administrative: [
        'F10 notification for projects >30 days or 500 person-days',
        'Principal Designer appointment',
        'Construction phase plan',
        'HSE notification procedures',
        'Client duty compliance',
  ...
  },
  {
    ...
    consequence:
      'Local authority prosecution, insurance void, property sale issues, client legal action',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
  ...
  },
  {
    ...
    consequence:
      'DNO enforcement action, supply disconnection, criminal prosecution, network damage liability',
    likelihood: 2,
    severity: 4,
    riskRating: 8,
    controlMeasures: {
      administrative: [
        'DNO notification for installations >13.8kVA',
        'G98/G99 connection agreements',
        'Earthing and bonding compliance',
        'Supply characteristic verification',
        'Metering position compliance',
      ],
      engineering: [
        'Proper earthing electrode installation (TT systems)',
        'Protective Multiple Earthing (PME) compliance',
        'Supply isolation coordination with DNO',
      ],
    },
    bs7671References: [
  ...
  },
  {
    ...
    consequence:
      'Professional negligence claims, undetected hazards causing injury/fire, loss of registration',
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'BS 7671 Schedule of Inspection compliance',
        'C1/C2/C3 coding accuracy',
        'Limitation clauses where access restricted',
        'Photographic evidence',
        'Report sign-off by qualified supervisor',
    ...
    bs7671References: [
      ...
      'BS 7671:2018+A3:2024 Schedule of Inspection',
    ],
    category: 'regulatory-compliance',
  ...
  },
  {
    ...
    consequence:
      'Fatal electric shock in wet environment, insurance rejection, prosecution, property condemnation',
    likelihood: 3,
    severity: 5,
    riskRating: 15,
    controlMeasures: {
      ...
      engineering: [
        'Supplementary bonding of all metalwork in reach',
        '30mA RCD protection for all circuits',
        'IPX4 minimum equipment (IPX5 for Zone 1, IPX7 for Zone 0)',
        '3m exclusion zone for socket outlets',
      ],
      administrative: [
        'Zone classification drawings',
        'Equipotential bonding testing',
        'Water conductivity considerations',
      ],
    },
    bs7671References: [
      '701 - Locations containing a bath or shower',
      '411.3.3 - Additional protection by RCD',
      '701.415.2 - Supplementary bonding',
    ],
  ...
  },
  {
    ...
    consequence:
      'Electrocution from damaged cables, fire from overload, multiple casualties, HSE prohibition notice',
    likelihood: 4,
    severity: 5,
    riskRating: 20,
    controlMeasures: {
      engineering: [
        'Reduced low voltage system (110V CTE or 55V ph-earth)',
        'RCD protection (30mA max) for all socket outlets',
        'Armoured cable or robust mechanical protection',
        'Segregation from other services',
      ],
      administrative: [
        'Daily visual inspection regime',
        'Competent person supervision',
  ...
  },
  {
    ...
    consequence:
      'Electrocution of holidaymakers, fire in caravans, child safety incidents, liability claims',
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
      engineering: [
        '30mA RCD for each pitch',
        'PME earthing prohibited - TT system mandatory',
        'IP44 minimum equipment rating',
        'Pitch supply points ≥0.5m, ≤1.5m above ground',
      ],
      administrative: [
        'Annual electrical inspection',
        'Caravan connection safety briefings',
        'Emergency isolation procedures',
        'Seasonal commissioning checks',
      ],
      ppe: ['Weather-appropriate PPE', 'Insulated tools'],
    },
    bs7671References: [
      '708 - Electrical installations in caravan/camping parks',
      '411.5 - TT system protection',
      '411.3.3 - RCD requirements',
    ],
    category: 'special-installation',
    workType: ['installation', 'maintenance'],
  ...
  },
  {
    ...
    consequence:
      'Patient death from micro-shock, life-support failure, micro-shock to cardiac patients, regulatory closure',
    likelihood: 2,
    severity: 5,
    riskRating: 10,
    controlMeasures: {
      engineering: [
        'Medical IT systems (isolated supplies) for Group 2 locations',
        'Insulation monitoring devices (IMD)',
        'Supplementary equipotential bonding ≤0.2Ω',
        'Battery backup for critical supplies',
        'Automatic changeover switches',
      ],
      administrative: [
        'HTM 06-01 compliance (England/Wales)',
        'Medical electrical engineer supervision',
        'IEC 60601 medical equipment standards',
        'Commissioning by competent medical electrical specialist',
      ],
  ...
  },
  {
    ...
    consequence:
      'DC arc flash (difficult to extinguish), electrocution during maintenance, fire brigade shock risk',
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
      engineering: [
        'DC isolators at both string and inverter',
        'Overvoltage protection (SPD Type I & II)',
        'String voltage <600V DC',
        'Firefighter emergency shutdown switch',
        'Arc fault detection devices (AFDD)',
      ],
      administrative: [
        'MCS certification requirements',
        'G98/G99 DNO applications',
        'Fire brigade liaison and labelling',
        'Commissioning tests per MCS standards',
      ],
  ...
  },
  {
    ...
    consequence:
      'System failure in fire emergency, false alarm penalties, insurance void, regulatory prosecution',
    likelihood: 3,
    severity: 5,
    riskRating: 15,
    controlMeasures: {
      engineering: [
        'Category L1-L5 or M system design',
        'Automatic fire detection in risk areas',
        'Manual call points at exits',
        'Sounder coverage (≥65dB)',
        'Battery autonomy ≥24h standby + 30min alarm',
      ],
      administrative: [
        'Weekly alarm tests',
        'Quarterly inspection by responsible person',
        'Annual servicing by competent technician',
        'Log book maintenance',
  ...
  },
  {
    ...
    consequence:
      'Evacuation fatalities in fire/power loss, regulatory closure, prosecution under Fire Safety Order',
    likelihood: 3,
    severity: 5,
    riskRating: 15,
    controlMeasures: {
      engineering: [
        '1 lux horizontal illuminance on escape routes',
        '≥3 hour duration',
        'Central battery or self-contained luminaires',
        'Maintained or non-maintained configuration',
        'Escape route and exit signage',
      ],
      administrative: [
        'Daily function indicator check',
        'Monthly function test (brief)',
        'Annual 3-hour duration test',
        'Third-yearly design compliance review',
        'Fire Risk Assessment alignment',
      ],
  ...
  // 🔍 TESTING & INSPECTION HAZARDS (8 new)
  {
    ...
    consequence:
      'Damage to electronic equipment, false pass results, undetected insulation faults causing shock/fire',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Disconnect surge protection devices (SPDs)',
        'Remove lamps and sensitive equipment',
        'Short phase and neutral for combined test',
        'Test at 250V for SELV/PELV, 500V for LV',
        'Minimum acceptable values: 1MΩ (≥1MΩ required)',
      ],
      engineering: [
        'Digital insulation tester calibrated annually',
        'Test lead inspection before use',
      ],
    },
    bs7671References: [
      'Part 6 - Section 612',
  ...
  },
  {
    ...
    consequence:
      'Inadequate fault protection, extended disconnection times, electric shock risk, non-compliance',
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        ...
        'Compare results with BS 7671 maximum Zs tables',
        'Apply 0.8 correction factor (Rule of Thumb)',
        'RCD bypass for non-RCD circuits',
        'Temperature correction (ambient ≠ 70°C conductor)',
      ],
      engineering: [
        'Calibrated multifunction tester',
        'GS38 test leads',
        'RCD loop testers where appropriate',
      ],
    },
    bs7671References: [
      'Part 6 - Section 612',
  ...
  },
  {
    ...
    consequence:
      'RCD fails to operate in shock event, nuisance tripping undetected, false sense of security',
    likelihood: 4,
    severity: 4,
    riskRating: 16,
    controlMeasures: {
  ...
  },
  {
    ...
    consequence:
      "Live switched neutral causing exposed metalwork to remain live, shock from 'off' equipment, fire risk",
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Verify all single-pole devices in phase conductor only',
        'Test at every outlet and accessory',
        'Check centre-contact of ES lampholders are phase',
        'Confirm socket outlet polarity (L-R, N-L, E-top)',
        'Document all polarity test results',
      ],
  ...
  },
  {
    ...
    consequence:
      'Interlocks fail, emergency stops inoperative, incorrect sequencing causing equipment damage/injury',
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Test all control and protective devices',
        'Emergency stop circuits under load',
        'RCD mechanical test button verification',
        'Interlocks and safety circuits',
        'Correct operation of changeover switches',
        'Indicator lamps and audible warnings',
      ],
  ...
  },
  {
    ...
    consequence:
      'False readings causing dangerous situations, non-compliance undetected, professional negligence',
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Annual calibration to ISO 17025 or equivalent',
        'Calibration certificates retained',
        'Pre-use proving unit checks',
        'Test equipment register with calibration due dates',
        'Equipment out of service if calibration expired',
      ],
      engineering: [
        'Purchase test equipment from reputable manufacturers',
        'Proving unit device (voltage indicator verification)',
      ],
    },
    bs7671References: [
  ...
  },
  {
    ...
    consequence:
      'Deterioration undetected, insurance void, HSE improvement notices, fire risk escalation',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        ...
        'Industrial: 3 years',
        'Educational: 5 years',
        'Rented domestic: 5 years (England) / 5 years (Scotland)',
        'Client reminder system',
        'EICR recommendation adherence',
      ],
  ...
  },
  {
    ...
    consequence:
      'Equipment malfunction, motor overheating, LED flicker, non-compliance, client complaints',
    likelihood: 4,
    severity: 2,
    riskRating: 8,
    controlMeasures: {
      administrative: [
        'Measure voltage drop under full load',
        'Lighting circuits: max 3% of supply voltage (6.9V on 230V)',
        'Other circuits: max 5% (11.5V)',
        'Apply mV/A/m values from BS 7671 Appendix 4',
        'Consider diversity and actual load',
      ],
      engineering: [
        'True RMS voltmeter',
        'Clamp meter for load measurement',
        'Cable sizing calculations verified',
      ],
    },
    bs7671References: [
      "525 - Voltage drop in consumers' installations",
      'Appendix 4 - Current-carrying capacity and voltage drop',
      'Table 4Ab - Voltage drop (mV/A/m)',
    ],
    category: 'testing-inspection',
  ...
  // 📐 DESIGN & CALCULATIONS HAZARDS (10 new)
  {
    ...
    consequence:
      'Undersized supply causing overload, volt-drop issues, cable/switchgear damage, fire risk',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Apply BS 7671 Appendix H diversity factors',
        'Consider simultaneous loads realistically',
        'Socket outlets: 100% first 10A, 40% remainder',
        'Lighting: 66% if >10 points',
        'Heating/cooling: 100% (rarely diversified)',
        'Document assumptions',
      ],
      engineering: [
        'Maximum demand assessment',
        'Load monitoring for verification',
  ...
  },
  {
    ...
    controlMeasures: {
      administrative: [
        ...
        'Select protective device In (Ib ≤ In ≤ Iz)',
        'Apply correction factors: grouping (Cg), ambient temperature (Ca), thermal insulation (Ci), BS 3036 fuses (0.725)',
        'Iz ≥ In / (Ca × Cg × Ci)',
        'Use BS 7671 Appendix 4 tables',
      ],
      engineering: ['Thermal imaging to verify installed performance', 'Load monitoring'],
    },
    bs7671References: [
      '523 - Current-carrying capacities',
      'Appendix 4 - Tables 4A-4L',
      'Table 52.3 - Correction factors',
    ],
    category: 'design-calculations',
    workType: ['design', 'installation'],
    environment: ['all-environments'],
  },
  {
    ...
    consequence:
      'Incorrect device trips causing total power loss, safety systems failure, production downtime',
    likelihood: 3,
    severity: 3,
    riskRating: 9,
    controlMeasures: {
      administrative: [
        'Selectivity studies using manufacturer curves',
        'Time-current discrimination ratios',
        'RCD selective (S-type) for upstream devices',
        'Fuse-to-MCB discrimination',
        'Back-up protection verification',
      ],
      engineering: [
        'Use of cascading tables',
        'Short-circuit withstand (Ipf) checks',
        'Energy let-through (I²t) calculations',
      ],
    },
    bs7671References: [
  ...
  },
  {
    ...
    consequence:
      'Inadequate breaking capacity, device explosion, arc flash, fire, conductor damage',
    likelihood: 3,
    severity: 5,
    riskRating: 15,
    controlMeasures: {
      administrative: [
        'Calculate prospective fault current at origin (Ze)',
        'Apply impedance to calculate Ipf at all points',
        'Verify protective device breaking capacity >Ipf',
        'Earth fault current verification',
        'Use manufacturer fault level data',
      ],
      engineering: [
        'Prospective fault current testing at origin',
        'Use of impedance values from DNO',
        'Adiabatic equation verification (t ≤ k²S² / I²)',
      ],
    },
    bs7671References: [
      '434 - Protection against fault current',
      'Appendix 3 - Time/current zones',
      '411.4.4 - Fault protection by automatic disconnection',
    ],
    category: 'design-calculations',
  ...
  },
  {
    ...
    consequence:
      'Conductor damage during fault, cable insulation failure, fire risk, inadequate CPC size',
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Apply formula: t = (k × S / I)²',
        'Where t = disconnection time (s), k = conductor constant (115 for copper, 74 for aluminium), S = conductor CSA (mm²), I = fault current (A)',
        'Verify CPC adequacy',
        'Check protective device operating time from curves',
      ],
      engineering: ['Use manufacturer adiabatic tables', 'Thermal withstand verification'],
    },
    bs7671References: [
      '543.1.3 - Adiabatic equation',
      '434.5.2 - Fault current protection',
      'Table 54.7 - Conductor k values',
    ],
    category: 'design-calculations',
    workType: ['design'],
    environment: ['all-environments'],
  },
  {
    ...
    consequence:
      'Supply inadequacy, DNO reinforcement costs, installation redesign costs, project delays',
    likelihood: 3,
    severity: 3,
    riskRating: 9,
    controlMeasures: {
      administrative: [
        ...
        'Apply diversity per Appendix H',
        'Add allowance for future expansion (typically 20%)',
        'Consider power factor',
        'Verify with DNO supply characteristics',
      ],
      engineering: [
        'Load profiling for complex installations',
        'Monitoring of existing installations',
        'Single-phase balance calculations',
      ],
    },
  ...
  },
  {
    ...
    consequence:
      'Ineffective fault protection, electric shock risk, fire, equipment damage, non-compliance',
    likelihood: 3,
    severity: 5,
    riskRating: 15,
    controlMeasures: {
      engineering: [
        'Verify earthing arrangement type (TN-S, TN-C-S, TT, IT)',
        'Main earthing terminal (MET) correctly sized',
        'Earth electrode resistance <200Ω (TT systems)',
        'Protective conductor continuity',
        'Bonding conductor sizing per BS 7671 Section 544',
      ],
      administrative: [
        'Earth fault loop impedance verification',
        'Bonding of extraneous-conductive-parts',
        'Label all earthing and bonding conductors',
      ],
    },
    bs7671References: [
  ...
  },
  {
    ...
    controlMeasures: {
      administrative: [
        'CPC cross-sectional area ≥1.5mm² for short fault durations',
        'Verify thermal withstand using k²S² ≥ I²t',
        'Compare with protective device characteristics',
        'Document calculations',
      ],
      engineering: ['Adequate CPC sizing from outset', 'Protective device coordination'],
    },
    bs7671References: [
      '543.1 - Cross-sectional areas of protective conductors',
      '543.1.3 - Adiabatic equation for fault conditions',
    ],
    category: 'design-calculations',
    workType: ['design'],
    environment: ['all-environments'],
  },
  {
    ...
    consequence:
      'Nuisance tripping of upstream devices, loss of supply to critical loads, production loss',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        ...
        'Use of selective (S-type or time-delayed) RCDs upstream',
        'Discrimination ratios: 2:1 for MCBs, 1.6:1 for fuses',
      ],
      engineering: [
        'Coordination software (Amtech, Trimble, etc.)',
        'Testing of discrimination on commissioning',
      ],
    },
    bs7671References: [
      '536 - Coordination of protective devices',
  ...
  },
  {
    ...
    consequence:
      'Neutral conductor overheating, nuisance RCD tripping, equipment malfunction, power quality issues',
    likelihood: 3,
    severity: 3,
    riskRating: 9,
    controlMeasures: {
      engineering: [
        'Oversized neutral for harmonic currents (up to 200%)',
        'Harmonic filters',
        'K-factor rated transformers',
        'Derating of cables in presence of harmonics',
        'Power quality monitoring',
      ],
      administrative: [
        'Harmonic analysis during design',
        'Total Harmonic Distortion (THD) limits <5%',
        'LED driver compatibility checks',
      ],
    },
    bs7671References: [
  ...
  // 🌍 WORK ENVIRONMENT HAZARDS (8 new)
  {
    ...
    consequence:
      'Delayed rescue in electric shock event, unwitnessed accidents, fatality risk, mental health impact',
    likelihood: 4,
    severity: 4,
    riskRating: 16,
    controlMeasures: {
      administrative: [
        ...
        'Check-in procedures (2-hourly minimum)',
        'Man-down/panic alarm systems',
        'Mobile phone or radio contact',
        'Emergency contact procedures',
        'Prohibition of high-risk live work when lone',
        'Buddy system for hazardous tasks',
      ],
  ...
  },
  {
    ...
    consequence:
      'Increased accident risk, errors due to fatigue, security risks, reduced emergency response',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Adequate site lighting (minimum 200 lux for electrical work)',
        'Breaks and shift limits',
        'Buddy system',
        'Security arrangements',
        'Emergency contact procedures',
        'Limit to non-complex tasks where possible',
      ],
      engineering: [
        'Head torches and task lighting',
        'Floodlights for work areas',
        'Emergency lighting',
      ],
    },
  ...
  },
  {
    ...
    consequence:
      'Heat stroke, hypothermia, cold-related injuries, slips on wet surfaces, wind-blown hazards',
    likelihood: 5,
    severity: 3,
    riskRating: 15,
    controlMeasures: {
      administrative: [
        'Weather monitoring and work suspension triggers (>Force 6 wind, <-5°C, >30°C)',
        'Hydration breaks (hot weather)',
        'Warm-up breaks (cold weather)',
        'Weather protection (tents, shelters)',
        'Rescheduling for extreme conditions',
      ],
  ...
  },
  {
    ...
    controlMeasures: {
      ...
      administrative: [
        'Noise assessments',
        'Hearing protection zones (>85dB)',
        'Rotation of workers',
        'Audiometry testing',
      ],
      ppe: [
        'Hearing protection (earplugs or defenders) rated for noise level',
        'Class 4 or 5 for >100dB',
  ...
  },
  {
    ...
    consequence:
      'Permanent vascular and neurological damage to hands, loss of manual dexterity, cold sensitivity',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      elimination: [
        ...
        'Alternative methods (e.g., cable clips vs drilling)',
      ],
      engineering: [
        'Anti-vibration tool handles',
        'Tool maintenance',
        'Sharp drill bits (less vibration)',
      ],
      administrative: [
        'Vibration exposure monitoring',
        'Tool vibration ratings (m/s²)',
        'Exposure action value (EAV): 2.5m/s² over 8hrs',
        'Exposure limit value (ELV): 5m/s²',
        'Health surveillance',
        'Work rotation',
      ],
  ...
  },
  {
    ...
    consequence:
      'Errors leading to accidents, long-term mental health conditions, absence, reduced concentration',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Realistic workload and deadlines',
  ...
  },
  {
    ...
    consequence:
      'Reduced concentration, errors, accidents, driving incidents, health deterioration',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Working Time Regulations compliance (48hr average week)',
        'Maximum shift length limits',
        'Adequate breaks (20min per 6hrs)',
  ...
  },
  {
    ...
    consequence:
      'Heat exhaustion, heat stroke (potentially fatal), reduced concentration, accidents',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Hydration breaks (≥250ml water per hour in heat)',
        'Acclimatization period',
        'Work-rest cycles in extreme heat',
  ...
  // 📊 PROJECT MANAGEMENT HAZARDS (7 new)
  {
    ...
    consequence:
      'Uncontrolled hazards, worker injury, non-compliance, HSE enforcement, legal liability',
    likelihood: 4,
    severity: 4,
    riskRating: 16,
    controlMeasures: {
      administrative: [
        'Method statement for all significant tasks',
        'Step-by-step procedure documented',
        'Hazard identification at each step',
        'Control measures specified',
        'Emergency procedures',
        'Review and approval by competent person',
        'Briefing to all workers',
      ],
  ...
  },
  {
    ...
    consequence:
      'Unidentified hazards causing injury, HSE enforcement, inadequate control measures, liability',
    likelihood: 4,
    severity: 4,
    riskRating: 16,
    controlMeasures: {
      administrative: [
        'Generic risk assessments for routine tasks',
        'Site-specific risk assessments for unique hazards',
        'Regular review (annually or after incident)',
        'Worker involvement in risk assessment',
        'Documented and communicated to all affected workers',
        'RAMS integration',
      ],
      engineering: ['N/A - procedural control'],
    },
  ...
  },
  {
    ...
    consequence:
      'Interface hazards, service strikes, access issues, delays, accidents from concurrent work',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Principal contractor coordination meetings',
        'Integrated programme',
        'Service drawings coordination',
        'Permit to work systems',
        'Exclusion zones',
        'Trade sequencing plans',
  ...
  },
  {
    ...
    consequence:
      'Misunderstood instructions, isolation errors, concurrent working hazards, injuries',
    likelihood: 4,
    severity: 4,
    riskRating: 16,
    controlMeasures: {
      administrative: [
        ...
        'Language barriers addressed (translators if needed)',
        'Written permits and logs',
  ...
  },
  {
    ...
    consequence:
      'Workers unaware of site hazards, control measures not understood, accidents, non-compliance',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Daily or task-specific toolbox talks',
        'Site induction for all new workers',
        'Hazard briefings',
        'Control measure explanations',
  ...
  },
  {
    ...
    consequence:
      'Unfamiliarity with site hazards, emergency procedures unknown, visitor injuries, liability',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Comprehensive site induction covering: site hazards, emergency procedures, welfare facilities, PPE requirements, permit systems, reporting procedures',
        'Induction record and sign-off',
        'Visitor escorts',
        'Refresher inductions for long-term workers',
      ],
  ...
  },
  {
    ...
    consequence:
      'Concurrent working accidents, isolation errors, live working incidents, confined space fatalities',
    likelihood: 3,
    severity: 5,
    riskRating: 15,
    controlMeasures: {
      administrative: [
        'Formal permit to work system for high-risk activities (confined spaces, live work, hot work, excavations)',
        'Permit content: task description, hazards, controls, isolation points, authorizing persons',
        'Permit displayed at work location',
        'Permit closure and handback',
        'Training in permit system',
      ],
  ...
  // 🔧 SPECIALIZED EQUIPMENT HAZARDS (10 new)
  {
    ...
    consequence:
      'Missed hotspots causing fire, false sense of security, electrical hazards undetected',
    likelihood: 3,
    severity: 3,
    riskRating: 9,
    controlMeasures: {
      administrative: [
        'Training in thermal imaging interpretation',
        'Understanding emissivity variations',
        'Load cycling before imaging (equipment at operating temperature)',
        'Minimum 40% load for meaningful results',
        'Image documentation with visible light reference',
      ],
      engineering: [
        'Quality thermal camera with ≥320×240 resolution',
        'Temperature range appropriate for electrical work (-20°C to +650°C)',
  ...
  },
  {
    ...
    consequence:
      'False pass/fail results, undetected faults, electric shock risk from faulty installation',
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Annual calibration to ISO 17025',
        'Calibration certificate retention',
        'Daily function checks using proving unit',
        'Test lead inspection (GS38 compliance)',
        'Understanding of test sequences',
      ],
      engineering: [
        'Purchase quality test equipment (Megger, Fluke, Metrel)',
        'Proving unit for voltage indicator verification',
        'Test lead storage to prevent damage',
      ],
    },
  ...
  },
  {
    ...
    consequence:
      'Inaccurate current readings, missed overload conditions, inadequate cable sizing, fire risk',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        ...
        'Ensure only one conductor in clamp jaws',
        'Clamp perpendicular to conductor',
        'Use AC or AC+DC mode as appropriate',
        'Understand true RMS vs averaging meters',
        'Multiple readings for consistency',
      ],
      engineering: [
        'True RMS clamp meter for distorted waveforms',
        'Annual calibration',
        'Appropriate current range (typically 0-1000A)',
      ],
    },
  ...
  },
  {
    ...
    consequence:
      'Three-phase motor reverse rotation, equipment damage, production loss, safety system failure',
    likelihood: 3,
    severity: 3,
    riskRating: 9,
    controlMeasures: {
      ...
      engineering: [
        'Phase rotation indicator at main distribution',
        'Motor protection relays with phase monitoring',
      ],
    },
  ...
  },
  {
    ...
    controlMeasures: {
      administrative: [
        'PAT tester calibration annually',
        ...
        'Class I: earth continuity, insulation resistance, earth leakage, load test',
        'Class II: insulation resistance, load test',
        'Pass/fail labelling',
      ],
      engineering: [
        'Quality PAT tester (Megger, Seaward, Kewtech)',
        'Test adapter collection',
  ...
  },
  {
    ...
    consequence:
      'Inadequate earthing undetected, electric shock risk in TT systems, non-compliance',
    likelihood: 3,
    severity: 4,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'Disconnect earth electrode from installation before test',
        'Three or four-terminal test method',
        'Test spike spacing: 10m between electrode and first spike, 10m to second spike',
        'Resistance <200Ω for TT systems',
        'Seasonal variations (test in dry conditions)',
        'Document results',
      ],
      engineering: [
        'Earth resistance tester (Megger DET series, Fluke 1623)',
        'Test spikes and leads',
        'Annual calibration',
      ],
    },
  ...
  },
  {
    ...
    consequence:
      'Equipment damage from excessive test voltage, inadequate testing from low voltage, false results',
    likelihood: 4,
    severity: 3,
    riskRating: 12,
    controlMeasures: {
      administrative: [
        'SELV/PELV: 250V DC test voltage',
        'LV circuits up to 500V: 500V DC test voltage',
        'LV circuits over 500V: 1000V DC test voltage',
        'Disconnect sensitive equipment (LED drivers, dimmers, IT equipment, surge protection devices)',
        'Short phase and neutral for combined test',
  ...
  },
  {
    ...
    consequence:
      'Undetected cables struck during excavation, electrocution, explosion, service disruption',
    likelihood: 4,
    severity: 5,
    riskRating: 20,
    controlMeasures: {
      administrative: [
        'Utility plans obtained before work',
        'Sweep area in multiple modes (power, radio, genny)',
        'Mark all detected services',
        'Hand digging within 0.5m of detected services',
        'Assume cables present if signal ambiguous',
        'Regular equipment calibration',
      ],
      engineering: [
        'CAT4+ or Genny4 equipment',
        'Ground penetrating radar for complex sites',
  ...
  },
  {
    ...
    controlMeasures: {
      administrative: [
        'GS38 compliant voltage indicators only',
        'Prove-Test-Prove sequence (test on known live, test circuit, re-test on known live)',
        'Two-pole testing (phase-earth and phase-neutral)',
        'Visual inspection of test equipment before use',
        'Six-monthly calibration check',
      ],
      engineering: [
        'LED or LCD voltage indicators with self-test function',
        'Fused and insulated test leads to GS38',
        'Proving unit for verification',
      ],
    },
    bs7671References: [
      'GS38 - Electrical test equipment',
      'Electricity at Work Regulations 1989 - Regulation 12 (Dead working)',
    ],
    category: 'specialised-equipment',
  ...
  },
  {
    ...
    controlMeasures: {
      administrative: [
        'Test proving unit with known live source periodically',
        'Battery replacement schedule',
        'Verification that proving unit produces expected voltage (typically 230V or 400V)',
        'Visual inspection before use',
      ],
      engineering: [
        'Quality proving unit (Fluke, Megger, Martindale)',
...
export const workplaceScenarios = [
  {
    ...
    description:
      'Full electrical installation in residential property including consumer unit upgrade',
    commonHazards: [
      'elec-shock-001',
      'consumer-unit-001',
      'manual-handling-001',
    ...
    specialConsiderations: [
      'Asbestos survey for pre-1980 properties',
  ...
  },
  {
    ...
    riskLevel: 'very-high',
    requiredCompetencies: [
      'Temporary installation expertise',
      'Event safety',
      'Emergency procedures',
    ],
...
export const riskAssessmentHelpers = {
  ...
  searchHazards: (searchTerm: string): EnhancedRiskConsequence[] => {
    ...
    return enhancedRiskDatabase.filter(
      (hazard) =>
        hazard.hazard.toLowerCase().includes(term) ||
        hazard.consequence.toLowerCase().includes(term) ||
        Object.values(hazard.controlMeasures)
          .flat()
          .some((control) => control?.toLowerCase().includes(term))
    );
  },
};
