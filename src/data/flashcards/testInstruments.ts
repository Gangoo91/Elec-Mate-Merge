...
export const testInstruments: FlashcardData[] = [
  ...
  {
    id: 'ti2',
    question: 'What voltage does an insulation resistance test use for a 230V circuit?',
  ...
  },
  {
    ...
    answer: 'A good connection - lower resistance means better continuity.',
    category: 'Test Instruments',
    difficulty: 'easy',
  },
  {
  ...
  },
  {
    ...
    answer: 'That the RCD trips within the required time at various test currents.',
    category: 'Test Instruments',
    difficulty: 'easy',
  },
  {
  ...
  {
    id: 'ti10',
    question: 'What does a clamp meter measure without breaking the circuit?',
    answer: 'Current flow (by measuring the magnetic field around a conductor).',
    category: 'Test Instruments',
    difficulty: 'easy',
  },
  {
  ...
  },
  {
    ...
    answer: 'To ensure accurate readings - instruments should be calibrated annually.',
    category: 'Test Instruments',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Suitable for use on distribution level circuits (e.g., consumer units).',
    category: 'Test Instruments',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Suitable for use on origin of supply and utility connections.',
    category: 'Test Instruments',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'To verify the correct sequence of phases in a three-phase supply.',
    category: 'Test Instruments',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'The maximum current that would flow if a short circuit occurred.',
    category: 'Test Instruments',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'For safety - fused, insulated, and with limited exposed probe tips.',
    category: 'Test Instruments',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Portable appliance safety - earth continuity, insulation, and leakage current.',
    category: 'Test Instruments',
    difficulty: 'easy',
  },
  {
    ...
    answer: 'Ze is external loop impedance (supply), Zs is total loop impedance (Ze + R1 + R2).',
    category: 'Test Instruments',
    difficulty: 'hard',
  },
  {
    id: 'ti20',
    question: 'What test current does a low-resistance ohmmeter use for continuity?',
    answer: 'Minimum 200mA to check for high-resistance joints.',
    category: 'Test Instruments',
    difficulty: 'hard',
  },
  {
  ...
  {
    id: 'ti22',
    question: 'What must you do before conducting insulation resistance tests?',
    answer:
