...
export const advancedInspection: FlashcardData[] = [
  ...
  },
  {
    ...
    answer:
      "Per BS 7671:2018+A4:2026 Appendix 6 and GN3, all measured values must be recorded on the schedule of test results in the correct columns: continuity (R1+R2 and R2 where applicable), insulation resistance (in MΩ), polarity (tick or cross), earth fault loop impedance Zs (in Ω), PFC (in kA), and RCD operating times (in ms). Results should be compared against the relevant maximum permissible values from BS 7671 tables. Any reading that approaches or exceeds the maximum must trigger further investigation. Where no test is carried out (due to agreed limitations), the cell should be marked with an 'LIM' notation rather than left blank.",
    category: 'EICR Process',
    difficulty: 'hard',
  },
  // === Special Locations ===
  ...
  },
  {
    ...
    answer:
      'Per BS 7671:2018+A4:2026 Section 702, swimming pool and paddling pool locations require SELV (Separated Extra-Low Voltage) in Zone 0 and Zone 1, with the SELV source located outside Zones 0, 1, and 2. During testing, the inspector must verify: supplementary equipotential bonding connects all extraneous-conductive-parts within Zones 0, 1, and 2; all equipment meets the required IP ratings (IPX8 in Zone 0, IPX4 or IPX5 in Zones 1 and 2); RCD protection at 30mA is fitted for all circuits; and that electrical equipment in Zone 0 is rated at no more than 12V AC or 30V DC SELV.',
    category: 'Special Locations',
    difficulty: 'hard',
  },
  {
    ...
    answer:
      'Per BS 7671:2018+A4:2026 Section 705, agricultural premises present increased risks due to livestock, moisture, dust, and corrosive environments. Testing must confirm: supplementary equipotential bonding in livestock locations connects all exposed and extraneous-conductive-parts accessible to livestock (Regulation 705.415.2); RCD protection at 30mA is used for socket outlet circuits and 300mA for other circuits; all equipment has adequate IP ratings for the environment; and earth electrode resistance is satisfactory where TT systems are common. Periodic inspection is recommended every 3 years due to the harsh environmental conditions that accelerate deterioration.',
    category: 'Special Locations',
    difficulty: 'medium',
  },
  // === Instrument Use ===
