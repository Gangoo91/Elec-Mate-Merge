...
export const faultFinding: FlashcardData[] = [
  ...
  },
  {
    ...
    answer: 'No current flow - the circuit is dead even when the supply is on.',
    category: 'Fault Finding',
    difficulty: 'easy',
  },
  {
    ...
    answer: 'Excessive current flow causing protective devices to trip immediately.',
    category: 'Fault Finding',
    difficulty: 'easy',
  },
  {
    ...
    answer: 'A poor connection that increases resistance, causing heat and voltage drop.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Discolouration, burning, melted insulation, or blackening around the connection.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Testing at the midpoint of a circuit to determine which half contains the fault.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Cumulative leakage current, faulty appliances, moisture ingress, or shared neutrals.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Insulation resistance test between neutral and earth with circuits disconnected.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
  ...
  },
  {
    ...
    answer: 'Loose connections, voltage fluctuations, faulty lamp, or overloaded neutral.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'A conducting path on insulation surface caused by contamination and moisture.',
    category: 'Fault Finding',
    difficulty: 'hard',
  },
  {
    ...
    answer: 'Overcurrent or short circuit between live and neutral (not involving earth).',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Earth fault or leakage current below MCB rating but above RCD sensitivity.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
    ...
    answer: "Using another circuit's neutral, causing imbalance and potential RCD issues.",
    category: 'Fault Finding',
    difficulty: 'hard',
  },
  {
    ...
    answer: 'Thermal imaging, monitoring equipment, or stress testing (flexing cables, vibration).',
    category: 'Fault Finding',
    difficulty: 'hard',
  },
  {
    ...
    answer: 'Damaged insulation, moisture ingress, or contamination in the circuit.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Verifying the ring is complete with no interconnections or breaks.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Poor earth connections, undersized cables, long cable runs, or corroded joints.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
  ...
  },
  {
    ...
    answer: 'Disconnect all circuits, reset RCD, reconnect one at a time until it trips.',
    category: 'Fault Finding',
    difficulty: 'easy',
  },
  {
    id: 'ff21',
    question: 'What could cause an electric shock from a metal appliance case?',
    answer: 'Earth fault with inadequate protective conductor or failed earth connection.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
  ...
  },
  {
    ...
    answer: 'Use a socket tester or verify with a multimeter that live and neutral are correct.',
    category: 'Fault Finding',
    difficulty: 'easy',
  },
  {
    ...
    answer: 'Missing earth, high earth impedance, or neutral-earth fault.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Loose connections creating high resistance joints and arcing.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'End-to-end continuity tests should give equal readings for L-L, N-N, and E-E.',
    category: 'Fault Finding',
    difficulty: 'hard',
  },
  {
  ...
  {
    id: 'ff28',
    question: 'What causes humming or buzzing from electrical equipment?',
    answer: 'Loose laminations, overloaded transformers, or magnetic component vibration.',
    category: 'Fault Finding',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Cable locator/tracer, TDR (time domain reflectometer), or tone generator.',
    category: 'Fault Finding',
    difficulty: 'hard',
  },
  {
    ...
    answer: 'Gather information - ask the user, check for recent changes, review symptoms.',
    category: 'Fault Finding',
    difficulty: 'easy',
  },
  // === NEW CARDS ff31–ff35 ===
  ...
  {
    id: 'ff32',
    question: 'What is a time domain reflectometer (TDR) and how does it locate cable faults?',
    answer:
  ...
  {
    id: 'ff35',
    question: 'What are harmonics in an electrical installation and what problems do they cause?',
    answer:
