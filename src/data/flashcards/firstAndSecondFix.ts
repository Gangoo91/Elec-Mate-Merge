...
export const firstAndSecondFix: FlashcardData[] = [
  ...
  {
    id: 'fsf3',
    question: 'What are the three common back box depths, and when would you use each?',
    answer:
  ...
  {
    id: 'fsf6',
    question: 'What are the rules for notching and drilling timber joists to run cables?',
    answer:
  ...
  {
    id: 'fsf11',
    question: 'What precautions must be taken when cables enter a metal consumer unit?',
    answer:
  ...
  {
    id: 'fsf19',
    question: 'Why must dead tests be carried out before live tests on a new installation?',
    answer:
