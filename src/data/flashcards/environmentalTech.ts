...
export const environmentalTech: FlashcardData[] = [
  ...
  },
  {
    ...
    answer: 'Section 712 — Solar photovoltaic (PV) power supply systems.',
    category: 'Solar PV',
    difficulty: 'easy',
  },
  {
  ...
  },
  {
    ...
    answer:
      'A DC isolator allows the inverter to be safely disconnected from the PV array for maintenance. It must be located adjacent to the inverter and be clearly labelled. An additional DC isolator may also be required at roof level depending on the installation. Under A3:2024, isolators in prosumer installations must be bidirectional where energy can flow in both directions.',
    category: 'Solar PV',
    difficulty: 'medium',
  },
  {
...

  {
    id: 'et8',
    question:
      'What is MCS certification and why is it important for renewable energy installations?',
    answer:
  ...
  {
    id: 'et10',
    question: 'List the four EV charging modes and give an example of each.',
    answer:
  ...
  },
  {
    ...
    answer: 'Section 722 — Electric vehicle charging installations.',
    category: 'EV Charging',
    difficulty: 'easy',
  },
  {
    id: 'et12',
    question: 'What type of circuit is required for an EV charge point under BS 7671 Section 722?',
    answer:
      'A dedicated radial circuit from the consumer unit is required. The circuit must not supply any other equipment. A 32A radial on 6mm\u00B2 twin-and-earth (or equivalent) is typical for a 7 kW single-phase charger. Where the installation includes PV or battery storage (prosumer), A3:2024 requires bidirectional switching devices at appropriate positions.',
    category: 'EV Charging',
    difficulty: 'medium',
  },
  {
  ...
  {
    id: 'et16',
    question: 'What are the two main types of heat pump used in UK domestic installations?',
    answer:
  ...
  {
    id: 'et22',
    question: 'What is the key difference between SMETS1 and SMETS2 smart meters?',
    answer:
  ...
  {
    id: 'et23',
    question: 'What is an EPC, what do the ratings mean, and when is one required?',
    answer:
