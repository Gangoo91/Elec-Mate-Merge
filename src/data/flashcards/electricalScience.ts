...
export const electricalScience: FlashcardData[] = [
  ...
  {
    id: 'es4',
    question: 'Give the three forms of the electrical power formula.',
    answer:
  ...
  {
    id: 'es5',
    question: 'A 3kW immersion heater is connected to a 230V supply. What current does it draw?',
    answer: 'I = P / V = 3000 / 230 = 13.04A (approximately 13A).',
    category: 'Power & Energy',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'E = P \u00D7 t = 9.5kW \u00D7 0.25h = 2.375kWh.',
    category: 'Power & Energy',
    difficulty: 'medium',
  },
  {
  ...
  // ── Resistor Networks ─────────────────────────────────────────────────
  {
    ...
    answer: 'In series, R_total = R1 + R2 + R3 = 10 + 20 + 30 = 60\u2126.',
  ...
  },
  {
    ...
    answer: '1/R_total = 1/30 + 1/60 = 2/60 + 1/60 = 3/60. R_total = 60/3 = 20\u2126.',
    category: 'Resistor Networks',
    difficulty: 'medium',
  },
  {
  ...
  {
    id: 'es11',
    question: "State Kirchhoff's current law (KCL) and explain its practical significance.",
    answer:
  ...
  {
    id: 'es14',
    question: "Explain how electromagnetic induction works and state Faraday's law.",
    answer:
  ...
  {
    id: 'es15',
    question: 'What are the standard characteristics of the UK mains electricity supply?',
    answer:
  ...
  {
    id: 'es21',
    question: 'What is an inductor, what is its unit, and what is back-EMF?',
    answer:
  ...
  {
    id: 'es22',
    question: "Define power factor and explain what 'leading' and 'lagging' power factor mean.",
    answer:
