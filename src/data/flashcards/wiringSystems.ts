...
export const wiringSystems: FlashcardData[] = [
  ...
  {
    id: 'ws2',
    question: 'What are the two gauges of PVC conduit and when would you use each?',
    answer:
  ...
  {
    id: 'ws5',
    question: 'Name three common conduit fittings used to provide access for drawing in cables.',
    answer:
  ...
  {
    id: 'ws8',
    question: 'What is the space factor (cable capacity factor) for cables laid into trunking?',
    answer:
  ...
  {
    id: 'ws12',
    question: 'Can the steel wire armour of an SWA cable be used as a CPC?',
    answer:
  ...
  {
    id: 'ws15',
    question: 'What does MICC stand for and what gives this cable its fire-resistant properties?',
    answer:
  ...
  {
    id: 'ws20',
    question: 'In the IP rating system (e.g. IP65), what does each digit represent?',
    answer:
  ...
  {
    id: 'ws21',
    question: 'State the meaning of the following IP ratings: IP20, IP44, IP65, and IP68.',
    answer:
