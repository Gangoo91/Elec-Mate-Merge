...
export const fireAlarmSystems: FlashcardData[] = [
  ...
  {
    id: 'fa1',
    question: 'What are the three main fire alarm system categories defined in BS 5839-1:2017?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Category L1 provides the highest level of life protection with automatic detectors installed throughout all areas of the building, including roof voids and floor voids. It is typically specified for high-risk premises such as care homes, hospitals, and buildings where occupants may have difficulty evacuating. BS 5839-1:2017 considers L1 as full coverage.',
    category: 'System Types',
    difficulty: 'easy',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Ionisation detectors contain a small amount of radioactive material (Americium-241) which raises disposal and environmental concerns. They are also highly prone to false alarms from cooking fumes, steam, and dust, making them unsuitable for many environments. While still permitted, BS 5839-1:2017 notes that optical or multi-sensor detectors are generally preferred for new installations.',
    category: 'Detection',
    difficulty: 'medium',
  },
  {
  ...
  {
    id: 'fa11',
    question: 'Where must manual call points (MCPs) be located according to BS 5839-1:2017?',
    answer:
  ...
  },
  {
    id: 'fa12',
    question:
      'What is the minimum sound level requirement for fire alarm sounders under BS 5839-1:2017?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Segregation prevents electrical interference, cross-faults, and fire damage from other circuits affecting the fire alarm system. BS 5839-1:2017 requires fire alarm cables to be segregated from all cables that are not fire alarm cables. They should run in separate trunking, conduit, or tray compartments, or maintain a minimum separation distance of 300 mm from other power cables where they run in parallel.',
    category: 'Wiring',
    difficulty: 'medium',
  },
  {
  ...
  {
    id: 'fa17',
    question: 'What is the maximum floor area for a single fire alarm zone under BS 5839-1:2017?',
    answer:
  ...
  {
    id: 'fa19',
    question: 'What is the scope of BS 5839-6:2019 and how does it differ from BS 5839-1:2017?',
    answer:
      'BS 5839-6:2019 covers the design, installation, commissioning, and maintenance of fire detection and alarm systems in domestic premises (dwellings). BS 5839-1:2017 covers non-domestic (commercial and industrial) premises. The domestic standard uses a simplified grading system (Grades A to F) and category system (LD1 to LD3) tailored to residential buildings.',
    category: 'Standards',
    difficulty: 'easy',
  },
  {
...

  {
    ...
    answer:
      'BS 5839-1:2017 requires the fire alarm system to be tested at least once every seven days using a manual call point. A different call point should be used each week in rotation so that every call point is tested over the course of a year. The test should confirm that the panel receives the signal, the sounders activate throughout the building, and any cause and effect outputs operate correctly.',
    category: 'Commissioning',
    difficulty: 'easy',
  },
  {
    id: 'fa25',
    question: 'What maintenance is required on a fire alarm system annually under BS 5839-1:2017?',
    answer:
