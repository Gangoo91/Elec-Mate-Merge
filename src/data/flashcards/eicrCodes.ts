...
export const eicrCodes: FlashcardData[] = [
  ...
  },
  {
    ...
    answer: 'Improvement recommended - Does not meet current standards but no immediate danger.',
    category: 'Observation Codes',
    difficulty: 'easy',
  },
  {
  ...
  {
    id: 'eicr5',
    question: 'If a C1 is recorded, what is the overall outcome of the EICR?',
  ...
  {
    id: 'eicr6',
    question: 'If only C3 codes are recorded, what is the overall outcome?',
    answer: 'Satisfactory',
    category: 'Overall Outcomes',
    difficulty: 'medium',
  },
  {
    id: 'eicr7',
    question: 'What maximum interval is recommended between EICRs for domestic properties?',
  ...
  {
    id: 'eicr8',
    question: 'What maximum interval is recommended for commercial properties?',
    answer: '5 years',
    category: 'Inspection Intervals',
    difficulty: 'medium',
  },
  {
    id: 'eicr9',
    question: 'What maximum interval is recommended for swimming pools?',
    answer: '1 year',
    category: 'Inspection Intervals',
    difficulty: 'hard',
  },
  {
    ...
    answer: 'Within 28 days or as agreed with the client - urgent action needed.',
    category: 'Observation Codes',
    difficulty: 'medium',
  },
  {
    ...
    answer: "Limitation - An item that couldn't be fully inspected or tested.",
    category: 'Forms & Documentation',
    difficulty: 'medium',
  },
  {
    id: 'eicr12',
    question: 'Who is responsible for ensuring C1 defects are rectified?',
    answer: 'The duty holder (usually the landlord/owner) must arrange immediate action.',
  ...
  },
  {
    ...
    answer: 'EIC is for new installations; EICR is for existing installations being inspected.',
    category: 'Forms & Documentation',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Not Applicable - The item does not exist or is not relevant to this installation.',
    category: 'Observation Codes',
    difficulty: 'easy',
  },
  {
    ...
    answer: 'Not Verified - Unable to confirm compliance during the inspection.',
    category: 'Observation Codes',
    difficulty: 'medium',
  },
  {
  ...
  {
    id: 'eicr17',
    question: 'What maximum interval is recommended for agricultural/horticultural premises?',
    answer: '3 years',
    category: 'Inspection Intervals',
    difficulty: 'hard',
  },
  {
    id: 'eicr18',
    question: 'What form is used to record the EICR observations?',
    answer: 'Schedule of Inspections and Schedule of Test Results (with condition report)',
    category: 'Forms & Documentation',
    difficulty: 'hard',
  },
  ...
  },
  {
    ...
    answer: '1 year, in accordance with IET Guidance Note 3 and BS 7671.',
    category: 'Inspection Intervals',
    difficulty: 'hard',
  },
  {
    ...
    answer: '1 year for both, due to the harsh or hazardous environments involved.',
    category: 'Inspection Intervals',
    difficulty: 'hard',
  },
  {
    ...
    answer: '1 year for the caravan park fixed installation; 3 years for individual caravan units.',
    category: 'Inspection Intervals',
    difficulty: 'hard',
  },
  {
    id: 'eicr23',
    question: 'What is the difference between an EICR and a Minor Works Certificate?',
    answer:
  ...
  {
    id: 'eicr25',
    question: 'Who is deemed competent to carry out an EICR under UK regulations?',
    answer:
