...
export const safeIsolation: FlashcardData[] = [
  // === EXISTING CARDS si1–si15 (preserved exactly) ===
  {
    ...
    answer: 'Identify the circuit to be isolated and inform all relevant persons.',
  ...
  },
  {
    ...
    answer: 'Prove it works on a known live source (proving unit or known supply).',
    category: 'Safe Isolation',
    difficulty: 'easy',
  },
  {
  ...
  {
    id: 'si4',
    question: "What does the acronym 'STOP' stand for in safe isolation?",
  ...
  },
  {
    ...
    answer: 'A unique personal lock with a single key held by the person working.',
    category: 'Safe Isolation',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'A clear warning that equipment is being worked on and who is doing the work.',
    category: 'Safe Isolation',
    difficulty: 'medium',
  },
  {
    ...
    answer: "At the point of work - as close as possible to where you'll be working.",
    category: 'Safe Isolation',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Electricity at Work Regulations 1989, specifically Regulation 14.',
    category: 'Safe Isolation',
    difficulty: 'hard',
  },
  {
    id: 'si9',
    question: 'What is the minimum PPE required during isolation testing?',
    answer: 'Insulated gloves, safety glasses, and appropriate clothing.',
    category: 'Safe Isolation',
    difficulty: 'medium',
  },
  {
  ...
  },
  {
    ...
    answer: 'Only the person who fitted it (or under strict permit-to-work procedures).',
    category: 'Safe Isolation',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Testing directly on the circuit conductors rather than through measuring equipment.',
    category: 'Safe Isolation',
    difficulty: 'hard',
  },
  {
    ...
    answer: 'To confirm L-N, L-E, and N-E are all dead - a backfeed could energise any conductor.',
    category: 'Safe Isolation',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'HSE guidance on electrical test equipment for use on low voltage systems.',
    category: 'Safe Isolation',
    difficulty: 'hard',
  },
  ...
  {
    id: 'si16',
    question: 'When is a formal permit-to-work required for electrical work?',
    answer:
  ...
  {
    id: 'si17',
    question: 'What key information must a permit-to-work document include?',
    answer:
  ...
  {
    id: 'si19',
    question: 'How does high voltage (HV) isolation differ from low voltage (LV) isolation?',
    answer:
  ...
  {
    id: 'si22',
    question: 'What GS38 requirements apply to test leads used with voltage indicators?',
    answer:
