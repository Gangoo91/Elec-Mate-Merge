...
export const bs7671Regulations: FlashcardData[] = [
  ...
  {
    id: 'bs3',
    question: 'What is the maximum disconnection time for a 32A circuit in a TN system?',
    answer: '0.4 seconds',
  ...
  {
    id: 'bs4',
    question: 'What is the minimum cross-sectional area for a main earthing conductor in copper?',
    answer:
      'Depends on supply conductor size — 6mm\u00B2 (supply up to 16mm\u00B2), 10mm\u00B2 (supply 16-35mm\u00B2), or 16mm\u00B2 (supply over 35mm\u00B2), per Table 54.8.',
    category: 'Protection',
    difficulty: 'medium',
  },
  {
    ...
    answer: 'Protection against electric shock and fire caused by earth faults',
    category: 'Protection',
    difficulty: 'easy',
  },
  ...
  {
    id: 'bs6',
    question: 'What does Part 1 of BS 7671 cover?',
    answer:
  ...
  {
    id: 'bs7',
    question: 'Which part of BS 7671 deals with the selection and erection of equipment?',
    answer:
  ...
  {
    id: 'bs8',
    question: 'Part 6 of BS 7671 covers which critical stage of an electrical installation?',
    answer:
  ...
  // Disconnection Times
  {
    ...
    answer: '0.2 seconds (Table 41.1 of BS 7671).',
    category: 'Disconnection Times',
    difficulty: 'hard',
  },
  {
    ...
    answer: '5 seconds (Regulation 411.3.2.3).',
    category: 'Disconnection Times',
    difficulty: 'medium',
  },
  {
    ...
    answer: '1.15 ohms (from Table 41.3 in BS 7671, for a 20A Type B MCB in a TN system).',
    category: 'Disconnection Times',
    difficulty: 'hard',
  },
  ...
  {
    id: 'bs13',
    question: 'In an IP rating such as IP44, what do the first and second digits represent?',
    answer:
  ...
  // Special Locations
  {
    ...
    answer: 'Only SELV at a maximum of 12V AC or 30V DC ripple-free is permitted in Zone 0.',
  ...
  {
    id: 'bs17',
    question: 'Section 708 of BS 7671 covers electrical installations on which type of site?',
    answer: 'Caravan parks and camping parks — covering the supply to each caravan or tent pitch.',
    category: 'Special Locations',
    difficulty: 'easy',
  },
  {
    ...
    answer: 'Section 703 — Rooms and cabins containing sauna heaters.',
    category: 'Special Locations',
    difficulty: 'medium',
  },
  ...
  {
    id: 'bs20',
    question: 'What key change did Amendment 2 make regarding Arc Fault Detection Devices (AFDDs)?',
    answer:
  ...
  {
    id: 'bs21',
    question: 'What does ADS stand for and what are its two essential requirements?',
    answer:
  ...
  {
    id: 'bs22',
    question: 'Explain the difference between basic protection and fault protection under BS 7671.',
    answer:
  ...
  {
    id: 'bs23',
    question: "What is the definition of an 'extraneous-conductive-part' in BS 7671?",
    answer:
  ...
  {
    id: 'bs24',
    question: 'What does PELV stand for, and how does it differ from SELV?',
    answer:
  ...
  // ── A3:2024 cards (bs26–bs28) ─────────────────────────────────────────

  {
    id: 'bs26',
    question: 'What is Amendment 3 (2024) to BS 7671?',
    answer:
      'A3:2024 was published on 31 July 2024 as a free PDF supplement to BS 7671:2018. It adds Regulation 530.3.201, which introduces requirements for bidirectional and unidirectional switching and isolation devices in prosumer installations (those that can both consume and export electrical energy).',
    category: 'Parts & Structure',
    difficulty: 'medium',
  },
  {
    id: 'bs27',
    question: 'What does Regulation 530.3.201 (introduced by A3:2024) require?',
    answer:
      'Regulation 530.3.201 requires that switching and isolation devices in prosumer installations are suitable for the direction(s) of energy flow. Bidirectional devices must be used where current can flow in both directions (e.g. between the grid and a battery/PV inverter). Unidirectional devices may only be used where current flow is in one direction only.',
    category: 'Protection',
    difficulty: 'hard',
  },
  {
    id: 'bs28',
    question:
      'In a domestic solar PV + battery installation, what does A3:2024 mean for isolator selection?',
    answer:
      'The installer must use bidirectional isolators rated for fault current in both directions at any point where energy can flow to and from the grid. A standard unidirectional isolator is no longer compliant at these positions. This applies to the main switch if the installation can export, and to any switching device between the inverter/battery system and the supply.',
    category: 'Protection',
    difficulty: 'hard',
  },
];
