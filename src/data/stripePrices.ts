...
const ELECTRICIAN_GROUPS: FeatureGroup[] = [
  ...
  },
  {
    ...
    items: [
      'Voice-to-form, voice quotes, voice notes',
      'Xero / QuickBooks sync, Stripe Connect',
    ],
  },
];
...
const MATE_GROUPS: FeatureGroup[] = [
  {
    ...
    items: [
      'Chat, voice-note or send photos — no new app to learn',
      'Morning brief at 7am: schedule, overdue invoices, urgent tasks',
      'Proactive alerts throughout the day (quotes going stale, clients gone quiet)',
      'Ask anything: "Zs for a B32 RCBO?" → instant BS 7671 answer with reg citation',
    ],
  },
  {
    heading: 'Actually talk to Mate — and hear it back',
    items: [
      'Hold the mic and speak — Mate understands voice notes end-to-end',
      'Mate replies in voice too — natural, hands-free while you drive or work',
      'Two-way voice conversations, not just voice-to-text',
      'Perfect for the van, the ladder, or when your hands are covered in dust',
    ],
  },
  {
    heading: 'Send Mate a photo and it does the rest',
    items: [
      'Consumer unit → priced quote draft with materials and labour',
      'Site install → cost estimate and material list',
      'Receipt → logged, categorised, VAT captured, synced to Xero / QuickBooks',
    ],
  },
  {
    ...
    items: [
      ...
      'Safety checks: blocks £0 invoices, flags duplicates within 7 days',
      'Invoice chasing workflows on a set cadence',
    ],
  },
  {
    heading: 'Calendar, routing & day planner',
    items: [
      '"Plan my day" → TSP-optimised route respecting fixed-time meetings',
      'Live traffic and 3-day weather built into the plan',
      'Create, update, delete events in chat — auto-coloured by type',
      'Availability lookup: "When am I free Thursday?"',
      'Share a client-booking link for self-service scheduling',
    ],
  },
  {
    heading: 'CRM & client portal',
    items: [
      'Look up clients by name, phone, email or address',
      'Create or update client records in chat',
      'Generate tokenised portal links — client sees their certs, invoices, quotes',
      'Full audit trail of every action Mate takes',
    ],
  },
  {
    heading: 'Tasks, projects & snagging',
    items: [
      'Create tasks or whole projects with ordered, auto-dated steps',
      'Filter: overdue, by priority, by customer, by project',
  ...
  },
  {
    ...
    items: [
      'Generate a full RAMS in ~3 minutes — H&S agent + Install Planner in parallel',
      'Standalone method statements',
      'Part P Building Control notifications',
      'Read RAMS history with job-level status',
    ],
  },
  {
    ...
    items: [
      ...
      'Log mileage — HMRC 45p/mile auto-calculated',
      'Categories: materials, tools, fuel, PPE, subscriptions, training and more',
      'Sync straight to Xero or QuickBooks (OAuth)',
    ],
  },
  {
    heading: 'Business intelligence on demand',
    items: [
      'Revenue summary — week / month / quarter / year with growth',
      'Revenue forecast and weighted pipeline',
      'Cash flow forecast with DSO and at-risk overdue',
      'Outstanding payments broken down 7 / 14 / 30 / 60+ days',
      'Top clients, inactive clients, client lifetime value',
      'Quote analytics: conversion rate, pipeline value, time-to-convert',
      'Seasonal trends: busiest / quietest months, YoY comparisons',
  ...
  },
  {
    ...
    items: [
      ...
      'Reads inbox, AI-classifies enquiries vs. quote responses vs. noise',
      'Drafts replies by intent: acknowledge, request details, send quote, decline',
      'You approve, Mate sends',
    ],
  },
  {
    heading: 'Knowledge & tools',
    items: [
      'BS 7671 A4:2026 end-to-end — Zs, cable ratings, AFDDs, PNB, schedule columns',
      'Specific reg citations in seconds — no more hunting the Big Brown Book',
      'Live UK wholesaler pricing — Mate finds the part and shows you options',
      'Labour timing and trade knowledge lookups',
      'Regional pricing and supplier data',
      'Google Solar API — roof analysis, panel count, 20-year savings',
      'Static maps, geocoding, UK address validation',
      'YouTube search for trade videos',
    ],
  },
  {
    heading: 'Smart automations',
    items: [
      'Completion checklist per job — surfaces missing cert, invoice or snag',
      'Pricing suggestions based on your history and job type',
      'Pre-built project templates with auto-generated task sequences',
      'Consent-safe outbound: STOP / opt-out automatically honoured',
    ],
  },
];
...
const EMPLOYER_GROUPS: FeatureGroup[] = [
  {
    heading: 'People Hub',
    items: [
      'Team management with roles and permissions (Operative, Supervisor, QS, PM)',
      'Elec-ID digital credentials — compliance tracking, renewal alerts, share links',
      'Timesheets — clock in / out, manual entry, approvals, leave and holiday allowances',
      'Team chat — channels, direct messages, reactions, read receipts',
      'Announcements and team-wide briefings',
      'Talent pool — browse available electricians and filter by skills',
      'Job vacancies — post, applications, interviews, vacancy templates and invitations',
    ],
  },
  {
    heading: 'Jobs Hub',
    items: [
      ...
      'Gantt timeline view for scheduling and dependencies',
      'Job packs bundling scope, docs, client sign-offs and checklists',
      'GPS worker tracking with live map and location history',
      'Progress logs with photo evidence, time-stamped, full audit trail',
      'Quality & snagging — defect marking, photo compare, sign-off workflow',
      'Testing workflow — drive EICR / EIC sequences per job',
      'Client portal (white-label) — job status, photos, certs, pay links',
      'Fleet management — vehicles, daily checks, services, fuel, tools',
      'Photo gallery with timeline, map view and before / after slider',
      'Variation orders with approval workflow',
      'Job assignments and QR job check-in',
    ],
  },
  {
    heading: 'Finance Hub',
    items: [
      ...
      'Tender search and bid pipeline (Contracts Finder, NHS, Housing and more)',
      ...
      'Procurement — orders, suppliers, material lists, PAT & calibration',
      'Reports — revenue, profitability, utilisation, debtor aging',
      'Digital signatures for quotes, invoices, sign-offs',
  ...
  },
  {
    heading: 'Safety Hub',
    items: [
      'RAMS generator and AI RAMS (3-minute pipeline)',
      'Incident reporting, near-miss log, witness testimonies',
      '1,000+ hazard database, COSHH builder, permits to work',
      'Fire watch records and pre-use checks',
      'Policies — upload, version, distribute, acknowledgement tracking',
      'Contracts — employment, subcontractor, HR templates',
      'Training records with CPD log and certification expiry alerts',
      'Toolbox briefings with QR sign-off and photo distribution',
      'Compliance calendar — insurance renewals, PAT, calibration deadlines',
      'Corrective actions, observations and safety achievements',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      'Company settings — logo, colours, bank details, branding',
      'Notification preferences and push alerts',
      'Activity feed — company-wide event timeline',
