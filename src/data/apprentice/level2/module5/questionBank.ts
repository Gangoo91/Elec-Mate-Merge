...
export const module5QuestionBank: QuestionBank[] = [
  // Section 5.1: Understanding Installation Specifications and Drawings (36 questions)
  {
    ...
    correctAnswer: 1,
    explanation:
      'Installation drawings provide a visual representation of electrical systems, showing component locations, connections, and circuit arrangements to guide installation work.',
    section: '5.1.1',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'A cable schedule should include comprehensive information about cable type, conductor size, length required, and circuit designation for proper installation planning.',
    section: '5.1.3',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'As-built drawings show what was actually installed, including any modifications made during construction that differ from the original design.',
    section: '5.1.5',
    difficulty: 'intermediate',
  ...
  // Section 5.2: Basic Electrical Design Principles (35 questions)
  {
    ...
    correctAnswer: 3,
    explanation:
      'Load requirements and current demand must be determined first to ensure the circuit can safely carry the required current without overloading.',
    section: '5.2.1',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Diversity factor is a reduction factor applied to the total connected load, recognising that not all electrical equipment operates simultaneously at full load.',
    section: '5.2.2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Voltage drop calculations ensure that electrical equipment receives adequate voltage at the point of utilisation for proper and efficient operation.',
    section: '5.2.3',
    difficulty: 'intermediate',
    topic: 'Voltage Drop',
  },
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Current-carrying capacity is affected by installation method, ambient temperature, grouping with other cables, and thermal insulation - all requiring derating factors.',
    section: '5.2.5',
    difficulty: 'advanced',
  ...
  // Section 5.3: Planning Installation Work on Site (38 questions)
  {
    ...
    correctAnswer: 0,
    explanation:
      'A site survey and risk assessment must be conducted first to understand site conditions, identify hazards, and plan safe working methods.',
    section: '5.3.1',
    difficulty: 'basic',
    topic: 'Site Survey',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Coordination with other trades prevents work conflicts, ensures safety of all personnel, maintains project schedules, and ensures quality outcomes.',
    section: '5.3.2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'A method statement should include step-by-step procedures, safety measures, required resources, and any special considerations for the work.',
    section: '5.3.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Temporary electrical supplies must be planned during the early planning phase to ensure adequate and safe power is available when work begins.',
    section: '5.3.4',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Cable routes must consider safe zones, accessibility for installation and maintenance, proximity to other services, and compliance with regulations.',
    section: '5.3.5',
    difficulty: 'advanced',
    topic: 'Cable Routing',
  },
  ...
  // Section 5.4: Materials, Tools, and Resource Planning (37 questions)
  {
    ...
    correctAnswer: 1,
    explanation:
      'A bill of quantities lists all required materials with accurate quantities and specifications to ensure complete procurement and cost estimation.',
    section: '5.4.1',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Tool planning must consider availability, suitability for specific tasks, safety requirements, calibration needs, and PAT testing status.',
    section: '5.4.2',
    difficulty: 'intermediate',
    topic: 'Tool Planning',
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Planned delivery schedules ensure materials arrive when needed, prevent storage problems, reduce wastage, and maintain project flow.',
    section: '5.4.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Resource allocation plans should include personnel requirements, tools needed, materials, time allocations, and any special equipment or skills required.',
    section: '5.4.4',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Materials must be stored according to manufacturer instructions, protected from weather, kept clean and dry, and organised to prevent damage.',
    section: '5.4.5',
    difficulty: 'basic',
  ...
  // Section 5.5: Working with Other Trades and Site Personnel (36 questions)
  {
    ...
    correctAnswer: 2,
    explanation:
      'Effective communication ensures safety of all trades, coordinates work sequences, prevents conflicts, and maintains project quality and schedule.',
    section: '5.5.1',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'When conflicts arise, work should stop and solutions discussed with relevant parties to ensure safety and quality are maintained.',
    section: '5.5.2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'The site supervisor, affected trades, and project coordinator should be informed to ensure proper coordination and prevent disruption.',
    section: '5.5.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "Understanding other trades' sequences allows electrical work to be planned at appropriate times, avoiding delays and ensuring logical construction sequence.",
    section: '5.5.4',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Shared workspace should be managed through coordination meetings and agreed schedules to ensure efficient use and prevent conflicts.',
    section: '5.5.5',
    difficulty: 'intermediate',
  ...
  // Section 5.6: Communicating Information Effectively (35 questions)
  {
    ...
    correctAnswer: 3,
    explanation:
      'Effective written communication must be clear, accurate, complete, and timely to ensure proper understanding and action by recipients.',
    section: '5.6.1',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Progress reports should be provided at regular agreed intervals and when significant milestones are reached to maintain project oversight.',
    section: '5.6.2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Safety concerns should include location, nature of hazard, potential consequences, immediate actions taken, and recommendations for resolution.',
    section: '5.6.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Technical information for non-technical personnel should use simple, clear language, avoiding unnecessary jargon while maintaining accuracy.',
    section: '5.6.4',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Toolbox talks communicate essential safety information, work updates, coordinate daily activities, and address specific site issues.',
    section: '5.6.5',
    difficulty: 'basic',
    topic: 'Toolbox Talks',
  },
  ...
  // Section 5.7: Documentation, Labelling, and Record Keeping (33 questions)
  {
    ...
    correctAnswer: 0,
    explanation:
      'Accurate records ensure legal compliance, facilitate future maintenance, provide quality assurance, and support warranty claims.',
    section: '5.7.1',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Cable labels should include circuit designation, cable type, destination information, and any relevant voltage or current ratings.',
    section: '5.7.2',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Test certificates should be completed during testing as results are obtained to ensure accuracy and prevent omissions or errors.',
    section: '5.7.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Installation logs track work progress, record important decisions, document changes from original plans, and provide project history.',
    section: '5.7.4',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Electrical installation records should be retained for the duration of the installation's life plus a reasonable period for potential future reference.",
    section: '5.7.5',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Installation route drawings show detailed cable containment routes, including trunking, conduit, and cable tray paths through the building.',
    section: '5.1.2',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'A distribution board schedule shows complete circuit details including protective device ratings, cable types and sizes, and circuit descriptions.',
    section: '5.1.3',
    difficulty: 'intermediate',
    topic: 'DB Schedules',
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Revision clouds are used to highlight changes and modifications made to drawings, making it easy to identify what has been altered.',
    section: '5.1.4',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Title blocks should include project name, drawing number, scale, date, revision status, and responsible parties for proper identification.',
    section: '5.1.5',
    difficulty: 'intermediate',
    topic: 'Title Blocks',
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'MCB represents Miniature Circuit Breaker, a protective device used in electrical installations to protect circuits from overcurrent.',
    section: '5.1.6',
    difficulty: 'basic',
  ...
  // Section 5.2 continued
  {
    ...
    correctAnswer: 3,
    explanation:
      'Load calculations determine the electrical demand to ensure appropriate cable sizes and protective device ratings are selected for safe operation.',
    section: '5.2.1',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Cable size selection must consider current carrying capacity, voltage drop limitations, fault protection requirements, and installation conditions.',
    section: '5.2.2',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Circuit protective conductors provide earth fault protection by creating a low-impedance path for fault currents to operate protective devices.',
    section: '5.2.3',
    difficulty: 'intermediate',
  ...
  // Section 5.3 continued
  {
    ...
    correctAnswer: 0,
    explanation:
      'Work sequences must consider logical progression, safety requirements, coordination with other trades, and efficient resource utilisation.',
    section: '5.3.1',
    difficulty: 'advanced',
    topic: 'Work Sequencing',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Access planning ensures safe and efficient installation processes and provides adequate access for future maintenance and modifications.',
    section: '5.3.2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Site surveys should capture existing services, structural constraints, environmental conditions, access requirements, and any site-specific challenges.',
    section: '5.3.3',
    difficulty: 'advanced',
    topic: 'Site Surveys',
  },
  ...
  // I'll add the remaining questions following the same structure
  {
    ...
    correctAnswer: 3,
    explanation:
      'A risk assessment matrix prioritises risks by evaluating likelihood and severity, helping focus attention on the most significant hazards.',
    section: '5.3.4',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Emergency procedures should be planned during the planning phase to ensure all personnel know what to do in case of accidents or emergencies.',
    section: '5.3.5',
    difficulty: 'basic',
  ...
  // Section 5.4 continued
  {
    ...
    correctAnswer: 1,
    explanation:
      'Material selection must consider quality, suitability for application, compliance with relevant standards, and environmental operating conditions.',
    section: '5.4.1',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Verifying specifications ensures materials meet design requirements, installation conditions, and relevant standards before commitment to purchase.',
    section: '5.4.2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Material requisitions should include complete specifications, accurate quantities, delivery requirements, and applicable quality standards.',
    section: '5.4.3',
    difficulty: 'intermediate',
  ...
  // More Section 5.1 questions
  {
    ...
    correctAnswer: 0,
    explanation:
      'Electrical legends explain the symbols, abbreviations, and conventions used in the drawings to ensure correct interpretation.',
    section: '5.1.1',
    difficulty: 'basic',
  ...
  // Section 5.5 continued
  {
    ...
    correctAnswer: 1,
    explanation:
      'Disagreements should be resolved through proper site supervision channels and established formal procedures to maintain project progress and relationships.',
    section: '5.5.1',
    difficulty: 'intermediate',
  ...
  // Section 5.6 continued
  {
    ...
    correctAnswer: 2,
    explanation:
      'Effective verbal communication requires clear speech, appropriate technical level for the audience, and confirmation that information is understood.',
    section: '5.6.1',
    difficulty: 'basic',
  ...
  // Section 5.7 continued
  {
    ...
    correctAnswer: 3,
    explanation:
      'Daily logs should record work completed, problems encountered, materials used, time spent, and any significant events or decisions.',
    section: '5.7.1',
    difficulty: 'intermediate',
    topic: 'Daily Logs',
  },

  {
    ...
    correctAnswer: 0,
    explanation:
      'Proper panel labelling enables safe identification during maintenance, emergency response, and future modifications or troubleshooting.',
    section: '5.7.2',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Electrical site plans show external electrical supplies, main distribution routes, outdoor equipment locations, and cable entry points to buildings.',
    section: '5.1.2',
    difficulty: 'basic',
    topic: 'Site Plans',
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Electrical drawings should be stored in controlled document systems with proper version control, access records, and backup procedures.',
    section: '5.1.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Equipment schedules provide comprehensive lists of all electrical equipment including specifications, ratings, locations, and identification details.',
    section: '5.1.4',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Detail drawings show specific installation methods, connection details, dimensional information, and construction techniques for complex installations.',
    section: '5.1.5',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Drawing modifications should be properly documented with revision numbers, clear change descriptions, dates, and appropriate authorisation signatures.',
    section: '5.1.6',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'AC circuit impedance is affected by resistance, inductance, and capacitance, with the latter two being frequency-dependent.',
    section: '5.2.3',
    difficulty: 'advanced',
    topic: 'AC Impedance',
  },
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Discrimination is determined by analysing operating characteristics and time-current curves to ensure upstream devices operate before downstream ones.',
    section: '5.2.5',
    difficulty: 'advanced',
  ...
  // Additional Section 5.3 questions (Planning Installation Work on Site)
  {
    ...
    correctAnswer: 0,
    explanation:
      'Comprehensive safety planning must consider working at height, electrical hazards, manual handling requirements, site access, and environmental conditions.',
    section: '5.3.1',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Identifying existing services prevents accidental damage during excavation and drilling, ensuring safety and avoiding costly repairs and delays.',
    section: '5.3.2',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Various permits may be required including permit to work systems, hot work permits for welding, and confined space permits for certain installations.',
    section: '5.3.3',
    difficulty: 'intermediate',
    topic: 'Work Permits',
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Environmental planning must assess temperature ranges, humidity levels, corrosive atmospheres, and determine appropriate IP protection requirements.',
    section: '5.3.4',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Pre-installation checks should verify materials, check tools and equipment, confirm safety equipment availability, and review current drawings.',
    section: '5.3.5',
    difficulty: 'intermediate',
  ...
  // Additional Section 5.4 questions (Materials, Tools, and Resource Planning)
  {
    ...
    correctAnswer: 1,
    explanation:
      'Containment selection must consider environmental conditions, accessibility requirements, cable loading capacity, and future expansion needs.',
    section: '5.4.1',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "Tool maintenance requires regular PAT testing, daily visual inspections, following manufacturer's maintenance schedules, and proper storage.",
    section: '5.4.2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Material certificates should include complete specifications, test results, compliance with relevant standards, and batch/serial numbers for traceability.',
    section: '5.4.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Waste management requires segregated collection, recycling where possible, proper disposal of hazardous materials, and environmental compliance.',
    section: '5.4.4',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Cable pulling may require specialist winches, conduit cleaning equipment, cable lubricants, and appropriate pulling grips for safe installation.',
    section: '5.4.5',
    difficulty: 'advanced',
  ...
  // Additional Section 5.5 questions (Working with Other Trades)
  {
    ...
    correctAnswer: 2,
    explanation:
      'HVAC coordination requires planning cable routes to avoid ductwork conflicts and coordinating electrical supplies for HVAC equipment installation.',
    section: '5.5.1',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Structural coordination requires sharing loading requirements for cable trays, penetration needs for cables, and support requirements for equipment.',
    section: '5.5.2',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Fire protection coordination ensures electrical installations don't compromise fire barriers and provides appropriate emergency power supplies.",
    section: '5.5.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Plumbing coordination requires avoiding water pipe damage, maintaining appropriate separation distances, and coordinating structural penetrations.',
    section: '5.5.4',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Project communication requires regular progress reports, milestone notifications, early problem alerts, and resource requirement updates.',
    section: '5.5.5',
    difficulty: 'basic',
  ...
  // Additional Section 5.6 questions (Communicating Information Effectively)
  {
    ...
    correctAnswer: 3,
    explanation:
      'Effective technical drawings require clear standardised symbols, appropriate scales, complete dimensional information, and accurate construction details.',
    section: '5.6.1',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Fault reporting should include clear descriptions, safety implications, recommended corrective actions, and realistic timeframes for resolution.',
    section: '5.6.2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Handover documentation should include system descriptions, operating instructions, maintenance requirements, emergency procedures, and contact information.',
    section: '5.6.3',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'User training should include structured sessions covering system operation, safety procedures, basic maintenance, and emergency responses.',
    section: '5.6.4',
    difficulty: 'intermediate',
    topic: 'User Training',
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Communication methods should match the technical knowledge level and role requirements of different site personnel for effective understanding.',
    section: '5.6.5',
    difficulty: 'advanced',
  ...
  // Additional Section 5.7 questions (Documentation, Labelling, and Record Keeping)
  {
    ...
    correctAnswer: 0,
    explanation:
      'Electrical certificates must comply with BS 7671 requirements including prescribed forms for test certificates and inspection schedules.',
    section: '5.7.1',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Circuit charts should be continuously updated as work progresses, recording actual circuit details and any changes from original design.',
    section: '5.7.2',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Test records should include test type, actual results, instruments used, environmental conditions, and relevant acceptance criteria.',
    section: '5.7.3',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Digital documentation requires proper version control, regular backup procedures, appropriate access control, and standardised file formats.',
    section: '5.7.4',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Distribution board labelling must include clear circuit identification, voltage levels, protective device ratings, and emergency contact information.',
    section: '5.7.5',
    difficulty: 'basic',
  ...
  // Section 5.1 - Advanced questions
  {
    ...
    correctAnswer: 1,
    explanation:
      'Load schedules should include equipment ratings, applicable demand factors, diversity factors, and calculations showing total connected load.',
    section: '5.1.1',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Drawing revisions require comprehensive logs, formal change notifications to affected parties, and records of distribution to ensure everyone has current versions.',
    section: '5.1.2',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Panel elevations should show detailed component layouts, required clearance dimensions, access requirements, and maintenance considerations.',
    section: '5.1.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Electrical drawings must reference common grid systems, coordinate floor levels, and align with architectural features for accurate installation.',
    section: '5.1.4',
    difficulty: 'advanced',
  ...
  // Section 5.2 - Advanced design principles
  {
    ...
    correctAnswer: 1,
    explanation:
      'Protective device selection must consider load characteristics, available fault levels, discrimination requirements, and environmental operating conditions.',
    section: '5.2.1',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Harmonics increase neutral currents in three-phase systems, affect cable sizing calculations, and influence transformer and filter selection.',
    section: '5.2.2',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Emergency lighting design requires supply separation, adequate battery autonomy, automatic testing provisions, and maintenance accessibility.',
    section: '5.2.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Power factor correction requires assessment of reactive power requirements and selection of appropriate compensation equipment to optimise system efficiency.',
    section: '5.2.4',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'IT systems require insulation monitoring devices, first fault indication systems, and specialised maintenance procedures for continued safe operation.',
    section: '5.2.5',
    difficulty: 'advanced',
  ...
  // Section 5.3 - Advanced planning
  {
    ...
    correctAnswer: 2,
    explanation:
      'Lifting operations require load calculations, appropriate equipment selection, exclusion zone establishment, and certified operator involvement.',
    section: '5.3.1',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Contaminated environments require thorough assessment, appropriate protective equipment, decontamination procedures, and specialist waste disposal.',
    section: '5.3.2',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Emergency planning must identify clear escape routes, designated assembly points, communication methods, and emergency contact procedures.',
    section: '5.3.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Heritage building work requires consideration of conservation requirements, structural limitations, access restrictions, and often specialist installation techniques.',
    section: '5.3.4',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Outdoor work requires monitoring wind speeds, precipitation alerts, temperature limits, and lightning detection for safe working conditions.',
    section: '5.3.5',
    difficulty: 'intermediate',
  ...
  // Section 5.4 - Advanced resource planning
  {
    ...
    correctAnswer: 3,
    explanation:
      'Specialist equipment procurement must specify accuracy requirements, ensure current calibration status, and consider operator training needs.',
    section: '5.4.1',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Cable drum handling requires consideration of weight limits, correct rotation direction, environmental protection, and appropriate handling equipment.',
    section: '5.4.2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Consumable management requires inventory tracking, usage monitoring, established reorder points, and waste minimisation strategies.',
    section: '5.4.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Temporary facilities selection must consider power requirements, security needs, environmental protection, and adequate access for personnel and materials.',
    section: '5.4.4',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Hazardous materials require proper segregation, appropriate containment systems, adequate ventilation, and comprehensive emergency procedures.',
    section: '5.4.5',
    difficulty: 'advanced',
  ...
  // Section 5.5 - Advanced inter-trade coordination
  {
    ...
    correctAnswer: 0,
    explanation:
      'Lift coordination requires careful power supply planning, control wiring route coordination, and integration of safety circuits and systems.',
    section: '5.5.1',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Security system coordination requires cable route planning, dedicated power supply arrangements, and clear interface requirements definition.',
    section: '5.5.2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'BMS coordination requires defining communication protocols, monitoring points, control interfaces, and data collection requirements.',
    section: '5.5.3',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Telecommunications coordination requires appropriate separation distances, electromagnetic interference prevention, and coordination of shared containment systems.',
    section: '5.5.4',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Effective progress meetings require regular schedules, clear agendas, systematic action item tracking, and properly documented outcomes.',
    section: '5.5.5',
    difficulty: 'intermediate',
  ...
  // Section 5.6 - Advanced communication
  {
    ...
    correctAnswer: 1,
    explanation:
      'Facility manager briefings should include system overviews, clear operational procedures, maintenance requirements, and emergency response protocols.',
    section: '5.6.1',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Commissioning reports should include comprehensive test results, performance verification, defect lists, and compliance with acceptance criteria.',
    section: '5.6.2',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Occupant safety communication requires simple language, effective visual aids, location-specific information, and clear emergency procedures.',
    section: '5.6.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'International projects require standardised symbols, multi-language documentation where necessary, and awareness of cultural communication differences.',
    section: '5.6.4',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Occupied building work requires advance notices, clear work schedules, disruption minimisation strategies, and regular progress updates to occupants.',
    section: '5.6.5',
    difficulty: 'intermediate',
  ...
  // Section 5.7 - Advanced documentation
  {
    ...
    correctAnswer: 2,
    explanation:
      'Long-term storage requires archival formats like PDF/A, standardised file naming conventions, and planned format migration strategies.',
    section: '5.7.1',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Testing documentation requires independent verification, instrument calibration checks, appropriate witness signatures, and accuracy reviews.',
    section: '5.7.2',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Backup procedures require multiple storage locations, regular backup schedules, periodic recovery testing, and appropriate access security.',
    section: '5.7.3',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Large projects require hierarchical filing systems, comprehensive cross-referencing, and formal document control procedures for effective management.',
    section: '5.7.4',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'O&M manuals should include comprehensive system descriptions, clear operating procedures, detailed maintenance schedules, and practical troubleshooting guides.',
    section: '5.7.5',
    difficulty: 'advanced',
    topic: 'O&M Manuals',
  },
  ...
  // Additional questions to reach 250 total - covering all sections comprehensively
  {
    ...
    options: [
      'BS 7671 Chapter 51 (identification and notices)',
    ...
    correctAnswer: 3,
    explanation:
      'UK electrical drawing symbols are governed by IEC 60617. BS 7671 Reg 514.9.1 requires that any symbol used in diagrams, charts, tables or schedules complies with IEC 60617. The older BS EN 60617 (and BS 6217, BS EN 60417) were withdrawn once IEC moved the symbol library to an online database, so IEC 60617 is the current reference. Standardised interpretation.',
    section: '5.1.1',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Fire evacuation plans should show emergency lighting locations, fire alarm components, and electrical isolation points for emergency responder information.',
    section: '5.1.2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Block diagrams provide overview of system architecture and major component relationships without detailed circuit information.',
    section: '5.1.3',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Earthing drawings should show complete system layout including conductor sizes, connection details, and equipotential bonding arrangements.',
    section: '5.1.4',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Material take-offs should include detailed item descriptions, accurate quantities, complete specifications, and any special delivery requirements.',
    section: '5.1.5',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Containment drawings should show sizes, support spacing requirements, load capacity information, and installation height details.',
    section: '5.1.6',
    difficulty: 'intermediate',
  ...
  // More Section 5.2 questions
  {
    ...
    correctAnswer: 1,
    explanation:
      'Prospective fault current depends on supply characteristics, total impedance of the supply path, and transformer or generator ratings.',
    section: '5.2.1',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Current-carrying capacity is determined by multiplying tabulated values by applicable derating factors for installation conditions.',
    section: '5.2.2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      "The 'k' factor relates to conductor material, insulation type, and their thermal properties for protective conductor sizing calculations.",
    section: '5.2.3',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Ring circuit design requires consideration of load distribution, loop impedance calculations, and cable routing for balanced loading and safety.',
    section: '5.2.4',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Swimming pool installations require zone classification assessment, appropriate IP ratings, comprehensive equipotential bonding, and mandatory RCD protection.',
    section: '5.2.5',
    difficulty: 'advanced',
...

  {
    ...
    correctAnswer: 2,
    explanation:
      'Energised work requires comprehensive risk assessment, formal permit systems, specially trained personnel, and appropriate personal protective equipment.',
    section: '5.3.1',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Long cable runs require tension calculations, intermediate pull point planning, appropriate lubricant selection, and proper pulling equipment.',
    section: '5.3.2',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Material deliveries should include delivery notes, compliance certificates, relevant test certificates, and any special handling instructions.',
    section: '5.4.1',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Quality monitoring requires regular staged inspections, progressive testing, compliance verification, and documented review processes.',
    section: '5.4.2',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Commissioning coordination requires system readiness confirmation, coordinated testing sequences, witness point scheduling, and complete documentation.',
    section: '5.5.1',
    difficulty: 'advanced',
  ...
  // Adding final questions to reach exactly 250
  {
    ...
    correctAnswer: 3,
    explanation:
      'Design changes require formal notifications, updated drawings, impact assessments, and proper approval records to maintain project control.',
    section: '5.6.1',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Inspection schedules should define inspection stages, mandatory hold points, clear acceptance criteria, and identify responsible parties.',
    section: '5.7.1',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Regulatory compliance requires chronological filing, comprehensive cross-indexing, defined retention schedules, and clear audit trails.',
    section: '5.7.2',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Installation documentation provides compliance evidence, supports warranty claims, enables defect tracking, and facilitates rectification work.',
    section: '5.7.3',
    difficulty: 'intermediate',
...

  {
    ...
    correctAnswer: 3,
    explanation:
      'Method statements must include detailed work sequences, comprehensive safety measures, resource requirements, and quality control procedures.',
    section: '5.3.1',
    difficulty: 'intermediate',
    topic: 'Method Statements',
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Circuit identification requires unique references, clear load descriptions, and coordination with protective device schedules for effective planning.',
    section: '5.1.1',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Installation method selection must consider building structure, environmental conditions, access requirements, and future maintenance accessibility.',
    section: '5.2.1',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Test equipment requires regular calibration schedules, certified calibration procedures, and comprehensive maintenance records for accuracy.',
    section: '5.4.1',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'System interactions require advance notification, coordination meetings with affected parties, and regular progress updates.',
    section: '5.5.1',
    difficulty: 'intermediate',
...

  {
    ...
    correctAnswer: 0,
    explanation:
      'Progress photographs should include date stamps, clear location identification, work stage documentation, and evidence of quality workmanship.',
    section: '5.6.1',
    difficulty: 'basic',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Defect management requires formal registers, severity classifications, planned corrective actions, and verification of completion.',
    section: '5.7.1',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Support spacing depends on cable type, installation method, environmental conditions, cable loading, and manufacturer recommendations.',
    section: '5.2.1',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Existing services require comprehensive location surveys, understanding clearance requirements, and established coordination procedures.',
    section: '5.3.1',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Testing and commissioning requires skilled personnel, properly calibrated instruments, coordinated test schedules, and comprehensive documentation systems.',
    section: '5.4.1',
    difficulty: 'advanced',
  ...
  // More advanced questions covering all sections comprehensively...
  {
    ...
    correctAnswer: 1,
    explanation:
      'Data cabling coordination requires maintaining separation distances, planning shared containment systems, and preventing electromagnetic interference.',
    section: '5.5.1',
    difficulty: 'intermediate',
  ...
  // Final questions to reach exactly 250
  {
    ...
    correctAnswer: 2,
    explanation:
      'Documentation strategies must consider full system lifecycle, anticipated technology changes, regulatory updates, and long-term archival requirements.',
    section: '5.7.5',
    difficulty: 'advanced',
...
export function validateQuestionBank(): {
  ...
  expectedSections.forEach((section) => {
    const sectionQuestions = Object.keys(sectionDistribution).filter((s) =>
  ...
  if (basicPercentage < 30 || basicPercentage > 50) {
    issues.push(
      `Basic questions percentage out of range: ${basicPercentage.toFixed(1)}% (recommended: 30-50%)`
    );
  }
  ...
  if (advancedPercentage < 10 || advancedPercentage > 25) {
    issues.push(
      `Advanced questions percentage out of range: ${advancedPercentage.toFixed(1)}% (recommended: 10-25%)`
    );
  }
