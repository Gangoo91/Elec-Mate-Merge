...
export const module7QuestionBank: QuestionBank[] = [
  ...
  },
  {
    ...
    options: ['MCB only', 'RCD (Residual Current Device)', 'Fuse only', 'Isolator switch'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['1 MΩ', '0.5 MΩ', '10 MΩ', '100 Ω'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Once a year', 'Before each use', 'Never', 'Only when they break'],
    correctAnswer: 1,
    explanation:
