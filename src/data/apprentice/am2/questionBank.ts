...
export const am2QuestionBank: AM2Question[] = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'In ring final circuits, line and neutral conductor readings should be similar. Earth conductor readings may be slightly higher due to different conductor size.',
