export const fieldHelpText = {
  ...
  earthingArrangement: {
    content:
      'The system earthing type defines how the installation is earthed relative to the supply.',
  ...
  earthElectrodeResistance: {
    content:
      'Resistance of the earth electrode to general mass of earth. Lower values indicate better earthing.',
    regulation: '542.2',
    example: 'Below 20Ω for TT systems, typically 200Ω maximum',
  },
  mainBondingSize: {
    content:
      'Cross-sectional area of main protective bonding conductors connecting extraneous conductive parts.',
    regulation: '544.1',
  ...
  supplementaryBonding: {
    content:
      'Additional bonding of simultaneously accessible exposed and extraneous conductive parts.',
    regulation: '415.2',
