...
export const legislationSection: SectionData = {
  ...
  content: {
    introduction:
      'This section covers the key legislation, regulations, and standards that govern electrical installation work in the UK.',
    subsections: [
      {
        id: '1.1',
      ...
      },
      {
        ...
        content:
          'Focusing on the legal requirements for electrical systems to prevent danger and ensure safety during installation and maintenance.',
        keyPoints: [
      ...
      },
      {
        ...
        content:
          'Covering the requirements for electrical installations in dwellings to ensure they are safe and comply with national standards.',
        keyPoints: [
      ...
      },
      {
        ...
        content:
          'Studying the IET Wiring Regulations, which set the standards for electrical installation in the UK, ensuring safety and proper functioning.',
        keyPoints: [
      ...
      },
      {
        ...
        content:
          "Utilizing documents such as the IET On-Site Guide and the Electrician's Guide to Good Electrical Practice to apply regulations effectively in practical scenarios.",
        keyPoints: [
      ...
      },
      {
        ...
        content:
          'Identifying the responsibilities of various parties involved in electrical installation, including designers, installers, and inspectors, to ensure compliance with legal and safety standards.',
        keyPoints: [
