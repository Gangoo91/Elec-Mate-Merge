...
export const healthAndSafetyQuizzes: UnitQuiz = {
  ...
  questions: [
    ...
    },
    {
      id: 'hs-q14',
      question:
        'What is the minimum safe distance from overhead power lines when using access equipment?',
      options: ['1 meter', '3 meters', '9 meters', '15 meters'],
      correctAnswer: 2,
    },
    {
      id: 'hs-q15',
      question:
        'What color is used for electrical danger signs according to the Health and Safety (Safety Signs and Signals) Regulations?',
    ...
    },
    {
      id: 'hs-q19',
      question:
        'What is the safe voltage limit for extra-low voltage for reduced risk of electric shock?',
      options: ['110V', '50V', '24V', '12V'],
      correctAnswer: 1,
    },
    {
      id: 'hs-q20',
    ...
    },
    {
      id: 'hs-q32',
      question:
        'What is the maximum weight that should be lifted at waist height according to manual handling guidelines?',
    ...
    },
    {
      id: 'hs-q37',
      question:
        'What is the recommended minimum frequency for PAT testing of power tools on a construction site?',
    ...
    },
    {
      ...
      options: ['Class A', 'Class B', 'Class C', 'Class E'],
      correctAnswer: 3,
    },
    {
      id: 'hs-q45',
    ...
    },
    {
      id: 'hs-q47',
      question:
        'What is the minimum safe distance to maintain from overhead power lines with voltages up to 33kV?',
    ...
    },
    {
      ...
      options: ['DC (0 Hz)', '50-60 Hz', '1,000-5,000 Hz', 'Above 10,000 Hz'],
      correctAnswer: 1,
    },
    {
      id: 'hs-q52',
    ...
    },
    {
      id: 'hs-q53',
      question:
        'What should be the minimum height clearance for overhead cables crossing public roads?',
      options: ['3.5 meters', '5.2 meters', '5.8 meters', '7.3 meters'],
      correctAnswer: 3,
    },
    {
      id: 'hs-q54',
    ...
    },
    {
      ...
      options: ['Mandatory action', 'Warning of hazard', 'Prohibition', 'Safe condition'],
      correctAnswer: 1,
    },
    {
      id: 'hs-q60',
      question:
        'What is the recommended inspection interval for Class I portable appliances in an office environment?',
      options: ['Every month', 'Every 6 months', 'Every 12-24 months', 'Every 5 years'],
      correctAnswer: 2,
    },
    ...
    },
    {
      ...
      options: ['1.5 meters', '3 meters', '6 meters', '9 meters'],
      correctAnswer: 1,
    },
    {
      id: 'hs-q66',
    ...
    },
    {
      id: 'hs-q69',
      question:
        'What is the maximum amount of time that a temporary supply can be used on a construction site according to BS 7671?',
      options: ['30 days', '3 months', '90 days', '12 months'],
      correctAnswer: 2,
    },
    {
      id: 'hs-q70',
    ...
    },
    {
      ...
      options: ['Overcurrent', 'Overvoltage', 'Leakage current to ground', 'Short circuits'],
      correctAnswer: 2,
    },
    {
      id: 'hs-q80',
    ...
    },
    {
      ...
      options: ['20 meters', '30 meters', '45 meters', '60 meters'],
      correctAnswer: 1,
    },
    {
      id: 'hs-q82',
    ...
    },
    {
      id: 'hs-q85',
      question:
        'What is the maximum height at which a properly secured ladder can be used without additional measures?',
      options: ['3 meters', '5 meters', '7 meters', '9 meters'],
      correctAnswer: 2,
    },
    {
      id: 'hs-q86',
    ...
    },
    {
      id: 'hs-q90',
      question:
        'What is the maximum temperature allowed for hot water from taps in healthcare premises?',
    ...
    },
    {
      ...
      options: ['Ionization', 'Optical', 'Heat detector', 'Beam detector'],
      correctAnswer: 2,
    },
    {
      id: 'hs-q94',
    ...
    },
    {
      ...
      options: ['Prohibition', 'Mandatory action', 'Hazard warning', 'Safe condition'],
      correctAnswer: 2,
    },
    {
      id: 'hs-q99',
      question:
        'How often should portable electrical equipment be formally visually inspected in a low-risk environment?',
      options: ['Daily', 'Weekly', 'Monthly', 'Before each use'],
      correctAnswer: 3,
    },
    {
      id: 'hs-q100',
    ...
    },
    {
      ...
      options: ['Water', 'Foam', 'Powder', 'Carbon Dioxide'],
      correctAnswer: 3,
    },
    {
      id: 'hs-q107',
    ...
    },
    {
      id: 'hs-q108',
      question:
        'What is the maximum weight that can be carried before requiring a manual handling assessment?',
      options: ['There is no specific weight limit', '10 kg', '20 kg', '25 kg'],
      correctAnswer: 0,
    },
    {
      id: 'hs-q109',
    ...
    },
    {
      id: 'hs-q126',
      question:
        'What is the maximum noise level that is considered safe for an 8-hour working day?',
    ...
    },
    {
      ...
      options: ['Carbon dioxide', 'Water', 'Dry powder', 'Foam'],
      correctAnswer: 1,
    },
    {
      id: 'hs-q131',
    ...
    },
    {
      id: 'hs-q133',
      question:
        'What is the minimum safe distance that should be maintained from overhead power lines?',
      options: ['1 meter', '3 meters', '9 meters', '15 meters'],
      correctAnswer: 2,
    },
    {
    ...
    },
    {
      id: 'hs-q146',
      question:
        'What is the legal minimum number of trained first aiders required in a low-risk workplace with 25 employees?',
      options: ['None', 'One appointed person', 'Two first aiders', 'Three first aiders'],
      correctAnswer: 1,
    },
    {
      id: 'hs-q147',
    ...
    },
    {
      ...
      options: ['45 degrees', '75 degrees', '90 degrees', '60 degrees'],
      correctAnswer: 1,
    },
    {
      id: 'hs-q149',
    ...
    },
    {
      id: 'hs-q158',
      question:
        'What is the recommended inspection frequency for Class II electrical equipment in a construction environment?',
