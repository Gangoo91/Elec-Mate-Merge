  ...
  sections: {
    safeIsolation: {
      ...
      acceptanceLimits: {
        ...
        'CAT III':
          'Equipment forming part of building wiring (socket-outlets, distribution boards)',
        'CAT IV':
          'Equipment at/near origin (between building entrance and primary distribution board)',
        'Test voltage safety':
          '>50V AC or >120V DC dry, >25V AC or >60V DC wet/damp requires extra precautions',
      },
      references: [
    ...
    pfcTesting: {
      ...
      acceptanceLimits: {
        ...
        'Domestic (consumer unit)':
          'Up to 16 kA - no measurement needed if DNO declares ≤16kA (BS EN 61439-3)',
        'Note Icn vs Ics':
          'Icn = max interrupt (may alter device), Ics = max interrupt without loss of performance',
      },
      references: [
...
export const testEquipmentRequirements = {
  ...
  insulationTester: {
    ...
    features: ['250V, 500V, 1000V DC test voltages', 'Minimum 1mA test current', 'Display in MΩ'],
  },
  loopImpedanceTester: {
