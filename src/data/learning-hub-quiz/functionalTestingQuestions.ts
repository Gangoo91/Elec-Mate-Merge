...
export const functionalTestingQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'By measuring voltage across it',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Allow door to open anytime',
      'Prevent access while equipment is energised',
      'Only lock from outside',
  ...
  },
  {
    ...
    options: [
      ...
      'Only note on certificate',
      'Leave for user to fix',
    ],
    correctAnswer: 1,
    explanation:
