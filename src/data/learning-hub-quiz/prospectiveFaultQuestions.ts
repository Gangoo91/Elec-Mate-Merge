...
export const prospectiveFaultQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'Ics is always higher',
      'Icn is for AC, Ics is for DC',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Adding single-phase values',
      'Dividing L-L fault current by 0.87',
      'Multiplying by 3',
      'Measuring at neutral',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only affects three-phase',
      'Requires RCD addition',
    ],
    correctAnswer: 1,
    explanation:
