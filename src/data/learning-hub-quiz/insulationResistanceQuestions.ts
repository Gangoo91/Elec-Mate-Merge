...
export const insulationResistanceQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['Exactly 1 MΩ', 'Greater than 2 MΩ', 'Greater than 200 MΩ', 'Less than 0.5 MΩ'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['The cable', 'The switch', 'The lampholder or luminaire', 'The junction box'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Leave connected', 'Disconnect or remove', 'Connect to supply', 'Cover with tape'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['500 MΩ', '50 MΩ', '2 MΩ', '5 MΩ or below on new installations'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Open (OFF)', 'Closed (ON)', 'Removed completely', 'Either position'],
    correctAnswer: 1,
    explanation:
