...
export const UK_JOB_TITLES: JobTitle[] = [
  ...
  { value: 'design_engineer', label: 'Design Engineer', category: 'Engineering' },
  {
    ...
    label: 'Testing & Commissioning Engineer',
...
export const UK_QUALIFICATIONS: Record<string, QualificationCategory> = {
  core: {
    ...
    items: [
      ...
      {
        value: 'nvq_level_2',
        label: 'NVQ Level 2 Electrical Installation',
        awarding: 'City & Guilds',
      },
      {
        value: 'nvq_level_3',
        label: 'NVQ Level 3 Electrical Installation',
        awarding: 'City & Guilds',
      },
      ...
      {
        value: 'cg_2330_l2',
        label: 'City & Guilds 2330 Level 2 Theory',
        awarding: 'City & Guilds',
      },
      {
        value: 'cg_2330_l3',
        label: 'City & Guilds 2330 Level 3 Theory',
        awarding: 'City & Guilds',
      },
      {
        value: 'cg_5357_l2',
        label: 'City & Guilds 5357 Level 2 Diploma',
        awarding: 'City & Guilds',
      },
      {
        value: 'cg_5357_l3',
        label: 'City & Guilds 5357 Level 3 Diploma',
        awarding: 'City & Guilds',
      },
      // Assessment
      ...
      {
        value: 'eal_level_2',
        label: 'EAL Level 2 Diploma in Electrical Installation',
        awarding: 'EAL',
      },
      {
        value: 'eal_level_2_et',
        label: 'EAL Level 2 Certificate in Electrotechnical Technology',
        awarding: 'EAL',
      },
      {
        value: 'eal_level_3_et',
        label: 'EAL Level 3 Certificate in Electrotechnical Technology',
        awarding: 'EAL',
      },
      {
        value: 'eal_level_3_diploma',
        label: 'EAL Level 3 Diploma in Electrical Installation',
        awarding: 'EAL',
      },
      {
        value: 'eal_domestic',
        label: 'EAL Level 2 Award in Domestic Electrical Installation',
        awarding: 'EAL',
      },
      // Other
      {
        value: 'btec_level_3',
        label: 'BTEC Level 3 National Diploma in Electrical Installation',
        awarding: 'Pearson',
      },
      {
        value: 'hnd_electrical',
        label: 'HND Electrical & Electronic Engineering',
        awarding: 'Various',
      },
      {
        value: 'degree_electrical',
        label: 'BSc/BEng Electrical Engineering',
        awarding: 'University',
      },
    ],
  },
  testing: {
    ...
    items: [
      ...
      {
        value: '2391_52',
        label: '2391-52 Initial & Periodic Inspection',
        awarding: 'City & Guilds',
      },
      { value: '2391_51', label: '2391-51 Periodic Inspection & Testing', awarding: 'City & Guilds' },
      { value: '2394', label: '2394 Initial Verification (withdrawn)', awarding: 'City & Guilds' },
      { value: '2395', label: '2395 Periodic Inspection (withdrawn)', awarding: 'City & Guilds' },
      { value: '2391_50', label: '2391-50 Initial Verification', awarding: 'City & Guilds' },
      // PAT
      ...
      // EAL
      {
        value: 'eal_inspection_testing',
        label: 'EAL Level 3 Certificate in Inspection, Testing & Certification',
        awarding: 'EAL',
      },
      {
        value: 'eal_initial_verification',
        label: 'EAL Level 3 Award in Initial Verification',
        awarding: 'EAL',
      },
      {
        value: 'eal_periodic_testing',
        label: 'EAL Level 3 Award in Periodic Inspection & Testing',
        awarding: 'EAL',
      },
      // Specialist Testing
      {
        value: 'thermal_imaging',
        label: 'Thermal Imaging Level 1',
        awarding: 'Various',
        hasExpiry: true,
        expiryYears: 3,
      },
      {
        value: 'thermal_imaging_l2',
        label: 'Thermal Imaging Level 2',
        awarding: 'Various',
        hasExpiry: true,
        expiryYears: 3,
      },
  ...
  regulations: {
    ...
    items: [
      ...
      {
        value: '18th_edition',
        label: '18th Edition (BS 7671:2018+A2:2022)',
        awarding: 'City & Guilds',
        hasExpiry: true,
        expiryYears: 5,
      },
      {
        value: 'cg_2382_22',
        label: 'City & Guilds 2382-22 (18th Edition)',
        awarding: 'City & Guilds',
        hasExpiry: true,
        expiryYears: 5,
      },
      {
        value: 'eal_18th_edition',
        label: 'EAL Level 3 Award in BS 7671:2018+A2:2022',
        awarding: 'EAL',
        hasExpiry: true,
        expiryYears: 5,
      },
      ...
      {
        value: 'cg_2396',
        label: 'City & Guilds 2396 Design & Verification',
        awarding: 'City & Guilds',
      },
      {
        value: 'eal_design_verification',
        label: 'EAL Level 4 Award in Design & Verification',
        awarding: 'EAL',
      },
    ],
  },
  cards: {
    ...
    items: [
      ...
      {
        value: 'ecs_gold',
        label: 'ECS Gold Card (Approved Electrician)',
        awarding: 'JIB/ECS',
        hasExpiry: true,
        expiryYears: 5,
      },
      {
        value: 'ecs_blue',
        label: 'ECS Blue Card (Electrician)',
        awarding: 'JIB/ECS',
        hasExpiry: true,
        expiryYears: 5,
      },
      {
        value: 'ecs_yellow',
        label: 'ECS Yellow Card (Apprentice)',
        awarding: 'JIB/ECS',
        hasExpiry: true,
        expiryYears: 3,
      },
      {
        value: 'ecs_white',
        label: 'ECS White Card (Electrical Labourer)',
        awarding: 'JIB/ECS',
        hasExpiry: true,
        expiryYears: 3,
      },
      {
        value: 'ecs_green',
        label: "ECS Green Card (Electrician's Mate)",
        awarding: 'JIB/ECS',
        hasExpiry: true,
        expiryYears: 3,
      },
      {
        value: 'ecs_black',
        label: 'ECS Black Card (Manager/Supervisor)',
        awarding: 'JIB/ECS',
        hasExpiry: true,
        expiryYears: 5,
      },
      {
        value: 'ecs_red',
        label: 'ECS Red Card (Experienced Worker)',
        awarding: 'JIB/ECS',
        hasExpiry: true,
        expiryYears: 3,
      },
  ...
  specialist: {
    ...
    items: [
      ...
      {
        value: 'asbestos',
        label: 'Asbestos Awareness (Cat A)',
        awarding: 'Various',
        hasExpiry: true,
        expiryYears: 1,
      },
      {
        value: 'asbestos_cat_b',
        label: 'Asbestos Cat B (Non-Licensed)',
        awarding: 'Various',
        hasExpiry: true,
        expiryYears: 1,
      },
      ...
      {
        value: 'confined_spaces',
        label: 'Confined Spaces Entry',
        awarding: 'Various',
        hasExpiry: true,
        expiryYears: 3,
      },
      {
        value: 'confined_spaces_rescue',
        label: 'Confined Spaces Rescue',
        awarding: 'Various',
        hasExpiry: true,
        expiryYears: 3,
      },
      ...
      {
        value: 'smsts',
        label: 'SMSTS (Site Management Safety)',
        awarding: 'CITB',
        hasExpiry: true,
        expiryYears: 5,
      },
      {
        value: 'sssts',
        label: 'SSSTS (Site Supervisor Safety)',
        awarding: 'CITB',
        hasExpiry: true,
        expiryYears: 5,
      },
      {
        value: 'health_safety_env',
        label: 'Health, Safety & Environment Test',
        awarding: 'CITB',
        hasExpiry: true,
        expiryYears: 2,
      },
  ...
  renewable: {
    ...
    items: [
      ...
      {
        value: 'ev_charging',
        label: 'EV Charging Equipment Installation',
        awarding: 'City & Guilds/IMI',
      },
      { value: 'ev_2919', label: 'City & Guilds 2919 EV Charging', awarding: 'City & Guilds' },
      {
        value: 'eal_ev_charging',
        label: 'EAL Level 3 Award in EV Charging Installation',
        awarding: 'EAL',
      },
      ...
      {
        value: 'bess_domestic',
        label: 'Domestic Battery Storage Installation',
        awarding: 'Various',
      },
      ...
      // Smart Home
      {
        value: 'eal_smart_home',
        label: 'EAL Level 3 Award in Smart Home Technology',
        awarding: 'EAL',
      },
      {
        value: 'smart_home_systems',
        label: 'Smart Home Systems Installation',
        awarding: 'Various',
      },
    ],
  },
  fire_security: {
    ...
    items: [
      ...
      {
        value: 'fia_foundation',
        label: 'FIA Foundation in Fire Detection & Alarm',
        awarding: 'FIA',
      },
      ...
      {
        value: 'emergency_lighting_design',
        label: 'Emergency Lighting Design (BS 5266)',
        awarding: 'Various',
      },
      // Security
  ...
  data_comms: {
    ...
    items: [
      ...
      {
        value: 'fibre_termination',
        label: 'Fibre Optic Termination & Splicing',
        awarding: 'Various',
      },
      {
        value: 'network_testing',
        label: 'Network Cable Testing & Certification',
        awarding: 'Fluke/Various',
      },
  ...
  industrial: {
    ...
    items: [
      ...
      {
        value: 'high_voltage',
        label: 'High Voltage Switching (HV Authorised)',
        awarding: 'Various',
        hasExpiry: true,
        expiryYears: 3,
      },
...
export const LEGACY_ECS_CARD_TYPES: ECSCardType[] = [
  // ECS Cards
  {
    ...
    label: 'ECS Gold Card',
    color: '#FFD700',
    description: 'Fully qualified with NVQ L3 and AM2',
    category: 'ECS',
  },
  {
    value: 'blue',
  ...
  {
    value: 'yellow',
    label: 'ECS Yellow Card',
    color: '#FFD93D',
    description: 'Apprentice or trainee',
    category: 'ECS',
  },
  {
    value: 'white',
    label: 'ECS White Card',
    color: '#F5F5F5',
    description: 'Electrical labourer',
    category: 'ECS',
  },
  {
    value: 'green',
    label: 'ECS Green Card',
    color: '#228B22',
    description: 'Electricians mate',
    category: 'ECS',
  },
  {
    value: 'black',
    label: 'ECS Black Card',
    color: '#1A1A1A',
    description: 'Manager or supervisor',
    category: 'ECS',
  },
  {
    value: 'red',
    label: 'ECS Red Card',
    color: '#DC143C',
    description: 'Experienced without formal quals',
    category: 'ECS',
  },
  // CSCS Cards (Construction Skills Certification Scheme)
  {
    ...
    label: 'CSCS Green Card',
    color: '#00A651',
    description: 'Construction Site Operative',
    category: 'CSCS',
  },
  {
    value: 'cscs_blue',
  ...
  },
  {
    ...
    label: 'CSCS Gold Card',
    color: '#D4AF37',
    description: 'Supervisory or Management',
    category: 'CSCS',
  },
  ...
  },
  {
    ...
    color: '#E31837',
    description: 'NAPIT approved contractor',
    category: 'Scheme',
  },
  {
    value: 'elecsa',
    ...
    color: '#1E3A8A',
    description: 'ELECSA approved contractor',
    category: 'Scheme',
  },
  {
    value: 'stroma',
...
export const SKILL_LEVELS = [
  {
    value: 'beginner',
    label: 'Beginner',
    description: 'Learning the basics, requires supervision',
    icon: 'seedling',
  },
  {
    value: 'intermediate',
    label: 'Intermediate',
    description: 'Works independently on standard tasks',
    icon: 'sprout',
  },
  {
    value: 'advanced',
    label: 'Advanced',
    description: 'Handles complex work, can mentor others',
    icon: 'tree',
  },
  {
    value: 'expert',
    label: 'Expert',
    description: 'Industry leader, specialist knowledge',
    icon: 'crown',
  },
] as const;
