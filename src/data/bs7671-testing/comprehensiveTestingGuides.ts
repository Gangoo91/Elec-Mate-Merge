...
export const comprehensiveTestingGuides: EnhancedTestGuide[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Switch off the circuit at the distribution board and remove fuses or lock off MCBs',
        safetyWarnings: [
      ...
      },
      {
        ...
        description:
          'Lock off the circuit using appropriate lockout devices and apply warning notices',
        safetyWarnings: [
      ...
      },
      {
        ...
        description:
          'Test between all live conductors and between live conductors and earth using a suitable voltage indicator',
        safetyWarnings: [
      ...
      },
      {
        ...
        description:
          "Test the voltage indicator on a known live source to ensure it's functioning correctly",
        safetyWarnings: [
  ...
  },
  {
    ...
    description:
      'Test the continuity of protective conductors including earth and bonding conductors',
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Test continuity from main earth terminal to each circuit's protective conductor",
        safetyWarnings: ['Test each circuit systematically', 'Record all readings accurately'],
    ...
    steps: [
      {
        ...
        description:
          'At the consumer unit, identify and separate the two ends of the ring final circuit',
        safetyWarnings: [
          'Ensure circuit is isolated and proven dead',
      ...
      },
      {
        ...
        description:
          'Test continuity between the ring ends for line, neutral, and earth conductors',
        safetyWarnings: [
      ...
      },
      {
        ...
        description:
          'Connect line of leg 1 to neutral of leg 2, and neutral of leg 1 to line of leg 2',
        safetyWarnings: [
    ...
    steps: [
      {
        ...
        description:
          'Remove or isolate all electronic equipment, lamps, and surge protection devices',
        safetyWarnings: [
      ...
      },
      {
        ...
        description:
          'Connect test leads between line and neutral conductors and perform 500V insulation test',
        safetyWarnings: [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Connect RCD tester leads to line, neutral, and earth at appropriate test points',
        safetyWarnings: [
...
export const getEnhancedTestGuidesByDifficulty = (
  difficulty: 'Beginner' | 'Intermediate' | 'Advanced'
): EnhancedTestGuide[] => {
