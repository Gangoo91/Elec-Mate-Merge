    ...
    steps: [
      {
        ...
        title: 'Test Setup',
        instruction:
          'Set MFT to continuity/low resistance mode. Connect test leads to the protective conductor at the distribution board and at the furthest point of the circuit.',
      ...
      },
      {
        ...
        instruction:
          'Press the test button on the MFT to measure the resistance of the protective conductor.',
        expectedResult: 'Reading should be less than 1.67 times the line conductor resistance',
        tips: ['Record the reading accurately', 'If reading is high, check connections'],
      ...
      },
      {
        ...
        instruction:
          'Document the measured value on the test certificate and compare with acceptable limits.',
        expectedResult: 'All readings within acceptable limits and properly documented',
        tips: ['Use appropriate test certificate format', 'Include circuit reference and reading'],
    ...
    steps: [
      {
        ...
        instruction:
          'At the distribution board, identify the two ends of the ring circuit (line, neutral, and earth conductors).',
        ...
        tips: ['Use a continuity tester to confirm circuit ends', 'Label the conductors clearly'],
      ...
      },
      {
        ...
        tips: ['Record all three readings', 'Readings should be similar for line and neutral'],
      ...
      },
      {
        ...
        instruction:
          'Connect line of leg 1 to neutral of leg 2, and neutral of leg 1 to line of leg 2. Test between line and neutral at each socket outlet.',
      ...
      },
      {
        ...
        instruction:
          'Reconnect conductors normally and measure R1+R2 at the furthest point from the board.',
        expectedResult: 'R1+R2 reading should be approximately 1/4 of the end-to-end readings',
        tips: ['This confirms the ring integrity', 'Record this value for Zs calculations'],
        equipment: ['Multifunction Tester', 'Test leads'],
      },
    ],
  },
    ...
    steps: [
      {
        ...
        instruction:
          'Remove or isolate all electronic equipment, fluorescent fittings, and surge protection devices. Set MFT to insulation resistance mode (500V DC for circuits up to 500V).',
      ...
      },
      {
        ...
        instruction:
          'Connect test leads between phase and neutral conductors. Press and hold the test button for the full test duration.',
      ...
      },
      {
        ...
        instruction:
          'Connect test leads between phase conductor and earth. Perform insulation resistance test.',
      ...
      },
      {
        ...
        instruction:
          'Connect test leads between neutral conductor and earth. Perform final insulation resistance test.',
        expectedResult: 'Minimum 1MΩ for circuits up to 500V',
        tips: [
    ...
    steps: [
      {
        ...
        instruction:
          'Visually inspect RCD for damage. Press the push button test to verify mechanical operation.',
      ...
      },
      {
        ...
        title: 'RCD Ramp Test',
        instruction:
          'Using RCD tester, perform ramp test to determine actual trip current (should be between 50% and 100% of rated current).',
      ...
      },
      {
        ...
        tips: ['Test at 0° and 180° phase angles', 'Record the longer of the two readings'],
        equipment: ['RCD Tester', 'Test leads'],
      },
      {
        id: 'trip-time-5x',
...
export const getTestGuidesByDifficulty = (
  difficulty: 'Beginner' | 'Intermediate' | 'Advanced'
): TestGuide[] => {
