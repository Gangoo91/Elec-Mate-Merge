...
export const SOLAR_INVERTERS: SolarInverter[] = [
...

  {
    id: 'sunsynk-3.6k',
    make: 'Sunsynk',
    model: 'ECCO 3.6kW Hybrid',
    type: 'hybrid' as InverterType,
    ratedPowerAc: 3.6,
    ratedPowerDc: 5.0,
    phases: 'single' as PhaseType,
    mpptCount: 2,
    mpptVoltageMin: 90,
    mpptVoltageMax: 450,
    maxInputVoltage: 500,
    ...
    maxOutputCurrent: 16.0,
    efficiency: 97.6,
    dimensions: { width: 460, height: 610, depth: 190 },
    weight: 24.0,
    ipRating: 'IP65',
    warranty: 10,
    mcsCertified: true,
    ...
    wifi: true,
    ethernet: false,
    monitoring: 'SunsynkConnect',
    yearIntroduced: 2024,
    notes: 'Popular UK hybrid. Built-in EPS for backup.',
  },
  {
    id: 'sunsynk-5k',
    make: 'Sunsynk',
    model: 'ECCO 5kW Hybrid',
    type: 'hybrid' as InverterType,
    ratedPowerAc: 5.0,
    ratedPowerDc: 6.5,
    phases: 'single' as PhaseType,
    ...
    monitoring: 'SunsynkConnect',
    yearIntroduced: 2024,
    notes: 'Best-selling UK hybrid inverter. Dual MPPT.',
  },
  {
    id: 'sunsynk-8k',
    make: 'Sunsynk',
    model: 'ECCO 8kW Hybrid',
    type: 'hybrid' as InverterType,
    ratedPowerAc: 8.0,
    ratedPowerDc: 10.4,
    phases: 'single' as PhaseType,
    ...
    maxInputVoltage: 500,
    maxInputCurrent: 16.0,
    maxOutputCurrent: 35.0,
    efficiency: 97.8,
    dimensions: { width: 510, height: 660, depth: 210 },
    weight: 30.0,
    ipRating: 'IP65',
    warranty: 10,
    mcsCertified: true,
    ...
    monitoring: 'SunsynkConnect',
    yearIntroduced: 2025,
    notes: '8kW single-phase hybrid with EPS.',
  },
...

  {
    ...
    maxOutputCurrent: 16.0,
    efficiency: 97.5,
    dimensions: { width: 460, height: 560, depth: 178 },
    weight: 21.0,
    ipRating: 'IP65',
    warranty: 10,
    mcsCertified: true,
    ...
    monitoring: 'SolarMAN',
    yearIntroduced: 2024,
    notes: 'EP series with emergency power supply.',
  },
  {
    id: 'sofar-hyd-5000',
    make: 'Sofar',
    ...
    monitoring: 'SolarMAN',
    yearIntroduced: 2024,
    notes: '5kW hybrid with dual MPPT and EPS.',
  },
  {
    id: 'sofar-me3000sp',
    make: 'Sofar',
    ...
    maxOutputCurrent: 14.0,
    efficiency: 97.0,
    dimensions: { width: 400, height: 500, depth: 170 },
    weight: 18.0,
    ipRating: 'IP65',
    warranty: 10,
    mcsCertified: true,
    ...
    monitoring: 'SolarMAN',
    yearIntroduced: 2023,
    notes: 'AC-coupled battery inverter. Retrofit-friendly.',
  },
  ...
  {
    id: 'luxpower-lxp-3.6k',
    make: 'Lux Power',
    model: 'LXP-LB-US 3.6K',
    type: 'hybrid' as InverterType,
    ratedPowerAc: 3.6,
    ratedPowerDc: 5.0,
    phases: 'single' as PhaseType,
    ...
    maxOutputCurrent: 16.0,
    efficiency: 97.3,
    dimensions: { width: 440, height: 590, depth: 185 },
    weight: 23.0,
    ipRating: 'IP65',
    warranty: 10,
    mcsCertified: true,
    ...
    wifi: true,
    ethernet: false,
    monitoring: 'LuxPowerTek',
    yearIntroduced: 2024,
    notes: 'Popular with UK installers. Dual MPPT hybrid.',
  },
  {
    id: 'luxpower-lxp-5k',
    make: 'Lux Power',
    ...
    monitoring: 'LuxPowerTek',
    yearIntroduced: 2024,
    notes: '5kW hybrid. Good installer support in UK.',
  },
...

  {
    ...
    maxOutputCurrent: 16.0,
    efficiency: 97.2,
    dimensions: { width: 345, height: 437, depth: 145 },
    weight: 12.0,
    ipRating: 'IP65',
    warranty: 10,
    mcsCertified: true,
    ...
    yearIntroduced: 2024,
    notes: 'Compact single-MPPT string inverter.',
  },
  {
    id: 'goodwe-gw5000',
    make: 'Goodwe',
    ...
    maxOutputCurrent: 22.0,
    efficiency: 97.6,
    dimensions: { width: 475, height: 555, depth: 186 },
    weight: 24.5,
    ipRating: 'IP65',
    warranty: 10,
    mcsCertified: true,
    ...
    monitoring: 'SEMS Portal',
    yearIntroduced: 2025,
    notes: 'EH series hybrid. Compatible with Goodwe Lynx battery.',
  },
...

  {
    ...
    maxOutputCurrent: 16.0,
    efficiency: 97.4,
    dimensions: { width: 385, height: 451, depth: 158 },
    weight: 13.5,
    ipRating: 'IP65',
    warranty: 10,
    mcsCertified: true,
    ...
    monitoring: 'eSolar',
    yearIntroduced: 2024,
    notes: 'Budget-friendly dual MPPT string inverter.',
  },
  {
    id: 'saj-h2-5k',
    make: 'SAJ',
    ...
    maxOutputCurrent: 22.0,
    efficiency: 97.5,
    dimensions: { width: 470, height: 560, depth: 190 },
    weight: 23.0,
    ipRating: 'IP65',
    warranty: 10,
    mcsCertified: true,
    ...
    monitoring: 'eSolar',
    yearIntroduced: 2025,
    notes: 'H2 hybrid series. Growing UK market share.',
  },
];
