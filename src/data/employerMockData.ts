...
export const jobs = [
  ...
  },
  {
    ...
    client: 'JCB Ltd',
    location: 'Stoke-on-Trent, ST4 2RU',
    status: 'Active',
    progress: 80,
...
export const certifications = [
  ...
  },
  {
    ...
    daysRemaining: 45,
    issuer: 'JIB',
    certNumber: 'ECS-GC-2022-456',
  },
  {
    id: '3',
    name: 'Part P Certification',
...
export const safetyIncidents = [
  {
    id: '1',
    type: 'Near Miss',
    description: 'Loose cable near walkway',
    location: 'Tesco Express, Manchester',
    date: '2024-02-10',
  ...
  },
  {
    id: '2',
    type: 'Minor Injury',
    description: 'Small cut while stripping wire',
    location: 'Barratt Homes, Leeds',
    date: '2024-02-08',
  ...
  },
  {
    ...
    description: 'Drill overheating',
    location: 'WeWork, Birmingham',
    date: '2024-02-05',
...
export const rams = [
  ...
  {
    id: '2',
    project: 'New Build Installation',
    version: '1.0',
  ...
  {
    id: '3',
    project: 'Office Lighting Upgrade',
    version: '1.2',
...
export const quotes = [
  {
    id: 'Q-2024-001',
    client: 'Costa Coffee',
    description: 'New store electrical fit-out',
    value: 32000,
    status: 'Sent',
    sentDate: '2024-02-10',
  ...
  },
  {
    id: 'Q-2024-003',
    client: 'Holiday Inn',
    description: 'Full rewire - 3 floors',
    value: 95000,
    status: 'Draft',
    sentDate: null,
    validUntil: null,
  },
  {
    id: 'Q-2024-004',
    client: 'Greggs',
    description: 'Kitchen electrical installation',
    value: 8500,
    status: 'Rejected',
    sentDate: '2024-01-20',
...
export const tenders = [
  {
    id: 'T-2024-001',
    title: 'Manchester Airport Terminal Upgrade',
  ...
  {
    id: 'T-2024-002',
    title: 'NHS Hospital Wing Electrical',
    client: 'NHS Trust',
    value: 280000,
    deadline: '2024-03-01',
    status: 'Open',
  ...
  {
    id: 'T-2024-004',
    title: 'Shopping Centre Refurbishment',
    client: 'Trafford Centre',
    value: 350000,
    deadline: '2024-02-10',
    status: 'Won',
    category: 'Retail',
  ...
  {
    id: 'T-2024-005',
    title: 'Council Housing Electrical Upgrades',
...
export const hrDocuments = [
  ...
  {
    id: '3',
    name: 'Annual Leave Request Form',
    category: 'Form',
...
export const elecIdProfiles: ElecIdProfile[] = [
  {
    ...
    workHistory: [
      {
        ...
        isCurrent: true,
        description:
          'Leading commercial electrical projects including EV charging networks and solar installations. Supervising team of 4 electricians.',
        projects: [
          'Tesco Express Rewiring',
          'NCP EV Charging Network',
      ...
      },
      {
        ...
        isCurrent: false,
        description:
          'Commercial and industrial electrical installations. Progressed from electrician to team lead.',
      ...
      },
      {
        ...
        isCurrent: false,
        description:
          'Completed apprenticeship and worked on domestic and small commercial projects.',
        projects: [],
    ...
    certifications: [
      ...
      {
        name: 'Part P Domestic Installer',
        issuer: 'NICEIC',
        certNumber: 'PP-2021-456',
    ...
    training: [
      {
        ...
        certificateId: 'EV-2023-001',
        fundedBy: 'Elec-Mate Ltd',
        ownedBy: 'worker',
        verified: true,
      },
      {
  ...
  },
  {
    ...
    certifications: [
      {
        name: 'ECS Apprentice Card',
        issuer: 'JIB',
        certNumber: 'ECS-AP-2023-789',
    ...
    training: [],
    qualifications: [{ name: 'City & Guilds 2365 Level 2', issuer: 'City & Guilds', year: '2023' }],
    verified: true,
    ...
    workHistory: [
      {
        ...
        projects: [
          'Factory Maintenance - JCB',
          'WeWork Lighting Upgrade',
      ...
      },
      {
        ...
        isCurrent: false,
        description:
          'Commercial and industrial electrical installations with team lead responsibilities.',
    ...
    workHistory: [
      {
        ...
        isCurrent: true,
        description:
          'Domestic and commercial electrical work with focus on smart home installations.',
  ...
  },
  {
    ...
    workHistory: [
      {
        ...
        isCurrent: true,
        description:
          'Managing multiple commercial electrical projects with teams of up to 15 electricians.',
        projects: [
          'Trafford Centre Refurbishment',
    ...
    certifications: [
      ...
      {
        name: 'ECS Supervisor Card',
        issuer: 'JIB',
        certNumber: 'ECS-SC-2020-678',
        issueDate: '2020-07-22',
...
export const toolboxTalks = [
  ...
  {
    id: 'TBT-004',
    title: 'Cable Handling and Manual Handling',
    date: '2024-02-05',
    presenter: 'James Wilson',
    attendees: ['2', '3', '5'],
    job: 'New Build Installation',
    signed: true,
  },
];
...
export const regAlerts = [
  {
    id: 'RA-001',
    title: 'BS 7671 Amendment 2 Coming Soon',
    description:
      'Amendment 2 to BS 7671:2018+A2:2022 includes updates to Chapter 41 and Section 722.',
    date: '2024-02-15',
    priority: 'High',
    status: 'Unread',
  },
  {
    id: 'RA-002',
    title: 'Part P Competent Person Scheme Update',
    description: 'New requirements for CPD hours from April 2024.',
    date: '2024-02-10',
    priority: 'Medium',
    status: 'Read',
  },
  {
    id: 'RA-003',
    title: 'EV Charging Regulations Update',
    description: 'Changes to IET Code of Practice for EV Charging Equipment Installation.',
    date: '2024-02-01',
    priority: 'Medium',
    status: 'Read',
  },
...
export const communications = [
  {
    id: 'COMM-001',
    type: 'Job Message',
    title: 'Materials delivery update',
    message: 'Cable delivery confirmed for tomorrow 8am at Tesco site.',
    sender: 'Lisa Parker',
    recipients: ['1', '2', '5'],
    job: 'Commercial Rewiring',
    date: '2024-02-13',
  ...
  },
  {
    ...
    message: 'Met Office amber warning for high winds. Review working at height activities.',
    sender: 'System',
  ...
  },
  {
    ...
    message: 'Reminder: Monthly safety meeting this Friday at 08:00 in the office.',
    sender: 'Lisa Parker',
    recipients: ['1', '2', '3', '4', '5', '6'],
    job: null,
    date: '2024-02-12',
  ...
  },
  {
    ...
    title: 'Updated Risk Assessment Procedure',
    message: 'Please review and sign off the updated risk assessment procedure by Friday.',
    sender: 'Lisa Parker',
    recipients: ['1', '2', '3', '4', '5', '6'],
    job: null,
    date: '2024-02-11',
  ...
  },
  {
    ...
    message: 'Site meeting with Barratt Homes PM confirmed for Thursday 10am.',
    sender: 'Lisa Parker',
    recipients: ['1', '4', '6'],
    job: 'New Build Installation',
    date: '2024-02-13',
...
export const snagLists = [
  {
    ...
    items: [
      {
        id: '1',
        description: 'Charging post 3 - cable tray not level',
        photo: null,
        status: 'Resolved',
      ...
      {
        id: '2',
        description: 'Signage missing on bays 5-8',
        photo: null,
        status: 'Resolved',
  ...
  },
  {
    ...
    items: [
      {
        id: '1',
        description: 'Socket faceplate in storeroom scratched',
        photo: null,
        status: 'Open',
        resolvedBy: null,
        resolvedDate: null,
      ...
      {
        id: '2',
        description: 'Light fitting in office 3 not aligned',
        photo: null,
        status: 'Resolved',
      ...
      {
        id: '3',
        description: 'Cable containment cover loose in corridor',
        photo: null,
        status: 'Open',
        resolvedBy: null,
        resolvedDate: null,
...
export const permissionsList = [
  ...
  { id: 'sign_off', name: 'Sign Off Work', description: 'Can sign off completed work' },
  {
    ...
    description: 'Can view and manage quotes and invoices',
  },
];
...
export const progressLogs = [
  {
    ...
    workCompleted: [
      'First fix wiring - storeroom',
      'First fix wiring - office 1-3',
      'Cable testing',
    ],
    materialsUsed: [
  ...
  },
  {
    ...
    workCompleted: [
      'DB inspection - Main building',
      'MCB replacements',
      'RCD testing',
      'Thermal imaging',
    ],
    materialsUsed: [{ item: '32A Type B MCB', quantity: '2', cost: 24 }],
...
export const jobIssues = [
  {
    ...
    description:
      'UKPN have pushed back supply upgrade by 1 week. Currently scheduled for 21st Feb.',
    status: 'Open',
    resolution: null,
    resolvedBy: null,
    resolvedDate: null,
  ...
  },
  {
    ...
    description:
      'Thermal imaging detected hot spot on main incomer terminals in DB3. Requires immediate investigation and potential rewire of incomer.',
    status: 'In Progress',
    resolution: null,
    resolvedBy: null,
    resolvedDate: null,
  ...
  },
  {
    ...
    description:
      'Scaffolding team still working on Plot 7 external. Cannot access for first fix until they clear.',
    status: 'Resolved',
  ...
  },
  {
    ...
    description:
      'Client has requested 4 additional double sockets in the break room. Need variation order approval.',
    status: 'Resolved',
...
export const jobFinancials = [
  {
    ...
    variationOrders: [
      {
        id: 'VO-001',
        description: 'Additional sockets - break room',
        value: 320,
        status: 'Approved',
        date: '2024-02-12',
      },
  ...
  },
  {
    ...
    variationOrders: [
      {
        id: 'VO-002',
        description: 'MCB replacements - emergency',
        value: 120,
        status: 'Approved',
        date: '2024-02-14',
      },
...
export const workerCheckIns = [
  ...
  },
  {
    ...
    date: '2024-02-14',
    checkInTime: '08:05',
    checkInLocation: { lat: 53.481, lng: -2.243, accuracy: 8 },
    checkOutTime: null,
    checkOutLocation: null,
    status: 'On Site',
    travelTime: 35,
  ...
  },
  {
    ...
    date: '2024-02-14',
    checkInTime: '08:30',
    checkInLocation: { lat: 53.475, lng: -2.25, accuracy: 5 },
    checkOutTime: null,
    checkOutLocation: null,
    status: 'Office',
    travelTime: 0,
    ...
    stages: [
      {
        ...
        notes: 'All visual checks passed',
      },
      {
        name: 'Dead Testing',
        status: 'Complete',
        ...
        notes: 'Continuity and insulation resistance satisfactory',
      },
      {
        name: 'Live Testing',
        status: 'In Progress',
  ...
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        completedBy: '2',
        completedDate: '2024-01-18',
        notes: 'All values within limits',
      },
      {
        name: 'Live Testing',
        status: 'Complete',
        ...
        notes: 'EV units tested and operational',
      },
      {
        name: 'Documentation',
        status: 'Complete',
...
export const suppliers = [
  {
    ...
    category: 'Wholesaler',
    accountNumber: 'EDM-12345',
    creditLimit: 15000,
    balance: 3240,
    contactName: 'Dave Roberts',
    phone: '0161 234 5678',
    email: 'droberts@edmundson.co.uk',
    deliveryDays: 1,
    discount: 25,
  },
  {
    ...
    name: 'CEF',
    category: 'Wholesaler',
    accountNumber: 'CEF-67890',
    creditLimit: 10000,
    balance: 1850,
    contactName: 'Karen Smith',
    phone: '0161 345 6789',
    email: 'ksmith@cef.co.uk',
    deliveryDays: 1,
    discount: 22,
  },
  {
  ...
  },
  {
    ...
    accountNumber: 'SCH-22222',
    creditLimit: 20000,
    balance: 0,
    contactName: 'Technical Sales',
    phone: '0845 678 901',
    email: 'sales@se.com',
    deliveryDays: 3,
    discount: 30,
  },
  {
    ...
    name: 'Toolstation',
    category: 'Retail',
    accountNumber: 'TLS-33333',
    creditLimit: 2500,
    balance: 125,
    contactName: 'Account Team',
    phone: '0808 100 7211',
    email: 'accounts@toolstation.com',
    deliveryDays: 0,
    discount: 5,
  },
];
...
export const materialOrders = [
  {
    ...
    jobTitle: 'Commercial Rewiring',
    items: [
      { name: 'Consumer Unit 18-way', qty: 2, price: 185 },
      { name: 'Twin & Earth 2.5mm 100m', qty: 10, price: 65 },
    ],
    total: 1020,
    status: 'Delivered',
    orderDate: '2024-02-10',
    deliveryDate: '2024-02-11',
    orderedBy: 'Lisa Parker',
  },
  {
    id: 'ORD-002',
    supplierId: 'SUP-002',
    ...
    jobTitle: 'New Build Installation',
    items: [
      { name: 'Back boxes', qty: 200, price: 0.85 },
      { name: 'White sockets', qty: 150, price: 2.5 },
    ],
    total: 545,
    status: 'In Transit',
  ...
  },
  {
    ...
    jobId: '1',
    jobTitle: 'Commercial Rewiring',
    items: [{ name: 'Distribution Board 100A', qty: 1, price: 650 }],
    total: 650,
    status: 'Processing',
  ...
  },
  {
    ...
    jobTitle: 'Stock',
    items: [
      { name: 'Cable clips mixed', qty: 5, price: 8.99 },
      { name: 'Drill bits HSS set', qty: 2, price: 24.99 },
    ],
    total: 94.93,
    status: 'Delivered',
...
export const companyTools = [
  ...
  },
  {
    ...
    name: 'Megger MFT1741',
    category: 'Testing',
    serialNumber: 'MG-87654321',
    purchaseDate: '2021-03-10',
    purchasePrice: 1650,
    assignedTo: 'Emma Thompson',
    assignedToId: '4',
    status: 'On Leave',
    lastCalibration: '2023-11-15',
  ...
  {
    id: 'TOOL-003',
    name: 'DeWalt DCK266P2T',
    category: 'Power Tools',
    serialNumber: 'DW-11223344',
  ...
  {
    id: 'TOOL-006',
    name: 'SDS Drill Makita',
    category: 'Power Tools',
    serialNumber: 'MK-55667788',
...
export const expenseClaims = [
  {
    ...
    jobTitle: 'Commercial Rewiring',
    category: 'Materials',
    description: 'Emergency cable purchase - B&Q',
    amount: 45.8,
    receiptImage: true,
    submittedDate: '2024-02-12',
    status: 'Approved',
    approvedBy: 'Lisa Parker',
  ...
  },
  {
    ...
    jobTitle: 'General',
    category: 'PPE',
    description: 'Safety boots replacement',
    amount: 89.99,
    receiptImage: true,
...
export const recruitmentPipeline = [
  {
    ...
    notes: 'Strong industrial background',
  ...
  },
  {
    ...
    name: 'Alex Morrison',
    stage: 'Shortlisted',
    notes: 'Excellent testing experience',
  ...
  },
  {
    ...
    name: 'Jordan Smith',
    stage: 'Offer Made',
    notes: 'Apprentice - good attitude',
...
export const customerSignatures = [
  {
    ...
    customerEmail: 'j.williams@ncpparks.co.uk',
    signedDate: '2024-01-20',
    documentType: 'Completion Certificate',
    status: 'Signed',
    signatureImage: true,
    linkedInvoice: 'INV-2024-002',
  },
  {
    id: 'SIG-002',
    jobId: '1',
    ...
    customerEmail: 'm.stevens@tesco.com',
    signedDate: null,
    documentType: 'Completion Certificate',
    status: 'Pending',
  ...
  },
  {
    ...
    customerEmail: 's.jones@jcb.com',
    signedDate: '2024-02-10',
    documentType: 'Service Report',
    status: 'Signed',
    signatureImage: true,
    linkedInvoice: 'INV-2024-004',
  },
  {
    id: 'SIG-004',
    jobId: '2',
    jobTitle: 'New Build Installation',
    customerName: 'Paul Roberts',
    customerEmail: 'p.roberts@barratthomes.com',
    signedDate: null,
    documentType: 'Stage Completion',
    status: 'Awaiting',
    signatureImage: false,
    linkedInvoice: null,
  },
  {
    ...
    documentType: 'Handover Document',
    status: 'Signed',
    signatureImage: true,
    linkedInvoice: null,
  },
...
export const electricianEndorsements = [
  {
    id: 'END-001',
    electricianId: 'AE-001',
    endorsedBy: 'Spark Solutions Ltd',
    endorserType: 'Employer',
    rating: 5,
    skills: ['Commercial', 'Testing'],
    comment: 'Excellent work on our commercial project. Very thorough testing.',
    date: '2024-01-20',
    verified: true,
    jobRef: 'Previous contract',
  },
  {
    id: 'END-002',
    electricianId: 'AE-001',
    endorsedBy: 'BuildRight Construction',
    endorserType: 'Employer',
    rating: 4,
    skills: ['Industrial'],
    comment: 'Good worker, reliable and professional.',
    date: '2023-11-15',
    verified: true,
    jobRef: 'Factory rewire',
  },
  {
    id: 'END-003',
    electricianId: 'AE-002',
    endorsedBy: 'Office Fit Ltd',
    endorserType: 'Employer',
    rating: 5,
    skills: ['Commercial', 'LED Lighting'],
    comment: 'Chris did a fantastic job on our office lighting upgrade.',
    date: '2024-02-01',
    verified: true,
    jobRef: 'Lighting project',
  },
  {
    id: 'END-004',
    electricianId: 'AE-003',
    endorsedBy: 'HomeServe',
    endorserType: 'Employer',
    rating: 4,
    skills: ['Domestic', 'Consumer Units'],
    comment: 'Reliable domestic installer.',
    date: '2023-12-10',
    verified: true,
    jobRef: 'Multiple domestic jobs',
  },
  {
    id: 'END-005',
    electricianId: 'AE-004',
    endorsedBy: 'DataCentre Solutions',
    endorserType: 'Employer',
    rating: 5,
    skills: ['Data Centres', 'Testing'],
    comment: 'Alex is our go-to for critical infrastructure work.',
    date: '2024-01-05',
    verified: true,
    jobRef: 'DC maintenance',
  },
];
...
export const jobPhotos: JobPhoto[] = [
  // Commercial Rewiring - Job 1 - linked to PL-001
  {
    ...
    uploadedById: '1',
    filename: 'consumer-unit-before.jpg',
    category: 'Before' as PhotoCategory,
    timestamp: '2024-02-12T08:30:00',
    location: { lat: 51.5074, lng: -0.1278, address: '45 Victoria Street' },
    approved: true,
    sharedWithClient: true,
    notes: 'Old consumer unit - 1970s wiring, needs complete replacement',
    progressLogId: 'PL-001',
  },
  {
    id: 'PHOTO-002',
    jobId: '1',
    ...
    uploadedBy: 'James Wilson',
    uploadedById: '1',
    filename: 'old-wiring-mess.jpg',
    category: 'Before' as PhotoCategory,
    timestamp: '2024-02-12T08:45:00',
    location: { lat: 51.5074, lng: -0.1278, address: '45 Victoria Street' },
    approved: true,
    sharedWithClient: true,
    notes: 'Existing wiring behind panels - fire risk identified',
    progressLogId: 'PL-001',
  },
  {
    id: 'PHOTO-003',
    ...
    uploadedBy: 'James Wilson',
    uploadedById: '1',
    filename: 'cable-runs-progress.jpg',
    category: 'During' as PhotoCategory,
    timestamp: '2024-02-13T14:20:00',
    location: { lat: 51.5074, lng: -0.1278, address: '45 Victoria Street' },
    approved: true,
    sharedWithClient: true,
    notes: 'New cable runs installed in ceiling void',
    progressLogId: 'PL-001',
  },
  {
    id: 'PHOTO-004',
    ...
    uploadedById: '2',
    filename: 'containment-install.jpg',
    category: 'During' as PhotoCategory,
    timestamp: '2024-02-14T10:15:00',
    location: { lat: 51.5074, lng: -0.1278, address: '45 Victoria Street' },
    approved: true,
    sharedWithClient: false,
    notes: 'Cable tray and trunking installation',
  },
  {
    id: 'PHOTO-005',
    jobId: '1',
    ...
    uploadedBy: 'James Wilson',
    uploadedById: '1',
    filename: 'new-db-installed.jpg',
    category: 'After' as PhotoCategory,
    timestamp: '2024-02-15T16:00:00',
    location: { lat: 51.5074, lng: -0.1278, address: '45 Victoria Street' },
    approved: true,
    sharedWithClient: true,
    notes: 'New 24-way distribution board installed and labelled',
    progressLogId: 'PL-002',
  },
  ...
  // New Build Installation - Job 2 - linked to PL-003
  {
    ...
    uploadedById: '3',
    filename: 'first-fix-cables.jpg',
    category: 'During' as PhotoCategory,
    timestamp: '2024-02-10T09:00:00',
    location: { lat: 51.4816, lng: -0.0085, address: 'Plot 14 Riverside' },
    approved: true,
    sharedWithClient: true,
    notes: 'First fix cabling in master bedroom',
    progressLogId: 'PL-003',
  },
  {
    id: 'PHOTO-007',
    jobId: '2',
    ...
    uploadedBy: 'Sarah Chen',
    uploadedById: '3',
    filename: 'back-boxes-installed.jpg',
    category: 'During' as PhotoCategory,
    timestamp: '2024-02-10T11:30:00',
    location: { lat: 51.4816, lng: -0.0085, address: 'Plot 14 Riverside' },
    approved: true,
    sharedWithClient: false,
    notes: 'Back boxes installed throughout ground floor',
    progressLogId: 'PL-003',
  },
  {
    id: 'PHOTO-008',
    ...
    uploadedBy: 'Mike Thompson',
    uploadedById: '2',
    filename: 'kitchen-wiring.jpg',
    category: 'During' as PhotoCategory,
    timestamp: '2024-02-11T14:00:00',
    location: { lat: 51.4816, lng: -0.0085, address: 'Plot 14 Riverside' },
    approved: true,
    sharedWithClient: true,
    notes: 'Kitchen appliance circuits roughed in',
    progressLogId: 'PL-003',
  },
  ...
  // Emergency Repair - Job 3
  {
    ...
    uploadedBy: 'James Wilson',
    uploadedById: '1',
    filename: 'fault-location.jpg',
    category: 'Before' as PhotoCategory,
    timestamp: '2024-02-08T19:30:00',
    location: { lat: 51.5155, lng: -0.142, address: '8 Oxford Street' },
    approved: true,
    sharedWithClient: true,
    notes: 'Burnt out connection at main isolator',
  },
  {
    id: 'PHOTO-010',
    jobId: '3',
    ...
    category: 'Completion' as PhotoCategory,
    timestamp: '2024-02-08T22:15:00',
    location: { lat: 51.5155, lng: -0.142, address: '8 Oxford Street' },
    approved: true,
    sharedWithClient: true,
    notes: 'Isolator replaced, power restored',
  },
  ...
  // EV Charging Points - Job 4
  {
    ...
    uploadedById: '5',
    filename: 'ev-unit-position.jpg',
    category: 'Before' as PhotoCategory,
    timestamp: '2024-01-15T08:00:00',
    location: { lat: 51.4545, lng: -0.9786, address: 'Tech Park, Reading' },
    approved: true,
    sharedWithClient: true,
    notes: 'Marked position for EV chargers',
  },
  {
    id: 'PHOTO-012',
    jobId: '4',
    ...
    uploadedBy: 'Tom Brown',
    uploadedById: '5',
    filename: 'groundworks-trench.jpg',
    category: 'During' as PhotoCategory,
    timestamp: '2024-01-16T10:30:00',
    location: { lat: 51.4545, lng: -0.9786, address: 'Tech Park, Reading' },
    approved: true,
    sharedWithClient: true,
    notes: 'Cable trench to car park',
  },
  {
    id: 'PHOTO-013',
    jobId: '4',
    ...
    uploadedBy: 'Mike Thompson',
    uploadedById: '2',
    filename: 'ev-chargers-installed.jpg',
    category: 'After' as PhotoCategory,
    timestamp: '2024-01-18T15:00:00',
    location: { lat: 51.4545, lng: -0.9786, address: 'Tech Park, Reading' },
    approved: true,
    sharedWithClient: true,
    notes: 'All 20 EV charging points installed and tested',
  },
  {
    id: 'PHOTO-014',
    jobId: '4',
    ...
    uploadedBy: 'Mike Thompson',
    uploadedById: '2',
    filename: 'ev-chargers-night.jpg',
    category: 'Completion' as PhotoCategory,
    timestamp: '2024-01-19T18:00:00',
    location: { lat: 51.4545, lng: -0.9786, address: 'Tech Park, Reading' },
    approved: true,
    sharedWithClient: true,
    notes: 'Night shot of illuminated charging bays',
  },
  ...
  // Industrial Panel Upgrade - Job 5 - linked to PL-004
  {
    id: 'PHOTO-015',
    jobId: '5',
    jobTitle: 'Industrial Panel Upgrade',
    uploadedBy: 'David Rodriguez',
    uploadedById: '4',
    filename: 'old-panel-state.jpg',
    category: 'Before' as PhotoCategory,
    timestamp: '2024-01-20T07:00:00',
    location: { lat: 51.5033, lng: -0.0193, address: 'Warehouse 7, Docklands' },
    approved: true,
    sharedWithClient: true,
    notes: 'Existing panel - obsolete components',
    progressLogId: 'PL-004',
  },
  {
    id: 'PHOTO-016',
    jobId: '5',
    ...
    uploadedBy: 'David Rodriguez',
    uploadedById: '4',
    filename: 'panel-stripped.jpg',
    category: 'During' as PhotoCategory,
    timestamp: '2024-01-22T12:00:00',
    location: { lat: 51.5033, lng: -0.0193, address: 'Warehouse 7, Docklands' },
    approved: true,
    sharedWithClient: false,
    notes: 'Old components removed, backplate cleaned',
    progressLogId: 'PL-004',
  },
  {
    id: 'PHOTO-017',
    ...
    uploadedBy: 'David Rodriguez',
    uploadedById: '4',
    filename: 'new-panel-wiring.jpg',
    category: 'During' as PhotoCategory,
    timestamp: '2024-01-24T14:30:00',
    location: { lat: 51.5033, lng: -0.0193, address: 'Warehouse 7, Docklands' },
    approved: true,
    sharedWithClient: true,
    notes: 'New components installed, wiring in progress',
    progressLogId: 'PL-004',
  },
  {
    id: 'PHOTO-018',
    ...
    approved: true,
    sharedWithClient: true,
    notes: 'Completed panel with updated schematic',
    progressLogId: 'PL-004',
  },
  ...
  // Issue photos
  {
    ...
    uploadedBy: 'James Wilson',
    uploadedById: '1',
    filename: 'damaged-cable-found.jpg',
    category: 'Issue' as PhotoCategory,
    timestamp: '2024-02-13T11:00:00',
    location: { lat: 51.5074, lng: -0.1278, address: '45 Victoria Street' },
    approved: true,
    sharedWithClient: false,
    notes: 'Rodent damage found on existing cables - reported to client',
    progressLogId: 'PL-002',
  },
  {
    id: 'PHOTO-020',
    ...
    uploadedBy: 'Sarah Chen',
    uploadedById: '3',
    filename: 'plumber-damage.jpg',
    category: 'Issue' as PhotoCategory,
    timestamp: '2024-02-11T09:30:00',
    location: { lat: 51.4816, lng: -0.0085, address: 'Plot 14 Riverside' },
    approved: true,
    sharedWithClient: true,
    notes: 'Cable damaged by plumber - rerouting required',
  },
  {
    id: 'PHOTO-021',
    jobId: '5',
    ...
    uploadedBy: 'David Rodriguez',
    uploadedById: '4',
    filename: 'asbestos-found.jpg',
    category: 'Issue' as PhotoCategory,
    timestamp: '2024-01-21T08:45:00',
    location: { lat: 51.5033, lng: -0.0193, address: 'Warehouse 7, Docklands' },
    approved: true,
    sharedWithClient: true,
    notes: 'Suspected asbestos behind panel - awaiting survey',
  },
  ...
  // More recent photos
  {
    ...
    uploadedBy: 'Mike Thompson',
    uploadedById: '2',
    filename: 'testing-in-progress.jpg',
    category: 'During' as PhotoCategory,
    timestamp: '2024-02-16T10:00:00',
    location: { lat: 51.5074, lng: -0.1278, address: '45 Victoria Street' },
    approved: false,
    sharedWithClient: false,
    notes: 'Live testing in progress',
  },
  {
    id: 'PHOTO-023',
    jobId: '1',
    ...
    uploadedBy: 'James Wilson',
    uploadedById: '1',
    filename: 'final-labels.jpg',
    category: 'Completion' as PhotoCategory,
    timestamp: '2024-02-17T14:00:00',
    location: { lat: 51.5074, lng: -0.1278, address: '45 Victoria Street' },
    approved: true,
    sharedWithClient: true,
    notes: 'All circuits labelled and documented',
  },
  {
    id: 'PHOTO-024',
    jobId: '6',
    jobTitle: 'Solar Installation',
    uploadedBy: 'Tom Brown',
    uploadedById: '5',
    filename: 'roof-survey.jpg',
    category: 'Before' as PhotoCategory,
    timestamp: '2024-02-18T09:00:00',
    location: { lat: 51.4025, lng: -0.3358, address: '12 Elm Road, Kingston' },
    approved: true,
    sharedWithClient: true,
    notes: 'Roof survey for solar panel placement',
  },
];
...
export const leaveRequests: LeaveRequest[] = [
  ...
  },
  {
    ...
    status: 'rejected',
    reason: 'Holiday',
    rejectedReason: 'Too many people already off',
