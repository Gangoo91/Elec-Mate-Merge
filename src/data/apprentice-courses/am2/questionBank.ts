...
export const am2QuestionBank: AM2Question[] = [
  ...
  },
  {
    ...
    options: ['Local councils', 'The police', 'Health and Safety Executive (HSE)', 'Fire service'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'TT systems allow 1.0 second for final circuits due to typically higher earth fault loop impedance.',
    section: 'Electric Shock',
    difficulty: 'intermediate',
    topic: 'Disconnection Times',
    category: 'BS7671 Fundamentals',
  ...
  },
  {
    ...
    options: ['0.8Ω maximum', '0.35Ω maximum', '21Ω maximum', '200Ω maximum'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Ca only', 'Cg only', 'Ci (thermal insulation factor)', 'No factor needed'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Type AC', 'Type A or Type B', 'Type S', 'Any type'],
    correctAnswer: 1,
    explanation:
  ...
  // Earthing and Bonding (15 questions)
  {
    ...
    correctAnswer: 0,
    explanation:
      'Main earthing conductor size depends on the size of the supply conductors, as specified in Table 54.7.',
    section: 'Earthing',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    options: ['6mm² copper', '10mm² copper', '16mm² copper', '25mm² copper'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Blue', 'Green and yellow bi-colour', 'Brown', 'Black'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Zone 1 requires minimum IPX5 (IPX4 where water jets not used for cleaning) protection.',
    section: 'Special Locations',
    difficulty: 'intermediate',
    topic: 'IP Ratings',
    category: 'BS7671 Selection & Erection',
  ...
  },
  {
    ...
    options: ['0.5MΩ', '1.0MΩ', '2.0MΩ', '0.25MΩ'],
    correctAnswer: 1,
    explanation:
  ...
  // Earth Fault Loop Impedance (15 questions)
  {
    ...
    options: ['Zs = Ze + R1 + R2', 'Zs = Ze × R1 × R2', 'Zs = Ze - R1 - R2', 'Zs = R1 + R2 only'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['1.44Ω', '1.09Ω', '0.86Ω', '2.30Ω'],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ['100ms', '300ms', '40ms', '1000ms'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['300ms', '150ms', '40ms', '1000ms'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Gas Safe Register', 'NAPIT, NICEIC, ELECSA, or Stroma', 'CORGI', 'OFTEC'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['10mm', '4mm (2mm preferred)', '20mm', 'No limit'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['CAT I', 'CAT II', 'CAT III or CAT IV', 'No rating required'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['3A', '500mA or less', '13A', 'No fuse required'],
    correctAnswer: 1,
    explanation:
  ...
  // Common Faults (20 questions)
  {
    ...
    options: ['Overload', 'Short circuit (dead short)', 'High resistance joint', 'Earth leakage'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Short circuit', 'Overload condition', 'Earth fault', 'Incorrect installation'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Multimeter', 'Thermal imaging camera', 'Proving unit', 'Socket tester'],
    correctAnswer: 1,
    explanation:
  ...
  // Additional questions to reach 400
  {
    ...
    options: ['±5%', '+10%/-6% of 230V', '±15%', 'Exactly 230V always'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['IPX0', 'IPX4', 'IPX7', 'No requirement'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Every year', 'Every 10 years or change of occupancy', 'Every 20 years', 'Never'],
    correctAnswer: 1,
    explanation:
      'Domestic installations should be inspected every 10 years or at change of occupancy, whichever is sooner.',
    section: 'Inspection',
    difficulty: 'basic',
  ...
  },
  {
    ...
    options: ['5×IΔn test', '1×IΔn test', '½×IΔn (50%) no-trip test', 'Insulation resistance test'],
    correctAnswer: 2,
    explanation:
