...
export const module5Questions: Question[] = [
  ...
  // ============================================================
  {
    ...
    options: [
      'It is convenient for the contractor',
      ...
      'The customer requests continuity of supply',
      'The supervisor verbally approves',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Switch off, lock off, test for dead',
      ...
      'Test live, switch off, post a warning sign',
      'Switch off, test, work',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Insulation resistance tester at 500V',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'It is only required before, not after',
  ...
  },
  {
    ...
    options: [
      'Place a sticker over the breaker',
      ...
      'Switch the main switch off only',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only loss of lighting',
      'Only inconvenience to the customer',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Bare probe tips for better contact',
      'Crocodile clips only',
  ...
  },
  {
    ...
    options: [
      ...
      'Removing the cover with bare hands',
      'Speeding up to limit exposure',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Mentioned verbally only',
      'Reported only if there was an injury',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Test live with the earth disconnected',
  ...
  },
  {
    ...
    options: [
      'Continue and note it on the report',
  ...
  // ============================================================
  {
    ...
    options: [
      "Only that the customer is happy",
      "That the requirements of BS 7671 have been met by inspection AND testing",
      "Only the wiring colours",
      "Only the consumer unit label",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Replacing a single accessory in an existing circuit",
  ...
  },
  {
    ...
    options: [
      ...
      "Replaces the EIC",
      "Is only used for commercial buildings",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "The installation is aesthetically pleasing",
  ...
  },
  {
    ...
    options: [
      ...
      "Only notify if asked",
      "Only notify domestic work",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "All five senses including taste",
      "Only smell",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Same csa as the earthing conductor always",
      "Any size that fits",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Same trunking is fine",
      "Different colour ties",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "0.5x, 1x and 5x IΔn at both 0° and 180°",
  ...
  },
  {
    ...
    options: [
      ...
      "Live testing whole installation",
      "From DNO records",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Light works normally with no risk",
  ...
  },
  {
    ...
    options: ["40ms", "300ms", "1000ms", "100ms"],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ["Inadequate", "Acceptable — Icn 6kA exceeds Ipf 4.2kA, satisfying Reg 432.1 breaking capacity requirement", "Marginal", "Replace MCB"],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "Banned in domestic premises",
      "Required only on commercial circuits",
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "Because PNB is illegal",
      "Because PNB always uses TT instead",
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "Compliant if RCD is fitted upstream of meter",
      "Compliant only on Sundays",
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "The test must be repeated at 1000 V",
