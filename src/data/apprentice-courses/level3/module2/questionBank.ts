...
export const module2Questions: Question[] = [
  ...
  },
  {
    ...
    options: ['0.50 W/m²K', '0.26 W/m²K or better', '1.0 W/m²K', '2.0 W/m²K'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Band G', 'Band D', 'Band A', 'Band E'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Band G', 'Band E', 'Band C', 'Band A'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.5-1.0', '2.5-4.0', '10-15', '100+'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['30-40%', 'Up to 90% or higher heat recovery', '100% (no losses)', '10-20%'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['5-10%', '18-22% for standard panels, up to 25%+ for premium', '50-60%', '90-100%'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['5-10 years', '25-30 years with degradation', '50+ years', 'They last forever'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Lead acid', 'Lithium-ion (Li-ion)', 'Nickel-cadmium', 'Zinc-carbon'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['50-60%', '85-95%', '99-100%', '30-40%'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['1-2kW', '7-22kW (typically 7kW for single-phase)', '50-100kW', '350kW+'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['HTTP only', 'BACnet, Modbus, KNX, or DALI for lighting', 'USB', 'Bluetooth only'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Only 5W', 'From 15W (PoE) to 90W+ (PoE++/802.3bt)', 'Only 1W', 'Unlimited power'],
    correctAnswer: 1,
    explanation:
  ...
  // ============================================
  {
    ...
    options: ['1 year', '10 years', '5 years', 'Indefinitely'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Fire safety', 'Ventilation requirements', 'Foundations', 'Fuel storage'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['50 kWh/m²/year', '15 kWh/m²/year', '100 kWh/m²/year', 'No limit'],
    correctAnswer: 1,
    explanation:
