...
export const module2Questions: QuestionBank[] = [
  ...
  },
  {
    ...
    options: [
      'A target for the delivered energy metered at the dwelling, excluding upstream losses',
      'A target for the carbon emissions of the space heating system only, excluding hot water',
      'A target limiting energy use per occupant rather than per square metre of floor area',
  ...
  },
  {
    ...
    options: [
      'Balancing the connected load evenly across all three phases to minimise neutral current',
      'Ramping load up gradually at start-up so inrush current does not trip the main breaker',
      'Deliberately reducing electrical load by switching off non-essential equipment during peak demand',
      'Transferring the whole installation onto a standby generator when the mains supply fails',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A manually-read gauge that a maintenance engineer records during periodic inspections',
      'A local standalone detector that sounds an alarm on site but transmits no data at all',
  ...
  },
  {
    ...
    options: [
      ...
      'A scanned archive of the building\'s paper drawings held as PDFs for record purposes',
      'A second identical building constructed nearby to provide standby accommodation',
  ...
  },
  {
    ...
    options: [
      'A handheld test instrument used to trace short circuits and open circuits in cabling',
      'Automated systems that identify operational faults and their likely causes in building systems',
      'A maintenance logbook in which occupants record faults for the facilities team to action',
      'A residual current device that disconnects the supply automatically on an earth fault',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'A building constructed entirely from materials with no carbon emitted in their manufacture',
      'A building whose emissions are zero during construction, with the operational phase excluded',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The carbon emitted by the building\'s heating, hot water and lighting throughout its occupied life',
      'The carbon permanently locked into the timber and other bio-based elements of the structure',
      'The carbon emissions from materials, construction, and eventual demolition - the building\'s lifecycle',
      'The carbon emitted by occupants and visitors travelling to and from the completed building',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Evaluating only the environmental impact arising while the product is actually in use',
      'A planned maintenance schedule covering every service task over the product\'s design life',
      'Evaluating environmental impacts throughout a product\'s life from raw materials to disposal',
      'Estimating the number of years a product will function before it must be replaced',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Energy, Sustainability and Generation - a certification scheme for renewable installers',
      ...
      'Efficiency Standards and Guidance - the rules governing building services design output',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Using a hydrogen fuel cell on site to generate the electricity that runs a heat pump',
      'Heating stored water directly by passing an electric current through it (electrolysis)',
      'Using hydrogen gas (potentially blended with natural gas or 100%) for building heating',
      'Recovering and reusing the waste heat given off when hydrogen is produced industrially',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A single large boiler plant serving only the various zones within one large building',
      'An individual heat pump installed in every separate dwelling across a housing estate',
      'Underfloor heating pipework distributed through every room of a single-family house',
  ...
  },
  {
    ...
    options: [
      ...
      'A network of wirelessly linked thermostats and TRVs controlling a single dwelling',
  ...
  },
  {
    ...
    options: [
      'The updated set of Building Regulations governing new construction from 2025 onwards',
      'Off-site manufacturing and innovative construction techniques reducing waste and time',
      'A digital modelling standard used to coordinate services during the design stage',
  ...
  },
  {
    ...
    options: [
      ...
      'A rule-of-thumb allowance of 100 W per square metre of floor area applied across the whole property regardless of fabric, with the existing emitters left at their present sizes',
      'Sizing the heat pump to match the kW output rating of the boiler it replaces, on the basis that the existing boiler was correctly sized for the property when it was fitted',
      'Sizing from the SAP rating printed on the property EPC, using the published annual energy demand divided by the heating hours for the relevant local climate region',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Refrigerant work is unrestricted where the charge is below 5 tonnes CO₂e, because the Regulation bites only above that threshold, at which point certification and leak checking become mandatory',
      'Only the equipment manufacturer or its appointed agent may carry out any work on the refrigerant circuit, and independent contractors are limited to the electrical and hydraulic connections',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'In an attached garage, because the parked vehicle adds fire load, or on any wall shared with a neighbouring property regardless of its construction or fire resistance',
      ...
      'On an external north-facing wall shaded from direct sunlight, because condensation forming on the cool enclosure is a greater risk to the cells than solar heat gain',
  ...
  },
  {
    ...
    options: [
      'It introduces an entirely new earthing arrangement replacing TT for rural installations, in which the distributor provides both a combined PEN conductor and a separate consumer earth electrode at the origin',
      ...
      'It means neutral and earth must now be kept separate all the way back to the supply transformer, so existing PME supplies must be converted to TN-S before an EV charge point may be added',
      'It is a new label for a TN-S system in which the earth is provided by a separate supply cable or the armouring of the service cable, so open-PEN protection is no longer required at all',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'SAP is used directly to size the heat pump and select its kW output, because the SAP worksheet already contains the property fabric and ventilation heat loss figures',
      'SAP replaces the need for any room-by-room heat-loss calculation on a heat pump job, provided the dwelling already holds a valid EPC that is less than ten years old',
      ...
      'SAP determines the design flow temperature for the emitters, which the installer then uses to select radiator sizes without carrying out a separate heat-loss calculation',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The mechanical standard defining the physical dimensions and pin layout of the Type 2 connector, together with the control pilot resistance values used in Mode 3 charging',
      'The installation standard setting the maximum cable length permitted between an EV charge point and the vehicle inlet, together with tethered lead retention arrangements',
      'The fire-safety standard setting separation distances, ventilation rates and compartmentation required around EV charge points in enclosed and underground car parks',
  ...
  },
  {
    ...
    options: [
      ...
      'A minimum continuous charge rate of 22 kW, a tethered Type 2 lead on every unit, and an integral MID-approved kWh meter permanently visible to the vehicle owner',
      'A built-in contactless payment card reader, a public-facing display screen showing the live tariff, and open-access roaming with at least two national charging networks',
      'A dedicated three-phase supply, a DNO-approved export meter, and load-curtailment signalling wired back to the distribution board over a hard-wired control cable',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'EV charging circuits are now exempt from the schedule of test results, because the charge point carries its own manufacturer commissioning record issued to the customer instead',
      ...
      'A separate certificate must be issued by the DNO rather than the installer, since the open-PEN risk arises on the distributor network rather than within the consumer installation',
      'The schedule must now record the make and model of the vehicle the charge point will serve, together with its on-board charger rating, so future load assessments stay accurate',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Break the tubes on site inside a sealed drum fitted with a carbon filter to reduce their volume, then dispose of the crushed glass as ordinary non-hazardous construction waste',
      'Treat them as ordinary WEEE under a standard Waste Transfer Note, since the mercury is bound within the phosphor coating and the tubes are therefore not classified as hazardous',
      'Place them intact in the site glass recycling skip alongside other glazing waste, provided the skip is kept covered and the operator is told that the load contains lamps',
  ...
  },
  {
    ...
    options: [
      ...
      'Monthly leak checks are required regardless of charge size, and may be carried out by any competent electrician provided the results are entered in the equipment logbook on site',
      'No leak checks are required at all below 50 tonnes CO₂e; above that threshold an annual check by F-Gas-certified personnel applies, halving to six-monthly above 500 tonnes',
      'A single leak check at commissioning is required, after which no further checks apply unless the equipment is moved, recharged, or the refrigerant type is changed at service',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Scope 1 = the largest and most visible emissions; Scope 2 = medium-sized emissions; Scope 3 = the smallest and easiest to measure, being the usual starting point for most firms',
      ...
      'Scope 1 = emissions from the office and stores; Scope 2 = emissions arising on site during the works; Scope 3 = emissions from staff travel to site in their own private vehicles',
      'Scope 1 = purchased electricity; Scope 2 = vans, plant and fuel burned directly; Scope 3 = materials only, and is not reportable by a small contractor below the size threshold',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Switch the office electricity supply to a certified renewable tariff and buy REGO-backed green electricity for every site welfare unit and temporary supply used during the works',
      'Replace the whole van fleet with electric vehicles and install workplace charge points at the depot so that all site travel is carried out with zero tailpipe emissions',
      ...
      'Install a heat pump to replace the gas heating in the firm own offices and stores, and fit LED lighting with presence detection throughout the premises and the workshop',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A phased ban on all single-use plastic packaging from 2024, requiring producers to switch to fibre-based or reusable alternatives for anything placed on the UK market',
      'A requirement that all packaging placed on the market contains at least 30% recycled content by weight, verified by the producer and reported annually to the Environment Agency',
      'A deposit return duty falling on consumers, who must take packaging back to the retailer to reclaim a deposit added at the point of sale on every item that they purchase',
  ...
  },
  {
    ...
    options: [
      ...
      'Set a headline net zero carbon target with a published completion date before assessing any of the organisation activities in detail',
      'Appoint an accredited external auditor to certify the organisation immediately, so the certificate is in place before the system is written',
      'Purchase verified carbon offsets sufficient to neutralise the organisation measured emissions for the current reporting year in full',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'An 80% cut in greenhouse gas emissions by 2050 against a 1990 baseline, which remains the binding figure because the 2019 amendment was only advisory',
  ...
  },
  {
    ...
    options: [
      'Secondary containment sized for 50% of the largest container, fitted with a lockable drain valve so that accumulated rainwater can be released to the surface water drain after inspection',
      'A single drip tray beneath the delivery tap is sufficient, with the tank standing on bare ground provided it is more than ten metres from any watercourse or surface water drain',
      'No secondary containment is required provided the oil store is kept under cover from rainfall and the total volume held on site at any one time stays below 1,000 litres',
  ...
  },
  {
    ...
    options: [
      ...
      'The refrigerant may be vented to atmosphere before scrapping, because R32 has a low GWP of 675 and therefore falls outside the recovery requirements set out in the F-Gas Regulation',
      'The whole unit may be placed in a general scrap-metal skip once it has been electrically isolated, as the scrap processor is then responsible for recovering any remaining refrigerant',
      'The refrigerant may be removed by any electrician provided the plant room is well ventilated and the recovered gas is handed to an authorised waste carrier for onward destruction',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Disposal → Other recovery → Recycling → Preparing for re-use → Prevention applied only as a last resort',
      'Prevention → Preparing for re-use → Recycling → Other recovery (including energy recovery) → Disposal as last resort',
      'Recycling → Disposal → Preparing for re-use → Prevention → Other recovery, applied in any convenient order',
      'Segregate → Store → Transfer → Record, with no order of preference applied between the four stages',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Place tubes and ballasts together in the general waste skip and record the total weight on a standard Waste Transfer Note, since a lighting retrofit is exempt from the WEEE segregation duty',
      'Leave the old fittings in position and wire the new LED luminaires alongside them, because equipment left in situ is not classed as waste and no consignment paperwork is then needed',
      ...
      'Crush the tubes on site to recover the glass for aggregate, then sell the ballasts as mixed scrap metal, keeping the weighbridge tickets as the record of disposal for two years',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The annual sum government sets aside to fund carbon capture and low-carbon heat projects, which contractors can bid into when tendering for public sector retrofit work',
      'A voluntary spending limit a contractor sets on low-carbon materials each year, disclosed in tender returns to demonstrate its commitment to sustainable procurement',
      'The per-project carbon allowance a client grants its main contractor, which is divided between subcontractors in proportion to their share of the total contract value',
  ...
  },
  {
    ...
    options: [
      ...
      'Part S requires every parking space in a new non-residential building to be fitted with a fully installed 22 kW charge point before the building may be occupied at all',
      'Part S applies only to new residential buildings and expressly exempts public and commercial car parks, which are instead covered by the Smart Charge Point Regulations',
      'Part S requires charge points only where the existing supply already has spare capacity, so a DNO capacity check determines whether any provision has to be made at all',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Around 31% lower CO₂ emissions than 2013 Part L, which is the same interim step already delivered by the 2021 amendment and needs no further fabric improvement',
      ...
      'A full 100% reduction in CO₂ emissions, requiring every new home to be off-grid with on-site generation and battery storage sized to meet its whole annual demand',
      'Around 50% lower CO₂ emissions than 2013 Part L, achieved mainly through fabric improvement while still permitting gas boilers to be fitted in new homes after 2025',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A private trade database of installer contact details and certification expiry dates, used by MCS purely for its own auditing purposes and not accessible or relevant to the consumer',
      'A manufacturer warranty register that the consumer must sign up to separately within 30 days of commissioning in order to keep the product guarantee valid at all',
      ...
      'A government-maintained list of approved renewable products and their published performance data, unrelated to any individual installation or its paperwork',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Every licensed supplier, regardless of size, must pay a fixed government-set rate per kWh for all exported energy, with the rate reviewed and published annually by Ofgem',
      'Suppliers must install an export meter free of charge for any customer with solar PV, and must then buy the exported units at the same price they charge for imported units',
      'Suppliers must buy back exported electricity only from customers who take their import supply on one of the supplier own tariffs, and only where the array is under 4 kW',
  ...
  },
  {
    ...
    options: [
      ...
      'A verbal handover demonstrating the thermostat and programmer, backed by a signed customer acknowledgement that the demonstration took place, plus the manufacturer warranty registration card returned within 30 days',
      'The manufacturer instruction leaflet supplied with the unit together with the refrigerant charge commissioning sheet, which between them satisfy the MCS handover requirement without further design paperwork',
      'The electrical installation certificate for the heat pump supply circuit and the Part P building notification, since the heating design paperwork is retained on file by the installer rather than issued to the customer',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Failure to wear the correct RPE and PPE when handling mercury-containing lamps and refrigerants during strip-out works on occupied premises',
      ...
      'Failure to obtain planning permission or listed building consent before installing external plant such as heat pumps, PV arrays and flues',
      'Failure to register completed renewable installations on the MCS Installation Database within the required period after commissioning the works',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Lithium batteries may be placed in the household recycling bin at end of life once they are fully discharged, so the design need only ensure the modules are light enough for one person to carry down from the installed position',
      'No end-of-life planning is needed because a domestic lithium battery is warranted for the design life of the building, and the manufacturer take-back scheme covers removal at no cost to the householder concerned',
      'The battery may simply be left in place and permanently disconnected when it fails, provided the DC isolator is locked off and a durable warning notice is fixed to the enclosure for the benefit of future workers',
  ...
  },
  {
    ...
    options: [
      ...
      'A target based on what the business can comfortably afford each year, benchmarked against sector peers rather than against any particular climate science trajectory',
      'A government-mandated emissions cap that every UK business must legally achieve by 2030, enforced through Companies House reporting and penalties for non-compliance',
      'A research funding target for universities and innovation bodies working on climate science, used to direct public grant money towards low-carbon technology development',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Cyber-security is the installer responsibility only up to handover, after which it transfers entirely to the customer, so no configuration beyond the factory default settings is required at commissioning',
      ...
      'The system should be kept permanently offline and isolated from any network, so that no cyber-security measures, firmware updates or credential management are needed after commissioning at all',
      'Only the inverter manufacturer is permitted to apply any security settings, so the installer must leave the default credentials in place and raise a support ticket for any change that is required',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Environmental competence mainly cuts the contractor own electricity and fuel bills, and the resulting saving on the office and van fleet is what pays back the cost of training, certification and the annual assessment fees charged by the schemes',
      'It is a legal requirement for every electrical contractor regardless of the work undertaken, because the Environment Act 2021 makes carbon reporting and MCS registration compulsory for any business that holds a waste carrier registration',
      ...
      'Environmental qualifications exempt the contractor from Building Regulations notification, so the firm can self-certify heat pump and PV work without belonging to a competent person scheme or paying the associated annual membership fees',
    ],
    correctAnswer: 2,
    explanation:
