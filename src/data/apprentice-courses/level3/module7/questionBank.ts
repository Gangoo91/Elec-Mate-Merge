...
export const module7Questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'Only ordering materials',
      'Just signing certificates',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only general electrical',
      'Only first aid certification',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only domestic circuits',
      'Only three-phase systems',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only AC electrical work',
      'Only battery systems',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'Only does physical work',
      'Only works in schools',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only works night shifts',
      'Has no technical role',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only fossil fuel plants',
      'Only nuclear systems',
    ],
    correctAnswer: 1,
  ...
  // Section 7.2: JIB Grading (Questions 31-60)
  {
    ...
    options: [
      'Joint Insurance Board',
      'Joint Industry Board',
      'Junction Installation Board',
      'Junior Industry Body',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'Only apprenticeship completion',
      'Only experience',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Lower skills than electrician',
      'Higher technical competence often with design capability',
      'Only administrative role',
      'Only apprentice level',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Retake all exams annually',
      'Only pay renewal fee',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'Only full apprenticeship',
      'Only degree qualification',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only verbal interview',
      'Only online assessment',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only general electrical',
      'Only automotive qualifications',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only roofing qualifications',
      'Only environmental studies',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only electrical skills',
      'Maths, English, and sometimes ICT',
      'Only manual dexterity',
      'Only communication',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only installation experience',
      'Only site supervision experience',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only general electrical qualification',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only matter for managers',
      "Don't affect career choice",
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'Wait for employer to arrange',
      'Only update after several years',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'Only employer direction',
      'Only formal qualifications',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only distracting from core skills',
      'Only if certified',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'Only engineering grades',
      'Only academic levels',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'JIB replaces professional registration',
      'Only administrative',
    ],
    correctAnswer: 1,
  ...
  // Section 7.7: Business Skills (Questions 171-200)
  {
    ...
    options: [
      "They're irrelevant to electrical work",
      'Good service leads to recommendations and repeat business',
      'Only managers need them',
      'Only in retail',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only benefits customers',
      'Is impossible in electrical work',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'Only large contracts matter',
      'Leave all to solicitors',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'Only for large companies',
      'Only accountants need to understand',
    ],
    correctAnswer: 1,
    explanation:
