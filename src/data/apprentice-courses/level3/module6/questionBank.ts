...
export const module6Questions: Question[] = [
  // Section 6.1: Design Principles (Questions 1-30)
  {
    ...
    options: [
      ...
      'Identical systems for all buildings',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Provide unlimited spare capacity',
      'Only design for current needs',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Installing various cable sizes',
  ...
  },
  {
    ...
    options: [
      ...
      'Using maximum cable sizes',
      'Installing maximum lighting',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Industrial only',
      'No standard arrangements exist',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Identical design to normal locations',
  ...
  },
  {
    ...
    options: [
      ...
      'It only applies to DC',
      'It reduces all loads',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      '50% of rating',
      'Ignored in demand calculations',
      'Occasional use only',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Connect all to one phase',
      'Balance loads across all three phases',
      'Use only two phases',
      'Ignore balance requirements',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Reduce other loads',
      'Use 7kW regardless of charger rating',
    ],
    correctAnswer: 1,
    explanation:
  ...
  // Section 6.3: Cable Selection (Questions 66-100)
  {
    ...
    options: [
      ...
      'Weight, flexibility, and appearance',
      'Brand, availability, and customer preference',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Insulation increases capacity',
      'Heat cannot dissipate effectively through thermal insulation',
      'Regulations require it regardless',
      'It only applies to very long runs',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "It's the minimum manufactured size",
  ...
  },
  {
    ...
    options: [
      ...
      'Resistance decreases when warm',
  ...
  },
  {
    ...
    options: [
      ...
      'Only disconnection time matters',
  ...
  },
  {
    ...
    options: [
      ...
      "Type doesn't matter for coordination",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Highly resistive loads only',
      'All domestic circuits',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Lower than prospective fault current',
      'At least equal to prospective fault current at installation point',
      'Exactly equal to rated current',
      'Unrelated to fault current',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Be set lower than running current',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Same as standard overcurrent',
      'Only metering function',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Using identical RCDs everywhere',
  ...
  },
  {
    ...
    options: [
      'Only transformer rating',
      'Transformer impedance effect on fault current',
      'Primary only',
      'No transformer considerations',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Faster upstream tripping',
      'No interlocking benefit',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Separate conductors throughout',
  ...
  },
  {
    ...
    options: [
      'Total installation impedance',
      'External earth fault loop impedance from supply',
      'CPC resistance',
      'Bonding conductor resistance',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Cold temperatures are the issue',
  ...
  },
  {
    ...
    options: [
      'Standard domestic installation rules',
  ...
  },
  {
    ...
    options: [
      ...
      'Any cable is acceptable',
      'Only surface mounted',
    ],
    correctAnswer: 1,
