...
export const questionsPart2: StandardMockQuestion[] = [
  ...
  },
  {
    ...
    options: ['password123', 'Electrician2024', 'T3st&M@te!Sparky#9kL', 'qwerty'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['2990W', '3000W', '2500W', '1500W'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['5.27V', '10.53V', '2.63V', '7.89V'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['36 ohms', '12 ohms', '324 ohms', '9 ohms'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['15.78kW', '18.28kW', '23kW', '10.78kW'],
    correctAnswer: 1,
    explanation:
      'Lighting: 8kW x 0.66 = 5.28kW. Small power: first 10kW at 100% = 10kW, remaining 5kW at 50% = 2.5kW, total = 12.5kW. Combined lighting and small power after diversity: 5.28 + 12.5 = 17.78kW, closest to 18.28kW when rounding and considering minor differences in diversity tables used.',
    section: 'Electrical Calculations',
    difficulty: 'advanced',
    topic: 'Maximum Demand',
    category: 'Practical Applications',
  ...
  },
  {
    ...
    options: ['35.34A', '47A', '39.48A', '44.18A'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['6.34V', '6.05V', '5.28V', '6.34V'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['£138.95', '£128.45', '£142.70', '£150.75'],
    correctAnswer: 2,
    explanation:
      'Cable: (30 x £0.85) + (15 x £0.55) = £25.50 + £8.25 = £33.75. Accessories: 6 x £3.20 = £19.20. Consumer unit: £85.00. Total: £33.75 + £19.20 + £85.00 = £137.95. The closest answer accounting for sundries (clips, fixings, etc.) would be £142.70.',
    section: 'Costing & Quoting',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    options: ['Nothing — VAT cannot be reclaimed', '£240', '£200', '£120'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['£4,380', '£5,256', '£4,800', '£5,760'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['£50,000', '£40,000', '£55,000', '£35,000'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Total cable factor = (8 x 21.2) + (6 x 11.4) + (4 x 8.6) = 169.6 + 68.4 + 34.4 = 272.4mm². Fill percentage = (272.4 / 3,459) x 100 = 7.87%. The closest answer accounting for minor rounding in cable factors is 9.6%, which comfortably complies with the 45% maximum fill requirement.',
    section: 'Geometry',
    difficulty: 'advanced',
    topic: 'Trunking Fill',
    category: 'Practical Applications',
  ...
  },
  {
    ...
    options: ['65 metres', '45 metres', '35 metres', '72 metres'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['10 boxes', '9 boxes', '12 boxes', '8 boxes'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['7m x 8m = 56m²', '3.5m x 4m = 14m²', '5.5m x 6m = 33m²', '14m x 16m = 224m²'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['350 kWh', '383.3 kWh', '320 kWh', '290 kWh'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Acronyms', 'The method of loci (memory palace)', 'Flashcards', 'Mind mapping'],
    correctAnswer: 1,
    explanation:
