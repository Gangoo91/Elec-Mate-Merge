...
export const questionsPart1: StandardMockQuestion[] = [
  ...
  // Permit to Work & Isolation (Questions 1-5)
  {
    ...
    correctAnswer: 1,
    explanation:
      'A permit to work (PTW) system provides a formal, documented procedure that ensures high-risk work activities (such as hot work, confined space entry, electrical isolation) are carried out safely with all necessary precautions in place. It defines responsibilities, hazards, and controls before work commences.',
  ...
  },
  {
    id: 7,
    question:
      'What category of arc flash PPE would typically be required when working on an energised 400 V motor control centre (MCC) with a calculated incident energy of 10 cal/cm²?',
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Electrical insulating gloves are classified by their voltage rating to BS EN 60903. Class 0 gloves provide protection up to 1000 V AC and would be the minimum required for a 1000 V system. In practice, the next class up (Class 1) may be selected to provide an additional safety margin.',
    section: 'PPE',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Approved Codes of Practice (ACoPs) are not legally binding in themselves, but they have a special legal status. If an employer is prosecuted for a breach of health and safety law and has not followed the relevant ACoP, a court can find them at fault unless they can demonstrate they complied with the law in an equivalent or better way.',
    section: 'Legislation',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    options: [
      'The voltage is the same across every component connected to the node',
      'The total resistance at the node equals the sum of the branch resistances',
      'The total current entering the node equals the total current leaving the node',
      'The current divides equally between all branches leaving the node',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "In a purely inductive circuit, the current lags the voltage by 90 degrees (pi/2 radians). This is because the inductor opposes changes in current. The mnemonic 'CIVIL' helps remember: in a Capacitor, I (current) leads V (voltage); in an Inductor, V leads I (current Lags).",
    section: 'AC Theory',
    difficulty: 'intermediate',
  ...
  },
  {
    id: 37,
    question:
      "An induction motor nameplate shows 'DOL' starting method. What does this mean and what is the typical starting current?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'DOL (Direct On Line) means the motor is connected directly to the full supply voltage at start-up. The starting current (also called locked rotor current) is typically 6 to 8 times the full load current (FLC). This high starting current must be considered when selecting protective devices, cables, and assessing the impact on the supply network.',
    section: 'Motors',
    difficulty: 'intermediate',
