...
export const module2QuestionBank: QuestionBank[] = [
  ...
  },
  {
    ...
    options: ['Resistance', 'Potential difference (voltage)', 'Conductors', 'Insulators'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['Too bright', 'If one bulb fails, all go out', 'Use too much power', 'Too expensive'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Voltage', 'Total resistance', 'Current capability', 'Power handling'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['Peak = RMS', 'Peak = RMS × 1.414', 'Peak = RMS × 2', 'Peak = RMS ÷ 2'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['A battery', 'A device that converts AC mains to DC', 'A transformer', 'A generator'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['High voltage', 'Positive terminal', 'AC connection', 'Earth connection'],
    correctAnswer: 1,
  ...
  },
  {
    id: 160,
    question: 'What does the - symbol indicate on a DC supply?',
    options: ['Low voltage', 'Negative terminal', 'AC connection', 'Dangerous connection'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['A type of motor', 'A device that converts DC to AC', 'A transformer', 'A battery'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['R = V/I', 'R = ρL/A', 'R = P/I²', 'R = L×A/ρ'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['Doubles', 'Becomes one quarter', 'Halves', 'Stays the same'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Copper and gold', 'Silicon and germanium', 'PVC and rubber', 'Steel and iron'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Increases', 'Decreases (derating required)', 'Stays the same', 'Becomes zero'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Only P = VI', 'P = VI, P = I²R, P = V²/R', 'Only P = I²R', 'Only P = V²/R'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['In watts', 'As a percentage or decimal fraction', 'In volts', 'In amperes'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['90-95%', 'About 5% (very inefficient)', '50-60%', '75-80%'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['5-10%', '80-90%', '30-40%', '60-70%'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['S = P + Q', 'S² = P² + Q² (power triangle)', 'S = P × Q', 'S = P - Q'],
    correctAnswer: 1,
    explanation:
