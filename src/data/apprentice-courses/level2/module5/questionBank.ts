...
export const module5QuestionBank: QuestionBank[] = [
  ...
  },
  {
    ...
    options: ['Schematic diagram', 'Layout drawing', 'Circuit diagram', 'Block diagram'],
    correctAnswer: 1,
    explanation:
  ...
  // Section 5.1 continued
  {
    ...
    options: ['1:1', '1:50 or 1:100', '1:1000', 'No specific scale needed'],
    correctAnswer: 1,
    explanation:
  ...
  // Additional Section 5.1 questions (Understanding Installation Specifications and Drawings)
  {
    ...
    options: ['Layout drawing', 'Single-line diagram', 'Detail drawing', 'Assembly drawing'],
    correctAnswer: 1,
    explanation:
  ...
  // Additional questions to reach 250 total - covering all sections comprehensively
  {
    ...
    correctAnswer: 0,
    explanation:
      'UK electrical drawing symbols are governed by BS EN 60617 (graphical symbols) and BS 3939 (British supplement), ensuring standardised interpretation.',
    section: '5.1.1',
    difficulty: 'intermediate',
