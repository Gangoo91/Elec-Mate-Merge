...
export const TOOLS_DATABASE: ToolDefinition[] = [
  // TESTING EQUIPMENT
  {
    ...
    description: 'MFT for full installation testing',
    brand: 'Fluke/Megger/Kewtech',
  },
  {
    id: 'insulation-tester',
    category: 'testing',
    name: 'Insulation Resistance Tester',
    description: 'IR testing at 250V/500V/1000V',
  },
  {
    id: 'multimeter',
    category: 'testing',
    name: 'Digital Multimeter',
    description: 'AC/DC voltage, current, resistance',
  },
  {
    id: 'true-rms-multimeter',
    category: 'testing',
    name: 'True RMS Multimeter',
    description: 'Accurate readings on non-sinusoidal waveforms',
  },
  {
    id: 'clamp-meter',
    category: 'testing',
    name: 'Clamp Meter',
    description: 'Non-contact current measurement',
  },
  {
    id: 'rcd-tester',
    category: 'testing',
    name: 'RCD Tester',
    description: 'Trip time and current testing',
  },
  {
    id: 'loop-tester',
    category: 'testing',
    name: 'Loop Impedance Tester',
    description: 'Zs and Ze testing',
  },
  {
    id: 'earth-tester',
    category: 'testing',
    name: 'Earth Electrode Tester',
    description: 'RA measurement',
  },
  {
    id: 'voltage-indicator',
    category: 'testing',
    name: 'Voltage Indicator (GS38)',
    description: 'Proving unit for safe isolation',
  },
  {
    id: 'proving-unit',
    category: 'testing',
    name: 'Proving Unit',
    description: 'For testing voltage indicators',
  },
  {
    id: 'non-contact-tester',
    category: 'testing',
    name: 'Non-Contact Voltage Tester',
    description: 'Quick live detection',
  },
  {
    id: 'socket-tester',
    category: 'testing',
    name: 'Socket Tester',
    description: 'Quick polarity/earth check',
  },
  {
    id: 'pfc-tester',
    category: 'testing',
    name: 'PFC/PSCC Tester',
  ...
  },
  {
    id: 'ev-tester',
    category: 'testing',
    name: 'EV Charger Tester',
    description: 'Type 2 / Mode 3 testing',
  },
  {
    id: 'phase-rotation',
    category: 'testing',
    name: 'Phase Rotation Tester',
    description: '3-phase sequence testing',
  },
  {
    id: 'thermal-camera',
    category: 'testing',
  ...
  },
  {
    ...
    description: 'Harmonics and power factor',
  },

  // HAND TOOLS
  {
    id: 'vde-screwdriver-set',
    category: 'hand',
    name: 'VDE Insulated Screwdriver Set',
    description: '1000V rated',
  },
  {
    id: 'vde-pliers',
    category: 'hand',
    name: 'VDE Combination Pliers',
    description: '1000V rated',
  },
  {
    id: 'side-cutters',
    category: 'hand',
    name: 'Side Cutters/Diagonal Pliers',
    description: 'Cable cutting',
  },
  {
    id: 'long-nose-pliers',
    category: 'hand',
  ...
  },
  {
    id: 'cable-knife',
    category: 'hand',
    name: "Electrician's Cable Knife",
    description: 'VDE insulated',
  },
  {
    id: 'junior-hacksaw',
    category: 'hand',
    name: 'Junior Hacksaw',
    description: 'Cutting conduit/trunking',
  },
  {
  ...
  { id: 'allen-keys', category: 'hand', name: 'Allen Key Set', description: 'Hex keys metric' },
  {
    ...
    description: 'For consumer units',
  },
  {
    id: 'terminal-screwdriver',
    category: 'hand',
    name: 'Terminal Screwdriver',
    description: 'Flat blade for terminals',
  },
  {
    id: 'pozidriv-screwdriver',
    category: 'hand',
    name: 'Pozidriv Screwdriver Set',
    description: 'PZ1, PZ2, PZ3',
  },
  ...
  {
    id: 'cable-ratchet-cutters',
    category: 'cable',
    name: 'Ratchet Cable Cutters',
    description: 'Large cables',
  },
  {
    id: 'crimping-tool',
    category: 'cable',
    name: 'Crimping Tool',
    description: 'Bootlace ferrules',
  },
  {
    id: 'hydraulic-crimper',
    category: 'cable',
    name: 'Hydraulic Crimper',
    description: 'Large lugs',
  },
  {
    id: 'cable-gland-spanner',
    category: 'cable',
    name: 'Cable Gland Spanner Set',
    description: 'SWA glands',
  },
  {
    id: 'swa-stripper',
    category: 'cable',
    name: 'SWA Cable Stripper',
  ...
  { id: 'cable-rod-set', category: 'cable', name: 'Cable Rod Set', description: 'Cable routing' },
  {
    id: 'fish-tape',
    category: 'cable',
    name: 'Fish Tape/Draw Wire',
    description: 'Pulling cables',
  },
  {
    id: 'cable-sock',
    category: 'cable',
    name: 'Cable Pulling Sock',
    description: 'Large cable pulls',
  },
  {
    id: 'cable-lubricant',
    category: 'cable',
    name: 'Cable Lubricant',
    description: 'For long pulls',
  },
  {
    id: 'cable-tie-gun',
    category: 'cable',
  ...
  { id: 'tape-measure', category: 'measuring', name: 'Tape Measure', description: '5m/8m' },
  {
    ...
    description: 'Accurate distances',
  },
  { id: 'spirit-level', category: 'measuring', name: 'Spirit Level', description: '600mm/1200mm' },
  {
    ...
    category: 'measuring',
    name: 'Laser Level',
    description: 'Line/cross laser',
  },
  {
    id: 'cable-detector',
    category: 'measuring',
    name: 'Cable/Pipe Detector',
    description: 'Avoid buried services',
  },
  { id: 'stud-finder', category: 'measuring', name: 'Stud Finder', description: 'Locate joists' },
  {
    ...
    category: 'measuring',
    name: 'Folding Rule',
    description: 'For vertical measurements',
  },
  {
    id: 'cable-length-meter',
    category: 'measuring',
    name: 'Cable Length Meter',
    description: 'Measuring drums',
  },
  ...
  // ACCESS EQUIPMENT
  {
    ...
    category: 'access',
    name: 'Step Ladder',
    description: 'Fibreglass insulated',
  },
  {
    id: 'extension-ladder',
    category: 'access',
  ...
  },
  {
    ...
    category: 'access',
    name: 'Platform Steps',
    description: 'Stable working platform',
  },
  { id: 'hop-up', category: 'access', name: 'Hop-Up Platform', description: 'Low level access' },
  {
    ...
    description: 'Extended height work',
  },
  {
    id: 'podium-steps',
    category: 'access',
    name: 'Podium Steps',
    description: 'Enclosed platform',
  },
  ...
  { id: 'pop-rivet-gun', category: 'fixings', name: 'Pop Rivet Gun', description: 'Metal fixings' },
  {
    id: 'rawl-bolt-setter',
    category: 'fixings',
    name: 'Anchor Bolt Setting Tool',
    description: 'Heavy duty fixings',
  },
  ...
  },
  {
    ...
    category: 'lighting',
    name: 'LED Work Light',
    description: 'Area illumination',
  },
  {
    id: 'inspection-torch',
    category: 'lighting',
    name: 'Inspection Torch',
  ...
  },
  {
    ...
    description: 'Cavity inspection',
  },
  {
    id: 'inspection-mirror',
    category: 'lighting',
