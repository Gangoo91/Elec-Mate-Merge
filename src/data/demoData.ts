export const demoEICRData = {
  ...
  testVoltage: '500',
  testNotes:
    'All tests carried out with installation isolated and all loads disconnected. RCD tests performed using calibrated Megger MFT.',
  ...
  nextInspectionDate: new Date(Date.now() + 5 * 365 * 24 * 60 * 60 * 1000)
    .toISOString()
    .split('T')[0], // 5 years
  ...
  additionalComments:
    'Installation generally in good condition. Recommend replacement of two damaged socket outlets in kitchen.',
