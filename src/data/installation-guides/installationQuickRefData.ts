...
export const cableSizingData: CableSizingRow[] = [
  {
    cable: '1.0mm\u00B2',
    ratingClipped: '15.5A',
    ratingEnclosed: '13.5A',
    voltDrop: '44',
    commonCircuit: 'Lighting (6A)',
    mcb: '6A',
  },
  {
    cable: '1.5mm\u00B2',
    ratingClipped: '20A',
    ratingEnclosed: '17.5A',
    voltDrop: '29',
    commonCircuit: 'Lighting (10A)',
    mcb: '6A/10A',
  },
  {
    cable: '2.5mm\u00B2',
    ...
    ratingEnclosed: '24A',
    voltDrop: '18',
    commonCircuit: 'Ring final / Radial',
    mcb: '32A / 20A',
  },
  {
    cable: '4.0mm\u00B2',
    ...
    ratingEnclosed: '32A',
    voltDrop: '11',
    commonCircuit: 'Heavy radial / Cooker (small)',
    mcb: '32A',
  },
  {
    cable: '6.0mm\u00B2',
    ...
    ratingEnclosed: '41A',
    voltDrop: '7.3',
    commonCircuit: 'Cooker / EV charger',
    mcb: '32A/40A',
  },
  {
    cable: '10mm\u00B2',
  ...
  },
  {
    ...
    ratingEnclosed: '76A',
    voltDrop: '2.8',
    commonCircuit: 'Sub-main / Large shower',
    mcb: '63A',
  },
  {
    cable: '25mm\u00B2',
    ...
    ratingEnclosed: '101A',
    voltDrop: '1.75',
    commonCircuit: 'Sub-main / Large load',
    mcb: '80A/100A',
  },
];
...
export const circuitData: CircuitData[] = [
  ...
  },
  {
    ...
    protection: '32A MCB',
    tip: 'Apply diversity factor from the IET On-Site Guide (Table A2). First 10A at 100%, remaining at 30%, plus 5A if socket on cooker control unit.',
  },
  {
    name: 'Shower Circuit',
...
export const ipRatingsData: IPRatingRow[] = [
  {
    code: 'IP20',
    solids: 'Protected against fingers',
    liquids: 'None',
    example: 'Standard domestic socket/switch',
  },
  {
    code: 'IP2X',
    solids: 'Protected against fingers',
    liquids: '\u2014',
    example: 'Minimum for live parts inside CU',
  },
  {
    code: 'IP44',
    solids: 'Protected against 1mm+ objects',
    liquids: 'Splashing water',
    example: 'Outdoor PIR sensor, junction boxes',
  },
  {
    code: 'IP55',
    solids: 'Dust protected',
    liquids: 'Water jets',
    example: 'Outdoor consumer unit, garden sockets',
  },
  {
    code: 'IP65',
    solids: 'Dust tight',
    liquids: 'Water jets',
    example: 'Outdoor LED floodlight, bathroom downlight',
  },
  {
    code: 'IP66',
    solids: 'Dust tight',
    liquids: 'Powerful water jets',
    example: 'Industrial enclosure, car wash areas',
  },
  {
    code: 'IP67',
    solids: 'Dust tight',
    liquids: 'Immersion (30 min)',
    example: 'Underground junction box, submersible pump',
  },
  {
    code: 'IP68',
    solids: 'Dust tight',
    liquids: 'Continuous immersion',
    example: 'Pool lighting, marine applications',
  },
];
...
export const bathroomZones: BathroomZone[] = [
  ...
  {
    zone: 'Zone 1 (above bath to 2.25m)',
    ipMin: 'IPX4 minimum',
    notes: 'IPX5 if water jets likely',
  },
  {
    zone: 'Zone 2 (0.6m from Zone 1)',
    ipMin: 'IPX4 minimum',
    notes: 'Standard rated accessories OK',
  },
...
export const safeIsolationSteps: SafeIsolationStep[] = [
  {
    step: 1,
    title: 'Identify',
    description: 'Identify the circuit to be worked on using drawings/schedules',
  },
  {
    step: 2,
    title: 'Notify',
    description: 'Inform all affected persons that the supply will be switched off',
  },
  {
    step: 3,
    title: 'Isolate',
    description: 'Switch off and isolate the circuit at the distribution board',
  },
  {
    step: 4,
    title: 'Lock off',
    description: 'Apply a lock and personal danger tag (your lock, your key)',
  },
  {
    step: 5,
    title: 'Prove',
    description: 'Test your voltage indicator on a KNOWN live source (proving unit)',
  },
  {
    step: 6,
    title: 'Test',
    description: 'Test between all conductors (L-N, L-E, N-E) to confirm dead',
  },
  {
    step: 7,
    title: 'Prove again',
    description: 'Re-test your voltage indicator on the known live source',
  },
...
export const accessoryHeights: AccessoryHeightRow[] = [
  {
    accessory: 'Socket outlets',
    standardHeight: '450mm from floor',
    accessibleHeight: '450\u20131200mm',
    notes: 'Part M: between 450\u20131200mm from FFL',
  },
  {
    accessory: 'Light switches',
    standardHeight: '1200\u20131400mm',
    accessibleHeight: '900\u20131100mm',
    notes: 'Part M: large rocker plates',
  },
  {
    accessory: 'Consumer unit',
    standardHeight: '1350\u20131500mm',
    accessibleHeight: 'Accessible without bending/stretching',
    notes: 'BS 7671 Reg 132.12',
  },
  {
    accessory: 'Cooker control unit',
    standardHeight: '1200\u20131400mm',
    accessibleHeight: 'Within easy reach',
    notes: 'Above worktop level',
  },
  {
    accessory: 'Fused connection unit',
    standardHeight: 'As required',
    accessibleHeight: '450\u20131200mm',
    notes: 'Match socket heights if visible',
  },
  {
    accessory: 'Isolator switches',
    standardHeight: '1200\u20131400mm',
    accessibleHeight: 'Accessible',
    notes: 'Emergency switches at obvious height',
  },
  {
    accessory: 'Thermostat',
    standardHeight: '1200\u20131500mm',
    accessibleHeight: '1200\u20131400mm',
    notes: 'Away from draughts and direct sun',
  },
  {
    accessory: 'Outdoor socket',
    standardHeight: '450mm+',
    accessibleHeight: 'Protected location',
    notes: 'IP66 minimum, RCD protected',
  },
];
