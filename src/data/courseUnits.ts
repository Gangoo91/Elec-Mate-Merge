...
export const level2DiplomaUnits: CourseUnit[] = [
  {
    ...
    code: 'ELEC2/01',
    description:
      'Learn about health and safety regulations, risk assessment, and safe working practices in electrical installations.',
    sections: [],
    resources: [],
  },
  {
    ...
    code: 'ELEC2/04',
    description:
      'Understand the fundamental theories and technologies behind electrical installations.',
    sections: [],
    resources: [],
  },
  {
    ...
    code: 'ELEC2/05A',
    description:
      'Explore proper installation methods and procedures according to industry standards.',
    sections: [],
    resources: [],
  },
  {
