...
export const TEST_LEARNING: Record<string, TestLearningEntry> = {
  ...
  'CONTINUITY:r1': {
    ...
    regulation: 'BS 7671:2018+A3:2024 Reg. 643.2 / GN3 Section 10',
    failPoints: [
  ...
  'CONTINUITY:polarity': {
    ...
    regulation: 'BS 7671:2018+A3:2024 Reg. 643.6 / GN3 Section 13',
    failPoints: [
  ...
  LOOP_ZS: {
    ...
    regulation: 'BS 7671:2018+A3:2024 Reg. 643.7.3 / Table 41.2–41.4 / GN3 Section 14',
    failPoints: [
  ...
  PFC: {
    ...
    regulation: 'BS 7671:2018+A3:2024 Reg. 643.7.3.201 / GN3 Section 16',
    failPoints: [
