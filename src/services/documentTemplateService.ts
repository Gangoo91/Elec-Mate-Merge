  ...
  // Invoicing Templates
  {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        placeholder: '',
        options: ['Net 7 days', 'Net 14 days', 'Net 30 days'],
      },
    ],
  },
  {
  ...
  // Certification Templates
  {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        placeholder: '',
        options: ['Satisfactory', 'Unsatisfactory', 'Requires Improvement'],
      },
      {
        id: 'inspectorName',
        name: 'inspectorName',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Tester Name',
        required: true,
        placeholder: "Tester's full name",
      },
    ],
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Work Description',
        required: true,
        placeholder: 'Describe the minor works performed',
      },
      {
        id: 'technicianName',
        name: 'technicianName',
  ...
  // Health & Safety Templates
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Assessor Name',
        required: true,
        placeholder: "Risk assessor's name",
      },
      {
        id: 'assessmentDate',
        name: 'assessmentDate',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Prepared By',
        required: true,
        placeholder: 'Method statement preparer',
      },
      {
        id: 'approverName',
        name: 'approverName',
        ...
        label: 'Approved By',
        required: true,
        placeholder: 'Method statement approver',
      },
      {
        id: 'workSequence',
        name: 'workSequence',
        ...
        label: 'Work Sequence',
        required: true,
        placeholder: 'Step-by-step work sequence',
      },
    ],
  },
  ...
  // Compliance Templates
  {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        placeholder: '',
        options: ['Pass', 'Fail', 'Further Investigation Required'],
      },
    ],
  },
  ...
  // Contract Templates
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Work Description',
        required: true,
        placeholder: 'Detailed description of electrical work',
      },
      {
        id: 'contractValue',
        name: 'contractValue',
  ...
  // Business Templates
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Premises',
        required: true,
        placeholder: 'Property to be maintained',
      },
      {
        id: 'agreementPeriod',
