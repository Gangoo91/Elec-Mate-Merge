    ...
    projectMetadata: {
      ...
      properties: {
        ...
        riskAssessmentReference: {
          type: 'string',
          description: 'Associated Risk Assessment reference',
        },
      },
    },
    executiveSummary: {
  ...
  properties: {
    ...
    ragContextUsed: {
      ...
      properties: {
        ...
        practicalProceduresCount: {
          type: 'number',
          description: 'Number of practical procedures retrieved',
        },
        toolsExtracted: { type: 'number', description: 'Number of tools extracted from RAG' },
        materialsExtracted: {
          type: 'number',
          description: 'Number of materials extracted from RAG',
        },
      },
    },
    ragCitations: {
