      ...
      <div className="space-y-8">
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
              ...
              <ul className="text-gray-300 text-sm space-y-1 list-disc list-inside">
                ...
                <li>
                  Photos and images you capture or upload (site visit photos, safety documentation,
                  board scanner images, portfolio evidence, document scans)
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
              ...
              <ul className="text-gray-300 text-sm space-y-1 list-disc list-inside">
                ...
                <li>
                  ...
                  location search, travel time estimates, or address lookup — only with your device
                  permission
                </li>
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                ...
                OpenAI processes this data under a Data Processing Agreement and does not use it to
                train their models. We do not send your name, email, or account details to OpenAI.
              </p>
            </div>
        ...
        <section>
          ...
          <ul className="text-gray-300 text-sm space-y-2 list-disc list-inside">
            ...
            <li>
              ...
              EU-US Data Privacy Framework or ensure International Data Transfer Agreements (IDTAs)
              and Standard Contractual Clauses (SCCs) are in place
            </li>
            <li>
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            ...
            take effect. We encourage you to review this policy periodically.
          </p>
        </section>
