    ...
    <LegalPageLayout>
      ...
      <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-400 text-xs">
                ...
                like keeping you logged in during a visit.
              </p>
            </div>
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
            ...
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-400 text-xs">
                Set by our service providers (Supabase, Stripe, PostHog). We disclose these in this
                policy.
              </p>
            </div>
          </div>
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed mb-3">
            These cookies are essential for the platform to function. They cannot be disabled as the
            service would not work without them. We do not require your consent for these cookies
          ...
          <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/30">
            <div className="flex items-start gap-3">
              ...
              <p className="text-blue-200 text-sm">
                <strong>Note:</strong> Blocking essential cookies via your browser will prevent you
                from logging in or using core features of Elec-Mate.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed mb-3">
            ...
            platform. This data helps us improve our services.{' '}
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed mb-4">
            Some of our service providers may set cookies on your device. We have carefully selected
            providers who comply with data protection regulations:
          </p>
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-300 text-sm mb-2">
                Only loaded if you consent to analytics cookies. Helps us understand platform usage.
              </p>
              <p className="text-gray-400 text-xs">
                Location: EU |{' '}
                <a
          ...
          <div className="space-y-3">
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
              ...
              <ul className="text-gray-300 text-sm mt-2 space-y-1 list-disc list-inside">
                <li>
                  <strong className="text-white">Accept All:</strong> Enables all cookies including
                  analytics
                </li>
                <li>
                ...
                <li>
                  <strong className="text-white">Manage Preferences:</strong> Customise which cookie
                  categories you accept
                </li>
              </ul>
            </div>
        ...
        <section>
          ...
          <ul className="text-gray-300 text-sm space-y-2 list-disc list-inside">
            ...
            <li>
              <strong className="text-white">Right to withdraw consent:</strong> Change preferences
              anytime via Settings → Privacy
            </li>
            <li>
