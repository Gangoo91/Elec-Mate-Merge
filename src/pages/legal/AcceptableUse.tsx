...
import { Scale, Ban, Shield, AlertTriangle, Users, Flag, FileText, Mail } from 'lucide-react';
      ...
      <Card className="bg-neutral-900 border-white/10 mb-6">
        <CardContent className="p-4 sm:p-6">
          <p className="text-gray-300 leading-relaxed">
            This Acceptable Use Policy ("AUP") sets out the rules for using the Elec-Mate platform.
            By using our services, you agree to comply with this policy. This AUP should be read
            alongside our{' '}
