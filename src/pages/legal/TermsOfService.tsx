      ...
      <Card className="bg-neutral-900 border-white/10 mb-6">
        <CardContent className="p-4 sm:p-6">
          <p className="text-gray-300 leading-relaxed">
            ...
            Elec-Mate Ltd ("Elec-Mate", "we", "us", "our"), governing your access to and use of the
            Elec-Mate platform, including our website, mobile applications, and all related
            services.
          </p>
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="space-y-2 text-gray-300 text-sm">
            ...
            <p>
              <strong className="text-white">"Platform"</strong> means the Elec-Mate website, mobile
              applications, and all related technology infrastructure.
            </p>
            <p>
              <strong className="text-white">"Services"</strong> means all features, tools, content,
              and functionality provided through the Platform.
            </p>
            <p>
              <strong className="text-white">"Subscription"</strong> means a paid plan that provides
              access to premium features.
            </p>
            <p>
              <strong className="text-white">"User"</strong> or{' '}
              <strong className="text-white">"you"</strong> means any individual or entity accessing
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-400 text-xs">
                Calculators, reference materials, and tools aligned with BS7671 and UK regulations.
              </p>
            </div>
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-400 text-xs mt-2">
                Refund requests must be submitted to info@elec-mate.com within the eligible period.
              </p>
            </div>
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                ...
                to text, graphics, logos, icons, images, audio, video, software, and the compilation
                thereof — are owned by Elec-Mate or our licensors and are protected by UK and
            ...
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                ...
                and use our Services for your personal or internal business purposes, subject to
                these Terms. This licence does not include the right to:
              </p>
            ...
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                You retain ownership of User Content you create. By submitting content, you grant us
                a worldwide, royalty-free, non-exclusive licence to use, reproduce, modify, and
                display such content solely for the purpose of providing and improving our Services.
            ...
            <div className="p-4 rounded-xl bg-white/5 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                Any feedback, suggestions, or ideas you provide about our Services may be used by us
        ...
        <section>
          ...
          <div className="space-y-3 text-gray-300 text-sm">
            ...
            <p>
              ...
              manufacturer guidelines, and applicable regulations regardless of any content provided
        ...
        <section>
          ...
          <div className="space-y-3 text-gray-300 text-sm">
            <p>
              ...
              Elec-Mate and its directors, employees, agents, and affiliates shall not be liable for
              any:
            </p>
            <ul className="list-disc list-inside ml-4 space-y-1">
            ...
            <p>
              <strong className="text-white">10.3</strong> Nothing in these Terms excludes or limits
              liability for:
            </p>
            <ul className="list-disc list-inside ml-4 space-y-1">
        ...
        <section>
          ...
          <p className="text-gray-300 text-sm leading-relaxed">
            You agree to indemnify, defend, and hold harmless Elec-Mate and its officers, directors,
        ...
        <section>
          ...
          <p className="text-gray-300 text-sm mt-3">
            ...
            our Services after changes constitutes acceptance of the modified Terms. If you disagree
            with changes, you must stop using our Services and close your account.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3 text-gray-300 text-sm">
            ...
            <p>
              <strong className="text-white">15.3 Waiver:</strong> Our failure to enforce any right
              or provision does not constitute a waiver of that right or provision.
            </p>
            ...
            <p>
              <strong className="text-white">15.5 Force Majeure:</strong> We are not liable for any
              failure or delay caused by circumstances beyond our reasonable control.
            </p>
