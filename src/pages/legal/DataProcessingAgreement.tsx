      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="space-y-3 text-gray-300">
            <p>
              <strong className="text-white">"Controller"</strong> means the organisation (you) that
            ...
            <p>
              ...
              to an identified or identifiable natural person as defined under UK GDPR.
            </p>
            <p>
              <strong className="text-white">"Processing"</strong> means any operation performed on
              personal data, including collection, storage, use, and deletion.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-300 mb-3">
            This DPA governs the processing of personal data in connection with Elec-Mate's employer
            services, including:
          </p>
        ...
        <section>
          ...
          <p className="text-gray-300 mb-3">
            Where personal data is transferred outside the UK, we ensure appropriate safeguards are
            in place:
          </p>
          <ul className="text-gray-300 text-sm space-y-2 list-disc list-inside">
            <li>
            ...
            <li>
              <strong className="text-white">USA:</strong> Standard Contractual Clauses (SCCs) with
            ...
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Enterprise customers requiring a countersigned Data Processing Agreement should
                    contact our legal team. We can provide customised DPAs for specific
                    requirements.
                  </p>
                </div>
              </div>
