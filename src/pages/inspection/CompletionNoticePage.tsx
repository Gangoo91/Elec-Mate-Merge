...
export default function CompletionNoticePage() {
  ...
  const handlePhotoCapture = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    for (const file of Array.from(files)) { const reader = new FileReader(); reader.onload = () => { setData((prev) => ({ ...prev, photos: [...prev.photos, reader.result as string] })); }; reader.readAsDataURL(file); }
  };
