...
const quickCheckQuestions = [
  {
    ...
    options: ['0.5 m/s', '1.0 m/s', '2.0 m/s', '1.5 m/s'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['1 hour', '30 minutes', '10 minutes', '2 hours'],
    correctIndex: 0,
    explanation:
...
const HNCModule8Section1_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 1 · Subsection 6"
      ...
      <HubBody>
        ...
        <ConceptBlock title="System Flushing and Pre-Commissioning Cleaning">
          ...
          <p>
            <strong>Why Flushing is Essential</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Debris removal:</strong> Swarf, solder, flux residue and pipe scale can block
              valves, pumps and heat exchangers
            </li>
            <li>
              <strong>Pump protection:</strong> Abrasive particles damage pump impellers and seals
            </li>
            <li>
              <strong>Heat transfer:</strong> Deposits reduce heat exchanger efficiency
            </li>
            <li>
              <strong>Corrosion prevention:</strong> Flux residues are corrosive and must be removed
            </li>
            <li>
              <strong>Warranty compliance:</strong> Many manufacturers require evidence of proper
              flushing
            </li>
          </ul>
          <p>
            <strong>BSRIA Flushing Procedure</strong>
          </p>
          <p>
            <strong>Flushing Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Flushing Methods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Flushing Sequence</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Step 3:</strong> Open all valves (lockshields, zone valves, TRVs fully open)
            </li>
            <li>
            ...
            <li>
              <strong>Step 6:</strong> Remove temporary strainers and inspect permanent strainers
            </li>
          </ul>
          <p>
          ...
          <p>
            For heavily contaminated systems or where water-only flushing is insufficient, chemical
          ...
          <p>
            <strong>Documentation:</strong> Record flushing dates, methods used, duration and visual
            inspection results. Photograph the discharge water at start and end of flushing for
            evidence of cleanliness achieved.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Filling, Pressurising and Water Treatment">
          <p>
            After successful flushing, the system must be correctly filled, vented, pressure tested
            and treated with appropriate chemicals. This stage establishes the baseline system
            integrity and water quality essential for long-term reliable operation.
          </p>
          <p>
            <strong>System Filling Procedure</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fill point:</strong> Connect to lowest point to allow air to rise and escape
            </li>
            <li>
              <strong>Fill rate:</strong> Slow enough to allow air venting (avoid air entrainment)
            </li>
            <li>
              <strong>Air venting:</strong> Open all manual air vents, check AAVs are functioning
            </li>
            <li>
          ...
          <p>
            <strong>Hydraulic Pressure Testing</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Water Treatment Requirements (BS 7593)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Concentration:</strong> Manufacturer's recommended level, verified by on-site
              test
            </li>
            <li>
            ...
            <li>
              <strong>Antifreeze:</strong> Where freeze protection required (e.g., solar thermal,
              exposed locations)
            </li>
          </ul>
          <p>
            <strong>Water Quality Testing</strong>
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Inhibitor concentration:</strong> Proprietary test kit — Manufacturer's
              specification
            </li>
            <li>
              <strong>pH:</strong> pH strips or meter — 7.5 - 9.0 (typically)
            </li>
            <li>
              <strong>Total dissolved solids:</strong> TDS meter — &lt;500 ppm (varies)
            </li>
            <li>
              <strong>Appearance:</strong> Visual inspection — Clear, no sediment
            </li>
          </ul>
          <p>
            <strong>Record keeping:</strong> Document all water treatment products used,
            concentrations achieved and test results. Affix a permanent label to the system stating
            treatment type and date for future maintenance reference.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="System Balancing to Design Flow Rates">
          ...
          <p>
            <strong>Why Balancing Matters</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Balancing Methods</strong>
          </p>
          <p>
            <strong>Proportional Balancing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>PICV (Pressure Independent) Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fixed orifice valves:</strong> Measure differential pressure across orifice,
              use valve chart to determine flow
            </li>
            <li>
              <strong>Ultrasonic flow meter:</strong> Clamp-on device measures flow non-invasively
            </li>
            <li>
              <strong>Temperature differential:</strong> Calculate flow from Q = m x Cp x delta-T
              (requires accurate thermometers)
            </li>
            <li>
          ...
          <p>
            <strong>Balancing Procedure (Proportional Method)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Step 1:</strong> Identify index circuit (longest run, highest resistance path)
            </li>
            <li>
            ...
            <li>
              <strong>Step 6:</strong> Working from index towards pump, adjust each valve to achieve
              proportional flow
            </li>
            <li>
          ...
          <p>
            <strong>Design Flow Rate Calculation</strong>
          </p>
          ...
          <p>
            <strong>Acceptable Tolerances</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Record all values:</strong> Document design flow rate, measured flow rate, valve
            position (turns open) and differential pressure for each circuit. These records are
            essential for future troubleshooting and re-commissioning.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Performance Testing and Handover Documentation">
          <p>
            Performance testing verifies that the complete heating system achieves its design intent
            under realistic operating conditions. Comprehensive handover documentation ensures
            compliance with Building Regulations and provides the building operator with the
            information needed for effective ongoing management.
          </p>
          <p>
            <strong>Witnessed Performance Testing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Conditions:</strong> Test under realistic load conditions (heating season or
              artificial load)
            </li>
            <li>
              <strong>Parameters:</strong> Temperatures, flow rates, pressures, control response,
              noise levels
            </li>
            <li>
              <strong>Witness:</strong> Client, consulting engineer or clerk of works to sign off
              results
            </li>
          </ul>
          <p>
            <strong>Performance Test Checklist</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Distribution and Controls</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Notice:</strong> Building Control must be notified of commissioning completion
            </li>
            <li>
              <strong>Certificate:</strong> Commissioning certificate required (domestic: Benchmark,
              commercial: BSRIA format)
            </li>
            <li>
          ...
          <p>
            <strong>Commissioning Records Required</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pressure test certificate:</strong> Test pressure, duration, result, gauge
              calibration — Essential
            </li>
            <li>
              <strong>Flushing record:</strong> Method, duration, cleanliness achieved — Essential
            </li>
            <li>
              <strong>Water treatment record:</strong> Products used, concentrations, test results —
              Essential (BS 7593)
            </li>
            <li>
              <strong>Balancing report:</strong> Design vs achieved flow rates, valve positions —
              Essential
            </li>
            <li>
              <strong>Performance test results:</strong> Witnessed test data, signatures —
              Commercial projects
            </li>
            <li>
              <strong>Control settings:</strong> Set points, schedules, parameters — Essential
            </li>
          </ul>
          <p>
            <strong>Building Log Book Contents</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Control system documentation:</strong> Descriptions, schematics, programming
            </li>
            <li>
          ...
          <p>
            <strong>Client Training Requirements</strong>
          </p>
          <p>Handover should include training for building operators:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>System operation:</strong> Normal start-up, shutdown and seasonal changeover
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A sealed heating system has a maximum working pressure of 2.5
            bar and is protected by a 3 bar pressure relief valve. What test pressure should be used
            and why?
          </p>
          ...
          <p>
            <strong>Question:</strong> A system has three radiator circuits with design flow rates
            of 2.0, 1.5 and 1.0 L/min respectively. The index circuit (2.0 L/min) valve is fully
            open. When measured, it achieves 2.2 L/min. The second circuit reads 1.8 L/min with its
            valve fully open. Calculate the required adjustment.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Pre-commissioning:</strong> Install strainers, clean pipework, flush system
              thoroughly
            </li>
            <li>
              <strong>2. Pressure test:</strong> Hydraulic test at 1.5x working pressure for minimum
              1 hour
            </li>
            <li>
            ...
            <li>
              <strong>4. Static commissioning:</strong> Check all components installed correctly,
              valves operational
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Inadequate flushing:</strong> Leads to pump damage, blocked heat exchangers,
                valve failures
              </li>
              <li>
              ...
              <li>
                <strong>Incomplete records:</strong> Creates compliance issues, maintenance problems
              </li>
              <li>
                <strong>No client training:</strong> System operated incorrectly, premature failures
              </li>
            </ul>
          }
