...
const DESCRIPTION =
  'Learn essential site housekeeping practices and safety signage requirements for electrical work, ensuring clean and safe work environments.';
  ...
  const quickCheckQuestions = [
    {
      ...
      correctIndex: 1,
      explanation:
        'Site housekeeping refers to how clean, tidy, and organised a worksite is, including proper storage and management of tools, materials, and waste.',
    },
    {
      id: '2',
      ...
      correctIndex: 2,
      explanation:
        'Warning signs are yellow with black symbols to indicate that a hazard is present.',
    },
  ];
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Site housekeeping refers to how clean, tidy, and organised a worksite is, including how tools, materials, waste, and equipment are stored or managed.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'Poor housekeeping causes trips on leads/tools, blocked emergency exits, fire risks, delays in finding equipment, and reduced productivity.',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      correctAnswer: 3,
      explanation:
        'Prohibition signs (red circle with line) are used to show actions that are not allowed or forbidden.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'False. Fire exit signs are green with white symbols as they indicate safe conditions and emergency escape routes.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'Everyone on site is responsible for housekeeping. While site supervisors and managers have overall responsibility, each worker must maintain their own work area and follow housekeeping procedures throughout the day.',
    },
    {
      question: 'How often should tools and materials be tidied?',
      answer:
        "Tools and materials should be tidied continuously throughout the day ('tidy as you go') and properly stored at the end of each work period. This prevents accumulation of mess and maintains safety standards.",
    },
    {
      question: 'What should I do if I notice damaged safety signage?',
      answer:
        'Report damaged, missing, or unclear safety signage immediately to your supervisor. Do not ignore it - proper signage is a legal requirement and essential for site safety.',
    },
    {
      question: 'Are there specific regulations for safety signage?',
      answer:
        'Yes, the Health and Safety (Safety Signs and Signals) Regulations 1996 set out legal requirements for workplace signage, including colours, symbols, positioning, and maintenance standards.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-foreground">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Housekeeping:</strong> Clean, tidy, organised worksites prevent accidents.
                </li>
                <li>
                  <strong>Safety first:</strong> Poor housekeeping causes trips, fires, and delays.
                </li>
                <li>
                  <strong>Signage:</strong> Legal requirement to inform and warn of hazards.
                </li>
                <li>
                  <strong>Types:</strong> Warning, mandatory, prohibition, and safe condition signs.
                </li>
                <li>
                  <strong>Professional image:</strong> Clean sites impress clients and improve
                  productivity.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Messy work areas, blocked exits, missing/damaged signs.
                </li>
                <li>
                  <strong>Use:</strong> Tidy as you go, proper waste disposal, sign reporting
                  systems.
                </li>
                <li>
                  <strong>Apply:</strong> Daily housekeeping checks, signage maintenance, hazard
                  awareness.
                </li>
              </ul>
            </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <ul className="space-y-3 text-foreground">
            <li className="flex items-start gap-3">
              ...
              <span>
                Understand what housekeeping means in a construction or electrical setting
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
          ...
          <div className="space-y-6">
            <div className="bg-elec-yellow/5 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <p className="font-medium text-blue-800 dark:text-white mb-3">
                Housekeeping refers to how clean, tidy, and organised a worksite is — including how
                tools, materials, waste, and equipment are stored or managed.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
              <p className="font-medium text-purple-800 dark:text-purple-200 mb-3">
                Safety signs are used to inform, instruct, warn, or prohibit certain actions. These
                are required by law under the Health and Safety (Safety Signs and Signals)
                Regulations 1996.
              </p>
            </div>
            ...
            <div className="grid gap-4">
              <div className="bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                ...
                <p className="text-yellow-700 dark:text-yellow-300 text-sm">
                  Yellow with black symbol - Hazard present
                </p>
              </div>
              ...
              <div className="bg-elec-yellow/5 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                ...
                <p className="text-blue-700 dark:text-elec-yellow text-sm">
                  Blue with white symbol - Action required
                </p>
              </div>
              ...
              <div className="bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-lg p-4">
                ...
                <p className="text-red-700 dark:text-elec-yellow text-sm">
                  Red circle with line - Action not allowed
                </p>
              </div>
              ...
              <div className="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-lg p-4">
                ...
                <p className="text-green-700 dark:text-green-300 text-sm">
                  Green with white symbol - Safety information
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mb-8 border-l-4 border-teal-500 p-6 bg-card rounded-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-foreground">
              Advanced Safety Signage Requirements
            </h2>
          </div>
        ...
        <div className="mb-8 border-l-4 border-amber-500 p-6 bg-card rounded-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-foreground">
              Case Study: Office Rewiring Project
            </h2>
          </div>
