  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'A short circuit occurs when live conductors at different potentials (such as line and neutral) come into direct contact, creating a path of very low resistance.',
    },
    {
      id: 2,
      ...
      correctAnswer: 2,
      explanation:
        'During a short circuit, current increases dramatically to very high levels because the resistance of the circuit becomes very low.',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Short circuits are dangerous because they allow extremely high fault currents that cause overheating, arcing, equipment damage, and can lead to fires.',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'False. Overloads are excess current flowing through a load, while short circuits are abnormal current paths with very low resistance that bypass the load entirely.',
    },
    {
      id: 8,
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                This creates an unintended path that bypasses the normal load, allowing current to
                flow at levels far exceeding the circuit's design capacity.
              </p>
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <strong className="text-white">Line to Neutral:</strong> Most common in
                    single-phase systems
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <strong className="text-white">Line to Line:</strong> Between phase conductors
                    in three-phase systems
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <strong className="text-white">Line to Earth:</strong> Phase conductor touching
                    earthed metalwork
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <strong className="text-white">Three-phase:</strong> All phases short-circuited
                    together
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <strong className="text-white">Arcing faults:</strong> Intermittent contact
                    causing arcing
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
                <p className="text-sm text-red-200/80">
                  <strong className="text-red-300">Immediate Danger:</strong> Short circuits can
                  generate fault currents of thousands of amperes within milliseconds, creating
                  intense heat, dangerous arcing, and potential for explosion or fire.
                </p>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-red-500/10 rounded-lg p-4 border border-red-500/30">
                ...
                <ul className="space-y-1.5 text-sm text-red-200/80">
                  <li>
                    • <strong className="text-red-300">Arcing:</strong> Intense electrical arcs
                    reaching thousands of degrees
                  </li>
                  <li>
                    • <strong className="text-red-300">Fire risk:</strong> Ignition of surrounding
                    materials
                  </li>
                  <li>
                    • <strong className="text-red-300">Explosion:</strong> Rapid heating causing
                    metal expansion and arc blast
                  </li>
                  <li>
                    • <strong className="text-red-300">Toxic gases:</strong> Burning insulation
                    releasing harmful fumes
                  </li>
                  <li>
                    • <strong className="text-red-300">Electric shock:</strong> Touch potentials and
                    step potentials
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <ul className="space-y-1.5 text-sm">
                  <li>
                    • <strong className="text-white">Equipment destruction:</strong> Severe damage
                    to electrical components
                  </li>
                  <li>
                    • <strong className="text-white">System instability:</strong> Voltage dips
                    affecting other circuits
                  </li>
                  <li>
                    • <strong className="text-white">Power outages:</strong> Protective device
                    operation causing loss of supply
                  </li>
                  <li>
                    • <strong className="text-white">Data loss:</strong> Sudden power interruption
                    to IT systems
                  </li>
                  <li>
                    • <strong className="text-white">Process disruption:</strong> Industrial systems
                    shutting down
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
                <p className="text-sm text-red-200/80">
                  <strong className="text-red-300">Arc Flash Hazard:</strong> Arc flash incidents
                  can reach temperatures of 20,000°C (four times hotter than the sun's surface) and
                  produce pressure waves capable of causing severe burns and hearing damage. Proper
                  PPE and safety procedures are essential when working on live equipment.
                </p>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <ul className="space-y-1.5 text-sm">
                  <li>
                    • <strong className="text-white">Fuses (BS 88, BS 1361):</strong> Reliable
                    interruption, high breaking capacity
                  </li>
                  <li>
                    • <strong className="text-white">MCBs (BS EN 60898):</strong> Automatic reset,
                    precise characteristics
                  </li>
                  <li>
                    • <strong className="text-white">MCCBs (BS EN 60947):</strong> High current
                    ratings, adjustable settings
                  </li>
                  <li>
                    • <strong className="text-white">RCBOs:</strong> Combined overcurrent and earth
                    fault protection
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <ul className="space-y-1.5 text-sm">
                  <li>
                    • <strong className="text-white">Breaking capacity:</strong> Must exceed
                    prospective short circuit current
                  </li>
                  <li>
                    • <strong className="text-white">Discrimination:</strong> Selective operation
                    between protective devices
                  </li>
                  <li>
                    • <strong className="text-white">Disconnection times:</strong> Maximum times
                    specified for safety
                  </li>
                  <li>
                    • <strong className="text-white">Let-through energy:</strong> Limitation of
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <ul className="space-y-1.5 text-sm">
                  <li>
                    • <strong className="text-white">Insulation resistance testing:</strong> Low
                    readings indicate potential problems
                  </li>
                  <li>
                    • <strong className="text-white">Visual inspection:</strong> Signs of
                    overheating, burning, or damage
                  </li>
                  <li>
                    • <strong className="text-white">Thermal imaging:</strong> Hot spots indicating
                    high resistance joints
                  </li>
                  <li>
                    • <strong className="text-white">Protective device operation:</strong> Repeated
                    tripping indicates faults
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 rounded-lg p-4 border border-orange-500/30">
                ...
                <ul className="space-y-1.5 text-sm text-orange-200/80">
                  <li>
                    • <strong className="text-orange-300">Immediate isolation:</strong> Switch off
                    supply if safe to do so
                  </li>
                  <li>
                    • <strong className="text-orange-300">Evacuation:</strong> Clear area of
                    personnel if arc flash risk
                  </li>
                  <li>
                    • <strong className="text-orange-300">Fire suppression:</strong> Use appropriate
                    extinguishing methods
                  </li>
                  <li>
                    • <strong className="text-orange-300">Medical attention:</strong> For any
                    injuries from arc flash or shock
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
                ...
                <ul className="space-y-1.5 text-sm text-red-200/80">
                  <li>
                    • <strong className="text-red-300">Never re-energise:</strong> Until fault is
                    found and rectified
                  </li>
                  <li>
                    • <strong className="text-red-300">Systematic approach:</strong> Logical
                    fault-finding methodology
                  </li>
                  <li>
                    • <strong className="text-red-300">Safe isolation:</strong> Proper isolation and
                    verification procedures
                  </li>
                  <li>
                    • <strong className="text-red-300">Competent person:</strong> Qualified
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
                <h4 className="font-medium text-red-300 mb-2">
                  Case Study: Lighting Circuit Short Circuit
                </h4>
                <p className="text-sm text-red-200/80">
                  During the installation of new LED downlights in an office ceiling, an electrician
                  experienced a dramatic short circuit that tripped the lighting MCB and caused a
                  small fire in the ceiling void.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-orange-500/10 border-l-2 border-orange-500/50">
                ...
                <p className="text-sm text-orange-200/80">
                  While fixing a recessed LED fitting to the ceiling, the electrician used a screw
                  that was too long. The screw penetrated through the plasterboard and pinched the
                  twin and earth cable supplying the lighting circuit. There was a loud bang, bright
                  flash, and the lighting MCB tripped immediately.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/10 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm text-elec-yellow/80">
                  The screw had penetrated the cable insulation, causing the line and neutral
                  conductors to come into contact through the metal screw. This created a short
                  circuit with extremely low resistance, allowing a fault current of approximately
                  1,500A to flow for the brief moment before the 6A Type B MCB operated.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-purple-500/10 border-l-2 border-purple-500/50">
                ...
                <p className="text-sm text-purple-200/80">
                  The intense heat generated by the fault current caused the cable insulation to
                  burn, creating smoke and a small fire in the ceiling void. The screw was welded to
                  the cable by the arcing, and approximately 500mm of cable was damaged by heat.
                  Fortunately, the ceiling insulation was mineral wool which did not ignite.
                </p>
              </div>
          ...
          <section className="mb-10">
            <div className="p-5 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white leading-relaxed">
                ...
                causing intense arcing, fire risks, and potential injury. BS 7671 requires
                appropriate protective devices with sufficient breaking capacity to interrupt fault
                currents safely. Prevention relies on quality installation practices and proper
                maintenance, while systematic investigation following safe isolation procedures is
                crucial when faults occur.
              </p>
            </div>
          </section>
