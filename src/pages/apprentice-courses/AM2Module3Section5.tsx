...
const AM2Module3Section5 = () => {
  ...
  const quickCheckQuestions: Array<{
    ...
    },
    {
      ...
      options: ['Regulation 134.1.1', 'Regulation 526', 'Regulation 522', 'Regulation 559'],
      correctIndex: 1,
      explanation:
        'Regulation 526 covers joints and connections, requiring them to be both electrically and mechanically sound.',
    },
    {
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 0,
      explanation:
        "Regulation 134.1.1 requires electrical work to be completed in a 'proper and workmanlike manner'.",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Regulation 526 specifically covers electrical connections, requiring them to be electrically and mechanically sound.',
    },
    {
      id: 6,
  ...
  return (
    ...
    >
        ...
        <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-white">
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Height, distance, and position must match specification exactly. No "close
                    enough" tolerance.
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    No substitutions allowed. Wrong cable = automatic failure regardless of
                    functionality.
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    MCB/RCBO ratings must correspond to drawing specifications. No approximations.
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Proper separation in trunking/conduit as per BS 7671. Mixing circuits fails
                    safety.
                  </p>
                </div>
              </li>
          ...
          <div className="bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800/30 rounded-lg p-4">
            ...
            <ul className="space-y-1 text-sm text-orange-700 dark:text-elec-yellow">
              ...
              <li>
                • <strong>Reference drawings constantly</strong> - Don't rely on memory for
                positions
              </li>
              <li>
          ...
          <div className="border border-white/10 rounded-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-white">
              ...
              <li className="flex gap-2">
                <span className="font-medium text-green-400 min-w-[20px]">•</span>
                <div>
                  <strong>Accessories mounted perfectly</strong> - Level, flush, and square to
                  surface
                </div>
              </li>
              <li className="flex gap-2">
        ...
        <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-white">
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Foundation requirement - all work must meet professional installation standards
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Joints and connections must be electrically and mechanically sound
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Adequate support, protection, and identification of all conductors
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Applied where specification demands (sockets, special locations, outdoor
                    circuits)
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Line, neutral, and earth properly identified and connected throughout
                  </p>
                </div>
              </li>
            </ul>
          ...
          <div className="bg-transparent border border-elec-yellow/20 rounded-lg p-4">
            ...
            <ul className="space-y-1 text-sm text-white">
              ...
              <li>
                • <strong>Verify identification requirements</strong> - All conductors properly
                marked
              </li>
              <li>
          ...
          <div className="border border-white/10 rounded-lg p-4">
            ...
            <div className="bg-muted/50 rounded p-3 mb-3">
              <p className="text-sm text-white italic">
                "Does this installation look like a real electrician did it, or like rushed
                training-bay work?"
              </p>
            </div>
            <ul className="space-y-2 text-sm text-white">
      ...
      <AM2ContentCard
        title="5. Common Candidate Mistakes - NET Findings Analysis"
        icon={AlertTriangle}
      >
        <div className="space-y-4">
          <div className="border border-white/10 rounded-lg p-4">
            ...
            <ol className="space-y-2 text-sm text-white">
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Sockets, switches crooked or at wrong heights - immediate visual impact failure
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Safety critical failure - exposed copper at terminations
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
      ...
      {/* Practical Guidance */}
      <AM2ContentCard
        title="6. Practical Guidance - Professional Installation Techniques"
        icon={Target}
      >
        <div className="space-y-4">
          <div className="border border-white/10 rounded-lg p-4">
            ...
            <ol className="space-y-2 text-sm text-white">
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Accuracy starts with careful layout. Use proper measuring tools and double-check
                    positions.
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    On accessories and trunking runs. Crooked installation immediately visible to
                    assessor.
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Don't rush cable preparation. Nicked conductors or wrong strip lengths lose
                    marks.
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Don't leave CPC sleeving to the end. Apply during cable preparation phase.
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Keep conductors straight, bend neatly, avoid tangles. Group by function.
                  </p>
                </div>
              </li>
              <li className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Step back regularly: would you be happy to hand this over to an NICEIC
                    inspector?
                  </p>
                </div>
              </li>
        ...
        <div className="space-y-4">
          <div className="bg-transparent border border-elec-yellow/20 rounded-lg p-4">
            ...
            <p className="text-sm text-white italic mb-3">
              "If your installation wouldn't pass a customer handover or NICEIC inspection, it won't
              pass AM2."
            </p>
            <p className="text-sm text-white">
              This single principle encompasses all workmanship standards. Every decision should
              pass this test.
            </p>
          </div>
          ...
          <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800/30 rounded-lg p-4">
            <h4 className="font-medium text-green-800 dark:text-green-200 mb-2">
              Assessment Success Requirements
            </h4>
            <ul className="space-y-1 text-sm text-green-700 dark:text-green-300">
              <li>
              ...
              <li>
                • <strong>BS 7671 compliance</strong> - Regulations 134.1.1, 526, Part 5
              </li>
            </ul>
          </div>
