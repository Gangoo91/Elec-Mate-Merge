...
const AM2Module3Section5 = () => {
  ...
  const quickCheckQuestions: Array<{
    ...
    },
    {
      ...
      options: ['Regulation 134.1.4', 'Regulation 559', 'Regulation 522', 'Regulation 526.1'],
      correctIndex: 3,
      explanation:
  ...
  const quizQuestions = [
    {
      ...
      options: ['Regulation 526.5', 'Regulation 134.1.4', 'Regulation 522', 'Regulation 411'],
      correctAnswer: 1,
      explanation:
    ...
    },
    {
      ...
      options: ['5mm if secure', '1mm', 'None - zero tolerance', '2mm'],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: ['Regulation 134', 'Regulation 526.5', 'Regulation 411', 'Regulation 522'],
      correctAnswer: 1,
      explanation:
    ...
    },
    {
      id: 8,
      question:
        'How does neatness affect your AM2 result if the installation is electrically safe?',
      options: [
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/am2/module3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Professional workmanship standards, accuracy requirements and NET compliance for AM2
          assessment success - master the critical details that determine pass or fail.
        </p>
        ...
        <ConceptBlock title="1. Accuracy to Specification - Zero Tolerance Standards">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Accessories positioned exactly as per drawings.</strong> Height, distance, and
              position must match specification exactly. No "close enough" tolerance.
            </li>
            <li>
            ...
            <li>
              <strong>Protective devices match exactly.</strong> MCB/RCBO ratings must correspond to
              drawing specifications. No approximations.
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Mark out before drilling/fixing</strong> - Accuracy starts with careful layout
            </li>
            <li>
              <strong>Use proper measuring tools</strong> - Steel rules, spirit levels, laser levels
              for precision
            </li>
            <li>
        ...
        <ConceptBlock title="3. Compliance with BS 7671 - Regulatory Framework">
          <div className="space-y-4">
            <p className="text-ios-callout text-white">
              These are the verbatim regs an AM2 assessor will hold your installation against. Read
              the clause text — it's the language you should reach for when asked to justify what
              you've fitted.
            </p>
          </div>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              This is the workmanship clause. On AM2 day it covers torque, sleeving, the absence of
              bare copper at terminals, and the mechanical security of every gland and clamp the
              assessor lifts a lid on.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              under thermal cycling fails this reg. It's why you torque to the manufacturer's figure
              and don't double up flex into a single rigid terminal.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              complying with the appropriate product standard; (b) an equipment enclosure complying
              with the appropriate product standard; (c) an enclosure partially formed or completed
              with building material which is non-combustible when tested to BS 476-4."
            </>
          }
          meaning={
            <>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              This is what the assessor is testing when they look at how you've supported, clipped,
              bushed and protected cables — including grommets where cables enter metal enclosures
              and capping in chases.
            </>
          }
        ...
        <ConceptBlock title="5. Common Candidate Mistakes - NET Findings Analysis">
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Trunking overfilled or lids not fitted properly (35% of cases).</strong> Poor
              containment standards and presentation.
            </li>
            <li>
            ...
            <li>
              <strong>Messy or incomplete paperwork (28% of cases).</strong> Documentation standards
              affect overall assessment.
            </li>
          </ol>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Example 3:</strong> Candidate rushed containment, left trunking lid with gaps.
              Assessor deducted marks for poor finish.
            </li>
            <li>
              <strong>Example 4:</strong> In real work, installation failed EICR inspection because
              CPC sleeving missing. Same error in AM2 = marks lost.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="6. Practical Guidance - Professional Installation Techniques">
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Mark out before drilling/fixing.</strong> Accuracy starts with careful layout.
              Use proper measuring tools and double-check positions.
            </li>
            <li>
            ...
            <li>
              <strong>Sleeve before termination.</strong> Don't leave CPC sleeving to the end. Apply
              during cable preparation phase.
            </li>
            <li>
            ...
            <li>
              <strong>Self-inspect continuously.</strong> Step back regularly: would you be happy to
              hand this over to an NICEIC inspector?
            </li>
          </ol>
          <p>
        ...
        <ConceptBlock title="Section Summary - Critical Success Factors">
          <p>
            ...
            installation wouldn't pass a customer handover or NICEIC inspection, it won't pass AM2."
            This single principle encompasses all workmanship standards. Every decision should pass
            this test.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Perfect geometric alignment</strong> - Square, straight, and level throughout
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Candidate finishes the install electrically perfect — every test passes, every circuit
              operates — but accessories are off-level by 5–10°, trunking lids have visible gaps,
              and the DB has cables crossing in front of MCBs. They assume the assessor will only
              mark the electrical side. Result: workmanship marks tank, and the overall section can
              drop below the pass threshold.
            </>
          }
          doInstead={
            <>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              other and the install works fine. You've got two hours of testing and paperwork left.
            </>
          }
          whatToDo={
            <>
          ...
          whyItMatters={
            <>
              "Heights, positions, routes exactly as shown" is in the NET assessment criteria. Even
              safe deviations from the drawing lose marks — the assessor isn't grading whether your
              version is acceptable, they're grading whether it matches the drawing. On a real site
              this is the same conversation with a clerk of works.
            </>
          }
        />
        ...
        <ConceptBlock title="Knowledge Check - Workmanship Standards">
          <p className="text-sm text-white mb-6">
            Test your understanding of accuracy, neatness and BS 7671 compliance requirements. This
            quiz covers key assessment criteria and common failure points.
          </p>
