...
const DESCRIPTION =
  'Creating professional electrical design drawings, schematic diagrams, and layout plans using BS EN 60617 symbols and industry-standard conventions.';

const quickCheckQuestions = [
  {
    id: 'check-1',
    question: 'What standard defines the graphical symbols used in electrical drawings in the UK?',
    options: ['BS 1363', 'BS EN 60617 (graphical symbols for diagrams)', 'BS 7671', 'BS 5839'],
    correctIndex: 1,
    explanation:
      "BS EN 60617 is the standard that defines graphical symbols for use in electrical diagrams. These symbols are internationally recognised and ensure consistency across the industry. BS 7671 references these symbols but doesn't define them.",
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'A single-line diagram (also called one-line diagram) shows the electrical flow and relationship between major components using a single line to represent conductors, regardless of the number of phases. It provides an overview of the power distribution without physical layout details.',
  },
  {
    id: 'check-3',
    question:
      'When drawing a circuit diagram for a final circuit, what essential information should be included?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'A complete circuit diagram should include all information needed for installation and verification: circuit reference number, protective device type and rating, cable type and size, circuit length for volt drop calculations, and the total connected load or current demand.',
  },
  {
    id: 'check-4',
    question:
      'What type of drawing shows the physical layout of electrical equipment within a building?',
    options: [
      'Schematic diagram',
      'Single-line diagram',
    ...
    correctIndex: 2,
    explanation:
      'Layout or floor plan drawings show the physical position of electrical equipment within the building structure. They are typically overlaid on architectural plans and show socket outlets, light fittings, distribution boards, cable routes, and other equipment in their actual locations.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "Dashed or dotted lines typically indicate concealed elements - cables installed in walls, floors, or above ceilings where they won't be visible in the finished building. Solid lines indicate surface-mounted or visible elements.",
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'The title block provides essential administrative information: project identification, drawing title describing its content, scale, date of issue, revision history, who prepared and checked it, and a unique drawing number. This enables proper document control and reference.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Standard symbols to BS EN 60617 are universally understood by electricians, other trades, inspectors, and clients. Using non-standard symbols can cause misinterpretation, installation errors, and delays while people try to understand unfamiliar notation.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'A scaled drawing maintains proportional relationships between elements. If drawn at 1:50 scale, 1mm on the drawing represents 50mm in reality. This allows cable lengths to be estimated, clearances to be verified, and positions to be accurately set out on site.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Wiring diagrams show how conductors physically connect to equipment terminals, enabling assembly and maintenance. Circuit diagrams show the electrical principle of operation. Both may be needed: the circuit diagram to understand function, the wiring diagram to make connections.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      "A 'For Construction' or 'Issued for Construction' status indicates the drawing has been through appropriate review and approval processes and may be used for actual installation work. Earlier statuses like 'Draft' or 'For Comment' indicate documents not yet approved for construction use.",
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      "Cross-referencing enables efficient navigation of drawing sets. A floor plan might reference 'See Drawing E-401 for distribution board details' rather than repeating information. This reduces duplication, ensures consistency, and helps users locate all relevant information.",
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      "Schematic or wiring diagrams show internal connections within equipment. A motor starter schematic would show contactors, overloads, control circuits, and their interconnections. The single-line diagram would simply show 'motor starter' as a single block symbol.",
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Proper revision control requires incrementing the revision indicator (A to B, or 1 to 2), clouding or otherwise marking changed areas, recording the change description in the revision history, updating the date, and formally re-issuing. This provides audit trail and prevents use of superseded information.',
  },
  {
    id: 10,
    question:
      'What scale is typically used for detailed electrical drawings showing internal distribution board arrangements?',
    options: ['1:500', '1:10 or 1:20', '1:100', 'Not to scale'],
    correctAnswer: 1,
    explanation:
      'Detail drawings showing internal arrangements of equipment (distribution board internals, control panel layouts) typically use larger scales like 1:10 or 1:20 to show sufficient detail. Floor plans might use 1:50 or 1:100, while site plans might use 1:200 or 1:500.',
  },
  {
    id: 11,
    ...
    correctAnswer: 1,
    explanation:
      "NTS means 'Not To Scale'. This indicates the drawing is for general arrangement or diagrammatic purposes only - elements may not be proportionally sized and measurements should not be scaled from the drawing. Actual dimensions should be obtained from dimensions shown or field measurement.",
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      'As-Built drawings record what was actually installed, which often differs from design intent due to site conditions, variations, and practical adjustments. They are essential for future maintenance, alterations, and fault finding. They form part of the O&M manual and health and safety file.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'A good drawing is clear, accurate, and complete. Use appropriate line weights (thicker for emphasis), consistent symbols to standards, logical layout with adequate spacing, complete title block and revision history, proper cross-referencing, and notes explaining non-standard items. The test is whether someone unfamiliar with the project can use it correctly.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>BS EN 60617:</strong> Standard symbols for electrical diagrams
              </li>
              <li>
                <strong>Drawing Types:</strong> Layout, schematic, wiring, single-line
              </li>
              <li>
                <strong>Title Block:</strong> Essential project and revision information
              </li>
              <li>
                <strong>Scale:</strong> Enables measurements from drawings
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Missing title blocks, non-standard symbols, no scales
              </li>
              <li>
                <strong>Use:</strong> Consistent line weights and symbol conventions
              </li>
              <li>
                <strong>Apply:</strong> Revision control with clouding and history
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Electrical design documentation typically comprises several types of drawings, each
              serving a specific purpose. Understanding when to use each type - and what information
              each should contain - is fundamental to producing professional documentation.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Electrical drawings use standardised symbols defined in BS EN 60617. Using these
              consistently ensures drawings are understood by all parties - electricians, other
              trades, inspectors, and clients - without ambiguity.
            </p>
            ...
            <p>
              Line conventions are equally important: solid lines for visible or surface elements,
              dashed lines for concealed elements, different line weights to distinguish between
              different cable sizes or importance levels, and consistent use of colour where colour
              printing is available.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> If you must use a non-standard symbol, include a clear
              legend explaining its meaning. Non-standard symbols should be the exception, not the
              rule.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The purpose of a drawing is to communicate design intent accurately. Every drawing
              should contain sufficient information for its intended purpose, without unnecessary
              clutter that obscures important details.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper drawing management ensures the correct version is always used. On a
              construction project, using superseded drawings can result in incorrect installation,
              abortive work, and potentially dangerous outcomes.
            </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <ul className="text-white space-y-1">
                    ...
                    <li>
                      <strong>For Approval:</strong> Issued for formal review
                    </li>
                    <li>
                      <strong>For Construction:</strong> Approved for installation work
                    </li>
                    <li>
                      <strong>As-Built:</strong> Records actual installed conditions
                    </li>
                  </ul>
                </div>
                <div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Every drawing on site should be verified as current before
              use. Establish a procedure for replacing superseded drawings and ensure all team
              members understand the importance of using only current revisions.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Missing title blocks</strong> - Drawings without identification cannot be
                  controlled
                </li>
                <li>
                  <strong>Non-standard symbols</strong> - Creates confusion and misinterpretation
                </li>
                <li>
                  <strong>No revision control</strong> - Old versions remain in circulation
                </li>
                <li>
                  <strong>Overcrowded drawings</strong> - Too much information obscures important
                  details
                </li>
                <li>
                  <strong>Missing cross-references</strong> - Users cannot find related information
                </li>
                <li>
                  <strong>Inconsistent notation</strong> - Different conventions on different
                  drawings
                </li>
              </ul>
            </div>
