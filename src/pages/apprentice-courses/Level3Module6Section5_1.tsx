      ...
      <div className="border-b border-white/10 sticky top-0 z-50 bg-[#1a1a1a]/95 backdrop-blur-sm">
        <div className="px-4 sm:px-6 py-2">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module6-section5">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <header className="text-center mb-12">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3">
            Preparing Design Drawings and Schematics
          </h1>
          <p className="text-white/80">
            Creating professional electrical design documentation using standard symbols and conventions
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Types of electrical drawings and their purposes",
              "BS EN 60617 symbol conventions",
              "Creating clear and accurate layout drawings",
              "Single-line diagram development",
              "Title block and revision control procedures",
              "Drawing coordination with other disciplines"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module6-section5-5-2">
