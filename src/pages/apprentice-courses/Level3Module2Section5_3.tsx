      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3">
            Impact of Renewables on Earthing & Protection
          </h1>
          <p className="text-white/80">
            How environmental technologies affect earthing and protective systems
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "DC earth fault characteristics and protection methods",
              "Equipotential bonding requirements for PV arrays",
              "RCD type selection for renewable installations",
              "Surge protection device requirements",
              "Impact on TN and TT earthing systems",
              "Arc fault detection in DC systems"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module2-section5-2">
              <ArrowLeft className="w-4 h-4 mr-2" />
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module2-section5-4">
              Next: Load Balancing
