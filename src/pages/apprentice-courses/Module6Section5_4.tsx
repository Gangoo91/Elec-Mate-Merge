  ...
  const faqs = [
    {
      ...
      answer:
        'Generally 1 MΩ for most low-voltage circuits, though specific requirements may vary depending on the installation type and voltage rating.',
    },
    {
      question: 'Can environmental conditions affect test results?',
      answer:
        'Yes. Temperature, humidity, moisture, and contamination can all significantly impact insulation resistance readings.',
    },
    {
      question: 'What should I do if readings are borderline (close to 1 MΩ)?',
      answer:
        'Investigate further. Look for potential causes such as moisture, contamination, or poor connections before deciding whether to energise.',
    },
    {
      question: 'Is it safe to energise a circuit with readings just above 1 MΩ?',
      answer:
        "While technically compliant, it's good practice to investigate why readings are close to the minimum. Higher readings are expected in good installations.",
    },
    {
      question: 'How do I distinguish between genuine faults and test errors?',
      answer:
        'Repeat the test, check connections, verify isolation, and consider environmental factors. Consistent low readings usually indicate genuine issues.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <ul className="text-white/80 text-sm space-y-1">
              ...
              <li>
                • <strong>Use:</strong> BS 7671 minimum values as guidance
              </li>
              <li>
                • <strong>Check:</strong> Environmental factors affecting readings
              </li>
            </ul>
          </div>
            ...
            <div className="text-white/80 space-y-3 leading-relaxed">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Identify the minimum insulation resistance values specified in BS 7671
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-elec-yellow flex-shrink-0 mt-1" />
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                readings mean in practice - and when to take action - requires experience and
                knowledge.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-6 leading-relaxed">
              <p>
                ...
                reading of 1MΩ or below constitutes an automatic failure.
              </p>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>≤ 1MΩ:</strong> Automatic failure - circuit must not be energised
                  </li>
                  <li>
                    • <strong>0.5-1MΩ:</strong> Serious insulation breakdown requiring immediate
                    investigation
                  </li>
                  <li>
                    • <strong>&lt;0.5MΩ:</strong> Dangerous condition - potential imminent failure
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>1.1-2MΩ:</strong> Requires investigation before energising
                  </li>
                  <li>
                    • <strong>2.1-5MΩ:</strong> Monitor closely, consider environmental factors
                  </li>
                  <li>
                    • <strong>&gt;5MΩ:</strong> Generally satisfactory for most installations
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-6 leading-relaxed">
              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>10-50MΩ:</strong> Excellent condition, new or well-maintained cables
                  </li>
                  <li>
                    • <strong>5-10MΩ:</strong> Very good condition, suitable for energising
                  </li>
                  <li>
                    • <strong>2-5MΩ:</strong> Good condition but monitor trends over time
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
                <h3 className="font-medium text-orange-400 mb-3">
                  Borderline Readings (Requires Investigation)
                </h3>
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>1.5-2MΩ:</strong> May indicate ageing, moisture, or contamination
                  </li>
                  <li>
                    • <strong>1.1-1.5MΩ:</strong> Strong indication of developing problems
                  </li>
                  <li>
                    • <strong>1.01-1.1MΩ:</strong> Technically compliant but professionally
                    concerning
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>0.8-1MΩ:</strong> Insulation breakdown, investigate immediately
                  </li>
                  <li>
                    • <strong>0.3-0.8MΩ:</strong> Significant deterioration, likely moisture/damage
                  </li>
                  <li>
                    • <strong>&lt;0.3MΩ:</strong> Dangerous condition, potential short circuit risk
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-6 leading-relaxed">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>Temperature:</strong> Higher temps reduce readings by ~2% per °C above
                    20°C
                  </li>
                  <li>
                    • <strong>Humidity:</strong> &gt;80% relative humidity can halve resistance
                    values
                  </li>
                  <li>
                    • <strong>Moisture:</strong> Direct water contact can drop readings to &lt;0.1MΩ
                  </li>
                  <li>
                    • <strong>Contamination:</strong> Dust, grease, salt spray reduce surface
                    resistance
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>New cables (0-5 years):</strong> Typically 20-100MΩ+
                  </li>
                  <li>
                    • <strong>Mature cables (5-15 years):</strong> Usually 5-20MΩ in good condition
                  </li>
                  <li>
                    • <strong>Older cables (15-25 years):</strong> May show 2-8MΩ if well maintained
                  </li>
                  <li>
                    • <strong>Ageing cables (25+ years):</strong> Often 1-3MΩ, requiring close
                    monitoring
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-6 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
                <h3 className="font-medium text-orange-400 mb-3">
                  Investigation Before Energising (1.1-2MΩ)
                </h3>
                <ul className="text-sm space-y-2">
              ...
              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                <h3 className="font-medium text-green-400 mb-3">
                  Generally Safe to Energise (&gt;2MΩ)
                </h3>
                <ul className="text-sm space-y-2">
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-3 leading-relaxed">
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-elec-yellow flex-shrink-0 mt-1" />
                <span>
                  Good insulation typically shows readings well above the minimum - several MΩ is
                  normal
                </span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-elec-yellow flex-shrink-0 mt-1" />
                <span>
                  Borderline readings (close to 1MΩ) should be investigated even if they technically
                  comply
                </span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-elec-yellow flex-shrink-0 mt-1" />
                <span>
                  Consider environmental factors - moisture and humidity can temporarily reduce
                  readings
                </span>
              </div>
              <div className="flex items-start gap-2">
            ...
            <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
              ...
              <div className="text-white/80 text-sm space-y-3 leading-relaxed">
                <p>
                  ...
                  Initially concerned about widespread insulation failure, he investigated further.
                </p>
                <p>
                  He discovered that the consumer unit was located in a basement area with high
                  humidity and some water ingress. After the moisture issue was resolved and the
                  installation allowed to dry out, the same circuits showed readings above 5MΩ, well
                  within acceptable limits.
                </p>
                <p className="font-medium text-green-400 mt-3">
                  Lesson: Environmental factors can significantly affect readings. Don't immediately
                  assume permanent damage - investigate the root cause first.
                </p>
              </div>
            </div>
          </section>
