      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>LOLER:</strong> Governs all lifting operations and lifting equipment
              </li>
              <li className="pl-1">
                <strong>Reg 8:</strong> Every lift must be planned, supervised, carried out safely
              </li>
              <li className="pl-1">
                <strong>Reg 9:</strong> Thorough examination — 6 months (persons) / 12 months
                (loads)
              </li>
              <li className="pl-1">
                <strong>SWL:</strong> Safe working load must be clearly marked
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-2">
                ...
                its attachments used for anchoring, fixing or supporting it. "Load" includes any
                person or animal lifted by the equipment.
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Equipment:</strong> Cranes, hoists, chain blocks, MEWPs, scissor lifts,
                  tail lifts, forklifts, gin wheels, cable winches, panel lifters, lifting beams
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Not lifting equipment:</strong> Ladders (access only), escalators (in
                  normal use), stacker trucks below a certain threshold (depending on risk)
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  Every employer must ensure lifting equipment is of adequate strength and stability
                  for each load, having regard in particular to the stress induced at its mounting
                  or fixing point.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                    The equipment must be strong enough for the intended load — including dynamic
                ...
                <p className="text-sm text-elec-yellow/70 mt-2">
                  <strong>Maintenance example:</strong> Before using a ceiling-mounted lifting beam
                  in a substation to remove a transformer, you must verify the beam's SWL and
                  confirm the building structure can support the load. A competent structural
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  Where lifting equipment is used for lifting persons, additional requirements apply
                  to protect the persons being lifted:
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">
                    The carrier (platform, cage) must be prevented from falling — by reliable means
                    such as redundant suspension
                  </li>
                  <li className="pl-1">
                  ...
                  <li className="pl-1">
                    Means of evacuation must be provided in case the carrier becomes stranded
                  </li>
                  <li className="pl-1">
                    The equipment must have suitable devices to prevent the carrier falling
                    (overspeed governors, check valves)
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  Lifting equipment must be positioned or installed to reduce the risk of the
                  equipment or load striking a person, and to reduce the risk of the load drifting,
                  falling freely, or being released unintentionally. For electrical maintenance,
                  this means positioning MEWPs and hoists so that loads do not travel over occupied
                  areas, and ensuring adequate clearances from live equipment.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                    SWL for each configuration (e.g., different boom lengths, radii)
                  </li>
                  <li className="pl-1">
                    Equipment designed for lifting persons must be marked accordingly
                  </li>
                  <li className="pl-1">
                    Equipment NOT designed for lifting persons must be marked to that effect
                  </li>
                  <li className="pl-1">
                    Lifting accessories (slings, shackles) must show their SWL and identifying
                    markings
                  </li>
                </ul>
              </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>The people:</strong> Competent persons to plan, supervise and carry out
                  the lift; slingers, signallers, banksmen as required
                </li>
                <li className="pl-1">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  For routine, repetitive lifts (e.g., regularly using a MEWP to access cable tray
                  at a known location), the plan may be a generic method statement covering the
                  standard procedure. However, site-specific conditions must always be checked
                  before each lift — ground conditions may have changed, other activities may be in
                  progress, or the equipment status may have changed.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                ...
                <p className="text-sm text-white">
                  ...
                  using a chain hoist and gantry), a specific lift plan is required. This should
                  include a detailed method statement, engineering calculations (or reference to the
                  equipment load charts), and a risk assessment. The plan must be prepared by a
                  competent person — typically a Appointed Person (Lifting) or an engineer with
                  lifting experience.
                </p>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                When lifting operations take place near live electrical equipment (which is common
                in electrical maintenance), the lift plan must address the risk of the load,
                equipment, or personnel coming into contact with or approaching live conductors. For
                HV systems, minimum approach distances must be maintained. Barriers, exclusion
                zones, and earthing arrangements may be required. This is where LOLER and the EAWR
                1989 overlap — the lift plan must comply with both sets of regulations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Regulation 9 — Thorough Examination Requirements
              </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Date of the examination and date of the previous examination
                </li>
                <li className="pl-1">
                  The SWL of the equipment (or range of SWLs for different configurations)
                </li>
                ...
                <li className="pl-1">
                  The latest date by which the next thorough examination must take place
                </li>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              <p className="text-sm font-medium text-orange-400 mb-2">
                What to Check Before Using Lifting Equipment
              </p>
              <p className="text-sm text-white">
                As a maintenance technician, before using any lifting equipment you should verify:
                (1) the equipment has a current thorough examination report within the required
                interval, (2) the SWL is clearly marked and adequate for your load, (3) there are no
                visible defects (damage, wear, corrosion, missing pins), (4) the equipment is
                suitable for the task and environment. If any of these cannot be confirmed, do not
                use the equipment — report the issue to your supervisor.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Regulation 11 imposes a duty to report serious defects to the enforcing authority.
              This provides an additional safety net — ensuring that dangerous equipment is not only
              taken out of service but that the regulatory body is informed, enabling wider action
              if a systemic problem is identified.
            </p>

            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Regulation 11 — Defects
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  If a thorough examination reveals an{' '}
                  <strong>existing or imminent risk of serious personal injury</strong>, the
                  competent person must immediately inform the employer and the relevant enforcing
                  authority (usually the HSE)
                </li>
                <li className="pl-1">
                  The equipment must not be used until the defect is remedied
                </li>
                <li className="pl-1">
                  The employer must ensure the defect is remedied before the equipment is used again
                </li>
                <li className="pl-1">
                  The report must be sent to the enforcing authority as soon as is practicable
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Common Lifting Equipment in Electrical Maintenance
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  LOLER and PUWER Together
                </h3>
                <p className="text-sm text-white">
                  Lifting equipment is subject to both LOLER and PUWER simultaneously. PUWER
                  provides the general requirements (suitability, maintenance, inspection, training,
                  controls, isolation). LOLER adds specific requirements for lifting (strength and
                  stability, thorough examination, lift planning, SWL marking, reporting). You must
                  comply with both. Think of PUWER as the baseline and LOLER as the additional layer
                  for lifting-specific risks.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                ...
                <p className="text-sm text-white">
                  ...
                  lifts, but you will use lifting equipment regularly. Your responsibilities
                  include: checking thorough examination certificates are current, verifying SWL
                  markings, carrying out pre-use visual inspections, not exceeding the SWL,
                  reporting defects immediately, and not using equipment that appears damaged or
                  lacks documentation.
                </p>
              </div>
            </div>
            ...
            <p className="text-sm text-white/90 italic">
              <strong>ST1426 note:</strong> LOLER is one of the key regulations covered in the
              maintenance technician standard. You should be able to explain the thorough
              examination requirements, identify lifting equipment you use, and describe the
              planning requirements for lifting operations. In your EPA, you may be asked about a
              scenario involving a lifting operation as part of electrical maintenance.
            </p>
          </div>
        </section>
