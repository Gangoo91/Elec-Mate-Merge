    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-base text-muted-foreground mb-12">
          This section covers how power and lighting systems are integrated into complete electrical
          installations. You'll learn about distribution board design, circuit protection
          coordination, earthing systems, commissioning procedures and the documentation required
