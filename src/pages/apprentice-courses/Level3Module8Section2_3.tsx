...
const DESCRIPTION =
  'Step-by-step safe isolation procedures for practical exam scenarios. Master the essential safety procedure that underpins all electrical work.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "Proving the device before confirms it works. Proving after confirms it did not fail during testing. If you only prove before, you cannot know if the device failed while testing - a failed device would show 'dead' even on a live circuit.",
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'Lock-off prevents anyone from re-energising the circuit while you work on it. Without lock-off, someone unaware of your work could switch on and create an electrocution hazard. It is mandatory, not optional.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 1,
    explanation:
      'Test at the point of work - this is where you need confirmation of dead. A fault between the consumer unit and point of work could mean the circuit is live at your work location even though it appears dead at the origin.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      'GS38-compliant two-pole voltage indicators are required. They test between conductors (not conductor to earth via your body). Neon screwdrivers and simple testers can give false readings and are not acceptable for safe isolation.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "GS38 is HSE Guidance Note 38: 'Electrical test equipment for use on low voltage electrical systems'. It specifies safety requirements for test equipment including voltage indicators used in safe isolation.",
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'The correct sequence is: Identify the circuit, isolate at the correct point, secure against re-energisation (lock-off), prove the proving device, test for dead at point of work, prove the proving device again.',
  },
  {
    id: 3,
    question:
      'What should you do if your voltage indicator shows no voltage but you have not proved the device?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Never trust an unproven device. The indicator could be faulty and showing 'dead' incorrectly. Prove the device works on a known live source, then retest your circuit, then prove again.",
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      "The Electricity at Work Regulations require working dead wherever reasonably practicable. Live working is only permitted when it's unreasonable to work dead AND suitable precautions are taken. This is rare and requires specific risk assessment.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'A proving unit generates a known voltage to test that your voltage indicator is working correctly. It allows you to prove the device without needing access to a separate known live source.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'The person who performs the isolation is responsible for maintaining it. They control the lock-off key and must ensure isolation is maintained until work is complete and it is safe to re-energise.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Warning notices should clearly identify who isolated the circuit, why, when, and how to contact them. This prevents confusion and ensures only the responsible person removes isolation.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'All sources must be isolated, secured, and the circuit proven dead from all sources. Examples include backup generators, solar PV systems, UPS systems, and cross-feeds from adjacent properties.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Proving units typically produce a low voltage (often 50V DC or similar) sufficient for the voltage indicator to detect. This confirms the indicator is functioning without creating additional hazard.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Safe isolation failure typically results in automatic overall assessment failure. This reflects the real-world consequence - failure to isolate safely can result in death. It is treated as the most serious error possible.',
  },
  {
    id: 11,
    ...
    correctAnswer: 1,
    explanation:
      'Neutral can carry dangerous voltage due to various faults including broken PEN conductors, borrowed neutrals, or neutral-earth faults elsewhere. Test between all conductors (L-N, L-E, N-E) for complete confirmation.',
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      'Multiple lock-off devices can be applied - each person working on the circuit applies their own lock. The circuit cannot be re-energised until ALL locks are removed by their respective owners.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Do not proceed until adequate isolation can be achieved. You may need to isolate at a higher level (e.g., submain rather than final circuit) or at the origin. If no suitable point exists, the installation may need modification before work can proceed safely.',
  },
  {
    question: 'Can I use a multimeter instead of a two-pole voltage indicator?',
    answer:
      'GS38 recommends proprietary two-pole voltage indicators rather than general-purpose multimeters for safe isolation. Multimeters may not meet the safety requirements, may be set to wrong range, and single-pole measurement creates additional risks.',
  },
  {
    question: "How do I prove the proving device if I don't have a proving unit?",
    answer:
      "You can prove on a known live source - typically a socket outlet or supply point that you are certain is energised. However, a proving unit is preferred as it is always available, known to be safe, and removes doubt about the 'known live' source.",
  },
  {
    question: "What if the circuit breaker won't lock off?",
    answer:
      'Some older circuit breakers lack lock-off facility. Use a lock-off device designed for the type of protective device, isolate at a point that can be locked (e.g., isolator), or fit a temporary lock-off enclosure. Never proceed without secure isolation.',
  },
  {
    question: 'Do I need to safe isolate for every task in an assessment?',
    answer:
      'Yes - safe isolation is required before working on any circuit, even if you isolated the same circuit earlier. Circumstances may have changed. Demonstrate the full procedure each time to show competence and ensure safety.',
  },
  {
    question: 'What if my voltage indicator battery is low?',
    answer:
      'Do not use a device with low battery indication - it may give unreliable readings. Replace or charge batteries before the assessment. Low battery warnings should trigger immediate replacement, not continued use.',
  },
];
...
const isolationSteps = [
  {
    ...
    description:
      'Positively identify the circuit to be worked on using circuit charts, labels, and verification',
    critical: 'Correct identification prevents isolating the wrong circuit',
    actions: [
      'Check circuit chart/schedule',
      'Verify circuit identity at work location',
      'Confirm with functional test if appropriate',
      'Identify all supplies to the circuit',
    ],
  },
  {
    step: 2,
    ...
    actions: [
      'Locate correct isolation point',
      'Switch/operate the isolation device',
      'Verify the device is in OFF/isolated position',
      'Note position of any other linked circuits',
    ],
  },
  {
    step: 3,
    ...
    actions: [
      'Apply lock-off device with your own padlock',
      'Retain the key on your person',
      'Attach warning notice with your details',
      'Check isolation device cannot be operated',
    ],
  },
  {
    step: 4,
    ...
    actions: [
      'Use proving unit or known live source',
      'Confirm indicator shows voltage/responds',
      'Check indicator for damage or low battery',
      'Verify leads and probes are undamaged',
    ],
  },
  {
    step: 5,
    ...
    actions: [
      ...
      'Test all phases if three-phase supply',
    ],
  },
  {
    step: 6,
    ...
    actions: [
      'Use same proving unit or known live source',
      'Confirm indicator still responds to voltage',
      'Only proceed if device proves satisfactory',
      'Document completion of safe isolation',
    ],
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Sequence:</strong> Identify, Isolate, Secure, Prove, Test, Prove
              </li>
              <li>
                <strong>Critical:</strong> Prove device BEFORE and AFTER testing dead
              </li>
              <li>
                <strong>Non-negotiable:</strong> Lock-off is mandatory, not optional
              </li>
              <li>
                <strong>Assessment:</strong> Failure typically means overall failure
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Multiple supplies, borrowed neutrals, PV systems
              </li>
              <li>
                <strong>Use:</strong> GS38-compliant two-pole voltage indicator
              </li>
              <li>
                <strong>Apply:</strong> Test at point of work, not just at origin
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Safe isolation is not just another procedure - it is the procedure that prevents
              electrocution. Every year, electrical workers are killed or seriously injured because
              of isolation failures. In practical assessments, safe isolation failure typically
              results in automatic overall failure, regardless of how well you perform everything
              else.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Electricity at Work Regulations 1989 (Regulation 13):</strong> Adequate
                  precautions must be taken to prevent danger when work is done on equipment that
                  has been made dead. Safe isolation is how this is achieved.
                </li>
                <li>
                  <strong>Regulation 14:</strong> Work on or near live conductors is prohibited
                  unless it is unreasonable to work dead AND suitable precautions are taken. Working
                  dead is the expectation, not the exception.
                </li>
                <li>
                  <strong>HSE Guidance (GS38):</strong> Specifies requirements for electrical test
                  equipment. Your voltage indicator must meet these requirements - non-compliant
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Why Complete Procedure is Essential:
              </p>
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Wrong Circuit:</strong> Without positive identification, you might isolate
                  the wrong circuit and work on a live one.
                </li>
                <li>
                  <strong>Re-energisation:</strong> Without lock-off, someone could switch the
                  circuit back on while you work.
                </li>
                <li>
                  <strong>Faulty Tester:</strong> Without proving, your voltage indicator might be
                  faulty and show 'dead' on a live circuit.
                </li>
                <li>
                  <strong>Multiple Supplies:</strong> Without thorough testing, an alternative
                  supply (generator, PV, cross-feed) could energise the circuit.
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Assessment Reality:</strong> Assessors are specifically watching for safe
              isolation. They will note if you skip steps, rush the procedure, or fail to prove your
              device. This is not about catching you out - it is about ensuring you have the
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Safe isolation follows a specific sequence. Each step builds on the previous one, and
              skipping any step compromises safety. Learn this sequence until it becomes automatic -
              you should be able to perform it correctly under any circumstances.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Safe isolation requires appropriate equipment that meets safety standards. Using
              incorrect or inadequate equipment is dangerous and will result in assessment failure.
              Know what equipment is required and ensure yours is suitable.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Visual Inspection:</strong> Check indicator and leads for physical damage.
                  Cracked cases, damaged probes, worn leads, or exposed conductors make equipment
                  unsafe.
                </li>
                <li>
                  <strong>Functionality:</strong> Press test button if fitted. Check display/LEDs
                  respond. Verify batteries are adequate (no low battery warning).
                </li>
                <li>
                  <strong>Leads:</strong> Check leads are firmly attached. Verify probe tips are
                  undamaged. Ensure finger guards are in place and secure.
                </li>
                <li>
                  <strong>Calibration:</strong> Be aware of any calibration requirements. Most
                  voltage indicators do not require calibration but should be periodically checked.
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70 mt-4">
              <strong>Equipment Failure:</strong> If you discover equipment problems during an
              assessment, inform the assessor immediately. Do not proceed with faulty equipment.
              Assessors can provide replacement equipment - continuing with suspect equipment would
              be a safety failure.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Many safe isolation failures stem from the same repeated errors. Understanding these
              common mistakes helps you avoid them. In assessments, these errors result in failure;
              in real work, they can result in death.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Verbalise Your Actions:</strong> Clearly state what you are doing at each
                  step. This helps the assessor follow your procedure and demonstrates your
                  understanding. "I am now proving my voltage indicator on the proving unit..."
                </li>
                <li>
                  <strong>Don't Rush:</strong> Nervous candidates often rush safe isolation to 'get
                  on with the work'. This is backwards - take the time to do it correctly. The work
                  cannot proceed safely until isolation is complete.
                </li>
                <li>
                  <strong>Complete Every Step:</strong> Even if you feel certain the circuit is
                  dead, complete every step of the procedure. Assessors are checking that you always
                  follow the full procedure, not just when you remember to.
                </li>
                <li>
                  <strong>Handle Interruptions:</strong> If you are interrupted during safe
                  isolation, return to a safe point in the procedure - do not assume you know where
                  you were. Restart proving if unsure.
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Practice the full procedure at home on your consumer unit (do not remove covers)
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Multiple supply warnings</strong> - Look for PV, generator, UPS notices
                </li>
                <li>
                  <strong>Borrowed neutrals</strong> - Shared neutrals between circuits
                </li>
                <li>
                  <strong>Unusual wiring</strong> - Evidence of modifications or poor practice
                </li>
                <li>
                  <strong>Inadequate labelling</strong> - If circuits aren't clearly identified,
                  extra care needed
                </li>
                <li>
                  <strong>Damaged equipment</strong> - Never use damaged test equipment
                </li>
              </ul>
            </div>
          </div>
