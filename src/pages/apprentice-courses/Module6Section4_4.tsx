  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'An open circuit is a break in continuity of the conductor, preventing current flow through the complete circuit path.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'A low resistance ohmmeter is specifically designed for accurate continuity measurements in electrical circuits.',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'All faults must be clearly recorded on test sheets and rectified before energising for safety and compliance.',
    },
    {
      id: 10,
  ...
  const faqs = [
    {
      ...
      answer:
        'Yes, but the installation is unsafe because protective devices may not operate correctly.',
    },
    {
      question: 'Is a high resistance joint always obvious?',
      answer:
        'No, often the circuit works normally but generates heat over time, posing a fire risk.',
    },
    {
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <section className="mb-10">
            <p className="text-white/80 leading-relaxed">
              ...
              missing CPCs. If left undetected, these faults can result in electric shock, fire
              hazards, or premature equipment failure.
            </p>
          </section>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Appliances may still operate but protective devices won't function correctly
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Internal fuses and switches in appliances designed to break line conductor
                      only
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <ul className="text-sm space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-red-400">⚠</span>
                    <span>
                      Violates BS 7671 Regulation 132.7 requiring single-pole devices to break line
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      CPC continuity: should not exceed (R1 + R2) values specified in BS 7671
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Ring circuit end-to-end resistance: typically 0.05Ω to 1.67Ω depending on
                      cable size
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Polarity confirmation: correct at all points - no tolerance for incorrect
                      connections
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      High resistance joints: any reading significantly above cable resistance
                      indicates problems
                    </span>
                  </li>
                </ul>
