      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3">
            Pure Capacitance Circuits
          </h1>
          <p className="text-white/80">
            Capacitive reactance, energy storage in electric fields, and charging/discharging behaviour
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Calculate capacitive reactance using XC = 1/(2 x pi x f x C)",
              "Explain why current leads voltage by 90 degrees in capacitors",
              "Determine current flow in pure capacitive AC circuits",
              "Calculate energy stored in a capacitor's electric field",
              "Understand capacitor charging and discharging (RC time constant)",
              "Apply capacitor concepts to power factor correction"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module3-section2-2">
              <ArrowLeft className="w-4 h-4 mr-2" />
