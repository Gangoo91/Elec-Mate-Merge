        ...
        <section className="mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-sm text-white">
              This section covers fundamental electrical principles including Ohm's Law and power equations,
              electrical quantities and their units, measurement instruments and their applications,
              accuracy and tolerances in measurements, and SI units with conversions.
            </p>
          </div>
        </section>
