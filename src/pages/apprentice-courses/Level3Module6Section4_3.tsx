...
const DESCRIPTION =
  'Special requirements for electrical installations in agricultural and industrial environments under BS 7671 Sections 705 and 700 series, covering livestock safety, hazardous atmospheres, and industrial demands.';

const quickCheckQuestions = [
  {
    id: 'check-1',
    question:
      'Why do agricultural installations have stricter requirements than standard domestic installations?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Agricultural installations face multiple challenges: livestock are extremely sensitive to even small leakage currents, environments include moisture, dust, corrosive substances and fire risks (hay, straw), and the consequences of failure can be catastrophic for both animals and buildings.',
  },
  {
    id: 'check-2',
    question:
      'What is the maximum RCD rating required for socket outlet circuits in agricultural premises?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Regulation 705.411.1 requires 30mA RCD protection for all socket outlet circuits and circuits supplying hand-held or mobile equipment. The 30mA threshold provides protection for humans and helps protect livestock from harmful leakage currents.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 1,
    explanation:
      'Regulation 705.415.2 requires supplementary equipotential bonding in locations containing livestock. This connects all exposed and extraneous conductive parts that animals may contact, creating an equipotential zone to prevent even small potential differences that could stress or harm animals.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      'Motor starting currents (typically 6-8 times running current) can trip incorrectly sized MCBs. Designers must select devices that accommodate inrush current while still providing adequate short-circuit and overload protection. Type C or D MCBs, or motor-rated devices, are often required.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'According to BS 7671 Section 705, what additional protection measure is required for all circuits in agricultural premises?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Section 705 requires RCD protection with rated residual current not exceeding 30mA for most circuits. 100mA RCDs may be used for fire protection in specific circumstances, but 30mA is the standard requirement for agricultural installations.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'SWA cables resist damage from livestock rubbing, kicking, or chewing, rodent attack, and the general rough treatment common in agricultural environments. The mechanical protection is essential for long-term reliability in these challenging conditions.',
  },
  {
    id: 3,
    question:
      'What is the minimum IP rating generally required for electrical equipment in locations where animals are kept?',
    options: [
      'IP2X',
    ...
    correctAnswer: 1,
    explanation:
      'Equipment in animal housing must resist water (cleaning, animal waste, condensation) and dust/particles (feed, bedding). IP44 is typically the minimum, with IP55 or IP65 preferred in areas subject to pressure washing or high dust levels.',
  },
  {
    id: 4,
    question:
      'A dairy farm has automatic milking equipment. What fault protection consideration is particularly important?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'During milking, cows are in close contact with equipment, and the milk provides an excellent conductive path. Even small leakage currents can cause distress, reduced milk yield, or refusal to enter the parlour. Rapid disconnection via 30mA RCDs is essential.',
  },
  {
    id: 5,
    question:
      "In industrial installations, what does 'selectivity' between protective devices mean?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Selectivity (discrimination) ensures that a fault disconnects only the affected circuit while upstream devices remain closed. This maintains power to unaffected parts of the installation, which is crucial for industrial processes and safety systems.',
  },
  {
    id: 6,
    question:
      'What special consideration applies to emergency switching in industrial motor installations?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Industrial machinery requires emergency stop facilities that are immediately accessible, clearly marked (red/yellow), and capable of removing power from all hazardous motion. They must be designed so release does not automatically restart the machinery.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Grain dust in suspension can form explosive atmospheres. Electrical equipment in these areas must be suitable for hazardous zones (typically Zone 21 or 22), using appropriate Ex-rated enclosures and wiring methods to prevent ignition sources.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Cables in steel conduit or trunking provide excellent mechanical protection. Mounting above animal reach (typically 2.5m minimum) protects against direct damage, while steel provides resistance to rodents and fire. This method also provides easy maintenance access.',
  },
  {
    id: 9,
    question:
      'In industrial three-phase motor installations, what protection is typically provided by a motor starter?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Motor starters incorporate overload relays (protecting against sustained overcurrent), short-circuit protection (via fuses or back-up MCB), and often phase-failure/imbalance protection. This comprehensive protection prevents motor burnout and fire risks.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Stray voltage refers to small AC potentials (even 1-2V) between grounded objects that animals may contact. Livestock are far more sensitive than humans to these voltages. Proper equipotential bonding is essential to eliminate stray voltage conditions.',
  },
  {
    id: 11,
    question:
      'What switching arrangement is required for fixed heating appliances in agricultural buildings?',
    options: [
      'Any standard switch',
    ...
    correctAnswer: 1,
    explanation:
      'Fixed heating appliances (heat lamps, underfloor heating, etc.) in agricultural premises must have readily accessible isolation capable of disconnecting all poles. This enables safe maintenance and emergency disconnection, particularly important given fire risks with bedding materials.',
  },
  {
    id: 12,
    question:
      'An industrial installation uses variable speed drives (VSDs) for motor control. What design consideration applies to protective conductor sizing?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'VSDs generate high-frequency harmonics that can flow through the protective conductor. BS 7671 and manufacturer guidance may require increased protective conductor sizing and/or the use of shielded cables to manage EMC effects and ensure effective fault protection.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Animal Sensitivity:</strong> Livestock react to voltages as low as 1-2V
              </li>
              <li>
                <strong>30mA RCDs:</strong> Required for virtually all agricultural circuits
              </li>
              <li>
                <strong>Bonding Critical:</strong> Supplementary bonding essential in animal areas
              </li>
              <li>
                <strong>Harsh Conditions:</strong> IP44+ ratings, mechanical protection mandatory
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Animals avoiding water troughs or becoming reluctant to enter
                areas
              </li>
              <li>
                <strong>Use:</strong> SWA cable for all livestock building wiring
              </li>
              <li>
                <strong>Apply:</strong> Zone classification for explosive atmosphere areas
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Agricultural installations present unique challenges that standard wiring practices
              cannot adequately address. BS 7671 Section 705 recognises these challenges and imposes
              additional requirements beyond those for normal domestic or commercial premises.
            </p>
            <p>
              The key factors driving these requirements are: the extreme sensitivity of livestock
              to electric current, harsh environmental conditions (moisture, dust, corrosive
              atmospheres), elevated fire risks (combustible materials everywhere), and mechanical
              damage risks from animals and machinery.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> The goal in agricultural installations is not just to
              protect against dangerous shock levels for humans, but to eliminate potential
              differences that could affect animal welfare and productivity.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Section 705 establishes a comprehensive protection regime centred on RCD protection
              and enhanced equipotential bonding. These measures work together to minimise both
              fault currents and potential differences within the installation.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-green-500/10 border border-green-500/30">
              ...
              <ul className="text-sm text-white/90 space-y-2 ml-4">
                ...
                <li>
                  <strong>100mA RCDs:</strong> May be used for fixed equipment where 30mA would
                  cause excessive nuisance tripping
                </li>
                <li>
                  <strong>300mA RCDs:</strong> Maximum for any agricultural circuit - primarily for
                  fire protection
                </li>
              </ul>
            </div>
            ...
            <p>
              Supplementary equipotential bonding is mandatory in locations containing livestock.
              This creates an equipotential zone by connecting all simultaneously accessible exposed
              and extraneous conductive parts within reach of animals.
            </p>
            ...
            <p className="text-sm text-white/90 italic">
              ...
              creating an equipotential zone where no dangerous potential differences can exist even
              during a fault.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Industrial installations typically feature higher power demands, three-phase supplies,
              significant motor loads, and often hazardous areas. Design must address fault levels,
              protection coordination, motor starting, and maintaining supply continuity.
            </p>
            <p>
              Unlike domestic installations where fault levels are relatively predictable,
              industrial sites may have prospective fault currents of tens of kA. All equipment must
              be rated for the actual fault level at its location, requiring power system studies
              for larger installations.
            </p>

            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-white mb-3">
                Motor Circuit Design Considerations:
              </p>
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                <div>
            ...
            <p>
              Selectivity between protective devices ensures that a fault disconnects only the
              affected circuit. In industrial systems, this is achieved through time-grading
              (upstream devices have longer delay) or current-grading (upstream devices have higher
              settings) or a combination.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Industrial systems often require coordination studies to
              verify that protective devices operate correctly together. This is beyond simple
              application of BS 7671 tables and may require manufacturer's characteristic curves.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Many agricultural and industrial locations contain areas where explosive atmospheres
              may occur. Grain stores, fuel storage, paint shops, chemical processing, and many
              other applications require hazardous area classification and appropriate equipment
              selection.
            </p>
            <p>
              The ATEX Directives (Equipment Directive 2014/34/EU and Workplace Directive
              1999/92/EC) establish the legal framework. BS EN 60079 series provides technical
              guidance. Hazardous areas are classified by zone, indicating the likelihood of an
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                <div className="p-3 rounded bg-red-500/10 border border-red-500/30">
                  ...
                  <ul className="text-white/90 space-y-1">
                    ...
                    <li>
                      <strong>Zone 1:</strong> Likely in normal operation
                    </li>
                    <li>
                      <strong>Zone 2:</strong> Not likely, brief if occurs
                    </li>
                  </ul>
                </div>
                <div className="p-3 rounded bg-orange-500/10 border border-orange-500/30">
                  ...
                  <ul className="text-white/90 space-y-1">
                    ...
                    <li>
                      <strong>Zone 21:</strong> Likely in normal operation
                    </li>
                    <li>
                      <strong>Zone 22:</strong> Not likely, brief if occurs
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <p>
              Equipment for hazardous areas must be certified to the appropriate standards, marked
              with the 'Ex' symbol, and suitable for the specific zone. Installation, maintenance,
              and modification can only be carried out by competent persons with appropriate
              training and using certified methods.
            </p>
            ...
            <p className="text-sm text-white/90 italic">
              ...
              Ex tb or Ex tc for dust applications.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  Allow for pressure washing during cleaning - IP66 preferred for wash-down areas
                </li>
              </ul>
            </div>
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Industrial Motor Circuit Design
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Obtain motor nameplate data: rated power, current, starting method, duty cycle
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Inadequate bonding</strong> - Missing or undersized supplementary bonding
                  in animal areas
                </li>
                <li>
                  <strong>Wrong RCD rating</strong> - Using 100mA or 300mA where 30mA is required
                </li>
                <li>
                  <strong>Standard accessories</strong> - Using domestic-grade equipment in harsh
                  environments
                </li>
                <li>
                  <strong>MCB nuisance tripping</strong> - Type B MCBs tripping on motor starting
                </li>
                <li>
                  <strong>Ignoring ATEX</strong> - Installing standard equipment in hazardous zones
                </li>
                <li>
                  <strong>Poor cable routing</strong> - Cables accessible to livestock or machinery
                  damage
                </li>
              </ul>
            </div>
