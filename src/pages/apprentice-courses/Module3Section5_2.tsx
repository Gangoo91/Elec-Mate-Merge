      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
              ...
              <div className="space-y-3">
                  ...
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">Internal components, controlled environments</td>
                      </tr>
                      ...
                      <tr className="bg-muted/5">
                        ...
                        <td className="border border-white/10 p-3">Dusty environments, no harmful deposits</td>
                      </tr>
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">Critical equipment, harsh environments</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 bg-transparent border border-border/30 rounded-lg">
                    <h5 className="font-medium text-elec-yellow mb-2">Dust Protection Considerations</h5>
                    <ul className="space-y-2 text-sm">
                  ...
                  <div className="p-4 bg-transparent border border-border/30 rounded-lg">
                    <h5 className="font-medium text-elec-yellow mb-2">Industry-Specific Requirements</h5>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              ...
              <div className="space-y-4">
                  ...
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    <thead>
                      <tr className="">
                        ...
                        <th className="border border-white/10 p-3 text-left">Example Applications</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                      ...
                      <tr className="bg-muted/5">
                        ...
                        <td className="border border-white/10 p-3">Minimal exposure, covered areas</td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3 font-medium">2</td>
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-transparent border border-border/30 rounded-lg">
                    <h5 className="font-medium text-elec-yellow mb-3">Critical Water Protection Considerations</h5>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-transparent border border-border/30 rounded-lg">
              <h3 className="font-medium text-elec-yellow mb-3">Case Study 2: Coastal Installation Corrosion</h3>
              <p className="text-xs sm:text-sm text-white mb-3">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">Q: What does 'X' mean in an IP code like IPX4?</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">Q: Can IP68 equipment be used above ground?</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">Q: How often should IP-rated equipment be inspected?</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">Q: Can IP ratings be maintained after cable entry modifications?</h3>
              <p className="text-xs sm:text-sm text-white">
