    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Apply fluid mechanics principles to the design and analysis of pipework systems and pump
          selection
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the fundamental principles of fluid behaviour, pressure drop
          calculations using Darcy-Weisbach, and the matching of pump characteristics to system
          curves - essential skills for designing heating, chilled water and domestic water systems.
        </p>
