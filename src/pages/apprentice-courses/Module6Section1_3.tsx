  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'An Electrical Installation Certificate (EIC) is required for all new electrical installations to confirm they meet BS 7671 standards.',
    },
    {
      id: 2,
    ...
    },
    {
      id: 4,
      question:
        'True or False: You can energise an alteration without testing if the original installation was recently tested.',
      options: ['True', 'False'],
      correctAnswer: 1,
      explanation:
        'False. All alterations must be tested before being energised, regardless of when the original installation was last tested.',
    },
    {
      id: 5,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Alterations must be tested to ensure the new work has not compromised the safety of the existing installation.',
    },
    {
      id: 10,
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <ul className="text-white/80 text-sm space-y-1 list-disc pl-5">
              ...
              <li>
                ANY alteration requires testing before use - no exceptions for "small" changes.
              </li>
              <li>
                Fault diagnosis testing essential for RCD trips, flickering, overheating symptoms.
              </li>
              <li>
                Periodic testing: domestic 10 years, commercial 5 years - issue appropriate
                certificates always.
              </li>
            </ul>
          </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                installers from electrical dangers.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="font-medium text-white mb-3">Mandatory Testing Before Energising:</p>
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    <strong>Initial Verification</strong> must be performed before energising a new
                    installation
                  </li>
                  <li>
                    Includes both <strong>inspection</strong> (visual checks) and{' '}
                    <strong>testing</strong> (measured checks)
                  </li>
                  <li>
                    Testing ensures correct polarity, insulation resistance, continuity, and
                    protective devices
                  </li>
                  <li>
                    NEVER energise a circuit until all initial verification is complete and
                    satisfactory
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
                ...
                <p className="text-sm">
                  Energising an untested installation can result in electric shock, fire, or
                  equipment damage. Initial verification is a legal requirement under EAWR and
                  professional duty under BS 7671.
                </p>
              </div>
            </div>
          </section>
          ...
          <InlineCheck
            ...
            options={[
              'Energise first, then test',
              'Test insulation first, then continuity',
              'Complete all dead tests before energising',
              'Test only if problems occur',
            ]}
            correctIndex={2}
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    Any change to an existing system must be tested before being put into service
                  </li>
                  <li>
                    <strong>Example:</strong> Adding a socket to an existing ring final circuit
                    requires continuity, polarity, and R1+R2 checks
                  </li>
                  <li>
                    Must verify the alteration has not adversely affected the existing installation
                  </li>
              ...
              <div className="p-4 rounded-lg bg-orange-500/10 border-l-2 border-orange-500/50">
                ...
                <p className="text-sm">
                  When you alter an existing installation, you become responsible for ensuring that
                  your work does not make the existing installation unsafe. This means testing may
                  reveal pre-existing faults that you must address or formally report.
                </p>
              </div>
            </div>
          </section>
          ...
          <InlineCheck
            ...
            options={[
              'Adding a socket to existing ring',
              'Replacing a light switch',
              'Installing a new consumer unit',
              'Changing a lamp holder',
            ]}
            correctIndex={2}
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="font-medium text-white mb-3">
                  Common Fault Symptoms Requiring Testing:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    <strong>Tripping RCDs:</strong> May indicate earth leakage, damaged cables, or
                    moisture ingress
                  </li>
                  <li>
                    <strong>Flickering lights:</strong> Could suggest loose connections or
                    overloading
                  </li>
                  <li>
                    <strong>Overheating cables/accessories:</strong> May indicate overloading or
                    high resistance joints
                  </li>
                  <li>
                    <strong>Electric shock from metalwork:</strong> Potential earth fault requiring
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    <strong>Safe isolation first</strong> - never test live circuits for fault
                    diagnosis
                  </li>
                  <li>
                    <strong>Continuity tests:</strong> Check protective conductor integrity and
                    circuit continuity
                  </li>
                  <li>
                    <strong>Insulation resistance:</strong> Identify deteriorated insulation or
                    moisture damage
                  </li>
                  <li>
                    <strong>Earth fault loop impedance:</strong> Verify protective device operation
                  </li>
                  <li>
                    <strong>RCD testing:</strong> Confirm correct operation and sensitivity
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <ul className="text-sm space-y-1">
                    <li>
                      <strong>Interval:</strong> Every 10 years maximum
                    </li>
                    <li>
                      <strong>Change of occupancy:</strong> Before new tenant/owner
                    </li>
                    <li>
                      <strong>Insurance requirements:</strong> May require more frequent testing
                    </li>
                    <li>
                      <strong>Rental properties:</strong> Every 5 years in some regions
                    </li>
                  </ul>
                </div>
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <ul className="text-sm space-y-1">
                    <li>
                      <strong>Standard interval:</strong> Every 5 years maximum
                    </li>
                    <li>
                      <strong>High-risk environments:</strong> Annual or more frequent
                    </li>
                    <li>
                      <strong>Risk assessment driven:</strong> May require shorter intervals
                    </li>
                    <li>
                      <strong>Construction sites:</strong> Every 3 months
                    </li>
                  </ul>
                </div>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    <strong>EICR:</strong> Electrical Installation Condition Report must be issued
                  </li>
                  <li>
                    <strong>Condition codes:</strong> C1 (danger present), C2 (potentially
                    dangerous), C3 (improvement recommended)
                  </li>
                  <li>
                    <strong>Recommendations:</strong> Clear guidance on required remedial work
                  </li>
                  <li>
                    <strong>Next inspection date:</strong> Must be specified based on condition
                    found
                  </li>
                </ul>
              </div>
            ...
            <div className="p-4 rounded-lg bg-purple-500/10 border-l-2 border-purple-500/50">
              <div className="text-white/80 text-sm space-y-3">
                <p>
                  ...
                  and no certificates were issued to save time and money.
                </p>
                <p>
                  <strong>The Incident:</strong> Six months later, a socket outlet overheated due to
                  a poor connection, causing a fire that destroyed £50,000 worth of stock and forced
                  the business to close for three weeks.
                </p>
                <p>
                  <strong>Investigation:</strong> HSE investigation revealed the additional sockets
                  were not properly connected to the ring circuit, creating a high-resistance joint
                  that overheated under load.
                </p>
                <p>
                  <strong>Consequences:</strong> Shop owner prosecuted under EAWR 1989, fined
                  £15,000, insurance claim rejected due to non-compliance, business reputation
                  severely damaged. Total cost exceeded £100,000 - far more than proper testing
                  would have cost.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-green-500/10 border-l-2 border-green-500/50">
                ...
                <ul className="text-sm space-y-1 text-white/80">
                  ...
                  <li>
                    <strong>Alterations</strong> = Test before energising → Minor Works or EIC
                  </li>
                  <li>
                    <strong>Faults</strong> = Test to diagnose safely → Record results
                  </li>
                  <li>
                    <strong>Periodic</strong> = EICR → every 5 or 10 years
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-green-500/10 border-l-2 border-green-500/50">
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                for use. Certificates must always be issued, and periodic inspections are critical
                to maintaining long-term safety.
              </p>
              <p className="text-sm text-elec-yellow/80">
                Remember: safe isolation first, test systematically, and never energise untested
                circuits.
              </p>
            </div>
          </section>
