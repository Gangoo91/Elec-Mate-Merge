...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'When estimating voltage drop on a radial circuit, the length used should be:',
    options: [
      'The total path length (out and back)',
      'The straight-line distance only',
      'Half the route length',
      'The longest single conductor only',
    ],
    correctAnswer: 0,
    explanation:
      "Use the full current path. For a radial that's the route out and back; for rings, use the effective current path length.",
  },
  {
    id: 5,
    question: 'Using mV/A/m from Appendix 4, the voltage-drop formula is:',
    options: [
      'Vd = (mV/A/m + I + L) / 1000',
      'Vd = (mV/A/m × I × L) / 1000',
      'Vd = (mV/A/m × I) / L',
    ...
    correctAnswer: 1,
    explanation:
      'Multiply the tabulated mV per amp per metre by current and length, then divide by 1000 to convert millivolts to volts.',
  },
  {
    id: 6,
  ...
  {
    id: 8,
    question: 'The tabulated BS 7671 Appendix 4 mV/A/m values assume the conductor is at:',
    options: [
      'Ambient air temperature (around 30°C)',
      'Its maximum permitted operating temperature',
      'A fixed 20°C reference temperature',
  ...
  {
    id: 10,
    question: 'Excessive voltage drop is a concern mainly because it can cause:',
    options: [
      'A higher prospective fault current at the load',
      'The protective device to trip on overload',
      'Equipment to receive too little voltage and underperform',
      'The cable insulation resistance to fall',
    ],
    correctAnswer: 2,
    explanation:
      'Excessive voltage drop means equipment receives less than its rated voltage, leading to dim lighting, poor motor starting and reduced efficiency.',
  },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Voltage drop:</strong> Lost voltage in cable resistance
                </li>
                <li>
                  <strong>Method A:</strong> Vd = I × R (using resistance)
                </li>
                <li>
                  <strong>Method B:</strong> Use mV/A/m tables from Appendix 4
                </li>
                <li>
                  <strong>Limits:</strong> ≈3% lighting, ≈5% other final circuits
                </li>
                <li>
                  <strong>Solutions:</strong> Shorter runs, larger CSA
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Long runs, small CSA, high current
                </li>
                <li>
                  <strong>Use:</strong> Appendix 4 tables for design method
                </li>
                <li>
                  <strong>Apply:</strong> Check %Vd against design limits
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-white text-sm space-y-4">
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-elec-yellow/30">
              <h3 className="font-semibold mb-1 flex items-center gap-2">
                <TrendingDown className="w-4 h-4" /> Method A – Using resistance
              </h3>
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  Find the circuit resistance R (use R ≈ 0.0172 × L ÷ A for copper, 0.0282 for
                  aluminium).
                </li>
                <li>Use the total path length for current (out and back for a radial).</li>
                <li>
                  Voltage drop: <strong>Vd ≈ I × R</strong>. Percentage:{' '}
                  <strong>%Vd ≈ (Vd / 230) × 100</strong>.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
              <h3 className="font-semibold mb-1 flex items-center gap-2">
                <CheckCircle className="w-4 h-4" /> Method B – Using tables (mV/A/m)
              </h3>
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  Appendix 4 gives <strong>mV/A/m</strong> values for cables and installation
                  methods.
                </li>
                <li>
                  Formula: <strong>Vd (V) = (mV/A/m × I × L) ÷ 1000</strong>.
                </li>
                <li>
                  Use the correct table for the cable type and installation method. This is the
                  preferred design method.
                </li>
              </ul>
            </div>
            <div className="text-xs text-white">
              Always verify against Appendix 4. Consider temperature, grouping and supply
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-xs sm:text-sm text-white">
            <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
              ...
              <p>
                Water loses pressure as it flows through a long, narrow pipe. Electricity loses
                voltage as it flows through a long, thin cable. We call this lost voltage "voltage
                drop".
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-card border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li>
                    <strong>How far?</strong> Length of cable run (metres)
                  </li>
                  <li>
                    <strong>How much current?</strong> Amps the circuit will carry
                  </li>
                  <li>
                    <strong>What cable?</strong> Size and type you're using
                  </li>
                  <li>
                    <strong>How installed?</strong> Clipped direct, in conduit, buried, etc.
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-card border border-border/30 p-4 rounded-lg">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li>
                    <strong>Lighting circuits:</strong> Maximum 3% voltage drop
                  </li>
                  <li>
                    <strong>Socket circuits:</strong> Maximum 5% voltage drop
                  </li>
                  <li>
                    <strong>At 230V:</strong> 3% = 6.9V, 5% = 11.5V
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-card border border-amber-400/30 p-4 rounded-lg">
              <h3 className="font-semibold text-amber-300 mb-2">
                Quick example - Kitchen socket circuit:
              </h3>
              <div className="grid md:grid-cols-2 gap-4 mt-2">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    <li>
                      Look up 2.5mm² T&E clipped: <strong>18 mV/A/m</strong>
                    </li>
                    <li>
                      Cable length out and back: <strong>40m total</strong>
                    </li>
                    <li>
                      Calculate: (18 × 20 × 40) ÷ 1000 = <strong>14.4V</strong>
                    </li>
                    <li>
                      <strong>FAIL!</strong> 14.4V &gt; 11.5V limit. Need 4mm² cable.
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <p className="text-xs sm:text-sm text-white mb-4">
            This is what you'll actually use on site. The tables give you "mV/A/m" values -
            millivolts per amp per metre.
          </p>
          ...
          <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  ...
                  <div className="bg-[#121212] rounded p-3 text-xs">
                    ...
                    <div className="grid grid-cols-2 gap-2 bg-elec-yellow/20">
                      <span>2.5mm²</span>
                      <span>18</span>
                    </div>
                    <div className="grid grid-cols-2 gap-2">
            ...
            <div className="bg-card border border-border/30 p-4 rounded-lg">
              ...
              <ol className="list-decimal pl-6 space-y-1 text-sm">
                <li>
                  <strong>Find your cable</strong> in the correct table (type and installation
                  method)
                </li>
                <li>
                  <strong>Look up the mV/A/m value</strong> for your cable size
                </li>
                <li>
                  <strong>Use this formula:</strong> Voltage drop = (mV/A/m × Current × Length) ÷
                  1000
                </li>
                <li>
                  <strong>Remember:</strong> Length = total path (out and back for radials)
                </li>
                <li>
                  <strong>Check the limit:</strong> 3% for lighting (6.9V), 5% for others (11.5V)
                </li>
              </ol>
            </div>
            ...
            <div className="bg-card border border-elec-yellow/30 p-4 rounded-lg">
              ...
              <div className="text-sm">
                <p className="mb-2">
                  <strong>Job:</strong> 30m run to shed, 16A load, using 2.5mm² T&E clipped direct
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ol className="list-decimal pl-6 space-y-1">
                      <li>
                        From table: 2.5mm² T&E = <strong>18 mV/A/m</strong>
                      </li>
                      <li>
                        Total length: 30m × 2 = <strong>60m</strong>
                      </li>
                      <li>
                        Current: <strong>16A</strong>
                      </li>
                      <li>
                        Calculate: (18 × 16 × 60) ÷ 1000 = <strong>17.28V</strong>
                      </li>
                    </ol>
                  </div>
                  <div>
                    ...
                    <p className="text-elec-yellow">
                      Solution: Use 4mm² cable (11 mV/A/m) = 10.56V = 4.6% ✓
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-2 text-white text-sm">
            <li>
              Electricity needs a push (voltage). Cables resist a little, so some push is lost on
              the way – that's voltage drop.
            </li>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-4 bg-indigo-500/10 border border-indigo-400/30">
              ...
              <p>
                Cable resistance increases with temperature. High ambient temperatures or poor
                ventilation increase resistance and voltage drop. Use temperature correction factors
                when operating conditions differ significantly from 20°C.
              </p>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
              <h3 className="font-semibold text-elec-yellow mb-2">Ring circuits</h3>
              <p>
                For ring final circuits, current divides around both legs. Use effective length
                (typically half the total ring length) for voltage drop calculations. The load
                position affects the actual voltage drop.
              </p>
            </div>
            <div className="rounded-lg p-4 bg-teal-500/10 border border-teal-400/30">
              ...
              <p>
                Motor starting currents are typically 6-8 times full load current. This can cause
                significant temporary voltage drop affecting other equipment. Consider starting
                methods and dedicated feeders for large motors.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-elec-yellow mt-2">
                    Result: FAILS - exceeds 5% limit
                  </p>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs mt-1">
                    Solution: Use 35mm² cable (1.3 mV/A/m) → 5.4% Still high - consider 50mm²
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
              ...
              <p>
                Calculate voltage drop for: 35m run, 1.5mm² T&E clipped direct, 6A load, lighting
                circuit.
              </p>
              <Collapsible>
                ...
                <CollapsibleContent className="mt-2">
                  <p>
                    mV/A/m = 29, Total length = 70m, Vd = (29 × 6 × 70) ÷ 1000 = 12.18V, %Vd = 5.3%
                    - FAILS (&gt;3%). Need 2.5mm².
                  </p>
                </CollapsibleContent>
              </Collapsible>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
              ...
              <Collapsible>
                ...
                <CollapsibleContent className="mt-2">
                  <p>
                    mV/A/m = 11, Total length = 40m, Vd = (11 × 25 × 40) ÷ 1000 = 11V, %Vd = 4.8% -
                    PASSES (≤5%).
                  </p>
                </CollapsibleContent>
              </Collapsible>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
              ...
              <Collapsible>
                ...
                <CollapsibleContent className="mt-2">
                  <p>
                    mV/A/m = 2.8, Total length = 120m, Vd = (2.8 × 80 × 120) ÷ 1000 = 26.9V, %Vd =
                    11.7% - Excessive for final circuits.
                  </p>
                </CollapsibleContent>
              </Collapsible>
            </div>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
              ...
              <p>
                Ring circuit with 30m total length, 2.5mm² T&E, 20A balanced load at midpoint.
              ...
              <Collapsible>
                ...
                <CollapsibleContent className="mt-2">
                  <p>
                    For balanced load at midpoint, effective length = 30/4 = 7.5m. Current per leg =
                    10A. Vd = (18 × 10 × 15) ÷ 1000 = 2.7V, %Vd = 1.2% - PASSES.
                  </p>
                </CollapsibleContent>
              </Collapsible>
            </div>
        ...
        <section className="mb-10">
          <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">
            6-step design checklist
          </h2>
          <ol className="list-decimal pl-6 space-y-2 text-white text-sm">
            <li>
              <strong>Determine load:</strong> Calculate design current including diversity factors
            </li>
            <li>
              <strong>Measure route:</strong> Use total path length (out and back for radials)
            </li>
            <li>
              <strong>Select cable:</strong> Choose appropriate type for environment and
              installation method
            </li>
            <li>
              <strong>Find mV/A/m:</strong> Use correct Appendix 4 table for cable and method
            </li>
            <li>
              <strong>Calculate Vd:</strong> Apply formula and check percentage against limits
            </li>
            <li>
              <strong>Document:</strong> Record calculations and upsize cable if necessary
            </li>
          </ol>
        </section>
        ...
        <section className="mb-10">
          <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">
            Pocket Guide: Voltage Drop Essentials
          </h2>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/apprentice/level2/module2/section5/5-4">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous
            </Link>
          </Button>
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/apprentice/level2/module2/section5/5-6">
              Next
