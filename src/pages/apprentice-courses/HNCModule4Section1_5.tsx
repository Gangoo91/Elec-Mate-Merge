...
const quickCheckQuestions = [
  {
    ...
    options: ['15-20%', '20-30%', '40-50%', '5-10%'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.5-1 kVA', '2-4 kVA', '50 kVA total', '7-22 kVA per space'],
    correctIndex: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Planning for growth, technology changes, and evolving building requirements in electrical
          system design.
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 132.16 is the regulatory hook for future-proofing. Every addition or alteration
              triggers a re-assessment of supply capacity, switchgear ratings, earthing and bonding.
              Designing in spare DB ways, oversized containment and supply headroom now is what
              stops a future heat-pump or EV charger upgrade becoming a full main-board replacement.
              The cost of designing in 25% headroom upfront is trivial against rip-out and replace
              later.
            </>
          }
        ...
        <ConceptBlock title="Capacity Planning Principles">
          <p>
            ...
            requirements will inevitably change. Effective capacity planning balances current needs
            against future flexibility without excessive over-engineering.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Main switchboard — 25-30% spare ways:</strong> extensions possible but costly
            </li>
            <li>
        ...
        <ConceptBlock title="EV Charging Provision">
          <p>
            ...
            Regulations now require EV infrastructure in new buildings, and existing buildings face
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Active (charge point):</strong> full charger installed and operational — full
              cost now
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Static load management:</strong> fixed reduced power per charger (e.g. 3.7 kW)
            </li>
            <li>
          ...
          <p>
            <strong>Key consideration:</strong> The 2030 new car sales deadline means EV penetration
            will accelerate significantly. Plan for 50%+ EV by 2030, 80%+ by 2040.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Adapting to Technology Changes">
          <p>
            ...
            Designing for flexibility rather than specific technologies reduces future obsolescence
            risk.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heat pumps:</strong> additional supply capacity, three-phase provision, space
              for outdoor units
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — office building growth allowance:</strong> A new 10,000m² office has
            calculated initial demand of 650 kVA. What supply capacity should be requested?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Future provision (100% spaces): 200 spaces × 2.5 kVA diversified = 500 kVA potential
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 40-flat new-build apartment block is being designed. Today the dwellings will be
              gas-heated (DHW and heating) with no EV charging fitted. The client wants the supply
              &lsquo;EV-ready and heat-pump-ready&rsquo; to avoid a costly DNO upgrade in 5–10 years
              when both technologies become standard.
            </>
          }
          whatToDo={
            <>
              Today&rsquo;s ADMD: 40 × 2.5&nbsp;kVA × 0.5 inter-dwelling diversity ≈ 50&nbsp;kVA.
              Future ADMD with all-electric heat pumps: 40 × 5&nbsp;kVA × 0.5 ≈ 100&nbsp;kVA. Add EV
              charging at 7&nbsp;kW per dwelling × 40, with smart-charging diversity ≈ 0.25, ≈
              70&nbsp;kVA. Total future ≈ 170&nbsp;kVA. Specify a 200&nbsp;kVA DNO TX with
              250&nbsp;kVA reinforcement headroom, 300&nbsp;A four-pole isolator, 400&nbsp;A rated
              busbar in the meter chamber, and 25% spare in landlord services DBs. Document the
              design intent against Reg 132.16 in the O&amp;M and the Part L submission.
            </>
          }
          whyItMatters={
            <>
              Designing in headroom adds maybe 5% to capital cost. Retro-fitting a DNO upgrade with
              the building occupied costs 10–20× that, often impossible without a dedicated outage
              and tenant decant. Reg 132.16 says any addition must check the existing distributor
              capacity is adequate — leave it short and the DNO blocks the future heat-pump rollout.
            </>
          }
        />
