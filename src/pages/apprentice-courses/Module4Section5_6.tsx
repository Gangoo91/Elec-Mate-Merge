...
const TITLE =
  'Testing for Polarity and Continuity During Install - Module 4.5.6 | Level 2 Electrical Course';
const DESCRIPTION =
  'Master polarity and continuity testing techniques during installation. Learn proper procedures, tools, and BS 7671 compliance for safe electrical verification and fault prevention.';
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Proving units verify that test instruments are working correctly before and after testing procedures.',
  },
  {
    id: 5,
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-6">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/80 text-sm space-y-1 list-disc pl-4">
                  ...
                  <li>
                    Testing before energisation prevents faults and ensures BS 7671 compliance
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/80 text-sm space-y-1 list-disc pl-4">
                  ...
                  <li>
                    <strong>Use:</strong> Proper test instruments, correct procedures, approved
                    methods
                  </li>
                  <li>
                    <strong>Check:</strong> Accurate readings, correct polarity, continuity values
                    within limits
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <ul className="text-white/80 space-y-2 leading-relaxed list-disc pl-6">
              ...
              <li>
                Identify and correctly use the tools and instruments required for accurate testing
                procedures
              </li>
              <li>
                Perform polarity and continuity tests to industry standards and BS 7671 requirements
              </li>
              <li>
                Interpret test results accurately and take appropriate corrective action when faults
                are discovered
              </li>
              <li>
                Apply BS 7671 Part 6 verification requirements correctly during installation and
                commissioning
              </li>
            </ul>
          </section>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <p className="text-sm mb-2">
                  Versatile instrument for polarity and continuity testing:
                </p>
                <ul className="text-sm space-y-1 list-disc pl-4">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-sm">
                  <strong>Maintenance requirement:</strong> All test equipment must be regularly
                  calibrated and maintained to ensure accuracy.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <p className="text-sm mb-2">
                  <strong>Pre-test safety checks:</strong>
                </p>
                <ul className="text-sm space-y-1 list-disc pl-4">
                ...
                <p className="text-sm mt-3 mb-2">
                  <strong>Systematic testing approach:</strong>
                </p>
                <ul className="text-sm space-y-1 list-disc pl-4">
                  <li>
                    Test at distribution board: phase to phase, neutral to neutral, earth to earth
                  </li>
                  <li>Verify correct conductor identification throughout installation</li>
                  <li>
                    Test each outlet point: live terminal to live conductor, neutral to neutral
                  </li>
                  <li>
                    Check switching arrangements: ensure switches operate live conductors only
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <p className="text-sm mb-2">
                  <strong>Circuit preparation:</strong>
                </p>
                <ul className="text-sm space-y-1 list-disc pl-4">
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/30">
                ...
                <ul className="text-sm space-y-1 list-disc pl-4">
                  <li>
                    Continuity: Typically &lt;0.05Ω for short runs, calculated for longer circuits
                  </li>
                  ...
                  <li>
                    Compare all readings with design calculations and manufacturer specifications
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-sm">
                  <strong>Professional practice:</strong> Never energise circuits until all tests
                  pass and certificates are complete.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-sm">
                  <strong>Certification requirement:</strong> No circuit should be energised until
                  testing is complete and certificates signed off.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-white/80 leading-relaxed">
                ...
                professional installation standards. Systematic testing prevents dangerous faults,
                protects equipment, and demonstrates professional competence in electrical
                installation work.
              </p>
            </div>
          </section>
