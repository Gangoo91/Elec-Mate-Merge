...
const quickCheckQuestions = [
  {
    ...
    options: ['Wood pellets', 'Logs', 'Miscanthus bales', 'Wood chips'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['10-15 tonnes', '2-3 tonnes', '20-25 tonnes', '5-8 tonnes'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['10-12%', '2-3%', '5-7%', 'Less than 0.7%'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['2.0 kWh/kg', '5.5 kWh/kg', '4.8 kWh/kg', '3.5 kWh/kg'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Even outside smoke control areas, only Ecodesign-compliant biomass boilers can
              lawfully be installed in dwellings. Within smoke control areas (most urban England),
              the appliance must additionally appear on the Defra exempt appliance list. Old log
              boilers and stoves cannot be specified for new installations.
            </>
          }
        ...
        <ConceptBlock title="Biomass Boiler Types and Fuel">
          <p>
            Biomass heating uses organic material - primarily wood in various forms - as fuel to
            generate heat. When sourced sustainably, biomass is considered carbon-neutral as the CO2
            released during combustion equals that absorbed during growth. Boiler selection depends
            on fuel availability, automation requirements, and heat demand profile.
          </p>
          <p>
            <strong>Biomass fuel comparison:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Wood pellets:</strong> &lt;10% — 4.8 kWh/kg — Fully automatic
            </li>
            <li>
              <strong>Wood chips (G30):</strong> 20-30% — 3.5 kWh/kg — Automatic
            </li>
            <li>
              <strong>Wood chips (G50):</strong> 30-50% — 2.5-3.0 kWh/kg — Automatic
            </li>
            <li>
              <strong>Logs (seasoned):</strong> 15-20% — 4.0-4.3 kWh/kg — Manual batch
            </li>
          </ul>
          <p>
            <strong>Boiler Types by Application</strong>
          </p>
          <p>
            <strong>Pellet Boilers (10-500kW)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Chip Boilers (50kW-10MW)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Fuel Quality Standards</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>ENplus:</strong> European pellet quality certification (A1, A2, B grades)
            </li>
            <li>
              <strong>Woodsure:</strong> UK quality assurance for logs, chips, briquettes
            </li>
            <li>
              <strong>BSL:</strong> Biomass Suppliers List - sustainability certification
            </li>
          </ul>
          <p>
            <strong>Specification note:</strong> Always specify fuel quality requirements in tender
            documents - poor fuel quality is the primary cause of biomass system problems.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Fuel Storage and Handling Systems">
          <p>
            Proper fuel storage is critical for biomass system reliability. Storage must keep fuel
            dry, allow efficient delivery and extraction, and maintain fire separation from the
            boiler plant. Automatic handling systems transport fuel from store to boiler with
            minimal operator intervention.
          </p>
          <p>
            <strong>Pellet Storage</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Automatic Feed Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Auger (screw conveyor):</strong> 6-8 metres — Short, straight runs — Simple,
              reliable, limited flexibility
            </li>
            <li>
              <strong>Pneumatic vacuum:</strong> 20-25 metres — Remote stores, direction changes —
              Pellets only, quiet operation
            </li>
            <li>
              <strong>Macerating auger:</strong> 8-15 metres — Larger chips (G50) — Handles variable
              chip sizes
            </li>
            <li>
              <strong>Belt/chain conveyor:</strong> 50+ metres — Large chip installations — Higher
              capacity, more maintenance
            </li>
          </ul>
          <p>
            <strong>Fire Safety - Burn-Back Prevention</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Drop tube:</strong> Creates air gap between feed system and combustion chamber
            </li>
            <li>
              <strong>Rotary valve:</strong> Provides positive isolation, thermal fuse triggers
              closure
            </li>
            <li>
              <strong>Water dousing:</strong> Temperature sensor activates water spray in feed tube
            </li>
            <li>
              <strong>Fire-rated construction:</strong> 60-minute separation between store and
              boiler
            </li>
          </ul>
          <p>
            <strong>Design tip:</strong> Allow 15-20% additional storage capacity beyond calculated
            requirements to accommodate delivery schedule variations and ensure continuous
            operation.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Emissions Control and Flue Systems">
          <p>
            Biomass combustion produces particulate matter (PM), nitrogen oxides (NOx), carbon
            monoxide (CO), and volatile organic compounds (VOCs). Modern boilers incorporate primary
            combustion controls and may require secondary abatement equipment to meet emission
            limits, particularly for larger installations subject to environmental permitting.
          </p>
          <p>
            <strong>Emission Limits (Medium Combustion Plant Directive)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Thermal input:</strong> 1-50 MW
            </li>
            <li>
              <strong>NOx limit:</strong> 300 mg/Nm3 (new plant &gt;5MW)
            </li>
            <li>
              <strong>PM limit:</strong> 30 mg/Nm3 (new plant &gt;5MW)
            </li>
            <li>
              <strong>SO2 limit:</strong> 200 mg/Nm3
            </li>
          </ul>
          <p>Note: Tighter limits apply in certain areas and for larger plant</p>
          <p>
            <strong>Emissions Control Technologies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Primary measures:</strong> Optimised combustion air, staged combustion, lambda
              control
            </li>
            <li>
              <strong>Cyclonic separator:</strong> 70-85% PM removal, low maintenance, common on
              chip boilers
            </li>
            <li>
              <strong>Multicyclone:</strong> 85-95% PM removal, moderate cost
            </li>
            <li>
              <strong>Electrostatic precipitator (ESP):</strong> &gt;99% PM removal, higher cost,
              required for strict limits
            </li>
            <li>
              <strong>Fabric filter (baghouse):</strong> &gt;99% PM removal, used in larger
              industrial plant
            </li>
          </ul>
          <p>
            <strong>Flue System Design</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Flue material:</strong> Stainless steel 316L minimum — Condensing flues
              require higher grades
            </li>
            <li>
              <strong>Terminal height:</strong> 1m above highest point within 10m — Dispersion
              modelling may require more
            </li>
            <li>
              <strong>Insulation:</strong> Twin-wall insulated throughout — Maintains flue gas
              temperature
            </li>
            <li>
              <strong>Condensate drain:</strong> Required at base of flue — Acidic - may need
              neutralisation
            </li>
            <li>
              <strong>Access for cleaning:</strong> Inspection hatches required — Annual cleaning
              essential
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="System Integration and Operation">
          <p>
            ...
            prevent operational problems, and ensure seamless integration with building heating
            systems. Buffer vessels, thermal stores, and backup provision are key design
            considerations.
          </p>
          <p>
            <strong>Hydraulic Integration Components</strong>
          </p>
          <p>
            <strong>Buffer Vessel</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Typical System Configuration</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Biomass boiler:</strong> Primary heat generation — 60-80% of design heat load
            </li>
            <li>
              <strong>Buffer vessel:</strong> Load smoothing, anti-cycling — 10-20 litres per kW
              biomass
            </li>
            <li>
              <strong>Backup boiler (gas/oil):</strong> Peak load, maintenance cover — 100% of
              design load
            </li>
            <li>
              <strong>Low-loss header:</strong> Hydraulic separation — For multiple circuit systems
            </li>
            <li>
              <strong>Plate heat exchanger:</strong> System separation — If water quality differs
            </li>
          </ul>
          <p>
            <strong>Control Strategy</strong>
          </p>
          <p>
            <strong>Cascade control:</strong> Biomass boiler operates as lead, backup as lag
          </p>
          <p>
            <strong>Weather compensation:</strong> Flow temperature varies with external conditions
          </p>
          <p>
            <strong>Buffer management:</strong> Boiler fires to maintain buffer temperature band
          </p>
          <p>
            <strong>Modulation:</strong> Modern boilers modulate 30-100% to match load
          </p>
          <p>
            <strong>Anti-cycling:</strong> Minimum run time and rest periods programmed
          </p>
          <p>
            <strong>BMS integration:</strong> Enable/disable, alarm monitoring, energy metering
          </p>
          <p>
            <strong>Ash Handling Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Automatic de-ashing:</strong> Auger removes ash from grate to external bin
            </li>
            <li>
              <strong>Ash bin sizing:</strong> Typically 4-8 weeks between emptying for pellet
              systems
            </li>
            <li>
              <strong>Disposal:</strong> Wood ash can be used as fertiliser (pH alkaline) or general
              waste
            </li>
            <li>
              <strong>Access:</strong> Ensure ash bin is accessible for manual removal
            </li>
            <li>
              <strong>Compaction:</strong> Some systems compact ash to reduce emptying frequency
            </li>
          </ul>
          <p>
            <strong>Design note:</strong> Undersizing the biomass boiler to 60-80% of peak load and
            relying on backup for peaks is often more cost-effective than sizing biomass for 100%
            peak load.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Calculate pellet storage for a 150kW boiler serving a care
            home with 1,200,000 kWh annual heat demand.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Pellet calorific value: <strong>4.8 kWh/kg</strong> at &lt;10% moisture
            </li>
            <li>
              Wood chip calorific value: <strong>3.5 kWh/kg</strong> at 25% moisture
            </li>
            <li>
              Buffer vessel: <strong>10-20 litres per kW</strong> boiler output
            </li>
            <li>
              Flue terminal: <strong>1m above highest point within 10m</strong>
            </li>
            <li>
              Boiler efficiency: <strong>85-92%</strong> typical for modern units
            </li>
            <li>
              Pellet bulk density: <strong>650 kg/m3</strong>
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Poor fuel quality:</strong> Specify ENplus or Woodsure certification
            </li>
            <li>
              <strong>Inadequate storage:</strong> Wet fuel causes bridging and combustion issues
            </li>
            <li>
              <strong>No buffer vessel:</strong> Short-cycling damages boiler and increases
              emissions
            </li>
            <li>
              <strong>Undersized flue:</strong> Poor draught causes incomplete combustion
            </li>
            <li>
              <strong>Blocked feed systems:</strong> Ensure fuel is correctly sized for feed
              mechanism
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A rural primary school installed a 100 kW wood-chip boiler under the (now closed) RHI
              scheme. The original supplier provided G30/G50 chips at 25% moisture and the system
              met its predicted efficiency. The new fuel supplier delivers G50 chips at 38%
              moisture. Output drops, ash builds up, and the school overrides to oil backup.
            </>
          }
          whatToDo={
            <>
              Verify against the boiler manufacturer fuel specification (typically ENplus or
              equivalent moisture/ash class). If the new fuel exceeds the spec, the supplier is in
              breach of contract — switch back. If switching is not viable, clean out the boiler,
              recalibrate combustion air, and accept reduced output capacity (typically 60–70% of
              nameplate at high moisture). Long-term: install a moisture-monitored fuel store or
              specify a boiler with adaptive combustion control. Update the BMS to alarm when oil
              backup runs &gt;5% of operating hours.
            </>
          }
          whyItMatters={
            <>
              Biomass success is 90% fuel quality, 10% boiler. Cheap wet fuel destroys efficiency,
              increases emissions and accelerates wear. The fuel supply contract is the most
              important document on the project — moisture %, ash %, particle size, delivery
              interval.
            </>
          }
        />
