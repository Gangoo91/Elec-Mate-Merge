...
const Module2Section2_2: React.FC = () => {
  ...
  const quickCheckQuestions = [
    ...
    },
    {
      ...
      options: [
        'Pick the formula you think you need from memory',
        'Convert prefixes and write values',
        'Estimate the answer and round to one figure',
        'Draw the triangle and shade in the unknown',
      ],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: [
        'The triangle was read upside down',
        'V should be divided, not multiplied',
        'Nothing — the answer of 11 V is already correct',
        'Should convert units first',
      ],
      correctIndex: 3,
      explanation:
        'Must convert: 2.2 kΩ = 2200 Ω, 5 mA = 0.005 A. Correct: V = 2200 × 0.005 = 11 V. The numerical answer happens to be 11 V, but it must come from converted base units.',
    },
    {
      id: 'q6',
  ...
  const faqs = [
    {
      q: 'Do I need to memorise triangles?',
      a: 'They are a handy memory aid. You can also rearrange algebraically; choose the method you prefer.',
    },
    {
      q: 'What about power triangles?',
      a: 'You can draw triangles for P, V and I too. Remember: P = V×I for DC and resistive AC.',
    },
    {
      q: 'Can I use triangles with AC?',
      a: 'Yes for resistive calculations at Level 2. Power factor and reactance are covered later in the course.',
    },
    {
      q: 'My answer is 1000× wrong—why?',
      a: 'Usually a prefix error (kΩ vs Ω, mA vs A). Convert before using the triangle.',
    },
    {
      q: 'Is the triangle method always accurate?',
      a: "The triangle is just a memory aid. The physics (Ohm's Law) is always valid for linear resistors.",
    },
    {
      q: 'Can I use this for three-phase calculations?',
      a: 'Yes, but use line-to-neutral values and consider balanced loads. Three-phase theory comes later.',
    },
    {
      q: 'Why does my multimeter reading differ from calculations?',
      a: 'Real components have tolerance, temperature effects, and ageing. Use calculations as a guide.',
    },
    {
      q: 'Which BS 7671 areas use this?',
      a: 'Cable sizing, protective device selection, voltage drop calculations - basically everything electrical.',
    },
  ];
  ...
  const quizQuestions = [
    {
      id: 1,
      question: 'Find R when V=24 V and I=2 A.',
      options: [
        '48 Ω',
        '12 Ω',
        '0.083 Ω',
    ...
    {
      id: 2,
      question: 'Find I when V=12 V and R=4 Ω.',
      options: [
        '0.33 A',
        '16 A',
        '3 A',
    ...
    {
      id: 3,
      question: 'V= ? for I=0.2 A and R=3.3 kΩ.',
      options: [
        '66 V',
        '0.66 V',
        '6.6 V',
      ...
      correctAnswer: 3,
      explanation: '3.3 kΩ = 3300 Ω, V = 0.2×3300 = 660 V.',
    },
    {
      id: 4,
      question: 'Which is correct for finding V using the triangle?',
      options: [
        'V = I×R',
        'V = R/I',
        'V = I/R',
      ...
      correctAnswer: 0,
      explanation: 'Cover V → I×R remains.',
    },
    {
      id: 5,
      question: 'Best first step before using triangle?',
      options: [
        'Guess the formula from memory',
        'Convert prefixes and write values',
        'Round the figures before calculating',
        'Draw the triangle from scratch each time',
      ],
      correctAnswer: 1,
      explanation: 'Convert and write values clearly first.',
    },
    ...
    {
      id: 7,
      question: 'Convert 150 mA to Amps:',
      options: [
        '1.5 A',
        '0.015 A',
        '15 A',
      ...
      correctAnswer: 3,
      explanation: '150 mA = 150/1000 = 0.15 A.',
    },
    {
      id: 8,
      question: 'Find V when I=500 mA and R=220 Ω:',
      options: [
        '110 V',
        '1.1 V',
        '0.44 V',
      ...
      correctAnswer: 0,
      explanation: 'First convert: 500 mA = 0.5 A. Then V = I×R = 0.5×220 = 110 V.',
    },
    {
      id: 9,
      question: "What's wrong with this calculation: V = 2.2 kΩ × 5 mA = 11 V?",
      options: [
        'The triangle gives division here, not multiplication',
        'Should convert units first',
        'The kΩ value should have been halved',
        'Nothing — 11 V is the wrong magnitude entirely',
      ],
      correctAnswer: 1,
      explanation:
        'Must convert: 2.2 kΩ = 2200 Ω, 5 mA = 0.005 A. Correct: V = 2200 × 0.005 = 11 V. The answer is 11 V, but only because the units must first be put into base form.',
    },
    {
      id: 10,
      question: 'In the triangle, if you cover I, what operation do you see?',
      options: [
        'V × R',
        'V + R',
        'V ÷ R',
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Triangle Method:</strong> Visual aid to remember Ohm's Law rearrangements.
                </li>
                <li>
                  <strong>Cover & Read:</strong> Cover what you want to find, read what remains.
                </li>
                <li>
                  <strong>Always Convert:</strong> Change mA→A, kΩ→Ω before using the triangle.
                </li>
                <li>
                  <strong>Three Outcomes:</strong> V=I×R, I=V/R, R=V/I.
                </li>
                <li>
                  <strong>Sanity Check:</strong> Does your answer make sense for the circuit?
                </li>
                <li>
                  <strong>Practice:</strong> Essential skill for all electrical calculations.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Any time you need V, I, or R from the other two values.
                </li>
                <li>
                  <strong>Use:</strong> Circuit analysis, fault finding, component sizing
                  calculations.
                </li>
                <li>
                  <strong>Apply:</strong> MCB sizing, cable calculations, voltage drop checks per BS
                  7671.
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-4 text-white">
            <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-sm">
                  Easier to remember than three separate formulas. One triangle, all combinations.
                </p>
              </div>
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-sm">
                  No need to think which formula. Cover what you want, read what remains.
                </p>
              </div>
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-sm">
                  Reduces wrong formula errors. Same method every time builds confidence.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 text-white">
            <div className="flex items-center justify-center mb-8">
              ...
              <svg
                ...
                className="mx-auto"
                role="img"
                aria-label="Ohm's Law Triangle showing V at top, I and R at bottom"
              >
                ...
                <line x1="105" y1="140" x2="195" y2="140" stroke="white" strokeWidth="2" />
                ...
                <text
                  ...
                  y="175"
                  textAnchor="middle"
                  className="fill-white text-4xl font-bold font-sans"
                >
                  I
                </text>
            ...
            <div className="bg-slate-700/50 border border-slate-600 p-4 rounded-lg">
              <p className="text-sm text-white">
                <strong>Memory tip:</strong> V always goes at the top. I and R share the bottom.
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            ...
            <div className="bg-yellow-950/30 p-4 rounded-lg border border-yellow-800">
              <p className="text-sm">
                <strong>Critical Rule:</strong> Triangle method only works with base units (V, A,
                Ω). Convert first, calculate second!
              </p>
            </div>
          </div>
            ...
            <div className="grid gap-4">
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-sm mb-2">
                  <strong>Given:</strong> I = 0.5A, R = 220Ω. Find V.
                </p>
                <p className="text-sm mb-2">
                  <strong>Method:</strong> Cover V in triangle → see I×R
                </p>
                <p className="text-sm mb-2">
                  <strong>Solution:</strong> V = I × R = 0.5 × 220 = 110V
                </p>
                <p className="text-sm text-white">
                  <strong>Check:</strong> 110V with 0.5A sounds reasonable for a heater.
                </p>
              </div>
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                <h3 className="font-semibold text-teal-400 mb-2">
                  Example 2: Finding Current (with conversion)
                </h3>
                <p className="text-sm mb-2">
                  <strong>Given:</strong> V = 24V, R = 4.7kΩ. Find I.
                </p>
                <p className="text-sm mb-2">
                  <strong>Convert:</strong> 4.7kΩ = 4700Ω
                </p>
                <p className="text-sm mb-2">
                  <strong>Method:</strong> Cover I in triangle → see V÷R
                </p>
                <p className="text-sm mb-2">
                  <strong>Solution:</strong> I = V ÷ R = 24 ÷ 4700 = 0.0051A (5.1mA)
                </p>
              </div>
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                <h3 className="font-semibold text-teal-400 mb-2">Example 3: Finding Resistance</h3>
                <p className="text-sm mb-2">
                  <strong>Given:</strong> V = 230V, I = 10A. Find R.
                </p>
                <p className="text-sm mb-2">
                  <strong>Method:</strong> Cover R in triangle → see V÷I
                </p>
                <p className="text-sm mb-2">
                  <strong>Solution:</strong> R = V ÷ I = 230 ÷ 10 = 23Ω
                </p>
                <p className="text-sm text-white">
                  <strong>Check:</strong> 10A at 230V suggests 2.3kW heater - makes sense!
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid gap-3">
              <div className="flex items-start gap-3 p-3 bg-red-950/30 rounded border border-red-800">
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    Putting mA and kΩ directly into triangle without converting. Always use V, A, Ω
                    only!
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-3 bg-red-950/30 rounded border border-red-800">
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    Putting I or R at the top instead of V. V always goes at the top of the
                    triangle.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-3 bg-red-950/30 rounded border border-red-800">
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    Getting 2000A for a light bulb and not questioning it. Always sense-check your
                    answer!
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-4 text-white">
            <div className="grid gap-4">
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-sm">
                  Need to size an MCB? Measure voltage, calculate resistance from nameplate power,
                  use triangle to find current.
                </p>
              </div>
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                <h3 className="font-semibold text-orange-400 mb-2">
                  Fault Finding with Resistance
                </h3>
                <p className="text-sm">
                  Measure voltage and current, use triangle to find resistance. Compare with
                  expected values to find faults.
                </p>
              </div>
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                <h3 className="font-semibold text-orange-400 mb-2">LED Circuit Design</h3>
                <p className="text-sm">
                  Know supply voltage and LED current rating? Triangle gives you the resistor value
                  needed.
                </p>
              </div>
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-sm">
                  Apply known voltage, measure current, triangle gives actual resistance. Compare
                  with rated value.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-4 text-white">
            <div className="grid gap-3">
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-sm">
                  Rough mental maths first: 240V ÷ 24Ω ≈ 10A. If triangle gives 100A or 0.1A, check
                  your working.
                </p>
              </div>
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-sm">
                  Found I = 5A? Put it back: V = I × R should give your original voltage. No match =
                  error somewhere.
                </p>
              </div>
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-sm">
                  House lights: few amps. Kettles: 10-13A. Industrial motors: tens to hundreds. Does
                  your answer fit?
                </p>
              </div>
              <div className="bg-card/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-sm">
                  A 12V car circuit won't have thousands of ohms resistance. A control circuit won't
                  draw hundreds of amps.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-950/20 to-elec-yellow/10 border border-green-800 rounded-lg p-6">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <ul className="space-y-2 text-xs sm:text-sm text-white">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0" />V always
                  goes at the top; I and R share the bottom
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0" />
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/apprentice/level2/module2/section2/2-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
