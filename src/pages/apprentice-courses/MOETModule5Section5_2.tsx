...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'The resistance of control loop wiring',
  ...
  },
  {
    ...
    options: [
      ...
      'Only test when the plant is shut down',
  ...
  },
  {
    ...
    options: [
      ...
      'Measuring milliampere currents only',
      'Programming smart transmitters',
    ],
    correctAnswer: 1,
    explanation:
