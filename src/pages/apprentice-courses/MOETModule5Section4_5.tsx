...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Running the control algorithms',
      'Configuring control strategies, I/O assignments, graphics, and alarm settings',
      'Providing operator interface only',
      'Acting as a data historian',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The main control room cabinet',
      'A cabinet where field wiring terminates and is cross-connected to the DCS I/O modules',
      'A cabinet containing the network switches only',
      'A fireproof enclosure for paper documents',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Turning off all alarms during maintenance',
      ...
      'The volume control for the alarm horn',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'SCADA is always more expensive',
      'DCS cannot display process graphics',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Running the DCS in a virtual reality environment',
      'Running operator stations, engineering workstations, and servers as virtual machines on shared hardware',
      'Simulating the process without real instruments',
      'Using virtual keyboards instead of physical ones',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'They must design DCS systems from scratch',
      ...
      'DCS is only relevant to software engineers',
      'It is optional knowledge not required for the EPA',
    ],
    correctAnswer: 1,
    explanation:
