...
const Level3Module8MockExam1 = () => {
  useSEO(
    'Mock Exam 1: Health & Safety | Level 3 Electrical Course',
          ...
          <Card className="border-elec-yellow/30 bg-transparent">
            <CardHeader className="text-center pb-3 sm:pb-4 px-3 sm:px-6">
              ...
              <h2 className="text-xs sm:text-sm md:text-lg text-elec-yellow">
                Health and Safety Legislation & Practices
              </h2>
            </CardHeader>
                ...
                <div className="grid gap-2 sm:gap-2">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm sm:text-sm text-white leading-relaxed">
                      30 questions randomly selected from 200 Module 1 questions
                    </p>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 sm:h-1.5 sm:w-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 sm:h-1.5 sm:w-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0" />
                    <p className="text-sm sm:text-sm text-white leading-relaxed">
                      Topics: HASAWA, EAWR, RIDDOR, COSHH, Risk Assessment, Safe Systems
                    </p>
                  </div>
                </div>
              </div>
            ...
            <CardContent className="space-y-4 sm:space-y-6 px-3 sm:px-6">
              ...
              <div className="flex flex-col gap-3 pt-2">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Link
                    to="/study-centre/apprentice/level3-course/module8-section1"
                    className="flex-1"
                  >
                    <Button
                      variant="outline"
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <div className="text-sm text-white mt-1">
                    Level 3 Module 1 • Health & Safety
                  </div>
                </div>
                <Button
                  onClick={toggleFlag}
