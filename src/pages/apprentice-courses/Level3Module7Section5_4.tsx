...
const DESCRIPTION =
  'Master pricing and estimating for electrical work. Learn to calculate costs accurately, create competitive quotations, understand tendering processes, and price for profit.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "An estimate is an approximate cost that may change based on actual work required. A quotation is a fixed price for defined work that you're committed to unless the scope changes. Make sure clients understand which they're receiving.",
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'Your charge-out rate must cover all business costs including wages, vehicle costs, insurance, tools and equipment, training, office costs, marketing, and include a profit margin. Failing to account for all costs leads to losses.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 1,
    explanation:
      "Provisional sums are appropriate when elements cannot be fully assessed before work starts, such as hidden wiring conditions or unknown cable routes. Clearly explain what's provisional and why.",
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      'A thorough site survey is essential for complex jobs. Assess existing installation condition, access difficulties, specific requirements, and potential hidden issues. This prevents costly surprises.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "Daywork means charging a set rate per day (or hourly rate) plus materials at cost. It's often used when scope is uncertain or for maintenance work where you can't predict exactly what's needed.",
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'A bill of quantities (BoQ) is a document prepared by a quantity surveyor listing all items of work, their quantities, and space for contractors to insert rates. It allows like-for-like comparison of tenders.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      "On-costs or uplift covers indirect costs not directly attributable to a job: company overheads, materials wastage, transport, insurance, and profit margin. It's typically applied as a percentage to direct costs.",
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      "Exclusions should clearly state what's NOT included: making good (plastering, decorating), work by other trades, building control fees, scaffolding hire, unexpected remedial work. This prevents disputes.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Value engineering involves finding ways to reduce costs while still meeting requirements. This might mean suggesting alternative materials, methods, or designs that achieve the same result more efficiently.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'There can be strategic reasons to price competitively: establishing relationships with new clients, keeping teams busy during quiet periods, or gaining experience in new sectors. However, never price below cost.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'For longer projects, include a price variation clause allowing adjustment for significant material price changes. Set a threshold (e.g., 5% increase) and define how adjustments will be calculated.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'A thorough site survey gathers: exact scope, access difficulties, existing installation condition, cable routes, floor types, special requirements, working hours restrictions, and any factors affecting complexity.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      "Assumptions document what your price is based on. For example, 'assumes existing circuits are in serviceable condition'. If assumptions prove wrong, you have grounds for variation orders.",
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Formal tenders have strict requirements. Follow all instructions exactly, meet the deadline, include all required documents (method statements, H&S policy, insurance certificates), and price correctly against any bill of quantities.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Add up all annual costs: your desired salary, employer's NI, vehicle costs, insurance, tools, training, office costs, phone, professional fees. Divide by productive hours/days (typically 220 days accounting for holidays, training, admin, and quiet periods). Add your profit margin. Most electricians' charge-out rates are 2-3x their hourly wage.",
  },
  {
    question: 'Should I price jobs hourly or fixed price?',
    answer:
      'It depends on the job. Fixed prices work well for defined scope jobs where you can accurately estimate time. Daywork is better for uncertain scope, reactive maintenance, or diagnostic work. Many contractors offer both options to suit different situations.',
  },
  {
    question: 'How do I compete with cheaper competitors?',
    answer:
      "Don't compete purely on price - that's a race to the bottom. Compete on quality, reliability, professionalism, and value. Explain what your price includes that cheap competitors might not: quality materials, proper testing, documentation, warranties, insurance. Some customers always want cheapest; let them go.",
  },
  {
    question: 'What markup should I add to materials?',
    answer:
      'Typical material markups are 15-30%. This covers your time sourcing, collecting, and managing materials, plus wastage. For materials you stock regularly, you might markup more. For special orders at customer request, markup might be less. Consider your cash flow impact of buying materials.',
  },
  {
    question: 'How do I handle customers who say my quote is too high?',
    answer:
      "Ask what they're comparing against. Often cheap quotes exclude things yours includes. Walk through your quotation explaining each element. If they've had a significantly cheaper quote, they're probably not your customer - wishing them well and moving on is often the right response.",
  },
  {
    question: 'Should I break down my quotation in detail?',
    answer:
      "Provide enough detail to be clear about scope without giving away your pricing structure. Clients don't need to see your profit margin, but should understand what's included. For commercial work, more detail is often expected. For domestic work, a clear scope description with total price often works.",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Site Survey:</strong> Gather all information before pricing
              </li>
              <li>
                <strong>True Costs:</strong> Include all overheads plus profit margin
              </li>
              <li>
                <strong>Clear Scope:</strong> Define inclusions, exclusions, assumptions
              </li>
              <li>
                <strong>Variations:</strong> Document changes and get approval before proceeding
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Hidden complexities that add time and cost
              </li>
              <li>
                <strong>Use:</strong> Systematic approach to pricing every job
              </li>
              <li>
                <strong>Apply:</strong> Clear documentation prevents disputes
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Accurate pricing starts with understanding your true costs. Many electricians
              undercharge because they only consider direct costs (labour and materials) without
              accounting for all the overheads that enable them to do business.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Your charge-out rate must cover all costs including
              overheads, not just your hourly wage. If you earn 20 per hour employed, you need to
              charge 40-60 per hour self-employed to cover everything plus profit.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The quality of your pricing depends on the quality of your information. A thorough
              site survey prevents costly surprises and gives you confidence in your pricing. Never
              price complex work without visiting site.
            </p>
            ...
            <p className="text-sm text-white italic">
              <strong>Example:</strong> For a rewire quote, you need to know: property size and
              construction, number of floors, loft access, whether decoration will be done after,
              existing consumer unit condition, and whether the client wants specific products or
              finishes.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A well-structured quotation protects you and builds client confidence. It should be
              clear about what's included, what's excluded, and any assumptions that affect the
              price.
            </p>
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent border border-white/10">
                ...
                <p className="text-white text-xs">What work will be done</p>
              </div>
              <div className="p-3 rounded bg-transparent border border-white/10">
                <p className="font-medium text-white mb-1">Exclusions</p>
                <p className="text-white text-xs">What's NOT included</p>
              </div>
              <div className="p-3 rounded bg-transparent border border-white/10">
                <p className="font-medium text-white mb-1">Assumptions</p>
                <p className="text-white text-xs">What price is based on</p>
              </div>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Critical Point:</strong> Exclusions protect you from scope creep. Common
              exclusions: making good (plastering, decorating), asbestos removal, structural
              alterations, building control fees, and work by other trades.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Even with thorough surveys, unforeseen issues arise. Having a clear process for
              variations prevents disputes. For commercial work, understanding formal tendering
            ...
            <p className="text-sm text-white italic">
              <strong>Example:</strong> During a kitchen rewire, you discover the existing wiring is
              in poorer condition than expected and needs more work. Stop, document the issue with
              photos, explain to the client, provide a written variation price, and only proceed
              once approved.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Fixed price:</strong> Best for defined scope - rewards efficiency
                </li>
                <li>
                  <strong>Daywork:</strong> Best for uncertain scope - reduces risk but may concern
                  clients
                </li>
                <li>
                  <strong>Daywork with maximum:</strong> Compromise - daywork up to a capped figure
                </li>
                <li>
                  <strong>Schedule of rates:</strong> Pre-agreed rates for common tasks
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Forgetting overheads</strong> - Include all costs, not just labour and
                  materials
                </li>
                <li>
                  <strong>Vague scope</strong> - Be specific about what's included and excluded
                </li>
                <li>
                  <strong>No contingency</strong> - Add allowance for unforeseen issues
                </li>
                <li>
                  <strong>Price pressure</strong> - Don't cut price below sustainable levels
                </li>
              </ul>
            </div>
          </div>
