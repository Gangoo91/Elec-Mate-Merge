/**
 * MOET · Module 6 · Section 1 · Subsection 1 — Engineering Drawing Conventions
 *
...
const MOETModule6Section1_1 = () => {
  ...
  return (
    <HubPage ground="reading">
      <HubMasthead
        section="Module 6 · Section 6.1 · Subsection 1"
      ...
      <HubBody pushContext="Get notified about your course progress, quiz streaks and new study content">
        <StudyPage>
          ...
          <TLDR
            points={[
              'Conventions: A shared language so a drawing means one thing to everyone',
              'Drawing types: Schematic, wiring, layout, single-line, P&ID — each answers a different question',
              'Title block: Number, revision, scale, projection, who approved it and when',
              'Revision control: Working to a superseded sheet is working blind',
            ]}
          />
          ...
          <ContentEyebrow>Standardisation</ContentEyebrow>

          <ConceptBlock title="Why Standardised Drawings Exist">
            <p>
          ...
          <ConceptBlock title="What conventions actually give you">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Portability:</strong> A drawing produced by one organisation can be read by
                another without translation or explanation
              </li>
              <li>
          ...
          <ConceptBlock title="Where the rules come from">
            <p>
              ...
              maintained as a central database. BS 7671:2018+A4:2026 ties the two worlds together at
              Regulation 514.9.1, which requires that any symbol used in the diagrams, charts,
          ...
          <ConceptBlock title="What BS 7671 requires to be provided">
            <p>
            ...
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              ...
              <li>The method used for compliance with Regulation 410.3.2</li>
              <li>
            ...
            <p>
              A4:2026 introduced an exception to Regulation 514.9.1 relating to domestic (household)
              premises. Read the published wording before relying on it — an exception that applies
              to a dwelling does not travel with you onto an industrial site.
            </p>
          ...
          <ContentEyebrow>Choosing the right drawing</ContentEyebrow>

          <ConceptBlock title="The Drawing Types You Will Meet">
            <p>
          ...
          <ConceptBlock title="Schematic and circuit diagrams">
            <p>
              A schematic explains function. Components are drawn as standard symbols and arranged
              so the logic reads cleanly — commonly as horizontal rungs between two vertical supply
              rails, read left to right and top to bottom. Physical position is ignored completely:
              the two halves of a single relay may appear on opposite ends of the sheet, linked only
              by a coil reference and a cross-reference to the rung where each contact appears.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
          ...
          <ConceptBlock title="Wiring and connection diagrams">
            <p>
              ...
              positions and the physical destination of every conductor. Where a schematic says that
              the start contact energises the contactor coil, the connection diagram says that core
              4 of cable MCC-14 lands on terminal X2:17.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
          ...
          <ConceptBlock title="Layout and general arrangement drawings">
            <p>
              ...
              arrangement drawing does the same job at a smaller scope: the physical size, mounting
              centres, cable entry positions and door swing of a single enclosure.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
          ...
          <ConceptBlock title="Single-line (one-line) diagrams">
            <p>
            ...
            <p>
              ...
              Regulation 560.7.9, which requires that full details of all electrical safety sources,
              together with a general schematic diagram, are maintained adjacent to the distribution
              board — and notes that a single-line diagram is sufficient for that schematic.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Shows:</strong> Sources, switchgear, protective devices, busbars, submains,
                board hierarchy, ratings
              </li>
              <li>
          ...
          <ConceptBlock title="Piping and instrumentation diagrams (P&ID)">
            <p>
              A P&amp;ID is a process drawing, but it is not somebody else&apos;s problem. It shows
              vessels, pumps, pipework, valves and — crucially for you — every instrument in the
              process, each carrying a unique tag number. Those tag numbers follow the instrument
              through the loop drawings, the marshalling cabinet, the control system and the
              maintenance history. When a level transmitter fails, the P&amp;ID tells you what it is
              measuring, what trips depend on it and what happens to the process if you take it out
              of service.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Shows:</strong> Process flow, vessels and pipework, valves, instruments and
                their tag numbers, control and trip functions
              </li>
              <li>
          ...
          <ConceptBlock title="Which drawing do I reach for?">
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left text-[13.5px]">
                <thead>
                  <tr className="border-b border-white/10">
                    <th className="py-2 pr-4 font-medium text-white">The question</th>
                    <th className="py-2 pr-4 font-medium text-white">The drawing</th>
                    <th className="py-2 font-medium text-white">Why</th>
                  </tr>
                </thead>
                <tbody className="text-white">
                  <tr className="border-b border-white/5">
                    ...
                    <td className="py-2 pr-4">Single-line diagram</td>
                    <td className="py-2">
                      Shows sources, switchgear and the board hierarchy on one sheet
                    </td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">Why does the contactor not pull in?</td>
                    <td className="py-2 pr-4">Schematic diagram</td>
                    <td className="py-2">
                      Shows the control logic and every permissive in the chain
                    </td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">Which terminal does this core land on?</td>
                    <td className="py-2 pr-4">Wiring or connection diagram</td>
                    <td className="py-2">
                      Shows terminal numbers, cable references and core identification
                    </td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">Where in the building is board DB-3?</td>
                    <td className="py-2 pr-4">Layout drawing</td>
                    <td className="py-2">
                  ...
                  <tr className="border-b border-white/5">
                    ...
                    <td className="py-2 pr-4">General arrangement drawing</td>
                    <td className="py-2">
          ...
          <ContentEyebrow>Reading line types</ContentEyebrow>

          <ConceptBlock title="Line Types and What They Mean">
            <p>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left text-[13.5px]">
                ...
                <tbody className="text-white">
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">Continuous thick</td>
                    <td className="py-2 pr-4">Solid, heavy</td>
                    <td className="py-2">
                      Visible outlines and edges — what you can actually see from that direction
                    </td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">Continuous thin</td>
                    <td className="py-2 pr-4">Solid, light</td>
                    <td className="py-2">
                      Dimension lines, projection lines, leader lines, hatching
                    </td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">Dashed thin</td>
                    <td className="py-2 pr-4">Even short dashes</td>
                    <td className="py-2">
                      Hidden edges and outlines — features present but not visible in that view
                    </td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">Chain thin</td>
                    <td className="py-2 pr-4">Long dash, short dash</td>
                    <td className="py-2">Centre lines, axes of symmetry, hole and shaft centres</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">Chain, thick at ends</td>
                    <td className="py-2 pr-4">Long-short with heavy ends and arrows</td>
                    <td className="py-2">Cutting plane for a sectional view, lettered A-A, B-B</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4">Chain thin, double dash</td>
                    <td className="py-2 pr-4">Long dash, two short</td>
                    <td className="py-2">
                      Outlines of adjacent parts, or a moving part shown in an alternative position
                    </td>
                  </tr>
                  <tr>
                    <td className="py-2 pr-4">Continuous thin irregular</td>
                    <td className="py-2 pr-4">Wavy freehand</td>
                    <td className="py-2">
          ...
          <ConceptBlock title="Line conventions on electrical diagrams">
            <p>
          ...
          <ConceptBlock title="Why hidden detail matters in maintenance">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                <strong>Rear-face knockouts:</strong> Cable entries on the back of an enclosure are
                shown dashed on the front elevation
              </li>
              <li>
          ...
          <ContentEyebrow>Title blocks &amp; revisions</ContentEyebrow>

          <ConceptBlock title="Title Blocks, Drawing Numbers and Revision Control">
            <p>
          ...
          <ConceptBlock title="What lives in a title block">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                <strong>Revision and status:</strong> Which issue you are holding, and whether it is
                preliminary, for construction, as-built or superseded
              </li>
              <li>
              ...
              <li>
                <strong>Units and general tolerance:</strong> The default unit, usually millimetres,
                and any blanket tolerance note
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="Drawing numbers: structure, not sequence">
            <p>
              Drawing numbers are rarely a simple count. Most organisations use a structured number
              in which each block of characters means something — project, area or system,
              discipline, drawing type and a serial number. A number such as P4821-MCC2-E-SCH-014
              might read as project 4821, motor control centre 2, electrical discipline, schematic,
              sheet 14. Once you learn the scheme in use on your site you can predict where a
              drawing lives and request the right one first time.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>
              ...
              <li>
                <strong>Discipline codes matter:</strong> E for electrical, M for mechanical, C for
                civil, I for instrumentation — the same area may have four drawings with otherwise
                similar numbers
              </li>
              <li>
                <strong>Always quote number and revision together:</strong> Asking for &quot;the MCC
                schematic&quot; invites the wrong sheet; asking for a number at a stated revision
                does not
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="How revision control works">
            <p>
            ...
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Check the revision against the register:</strong> The sheet cannot tell you
                that a later revision exists — only the register can
              </li>
              <li>
          ...
          <CommonMistake
            title="The sheet in the panel door"
            whatHappens={
              <>
                <p>
                  ...
                  the outgoing device fitted but no cable connected. He plans the work on that
                  basis, isolates and locks off the supply to the drive, and opens the way 7 chamber
                  to terminate his new submain.
                </p>
                <p>
                  The sheet in the wallet is revision C, issued four years earlier. Revision E,
                  issued eighteen months ago after a plant extension, reassigned way 7 to feed a
                  small distribution board in the packing hall. The chamber is live. The lock-off he
                  applied is on a different circuit entirely, and the only thing standing between
                  him and a fault across a live busbar chamber is his prove-dead test — a control
                  that exists precisely because paperwork fails.
                </p>
              </>
            }
            doInstead={
          ...
          <ConceptBlock title="A drawing is a snapshot, not a live feed">
            <p className="text-elec-yellow/70">
          ...
          <ContentEyebrow>Scale &amp; projection</ContentEyebrow>

          <ConceptBlock title="Scales and Projection Awareness">
            <p>
          ...
          <ConceptBlock title="Scales you will meet">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                <strong>NTS</strong> — not to scale, the norm on schematics and single-line diagrams
                where geometry carries no meaning
              </li>
            </ul>
          </ConceptBlock>

          <CommonMistake
            title="Never scale from a print"
            whatHappens={
              <>
            ...
            doInstead={
              <>
                Use the stated dimension. Where no dimension is given, measure the installation
                itself or request a dimensioned drawing.
              </>
            }
          />

          <ConceptBlock title="First angle and third angle projection — awareness level">
            <p>
            ...
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>First angle</strong> — the usual UK and European convention. The view falls
                on the far side of the object, so the plan appears below the front elevation and the
                view looking from the right appears on the left
              </li>
              <li>
                <strong>Third angle</strong> — the usual North American convention. The view falls
                on the near side, so the plan appears above the front elevation and the view looking
                from the right appears on the right
              </li>
            </ul>
            <p>
              The convention in use is declared by the projection symbol: a truncated cone drawn in
              two views, placed in or beside the title block. In first angle, the small circle (the
              narrow end seen end-on) sits on the opposite side to the tapered outline; in third
              angle it sits on the same side. You do not need to be able to construct projections to
              work safely, but you must be able to find that symbol and know what it changes.
              Section 6.1.3 develops orthographic projection in full.
            </p>
            <p className="text-elec-yellow/70">
          ...
          <ContentEyebrow>Registers &amp; red-lining</ContentEyebrow>

          <ConceptBlock title="Drawing Registers, Red-Lining and As-Built Discipline">
            <p>
          ...
          <ConceptBlock title="What a drawing register gives you">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                <strong>Issue date:</strong> Lets you judge how much plant change may have happened
                since
              </li>
              <li>
          ...
          <ConceptBlock title="Red-lining: marking up what you actually found">
            <p>
              Red-lining is the practice of marking a drawing to record what was actually installed,
              as distinct from what the drawing shows. The name comes from the traditional use of a
              red pen on a print so that the mark-up cannot be mistaken for original content. Those
              mark-ups are collected by whoever controls the drawings and incorporated into the next
              issued revision, which is how a set of construction drawings eventually becomes a set
            ...
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Show what was removed as well as what was added:</strong> Strike through the
                redundant item rather than erasing it, so the change is visible
              </li>
              <li>
              ...
              <li>
                <strong>Do not red-line a guess:</strong> If you are not certain what is installed,
                prove it by inspection and test first
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="Drawings, labelling and the certificate">
            <p>
              ...
              type and composition, the means of compliance with Regulation 410.3.2, identification
              and location of the devices performing protection, isolation and switching, and any
              circuit or equipment vulnerable to the tests of Part 6 — has to remain true after your
              modification, not just on the day the installation was energised.
            </p>
            <p>
              ...
              diagrams. Conductor identification carries the same logic: Regulation 514.3.1 requires
              conductors to be identified so their function can be determined, and that
            ...
            <p>
              ...
              details of all electrical safety sources together with a general schematic diagram to
              be maintained adjacent to the distribution board, and notes that a single-line diagram
              is sufficient for that schematic. The word maintained is doing real work in that
              regulation: adding a generator or a changeover device and leaving the old schematic on
              the wall does not satisfy it.
            </p>
            <p className="text-elec-yellow/70">
          ...
          <ContentEyebrow>Symbols &amp; IEC 60617</ContentEyebrow>

          <ConceptBlock title="Electrical Symbols and IEC 60617">
            <p>
          ...
          <ConceptBlock title="Common symbols, described in words">
            <p>
            ...
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Normally open contact:</strong> Two short in-line conductor stubs with a gap
                between them, one carrying a short angled bar that does not bridge the gap — the
                circuit is open until the contact operates
              </li>
              <li>
                <strong>Normally closed contact:</strong> The same arrangement with the angled bar
                crossing the gap and a short stroke through it, indicating the contact is made until
                it operates
              </li>
              <li>
              ...
              <li>
                ...
                horizontal bars; protective earth carries additional identification where it must be
                distinguished from functional earth
              </li>
              <li>
                <strong>Motor:</strong> A circle containing a letter M, commonly with the number of
                phases or the supply type annotated alongside
              </li>
              <li>
          ...
          <ConceptBlock title="Symbols versus safety signs">
            <p>
              ...
              prohibitions and mandatory signs fixed to equipment — are drawn from BS EN ISO 7010, a
              different standard with different rules about colour, shape and placement. A warning
              notice fixed to a distribution board and the symbol representing that board on a
              schematic come from two separate standards.
            </p>
          </ConceptBlock>

          <ConceptBlock title="Reading symbols without guessing">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Find the key first:</strong> Most drawing sets include a legend sheet; where
                a symbol is unusual, the legend is the authority for that set
              </li>
              <li>
                <strong>Read the annotation, not just the shape:</strong> Two devices may share a
                symbol and differ entirely in rating, type and function — the text beside it carries
                that
              </li>
              <li>
                <strong>Check the state convention:</strong> Contacts are drawn in the de-energised,
                unoperated state unless the sheet says otherwise; misreading that inverts your whole
          ...
          <CommonMistake
            title="A symbol is not a substitute for proving dead"
            whatHappens={
              <>
            ...
            doInstead={
              <>
                Drawings are a planning tool: they tell you where to isolate, what else may be live,
                and what may be fed from a second source. The isolation is then proved by safe
                isolation procedure using an approved voltage indicator and a proving unit, every
                time, at the point of work.
              </>
            }
          />

          <ConceptBlock title="Symbols are standardised so meaning does not depend on the author">
            <p className="text-elec-yellow/70">
          ...
          <KeyTakeaways
            points={[
              'Single-line — supplies, sources, isolation points',
              'Schematic — control logic; wiring diagram — terminals',
              'Layout/GA — position, dimensions, fit; P&ID — process',
              'Read the title block: number, revision, scale, projection',
              'Check the revision against the drawing register',
              'Never scale a dimension from a print',
              'Red-line changes at the time, dated and signed',
              'Thick continuous — visible outlines',
              'Thin dashed — hidden detail; thin chain — centre lines',
              'Dot at a crossing — a connection',
              '514.9.1 — diagram/chart/table information required',
              '514.9.1 — symbols shall comply with IEC 60617',
              '560.7.9 — schematic kept adjacent to the board',
              '642.3(l) — labelling checked at inspection',
            ]}
          />
