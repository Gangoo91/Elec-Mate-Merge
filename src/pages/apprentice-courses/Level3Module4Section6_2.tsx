...
const seoDescription =
  'Learn strategies for managing time effectively and working efficiently under pressure in electrical fault diagnosis, including prioritisation techniques, stress management, and deadline negotiation.';
...
const quickCheckQuestions = [
  {
    ...
    correctAnswer: 2,
    explanation:
      'Safety must never be compromised regardless of time pressure. Shortcuts that risk safety can lead to injury, death, or fire. Other aspects may be adapted within reason, but safe working practices are non-negotiable.',
  },
  {
    question:
      'A customer demands you complete an urgent repair faster than safely possible. What should you do?',
    options: [
      'Work faster to meet their demands',
      'Explain the safety requirements and provide realistic timescales',
      'Leave the job immediately',
      "Complete the work but don't certify it",
    ],
    correctAnswer: 1,
    explanation:
      'Professional practice requires explaining why the work cannot be done faster without compromising safety. Provide realistic timescales and help the customer understand the implications of rushing safety-critical work.',
  },
  {
    question: 'What is the most effective way to handle multiple urgent callouts on the same day?',
    options: [
      'Accept all jobs and work through the night',
      'Prioritise based on safety risk and communicate with all customers',
      'Only attend the highest-paying job',
      'Complete half of each job',
    ],
    correctAnswer: 1,
    explanation:
      'Effective management involves prioritising based on safety risk and urgency, then communicating honestly with all customers about realistic timescales. This maintains trust while ensuring the most critical situations are addressed first.',
  },
  {
    question:
      'When you realise a job will take longer than quoted, when should you inform the customer?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Professional practice requires informing the customer as soon as you realise timescales or costs will exceed estimates. Early communication allows them to make informed decisions and maintains trust.',
  },
];
...
const quizQuestions = [
  {
    question:
      'What is the primary cause of stress when working on fault diagnosis under time pressure?',
    options: [
      'Physical exertion',
    ...
    correctAnswer: 1,
    explanation:
      'Stress often stems from uncertainty and feeling out of control. Having systematic approaches, clear priorities, and good communication helps restore a sense of control and reduces stress even in demanding situations.',
  },
  {
    question: 'Which approach to time management is most effective for fault diagnosis work?',
    options: [
      'Always quote fixed times to appear confident',
      'Build contingency into estimates and communicate ranges',
      'Refuse to provide time estimates',
      'Complete all diagnosis before discussing timescales',
    ],
    correctAnswer: 1,
    explanation:
      'Effective time management involves providing realistic ranges that include contingency for unexpected complications. This sets appropriate expectations and reduces pressure when issues arise.',
  },
  {
    question: 'When multiple tasks compete for your time, what should determine priority?',
    options: [
      'Which customer is most assertive',
      'Which job pays the most',
      'Safety risk, urgency, and customer impact',
      'Order in which jobs were received',
    ],
    correctAnswer: 2,
    explanation:
      'Priority should be determined by safety risk first, then genuine urgency, and customer impact. A property without power or with a safety hazard takes precedence over routine work regardless of booking order.',
  },
  {
    question: 'How can systematic fault diagnosis methodology help with time pressure?',
    options: [
      'It eliminates all pressure',
      'It provides structure and prevents wasted effort',
      'It guarantees quick resolution',
      'It removes the need for customer communication',
    ],
    correctAnswer: 1,
    explanation:
      'A systematic approach provides structure, ensures nothing is missed, and prevents wasted effort from random troubleshooting. This methodical process is actually faster than haphazard approaches and reduces stress.',
  },
  {
    question: 'What should you do if safety cannot be maintained due to time constraints?',
    options: [
      'Take calculated risks to meet the deadline',
      'Stop work and discuss options with the customer',
      'Complete the work but document your concerns',
      'Work faster to minimise exposure time',
    ],
    correctAnswer: 1,
    explanation:
      'If safety cannot be maintained, work must stop. Discuss the situation with the customer, explain why more time is needed, and agree a revised plan that allows safe completion of the work.',
  },
  {
    question: 'How should you prepare for a callout where you know time will be critical?',
    options: [
      'Skip preparation to save time for the actual work',
      'Gather information, plan approach, and ensure equipment is ready',
      'Bring all equipment regardless of likely need',
      'Arrive as quickly as possible without planning',
    ],
    correctAnswer: 1,
    explanation:
      'Good preparation saves time during the actual work. Gathering information about the fault, planning your approach, and ensuring appropriate equipment is ready reduces wasted time on site.',
  },
  {
    question: 'What is a key sign that you are taking on too much work?',
    options: [
      'You are busy all the time',
      'You are consistently missing deadlines and feeling overwhelmed',
      'Customers ask for urgent appointments',
      'You have to work some weekends',
    ],
    correctAnswer: 1,
    explanation:
      'Consistently missing deadlines and feeling overwhelmed indicates unsustainable workload. Some busy periods are normal, but persistent overcommitment affects quality, safety, and wellbeing.',
  },
  {
    question: 'How can good record-keeping help manage time pressure?',
    options: [
      "It doesn't - documentation takes time away from productive work",
      'Previous records help diagnose recurring issues faster',
      'Records eliminate the need for testing',
      'Documentation should be skipped when busy',
    ],
    correctAnswer: 1,
    explanation:
      'Good records from previous visits can significantly speed up diagnosis of recurring issues. Documentation invested now saves time in future and protects you professionally.',
  },
  {
    question: 'When should you decline or defer work?',
    options: [
      'Never - always accept available work',
      'When taking on more would compromise quality or safety',
      'Only when the pay is too low',
      'When the customer is difficult',
    ],
    correctAnswer: 1,
    explanation:
      'Professional practice sometimes requires declining or deferring work when accepting it would compromise quality, safety, or existing commitments. Overcommitment harms everyone.',
  },
  {
    question: 'What role does physical and mental wellbeing play in working under pressure?',
    options: [
      'No role - professionalism overcomes fatigue',
      'Wellbeing directly affects judgement, safety, and performance',
      'Only affects customer interactions',
      'Only relevant for office workers',
    ],
    correctAnswer: 1,
    explanation:
      'Physical and mental wellbeing directly affects judgement, concentration, and safety performance. Fatigue and stress impair decision-making and increase accident risk.',
  },
  {
    question: 'How should you handle a situation where you make an error due to rushing?',
    options: [
      'Cover it up to avoid embarrassment',
      'Acknowledge the error, inform affected parties, and correct it',
      'Blame time pressure from the customer',
      'Complete the job quickly and leave',
    ],
    correctAnswer: 1,
    explanation:
      'Professional integrity requires acknowledging errors, informing affected parties, and taking corrective action. Attempting to hide mistakes can compound problems and creates liability.',
  },
  {
    question: 'What is the benefit of scheduling buffer time between jobs?',
    options: [
      'It reduces earnings',
      'It allows for overruns and reduces cascading delays',
      "It's only needed for inexperienced electricians",
      'Customers prefer back-to-back scheduling',
    ],
    correctAnswer: 1,
    explanation:
      'Buffer time between jobs allows for inevitable overruns without creating cascading delays. This reduces stress, maintains customer relationships, and provides time for proper documentation.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="mb-8 sm:mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-white">
              Understanding Pressure in Electrical Work
            </h2>
          </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <ul className="list-disc pl-5 text-white text-sm space-y-2">
              ...
              <li>
                <strong>Poor decision-making:</strong> Rushing to conclusions without proper
                verification
              </li>
              <li>
                <strong>Safety shortcuts:</strong> Skipping safety procedures to save time
              </li>
              <li>
                <strong>Communication breakdown:</strong> Failing to keep customers informed
              </li>
              <li>
                <strong>Quality issues:</strong> Incomplete repairs or inadequate testing
              </li>
              <li>
                <strong>Documentation gaps:</strong> Skipping records that provide protection
              </li>
            </ul>
          </div>
        </section>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="overflow-x-auto mb-6">
              <table className="w-full text-sm text-white border border-white/20">
                ...
                <tbody>
                  <tr>
                    <td className="border border-white/20 p-2 text-red-400 font-semibold">
                      Critical
                    </td>
                    <td className="border border-white/20 p-2">
                      Immediate safety hazard, risk to life
                    </td>
                    <td className="border border-white/20 p-2">
                      Attend immediately, defer other work
                    </td>
                  </tr>
                  <tr className="bg-white/5">
                    <td className="border border-white/20 p-2 text-orange-400 font-semibold">
                      Urgent
                    </td>
                    <td className="border border-white/20 p-2">
                      Property without essential services, significant business impact
                    </td>
                    <td className="border border-white/20 p-2">
                      Attend same day, communicate delays to other customers
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-white/20 p-2 text-yellow-400 font-semibold">
                      Important
                    </td>
                    <td className="border border-white/20 p-2">
                      Significant inconvenience, scheduled commitments
                    </td>
                    <td className="border border-white/20 p-2">
                      Schedule promptly, honour existing appointments
                    </td>
                  </tr>
                  <tr className="bg-white/5">
                    <td className="border border-white/20 p-2 text-green-400 font-semibold">
                      Routine
                    </td>
            ...
            <div className="bg-white/5 rounded-lg p-4 mb-4">
              <ul className="list-disc pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  <strong>Travel consideration:</strong> Account for realistic travel times
                </li>
                <li>
                  <strong>Complexity matching:</strong> Avoid scheduling complex work back-to-back
                </li>
                <li>
                  <strong>Documentation time:</strong> Include time for paperwork and certificates
                </li>
                <li>
                  <strong>Equipment preparation:</strong> Allow time to load van and check equipment
                </li>
                <li>
                  <strong>Emergency capacity:</strong> Leave some flexibility for urgent callouts
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-r from-yellow-400/10 to-amber-500/10 rounded-lg p-4 border border-yellow-400/20 mb-4">
              ...
              <ol className="list-decimal pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  <strong>Add contingency:</strong> Include 20-30% for unexpected complications
                </li>
                <li>
                  <strong>Consider specifics:</strong> Account for access, property age, complexity
                  indicators
                </li>
                <li>
                  <strong>Communicate ranges:</strong> Provide realistic ranges rather than fixed
                  times
                </li>
                <li>
                  <strong>Update as needed:</strong> Revise estimates when new information emerges
                </li>
              </ol>
            </div>
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <h3 className="text-lg font-semibold text-white mt-6 mb-3">
              Common Safety Shortcuts Under Pressure
            </h3>
            ...
            <div className="bg-white/5 rounded-lg p-4 mb-4">
              <ul className="list-disc pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  "The customer is waiting" - customer inconvenience never justifies safety risks
                </li>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-white/5 rounded-lg p-4 mb-4">
              ...
              <ul className="list-disc pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  <strong>Breathe:</strong> Slow, deep breaths reduce the physical stress response
                </li>
                <li>
                  <strong>Prioritise:</strong> Identify what actually needs to happen next
                </li>
                <li>
                  <strong>Simplify:</strong> Break complex problems into manageable steps
                </li>
                <li>
                  <strong>Communicate:</strong> Sharing concerns reduces their weight
                </li>
                <li>
                  <strong>Focus:</strong> Concentrate on the current task, not everything else
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-lg p-4 border border-green-500/20 mb-4">
              ...
              <ul className="list-disc pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  <strong>Breaks:</strong> Take proper breaks during the day, especially on
                  difficult jobs
                </li>
                <li>
                  <strong>Nutrition:</strong> Eat properly - blood sugar affects concentration
                </li>
                <li>
                  <strong>Hydration:</strong> Drink water throughout the day
                </li>
                <li>
                  <strong>Exercise:</strong> Physical activity reduces stress and improves
                  resilience
                </li>
                <li>
                  <strong>Boundaries:</strong> Maintain separation between work and personal time
                </li>
              </ul>
            </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-gradient-to-r from-yellow-400/10 to-amber-500/10 rounded-lg p-4 border border-yellow-400/20 mb-4">
              ...
              <ol className="list-decimal pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  <strong>Explain the reason:</strong> Be honest about what has changed
                </li>
                <li>
                  <strong>Provide revised estimate:</strong> Give realistic new timescales
                </li>
                <li>
                  <strong>Offer options:</strong> Where possible, provide choices
                </li>
                <li>
                  <strong>Document changes:</strong> Confirm revised agreements in writing
                </li>
                <li>
                  <strong>Apologise appropriately:</strong> Acknowledge any inconvenience caused
                </li>
              </ol>
            </div>
        ...
        {/* Quiz Section */}
        <section className="mb-8 sm:mb-12">
          <Quiz title="Section 6.2 Knowledge Check" questions={quizQuestions} passingScore={75} />
        </section>
        ...
        <nav className="flex flex-col sm:flex-row justify-between gap-4 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/apprentice/level3-module4-section6-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
