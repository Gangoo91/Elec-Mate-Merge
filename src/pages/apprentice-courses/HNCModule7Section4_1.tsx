...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['32 addresses', '64 addresses', '48 addresses', '128 addresses'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['64 groups', '8 groups', '32 groups', '16 groups'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['500 metres', '100 metres', '300 metres', '200 metres'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['8 scenes', '4 scenes', '32 scenes', '16 scenes'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['1,200 bits/second', '9,600 bits/second', '100 bits/second', '115,200 bits/second'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="DALI Protocol Fundamentals">
          ...
          <p>
            <strong>Key DALI characteristics:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Two-wire digital bus:</strong> Simple wiring, polarity independent
            </li>
            <li>
              <strong>SELV operation:</strong> Safe extra low voltage (16V DC nominal)
            </li>
            <li>
              <strong>Bidirectional:</strong> Commands sent, status returned
            </li>
            <li>
              <strong>Multi-master:</strong> Multiple controllers can share bus
            </li>
          </ul>
          <p>
            <strong>DALI Protocol Specifications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Standard:</strong> IEC 62386 — Multi-part international standard
            </li>
            <li>
              <strong>Bus voltage:</strong> 16V DC (9.5V-22.5V) — SELV, supplied by bus PSU
            </li>
            <li>
              <strong>Data rate:</strong> 1,200 bits/second — Manchester encoded
            </li>
            <li>
              <strong>Maximum current:</strong> 250mA — Total bus current limit
            </li>
            <li>
              <strong>Maximum length:</strong> 300m — Single bus segment
            </li>
            <li>
              <strong>Dimming range:</strong> 0.1% to 100% — Logarithmic curve (254 steps)
            </li>
          </ul>
          <p>
            <strong>DALI vs Analogue Dimming (1-10V)</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Design principle:</strong> DALI provides granular control at the luminaire level
            whilst maintaining simple two-wire installation comparable to traditional switching.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Addressing, Groups and Scenes">
          <p>
            DALI's power lies in its addressing structure. Each bus supports 64 individual
            addresses, 16 groups for collective control, and 16 scenes for preset configurations.
            This enables flexible, efficient lighting control without complex wiring changes.
          </p>
          <p>
            <strong>Individual Addressing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Addressing Modes Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Individual:</strong> Specific luminaire control — Address 15: dim to 50%
            </li>
            <li>
              <strong>Group:</strong> Zone/area control — Group 3: recall scene 2
            </li>
            <li>
              <strong>Broadcast:</strong> All luminaires on bus — All: off
            </li>
            <li>
              <strong>Scene:</strong> Preset configurations — Scene 5: meeting room presentation
            </li>
          </ul>
          <p>
            <strong>Typical Group Assignment Example</strong>
          </p>
          <p>
            <strong>Open plan office floor:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Group 0:</strong> All general lighting (master control)
            </li>
            <li>
              <strong>Group 1:</strong> Perimeter luminaires (daylight linking)
            </li>
            <li>
              <strong>Group 2:</strong> Window row (blind integration)
            </li>
            <li>
              <strong>Group 3:</strong> Desk zone A (presence detection)
            </li>
            <li>
              <strong>Group 4:</strong> Desk zone B (presence detection)
            </li>
            <li>
          ...
          <p>
            <strong>Best practice:</strong> Plan group assignments during design to align with
            control requirements - presence zones, daylight zones, switch zones, and cleaning
            circuits.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="System Architecture and Gateways">
          <p>
            ...
            hierarchy of components enables appropriate system specification for project
            requirements.
          </p>
          <p>
            <strong>DALI System Hierarchy</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Level 4:</strong> BMS / Supervisory System
            </li>
          </ul>
          <p>↓ BACnet/IP, Modbus TCP, KNX</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Level 3:</strong> DALI Gateway / Router
            </li>
          </ul>
          <p>↓ Protocol translation</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Level 2:</strong> Application Controller
            </li>
          </ul>
          <p>↓ DALI bus (multiple)</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Level 1:</strong> Control Gear (Drivers) + Input Devices (Sensors/Switches)
            </li>
          </ul>
          <p>
            <strong>Key System Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DALI PSU:</strong> Provides 16V DC bus power - one per bus (unless integrated
              in controller)
            </li>
            <li>
              <strong>Control gear:</strong> DALI drivers in luminaires - receive commands, dim LEDs
            </li>
            <li>
              <strong>Input devices:</strong> Sensors, switches, push buttons (DALI-2) - generate
              commands
            </li>
            <li>
              <strong>Application controller:</strong> Manages one or more buses, stores logic and
              schedules
            </li>
            <li>
              <strong>Gateway:</strong> Protocol translator to BACnet, KNX, Modbus, Ethernet
            </li>
          </ul>
          <p>
            <strong>Gateway Integration Options</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BACnet/IP:</strong> Building Management Systems — Full status and control
            </li>
            <li>
              <strong>KNX:</strong> European building automation — Seamless integration
            </li>
            <li>
              <strong>Modbus RTU/TCP:</strong> Industrial/process control — Register-based access
            </li>
            <li>
              <strong>Ethernet/IP:</strong> IT network integration — Web interface, API
            </li>
            <li>
              <strong>DMX512:</strong> Theatrical/entertainment — Bridge for effects lighting
            </li>
          </ul>
          <p>
            <strong>Multi-Bus Architecture Design</strong>
          </p>
          <p>
            <strong>When to use multiple buses:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Multi-bus controller selection:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Integration tip:</strong> Early coordination with BMS consultant is essential -
            agree gateway requirements, point schedules, and network architecture during design
            stage.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Wiring, DALI-2, and Commissioning">
          ...
          <p>
            <strong>DALI Wiring Requirements</strong>
          </p>
          <p>
            <strong>Cable Specifications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>DALI-2 Enhancements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Control gear:</strong> Standardised — Enhanced, DT8 colour
            </li>
            <li>
              <strong>Input devices:</strong> Not standardised — Fully standardised (Part 301-304)
            </li>
            <li>
              <strong>Push buttons:</strong> Proprietary — Standardised instance types
            </li>
            <li>
              <strong>Sensors:</strong> Basic support — Full presence/light sensor support
            </li>
            <li>
              <strong>Interoperability:</strong> Control gear only — Full system interoperability
            </li>
            <li>
              <strong>Certification:</strong> Self-declaration — Third-party certification (DiiA)
            </li>
          </ul>
          <p>
            <strong>Commissioning Procedure</strong>
          </p>
          <p>
            <strong>Step 1 - Physical verification:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Step 2 - Device discovery:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Step 3 - Addressing:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Step 4 - Groups and scenes:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Step 5 - Testing and handover:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Addresses per bus: <strong>64</strong> (0-63)
            </li>
            <li>
              Groups per bus: <strong>16</strong> (0-15)
            </li>
            <li>
              Scenes per device: <strong>16</strong> (0-15)
            </li>
            <li>
              Bus voltage: <strong>16V DC</strong> (9.5V-22.5V)
            </li>
            <li>
              Maximum current: <strong>250mA</strong>
            </li>
            <li>
              Maximum length: <strong>300m</strong>
            </li>
            <li>
              Data rate: <strong>1,200 bps</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Exceeding 64 addresses</strong> - check device count before specifying
                single bus
              </li>
              <li>
                <strong>Forgetting bus PSU</strong> - every bus needs dedicated power supply
              </li>
              <li>
                <strong>Creating loops</strong> - DALI is not a ring topology, no closed loops
              </li>
              <li>
                <strong>Mixing DALI-1 and DALI-2</strong> - older devices may not respond to DALI-2
                commands
              </li>
            </ul>
          }
