      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>DALI:</strong> IEC 62386 digital lighting control protocol
              </li>
              <li className="pl-1">
                <strong>Addressing:</strong> 64 individual addresses per bus
              </li>
              <li className="pl-1">
                <strong>Groups:</strong> 16 groups for zone control
              </li>
              <li className="pl-1">
                <strong>Scenes:</strong> 16 preset lighting configurations
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Bus voltage:</strong> 16V DC (9.5V-22.5V range)
              </li>
              <li className="pl-1">
                <strong>Max length:</strong> 300 metres per bus
              </li>
              <li className="pl-1">
                <strong>Data rate:</strong> 1,200 bits/second
              </li>
              <li className="pl-1">
                <strong>Integration:</strong> BMS via gateways (BACnet, KNX)
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              DALI (Digital Addressable Lighting Interface) is the international standard protocol
              for digital lighting control, defined by IEC 62386. It provides a robust, two-wire
              digital interface enabling individual addressable control of luminaires with features
              including dimming, switching, status monitoring, and scene control.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                DALI vs Analogue Dimming (1-10V)
              </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Design principle:</strong> DALI provides granular control at the luminaire
              level whilst maintaining simple two-wire installation comparable to traditional
              switching.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Scene 5: meeting room presentation
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical Group Assignment Example
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>DALI PSU:</strong> Provides 16V DC bus power - one per bus (unless
                  integrated in controller)
                </li>
                <li className="pl-1">
                  <strong>Control gear:</strong> DALI drivers in luminaires - receive commands, dim
                  LEDs
                </li>
                <li className="pl-1">
                  <strong>Input devices:</strong> Sensors, switches, push buttons (DALI-2) -
                  generate commands
                </li>
                <li className="pl-1">
                  <strong>Application controller:</strong> Manages one or more buses, stores logic
                  and schedules
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              DALI installation requires attention to wiring topology, cable selection, and
              systematic commissioning. DALI-2 extends the standard with new device types and
              enhanced features that improve interoperability and functionality.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                DALI Wiring Requirements
              </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Fully standardised (Part 301-304)
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Full presence/light sensor support
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Third-party certification (DiiA)
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: DALI Bus Current Calculation
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Multi-Bus System Design
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Scene Programming for Meeting Room
              </h3>
              <p className="text-sm text-white mb-2">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Install bus PSU at optimal location for voltage distribution
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Mixing DALI-1 and DALI-2</strong> - older devices may not respond to
                  DALI-2 commands
                </li>
              </ul>
            </div>
