...
const quickCheckQuestions = [
  {
    ...
    options: ['Asbestos only', 'Hydrocarbons and heavy metals', 'Lead paint', 'Silica dust'],
    correctIndex: 1,
    explanation:
      'Former petrol stations are brownfield sites likely to contain hydrocarbon contamination from fuel storage and heavy metals from vehicle servicing activities.',
  },
  {
    id: 'check-2',
    question: 'What IP rating indicates an enclosure is protected against powerful water jets?',
    options: ['IP44', 'IP65', 'IP68', 'IP20'],
    correctIndex: 1,
    explanation:
      'IP65 indicates protection against dust ingress (6) and powerful water jets (5). This rating is suitable for outdoor electrical installations exposed to rain and pressure washing.',
  },
  {
    id: 'check-3',
    question:
      'At what sustained wind speed should work on mobile elevating work platforms (MEWPs) typically cease?',
    options: ['10 mph', '17 mph (force 4)', '30 mph', '40 mph'],
    correctIndex: 1,
    explanation:
      'Most MEWP manufacturers specify wind speed limits around 17 mph (force 4 on the Beaufort scale). This is because wind loading can destabilise platforms and endanger workers at height.',
  },
  {
    id: 'check-4',
    question:
      'Which disease caused by contaminated water is a particular risk when working near waterways?',
    options: ['Tetanus', 'Legionella', "Leptospirosis (Weil's disease)", 'Hepatitis A'],
    correctIndex: 2,
    explanation:
      "Leptospirosis (Weil's disease) is contracted through contact with water contaminated by rat urine. Workers near canals, rivers, or in drainage systems are at particular risk.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Brownfield sites are previously developed land that may have contamination from former industrial, commercial, or military use. They require investigation before construction work begins.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Soil sampling and contamination assessment identifies hazards like heavy metals, hydrocarbons, asbestos, and chemical contamination that could affect worker health and safety.',
  },
  {
    id: 3,
    question:
      'When trenching in contaminated ground, what additional PPE might be required beyond standard site wear?',
    options: [
      'Safety glasses only',
    ...
    correctAnswer: 1,
    explanation:
      'Working in contaminated ground requires chemical-resistant PPE including appropriate suits, gloves, and respiratory protection to prevent skin contact and inhalation of hazardous substances.',
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      'The IP (Ingress Protection) rating has two digits: the first indicates solid particle protection (0-6), and the second indicates water protection (0-9K). For example, IP65 offers complete dust protection (6) and water jet protection (5).',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'BS 7671 typically requires IP44 as a minimum for outdoor socket outlets (protected against solid objects &gt;1mm and water splashing from all directions). Higher ratings may be needed in more exposed locations.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'The combination of water and electricity is extremely dangerous. The first priority is always to isolate electrical supplies to prevent electrocution, then evacuate personnel from affected areas safely.',
  },
  {
    id: 7,
    question:
      'What wind force on the Beaufort scale is typically the maximum for safe scaffold work?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Force 6 (strong breeze, 25-31 mph) is typically the maximum for scaffold work. Above this, loose materials become dangerous, climbing is hazardous, and workers may struggle to maintain balance.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Heat stress symptoms include heavy sweating, dizziness, nausea, headache, confusion, and rapid heartbeat. These indicate the body cannot regulate temperature properly and immediate action is needed.',
  },
  {
    id: 9,
    question:
      'When working in freezing conditions, what additional electrical hazard should you be aware of?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'In freezing conditions, cable insulation (particularly PVC) can become brittle and crack if flexed or impacted. This can expose live conductors and create shock or fire risks.',
  },
  {
    id: 10,
    question:
      'What precaution should be taken when storing electrical equipment in damp conditions?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Electrical equipment should be stored in dry, ventilated areas. Desiccants (silica gel) help absorb moisture. Sealed containers can trap condensation, while adequate ventilation prevents moisture build-up.',
  },
  {
    id: 11,
    question:
      'What biological hazard might be present when working in old farm buildings being converted?',
    options: [
      'Carbon monoxide',
      'Radon gas',
    ...
    correctAnswer: 2,
    explanation:
      'Histoplasmosis is a fungal infection caused by disturbing dried bird or bat droppings common in old agricultural buildings. Appropriate respiratory protection is essential when working in such environments.',
  },
  {
    id: 12,
    question:
      'Under the CDM Regulations 2015, who has primary responsibility for identifying environmental hazards on a construction site?',
    options: ['The electrician', 'The principal contractor', 'The client', 'The local council'],
    correctAnswer: 1,
    explanation:
      'Under CDM 2015, the principal contractor has primary responsibility for managing construction phase risks, including identifying and controlling environmental hazards. They must assess site conditions and implement appropriate controls.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Check the site investigation report provided before work starts. This should detail any contamination found through soil sampling. If no report exists, ask your supervisor. Former industrial sites (factories, petrol stations, gasworks), military land, and areas near landfill are high-risk. Never dig without knowing ground conditions.',
  },
  {
    question: 'Can I use my normal power tools in wet conditions?',
    answer:
      'Standard 230V tools should never be used in wet conditions. Use 110V CTE (Centre Tapped Earth) systems with splash-proof transformers, or battery-powered tools in wet environments. Ensure all equipment has appropriate IP ratings for the conditions. Check for damage to cables and connections before use.',
  },
  {
    question: 'What should I do if I discover unexpected contamination while working?',
    answer:
      'Stop work immediately and leave the area. Do not disturb the contamination further. Report to your supervisor at once. Do not eat, drink, or smoke until you have washed thoroughly. You may need decontamination procedures. The site must be reassessed before work continues.',
  },
  {
    question: 'How do extreme weather conditions affect my work as an electrician?',
    answer:
      'Hot weather can cause cable expansion and heat-related illness. Cold weather makes insulation brittle and affects battery performance. Rain creates electrical hazards and slip risks. High winds prevent working at height and can blow debris. Lightning requires work cessation. Always check weather forecasts and plan accordingly.',
  },
  {
    question: "What is Weil's disease and how do I protect myself?",
    answer:
      "Weil's disease (leptospirosis) is a bacterial infection spread through rat urine, often found in contaminated water. It causes flu-like symptoms and can lead to serious illness. Protect yourself by covering cuts before work, wearing waterproof gloves near water, not touching your face, and washing thoroughly after work. Report any illness promptly.",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-8 text-gray-200">
        ...
        <header className="mb-8">
          ...
          <p className="text-lg text-gray-300">
            Understanding how environmental factors create workplace risks and the controls needed
        ...
        <div className="bg-[#222] border-l-4 border-elec-yellow rounded p-5 mb-8">
          ...
          <ul className="list-disc list-inside space-y-1 text-gray-300">
            <li>
              Environmental hazards include contaminated ground, water ingress, weather, and
              biological risks
            </li>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              <strong className="text-white">Brownfield sites</strong> are previously developed land
              that may contain contamination from former industrial, commercial, or military use.
              Understanding ground conditions is essential before excavation or cable installation
              work.
            </p>
            ...
            <p>
              <strong className="text-white">Why this matters for electricians:</strong> When laying
              underground cables, you may excavate contaminated soil. Skin contact with contaminated
              material can cause chemical burns, dermatitis, or long-term health effects. Inhaling
            ...
            <div className="bg-yellow-900/30 border border-yellow-600/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                Under CDM Regulations 2015, clients must provide site investigation information to
                designers and contractors. This includes desk studies of historical land use and
                intrusive soil sampling where contamination is suspected. Never start excavation
                without this information.
              </p>
            </div>

            <h4 className="font-semibold text-white mt-6 mb-2">
              Control Measures for Contaminated Ground:
            </h4>
            <ul className="list-disc list-inside space-y-2">
              <li>Review site investigation reports before work begins</li>
              <li>
                Wear appropriate PPE: chemical-resistant gloves, coveralls, respiratory protection
              </li>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              Water and electricity are a dangerous combination. Understanding IP ratings and water
              hazards is essential for selecting appropriate equipment and working safely in damp or
              wet conditions.
            </p>
            ...
            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              ...
              <p className="text-sm mb-3">
                IP ratings have two digits: First digit = solid particle protection (0-6), Second
                digit = water protection (0-9K)
              </p>
            ...
            <p>
              <strong className="text-white">Why this matters:</strong> Selecting the wrong IP
              rating can lead to equipment failure, earth faults, or electric shock. Water tracking
              into enclosures can cause flashover, fire, or corrosion leading to delayed failures.
            </p>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                <strong>First priority:</strong> Isolate electrical supplies to flooded areas
                immediately
              </li>
              ...
              <li>
                Do not re-energise equipment that has been flooded without proper inspection and
                testing
              </li>
            ...
            <div className="bg-red-900/30 border border-red-500/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                Floodwater may appear clear but conduct electricity readily due to dissolved salts
                and contaminants. A fatal shock can occur even with apparently clean rainwater if it
                creates a path to earth through your body.
              </p>
            </div>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                Use 110V CTE (Centre Tapped Earth) supply systems with splash-proof transformers
              </li>
              <li>
                Ensure all 110V equipment and leads are in good condition with no damaged insulation
              </li>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              UK weather can change rapidly. Electricians working outdoors or on construction sites
              must understand how different weather conditions affect both personal safety and the
              electrical work itself.
            </p>

            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              <h4 className="font-semibold text-white mb-3">
                Wind Speed Limits for Work Activities:
              </h4>
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-600">
            ...
            <p>
              Hot weather, particularly when combined with physical work, can cause heat stress.
              Working in plant rooms, roof spaces, or wearing heavy PPE increases risk
              significantly.
            </p>
            <ul className="list-disc list-inside space-y-2 mt-2">
              <li>
                <strong>Heat exhaustion symptoms:</strong> Heavy sweating, weakness, dizziness,
                nausea, headache
              </li>
              <li>
                <strong>Heat stroke symptoms (emergency):</strong> Hot dry skin, confusion,
                collapse, no sweating
              </li>
              <li>
                <strong>Controls:</strong> Regular breaks in shade, adequate hydration (water, not
                caffeine), schedule heavy work for cooler times, acclimatise gradually
              </li>
            </ul>

            <h4 className="font-semibold text-white mt-6 mb-2">Cold Weather Hazards:</h4>
            <p>
              Cold conditions affect both workers and equipment. PVC cable insulation becomes
              brittle below freezing and can crack if flexed or impacted.
            </p>
            <ul className="list-disc list-inside space-y-2 mt-2">
              <li>
                <strong>Hypothermia risk:</strong> Shivering, confusion, drowsiness - get medical
                help
              </li>
              <li>
                <strong>Frostbite:</strong> Numbness in extremities, white/waxy skin
              </li>
              <li>
                <strong>Cable handling:</strong> Warm cables before bending, avoid impacts, check
                for cracks
              </li>
              <li>
                <strong>Battery tools:</strong> Reduced capacity in cold - carry spare batteries
              </li>
              <li>
                <strong>Slip hazards:</strong> Ice on scaffolds, access routes, materials
              </li>
            </ul>
            ...
            <div className="bg-blue-900/30 border border-blue-500/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                If lightning is visible or thunder audible, cease all outdoor work immediately. Do
                not shelter under isolated trees or near tall metal structures. Move to a
                substantial building or vehicle. Wait 30 minutes after the last lightning/thunder
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              Biological hazards on construction sites include bacteria, viruses, fungi, and
              parasites that can cause illness. Electricians face particular risks when working in
              certain environments.
            </p>

            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              <h4 className="font-semibold text-white mb-3">
                Key Biological Hazards for Electricians:
              </h4>
              <div className="space-y-4">
                <div>
                  <p className="font-medium text-elec-yellow">Leptospirosis (Weil's Disease)</p>
                  <p className="text-sm mt-1">
                    Bacterial infection from rat urine, transmitted through contaminated water or
                    soil. High risk near waterways, drainage systems, and farms. Causes flu-like
                    symptoms progressing to jaundice, kidney failure.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">Histoplasmosis</p>
                  <p className="text-sm mt-1">
                    Fungal infection from disturbing dried bird or bat droppings. Risk in old
                    buildings, agricultural conversions, roof spaces. Causes respiratory illness.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">Tetanus</p>
                  <p className="text-sm mt-1">
                    Bacterial infection entering through wounds contaminated with soil or rust.
                    Ensure tetanus vaccination is up to date. Causes muscle spasms and can be fatal.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">Legionella</p>
                  <p className="text-sm mt-1">
                    Bacteria in water systems, especially where water has stagnated. Risk when
                    working on systems that have been out of use. Causes severe pneumonia.
                  </p>
                </div>
              </div>
            </div>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                Report any illness, particularly flu-like symptoms after exposure to risk areas
              </li>
            ...
            <div className="bg-yellow-900/30 border border-yellow-600/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                You are rewiring a farmhouse that has been empty for years. The roof space contains
                evidence of nesting birds and bat activity. Before entering, you should: wet down
                droppings with disinfectant spray to reduce dust, wear FFP3 respiratory protection
                and disposable coveralls, ensure good ventilation, and bag contaminated material for
                safe disposal.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#282828] border border-gray-700 rounded-lg p-5">
            ...
            <div className="space-y-3 text-gray-300">
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Before starting work:</strong> Check site investigation reports, weather
                  forecasts, and any biological hazard information
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-elec-yellow font-bold">2.</span>
                <span>
                  <strong>Equipment selection:</strong> Choose appropriate IP ratings for the
              ...
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>PPE assessment:</strong> Consider all environmental factors when selecting
              ...
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>During work:</strong> Monitor changing conditions - weather, ground
              ...
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Hygiene:</strong> Maintain good hygiene practices throughout the working
                  day
                </span>
              </div>
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Reporting:</strong> Report any unexpected hazards, symptoms, or concerns
                  immediately
                </span>
              </div>
            </div>
        ...
        {/* Quiz */}
        <section className="mb-10">
          <Quiz title="Section 4.6 Knowledge Check" questions={quizQuestions} />
        </section>
