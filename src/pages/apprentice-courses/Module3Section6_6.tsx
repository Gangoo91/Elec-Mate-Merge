      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <header className="mb-6 sm:mb-8 text-center">
          ...
          <p className="text-white">
            Critical compliance requirements for following manufacturer instructions and site
            specifications alongside BS 7671 for safe, warranty-compliant electrical installations.
          </p>
        </header>
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  Manufacturer instructions are mandatory under BS 7671 and contractual obligations.
                </li>
                <li>
                  Ignoring instructions voids warranties and creates safety and legal liabilities.
                </li>
                <li>
                  Site specifications add project-specific requirements beyond regulatory minimums.
                </li>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Missing manuals, ignored torque specs, non-compliant
                  mounting, warranty voids.
                </li>
                <li>
                  <strong>Use:</strong> Latest manuals, specified tools, approved sequences,
                  documented approvals.
                </li>
                <li>
                  <strong>Check:</strong> Instruction compliance, site spec alignment, warranty
                  validity, deviation records.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
            <li>
              Understand the legal and contractual importance of following manufacturer installation
              instructions.
            </li>
            ...
            <li>
              Apply integrated compliance approach using standards, instructions and site
              specifications.
            </li>
            <li>
              Recognise and mitigate consequences of non-compliance with instructions and
              specifications.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="mb-6">
            <h3 className="font-medium text-white mb-3 flex items-center gap-2">
              <Shield className="w-5 h-5" /> 1. Legal and Safety Imperatives for Following
              Instructions
            </h3>
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                ...
                <p className="text-xs sm:text-sm text-white mb-3">
                  <strong>Legal Foundation:</strong> Manufacturer instructions form part of the
                  legal framework for electrical safety. BS 7671 explicitly requires adherence to
                  manufacturer's instructions, making them legally binding rather than advisory.
                  Failure to comply creates criminal and civil liability under multiple statutory
                  instruments.
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Health and Safety at Work Act 1974:</strong> Duty of care
                        obligations
                      </li>
                      <li>
                        • <strong>Electricity at Work Regulations 1989:</strong> Systems to prevent
                        danger
                      </li>
                      <li>
                        • <strong>BS 7671 Regulation 134.1.1:</strong> Equipment selection per
                        manufacturer specs
                      </li>
                      <li>
                        • <strong>Construction (Design and Management) Regulations:</strong>{' '}
                        Competent installation
                      </li>
                      <li>
                        • <strong>Consumer Rights Act 2015:</strong> Goods to be as described and
                        fit for purpose
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Criminal prosecution:</strong> HSE enforcement for unsafe systems
                      </li>
                      <li>
                        • <strong>Civil liability:</strong> Damages for injury/property loss
                      </li>
                      <li>
                        • <strong>Professional sanctions:</strong> Loss of competent person status
                      </li>
                      <li>
                        • <strong>Insurance voidance:</strong> Non-compliant installation exclusions
                      </li>
                      <li>
                        • <strong>Contract breach:</strong> Failure to meet specification
                        requirements
                      </li>
                    </ul>
                  </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">
                          Heat rise testing under defined conditions
                        </td>
                        <td className="border border-white/10 p-3">
                          Ventilation, derating, ambient limits
                        </td>
                        <td className="border border-white/10 p-3">
                          Overheating, fire risk, component failure
                        </td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">Mechanical strength</td>
                        <td className="border border-white/10 p-3">
                          Load testing, vibration, shock
                        </td>
                        <td className="border border-white/10 p-3">
                          Support requirements, fixing methods
                        </td>
                        <td className="border border-white/10 p-3">
                          Structural failure, conductor damage
                        </td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3">Environmental sealing</td>
                        <td className="border border-white/10 p-3">
                          IP testing, chemical resistance
                        </td>
                        <td className="border border-white/10 p-3">
                          Gasket compression, entry protection
                        </td>
                        <td className="border border-white/10 p-3">
                          Ingress, corrosion, insulation failure
                        </td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">Electrical performance</td>
                        <td className="border border-white/10 p-3">
                          Dielectric testing, current capacity
                        </td>
                        <td className="border border-white/10 p-3">
                          Torque values, conductor termination
                        </td>
                        <td className="border border-white/10 p-3">
                          Arcing, tracking, overcurrent damage
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="p-4 bg-transparent border border-cyan-400/30 rounded-lg">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Installation outside parameters:</strong> Environmental limits
                        exceeded
                      </li>
                      <li>
                        • <strong>Incorrect tool usage:</strong> Non-specified torque or connections
                      </li>
                      <li>
                        • <strong>Mounting deviations:</strong> Orientation or support modifications
                      </li>
                      <li>
                        • <strong>Modified products:</strong> Unauthorised alterations or
                        adaptations
                      </li>
                      <li>
                        • <strong>Incompatible integration:</strong> Use with non-approved
                        accessories
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Policy exclusions:</strong> Non-compliant installation coverage
                        gaps
                      </li>
                      <li>
                        • <strong>Premium increases:</strong> Risk assessment impact of poor
                        practices
                      </li>
                      <li>
                        • <strong>Claim rejection:</strong> Failure to follow instructions as
                        contributory factor
                      </li>
                      <li>
                        • <strong>Professional indemnity:</strong> Competence demonstration
                        requirements
                      </li>
                      <li>
                        • <strong>Product liability:</strong> Shared responsibility with
                        manufacturers
                      </li>
                    </ul>
                  </div>
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-elec-yellow mb-3">
                  Information Hierarchy and Sources
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Installation manuals:</strong> Step-by-step procedures and
                        requirements
                      </li>
                      <li>
                        • <strong>Technical data sheets:</strong> Performance parameters and
                        limitations
                      </li>
                      <li>
                        • <strong>Wiring diagrams:</strong> Connection requirements and termination
                        details
                      </li>
                      <li>
                        • <strong>Dimensional drawings:</strong> Mounting requirements and
                        clearances
                      </li>
                      <li>
                        • <strong>Certification documents:</strong> Test reports and compliance
                        declarations
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Application notes:</strong> Specific use case guidance
                      </li>
                      <li>
                        • <strong>Compatibility matrices:</strong> Approved combinations and
                        accessories
                      </li>
                      <li>
                        • <strong>Troubleshooting guides:</strong> Fault diagnosis and resolution
                      </li>
                      <li>
                        • <strong>Software/firmware:</strong> Programming and configuration
                        requirements
                      </li>
                      <li>
                        • <strong>Training materials:</strong> Installation and commissioning
                        procedures
                      </li>
                    </ul>
                  </div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    ...
                    <tbody>
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>Cable termination</strong>
                        </td>
                        <td className="border border-white/10 p-3">
                          Torque values, conductor size range, preparation length
                        </td>
                        <td className="border border-white/10 p-3">
                          ±10% torque, exact AWG/mm² range
                        </td>
                        <td className="border border-white/10 p-3">
                      ...
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                          <strong>Environmental limits</strong>
                        </td>
                        <td className="border border-white/10 p-3">
                          Operating temperature, humidity, altitude
                        </td>
                        <td className="border border-white/10 p-3">
                          Absolute limits, no tolerance
                        </td>
                        <td className="border border-white/10 p-3">
                      ...
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">
                          Vertical/horizontal restrictions, cooling requirements
                        </td>
                        <td className="border border-white/10 p-3">
                          ±5° typically, specific ventilation clearances
                        </td>
                        <td className="border border-white/10 p-3">
                          Spirit level, clearance measurement
                        </td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                        ...
                        <td className="border border-white/10 p-3">
                          Compatible accessories, communication protocols
                        </td>
                        <td className="border border-white/10 p-3">
                          Approved lists only, version compatibility
                        </td>
                        <td className="border border-white/10 p-3">
                          Compatibility matrix check, testing
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg">
                <h5 className="font-medium text-elec-yellow mb-3">
                  Information Access and Version Control
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Manufacturer websites:</strong> Latest versions, downloadable PDFs
                      </li>
                      <li>
                        • <strong>Technical support:</strong> Direct clarification and application
                        guidance
                      </li>
                      <li>
                        • <strong>Training centres:</strong> Hands-on instruction and certification
                      </li>
                      <li>
                        • <strong>Mobile apps:</strong> On-site access to instructions and
                        calculators
                      </li>
                      <li>
                        • <strong>Distributor resources:</strong> Local support and technical
                        assistance
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Regular updates:</strong> Check for latest versions before each
                        project
                      </li>
                      <li>
                        • <strong>Revision tracking:</strong> Maintain records of document versions
                        used
                      </li>
                      <li>
                        • <strong>Change notifications:</strong> Subscribe to manufacturer update
                        services
                      </li>
                      <li>
                        • <strong>Archive management:</strong> Keep installation-specific versions
                        on file
                      </li>
                      <li>
                        • <strong>Team distribution:</strong> Ensure all team members have current
                        versions
                      </li>
                    </ul>
                  </div>
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-amber-400/30 rounded-lg mb-4">
                <h5 className="font-medium text-amber-400 mb-3">
                  Site Specification Hierarchy and Sources
                </h5>
                <p className="text-xs sm:text-sm text-white mb-3">
                  <strong>Specification Framework:</strong> Site specifications represent the
                  project's specific requirements that often exceed regulatory minimums. They form
                  contractual obligations and must be clearly understood and implemented alongside
                  manufacturer instructions and BS 7671 requirements.
                </p>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    <thead>
                    ...
                    <tbody>
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>Architectural specifications</strong>
                        </td>
                        <td className="border border-white/10 p-3">
                          Aesthetic requirements, finishes, integration
                        </td>
                      ...
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                          <strong>Electrical design specs</strong>
                        </td>
                        <td className="border border-white/10 p-3">
                          Cable types, containment, protection methods
                        </td>
                        <td className="border border-white/10 p-3">Design engineer directive</td>
                        <td className="border border-white/10 p-3">
                          Technically and contractually binding
                        </td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3">
                        ...
                        <td className="border border-white/10 p-3">
                          Preferred brands, maintenance access, documentation
                        </td>
                      ...
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                          <strong>Main contractor specs</strong>
                        </td>
                        <td className="border border-white/10 p-3">
                          Work sequences, coordination, quality standards
                        </td>
                        <td className="border border-white/10 p-3">Project management directive</td>
                        <td className="border border-white/10 p-3">
                          Contractual and programme binding
                        </td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>Health & safety specs</strong>
                        </td>
                        <td className="border border-white/10 p-3">
                          Site-specific safety measures, access restrictions
                        </td>
                        <td className="border border-white/10 p-3">Safety management directive</td>
                        <td className="border border-white/10 p-3">
                          Legally and contractually binding
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-elec-yellow mb-3">
                  Common Site Specification Requirements
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Approved manufacturer lists:</strong> Specific brands/models only
                      </li>
                      <li>
                        • <strong>Cable specifications:</strong> Fire performance, low smoke
                        variants
                      </li>
                      <li>
                        • <strong>Containment systems:</strong> Material type, finish, fixing
                        methods
                      </li>
                      <li>
                        • <strong>Protection devices:</strong> Specific characteristics and settings
                      </li>
                      <li>
                        • <strong>Earthing systems:</strong> Enhanced requirements beyond BS 7671
                      </li>
                    </ul>
                  </div>
                  <div>
                    <h6 className="font-medium text-white mb-2">
                      Installation and Quality Requirements
                    </h6>
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Installation routes:</strong> Specific paths and containment
                        locations
                      </li>
                      <li>
                        • <strong>Labelling standards:</strong> Format, content, durability
                        requirements
                      </li>
                      <li>
                        • <strong>Testing protocols:</strong> Enhanced testing beyond minimum
                        requirements
                      </li>
                      <li>
                        • <strong>Documentation standards:</strong> Specific formats and submission
                        requirements
                      </li>
                      <li>
                        • <strong>Access requirements:</strong> Maintenance access and operating
                        clearances
                      </li>
                    </ul>
                  </div>
              ...
              <div className="p-4 bg-transparent border border-green-400/30 rounded-lg">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Safety first:</strong> No specification can compromise safety
                        requirements
                      </li>
                      <li>
                        • <strong>Regulatory compliance:</strong> BS 7671 minimum standards must be
                        met
                      </li>
                      <li>
                        • <strong>Manufacturer limits:</strong> Cannot exceed equipment design
                        parameters
                      </li>
                      <li>
                        • <strong>Most stringent rule:</strong> Apply highest standard when
                        conflicts arise
                      </li>
                      <li>
                        • <strong>Written clarification:</strong> Document all resolution decisions
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Early identification:</strong> Flag conflicts during design review
                      </li>
                      <li>
                        • <strong>Technical discussions:</strong> Engineer/manufacturer/client
                        meetings
                      </li>
                      <li>
                        • <strong>Alternative proposals:</strong> Present compliant solutions
                      </li>
                      <li>
                        • <strong>Formal approvals:</strong> Obtain written sign-off for changes
                      </li>
                      <li>
                        • <strong>Change control:</strong> Document specification modifications
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="mb-2">
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-elec-yellow mb-3">
                  Four-Step Compliance Framework
                </h5>
                <div className="space-y-4">
                  <div className="p-3 border border-white/10 rounded-lg">
                    <h6 className="font-medium text-white mb-2">
                      Step 1: Regulatory Foundation Review
                    </h6>
                    <ul className="space-y-1 text-sm">
                      ...
                      <li>
                        • Verify special location requirements (e.g., bathrooms, medical locations)
                      </li>
                  ...
                  <div className="p-3 border border-white/10 rounded-lg bg-muted/5">
                    <h6 className="font-medium text-white mb-2">
                      Step 2: Manufacturer Instruction Integration
                    </h6>
                    <ul className="space-y-1 text-sm">
                      <li>• Obtain latest version of all relevant manufacturer documentation</li>
                      <li>
                        • Cross-reference regulatory requirements with manufacturer specifications
                      </li>
                  ...
                  <div className="p-3 border border-white/10 rounded-lg">
                    <h6 className="font-medium text-white mb-2">
                      Step 3: Site Specification Application
                    </h6>
                    <ul className="space-y-1 text-sm">
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Pre-installation review:</strong> Comprehensive documentation
                        analysis
                      </li>
                      <li>
                        • <strong>Tool calibration:</strong> Ensure measurement accuracy for
                        critical parameters
                      </li>
                      <li>
                        • <strong>Stage inspections:</strong> Progressive compliance verification
                      </li>
                      <li>
                        • <strong>Photographic records:</strong> Document installation methodology
                      </li>
                      <li>
                        • <strong>Training verification:</strong> Confirm competence for specific
                        equipment
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Installation checklists:</strong> Systematic verification of
                        requirements
                      </li>
                      <li>
                        • <strong>Independent review:</strong> Third-party compliance verification
                      </li>
                      <li>
                        • <strong>Test protocols:</strong> Comprehensive commissioning procedures
                      </li>
                      <li>
                        • <strong>Documentation packages:</strong> Complete compliance records
                      </li>
                      <li>
                        • <strong>Handover procedures:</strong> Client education and warranty
                        protection
                      </li>
                    </ul>
                  </div>
          ...
          <div className="mt-6 p-4 bg-transparent border-l-2 border-elec-yellow rounded-lg border border-white/10">
            ...
            <p className="text-xs sm:text-sm text-white">
              A contractor installed a high-integrity consumer unit without following the
              manufacturer's specific torque settings for busbar terminals. Six months later, loose
              connections caused overheating, arcing, and eventual failure of the main switch. The
              manufacturer rejected the warranty claim because installation records showed
              non-compliance with their specified 25Nm torque requirement. The contractor faced
              £15,000 in replacement costs, project delays, and potential legal action from the
              client.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Can site specifications override BS 7671 requirements?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: No — site specifications can exceed BS 7671 requirements but cannot permit
                anything that would be unsafe or non-compliant with regulatory minimums.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: What should I do if manufacturer instructions conflict with BS 7671?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: Follow BS 7671 as the minimum legal requirement and seek immediate clarification
                from both the manufacturer and the design engineer. Document all communications and
                obtain written approval for any variations.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Do all products need to be installed exactly as per the manual?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: Yes — unless you have written confirmation from the manufacturer approving an
                alternative method that maintains safety and performance standards.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Who is liable if I follow site specs that later prove inadequate?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: Liability is shared — you have a duty to highlight safety concerns even when
                following specifications. Always document concerns and seek written clarification
                from specifiers.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 bg-transparent border-l-2 border-elec-yellow rounded-lg border border-white/10">
            <p className="text-white">
              ...
              approach integrating regulatory requirements, manufacturer instructions, and site
              specifications ensures compliant, safe, and high-quality electrical installations
