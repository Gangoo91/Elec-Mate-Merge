      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            ...
            <div className="mb-6">
              <h4 className="font-medium text-foreground mb-3">Regulatory and Legal Framework</h4>
              <div className="p-4 bg-card border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-emerald-400 mb-3">Statutory Requirements and Liability</h5>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h6 className="font-medium text-foreground mb-2">Statutory Obligations</h6>
                  ...
                  <div>
                    <h6 className="font-medium text-foreground mb-2">Legal Consequences</h6>
                    <ul className="space-y-1 text-sm">
                  ...
                  <table className="w-full border-collapse border border-border/20 text-sm">
                    <thead>
                      <tr className="bg-card">
                        <th className="border border-border/20 p-3 text-left">Safety Parameter</th>
                        <th className="border border-border/20 p-3 text-left">Manufacturer Testing</th>
                        <th className="border border-border/20 p-3 text-left">Installation Impact</th>
                        <th className="border border-border/20 p-3 text-left">Failure Consequence</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="border border-border/20 p-3">Thermal performance</td>
                        <td className="border border-border/20 p-3">Heat rise testing under defined conditions</td>
                        <td className="border border-border/20 p-3">Ventilation, derating, ambient limits</td>
                        <td className="border border-border/20 p-3">Overheating, fire risk, component failure</td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-border/20 p-3">Mechanical strength</td>
                        <td className="border border-border/20 p-3">Load testing, vibration, shock</td>
                        <td className="border border-border/20 p-3">Support requirements, fixing methods</td>
                        <td className="border border-border/20 p-3">Structural failure, conductor damage</td>
                      </tr>
                      <tr>
                        <td className="border border-border/20 p-3">Environmental sealing</td>
                        <td className="border border-border/20 p-3">IP testing, chemical resistance</td>
                        <td className="border border-border/20 p-3">Gasket compression, entry protection</td>
                        <td className="border border-border/20 p-3">Ingress, corrosion, insulation failure</td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-border/20 p-3">Electrical performance</td>
                        <td className="border border-border/20 p-3">Dielectric testing, current capacity</td>
                        <td className="border border-border/20 p-3">Torque values, conductor termination</td>
                        <td className="border border-border/20 p-3">Arcing, tracking, overcurrent damage</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="p-4 bg-card border border-cyan-400/30 rounded-lg">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h6 className="font-medium text-foreground mb-2">Warranty Voidance Triggers</h6>
                    <ul className="space-y-1 text-sm">
                  ...
                  <div>
                    <h6 className="font-medium text-foreground mb-2">Insurance Risk Factors</h6>
                    <ul className="space-y-1 text-sm">
          ...
          <section className="mb-6">
            ...
            <div className="mb-6">
              <h4 className="font-medium text-foreground mb-3">Comprehensive Documentation Ecosystem</h4>
              <div className="p-4 bg-card border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-emerald-400 mb-3">Information Hierarchy and Sources</h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h6 className="font-medium text-foreground mb-2">Primary Documentation</h6>
                    <ul className="space-y-1 text-sm">
                  ...
                  <div>
                    <h6 className="font-medium text-foreground mb-2">Supporting Information</h6>
                    <ul className="space-y-1 text-sm">
              ...
              <div className="p-4 bg-card border border-green-400/30 rounded-lg mb-4">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-border/20 text-sm">
                    <thead>
                      <tr className="bg-card">
                        <th className="border border-border/20 p-3 text-left">Parameter Category</th>
                        <th className="border border-border/20 p-3 text-left">Typical Specifications</th>
                        <th className="border border-border/20 p-3 text-left">Tolerance Limits</th>
                        <th className="border border-border/20 p-3 text-left">Verification Method</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="border border-border/20 p-3"><strong>Cable termination</strong></td>
                        <td className="border border-border/20 p-3">Torque values, conductor size range, preparation length</td>
                        <td className="border border-border/20 p-3">±10% torque, exact AWG/mm² range</td>
                        <td className="border border-border/20 p-3">Calibrated torque wrench, measurement</td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-border/20 p-3"><strong>Environmental limits</strong></td>
                        <td className="border border-border/20 p-3">Operating temperature, humidity, altitude</td>
                        <td className="border border-border/20 p-3">Absolute limits, no tolerance</td>
                        <td className="border border-border/20 p-3">Environmental monitoring, site survey</td>
                      </tr>
                      <tr>
                        <td className="border border-border/20 p-3"><strong>Mounting orientation</strong></td>
                        <td className="border border-border/20 p-3">Vertical/horizontal restrictions, cooling requirements</td>
                        <td className="border border-border/20 p-3">±5° typically, specific ventilation clearances</td>
                        <td className="border border-border/20 p-3">Spirit level, clearance measurement</td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-border/20 p-3"><strong>Integration requirements</strong></td>
                        <td className="border border-border/20 p-3">Compatible accessories, communication protocols</td>
                        <td className="border border-border/20 p-3">Approved lists only, version compatibility</td>
                        <td className="border border-border/20 p-3">Compatibility matrix check, testing</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="p-4 bg-card border border-border/30 rounded-lg">
                <h5 className="font-medium text-emerald-400 mb-3">Information Access and Version Control</h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h6 className="font-medium text-foreground mb-2">Access Methods</h6>
                    <ul className="space-y-1 text-sm">
                  ...
                  <div>
                    <h6 className="font-medium text-foreground mb-2">Version Control Best Practices</h6>
                    <ul className="space-y-1 text-sm">
          ...
          <section className="mb-6">
            ...
            <div className="mb-6">
              <h4 className="font-medium text-foreground mb-3">Understanding Project-Specific Requirements</h4>
              <div className="p-4 bg-card border border-amber-400/30 rounded-lg mb-4">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-border/20 text-sm">
                    <thead>
                      <tr className="bg-card">
                        <th className="border border-border/20 p-3 text-left">Document Type</th>
                        <th className="border border-border/20 p-3 text-left">Typical Content</th>
                        <th className="border border-border/20 p-3 text-left">Authority Level</th>
                        <th className="border border-border/20 p-3 text-left">Compliance Status</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="border border-border/20 p-3"><strong>Architectural specifications</strong></td>
                        <td className="border border-border/20 p-3">Aesthetic requirements, finishes, integration</td>
                        <td className="border border-border/20 p-3">Client/architect directive</td>
                        <td className="border border-border/20 p-3">Contractually binding</td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-border/20 p-3"><strong>Electrical design specs</strong></td>
                        <td className="border border-border/20 p-3">Cable types, containment, protection methods</td>
                        <td className="border border-border/20 p-3">Design engineer directive</td>
                        <td className="border border-border/20 p-3">Technically and contractually binding</td>
                      </tr>
                      <tr>
                        <td className="border border-border/20 p-3"><strong>Client requirements</strong></td>
                        <td className="border border-border/20 p-3">Preferred brands, maintenance access, documentation</td>
                        <td className="border border-border/20 p-3">End user preference</td>
                        <td className="border border-border/20 p-3">Commercial obligation</td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-border/20 p-3"><strong>Main contractor specs</strong></td>
                        <td className="border border-border/20 p-3">Work sequences, coordination, quality standards</td>
                        <td className="border border-border/20 p-3">Project management directive</td>
                        <td className="border border-border/20 p-3">Contractual and programme binding</td>
                      </tr>
                      <tr>
                        <td className="border border-border/20 p-3"><strong>Health & safety specs</strong></td>
                        <td className="border border-border/20 p-3">Site-specific safety measures, access restrictions</td>
                        <td className="border border-border/20 p-3">Safety management directive</td>
                        <td className="border border-border/20 p-3">Legally and contractually binding</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="p-4 bg-card border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-emerald-400 mb-3">Common Site Specification Requirements</h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h6 className="font-medium text-foreground mb-2">Material and Equipment Specifications</h6>
                    <ul className="space-y-1 text-sm">
                  ...
                  <div>
                    <h6 className="font-medium text-foreground mb-2">Installation and Quality Requirements</h6>
                    <ul className="space-y-1 text-sm">
              ...
              <div className="p-4 bg-card border border-green-400/30 rounded-lg">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h6 className="font-medium text-foreground mb-2">Resolution Hierarchy</h6>
                    <ul className="space-y-1 text-sm">
                  ...
                  <div>
                    <h6 className="font-medium text-foreground mb-2">Stakeholder Communication</h6>
                    <ul className="space-y-1 text-sm">
          ...
          <section className="mb-2">
            ...
            <div className="mb-6">
              <h4 className="font-medium text-foreground mb-3">Systematic Compliance Approach</h4>
              <div className="p-4 bg-card border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-emerald-400 mb-3">Four-Step Compliance Framework</h5>
                <div className="space-y-4">
                  <div className="p-3 border border-border/20 rounded-lg">
                    <h6 className="font-medium text-foreground mb-2">Step 1: Regulatory Foundation Review</h6>
                    <ul className="space-y-1 text-sm">
                  ...
                  <div className="p-3 border border-border/20 rounded-lg bg-muted/5">
                    <h6 className="font-medium text-foreground mb-2">Step 2: Manufacturer Instruction Integration</h6>
                    <ul className="space-y-1 text-sm">
                  ...
                  <div className="p-3 border border-border/20 rounded-lg">
                    <h6 className="font-medium text-foreground mb-2">Step 3: Site Specification Application</h6>
                    <ul className="space-y-1 text-sm">
                  ...
                  <div className="p-3 border border-border/20 rounded-lg bg-muted/5">
                    <h6 className="font-medium text-foreground mb-2">Step 4: Implementation and Documentation</h6>
                    <ul className="space-y-1 text-sm">
              ...
              <div className="p-4 bg-card border border-border/30 rounded-lg">
                <h5 className="font-medium text-emerald-400 mb-3">Risk Management and Quality Assurance</h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                  ...
                  <div>
                    <h6 className="font-medium text-foreground mb-2">Quality Assurance Processes</h6>
                    <ul className="space-y-1 text-sm">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-card border border-border/20 rounded-lg">
              <h3 className="font-medium text-foreground mb-2">Q: Can site specifications override BS 7671 requirements?</h3>
              <p className="text-xs sm:text-sm text-foreground">
            ...
            <div className="p-4 bg-card border border-border/20 rounded-lg">
              <h3 className="font-medium text-foreground mb-2">Q: What should I do if manufacturer instructions conflict with BS 7671?</h3>
              <p className="text-xs sm:text-sm text-foreground">
            ...
            <div className="p-4 bg-card border border-border/20 rounded-lg">
              <h3 className="font-medium text-foreground mb-2">Q: Do all products need to be installed exactly as per the manual?</h3>
              <p className="text-xs sm:text-sm text-foreground">
            ...
            <div className="p-4 bg-card border border-border/20 rounded-lg">
              <h3 className="font-medium text-foreground mb-2">Q: Who is liable if I follow site specs that later prove inadequate?</h3>
              <p className="text-xs sm:text-sm text-foreground">
