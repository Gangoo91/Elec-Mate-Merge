    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-base text-muted-foreground mb-12">
          This section covers modern lighting control systems from basic switching through to
          intelligent networked systems. You'll learn about DALI protocols, occupancy and daylight
          sensing, scene setting and how to integrate lighting controls with building management
          systems.
        </p>
