...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "PDCA (Plan, Do, Check, Act) is the fundamental cycle of continual improvement. Plan what you want to achieve, Do (implement it), Check if it's working, and Act to standardise or correct. This cycle then repeats.",
  },
  {
    id: 'check-2',
    ...
    correctIndex: 2,
    explanation:
      'Lagging indicators measure outcomes after the fact - accidents, injuries, ill health. They tell you what has already happened. Number of accidents is a classic lagging indicator.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 1,
    explanation:
      'Circumstances change - new processes, equipment, personnel, or regulations may make existing controls inadequate. Regular review ensures controls remain effective and are adjusted when needed.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 2,
    explanation:
      'Risk assessments should be reviewed when they may no longer be valid: after accidents or near misses, when processes/equipment change, when new information about hazards emerges, or if current controls are found to be inadequate.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "Continual improvement is an ongoing, cyclical process of identifying opportunities for enhancement and making incremental improvements to safety performance. It's about constant evolution, not one-off changes.",
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Leading indicators are proactive measures that predict or prevent harm (training completion, inspections done). Lagging indicators measure outcomes after the fact (accidents, injuries). Both types are needed for a complete picture.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'Percentage of planned inspections completed is a leading indicator - it measures proactive safety activity that aims to prevent incidents. The other options all measure outcomes that have already occurred (lagging indicators).',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Management review assesses whether the safety management system is suitable (right for the organisation), adequate (properly resourced), and effective (achieving its objectives). It drives strategic improvement.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'ISO 45001 is built on the principle of continual improvement. Organisations must establish a system, implement it, maintain it over time, and continually improve it. Static compliance is not sufficient.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      "Worker participation is essential for continual improvement. Workers have direct experience of hazards and controls, can suggest practical improvements, identify when procedures don't work, and are more likely to support changes they helped develop.",
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'The purpose of accident investigation is learning and prevention. Root causes should drive corrective actions - changes to procedures, training, equipment, or systems that prevent the same failure occurring again.',
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      'Health and safety policies should be reviewed at least annually to ensure they remain current. Additionally, they should be reviewed after significant changes - new activities, organisational changes, incidents, or regulatory changes.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      "Safety performance targets are specific, measurable goals for improvement - for example, 'complete 100% of planned inspections,' 'reduce lost time injuries by 25%,' or 'achieve zero prohibition notices.' They drive focused effort.",
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'HSG65 recommends both active monitoring (inspections, audits, observations - checking before things go wrong) and reactive monitoring (investigating accidents, ill health, incidents - learning from failures). Both are essential.',
  },
  {
    id: 11,
    ...
    correctAnswer: 1,
    explanation:
      'Trend analysis looks at patterns over time - increasing near misses, recurring issues in one area, seasonal variations. Identifying trends helps focus resources on systemic problems rather than just individual incidents.',
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      'Benchmarking compares your safety performance against similar organisations, industry averages, or recognised standards. It helps identify where you excel or lag behind and provides targets for improvement.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Look at multiple indicators: Are accident rates declining? Are near misses being reported and resolved? Are inspections finding fewer issues? Are workers more engaged in safety? Is training completion high? Don't rely on one measure - improving performance shows across multiple indicators consistently over time.",
  },
  {
    question: 'What if continual improvement feels overwhelming?',
    answer:
      'Focus on small, manageable steps rather than major overhauls. The PDCA cycle works best with regular small improvements rather than occasional big changes. Prioritise based on risk - tackle the biggest hazards first. Celebrate progress to maintain momentum.',
  },
  {
    question: 'How often should we review our safety performance?',
    answer:
      'Regular reviews at multiple levels: daily/weekly for operational matters (inspections, observations), monthly for team performance metrics, quarterly for management review of system effectiveness, and annually for strategic review of policy and objectives. More frequent reviews for higher-risk activities.',
  },
  {
    question: 'What should trigger an immediate review outside the normal schedule?',
    answer:
      "Serious accidents or near misses, significant changes to processes or equipment, new legislation or guidance, feedback from workers highlighting problems, failed audits, enforcement action by HSE, or when monitoring reveals controls aren't working.",
  },
  {
    question: 'How do we get workers engaged in improvement?',
    answer:
      "Involve them from the start - ask for their input on problems and solutions. Respond visibly when they raise concerns. Give feedback on how their suggestions were used. Recognise contributions. Make improvement part of everyone's job, not just management's. Workers are more likely to support changes they helped create.",
  },
  {
    question: "What's the link between ISO 45001 and continual improvement?",
    answer:
      "ISO 45001 is built on the PDCA cycle - the entire standard is structured around Plan (clauses 4-6), Do (clauses 7-8), Check (clause 9), and Act (clause 10). Continual improvement isn't just one requirement - it's the fundamental principle underlying the whole system.",
  },
];
      ...
      <div className="sticky top-0 z-30 w-full bg-elec-yellow shadow-md">
        <div className="max-w-4xl mx-auto flex items-center gap-3 px-4 sm:px-6 py-3">
          ...
          <span className="font-bold text-black text-lg">
            5.5 Monitoring & Continual Improvement
          </span>
        </div>
      </div>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-8 text-gray-200">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              The <strong className="text-white">Plan-Do-Check-Act (PDCA)</strong> cycle, also known
              as the Deming cycle, is the foundation of continual improvement. It provides a
              systematic framework for making improvements and ensuring they stick.
            </p>
            ...
            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-sm">
                    Identify what you want to improve. Set objectives. Determine how you will
                    achieve them. Identify resources needed.
                  </p>
                </div>
                <div className="border-l-4 border-green-500 pl-4">
                  <p className="font-medium text-green-400">DO</p>
                  <p className="text-sm">
                    Implement the plan. Put the improvement into practice. Collect data on results.
                ...
                <div className="border-l-4 border-elec-yellow pl-4">
                  ...
                  <p className="text-sm">
                    Review results against objectives. Did the improvement work? What went well?
                    What didn't? Analyse the data.
                  </p>
                </div>
                <div className="border-l-4 border-red-500 pl-4">
                  <p className="font-medium text-red-400">ACT</p>
                  <p className="text-sm">
                    If successful, standardise the change. If not, learn and adjust. Start the cycle
            ...
            <div className="bg-yellow-900/30 border border-yellow-600/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                <strong>Plan:</strong> Too many near misses involving isolation - aim to reduce by
                50%
                <br />
                <strong>Do:</strong> Implement new lock-out/tag-out procedure with verification
                steps
                <br />
                <strong>Check:</strong> Review near-miss reports after 3 months - down 60%
                <br />
                <strong>Act:</strong> Make new procedure standard, train all staff, move to next
                improvement
              </p>
            </div>

            <p>
              <strong className="text-white">Why PDCA works:</strong> It prevents ad-hoc changes
              that may not be effective. By checking results before standardising, you ensure
              improvements actually work. The cycle then repeats - improvement never stops.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              To improve safety performance, you need to measure it. Safety indicators are metrics
              that tell you how well your safety management is working. There are two main types:{' '}
              <strong className="text-white">leading</strong> and{' '}
              <strong className="text-white">lagging</strong>.
            </p>
            ...
            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              ...
              <p className="text-sm mb-3">
                Lagging indicators tell you what has happened - they're the outcomes you want to
                prevent. But by the time you measure them, the harm has occurred.
              </p>
              <p className="text-sm">
                Leading indicators are predictive - if you complete training and inspections,
                maintain equipment, and address hazards promptly, you can expect fewer accidents.
                They let you intervene BEFORE harm occurs.
              </p>
              <p className="text-sm mt-3 italic">
                Think of it like driving: lagging indicators are crash statistics; leading
                indicators are seatbelt usage, speed compliance, and vehicle maintenance.
              </p>
            </div>
            ...
            <div className="bg-blue-900/30 border border-blue-500/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                Safety targets should be SMART: Specific, Measurable, Achievable, Relevant,
                Time-bound. "Improve safety" is not SMART. "Reduce LTIFR from 5.0 to 3.0 within 12
                months through enhanced isolation procedures" is SMART.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              Collecting data is pointless without review and action. Regular review processes
              ensure that monitoring leads to actual improvement.
            </p>
            ...
            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm">
                    Review of immediate issues - inspection findings, near misses, day-to-day
                    hazards. Quick action on urgent matters. Toolbox talk topics.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">Tactical Review (Monthly)</p>
                  <p className="text-sm">
                    Review of performance metrics, trends, action completion rates. Team-level
                    analysis. Identify patterns needing attention.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">
                    Management Review (Quarterly/Annually)
                  </p>
                  <p className="text-sm">
                    Strategic review of system effectiveness. Policy review. Resource allocation.
                    Objective setting. Required by ISO 45001.
                  </p>
                </div>
              </div>
            </div>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                <strong>Performance data:</strong> Are targets being met? What are the trends?
              </li>
              <li>
                <strong>Incident analysis:</strong> What happened? Why? Have corrective actions
                worked?
              </li>
              <li>
                <strong>Audit/inspection findings:</strong> Are issues being addressed? Recurring
                themes?
              </li>
              <li>
                <strong>Worker feedback:</strong> What concerns are being raised? Suggestions?
              </li>
              <li>
                <strong>Regulatory changes:</strong> New legislation? Updated guidance?
              </li>
              <li>
                <strong>Organisational changes:</strong> New processes? Equipment? Personnel?
              </li>
            </ul>
            ...
            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              ...
              <p className="text-sm mb-3">
                The HSE's guidance document HSG65 describes the 'Plan, Do, Check, Act' approach:
              </p>
              <ul className="list-disc list-inside text-sm space-y-1">
                <li>
                  <strong>Plan:</strong> Determine your policy, plan for implementation
                </li>
                <li>
                  <strong>Do:</strong> Profile risks, organise, implement your plan
                </li>
                <li>
                  <strong>Check:</strong> Measure performance (active & reactive monitoring)
                </li>
                <li>
                  <strong>Act:</strong> Review performance, learn lessons, act on them
                </li>
              </ul>
            </div>
            ...
            <div className="bg-yellow-900/30 border border-yellow-600/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                Every incident, near miss, and complaint is an opportunity to learn. The key
                questions are: What failed? Why? What will we do differently? Has the action been
                effective? Share lessons - if it happened here, it could happen elsewhere.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              Continual improvement cannot be imposed from above - it requires active worker
              participation. Workers have unique insights into how work is actually done and where
              hazards really exist.
            </p>
            ...
            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-sm">
                <li>
                  <strong>Knowledge:</strong> Workers know where the real hazards are, what controls
                  work, and what doesn't
                </li>
                <li>
                  <strong>Practicality:</strong> Workers can identify when proposed solutions won't
                  work in practice
                </li>
                <li>
                  <strong>Buy-in:</strong> People support what they help create - involvement
                  increases compliance
                </li>
                <li>
                  <strong>Legal:</strong> Consultation with workers is legally required under SRSC
                  Regulations 1977
                </li>
                <li>
                  <strong>Culture:</strong> Participation demonstrates that safety is everyone's
                  responsibility
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              ...
              <p className="text-sm mb-3">
                Effective improvement systems include mechanisms for workers to contribute ideas:
              </p>
              <ul className="list-disc list-inside text-sm space-y-1">
            ...
            <div className="bg-green-900/30 border border-green-500/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                The most important thing is responding to worker input. When workers raise concerns
                or suggest improvements, they need to see action - or at least get feedback
                explaining why action wasn't possible. Nothing kills participation faster than being
                ignored.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#282828] border border-gray-700 rounded-lg p-5">
            ...
            <div className="space-y-3 text-gray-300">
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Observe:</strong> Notice what works well and what doesn't in your daily
                  work
                </span>
              </div>
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Report:</strong> All hazards, near misses, and concerns - even if they
                  seem minor
                </span>
              </div>
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Suggest:</strong> Practical improvements based on your experience
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-elec-yellow font-bold">4.</span>
                <span>
                  <strong>Participate:</strong> Engage in toolbox talks, risk assessments, safety
                  meetings
                </span>
              </div>
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Feedback:</strong> Tell your supervisor when procedures don't work in
                  practice
                </span>
              </div>
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Support:</strong> Help implement changes positively, even if initially
                  sceptical
                </span>
              </div>
            </div>
        ...
        {/* Quiz */}
        <section className="mb-10">
          <Quiz title="Section 5.5 Knowledge Check" questions={quizQuestions} />
        </section>
