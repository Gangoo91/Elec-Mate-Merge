...
const AM2Module5Section5 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['Part 7', 'Part 4', 'Part 6', 'Part 5'],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: ['RCD operation', 'Insulation resistance', 'Polarity', 'Continuity of conductors'],
      correctAnswer: 3,
      explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          In AM2, every rectified fault must be followed by re-testing. This proves that the fault
          has been corrected and that the circuit now complies with BS 7671. It also shows the
          assessor that you understand the professional responsibility of leaving installations safe
          after work.
        </p>
        ...
        <div className="space-y-6">
          ...
          <RegsCallout
            ...
            meaning={
              <>
                ...
                the affected portion. On AM2 day, that means stating the same dead test (continuity,
                IR) and live test (Zs, RCD) sequence as you would for a brand-new circuit.
              </>
            }
          ...
          <Scenario
            ...
            situation={
              <>
                You found an earth fault on a socket circuit: a damaged cable contacting the back of
                a metal accessory. After stating "Replace damaged cable section between SO2 and SO3
                with equivalent 2.5 mm² flat T+E" the assessor asks what re-tests would prove the
                circuit safe.
              </>
            }
            whatToDo={
            ...
            whyItMatters={
              <>
                ...
                marks. Single-test re-tests for earth faults miss the RCD verification that BS 7671
                642.x and 643.8 require. Two tests, named values, named maximums — that's the level
                of detail that earns full marks under Reg 643 verification requirements.
              </>
            }
          />
          ...
          <ConceptBlock title="3. What Assessors Look For">
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Clear linkage:</strong> Every rectification must be followed by appropriate
                re-test
              </li>
              <li>
              ...
              <li>
                <strong>Realistic results:</strong> Recorded values that make sense for the circuit
              </li>
              <li>
          ...
          <CommonMistake
            ...
            whatHappens={
              <>
                ...
                marks you partial — your IR test is correct but you've forgotten the RCD operational
                test. After any earth fault, BS 7671 Reg 643.8 requires verifying the RCD still
                trips within its rated time.
              </>
            }
            doInstead={
              <>
                ...
                <em>
                  "Re-test IR L-E and N-E at 500 V DC, expecting &gt; 1 MΩ. Re-test RCD operation at
                  ×1 IΔn, expecting trip within 300 ms per Reg 643.8."
                </em>{' '}
          ...
          <ConceptBlock title="5. Professional Re-testing Best Practices">
            ...
            <p>
              <em>
                "Reconnect CPC at socket outlet → Re-test continuity → 0.15 Ohms recorded → Complies
                with BS 7671"
              </em>
            </p>
          ...
          <ConceptBlock title="6. Real-World Application Examples">
            ...
            <p>
              "Rectification: Remake connection at socket 4 terminals → Re-test: Ring final circuit
              continuity → Result: 0.24 Ohms recorded → Complies with BS 7671 Table I1"
            </p>
          ...
          <ConceptBlock title="8. Professional Success Through Proper Re-testing">
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Legal protection:</strong> Documented re-testing provides liability coverage
              </li>
              <li>
