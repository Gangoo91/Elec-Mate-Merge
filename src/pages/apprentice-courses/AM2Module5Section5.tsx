  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <AM2ContentCard title="1. Why Re-testing Matters" icon={Target}>
          <div className="bg-white/5 border border-white/10 rounded-xl p-4">
            <h4 className="text-ios-headline font-semibold text-white mb-3">
              Essential Reasons for Re-testing:
            </h4>
        ...
        <AM2ContentCard title="2. Re-testing Requirements by Fault Type" icon={TestTube} accent>
        ...
        <AM2ContentCard title="3. What Assessors Look For" icon={Eye}>
        ...
        {/* Common Mistakes */}
        <AM2ContentCard title="4. Common Candidate Mistakes" icon={AlertTriangle}>
        ...
        <AM2ContentCard title="5. Professional Re-testing Best Practices" icon={Lightbulb} accent>
          <div className="space-y-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="text-ios-headline font-semibold text-white mb-3">
        ...
        <AM2ContentCard title="6. Real-World Application Examples" icon={Wrench}>
          <div className="space-y-4">
        ...
        <AM2ContentCard title="7. Advanced Re-testing Scenarios" icon={Target}>
          <div className="space-y-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="text-ios-headline font-semibold text-white mb-3">
        ...
        <AM2ContentCard title="8. Professional Success Through Proper Re-testing" icon={Shield}>
          <div className="space-y-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="text-ios-headline font-semibold text-white mb-3">
