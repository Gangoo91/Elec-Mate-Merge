...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['10A through load', '9.79A through load', '219.1V across load', '230V across load'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              IEC 60909 is the international standard for fault-level studies. It is Thevenin’s
              theorem applied at scale — every transformer, cable and source upstream of the fault
              point is collapsed into one equivalent voltage and one equivalent impedance. The HNC
              engineer uses the same idea on a building-services scale to size switchgear and
              protective devices.
            </>
          }
        ...
        <ConceptBlock title="Superposition Theorem">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Load current from mains:</strong> Current divider I = 92.9 × 2/12 → I_load1 =
              15.5A
            </li>
            <li>
            ...
            <li>
              <strong>Load current from PV:</strong> Current divider I = 86.8 × 0.5/10.5 → I_load2 =
              4.1A
            </li>
            <li>
        ...
        <ConceptBlock title="Thévenin's Theorem">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              For a 46Ω load (5kW heater): IL = 230 / (0.183 + 46) = <strong>4.98A</strong>
            </li>
            <li>
        ...
        <ConceptBlock title="Building Services Applications">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Load transfer:</strong> Superposition helps analyse transition currents during
              load transfer between mains and generator
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Transfer switching:</strong> Analyse voltage/current transients during static
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              This current flows from generator to mains, not through the load — it's wasted power
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            ...
            Generator 1 has internal resistance 0.6Ω, Generator 2 has 0.9Ω. If Gen 1's voltage rises
            to 402V, find the current from each generator.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Gen 1 current: I1 = (402 - 400.9) / 0.6 + (112.6 × 0.36/0.6) ≈ <strong>69A</strong>
            </li>
            <li>
          ...
          <p>
            <strong>Question:</strong> A 10kVA UPS has inverter output impedance of 0.5Ω. Find the
            Thévenin equivalent and calculate voltage regulation when loaded to 80%.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              UPS Thévenin equivalent: VTh = 230V (nominal output); RTh = 0.5Ω (output impedance)
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Combine Norton sources (parallel): IN_total = 230 + 76 = 306A; RN_total = 1 || 3 =
              0.75Ω
            </li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              impedance. Replacing voltage sources with open circuits instead of shorts. Sign errors
              when summing.
            </>
          }
          doInstead={
        ...
        <Scenario
          ...
          situation={
            <>
              A data-hall switchboard is fed from the building mains via a 1000 kVA transformer
              (impedance 5 %) and from a 200 kVA static UPS in static-bypass mode. During the
              millisecond they overlap on transfer, both sources can contribute to a downstream
              fault. You are picking the I_cu rating of the outgoing MCCBs.
            </>
          }
          whatToDo={
            <>
              Use Thevenin to collapse each source down to its equivalent: mains contribution from
              R_TH(mains) and UPS contribution from R_TH(UPS), referred to the switchboard busbar.
              Add the two prospective fault currents (or treat them as parallel sources by
              superposition) to get worst-case I''_k at the busbar. Pick MCCBs with I_cu greater
              than that combined PSCC, applying any cascading or coordination rules per BS 7671
              Section 434 / IEC 60947-2. Document the calculation in the short-circuit study.
            </>
          }
          whyItMatters={
            <>
              Switchgear under-rated for the actual prospective short-circuit current is lethal — it
              can rupture, arc-flash and fail to interrupt the fault. Thevenin and superposition are
              the working tools that let you defend the I_cu choice in the design report.
            </>
          }
        />
