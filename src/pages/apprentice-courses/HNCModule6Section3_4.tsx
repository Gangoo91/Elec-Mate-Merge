...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Mat 03', 'Mat 02', 'Mat 01', 'Wst 01'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Wst 01', 'Wst 03', 'Wst 02', 'Mat 01'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['BS 7671', 'CIBSE Guide A', 'EN 15804', 'ISO 9001'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BES 6001 is the UK responsible sourcing standard — applies to concrete, steel, timber,
              masonry. The contractor must collect certificates from suppliers at order stage and
              assemble the evidence pack for the assessor. SWMPs are no longer legally mandatory
              (repealed 2013) but are required for BREEAM and for many client/local-authority
              planning conditions.
            </>
          }
        ...
        <ConceptBlock title="Life Cycle Assessment and Mat 01">
          <p>
            BREEAM Mat 01 (Environmental Impacts from Construction Products) drives the selection of
            materials with lower environmental burdens across their entire life cycle. This requires
            understanding Life Cycle Assessment (LCA) methodology and the role of Environmental
            Product Declarations (EPDs) in demonstrating compliance.
          </p>
          <p>
            <strong>Life cycle stages assessed under EN 15804:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>A1-A3 (Product stage):</strong> Raw material extraction, transport to factory,
              manufacturing
            </li>
            <li>
              <strong>A4-A5 (Construction stage):</strong> Transport to site, installation processes
            </li>
            <li>
              <strong>B1-B7 (Use stage):</strong> Maintenance, repair, replacement, refurbishment,
              operational impacts
            </li>
            <li>
          ...
          <p>
            <strong>Environmental Impact Categories</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Global Warming Potential (GWP):</strong> kg CO2 eq — Embodied carbon of
              cables, equipment
            </li>
            <li>
              <strong>Ozone Depletion Potential (ODP):</strong> kg CFC-11 eq — Refrigerants,
              insulation blowing agents
            </li>
            <li>
              <strong>Acidification Potential (AP):</strong> kg SO2 eq — Metal processing emissions
            </li>
            <li>
              <strong>Eutrophication Potential (EP):</strong> kg PO4 eq — Manufacturing process
              discharges
            </li>
            <li>
              <strong>Abiotic Depletion (elements):</strong> kg Sb eq — Copper, rare earth elements
              usage
            </li>
          </ul>
          <p>
            <strong>Mat 01 Credit Guidance</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1-3 credits:</strong> Complete LCA using recognised methodology and EPD data
            </li>
            <li>
              <strong>Additional credits:</strong> Demonstrate material selection improvements based
              on LCA
            </li>
            <li>
        ...
        <ConceptBlock title="Responsible Sourcing - Mat 03">
          <p>
            ...
            from organisations with robust environmental management systems and verified sustainable
            supply chains. This applies directly to key MEP materials including copper, steel,
          ...
          <p>
            <strong>Tier 2: Certified EMS</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Tier 3: Full Certification</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Key MEP Materials for Responsible Sourcing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Copper:</strong> Cables, busbars, pipework — Copper Mark, BES 6001
            </li>
            <li>
              <strong>Steel:</strong> Containment, supports, ductwork — BES 6001, ResponsibleSteel
            </li>
            <li>
              <strong>Aluminium:</strong> Cables, heat exchangers, luminaires — ASI Certification,
              BES 6001
            </li>
            <li>
              <strong>Plastics (PVC, XLPE):</strong> Cable insulation, conduit, trunking —
              VinylPlus, BES 6001
            </li>
            <li>
              <strong>Timber:</strong> Packing, temporary supports — FSC, PEFC
            </li>
          </ul>
          <p>
            <strong>Procurement Specification Clause</strong>
          </p>
          <p>
            "All copper cables shall be sourced from manufacturers holding current BES 6001
            certification at minimum 'Very Good' rating, with Copper Mark certification preferred.
            Evidence of certification shall be submitted with material submittals."
          </p>
          <p>
            <strong>Credit strategy:</strong> Focus responsible sourcing requirements on the largest
            material volumes - cables, containment, and ductwork typically offer the greatest credit
            opportunity for MEP packages.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Construction Waste Management - Wst 01">
          ...
          <p>
            <strong>Resource Management Plan Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Wst 01 Credit Benchmarks</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Minimum standard:</strong> 70% from landfill — No specific target
            </li>
            <li>
              <strong>Good practice:</strong> 85% from landfill — &lt;7.5 tonnes per 100m2
            </li>
            <li>
              <strong>Best practice:</strong> 95% from landfill — &lt;5.5 tonnes per 100m2
            </li>
            <li>
              <strong>Exemplary:</strong> &gt;95% from landfill — &lt;3.5 tonnes per 100m2
            </li>
          </ul>
          <p>
            <strong>MEP Waste Streams and Management</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Copper offcuts:</strong> Cable installation — Segregate for recycling (high
              value)
            </li>
            <li>
              <strong>Cable drums:</strong> Cable deliveries — Return to supplier (take-back scheme)
            </li>
            <li>
              <strong>Cardboard/packaging:</strong> Equipment deliveries — Compact and recycle
            </li>
            <li>
              <strong>Plastic packaging:</strong> Accessories, fittings — Segregate by type for
              recycling
            </li>
            <li>
              <strong>Steel offcuts:</strong> Containment, supports — Scrap metal recycling
            </li>
            <li>
              <strong>WEEE:</strong> Replaced equipment — Licensed WEEE contractor
            </li>
          </ul>
          <p>
            <strong>Documentation tip:</strong> Maintain waste transfer notes for all movements off
            site. Photograph segregated waste storage areas for BREEAM evidence submissions.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Operational Waste and Circular Economy">
          ...
          <p>
            <strong>Wst 02 Operational Waste Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Dedicated space for recyclable waste storage (sized to building occupancy)</li>
            <li>
              Segregated bins/containers for minimum waste streams (paper, glass, plastic, metals)
            </li>
          ...
          <p>
            <strong>Circular Economy Principles for MEP</strong>
          </p>
          <p>
            <strong>Design for Disassembly</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Material Recovery Potential</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>MEP Circular Economy Strategies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Specify recycled content:</strong> Recycled copper cables, steel — Reduces
              virgin material demand
            </li>
            <li>
              <strong>Modular distribution:</strong> Plug-and-play wiring systems — Enables
              reconfiguration and reuse
            </li>
            <li>
              <strong>Equipment leasing:</strong> Lighting as a service — Manufacturer retains
              ownership/recovery
            </li>
            <li>
              <strong>Material passports:</strong> BIM-based material tracking — Enables future
              recovery planning
            </li>
            <li>
              <strong>Standardisation:</strong> Common component sizes — Facilitates spare parts and
              reuse
            </li>
          </ul>
          <p>
            <strong>Material Passport Example - Distribution Board</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Materials:</strong> Steel enclosure (22kg, galvanised), Copper busbars (8kg),
            MCCB/MCB units (15 units)
          </p>
          <p>
            <strong>Recycled content:</strong> Steel 45% post-consumer, Copper 30% recycled
          </p>
          <p>
            <strong>Disassembly:</strong> Bolted connections, accessible from front, no adhesives
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Compare two cable suppliers for 100m of 4-core 16mm2 armoured
            cable based on EPD data.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Incomplete waste records</strong> - Ensure all waste movements have transfer
                notes
              </li>
              <li>
                <strong>Mixed waste skips</strong> - Segregation is essential for recycling credits
              </li>
              <li>
                <strong>Ignoring packaging</strong> - Packaging waste can exceed installation waste
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              During value engineering, the steel frame supplier was changed from a BES
              6001-certified mill to a non-certified one for a £35k saving. The Mat 03 credit
              budgeted on the original supplier is now lost — and dropping it cascades the rating
              from Excellent to Very Good, breaching the planning condition.
            </>
          }
          whatToDo={
            <>
              Reverse the substitution if at all possible — the £35k saving has now caused planning
              re-application risk worth multiples of that. If reversal is not commercially viable,
              look for replacement Mat 03 wins on other packages (responsibly sourced concrete,
              masonry, timber). If insufficient, downgrade and seek a planning variation. Lesson:
              every value engineering change on a BREEAM project must go through the Assessor for
              credit-impact assessment before it is approved.
            </>
          }
          whyItMatters={
            <>
              BREEAM and value engineering are not friends. Cost-out exercises late in design
              routinely strip credits the team thought were locked. Build a no-substitution clause
              into BREEAM-critical packages, or require Assessor approval for any change. The
              procurement specification is the BREEAM specification.
            </>
          }
        />
