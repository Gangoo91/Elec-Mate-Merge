    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS 7671 prescribes the test sequence — and the sequence matters. Insulation resistance
              before energisation; polarity before connection of single-pole devices; earth fault
              loop impedance after the supply is energised. Out-of-sequence testing risks safety
              incidents and invalid results. Embed the sequence as a non-negotiable procedure.
            </>
          }
        ...
        <ConceptBlock title="Pre-Commissioning Tests">
          <p>
            Pre-commissioning tests verify that systems are correctly installed and safe to energise
            or start. These tests must be completed and documented before any system is made
            operational, protecting both personnel and equipment from potential damage.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Visual inspection:</strong> Checking installation quality and compliance with
              drawings
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Insulation resistance:</strong> Detect insulation failures — &gt;1 MΩ at 500V
              d.c.
            </li>
            <li>
            ...
            <li>
              <strong>RCD operation:</strong> Confirm protection function — general non-delay type
              trips ≤300 ms at IΔn (≤40 ms at 5×IΔn)
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Chilled water:</strong> 1.5 × working pressure — 2 hours minimum — No visible
              drop
            </li>
            <li>
        ...
        <ConceptBlock title="System Testing Procedures">
          <p>
            ...
            follows pre-commissioning and involves operating systems under controlled conditions to
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Analogue output:</strong> Command 0%, 50%, 100% — Actuator responds correctly
            </li>
            <li>
          ...
          <p>
            <strong>Best practice:</strong> Use standardised test sheets for consistency and ensure
            all instruments are within calibration date.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Acceptance Criteria and Performance Verification">
          <p>
            ...
            These must be measurable, achievable, and agreed by all parties before installation
            begins. Clear criteria prevent disputes and ensure objective assessment of system
            performance.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Stage 2 - Dynamic tests:</strong> System operation under controlled conditions
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Measurement:</strong> Temperature at 12 points per room, humidity at 4 points
            </li>
            <li>
        ...
        <ConceptBlock title="Test Certificates and Compliance Demonstration">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Pressure Test Certificate:</strong> Pipework integrity — Mechanical contractor
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Example 3 — Witness test documentation:</strong> Document a witnessed generator
            load test.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              At handover, the electrical sub energises a distribution board for the first time. A
              fault to earth on a circuit causes the upstream RCD to trip immediately. Investigation
              reveals a damaged cable on a circuit installed two months earlier. The IR test on this
              DB had been skipped due to time pressure; the schedule of test results was being
              completed retrospectively.
            </>
          }
          whatToDo={
            <>
              De-energise. Locate and rectify the cable damage. Repeat full IR testing on every
              circuit on the DB. Issue NCR for the skipped test and reconstructed records. Re-brief
              the test team on the BS 7671 sequence and the requirement for contemporaneous records.
              Audit other DBs on the project for similar shortcuts. Update the ITP to require
              sign-off of test results as each circuit is tested, by the operative doing the test —
              not by office staff after the fact.
            </>
          }
          whyItMatters={
            <>
              Testing is the safety-critical verification step. Skipped tests can mean energising
              onto a fault — risk of injury, fire, equipment damage. Reconstructed test results are
              also a regulatory and contractual breach: the EIC says the test was carried out in
              compliance with the regulations; if it was not, the certificate is invalid.
            </>
          }
        />
