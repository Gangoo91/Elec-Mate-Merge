      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Linear bridges (ψ):</strong> Heat loss per metre length (W/mK)
              </li>
              <li className="pl-1">
                <strong>Point bridges (χ):</strong> Heat loss at single points (W/K)
              </li>
              <li className="pl-1">
                <strong>Condensation risk:</strong> Cold surfaces below dew point
              </li>
              <li className="pl-1">
                <strong>ACDs:</strong> Pre-approved details minimising bridging
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Service penetrations:</strong> Cables, ducts, pipes through walls
              </li>
              <li className="pl-1">
                <strong>Fixings:</strong> Cable trays, equipment supports
              </li>
              <li className="pl-1">
                <strong>Part L compliance:</strong> Thermal bridge calculations
              </li>
              <li className="pl-1">
                <strong>Mitigation:</strong> Thermal breaks and sealing details
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              ...
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Building Services Point Bridges
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Per tie, typically 2.5/m²
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Steel fixing bracket (100mm²)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Includes air leakage effect
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Cable entry (sealed with thermal break)
                      </td>
                    ...
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Structural steel beam penetration
                      </td>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                High-Risk Thermal Bridge Locations
              </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="text-xs text-white/70 text-center space-y-1">
                ...
                <p className="mt-2">
                  <strong>Minimum fRsi = 0.75</strong> required to avoid mould growth (BRE IP 1/06)
                </p>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Surface Temperature vs Condensation Risk
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">0.05</td>
                      <td className="border border-white/10 px-3 py-2">
                        All junctions match ACD specifications
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Thermal modelling of all junctions
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Building Services Junction Mitigation Strategies
              </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Continuity:</strong> Maintain insulation layer continuity wherever
                  possible
                </li>
                <li className="pl-1">
                  <strong>Thermal breaks:</strong> Use low-conductivity materials where continuity
                  is impossible
                </li>
                <li className="pl-1">
                  <strong>Air sealing:</strong> Seal all penetrations to prevent convective heat
                  loss
                </li>
                <li className="pl-1">
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Linear Thermal Bridge Heat Loss
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> A building has 48m of wall-to-floor junction with ψ =
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Point Thermal Bridge Assessment
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> A commercial building has 120 cable tray brackets
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  χ<sub>total</sub> = 120 × 0.06 = 7.2 W/K
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Condensation Risk Check
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  T<sub>si</sub> = -2 + 0.72 × (21 - (-2))
                </p>
                <p>
                  T<sub>si</sub> = -2 + 0.72 × 23 = -2 + 16.6 = <strong>14.6°C</strong>
                </p>
                <p className="mt-2">
                  Dew point at 21°C, 60% RH ≈ <strong>12.9°C</strong>
                </p>
                <p className="mt-2 text-green-400">
                  ✓ Surface (14.6°C) is above dew point (12.9°C)
                </p>
                <p className="text-yellow-400">
                  ⚠ But close to threshold - mould risk if RH increases
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 4: Y-Value Impact on Heat Loss
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> A dwelling has 450m² total envelope area. Compare annual
