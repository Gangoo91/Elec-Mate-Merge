...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['y = 0.05', 'y = 0.10', 'y = 0.15', 'y = 0.08'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Part L makes thermal bridging a compliance item, not an afterthought. Using Approved
              Construction Details (ACDs) drops the y-value from 0.15 to 0.05 and often makes the
              difference between a passing and failing SAP/SBEM.
            </>
          }
        ...
        >
          ...
          <p>
            <strong>Aggregate effect:</strong> A building with 50 unsealed service penetrations at χ
            = 0.15 W/K each, with ΔT = 20K, loses 150W - equivalent to leaving a desktop heater on
            permanently.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            internal surface temperature, Ti = internal air temperature, Te = external temperature.
            Minimum fRsi = 0.75 required to avoid mould growth (BRE IP 1/06).
          </p>
          <p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Thermal breaks:</strong> Use low-conductivity materials where continuity is
              impossible
            </li>
            <li>
            ...
            <li>
              <strong>Coordination:</strong> Early coordination between architects and services
              engineers
            </li>
            <li>
              <strong>Documentation:</strong> Record all non-standard details for compliance
              evidence
            </li>
          </ul>
          <p>
            <strong>Design coordination:</strong> Thermal bridging mitigation must be considered
            during early design stages. Retrofitting solutions is far more expensive and often less
            effective than designing details correctly from the outset.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Q = ψ × L × ΔT = 0.08 × 48 × 12 = <strong>46.1W</strong>
            </li>
            <li>
              E = 46.1W × 5,400h = 249,000 Wh = <strong>249 kWh/year</strong>
            </li>
            <li>At £0.28/kWh = £70/year for this single junction</li>
          </ul>
          <p>
            <strong>Example 2 - point thermal bridge assessment:</strong> A commercial building has
            120 cable tray brackets penetrating the external wall insulation. Each bracket has χ =
            0.06 W/K. Calculate the total additional heat loss at design conditions (ΔT = 25K).
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>χtotal = n × χ = 120 × 0.06 = 7.2 W/K</li>
            <li>
              Q = χtotal × ΔT = 7.2 × 25 = <strong>180W</strong>
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Tsi = -2 + 0.72 × 23 = -2 + 16.6 = <strong>14.6°C</strong>
            </li>
            <li>
              Dew point at 21°C, 60% RH ≈ <strong>12.9°C</strong>
            </li>
            <li>
              Surface (14.6°C) is above dew point (12.9°C) — but close to threshold; mould risk if
              RH increases
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Saving: 2,916 kWh/year (£816/year at £0.28/kWh)</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Late coordination</strong> — Services routes designed without thermal
                consideration
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A new dwelling is showing mould growth at the window reveals after one heating season.
              The fabric U-values are at Part L target, but the as-built construction did not follow
              Approved Construction Details at the lintel and jamb.
            </>
          }
          whatToDo={
            <>
              Run a thermal-bridging assessment. Calculate the f_Rsi (temperature factor at the
              internal surface) at the worst-case junction using a 2D heat-flow simulation (Therm or
              HEAT3). If f_Rsi falls below the BS EN ISO 13788 limit (typically 0.75 for dwellings),
              surface condensation is foreseeable. Specify remedial work: insulating reveal liner,
              internal insulating render, or warm-edge spacer if missed. Document and re-run SAP
              with corrected y-value.
            </>
          }
          whyItMatters={
            <>
              Surface condensation triggers mould growth and habitability claims under Homes
              (Fitness for Human Habitation) Act 2018. Designing junctions correctly and verifying
              f_Rsi is cheaper than the call-back.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">U-values</div>
          </button>
          <button
