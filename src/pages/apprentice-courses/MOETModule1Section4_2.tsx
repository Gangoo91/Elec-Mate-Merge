...
const DESCRIPTION =
  'Comprehensive guide to the Electricity at Work Regulations 1989 (EAWR) for electrical maintenance technicians: 33 regulations, absolute duties vs SFARP, dead working, live working, competence, and practical application.';

const quickCheckQuestions = [
  {
    id: 'eawr-reg4',
    question:
      'Regulation 4(1) of the EAWR 1989 requires that all systems shall at all times be of such construction as to prevent, so far as is reasonably practicable, danger. What type of duty is this?',
    options: [
      ...
      'An absolute duty — there is no qualification at all',
    ],
    correctIndex: 0,
    explanation:
      "Regulation 4(1) is a qualified duty — its wording includes 'so far as is reasonably practicable' (SFARP), allowing a balance of risk against cost. By contrast, Regulations 5, 9, 10, 12 and 13 are absolute duties with no SFARP qualification.",
  },
  {
    ...
    options: [
      'Switched off at the local control switch and left for the supply to discharge',
      'Made dead and disconnected from every source of electrical energy',
      'Fitted with a residual current device before the work commences',
      'Inspected visually for damage and then worked on while still energised',
    ],
    correctIndex: 1,
    explanation:
      'Regulation 12 requires that equipment be made dead before work is carried out on or near it. This is the fundamental principle of dead working — the equipment must be disconnected from every source of electrical energy before any work begins, not merely switched off.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Regulation 14 requires all three conditions to be satisfied simultaneously: (1) it is unreasonable in all the circumstances for the conductor to be dead, (2) it is reasonable in all the circumstances for the person to work on or near it while live, and (3) suitable precautions (including PPE where necessary) are taken to prevent injury.',
  },
  {
    id: 'eawr-competence',
    question:
    ...
    options: [
      ...
      'Hold a current ECS card and a minimum of five years on-site experience',
      'Are registered with a competent person scheme such as NICEIC or NAPIT',
      'Have passed the City & Guilds 2391 inspection and testing qualification',
    ],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The EAWR 1989 are statutory instruments made under the enabling powers of Section 15 of the Health and Safety at Work Act 1974. They are criminal law regulations, not civil — breach is a criminal offence enforced by the HSE.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    options: [
      ...
      'Regulation 6 — equipment in adverse or hazardous environments',
      'Regulation 5 — strength and capability of equipment',
      'Regulation 7 — insulation, protection and placing of conductors',
    ],
    correctAnswer: 2,
    explanation:
      "Regulation 5 is an absolute duty: no electrical equipment shall be put into use where its strength and capability may be exceeded so as to give rise to danger — there is no SFARP qualifier. Regulations 4(1), 6 and 7 are all qualified by 'so far as is reasonably practicable'.",
  },
  {
    id: 4,
    ...
    options: [
      ...
      'Employers and the Health and Safety Executive only',
      'Equipment manufacturers and suppliers only',
      'Building owners and occupiers only',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A verbal confirmation from a supervisor that the supply has been turned off',
      'Adequate precautions including isolation, securing the isolation, and proving dead',
      'A warning notice placed on the equipment and the area cordoned off',
      'Confirmation that the circuit is protected by a 30 mA residual current device',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'All electrical equipment be inspected and tested at fixed annual intervals',
      'Only competent persons may hold the keys to a locked-off isolation device',
      'Adequate working space, access, and lighting be provided for work on electrical equipment',
      'Every distribution board be clearly labelled with its circuit designations',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The breach was caused entirely by the act of another employee',
      'No injury actually resulted from the contravention',
      'The cost of compliance would have been disproportionate to the risk',
  ...
  },
  {
    ...
    options: [
      ...
      'Inspected and tested at intervals fixed by the regulation, regardless of condition',
      'Returned to the original manufacturer for servicing at least once a year',
      'Repaired only after a fault has occurred and caused a loss of supply',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 9,
    question:
      'Which EAWR regulation specifically addresses the strength and capability of electrical equipment?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Regulation 5 requires that no electrical equipment shall be put into use where its strength and capability may be exceeded in such a way as to give rise to danger. This means equipment must be rated for the conditions in which it will be used — for example, switchgear must have adequate fault level rating.',
  },
  {
    id: 10,
    question: "Under the EAWR, the term 'electrical equipment' is defined to include:",
    options: [
      'Only fixed wiring and distribution equipment rated above 50 volts',
      'Only portable appliances and hand tools used by the workforce',
      ...
      'Only equipment connected to the public electricity supply network',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'BS 7671 is statute law and the EAWR are merely advisory guidance',
      'They are identical documents published under two different names',
      'BS 7671 takes legal precedence over the EAWR where they conflict',
  ...
  },
  {
    ...
    options: [
      ...
      'They set out the wiring colours and cable sizes used in maintenance work',
      'They specify the calibration intervals for portable test instruments',
      'They list the qualifications a technician must hold before starting work',
    ],
    correctAnswer: 0,
    explanation:
...
const faqs = [
  {
    ...
    answer:
      'Yes. The EAWR 1989 apply to all electrical systems and equipment at any voltage. There is no lower voltage threshold — the regulations apply equally to extra-low voltage (ELV), low voltage (LV), and high voltage (HV) systems. The level of precaution required will vary with the degree of danger, but the duty to prevent danger applies universally.',
  },
  {
    question:
      "What is the difference between an 'absolute' duty and a 'qualified' duty in the EAWR?",
    answer:
      "An absolute duty uses the word 'shall' without any qualification — it must be complied with regardless of cost or practicability (e.g., Regulation 12 — equipment shall be made dead). A qualified duty includes the phrase 'so far as is reasonably practicable' (SFARP), allowing a cost-benefit analysis. Some EAWR regulations are absolute, others are SFARP. Regulation 29 provides a defence of due diligence for absolute duties.",
  },
  {
    question: 'Can I be personally prosecuted under the EAWR 1989?',
    answer:
      'Yes. Regulation 3 places duties on employees as well as employers. If you, as a maintenance technician, breach a regulation in respect of a matter within your control — for example, failing to prove dead before working on a circuit — you can be personally prosecuted. The defence of due diligence (Regulation 29) is available, but you must demonstrate that you took all reasonable steps to comply.',
  },
  {
    question: "How do the EAWR 1989 define 'danger'?",
    answer:
      "Regulation 2 defines 'danger' as 'risk of injury'. 'Injury' means death or personal injury from electric shock, electric burn, electrical explosion, or arcing, or from fire or explosion initiated by electrical energy. Note that this is broader than just electric shock — it includes burns, arc flash, and fires caused by electrical faults.",
  },
  {
    question: 'Are the EAWR 1989 affected by Brexit?',
    answer:
      "No. The EAWR 1989 are domestic UK regulations made under the HSWA 1974, not EU-derived legislation. They were drafted and enacted by the UK government and are unaffected by the UK's departure from the European Union. They remain fully in force as originally enacted.",
  },
];
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              Health and Safety at Work Act 1974 and came into force on 1 April 1990, replacing
              parts of the Factories Act 1961 and the Electricity (Factories Act) Special
              Regulations 1908 and 1944.
            </p>
            <p>
              The EAWR contain 33 regulations. Unlike the goal-setting approach of the HSWA 1974,
              many EAWR regulations impose <strong>absolute duties</strong> — duties that must be
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              relating to different aspects of electrical safety. For maintenance technicians,
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              <strong>dead working is the default</strong> and live working is the exception —
