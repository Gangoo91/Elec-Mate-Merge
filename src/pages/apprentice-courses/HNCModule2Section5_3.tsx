        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Admittance (Y):</strong> Surface heat absorption capacity (W/m²K)
              </li>
              <li className="pl-1">
                <strong>Decrement (f):</strong> Dampening of external temperature swings
              </li>
              <li className="pl-1">
                <strong>Time lag (φ):</strong> Delay between outside and inside peaks
              </li>
              <li className="pl-1">
                <strong>Thermal mass:</strong> Heat storage in heavy building elements
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Peak shifting:</strong> Move cooling load to evening/night
              </li>
              <li className="pl-1">
                <strong>Load reduction:</strong> Lower peak = smaller plant
              </li>
              <li className="pl-1">
                <strong>Night purge:</strong> Free cooling using stored heat discharge
              </li>
              <li className="pl-1">
                <strong>Comfort:</strong> More stable temperatures
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical Admittance Values (CIBSE Guide A)
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Decrement factor (f):</strong> Ratio of internal to external temperature
                  swing (0-1)
                </li>
                <li className="pl-1">
                  <strong>Time lag (φ):</strong> Hours delay between external and internal
                  temperature peaks
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Mechanical night cooling:</strong> Fans run overnight with 100% outside
                  air
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-2">Requirements for effective night cooling:</p>
              <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                <li className="pl-1">
                  Significant diurnal temperature swing (UK typically 8-12K in summer)
                </li>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical Daily Cycle - Heavyweight Office
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Pre-cooling complete, mass discharged
                      </td>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Maximising thermal mass effectiveness:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Adequate depth:</strong> 75-100mm of exposed concrete provides most
                  benefit
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Part O and Thermal Mass
              </p>
              <p className="text-sm text-white">
                TM59 overheating assessment considers thermal mass through dynamic simulation.
                Heavyweight construction typically performs better due to:
              </p>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Room Admittance Sum
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> Calculate ΣAY for a room with: exposed concrete ceiling
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Impact of Suspended Ceiling
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Decrement Effect
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> External sol-air temperature swings from 25°C to 45°C
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="text-green-400">
                  75% of temperature variation eliminated by thermal mass
                </p>
              </div>
            </div>
