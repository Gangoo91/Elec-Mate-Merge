...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['06:00', '22:00', '18:00', '14:00'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['10-12 hours', '2-3 hours', '24 hours', '6-8 hours'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['1.0-2.0 W/m²K', '0.5-1.0 W/m²K', '4.0-5.0 W/m²K', '6.0-8.0 W/m²K'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE Guide A provides the dynamic-response data that the admittance method consumes.
              As HNC engineer you reference it when defending a thermal-mass design decision to the
              architect — particularly in TM52/TM59 overheating studies where thermal mass swings
              the result.
            </>
          }
        ...
        >
          <p>
            As heat passes through an external element, it is dampened (decrement) and delayed (time
            lag). These properties are crucial for understanding how external temperature swings
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Decrement factor (f):</strong> Ratio of internal to external temperature swing
              (0-1)
            </li>
            <li>
              <strong>Time lag (φ):</strong> Hours delay between external and internal temperature
              peaks
            </li>
            <li>
          ...
          <p>
            ...
            evening (22:00) when occupants have left and external temperature has dropped, enabling
            natural or free cooling.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            external conditions are cooler and electricity may be cheaper. This is the basis of many
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Night purge ventilation:</strong> High airflow (4-10 ach) through open
              windows/louvres
            </li>
            <li>
            ...
            <li>
              <strong>Thermally active building systems (TABS):</strong> Water pipes in slab for
              thermal charging
            </li>
            <li>
        ...
        >
          ...
          <p>
            <strong>Part O and thermal mass:</strong> TM59 overheating assessment considers thermal
            mass through dynamic simulation. Heavyweight construction typically performs better due
            to lower peak temperatures (Criterion 1 - hours over 26°C), better night-time recovery
            enabling next-day absorption, and more time for occupants to adapt or take action.
          </p>
          <p>
        ...
        >
          <p>
            <strong>Example 1 - Room admittance sum:</strong> Calculate ΣAY for a room with exposed
            concrete ceiling 50m² (Y=5.5), plastered brick walls 80m² (Y=4.0), carpeted floor 50m²
            (Y=1.0), glazing 15m² (Y=5.7).
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 2 - Impact of suspended ceiling:</strong> The same room has a suspended
            ceiling installed (Y=0.8). How does this affect ΣAY?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 - Decrement effect:</strong> External sol-air temperature swings from
            25°C to 45°C (±10K from mean of 35°C). A wall with f=0.25 separates the room. What is
            the internal surface temperature swing?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A primary-school classroom (60 m², south-facing, 20 students) is being designed for
              natural ventilation only — no mechanical cooling. The architect proposes a fully
              suspended acoustic ceiling. You suspect that will compromise summer comfort.
            </>
          }
          whatToDo={
            <>
              Run two TM52 overheating studies: (a) acoustic suspended ceiling — the concrete soffit
              is uncoupled from the room air, admittance to the room drops dramatically; (b) exposed
              soffit with acoustic baffles for speech intelligibility — the slab Y-value (~6 W/m²·K)
              damps the peak temperature swing. Compare the two against TM52 criteria. Recommend
              exposed-soffit + baffles, citing the night-cooling discharge route through openable
              high-level windows.
            </>
          }
          whyItMatters={
            <>
              A no-cooling school is a Department for Education preference for capex and opex
              reasons. Get the thermal-mass coupling wrong and the classroom overheats by lunchtime
              in late June, students can&rsquo;t concentrate, and the head teacher demands retrofit
              cooling. The admittance-method study is what decides this at design stage.
            </>
          }
        />
