        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm text-white">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    Quality installation: Reflects safety, compliance and professional competence.
                  </li>
                  <li>
                    Planning first: Assess routes, avoid conflicts, plan for future expansion.
                  </li>
                  <li>Professional finish: Straight runs, consistent spacing, proper alignment.</li>
                  <li>
                    Future-proofing: 25-30% spare capacity, accessible design, maintainable systems.
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    <strong>Spot:</strong> Neat, level containment with consistent spacing and
                    proper protection.
                  </li>
                  <li>
                    <strong>Use:</strong> Plan routes, separate cable types, allow spare capacity,
                    ensure access.
                  </li>
                  <li>
                    <strong>Check:</strong> Alignment, spacing, protection, separation, future
                    accessibility.
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm text-white">
              ...
              <li>
                Apply correct spacing, alignment, and routing techniques for professional
                installation quality.
              </li>
              <li>
                Identify methods for separating and protecting different cable types within
                containment systems.
              </li>
              <li>
                Recognise the importance of future-proofing in containment design and capacity
                planning.
              </li>
              <li>
                Implement accessibility and maintenance considerations in containment layout and
                design.
              </li>
            </ul>
          </section>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-4 bg-white/5 border border-white/10">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-white">
                  ...
                  <li>
                    Inspection passes more easily when work appears professional and considered
                  </li>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-4 bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-white">
                  ...
                  <li>
                    <strong>Consistent spacing:</strong> Follow manufacturer and BS 7671
                    recommendations
                  </li>
                  <li>
                    <strong>Smooth bends:</strong> Maintain minimum bend radius to prevent cable
                    damage
                  </li>
                  <li>
                    <strong>Level installation:</strong> +/-2mm tolerance over 3m for professional
                    appearance
                  </li>
                  <li>
                    <strong>Parallel runs:</strong> Maintain consistent separation between multiple
                    systems
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-lg p-4 bg-violet-500/10 border border-violet-400/30">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-violet-200">
                  <li>
                    <strong>Power/data separation:</strong> Use barriers or separate compartments
                  </li>
                  <li>
                    <strong>Minimum distances:</strong> 50mm separation or screened cables where
                    required
                  </li>
                  <li>
                    <strong>Entry/exit protection:</strong> Grommets and bushes at all sharp edges
                  </li>
                  <li>
                    <strong>Support spacing:</strong> Prevent cable stress and maintain insulation
                    integrity
                  </li>
                  <li>
                    <strong>Environmental protection:</strong> Select appropriate materials for
                    conditions
                  </li>
                </ul>
              </div>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-4 bg-white/5 border border-white/10">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-white">
                  ...
                  <li>
                    <strong>Poor route selection:</strong> Creating unnecessarily long or difficult
                    cable runs
                  </li>
                  <li>
                    <strong>Ignoring other trades:</strong> Creating conflicts requiring expensive
                    rectification
                  </li>
                  <li>
                    <strong>No expansion provision:</strong> Making future modifications difficult
                    or impossible
                  </li>
                  <li>
                    <strong>Inadequate documentation:</strong> Leaving no record of installation
                    details
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-lg p-4 bg-white/5 border border-amber-400/30">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-white">
                  ...
                  <li>
                    <strong>Incorrect spacing:</strong> Inadequate support leading to stress and
                    potential failure
                  </li>
                  <li>
                    <strong>Missing protection:</strong> Sharp edges damaging cables during
                    installation or service
                  </li>
                  <li>
                    <strong>Overfilling containment:</strong> Restricting heat dissipation and
                    making additions impossible
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-4 bg-white/5 border border-white/10">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-white">
                  ...
                  <li>
                    <strong>521.10:</strong> Cable support and spacing requirements
                  </li>
                  <li>
                    <strong>528:</strong> Proximity of wiring systems to other services
                  </li>
                  <li>
                    <strong>527:</strong> Current-carrying capacity and cable grouping factors
                  </li>
                  <li>
                    <strong>543:</strong> Protective conductor requirements and earthing
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-lg p-4 bg-white/5 border border-green-400/30">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-white">
                  ...
                  <li>
                    Compliance demonstrates understanding of safety and regulatory requirements
                  </li>
          ...
          <section className="mb-10">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <div className="space-y-3 text-sm text-white">
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    <strong>Planning</strong> prevents conflicts, ensures adequate capacity and
                    enables future modifications
                  </li>
                  <li>
                    <strong>Quality installation</strong> reflects professional competency and
                    facilitates inspection and maintenance
                  </li>
                  <li>
                    <strong>Cable separation</strong> prevents interference and ensures system
                    reliability and performance
                  </li>
                  <li>
                    <strong>Future-proofing</strong> with 25-30% spare capacity avoids expensive
                    system replacements
                  </li>
                  <li>
                    <strong>Accessibility</strong> design enables effective testing, maintenance and
                    fault finding
                  </li>
                </ul>
                <p>
                  Professional containment installation stands the test of time, providing safe,
                  compliant and maintainable electrical systems that meet both current needs and
                  future requirements.
                </p>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="mt-4 p-3 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30">
              <p className="text-yellow-200 text-xs">
                <strong>Quality checklist:</strong> Plan first, straight runs, 25-30% spare
                capacity, separate power/data, protect edges, ensure access. Quality reflects
                competency!
              </p>
            </div>
          </section>
