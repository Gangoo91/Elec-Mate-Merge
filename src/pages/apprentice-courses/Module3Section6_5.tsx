      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <section className="mb-10">
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-elec-yellow mb-3">Risk Mitigation Through Identification</h5>
                  ...
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    <thead>
                      <tr className="">
                        ...
                        <th className="border border-white/10 p-3 text-left">% of Electrical Accidents</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">Clear circuit schedules and labelling</td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">Mixed voltage confusion</td>
                        <td className="border border-white/10 p-3">20%</td>
                        <td className="border border-white/10 p-3">Inadequate voltage identification</td>
                        <td className="border border-white/10 p-3">Voltage warning notices and colour coding</td>
                      </tr>
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">Standardised conductor identification</td>
                      </tr>
                      <tr className="bg-muted/5">
                        ...
                        <td className="border border-white/10 p-3">Clear isolation point marking</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              <h4 className="font-medium text-white mb-3">Mandatory Labelling and Notice Requirements</h4>
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-elec-yellow mb-3">Circuit Information and Schedules</h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h6 className="font-medium text-white mb-2">Consumer Unit Requirements (Section 514)</h6>
                    <ul className="space-y-1 text-sm">
              ...
              <div className="p-4 bg-transparent border border-green-400/30 rounded-lg mb-4">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    <thead>
                      <tr className="">
                        <th className="border border-white/10 p-3 text-left">Warning Notice Type</th>
                        <th className="border border-white/10 p-3 text-left">BS 7671 Requirement</th>
                        <th className="border border-white/10 p-3 text-left">Required Text/Content</th>
                        <th className="border border-white/10 p-3 text-left">Location</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="border border-white/10 p-3"><strong>Dual Supply</strong></td>
                        <td className="border border-white/10 p-3">Regulation 514.15.1</td>
                        <td className="border border-white/10 p-3">"Warning: Dual Supply" + isolation requirements</td>
                        <td className="border border-white/10 p-3">All switch positions for both supplies</td>
                      </tr>
                      <tr className="bg-muted/5">
                        ...
                        <td className="border border-white/10 p-3">"This installation has RCD protection"</td>
                        <td className="border border-white/10 p-3">Consumer unit if not all circuits RCD protected</td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3"><strong>Isolation Points</strong></td>
                        <td className="border border-white/10 p-3">Regulation 514.11.1</td>
                        <td className="border border-white/10 p-3">Clear marking of isolation function</td>
                        <td className="border border-white/10 p-3">All main isolation and switching points</td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3"><strong>Mixed Wiring Colours</strong></td>
                        <td className="border border-white/10 p-3">Regulation 514.14.1</td>
                        <td className="border border-white/10 p-3">"Caution: This installation has wiring colours to two standards"</td>
                        <td className="border border-white/10 p-3">Consumer unit/distribution board</td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3"><strong>Photovoltaic Installation</strong></td>
                        <td className="border border-white/10 p-3">Section 712</td>
                        <td className="border border-white/10 p-3">PV system warnings and isolation procedures</td>
                        <td className="border border-white/10 p-3">DC and AC isolation points</td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3"><strong>Periodic Inspection</strong></td>
                        ...
                        <td className="border border-white/10 p-3">Consumer unit/main distribution board</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg">
                <h5 className="font-medium text-elec-yellow mb-3">Label Durability and Legibility Requirements</h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
                  ...
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-white/10 p-3 text-green-600">Low confusion risk</td>
                      </tr>
                      <tr className="bg-muted/5">
                        ...
                        <td className="border border-white/10 p-3 text-red-600">HIGH: Black now L2 in 3-phase</td>
                      </tr>
                      <tr>
                      ...
                      <tr className="bg-muted/5">
                        ...
                        <td className="border border-white/10 p-3">Black</td>
                        <td className="border border-white/10 p-3 text-amber-600">Medium confusion risk</td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3">Three-phase L3</td>
                        <td className="border border-white/10 p-3">Blue</td>
                        <td className="border border-white/10 p-3">Grey</td>
                        <td className="border border-white/10 p-3 text-red-600">HIGH: Blue now neutral</td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">Neutral</td>
                        <td className="border border-white/10 p-3">Black</td>
                        <td className="border border-white/10 p-3">Blue</td>
                        <td className="border border-white/10 p-3 text-red-600">CRITICAL: Major safety risk</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg">
                <h5 className="font-medium text-elec-yellow mb-3">Mixed Colour Code Safety Procedures</h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
          ...
          <div className="mb-2">
            ...
            <div className="mb-6">
              <h4 className="font-medium text-white mb-3">Material Selection for Different Environments</h4>
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg">
                <h5 className="font-medium text-elec-yellow mb-3">Environmental Selection Criteria</h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">Q: Do I have to relabel old wiring to new colours?</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">Q: Can I handwrite circuit IDs on masking tape?</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">Q: Are cable markers mandatory for every cable?</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">Q: What size should text be on electrical labels?</h3>
              <p className="text-xs sm:text-sm text-white">
