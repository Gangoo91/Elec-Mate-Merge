...
const AM2Module4Section6 = () => {
  ...
  const quickCheckQuestions: Array<{
    ...
    },
    {
      ...
      options: ['Continuity test', 'RCD test', 'Polarity test', 'Earth fault loop test'],
      correctIndex: 0,
      explanation:
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['50-60 minutes', '10-20 minutes', 'No specific time needed', '30-40 minutes'],
      correctAnswer: 3,
      explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Inspection and testing in AM2 is heavily time-pressured. You'll have around 3.5 hours to
          complete the full sequence of tests and fill in all paperwork. Poor pacing means
          incomplete results, rushed certificates, or unsafe shortcuts.
        </p>
        ...
        >
          <p>
            ...
            procedure and paperwork. Running out of time = incomplete tests, missing results, blank
            certificates. Rushing = unsafe shortcuts, missed steps, "book answers". Incomplete
            paperwork can drag strong candidates below pass threshold.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The reg that ties testing to paperwork. Reg 644.4 makes it clear: the test results AND
              the certificate together are the deliverable. On AM2 day, running out of time on the
              certificate is the same as not finishing the test — Reg 644.4 isn't satisfied without
              both. That's why "30-40 minutes for paperwork" gets its own time block.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              <strong>Top 5 Time Management Failures:</strong> 1. Spending too long setting up first
              tests — panicking later. 2. Not recording results as they go — trying to write
        ...
        >
          <p>
            <strong>What Assessors Want to See:</strong> Work steady and systematic — no shortcuts.
            Talk through what you are doing (shows confidence and keeps you focused). Record results
            circuit-by-circuit, not all at the end. Leave circuits safe if incomplete. Unsafe =
            fail.
          </p>
          <p>
            <strong>Professional Qualities Demonstrated:</strong> Methodical approach under
            pressure. Clear communication and commentary. Organised documentation practices. Safety
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              and external influences. On AM2 day this matters because the recommended interval you
              write on the EIC under Reg 644.4 has to be defensible — you can't just guess. Domestic
              dwellings: typically 10 years. Commercial: 5 years. Industrial / harsher environments:
              3 years or shorter. Match the figure on the EIC to the figure on the periodic
              inspection notice (Reg 514.12.1).
            </>
          }
        ...
        >
          ...
          <p>
            <strong>Recording Strategies:</strong> Record immediately: Enter values as you test, not
            afterwards. Work cleanly: Avoid wasted time untangling leads. Clear handwriting:
        ...
        >
          ...
          <p>
            <strong>Example 3: Methodical Success.</strong> Candidate kept to time blocks, recorded
            as they went, talked through each stage clearly. Completed all tests and paperwork on
            time — pass. Success factor: Disciplined time management and immediate recording.
          </p>
          <p>
        ...
        >
          <p>
            ...
            up test equipment systematically in logical order. Check all instruments are calibrated
            and functioning. Organise test leads and accessories within easy reach. Review circuit
            schedules and understand the installation layout. Plan your testing sequence based on
        ...
        >
          ...
          <p>
            <strong>Problem: Unexpected circuit complexities.</strong> Solution: Spend adequate time
            on visual inspection to understand the installation layout fully.
          </p>
          <p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You're 40 minutes in. Continuity tests done in 25 minutes (the time block was 40-50).
              You skip ahead — IR, polarity, Ze — all rushed. Numbers look right at a glance. You
              hit live testing, push the 1×IΔn RCD button, get a 12 ms result. Looks good. You move
              on. Two hours later when you sit down for paperwork, you realise you missed two
              circuits' R1+R2 readings entirely and one IR was at the wrong test voltage.
            </>
          }
          doInstead={
            <>
              Hit your time targets, but don't run under them. The 40-50 minute continuity block
              exists because that's how long thorough continuity testing actually takes — end-to-end
              ring tests, R1+R2 at every accessory on radial circuits, nullified leads, values
              logged in the schedule. Banking time at the start by skipping steps means going back
              to refill the schedule from memory. Memory is wrong.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You watched a YouTube walkthrough from 2022. The presenter ran 5×IΔn RCD tests as part
              of his time budget. You allocate that same time block. On the day you're following
              A4:2026 (no 5×IΔn) so the RCD slot finishes faster — but you've allocated the slow
              time AND you spend extra minutes second-guessing whether you should be running 5× too.
              Net effect: confusion, wasted minutes, weak documentation.
            </>
          }
          doInstead={
            <>
              Plan from the A4:2026 routine: continuity → ring continuity → IR (500 V DC, ≥1 MΩ) →
              polarity → Ze (TT: earth electrode) → energise → Zs → PFC → RCD (single 1×IΔn AC test
              + manual button) → phase sequence (3-ph only) → functional. The RCD block is shorter
              under A4:2026. Use the saved time on paperwork — that's where most marks are lost.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Slow down deliberately. The RCD test is fast — single AC test at 1×IΔn + manual button
              per RCBO. Three of them = about 6 minutes if you're methodical. Do them one at a time,
              write the trip time straight onto the schedule (don't try to remember three figures).
              That leaves you 14 minutes for the EIC header + schedule of inspections + signatures.
              If something goes wrong on a trip test, RECORD THE FIGURE — you'd rather hand in a
              complete schedule with one non-compliant RCD than a half-blank schedule that suggests
              you ran out of time.
            </>
          }
          whyItMatters={
