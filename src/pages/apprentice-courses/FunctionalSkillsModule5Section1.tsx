      ...
      <div className="sticky top-0 z-10 bg-elec-dark/95 backdrop-blur-sm border-b border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-base font-bold text-white">Level 1 Functional Skills Practice</h1>
          </div>
        </div>
      </div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              to real-world situations — exactly the kind of tasks you encounter on site as an
              electrical apprentice.
            </p>
            <p>
              As part of your apprenticeship framework, you must achieve at least Level 1 in both
              Maths and English before your End-Point Assessment (EPA). Many employers and training
              providers require Level 2, but Level 1 is the minimum gateway qualification. If you
              already hold a GCSE grade 4 or above, you may be exempt — check with your training
              provider.
            </p>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                using these skills daily.
              </p>
            </div>

            <p>
              The main awarding bodies for Functional Skills are City & Guilds, Pearson (Edexcel),
              NCFE, and Open Awards. Whilst the format may vary slightly between boards, the content
              standards are set by Ofqual and remain consistent across all providers. Your training
              centre will confirm which board you are sitting.
            </p>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Maths:</strong> Whole numbers, fractions, decimals,
                  percentages, ratio, measurement, shape, space, and basic data handling
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">English:</strong> Reading comprehension, writing
                  for purpose, spelling, punctuation, and grammar (SPaG)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">ICT / Digital Skills:</strong> Using software to
                  create documents, spreadsheets, and presentations fit for purpose
                </span>
              </li>
            </ul>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  Apprentices who do not yet hold a GCSE grade 4 (C) or above in Maths or English
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  Anyone wanting to progress to Level 2 Functional Skills as a stepping stone
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
            ...
            <p>
              Each subject is assessed independently. You can pass them in any order and at
              different times. If you fail one, you only need to resit that particular subject —
              your passes in the other subjects are retained indefinitely.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              timings can vary by awarding body.
            </p>
                ...
                <div className="bg-white/5 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 text-xs text-white/70">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>
                        Questions on addition, subtraction, multiplication, division, fractions, and
                        simple percentages
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                ...
                <div className="bg-white/5 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 text-xs text-white/70">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>
                        Covers measurement, ratio, proportion, area, perimeter, and data
                        interpretation
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
            ...
            <p>
              The pass mark is typically around 60-65%, though this can vary between sittings as
              awarding bodies adjust for difficulty. You are expected to show your working — even if
              your final answer is wrong, you can pick up method marks for demonstrating the correct
              approach.
            </p>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Number:</strong> Whole numbers up to 1,000,000;
                  decimals to 2 decimal places; fractions (halves, quarters, thirds, fifths,
                  tenths); percentages (10%, 25%, 50%, 75%)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Measures:</strong> Length (mm, cm, m, km), weight
                  (g, kg), capacity (ml, l), time (12-hour and 24-hour), temperature, and currency
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Shape and Space:</strong> Perimeter, area of
                  rectangles and triangles, properties of 2D shapes, and simple scale drawings
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Data Handling:</strong> Reading tables, charts, and
                  simple graphs; calculating mean averages; understanding probability in simple
                  terms
                </span>
              </li>
            </ul>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              topic areas you will see in the exam.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <div className="bg-white/5 rounded-lg p-3 mt-2">
                ...
                <p className="text-xs text-white/70">
                  ...
                  <strong className="text-white">£68.00</strong>
                </p>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <div className="bg-white/5 rounded-lg p-3 mt-2">
                ...
                <p className="text-xs text-white/70">
                  ...
                  <br />
                  Round up (you cannot install 0.4 of a light) ={' '}
                  <strong className="text-white">9 downlighters</strong>
                </p>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <div className="bg-white/5 rounded-lg p-3 mt-2">
                ...
                <p className="text-xs text-white/70">
                  ...
                  <strong className="text-white">13 installations</strong>
                </p>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <div className="bg-white/5 rounded-lg p-3 mt-2">
                ...
                <p className="text-xs text-white/70">
                  ...
                  <strong className="text-white">2.75 metres</strong>
                </p>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                measurements, follow the instruction in the question.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              are externally assessed exams, while SLC is assessed internally by your training
              provider.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-xs text-white/70">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Duration:</strong> Approximately 45 minutes to 1
                    hour
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Format:</strong> You are given one or more texts
                    (letters, articles, notices, instructions, leaflets) and answer questions about
                    them
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Skills tested:</strong> Identifying main points,
                    extracting details, understanding purpose, comparing information, understanding
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Question types:</strong> Multiple choice, short
                    answer, and extended response (a few sentences)
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-xs text-white/70">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Format:</strong> You complete one or two writing
                    tasks such as writing a letter, email, report, or article
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Skills tested:</strong> Writing clearly and
                    coherently, correct spelling, grammar and punctuation, using appropriate tone
                    and format
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Length:</strong> Typically 150-250 words per
                    task, though there is no strict word limit
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-xs text-white/70">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Format:</strong> Assessed by your tutor, often
                    through a group discussion or short presentation
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Skills tested:</strong> Taking part in
                    discussions, making relevant contributions, listening to others, presenting
                    information clearly
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Tip:</strong> This is often the easiest component
                    — you are assessed on everyday communication skills you already use on site with
                    colleagues
                  </span>
                </li>
              </ul>
            ...
            <p>
              Most reading questions are worth 1-2 marks. For 1-mark questions, a brief, accurate
              answer is sufficient. For 2-mark questions, you need to provide evidence from the text
              or give two distinct points. Always refer back to the text provided — do not rely
              solely on your own background knowledge.
            </p>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                errors will score higher than a disorganised one that is technically perfect.
              </p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <div className="bg-white/5 rounded-lg p-3 text-xs text-white/70 italic">
                <p className="mb-2">
                  ...
                  requiring isolation of the main supply must be agreed with the building manager at
                  least 24 hours in advance. Failure to comply may result in removal from site."
                </p>
              </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <div className="bg-white/5 rounded-lg p-3 text-xs text-white/70 italic">
                ...
                <p className="mb-2">
                  ...
                  Riverside Development must now wear high-visibility vests at all times, including
                  inside the building. Hard hats remain compulsory in all areas where overhead work
                  is taking place. Safety boots must be worn throughout the site. Any operative
                  found without the correct PPE will be asked to leave site immediately. New PPE can
                  be collected from the site office between 07:00 and 08:00."
                </p>
              </div>
              <div className="space-y-2">
                <p className="text-sm text-white/80">
              ...
              <div className="bg-white/5 rounded-lg p-3 mt-2">
                ...
                <ul className="space-y-1 text-xs text-white/70">
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Opening:</strong> Dear [Name], I am writing to
                      inform you of a fault I have identified at [address]...
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Description:</strong> During my inspection of
                      the consumer unit, I noticed that the main switch shows signs of overheating
                      and discolouration...
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Action taken:</strong> I have isolated the
                      affected circuit and made the area safe. I have also informed the homeowner...
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Recommendation:</strong> I recommend that we
                      arrange for a full inspection and replacement of the consumer unit...
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Closing:</strong> Please let me know how you
                      would like to proceed. Kind regards, [Your name]
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">There / Their / They're:</strong> "There" = a
                  place; "Their" = belonging to them; "They're" = they are
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Your / You're:</strong> "Your" = belonging to you;
                  "You're" = you are
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Its / It's:</strong> "Its" = belonging to it;
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Affect / Effect:</strong> "Affect" = verb (to
                  influence); "Effect" = noun (the result)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">To / Too / Two:</strong> "To" = direction or
                  infinitive; "Too" = also or excessively; "Two" = the number 2
                </span>
              </li>
            </ul>
          </div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              effectively in realistic workplace scenarios. This is typically assessed through
              practical, computer-based tasks.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-xs text-white/70">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Duration:</strong> Approximately 2 hours for the
                    practical tasks
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Format:</strong> You are given a scenario and
                    must complete tasks using word processing, spreadsheet, and/or presentation
                    software
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Skills tested:</strong> Creating documents,
                    formatting text, using formulae in spreadsheets, inserting images, saving files
                    correctly
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Software:</strong> Usually Microsoft Office
                    (Word, Excel, PowerPoint) or equivalent applications
                  </span>
                </li>
              </ul>
            </div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Word Processing:</strong> Create a professional
                  document with headings, bullet points, tables, and appropriate formatting. Change
                  fonts, sizes, and colours. Use spell check effectively.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Spreadsheets:</strong> Enter data accurately, use
                  basic formulae (SUM, simple multiplication), format cells for currency or
                  percentages, create a simple chart or graph from data.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Email and Internet:</strong> Compose an email with
                  an appropriate subject line and tone, attach a file, use a search engine to find
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">File Management:</strong> Save files with sensible
                  names, organise into folders, understand common file types (.docx, .pdf, .xlsx,
                  .jpg).
                </span>
              </li>
            </ul>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                needs to see and present information accordingly.
              </p>
            </div>

            <h4 className="text-white font-semibold pt-2">Electrical Context Practice Tasks</h4>
            <p>
              In your assessment, tasks might include creating a material order form in a
              spreadsheet, writing a professional letter to a customer about upcoming work, or
              producing a short safety briefing document. Practise creating these kinds of workplace
              documents regularly so they feel natural.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 mt-2">
              ...
              <p className="text-xs text-white/70">
                ...
                at the bottom. Format the header row in bold with a coloured background. Save the
                file as "Material_Order_[date].xlsx".
              </p>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 mt-2">
              ...
              <p className="text-xs text-white/70">
                ...
                formatting including bold for the subject line and correct paragraph spacing.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              attempt every question and maximise your overall score.
            </p>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Read all instructions:</strong> Spend the first 2-3
                  minutes reading through the entire paper. Note how many questions there are and
                  their mark values.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Identify quick wins:</strong> Spot questions you
                  find easy and ensure you attempt them first or set aside time for them.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Note time checkpoints:</strong> Write down when you
                  should be starting each section (e.g., "Section B by 10:30").
                </span>
              </li>
            </ul>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Do not get stuck:</strong> If a question is taking
                  too long (more than 3 minutes on a 2-mark question), write what you can and move
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Answer the question asked:</strong> Read the
                  question twice. Underline the command word (calculate, explain, describe,
                  identify, compare).
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Show your working:</strong> Even a wrong answer
                  with the correct method can earn marks in maths.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Check the clock:</strong> Glance at the time every
                  15 minutes to ensure you are on track with your time plan.
                </span>
              </li>
            </ul>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="bg-white/5 rounded-lg p-3">
                ...
                <ul className="text-xs text-white/70 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>Calculator: ~2-3 min per question</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>Final checking: 5-10 minutes</span>
                  </li>
                </ul>
              </div>
              <div className="bg-white/5 rounded-lg p-3">
                ...
                <ul className="text-xs text-white/70 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>Writing task: 30-35 minutes total</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>Final checking: 5 minutes</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  Check your answers for obvious errors (wrong units, decimal point in wrong place)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  Re-read writing tasks for spelling and grammar errors you can quickly correct
                </span>
              </li>
            </ul>
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <ul className="space-y-2 text-xs text-white/70">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Not showing working:</strong> Even if the answer
                    is correct, you lose method marks without working shown. This is the single most
                    common reason for lost marks.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Forgetting units:</strong> Always include units
                    in your answer (m, m², kg, £). An answer of "14.4" without "m²" may lose you a
                    mark.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Misreading the question:</strong> "Calculate the
                    perimeter" is not the same as "calculate the area." Underline the command word
                    before you start.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Decimal errors:</strong> Double-check decimal
                    point placement. £12.80 is very different from £128.00 or £1.28.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Not checking reasonableness:</strong> Does your
                    answer make sense? If a cable costs £2.45 per metre, 12 metres should not cost
                    £2,940.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Rounding too early:</strong> Keep full decimal
                    values throughout your calculation and only round at the final step.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <ul className="space-y-2 text-xs text-white/70">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Not planning writing tasks:</strong> Jumping
                    straight into writing often leads to rambling, disorganised responses. Spend 3-5
                    minutes planning your structure.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Wrong tone or format:</strong> A formal letter
                    requires "Dear Sir/Madam" and "Yours faithfully," not "Hi mate." Always match
                    your tone to the audience specified.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Not using paragraphs:</strong> A solid block of
                    text is hard to read and shows poor organisation. Use a new paragraph for each
                    new point or idea.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Copying from the source text:</strong> In reading
                    exams, use your own words where possible. Direct copying shows you have found
                    the information but may not fully understand it.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Ignoring proofreading:</strong> Always re-read
                    your writing in the final minutes. Common errors like "their" instead of "there"
                    can be caught easily with a quick check.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <ul className="space-y-2 text-xs text-white/70">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Not saving regularly:</strong> Save your work
                    every few minutes using Ctrl+S. Losing your work to a crash is devastating and
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Wrong file format:</strong> If the task says
                    "save as PDF," do not submit a .docx file. Read the file format instructions
                    carefully.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Over-formatting:</strong> Using five different
                    fonts and rainbow colours makes your document look unprofessional. Keep
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Formula errors:</strong> In spreadsheets, check
                    your cell references. =A2*B2 is correct only if A2 and B2 contain the values you
                    intend to multiply.
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                you how much detail is expected in your answer.
              </p>
            </div>
