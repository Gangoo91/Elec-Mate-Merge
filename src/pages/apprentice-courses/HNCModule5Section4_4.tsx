      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Standards:</strong> BSRIA BG 55/56, CIBSE guides define quality benchmarks
              </li>
              <li className="pl-1">
                <strong>Supervision:</strong> 1:10 ratio for complex M&E work
              </li>
              <li className="pl-1">
                <strong>Verification:</strong> Progressive checks at key milestones
              </li>
              <li className="pl-1">
                <strong>Records:</strong> Photographic evidence of concealed work
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Walk-downs:</strong> Before ceiling/wall closure
              </li>
              <li className="pl-1">
                <strong>First-of-type:</strong> Approval before mass installation
              </li>
              <li className="pl-1">
                <strong>Checklists:</strong> Systematic inspection records
              </li>
              <li className="pl-1">
                <strong>Snagging:</strong> Defect tracking to completion
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                BSRIA Workmanship Assessment Approach
              </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Level, aligned, consistent fixings, proper joints
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Sagging, misaligned, mixed fixing types
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Conduit bends</td>
                      <td className="border border-white/10 px-3 py-2">
                        Smooth radius, no kinks, consistent spacing
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Kinked, varying radii, uneven fixing centres
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Accessory mounting</td>
                      <td className="border border-white/10 px-3 py-2">
                        Level, secure, consistent heights, correct orientation
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Crooked, loose, varying heights across room
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Cable terminations</td>
                      <td className="border border-white/10 px-3 py-2">
                        Correct torque, neat dressing, proper identification
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Over/under-tightened, untidy, missing labels
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Distribution boards</td>
                      <td className="border border-white/10 px-3 py-2">
                        Tidy wiring, clear labelling, circuits identified
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Tangled cables, illegible labels, unknown circuits
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Supervisor Competence Requirements
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        NVQ Level 3 / AM2, relevant trade background
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Review drawings, specs, previous snags
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Systematic area-by-area review
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Defect notes, photographs
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Documentation</td>
                      <td className="border border-white/10 px-3 py-2">
                        Complete snagging list, categorise items
                      </td>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Electrical Installation Checklist Elements
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Type correct, fixing centres, level/plumb, earthing continuity, fire
                        barriers
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Type/CSA per schedule, bend radii, segregation, identification, damage-free
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Distribution boards</td>
                      <td className="border border-white/10 px-3 py-2">
                        Location correct, mounting height, labelling, circuit schedules, spare ways
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Accessories</td>
                      <td className="border border-white/10 px-3 py-2">
                        Height/position, type correct, fixing secure, level, no damage
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Terminations</td>
                      <td className="border border-white/10 px-3 py-2">
                        Correct terminals, torque verified, insulation intact, dressing neat
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Luminaires</td>
                      <td className="border border-white/10 px-3 py-2">
                        Position per drawing, suspension secure, emergency function, lamp type
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                First-of-Type Approval Process
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Supervision Planning
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Quality Inspection Sampling
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-green-400">
                  Answer: 50 formal inspections plus first-of-type approval
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Quality Walk-Down Checklist
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Review specification and approved drawings before walk-down
                </li>
