...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Q = V × I', 'Q = U × A × ΔT', 'Q = 0.33 × n × V × ΔT', 'Q = P × t'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['-1°C to -4°C', '0°C', '+5°C', '-10°C'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['0.50 Wh/m³K', '0.25 Wh/m³K', '1.00 Wh/m³K', '0.33 Wh/m³K'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['7.0kW', '7.5kW', '9.2kW', '8.05kW'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['1.0 ACH', '1.5 ACH', '0.5 ACH', '2.0 ACH'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['External wall', 'Windows', 'Floor', 'Roof'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.35 W/m²K', '0.26 W/m²K', '0.15 W/m²K', '0.18 W/m²K'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['16.9kW', '17.8kW', '13.4kW', '15.0kW'],
    correctAnswer: 0,
    explanation:
...
const HNCModule2Section1_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 1 · Subsection 6"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              CIBSE&rsquo;s Domestic Heating Design Guide and Guide A apply the same physics with
              UK-specific data. As an HNC engineer your output (kW per room, kW per building) drives
              every downstream sizing decision.
            </>
          }
        ...
        >
          <p>
            Fabric heat loss occurs through the building envelope - walls, roof, floor, windows and
            doors. It is the primary heat loss mechanism in most buildings and is directly related
            to the insulation quality (U-value) and surface area of each element.
          </p>
          <p>
          ...
          <p>
            <strong>
              Typical U-values (Building Regulations Part L 2021) — new build / existing refurb /
          ...
          <p>
            <strong>Remember:</strong> Windows typically have U-values 5-10 times higher than modern
            walls, making them the weakest thermal element despite their smaller area.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Ventilation heat loss occurs when warm indoor air is replaced by cold outdoor air. This
            happens through both controlled ventilation (windows, vents, MVHR) and uncontrolled
            infiltration (gaps, cracks, service penetrations).
          </p>
          <p>
            <strong>Formula:</strong> Q = 0.33 × n × V × ΔT. Q = heat loss (W), 0.33 = volumetric
            specific heat of air (Wh/m³K), n = air changes per hour (ACH), V = room volume (m³), ΔT
          ...
          <p>
            ...
            mechanical ventilation with heat recovery (MVHR) can recover 80-90% of heat from exhaust
            air.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>Calculating temperature difference (ΔT):</strong> ΔT = ti - te. Example - office
            in Manchester: internal 22°C, external -3°C. ΔT = 22 - (-3) = <strong>25K</strong>.
          </p>
          <p>
            <strong>CIBSE basis:</strong> External design temperatures are based on the temperature
            exceeded for 99.6% of the year (i.e., only colder for approximately 35 hours annually).
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>Total heat load formula:</strong> Qtotal = Qfabric + Qventilation. Add margins
            for pre-heat (10-20%) and distribution losses (5-10%).
          </p>
          <p>
        ...
        >
          <p>
            <strong>Example 1 - room fabric heat loss:</strong> Living room with: external wall 12m²
            (U=0.3), window 4m² (U=1.4), floor 20m² (U=0.2), ceiling 20m² (U=0.15). Internal 21°C,
            external -3°C.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>ΔT = 21 - (-3) = 24K</li>
            ...
            <li>
              Total fabric loss = <strong>388.8W</strong>
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>ΔT = 24K</li>
            <li>
              Q = 0.33 × 1.0 × 48 × 24 = <strong>380.2W</strong>
            </li>
            <li>Ventilation loss is almost equal to fabric loss in this example</li>
          </ul>
          <p>
            <strong>Example 3 - total room heat load with margin:</strong> Total heat loss = fabric
            + ventilation = 388.8 + 380.2 = 769W. With 10% margin = 769 × 1.10 =
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Recommended: <strong>12-15kW combi boiler</strong> (or 9-10kW system boiler with
        ...
        <Scenario
          ...
          situation={
            <>
              The customer wants an ASHP retrofit for a 3-bed Victorian terrace. The existing gas
              boiler is 24 kW. They have read online that ASHP needs to be sized to 80% of boiler
              capacity.
            </>
          }
          whatToDo={
            <>
              Reject the rule of thumb. Run a room-by-room heat loss to BS EN 12831 with the actual
              U-values of the as-built fabric (likely 1.5-2.5 W/m²·K for solid brick walls, 5+ for
              single glazing). Use design external temperature for the location (-3 °C London, -5 °C
              Birmingham, -8 °C Glasgow per CIBSE). Sum the room loads. Compare against ASHP
              performance at the design ambient (de-rated from nameplate). Likely outcome: 8-12 kW
              heat pump matched to the actual load is realistic. The 24 kW boiler was massively
              oversized.
            </>
          }
          whyItMatters={
            <>
              Oversized ASHPs cycle, lose efficiency and shorten compressor life. Right-sizing from
              a proper heat-loss calculation is the single biggest factor in retrofit success.
            </>
          }
        />
