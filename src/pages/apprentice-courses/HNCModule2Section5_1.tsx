...
const quickCheckQuestions = [
  {
    ...
    options: ['2000 W/m²', '1367 W/m²', '1000 W/m²', '500 W/m²'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['10-20%', 'Nearly 100%', '30-40%', '50-60%'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['600-700 W/m²', '400-500 W/m²', '1000-1100 W/m²', '800-900 W/m²'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Winter midday', 'Summer midday', 'Spring/autumn equinox', 'Summer morning/evening'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['AM 1.5', 'AM 2.0', 'AM 3.0', 'AM 1.0'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['50-55%', '80-85%', '65-70%', '90-95%'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.15-0.25', '0.70-0.80', '0.55-0.65', '0.30-0.45'],
    correctAnswer: 3,
    explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/h-n-c-module2-section5"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE Guide A is the canonical UK source for design irradiance. As HNC engineer you
              cite it on the load schedule so the architect, BREEAM assessor and PV/solar-thermal
              sub-contractor are all working from the same numbers.
            </>
          }
        ...
        >
          <p>
            ...
            calculating solar heat gains. The sun's position is defined by two angles measured from
            any point on Earth.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Hour angle (ω):</strong> Angular displacement of sun from solar noon (15° per
              hour)
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              21 June (Summer): noon altitude 62°, sunrise/sunset 04:43 / 21:21, day length 16h 38m
            </li>
            <li>
              21 March/Sept (Equinox): noon altitude 38.5°, sunrise/sunset 06:00 / 18:00, day length
              12h 00m
            </li>
            <li>
              21 December (Winter): noon altitude 15°, sunrise/sunset 08:04 / 15:53, day length 7h
              49m
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Direct beam (Ib):</strong> Radiation arriving directly from the sun's disc in
              parallel rays
            </li>
            <li>
          ...
          <p>
            ...
            climates. This means north-facing glazing still receives significant radiation from the
            sky dome.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Direct and diffuse radiation behave differently on building surfaces. Understanding this
            distinction is crucial for accurate cooling load calculations and appropriate shading
            design.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Direction:</strong> Direct - from sun's disc only; Diffuse - from all sky
              directions
            </li>
            <li>
              <strong>Shading effectiveness:</strong> Direct - highly effective; Diffuse - limited
              effect
            </li>
            <li>
              <strong>Incidence angle effect:</strong> Direct - strong cosine relationship; Diffuse
              - minimal angle dependence
            </li>
            <li>
              <strong>Weather dependence:</strong> Direct - zero when overcast; Diffuse - always
              present (daylight)
            </li>
            <li>
              <strong>Shadow formation:</strong> Direct - creates sharp shadows; Diffuse - no
              shadows
            </li>
          </ul>
          <p>
            <strong>Irradiance on tilted surface:</strong> I_surface = I_bn × cos(θ) + I_d × F_sky +
            I_g × ρ × F_ground. Where θ = angle of incidence, F = view factors, ρ = ground
            reflectance (albedo).
          </p>
          <p>
        ...
        >
          <p>
            ...
            Understanding the factors affecting solar heat gain is essential for HVAC sizing and
            overheating prevention.
          </p>
          <p>
            <strong>Solar heat gain calculation:</strong> Q_solar = I × A × SHGC × F_frame ×
            F_shading. Where I = irradiance, A = glass area, SHGC = solar heat gain coefficient.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>SHGC (g-value):</strong> Fraction of incident solar energy entering as heat (0
              to 1)
            </li>
            <li>
            ...
            <li>
              <strong>Selectivity:</strong> Ratio of light to solar transmittance (τv/g) - higher is
              better
            </li>
            <li>
          ...
          <p>
            <strong>Part O consideration:</strong> Building Regulations Part O limits solar gains to
            prevent overheating. Maximum g-value limits apply to residential glazing based on
        ...
        >
          <p>
            <strong>Example 1 - Solar altitude calculation:</strong> Calculate the solar altitude at
            solar noon on 21st June in Birmingham (latitude 52.5°N).
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            20m² of solar control glazing (g-value 0.40, frame factor 0.75). Peak irradiance on the
            facade is 450 W/m². Calculate the solar heat gain.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 - Effect of external shading:</strong> The same window (Example 2) has
            external louvres installed with shading factor 0.15. What is the new solar gain?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 4 - Annual irradiation for PV sizing:</strong> A roof-mounted PV array
            in London faces south at 35° tilt. Annual irradiation is 1050 kWh/m². What energy yield
            can 20m² of panels (18% efficiency) produce?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A new mixed-use scheme has a 6-storey south-facing glass atrium (480 m² glazing,
              double-glazed g = 0.65). Early-stage cooling load is provisional; the architect is
              pushing back on external brise-soleil for aesthetic reasons. You need to quantify the
              no-shading penalty.
            </>
          }
          whatToDo={
            <>
              Pick July 21 12:00 noon as the design moment. Look up CIBSE Guide A direct and diffuse
              irradiance for vertical south-facing glazing at the site latitude (~51 °N). Compute
              solar gain Q = A × g × (Ib + Id). Repeat for 09:00 and 15:00 to capture the daily
              peak. Compare against the with-shading case (brise-soleil reducing direct beam by
              ~70%). Quote the cooling-coil upsize required to handle the no-shade case.
            </>
          }
          whyItMatters={
            <>
              Solar gain on a south facade can easily exceed the entire occupant + IT load. A
              no-shade decision driven by aesthetics costs the project a larger chiller, fatter
              ductwork, more electrical infrastructure and a worse EPC. CIBSE-grounded numbers turn
              the conversation from style preference into cost trade-off.
            </>
          }
        />
