...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['60 dB', '90 dB', '63 dB', '120 dB'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1500 m/s', '140 m/s', '343 m/s', '3000 m/s'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1.47 m', '0.34 m', '170 m', '0.68 m'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['20 μPa', '20 Pa', '1 Pa', '1 μPa'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['0.02 Pa', '1 Pa', '2 Pa', '0.002 Pa'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['68 dB', '60 dB', '74 dB', '72 dB'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['0.25 W/m²', '0.04 W/m²', '0.08 W/m²', '0.02 W/m²'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS 4142 is the UK reference for assessing whether plant noise is likely to generate
              complaint at the nearest residential receptor. As HNC engineer you use it for chiller,
              AHU and dry-cooler positioning, and to brief the acoustic consultant on attenuator
              selection.
            </>
          }
        ...
        >
          <p>
            Sound is a mechanical wave — a travelling disturbance in pressure, density, and particle
            velocity that propagates through an elastic medium. Unlike light, sound requires a
            medium (air, water, solids) and cannot travel through a vacuum.
          </p>
          <p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>1000 Hz:</strong> 0.34 m wavelength, mid-range (reference), standard test tone
            </li>
            <li>
              <strong>4000 Hz:</strong> 0.086 m wavelength, high (speech clarity), consonant sounds
            </li>
            <li>
          ...
          <p>
            <strong>Standard Octave Bands:</strong> Acoustic analysis uses octave bands with centre
            frequencies: 31.5 | 63 | 125 | 250 | 500 | 1k | 2k | 4k | 8k | 16k Hz. Each band covers
            frequencies from 0.707× to 1.414× the centre frequency.
          </p>
          <p>
        ...
        >
          ...
          <p>
            <strong>Perception:</strong> A 10 dB change sounds approximately twice or half as loud.
            A 3 dB change is the smallest difference most people can reliably detect.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Because decibels are logarithmic, they cannot be added arithmetically. Two 60 dB sources
            do not make 120 dB. Instead, we must convert to linear values (power or intensity), add,
            then convert back.
          </p>
          <p>
          ...
          <p>
            <strong>Inverse Square Law:</strong> L2 = L1 - 20 log₁₀(r2/r1). For point source in free
            field: each doubling of distance = -6 dB.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              This long wavelength explains why low frequency noise is hard to attenuate with thin
              barriers.
            </li>
          </ul>
          <p>
            <strong>Example 2: Adding Sound Sources.</strong> A plant room has three pumps producing
            72 dB(A), 70 dB(A), and 68 dB(A). What is the combined sound level?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Or precisely: 10 log(10^7.2 + 10^7.0 + 10^6.8) = 10 log(15.85×10⁶ + 10×10⁶ + 6.31×10⁶)
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              Three air-cooled chillers (each 92 dB(A) SWL at 1 m) are scheduled for the roof of a
              city-centre office. The nearest residential window is 35 m away. Local planning sets a
              5 dB margin above background (40 dB(A) night) — so the chiller contribution at the
              receptor must be ≤ 45 dB(A).
            </>
          }
          whatToDo={
            <>
              Sum the three chiller SWLs logarithmically: 92 + 10 log 3 ≈ 96.8 dB(A). Apply distance
              attenuation Lp = Lw − 20 log 35 − 11 ≈ 96.8 − 30.9 − 11 = 54.9 dB(A). That&rsquo;s 9.9
              dB above the limit. Specify acoustic louvres or a duct silencer with insertion loss ≥
              12 dB(A), or relocate plant 15 m further from the boundary, or both. Document the
              calculation in the BS 4142 assessment.
            </>
          }
          whyItMatters={
            <>
              A planning condition breach means a Section 80 abatement notice, possible enforcement
              action, and an emergency attenuator install at the contractor&rsquo;s cost. The
              dB-arithmetic done at design stage is what stops a six-figure rework bill.
            </>
          }
        />
