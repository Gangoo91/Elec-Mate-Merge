...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Around 10%', 'Around 25%', 'Around 60%', 'Around 40%'],
    correctAnswer: 3,
    explanation:
...
const HNCModule6Section4_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 4 · Subsection 6"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The UK Net Zero Carbon Buildings Standard (2024 pilot, full release expected) is the
              first cross-industry-agreed UK definition of a net-zero building. It is
              performance-based (measured EUI, measured embodied carbon) — design intent statements
              alone do not qualify. Annual re-verification ties net-zero to operational reality, not
              handover-day modelling.
            </>
          }
        ...
        <ConceptBlock title="Net-Zero Definitions and Context">
          ...
          <p>
            <strong>Key definitions in net-zero terminology:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Net-zero carbon:</strong> Emissions reduced to minimum, residual balanced by
              verified offsets
            </li>
            <li>
              <strong>Net-zero operational carbon:</strong> Zero net emissions from building energy
              use
            </li>
            <li>
              <strong>Net-zero whole-life carbon:</strong> Includes operational and embodied carbon
              over building lifecycle
            </li>
            <li>
              <strong>Carbon neutral:</strong> May rely more heavily on offsetting without
              prioritising reductions
            </li>
          </ul>
          <p>
            <strong>UK Climate Policy Context</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2019 Amendment:</strong> Net-zero by 2050 (legally binding) — All sectors must
              decarbonise
            </li>
            <li>
              <strong>Sixth Carbon Budget:</strong> 78% reduction by 2035 (vs 1990) — Building
              sector transformation required
            </li>
            <li>
              <strong>Future Homes Standard:</strong> 75-80% carbon reduction (new homes) — No
              fossil fuel heating in new homes
            </li>
            <li>
              <strong>Part L 2021:</strong> 31% improvement (homes), 27% (non-domestic) — Stepping
              stone to net-zero
            </li>
          </ul>
          <p>
            <strong>Critical point:</strong> Buildings account for approximately 40% of UK carbon
            emissions - decarbonising the built environment is essential to achieving national
            net-zero targets.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="The Carbon Reduction Hierarchy">
          <p>
            ...
            the most effective and permanent measures are implemented before resorting to
            offsetting. This hierarchy is fundamental to credible net-zero pathways.
          </p>
          <p>
          ...
          <p>
            <strong>Applying the Hierarchy to Building Services</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Avoid:</strong> Reduce heat loss through fabric — Maximise daylight
              penetration
            </li>
            <li>
              <strong>Reduce:</strong> Optimise heating setpoints/schedules — Install
              presence/daylight sensors
            </li>
            <li>
              <strong>Replace:</strong> Install heat pump instead of boiler — Upgrade to
              high-efficacy LEDs
            </li>
            <li>
              <strong>Offset:</strong> Purchase offsets for residual gas — Offset grid carbon factor
            </li>
          </ul>
          <p>
            <strong>Best practice:</strong> Each level of the hierarchy should be exhausted before
            moving to the next. Offsets are a last resort, not a first choice.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Pathway Development and Technology Options">
          ...
          <p>
            <strong>Pathway Development Steps</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Baseline assessment:</strong> Comprehensive audit of current energy use and
              emissions
            </li>
            <li>
              <strong>Target setting:</strong> Define end goal (net-zero by date) and interim
              milestones
            </li>
            <li>
              <strong>Gap analysis:</strong> Identify what must change to bridge baseline to target
            </li>
            <li>
              <strong>Measure identification:</strong> List all potential interventions with costs
              and impacts
            </li>
            <li>
              <strong>Prioritisation:</strong> Sequence measures using hierarchy and lifecycle
              alignment
            </li>
            <li>
              <strong>Financial planning:</strong> Develop investment plan and funding strategy
            </li>
            <li>
              <strong>Implementation:</strong> Execute measures according to roadmap
            </li>
            <li>
              <strong>Monitoring:</strong> Track progress and adjust pathway as needed
            </li>
          </ul>
          <p>
            <strong>Technology Options for Building Decarbonisation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Air source heat pump:</strong> Space heating/cooling — 60-80% vs gas boiler —
              Requires electrical upgrade
            </li>
            <li>
              <strong>Ground source heat pump:</strong> Heating/cooling (larger buildings) — 65-85%
              vs gas boiler — Higher COP, needs ground works
            </li>
            <li>
              <strong>LED lighting:</strong> All lighting applications — 50-70% vs fluorescent —
              Quick payback, no barriers
            </li>
            <li>
              <strong>Building management system:</strong> Controls optimisation — 10-30% across
              systems — Needs ongoing commissioning
            </li>
            <li>
              <strong>Solar PV:</strong> On-site electricity generation — Reduces grid dependence —
              Roof space, orientation needed
            </li>
            <li>
              <strong>Battery storage:</strong> Load shifting, PV optimisation — Enables higher
              renewable use — Adds cost, improves flexibility
            </li>
          </ul>
          <p>
            <strong>Example: Office Building Net-Zero Pathway</strong>
          </p>
          <p>
            <strong>Baseline (2024):</strong> 850 tonnes CO2/year (gas heating, standard lighting,
            grid electricity)
          </p>
          <p>
            <strong>2027 target:</strong> 600 tonnes (-30%) - LED retrofit, BMS upgrade, green
            tariff
          </p>
          <p>
            <strong>2030 target:</strong> 300 tonnes (-65%) - Heat pump installation, solar PV
          </p>
          <p>
            <strong>2035 target:</strong> 100 tonnes (-88%) - Additional efficiency, battery storage
          </p>
          <p>
            <strong>2040 target:</strong> Net-zero - Offset remaining 100 tonnes with verified
            removals
          </p>
          <p>
            <strong>Planning tip:</strong> Align major interventions with equipment replacement
            cycles (boilers typically 15-20 years) to avoid stranded assets and optimise whole-life
            costs.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Verification and Reporting Frameworks">
          <p>
            Credible net-zero claims require robust verification against recognised frameworks. The
            UKGBC Net Zero Carbon Buildings Framework provides the primary industry standard for the
            UK built environment, ensuring consistency and preventing greenwashing.
          </p>
          <p>
            <strong>UKGBC Net Zero Carbon Buildings Framework</strong>
          </p>
          <p>
            <strong>Net-Zero Construction</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Net-Zero Operation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Verification Standards and Reporting</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>UKGBC Framework:</strong> UK buildings (construction/operation) — Hierarchy,
              reduction first, public disclosure
            </li>
            <li>
              <strong>Science Based Targets (SBTi):</strong> Corporate emissions targets —
              Paris-aligned, 90%+ reduction before offset
            </li>
            <li>
              <strong>GHG Protocol:</strong> Carbon accounting methodology — Scope 1, 2, 3 emissions
              categories
            </li>
            <li>
              <strong>PAS 2080:</strong> Infrastructure carbon management — Whole-life carbon, value
              chain approach
            </li>
            <li>
              <strong>NABERS UK:</strong> Operational performance rating — Actual (not design)
              energy performance
            </li>
          </ul>
          <p>
            <strong>Building Services Role in Net-Zero Achievement</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design:</strong> Specify low-carbon HVAC, efficient lighting, smart controls
              from project inception
            </li>
            <li>
              <strong>Energy modelling:</strong> Predict operational carbon and test reduction
              scenarios
            </li>
            <li>
              <strong>Technology selection:</strong> Advise on heat pumps, renewables, storage
              systems
            </li>
            <li>
              <strong>Commissioning:</strong> Ensure systems operate as designed for optimal
              efficiency
            </li>
            <li>
              <strong>Monitoring:</strong> Set up metering and analytics to track performance
            </li>
            <li>
              <strong>Continuous improvement:</strong> Identify optimisation opportunities
              post-occupancy
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> A university is planning a new teaching building and wants to
            achieve net-zero operation. Apply the hierarchy.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> A commercial property owner has set a 2040 net-zero target.
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              UK net-zero target: <strong>2050</strong> (legally binding)
            </li>
            <li>
              Buildings' share of UK emissions: <strong>~40%</strong>
            </li>
            <li>
              SBTi minimum reduction before offset: <strong>90%</strong>
            </li>
            <li>
              Heat pump COP range: <strong>3-4</strong> (300-400% efficiency)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Offsetting first:</strong> Using offsets before exhausting efficiency
                measures
              </li>
              <li>
                <strong>Poor baseline:</strong> Inaccurate starting point undermines entire pathway
              </li>
              <li>
                <strong>Missing interim targets:</strong> Without milestones, progress cannot be
                tracked
              </li>
              <li>
                <strong>Low-quality offsets:</strong> Cheap offsets that lack additionality or
                permanence
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A new-build office was marketed at handover as "operational net-zero in use" based on
              design predictions: 60 kWh/m²/year EUI offset by on-site PV + green tariff PPA. Twelve
              months of metered data shows actual EUI at 145 kWh/m²/year — exceeding PV generation
          ...
          whatToDo={
            <>
              Three-track response: (1) immediately remove the net-zero claim from marketing and
              update sustainability disclosures; (2) commission a performance gap investigation —
              typically BMS scheduling, HVAC overrides, and unregulated loads; (3) implement the
              operational adjustments (re-commission BMS, tenant engagement, additional
              sub-metering) and re-verify after 6 months. Going forward, claim "net-zero ready" or
              "designed to net-zero" until measured performance confirms — not at handover.
            </>
          }
          whyItMatters={
            <>
              Claiming net-zero on design intent is becoming a reputational and legal risk. The UK
              Net Zero Carbon Buildings Standard requires measured verification annually for 5
              years. The performance gap is real, large and operational — and the only way to close
              it is structured aftercare (Soft Landings + TM63 + annual re-commissioning).
            </>
          }
        />
