      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Net-zero:</strong> Emissions balanced by verified offsets/removals
              </li>
              <li className="pl-1">
                <strong>Hierarchy:</strong> Avoid, Reduce, Replace, Offset
              </li>
              <li className="pl-1">
                <strong>UK target:</strong> Net-zero greenhouse gases by 2050
              </li>
              <li className="pl-1">
                <strong>Verification:</strong> Third-party assurance essential
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Buildings:</strong> ~40% of UK carbon emissions
              </li>
              <li className="pl-1">
                <strong>MEP role:</strong> Design low-carbon systems
              </li>
              <li className="pl-1">
                <strong>Key tech:</strong> Heat pumps, LEDs, smart controls
              </li>
              <li className="pl-1">
                <strong>Timeline:</strong> Pathway with interim milestones
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Net-zero carbon represents the critical goal of balancing greenhouse gas emissions
              with removals or offsets, resulting in no net contribution to climate change. For
              buildings, this encompasses both operational emissions (energy use) and increasingly
              embodied emissions (materials and construction).
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Key definitions in net-zero terminology:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Net-zero carbon:</strong> Emissions reduced to minimum, residual balanced
                  by verified offsets
                </li>
                <li className="pl-1">
                  <strong>Net-zero operational carbon:</strong> Zero net emissions from building
                  energy use
                </li>
                <li className="pl-1">
                  <strong>Net-zero whole-life carbon:</strong> Includes operational and embodied
                  carbon over building lifecycle
                </li>
                <li className="pl-1">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Net-zero by 2050 (legally binding)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        78% reduction by 2035 (vs 1990)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Building sector transformation required
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Future Homes Standard</td>
                      <td className="border border-white/10 px-3 py-2">
                        75-80% carbon reduction (new homes)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        No fossil fuel heating in new homes
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Part L 2021</td>
                      <td className="border border-white/10 px-3 py-2">
                        31% improvement (homes), 27% (non-domestic)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Stepping stone to net-zero
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Applying the Hierarchy to Building Services
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Reduce heat loss through fabric
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Optimise heating setpoints/schedules
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Install presence/daylight sensors
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Replace</td>
                      <td className="border border-white/10 px-3 py-2">
                        Install heat pump instead of boiler
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Upgrade to high-efficacy LEDs
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Offset</td>
                      <td className="border border-white/10 px-3 py-2">
                        Purchase offsets for residual gas
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Offset grid carbon factor
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A net-zero pathway provides a structured roadmap showing how an organisation or
              building will achieve net-zero carbon, including interim milestones, technology
              choices, and investment timelines aligned with equipment lifecycles and strategic
              planning.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              ...
              <ol className="text-sm text-white space-y-1.5 list-decimal list-outside ml-5">
                <li className="pl-1">
                  <strong>Baseline assessment:</strong> Comprehensive audit of current energy use
                  and emissions
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Gap analysis:</strong> Identify what must change to bridge baseline to
                  target
                </li>
                <li className="pl-1">
                  <strong>Measure identification:</strong> List all potential interventions with
                  costs and impacts
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Technology Options for Building Decarbonisation
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Load shifting, PV optimisation
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Enables higher renewable use
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Adds cost, improves flexibility
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example: Office Building Net-Zero Pathway
              </p>
              <div className="text-sm space-y-2">
                <p>
                  <strong>Baseline (2024):</strong> 850 tonnes CO2/year (gas heating, standard
                ...
                <p>
                  <strong>2035 target:</strong> 100 tonnes (-88%) - Additional efficiency, battery
                  storage
                </p>
                <p>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              cycles (boilers typically 15-20 years) to avoid stranded assets and optimise
              whole-life costs.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Verification Standards and Reporting
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        UK buildings (construction/operation)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Hierarchy, reduction first, public disclosure
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Scope 1, 2, 3 emissions categories
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Whole-life carbon, value chain approach
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Actual (not design) energy performance
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-green-500/10 border border-green-500/30">
              <p className="text-sm font-medium text-green-400 mb-2">
                Building Services Role in Net-Zero Achievement
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Design:</strong> Specify low-carbon HVAC, efficient lighting, smart
                  controls from project inception
                </li>
                <li className="pl-1">
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Applying the Carbon Hierarchy
              </h3>
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  Result: Net-zero operational carbon from day one
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Developing Interim Targets
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Carbon Baseline Calculation
              </h3>
              <p className="text-sm text-white mb-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Net-Zero Pathway Checklist
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Conduct comprehensive energy audit and establish carbon baseline
                </li>
                <li className="pl-1">
                  Define clear net-zero target date aligned with organisational strategy
                </li>
                <li className="pl-1">
                  Set interim milestones (typically 2030, 2035) with specific reduction targets
                </li>
                <li className="pl-1">
                  Identify all reduction measures using the hierarchy (Avoid-Reduce-Replace)
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Poor baseline:</strong> Inaccurate starting point undermines entire
                  pathway
                </li>
                <li className="pl-1">
