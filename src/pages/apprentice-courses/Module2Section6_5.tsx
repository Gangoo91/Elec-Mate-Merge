  ...
  const quizQuestions = [
    {
      ...
      options: [
        'Longer cables',
        'Timers/smart control to switch off',
    ...
    },
    {
      ...
      options: [
        'Bridge a protective device',
        'Use a rated timer/pressure control and keep protective devices as designed',
        'Remove the fuse',
        'Undersize the MCB',
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'PF reduces current for the same useful power',
        'PF makes voltage higher',
        'PF eliminates all losses',
        'PF increases harmonic heating',
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Rated efficiency and standby draw',
        'Colour of the label',
        'Only the price',
    ...
    },
    {
      ...
      options: [
        'Always use the smallest permitted CSA',
        'Balance voltage drop, current-carrying capacity, and installation costs',
        'Ignore manufacturer guidance',
        'Use only armoured cables',
      ],
      correctAnswer: 1,
      explanation:
        'Consider all factors: voltage drop limits, thermal constraints, and economic considerations for optimal efficiency.',
    },
  ] as const;
