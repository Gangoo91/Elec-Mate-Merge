    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Manage site operations, coordinate interfaces and ensure CDM compliance for building
          services projects
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers site management responsibilities for building services contractors -
          from establishing site facilities and monitoring progress through to CDM compliance,
          environmental management and achieving practical completion.
        </p>
