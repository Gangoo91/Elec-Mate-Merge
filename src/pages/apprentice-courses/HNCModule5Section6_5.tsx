...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Method statement', 'Risk assessment only', 'Consignment note', 'Site diary entry'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['80 dB(A)', '70 dB(A)', '90 dB(A)', '85 dB(A)'],
    correctAnswer: 3,
    explanation:
...
const HNCModule5Section6_5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 6 · Subsection 5"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The duty of care under EPA s.34 makes every party in the waste chain responsible.
              Producer (you), carrier (skip company), receiver (waste site) — all accountable. Waste
              transfer notes (WTN) and consignment notes (hazardous) are the audit trail. Penalties
              for breach include unlimited fines and corporate prosecution. The PM's environmental
              discipline starts at skip-hire.
            </>
          }
        ...
        <ConceptBlock title="Site Waste Management Plans and Waste Hierarchy">
          <p>
            ...
            services. The Environmental Protection Act 1990 imposes a duty of care on all those who
            handle waste, from production through to final disposal.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Prevention:</strong> Avoid generating waste through better design and ordering
            </li>
            <li>
        ...
        <ConceptBlock title="Noise Monitoring and Control">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lower action level (80 dB):</strong> Information, training, hearing protection
              available
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Substitution:</strong> Select quieter equipment (e.g., hydraulic vs pneumatic)
            </li>
            <li>
        ...
        <ConceptBlock title="Dust Control and Suppression">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Cutting cable tray:</strong> Cold cut where possible — RPE: P2 for metal fume
            </li>
            <li>
        ...
        <ConceptBlock title="Environmental Permits and ISO 14001 Principles">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Protected species licence:</strong> Work affecting bats, newts, etc. — Natural
              England
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Improvement:</strong> Nonconformity, corrective action, continual improvement
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Real-World Examples">
          <p>
            ...
            boards in an occupied hospital wing. Works include chasing, core drilling, and temporary
            generator use.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              Construction waste from your project is fly-tipped on a country road 15 miles from
              site. The Environment Agency tracks the waste back via paperwork found in the load.
              You as principal contractor used an uninsured "man-with-van" skip operator at £80/load
              instead of the licensed contractor at £180/load. Investigation reveals the operator
              dumps loads to save tipping fees.
            </>
          }
          whatToDo={
            <>
              Cooperate fully with the EA investigation. Engage waste lawyers. Audit every load
              taken from site for the past 6 months. Switch immediately to a licensed waste carrier
              with verifiable WTNs and weighbridge tickets. The EPA s.34 duty of care means you can
              be prosecuted even though you did not personally fly-tip — failing to verify the
              carrier's licence is the breach. Update procurement procedure: licensed carriers only,
              WTN check at every collection.
            </>
          }
          whyItMatters={
            <>
              Waste duty of care is one of the highest-risk environmental obligations on
              construction. Cheap skip operators are cheap because they cut corners on disposal —
              the cost saving becomes prosecution and reputational damage. Discipline at procurement
