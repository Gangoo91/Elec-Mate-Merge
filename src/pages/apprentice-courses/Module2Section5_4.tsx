...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Length of live conductor only',
    ],
    correctAnswer: 1,
    explanation:
      'Current flows out and back, so use the total path length for resistance calculations.',
  },
  {
    id: 7,
    ...
    <div className="bg-[#1a1a1a] overflow-x-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="mb-12 text-center">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-white mb-3">Resistance in Practice</h1>
          ...
          <div className="grid gap-4 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Quick estimate:</strong> Copper R ≈ 0.0172 × L ÷ A
                </li>
                <li>
                  <strong>Longer runs:</strong> Higher resistance and voltage drop
                </li>
                <li>
                  <strong>Poor joints:</strong> Add resistance and create hot spots
                </li>
                <li>
                  <strong>Temperature:</strong> Heat increases resistance
                </li>
                <li>
                  <strong>Testing:</strong> Use continuity tester, follow BS 7671
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Long runs, loose terminals, overheating joints
                </li>
                <li>
                  <strong>Use:</strong> Proper torque settings, clean connections
                </li>
                <li>
                  <strong>Apply:</strong> Route efficiently, upsize for voltage drop
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-2 text-white text-sm">
            <li>
              <strong>Longer</strong> runs have more resistance; keep runs sensible and plan routes.
            </li>
            <li>
              <strong>Thicker</strong> cables (bigger CSA) have less resistance; upsize to limit
              heating and voltage drop.
            </li>
            <li>
              <strong>Material</strong> matters: copper has lower resistance than aluminium for the
              same size.
            </li>
            <li>
              <strong>Heat</strong> raises resistance; avoid bunching, poor ventilation and
              overloaded enclosures.
            </li>
            <li>
              <strong>Joints/terminations</strong> add contact resistance; poor joints overheat – a
              safety risk.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          <h2 className="text-lg sm:text-xl font-semibold text-white mb-2 flex items-center gap-2">
            ...
            Quick resistance estimator
          </h2>
          <p className="text-xs sm:text-sm text-white mb-4">
            Use these constants with <strong>L</strong> in metres and <strong>A</strong> in mm²
            (20°C reference):
          </p>
          <div className="grid gap-4 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-elec-yellow/30">
              ...
              <p>
                R (Ω) ≈ <strong>0.0172 × L ÷ A</strong>
              </p>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
              <p className="font-medium">Aluminium</p>
              <p>
                R (Ω) ≈ <strong>0.0282 × L ÷ A</strong>
              </p>
            </div>
          </div>
          <div className="text-xs text-white mt-3">
            For a complete loop (out and back), use the total path length. Always verify design with
            Appendix 4 tables.
          </div>
        </section>
          ...
          <div className="grid gap-4 text-xs sm:text-sm text-white">
            <div className="bg-card border border-border/30 p-4 rounded-lg space-y-2">
              <h3 className="font-semibold text-elec-yellow mb-1 flex items-center gap-2">
                <Ruler className="w-4 h-4" /> Cable runs
              </h3>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <div className="bg-card border border-elec-yellow/30 p-4 rounded-lg space-y-2">
              <h3 className="font-semibold text-elec-yellow mb-1 flex items-center gap-2">
                <Plug className="w-4 h-4" /> Joints and terminations
              </h3>
              <ul className="list-disc pl-6 space-y-1">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-xs sm:text-sm text-white">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
              ...
              <p>
                Estimate the loop resistance for a 15 m radial (out and back) in copper, 2.5 mm².
              </p>
              <Collapsible>
                <CollapsibleTrigger className="mt-2 inline-flex text-elec-yellow text-sm underline min-h-[44px] touch-manipulation">
                  Show answer
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
              ...
              <p>
                Which will have lower resistance: 10 m of 1.5 mm² copper or 10 m of 2.5 mm² copper?
              </p>
              <Collapsible>
                <CollapsibleTrigger className="mt-2 inline-flex text-elec-yellow text-sm underline min-h-[44px] touch-manipulation">
                  Show answer
