...
const TITLE =
  'The Health and Safety at Work etc. Act 1974 (HASAWA) - Module 1.1.1 | Level 2 Electrical Course';
const DESCRIPTION =
  'Master the legal framework for health, safety and welfare in UK workplaces. Understand employer and employee duties under HASAWA for electrical work.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      'Technical wiring rules',
      'General duties for health, safety and welfare',
      'Electrical testing standards',
      'Setting electricity prices',
    ],
    correctIndex: 1,
    explanation:
      'HASAWA sets out general duties to protect the health, safety and welfare of employees and others across all industries, providing the legal framework for workplace safety.',
  },
  {
    id: 2,
    question: 'Which is an employer duty under HASAWA?',
    options: [
      'Only supervise qualified workers',
      'Provide safe systems of work',
      'Only employ electricians',
      'Report to HSE daily',
    ],
    correctIndex: 1,
    explanation:
      'Employers must provide safe plant, equipment, safe systems of work, information, instruction, training and supervision as required under HASAWA.',
  },
  {
    id: 3,
    ...
    correctIndex: 2,
    explanation:
      "Employees must take reasonable care for their own and others' safety, use PPE correctly, and cooperate with safety procedures and training.",
  },
];
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'HASAWA sets general duties on employers, employees and others to ensure health, safety and welfare at work across all industries.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'Employers must provide safe plant, safe systems of work, information, instruction, training and supervision as needed.',
    },
    {
      id: 3,
      ...
      correctAnswer: 2,
      explanation:
        'Employees must take reasonable care, use provided PPE correctly, and cooperate with safety procedures.',
    },
    {
      id: 4,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'HASAWA sets legal duties; compliance with BS 7671 helps demonstrate safe systems and installations.',
    },
    {
      id: 6,
      ...
      correctAnswer: 1,
      explanation:
        'Reasonably practicable means balancing the risk against the time, trouble, and cost of implementing control measures.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'Apprentices must stop work, make the area safe, and raise concerns when asked to perform unsafe work. They are protected when raising genuine safety issues.',
    },
    {
      id: 8,
      ...
      correctAnswer: 2,
      explanation:
        'RAMS (Risk Assessments and Method Statements) contain safe systems of work and must be followed on site to comply with HASAWA.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Yes - HASAWA applies to all employees including apprentices. You have duties to take reasonable care for your own and others' safety, and to cooperate with your employer's safety procedures.",
    },
    {
      question: 'What happens if I refuse to do unsafe work?',
      answer:
        'You are protected under HASAWA when raising genuine safety concerns. Employers cannot discipline you for refusing to perform genuinely unsafe work or for reporting safety issues.',
    },
    {
      question: 'How does HASAWA relate to other electrical regulations?',
      answer:
        'HASAWA provides the legal framework for workplace safety. Other regulations like BS 7671 provide specific technical requirements that help employers meet their HASAWA duties.',
    },
    {
      question: 'Who can prosecute under HASAWA?',
      answer:
        'The Health and Safety Executive (HSE) and local authorities can investigate incidents and prosecute serious breaches. Penalties can include unlimited fines and imprisonment.',
    },
    {
      question: 'Do I need to know HASAWA word-for-word?',
      answer:
        'No - you need to understand the key principles and duties. Focus on practical application: safe systems of work, cooperation with procedures, and raising safety concerns.',
    },
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-base text-foreground">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1 text-foreground">
                ...
                <li>
                  Sets out duties for employers, employees and others to prevent harm at work.
                </li>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1 text-foreground">
                <li>
                  <strong>Spot:</strong> RAMS, safety briefings, PPE requirements, risk assessments.
                </li>
                <li>
                  <strong>Use:</strong> Safe systems of work, cooperation with procedures, reporting
                  hazards.
                </li>
                <li>
                  <strong>Check:</strong> Your duties, employer obligations, safety compliance.
                </li>
              </ul>
            </div>
          </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <ul className="list-disc pl-6 space-y-2 text-base text-foreground">
            <li>
              Explain the purpose and scope of HASAWA for electrical work and workplace safety.
            </li>
            <li>
              Outline employer and employee duties relevant to site activities and daily operations.
            </li>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            ...
            <p className="text-base text-foreground mb-4">
              The Health and Safety at Work etc. Act 1974 provides the legal foundation for
              workplace safety across all UK industries:
            </p>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-elec-yellow dark:text-elec-yellow mb-1">
                      Purpose and Scope of HASAWA
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>Legislative framework:</strong> HASAWA sets the legal foundation for
                      workplace safety.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>
                        Applies to all workplaces, employers, employees and others affected by work
                        activities
                      </li>
                      <li>Sets general duties rather than specific technical requirements</li>
                      <li>
                        Covers health, safety and welfare of people at work and members of the
                        public
                      </li>
                      <li>Provides framework for more specific safety regulations and standards</li>
                    </ul>
                    <p className="text-base text-foreground mb-2">
                      <strong>Key principles:</strong> Prevention, cooperation and reasonableness
                      underpin the Act.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      ...
                      <li>
                        Reasonably practicable - balance risk against cost and effort of controls
                      </li>
                      <li>Continuous improvement through consultation and risk management</li>
                    </ul>
                    <p className="text-base text-foreground mb-2">
                      <strong>Electrical industry relevance:</strong> HASAWA directly impacts
                      electrical work practices.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>
                        Electrical work involves significant risks requiring careful management
                      </li>
                      <li>
                        Compliance with electrical standards like BS 7671 helps meet HASAWA duties
                      </li>
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Legal foundation:</strong> HASAWA makes workplace safety a legal
          ...
          <section className="mb-6">
            ...
            <p className="text-base text-foreground mb-4">
              HASAWA places specific duties on employers to ensure the health, safety and welfare of
              their employees:
            </p>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-green-600 dark:text-green-400 mb-1">
                      Core Employer Obligations Under HASAWA
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>Safe plant and equipment:</strong> Providing and maintaining safe
                      working equipment.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>
                        All tools, machinery and equipment must be safe and properly maintained
                      </li>
                      <li>
                        Regular inspection, testing and maintenance schedules must be implemented
                      </li>
                      <li>Defective equipment must be removed from service immediately</li>
                      <li>
                        Suitable personal protective equipment (PPE) must be provided free of charge
                      </li>
                    </ul>
                    <p className="text-base text-foreground mb-2">
                      <strong>Safe systems of work:</strong> Establishing and maintaining safe
                      working procedures.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Information, instruction, training and supervision:</strong> Ensuring
                      employee competence.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Safe workplace and welfare facilities:</strong> Maintaining suitable
                      working conditions.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      ...
                      <li>
                        Welfare facilities including toilets, washing facilities and rest areas
                      </li>
                      <li>
                        First aid facilities and arrangements proportionate to workplace risks
                      </li>
                    </ul>
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Employer responsibility:</strong> Employers must provide everything
          ...
          <section className="mb-6">
            ...
            <p className="text-base text-foreground mb-4">
              HASAWA also places important duties on employees to take responsibility for their own
              and others' safety:
            </p>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-amber-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Take reasonable care:</strong> Personal responsibility for safety at
                      work.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>
                        Take reasonable care for your own health and safety during work activities
                      </li>
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Use safety equipment correctly:</strong> Proper use of provided safety
                      measures.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Cooperate with safety measures:</strong> Active participation in
                      safety systems.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Competence and learning:</strong> Recognising limits and developing
                      skills.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Shared responsibility:</strong> Safety is everyone's responsibility,
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">
              Practical Application for Electrical Apprentices
            </h3>
            <p className="text-base text-foreground mb-4">
              Understanding how HASAWA applies in practice helps apprentices work safely and
              professionally:
            </p>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-elec-yellow mb-1">
                      Daily Application of HASAWA Principles
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>Site induction and briefings:</strong> Starting work safely and
                      informed.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>
                        Attend all site inductions covering site-specific hazards and procedures
                      </li>
                      <li>Participate in daily toolbox talks and safety briefings</li>
                      <li>
                        Understand emergency procedures, evacuation routes and first aid
                        arrangements
                      </li>
                      <li>Know who to contact for safety advice and in emergency situations</li>
                    </ul>
                    <p className="text-base text-foreground mb-2">
                      <strong>Following RAMS and procedures:</strong> Implementing safe systems of
                      work.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Recognising and reporting hazards:</strong> Active hazard management.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Daily practice:</strong> HASAWA principles guide every aspect of
                      electrical work
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
              <h3 className="font-medium text-foreground mb-2">
                Scenario 1: Site Induction Safety
              </h3>
              <p className="text-base text-foreground mb-2">
                <strong>Situation:</strong> You arrive at a new construction site for electrical
                installation work.
              </p>
              <p className="text-xs sm:text-sm text-foreground mb-2">
                <strong>HASAWA Application:</strong> Attend site induction covering hazards,
            ...
            <div className="rounded-lg p-4 bg-card border border-green-400/30">
              ...
              <p className="text-base text-foreground mb-2">
                <strong>Situation:</strong> Your supervisor asks you to work on a circuit that
                hasn't been properly isolated and tested.
              </p>
              <p className="text-xs sm:text-sm text-foreground mb-2">
                <strong>HASAWA Application:</strong> Refuse to perform unsafe work. Explain the need
            ...
            <div className="rounded-lg p-4 bg-card border border-amber-400/30">
              <h3 className="font-medium text-foreground mb-2">
                Scenario 3: Equipment Defect Discovery
              </h3>
              <p className="text-base text-foreground mb-2">
                <strong>Situation:</strong> You discover that a portable electrical tool has damaged
                casing and exposed conductors.
              </p>
              <p className="text-xs sm:text-sm text-foreground mb-2">
                <strong>HASAWA Application:</strong> Immediately stop using the equipment. Remove it
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <p className="text-base text-foreground mb-4">
            The Health and Safety at Work etc. Act 1974 provides the legal foundation for workplace
            safety in the UK. It places duties on both employers and employees to ensure health,
