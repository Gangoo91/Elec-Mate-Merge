  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Level 2 learners should understand procedures and assist qualified electricians under supervision, building foundational knowledge and skills.',
    },
    {
      id: 2,
      question:
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Level 2 learners should understand basic tests including continuity, insulation resistance, polarity, earth fault loop impedance, and RCD testing.',
    },
    {
      id: 4,
      ...
      correctAnswer: 1,
      explanation:
        'Inspection involves visual checks of construction and compliance, while testing uses instruments to measure electrical characteristics.',
    },
    {
      id: 5,
      question: 'What is the first rule before carrying out any electrical testing?',
      options: ['Check the weather', 'Safe isolation', 'Call the supervisor', 'Read the manual'],
      correctAnswer: 1,
      explanation:
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Level 2 learners cannot sign certificates or carry out unsupervised testing on live systems - these require higher qualifications.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'Always ask for clarification before proceeding. Safety and accuracy depend on fully understanding all instructions.',
    },
    {
      id: 8,
      ...
      correctAnswer: 1,
      explanation:
        'Formal certificates (EIC, Minor Works, EICR) provide legal documentation that testing has been completed correctly.',
    },
    {
      id: 9,
      ...
      correctAnswer: 1,
      explanation:
        'Level 3 training builds on Level 2 foundations to develop competence in carrying out full inspection and testing independently.',
    },
    {
      id: 10,
      ...
      correctAnswer: 1,
      explanation:
        'The apprentice assisted by setting up equipment and reading results under supervision, gaining hands-on experience safely.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <ul className="text-white/80 text-sm space-y-1 list-disc pl-5">
              ...
              <li>
                Know WHY tests are done (safety, compliance) and WHAT tests exist (continuity,
                insulation, etc.).
              </li>
              <li>
                Assist with preparation, readings, and documentation - but qualified person signs
                certificates.
              </li>
              <li>
                Foundation for Level 3 competence - builds essential knowledge and safe working
                habits.
              </li>
            </ul>
          </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-2 leading-relaxed">
              <ul className="list-disc pl-6 space-y-2 text-sm">
                ...
                <li>
                  Identify the tests and inspections you are expected to recognise at Level 2.
                </li>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                safety and compliance. This theoretical foundation is crucial for safe practical
                assistance.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    <strong>Purpose:</strong> Understand why inspection and testing are carried out
                    (safety, compliance, fault detection)
                  </li>
                  <li>
                    <strong>Legal framework:</strong> Awareness of EAWR 1989 and BS 7671
                    requirements
                  </li>
                  <li>
                    <strong>Process distinction:</strong> Know the difference between inspection
                    (visual) and testing (instrumental)
                  </li>
                  <li>
                    <strong>Safety implications:</strong> Understand consequences of poor or missing
                    verification
                  </li>
                </ul>
              </div>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <ul className="text-sm space-y-1">
                    <li>
                      • <strong>Continuity of protective conductors</strong>
                    </li>
                    <li>
                    ...
                    <li>
                      • <strong>Earth fault loop impedance</strong>
                    </li>
                    <li>
                      • <strong>RCD operation</strong>
                    </li>
                  </ul>
                </div>
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <ul className="text-sm space-y-1">
                    <li>
                      • <strong>Purpose:</strong> Why the test is carried out
                    </li>
                    <li>
                      • <strong>Basic method:</strong> How the test is performed
                    </li>
                    <li>
                      • <strong>Safety aspects:</strong> Risks and precautions
                    </li>
                    <li>
                      • <strong>Results interpretation:</strong> Pass/fail basics
                    </li>
                    <li>
                      • <strong>Documentation:</strong> How results are recorded
                    </li>
                  </ul>
                </div>
              </div>
              <div className="p-4 rounded-lg bg-blue-500/10 border-l-2 border-blue-500/50">
                ...
                <p className="text-sm">
                  At Level 2, you're expected to understand the 'why' behind each procedure, not
                  just memorise steps. This conceptual understanding enables you to assist
                  effectively and builds the foundation for independent competence at Level 3.
                </p>
              </div>
            </div>
          </section>
          ...
          <InlineCheck
            ...
            options={[
              'Only how to use the equipment',
              'The purpose, safety aspects, and basic methods',
              'Just the pass/fail criteria',
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                skills form the foundation for future independent practice at higher levels.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="font-medium text-white mb-3">Equipment Preparation and Setup:</p>
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    <strong>Tool preparation:</strong> Safely prepare tools and instruments for
                    testing under supervision
                  </li>
                  <li>
                    <strong>Lead selection:</strong> Choose appropriate test leads for different
                    measurements
                  </li>
                  <li>
                    <strong>Instrument checks:</strong> Basic functional checks of test equipment
                    before use
                  </li>
                  <li>
                    <strong>Safety preparation:</strong> Set up barriers, warning notices, and
                    safety equipment
                  </li>
                  <li>
                    <strong>Documentation setup:</strong> Prepare certificates and record sheets
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    <strong>Switching procedures:</strong> Correct sequence for isolating circuits
                  </li>
                  <li>
                    <strong>Lock-off procedures:</strong> Applying locks and warning labels
                  </li>
                  <li>
                    <strong>Proving unit testing:</strong> Checking voltage indicators are working
                  </li>
                  <li>
                    <strong>Dead testing:</strong> Confirming circuits are de-energised
                  </li>
                  <li>
                    <strong>Documentation:</strong> Recording isolation procedures
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <div className="grid md:grid-cols-2 gap-2 text-sm">
                  <p className="p-2 rounded bg-green-500/10">
                    <strong>Continuity Testing:</strong> Connect leads, take readings, record under
                    guidance
                  </p>
                  <p className="p-2 rounded bg-blue-500/10">
                    <strong>Insulation Resistance:</strong> Assist with lead connection and reading
                    recording
                  </p>
                  <p className="p-2 rounded bg-purple-500/10">
                    <strong>Visual Inspection:</strong> Systematically check cable routes and
                    accessories
                  </p>
                  <p className="p-2 rounded bg-orange-500/10">
                    <strong>Result Recording:</strong> Accurately document measurements
                  </p>
                </div>
              </div>
              <div className="p-4 rounded-lg bg-orange-500/10 border-l-2 border-orange-500/50">
                ...
                <p className="text-sm">
                  All practical activities must be carried out under the direct supervision of a
                  qualified electrician. The supervisor retains full responsibility for safety,
                  accuracy, and compliance - your role is to assist and learn under their guidance.
                </p>
              </div>
            </div>
          </section>
          ...
          <InlineCheck
            ...
            options={[
              'Complete testing independently',
              'Assist with testing under direct supervision',
              'Sign certificates for simple tests',
              'Work unsupervised on low-voltage circuits',
            ]}
            correctIndex={1}
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                while building towards future competence.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="font-medium text-white mb-3">Certification Limitations:</p>
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    <strong>No certificate signing:</strong> You are not qualified to sign any
                    electrical certificates
                  </li>
                  <li>
                    <strong>No design responsibility:</strong> Cannot take responsibility for
                    electrical design decisions
                  </li>
                  <li>
                    <strong>No compliance assessment:</strong> Cannot determine if installations
                    meet BS 7671 requirements
                  </li>
                  <li>
                    <strong>No final verification:</strong> Cannot make final decisions on
                    installation safety
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <div className="space-y-2 text-sm">
                  <p className="p-2 rounded bg-red-500/10">
                    <strong>Unusual readings:</strong> Any test result that seems abnormal should be
                    referred to your supervisor.
                  </p>
                  <p className="p-2 rounded bg-orange-500/10">
                    <strong>Safety concerns:</strong> Any situation where you're unsure about safety
                    requires immediate escalation.
                  </p>
                  <p className="p-2 rounded bg-yellow-500/10">
                    <strong>Technical questions:</strong> Client queries or technical decisions
                    should always be referred to qualified staff.
                  </p>
                </div>
              </div>
            </div>
          ...
          <InlineCheck
            ...
            options={[
              ...
              'Refer it to their supervisor immediately',
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                for future advancement and career development.
              </p>
              <div className="p-4 rounded-lg bg-blue-500/10 border-l-2 border-blue-500/50">
                <p className="font-medium text-white mb-2">Level 2 Foundation Stage:</p>
                <ul className="text-sm space-y-1">
                  <li>
                    <strong>Focus:</strong> Understanding + Assisted Practice
                  </li>
                  <li>
                    <strong>Knowledge:</strong> Fundamental concepts, procedures, and safety
                    requirements
                  </li>
                  <li>
                    <strong>Skills:</strong> Basic tool use, measurement taking, result recording
                    under supervision
                  </li>
                  <li>
                    <strong>Responsibility:</strong> Learning and assisting only - no independent
                    decision making
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-green-500/10 border-l-2 border-green-500/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    <strong>Focus:</strong> Independent Practice Under Guidance
                  </li>
                  <li>
                    <strong>Knowledge:</strong> Detailed understanding of testing procedures, fault
                    diagnosis, design principles
                  </li>
                  <li>
                    <strong>Skills:</strong> Complete testing sequences, result interpretation,
                    basic fault finding
                  </li>
                  <li>
                    <strong>Responsibility:</strong> Carrying out testing independently but with
                    oversight
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-purple-500/10 border-l-2 border-purple-500/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    <strong>Focus:</strong> Full Professional Competence
                  </li>
                  <li>
                    <strong>Knowledge:</strong> Complete mastery of inspection, testing, design, and
                    compliance
                  </li>
                  <li>
                    <strong>Skills:</strong> Advanced fault diagnosis, design verification, complex
                    installation assessment
                  </li>
                  <li>
                    <strong>Responsibility:</strong> Full certification authority and professional
                    accountability
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Theoretical knowledge</strong> from Level 2 becomes practical competence
                    at Level 3
                  </li>
                  <li>
                    <strong>Assisted activities</strong> develop into independent capabilities
                  </li>
                  <li>
                    <strong>Understanding procedures</strong> evolves into making professional
                    judgements
                  </li>
                  <li>
                    <strong>Safety awareness</strong> becomes responsibility for others' safety
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-orange-500/10 border-l-2 border-orange-500/50">
              ...
              <p className="text-sm text-white/80">
                ...
                confirmed compliance with acceptable limits. This allowed the apprentice to gain
                hands-on experience safely, understand the complete process, and contribute
                meaningfully to the work, while the responsibility for interpretation and
                certification remained with the qualified electrician.
              </p>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-green-500/10 border-l-2 border-green-500/50">
                ...
                <ul className="text-sm space-y-1 text-white/80">
                  ...
                  <li>
                    <strong>Know why</strong> tests are done, not just how
                  </li>
                  <li>
                    <strong>Inspection</strong> = visual, <strong>Testing</strong> = instruments
                  </li>
                  <li>
                    <strong>Support</strong> supervisors with safe, accurate preparation
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-green-500/10 border-l-2 border-green-500/50">
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                you can develop under supervision, and the important limitations of your role.
              </p>
              <p className="text-sm text-elec-yellow/80">
                Remember: your role is to learn, assist safely, and build towards independent
                practice - always within the bounds of your current competence and under appropriate
                supervision.
              </p>
            </div>
          </section>
          ...
          <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10 mt-10">
            ...
            <Button
              ...
              asChild
            >
              <Link to="..">Return to Section 6.1</Link>
            </Button>
          </nav>
        </div>
      </article>
