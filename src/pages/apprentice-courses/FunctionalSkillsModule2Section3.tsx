...
const FunctionalSkillsModule2Section3 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'Honesty is essential in professional communication. Giving an unrealistic commitment damages trust far more than being upfront about challenges. Explain what you can achieve, identify the obstacles, and work with the project manager to find a realistic solution.',
    },
    {
      id: 3,
      question:
    ...
    <div className="pb-24 bg-elec-dark min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-6 mt-6">
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              effectively with other trades, or present yourself professionally in meetings. The way
              you communicate shapes how others perceive your competence, reliability, and
              trustworthiness.
            </p>
            <p>
              As an electrician, you communicate in many different contexts: explaining work to
              homeowners, coordinating with plumbers and builders on site, reporting to project
              managers, presenting at toolbox talks, and negotiating with suppliers. Each context
              requires a slightly different approach, but the core principles remain the same.
            </p>

            <h4 className="text-white font-semibold pt-2">
              The five principles of professional communication
            </h4>
            ...
            <p>
              The way you speak to a homeowner should be different from the way you speak to a
              fellow electrician or a project manager. This is not about being fake — it is about
              adjusting your language and approach to suit your audience:
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              may not understand the work you are doing, worry about the cost, or feel anxious about
              the disruption. Your ability to communicate with empathy, clarity, and professionalism
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 mt-2">
              ...
              <p className="text-white italic">
                ...
                deteriorated, which means there's an increased risk of electric shock and electrical
                fire. Your installation also doesn't have the modern safety devices — called RCDs —
                that would protect you if a fault developed. I would strongly recommend a rewire,
                which would bring your home up to current safety standards. I understand this is a
                significant expense, and I'm happy to discuss options, including whether the work
                could be done in stages to spread the cost."
              </p>
            </div>

            <h4 className="text-white font-semibold pt-2">
              Key principles for client conversations
            </h4>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              or improver, you may attend these meetings with your supervisor. As you progress, you
              will be expected to contribute and eventually represent your company independently.
            </p>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Prepare what you want to say before the meeting — even just a few bullet points
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Speak clearly and at a steady pace — do not rush</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Stick to facts and avoid speculation</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  If you do not know the answer to a question, say "I'll find out and get back to
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Remember that everyone in the room was once new to meetings — confidence comes
                  with practice
                </span>
              </li>
            </ul>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              to your office, and respond to emergency callouts. Without the benefit of body
              language and facial expressions, your words and tone carry even more weight.
            </p>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Stay calm — your composure will help calm the caller</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Ask about immediate safety: "Is anyone injured?" "Can you smell burning?"
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Give clear safety advice: "Turn off the main switch in your consumer unit if it is
                  safe to do so"
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Never advise a client to touch damaged equipment or investigate a fault themselves
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Confirm when you will attend and ensure the client has your contact number
                </span>
              </li>
            </ul>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              explaining test results to a property manager, or justifying a design decision to an
              architect, your ability to bridge the gap between technical and non-technical
              understanding sets you apart.
            </p>
            ...
            <h4 className="text-white font-semibold pt-2">
              Common explanations you will need to give
            </h4>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 mt-2">
              <div className="space-y-3">
                ...
                <div className="border-t border-white/10 pt-3">
                  ...
                  <p className="text-white italic">
                    ...
                    approximately [amount]. I won't proceed without your approval."
                  </p>
                </div>
                <div className="border-t border-white/10 pt-3">
                  <p className="text-white font-semibold text-xs mb-1">
                  ...
                  <p className="text-white italic">
                    ...
                    providing proper protection. I'll leave you with a certificate that shows all
                    the results."
                  </p>
                </div>
              </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                work, and recommend you to others.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              relationship. A well-handled complaint can actually increase client loyalty — because
              the client sees that you take their concerns seriously and act to resolve them.
            </p>

            <h4 className="text-white font-semibold pt-2">
              The LEAP framework for handling complaints
            </h4>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>Do not become defensive or argumentative</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-400 mt-0.5">&bull;</span>
                <span>Do not blame the client, another trade, or your supplier</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-400 mt-0.5">&bull;</span>
                <span>Do not ignore the complaint or hope it goes away</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-400 mt-0.5">&bull;</span>
                <span>Do not discuss the complaint with other clients or on social media</span>
              </li>
            </ul>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              communication and coordination with these professionals is essential to keeping the
              project on programme, avoiding conflicts, and ensuring the quality of everyone's work.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 mt-2">
              ...
              <p className="text-white italic">
                ...
                manager so we can get it sorted before we lose any time."
              </p>
            </div>

            <h4 className="text-white font-semibold pt-2">
              Tips for good inter-trade relationships
            </h4>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              colleagues who support you, and the suppliers who prioritise your orders — all of
              these relationships are built through consistent, professional communication over
              time.
            </p>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Your reputation is built one interaction at a time. Every phone call, every site
                  visit, every completed job contributes to it.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  It takes years to build a good reputation and minutes to destroy it. Think before
                  you speak or write.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Be careful on social media. What you post publicly reflects on you and your
                  company.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Never speak negatively about other electricians or companies. It reflects poorly
                  on you, not on them.
                </span>
              </li>
            </ul>
        ...
        <div className="flex items-center justify-between pt-6 border-t border-white/10">
          ...
          <Link
            to="/study-centre/apprentice/functional-skills/module2/section4"
