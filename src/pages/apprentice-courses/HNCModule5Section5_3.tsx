...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['2 hours', '1 hour', '30 minutes', '24 hours'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['CIBSE Code A', 'CIBSE Code R', 'CIBSE Code W', 'CIBSE Code M'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Design air flow', 'Minimum air flow', '50% of design flow', 'Maximum air flow'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['2-4K', '15-20K', '10-12K', '5-8K'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Manometer', 'Hygrometer', 'Balometer (capture hood)', 'Thermometer'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1-2 m/s', '12-15 m/s', '8-10 m/s', '4-6 m/s'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Code A is the technical reference for air system commissioning. Specifications
              increasingly require Code A compliance with documented results — flow rates, balance,
              leakage, fan curves. A system commissioned outside Code A is a system that will be
              retro-commissioned within 12 months at owner cost.
            </>
          }
        ...
        <ConceptBlock title="CIBSE Commissioning Codes">
          <p>
            The Chartered Institution of Building Services Engineers (CIBSE) publishes commissioning
            codes that define standard procedures and acceptable performance criteria for building
            services systems. These codes are referenced in specifications and form the basis for
          ...
          <p>
            <strong>Real-world example — office building HVAC:</strong> A new 10-storey office block
            requires commissioning of: 4 AHUs (Code A), LTHW heating circuit with 200 FCUs (Code W),
            CHW cooling circuit (Code W), 2 air-cooled chillers (Code R), and BMS integration (Code
            C). The commissioning engineer must coordinate all trades, ensure pre-requisites are
            met, and demonstrate integrated system performance before handover.
          </p>
          <p>
        ...
        <ConceptBlock title="Water System Balancing (CIBSE Code W)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Example: A regulating valve with Kv = 2.5 shows dP = 0.16 bar. Flow = 2.5 x sqrt(0.16)
              = 2.5 x 0.4 = 1.0 m³/h (0.28 l/s)
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Air System Commissioning (CIBSE Code A)">
          ...
          <p>
            <strong>Real-world example — VAV system:</strong> A 50-box VAV system serving open-plan
            offices. Commissioning sequence: (1) Set AHU to 100% supply, (2) Drive all boxes to
            maximum, (3) Measure and record each box flow, (4) Adjust main dampers for +/- 10%, (5)
            Test box minimum positions for ventilation compliance, (6) Verify pressure-independent
        ...
        <ConceptBlock title="Pressure Testing and Performance Verification">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Test pressure:</strong> 1.5 x maximum working pressure (typically 4.5 bar for
              3 bar systems)
            </li>
            <li>
            ...
            <li>
              <strong>Documentation:</strong> Record initial pressure, temperature, time, and final
              readings
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Example 2 — Air flow deviation:</strong> A supply grille has design flow of 120
            l/s. Measured flow with balometer is 108 l/s. Is this acceptable?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — Proportional balancing:</strong> Three circuits have design flows of
            1.0, 0.8, and 0.6 l/s. Measured flows with index valve (Circuit 1) fully open are: 1.2,
            1.1, and 0.9 l/s. Calculate required flow ratios.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Ignoring temperature effects</strong> - pressure tests vary with temperature
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              To save programme time, the mechanical sub skips BSRIA BG 29 chemical cleaning of the
              chilled water system. The system is filled and commissioned. Within six months the
              building reports comfort cooling failures; investigation finds the AHU coils fouled
              with construction debris and biofilm. Cost of remedial cleaning, flushing and coil
              replacement: £180k. The contractor and design team dispute responsibility; the
              warranty will not cover it.
            </>
          }
          whatToDo={
            <>
              Pre-commissioning cleaning is non-negotiable on any closed water system. Make it a
              hold point on the ITP: chemical clean to BG 29, flush, side-stream filtration, water
              quality test (TVCs, conductivity, pH) signed off before final fill. Witness the
              process if the contractor proposes shortcuts. The cost of cleaning is a fraction of
              the cost of contamination.
            </>
          }
          whyItMatters={
            <>
              Skipped pre-commissioning is a hidden defect that surfaces after the contractor leaves
              site. The owner pays; the warranty is contested; the project's reputation suffers.
              Discipline on cleaning protects everyone.
            </>
          }
        />
