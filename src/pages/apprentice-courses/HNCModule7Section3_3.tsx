...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['E = I / (d × cosθ)', 'E = I × cosθ / d²', 'E = I × cos³θ / h²', 'E = I × sinθ / h²'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['61.4 lux', '93.75 lux', '75 lux', '48 lux'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="The Inverse Square Law">
          <p>
            The inverse square law is the fundamental principle governing how illuminance decreases
            with distance from a light source. Understanding this relationship is essential for all
            point illuminance calculations and forms the basis of lighting design.
          </p>
          <p>
            <strong>Basic Inverse Square Law Formula</strong>
          </p>
          <p>E = I / d²</p>
          <p>
            <strong>Where:</strong>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Point source assumption:</strong> Valid when distance &gt; 5× luminaire
              dimension
            </li>
            <li>
              <strong>Direct component only:</strong> Does not include reflected light
            </li>
            <li>
              <strong>Perpendicular incidence:</strong> Applies when light strikes surface at 90°
            </li>
            <li>
              <strong>Intensity direction:</strong> Must use intensity in the specific direction
              toward the point
            </li>
          </ul>
          <p>
            <strong>Illuminance vs Distance Relationship</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1:</strong> 1 — 1000 lux — Reference
            </li>
            <li>
              <strong>2:</strong> 4 — 250 lux — 1/4 (25%)
            </li>
            <li>
              <strong>3:</strong> 9 — 111 lux — 1/9 (11%)
            </li>
            <li>
              <strong>4:</strong> 16 — 62.5 lux — 1/16 (6.25%)
            </li>
            <li>
              <strong>5:</strong> 25 — 40 lux — 1/25 (4%)
            </li>
          </ul>
          <p>
            <strong>Critical insight:</strong> Illuminance drops rapidly with distance - doubling
            the mounting height reduces illuminance to one quarter. This has significant
            implications for luminaire spacing and task lighting design.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Cosine Correction for Angled Incidence">
          ...
          <p>
            <strong>Horizontal Surface Formula</strong>
          </p>
          <p>E = I × cos³θ / h²</p>
          <p>
            <strong>Where:</strong>
          ...
          <p>
            <strong>Vertical Surface Formula</strong>
          </p>
          ...
          <p>
            <strong>Understanding the cos³θ Term</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>0° (directly below):</strong> 1.000 — 1.000 — Full illuminance
            </li>
            <li>
              <strong>30°:</strong> 0.866 — 0.650 — 65% of maximum
            </li>
            <li>
              <strong>45°:</strong> 0.707 — 0.354 — 35% of maximum
            </li>
            <li>
              <strong>60°:</strong> 0.500 — 0.125 — 12.5% of maximum
            </li>
            <li>
              <strong>75°:</strong> 0.259 — 0.017 — 1.7% of maximum
            </li>
          </ul>
          <p>
            <strong>Worked Calculation Example</strong>
          </p>
          ...
          <p>E = 48 lux</p>
          <p>
            <strong>Practical tip:</strong> For quick estimates, remember that at 45° the
            illuminance is roughly one-third of directly below, and at 60° it drops to about
            one-eighth.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Computer-Aided Lighting Design">
          <p>
            ...
            of point calculations, model inter-reflections, and generate comprehensive
            documentation. DIALux and Relux are the industry-standard tools available free of
            charge.
          </p>
          <p>
            <strong>DIALux</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Software Calculation Methods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Point-by-point:</strong> Direct component from each luminaire summed — Base
              calculation for all points
            </li>
            <li>
              <strong>Radiosity:</strong> Iterative calculation of diffuse inter-reflections —
              Interior spaces with reflective surfaces
            </li>
            <li>
              <strong>Ray tracing:</strong> Follows individual light paths for specular reflection —
              Spaces with mirrors, glazing, polished surfaces
            </li>
            <li>
              <strong>Monte Carlo:</strong> Statistical sampling of light paths — Complex
              geometries, daylight modelling
            </li>
          </ul>
          <p>
            <strong>Essential Input Data for Software</strong>
          </p>
          <p>Room Parameters</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Best practice:</strong> Always use manufacturer-supplied photometric files
            rather than generic data. Verify luminaire performance claims against independent test
        ...
        <ConceptBlock title="Isolux Diagrams and Design Verification">
          <p>
            Isolux diagrams provide visual representation of illuminance distribution across a
            surface. Combined with uniformity calculations and compliance checks, they form the
            basis for verifying that a lighting design meets specification requirements.
          </p>
          <p>
            <strong>Understanding Isolux Diagrams</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Contour lines:</strong> Connect points of equal illuminance (like altitude
              contours on maps)
            </li>
            <li>
              <strong>Close spacing:</strong> Indicates rapid change in illuminance (steep gradient)
            </li>
            <li>
              <strong>Wide spacing:</strong> Indicates gradual, uniform illuminance distribution
            </li>
            <li>
              <strong>Closed loops:</strong> Show peaks (high values inside) or troughs (low values
              inside)
            </li>
            <li>
              <strong>Colour coding:</strong> Typically red/orange for high values, blue/purple for
              low
            </li>
          </ul>
          <p>
            <strong>Uniformity Ratios to BS EN 12464-1</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>U₀ (uniformity):</strong> E<sub>min</sub> / E<sub>average</sub> — ≥ 0.6 for
              task areas, ≥ 0.4 for surroundings
            </li>
            <li>
              <strong>
                U<sub>d</sub> (diversity):
              </strong>{' '}
              E<sub>min</sub> / E<sub>max</sub> — Used for specific applications (sports lighting)
            </li>
            <li>
              <strong>
                E<sub>average</sub>:
              </strong>{' '}
              Mean illuminance across calculation area — Must meet maintained illuminance
              requirement
            </li>
            <li>
              <strong>
              ...
              Minimum point illuminance — Critical for emergency lighting (≥ 1 lux)
            </li>
          </ul>
          <p>
            <strong>Design Verification Checklist</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              E<sub>average</sub> meets maintained illuminance
            </li>
          ...
          <p>
            <strong>Common Design Issues Identified</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Grid Spacing Requirements (BS EN 12464-1 Annex A)</strong>
          </p>
          ...
          <p>
            ...
            on-site measurements at representative points. A ±20% variance from calculated values is
            generally acceptable, accounting for construction tolerances and actual surface
            reflectances.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Two identical luminaires (I = 1200 cd at nadir) mounted at 3m
            height, 4m apart. Calculate illuminance at the midpoint.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Calculate the illuminance on a wall 2m from directly below a
            luminaire (I = 800 cd, h = 2.5m).
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Direct below (perpendicular):</strong> E = I / h²
            </li>
            <li>
              <strong>Horizontal surface (angled):</strong> E = I × cos³θ / h²
            </li>
            <li>
              <strong>Vertical surface:</strong> E = I × cos²θ × sinθ / h²
            </li>
            <li>
              <strong>Uniformity ratio:</strong> U₀ = E<sub>min</sub> / E<sub>average</sub>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Using lumens instead of candelas</strong> - Point calculations require
                intensity (cd) not flux (lm)
              </li>
              <li>
                <strong>Forgetting cos³θ term</strong> - Simple inverse square only applies directly
                below
              </li>
              <li>
                <strong>Incorrect angle measurement</strong> - θ is from nadir (vertical), not from
                horizontal
              </li>
              <li>
                <strong>Ignoring maintenance factor</strong> - Results show initial, not maintained
                values
              </li>
            </ul>
          }
