      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Inverse square:</strong> E = I/d² for direct illuminance
              </li>
              <li className="pl-1">
                <strong>Cosine correction:</strong> E = I × cos³θ/h² for angled rays
              </li>
              <li className="pl-1">
                <strong>Software tools:</strong> DIALux, Relux for complex designs
              </li>
              <li className="pl-1">
                <strong>Verification:</strong> Isolux diagrams and uniformity checks
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Task lighting:</strong> Verify illuminance at work positions
              </li>
              <li className="pl-1">
                <strong>Emergency lighting:</strong> Compliance with 1 lux minimum
              </li>
              <li className="pl-1">
                <strong>Floodlighting:</strong> Outdoor and sports lighting design
              </li>
              <li className="pl-1">
                <strong>Display lighting:</strong> Retail and museum applications
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The inverse square law is the fundamental principle governing how illuminance
              decreases with distance from a light source. Understanding this relationship is
              essential for all point illuminance calculations and forms the basis of lighting
              design.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Perpendicular incidence:</strong> Applies when light strikes surface at
                  90°
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Illuminance vs Distance Relationship
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Modern lighting design relies heavily on specialist software that can perform
              thousands of point calculations, model inter-reflections, and generate comprehensive
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Direct component from each luminaire summed
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Base calculation for all points
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Radiosity</td>
                      <td className="border border-white/10 px-3 py-2">
                        Iterative calculation of diffuse inter-reflections
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Follows individual light paths for specular reflection
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Statistical sampling of light paths
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Complex geometries, daylight modelling
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                Essential Input Data for Software
              </p>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Close spacing:</strong> Indicates rapid change in illuminance (steep
                  gradient)
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Closed loops:</strong> Show peaks (high values inside) or troughs (low
                  values inside)
                </li>
                <li className="pl-1">
                  <strong>Colour coding:</strong> Typically red/orange for high values, blue/purple
                  for low
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Uniformity Ratios to BS EN 12464-1
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        E<sub>min</sub> / E<sub>average</sub>
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        ≥ 0.6 for task areas, ≥ 0.4 for surroundings
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Used for specific applications (sports lighting)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Mean illuminance across calculation area
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Must meet maintained illuminance requirement
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Minimum point illuminance
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Critical for emergency lighting (≥ 1 lux)
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              ...
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
                <p className="text-sm font-medium text-orange-400 mb-2">
                  Common Design Issues Identified
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Multiple Luminaire Contribution
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Vertical Surface Illuminance
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Emergency Lighting Verification
              </h3>
              <p className="text-sm text-white mb-2">
          ...
          <div className="space-y-6">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2 font-mono">
                        U₀ = E<sub>min</sub> / E<sub>average</sub>
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Forgetting cos³θ term</strong> - Simple inverse square only applies
                  directly below
                </li>
                <li className="pl-1">
                  <strong>Incorrect angle measurement</strong> - θ is from nadir (vertical), not
                  from horizontal
                </li>
                <li className="pl-1">
                  <strong>Ignoring maintenance factor</strong> - Results show initial, not
                  maintained values
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs text-white">
              <div>
                ...
                <ul className="space-y-0.5">
                  ...
                  <li>
                    U₀ = E<sub>min</sub>/E<sub>average</sub> ≥ 0.6
                  </li>
                </ul>
              </div>
              <div>
