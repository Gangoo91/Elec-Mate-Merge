...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['42 kVAr', '25 kVAr', '55 kVAr', '75 kVAr'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['500 kVAr', '250 kVAr', '357 kVAr', '350 kVAr'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['0.90 lagging', '0.95 lagging or better', 'Unity (1.0)', '0.85 lagging'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['111 kVAr', '150 kVAr', '85 kVAr', '132 kVAr'],
    correctAnswer: 0,
    explanation:
      ...
      <HubBody>
        ...
        <ConceptBlock title="Reactive Power Fundamentals">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Power factor (pf):</strong> Dimensionless ratio P/S = cos φ, where φ is the
              phase angle between voltage and current
            </li>
          </ul>
          <p>
            <strong>Power Triangle Relationships</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>S² = P² + Q²:</strong> Pythagorean relationship — Finding any power component
            </li>
            <li>
              <strong>pf = P / S = cos φ:</strong> Power factor definition — Determining phase angle
            </li>
            <li>
              <strong>Q = P × tan φ:</strong> Reactive from real power — Calculating kVAr demand
            </li>
            <li>
              <strong>S = P / pf:</strong> Apparent from real power — Supply sizing calculations
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply capacity:</strong> Poor pf means higher kVA demand for the same kW load
            </li>
            <li>
            ...
            <li>
              <strong>Voltage regulation:</strong> High reactive current causes increased voltage
              drop
            </li>
          </ul>
          <p>
            <strong>Key principle:</strong> Improving power factor from 0.7 to 0.95 reduces apparent
            power by 26% - equivalent to increasing supply capacity without infrastructure upgrades.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Capacitor Bank Sizing and Selection">
          <p>
            Capacitors provide leading reactive power that cancels the lagging reactive power drawn
            by inductive loads. Correct sizing ensures the target power factor is achieved without
            over-correction, which would cause leading power factor and potential problems.
          </p>
          <p>
            <strong>Fixed Capacitor Banks</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Automatic PFC Banks</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Capacitor Sizing Calculation</strong>
          </p>
          ...
          <p>
            For 200 kW load: kVAr = 200 × 0.553 = <span>110.6 kVAr</span>
          </p>
          <p>
            <strong>Standard Capacitor Bank Ratings</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>5 kVAr:</strong> Small commercial, fine control — Contactor
            </li>
            <li>
              <strong>10 kVAr:</strong> Light industrial, retail — Contactor
            </li>
            <li>
              <strong>25 kVAr:</strong> Medium industrial — Contactor or thyristor
            </li>
            <li>
              <strong>50 kVAr:</strong> Heavy industrial — Contactor or circuit breaker
            </li>
            <li>
              <strong>100+ kVAr:</strong> Large industrial, substations — Circuit breaker
            </li>
          </ul>
          <p>
            <strong>Sizing tip:</strong> For automatic PFC, select stage sizes that provide adequate
            resolution. A 150 kVAr bank might use 6 × 25 kVAr or 5 × 25 kVAr + 5 × 5 kVAr for finer
            control.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Automatic Power Factor Correction">
          ...
          <p>
            <strong>Automatic PFC Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Current transformer (CT):</strong> Measures load current for pf calculation
              (typically 5A secondary)
            </li>
            <li>
          ...
          <p>
            <strong>Controller Operation Sequence</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1:</strong> Measure voltage and current — Determine load conditions
            </li>
            <li>
              <strong>2:</strong> Calculate power factor — Compare with target setpoint
            </li>
            <li>
              <strong>3:</strong> Determine correction needed — Calculate kVAr deficit/excess
            </li>
            <li>
              <strong>4:</strong> Check discharge time — Ensure capacitor ready for reconnection
            </li>
            <li>
              <strong>5:</strong> Switch appropriate stage — Add/remove capacitors
            </li>
            <li>
              <strong>6:</strong> Wait settling time — Allow system to stabilise
            </li>
          </ul>
          <p>
            <strong>Contactor Switching</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Thyristor Switching</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Harmonic Filters and Detuned Reactors">
          ...
          <p>
            <strong>Warning: Harmonic Resonance</strong>
          </p>
          <p>
            When system inductance (transformers, cables) resonates with capacitor banks at a
            harmonic frequency, currents at that frequency are amplified dramatically. This causes:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Detuning Reactor Principles</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Detuning factor (p):</strong> Expressed as percentage (typically 7%, 5.67%, or
              14%)
            </li>
            <li>
              <strong>Resonant frequency:</strong> f<sub>r</sub> = 50 / √p (for 7%: f <sub>r</sub> =
              189 Hz)
            </li>
            <li>
          ...
          <p>
            <strong>Detuning Factor Selection</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>5.67%:</strong> 210 Hz — Low harmonic environments (THD &lt;8%)
            </li>
            <li>
              <strong>7%:</strong> 189 Hz — Standard industrial (THD 8-15%)
            </li>
            <li>
              <strong>14%:</strong> 134 Hz — High harmonic environments (THD &gt;15%)
            </li>
          </ul>
          <p>
            <strong>Detuned vs Active Filters</strong>
          </p>
          <p>
            <strong>Detuned Reactors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            PFC equipment. Harmonic levels determine whether standard, detuned, or active solutions
            are required.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            kVAr = 300 × 0.635 = <span>190.5 kVAr</span>
          </p>
          ...
          <p>Annual savings:</p>
          <p>
            kVA saving: (4,000 - 3,160) × 12 = <span>£10,080</span>
          </p>
          <p>
            kVAr saving: (166 - 66) × 12 = <span>£1,200</span>
          </p>
          <p>
            Total annual saving: <span>£11,280</span>
          </p>
          <p>Payback (200 kVAr detuned bank ~£15,000 installed):</p>
          <p>
            Payback = £15,000 / £11,280 = <span>1.3 years</span>
          </p>
          <p>
          ...
          <p>
            kVAr = 45 × (0.698 - 0.329) = <span>16.6 kVAr</span>
          </p>
          <p>Selection:</p>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">LED technology</div>
          </button>
          <button
