...
const TITLE =
  'Safety Considerations Before and During Fault Finding - Level 3 Module 4 Section 1.4';
const DESCRIPTION =
  'Essential safe working practices, risk assessment, and safe isolation procedures for electrical fault diagnosis and rectification work.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Risk assessment comes first. Identify hazards (live working, working at height, asbestos, etc.), assess who might be harmed, and determine control measures. Many fault-finding tasks require safe isolation - this must be determined before work begins, not discovered mid-task.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      "Live working is only permitted when it's unreasonable for the work to be done dead, and then only with appropriate precautions. For fault finding, this means: dead test first where possible; only live test when you need to observe fault behaviour or measure operating voltages/currents that dead testing can't provide.",
  },
  {
    id: 'check-3',
    ...
    correctIndex: 2,
    explanation:
      'The safe isolation procedure is: Identify the circuit to be worked on; Isolate (switch off and lock off); Secure against re-energisation; Prove dead using a proved tester. Only then begin work. Skipping steps or changing the order creates danger.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 2,
    explanation:
      "A faulty voltage tester might not indicate voltage even when present. Proving the tester on a known live source before testing confirms it works. Proving it again after confirms it hasn't failed during use. This 'prove-test-prove' approach catches tester faults that could lead to fatal errors.",
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      "You arrive at a job where the customer reports a burning smell from a socket. What's your immediate priority?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'A burning smell indicates an active dangerous condition. Before any investigation, ensure the circuit is safely isolated to prevent fire and shock risks. The priority is making the situation safe, then investigating. Never investigate an active fault on a live circuit.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      "Suitable precautions for live working include: barriers to prevent inadvertent contact, insulated tools rated for the voltage, appropriate PPE (insulating gloves, eye protection), accompaniment by a competent person, limiting the work area and scope. 'Being careful' is not a control measure.",
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Lock-off devices should be used whenever you isolate for work. They physically prevent re-energisation and show the circuit is being worked on. Even brief work can result in electrocution if someone unknowingly switches the circuit back on. Use your lock, carry the key.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'If a protective device fails or an arc flash occurs, standing directly in front exposes you to the blast. Standing to the side reduces injury risk. While modern equipment is safer, faults can cause unexpected behaviour. This simple habit costs nothing and could prevent serious burns or eye injury.',
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      "As minimum: safety glasses protect against debris and minor arc flash; insulating gloves protect against contact with live parts. Additional PPE depends on circumstances - face shields for higher risk work, arc-rated clothing if arc flash risk is elevated. Domestic doesn't mean safe - fault currents can be very high.",
  },
  {
    id: 7,
    question:
      'You need to trace a live fault by measuring voltage at various points. What approach minimises risk?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'The one-hand technique prevents current flowing hand-to-hand across your heart - the most dangerous shock path. Keep your free hand behind your back or in your pocket. Use probes with insulated shafts and finger guards. This limits exposure even if you contact live parts accidentally.',
  },
  {
    id: 8,
    question:
      "A customer tells you they've 'turned off the circuit at the fuse box'. What should you do?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Never trust anyone else's isolation - always prove dead yourself using a proved voltage tester. The customer might have switched the wrong circuit, the MCB might not have fully opened, or the circuit might be fed from multiple sources. Your safety is your responsibility - prove it yourself.",
  },
  {
    id: 9,
    question:
      "What should you do if you discover a fault requires live testing but you don't feel competent to do it safely?",
    options: [
  ...
  },
  {
    id: 12,
    question:
      'After completing fault repairs, what safety check is essential before restoring supply?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Before restoring supply, verify: all covers are replaced (no exposed live parts), all terminations are secure (no loose conductors), insulation resistance is satisfactory (no short circuits or earth faults), polarity is correct, and any temporary arrangements have been removed. Energising an unsafe circuit creates immediate danger.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>First:</strong> Risk assess before any work begins
              </li>
              <li>
                <strong>Isolate:</strong> Identify, isolate, secure, prove dead
              </li>
              <li>
                <strong>Prove:</strong> Test your tester before AND after
              </li>
              <li>
                <strong>Live work:</strong> Only when absolutely necessary
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Multiple supplies or backfeeds
              </li>
              <li>
                <strong>Spot:</strong> Asbestos in older installations
              </li>
              <li>
                <strong>Use:</strong> Lock-off every time you isolate
              </li>
              <li>
                <strong>Use:</strong> One-hand technique for live testing
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Before beginning any fault finding work, assess the risks involved. Fault finding
              often requires working on electrical systems that have behaved unexpectedly - this
              inherent uncertainty demands careful hazard identification. A few minutes of risk
              assessment can prevent fatal accidents.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Electrical shock:</strong> From contact with live parts during testing or
                  investigation
                </li>
                <li>
                  <strong>Arc flash:</strong> From faults during testing or when operating
                  protective devices
                </li>
                <li>
                  <strong>Fire:</strong> From active faults or re-energising faulty circuits
                </li>
                <li>
                  <strong>Burns:</strong> From overheated components or arc flash
                </li>
                <li>
                  <strong>Working at height:</strong> Accessing distribution boards or tracing
                  cables
                </li>
                <li>
                  <strong>Asbestos:</strong> In older installations' equipment and building
                  materials
                </li>
              </ul>
            </div>
            ...
            <p>
              The fault you're investigating may itself create additional hazards. A fault that's
              causing overheating means hot components. A fault that's tripping devices
              unpredictably means the system is unstable. Factor the fault's nature into your risk
              assessment.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Risk assessment isn't paperwork - it's thinking. A mental
              walk-through of 'what could hurt me and how do I prevent it' before starting work is
              the core of risk assessment. Document it appropriately, but do the thinking
              regardless.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Safe isolation is the foundation of electrical safety. The procedure ensures that
              circuits are genuinely dead before you work on them, and that they cannot be
              re-energised by someone else while you're working. Every step matters - shortcuts
              kill.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>1. Identify:</strong> Confirm which circuit(s) to isolate
                  </li>
                  <li>
                    <strong>2. Isolate:</strong> Switch off at the point of isolation
                  </li>
                  <li>
                    <strong>3. Secure:</strong> Apply lock and warning notice
                  </li>
                  <li>
                    <strong>4. Prove:</strong> Prove tester, test circuit, prove tester
                  </li>
                  <li>
                    <strong>5. Work:</strong> Only now is it safe to begin
                  </li>
                </ul>
              </div>
              <div>
            ...
            <p>
              Why prove the tester twice? A voltage tester that fails during use might show 'dead'
              when the circuit is actually live. By checking it works both before and after testing
              the circuit, you catch tester failures. This simple step has prevented many
              fatalities.
            </p>
            ...
            <p className="text-sm text-white italic">
              ...
              works on the adjacent live circuit again. Now and only now do you begin work.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The Electricity at Work Regulations are clear: work should be done dead unless it's
              unreasonable in all circumstances. For fault finding, this creates a genuine dilemma -
              some faults can only be diagnosed while circuits are live. The law permits this, but
              requires rigorous precautions.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Dead testing cannot diagnose the fault (e.g., intermittent faults only appearing
                  under load)
                </li>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Required precautions for live work:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Competence:</strong> Only competent persons may work live; know your
                  limits
                </li>
                <li>
                  <strong>PPE:</strong> Insulating gloves, safety glasses/face shield, appropriate
                  clothing
                </li>
                <li>
                  <strong>Insulated tools:</strong> All tools must be insulated and rated for the
                  voltage
                </li>
                <li>
                  <strong>Barriers:</strong> Prevent inadvertent contact with live parts
                </li>
                <li>
                  <strong>Accompaniment:</strong> Second competent person present for rescue if
                  needed
                </li>
                <li>
                  <strong>Limited work area:</strong> Minimise exposed live parts and work scope
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Live working is a last resort, not a convenience. Every
              live working decision should be justifiable - 'I could have worked dead but chose not
              to' is indefensible if an accident occurs.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Personal Protective Equipment and properly rated test equipment form your final line
              of defence. They won't prevent faults, but they reduce the severity of harm if
              something goes wrong. Using inadequate or damaged PPE is not a calculated risk - it's
              negligence.
            </p>
            ...
            <p>
              GS38 specifies test probe requirements: maximum 4mm exposed metal (2mm preferred),
              finger barriers to prevent slip, fused leads for protection against fault current, and
              robust insulation. Your test equipment is only as safe as its weakest element -
            ...
            <p className="text-sm text-white italic">
              ...
              each use; replace damaged equipment immediately.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  Work dead where possible: Only go live when dead testing can't answer the question
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Trusting others' isolation</strong> - Always prove dead yourself
                </li>
                <li>
                  <strong>Skipping the second prove</strong> - Tester might have failed during use
                </li>
                <li>
                  <strong>Working live for convenience</strong> - Only when genuinely necessary
                </li>
                <li>
                  <strong>Using damaged PPE</strong> - Inspect before use; replace if in doubt
                </li>
              </ul>
            </div>
          </div>
