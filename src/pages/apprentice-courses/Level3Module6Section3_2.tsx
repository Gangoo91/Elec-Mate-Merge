      ...
      <div className="border-b border-white/10 sticky top-0 z-50 bg-[#1a1a1a]/95 backdrop-blur-sm">
        <div className="px-4 sm:px-6 py-2">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module6-section3">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Using BS 7671 Appendix 4 tables to determine cable ratings
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Define current-carrying capacity and its thermal basis",
              "Navigate BS 7671 Appendix 4 current rating tables",
              "Match installation methods to correct reference methods",
              "Read tabulated values for common cable types",
              "Understand why different methods give different ratings",
              "Select appropriate tables for various cable constructions"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module6-section3-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module6-section3-3">
