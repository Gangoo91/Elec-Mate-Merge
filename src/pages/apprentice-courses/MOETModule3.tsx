...
const sections = [
  ...
  },
  {
    ...
    icon: Cog,
    description: 'Motor operation, DOL and star-delta starters, VSDs and motor maintenance.',
  },
  {
    id: 3,
  ...
  {
    id: 6,
    title: 'Emerging technologies — renewables and smart systems',
    icon: Leaf,
...
export default function MOETModule3() {
  useSEO({
    ...
    description:
      'Switchgear, motors and drives, control panels, lighting, auxiliary systems and emerging technologies for maintenance engineers.',
  });
