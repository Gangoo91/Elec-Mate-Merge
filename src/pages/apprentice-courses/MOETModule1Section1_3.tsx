        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>LOTO:</strong> Prevents unexpected release of hazardous energy during
                maintenance
              </li>
              <li className="pl-1">
                <strong>7 energy types:</strong> Electrical, mechanical, hydraulic, pneumatic,
                thermal, chemical, gravitational
              </li>
              <li className="pl-1">
                <strong>6 steps:</strong> Prepare, shut down, isolate, lock/tag, verify, work
              </li>
              <li className="pl-1">
                <strong>Rule:</strong> One person, one lock, one key — only you remove your lock
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              servicing, or repair work begins. The 'lock-out' element involves applying a physical
              lock to an energy isolating device, preventing it from being operated. The 'tag-out'
              element involves attaching a warning tag that identifies who applied the lock, when,
              and why.
            </p>
            <p>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              <p className="text-sm font-medium text-red-400 mb-2">
                The Human Cost of LOTO Failure
              </p>
              <p className="text-sm text-white mb-3">
                HSE data consistently shows that failure to control hazardous energy is one of the
                leading causes of workplace fatalities in the UK. Across all industries,
                LOTO-related incidents cause significant numbers of deaths and major injuries
                annually. In the electrical sector specifically, failures include electrocution from
                unexpected energisation, burns from arc flash on supposedly isolated switchgear, and
                injuries from machinery restarting during maintenance.
              </p>
              <p className="text-sm text-white">
                The common thread in most incidents is not a lack of equipment or knowledge — it is
                a failure to follow the procedure. Shortcuts, complacency, and time pressure are the
                real killers.
              </p>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Legal Framework for LOTO in the UK
              </p>
              <p className="text-sm text-white mb-3">
                ...
                Instead, LOTO requirements are derived from several overlapping pieces of
                legislation:
              </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              standard requires you to demonstrate competence in energy isolation and LOTO
              procedures as part of the safe working practices knowledge and skills requirements.
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              of the equipment's design, operation, and interconnections. Missing even one energy
              source can be fatal. For electrical maintenance technicians, the challenge is that
              modern equipment often combines multiple energy types in a single system.
            </p>

            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                  The Seven Categories of Hazardous Energy
                </h3>
                <div className="space-y-3">
                  <div className="p-3 rounded bg-blue-500/10 border border-blue-500/20">
                    ...
                    <p className="text-xs text-white">
                      ...
                      energy can cause electrocution, burns, and arc flash.
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded bg-green-500/10 border border-green-500/20">
                    ...
                    <p className="text-xs text-white">
                      ...
                      the skin — is a medical emergency.
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded bg-amber-500/10 border border-amber-500/20">
                    ...
                    <p className="text-xs text-white">
                      ...
                      electrical maintenance. Chemical energy can cause burns, poisoning, and
                      asphyxiation.
                    </p>
                  </div>
                  <div className="p-3 rounded bg-orange-500/10 border border-orange-500/20">
                    ...
                    <p className="text-xs text-white">
                      ...
                      switchgear compartments are common examples in electrical maintenance.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-3">
                Energy Source Identification for Common Electrical Equipment
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Capacitor banks, spring-charged breakers
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Variable Speed Drive</td>
                      <td className="border border-white/10 px-3 py-2">
                        Electrical (AC supply + DC bus)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        DC bus capacitors (300-800V DC for several minutes)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">HV Switchgear</td>
                      <td className="border border-white/10 px-3 py-2">
                        Electrical (HV + LV control), mechanical
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Spring mechanisms, cable capacitance
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">UPS System</td>
                      <td className="border border-white/10 px-3 py-2">
                        Electrical (mains + battery + output)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Battery bank, DC bus capacitors
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Hydraulic Press</td>
                      <td className="border border-white/10 px-3 py-2">
                        Electrical (motor), hydraulic, gravitational
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Pressurised accumulator, raised ram
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Never assume you know all the energy sources from memory
              alone. Always consult the equipment manual, site documentation, and plant drawings. If
              in doubt, ask — it is far better to delay the work than to miss a hidden energy
              source.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 space-y-3">
              ...
              {[
                ...
                },
                {
                  ...
                  bg: 'bg-purple-500/10',
                  content:
                    'Stop the equipment using the normal operating procedures and controls. This controlled shutdown prevents additional hazards that could arise from an abrupt stop — for example, a sudden stop of a pump could cause water hammer, or an uncontrolled motor stop could damage the drive system. Never start the LOTO process by going directly to the isolation devices.',
                },
                {
                  step: '3',
                  title: 'Isolate',
                ...
                },
                {
                  ...
                  bg: 'bg-amber-500/10',
                  content:
                    'Apply your personal safety padlock to each energy isolating device. Attach a completed danger tag to each lock identifying you as the person who applied it. If multiple workers are involved, apply a multi-lock hasp first, then each worker applies their own lock. For complex isolations with many points, use a group lockout box system.',
                },
                {
                  step: '5',
                ...
                },
                {
                  ...
                  content:
                    'Only after all energy sources have been isolated, locked, tagged, and verified may the maintenance work begin. Throughout the work, the locks and tags must remain in place. If the scope of work changes, stop and reassess whether additional energy sources need to be isolated. When work is complete, follow the controlled re-energisation procedure.',
                },
              ].map((item) => (
                <div
                  key={item.step}
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30">
              ...
              <p className="text-sm text-white">
                ...
                and replaces it with physical evidence. Never skip this step.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="p-3 rounded bg-white/5">
                  ...
                  <ul className="text-xs text-white space-y-1 list-disc list-outside ml-4">
                    ...
                    <li>
                      No one can access the isolation keys until all personal locks are removed
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              <h3 className="text-sm font-medium text-orange-400 mb-3">
                Shift Changeover — The Critical Gap
              </h3>
              <p className="text-sm text-white mb-3">
              ...
              <div className="bg-black/30 p-3 rounded text-sm text-white">
                ...
                <p>
                  ...
                  <span className="text-green-400 font-medium">
                    Incoming worker applies their personal lock
                  </span>
                </p>
                <p>
                  4.{' '}
                  <span className="text-amber-400 font-medium">
                    Outgoing worker removes their personal lock
                  </span>
                </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                Periodic Inspection of LOTO Procedures
              </h3>
              <p className="text-sm text-white mb-3">
                LOTO procedures must be formally inspected at regular intervals to ensure they
                remain effective and are being correctly followed. Best practice requires annual
                inspections, though more frequent reviews may be appropriate for high-risk
                activities.
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Scope:</strong> Observe the procedure being carried out, interview
                  workers, check equipment condition
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Documentation:</strong> Record the inspection findings, corrective
                  actions, and date of next review
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                In exceptional circumstances, it may be necessary to remove a lock when the person
                who applied it is not available. This is a last resort and must follow a formal,
                documented procedure:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  All reasonable efforts to contact the lock owner have been exhausted
                </li>
                <li className="pl-1">
                  A senior authorised person has assessed that it is safe to remove the lock
                </li>
                <li className="pl-1">
                  A thorough check of the work area confirms no one is at risk
                </li>
                <li className="pl-1">
                  The removal is authorised in writing by a named senior manager
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  The incident is documented and reviewed to prevent recurrence
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">
                    <strong>Main incoming supply:</strong> Isolate at the incoming
                    switch-disconnector and lock off
                  </li>
                  <li className="pl-1">
                  ...
                  <li className="pl-1">
                    <strong>Power factor correction capacitors:</strong> Retain charge after
                    isolation — verify discharge (wait for bleed-down time, typically 1-5 minutes)
                  </li>
                  <li className="pl-1">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    <strong>Verification:</strong> Check the 'DC bus active' or 'charge' indicator
                    LED; measure DC bus voltage with an approved instrument
                  </li>
                  <li className="pl-1">
                    <strong>Never assume:</strong> Even if the display is blank, the DC bus may
                    still be charged — always measure
                  </li>
                </ul>
              </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              <p className="text-sm font-medium text-red-400 mb-2">
                Common LOTO Failures in Electrical Maintenance
              </p>
              <ul className="text-sm text-white space-y-2 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Incomplete energy survey:</strong> Failing to identify all energy sources
                  — especially stored energy in capacitors, springs, and elevated loads.{' '}
                  <span className="text-green-400">
                    Prevention: Always use a documented Energy Isolation Procedure specific to the
                    equipment.
                  </span>
                </li>
                <li className="pl-1">
                  <strong>Tags without locks:</strong> Using danger tags as the sole means of
                  protection, without padlocks. Tags can be ignored or removed.{' '}
                  <span className="text-green-400">
                    Prevention: Always use locks AND tags together.
                  </span>
                </li>
                <li className="pl-1">
                  <strong>Skipping verification:</strong> Failing to verify that isolation is
                  effective after applying locks.{' '}
                  <span className="text-green-400">
                    Prevention: Always perform the Prove-Test-Prove sequence for electrical energy,
                    and physical verification for all other energy types.
                  </span>
                </li>
                <li className="pl-1">
                  <strong>Improper lockout devices:</strong> Using cable ties, tape, or ill-fitting
                  devices that do not properly secure the isolating device.{' '}
                  <span className="text-green-400">
                    Prevention: Use only purpose-designed LOTO devices matched to the specific
                    equipment.
                  </span>
                </li>
                <li className="pl-1">
                  <strong>Complacency on routine tasks:</strong> Believing that familiar equipment
                  does not need full LOTO because 'I've done this a hundred times.'{' '}
                  <span className="text-green-400">
                    Prevention: Follow the full procedure every time, without exception.
                  </span>
                </li>
                <li className="pl-1">
                  <strong>Poor shift handover:</strong> Removing locks at shift end without ensuring
                  continuity of lockout by the incoming shift.{' '}
                  <span className="text-green-400">
                    Prevention: Incoming lock applied before outgoing lock removed.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                Case Study: The Hidden Energy Source
              </h3>
              <p className="text-sm text-white">
                ...
                section and applied a personal lock. However, the control circuit for the starter
                was fed from a separate 110V control transformer, located in a different section of
                the MCC. When the technician disconnected the contactor coil wires, they received a
                110V shock. The investigation found that the Energy Isolation Procedure for the MCC
                had not been updated after a modification that added the separate control supply.
                The technician survived, but the incident highlighted the critical importance of
                verifying that documented procedures reflect the current state of the installation.
              </p>
            </div>
            ...
            <p className="text-sm text-white italic">
              ...
              demonstrating compliance with this regulation. LOTO is not optional — it is a legal
              requirement for electrical maintenance.
            </p>
          </div>
        </section>
