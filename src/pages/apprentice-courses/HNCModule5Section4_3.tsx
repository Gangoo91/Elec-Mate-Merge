...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'To record installation dates',
      'To list subcontractor details',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Only the manufacturer's address",
  ...
  },
  {
    ...
    options: [
      ...
      'That the contractor prefers it',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1 day', '7-14 days', '3 months', 'No time limit'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Approved', 'Approved as noted', 'Rejected - resubmit', 'For information only'],
    correctAnswer: 2,
    explanation:
