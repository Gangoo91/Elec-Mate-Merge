...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['3 years', '6 years', '5 years', '4 years'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['£28,800', '£-8,000', '£12,122', '£20,122'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1.5 years', '3 years', '25 years', '6 years'],
    correctAnswer: 3,
    explanation:
...
const HNCModule6Section5_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 5 · Subsection 6"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              IPMVP options: Option A = retrofit isolation with key parameter measurement; Option B
              = retrofit isolation with all-parameter measurement; Option C = whole-facility
              metering; Option D = calibrated simulation. Option C is most common for whole-building
              ECMs (BMS, lighting, HVAC); Option A for isolated equipment swaps. M&V plan must be
              agreed before implementation, not constructed afterwards.
            </>
          }
        ...
        <ConceptBlock title="ECM Identification and Categories">
          <p>
            ...
            identification requires systematic assessment of building systems, operational patterns,
            and occupant needs.
          </p>
          <p>
            <strong>ECM Categories by Investment Level:</strong>
          </p>
          ...
          <p>
            <strong>Common ECMs in Building Services</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lighting:</strong> LED retrofit, daylight linking, occupancy control — 40-70%
            </li>
            <li>
              <strong>HVAC:</strong> VSD on fans/pumps, economiser cycles, heat recovery — 20-40%
            </li>
            <li>
              <strong>Controls:</strong> BMS optimisation, weather compensation, scheduling — 10-25%
            </li>
            <li>
              <strong>Motors:</strong> IE4/IE5 motors, VSD retrofit, right-sizing — 15-35%
            </li>
            <li>
              <strong>Building fabric:</strong> Insulation upgrade, glazing replacement, air
              tightness — 10-30%
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Payback Analysis and Financial Metrics">
          <p>
            ...
            metrics suit different purposes - from quick screening to detailed investment appraisal.
          </p>
          <p>
          ...
          <p>
            <strong>Life Cycle Costing (LCC)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Payback Calculation Examples</strong>
          </p>
          <p>Simple Payback:</p>
          ...
          <p>
            <strong>Typical Payback Expectations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Controls/operational:</strong> 0-1 years — Immediate implementation
            </li>
            <li>
              <strong>LED lighting:</strong> 2-4 years — Up to 5 years
            </li>
            <li>
              <strong>VSD retrofits:</strong> 2-4 years — Up to 5 years
            </li>
            <li>
              <strong>HVAC plant replacement:</strong> 5-10 years — Up to equipment life
            </li>
            <li>
              <strong>Building fabric:</strong> 10-20 years — Building lifecycle
            </li>
          </ul>
          <p>
            <strong>Best practice:</strong> Use simple payback for initial screening, then apply NPV
            or LCC for measures that pass preliminary criteria.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Implementation Priorities and Planning">
          <p>
            Prioritising ECMs requires balancing multiple factors beyond simple financial return. A
            structured approach ensures resources target the most effective measures while managing
            risk and building organisational capability.
          </p>
          <p>
            <strong>ECM Prioritisation Matrix</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Payback period:</strong> &lt; 3 years — &gt; 7 years
            </li>
            <li>
              <strong>Implementation risk:</strong> Proven technology, minimal disruption — Novel
              technology, major works
            </li>
            <li>
              <strong>Energy savings %:</strong> &gt; 20% of system consumption — &lt; 5% of system
              consumption
            </li>
            <li>
              <strong>Co-benefits:</strong> Improved comfort, reduced maintenance — Energy only
            </li>
            <li>
              <strong>Strategic alignment:</strong> Supports carbon targets, regulations — No
              strategic drivers
            </li>
          </ul>
          <p>
            <strong>Implementation Sequencing Strategy</strong>
          </p>
          <p>
            <strong>Key implementation considerations:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Interactions:</strong> Some ECMs affect others - install controls before plant
              upgrades to right-size equipment
            </li>
            <li>
              <strong>Funding:</strong> Match ECM timing to budget cycles and available financing
              mechanisms
            </li>
            <li>
              <strong>Disruption:</strong> Schedule disruptive measures during building closures or
              low-occupancy periods
            </li>
            <li>
              <strong>Dependencies:</strong> Ensure enabling works (sub-metering, BMS points) are
              completed first
            </li>
            <li>
        ...
        <ConceptBlock title="Measurement, Verification and Avoiding Rebound">
          ...
          <p>
            <strong>IPMVP Options</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>A: Key Parameter:</strong> Measure key parameter (e.g., kW), estimate others —
              Lighting, constant loads
            </li>
            <li>
              <strong>B: All Parameters:</strong> Measure all parameters at retrofit level — Motors,
              VSDs, specific systems
            </li>
            <li>
              <strong>C: Whole Facility:</strong> Use utility meters, adjust for independent
              variables — Multiple ECMs, whole building
            </li>
            <li>
              <strong>D: Simulation:</strong> Calibrated simulation modelling — Complex buildings,
              new construction
            </li>
          </ul>
          <p>
            <strong>M&V Calculation Formula</strong>
          </p>
          ...
          <p>
            <strong>Understanding the Rebound Effect</strong>
          </p>
          <p>
            The rebound effect occurs when efficiency improvements lead to increased consumption
            that partially offsets expected savings. Research suggests 10-30% of theoretical savings
            may be lost to rebound in commercial buildings.
          </p>
          <p>
          ...
          <p>
            <strong>Rebound Mitigation Strategies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Maintain visibility:</strong> Install energy dashboards and regular reporting
            </li>
            <li>
            ...
            <li>
              <strong>M&V baseline:</strong> Include realistic behavioural assumptions in baseline
              calculations
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> A VSD retrofit on a 37 kW chiller pump operating 4,000 hours
            annually.
          </p>
          <p>Given data:</p>
          ...
          <p>
            <strong>Scenario:</strong> Compare two lighting options for a warehouse over 15 years at
            5% discount rate.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Verify heating savings after boiler upgrade using degree day
            adjustment.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Optimistic savings estimates:</strong> Use conservative figures and validate
        ...
        <Scenario
          ...
          situation={
            <>
              An Energy Performance Contract (EPC) was signed for a hospital lighting upgrade — the
              contractor guaranteed 35% savings vs baseline. After 12 months, the contractor claims
              £180k savings achieved; the client's metered data shows only 22% reduction. There is
              no agreed M&V plan and no isolated lighting metering.
            </>
          }
          whatToDo={
            <>
              Adversarial situation — neither party can prove their position. Three options: (1)
              install retrospective lighting circuit metering, run a 6-month verification period,
              then reconcile; (2) appoint an independent IPMVP CMVP (Certified Measurement and
              Verification Professional) to adjudicate using available data and engineering
              analysis; (3) settle on a negotiated figure to avoid litigation. Lesson: every EPC
              contract must have an IPMVP-compliant M&V plan signed before implementation, with
              measurement points, baseline, adjustment routines and reporting frequency.
            </>
          }
          whyItMatters={
            <>
              Most claimed energy savings are aspirational — measurement is the difference between
              claimed and verified. EPCs (Energy Performance Contracts) are commercially structured
              around verified savings; without IPMVP M&V, both parties are exposed. Plan M&V before
