      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>IDP:</strong> All disciplines collaborate from project inception
              </li>
              <li className="pl-1">
                <strong>Early MEP:</strong> Influence form before fixing design
              </li>
              <li className="pl-1">
                <strong>Value engineering:</strong> Whole-life, not just capital cost
              </li>
              <li className="pl-1">
                <strong>Soft landings:</strong> Bridge design-to-operation gap
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>RIBA stages:</strong> Sustainability at Stage 0-1
              </li>
              <li className="pl-1">
                <strong>BIM Level 2:</strong> Federated model coordination
              </li>
              <li className="pl-1">
                <strong>Performance gap:</strong> 2-10x actual vs predicted
              </li>
              <li className="pl-1">
                <strong>POE:</strong> Minimum 3 years post-handover
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The integrated design process (IDP) fundamentally differs from traditional linear
              design approaches. Rather than passing design between disciplines in sequence, IDP
              brings together all stakeholders from project inception to collaborate on holistic
              solutions that embed sustainability throughout.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Key principles of integrated design:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Early collaboration:</strong> All disciplines engaged from Stage 0-1, not
                  just architect-led
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Performance-based targets:</strong> Define outcomes (energy, carbon,
                  comfort) not just specifications
                </li>
                <li className="pl-1">
                  <strong>Iterative optimisation:</strong> Test and refine solutions through
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Sequential, discipline-by-discipline
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Concurrent, multi-disciplinary
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Embedded from project start
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Passive strategies</td>
                      <td className="border border-white/10 px-3 py-2">
                        Limited by fixed architecture
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Maximised through early input
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              ...
              <p className="text-sm text-white">
                ...
                of changes. Integrated design deliberately front-loads collaboration when influence
                is highest.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key insight:</strong> Early engagement is not just about starting sooner -
              it's about ensuring MEP input shapes fundamental decisions about building form,
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                BIM Coordination for Sustainability
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Optimise services routing, reduce materials
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Test design options against energy targets
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Optimise glazing and artificial lighting
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Plan logistics to reduce site transport
                      </td>
            ...
            <div className="my-6 p-4 rounded-lg bg-green-500/10 border border-green-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Facilitate:</strong> Use an independent facilitator for complex or
                  contentious issues
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              (fortnightly minimum) throughout design development to catch clashes early and
              maintain design alignment.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              sustainability activities with RIBA stages ensures targets are set early, tested
              through design development, and verified in construction and operation.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Sustainability Activities by RIBA Stage
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Set sustainability aspirations, identify targets (BREEAM, net zero, etc.)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">1 Preparation & Brief</td>
                      <td className="border border-white/10 px-3 py-2">
                        Develop sustainability brief, site analysis, establish energy strategy
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">2 Concept Design</td>
                      <td className="border border-white/10 px-3 py-2">
                        Passive design options, initial energy modelling, BREEAM pre-assessment
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">3 Spatial Coordination</td>
                      <td className="border border-white/10 px-3 py-2">
                        Detailed energy modelling, services coordination, embodied carbon assessment
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">4 Technical Design</td>
                      <td className="border border-white/10 px-3 py-2">
                        Specification completion, compliance calculations, commissioning plan
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Site waste management, sustainable procurement, commissioning
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">6 Handover</td>
                      <td className="border border-white/10 px-3 py-2">
                        Building log book, training, metering setup, BREEAM certification
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">7 Use</td>
                      <td className="border border-white/10 px-3 py-2">
                        POE, seasonal commissioning, performance monitoring, aftercare
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Stage 3 freeze:</strong> Lock building form, orientation, fabric
                  performance, major systems strategy
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              handover and early occupation, soft landings bridges the gap between design intent and
              operational reality.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Government Soft Landings (GSL) Framework
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Define operational requirements, success criteria
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Review design against operational needs
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Commissioning planning, reality checking
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Training, documentation, initial occupation support
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        POE, seasonal commissioning, performance review
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-purple-500/10 border border-purple-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Installation quality:</strong> Air leakage, thermal bridging, controls
                  errors
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Occupant behaviour:</strong> Opening windows with heating on, lights left
                  on
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Install sub-metering for all major energy uses (lighting, HVAC, small power,
                  lifts)
                </li>
                <li className="pl-1">
                  Establish BMS data logging with appropriate trending intervals
                </li>
                <li className="pl-1">
                  Create baseline predictions for comparison (monthly profiles)
                </li>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Early MEP Engagement Influence
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-red-400">
                  Result: Full mechanical HVAC, energy target missed by 35%
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Value Engineering Assessment
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: POE Performance Gap Analysis
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="ml-4 text-yellow-400">
                  Cooling: BMS setpoints 2°C lower than design, economiser disabled
                </p>
                <p className="ml-4 text-yellow-400">
                  Lighting: Daylight dimming not commissioned, occupancy sensors bypassed
                </p>
                <p className="ml-4 text-yellow-400">
                  Small power: 30% more equipment than design assumption
                </p>
                <p className="mt-2 text-green-400">
                  Actions: Seasonal commissioning + training = 25% reduction expected
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Test design options against performance criteria iteratively
                </li>
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Key Stages for MEP Sustainability Input
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">Stage 0: Sustainability targets, energy strategy direction</li>
                <li className="pl-1">
                  Stage 1: Site analysis, passive design potential, system concepts
                </li>
                <li className="pl-1">
                  Stage 2: Detailed energy modelling, system selection, renewables sizing
                </li>
                <li className="pl-1">
                  Stage 3: Services coordination, controls strategy, metering specification
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>VE as cost-cutting:</strong> Sustainability features removed to save
                  capital
                </li>
              </ul>
            </div>
