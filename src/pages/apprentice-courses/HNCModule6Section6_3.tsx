...
const HNCModule6Section6_3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 6 · Subsection 3"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ISO 19650 is the BIM information management standard — replacing PAS 1192. The CDE
              (Common Data Environment) is mandatory. BSRIA Soft Landings is the operational
              complement — ensuring the building delivered actually performs as designed. Both are
              increasingly contractual on major UK projects.
            </>
          }
        ...
        <ConceptBlock title="Integrated Design Process Fundamentals">
          ...
          <p>
            <strong>Key principles of integrated design:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Early collaboration:</strong> All disciplines engaged from Stage 0-1, not just
              architect-led
            </li>
            <li>
              <strong>Whole-systems thinking:</strong> Consider interactions between building
              elements, not isolated systems
            </li>
            <li>
              <strong>Performance-based targets:</strong> Define outcomes (energy, carbon, comfort)
              not just specifications
            </li>
            <li>
              <strong>Iterative optimisation:</strong> Test and refine solutions through analysis
              and feedback loops
            </li>
          </ul>
          <p>
            <strong>Traditional vs Integrated Approach</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>MEP involvement:</strong> Stage 2-3 onwards — Stage 0-1 from inception
            </li>
            <li>
              <strong>Design approach:</strong> Sequential, discipline-by-discipline — Concurrent,
              multi-disciplinary
            </li>
            <li>
              <strong>Sustainability:</strong> Added to meet requirements — Embedded from project
              start
            </li>
            <li>
              <strong>Passive strategies:</strong> Limited by fixed architecture — Maximised through
              early input
            </li>
            <li>
              <strong>Cost of changes:</strong> High - late discovery — Low - early resolution
            </li>
          </ul>
          <p>
            <strong>The MacLeamy Curve</strong>
          </p>
          <p>
            The MacLeamy curve demonstrates that design effort applied early has the greatest impact
            on project outcomes at the lowest cost. Moving effort forward (left on the curve)
          ...
          <p>
            <strong>Key insight:</strong> Early engagement is not just about starting sooner - it's
            about ensuring MEP input shapes fundamental decisions about building form, orientation,
            and fabric.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Design Workshops and BIM Coordination">
          <p>
            Effective integrated design requires structured opportunities for collaboration. Design
            workshops, charrettes, and BIM coordination meetings provide forums for
            multi-disciplinary problem-solving and conflict resolution.
          </p>
          <p>
            <strong>Design Charrettes</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Technical Workshops</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>BIM Coordination for Sustainability</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Clash detection:</strong> Optimise services routing, reduce materials —
              Navisworks, Solibri
            </li>
            <li>
              <strong>Energy analysis:</strong> Test design options against energy targets — IES VE,
              DesignBuilder
            </li>
            <li>
              <strong>Daylight simulation:</strong> Optimise glazing and artificial lighting —
              Radiance, DIVA, Sefaira
            </li>
            <li>
              <strong>Quantity take-off:</strong> Calculate embodied carbon from materials — One
              Click LCA, eToolLCD
            </li>
            <li>
              <strong>4D simulation:</strong> Plan logistics to reduce site transport — Synchro,
              Navisworks
            </li>
          </ul>
          <p>
            <strong>Workshop Best Practice</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Facilitate:</strong> Use an independent facilitator for complex or contentious
              issues
            </li>
            <li>
              <strong>Visualise:</strong> Use models, drawings, and simulations to support
              discussion
            </li>
            <li>
              <strong>Record:</strong> Document decisions, actions, and rationale immediately
            </li>
            <li>
              <strong>Follow up:</strong> Distribute minutes within 48 hours, track action
              completion
            </li>
          </ul>
          <p>
            <strong>Coordination tip:</strong> Schedule regular BIM coordination meetings
            (fortnightly minimum) throughout design development to catch clashes early and maintain
            design alignment.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="RIBA Stages and Value Engineering">
          <p>
            ...
            sustainability activities with RIBA stages ensures targets are set early, tested through
            design development, and verified in construction and operation.
          </p>
          <p>
            <strong>Sustainability Activities by RIBA Stage</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>0 Strategic Definition:</strong> Set sustainability aspirations, identify
              targets (BREEAM, net zero, etc.)
            </li>
            <li>
              <strong>1 Preparation & Brief:</strong> Develop sustainability brief, site analysis,
              establish energy strategy
            </li>
            <li>
              <strong>2 Concept Design:</strong> Passive design options, initial energy modelling,
              BREEAM pre-assessment
            </li>
            <li>
              <strong>3 Spatial Coordination:</strong> Detailed energy modelling, services
              coordination, embodied carbon assessment
            </li>
            <li>
              <strong>4 Technical Design:</strong> Specification completion, compliance
              calculations, commissioning plan
            </li>
            <li>
              <strong>5 Manufacturing & Construction:</strong> Site waste management, sustainable
              procurement, commissioning
            </li>
            <li>
              <strong>6 Handover:</strong> Building log book, training, metering setup, BREEAM
              certification
            </li>
            <li>
              <strong>7 Use:</strong> POE, seasonal commissioning, performance monitoring, aftercare
            </li>
          </ul>
          <p>
            <strong>Value Engineering: Right Approach</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Design freeze considerations:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stage 3 freeze:</strong> Lock building form, orientation, fabric performance,
              major systems strategy
            </li>
            <li>
              <strong>Stage 4 freeze:</strong> Lock specifications, product selections, detailed
              performance criteria
            </li>
            <li>
              <strong>Post-freeze changes:</strong> Require formal change control with impact
              assessment on sustainability targets
            </li>
          </ul>
          <p>
            <strong>VE principle:</strong> If a VE proposal cannot demonstrate neutral or positive
            whole-life value impact, it is cost-cutting, not value engineering.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Soft Landings and Post-Occupancy Evaluation">
          <p>
            The soft landings approach addresses the common problem of buildings failing to perform
            as designed in operation. By maintaining design team involvement through handover and
            early occupation, soft landings bridges the gap between design intent and operational
            reality.
          </p>
          <p>
            <strong>Government Soft Landings (GSL) Framework</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Briefing:</strong> Gateway 1 — Define operational requirements, success
              criteria
            </li>
            <li>
              <strong>Design:</strong> Gateway 2 — Review design against operational needs
            </li>
            <li>
              <strong>Construction:</strong> Gateway 3 — Commissioning planning, reality checking
            </li>
            <li>
              <strong>Handover:</strong> Gateway 4 — Training, documentation, initial occupation
              support
            </li>
            <li>
              <strong>In-use:</strong> Gateway 5 — POE, seasonal commissioning, performance review
            </li>
          </ul>
          <p>
            <strong>Extended Aftercare Timeline</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Month 1-3:</strong> Intensive support, weekly reviews
            </li>
            <li>
              <strong>Month 4-12:</strong> Monthly reviews, seasonal commissioning
            </li>
            <li>
              <strong>Year 2:</strong> Quarterly reviews, performance fine-tuning
            </li>
            <li>
              <strong>Year 3:</strong> Annual review, lessons learned report
            </li>
          </ul>
          <p>
            <strong>POE Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Energy performance:</strong> Actual vs predicted consumption
            </li>
            <li>
              <strong>Occupant satisfaction:</strong> Comfort, functionality surveys
            </li>
            <li>
              <strong>Systems performance:</strong> Commissioning verification
            </li>
            <li>
              <strong>Maintenance review:</strong> Issues log, remediation tracking
            </li>
          </ul>
          <p>
            <strong>Addressing the Performance Gap</strong>
          </p>
          <p>
            The performance gap - where buildings use 2-10 times more energy than predicted - has
            multiple causes that soft landings helps address:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design assumptions:</strong> Unrealistic occupancy, equipment loads, operating
              hours
            </li>
            <li>
              <strong>Installation quality:</strong> Air leakage, thermal bridging, controls errors
            </li>
            <li>
              <strong>Commissioning gaps:</strong> Incomplete testing, suboptimal settings
            </li>
            <li>
              <strong>Occupant behaviour:</strong> Opening windows with heating on, lights left on
            </li>
            <li>
              <strong>FM capability:</strong> Complex systems not understood or maintained
            </li>
          </ul>
          <p>
            <strong>POE preparation checklist:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Install sub-metering for all major energy uses (lighting, HVAC, small power, lifts)
            </li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> A commercial office project where MEP was engaged at Stage 1
            vs a similar project where engagement was delayed to Stage 3.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Evaluate a VE proposal to substitute specified LED luminaires
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Late MEP appointment:</strong> Building form fixed before services input
            </li>
            <li>
              <strong>Siloed design:</strong> Each discipline optimises independently
            </li>
            <li>
              <strong>Paper coordination:</strong> No proper BIM clash detection
            </li>
            <li>
              <strong>VE as cost-cutting:</strong> Sustainability features removed to save capital
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A federated BIM model on a 12-storey hospital reaches Stage 4 (Technical Design). MEP
              has routed 1,200 mm twin-wall ductwork through what structural has now identified as a
              primary transfer beam zone. Resolution requires either MEP re-routing (4-week design +
              procurement re-issue) or structural re-design (6-week + Building Control
              re-submission).
            </>
          }
          whatToDo={
            <>
              Convene a clash resolution meeting using the federated model — MEP, structural,
              architectural together. Most clashes have a coordination solution that is cheaper than
              either single-discipline rework: typically MEP routes around with shallower duct
              (parallel runs), structural penetrates with engineered openings, or architecture
              compromises ceiling void. Update the BIM model and re-run clash detection. Lesson:
              Stage 3 spatial coordination should have caught this — Stage 4 clashes are
              programme-critical.
            </>
          }
          whyItMatters={
            <>
              BIM clashes at Stage 4+ are the most expensive errors on a project — programme drives
              commercial loss. Investment in Stage 2/3 coordination (regular ICE — Integrated
              Concurrent Engineering — sessions, weekly federated model reviews) pays for itself
              many times over. The clash report is a project-management dashboard, not just a
              technical document.
            </>
          }
        />
