    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Apply scientific principles using industry-standard tools and methods to design and verify
          building services performance
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers practical application of building services science using CIBSE load
          estimation methods, dynamic simulation software, energy analysis techniques, and
          compliance verification against Part L, BREEAM and other standards.
        </p>
