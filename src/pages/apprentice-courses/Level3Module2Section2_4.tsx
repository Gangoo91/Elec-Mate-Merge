      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Understanding demand management and diversity in electrical installations
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              ...
              "BS7671 diversity assessment guidance",
              "Demand-side response principles",
              "Load shedding and management systems",
              "Time-of-use tariffs and smart charging",
              "Future grid challenges and solutions"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module2-section2-5">
              Next Section
