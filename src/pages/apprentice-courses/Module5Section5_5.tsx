...
const TITLE =
  'Attending Briefings, Toolbox Talks, and Site Meetings - Module 5.5.5 | Level 2 Electrical Course';
const DESCRIPTION =
  'Learn the importance of attending briefings, toolbox talks, and site meetings. Essential communication skills and responsibilities for electrical professionals.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Toolbox talks are short sessions focused on safety topics to ensure everyone is aware of current hazards and safety procedures.',
  },
  {
    id: 2,
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Toolbox talks are short sessions focused on safety topics to ensure all workers are aware of current hazards and safety procedures.',
    },
    {
      id: 2,
      question: 'True or False: Attendance at toolbox talks is optional.',
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Not paying attention and missing key safety points or instructions is a serious mistake that can lead to accidents and delays.',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'You should bring a notebook or use your phone (if permitted) to record key points and action items from meetings.',
    },
    {
      id: 10,
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white text-sm space-y-1">
                  ...
                  <li>
                    • <strong>Use:</strong> Listen actively, take notes, ask questions
                  </li>
                  <li>
                    • <strong>Check:</strong> Attendance recorded, actions understood
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-red-500/5 border-l-2 border-red-500/50">
                ...
                <ul className="text-sm space-y-2 text-white">
                  ...
                  <li>
                    • <strong className="text-white">Causing distractions:</strong> Interrupting
                    speakers, loud conversations, making jokes during safety discussions
                  </li>
                  <li>
                    • <strong className="text-white">Failing to act:</strong> Not following through
                    on tasks, ignoring new procedures, forgetting deadlines
                  </li>
                </ul>
                <p className="mt-3 text-sm font-medium text-red-300">
                  Warning: These behaviours can lead to accidents, disciplinary action, and damage
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="mt-3 text-sm font-medium text-amber-300">
                  Legal warning: Failure to attend mandatory safety briefings or follow instructions
                  can result in prosecution under health and safety legislation.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-white text-sm space-y-1">
                  ...
                  <li>
                    • <strong className="text-white">Arrive on time</strong> and prepared with
                    notebook
                  </li>
                  <li>
                    • <strong className="text-white">Listen carefully</strong> and take notes
                  </li>
                  <li>
                    • <strong className="text-white">Ask questions</strong> if anything is unclear
                  </li>
                  <li>
                    • <strong className="text-white">Follow up</strong> on all agreed actions
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-white text-sm space-y-1">
                ...
                <li>
                  • Different meeting types serve specific purposes and all require attendance
                </li>
          ...
          <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
            ...
            <Button
              ...
              asChild
            >
              <Link to="..">Back to Section 5</Link>
            </Button>
          </nav>
        </div>
      </article>
