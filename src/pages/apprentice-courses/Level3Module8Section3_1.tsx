...
const Level3Module8Section3_1 = () => {
  ...
  const quizQuestions = [
    {
      question:
        'For a 2-hour exam with 40 questions, approximately how much time should you allocate per question?',
      options: ['1 minute', '2 minutes', '3 minutes', '4 minutes'],
      correctAnswer: 2,
      explanation:
        "With 40 questions in 2 hours (120 minutes), you have 3 minutes per question. However, it's wise to aim for 2-2.5 minutes per question to allow review time.",
    },
    {
      question:
      ...
      correctAnswer: 2,
      explanation:
        "Mark difficult questions and return to them after completing easier ones. This ensures you don't miss straightforward marks while struggling with complex questions.",
    },
    {
      ...
      correctAnswer: 0,
      explanation:
        'The 50/10 rule involves 50 minutes of focused study followed by a 10-minute break. This maintains concentration and prevents mental fatigue.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Spaced repetition strengthens memory by reviewing material at increasing intervals, effectively moving information from short-term to long-term memory.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Mental energy and concentration are typically highest in the morning. Tackling challenging material when you're freshest leads to better understanding and retention.",
    },
    {
      question:
        'What percentage of your exam time should ideally be reserved for reviewing answers?',
      options: ['5%', '10-15%', '25%', '50%'],
      correctAnswer: 2,
      explanation:
        'Reserving approximately 25% of your exam time (e.g., 30 minutes in a 2-hour exam) allows you to review answers, return to marked questions, and check for errors.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Topic chunking involves breaking large, complex topics into manageable 30-minute segments. This makes study sessions more achievable and progress more visible.',
    },
    {
      question: "How many weeks before the exam should 'deep learning' revision typically begin?",
      options: ['12-8 weeks', '8-4 weeks', '4-2 weeks', 'Final 2 weeks'],
      correctAnswer: 1,
      explanation:
        'The deep learning phase, involving in-depth study and regular practice, should typically occur 8-4 weeks before the exam, after foundation building is complete.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Second-guessing often leads to changing correct answers to wrong ones. Research shows first instincts are usually right unless you have clear evidence of an error.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Active recall involves testing yourself without notes, which forces your brain to retrieve information and significantly strengthens memory pathways compared to passive reading.',
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'The final 2 weeks should focus on consolidation - reviewing key facts, final mock exams, and ensuring adequate rest. Cramming new material is ineffective this close to the exam.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Memory consolidation occurs during sleep. Reviewing key points before bed helps transfer information to long-term memory as your brain processes it overnight.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "If you're studying for more than 3-4 hours without breaks, retention drops significantly. Quality matters more than quantity. Stick to focused sessions with regular breaks, and ensure you're getting adequate sleep and rest.",
    },
    {
      question: 'What if I run out of time in the exam?',
      answer:
        'If time is running short, prioritise unanswered questions where you know the answer. For multiple choice, never leave blanks - make an educated guess. For written answers, use bullet points to cover key points quickly.',
    },
    {
      question: 'Should I revise topics in order or randomly?',
      answer:
        'A combination works best. Start with weaker topics to give them more attention, but also interleave different subjects to strengthen connections. Random practice more closely simulates exam conditions.',
    },
    {
      question: 'How do I balance work and revision?',
      answer:
        'Create a realistic schedule that accounts for work hours. Even 30-45 minutes daily is effective if consistent. Use commute time for audio revision or flashcard apps. Weekend sessions can be longer but should still include breaks.',
    },
    {
      question: 'Is it better to revise alone or with others?',
      answer:
        'Both have benefits. Solo revision allows focus and personalised pace. Group study helps explain concepts (teaching reinforces learning) and identifies gaps. A mix of 70% solo and 30% group often works well.',
    },
    {
      question: 'What should I do the night before the exam?',
      answer:
        'Light revision only - review summary cards or key formulae. Prepare everything needed (ID, equipment, route). Get a good meal and aim for 7-8 hours sleep. Avoid cramming as it increases anxiety and reduces performance.',
    },
  ];
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-invert max-w-none mb-6">
            <p className="text-white">
              ...
              difficult questions steal time from easier marks.
            </p>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-invert max-w-none mb-6">
            <p className="text-white">
              ...
              retention and increased anxiety.
            </p>
          </div>
