...
const quickCheckQuestions = [
  {
    ...
    options: ['80 lm/W', '50 lm/W', '200 lm/W', '120-150 lm/W'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['50 lm/W', '70 lm/W', '95 lm/W', '120 lm/W'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['80-90%', '50-70%', '10-20%', '30-40%'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['2-4 years', '1-2 years', '5-7 years', '10+ years'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              A4:2026 introduced Reg 421.1.7 as a <strong>recommendation</strong> (not a mandate) —
              note the wording carefully. AFDDs detect series and parallel arc faults that an MCB or
              RCD won’t see. For dense LED lighting circuits with multiple luminaire drivers in
              series, drivers ageing in elevated ambients, or routes through combustible materials,
              AFDD on the final circuit is a sensible design choice. The HNC designer’s job is to
              apply the recommendation through risk assessment — call it out on the load schedule
              where the fire-load justifies it.
            </>
          }
        ...
        <ConceptBlock title="LED Selection and Efficacy Targets">
          <p>
            ...
            colour quality and controllability. Selecting the right LED involves balancing efficacy
          ...
          <p>
            <strong>
              Light source efficacy comparison (source type / typical efficacy / typical CRI):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Example: L70B10 = 50,000h means 90% of LEDs will still produce 70% output at 50,000h
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Part L Requirements for Lighting">
          <p>
            ...
            efficiency in new and refurbished buildings. Compliance is demonstrated through the LENI
            (Lighting Energy Numeric Indicator) calculation methodology.
          </p>
          <p>
        ...
        <ConceptBlock title="LENI Calculations for Compliance">
          ...
          <p>
            <strong>LENI calculation formula (BS EN 15193-1):</strong> LENI = W × (t<sub>D</sub> × F
            <sub>D</sub> × F<sub>O</sub>) + (t<sub>N</sub> × F<sub>O</sub>) / A.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>
              Typical LENI targets by building type (building type / LENI target / notes):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Important:</strong> LENI calculation must use actual installed power, not design
            allowance. Verify luminaire quantities and wattages match the as-installed condition.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Controls Strategy for Energy Efficiency">
          ...
          <p>
            <strong>
              Control strategy energy savings (control / typical saving / best application):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Presence detection (auto on/off) — 20-30% — toilets, corridors, stores</li>
          ...
          <p>
            <strong>Remember:</strong> Controls only save energy when properly commissioned. Budget
            adequate time and resource for setup and user training. Monitor post-occupancy to verify
            performance.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — LENI calculation:</strong> Calculate LENI for a 500m² office with
            5kW installed lighting, daylight dimming and absence detection.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 2 — Part L efficacy check:</strong> A luminaire produces 4000 luminaire
            lumens and consumes 38W (including driver). Does it comply?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              You’re leading the lighting design for a 4-storey, 6,000 m² speculative office. Client
              targets BREEAM Excellent and a LENI ≤ 25 kWh/m²/yr to evidence Part L 2021 compliance
              plus BREEAM Hea 06 and Ene 03. Open-plan, meeting rooms, breakout, WCs, back-of-house.
              You’ve got the lighting criteria locked from sub-section 4.1.
            </>
          }
          whatToDo={
            <>
              ...
              dimming on perimeter. Run the LENI calc in BS EN 15193-1: include parasitic (sensor +
              emergency drivers ≈ 1.5 kWh/m²/yr), control factor FD = 0.7 (daylight response), FO =
              0.8 (occupancy). Initial calc lands at 18 kWh/m²/yr — comfortable margin against 25.
              On the load schedule, flag the open-plan and meeting-room final circuits for AFDD per
              Reg 421.1.7 recommendation given the high luminaire density and combustible ceiling
              void. Include the LENI workings, the photometric files, and the controls narrative in
              the O&amp;M pack.
            </>
          }
          whyItMatters={
            <>
              LENI is a <em>calculated</em> compliance route — easy to under-count parasitics and
              over-claim daylight savings. A defensible LENI ≤ 25 with margin protects the design
              when the SBEM modeller runs the building through Part L proper.
            </>
          }
        />
