  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Scorching on sockets is a clear sign of overheating, typically caused by loose connections or faulty terminations that create resistance and heat.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Corrosion on terminals indicates environmental effects that can weaken connections and lead to increased resistance and potential failure.',
    },
    {
      id: 6,
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-sm text-white/80">
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    <strong>Spot:</strong> Scorch marks, cracks, loose fittings, corrosion
                  </li>
                  <li>
                    <strong>Use:</strong> Good lighting, careful inspection, thermal detection
                  </li>
                  <li>
                    <strong>Check:</strong> Safety-critical vs cosmetic defects
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                these issues before testing or energising the system.
              </p>
              <p>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    <p className="text-white mb-1">
                      <strong>Accessory Damage:</strong>
                    </p>
                    <ul className="list-disc pl-5 space-y-1">
                  ...
                  <div>
                    <p className="text-white mb-1">
                      <strong>Insulation Damage:</strong>
                    </p>
                    <ul className="list-disc pl-5 space-y-1">
                  ...
                  <div>
                    <p className="text-white mb-1">
                      <strong>Heat Damage Indicators:</strong>
                    </p>
                    <ul className="list-disc pl-5 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30">
                ...
                <p className="text-sm">
                  Any physical damage that exposes live conductors or shows signs of overheating
                  must be treated as an immediate safety hazard. Isolate the circuit and make safe
                  before proceeding.
                </p>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div>
                    <p className="text-white mb-1">
                      <strong>Environmental Deterioration:</strong>
                    </p>
                    <ul className="list-disc pl-5 space-y-1">
                  ...
                  <div>
                    <p className="text-white mb-1">
                      <strong>Age-Related Degradation:</strong>
                    </p>
                    <ul className="list-disc pl-5 space-y-1">
            ...
            <div className="mt-6">
              <InlineCheck
                ...
                options={[
                  'Faded cable colours',
                  'Brittle insulation exposing conductors',
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    <p className="text-white mb-1">
                      <strong>Electrical Connection Faults:</strong>
                    </p>
                    <ul className="list-disc pl-5 space-y-1">
                  ...
                  <div>
                    <p className="text-white mb-1">
                      <strong>Protection and Safety Faults:</strong>
                    </p>
                    <ul className="list-disc pl-5 space-y-1">
                  ...
                  <div>
                    <p className="text-white mb-1">
                      <strong>Installation Quality Issues:</strong>
                    </p>
                    <ul className="list-disc pl-5 space-y-1">
            ...
            <div className="mt-6">
              <InlineCheck
                ...
                options={[
                  'It affects equipment efficiency',
                  'It can cause electric shock and equipment damage',
                  'It makes testing difficult',
                  'It violates building regulations',
                ]}
                correctIndex={1}
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-amber-500/50">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    <p className="text-white mb-1">
                      <strong>Fire and Overheating Risks:</strong>
                    </p>
                    <ul className="list-disc pl-5 space-y-1">
                  ...
                  <div>
                    <p className="text-white mb-1">
                      <strong>Shock and Electrocution Hazards:</strong>
                    </p>
                    <ul className="list-disc pl-5 space-y-1">
            ...
            <div className="mt-6">
              <InlineCheck
                ...
                options={[
                  ...
                  'Overheating and restricted maintenance access',
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-white/5 border-l-2 border-gray-500/50">
                  <p className="font-medium text-white mb-2">
                    Cosmetic Issues (Usually Non-Critical):
                  </p>
                ...
                <div className="p-4 rounded-lg bg-white/5 border-l-2 border-red-500/50">
                  <p className="font-medium text-white mb-2">
                    Safety-Critical Issues (Must Rectify):
                  </p>
                  <ul className="text-sm list-disc pl-5 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
                ...
                <p className="text-sm">
                  When in doubt, err on the side of safety. Document all observations and seek
                  advice from senior colleagues if uncertain about the significance of any defect.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/30">
              ...
              <div className="text-white/80 space-y-3 text-sm">
                ...
                <p>
                  <strong>Investigation:</strong> Detailed examination revealed a loose neutral
                  connection that had been arcing and overheating, gradually carbonising the
                  surrounding materials.
                </p>
                <p>
                  <strong>Outcome:</strong> The entire distribution board was replaced and the
                  circuit was rewired. Fire investigation showed the defect could have resulted in a
                  significant electrical fire.
                </p>
                <p>
                  <strong>Learning Point:</strong> Visual inspection of distribution boards must
                  include careful examination of all terminal connections for signs of overheating.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-3 leading-relaxed">
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Professional judgement is essential to prioritise remedial actions appropriately
                </li>
              </ul>
            </div>
          </section>
