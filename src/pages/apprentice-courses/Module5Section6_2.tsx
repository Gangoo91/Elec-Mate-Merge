    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="border-l-4 border-l-green-500 bg-card p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Labels</strong> – Marking distribution boards, circuits, isolators, and accessories</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Basic Notes</strong> – Quick reminders left for colleagues</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Handover Sheets</strong> – Summarising progress for the next shift</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Record Books/Logs</strong> – Used on larger sites for tracking works</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
          ...
          <div className="border-l-4 border-l-purple-500 bg-card p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Clarity</strong> – Use simple, unambiguous wording</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Accuracy</strong> – Double-check all details</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Legibility</strong> – Ensure it can be read by anyone</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Professionalism</strong> – Maintain appropriate tone</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
          ...
          <div className="border-l-4 border-l-orange-500 bg-card p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Why handovers matter:</strong></p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Essential handover content:</strong></p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Best practices:</strong></p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
          ...
          <div className="border-l-4 border-l-red-500 bg-card p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Requirements for electrical labels:</strong></p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Types of labels commonly used:</strong></p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-foreground mb-2"><strong>Best practices for labelling:</strong></p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card border border-border/30 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-emerald-400 mb-3">Creating Structured Handovers</h3>
              <ul className="text-xs sm:text-sm text-foreground space-y-2">
                <li className="flex items-start gap-2">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="bg-card border border-border/30 rounded-lg p-6">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-emerald-400 mb-2">The Cost of Poor Communication</h3>
        ...
        <Card className="mb-8 p-6 bg-gradient-to-r from-emerald-500/10 to-emerald-500/5 border border-emerald-500/30">
          ...
          <p className="text-muted-foreground mb-4">Quick reference for written communication</p>
