...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Added together', 'The lowest is used', 'The highest is used', 'Multiplied together'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['3 circuits', '12 circuits', '9 circuits (3 × 3-phase)', '6 circuits'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 434.5.2 requires the protective device to clear a fault before the cable reaches
              its limiting temperature. That calculation (the &lsquo;adiabatic equation&rsquo; in
              Reg 434.5.2) uses the cable&rsquo;s real I_z — derated for ambient, grouping, thermal
              insulation and harmonic content. Skip a derating factor and the device may
              &lsquo;protect&rsquo; on paper but fail to clear the fault before insulation breakdown
              in reality.
            </>
          }
        ...
        <ConceptBlock title="Ambient Temperature Correction (Ca)">
          ...
          <p>
            <strong>
              Ambient temperature factors (Table 4B1) — ambient °C / PVC (70°C) / XLPE (90°C) /
              Mineral (70°C):
            </strong>
          </p>
          ...
          <p>
            <strong>XLPE advantage:</strong> At 50°C ambient, XLPE (Ca = 0.82) retains significantly
            more capacity than PVC (Ca = 0.71), making it preferred for hot locations.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Grouping Factors (Cg)">
          <p>
            ...
            reducing the ability to dissipate heat. The grouping factor Cg accounts for this mutual
            heating effect.
          </p>
          <p>
            <strong>
              Grouping factors (Table 4C1) — cables touching (no. circuits / bunched / single layer
              / perforated tray):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Thermal Insulation Correction (Ci)">
          ...
          <p>
            <strong>
              Thermal insulation factors (Table 52.2) — cable position / length in insulation / Ci
              factor:
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Combined Derating Calculations">
          ...
          <p>
            <strong>
              Worked example — hot plant room with grouping (32A MCB, 45°C ambient, 6 circuits
              grouped, PVC cable):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — domestic loft lighting circuit:</strong> A 6A lighting circuit runs
            through 300mm of loft insulation. Ambient 35°C in summer. What cable size?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Ca (35°C) = 0.94</li>
          ...
          <p>
            <strong>Example 2 — commercial riser:</strong> 8 × 63A three-phase circuits in a riser,
            ambient 35°C. XLPE/SWA on tray. What size?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — comparing PVC vs XLPE:</strong> 50°C plant room, 4 circuits grouped.
            Compare cable sizes for 32A circuit.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PVC cable:</strong> Ca = 0.71, Cg = 0.65 → combined = 0.46; min It = 32 / 0.46
              = 69.6A → need 16mm²
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Wrong Cg arrangement:</strong> bunched vs single layer differ significantly
              </li>
              <li>
                <strong>Using summer ambient in winter:</strong> design for worst case (usually hot)
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A plant room contains 8 grouped XLPE/SWA sub-main cables on a perforated tray, each
              feeding a different floor DB. Ambient 40&nbsp;°C in summer (poor ventilation, heat
              from boilers and chillers). Each cable carries a load with measured 25% 3rd-harmonic
              content from LED lighting and IT.
            </>
          }
          whatToDo={
            <>
              C_a (40&nbsp;°C, 90&nbsp;°C XLPE) ≈ 0.91 (Appendix 4 Table 4B1). C_g (8 circuits
              grouped on tray) ≈ 0.52 (Table 4C1). 3rd harmonic 15–33%: Appendix 4 Section 5.5
              derate applies to neutral-loaded circuits — use the line-current rating without
              adjustment unless &gt; 33%, where the derating bites. Combined: I_z = I_t × 0.91 ×
              0.52 = 0.47 × I_t. A 70&nbsp;mm² XLPE rated at 254&nbsp;A clipped becomes ≈ 119&nbsp;A
              in this environment. Document on the cable schedule and feed the derated I_z into the
              Reg 434.5.2 adiabatic check for fault-current protection.
            </>
          }
          whyItMatters={
            <>
              Grouping is the most-missed factor in real designs. A 100&nbsp;A MCB on a cable that
              has lost 50% of its capacity is a long-term fire risk — and the protective
              device&rsquo;s operating characteristic under Reg 434.5.2 has been calculated against
              the wrong I_z. Get the derating right at design, not after a fire investigator
              arrives.
            </>
          }
        />
