      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Step-by-step methods for calculating voltage drop in circuits
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Calculate voltage drop using the mV/A/m method",
              "Determine maximum cable length for a given voltage drop",
              "Calculate minimum conductor size for voltage drop compliance",
              "Handle combined distribution and final circuit drops",
              "Apply three-phase voltage drop calculations",
              "Use BS 7671 Appendix 4 tables effectively"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module3-section6-2">
              <ArrowLeft className="w-4 h-4 mr-2" />
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module3-section6-4">
