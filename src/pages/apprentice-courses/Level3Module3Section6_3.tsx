...
const DESCRIPTION =
  'Master voltage drop calculations for circuit design. Learn step-by-step methods using BS 7671 tables and mV/A/m values for single-phase and three-phase circuits.';
...
const quickCheckQuestions = [
  {
    id: 'check-1',
    question:
      'A 15m circuit uses 2.5mm sq cable (mV/A/m = 18) with design current 18A. What is the voltage drop?',
    options: ['4.86V', '48.6V', '0.486V', '486V'],
    correctIndex: 0,
    explanation:
      'Vd = (mV/A/m x I x L) / 1000 = (18 x 18 x 15) / 1000 = 4860 / 1000 = 4.86V. This is within the 11.5V (5%) limit for power circuits.',
  },
  {
    id: 'check-2',
    question:
      'For the calculation above (4.86V drop), would this be acceptable for a lighting circuit?',
    options: [
    ...
    correctIndex: 0,
    explanation:
      'The 4.86V voltage drop is within the 6.9V (3% of 230V) limit for lighting circuits. This cable and circuit length combination would be acceptable for either lighting or power use.',
  },
  {
    id: 'check-3',
    question:
      'What is the maximum cable length for a 20A circuit using 2.5mm sq cable (mV/A/m = 18) if voltage drop must not exceed 11.5V?',
    options: ['31.9m', '11.5m', '20m', '63.9m'],
    correctIndex: 0,
    explanation:
      'Rearranging: L = (Vd x 1000) / (mV/A/m x I) = (11.5 x 1000) / (18 x 20) = 11500 / 360 = 31.9m maximum length.',
  },
  {
    id: 'check-4',
    question:
      'A distribution circuit drops 3V and feeds a final circuit that drops 5V. Is this acceptable for a power circuit?',
    options: [
    ...
    correctIndex: 0,
    explanation:
      'Total voltage drop = 3V + 5V = 8V, which is within the 11.5V (5%) limit for power circuits. BS 7671 limits apply to total drop from origin to point of use.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The formula is Vd = (mV/A/m x I x L) / 1000. The division by 1000 converts millivolts to volts. mV/A/m is the value from tables, I is design current, L is cable length.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Rearranging Vd = (mV/A/m x I x L) / 1000 gives L = (Vd x 1000) / (mV/A/m x I). This is useful for determining maximum circuit length for a given cable size.',
  },
  {
    id: 3,
    question: 'A 40m circuit with 10A load uses 1.5mm sq cable (mV/A/m = 29). The voltage drop is:',
    options: ['11.6V', '1.16V', '116V', '0.116V'],
    correctAnswer: 0,
    explanation:
      'Vd = (29 x 10 x 40) / 1000 = 11600 / 1000 = 11.6V. This exceeds the 6.9V lighting limit and marginally exceeds the 11.5V power limit.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Using a larger conductor reduces the mV/A/m value, directly reducing voltage drop. This is the most practical solution in most situations where circuit length and load are fixed.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Three-phase voltage drop = (root 3 x mV/A/m x I x L) / 1000 for line-to-line voltage. The root 3 factor relates line-to-neutral and line-to-line voltages in balanced three-phase systems.',
  },
  {
    id: 6,
    ...
    correctAnswer: 0,
    explanation:
      'BS 7671 Appendix 4 voltage drop values are given at conductor operating temperature, unlike resistance tables which are at 20 degrees C. No temperature correction is needed for voltage drop calculations.',
  },
  {
    id: 7,
    question:
      'A circuit has mV/A/m = 11. To achieve maximum 5V drop with 25A load, maximum length is:',
    options: ['18.2m', '1.82m', '182m', '137.5m'],
    correctAnswer: 0,
    explanation:
      'L = (Vd x 1000) / (mV/A/m x I) = (5 x 1000) / (11 x 25) = 5000 / 275 = 18.18m, approximately 18.2m maximum.',
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      'For a ring circuit with load at the mid-point (worst case), effective length is quarter of total ring length because current splits and conductors work in parallel. This gives the worst-case voltage drop scenario.',
  },
  {
    id: 9,
    question:
      'If a distribution circuit uses 2% of supply voltage and a final circuit must not exceed 3% total, the final circuit limit is:',
    options: ['3%', '1%', '5%', '2%'],
    correctAnswer: 1,
    explanation:
      'Total allowable is 3% (lighting). If distribution uses 2%, only 1% remains for the final circuit. Total drop from origin to point of use must not exceed the BS 7671 limit.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'For conductors 25mm sq and larger, cable reactance becomes significant and the mV/A/m values include both resistive and reactive components. Separate columns may be provided for different power factors.',
  },
  {
    id: 11,
    ...
    correctAnswer: 0,
    explanation:
      'Calculate the maximum acceptable mV/A/m: max mV/A/m = (Vd x 1000) / (I x L). Then select the smallest cable size with mV/A/m equal to or less than this value.',
  },
  {
    id: 12,
    question:
      'A 230V supply feeds a 25m circuit. For 5% max drop, the maximum voltage at the load is:',
    options: ['230V', '218.5V', '241.5V', '225V'],
    correctAnswer: 1,
    explanation:
      '5% of 230V = 11.5V drop. Minimum voltage at load = 230 - 11.5 = 218.5V. Equipment connected must be able to operate satisfactorily at this voltage.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Voltage drop should be verified for all circuits during design. Short domestic circuits with standard cable sizes typically comply. Long runs, high current circuits, or non-standard situations require explicit calculation. When in doubt, calculate.',
  },
  {
    question: 'What if I need both current-carrying capacity AND voltage drop to comply?',
    answer:
      'Calculate both requirements independently and use whichever requires the larger conductor. Often for long circuits, voltage drop is the determining factor even though current-carrying capacity would permit a smaller cable.',
  },
  {
    question: 'How do I handle voltage drop for motor circuits with high starting current?',
    answer:
      'Motor starting current (typically 6-8 times running current) causes temporary voltage drop. While BS 7671 limits apply to running current, excessive starting drop can affect other equipment. Consider this in the design, especially for direct-on-line starting of large motors.',
  },
  {
    question: 'Are the mV/A/m values the same for all installation methods?',
    answer:
      'BS 7671 tables provide values for different installation methods. While resistance-based voltage drop is similar, the operating temperature (and therefore resistance) can vary with installation method. Use the appropriate table column for your installation method.',
  },
  {
    question: 'How do I account for harmonics in voltage drop calculations?',
    answer:
      'Harmonics, particularly third harmonics, can increase neutral current in three-phase systems. For installations with significant non-linear loads, neutral current may exceed phase current, requiring voltage drop to be calculated based on actual neutral current.',
  },
  {
    question: 'Can I use diversity in voltage drop calculations?',
    answer:
      'Generally, use the actual expected load current (design current Ib) which may include diversity. However, for circuits where maximum load is likely (such as dedicated equipment circuits), use full load current. Conservative calculations use full rated load.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              ...
              <li>
                <strong>Max Length:</strong> L = (Vd x 1000) / (mV/A/m x I)
              </li>
              <li>
                <strong>Limits:</strong> 6.9V lighting, 11.5V power (230V supply)
              </li>
              <li>
                <strong>Tables:</strong> BS 7671 Appendix 4 for mV/A/m values
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Long cable runs, high current circuits
              </li>
              <li>
                <strong>Use:</strong> BS 7671 Table 4D5 for flat cable mV/A/m
              </li>
              <li>
                <strong>Apply:</strong> Add distribution + final circuit drops
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The standard method for calculating voltage drop uses mV/A/m values from BS 7671
              Appendix 4 tables. This method is straightforward and accurate for most single-phase
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white space-y-2 font-mono">
                ...
                <p>
                  <strong>Step 2:</strong> From Table 4D5 (method C), mV/A/m = 18
                </p>
                <p>
                  <strong>Step 3:</strong> Vd = (18 x 20 x 18) / 1000 = 6480 / 1000 = 6.48V
                </p>
                <p>
                  <strong>Step 4:</strong> 6.48V is less than 11.5V limit for power circuits
                </p>
                <p className="text-green-400 mt-2">
                  Voltage drop = 6.48V - ACCEPTABLE for power circuit
                </p>
              </div>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Note:</strong> The mV/A/m values in BS 7671 Appendix 4 are given at conductor
              operating temperature, so no temperature correction is needed for voltage drop
              calculations.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Sometimes you need to find the maximum cable length that will keep voltage drop within
              limits. This is useful when planning cable routes or determining if a particular cable
              size can reach the intended load location.
            </p>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-white/10 my-6">
              <p className="text-sm font-medium text-white mb-2">
                Quick Reference - Maximum Lengths (Power Circuits, 11.5V limit):
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              When circuit length and current are known, you can calculate the maximum acceptable
              mV/A/m value, then select the smallest cable size that meets this requirement.
            </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white space-y-2 font-mono">
                ...
                <p className="mt-2">
                  <strong>Step 2:</strong> Find cable with mV/A/m less than or equal to 15.3
                </p>
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20 my-6">
              ...
              <p className="text-xs text-white">
                ...
                moderate current, voltage drop often requires a larger cable than current-carrying
                capacity alone would need.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Design Process:</strong> Always calculate both requirements and compare.
              Document both calculations in your design to show compliance with BS 7671.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              When an installation includes distribution circuits feeding final circuits, the total
              voltage drop from the origin to the point of use is the sum of both. Both must be
              calculated and the combined total must not exceed the BS 7671 limit.
            </p>
