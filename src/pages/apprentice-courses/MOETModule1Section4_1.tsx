    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">The cornerstone of UK health and safety legislation</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>HSWA:</strong> The primary UK health and safety legislation — an enabling
                act
              </li>
              <li className="pl-1">
                <strong>Sections 2–8:</strong> Core duties on employers, employees and others
              </li>
              <li className="pl-1">
                <strong>SFARP:</strong> So far as is reasonably practicable — the key legal test
              </li>
              <li className="pl-1">
                <strong>Enforcement:</strong> HSE inspectors, improvement and prohibition notices
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Schedules 1–10:</strong> Supplementary provisions including the
                  constitution of the HSE and transitional arrangements
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Why the HSWA Matters for Electrical Maintenance
              </p>
              <p className="text-sm text-white mb-3">
                Every piece of electrical safety legislation, every approved code of practice, and
                every guidance note traces its authority back to the HSWA 1974. Understanding the
                Act is not academic — it is the foundation upon which your entire legal framework
                rests.
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  The Electricity at Work Regulations 1989 — made under HSWA Section 15
                </li>
                <li className="pl-1">
                  HSE Guidance Notes (GS38, HSG85) — published under HSWA Section 11
                </li>
                <li className="pl-1">
                  Approved Codes of Practice — approved under HSWA Section 16
                </li>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                ...
                statutes (Factories Act 1961, Offices, Shops and Railway Premises Act 1963, Mines
                and Quarries Act 1954). Approximately 8 million workers had no statutory safety
                protection at all. The Robens Report found that this fragmented approach was
                failing, with around 1,000 workers killed and 500,000 injured each year. The HSWA
                brought all workers under a single framework for the first time.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  Section 2(1) states: "It shall be the duty of every employer to ensure, so far as
                  is reasonably practicable, the health, safety and welfare at work of all his
                  employees."
                </p>
                ...
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    <strong>(b)</strong> Arrangements for ensuring, SFARP, safety and absence of
                    risks in the use, handling, storage and transport of articles and substances
                  </li>
                  <li className="pl-1">
                  ...
                  <li className="pl-1">
                    ...
                    control in a safe condition, SFARP, and provision and maintenance of safe means
              ...
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Section 2(3) — Written Safety Policy
                </h3>
                <p className="text-sm text-white">
                  ...
                  organisation and arrangements for carrying it out. This policy must be brought to
                  the attention of all employees. For electrical contractors, this typically
                  includes safe isolation procedures, permit to work arrangements, PPE requirements,
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  Employers and self-employed persons must conduct their undertaking so that persons
                  not in their employment are not exposed to risks to their health or safety. For
                  electrical maintenance, this means your work must not create risks for building
                  occupants, other contractors, visitors, or members of the public. Isolation of
                  circuits must consider the impact on fire alarms, emergency lighting, and life
                  safety systems.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  means of access and egress, and any plant or substance in the premises are safe
                  and without risks to health. This is particularly relevant to building owners and
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  Those who design, manufacture, import or supply articles for use at work must
                  ensure they are safe when properly used. This applies to manufacturers of
                  electrical equipment, switchgear, test instruments and protective devices. They
                  must carry out testing, provide adequate information, and undertake research to
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">Every employee has a duty to:</p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                    <strong>(a)</strong> Take reasonable care for the health and safety of
                    themselves and of other persons who may be affected by their acts or omissions
                    at work
                  </li>
                  <li className="pl-1">
                    <strong>(b)</strong> Co-operate with their employer so far as is necessary to
                    enable the employer to comply with any duty or requirement imposed on them
                  </li>
                </ul>
                <p className="text-sm text-elec-yellow/70 mt-3">
                  <strong>For maintenance technicians:</strong> This means following safe isolation
                  procedures, wearing required PPE, reporting defective equipment, and not taking
                  shortcuts. If you bypass a lock-off or fail to prove dead, you are breaching
                  Section 7.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  provided in the interests of health, safety or welfare. This is an{' '}
                  <strong>absolute duty</strong> — there is no SFARP qualification. Removing a
                  safety guard, disabling an RCD, bypassing a lock-off, or removing warning signs
                  are all offences under Section 8.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The phrase "so far as is reasonably practicable" (SFARP) appears throughout the HSWA
              1974 and is the legal standard against which most duties are measured. Understanding
              SFARP is essential for every maintenance technician because it determines what your
              employer must provide and what you must do.
            </p>

            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                The Edwards v. National Coal Board Test (1949)
              </p>
              <p className="text-sm text-white mb-3">
                The leading case on SFARP is Edwards v. National Coal Board [1949]. The Court of
                Appeal held that "reasonably practicable" is narrower than "physically possible". It
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>On the other:</strong> The sacrifice — the cost, time, trouble and
                  physical difficulty of the measures needed to avert the risk
                </li>
              </ul>
              <p className="text-sm text-white mt-3">
                If the risk is significant, it can only be left unaddressed if the cost of remedial
                measures would be
                <strong> grossly disproportionate</strong> to the risk. Note: the test is not about
                proportionate cost — the cost must be <em>grossly</em> disproportionate, placing the
                burden firmly on the duty holder.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  SFARP in Practice — Electrical Examples
                </h3>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">
                  ...
                  <li className="pl-1">
                    Replacing an entire 30-year-old switchboard because one minor component has
                    corroded — cost may be grossly disproportionate to the risk if the component can
                    be repaired
                  </li>
                  <li className="pl-1">
                  ...
                  <li className="pl-1">
                    ...
                    consumer unit — cost may be disproportionate, but providing a lock-off kit for
                    the main switch is reasonably practicable
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  demonstrate that it was not reasonably practicable to do more than was in fact
                  done. This is a reverse burden — the prosecution does not need to prove that more
                  should have been done; the employer must prove it was not reasonably practicable.
                  This is particularly significant in prosecution cases following electrical
                  fatalities.
                </p>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Safety Policy Requirements — Section 2(3)
              </p>
              <p className="text-sm text-white mb-3">
              ...
              <p className="text-sm text-white mt-3">
                The policy must be kept up to date and brought to the attention of all employees.
                For electrical maintenance contractors, the arrangements section should include
                specific reference to safe isolation procedures, live working policies, test
                instrument management, and work at height procedures.
              </p>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  ...
                  employees in consultations with the employer, attend safety committee meetings,
                  and receive paid time off for training
                </li>
                <li className="pl-1">
                  <strong>Health and Safety (Consultation with Employees) Regulations 1996:</strong>{' '}
                  Where there is no recognised trade union, employers must consult employees
                  directly or through elected representatives of employee safety (ROES)
                </li>
              </ul>
              <p className="text-sm text-white mt-3">
                As a maintenance technician, you have the right to be consulted on health and safety
                matters affecting your work and to raise concerns without fear of detriment.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Require any person to answer questions and sign a declaration of truth
                </li>
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
                ...
                <p className="text-sm text-white mb-2">
                  Issued when an inspector is of the opinion that a person is contravening a
                  statutory provision or has contravened it in circumstances that make it likely the
                  contravention will continue or be repeated.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">States the contravention and the provision breached</li>
                  <li className="pl-1">
                    Specifies the period within which the contravention must be remedied (not less
                    than 21 days)
                  </li>
                  <li className="pl-1">
                    May direct the manner in which the contravention should be remedied
                  </li>
                  <li className="pl-1">
                    Work can continue during the compliance period unless separately prohibited
                  </li>
                  <li className="pl-1">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30">
                ...
                <p className="text-sm text-white mb-2">
                  Issued when an inspector is of the opinion that an activity involves, or will
                  involve, a risk of serious personal injury.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                    Can take immediate effect or be deferred to a specified date
                  </li>
                  <li className="pl-1">
                    Directs that the activity shall not be carried on until the matter is remedied
                  </li>
                  <li className="pl-1">
                    Does not need to involve a contravention — the risk alone is sufficient
                  </li>
                  <li className="pl-1">
                    Right of appeal, but the appeal does NOT suspend a prohibition notice
                  </li>
                  <li className="pl-1">
                    Contravention of a prohibition notice is a criminal offence
                  </li>
                </ul>
                <p className="text-sm text-white mt-3">
                  <strong>Example:</strong> An HSE inspector visiting a commercial premises observes
                  a maintenance technician working in a live 400 V distribution board without arc
                  flash PPE, barriers, or a documented risk assessment. The inspector could issue an
                  immediate prohibition notice stopping all live work until adequate precautions are
                  in place.
                </p>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mt-3">
                ...
                have received fines in the millions of pounds. The guidelines consider the
                culpability of the offender, the seriousness of harm risked, the likelihood of harm,
                and the organisation's turnover.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Section 37 allows individual directors and managers to be
              prosecuted personally if an offence was committed with their consent, connivance, or
              was attributable to their neglect. This means senior managers who fail to resource
              electrical safety properly can face personal criminal liability.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                Under Section 2, your employer must provide:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Safe systems of work:</strong> Documented safe isolation procedures,
                  permit to work systems, risk assessments, and method statements
                </li>
                <li className="pl-1">
                  <strong>Information and training:</strong> Initial induction training, ongoing
                  CPD, specific training for new equipment or procedures, access to BS 7671 and
                  relevant guidance
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  switchrooms; safe means of access to equipment at height; welfare facilities on
                  site
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Use the PPE provided — arc flash protection, insulated gloves, safety boots
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  Report hazards and near-misses through your employer's reporting system
                </li>
                <li className="pl-1">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  1974 is the foundational legislation. In your End Point Assessment, you may be
                  asked about the general duties, SFARP, enforcement mechanisms, and how the Act
                  relates to more specific regulations such as the EAWR 1989.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                ...
                <p className="text-sm text-white">
                  ...
                  regulations (EAWR, PUWER, LOLER, COSHH, CDM), approved codes of practice (which
                  have a special legal status — compliance is not compulsory, but failure to comply
                  can be used as evidence of contravention), and HSE guidance notes (advisory, not
                  legally binding, but representing good practice).
                </p>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white">
                ...
                documented justification for live working exists. Under Section 7, you have a duty
                to take reasonable care — which means refusing to carry out work that is contrary to
                your employer's safe system of work. Under Section 2, your employer has a duty to
            ...
            <p className="text-sm text-white/90 italic">
              <strong>Note:</strong> The Employment Rights Act 1996 (Section 44) protects employees
              from detriment for refusing to work in circumstances they reasonably believe to be
              dangerous. You cannot lawfully be disciplined or dismissed for refusing unsafe work —
              provided your belief is reasonable and you follow your employer's reporting
              procedures.
            </p>
          </div>
        </section>
