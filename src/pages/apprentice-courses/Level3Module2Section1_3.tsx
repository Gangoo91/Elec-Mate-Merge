      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3">
            BS7671 Sustainability Considerations
          </h1>
          <p className="text-white/80">
            Wiring Regulations requirements for sustainable electrical installations
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "BS7671 Chapter 64 prosumer installation requirements",
              "EV charging earthing and protection considerations",
              "Solar PV AC and DC circuit requirements",
              "Battery storage installation guidance",
              "EMC and harmonic considerations",
              "Documentation requirements for renewable installations"
            ].map((item, i) => (
