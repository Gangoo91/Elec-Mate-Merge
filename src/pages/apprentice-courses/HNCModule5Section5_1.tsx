...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['48 hours', '24 hours', '14 days', '7 days'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Commissioning Record', 'Building Log Book', 'O&M Manual', 'As-built drawings'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['10-15%', '15-25%', '25-35%', '5-10%'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Lighting controls', 'BMS and controls', 'Fire alarm', 'Hot water systems'],
    correctAnswer: 1,
    explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/h-n-c-module5-section5"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Code M is the management spine for commissioning: who does what, when, to what
              standard, with what evidence. A commissioning plan aligned to Code M is the
              deliverable that gives the client confidence the building will perform — not just be
              built. Many specifications now explicitly require Code M compliance.
            </>
          }
        ...
        <ConceptBlock title="CIBSE Code M Structure and Principles">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Part B — Air Distribution Systems:</strong> Ductwork, AHUs, terminals, extract
              systems
            </li>
            <li>
              <strong>Part C — Water Distribution Systems:</strong> Heating, chilled water, domestic
              water
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Early planning:</strong> Commissioning requirements identified at design stage
            </li>
            <li>
        ...
        <ConceptBlock title="Commissioning Management Plan Content">
          ...
          <p>
            ...
            electrical completion, theatre ventilation requiring BMS integration). The commissioning
            programme spanned 18 months with seasonal commissioning provisions for heating and
            cooling systems.
          </p>
          <p>
        ...
        <ConceptBlock title="Scheduling and Resource Coordination">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Level 1:</strong> Master commissioning milestones aligned with main programme
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>BMS and controls:</strong> 6-12 weeks — Points count, integration requirements
            </li>
            <li>
              <strong>Fire detection:</strong> 2-4 weeks — Device count, cause and effect
            </li>
            <li>
              <strong>Lifts:</strong> 2-4 weeks per lift — Type, traffic analysis, firefighting mode
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Pre-requisites for Commissioning">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>HVAC water systems:</strong> Pipework flushed and cleaned, chemical treatment,
              pump rotation checked
            </li>
            <li>
            ...
            <li>
              <strong>Fire detection:</strong> All devices installed, ceilings complete, interfaces
              connected
            </li>
            <li>
              <strong>Lifts:</strong> Shaft complete, machine room ready, electrical supplies, fire
              service connections
            </li>
            <li>
          ...
          <p>
            <strong>Real-world example — office building HVAC:</strong> A 15-storey office building
            commissioning was delayed by 3 weeks because water system pre-commissioning flushing was
            incomplete. Debris in pipework damaged pump seals during initial operation. The lesson:
            commissioning manager now requires photographic evidence of strainer condition and water
            sample test results before allowing pump energisation.
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Example 3 — Interface matrix:</strong> Identify commissioning dependencies for a
            fire alarm system.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>After fire alarm (dependent systems):</strong> Smoke damper operation testing
            </li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Insufficient contingency</strong> - Unrealistic programmes without snagging
                allowance
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              The construction programme shows "commissioning" as a single 4-week activity at the
              end. As handover approaches, electrical commissioning is incomplete (cables still
              being terminated), mechanical balancing is starting on systems that have not been
              tested, the BMS contractor is on holiday, and witness testing is scheduled before
              functional performance is verified. Handover slips by 6 weeks.
            </>
          }
          whatToDo={
            <>
              Commissioning must be planned from day one. Build a Commissioning Management Plan
              aligned to CIBSE Code M; identify dependencies between commissioning activities (e.g.,
              electrical complete before mechanical pre-commissioning before BMS integration). Show
              the dependencies on the master programme as logically-linked activities, not a single
              block. Brief subcontractors on commissioning programme. Hold weekly commissioning
              meetings from month nine onwards. Avoid the "commissioning as afterthought" trap — it
              is the most common cause of late handover in building services.
            </>
          }
          whyItMatters={
            <>
              Commissioning controls the handover date. A well-planned commissioning programme
              delivers a building that works on day one; a poorly-planned one delivers a building
              that limps into use, generates complaints, and absorbs aftercare resources for years.
              The PM's discipline at planning stage pays dividends at handover.
            </>
          }
        />
