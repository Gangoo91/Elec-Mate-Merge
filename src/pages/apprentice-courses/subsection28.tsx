...
const DESCRIPTION =
  'Reinforcing core safety concepts and building lifelong safe working habits for electrical professionals.';
  ...
  const quickCheckQuestions = [
    {
      ...
      correctIndex: 2,
      explanation:
        'Personal responsibility is the foundation of electrical safety - you are responsible for your safety and the safety of others affected by your work.',
    },
  ];
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Safe isolation ensures that electrical circuits are completely de-energised before work begins, preventing electrical shock, arc flash, and ensuring worker safety.',
    },
    {
      id: 2,
      ...
      correctAnswer: 2,
      explanation:
        'The Electricity at Work Regulations 1989 (EAWR) and Health and Safety at Work Act 1974 (HASAWA) are key regulations governing electrical safety in the workplace.',
    },
    {
      id: 3,
      ...
      correctAnswer: 2,
      explanation:
        'Damaged PPE cannot provide adequate protection and must be replaced immediately. Never use damaged PPE as it may fail when you need it most.',
    },
    {
      id: 4,
      ...
      correctAnswer: 1,
      explanation:
        'Good housekeeping prevents accidents by eliminating trip hazards, reducing fire risks, preventing water contact with electricity, and maintaining clear escape routes.',
    },
    {
      id: 5,
      ...
      correctAnswer: 0,
      explanation:
        'True. Competence in electrical work means consistently following safety procedures and regulations every time, regardless of time pressure or familiarity with the task.',
    },
    {
      id: 6,
      ...
      correctAnswer: 0,
      explanation:
        'RIDDOR stands for Reporting of Injuries, Diseases and Dangerous Occurrences Regulations - the legal requirement to report serious workplace incidents.',
    },
    {
      id: 7,
      ...
      correctAnswer: 2,
      explanation:
        'Never work on live circuits unless absolutely necessary, and only with proper training, equipment, and safety controls in place.',
    },
    {
      id: 8,
      ...
      correctAnswer: 1,
      explanation:
        'Emergency procedures exist to protect life, minimise harm, ensure swift help arrives, and maintain accountability during incidents.',
    },
    {
      id: 9,
      ...
      correctAnswer: 2,
      explanation:
        "If you're not competent for a task, you must refuse the work and seek proper training. Working beyond your competence level is dangerous and potentially illegal.",
    },
    {
      id: 10,
      ...
      correctAnswer: 2,
      explanation:
        'Safety systems, procedures, and PPE exist to protect you and others, not to slow you down. They are based on lessons learned from previous incidents and deaths.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-white text-sm leading-relaxed">
                You've completed Module 1 on Health and Safety. These aren't just rules for
                assessments — they're the foundation for working safely and professionally on any
                job. Master these principles and they'll serve you throughout your electrical
                career.
              </p>
            </div>
            <div className="bg-card border border-elec-yellow/30 rounded-lg p-4">
              ...
              <div className="space-y-2 text-white text-sm">
                <p>
                  <span className="text-elec-yellow">Spot:</span> Personal responsibility, live
                  working risks, safe isolation needs, PPE requirements, housekeeping issues
                </p>
                <p>
                  <span className="text-elec-yellow">Use:</span> Apply safety principles
                  consistently, take responsibility, follow procedures, report incidents, stay
                  competent
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              ...
              <span className="text-white">
                Reinforce the core safety concepts covered in Module 1
              </span>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span className="text-white">
                Summarise the responsibilities of electricians regarding safety
              </span>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
            ...
            <div className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span className="text-white">
                Encourage the development of lifelong safe working habits
              </span>
            </div>
          </div>
        </Card>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-white mb-6">
                These five principles form the foundation of electrical safety. Master them and
              ...
              <div className="bg-muted/50 border border-border rounded-lg p-4 mb-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="bg-elec-yellow text-black rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold flex-shrink-0">
                      1
                    </div>
                    <div>
                      <p className="text-white font-medium">Personal Responsibility</p>
                      <p className="text-white text-sm">
                        You are responsible for your safety — and for the safety of others affected
                        by your work
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white text-sm">
                        Never work on live circuits unless absolutely necessary — and only with the
                        right training and controls
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white text-sm">
                        Always use safe isolation procedures — isolate, lock off, and prove dead
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white text-sm">
                        Wear and maintain PPE — it's your last line of defence, not your first
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white text-sm">
                        Use the correct tools for the job — and inspect them regularly
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-muted/50 border border-border rounded-lg p-4">
                ...
                <p className="text-white text-sm">
                  These aren't suggestions — they're requirements for safe electrical work. Your
                  life and others depend on following them consistently.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-bold text-white mb-4">
                Additional Professional Principles
              </h2>
              <p className="text-white mb-6">
              ...
              <div className="bg-muted/50 border border-border rounded-lg p-4">
                ...
                <p className="text-white text-sm">
                  Being qualified means more than passing exams — it means working safely,
                  consistently, and professionally every day.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mb-8 border-l-4 border-indigo-500 p-6 bg-card rounded-lg">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-white mb-6">
                Electricians are trusted to work with systems that could kill. The best ones respect
              ...
              <div className="bg-muted/50 border border-border rounded-lg p-4">
                ...
                <p className="text-white text-sm">
                  On your first day on site — and your thousandth — these rules still apply. Safety
                  is not something you grow out of.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mb-8 border-l-4 border-elec-yellow p-6 bg-card rounded-lg">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-bold text-white mb-4">
                The Complete Electrical Professional
              </h2>
              <p className="text-white mb-6">
                Success in the electrical industry requires three skill sets working together:
                technical, safety, and professional.
              </p>
              ...
              <div className="bg-muted/50 border border-border rounded-lg p-4">
                ...
                <p className="text-white text-sm">
                  All three skill areas must work together. Technical skill without safety awareness
                  is dangerous. Safety knowledge without professional skills limits career growth.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mb-8 border-l-4 border-slate-500 p-6 bg-card rounded-lg">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-white mb-6">
                The choices you make about safety don't just affect you — they impact your family,
                colleagues, and the entire electrical industry.
              </p>
              ...
              <div className="bg-muted/50 border border-border rounded-lg p-4">
                ...
                <p className="text-white text-sm">
                  Electricity won't give you a second chance. Procedures, PPE, and risk assessments
                  aren't red tape — they're there because someone before you was injured or killed.
                  Be the person who breaks the cycle, not the next example.
                </p>
              </div>
            </div>
          </div>
        ...
        <Card className="p-6 bg-elec-yellow/5 border border-elec-yellow/20 mb-8">
          ...
          <div className="bg-card border border-elec-yellow/30 rounded-lg p-4 mb-4">
            ...
            <p className="text-elec-yellow text-sm">
              Two electricians with identical qualifications start their careers. One follows safety
              procedures religiously; the other takes shortcuts to work faster. After five years,
              the first has built a reputation for reliable, safe work and commands higher rates.
              The second has had three near misses and one reportable injury.
            </p>
          </div>
          <div className="bg-card border border-elec-yellow/30 rounded-lg p-4 mb-4">
            <h3 className="font-semibold text-elec-yellow mb-2">What Happened Next</h3>
            <p className="text-elec-yellow text-sm">
              The safety-conscious electrician becomes a team leader, mentors apprentices, and
              builds a successful career. The other struggles to find work as word spreads about
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-elec-yellow pl-4">
              <h3 className="font-semibold text-white mb-1">
                Will following safety procedures make me slower than other electricians?
              </h3>
              <p className="text-white text-sm">
                Initially perhaps, but safe workers avoid rework, injuries, and accidents that cost
                far more time. Speed comes with practice, safety must be consistent.
              </p>
            </div>
            <div className="border-l-4 border-green-500 pl-4">
              <h3 className="font-semibold text-white mb-1">
                What if experienced workers tell me safety rules don't matter?
              </h3>
              <p className="text-white text-sm">
                Some experienced workers have developed bad habits. Follow regulations and
                procedures regardless. Your career and life are worth more than fitting in.
              </p>
            </div>
            <div className="border-l-4 border-orange-500 pl-4">
              <h3 className="font-semibold text-white mb-1">
                How do I stay motivated to follow safety procedures every day?
              </h3>
              <p className="text-white text-sm">
                Remember that consistency builds habits. Think about your family, colleagues, and
                career. One mistake can change everything permanently.
              </p>
            </div>
            <div className="border-l-4 border-purple-500 pl-4">
              <h3 className="font-semibold text-white mb-1">
                What's the most important safety habit to develop first?
              </h3>
              <p className="text-white text-sm">
                Taking personal responsibility. When you truly accept that safety is your
                responsibility, all other good habits follow naturally.
              </p>
            </div>
            <div className="border-l-4 border-red-500 pl-4">
              <h3 className="font-semibold text-white mb-1">
                How do I keep learning about safety throughout my career?
              </h3>
              <p className="text-white text-sm">
                Attend refresher training, read incident reports, learn from near misses, stay
                updated with regulations, and always ask questions when unsure.
              </p>
            </div>
            <div className="border-l-4 border-elec-yellow pl-4">
              <h3 className="font-semibold text-white mb-1">
                What advice would you give to someone starting their electrical career?
              </h3>
              <p className="text-white text-sm">
                Build safety habits from day one. They're easier to develop than to change later.
                Your future self will thank you for the foundation you build now.
              </p>
            </div>
          </div>
        </Card>
