...
const Module4Section1_4 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'False – workflow planning applies to all projects regardless of size. Even small domestic jobs benefit from proper sequencing and coordination.',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      options: [
        ...
        'A task requiring special skills',
      ],
      correctAnswer: 1,
      explanation:
    ...
    },
    {
      ...
      options: [
        ...
        'Only materials create dependencies',
      ],
      correctAnswer: 1,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Ignore the changes',
        'Risk-assess and communicate changes',
  ...
  const quickChecks = [
    ...
    },
    {
      ...
      options: [
        "It's not necessary",
        'To prevent clashes, damage, and ensure efficient use of shared resources',
