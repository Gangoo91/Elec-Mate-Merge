...
const Module4Section1_4 = () => {
  ...
  const quizQuestions = [
    {
      ...
      options: [
        'Routing the cables through the containment',
        'Installing and connecting sockets and switches',
        'Fixing the back boxes into the wall',
        'Carrying out the initial site survey',
      ],
      correctAnswer: 1,
      explanation:
        'Second fix involves installing and connecting accessories like sockets, switches, and light fittings after first fix containment and cables are in place.',
    },
    {
      id: 2,
      question: 'On which projects is workflow planning necessary?',
      options: [
        'Only on large commercial jobs',
        'Only where more than one trade is involved',
        'All projects, regardless of size',
        'Only on new-build installations',
      ],
      correctAnswer: 2,
      explanation:
        'Workflow planning applies to all projects regardless of size. Even small domestic jobs benefit from proper sequencing and coordination.',
    },
    {
      id: 3,
      question: 'Name one reason to sequence high-level work before low-level work.',
      options: [
        'It prevents obstruction of access and avoids rework',
        'High-level materials cost less to buy',
        'High-level work is easier to see',
        'It reduces the amount of testing needed',
      ],
      correctAnswer: 0,
      explanation:
        'High-level work should be done first to prevent obstruction of access and avoid potential damage to completed low-level work.',
    },
    {
      id: 4,
      question: "What is a 'critical path task'?",
      options: [
        'A task that can be done at any point in the project',
        'A task that determines the project completion date',
        'A task carried out only by the site supervisor',
        'A task that requires a permit to work',
      ],
      correctAnswer: 1,
      explanation:
        'Critical path tasks are activities that directly determine the project completion date - any delay in these tasks delays the entire project.',
    },
    {
      id: 5,
      question: 'Give one example of a task dependency.',
      options: [
        'Choosing the colour of the accessories',
        'Selecting which cable manufacturer to use',
        "You can't terminate cables until devices are mounted",
        'Deciding how many breaks the team will take',
      ],
      correctAnswer: 2,
      explanation:
        'You cannot terminate cables until devices are mounted - this is a classic example of task dependency where one task must be completed before another can begin.',
    },
    {
      id: 6,
      ...
      options: [
        ...
        'Working without any planning tool',
      ],
      correctAnswer: 0,
      explanation:
        'Gantt charts, daily task sheets, and work programmes are essential planning tools for managing electrical installation projects effectively.',
    },
    {
      id: 7,
      question: 'Why is it risky to work in areas undergoing wet trades?',
      options: [
        'It increases the supply voltage in the area',
        'Risk of damage from moisture or debris',
        'It changes the colour coding of conductors',
        'It removes the need for a risk assessment',
      ],
      correctAnswer: 1,
      explanation:
        'Working in areas with wet trades (plastering, painting) risks damage to electrical equipment from moisture, chemicals, and debris.',
    },
    {
      id: 8,
      question: 'What should be done when workflow changes mid-project?',
      options: [
        'Continue without telling anyone to save time',
        'Stop all work until the project is re-tendered',
        'Risk-assess the change and communicate it',
        'Leave the change to the next shift to handle',
      ],
      correctAnswer: 2,
      explanation:
        'Workflow changes must be properly risk-assessed for safety implications and communicated to all relevant parties to maintain coordination.',
    },
  ];
  ...
  const quickChecks = [
    {
      ...
      options: [
        'Connecting the sockets and switches',
        'Installing containment systems and routing cables',
        'Carrying out the final electrical testing',
        'Producing the floor plan for the installation',
      ],
      correctIndex: 1,
      explanation:
        'First fix involves installing containment systems, routing cables, and fixing back boxes - the structural elements before accessories are connected.',
    },
    {
      id: 'coordination-check',
      question: 'Why is coordination with other trades important?',
      options: [
        'It removes the need to risk-assess the work',
        'It allows electrical work to skip the testing stage',
        'It lets the electrician work without drawings',
        'To prevent clashes, damage, and share resources efficiently',
      ],
      correctIndex: 3,
      explanation:
        'Coordination prevents trade clashes, equipment damage, ensures efficient use of scaffolding/lifts, and maintains overall project flow.',
    },
    {
      id: 'planning-check',
      ...
      correctIndex: 1,
      explanation:
        'Gantt charts provide visual timelines showing task sequences, dependencies, and critical path activities for effective project scheduling.',
    },
  ];
  ...
  const workflowPhases = [
    {
      ...
      activities:
        'Site surveys, drawing reviews, material ordering, risk assessments, method statements, permit applications',
    ...
    },
    {
      ...
      activities:
        'Installing containment systems, routing cables, fixing back boxes, earthing systems, cable pulling',
    ...
    },
    {
      ...
      activities:
        'Installing switches, sockets, light fittings, connecting circuits, labelling, initial testing',
    ...
    },
    {
      ...
      activities:
        'Full electrical testing, fault rectification, system commissioning, documentation, handover',
  ...
  const sequencingPrinciples = [
    ...
    },
    {
      ...
      rationale:
        'Ensures proper cable support, protection, and compliance with installation standards',
    },
    {
  ...
  const coordinationAspects = [
    {
      ...
      coordinationNeeds:
        'Opening schedules, embed requirements, access coordination, protection measures',
    },
    {
      trade: 'Plumbing/Mechanical',
      activities: 'Pipework installation, heating systems, ventilation, drainage',
      coordinationNeeds:
        'Route coordination, shared penetrations, equipment connections, controls integration',
    },
    {
      trade: 'HVAC Systems',
      activities: 'Ductwork, air handling units, controls, ventilation systems',
      coordinationNeeds:
        'Power supplies, control wiring, shared ceiling space, equipment coordination',
    },
    {
  ...
  const planningTools = [
    {
      ...
      applications:
        'Overall project scheduling, resource planning, progress monitoring, dependency tracking',
    },
    {
      tool: 'Daily Task Sheets',
      purpose: 'Detailed daily work planning and progress tracking for individual teams',
      applications:
        'Daily work allocation, skill matching, progress recording, issue identification',
    },
    {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-10">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm text-white">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    <strong>Spot:</strong> Task dependencies, trade clashes, critical path
                    activities.
                  </li>
                  <li>
                    <strong>Use:</strong> Logical sequencing, coordination meetings, planning tools.
                  </li>
                  <li>
                    <strong>Check:</strong> Dependencies met, resources available, safety
                    requirements.
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm text-white">
              ...
              <li>
                Adapt workflow to address unforeseen issues without compromising safety or quality.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4">
              {planningTools.map((tool, i) => (
                <div
                  key={i}
                  className="rounded-lg p-4 border-l-2 border-orange-500/50 bg-orange-500/5"
                >
                  <div className="flex items-start gap-3">
          ...
          <section className="mb-10">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <div className="space-y-2 text-sm text-white">
                ...
                <p>
                  <strong>Task sequencing</strong> should follow natural construction logic:
                  high-level before low-level, containment before cables, and coordination with
                  overall building sequence.
                </p>
                <p>
                  <strong>Trade coordination</strong> prevents clashes, equipment damage, and
                  ensures efficient use of shared resources like scaffolding, lifts, and workspace.
                </p>
                <p>
                  <strong>Planning tools</strong> like Gantt charts and daily task sheets provide
                  visual control and help identify critical path activities and dependencies.
                </p>
              </div>
            </div>
          </section>
