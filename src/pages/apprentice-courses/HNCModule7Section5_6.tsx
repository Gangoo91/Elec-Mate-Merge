...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Operating margin', 'Current ratio', 'Simple payback period', 'Gross profit margin'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['7-10 years', 'Less than 1 year', 'Over 15 years', '2-5 years'],
    correctAnswer: 3,
    explanation:
      ...
      <HubBody>
        ...
        <ConceptBlock title="Assessment Methodology and Energy Audits">
          <p>
            ...
            identify opportunities, quantify potential savings, and provide the data foundation for
            business case development and project specification.
          </p>
          <p>
            <strong>Energy Audit Levels (ASHRAE Standard):</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Level 3 - Investment-grade audit:</strong> Engineering analysis, monitoring
              data, life-cycle costing for capital decisions
            </li>
          </ul>
          <p>
            <strong>Audit Level Selection Guide</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Level 1:</strong> 1-2 days — Visual, utility bills — Initial screening, small
              buildings
            </li>
            <li>
              <strong>Level 2:</strong> 1-2 weeks — Inventory, spot measurements — Standard
              commercial projects
            </li>
            <li>
              <strong>Level 3:</strong> 4-8 weeks — Extended monitoring, modelling — Major
              investments, complex buildings
            </li>
          </ul>
          <p>
            <strong>Lighting Survey Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Equipment inventory:</strong> Lamp types, wattages, quantities, control gear
            </li>
            <li>
        ...
        <ConceptBlock title="Business Case Development">
          ...
          <p>
            <strong>Non-Financial Benefits</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Financial Analysis Methods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Simple Payback:</strong> Capital Cost ÷ Annual Savings — &lt; 5 years
            </li>
            <li>
              <strong>Net Present Value (NPV):</strong> ∑ Discounted Cash Flows - Initial Investment
              — &gt; £0 (positive)
            </li>
            <li>
              <strong>Internal Rate of Return (IRR):</strong> Discount rate where NPV = 0 — &gt; 15%
              typically
            </li>
            <li>
              <strong>Return on Investment (ROI):</strong> (Net Benefit ÷ Cost) × 100% — &gt; 20%
              annually
            </li>
          </ul>
          <p>
            <strong>Sample Payback Calculation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Project:</strong> Office LED Retrofit - 500 fittings
            </li>
            <li>
              <strong>Capital cost:</strong> £45,000 (equipment + installation)
            </li>
            <li>
              <strong>Energy saving:</strong> 75,000 kWh/year @ £0.30/kWh = £22,500/year
            </li>
            <li>
              <strong>Maintenance saving:</strong> £3,500/year
            </li>
            <li>
              <strong>Total annual saving:</strong> £26,000
            </li>
          </ul>
          <p>Simple payback: £45,000 ÷ £26,000 = 1.7 years</p>
          <p>
            <strong>Stakeholder tip:</strong> Present payback for finance teams, NPV for senior
            management, and carbon savings for sustainability officers - tailor metrics to audience.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="LED Retrofit Considerations and Implementation">
          ...
          <p>
            <strong>LED Retrofit Tube Types</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type A:</strong> Works with existing ballast — Simple lamp swap — Ballast
              compatibility critical
            </li>
            <li>
              <strong>Type B:</strong> Ballast bypass required — Rewiring needed — Mains voltage at
              lamp holder
            </li>
            <li>
              <strong>Type C:</strong> External LED driver — Driver installation — Correct driver
              matching
            </li>
            <li>
              <strong>Type A+B (Hybrid):</strong> Either mode — Flexible installation — Clear
              labelling essential
            </li>
          </ul>
          <p>
            <strong>Critical Safety Warning - Type B Installation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Implementation Planning Checklist</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Site survey:</strong> Confirm fitting types, access requirements, electrical
              infrastructure
            </li>
            <li>
            ...
            <li>
              <strong>Phasing:</strong> Plan installation by zones to maintain building operation
            </li>
            <li>
            ...
            <li>
              <strong>Documentation:</strong> Updated drawings, O&amp;M manuals, test certificates
            </li>
          </ul>
          <p>
            <strong>Control System Upgrades</strong>
          </p>
          <p>
            <strong>Occupancy Sensing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Daylight Dimming</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="IPMVP Verification and Post-Retrofit Commissioning">
          ...
          <p>
            <strong>IPMVP Option Selection</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Option A:</strong> Retrofit isolation: key parameter measurement — Single
              isolated measures, lighting retrofits
            </li>
            <li>
              <strong>Option B:</strong> Retrofit isolation: all parameter measurement — Variable
              loads, motors, chillers
            </li>
            <li>
              <strong>Option C:</strong> Whole facility: utility metering — Multiple measures, whole
              building approach
            </li>
            <li>
              <strong>Option D:</strong> Calibrated simulation — Complex buildings, new construction
            </li>
          </ul>
          <p>
            <strong>IPMVP Savings Equation</strong>
          </p>
          ...
          <p>
            <strong>Post-Retrofit Commissioning Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Illuminance verification:</strong> Measure lux levels at task plane against
          ...
          <p>
            <strong>M&amp;V Reporting Timeline</strong>
          </p>
          <p>
            <strong>Short-term (0-3 months)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Evaluate a £50,000 retrofit with £15,000 annual savings over
            10 years.
          </p>
          <p>Parameters:</p>
          ...
          <p>
            <strong>Scenario:</strong> Adjust baseline consumption for weather changes using IPMVP
            Option C.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Wrong tube type selection</strong> - Type B in Type A fitting causes safety
                risk
              </li>
              <li>
