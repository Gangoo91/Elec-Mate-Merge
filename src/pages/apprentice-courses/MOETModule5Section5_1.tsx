...
const quickCheckQuestions = [
  {
    ...
    options: ['ISO 9001', 'ISO/IEC 17025', 'BS 7671', 'IEC 61131-3'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'A replacement for calibration technicians',
      'Only a list of instrument serial numbers',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'As a percentage of the instrument cost',
      'As the number of test points used',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A type of adhesive for instrument mounting',
      ...
      'A UK government regulation',
      'A brand of calibration equipment',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It provides calibration procedures',
      ...
      'It specifies calibration intervals',
      'It certifies individual calibration technicians',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'For the comfort of the technician',
      ...
      'It is not important for modern digital instruments',
      'Only for laboratory-based calibrations',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A meeting to discuss calibration costs',
      ...
      'A review of the calibration procedure only',
      'An annual inspection of the calibration laboratory',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Type A is for pressure, Type B is for temperature',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Discard the standard immediately',
      'No action is needed',
    ],
    correctAnswer: 1,
    explanation:
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>SOPs:</strong> Controlled, step-by-step procedures for each calibration task
              </li>
              <li className="pl-1">
                <strong>ISO/IEC 17025:</strong> Laboratory competence standard for calibration
              </li>
              <li className="pl-1">
                <strong>GUM:</strong> Framework for evaluating measurement uncertainty
              </li>
              <li className="pl-1">
                <strong>Guard banding:</strong> Accounts for uncertainty in pass/fail decisions
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              ...
              <li className="pl-1">
                <strong>OOT investigation:</strong> Assesses impact when instruments found out of
                tolerance
              </li>
              <li className="pl-1">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> A calibration performed without following the approved
              procedure has no demonstrated validity, regardless of how accurate the result might
              be. Always use the current, controlled version of the SOP.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong>UKAS (United Kingdom Accreditation Service)</strong>. Accreditation
                  involves rigorous assessment of the laboratory's management system, technical
                  competence, and measurement capability through regular surveillance visits.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  An accredited calibration certificate carries the UKAS logo and provides the
                  highest level of confidence. It includes a verified uncertainty statement. Many
                  industries (pharmaceutical, aerospace, nuclear) require UKAS-accredited
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>ST1426 link:</strong> Maintenance technicians should understand the
              significance of UKAS accreditation when selecting calibration services, and ensure
              their own calibration activities follow documented procedures with traceable reference
              standards.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              <strong>Measurement uncertainty</strong>
              quantifies this doubt, expressing the range of values within which the true value is
              expected to lie with a stated confidence level. The internationally accepted framework
              for evaluating uncertainty is the
              <strong>
                {' '}
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Step 1:</strong> Identify all sources of uncertainty (Type A --
                  statistical analysis of repeated measurements; Type B -- specifications,
                  certificates, environmental effects)
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Step 4:</strong> Multiply by coverage factor k (typically k=2) for
                  expanded uncertainty U at approximately 95% confidence
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Repeatability</td>
                    ...
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Resolution</td>
                      <td className="border border-white/10 px-3 py-2">B</td>
                      <td className="border border-white/10 px-3 py-2">
                        Smallest display increment / 2
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Temperature effect</td>
                      <td className="border border-white/10 px-3 py-2">B</td>
                      <td className="border border-white/10 px-3 py-2">
                        Temperature coefficient x deviation
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Practical tip:</strong> When making pass/fail decisions, always consider
              measurement uncertainty. The guard band approach subtracts uncertainty from acceptance
              limits, ensuring declared passes are genuine.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Identify which processes or products were measured using the instrument
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  Decide on corrective action (product recall, process review, re-testing)
                </li>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> An OOT finding is not just a calibration issue -- it is a
              quality event that can have wide-ranging implications. Always follow the OOT
              investigation procedure thoroughly.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              When declaring an instrument as 'pass' or 'fail', the measurement uncertainty must be
              considered.
              <strong> ILAC-G8</strong> provides guidance on decision rules for statements of
              conformity. The simplest approach is <strong>guard banding</strong>, which narrows the
              acceptance limits by the measurement uncertainty.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>With guard band:</strong> Pass if reading is within plus/minus 0.08 bar
                  (0.1 - 0.02)
                </li>
                <li className="pl-1">
            ...
            <p>
              ...
              Some accept 'simple acceptance' (no uncertainty consideration), while regulated
              industries (pharmaceutical, nuclear) typically require guard banding. The decision
              rule used must be documented and agreed with the customer or regulatory authority.
            </p>

            <p className="text-sm text-white italic">
              <strong>Note:</strong> Calibration procedures and standards form the quality framework
              for all measurement activities. The principles covered here underpin the practical
              calibration techniques covered in the following sections of Module 5.5.
            </p>
          </div>
        </section>
