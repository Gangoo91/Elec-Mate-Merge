...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Only interviews with workers',
      'Documents, observations, and interviews combined',
      'Only management reports',
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Third-party audit', 'External audit', 'Internal audit', 'Certification audit'],
    correctAnswer: 2,
    explanation:
