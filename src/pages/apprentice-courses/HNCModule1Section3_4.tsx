...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Certification audit', 'Third-party audit', 'Internal audit', 'External audit'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 5 names monitoring and review as statutory duties. Audit and inspection are the
              two main mechanisms. As an HNC supervisor your audit programme is the evidence that
              the firm is meeting Reg 5.
            </>
          }
        ...
        <ConceptBlock title="Understanding Audits and Inspections">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Focus</strong> — Safety Audit: Management systems, procedures, compliance.
              Safety Inspection: Physical conditions, equipment, practices
            </li>
            <li>
              <strong>Depth</strong> — Safety Audit: Systematic, comprehensive, in-depth. Safety
              Inspection: Snapshot at a point in time
            </li>
            <li>
              <strong>Frequency</strong> — Safety Audit: Annual or planned programme. Safety
              Inspection: Daily to monthly based on risk
            </li>
            <li>
              <strong>Conducted by</strong> — Safety Audit: Trained auditors (internal/external).
              Safety Inspection: Supervisors, managers, safety reps
            </li>
            <li>
              <strong>Output</strong> — Safety Audit: Formal report with non-conformances. Safety
              Inspection: Checklist, action list, observations
            </li>
          </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Complementary approaches:</strong> Audits and inspections work together - audits
            ensure systems are in place; inspections verify they're implemented on the ground.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Statutory Inspection Requirements">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electrical installation</strong> — Regulation: EAWR / BS 7671. Typical
              Interval: 1-5 years (based on type)
            </li>
            <li>
              <strong>Lifting equipment (MEWP, hoist)</strong> — Regulation: LOLER 1998. Typical
              Interval: 6-12 months
            </li>
            <li>
              <strong>Pressure systems</strong> — Regulation: PSSR 2000. Typical Interval: As per
              written scheme
            </li>
            <li>
              <strong>Portable appliances</strong> — Regulation: EAWR (via PUWER). Typical Interval:
              3 months - 4 years (risk-based)
            </li>
            <li>
              <strong>Fire detection systems</strong> — Regulation: RRO / BS 5839. Typical Interval:
              Weekly test, annual service
            </li>
            <li>
              <strong>Emergency lighting</strong> — Regulation: RRO / BS 5266. Typical Interval:
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            retained and made available for inspection. LOLER thorough examinations require reports
            kept until the next examination; EICR kept for the period of the certificate plus 2
            years.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Conducting Effective Inspections">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Prepare:</strong> Review previous findings, incidents, current work activities
            </li>
            <li>
              <strong>Conduct:</strong> Follow systematic route, use checklist, observe and talk to
              workers
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Access/egress</strong> — Items to Check: Clear walkways, unobstructed exits,
              signage, lighting
            </li>
            <li>
              <strong>Electrical</strong> — Items to Check: Cable condition, temporary supplies,
              isolation points, testing records
            </li>
            <li>
              <strong>Working at height</strong> — Items to Check: Scaffold condition, ladder
              inspection tags, edge protection
            </li>
            <li>
              <strong>Fire precautions</strong> — Items to Check: Extinguisher condition, storage of
              flammables, hot work controls
            </li>
            <li>
              <strong>PPE</strong> — Items to Check: Correct PPE worn, condition, storage,
              availability
            </li>
            <li>
              <strong>Housekeeping</strong> — Items to Check: Waste management, material storage,
              slip/trip hazards
            </li>
          </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            builds ownership, and often identifies issues that outsiders miss. Safety reps have
            statutory rights to conduct inspections.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Corrective Action and Follow-up">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Immediate</strong> — Risk Level: Imminent danger. Timeframe: Stop work now.
              Example: Exposed live conductors
            </li>
            <li>
              <strong>High</strong> — Risk Level: High risk. Timeframe: Within 24-48 hours. Example:
              Scaffold incomplete
            </li>
            <li>
              <strong>Medium</strong> — Risk Level: Moderate risk. Timeframe: Within 1-2 weeks.
              Example: PPE storage inadequate
            </li>
            <li>
              <strong>Low</strong> — Risk Level: Low risk. Timeframe: Within 1 month. Example:
          ...
          <p className="text-sm text-white italic">
            <strong>Trend analysis:</strong> Review findings over time to identify patterns. Repeat
            issues in the same area may indicate systemic problems, training gaps, or cultural
        ...
        <ConceptBlock title="Practical Application">
          <p>
            <strong>Example 1: Weekly Site Inspection</strong>
          </p>
          ...
          <p>
            <strong>Example 2: Internal Safety Audit Finding</strong>
          </p>
          <p className="text-sm text-white mb-2">
        ...
        <ConceptBlock title="Key Points Summary">
          <div>
            <p>
              <strong>Audit Essentials</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>Audits verify systems - are policies and procedures implemented?</li>
              <li>Gather evidence from documents, observations, and interviews</li>
          ...
          <div>
            <p>
              <strong>Inspection Essentials</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              You are running a quarterly safety inspection on a 24-week multi-trade office fit-out.
              Last quarter&rsquo;s findings included blocked fire-escape routes and missing
              isolation locks. The actions were closed, but you want to verify on the ground.
            </>
          }
          whatToDo={
            <>
              Walk the floors with the principal contractor&rsquo;s safety lead and the workforce
              safety rep. Check fire routes physically (not just paperwork), check isolation lock
              kits at each TBA, sample five RAMS at random, observe a live task. Photograph
              findings, score against a numerical checklist, prioritise actions: red (stop work),
              amber (close within 7 days), green (improvement). Issue the report within 48 hours,
              allocate named owners, follow up at the next review.
            </>
          }
          whyItMatters={
            <>
              Closing actions on paper without verifying on the floor is the most common audit
              failing. The HSE will sample your inspection records after any incident and a
              paper-only history is treated as evidence of a wider failure.
            </>
          }
        />
