...
const DESCRIPTION =
  'Master conductor resistance calculations for electrical installations. Learn about resistivity, factors affecting resistance, and how to calculate resistance from cable dimensions.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 0,
    explanation:
      'Copper has a resistivity of 1.72 x 10^-8 ohm metres at 20 degrees C. This very low value is why copper is the most common conductor material. Aluminium has a slightly higher resistivity of 2.82 x 10^-8 ohm metres.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'Resistance is directly proportional to length. Using R = rho x L / A, if length doubles (2L), resistance doubles (2R). Think of it as electrons having twice as far to travel through the material.',
  },
  {
    id: 'check-3',
    question:
      'If you double the cross-sectional area of a conductor, what happens to its resistance?',
    options: ['It halves', 'It doubles', 'It stays the same', 'It quadruples'],
    correctIndex: 0,
    explanation:
      'Resistance is inversely proportional to cross-sectional area. Using R = rho x L / A, if area doubles (2A), resistance halves (R/2). Think of it as electrons having more paths available to flow through.',
  },
  {
    id: 'check-4',
    question:
      'Which has lower resistance: a 1.5mm squared cable or a 2.5mm squared cable of the same length and material?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'The 2.5mm squared cable has lower resistance because it has a larger cross-sectional area. Resistance is inversely proportional to area, so larger conductors have lower resistance for the same length and material.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: ['R = rho x A / L', 'R = rho x L / A', 'R = L x A / rho', 'R = rho x L x A'],
    correctAnswer: 1,
    explanation:
      'R = rho x L / A where R is resistance (ohms), rho is resistivity (ohm metres), L is length (metres), and A is cross-sectional area (square metres). Resistance increases with length and decreases with area.',
  },
  {
    id: 2,
    question: 'The SI unit of resistivity is:',
    options: ['Ohms per metre', 'Ohm metres', 'Ohms per square metre', 'Ohms'],
    correctAnswer: 1,
    explanation:
      'Resistivity is measured in ohm metres. From R = rho x L / A, rearranging gives rho = R x A / L. The units are ohms x square metres / metres = ohm metres.',
  },
  {
    id: 3,
    question:
      'A 10 metre length of 2.5mm squared copper cable has approximately what resistance at 20 degrees C?',
    options: ['0.069 ohms', '0.69 ohms', '6.9 ohms', '0.0069 ohms'],
    correctAnswer: 0,
    explanation:
      'R = rho x L / A = (1.72 x 10^-8 x 10) / (2.5 x 10^-6) = 0.069 ohms. Note the conversion of mm squared to m squared (divide by 10^6).',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      "Aluminium has a resistivity of 2.82 x 10^-8 ohm metres compared to copper's 1.72 x 10^-8. This is about 1.6 times higher, so aluminium conductors need to be about 1.6 times the cross-sectional area for equivalent resistance.",
  },
  {
    id: 5,
    question: 'In cable tables, resistance values are typically given in:',
    options: ['Ohms per kilometre', 'Milliohms per metre', 'Microohms per metre', 'Ohms per metre'],
    correctAnswer: 1,
    explanation:
      'Cable tables commonly express resistance as milliohms per metre (mOhms/m) for practical cable lengths. Appendix 4 of BS 7671 uses mV/A/m values which incorporate resistance. The IET On-Site Guide Table I1 gives R1+R2 values in milliohms per metre.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'For metallic conductors like copper and aluminium, resistance increases with temperature. This is because atomic vibrations increase with temperature, impeding electron flow. The temperature coefficient of copper is approximately +0.004 per degree C.',
  },
  {
    id: 7,
    ...
    correctAnswer: 0,
    explanation:
      'Rt = R20 x (1 + alpha x (T - 20)) where Rt is resistance at temperature T, R20 is resistance at 20 degrees C, and alpha is the temperature coefficient. For copper, alpha is approximately 0.004 per degree C.',
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      'Table I1 in the IET On-Site Guide provides combined R1+R2 values in milliohms per metre for common cable combinations. This is useful for calculating earth fault loop impedance.',
  },
  {
    id: 9,
    question:
      'A stranded conductor has slightly higher resistance than a solid conductor of the same cross-sectional area because:',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'The small air gaps between individual strands slightly reduce the effective conducting cross-sectional area. However, the difference is minimal and stranded conductors are preferred for flexibility and ease of installation.',
  },
  {
    id: 10,
    question:
      'When calculating circuit resistance for earth fault loop impedance, why multiply by a factor of 1.2?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'The 1.2 factor accounts for the increase in conductor resistance at maximum operating temperature (typically 70 degrees C for thermoplastic) compared to the 20 degrees C values used in tables. Regulation 522.1.5 refers to this.',
  },
  {
    id: 11,
    question:
      'The resistance of 100m of 1.5mm squared / 1.0mm squared twin and earth cable (R1+R2) is approximately:',
    options: ['0.3 ohms', '3 ohms', '30 ohms', '0.03 ohms'],
    correctAnswer: 1,
    explanation:
      'From IET On-Site Guide Table I1, R1+R2 for 1.5/1.0mm squared cable is approximately 30.2 milliohms per metre. For 100m: 30.2 x 100 / 1000 = 3.02 ohms (approximately 3 ohms).',
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      'The CPC only carries fault current for short durations, not continuous load current. Therefore it can be smaller, reducing cable cost and weight. However, it must be large enough to carry prospective fault current for the disconnection time required.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Resistivity (rho) represents the resistance of a unit cube of material (1m x 1m x 1m). The formula R = rho x L / A can be rearranged to rho = R x A / L. The units are ohms x square metres / metres = ohm metres. This standardised unit allows comparison between different materials regardless of conductor dimensions.',
  },
  {
    question: 'How do I convert between mm squared and m squared for calculations?',
    answer:
      'To convert mm squared to m squared, divide by 1,000,000 (10^6). For example, 2.5mm squared = 2.5 x 10^-6 m squared. This is a common source of calculation errors - remember that 1mm = 0.001m, so 1mm squared = 0.000001 m squared.',
  },
  {
    question: 'Why do we need to know conductor resistance for circuit design?',
    answer:
      'Conductor resistance is essential for: calculating voltage drop (to ensure adequate voltage at the load), determining earth fault loop impedance (to verify protective device operation), calculating cable heating (I squared R losses), and designing circuit protection. BS 7671 sets maximum values for these parameters.',
  },
  {
    question: 'What is the difference between resistance and impedance?',
    answer:
      'Resistance opposes DC current flow and is caused by the physical properties of the conductor. Impedance is the total opposition to AC current flow and includes resistance plus reactance (from inductance and capacitance). For most low voltage installations, reactance is negligible and impedance approximately equals resistance.',
  },
  {
    question: 'How does cable construction affect resistance?',
    answer:
      'Solid conductors have slightly lower resistance than stranded due to no air gaps. Class 5 (flexible) conductors have more strands and slightly higher resistance than Class 2 (stranded). The conductor material (copper vs aluminium), purity, and any coating (tinning) also affect resistance.',
  },
  {
    question:
      'What resistance values should I use for calculations - 20 degrees C or operating temperature?',
    answer:
      'Use 20 degrees C values from tables for initial selection. Then apply a temperature correction factor (typically 1.2 for thermoplastic at 70 degrees C) when verifying earth fault loop impedance to ensure compliance at operating temperature. BS 7671 Table 4A2 and Regulation 522.1.5 provide guidance.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Formula:</strong> R = rho x L / A (resistance = resistivity x length / area)
              </li>
              <li>
                <strong>Copper:</strong> Resistivity = 1.72 x 10^-8 ohm metres
              </li>
              <li>
                <strong>Temperature:</strong> Resistance increases with temperature
              </li>
              <li>
                <strong>Tables:</strong> Use IET On-Site Guide Table I1 for R1+R2 values
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Cable sizes (1.5, 2.5, 4, 6mm squared)
              </li>
              <li>
                <strong>Use:</strong> Table I1 for circuit resistance calculations
              </li>
              <li>
                <strong>Apply:</strong> Multiply by 1.2 for operating temperature correction
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Every material has an inherent opposition to current flow called resistivity (symbol:
              rho). Resistivity is a property of the material itself, independent of the conductor's
              dimensions. The actual resistance of a conductor depends on three factors: the
              material's resistivity, the conductor's length, and its cross-sectional area.
            </p>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-white/10 my-6">
              <p className="text-sm font-medium text-white mb-2">
                Common Conductor Material Resistivities (at 20 degrees C):
              </p>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-white/10">
                      ...
                      <th className="text-left py-2 text-elec-yellow/80">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Why Copper?</strong> Silver has lower resistivity but is too expensive. Copper
              offers the best balance of conductivity, cost, and workability. Aluminium is used
              where weight savings justify the larger conductor size required.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Understanding how each factor affects resistance is crucial for cable selection and
              circuit calculations. The resistance formula shows that resistance is directly
              proportional to length and resistivity, and inversely proportional to cross-sectional
              area.
            </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white space-y-2 font-mono">
                ...
                <p className="text-green-400 mt-2">
                  The conductor resistance is approximately 0.108 ohms (108 milliohms)
                </p>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              For metallic conductors, resistance increases with temperature. As temperature rises,
              atoms vibrate more vigorously, creating more collisions with flowing electrons and
              increasing resistance. This is important because cables operating at their rated
              current will be hotter than ambient temperature.
            </p>
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20 my-6">
              ...
              <p className="text-xs text-white">
                ...
                requirement. A circuit that appears to comply at 20 degrees C may not comply at
                operating temperature.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Practical Application:</strong> When using a low resistance ohmmeter to
              measure circuit resistance, readings are taken at ambient temperature (approximately
              20 degrees C). Multiply by 1.2 for PVC-insulated cables to determine worst-case
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              For practical circuit design and verification, published tables provide resistance
              values for common cable types. The IET On-Site Guide Table I1 is particularly useful,
              giving combined R1+R2 values (line plus circuit protective conductor) in milliohms per
              metre.
            </p>

            <div className="p-4 rounded-lg bg-transparent border border-white/10 my-6">
              <p className="text-sm font-medium text-white mb-2">
                Sample R1+R2 Values from IET On-Site Guide Table I1:
              </p>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white space-y-2 font-mono">
                ...
                <p className="mt-2">
                  <strong>Step 2:</strong> Calculate for circuit length
                </p>
                <p className="ml-4">R1+R2 = 19.51 x 20 = 390.2 mOhms = 0.39 ohms</p>
                <p className="mt-2">
                  <strong>Step 3:</strong> Apply temperature correction (x1.2 for PVC at 70 degrees
                  C)
                </p>
                <p className="ml-4">R1+R2 (corrected) = 0.39 x 1.2 = 0.47 ohms</p>
                <p className="text-green-400 mt-2">
                  The circuit resistance at operating temperature is 0.47 ohms
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Calculating Circuit Resistance
              </h3>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Unit conversion errors</strong> - mm squared to m squared requires
                  dividing by 10^6
                </li>
                <li>
                  <strong>Forgetting temperature correction</strong> - measured values are at
                  ambient, not operating temperature
                </li>
                <li>
                  <strong>Using wrong table column</strong> - ensure correct conductor combination
                </li>
                <li>
                  <strong>Cable route length</strong> - actual route is often longer than direct
                  distance
                </li>
              </ul>
            </div>
