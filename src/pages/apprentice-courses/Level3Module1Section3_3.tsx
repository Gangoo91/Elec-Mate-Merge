...
const DESCRIPTION =
  'Understand when live working is permitted, the legal requirements under Electricity at Work Regulations, and the strict precautions required for any live work.';
...
const quickCheckQuestions = [
  {
    id: 'check-1',
    question:
      'According to Regulation 14 of the Electricity at Work Regulations, when is live working permitted?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Regulation 14 permits live working ONLY when it is unreasonable in all circumstances for the equipment to be dead, AND suitable precautions are taken to prevent injury. Both conditions must be met. Convenience or time-saving is NOT a valid reason.',
  },
  {
    id: 'check-2',
    question:
      'An electrician wants to trace a fault by testing on a live circuit. Is this considered live working?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Testing, fault-finding, and any activity where there is a foreseeable risk of contact with live conductors is considered live working. The Electricity at Work Regulations apply to ALL such work, regardless of the purpose.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 2,
    explanation:
      'Testing often requires the circuit to be live to identify faults (e.g., finding where voltage is lost) or verify correct operation. This is a legitimate reason why working dead may be unreasonable. Customer inconvenience or time pressure are NOT valid reasons.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      'The Electricity at Work Regulations place duties on both employers (to provide safe systems of work, training, and equipment) AND employees (to cooperate, use precautions, and not work beyond their competence). Both share responsibility for safety.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'Under the Electricity at Work Regulations 1989, what must be proven before live working is permitted?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Regulation 14 states that live working is only permitted when it is 'unreasonable in all the circumstances' to work dead, AND adequate precautions are taken to prevent injury. Both conditions must be satisfied - one alone is insufficient.",
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Live testing is often necessary because the circuit must be energised to locate faults or verify operation. Customer convenience, speed, or lack of equipment are NOT valid justifications for live working under the regulations.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Planned live work should be supported by a documented risk assessment and method statement. These identify hazards, assess risks, and specify control measures. This demonstrates that the work has been properly planned and that precautions are adequate.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      "The Electricity at Work Regulations require persons to be 'competent' - having adequate knowledge, experience, and understanding of the work and associated risks. This varies depending on the complexity and danger of the work. A qualification alone doesn't guarantee competence for specific live work.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      "Accompanied working means having another competent person present who understands the hazards and can provide emergency assistance including isolating the supply and administering first aid or CPR if electric shock occurs. They shouldn't be a passive observer.",
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Suitable precautions include: insulated tools meeting relevant standards, physical barriers to prevent contact, appropriate PPE, accompanied working, clear work space, proper lighting, avoiding jewellery/conductive items, and following documented safe systems of work.',
  },
  {
    id: 7,
    question:
      'What class of insulated tools should be used for live working on low voltage systems?',
    options: [
      'Class 0',
    ...
    correctAnswer: 1,
    explanation:
      'VDE rated tools are tested to 10,000V and certified safe for use on systems up to 1000V AC. They have distinctive red/yellow insulation and the VDE mark. Standard tools with rubber handles are NOT adequate protection for live working.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Test equipment should meet GS38 requirements (fused leads, shrouded probes, appropriate CAT rating), be in good condition (no damaged insulation, probes intact), and be suitable for the voltage and environment. Pre-use checks are essential safety measures.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'The Electricity at Work Regulations require persons to not engage in work beyond their competence. An apprentice should only undertake live work under appropriate supervision matching their competence level, or refuse if they cannot work safely.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Shrouded probes with limited exposed metal (max 4mm per GS38) prevent accidental short circuits to adjacent conductors and reduce the risk of arc flash. The shrouding protects the user from inadvertent contact during live testing.',
  },
  {
    id: 11,
    ...
    correctAnswer: 1,
    explanation:
      'Metal jewellery and watches are excellent conductors. They could contact live parts causing short circuits (leading to burns and arc flash) or provide a low-resistance path for current through your body. Remove all conductive items before live work.',
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      'If precautions are found to be inadequate during live work, you must STOP immediately. Continuing puts you at risk. Reassess the situation, implement additional controls, or decide if the work can reasonably continue. Safety takes priority over task completion.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Yes, this is a common example of live testing where it's unreasonable to work dead - you need voltage present to check polarity. However, you must use GS38-compliant test equipment, ensure adequate precautions (appropriate probes, clear work area), and be competent to do the work safely.",
  },
  {
    question: 'Does live working always require two people?',
    answer:
      'Not always, but accompanied working is strongly recommended for most live work, especially where shock risk is significant. For some low-risk live testing (e.g., using a socket tester), single working may be acceptable if other precautions are in place. The risk assessment determines whether accompanied working is necessary.',
  },
  {
    question:
      'My boss wants me to work live because isolating would shut down production. Is this legal?',
    answer:
      "Economic considerations alone do NOT justify live working. The test is whether it's 'unreasonable in ALL circumstances' to work dead. Production loss might be considered, but safety must take priority. If dead working is reasonably practicable, it must be done dead. Document any pressure to work unsafely.",
  },
  {
    question: 'What happens if someone is injured during authorised live work?',
    answer:
      "Even if live working was justified and authorised, the employer and duty holders may still be liable if precautions were inadequate. The incident must be reported (RIDDOR if applicable), investigated, and lessons learned. The fact that work was 'authorised' doesn't exempt anyone from ensuring precautions were sufficient.",
  },
  {
    question: 'Are there any situations where live working is completely prohibited?',
    answer:
      'High voltage work (above 1000V AC or 1500V DC) is subject to even stricter controls and is generally prohibited except for specific operations by specially trained personnel. Work inside live panels, work in confined spaces with shock risk, and work by non-competent persons should not proceed live.',
  },
  {
    question: 'How do I document that live working was justified?',
    answer:
      'Record: why dead working was unreasonable (specific technical reason), the risk assessment findings, precautions implemented, competence of persons involved, and authorisation (if your company requires it). This creates an audit trail showing the decision was properly made. Keep records even for routine testing.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Default:</strong> Work dead - live working is the exception, not the rule
              </li>
              <li>
                <strong>Two conditions:</strong> Must be unreasonable to work dead AND precautions
                adequate
              </li>
              <li>
                <strong>Testing:</strong> Often requires live - legitimate reason, but still needs
                precautions
              </li>
              <li>
                <strong>Never:</strong> Convenience, speed, or customer preference alone
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Ask:</strong> "Can this reasonably be done dead?"
              </li>
              <li>
                <strong>If live:</strong> VDE tools, GS38 testers, barriers, clear area, no
                jewellery
              </li>
              <li>
                <strong>Document:</strong> Why dead working was unreasonable
              </li>
              <li>
                <strong>Accompanied:</strong> For significant shock risk
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The Electricity at Work Regulations 1989 establish the fundamental principle: work
              should be done dead. Regulation 14 states that no person shall work on or near live
              conductors unless it is unreasonable in all the circumstances for them to be dead, AND
              suitable precautions are taken to prevent injury.
            </p>
            <p>
              This creates a two-part test. First, can the work reasonably be done dead? If yes, it
              MUST be done dead. Only if dead working is genuinely unreasonable do you move to the
              second part: are the precautions adequate? Both conditions must be satisfied for live
              work to be lawful.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> The law doesn't prohibit live working - it restricts it to
              situations where dead working is genuinely unreasonable AND precautions are adequate.
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The most common legitimate reason for live working is testing and fault-finding. You
              cannot measure voltage on a dead circuit. You cannot find where voltage is lost
              without the circuit being energised. You cannot verify correct operation of controls
              and protection without power. These are genuine technical reasons.
            </p>
            ...
            <p className="text-sm text-white italic">
              ...
              because you genuinely cannot diagnose the fault without power. But you still need
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Even when live working is justified, it remains dangerous. The precautions you take
              must reduce risk to the lowest level reasonably practicable. These aren't optional
              extras - they're the second legal requirement that must be satisfied.
            </p>
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  tested to 10,000V for safety margin.
                </p>
              </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Precautions Are Not Optional:</strong> If you cannot implement adequate
              precautions, you cannot do the work live. "We didn't have the right equipment" is not
              a defence - it means the work should not have proceeded.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The Electricity at Work Regulations require that people have adequate competence for
              the work they do. For live working, this means understanding both the technical
              aspects and the specific hazards and precautions. Competence isn't just about
              qualifications - it's about genuine capability.
            </p>
            ...
            <p className="text-sm text-white italic">
              ...
              supervisor told me to" is not a legal defence.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Decision Process for Live Working
              </h3>
