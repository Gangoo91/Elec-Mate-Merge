...
const TITLE =
  'Using Hand and Power Tools Safely and Legally - Module 4.7.2 | Level 2 Electrical Course';
const DESCRIPTION =
  'Learn safe and legal use of hand and power tools in electrical work. Master tool safety, maintenance, and legal requirements under PUWER and EAWR regulations.';
  ...
  const faqs = [
    {
      ...
      answer:
        'Yes, but they must be in good condition and meet safety standards. Your employer may require them to be inspected and tested before use. Personal tools must comply with the same safety requirements as company-provided equipment.',
    },
    {
      question: 'How often should portable power tools be tested (PAT)?',
      answer:
        "Typically every 6–12 months, depending on site rules and usage frequency. High-risk environments may require more frequent testing, while office environments may allow longer intervals. Always follow your employer's specific requirements.",
    },
    {
      question: 'What should I do if a tool feels unsafe during use?',
      answer:
        'Stop immediately, tag it as defective, and report it to your supervisor. Never continue using a tool that feels unsafe - unusual vibration, sparking, or overheating are all warning signs that require immediate attention.',
    },
  ];
            ...
            <div className="grid md:grid-cols-2 gap-4 text-white">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    Hand and power tools are essential in electrical installation but can cause
                    serious injuries if used improperly.
                  </li>
                  <li>
                    Legal requirements under PUWER 1998 and EAWR 1989 mandate safe tool use,
                    maintenance, and inspection.
                  </li>
                  <li>
                    Proper tool selection, correct operation, and regular maintenance prevent most
                    tool-related accidents and equipment failures.
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Spot:</strong> Damaged tool leads, missing guards, blunt cutting edges,
                    tools without RCD protection.
                  </li>
                  <li>
                    <strong>Use:</strong> Insulated hand tools, RCD-protected power supplies,
                    correct PPE for each task.
                  </li>
                  <li>
                    <strong>Check:</strong> Tool condition before use, appropriate tool for the job,
                    secure workpieces before drilling.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm list-disc pl-6 space-y-1">
                  <li>
                    <strong>Suitable equipment</strong> - tools must be appropriate for the work and
                    environment
                  </li>
                  <li>
                    <strong>Maintenance requirements</strong> - regular inspection and maintenance
                    to keep tools safe
                  </li>
                  <li>
                    <strong>Training obligations</strong> - users must be trained and competent in
                    tool operation
                  </li>
                  <li>
                    <strong>Information provision</strong> - adequate information about risks and
                    safe use
                  </li>
                  <li>
                    <strong>Inspection schedules</strong> - systematic checks to identify defects
                    before they cause harm
                  </li>
                  <li>
                    <strong>Dangerous parts protection</strong> - guards and safety devices must be
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
                ...
                <ul className="text-sm list-disc pl-6 space-y-1">
                  <li>
                    <strong>Cuts, burns, and eye injuries</strong> - from sharp edges, hot surfaces,
                    and flying debris
                  </li>
                  <li>
                    <strong>Electric shock from damaged equipment</strong> - faulty cables, broken
                    plugs, or compromised insulation
                  </li>
                  <li>
                    <strong>Trips from trailing extension leads</strong> - poor cable management and
                    inadequate routing
                  </li>
                  <li>
                    <strong>Noise and vibration risks</strong> - hearing damage and hand-arm
                    vibration syndrome (HAVS)
                  </li>
                  <li>
                    <strong>Struck by moving parts</strong> - unguarded cutting blades, rotating
                    chucks, and reciprocating components
                  </li>
                  <li>
                    <strong>Respiratory hazards</strong> - dust, fumes, and particles from cutting
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-green-500/10 border-l-2 border-green-500/50">
                ...
                <ul className="text-sm list-disc pl-6 space-y-1">
                  <li>
                    <strong>Screwdrivers</strong> - use correct size and type to avoid slipping,
                    ensure insulated handles for electrical work
                  </li>
                  <li>
                    <strong>Pliers and cutters</strong> - maintain sharp cutting edges, use
                    insulated versions near live conductors
                  </li>
                  <li>
                    <strong>Hammers</strong> - check handles and heads are secure, use appropriate
                    weight for the task
                  </li>
                  <li>
                    <strong>Spanners and wrenches</strong> - select correct size to prevent slipping
                    and damage to fasteners
                  </li>
                  <li>
                    <strong>Files and saws</strong> - keep cutting surfaces clean and sharp, secure
                    workpieces properly
                  </li>
                  <li>
                    <strong>Measuring tools</strong> - handle carefully to maintain accuracy, store
                    in protective cases
                  </li>
                </ul>
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-amber-500/10 border-l-2 border-amber-500/50">
                ...
                <ul className="text-sm list-disc pl-6 space-y-1">
                  <li>
                    <strong>Pre-use inspection</strong> - check plugs, leads, and guards before each
                    use
                  </li>
                  <li>
                    <strong>RCD protection</strong> - all portable power tools must be RCD-protected
                    (30mA trip)
                  </li>
                  <li>
                    <strong>Appropriate PPE</strong> - safety glasses, gloves, ear defenders as
                    required by task
                  </li>
                  <li>
                    <strong>Workpiece security</strong> - clamp or secure items before cutting,
                    drilling, or grinding
                  </li>
                  <li>
                    <strong>Correct technique</strong> - maintain firm grip, stable stance, and
                    controlled operation
                  </li>
                  <li>
                    <strong>Environmental awareness</strong> - check for hidden services, adequate
                    lighting, and stable surfaces
                  </li>
                </ul>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-purple-500/10 border-l-2 border-purple-500/50">
                <p className="font-semibold text-purple-400 mb-2">
                  Tool Maintenance and Storage Systems
                </p>
                <ul className="text-sm list-disc pl-6 space-y-1">
                  <li>
                    <strong>Daily inspection</strong> - check tools before and after each use for
                    defects
                  </li>
                  <li>
                    <strong>Immediate removal</strong> - tag and remove faulty tools from service
                    immediately
                  </li>
                  <li>
                    <strong>Cleaning procedures</strong> - keep tools clean and free from debris and
                    contaminants
                  </li>
                  <li>
                    <strong>Proper storage</strong> - store in correct cases, racks, or designated
                    areas
                  </li>
                  <li>
                    <strong>Environmental protection</strong> - keep tools dry and protected from
                    damage
                  </li>
                  <li>
                    <strong>Regular maintenance</strong> - follow manufacturer schedules for
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="font-medium text-white">
                      PUWER requires safe and suitable tool use
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                    <span className="font-medium text-white">
                      Use insulated hand tools for electrical work
                    </span>
                  </div>
                </div>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                    <span className="font-medium text-white">
                      Always wear PPE for cutting, drilling, or grinding
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                    <span className="font-medium text-white">
                      Faulty tools = tag, remove, report
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                    <span className="font-medium text-white">
                      RCD protection for all portable power tools
                    </span>
                  </div>
                </div>
              </div>
