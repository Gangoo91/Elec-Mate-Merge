    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Understand the fundamental mechanisms of heat transfer and their application to building
          fabric performance
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the three modes of heat transfer - conduction, convection and
          radiation - and their practical application in calculating U-values, identifying thermal
          bridges, and determining building heat loads to CIBSE and Part L standards.
        </p>
