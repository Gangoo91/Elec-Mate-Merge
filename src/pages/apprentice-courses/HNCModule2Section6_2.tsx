...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['50-100% higher', '150-300% higher', 'No significant difference', '10-20% higher'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              TM46 + TM54 are the design-to-operation toolkit. As HNC engineer you cite TM46 to set
              baseline expectations against the developer&rsquo;s peers, and you run TM54 alongside
              the SBEM/SAP submission so the client sees the realistic operational forecast — not
              just the regulated-energy EPC band.
            </>
          }
        ...
        >
          ...
          <p>
            ...
            effective interventions. If ventilation losses dominate, heat recovery is more valuable
            than fabric upgrades.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            CIBSE TM46 provides energy benchmarks for different building types, enabling comparison
            of actual performance against typical and good practice values. These benchmarks
            underpin Display Energy Certificates (DECs).
          </p>
          <p>
            <strong>
              TM46 benchmark categories (electricity / fossil-thermal in kWh/m², typical / good):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          <p>
            ...
            provides methodology for predicting realistic energy consumption, bridging the gap
            between compliance calculations and actual operational performance.
          </p>
          <p>
            <strong>
              TM54 additional considerations (factor / Part L assumption / TM54 reality):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          ...
          <p>
            ...
            2.5× design predictions. Schools typically 2× design predictions. Electricity gap often
            larger than heating gap. Gap has not significantly reduced over past decade.
          </p>
          <p>
        ...
        >
          <p>
            ...
            consumes 750,000 kWh electricity and 600,000 kWh gas annually. Calculate the DEC rating.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              DEC Rating: (57.0 / 62.6) × 100 = <strong>91 (Band D)</strong>
            </li>
            <li>Building performs slightly better than typical</li>
          </ul>
          <p>
            <strong>Example 2 - TM54 uplift:</strong> A Part L calculation shows 80 kWh/m² regulated
            energy for an office. Estimate TM54 operational energy.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              TM54 prediction: <strong>180 kWh/m²</strong> - 2.25× the Part L calculation
            </li>
          </ul>
          <p>
            <strong>Example 3 - Weather normalisation:</strong> A building used 450 MWh heating
            energy in a year with 2,100 degree days. Long-term average is 2,400 degree days. What is
            the weather-normalised consumption?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Weather-normalised consumption: 450 / 0.875 = <strong>514 MWh</strong>
            </li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 12,000 m² hospital wing is consuming 480 kWh/m²·year against a TM46 typical
              benchmark of 410 and a design forecast of 360. The client wants to know why and what
              to fix. You have access to one year of half-hourly meter data, BMS trend logs and the
              original Stage-4 design file.
            </>
          }
          whatToDo={
            <>
              Weather-normalise consumption to a 20-year degree-day baseline. Disaggregate meter
              data by end use (HVAC, lighting, IT, hot water, kitchen). Compare against CIBSE TM46
              healthcare sub-categories. Build the Sankey energy balance from BMS data and compare
              to the TM54 design model. Identify the top three excess paths — typically:
              simultaneous heating &amp; cooling, AHU running 24/7, hot-water deadleg losses. Quote
              the kWh and £ saving for each fix.
            </>
          }
          whyItMatters={
            <>
              NHS Trusts are under explicit Net-Zero targets (NHS Net Zero by 2040 for Scope 1+2). A
              17% performance gap on a 12,000 m² wing is roughly £40k/yr and 100+ tCO₂e. The Sankey
              + TM54 closing exercise turns vague &ldquo;feels too high&rdquo; complaints into a
              costed, prioritised retrofit plan.
            </>
          }
        />
