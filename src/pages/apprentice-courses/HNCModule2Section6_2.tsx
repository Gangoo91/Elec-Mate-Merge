      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Energy balance:</strong> Gains must equal losses in steady state
              </li>
              <li className="pl-1">
                <strong>TM46:</strong> Benchmarks for comparing building performance
              </li>
              <li className="pl-1">
                <strong>TM54:</strong> Realistic operational energy prediction
              </li>
              <li className="pl-1">
                <strong>Performance gap:</strong> Actual use often 2-3× design predictions
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Client expectations:</strong> Energy costs must be realistic
              </li>
              <li className="pl-1">
                <strong>Carbon targets:</strong> Net zero requires actual, not theoretical
              </li>
              <li className="pl-1">
                <strong>DECs:</strong> Based on actual operational data
              </li>
              <li className="pl-1">
                <strong>BREEAM:</strong> Credits for TM54 analysis
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Typical Energy Balance Breakdown (UK Office):
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                TM54 Additional Considerations
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-green-400">
                  Building performs slightly better than typical
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Weather Normalisation
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> A building used 450 MWh heating energy in a year with
