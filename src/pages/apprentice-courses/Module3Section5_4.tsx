...
import { ArrowLeft, ArrowRight, Shield, Droplets, Beaker, Wrench } from 'lucide-react';
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <header className="mb-6 sm:mb-8 text-center">
          ...
          <p className="text-white">
            Practical selection and installation guidance for damp, coastal and chemically
            aggressive locations with references to BS 7671 external influences and good practice.
          </p>
        </header>
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Salt air, condensation, chemical washdowns, existing
                  corrosion.
                </li>
                <li>
                  <strong>Use:</strong> 316 stainless, GRP/polycarbonate, LSZH cables, IP66+
                  enclosures.
                </li>
                <li>
                  <strong>Check:</strong> Gaskets, glands, drainage, and separation of dissimilar
                  metals.
                </li>
              </ul>
            </div>
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              <h4 className="font-medium text-white mb-3">
                BS 7671 External Influences Classification
              </h4>
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <p className="text-xs sm:text-sm text-white mb-3">
                  <strong>BS 7671 Section 512:</strong> External influences must be assessed during
                  design. Each location receives codes for Environmental (A), Utilisation (B), and
                  Construction (C) conditions that determine equipment selection.
                </p>
                    ...
                    <tbody>
                      ...
                      <tr className="bg-muted/5">
                        ...
                        <td className="border border-white/10 p-3">
                          Negligible to continuous immersion
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">
                          Negligible to high significance
                        </td>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-transparent border border-border/30 rounded-lg">
                  <h5 className="font-medium text-elec-yellow mb-3">
                    Swimming Pool Plant Rooms - Detailed Assessment
                  </h5>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <ul className="space-y-1 text-sm">
                        <li>
                          • <strong>Temperature:</strong> 25-35°C typical operating range
                        </li>
                        <li>
                          • <strong>Humidity:</strong> Often exceeds 90% relative humidity
                        </li>
                        <li>
                          • <strong>Chlorine gas:</strong> 1-5 ppm typical, up to 10 ppm peaks
                        </li>
                        <li>
                          • <strong>pH chemicals:</strong> Sodium bisulphate, sodium hypochlorite
                        </li>
                        <li>
                          • <strong>Water exposure:</strong> Pipe leaks, condensation, washdown
                        </li>
                      </ul>
                    </div>
                    <div>
                      ...
                      <ul className="space-y-1 text-sm">
                        <li>
                          • <strong>Steel corrosion:</strong> Rapid rust and pitting in 6-12 months
                        </li>
                        <li>
                          • <strong>Copper oxidation:</strong> Green patina formation, connection
                          loosening
                        </li>
                        <li>
                          • <strong>Plastic degradation:</strong> UV + chlorine causes embrittlement
                        </li>
                        <li>
                          • <strong>Seal failure:</strong> Chlorine attacks rubber compounds
                        </li>
                        <li>
                          • <strong>Electrical issues:</strong> Tracking, insulation breakdown
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div className="mt-4 p-3 bg-white/5 rounded-lg">
                    <p className="text-xs sm:text-sm text-white">
                      <strong>BS 7671 Classification:</strong> Typical swimming pool plant room
                      would be coded as AA5 (high temperature), AD4 (water splashing), AF3
                      (chemically active substances present).
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 bg-transparent border border-amber-400/30 rounded-lg">
                  <h5 className="font-medium text-amber-400 mb-3">
                    Food Processing - Hygiene and Chemical Challenges
                  </h5>
                  <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
                    <div>
                      ...
                      <ul className="space-y-1 text-sm">
                        <li>
                          • <strong>Frequency:</strong> Multiple times per shift
                        </li>
                        <li>
                          • <strong>Pressure:</strong> 40-80 bar water jets typical
                        </li>
                        <li>
                          • <strong>Temperature:</strong> 60-85°C hot water/steam
                        </li>
                        <li>
                          • <strong>Chemicals:</strong> Caustic soda, acids, sanitisers
                        </li>
                      </ul>
                    </div>
                    <div>
                      ...
                      <ul className="space-y-1 text-sm">
                        <li>
                          • <strong>Surfaces:</strong> Smooth, non-porous, sloped to drain
                        </li>
                        <li>
                          • <strong>Accessibility:</strong> All areas must be cleanable
                        </li>
                        <li>
                          • <strong>Materials:</strong> Food-grade approved only
                        </li>
                        <li>
                          • <strong>Maintenance:</strong> Rapid component replacement
                        </li>
                      </ul>
                    </div>
                    <div>
                      ...
                      <ul className="space-y-1 text-sm">
                        <li>
                          • <strong>Seal degradation:</strong> Chemical attack on gaskets
                        </li>
                        <li>
                          • <strong>Crevice corrosion:</strong> In joints and fixings
                        </li>
                        <li>
                          • <strong>Coating failure:</strong> Paint/powder coat breakdown
                        </li>
                        <li>
                          • <strong>Water ingress:</strong> Through damaged glands
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="p-4 bg-transparent border border-cyan-400/30 rounded-lg">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <ul className="space-y-1 text-sm">
                        <li>
                          • <strong>Pitting corrosion:</strong> Chloride attack on passive layers
                        </li>
                        <li>
                          • <strong>Galvanic action:</strong> Electrolyte (salt water) accelerates
                        </li>
                        <li>
                          • <strong>Crevice corrosion:</strong> Oxygen depletion in tight spaces
                        </li>
                        <li>
                          • <strong>Stress corrosion:</strong> Combined load and environmental
                          attack
                        </li>
                        <li>
                          • <strong>Atmospheric corrosion:</strong> Salt deposits + moisture cycles
                        </li>
                      </ul>
                    </div>
                    <div>
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-green-400/30 rounded-lg mb-4">
                <h5 className="font-medium text-green-400 mb-3">
                  Stainless Steel Grades and Selection
                </h5>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    <thead>
                ...
                <div className="mt-4 grid md:grid-cols-2 gap-4">
                  <div className="p-3 bg-white/5 rounded-lg">
                    <h6 className="font-medium text-white mb-2">
                      Stainless Steel Installation Tips
                    </h6>
                    <ul className="space-y-1 text-sm">
                  ...
                  <div className="p-3 bg-white/5 rounded-lg">
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Pitting:</strong> Chloride attack, especially in stagnant areas
                      </li>
                      <li>
                        • <strong>Crevice corrosion:</strong> Under gaskets, washers, deposits
                      </li>
                      <li>
                        • <strong>Stress corrosion:</strong> Chloride + tensile stress + heat
                      </li>
                      <li>
                        • <strong>Galvanic attack:</strong> When coupled to carbon steel
                      </li>
                      <li>
                        • <strong>Sensitisation:</strong> Poor welding technique causes carbide
                        precipitation
                      </li>
                    </ul>
                  </div>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                ...
                <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>6063-T6:</strong> Good strength, moderate corrosion resistance
                      </li>
                      <li>
                        • <strong>5083:</strong> Marine grade, excellent salt water resistance
                      </li>
                      <li>
                        • <strong>Anodising:</strong> 25-50 micron coating for protection
                      </li>
                      <li>
                        • <strong>Powder coating:</strong> Additional barrier protection
                      </li>
                      <li>
                        • <strong>Isolation required:</strong> From steel and copper components
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Hot dip:</strong> 85 micron minimum, 15-20 year life
                      </li>
                      <li>
                        • <strong>Sherardised:</strong> For threaded components
                      </li>
                      <li>
                        • <strong>Coating damage:</strong> Repair with zinc-rich primers
                      </li>
                      <li>
                        • <strong>Maintenance:</strong> Annual inspection, 5-7 year recoating
                      </li>
                      <li>
                        • <strong>Chemical limits:</strong> pH 6-12 range for zinc stability
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Brass:</strong> Vulnerable to dezincification
                      </li>
                      <li>
                        • <strong>Bronze:</strong> Good marine performance
                      </li>
                      <li>
                        • <strong>Copper:</strong> Self-limiting patina formation
                      </li>
                      <li>
                        • <strong>Galvanic issues:</strong> Cathodic to most other metals
                      </li>
                      <li>
                        • <strong>Ammonia:</strong> Particularly corrosive to copper alloys
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg">
                <h5 className="font-medium text-elec-yellow mb-3">
                  Cable and Wiring System Materials
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>PVC:</strong> Cost-effective, requires UV stabilisation outdoors
                      </li>
                      <li>
                        • <strong>LSZH:</strong> Reduced toxic gas emission, good chemical
                        resistance
                      </li>
                      <li>
                        • <strong>XLPE:</strong> Higher temperature rating, good chemical resistance
                      </li>
                      <li>
                        • <strong>EPR:</strong> Excellent flexibility, moisture resistance
                      </li>
                      <li>
                        • <strong>FEP/ETFE:</strong> Maximum chemical resistance, high cost
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>PVC conduit:</strong> Good for most environments, UV rating
                        essential
                      </li>
                      <li>
                        • <strong>Galvanised steel:</strong> Mechanical protection, needs coating
                        maintenance
                      </li>
                      <li>
                        • <strong>Stainless steel:</strong> Premium option for severe environments
                      </li>
                      <li>
                        • <strong>GRP trunking:</strong> Chemical resistance, electrical insulation
                      </li>
                      <li>
                        • <strong>Aluminium:</strong> Lightweight, marine grades available
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="mt-4 p-3 bg-white/5 rounded-lg">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>IP rating:</strong> Match or exceed enclosure rating
                      </li>
                      <li>
                        • <strong>Cable compatibility:</strong> Outer diameter and sheath material
                      </li>
                      <li>
                        • <strong>Thread type:</strong> Metric, BSPT, NPT - ensure sealing
                      </li>
                    </ul>
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Material compatibility:</strong> Avoid galvanic couples
                      </li>
                      <li>
                        • <strong>Temperature rating:</strong> Account for cable and ambient
                      </li>
                      <li>
                        • <strong>Chemical resistance:</strong> Seal and body materials
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-amber-400/30 rounded-lg mb-4">
                <h5 className="font-medium text-amber-400 mb-3">
                  Cable Entry Design and Installation
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Purpose:</strong> Directs water away from cable entry points
                      </li>
                      <li>
                        • <strong>Minimum drop:</strong> 150mm below entry point
                      </li>
                      <li>
                        • <strong>Radius:</strong> Minimum 6x cable diameter to avoid stress
                      </li>
                      <li>
                        • <strong>Support:</strong> Cleat or bracket at low point
                      </li>
                      <li>
                        • <strong>Inspection:</strong> Clear view of loop integrity
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Side entries:</strong> Preferred over top entries
                      </li>
                      <li>
                        • <strong>Bottom entries:</strong> Best for washdown environments
                      </li>
                      <li>
                        • <strong>Sloped knockouts:</strong> Encourage water runoff
                      </li>
                      <li>
                        • <strong>Weather protection:</strong> Hood or canopy above entries
                      </li>
                      <li>
                        • <strong>Multiple entries:</strong> Stagger heights to prevent pooling
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    ...
                    <tbody>
                      ...
                      <tr className="bg-muted/5">
                        ...
                        <td className="border border-white/10 p-3">
                          Marine, chemical, high temperature
                        </td>
                      </tr>
                      <tr>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                ...
                <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Standoff distance:</strong> 25-50mm from damp walls
                      </li>
                      <li>
                        • <strong>Gasket continuity:</strong> Full perimeter sealing
                      </li>
                      <li>
                        • <strong>Drain holes:</strong> 6mm diameter, low points
                      </li>
                      <li>
                        • <strong>Mounting surface:</strong> Level, dry, compatible material
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Breather membranes:</strong> Allow pressure equalisation
                      </li>
                      <li>
                        • <strong>Internal heaters:</strong> Prevent condensation
                      </li>
                      <li>
                        • <strong>Drain valves:</strong> Manual or automatic operation
                      </li>
                      <li>
                        • <strong>Air circulation:</strong> Minimum 300mm clearance
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Gasket material:</strong> EPDM, silicone, FKM for chemicals
                      </li>
                      <li>
                        • <strong>Compression ratio:</strong> 25-30% for optimal sealing
                      </li>
                      <li>
                        • <strong>Surface finish:</strong> Ra 1.6μm maximum for sealing
                      </li>
                      <li>
                        • <strong>Multiple seals:</strong> Primary and secondary barriers
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Material separation:</strong> Nylon washers, PTFE tape
                      </li>
                      <li>
                        • <strong>Compatible fasteners:</strong> Match base material or upgrade
                      </li>
                      <li>
                        • <strong>Sealant application:</strong> Marine-grade polyurethane/silicone
                      </li>
                      <li>
                        • <strong>Electrical isolation:</strong> Break current paths
                      </li>
                      <li>
                        • <strong>Sacrificial anodes:</strong> For severe marine applications
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Pre-installation:</strong> Touch up any shipping damage
                      </li>
                      <li>
                        • <strong>Site protection:</strong> Mask during construction activities
                      </li>
                      <li>
                        • <strong>Inspection interval:</strong> Annual for coastal, bi-annual inland
                      </li>
                      <li>
                        • <strong>Repair procedure:</strong> Clean, prime, topcoat matching system
                      </li>
                      <li>
                        • <strong>Documentation:</strong> Record coating type and application dates
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="mt-4 p-3 bg-white/5 rounded-lg">
                  ...
                  <p className="text-xs mt-2 text-white">
                    Metals further apart are more likely to cause galvanic corrosion when coupled
                  </p>
                </div>
              </div>
              ...
              <div className="p-4 bg-transparent border border-green-400/30 rounded-lg mb-4">
                <h5 className="font-medium text-green-400 mb-3">
                  Specific Environment Installation Guidelines
                </h5>
                <div className="space-y-4">
                  <div className="p-3 bg-white/5 rounded-lg">
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Seal integrity:</strong> Pressure test to 1.5x operating pressure
                      </li>
                      <li>
                        • <strong>Coating continuity:</strong> Holiday detection at 100V/μm
                      </li>
                      <li>
                        • <strong>Gasket compression:</strong> Verify correct squeeze ratio
                      </li>
                      <li>
                        • <strong>Drain function:</strong> Test all drainage and venting systems
                      </li>
                      <li>
                        • <strong>Material compatibility:</strong> Verify all components match
                        specification
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Insulation resistance:</strong> Monthly testing in damp conditions
                      </li>
                      <li>
                        • <strong>Earth fault monitoring:</strong> Continuous RCD supervision
                      </li>
                      <li>
                        • <strong>Corrosion monitoring:</strong> Ultrasonic thickness measurement
                      </li>
                      <li>
                        • <strong>Environmental logging:</strong> Temperature, humidity, chemical
                        exposure
                      </li>
                      <li>
                        • <strong>Seal condition:</strong> Visual inspection and replacement
                        schedule
                      </li>
                    </ul>
                  </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Do I always need stainless steel outdoors?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: Not always. Consider the environment and duty—UV‑stable plastics or coated metals
                may be suitable inland. Coastal and chemical sites often justify 316 stainless or
                GRP.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: How often should gaskets be changed?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: Follow manufacturer guidance—monthly inspection in harsh areas is common, with
                proactive replacement at first signs of hardening, cracking or flattening.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Are LSZH cables always the best choice?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: LSZH is often preferred in public or process areas, but confirm chemical and UV
                compatibility. Select sheath type for the actual environment and mechanical duty.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="rounded-lg p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
            <p className="text-white">
              ...
              7671 principles ensures safe, durable installations.
            </p>
          </div>
        </section>
        ...
        <div className="flex flex-col-reverse sm:flex-row justify-between items-stretch sm:items-center gap-3 pt-8 border-t border-white/10">
          ...
          <Button className="min-h-[44px] touch-manipulation active:scale-[0.98]" asChild>
            <Link to="/study-centre/apprentice/level2/module3/section5/5-5">
