      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">1. Types of Defects</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-red-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Wiring defects:</strong> Problems with conductor connections and routing.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Insulation defects:</strong> Damage to cable protection and insulation.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Design/installation errors:</strong> Incorrect component selection or application.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">2. How to Identify Defects</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Basic functional tests:</strong> Essential electrical verification.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Operational checks:</strong> Verify correct function after safe energisation.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">3. Systematic Fault-Finding</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Work methodically:</strong> Start at the origin of supply and progress circuit by circuit.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Use drawings and schedules:</strong> Documentation aids systematic inspection.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Record all observations:</strong> Document everything, even minor defects.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">4. Rectification of Defects</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Correction techniques:</strong> Apply appropriate methods for each defect type.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Verification:</strong> Re-test all corrected work to confirm compliance.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-medium text-white">Safety Procedures</h3>
              </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <div className="bg-card rounded-lg p-4 border border-white/10">
            ...
            <div className="bg-elec-yellow/10 rounded p-3 border-l-4 border-l-elec-yellow">
        ...
        <Card className="mb-8 p-6 bg-gradient-to-br from-card/10 to-emerald-500/5 border-elec-yellow/30">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-white">Pocket Guide – Identifying & Rectifying Defects</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white">Isolate and prove dead before fault-finding.</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-white">Inspect for mechanical damage: cracked accessories, missing fixings.</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-white">Check wiring: correct terminations, no exposed copper, polarity correct.</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-white">Test continuity, insulation resistance, and polarity after corrections.</span>
              </div>
            </div>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-white">Replace damaged cables/accessories — never "make do".</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-white">Record defect and corrective action for certification.</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
              ...
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-white">Prevent recurrence: double-check, use proper tools, and follow BS 7671.</span>
              </div>
            </div>
          </div>
        </Card>
        ...
        <Card className="mb-8 p-6 bg-gradient-to-br from-green-500/5 to-emerald-500/10 border-green-400/20">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-white">Recap - What You've Learned</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-white mb-1">Defect Recognition</h3>
                  <p className="text-sm text-white">You can now identify common mechanical, wiring, insulation, and design defects that compromise installation safety and compliance.</p>
                </div>
              </div>
              
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-8 h-8 bg-elec-yellow text-white rounded-full flex items-center justify-center text-sm font-bold">2</div>
                <div>
                  <h3 className="font-medium text-white mb-1">Identification Methods</h3>
                  <p className="text-sm text-white">You understand how to apply visual checks and tests to spot faults using systematic inspection procedures.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-white mb-1">Fault-Finding Skills</h3>
                  <p className="text-sm text-white">You know how to systematically fault-find and rectify issues using methodical approaches and proper documentation.</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-white mb-1">Safe Rectification</h3>
                  <p className="text-sm text-white">You can ensure corrective work is documented, retested, and compliant with BS 7671 and safety regulations.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-white mb-1">Prevention Strategies</h3>
                  <p className="text-sm text-white">You've learned preventative strategies to avoid repeat defects and maintain high installation standards.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-white mb-1">Professional Standards</h3>
                  <p className="text-sm text-white">By mastering this, you ensure installations are safe, professional, and inspection-ready for energisation and certification.</p>
                </div>
              </div>
            </div>
          </div>
          
          <div className="mt-6 p-4 bg-elec-yellow/10 rounded-lg border border-elec-yellow/30">
            <div className="flex items-center gap-2 mb-2">
              <AlertTriangle className="w-5 h-5 text-elec-yellow" />
              <span className="font-medium text-white">Key Compliance Point</span>
            </div>
            <p className="text-xs sm:text-sm text-white">
