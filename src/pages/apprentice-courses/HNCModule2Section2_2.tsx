...
const quickCheckQuestions = [
  {
    ...
    options: ['Re > 10,000', 'Re ≈ 4000', 'Re < 500', 'Re ≈ 2300'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Re = μvD/ρ', 'Re = vD/ρμ', 'Re = ρvD/μ', 'Re = ρμ/vD'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['10,000', '1,000', '1,000,000', '100,000'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Fluid velocity', 'Pipe diameter', 'Pipe material roughness', 'Fluid viscosity'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['2300 - 4000', '4000 - 10000', '500 - 1000', '1000 - 2000'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['A₁v₁ = A₂v₂', 'Q = ΔP/R', 'F = ma', 'P₁ + ρv₁² = P₂ + ρv₂²'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE Guide C provides the UK reference data and friction-factor charts used in
              building services design. As an HNC engineer your pipe-sizing and pressure-loss
              calculations live or die on getting the regime classification right.
            </>
          }
        ...
        >
          <p>
            Fluid flow can be classified into two distinct regimes based on how the fluid particles
            move. Understanding these regimes is essential for predicting pressure losses and heat
            transfer in building services.
          </p>
          <p>
        ...
        >
          ...
          <p>
            ...
            velocity (m/s), D = diameter (m), μ = dynamic viscosity (Pa·s), ν = kinematic viscosity
            (m²/s).
          </p>
          <p>
        ...
        >
          ...
          <p>
            <strong>The no-slip condition:</strong> At any solid boundary, the fluid velocity equals
            the boundary velocity. For stationary pipes, this means v = 0 at the wall. This
        ...
        >
          ...
          <p>
            <strong>Continuity equation:</strong> Q = A₁v₁ = A₂v₂ = constant. For circular pipes: A
            = πD²/4, so v₁D₁² = v₂D₂².
          </p>
          <p>
        ...
        >
          <p>
            <strong>Example 1 - Reynolds number calculation:</strong> Water at 20°C flows at 1.5 m/s
            through a 65mm diameter pipe. Determine the flow regime. (ρ = 998 kg/m³, μ = 0.001
            Pa·s).
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Re = ρvD/μ = (998 × 1.5 × 0.065) / 0.001 = <strong>97,305</strong>
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              100mm pipe: A₁ = π × 0.1² / 4 = 0.00785 m²; v₁ = 0.008 / 0.00785 ={' '}
              <strong>1.02 m/s</strong>
            </li>
            <li>
              50mm pipe: A₂ = π × 0.05² / 4 = 0.00196 m²; v₂ = 0.008 / 0.00196 ={' '}
              <strong>4.08 m/s</strong>
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              At 20°C: ρ = 998 kg/m³, μ = 0.001 Pa·s. Re₂₀ = (998 × 2 × 0.05) / 0.001 ={' '}
              <strong>99,800</strong>
            </li>
            <li>
              At 80°C: ρ = 972 kg/m³, μ = 0.00035 Pa·s. Re₈₀ = (972 × 2 × 0.05) / 0.00035 ={' '}
              <strong>277,714</strong>
            </li>
            <li>
              Hot water Re is ~2.8× higher due to lower viscosity. Both well into turbulent regime
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A long underfloor heating loop is under-performing. Manifold flow is set correctly,
              but the surface temperature at the far end is 8 °C below design. The loop is 120 m of
              16 mm PE-X at 0.18 m/s.
            </>
          }
          whatToDo={
            <>
              Calculate Re = ρvD/µ at LTHW design temperature (970 × 0.18 × 0.014 / 0.00036) ≈ 680.
              The flow is laminar. Heat transfer in laminar flow is much weaker than turbulent (Nu ≈
              3.66 vs ≈ 100+ at higher Re), and the temperature drop along the loop is amplified.
              Solutions: shorten loops to standard 80-100 m, increase pipe size to allow lower
              velocity but maintain head, or accept the regime and adjust manifold flow to lift the
              velocity into transitional range (above Re 2,300).
            </>
          }
          whyItMatters={
            <>
              Underfloor loops sized without checking Re are the most common case of laminar-flow
              underperformance in building services. Diagnosis is a five-line Reynolds calculation.
            </>
          }
        />
