...
import { getRandomQuestions } from '@/data/apprentice-courses/level3/module2/questionBank';

const Level3Module8MockExam2 = () => {
  useSEO(
    'Mock Exam 2: Environmental Technologies | Level 3 Electrical Course',
    'Test your knowledge of Module 2 environmental technologies with this comprehensive 30-question mock exam.'
  );
                ...
                <div className="grid gap-2 sm:gap-2">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm sm:text-sm text-white leading-relaxed">
                      30 questions randomly selected from 200 Module 2 questions
                    </p>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 sm:h-1.5 sm:w-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 sm:h-1.5 sm:w-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0" />
                    <p className="text-sm sm:text-sm text-white leading-relaxed">
                      Topics: Solar PV, Battery Storage, Heat Pumps, EV Charging, Smart Systems,
                      Energy Efficiency
                    </p>
                  </div>
                </div>
            ...
            <CardContent className="space-y-4 sm:space-y-6 px-3 sm:px-6">
              ...
              <div className="flex flex-col gap-3 pt-2">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Link
                    to="/study-centre/apprentice/level3-course/module8-section2"
                    className="flex-1"
                  >
                    <Button
                      variant="outline"
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <div className="text-sm text-white mt-1">
                    Level 3 Module 2 • Environmental Technologies
                  </div>
                </div>
                <Button
                  onClick={toggleFlag}
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-center text-white pt-2 border-t border-elec-yellow/30">
                    <div>Level 3 Module 2</div>
                    <div>Environmental Technologies</div>
                  </div>
                </div>
              </div>
            </CardContent>
