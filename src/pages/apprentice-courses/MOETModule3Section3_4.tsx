...
const quizQuestions = [
  {
    ...
    options: [
      '40% of cables must be the same size',
      'Cables must not occupy more than 40% of the conduit internal cross-sectional area',
      'Conduit must be 40% full at all times',
      '40% of conduit runs must include inspection fittings',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Higher mechanical protection is needed',
      ...
      'The conduit must serve as a CPC',
      'Maximum fire resistance is required',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Just fill the gap with expanding foam',
      ...
      'Leave it open for ventilation',
      'Paint the trunking red',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Structural support for partitions',
  ...
  },
  {
    ...
    options: [
      'Force the cables in regardless',
      ...
      'Remove all existing cables first',
      'Only check if the conduit is empty',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only the colour',
      'Nothing — containment does not require inspection',
    ],
    correctAnswer: 1,
    explanation:
