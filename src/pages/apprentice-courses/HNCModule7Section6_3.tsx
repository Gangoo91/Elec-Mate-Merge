...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      'What is the typical maximum declared earth fault loop impedance (Ze) for a TN-S system?',
    options: ['21Ω', '0.8Ω', '200Ω', '0.35Ω'],
    correctAnswer: 1,
    explanation:
...
const HNCModule7Section6_3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 6 · Subsection 3"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Earthing System Types">
          ...
          <p>
            <strong>System designation letters:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>First letter (relationship of supply to earth):</strong> T = direct connection
              to earth, I = isolated or high impedance connection
            </li>
            <li>
            ...
            <li>
              <strong>Subsequent letters:</strong> S = separate neutral and protective conductors, C
              = combined conductor (PEN)
            </li>
          </ul>
          <p>
            <strong>UK Earthing Systems Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>TN-S:</strong> Cable sheath/armouring — ≤ 0.8Ω — Older urban supplies,
              industrial
            </li>
            <li>
              <strong>TN-C-S (PME):</strong> Supply neutral (PEN) — ≤ 0.35Ω — Modern
              domestic/commercial
            </li>
            <li>
              <strong>TT:</strong> Earth electrode — ≤ 21Ω (typically) — Rural, overhead supplies,
              outbuildings
            </li>
            <li>
              <strong>IT:</strong> Isolated or high impedance — Variable — Critical systems,
              hospitals, process plants
            </li>
          </ul>
          <p>
            <strong>PME Precautions</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Key point:</strong> Always verify the earthing system type at the origin before
            designing or testing an installation. The system type determines Zs values, protective
            device selection, and additional measures required.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Main Earthing Terminal and Protective Conductors">
          ...
          <p>
            <strong>Main Earthing Terminal Connections</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>CPC Sizing - Table 54.7 Method</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>S ≤ 16:</strong> S (same as line) — e.g., 2.5mm² line → 2.5mm² cpc
            </li>
            <li>
              <strong>16 &lt; S ≤ 35:</strong> 16 — e.g., 25mm² line → 16mm² cpc
            </li>
            <li>
              <strong>S &gt; 35:</strong> S/2 — e.g., 70mm² line → 35mm² cpc
            </li>
          </ul>
          <p>
            <strong>Adiabatic Equation Method</strong>
          </p>
          <p>S = √(I²t) / k</p>
          <p>Where:</p>
        ...
        <ConceptBlock title="Main Equipotential Bonding">
          ...
          <p>
            <strong>Parts Requiring Main Bonding</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Gas installation pipes:</strong> Bond within 600mm of meter outlet on consumer
              side
            </li>
            <li>
          ...
          <p>
            <strong>Main Bonding Conductor Sizing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Up to 16:</strong> 10 (min 6mm²) — Small domestic (60A-80A supply)
            </li>
            <li>
              <strong>25:</strong> 16 (half of 25 = 12.5, round up) — Larger domestic (100A supply)
            </li>
            <li>
              <strong>35:</strong> 16 (half of 35 = 17.5, round down to 16) — Commercial small
            </li>
            <li>
              <strong>50 or greater:</strong> 25 (maximum requirement) — Large commercial/industrial
            </li>
          </ul>
          <p>
            <strong>Bonding Connection Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Connection Locations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Supplementary Bonding and Earth Electrode Testing">
          ...
          <p>
            <strong>Supplementary Bonding Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Two exposed-conductive-parts:</strong> 2.5mm² Cu — 4mm² Cu
            </li>
            <li>
              <strong>Exposed to extraneous:</strong> 2.5mm² Cu — 4mm² Cu
            </li>
            <li>
              <strong>Two extraneous-conductive-parts:</strong> 2.5mm² Cu — 4mm² Cu
            </li>
          </ul>
          <p>
            <strong>When Supplementary Bonding May Be Omitted</strong>
          </p>
          ...
          <p>
            <strong>Earth Electrode Testing</strong>
          </p>
          <p>
            <strong>Fall of Potential Method</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Maximum Electrode Resistance</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Earth Electrode Types and Installation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Driven rod (copper-clad steel):</strong> Most common, domestic TT — 1.2m
              minimum, often 2.4m
            </li>
            <li>
              <strong>Earth mat/plate:</strong> Rocky ground, low depth — Varies by soil conditions
            </li>
            <li>
              <strong>Foundation electrode:</strong> New builds, commercial — Embedded in concrete
            </li>
            <li>
              <strong>Tape/strip buried:</strong> Large sites, ring electrodes — 25mm × 3mm copper
              tape
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Calculate minimum cpc size for a circuit with Ipf = 2000A,
            disconnection time = 0.2s, thermoplastic copper (k=115).
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              TN-S typical Ze: <strong>0.8Ω maximum</strong>
            </li>
            <li>
