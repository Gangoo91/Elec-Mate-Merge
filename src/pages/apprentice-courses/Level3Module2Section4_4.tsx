...
const quickCheckQuestions: QuickCheckQuestion[] = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Smart charging optimises the charging process based on various factors including grid demand, electricity tariffs, renewable energy availability, and user requirements, rather than simply charging at maximum rate.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Dynamic load management continuously monitors the total electrical load and adjusts EV charging power to prevent the combined demand from exceeding the available supply capacity, avoiding overloads and nuisance tripping.',
  },
  {
    question:
      'Which communication protocol is commonly used between EV and charger for smart charging?',
    options: ['Bluetooth only', 'ISO 15118 / OCPP', 'Infrared', 'Radio frequency'],
    correctIndex: 1,
    explanation:
      'ISO 15118 enables communication between EV and charger (including Plug & Charge), while OCPP (Open Charge Point Protocol) handles communication between chargers and back-end management systems for smart charging functionality.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Time-of-Use tariff optimisation schedules EV charging to coincide with off-peak electricity periods (typically overnight), reducing costs for the user while also helping to balance grid demand.',
  },
];
...
const quizQuestions: QuizQuestion[] = [
  {
    question:
      'What is the main function of an Energy Management System (EMS) in EV charging installations?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'An Energy Management System coordinates EV charging with other building electrical loads, monitors supply capacity, and manages charging schedules to optimise energy use and prevent overloading.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Dynamic load management continuously monitors actual loads and adjusts charging power in real-time, whereas static load management allocates a fixed maximum power regardless of other actual loads.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'OCPP is an open communication protocol used between charging stations and central management systems (back-end), enabling remote monitoring, control, and smart charging features.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Vehicle-to-Grid (V2G) enables bi-directional power flow, allowing EVs not only to charge from the grid but also to discharge stored energy back to the grid or building when needed, supporting grid stability.',
  },
  {
    question:
      'What CT (Current Transformer) sensors are typically used for in smart EV charging systems?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'CT sensors are installed on incoming supply cables to monitor real-time current flow. This data enables dynamic load management by showing available capacity and triggering charging adjustments.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Solar diversion prioritises using excess PV generation for EV charging rather than exporting to the grid, maximising self-consumption and reducing electricity costs.',
  },
  {
    question:
      'According to BS 7671 Regulation 722.311, what must be considered when multiple EV charging points share supply?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Regulation 722.311 requires assessment of maximum demand considering diversity factors when multiple charging points share a supply, as not all vehicles charge simultaneously at full power.',
  },
  {
    question:
      'What is the typical communication method for home smart chargers to receive grid signals?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Home smart chargers typically connect via Wi-Fi or cellular networks to cloud-based services, enabling them to receive grid signals, tariff information, and user preferences for optimised charging schedules.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Scheduled charging allows users to set departure times and preferred charging windows, enabling the system to charge during optimal periods (e.g., off-peak tariffs) while ensuring the vehicle is ready when needed.',
  },
  {
    question:
      "In a commercial installation with multiple EV chargers, what is 'first-in-first-out' (FIFO) priority?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'FIFO priority ensures that when load management reduces available power, vehicles that connected first maintain their charging allocation, while later arrivals may receive reduced power or be queued.',
  },
  {
    question:
      'What is the primary benefit of integrating EV charging with building energy management?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Integrating EV charging with building energy management allows coordinated control of all loads, preventing demand peaks that could exceed supply capacity or incur penalty charges, while optimising overall energy efficiency.',
  },
];
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-lg">
            Understanding smart charging technologies, load management systems, communication
            protocols, and energy optimisation for EV charging installations.
          </p>
        </div>
        ...
        <Card className="p-4 mb-8 bg-[#E8FF00]/10 border-[#E8FF00]/30">
          ...
          <p className="text-gray-300 text-sm">
            Smart charging goes beyond simply supplying power to an EV - it optimises when, how
            fast, and from what source vehicles are charged. Load management prevents overloading by
            coordinating EV charging with other electrical loads. These technologies are essential
            for enabling widespread EV adoption without requiring costly infrastructure upgrades,
            while also reducing costs for users through off-peak charging and maximising use of
            renewable energy.
          </p>
        </Card>
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300">
              <p>
                Smart charging refers to EV charging systems that can communicate, adapt, and
                optimise the charging process based on various inputs. Unlike 'dumb' chargers that
                simply deliver maximum power whenever plugged in, smart chargers can:
              </p>
              ...
              <div className="bg-[#242424] p-4 rounded-lg border border-[#333]">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Scheduled Charging:</strong> Delay charging to start at user-defined
                      times (e.g., when off-peak tariffs begin)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <BarChart3 className="h-4 w-4 text-[#E8FF00] mt-0.5" />
                    <span>
                      <strong>Power Modulation:</strong> Adjust charging rate up or down based on
                      grid signals or local conditions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Wifi className="h-4 w-4 text-[#E8FF00] mt-0.5" />
                    <span>
                      <strong>Remote Monitoring:</strong> Report status, energy consumption, and
                      faults to management systems
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Zap className="h-4 w-4 text-[#E8FF00] mt-0.5" />
                    <span>
                      <strong>Grid Response:</strong> React to grid operator signals during periods
              ...
              <h3 className="text-lg font-medium text-white mt-6 mb-3">
                UK Smart Charger Regulations
              </h3>
              <p>
                The Electric Vehicles (Smart Charge Points) Regulations 2021 mandate that all new
                domestic and workplace chargers sold in the UK must be smart chargers. Key
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300">
              <p>
                Load management is crucial for EV installations, particularly where supply capacity
                is limited or where multiple chargers are installed. Without load management, the
                combined demand from EV charging and other loads could exceed the available supply,
                causing overloads and nuisance tripping.
              </p>

              <h3 className="text-lg font-medium text-white mt-6 mb-3">Static Load Management</h3>
              <p>
                The simplest form of load management allocates a fixed maximum power to EV charging,
                regardless of other loads:
              </p>

              <div className="bg-[#242424] p-4 rounded-lg border border-[#333]">
                <h4 className="text-[#E8FF00] font-medium mb-2">Example: Static Allocation</h4>
                <p className="text-sm mb-2">
                  A property has 100A single-phase supply with estimated maximum demand of 60A for
                  other loads:
                </p>
                <ul className="text-sm space-y-1">
                ...
                <p className="text-sm mt-2 text-elec-yellow">
                  Limitation: Doesn't utilise full capacity when other loads are low
                </p>
              </div>

              <h3 className="text-lg font-medium text-white mt-6 mb-3">Dynamic Load Management</h3>
              <p>
                Dynamic systems continuously monitor actual loads and adjust EV charging in
                real-time:
              </p>

              <div className="bg-[#242424] p-4 rounded-lg border border-[#333]">
                <h4 className="text-[#E8FF00] font-medium mb-2">
                  Dynamic Load Management Components
                </h4>
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-[#E8FF00]">CT Sensors:</span>
                    <span>
                      Current transformers installed on incoming supply to monitor real-time
                      consumption
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Signals to charger to adjust power output (typically via Modbus, REST API, or
              ...
              <div className="bg-[#242424] p-4 rounded-lg border border-[#333] mt-4">
                ...
                <p className="text-sm mt-2 text-green-400">
                  Benefit: Maximises charging while preventing overload
                </p>
              </div>

              <h3 className="text-lg font-medium text-white mt-6 mb-3">
                Multiple Charger Load Sharing
              </h3>
              <p>
                For installations with multiple EV chargers, load management can share available
                capacity:
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-4">
                <div className="bg-[#242424] p-4 rounded-lg border border-[#333]">
                  ...
                  <p className="text-sm mb-2">
                    Available power divided equally between active chargers:
                  </p>
                  <ul className="text-sm space-y-1">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300">
              <p>
                Smart charging relies on standardised communication protocols to enable
                interoperability between different components and vendors.
              </p>
              ...
              <p>
                OCPP is the leading open protocol for communication between EV charging stations and
              ...
              <div className="bg-[#242424] p-4 rounded-lg border border-[#333]">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    <strong>Open Standard:</strong> Vendor-neutral, avoiding lock-in to proprietary
                    systems
                  </li>
                  <li>
                    <strong>Remote Management:</strong> Start/stop charging, update firmware,
                    configure settings
                  </li>
                  <li>
                    <strong>Smart Charging Profiles:</strong> Set charging schedules and power
                    limits remotely
                  </li>
                  <li>
                    <strong>Transactions:</strong> Authorisation, metering data, billing information
                  </li>
                  <li>
                    <strong>Diagnostics:</strong> Status reporting, fault notifications, logs
                  </li>
                </ul>
              ...
              <p>
                ISO 15118 defines communication between the EV and charging station, enabling
                advanced features:
              </p>
              ...
              <div className="bg-[#242424] p-4 rounded-lg border border-[#333]">
                <ul className="text-sm space-y-3">
                  <li>
                    <strong className="text-[#E8FF00]">Modbus:</strong> Industrial protocol often
                    used for local load management between CT sensors, controllers, and chargers.
                    Simple, reliable, widely supported.
                  </li>
                  <li>
                    <strong className="text-[#E8FF00]">OpenADR:</strong> Protocol for demand
                    response signals from grid operators. Enables chargers to respond to grid stress
                    events.
                  </li>
                  <li>
                    <strong className="text-[#E8FF00]">MQTT:</strong> Lightweight messaging protocol
                    used for IoT devices including some smart charger integrations.
                  </li>
                  <li>
                    <strong className="text-[#E8FF00]">REST APIs:</strong> Web-based interfaces for
                    cloud connectivity and third-party integrations.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300">
              <p>
                Smart charging enables various energy optimisation strategies that reduce costs and
              ...
              <div className="bg-[#242424] p-4 rounded-lg border border-[#333]">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    <strong>Economy 7/10:</strong> Overnight rates typically 5-8p/kWh vs 25-35p/kWh
                    peak
                  </li>
                  <li>
                    <strong>EV-Specific Tariffs:</strong> Some suppliers offer 5p/kWh overnight for
                    EVs
                  </li>
                  <li>
                    <strong>Agile Tariffs:</strong> Half-hourly pricing, smart chargers can chase
                    lowest prices
                  </li>
                  <li>
                    <strong>Example Savings:</strong> 7.4kW charger running 8 hours overnight at 5p
                    vs 30p = savings of approx. 14.80 per night
                  </li>
                </ul>
              </div>
              ...
              <p>
                Integrating EV charging with solar PV maximises self-consumption of generated
                electricity:
              </p>
              ...
              <div className="bg-[#242424] p-4 rounded-lg border border-[#333]">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    <strong>Excess Only:</strong> EV charges only when PV generation exceeds other
                    consumption. May result in slow/interrupted charging but uses 100% solar.
                  </li>
                  <li>
                    <strong>Boosted Solar:</strong> Minimum charging rate maintained with grid
                    top-up, increased when solar available. Better for ensuring adequate charge.
                  </li>
                  <li>
                    <strong>Scheduled + Solar:</strong> Daytime solar charging when available,
                    overnight off-peak charging to complete. Balances solar use and reliability.
                  </li>
                </ul>
              </div>
              ...
              <p>Bi-directional charging enables EVs to become mobile energy storage assets:</p>
              ...
              <p>
                BS 7671 Regulation 722.311 requires proper assessment of maximum demand for EV
                installations:
              </p>
              ...
              <div className="bg-[#242424] p-4 rounded-lg border border-[#333]">
                ...
                <p className="text-sm mb-3">
                  Not all chargers operate simultaneously at full power. Typical diversity
                  allowances:
                </p>
                ...
                <p className="text-xs text-gray-400 mt-2">
                  Note: Actual diversity depends on usage patterns. Load management systems can
                  guarantee lower maximum demand.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 text-gray-300">
              <div>
                ...
                <ul className="text-sm space-y-1">
                  ...
                  <li>
                    5. If dynamic load management required, install CT on main incoming supply
                  </li>
            ...
            {!showQuiz ? (
              <div className="text-center">
                ...
                <p className="text-gray-400 mb-4">
                  Ready to test your understanding of smart charging and load management?
                </p>
                <Button
