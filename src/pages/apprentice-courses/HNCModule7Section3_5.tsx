...
const quickCheckQuestions = [
  {
    ...
    options: ['Eav / Emax', 'Emax / Emin', 'Emin / Emax', 'Emin / Eav'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The ability to recognise faces and three-dimensional form',
      'The total light reflected from the floor surface',
      'The glare contribution of luminaires in the field of view',
      'The evenness of light across the horizontal task plane',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['UGR ≤ 13', 'UGR ≤ 16', 'UGR ≤ 25', 'UGR ≤ 19'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Uo ≥ 0.8', 'Uo ≥ 0.4', 'Uo ≥ 0.6', 'Uo ≥ 0.5'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['100 lux', '150 lux', '200 lux', '50 lux'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Uo ≥ 0.2', 'Uo ≥ 0.8', 'Uo ≥ 0.6', 'Uo ≥ 0.4'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['SHR = 1.0 to 1.5', 'SHR = 2.0 to 2.5', 'SHR ≤ 1.0', 'SHR > 3.0'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The perceived colour temperature of the light source',
      'The average horizontal illuminance on the working plane',
      'The uniformity ratio across the whole room',
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="Uniformity Ratios">
          ...
          <p>
            <strong>Uniformity Ratio Formula</strong>
          </p>
          <p>Uo = Emin / Eav</p>
          <p>
            Where Emin is minimum illuminance and Eav is average illuminance across the reference
            plane
          </p>
          <p>
            <strong>CIBSE LG7 Uniformity Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Task area:</strong> Uo ≥ 0.6 — Primary work surface
            </li>
            <li>
              <strong>Immediate surrounding:</strong> Uo ≥ 0.4 — 0.5m band around task area
            </li>
            <li>
              <strong>Background area:</strong> Uo ≥ 0.1 — Remainder of room
            </li>
            <li>
              <strong>Circulation areas:</strong> Uo ≥ 0.4 — Corridors, stairs, lobbies
            </li>
          </ul>
          <p>
            <strong>Diversity ratio:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Cylindrical Illuminance and Modelling">
          ...
          <p>
            <strong>Cylindrical Illuminance (Ez)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Cylindrical Illuminance Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>General office:</strong> 150 — Visual communication
            </li>
            <li>
              <strong>Reception areas:</strong> 150-200 — Welcoming atmosphere
            </li>
            <li>
              <strong>Meeting rooms:</strong> 150 — Face-to-face interaction
            </li>
            <li>
              <strong>Circulation:</strong> 75-100 — Recognition of people
            </li>
          </ul>
          <p>
            <strong>Modelling Example</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Design tip:</strong> Purely downward lighting gives poor modelling (low Ez). Add
            indirect or wall-washing components to improve cylindrical illuminance without
        ...
        <ConceptBlock title="Visual Comfort and UGR">
          <p>
            ...
            flicker. The Unified Glare Rating (UGR) is the primary metric for discomfort glare from
            luminaires, with lower values indicating less glare discomfort.
          </p>
          <p>
            <strong>UGR Formula Factors</strong>
          </p>
          <p>UGR depends on:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>CIBSE UGR Limits by Application</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Technical drawing:</strong> ≤ 16 — CAD workstations, drawing offices
            </li>
            <li>
              <strong>Reading, writing, VDU:</strong> ≤ 19 — General offices, classrooms
            </li>
            <li>
              <strong>Industrial work:</strong> ≤ 22 — Assembly, machine work
            </li>
            <li>
              <strong>Rough work, storage:</strong> ≤ 25 — Warehouses, plant rooms
            </li>
            <li>
              <strong>Circulation:</strong> ≤ 28 — Corridors (no prolonged viewing)
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Disability glare:</strong> Impairs vision by reducing contrast (e.g., oncoming
              headlights)
            </li>
            <li>
            ...
            <li>
              <strong>Reflected/veiling glare:</strong> Reflections from glossy surfaces reducing
              contrast
            </li>
          </ul>
          <p>
            <strong>VDU considerations:</strong> For workstations with screens, luminaires should be
            positioned to avoid reflections. Cross-baffled or low-brightness louvred luminaires help
            control both direct glare and screen reflections.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Surface Reflectances and Design Integration">
          <p>
            ...
            reflectance surfaces increase the inter-reflected light component, improving uniformity,
            modelling, and reducing contrast between luminaires and background.
          </p>
          <p>
            <strong>CIBSE Recommended Reflectances</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ceiling:</strong> 70-90% — Improves uniformity, reduces luminaire contrast
            </li>
            <li>
              <strong>Walls:</strong> 50-70% — Enhances cylindrical illuminance
            </li>
            <li>
              <strong>Floor:</strong> 20-40% — Contributes to overall light levels
            </li>
            <li>
              <strong>Furniture:</strong> 25-45% — Avoids excessive contrast with paper
            </li>
          </ul>
          <p>
            <strong>Spacing-to-Height Ratio (SHR)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Luminaire Selection Factors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            (DIALux, Relux) to verify uniformity, UGR, and illuminance levels at design stage. Check
            critical observer positions for UGR compliance.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> An open-plan office has measured illuminances of: Emax = 650
            lux, Emin = 380 lux, Eav = 520 lux
          </p>
          ...
          <p>
            <strong>Scenario:</strong> A meeting room has Eh = 400 lux and Ez = 100 lux. Assess the
            modelling quality.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Recessed luminaires in a 3.0m ceiling height office, working
            plane at 0.75m. Luminaire SHRmax = 1.4. Proposed spacing = 3.0m.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Exceeding SHRmax</strong> - causes poor uniformity despite adequate average
                lux
              </li>
              <li>
              ...
              <li>
                <strong>Dark surfaces</strong> - low reflectances require more luminaires and create
                contrast issues
              </li>
            </ul>
          }
