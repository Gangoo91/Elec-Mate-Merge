      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>CIBSE Code M:</strong> Framework for systematic commissioning of building
                services
              </li>
              <li className="pl-1">
                <strong>Commissioning stages:</strong> Static checks, dynamic testing, performance
                verification
              </li>
              <li className="pl-1">
                <strong>Witness testing:</strong> Independent verification of critical test results
              </li>
              <li className="pl-1">
                <strong>Seasonal:</strong> Verify heating and cooling operation under actual
                conditions
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Coordination:</strong> Commissioning spans all MEP trades
              </li>
              <li className="pl-1">
                <strong>Timing:</strong> Plan from design stage, execute post-installation
              </li>
              <li className="pl-1">
                <strong>Documentation:</strong> Comprehensive records for O&amp;M manuals
              </li>
              <li className="pl-1">
                <strong>Handover:</strong> Demonstrates systems meet design intent
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Key Principles of Code M
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Early involvement:</strong> Commissioning management should begin at
                  design stage
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Verification:</strong> Independent checking of results against design
                  criteria
                </li>
                <li className="pl-1">
                  <strong>Integration:</strong> Coordination across all building services
                  disciplines
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Commissioning Management Structure
              </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Overall coordination, programme, quality assurance
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Technical supervision of commissioning activities
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Discipline-specific commissioning (HVAC, electrical, controls)
                      </td>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Commissioning Specification Requirements
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Health and safety requirements for commissioning activities
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              alongside the technical specifications during design, ensuring that systems are
              designed with commissioning requirements in mind and that adequate access, test points
              and isolation are provided.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              (pre-commissioning checks on systems at rest) and dynamic commissioning (testing
              systems under operating conditions). Both phases are essential and must be completed
              in sequence for successful commissioning.
            </p>

            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Static Commissioning (Pre-commissioning)
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Static checks, pressure tests, visual inspection
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Installation complete, power available
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">2. Setting to work</td>
                      <td className="border border-white/10 px-3 py-2">
                        Initial start-up, direction checks, basic operation
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Pre-commissioning signed off
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">3. Regulation</td>
                      <td className="border border-white/10 px-3 py-2">
                        Flow balancing, damper setting, valve adjustment
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        BMS points, control loops, sequences
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Capacity verification, efficiency measurement
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Demonstration to client, sign-off
                      </td>
                      <td className="border border-white/10 px-3 py-2">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Air System Commissioning Tolerances (CIBSE Code A)
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              conducted correctly and that results meet specified requirements. It is a formal
              process requiring preparation, documentation and sign-off by authorised
              representatives.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Hold points:</strong> Activities that cannot proceed without witness
                  sign-off
                </li>
                <li className="pl-1">
                  <strong>Notification points:</strong> Activities requiring advance notice to
                  witnesses
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Preparation for Witness Testing
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Approved written procedures for each test
                      </td>
                      <td className="border border-white/10 px-3 py-2">Commissioning manager</td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Blank forms ready for recording results
                      </td>
                      <td className="border border-white/10 px-3 py-2">Commissioning specialist</td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Current certificates for all test instruments
                      </td>
                      <td className="border border-white/10 px-3 py-2">Commissioning specialist</td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Safe systems of work for testing activities
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Appropriate protective equipment for witnesses
                      </td>
                      <td className="border border-white/10 px-3 py-2">Contractor</td>
                    </tr>
                  </tbody>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Tests Typically Requiring Witnessing
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              required may need to be repeated, causing programme delays and additional costs.
              Always confirm witness availability before scheduling hold point tests.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              cooling demands. Performance verification demonstrates that systems achieve their
              design intent under actual operating conditions over an extended period.
            </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Boilers, heating coils, radiators, underfloor heating
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Chillers, cooling coils, condensers, free cooling
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Economiser cycles, mixed mode operation
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Changeover, free cooling optimisation
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Design criteria:</strong> Document target performance parameters from
                  design
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Extended Performance Monitoring (12 months)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Calculated from flow/energy data
                      </td>
                      <td className="border border-white/10 px-3 py-2">Monthly</td>
                    </tr>
                    <tr>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              for demonstrating that buildings perform as designed through post-occupancy
              evaluation.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Air Handling Unit Commissioning
              </h3>
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-green-400">
                  Result: System within tolerance, witness test passed
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Chilled Water System Commissioning
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-green-400">
                  Result: Performance verified, exceeds design COP
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Witness Test - Fire Damper Testing
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-green-400">
                  Witness signed off: All 45 dampers satisfactory
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 4: Snagging List Management
              </h3>
              <p className="text-sm text-white mb-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Key Documents for Commissioning
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Common Commissioning Tolerances
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Missing test points:</strong> Specify during design, not after
                  installation
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Coordination failures:</strong> Ensure all trades are ready before
                  starting
                </li>
              </ul>
            </div>
