...
const HNCModule8Section6_4 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 6 · Subsection 4"
      ...
      <HubBody>
        ...
        <ConceptBlock title="CIBSE Commissioning Code M">
          <p>
            CIBSE Commissioning Code M provides a comprehensive framework for the systematic
            commissioning of building services installations. The code establishes best practice
            procedures that ensure systems are set to work correctly, regulated to design
            parameters, and demonstrated to meet their specified performance requirements.
          </p>
          <p>
            <strong>Key Principles of Code M</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Early involvement:</strong> Commissioning management should begin at design
              stage
            </li>
            <li>
              <strong>Systematic approach:</strong> Logical progression from pre-commissioning
              through to handover
            </li>
            <li>
              <strong>Documentation:</strong> Comprehensive records of all commissioning activities
            </li>
            <li>
              <strong>Verification:</strong> Independent checking of results against design criteria
            </li>
            <li>
              <strong>Integration:</strong> Coordination across all building services disciplines
            </li>
          </ul>
          <p>
            <strong>Commissioning Management Structure</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Commissioning Manager:</strong> Overall coordination, programme, quality
              assurance — RIBA Stage 3
            </li>
            <li>
              <strong>Commissioning Engineer:</strong> Technical supervision of commissioning
              activities — RIBA Stage 4
            </li>
            <li>
              <strong>Commissioning Specialist:</strong> Discipline-specific commissioning (HVAC,
              electrical, controls) — RIBA Stage 5
            </li>
            <li>
              <strong>Witness:</strong> Independent verification of test results — As required
            </li>
          </ul>
          <p>
            <strong>Commissioning Specification Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Best practice:</strong> The commissioning specification should be developed
            alongside the technical specifications during design, ensuring that systems are designed
            with commissioning requirements in mind and that adequate access, test points and
        ...
        <ConceptBlock title="Static and Dynamic Commissioning">
          <p>
            Commissioning activities are typically divided into static commissioning
            (pre-commissioning checks on systems at rest) and dynamic commissioning (testing systems
            under operating conditions). Both phases are essential and must be completed in sequence
            for successful commissioning.
          </p>
          <p>
            <strong>Static Commissioning (Pre-commissioning)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Dynamic Commissioning</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Typical Commissioning Sequence</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Pre-commissioning:</strong> Static checks, pressure tests, visual
              inspection — Installation complete, power available
            </li>
            <li>
              <strong>2. Setting to work:</strong> Initial start-up, direction checks, basic
              operation — Pre-commissioning signed off
            </li>
            <li>
              <strong>3. Regulation:</strong> Flow balancing, damper setting, valve adjustment —
              Systems operational
            </li>
            <li>
              <strong>4. Controls commissioning:</strong> BMS points, control loops, sequences —
              Mechanical regulation complete
            </li>
            <li>
              <strong>5. Performance testing:</strong> Capacity verification, efficiency measurement
              — Controls commissioned
            </li>
            <li>
              <strong>6. Witness testing:</strong> Demonstration to client, sign-off — All
              commissioning complete
            </li>
          </ul>
          <p>
            <strong>Air System Commissioning Tolerances (CIBSE Code A)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Critical sequence:</strong> Always complete static commissioning before
            attempting dynamic commissioning. Operating systems with incomplete pre-commissioning
            risks equipment damage, safety hazards, and invalidates commissioning results.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Witness Testing Procedures">
          <p>
            Witness testing provides independent verification that commissioning tests have been
            conducted correctly and that results meet specified requirements. It is a formal process
            requiring preparation, documentation and sign-off by authorised representatives.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Hold points:</strong> Activities that cannot proceed without witness sign-off
            </li>
            <li>
              <strong>Notification points:</strong> Activities requiring advance notice to witnesses
            </li>
            <li>
              <strong>Review points:</strong> Documentation review and acceptance
            </li>
          </ul>
          <p>
            <strong>Preparation for Witness Testing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Test procedures:</strong> Approved written procedures for each test —
              Commissioning manager
            </li>
            <li>
              <strong>Test sheets:</strong> Blank forms ready for recording results — Commissioning
              specialist
            </li>
            <li>
              <strong>Calibration certificates:</strong> Current certificates for all test
              instruments — Commissioning specialist
            </li>
            <li>
              <strong>Method statements:</strong> Safe systems of work for testing activities —
              Contractor
            </li>
            <li>
              <strong>Risk assessments:</strong> Hazard identification and controls — Contractor
            </li>
            <li>
              <strong>PPE:</strong> Appropriate protective equipment for witnesses — Contractor
            </li>
          </ul>
          <p>
            <strong>Tests Typically Requiring Witnessing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Witness Test Documentation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Witness Test Process</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Notification:</strong> Give required notice to witnesses (typically 48-72
              hours)
            </li>
            <li>
              <strong>Pre-meeting:</strong> Review procedures and safety requirements
            </li>
            <li>
              <strong>Instrument check:</strong> Verify calibration of all test equipment
            </li>
            <li>
              <strong>Test execution:</strong> Conduct tests per approved procedures
            </li>
            <li>
              <strong>Recording:</strong> Document all readings on test sheets
            </li>
            <li>
              <strong>Evaluation:</strong> Compare results against acceptance criteria
            </li>
            <li>
              <strong>Sign-off:</strong> Witness signature confirming acceptance or rejection
            </li>
            <li>
              <strong>Follow-up:</strong> Address any snagging items identified
            </li>
          </ul>
          <p>
            <strong>Important:</strong> Tests conducted without proper witness attendance when
            required may need to be repeated, causing programme delays and additional costs. Always
            confirm witness availability before scheduling hold point tests.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Seasonal Commissioning and Performance Verification">
          <p>
            Seasonal commissioning addresses the reality that HVAC systems cannot be fully
            commissioned during a single period if that period does not include both heating and
            cooling demands. Performance verification demonstrates that systems achieve their design
            intent under actual operating conditions over an extended period.
          </p>
          <p>
            <strong>Seasonal Commissioning Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heating Season:</strong> Boilers, heating coils, radiators, underfloor heating
              — Flow temperatures, heat output, efficiency
            </li>
            <li>
              <strong>Cooling Season:</strong> Chillers, cooling coils, condensers, free cooling —
              Cooling capacity, COP, dehumidification
            </li>
            <li>
              <strong>Intermediate:</strong> Economiser cycles, mixed mode operation — Changeover,
              free cooling optimisation
            </li>
          </ul>
          <p>
            <strong>Heating Season Verification</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Cooling Season Verification</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Performance Verification Framework</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design criteria:</strong> Document target performance parameters from design
            </li>
            <li>
              <strong>Measurement plan:</strong> Define how each parameter will be measured and
              verified
            </li>
            <li>
              <strong>Trend logging:</strong> Configure BMS to capture relevant data over time
            </li>
            <li>
              <strong>Analysis:</strong> Review data to identify performance gaps
            </li>
            <li>
              <strong>Optimisation:</strong> Fine-tune systems to improve performance
            </li>
            <li>
              <strong>Verification report:</strong> Document achieved performance against design
            </li>
          </ul>
          <p>
            <strong>Extended Performance Monitoring (12 months)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Energy consumption:</strong> Sub-metering, BMS trends — Monthly
            </li>
            <li>
              <strong>Space temperatures:</strong> BMS zone sensors — Weekly
            </li>
            <li>
              <strong>Plant efficiency:</strong> Calculated from flow/energy data — Monthly
            </li>
            <li>
              <strong>Occupant comfort:</strong> Feedback, complaints log — Ongoing
            </li>
            <li>
              <strong>Alarm frequency:</strong> BMS alarm logs — Weekly
            </li>
          </ul>
          <p>
            <strong>Snagging and Defects Management</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Recording:</strong> Log all defects with clear descriptions, locations,
              photographs
            </li>
            <li>
              <strong>Categorisation:</strong> Priority 1 (safety/critical), Priority 2
              (operational), Priority 3 (minor)
            </li>
            <li>
              <strong>Responsibility:</strong> Assign each item to responsible party
            </li>
            <li>
              <strong>Tracking:</strong> Maintain snagging register with status updates
            </li>
            <li>
              <strong>Close-out:</strong> Verify rectification and sign off completed items
            </li>
            <li>
              <strong>Escalation:</strong> Process for unresolved items at defects period end
            </li>
          </ul>
          <p>
            <strong>BREEAM context:</strong> Seasonal commissioning and extended performance
            monitoring are requirements for achieving higher BREEAM ratings. Credits are available
            for demonstrating that buildings perform as designed through post-occupancy evaluation.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Managing snagging items identified during commissioning of a
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Commissioning specification:</strong> Defines requirements and acceptance
              criteria
            </li>
            <li>
              <strong>Commissioning programme:</strong> Schedule of activities and dependencies
            </li>
            <li>
              <strong>Method statements:</strong> Safe procedures for commissioning activities
            </li>
            <li>
              <strong>Test sheets:</strong> Standard forms for recording results
            </li>
            <li>
              <strong>Snagging register:</strong> Track defects and resolution
            </li>
            <li>
              <strong>Commissioning report:</strong> Summary of results and handover
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Air flow (system):</strong> +/- 5% of design total
            </li>
            <li>
              <strong>Air flow (terminal):</strong> +/- 10% of design
            </li>
            <li>
              <strong>Water flow:</strong> +/- 10% of design
            </li>
            <li>
              <strong>Temperature (supply):</strong> +/- 1degC of setpoint
            </li>
            <li>
              <strong>Temperature (space):</strong> +/- 1degC of design
            </li>
            <li>
              <strong>Pressure:</strong> +/- 10% of design
            </li>
            <li>
              <strong>Humidity:</strong> +/- 5% RH of design
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Inadequate access:</strong> Design should allow for commissioning access
              </li>
              <li>
                <strong>Missing test points:</strong> Specify during design, not after installation
              </li>
              <li>
                <strong>Incomplete installation:</strong> Commissioning attempted too early
              </li>
              <li>
                <strong>Poor documentation:</strong> Ensure specifications include commissioning
                requirements
              </li>
              <li>
                <strong>Time pressure:</strong> Allow adequate programme time for commissioning
              </li>
              <li>
                <strong>Coordination failures:</strong> Ensure all trades are ready before starting
              </li>
            </ul>
          }
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Documentation</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
