    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              A safe system of work is the legal expression of s.2(2)(a). Document the system, train
              people in it, monitor it and revise it after every incident. As an HNC supervisor, the
              SSOW is your day-to-day deliverable.
            </>
          }
        ...
        <ConceptBlock title="Definition and Legal Basis">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>MHSWR 1999 Regulation 3:</strong> Risk assessment requirement - foundation of
              all SSOW
            </li>
            <li>
              <strong>MHSWR 1999 Regulation 4:</strong> Implement preventive and protective measures
              from assessment
            </li>
            <li>
              <strong>EAW 1989 Regulation 4:</strong> Systems of work to prevent electrical danger
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Task analysis</strong> — Description: Break down work into steps. Example:
              Each stage of cable installation
            </li>
            <li>
              <strong>Hazard identification</strong> — Description: Find things that could cause
              harm. Example: Live conductors, work at height
            </li>
            <li>
              <strong>Risk evaluation</strong> — Description: Assess likelihood and severity.
              Example: High risk = live HV work
            </li>
            <li>
              <strong>Control measures</strong> — Description: Actions to reduce risk. Example:
              Isolation, PPE, barriers
            </li>
            <li>
              <strong>Safe procedures</strong> — Description: Step-by-step safe method. Example:
              Isolation sequence
            </li>
            <li>
              <strong>Competent persons</strong> — Description: Trained, qualified workers. Example:
              Authorised persons for HV
            </li>
          </ul>
        ...
        <ConceptBlock title="Development Process">
          <p>
            ...
            identification of hazards, and selection of appropriate controls using the hierarchy of
            controls.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Identify the people, plant, materials and environment involved</li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Consider physical, chemical, biological, ergonomic and psychological hazards</li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Engineering:</strong> Physical controls (guards, ventilation, isolation)
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Include risk assessment, method statement, permits if required</li>
          ...
          <div className="relative">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 p-2 rounded bg-lime-500/10 border border-lime-500/30">
                ...
                <p className="text-xs text-white">Replace with less hazardous alternative</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Key principle:</strong> Always start at the top of the hierarchy. Only move down
        ...
        <ConceptBlock title="Implementation and Communication">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Scope of work</strong> — Content: What task is being done, where, and when
            </li>
            <li>
              <strong>Hazards</strong> — Content: Specific dangers for this task/location
            </li>
            <li>
              <strong>Controls</strong> — Content: Measures in place and required actions
            </li>
            <li>
              <strong>PPE</strong> — Content: Required equipment and standards
            </li>
            <li>
              <strong>Emergency</strong> — Content: What to do if things go wrong
            </li>
            <li>
              <strong>Questions</strong> — Content: Opportunity to clarify and raise concerns
            </li>
          </ul>
        ...
        <ConceptBlock title="Monitoring, Supervision and Review">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Regularly:</strong> As part of a planned review schedule (at least annually)
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>High-risk task, new worker</strong> — Supervision Level: Constant, direct
              supervision
            </li>
            <li>
              <strong>High-risk task, experienced worker</strong> — Supervision Level: Regular
              checks, immediate availability
            </li>
            <li>
              <strong>Low-risk task, competent worker</strong> — Supervision Level: Periodic
              monitoring
            </li>
            <li>
              <strong>Permit-controlled work</strong> — Supervision Level: As specified in permit
              conditions
            </li>
          </ul>
        ...
        <ConceptBlock title="Building Services SSOW Examples">
          ...
          <p>
            <strong>Safe Isolation Procedure (GS38)</strong>
          </p>
          <p className="text-sm text-white mb-4">
            Safe isolation is the fundamental SSOW for electrical work. It ensures conductors are
            dead before work begins and cannot be re-energised during work.
          </p>
          ...
          <div className="flex items-start gap-3 p-2 rounded bg-black/30">
            ...
            <div>
              ...
              <p className="text-xs text-white">
                Test with approved voltage indicator (proved on known live source before AND after)
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3 p-2 rounded bg-black/30">
          ...
          <div className="p-4 rounded-lg bg-white/5 mt-6">
            <p>
              <strong>Permit-to-Work Systems</strong>
            </p>
            <p className="text-sm text-white mb-4">
            ...
            <div className="overflow-x-auto mb-4">
              <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
                <li>
                  <strong>Electrical (HV)</strong> — When Required: Work on high voltage systems.
                  Key Controls: Isolation, earthing, access control
                </li>
                <li>
                  <strong>Hot Work</strong> — When Required: Welding, cutting, brazing. Key
                  Controls: Fire watch, removal of combustibles
                </li>
                <li>
                  <strong>Confined Space</strong> — When Required: Entry to tanks, ducts, chambers.
                  Key Controls: Atmosphere testing, rescue plan
                </li>
                <li>
                  <strong>Excavation</strong> — When Required: Groundwork near services. Key
                  Controls: Service location, shoring
                </li>
                <li>
                  <strong>Breaking Containment</strong> — When Required: Opening pressurised
                  systems. Key Controls: Depressurisation, drainage
                </li>
              </ul>
            </div>
          ...
          <div className="p-4 rounded-lg bg-white/5 mt-6">
            <p>
              <strong>Lock-Out Tag-Out (LOTO) for Mechanical Systems</strong>
            </p>
            <p className="text-sm text-white mb-4">
        ...
        <ConceptBlock title="Practical Guidance">
          <div>
            <p>
              <strong>SSOW Development Checklist</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <div>
            <p>
              <strong>Key Legislation and Guidance</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
          ...
          <div>
            <p>
              <strong>Common Failures to Avoid</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You have just taken on a supervisory role at a building services contractor. You
              discover that operatives are using inconsistent isolation methods — some lock off,
              some just remove fuses, some rely on the foreman&rsquo;s word that the circuit is
              dead. There is no documented isolation procedure.
            </>
          }
          whatToDo={
            <>
              Establish the SSOW. Adopt HSE GS38 + the IET&rsquo;s recommended sequence: identify,
              switch off, prove voltage indicator on a known live source, prove dead at the point of
              work, prove voltage indicator again on the known live source, lock off and apply
              caution notice. Issue padlocks, multi-padlock hasps, personal danger tags, GS38
              voltage indicators and proving units. Train every operative, record the briefing,
              audit weekly for the first quarter. Tie the procedure into the firm&rsquo;s
              permit-to-work system for all live or near-live work.
            </>
          }
          whyItMatters={
            <>
              Inconsistent isolation is the largest single cause of UK electrical fatalities in
              maintenance. A single firm-wide SSOW removes the variability and gives every operative
              the same defence under EAWR Reg 14.
            </>
          }
        />
