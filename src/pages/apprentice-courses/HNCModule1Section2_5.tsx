      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>SSOW:</strong> Formal procedure from systematic hazard examination
              </li>
              <li className="pl-1">
                <strong>Legal basis:</strong> Required under HASAWA 1974 Section 2
              </li>
              <li className="pl-1">
                <strong>Five stages:</strong> Assess, design, implement, monitor, review
              </li>
              <li className="pl-1">
                <strong>Key examples:</strong> Safe isolation, permit-to-work systems
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Electrical:</strong> Safe isolation per GS38
              </li>
              <li className="pl-1">
                <strong>Mechanical:</strong> LOTO for rotating plant
              </li>
              <li className="pl-1">
                <strong>Permits:</strong> Hot work, confined spaces, high voltage
              </li>
              <li className="pl-1">
                <strong>Documentation:</strong> Method statements, risk assessments
              </li>
            </ul>
          </div>
        </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Find things that could cause harm
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Live conductors, work at height
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        What task is being done, where, and when
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Hazards</td>
                      <td className="border border-white/10 px-3 py-2">
                        Specific dangers for this task/location
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Controls</td>
                      <td className="border border-white/10 px-3 py-2">
                        Measures in place and required actions
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Opportunity to clarify and raise concerns
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        High-risk task, experienced worker
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Regular checks, immediate availability
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Low-risk task, competent worker
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        As specified in permit conditions
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Isolation, earthing, access control
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Fire watch, removal of combustibles
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Confined Space</td>
                      <td className="border border-white/10 px-3 py-2">
                        Entry to tanks, ducts, chambers
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Atmosphere testing, rescue plan
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="p-4 rounded-lg bg-white/5 mt-6">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                Lock-Out Tag-Out (LOTO) for Mechanical Systems
              </h3>
              <p className="text-sm text-white mb-4">
