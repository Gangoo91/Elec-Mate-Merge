...
import { ArrowLeft, ArrowRight, Anchor, Ruler, Weight } from 'lucide-react';
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Cable sag, loose supports, plastic clips in escape routes.
                </li>
                <li>
                  <strong>Use:</strong> 300mm PVC, 450mm SWA, 250mm flex, steel supports in fire
                  routes.
                </li>
                <li>
                  <strong>Check:</strong> Support spacing, fixing security, manufacturer
                  specifications.
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
            <li>
              State the recommended maximum cable support distances for horizontal and vertical
              runs.
            </li>
        ...
        <section className="mb-10">
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              <h4 className="font-medium text-white mb-3">
                Engineering Principles Behind Cable Support
              </h4>
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <p className="text-xs sm:text-sm text-white mb-3">
                  <strong>Mechanical Loading:</strong> Cables act as distributed loads creating
                  bending moments between supports. The maximum sag occurs at mid-span and increases
                  with the square of the span length, making proper spacing critical for maintaining
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Load distribution:</strong> Transfers cable weight to building
                        structure
                      </li>
                      <li>
                        * <strong>Deflection control:</strong> Maintains acceptable sag within
                        limits
                      </li>
                      <li>
                        * <strong>Strain relief:</strong> Prevents mechanical stress at terminations
                      </li>
                      <li>
                        * <strong>Vibration damping:</strong> Reduces fatigue from building movement
                      </li>
                      <li>
                        * <strong>Thermal stability:</strong> Accommodates expansion/contraction
                        cycles
                      </li>
                    </ul>
                  </div>
                  <div>
                    <h6 className="font-medium text-white mb-2">
                      Failure Modes Without Adequate Support
                    </h6>
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Excessive sag:</strong> Beyond acceptable aesthetic/functional
                        limits
                      </li>
                      <li>
                        * <strong>Termination stress:</strong> Pull-out forces at connections
                      </li>
                      <li>
                        * <strong>Sheath cracking:</strong> Repeated flexing at support points
                      </li>
                      <li>
                        * <strong>Core stretching:</strong> Conductor elongation in vertical runs
                      </li>
                      <li>
                        * <strong>Joint separation:</strong> Mechanical failure at splice points
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Escape route protection:</strong> Non-combustible supports
                        mandatory
                      </li>
                      <li>
                        * <strong>Fire resistance:</strong> Supports must not fail below 750C
                      </li>
                      <li>
                        * <strong>Structural integrity:</strong> Maintain support during evacuation
                        period
                      </li>
                      <li>
                        * <strong>Emergency lighting:</strong> Critical circuit protection priority
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Grenfell Tower:</strong> Highlighted cable support fire safety
                        risks
                      </li>
                      <li>
                        * <strong>Building regulations:</strong> Enhanced fire safety requirements
                      </li>
                      <li>
                        * <strong>Insurance implications:</strong> Non-compliance affects coverage
                      </li>
                      <li>
                        * <strong>Professional liability:</strong> Designer and installer
                        responsibility
                      </li>
                    </ul>
                  </div>
                    ...
                    <tbody>
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>Cable Weight</strong>
                        </td>
                        <td className="border border-white/10 p-3">
                          Heavier = closer spacing required
                        </td>
                        <td className="border border-white/10 p-3">
                          1.5-15 kg/m depending on size
                        </td>
                        <td className="border border-white/10 p-3">Linear loading calculation</td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                          <strong>Overall Diameter</strong>
                        </td>
                        <td className="border border-white/10 p-3">
                          Larger diameter = greater sag
                        </td>
                      ...
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>Sheath Stiffness</strong>
                        </td>
                        <td className="border border-white/10 p-3">
                          Flexible = more support needed
                        </td>
                        <td className="border border-white/10 p-3">
                          Varies by material/construction
                        </td>
                      ...
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>Armouring</strong>
                        </td>
                        <td className="border border-white/10 p-3">
                          Armoured = wider spacing possible
                        </td>
              ...
              <div className="p-4 bg-transparent border border-amber-400/30 rounded-lg mb-4">
                ...
                <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Thermal cycling:</strong> Daily heating/cooling stress
                      </li>
                      <li>
                        * <strong>Material degradation:</strong> UV and ozone effects
                      </li>
                      <li>
                        * <strong>Expansion coefficients:</strong> PVC 8x10-5/C, XLPE 2x10-4/C
                      </li>
                      <li>
                        * <strong>Cold weather brittleness:</strong> Increased support needs
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Vibration sources:</strong> Machinery, traffic, wind
                      </li>
                      <li>
                        * <strong>Dynamic loading:</strong> Short-circuit fault currents
                      </li>
                      <li>
                        * <strong>Building movement:</strong> Settlement, thermal, seismic
                      </li>
                      <li>
                        * <strong>Access requirements:</strong> Maintenance and alteration
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Corrosive atmospheres:</strong> Support material selection
                      </li>
                      <li>
                        * <strong>Humidity cycles:</strong> Dimensional changes
                      </li>
                      <li>
                        * <strong>Chemical compatibility:</strong> Support/cable interaction
                      </li>
                      <li>
                        * <strong>Water absorption:</strong> Weight increase over time
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="p-4 bg-transparent border border-cyan-400/30 rounded-lg">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Fire escape routes:</strong> Non-combustible supports mandatory
                      </li>
                      <li>
                        * <strong>Public areas:</strong> Enhanced mechanical protection
                      </li>
                      <li>
                        * <strong>Industrial environments:</strong> Vibration and chemical
                        resistance
                      </li>
                      <li>
                        * <strong>Outdoor installations:</strong> Weather and UV protection
                      </li>
                      <li>
                        * <strong>Hazardous areas:</strong> Explosion-proof support systems
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Grouped cables:</strong> Combined weight considerations
                      </li>
                      <li>
                        * <strong>Thermal effects:</strong> Heat buildup in bundles
                      </li>
                      <li>
                        * <strong>Segregation requirements:</strong> Different voltage levels
                      </li>
                      <li>
                        * <strong>EMC considerations:</strong> Power and data separation
                      </li>
                      <li>
                        * <strong>Future expansion:</strong> Additional cable accommodation
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    ...
                    <tbody>
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>PVC T&E (2.5-6mm2)</strong>
                        </td>
                      ...
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                          <strong>PVC T&E (10mm2 and above)</strong>
                        </td>
                        <td className="border border-white/10 p-3">250mm</td>
                        <td className="border border-white/10 p-3">350mm</td>
                        <td className="border border-white/10 p-3">
                          Heavier cables need closer spacing
                        </td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>SWA Cable (up to 35mm2)</strong>
                        </td>
                        <td className="border border-white/10 p-3">450mm</td>
                        <td className="border border-white/10 p-3">600mm</td>
                        <td className="border border-white/10 p-3">
                          Armour provides mechanical strength
                        </td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                          <strong>SWA Cable (50mm2 and above)</strong>
                        </td>
                        <td className="border border-white/10 p-3">350mm</td>
                        <td className="border border-white/10 p-3">500mm</td>
                        <td className="border border-white/10 p-3">
                          Increased weight requires closer support
                        </td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>Flexible Cord/Cable</strong>
                        </td>
                        <td className="border border-white/10 p-3">250mm</td>
                        <td className="border border-white/10 p-3">300mm</td>
                        <td className="border border-white/10 p-3">
                          Stranded construction more flexible
                        </td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                          <strong>FP200 Fire Cable</strong>
                        </td>
                        <td className="border border-white/10 p-3">300mm</td>
                        <td className="border border-white/10 p-3">400mm</td>
                        <td className="border border-white/10 p-3">
                          Similar to standard PVC but fire rated
                        </td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>MICC Cable</strong>
                        </td>
                        <td className="border border-white/10 p-3">600mm</td>
                        <td className="border border-white/10 p-3">800mm</td>
                        <td className="border border-white/10 p-3">
                          Rigid construction allows wider spacing
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-elec-yellow mb-3">
                  Support Methods and Hardware Selection
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Plastic clips:</strong> Standard T&E, indoor use only
                      </li>
                      <li>
                        * <strong>Metal saddles:</strong> Fire routes, enhanced durability
                      </li>
                      <li>
                        * <strong>Cable ties with clips:</strong> Bundled cables, temporary runs
                      </li>
                      <li>
                        * <strong>Adhesive clips:</strong> Masonry fixing, appropriate substrates
                      </li>
                      <li>
                        * <strong>Nail-in clips:</strong> Timber frame construction
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Steel cleats:</strong> SWA termination and support
                      </li>
                      <li>
                        * <strong>Cable trays:</strong> Multiple cable support systems
                      </li>
                      <li>
                        * <strong>Beam clamps:</strong> Structural steel mounting
                      </li>
                      <li>
                        * <strong>Threaded rod systems:</strong> Suspended installations
                      </li>
                      <li>
                        * <strong>Explosion-proof supports:</strong> Hazardous area applications
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Can cable ties be used as the only fixing method in escape routes?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: No. Cable ties must be used in conjunction with non-combustible supports. They
                can group cables but cannot be the primary support method in fire escape routes.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Do vertical runs always need less support than horizontal runs?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: No. While vertical spacing can often be wider due to gravity effects, heavy
                cables may require closer spacing to prevent conductor stretching and sheath stress.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Should support distances be closer than recommended?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: Yes, closer spacing is advisable for cables under mechanical stress, subject to
                vibration, installed in harsh conditions, or when manufacturer guidance specifies
                it.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: What happens if I exceed maximum support distances?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: Excessive spacing can cause non-compliance with BS 7671, inspection failures,
                cable damage, termination stress, and potential safety hazards including fire route
                obstruction.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 bg-transparent border-l-2 border-elec-yellow rounded-lg border border-white/10">
            <p className="text-white/90">
              ...
              regulations mandate non-combustible supports in escape routes, reflecting the critical
              importance of maintaining electrical system integrity during emergencies.
            </p>
          </div>
        </section>
