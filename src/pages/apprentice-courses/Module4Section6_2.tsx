...
const TITLE =
  'Continuity and Polarity Checks (Functional, Non-Certified) - Module 4.6.2 | Level 2 Electrical Course';
const DESCRIPTION =
  'Master functional continuity and polarity testing techniques for electrical installations. Learn to verify circuit integrity and correct conductor connections before formal certification testing.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Continuity refers to an unbroken, consistent electrical path through a conductor, ensuring proper electrical connection from one end to the other.',
  },
  {
    id: 2,
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Continuity refers to an unbroken electrical path in a circuit, ensuring proper electrical connection throughout the conductor.',
    },
    {
      id: 2,
      question:
  ...
  const faqs = [
    {
      ...
      answer:
        'No — these are performed with the circuit safely isolated. Never attempt polarity or continuity checks on energised circuits as this creates serious safety hazards.',
    },
    {
      question: 'Are continuity and polarity checks recorded on the installation certificate?',
      answer:
        'Formal test results are recorded on certificates; basic functional checks are usually noted in site records for quality assurance and fault tracking purposes.',
    },
    {
      question: "If I find a break in continuity, what's the next step?",
      answer:
        'Locate and repair the fault before progressing to formal testing. Document the fault location and corrective action taken for site records.',
    },
    {
      question: 'How often should functional checks be performed during installation?',
      answer:
        'Best practice is to test each circuit and accessory as it is installed, rather than waiting until the end of the job. This makes fault finding much easier.',
    },
    {
      question: "What's the difference between functional and certification testing?",
      answer:
        'Functional checks are preliminary verification tests during installation, while certification testing follows formal BS 7671 procedures with calibrated instruments and documented results.',
    },
  ];
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-white/80">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    Functional checks verify continuity and polarity before formal testing begins
                  </li>
                  <li>
                    These preliminary tests identify wiring faults early in the installation process
                  </li>
                  <li>
                    Proper checks prevent equipment damage and ensure safety before energisation
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Spot:</strong> Conductor breaks, incorrect connections, polarity errors
                  </li>
                  <li>
                    <strong>Use:</strong> Continuity testers, systematic checking methods, isolation
                    procedures
                  </li>
                  <li>
                    <strong>Check:</strong> Zero resistance paths, correct terminal connections,
                    safety compliance
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-white/80">
              ...
              <li>
                Perform basic functional continuity tests on conductors and circuit protective
                conductors (CPCs)
              </li>
              <li>
                Verify polarity of outlets, switches, and light fittings using appropriate testing
                methods
              </li>
              <li>
                Recognise common faults found during functional checks and understand their
                potential consequences
              </li>
              <li>
                Understand when to escalate from basic functional checks to formal certification
                testing procedures
              </li>
            </ul>
          </section>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="font-semibold text-white mb-2">
                  Continuity Fundamentals and Testing Principles
                </p>
                <p className="text-sm mb-2">
                  <strong>Definition and importance:</strong> Continuity ensures unbroken electrical
                  paths through conductors.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                  <li>
                    Unbroken, consistent electrical path through conductors from origin to
                    termination point
                  </li>
                  <li>Essential for proper current flow and protection system operation</li>
                  <li>
                    Critical for circuit protective conductor (CPC) effectiveness in fault
                    conditions
                  </li>
                  <li>
                    Fundamental requirement for safe equipment operation and personnel protection
                  </li>
                </ul>
                <p className="text-sm mb-2">
                  <strong>Testing methodology:</strong> Low-resistance measurement techniques for
                  accurate assessment.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <div className="text-sm p-2 rounded bg-white/5 border border-white/10">
                  <strong>Safety critical:</strong> CPC continuity failures can result in dangerous
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
                <p className="font-semibold text-white mb-2">
                  Polarity Verification and Safety Requirements
                </p>
                <p className="text-sm mb-2">
                  <strong>Polarity definition and significance:</strong> Correct
                  conductor-to-terminal relationships for safe operation.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="text-sm mb-2">
                  <strong>Safety implications of polarity errors:</strong> Incorrect connections
                ...
                <div className="text-sm p-2 rounded bg-white/5 border border-white/10">
                  <strong>Critical verification:</strong> All conductor connections must be verified
                  before energisation
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
                <p className="font-semibold text-white mb-2">
                  Professional Testing Procedures and Safety Protocols
                </p>
                <p className="text-sm mb-2">
                  <strong>Continuity testing procedure:</strong> Systematic approach for reliable
                  results.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="text-sm mb-2">
                  <strong>Polarity verification procedure:</strong> Confirming correct conductor
                  connections.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <div className="text-sm p-2 rounded bg-white/5 border border-white/10">
                  <strong>Safety first:</strong> Never attempt testing on energised circuits -
                  always isolate and verify
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
                <p className="font-semibold text-white mb-2">
                  Typical Installation Faults and Resolution Strategies
                </p>
                <p className="text-sm mb-2">
                  <strong>Continuity-related faults:</strong> Common breaks and connection issues.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                  <li>Broken CPC connections in socket ring final circuits affecting protection</li>
                  <li>
                    Damaged conductors due to poor installation techniques or subsequent damage
                  </li>
                ...
                <p className="text-sm mb-2">
                  <strong>Polarity-related faults:</strong> Incorrect conductor connections and
                  identification.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <div className="text-sm p-2 rounded bg-white/5 border border-white/10">
                  <strong>Early detection:</strong> Functional testing identifies problems before
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-lg border border-green-400/30 bg-green-500/5">
                ...
                <ul className="text-sm text-white/80 space-y-1 list-disc pl-4">
                  ...
                  <li>
                    Test each accessory as it is installed rather than waiting until project
                    completion
                  </li>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
              ...
              <div className="text-white/80 space-y-3 text-sm">
                ...
                <p>
                  <strong>Discovery:</strong> A continuity check on the classroom socket ring
                  circuit revealed a break in the circuit protective conductor (CPC) between two
                  sockets. The initial reading showed infinite resistance instead of the expected
                  near-zero value.
                </p>
                <p>
                  <strong>Investigation:</strong> Systematic testing traced the fault to a poorly
                  crimped earth connection inside a junction box that had been hidden behind a wall
                  panel.
                </p>
                <p>
                  <strong>Resolution:</strong> The junction box was accessed, and the faulty crimp
                  connection was remade properly. Continuity testing confirmed the repair.
                </p>
                <div className="p-3 rounded bg-green-500/10 border border-green-400/30 mt-3">
                  <p className="font-medium text-white">
                    Key Learning: Functional testing during installation saves time and money by
                    identifying faults when they are easier to access and repair.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-white/80 mb-4">
                ...
                easier and less expensive to correct.
              </p>
