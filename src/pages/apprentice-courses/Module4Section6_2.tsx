      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Understanding Continuity and Its Critical Importance</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Continuity Fundamentals and Testing Principles</p>
                    <p className="text-base text-foreground mb-2"><strong>Definition and importance:</strong> Continuity ensures unbroken electrical paths through conductors.</p>
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Testing methodology:</strong> Low-resistance measurement techniques for accurate assessment.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Circuit protective conductor priority:</strong> CPC continuity is critical for safety systems.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Understanding Polarity and Connection Verification</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Polarity definition and significance:</strong> Correct conductor-to-terminal relationships for safe operation.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Safety implications of polarity errors:</strong> Incorrect connections create serious hazards.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Common polarity error scenarios:</strong> Typical mistakes requiring verification.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          {/* Testing Procedures */}
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Systematic Testing Procedures and Best Practices</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Professional Testing Procedures and Safety Protocols</p>
                    <p className="text-base text-foreground mb-2"><strong>Continuity testing procedure:</strong> Systematic approach for reliable results.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Polarity verification procedure:</strong> Confirming correct conductor connections.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Lighting circuit special considerations:</strong> Additional verification requirements.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Documentation and recording:</strong> Maintaining accurate test records.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Common Issues and Fault Identification</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-amber-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Continuity-related faults:</strong> Common breaks and connection issues.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Polarity-related faults:</strong> Incorrect conductor connections and identification.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Installation quality issues:</strong> Workmanship-related problems.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          {/* Tools and Equipment */}
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Essential Tools and Equipment for Effective Testing</h3>
            <div className="space-y-4">
              <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
                <p className="font-medium text-foreground mb-2">Required Testing Equipment</p>
              ...
              <div className="rounded-lg p-4 bg-card border border-green-400/30">
                <p className="font-medium text-foreground mb-2">Professional Testing Techniques</p>
                <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
              ...
              <div className="rounded-lg p-4 bg-card border border-amber-400/30">
                <p className="font-medium text-foreground mb-2">Field Testing Best Practices</p>
                <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
            <div className="space-y-4">
              <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
                <h3 className="font-medium text-foreground mb-2">Immediate Implementation</h3>
                <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-4 bg-card border border-amber-400/30">
                <h3 className="font-medium text-foreground mb-2">Project Scheduling</h3>
                <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
          ...
          <div className="space-y-6">
            <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <p className="font-medium text-foreground mb-2">Progressive Testing Strategy</p>
                  <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
                ...
                <div>
                  <p className="font-medium text-foreground mb-2">Fault Prevention Methods</p>
                  <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
            ...
            <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <p className="font-medium text-foreground mb-2">Testing Documentation</p>
                  <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
                ...
                <div>
                  <p className="font-medium text-foreground mb-2">Safety Procedures</p>
                  <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-4">
            <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
              <h3 className="font-medium text-red-600 dark:text-emerald-400 mb-3">Testing Procedure Errors</h3>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-4">
            <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/20">
              <h3 className="font-medium text-foreground mb-2">Regulatory Framework</h3>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
              <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
                <h3 className="font-medium text-emerald-400 dark:text-emerald-400 mb-2">Safety Benefits</h3>
                <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
              ...
              <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
                <h3 className="font-medium text-purple-600 dark:text-emerald-400 mb-2">Project Efficiency</h3>
                <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
            <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/20">
              <h3 className="font-medium text-foreground mb-3">Functional Testing Checklist</h3>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              <h3 className="font-medium text-foreground mb-2">Technical Guidance</h3>
              <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
