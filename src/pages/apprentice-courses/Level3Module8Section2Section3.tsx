...
const TITLE = 'Exam day preparation for the L3 paper | Level 3 Module 8.2.3 | Elec-Mate';
const DESCRIPTION =
...
const faqs = [
  {
    question: 'Do I need to bring anything other than ID for an L3 closed-book unit assessment?',
    answer:
  ...
  {
    question: 'Should I sit a full mock the day before, or rest?',
    answer:
  ...
  {
    question: 'How does sleep affect L3 paper performance?',
    answer:
  ...
  {
    question: "I'm a working apprentice — when should I take the day before off?",
    answer:
  ...
  {
    question: 'I get exam anxiety badly. What actually helps?',
    answer:
...
export default function Level3Module8Section2Section3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 2 · Subsection 3"
        title="Exam day preparation for the L3 paper"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The 24-hour run-up to a Level 3 closed-book unit assessment — what to revise the night
          before, what to pack, what to eat, sleep strategy and how to walk into the centre with the
          right mindset for a calm, well-paced paper.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Evening before, 5pm-7pm</strong> — review your mock error log (every question
              you got wrong, with the right answer and why). Refresh the formula bank for the
              relevant unit (Unit 304: Zs limits, IR thresholds, RCD operating values; Unit 305:
              voltage drop, CCC after derating, Zs design check; Unit 302: three-phase line/phase,
              transformer ratios, AC waveform).
            </li>
            <li>
              <strong>7pm</strong> — close the books. Eat a proper meal (slow-release carbs,
              protein, vegetables; avoid alcohol).
            </li>
            <li>
              <strong>Evening</strong> — do something genuinely relaxing. Watch something, see
              family, walk. Anything that is not exam-related. Your brain consolidates while you
              switch off.
            </li>
            <li>
              <strong>9pm-10pm</strong> — pack everything you need for the morning. Lay it by the
              door. ID, confirmation letter, calculator, water, snack, watch. One bag, sealed.
            </li>
            <li>
              <strong>Bed at your normal time</strong> — not earlier (you'll lie awake). Aim for 7-8
              hours. If anxiety is keeping you awake, slow box breathing (4 in, 4 hold, 4 out, 4
              hold) for 5 minutes before lights out.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Start time minus 3 hours</strong> — wake up. Don't oversleep, don't rush.
              Shower, get dressed in something comfortable.
            </li>
            <li>
              <strong>Start time minus 2 hours</strong> — eat breakfast. Slow-release carbs,
              protein, a banana, water. One coffee or tea if it's your normal routine.
            </li>
            <li>
              <strong>Start time minus 90 minutes</strong> — final pack-check. ID, letter,
              calculator, water, snack, watch. Phone going in the car (or in your bag, switched off,
              before you reach the centre).
            </li>
            <li>
              <strong>Start time minus 60 minutes</strong> — leave for the centre. Pad for traffic.
              If the journey is normally 20 minutes, allow 40.
            </li>
            <li>
              <strong>Start time minus 30 minutes</strong> — arrive at the centre. Sign in, use the
              toilet, settle. Do NOT do last-minute revision — it spikes anxiety without adding
              knowledge.
            </li>
            <li>
              <strong>Start time minus 5 minutes</strong> — in the room, seated, calculator on the
              desk, ID visible. Slow breathing. Trust the preparation.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Photo ID</strong> — passport, driving licence, or another centre-accepted
              form. No ID = no exam. Confirm in advance which forms your centre accepts.
            </li>
            <li>
              <strong>Candidate confirmation letter or email</strong> — printed or screenshotted
              (most centres accept either). Has your candidate number on it.
            </li>
            <li>
              <strong>Basic non-programmable scientific calculator</strong> — backup in case the
              on-screen calculator misbehaves or the centre's setup is different from what you
              expected. Programmable calculators are NOT permitted.
            </li>
            <li>
              <strong>Clear water bottle</strong> — label removed (centres ban printed labels in
              case of hidden notes).
            </li>
            <li>
              <strong>Snack for AFTER the exam</strong> — banana, energy bar. You'll want it on the
              way home.
            </li>
            <li>
              <strong>Analogue watch</strong> — phones and smartwatches are banned, but most rooms
              have a wall clock and the on-screen timer counts down. A cheap analogue watch is a
              cheap insurance against losing track.
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Anything that could be mistaken for a hidden note (printed water bottle labels,
              written-on tissues).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Day before</strong> — eat normally. Drink plenty of water. Avoid alcohol (it
              disrupts sleep architecture even if you fall asleep fine).
            </li>
            <li>
              <strong>Evening</strong> — last caffeine by 2pm if you're sensitive, 4pm at the
              latest. A late coffee will keep you awake and steal an hour off your sleep.
            </li>
            <li>
              <strong>Morning of</strong> — slow-release carbs, protein, banana, water. Avoid sugary
              cereal, pastries, energy drinks.
            </li>
            <li>
              <strong>Caffeine</strong> — one normal coffee or tea with breakfast if that's your
              routine. Don't suddenly drink three to &quot;get sharp&quot; — caffeine on a
              non-tolerant system makes you jittery, not focused.
            </li>
            <li>
              <strong>Hydration</strong> — sip water through the morning. The L3 paper rooms are
              usually warm, and dehydration is a measurable performance hit.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Working apprentice finishes a long shift at 6pm, arrives home, eats a quick takeaway,
              then sits up until 2am cramming three-phase theory and voltage drop calculations they
              haven&apos;t mastered. They sleep 4 hours, wake up at 7am for a 9:30am start, skip
              breakfast because they&apos;re running late, drink three coffees in the car, and
              arrive at the centre jittery and exhausted. They read questions twice and still
              misread half of them. They fail by 6 marks on a paper they were on track for at 72% in
              mocks.
            </>
          }
          doInstead={
            <>
              Stop revising at 8pm the night before. Eat a proper meal, do something relaxing for an
              hour, then sleep at your normal time. The hour you save by NOT cramming is worth 10
              marks of clearer thinking on the day. Sleep is the multiplier — preparation without
              sleep is wasted preparation.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You're a working apprentice. Your Unit 304 (Inspection, Testing and Commissioning)
              paper is on a Friday at 09:30. You normally work 07:30-16:30 Mon-Fri on a commercial
              fit-out site. You have done five full Unit 304 mocks across the last month, averaging
              71%. Your tutor thinks you're ready.
            </>
          }
          whatToDo={
            <>
              Mon-Wed of exam week: work normally. Each evening do 30-45 minutes of error-log review
              focused on the items you've consistently got wrong (likely C2 vs C3 boundary calls,
              Zs/disconnection time mappings, IR test thresholds for different cable categories).
              Thursday: try to leave site at 14:00 if your employer allows; if not, finish at 16:30
              and go straight home, no detours. Eat a proper evening meal at 18:00. From
              19:00-20:00, one final error-log review and a refresh of the Part 6 BS 7671 structure.
              20:00 onwards: stop, do something relaxing, pack everything for the morning, bed at
              your normal time. Friday: alarm at 06:30, breakfast at 07:00 (porridge, banana, water,
              one coffee), out the door at 08:30, arrive at the centre 09:00, sign in, settle, walk
              in calm at 09:25.
            </>
          }
          whyItMatters={
            <>
              The L3 closed-book papers reward calm, well-rested candidates more than they reward
              last-minute crammers. A working apprentice has less bandwidth than a full-time student
              — the trade is sleep and consolidation, not heroic late-night revision. The 71% mock
              average is your real baseline; protecting it with sleep and prep is worth more than
              trying to push it to 80% with a sleepless cram.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Calculator and rough paper laid out where your hands fall naturally.</li>
            <li>Slow box breathing — 4 in, 4 hold, 4 out, 4 hold — for 30 seconds.</li>
            <li>
              Confirm screen navigation: where is the next button, the previous button, the flag
              button, the submit button. Where does the on-screen timer live.
            </li>
            <li>
              Read question 1 calmly, two reads, identify command word, work the answer. The first
              question sets the rhythm for the next 89.
            </li>
            <li>
              If question 1 is hard, flag and move on without panic. Question order isn't always
              difficulty order — Q2 may be your easiest mark.
            </li>
          </ul>
        </ConceptBlock>
