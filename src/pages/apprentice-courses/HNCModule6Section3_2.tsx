...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['6.0 litres', '4.0 litres', '4.5 litres', '3.0 litres'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['8 litres/minute', '3 litres/minute', '6 litres/minute', '12 litres/minute'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['40% improvement', '25% improvement', '65% improvement', '55% improvement'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['5-10 years', '15-20 years', '1-2 years', 'Over 25 years'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['6 litres/minute', '8 litres/minute', '12 litres/minute', '10 litres/minute'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['1 litre/minute', 'No minimum specified', '0.1 litres/second', '10 litres/minute'],
    correctAnswer: 0,
    explanation:
...
const HNCModule6Section3_2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 3 · Subsection 2"
        title="BREEAM Water Category"
        backTo="/study-centre/apprentice/h-n-c-module6-section3"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Part G is the legal floor (125 L/p/d default; 110 L/p/d optional). BREEAM credits are
              awarded for performance below the Part G limit. Many local plans (particularly
              south-east England) impose the 110 L/p/d optional standard, which already requires the
              same fitting choices as 3-credit BREEAM performance — so dwelling design must meet
              both simultaneously.
            </>
          }
        ...
        <ConceptBlock title="Wat 01: Water Consumption">
          <p>
            The Water Consumption issue (Wat 01) is the primary credit-generating opportunity within
            the BREEAM Water category. It uses a standardised calculator methodology to compare the
            assessed building's predicted water consumption against a notional baseline building
            fitted with conventional sanitary components.
          </p>
          <p>
            <strong>Credit Thresholds for Wat 01:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>12.5% improvement:</strong> 1 credit — Standard efficient fittings
            </li>
            <li>
              <strong>25% improvement:</strong> 2 credits — Good practice fittings throughout
            </li>
            <li>
              <strong>40% improvement:</strong> 3 credits — Best practice fittings
            </li>
            <li>
              <strong>50% improvement:</strong> 4 credits — Best practice + low-flush WCs
            </li>
            <li>
              <strong>55% improvement:</strong> 5 credits — Best practice + waterless
              urinals/recycled water
            </li>
          </ul>
          <p>
            <strong>BREEAM Water Calculator Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Building data:</strong> Floor area, occupancy levels, operating hours by use
              type
            </li>
            <li>
              <strong>Sanitary fittings:</strong> WCs, urinals, WHB taps, showers, kitchen taps,
              baths
            </li>
            <li>
              <strong>Flow rates/flush volumes:</strong> Specified for each fitting type
            </li>
            <li>
              <strong>Alternative water sources:</strong> Rainwater, greywater, borehole water
            </li>
            <li>
              <strong>Process water:</strong> Cooling towers, laboratories, specialist uses
            </li>
          </ul>
          <p>
            <strong>Design principle:</strong> The water calculator automatically compares actual
            specifications against baseline values - specify efficient fittings throughout to
            maximise improvement percentage.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Efficient Sanitary Fittings">
          <p>
            ...
            efficiency credits. Each fitting type has baseline and best practice flow rates or flush
            volumes defined in the BREEAM methodology.
          </p>
          <p>
            <strong>Flow Rates and Flush Volumes</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>WC (single flush):</strong> 6.0 litres — 4.0 litres — Per flush volume
            </li>
            <li>
              <strong>WC (dual flush):</strong> 6.0 litres effective — 4.0 litres effective — (Full
              + 2 × Reduced) / 3
            </li>
            <li>
              <strong>Urinal (per bowl/hour):</strong> 7.5 litres — 0 litres (waterless) — Or
              demand-flush systems
            </li>
            <li>
              <strong>WHB tap:</strong> 6 l/min — 4 l/min — Flow restrictors or aerators
            </li>
            <li>
              <strong>Shower:</strong> 10 l/min — 6 l/min — Low-flow showerheads
            </li>
            <li>
              <strong>Kitchen tap:</strong> 12 l/min — 8 l/min — Higher flow needed for filling
            </li>
            <li>
              <strong>Bath:</strong> No flow limit — Volume limit — Based on bath capacity
            </li>
          </ul>
          <p>
            <strong>Flow Control Technologies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Effective Flush Volume Calculation Example</strong>
          </p>
          <p>
            <span>Dual flush WC:</span> 4.5 litre full / 3.0 litre reduced
          </p>
          <p>
            <span>Formula:</span> (Full + 2 × Reduced) / 3
          </p>
          <p>
            <span>Calculation:</span> (4.5 + 2 × 3.0) / 3 = 10.5 / 3 = 3.5 litres effective
          </p>
          <p>This meets the best practice (4.0L) requirement</p>
          <p>
            <strong>Best practice:</strong> Specify dual flush WCs with 4.5/3.0 litre or lower flush
            volumes - the effective flush of 3.5 litres meets the best practice threshold of 4.0
            litres.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Water Metering and Leak Detection">
          <p>
            ...
            management. These issues recognise that specifying efficient fittings alone is
            insufficient - buildings need monitoring systems to identify problems and verify actual
            consumption.
          </p>
          <p>
            <strong>Wat 02: Water Monitoring Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1 credit:</strong> Pulsed output meter on mains supply — Connected to BMS or
              data logger
            </li>
            <li>
              <strong>2 credits:</strong> Sub-metering of major water uses — WCs, kitchens, process
              uses, irrigation
            </li>
          </ul>
          <p>
            <strong>Metering System Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pulsed output meters:</strong> Typically 1 pulse per litre or 10 litres
              depending on flow range
            </li>
            <li>
              <strong>BMS integration:</strong> Pulse counting, data logging, alarm generation on
              abnormal consumption
            </li>
            <li>
              <strong>Sub-meters:</strong> Located on branches to WC cores, kitchens, plant rooms,
              external taps
            </li>
            <li>
              <strong>Data analysis:</strong> Capable of generating consumption reports and
              identifying trends
            </li>
          </ul>
          <p>
            <strong>Wat 03: Leak Detection Systems</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Metering Strategy Example - Office Building</strong>
          </p>
          ...
          <p>
            <strong>Integration tip:</strong> Specify leak detection sensitivity in the BMS
            functional specification - the system must be programmed to recognise sustained low
            flows (e.g., 1 l/min for 30 minutes) as potential leaks.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Water Recycling Systems">
          <p>
            Rainwater harvesting and greywater recycling systems can significantly reduce mains
            water consumption, contributing to higher Wat 01 credit achievement. These systems
            capture water that would otherwise be discharged and treat it for non-potable uses.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Source:</strong> Roof drainage from non-trafficked areas
            </li>
            <li>
              <strong>Collection:</strong> First flush diverter, filter, storage tank
            </li>
            <li>
              <strong>Treatment:</strong> Filtration, UV disinfection (optional)
            </li>
            <li>
              <strong>Uses:</strong> WC flushing, irrigation, cooling towers
            </li>
            <li>
              <strong>Mains backup:</strong> Type AA/AB air gap required
            </li>
          </ul>
          <p>
            <strong>Greywater Recycling</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Source:</strong> Showers, basins, baths (not kitchen)
            </li>
            <li>
              <strong>Collection:</strong> Separate drainage to treatment plant
            </li>
            <li>
              <strong>Treatment:</strong> Biological treatment, filtration, disinfection
            </li>
            <li>
              <strong>Uses:</strong> WC flushing, irrigation (sub-surface only)
            </li>
            <li>
              <strong>Standards:</strong> BS 8525-1 for greywater systems
            </li>
          </ul>
          <p>
            <strong>System Components Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Storage tank:</strong> Underground or above ground — Smaller, internal plant
              room
            </li>
            <li>
              <strong>Treatment level:</strong> Filtration + optional UV — Biological + filtration +
              disinfection
            </li>
            <li>
              <strong>Pump system:</strong> Header tank or direct pumped — Direct pumped with
              pressure set
            </li>
            <li>
              <strong>Maintenance:</strong> 6-monthly filter clean, annual inspection — Monthly
              checks, quarterly servicing
            </li>
            <li>
              <strong>Typical payback:</strong> 5-10 years — 8-15 years
            </li>
          </ul>
          <p>
            <strong>Rainwater Yield Calculation Example</strong>
          </p>
          <p>
            <span>Roof area:</span> 2,000 m2
          </p>
          <p>
            <span>Annual rainfall:</span> 800 mm (0.8 m)
          </p>
          <p>
            <span>Collection efficiency:</span> 80%
          </p>
          <p>
            <span>Calculation:</span> 2,000 x 0.8 x 0.8 = 1,280 m3/year
          </p>
          <p>
            <span>WC demand (200 people):</span> 200 x 6 flushes x 4L x 250 days = 1,200 m3/year
          </p>
          <p>Rainwater can supply approximately 100% of WC flushing demand</p>
          <p>
            <strong>Design Considerations for Recycled Water Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pipework marking:</strong> Non-potable pipework must be clearly identified
              (green with black text)
            </li>
            <li>
              <strong>Backflow prevention:</strong> Type AA or AB air gap for mains water backup
              connections
            </li>
            <li>
              <strong>Storage sizing:</strong> Balance between yield capture and demand matching
            </li>
            <li>
              <strong>Overflow:</strong> Connected to surface water drainage (not foul)
            </li>
            <li>
              <strong>Controls:</strong> Automatic switchover to mains when recycled water depleted
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Office building, 500 occupants, calculate water consumption
            improvement.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design stage:</strong> Completed BREEAM water calculator, sanitary fitting
              schedules, metering schematics
            </li>
            <li>
              <strong>Post-construction:</strong> Product data sheets confirming flow rates,
              commissioning records for meters
            </li>
            <li>
              <strong>Leak detection:</strong> System specification, commissioning certificate, BMS
              alarm configuration
            </li>
            <li>
              <strong>Water recycling:</strong> System design, treatment specification, mains backup
              arrangement
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              WHB tap baseline: <strong>6 l/min</strong>, best practice: <strong>4 l/min</strong>
            </li>
            <li>
              Shower baseline: <strong>10 l/min</strong>, best practice: <strong>6 l/min</strong>
            </li>
            <li>
              WC effective flush: <strong>(Full + 2 × Reduced) / 3</strong>
            </li>
            <li>
              Leak detection sensitivity: <strong>1 litre/minute</strong>
            </li>
            <li>
              Maximum credits (Wat 01): <strong>55% improvement = 5 credits</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Incorrect flush calculation:</strong> Using average instead of effective
                flush formula
              </li>
              <li>
                <strong>Missing sub-meters:</strong> Failing to meter all major water uses
              </li>
              <li>
                <strong>Inadequate leak detection:</strong> System cannot detect 1 l/min flows
              </li>
              <li>
                <strong>No mains backup:</strong> Recycled water systems without automatic
                switchover
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A residential block achieves 4 Wat 01 credits partly via a greywater recycling system
              (showers/baths to WCs and irrigation). At handover, the FM team discover the system
              has been bypassed — the GRP tank was not commissioned, manual valves are closed, and
              WCs are running on mains. The BREEAM Post-Construction assessment is in two weeks.
            </>
          }
          whatToDo={
            <>
              Investigate why bypassed — most often (1) commissioning never completed because
              filtration/UV had outstanding snags, (2) FM team unfamiliar with system and turned it
              off after a low-level alarm. Get the system commissioned, run a 2-week proving period
              with metered flow data, and provide the assessor with verified consumption data. If
              full commissioning is genuinely not achievable, the credit must be withdrawn, dropping
              the rating — flag immediately and discuss compensating credits with the assessor.
            </>
          }
          whyItMatters={
            <>
              Water recycling credits are high-risk because they depend on a working system at
              handover, not just an installed one. Many greywater and rainwater systems are bypassed
              within 18 months because of complexity, maintenance demand, or cost. The credit is
              worth 1–2 points; the system is worth nothing if it does not run.
            </>
          }
        />
