      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Wat 01:</strong> Up to 5 credits for water efficiency improvement
              </li>
              <li className="pl-1">
                <strong>Calculator:</strong> Compares building against baseline consumption
              </li>
              <li className="pl-1">
                <strong>Metering:</strong> Pulsed output meters connected to BMS
              </li>
              <li className="pl-1">
                <strong>Leak detection:</strong> Must detect flows as low as 1 litre/min
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Flow rates:</strong> WHB taps 6 l/min baseline, 4 l/min best practice
              </li>
              <li className="pl-1">
                <strong>WC flush:</strong> 6 litres baseline, 4 litres best practice
              </li>
              <li className="pl-1">
                <strong>Sub-metering:</strong> Required for major water uses
              </li>
              <li className="pl-1">
                <strong>Recycling:</strong> Rainwater and greywater systems
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The Water Consumption issue (Wat 01) is the primary credit-generating opportunity
              within the BREEAM Water category. It uses a standardised calculator methodology to
              compare the assessed building's predicted water consumption against a notional
              baseline building fitted with conventional sanitary components.
            </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Good practice fittings throughout
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Best practice + waterless urinals/recycled water
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                BREEAM Water Calculator Components
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Building data:</strong> Floor area, occupancy levels, operating hours by
                  use type
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Higher flow needed for filling
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                Effective Flush Volume Calculation Example
              </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Best practice:</strong> Specify dual flush WCs with 4.5/3.0 litre or lower
              flush volumes - the effective flush of 2.5 litres significantly exceeds the best
              practice threshold.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              insufficient - buildings need monitoring systems to identify problems and verify
              actual consumption.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Wat 02: Water Monitoring Requirements
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">1 credit</td>
                      <td className="border border-white/10 px-3 py-2">
                        Pulsed output meter on mains supply
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Connected to BMS or data logger
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">2 credits</td>
                      <td className="border border-white/10 px-3 py-2">
                        Sub-metering of major water uses
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        WCs, kitchens, process uses, irrigation
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>BMS integration:</strong> Pulse counting, data logging, alarm generation
                  on abnormal consumption
                </li>
                <li className="pl-1">
                  <strong>Sub-meters:</strong> Located on branches to WC cores, kitchens, plant
                  rooms, external taps
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p>---------|------------|--------</p>
                <p>
                  Incoming main | Pulsed output + leak detection | Total consumption + leak alert
                </p>
                ...
                <p className="mt-2 text-green-400">
                  Total: 5 meters providing full consumption breakdown
                </p>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Biological + filtration + disinfection
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Pump system</td>
                      <td className="border border-white/10 px-3 py-2">
                        Header tank or direct pumped
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Direct pumped with pressure set
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Maintenance</td>
                      <td className="border border-white/10 px-3 py-2">
                        6-monthly filter clean, annual inspection
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Monthly checks, quarterly servicing
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                Rainwater Yield Calculation Example
              </p>
              <div className="font-mono text-sm space-y-1">
                <p>
                ...
                <p className="text-green-400 mt-2">
                  Rainwater can supply approximately 100% of WC flushing demand
                </p>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Design Considerations for Recycled Water Systems
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Controls:</strong> Automatic switchover to mains when recycled water
                  depleted
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Water Calculator Assessment
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Sub-metering Strategy
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-green-400">
                  Verification: M1 = M2 + M3 + M4 + M5 + M6 (within tolerance)
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Rainwater System Sizing
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-green-400">
                  Supply ratio: 840 / (4.8 x 190) = 92% of WC demand
                </p>
                <p className="text-green-400">
                  Enter 774 m3 alternative water in BREEAM calculator
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Leak detection:</strong> System specification, commissioning certificate,
                  BMS alarm configuration
                </li>
                <li className="pl-1">
                  <strong>Water recycling:</strong> System design, treatment specification, mains
                  backup arrangement
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  WHB tap baseline: <strong>6 l/min</strong>, best practice:{' '}
                  <strong>4 l/min</strong>
                </li>
                <li className="pl-1">
                  Shower baseline: <strong>10 l/min</strong>, best practice:{' '}
                  <strong>6 l/min</strong>
                </li>
                <li className="pl-1">
                  WC effective flush: <strong>(Full + Reduced) / 3</strong>
                </li>
                <li className="pl-1">
