...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['3 months', '12 months', '6 months', '24 months'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1-2%', 'No retention is held', '10%', '2.5-5%'],
    correctAnswer: 3,
    explanation:
...
const HNCModule8Section6_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 6 · Subsection 6"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Client Training Requirements">
          ...
          <p>
            <strong>Training Programme Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Emergency procedures:</strong> Isolation, lock-off, and evacuation protocols
            </li>
            <li>
          ...
          <p>
            <strong>Training Audience and Content</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Building owner/client:</strong> Overview, key contacts, warranty arrangements
              — 1-2 hours
            </li>
            <li>
              <strong>FM manager:</strong> Comprehensive system operation, maintenance planning —
              1-2 days
            </li>
            <li>
              <strong>Maintenance technicians:</strong> Detailed operation, fault finding, safe
              isolation — 2-3 days
            </li>
            <li>
              <strong>Security/reception:</strong> Emergency procedures, basic BMS monitoring — 2-4
              hours
            </li>
            <li>
              <strong>General occupants:</strong> User controls, emergency evacuation — 30-60
              minutes
            </li>
          </ul>
          <p>
            <strong>Training Documentation Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Operational Handover and FM Team">
          <p>
            ...
            the FM team has the knowledge, documentation, and resources to operate the building
            safely.
          </p>
          <p>
            <strong>Handover Process Stages</strong>
          </p>
          <p>
            <strong>FM Team Handover Checklist</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>O&amp;M manuals:</strong> Complete, indexed, and project-specific — Main
              contractor
            </li>
            <li>
              <strong>As-built drawings:</strong> Full set reflecting actual installation — Main
              contractor
            </li>
            <li>
              <strong>Test certificates:</strong> EIC, commissioning records, witness tests —
              Sub-contractors
            </li>
            <li>
              <strong>Spare parts:</strong> Contractually specified spares with storage — Main
              contractor
            </li>
            <li>
              <strong>Access keys:</strong> All panel keys, lock-off devices, access cards — Main
              contractor
            </li>
            <li>
              <strong>Warranty documents:</strong> Equipment warranties with claim procedures —
              Sub-contractors
            </li>
            <li>
              <strong>Contact list:</strong> Emergency contacts, specialist suppliers — Main
              contractor
            </li>
          </ul>
          <p>
            <strong>Operational Demonstrations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Safety Briefings Required</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Defects Liability Period">
          <p>
            ...
            following practical completion during which the contractor must return to rectify
            defects that become apparent under normal use. For building services, this is typically
            12 months.
          </p>
          <p>
            <strong>Standard Defects Period</strong>
          </p>
          <p>
            <strong>12 months from practical completion</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Contractor's Obligations During DLP</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Respond to defect notices:</strong> Acknowledge and arrange inspection —
              Within 48 hours
            </li>
            <li>
              <strong>Rectify defects:</strong> Repair defects in workmanship/materials — Reasonable
              time
            </li>
            <li>
              <strong>Emergency response:</strong> Attend dangerous defects immediately — Within 4
              hours
            </li>
            <li>
              <strong>Update documentation:</strong> Amend as-builts if repairs require changes —
              With final account
            </li>
            <li>
              <strong>Seasonal commissioning:</strong> Return for heating/cooling season
              optimisation — As seasons occur
            </li>
          </ul>
          <p>Defects Covered</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Retention and Final Certificate</strong>
          </p>
          <p>
            <strong>At Practical Completion:</strong> Half of retention released (typically 2.5% of
            contract value retained)
          </p>
          <p>
            <strong>During DLP:</strong> Client notifies defects in writing; contractor rectifies
          </p>
          <p>
            <strong>At DLP End:</strong> Final inspection; making good of any outstanding defects
          </p>
          <p>
            <strong>Final Certificate:</strong> Issued after all defects rectified; remaining
            retention released
          </p>
          <p>
        ...
        <ConceptBlock title="Post-Occupancy Support and Soft Landings">
          ...
          <p>
            <strong>BSRIA Soft Landings Framework</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stage 1: Inception:</strong> RIBA Stage 1-2 — Set performance targets, define
              roles
            </li>
            <li>
              <strong>Stage 2: Design:</strong> RIBA Stage 3-4 — Review for operational efficiency,
              involve FM
            </li>
            <li>
              <strong>Stage 3: Pre-handover:</strong> Final 12 weeks — Commissioning, training
              preparation
            </li>
            <li>
              <strong>Stage 4: Initial Aftercare:</strong> First 4 weeks — Resident support, system
              fine-tuning
            </li>
            <li>
              <strong>Stage 5: Extended Aftercare:</strong> Years 1-3 — Seasonal commissioning, POE,
              reviews
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Functional performance:</strong> Does the building work for its intended use?
            </li>
            <li>
          ...
          <p>
            <strong>POE Timing and Activities</strong>
          </p>
          <p>
            <strong>12-Month POE</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>3-Year POE (Optional)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Government Soft Landings (GSL)</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Aftercare Support Arrangements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Helpdesk support:</strong> Telephone/email technical queries — 12 months
              minimum
            </li>
            <li>
              <strong>Site visits:</strong> Monthly review meetings reducing to quarterly — First 12
              months
            </li>
            <li>
              <strong>Seasonal commissioning:</strong> Heating and cooling season optimisation —
              First full year
            </li>
            <li>
              <strong>BMS support:</strong> Remote monitoring, setpoint adjustment — 12-24 months
            </li>
            <li>
              <strong>Extended warranty:</strong> Equipment manufacturer support — 2-5 years
            </li>
          </ul>
          <p>
            <strong>Performance gap:</strong> Studies show that buildings often consume 2-5 times
            more energy than design predictions. Soft Landings and POE help identify and close this
            performance gap.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Develop a training programme for a new office building with
            BMS-controlled lighting and HVAC.
          </p>
          ...
          <p>
            D004 | 22/09/24 | Office area | Underfloor heating | <span>Outstanding</span>
          </p>
          <p>
            D005 | 10/01/25 | Server room | UPS alarm fault | <span>Outstanding</span>
          </p>
          ...
          <p>
            - Controls usability: 3.1/5 <span>&lt;-- Action required</span>
          </p>
          <p>Key Findings:</p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>BS 8536-1:</strong> Briefing for design and construction (Code of practice)
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Late documentation:</strong> O&amp;M manuals arriving weeks after occupation
            </li>
            <li>
              <strong>Rushed training:</strong> Inadequate time for FM team to absorb information
            </li>
            <li>
            ...
            <li>
              <strong>No aftercare plan:</strong> Contractor disengages immediately after handover
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Documentation</div>
          </button>
          <button
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">HNC Module 9</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
