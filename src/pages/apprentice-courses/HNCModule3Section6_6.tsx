...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['kgCO₂/m²/year', 'lux/W', 'kWh/m²/year', 'W/m²K'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['CIBSE Guide F', 'CIBSE Guide A', 'CIBSE Guide M', 'CIBSE Guide L'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Regulation 311.1', 'Regulation 132.5', 'Regulation 433.1', 'Regulation 525.1'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Good', 'Excellent', 'Pass', 'Very Good'],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 8,
    question: 'How does Part L set the lighting energy efficiency requirement for LED circuits?',
    options: [
  ...
  },
  {
    ...
    options: ['Every 5 years', 'Every year', 'Every 7 years', 'Every 10 years'],
    correctAnswer: 1,
    explanation:
...
const HNCModule3Section6_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 6 · Subsection 6"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Approved Document L 2021 is the apex regulatory anchor for energy efficiency on UK BSE
              projects. As designer you orchestrate all the downstream evidence &mdash; SBEM/DSM TER
              vs BER calculation, motor IE class, lighting LENI, BMS controls strategy, transformer
              Tier-2 Ecodesign, commissioning M&amp;V &mdash; into one coherent submission that
              satisfies Building Control. CIBSE and BS 7671 give you the technical methodology; Part
              L is the statutory hook.
            </>
          }
        ...
        <ConceptBlock title="In 30 seconds">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>TER vs BER:</strong> Target vs actual CO₂ emissions
            </li>
            <li>
              <strong>CIBSE Guide L:</strong> Sustainability in building services
            </li>
            <li>
              <strong>BS 7671:</strong> Supporting efficient design principles
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Building Services Context</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sub-metering:</strong> Required for buildings over 1000m²
            </li>
            <li>
              <strong>BREEAM:</strong> Environmental assessment method
            </li>
            <li>
              <strong>DECs:</strong> Display Energy Certificates for public buildings
            </li>
            <li>
              <strong>Documentation:</strong> Design stage and as-built compliance
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Regulations Part L Overview">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Volume 2:</strong> New buildings other than dwellings - commercial/industrial
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Energy efficiency of fixed building services</strong> — Heating, cooling,
              lighting, ventilation — Meet minimum efficacy standards
            </li>
            <li>
              <strong>Controls for building services</strong> — Time, temperature, occupancy sensing
              — Appropriate control strategy
            </li>
            <li>
              <strong>Commissioning of systems</strong> — All fixed building services — CIBSE
              commissioning codes
            </li>
            <li>
              <strong>Energy metering</strong> — Buildings over 1000m² — Sub-metering by end-use
              category
            </li>
            <li>
              <strong>Information provision</strong> — Building owner/occupier — Building log book,
              O&M manuals
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>~31% reduction in carbon emissions compared to 2013 standards</li>
        ...
        <ConceptBlock title="Target Emission Rate (TER) vs Building Emission Rate (BER)">
          ...
          <p>
            The maximum CO₂ emission rate for a 'notional' reference building of the same size,
            shape and use. Calculated using SBEM or approved software.
          </p>
          ...
          <p>
            The actual calculated CO₂ emission rate for the proposed building design, based on
            specified fabric, systems and controls.
          </p>
          <p className="text-xs text-white mt-2">Unit: kgCO₂/m²/year</p>
          ...
          <p>The building emission rate must not exceed the target emission rate</p>

          <p className="text-sm font-medium text-elec-yellow/80">Additional Metrics</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>TFEE</strong> — Target Fabric Energy Efficiency - maximum fabric energy demand
              — kWh/m²/year
            </li>
            <li>
              <strong>DFEE</strong> — Dwelling Fabric Energy Efficiency - actual fabric performance
              — kWh/m²/year
            </li>
            <li>
              <strong>TPER</strong> — Target Primary Energy Rate - total primary energy target —
              kWh/m²/year
            </li>
            <li>
              <strong>BPER</strong> — Building Primary Energy Rate - actual primary energy use —
              kWh/m²/year
            </li>
          </ul>
        ...
        <ConceptBlock title="CIBSE Guide L: Sustainability">
          <p>
            ...
            engineering, covering environmental design principles, energy efficiency strategies, and
            the role of building services in achieving sustainable buildings.
          </p>

          <p className="text-sm font-medium text-white">Key CIBSE Guides for Energy Efficiency</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Guide L</strong> — Sustainability — Primary guide for sustainable building
              services design
            </li>
            <li>
              <strong>Guide F</strong> — Energy Efficiency in Buildings — Detailed energy benchmarks
              and calculation methods
            </li>
            <li>
              <strong>Guide A</strong> — Environmental Design — Thermal comfort, indoor environment
              criteria
            </li>
            <li>
              <strong>Guide M</strong> — Maintenance Engineering — Maintaining system efficiency
              over building lifetime
            </li>
            <li>
              <strong>TM54</strong> — Evaluating Operational Energy — Predicting actual energy use
              vs design calculations
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">CIBSE Guide L Key Topics</p>
          ...
          <p>
            <strong>Application:</strong> CIBSE guides provide the technical detail to support Part
            L compliance and go beyond minimum standards towards best practice sustainable design.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="BS 7671 Requirements for Efficiency">
          <p>
            ...
            includes several requirements that support energy efficient design. Understanding these
            provisions helps integrate safety and sustainability in electrical installations.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Relevant BS 7671 Regulations</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>132.5</strong> — Reasonably foreseeable influences — Include energy efficiency
              as a design consideration
            </li>
            <li>
              <strong>311.1</strong> — Maximum demand assessment — Prevents oversized supplies -
              reduces losses
            </li>
            <li>
              <strong>Chapter 55</strong> — Other equipment (BMS, controls) — Coordination with
              control and automation systems
            </li>
            <li>
              <strong>525</strong> — Voltage drop requirements — Ensures efficient power
              transmission
            </li>
            <li>
              <strong>314</strong> — Division of installation — Circuit separation enables
              sub-metering
            </li>
          </ul>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Regulation 525 - Voltage Drop</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Metering Requirements (Sub-Metering)">
          ...
          <p>
            Must provide sub-metering enabling at least 90% of estimated annual energy consumption
            to be assigned to end-use categories
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DIN rail kWh meter</strong> — Individual circuits in distribution boards —
              Pulse, Modbus, M-Bus
            </li>
            <li>
              <strong>CT operated meter</strong> — Larger loads, busbar systems — Pulse, Modbus,
              BACnet
            </li>
            <li>
              <strong>Multi-circuit meter</strong> — Multiple circuits from single device —
              Ethernet, cloud platform
            </li>
            <li>
              <strong>Smart meter</strong> — Main incomer (fiscal metering) — Half-hourly data to
              supplier
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Best Practice Metering Strategy</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Design distribution to group similar loads for efficient metering</li>
            <li>Connect meters to BMS for automatic data collection and trending</li>
            <li>Provide sufficient CT space in panels for future metering</li>
            <li>Use automatic meter reading (AMR) to enable analysis and reporting</li>
        ...
        <ConceptBlock title="BREEAM and Energy Credits">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Unclassified</strong> — &lt;30% — Below minimum standard
            </li>
            <li>
              <strong>Pass</strong> — ≥30% — Minimum acceptable performance
            </li>
            <li>
              <strong>Good</strong> — ≥45% — Standard commercial development
            </li>
            <li>
              <strong>Very Good</strong> — ≥55% — Good commercial practice
            </li>
            <li>
              <strong>Excellent</strong> — ≥70% — UK government requirement for public buildings
            </li>
            <li>
              <strong>Outstanding</strong> — ≥85% — Top 1% of buildings - exemplar projects
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Energy-Related BREEAM Credits</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ene 01</strong> — Reduction of energy use and carbon emissions — Efficient
              lighting, controls, low loss transformers
            </li>
            <li>
              <strong>Ene 02</strong> — Energy monitoring — Sub-metering installation, BMS
              integration
            </li>
            <li>
              <strong>Ene 03</strong> — External lighting — Efficient luminaires, controls, light
              pollution
            </li>
            <li>
              <strong>Ene 04</strong> — Low carbon design — Passive design analysis, energy strategy
            </li>
            <li>
              <strong>Ene 05</strong> — Energy efficient cold storage — Refrigeration controls,
              defrost management
            </li>
            <li>
              <strong>Ene 06</strong> — Energy efficient transportation — Efficient lifts and
              escalators, regenerative drives
            </li>
          </ul>
          ...
          <p>Credits awarded based on Energy Performance Ratio (EPR):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Minimum standards required for 'Excellent' and 'Outstanding'</li>
          </ul>
        ...
        <ConceptBlock title="Display Energy Certificates (DECs)">
          <p>
            ...
            reflect real operational performance and must be displayed prominently in the building.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">DEC Requirements</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>&gt;1000m²</strong> — Yes - mandatory — Annual — Every 7 years
            </li>
            <li>
              <strong>250-1000m²</strong> — Yes - mandatory — Every 10 years — Every 10 years
            </li>
            <li>
              <strong>&lt;250m²</strong> — Not required — - — -
            </li>
          </ul>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Public Buildings Requiring DECs</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Any building frequently visited by the public and over 250m²</li>
          </ul>
        ...
        <ConceptBlock title="Building Services: Compliance Documentation">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Design Stage Documentation</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BRUKL output (design)</strong> — Shows predicted TER/BER compliance — Before
              work commences
            </li>
            <li>
              <strong>Lighting design calculations</strong> — Demonstrates efficacy compliance —
              Design stage submission
            </li>
            <li>
              <strong>Control strategy</strong> — Documents automatic controls — Design stage
              submission
            </li>
            <li>
              <strong>Sub-metering schedule</strong> — Shows metering strategy — Design stage
              (buildings &gt;1000m²)
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BRUKL output (as-built)</strong> — Confirms final TER/BER compliance —
              SAP/SBEM assessor
            </li>
            <li>
              <strong>EPC certificate</strong> — Energy Performance Certificate — Accredited energy
              assessor
            </li>
            <li>
              <strong>Commissioning certificates</strong> — Proves systems commissioned to CIBSE
              codes — Commissioning engineer
            </li>
            <li>
              <strong>Building log book</strong> — Operating and maintenance information — Design
              team / contractor
            </li>
            <li>
              <strong>O&M manuals</strong> — System-specific operating instructions — Installing
              contractor
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">BRUKL Document Contents</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Building Log Book Contents</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            work to achieve compliance after construction is expensive and may not be possible. The
            design stage BRUKL output gives confidence that the proposed design will comply.
          </p>
        ...
        <ConceptBlock title="Worked Examples">
          <p className="text-sm font-medium text-elec-yellow/80">Example 1: Sub-Metering Design</p>
          <p>
            <strong>Question:</strong> A new 2500m² office building requires sub-metering. Annual
            energy consumption is estimated at 150,000 kWh. Design the metering strategy.
          </p>
          ...
          <p>
            Efficacy = 110 lm/W &gt; 95 lm/W <span className="text-green-400">✓ COMPLIANT</span>
          </p>
          ...
          <p>
            <strong>Question:</strong> A building achieves BER of 18 kgCO₂/m²/year against a TER of
            25 kgCO₂/m²/year. Calculate the improvement and estimated Ene 01 credits.
          </p>
          ...
          <p>(Exact credits depend on BREEAM version and EPR calculation)</p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Non-Domestic Building Services Compliance Guide:</strong> Technical standards
              for systems
            </li>
            <li>
              <strong>CIBSE Guide L:</strong> Sustainability in building services
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Verify lighting efficacy meets minimum standards for each space type</li>
            <li>Specify automatic controls: occupancy, daylight, time scheduling</li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 4500 m&sup2; commercial office on a 10-year lease has an EPC of D (rating 92). The
              landlord plans a refurbishment in 2026 with a 12-year forward-lease in mind. MEES
              Regulations require commercial leasehold to achieve EPC Band C by 1 April 2027. The
              BSE engineer is asked to design the electrical-services upgrades that get the building
              from D to C.
            </>
          }
          whatToDo={
            <>
              Three-track upgrade: (a) Lighting &mdash; full LED retrofit + presence / daylight
              controls + LENI evidence to BS EN 15193, typically delivers 15&ndash;20 EPC points on
              commercial offices; (b) Motors / drives &mdash; replace fan/pump motors with IE3+ on
              VSDs across HVAC plant, deliver cube-law saving + Part L compliance evidence; (c)
              Controls &mdash; BMS upgrade to G36 high-performance sequences for AHUs / VAVs,
              sub-meter lighting + small power per CIBSE TM39. Re-run SBEM with as-built data;
              target EPC B (more headroom for the 2030 step) not just C. Lodge the new EPC and
              update the building&rsquo;s log book.
            </>
          }
          whyItMatters={
            <>
              MEES is now actively enforced &mdash; landlords found leasing sub-Band-E commercial
              space face up to &pound;150k civil penalties. The 2027 step to C and 2030 step to B
              will affect ~85 % of UK commercial stock. The BSE engineer who designs the integrated
              electrical upgrades that hit the rating unlocks the building&rsquo;s lettability for
              the next decade.
            </>
          }
        />
