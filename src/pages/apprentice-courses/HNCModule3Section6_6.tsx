                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Meet minimum efficacy standards
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Controls for building services
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Time, temperature, occupancy sensing
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Sub-metering by end-use category
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Target Fabric Energy Efficiency - maximum fabric energy demand
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Dwelling Fabric Energy Efficiency - actual fabric performance
                      </td>
                      <td className="border border-white/10 px-3 py-2">kWh/m²/year</td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Target Primary Energy Rate - total primary energy target
                      </td>
                      <td className="border border-white/10 px-3 py-2">kWh/m²/year</td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Building Primary Energy Rate - actual primary energy use
                      </td>
                      <td className="border border-white/10 px-3 py-2">kWh/m²/year</td>
                    </tr>
                  </tbody>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Primary guide for sustainable building services design
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Detailed energy benchmarks and calculation methods
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Thermal comfort, indoor environment criteria
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Maintaining system efficiency over building lifetime
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Predicting actual energy use vs design calculations
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Reasonably foreseeable influences
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Include energy efficiency as a design consideration
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Prevents oversized supplies - reduces losses
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-mono">Chapter 55</td>
                      <td className="border border-white/10 px-3 py-2">
                        Other equipment (BMS, controls)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Coordination with control and automation systems
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Ensures efficient power transmission
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Circuit separation enables sub-metering
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Individual circuits in distribution boards
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Multiple circuits from single device
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Main incomer (fiscal metering)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Half-hourly data to supplier
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr className="bg-green-500/10">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        UK government requirement for public buildings
                      </td>
                    </tr>
                    <tr className="bg-yellow-500/10">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Top 1% of buildings - exemplar projects
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                    <tr className="bg-white/5">
                      ...
                      <th className="border border-white/10 px-3 py-2 text-left">Title</th>
                      <th className="border border-white/10 px-3 py-2 text-left">
                        Electrical Services Contribution
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Efficient lighting, controls, low loss transformers
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Sub-metering installation, BMS integration
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Efficient luminaires, controls, light pollution
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Passive design analysis, energy strategy
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Refrigeration controls, defrost management
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Efficient lifts and escalators, regenerative drives
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Shows predicted TER/BER compliance
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Demonstrates efficacy compliance
                      </td>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Confirms final TER/BER compliance
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Proves systems commissioned to CIBSE codes
                      </td>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Late engagement:</strong> Starting Part L calculations after design freeze
                </li>
                <li className="pl-1">
                  <strong>Control gaps:</strong> Specifying efficient luminaires but inadequate
                  controls
                </li>
                <li className="pl-1">
                  <strong>Metering omissions:</strong> Not designing sufficient sub-metering
                  circuits
                </li>
                <li className="pl-1">
                  <strong>Documentation gaps:</strong> Missing commissioning evidence at completion
                </li>
                <li className="pl-1">
                  <strong>Design vs reality:</strong> Installed equipment differs from BRUKL inputs
                </li>
              </ul>
            </div>
          </div>
