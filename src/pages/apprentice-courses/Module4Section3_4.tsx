...
const TITLE =
  'Cutting, Deburring, and Preparing Conduit Ends - Module 4.3.4 | Level 2 Electrical Course';
const DESCRIPTION =
  'Master essential cutting, deburring, and preparation techniques for PVC and metal conduit. Learn correct tools, safety measures, and quality checks for BS 7671 compliance.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Fine-toothed blades (24-32 TPI) provide clean cuts in PVC without cracking or tearing.',
  },
  {
    id: 3,
          ...
          <section className="mb-10">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-sm text-white">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    <strong>Spot:</strong> Conduit material, cutting requirements, joint types
                  </li>
                  <li>
                    <strong>Use:</strong> Correct tools, proper technique, thorough preparation
                  </li>
                  <li>
                    <strong>Check:</strong> Square cuts, smooth edges, cable test passed
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-blue-500/10 border-l-2 border-blue-500/50">
              <p className="text-sm text-white mb-4">
                ...
                and re-pulled, costing an entire day of labour.
              </p>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                ...
                rush these critical preparation steps - proper preparation prevents problems and
                ensures successful cable installation that meets BS 7671 requirements.
              </p>
            </div>
          </section>
