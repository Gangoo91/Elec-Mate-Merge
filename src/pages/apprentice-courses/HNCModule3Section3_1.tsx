...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Zero', '0.707 x Peak', '0.637 x Peak', 'Equal to RMS'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['1 cycle', '20 cycles', '4 cycles', '2 cycles'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['314 rad/s', '628 rad/s', '50 rad/s', '100 pi rad/s'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          RMS, average and peak values - understanding the sinusoidal waveforms that power building
          services
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS 7671 expresses voltage limits at equipment terminals in RMS values because product
              standards (BS EN 60898 for MCBs, BS EN 60947 for switchgear) are RMS-rated. As a BSE
              designer you must convert from peak only when checking insulation withstand (BS 7671
              443.4 / equipment data sheets) — not for the voltage-drop calculation in Appendix 4.
            </>
          }
        ...
        <ConceptBlock title="Sinusoidal AC Waveforms - Generation and Characteristics">
          <p>
            ...
            producing a voltage that varies sinusoidally with time. This is the fundamental
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cycle</strong> — One complete positive and negative alternation
            </li>
            <li>
              <strong>Period (T)</strong> — Time for one cycle: T = 1/f = 20ms at 50Hz
            </li>
            <li>
              <strong>Frequency (f)</strong> — Cycles per second: 50Hz in UK
            </li>
            <li>
              <strong>Angular frequency (omega)</strong> — Radians per second: omega = 2 pi f = 314
              rad/s
            </li>
            <li>
              <strong>Amplitude (Vm, Im)</strong> — Maximum value (peak) from zero
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Peak and RMS Values">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Single-phase half-cycle average: 207V — Three-phase line half-cycle average: 358V
            </li>
          </ul>
          <p>
            <strong>Mathematical Definition of RMS:</strong> VRMS = sqrt(1/T integral from 0 to T of
            v squared dt). For a sine wave, this evaluates to Vpeak/sqrt(2) = 0.707 x Vpeak.
          </p>
          <p>
        ...
        <ConceptBlock title="Average Value, Form Factor and Crest Factor">
          ...
          <p>
            <strong>Average Value (Half-Cycle):</strong> Vavg = 0.637 x Vpeak = (2/pi) x Vpeak. Only
            applies to half-cycle (rectified) waveforms.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Distorted sine — RMS/Peak: Varies, Form Factor: Not 1.11, Crest Factor: Greater than
              1.414
            </li>
          </ul>
          <p>
            <strong>Practical application:</strong> Comparing true RMS and average-responding meter
            readings can reveal waveform distortion. If they differ significantly, harmonics are
            present.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Applications in Building Services">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Average-responding (scaled) — Measures average, scales by 1.11. Best for: Pure
              sinusoidal supplies
            </li>
            <li>
              True RMS — Calculates actual RMS mathematically. Best for: Any waveform, VSDs, LEDs
            </li>
            <li>Peak-reading — Captures maximum value. Best for: Transient detection, surges</li>
            <li>
              Moving coil (analogue) — Responds to average DC value. Best for: DC only (needs
              rectifier for AC)
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>LED lighting:</strong> Switch-mode drivers draw non-sinusoidal current - true
              RMS meters essential
            </li>
            <li>
            ...
            <li>
              <strong>Insulation testing:</strong> Test voltages must consider peak values (500V DC
              test is comparable to 354V AC RMS)
            </li>
            <li>
              <strong>Harmonic surveys:</strong> Form factor deviation from 1.11 indicates harmonic
              content
            </li>
            <li>
          ...
          <p>
            <strong>Energy Meter Operation:</strong> Building energy meters measure real power (kW)
            and energy (kWh) using voltage and current transformers. They sample instantaneous v and
            i, multiply them, and integrate over time to give true energy consumption regardless of
            waveform distortion. Modern meters also measure kVA (apparent power), kVAr (reactive
            power), power factor, and total harmonic distortion (THD).
          </p>
          <p>
          ...
          <p>
            ...
            LED or VSD loads, always use true RMS instruments for measurements and consider harmonic
            filters if THD exceeds 5%.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Vpeak = VRMS x sqrt(2) = 230 x 1.414 = <strong>325V</strong>
            </li>
            <li>
              Vp-p = 2 x Vpeak = 2 x 325 = <strong>650V</strong>
            </li>
            <li>
              Vavg (half-cycle) = 0.637 x Vpeak = 0.637 x 325 = <strong>207V</strong>
            </li>
          </ul>
          <p>
            <strong>Example 2: Finding Peak from RMS Current.</strong> A circuit draws 13A RMS. What
            is the peak current and what current capacity must the cable withstand?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Ipeak = IRMS x sqrt(2) = 13 x 1.414 = <strong>18.4A</strong>
            </li>
          ...
          <p>
            <strong>Example 3: Form Factor Verification.</strong> A true RMS meter reads 228V while
            an average-responding meter reads 243V on the same circuit. What does this indicate?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              VL(RMS) = 400V — VL(peak) = 400 x 1.414 = <strong>566V</strong>
            </li>
            <li>
              VP(RMS) = 400 / sqrt(3) = 231V — VP(peak) = 231 x 1.414 = <strong>327V</strong>
            </li>
        ...
        <Scenario
          ...
          situation={
            <>
              You are commissioning a 240-luminaire LED retrofit on a single 100 A three-phase
              distribution board. Your average-responding multimeter reads 238 V on L1 but the
              energy meter logs the same circuit at 230 V true-RMS. The Class C LED drivers draw
              heavily distorted current (5th and 7th harmonics typical 25&ndash;40 %).
            </>
          }
          whatToDo={
            <>
              Switch to a true-RMS meter for every voltage and current reading on this board (Fluke
              87V, Megger DCM340 or equivalent). Record line current with a clamp meter that
              supports true-RMS bandwidth to at least the 13th harmonic. Compare true-RMS phase
              currents to the neutral current — if the neutral exceeds 1.0&times; phase current you
              have triplen aggregation and need to size the neutral up under BS 7671 Appendix 4 /
              IEC 61000-3-2 considerations.
            </>
          }
          whyItMatters={
            <>
              An average-responding meter is calibrated for a pure sine form factor of 1.11. A 25 %
              THD waveform throws the reading off by 5&ndash;10 %. That can mean you sign off a
              board as compliant when the true neutral current is already above its design rating,
              leading to overheating, RCBO nuisance tripping and breach of BS 7671 132.2.1
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Section 2.7</div>
          </button>
          <button
