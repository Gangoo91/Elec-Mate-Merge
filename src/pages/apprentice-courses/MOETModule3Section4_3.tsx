      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Ring final:</strong> 2.5 mm² cable, 32 A MCB, cable returns to origin
              </li>
              <li className="pl-1">
                <strong>Radial:</strong> 2.5 mm² (20 A) or 4.0 mm² (32 A), terminates at last point
              </li>
              <li className="pl-1">
                <strong>Spurs:</strong> One non-fused spur per point on the ring; unlimited fused
                spurs
              </li>
              <li className="pl-1">
                <strong>RCD protection:</strong> 30 mA RCD required for all sockets up to 32 A
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              ...
              <li className="pl-1">
                <strong>BS EN 60309-2:</strong> Industrial plugs and sockets (commando)
              </li>
              <li className="pl-1">
                <strong>ST1426:</strong> Install, test and maintain power circuits
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                ...
                current-carrying capacity depending on the installation method. This is why ring
                continuity testing is essential during periodic inspection and testing.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Maintenance tip:</strong> Always carry out the ring continuity test during
              periodic inspection to verify the ring is intact. Breaks are commonly found at socket
              outlets where connections have loosened or where previous alterations have been made
              incorrectly.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  May supply one single or one twin socket outlet, or one fused connection unit
                </li>
                <li className="pl-1">One non-fused spur per point on the ring</li>
                <li className="pl-1">
                  Total non-fused spurs must not exceed the number of points on the ring
                </li>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Connected via a fused connection unit (FCU) containing a BS 1362 fuse
                </li>
                <li className="pl-1">Any number of fused spurs may be connected to the ring</li>
                <li className="pl-1">
                  Cable on the load side can be reduced (e.g., 1.0 mm² for a 3 A fuse)
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  FCU can be switched or unswitched, with or without a neon indicator
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Fused Connection Unit (FCU) Applications
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Boilers and heating controls:</strong> Switched FCU with 3 A fuse —
                  provides local isolation
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Under-counter lights:</strong> Unswitched FCU with 3 A fuse — controlled
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> When adding a socket outlet to an existing ring circuit,
              always check whether the point you are connecting from is already a spur. Connecting a
              spur from a spur creates an unprotected extension and is a non-compliance with BS
              7671.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  All socket outlets with rated current not exceeding 32 A (all locations)
                </li>
                <li className="pl-1">
                  Mobile equipment with rated current not exceeding 32 A for outdoor use
                </li>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> RCBOs (combined MCB and RCD in a single device) are
              increasingly preferred over split-load consumer units because they provide individual
              circuit RCD protection without the risk of nuisance tripping affecting other circuits.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                R1+R2 Ring Continuity Test Procedure
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Step 1:</strong> Isolate the circuit and confirm dead. Disconnect both
                  ends of the ring from the consumer unit
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Step 5:</strong> Cross-connect: line of one end to neutral of the other
                  end, and vice versa
                </li>
                <li className="pl-1">
                  <strong>Step 6:</strong> Measure resistance at each socket outlet — this gives
                  R1+Rn (should be approximately r1+rn / 4)
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                ...
                radial circuits connected at the consumer unit to appear as a ring). All of these
                are potentially dangerous and must be rectified.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>ST1426 link:</strong> The maintenance technician standard requires competence
              in testing ring final circuits, interpreting results, and identifying defects. You
              must be able to carry out the full ring continuity test procedure and explain the
              results.
            </p>
          </div>
        </section>
