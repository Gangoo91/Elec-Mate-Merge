...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['3.5 - 4.5', '2.0 - 3.0', '10.0 - 12.0', '5.0 - 8.0'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['R-32 (GWP 675)', 'R-290 (GWP 3)', 'R-134a (GWP 1430)', 'R-410A (GWP 2088)'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['GWP < 750', 'GWP < 150', 'No limit applies', 'GWP < 2500'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['1.0 (no diversity)', '0.7 - 0.85', '0.9 - 0.95', '0.5 - 0.6'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Less than 1 year', 'Over 10 years', '5-7 years', '2-4 years'],
    correctAnswer: 3,
    explanation:
...
const HNCModule8Section3_5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 3 · Subsection 5"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Cooling Load Calculations">
          ...
          <p>
            <strong>Cooling Load Components:</strong>
          </p>
          ...
          <p>
            <strong>CIBSE Load Calculation Methods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Simple (CIBSE Guide A):</strong> Small, simple buildings — ±20%
            </li>
            <li>
              <strong>Admittance method:</strong> General commercial buildings — ±10-15%
            </li>
            <li>
              <strong>Dynamic simulation (TM54):</strong> Complex or critical buildings — ±5-10%
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Typical Internal Heat Gains</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Occupants (office):</strong> 90-150 W/person (sensible + latent) — 0.7-0.85
            </li>
            <li>
              <strong>LED lighting:</strong> 8-12 W/m² — 0.8-0.9
            </li>
            <li>
              <strong>Office equipment:</strong> 15-25 W/m² (general office) — 0.7-0.85
            </li>
            <li>
              <strong>Data/comms rooms:</strong> 500-2000 W/m² — 0.9-1.0
            </li>
          </ul>
          <p>
            <strong>Peak Load vs Annual Energy</strong>
          </p>
          <p>
        ...
        <ConceptBlock title="System Comparison: DX vs Chilled Water">
          ...
          <p>
            <strong>System Comparison Matrix</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Typical building size:</strong> &lt; 10,000 m² — &gt; 5,000 m² (preferred &gt;
              10,000 m²)
            </li>
            <li>
              <strong>Capital cost:</strong> Lower for small systems — Lower per kW for large
              systems
            </li>
            <li>
              <strong>Refrigerant distribution:</strong> Throughout building — Confined to plant
              room
            </li>
            <li>
              <strong>Zone control:</strong> Good (VRF excellent) — Excellent with FCUs
            </li>
            <li>
              <strong>Response time:</strong> Fast (minutes) — Slower (thermal mass)
            </li>
            <li>
              <strong>Maintenance access:</strong> Distributed (ceiling void) — Centralised plant
              room
            </li>
            <li>
              <strong>Redundancy:</strong> Per zone/unit — N+1 at central plant
            </li>
            <li>
              <strong>Part load efficiency:</strong> VRF: Excellent — Good with VSD and staging
            </li>
          </ul>
          <p>
            <strong>DX Systems - Best For</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Chilled Water - Best For</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Seasonal Efficiency Ratings</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single split (&lt; 12 kW):</strong> 4.0 - 6.5 — SEER &gt; 4.0
            </li>
            <li>
              <strong>Multi-split system:</strong> 4.5 - 7.0 — SEER &gt; 4.3
            </li>
            <li>
              <strong>VRF/VRV system:</strong> 5.0 - 8.0 — SEER &gt; 4.5
            </li>
            <li>
              <strong>Air-cooled chiller:</strong> 2.8 - 4.0 (EER) — SEER &gt; 3.0
            </li>
            <li>
              <strong>Water-cooled chiller:</strong> 5.0 - 7.5 (EER) — SEER &gt; 4.5
            </li>
          </ul>
          <p>
            <strong>Understanding SEER vs EER vs COP</strong>
          </p>
          <p>
            <strong>COP (Coefficient of Performance):</strong> Instantaneous efficiency at specific
            conditions (e.g., 35°C outdoor)
          </p>
          <p>
            <strong>EER (Energy Efficiency Ratio):</strong> Cooling capacity (BTU/h) ÷ power input
            (W) at rated conditions
          </p>
          <p>
          ...
          <p>
            SEER is most meaningful for comparing systems as it reflects real-world performance
        ...
        <ConceptBlock title="Life Cycle Cost Analysis">
          ...
          <p>
            <strong>Life Cycle Cost Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Capital (equipment + install):</strong> 15-25% — System type, capacity,
              complexity
            </li>
            <li>
              <strong>Energy consumption:</strong> 60-80% — SEER, operating hours, tariff
            </li>
            <li>
              <strong>Planned maintenance:</strong> 5-10% — Service frequency, access difficulty
            </li>
            <li>
              <strong>Reactive maintenance:</strong> 3-8% — Reliability, parts availability
            </li>
            <li>
              <strong>Replacement/disposal:</strong> 2-5% — Refrigerant recovery, disposal costs
            </li>
          </ul>
          <p>
            <strong>Net Present Value Calculation</strong>
          </p>
          ...
          <p>
            <strong>LCC Example: DX vs Chilled Water for 5,000 m² Office</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cooling load:</strong> 400 kW — 400 kW
            </li>
            <li>
              <strong>Capital cost:</strong> £320,000 — £380,000
            </li>
            <li>
              <strong>SEER:</strong> 6.5 — 5.0 (system)
            </li>
            <li>
              <strong>Annual energy (1,500 EFLHs):</strong> 92,300 kWh — 120,000 kWh
            </li>
            <li>
              <strong>Annual energy cost (£0.30/kWh):</strong> £27,700 — £36,000
            </li>
            <li>
              <strong>Annual maintenance:</strong> £12,000 — £15,000
            </li>
            <li>
              <strong>20-year NPV (5% discount):</strong> £815,000 — £1,015,000
            </li>
          </ul>
          <p>
            Note: This example shows VRF advantage at this scale. Results vary significantly with
            building size, operating hours, and energy costs. Always perform project-specific
            analysis.
          </p>
          <p>
            <strong>Sensitivity Analysis Factors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Operating hours:</strong> Test reduced hours (COVID effect) and extended hours
            </li>
            <li>
          ...
          <p>
            ...
            system can justify 30-40% higher capital cost whilst still providing lower total cost of
            ownership.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Sustainability and Selection Criteria">
          <p>
            ...
            regulations, carbon reduction targets, and building certification schemes. These factors
            increasingly influence both regulatory compliance and market value.
          </p>
          <p>
            <strong>Refrigerant Selection and F-gas Compliance</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>R-410A:</strong> 2088 — A1 (non-flammable) — Being phased out for new systems
            </li>
            <li>
              <strong>R-32:</strong> 675 — A2L (mildly flammable) — Splits, VRF (preferred for &lt;3
              kg)
            </li>
            <li>
              <strong>R-290 (propane):</strong> 3 — A3 (flammable) — Small systems (&lt;500g charge)
            </li>
            <li>
              <strong>R-1234ze:</strong> 7 — A2L (mildly flammable) — Chillers, large systems
            </li>
            <li>
              <strong>R-513A:</strong> 631 — A1 (non-flammable) — Chillers (R-134a replacement)
            </li>
          </ul>
          <p>
            <strong>F-gas Regulation Key Dates</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>2027:</strong> All splits and multi-splits must use GWP &lt;750 refrigerants
            </li>
            <li>
              <strong>Ongoing:</strong> Phase-down of HFC quotas reducing availability of high-GWP
              refrigerants
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Minimum efficiency:</strong> Systems must meet SEER minimums per Non-Domestic
            ...
            <li>
              <strong>Controls:</strong> Time and temperature control required, optimum start/stop
              for larger systems
            </li>
            <li>
          ...
          <p>
            <strong>BREEAM Credits for Cooling Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ene 01:</strong> Energy performance (EPR improvement) — Up to 15
            </li>
            <li>
              <strong>Ene 02:</strong> Sub-metering of major energy uses — Up to 2
            </li>
            <li>
              <strong>Ene 04:</strong> Low and zero carbon technologies — Up to 5
            </li>
            <li>
              <strong>Pol 01:</strong> Refrigerant GWP &lt;10 (exemplary) — Up to 3
            </li>
            <li>
              <strong>Man 04:</strong> Seasonal commissioning — Up to 4
            </li>
          </ul>
          <p>
            <strong>System Selection Decision Matrix</strong>
          </p>
          ...
          <p>
            <strong>Commercial Factors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Future-Proofing Considerations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Grid integration:</strong> Enable demand response and smart grid connection
            </li>
            <li>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Terminal units</div>
          </button>
          <button
