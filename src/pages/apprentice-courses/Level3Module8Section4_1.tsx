...
const DESCRIPTION =
  'Learn to analyse your mock exam scores effectively. Understand what your results mean, identify patterns, and use score data to guide targeted revision.';
...
const quickCheckQuestions = [
  {
    id: 'check-1',
    question:
      'You scored 68% on a mock exam. According to typical pass criteria, where does this place you?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'With typical pass marks around 65%, a 68% score is borderline - technically passing but only 3% above the threshold. This provides little safety margin for exam day variation. Aim for 75%+ to ensure a comfortable pass.',
  },
  {
    id: 'check-2',
    question:
      'What does it mean if you consistently score well on knowledge questions but poorly on calculation questions?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'Consistent patterns reveal specific areas needing work. Strong knowledge scores show good understanding; weak calculation scores indicate need for formula practice, method revision, or more worked examples. Address weaknesses specifically.',
  },
  {
    id: 'check-3',
    question:
      'You scored 85% but got 3 questions about RCD testing wrong. What should your priority be?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      "Even with high overall scores, consistently missing the same topic reveals a knowledge gap. RCD testing questions on the real exam won't be the same ones - you need to understand the topic properly. A high score overall doesn't mean every topic is secure.",
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      "Tracking both overall scores and topic breakdowns reveals trends: improving areas, persistent weaknesses, and whether your study is effective. This data guides future revision. Single scores or pass/fail alone doesn't show the full picture.",
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      "What is typically considered a 'safe' mock exam score to aim for before the real exam?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Aim for 10%+ above pass mark to account for exam day variation, nerves, unfamiliar questions, and the fact mock exams may not perfectly match real exam difficulty. A 75%+ score typically indicates solid preparation.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Analysing by question difficulty reveals if your fundamentals are strong (easy questions correct) and if you can handle complexity (hard questions correct). Getting easy ones wrong but hard ones right might indicate carelessness; opposite pattern suggests knowledge gaps in advanced topics.',
  },
  {
    id: 3,
    question:
      "You've taken three mock exams and scored 55%, 62%, 68%. What does this trend suggest?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "A clear upward trend (55% to 68%) indicates effective revision. You're learning from mistakes and building knowledge. Continue your approach while targeting remaining weak areas. This is positive progress.",
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      'Plateaued scores suggest your current approach has taken you as far as it can. You need different strategies: deeper learning (not just memorising), addressing persistent weak topics specifically, or trying different revision methods (active vs passive).',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Overall scores can hide significant weaknesses. You might score 75% overall but only 40% on earthing - a critical safety topic. Topic analysis reveals these hidden gaps so you can address them specifically rather than general revision.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      "Reviewing correct answers confirms understanding and catches lucky guesses. If you got a question right but aren't sure why, you might miss a similar question phrased differently. Confirming correct answers reinforces learning.",
  },
  {
    id: 7,
    question:
      'What does it indicate if your score decreases significantly from one mock to the next?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Score drops can result from multiple factors: the second mock may have covered topics you're weaker in, you may have been tired or stressed, or it may be random variation. Analyse the specific questions missed to understand the cause.",
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Scoring exactly at pass mark is risky. Real exam conditions (stress, unfamiliar venue, different questions) can easily cause performance variation. A borderline mock score could translate to either pass or fail on the actual exam. Build more margin.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      "Error pattern analysis identifies recurring mistake types: misreading questions, calculation errors, time pressure mistakes, specific topic gaps. Identifying patterns allows targeted correction - it's more effective than just 'study more'.",
  },
  {
    id: 10,
    question:
      "Why might you score lower on a mock exam that's more realistic (timed, exam conditions)?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Untimed practice allows unlimited thinking time that won't exist in real exams. Timed mock exams under exam conditions reveal your true likely performance. Lower scores here are valuable data - they show what you need to work on for real exam conditions.",
  },
  {
    id: 11,
    question:
      'What action should follow identifying a consistently weak topic across multiple mocks?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Consistently weak topics need targeted attention. Use different resources (textbooks, videos, practice questions, discussion) to attack from multiple angles. Don't hope it won't appear - exams often feature questions on fundamental topics.",
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      "Score analysis should actively guide revision: allocate more time to weak areas, but don't neglect strong areas (they need maintenance). Update your plan based on data. This evidence-based approach is more effective than generic study.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Aim for at least 3-5 full mock exams under timed conditions, plus additional topic-specific practice. Space them out to allow for learning between attempts. The last mock should be 3-5 days before the real exam, leaving time to address any final weak areas.',
  },
  {
    question: 'My mock scores vary a lot - is that normal?',
    answer:
      'Some variation is normal (5-10%) due to topic coverage, question difficulty, and your state on the day. Large variation (15%+) may indicate inconsistent knowledge - you know some areas well but have gaps. Focus on building consistent competence across all topics.',
  },
  {
    question: 'Should I be concerned if mock exams are easier than I expected?',
    answer:
      "Yes - mock exams that seem easy may not adequately prepare you. Ensure you're using realistic mock exams from reputable sources that match exam format and difficulty. If mocks are too easy, you may be overconfident about your readiness.",
  },
  {
    question: 'How do I know if my mock exam scores accurately predict real exam performance?',
    answer:
      'Mock exams best predict real performance when they: match the real exam format, cover similar content, are completed under timed conditions, and come from reputable sources. Self-marked open-book practice is less predictive than supervised timed mocks.',
  },
  {
    question: "I keep getting the same topic wrong - why can't I improve?",
    answer:
      'Persistent errors in one topic usually mean your foundational understanding is flawed, not just facts missing. Go back to basics: read explanatory material, watch videos, work through examples step-by-step. Understand WHY before memorising WHAT.',
  },
  {
    question: 'Is it better to have high scores on a few mocks or consistent scores on many?',
    answer:
      'Consistency across many mocks is more valuable. A single high score might be luck; consistent 75%+ across 5+ mocks shows reliable competence. Take enough mocks to establish a pattern - then you know your true performance level.',
  },
];
...
const scoreBands = [
  {
    ...
    action:
      'Return to foundational learning. Use structured resources, not just practice questions.',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Target:</strong> 75%+ for comfortable pass (65% minimum)
              </li>
              <li>
                <strong>Analyse:</strong> By topic and question type, not just overall
              </li>
              <li>
                <strong>Track:</strong> Scores over time to measure progress
              </li>
              <li>
                <strong>Act:</strong> Use analysis to guide targeted revision
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Consistent topic weaknesses across mocks
              </li>
              <li>
                <strong>Use:</strong> Topic breakdown to find specific gaps
              </li>
              <li>
                <strong>Apply:</strong> Direct more revision time to weak areas
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Raw scores only tell part of the story. Understanding what different score levels mean
              - in terms of exam readiness and required action - helps you interpret your results
              meaningfully. Don't just celebrate passing or despair at failing; understand what your
              score indicates about your preparation.
            </p>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-elec-yellow/20 my-6">
              ...
              <p className="text-xs text-white">
                ...
                score often translates to borderline or failing real exam results.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Important Context:</strong> These bands assume mock exams of similar
              difficulty to the real exam. Easier mock exams may inflate your apparent readiness.
              Use official or quality third-party mock exams for accurate assessment.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Overall scores can hide significant topic-level weaknesses. Breaking down your
              performance by topic reveals specific areas needing attention. A candidate scoring 72%
              overall might score 90% on some topics but only 45% on others - the overall score
              hides a serious gap.
            </p>

            <div className="p-4 rounded-lg bg-transparent border border-white/10 my-6">
              <p className="text-sm font-medium text-white mb-3">
                Example Topic Breakdown Analysis:
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Single mock exam scores have limited meaning - they could reflect your true ability,
              an easy/hard paper, or your state on that day. Tracking scores over multiple attempts
              reveals meaningful trends: is your revision working? Are you improving? Have you
              plateaued?
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white">
                    ...
                    same won't produce different results.
                  </p>
                </div>
              </div>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70 mt-4">
              <strong>Minimum Data Points:</strong> You need at least 3 mock exam scores to identify
              a meaningful trend. One high or low score could be anomaly. Consistent patterns across
              multiple attempts are significant.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Score analysis is only valuable if it informs action. Converting insights into
              specific revision changes is the critical step. Vague intentions ('study more') are
              less effective than specific plans ('spend 30 minutes daily on earthing
              calculations').
            </p>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-elec-yellow/20 my-6">
              ...
              <ol className="text-xs text-white space-y-2">
                ...
                <li>
                  <strong>2. Prioritise:</strong> Rank weak areas by importance (weight in exam,
                  severity of gap).
                </li>
                <li>
                  <strong>3. Allocate:</strong> Assign specific time blocks to priority weak areas.
                </li>
                <li>
                  <strong>4. Select:</strong> Choose appropriate resources for each weak area.
                </li>
                <li>
                  <strong>5. Implement:</strong> Follow the plan consistently for 1-2 weeks.
                </li>
                <li>
                  <strong>6. Retest:</strong> Take another mock to measure improvement.
                </li>
                <li>
                  <strong>7. Iterate:</strong> Adjust plan based on new results.
                </li>
              </ol>
            </div>
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-transparent border border-white/10">
                ...
                <ul className="text-xs text-white space-y-1">
                  ...
                  <li>
                    <strong>Action 1:</strong> Re-read textbook chapter on earthing systems (Day
                    1-2)
                  </li>
                  <li>
                    <strong>Action 2:</strong> Watch video tutorial on earthing arrangements (Day 3)
                  </li>
                  <li>
                    <strong>Action 3:</strong> Complete 30 earthing-specific practice questions (Day
                    4-6)
                  </li>
                  <li>
                    <strong>Action 4:</strong> Create comparison diagram of earthing systems (Day 7)
                  </li>
                  <li>
                    <strong>Retest:</strong> Topic test on Day 8, full mock on Day 10
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Knowledge gap:</strong> Didn't know the content - needs study
                </li>
                <li>
                  <strong>Careless error:</strong> Knew but made silly mistake - needs care
                </li>
                <li>
                  <strong>Time pressure:</strong> Ran out of time - needs pacing practice
                </li>
                <li>
                  <strong>Misread question:</strong> Answered wrong question - needs reading
                  technique
                </li>
                <li>
                  <strong>Calculation error:</strong> Method correct, arithmetic wrong - needs
                  checking
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <div className="p-5 rounded-lg bg-transparent border border-elec-yellow/20">
            <h3 className="text-sm font-medium text-white mb-4">
              Quick Reference - Score Analysis
            </h3>
