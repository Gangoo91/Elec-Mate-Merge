      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <header className="mb-6 sm:mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 rounded-lg bg-card">
              <ShieldX className="w-6 h-6 text-foreground" />
            </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Common Causes of Cable Damage During Installation</h3>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Mechanical Damage Sources</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Abrasion damage mechanisms:</strong></p>
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Crushing and impact prevention:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Bend Radius and Tension Control</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Minimum bend radius requirements:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Pulling tension control methods:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Environmental and Chemical Damage</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Temperature damage prevention:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Chemical and UV protection:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Protection During Handling and Storage</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Drum storage specifications:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Physical protection measures:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Drum handling specifications:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Pre-installation inspection criteria:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Protection During Cable Pulling Operations</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">Mechanical Protection Systems</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Cable roller installation:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Entry and exit point protection:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">Pulling Lubricant Application and Techniques</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Lubricant selection and application:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Tension monitoring and control:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">Environmental Control and Timing</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Temperature and timing considerations:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Support during vertical installations:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Protection During Installation in Containment</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Support System Design and Spacing</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>BS 7671 Table 4A2 support spacing:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Cleat selection and installation:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Installation Quality Control and Documentation</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Installation quality standards:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Documentation and compliance:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Compliance with BS 7671 and Industry Standards</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-red-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-red-600 dark:text-emerald-400 mb-1">BS 7671 Regulatory Requirements</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Specific regulation compliance:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Manufacturer datasheet compliance:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-4">Real-World Example: Industrial Cable Tray Damage Incident</h2>
          
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 mb-4">
            <div>
              <h3 className="font-semibold text-foreground mb-2">The Incident</h3>
            ...
            <div>
              <h3 className="font-semibold text-foreground mb-2">Discovery and Cost Impact</h3>
              <p className="text-xs sm:text-sm text-foreground mb-3">
          ...
          <div className="bg-muted/50 p-4 rounded-lg">
            <h3 className="font-semibold text-foreground mb-2">Prevention Analysis</h3>
            <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
              <div>
                <p className="font-medium text-foreground mb-1">Required Prevention</p>
              ...
              <div>
                <p className="font-medium text-foreground mb-1">Actual Remedial Cost</p>
                <ul className="text-xs text-foreground space-y-1">
              ...
              <div>
                <p className="font-medium text-foreground mb-1">Return on Investment</p>
                <ul className="text-xs text-foreground space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold text-foreground mb-2">Q: Are cable cleats always necessary for electrical installations?</h3>
              <p className="text-xs sm:text-sm text-foreground">
            ...
            <div>
              <h3 className="font-semibold text-foreground mb-2">Q: Can damaged cable sheathing be repaired with electrical tape?</h3>
              <p className="text-xs sm:text-sm text-foreground">
            ...
            <div>
              <h3 className="font-semibold text-foreground mb-2">Q: How do I determine the correct bend radius for any cable type?</h3>
              <p className="text-xs sm:text-sm text-foreground">
            ...
            <div>
              <h3 className="font-semibold text-foreground mb-2">Q: What should I do if pulling tension limits are exceeded during installation?</h3>
              <p className="text-xs sm:text-sm text-foreground">
