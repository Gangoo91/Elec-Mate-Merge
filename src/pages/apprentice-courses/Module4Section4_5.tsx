...
const DESCRIPTION =
  'Master professional cable damage prevention techniques during installation. Learn protection methods, handling procedures, and BS 7671 compliance for safe electrical installations.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'To allow for future thermal expansion of the cable',
      'To reduce the number of fixings needed along the run',
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'What is the main risk of over-tightening a cable tie or clip?',
    options: [
      'It can crush the cable insulation and conductors',
      'It increases the resistance of the conductor',
      'It reduces the current-carrying capacity of the cable',
      'It causes the cable to overheat under load',
    ],
    correctAnswer: 0,
    explanation:
      'Cable ties should not be over-tightened as this can crush the cable insulation and damage conductors.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    options: [
      'Reduced current-carrying capacity due to compression',
      'Damage to insulation and conductor stretching',
      'Increased bend radius at containment changes',
      'Loss of the cable sheath colour identification',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Coiled flat on the floor in the work area',
      'Laid loosely across other building materials',
      'On drums or reels, kept off the ground',
      'Stacked upright against an external wall',
    ],
    correctAnswer: 2,
    explanation:
      'Cables should be stored on drums or reels to prevent kinks, damage, and contamination from ground contact.',
  },
  {
    id: 6,
    question: 'Why must outdoor cables be UV-rated?',
    options: [
      'To increase their current-carrying capacity outdoors',
      'To improve their flexibility in cold weather',
  ...
  },
  {
    ...
    options: [
      ...
      'Increase the pulling speed',
      'Use smaller cable drums',
      'Install cables in wet conditions',
    ],
    correctAnswer: 0,
    explanation:
  ...
  {
    id: 8,
    question: 'Which standard requires cables to be protected from damage during installation?',
    options: [
      'BS 5839 (fire detection and alarm systems)',
      'BS 6423 (maintenance of switchgear)',
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white text-sm space-y-1 list-disc pl-4">
                  ...
                  <li>
                    Damage can occur from abrasion, crushing, over-bending, and excessive tension
                  </li>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white text-sm space-y-1 list-disc pl-4">
                  ...
                  <li>
                    <strong>Use:</strong> Cable rollers, bushes, grommets, pulling lubricant,
                    tension gauges
                  </li>
                  <li>
                    <strong>Check:</strong> Sheath integrity, bend radius, support spacing, cleat
                    tightness
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-2 leading-relaxed">
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Apply protective measures when handling, storing, and installing cables in various
                  environments
                </li>
                <li>
                  Select appropriate tools, supports, and pulling methods to prevent mechanical
                  cable damage
                </li>
                <li>
                  Understand the importance of bend radius, tension limits, and sheath integrity
                  preservation
                </li>
                <li>
                  Follow BS 7671 and manufacturer guidelines to maintain cable safety and warranty
                  compliance
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Dragging over surfaces: Use rollers every 3m, maintain 50mm ground clearance
                  </li>
                  <li>
                ...
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Support point pressure: Use soft-lined cleats, distribute loads across multiple
                    points
                  </li>
                ...
                <div className="text-sm text-elec-yellow/80 bg-elec-yellow/5 p-2 rounded mt-2">
                  <strong>Critical limit:</strong> Any visible sheath damage {'>'}10% thickness
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <div className="text-sm text-green-400/80 bg-green-500/5 p-2 rounded mt-2">
                  <strong>Professional tip:</strong> Use 80% of maximum tension as working limit for
                  safety margin
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <div className="text-sm text-purple-400/80 bg-purple-500/5 p-2 rounded mt-2">
                  <strong>Safety requirement:</strong> Environmental assessment mandatory before
                  cable specification
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <div className="text-sm text-green-400/80 bg-green-500/5 p-2 rounded mt-2">
                  <strong>Quality standard:</strong> Pre-installation inspection mandatory for all
                  cable lengths
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-blue-500/50">
                ...
                <div className="text-sm text-blue-400/80 bg-blue-500/5 p-2 rounded mt-2">
                  <strong>Rejection criteria:</strong> Any damage affecting conductor or insulation
                  integrity
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-orange-500/50">
                ...
                <div className="text-sm text-orange-400/80 bg-orange-500/5 p-2 rounded mt-2">
                  <strong>Installation standard:</strong> All containment entries must have
                  protective fittings
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Friction reduction: 60-80% reduction in pulling force when correctly applied
                  </li>
                ...
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Working limits: 80% of manufacturer maximum, adjust for ambient conditions
                  </li>
                  <li>Emergency procedures: Immediate stop protocols when limits approached</li>
                </ul>
                <div className="text-sm text-elec-yellow/80 bg-elec-yellow/5 p-2 rounded mt-2">
                  <strong>Critical procedure:</strong> Stop pull immediately if tension limits
                  exceeded
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Thermal expansion: Allow for coefficient differences between containment and
                    cable
                  </li>
                ...
                <div className="text-sm text-purple-400/80 bg-purple-500/5 p-2 rounded mt-2">
                  <strong>Safety requirement:</strong> Risk assessment mandatory for vertical pulls{' '}
                  {'>'}10m
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Vertical runs: 400mm maximum spacing, additional support at changes of direction
                  </li>
                ...
                <div className="text-sm text-purple-400/80 bg-purple-500/5 p-2 rounded mt-2">
                  <strong>Design requirement:</strong> Support calculations must account for fault
                  current forces
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <div className="text-sm text-green-400/80 bg-green-500/5 p-2 rounded mt-2">
                  <strong>Compliance standard:</strong> Installation must maintain cable current
                  ratings
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-white/5 border-l-2 border-red-500/50">
              ...
              <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <li>
                  Regulation 522.8: Mechanical damage protection during installation and service
                </li>
                <li>
                  Section 523: Current-carrying capacity not compromised by installation damage
                </li>
              ...
              <div className="text-sm text-red-400/80 bg-red-500/5 p-2 rounded mt-2">
                <strong>Legal requirement:</strong> Installation must comply with BS 7671 for
                certification
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4 text-white">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm">
                  A: Yes, cable cleats are required for most fixed installations to prevent movement
                  during fault conditions (short-circuit forces) and provide mechanical support.
                  However, they must be installed correctly to avoid crushing. Use torque-controlled
                  installation (typically 2-4Nm for M6 fixings) and appropriate cleat materials for
                  the cable type (polymer-lined for PVC cables).
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <p className="font-medium text-white mb-1">
                  Q: Can damaged cable sheathing be repaired with electrical tape?
                </p>
                <p className="text-sm">
                  A: Only minor superficial damage ({'<'}10% sheath thickness) can be temporarily
                  repaired with appropriate insulating tape or heat-shrink sleeves. Deep cuts,
                  exposed conductors, or damaged armouring usually require complete cable
                  replacement. Always consult manufacturer guidelines and consider long-term
                  reliability and warranty implications.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <p className="font-medium text-white mb-1">
                  Q: How do I determine the correct bend radius for any cable type?
                </p>
                <p className="text-sm">
                  A: Always refer to the manufacturer's datasheet first. Bend radius is typically
                  expressed as multiples of cable overall diameter: PVC cables (6× for installation,
                  4× fixed), XLPE cables (8× installation, 6× fixed), SWA cables (12× installation,
                  8× fixed). For special applications or multi-core cables, specific manufacturer
                  guidance supersedes general rules.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <p className="font-medium text-white mb-1">
                  Q: What should I do if pulling tension limits are exceeded during installation?
                </p>
                <p className="text-sm">
                  A: Stop the pull immediately, release tension carefully, and inspect the cable for
                  damage. Reassess the installation method - consider using pulling lubricant (can
                  reduce tension by 60-80%), additional cable rollers, or breaking the pull into
                  shorter sections. Document any tension exceedance for quality records and warranty
                  purposes.
                </p>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-white text-sm leading-relaxed">
                ...
                mechanical protection during pulling operations, correct support system design, and
                environmental control. Taking preventive measures from the start avoids electrical
                faults, costly rework, safety hazards, and warranty issues while ensuring long-term
                system reliability and compliance with electrical installation standards.
              </p>
            </div>
          </section>
