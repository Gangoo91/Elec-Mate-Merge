...
const DESCRIPTION =
  'Professional standards, teamwork skills, ethical behaviour, continuous professional development, and workplace conduct for electrical maintenance technicians under ST1426.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Professional responsibility encompasses: producing work to an acceptable standard, making sound safety judgements, maintaining and developing your skills, being accountable for your actions, and considering the impact of your work on others. It is an active, ongoing commitment — not simply following instructions.',
  },
  {
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Professional behaviour is not a soft skill — it is directly linked to safety. A technician who takes shortcuts, fails to communicate, or disregards procedures creates risk. ST1426 assesses behaviours because they are inseparable from competent, safe practice.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      "Effective teams communicate openly, support each other, share information about hazards and progress, and take collective responsibility for outcomes. Every team member — regardless of experience level — has a duty to speak up about safety concerns and contribute to the team's effectiveness.",
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Ethical behaviour means doing the right thing even when nobody is watching. This includes: reporting genuine test results (never fabricating data), declaring competence limitations honestly, never signing certificates for work you have not done or checked, and reporting safety hazards even when they create extra work.',
  },
  {
    id: 4,
    question:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A positive attitude is not about suppressing problems — it is about approaching them constructively. Teams where people feel able to raise concerns, ask for help, and share knowledge are safer and more effective than teams where people hide problems to appear positive.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Effective mentoring transfers not just knowledge but understanding. Explaining why things are done a certain way (not just how) builds professional judgement. Encouraging questions creates a learning culture. Supervising safety-critical tasks protects both the learner and the public.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Section 7 creates a personal legal duty on every employee. You must take care of yourself and others, cooperate with safety measures, not interfere with safety equipment, and report hazards. This duty applies at all times — not just when you are being watched.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Professional time management means: planning work before starting, having the right tools and parts ready, working efficiently without rushing safety-critical steps, communicating delays early, and respecting that your timekeeping affects your team. It is about effectiveness, not speed.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Everyone makes mistakes. The measure of professionalism is how you respond. Honest reporting enables: immediate correction before the error causes harm, learning for yourself and the team, improvement of procedures to prevent recurrence, and maintenance of trust. Cover-ups are discovered eventually — and the consequences are always worse.',
  },
  {
    id: 10,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Modern maintenance requires a broad set of competencies. Technical skill alone is not sufficient — you also need communication skills (to report findings and liaise with others), safety awareness (to protect yourself and others), ethical judgement (to make honest decisions), and the habit of continuous learning (to stay current).',
  },
  {
    id: 12,
...
const faqs = [
  ...
  {
    question:
      'How should I handle a situation where company procedures conflict with what I believe is safe?',
    answer:
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              reputation of the profession. Under ST1426, professional behaviours are assessed
              alongside knowledge and skills as a core pillar of competence.
            </p>
            <p>
              Being professional means taking ownership. Ownership of your work quality — if you
              install it, test it, or sign it off, you stand behind it. Ownership of safety — not
              just your own, but that of everyone affected by your work. Ownership of your
              development — keeping your skills current throughout your career. And ownership of
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              electric shock. A signed-off certificate for work you did not verify could result in a
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              advance, and best practices improve. A commitment to lifelong learning is what
