...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Machine learning FDD', 'Neural network FDD', 'Statistical FDD', 'Rule-based FDD'],
    correctAnswer: 3,
    explanation:
...
const HNCModule8Section5_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 5 · Subsection 6"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Energy Monitoring and Dashboards">
          <p>
            ...
            consumption data at appropriate granularity. Modern BMS platforms provide sophisticated
            dashboards that transform raw data into actionable insights for building operators.
          </p>
          <p>
            <strong>Sub-Metering Hierarchy:</strong>
          </p>
          ...
          <p>
            <strong>Sub-Metering Strategy Guide</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Level 1:</strong> 100% of supply — Billing, overall tracking — Essential -
              mandatory
            </li>
            <li>
              <strong>Level 2:</strong> 80-90% of load — Zone allocation, tenant billing — High
              value - recommended
            </li>
            <li>
              <strong>Level 3:</strong> 60-80% of load — System benchmarking, M&amp;V — Good value
              for large systems
            </li>
            <li>
              <strong>Level 4:</strong> Critical equipment — Fault detection, optimisation —
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Comparative views:</strong> Actual vs target, this year vs last year, building
              vs benchmark
            </li>
            <li>
          ...
          <p>
            <strong>Key Dashboard Metrics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Energy Use Intensity (EUI):</strong> kWh/m²/year - normalised consumption
            </li>
            <li>
              <strong>Peak Demand:</strong> kW maximum - capacity and charges
            </li>
            <li>
              <strong>Power Factor:</strong> Target &gt; 0.95 - reactive charges
            </li>
            <li>
              <strong>Base Load Ratio:</strong> Night/day consumption - identifies waste
            </li>
            <li>
              <strong>Carbon Intensity:</strong> kgCO₂/m² - sustainability reporting
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Fault Detection and Diagnostics (FDD)">
          <p>
            ...
            identify equipment faults, control sequence errors, and operational inefficiencies. FDD
            can detect issues that would otherwise go unnoticed until causing significant energy
            waste or equipment failure.
          </p>
          <p>
            <strong>Rule-Based FDD</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Machine Learning FDD</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Common FDD Rules for HVAC Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Simultaneous heating/cooling:</strong> Heating AND cooling active in same zone
              — High - systems fight each other
            </li>
            <li>
              <strong>Economiser not working:</strong> OAT favourable but dampers at minimum —
              Moderate - missed free cooling
            </li>
            <li>
              <strong>Stuck valve:</strong> Valve command changes but output unchanged — Variable -
              depends on stuck position
            </li>
            <li>
              <strong>Sensor drift:</strong> Sensor reading implausible vs related sensors — High -
              incorrect control decisions
            </li>
            <li>
              <strong>Schedule mismatch:</strong> Equipment running outside occupied hours —
              Moderate - unnecessary runtime
            </li>
          </ul>
          <p>
            <strong>FDD Implementation Steps</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Rule configuration:</strong> Select and tune rules for building systems and
              climate
            </li>
            <li>
              <strong>Threshold setting:</strong> Balance sensitivity (catch faults) vs specificity
              (avoid false alarms)
            </li>
            <li>
              <strong>Prioritisation logic:</strong> Rank faults by energy impact, comfort impact,
              and urgency
            </li>
            <li>
            ...
            <li>
              <strong>Feedback loop:</strong> Capture resolution data to improve detection accuracy
            </li>
          </ul>
          <p>
            <strong>FDD Benefits Quantified</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Performance Analytics and Trending">
          <p>
            ...
            decisions. Advanced analytics techniques reveal patterns, predict problems, and
            benchmark performance against targets and similar buildings.
          </p>
          <p>
            <strong>Key Analytics Techniques</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Time-series trending:</strong> Any measured parameter — Patterns, anomalies,
              seasonality
            </li>
            <li>
              <strong>Regression analysis:</strong> Energy vs weather/occupancy — Weather
              normalisation, baseline models
            </li>
            <li>
              <strong>CUSUM analysis:</strong> Cumulative variance tracking — Performance drift
              detection
            </li>
            <li>
              <strong>Load duration curves:</strong> Demand analysis — Base load, peak shaving
              opportunities
            </li>
            <li>
              <strong>Carpet plots (heat maps):</strong> Hour-by-day visualisation — Schedule
              effectiveness, weekend operation
            </li>
          </ul>
          <p>
            <strong>CUSUM Analysis Example</strong>
          </p>
          <p>Purpose: Detect when performance deviates from baseline</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Baseline model:</strong> kWh = 1,500 + (25 × HDD)
            </li>
            <li>
              <strong>Week 1 actual:</strong> 2,100 kWh, HDD = 20
            </li>
            <li>
              <strong>Week 1 predicted:</strong> 1,500 + (25 × 20) = 2,000 kWh
            </li>
            <li>
              <strong>Week 1 variance:</strong> 2,100 - 2,000 = +100 kWh
            </li>
            <li>
              <strong>CUSUM after W1:</strong> +100 kWh
            </li>
          </ul>
          <p>Accumulate weekly variances - rising CUSUM indicates degradation</p>
          <p>
            <strong>Building Analytics Platform Features</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Benchmarking Comparisons:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            ...
            should show a clear V-shape for buildings with heating and cooling - deviations indicate
            control or operational issues.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Continuous Commissioning and Performance Ratings">
          ...
          <p>
            <strong>Commissioning Types Compared</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Initial (Cx):</strong> Construction/handover — Design intent verification —
              Baseline establishment
            </li>
            <li>
              <strong>Retro-commissioning (RCx):</strong> Existing buildings — Restoring performance
              — 10-20%
            </li>
            <li>
              <strong>Re-commissioning:</strong> Periodic (3-5 years) — Performance recovery — 5-15%
            </li>
            <li>
              <strong>Continuous (CCx):</strong> Ongoing — Sustained optimisation — 10-30%
            </li>
          </ul>
          <p>
            <strong>CCx Programme Elements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Review cadence:</strong> Daily monitoring, weekly analysis, monthly reporting
            </li>
            <li>
              <strong>Skilled resources:</strong> Trained operators with analytics interpretation
              skills
            </li>
            <li>
            ...
            <li>
              <strong>Continuous improvement:</strong> Regular setpoint optimisation and sequence
              tuning
            </li>
          </ul>
          <p>
            <strong>NABERS UK Rating</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Display Energy Certificate (DEC)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>DEC Rating Calculation</strong>
          </p>
          ...
          <p>
            <strong>Common CCx Issues to Address</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Sequence bypass:</strong> Optimisation routines disabled for troubleshooting
            </li>
          </ul>
          <p>
            <strong>Performance principle:</strong> Buildings rarely maintain their as-commissioned
            efficiency without active management. CCx addresses the natural tendency for performance
            to degrade over time through operational drift, equipment wear, and changing use
            patterns.
          </p>
        </ConceptBlock>
