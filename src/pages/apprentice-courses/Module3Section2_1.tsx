...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Section 522', 'Section 434', 'Section 711'],
    correctIndex: 0,
    explanation:
...
const faqs = [
  {
    ...
    answer:
      'Yes - certain containment systems are designed for both aesthetic appeal and performance, especially in commercial interiors.',
  },
  {
    question: 'Is containment always needed for domestic installations?',
    answer:
      'Not always, but it is recommended in exposed areas or where mechanical protection is needed.',
  },
  {
    question: 'Does containment improve fire safety?',
    answer:
      'Yes - appropriate supports and containment can prevent premature collapse of wiring and help maintain escape routes during a fire.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Cables in PVC/steel conduit, trunking or tray
              </li>
              <li>
                <strong>Use:</strong> Public and industrial areas, outdoors, mixed services
              </li>
              <li>
                <strong>Check:</strong> Supports, segregation, fill and environmental suitability
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Cable containment serves multiple critical functions in electrical installations,
              providing protection, organisation, and compliance with safety standards.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Containment is required in various situations to meet regulatory requirements and
              ensure safety.
            </p>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-3 rounded bg-white/5">
              ...
              <ul className="text-xs text-white/80 space-y-1">
                ...
                <li>
                  <strong>Solution:</strong> Use separate compartments or maintain minimum
                  separation distances per BS 7671
                </li>
              </ul>
            </div>
            ...
            <div className="p-3 rounded bg-amber-500/10 border border-amber-400/20">
              ...
              <ul className="text-xs text-white/80 space-y-1">
                ...
                <li>
                  <strong>Solution:</strong> Follow manufacturer guidelines for maximum support
                  intervals (typically 1.2m for steel trunking)
                </li>
              </ul>
            </div>
            ...
            <div className="p-3 rounded bg-white/5">
              ...
              <ul className="text-xs text-white/80 space-y-1">
                ...
                <li>
                  <strong>Solution:</strong> Calculate cable cross-sectional areas and plan for
                  future additions
                </li>
              </ul>
            </div>
            ...
            <div className="p-3 rounded bg-white/5">
              ...
              <ul className="text-xs text-white/80 space-y-1">
                ...
                <li>
                  <strong>Solution:</strong> Select containment with appropriate IP ratings and
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Cable containment selection and installation must comply with several key sections of
              BS 7671:
            </p>

            <ul className="text-sm text-white space-y-2 ml-4">
              <li>
                <strong>Section 522 - External influences:</strong> Selection of wiring systems
                according to environmental conditions (temperature, moisture, mechanical stress)
              </li>
              <li>
                <strong>Section 528 - Proximity to other services:</strong> Segregation requirements
                for different circuit types and interference prevention
              </li>
              <li>
                <strong>Section 521.10.202 - Support and fixings:</strong> Prevention of premature
                collapse of wiring systems during fire conditions
              </li>
              <li>
                <strong>Section 514 - Identification:</strong> Clear marking and identification of
                circuits for inspection and maintenance
              </li>
              <li>
                <strong>Section 543 - Protective conductors:</strong> Requirements when metallic
                containment is used as protective conductor
              </li>
            </ul>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    "Where cables are installed in locations exposed to mechanical damage, they
                    shall be protected by being enclosed in conduit, ducting or trunking providing
        ...
        <section className="mb-10">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-sm text-white leading-relaxed">
              Containment is fundamental to safe, organised and compliant electrical work -
              protecting cables, supporting BS 7671 compliance and simplifying maintenance.
            </p>
          </div>
        </section>
