  ...
  const sections = [
    {
      ...
      description:
        "Ohm's Law, Kirchhoff's Laws, circuit analysis, Thevenin's and Norton's theorems, superposition and transient response",
      icon: Calculator,
    ...
    },
    {
      ...
      description:
        'Reactive components, impedance, phase relationships, power factor correction and resonance in AC circuits',
      icon: Zap,
    ...
    },
    {
      ...
      description:
        'AC characteristics, waveforms, harmonics, power relationships and efficiency in AC systems',
      icon: BarChart3,
    ...
    },
    {
      ...
      description:
        'Star and delta configurations, balanced loads, three-phase power calculations and distribution systems',
      icon: Cog,
    ...
    },
    {
      ...
      description:
        'Electromagnetic induction, transformer theory, motor types, control systems and maintenance practices',
      icon: Battery,
    ...
    },
    {
      ...
      description:
        'Electrical losses, efficiency calculations, load management, smart controls and renewable integration',
      icon: Gauge,
    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-12">
          Master electrical theory, circuit analysis, power systems and energy efficiency principles
          essential for building services engineering
        </p>
