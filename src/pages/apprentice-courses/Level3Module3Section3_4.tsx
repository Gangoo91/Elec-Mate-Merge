...
const quickCheckQuestions = [
  {
    question:
      'What is the turns ratio of a transformer with 2400 primary turns and 120 secondary turns?',
    options: ['20:1 step-up', '20:1 step-down', '1:20 step-up', '1:20 step-down'],
    correctIndex: 1,
    explanation:
      'Turns ratio = Np/Ns = 2400/120 = 20:1. Since primary has more turns, secondary voltage is lower - this is a step-down transformer.',
  },
  {
    question:
      'A transformer has 400V primary and 50V secondary. If secondary current is 16A, what is primary current (ideal transformer)?',
    options: ['2 A', '128 A', '0.5 A', '8 A'],
    correctIndex: 0,
    explanation:
      'For an ideal transformer: Vp x Ip = Vs x Is. So Ip = (Vs x Is) / Vp = (50 x 16) / 400 = 800 / 400 = 2 A.',
  },
  {
    ...
    options: [
      'Core losses only',
      'Copper losses only',
      'Both core and copper losses',
      'Neither - all losses are constant',
    ],
    correctIndex: 1,
    explanation:
      'Copper losses (I squared R in windings) vary with load current squared. Core losses (hysteresis and eddy current) depend on voltage/frequency and remain approximately constant.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Laminations (thin sheets with insulating coating) break up eddy current paths. Eddy current losses are proportional to thickness squared, so thinner laminations give lower losses.',
  },
];
...
const quizQuestions = [
  {
    question:
      'An ideal transformer has 500 primary turns. For a 10:1 step-down ratio, how many secondary turns are needed?',
  ...
  {
    question:
      'A 11kV/400V transformer supplies a 50 kVA load at unity power factor. What is the secondary full-load current?',
    options: ['125 A', '72.2 A', '4.55 A', '200 A'],
    correctIndex: 1,
    explanation:
      'S = V x I for single phase, so Is = S / Vs = 50000 / (400 x sqrt(3)) = 50000 / 693 = 72.2 A for 3-phase (or 125 A if single phase).',
  },
  {
    question:
      'A transformer has core loss of 500 W and copper loss of 1200 W at full load. What is the efficiency at full load (50 kVA)?',
    options: ['96.7%', '94.5%', '97.6%', '92.4%'],
    correctIndex: 0,
    explanation:
      'Output = Input - Losses. Eff = Output/Input = (50000)/(50000 + 500 + 1200) = 50000/51700 = 96.7%.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Maximum efficiency occurs when variable losses (copper losses) equal fixed losses (core losses). This is typically at 50-75% of full load.',
  },
  {
    question:
      'What is the voltage regulation of a transformer if no-load voltage is 240V and full-load voltage is 230V?',
    options: ['4.17%', '4.35%', '10%', '2.17%'],
    correctIndex: 0,
    explanation:
      'Voltage regulation = ((Vno-load - Vfull-load) / Vfull-load) x 100 = ((240 - 230) / 240) x 100 = 4.17%.',
  },
  {
    question:
      'An auto-transformer has 400 turns with a tap at 300 turns. If input is 230V, what is the output voltage?',
    options: ['172.5 V', '306.7 V', '100 V', '130 V'],
    correctIndex: 0,
    explanation:
      'Output voltage = Input voltage x (output turns / input turns) = 230 x (300/400) = 230 x 0.75 = 172.5 V.',
  },
  {
    question: 'What determines the no-load current of a transformer?',
    options: [
      'Secondary load',
      'Core magnetising requirements',
      'Copper resistance',
      'Frequency only',
    ],
    correctIndex: 1,
    explanation:
      "No-load current is primarily the magnetising current needed to establish flux in the core, plus a small component for core losses. It's typically 2-5% of full-load current.",
  },
  {
    question: 'Why are 3-phase transformers rated in kVA rather than kW?',
    options: [
      "It's an industry convention only",
      'kVA indicates both voltage and current capacity regardless of power factor',
      'kW would be too large a number',
      'kVA is easier to calculate',
    ],
    correctIndex: 1,
    explanation:
      "Transformer heating depends on V x I (apparent power in VA), not actual power. The load power factor doesn't affect transformer heating, so kVA rating is appropriate.",
  },
  {
    question:
      'A transformer has percentage impedance of 5%. If a fault occurs on the secondary, what is the fault current as a multiple of full-load current?',
    options: ['5 times', '20 times', '0.05 times', '95 times'],
    correctIndex: 1,
    explanation:
      'Fault current = Full-load current / (% impedance / 100) = FLC / 0.05 = 20 x FLC. Lower impedance means higher fault current.',
  },
  {
    ...
    correctIndex: 0,
    explanation:
      'In Delta-Star (Dy) connection, the star-connected secondary provides a neutral point. This is common for distribution transformers where a neutral is needed for single-phase loads.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Magnetostriction is the slight change in core dimensions as it is magnetised and demagnetised at 50 Hz. This causes vibration at 100 Hz (twice per cycle) producing the characteristic hum.',
  },
  {
    question:
      'A current transformer has a ratio of 200/5. If the primary carries 150A, what is the secondary current?',
    options: ['3.75 A', '6000 A', '40 A', '1.5 A'],
    correctIndex: 0,
    explanation:
      'CT ratio means 200A primary gives 5A secondary. For 150A: Is = Ip x (5/200) = 150 x 0.025 = 3.75 A.',
  },
];
...
const faqItems = [
  {
    ...
    answer:
      'Transformers rely on electromagnetic induction, which requires a changing magnetic flux. AC naturally provides continuous flux change as current alternates. DC creates a constant flux that induces no EMF in the secondary once established. The only EMF induced with DC occurs during switch-on and switch-off transients.',
  },
  {
    question: 'What is the difference between power transformers and distribution transformers?',
    answer:
      'Power transformers operate at transmission voltages (33kV-400kV), are large, efficient at high loads, and typically located in substations. Distribution transformers operate at lower voltages (11kV/400V), are smaller, designed for varying loads, and located closer to consumers. Distribution transformers have higher iron-to-copper ratio for efficiency at lighter loads.',
  },
  {
    question: 'Why do transformers have a no-load current?',
    answer:
      'Even with no load connected, the transformer needs current to establish the magnetic flux in the core (magnetising current) and to supply core losses (hysteresis and eddy currents). This no-load current is typically 2-5% of full-load current and is mostly reactive (low power factor).',
  },
  {
    question: 'What is percentage impedance and why is it important?',
    answer:
      'Percentage impedance (%Z) is the percentage of rated voltage needed to circulate rated current through the short-circuited transformer. It determines fault current magnitude (Ifault = Irated / %Z) and voltage regulation. Typical values are 4-6% for distribution transformers. Higher %Z means lower fault current but poorer regulation.',
  },
  {
    question: 'How do I parallel transformers correctly?',
    answer:
      'To parallel transformers: same voltage ratio and phase displacement (vector group), same percentage impedance (within 10%), correct phase sequence, and proper synchronisation. Unequal impedances cause unequal load sharing; wrong vector group causes circulating currents that could damage the transformers.',
  },
  {
    question: 'What protection is required for transformers?',
    answer:
      'Common protections include: overcurrent relays (backup protection), differential relays (internal faults), Buchholz relay (gas/oil-flow detection for oil-filled types), temperature monitoring (winding and oil), pressure relief devices, and earth fault protection. BS 7671 requires overcurrent protection on the primary or secondary side.',
  },
];
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                <div className="bg-[#1a1a1a] rounded-lg p-4">
                  ...
                  <ul className="text-white text-sm space-y-1">
                    ...
                    <li>
                      <strong>Eddy currents:</strong> Circulating currents in the core
                    </li>
          ...
          <div className="mb-12">
            ...
            <div className="bg-[#242424] rounded-lg p-6 border border-white/10">
              ...
              <ul className="text-white space-y-2 mb-4">
                ...
                <li>
                  <strong>Leakage reactance:</strong> Creates quadrature voltage drop (I x X)
                </li>
            ...
            <div className="bg-[#242424] rounded-lg p-6 border border-white/10">
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 mb-4">
                <ul className="text-white space-y-3">
                  ...
                  <li>
                    <strong>Current transformer (CT):</strong> Steps down current for measurement.
                    Secondary must never be open-circuited. Primary often a single turn (bus bar).
                  </li>
                  <li>
                    <strong>Voltage transformer (VT/PT):</strong> Steps down voltage for
                    measurement. High accuracy, low burden. Must not be short-circuited.
                  </li>
                  <li>
                    <strong>Isolation transformer:</strong> 1:1 ratio providing galvanic isolation.
                    Used for safety and noise reduction.
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 mb-4">
                ...
                <ul className="text-white text-sm space-y-2">
                  ...
                  <li>
                    <strong>Yy0:</strong> Star-Star, no phase shift. Simple but has 3rd harmonic
                    issues without delta tertiary.
                  </li>
                  <li>
                    <strong>Dd0:</strong> Delta-Delta, no phase shift. No neutral available. Used
                    for special applications.
                  </li>
                  <li>
                    <strong>Yd1:</strong> Star-Delta, 30 degree phase shift. Used for step-up at
                    generators.
                  </li>
                </ul>
              </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-yellow-900/30 border border-yellow-500/50 rounded-lg p-6">
              ...
              <ul className="text-white space-y-2">
                ...
                <li>
                  <strong>Cooling:</strong> Oil-filled (ONAN, ONAF) for large outdoor units.
                  Dry-type (AN, AF) for indoor installation. Adequate ventilation essential.
                </li>
                <li>
                  <strong>Protection:</strong> Overcurrent and earth fault protection per BS 7671.
                  Oil-filled transformers need Buchholz relay and pressure relief.
                </li>
                <li>
                  <strong>Paralleling:</strong> Same vector group, similar %Z (within 10%), correct
                  phase sequence. Test with reduced voltage before full connection.
                </li>
                <li>
                  <strong>Earthing:</strong> LV neutral solidly earthed (TN-S, TN-C-S). Transformer
                  tank must be earthed. Follow BS 7671 Part 4.
                </li>
              </ul>
            </div>
          </div>
