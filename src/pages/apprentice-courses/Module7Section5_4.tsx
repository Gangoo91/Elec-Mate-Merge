  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'PPE provides crucial protection against electrical shock, arc flash burns, and flying debris when faults escalate during testing.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Environmental hazards include wet/damp conditions, poor lighting, trip hazards, confined spaces, and cluttered work areas that all increase electrical risk.',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'False. PPE is a final layer of protection but cannot replace proper safe working practices and risk assessments.',
    },
    {
      id: 8,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "The electrician suffered face and eye burns when molten copper particles from an arc fault hit him because he wasn't wearing safety glasses.",
    },
    {
      id: 10,
      question:
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-10">
            <p className="text-white/80 leading-relaxed">
              ...
              work areas can all increase danger. Personal protective equipment (PPE) provides a
              final layer of protection against shock, burns, and injury, while good environmental
              precautions reduce the likelihood of accidents occurring in the first place. For
              apprentices, learning to combine PPE with safe working environments is a key
          ...
          <section className="mb-10">
            ...
            <ul className="space-y-2 text-white/80">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Explain why PPE and environmental safety are vital during fault investigation
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-elec-yellow">✓</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-elec-yellow">✓</span>
                <span>
                  Describe environmental checks that must be carried out before testing begins
                </span>
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-4">
              <div className="space-y-4 text-sm text-white/80">
                <p>
                  ...
                  regularly inspected for holes, tears, or degradation. Different voltage ratings
                  available - ensure gloves match the system voltage being worked on.
                </p>

                <p>
                  <strong className="text-white">Safety glasses:</strong> Protect eyes from sparks,
                  flying debris, and molten metal particles that can occur during arc faults.
                  Essential when working near switchgear or when probing live circuits. Side shields
                  provide additional protection from peripheral hazards.
                </p>

                <p>
                  <strong className="text-white">Protective footwear:</strong> Prevents earthing
                  through the body by providing electrical insulation from ground. Must have
                  non-conductive soles and be free from metal components that could create
                  conductive paths. Regular inspection for sole damage critical.
                </p>

                <p>
                  <strong className="text-white">Flame-retardant clothing:</strong> Limits burn
                  injuries in the event of an arc fault by self-extinguishing rather than continuing
                  to burn. Made from materials that do not melt and stick to skin. Essential in
                  higher-risk environments like distribution boards and industrial installations.
                </p>
              </div>
            </div>
            ...
            <InlineCheck
              ...
              options={[
                'To stay warm',
                'To look professional',
                'To reduce burn injury in an arc fault',
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50 mb-4">
              <div className="space-y-4 text-sm text-white/80">
                <p>
                  ...
                  water before testing. Even damp walls or high humidity can increase shock risk
                  significantly. If dampness cannot be eliminated, additional precautions like
                  rubber matting are essential.
                </p>

                <p>
                  <strong className="text-white">Adequate lighting:</strong> Poor lighting leads to
                  mistakes and accidents. Ensure sufficient illumination to clearly see what you're
                  testing, read instrument displays, and identify potential hazards. Temporary
                  lighting may be needed in basements, roof spaces, or when main lighting is
                  isolated.
                </p>

                <p>
                  <strong className="text-white">Clear workspace:</strong> Remove trip hazards, tidy
                  cables, and ensure adequate space to move safely without contacting live parts.
                  Tools and equipment should be organised to prevent creating additional hazards.
                  Keep escape routes clear in case of emergency evacuation.
                </p>

                <p>
                  <strong className="text-white">Crowd control and barriers:</strong> In commercial
                  or public environments, use barriers and warning signs to keep unauthorised people
                  away. This protects others and prevents interruption during critical safety
                  procedures. Barriers also create a defined safe working zone.
                </p>
              </div>
            </div>
            ...
            <InlineCheck
              ...
              options={[
                ...
                'Stop, make safe with drying/rubber matting, then proceed',
                'Use different tools',
              ]}
              correctIndex={2}
            ...
            <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50 mb-4">
              <div className="space-y-4 text-sm text-white/80">
                <p>
                  ...
                  cannot replace proper safe working practices. The best protection comes from
                  eliminating hazards through good planning and environmental control, with PPE as
                  the final safety barrier.
                </p>

                <p>
                  <strong className="text-white">Combined approach essential:</strong> PPE and
                  environmental safety must work together. For example, insulated gloves may reduce
                  shock risk, but if testing in a wet basement with poor footing, the overall risk
                  remains unacceptably high. Both the person and workplace must be prepared.
                </p>

                <p>
                  <strong className="text-white">Dynamic risk assessment:</strong> Conditions can
                  change during work. Weather may worsen, lighting may fail, or new hazards may
                  appear. Continuously reassess both PPE effectiveness and environmental conditions
                  throughout the job, not just at the start.
                </p>

                <p>
                  <strong className="text-white">Professional responsibility:</strong> Skilled
                  electricians understand that using PPE in unsafe environments gives false
                  confidence. The professional approach is to control environmental risks first,
                  then use appropriate PPE as backup protection.
                </p>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50 mb-4">
              <div className="space-y-4 text-sm text-white/80">
                <p>
                  ...
                  Are there trip hazards? Is appropriate PPE available and in good condition? If any
                  answer is 'no', stop and address the issue.
                </p>

                <p>
                  <strong className="text-white">Environmental hazard identification:</strong> Look
                  for water sources, poor drainage, inadequate lighting, confined spaces, presence
                  of flammable materials, or unstable surfaces. Consider weather conditions for
                  outdoor work and ventilation for indoor work in enclosed spaces.
                </p>

                <p>
                  <strong className="text-white">Stop and report procedure:</strong> If conditions
                  are unsafe and cannot be immediately rectified, the correct professional response
                  is to stop work and report the issue to supervision. Document the hazards
                  identified and actions needed before work can proceed safely.
                </p>

                <p>
                  <strong className="text-white">Making areas safe:</strong> Common solutions
                  include installing temporary lighting, laying rubber matting, removing water
                  sources, setting up barriers, or waiting for weather to improve. Never compromise
                  on safety to meet deadlines - accidents cost far more than delays.
                </p>
              </div>
            </div>
            ...
            <InlineCheck
              ...
              options={[
                ...
                'Work faster to minimise exposure',
                'Stop work, report, make safe before continuing',
                'Use more PPE to compensate',
              ]}
              correctIndex={2}
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <ul className="space-y-2 text-sm text-white/80">
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">✓</span>
                  <span>
                    PPE provides essential protection but cannot replace safe working practices
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">✓</span>
                  <span>
                    Environmental hazards must be identified and controlled before testing begins
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">✓</span>
                  <span>
                    Stop work and report if conditions are unsafe - no testing deadline justifies
                    compromising safety
                  </span>
                </li>
              </ul>
          ...
          <section className="mb-10">
            <Quiz
              ...
              title="Test Your Knowledge: PPE and Environmental Precautions"
            />
          </section>
