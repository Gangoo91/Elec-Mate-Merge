...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['0.2 seconds', '0.1 seconds', '5 seconds', '0.4 seconds'],
    correctAnswer: 3,
    explanation:
...
const HNCModule7Section6_2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 6 · Subsection 2"
        title="Circuit Protection"
        backTo="/study-centre/apprentice/h-n-c-module7-section6"
      />
      <HubBody>
        ...
        <ConceptBlock title="Protective Device Selection">
          <p>
            Selecting the correct protective device requires consideration of the circuit's normal
            operating conditions, potential fault conditions, and the characteristics of the
            equipment being protected. The device must provide both overload and fault protection
            whilst remaining stable during normal operation.
          </p>
          <p>
            <strong>Protective Device Types:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>MCB (Miniature Circuit Breaker):</strong> Standard protection up to 125A,
              fixed trip characteristics
            </li>
            <li>
              <strong>MCCB (Moulded Case Circuit Breaker):</strong> Higher ratings (100A-1600A+),
              adjustable settings
            </li>
            <li>
              <strong>Fuse (BS 88, BS 1361, BS 3036):</strong> High breaking capacity, no mechanical
              parts to fail
            </li>
            <li>
              <strong>RCD/RCBO:</strong> Earth fault protection, additional shock protection
            </li>
          </ul>
          <p>
            <strong>MCB Characteristics (BS EN 60898)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type B:</strong> 3 to 5 × In — Resistive loads, lighting, socket circuits
            </li>
            <li>
              <strong>Type C:</strong> 5 to 10 × In — Small motors, fluorescent lighting, IT
              equipment
            </li>
            <li>
              <strong>Type D:</strong> 10 to 20 × In — High inrush loads, transformers, X-ray
              equipment
            </li>
          </ul>
          <p>
            <strong>Device Selection Criteria</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Rated voltage (Ue):</strong> Must equal or exceed system voltage
            </li>
            <li>
              <strong>Rated current (In):</strong> ≥ circuit design current (Ib) but ≤ cable current
              capacity (Iz)
            </li>
            <li>
              <strong>Breaking capacity (Icn/Icu):</strong> &gt; prospective fault current at
              installation point
            </li>
            <li>
              <strong>Trip characteristics:</strong> Suitable for load type and inrush currents
            </li>
            <li>
              <strong>Number of poles:</strong> Matched to circuit configuration (SP, DP, TP, TPN,
              4P)
            </li>
          </ul>
          <p>
            <strong>Selection principle:</strong> The protective device rating chain must satisfy:
            Ib ≤ In ≤ Iz, where Ib is design current, In is device rating, and Iz is cable capacity.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Breaking Capacity and Fault Ratings">
          <p>
            Breaking capacity is the maximum fault current a protective device can safely interrupt
            without damage, fire, or danger. BS 7671 Regulation 432.1 requires that every protective
            device has a rated short-circuit capacity not less than the prospective fault current at
            its point of installation.
          </p>
          <p>
            <strong>Icn (MCBs)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Prospective Fault Current Sources</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Domestic origin (PME):</strong> Up to 16kA — 16kA for main switch
            </li>
            <li>
              <strong>Final circuits (domestic):</strong> 1-3kA typical — 6kA MCBs usually
              sufficient
            </li>
            <li>
              <strong>Commercial/Industrial LV:</strong> 10-50kA — Match to calculated PFC
            </li>
            <li>
              <strong>Close to transformer:</strong> Up to 80kA+ — High-rupturing capacity devices
            </li>
          </ul>
          <p>
            <strong>PFC Calculation Example</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply transformer:</strong> 500kVA, 4% impedance
            </li>
            <li>
              <strong>Secondary voltage:</strong> 400V (line-line)
            </li>
            <li>
              <strong>Full load current:</strong> I = 500,000 / (√3 × 400) = 722A
            </li>
            <li>
              <strong>PFC at transformer:</strong> 722 / 0.04 = 18.05kA
            </li>
            <li>
              <strong>Minimum breaking capacity:</strong> &gt;18kA at main switchboard
            </li>
          </ul>
          <p>
            <strong>Back-up protection:</strong> Where PFC exceeds a device's rating, back-up
            protection coordination with an upstream device may be permitted per BS EN 60947-2 Annex
            A, but only where manufacturer's data confirms the combination.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Let-Through Energy (I²t)">
          <p>
            ...
            protective device during fault clearance. BS 7671 Regulation 434.5.2 requires that the
            energy let through by the protective device does not exceed the energy withstand
            capability of the protected conductor.
          </p>
          <p>
            <strong>The Adiabatic Equation</strong>
          </p>
          <p>I²t ≤ k²S²</p>
          <p>Where:</p>
          ...
          <p>
            <strong>Cable Withstand Values (k²S²)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1.5:</strong> 29,756 A²s — 46,010 A²s
            </li>
            <li>
              <strong>2.5:</strong> 82,656 A²s — 127,806 A²s
            </li>
            <li>
              <strong>4.0:</strong> 211,600 A²s — 327,184 A²s
            </li>
            <li>
              <strong>6.0:</strong> 476,100 A²s — 736,164 A²s
            </li>
            <li>
              <strong>10:</strong> 1,322,500 A²s — 2,044,900 A²s
            </li>
          </ul>
          <p>
            <strong>MCB Energy Classes</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Class 1:</strong> No energy limitation
            </li>
            <li>
              <strong>Class 2:</strong> Limited energy let-through
            </li>
            <li>
              <strong>Class 3:</strong> Greatest energy limitation (UK standard)
            </li>
          </ul>
          <p>
            <strong>Fuse I²t Characteristics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pre-arcing I²t:</strong> Energy before arc forms
            </li>
            <li>
              <strong>Operating I²t:</strong> Total energy including arc
            </li>
            <li>
              <strong>Cut-off current:</strong> Limited peak current
            </li>
          </ul>
          <p>
            <strong>Verification Example</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cable:</strong> 2.5mm² thermoplastic copper
            </li>
            <li>
              <strong>k²S² =</strong> 115² × 2.5² = 82,656 A²s
            </li>
            <li>
              <strong>32A Type B MCB let-through at 3kA:</strong> ~15,000 A²s (typical)
            </li>
            <li>
              <strong>Check:</strong> 15,000 &lt; 82,656 ✓ Cable protected
            </li>
          </ul>
          <p>
            <strong>Critical point:</strong> Always verify let-through energy against cable
            withstand, especially for long cable runs where fault current is reduced and clearance
            time increased.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Selectivity and RCD Coordination">
          <p>
            Selectivity (discrimination) ensures that during a fault condition, only the protective
            device nearest to the fault operates, maintaining supply to healthy circuits. BS 7671
            Regulation 536.4 requires that where discrimination is necessary for safety, the
            characteristics of the devices shall be coordinated accordingly.
          </p>
          <p>
            <strong>Discrimination Methods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Current (Ampere):</strong> Upstream device rated higher — Limited range; ratio
              1:1.6 minimum
            </li>
            <li>
              <strong>Time:</strong> Upstream device has time delay — MCCBs with adjustable settings
            </li>
            <li>
              <strong>Energy (I²t):</strong> Downstream limits energy below upstream pre-arc —
              Current-limiting devices; fuse/MCB combinations
            </li>
            <li>
              <strong>Zone selective interlocking:</strong> Communication between devices —
              Intelligent protection systems
            </li>
          </ul>
          <p>
            <strong>RCD Types and Selection (BS EN 61008/61009)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type AC:</strong> Sinusoidal AC only — Basic resistive loads (limited use now)
            </li>
            <li>
              <strong>Type A:</strong> AC + pulsating DC — IT equipment, LED drivers, single-phase
              rectifiers
            </li>
            <li>
              <strong>Type F:</strong> AC + pulsating DC + composite (to 1kHz) — VSDs, single-phase
              frequency inverters
            </li>
            <li>
              <strong>Type B:</strong> AC + pulsating DC + smooth DC — Three-phase rectifiers, EV
              chargers, PV inverters
            </li>
          </ul>
          <p>
            <strong>RCD Time Delay Ratings</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>General (no delay):</strong> Instantaneous operation
            </li>
            <li>
              <strong>Type S (selective):</strong> 40-500ms delay at IΔn
            </li>
            <li>
              <strong>Custom delay:</strong> For discrimination schemes
            </li>
          </ul>
          <p>
            <strong>RCD Discrimination Rules</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>RCD Discrimination Example</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Upstream:</strong> 100mA Type S (time-delayed)
            </li>
            <li>
              <strong>Downstream:</strong> 30mA general (instantaneous)
            </li>
            <li>
              <strong>Ratio check:</strong> 100/30 = 3.33:1 ≥ 3:1 ✓
            </li>
            <li>
              <strong>Time check:</strong> S type has 40-500ms delay ✓
            </li>
          </ul>
          <p>
            <span> Discrimination achieved - downstream trips first </span>
          </p>
          <p>
            <strong>RCBO Selection Advantages</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            socket outlets ≤32A in domestic and similar installations, cables concealed in walls at
            depths &lt;50mm, and cables without earthed metallic covering.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Select an MCB for a ring final circuit with design current
            26A, cable capacity 32A.
          </p>
          <p>Given data:</p>
          ...
          <p>
            <strong>Scenario:</strong> Design RCD discrimination for a consumer unit with multiple
            final circuits.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Domestic PME max PFC: <strong>16kA</strong> (declared by DNO)
            </li>
            <li>
              Max disconnection time (final circuits ≤63A, TN): <strong>0.4 seconds</strong>
            </li>
            <li>
              RCD discrimination ratio: <strong>≥3:1</strong> with time delay
            </li>
            <li>
              k value (70°C PVC/Cu): <strong>115</strong>
            </li>
            <li>
              k value (90°C XLPE/Cu): <strong>143</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Assuming 6kA is always adequate</strong> - verify PFC at each location
              </li>
              <li>
                <strong>Ignoring I²t verification</strong> - essential for fault protection
              </li>
              <li>
                <strong>Using Type AC RCDs</strong> - Type A minimum now required for most
                applications
              </li>
              <li>
                <strong>Forgetting time delay for RCD discrimination</strong> - ratio alone is not
                sufficient
              </li>
            </ul>
          }
