    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Breaking capacity:</strong> Must exceed prospective fault current
              </li>
              <li className="pl-1">
                <strong>I²t energy:</strong> Must be less than cable withstand (k²S²)
              </li>
              <li className="pl-1">
                <strong>Discrimination:</strong> Nearest device operates first
              </li>
              <li className="pl-1">
                <strong>RCD types:</strong> AC, A, F, B for different fault waveforms
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Reg 432.1:</strong> Breaking capacity ≥ prospective fault current
              </li>
              <li className="pl-1">
                <strong>Reg 434.5.2:</strong> I²t ≤ k²S² for fault protection
              </li>
              <li className="pl-1">
                <strong>Reg 536.4:</strong> Discrimination requirements
              </li>
              <li className="pl-1">
                <strong>Reg 411.3.3:</strong> 30mA RCD for socket outlets ≤32A
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>MCCB (Moulded Case Circuit Breaker):</strong> Higher ratings
                  (100A-1600A+), adjustable settings
                </li>
                <li className="pl-1">
                  <strong>Fuse (BS 88, BS 1361, BS 3036):</strong> High breaking capacity, no
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                MCB Characteristics (BS EN 60898)
              </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Resistive loads, lighting, socket circuits
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Small motors, fluorescent lighting, IT equipment
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        High inrush loads, transformers, X-ray equipment
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Rated current (In):</strong> ≥ circuit design current (Ib) but ≤ cable
                  current capacity (Iz)
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Number of poles:</strong> Matched to circuit configuration (SP, DP, TP,
                  TPN, 4P)
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              Ib ≤ In ≤ Iz, where Ib is design current, In is device rating, and Iz is cable
              capacity.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Breaking capacity is the maximum fault current a protective device can safely
              interrupt without damage, fire, or danger. BS 7671 Regulation 432.1 requires that
              every protective device has a rated short-circuit capacity not less than the
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Prospective Fault Current Sources
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        High-rupturing capacity devices
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              protection coordination with an upstream device may be permitted per BS EN 60947-2
              Annex A, but only where manufacturer's data confirms the combination.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Let-through energy represents the thermal energy (measured in A²s) that passes through
              a protective device during fault clearance. BS 7671 Regulation 434.5.2 requires that
              the energy let through by the protective device does not exceed the energy withstand
                ...
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                    <tr className="bg-white/5">
                      ...
                      <th className="border border-white/10 px-3 py-2 text-left">
                        70°C Thermoplastic (k=115)
                      </th>
                      <th className="border border-white/10 px-3 py-2 text-left">
                        90°C Thermosetting (k=143)
                      </th>
                    </tr>
                  </thead>
                  <tbody>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Selectivity (discrimination) ensures that during a fault condition, only the
              protective device nearest to the fault operates, maintaining supply to healthy
              circuits. BS 7671 Regulation 536.4 requires that where discrimination is necessary for
              safety, the characteristics of the devices shall be coordinated accordingly.
            </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Upstream device rated higher
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Limited range; ratio 1:1.6 minimum
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Time</td>
                      <td className="border border-white/10 px-3 py-2">
                        Upstream device has time delay
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        MCCBs with adjustable settings
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Energy (I²t)</td>
                      <td className="border border-white/10 px-3 py-2">
                        Downstream limits energy below upstream pre-arc
                      </td>
                      <td className="border border-white/10 px-3 py-2">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                RCD Types and Selection (BS EN 61008/61009)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Basic resistive loads (limited use now)
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        IT equipment, LED drivers, single-phase rectifiers
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Type F</td>
                      <td className="border border-white/10 px-3 py-2">
                        AC + pulsating DC + composite (to 1kHz)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        VSDs, single-phase frequency inverters
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Type B</td>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Three-phase rectifiers, EV chargers, PV inverters
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="font-mono text-sm space-y-1">
                ...
                <p>
                  <span className="text-green-400">
                    Discrimination achieved - downstream trips first
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                RCBO Selection Advantages
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Individual circuit protection - fault affects only one circuit
                </li>
                <li className="pl-1">Integral overcurrent and earth fault protection</li>
                <li className="pl-1">
                  Required for fire alarm, emergency lighting, security circuits per BS 7671
                </li>
                <li className="pl-1">
                  Simplifies fault finding - tripped device indicates faulty circuit
                </li>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: MCB Selection for Final Circuit
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: RCD Discrimination Scheme
              </h3>
              <p className="text-sm text-white mb-2">
