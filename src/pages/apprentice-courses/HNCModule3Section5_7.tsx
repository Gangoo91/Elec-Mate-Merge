...
const quickCheckQuestions = [
  {
    ...
    options: ['2-3 times FLC', 'Equal to FLC', '10-12 times FLC', '4-8 times FLC'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['1/√3 (58%)', '1/4 (25%)', '1/3 (33%)', '1/2 (50%)'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['750 rpm', '1500 rpm', '375 rpm', '3000 rpm'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Vector control (FOC)', 'PWM control', 'V/f control', 'Scalar control'],
    correctAnswer: 0,
    explanation:
...
const HNCModule3Section5_7 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 5 · Subsection 7"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The retained Ecodesign regulation places VSDs on the same legal footing as motors
              &mdash; IES2 minimum efficiency, declared per IEC 61800-9 packaged drive standard. As
              BSE designer specifying fan / pump VSDs you must verify the IES2 declaration on the
              manufacturer&rsquo;s submission and document compliance for the SBEM / Part L 2021
              evidence.
            </>
          }
        ...
        <ConceptBlock title="Direct-On-Line (DOL) Starting">
          <p>
            DOL starting is the simplest method - the motor is connected directly to the full supply
            voltage via a contactor. While straightforward, the high starting current (typically 6-8
            times full load current) limits its use to smaller motors.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Overload relay:</strong> Thermal or electronic, trips on sustained overcurrent
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">DOL Starting Characteristics</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Starting current</strong> — 6-8 × FLC — Can be 4-10× depending on motor
            </li>
            <li>
              <strong>Starting torque</strong> — 100-200% FLT — Full torque available from start
            </li>
            <li>
              <strong>Voltage at motor</strong> — 100% — Full line voltage applied
            </li>
            <li>
              <strong>Typical max size</strong> — 7.5-11kW — Depends on supply capacity
            </li>
            <li>
              <strong>Cost</strong> — Lowest — Simple, few components
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">When to Use DOL</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Small motors (typically under 7.5kW in commercial buildings)</li>
            <li>Supply can handle inrush without excessive voltage drop (&lt;3%)</li>
        ...
        <ConceptBlock title="Star-Delta Starting">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Star vs Delta Configuration</p>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Star-Delta Starting Sequence</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Start</strong> — Star (Y) — 33% of DOL — 33% of DOL
            </li>
            <li>
              <strong>2. Accelerate</strong> — Star (Y) — Decreasing — Accelerating load
            </li>
            <li>
              <strong>3. Changeover</strong> — Open → Delta — Current spike — Torque spike
            </li>
            <li>
              <strong>4. Run</strong> — Delta (Δ) — FLC — 100% FLT
            </li>
          </ul>
          ...
          <p>
            <strong>Application note:</strong> Star-delta is suitable for low-inertia loads that can
            accelerate to near running speed in star. High-inertia loads may stall or experience
            severe changeover transients.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Auto-transformer and Soft Starters">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Auto-transformer Starting</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Uses tapped auto-transformer (typically 50%, 65%, 80% taps)</li>
            <li>Starting current = (tap%)² × DOL current (e.g., 65% tap = 42% current)</li>
            <li>Starting torque = (tap%)² × DOL torque</li>
            <li>Line current is further reduced by transformer action</li>
            <li>Used for large motors where star-delta torque is insufficient</li>
          </ul>
          ...
          <p>
            ...
            applied to the motor by phase-angle control. Voltage ramps up gradually from a preset
            initial value to full voltage over an adjustable time period.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Adjustable ramp time</strong> — Match acceleration to load requirements
            </li>
            <li>
              <strong>Current limiting</strong> — Precise control of maximum starting current
            </li>
            <li>
              <strong>Soft stop</strong> — Prevents water hammer in pump systems
            </li>
            <li>
              <strong>Kick start</strong> — Pulse of higher voltage to break static friction
            </li>
            <li>
              <strong>Motor protection</strong> — Overload, phase loss, phase imbalance, stall
            </li>
            <li>
              <strong>Bypass contactor</strong> — Thyristors bypassed at full speed (reduces losses)
            </li>
          </ul>
        ...
        <ConceptBlock title="Variable Frequency Drives (VFDs/VSDs)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Voltage must be varied with frequency to maintain flux (V/f control)</li>
            <li>PWM (Pulse Width Modulation) creates sinusoidal current in motor</li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">VFD Operating Range</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>0-50Hz (base speed)</strong> — 0-400V (constant V/f) — Constant torque region
            </li>
            <li>
              <strong>50-100Hz (field weakening)</strong> — 400V (constant) — Constant power,
              reduced torque
            </li>
          </ul>
          ...
          <p>
            <strong>Low speed operation:</strong> Standard motors overheat below 20Hz due to reduced
            cooling. Use inverter-duty motors with independent cooling (IC416) or limit minimum
            speed to 20% for standard motors.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="V/f Control and Vector Control">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">V/f (Volts/Hertz) Control</p>

          <p>
            Also called scalar control, V/f maintains a constant ratio of voltage to frequency. This
            keeps motor flux approximately constant, ensuring rated torque is available across the
            speed range.
          </p>
          <p>
            <strong>V/f = 400V / 50Hz = 8 V/Hz = constant</strong>
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Control method</strong> — Voltage and frequency — Flux and torque currents
            </li>
            <li>
              <strong>Low speed torque</strong> — Poor (voltage boost helps) — Excellent (full
              torque at zero speed)
            </li>
            <li>
              <strong>Dynamic response</strong> — Slow (100-200ms) — Fast (5-10ms)
            </li>
            <li>
              <strong>Speed accuracy</strong> — ±1-3% (open loop) — ±0.01% (with encoder)
            </li>
            <li>
              <strong>Setup complexity</strong> — Simple — Requires motor auto-tune
            </li>
            <li>
              <strong>Typical applications</strong> — Fans, pumps, conveyors — Hoists, cranes,
              winders
            </li>
          </ul>
        ...
        <ConceptBlock title="Energy Savings with Variable Speed Drives">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Pump and Fan Affinity Laws</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>100%</strong> — 100% — 100% — 100% — 0%
            </li>
            <li>
              <strong>80%</strong> — 80% — 64% — 51.2% — 48.8%
            </li>
            <li>
              <strong>60%</strong> — 60% — 36% — 21.6% — 78.4%
            </li>
            <li>
              <strong>50%</strong> — 50% — 25% — 12.5% — 87.5%
            </li>
            <li>
              <strong>40%</strong> — 40% — 16% — 6.4% — 93.6%
            </li>
          </ul>

          <p className="text-sm font-medium text-white">VSD vs Traditional Flow Control:</p>
        ...
        <ConceptBlock title="Building Services Applications">
          <p className="text-sm font-medium text-elec-yellow/80">Pump Control Applications</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>LTHW heating</strong> — ΔP control (constant pressure) — 30-50%
            </li>
            <li>
              <strong>CHW cooling</strong> — ΔT control or ΔP control — 40-60%
            </li>
            <li>
              <strong>Condenser water</strong> — Temperature control — 20-40%
            </li>
            <li>
              <strong>Booster sets</strong> — Pressure control, duty/assist — 30-50%
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Fan Control Applications</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>AHU supply fans</strong> — Duct static pressure or CO₂ — 40-60%
            </li>
            <li>
              <strong>AHU extract fans</strong> — Track supply or pressure control — 40-60%
            </li>
            <li>
              <strong>Cooling tower fans</strong> — Condenser water temperature — 30-50%
            </li>
            <li>
              <strong>Car park ventilation</strong> — CO level control, jet fans — 50-70%
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Escalators and Moving Walkways</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Speed control:</strong> Slow/standby when unoccupied, full speed when in use
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Applications:</strong> Baggage handling, distribution centres, manufacturing
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">BMS Integration</p>
          <p>Modern VSDs integrate with Building Management Systems for optimised control:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Harmonic Considerations">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Typical Harmonic Content</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>5th</strong> — 250Hz — 30-40% — Motor heating, vibration
            </li>
            <li>
              <strong>7th</strong> — 350Hz — 15-25% — Motor heating, vibration
            </li>
            <li>
              <strong>11th, 13th</strong> — 550Hz, 650Hz — 5-10% — Cable heating, interference
            </li>
          </ul>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A 15kW motor has a DOL starting current of 180A. What is the
            starting current with star-delta starting?
          </p>
          ...
          <p>
            ...
            requests 70% airflow. Calculate the new frequency, speed, and power as a percentage of
            full load.
          </p>
          ...
          <p>
            <strong>Question:</strong> A 22kW pump runs 4000 hours/year. Currently throttled to 60%
            flow. Calculate annual savings if converted to VSD control at 60% speed. Electricity
            costs £0.15/kWh.
          </p>
        ...
        <ConceptBlock title="Practical Guidance">
          <p className="text-sm font-medium text-elec-yellow/80">Starting Method Selection Guide</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Small pump &lt;7.5kW</strong> — DOL — Simple, adequate supply capacity
            </li>
            <li>
              <strong>Large pump, constant speed</strong> — Soft starter — Smooth start, prevents
              water hammer
            </li>
            <li>
              <strong>HVAC pump, variable flow</strong> — VFD — Energy savings, BMS control
            </li>
            <li>
              <strong>AHU fan</strong> — VFD — VAV control, major savings
            </li>
            <li>
              <strong>Escalator</strong> — VFD — Standby mode, regeneration
            </li>
            <li>
              <strong>Chiller compressor</strong> — VFD (integral) — Capacity control, efficiency
            </li>
            <li>
              <strong>Fire pump</strong> — DOL or Star-delta — Simplicity, reliability critical
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">VFD Installation Considerations</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cable length:</strong> Long motor cables need output filters (dV/dt or sine
              wave)
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 30 kW supply fan in an office AHU runs constantly at full speed via a DOL starter,
              controlled by inlet vanes. The BMS data shows actual airflow demand averages 65 % of
              design over occupied hours, with morning peak at 90 % and overnight at 40 %. You
              evaluate retrofitting a VSD with BMS speed control via 0&ndash;10 V or BACnet.
            </>
          }
          whatToDo={
            <>
              Apply cube affinity: P/P&#x2080; = (n/n&#x2080;)&sup3;. At 65 % speed the power =
              0.65&sup3; = 0.275 (~27.5 % of design power). For a 30 kW fan that&rsquo;s 8.25 kW
              absorbed instead of ~30 kW &mdash; 21.75 kW saving during typical operation.
              Annualised over 4500 occupied hours: ~98,000 kWh/year, ~&pound;19,600 at 20 p/kWh +
              ~13.6 t CO&#x2082;. Specify a 30 kW VSD (IES2, 5 % line reactor, EMC filter for
              residential / commercial area), open IO-Bus to the BMS, payback typically &lt; 18
              months. Document in the Part L log book.
            </>
          }
          whyItMatters={
            <>
              VSD-on-fan is the highest-leverage energy-efficiency intervention on most existing
              commercial buildings. The HNC engineer&rsquo;s ability to run the cube-law arithmetic
              and choose the right VSD package (with harmonic mitigation appropriate to the upstream
              supply) is the difference between a successful retrofit and one that causes
              power-quality problems on the busbar.
            </>
          }
        />
