      ...
      <div className="sticky top-0 z-10 bg-elec-dark/95 backdrop-blur-sm border-b border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-base font-bold text-white">Number Systems &amp; Arithmetic</h1>
          </div>
        </div>
      </div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              numbers on a distribution board, or tallying up the number of sockets on a ring final
              circuit.
            </p>
            <p>
              ...
              <strong className="text-white">multiplication (&times;)</strong> and{' '}
              <strong className="text-white">division (&divide;)</strong>. Each appears regularly in
            ...
            <ul className="space-y-2 pl-1">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Addition:</strong> Totalling the number of
                  accessories on a floor plan &mdash; e.g. 14 double sockets + 6 single sockets + 3
                  fused spurs = 23 accessories.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  <strong className="text-white">Subtraction:</strong> Working out remaining stock
                  &mdash; you started with 500 cable ties and used 187, leaving 313.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  <strong className="text-white">Multiplication:</strong> Calculating total cost
                  &mdash; 12 back boxes at &pound;2 each = &pound;24.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  <strong className="text-white">Division:</strong> Sharing materials equally
                  &mdash; 96 metres of trunking split across 4 floors = 24 metres per floor.
                </span>
              </li>
            </ul>
            ...
            <p>
              <strong className="text-white">Place value</strong> is also important. The number
              2,430 means 2 thousands, 4 hundreds, 3 tens and 0 units. Understanding place value
              helps you read meter readings accurately and avoid costly mistakes when interpreting
              measurement data. For instance, misreading a meter as 2,430 kWh instead of 24,300 kWh
              would result in a billing error of a factor of ten.
            </p>

            <p>
              <strong className="text-white">Long multiplication</strong> is needed when calculating
              material costs on larger jobs. For example, 156 cable clips at 8p each: 156 &times; 8
              = 1,248p = &pound;12.48. Break it down: (150 &times; 8) + (6 &times; 8) = 1,200 + 48 =
              1,248.
            </p>

            <p>
              <strong className="text-white">Long division</strong> helps when splitting quantities.
              If you have 1,350 metres of cable to distribute equally across 6 circuits: 1,350
              &divide; 6 = 225m per circuit.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              2.5&thinsp;mm&sup2;, a voltage reading 232.7V, or a test result 0.35&thinsp;&Omega;.
            </p>

            <p>
              <strong className="text-white">Adding and subtracting decimals:</strong> Line up the
              decimal points, then proceed as with whole numbers. For example, when measuring cable
              runs: 12.45m + 8.3m + 0.75m. Rewrite as:
            </p>
...
-------
  21.50m`}
            ...
            <p>
              <strong className="text-white">Multiplying decimals:</strong> Multiply as if there
              were no decimal points, then count the total number of decimal places in both numbers
              and place the point accordingly. For instance, calculating the cost of 23.5 metres of
              cable at &pound;1.24 per metre:
            </p>
            <ul className="space-y-2 pl-1">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Total decimal places: 1 (from 23.5) + 2 (from 1.24) = 3</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
            ...
            <p>
              <strong className="text-white">Dividing decimals:</strong> When dividing by a decimal,
              multiply both the divisor and the dividend by 10 (or 100, etc.) to make the divisor a
              whole number. For example, 45.6 &divide; 1.2 becomes 456 &divide; 12 = 38.
            </p>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                essential for compliance with BS 7671.
              </p>
            </div>

            <p>
              <strong className="text-white">Decimal places vs significant figures:</strong> Two
              decimal places (2 d.p.) means two digits after the point, e.g. 4.57. Two significant
              figures (2 s.f.) means two meaningful digits, e.g. 4.6 or 0.046. Your test instruments
              typically display readings to a specific number of decimal places, and you should
              record them as displayed without rounding unless instructed otherwise.
            </p>

            <p>
              <strong className="text-white">Recurring decimals:</strong> Some fractions produce
              decimals that repeat forever. For example, 1&frasl;3 = 0.333... In practice, round to
              the number of decimal places appropriate for your task &mdash; usually 2 d.p. for
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              imperial conduit sizes (e.g. &frac34; inch), splitting materials between teams, and
              understanding technical documentation.
            </p>
            <p>
              A fraction has two parts: the <strong className="text-white">numerator</strong> (top
              number) and the <strong className="text-white">denominator</strong> (bottom number).
              In the fraction &frac34;, the numerator is 3 and the denominator is 4, meaning 3 out
              of 4 equal parts.
            </p>

            <p>
              <strong className="text-white">Adding and subtracting fractions:</strong> You need a
              common denominator. For example, &frac12; + &frac14;: convert &frac12; to 2&frasl;4,
              then add: 2&frasl;4 + 1&frasl;4 = &frac34;.
            </p>

            <p>
              <strong className="text-white">Multiplying fractions:</strong> Multiply the numerators
              together and the denominators together. For example, 2&frasl;3 &times; &frac34; =
              6&frasl;12 = &frac12;.
            </p>

            <p>
              <strong className="text-white">Dividing fractions:</strong> Flip the second fraction
              (take its reciprocal) and multiply. For example, &frac34; &divide; &frac12; = &frac34;
              &times; 2&frasl;1 = 6&frasl;4 = 1&frac12;.
            </p>
            ...
            <ul className="space-y-2 pl-1">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Fraction to decimal: divide numerator by denominator &mdash; &frac38; = 3 &divide;
                  8 = 0.375
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Decimal to percentage: multiply by 100 &mdash; 0.375 &times; 100 = 37.5%
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Percentage to fraction: write over 100 and simplify &mdash; 37.5% = 375&frasl;1000
                  = &frac38;
                </span>
              </li>
            </ul>
            ...
            <p>
              <strong className="text-white">Mixed numbers and improper fractions:</strong> A mixed
              number like 2&frac34; means 2 whole units and &frac34; of another. To convert to an
              improper fraction: (2 &times; 4 + 3)&frasl;4 = 11&frasl;4. This is useful when
              multiplying or dividing mixed numbers &mdash; always convert to improper fractions
              first.
            </p>

            <p>
              <strong className="text-white">Simplifying fractions:</strong> Divide both numerator
              and denominator by their highest common factor (HCF). For example, 12&frasl;18: HCF of
              12 and 18 is 6, so 12&frasl;18 = 2&frasl;3.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              quotation &mdash; you need to be confident with percentage calculations.
            </p>

            <p>
              <strong className="text-white">Finding a percentage of a value:</strong> To find X% of
              a number, multiply by X&frasl;100. For example, the maximum permitted voltage drop on
              a lighting circuit is 3% of the nominal supply voltage:
            </p>
            <div className="bg-white/5 rounded-lg p-4 font-mono text-sm text-green-300">
            ...
            <p>
              ...
              Divide the part by the whole, then multiply by 100. For example, if a cable carrying a
              load has a 5.2V drop on a 230V supply:
            </p>
            <div className="bg-white/5 rounded-lg p-4 font-mono text-sm text-green-300">
            ...
            <p>
              <strong className="text-white">Percentage increase and decrease:</strong> These are
              essential for understanding price changes and electrical efficiency. To increase a
              value by 20% (e.g. adding VAT): multiply by 1.20. To decrease by 15%: multiply by
              0.85.
            </p>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                + 40% of the remaining circuits, significantly reducing the total assumed demand for
                cable and protective device sizing.
              </p>
            </div>

            <p>
              <strong className="text-white">Efficiency calculations:</strong> Electrical efficiency
              is the ratio of useful power output to total power input, expressed as a percentage:
            </p>
            <div className="bg-white/5 rounded-lg p-4 font-mono text-sm text-green-300">
              Efficiency = (Power Out &divide; Power In) &times; 100%
            </div>
            <p>
              A motor with 1,800W input and 1,530W useful output has an efficiency of (1,530
              &divide; 1,800) &times; 100 = 85%. The remaining 15% is lost as heat, sound and
              vibration.
            </p>
            ...
            <ul className="space-y-2 pl-1">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  <strong className="text-white">10%:</strong> Divide by 10 (move decimal point one
                  place left)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  <strong className="text-white">5%:</strong> Find 10%, then halve it
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  <strong className="text-white">1%:</strong> Divide by 100 (move decimal point two
                  places left)
                </span>
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  <strong className="text-white">20%:</strong> Divide by 5 (useful for VAT
                  calculations)
                </span>
              </li>
            </ul>
            ...
            <p>
              <strong className="text-white">Reverse percentages:</strong> If a price including 20%
              VAT is &pound;360, what was the pre-VAT price? Divide by 1.20: &pound;360 &divide;
              1.20 = &pound;300. Do not simply subtract 20% of &pound;360 (&pound;72) &mdash; that
              would give &pound;288, which is incorrect.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            ...
            <p>
              <strong className="text-white">Why does BIDMAS matter for electricians?</strong>{' '}
              Electrical formulae often combine multiple operations. Consider calculating total
            ...
            <div className="bg-white/5 rounded-lg p-4 font-mono text-sm text-green-300">
              ...
              <p className="mt-1">Step 1 (Indices): 230&sup2; = 52,900</p>
              <p className="mt-1">Step 2 (Division): 52,900 &divide; 46 = 1,150W</p>
            </div>

            <p>
              If you mistakenly divided 230 by 46 first (getting 5), then squared the result
              (getting 25W), you would be wildly wrong. The correct answer is 1,150W &mdash; quite
              different from 25W!
            </p>
            ...
            <p>
              <strong className="text-white">Common mistake:</strong> Students often forget that
              multiplication and division have equal priority, as do addition and subtraction. When
              operations of equal priority appear together, work from left to right.
            </p>

            <p>
              <strong className="text-white">Nested brackets:</strong> When brackets appear inside
              other brackets, work from the innermost pair outward. For example: 3 &times; [(4 + 2)
              &times; 5] = 3 &times; (6 &times; 5) = 3 &times; 30 = 90.
            </p>

            <p>
              <strong className="text-white">Using your calculator correctly:</strong> Scientific
              calculators follow BIDMAS automatically, but basic calculators may not. If in doubt,
              use brackets on your calculator to force the correct order. For the power formula P =
              V&sup2;&divide;R, enter: (230) x&sup2; &divide; 46 =.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              when working with alternating current waveforms that swing between positive and
              negative values.
            </p>

            <p>
              <strong className="text-white">Rules for working with negative numbers:</strong>
            </p>
            <ul className="space-y-2 pl-1">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  <strong className="text-white">Adding a negative number</strong> is the same as
                  subtracting: 10 + (&minus;3) = 10 &minus; 3 = 7
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  <strong className="text-white">Subtracting a negative number</strong> is the same
                  as adding: 10 &minus; (&minus;3) = 10 + 3 = 13
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  <strong className="text-white">Multiplying/dividing:</strong> Same signs give a
                  positive result; different signs give a negative result
                </span>
              </li>
            </ul>
            ...
            <div className="bg-white/5 rounded-lg p-4">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                <div className="bg-green-500/10 rounded-lg p-2 text-center">
                  <p className="font-mono text-green-300">(+) &times; (+) = +</p>
                </div>
                <div className="bg-green-500/10 rounded-lg p-2 text-center">
                  <p className="font-mono text-green-300">(&minus;) &times; (&minus;) = +</p>
                </div>
                <div className="bg-red-500/10 rounded-lg p-2 text-center">
                  <p className="font-mono text-red-300">(+) &times; (&minus;) = &minus;</p>
                </div>
                <div className="bg-red-500/10 rounded-lg p-2 text-center">
                  <p className="font-mono text-red-300">(&minus;) &times; (+) = &minus;</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                current. Conversely, at higher temperatures like 45&deg;C the factor drops below 1
                (e.g. 0.79), requiring a larger cable to carry the same current safely.
              </p>
            </div>

            <p>
              <strong className="text-white">Number lines</strong> are a useful visual tool. Imagine
              a thermometer: temperatures above zero are positive, below zero are negative. Moving
              right (or up) increases the value; moving left (or down) decreases it.
            </p>

            <p>
              <strong className="text-white">Practical example:</strong> A cold store for a
              commercial installation has a temperature of &minus;18&deg;C. The cable route passes
              through a plant room at 35&deg;C before entering the cold store. The temperature
              difference is 35 &minus; (&minus;18) = 35 + 18 = 53&deg;C. This range must be
              considered when selecting cable insulation ratings and ensuring the cable can
              withstand thermal cycling.
            </p>

            <p>
              <strong className="text-white">AC waveforms:</strong> An alternating current
              constantly switches between positive and negative values. The peak voltage of UK mains
              is approximately +325V to &minus;325V (the 230V figure is the RMS value). When
              studying three-phase systems, understanding positive and negative values becomes even
              more critical.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              quantities, or to express test results to an appropriate number of decimal places.
            </p>
            ...
            <ul className="space-y-2 pl-1">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Look at the digit to the right of your rounding position</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>If it is 5 or above, round up; if 4 or below, round down</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  For fuse/MCB selection, always round <em>up</em> to the next standard rating
                  (never down)
                </span>
              </li>
            </ul>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                or fail to protect the circuit properly.
              </p>
            </div>

            <p>
              <strong className="text-white">Estimation</strong> is a powerful tool for checking
              whether your calculated answer is reasonable. Round each number to one significant
              figure, then do the calculation mentally:
            </p>
            ...
            <p>
              <strong className="text-white">When to use estimation on site:</strong>
            </p>
            <ul className="space-y-2 pl-1">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Quickly checking a supplier&rsquo;s quote for materials</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Estimating how much cable to order before doing the precise take-off</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Verifying calculator results &mdash; if the estimate and the calculated answer are
                  far apart, you may have made a keying error
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Giving a customer a rough idea of costs before preparing a formal quotation
                </span>
              </li>
            </ul>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            ...
            <p>
              <strong className="text-white">Step 1 &mdash; Cable measurement (decimals):</strong>{' '}
              Measure the cable runs. The ring circuit totals 28.5m of 2.5&thinsp;mm&sup2;
              twin-and-earth. The cooker circuit needs 12.75m of 6&thinsp;mm&sup2;. The lighting
              circuit requires 15.3m of 1.5&thinsp;mm&sup2;. The extractor spur needs 4.8m of
              2.5&thinsp;mm&sup2;.
            </p>
            ...
            <ul className="space-y-2 pl-1">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  2.5&thinsp;mm&sup2; cable: (28.5 + 4.8)m = 33.3m at &pound;0.85/m = &pound;28.31
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>6&thinsp;mm&sup2; cable: 12.75m at &pound;1.95/m = &pound;24.86</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>1.5&thinsp;mm&sup2; cable: 15.3m at &pound;0.55/m = &pound;8.42</span>
              </li>
            </ul>
            ...
            <p>
              ...
              Add 10% for wastage and off-cuts. Total cable cost = &pound;28.31 + &pound;24.86 +
              &pound;8.42 = &pound;61.59. With 10% wastage: &pound;61.59 &times; 1.10 =
              &pound;67.75.
            </p>

            <p>
              <strong className="text-white">Step 4 &mdash; Estimate check (rounding):</strong>{' '}
              Quick estimate: roughly &pound;30 + &pound;25 + &pound;8 = &pound;63, plus 10% &asymp;
              &pound;69. Our calculated &pound;67.75 is close &mdash; confidence the arithmetic is
              correct.
            </p>
            ...
            <p>
              ...
              If the total job (materials + labour) comes to &pound;485.00, the VAT = &pound;485.00
              &times; 0.20 = &pound;97.00. Grand total = &pound;582.00. Always show VAT separately
              on your invoices.
            </p>
            ...
            <p>
              ...
              The cooker has a rated current of 28.7A. Using BIDMAS with the power formula: I = P
              &divide; V = 6,600 &divide; 230 = 28.7A. Select the next standard BS 88 fuse rating:
              32A. The ring circuit is protected by a 32A device as standard.
            </p>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                and your accuracy on site will improve dramatically.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        {/* Quiz */}
        <Quiz questions={quizQuestions} title="Number Systems & Arithmetic Quiz" />
