...
const quickCheckQuestions = [
  {
    ...
    options: ['Quadruples', 'Stays the same', 'Doubles', 'Halves'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['At DC only', '50 Hz only', 'Above 1 kHz', 'Below 10 Hz'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Hysteresis loss', 'Resistive loss', 'Stray loss', 'Eddy current loss'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['2500W', '2000W', '500W', '1500W'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['13.5kW', '15kW', '18kW', '16.67kW'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['IE1 Standard', 'IE2 High', 'IE4 Super Premium', 'IE3 Premium'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS 7671 132.5 forces conductor sizing against Iz, In and voltage drop — all of which
              are driven by I&sup2;R loss. Choosing a larger cable than the minimum for a long
              submain or constantly-loaded supply lowers I&sup2;R loss quadratically over the
              cable&rsquo;s 25-year life &mdash; one of the cheapest energy-efficiency interventions
              on a BSE design and an explicit Part L 2021 design consideration on commercial
              buildings.
            </>
          }
        ...
        <ConceptBlock title="In 30 seconds">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>I²R losses:</strong> Heat in conductors, proportional to current squared
            </li>
            <li>
              <strong>Eddy currents:</strong> Circulating currents in cores, reduced by laminations
            </li>
            <li>
              <strong>Hysteresis:</strong> Energy lost reversing magnetic domains each cycle
            </li>
            <li>
              <strong>Total losses:</strong> Copper losses + iron losses = wasted energy as heat
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Building Services Context</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cable sizing:</strong> Limits based on I²R heating
            </li>
            <li>
              <strong>Transformer selection:</strong> Iron vs copper loss balance
            </li>
            <li>
              <strong>Motor efficiency:</strong> IE classes and regulations
            </li>
            <li>
              <strong>Energy costs:</strong> Losses directly impact running costs
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Resistive Losses (I²R) - Joule Heating">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">The Power Loss Equation</p>
          <p>
            <strong>
              P<sub>loss</sub> = I² × R
            </strong>
          </p>
          <p>Where I = current (A), R = resistance (Ω), P = power loss (W)</p>

          <p className="text-sm font-medium text-white">Key characteristics of I²R losses:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            The squared relationship is crucial. A circuit carrying 20A has four times the losses of
            one carrying 10A through the same resistance. This is why high-current circuits require
            proportionally larger cables - not just for current capacity, but to reduce losses and
            heat generation.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">I²R Loss Calculation for Cables</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single-phase</strong> — P = 2 × I² × r × L — ×2 for line and neutral
            </li>
            <li>
              <strong>Three-phase balanced</strong> — P = 3 × I² × r × L — Neutral carries no
              current
            </li>
            <li>
              <strong>DC circuit</strong> — P = 2 × I² × r × L — Positive and negative
            </li>
          </ul>
        ...
        <ConceptBlock title="Skin Effect at High Frequencies">
          ...
          <p>Where δ = skin depth (m), ρ = resistivity, f = frequency, μ = permeability</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>50 Hz</strong> — 9.4 mm — Mains frequency - minimal effect
            </li>
            <li>
              <strong>1 kHz</strong> — 2.1 mm — Harmonic frequencies
            </li>
            <li>
              <strong>10 kHz</strong> — 0.66 mm — VSD switching frequencies
            </li>
            <li>
              <strong>100 kHz</strong> — 0.21 mm — SMPS, high-frequency inverters
            </li>
          </ul>
          ...
          <p>
            Related to skin effect, proximity effect occurs when conductors carrying AC are close
            together. The magnetic field from one conductor distorts current distribution in
            adjacent conductors, further increasing effective resistance. This is significant in
            transformer windings and parallel cables.
          </p>

          <p>
            <strong>Practical note:</strong> At 50 Hz, skin effect is negligible for cables up to
            about 150mm². For larger conductors or harmonic-rich environments, consult manufacturer
            AC resistance data.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Eddy Current Losses in Magnetic Cores">
          <p>
            ...
            circulating currents within that material - these are eddy currents. Named because they
            flow in closed loops like eddies in water, they cause I²R heating in the core material.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Eddy Current Loss Formula</p>
          <p>
            <strong>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Proportional to t²:</strong> Thinner laminations dramatically reduce losses
            </li>
            <li>
              <strong>Induced by changing flux:</strong> Faraday's law of electromagnetic induction
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Power transformers (50 Hz)</strong> — 0.35-0.5 mm — Grain-oriented silicon
              steel
            </li>
            <li>
              <strong>Distribution transformers</strong> — 0.27-0.35 mm — Cold-rolled silicon steel
            </li>
            <li>
              <strong>Motor cores</strong> — 0.35-0.65 mm — Non-oriented silicon steel
            </li>
            <li>
              <strong>High-frequency (&gt;400 Hz)</strong> — 0.1-0.2 mm or ferrite — Thin steel or
              ferrite cores
            </li>
          </ul>
          ...
          <p>
            Laminations break the core into thin sheets with insulating coatings between them. This
            creates high resistance paths perpendicular to the flux direction, where eddy currents
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Halving lamination thickness reduces losses by factor of 4 (t² relationship)</li>
          </ul>
        ...
        <ConceptBlock title="Hysteresis Losses in Magnetic Materials">
          <p>
            ...
            half-cycle, and each reversal requires energy to realign the magnetic domains within the
            material.
          </p>
          ...
          <p className="text-sm font-medium text-white">Understanding the B-H Hysteresis Loop:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Soft Magnetic Materials</p>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Hard Magnetic Materials</p>
          ...
          <p>
            ...
            currents) and narrows the hysteresis loop (reducing hysteresis losses). However, silicon
            also makes the steel more brittle and harder to work. Grain-oriented silicon steel has
            even lower losses when the flux is aligned with the grain direction.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Comparing Core Materials</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Standard silicon steel</strong> — 2.5-4.0 — Motors, small transformers
            </li>
            <li>
              <strong>Grain-oriented (GOES)</strong> — 0.8-1.2 — Power transformers
            </li>
            <li>
              <strong>Hi-B grade GOES</strong> — 0.7-0.9 — High-efficiency transformers
            </li>
            <li>
              <strong>Amorphous metal</strong> — 0.2-0.3 — Premium efficiency transformers
            </li>
          </ul>
          ...
          <p>
            ...
            comparable; at higher frequencies, eddy current losses dominate unless special materials
            are used.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Stray Losses in Electrical Machines">
          <p>
            ...
            calculated I²R and core losses. They are difficult to measure directly and are typically
            determined by subtracting known losses from total losses measured during testing.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Harmonic losses:</strong> Non-sinusoidal flux causing additional core heating
            </li>
            <li>
              <strong>Slot leakage:</strong> Flux crossing slots in motor/generator cores
            </li>
            <li>
              <strong>End-winding losses:</strong> Eddy currents in structural parts near windings
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stator I²R</strong> — 25-40% — Load (current squared)
            </li>
            <li>
              <strong>Rotor I²R</strong> — 15-25% — Load (slip, current)
            </li>
            <li>
              <strong>Core losses</strong> — 15-25% — Constant (voltage dependent)
            </li>
            <li>
              <strong>Friction & windage</strong> — 5-15% — Speed
            </li>
            <li>
              <strong>Stray load losses</strong> — 10-15% — Load (approximately I²)
            </li>
          </ul>
        ...
        <ConceptBlock title="Cable Losses and Derating">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ambient temperature</strong> — C<sub>a</sub> — 0.71 - 1.0
            </li>
            <li>
              <strong>Grouping</strong> — C<sub>g</sub> — 0.40 - 1.0
            </li>
            <li>
              <strong>Thermal insulation</strong> — C<sub>i</sub> — 0.5 - 1.0
            </li>
            <li>
              <strong>Soil thermal resistivity</strong> — C<sub>s</sub> — 0.85 - 1.0
            </li>
          </ul>
          <p className="text-xs text-white mt-2">
          ...
          <p>
            Each cable generates I²R heat. When cables are grouped together (in trunking, conduit,
            or trays), they share the surrounding air space. The heat from one cable warms adjacent
            cables, reducing their ability to dissipate their own heat. The grouping factor
            compensates for this mutual heating.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Cable Loss Calculation Example</p>

          <p className="text-sm font-mono text-white mb-2">
            <strong>Problem:</strong> Calculate power loss in a 50m single-phase circuit using 4mm²
            cable carrying 25A
          </p>
          ...
          <p className="text-sm font-medium text-white">Factors Affecting Cable Losses</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Reducing Losses Through Design">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Increase conductor size:</strong> Halving resistance halves losses (but cost
              increases)
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Life Cycle Cost Analysis</p>
          <p>
            Higher-efficiency equipment typically costs more to purchase but less to operate. The
            total cost of ownership includes both capital and running costs.
          </p>
        ...
        <ConceptBlock title="Building Services: Cable Sizing, Transformer Losses, Motor Efficiency">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>20A continuous</strong> — 2.5mm² — 4mm² — ~40%
            </li>
            <li>
              <strong>32A continuous</strong> — 4mm² — 6mm² — ~35%
            </li>
            <li>
              <strong>63A continuous</strong> — 16mm² — 25mm² — ~35%
            </li>
          </ul>
          ...
          <p>
            ...
            significantly impacts energy costs. The EU Ecodesign Directive sets minimum efficiency
            requirements.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Transformer Loss Categories</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>100</strong> — 70 — 1,250
            </li>
            <li>
              <strong>250</strong> — 140 — 2,350
            </li>
            <li>
              <strong>630</strong> — 270 — 4,600
            </li>
            <li>
              <strong>1000</strong> — 380 — 6,500
            </li>
          </ul>
          <p className="text-xs text-white mt-2">
          ...
          <p>
            Motors are the largest single electrical load in most commercial buildings (HVAC, pumps,
            lifts). IEC 60034-30-1 defines efficiency classes, with EU regulations mandating minimum
            standards.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>IE1</strong> — Standard — 87.0%
            </li>
            <li>
              <strong>IE2</strong> — High — 89.1%
            </li>
            <li>
              <strong>IE3</strong> — Premium — 90.7%
            </li>
            <li>
              <strong>IE4</strong> — Super Premium — 92.0%
            </li>
            <li>
              <strong>IE5</strong> — Ultra Premium — 93.5%
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>VSD-driven motors can be IE2 if drive + motor meets system efficiency</li>
            <li>Some applications (hazardous areas, high altitude) have exemptions</li>
          </ul>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>→ Upgrading to 10mm² would reduce losses by ~45%</p>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Example 4: Core Loss Analysis</p>
          <p>
            <strong>Question:</strong> A transformer core has total iron losses of 800W at 50Hz. If
            hysteresis losses are 60% of total, calculate the losses at 60Hz (same flux density).
          </p>
          ...
          <p className="text-white">→ 30% increase in losses from 20% frequency increase</p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A new commercial building has a 200 m main supply cable from the DNO substation to the
              LV switchroom carrying 400 A continuous. Standard cable size from the load calc is 240
              mm&sup2; copper SWA (Iz adequate). The design engineer evaluates upsizing to 300
              mm&sup2; or 400 mm&sup2; on lifecycle-cost grounds.
            </>
          }
          whatToDo={
            <>
              Calculate I&sup2;R loss for each option. R per phase per metre approx: 240 mm&sup2; =
              0.0754 m&Omega;/m; 300 mm&sup2; = 0.0601 m&Omega;/m; 400 mm&sup2; = 0.0470 m&Omega;/m.
              Loss per metre at 400 A 3-phase = 3 &times; 400&sup2; &times; R. Annual loss (8000
              hours operation) = 240 mm&sup2; ~58 MWh; 300 mm&sup2; ~46 MWh; 400 mm&sup2; ~36 MWh.
              Lifecycle saving 240&rarr;400 = ~22 MWh/year &asymp; &pound;4400/year at 20 p/kWh
              &mdash; payback typically 4&ndash;6 years on the cable cost differential. Specify 400
              mm&sup2; and document the analysis.
            </>
          }
          whyItMatters={
            <>
              Long main-supply cables are huge lifetime energy sinks because they run continuously.
              The HNC engineer who runs the lifecycle analysis converts a 4&ndash;6 year payback
              into 20 years of cumulative saving and feeds that into the building&rsquo;s SAP / SBEM
              evidence. Building Regs Part L 2021 explicitly expects this analysis on commercial
              supplies.
            </>
          }
        />
