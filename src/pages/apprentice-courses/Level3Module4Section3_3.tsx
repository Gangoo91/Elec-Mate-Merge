      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Understanding MCB, RCD, and RCBO operation and diagnosing trip causes
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Differentiate between thermal and magnetic MCB operation",
              "Diagnose causes of RCD nuisance tripping",
              "Understand cumulative earth leakage effects",
              "Apply the half-split method to locate tripping faults",
              "Verify protective device operation is correct",
              "Recommend appropriate solutions for recurring trips"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module4-section3-2">
              <ArrowLeft className="w-4 h-4 mr-2" />
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module4-section3-4">
