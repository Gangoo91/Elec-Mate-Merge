      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>M&T:</strong> Compare actual vs expected energy performance
              </li>
              <li className="pl-1">
                <strong>Degree days:</strong> Weather normalisation for fair comparison
              </li>
              <li className="pl-1">
                <strong>Cusum charts:</strong> Visualise cumulative performance trends
              </li>
              <li className="pl-1">
                <strong>Exception reporting:</strong> Alert when variance exceeds threshold
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>UK base temp:</strong> 15.5°C for heating degree days
              </li>
              <li className="pl-1">
                <strong>Performance line:</strong> E = (m × DD) + c
              </li>
              <li className="pl-1">
                <strong>Threshold:</strong> Typically 5-10% variance
              </li>
              <li className="pl-1">
                <strong>Baseline:</strong> Minimum 12 months data
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Normalise:</strong> Adjust for weather, occupancy, and production
                  variations
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Report:</strong> Generate exception alerts when variances exceed
                  thresholds
                </li>
                <li className="pl-1">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Occupancy, hours, production data
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Separate heating, lighting, processes
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        High internal gains from IT, people
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        UK default, moderate internal gains
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Lower gains, higher comfort expectations
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Higher comfort, ventilation requirements
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              days using linear regression. This enables prediction of expected consumption for any
              weather condition and forms the basis for target setting and variance analysis.
            </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Interpreting the Performance Line
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Slope (m):</strong> Represents thermal performance - steeper slope means
                  more energy per degree day (poorer building fabric or higher ventilation losses)
                </li>
                <li className="pl-1">
                  <strong>Intercept (c):</strong> Base load consumption - lighting, equipment,
                  domestic hot water, processes that occur regardless of weather
                </li>
                <li className="pl-1">
                  <strong>R² value:</strong> Coefficient of determination - indicates how well the
                  line fits data (aim for R² &gt; 0.9)
                </li>
                <li className="pl-1">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Review base temp, check data quality
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Performance Line Calculation Example
              </p>
              <div className="text-sm space-y-2">
                ...
                <p className="text-red-400 mt-2">
                  This exceeds typical 10% threshold - exception report triggered
                </p>
              </div>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              insulation or controls improvements have not worked. A shallower slope confirms
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                Cusum Chart Calculation Example
              </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Discrete event increased consumption
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        New equipment, system fault, occupancy change
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Sudden step down</td>
                      <td className="border border-white/10 px-3 py-2">
                        Discrete event reduced consumption
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Energy saving measure, equipment removed
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Control deterioration, maintenance needs
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Wrong base temp, unaccounted solar gain
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Establishing a Performance Baseline
              </h3>
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="ml-4 text-green-400">
                  R² of 0.94 confirms reliable baseline for targeting
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Weather Normalised Comparison
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-yellow-400">
                  Conclusion: Performance similar - reduction was weather-related, not efficiency
                  gain
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Cusum Analysis Identifying a Problem
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  Action: Correct time clock settings - savings verified in subsequent weeks
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 4: Target Setting with Improvement Factor
              </h3>
              <p className="text-sm text-white mb-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Ignoring base temperature optimisation</strong> - Wrong base temp gives
                  poor correlation
                </li>
                <li className="pl-1">
