...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['750 kWh', '1,950 kWh', '1,200 kWh', '3,600 kWh'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ISO 50006 is the methodology underpinning ISO 50001 M&T — defining EnPIs (e.g. kWh/m²,
              kWh/HDD), baselines, and the requirement to investigate deviations. Without baselines
              and normalisation, energy data is just numbers; with them, it is a management tool.
            </>
          }
        ...
        <ConceptBlock title="M&T Fundamentals and Baseline Establishment">
          ...
          <p>
            <strong>The M&T Process Cycle:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Monitor:</strong> Collect consumption data at appropriate intervals
              (weekly/daily/half-hourly)
            </li>
            <li>
              <strong>Normalise:</strong> Adjust for weather, occupancy, and production variations
            </li>
            <li>
              <strong>Compare:</strong> Assess actual performance against targets
            </li>
            <li>
              <strong>Report:</strong> Generate exception alerts when variances exceed thresholds
            </li>
            <li>
              <strong>Act:</strong> Investigate causes and implement corrective measures
            </li>
          </ul>
          <p>
            <strong>Baseline Establishment Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Data period:</strong> Capture seasonal variation — 12 months minimum
            </li>
            <li>
              <strong>Data quality:</strong> Reliable analysis — Actual readings, not estimates
            </li>
            <li>
              <strong>Weather data:</strong> Enable normalisation — Local degree day records
            </li>
            <li>
              <strong>Operating conditions:</strong> Context for analysis — Occupancy, hours,
              production data
            </li>
            <li>
              <strong>Sub-metering:</strong> Identify specific loads — Separate heating, lighting,
              processes
            </li>
          </ul>
          <p>
            <strong>Key principle:</strong> M&T answers "Are we using more or less energy than we
            should for the conditions?" rather than simply "How much energy did we use?"
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Degree Day Analysis and Weather Normalisation">
          <p>
            ...
            consumption across different periods. Without weather normalisation, comparing January's
            consumption to July's would be meaningless for heating analysis.
          </p>
          <p>
            <strong>Heating Degree Days (HDD)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Cooling Degree Days (CDD)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Degree Day Calculation Example</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Base temperature:</strong> 15.5°C (UK standard)
            </li>
            <li>
              <strong>Day 1 mean temp:</strong> 8°C → HDD = 15.5 - 8 = 7.5
            </li>
            <li>
              <strong>Day 2 mean temp:</strong> 12°C → HDD = 15.5 - 12 = 3.5
            </li>
            <li>
              <strong>Day 3 mean temp:</strong> 16°C → HDD = 0 (no heating needed)
            </li>
            <li>
              <strong>3-day total:</strong> 7.5 + 3.5 + 0 = 11 degree days
            </li>
          </ul>
          <p>
            <strong>Base Temperature Selection</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Dense office:</strong> 14-15°C — High internal gains from IT, people
            </li>
            <li>
              <strong>Standard commercial:</strong> 15.5°C — UK default, moderate internal gains
            </li>
            <li>
              <strong>Residential:</strong> 15.5-16°C — Lower gains, higher comfort expectations
            </li>
            <li>
              <strong>Warehouse:</strong> 12-14°C — Lower temperature requirement
            </li>
            <li>
              <strong>Hospital:</strong> 16-17°C — Higher comfort, ventilation requirements
            </li>
          </ul>
          <p>
            <strong>Optimisation tip:</strong> The correct base temperature gives the highest R²
            correlation. Try different values (14-17°C) and select the one producing the best
            regression fit.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Performance Lines and Regression Analysis">
          <p>
            Performance lines establish the relationship between energy consumption and degree days
            using linear regression. This enables prediction of expected consumption for any weather
            condition and forms the basis for target setting and variance analysis.
          </p>
          <p>
            <strong>Performance Line Equation</strong>
          </p>
          <p>E = (m × DD) + c</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>E =</strong> Energy consumption (kWh, kWh/m², or therms)
            </li>
            <li>
              <strong>m =</strong> Slope (weather sensitivity, kWh per degree day)
            </li>
            <li>
              <strong>DD =</strong> Degree days for the period
            </li>
            <li>
              <strong>c =</strong> Y-intercept (base load, weather-independent consumption)
            </li>
          </ul>
          <p>
            <strong>Interpreting the Performance Line</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Slope (m):</strong> Represents thermal performance - steeper slope means more
              energy per degree day (poorer building fabric or higher ventilation losses)
            </li>
            <li>
              <strong>Intercept (c):</strong> Base load consumption - lighting, equipment, domestic
              hot water, processes that occur regardless of weather
            </li>
            <li>
              <strong>R² value:</strong> Coefficient of determination - indicates how well the line
              fits data (aim for R² &gt; 0.9)
            </li>
            <li>
              <strong>Scatter:</strong> Spread of points around the line - wide scatter suggests
              other influencing factors
            </li>
          </ul>
          <p>
            <strong>Regression Analysis Quality Indicators</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>&gt; 0.95:</strong> Excellent correlation — High confidence in predictions
            </li>
            <li>
              <strong>0.85 - 0.95:</strong> Good correlation — Acceptable for M&T purposes
            </li>
            <li>
              <strong>0.70 - 0.85:</strong> Moderate correlation — Consider other influencing
              factors
            </li>
            <li>
              <strong>&lt; 0.70:</strong> Poor correlation — Review base temp, check data quality
            </li>
          </ul>
          <p>
            <strong>Performance Line Calculation Example</strong>
          </p>
          <p>
            <strong>Given regression result:</strong> E = 2.8DD + 850 (kWh/week)
          </p>
          <p>
            <strong>February week:</strong> 95 degree days
          </p>
          <p>
            <strong>Expected consumption:</strong> (2.8 × 95) + 850 = 266 + 850 = 1,116 kWh
          </p>
          <p>
            <strong>Actual consumption:</strong> 1,280 kWh
          </p>
          <p>
            <strong>Variance:</strong> 1,280 - 1,116 = +164 kWh (14.7% over target)
          </p>
          <p>This exceeds typical 10% threshold - exception report triggered</p>
          <p>
            <strong>Improvement indicator:</strong> A steeper slope after retrofit suggests
            insulation or controls improvements have not worked. A shallower slope confirms reduced
            weather sensitivity.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Cusum Charts and Exception Reporting">
          <p>
            ...
            performance trends. By plotting the running total of variances (actual minus expected),
            cusum charts reveal patterns that might be obscured in raw consumption data.
          </p>
          <p>
            <strong>Cusum Calculation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Interpreting Cusum Slope</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Cusum Chart Calculation Example</strong>
          </p>
          <p>Pattern shows over-consumption corrected by Week 5</p>
          <p>
            <strong>Cusum Pattern Recognition</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sudden step up:</strong> Discrete event increased consumption — New equipment,
              system fault, occupancy change
            </li>
            <li>
              <strong>Sudden step down:</strong> Discrete event reduced consumption — Energy saving
              measure, equipment removed
            </li>
            <li>
              <strong>Gradual upward drift:</strong> Progressive degradation — Control
              deterioration, maintenance needs
            </li>
            <li>
              <strong>Seasonal oscillation:</strong> Weather correlation issues — Wrong base temp,
              unaccounted solar gain
            </li>
          </ul>
          <p>
            <strong>Exception Reporting Framework</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Threshold setting:</strong> Typically 5-10% of expected consumption
            </li>
            <li>
              <strong>Alert mechanism:</strong> Automatic notification when threshold exceeded
            </li>
            <li>
              <strong>Investigation protocol:</strong> Defined steps to identify root cause
            </li>
            <li>
              <strong>Action tracking:</strong> Record corrective measures and outcomes
            </li>
            <li>
              <strong>Escalation:</strong> Procedures for persistent or severe exceptions
            </li>
          </ul>
          <p>
            <strong>Best practice:</strong> Set initial thresholds conservatively (10%) then tighten
            as the system matures and noise sources are eliminated.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Compare January consumption between two years with different
            weather.
          </p>
          ...
          <p>
            Conclusion: Performance similar - reduction was weather-related, not efficiency gain
          </p>
          <p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              UK heating base temperature: <strong>15.5°C</strong>
            </li>
            <li>
              Good R² correlation: <strong>&gt; 0.85</strong>
            </li>
            <li>
              Typical exception threshold: <strong>5-10%</strong>
            </li>
            <li>
              Baseline period: <strong>12 months minimum</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Ignoring base temperature optimisation</strong> - Wrong base temp gives poor
                correlation
              </li>
              <li>
                <strong>Using estimated meter readings</strong> - Actual readings essential for
                accuracy
              </li>
              <li>
                <strong>Setting thresholds too tight initially</strong> - Creates alert fatigue
              </li>
              <li>
                <strong>Not investigating exceptions</strong> - Reports are useless without action
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A 6,000 m² office has run M&T for 3 years with weekly cusum charts. After an FM
              contract handover, the cusum on heating gas suddenly turns sharply upward —
              accumulating 18% above baseline over 8 weeks despite no occupancy or weather change.
            </>
          }
          whatToDo={
            <>
              Investigate immediately — the cusum shape suggests sustained schedule change, not a
              one-off event. Check BMS heating schedules: most likely (1) new FM team has reset
              weekend setback to occupied, or (2) optimisation start time has moved earlier "to be
              safe", or (3) summer cooling/heating changeover not implemented. Reset to commissioned
              strategy, document the cause, and use as training material with the new FM team.
              Report the saved energy in the next M&T report.
            </>
          }
          whyItMatters={
            <>
              M&T catches operational drift that no one would otherwise notice — schedule changes,
              control overrides, insulation damage, thermostat tampering. The cusum shape (sudden
              step, gradual drift, periodic spike) tells you what kind of cause to look for. Without
              M&T, drift accumulates silently for years.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">ISO 50001</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
