      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>MVHR:</strong> Mechanical ventilation with heat recovery
              </li>
              <li className="pl-1">
                <strong>Efficiency:</strong> 70-95% heat recovery achievable
              </li>
              <li className="pl-1">
                <strong>Part L requirement:</strong> Minimum 70% efficiency
              </li>
              <li className="pl-1">
                <strong>SFP limit:</strong> Typically 1.0 W/(l/s) maximum
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Plate exchangers:</strong> 70-95% efficiency, no moving parts
              </li>
              <li className="pl-1">
                <strong>Thermal wheels:</strong> 75-85% efficiency, enthalpy recovery
              </li>
              <li className="pl-1">
                <strong>Run-around coils:</strong> 45-55% efficiency, zero cross-contamination
              </li>
              <li className="pl-1">
                <strong>Heat pipes:</strong> 50-70% efficiency, passive operation
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Mechanical Ventilation with Heat Recovery (MVHR) systems provide controlled
              ventilation whilst recovering heat from exhaust air. This significantly reduces
              heating energy demand in well-insulated, airtight buildings - making MVHR essential
              for meeting modern Building Regulations energy targets.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-green-500/10 border border-green-500/30">
              ...
              <p className="text-sm text-white">
                ...
                and removing moisture, reducing condensation and mould risk.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-3">
                Thermal Wheels (Rotary Heat Exchangers)
              </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Heat Recovery Technology Comparison
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2 text-green-400">0%</td>
                      <td className="border border-white/10 px-3 py-2">
                        Process exhaust, passive systems
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              applications. Use run-around coils where contamination must be avoided. Consider
              thermal wheels for high-humidity applications requiring moisture recovery.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              protecting equipment and maintaining comfort. This includes frost protection in
              winter, summer bypass for free cooling, and demand-controlled ventilation.
            </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        CO₂ sensor (target 800-1000 ppm)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Offices, schools, meeting rooms
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Humidity-based</td>
                      <td className="border border-white/10 px-3 py-2">
                        RH sensor (target 40-60%)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Bathrooms, kitchens, wet rooms
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Manual switch or automatic
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Cooking, showering events
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">
                    <strong>Airflow measurement:</strong> Verify supply and extract rates at each
                    terminal
                  </li>
                  <li className="pl-1">
                  ...
                  <li className="pl-1">
                    <strong>Temperature test:</strong> Measure heat recovery efficiency under
                    steady-state
                  </li>
                  <li className="pl-1">
                  ...
                  <li className="pl-1">
                    <strong>Controls verification:</strong> Test boost, bypass, frost protection
                    functions
                  </li>
                  <li className="pl-1">
                  ...
                  <li className="pl-1">
                    <strong>Documentation:</strong> Record all settings and provide to building
                    owner
                  </li>
                </ul>
              </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Part L compliance:</strong> Commissioning results must be recorded and
              submitted as part of Building Regulations compliance evidence. Include measured SFP,
              heat recovery efficiency, and airflow rates.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Heat Recovery Efficiency Calculation
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> An MVHR unit is tested with outdoor air at -2°C, extract
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-green-400">
                  This exceeds the Part L minimum of 70% - compliant
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Annual Energy Savings Calculation
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> Calculate annual heating energy saved by an MVHR system
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Specific Fan Power Calculation
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 4: Dwelling MVHR Sizing
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> Size an MVHR system for a 3-bedroom dwelling with 1
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Recovered heat:</strong> Q = V̇ × ρ × Cp × ΔT × η (where V̇ = volume flow
                  rate)
                </li>
                <li className="pl-1">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Use rigid ductwork where possible (lower resistance than flexible)
                </li>
