...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Defrost cycle', 'Supply air modulation', 'Recirculation', 'Pre-heater'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.5 W/(l/s)', '1.5 W/(l/s)', '1.0 W/(l/s)', '2.0 W/(l/s)'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['3.0 kW', '2.1 kW', '4.5 kW', '1.0 kW'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="MVHR Principles and Building Regulations">
          <p>
            Mechanical Ventilation with Heat Recovery (MVHR) systems provide controlled ventilation
            whilst recovering heat from exhaust air. This significantly reduces heating energy
            demand in well-insulated, airtight buildings - making MVHR essential for meeting modern
            Building Regulations energy targets.
          </p>
          <p>
            <strong>How MVHR Works</strong>
          </p>
          <p>Extract Side</p>
          ...
          <p>
            <strong>Building Regulations Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ventilation rate:</strong> Based on wet room count — -
            </li>
            <li>
              <strong>Heat recovery efficiency:</strong> - — &gt;70% (typical requirement)
            </li>
            <li>
              <strong>Specific fan power:</strong> - — &lt;1.0 W/(l/s) domestic
            </li>
            <li>
              <strong>Airtightness:</strong> Required for System 4 — &lt;5 m³/h.m² at 50Pa
            </li>
            <li>
              <strong>Commissioning:</strong> Airflow measurement required — Performance
              verification
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Key requirement:</strong> MVHR only works effectively in airtight buildings.
            Uncontrolled air leakage bypasses the heat recovery system entirely.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Plate Heat Exchangers">
          <p>
            Plate heat exchangers are the most common heat recovery technology in MVHR systems. They
            use thin metal or plastic plates to separate the extract and supply air streams,
            allowing heat transfer by conduction without air mixing.
          </p>
          <p>
            <strong>Types of Plate Heat Exchangers</strong>
          </p>
          ...
          <p>
            <strong>Plate Heat Exchanger Specifications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heat recovery efficiency:</strong> 50-75% — 75-95%
            </li>
            <li>
              <strong>Plate material:</strong> Aluminium or plastic — Aluminium or polystyrene
            </li>
            <li>
              <strong>Pressure drop:</strong> 50-150 Pa — 100-250 Pa
            </li>
            <li>
              <strong>Cross-contamination:</strong> &lt;1% (leakage) — &lt;1% (leakage)
            </li>
            <li>
              <strong>Moisture transfer:</strong> Sensible only (standard) — Enthalpy (membrane
              types)
            </li>
            <li>
              <strong>Maintenance:</strong> Washable, annual clean — Washable, annual clean
            </li>
          </ul>
          <p>
          ...
          <p>
            η = (17 - 0) / (21 - 0) × 100% = <strong>81%</strong>
          </p>
          <p>
            <strong>Selection tip:</strong> Counter-flow exchangers are essential to meet Part L
            efficiency requirements. Plastic plate exchangers offer better frost resistance than
            aluminium.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Thermal Wheels and Run-Around Coils">
          ...
          <p>
            <strong>Thermal Wheels (Rotary Heat Exchangers)</strong>
          </p>
          ...
          <p>
            <strong>Run-Around Coils</strong>
          </p>
          ...
          <p>
            <strong>Heat Recovery Technology Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Counter-flow plate:</strong> 75-95% — &lt;1% — Dwellings, offices
            </li>
            <li>
              <strong>Cross-flow plate:</strong> 50-75% — &lt;1% — Compact installations
            </li>
            <li>
              <strong>Thermal wheel:</strong> 75-85% — 2-5% — Swimming pools, humid spaces
            </li>
            <li>
              <strong>Run-around coils:</strong> 45-55% — 0% — Hospitals, laboratories
            </li>
            <li>
              <strong>Heat pipes:</strong> 50-70% — 0% — Process exhaust, passive systems
            </li>
          </ul>
          <p>
            <strong>Heat Pipe Systems</strong>
          </p>
          <p>
            ...
            Common in industrial exhaust applications where reliability and simplicity are
            paramount.
          </p>
          <p>
            <strong>Selection guidance:</strong> Choose plate exchangers for most comfort
            applications. Use run-around coils where contamination must be avoided. Consider thermal
            wheels for high-humidity applications requiring moisture recovery.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Efficiency, Control and Frost Protection">
          ...
          <p>
            <strong>Frost Protection Methods</strong>
          </p>
          <p>
          ...
          <p>
            ...
            exchanger. Simple and effective but uses energy, partially offsetting heat recovery
            savings. Typically activates below -5°C outdoor temperature.
          </p>
          ...
          <p>Defrost Cycle</p>
          <p>
            Periodically bypasses heat recovery or reverses airflow to melt ice. Can cause temporary
            discomfort as cold air enters. Some systems use exhaust air recirculation during defrost
            periods.
          </p>
          <p>Earth Tube Pre-Heating</p>
          <p>
            Outdoor air passes through buried tubes, pre-tempered by ground heat (8-12°C
            year-round). Passive, zero-energy frost protection but requires significant excavation.
            Also provides summer pre-cooling benefit.
          </p>
          <p>
            <strong>Summer Bypass Operation</strong>
          </p>
          <p>
            When outdoor temperature is lower than indoor temperature, heat recovery is undesirable
            - it would heat incoming air that is already cooler than required. A summer bypass
            allows fresh air to enter directly, providing free cooling.
          </p>
          <p>
            <strong>Bypass Activation Conditions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Demand-Controlled Ventilation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>CO₂-based:</strong> CO₂ sensor (target 800-1000 ppm) — Offices, schools,
              meeting rooms
            </li>
            <li>
              <strong>Humidity-based:</strong> RH sensor (target 40-60%) — Bathrooms, kitchens, wet
              rooms
            </li>
            <li>
              <strong>Occupancy-based:</strong> PIR, CO₂, or schedule — Variable occupancy spaces
            </li>
            <li>
              <strong>Boost mode:</strong> Manual switch or automatic — Cooking, showering events
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Airflow measurement:</strong> Verify supply and extract rates at each terminal
            </li>
            <li>
              <strong>Balance check:</strong> Supply within ±10% of extract rate
            </li>
            <li>
              <strong>Temperature test:</strong> Measure heat recovery efficiency under steady-state
            </li>
            <li>
              <strong>Filter pressure:</strong> Record clean filter pressure drop baseline
            </li>
            <li>
              <strong>Controls verification:</strong> Test boost, bypass, frost protection functions
            </li>
            <li>
              <strong>Noise measurement:</strong> Verify compliance with design criteria
            </li>
            <li>
              <strong>Documentation:</strong> Record all settings and provide to building owner
            </li>
          </ul>
          <p>
            <strong>Common Commissioning Issues</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Dirty filters:</strong> Pre-commissioning filters left in place
            </li>
            <li>
              <strong>Duct leakage:</strong> Reducing actual delivered airflow
            </li>
            <li>
              <strong>Incorrect wiring:</strong> Fans running at wrong speed or direction
            </li>
            <li>
              <strong>Bypass stuck:</strong> Always open or always closed
            </li>
          </ul>
          <p>
            <strong>Part L compliance:</strong> Commissioning results must be recorded and submitted
            as part of Building Regulations compliance evidence. Include measured SFP, heat recovery
            efficiency, and airflow rates.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> An MVHR unit is tested with outdoor air at -2°C, extract air
            at 20°C, and supply air leaving the exchanger at 15.5°C. Calculate the heat recovery
            efficiency.
          </p>
          ...
          <p>
            <strong>Question:</strong> Calculate annual heating energy saved by an MVHR system with
            80% efficiency, 50 l/s airflow, operating 8,760 hours/year, average heating season ΔT of
            15°C for 5,000 hours.
          </p>
          ...
          <p>
            E = <strong>3,600 kWh/year</strong>
          </p>
          ...
          <p>
            <strong>Question:</strong> An MVHR unit has two fans each consuming 45W to deliver 60
            l/s. Calculate the specific fan power and assess Part L compliance.
          </p>
          ...
          <p>
            <strong>Question:</strong> Size an MVHR system for a 3-bedroom dwelling with 1 kitchen,
            2 bathrooms, and 1 utility room. Determine the minimum continuous ventilation rate.
          </p>
          ...
          <p>Utility: 8 l/s</p>
          <p>
            Total Extract = 13 + 8 + 8 + 8 = <strong>37 l/s</strong>
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heat recovery efficiency:</strong> η = (T_supply_out - T_supply_in) /
              (T_extract_in - T_supply_in) × 100%
            </li>
            <li>
              <strong>Recovered heat:</strong> Q = V̇ × ρ × Cp × ΔT × η (where V̇ = volume flow rate)
            </li>
            <li>
              <strong>Specific fan power:</strong> SFP = Total fan power (W) / Airflow (l/s)
            </li>
            <li>
              <strong>Air density:</strong> ρ ≈ 1.2 kg/m³ at standard conditions
            </li>
            <li>
              <strong>Specific heat of air:</strong> Cp ≈ 1.0 kJ/kgK
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Part L heat recovery efficiency: <strong>&gt;70%</strong>
            </li>
            <li>
              Part L SFP limit (domestic): <strong>≤1.0 W/(l/s)</strong>
            </li>
            <li>
              Duct velocity limit (noise): <strong>2-3 m/s</strong>
            </li>
            <li>
              Airtightness for MVHR: <strong>&lt;5 m³/h.m² at 50Pa</strong>
            </li>
            <li>
              Frost protection activation: <strong>-5°C to 0°C</strong>
            </li>
            <li>
              Summer bypass activation: <strong>12-15°C outdoor</strong>
            </li>
          </ul>
          <p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Excessive duct lengths:</strong> Increases pressure drop and SFP
              </li>
              <li>
                <strong>Undersized ductwork:</strong> Causes noise and high resistance
              </li>
              <li>
                <strong>Poor airtightness:</strong> Renders heat recovery ineffective
              </li>
              <li>
                <strong>Missing frost protection:</strong> Leads to ice damage in cold spells
              </li>
              <li>
                <strong>No summer bypass:</strong> Overheating in warm weather
              </li>
              <li>
                <strong>Inaccessible filters:</strong> Leads to poor maintenance
              </li>
            </ul>
          }
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Fan selection</div>
          </button>
          <button
