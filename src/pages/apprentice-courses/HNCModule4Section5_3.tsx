...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Sandwich busbar', 'Lighting trunking', 'Rising main busbar', 'Overhead busbar'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Copper or aluminium', 'Steel only', 'Bronze only', 'Brass'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Busbar trunking is a type-tested assembly under BS EN 61439-6. Reg 510.3 means that
              the BS EN compliance only protects you if the install follows the manufacturer’s
              instructions exactly — joint torques, fire barrier products, expansion-joint spacing,
              support intervals, ambient/derating curves. Site substitutions of fire barriers or
              tap-off units invalidate the type test and shift fault liability onto the designer who
              allowed it.
            </>
          }
        ...
        <ConceptBlock title="Rising Mains">
          <p>
            ...
            from the main switchroom through dedicated risers, with tap-off points at each floor for
            connection to floor distribution boards.
          </p>
          <p>
        ...
        <ConceptBlock title="Busbar Trunking Types">
          ...
          <p>
            <strong>
              Busbar trunking categories (type / current range / typical applications):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Tap-Off Units">
          <p>
            Tap-off units provide connection points from busbar trunking to outgoing circuits. They
            contain protection devices and allow connection without system shutdown in many cases.
          </p>
          <p>
        ...
        <ConceptBlock title="Fire Barriers and System Ratings">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Must match the fire rating of the penetrated element (typically 60-120 minutes)</li>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — rising main sizing:</strong> 8-storey office building with 80kVA per
            floor. Size the rising main.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 2 — voltage drop check:</strong> 1000A busbar, 35m height, 800A load at
            top floor. Busbar: 0.017 mV/A/m.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              ambient peaks 32 °C in summer. You’re pricing busbar versus parallel SWA cables with
              the QS today.
            </>
          }
          whatToDo={
            <>
              Total demand 6 × 105 A = 630 A. Apply 80 % diversity for non-coincident floor peaks →
              504 A design load. Specify an 800 A 4-pole busbar trunking (BS EN 61439-6) with 25 %
              spare for future fit-out. Vertical orientation derating: typical 0.95 factor. Ambient
              32 °C: factor 1.0 (no derating below 35 °C). Net 760 A continuous — ample. Tap-off
              unit per floor: 160 A 4-pole MCCB with mechanical interlock, IP4X. Fire barrier per
              manufacturer (BS EN 1366-3 tested) at every floor slab. Specify two expansion joints
              in the run (one per 12 m as guidance). Joint torque values + thermographic survey at
              handover written into the spec. Compare against 4× 240 mm² SWA in parallel — busbar
              wins on shaft footprint and install time, even if material cost is similar. Reg 510.3
          ...
          whyItMatters={
            <>
              ...
              handover sign-off and could compromise compartmentation under a fire. A non-torqued
              joint runs hot, fails after 18 months and takes the building offline. Specify
              properly, sign off properly.
            </>
          }
        />
