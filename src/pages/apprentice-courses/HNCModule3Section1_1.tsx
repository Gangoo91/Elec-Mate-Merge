...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['P = R/I²', 'P = I/R', 'P = IR', 'P = I²R'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['2.25kW', '4.5kW', '1.125kW', '0.9kW'],
    correctAnswer: 0,
    explanation: 'Total power = 50 × 45W = 2250W = 2.25kW.',
  },
  {
    id: 5,
    question: 'What maximum voltage is permitted for SELV circuits in bathrooms?',
    options: ['24V DC', '50V AC or 120V DC', '230V with RCD protection', '12V AC'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.222Ω', '0.111Ω', '0.444Ω', '7.41Ω'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['5 W/m²', '50 W/m²', '25-30 W/m²', '10-12 W/m²'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Equipment is rated to operate across the full ±10 % band, so HNC sizing calculations
              should use 230 V nominal and check worst-case voltage drop down to 207 V at the
              furthest outlet. Anything outside that band is a power-quality issue, not a normal
              design assumption.
            </>
          }
        ...
        <ConceptBlock title="Voltage — Electrical Potential Difference">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>SELV (bathrooms):</strong> ≤50V AC / ≤120V DC — Extra-low voltage protection
            </li>
            <li>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Remember:</strong> 400V ÷ √3 = 230V - this is the relationship between line and
        ...
        <ConceptBlock title="Resistance — Opposition to Current Flow">
          <p>
            ...
            cable resistance causes voltage drop and power losses that must be accounted for in
            design.
          </p>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Temperature effect:</strong> Copper resistance increases ~0.4% per °C rise. Use
            correction factor 1.2 for cables operating at 70°C.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Power — Rate of Energy Transfer">
          ...
          <p>
            P = √3 × V<sub>L</sub> × I<sub>L</sub> × cos φ — Where VL = line voltage (400V), cos φ =
            power factor
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Current at 230V: I = P / V = 6000 / 230 = <strong>26.1A</strong>
            </li>
          ...
          <p>
            <strong>Question:</strong> A 3kW heater is supplied by 25m of 2.5mm² cable. Calculate
            the voltage drop.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Current: I = P / V = 3000 / 230 = 13A</li>
            <li>
              Cable resistance: R = 25m × 2 × 7.41mΩ/m = 0.37Ω (×2 for go and return conductors)
            </li>
            <li>
              Voltage drop: V = I × R = 13 × 0.37 = <strong>4.8V</strong>
            </li>
            <li>
              As percentage: (4.8 / 230) × 100 = <strong>2.1%</strong> ✓ Within 5% limit for power
              circuits
            </li>
          </ul>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Always double the run length for single-phase Vd. Convert all resistances to Ω before
              substituting. Apply pf for inductive loads. Use the 1.2 correction factor for hot
              cables.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You are the building services engineer on a Cat-B office fit-out. The tenant has
              declared 80 kW of total connected load (lighting, small power, comfort cooling
              fan-coils) at an assumed 0.9 power factor, fed from a 400 V three-phase sub-main run
              35 m from the landlord’s riser distribution board.
            </>
          }
          whatToDo={
            <>
              Convert load to line current: I<sub>L</sub> = P / (√3 × V<sub>L</sub> × cos φ) = 80
              000 / (1.732 × 400 × 0.9) ≈ 128 A. Pick the next standard protective device above 128
              A (typically 160 A MCCB), then select a cable from BS 7671 Appendix 4 with I
              <sub>z</sub> ≥ 160 A under the actual installation method, ambient and grouping
              factors. Finally check voltage drop over 35 m using the cable’s mV/A/m figure × length
              × I<sub>b</sub> against the 5 % limit for power circuits in BS 7671 Appendix 4,
              Section 6.4.
            </>
          }
          whyItMatters={
            <>
              Getting these four basics right — V, I, R and P — is the difference between a sub-main
              that serves the tenant for 25 years and one that nuisance-trips, cooks its insulation
              or fails the voltage drop check on commissioning. The numbers also sit inside the Part
              L energy submission, so they are auditable, not throwaway.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Ohm's Law</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
