...
const AM2Module7Section1 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['90 minutes', '30 minutes', '60 minutes', '45 minutes'],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: ['1.37Ω', '1.44Ω', '0.87Ω', '2.3Ω'],
      correctAnswer: 0,
      explanation:
    ...
    },
    {
      ...
      options: ['0.5MΩ', '1.5MΩ', '1.0MΩ', '2.0MΩ'],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: ['Part 4', 'Part 6', 'Part 5', 'Part 7'],
      correctAnswer: 1,
      explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/am2/module7"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The knowledge test is typically the first component of AM2 assessment and sets the tone
          for your entire assessment. Mastering knowledge test strategies, practice questions, mock
          tests and exam techniques is essential for AM2 assessment success.
        </p>
        ...
        <ConceptBlock title="Critical Assessment Component">
          <p>
            <strong className="text-red-300">Critical.</strong> The knowledge test is typically the
            first component of AM2 assessment and sets the tone for your entire assessment. Poor
            performance here can affect confidence and momentum. You must demonstrate thorough
            understanding of BS 7671, testing procedures, and safety requirements. Inadequate
            preparation or test-taking strategy will impact your overall AM2 success.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Multiple-Choice Question Banks">
          ...
          <p>
            <strong className="text-amber-400">Key Point:</strong> Question banks should mirror the
            AM2 knowledge test format with similar difficulty levels and question styles.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Feedback and Explanations">
          ...
          <p>
            <strong className="text-green-400">Best Practice:</strong> Review explanations even for
            questions answered correctly to reinforce understanding and identify any gaps.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Open-Book Regs You Need Verbatim">
          <p>
            ...
            for finding and quoting the right clause. Drill these four until you can locate them in
            your regs book in under 30 seconds.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              This is why you sleeve every CPC and land it at every box, even on a lighting circuit
              where the accessory is plastic. It's also the reg that justifies bonding metal
              backboxes and fittings to the same earthing system.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              fixed gear you fit on AM2 day. If you can poke a finger to a live part, you've failed
              this reg — and the assessor will mark it.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              protecting cables where they pass through metalwork. It's the one to quote whenever an
              AM2 question asks why a cable needs extra protection.
            </>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              You’re forty minutes into the one-hour knowledge test. You’ve answered most questions
              confidently but you’re stuck on a complex Zs calculation. The question carries the
              same weight as every other one. The clock is ticking.
            </>
          }
          whatToDo={
            <>
              ...
              ten minutes you needed for the easy ones at the end. If you genuinely don’t know with
              two minutes left, eliminate the obviously-wrong options and pick the most likely from
              what’s left — blank answers score zero, guesses sometimes score full.
            </>
          }
          whyItMatters={
            <>
              Multiple-choice tests reward pace and pattern. Candidates who fail the knowledge test
              usually fail because they ran out of time, not because they didn’t know the material.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You spend evenings flicking through the brown book trying to remember reg numbers. On
              the day, the test asks you to find specific values from Appendix 3 or Table 41.1, and
              you waste minutes hunting because you’ve never timed yourself doing it.
            </>
          }
          doInstead={
            <>
              Practise lookup with a stopwatch. Tab the appendices and the most-used tables. Aim to
              find any specific value (cable rating, disconnection time, RCD type) in under thirty
              seconds. Speed of lookup beats memorisation every time.
            </>
          }
        />
