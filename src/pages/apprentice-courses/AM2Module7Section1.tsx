...
const AM2Module7Section1 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Regulation 416.1 covers basic protection by insulation of live parts - a fundamental safety requirement tested in AM2.',
    },
    {
      id: 4,
      ...
      correctAnswer: 0,
      explanation:
        'Maximum Zs for a 32A Type B MCB is 1.44Ω. These values are critical for AM2 knowledge tests and must be memorised.',
    },
    {
      id: 5,
  ...
  return (
    ...
    >
      ...
      {/* Navigation Footer */}
      <AM2NavigationFooter
        previousHref="/study-centre/apprentice/am2/module6/section4"
        previousLabel="Module 6 Section 4"
        nextHref="/study-centre/apprentice/am2/module7/section2"
