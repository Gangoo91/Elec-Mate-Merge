      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>HV:</strong> Exceeds 1000 V AC; UK distribution typically 11 kV
              </li>
              <li className="pl-1">
                <strong>SF6:</strong> Gas-insulated breakers, 23,500x CO2 warming potential
              </li>
              <li className="pl-1">
                <strong>Vacuum:</strong> Environmentally friendly, up to 30,000 operations
              </li>
              <li className="pl-1">
                <strong>RMU:</strong> 3-panel ring main unit at substation entry point
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Awareness:</strong> LV technicians must recognise HV equipment
              </li>
              <li className="pl-1">
                <strong>Safety rules:</strong> Disconnect, Isolate, Secure, Prove Dead, Earth
              </li>
              <li className="pl-1">
                <strong>Authorisation:</strong> Only APs may switch HV equipment
              </li>
              <li className="pl-1">
                <strong>ST1426:</strong> Maps to hazard awareness and safe working KSBs
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        230/400 V distribution, final circuits
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                The primary hazard of HV systems is the potential for fatal electric shock and
                severe arc flash. At 11 kV, an electric arc can form across an air gap of
                approximately 30 mm, but in practice, safety clearances are measured in hundreds of
                millimetres. Arc flash temperatures can exceed 20,000 degrees Celsius, causing
                severe burns, blast injuries and hearing damage even at a distance from the arc.
                Unlike LV systems where contact is typically required for shock, HV can cause
                flashover across air gaps — you do not need to physically touch an HV conductor to
                be electrocuted.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Approaching too closely to energised HV equipment is
              potentially fatal. Always respect HV warning signs and restricted areas, and never
              enter an HV switchroom without proper authorisation and escort.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                ...
                strength of air at atmospheric pressure. When the contacts separate, the arc is
                formed in the SF6 gas, which absorbs the energy and extinguishes the arc rapidly.
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Compact, reliable and have long service intervals (25-30 years)
                </li>
                <li className="pl-1">
                  Typically sealed-for-life units requiring no gas maintenance
                </li>
                <li className="pl-1">
                  Include gas pressure monitoring and lockout on low pressure
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Minimal maintenance and very long electrical life (up to 30,000 operations)
                </li>
                <li className="pl-1">
                  Compact design increasingly popular for 11 kV and 33 kV applications
                </li>
                <li className="pl-1">
                  Many new installations now specify vacuum as the preferred technology
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Note:</strong> Although largely obsolete for new installations, oil circuit
              breakers (OCBs) may still be encountered in older substations. They use mineral oil
              both as an insulating medium and for arc quenching. OCBs require regular oil sampling
              and testing, present a fire risk, and are gradually being replaced by SF6 or vacuum
              types during refurbishment programmes.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Ring Main Advantages
                </h3>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">Supply resilience — dual feed path to each substation</li>
                  <li className="pl-1">
                    Faulted sections can be isolated without total loss of supply
                  </li>
                  <li className="pl-1">
                    Maintenance can be planned without customer disconnection
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    An RMU is energised at 11 kV even if the LV side is isolated
                  </li>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Always recognise that an RMU is energised at 11 kV — even
              if the transformer secondary (LV side) has been isolated. The ring cables passing
              through the RMU may be energised from either direction.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                The Five HV Safety Rules
              </h3>
              <p className="text-sm text-white mb-3">
                When HV equipment is to be worked on, the following five safety rules must be
                applied in strict order:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>1. Disconnect:</strong> The equipment must be disconnected from all
                  sources of supply by opening the appropriate switching devices
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              <p className="text-sm font-medium text-orange-400 mb-2">
                LV Technician Awareness Responsibilities
              </p>
              <p className="text-sm text-white">
                As an LV maintenance technician, your responsibilities around HV equipment include:
                never entering an HV switchroom unless authorised and escorted; recognising HV
                warning signs and restricted areas; understanding that isolating the LV side does
                not isolate the HV side; reporting any defects or damage to HV equipment
                immediately; and knowing the emergency procedures for HV incidents. If your LV work
                requires isolation of a transformer, remember that the HV side remains energised
                unless separately isolated by an Authorised Person.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> The fifth HV safety rule — applying portable protective
              earths — is additional to standard LV isolation procedures. This is because HV systems
              have much greater stored energy and a risk of induced voltages on de-energised HV
              cables running parallel to energised ones.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                HV Cables and Cable Routes
              </h3>
              <p className="text-sm text-white">
                HV cables are typically identified by their larger diameter, red or black colour,
                trefoil arrangement, and prominent cable markers or labels. They may be routed
                through dedicated ducts or on dedicated cable trays. HV cable routes should be
                clearly marked with warning tape (buried cables) or labels (surface-mounted cables).
                When working near cable routes, always verify the cable voltage before proceeding.
              </p>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white">
                HV switchrooms and substations must display standard safety signs including the
                yellow triangular "Danger of Death" sign, "Authorised Personnel Only" notices, and
                first aid and emergency procedure notices. Access to HV areas is typically
                controlled by locked doors with restricted key access. Never attempt to enter an HV
                area without proper authorisation — even if the door appears to be unlocked, entry
                without permission is a serious safety breach.
              </p>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white">
                ...
                room or separated by a firewall. The HV section requires restricted access, whilst
                the LV switchboard may be more accessible for routine maintenance. Always check the
                room layout and identify the HV section boundaries before commencing any work in a
            ...
            <p className="text-sm text-white/90 italic">
              ...
              be engaged in any work activity on or near any live conductor other than one suitably
              insulated unless it is reasonable for them to be at work on or near it. For HV
              systems, this means strict access control and formal safety documentation at all
              times.
            </p>
          </div>
        </section>
