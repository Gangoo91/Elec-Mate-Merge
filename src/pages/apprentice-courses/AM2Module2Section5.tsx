    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Some mistakes in the AM2 cost marks; others cause instant failure. NET defines these as
          critical safety errors involving unsafe isolation, energising unsafe circuits, or
          breaching basic health and safety law.
        </p>
        ...
        <ConceptBlock title="Safety Errors = Instant Failure">
          ...
          <p>
            <strong className="text-red-300">Golden Rule.</strong> If it's unsafe in the real world,
            it's an instant fail in AM2. One critical mistake proves you're not ready for
            unsupervised work.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Why These Errors Cause Instant Failure">
          <p>
            <strong className="text-elec-yellow">Real-World Simulation.</strong> AM2 simulates real
            work conditions. Unsafe practices in the assessment represent the same risks that could
            kill someone in real life — electric shock, fire, explosion, or serious injury. Every
            safety procedure you follow (or skip) directly translates to real-world competency.
          </p>
          <p>
            <strong className="text-elec-yellow">Competency Verification.</strong> NET's role is to
            confirm you are safe to work unsupervised. One critical mistake proves you're not ready
            for independent work, regardless of your technical abilities. This isn't about being
            harsh — it's about ensuring public safety and protecting the electrical industry's
            reputation.
          </p>
          <p>
          ...
          <p>
            <strong className="text-orange-400">Industry Standards.</strong> The electrical industry
            has zero tolerance for unsafe practices because the consequences are so severe. A single
            mistake can result in fatalities, major fires, or explosions. NET reflects this reality
        ...
        <ConceptBlock title="Real-World Examples">
          ...
          <p>
            <strong className="text-red-400">AM2 Example 3: Lock-off Device.</strong> Candidate used
            tape instead of a proper lock-off device to secure isolation. This is considered unsafe
            isolation practice → instant fail, despite otherwise competent work.
          </p>
          <p>
        ...
        <ConceptBlock title="Frequently Asked Questions">
          <p>
            <strong>Q1: What's the biggest single cause of critical safety fails?</strong> Incorrect
            safe isolation procedures, particularly skipping the re-prove step or using inadequate
            lock-off methods. Remember: safe isolation is a complete 6-step procedure, not just
            switching off.
          </p>
          <p>
          ...
          <p>
            ...
            failure with no opportunity for correction. Zero tolerance policy: one mistake = instant
            section fail.
          </p>
          <p>
            <strong>
          ...
          <p>
            ...
            cover unsafe tool use, PPE breaches, and general unsafe site behaviour that could cause
            injury. Covers all aspects of health &amp; safety, not just electrical work.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              All three tests must be met before live working is lawful. AM2 simulates installation
              and testing — there’s effectively never a justification for live work on the rig.
              Touch anything live and the assessment is over.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              This is the regulatory framing for basic protection. Every install you do on AM2 must
              leave no live parts accessible — terminal screws covered, accessory plates squared and
              tightened, no exposed copper. An exposed live conductor on a finished accessory is a
        ...
        <Scenario
          ...
          whyItMatters={
            <>
              ...
              tests are satisfactory. The order is the law of the rig — assessors will fail you for
              getting it backwards even if everything turns out fine.
            </>
          }
        />
