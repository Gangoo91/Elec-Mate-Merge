...
const AM2Module6Section1 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['45-50', '20-25', '30-40', '50-60'],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: ['60-65%', '50-55%', '80-85%', '70-75%'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: ['30-60 seconds', '3-4 minutes', '1-2 minutes', '5-10 minutes'],
      correctAnswer: 2,
      explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The AM2 online knowledge test is a computer-based, multiple-choice exam. It assesses your
          knowledge of electrical regulations, science, and safety, alongside your ability to apply
          theory to real-world situations. The test lasts 60 minutes and contains 30 questions.
        </p>
        ...
        <div className="space-y-6">
          ...
          <ConceptBlock title="1. Understanding the Test Structure">
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Marking:</strong> One mark per correct answer, no penalty for wrong answers
              </li>
              <li>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Review time:</strong> Reserve 5-10 minutes at the end for flagged questions
              </li>
            </ul>
          ...
          <ConceptBlock title="2. Question Types and Content Areas">
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Example areas:</strong> Regulation numbers for specific requirements, table
                references, appendix content
              </li>
              <li>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Common topics:</strong> Ohm's law applications, power calculations, voltage
                drop, fault current, cable sizing
              </li>
              <li>
                <strong>Strategy:</strong> Show your working mentally and double-check calculations
              </li>
            </ul>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Strategy:</strong> Think about best practice and legal requirements - safety
          ...
          <Scenario
            ...
            whatToDo={
              <>
                ...
                <strong>flag aggressively.</strong> Skim the next 10 questions, answer only the ones
                you can do in under 60 seconds, flag everything else. Aim to clear all easy/medium
                questions first across the remaining 22, then come back to flagged with whatever
                time's left. You'll guess on some — that's fine, no penalty. The goal is to not
                leave any blank, and to bank the marks you definitely know.
              </>
            }
            whyItMatters={
              <>
                Most online test failures come from candidates who knew the material but managed
                time badly. Spending 5 minutes on a tricky calculation question that's worth 1 mark,
                while leaving 5 easy questions unanswered, is the classic mistake. Pace checkpoints
                (10 questions in 20 min, 20 in 40 min, 30 in 55 min) save you.
              </>
            }
          />
          ...
          <ConceptBlock title="3. Assessor Expectations">
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>Understand how to approach scenario-based questions, not just memorise facts</li>
          ...
          <ConceptBlock title="4. Test-Taking Strategies and Practical Guidance">
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Read the entire question:</strong> Don't assume after reading the first few
                words
              </li>
              <li>
                <strong>Identify key words:</strong> Look for "minimum", "maximum", "not", "except",
                "best"
              </li>
              <li>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Don't get stuck:</strong> If more than 3 minutes on a question, flag it and
                move on
              </li>
              <li>
          ...
          <CommonMistake
            ...
            whatHappens={
              <>
                You hit a question you don't immediately know, you stare at it, you eventually leave
                it blank thinking "no point guessing". You repeat this 4–5 times across the hour.
                Result: you've thrown away 4–5 marks just by not picking ANY answer. With a 70% pass
                mark on 30 questions, that's the difference between pass and fail.
              </>
            }
            doInstead={
              <>
          ...
          <ConceptBlock title="5. Real-World Examples">
            ...
            <p>
              Candidate spent 15 minutes stuck on one science question, ran out of time, and left 5
              unanswered. <strong>Failed.</strong>
            </p>
            ...
            <p>
              Candidate flagged 3 questions, completed the rest, then came back with fresh focus and
              answered correctly. <strong>Passed.</strong>
            </p>
          ...
          <ConceptBlock title="Summary">
            <p className="text-ios-body text-white leading-relaxed">
              ...
              only on knowledge but also on managing your time and answering every question.
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            ...
            >
              ...
              <div className="mt-1 text-[14px] font-semibold text-black truncate">Core Topics</div>
            </Link>
          </div>
        </div>
      </HubBody>
