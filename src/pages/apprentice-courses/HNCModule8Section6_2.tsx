...
const quickCheckQuestions = [
  {
    ...
    options: [
      'Locating it as close as possible to water services',
      'Positioning it at the lowest point of the plant room',
      'Ensuring adequate front and rear access for maintenance and operation',
      'Mounting it directly above the incoming cable trench',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To pressurise the room and prevent dust ingress only',
      'To supply combustion air for any gas-fired plant',
      'To dilute any leaked refrigerant to a safe concentration',
  ...
  },
  {
    ...
    options: [
      'To provide a local isolation point for each circuit',
      'To serve as the central bonding point connecting all protective conductors and extraneous-conductive-parts',
      'To act as the neutral reference for the supply transformer',
      'To house the main switch and incoming protective device',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'To increase the current-carrying capacity of the earthing conductor',
      'To connect all simultaneously accessible exposed-conductive-parts and extraneous-conductive-parts',
      'To provide a dedicated earth for sensitive electronic equipment',
      'To bond the lightning protection system to the building steel',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The same size as the earthing conductor (minimum 16mm squared)',
      'Half the size of the earthing conductor (minimum 6mm squared)',
      'A quarter the size of the earthing conductor (minimum 4mm squared)',
      'A fixed 10mm squared regardless of earthing conductor size',
    ],
    correctAnswer: 1,
    explanation:
      'BS 7671 specifies that main protective bonding conductors should have a cross-sectional area not less than half that of the earthing conductor, with a minimum of 6mm squared for copper. This ensures adequate fault current capacity for protective bonding.',
  },
  {
    id: 10,
    question:
    ...
    options: [
      ...
      'The fire rating of the floor construction',
      'The cable bend radius requirements and quantity of cables',
      'The IP rating of the switchgear enclosures',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Additional RCD protection rated at not more than 30mA',
      'Segregation from all extra-low voltage control cables',
      'Fire-resistant cable rated to maintain circuit integrity for 60 minutes',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To record the test results for each circuit at commissioning',
      'To show the spatial relationship of all services and identify potential clashes',
      'To schedule the maintenance intervals for each item of plant',
      'To list the electrical load of every connected item of equipment',
    ],
    correctAnswer: 1,
    explanation:
