        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Selection:</strong> Assess competence before appointment
              </li>
              <li className="pl-1">
                <strong>Induction:</strong> Site-specific safety information for all
              </li>
              <li className="pl-1">
                <strong>Monitoring:</strong> Ongoing checks of compliance and performance
              </li>
              <li className="pl-1">
                <strong>Coordination:</strong> Manage interfaces and prevent conflicts
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>CDM duties:</strong> Principal contractor coordination
              </li>
              <li className="pl-1">
                <strong>M&E interfaces:</strong> Multiple trades working together
              </li>
              <li className="pl-1">
                <strong>Specialist work:</strong> High-risk electrical, gas, refrigeration
              </li>
              <li className="pl-1">
                <strong>Permit systems:</strong> Coordinated isolation and access
              </li>
            </ul>
          </div>
        </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Appropriate to activities, current, signed
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Trade qualifications, CSCS/ECS cards, safety training
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Training matrix, card copies
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Experience</td>
                      <td className="border border-white/10 px-3 py-2">
                        Similar projects, specific expertise
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Project references, testimonials
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        SSIP, ISO 45001, trade body membership
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Accident rates, enforcement action, improvements
                      </td>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Make suitable arrangements, ensure adequate time/resources, provide
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Plan, manage, coordinate pre-construction phase, prepare health and safety
                        file
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Plan, manage, coordinate construction phase, prepare construction phase plan
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Designers</td>
                      <td className="border border-white/10 px-3 py-2">
                        Eliminate/reduce risks through design, provide information on remaining
                        risks
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Plan, manage, monitor own work, cooperate with others, provide information
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Workers</td>
                      <td className="border border-white/10 px-3 py-2">
                        Cooperate with others, report unsafe conditions, follow instructions
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Does it cover all the work to be done? Specific to this site?
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Hazards</td>
                      <td className="border border-white/10 px-3 py-2">
                        All significant hazards identified? Including site-specific ones?
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Controls</td>
                      <td className="border border-white/10 px-3 py-2">
                        Controls proportionate and practical? Hierarchy of control followed?
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Sequence</td>
                      <td className="border border-white/10 px-3 py-2">
                        Logical work sequence? Safe access/egress? Isolation points?
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Resources</td>
                      <td className="border border-white/10 px-3 py-2">
                        Right equipment specified? Training requirements clear?
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Interfaces</td>
                      <td className="border border-white/10 px-3 py-2">
                        Coordination with other trades? Impact on building users?
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Minor non-compliance, first instance
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Verbal correction, coaching, record made
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">2</td>
                      <td className="border border-white/10 px-3 py-2">
                        Repeat minor or moderate breach
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Written warning, meeting with supervisor
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">3</td>
                      <td className="border border-white/10 px-3 py-2">
                        Serious breach or continued repeats
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Stop notice, formal meeting with management
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">4</td>
                      <td className="border border-white/10 px-3 py-2">
                        Gross misconduct or refusal to comply
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Removal from site, contract review
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Contractor Pre-Qualification
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Multi-Contractor Coordination
              </h3>
              <p className="text-sm text-white mb-2">
