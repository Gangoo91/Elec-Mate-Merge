          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white mb-3">
                ...
                calculating from basic resistance values (Ω/m).
              </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2 font-semibold text-elec-yellow">
                        3%
                      </td>
              ...
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Cable in free air (no insulation)
                      </td>
                      <td className="border border-white/10 px-3 py-2">1.00</td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        One side touching thermal insulation
                      </td>
                      <td className="border border-white/10 px-3 py-2">0.75 - 0.89</td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Surrounded by 50mm insulation
                      </td>
                      <td className="border border-white/10 px-3 py-2">0.55</td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Surrounded by 100mm insulation
                      </td>
                      <td className="border border-white/10 px-3 py-2">0.50</td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Surrounded by 200mm+ insulation
                      </td>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Fault level:</strong> Check prospective fault current at distribution
                  boards
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2">
                  From Table 4D2A (Method B): 25mm² = 89A, 35mm² = 110A, 50mm² = 134A
                </p>
                <p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Multiplying by √3</strong> — mV/A/m values already include this factor
                </li>
                <li className="pl-1">
                  <strong>Forgetting derating</strong> — Always check grouping and ambient factors
                </li>
                <li className="pl-1">
                  <strong>Ignoring submain drop</strong> — Total drop includes all sections
                </li>
                <li className="pl-1">
                  <strong>Wrong table</strong> — Match table to cable type and installation method
                </li>
                <li className="pl-1">
                  <strong>Single-phase values for three-phase</strong> — Use correct column in
                  tables
                </li>
              </ul>
            </div>
