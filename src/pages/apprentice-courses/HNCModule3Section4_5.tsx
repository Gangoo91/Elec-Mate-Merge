...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Table 4D2A', 'Table 4D1A', 'Table 4E4A', 'Table 4D4A'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['1.48 mV/A/m', '4.44 mV/A/m', '2.96 mV/A/m', '6.67 mV/A/m'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS 7671 Reg 524.1 + Appendix 4 is the full cable-sizing framework: Table 4D2A/4D4A
              etc. give Iz under reference installation methods, then Tables 4Ab/4Ac etc. apply
              derating factors. The HNC-grade BSE designer must evidence the four-step calc on the
              design submission: (1) determine Ib; (2) select In &ge; Ib (per BS 7671 Reg 433.1.1);
              (3) compute Iz = It &times; C&#x2090; &times; C&#x2099; &times; C&#x1d62;; (4) verify
              In &le; Iz and voltage drop &le; Appendix 4 limit.
            </>
          }
        ...
        <ConceptBlock title="Three-Phase Voltage Drop Formula Using mV/A/m">
          <p>
            The mV/A/m (millivolts per ampere per metre) method is the standard approach for voltage
            drop calculations in BS 7671. This value combines both resistive and reactive components
            of the cable impedance into a single figure that can be read directly from the tables.
          </p>
          ...
          <p>
            ...
            <strong>already include the three-phase geometry factor</strong>. You do NOT multiply by
            √3 when using table values. The √3 factor is only needed when calculating from basic
            resistance values (Ω/m).
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            mV/A/m Values - Typical Examples
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Remember:</strong> XLPE cables have lower mV/A/m values than PVC cables because
            they operate at higher temperatures (90°C vs 70°C) and have lower resistance at these
            temperatures.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="BS 7671 Voltage Drop Limits">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Power circuits (other uses):</strong> 5% — 11.5V at 230V (1-ph), 20V at 400V
              (3-ph)
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p>
            The voltage drop limits apply to the <strong>total</strong> drop from the origin of the
            installation to the point of use. This includes the submain, distribution board
            connections, and final circuit. In large installations, you must apportion the available
            drop between different sections.
          </p>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            supplying fixed equipment if the equipment manufacturer confirms satisfactory operation.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Cable Sizing for Current-Carrying Capacity">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              = Tabulated cable capacity (from BS 7671)
            </li>
            <li>
              <strong>
                I<sub>n</sub>
            ...
            <li>
              ...
              = Semi-enclosed fuse factor (0.725)
            </li>
          </ul>
        ...
        <ConceptBlock title="Derating Factors (Grouping, Ambient, Thermal Insulation)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1 circuit:</strong> Bunched 1.00 — Single-layer tray 1.00 — Ladder (spaced)
              1.00
            </li>
            <li>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Design tip:</strong> Keep cables away from thermal insulation where possible. If
            unavoidable, use XLPE cables which tolerate higher temperatures better than PVC.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Armoured vs Non-Armoured Cables">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Non-Armoured (T+E, NYY, etc.)</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Installation labour:</strong> SWA more termination time — non-armoured faster
              to terminate
            </li>
            <li>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            (Regulation 522.6), SWA cable or equivalent protection must be provided. External cables
            should be armoured unless installed in metallic conduit or similar.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="SWA Cable Installation">
          <p>
            ...
            protection, electrical safety, and compliance with BS 7671. The armour must be properly
            terminated and earthed at each end.
          </p>
          ...
          <p>
            The armour must be earthed at <strong>both ends</strong> of the cable. This provides the
            low-impedance fault path required for protective device operation. Use the armour earth
            tag connection and verify continuity during commissioning testing.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Volt Drop Calculators and Tables">
          <p>
            ...
            Understanding how to navigate these tables and apply the values is essential for design
            work.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            Calculator Method - Step by Step
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Use mV/A/m straight from BS 7671 tables — no √3 multiplier. Always apply Ca, Cg and
              Ci. Sum submain and final-circuit drops to check the 5% (or 3%) limit. Match the table
              to your actual cable type (PVC vs XLPE, armoured vs non) and reference method. Pick
              the correct three-phase column.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A roof-top plantroom MCC carries a continuous 165 A three-phase load (mostly AHU and
              pump motors via VSDs). Cable run: 110 m up a ventilated riser, ambient 35&deg;C, four
              similar circuits in the same tray (grouping factor C&#x2099; = 0.77). Permitted
              voltage drop on this distribution leg is 2.5 % (leaving 2.5 % for final circuits
              within the plantroom).
            </>
          }
          whatToDo={
            <>
              Step 1 — Ib = 165 A. Step 2 — In = 200 A MCCB (next standard step). Step 3 — target
              Iz: try 95 mm&sup2; XLPE/SWA Cu, Method E, It = 271 A; with C&#x2090;(35&deg;C) = 0.96
              and C&#x2099; = 0.77 &rarr; Iz = 271 &times; 0.96 &times; 0.77 = 200 A &mdash; matches
              In, satisfies Iz &ge; In. Step 4 — voltage drop: 95 mm&sup2; XLPE/SWA mV/A/m (4D4B) =
              0.50 &rarr; Vd = (0.50 &times; 165 &times; 110) / 1000 = 9.08 V = 2.27 % &mdash;
              within 2.5 % budget. Cable verified.
            </>
          }
          whyItMatters={
            <>
              Underspec&rsquo;d submains either trip protection on overload, droop voltage on motor
              starts, or overheat insulation. All three cost six-figure remedials on commercial
              fit-outs because submains are concealed in risers. The four-step BS 7671 cable-sizing
              pipeline is the BSE engineer&rsquo;s primary defence against all three failure modes.
            </>
          }
        />
