...
const DESCRIPTION =
  'Learn the legal requirements and best practices for recording inspection and test results. Master documentation standards for BS 7671 compliance and professional record keeping.';
...
const Module4Section6_6 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'The Electricity at Work Regulations 1989 place a statutory duty on employers to maintain electrical systems in a safe condition and keep appropriate records.',
    },
    {
      id: 6,
    ...
    },
    {
      id: 9,
      question:
        'Which certificate is used for small alterations, such as adding a socket to an existing circuit?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'The Minor Electrical Installation Works Certificate (MEIWC) is specifically designed for small alterations and additions to existing circuits.',
    },
    {
      id: 10,
      question:
  ...
  const faqs = [
    {
      ...
      answer:
        'Yes, installers should retain copies for at least the recommended retention period for liability protection and future reference. This provides protection against potential claims and assists with warranty issues.',
    },
    {
      question: 'Can results be recorded digitally?',
      answer:
        'Yes, provided they are secure, accurate, and signed off by the responsible person. Digital systems must have appropriate security measures to prevent unauthorised alteration of results.',
    },
    {
      question: "What if a client requests only a 'visual check' and not full testing?",
      answer:
        'You must still complete appropriate documentation for the work done. Failing to record test results where testing was performed could leave you liable, regardless of client preferences.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="text-center mb-12">
            <div className="inline-flex items-center gap-2 text-elec-yellow text-sm mb-3">
              ...
              <span className="text-white">Section 6.6</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">
              Recording Inspection and Test Results
            </h1>
            <p className="text-white text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
              Master the legal requirements and best practices for accurate documentation of
              electrical testing.
            </p>
          </header>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm text-white space-y-1 list-disc pl-4">
                  <li>
                    Accurate recording of results is a legal requirement under BS 7671 and EAWR
                    1989.
                  </li>
                  <li>
                    Clear records prove the installation has been inspected, tested, and complies
                    with safety standards.
                  </li>
                  <li>
                    Poor records can undermine certificate validity and expose you to safety risks
                    and liability.
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm text-white space-y-1 list-disc pl-4">
                  <li>
                    <strong>Spot:</strong> Incomplete forms, missing signatures, vague entries like
                    "OK".
                  </li>
                  <li>
                    <strong>Use:</strong> Official test sheets, numerical values, proper units and
                    signatures.
                  </li>
                  <li>
                    <strong>Check:</strong> Forms are complete, legible, and stored securely.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <ul className="text-white space-y-2 list-disc pl-6">
              ...
              <li>
                Accurately record polarity, continuity, insulation resistance, and earth fault loop
                impedance results.
              </li>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1 list-disc pl-4">
                <li>
                  <strong>Provide legal proof of compliance</strong> with BS 7671 and statutory
                  regulations
                </li>
                <li>
                  <strong>Show the system has been tested</strong> to BS 7671 Part 6 standards with
                  specific test values
                </li>
                <li>
                  <strong>Protect the contractor</strong> in case of disputes, insurance claims, or
                  liability issues
                </li>
                <li>
                  <strong>Assist future electricians</strong> in maintenance, upgrades, and
                  fault-finding
                </li>
                <li>
                  <strong>Demonstrate professional competence</strong> and adherence to industry
                  standards
                </li>
                <li>
                  <strong>Enable warranty claims</strong> and manufacturer support when issues arise
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-4">
              <div className="p-3 rounded bg-white/5 border border-white/10">
                ...
                <p className="text-xs text-white">
                  Many insurance policies require evidence of proper installation and testing.
                  Missing or inadequate records can void coverage.
                </p>
              </div>
              <div className="p-3 rounded bg-white/5 border border-white/10">
                <p className="text-sm font-medium text-white mb-1">Regulatory enforcement</p>
                <p className="text-xs text-white">
                  Local authority building control and HSE inspectors routinely request test
                  certificates. Inability to produce documentation can result in enforcement action.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10 mt-8">
            ...
            <p className="text-white mb-4">
              BS 7671 requires specific test results to be documented with precise values and proper
              units:
            </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
              ...
              <ul className="text-sm text-white space-y-1 list-disc pl-4">
                <li>
                  <strong>Continuity of protective conductors</strong> — resistance values in ohms
                  (Ω), typically &lt;0.05Ω for final circuits
                </li>
                <li>
                  <strong>Insulation resistance results</strong> — minimum 1MΩ at 500V DC, recorded
                  in megohms (MΩ)
                </li>
                <li>
                  <strong>Polarity confirmation</strong> — verification that line conductors connect
                  only to line terminals
                </li>
                <li>
                  <strong>Earth fault loop impedance values</strong> — measured in ohms (Ω), must
                  not exceed BS 7671 maximum values
                </li>
                <li>
                  <strong>RCD trip times</strong> — measured in milliseconds (ms), typically 10-40ms
                  at rated current
                </li>
                <li>
                  <strong>Visual inspection findings</strong> — comprehensive checklist of
            ...
            <div className="mt-4 p-3 rounded bg-white/5 border border-white/10">
              ...
              <ul className="text-xs text-white space-y-1 list-disc pl-4">
                <li>
                  <strong>Phase sequence</strong> — for three-phase installations
                </li>
                <li>
                  <strong>Voltage measurements</strong> — supply voltage at origin and circuit
                  extremities
                </li>
                <li>
                  <strong>Current measurements</strong> — load currents and earth leakage currents
                </li>
                <li>
                  <strong>Functional testing</strong> — operation of switches, isolators, and
                  protective devices
                </li>
                <li>
                  <strong>Temperature rise</strong> — conductor and connection temperatures under
                  load
                </li>
              </ul>
            </div>
          ...
          <section className="mb-10 mt-8">
            ...
            <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
              ...
              <ul className="text-sm text-white space-y-1 list-disc pl-4">
                <li>
                  <strong>Electrical Installation Certificate (EIC)</strong> — for new
                  installations, consumer unit replacements, and major alterations
                </li>
                <li>
                  <strong>Minor Electrical Installation Works Certificate (MEIWC)</strong> — for
                  additions like socket outlets, lighting points, or single circuit additions
                </li>
                <li>
                ...
                <li>
                  <strong>Schedule of Inspections and Test Results</strong> — detailed
                  circuit-by-circuit test data
                </li>
                <li>
                  <strong>All must be signed</strong> by the responsible person with appropriate
                  qualifications
                </li>
              </ul>
            </div>
          ...
          <section className="mb-10 mt-8">
            ...
            <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
              ...
              <ul className="text-sm text-white space-y-1 list-disc pl-4">
                <li>
                  <strong>Use the correct test forms</strong> issued by the IET — ensure current
                  edition
                </li>
                <li>
                  <strong>Enter results clearly</strong> in black ink or type — avoid pencil or
                  erasable ink
                </li>
                <li>
                  <strong>Record correct units:</strong> resistance in ohms (Ω), insulation
                  resistance in megohms (MΩ), time in ms
                </li>
                <li>
                  <strong>Avoid vague entries</strong> like "OK", "Pass", "Satisfactory" — numerical
                  values are mandatory
                </li>
                <li>
                  <strong>Record separately</strong> for each circuit to enable precise fault
                  location
                </li>
                <li>
                  <strong>Cross-reference circuit numbers</strong> with distribution board labelling
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-4">
              ...
              <div className="p-3 rounded bg-blue-500/5 border border-blue-500/20">
                ...
                <ul className="text-xs text-white space-y-1 list-disc pl-4">
                  <li>
                    <strong>Digital:</strong> reduced errors, automatic calculations, data backup
                  </li>
                  <li>
                    <strong>Handwritten:</strong> no battery dependency, immediate completion
                  </li>
                  <li>
                    <strong>Hybrid:</strong> digital capture with printed copies for signatures
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <p className="text-white mb-4">Key regulations governing record keeping:</p>
            ...
            <div className="p-4 rounded-lg bg-red-500/5 border-l-2 border-red-500/50">
              ...
              <ul className="text-sm text-white space-y-1 list-disc pl-4">
                ...
                <li>
                  <strong>Electricity at Work Regulations 1989 Regulation 4(2)</strong> — Systems
                  must be maintained to prevent danger
                </li>
                <li>
                  <strong>Building Regulations Part P</strong> — Notification and certification
                  requirements for domestic work
                </li>
                <li>
                  <strong>Construction (Design and Management) Regulations</strong> — Handover
            ...
            <div className="mt-4 p-4 rounded-lg bg-red-500/5 border border-red-500/20">
              ...
              <ul className="text-xs text-white space-y-1 list-disc pl-4">
                <li>
                  <strong>Criminal prosecution</strong> under EAWR for unsafe systems
                </li>
                <li>
                  <strong>Professional sanctions</strong> from competent person scheme providers
                </li>
                <li>
                  <strong>Insurance claim rejection</strong> for inadequate documentation
                </li>
                <li>
                  <strong>Civil liability</strong> for damages resulting from electrical incidents
                </li>
                <li>
                  <strong>Trading standards action</strong> for fraudulent or misleading
                  certificates
                </li>
              </ul>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
                ...
                <ul className="text-sm text-white space-y-1 list-disc pl-4">
                  <li>
                    Make multiple copies: original for client, copy for contractor, copy for
                    competent person scheme
                  </li>
                  <li>
                    Use waterproof storage for physical documents, cloud backup for digital copies
                  </li>
              ...
              <div className="p-4 rounded-lg bg-red-500/5 border border-red-500/20">
                ...
                <ul className="text-sm text-white space-y-1 list-disc pl-4">
                  <li>
                    <strong>Never falsify results</strong> — if a test fails, investigate and
                    rectify
                  </li>
                  <li>Don't use old certificate forms — ensure current IET edition</li>
                  <li>Avoid generic results — each installation is unique</li>
                  <li>
                    Never sign incomplete certificates — all sections must be completed or marked
                    "N/A"
                  </li>
                </ul>
              </div>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-red-500/5 border border-red-500/20">
                <p className="font-medium text-red-400 mb-2">
                  Case Study 1: The "Satisfactory" Disaster
                </p>
                <p className="text-sm text-white mb-2">
                  On a £50,000 commercial office fit-out, the contractor failed to record insulation
                  resistance values and instead wrote "satisfactory" throughout. Six months later, a
                  fault caused equipment damage and business interruption.
                </p>
                <p className="text-xs text-white">
                  <strong>Consequences:</strong> £15,000 re-testing and rectification, insurance
                  claim rejected, loss of future contracts worth £200,000+, professional sanctions
                  from competent person scheme.
                </p>
              </div>

              <div className="p-4 rounded-lg bg-green-500/5 border border-green-500/20">
                <p className="font-medium text-green-400 mb-2">
                  Case Study 2: The Photography Success
                </p>
                <p className="text-sm text-white mb-2">
                  An industrial contractor routinely photographed all test instrument displays
                  during commissioning. When a dispute arose 18 months later, the photographs proved
                  invaluable.
                </p>
                <p className="text-xs text-white">
                  <strong>Outcome:</strong> Client accepted responsibility for maintenance issues.
                  Contractor's reputation protected and additional maintenance contract secured.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                <div className="space-y-2">
                  ...
                  <div className="flex items-start gap-2">
                    <span className="text-green-400">✓</span>
                    <span className="text-white">Record numerical values, not "OK".</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-green-400">✓</span>
                    <span className="text-white">Double-check units before entry.</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-green-400">✓</span>
                    <span className="text-white">Sign and date all certificates.</span>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex items-start gap-2">
                  ...
                  <div className="flex items-start gap-2">
                    <span className="text-green-400">✓</span>
                    <span className="text-white">Photograph readings as backup.</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-green-400">✓</span>
                    <span className="text-white">
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-green-500/5 border border-green-500/20">
              <ul className="text-white space-y-2 list-disc pl-6">
                <li>
                  You now understand the importance of recording inspection and test results for
                ...
                <li>
                  You are aware of the legal and regulatory requirements under BS 7671 and EAWR.
                </li>
              </ul>
            </div>
          </section>
