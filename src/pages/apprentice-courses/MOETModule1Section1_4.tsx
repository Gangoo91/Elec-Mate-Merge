...
const DESCRIPTION =
  'Comprehensive guide to the Work at Height Regulations 2005 for electrical maintenance technicians: hierarchy of controls, access equipment, inspection requirements, harness systems, rescue plans and electrical-specific height work.';
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Pre-use inspection must check: stiles for cracks, splits, bends, or corrosion; rungs for damage, looseness, or contamination; feet for wear and grip condition; locking mechanisms (for stepladders) for proper function; and overall condition including labels and markings. Any defect means the ladder must be taken out of service immediately.',
  },
  {
    id: 6,
...
const faqs = [
  {
    ...
    answer:
      "There is no minimum height threshold. The Work at Height Regulations 2005 apply to all work where a person could fall a distance liable to cause personal injury. A fall from a stepladder at 1 metre can cause serious head injuries or fractures. Even working at ground level near an open trench or excavation is 'work at height' under the Regulations.",
  },
  {
    question: 'Can I use a ladder for electrical maintenance work?',
    answer:
      'Ladders should only be used when a risk assessment confirms the task is of short duration (typically minutes, not hours), the risk is low, and site conditions are suitable. For most electrical maintenance tasks — cable tray installation, luminaire replacement, cable containment work — the duration and need for two-handed working means a scaffold, tower scaffold, podium step, or MEWP is more appropriate. Ladders are a last resort, not a default choice.',
  },
  {
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              from falls, with many hundreds more suffering life-changing injuries — spinal
              fractures, traumatic brain injuries, and permanent disability. The Work at Height
              Regulations 2005 were introduced to provide a comprehensive legal framework for
              managing this risk.
            </p>
            <p>
              For electrical maintenance technicians, work at height is a routine part of the job.
              Cable tray runs at 3-4 metres, luminaire replacement, overhead busbar maintenance,
              cable containment installation, and access to plant rooms on mezzanines or rooftops
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              the working environment, the load to be carried, and the number of workers involved.
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              of fatal falls, and objects dropped from height can cause serious or fatal injuries to
              people below. Electrical maintenance technicians frequently encounter both hazards —
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              protection (guardrails, platforms) is not reasonably practicable. However, there are
              electrical maintenance scenarios where harness use is necessary: working from boom
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              electric shock at height is likely to fall as well — the involuntary muscular
