...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Quarterly', 'Annually (typically)', 'Every three years only', 'Monthly'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Energy Manager', 'Facilities Manager', 'Top Management', 'External Auditor'],
    correctAnswer: 2,
    explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/h-n-c-module6-section5"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ISO 50001 is structured around High-Level Structure (HLS) shared with ISO 14001 and
              ISO 9001 — easy integration with existing management systems. SEU identification is
              the key technical step: the EnMS focus and resource is concentrated on the few
              processes / systems that drive most consumption.
            </>
          }
        ...
        <ConceptBlock title="ISO 50001 Structure and Fundamentals">
          <p>
            ISO 50001 is the international standard for energy management systems (EnMS), providing
            organisations with a systematic framework to manage energy use, improve efficiency, and
            reduce costs. First published in 2011 and revised in 2018, it adopts the High-Level
            Structure common to all ISO management system standards.
          </p>
          <p>
            <strong>ISO 50001:2018 Clause Structure:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Clause 4:</strong> Context of the organisation - understanding internal and
              external issues
            </li>
            <li>
              <strong>Clause 5:</strong> Leadership - top management commitment and energy policy
            </li>
            <li>
              <strong>Clause 6:</strong> Planning - energy review, EnPIs, baselines, objectives
            </li>
            <li>
              <strong>Clause 7:</strong> Support - resources, competence, awareness, communication
            </li>
            <li>
              <strong>Clause 8:</strong> Operation - operational planning and control, design,
              procurement
            </li>
            <li>
              <strong>Clause 9:</strong> Performance evaluation - monitoring, internal audit,
              management review
            </li>
            <li>
              <strong>Clause 10:</strong> Improvement - nonconformity, corrective action, continual
              improvement
            </li>
          </ul>
          <p>
            <strong>Key ISO 50001 Concepts</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Energy Management System (EnMS):</strong> Set of interrelated elements to
              establish energy policy and objectives — Documented system covering all energy uses
            </li>
            <li>
              <strong>Significant Energy Use (SEU):</strong> Energy use accounting for substantial
              consumption or improvement potential — HVAC systems, compressed air, lighting
            </li>
            <li>
              <strong>Energy Baseline (EnB):</strong> Quantitative reference for comparing energy
              performance — 2023 calendar year consumption data
            </li>
            <li>
              <strong>Energy Performance Indicator (EnPI):</strong> Quantitative value or measure of
              energy performance — kWh/m², kWh/unit produced
            </li>
            <li>
              <strong>Energy Review:</strong> Analysis of energy efficiency, use, and consumption —
              Annual analysis of all energy sources
            </li>
          </ul>
          <p>
            <strong>Design principle:</strong> ISO 50001 is performance-based, not prescriptive -
            organisations choose how to achieve energy performance improvement within the framework.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Plan-Do-Check-Act Cycle">
          <p>
            The PDCA cycle is the fundamental methodology underpinning ISO 50001. This iterative
            process drives continual improvement in energy performance by systematically planning,
            implementing, monitoring, and improving energy management activities.
          </p>
          <p>
          ...
          <p>
            <strong>PDCA in Building Services Context</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Plan:</strong> Energy review — Analyse HVAC, lighting, and plant energy use
              from BMS data
            </li>
            <li>
              <strong>Do:</strong> Implementation — Install VSD on AHU fans, optimise BMS schedules
            </li>
            <li>
              <strong>Check:</strong> Monitoring — Compare kWh/m² pre and post intervention via
              submetering
            </li>
            <li>
              <strong>Act:</strong> Improvement — Extend VSDs to other plant, update O&M procedures
            </li>
          </ul>
          <p>
            <strong>Implementation tip:</strong> The PDCA cycle operates continuously - completion
            of one cycle immediately begins the next, driving ongoing improvement.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Energy Planning and Implementation">
          <p>
            Energy planning is the core of ISO 50001, requiring organisations to analyse their
            energy use, identify opportunities for improvement, and establish systems for managing
            energy performance. Effective implementation requires leadership commitment, adequate
            resources, and clear operational controls.
          </p>
          <p>
            <strong>Energy Policy Requirements</strong>
          </p>
          ...
          <p>
            <strong>Energy Review Process</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Analyse energy use:</strong> Identify current energy sources (electricity,
              gas, oil, renewables)
            </li>
            <li>
              <strong>Evaluate consumption:</strong> Determine past and present energy consumption
              patterns
            </li>
            <li>
              <strong>Identify SEUs:</strong> Determine facilities, equipment, systems, and
              processes with significant energy use
            </li>
            <li>
              <strong>Identify opportunities:</strong> Estimate future energy use and opportunities
              for improvement
            </li>
            <li>
              <strong>Determine variables:</strong> Identify relevant variables affecting SEUs
              (weather, occupancy, production)
            </li>
          </ul>
          <p>
            <strong>Establishing Baselines and EnPIs</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Energy Baseline:</strong> Established using data from suitable period,
              normalised for variables — 2023 consumption adjusted for degree days and occupancy
            </li>
            <li>
              <strong>EnPI Selection:</strong> Must demonstrate energy performance improvement —
              kWh/m²/year, kWh/degree day, kWh/occupant
            </li>
            <li>
              <strong>Data Collection:</strong> Measurement plan with accuracy requirements —
              Monthly submetering of major plant, BMS trending
            </li>
            <li>
              <strong>Baseline Revision:</strong> Required when significant changes occur — Building
              extension, major plant replacement
            </li>
          </ul>
          <p>
            <strong>Operational Control Areas</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Planning tip:</strong> Use submetering data to accurately identify SEUs - often
            20% of equipment accounts for 80% of energy consumption.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Certification and Continual Improvement">
          <p>
            ISO 50001 certification demonstrates to stakeholders that an organisation has
            implemented an effective energy management system. The certification process involves
            assessment by an independent, accredited certification body and requires ongoing
            commitment to maintain certification.
          </p>
          <p>
            <strong>Certification Process Steps</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Gap Analysis:</strong> Assess current state against ISO 50001 requirements
              — 1-2 weeks
            </li>
            <li>
              <strong>2. System Development:</strong> Develop policies, procedures, and
              documentation — 2-4 months
            </li>
            <li>
              <strong>3. Implementation:</strong> Operate the EnMS, collect data, train staff — 3-6
              months
            </li>
            <li>
              <strong>4. Internal Audit:</strong> Verify conformance, identify nonconformities — 1-2
              weeks
            </li>
            <li>
              <strong>5. Management Review:</strong> Top management evaluation of EnMS effectiveness
              — 1 day
            </li>
            <li>
              <strong>6. Stage 1 Audit:</strong> Documentation review by certification body — 1-2
              days
            </li>
            <li>
              <strong>7. Stage 2 Audit:</strong> On-site assessment of implementation — 2-5 days
            </li>
            <li>
              <strong>8. Certification:</strong> Certificate issued (valid 3 years) — 2-4 weeks
            </li>
          </ul>
          <p>
            <strong>Ongoing Certification Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Annual surveillance audits:</strong> Verify continued compliance (years 1 and
              2)
            </li>
            <li>
              <strong>Recertification audit:</strong> Full reassessment every three years
            </li>
            <li>
              <strong>Internal audits:</strong> Regular internal verification of EnMS effectiveness
            </li>
            <li>
              <strong>Management reviews:</strong> Periodic top management evaluation
            </li>
            <li>
              <strong>Continual improvement:</strong> Demonstrated energy performance improvement
            </li>
          </ul>
          <p>
            <strong>Benefits of ISO 50001 Certification</strong>
          </p>
          ...
          <p>
            <strong>Integration with Other Management Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>ISO 14001:</strong> Environmental management — Shared policy, objectives,
              audits, management review
            </li>
            <li>
              <strong>ISO 9001:</strong> Quality management — Documentation control, competence,
              internal audit
            </li>
            <li>
              <strong>ISO 45001:</strong> Health and safety — Leadership, resources, operational
              control
            </li>
            <li>
              <strong>ISO 55001:</strong> Asset management — Asset lifecycle, maintenance,
              performance
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Certification cycle: <strong>3 years</strong> with annual surveillance
            </li>
            <li>
              Baseline period: <strong>Minimum 12 months</strong> of data
            </li>
            <li>
              Typical savings: <strong>10-30%</strong> energy cost reduction
            </li>
            <li>
              ESOS coverage: <strong>90%</strong> of total energy for compliance route
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Lack of top management engagement</strong> - EnMS requires visible
                leadership commitment
              </li>
              <li>
                <strong>Poor data quality</strong> - Unreliable energy data undermines the entire
                system
              </li>
              <li>
                <strong>EnPIs not normalised</strong> - Weather, occupancy, and production affect
                consumption
              </li>
              <li>
                <strong>Treating certification as the goal</strong> - Focus should be on actual
                energy improvement
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A facilities-management company is pursuing ISO 50001 certification across its
              corporate estate. Two months before the certification audit, the internal audit
              identifies multiple non-conformances: SEUs identified but no EnPIs assigned to half of
              them, action plans without owners, management review held but no record of
              input/output. The certification audit is at risk.
            </>
          }
          whatToDo={
            <>
              Defer the certification audit by 8 weeks. Address each non-conformance: (1) assign
              EnPIs to every SEU with baselines; (2) re-issue every action plan with owner, deadline
              and success criteria; (3) re-run the management review with structured agenda per ISO
              50001 clause 9.3 and minute formally. Use the internal audit findings as the agenda.
              Re-audit internally and confirm closure before re-engaging the external auditor.
            </>
          }
          whyItMatters={
            <>
              ISO 50001 certification is structurally similar to ISO 9001 / 14001 — but the subject
              matter is technical (energy data, technical baselines, engineering action plans). Many
              organisations underestimate the technical depth required and fail at the documentation
              maturity test. Internal audit is your safety net.
            </>
          }
        />
