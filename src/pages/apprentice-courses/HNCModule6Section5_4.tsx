...
const quickCheckQuestions = [
  {
    ...
    options: [
      'To reduce carbon emissions only',
  ...
  },
  {
    ...
    options: [
      'A one-time implementation process',
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Monthly', 'Quarterly', 'Annually (typically)', 'Every three years only'],
    correctAnswer: 2,
    explanation:
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>ISO 50001:</strong> International standard for energy management systems
              </li>
              <li className="pl-1">
                <strong>PDCA cycle:</strong> Plan-Do-Check-Act for continual improvement
              </li>
              <li className="pl-1">
                <strong>EnPI:</strong> Energy Performance Indicators measure success
              </li>
              <li className="pl-1">
                <strong>Certification:</strong> Third-party verification by accredited bodies
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>HVAC systems:</strong> Major significant energy uses
              </li>
              <li className="pl-1">
                <strong>Lighting:</strong> Key area for energy improvement
              </li>
              <li className="pl-1">
                <strong>BMS integration:</strong> Critical for monitoring and control
              </li>
              <li className="pl-1">
                <strong>Submetering:</strong> Essential for energy performance tracking
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              providing organisations with a systematic framework to manage energy use, improve
              efficiency, and reduce costs. First published in 2011 and revised in 2018, it adopts
              the High-Level Structure common to all ISO management system standards.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                ISO 50001:2018 Clause Structure:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Clause 4:</strong> Context of the organisation - understanding internal
                  and external issues
                </li>
                <li className="pl-1">
                  <strong>Clause 5:</strong> Leadership - top management commitment and energy
                  policy
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Clause 7:</strong> Support - resources, competence, awareness,
                  communication
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Clause 10:</strong> Improvement - nonconformity, corrective action,
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Set of interrelated elements to establish energy policy and objectives
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Documented system covering all energy uses
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Energy use accounting for substantial consumption or improvement potential
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        HVAC systems, compressed air, lighting
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Energy Baseline (EnB)</td>
                      <td className="border border-white/10 px-3 py-2">
                        Quantitative reference for comparing energy performance
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        2023 calendar year consumption data
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        kWh/m², kWh/unit produced
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Energy Review</td>
                      <td className="border border-white/10 px-3 py-2">
                        Analysis of energy efficiency, use, and consumption
                      </td>
                      <td className="border border-white/10 px-3 py-2">
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              organisations choose how to achieve energy performance improvement within the
              framework.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                PDCA in Building Services Context
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">Energy review</td>
                      <td className="border border-white/10 px-3 py-2">
                        Analyse HVAC, lighting, and plant energy use from BMS data
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Install VSD on AHU fans, optimise BMS schedules
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Compare kWh/m² pre and post intervention via submetering
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Extend VSDs to other plant, update O&M procedures
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Evaluate consumption:</strong> Determine past and present energy
                ...
                <li className="pl-1">
                  <strong>Identify opportunities:</strong> Estimate future energy use and
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Establishing Baselines and EnPIs
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Established using data from suitable period, normalised for variables
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        2023 consumption adjusted for degree days and occupancy
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">EnPI Selection</td>
                      <td className="border border-white/10 px-3 py-2">
                        Must demonstrate energy performance improvement
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Measurement plan with accuracy requirements
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Required when significant changes occur
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Building extension, major plant replacement
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Planning tip:</strong> Use submetering data to accurately identify SEUs -
              often 20% of equipment accounts for 80% of energy consumption.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Assess current state against ISO 50001 requirements
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Operate the EnMS, collect data, train staff
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Verify conformance, identify nonconformities
                      </td>
                      <td className="border border-white/10 px-3 py-2">1-2 weeks</td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Top management evaluation of EnMS effectiveness
                      </td>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Annual surveillance audits:</strong> Verify continued compliance (years 1
                  and 2)
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Internal audits:</strong> Regular internal verification of EnMS
                  effectiveness
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Continual improvement:</strong> Demonstrated energy performance
                  improvement
                </li>
              </ul>
            </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Shared policy, objectives, audits, management review
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Documentation control, competence, internal audit
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Leadership, resources, operational control
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Asset lifecycle, maintenance, performance
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Establishing Energy Baseline for Commercial Building
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Identifying Significant Energy Uses
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-green-400">
                  SEUs identified (above 10%): HVAC, Medical Equipment, Lighting
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: PDCA Improvement Cycle - Lighting Upgrade
              </h3>
              <p className="text-sm text-white mb-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                ISO 50001 Implementation Checklist
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Secure top management commitment and appoint energy management representative
                </li>
                <li className="pl-1">
                  Define EnMS scope and boundaries (sites, facilities, processes)
                </li>
                <li className="pl-1">
                  Conduct comprehensive energy review to identify all energy sources and SEUs
                </li>
                ...
                <li className="pl-1">
                  Set measurable energy objectives and targets with action plans
                </li>
                <li className="pl-1">
                  Implement operational controls for SEUs and document procedures
                </li>
                <li className="pl-1">
                  Establish monitoring and measurement plan with regular data collection
                </li>
              </ul>
            </div>
