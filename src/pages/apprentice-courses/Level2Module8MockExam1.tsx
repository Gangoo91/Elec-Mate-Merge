...
const Level2Module8MockExam1 = () => {
  ...
  const history = useMockExamHistory('level2-module8-mock1', user?.id ?? null);
  const failureRates = useQuestionFailureRates(
    'level2-module8-mock1',
  ...
  useEffect(() => {
    ...
    recordMockExamAttempt({
      examSlug: 'level2-module8-mock1',
      source: 'in_app',
      examName: 'Level 2 Mock Exam 1',
      questions: examQuestions,
  ...
  if (!examStarted) {
    return (
      <ExamStartPanel
        ...
        title="Mock Exam 1"
        subtitle="Health and Safety in Building Services Engineering"
        totalQuestions={60}
