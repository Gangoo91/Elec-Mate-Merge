  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Test results provide evidence of compliance with BS 7671 and ensure safety through proper documentation.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'The competent person who carried out or supervised the testing must sign off the test records.',
    },
    {
      id: 10,
  ...
  const faqs = [
    {
      ...
      answer:
        'Yes, digital recording is acceptable provided the results follow BS 7671 formats and are stored securely with appropriate backup systems. Many modern test instruments can export results directly to certification software.',
    },
    {
      question: 'Do minor works require results to be recorded?',
      answer:
        'Yes, all electrical work must have recorded test results. Even minor works require proper documentation on a Minor Works Certificate with relevant test results to demonstrate compliance.',
    },
    {
      question: 'Who is responsible for signing off test records?',
      answer:
        'The competent person carrying out or supervising the testing is responsible for signing off test records. This person must have appropriate qualifications and experience to verify the work meets BS 7671 requirements.',
    },
    {
      question: 'How long should test records be kept?',
      answer:
        'Test records should be kept for the life of the installation plus any relevant warranty periods. Copies should be provided to the client, and the contractor should retain records for potential liability claims.',
    },
    {
      question: 'What happens if I make an error on test records?',
      answer:
        'Any errors should be clearly crossed out and corrected, with the person making the correction initialling and dating the change. Never use correction fluid or erasers - transparency and traceability are essential.',
    },
  ];
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <ul className="text-white/80 text-sm space-y-1">
              ...
              <li>
                • <strong>Use:</strong> BS 7671 Appendix 6 schedules, digital test software
              </li>
              <li>
                • <strong>Check:</strong> All measurements recorded, signatures present, copies
                filed
              </li>
            </ul>
          </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                with BS 7671, supports future maintenance, and highlights issues that require
                corrective action.
              </p>
              <p>
                This subsection explains how to record results, interpret them, and determine what
                actions are needed when faults or anomalies are found.
              </p>
            </div>
          </section>
            ...
            <div className="text-white/80 space-y-6 leading-relaxed">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  ...
                  <li>
                    • <strong>EAWR 1989 Obligations:</strong> Regulation 4(2) requires duty holders
                    to maintain systems in safe condition with documented evidence
                  </li>
                  <li>
                    • <strong>CDM Regulations 2015:</strong> Require health and safety information
                    for future work
                  </li>
                  <li>
                    • <strong>Building Regulations Part P:</strong> Requires electrical work
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h3 className="font-medium text-white mb-3">
                  Professional and Commercial Protection
                </h3>
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>Insurance Requirements:</strong> Insurers require documented proof of
                    proper testing for claims
                  </li>
                  <li>
                    • <strong>Liability Protection:</strong> Detailed records provide evidence of
                    due diligence in legal proceedings
                  </li>
                  <li>
                    • <strong>Warranty Validation:</strong> Manufacturers may void warranties
                    without proper installation certificates
                  </li>
                  <li>
                    • <strong>Contract Compliance:</strong> Many commercial contracts specify
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>Future Reference:</strong> Baseline readings help diagnose developing
                    faults during periodic inspections
                  </li>
                  <li>
                    • <strong>Maintenance Planning:</strong> Historical data enables predictive
                    maintenance strategies
                  </li>
                  <li>
                    • <strong>Fault Diagnosis:</strong> Previous test results aid in identifying
                    changes and deterioration
                  </li>
                  <li>
                    • <strong>Asset Management:</strong> Test records form part of electrical asset
                    registers
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-6 leading-relaxed">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    ...
                    installations, complete rewires, and major alterations
                  </li>
                  <li>
                    • <strong>Minor Works Certificate (MWC):</strong> For additions, alterations,
                    and replacements not covered by EIC
                  </li>
                  <li>
                  ...
                  <li>
                    • <strong>Periodic Inspection Report:</strong> Specific format for rental
                    properties under Electrical Safety Standards
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h3 className="font-medium text-white mb-3">
                  Test Result Schedules and Appendices
                </h3>
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>Schedule of Test Results:</strong> Detailed measurements for each
                    circuit (R1, R2, R1+R2, ring circuit continuity)
                  </li>
                  <li>
                    • <strong>Schedule of Items Inspected:</strong> Visual inspection findings and
                    observations
                  </li>
                  <li>
                    • <strong>Schedule of Circuit Details:</strong> Circuit references, cable types,
                    protection devices
                  </li>
                  <li>
                    • <strong>BS 7671 Appendix 6 Templates:</strong> Standardised formats ensuring
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h3 className="font-medium text-white mb-3">
                  Digital and Supporting Documentation
                </h3>
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>Test Instrument Memory:</strong> Modern testers can store thousands of
                    results with circuit references
                  </li>
                  <li>
                    • <strong>Certification Software:</strong> Professional packages like Amtech,
                    Fluke DMS, or Megger software
                  </li>
                  <li>
                    • <strong>Cloud Storage:</strong> Secure backup and client access through online
                    portals
                  </li>
                  <li>
                    • <strong>Photographic Evidence:</strong> Digital images of test setups, meter
                    readings, and installation details
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-6 leading-relaxed">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>Measured Values:</strong> Record actual ohmic readings to appropriate
                    decimal places (e.g., R1+R2 = 0.45Ω, not 0.5Ω)
                  </li>
                  <li>
                    • <strong>Units and Symbols:</strong> Always include correct units (Ω, V, A, mA)
                    and standard electrical symbols
                  </li>
                  <li>
                    • <strong>Range Selection:</strong> Use appropriate test instrument ranges for
                    maximum accuracy
                  </li>
                  <li>
                    • <strong>Null Readings:</strong> Record zero readings as "0.00" not "NIL" or
                    "-" to show test was performed
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>Legibility:</strong> Use block capitals for names and addresses, clear
                    numerical entries
                  </li>
                  <li>
                    • <strong>Permanent Ink:</strong> Black or blue ink only, no pencil or erasable
                    ink
                  </li>
                  <li>
                    • <strong>Circuit References:</strong> Match circuit labels in distribution
                    board exactly
                  </li>
                  <li>
                    • <strong>Signatures:</strong> Full signatures not initials, with printed name
                    underneath
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>Backup Systems:</strong> Multiple storage locations, cloud
                    synchronisation
                  </li>
                  <li>
                    • <strong>Data Validation:</strong> Built-in range checking and error detection
                  </li>
                  <li>
                    • <strong>Traceability:</strong> Audit trails showing who entered data and when
                  </li>
                  <li>
                    • <strong>Export Formats:</strong> PDF generation for client copies, CSV for
                    data analysis
                  </li>
                </ul>
              </div>
          ...
          <InlineCheck
            ...
            options={[
              'Pass/fail only',
              'Measured ohmic values (e.g., R1+R2)',
            ...
            <div className="text-white/80 space-y-6 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
                <h3 className="font-medium text-orange-400 mb-3">
                  Minor Deviations (Investigation Required)
                </h3>
                <ul className="text-sm space-y-2">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                <h3 className="font-medium text-red-400 mb-3">
                  Non-Compliance (Rectification Required)
                </h3>
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>Do Not Energise</strong> until faults rectified
                  </li>
          ...
          <InlineCheck
            ...
            options={[
              'Continue with installation',
              'Do not energise until rectified',
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-6 leading-relaxed">
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>EAWR 1989 Prosecution:</strong> Fines up to £20,000 and imprisonment
                    for serious breaches
                  </li>
                  <li>
                    • <strong>HSE Enforcement:</strong> Prohibition notices stopping work until
                    compliance achieved
                  </li>
                  <li>
                    • <strong>Professional Misconduct:</strong> Disciplinary action by professional
                    bodies and trade associations
                  </li>
                  <li>
                    • <strong>Court Evidence:</strong> Inability to defend against liability claims
            ...
            <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
              ...
              <div className="text-white/80 text-sm space-y-3 leading-relaxed">
                <p>
                  ...
                  junior electricians failed to properly record continuity and polarity test results
                  for several floors of the installation. They noted "satisfactory" on certificates
                  without recording actual measured values.
                </p>
                <p>
                  Three months after handover, a serious earth fault occurred on the 8th floor,
                  causing a complete power outage and potential fire risk. The building's insurance
                  company demanded to see all test records as part of their investigation.
                </p>
                <p className="font-medium text-amber-400">
                  When proper records couldn't be provided:
                </p>
                ...
                <p className="font-medium text-white mt-3">
                  Outcome: Total cost exceeded £150,000, plus severe reputational damage. The
                  company now uses digital test instruments with mandatory data logging and random
                  audits of all test records.
                </p>
              </div>
            </div>
          </section>
