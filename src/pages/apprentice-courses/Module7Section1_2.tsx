...
const TITLE =
  'Why Faults Occur in Electrical Installations - Module 7.1.2 | Level 2 Electrical Course';
const DESCRIPTION =
  'Understanding the common causes of electrical faults including poor workmanship, material failure, environmental influences, and misuse.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'It makes connections stronger',
      'It improves current flow',
    ],
    correctIndex: 1,
    explanation:
      'Loose connections cause overheating and arcing due to increased resistance, which can lead to insulation damage and fire risks.',
  },
  {
    ...
    options: [
      "It's not necessary",
      'Materials deteriorate over time due to heat, UV, and wear',
      'To create more work',
      'To use more equipment',
    ],
    correctIndex: 1,
    explanation:
      'Even correctly installed materials deteriorate over time due to heat, UV exposure, mechanical wear, and ageing, making periodic inspection essential.',
  },
  {
    id: 'environmental-check',
    question: 'Name two environmental conditions that can contribute to electrical faults.',
    options: [
      'Good lighting and clean air',
      'Moisture ingress and excessive heat',
      'Low humidity and stable temperature',
      'Fresh air and dry conditions',
    ],
    correctIndex: 1,
    explanation:
      'Moisture ingress and excessive heat are major environmental factors that can cause insulation breakdown and electrical faults.',
  },
  {
    ...
    options: [
      'Nothing happens',
      'Overheating leading to insulation breakdown and fire risk',
      'It becomes more efficient',
      'It uses less electricity',
    ],
    correctIndex: 1,
    explanation:
      'Consistent overloading causes overheating, which accelerates insulation breakdown and creates serious fire risks.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Poor workmanship during installation, such as loose connections and damaged insulation, is one of the leading causes of electrical faults.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Loose connections create increased resistance, leading to overheating and arcing that can cause insulation damage and fire.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Periodic inspection (EICR) identifies faults caused by material ageing or deterioration before they create dangerous conditions.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Excessive heat causes cable insulation to dry out, crack, and break down, reducing its effectiveness and creating fault conditions.',
  },
  {
    id: 5,
    ...
    options: [
      ...
      'Moisture ingress and excessive heat',
      'Clean air and stable temperature',
      'Low humidity and cool temperature',
    ],
    correctAnswer: 1,
    explanation:
      'Moisture ingress and excessive heat are major environmental factors that can significantly reduce insulation resistance and cause faults.',
  },
  {
    id: 6,
    question:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Overloading sockets causes overheating, which accelerates insulation breakdown and creates serious fire risks.',
  },
  {
    id: 8,
    question: 'How can rodents create electrical faults?',
    options: [
      'They cannot affect electrical systems',
      'By chewing through cable insulation and damaging conductors',
      'They improve cable performance',
      'They clean the cables',
    ],
    correctAnswer: 1,
    explanation:
      'Rodents can chew through cable insulation and damage conductors, creating short circuits, earth faults, and fire risks.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Selecting environment-appropriate materials prevents premature failure and ensures long-term safety and reliability of the installation.',
  },
  {
    id: 10,
    question:
    ...
    correctAnswer: 1,
    explanation:
      'The installer used standard PVC cable too close to a heat source instead of heat-resistant cable, causing premature deterioration.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Yes — if workmanship is poor or the wrong materials are used. Even new installations can have faults if not properly designed, installed, or tested.',
  },
  {
    question: 'Do materials fail even if installed correctly?',
    answer:
      'Over time, yes. Ageing, heat, UV exposure, and mechanical wear can all cause properly installed materials to deteriorate and eventually fail.',
  },
  {
    question: 'Why do electricians carry out EICRs?',
    answer:
      "To identify faults caused by ageing or deterioration before they become dangerous. EICRs help maintain electrical safety throughout the installation's life.",
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Causes:</strong> Poor workmanship, material failure, environmental factors
              </li>
              <li>
                <strong>Prevention:</strong> Most faults are preventable with correct practices
              </li>
              <li>
                <strong>Understanding:</strong> Knowing causes helps prevent future problems
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Loose connections, wrong materials, environmental stress
              </li>
              <li>
                <strong>Use:</strong> Proper installation techniques, suitable materials
              </li>
              <li>
                <strong>Check:</strong> Environmental conditions, material suitability
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Poor installation practices are the leading cause of electrical faults in new
              installations, accounting for approximately 45% of all faults discovered during
              initial testing.
            </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Root Causes of Poor Workmanship:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Inadequate training:</strong> Insufficient knowledge of BS 7671
                  requirements
                </li>
                <li>
                  <strong>Time pressure:</strong> Rushing work to meet unrealistic deadlines
                </li>
                <li>
                  <strong>Poor supervision:</strong> Lack of quality control during installation
                </li>
                <li>
                  <strong>Wrong tools:</strong> Using inappropriate or damaged tools
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                Careful workmanship and adherence to BS 7671 standards prevent many faults before
                they occur. Quality installation is the first line of defence.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Heat:</strong> Accelerates polymer degradation
                  </li>
                  <li>
                    <strong>UV Radiation:</strong> Breaks down molecular bonds
                  </li>
                  <li>
                    <strong>Moisture:</strong> Causes metal corrosion
                  </li>
                  <li>
                    <strong>Chemical Attack:</strong> Industrial environments
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Vibration:</strong> Loosens connections
                  </li>
                  <li>
                    <strong>Thermal Cycling:</strong> Expansion and contraction
                  </li>
                  <li>
                    <strong>Cable Movement:</strong> Conductor fatigue
                  </li>
                  <li>
                    <strong>Physical Loading:</strong> Impact damage
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              External factors are another major cause of electrical faults. Electrical systems must
              be designed and installed with environmental risks in mind.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Design Consideration:</strong> Electrical systems must be designed and
              installed with environmental risks in mind, using suitable materials and protective
              measures.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Circuits are designed with specific limits, and exceeding those limits creates fault
              conditions. User behaviour plays a significant role in fault development.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-white/5">
            <h3 className="text-sm font-medium text-white mb-3">
              Case Study: Community Centre Kitchen Circuit
            </h3>
            <p className="text-sm text-white mb-4">
              A community centre experienced repeated tripping on its kitchen ring circuit.
              Investigation revealed that the cable insulation had degraded near a cooker point. The
              original installation used standard PVC cable too close to a heat source, which
            ...
            <div className="p-3 rounded bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                ...
                factors such as poor installation practices, unsuitable materials, or environmental
                stress. The cable had to be replaced with heat-resistant cable at extra cost.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white leading-relaxed">
            Faults occur because of poor workmanship, material failure, environmental influences, or
            misuse. They are rarely random — most are predictable and preventable. Understanding why
            faults occur helps electricians design better, install carefully, and maintain systems
            safely. The key is to consider all factors during installation and to educate users
            about proper electrical system use.
          </p>
        </section>
