...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "Faraday's Law states that induced EMF equals the rate of change of flux linkage: e = -N x (d(Phi)/dt). Faster change means greater EMF.",
  },
  {
    question: "What does Lenz's Law tell us about the direction of induced current?",
    options: [
      'It flows in the same direction as the primary current',
      'It opposes the change causing it',
      'It always flows clockwise',
      'It depends on conductor resistance',
    ],
    correctIndex: 1,
    explanation:
      "Lenz's Law states that the direction of induced current is always such as to oppose the change producing it. This is represented by the negative sign in Faraday's equation.",
  },
  {
    question:
      'A coil of 200 turns experiences a flux change of 0.01 Wb in 0.02 seconds. What is the induced EMF?',
    options: ['1 V', '10 V', '100 V', '0.1 V'],
    correctIndex: 2,
    explanation:
      'EMF = N x (change in Phi / change in t) = 200 x (0.01 / 0.02) = 200 x 0.5 = 100 V.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Generators use electromagnetic induction - a conductor moving through a magnetic field has an EMF induced across it. This is the basis of all electrical generation.',
  },
];
...
const quizQuestions = [
  {
    question:
      'A conductor 0.5m long moves at 20 m/s through a magnetic field of 0.8 T. What EMF is induced?',
  ...
  {
    question:
      'The flux through a 500-turn coil decreases from 20 mWb to 5 mWb in 10 ms. Calculate the average induced EMF.',
    options: ['75 V', '750 V', '7.5 V', '7500 V'],
    correctIndex: 1,
    explanation:
      'EMF = N x (change in Phi / change in t) = 500 x ((0.020 - 0.005) / 0.01) = 500 x (0.015 / 0.01) = 500 x 1.5 = 750 V.',
  },
  {
    question: "Why is the negative sign important in Faraday's Law equation (e = -N x d(Phi)/dt)?",
    options: [
      'It indicates power loss',
      "It represents Lenz's Law - opposition to change",
      'It shows decreasing flux',
      'It corrects for measurement error',
    ],
    correctIndex: 1,
    explanation:
      "The negative sign represents Lenz's Law, indicating that the induced EMF opposes the change in flux. Without this opposition, energy would not be conserved.",
  },
  {
    question:
      'A coil rotates at 3000 rpm in a magnetic field. How many complete cycles occur per second?',
    options: ['50 Hz', '3000 Hz', '100 Hz', '25 Hz'],
    correctIndex: 0,
    explanation:
      'Frequency = rpm / 60 = 3000 / 60 = 50 Hz. Each rotation produces one complete AC cycle in a simple generator.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'No EMF is induced if there is no change in flux linkage. Either the conductor must move, the field must change, or both - a constant situation induces nothing.',
  },
  {
    ...
    options: [
      ...
      'Current direction in a motor',
    ],
    correctIndex: 1,
    explanation:
      "Fleming's Right-Hand Rule (for generators) relates Motion, Field and induced EMF direction. The left-hand rule is for motors (force on current).",
  },
  {
    question:
      'If the speed of a generator is doubled while keeping the field constant, what happens to the induced EMF?',
    options: ['Halved', 'Unchanged', 'Doubled', 'Quadrupled'],
    correctIndex: 2,
    explanation:
      'EMF is proportional to the rate of change of flux (or velocity in e = Blv). Doubling speed doubles the rate of flux cutting, hence doubling the EMF.',
  },
  {
    question:
      'A transformer primary has 1000 turns and secondary has 100 turns. If primary flux is 10 mWb, what is the flux in the secondary?',
    options: ['1 mWb', '10 mWb', '100 mWb', '0.1 mWb'],
    correctIndex: 1,
    explanation:
      'In an ideal transformer, the same flux links both windings. The flux is 10 mWb in both primary and secondary - only the voltage differs due to different turns.',
  },
  {
    question:
      'What is the peak EMF in a coil of 100 turns, area 0.02 m squared, rotating at 50 Hz in a 1.5 T field?',
    options: ['471 V', '942 V', '150 V', '300 V'],
    correctIndex: 1,
    explanation:
      'Peak EMF = N x B x A x omega = N x B x A x 2 x pi x f = 100 x 1.5 x 0.02 x 2 x 3.142 x 50 = 942 V.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'AC creates changing flux which induces eddy currents in the core. Laminations (thin insulated sheets) break up eddy current paths, reducing I squared R losses.',
  },
  {
    question: 'An RCD trips when:',
    options: [
      'Current exceeds 30A',
      'Voltage exceeds 253V',
      'Imbalance between live and neutral currents is detected',
      'Temperature exceeds safe limits',
    ],
    correctIndex: 2,
    explanation:
      'RCDs use electromagnetic induction. If live and neutral currents are equal (balanced), the net flux is zero. Any imbalance (earth fault) creates net flux that induces EMF to trip the device.',
  },
  {
    question: 'The back-EMF in a motor:',
    options: [
      'Assists the supply voltage',
      'Opposes the supply voltage',
      'Only appears at start-up',
      'Is independent of speed',
    ],
    correctIndex: 1,
    explanation:
      "As the motor armature rotates in the magnetic field, it acts like a generator producing back-EMF that opposes the supply. This limits current as speed increases - demonstrated by Lenz's Law.",
  },
];
          ...
          <div className="mb-12">
            ...
            <div className="bg-[#242424] rounded-lg p-6 border border-white/10">
              ...
              <ul className="text-white space-y-2 mb-4">
                ...
                <li>
                  The method of change doesn't matter - moving conductor, moving magnet, or changing
                  current all work
                </li>
              </ul>
          ...
          <div className="mb-12">
            ...
            <div className="bg-[#242424] rounded-lg p-6 border border-white/10">
              ...
              <p className="text-white mb-4">
                ...
                Energy must be put into the system to cause the change.
              </p>
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 mb-4">
                ...
                <ul className="text-white text-sm space-y-2">
                  ...
                  <li>
                    <strong>Transformer:</strong> Secondary current creates flux opposing primary
                    flux - primary current increases to compensate
                  </li>
                  <li>
                    <strong>Eddy currents:</strong> Oppose the motion that creates them - used in
                    electromagnetic braking
                  </li>
                  <li>
                    <strong>Motor back-EMF:</strong> Opposes supply voltage - limits current as
                    motor speeds up
                  </li>
                </ul>
              </div>
              ...
              <InlineCheck
                ...
                options={[
                  'Falls at normal speed - copper is non-magnetic',
                  'Falls slowly due to induced currents opposing its motion',
                  'Accelerates due to induced currents',
                  'Stops completely in the tube',
                ]}
                correctIndex={1}
            ...
            <div className="bg-[#242424] rounded-lg p-6 border border-white/10">
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 mb-4">
                <p className="text-green-400 font-mono mb-2">
                  Instantaneous: e = E(max) x sin(omega x t)
                </p>
                <p className="text-green-400 font-mono mb-2">
            ...
            <div className="bg-[#242424] rounded-lg p-6 border border-white/10">
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 mb-4">
                <ul className="text-white space-y-3">
                  ...
                  <li>
                    <strong>Inductors/Chokes:</strong> Oppose changes in current. Used in filters,
                    motor starting, and power factor correction reactors.
                  </li>
                  <li>
                    <strong>Current Transformers:</strong> Measure high currents safely. Primary is
                    the main conductor, secondary provides scaled-down current.
                  </li>
                  <li>
                    <strong>RCDs:</strong> Line and neutral pass through a toroid. Equal currents
                    create zero net flux. Any imbalance induces EMF in sensing coil, triggering
                    trip.
                  </li>
                  <li>
                    <strong>Induction Heating:</strong> High-frequency changing field induces eddy
                    currents in metal workpiece, causing direct heating.
                  </li>
                </ul>
              </div>
              ...
              <InlineCheck
                ...
                options={[
                  'It would damage the primary winding',
                  'Dangerous high voltage would be induced in the open secondary',
                  'The core would demagnetise',
                  'The meter would give wrong readings',
                ]}
                correctIndex={1}
            ...
            <div className="bg-yellow-900/30 border border-yellow-500/50 rounded-lg p-6">
              ...
              <ul className="text-white space-y-2">
                <li>
                  ...
                  Star-delta and VFD starting reduce this.
                </li>
                <li>
                  <strong>CT secondary circuits:</strong> Never open-circuit a live CT. If meter
                  must be removed, short secondary first. CT secondaries should be earthed at one
                  point only.
                </li>
                <li>
                  <strong>Inductive loads:</strong> Opening inductive circuits suddenly causes high
                  voltage spikes (Lenz's Law). Snubber circuits, flywheel diodes or RC suppressors
                  protect contacts and electronics.
                </li>
                <li>
                  <strong>Electromagnetic compatibility:</strong> Changing currents induce voltages
                  in nearby conductors. Proper segregation, screening and filtering required per BS
                  7671 Chapter 44.
                </li>
              </ul>
            </div>
