    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>DX Systems:</strong> Refrigerant directly cools the air (no secondary
                medium)
              </li>
              <li className="pl-1">
                <strong>Split Systems:</strong> Indoor unit + outdoor unit connected by refrigerant
                pipes
              </li>
              <li className="pl-1">
                <strong>VRF/VRV:</strong> Variable refrigerant flow to multiple indoor units
              </li>
              <li className="pl-1">
                <strong>Heat Recovery:</strong> 3-pipe systems for simultaneous heating and cooling
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Applications:</strong> Offices, retail, hotels, healthcare
              </li>
              <li className="pl-1">
                <strong>Electrical:</strong> Single-phase or three-phase supplies
              </li>
              <li className="pl-1">
                <strong>Controls:</strong> Individual zone control, BMS integration
              </li>
              <li className="pl-1">
                <strong>F-gas:</strong> Refrigerant handling regulations
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              (indoor unit). This arrangement provides flexibility in installation whilst
              maintaining efficient heat rejection.
            </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Small offices, bedrooms, server rooms
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Open plan offices, retail, restaurants
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Concealed installations, multiple rooms
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Server rooms, areas without ceiling void
                      </td>
                    </tr>
                    <tr>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              standard systems. Longer runs require additional refrigerant charge and may need
              larger pipe sizes to maintain performance.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Individual runs or branch boxes
                      </td>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Refrigerant piping:</strong> Header system with Y-branches to each indoor
                  unit
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Indoor units:</strong> Any combination of wall, cassette, ducted, floor
                  units
                </li>
                <li className="pl-1">
                  <strong>Controls:</strong> Centralised controller, individual remotes, BMS
                  integration
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Inverter compressors:</strong> Variable speed operation matches load
                  precisely
                </li>
                <li className="pl-1">
                  <strong>Part-load efficiency:</strong> Optimum COP often achieved at 40-60%
                  capacity
                </li>
                <li className="pl-1">
                  <strong>Heat recovery:</strong> Energy from cooling zones supplements heating
                  zones
                </li>
                <li className="pl-1">
                  <strong>Reduced duct losses:</strong> Refrigerant distribution more efficient than
                  air
                </li>
              </ul>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Correct refrigerant pipe sizing is critical for DX system performance. Undersized
              pipes cause excessive pressure drop reducing capacity, whilst oversized pipes can
              result in poor oil return and increased refrigerant charge.
            </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Maintain subcooling, prevent flash gas
                      </td>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              Pipe sizing software from manufacturers should be used for complex VRF installations
              to verify pressure drop and oil return.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                VRF systems use inverter-driven compressors which create specific electrical
                challenges:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Harmonic distortion:</strong> May require harmonic filters on larger
                  systems
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Earth leakage:</strong> Capacitive currents may cause nuisance RCD
                  tripping
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Documentation:</strong> Complete commissioning records including pressure
              tests, vacuum records, refrigerant charge, electrical readings and control settings
              must be retained and provided to the client as part of O&amp;M manuals.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Split System Electrical Sizing
              </h3>
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  → Specify: 20A Type C MCB, 2.5mm² T+E, local isolator
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: VRF Additional Refrigerant Charge
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> A VRF system has 85m of 9.52mm liquid line and 95m of
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Three-Phase VRF Current Calculation
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  → Specify: 100A 3-phase supply, 25mm² 4-core SWA
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>3-pipe VRF:</strong> Large buildings, diverse loads, heat recovery
                  potential
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Outdoor unit location:</strong> Adequate airflow, noise impact,
                  maintenance access
                </li>
                <li className="pl-1">
                  <strong>Pipe routes:</strong> Shortest practical, avoid heat sources, provision
                  for expansion
                </li>
                <li className="pl-1">
                  <strong>Condensate drainage:</strong> Falls to drain points, trace heating if
                  exposed
                </li>
                <li className="pl-1">
                  <strong>Controls integration:</strong> BMS connectivity, scheduling, energy
                  monitoring
                </li>
              </ul>
            </div>
