...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['50 metres', '10 metres', '15-25 metres', '100 metres'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['15 metres', '100 metres', '75 metres', '30-50 metres'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 8,
    question:
      'What is the primary consideration when sizing the liquid line in a refrigerant circuit?',
    options: [
...
const HNCModule8Section3_2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 3 · Subsection 2"
        title="DX Systems"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Split System Fundamentals">
          <p>
            Split systems are the most common form of air conditioning, separating the noisy
            compressor and condenser (outdoor unit) from the quiet evaporator and air distribution
            (indoor unit). This arrangement provides flexibility in installation whilst maintaining
            efficient heat rejection.
          </p>
          <p>
            <strong>Split System Components:</strong>
          </p>
          <p>
            <strong>Indoor Unit</strong>
          </p>
          ...
          <p>
            <strong>Split System Types</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Wall-mounted:</strong> 2.5 - 8 kW — Small offices, bedrooms, server rooms
            </li>
            <li>
              <strong>Ceiling cassette:</strong> 3.5 - 14 kW — Open plan offices, retail,
              restaurants
            </li>
            <li>
              <strong>Ducted:</strong> 5 - 25 kW — Concealed installations, multiple rooms
            </li>
            <li>
              <strong>Floor-standing:</strong> 3.5 - 7 kW — Server rooms, areas without ceiling void
            </li>
            <li>
              <strong>Under-ceiling:</strong> 3.5 - 14 kW — Exposed ceiling applications
            </li>
          </ul>
          <p>
            <strong>Refrigerant Connections</strong>
          </p>
          <p>Split systems require two refrigerant pipes between indoor and outdoor units:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Liquid line (smaller):</strong> High-pressure liquid from condenser to
              expansion device
            </li>
            <li>
              <strong>Suction/gas line (larger):</strong> Low-pressure gas from evaporator to
              compressor
            </li>
            <li>
              <strong>Pipe sizing:</strong> Typically 6.35mm liquid, 9.52-15.88mm suction for
              residential units
            </li>
            <li>
              <strong>Insulation:</strong> Both pipes require insulation; suction line prevents
              condensation
            </li>
          </ul>
          <p>
            <strong>Installation note:</strong> Maximum pipe lengths are typically 15-25m for
            standard systems. Longer runs require additional refrigerant charge and may need larger
            pipe sizes to maintain performance.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Multi-Split and VRF/VRV Technology">
          <p>
            ...
            (Variable Refrigerant Flow) systems extend this concept with sophisticated inverter
            control and the ability to serve large numbers of indoor units with precise individual
            control.
          </p>
          <p>
            <strong>Multi-Split vs VRF Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Indoor units per outdoor:</strong> 2-9 units — Up to 64+ units
            </li>
            <li>
              <strong>Capacity range:</strong> 4-14 kW outdoor — 14-150+ kW outdoor
            </li>
            <li>
              <strong>Piping configuration:</strong> Individual runs or branch boxes — Header and
              branch system
            </li>
            <li>
              <strong>Capacity modulation:</strong> Stepped or basic inverter — Full inverter,
              10-100%
            </li>
            <li>
              <strong>Simultaneous heat/cool:</strong> Not available — 3-pipe systems only
            </li>
            <li>
              <strong>Maximum pipe length:</strong> 25-50m typical — 165-200m+ from outdoor unit
            </li>
          </ul>
          <p>
            <strong>VRF System Architecture:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Outdoor unit(s):</strong> Modular, can be combined for larger capacity
            </li>
            <li>
              <strong>Refrigerant piping:</strong> Header system with Y-branches to each indoor unit
            </li>
            <li>
              <strong>BC/BS boxes:</strong> Branch controller/selector boxes for heat recovery
              systems
            </li>
            <li>
              <strong>Indoor units:</strong> Any combination of wall, cassette, ducted, floor units
            </li>
            <li>
              <strong>Controls:</strong> Centralised controller, individual remotes, BMS integration
            </li>
          </ul>
          <p>
            <strong>2-Pipe VRF Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>3-Pipe VRF (Heat Recovery)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>VRF Energy Efficiency</strong>
          </p>
          <p>VRF systems achieve high seasonal efficiency through:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Inverter compressors:</strong> Variable speed operation matches load precisely
            </li>
            <li>
              <strong>Part-load efficiency:</strong> Optimum COP often achieved at 40-60% capacity
            </li>
            <li>
              <strong>Heat recovery:</strong> Energy from cooling zones supplements heating zones
            </li>
            <li>
              <strong>Reduced duct losses:</strong> Refrigerant distribution more efficient than air
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Design tip:</strong> VRF connected capacity ratio (total indoor to outdoor)
            typically ranges from 50-130%. Higher ratios rely on diversity but reduce available
            capacity per unit at peak times.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Refrigerant Pipe Sizing and Installation">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Liquid line:</strong> Maintain subcooling, prevent flash gas — 0.5 - 1.5 m/s
              typical
            </li>
            <li>
              <strong>Suction line (horizontal):</strong> Oil return, pressure drop — &gt; 3.5 m/s
              minimum
            </li>
            <li>
              <strong>Suction line (vertical rise):</strong> Oil lift against gravity — &gt; 5-7 m/s
              minimum
            </li>
            <li>
              <strong>Discharge line:</strong> Noise, pressure drop — 10-18 m/s typical
            </li>
          </ul>
          <p>
            <strong>Typical VRF Pipe Sizes (R410A)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2.2 - 3.6 kW:</strong> 6.35 mm (1/4") — 9.52 mm (3/8")
            </li>
            <li>
              <strong>4.5 - 5.6 kW:</strong> 6.35 mm (1/4") — 12.7 mm (1/2")
            </li>
            <li>
              <strong>7.1 - 11.2 kW:</strong> 9.52 mm (3/8") — 15.88 mm (5/8")
            </li>
            <li>
              <strong>14 - 22.4 kW:</strong> 9.52 mm (3/8") — 19.05 mm (3/4")
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Brazing:</strong> Nitrogen purge during brazing to prevent oxidation
            </li>
            <li>
              <strong>Pressure test:</strong> 3.0 MPa with dry nitrogen for 24 hours minimum
            </li>
            <li>
              <strong>Evacuation:</strong> Deep vacuum to below 500 Pa (0.5 mbar) absolute
            </li>
            <li>
              <strong>Leak test:</strong> Electronic leak detector after evacuation
            </li>
            <li>
              <strong>Insulation:</strong> 10-19mm thickness depending on pipe size and location
            </li>
          </ul>
          <p>
            <strong>VRF Piping Limitations</strong>
          </p>
          <p>
            <strong>Maximum Lengths (typical)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Height Differences (typical)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Critical:</strong> Oil traps may be required on suction risers exceeding 10m.
            Pipe sizing software from manufacturers should be used for complex VRF installations to
            verify pressure drop and oil return.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Electrical Requirements and Commissioning">
          ...
          <p>
            <strong>Electrical Supply Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Small split (residential):</strong> 2.5-3.5 kW — 230V 1-ph — 16A Type C
            </li>
            <li>
              <strong>Medium split:</strong> 5-7 kW — 230V 1-ph — 20A Type C
            </li>
            <li>
              <strong>Large split:</strong> 10-14 kW — 230V 1-ph or 400V 3-ph — 32A Type C
            </li>
            <li>
              <strong>VRF outdoor (small):</strong> 14-28 kW — 400V 3-ph — 20-25A Type C
            </li>
            <li>
              <strong>VRF outdoor (medium):</strong> 33-56 kW — 400V 3-ph — 32-40A Type C
            </li>
            <li>
              <strong>VRF outdoor (large):</strong> 73-150+ kW — 400V 3-ph — 63-100A Type C
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Dedicated circuit:</strong> Each outdoor unit requires dedicated supply
            </li>
            <li>
              <strong>Local isolation:</strong> Lockable isolator within sight of outdoor unit
            </li>
            <li>
              <strong>RCD protection:</strong> 30mA RCD for accessible outdoor units per BS 7671
            </li>
            <li>
              <strong>Cable sizing:</strong> Based on manufacturer MCA (Maximum Circuit Amps)
            </li>
            <li>
              <strong>MCB selection:</strong> Type C or D for motor starting currents
            </li>
            <li>
              <strong>EMC:</strong> Screened cables may be required for inverter units
            </li>
          </ul>
          <p>
            <strong>Inverter Considerations</strong>
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Harmonic distortion:</strong> May require harmonic filters on larger systems
            </li>
            <li>
              <strong>High frequency noise:</strong> Can affect sensitive equipment nearby
            </li>
            <li>
              <strong>Earth leakage:</strong> Capacitive currents may cause nuisance RCD tripping
            </li>
            <li>
              <strong>Soft start:</strong> Reduced inrush current vs fixed speed compressors
            </li>
            <li>
              <strong>Power factor:</strong> Generally &gt; 0.95 at full load
            </li>
          </ul>
          <p>
            <strong>Commissioning Procedures</strong>
          </p>
          <p>
          ...
          <p>
            <strong>VRF System Configuration</strong>
          </p>
          <p>VRF systems require address setting and network configuration:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Refrigerant address:</strong> Each indoor unit assigned unique address
            </li>
            <li>
              <strong>Capacity tables:</strong> Entered via outdoor unit or central controller
            </li>
            <li>
              <strong>Communication check:</strong> Verify all units communicate correctly
            </li>
            <li>
              <strong>Charge calculation:</strong> Additional charge based on pipe lengths
            </li>
            <li>
              <strong>Auto-commissioning:</strong> Many systems run automatic charge check
            </li>
          </ul>
          <p>
            <strong>Documentation:</strong> Complete commissioning records including pressure tests,
            vacuum records, refrigerant charge, electrical readings and control settings must be
            retained and provided to the client as part of O&amp;M manuals.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A 7kW single-phase split system has a maximum operating
            current of 12.5A and inrush current of 35A. Specify the electrical supply requirements.
          </p>
          ...
          <p>
            <strong>Question:</strong> A VRF system has 85m of 9.52mm liquid line and 95m of 19.05mm
            suction line beyond the factory allowance. Calculate additional refrigerant charge if
            the liquid line requires 90g/m.
          </p>
          ...
          <p>
            <strong>Question:</strong> A 56kW VRF outdoor unit operates at 0.97 power factor on 400V
            three-phase. Calculate the line current and select appropriate protection.
          </p>
          <p>Using: P = √3 × VL × IL × cos φ</p>
          <p>Rearranging: IL = P / (√3 × VL × cos φ)</p>
          <p>IL = 56,000 / (1.732 × 400 × 0.97)</p>
          <p>
            IL = 56,000 / 672.3 = <strong>83.3A per phase</strong>
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single split:</strong> Individual rooms, server closets, residential
            </li>
            <li>
              <strong>Multi-split:</strong> Small commercial, 2-5 zones, limited outdoor space
            </li>
            <li>
              <strong>2-pipe VRF:</strong> Medium buildings, uniform loads, heat pump operation
            </li>
            <li>
              <strong>3-pipe VRF:</strong> Large buildings, diverse loads, heat recovery potential
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Outdoor unit location:</strong> Adequate airflow, noise impact, maintenance
              access
            </li>
            <li>
              <strong>Pipe routes:</strong> Shortest practical, avoid heat sources, provision for
              expansion
            </li>
            <li>
              <strong>Condensate drainage:</strong> Falls to drain points, trace heating if exposed
            </li>
            <li>
              <strong>Controls integration:</strong> BMS connectivity, scheduling, energy monitoring
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Inadequate brazing:</strong> Not purging with nitrogen causes internal
                oxidation
              </li>
              <li>
                <strong>Poor vacuum:</strong> Moisture contamination leads to compressor failure
              </li>
              <li>
                <strong>Wrong refrigerant charge:</strong> Under or overcharge reduces efficiency
                and life
              </li>
              <li>
                <strong>Incorrect addressing:</strong> Indoor units not responding to controls
              </li>
              <li>
                <strong>Missing isolation:</strong> No local isolator for outdoor unit maintenance
              </li>
            </ul>
          }
