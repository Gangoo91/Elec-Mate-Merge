      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Systematic Preparation for Final Fixing</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Pre-Installation Verification and Planning</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>First-fix completion check:</strong> Verify all preparatory work is complete and satisfactory.</p>
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Work area preparation:</strong> Create optimal conditions for quality installation.</p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Accessory verification:</strong> Confirm all components meet specification requirements.</p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Professional Termination Standards and Verification</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Conductor Preparation and Inspection</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Stripping length verification:</strong> Ensure optimal conductor exposure for secure termination.</p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Conductor integrity assessment:</strong> Check for damage that could compromise connection.</p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Terminal tightening procedures:</strong> Apply manufacturer torque specifications precisely.</p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Professional Alignment and Securing Techniques</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Precision Alignment Methods</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Spirit level application:</strong> Ensure professional appearance with accurate alignment.</p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Screw tightening technique:</strong> Secure without damage or distortion.</p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Box type considerations:</strong> Adapt technique to mounting box material and design.</p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Regulatory Compliance and Standards Application</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>BS 7671 connection requirements:</strong> Electrical safety and reliability standards.</p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Building Regulations Part M:</strong> Accessibility requirements for public and domestic buildings.</p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Site-specific requirements:</strong> Additional standards and client specifications.</p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Professional Installation Techniques and Quality Control</h3>
            <div className="space-y-4">
              <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
                <p className="font-medium text-foreground mb-2">Handling and Protection Methods</p>
              ...
              <div className="rounded-lg p-4 bg-card border border-green-400/30">
                <p className="font-medium text-foreground mb-2">Surface Preparation and Correction Techniques</p>
                <ul className="text-xs text-foreground space-y-1 list-disc pl-4">
              ...
              <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
                <p className="font-medium text-foreground mb-2">Quality Assurance and Verification Procedures</p>
                <ul className="text-xs text-foreground space-y-1 list-disc pl-4">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Systematic Installation Procedures</h3>
            
            <div className="space-y-4">
              <div className="rounded-lg p-4 bg-card border border-amber-400/30">
                <p className="font-medium text-foreground mb-2">Standard Socket Outlet Installation</p>
              ...
              <div className="rounded-lg p-4 bg-card border border-cyan-400/30">
                <p className="font-medium text-foreground mb-2">Light Switch Installation Procedure</p>
                <ol className="text-xs text-foreground space-y-1 list-decimal pl-4">
              ...
              <div className="rounded-lg p-4 bg-indigo-500/10 border border-indigo-400/30">
                <p className="font-medium text-foreground mb-2">Light Fitting Final Fix Process</p>
                <ol className="text-xs text-foreground space-y-1 list-decimal pl-4">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Common Issues and Professional Solutions</h3>
            <div className="space-y-3">
              <div className="rounded-lg p-3 bg-card border border-border/30">
                <p className="font-medium text-foreground text-sm mb-1">Problem: Accessory not sitting flush with wall surface</p>
                <p className="text-xs text-foreground mb-2"><strong>Causes:</strong> Uneven wall surface, incorrect box depth, debris in mounting box</p>
                <p className="text-xs text-foreground"><strong>Solutions:</strong> Use appropriate spacers or shims, install box extenders if needed, clean box thoroughly, check wall for high spots</p>
              </div>
              
              <div className="rounded-lg p-3 bg-card border border-border/30">
                <p className="font-medium text-foreground text-sm mb-1">Problem: Terminals loosening after installation</p>
                <p className="text-xs text-foreground mb-2"><strong>Causes:</strong> Insufficient initial tightening, movement during fixing, conductor spring-back</p>
                <p className="text-xs text-foreground"><strong>Solutions:</strong> Use specified torque values, check tightness after positioning, consider ferrules for stranded conductors</p>
              </div>
              
              <div className="rounded-lg p-3 bg-card border border-border/30">
                <p className="font-medium text-foreground text-sm mb-1">Problem: Cracked or damaged faceplate during installation</p>
                <p className="text-xs text-foreground mb-2"><strong>Causes:</strong> Over-tightening screws, using wrong screwdriver size, forcing misaligned accessories</p>
                <p className="text-xs text-foreground"><strong>Solutions:</strong> Use appropriate torque, ensure correct tool sizes, align properly before tightening, replace damaged components</p>
              </div>
            </div>
          </section>
        </Card>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-4">
            <div>
              <h4 className="font-medium text-foreground mb-2">Q: Can I reuse screws from old accessories?</h4>
              <p className="text-sm text-muted-foreground">A: Only if they are undamaged, the correct length and thread type, and meet manufacturer specifications. New accessories should generally use new fixings for optimal performance.</p>
            </div>
            <Separator />
            <div>
              <h4 className="font-medium text-foreground mb-2">Q: What should I do if the mounting box is not flush with the wall?</h4>
              <p className="text-sm text-muted-foreground">A: Use box extenders to bring the mounting point flush with the finished surface, or use spacers behind the accessory. Never force accessories to fit uneven surfaces.</p>
            </div>
            <Separator />
            <div>
              <h4 className="font-medium text-foreground mb-2">Q: Is it acceptable to leave bare copper exposed at the terminal?</h4>
              <p className="text-sm text-muted-foreground">A: No — only the correct stripped length should be inside the terminal block. Any exposed copper outside terminals creates a safety risk and fails inspection.</p>
            </div>
            <Separator />
            <div>
              <h4 className="font-medium text-foreground mb-2">Q: How do I maintain consistent spacing between grouped accessories?</h4>
              <p className="text-sm text-muted-foreground">A: Use a template or measuring stick to ensure consistent centres, and check alignment with a string line or laser level across multiple accessories.</p>
            </div>
          </div>
        </Card>
