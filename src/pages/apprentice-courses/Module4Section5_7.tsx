...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'To speed up the installation and reduce labour time on site',
      'To allow thinner conductors to be used in the same terminal',
      'To avoid the need for any continuity testing afterwards',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Estimate the alignment visually by eye',
      'Use a spirit level',
      'Measure the diagonal with a tape measure',
      'Match it to the skirting board line',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Press firmly with the thumbs to seat the plate',
      'Fit them as quickly as possible to save time',
      'Wear clean gloves to protect the finish',
      'Use a power screwdriver for a flush fit',
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'To secure and align electrical accessories in their final positions',
      'To test the insulation resistance of the completed circuit',
      'To pull the cables through the conduit and trunking',
      'To calculate the cable sizes needed for each circuit',
    ],
    correctAnswer: 0,
    explanation:
  ...
  {
    id: 2,
    question: 'Over-tightening fixing screws on an accessory is most likely to cause which problem?',
    options: [
      'It improves the earth continuity of the accessory',
      'It cracks faceplates and strips the mounting threads',
      'It increases the current rating of the terminals',
      'It has no effect provided the cable is correctly rated',
    ],
    correctAnswer: 1,
    explanation:
      'Over-tightening can crack faceplates, strip threads, distort mounting boxes, and damage internal components.',
  },
  {
    id: 3,
    question: 'Why should gloves be worn when handling decorative faceplates?',
    options: [
      'To provide protection against electric shock from the plate',
      'To improve grip when driving the fixing screws',
      'To avoid leaving fingerprints and scratches on the finish',
      'To reduce static discharge into the wiring accessory',
    ],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 5,
    question: 'Which standard sets the recommended mounting heights for accessible installations in dwellings?',
    options: [
    ...
    correctAnswer: 0,
    explanation:
      'Building Regulations Approved Document M specifies accessibility requirements including mounting heights for switches and sockets.',
  },
  {
    id: 6,
    question: 'What should you check on all earth connections before final fixing?',
    options: [
      'That they carry the same current as the line conductor',
      'That the sleeving is coloured brown for identification',
      'That they are continuous, tight, and mechanically secure',
      'That they are connected through the neutral terminal',
    ],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 7,
    question: 'Name one method of correcting an uneven mounting surface when fixing an accessory.',
    options: [
      'Force the accessory flat against the wall',
      'Fit longer screws to bridge the gap',
      'Leave a visible gap behind the faceplate',
      'Use spacers or shims to pack out the box',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Handling during fixing can loosen the terminal screws',
      'Terminals always loosen overnight after installation',
      'It confirms the cable has the correct current rating',
      'It is needed to set the RCD test current correctly',
    ],
    correctAnswer: 0,
    explanation:
