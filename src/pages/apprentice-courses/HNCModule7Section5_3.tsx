    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="Harmonic Sources in Buildings">
          ...
          <p>
            <strong>Common harmonic sources in modern buildings:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Variable speed drives (VSDs):</strong> Six-pulse rectifiers produce 5th, 7th,
              11th, 13th harmonics
            </li>
            <li>
              <strong>LED lighting:</strong> Switch-mode drivers generate predominantly 3rd harmonic
              current
            </li>
            <li>
              <strong>IT equipment:</strong> Computers, servers with switch-mode PSUs produce 3rd
              and 5th harmonics
            </li>
            <li>
          ...
          <p>
            <strong>Harmonic Orders and Characteristics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>3rd (triplen):</strong> 150 — Zero sequence — Single-phase loads (LEDs, PCs)
            </li>
            <li>
              <strong>5th:</strong> 250 — Negative sequence — VSDs, rectifiers
            </li>
            <li>
              <strong>7th:</strong> 350 — Positive sequence — VSDs, rectifiers
            </li>
            <li>
              <strong>9th (triplen):</strong> 450 — Zero sequence — Single-phase loads
            </li>
            <li>
              <strong>11th, 13th:</strong> 550, 650 — Neg/Pos sequence — VSDs, 6-pulse rectifiers
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Effects of Harmonics on Electrical Systems">
          ...
          <p>
            <strong>Operational Effects</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Critical: Neutral Conductor Overheating</strong>
          </p>
          <p>
            In three-phase systems, triplen harmonics (3rd, 9th, 15th) are zero-sequence currents
            that add arithmetically in the neutral rather than cancelling. With significant
            single-phase non-linear loads, neutral current can exceed 170% of phase current.
            Standard neutral sizing (equal to phase) becomes dangerously inadequate.
          </p>
          <p>
            <strong>Equipment-Specific Effects</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Transformers:</strong> Increased eddy current and hysteresis losses — Derating
              required or premature failure
            </li>
            <li>
              <strong>Cables:</strong> Skin effect increases AC resistance — Additional voltage drop
              and heating
            </li>
            <li>
              <strong>Circuit breakers:</strong> RMS current higher than expected — Nuisance
              tripping, inadequate protection
            </li>
            <li>
              <strong>Motors:</strong> Negative sequence creates counter-torque — Reduced
              efficiency, overheating, vibration
            </li>
            <li>
              <strong>Capacitors:</strong> Harmonic current amplification — Overheating, resonance,
              catastrophic failure
            </li>
          </ul>
          <p>
            <strong>Diagnostic indicator:</strong> If transformers or panels are running hot with
            loads below rated capacity, or breakers trip without apparent overload, suspect harmonic
            distortion.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="THD Measurement and G5/5 Limits">
          ...
          <p>
            <strong>G5/5 Planning Levels at 400V (LV)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>5th:</strong> 6% — - — -
            ...
            <li>
              <strong>9th:</strong> - — 1.5% — -
            </li>
            <li>
              <strong>11th, 13th:</strong> 3.5% — - — -
            </li>
            <li>
              <strong>THD (total):</strong> 8%
            </li>
          </ul>
          <p>
            <strong>Power quality measurement requirements:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Parameters:</strong> THD voltage, individual harmonic magnitudes, THD current
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Passive and Active Filter Solutions">
          ...
          <p>
            <strong>Mitigation Techniques Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>12-pulse VSD:</strong> Large motor drives (&gt;100 kW) — Eliminates 5th, 7th
              harmonics
            </li>
            <li>
              <strong>18-pulse VSD:</strong> Critical applications — THD &lt;5% achievable
            </li>
            <li>
              <strong>DC choke:</strong> VSD input stage — 20-30% harmonic reduction
            </li>
            <li>
              <strong>AC line reactor:</strong> VSD input, general loads — 35-45% harmonic reduction
            </li>
            <li>
              <strong>Passive tuned filter:</strong> Specific harmonic orders — 80-90% of targeted
              harmonic
            </li>
            <li>
              <strong>Active filter (AHF):</strong> Centralised or distributed — THD &lt;5% across
              spectrum
            </li>
            <li>
              <strong>K-rated transformer:</strong> Non-linear load substations — Handles harmonic
              heating
            </li>
          </ul>
          <p>
            <strong>K-Factor Transformer Ratings</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Detuned filter design considerations:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Tuning frequency:</strong> 189 Hz (7%) or 134 Hz (14%) to avoid 3rd harmonic
              resonance
            </li>
            <li>
            ...
            <li>
              <strong>Location:</strong> Install close to non-linear loads for maximum effectiveness
            </li>
          </ul>
          <p>
            <strong>Design strategy:</strong> For new installations, specify low-harmonic equipment
            at source. For existing installations, centralised active filtering often provides the
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Size neutral conductor for LED lighting circuit with high 3rd
            harmonic content.
          </p>
          <p>Given:</p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Using standard transformers for IT loads</strong> - causes overheating even
                at partial load
              </li>
              <li>
