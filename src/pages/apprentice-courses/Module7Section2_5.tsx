  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Incorrect polarity occurs when line and neutral are swapped, or when protective/switching devices are connected in the wrong conductor.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'A common polarity fault is wiring a light switch into the neutral conductor rather than the line conductor, leaving the lamp holder live when switched off.',
    },
    {
      id: 3,
      ...
      correctAnswer: 1,
      explanation:
        'Polarity faults are typically caused by misidentification of conductors and careless or rushed wiring during installation.',
    },
    {
      id: 4,
      ...
      correctAnswer: 2,
      explanation:
        'With incorrect polarity, equipment may still function but can remain electrically live when switched off, creating serious shock hazards.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'BS 7671 (IET Wiring Regulations) requires correct polarity for all electrical installations.',
    },
    {
      id: 6,
      question:
        'True or False: A polarity fault may leave lamp holders live even when switched off.',
      options: ['True', 'False'],
      correctAnswer: 0,
      explanation:
        'True. If a switch is wired in the neutral instead of the line, the lamp holder remains live even when the switch is off.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'Polarity is checked using continuity tests and functional tests to confirm correct line, neutral, and earth connections.',
    },
    {
      id: 8,
      ...
      correctAnswer: 2,
      explanation:
        'Polarity faults must be corrected immediately by re-terminating conductors correctly, followed by retesting before the circuit is energised.',
    },
    {
      id: 9,
      ...
      correctAnswer: 2,
      explanation:
        'The qualified electrician carrying out the installation work is responsible for ensuring correct polarity before energising any circuit.',
    },
    {
      id: 10,
      ...
      correctAnswer: 1,
      explanation:
        'The switch was incorrectly wired into the neutral conductor, leaving the lamp holder live even when switched off, causing a shock when changing the bulb.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="text-center mb-12">
            <div className="inline-flex items-center gap-2 text-elec-yellow text-sm mb-3">
              ...
              <span className="text-white">Section 2.5</span>
            </div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
              Incorrect Polarity
            </h1>
            <p className="text-white text-base sm:text-lg max-w-2xl mx-auto">
              Understanding polarity faults, risks, testing and correction in electrical
              installations
            </p>
          </header>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Polarity refers to the correct connection of line, neutral, and earth conductors in
                a circuit. Incorrect polarity occurs when line and neutral are swapped, or when a
                protective or switching device is connected in the wrong conductor. A common example
                is a light switch wired into the neutral conductor instead of the line.
              </p>
              ...
              <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/30 mb-4">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • Single-pole switches and protective devices must be in the line conductor
                  </li>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30">
                ...
                <p className="text-sm">
                  With incorrect polarity, equipment may function normally but remain live when
                  switched off, creating unexpected shock hazards during maintenance or bulb
                  changes.
                </p>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Polarity faults are usually the result of human error during installation.
                Understanding these causes helps prevent future occurrences:
              </p>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30">
                ...
                <p className="text-sm">
                  Always use a systematic approach: identify conductors correctly, follow wiring
                  diagrams, apply proper labelling, and conduct thorough testing before energising.
                </p>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Incorrect polarity is especially dangerous because the installation may still appear
                to work. However, the risks include:
              </p>

              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Electric shock risk:</strong> A switched-off appliance may still have live
                  components
                </li>
                <li>
                  <strong>Inoperative protective devices:</strong> Fuses and breakers may not
                  disconnect the circuit correctly
                </li>
                <li>
                  <strong>Legal and compliance issues:</strong> BS 7671 requires correct polarity
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Polarity is checked during initial verification and periodic inspection using
                continuity and functional tests. Multiple testing methods ensure comprehensive
                verification:
              </p>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30">
                ...
                <p className="text-sm">
                  Never energise a circuit with suspected polarity faults. All corrections must be
                  verified through retesting before the installation can be considered safe for use.
                </p>
              </div>
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-white mb-4">
              Real-World Case Study: The Hidden Danger
            </h2>
              ...
              <div className="space-y-4">
                <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/30">
                  ...
                  <p className="text-xs text-white">
                    During a domestic lighting installation, an apprentice electrician incorrectly
                    wired a bedroom light switch into the neutral conductor instead of the line. The
                    installation was completed and commissioned without proper polarity testing.
                  </p>
                </div>
                ...
                <div className="p-3 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2 text-xs text-white">
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <h3 className="font-medium text-white mb-2">
                  Q: Can a circuit still work with incorrect polarity?
                </h3>
                <p className="text-sm text-white">
                  A: Yes, but it will be unsafe, as equipment may remain live when switched off.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <h3 className="font-medium text-white mb-2">
                  Q: How is polarity checked during testing?
                </h3>
                <p className="text-sm text-white">
                  A: By continuity and functional tests to confirm correct line, neutral, and earth
                  connections.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <h3 className="font-medium text-white mb-2">
                  Q: Why must polarity faults always be corrected before energising?
                </h3>
                <p className="text-sm text-white">
                  A: Because they create immediate shock hazards and make protective devices
                  unreliable.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-gradient-to-r from-elec-yellow/10 to-indigo-500/10 border border-white/10">
              ...
              <div className="grid gap-4 sm:grid-cols-2 text-sm">
                <div className="p-3 rounded-lg bg-blue-500/10 border border-blue-500/30">
                  ...
                  <p className="text-xs text-white">
                    Line and neutral conductors swapped, or switches/protective devices connected in
                    wrong conductor, creating hidden shock hazards.
                  </p>
                </div>
                ...
                <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/30">
                  ...
                  <p className="text-xs text-white">
                    Equipment functions normally but remains live when switched off, creating
                    unexpected shock risks during maintenance.
                  </p>
                </div>
                ...
                <div className="p-3 rounded-lg bg-orange-500/10 border border-orange-500/30">
                  ...
                  <p className="text-xs text-white">
                    Poor workmanship, misidentification of conductors, rushed installations, and
                ...
                <div className="p-3 rounded-lg bg-green-500/10 border border-green-500/30">
                  ...
                  <p className="text-xs text-white">
                    Systematic conductor identification, proper testing procedures, and thorough
                    verification before energising.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-4 p-3 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30">
                ...
                <p className="text-xs text-white">
                  Incorrect polarity is a "silent killer" - installations appear to work correctly
                  but create life-threatening shock hazards. BS 7671 compliance demands correct
                  polarity, and thorough testing is the only way to ensure safety. Never compromise
                  on polarity verification - lives depend on it.
                </p>
              </div>
            </div>
          </section>
