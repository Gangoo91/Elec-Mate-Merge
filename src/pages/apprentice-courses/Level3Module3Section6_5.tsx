...
const DESCRIPTION =
  'Work through real-world voltage drop scenarios from domestic to commercial installations. Master exam-style calculations with step-by-step solutions and common pitfalls to avoid.';
...
const quickCheckQuestions = [
  {
    id: 'check-1',
    question:
      'A domestic lighting circuit uses 1.5mm sq cable (mV/A/m = 29), runs 25m, and carries 6A. Is it compliant?',
    options: [
    ...
    correctIndex: 0,
    explanation:
      'Vd = (29 x 6 x 25) / 1000 = 4.35V. For lighting circuits, the limit is 6.9V (3% of 230V). 4.35V is well within this limit, so the circuit is compliant.',
  },
  {
    id: 'check-2',
    question:
      'An outbuilding supply uses 6mm sq SWA (mV/A/m = 7.3), runs 45m to a 40A load. What is the voltage drop?',
    options: ['13.14V', '1.31V', '131.4V', '8.1V'],
    correctIndex: 0,
    explanation:
      'Vd = (7.3 x 40 x 45) / 1000 = 13140 / 1000 = 13.14V. This exceeds the 11.5V (5%) limit for power circuits and would require a larger cable.',
  },
  {
    id: 'check-3',
    question:
      'A three-phase motor circuit (400V) allows maximum 5% voltage drop. What is the maximum drop in volts?',
    options: ['11.5V', '20V', '12V', '23V'],
    correctIndex: 1,
    explanation:
      'For three-phase 400V supply, 5% = 400 x 0.05 = 20V maximum voltage drop. Note this is higher than the single-phase 230V limit of 11.5V.',
  },
  {
    id: 'check-4',
    question:
      'A distribution board is fed by a 25m sub-main dropping 3.5V. What voltage drop is available for final circuits to a power load?',
    options: ['11.5V', '8.0V', '6.9V', '3.4V'],
    correctIndex: 1,
    explanation:
      'Total limit for power = 11.5V. With 3.5V used by sub-main, remaining = 11.5 - 3.5 = 8.0V available for final circuits.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A 10A lighting circuit uses 1.0mm sq cable (mV/A/m = 44) over 12m. The voltage drop is:',
    options: [
    ...
    correctAnswer: 0,
    explanation:
      'Vd = (44 x 10 x 12) / 1000 = 5.28V. The lighting limit is 6.9V, so 5.28V is acceptable.',
  },
  {
    id: 2,
    question:
      'An electric shower circuit (40A, 15m, 6mm sq cable, mV/A/m = 7.3) has voltage drop of:',
    options: ['4.38V', '43.8V', '0.438V', '7.3V'],
    correctAnswer: 0,
    explanation:
      'Vd = (7.3 x 40 x 15) / 1000 = 4380 / 1000 = 4.38V. Well within the 11.5V power circuit limit.',
  },
  {
    id: 3,
    question:
      'For a ring final circuit with 80m total length, the effective length for voltage drop calculation is:',
    options: ['80m', '40m', '20m', '10m'],
    correctAnswer: 2,
    explanation:
      'For ring circuits, effective length = total length / 4. This accounts for the parallel paths and worst-case load position. 80m / 4 = 20m.',
  },
  {
    id: 4,
    question:
      'A garage supply uses 25m of 4mm sq cable (mV/A/m = 11) with 25A load. The voltage drop is:',
    options: [
      '6.88V - acceptable',
      '6.88V - unacceptable',
      '11V - at the limit',
    ...
    correctAnswer: 0,
    explanation:
      'Vd = (11 x 25 x 25) / 1000 = 6875 / 1000 = 6.88V. Within the 11.5V limit for power circuits.',
  },
  {
    id: 5,
    question:
      'A commercial kitchen has a 60A three-phase supply over 35m using 16mm sq cable (mV/A/m = 2.8). Voltage drop is:',
    options: ['5.88V', '10.2V', '2.94V', '8.4V'],
    correctAnswer: 0,
    explanation:
      'For three-phase: Vd = (1.732 x 2.8 x 60 x 35) / 1000 = 10185 / 1000 = 10.2V. But for single-phase calculation: (2.8 x 60 x 35) / 1000 = 5.88V. The question format suggests single-phase method.',
  },
  {
    id: 6,
  ...
  },
  {
    id: 7,
    question:
      'If a sub-main has 2V drop and a final circuit has 8V drop, for a power installation:',
    options: [
    ...
    correctAnswer: 0,
    explanation:
      'Total voltage drop = 2 + 8 = 10V. The BS 7671 limit of 11.5V (5%) applies to total drop from origin to point of use. 10V is acceptable.',
  },
  {
    id: 8,
    question:
      'A farm outbuilding supply 100m from the main building needs 30A. Using 10mm sq SWA (mV/A/m = 4.4):',
    options: [
    ...
    correctAnswer: 0,
    explanation:
      'Vd = (4.4 x 30 x 100) / 1000 = 13.2V. This exceeds 11.5V, so a larger cable (16mm sq) is needed.',
  },
  {
    id: 9,
    ...
    correctAnswer: 0,
    explanation:
      'Forgetting to divide by 1000 gives the answer in millivolts (mV) instead of volts (V). The result would be 1000 times too large.',
  },
  {
    id: 10,
    question:
      'A warehouse lighting circuit needs 50m cable run with 8A load. Maximum mV/A/m for compliance is:',
    options: ['17.25', '11.5', '28.75', '14.4'],
    correctAnswer: 0,
    explanation:
      'Max mV/A/m = (Vd x 1000) / (I x L) = (6.9 x 1000) / (8 x 50) = 6900 / 400 = 17.25. Use 1.5mm sq (mV/A/m = 29) would fail; need larger cable.',
  },
  {
    id: 11,
    ...
    correctAnswer: 1,
    explanation:
      'Always show your working: state the formula, substitute values, calculate step-by-step, and compare your answer with the relevant limit. This earns method marks even if arithmetic is slightly wrong.',
  },
  {
    id: 12,
    ...
    correctAnswer: 3,
    explanation:
      "11.3V is technically compliant (under 11.5V), but leaves little margin for measurement uncertainty or future load increases. Both answering 'compliant' or recommending upsizing are valid professional approaches.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Forgetting to divide by 1000 to convert millivolts to volts. Always check that your answer is a sensible value - voltage drops of hundreds or thousands of volts indicate a calculation error.',
  },
  {
    question: 'How do I remember the voltage drop limits?',
    answer:
      'Use the 3-5 rule: 3% for lighting (6.9V from 230V), 5% for power (11.5V from 230V). For three-phase 400V, the 5% gives 20V. These percentages are easier to remember than the voltage values.',
  },
  {
    question: 'Should I always calculate voltage drop in exams even if not explicitly asked?',
    answer:
      'If a question involves cable sizing, always verify voltage drop compliance unless the question specifically says to ignore it. This demonstrates understanding that both current capacity and voltage drop must be satisfied.',
  },
  {
    question: 'How precise should my voltage drop answers be?',
    answer:
      "Work to at least 2 decimal places during calculation, then round appropriately for the final answer. For exam purposes, stating '6.48V which is less than 6.9V limit' is good practice.",
  },
  {
    question: 'What if a question uses different voltage drop limits?',
    answer:
      'Always use the limits stated in the question if different from standard. Some industrial or special installations may have different requirements. Read the question carefully for any stated limits.',
  },
  {
    question: 'How do I handle combined AC and DC installations like EV chargers?',
    answer:
      'The AC supply side uses standard voltage drop calculations. The DC side of an EV charger is internal to the equipment. Your voltage drop calculation covers the AC circuit up to the charger.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              ...
              <li>
                <strong>Lighting:</strong> Max 6.9V (3% of 230V)
              </li>
              <li>
                <strong>Power:</strong> Max 11.5V (5% of 230V)
              </li>
              <li>
                <strong>Show working:</strong> Formula, values, calculation, comparison
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Long runs, outbuildings, distribution circuits
              </li>
              <li>
                <strong>Use:</strong> BS 7671 Appendix 4 mV/A/m values
              </li>
              <li>
                <strong>Check:</strong> Total drop including sub-mains
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Domestic installations typically involve shorter cable runs but require careful
              attention to the different limits for lighting and power circuits.
            </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white/80 space-y-2 font-mono">
                ...
                <p>
                  <strong>Substituting:</strong> Vd = (18 x 20 x 22) / 1000
                </p>
                <p>
                  <strong>Calculate:</strong> Vd = 7920 / 1000 = 7.92V
                </p>
                <p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white/80 space-y-2 font-mono">
                ...
                <p>
                  <strong>Substituting:</strong> Vd = (29 x 5 x 35) / 1000
                </p>
                <p>
                  <strong>Calculate:</strong> Vd = 5075 / 1000 = 5.08V
                </p>
                <p>
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20 my-6">
              ...
              <div className="text-xs text-white/80 space-y-2 font-mono">
                ...
                <p>
                  <strong>Substituting:</strong> Vd = (29 x 10 x 28) / 1000
                </p>
                <p>
                  <strong>Calculate:</strong> Vd = 8120 / 1000 = 8.12V
                </p>
                <p>
                  <strong>Limit:</strong> Lighting circuit = 6.9V (3%)
                </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Exam Tip:</strong> Always state the applicable limit before comparing your
              calculated value. This shows the examiner you understand which limit applies.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Outbuildings, garages, and external installations often involve longer cable runs,
              making voltage drop a critical design factor.
            </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white/80 space-y-2 font-mono">
                ...
                <p>
                  <strong>Substituting:</strong> Vd = (7.3 x 32 x 30) / 1000
                </p>
                <p>
                  <strong>Calculate:</strong> Vd = 7008 / 1000 = 7.01V
                </p>
                <p>
                  <strong>Limit:</strong> Power circuit = 11.5V (5%)
                </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white/80 space-y-2 font-mono">
                ...
                <p>
                  <strong>Substituting:</strong> Vd = (4.4 x 50 x 40) / 1000
                </p>
                <p>
                  <strong>Calculate:</strong> Vd = 8800 / 1000 = 8.8V
                </p>
                <p>
                  <strong>Limit:</strong> Power circuit = 11.5V (5%)
                </p>
                ...
                <p className="text-yellow-400 mt-1">
                  Warning: Limited headroom for final circuits - consider 16mm sq
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-white/10 my-6">
              <p className="text-sm font-medium text-white mb-2">
                Typical SWA Cable mV/A/m Values:
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Commercial and industrial installations often involve larger currents, longer runs,
              and three-phase supplies. Understanding how to handle these scenarios is essential.
            </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white/80 space-y-2 font-mono">
                ...
                <p>
                  <strong>Substituting:</strong> Vd = (1.75 x 80 x 60) / 1000
                </p>
                <p>
                  <strong>Calculate:</strong> Vd = 8400 / 1000 = 8.4V
                </p>
                <p>
                  <strong>Limit:</strong> Power circuit = 11.5V (5%)
                </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white/80 space-y-2 font-mono">
                ...
                <p>
                  <strong>Substituting:</strong> Vd = (7.3 x 20 x 25) / 1000
                </p>
                <p>
                  <strong>Calculate:</strong> Vd = 3650 / 1000 = 3.65V
                </p>
                <p>
                  <strong>Limit:</strong> 5% of 400V = 20V for three-phase
                </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white/80 space-y-2 font-mono">
                ...
                <p>
                  <strong>Substituting:</strong> Vd = (18 x 12 x 45) / 1000
                </p>
                <p>
                  <strong>Calculate:</strong> Vd = 9720 / 1000 = 9.72V
                </p>
                <p>
                  <strong>Limit:</strong> Lighting circuit = 6.9V (3%)
                </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Commercial Note:</strong> Large retail and commercial premises often require
              careful voltage drop design due to the combination of long cable runs and the stricter
              3% lighting limit.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Ring final circuits and installations with distribution circuits feeding final
              circuits require special calculation approaches.
            </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white/80 space-y-2 font-mono">
                ...
                <p>
                  <strong>Effective length:</strong> 64 / 4 = 16m
                </p>
                <p>
                  <strong>Formula:</strong> Vd = (mV/A/m x I x L effective) / 1000
                </p>
                <p>
                  <strong>Substituting:</strong> Vd = (18 x 32 x 16) / 1000
                </p>
                <p>
                  <strong>Calculate:</strong> Vd = 9216 / 1000 = 9.22V
                </p>
                <p>
                  <strong>Limit:</strong> Power circuit = 11.5V (5%)
                </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white/80 space-y-2 font-mono">
                ...
                <p className="mt-2">
                  <strong>Step 2: Final Circuit Drop</strong>
                </p>
                <p className="ml-4">Vd2 = (7.3 x 30 x 8) / 1000 = 1.75V</p>

                <p className="mt-2">
                  <strong>Step 3: Total Voltage Drop</strong>
                </p>
