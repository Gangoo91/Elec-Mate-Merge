...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Zs = Ze + (R1+R2) = 0.35 + 0.25 = 0.6 ohms. The maximum Zs for a 63A Type B MCB at 0.4s is 0.73 ohms (from BS 7671 Table 41.3). Since 0.6 < 0.73 ohms, automatic disconnection is achieved.',
  },
  {
    id: 5,
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Separate earth conductor from transformer
                      </td>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                <li className="pl-1">
                  Low impedance fault path - high fault currents for rapid disconnection
                </li>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                <li className="pl-1">
                  Very low Ze (typically 0.35 ohms) - excellent fault clearance
                </li>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                <li className="pl-1">
                  High Ze (21+ ohms) - depends on soil resistivity and electrode type
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  30mA RCDs required for socket outlets and portable equipment
                </li>
                <li className="pl-1">
                  Earth electrode resistance (Ra) must be verified: Ra x I delta n less than or
                  equal to 50V
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white/90">
                ...
                earthed metalwork within the installation.
              </p>
            </div>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                PME Protective Measures
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Main protective bonding:</strong> All extraneous-conductive-parts bonded
                  to MET
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Minimum bonding sizes:</strong> 10mm squared Cu minimum for gas, water,
                  oil services
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Maximum Zs Values (Type B MCB, 0.4s Disconnection)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Upstream device rated higher than downstream
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Minimum 2:1 ratio (check selectivity tables)
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        MCCBs with adjustable trip times
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Upstream device has higher let-through energy
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Communication between devices to identify fault zone
                      </td>
                      <td className="border border-white/10 px-3 py-2">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white/90 mb-3">
                ...
                squared t) of the upstream device must not exceed the withstand capability of
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Resistive loads only (limited use)
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Single-phase rectified loads
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Type F</td>
                      <td className="border border-white/10 px-3 py-2">
                        AC, pulsating DC, composite waveforms
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Single-phase VSDs, inverters
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Three-phase VSDs, EV chargers, PV inverters
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Upstream discrimination with Type A/B
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Adjustable thermal and magnetic
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                MCCB Trip Unit Settings
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Ir (thermal):</strong> Adjustable long-time pickup (typically 0.4-1.0 x
                  In)
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Selectivity tables:</strong> Manufacturer data for confirmed
                  discrimination
                </li>
                <li className="pl-1">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Use MCCBs with adjustable magnetic trip
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Similar device types</td>
                      <td className="border border-white/10 px-3 py-2">
                        Similar characteristics reduce selectivity
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Reduces fault current at remote points
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        May improve discrimination for remote faults
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Motor starting</td>
                      <td className="border border-white/10 px-3 py-2">
                        High inrush may cause nuisance tripping
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Type C/D MCBs, time-delayed MCCBs
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                    <tr className="bg-white/5">
                      <th className="border border-white/10 px-3 py-2 text-left">
                        Line Conductor (mm squared)
                      </th>
                      <th className="border border-white/10 px-3 py-2 text-left">
                        Min Earthing Conductor (Cu)
                      </th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Line up to 16mm squared:</strong> CPC = line size (minimum 1.5mm squared)
                </li>
                <li className="pl-1">
                  <strong>Line 16-35mm squared:</strong> CPC = 16mm squared
                </li>
                <li className="pl-1">
                  <strong>Line over 35mm squared:</strong> CPC = half line size
                </li>
                <li className="pl-1">
                  <strong>Adiabatic check:</strong> S = square root of (I squared t) / k for short
                  fault durations
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Accessibility:</strong> Earth connections must be accessible for
                  inspection
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2">
                  (R1+R2) = 30 x (4.61 + 12.1) / 1000 = 30 x 16.71 / 1000 = 0.50 ohms
                </p>
                <p className="mt-2">
                ...
                <p className="mt-2 text-green-400">
                  0.85 ohms &lt; 1.10 ohms - Disconnection achieved
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  I delta n less than or equal to 50 / Ra = 50 / 150 ={' '}
                  <strong>0.33A = 333mA</strong>
                </p>
                <p className="mt-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  For neutral up to 35mm squared, minimum bonding = <strong>10mm squared Cu</strong>
                </p>
                ...
                <p className="mt-2 text-green-400">
                  Use 10mm squared (higher of the two requirements)
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  If = (400 x 0.866) / Zs = 346 / 0.25 = <strong>1384A</strong>
                </p>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Ra x I delta n less than or equal to 50V</strong> - TT system RCD
                  selection
                </li>
                <li className="pl-1">
                  <strong>S = square root of (I squared t / k)</strong> - Adiabatic equation for
                  conductor sizing
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Forgetting 80% rule</strong> - Design Zs must not exceed 80% of tabulated
                  maximum
                </li>
                <li className="pl-1">
                  <strong>Wrong RCD type</strong> - Type B required for three-phase VSDs, not Type A
                </li>
                <li className="pl-1">
                  <strong>Insufficient bonding</strong> - All extraneous-conductive-parts must be
                  bonded
                </li>
                <li className="pl-1">
                  <strong>Ignoring selectivity</strong> - Check manufacturer discrimination tables
                </li>
                <li className="pl-1">
                  <strong>Breaking capacity</strong> - Device Icn/Icu must exceed prospective fault
                  current
                </li>
              </ul>
            </div>
