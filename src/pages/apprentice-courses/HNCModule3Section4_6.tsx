...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['0.8 ohms', '0.2 ohms', '0.35 ohms', '21 ohms'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS 7671 411.4.1 makes the integrity of the DNO-supplied earth a precondition for safe
              TN operation. As BSE designer you must ascertain (and record in the certificate) which
              earthing system is provided, measure Ze at the origin, and design every downstream
              circuit so that the calculated Zs &times; Ia &le; U&#x2080; / 0.8 (for TN under Reg
              411.4.5) within the disconnection times of Table 41.1.
            </>
          }
        ...
        <ConceptBlock title="Earthing Systems — TN-S, TN-C-S and TT">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Second letter:</strong> Installation earthing - T (local earth), N (connected
              to supply earth)
            </li>
            <li>
              <strong>Third letter:</strong> Neutral/earth arrangement - S (separate), C (combined)
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">UK Earthing Systems Comparison</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>TN-S:</strong> Separate earth conductor from transformer — typical Ze 0.8 ohms
              — older urban supplies, cable sheath earth
            </li>
            <li>
              <strong>TN-C-S:</strong> Combined PEN in supply, separate at origin — typical Ze 0.35
              ohms — most common UK supply (PME)
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Earth electrode resistance (Ra) must be verified: Ra x I delta n less than or equal to
              50V
            </li>
            <li>Used in rural areas, temporary installations, and where PME restrictions apply</li>
          </ul>
        ...
        <ConceptBlock title="Earth Fault Loop Impedance (Zs)">
          <p>
            ...
            disconnection time of protective devices. Calculating and verifying Zs is fundamental to
            ensuring safety in any installation.
          </p>
        ...
        <ConceptBlock title="Protective Device Coordination">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Current:</strong> Upstream device rated higher than downstream — minimum 2:1
              ratio (check selectivity tables)
            </li>
            <li>
            ...
            <li>
              <strong>Zone selective:</strong> Communication between devices to identify fault zone
          ...
          <p>
            ...
            fails or has insufficient breaking capacity. The let-through energy (I squared t) of the
            upstream device must not exceed the withstand capability of downstream equipment.
          </p>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="RCDs in Three-Phase Systems">
          <p>
            ...
            In three-phase systems, RCD selection must account for load types, particularly
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Type B:</strong> AC, pulsating DC, smooth DC — three-phase VSDs, EV chargers,
              PV inverters
            </li>
            <li>
              <strong>Type S:</strong> Time-delayed (40-500ms) — upstream discrimination with Type
              A/B
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
        ...
        <ConceptBlock title="MCCB vs MCB Selection">
          <p>
            ...
            (MCBs) depends on current rating, fault level, adjustability requirements, and position
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Trip adjustment:</strong> MCB fixed (Type B, C, D) — MCCB adjustable thermal
              and magnetic
            </li>
            <li>
              <strong>Physical size:</strong> MCB DIN rail modules — MCCB larger, dedicated mounting
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Im (magnetic):</strong> Adjustable instantaneous pickup (typically 2-10 x Ir)
            </li>
            <li>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Fault level check:</strong> Always verify the prospective fault current (Ipf) at
            the point of installation. The protective device breaking capacity (Icn/Icu) must exceed
            Ipf.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Discrimination and Selectivity">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Time-current curves:</strong> Plot device characteristics to verify no overlap
            </li>
            <li>
            ...
            <li>
              <strong>Software tools:</strong> Manufacturer selection software for complex systems
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>High fault currents:</strong> Both devices may trip simultaneously — use MCCBs
              with adjustable magnetic trip
            </li>
            <li>
            ...
            <li>
              <strong>Cable impedance:</strong> Reduces fault current at remote points — may improve
              discrimination for remote faults
            </li>
            <li>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            current that can occur. <strong>Partial selectivity:</strong> Discrimination only up to
            a stated fault level.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Services: MET and Protective Conductors">
          <p>
            ...
            electrical safety in any building. Proper design and installation ensures fault currents
            can flow safely and all exposed-conductive-parts remain at earth potential.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            accessible for periodic inspection and testing throughout the life of the installation.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A 32A Type B MCB protects a radial circuit. Ze = 0.35 ohms,
            circuit length 30m using 4mm²/1.5mm² cable. Verify automatic disconnection.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              installations. Ignoring selectivity between upstream and downstream devices. Choosing
              protective devices whose breaking capacity is below the prospective fault current.
            </>
          }
          doInstead={
            <>
              Design to 80% of tabulated max Zs. Use Type B RCDs on three-phase VSDs/EV chargers/PV.
              Bond every extraneous-conductive-part to the MET. Verify discrimination with
              manufacturer selectivity tables. Always confirm Icn/Icu exceeds prospective Ipf at the
              device location.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A car-park EV charging installation has 12&times;22 kW AC chargers fed from a TN-C-S
              (PME) supply. The cable run from the LV switchroom to the outdoor charging cabinet is
              75 m. As the BSE engineer you must assess BS 7671 722 (EV) compliance against the PME
              PEN-fault risk.
            </>
          }
          whatToDo={
            <>
              BS 7671 Reg 722.411.4.1 requires that on TN-C-S supplies feeding outdoor EV charging,
              you must either (a) provide an alternative earth (TT arrangement at the charger via a
              dedicated earth electrode + 30 mA RCD, with PEN broken at the local DB) or (b) use a
              charger that incorporates PEN open-circuit detection. Most modern OCPP chargers
              integrate (b), which is the cheaper and more reliable solution. Document the choice
              and verify with the DNO that PME extension to outdoor metalwork is compliant.
            </>
          }
          whyItMatters={
            <>
              A PEN fault on a TN-C-S supply leaves the entire bonded metalwork floating up to
              U&#x2080; — fatal if a person touches a charger and stands on independently-earthed
              ground (e.g. wet concrete). The 2026 update to BS 7671 made the PEN-fault risk
              assessment for outdoor EV charging explicit. The HNC engineer must engage with this on
              every new car-park installation, not delegate to the manufacturer.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Cable Sizing</div>
          </button>
          <button
