      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Vapour compression:</strong> Compress, condense, expand, evaporate
              </li>
              <li className="pl-1">
                <strong>Low-GWP shift:</strong> R410A (2088) to R32 (675) to R290 (3)
              </li>
              <li className="pl-1">
                <strong>F-Gas certification:</strong> Required for all HFC handling
              </li>
              <li className="pl-1">
                <strong>COP:</strong> Typically 2.5-4.0 for air-cooled systems
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>AC systems:</strong> Scroll compressors, R32 refrigerant dominant
              </li>
              <li className="pl-1">
                <strong>Heat pumps:</strong> Same cycle, heating COP 3-5 typical
              </li>
              <li className="pl-1">
                <strong>Chillers:</strong> Screw or centrifugal, water-cooled for efficiency
              </li>
              <li className="pl-1">
                <strong>Compliance:</strong> F-Gas records, leak checks, recovery
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The vapour compression cycle is the fundamental thermodynamic process used in
              virtually all air conditioning, heat pump and refrigeration systems. It exploits the
              latent heat of vaporisation to move thermal energy from a low-temperature source to a
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Evaporation (4&gt;1):</strong> Low-pressure liquid absorbs heat and
                  evaporates to low-pressure vapour
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs text-white/70 mt-3">
                <div>
                  ...
                  = Heat rejected at condenser (kW)
                </div>
                <div>
                  <strong>
                    Q<sub>evap</sub>
                  </strong>{' '}
                  = Heat absorbed at evaporator (kW)
                </div>
                <div>
                  <strong>
                    W<sub>comp</sub>
                ...
                <div>
                  <strong>COP</strong> = Q<sub>evap</sub> / W<sub>comp</sub> (cooling)
                </div>
              </div>
            </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Isentropic (constant entropy) - pressure and enthalpy increase
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Isobaric (constant pressure) - enthalpy decreases as heat is rejected
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Isenthalpic (constant enthalpy) - pressure drops, some flash gas forms
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Isobaric (constant pressure) - enthalpy increases as heat is absorbed
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Condensing temperature:</strong> Typically 10-15K above ambient
                  (air-cooled)
                </li>
                <li className="pl-1">
                  <strong>Superheat:</strong> 5-10K above evaporating temperature at compressor
                  inlet
                </li>
                <li className="pl-1">
                  <strong>Subcooling:</strong> 5-10K below condensing temperature at expansion
                  device inlet
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Common Refrigerants Comparison
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Simple, repairable, wide pressure ratio
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Quiet, efficient, reliable, few parts
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Split AC, heat pumps, light commercial
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Compact, quiet, low vibration
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Domestic AC, small splits
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        High capacity, variable speed capable
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Large commercial, industrial chillers
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Fixed restriction (length/diameter)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Small domestic, simple systems
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Residential heat pumps (piston type)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">TXV/TEV</td>
                      <td className="border border-white/10 px-3 py-2">
                        Thermostatic - maintains superheat
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Electronic - stepper motor/PWM
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        VRF systems, precision control
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-2 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Certification:</strong> All personnel handling F-gases must hold
                  appropriate F-Gas certificates
                </li>
                <li className="pl-1">
                  <strong>Leak checking:</strong> Mandatory for systems above 5 tonnes CO2e
                  (frequency depends on charge)
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Leak Check Frequency (Based on CO2 Equivalent)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        All activities including leak checking, recovery, installation, maintenance,
                        servicing
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Recovery, installation, maintenance where refrigerant circuit is not
                        breached
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Recovery from equipment with &lt;3 kg charge (or &lt;6 kg hermetically
                        sealed)
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Leak checking only (not involving breaking into refrigerant circuit)
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Quantity added during installation, maintenance or servicing
                </li>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              covered by F-Gas regulations as they are not fluorinated gases. However, they have
              their own safety requirements - R290 requires compliance with flammable substance
              regulations, R717 with toxic substance handling.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: CO2 Equivalent Determination
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 4: Refrigerant Comparison for New Installation
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 5: Heat Pump Heating COP
              </h3>
              <p className="text-sm text-white mb-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Essential Refrigeration Parameters
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Lower condensing temperature:</strong> Improves COP - keep condensers
                  clean
                </li>
                <li className="pl-1">
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Fault Diagnosis from Pressures
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Low suction, high discharge:</strong> Evaporator airflow restriction or
                  iced coil
                </li>
              </ul>
            </div>
