...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['GWP <2500', 'GWP <150', 'GWP <750', 'No GWP limit applies'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1.0 - 1.5', '10.0 - 15.0', '6.0 - 8.0', '2.5 - 4.0'],
    correctAnswer: 3,
    explanation:
...
const HNCModule8Section3_1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 3 · Subsection 1"
      ...
      <HubBody>
        ...
        <ConceptBlock title="The Vapour Compression Refrigeration Cycle">
          <p>
            The vapour compression cycle is the fundamental thermodynamic process used in virtually
            all air conditioning, heat pump and refrigeration systems. It exploits the latent heat
            of vaporisation to move thermal energy from a low-temperature source to a
            high-temperature sink.
          </p>
          <p>
            <strong>The Four Stages of the Cycle:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Compression (1&gt;2):</strong> Low-pressure vapour is compressed to
              high-pressure, high-temperature vapour
            </li>
            <li>
              <strong>Condensation (2&gt;3):</strong> High-pressure vapour releases heat and
              condenses to high-pressure liquid
            </li>
            <li>
              <strong>Expansion (3&gt;4):</strong> High-pressure liquid passes through expansion
              device, dropping to low pressure
            </li>
            <li>
              <strong>Evaporation (4&gt;1):</strong> Low-pressure liquid absorbs heat and evaporates
          ...
          <p>(cooling)</p>
          <p>
            <strong>Pressure-Enthalpy (P-h) Diagram</strong>
          </p>
          <p>
            The P-h diagram is essential for analysing refrigeration cycles. The x-axis shows
            specific enthalpy (kJ/kg), the y-axis shows pressure (bar). The saturation dome divides
            liquid, two-phase and vapour regions.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Compression:</strong> Curved, rising right — Isentropic (constant entropy) -
              pressure and enthalpy increase
            </li>
            <li>
              <strong>Condensation:</strong> Horizontal, left — Isobaric (constant pressure) -
              enthalpy decreases as heat is rejected
            </li>
            <li>
              <strong>Expansion:</strong> Vertical, down — Isenthalpic (constant enthalpy) -
              pressure drops, some flash gas forms
            </li>
            <li>
              <strong>Evaporation:</strong> Horizontal, right — Isobaric (constant pressure) -
              enthalpy increases as heat is absorbed
            </li>
          </ul>
          <p>
            <strong>Key Cycle Parameters</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Evaporating temperature:</strong> Typically 5-10K below desired cooling
              temperature
            </li>
            <li>
              <strong>Condensing temperature:</strong> Typically 10-15K above ambient (air-cooled)
            </li>
            <li>
              <strong>Superheat:</strong> 5-10K above evaporating temperature at compressor inlet
            </li>
            <li>
              <strong>Subcooling:</strong> 5-10K below condensing temperature at expansion device
              inlet
            </li>
            <li>
              <strong>Pressure ratio:</strong> P<sub>discharge</sub> / P<sub>suction</sub> -
              typically 2.5-4 for AC systems
            </li>
          </ul>
          <p>
            <strong>Remember:</strong> Heat always flows from hot to cold naturally. The
            refrigeration cycle uses work (compressor) to move heat against this natural direction -
            from the cold evaporator to the hot condenser.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Refrigerants and Environmental Impact">
          <p>
            ...
            transitioning from high-GWP HFCs towards lower-GWP alternatives and natural
            refrigerants.
          </p>
          <p>
            <strong>Common Refrigerants Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>R410A:</strong> HFC blend — 2088 — A1 — Split AC (being phased out)
            </li>
            <li>
              <strong>R32:</strong> HFC — 675 — A2L — Split AC, heat pumps
            </li>
            <li>
              <strong>R134a:</strong> HFC — 1430 — A1 — Chillers, automotive
            </li>
            <li>
              <strong>R290 (Propane):</strong> HC (Natural) — 3 — A3 — Small systems, heat pumps
            </li>
            <li>
              <strong>R744 (CO2):</strong> Natural — 1 — A1 — Commercial refrigeration, heat pumps
            </li>
            <li>
              <strong>R717 (Ammonia):</strong> Natural — 0 — B2L — Industrial refrigeration
            </li>
          </ul>
          <p>
            <strong>Safety Classification (ASHRAE 34)</strong>
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>B</strong> = Higher toxicity (OEL &lt;400 ppm)
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>2L</strong> = Lower flammability (&lt;10 cm/s)
            </li>
            <li>
              <strong>2</strong> = Flammable
            </li>
            <li>
              <strong>3</strong> = Higher flammability
            </li>
          </ul>
          <p>
          ...
          <p>
            GWP measures a gas's ability to trap heat relative to CO2 (GWP=1) over 100 years. R410A
            with GWP of 2088 means 1 kg leaked is equivalent to 2088 kg of CO2 emissions. This is
            why F-Gas regulations are driving the transition to lower-GWP refrigerants.
          </p>
          <p>
            <strong>R32 vs R410A - Key Differences:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>GWP:</strong> R32 (675) is 68% lower than R410A (2088)
            </li>
            <li>
              <strong>Charge:</strong> R32 requires approximately 30% less refrigerant
            </li>
            <li>
              <strong>Pressure:</strong> R32 operates at slightly higher discharge pressures
            </li>
            <li>
              <strong>Temperature:</strong> R32 has higher discharge temperatures - affects
              compressor design
            </li>
            <li>
              <strong>Safety:</strong> R32 is A2L (mildly flammable) vs R410A A1 (non-flammable)
            </li>
            <li>
              <strong>Efficiency:</strong> R32 has approximately 5% better energy efficiency
            </li>
          </ul>
          <p>
            <strong>Key point:</strong> The refrigerant landscape is evolving rapidly. Building
            services engineers must stay current with regulations, understand refrigerant
            properties, and consider future service availability when specifying new systems.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Compressors and System Components">
          <p>
            The compressor is the "heart" of the refrigeration system, providing the pressure
            difference that drives refrigerant flow. Different compressor types suit different
            capacities and applications, each with distinct characteristics.
          </p>
          <p>
            <strong>Compressor Types Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reciprocating:</strong> 0.5-100 kW — Simple, repairable, wide pressure ratio —
              Small commercial, transport
            </li>
            <li>
              <strong>Scroll:</strong> 3-60 kW — Quiet, efficient, reliable, few parts — Split AC,
              heat pumps, light commercial
            </li>
            <li>
              <strong>Rotary:</strong> 1-15 kW — Compact, quiet, low vibration — Domestic AC, small
              splits
            </li>
            <li>
              <strong>Screw:</strong> 50-1500 kW — High capacity, variable speed capable — Large
              commercial, industrial chillers
            </li>
            <li>
              <strong>Centrifugal:</strong> 300-10,000+ kW — Very high efficiency at full load —
              Large chillers, district cooling
            </li>
          </ul>
          <p>
            <strong>Scroll Compressor Operation</strong>
          </p>
          <p>
            Scroll compressors use two interleaved spiral scrolls - one stationary, one orbiting. As
            the orbiting scroll moves eccentrically, crescent-shaped pockets trap and progressively
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Air-cooled:</strong> Fans over finned coils, simple, common
            </li>
            <li>
              <strong>Water-cooled:</strong> Shell-and-tube, higher efficiency
            </li>
            <li>
              <strong>Evaporative:</strong> Water spray + air, approaching wet-bulb
            </li>
            <li>
              <strong>Microchannel:</strong> Compact, lower charge, modern units
            </li>
          </ul>
          <p>
            <strong>Evaporators</strong>
          </p>
          <p>Absorb heat into low-pressure refrigerant</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Direct expansion (DX):</strong> Air over refrigerant coils
            </li>
            <li>
              <strong>Flooded:</strong> Shell-and-tube for chillers
            </li>
            <li>
              <strong>Plate heat exchanger:</strong> Compact, high efficiency
            </li>
            <li>
              <strong>Fan coil units:</strong> Terminal units with DX or chilled water
            </li>
          </ul>
          <p>
            <strong>Expansion Devices</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Capillary tube:</strong> Fixed restriction (length/diameter) — Small domestic,
              simple systems
            </li>
            <li>
              <strong>Fixed orifice:</strong> Fixed opening size — Residential heat pumps (piston
              type)
            </li>
            <li>
              <strong>TXV/TEV:</strong> Thermostatic - maintains superheat — Commercial AC,
              refrigeration
            </li>
            <li>
              <strong>EEV:</strong> Electronic - stepper motor/PWM — VRF systems, precision control
            </li>
          </ul>
          <p>
            <strong>Design consideration:</strong> Modern inverter-driven compressors require
            electronic expansion valves (EEVs) that can respond quickly to capacity changes. Fixed
            devices cannot maintain correct superheat across the wide operating range of
        ...
        <ConceptBlock title="F-Gas Regulations and Compliance">
          <p>
            ...
            greenhouse gases (HFCs) to reduce their contribution to climate change. Building
            services engineers must understand and comply with these requirements.
          </p>
          <p>
            <strong>Key F-Gas Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Certification:</strong> All personnel handling F-gases must hold appropriate
              F-Gas certificates
            </li>
            <li>
              <strong>Leak checking:</strong> Mandatory for systems above 5 tonnes CO2e (frequency
              depends on charge)
            </li>
            <li>
              <strong>Record keeping:</strong> Equipment records for 5 years minimum
            </li>
            <li>
              <strong>Recovery:</strong> F-gases must be properly recovered during
              service/decommissioning
            </li>
            <li>
              <strong>Labelling:</strong> Equipment must be labelled with refrigerant type and
              charge
            </li>
          </ul>
          <p>
            <strong>Leak Check Frequency (Based on CO2 Equivalent)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>&lt;5 tonnes:</strong> No requirement — -
            </li>
            <li>
              <strong>5-50 tonnes:</strong> 12 months — 24 months
            </li>
            <li>
              <strong>50-500 tonnes:</strong> 6 months — 12 months
            </li>
            <li>
              <strong>&gt;500 tonnes:</strong> 3 months — 6 months
            </li>
          </ul>
          <p>
            <strong>GWP Phase-Down and Bans</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2020:</strong> Domestic refrigerators/freezers GWP &gt;150 banned
            </li>
            <li>
              <strong>2020:</strong> Moveable AC GWP &gt;150 banned
            </li>
            <li>
              <strong>2022:</strong> Commercial refrigeration &lt;40 kW GWP &gt;150 banned
            </li>
            <li>
              <strong>2025:</strong> Single split AC &lt;3 kg charge GWP &gt;750 banned
            </li>
            <li>
              <strong>2025:</strong> Multipack centralised refrigeration &gt;40 kW GWP &gt;150
              banned
            </li>
          </ul>
          <p>
            <strong>CO2 Equivalent Calculation</strong>
          </p>
          ...
          <p>
            <strong>F-Gas Certificate Categories</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>I:</strong> All activities including leak checking, recovery, installation,
              maintenance, servicing
            </li>
            <li>
              <strong>II:</strong> Recovery, installation, maintenance where refrigerant circuit is
              not breached
            </li>
            <li>
              <strong>III:</strong> Recovery from equipment with &lt;3 kg charge (or &lt;6 kg
              hermetically sealed)
            </li>
            <li>
              <strong>IV:</strong> Leak checking only (not involving breaking into refrigerant
              circuit)
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Compliance note:</strong> Natural refrigerants (R290, R744, R717) are not
            covered by F-Gas regulations as they are not fluorinated gases. However, they have their
            own safety requirements - R290 requires compliance with flammable substance regulations,
            R717 with toxic substance handling.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A split system air conditioner has a cooling capacity of 7 kW
            and consumes 2.2 kW of electrical power. Calculate the COP.
          </p>
          ...
          <p>
            COP = 7 kW / 2.2 kW = <strong>3.18</strong>
          </p>
          ...
          <p>
            - Standard leak check interval: <strong>6 months</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Question:</strong> An evaporator operates at 5 bar with R32. The saturation
            temperature at 5 bar is 2 degrees C. The suction line temperature measures 10 degrees C.
          ...
          <p>Implications:</p>
          <p>
            R410A: <strong>Above 5 tonnes - annual leak checks required</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Question:</strong> A heat pump has a heating capacity of 12 kW and compressor
            power of 3.2 kW. Calculate the heating COP.
          </p>
          <p>For heating mode:</p>
          <p>COP (heating) = Heating capacity / Power input</p>
          <p>
            COP = Q<sub>condenser</sub> / W<sub>comp</sub>
          </p>
          <p>
            COP = 12 kW / 3.2 kW = <strong>3.75</strong>
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Superheat:</strong> 5-10K typical - ensures dry vapour to compressor
            </li>
            <li>
              <strong>Subcooling:</strong> 5-10K typical - ensures liquid to expansion device
            </li>
            <li>
              <strong>Suction pressure:</strong> Determines evaporating temperature
            </li>
            <li>
              <strong>Discharge pressure:</strong> Determines condensing temperature
            </li>
            <li>
              <strong>Pressure ratio:</strong> 2.5-4 typical for AC - affects efficiency and
              compressor life
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lower condensing temperature:</strong> Improves COP - keep condensers clean
            </li>
            <li>
              <strong>Higher evaporating temperature:</strong> Improves COP - correctly size
              evaporators
            </li>
            <li>
              <strong>Correct refrigerant charge:</strong> Both under and overcharge reduce
              efficiency
            </li>
            <li>
              <strong>Adequate subcooling:</strong> Maximises evaporator capacity
            </li>
            <li>
              <strong>Clean filters and coils:</strong> Essential for airflow and heat transfer
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Low suction, low discharge:</strong> Low charge or restricted liquid line
            </li>
            <li>
              <strong>High suction, low discharge:</strong> Compressor valve damage
            </li>
            <li>
              <strong>High suction, high discharge:</strong> Overcharge or condenser airflow
              restriction
            </li>
            <li>
              <strong>Low suction, high discharge:</strong> Evaporator airflow restriction or iced
              coil
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Mixing refrigerants:</strong> Never mix different refrigerant types in a
                system
              </li>
              <li>
                <strong>Venting refrigerant:</strong> Illegal under F-Gas regulations - always
                recover
              </li>
              <li>
                <strong>Wrong oil:</strong> Each refrigerant requires specific oil type (POE, PVE,
                mineral)
              </li>
              <li>
                <strong>Ignoring flammability:</strong> A2L and A3 refrigerants need specific
                handling
              </li>
              <li>
                <strong>Working without certification:</strong> F-Gas certificate required for HFC
                handling
              </li>
            </ul>
          }
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">DX systems</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
