      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Review all:</strong> Study explanations for correct and incorrect answers
              </li>
              <li className="pl-1">
                <strong>Diagnose:</strong> Each wrong answer reveals a specific knowledge gap
              </li>
              <li className="pl-1">
                <strong>Patterns:</strong> Track errors by topic to target weak areas
              </li>
              <li className="pl-1">
                <strong>Near misses:</strong> Correct answers with flawed reasoning need attention
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Application failure:</strong> You know the theory but could not apply it
                  in context
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Types of "Correct but Risky" Answers
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Right reason, incomplete understanding:</strong> Your reasoning was
                  correct but shallow — a deeper question would catch you out
                </li>
                <li className="pl-1">
                  <strong>Correct elimination:</strong> You eliminated distractors correctly but
                  could not have identified the answer independently
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> For every correct answer, ask yourself: "Could I explain
              to someone else why this is correct and why the other options are wrong?" If the
              answer is no, study the explanation.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Common Error Patterns in Electrical Maintenance EPA
              </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Always wrong on PLC questions
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Restudy Module 4 PLC content
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Misreading</td>
                      <td className="border border-white/10 px-3 py-2">
                        Missing NOT/EXCEPT in stems
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Practise highlighting key words
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Calculation errors</td>
                      <td className="border border-white/10 px-3 py-2">
                        Unit conversion mistakes (kW/W)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Drill unit conversions daily
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Misconception</td>
                      <td className="border border-white/10 px-3 py-2">
                        Confusing RCD and MCB functions
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Study protection devices in depth
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Application failure</td>
                      <td className="border border-white/10 px-3 py-2">
                        Knowing theory but failing scenarios
                      </td>
                      <td className="border border-white/10 px-3 py-2">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Error log:</strong> Keep a running list of topics and question types you
                  get wrong
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Revision targeting:</strong> Allocate your study time proportionally to
                  your weakest areas
                </li>
              </ul>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Teach it:</strong> Try explaining the concept in your own words — if you
                  can teach it, you understand it
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  Surface learning means recognising the right answer when you see it. Deep learning
                  means understanding why it is right and being able to apply the principle to new
                  situations. The EPA tests deep learning through scenario-based questions — surface
                  learning is not enough. Use explanations to build depth.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Building a Revision Notes Bank
                </h3>
                <p className="text-sm text-white">
                  ...
                  worked examples. These notes become your final revision resource — distilled from
                  your own learning process and focused on your specific needs.
                </p>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                Example: Deep Learning from One Question
              </h3>
              <p className="text-sm text-white mb-3">
                <strong>Question:</strong> What is the maximum disconnection time for a 32 A final
                circuit in a TN system?
              </p>
              <p className="text-sm text-white mb-2">
                <strong>Surface learning:</strong> The answer is 0.4 seconds. Memorise it.
              </p>
              <p className="text-sm text-white mb-2">
                <strong>Deep learning:</strong> BS 7671 Table 41.1 specifies 0.4 seconds for
                circuits not exceeding 32 A in TN systems. The purpose is to ensure automatic
                disconnection of supply (ADS) operates fast enough to prevent electric shock. The
                time relates to the let-through energy that the human body can tolerate. Different
                earthing systems (TT) have different requirements (0.2 seconds). Understanding this
                principle means you can answer questions about any combination of circuit rating and
                earthing system.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Every explanation is an opportunity to move from "I know
              the answer" to "I understand the principle." The EPA rewards understanding, not just
              recall.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                The Practice-Review-Revise Cycle
              </p>
              <ol className="text-sm text-white space-y-2 list-decimal list-outside ml-5">
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Confidence level:</strong> You should feel increasingly confident about
                  your knowledge
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>ST1426 link:</strong> This systematic approach to learning from feedback
              demonstrates the professional behaviour of continuous improvement — a key behaviour
              assessed in the EPA professional discussion.
            </p>
          </div>
        </section>
