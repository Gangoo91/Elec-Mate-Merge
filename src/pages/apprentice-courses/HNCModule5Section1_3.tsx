...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Negative duration', 'Free float only', 'Zero total float', 'Maximum float'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['5 days', '3 days', '4 days', '7 days'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Late Finish', 'Early Start', 'Early Finish', 'Duration'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Clause 32 forces a monthly programme refresh that re-runs the critical path against
              actuals. If you ignore CPM and submit a static Gantt month after month, the PM is
              entitled to reject it and withhold up to 25% of the price (Clause 50.5). CPM
              discipline is therefore not optional under NEC — it is the basis of payment
              certification.
            </>
          }
        ...
        <ConceptBlock title="Critical Path Method Fundamentals">
          <p>
            The Critical Path Method (CPM) is the foundation of modern project scheduling. Developed
            in the 1950s for complex construction and engineering projects, it remains essential for
            managing building services installations where multiple trades must coordinate their
            work precisely.
          </p>
          <p>
          ...
          <p>
            <strong>Standard AON node layout:</strong> A node box typically shows ES, Duration, EF
            on the top row; the Activity ID/Name in the middle; and LS, Float, LF on the bottom row.
        ...
        <ConceptBlock title="Forward and Backward Pass Calculations">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Finish-to-Start (FS):</strong> B starts when A finishes — containment complete
              before cabling
            </li>
            <li>
            ...
            <li>
              <strong>Finish-to-Finish (FF):</strong> B finishes when A finishes — testing completes
              with installation
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Lead (-):</strong> Overlap allowed. Example: FS-3 = cabling can start 3 days
              before containment finishes
            </li>
            <li>
        ...
        <ConceptBlock title="Float Calculations and Critical Path Identification">
          ...
          <p>
            <strong>Float calculation example:</strong> Activity Install distribution board (DB-L2),
            duration 3 days. ES = 15, EF = 18 (from forward pass). LS = 18, LF = 21 (from backward
            pass). Total Float = LF - EF = 21 - 18 = <strong>3 days</strong>. If successor ES = 20,
            Free Float = ES(successor) - EF = 20 - 18 = <strong>2 days</strong>.
          </p>
          <p>
        ...
        <ConceptBlock title="Programme Optimisation and MEP Coordination">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Crashing:</strong> Add resources to reduce duration — higher cost, diminishing
              returns
            </li>
            <li>
              <strong>Fast-tracking:</strong> Overlap sequential activities — increased risk, rework
              potential
            </li>
            <li>
              <strong>Scope reduction:</strong> Remove non-essential work — client approval required
            </li>
            <li>
            ...
            <li>
              <strong>Overtime/shifts:</strong> Extended working hours — fatigue, productivity loss
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Coordination principle:</strong> In MEP works, the trade with longest critical
            path duration typically leads coordination. Others must align their programmes to
            maintain interfaces.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — Forward Pass Calculation:</strong> Calculate Early Start and Early
            Finish for a simple network: Activity A (5 days) leads to B (3 days) and C (4 days).
            Both B and C lead to D (2 days).
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Activity B: ES=5, EF=5+3=<strong>8</strong>
            </li>
            <li>
              Activity C: ES=5, EF=5+4=<strong>9</strong>
            </li>
            <li>
              D requires both B and C complete: ES(D) = MAX(EF of B, EF of C) = MAX(8, 9) =
              <strong>9</strong>
            </li>
            <li>
              Activity D: ES=9, EF=9+2=<strong>11</strong>
            </li>
            <li>Project duration = 11 days</li>
          </ul>
          <p>
            <strong>Example 2 — Float Calculation:</strong> Using the same network, calculate total
            float for Activity B if project duration is 11 days.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Total Float = LF - EF = 9 - 8 = <strong>1 day</strong> (Alternatively: LS - ES = 6 - 5
              = 1 day)
            </li>
          </ul>
          <p>
            <strong>Example 3 — Critical Path Identification:</strong> Which path is critical: A-B-D
            or A-C-D?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Activity C: ES=5, EF=9; LF(C) = LS(D) = 9; TF = LF - EF = 9 - 9 =
              <strong>0 (Critical)</strong>
            </li>
          </ul>
          <p>
            <strong>Example 4 — Crashing Decision:</strong> Project must finish in 10 days. Activity
            C can be crashed by 1 day for GBP500, Activity A by 1 day for GBP800. Which should be
            crashed?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Ignoring near-critical paths</strong> - Low float paths can become critical
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You take over a 14-month commercial fit-out at month four. The accepted programme
              shows a 26-week activity for the LV switchboard, but no logic linking it to the DNO
              connection. The QS reports the switchboard manufacturer has just quoted a 38-week lead
              time on the latest spec change.
            </>
          }
          whatToDo={
            <>
              Run a fresh CPM with the actual switchboard duration. The new critical path now runs
              through switchboard manufacture → DNO witness → energisation → temporary supply → main
              commissioning. The end date slips by 12 weeks. Issue an early warning the same day,
              propose mitigation (split-pack alternative, interim supply, parallel commissioning),
              revise the programme under Clause 32 and quantify the time impact on a CE under Clause
              60. Negotiate down to a 6-week net slip with mitigation.
            </>
          }
          whyItMatters={
            <>
              Long-lead MEP equipment hides on the bar chart but lives on the critical path. CPM
              exposes it. Without CPM, you would have noticed the slip when the switchboard did not
              arrive — three months too late to mitigate, and with no audit trail to support a CE.
            </>
          }
        />
