        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              ...
              <li className="pl-1">
                <strong>Float:</strong> Available slack time for non-critical activities
              </li>
              <li className="pl-1">
                <strong>Forward pass:</strong> Calculate Early Start/Finish times
              </li>
              <li className="pl-1">
                <strong>Backward pass:</strong> Calculate Late Start/Finish times
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>MEP coordination:</strong> Trade interfaces drive dependencies
              </li>
              <li className="pl-1">
                <strong>Plant rooms:</strong> Mechanical often on critical path
              </li>
              <li className="pl-1">
                <strong>Commissioning:</strong> Sequential witness testing constraints
              </li>
              <li className="pl-1">
                <strong>Handover:</strong> Certification dependencies
              </li>
            </ul>
          </div>
        </div>
...
+--------+--------+--------+`}</pre>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Containment complete before cabling
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Testing completes with installation
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Rare - old system until new commissioned
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                Activities with <strong>zero total float</strong> are on the critical path. Any
                delay to these activities directly delays the project completion date by the same
                amount. The critical path is the longest path through the network.
              </p>
            </div>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Float Types and Formulae
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">LF - EF (or LS - ES)</td>
                      <td className="border border-white/10 px-3 py-2">
                        May delay successors (not project end)
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        No impact on any other activity
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Delays successors but not project
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Non-Critical Activities (TF greater than 0)
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2">
                  Total Float = LF - EF = 21 - 18 = <strong>3 days</strong>
                </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Programme Compression Techniques
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Increased risk, rework potential
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ol className="text-sm text-white space-y-1.5 list-decimal list-outside ml-5">
                <li className="pl-1">
                  Only crash activities on the critical path (others have no impact)
                </li>
                <li className="pl-1">
                  Select activities with lowest crash cost per time unit saved
                </li>
                ...
                <li className="pl-1">
                  Stop when crash cost exceeds benefit or no further reduction possible
                </li>
              </ol>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                MEP Critical Path Considerations
              </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Coordination Meeting Focus Areas
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Forward Pass Calculation
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> Calculate Early Start and Early Finish for a simple
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  ES(D) = MAX(EF of B, EF of C) = MAX(8, 9) = <strong>9</strong>
                </p>
                <p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>LF(C) = LS(D) = 9</p>
                <p>
                  TF = LF - EF = 9 - 9 = <strong>0 (Critical)</strong>
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Verify: first activity LS = 0, critical path duration = project duration
                </li>
              </ul>
            </div>
