...
const quickCheckQuestions = [
  {
    ...
    options: ['1500 kg/m³', '1000 kg/m³', '100 kg/m³', '500 kg/m³'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['201.3 kPa', '48.7 kPa', '251.3 kPa', '150 kPa'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['98.1 kPa', '78.48 kPa', '7.85 kPa', '39.24 kPa'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Compressibility', 'Density', 'Viscosity', 'Pressure'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['m²/s', 'kg/m³', 'N/m²', 'Pa·s (Pascal-seconds)'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['50 kPa', '101.3 kPa', '1013 kPa', '10.13 kPa'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Absolute vacuum', 'Maximum system pressure', 'Atmospheric pressure', 'Pump failure'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['250 kPa', '2500 kPa', '25 kPa', '100 kPa'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Density and viscosity', 'Surface tension', 'Colour', 'Thermal conductivity'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE Guide C is the UK reference for fluid properties used in building services
              design. As an HNC engineer your pump curves, pipe sizing and pressure budgets all
              start from these tables — interpolated to the actual operating temperature and
              pressure.
            </>
          }
        ...
        >
          ...
          <p>
            ...
            designed for 80°C water will have slightly different flow characteristics than at 20°C.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>Design tip:</strong> When using glycol solutions, expect 15-25% higher friction
            losses and size pumps accordingly.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>Pressure relationships:</strong> Pabs = Pgauge + Patm. Absolute pressure = gauge
        ...
        >
          ...
          <p>
            ...
            undiminished and equally in all directions throughout the fluid. This enables hydraulic
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Pressurisation:</strong> Systems maintained above atmospheric to prevent air
              ingress
            </li>
            <li>
          ...
          <p>
            <strong>Rule of thumb:</strong> Each 10 metres of water column adds approximately 1 bar
            (100 kPa) of static pressure.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Example 1 - static pressure in a tall building:</strong> A 45m tall building has
            a header tank at roof level. Calculate the static pressure at ground floor level.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              P = ρgh = 1000 × 9.81 × 45 = 441,450 Pa = <strong>441.45 kPa</strong>
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Pabs = Pgauge + Patm = 2.5 bar + 1.013 bar = <strong>3.513 bar absolute</strong>
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ν = 4.78 × 10⁻⁷ m²/s = <strong>0.478 mm²/s (or 0.478 cSt)</strong>
            </li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Forgetting temperature effects</strong> — Density and viscosity change with
                temperature
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You are commissioning the LTHW system in a 30-storey building. The plant room is in
              the basement; the highest emitter is on Level 28 (95 m above plant). You need to set
              the static pressure to keep all parts of the system pressurised above ~20 kPa to
              prevent air ingress and pump cavitation.
            </>
          }
          whatToDo={
            <>
              Calculate the static head: P = ρgh = 970 × 9.81 × 95 ≈ 904 kPa = 9.04 bar at the
              basement plant for the highest point to sit at zero. Add a safety margin (20-30 kPa)
              and account for system temperature (use 80 °C density). Set the expansion vessel
              pre-charge accordingly. Specify pipework, valves and gaskets rated to PN10 or PN16 as
              appropriate. Document the pressure budget on a pressure-elevation diagram for
              handover.
            </>
          }
          whyItMatters={
            <>
              Tall-building LTHW systems often hit pressure ratings as the design constraint. Get
              the static head wrong and you either under-pressurise (air in, cavitation) or
              over-pressurise (pipework rating breach, fitting failures).
            </>
          }
        />
