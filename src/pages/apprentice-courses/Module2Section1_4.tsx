...
const DESCRIPTION =
  'Master SI prefixes (milli, kilo, mega) and unit conversions for electrical quantities. Essential skills for BS 7671 testing and equipment selection.';
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>SI Prefixes:</strong> Standard multipliers for large/small electrical
                  values.
                </li>
                <li>
                  <strong>kilo (k):</strong> × 1,000 - common for power (kW), voltage (kV).
                </li>
                <li>
                  <strong>milli (m):</strong> ÷ 1,000 - used for current (mA), time (ms).
                </li>
                <li>
                  <strong>mega (M):</strong> × 1,000,000 - typical for resistance (MΩ).
                </li>
                <li>
                  <strong>Conversion:</strong> Move decimal point or multiply/divide by factors.
                </li>
                <li>
                  <strong>Safety:</strong> Wrong units = wrong components = danger.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Equipment labels (2.5kW heater), test results (500mA RCD),
                  specifications.
                </li>
                <li>
                  <strong>Use:</strong> Reading drawings, interpreting test readings, component
                  selection.
                </li>
                <li>
                  <strong>Apply:</strong> Load calculations, cable sizing, protection device
                  selection, fault diagnosis.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                Understand common SI prefixes (kilo, mega, milli, micro, nano) and their multipliers
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Recognise prefix symbols and abbreviations on equipment and test instruments
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The International System of Units (SI) uses prefixes to express very large or very
                small quantities. These prefixes are based on powers of 10, making conversions
                straightforward once you understand the pattern.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="font-semibold mb-2 text-elec-yellow">
                  Why SI Prefixes Matter in Electrical Work
                </h3>
                <ul className="text-white space-y-1 text-sm">
                  <li>
                    • <strong>Safety:</strong> Wrong units can lead to equipment damage or personal
                    injury
                  </li>
                  <li>
                    • <strong>Precision:</strong> Electrical measurements often span many orders of
                    magnitude
                  </li>
                  <li>
                    • <strong>Standards:</strong> BS 7671 and IET regulations use consistent SI
                    notation
                  </li>
                  <li>
                    • <strong>Communication:</strong> Universal language for electrical
                ...
                <table className="w-full border-collapse border border-white/10">
                  <thead>
                    <tr className="bg-white/5">
                      <th className="border border-white/10 p-4 text-left text-white font-semibold">
                        Prefix
                      </th>
                      <th className="border border-white/10 p-4 text-left text-white font-semibold">
                        Symbol
              ...
              <div className="rounded-md border border-white/10 p-3 bg-white/5">
                <p className="text-sm">
                  <strong>Professional tip:</strong> These prefixes appear constantly on equipment
                  labels, drawings, and test results. Master them early to work more safely and
                  efficiently.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Converting between units with prefixes follows simple rules. Understanding these
                patterns helps you work quickly and accurately with electrical calculations.
              </p>
            ...
            <div className="space-y-6 text-white">
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 p-4 rounded-lg space-y-2">
                    <p>
                      <strong>Step 1:</strong> Identify the conversion (kilo to base)
                    </p>
                    <p>
                      <strong>Step 2:</strong> Kilo = × 1,000
                    </p>
                    <p>
                      <strong>Step 3:</strong> 2.5 × 1,000 = 2,500
                    </p>
                    <p className="text-elec-yellow font-medium">
                      <strong>Answer:</strong> 2,500 W
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 p-4 rounded-lg space-y-2">
                    <p>
                      <strong>Step 1:</strong> Identify the conversion (milli to base)
                    </p>
                    <p>
                      <strong>Step 2:</strong> Milli = ÷ 1,000
                    </p>
                    <p>
                      <strong>Step 3:</strong> 750 ÷ 1,000 = 0.75
                    </p>
                    <p className="text-elec-yellow font-medium">
                      <strong>Answer:</strong> 0.75 A
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 p-4 rounded-lg space-y-2">
                    <p>
                      <strong>Step 1:</strong> Identify the conversion (base to milli)
                    </p>
                    <p>
                      <strong>Step 2:</strong> To get milli, multiply by 1,000
                    </p>
                    <p>
                      <strong>Step 3:</strong> 0.002 × 1,000 = 2
                    </p>
                    <p className="text-elec-yellow font-medium">
                      <strong>Answer:</strong> 2 mA
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 p-4 rounded-lg space-y-2">
                    <p>
                      <strong>Step 1:</strong> Identify the conversion (mega to kilo)
                    </p>
                    <p>
                      <strong>Step 2:</strong> 1 MΩ = 1,000 kΩ
                    </p>
                    <p>
                      <strong>Step 3:</strong> 4.7 × 1,000 = 4,700
                    </p>
                    <p className="text-elec-yellow font-medium">
                      <strong>Answer:</strong> 4,700 kΩ
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Practice converting between different electrical units and prefixes using this
            interactive tool:
          </p>
            ...
            <div className="space-y-6 text-white">
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 p-4 rounded-lg space-y-2">
                    <p>
                      • <strong>2.5kW Heater:</strong> 2,500 watts
                    </p>
                    <p>
                      • <strong>32A MCB:</strong> 32 amperes
                    </p>
                    <p>
                      • <strong>500mA RCD:</strong> 0.5 amperes
                    </p>
                    <p>
                      • <strong>13A Fuse:</strong> 13 amperes
                    </p>
                    <p>
                      • <strong>1000V Insulation:</strong> 1 kilovolt
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 p-4 rounded-lg space-y-2">
                    <p>
                      • <strong>Insulation test:</strong> &gt;2MΩ = good
                    </p>
                    <p>
                      • <strong>Continuity test:</strong> &lt;0.05Ω = good
                    </p>
                    <p>
                      • <strong>RCD test:</strong> 28mA = 0.028A
                    </p>
                    <p>
                      • <strong>Loop impedance:</strong> 1.2Ω = acceptable
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-elec-yellow">
                  <strong>Safety Reminder:</strong> Always double-check units when selecting
                  components. Confusing mA with A, or kV with V, can be dangerous and damage
                  equipment.
                </p>
              </div>
            </div>
        ...
        {/* Quiz Section */}
        <div className="mt-12">
          <Quiz title="SI Prefixes and Conversions Quiz" questions={quizQuestions} />
        </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/apprentice/level2/module2/section1/1-5">
              Next: Multimeters
