...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'A complete calibration certificate must contain all information needed to demonstrate traceability, accuracy, and compliance with the calibration procedure.',
  },
  {
    id: 'qc2',
    ...
    correctIndex: 1,
    explanation:
      'As-found data reveals how much the instrument has drifted since its last calibration, enabling trend analysis and calibration interval optimisation.',
  },
  {
    id: 'qc3',
...
const quizQuestions = [
  {
    ...
    options: [
      'To create attractive graphs',
      'To identify drift patterns, predict when instruments may go out of tolerance, and optimise calibration intervals',
      'To satisfy auditors only',
      'To compare different instrument brands',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'One year only',
      'Records do not need to be retained',
    ],
    correctAnswer: 1,
    explanation:
      'Retention periods are defined by the QMS and applicable regulations. Pharmaceutical (GMP) may require lifetime plus 10 years. General industrial practice is typically 5-10 years minimum.',
  },
  {
    id: 3,
    question: 'What is an audit trail in calibration documentation?',
    options: [
      'A hiking trail near the calibration lab',
      'A complete, tamper-evident record of all calibration activities, changes, and approvals that can be independently verified',
      'A list of auditor names',
  ...
  },
  {
    ...
    options: [
      'Paper records only',
      'Electronic records must have the same trustworthiness as paper records, with electronic signatures, audit trails, and system validation',
      'No specific requirements',
      'Records stored on CDs only',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A system for recalling faulty instruments from customers',
      'A system that tracks calibration due dates and generates notifications when instruments are due for calibration',
      'A telephone system for the calibration department',
      'A system for returning calibration equipment to the manufacturer',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Investigate the discrepancy, complete or correct the records, assess any impact on measurement validity, and implement corrective actions to prevent recurrence',
      'Delete the records',
      'Re-calibrate all instruments in the plant',
    ],
    correctAnswer: 1,
    explanation:
      'Incomplete or incorrect records may indicate that calibrations were not performed correctly. The discrepancy must be investigated, records corrected, impact assessed, and preventive measures implemented.',
  },
  {
    id: 7,
    question: 'What is the benefit of electronic calibration records over paper?',
    options: [
      'Paper records are always superior',
      'Electronic records enable automated scheduling, trending, search/retrieval, secure storage, audit trail, and integration with asset management systems',
      'Electronic records are cheaper to create',
      'There is no significant benefit',
    ],
    correctAnswer: 1,
    explanation:
      'Electronic records offer searchability, automated trending, secure backup, audit trails, integration with CMS/CMMS, and elimination of manual transcription errors.',
  },
  {
    id: 8,
  ...
  },
  {
    ...
    options: [
      ...
      'The instrument is only used on Mondays',
    ],
    correctAnswer: 1,
    explanation:
      'Limited use status indicates the instrument is functional but does not meet its full specification. It can be used where its actual accuracy is sufficient for the measurement requirement.',
  },
  {
    id: 10,
    question: 'During a quality audit, what calibration documentation is typically reviewed?',
    options: [
      'Only the most recent calibration certificate',
      ...
      'Only the instrument purchase orders',
      'Only the calibration schedule',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Strike through the error with a single line, write the correction alongside, initial and date the change',
      'Erase the error and rewrite',
      'Start a new record from scratch',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To replace calibration technicians',
      'To schedule, track, document, and trend all calibration activities, ensuring compliance and enabling data-driven interval management',
      'To store instrument photographs only',
      'To calculate instrument purchase costs',
    ],
    correctAnswer: 1,
    explanation:
      'A CMS manages the complete calibration lifecycle: scheduling, tracking instrument status, storing records, trending drift data, managing OOT events, and generating compliance reports. Examples include Beamex CMX and Fluke DPC/TRACK.',
  },
];
