...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['2.4 GHz', '433 MHz', '5 GHz', '868 MHz'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['Zigbee', 'Thread', 'Bluetooth Mesh', 'Z-Wave'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['32,767', '256', '1,024', '65,535'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Edge computing', 'Centralised cloud', 'Fog computing', 'Distributed ledger'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['WEP', 'Basic HTTP authentication', 'OAuth 2.0 with TLS', 'Telnet access'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="IoT Lighting Fundamentals">
          <p>
            Internet of Things (IoT) enabled lighting transforms luminaires from simple light
            sources into intelligent networked devices capable of bidirectional communication, data
            collection, and integration with building management ecosystems.
          </p>
          <p>
            <strong>IoT Lighting Architecture Components:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Smart luminaires:</strong> LED drivers with embedded wireless radios and
              sensors
            </li>
            <li>
              <strong>Gateways/bridges:</strong> Protocol translation between lighting network and
              IP infrastructure
            </li>
            <li>
              <strong>Cloud platform:</strong> Data storage, analytics, remote management, and API
              access
            </li>
            <li>
              <strong>Edge processing:</strong> Local intelligence for latency-sensitive operations
            </li>
          </ul>
          <p>
            <strong>IoT vs Traditional Lighting Control</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Communication:</strong> Unidirectional (command only) — Bidirectional (command
              + feedback)
            </li>
            <li>
              <strong>Remote access:</strong> Requires on-site presence — Cloud-based anywhere
              access
            </li>
            <li>
              <strong>Data collection:</strong> Manual meter readings — Continuous automated logging
            </li>
            <li>
              <strong>Firmware updates:</strong> Physical replacement — Over-the-air (OTA)
            </li>
            <li>
              <strong>Integration:</strong> Proprietary protocols — Open APIs, IT system integration
            </li>
          </ul>
          <p>
            <strong>Key principle:</strong> IoT lighting creates value beyond illumination through
            the data it generates and the systems it enables.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Wireless Protocols for Smart Lighting">
          <p>
            Modern smart lighting relies on low-power wireless protocols optimised for mesh
            networking. The three dominant protocols - Bluetooth Mesh, Zigbee, and Thread - each
            offer distinct advantages for different application requirements.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Frequency:</strong> 2.4 GHz — 2.4 GHz / 868 MHz — 2.4 GHz
            </li>
            <li>
              <strong>Max nodes:</strong> 32,767 — 65,535 — ~250 per network
            </li>
            <li>
              <strong>IP-based:</strong> No (requires gateway) — No (requires gateway) — Yes (native
              IPv6)
            </li>
            <li>
              <strong>Smartphone access:</strong> Direct (no hub needed) — Via hub/gateway — Via
              border router
            </li>
            <li>
              <strong>Typical range:</strong> 10-30m per hop — 10-100m per hop — 10-30m per hop
            </li>
            <li>
              <strong>Best for:</strong> Retrofit, smartphone control — Large-scale commercial —
              IT-integrated smart buildings
            </li>
          </ul>
          <p>
            <strong>Bluetooth Mesh</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Matter Standard</strong>
          </p>
          <p>
            Matter (formerly CHIP) provides a unified application layer running over Thread, Wi-Fi,
            and Ethernet. Matter-certified devices interoperate regardless of manufacturer,
            addressing the fragmentation that previously limited smart home adoption. Major lighting
            manufacturers now offer Matter-compatible products.
          </p>
          <p>
            <strong>Selection guidance:</strong> Choose Bluetooth Mesh for retrofit simplicity,
            Zigbee for proven large-scale commercial deployments, and Thread for new builds
            prioritising IT integration.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="App Control and Cloud Platforms">
          <p>
            Smartphone applications and cloud platforms transform how lighting systems are
            commissioned, controlled, and managed. Modern platforms provide intuitive interfaces for
            end users while enabling sophisticated management capabilities for facilities teams.
          </p>
          <p>
            <strong>App Control Capabilities:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Commissioning:</strong> Automatic device discovery, grouping, and scene
              programming
            </li>
            <li>
              <strong>Real-time control:</strong> Dimming, colour temperature, scene selection,
              scheduling
            </li>
            <li>
              <strong>Personalisation:</strong> User preferences, circadian profiles, workspace
              settings
            </li>
            <li>
              <strong>Voice integration:</strong> Amazon Alexa, Google Assistant, Apple HomeKit
            </li>
          </ul>
          <p>
            <strong>Cloud Platform Architecture</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Device layer:</strong> Luminaires, sensors, switches — Bluetooth/Zigbee/Thread
              mesh
            </li>
            <li>
              <strong>Gateway layer:</strong> Protocol translation, local processing — Edge
              computing devices
            </li>
            <li>
              <strong>Connectivity layer:</strong> Secure cloud connection — MQTT, HTTPS, WebSocket
            </li>
            <li>
              <strong>Platform layer:</strong> Data storage, processing, APIs — AWS IoT, Azure IoT
              Hub
            </li>
            <li>
              <strong>Application layer:</strong> User interfaces, dashboards — Mobile apps, web
              portals
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Calendar integration:</strong> Automatic lighting scenes based on room
              bookings
            </li>
            <li>
              <strong>Access control:</strong> Lights activate when authorised badge detected
            </li>
            <li>
              <strong>HVAC coordination:</strong> Synchronised occupancy-based control
            </li>
            <li>
              <strong>Energy management:</strong> Demand response during peak tariff periods
            </li>
          </ul>
          <p>
            <strong>Best practice:</strong> Implement local fallback control to ensure lighting
            remains operational during cloud or internet outages.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Data Analytics and Predictive Maintenance">
          <p>
            Smart lighting systems generate continuous streams of operational data. Properly
            analysed, this data enables energy optimisation, space utilisation insights, and
            predictive maintenance strategies that reduce costs and improve building performance.
          </p>
          <p>
          ...
          <p>
            <strong>Occupancy Analytics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Predictive Maintenance Data Points</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Operating hours:</strong> Progress toward rated lifetime — Schedule
              replacement at L70
            </li>
            <li>
              <strong>Junction temperature:</strong> Thermal stress, accelerated ageing — Improve
              ventilation, derate output
            </li>
            <li>
              <strong>Driver current trend:</strong> Component degradation — Predict driver failure
              window
            </li>
            <li>
              <strong>Light output (lux):</strong> Lumen depreciation rate — Increase output or
              schedule replacement
            </li>
            <li>
              <strong>Communication errors:</strong> Network or hardware issues — Investigate
          ...
          <p>
            <strong>Cybersecurity Considerations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Encryption:</strong> TLS 1.3 for cloud communication, AES-128 for mesh
              networks
            </li>
            <li>
              <strong>Authentication:</strong> OAuth 2.0 for apps, certificate-based for devices
            </li>
            <li>
              <strong>Firmware security:</strong> Cryptographic code signing, secure boot
            </li>
            <li>
              <strong>Network segmentation:</strong> Separate VLAN for IoT devices
            </li>
            <li>
              <strong>PSTI compliance:</strong> No default passwords, vulnerability disclosure
              policy
            </li>
          </ul>
          <p>
            <strong>GDPR compliance:</strong> Occupancy analytics must anonymise data. Use heat
            mapping and aggregated counting rather than individual tracking. Conduct Data Protection
            Impact Assessments for any personal data processing.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> A 3-floor office building requires smart lighting retrofit
            without rewiring. 150 luminaires, smartphone control required, moderate IT integration.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Calculate annual energy savings from smart lighting controls
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Select protocol based on scale, integration requirements, and retrofit constraints
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Zigbee frequency: <strong>2.4 GHz</strong> (global), 868 MHz (Europe)
            </li>
            <li>
              Bluetooth Mesh max nodes: <strong>32,767</strong> devices
            </li>
            <li>
              Thread addressing: <strong>IPv6 native</strong>
            </li>
            <li>
              Typical energy savings: <strong>40-70%</strong> with smart controls
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Insufficient mesh density</strong> - Message failures in sparse areas
              </li>
              <li>
                <strong>No local fallback</strong> - System fails during cloud outages
              </li>
              <li>
                <strong>Ignoring cybersecurity</strong> - Vulnerable to attacks and non-compliant
              </li>
              <li>
                <strong>Over-collecting data</strong> - GDPR violations with personal data
              </li>
            </ul>
          }
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Scene setting</div>
          </button>
          <button
