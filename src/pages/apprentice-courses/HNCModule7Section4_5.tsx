        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>IoT lighting:</strong> Bidirectional cloud-connected luminaires
              </li>
              <li className="pl-1">
                <strong>Wireless protocols:</strong> Bluetooth Mesh, Zigbee, Thread
              </li>
              <li className="pl-1">
                <strong>Data analytics:</strong> Energy, occupancy, and performance insights
              </li>
              <li className="pl-1">
                <strong>Predictive maintenance:</strong> AI-driven failure forecasting
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Integration:</strong> BMS, HVAC, access control systems
              </li>
              <li className="pl-1">
                <strong>Standards:</strong> Matter, DALI-2, KNX compatibility
              </li>
              <li className="pl-1">
                <strong>Security:</strong> Encrypted communications, firmware signing
              </li>
              <li className="pl-1">
                <strong>Compliance:</strong> GDPR, PSTI Act, energy regulations
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              sources into intelligent networked devices capable of bidirectional communication,
              data collection, and integration with building management ecosystems.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                IoT Lighting Architecture Components:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Gateways/bridges:</strong> Protocol translation between lighting network
                  and IP infrastructure
                </li>
                <li className="pl-1">
                  <strong>Cloud platform:</strong> Data storage, analytics, remote management, and
                  API access
                </li>
                <li className="pl-1">
                  <strong>Edge processing:</strong> Local intelligence for latency-sensitive
                  operations
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                IoT vs Traditional Lighting Control
              </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Unidirectional (command only)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Bidirectional (command + feedback)
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Open APIs, IT system integration
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              ...
              <p className="text-sm text-white">
                Matter (formerly CHIP) provides a unified application layer running over Thread,
                Wi-Fi, and Ethernet. Matter-certified devices interoperate regardless of
                manufacturer, addressing the fragmentation that previously limited smart home
                adoption. Major lighting manufacturers now offer Matter-compatible products.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              commissioned, controlled, and managed. Modern platforms provide intuitive interfaces
              for end users while enabling sophisticated management capabilities for facilities
              teams.
            </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Luminaires, sensors, switches
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Bluetooth/Zigbee/Thread mesh
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Gateway layer</td>
                      <td className="border border-white/10 px-3 py-2">
                        Protocol translation, local processing
                      </td>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Progress toward rated lifetime
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Schedule replacement at L70
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Junction temperature</td>
                      <td className="border border-white/10 px-3 py-2">
                        Thermal stress, accelerated ageing
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Improve ventilation, derate output
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Increase output or schedule replacement
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Investigate interference or faults
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              ...
              <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5 mt-2">
                <li className="pl-1">
                  Anomaly detection identifies failing luminaires before complete failure
                </li>
                <li className="pl-1">
                  Pattern recognition optimises schedules based on actual usage
                </li>
                <li className="pl-1">
                  Regression models correlate energy use with weather and occupancy
                </li>
                <li className="pl-1">
                  Classification algorithms categorise space usage for facility planning
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Protocol Selection for Office Retrofit
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Scenario:</strong> A 3-floor office building requires smart lighting
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Energy Savings Calculation
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Predictive Maintenance Alert
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="ml-4 text-yellow-400">
                  Junction temperature: +12°C above fleet average
                </p>
                <p className="ml-4 text-yellow-400">Driver current: +8% above nominal</p>
                <p className="ml-4 text-yellow-400">
                  Light output: -18% from commissioning baseline
                </p>
                ...
                <p className="mt-2 text-red-400">
                  Prediction: Driver failure in 2,000-4,000 operating hours
                </p>
                <p className="text-green-400">
                  Action: Schedule replacement in next maintenance cycle
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Ensure adequate mesh density (typically 1 router per 5-10 end devices)
                </li>
                <li className="pl-1">
                  Plan gateway placement for optimal coverage and IT room access
                </li>
                <li className="pl-1">
                  Specify cybersecurity requirements in procurement documents
                </li>
                <li className="pl-1">
                  Define data analytics requirements and reporting dashboards
                </li>
