...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'To set the minimum insulation resistance values for fixed electrical installations',
      'To define the inspection and testing sequence for completed installations',
      'To specify the maximum permitted carbon emissions for industrial buildings',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It increases the supply voltage to improve the performance of resistive loads',
      'It filters harmonic currents generated by non-linear loads on the network',
      'It reduces reactive power demand, lowering electricity costs and freeing up system capacity',
      'It provides a back-up source of real power during a mains supply failure',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It has no measurable effect on energy use because the motor speed stays constant',
      'It reduces energy consumption by lowering the mechanical load on the motor',
      'It increases energy consumption due to additional mechanical losses, vibration and bearing wear',
      'It only affects the motor starting current, not its running consumption',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Because compressed air leaks present an immediate electric shock hazard to operators',
      'Because compressed air is energy-intensive and leaks can waste 20-30% of output',
      'Because leaks reduce the air pressure below the level required by building regulations',
      'Because the compressor warranty is voided if any leak is left unrepaired',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Replacing the warning labels on a distribution board',
      'Tightening the fixing screws on a cable tray',
      'Cleaning and maintaining heat exchanger surfaces on HVAC equipment',
      'Updating the circuit chart inside a consumer unit',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It corrects the motor power factor by supplying reactive power locally',
      'It steps down the supply voltage to reduce losses in the motor windings',
      'It switches the motor off automatically when the building is unoccupied',
      'It varies the supply frequency to match motor speed with the actual demand',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Driver efficiency, luminaire cleanliness, controls and emergency battery condition',
      'Only the colour temperature of the LED chips, since nothing else affects efficiency',
      'Only the supply voltage at the consumer unit, since the luminaires are sealed',
      'Only the fire rating of the downlights, since this determines their energy use',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Degraded insulation increases the circuit resistance, reducing the current that can flow',
      'Leakage currents flow through the degraded insulation, wasting energy as heat and potentially causing tripping',
      'Degraded insulation raises the supply voltage, forcing equipment to draw more power',
      'Degraded insulation improves conduction, allowing the cable to carry more useful load',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Generating electricity on site to reduce the load drawn from the grid',
      'Correcting the building power factor to avoid reactive power charges',
      'Controlling heating, cooling and lighting to suit occupancy and conditions',
      'Storing surplus heat in a thermal store for use during peak demand periods',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Replacing the supplier fiscal meter with a more accurate model to cut billing errors',
      'Fitting a single meter at the incoming supply to record whole-site consumption',
      'Reading the main incoming meter more frequently to spot changes in total demand',
      'Adding meters on individual circuits or equipment to show where energy is used',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Oversized equipment, poor power factor, worn belts, air leaks and needless running',
      'Only the readings shown on the main incoming supply meter for the whole site',
      'Only the age of the consumer unit and the type of protective devices fitted',
      'Only whether the installation complies with the latest edition of BS 7671',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A correctly tensioned belt raises the motor speed and so increases its output',
      'Incorrect tension, whether too loose or too tight, increases energy losses',
      'Belt tension determines the power factor of the motor and its reactive demand',
      'A tighter belt always reduces energy use by transmitting more power to the load',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It increases the motor speed, allowing the driven equipment to work faster',
      'It improves the motor power factor and reduces the reactive current drawn',
      'Proper lubrication reduces friction losses in the bearings, lowering energy consumption and extending bearing life',
      'It cools the motor windings directly, reducing copper losses in the stator',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Worn drive belts slipping on their pulleys and converting power into heat',
      'Dirty luminaires reducing light output and prompting higher lighting levels',
      'Blocked HVAC filters restricting airflow and overloading the fan motors',
      'Voltage imbalance, harmonics and poor power factor causing extra losses',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Because technicians can spot and act on energy waste during routine work',
      'Because the standard requires technicians to design replacement supply systems',
      'Because energy efficiency is the only knowledge area assessed in the end-point assessment',
      'Because technicians are legally responsible for the owner meeting carbon targets',
    ],
    correctAnswer: 0,
    explanation:
