...
const DESCRIPTION =
  'Comprehensive guide to energy efficiency in electrical maintenance: ISO 50001, motor alignment, power factor correction, LED upgrades, VSD maintenance, compressed air leak detection, BEMS maintenance, energy auditing and metering practices aligned to ST1426.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "Compressed air is often called the 'fourth utility' and is one of the most expensive forms of energy in industrial settings — only about 10% of the electrical energy input to a compressor is converted to useful work. Industry studies consistently show that 20-30% of compressed air output is lost through leaks. Regular ultrasonic leak surveys and prompt repair are high-value energy efficiency activities.",
  },
];
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              consumption, and a significant proportion of that energy is wasted through poorly
              maintained equipment, inefficient systems, and avoidable losses. As a maintenance
              technician, you are uniquely positioned to influence energy efficiency — you see
              equipment in its operational state, you understand how systems perform, and you have
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              lose efficiency from insulation degradation and connection resistance. Lighting
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              identify energy waste. Developing the habit of observing energy performance alongside
