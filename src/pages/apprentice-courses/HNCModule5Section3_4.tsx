    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Statutory adjudication under the Construction Act gives both parties a 28-day route to
              a binding decision on disputed variations and claims. It is fast, relatively cheap,
              and the decision is binding pending final determination. Contemporaneous records and
              clear notices are what win adjudications — not retrospective narrative.
            </>
          }
        ...
        <ConceptBlock title="Variation Instruction Process">
          <p>
            Variations are changes to the contracted scope of work, whether additions, omissions, or
            alterations. Proper administration of variations protects both parties and ensures fair
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Substitution:</strong> Replacement with different specification (e.g., LED for
              fluorescent)
            </li>
            <li>
              <strong>Alteration:</strong> Change to design or sequence (e.g., relocating a submain
              route)
            </li>
            <li>
          ...
          <p>
            <strong>
              Variation Instruction Requirements (Contract — Who Can Instruct — Form):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>JCT DB:</strong> Employer/Employer's Agent — Change to Employer's Requirements
            </li>
            <li>
          ...
          <p>
            <strong>Confirmation of Verbal Instruction (CVI) —</strong> When a verbal instruction is
            given on site, the contractor should issue a CVI confirming:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>M&E reality:</strong> On complex building services projects, verbal instructions
            are common due to coordination pressures. Robust CVI procedures protect the
        ...
        <ConceptBlock title="Valuation Methods">
          <p>
            Standard form contracts establish a hierarchy of valuation methods, moving from the most
            objective (contract rates) to the most subjective (fair valuation) as the work diverges
          ...
          <p>
            ...
            instructs rerouting of 50m of cable tray due to a clash with structural steelwork. The
            original contract rate for cable tray was priced for straight runs at low level. The
            variation involves working at 4m height around obstructions.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Submission:</strong> Build-up showing base rate plus adjustments for changed
              conditions
            </li>
          </ul>
          <p>
            <strong>Key principle:</strong> The contractor must substantiate why contract rates are
            inapplicable before moving to fair valuation. Simply asserting rates are too low is
            insufficient.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Notice Requirements and Conditions Precedent">
          <p>
            ...
            formalities; failure to give proper notice may completely bar a claim, regardless of its
            substantive merit.
          </p>
          <p>
            ...
            <em>Bexheat v Essex Services</em> confirmed that failure to give timely notice can bar
            an otherwise valid claim. "Time is of the essence" in notification.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Identification:</strong> Clearly identify the event or instruction giving rise
              to the claim
            </li>
            <li>
            ...
            <li>
              <strong>Records intention:</strong> State that contemporaneous records are being kept
            </li>
          </ul>
          <p>
            <strong>Sample Early Warning Notice (NEC4 Style) —</strong> To: Project Manager. Date:
            15 March 2024. Re: Early Warning Notice - Main Plant Room Access. We hereby give notice
            under clause 15.1 of a matter which could:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Delay completion (access restriction until 30 April)</li>
            <li>Increase total cost (out-of-sequence working)</li>
            <li>
              The structural contractor has advised that the main plant room will not be handed over
              until 30 April 2024, 6 weeks later than the construction programme.
            </li>
            <li>
              We request this matter be added to the Risk Register and discussed at the next risk
              reduction meeting.
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Loss and Expense Claims and Substantiation">
          <p>
            Loss and expense claims compensate the contractor for direct loss or expense beyond the
            contract sum, caused by matters for which the employer bears contractual risk.
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Disruption costs:</strong> Loss of productivity due to working inefficiently
            </li>
            <li>
            ...
            <li>
              <strong>Finance charges:</strong> Interest on delayed payments or additional capital
              employed
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Event:</strong> Identify the cause/relevant matter — Instructions, minutes,
              correspondence
            </li>
            <li>
            ...
            <li>
              <strong>3. Causation:</strong> Show event caused the loss — Programme analysis, delay
              expert
            </li>
            <li>
          ...
          <p>
            <strong>M&E Disruption Claim Example:</strong> An electrical subcontractor is forced to
            work in areas out of sequence due to late structural completion. Instead of installing
            containment floor-by-floor (planned productivity: 40m/day), work is scattered across
            multiple floors (actual productivity: 25m/day).
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            ...
            rejected entirely. The burden of proof is on the claimant to demonstrate both liability
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            ...
            substitution of standard LED panels for emergency-rated versions in a corridor. Original
            contract rate: £85/luminaire. Emergency version requires different wiring and testing.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 2 — Prolongation Cost Calculation:</strong> M&E subcontractor is granted
            4 weeks extension of time due to late access. Calculate prolongation costs.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — Daywork Calculation:</strong> Emergency modification to distribution
            board following discovery of existing asbestos. 2 electricians for 6 hours plus
            materials.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              The contract administrator verbally tells you to redesign the lighting layout at high
              level to suit a new ceiling grid. You crack on, complete the work, and submit a £45k
              variation. The CA rejects it: "I never said that, and you have no instruction." You
              have no email confirmation, no written instruction, no contemporaneous record of the
              conversation.
            </>
          }
          whatToDo={
            <>
              Never act on verbal instructions without written confirmation. JCT Clause 5.1 requires
              variations to be in writing; the contractor should refuse verbal instructions or
              follow up the same day with a "confirmation of verbal instruction" (CVI) email asking
              the CA to confirm. NEC4 has equivalent provisions. From now on, no verbal instruction
              is acted on without same-day written confirmation. Brief site staff on this
              discipline.
            </>
          }
          whyItMatters={
            <>
              Variations and claims live or die on contemporaneous records. Verbal instructions,
              ambiguous emails and missing notices are how contractors lose money on otherwise valid
              work. The discipline of "if it isn't written, it didn't happen" is the cheapest
              commercial protection on any project.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Cost control</div>
          </button>
          <button
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Final account</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
