...
const quickCheckQuestions = [
  {
    ...
    options: [
      'Any change the contractor wants to make',
  ...
  },
  {
    ...
    options: [
      'Daywork, then fair rates, then contract rates',
      'Contract rates, then pro-rata rates, then fair valuation',
      'Fair valuation first, then negotiate',
      'Lump sum agreement only',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Can be created from memory later',
    ],
    correctIndex: 2,
    explanation:
