...
const AM2Module2Section4 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['MΩ (megohms)', 'kΩ (kilohms)', 'Ω (ohms)', 'mΩ (milliohms)'],
      correctAnswer: 0,
      explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Accurate completion of certificates, test sheets, and RAMS forms within AM2 time limits -
          critical skills for passing AM2 and real-world electrical work.
        </p>
        ...
        <ConceptBlock title="Paperwork Failure = Assessment Failure">
          <p>
            ...
            afterthought — it's part of the assessment. Candidates must complete certificates, test
            sheets, and RAMS forms accurately and efficiently within the strict time limit. Many
            otherwise competent electricians fail because their documentation is rushed, incomplete,
            or unrealistic.
          </p>
          <p>
        ...
        <ConceptBlock title="Types of Paperwork You'll Complete">
          ...
          <p>
            <strong>Schedule of Test Results.</strong> Detailed test measurements for each circuit.
            Values must be consistent with actual installation and realistic for the circuit types.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="NET Testing Procedures">
          ...
          <p>
            <strong>5. Earth Fault Loop Impedance (Zs).</strong> Verify disconnection times meet BS
            7671 requirements.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Common Paperwork Mistakes">
          ...
          <p>
            <strong className="text-elec-yellow">Why Realistic Values Matter.</strong> Assessors are
            experienced electricians who know what realistic test results look like. They can spot
            copied or "book" values immediately. Values like "999.9 MΩ" for insulation resistance or
            "0.00 Ω" for earth fault loop impedance are red flags that indicate you haven't actually
            performed the tests.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Time Pressure in AM2">
          ...
          <p>
            <strong>Time Allocation.</strong> About 3.5 hours for testing and documentation combined
            — no separate paperwork time.
          </p>
          <p>
          ...
          <p>
            <strong className="text-orange-400">Time Management Reality.</strong> With approximately
            3.5 hours to complete inspection, testing AND all documentation, you cannot afford to
            leave paperwork until the end. Successful candidates integrate documentation into their
            testing process, recording results immediately after each test.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Real-world Examples">
          ...
          <p>
            ...
            industry, an electrician signed off an incomplete EIC without proper test results. Work
            was later audited by building control — disciplinary action taken and professional
            reputation damaged.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Frequently Asked Questions">
          ...
          <p>
            <strong>Q2: Will assessors allow small mistakes?</strong> Minor slips may not fail you,
            but repeated or major omissions will. Quality and accuracy are assessed holistically.
          </p>
          <p>
            <strong>Q3: Do I need to write explanations for test results?</strong> No, just accurate
            measured values in the correct boxes. Over-explanation can waste valuable time.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Inspection and testing isn’t just a Section B exercise — it’s a regulatory requirement
              for every installation. Your AM2 paperwork has to record what you tested, what you
              measured, and the certificate confirms the install meets BS 7671. Blank readings break
              the regulation. Made-up readings break the law.
            </>
          }
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Don’t panic-fill. Work through it methodically: schedule of inspections (tick what you
              actually inspected, leave the rest blank rather than tick everything to be safe),
              schedule of test results (transcribe from your rough sheet — never make a number up),
              then declarations and signatures. If you genuinely run out of time, hand in what
              you’ve honestly completed. A blank field loses one criterion. A fabricated reading is
              a critical fail.
            </>
          }
          whyItMatters={
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              says something different at the end. The assessor spots the mismatch and you’ve got no
              clean trail.
            </>
          }
          doInstead={
            <>
              ...
              end. Cross-check before you sign. One source of truth, transcribed once, signed once.
            </>
          }
        />
