  ...
  const quickCheckQuestions = [
    {
      ...
      options: [
        'Rounding the final answer too early',
        'Reading a value off the wrong instrument scale',
        'Forgetting to square a term in a formula',
    ...
    },
    {
      ...
      options: [
        'Calculate first, then convert the units afterwards',
        'Convert units, write values, choose formula, calculate, round',
        'Round each value, then choose a formula and convert',
        'Guess the answer, then work backwards to check',
      ],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'The plug fuse rating is higher than the appliance needs',
        'The appliance simply draws a normal, healthy load',
        'The socket has been wired with the line and neutral reversed',
      ],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [
        'Repeat the same calculation a second time',
        'Add an extra decimal place to the answer',
        'Convert the answer into a different unit',
    ...
    },
    {
      ...
      options: [
        'The age and condition of your calculator',
        'Whether the supply voltage is exactly 230 V',
        'Unit conversions and formula rearrangement',
        'The ambient temperature where you are working',
      ],
      correctIndex: 2,
  ...
  const quizQuestions = [
    {
      ...
      question: 'Which is the top cause of 1000× errors?',
      options: [
        'Using the wrong colour pen on a worksheet',
        'Prefix mistakes (kΩ vs Ω, mA vs A)',
        'Writing the answer before the question',
        'Forgetting to label the units on a diagram',
      ],
      correctAnswer: 1,
      explanation: 'Always convert prefixes first.',
    },
    ...
    },
    {
      ...
      question: 'Best order of steps?',
      options: [
        'Round first, then choose a formula and convert units',
        'Calculate first, then convert the units afterwards',
        'Choose a formula, guess the answer, then check it',
        'Convert units, write values, choose formula, calculate, round',
      ],
      correctAnswer: 3,
      explanation: 'Good workflow prevents mistakes.',
    },
    {
      ...
      options: [
        'Loose connection/high current causing I²R heating',
        'The supply voltage is slightly above 230 V',
        'The appliance is operating at its rated efficiency',
        'The circuit is correctly protected and balanced',
      ],
      correctAnswer: 0,
      explanation: 'Investigate safely and retorque to manufacturer values if required.',
    },
    {
      ...
      options: [
        'Write only the final answer with no working',
        'Show the working, units and a quick plausibility check',
        'Keep the method in your head and report the result',
        'Round the answer heavily to keep it simple',
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      question: 'You get 3000 A for a small load. What should you check first?',
      options: [
        'The brand of multimeter you are using',
        'Whether the room temperature is correct',
        'Unit conversions and formula rearrangement',
        'The colour coding of the cables involved',
      ],
      correctAnswer: 2,
      explanation: 'Wild results usually come from unit or rearrangement errors.',
    },
    {
      ...
      question: 'Which quick method catches a triangle misread?',
      options: [
        'Write the answer to more decimal places',
        'Repeat the calculation using the same steps',
        'Convert the answer into a different unit',
        'Estimate the order of magnitude with rounded numbers',
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        ...
        'Only the final numerical answer, rounded',
        'A photograph of the equipment involved',
        'The make and model of the calculator used',
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'The wrong formula has been used',
        'Should convert units first',
        'The answer should be divided, not multiplied',
    ...
    },
    {
      ...
      options: [
        'The power should be divided by the time',
        'The wrong formula has been used entirely',
