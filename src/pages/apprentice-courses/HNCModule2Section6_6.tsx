...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Excellent', 'Outstanding', 'A+++', 'Platinum'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Hea (Health and Wellbeing)', 'Man (Management)', 'Pol (Pollution)', 'Ene (Energy)'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Part L1A', 'Part L1B', 'Part L2A', 'Part L2B'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              contractually required (planning conditions, lender requirements, ESG strategy). As
              HNC engineer you sequence Part L compliance first (mandatory), then BREEAM credits
              where they don&rsquo;t add disproportionate cost, then NABERS UK design rating to
              align design intent with measured operational performance.
            </>
          }
        ...
        >
          ...
          <p>
            <strong>
              BREEAM categories and weightings (UK NC 2018) - category / weighting / key credits:
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EPC (asset rating):</strong> Based on design calculations, standard occupancy
              assumptions, valid 10 years, required for sale/let
            </li>
            <li>
              <strong>DEC (operational rating):</strong> Based on actual consumption, reflects real
              operation, valid 1 year, required for public buildings
            </li>
          </ul>
          <p>
        ...
        >
          <p>
            <strong>Example 1 - Part L compliance check:</strong> New office building SBEM results.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Building COMPLIES with Part L 2021</strong>
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Floor area: 3,500 m² (GIA); Electricity: 185,000 kWh/year; Gas: 420,000 kWh/year
            </li>
          ...
          <p>
            <strong>Example 3 - BREEAM energy credits:</strong> Office targeting BREEAM Excellent -
            Ene 01 credits.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>EPRNC = (BER × 1.0 + BBER × 0.5) / (TER × 1.0 + BTBER × 0.5)</li>
            <li>
              Building data: BER 22 kgCO₂/m², TER 28 kgCO₂/m², BBER 115 kWh/m², BTBER 145 kWh/m²
            </li>
            <li>EPRNC = (22 + 57.5) / (28 + 72.5) = 79.5 / 100.5 = 0.79</li>
            <li>EPRNC of 0.79 = 21% improvement over Part L</li>
            <li>
              <strong>5 Ene 01 credits (BREEAM 2018 scoring)</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A 28,000 m² commercial tower in central London is targeting NABERS UK Design Reviewed
              Target Rating of 5 stars (operational energy ≤ 70 kWh/m²·year). The lease structure is
              leveraging NABERS as a tenant attraction. You are the M&amp;E lead from RIBA-2.
            </>
          }
          whatToDo={
            <>
              At Stage-2: lock the form-factor, glazing ratio and orientation with early-stage TM54
              forecasting against the NABERS 5-star envelope. At Stage-3: drive the HVAC strategy
              (typically VRF or 4-pipe FCU + heat recovery + free cooling), lighting LPD, and
              landlord small power. At Stage-4: complete the NABERS UK Design Reviewed Target Rating
              submission with full TM54 backing. At year-1 operation: verify against 12-month
              metered consumption per the NABERS UK Rules. At year-3: re-rate.
            </>
          }
          whyItMatters={
            <>
              NABERS UK 5-star buildings command 5–10% lease premium and lower void rates in central
              London. The rating is operational, not theoretical — so design decisions taken at
              Stage-2 (form factor, services strategy) determine whether 5 stars is achievable. Get
              the NABERS forecast wrong at Stage-2 and the entire commercial proposition is at risk.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">HNC Module 2</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
