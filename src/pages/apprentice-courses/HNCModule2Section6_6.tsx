...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Man (Management)', 'Hea (Health and Wellbeing)', 'Ene (Energy)', 'Pol (Pollution)'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['CIBSE', 'BRE (Building Research Establishment)', 'RIBA', 'BSI'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['UK Government', 'BSRIA and Usable Buildings Trust', 'ASHRAE', 'European Commission'],
    correctAnswer: 1,
    explanation:
