...
const DESCRIPTION =
  'Learn the safety considerations and testing differences between AC and DC electrical systems - isolation, instruments, and procedures.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      'DC arcs self-extinguish faster than AC arcs',
      'DC cannot sustain an arc at low voltages',
      'AC is far more likely to sustain an arc than DC',
  ...
  },
  {
    ...
    options: [
      'A loop impedance tester at the supply intake',
      'A two-pole voltage indicator',
      'An insulation tester at defined DC voltage',
      'A continuity tester at 200 mA',
    ],
    correctIndex: 2,
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Set the instrument to its highest possible range',
      'Remove the fuses from the test leads first',
      'Record the expected reading before measuring',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      'Overload currents above the rated value only',
      'AC residual currents (and some types handle DC components)',
      'Short-circuit faults between line and neutral only',
      'Voltage drop along the final circuit conductors',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Polarity verifies correct termination of line, neutral and protective conductors.',
  },
  {
    id: 7,
    question: 'For PV strings, special consideration includes:',
    options: [
      'Testing live without protection',
      'No labelling required',
      'Only AC testing needed',
      'High DC voltages and arc hazards',
    ],
    correctAnswer: 3,
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Zs/Ze testing assesses AC fault loop to ensure disconnection within required times.',
  },
  {
    id: 9,
    question: 'What CAT rating should instruments have for most electrical installation work?',
    options: [
      'CAT I for low-energy electronic circuits',
      'CAT III for distribution boards and fixed equipment',
      'CAT II for socket-outlet appliances only',
      'No CAT rating is needed for dead testing',
    ],
    correctAnswer: 1,
    explanation:
      'CAT III instruments are required for distribution boards and fixed equipment installations. CAT IV may be needed for supply-side work.',
  },
  {
    id: 10,
    question:
      'When testing insulation resistance on circuits with electronic equipment, you should:',
    options: [
      'Raise the test voltage to 1000 V to overcome them',
      'Leave the electronics connected for a true reading',
      'Disconnect sensitive electronics as per manufacturer guidance',
      'Test at 250 V instead and accept any low reading',
    ],
    correctAnswer: 2,
    explanation:
      'Sensitive electronics should be disconnected before IR testing to prevent damage, following manufacturer instructions for safe disconnection procedures.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "DC current doesn't naturally reduce to zero like AC does (which happens 100 times per second at 50Hz). This means DC arcs can be sustained more easily, making it harder to extinguish them when breaking circuits under load.",
  },
  {
    question: 'Can I use AC instruments on DC systems?',
    answer:
      "Generally no - instruments are designed for specific current types. AC instruments may not read correctly on DC systems and vice versa. Always check the instrument's specifications and use CAT-rated instruments appropriate for the system.",
  },
  {
    question: 'Do RCDs work on DC systems?',
    answer:
      'Standard Type AC RCDs only work on pure AC systems. For systems with DC components (like VFDs, EV chargers), you need Type A, F, or B RCDs depending on the application. Check BS 7671 and manufacturer requirements.',
  },
  {
    question: "What's different about testing PV systems?",
    answer:
      'PV systems can have high DC voltages (up to 1000V or more) and are always live during daylight. Special isolation procedures, DC-rated instruments, and safety precautions are essential. Follow BS 7671 Section 712 and manufacturer guidance.',
  },
  {
    question: 'How do I prove dead on DC systems?',
    answer:
      'Use a suitable DC voltage indicator or multimeter rated for the system voltage. Always prove the instrument on a known live source before and after testing. Consider that some DC systems may have multiple sources (PV, battery, mains-derived).',
  },
  {
    question: 'What about loop impedance testing on DC systems?',
    answer:
      "Traditional AC loop impedance testing doesn't apply to DC systems. Instead, follow manufacturer data for fault current calculations and protective device selection. Some DC systems may require specialist testing equipment.",
  },
];
      ...
      <div className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
          <p className="text-sm text-white leading-relaxed">
            ...
            appropriate RCD type (AC/A/F/B) where DC components exist.
          </p>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              ...
              sources in modern installations.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <p className="text-elec-yellow">
                  <strong>Universal Rule:</strong> Always isolate, lock‑off, tag and prove dead
                  before starting work. Use a proving unit and prove before/after testing.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-1 text-sm">
                <li>
                  <strong>DC Arc Hazards:</strong> DC may sustain arcs more readily than AC - use
                  DC‑rated switches, fuses and breakers
                </li>
                <li>
                  <strong>Multiple Sources:</strong> PV, battery, mains - each needs separate
                  isolation and clear labelling
                </li>
                <li>
                  <strong>Instrument Rating:</strong> Confirm CAT III/IV rating appropriate for
                  voltage/current ranges
                </li>
                <li>
                  <strong>PPE Selection:</strong> Use PPE suitable for the arc risk, especially on
                  DC and battery systems
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-4 text-white">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Continuity:</strong> Applies to both - ensure correct conductor
                    connections
                  </li>
                  <li>
                    <strong>Polarity:</strong> L/N/PE for AC, +/−/PE for DC systems
                  </li>
                  <li>
                    <strong>Insulation Resistance:</strong> Uses DC test set at defined voltages
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-3">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Loop Impedance (Zs/Ze):</strong> For AC ADS disconnection calculations
                  </li>
                  <li>
                    <strong>RCD Testing:</strong> AC systems with correct type selection (AC/A/F/B)
                  </li>
                  <li>
                    <strong>Phase Sequence:</strong> Three-phase motor rotation
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
              <p className="text-yellow-300">
                <strong>Important:</strong> For DC systems, traditional loop impedance testing
                doesn't apply. Instead, use manufacturer data for fault current paths and protective
                device selection.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4 text-white">
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Insulation Tester:</strong> Selectable DC test voltages (250/500/1000V
                    as specified)
                  </li>
                  <li>
                    <strong>Loop Tester:</strong> Suitable for system type and prospective fault
                    current ranges
                  </li>
                  <li>
                    <strong>RCD/RCBO Tester:</strong> Compatible with device type (AC/A/F/B)
                  </li>
                  <li>
                    <strong>DC Clamp Meter:</strong> For battery, PV and control circuits where
                    needed
                  </li>
                  <li>
                    <strong>Proving Unit:</strong> To verify voltage indicators before and after use
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="list-disc pl-4 space-y-1 text-sm text-white">
                  ...
                  <li>
                    <strong>CAT IV:</strong> Supply side, meters, primary equipment - higher energy
                    systems
                  </li>
                  <li>
                    <strong>Voltage Rating:</strong> Must exceed maximum system voltage (e.g. 1000V
                    for PV)
                  </li>
                  <li>
                    <strong>Current Rating:</strong> Appropriate for expected measurements
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="space-y-4 text-white">
            ...
            <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <p className="text-elec-yellow">
                  <strong>Remember:</strong> Always follow BS 7671 Part 7 requirements and
                  manufacturer instructions for special installations. When in doubt, seek
                  specialist advice.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <ul className="list-disc pl-4 space-y-2 text-sm text-white">
                  ...
                  <li>
                    <strong>Inadequate CAT rating:</strong> Using instruments not rated for the
                    system voltage
                  </li>
                  <li>
                    <strong>Skipping proving:</strong> Not proving instruments dead before and after
                    testing
                  </li>
                  <li>
                    <strong>Damaging electronics:</strong> IR testing live electronics without
                    disconnection
                  </li>
                  <li>
                    <strong>Poor documentation:</strong> Not recording serial numbers, cal dates, or
                    results properly
                  </li>
                </ul>
              </div>
            ...
            <div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <ul className="list-disc pl-4 space-y-2 text-sm text-elec-yellow/80">
                  <li>
                    <strong>Learn BS 7671 Part 6:</strong> Testing requirements and acceptable
                    values
                  </li>
                  <li>
                    <strong>Study Guidance Note 3:</strong> Detailed testing procedures and safety
                  </li>
                  <li>
                    <strong>Practice with instruments:</strong> Become familiar with different test
                    equipment
                  </li>
                  <li>
                    <strong>Understand limitations:</strong> Know when specialist equipment or
                    advice is needed
                  </li>
                  <li>
                    <strong>Stay updated:</strong> New technologies require new testing approaches
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-3 rounded-lg">
                ...
                <ul className="space-y-1 text-elec-yellow/80 text-xs">
                  <li>
                    • <strong>Isolate:</strong> Lock-off all sources
                  </li>
                  <li>
                    • <strong>Prove dead:</strong> Before & after with proving unit
                  </li>
                  <li>
                    • <strong>CAT rating:</strong> III/IV for voltage range
                  </li>
                  <li>
                    • <strong>DC arcs:</strong> Use DC-rated switching
                  </li>
                  <li>
                    • <strong>Label:</strong> Multiple sources clearly
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                ...
                <ul className="space-y-1 text-white text-xs">
                  ...
                  <li>
                    • <strong>EV (722):</strong> DC components, RCD type
                  </li>
                  <li>
                    • <strong>BESS:</strong> High current, ventilation
                  </li>
                  <li>
                    • <strong>UPS:</strong> Multiple sources, isolation
                  </li>
                  <li>
                    • <strong>VFD:</strong> Harmonics, disconnect for IR
                  </li>
                </ul>
              </div>
            </div>
