    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>THD limit:</strong> 8% voltage THD at LV (G5/5)
              </li>
              <li className="pl-1">
                <strong>Voltage tolerance:</strong> ±10% of nominal (EN 50160)
              </li>
              <li className="pl-1">
                <strong>Power factor:</strong> Target &gt;0.95 to avoid penalties
              </li>
              <li className="pl-1">
                <strong>Flicker:</strong> Pst ≤1.0 threshold of irritability
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>G5/5:</strong> UK harmonic limits and assessment
              </li>
              <li className="pl-1">
                <strong>EN 50160:</strong> Voltage characteristics
              </li>
              <li className="pl-1">
                <strong>IEC 61000:</strong> EMC and immunity levels
              </li>
              <li className="pl-1">
                <strong>BS EN 61642:</strong> Capacitor bank protection
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              whether equipment operates correctly without interference or damage. Poor power
              quality can cause equipment malfunction, reduced efficiency, overheating, and
              premature failure.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Voltage magnitude:</strong> Steady-state level compared to nominal
                  (230V/400V)
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              £150-200 million annually through equipment damage, downtime, and reduced
              productivity.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              multiples of the fundamental supply frequency (50Hz). They are generated by non-linear
              loads that draw current in pulses rather than smoothly throughout the cycle.
            </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                G5/5 Individual Harmonic Limits at 400V
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              add in the neutral conductor - neutral current can exceed phase current in
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Large load switching off, SLG faults
                      </td>
                      <td className="border border-white/10 px-3 py-2">10ms to 1 minute</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Overloaded circuits, long cables
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Incorrect tap settings, light load
                      </td>
                      <td className="border border-white/10 px-3 py-2">&gt;1 minute</td>
                    </tr>
                  </tbody>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Flicker sources:</strong> Arc furnaces, welders, large motor starting,
                  wind turbines
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Voltage Dip Classification (ITIC/CBEMA)
              </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Sensitive equipment:</strong> PLCs, variable speed drives, and IT equipment
              are particularly sensitive to voltage dips and may require UPS protection or voltage
              conditioning.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Power factor is the ratio of real power (kW) to apparent power (kVA). A low power
              factor means more current is required to deliver the same real power, increasing
              losses, requiring larger equipment, and potentially attracting utility penalties.
            </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Capacitor banks, synchronous motors
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Central or distributed PFC
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Harmonics</td>
                      <td className="border border-white/10 px-3 py-2">
                        Passive filters, active filters, 12/18-pulse drives
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        SVCs, STATCOMs, dedicated feeders
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Oversized neutral, zig-zag transformer
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Single-phase non-linear loads
                      </td>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Parameters measured:</strong> V, I, P, Q, S, PF, THD, harmonics,
                  dips/swells, flicker
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Monitoring period:</strong> Minimum 7 days recommended for baseline
                  assessment
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: THD Compliance Assessment
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Power Factor Correction Sizing
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Neutral Current with Triplen Harmonics
              </h3>
              <p className="text-sm text-white mb-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Power Quality Assessment Checklist
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Install power quality analyser for minimum 7-day monitoring period
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Standard capacitors with VSDs</strong> - Always use detuned banks to
                  prevent resonance
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Over-correction of PF</strong> - Can cause leading power factor and
                  voltage rise
                </li>
              </ul>
            </div>
