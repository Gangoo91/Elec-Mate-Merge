...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Linear loads', 'Capacitive loads', 'Inductive loads', 'Resistive loads'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['7th harmonic', '3rd harmonic', '5th harmonic', '11th harmonic'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['THD and TDD', 'kVAr and cosφ', 'Pst (short-term) and Plt (long-term)', 'dB and Hz'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['±5% of nominal', '±15% of nominal', '±6% of nominal', '±10% of nominal'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="Power Quality Fundamentals">
          <p>
            Power quality refers to the characteristics of the electrical supply that determine
            whether equipment operates correctly without interference or damage. Poor power quality
            can cause equipment malfunction, reduced efficiency, overheating, and premature failure.
          </p>
          <p>
            <strong>Key power quality parameters:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Voltage magnitude:</strong> Steady-state level compared to nominal (230V/400V)
            </li>
            <li>
              <strong>Frequency:</strong> Deviation from nominal 50Hz (typically ±1%)
            </li>
            <li>
              <strong>Waveform distortion:</strong> Deviation from ideal sinusoidal (harmonics)
            </li>
            <li>
              <strong>Voltage variations:</strong> Dips, swells, interruptions, flicker
            </li>
            <li>
              <strong>Voltage unbalance:</strong> Asymmetry between phases (typically &lt;2%)
            </li>
          </ul>
          <p>
            <strong>EN 50160 Voltage Characteristics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply voltage:</strong> ±10% of Uₙ (207V-253V) — 95% of 10-min values/week
            </li>
            <li>
              <strong>Frequency:</strong> ±1% (49.5Hz-50.5Hz) — 99.5% of year
            </li>
            <li>
              <strong>Voltage THD:</strong> ≤8% — 95% of 10-min values/week
            </li>
            <li>
              <strong>Voltage unbalance:</strong> ≤2% — 95% of 10-min values/week
            </li>
            <li>
              <strong>Flicker Plt:</strong> ≤1.0 — 95% of week
            </li>
          </ul>
          <p>
            <strong>Industry impact:</strong> Power quality issues cost UK industry an estimated
            £150-200 million annually through equipment damage, downtime, and reduced productivity.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Harmonic Distortion">
          <p>
            Harmonics are sinusoidal voltages or currents at frequencies that are integer multiples
            of the fundamental supply frequency (50Hz). They are generated by non-linear loads that
            draw current in pulses rather than smoothly throughout the cycle.
          </p>
          <p>
            <strong>Common Harmonic Sources</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Effects of Harmonics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Total Harmonic Distortion (THD) Calculation</strong>
          </p>
          <p>THD = √(V₂² + V₃² + V₄² + ... + Vₙ²) / V₁ × 100%</p>
          <p>Where V₁ = fundamental, V₂, V₃... = harmonic magnitudes</p>
          <p>
            <strong>Example:</strong> If V₁=230V, V₅=12V, V₇=8V, V₁₁=4V:
          </p>
          <p>THD = √(12² + 8² + 4²) / 230 × 100%</p>
          <p>THD = √(144 + 64 + 16) / 230 × 100%</p>
          <p>THD = 6.5% (within 8% limit)</p>
          <p>
            <strong>G5/5 Individual Harmonic Limits at 400V</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>3rd:</strong> 150Hz — 4% — 5%
            </li>
            <li>
              <strong>5th:</strong> 250Hz — 5% — 6%
            </li>
            <li>
              <strong>7th:</strong> 350Hz — 4% — 5%
            </li>
            <li>
              <strong>11th:</strong> 550Hz — 3% — 3.5%
            </li>
            <li>
              <strong>Total THD:</strong> - — 8% — 8%
            </li>
          </ul>
          <p>
            <strong>Triplen harmonics:</strong> The 3rd, 9th, 15th harmonics are zero-sequence and
            add in the neutral conductor - neutral current can exceed phase current in single-phase
            non-linear loads.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Voltage Variations and Flicker">
          ...
          <p>
            <strong>Voltage Variation Types</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Voltage dip (sag):</strong> 1% to 90% of Uₙ — Faults, large motor starting —
              10ms to 1 minute
            </li>
            <li>
              <strong>Voltage swell:</strong> 110% to 180% of Uₙ — Large load switching off, SLG
              faults — 10ms to 1 minute
            </li>
            <li>
              <strong>Interruption:</strong> &lt;1% of Uₙ — Faults, protection operation — 10ms to 3
              minutes
            </li>
            <li>
              <strong>Undervoltage:</strong> &lt;90% of Uₙ sustained — Overloaded circuits, long
              cables — &gt;1 minute
            </li>
            <li>
              <strong>Overvoltage:</strong> &gt;110% of Uₙ sustained — Incorrect tap settings, light
              load — &gt;1 minute
            </li>
          </ul>
          <p>
            <strong>Flicker Measurement</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pst (short-term):</strong> Measured over 10 minutes, Pst ≤1.0 required
            </li>
            <li>
              <strong>Plt (long-term):</strong> Calculated from 12 consecutive Pst values over 2
              hours
            </li>
            <li>
              <strong>Flicker sources:</strong> Arc furnaces, welders, large motor starting, wind
              turbines
            </li>
            <li>
              <strong>Human perception:</strong> Most sensitive to voltage changes at 8.8Hz
              frequency
            </li>
          </ul>
          <p>
            <strong>Voltage Dip Classification (ITIC/CBEMA)</strong>
          </p>
          <p>
            <strong>Region A:</strong> Equipment should operate without interruption
          </p>
          <p>
            <strong>Region B:</strong> Equipment may malfunction but should not be damaged
          </p>
          <p>
            <strong>Region C:</strong> Equipment may be damaged
          </p>
          <p>
            Example: A 70% dip lasting 100ms falls in Region B - computers may reset but should not
            be damaged.
          </p>
          <p>
            <strong>Sensitive equipment:</strong> PLCs, variable speed drives, and IT equipment are
            particularly sensitive to voltage dips and may require UPS protection or voltage
            conditioning.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Power Factor and Mitigation Measures">
          <p>
            ...
            means more current is required to deliver the same real power, increasing losses,
            requiring larger equipment, and potentially attracting utility penalties.
          </p>
          <p>
            <strong>Power Factor Relationships</strong>
          </p>
          <p>Power Factor (PF) = P / S = kW / kVA = cosφ</p>
          <p>Reactive Power: Q = S × sinφ (kVAr)</p>
          <p>Apparent Power: S = √(P² + Q²)</p>
          <p>
            <strong>Example:</strong> 100kW load at PF 0.8 lagging:
          </p>
          ...
          <p>
            <strong>Mitigation Measures Summary</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Low power factor:</strong> Capacitor banks, synchronous motors — Central or
              distributed PFC
            </li>
            <li>
              <strong>Harmonics:</strong> Passive filters, active filters, 12/18-pulse drives — At
              source or central
            </li>
            <li>
              <strong>Voltage dips:</strong> UPS, DVR, soft starters — Sensitive equipment
              protection
            </li>
            <li>
              <strong>Flicker:</strong> SVCs, STATCOMs, dedicated feeders — Large fluctuating loads
            </li>
            <li>
              <strong>Neutral overload:</strong> Oversized neutral, zig-zag transformer —
              Single-phase non-linear loads
            </li>
          </ul>
          <p>
            <strong>Passive Harmonic Filters</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Active Harmonic Filters</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Power Quality Monitoring Equipment</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Power quality analysers:</strong> Fluke 435-II, Hioki PQ3100, Dranetz
            </li>
            <li>
              <strong>Parameters measured:</strong> V, I, P, Q, S, PF, THD, harmonics, dips/swells,
              flicker
            </li>
            <li>
              <strong>Standards compliance:</strong> Class A to IEC 61000-4-30 for contractual
              measurements
            </li>
            <li>
              <strong>Monitoring period:</strong> Minimum 7 days recommended for baseline assessment
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Calculate capacitor bank size to improve power factor from
            0.75 to 0.95.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Voltage THD limit: <strong>8%</strong> at LV (G5/5)
            </li>
            <li>
              Voltage tolerance: <strong>±10%</strong> of nominal (EN 50160)
            </li>
            <li>
              Target power factor: <strong>&gt;0.95</strong> to avoid penalties
            </li>
            <li>
              Flicker limit: <strong>Pst ≤1.0</strong>
            </li>
            <li>
              5th harmonic limit: <strong>5%</strong> planning level
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Standard capacitors with VSDs</strong> - Always use detuned banks to prevent
                resonance
              </li>
              <li>
                <strong>Undersized neutrals</strong> - Size for triplen harmonics in single-phase
                loads
              </li>
              <li>
                <strong>Ignoring displacement vs total PF</strong> - Harmonics reduce total power
                factor
              </li>
              <li>
                <strong>Over-correction of PF</strong> - Can cause leading power factor and voltage
                rise
              </li>
            </ul>
          }
