...
const quickCheckQuestions = [
  {
    ...
    options: ['Q = hA(Ts - T∞)', 'Q = kA(ΔT/L)', 'Q = εσAT⁴', 'Q = mcΔT'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['500-10,000 W/m²K', '50,000-100,000 W/m²K', '5-25 W/m²K', '25-250 W/m²K'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['50 W/m²K', '100 W/m²K', '500 W/m²K', '250 W/m²K'],
    correctAnswer: 3,
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE Guide A is the UK reference for convective h values in building services design.
              The choice of coefficient must match the assumed flow regime — natural vs forced — and
              the surface orientation. Generic coefficients lead to generically wrong answers.
            </>
          }
        ...
        >
          ...
          <p>
            <strong>Worked example:</strong> A panel radiator has a surface area of 1.8m², operates
            at 65°C in a room at 21°C, with h = 8 W/m²K. Calculate the convective heat output.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Q = hA(Ts - T∞)</li>
            <li>Q = 8 × 1.8 × (65 - 21)</li>
          ...
          <p>
            <strong>Remember:</strong> The temperature difference drives heat transfer - increasing
            supply temperature or reducing room temperature increases output.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Total R = 0.13 + 0.132 + 0.18 + 0.526 + 0.078 + 0.04 = <strong>1.086 m²K/W</strong>
            </li>
            <li>
        ...
        >
          <p>
            <strong>Panel radiators:</strong> Despite their name, panel radiators transfer 50-70% of
            heat by convection. The panel warms adjacent air, which rises and is replaced by cooler
            air from below.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Heating and cooling coils:</strong> Coils in AHUs and fan coil units use forced
            convection to transfer heat between air and water/refrigerant. Design involves
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Convective output: Q = hAΔT = 10 × 1.68 × 40 = <strong>672W convective</strong>
            </li>
            <li>
              If this is 65% of total: Total output = 672/0.65 = <strong>~1034W total</strong>
            </li>
          </ul>
          <p>
            <strong>Example 2 - heating coil sizing:</strong> A heating coil must raise 1.5 m³/s of
            air from 5°C to 22°C. LTHW at 80/60°C is available. If overall U = 45 W/m²K and LMTD =
            52K, what coil area is required?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ΔP = ρ × g × h × (Ti - To)/To (using ρ = 1.2 kg/m³, g = 9.81 m/s², To in Kelvin)
            </li>
            <li>ΔP = 1.2 × 9.81 × 15 × (22-5)/(273+5)</li>
            <li>
              ΔP = 176.6 × 17/278 = <strong>10.8 Pa</strong>
            </li>
        ...
        <Scenario
          ...
          situation={
            <>
              You are sizing fan-coil units for an open-plan office with a 6 kW cooling load per
              zone. The design supplies 12 °C chilled water with a 6 K rise. The air-side delta-T at
              the coil is 11 K (room 24 °C, off-coil 13 °C).
            </>
          }
          whatToDo={
            <>
              Apply Q = hA·ΔT on both sides of the coil. Manufacturer data gives the overall U·A for
              the coil (combined water-side and air-side h). Cross-check the air-side LMTD
              calculation matches the manufacturer&rsquo;s rated capacity at your design conditions.
              Allow margin for fouling factor (typically 10% derating). Document the selection —
              duty, water flow, air flow, dB(A) — in the equipment schedule.
            </>
          }
          whyItMatters={
            <>
              A fan-coil that rated correctly on paper but does not transfer heat as expected at
              site conditions creates a complaints trail and a re-engineering bill. Newton&rsquo;s
              law of cooling drives the calculation that prevents it.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Conduction</div>
          </button>
          <button
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Radiation</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
