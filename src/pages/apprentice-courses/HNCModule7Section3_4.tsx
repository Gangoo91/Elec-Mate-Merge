...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['UGR ≤ 16', 'UGR ≤ 28', 'UGR ≤ 22', 'UGR ≤ 19'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['UGR ≤ 25', 'UGR ≤ 16', 'UGR ≤ 19', 'UGR ≤ 28'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['UGR ≤ 16', 'UGR ≤ 22', 'UGR ≤ 19', 'UGR ≤ 25'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Discomfort glare', 'Contrast glare', 'Reflected glare', 'Disability glare'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="Glare Fundamentals">
          <p>
            Glare is the visual discomfort or impairment caused by excessive luminance contrast in
            the field of view. In lighting design, understanding and controlling glare is essential
            for creating comfortable, productive visual environments that comply with workplace
            standards.
          </p>
          <p>
          ...
          <p>
            <strong>Discomfort Glare</strong>
          </p>
          ...
          <p>
            <strong>Disability Glare</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Glare Sources in Interior Lighting</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Direct glare:</strong> Luminaire lamps/optics — Shielding, louvres,
              positioning
            </li>
            <li>
              <strong>Reflected glare:</strong> Specular surfaces, screens — Luminaire positioning,
              matte finishes
            </li>
            <li>
              <strong>Veiling reflections:</strong> Glossy task surfaces — Indirect lighting, task
              orientation
            </li>
            <li>
              <strong>Daylight glare:</strong> Windows, skylights — Blinds, shading, orientation
            </li>
          </ul>
          <p>
            <strong>Design principle:</strong> Glare depends on the luminance of the source, its
            size, position in the field of view, and the background luminance. UGR provides a
            standardised way to evaluate these factors together.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Unified Glare Rating (UGR)">
          <p>
            ...
            a standardised numerical assessment of discomfort glare from luminaires in indoor
            spaces, enabling designers to predict visual comfort before installation.
          </p>
          <p>
            <strong>UGR Formula</strong>
          </p>
          ...
          <p>
            <strong>Factors Increasing UGR</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Factors Decreasing UGR</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>UGR Limits by Application (BS EN 12464-1)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Technical drawing:</strong> ≤ 16 — Precision visual tasks, fine detail
            </li>
            <li>
              <strong>Offices, classrooms:</strong> ≤ 19 — Reading, writing, screen work
            </li>
            <li>
              <strong>Industrial, fine work:</strong> ≤ 19 — Assembly, inspection tasks
            </li>
            <li>
              <strong>Industrial, medium work:</strong> ≤ 22 — General manufacturing
            </li>
            <li>
              <strong>Retail, general:</strong> ≤ 22 — Varied viewing directions
            </li>
            <li>
              <strong>Industrial, rough work:</strong> ≤ 25 — Heavy industry, storage
            </li>
            <li>
              <strong>Corridors, stairs:</strong> ≤ 28 — Transient occupation
            </li>
          </ul>
          <p>
            <strong>Important:</strong> UGR is calculated for specific observer positions and
            viewing directions. Design software evaluates UGR across a grid to ensure compliance
        ...
        <ConceptBlock title="Shielding Angles and Luminaire Selection">
          <p>
            The shielding angle is the angle measured from horizontal below which the lamp is hidden
            from direct view. Effective shielding prevents high-luminance lamp surfaces from
            contributing to glare at normal viewing angles.
          </p>
          <p>
            <strong>Shielding Angle Definition</strong>
          </p>
          <p>
            The shielding angle (γ) is measured from horizontal to the line from the edge of the
            luminaire aperture to the lamp.
          </p>
          <p>γ = arctan(d / h)</p>
          <p>
            Where: d = horizontal distance from lamp to aperture edge, h = vertical depth of recess
          </p>
          <p>
            A shielding angle of 30° means the lamp is not visible when viewing the luminaire at
            angles less than 30° above horizontal.
          </p>
          <p>
            <strong>Minimum Shielding Angles by Lamp Luminance</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>20,000 - 50,000:</strong> 15° — Fluorescent tubes
            </li>
            <li>
              <strong>50,000 - 500,000:</strong> 20° — Compact fluorescent, some LED
            </li>
            <li>
              <strong>&gt; 500,000:</strong> 30° — High-intensity LED, halogen
            </li>
          </ul>
          <p>
            <strong>Louvred Luminaires</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Micro-Prismatic Diffusers</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Recessed Luminaires</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>VDU Workstation Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Maximum luminaire luminance: <strong>3,000 cd/m² at 65°</strong> from vertical
            </li>
          ...
          <p>
            <strong>Selection tip:</strong> Compare UGR values from luminaire datasheets at
            equivalent room conditions. A luminaire with UGR 16 in standard conditions may achieve
            UGR 19 compliance more easily than one rated UGR 19.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="UGR Tables and Design Compliance">
          <p>
            Manufacturers provide UGR tables showing glare ratings for their luminaires across a
            range of room sizes and surface reflectances. Understanding how to read and apply these
            tables is essential for early-stage luminaire selection.
          </p>
          <p>
            <strong>Example UGR Table Structure</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2H : 2H:</strong> 16.2 — 17.5 — 18.1
            </li>
            <li>
              <strong>4H : 4H:</strong> 18.4 — 19.7 — 20.3
            </li>
            <li>
              <strong>8H : 4H:</strong> 19.1 — 20.4 — 21.0
            </li>
            <li>
              <strong>12H : 12H:</strong> 19.8 — 21.1 — 21.7
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Reading UGR Tables</strong>
          </p>
          <p>
            <strong>Step 1:</strong> Calculate room dimensions as multiples of H (mounting height
            above eye level)
          </p>
          <p>
            <strong>Step 2:</strong> Determine surface reflectances (ceiling/walls/floor as
            percentages)
          </p>
          <p>
            <strong>Step 3:</strong> Find the row matching your room dimensions
          </p>
          <p>
            <strong>Step 4:</strong> Find the column matching your reflectances
          </p>
          <p>
            <strong>Step 5:</strong> Compare the value against your UGR limit requirement
          </p>
          <p>
            <strong>Typical Surface Reflectances</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ceiling:</strong> White painted plaster — 70-80
            </li>
            <li>
              <strong>Ceiling:</strong> White suspended tiles — 70-85
            </li>
            <li>
              <strong>Walls:</strong> Light colours — 50-70
            </li>
            <li>
              <strong>Walls:</strong> Medium colours — 30-50
            </li>
            <li>
              <strong>Floor:</strong> Light carpet/vinyl — 20-40
            </li>
            <li>
              <strong>Floor:</strong> Dark carpet — 10-20
            </li>
          </ul>
          <p>
            <strong>Glare Control Strategies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Luminaire selection:</strong> Choose luminaires with appropriate UGR ratings
              for the application
            </li>
            <li>
              <strong>Increase reflectances:</strong> Light-coloured surfaces raise background
              luminance, reducing UGR
            </li>
            <li>
              <strong>Positioning:</strong> Avoid placing luminaires directly in primary viewing
              directions
            </li>
            <li>
              <strong>Mounting height:</strong> Greater height reduces solid angle and apparent
              luminance
            </li>
            <li>
              <strong>Indirect lighting:</strong> Uplighting reduces direct glare but may require
              higher installed power
            </li>
            <li>
              <strong>Task lighting:</strong> Localised lighting allows lower ambient levels
            </li>
          </ul>
          <p>
            <strong>Design verification:</strong> While UGR tables provide initial guidance, always
            verify compliance using lighting design software that calculates UGR at multiple
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Assess UGR suitability for a 12m × 8m open-plan office with
            2.8m ceiling height.
          </p>
          <p>Given data:</p>
          ...
          <p>
            <strong>Scenario:</strong> A classroom design shows UGR 21, but the limit is UGR ≤ 19.
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Technical drawing: <strong>UGR ≤ 16</strong>
            </li>
            <li>
              Offices, classrooms: <strong>UGR ≤ 19</strong>
            </li>
            <li>
              Industrial (fine): <strong>UGR ≤ 19</strong>
            </li>
            <li>
              Retail, industrial (medium): <strong>UGR ≤ 22</strong>
            </li>
            <li>
              Corridors, warehouses: <strong>UGR ≤ 28</strong>
            </li>
            <li>
              VDU areas: <strong>3,000 cd/m² at 65°</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Using single UGR value:</strong> Tables show ranges - select appropriate
                room/reflectance conditions
              </li>
              <li>
                <strong>Ignoring viewing direction:</strong> UGR varies with observer position and
                direction
              </li>
              <li>
                <strong>Forgetting VDU criteria:</strong> Screen areas have additional luminance
                limits beyond UGR
              </li>
              <li>
                <strong>Over-relying on louvres:</strong> Excessive shielding reduces efficiency and
                may cause dark ceilings
              </li>
            </ul>
          }
