...
const TITLE =
  'Checking Fixings, Cable Routes, and Terminations - Module 4.6.4 | Level 2 Electrical Course';
const DESCRIPTION =
  'Master the final inspection techniques for electrical installations. Learn to verify secure fixings, safe cable routes, and reliable terminations for BS 7671 compliance.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Safe wiring zones protect cables from accidental damage during building work by defining specific areas where cables should be routed, such as vertically and horizontally from outlets.',
  },
  {
    id: 2,
...
const Module4Section6_4 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Over-tightening can damage conductors, strip threads, or crack terminals, all of which reduce connection integrity and can lead to loose connections over time.',
    },
    {
      id: 6,
  ...
  const faqs = [
    {
      ...
      answer:
        "No — cables must follow vertical or horizontal safe zones unless mechanically protected. Diagonal routing increases the risk of accidental damage during building work and doesn't comply with BS 7671 requirements for cable protection.",
    },
    {
      question: 'Is it acceptable to leave a small amount of copper visible outside the terminal?',
      answer:
        'No — exposed copper increases the risk of short circuits and should be avoided. All bare conductor should be contained within the terminal, with only the insulated portion visible outside.',
    },
    {
      question: 'Do I need to check fixings if the containment system feels solid?',
      answer:
        'Yes — visual and physical checks are essential, as internal fixings may still be loose or unsuitable. A system that feels solid on the surface may have individual fixing points that are compromised.',
    },
    {
      question: 'What spacing should be maintained for containment system supports?',
      answer:
        'Follow manufacturer guidance and BS 7671 requirements. Typical spacing is 1.5m for steel conduit, 1m for PVC conduit, and varies for trunking and cable tray depending on size and loading.',
    },
    {
      question: 'How do I verify that cable routes follow safe zones in finished installations?',
      answer:
        'Use cable detection equipment to trace routes, check installation drawings, and verify that visible cable entry/exit points align with safe zone requirements. Any deviations should be investigated and corrected.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-white/80">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    Final inspection ensures secure fixings, safe cable routes, and reliable
                    terminations
                  </li>
                  <li>
                    Incorrect fixings or poor terminations can cause safety hazards and equipment
                    damage
                  </li>
                  <li>
                    Compliance with BS 7671 requires systematic checking of all installation
                    elements
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Spot:</strong> Loose fixings, unsafe cable routes, faulty terminations
                  </li>
                  <li>
                    <strong>Use:</strong> Torque screwdrivers, cable detectors, inspection
                    procedures
                  </li>
                  <li>
                    <strong>Check:</strong> Safe zones, secure connections, mechanical integrity
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-white/80">
              ...
              <li>
                Confirm that all terminations are correctly stripped, connected, and tightened
              </li>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Surface compatibility:</strong> Ensure screws, clips, saddles, or brackets
                  are appropriate for the mounting surface.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                  <li>
                    Masonry fixings: Use appropriate plugs or anchors for concrete/brick walls
                  </li>
                  <li>Plasterboard fixings: Use cavity fixings or locate studs for heavy loads</li>
                  <li>
                    Metal surface fixings: Use self-tapping screws or through-bolts as appropriate
                  </li>
                  <li>Wooden fixings: Use wood screws of appropriate length and gauge</li>
                </ul>
                <p className="text-sm mb-2">
                  <strong>Tightness verification:</strong> Fixings should be tight but not
                  over-torqued to avoid damage.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <div className="text-sm p-2 rounded bg-white/5 border border-white/10">
                  <strong>Containment support:</strong> Brackets and supports for conduit, trunking,
                  and tray must follow manufacturer spacing guidance
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Prescribed zones:</strong> Cables should follow pre-planned safe wiring
                  zones as per Building Regulations Part P.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                  <li>
                    Horizontal zones: Within 150mm of room edges and junction of walls/ceiling
                  </li>
                  <li>
                    Vertical zones: Within 150mm either side of switches, sockets, and outlets
                  </li>
                ...
                <p className="text-sm mb-2">
                  <strong>Environmental considerations:</strong> Route cables away from hazards and
                  maintain proper separation.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                  <li>
                    Avoid routing near heat sources unless cables are rated for high temperatures
                  </li>
                ...
                <div className="text-sm p-2 rounded bg-white/5 border border-white/10">
                  <strong>Protection methods:</strong> Use appropriate barriers for cables passing
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Stripping and preparation:</strong> Cable ends should be stripped to the
                  correct length with no exposed copper.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="text-sm mb-2">
                  <strong>Connection security:</strong> Conductors must be fully inserted and
                  securely clamped.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <div className="text-sm p-2 rounded bg-white/5 border border-white/10">
                  <strong>Testing security:</strong> Gently tug cables at terminations to ensure
                  they are secure
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Connection testing:</strong> Verify security without damaging components.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="text-sm mb-2">
                  <strong>Visual inspection:</strong> Look for signs of damage or deterioration.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <div className="text-sm p-2 rounded bg-white/5 border border-white/10">
                  <strong>Documentation:</strong> Record any defects found and remedial actions
                  taken
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-lg border border-green-400/30 bg-green-500/5">
                ...
                <ul className="text-sm text-white/80 space-y-1 list-disc pl-4">
                  ...
                  <li>
                    <strong>2. Mechanical testing:</strong> Gently test fixing security and
                    termination tightness
                  </li>
                  <li>
                    <strong>3. Route verification:</strong> Use cable detector to confirm hidden
                    cable paths follow safe zones
                  </li>
                  <li>
                    <strong>4. Documentation:</strong> Record findings, defects, and remedial
                    actions on inspection sheets
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg border border-amber-400/30 bg-amber-500/5">
                ...
                <ul className="text-sm text-white/80 space-y-1 list-disc pl-4">
                  ...
                  <li>
                    <strong>Socket outlets:</strong> Ensure back boxes are secure, terminals tight,
                    and earth continuity maintained
                  </li>
                  <li>
                    <strong>Light fittings:</strong> Check ceiling fixings can support weight,
                    terminals secure, and earth connections made
                  </li>
                  <li>
                    <strong>Junction boxes:</strong> Verify all connections are accessible, secure,
            ...
            <div className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  ...
                  <ul className="space-y-1 text-sm text-white/80 list-disc pl-4">
                    ...
                    <li>
                      <strong>Proper tightness:</strong> Hand-tight plus quarter turn for plastic
                      fixings
                    </li>
                    <li>
                      <strong>Support spacing:</strong> Follow manufacturer guidance
                    </li>
                    <li>
                      <strong>Load verification:</strong> Ensure fixings can handle loads
                    </li>
                  </ul>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-1 text-sm text-white/80 list-disc pl-4">
                    ...
                    <li>
                      <strong>Vertical zones:</strong> Within 150mm either side of switches/sockets
                    </li>
                    <li>
                      <strong>No diagonal routing:</strong> Unless mechanically protected
                    </li>
                    <li>
                      <strong>Protection methods:</strong> Grommets, sleeves, conduit for wall
                      penetrations
                    </li>
                  </ul>
                </div>
              ...
              <div className="p-4 rounded-lg border border-elec-yellow/20 bg-elec-yellow/5">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  ...
                  <p>
                    <strong>Chapter 52:</strong> Wiring systems must be selected and erected to
                    avoid damage during expected service life
                  </p>
                  <p>
                    <strong>Building Regulations Part P:</strong> Cable routes must follow
                    prescribed safe zones unless mechanically protected
                  </p>
                </div>
              </div>
