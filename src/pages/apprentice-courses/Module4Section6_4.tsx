      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">1. Checking Fixings</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Tightness verification:</strong> Fixings should be tight but not over-torqued to avoid damage.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">2. Cable Route Verification</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Prescribed zones:</strong> Cables should follow pre-planned safe wiring zones as per Building Regulations Part P.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Environmental considerations:</strong> Route cables away from hazards and maintain proper separation.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
          ...
          {/* Termination Checks */}
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">3. Termination Checks</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Connection security:</strong> Conductors must be fully inserted and securely clamped.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">4. Testing Mechanical Security</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Visual inspection:</strong> Look for signs of damage or deterioration.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
              <h3 className="font-medium text-white mb-2">Inspection Sequence</h3>
              <div className="text-xs sm:text-sm text-white space-y-2">
            ...
            <div className="rounded-lg p-4 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800">
              <h3 className="font-medium text-white mb-2">Common Inspection Points</h3>
              <div className="text-xs sm:text-sm text-white space-y-2">
            ...
            <div className="rounded-lg p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
              <h3 className="font-medium text-white mb-2">Professional Tips</h3>
              <div className="text-xs sm:text-sm text-white space-y-2">
            ...
            <div className="rounded-lg p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
              <h3 className="font-medium text-white mb-2">Safety Reminders</h3>
              <div className="text-xs sm:text-sm text-white space-y-2">
            ...
            <div className="rounded-lg p-4 bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-200 dark:border-cyan-800">
              <h3 className="font-medium text-white mb-2">Quality Assurance Checklist</h3>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">Example Field Scenario</h2>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
              <h3 className="font-medium text-white mb-2">Case Study 3: Industrial Lighting Failure</h3>
              <p className="text-xs sm:text-sm text-white mb-2">
            ...
            <div className="rounded-lg p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
              <h3 className="font-medium text-white mb-2">Case Study 4: Moisture Ingress in Outdoor Installation</h3>
              <p className="text-xs sm:text-sm text-white mb-2">
            ...
            <div className="rounded-lg p-4 bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800">
              <h3 className="font-medium text-white mb-2">Case Study 5: Multi-stranded Conductor Failure</h3>
              <p className="text-xs sm:text-sm text-white mb-2">
        ...
        {/* Summary */}
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">Summary & Key Takeaways</h2>
          <div className="space-y-6">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-red-500/20">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-semibold text-white">Problems to Avoid</h3>
              </div>
            ...
            <div className="text-center p-4 bg-transparent border border-green-500/20 rounded-lg">
