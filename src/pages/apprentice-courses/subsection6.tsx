...
const DESCRIPTION =
  'Understanding electrical faults including overloads, short circuits, and arcing. BS 7671 fault protection, investigation techniques, and prevention strategies for electrical workers.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "Overloads occur when more current flows through a circuit than it's designed to carry, causing excessive heating and potential damage.",
  },
  {
    id: 2,
    ...
    correctIndex: 2,
    explanation:
      'A short circuit creates a low-resistance path that bypasses the intended load, causing very high currents to flow.',
  },
  {
    id: 3,
    ...
    correctIndex: 2,
    explanation:
      'AFDDs are specifically designed to detect the unique characteristics of arc faults and provide rapid protection.',
  },
  {
    id: 4,
    question: 'What is the maximum disconnection time for a 32A circuit under BS 7671?',
    options: ['0.1 seconds', '0.4 seconds', '5 seconds', 'Instantaneous'],
    correctIndex: 1,
    explanation:
      'BS 7671 requires final circuits up to 32A to disconnect within 0.4 seconds for shock protection.',
  },
];
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        "An overload occurs when more current flows through a circuit than it's designed to carry, causing excessive heating that can damage cables and start fires.",
    },
    {
      id: 2,
      ...
      correctAnswer: 2,
      explanation:
        'A short circuit creates a low-resistance path between conductors, allowing very high currents to flow that can cause fires, explosions, and equipment damage.',
    },
    {
      id: 3,
      ...
      correctAnswer: 1,
      explanation:
        'Warm outlets, cables or switch plates indicate excessive current flow causing resistive heating - a clear sign of overloading that requires immediate attention.',
    },
    {
      id: 4,
      ...
      correctAnswer: 1,
      explanation:
        'Proper torque values ensure optimal electrical contact, preventing high resistance connections that lead to arcing, heating, and potential fires.',
    },
    {
      id: 5,
      ...
      correctAnswer: 2,
      explanation:
        'BS 7671 requires AFDDs in specific high-risk locations such as sleeping accommodation, escape routes, and areas with combustible materials.',
    },
    {
      id: 6,
      question: 'What is the typical fault current level in a domestic installation short circuit?',
      options: ['1-10 A', '100-1000 A', '1000-10,000 A', 'Over 50,000 A'],
      correctAnswer: 2,
      explanation:
        'Domestic short circuit currents typically range from 1-10 kA (1000-10,000 A), requiring protective devices with adequate breaking capacity.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'EAWR requires thorough investigation of any electrical fault to determine and rectify the cause before re-energising to prevent recurrence.',
    },
    {
      id: 8,
      ...
      correctAnswer: 1,
      explanation:
        'Discrimination ensures that only the protective device closest to the fault operates, maintaining supply to healthy circuits and minimising disruption.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Use the cable's current-carrying capacity (Iz) from BS 7671 tables, apply derating factors for installation method, ambient temperature, and grouping. The protective device rating must not exceed the cable's derated capacity.",
    },
    {
      question: "What's the difference between an overload and a short circuit?",
      answer:
        'Overloads involve excessive current (typically 1.5-10 times normal) flowing through the intended circuit path. Short circuits create unintended low-resistance paths with much higher currents (hundreds to thousands of times normal).',
    },
    {
      question: 'When should I use Arc Fault Detection Devices (AFDDs)?',
      answer:
        'BS 7671 Amendment 2 requires AFDDs in specific locations: sleeping accommodation, escape routes, common areas in HMOs, and areas with particular fire risk due to combustible materials or construction.',
    },
    {
      question: 'How do I investigate an electrical fault safely?',
      answer:
        'Follow safe isolation procedures, use appropriate test equipment (GS38 compliant), check for obvious signs of damage, measure insulation resistance, continuity, and earth fault loop impedance. Document findings and causes.',
    },
    {
      question: 'What are the economic impacts of electrical faults?',
      answer:
        'Costs include equipment replacement, business interruption, emergency callouts, insurance claims, and potential legal liability. Prevention through proper design and maintenance is far more cost-effective than fault rectification.',
    },
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <header className="mb-6 sm:mb-8">
          ...
          <p className="text-white">
            Understanding electrical faults, their causes, effects, and prevention strategies. BS
            7671 fault protection requirements and investigation techniques.
          </p>
        </header>
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-base text-foreground">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  Overloads occur when circuits carry more current than designed, causing heating
                  and potential fires.
                </li>
                <li>
                  Short circuits create unintended low-resistance paths with dangerously high fault
                  currents.
                </li>
                <li>
                  Arc faults generate extreme heat and can ignite fires even without overcurrent
                  conditions.
                </li>
                <li>
                  BS 7671 requires specific protection devices and disconnection times for each
                  fault type.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Warm cables/outlets, tripping MCBs, burning smells, loose
                  connections.
                </li>
                <li>
                  <strong>Use:</strong> Correct cable sizing, proper protective devices, AFDDs where
                  required.
                </li>
                <li>
                  <strong>Check:</strong> Load calculations, fault current capacity, discrimination,
                  connection torques.
                </li>
              </ul>
            </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <ul className="list-disc pl-6 space-y-2 text-base text-foreground">
            <li>
              Understand the causes, effects, and prevention of electrical overloads, short
              circuits, and arc faults.
            </li>
            <li>
              Apply BS 7671 requirements for fault protection including protective device selection
              and discrimination.
            </li>
            <li>
              Calculate maximum circuit loads and apply diversity factors in electrical design.
            </li>
            <li>
              Recognise warning signs of electrical faults and understand investigation procedures.
            </li>
            <li>
              Select appropriate protection devices including MCBs, RCDs, and AFDDs for different
              applications.
            </li>
            <li>
              Understand the economic and safety implications of electrical faults in installations.
            </li>
          </ul>
        </Card>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">
              Overload Faults - Causes and Prevention
            </h3>
            <p className="text-base text-foreground mb-4">
              Overload faults occur when electrical circuits carry more current than their designed
              capacity, leading to excessive heating and potential fire hazards:
            </p>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Definition:</strong> Current exceeding the circuit's design capacity
                      for sustained periods.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>
                        <strong>Load calculations:</strong> Sum of all connected loads vs cable
                        current-carrying capacity (Iz)
                      </li>
                      <li>
                        <strong>Diversity factors:</strong> Applied per BS 7671 to account for
                        simultaneous usage
                      </li>
                      <li>
                        <strong>Thermal effects:</strong> I²R heating in cables and connections
                      </li>
                      <li>
                        <strong>Protective device coordination:</strong> MCB ratings must not exceed
                        cable capacity
                      </li>
                    </ul>
                    <p className="text-base text-foreground mb-2">
                      <strong>Common causes in practice:</strong> Real-world overload scenarios.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Early warning signs:</strong> Recognition and immediate action
                      required.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>BS 7671 requirement:</strong> Cable current-carrying capacity must
                      exceed design current with appropriate derating factors applied
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">
              Short Circuit Faults - Analysis and Protection
            </h3>
            <p className="text-base text-foreground mb-4">
              Short circuit faults create dangerous high-current conditions requiring immediate
              disconnection and thorough investigation:
            </p>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-elec-yellow mb-1">
                      Short Circuit Characteristics and Protection
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>Fault types:</strong> Different short circuit configurations and their
                      characteristics.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Fault current calculations:</strong> Determining maximum fault levels
                      for protection.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Protective device discrimination:</strong> Ensuring selective
                      operation.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>EAWR requirement:</strong> Thorough fault investigation required
                      before re-energising any circuit
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-6">
            ...
            <p className="text-base text-foreground mb-4">
              Arc faults represent a unique hazard requiring specialised detection and protection
              methods beyond conventional overcurrent devices:
            </p>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-green-600 dark:text-green-400 mb-1">
                      Arc Fault Detection and Prevention Technology
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>Arc fault characteristics:</strong> Understanding the unique
                      signatures of electrical arcing.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>AFDD technology:</strong> Arc Fault Detection Devices per BS 7671
                      Amendment 2.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>
                        Required locations: sleeping accommodation, escape routes, high-risk areas
                      </li>
                      <li>
                        Detection algorithms: distinguishing between harmful and normal arcing
                      </li>
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Prevention strategies:</strong> Eliminating arc fault conditions
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Key principle:</strong> AFDDs detect dangerous arcing that may not
                      cause overcurrent but can ignite fires
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">
              Fault Investigation and Documentation
            </h3>
            <p className="text-base text-foreground mb-4">
              Systematic fault investigation is essential for identifying root causes and preventing
              recurrence:
            </p>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-elec-yellow mb-1">
                      Systematic Fault Investigation Procedures
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>Safe investigation methods:</strong> Ensuring personal safety during
                      fault finding.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Diagnostic techniques:</strong> Systematic approach to fault
                      identification.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Documentation requirements:</strong> Recording findings for compliance
                      and learning.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Legal requirement:</strong> EAWR mandates investigation of all
                      electrical faults before re-energisation
                    </div>
                  </div>
                </div>
              </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="rounded-lg p-5 bg-card border border-border/20">
            ...
            <p className="text-base text-foreground mb-4">
              <strong>Scenario:</strong> A fire occurred in a commercial kitchen overnight, damaging
              equipment worth £50,000. The fire started near the main distribution board supplying
              cooking equipment.
            </p>
            <p className="text-base text-foreground mb-4">
              <strong>Initial findings:</strong> Fire investigator identified electrical origin.
              MCBs had tripped, but significant damage occurred before disconnection. No RCD
              protection on affected circuits.
            </p>
            <p className="text-base text-foreground mb-4">
              <strong>Investigation process:</strong> Electrical contractor conducted systematic
              fault investigation:
            </p>
            <ul className="text-xs sm:text-sm text-foreground ml-6 mb-4 list-disc space-y-1">
              <li>
                Safe isolation and visual inspection revealed severely damaged cable terminations
              </li>
              ...
              <li>
                Load monitoring revealed circuits operating at 90% capacity during peak periods
              </li>
            </ul>
            <p className="text-base text-foreground mb-4">
              <strong>Root causes identified:</strong> Multiple contributing factors led to the
              incident:
            </p>
            <ul className="text-xs sm:text-sm text-foreground ml-6 mb-4 list-disc space-y-1">
            ...
            <div className="rounded-lg p-3 bg-card border border-amber-400/30">
              <p className="text-xs sm:text-sm text-foreground">
                <strong>Learning outcome:</strong> This incident demonstrates how multiple minor
                issues can combine to create major hazards. Regular maintenance, proper installation
                techniques, and appropriate protection devices are essential for preventing
                electrical fires.
              </p>
            </div>
          </div>
        ...
        <Card className="mb-8 p-6 bg-card border-border/20">
          ...
          <div className="space-y-3 text-base text-foreground">
            <p>
              Electrical faults - overloads, short circuits, and arc faults - represent significant
              hazards that can cause fires, equipment damage, and injury even without direct contact
              with live parts.
            </p>
            <p>
              <strong>Key principles for fault prevention:</strong> Proper design calculations,
              correct protective device selection, quality installation techniques, and regular
              maintenance are essential for electrical safety.
            </p>
            <p>
              <strong>BS 7671 compliance:</strong> Modern electrical installations must incorporate
              appropriate protection devices including AFDDs in high-risk locations, with proper
              discrimination to ensure selective operation.
            </p>
            <p>
              <strong>Professional responsibility:</strong> Electrical workers must understand fault
              characteristics, investigation techniques, and prevention strategies to maintain safe
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/20">
            ...
            <div className="mt-4 p-3 bg-card rounded border border-amber-400/30">
              <p className="text-xs sm:text-sm text-foreground">
                <strong>Emergency action:</strong> Safe isolation → Investigation → Documentation →
                Remedial action → Test → Re-energise
              </p>
            </div>
          </div>
        </Card>
