      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>What:</strong> Laboratory analysis of oils and fluids to detect wear and
                contamination
              </li>
              <li className="pl-1">
                <strong>Tests:</strong> Wear metals, viscosity, TAN, water content, particle count
              </li>
              <li className="pl-1">
                <strong>Transformer:</strong> Dissolved gas analysis (DGA) for internal fault
                detection
              </li>
              <li className="pl-1">
                <strong>Trending:</strong> Regular sampling builds a deterioration profile
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Oil condition:</strong> Viscosity, acidity, oxidation and additive
                  depletion show whether the oil is still fit for service
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Internal faults (transformers):</strong> Dissolved gases reveal
                  overheating, arcing and insulation degradation
                </li>
              </ul>
            </div>
            <div className="my-6">
              ...
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Spectrometric analysis</td>
                      <td className="border border-white/10 px-3 py-2">
                        Wear metals and contaminants (ppm)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Identifies which components are wearing
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Viscosity</td>
                      <td className="border border-white/10 px-3 py-2">
                        Oil film thickness capability
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Changes indicate contamination or degradation
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Total acid number</td>
                      <td className="border border-white/10 px-3 py-2">Acidity from oxidation</td>
                      <td className="border border-white/10 px-3 py-2">
                        Rising TAN indicates oil degradation
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Water content</td>
                      <td className="border border-white/10 px-3 py-2">
                        Dissolved and free water (ppm)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Even trace water is highly damaging
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Particle count</td>
                      <td className="border border-white/10 px-3 py-2">
                        Solid contamination (ISO 4406)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Cleanliness affects component life
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Dissolved gas (DGA)</td>
                      <td className="border border-white/10 px-3 py-2">
                        Gases from internal faults
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Transformer-specific fault diagnosis
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> A single oil analysis result tells you the current
              condition. Regular sampling and trending reveals the rate of change — which is far
              more valuable for maintenance planning.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Consistent location:</strong> Always sample from the same point — ideally
                  a dedicated sample valve in the return line or mid-stream
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Clean bottles:</strong> Use laboratory-supplied clean sample bottles.
                  Never reuse bottles or use workshop containers
                </li>
                <li className="pl-1">
                  <strong>Flush first:</strong> Before taking the sample, flush a small amount of
                  oil through the sample valve to clear any stagnant oil
                </li>
                <li className="pl-1">
                  <strong>Label immediately:</strong> Record date, equipment ID, operating hours,
                  oil type and any observations
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Sampling from the drain plug (collects settled debris — not representative)
                </li>
                ...
                <li className="pl-1">
                  Inconsistent sampling locations between tests (makes trending meaningless)
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Iron (Fe)</td>
                      <td className="border border-white/10 px-3 py-2">
                        Gears, shafts, rolling elements, cylinder liners
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Copper (Cu)</td>
                      <td className="border border-white/10 px-3 py-2">
                        Bronze bushes, bearing cages, thrust washers
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Chromium (Cr)</td>
                      <td className="border border-white/10 px-3 py-2">
                        Hardened steel components, piston rings
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Aluminium (Al)</td>
                      <td className="border border-white/10 px-3 py-2">
                        Bearing shells, pistons, pump housings
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Lead (Pb)</td>
                      <td className="border border-white/10 px-3 py-2">
                        Plain bearing overlay, solder
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Silicon (Si)</td>
                      <td className="border border-white/10 px-3 py-2">
                        External dirt ingression, sealant contamination
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Absolute values matter less than the trend. A steady iron
              level of 20 ppm may be normal for a particular gearbox. A sudden increase from 20 to
              80 ppm indicates accelerating wear requiring investigation.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Key DGA Gases and Their Meaning
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Acetylene (C2H2):</strong> High-energy arcing (above 700 degrees C) —
                  always significant
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>ST1426 link:</strong> Understanding oil and fluid analysis contributes to the
              condition monitoring and predictive maintenance knowledge required under the
              maintenance technician standard. For the electrical pathway, transformer oil testing
