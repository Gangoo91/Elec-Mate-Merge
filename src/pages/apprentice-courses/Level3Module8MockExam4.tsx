...
import { getRandomQuestions } from "@/data/study-centre/apprentice/level3/module4/questionBank";

const Level3Module8MockExam4 = () => {
  useSEO("Mock Exam 4: Fault Diagnosis | Level 3 Electrical Course", "Test your knowledge of Module 4 fault diagnosis with this comprehensive 30-question mock exam.");
        ...
        <div>
          <Card className="border-elec-yellow/30 bg-transparent">
            <CardHeader className="text-center pb-3 sm:pb-4 px-3 sm:px-6">
              ...
              <CardTitle className="text-lg sm:text-xl md:text-2xl text-white mb-1">Level 3 Mock Exam 4</CardTitle>
              <h2 className="text-xs sm:text-sm md:text-lg text-elec-yellow">Fault Diagnosis & Rectification</h2>
            </CardHeader>
              ...
              <div className="bg-[#1a1a1a] p-3 sm:p-4 rounded-lg sm:rounded-xl border border-muted/40">
                ...
                <div className="grid gap-2 sm:gap-2">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm sm:text-sm text-white/70 leading-relaxed">30 questions randomly selected from 200 Module 4 questions</p>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 sm:h-1.5 sm:w-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 sm:h-1.5 sm:w-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0" />
                    <p className="text-sm sm:text-sm text-white/70 leading-relaxed">Topics: Fault Types, Diagnosis Methods, Safe Isolation, Test Equipment, Repair Procedures</p>
                  </div>
                </div>
              </div>
            ...
            <CardContent className="space-y-4 sm:space-y-6 px-3 sm:px-6">
              ...
              <div className="flex flex-col gap-3 pt-2">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Link to="/study-centre/apprentice/level3-course/module8-section4" className="flex-1">
    ...
    <div className="min-h-screen overflow-x-hidden bg-[#1a1a1a]">
      <div className="border-b border-muted/20 bg-transparent/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <Link to="/study-centre/apprentice/level3-course/module8-section4" className="text-sm text-white/70 hover:text-elec-yellow transition-colors flex items-center gap-2">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <div className="text-sm text-white/70 mt-1">Level 3 Module 4 • Fault Diagnosis</div>
                </div>
                <Button
                  onClick={toggleFlag}
                  variant="outline"
