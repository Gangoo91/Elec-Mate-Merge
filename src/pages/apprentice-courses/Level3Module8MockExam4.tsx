...
import {
  ...
  M4_SECTION_TOPIC,
  type Question,
} from '@/data/apprentice-courses/level3/module4/questionBank';
...
const Level3Module8MockExam4 = () => {
  useSEO(
    ...
    'Test your knowledge of Module 4 fault diagnosis with this 60-question mock exam aligned to the C&G 2365-03 Unit 303 specification.'
  );
  ...
  const history = useMockExamHistory('level3-module8-mock4', user?.id ?? null);
  const failureRates = useQuestionFailureRates(
    'level3-module8-mock4',
  ...
  useEffect(() => {
    ...
    recordMockExamAttempt({
      examSlug: 'level3-module8-mock4',
      source: 'in_app',
      examName: 'Level 3 Mock Exam 4',
      questions: examQuestions,
  ...
  if (!examStarted) {
    return (
      <ExamStartPanel
        ...
        title="Mock Exam 4"
        subtitle="Fault Diagnosis (C&G 2365-03 Unit 303 / 2357 Unit 608)"
        totalQuestions={60}
        bankSize={module4Questions.length}
        timeLimitMinutes={90}
        passThreshold={60}
        history={history}
        onStart={startExam}
