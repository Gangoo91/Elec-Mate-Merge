    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Essential guide to cable selection and containment systems for AM2 - trunking, conduit,
          tray installation and assessment requirements.
        </p>
        ...
        <div className="my-6">
          ...
          <p className="text-xs sm:text-sm text-white/80 mb-3">
            The AM2 spec gives you the cable size, but assessors expect you to know whether it stays
            within the BS 7671 voltage drop limits (3% lighting, 5% other) over the route length.
            Drop in your circuit current and route length and confirm the chosen cable passes.
          </p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              through a ceiling support (for example, under floorboards), shall: (a) be installed at
              least 50 mm measured vertically from the top, or bottom as appropriate, of the joist
              or batten; or (b) comply with Regulation 522.6.204."
            </>
          }
          meaning={
            <>
              If your AM2 rig has a joist run, drill at least 50 mm from the top or bottom — or use
              mechanical protection / earthed metallic containment per 522.6.204. Drilling straight
              through the centre of a joist 20 mm down is the textbook fail.
            </>
          }
        ...
        <ConceptBlock title="4. Common Errors in AM2 Containment Tasks (NET 'Common Errors' List)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Candidate drilled tray fixing too close to edge of brick - fixing pulled out - unsafe
              support
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="5. Practical Guidance for Candidates">
          ...
          <p>
            <strong className="text-elec-yellow">Self-Assessment Question:</strong> Check as you go:
            "Would an assessor photograph this as good practice or poor practice?"
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Real-World Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Example 1:</strong> Candidate completed installation electrically correct but
              conduit bends were kinked. Lost marks for workmanship.
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Commercial Office:</strong> Trunking systems requiring easy access for future
        ...
        <Scenario
          ...
          situation={
            <>
              You measured your steel trunking run from the DB to the first dado box, cut it, fitted
              it — and you can see daylight under the lid where the trunking stops 30 mm short of
              the box. You've already used the offcut for a different drop. There's a spare 1 m
              length on the bench.
            </>
          }
          whatToDo={
          ...
          whyItMatters={
            <>
              ...
              "straight runs, flush lids, secure fixings" — a coupler shoved in to hide a measuring
              error fails all three at once. Reg 522.6.1 also expects the wiring system to be
              selected and erected to minimise mechanical stress; an extra unnecessary joint is the
              opposite of that.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Power Circuits</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
