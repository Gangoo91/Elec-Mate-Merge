  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 2,
      explanation:
        'GS38 is HSE guidance specifically on the safe use of electrical test equipment for work on or near live conductors.',
    },
    {
      id: 2,
      question: 'What is the maximum exposed metal length recommended for a GS38 probe tip?',
      options: [
        '8 mm',
        '4 mm',
        '6 mm',
      ...
      correctAnswer: 1,
      explanation: 'GS38 recommends no more than 4 mm of exposed metal at the probe tip (ideally 2 mm or spring-loaded) to limit the risk of shorting and shock.',
    },
    {
      id: 3,
      question: 'Why should test leads incorporate a fuse (or current-limiting resistor)?',
      options: [
        'To limit the energy let through if the probes accidentally short',
        'To improve the accuracy of voltage readings',
        'To allow the leads to be used at higher CAT ratings',
        'To prevent the instrument battery from discharging',
      ],
      correctAnswer: 0,
      explanation: 'A fuse or current-limiting resistor in the leads limits the prospective fault current if the probes accidentally bridge live conductors, protecting the user and instrument.',
    },
    {
      id: 4,
      question: "Which rating indicates a tester's suitability for the transient voltages of different installation environments?",
      options: [
        'IP rating',
        'IK impact rating',
      ...
      correctAnswer: 3,
      explanation:
        'The CAT (measurement category) rating indicates the maximum transient overvoltage the instrument can safely withstand in a given part of the installation.',
    },
    {
      id: 5,
      question: 'What should you always do immediately before and after using a voltage tester to prove dead?',
      options: [
        'Recalibrate it against a multimeter',
        'Replace its batteries',
        'Prove it on a known live source or proving unit',
        'Record the reading on the certificate',
      ],
      correctAnswer: 2,
      explanation: 'Proving the tester on a known live source or proving unit before and after confirms it was working throughout the dead test (prove-test-prove).',
    },
    {
      id: 6,
      question: 'Are neon screwdrivers an acceptable means of proving a circuit dead under GS38?',
      options: ['Yes, they meet GS38 requirements', 'No, they are not safe or reliable for proving dead'],
      correctAnswer: 1,
      explanation:
        'Neon screwdrivers rely on current through the user and can give false readings, so GS38 does not accept them for proving dead — use an approved voltage indicator.',
    },
    {
      id: 7,
      question: 'Which of these is NOT a feature of GS38-compliant test equipment?',
      options: [
        'Long exposed probe tips for easier contact',
        'Insulated and double-insulated leads',
        'Shrouded probes with finger guards',
        'Fused or current-limited leads',
      ],
      correctAnswer: 0,
      explanation: 'GS38 calls for shrouded probes, insulated fused leads and minimal exposed metal (≤4 mm); long exposed tips are exactly what it tries to avoid.',
    },
    {
      id: 8,
      question: 'What is the main danger of continuing to use leads with cracked insulation?',
      options: [
        'The readings drift slightly out of calibration',
        'The fuse in the lead may blow prematurely',
        'The instrument display becomes harder to read',
        'Exposed conductors can cause electric shock or arcing',
      ],
      correctAnswer: 3,
      explanation: 'Cracked insulation can expose live conductors, allowing the user to receive an electric shock or causing arcing between leads.',
    },
    {
      id: 9,
    ...
    {
      id: 10,
      question: 'Why is using GS38-compliant equipment essential when testing live?',
      options: [
        'It guarantees faster test results on site',
        'It protects the user from shock and arc flash during live testing',
        'It removes the need to prove the tester first',
        'It allows testing without any PPE',
      ],
      correctAnswer: 1,
      explanation:
        'GS38-compliant equipment minimises the risk of electric shock and arc flash, which is essential when measurements must be taken on or near live conductors.',
    },
  ];
