...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['A cordless drill', 'A ladder', 'Livestock', 'A multifunction tester'],
    correctAnswer: 2,
    explanation:
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>PUWER:</strong> Requires equipment to be suitable, safe and maintained
              </li>
              <li className="pl-1">
                <strong>Scope:</strong> All work equipment from hand tools to machinery
              </li>
              <li className="pl-1">
                <strong>Duties:</strong> Employer must assess, select, maintain, inspect, train
              </li>
              <li className="pl-1">
                <strong>Guarding:</strong> Hierarchy from fixed guards to PPE as last resort
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Power tools:</strong> Drills, grinders, saws - all require guarding
              </li>
              <li className="pl-1">
                <strong>Test equipment:</strong> MFTs, insulation testers - calibration required
              </li>
              <li className="pl-1">
                <strong>Access equipment:</strong> Ladders, platforms, MEWPs - inspection regime
              </li>
              <li className="pl-1">
                <strong>110V systems:</strong> Mandatory for construction site tools
              </li>
            </ul>
          </div>
        </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Dangerous parts, controls, stability, lighting, markings
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Torque, speed, battery capacity
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Clutch for torque control, side handle provision
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Angle grinder</td>
                      <td className="border border-white/10 px-3 py-2">
                        Disc size, power, disc type
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Guard fitted, dead man's switch, anti-vibration
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">MFT (tester)</td>
                      <td className="border border-white/10 px-3 py-2">
                        Test range, accuracy, features
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        CAT rating suitable, calibration valid
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Ladder</td>
                      <td className="border border-white/10 px-3 py-2">
                        Height, duty rating, material
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        BS EN 131 compliance, suitable for load
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">SDS drill</td>
                      <td className="border border-white/10 px-3 py-2">
                        Impact energy, drill diameter capacity
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Vibration rating, dust extraction provision
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Weekly/monthly visual + PAT 3-6 monthly
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Higher frequency on construction sites
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">Before each use</td>
                      <td className="border border-white/10 px-3 py-2">
                        Monthly visual + PAT 3-6 monthly
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Check for damage, overheating signs
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Test instruments</td>
                      <td className="border border-white/10 px-3 py-2">
                        Before use (proving unit)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Annual calibration + visual inspection
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Check leads and probes condition
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Check rungs, stiles, feet, locking mechanisms
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        6-monthly thorough examination (LOLER)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Check handles, heads, insulation
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Controls requiring deliberate action
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Dead man's switch on angle grinder
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Controls clearly visible/identifiable
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Colour-coded switches, labels
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-6">
            Practical Application in Building Services
          </h2>

          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Case Study: 110V Power Tool System
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Case Study: Multifunction Test Equipment
              </h3>
              <p className="text-sm text-white mb-2">
