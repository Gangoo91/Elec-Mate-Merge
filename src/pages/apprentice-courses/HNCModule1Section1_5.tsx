...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['A multifunction tester', 'A cordless drill', 'Livestock', 'A ladder'],
    correctAnswer: 2,
    explanation:
...
const HNCModule1Section1_5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1.1.5"
        title="PUWER and Work Equipment"
        backTo="../h-n-c-module1-section1"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              place of use, and fit for the user. As an HNC supervisor your sign-off on a piece of
              test gear or access equipment is implicitly a Reg 4 declaration. Document it.
            </>
          }
        ...
        <ConceptBlock title="Definition of Work Equipment and PUWER Scope">
          <p>
            ...
            regulations implement European Directive requirements and apply across all industry
            sectors.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80 mb-2">What is Work Equipment?</p>
          <p className="text-sm text-white mb-3">
            PUWER defines <strong>work equipment</strong> as: "any machinery, appliance, apparatus,
            tool or installation for use at work (whether exclusively or not)". This definition is
            deliberately broad and includes:
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 4</strong> — Requirement: Suitability of work equipment
            </li>
            <li>
              <strong>Reg 5</strong> — Requirement: Maintenance
            </li>
            <li>
              <strong>Reg 6</strong> — Requirement: Inspection
            </li>
            <li>
              <strong>Reg 7</strong> — Requirement: Specific risks
            </li>
            <li>
              <strong>Reg 8</strong> — Requirement: Information and instructions
            </li>
            <li>
              <strong>Reg 9</strong> — Requirement: Training
            </li>
            <li>
              <strong>Regs 11-24</strong> — Requirement: Dangerous parts, controls, stability,
              lighting, markings
            </li>
          </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Important:</strong> PUWER applies to privately owned equipment used for work. If
            an electrician uses their own tools at work, the employer still has duties to ensure
        ...
        <ConceptBlock title="Selection and Suitability Requirements">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Conditions of use:</strong> The place and environment where it will be used
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cordless drill</strong> — Key Selection Criteria: Torque, speed, battery
              capacity. PUWER Considerations: Clutch for torque control, side handle provision
            </li>
            <li>
              <strong>Angle grinder</strong> — Key Selection Criteria: Disc size, power, disc type.
              PUWER Considerations: Guard fitted, dead man's switch, anti-vibration
            </li>
            <li>
              <strong>MFT (tester)</strong> — Key Selection Criteria: Test range, accuracy,
              features. PUWER Considerations: CAT rating suitable, calibration valid
            </li>
            <li>
              <strong>Ladder</strong> — Key Selection Criteria: Height, duty rating, material. PUWER
              Considerations: BS EN 131 compliance, suitable for load
            </li>
            <li>
              <strong>SDS drill</strong> — Key Selection Criteria: Impact energy, drill diameter
              capacity. PUWER Considerations: Vibration rating, dust extraction provision
            </li>
          </ul>
            ...
            whatHappens={
              <>
                <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
                  ...
                  <li>Standard multimeter for mains testing (needs CAT III/IV rating)</li>
                  <li>
        ...
        <ConceptBlock title="Maintenance and Inspection Requirements">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>The safety of equipment depends on the installation conditions</li>
            <li>
              Equipment is exposed to conditions causing deterioration liable to result in danger
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>110V power tools</strong> — User Check: Before each use. Formal Inspection:
              Weekly/monthly visual + PAT 3-6 monthly. Notes: Higher frequency on construction sites
            </li>
            <li>
              <strong>Extension leads</strong> — User Check: Before each use. Formal Inspection:
              Monthly visual + PAT 3-6 monthly. Notes: Check for damage, overheating signs
            </li>
            <li>
              <strong>Test instruments</strong> — User Check: Before use (proving unit). Formal
              Inspection: Annual calibration + visual inspection. Notes: Check leads and probes
              condition
            </li>
            <li>
              <strong>Ladders</strong> — User Check: Before each use. Formal Inspection: Monthly
              detailed inspection. Notes: Check rungs, stiles, feet, locking mechanisms
            </li>
            <li>
              <strong>MEWPs</strong> — User Check: Daily pre-use checks. Formal Inspection:
              6-monthly thorough examination (LOLER). Notes: Written report required
            </li>
            <li>
              <strong>Hand tools</strong> — User Check: Before each use. Formal Inspection: Periodic
              - risk-based. Notes: Check handles, heads, insulation
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Ability to assess their significance for continued safe use</li>
            <li>Independence from the work that may be affected by the inspection</li>
          </ul>
          ...
          <div className="my-6 p-4 rounded-lg bg-amber-500/10 border border-amber-500/30">
            ...
            <p className="text-sm text-white">
              ...
              available until the next inspection. Records should include: date, person carrying out
              inspection, equipment identified, defects found, and action taken. For thorough
        ...
        <ConceptBlock title="Training, Competence, Guards and Protection Devices">
          <p>
            PUWER establishes comprehensive requirements for training users and protecting them from
            dangerous parts of machinery. These regulations work together to ensure both competent
            operation and engineered safety measures.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Information on conditions of use and foreseeable abnormal situations</li>
          ...
          <p className="text-sm text-white mb-3">
            Where there is risk from contact with dangerous parts, effective measures must be taken
            to:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Prevent access to dangerous parts, OR</li>
            <li>Stop the movement of dangerous parts before any part of a person can reach them</li>
          </ul>
          ...
          <div className="p-3 rounded bg-blue-500/10 border-l-4 border-blue-500">
            ...
            <p className="text-sm text-white mt-1">
              ...
              opened), adjustable guards, self-adjusting guards, photoelectric devices, pressure
          ...
          <div className="p-3 rounded bg-amber-500/10 border-l-4 border-amber-500">
            ...
            <p className="text-sm text-white mt-1">
              Jigs, holders, push sticks - devices that keep hands away from danger zones while
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 14</strong> — Requirement: Controls requiring deliberate action. Building
              Services Example: Dead man's switch on angle grinder
            </li>
            <li>
              <strong>Reg 15</strong> — Requirement: Start controls. Building Services Example:
              On/off switch on power tool
            </li>
            <li>
              <strong>Reg 16</strong> — Requirement: Stop controls. Building Services Example:
              Trigger release stops drill
            </li>
            <li>
              <strong>Reg 17</strong> — Requirement: Emergency stop. Building Services Example:
              E-stop on workshop machinery
            </li>
            <li>
              <strong>Reg 18</strong> — Requirement: Controls clearly visible/identifiable. Building
              Services Example: Colour-coded switches, labels
            </li>
          </ul>
          ...
          <p className="text-sm text-white mt-2">
            Example: Only trained and authorised persons should operate MEWPs or high-voltage test
            equipment.
          </p>
        ...
        <ConceptBlock title="Practical Application in Building Services">
          <p>
            <strong>Case Study: 110V Power Tool System</strong>
          </p>
          <p className="text-sm text-white mb-2">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Maintenance:</strong> Monthly servicing schedule, replacement of worn parts
            </li>
            <li>
              <strong>Inspection:</strong> User pre-use checks (laminated checklist), weekly formal
              inspection, quarterly PAT testing
            </li>
            <li>
              <strong>Training:</strong> Tool induction for all operatives, refresher annually
            </li>
            <li>
              <strong>Records:</strong> Asset register, inspection log, training matrix maintained
            </li>
          </ul>

          <p>
            <strong>Case Study: Multifunction Test Equipment</strong>
          </p>
          <p className="text-sm text-white mb-2">Applying PUWER to electrical test instruments:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Maintenance:</strong> Firmware updates, battery replacement, lead replacement
            </li>
            <li>
            ...
            <li>
              <strong>Training:</strong> Instrument-specific training, understanding of test methods
              and limitations
            </li>
            <li>
          ...
          <p>
            <strong>Case Study: Access Equipment</strong>
          </p>
          <p className="text-sm text-white mb-2">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Maintenance:</strong> Cleaning, adjustment of locking mechanisms, replacement
              of worn feet
            </li>
            <li>
              <strong>Inspection:</strong> Pre-use visual check, monthly detailed inspection with
              tagging system
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You arrive at site to find a contractor using a mobile scaffold tower for high-level
              tray and trunking installation. The tower has no PUWER inspection tag, the toeboards
              are missing on one side, and the operator has no PASMA card.
            </>
          }
          whatToDo={
            <>
              Stop the work. Apply Reg 4 (suitability — toeboards missing fails fit-for-place), Reg
              6 (maintenance), Reg 7 (specific risks — falls from height), Reg 9 (training —
              ...
              platform against Schedule 1 of the Work at Height Regulations 2005 before releasing.
            </>
          }
          whyItMatters={
            <>
              Falls from height remain the largest construction fatality category. PUWER
              non-compliance on access equipment is one of the most-prosecuted breaches and a
              Prohibition Notice will follow any HSE visit that catches it.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">COSHH</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
