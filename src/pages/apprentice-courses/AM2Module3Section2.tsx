...
const AM2Module3Section2 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['32A MCB', '20A MCB', '50A MCB', '32-40A MCB'],
      correctAnswer: 3,
      explanation:
    ...
    },
    {
      ...
      options: ['Contactor', 'Overload protection', 'Phase monitor', 'Timer relay'],
      correctAnswer: 1,
      explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Master power circuit installation for AM2 assessment - ring finals, radials, cooker
          circuits, and motor controls with professional workmanship standards.
        </p>
          ...
          <VideoCard
            ...
            caption={
              <>
                ...
                3-step continuity test. Craig walks through the cross-connection method that catches
                a broken ring — the most common reason candidates lose marks on the power circuit.
              </>
            }
          />
        </div>
        ...
        <ConceptBlock title="3. Cooker Circuit">
          ...
          <p>
            <strong className="text-elec-yellow">Common Error:</strong> Over-stripping cable sheath
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              30 mA shall be provided for socket-outlets with a rated current not exceeding 32 A. An
              exception to omit RCD protection is permitted where, other than for a dwelling, a
          ...
          meaning={
            <>
              ...
              socket circuits go on the RCD side. Sockets on a non-RCD-protected MCB is an automatic
              fail.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              "All equipment, including cable, of every circuit carrying the starting, accelerating
              and load currents of a motor shall be suitable for a current at least equal to the
              full-load current rating of the motor when rated in accordance with the appropriate
              British or Harmonized Standard."
            </>
          }
          meaning={
            <>
              ...
              or 4 mm² SWA, install that and set the overload to the FLC stamped on the motor — not
              a guess.
            </>
          }
        ...
        <ConceptBlock title="4. Motor Circuit">
          ...
          <p>
            ...
            until it's second nature. Use a checklist: gland tight, banjo fitted, earth continuous,
        ...
        <ConceptBlock title="8. Real-World Examples">
          ...
          <p>
            ...
            Cooker circuit wired with sheath stripped back too far. Exposed cable insulation visible
            at outlet plate = significant marks lost for poor workmanship.
          </p>
          <p>
            <strong className="text-elec-yellow">Example 3: Motor Circuit Incomplete.</strong> Motor
            circuit wired correctly but overload protection not set for motor FLC. Assessor flagged
            incomplete installation - lost marks for attention to detail.
          </p>
          <p>
        ...
        <ConceptBlock title="9. Frequently Asked Questions">
          ...
          <p>
            <strong>Q2: Will the assessor open socket outlets and accessories?</strong> Yes - expect
            sample inspections of terminations, so ensure all connections are neat and secure.
          </p>
          <p>
        ...
        <ConceptBlock title="10. Summary">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Safety compliance:</strong> No unsafe shortcuts, circuits tested fully before
              energisation
            </li>
          </ul>
          <p>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              isolate, take the lid off the consumer unit, leave the cross-connection in, then walk
              back through every socket in turn looking for the line termination that's pulled out
              or under-tightened. Most likely it's the last one you wired in a hurry. Re-terminate,
              retest end-to-end, then do r1+rn and r1+r2 cross-connections.
            </>
          }
          whyItMatters={
            <>
              ...
              cable rated 20 A. That's a section fail. The 3-step ring test exists exactly to catch
              this before energising.
            </>
          }
        />
