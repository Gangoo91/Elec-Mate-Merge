...
const AM2 = () => {
  ...
  const modules = [
    ...
    },
    {
      ...
      description:
        'Cable selection, power circuits, lighting, special installations and time management',
      icon: Wrench,
      path: 'module3',
    },
    {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="relative overflow-hidden px-4 sm:px-6 pt-8 pb-6">
            ...
            <div
              ...
              style={{
                background:
                  'radial-gradient(circle, rgba(59,130,246,0.5) 0%, rgba(245,158,11,0.4) 60%, transparent 80%)',
              }}
            />
              ...
              <div className="flex items-center justify-between sm:justify-center sm:gap-0">
                {stats.map((stat, index) => (
                  <div key={stat.label} className="flex items-center">
                    {index > 0 && <div className="hidden sm:block w-px h-8 bg-white/10 mx-6" />}
