...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['2× cable diameter', '4× cable diameter', '10× cable diameter', '6× cable diameter'],
    correctIndex: 3,
    explanation:
...
const HNCModule4Section2_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 2 · Subsection 6"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              Bending radius, support spacing, fill ratio, segregation, gland torque and termination
              quality are all design specifications you make, then inspect under Part 6. Skip any of
              them and the install fails the workmanship test — even if the cable schedule is
              perfect on paper.
            </>
          }
        ...
        <ConceptBlock title="Containment Systems">
          ...
          <p>
            <strong>
              Containment types comparison (type / best for / reference method / characteristics):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cable tray (perforated)</strong> — plantrooms, risers — Method E (best) — best
              heat dissipation, easy access
            </li>
            <li>
              <strong>Cable ladder</strong> — heavy cables, long spans — Method E — strong, good for
              SWA
            </li>
            <li>
            ...
            <li>
              <strong>Trunking (metal)</strong> — offices, corridors — Method B — neat, accessible,
              can be decorative
            </li>
            <li>
        ...
        <ConceptBlock title="Supports and Bending Radii">
          ...
          <p>
            <strong>
              Cable support spacing — horizontal (cable type / clipped direct / on tray-ladder):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Quality check:</strong> Inspect bends during installation — kinked or flattened
            cables indicate the bend was too tight.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Segregation Requirements">
          <p>
            ...
            fire spread, and to maintain system integrity. BS 7671 Chapter 52 and BS 6701 provide
            guidance.
          </p>
          <p>
            <strong>
              Cable categories for segregation (category / examples / segregation required from):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Band I</strong> — fire alarm, emergency comms, SELV — Band II unless screened
            </li>
            <li>
        ...
        <ConceptBlock title="Labelling and Documentation">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Cable schedules:</strong> type, size, length, circuit reference for each cable
            </li>
            <li>
          ...
          <p>
            <strong>Fire stopping requirements:</strong> where cables pass through fire compartment
            walls or floors:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Installation Examples">
          <p>
            <strong>Example 1 — office floor distribution:</strong> power and data distribution for
            open-plan office, 500m² floor plate.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A 10-storey commercial riser must accommodate: 4 sub-mains (Cu/XLPE/SWA from main
              switchroom to each floor DB cluster), 2 fire-rated cables (FP400 to smoke extract
              panels), Cat 6A data, and BMS comms. Fire compartments at each floor; ambient riser
              temperature 35&nbsp;°C in summer.
            </>
          }
          whatToDo={
            <>
              Use perforated tray for the sub-mains (reference method E or F) — better ventilation
              than enclosed trunking, much higher I_z. Group 4 sub-mains: C_g ≈ 0.65, C_a
              (35&nbsp;°C XLPE) ≈ 0.96. FP400 fire cables: separate clipped-direct tray, segregated
              from SWA by Reg 528.1 (different cable category). Data and BMS in a separate parallel
              basket — keep ≥ 200&nbsp;mm clear of LV power runs to limit EMC interference.
              Fire-stop every floor through the riser slab penetration (intumescent collar around
              each cable) to maintain fire compartmentation. Specify support spacing per BS 7671
              Table 4A2 / manufacturer data; bending radius at least 12 × OD for SWA at the cable
              break-outs.
            </>
          }
          whyItMatters={
            <>
              ...
              requirement. A riser fire-stop missed at one floor means the riser becomes the fire
              route — bypassing the building&rsquo;s fire compartmentation strategy. Get the install
              method wrong and you compromise both Part 6 verification and Building Regs Part B.
            </>
          }
        />
