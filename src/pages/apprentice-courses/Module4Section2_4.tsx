...
const TITLE =
  'Avoiding Common Errors in Measurement and Positioning - Module 4.2.4 | Level 2 Electrical Course';
const DESCRIPTION =
  'Learn to identify and prevent common measurement and positioning errors in electrical installation to ensure accuracy, compliance, and professional results.';
...
const quizQuestions = [
  {
    ...
    options: [
      'Using a worn or damaged tape measure',
      'Viewing the measurement scale at an angle',
      'Working in cold temperatures',
      'Reading the dimensions aloud too quickly',
    ],
    correctAnswer: 1,
    explanation:
      'Parallax error occurs when viewing the measurement scale at an angle rather than directly perpendicular to it.',
  },
  {
    id: 2,
    question: 'Is working from memory acceptable for short measurements?',
    options: [
      'Yes, but only for experienced electricians',
      'Yes, memory is reliable over short distances',
      'No, measurements should always be recorded',
      'Yes, provided the lighting is good',
    ],
    correctAnswer: 2,
    explanation:
      'Working from memory is not acceptable even for short measurements, as it increases the risk of errors.',
  },
  {
    id: 3,
    question: 'Which of these is a common positioning error in electrical installation?',
    options: [
      'Recording test results on the certificate',
      'Connecting the main earthing terminal',
      'Sleeving the CPC green and yellow',
      'Misaligned sockets and incorrect mounting heights',
    ],
    correctAnswer: 3,
    explanation:
      'Misaligned sockets or switches in a row and incorrect mounting heights are common positioning errors.',
  },
  {
    id: 4,
    question: 'What is the best way to ensure accuracy before drilling holes?',
    options: [
      'Marking the positions and cross-checking before you drill',
      'Drilling first and adjusting the fixing afterwards',
      'Estimating the spacing by eye to save time',
      'Relying on a single measurement taken once',
    ],
    correctAnswer: 0,
    explanation:
      'Marking positions and cross-checking with a second person or using levels/lasers ensures accuracy before drilling.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      "'Measure twice, cut once' is the golden rule that prevents costly measurement errors.",
  },
  {
    id: 6,
    ...
    options: [
      ...
      'It removes the need to refer to drawings',
      'To maintain consistency and avoid variations between tools',
      'It allows you to skip cross-checking measurements',
    ],
    correctAnswer: 2,
    explanation:
      'Using the same measuring tool maintains consistency and avoids small variations between different devices.',
  },
  {
    id: 7,
    question: "What should you do if a drawing measurement doesn't match site conditions?",
    options: [
      'Ignore the drawing and work to the site',
      'Pick whichever option is easier to install',
      'Use your own best judgement without asking',
      'Verify with the site supervisor before changing anything',
    ],
    correctAnswer: 3,
    explanation:
      "Always verify with the site supervisor before making changes when drawings don't match site conditions.",
  },
  {
    id: 8,
    question: 'What is one financial consequence of poor measurement?',
    options: [
      'Extra material costs from rework and waste',
      'A reduction in cable installation length',
      'Lower current-carrying capacity of cables',
      'A longer maximum disconnection time',
    ],
    correctAnswer: 0,
    explanation:
      'Poor measurement leads to extra material costs from rework, delays, and potential failed inspections.',
  },
];
...
const quickCheckQuestions = [
  {
    ...
    options: [
      'A misreading caused by viewing the scale at an angle',
      'An error caused by a damaged tape measure',
      'An error caused by working in poor lighting',
      'An error caused by using the wrong units',
    ],
    correctIndex: 0,
    explanation:
      'Parallax error occurs when you view the measurement scale at an angle rather than directly perpendicular, causing misreadings.',
  },
  {
    id: 2,
    question: 'Why is it important to measure from the correct reference point?',
    options: [
      'It makes the tape measure easier to read',
      'It removes the need to mark positions',
      'It prevents cumulative errors and ensures accuracy',
      'It allows you to skip a final verification check',
    ],
    correctIndex: 2,
    explanation:
      'Using the correct reference point prevents cumulative errors and ensures all measurements are consistent and accurate.',
  },
  {
    id: 3,
    question: 'Name one method to verify measurements before fixing.',
    options: [
      'Energise the circuit and measure the voltage',
      'Estimate the dimension from the drawing scale',
      'Round all dimensions to the nearest 10 mm',
      'Have a second person verify the measurements',
    ],
    correctIndex: 3,
    explanation:
      'Having a second person verify critical measurements is an effective method to catch errors before installation.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white text-sm space-y-1 list-disc pl-4">
                  ...
                  <li>
                    <strong>Use:</strong> Verification methods, consistent tools, proper lighting
                  </li>
                  <li>
                    <strong>Check:</strong> Measurements twice, alignment before fixing
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <ul className="text-white text-sm space-y-2 list-disc pl-4">
                ...
                <li>
                  Use tools and methods that ensure accurate placement of electrical components
                </li>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
              ...
              <div className="text-white text-sm space-y-2">
                ...
                <p>
                  • <strong>Failed inspections</strong> from non-compliance issues
                </p>
                <p>
                  • <strong>Increased costs</strong> from material waste and additional labour
                </p>
                <p>
                  • <strong>Safety hazards</strong> if equipment is incorrectly positioned
                </p>
              </div>
              <div className="mt-3 p-3 rounded bg-red-500/10 border border-red-500/20">
                <p className="text-red-300 text-xs">
                  <strong>Prevention is key:</strong> The cost of verification is always less than
            ...
            <div className="p-4 rounded-lg bg-blue-500/10 border-l-2 border-blue-500/50">
              ...
              <div className="p-3 rounded bg-blue-500/10 border border-blue-500/20">
                <p className="text-blue-300 text-xs">
                  <strong>Lesson:</strong> Always confirm reference points from drawings and verify
                  with site conditions. Using the wrong datum point can cause systematic errors
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-white text-sm">
                ...
                verify critical measurements before installation.
              </p>
            </div>
          </section>
          ...
          <Quiz
            ...
            title="Test Your Knowledge: Avoiding Common Errors in Measurement and Positioning"
          />
