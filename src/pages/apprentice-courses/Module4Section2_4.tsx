...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'True - memory is reliable for short distances',
      'False - always record measurements',
      'Only for experienced electricians',
      'Only in good lighting',
    ],
    correctAnswer: 1,
    explanation:
      'False - working from memory is not acceptable even for short measurements as it increases the risk of errors.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    options: [
      'Drill immediately',
      'Marking and cross-checking with verification',
  ...
  },
  {
    ...
    options: [
      "It's cheaper",
      'To maintain consistency and avoid variations',
      "It's faster",
  ...
  },
  {
    ...
    options: [
      'Ignore the drawing',
      'Verify with the site supervisor',
  ...
  },
  {
    ...
    options: [
      'Lower wages',
      'Extra material costs from rework',
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      "It's faster",
      'Prevents cumulative errors and ensures accuracy',
      "It's easier",
      'Saves materials',
    ],
    correctIndex: 1,
