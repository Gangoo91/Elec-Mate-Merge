    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Accurately assess electrical loads to ensure building services installations are correctly
          sized and future-proofed
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the essential techniques for determining maximum demand, applying
          diversity factors, and accounting for power quality issues in building services design.
          These skills are fundamental to producing cost-effective yet adequately sized electrical
          installations.
        </p>
