...
const DESCRIPTION =
  'Master essential UK safety regulations for electrical work. Learn RIDDOR reporting, PUWER equipment safety, and COSHH hazardous substance controls.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'RIDDOR sets legal duties to report specified incidents to the enforcing authority.',
  },
  {
    id: 2,
    ...
    correctIndex: 1,
    explanation:
      'PUWER requires equipment to be suitable, safe, maintained and used by competent persons with information and instruction.',
  },
  {
    id: 3,
...
const Section1_3 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Serious electrical incidents can be reportable dangerous occurrences depending on circumstances.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'Legal regulations require preventing danger and controlling risks; BS 7671 offers technical means to achieve electrical safety.',
    },
    {
      id: 6,
      ...
      correctAnswer: 1,
      explanation:
        'Always follow Safety Data Sheet guidance and report exposures to your supervisor immediately.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'PUWER requires equipment to be suitable, maintained, and used by competent persons.',
    },
    {
      id: 8,
      ...
      correctAnswer: 1,
      explanation:
        'Serious injuries requiring hospital treatment are typically reportable under RIDDOR.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'RIDDOR reporting is required for specified injuries (fractures, amputations, serious burns), over-7-day incapacitation, dangerous occurrences, and specified occupational diseases. Your supervisor will determine if reporting is needed.',
    },
    {
      question: "What's the difference between PUWER and electrical safety regulations?",
      answer:
        'PUWER covers all work equipment safety, while EAWR specifically covers electrical safety. Both apply to electrical equipment - PUWER for general equipment safety, EAWR for electrical-specific hazards.',
    },
    {
      question: 'Where do I find Safety Data Sheets (SDS)?',
      answer:
        'SDS should be readily available where hazardous substances are stored or used. Your employer must provide access to them. They contain vital information about hazards, handling, and emergency procedures.',
    },
    {
      question: 'Can apprentices use all types of electrical equipment?',
      answer:
        "Only if they're trained and competent on that specific equipment. PUWER requires training and competence. Complex or high-risk equipment may require additional authorisation.",
    },
    {
      question: 'What PPE is required under COSHH?',
      answer:
        'PPE depends on the specific hazardous substance and exposure route. Common electrical trade PPE includes safety glasses, gloves (chemical-resistant for solvents), and respiratory protection for dust. Follow the COSHH assessment.',
    },
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <header className="mb-6 sm:mb-8">
          ...
          <p className="text-white">
            Master essential UK safety regulations for electrical work. Learn incident reporting,
            equipment safety, and hazardous substance controls.
          </p>
        </header>
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-base text-foreground">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  RIDDOR (incident reporting), PUWER (equipment safety), COSHH (hazardous
                  substances).
                </li>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Incident reporting procedures, equipment checks, safety
                  data sheets.
                </li>
                <li>
                  <strong>Use:</strong> Pre-use equipment checks, proper substance handling,
                  incident reporting.
                </li>
                <li>
                  <strong>Check:</strong> COSHH assessments, equipment inspection dates, reporting
                  requirements.
                </li>
              </ul>
            </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <ul className="list-disc pl-6 space-y-2 text-base text-foreground">
            <li>
              Understand what incidents must be reported under RIDDOR and reporting procedures.
            </li>
            ...
            <li>
              Follow proper procedures for incident reporting, equipment use, and substance
              handling.
            </li>
          </ul>
        </Card>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            ...
            <p className="text-base text-foreground mb-4">
              RIDDOR sets legal duties to report specified work-related injuries, diseases, and
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-red-600 dark:text-elec-yellow mb-1">
                      RIDDOR Reporting Requirements and Process
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>What must be reported:</strong> Specified injuries, diseases and
                      dangerous occurrences.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>
                        Specified injuries (fractures, amputations, serious burns, loss of
                        consciousness)
                      </li>
                      <li>Over-7-day incapacitation from work-related injury</li>
                      <li>
                        Dangerous occurrences (electrical short circuits causing fire/explosion)
                      </li>
                      <li>Specified occupational diseases diagnosed by a doctor</li>
                    </ul>
                    <p className="text-base text-foreground mb-2">
                      <strong>Reporting process:</strong> Use HSE systems with proper timescales.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>
                        Report immediately for fatal/specified injuries (within 10 days for
                        over-7-day injuries)
                      </li>
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Electrical context:</strong> Many electrical incidents are reportable
                      under RIDDOR.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Key principle:</strong> Report serious incidents to help prevent
                      future occurrences and meet legal duties
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-6">
            ...
            <p className="text-base text-foreground mb-4">
              PUWER ensures that work equipment is suitable, safe, inspected, maintained, and used
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-green-600 dark:text-green-400 mb-1">
                      PUWER Equipment Safety Requirements
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>Equipment suitability:</strong> All equipment must be suitable for its
                      intended use.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      ...
                      <li>
                        Guards, protection devices, and safety features must be fitted and used
                      </li>
                      <li>Only trained/competent persons may use equipment</li>
                    </ul>
                    <p className="text-base text-foreground mb-2">
                      <strong>Pre-use equipment checks:</strong> Essential safety verification
                      before use.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Common electrical equipment:</strong> Examples requiring PUWER
                      compliance.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Key principle:</strong> Equipment must be suitable, maintained, and
                      used by competent persons with proper training
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-6">
            ...
            <p className="text-base text-foreground mb-4">
              COSHH requires employers to assess and control exposure to hazardous substances that
              could harm health:
            </p>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-elec-yellow mb-1">
                      COSHH Assessment and Control Process
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>The COSHH process:</strong> Five-step approach to hazardous substance
                      control.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>Assess: Identify hazardous substances and exposure risks</li>
                      <li>
                        Control: Implement hierarchy of controls (eliminate, substitute, enclose,
                        ventilate, PPE)
                      </li>
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Common electrical trade substances:</strong> Typical hazardous
                      materials encountered.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>
                        Silica dust from drilling/chasing masonry - requires extraction and RPE
                      </li>
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Control measures:</strong> Hierarchy of protection methods.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Safety Data Sheets (SDS):</strong> Every hazardous substance must have
                      an SDS with hazard identification, safe handling, and emergency procedures
                    </div>
                  </div>
                </div>
              </div>
