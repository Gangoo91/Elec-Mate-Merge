...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Magnetic flux is measured in Webers (Wb). One Weber equals one volt-second, representing the total magnetic field passing through a surface.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Flux density B = Phi / A, where Phi is flux in Webers and A is area in square metres. Flux density is measured in Tesla (T) or Wb/m squared.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Permeability (mu) indicates how easily a material can be magnetised - how well it conducts magnetic flux. High permeability materials like iron are easily magnetised.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'MMF = N x I = 500 x 2 = 1000 Ampere-turns (At). This is the magnetic equivalent of voltage in an electrical circuit.',
  },
];
...
const quizQuestions = [
  {
    question:
      'Calculate the flux density in a core with cross-sectional area 0.01 m squared carrying 0.05 Wb of flux.',
    options: ['0.5 T', '5 T', '0.005 T', '50 T'],
    correctIndex: 1,
    explanation:
      'B = Phi / A = 0.05 / 0.01 = 5 Tesla. This is a high flux density, typical of transformer cores at maximum loading.',
  },
  {
    question:
      'What is the magnetic field strength H in a 200mm long magnetic circuit with 400 At MMF?',
    options: ['2000 At/m', '80 At/m', '200 At/m', '800 At/m'],
    correctIndex: 0,
    explanation:
      'H = MMF / l = F / l = 400 / 0.2 = 2000 At/m. Magnetic field strength is measured in Ampere-turns per metre.',
  },
  {
  ...
  {
    question:
      'What is the reluctance of a magnetic path 0.5m long with area 0.002 m squared and permeability 0.005 H/m?',
    options: ['50,000 At/Wb', '500 At/Wb', '5,000 At/Wb', '0.002 At/Wb'],
    correctIndex: 0,
    explanation:
      'Reluctance S = l / (mu x A) = 0.5 / (0.005 x 0.002) = 0.5 / 0.00001 = 50,000 At/Wb.',
  },
  {
    ...
    options: [
      ...
      'Little change in B despite increasing H',
      'Maximum reluctance',
    ],
    correctIndex: 2,
    explanation:
      "After saturation, further increases in magnetic field strength H produce little additional flux density B. The material's magnetic domains are fully aligned.",
  },
  {
    question: 'What is hysteresis loss in magnetic materials?',
    options: [
      'Energy lost due to resistance',
      'Energy lost reversing magnetic domains each cycle',
      'Energy lost to eddy currents',
      'Energy stored in the magnetic field',
    ],
    correctIndex: 1,
    explanation:
      'Hysteresis loss is energy required to reverse the magnetic domain alignment in each AC cycle. It appears as heat and is proportional to the area of the BH loop.',
  },
  {
    question:
      'A magnetic circuit has reluctance 100,000 At/Wb and MMF of 500 At. What is the flux?',
    options: ['0.005 Wb', '50 Wb', '200 Wb', '0.05 Wb'],
    correctIndex: 0,
    explanation:
      "Using Ohm's law for magnetic circuits: Phi = MMF / S = 500 / 100,000 = 0.005 Wb = 5 mWb.",
  },
  {
    question: 'Why are transformer cores laminated?',
    options: [
      'To increase flux density',
    ...
    correctIndex: 1,
    explanation:
      'Laminations break up the path for eddy currents, which are induced currents that circulate in the core and cause I squared R heating. Thinner laminations mean lower eddy current losses.',
  },
  {
    ...
    correctIndex: 0,
    explanation:
      'The permeability of free space mu_0 = 4pi x 10^-7 H/m = 1.257 x 10^-6 H/m. This is a fundamental constant in electromagnetism.',
  },
  {
    question: 'What does high retentivity in a magnetic material indicate?',
    options: [
      'Easy to magnetise',
      'Retains magnetism well after field removed',
      'High resistance',
      'Low permeability',
    ],
    correctIndex: 1,
    explanation:
      'High retentivity means the material retains significant flux density after the magnetising force is removed. This is desirable for permanent magnets but undesirable for transformer cores.',
  },
  {
    question:
      'Calculate the total flux in a core with B = 1.2T and cross-sectional area of 50 cm squared.',
    options: ['6 mWb', '60 mWb', '0.6 mWb', '600 mWb'],
    correctIndex: 0,
    explanation:
      'Phi = B x A = 1.2 x 0.005 = 0.006 Wb = 6 mWb. Note: 50 cm squared = 50 x 10^-4 m squared = 0.005 m squared.',
  },
  {
    question:
      'Which type of magnetic material would be best for an electromagnet that must quickly switch on and off?',
    options: [
      'Hard magnetic material with high retentivity',
      'Soft magnetic material with low retentivity',
      'Permanent magnet material',
      'Non-magnetic material',
    ],
    correctIndex: 1,
    explanation:
      'Soft magnetic materials with low retentivity and low coercivity can be magnetised and demagnetised quickly, making them ideal for electromagnets and transformer cores.',
  },
];
...
const faqItems = [
  {
    ...
    answer:
      'Magnetic flux (Phi) is the total amount of magnetic field passing through a surface, measured in Webers (Wb). Flux density (B) is the flux per unit area, measured in Tesla (T) or Wb/m squared. If you imagine magnetic field lines, flux is the total number of lines through a surface, while flux density is how closely packed those lines are.',
  },
  {
    question: 'Why is the BH curve important for electrical engineers?',
    answer:
      'The BH curve shows the relationship between magnetic field strength (H) and flux density (B) for a material. It reveals important properties: initial permeability (slope), saturation point (where the curve flattens), and hysteresis characteristics. Engineers use this to select appropriate materials for transformers, motors and other magnetic devices.',
  },
  {
    question: "What is the magnetic circuit analogy to Ohm's Law?",
    answer:
      "Ohm's Law for magnetic circuits states: Flux (Phi) = MMF / Reluctance, analogous to Current = Voltage / Resistance. MMF (Magnetomotive Force) is like voltage, Flux is like current, and Reluctance is like resistance. This analogy helps in analysing complex magnetic circuits using familiar electrical concepts.",
  },
  {
    question: 'How do air gaps affect magnetic circuits?',
    answer:
      'Air gaps have very high reluctance compared to magnetic materials (about 2000-5000 times higher for the same dimensions). Even a small air gap can dominate the total reluctance of a magnetic circuit, significantly reducing flux for a given MMF. However, air gaps are sometimes deliberately used to prevent saturation or store energy.',
  },
  {
    question: 'What causes magnetic saturation?',
    answer:
      'Magnetic saturation occurs when all the magnetic domains in a material have aligned with the applied field. Further increases in field strength produce little additional flux density because there are no more domains to align. Operating past saturation wastes energy and can cause overheating in transformers and motors.',
  },
  {
    question: 'What is the difference between soft and hard magnetic materials?',
    answer:
      'Soft magnetic materials (like silicon steel) are easily magnetised and demagnetised, with low hysteresis loss - ideal for transformers and motor cores. Hard magnetic materials (like alnico, ferrite) retain their magnetism after the field is removed - used for permanent magnets. The distinction is about ease of magnetisation reversal, not physical hardness.',
  },
];
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 mb-4">
                ...
                <table className="w-full text-white/80 mt-4">
                  ...
                  <tbody className="text-sm">
                    ...
                    <tr>
                      <td>Current (I)</td>
                      <td>Flux (Phi) in Wb</td>
                    </tr>
                    <tr>
                      <td>Resistance (R)</td>
                      <td>Reluctance (S) in At/Wb</td>
                    </tr>
                    <tr>
                      <td>Conductance (G)</td>
                      <td>Permeance in Wb/At</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="bg-yellow-900/30 border border-yellow-500/50 rounded-lg p-6">
              ...
              <ul className="text-white/80 space-y-2">
                <li>
                  ...
                  currents. Operating flux density kept below saturation.
                </li>
                <li>
                  <strong>Motor cores:</strong> Similar requirements to transformers. Grain-oriented
                  silicon steel improves efficiency. Air gaps carefully controlled to balance torque
                  and magnetising current.
                </li>
                <li>
                  <strong>Contactors and relays:</strong> Use soft iron for fast operation. Air gap
                  determines pull-in force and holding current. Shading rings prevent chatter on AC.
                </li>
                <li>
                  <strong>RCDs:</strong> High-permeability toroidal cores detect small imbalance
                  currents. Core must not saturate during fault conditions.
                </li>
              </ul>
            </div>
          </div>
