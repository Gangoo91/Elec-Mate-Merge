...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['80-100 lm/W', '40-60 lm/W', '200-250 lm/W', '100-150 lm/W'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['T5 fluorescent', 'LED', 'Metal halide', 'Compact fluorescent'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['135 lm/W', '90 lm/W', '120 lm/W', '180 lm/W'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['10-15 lm/W', '80-90 lm/W', '100+ lm/W', '40-50 lm/W'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['CRI', 'CCT', 'Power factor', 'Lumen maintenance (Lx)'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Approved Document L sets a minimum lamp efficacy and a maximum installed lighting
              power density (W/m²·100 lux) for new and refurbished schemes. As HNC engineer you
              evidence compliance on the lighting calculation summary and in the Part L SBEM/SAP
              submission.
            </>
          }
        ...
        >
          <p>
            Efficacy measures how efficiently a light source converts electrical power into visible
            light, expressed in lumens per watt (lm/W). Higher efficacy directly translates to lower
            energy costs and reduced carbon emissions — a critical factor in modern building
            services design.
          </p>
          <p>
        ...
        >
          <p>
            ...
            lighting. They offer superior efficacy, long life, instant switching, excellent dimming
            capability, and continuously improving performance.
          </p>
          <p>
        ...
        >
          ...
          <p>
            <strong>EU regulations:</strong> T8 and T5 fluorescent tubes are being phased out under
            EU RoHS and Ecodesign regulations. Plan for LED replacement.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            superseded by LED, understanding HID characteristics remains relevant for maintenance of
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>High-pressure sodium (HPS):</strong> 100-150 lm/W, CRI 20-25, traditional use
              street lighting and industrial
            </li>
            <li>
          ...
          <p>
            <strong>Replacement planning:</strong> HID lamp and ballast availability is declining as
            manufacturers focus on LED. Plan proactive LED replacement rather than waiting for
            failure.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Example 1: Efficacy Calculation.</strong> A LED panel consumes 32W and produces
            3840 lumens. What is its efficacy? Compare to a 36W T8 fluorescent producing 3350
            lumens.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Example 2: Energy Savings.</strong> An office has 100 × 2-lamp T8 fittings (72W
            each including ballast), operating 3000 hours/year. Calculate annual savings if replaced
            with 40W LED panels.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              For 100 luminaires: T5 means 200+ lamps and multiple maintenance visits; LED means
              zero lamp changes, only potential driver replacement.
            </li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 6,000 m² distribution warehouse runs 80 × 400 W metal-halide highbays (≈85 lm/W
              including ballast losses) over 4,000 hours/year. The client wants a payback case for
              an LED retrofit with daylight and PIR controls, targeting CIBSE LG7 warehouse Em = 200
              lux.
            </>
          }
          whatToDo={
            <>
              Specify a 200 lm/W LED highbay at 150 W with L80 = 100,000 hours and IP65 housing.
              Recompute layout: fewer fittings can deliver Em = 200 lux with U₀ ≥ 0.4. Add zoned PIR
              + daylight dimming (typically 30–45% additional saving). Build the payback model:
              capex × kit + install, opex saving = (Old kW − New kW) × hours × £/kWh. Quote payback,
              Part L compliance evidence, and the BREEAM Ene-03 / Hea-01 contribution.
            </>
          }
          whyItMatters={
            <>
              Highbays are a top-three energy line in any logistics building. An evidenced LED
              retrofit case unlocks ESOS / SECR reporting credit, drops the building&rsquo;s EPC
              band, and pays back inside three years. Without the lm/W and L80 numbers, the FD signs
              nothing.
            </>
          }
        />
