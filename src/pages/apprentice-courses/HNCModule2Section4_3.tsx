        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Efficacy:</strong> Lumens per watt (lm/W)
              </li>
              <li className="pl-1">
                <strong>LED:</strong> 100-150+ lm/W, 50,000-100,000h life
              </li>
              <li className="pl-1">
                <strong>Fluorescent:</strong> 80-100 lm/W, 15,000-25,000h
              </li>
              <li className="pl-1">
                <strong>Discharge:</strong> 80-150 lm/W, 10,000-20,000h
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>New projects:</strong> LED is standard choice
              </li>
              <li className="pl-1">
                <strong>Refurb:</strong> LED retrofit or replacement
              </li>
              <li className="pl-1">
                <strong>Controls:</strong> DALI dimming specification
              </li>
              <li className="pl-1">
                <strong>Life:</strong> L70/L80 ratings for LED
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white">
                HID lamps require: <strong>Ballast</strong> (current limiting),{' '}
                <strong>Ignitor</strong> (high voltage starting pulse), and often a{' '}
                <strong>capacitor</strong> (power factor correction). Electronic ballasts offer
                better performance than magnetic types. The control gear typically adds 10-15% to
                lamp wattage (system watts &gt; lamp watts).
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Efficacy Calculation
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> An office has 100 × 2-lamp T8 fittings (72W each
