      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>50 Hz UK</strong> — one cycle every 20 ms, ω = 314 rad/s
              </li>
              <li className="pl-1">
                <strong>Harmonics</strong> — multiples of 50 Hz caused by non-linear loads
              </li>
              <li className="pl-1">
                <strong>THD</strong> — total harmonic distortion, should be below 8% voltage
              </li>
              <li className="pl-1">
                <strong>Triplen harmonics</strong> — add in the neutral, causing overloading
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                THD quantifies the overall level of harmonic distortion as a single percentage
                figure:
              </p>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white mb-3">
                ...
                balanced conditions with linear loads, the neutral current is zero. With non-linear
                loads:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Triplen harmonics (3rd, 9th, 15th) from all three phases add arithmetically in the
                  neutral
                </li>
                <li className="pl-1">
                  Neutral current can reach up to 1.73 times the line current
                </li>
                <li className="pl-1">
                  The neutral conductor has no overcurrent protection (it must not be fused in TN
                  systems)
                </li>
                <li className="pl-1">
                  Older installations often used reduced-size neutral conductors (50% of line CSA)
                </li>
                <li className="pl-1">
                  Result: neutral conductor overheating, insulation degradation, potential fire
                </li>
                <li className="pl-1">
                  <strong>BS 7671 solution:</strong> Size neutral conductors at 100% of line
                  conductor CSA where harmonic currents are expected. Apply correction factors from
                  Appendix 4 Table 4C3
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  ...
                  transformers. K-factor indicates the transformer's ability to withstand harmonic
                  heating
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  backward-rotating magnetic field, causing additional losses, overheating,
                  vibration, noise and reduced efficiency. Motor temperature rise may exceed design
                  limits
                </li>
                <li className="pl-1">
                  <strong>PFC capacitors:</strong> Capacitive reactance decreases with frequency (XC
                  = 1/2πfC). At harmonic frequencies, capacitors present a low impedance and can
                  absorb excessive harmonic currents. Resonance between PFC capacitors and
                  transformer inductance can amplify specific harmonics dramatically, causing
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  ...
                  compensating currents in real time to cancel harmonics. The most effective
                  solution — can reduce THD to less than 5%. Self-adapting to changing loads. More
                  expensive than passive solutions
                </li>
                <li className="pl-1">
                  <strong>Multi-pulse rectifiers:</strong> 12-pulse (eliminates 5th, 7th) or
                  18-pulse (eliminates 5th, 7th, 11th, 13th) rectifier configurations. Require
                  specialised transformers. Commonly used in large VSD installations
                </li>
                <li className="pl-1">
                  <strong>Active front-end (AFE) drives:</strong> VSDs with IGBT-based rectifiers
                  that draw near-sinusoidal current. Expensive but provide excellent harmonic
                  performance and regenerative braking capability
                </li>
                <li className="pl-1">
                  <strong>K-rated transformers:</strong> Designed with enhanced cooling, reduced
                  eddy current losses and oversized neutral connections to withstand harmonic
                  heating. K-factor ratings: K-4 (light harmonic duty), K-13 (moderate), K-20
                  (heavy)
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Using an Oscilloscope for Waveform Analysis
              </p>
              <p className="text-sm text-white mb-3">
                ...
                oscilloscope or a multimeter with waveform display is invaluable for diagnosing
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              <p className="text-sm font-medium text-orange-400 mb-2">
                Maintenance of Harmonic Filters
              </p>
              <p className="text-sm text-white">
                ...
                annually. Check for signs of swelling, leaking dielectric, or discolouration.
                Measure the capacitance and compare to the rated value — a decrease of more than 5%
                indicates degradation. Active harmonic filters should have their performance
                verified using a power quality analyser quarterly. Check that the THD at the point
                of common coupling (PCC) remains within acceptable limits. Keep firmware updated and
                maintain adequate cooling for the power electronics.
              </p>
            </div>
