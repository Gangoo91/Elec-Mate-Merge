...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['200°C', '160°C', '300°C', '250°C'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Silicon rubber', 'Magnesium oxide powder', 'Ceramic tape', 'Glass fibre'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['FP200 Gold', 'H07RN-F', 'PVC/SWA', 'XLPE/SWA'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 134.1.1 is the regulatory hook for cable selection &amp; installation quality.
              Selecting PVC where LSF is needed, XLPE where fire-resistant is needed, or unarmoured
              where SWA is needed are all workmanship failures under 134.1.1 — even if every other
              table check passes. As designer you specify the right cable for the environment; the
              installer applies skilled workmanship to deliver it. Both signatures sit on the EIC.
            </>
          }
        ...
        <ConceptBlock title="LSF and LSZH Cables">
          ...
          <p>
            <strong>Specification tip:</strong> Check the building fire strategy document — it often
            mandates LSF/LSZH throughout or in specific areas.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="SWA Armoured Cables">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Outbuildings — protected cable to detached structures — direct burial or in duct
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Fire Performance and MI Cables">
          ...
          <p>
            <strong>
              Fire performance classifications (BS 8519) — category / fire resistance / typical
              application:
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Mineral Insulated (MI) cables:</strong> use magnesium oxide powder insulation in
            a seamless metal sheath.
          </p>
          <p>
        ...
        <ConceptBlock title="Selection Examples">
          <p>
            <strong>Example 1 — office distribution board sub-main:</strong> 100A 3-phase sub-main,
            45m in riser, 35°C ambient, grouped with 5 other circuits.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — external chiller supply:</strong> 45kW chiller on roof, supply from
            basement, 60m route including 30m underground.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Current capacity:</strong> PVC for standard, XLPE for high loads/temperatures
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              lighting on dedicated fire-rated cables, normal lighting and small power on LSF/LSZH
              (escape route requirement), an external buried sub-main from a remote generator, and
              HV ring-main feeding the substation. You need to specify cable types per zone and
              justify each choice.
            </>
          }
          whatToDo={
            <>
              Fire alarm + emergency lighting: FP200 Gold (60-min rated, BS EN 50200 PH30) clipped
              direct on the cable route. Smoke extract: FP400 (120-min). General lighting + small
              power: LSF/LSZH 6491B singles in steel trunking — meets escape route low-smoke
              requirement (Building Regs Part B). External buried sub-main: LSF SWA Cu/XLPE to BS
              6724 with sand bedding and warning tape per BS 7671 522.8. HV ring: 11&nbsp;kV
              XLPE/SWA/PVC to BS 7870. Document each choice on the cable schedule with the reference
              standard and the Reg 134.1.1 workmanship expectation passed to the install team.
            </>
          }
          whyItMatters={
            <>
              In a hospital, the fire-rated and LSF specifications are life-safety. Pick PVC in an
              escape route and the smoke generated during a fire kills before the fire does. Reg
              134.1.1 makes the workmanship of selecting and installing the right cable a mandatory
