...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['BACnet/IP', 'Modbus TCP', 'LonWorks IP', 'BACnet MS/TP'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['OpenTherm Association', 'British Standards Institution', 'ASHRAE', 'CIBSE'],
    correctAnswer: 0,
    explanation:
...
const HNCModule8Section1_5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 1 · Subsection 5"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Weather Compensation and Load Compensation">
          <p>
            ...
            demand, rather than operating at a fixed high temperature. This reduces boiler cycling,
            improves condensing operation, and can deliver 10-15% energy savings compared to fixed
            temperature control.
          </p>
          <p>
            <strong>Weather Compensation Principles</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Outdoor sensor:</strong> Measures external temperature, typically mounted on
              north-facing wall
            </li>
            <li>
            ...
            <li>
              <strong>Lower flow temps:</strong> Enable condensing boiler to operate in condensing
              mode more often
            </li>
            <li>
          ...
          <p>
            <strong>Heating Curve Selection</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Load Compensation (Room Compensation)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>OpenTherm Protocol</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Boiler modulation:</strong> No - full power or off — Yes - variable output
            </li>
            <li>
              <strong>Flow temp control:</strong> Fixed at boiler — Controlled by thermostat
            </li>
            <li>
              <strong>Cycling frequency:</strong> High - frequent on/off — Low - continuous
              operation
            </li>
            <li>
              <strong>Condensing efficiency:</strong> Lower - high temps — Higher - lower temps
            </li>
            <li>
              <strong>Diagnostic info:</strong> None — Yes - fault codes, temps
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Optimum Start/Stop and Time Control">
          <p>
            ...
            building reaches the desired temperature at the beginning of the occupancy period. This
            avoids wasting energy by starting heating too early, while ensuring comfort when
            occupants arrive.
          </p>
          <p>
            <strong>Optimum Start Factors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Optimum Stop Benefits</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Optimum Start Calculation Example</strong>
          </p>
          ...
          <p>
            <strong>Self-Learning Algorithms</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Time Control Requirements (Part L)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Space heating:</strong> Programmer with on/off times — 7-day programming with
              optimum start
            </li>
            <li>
              <strong>Hot water:</strong> Independent timing from heating — Separate programmer,
              cylinder stat
            </li>
            <li>
              <strong>Zones:</strong> Independent time control per zone — Zone programmers or
              multi-zone controller
            </li>
          </ul>
          <p>
            <strong>Energy saving:</strong> Optimum start/stop typically saves 5-10% of heating
            energy compared to fixed time schedules, with greater savings in heavyweight buildings.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Zone Control and Building Regulations">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Independent control:</strong> Each zone needs independent time and temperature
              control
            </li>
            <li>
            ...
            <li>
              <strong>TRVs:</strong> Required on all radiators except in rooms with room thermostats
            </li>
            <li>
              <strong>Boiler interlock:</strong> Wiring must prevent boiler firing when no demand
            </li>
            <li>
          ...
          <p>
            <strong>Boiler Plus Legislation (England from April 2018)</strong>
          </p>
          <p>
            <strong>Applies to:</strong> All gas and oil boiler installations in existing dwellings
          </p>
          <p>
          ...
          <p>
            <strong>Zone Valve Types and Selection</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2-port motorised:</strong> Open/closed, one per zone — Standard zone control,
              22mm/28mm
            </li>
            <li>
              <strong>3-port mid-position:</strong> A only, B only, or A+B — Heating/hot water
              selection
            </li>
            <li>
              <strong>3-port diverter:</strong> A only or B only (not both) — Priority DHW systems
            </li>
            <li>
              <strong>Thermostatic radiator valve:</strong> Modulates on room temp — Individual
              radiator control
            </li>
          </ul>
          <p>
            <strong>Wiring Centre Functions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>S Plan (2 x 2-port valves)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Y Plan (3-port mid-position)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="BMS Integration and Smart Controls">
          <p>
            ...
            optimise comfort and efficiency, meeting Boiler Plus requirements when properly
            specified.
          </p>
          <p>
            <strong>BMS Communication Protocols</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BACnet/IP:</strong> Ethernet (Cat5e/6) — Building-wide HVAC control
            </li>
            <li>
              <strong>BACnet MS/TP:</strong> RS-485 twisted pair — Field device connection
            </li>
            <li>
              <strong>Modbus RTU:</strong> RS-485 twisted pair — Equipment monitoring
            </li>
            <li>
              <strong>Modbus TCP:</strong> Ethernet — Plant room integration
            </li>
            <li>
              <strong>KNX:</strong> TP/RF/IP variants — Building automation
            </li>
            <li>
              <strong>OpenTherm:</strong> 2-wire connection — Thermostat-boiler interface
            </li>
          </ul>
          <p>
            <strong>BMS Functions for Heating Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Control:</strong> Setpoints, schedules, optimum start, weather compensation
            </li>
            <li>
              <strong>Alarming:</strong> Fault detection, temperature excursions, equipment failures
            </li>
            <li>
              <strong>Trending:</strong> Historical data logging for analysis and reporting
            </li>
            <li>
              <strong>Integration:</strong> Coordination with ventilation, lighting, fire systems
            </li>
            <li>
          ...
          <p>
            <strong>Smart Thermostat Features (Boiler Plus Compliant)</strong>
          </p>
          <p>
          ...
          <p>
            ...
            equipment has the required communication interfaces. Many modern boilers support BACnet,
            Modbus, or OpenTherm natively; older equipment may need gateway devices.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Select the heating curve for a 1990s semi-detached house with
            standard insulation and correctly sized radiators.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Size zone valves for a domestic S-plan system with heating
            and hot water zones.
          </p>
          <p>System data:</p>
          ...
          <p>
            <strong>Scenario:</strong> Specify compliant controls for a combi boiler installation in
            England.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>TRV in thermostat room:</strong> Causes control conflict - leave thermostat
                room without TRV
              </li>
              <li>
              ...
              <li>
                <strong>Ignoring Boiler Plus:</strong> Installations without compliant controls fail
                inspection
              </li>
            </ul>
          }
