...
const HNCModule2Section1_7 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 1 · Subsection 7"
        title="Comfort Conditions"
        backTo="/study-centre/apprentice/h-n-c-module2-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Human thermal comfort - the six factors, operative temperature, PMV/PPD and the local
          effects that drive complaints.
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              criteria and recommended conditions you actually put on a drawing. You are expected to
              know the six inputs, what PMV and PPD mean, and why an environment can satisfy the
              whole-body index and still generate complaints. Look the specific numeric criteria up
              in the current editions rather than working from memory.
            </>
          }
        ...
        >
          ...
          <p>
            ...
            space is a comfort decision, and moving it a degree moves the heat load, emitter sizes,
            air volumes and plant duty with it.{' '}
            <strong>It is what gets reported as a fault:</strong> most post-handover complaints
            about building services are comfort complaints - too hot, too cold, draughty, stuffy -
            and they are rarely plant failures, usually distribution, control or radiant problems.{' '}
            <strong>And it is an energy trade-off:</strong> every degree of winter overheating and
            summer overcooling costs fuel for the life of the building, and tight comfort bands,
            overlapping setpoints and oversized plant all land on the energy bill.
          </p>
          <p>
            Uncomfortable occupants also defeat the design intent: they open windows mid-heating
            season, bring in personal heaters that load final circuits, and tape over diffusers. You
            cannot make everyone comfortable, and the models say so explicitly - you design for the
            majority, eliminate the local effects that create the loudest complaints, and give
            occupants real control at the margins.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              surrounding surfaces. Cold glazing, warm ceilings, radiant panels and direct sunlight
              all move it, and none of them move the air temperature much.
            </li>
            <li>
              <strong>Relative humidity (%)</strong> - governs how readily sweat evaporates. In the
              normal indoor band its effect on sensation is modest; at the extremes it dominates.
            </li>
            <li>
          ...
          <p>
            ...
            picking area cannot share a design temperature, because the seated operator is near 1
            met and the picker walking with loads is well above it. A church with cold masonry is
            uncomfortable at an air temperature that would be fine in a well-insulated office,
            because radiant conditions differ. A relaxed summer dress code lowers clo, which raises
            the comfortable temperature - a free reduction in cooling energy.
          </p>
          <p>
            <strong>Design consequence:</strong> when a comfort complaint arrives, ask which of the
            six has changed. Very often air temperature is exactly as designed and one of the other
            five has moved.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Air temperature and mean radiant temperature are independent quantities that can differ
            substantially in the same room at the same moment. The body exchanges heat with the air
            by convection and with surrounding surfaces by radiation, and it does not distinguish
            between the two when it reports whether it is comfortable.
          </p>
          <p>
            <strong>What it is:</strong> the uniform temperature of an imaginary enclosure that
            would give the occupant the same net radiant exchange as the real, non-uniform room. It
            represents every surface the occupant can see, weighted by how much of their field of
            view each surface occupies and by surface emissivity.{' '}
            <strong>How it is measured:</strong> with a globe thermometer - a matt black sphere with
            a sensor at its centre. It equilibrates under combined radiant and convective exchange,
            and mean radiant temperature is derived from the globe reading, the air temperature and
            the air velocity. A plain wall thermometer cannot see it.
          </p>
          <p>
            ...
            closer the occupant, the stronger the effect. Mean radiant temperature falls, operative
            temperature falls with it, and the occupant feels cold although the thermostat is
            satisfied. The same glass chills the air touching it, adding a cold downdraught, so the
            occupant gets a radiant penalty and a draught together.
          </p>
          <p>
          ...
          <p>
            ...
            warms the glass; use radiant systems where the fabric is poor and the volume large; and
            control solar gain at the facade so the summer penalty never enters the space.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            temperature the occupant effectively experiences. It is the figure comfort criteria are
            properly expressed against, and the figure you should be designing to.
          </p>
          <p>
            <strong>General form:</strong> a weighted combination of the two, with the weighting set
            by the relative strength of convective and radiant transfer at the body surface. As air
            velocity rises, convection strengthens and the weighting shifts towards air temperature.
          </p>
          <p>
            ...
            <strong>t_op &asymp; (t_air + t_r) / 2</strong>, both in °C. That is accurate enough for
            HNC design work and for diagnosis on site; where air velocity is elevated, weight air
            temperature more heavily.
          </p>
          <p>
            <strong>Worked example 1 - cold perimeter office:</strong> air 22 °C, mean radiant 18 °C
            because of large cold glazing, still air.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            ...
            panels reaches a mean radiant temperature of 26 °C at an air temperature of 20 °C, still
            air.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              ...
              ventilation and infiltration losses scale with the air-to-outside difference - so that
              3 K is a permanent saving in a tall, leaky building
            </li>
          </ul>
          <p>
            <strong>Worked example 3 - reading it backwards:</strong> you need 21 °C operative and a
            survey shows mean radiant stuck at 17 °C. Then 21 = (t_air + 17) / 2, so t_air = (21
            &times; 2) - 17 = <strong>25 °C</strong>. Holding 25 °C of air to compensate for cold
            surfaces is expensive, stratifies badly and feels stuffy - the quantified argument for
            fixing the fabric instead.
          </p>
          <p>
        ...
        >
          ...
          <p>
            ...
            and desk fans exploit that at a fraction of the energy of mechanical cooling. When it is
            neutral or cool, the same velocity is perceived as draught - among the most frequent
            complaints in air-conditioned buildings. Turbulence matters as well as mean speed,
            because fluctuating airflow reads as draught far more readily than steady flow at the
            same average velocity, and so does temperature: the cooler the moving air, the greater
            the draught risk at any given velocity.
          </p>
          <p>
            <strong>Design consequence:</strong> occupied-zone velocity is an output you check, not
            an accident of the terminal you happened to specify. Diffuser selection, throw, supply
            air temperature difference and occupied-zone position go together.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            1 clo corresponds approximately to a typical business suit. Light summer indoor clothing
            sits appreciably below that and heavy outdoor winter clothing with an overcoat
            appreciably above it. Clothing is controlled by the occupant and responds to season,
            dress code and the weather that morning - not to your design assumptions.
          </p>
          <p>
            <strong>Metabolic rate (met)</strong> quantifies the heat the occupant generates
            internally, normalised to body surface area. The higher the met, the more heat has to be
            rejected and the cooler the environment needs to be. 1 met corresponds approximately to
            a person seated at rest, and sedentary office work sits close to it. Standing, light
            activity, walking and manual handling progressively raise it, and sustained heavy work
            raises it several-fold - which is why workshops, kitchens, gyms and warehouses are
            designed cooler than offices.
          </p>
          <p>
            <strong>Why this matters commercially:</strong> the personal factors are the cheapest
            levers available. A summer dress code that drops clo lets the cooling setpoint rise with
            no loss of satisfaction and no capital spend. Conversely, specifying a temperature
            suited to seated work and then letting the space be used for active work guarantees
            complaints however good the plant is.
          </p>
          <p>
        ...
        >
          <p>
            ...
            evaluates the thermal load on the body - the difference between heat produced internally
            and heat actually lost to the environment - and maps that onto a subjective sensation
            scale calibrated against large panels of test subjects.
          </p>
          <p>
          ...
          <p>
            PPD estimates the percentage of a large group who would be dissatisfied with the thermal
            environment. The relationship is symmetrical about neutral - equally too warm and
            equally too cool give the same PPD - and <strong>PPD never falls below about 5%</strong>
            , even at PMV = 0, because individuals differ in physiology, clothing and preference. It
            rises steeply as PMV moves away from zero, so small departures from the design condition
            produce disproportionate increases in complaints.
          </p>
          <p>
            ...
            humidity and air velocity that achieves it for a stated clothing and activity assumption
            - and you record those assumptions, because the answer is meaningless without them.
          </p>
          <p>
            <strong>The most common misuse:</strong> quoting a PMV result without stating the clo
            and met values assumed. The same room is comfortable at markedly different temperatures
            for a suited seated occupant and a lightly dressed active one.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              environment, so it does not describe someone who has just come in from outside, or a
              space with rapidly swinging conditions
            </li>
            <li>
            ...
            <li>
              <strong>No adaptation over time</strong> - it does not capture acclimatisation or the
              shift in expectations over a warm or cold spell
            </li>
            <li>
              <strong>Population basis</strong> - it predicts a group mean, so it is least reliable
          ...
          <p>
            ...
            physiological (acclimatisation) and psychological (expectation, and the sense of having
            control). Control is central: occupants who can act on their environment tolerate a far
            wider range than those who cannot, so a sealed building with no local control must be
            held much closer to the calculated optimum. And the band moves with the weather -
            adaptive criteria express acceptable indoor temperature as a function of a running mean
            of recent outdoor temperature rather than as a fixed number.
          </p>
          <p>
            ...
            space its occupants are perfectly content with, and can be used to justify unnecessary
            mechanical cooling.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              ankles feel it first. Causes: cold downdraught off glazing, badly selected or located
              diffusers, excessive supply air temperature difference, leaky facades. Remedies: cut
              occupied-zone velocity, raise supply air temperature and increase volume, select throw
              and induction so mixing happens above the occupied zone, put emitters under glazing,
              seal the fabric.
            </li>
            <li>
              ...
              <strong>A warm ceiling is the least tolerated case</strong>, becoming uncomfortable at
              a smaller asymmetry than any other configuration, which constrains radiant panel
            ...
            <li>
              <strong>Vertical air temperature difference - warm head, cold feet.</strong> Warm air
              rises, so temperature stratifies with height, and a large head-to-ankle difference
              causes discomfort even when the average is correct. Causes: high-level warm air
              heating, tall spaces, poor mixing, purely convective heating over a cold floor.
              Remedies: underfloor or low-level emitters, destratification fans, floor insulation,
              and displacement ventilation with the gradient explicitly checked.
            </li>
            <li>
              ...
              finishes such as stone and tile, which feel colder than carpet at the same temperature
              because they draw heat away faster. Too warm: underfloor heating run above its surface
              temperature limit. Remedies: insulate the slab, respect the limit, and account for the
              finish where people stand still for long periods.
            </li>
          </ul>
          <p>
            <strong>Why this list matters:</strong> when someone reports a problem in a space whose
            average conditions are correct, the answer is almost always one of these four. Work
            through them before you touch a setpoint.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Comfort is not checked at the end of a design - it is the input at the start. The chain
            runs from criteria to conditions to loads to equipment, and a mistake at the top
            propagates all the way down.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Internal design conditions.</strong> Pick the design operative temperature
              and humidity band per space type from CIBSE Guide A, based on expected activity and
              clothing, and record the clo and met assumptions alongside them - without those the
              numbers cannot be defended. Those figures become the internal temperatures in the heat
              loss and cooling load calculations covered earlier.
            </li>
            <li>
              <strong>2. Emitter type.</strong> Poor fabric, tall volume, intermittent occupancy -
              radiant wins, because it lifts mean radiant temperature without heating the whole air
              volume. Well insulated, normal ceiling height, continuous occupancy - convective
              emitters or air systems are simpler and cheaper. Cold-glazing perimeters need
              perimeter emitters regardless of total load, because the problem is radiant and local
              rather than a shortfall in kilowatts.
            </li>
            <li>
              <strong>3. Terminals and air distribution.</strong> Supply air temperature difference
              and diffuser throw must land the air outside the occupied zone - draught complaints
              are usually a terminal selection failure, not a plant failure. Displacement
              ventilation must be checked against the vertical gradient criterion, and radiant panel
              temperature and mounting height against the warm ceiling asymmetry criterion.
            </li>
            <li>
              <strong>4. Zoning and control.</strong> Zone by exposure and use - perimeter and
              internal zones behave completely differently, and so do north and south facades. Site
              the sensor where it represents the occupied zone, not above a photocopier or in direct
              sun. Set a genuine deadband between heating and cooling, because overlapping setpoints
              produce simultaneous heating and cooling that is invisible to occupants and enormously
              expensive. Give occupants local control where you can.
            </li>
          </ul>
          <p>
            ...
            movement, dress code, occupant control - is usually far cheaper than the plant capacity
            needed to hold a narrow one, and fixing a radiant problem at the fabric beats
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>1 clo</strong> &asymp; a typical business suit; <strong>1 met</strong> &asymp;
              a person seated at rest
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Raising the setpoint to mask a radiant problem</strong> - expensive, stuffy,
                stratified, and it never fully works
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A south-east facing open-plan office generates persistent complaints. Staff along the
              fully glazed perimeter say they are cold all winter morning and overheat on sunny
              afternoons. Staff in the internal zone are content. The BMS trend shows the perimeter
              zone air temperature holding steady at its 22 °C setpoint throughout, and the
              facilities manager has raised the setpoint twice - which made the internal zone too
              warm without silencing the perimeter complaints.
            </>
          }
          whatToDo={
            <>
              Stop adjusting the setpoint: air temperature is doing exactly what it was asked to do,
              so the problem lies in one of the other five factors. Take a globe thermometer survey
              at seated head height along the perimeter and in the internal zone. Expect perimeter
              mean radiant temperature several degrees below air temperature on a cold morning - at
              22 °C air and 18 °C mean radiant the operative temperature is (22 + 18) / 2 = 20 °C,
              while the internal zone with surfaces near air temperature is genuinely at 22 °C. That
              one calculation explains the split. Then measure velocity at ankle level near the
              glass to confirm cold downdraught, and check whether the perimeter emitters are still
              under the glazing or were relocated during a churn. Survey again in sun for the
              afternoon complaint: mean radiant temperature will now sit above air temperature.
              Remedies in order of effectiveness: control solar gain at the facade; improve the
              glazing; restore perimeter emitters under the glass; and split perimeter and internal
              zones onto separate control with a sensor in each. Revisit setpoints last, and against
          ...
          whyItMatters={
            <>
              ...
              against the six factors, and against operative rather than air temperature, identifies
              the real cause in a single site visit and points at remedies that cost less to run,
              not more.
            </>
          }
        />
