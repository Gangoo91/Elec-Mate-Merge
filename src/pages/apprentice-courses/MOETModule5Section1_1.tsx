      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <p className="text-lg text-muted-foreground">
            This section covers the fundamental principles of sensing and the differences between
            analogue and digital signal processing in control systems.
          </p>

          <p>
            Content for this subsection will be added here covering the principles of sensing and
            signal types.
          </p>
        </div>
      </div>
