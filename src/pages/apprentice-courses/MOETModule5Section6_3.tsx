      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>WirelessHART</strong> is the leading process wireless standard — mesh
                topology with 5-10 year battery life
              </li>
              <li className="pl-1">
                <strong>IIoT</strong> connects sensors and equipment to edge and cloud platforms for
                data-driven optimisation
              </li>
              <li className="pl-1">
                <strong>MQTT</strong> is the dominant IoT messaging protocol using publish/subscribe
              </li>
              <li className="pl-1">
                <strong>Edge computing</strong> processes data locally; cloud provides analytics and
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Access method:</strong> TDMA (Time Division Multiple Access) with
                ...
                <li className="pl-1">
                  <strong>Battery life:</strong> 5-10 years with configurable update rates
                  (typically 8-60 seconds)
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                ISA100.11a provides similar capabilities to WirelessHART with additional
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Maintenance tip:</strong> When deploying wireless devices, always conduct a
              site survey first to assess the RF environment. Metal structures, process vessels, and
              other equipment create unpredictable reflections and dead spots that can affect mesh
              coverage. Plan gateway and repeater locations based on the survey results, not
              assumptions.
            </p>
          </div>
        </section>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  ...
                  vibration monitors, power meters, and existing instrumentation with digital
                  outputs
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Latency</td>
                      <td className="border border-white/10 px-3 py-2">Very low (milliseconds)</td>
                      <td className="border border-white/10 px-3 py-2">
                        Higher (depends on connectivity)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Bandwidth</td>
                      <td className="border border-white/10 px-3 py-2">
                        Minimal (sends summaries)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        High (receives raw or processed data)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Offline capability</td>
                      <td className="border border-white/10 px-3 py-2">Continues to function</td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">Limited local storage</td>
                      <td className="border border-white/10 px-3 py-2">Virtually unlimited</td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Analytics</td>
                      <td className="border border-white/10 px-3 py-2">Real-time, simple models</td>
                      <td className="border border-white/10 px-3 py-2">
                        Advanced ML, historical trends
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Most effective IIoT architectures combine edge and cloud
              processing. The edge handles time-critical local decisions and data reduction, whilst
              the cloud provides long-term storage, advanced analytics, machine learning model
              training, and enterprise-wide dashboards.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Predictive maintenance:</strong> Vibration analysis, thermal monitoring,
                  oil condition sensing, and motor current analysis to predict failures before they
                  occur — shifting from time-based to condition-based maintenance
                </li>
                <li className="pl-1">
                  <strong>Energy management:</strong> Real-time monitoring and optimisation of
                  energy consumption across the plant, identifying waste and enabling demand
                  response
                </li>
                <li className="pl-1">
                  <strong>Remote monitoring:</strong> Accessing plant data from anywhere for
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Predictive analytics:</strong> Use historical and real-time data to
                  predict equipment behaviour and remaining useful life
                </li>
                <li className="pl-1">
                  <strong>Training:</strong> Provide realistic training environments for operators
                  and maintenance technicians without risk to the real plant
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                ...
                without modifying the control system — they operate independently, reporting data to
                a separate analytics platform. When installing wireless vibration or temperature
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                IIoT Security Principles
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>OT/IT separation:</strong> Never bridge the control network directly to
                  the internet or cloud — use DMZ gateways
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Firmware updates:</strong> Secure, authenticated firmware update
                  mechanisms for edge and field devices
                </li>
                <li className="pl-1">
                  <strong>IEC 62443 compliance:</strong> Follow the industrial cybersecurity
                  standard for all IoT deployments
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                ...
                secured boundary — ideally using one-way data diodes for the most critical systems,
                or secured OPC UA gateways in a DMZ for bidirectional communication. Never allow
                external cloud services or IoT platforms to have direct inbound access to the
                control network. A compromised IoT device must not provide a pathway into the
                control system.
              </p>
            </div>

            <p className="text-sm text-white/90 italic">
              <strong>Note:</strong> Under ST1426, maintenance technicians are expected to have
              awareness of emerging technologies including wireless instrumentation and IoT,
              understand the basic architecture and security requirements, and recognise the role of
              these technologies in modern maintenance strategies such as condition-based and
