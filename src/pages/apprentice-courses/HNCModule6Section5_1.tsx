...
const quizQuestions = [
  {
    ...
    options: ['Annually', 'Every 4 years', 'Every 2 years', 'Every 5 years'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Power quality analyser', 'Lux meter', 'Tachometer', 'Thermal imaging camera'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Power factor', 'Maximum demand', 'Energy Use Intensity (EUI)', 'Load factor'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Environment Agency', 'Building Research Establishment', 'CIBSE', 'National Grid'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ESOS Phase 3 (compliance deadline 5 December 2023, with subsequent phases every 4
              years) is mandatory for large UK organisations (&gt;250 employees or &gt;£44m turnover
              and &gt;£38m balance sheet). The audit must use EN 16247 methodology and be signed off
              by an ESOS Lead Assessor. Phase 3 added a public action plan requirement — committing
              to identified savings.
            </>
          }
        ...
        <ConceptBlock title="ESOS and Regulatory Framework">
          <p>
            The Energy Savings Opportunity Scheme (ESOS) is the UK's implementation of Article 8 of
            the EU Energy Efficiency Directive. It mandates energy audits for large organisations to
            identify cost-effective energy saving opportunities and drive improved energy
            performance.
          </p>
          <p>
            <strong>ESOS Qualification Criteria:</strong>
          </p>
          ...
          <p>
            <strong>ESOS Compliance Timeline</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Phase 1:</strong> 31 December 2014 — 5 December 2015
            </li>
            <li>
              <strong>Phase 2:</strong> 31 December 2018 — 5 December 2019
            </li>
            <li>
              <strong>Phase 3:</strong> 31 December 2022 — 5 December 2023
            </li>
            <li>
              <strong>Phase 4:</strong> 31 December 2026 — 5 December 2027
            </li>
          </ul>
          <p>
            <strong>ESOS Coverage Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              • Audits must cover <strong>at least 95%</strong> of total energy consumption (5% de
              minimis since the 2023 amendment)
            </li>
        ...
        <ConceptBlock title="Audit Types and Methodology">
          <p>
            ...
            investment-grade analyses. The ASHRAE classification provides a widely-adopted framework
            defining three distinct audit levels, each with specific purposes and deliverables.
          </p>
          <p>
            <strong>Level I: Walk-Through</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Level II: Energy Survey</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Level III: Investment-Grade</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Audit Methodology (EN 16247)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Preliminary Contact:</strong> Define scope, boundaries, objectives — Audit
              agreement, data request
            </li>
            <li>
              <strong>2. Start-up Meeting:</strong> Review data, discuss operations — Understanding
              of site/process
            </li>
            <li>
              <strong>3. Data Collection:</strong> Gather bills, drawings, schedules — Baseline
              consumption data
            </li>
            <li>
              <strong>4. Field Work:</strong> Site survey, measurements, interviews — Equipment
              inventory, readings
            </li>
            <li>
              <strong>5. Analysis:</strong> Energy balance, benchmarking, ECMs — Identified
              opportunities
            </li>
            <li>
              <strong>6. Reporting:</strong> Document findings, recommendations — Audit report
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Data Collection and Analysis">
          ...
          <p>
            <strong>Essential Data Requirements</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Utility Bill Analysis Techniques</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Regression analysis:</strong> Statistical relationship between consumption and
              driving variables
            </li>
          </ul>
          <p>
            <strong>Energy Performance Metrics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Energy Use Intensity (EUI):</strong> kWh/m²/year — 150-400 kWh/m²
            </li>
            <li>
              <strong>Electrical EUI:</strong> Electricity kWh/m² — 80-200 kWh/m²
            </li>
            <li>
              <strong>Fossil thermal EUI:</strong> Gas/oil kWh/m² — 70-200 kWh/m²
            </li>
            <li>
              <strong>Carbon intensity:</strong> kgCO₂/m²/year — 30-100 kgCO₂/m²
            </li>
            <li>
              <strong>Cost intensity:</strong> £/m²/year — £15-50/m²
            </li>
          </ul>
          <p>
            <strong>Half-Hourly Data Analysis</strong>
          </p>
          <p>
            <strong>Base load:</strong> Minimum overnight/weekend consumption - identify equipment
            running unnecessarily
          </p>
          <p>
            <strong>Peak demand:</strong> Maximum kW - opportunity for demand management and tariff
            optimisation
          </p>
          <p>
          ...
          <p>
            <strong>Analysis tip:</strong> Out-of-hours consumption often represents 30-50% of total
            electricity use in commercial buildings - a key focus area for quick wins.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Site Surveys and Measurement">
          ...
          <p>
            <strong>Site Survey Checklist</strong>
          </p>
          <p>
            <strong>Building Fabric</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Measurement Equipment</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Power analyser:</strong> Electrical systems — kW, kVA, PF, kWh, harmonics
            </li>
            <li>
              <strong>Clamp meter:</strong> Circuit loading — Amps, voltage, power
            </li>
            <li>
              <strong>Thermal camera:</strong> Building fabric, electrical — Surface temperature,
              heat loss
            </li>
            <li>
              <strong>Lux meter:</strong> Lighting assessment — Illuminance levels (lux)
            </li>
            <li>
              <strong>Data logger:</strong> Long-term monitoring — Temperature, humidity, CO₂
            </li>
            <li>
              <strong>Flue gas analyser:</strong> Boiler efficiency — O₂, CO₂, CO, efficiency %
            </li>
            <li>
              <strong>Anemometer:</strong> Ventilation assessment — Air velocity, flow rate
            </li>
            <li>
              <strong>Ultrasonic flow meter:</strong> Water/heating systems — Flow rate, heat
              transfer
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Calibration:</strong> Ensure all instruments are within calibration date and
            ...
            <li>
              <strong>Duration:</strong> Spot measurements suit stable systems; logging required for
              varying loads
            </li>
            <li>
          ...
          <p>
            <strong>Survey tip:</strong> Interview facilities staff and building users - operational
            practices often explain unexpected consumption patterns that measurements alone cannot
            reveal.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Calculate EUI for a 5,000m² office building consuming 850,000
            kWh electricity and 450,000 kWh gas annually.
          </p>
          <p>Given:</p>
          ...
          <p>
            Assessment: Electrical consumption above benchmark - investigate lighting and cooling
          </p>
          <p>
            <strong>Example 2: Simple Payback Calculation</strong>
          </p>
          <p>
            <strong>Scenario:</strong> LED lighting retrofit for an office floor - assess financial
            viability.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Compare heating consumption between a mild year and a cold
            year.
          </p>
        ...
        <Scenario
          ...
          situation={
            <>
              An ESOS Phase 3 audit on a 28-site retail estate identifies a portfolio of energy
              conservation measures totalling £840k investment with 4.2-year payback — a 12%
              reduction in total electricity use. The client uses the audit for ESOS compliance but
              does not implement any of the measures. Phase 3 introduced an action plan disclosure
              requirement.
            </>
          }
          whatToDo={
            <>
              Two distinct issues: (1) ESOS compliance — audit and action plan must be filed; the
              regulation does not mandate implementation; (2) commercial / reputational —
              non-implementation of identified savings is increasingly questioned by investors, by
              shareholder activists, and (post 2024) by the public action plan disclosure.
              Recommendation: Lead Assessor structures the action plan as a phased programme over
              the next 4-year cycle, with priority on quick-payback measures (lighting controls, BMS
              optimisation) — making partial implementation more achievable than the full £840k
              headline figure.
            </>
          }
          whyItMatters={
            <>
              ESOS audits regularly identify 5–15% savings that go unimplemented because the
              regulation has no implementation mandate. Phase 3's action plan disclosure is the
              first lever forcing this; future phases may go further. The auditor's value is no
              longer just identifying the savings — it is designing an implementation roadmap the
