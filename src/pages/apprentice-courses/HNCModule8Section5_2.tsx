...
const quickCheckQuestions = [
  {
    ...
    options: ['1000 ohms', '10000 ohms', '100 ohms', '10 ohms'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Every month', 'Only when faulty', 'Every 5 years', 'Every 6-12 months'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['Pt100 RTD', 'Thermocouple', 'NTC thermistor', 'Pt1000 RTD'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['10000 ohms', '100 ohms', '1000 ohms', '500 ohms'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['0-500 ppm', '0-2000 ppm', '0-10000 ppm', '0-100 ppm'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.025 bar', '0.0025 bar', '2.5 bar', '0.25 bar'],
    correctAnswer: 0,
    explanation:
...
const HNCModule8Section5_2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 5 · Subsection 2"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Temperature Sensors">
          ...
          <p>
            <strong>Resistance Temperature Detectors (RTDs)</strong>
          </p>
          <p>
            RTDs use the principle that metal resistance increases with temperature. Platinum is the
            most common material due to its stability, linearity and wide temperature range.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pt100:</strong> 100 ohms — -50 to +200 deg C — Standard HVAC, AHU coils
            </li>
            <li>
              <strong>Pt1000:</strong> 1000 ohms — -50 to +200 deg C — Long cable runs, remote
              sensors
            </li>
            <li>
              <strong>Ni1000:</strong> 1000 ohms — -50 to +150 deg C — Room sensors, lower cost
            </li>
          </ul>
          <p>
            <strong>RTD Accuracy Classes (IEC 60751)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>NTC Thermistors</strong>
          </p>
          <p>
            Negative Temperature Coefficient (NTC) thermistors decrease in resistance as temperature
            rises. They offer high sensitivity but non-linear output requiring linearisation.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Thermocouples</strong>
          </p>
          <p>
            Thermocouples generate a voltage (Seebeck effect) proportional to temperature difference
            between the measurement junction and reference junction. They suit high-temperature
            applications.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type K:</strong> Chromel-Alumel — -200 to +1350 deg C — Boilers, flue gases
            </li>
            <li>
              <strong>Type J:</strong> Iron-Constantan — -40 to +750 deg C — Industrial heating
            </li>
            <li>
              <strong>Type T:</strong> Copper-Constantan — -200 to +350 deg C — Low temperature,
              food
            </li>
          </ul>
          <p>
            <strong>Wiring Configurations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2-wire:</strong> Simple but cable resistance adds to reading (not recommended
              for Pt100)
            </li>
            <li>
        ...
        <ConceptBlock title="Humidity and Air Quality Sensors">
          ...
          <p>
            <strong>Humidity Sensor Technologies</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Resistive Sensors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Humidity Sensor Specifications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Range:</strong> 0-100% RH — Full range measurement
            </li>
            <li>
              <strong>Accuracy:</strong> Plus or minus 2% RH — At 25 deg C, 10-90% RH
            </li>
            <li>
              <strong>Long-term drift:</strong> Less than 1% RH/year — Affects calibration interval
            </li>
            <li>
              <strong>Response time:</strong> Less than 30 seconds — To reach 63% of step change
            </li>
          </ul>
          <p>
            <strong>CO2 Sensors for Demand-Controlled Ventilation</strong>
          </p>
          <p>
            CO2 concentration indicates occupancy and air quality. Non-dispersive infrared (NDIR)
            sensors are standard for BMS applications, measuring CO2 absorption of infrared light.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Outdoor air:</strong> Approximately 400-420 ppm (rising due to climate change)
            </li>
            <li>
              <strong>Occupied spaces target:</strong> Less than 1000 ppm (800 ppm above outdoor)
            </li>
            <li>
          ...
          <p>
            <strong>CIBSE Guide A - Recommended CO2 Levels</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Category III (moderate expectation):</strong> Less than 1350 ppm above outdoor
            </li>
          </ul>
          <p>
            <strong>Installation tip:</strong> Mount CO2 sensors at breathing height (1.1-1.5m) away
            from doors, windows and supply air diffusers. Avoid locations near plants or areas where
            people congregate.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Pressure and Flow Sensors">
          <p>
            Pressure and flow measurement are fundamental to HVAC control. Pressure sensors monitor
            duct static pressure, filter condition and pump operation. Flow meters verify water and
            air flow rates.
          </p>
          <p>
            <strong>Pressure Measurement Types</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Pressure Transducer Technologies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Piezoresistive:</strong> Strain gauges on silicon diaphragm - most common in
              HVAC
            </li>
            <li>
              <strong>Capacitive:</strong> Diaphragm deflection changes capacitance - high accuracy
            </li>
            <li>
          ...
          <p>
            <strong>HVAC Pressure Sensor Applications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Duct static pressure:</strong> Differential — 0-1000 Pa
            </li>
            <li>
              <strong>Filter differential:</strong> Differential — 0-500 Pa
            </li>
            <li>
              <strong>Room pressure:</strong> Differential — 0-100 Pa
            </li>
            <li>
              <strong>LTHW/CHW system:</strong> Gauge — 0-10 bar
            </li>
            <li>
              <strong>Pump differential:</strong> Differential — 0-6 bar
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Flow-Pressure Relationship</strong>
          </p>
          <p>
            For differential pressure flow measurement, flow is proportional to the square root of
            pressure:
          </p>
          ...
          <p>
            ...
            across wide flow ranges. Ensure adequate straight pipe lengths upstream (10 x diameter)
            and downstream (5 x diameter).
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Signal Types, Accuracy and Calibration">
          <p>
            ...
            essential for proper BMS integration and maintaining measurement quality over the sensor
            lifetime.
          </p>
          <p>
            <strong>Analogue Signal Types</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>4-20mA:</strong> Noise immune, fault detection (0mA = break) — Requires loop
              power, higher cost — Long runs, noisy environments
            </li>
            <li>
              <strong>0-10V DC:</strong> Simple, low cost, easy to measure — Susceptible to noise,
              voltage drop — Short runs, clean environments
            </li>
            <li>
              <strong>2-10V DC:</strong> Live zero for fault detection — Less common, limited
              compatibility — Critical applications needing fault detection
            </li>
            <li>
              <strong>Resistance:</strong> Direct connection, no transmitter — Cable resistance
              affects reading — RTDs, thermistors with short cables
            </li>
          </ul>
          <p>
            <strong>4-20mA Signal Calculations</strong>
          </p>
          <p>
            <strong>Signal to Value</strong>
          </p>
          <p>Value = ((mA - 4) / 16) x Span + Zero</p>
          <p>Example: 12mA on 0-100 deg C sensor = ((12-4)/16) x 100 + 0 = 50 deg C</p>
          <p>
            <strong>Value to Signal</strong>
          </p>
          <p>mA = ((Value - Zero) / Span) x 16 + 4</p>
          <p>Example: 75 deg C on 0-100 deg C sensor = ((75-0)/100) x 16 + 4 = 16mA</p>
          <p>
            <strong>Understanding Accuracy Specifications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Accuracy (% FS):</strong> Error as percentage of full scale range - applies at
              any reading
            </li>
            <li>
              <strong>Accuracy (% reading):</strong> Error as percentage of actual reading - better
              at low readings
            </li>
            <li>
            ...
            <li>
              <strong>Drift:</strong> Change in accuracy over time - affects calibration interval
            </li>
          </ul>
          <p>
            <strong>Accuracy Example</strong>
          </p>
          ...
          <p>
            <strong>Calibration Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Frequency:</strong> Typically 6-12 months for critical sensors, annually for
              standard
            </li>
            <li>
            ...
            <li>
              <strong>Adjustment:</strong> Zero and span adjustment if within tolerance, replace if
              not
            </li>
            <li>
              <strong>Environment:</strong> Calibrate at conditions similar to installed environment
            </li>
          </ul>
          <p>
            <strong>Calibration Procedure (General)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Slow response:</strong> Check for fouling, thermal mass of installation, air
              in pressure lines.
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Flow:</strong> Insufficient straight pipe lengths, air in water flow meters
              </li>
              <li>
                <strong>CO2:</strong> Too close to supply diffusers, wrong height, drafty locations
              </li>
            </ul>
          }
