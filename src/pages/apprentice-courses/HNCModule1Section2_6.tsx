...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Avoid', 'Alert', 'Assess', 'Act'],
    correctIndex: 2,
    explanation:
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              change, the written RA may no longer be valid — the operative on the floor is the
              duty-holder for that moment, until the supervisor revises the formal RA.
            </>
          }
        ...
        <ConceptBlock title="Definition and Purpose of Dynamic Risk Assessment">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Worker-led:</strong> Performed by those doing the work, not just supervisors
            </li>
            <li>
              <strong>Supplementary:</strong> Works alongside formal risk assessments, not instead
              of them
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Multiple trades working in the same space with changing activities</li>
            <li>Occupied buildings where building users create unpredictable situations</li>
            <li>Discovery of unexpected hazards (asbestos, live services, structural issues)</li>
            <li>Weather changes affecting work in exposed or partially completed areas</li>
            <li>Equipment breakdowns or unavailability requiring work method changes</li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HSWA 1974 s.2</strong> — Relevance to DRA: Employer duty to ensure health and
              safety so far as reasonably practicable
            </li>
            <li>
              <strong>HSWA 1974 s.7</strong> — Relevance to DRA: Employee duty to take reasonable
              care for themselves and others
            </li>
            <li>
              <strong>MHSWR Reg.3</strong> — Relevance to DRA: Requirement for suitable and
              sufficient risk assessment
            </li>
            <li>
              <strong>CDM 2015 Reg.15</strong> — Relevance to DRA: Duty to report anything likely to
              endanger health or safety
            </li>
          </ul>

          <p className="text-sm text-elec-yellow/70">
            <strong>Remember:</strong> Dynamic risk assessment is a legal duty under Regulation 3 of
            MHSWR - risk assessments must remain 'suitable and sufficient', which requires ongoing
        ...
        <ConceptBlock title="When to Apply Dynamic Risk Assessment">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Unexpected hazards:</strong> Discovery of asbestos, live services, structural
              damage
            </li>
            <li>
            ...
            <li>
              <strong>Equipment issues:</strong> Breakdown, unavailability, or different equipment
              being used
            </li>
            <li>
              <strong>Personnel changes:</strong> Different workers, visitors, or building occupants
              present
            </li>
            <li>
              <strong>Emergency situations:</strong> Fire alarms, evacuations, medical emergencies
            </li>
          </ul>
          ...
          <div>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>Expected ceiling void access but asbestos insulation discovered</li>
            </ul>
          </div>
          <div>
            <p className="text-sm font-medium text-elec-yellow/80 mb-2">
            ...
            whatHappens={
              <>
                <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
                  ...
                  <li>Visual anomalies (smoke, water, sparking, structural cracks)</li>
                  <li>People behaving unusually (evacuation movements, distress)</li>
                  <li>Equipment behaving abnormally (overheating, tripping, vibration)</li>
                </ul>
              </>
            }
            doInstead={
        ...
        <ConceptBlock title="SLAM Technique and Take 5">
          ...
          <div className="grid gap-3">
            <div className="p-4 rounded-lg bg-white/5 border-l-4 border-red-500">
              ...
              <p className="text-sm">
                Pause before starting or continuing work. Create a mental break to engage your risk
                awareness. If something unexpected has occurred, stop immediately before proceeding.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border-l-4 border-yellow-500">
              <p className="font-bold text-yellow-400 mb-1">L - LOOK</p>
              <p className="text-sm">
                Actively observe your surroundings. Look up, down, and around. Identify all hazards
                present including the environment, equipment, other people, and activities. Use all
                your senses.
              </p>
            </div>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Task</strong> — What to Check: Do I understand the job? Do I have the right
              skills and training?
            </li>
            <li>
              <strong>2. Environment</strong> — What to Check: Weather, lighting, access, confined
              spaces, heights, other workers
            </li>
            <li>
              <strong>3. Equipment</strong> — What to Check: Right tools? Good condition?
              Tested/inspected? PPE available?
            </li>
            <li>
              <strong>4. Hazards</strong> — What to Check: Electrical, mechanical, chemical,
              biological, ergonomic hazards
            </li>
            <li>
              <strong>5. Controls</strong> — What to Check: Are existing controls sufficient? What
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Last Minute Risk Assessment (LMRA):</strong> Final check immediately before
              starting hazardous activities
            </li>
            <li>
              <strong>Stepback 5x5:</strong> Five steps back, five seconds to observe before acting
            </li>
            <li>
              <strong>Job Safety Analysis (JSA):</strong> Breaking tasks into steps and assessing
              each step
            </li>
          </ul>

          <p className="text-sm text-elec-yellow/70">
            <strong>Best practice:</strong> Use Take 5 before starting work each day or when moving
            to a new area. Apply SLAM continuously throughout the day, especially when conditions
            change.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Decision Making and Stop Work Authority">
          <p>
            The outcome of a dynamic risk assessment is a decision: proceed, proceed with additional
            controls, or stop work. Understanding when to stop and having the confidence to exercise
            that authority is critical for preventing serious incidents.
          </p>
          ...
          <div className="grid gap-3">
            ...
            <div className="p-3 rounded bg-yellow-500/10 border border-yellow-500/30">
              ...
              <p className="text-sm text-white">
                Hazards identified, additional measures required but achievable, work can continue
                safely with modifications
              </p>
            </div>
            <div className="p-3 rounded bg-red-500/10 border border-red-500/30">
              <p className="font-medium text-red-400 text-sm">STOP WORK</p>
              <p className="text-sm text-white">
                Hazards cannot be adequately controlled, immediate danger exists, situation needs
                escalation
              </p>
            </div>
          </div>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Missing or defective safety equipment (harnesses, barriers, permits)</li>
            <li>Weather conditions making work dangerous (lightning, high winds, flooding)</li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Stop</strong> — Action: Cease work immediately. Warn others in the area.
            </li>
            <li>
              <strong>2. Secure</strong> — Action: Make the area safe. Isolate hazards where
              possible.
            </li>
            <li>
              <strong>3. Report</strong> — Action: Inform supervisor and site management
              immediately.
            </li>
            <li>
              <strong>4. Document</strong> — Action: Record what was found, actions taken, and who
              was informed.
            </li>
            <li>
              <strong>5. Await</strong> — Action: Do not resume until authorised and hazard is
              controlled.
            </li>
          </ul>
        ...
        <ConceptBlock title="Building Services Scenarios">
          <p>
            <strong>Scenario 1: Live Plant Discovery</strong>
          </p>
          <p className="text-sm text-white mb-2">
            <strong>Situation:</strong> You arrive to work on a distribution board that should be
            isolated per the permit to work. Upon opening the panel and testing, you find the busbar
            is still live.
          </p>
          <div className="bg-black/30 p-3 rounded text-sm text-white">
            ...
            <p className="mt-2">
              <strong>LOOK:</strong> Check isolation point - is the isolator actually off? Is there
              a second supply?
            </p>
            <p className="mt-2">
              <strong>ASSESS:</strong> This is a serious failure of the isolation procedure. Work
              cannot proceed.
            </p>
            <p className="mt-2">
              <strong>MANAGE:</strong> Barrier the area. Report to site manager and permit issuer.
              Do not proceed until correct isolation is proven dead and permit reissued.
            </p>
          ...
          <p>
            <strong>Scenario 2: Occupied Building - Fire Alarm Activation</strong>
          </p>
          <p className="text-sm text-white mb-2">
          ...
          <div className="bg-black/30 p-3 rounded text-sm text-white">
            ...
            <p className="mt-2">
              ...
              evacuation to secure equipment. Follow building evacuation procedures. Account for all
              your team at the assembly point.
            </p>
          ...
          <p>
            <strong>Scenario 3: Unexpected Asbestos Discovery</strong>
          </p>
          <p className="text-sm text-white mb-2">
            <strong>Situation:</strong> While pulling cable through a ceiling void, you disturb
            material that appears to be asbestos insulation board around old pipework. This was not
            identified in the refurbishment survey.
          </p>
          <div className="bg-black/30 p-3 rounded text-sm text-white">
            <p>
            ...
            <p className="mt-2">
              <strong>MANAGE:</strong> Leave the area calmly. Prevent others from entering. Report
              to site manager immediately. The area must be sealed and material tested before any
              work continues. Record your potential exposure.
            </p>
            <p className="mt-2 text-red-400">
          ...
          <p>
            <strong>Scenario 4: Multi-Trade Conflict</strong>
          </p>
          <p className="text-sm text-white mb-2">
          ...
          <div className="bg-black/30 p-3 rounded text-sm text-white">
            <p>
              <strong>STOP:</strong> Pause your testing. Do not assume the hot works permit covers
              your presence.
            </p>
            <p className="mt-2">
              <strong>LOOK:</strong> Check for fire hazards near your work area. Is there adequate
              ventilation? Fire watch in place?
            </p>
            <p className="mt-2">
              <strong>ASSESS:</strong> Hot works create additional hazards (fire, fumes, UV). Your
              emergency lighting test may affect the mechanical contractor's work too.
            </p>
            <p className="mt-2">
              <strong>MANAGE:</strong> Communicate with the other contractor. Agree safe working
              arrangements or work in different areas at different times. Inform both supervisors of
              the coordination issue.
            </p>
            <p className="mt-2 text-yellow-400">
              This is a site coordination failure that should be raised at the next site meeting.
            </p>
          </div>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Guidance">
          <div>
            <p>
              <strong>SLAM Quick Reference</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
          ...
          <div>
            <p>
              <strong>Take 5 Checklist Summary</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
          ...
          <div>
            <p>
              <strong>Stop Work Authority Triggers</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              Mid-task they discover a live, unmarked, single-insulated cable they had not been
              briefed on. The original RA does not cover this hazard.
            </>
          }
          whatToDo={
            <>
              Stop the task. Apply STAR. Step out, isolate where possible, photograph the cable,
              identify the source. Update the written RA before resuming. If the source cannot be
              identified, treat as live and mandate exclusion. Brief the team and record the dynamic
              decision in the day log. Escalate to the principal contractor so all other trades are
              warned.
            </>
          }
          whyItMatters={
            <>
              Continuing the task on the basis of the original RA would be both an EAWR Reg 14
              breach and an MHSWR Reg 3(3) breach. The DRA is the legal mechanism that lets the
              operative pause and re-set without becoming the duty-holder for an avoidable injury.
            </>
          }
        />
