        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Dynamic RA:</strong> Continuous, real-time risk assessment
              </li>
              <li className="pl-1">
                <strong>SLAM:</strong> Stop, Look, Assess, Manage
              </li>
              <li className="pl-1">
                <strong>Take 5:</strong> Five-minute pre-task safety check
              </li>
              <li className="pl-1">
                <strong>Stop work:</strong> Authority for all workers to halt unsafe work
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Live plant:</strong> Assessing unexpected energised equipment
              </li>
              <li className="pl-1">
                <strong>Occupied buildings:</strong> Managing public and tenant interactions
              </li>
              <li className="pl-1">
                <strong>Emergencies:</strong> Responding to fire alarms, evacuations
              </li>
              <li className="pl-1">
                <strong>Multi-trade:</strong> Coordinating with changing site conditions
              </li>
            </ul>
          </div>
        </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Employer duty to ensure health and safety so far as reasonably practicable
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">HSWA 1974 s.7</td>
                      <td className="border border-white/10 px-3 py-2">
                        Employee duty to take reasonable care for themselves and others
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Duty to report anything likely to endanger health or safety
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Do I understand the job? Do I have the right skills and training?
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">2. Environment</td>
                      <td className="border border-white/10 px-3 py-2">
                        Weather, lighting, access, confined spaces, heights, other workers
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">3. Equipment</td>
                      <td className="border border-white/10 px-3 py-2">
                        Right tools? Good condition? Tested/inspected? PPE available?
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">4. Hazards</td>
                      <td className="border border-white/10 px-3 py-2">
                        Electrical, mechanical, chemical, biological, ergonomic hazards
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">5. Controls</td>
                      <td className="border border-white/10 px-3 py-2">
                        Are existing controls sufficient? What additional controls are needed?
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Cease work immediately. Warn others in the area.
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">2. Secure</td>
                      <td className="border border-white/10 px-3 py-2">
                        Make the area safe. Isolate hazards where possible.
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">3. Report</td>
                      <td className="border border-white/10 px-3 py-2">
                        Inform supervisor and site management immediately.
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">4. Document</td>
                      <td className="border border-white/10 px-3 py-2">
                        Record what was found, actions taken, and who was informed.
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">5. Await</td>
                      <td className="border border-white/10 px-3 py-2">
                        Do not resume until authorised and hazard is controlled.
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Scenario 1: Live Plant Discovery
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Scenario 2: Occupied Building - Fire Alarm Activation
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Scenario 3: Unexpected Asbestos Discovery
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Scenario 4: Multi-Trade Conflict
              </h3>
              <p className="text-sm text-white mb-2">
