        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Power triangle:</strong> P, Q, S form right-angled triangle
              </li>
              <li className="pl-1">
                <strong>Pythagoras:</strong> S² = P² + Q² (fundamental relationship)
              </li>
              <li className="pl-1">
                <strong>Efficiency:</strong> η = Pout/Pin × 100% (always &lt;100%)
              </li>
              <li className="pl-1">
                <strong>System efficiency:</strong> Multiply individual efficiencies
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Motor IE ratings:</strong> IE3 minimum, IE4 for high hours
              </li>
              <li className="pl-1">
                <strong>Transformer losses:</strong> Iron + copper losses
              </li>
              <li className="pl-1">
                <strong>Part L compliance:</strong> Energy efficiency requirements
              </li>
              <li className="pl-1">
                <strong>Energy audits:</strong> Identify efficiency improvements
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Real Power (P):</strong> Horizontal side - measured in kW - does useful
                  work
                </li>
                <li className="pl-1">
                  <strong>Reactive Power (Q):</strong> Vertical side - measured in kVAr - energy
                  storage in L and C
                </li>
                <li className="pl-1">
  ...
  cos φ = Power Factor = P/S`}
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Alternative Using Power Factor
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>sin φ = √(1 - cos²φ)</strong> — Convert power factor to sin for Q
                  calculations
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              rated for apparent power S, not real power P. A 100kW load at 0.8 pf requires 125kVA
              capacity.
            </p>
          </div>
        </section>
...
Result: 27% reduction in apparent power (S)`}
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Current UK/EU Regulations (from July 2023):
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              continuous operation and the large powers involved, even small efficiency improvements
              translate to significant energy and cost savings.
            </p>
            ...
            <div className="my-6">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2">
                  Since copper losses = P<sub>Cu(FL)</sub> × (Load fraction)²
                </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Real building services systems comprise multiple components in series. Understanding
              how to calculate overall system efficiency is essential for accurate energy modelling
            ...
            <div className="my-6">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p>
                  η<sub>total</sub> = 0.985 × 0.97 × 0.92 × 0.75
                </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Typical System Component Efficiencies:
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              appropriate equipment, demonstrate regulatory compliance, and identify opportunities
              for energy savings through audits and upgrades.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>BRUKL compliance:</strong> As-built specifications must match or exceed
                  design
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Energy Audits - Key Efficiency Checks
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        IE class, loading factor, running hours
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Upgrade to IE4, right-size, add VSD
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Transformers</td>
                      <td className="border border-white/10 px-3 py-2">
                        No-load losses, loading pattern
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Low-loss cores, right-sizing
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Lighting</td>
                      <td className="border border-white/10 px-3 py-2">
                        Luminous efficacy (lm/W), controls
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        LED retrofit, presence/daylight sensing
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">HVAC</td>
                      <td className="border border-white/10 px-3 py-2">
                        SEER, SCOP, fan/pump efficiency
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        High-efficiency chillers, VSDs on AHUs
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Power factor</td>
                      <td className="border border-white/10 px-3 py-2">
                        Site pf, reactive power charges
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        PFC capacitors, active filters
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                ESOS and Energy Auditing Requirements:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>ESOS (Energy Savings Opportunity Scheme):</strong> Large organisations
                  must conduct energy audits every 4 years
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>MEES (Minimum Energy Efficiency Standards):</strong> EPC rating
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Motor Efficiency and Running Costs
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p>
                  P<sub>in</sub> = P<sub>out</sub> / η = 22 / 0.93 = <strong>23.66 kW</strong>
                </p>
                <p className="mt-2">Annual energy consumption:</p>
                <p>
                  E = P<sub>in</sub> × hours = 23.66 × 5000 = <strong>118,300 kWh</strong>
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Transformer Efficiency at Part Load
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-3">
                  <strong>
                    At 50% load (P<sub>out</sub> = 250kW):
                  </strong>
                </p>
                ...
                <p>
                  η = 250 / (250 + 2.7) × 100 = <strong>98.93%</strong>
                </p>
                <p className="mt-2 text-green-400">
                  Note: Higher efficiency at part load as iron is approximately equal to copper
                  losses
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 4: Complete Pump System Efficiency
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p>
                  η<sub>system</sub> = η<sub>VSD</sub> × η<sub>motor</sub> × η<sub>pump</sub>
                </p>
                <p>
                  η<sub>system</sub> = 0.96 × 0.91 × 0.72 = <strong>0.629 = 62.9%</strong>
                </p>
                <p className="mt-2">Electrical input required:</p>
                <p>
                  P<sub>elec</sub> = P<sub>hydraulic</sub> / η<sub>system</sub>
                </p>
                <p>
