...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['IE3 Premium', 'IE2 High', 'IE1 Standard', 'IE4 Super Premium'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['Reactive power (Q)', 'Real power (P)', 'Apparent power (S)', 'Power factor'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['50 kVAr', '62.5 kVAr', '30 kVAr', '40 kVAr'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['16.3kW', '15kW', '13.8kW', '17.4kW'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Approved Document L 2021 (and L Volume 1 / Volume 2 for dwellings and non-dwellings)
              is the regulatory anchor for efficiency on every BSE project. As designer you evidence
              motor IE class, lighting efficacy (lm/W), variable speed control on pumps/fans, and
              overall as-built energy performance against the design-stage SAP / SBEM model. The
              arithmetic on this page (efficiency, P/Q/S) is the calculation behind that evidence.
            </>
          }
        ...
        <ConceptBlock title="The Power Triangle - P, Q, S Relationship">
          <p>
            The power triangle is a graphical representation of the relationship between real power
            (P), reactive power (Q) and apparent power (S) in AC circuits. It provides an intuitive
            way to visualise how these three power components relate to each other and to power
            factor.
          </p>
          <p>Power Triangle Components:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Real Power (P):</strong> Horizontal side - measured in kW - does useful work
            </li>
            <li>
              <strong>Reactive Power (Q):</strong> Vertical side - measured in kVAr - energy storage
              in L and C
            </li>
            <li>
              <strong>Apparent Power (S):</strong> Hypotenuse - measured in kVA - total power
              supplied
            </li>
            <li>
              <strong>Phase Angle (φ):</strong> Angle between P and S - determines power factor
            </li>
          </ul>
          <p>
            <strong>Power Triangle Diagram:</strong> S (apparent power, hypotenuse, kVA) at the top
            of the right-angled triangle; P (real power, adjacent, kW) along the horizontal base; Q
            (reactive power, opposite, kVAr) on the vertical side; angle φ between P and S; cos φ =
            Power Factor = P/S.
          </p>
          <p>
          ...
          <p>
            <strong>Remember:</strong> For inductive loads (motors, transformers), Q is positive
            (lagging). For capacitive loads, Q is negative (leading). The triangle helps visualise
        ...
        <ConceptBlock title="Pythagoras' Theorem: S² = P² + Q²">
          ...
          <p>
            <strong>The Fundamental Equation:</strong> S² = P² + Q². Apparent power squared equals
            real power squared plus reactive power squared.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>S = P / cos φ</strong> — Calculate S when P and pf are known
            </li>
            <li>
              <strong>Q = P × tan φ</strong> — Calculate Q when P and pf are known
            </li>
            <li>
              <strong>sin φ = √(1 - cos²φ)</strong> — Convert power factor to sin for Q calculations
            </li>
          </ul>
          <p>
            <strong>Design tip:</strong> Equipment (cables, transformers, switchgear) must be rated
            for apparent power S, not real power P. A 100kW load at 0.8 pf requires 125kVA capacity.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Graphical Representation and Applications">
          ...
          <p>
            <strong>Power Factor Correction Visualised.</strong> Before PFC (pf = 0.7): S₁ = 143
            kVA, Q₁ = 102 kVAr, angle 45°, P = 100 kW. After PFC (pf = 0.95): S₂ = 105 kVA, Q₂ = 33
            kVAr, angle 18°, P = 100 kW. Capacitor added: Qc = 102 - 33 = 69 kVAr. Result: 27%
            reduction in apparent power (S).
          </p>
          <p>What the Triangle Shows:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Angle φ:</strong> Larger angle = lower power factor = more reactive power
            </li>
            <li>
              <strong>PFC effect:</strong> Reduces Q, therefore reduces S while P stays constant
            </li>
            <li>
              <strong>Capacity release:</strong> Lower S means existing cables/transformers can
              serve more real load
            </li>
            <li>
              <strong>Unity pf:</strong> Triangle collapses to a line (Q = 0, S = P)
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            penalties when power factor falls below 0.95 lagging. The power triangle helps calculate
            the capacitor kVAr needed for correction.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Efficiency - η = Pout/Pin × 100%">
          ...
          <p>
            <strong>The Efficiency Equation:</strong> η = (Pout / Pin) × 100%. Efficiency equals
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>η = Pout / Pin</strong> — Basic ratio (as decimal)
            </li>
            <li>
              <strong>η = (Pin - Losses) / Pin</strong> — Using losses
            </li>
            <li>
              <strong>Losses = Pin - Pout</strong> — Power dissipated
            </li>
            <li>
              <strong>Pin = Pout / η</strong> — Input from output
            </li>
            <li>
              <strong>Pout = Pin × η</strong> — Output from input
            </li>
            <li>
              <strong>Losses = Pin × (1 - η)</strong> — Loss calculation
            </li>
          </ul>
          <p>
            ...
            efficiency, 4000 hrs/year. Input = 50/0.92 = 54.3kW, Losses = 4.3kW. Annual loss = 4.3 ×
            4000 = 17,200 kWh.
          </p>
          <p>
            <strong>Key principle:</strong> Efficiency is always less than 100% due to unavoidable
            losses. Even small efficiency improvements yield significant savings over equipment
            lifetime.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Motor Efficiency and IE Classifications">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>0.75-1000kW:</strong> IE3 minimum for direct-on-line starting
            </li>
            <li>
              <strong>0.75-1000kW with VSD:</strong> IE2 minimum permitted
            </li>
            <li>
              <strong>75-200kW (2,4,6 pole):</strong> IE4 mandatory
            </li>
            <li>
              <strong>Exemptions:</strong> ATEX, high altitude, specific duty applications
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stator copper losses:</strong> I²R losses in stator windings (largest
              component)
            </li>
            <li>
              <strong>Rotor copper losses:</strong> I²R losses in rotor (induction motors)
            </li>
            <li>
              <strong>Iron/core losses:</strong> Hysteresis and eddy currents in laminations
            </li>
            <li>
              <strong>Mechanical losses:</strong> Bearing friction and windage (fan cooling)
            </li>
            <li>
              <strong>Stray load losses:</strong> Leakage flux and harmonic effects
            </li>
          </ul>
          <p>
            <strong>Selection guidance:</strong> For motors running &gt;4000 hours/year at &gt;75%
            load, IE4 typically pays back within 2-3 years despite higher purchase cost.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Transformer Efficiency">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Iron (Core) Losses - Constant — Occur whenever energised; Independent of load;
              Hysteresis losses (magnetisation); Eddy current losses; Also called "no-load losses"
            </li>
            <li>
              Copper (Winding) Losses - Variable — Vary with load current; Proportional to I² (load
              squared); I²R losses in windings; Also called "load losses"; Quadruple if load doubles
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Condition for Maximum Efficiency:</strong> Maximum efficiency occurs when Iron
            losses = Copper losses. Since copper losses = PCu(FL) × (Load fraction)² and iron losses
            are constant, Load for max η = √(Piron / PCu(FL)) × Full load. Typically occurs at
            50-75% of rated load.
          </p>
          <p>
          ...
          <p>
            <strong>EU Ecodesign:</strong> Regulation 2019/1783 sets minimum efficiency (Tier 2 from
            July 2021) for distribution transformers 50kVA - 40MVA. Specify compliant transformers
        ...
        <ConceptBlock title="System Efficiency Calculations">
          ...
          <p>
            <strong>Example: Variable Speed Pump System.</strong> Components in series: Transformer
            η = 98.5%; Variable Speed Drive η = 97%; Motor (IE3, 15kW) η = 92%; Pump η = 75%.
            Overall efficiency: ηtotal = 0.985 × 0.97 × 0.92 × 0.75 = 0.659 = 65.9%. To deliver 10kW
            hydraulic power: Electrical input = 10 / 0.659 = 15.2 kW.
          </p>
          <p>
          ...
          <p>
            ...
            performance. Improving pump efficiency from 70% to 80% saves more energy than improving
            a 95% motor to 97%.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Services: Equipment Efficiency and Compliance">
          <p>
            ...
            appropriate equipment, demonstrate regulatory compliance, and identify opportunities for
            energy savings through audits and upgrades.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fixed building services:</strong> Must meet minimum efficiency standards
            </li>
            <li>
              <strong>HVAC systems:</strong> SEER (cooling) and SCOP (heating) ratings apply
            </li>
            <li>
              <strong>Lighting:</strong> Luminous efficacy and control requirements
            </li>
            <li>
              <strong>Motors and drives:</strong> IE class requirements as per Ecodesign
            </li>
            <li>
              <strong>BRUKL compliance:</strong> As-built specifications must match or exceed design
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Motors — IE class, loading factor, running hours — Improvement: Upgrade to IE4,
              right-size, add VSD
            </li>
            <li>
              Transformers — No-load losses, loading pattern — Improvement: Low-loss cores,
              right-sizing
            </li>
            <li>
              Lighting — Luminous efficacy (lm/W), controls — Improvement: LED retrofit,
              presence/daylight sensing
            </li>
            <li>
              HVAC — SEER, SCOP, fan/pump efficiency — Improvement: High-efficiency chillers, VSDs
              on AHUs
            </li>
            <li>
              Power factor — Site pf, reactive power charges — Improvement: PFC capacitors, active
              filters
            </li>
          </ul>
          <p>
            <strong>Life Cycle Cost Analysis.</strong> Comparing IE3 vs IE4 motor (15kW, 4000
            hrs/year, 12p/kWh): IE3: η = 91.5%, Input = 15/0.915 = 16.39 kW. IE4: η = 93.0%, Input =
            15/0.930 = 16.13 kW. Annual saving = (16.39 - 16.13) × 4000 × 0.12 = 0.26 × 4000 × 0.12
            = £125/year. If IE4 premium is £300, payback = 2.4 years. Over 15-year motor life:
            £1,875 net saving.
          </p>
          <p>ESOS and Energy Auditing Requirements:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>ESOS (Energy Savings Opportunity Scheme):</strong> Large organisations must
              conduct energy audits every 4 years
            </li>
            <li>
              <strong>ISO 50001:</strong> Energy management certification (ESOS alternative)
            </li>
            <li>
              <strong>DEC (Display Energy Certificate):</strong> Public buildings must display
              energy performance
            </li>
            <li>
              <strong>MEES (Minimum Energy Efficiency Standards):</strong> EPC rating requirements
              for lettings
            </li>
          </ul>
          <p>
            <strong>Professional practice:</strong> Always document equipment efficiencies in design
            reports. This supports Part L compliance, future audits, and maintenance decisions.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1: Power Triangle Calculation.</strong> A three-phase motor draws 75kVA
            at 0.85 power factor lagging. Calculate P, Q and verify using Pythagoras.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Given: S = 75 kVA, cos φ = 0.85 (lagging)</li>
            <li>
              Real power: P = S × cos φ = 75 × 0.85 = <strong>63.75 kW</strong>
            </li>
            <li>sin φ = √(1 - cos²φ) = √(1 - 0.7225) = 0.527</li>
            <li>
              Reactive power: Q = S × sin φ = 75 × 0.527 = <strong>39.5 kVAr</strong> (lagging)
            </li>
            <li>
              Verify: S² = P² + Q² → 75² = 63.75² + 39.5² → 5625 = 4064 + 1560 = 5624 (rounding)
            </li>
          </ul>
          <p>
            <strong>Example 2: Motor Efficiency and Running Costs.</strong> A 22kW IE3 motor (93%
            efficiency) runs 5000 hours/year. Calculate annual energy consumption and cost at
            15p/kWh.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Pout = 22 kW; η = 93% = 0.93</li>
            <li>
              Pin = Pout / η = 22 / 0.93 = <strong>23.66 kW</strong>
            </li>
            <li>
              E = Pin × hours = 23.66 × 5000 = <strong>118,300 kWh</strong>
            </li>
            <li>
          ...
          <p>
            <strong>Example 3: Transformer Efficiency at Part Load.</strong> A 500kVA transformer
            has 1.2kW iron losses and 6kW copper losses at full load. Calculate efficiency at full
            load and 50% load.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              At full load (assuming unity pf, so Pout = 500kW): Total losses = 1.2 + 6.0 = 7.2 kW;
              η = 500 / (500 + 7.2) × 100 = <strong>98.58%</strong>
            </li>
            <li>
              At 50% load (Pout = 250kW): Iron losses = 1.2 kW (constant); Copper losses = 6.0 ×
              (0.5)² = 6.0 × 0.25 = 1.5 kW; Total losses = 1.2 + 1.5 = 2.7 kW; η = 250 / (250 + 2.7)
              × 100 = <strong>98.93%</strong>
            </li>
            <li>Higher efficiency at part load as iron is approximately equal to copper losses</li>
          </ul>
          <p>
            <strong>Example 4: Complete Pump System Efficiency.</strong> A HVAC pump system requires
            8kW hydraulic power. Calculate the electrical input given: VSD 96%, motor 91%, pump 72%.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Phydraulic = 8 kW</li>
            <li>
              ηsystem = ηVSD × ηmotor × ηpump = 0.96 × 0.91 × 0.72 = <strong>0.629 = 62.9%</strong>
            </li>
            <li>
              Pelec = Phydraulic / ηsystem = 8 / 0.629 = <strong>12.72 kW</strong>
            </li>
            <li>
              Losses breakdown: VSD: 12.72 × 0.04 = 0.51 kW; Motor: (12.72 - 0.51) × 0.09 = 1.10 kW;
              Pump: (12.72 - 0.51 - 1.10) × 0.28 = 3.11 kW; Total: 4.72 kW losses (37.1% of input)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>S² = P² + Q²</strong> — Pythagoras for power triangle
            </li>
            <li>
              <strong>P = S × cos φ</strong> — Real power from apparent
            </li>
            <li>
              <strong>Q = S × sin φ</strong> — Reactive power from apparent
            </li>
            <li>
              <strong>η = Pout / Pin × 100%</strong> — Efficiency definition
            </li>
            <li>
              <strong>ηtotal = η₁ × η₂ × η₃</strong> — Series efficiency
            </li>
            <li>
              <strong>Pin = Pout / η</strong> — Input from output and efficiency
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              IE3 motor typical efficiency: <strong>90-94%</strong> (depends on size)
            </li>
            <li>
              Distribution transformer efficiency: <strong>98-99%</strong>
            </li>
            <li>
              VSD efficiency: <strong>95-98%</strong> at rated speed
            </li>
            <li>
              Centrifugal pump BEP efficiency: <strong>70-85%</strong>
            </li>
            <li>
              Target site power factor: <strong>&gt;0.95</strong> (avoid charges)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Adding efficiencies:</strong> Series efficiencies multiply, not add
              </li>
              <li>
                <strong>Confusing kW and kVA:</strong> Size equipment for kVA, pay for kWh
              </li>
              <li>
                <strong>Ignoring part-load:</strong> Equipment often runs at 30-70% load
              </li>
              <li>
                <strong>Full-load efficiency only:</strong> Efficiency varies with loading
              </li>
              <li>
                <strong>Forgetting copper loss varies:</strong> Copper losses are proportional to
                load² for transformers
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A school AHU has a failed 22 kW IE2 induction motor (typical 91.0 % efficiency). The
              maintenance contractor proposes a like-for-like IE3 replacement (92.6 %), but a Part L
              compliance review by the SBEM consultant suggests an IE4 motor (93.6 %) for the
              additional CO&#x2082; credit. Annual run-time is 4500 hours.
            </>
          }
          whatToDo={
            <>
              Compute the energy delta. IE3 input = 22 / 0.926 = 23.76 kW; IE4 input = 22 / 0.936 =
              23.50 kW. Annual kWh saving (IE4 vs IE3) = (23.76 &minus; 23.50) &times; 4500 = 1170
              kWh, ~&pound;234/year at 20 p/kWh, plus 0.16 t CO&#x2082;/year. Capital uplift IE4 vs
              IE3 typically &pound;200&ndash;&pound;400. Payback &lt; 2 years. Specify IE4 and
              document the saving in the building&rsquo;s log book / SBEM as-built submission.
            </>
          }
          whyItMatters={
            <>
              Motor efficiency above IE3 is no longer optional in UK new-build above certain ratings
              under Ecodesign Regulation 2019/1781 (retained as UK law), and is increasingly
              enforced on like-for-like replacements via Part L log book obligations. The arithmetic
              the BSE engineer signs off here is the evidence the building uses for SAP/SBEM
              as-built compliance.
            </>
          }
        />
