    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Develop carbon reduction strategies and net-zero pathways for building services
          engineering
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers carbon accounting, reduction strategies and the pathway to net-zero
          for buildings. You'll learn about operational and embodied carbon, science-based targets,
          offsetting and how to develop effective carbon reduction roadmaps for building services
          projects.
        </p>
