      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <p className="text-base text-white mb-2"><strong>Project management benefits:</strong></p>
                    <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
          ...
          <div className="border-l-4 border-l-green-500 p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-base text-white mb-2"><strong>Equipment and Installation Faults:</strong></p>
                    <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-white mb-2"><strong>Environmental and Access Issues:</strong></p>
                    <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
          ...
          <div className="border-l-4 border-l-purple-500 p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-base text-white mb-2"><strong>Verbal Reports</strong> – For immediate issues requiring urgent attention</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-white mb-2"><strong>Written Reports</strong> – For logging hazards or long-term issues</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-white mb-2"><strong>Tagging Equipment/Areas</strong> – Visual warnings for immediate identification</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-white mb-2"><strong>Digital Platforms</strong> – Modern reporting systems</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
          ...
          <div className="border-l-4 border-l-orange-500 p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-base text-white mb-2"><strong>Break work into clear stages:</strong></p>
                    <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-white mb-2"><strong>Record details accurately:</strong></p>
                    <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-white mb-2"><strong>Provide regular updates to supervisors:</strong></p>
                    <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-white mb-2"><strong>Use specific rather than vague language:</strong></p>
                    <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
          ...
          <div className="border-l-4 border-l-red-500 p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-base text-white mb-2"><strong>Safety consequences:</strong></p>
                    <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-base text-white mb-2"><strong>Project impact:</strong></p>
                    <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card border border-border/30 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-elec-yellow mb-3">Effective Progress Updates</h3>
              <ul className="text-xs sm:text-sm text-white space-y-2">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-elec-yellow mt-0.5 flex-shrink-0" />
        ...
        <Card className="mb-8 p-6 bg-gradient-to-r from-emerald-500/10 to-emerald-500/5 border border-elec-yellow/30">
          ...
          <p className="text-white mb-4">Quick reference for fault and progress reporting</p>
