      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Supply voltages:</strong> 230V single-phase, 400V three-phase
              </li>
              <li className="pl-1">
                <strong>Motor sizing:</strong> 125% FLC for conductor rating
              </li>
              <li className="pl-1">
                <strong>Control wiring:</strong> Mains-rated or ELV (24V) with segregation
              </li>
              <li className="pl-1">
                <strong>MCC design:</strong> Form 2-4 separation, 25% spare capacity
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>BS 7671:</strong> Wiring Regulations, Sections 433, 528
              </li>
              <li className="pl-1">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              schedule documents all electrical equipment, their power requirements, and provides
              the basis for sizing distribution boards, cables, and incoming supplies. Understanding
              how to compile and interpret these schedules is essential for effective coordination
              between mechanical and electrical disciplines.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Typical HVAC Equipment Categories:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Distribution equipment:</strong> Pumps, fans, AHUs (variable loads,
                  1-50kW)
                </li>
                <li className="pl-1">
                  <strong>Terminal units:</strong> Fan coil units, VAV boxes, unit heaters (small
                  loads, 0.1-2kW)
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Ancillary:</strong> Electric trace heating, water treatment, condensate
                  pumps
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Sample HVAC Load Schedule Format
              </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                Diversity Factors for HVAC Loads
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Motor Current and Cable Sizing Requirements
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Motor Starting Methods and Current Draw
              </p>
              <div className="text-sm space-y-2">
                ...
                <p>
                  <strong>Star-Delta:</strong> Starting current reduced to ~33% of DOL, requires
                  6-core cable, torque dip on changeover
                </p>
                <p>
                  <strong>Soft Starter:</strong> 2-4× FLC starting, smooth acceleration, current
                  limiting, reduced mechanical stress
                </p>
                <p>
                  <strong>VSD/VFD:</strong> 1-1.5× FLC starting, full speed control, energy savings
                  on variable loads, harmonic considerations
                </p>
              </div>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Important:</strong> BS 7671 Regulation 433.3.1 requires motor circuit
              conductors to be rated at not less than 125% of FLC. This accounts for motor
              temperature rise and ensures the cable can handle continuous full-load operation.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              HVAC systems require extensive control wiring connecting the Building Management
              System (BMS) to field devices. Understanding the distinction between mains-rated and
              extra-low voltage (ELV) control circuits is essential for safe installation design and
              compliance with BS 7671 segregation requirements.
            </p>

            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                Control Circuit Voltage Classifications
              </p>
              <ul className="text-sm space-y-1">
                <li>
                ...
                <li>
                  - <strong>ELV (Band I):</strong> Typically 24V AC or DC, BMS field devices,
                  sensors, actuators
                </li>
                <li>
                ...
                <li>
                  - <strong>PELV:</strong> Protective extra-low voltage, earthed reference, common
                  for BMS
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                BMS Interface Requirements at MCC
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Volt-free contact via interposing relay
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">MCC → BMS</td>
                      <td className="border border-white/10 px-3 py-2">
                        Selector switch position feedback
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        0-10V or 4-20mA analogue signal
                      </td>
                    </tr>
                    <tr>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              requirements for segregation, support, and installation methods. Effective
              coordination during design prevents costly clashes and delays during construction.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                BS 7671 Segregation Requirements (Regulation 528.1)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        150mm gap or fire-rated barrier
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        50mm minimum, screened cables preferred
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Adequate capacity and derating applied
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-sm font-medium text-elec-yellow/80">
                  Containment Types for HVAC Applications
                </p>
              </div>
              <div className="text-sm space-y-2">
                <p>
                  <strong>Cable tray:</strong> Open ventilated, good heat dissipation, suitable for
                  plant rooms. Perforated or ladder type. Derating factors apply per BS 7671
                  Appendix 4.
                </p>
                <p>
                  <strong>Cable basket:</strong> Lighter duty alternative to tray, easier cable
                  additions, good in ceiling voids. Wire mesh construction.
                </p>
                <p>
                  <strong>Trunking:</strong> Enclosed metal or PVC, better protection,
                  compartmentalised options available for segregation. Higher derating factors
                  apply.
                </p>
                <p>
                  <strong>Conduit:</strong> Steel or PVC, individual circuit runs, suitable for
                  final connections to equipment. Rigid or flexible.
                </p>
                <p>
                  <strong>SWA direct:</strong> Steel wire armoured cable without containment, used
                  for external runs or direct burial.
                </p>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                MCC Design Considerations for HVAC Plant
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Form of separation:</strong> Form 2 (busbars separated from units) or Form
                  4 (full segregation) for larger installations
                </li>
                <li className="pl-1">
                  <strong>IP rating:</strong> IP54 minimum for plant rooms with potential
                  moisture/dust
                </li>
                <li className="pl-1">
                  <strong>Layout:</strong> Group by system (chillers, pumps, AHUs) for logical
                  operation
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Local indication:</strong> Run lamps, trip indication, hour meters on
                  critical plant
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Coordination principle:</strong> Early engagement between M&E disciplines
              (RIBA Stage 3/4) using 3D BIM models identifies containment clashes before
              construction. Regular design coordination meetings with documented decisions prevent
              costly site variations.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Motor Circuit Design for AHU
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: HVAC Load Schedule and Diversity
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Control Wiring Interface Schedule
              </h3>
              <p className="text-sm text-white mb-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                HVAC Electrical Design Checklist
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Obtain accurate load data from HVAC equipment manufacturer data sheets
                </li>
                <li className="pl-1">
                  Apply correct diversity factors based on system operation strategy
                </li>
                <li className="pl-1">
                  Size motor circuits at 125% FLC per BS 7671 Regulation 433.3.1
                </li>
                <li className="pl-1">
                  Specify appropriate motor starting methods for network capacity
                </li>
                <li className="pl-1">
                  Define clear BMS interface schedules with voltage levels and signal types
                </li>
                <li className="pl-1">
                  Coordinate containment routes early using BIM where available
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Under-sizing cables</strong> - forgetting the 125% factor for motor
                  circuits
                </li>
                <li className="pl-1">
