...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['MCB only', 'Time delay relay', 'Thermal overload relay', 'Fuse only'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Section 525', 'Section 411', 'Section 433', 'Section 701'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['400V three-phase', '230V single-phase', '230V three-phase', '415V three-phase'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['0.8', '0.6', '1.0 (no diversity)', '0.9'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['TT system only', 'IT system', 'No earthing required', 'TN-S or TN-C-S system'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Dual Operating Load', 'Direct On-Line', 'Dynamic Output Limiter', 'Delayed On-Line'],
    correctAnswer: 1,
    explanation:
...
const HNCModule8Section6_1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 6 · Subsection 1"
      ...
      <HubBody>
        ...
        <ConceptBlock title="HVAC Electrical Load Schedules">
          <p>
            Accurate electrical load scheduling is fundamental to HVAC system design. The load
            schedule documents all electrical equipment, their power requirements, and provides the
            basis for sizing distribution boards, cables, and incoming supplies. Understanding how
            to compile and interpret these schedules is essential for effective coordination between
            mechanical and electrical disciplines.
          </p>
          <p>
            <strong>Typical HVAC Equipment Categories:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Primary plant:</strong> Chillers, boilers, heat pumps (typically largest
              loads, 50-500kW)
            </li>
            <li>
              <strong>Distribution equipment:</strong> Pumps, fans, AHUs (variable loads, 1-50kW)
            </li>
            <li>
              <strong>Terminal units:</strong> Fan coil units, VAV boxes, unit heaters (small loads,
              0.1-2kW)
            </li>
            <li>
              <strong>Controls:</strong> BMS panels, actuators, sensors, valves (low power,
              typically &lt;1kW total)
            </li>
            <li>
              <strong>Ancillary:</strong> Electric trace heating, water treatment, condensate pumps
            </li>
          </ul>
          <p>
            <strong>Sample HVAC Load Schedule Format</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Chiller No.1:</strong> 150 — 400V 3ph — 255 — VSD
            </li>
            <li>
              <strong>LTHW Pump P1:</strong> 11 — 400V 3ph — 21 — DOL
            </li>
            <li>
              <strong>AHU-01 Supply Fan:</strong> 22 — 400V 3ph — 38 — VSD
            </li>
            <li>
              <strong>FCU (×20 units):</strong> 0.15 ea — 230V 1ph — 0.7 ea — DOL
            </li>
            <li>
              <strong>BMS Panel:</strong> 0.5 — 230V 1ph — 2.2 — N/A
            </li>
          </ul>
          <p>
            <strong>Diversity Factors for HVAC Loads</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Design principle:</strong> Always obtain manufacturer data sheets for accurate
            electrical ratings. Nameplate data supersedes estimated calculations, particularly for
            equipment with integrated VSDs or electronic controls.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Supply Voltages and Motor Power Calculations">
          <p>
            ...
            protective device selection, and switchgear specification. These calculations form the
            foundation of all HVAC electrical design work.
          </p>
          <p>
            <strong>Single-Phase (230V)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Three-Phase (400V)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Motor Current and Cable Sizing Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>4kW:</strong> 8A — 10A (1.5mm²) — 10A MCB + 10A overload
            </li>
            <li>
              <strong>7.5kW:</strong> 15A — 19A (2.5mm²) — 20A MCB + 16A overload
            </li>
            <li>
              <strong>15kW:</strong> 28A — 35A (6mm²) — 32A MCB + 30A overload
            </li>
            <li>
              <strong>30kW:</strong> 55A — 69A (16mm²) — 63A MCCB + 55A overload
            </li>
            <li>
              <strong>55kW:</strong> 100A — 125A (35mm²) — 125A MCCB + 100A overload
            </li>
          </ul>
          <p>
            <strong>Motor Starting Methods and Current Draw</strong>
          </p>
          <p>
            <strong>DOL (Direct On-Line):</strong> 6-8× FLC starting current, simplest method,
            limited to motors &lt;11kW typically
          </p>
          <p>
            <strong>Star-Delta:</strong> Starting current reduced to ~33% of DOL, requires 6-core
            cable, torque dip on changeover
          </p>
          <p>
            <strong>Soft Starter:</strong> 2-4× FLC starting, smooth acceleration, current limiting,
            reduced mechanical stress
          </p>
          <p>
            <strong>VSD/VFD:</strong> 1-1.5× FLC starting, full speed control, energy savings on
            variable loads, harmonic considerations
          </p>
          <p>
            <strong>Important:</strong> BS 7671 Regulation 433.3.1 requires motor circuit conductors
            to be rated at not less than 125% of FLC. This accounts for motor temperature rise and
            ensures the cable can handle continuous full-load operation.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Control Wiring and BMS Integration">
          <p>
            HVAC systems require extensive control wiring connecting the Building Management System
            (BMS) to field devices. Understanding the distinction between mains-rated and extra-low
            voltage (ELV) control circuits is essential for safe installation design and compliance
            with BS 7671 segregation requirements.
          </p>
          <p>
            <strong>Control Circuit Voltage Classifications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              - <strong>Mains-rated (Band II):</strong> 230V AC control circuits, motor starter
              coils, direct-switched equipment
            </li>
            <li>
              - <strong>ELV (Band I):</strong> Typically 24V AC or DC, BMS field devices, sensors,
              actuators
            </li>
            <li>
              - <strong>SELV:</strong> Safety extra-low voltage, isolated from earth, used for
              sensitive electronics
            </li>
            <li>
              - <strong>PELV:</strong> Protective extra-low voltage, earthed reference, common for
              BMS
            </li>
          </ul>
          <p>
            <strong>Mains-Rated Control Wiring</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>ELV Control Wiring (24V)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>BMS Interface Requirements at MCC</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Start/Stop Command:</strong> BMS → MCC — Volt-free contact via interposing
              relay
            </li>
            <li>
              <strong>Run Status:</strong> MCC → BMS — Auxiliary contact on contactor
            </li>
            <li>
              <strong>Trip/Fault:</strong> MCC → BMS — Auxiliary contact on overload
            </li>
            <li>
              <strong>Hand/Off/Auto:</strong> MCC → BMS — Selector switch position feedback
            </li>
            <li>
              <strong>Speed Reference:</strong> BMS → VSD — 0-10V or 4-20mA analogue signal
            </li>
            <li>
              <strong>Speed Feedback:</strong> VSD → BMS — 0-10V or 4-20mA analogue signal
            </li>
          </ul>
          <p>
            <strong>Design tip:</strong> Specify interposing relays between BMS outputs (typically
            24V) and mains-voltage starter coils. This provides galvanic isolation and prevents BMS
            damage from back-EMF or fault currents.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Cable Containment and Installation Standards">
          ...
          <p>
            <strong>BS 7671 Segregation Requirements (Regulation 528.1)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Band I (ELV) + Band II (LV):</strong> Physical separation — Partition, 50mm
              gap, or separate compartment
            </li>
            <li>
              <strong>Power + Fire alarm:</strong> Enhanced separation — 150mm gap or fire-rated
              barrier
            </li>
            <li>
              <strong>Power + Data/comms:</strong> EMC consideration — 50mm minimum, screened cables
              preferred
            </li>
            <li>
              <strong>Same voltage band:</strong> Can share containment — Adequate capacity and
              derating applied
            </li>
          </ul>
          <p>
            <strong>Containment Types for HVAC Applications</strong>
          </p>
          <p>
            <strong>Cable tray:</strong> Open ventilated, good heat dissipation, suitable for plant
            rooms. Perforated or ladder type. Derating factors apply per BS 7671 Appendix 4.
          </p>
          <p>
            <strong>Cable basket:</strong> Lighter duty alternative to tray, easier cable additions,
            good in ceiling voids. Wire mesh construction.
          </p>
          <p>
            <strong>Trunking:</strong> Enclosed metal or PVC, better protection, compartmentalised
            options available for segregation. Higher derating factors apply.
          </p>
          <p>
            <strong>Conduit:</strong> Steel or PVC, individual circuit runs, suitable for final
            connections to equipment. Rigid or flexible.
          </p>
          <p>
            <strong>SWA direct:</strong> Steel wire armoured cable without containment, used for
            external runs or direct burial.
          </p>
          <p>
            <strong>Plant Room Containment</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Ceiling Void Containment</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>MCC Design Considerations for HVAC Plant</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Form of separation:</strong> Form 2 (busbars separated from units) or Form 4
              (full segregation) for larger installations
            </li>
            <li>
              <strong>IP rating:</strong> IP54 minimum for plant rooms with potential moisture/dust
            </li>
            <li>
              <strong>Layout:</strong> Group by system (chillers, pumps, AHUs) for logical operation
            </li>
            <li>
              <strong>Labelling:</strong> Clear equipment identification, circuit references,
              warning notices
            </li>
            <li>
              <strong>BMS marshalling:</strong> Dedicated terminal blocks for control wiring
              interface
            </li>
            <li>
              <strong>Spare capacity:</strong> 20-25% spare outgoing ways for future plant
            </li>
            <li>
              <strong>Local indication:</strong> Run lamps, trip indication, hour meters on critical
              plant
            </li>
          </ul>
          <p>
            <strong>Coordination principle:</strong> Early engagement between M&E disciplines (RIBA
            Stage 3/4) using 3D BIM models identifies containment clashes before construction.
            Regular design coordination meetings with documented decisions prevent costly site
            variations.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Design the electrical supply for a 22kW AHU supply fan motor
            with VSD control.
          </p>
          <p>Given Data:</p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Motor cable sizing: <strong>125% of FLC minimum</strong>
            </li>
            <li>
              DOL starting current: <strong>6-8× FLC</strong>
            </li>
            <li>
              VSD starting current: <strong>1-1.5× FLC</strong>
            </li>
            <li>
              Maximum voltage drop: <strong>5%</strong> (BS 7671 guidance)
            </li>
            <li>
              Containment spare capacity: <strong>25%</strong> for HVAC applications
            </li>
            <li>
              ELV/LV segregation: <strong>50mm or partition</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Under-sizing cables</strong> - forgetting the 125% factor for motor circuits
              </li>
              <li>
                <strong>Ignoring starting currents</strong> - causing nuisance tripping or voltage
                dips
              </li>
              <li>
                <strong>Missing segregation</strong> - ELV and mains in same containment without
                barriers
              </li>
              <li>
                <strong>Inadequate spare capacity</strong> - no room for future HVAC additions
              </li>
              <li>
                <strong>Poor interface documentation</strong> - unclear BMS/MCC responsibilities
              </li>
            </ul>
          }
