...
const quickCheckQuestions = [
  {
    ...
    options: ['BACnet/IP', 'BACnet MS/TP', 'BACnet PTP', 'BACnet ARCNET'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['256 devices', '127 devices', '64 devices', '32 devices'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['115200 bps', '9600 bps', '38400 or 76800 bps', '19200 bps'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['500 metres', '1200 metres', '2000 metres', '100 metres'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Every second', 'Once per day', 'Once per hour', 'Every 5-15 minutes'],
    correctAnswer: 3,
    explanation:
...
const HNCModule8Section5_4 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 5 · Subsection 4"
      ...
      <HubBody>
        ...
        <ConceptBlock title="BACnet - Building Automation and Control Network">
          <p>
            ...
            ASHRAE and published as ANSI/ASHRAE Standard 135. It provides a standardised method for
            building automation devices to communicate, regardless of manufacturer, enabling true
            interoperability in commercial building systems.
          </p>
          <p>
            <strong>BACnet Transport Layers</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BACnet/IP:</strong> Ethernet (UDP/IP) — 100 Mbps - 1 Gbps — Backbone,
              head-end, supervisory
            </li>
            <li>
              <strong>BACnet MS/TP:</strong> RS-485 — 9.6 - 76.8 kbps — Field devices, controllers,
              sensors
            </li>
            <li>
              <strong>BACnet/SC:</strong> WebSocket/TLS — Network dependent — Secure communications,
              cloud connectivity
            </li>
            <li>
              <strong>BACnet Ethernet:</strong> Ethernet (802.3) — 10/100 Mbps — Legacy
              installations (now rare)
            </li>
          </ul>
          <p>
            <strong>BACnet Object Model</strong>
          </p>
          <p>
            BACnet uses an object-oriented approach where all data is organised into standardised
            objects with defined properties. This enables consistent access to data across different
            manufacturers.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Analog Input (AI):</strong> Sensor readings (temperature, pressure) — Room
              temperature sensor
            </li>
            <li>
              <strong>Analog Output (AO):</strong> Modulating control outputs — Valve position
              command
            </li>
            <li>
              <strong>Binary Input (BI):</strong> On/off status readings — Fan running status
            </li>
            <li>
              <strong>Binary Output (BO):</strong> On/off control outputs — Pump start/stop command
            </li>
            <li>
              <strong>Schedule:</strong> Time-based control schedules — AHU operating times
            </li>
            <li>
              <strong>Trend Log:</strong> Historical data storage — Temperature logging
            </li>
            <li>
              <strong>Notification Class:</strong> Alarm routing configuration — Critical alarm
              distribution
            </li>
          </ul>
          <p>
            <strong>BACnet Device Profiles (ASHRAE 135.1)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>B-AAC:</strong> Advanced Application Controller - complex control applications
            </li>
            <li>
              <strong>B-ASC:</strong> Application Specific Controller - single application (e.g.,
              VAV box)
            </li>
            <li>
          ...
          <p>
            ...
            Implementation Conformance Statement) from vendors. This document details exactly which
            objects, services, and profiles the device supports, enabling verification of
        ...
        <ConceptBlock title="Modbus - Industrial Communication Standard">
          ...
          <p>
            <strong>Modbus Variants Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Physical layer:</strong> RS-485 / RS-232 — RS-485 / RS-232 — Ethernet (TCP/IP)
            </li>
            <li>
              <strong>Data encoding:</strong> Binary (compact) — ASCII (human readable) — Binary in
              TCP frame
            </li>
            <li>
              <strong>Max devices:</strong> 247 per bus — 247 per bus — Unlimited (IP-based)
            </li>
            <li>
              <strong>Speed:</strong> Up to 115.2 kbps — Up to 19.2 kbps — 10/100/1000 Mbps
            </li>
            <li>
              <strong>Cable length:</strong> 1200m (RS-485) — 1200m (RS-485) — 100m per segment
            </li>
            <li>
              <strong>Error checking:</strong> CRC-16 — LRC — TCP checksum
            </li>
            <li>
              <strong>Common use:</strong> Field devices, meters — Legacy systems — Modern
              installations
            </li>
          </ul>
          <p>
            <strong>Modbus Data Model</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Coils:</strong> 00001-09999 — Read/Write — Digital outputs (on/off commands)
            </li>
            <li>
              <strong>Discrete Inputs:</strong> 10001-19999 — Read Only — Digital inputs (status)
            </li>
            <li>
              <strong>Input Registers:</strong> 30001-39999 — Read Only — Analog inputs (sensor
              values)
            </li>
            <li>
              <strong>Holding Registers:</strong> 40001-49999 — Read/Write — Setpoints,
              configuration
            </li>
          </ul>
          <p>
            <strong>Common Function Codes</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>03 (0x03):</strong> Read Holding Registers - read setpoints and configuration
            </li>
            <li>
          ...
          <p>
            <strong>RS-485 Wiring Best Practice</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="LonWorks, KNX and M-Bus Protocols">
          ...
          <p>
            <strong>LonWorks (Local Operating Network)</strong>
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Standard:</strong> ISO/IEC 14908 (LonTalk protocol)
            </li>
            <li>
              <strong>Physical layers:</strong> TP/FT-10 (twisted pair), IP, power line
            </li>
            <li>
              <strong>TP/FT-10 speed:</strong> 78 kbps
            </li>
            <li>
              <strong>Max devices per segment:</strong> 64 per subnet (128 with repeaters)
            </li>
            <li>
              <strong>Architecture:</strong> Peer-to-peer (no master required)
            </li>
            <li>
              <strong>Intelligence:</strong> Distributed - each device has Neuron chip
            </li>
            <li>
              <strong>Interoperability:</strong> LonMark certified profiles
            </li>
          </ul>
          <p>
            <strong>KNX (Konnex)</strong>
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Standard:</strong> ISO/IEC 14543-3 (EN 50090, EN 13321-1)
            </li>
            <li>
              <strong>Physical layers:</strong> TP (twisted pair), PL (power line), RF (radio), IP
            </li>
            <li>
              <strong>TP speed:</strong> 9.6 kbps
            </li>
            <li>
              <strong>Topology:</strong> Line &gt; Area &gt; Backbone (hierarchical)
            </li>
            <li>
              <strong>Devices per line:</strong> 64 devices maximum
            </li>
            <li>
              <strong>Lines per area:</strong> 15 lines maximum
            </li>
            <li>
              <strong>Areas per system:</strong> 15 areas maximum
            </li>
            <li>
              <strong>Max system size:</strong> 57,375 devices (15 x 15 x 255)
            </li>
            <li>
              <strong>Bus power:</strong> 29V DC carried on bus cable
            </li>
          </ul>
          <p>
            <strong>M-Bus (Meter Bus)</strong>
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Standard:</strong> EN 13757-2 (physical), EN 13757-3 (application)
            </li>
            <li>
              <strong>Physical layer:</strong> Two-wire bus (polarity independent)
            </li>
            <li>
              <strong>Speed:</strong> 300 to 9600 bps
            </li>
            <li>
              <strong>Max devices:</strong> 250 per segment
            </li>
            <li>
              <strong>Cable length:</strong> Up to 1000m (baud rate dependent)
            </li>
            <li>
              <strong>Power:</strong> Bus powered (meters draw from bus)
            </li>
            <li>
              <strong>Architecture:</strong> Master-slave (master polls slaves)
            </li>
          </ul>
          <p>
            <strong>When to Use KNX</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>When to Use M-Bus</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Integration consideration:</strong> Both KNX and M-Bus commonly require gateways
            to integrate with BACnet or Modbus-based BMS systems. Ensure gateway capacity and points
            are specified correctly, and budget for gateway configuration during commissioning.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Protocol Gateways and Multi-Vendor Integration">
          ...
          <p>
            <strong>Gateway Types and Applications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Modbus to BACnet:</strong> Modbus RTU/TCP — BACnet/IP — Chillers, boilers,
              meters to BMS
            </li>
            <li>
              <strong>M-Bus to BACnet:</strong> M-Bus — BACnet/IP — Heat meters, utility
              sub-metering
            </li>
            <li>
              <strong>KNX to BACnet:</strong> KNX TP — BACnet/IP — Lighting control, blinds to BMS
            </li>
            <li>
              <strong>BACnet router:</strong> BACnet MS/TP — BACnet/IP — Field devices to IP
              backbone
            </li>
            <li>
              <strong>LonWorks to BACnet:</strong> LonWorks — BACnet/IP — Legacy LonWorks
              integration
            </li>
            <li>
              <strong>DALI to BACnet:</strong> DALI — BACnet/IP — Lighting control integration
            </li>
          </ul>
          <p>
            <strong>Gateway Selection Criteria</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Point capacity:</strong> Number of data points that can be translated (allow
              20% spare)
            </li>
            <li>
            ...
            <li>
              <strong>Configuration interface:</strong> Web-based preferred for ease of maintenance
            </li>
            <li>
            ...
            <li>
              <strong>Vendor support:</strong> Configuration services, firmware updates, technical
              support
            </li>
          </ul>
          <p>
            <strong>Open vs Proprietary Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Vendor choice:</strong> Multiple vendors, competitive tendering — Single
              vendor, limited competition
            </li>
            <li>
              <strong>Long-term support:</strong> Alternative suppliers available — Dependent on
              original vendor
            </li>
            <li>
              <strong>Lifecycle cost:</strong> Lower through competition — Higher due to vendor
              lock-in
            </li>
            <li>
              <strong>Initial integration:</strong> May require more configuration — Often simpler
              within system
            </li>
            <li>
              <strong>Feature set:</strong> Standardised, may lag innovation — May offer unique
              features
            </li>
            <li>
              <strong>Interoperability:</strong> Designed for multi-vendor — Limited to vendor
              ecosystem
            </li>
          </ul>
          <p>
            <strong>Multi-Vendor Integration Best Practice</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Integration testing:</strong> Allocate time for point-to-point verification
            ...
            <li>
              <strong>Documentation:</strong> Require network diagrams, gateway configurations, and
              register maps
            </li>
            <li>
          ...
          <p>
            <strong>Typical Commercial Building Integration Architecture</strong>
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Modbus:</strong> Industrial equipment, meters, chillers, boilers integration
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Poor documentation</strong> - Network diagrams and configurations essential
                for FM
              </li>
            </ul>
          }
