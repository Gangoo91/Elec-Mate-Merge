    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-base text-muted-foreground mb-12">
          This section covers quality management principles and practices for building services
          projects - from establishing quality systems and inspection plans through to installation
          verification, testing and defects management.
        </p>
