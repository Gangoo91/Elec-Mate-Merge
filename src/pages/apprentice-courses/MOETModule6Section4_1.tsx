...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Shift handover ensures continuity of safety and operations. The incoming team must know: what work is in progress, what hazards are present, what permits are active, what equipment is isolated, and what requires attention.',
  },
  {
    id: 'handover-content',
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Handovers must be structured and documented. A face-to-face exchange ensures information is clearly communicated and questions can be asked. The written record provides an audit trail.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Active permits must be physically handed over with a verbal explanation. The incoming shift must understand the permit conditions, what work is in progress, where isolation points are, and who the permit holder is.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Isolation status is safety-critical information. The incoming shift must know: what is isolated, where the isolation points are, who holds the locks/keys, and whether the isolation should be maintained or removed.',
  },
  {
    id: 8,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Handovers should be thorough, not rushed. Complex situations require longer handovers. The goal is clear, accurate communication — not speed. Rushing a handover to save time has contributed to numerous serious incidents.',
  },
];
