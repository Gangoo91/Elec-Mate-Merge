...
const TITLE =
  'Multimeters: Safe Use and Core Functions – Digital Testing Equipment (Level 2 Module 2 Section 1.5)';
const DESCRIPTION =
  'Master multimeter operation for safe electrical measurements. Learn voltage, current, resistance testing, AC/DC differences, and True RMS capabilities per BS 7671.';
...
const faqs = [
  {
    ...
    answer:
      'Most likely the internal current fuse has blown. This commonly happens when accidentally connecting in current mode across a voltage source. Check and replace the fuse (usually accessible via a compartment). Always verify meter settings before connecting.',
  },
  {
    question: 'Should I use auto-ranging or select ranges manually?',
    answer:
      'Auto-ranging is convenient and reduces errors, but manual ranging gives you more control and faster response. For repetitive measurements or when you know the expected range, manual selection is often quicker and more precise.',
  },
  {
    question: 'When do I need True RMS instead of average-responding measurement?',
    answer:
      'True RMS is essential when measuring non-sinusoidal waveforms - common with LED drivers, electronic ballasts, variable speed drives, and inverters. For pure sinusoidal AC (traditional transformers, motors), average-responding meters are adequate.',
  },
  {
    question: 'How do I test if a circuit is dead before starting work?',
    answer:
      "Use a voltmeter or voltage indicator to test between all conductors and between each conductor and earth. Test your instrument on a known live source before and after testing to prove it's working correctly. This is fundamental safe isolation procedure.",
  },
  {
    question: "Why can't I measure resistance on a live circuit?",
    answer:
      "Resistance measurement works by passing a small test current through the component. Any external voltage will interfere with this measurement, giving false readings. Additionally, the meter's resistance function can be damaged by external voltages.",
  },
  {
    question: "What's the difference between clamp meters and multimeters for current measurement?",
    answer:
      'Clamp meters measure current without breaking the circuit (using magnetic induction) - safer and quicker for high currents. Multimeters are more accurate for smaller currents but require series insertion. Many situations benefit from having both available.',
  },
  {
    question: 'What safety rating should my multimeter leads have?',
    answer:
      'Test leads should match or exceed your working voltage and have appropriate CAT rating. For UK domestic work, CAT III 600V minimum. Look for double-insulated leads with finger guards and proper probe tips. Replace damaged leads immediately.',
  },
  {
    question: 'Why does my continuity tester beep on some connections but not others?',
    answer:
      "Continuity testers typically beep below 20-50Ω resistance (varies by meter). Good connections (cables, closed switches) will beep. High resistance connections, corroded joints, or open circuits won't beep - this helps identify poor connections that might cause problems.",
  },
];
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Multimeter:</strong> Measures voltage, current, resistance in one device.
                </li>
                <li>
                  <strong>Digital vs Analogue:</strong> Digital displays are easier to read
                  accurately.
                </li>
                <li>
                  <strong>Input Jacks:</strong> COM, VΩ, mA, A - use correctly to avoid damage.
                </li>
                <li>
                  <strong>AC vs DC:</strong> Wrong setting gives wrong readings.
                </li>
                <li>
                  <strong>Safety First:</strong> Check CAT rating, isolate before resistance tests.
                </li>
                <li>
                  <strong>Professional Tool:</strong> Quality meter lasts entire career.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Every electrical job needs measurement - installation,
                  testing, fault-finding.
                </li>
                <li>
                  <strong>Use:</strong> Voltage testing before work, continuity checks, current
                  measurement, component testing.
                </li>
                <li>
                  <strong>Apply:</strong> Safe isolation verification, BS 7671 testing, fault
                  diagnosis, proving circuits dead.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                Distinguish between digital and analogue multimeters and their applications
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Select correct input jacks and understand fusing protection for different
                measurements
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Differentiate between AC and DC measurements and choose appropriate ranges
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Follow best practice for resistance and continuity testing including circuit
                isolation
              </span>
            </li>
            <li className="flex items-start gap-3">
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Understanding different multimeter types helps you choose the right tool for
                electrical work. Modern digital meters offer advantages over older analogue types
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ul className="text-white space-y-1 text-sm">
                      <li>
                        • <strong>LCD Display:</strong> Clear numerical readings
                      </li>
                      <li>
                        • <strong>High Accuracy:</strong> Typically 0.1% to 0.5%
                      </li>
                      <li>
                        • <strong>Auto-ranging:</strong> Automatically selects best scale
                      </li>
                      <li>
                        • <strong>Overload Protection:</strong> Built-in fuses and circuits
                      </li>
                      <li>
                        • <strong>Multiple Functions:</strong> Min/max, hold, relative
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ul className="text-white space-y-1 text-sm">
                      <li>
                        • <strong>Moving Coil Display:</strong> Needle and scale
                      </li>
                      <li>
                        • <strong>Good for Trends:</strong> Shows changing values clearly
                      </li>
                      <li>
                        • <strong>No Battery:</strong> For basic voltage/current (not resistance)
                      </li>
                      <li>
                        • <strong>Less Robust:</strong> Mechanical movement can be damaged
                      </li>
                      <li>
                        • <strong>Reading Accuracy:</strong> Limited by scale resolution
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    ...
                    <ul className="text-white space-y-1 text-sm">
                      <li>
                        • <strong>3½ digit:</strong> 1999 count (basic)
                      </li>
                      <li>
                        • <strong>4½ digit:</strong> 19,999 count (precise)
                      </li>
                      <li>
                        • <strong>True RMS:</strong> Accurate AC measurement
                      </li>
                    </ul>
                  </div>
                  <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                    ...
                    <ul className="text-white space-y-1 text-sm">
                      <li>
                        • <strong>CAT II:</strong> Appliances, portable equipment
                      </li>
                      <li>
                        • <strong>CAT III:</strong> Fixed installations (preferred)
                      </li>
                      <li>
                        • <strong>CAT IV:</strong> Service entrance, utility level
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Correct use of multimeter controls and input jacks is essential for accurate
                readings and meter protection. Understanding the layout prevents costly mistakes.
              </p>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Voltage measurement is the most common multimeter function. Always connect in
                parallel (across) the component or circuit you're testing.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white/5 p-4 rounded-lg">
                  <ol className="space-y-2 text-sm">
                    <li>
                      <strong>1.</strong> Connect black lead to COM jack
                    </li>
                    <li>
                      <strong>2.</strong> Connect red lead to VΩ jack
                    </li>
                    <li>
                      <strong>3.</strong> Select AC voltage (V~) or DC voltage (V⎓)
                    </li>
                    <li>
                      <strong>4.</strong> Choose appropriate range (or use auto-range)
                    </li>
                    <li>
                      <strong>5.</strong> Connect probes across (parallel to) the circuit
                    </li>
                    <li>
                      <strong>6.</strong> Read display value and note units
                    </li>
                  </ol>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ul className="text-white space-y-1 text-sm">
                      <li>
                        • <strong>UK Mains:</strong> 230V AC (±10%)
                      </li>
                      <li>
                        • <strong>Car Battery:</strong> 12V DC (charged: 12.6V)
                      </li>
                      <li>
                        • <strong>Three-phase:</strong> 400V AC line-to-line
                      </li>
                      <li>
                        • <strong>Control Systems:</strong> 24V DC common
                      </li>
                      <li>
                        • <strong>Electronics:</strong> 5V, 3.3V DC supplies
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  <ol className="text-white space-y-2 text-sm">
                    <li>
                      <strong>1.</strong> Isolate circuit - switch off, lock off, tag out
                    </li>
                    <li>
                      <strong>2.</strong> Prove dead - test between all conductors and earth
                    </li>
                    <li>
                      <strong>3.</strong> Remove parallel paths - disconnect one end if needed
                    </li>
                    <li>
                      <strong>4.</strong> Discharge capacitors - wait for stored energy to dissipate
                    </li>
                    <li>
                      <strong>5.</strong> Select resistance function (Ω) or continuity (♪)
                    </li>
                    <li>
                      <strong>6.</strong> Connect probes and read result
                    </li>
                  </ol>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-1 text-sm">
                      <li>
                        • <strong>Cable Resistance:</strong> Should be very low (mΩ range)
                      </li>
                      <li>
                        • <strong>Heating Elements:</strong> Calculate from P = V²/R
                      </li>
                      <li>
                        • <strong>Insulation:</strong> Should be {'>'}1MΩ (BS 7671)
                      </li>
                      <li>
                        • <strong>Earth Bonds:</strong> Typically {'<'}0.05Ω
                      </li>
                      <li>
                        • <strong>Component Values:</strong> Check against ratings
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-1 text-sm">
                      <li>
                        • <strong>Beep Function:</strong> Sounds below ~50Ω threshold
                      </li>
                      <li>
                        • <strong>Cable Testing:</strong> End-to-end continuity checks
                      </li>
                      <li>
                        • <strong>Switch Testing:</strong> Open/closed operation
                      </li>
                      <li>
                        • <strong>Fuse Testing:</strong> Quick good/blown indication
                      </li>
                      <li>
                        • <strong>Earth Paths:</strong> Verify protective conductor integrity
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Current measurement requires series insertion - the meter becomes part of the
                circuit. This is the most dangerous measurement as incorrect connection can create
                short circuits.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white/5 p-4 rounded-lg">
                  <ol className="space-y-2 text-sm">
                    <li>
                      <strong>1.</strong> Estimate expected current to choose correct jack
                    </li>
                    <li>
                      <strong>2.</strong> Black lead to COM, red lead to mA or A jack
                    </li>
                    <li>
                      <strong>3.</strong> Select AC current (A~) or DC current (A⎓)
                    </li>
                    <li>
                      <strong>4.</strong> Break circuit and insert meter in series
                    </li>
                    <li>
                      <strong>5.</strong> Energise circuit and read current
                    </li>
                    <li>
                      <strong>6.</strong> De-energise before removing meter
                    </li>
                  </ol>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ul className="text-white space-y-1 text-sm">
                      <li>
                        • <strong>mA Jack:</strong> Up to 200-400mA (fused)
                      </li>
                      <li>
                        • <strong>A Jack:</strong> Higher currents to 10A (may be unfused)
                      </li>
                      <li>
                        • <strong>Fuse Protection:</strong> mA circuit usually has ceramic fuse
                      </li>
                      <li>
                        • <strong>Current Path:</strong> Through internal shunt resistor
                      </li>
                      <li>
                        • <strong>Overload:</strong> Blown fuse = no current readings
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ul className="text-white space-y-1 text-sm">
                      <li>
                        • <strong>High Currents:</strong> Above 10A safely
                      </li>
                      <li>
                        • <strong>Live Testing:</strong> No circuit breaking required
                      </li>
                      <li>
                        • <strong>Motor Currents:</strong> Start-up and running values
                      </li>
                      <li>
                        • <strong>Load Surveys:</strong> Quick current measurements
                      </li>
                      <li>
                        • <strong>Limitations:</strong> Less accurate for small currents
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Understanding AC and DC measurement modes is crucial for accurate readings. True RMS
                capability becomes essential with modern electronic loads.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-1 text-sm">
                      <li>
                        • <strong>Symbol:</strong> ~ (sine wave) for alternating
                      </li>
                      <li>
                        • <strong>UK Frequency:</strong> 50Hz (50 cycles per second)
                      </li>
                      <li>
                        • <strong>RMS Values:</strong> Effective heating value
                      </li>
                      <li>
                        • <strong>Applications:</strong> Mains supply, motors, transformers
                      </li>
                      <li>
                        • <strong>Coupling:</strong> AC-coupled input blocks DC component
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ul className="text-white space-y-1 text-sm">
                      <li>
                        • <strong>Symbol:</strong> ⎓ (straight lines) for direct
                      </li>
                      <li>
                        • <strong>Constant Value:</strong> Doesn't change polarity
                      </li>
                      <li>
                        • <strong>Polarity Matters:</strong> Shows + or - reading
                      </li>
                      <li>
                        • <strong>Applications:</strong> Batteries, electronics, control systems
                      </li>
                      <li>
                        • <strong>Zero AC:</strong> Will read zero on AC supply
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                  <div className="text-yellow-200 space-y-2 text-sm">
                    <p>
                      <strong>Average-Responding:</strong> Assumes perfect sine wave, accurate for
                      traditional loads
                    </p>
                    <p>
                      <strong>True RMS:</strong> Calculates actual heating effect, essential for:
                    </p>
                    ...
                    <p>
                      <strong>Result:</strong> Average-responding meters can under-read by 40%+ on
                      electronic loads
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-4 text-white">
              <div className="bg-red-500/20 border border-red-400/50 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li>
                    • <strong>Current Mode Across Voltage:</strong> Blows fuse instantly, can cause
                    arc flash
                  </li>
                  <li>
                    • <strong>Wrong CAT Rating:</strong> Meter not rated for installation voltage
                  </li>
                  <li>
                    • <strong>Damaged Test Leads:</strong> Cracked insulation = shock risk
                  </li>
                  <li>
                    • <strong>Live Resistance Testing:</strong> Damages meter, gives false readings
                  </li>
                  <li>
                    • <strong>Wrong AC/DC Setting:</strong> Dangerous assumption about circuit state
                  </li>
                  <li>
                    • <strong>No Proving Unit Check:</strong> Don't assume dead circuit is safe
                  </li>
                </ul>
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="space-y-1 text-white">
                  ...
                  <li>
                    • <strong className="text-white">Current ≤400mA:</strong> COM + mA jacks
                  </li>
                  <li>
                    • <strong className="text-white">Current {'>'}400mA:</strong> COM + A jacks
                  </li>
                  <li>
                    • <strong className="text-white">Always black to COM</strong>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white font-mono">
                  ...
                  <li>
                    • <strong className="text-white">V⎓:</strong> DC voltage measurement
                  </li>
                  <li>
                    • <strong className="text-white">A~:</strong> AC current measurement
                  </li>
                  <li>
                    • <strong className="text-white">A⎓:</strong> DC current measurement
                  </li>
                  <li>
                    • <strong className="text-white">Ω:</strong> Resistance measurement
                  </li>
                  <li>
                    • <strong className="text-white">♪)))) :</strong> Continuity with beep
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  ...
                  <li>
                    • <strong className="text-white">Three-phase:</strong> 400V AC line-to-line
                  </li>
                  <li>
                    • <strong className="text-white">RCD rating:</strong> 30mA typical
                  </li>
                  <li>
                    • <strong className="text-white">Socket circuit:</strong> 32A max
                  </li>
                  <li>
                    • <strong className="text-white">Earth resistance:</strong> {'<'}0.05Ω bonds
                  </li>
                  <li>
                    • <strong className="text-white">Insulation:</strong> {'>'}1MΩ @ 500V
                  </li>
                </ul>
              </div>
            </div>
        ...
        {/* Quiz Section */}
        <div className="mt-12">
          <Quiz title="Multimeter Safe Use and Functions Quiz" questions={quizQuestions} />
        </div>
