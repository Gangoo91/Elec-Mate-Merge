...
const TITLE =
  'Lockout/Tagout and Permit-to-Work Systems - Module 1.5.4 | Level 2 Electrical Course';
const DESCRIPTION =
  'Master formal safety systems for electrical isolation, including LOTO procedures and permit-to-work systems for safe electrical work practices.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "Lockout prevents the accidental re-energising of equipment or circuits by physically securing the isolator in the 'off' position.",
  },
  {
    id: 2,
    ...
    correctIndex: 2,
    explanation:
      "Each worker must use their own padlock to ensure they have individual control over the safety of the isolation. This prevents work from continuing if one person hasn't finished.",
  },
  {
    id: 3,
    ...
    correctIndex: 2,
    explanation:
      'A permit-to-work system is a formal safety agreement between the worker and the person responsible for the site, providing written authorisation and safety confirmation.',
  },
];
...
const Section5_4 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 0,
      explanation:
        "Tags should include the worker's name and contact information to identify who applied the lock and how to reach them if needed.",
    },
    {
      id: 4,
      question: 'What is a permit-to-work system used for?',
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "False. Each worker must use their own padlock. If multiple people are working, multiple locks must be applied to ensure everyone's safety.",
    },
    {
      id: 6,
      ...
      correctAnswer: 1,
      explanation:
        'Each worker must place their own individual lock on the group lock box to maintain individual control over the isolation.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'Permit-to-work systems are typically required for high-voltage work, switchgear operations, confined spaces, and work that affects others on site.',
    },
    {
      id: 8,
      ...
      correctAnswer: 1,
      explanation:
        'A complete permit must include a description of the work, confirmation the system is safely isolated, authorisation to proceed, and sign-off after completion.',
    },
    {
      id: 9,
      ...
      correctAnswer: 2,
      explanation:
        'You must find an appropriate lock-off device or use an alternative isolation method. Never proceed without proper physical isolation.',
    },
    {
      id: 10,
      ...
      correctAnswer: 2,
      explanation:
        'Both the person authorising the work and the worker have responsibilities for maintaining proper documentation throughout the permit process.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'Never break or cut your own lock. Contact your supervisor immediately - they should have procedures for this situation, which may involve specialist lock removal by maintenance personnel with proper documentation.',
    },
    {
      question: 'Can I use the same lock for multiple isolation points?',
      answer:
        'No, each isolation point should have its own lock where possible. If one lock must secure multiple points, use a lock box system where your individual lock secures the group key.',
    },
    {
      question: 'How long is a permit-to-work valid?',
      answer:
        'Permits have specific time limits stated on the document. They typically expire at the end of a shift or specified time period. Extended work requires permit renewal or extension.',
    },
    {
      question: "What should I do if I find equipment that's locked out but no one is around?",
      answer:
        "Never remove locks that aren't yours. Check with the supervisor, look for contact details on tags, and follow site procedures for abandoned locks. Safety is more important than delays.",
    },
    {
      question: 'Do I need a permit for simple electrical repairs?',
      answer:
        "It depends on the work complexity, voltage levels, and site policies. When in doubt, ask your supervisor. It's better to have an unnecessary permit than risk safety without one.",
    },
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-base text-foreground">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> High-voltage switchgear work, multiple workers on one
                  system.
                </li>
                <li>
                  <strong>Use:</strong> Individual locks, group lock boxes, permit systems.
                </li>
                <li>
                  <strong>Check:</strong> Commercial and industrial sites, work affecting others.
                </li>
              </ul>
            </div>
          </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <ul className="list-disc pl-6 space-y-2 text-base text-foreground">
            ...
            <li>
              Recognise the responsibilities and documentation requirements for safe isolation.
            </li>
            <li>
              Apply LOTO and permit systems to prevent electrical accidents and ensure compliance.
            </li>
          </ul>
        </Card>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">
              Understanding Lockout/Tagout (LOTO) Systems
            </h3>
            <p className="text-base text-foreground mb-4">
              LOTO systems provide physical and visual protection against accidental re-energising
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-elec-yellow dark:text-elec-yellow mb-1">
                      LOTO Fundamentals and Components
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>Lockout component:</strong> Physical security of isolation points.
                    </p>
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Tagout component:</strong> Clear identification and communication.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>LOTO process steps:</strong> Systematic approach to safe isolation.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Key principle:</strong> LOTO provides both physical barriers and clear
                      communication to prevent accidents
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-6">
            ...
            <p className="text-base text-foreground mb-4">
              When multiple workers are involved in electrical work, group LOTO systems ensure every
              person's safety:
            </p>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-green-600 dark:text-green-400 mb-1">
                      Multiple Worker Safety Principles
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>Individual control requirement:</strong> Each worker must have
                      personal control.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Group lock box system:</strong> Coordinating multiple locks
                      effectively.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Communication and coordination:</strong> Essential for group safety.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Key principle:</strong> Every worker must have individual control - no
          ...
          <section className="mb-6">
            ...
            <p className="text-base text-foreground mb-4">
              Permit-to-work systems provide formal documentation and authorisation for high-risk
              electrical work:
            </p>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-elec-yellow mb-1">
                      Permit-to-Work Framework and Requirements
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>Purpose and scope:</strong> Formal safety agreement and documentation.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>When permits are required:</strong> High-risk electrical activities.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Essential permit information:</strong> Complete documentation
                      requirements.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Key principle:</strong> Permits ensure all parties understand risks
                      and agree on safety measures
                    </div>
                  </div>
                </div>
              </div>
          ...
          <CardContent>
            <div className="space-y-3 text-slate-700 dark:text-slate-300">
              <p className="font-medium">
                Situation: Electrical maintenance on a production line involving five electricians
                working simultaneously.
              </p>
              <p>
                Initially, only the lead electrician applied a single lock, thinking coordination
                through him would be sufficient. However, when one electrician finished early and
                left without informing the lead, production management pressured for system
                re-energising while others were still working.
              </p>
              <p className="font-medium">LOTO system implemented:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Group lock box:</strong> Master isolation key secured in lockable box
                </li>
                <li>
                  <strong>Individual locks:</strong> Each of the five electricians placed their own
                  lock on the box
                </li>
                <li>
                  <strong>Formal permit:</strong> Written authorisation detailing work scope and
                  safety measures
                </li>
                <li>
                  <strong>Sign-in/out system:</strong> Workers logged arrival and departure times
                </li>
                <li>
                  <strong>Communication protocol:</strong> Regular progress updates to control room
                </li>
              </ul>
              <p className="font-medium text-green-600 dark:text-green-400">
                Result: System could not be re-energised until all five workers had completed their
                tasks and removed their individual locks, ensuring complete safety accountability
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-card">
              ...
              <p className="text-base text-foreground">
                LOTO and permit-to-work systems are essential safety tools that prevent electrical
                accidents through physical barriers, clear communication, and formal documentation.
                Every worker must have individual control over their safety - no shortcuts or
                exceptions.
              </p>
            </div>
          </div>
