    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          One of the main challenges of the AM2 is not just completing the tasks but doing them
          within the strict time limits. Understanding the structure and timings before you walk in
        ...
        <ConceptBlock title="Total Time">
          <p>
            ...
            centres allow short breaks between sections, but you should be prepared for long
        ...
        <Scenario
          ...
          situation={
            <>
              You’ve started Section A. The rig has conduit, trunking, an SWA run and a three-phase
              isolator to terminate. The candidate next to you has already started bending conduit
              and you can feel yourself wanting to do the same.
            </>
          }
          whatToDo={
            <>
              Stop. Read the spec end-to-end. Walk the rig once and check what cable, what fixings,
              what terminations are required. Sketch a rough sequence — installation order matters
              because some accessories block access to others. Five minutes of planning saves an
              hour of unpicking.
            </>
          }
          whyItMatters={
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Break Section A into A1–A5 sub-tasks and give each a target finish time. Tick them off
              as you go. If you’re behind on one sub-task, decide whether to fix it now or bank the
              lost time and work it into the next one.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Purpose of AM2</div>
          </button>
          <button
