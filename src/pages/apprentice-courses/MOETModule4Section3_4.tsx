...
const DESCRIPTION =
  'Typical motor and drive faults, causes and diagnostic techniques including winding faults, bearing failure, VSD fault codes, single-phasing and overheating for electrical maintenance technicians.';
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              mechanical interface between the stationary stator and the rotating rotor, supporting
              the shaft while allowing free rotation. When bearings fail, the consequences range
              from increased noise and vibration to catastrophic seizure that can damage the rotor,
              stator and driven equipment.
            </p>
            <p>
              Understanding bearing failure modes, their symptoms and causes is essential for any
              maintenance technician working with rotating machinery. Early detection of bearing
              deterioration through condition monitoring (vibration analysis, temperature
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              the stator core. The insulation system — a combination of enamel coating on the wire,
              slot liners, phase-to-phase insulation and varnish impregnation — is the most
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              applications. They convert the fixed-frequency AC supply into a variable-frequency,
              variable-voltage output using power electronic switching (IGBTs). While VSDs offer
            ...
            <p>
              ...
              voltage, frequency, temperature) at the time of the trip. This data is enormously
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              insulation system, bearings and lubricant are all temperature-sensitive, and sustained
              operation above their rated temperatures leads to accelerated degradation. As a
