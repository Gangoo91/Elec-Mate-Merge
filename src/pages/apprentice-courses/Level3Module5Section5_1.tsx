      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            The primary certification document for all new electrical installations
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Understand when an EIC must be issued",
              "Complete all sections of the certificate correctly",
              "Know the responsibilities of designer, constructor, inspector",
              "Record supply characteristics and earthing arrangements",
              "Attach appropriate schedules of inspections and test results",
              "Advise on recommended periodic inspection intervals"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module5-section5-5-2">
