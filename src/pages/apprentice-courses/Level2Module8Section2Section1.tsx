    ...
    <div className="bg-background p-4 sm:p-6 lg:p-8">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-card border border-elec-yellow/30 rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-elec-yellow mb-1">First-time</div>
            <div className="text-sm text-white">
              Most candidates who manage their time well pass first time
            </div>
          </div>
          <div className="bg-card border border-elec-yellow/30 rounded-lg p-4 text-center">
        ...
        <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-muted/50 rounded-lg border-l-4 border-elec-yellow">
                      <div className="font-medium text-elec-yellow text-sm">
                        Online MC Assessments (C&amp;G 2365-02)
                      </div>
                      <div className="text-sm text-white mb-2">
                        90 minutes (1.5 hrs) • Typically 60 questions • Closed book
                      </div>
                      <div className="text-xs text-white space-y-1">
                        <div>• Each unit (201, 202, 203, 204, 210) has its own online MC assessment</div>
                        <div>
                          • All units must be passed to achieve the Level 2 Diploma
                        </div>
                        <div>• Multiple choice format - no negative marking, never leave a blank</div>
                        <div>
                          • <strong>Closed book</strong> — BS 7671 / IET OSG / notes are NOT permitted
                          in the online MC sittings
                        </div>
                        <div>
                          • Sat under invigilated conditions at your training centre
                        </div>
                      </div>
                    </div>
                    <div className="p-3 bg-muted/50 rounded-lg border-l-4 border-elec-yellow">
                      <div className="font-medium text-elec-yellow text-sm">
                        Practical Element (Workplace / Portfolio)
                      </div>
                      <div className="text-sm text-white mb-2">
                        Portfolio + observed practical assignments • Delivered across the academic year
                      </div>
                      <div className="text-xs text-white space-y-1">
                        <div>
                          • The 2365-02 practical element is portfolio-based — built up over the year, NOT a single timed exam
                        </div>
                        <div>
                          • Centre-delivered observed practical assignments (OBPA) cover circuit installation,
                          testing, inspection and safe isolation
                        </div>
                        <div>
                          • Workplace evidence, witness statements, photos and assessor observations contribute
                          to the portfolio
                        </div>
                        <div>
                          • Note: <strong>2365-03</strong> is the separate Level 3 Diploma qualification —
                          NOT a "practical exam" for Level 2
                        </div>
                      </div>
                    </div>
                    <div className="p-3 bg-muted/50 rounded-lg border-l-4 border-elec-yellow">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-3 p-2 rounded">
                      ...
                      <span className="text-sm">
                        <strong>90 seconds rule:</strong> Start with this target, adjust based on
                        question complexity
                      </span>
                    </div>
                    <div className="flex items-center gap-3 p-2 rounded">
                      <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                      <span className="text-sm">
                        <strong>15-20 minute buffer:</strong> Essential for review and panic
                        prevention
                      </span>
                    </div>
                    <div className="flex items-center gap-3 p-2 rounded">
                      <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                      <span className="text-sm">
                        <strong>3-minute maximum:</strong> Absolute ceiling - move on regardless of
                        progress
                      </span>
                    </div>
                    <div className="flex items-center gap-3 p-2 rounded">
                      <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                      <span className="text-sm">
                        <strong>Flag system:</strong> Mark difficult questions with symbols (?, *,
                        !) for prioritised return
                      </span>
                    </div>
                    <div className="flex items-center gap-3 p-2 rounded">
                      <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                      <span className="text-sm">
                        <strong>Never blank rule:</strong> Even wild guesses have 25% success rate
                        in multiple choice
                      </span>
                    </div>
                    <div className="flex items-center gap-3 p-2 rounded">
                      <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                      <span className="text-sm">
                        <strong>Checkpoint system:</strong> Review progress every 15 questions
                        (every 30 minutes)
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="relative p-5 bg-gradient-to-r from-green-500/10 to-transparent rounded-lg border border-green-500/30">
                    ...
                    <div className="ml-12">
                      ...
                      <div className="mt-3 p-2 bg-green-500/20 rounded text-xs">
                        <strong>Goal:</strong> Complete 35-40 questions in this pass, maintaining
                        85%+ accuracy
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="ml-12">
                      ...
                      <div className="mt-3 space-y-2">
                        <div className="p-2 bg-orange-500/20 rounded text-xs">
                          <strong>Time Management:</strong> Allocate maximum 4 minutes per
                          calculation question
                        </div>
                        <div className="p-2 bg-elec-yellow/20 rounded text-xs">
                          <strong>Calculator Tip:</strong> Use memory functions for repeated values
                          (cable factors, etc.)
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="relative p-5 bg-gradient-to-r from-elec-yellow/10 to-transparent rounded-lg border border-border/30">
                    ...
                    <div className="ml-12">
                      ...
                      <div className="mt-3 p-2 bg-elec-yellow/20 rounded text-xs">
                        <strong>Final Check:</strong> Ensure every question is answered - blank
                        answers guarantee 0 marks
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  <h4 className="font-semibold mb-3 text-foreground">
                    Question Analysis Timing Breakdown
                  </h4>
                  <div className="space-y-2">
                    {[
                      {
                        task: 'Read question carefully',
                        time: '15-20 sec',
                        color: 'bg-elec-yellow',
                      },
                      {
                        task: 'Identify key requirements',
                        time: '10-15 sec',
                        color: 'bg-green-500',
                      },
                      {
                        task: 'Locate BS7671 reference',
                        time: '30-45 sec',
                        color: 'bg-orange-500',
                      },
                      {
                        task: 'Calculate/determine answer',
                        time: '45-60 sec',
                        color: 'bg-red-500',
                      },
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div
                        key={index}
                        className="flex items-center gap-3 p-2 bg-card rounded border border-red-500/20"
                      >
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  <h4 className="font-semibold mb-4 text-foreground">
                    Advanced Task Prioritisation Matrix
                  </h4>
                  <div className="space-y-3">
                    <div className="p-4 bg-gradient-to-r from-green-500/10 to-transparent rounded-lg border border-green-500/30">
                      ...
                      <div className="text-xs text-white space-y-1">
                        ...
                        <div>
                          • <strong>Main earthing connections:</strong> 10-15 marks + safety
                          critical
                        </div>
                        <div>
                          • <strong>Basic circuit wiring:</strong> Core competency demonstration
                        </div>
                        <div>
                          • <strong>Cable selection & sizing:</strong> Shows technical knowledge
                        </div>
                      </div>
                    </div>
                    <div className="p-4 bg-gradient-to-r from-elec-yellow/10 to-transparent rounded-lg border border-border/30">
                      ...
                      <div className="text-xs text-white space-y-1">
                        ...
                        <div>
                          • <strong>Radial circuits:</strong> 15-20 marks, simpler but still crucial
                        </div>
                        <div>
                          • <strong>Lighting circuits:</strong> 15-20 marks, multiple connection
                          points
                        </div>
                        <div>
                          • <strong>Cooker circuit:</strong> 15-20 marks, higher current rating
                        </div>
                      </div>
                    </div>
                    <div className="p-4 bg-gradient-to-r from-orange-500/10 to-transparent rounded-lg border border-border/30">
                      ...
                      <div className="text-xs text-white space-y-1">
                        ...
                        <div>
                          • <strong>Live testing procedures:</strong> 10-15 marks, safety critical
                        </div>
                        <div>
                          • <strong>Earth fault loop impedance:</strong> 5-10 marks per circuit
                        </div>
                        <div>
                          • <strong>RCD testing:</strong> 5-10 marks, multiple test requirements
                        </div>
                      </div>
                    </div>
                    <div className="p-4 bg-gradient-to-r from-purple-500/10 to-transparent rounded-lg border border-border/30">
                      ...
                      <div className="text-xs text-white space-y-1">
                        ...
                        <div>
                          • <strong>Schedule of test results:</strong> 5-10 marks
                        </div>
                        <div>
                          • <strong>Cable labelling:</strong> 2-5 marks, easy wins
                        </div>
                        <div>
                          • <strong>Final presentation:</strong> 2-5 marks, professional finish
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                  <h4 className="font-semibold mb-4 text-foreground">
                    Detailed 6-Hour Assessment Breakdown
                  </h4>
                  <div className="space-y-3">
                    {[
                      {
                    ...
                    {[
                      {
                        ...
                        detail:
                          'Focus only on tasks that will definitely gain marks. Stop any cosmetic work immediately.',
                      },
                      {
                        priority: 'CRITICAL',
                        ...
                        detail:
                          'Prioritise ring final circuit completion over multiple radial circuits if marks are similar.',
                      },
                      {
                        priority: 'HIGH',
                        ...
                        detail:
                          'Earth connections, RCD functionality, and basic protective devices must work.',
                      },
                      {
                        priority: 'MEDIUM',
                        ...
                        detail:
                          'Dead tests first (continuity, polarity), then essential live tests (earth loop).',
                      },
                      {
                        priority: 'LOW',
                        ...
                        detail:
                          "Partial certificates with 'N/A' entries score higher than blank forms.",
                      },
                    ].map((item, index) => (
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-card rounded-lg border border-border/30">
                      ...
                      <div className="space-y-1 text-xs text-white">
                        ...
                        <div>
                          <strong>Orange Tab:</strong> Section 433 (Overload protection)
                        </div>
                        <div>
                          <strong>Yellow Tab:</strong> Section 411 (Protective measures)
                        </div>
                        <div>
                    ...
                    <div className="p-3 bg-card rounded-lg border border-border/30">
                      ...
                      <div className="space-y-1 text-xs text-white">
                        ...
                        <div>
                          <strong>Earth fault loop:</strong> Zs = Ze + R1 + R2
                        </div>
                        <div>
                          <strong>Ring final R1+R2:</strong> (R1+R2)/4 at midpoint
                        </div>
                        <div>
                          <strong>Cable grouping:</strong> Apply derating factors from Table 4C
                        </div>
                        <div>
                          <strong>Discrimination:</strong> Upstream device ≥ 2 × downstream
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <Card className="border-elec-yellow/30 bg-card">
            ...
            <CardContent className="space-y-6 pt-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          Use index efficiently - practice finding regulations in under 30 seconds
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Target className="w-4 h-4 text-elec-yellow" />
              ...
              <div>
                <h4 className="font-semibold mb-3 text-foreground">
                  Mental Preparation & Exam Day Strategy
                </h4>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div
                        key={index}
                        className="flex items-center gap-3 p-2 bg-card rounded border border-green-500/20"
                      >
