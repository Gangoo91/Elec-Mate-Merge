      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Purpose and Benefits of Professional Cable Dressing</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Mechanical protection:</strong> Prevents strain on terminations and conductor damage.</p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Maintenance efficiency:</strong> Enables quick identification and safe working.</p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Planning and Layout Strategy</h3>
            <p className="text-xs sm:text-sm text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Functional grouping principles:</strong> Organise circuits by type and purpose.</p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Space allocation strategy:</strong> Plan for adequate working room and future expansion.</p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Securing Methods and Cable Separation</h3>
            <p className="text-xs sm:text-sm text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Alternative securing methods:</strong> Select based on installation requirements.</p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Data cable considerations:</strong> Minimise electromagnetic interference.</p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Avoiding Common Problems and Ensuring Compliance</h3>
            <p className="text-xs sm:text-sm text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>BS 7671 requirements:</strong> Fundamental regulations for cable arrangement.</p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Manufacturer specifications:</strong> Follow equipment-specific requirements.</p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Enclosure-Specific Dressing Techniques</h3>
            <div className="space-y-4">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Step-by-Step Installation Process</h3>
            
            <div className="space-y-4">
              <div className="rounded-lg p-4 bg-transparent border border-amber-400/30">
                <p className="font-medium text-white mb-2">Phase 1: Pre-Installation Planning</p>
              ...
              <div className="rounded-lg p-4 bg-transparent border border-cyan-400/30">
                <p className="font-medium text-white mb-2">Phase 2: Cable Installation and Routing</p>
                <ol className="text-xs text-white space-y-1 list-decimal pl-4">
              ...
              <div className="rounded-lg p-4 bg-indigo-500/10 border border-indigo-400/30">
                <p className="font-medium text-white mb-2">Phase 3: Final Dressing and Securing</p>
                <ol className="text-xs text-white space-y-1 list-decimal pl-4">
          ...
          {/* Quality Assurance */}
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Quality Assurance and Inspection Checklist</h3>
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
              <p className="text-xs sm:text-sm text-white mb-3"><strong>Pre-closure inspection checklist:</strong></p>
              ...
              <div className="mt-3 p-2 bg-[#121212]/50 rounded border">
                <p className="text-xs text-white"><strong>Documentation:</strong> Photograph completed installations for quality records and future reference.</p>
              </div>
            </div>
          </section>
        </Card>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <div className="space-y-4">
            <div>
              <h4 className="font-medium text-white mb-2">Q: Is it acceptable to leave long loops of spare cable inside an enclosure?</h4>
              <p className="text-sm text-white">A: Only if necessary for maintenance access, but loops should be neatly secured and positioned to avoid obstructing other components or blocking ventilation.</p>
            </div>
            <Separator />
            <div>
              <h4 className="font-medium text-white mb-2">Q: Can cable ties be replaced with adhesive cable clips inside enclosures?</h4>
              <p className="text-sm text-white">A: Yes, as long as they are rated for the temperature and environmental conditions of the enclosure and provide adequate support for the cable type.</p>
            </div>
            <Separator />
            <div>
              <h4 className="font-medium text-white mb-2">Q: What if I can't maintain separation between ELV and mains cables?</h4>
              <p className="text-sm text-white">A: Use segregated trunking or suitable cable types with insulation rated for the higher voltage, ensuring compliance with BS 7671 requirements.</p>
            </div>
            <Separator />
            <div>
              <h4 className="font-medium text-white mb-2">Q: How tight should cable ties be when securing cables?</h4>
              <p className="text-sm text-white">A: Firm enough to provide support but loose enough that the cable can slide with some resistance. Over-tightening can crush insulation and damage conductors.</p>
            </div>
          </div>
        </Card>
