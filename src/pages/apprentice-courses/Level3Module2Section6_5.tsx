...
const Level3Module2Section6_5 = () => {
  ...
  const quizQuestions: QuizQuestion[] = [
    {
      question:
        "Why is 'leading by example' considered the most effective way to promote sustainability in a team?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "People are naturally influenced by observed behaviour. When supervisors and experienced workers consistently demonstrate sustainable practices, it normalises these behaviours and shows they're valued by the organisation. Actions speak louder than instructions or policies.",
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Toolbox Talks are brief (5-15 minute) informal discussions with the team, often at the start of a shift. They work well for sustainability topics because they're regular, accessible, and can address specific site conditions or recent issues without requiring formal training time.",
    },
    {
      question:
        'Why should sustainability initiatives connect to business benefits when communicating with teams?',
      options: [
      ...
      correctAnswer: 2,
      explanation:
        'While many people are motivated by environmental concerns, connecting sustainability to tangible business benefits - cost savings, client expectations, reputation, competitiveness - reinforces that these practices are good for everyone. It broadens the appeal and shows organisational commitment.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Gamification applies game-like elements (points, challenges, leaderboards, rewards) to non-game contexts. In sustainability, this might include team challenges for waste reduction, recognition for ideas implemented, or friendly competition between sites. It makes participation engaging and progress visible.',
    },
    {
      question:
        'Why is it important to celebrate small wins when building a sustainability culture?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'Recognising small successes - a percentage reduction in waste, adoption of a new practice, a cost saving achieved - builds momentum and shows the team that their efforts matter. This positive reinforcement encourages continued engagement and makes larger goals seem achievable.',
    },
    {
      question:
        "What role does 'psychological safety' play in promoting sustainability within teams?",
      options: [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Resistance to change is a natural human response - people prefer familiar practices and may worry about extra work or criticism of past methods. Address it by explaining the 'why', involving team members in how changes are implemented, starting with easy wins, and acknowledging valid concerns.",
    },
    {
      question:
        'Why should sustainability be integrated into existing processes rather than added as a separate layer?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "When sustainability is woven into existing practices - planning, ordering, site setup, completion routines - it becomes 'how we do things' rather than an additional task. Standalone initiatives often feel like extra work and are more easily neglected when pressure increases.",
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Sustainability works best when it's a conversation, not a directive. Frontline workers often see barriers that management doesn't, have practical improvement ideas, and are more engaged when they feel heard. Regular feedback mechanisms (informal and formal) are essential for continuous improvement.",
    },
    {
        ...
        <div className="relative overflow-hidden mb-8 p-6 md:p-8 rounded-2xl bg-gradient-to-br from-[#252525] to-[#1a1a1a] border border-[#333333]">
          ...
          <div className="relative">
            ...
            <p className="text-[#a1a1a1]">
              Understanding how to build, embed, and maintain sustainable practices within
              electrical contracting teams - turning environmental awareness into everyday
              behaviour.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8">
          <div className="p-4 rounded-xl bg-gradient-to-br from-[#252525] to-[#1a1a1a] border border-[#333333]">
            ...
            <p className="text-sm text-[#a1a1a1]">
              Sustainability culture requires leadership by example, regular communication, employee
              involvement, and celebration of progress. Focus on integrating sustainable practices
              into daily routines rather than treating them as separate initiatives. Make it easy to
              do the right thing, and recognise those who do.
            </p>
          </div>
          <div className="p-4 rounded-xl bg-gradient-to-br from-[#252525] to-[#1a1a1a] border border-[#333333]">
            <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-sm text-[#a1a1a1]">
              Start conversations about sustainability during site work. Share tips with colleagues.
              Ask 'is there a more sustainable way?' when planning work. Suggest improvements - even
              small ones. Your enthusiasm and example influence others. Culture change starts with
              individuals choosing to act differently.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <section className="p-6 rounded-xl bg-gradient-to-br from-[#252525] to-[#1a1a1a] border border-[#333333]">
            ...
            <div className="space-y-4 text-[#a1a1a1]">
              <p>
                Policies and procedures can mandate certain behaviours, but genuine sustainability
                requires people to make good choices even when no one is watching. That's culture -
                the shared values, assumptions, and habits that guide everyday behaviour. A strong
                sustainability culture makes environmentally responsible decisions feel natural and
                normal.
              </p>
              ...
              <div className="p-4 bg-[#1a1a1a] rounded-lg border border-[#333333]">
                ...
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div className="p-3 bg-[#252525] rounded">
                    ...
                    <p className="mt-2">
                      "The van log says check tyre pressure weekly, but nobody does."
                    </p>
                  </div>
                  <div className="p-3 bg-[#252525] rounded">
                    ...
                    <p className="mt-2">
                      "The team reminds each other about fuel efficiency - we all care about our
                      impact."
                    </p>
                  </div>
                </div>
              ...
              <p>
                <strong className="text-[#f5f5f5]">The business case:</strong> Companies with strong
                sustainability cultures report better employee engagement, easier recruitment of
                younger workers, improved client relationships, and often lower costs. Culture
                creates competitive advantage that policies alone cannot achieve.
              </p>
            </div>
          </section>
          ...
          <section className="p-6 rounded-xl bg-gradient-to-br from-[#252525] to-[#1a1a1a] border border-[#333333]">
            ...
            <div className="space-y-4 text-[#a1a1a1]">
              <p>
                The most powerful influence on team behaviour is what they see leaders and
                experienced colleagues doing. If supervisors cut corners on waste segregation, team
                members learn that sustainability isn't really important. If leaders visibly
                prioritise environmental practices, the message is clear without needing to be
                stated.
              </p>
              ...
              <div className="p-4 bg-[#1a1a1a] rounded-lg border border-[#333333]">
                ...
                <div className="space-y-3 text-sm">
                  <div className="p-3 bg-[#252525] rounded">
                    ...
                    <p className="mt-1">
                      Personally separating waste correctly, turning off equipment when not in use,
                      planning efficient routes, asking about material sustainability when ordering.
                    </p>
                  </div>
                  <div className="p-3 bg-[#252525] rounded">
                    <span className="text-[#FFD93D] font-medium">Communication:</span>
                    <p className="mt-1">
                      Talking about sustainability regularly (not just during audits), asking team
                      members about their ideas, acknowledging good practices when seen.
                    </p>
                  </div>
                  <div className="p-3 bg-[#252525] rounded">
                    <span className="text-[#FFD93D] font-medium">Decision Making:</span>
                    <p className="mt-1">
                      Considering environmental factors in purchasing decisions, not overriding
                      sustainable choices for short-term convenience, investing in efficient
                      equipment.
                    </p>
                  </div>
                  <div className="p-3 bg-[#252525] rounded">
                    ...
                    <p className="mt-1">
                      Treating sustainability issues as seriously as safety issues, seeking
                      solutions rather than blame, learning from incidents.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                <strong className="text-[#f5f5f5]">For apprentices and newer workers:</strong> You
                can also lead by example. Your enthusiasm and fresh perspective are valuable. When
                you demonstrate sustainable practices, you influence colleagues around you and help
                normalise these behaviours across the team.
              </p>
            </div>
          </section>
          ...
          <section className="p-6 rounded-xl bg-gradient-to-br from-[#252525] to-[#1a1a1a] border border-[#333333]">
            ...
            <div className="space-y-4 text-[#a1a1a1]">
              <p>
                Communication about sustainability needs to be regular, relevant, and two-way.
                Occasional memos or annual training aren't enough. Effective communication keeps
                sustainability visible, shares progress, addresses concerns, and generates ideas.
              </p>
              ...
              <div className="mt-4 p-4 bg-[#FFD93D]/10 rounded-lg border border-[#FFD93D]/30">
                <p className="text-sm text-[#f5f5f5]">
                  <strong>Toolbox Talk tip:</strong> Keep them short (5-10 minutes), focused on one
                  topic, and interactive. Ask questions rather than just presenting. Relate to
                  current site conditions or recent incidents. End with one clear action people can
                  take. Rotate who leads them to spread ownership.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="p-6 rounded-xl bg-gradient-to-br from-[#252525] to-[#1a1a1a] border border-[#333333]">
            ...
            <div className="space-y-4 text-[#a1a1a1]">
              <p>
                People are more committed to changes they helped create. Involvement builds
                ownership, generates better ideas (frontline workers often see barriers and
                opportunities invisible to management), and reduces resistance to change.
              </p>
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3 p-3 bg-[#252525] rounded">
                    ...
                    <div>
                      ...
                      <p className="text-[#a1a1a1]">
                        Suggestion schemes, brainstorming sessions, 'what would you improve?'
                        discussions. Respond to all suggestions, implement good ones, explain why
                        others weren't taken forward.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-[#252525] rounded">
                    ...
                    <div>
                      ...
                      <p className="text-[#a1a1a1]">
                        When planning how to implement changes, ask those affected how it might work
                        best. 'How could we make waste sorting easier on this site?' generates
                        better solutions than imposing procedures.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-[#252525] rounded">
                    ...
                    <div>
                      ...
                      <p className="text-[#a1a1a1]">
                        Designate team members as sustainability champions - points of contact who
                        promote initiatives, gather feedback, and coordinate improvements. Spread
                        the role across the team over time.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-[#252525] rounded">
                    ...
                    <div>
                      ...
                      <p className="text-[#a1a1a1]">
                        Let team members lead specific initiatives - someone manages the cable
                        recycling process, another tracks van fuel efficiency. Ownership drives
                        engagement.
                      </p>
                    </div>
                  </div>
              ...
              <p>
                <strong className="text-[#f5f5f5]">Psychological safety:</strong> People will only
                share ideas and concerns if they feel safe doing so. Create an environment where
                questions are welcomed, suggestions are considered fairly, and mistakes are learning
                opportunities rather than blame opportunities. This openness is essential for
          ...
          <section className="p-6 rounded-xl bg-gradient-to-br from-[#252525] to-[#1a1a1a] border border-[#333333]">
            ...
            <div className="space-y-4 text-[#a1a1a1]">
              <p>
                Recognition reinforces desired behaviours and shows that sustainability efforts are
                valued. It doesn't have to be expensive - acknowledgement, thanks, and celebration
                of milestones are often more meaningful than financial rewards.
              </p>
              ...
              <div className="mt-4 p-4 bg-[#FFD93D]/10 rounded-lg border border-[#FFD93D]/30">
                <p className="text-sm text-[#f5f5f5]">
                  <strong>Gamification idea:</strong> Create friendly competition - which site has
                  the best waste segregation? Which team improved fuel efficiency most? Display
                  progress visibly. Award 'sustainability star of the month'. Make it fun rather
                  than pressured. Competition engages people who might not respond to environmental
                  arguments alone.
                </p>
              </div>
            </div>
          ...
          <section className="p-6 rounded-xl bg-gradient-to-br from-[#252525] to-[#1a1a1a] border border-[#333333]">
            ...
            <div className="space-y-4 text-[#a1a1a1]">
              <p>
                Resistance to change is natural - people prefer familiar practices and may worry
                about extra work, criticism of past methods, or appearing incompetent with new
                approaches. Understanding and addressing resistance is essential for successful
                culture change.
              </p>
                ...
                <div className="space-y-3 text-sm">
                  <div className="p-3 bg-[#252525] rounded">
                    ...
                    <p className="mt-1 text-[#a1a1a1]">
                      Response: Show how sustainable practices save time (fewer returns for
                      forgotten materials, less waste management hassle). Integrate into existing
                      routines rather than adding separate tasks.
                    </p>
                  </div>
                  <div className="p-3 bg-[#252525] rounded">
                    ...
                    <p className="mt-1 text-[#a1a1a1]">
                      Response: Acknowledge experience but explain why change is needed (client
                      requirements, regulations, costs). Involve experienced workers in how to
                      implement changes - their knowledge is valuable.
                    </p>
                  </div>
                  <div className="p-3 bg-[#252525] rounded">
                    <span className="text-red-400 font-medium">
                    ...
                    <p className="mt-1 text-[#a1a1a1]">
                      Response: Show collective impact - small actions multiplied across the
                      team/industry do add up. Share data on improvements achieved. Connect
                      individual actions to bigger picture.
                    </p>
                  </div>
                  <div className="p-3 bg-[#252525] rounded">
                    <span className="text-red-400 font-medium">
                      "It's management's responsibility, not mine."
                    </span>
                    <p className="mt-1 text-[#a1a1a1]">
                      Response: Explain that culture is everyone's responsibility. Frontline workers
                      make hundreds of small decisions daily that management can't control.
                      Sustainability is part of professional competence.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                <strong className="text-[#f5f5f5]">Key principles:</strong> Start with quick wins to
                build credibility. Listen to concerns genuinely - some resistance highlights real
                barriers that need addressing. Don't criticise past practices - focus on future
                improvement. Make it easy to comply - remove practical barriers. Be patient -
          ...
          <section className="p-6 rounded-xl bg-gradient-to-br from-[#252525] to-[#1a1a1a] border border-[#333333]">
            ...
            <div className="space-y-4 text-[#a1a1a1]">
              <p>
                Initial enthusiasm often fades. Sustaining a sustainability culture requires ongoing
                attention, regular reinforcement, and integration into normal business operations
                rather than treating it as a special initiative.
              </p>
              ...
              <div className="p-4 bg-[#1a1a1a] rounded-lg border border-[#333333]">
                ...
                <div className="grid md:grid-cols-2 gap-3 text-sm">
                  <div className="p-2 bg-[#252525] rounded">
                    ...
                    <p className="text-[#a1a1a1]">
                      Embed sustainability into standard procedures, inductions, job planning,
                      purchasing
                    </p>
                  </div>
                  <div className="p-2 bg-[#252525] rounded">
                    ...
                    <p className="text-[#a1a1a1]">
                      Track and report progress - what gets measured gets managed
                    </p>
                  </div>
                  <div className="p-2 bg-[#252525] rounded">
                    <span className="text-[#FFD93D]">Renewal:</span>
                    <p className="text-[#a1a1a1]">
                      Refresh approaches periodically - new challenges, new ideas, new champions
                    </p>
                  </div>
                  <div className="p-2 bg-[#252525] rounded">
                    <span className="text-[#FFD93D]">Connection:</span>
                    <p className="text-[#a1a1a1]">
                      Link to current events, client requirements, industry developments
                    </p>
                  </div>
                  <div className="p-2 bg-[#252525] rounded">
                    <span className="text-[#FFD93D]">Accountability:</span>
                    <p className="text-[#a1a1a1]">
                      Include sustainability in performance discussions and reviews
                    </p>
                  </div>
                  <div className="p-2 bg-[#252525] rounded">
                    <span className="text-[#FFD93D]">Leadership:</span>
                    <p className="text-[#a1a1a1]">
                      Sustained visible commitment from management at all levels
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                <strong className="text-[#f5f5f5]">Remember:</strong> Culture change is a journey,
                not a destination. There will be setbacks - busy periods when sustainability slips
                down the priority list, new team members who need bringing up to speed, changes that
                don't work as planned. The key is persistence and continuous improvement, not
                perfection.
              </p>
            </div>
          </section>
                ...
                <div className="mb-6 p-4 rounded-lg bg-[#1a1a1a] border border-[#333333]">
                  {score === quizQuestions.length ? (
                    <p className="text-green-400">
                      Perfect score! You understand the principles of building sustainability
                      culture.
                    </p>
                  ) : score >= quizQuestions.length * 0.8 ? (
                    <p className="text-green-400">
                      Great work! You have a strong grasp of culture change principles.
                    </p>
                  ) : score >= quizQuestions.length * 0.6 ? (
                    <p className="text-[#FFD93D]">
                      Good effort! Review the sections on leadership and engagement.
                    </p>
                  ) : (
                    <p className="text-orange-400">
                      Keep learning! Focus on understanding how culture differs from policy.
                    </p>
                  )}
                </div>
          ...
          <section className="p-6 rounded-xl bg-gradient-to-br from-green-900/20 to-[#1a1a1a] border border-green-500/30">
            <div className="text-center">
              ...
              <p className="text-[#a1a1a1] mb-4">
                You've completed all topics in Section 6: Sustainable Working Practices. You now
                understand waste management, hazardous disposal, life-cycle thinking, carbon
                reduction, and building sustainability culture within teams.
              </p>
              <p className="text-sm text-[#a1a1a1]">
