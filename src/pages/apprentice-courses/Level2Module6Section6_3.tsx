...
const Level2Module6Section6_3 = () => {
  ...
  const spotItQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Low insulation resistance (typically below 1 MΩ) indicates damaged or deteriorated insulation that could allow leakage currents or create shock risks.',
    },
    {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 0,
      explanation:
        'Environmental factors like heat, moisture, and physical damage cause insulation to deteriorate.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'Incorrect polarity means switching occurs in the neutral, leaving equipment live when apparently switched off.',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'All defects must be recorded clearly and investigated, as even minor issues can escalate to serious hazards.',
    },
    {
      id: 10,
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-card border border-elec-yellow/20">
              ...
              <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-foreground">•</span>
                  <span>
                    <strong>Spot:</strong> Unusual test readings or poor workmanship
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-foreground">•</span>
                  <span>
                    <strong>Use:</strong> Visual inspection plus targeted retests
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-foreground">•</span>
                  <span>
                    <strong>Check:</strong> All readings against BS 7671 limits
                  </span>
                </li>
              </ul>
            </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <p className="text-sm sm:text-base text-foreground mb-4">
            Testing is not just about ticking boxes; it is about uncovering real faults in an
            installation that could cause danger or failure in service. By learning to recognise
            common installation defects, apprentices can develop the awareness needed to spot issues
            before they become serious hazards. This subsection introduces the typical problems that
            test results reveal and explains how they affect safety, performance, and compliance.
          </p>
        </Card>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
                ...
                <div className="flex items-start gap-2 sm:gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-elec-yellow dark:text-elec-yellow mb-2 sm:mb-3 text-sm sm:text-base">
                      Understanding Common Installation Defects
                    </p>

                    <div className="space-y-4">
                      <p className="text-xs sm:text-sm text-foreground">
                        Electrical installation defects fall into several categories, each with
                        distinct characteristics and safety implications. Poor workmanship defects
                        include loose connections, inadequate cable support, incorrect terminations,
                        and failure to follow manufacturer's instructions. These defects often
                        result from rushed work, insufficient training, or lack of proper
                        supervision during installation.
                      </p>
                      <p className="text-xs sm:text-sm text-foreground">
                        Material deterioration defects develop over time due to environmental
                        conditions, overloading, or normal aging. Common examples include insulation
                        breakdown due to moisture ingress, conductor corrosion in damp conditions,
                        and mechanical damage from inadequate protection. These defects highlight
                        the importance of proper installation techniques and environmental
                        protection.
                      </p>
                      <p className="text-xs sm:text-sm text-foreground">
                        Design and specification errors can create systemic problems throughout an
                        installation. Examples include undersized protective conductors,
                        inappropriate cable selection for environmental conditions, inadequate fault
                        protection coordination, and missing or incorrectly rated protective
                        devices. These defects often require extensive remedial work to achieve
                        compliance.
                      </p>
                      <p className="text-xs sm:text-sm text-foreground">
                        Compliance defects involve installations that may function adequately but
                        fail to meet current regulatory standards. This is particularly common in
                        older installations or where work has been carried out without proper
                        certification. Examples include missing RCD protection, inadequate earthing
                        arrangements, and non-compliant wiring methods in special locations.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-green-600 dark:text-green-400 mb-3 text-base">
                      Insulation Resistance Test Failures
                    </p>

                    <div className="space-y-4">
                      <p className="text-xs sm:text-sm text-foreground">
                        Low insulation resistance readings are among the most common test failures,
                        typically indicating moisture ingress, contamination, or physical damage to
                        cable insulation. Moisture can enter through damaged outer sheaths, poorly
                        sealed gland entries, or condensation in cold conditions. Even small amounts
                        of moisture can dramatically reduce insulation resistance, creating
                        potential shock and fire hazards.
                      </p>
                      <p className="text-xs sm:text-sm text-foreground">
                        Contamination of cable insulation can occur during installation through
                        contact with cement, plaster, oils, or other substances that compromise
                        insulation properties. Poor storage conditions before installation can also
                        lead to contamination that only becomes apparent during testing. This
                        emphasizes the importance of proper cable handling and protection throughout
                        the installation process.
                      </p>
                      <p className="text-xs sm:text-sm text-foreground">
                        Physical damage to cable insulation often results from poor installation
                        practices, including excessive bending, crushing, or nicking during cable
                        pulling. Sharp edges on cable trays, trunking, or conduit entries can damage
                        insulation even after installation is complete. Rodent damage in roof spaces
                        and basements is another common cause of insulation failures.
                      </p>
                      <p className="text-xs sm:text-sm text-foreground">
                        Age-related insulation deterioration affects older installations,
                        particularly those with rubber or early PVC insulation that becomes brittle
                        over time. Thermal cycling from load variations can accelerate this process,
                        causing insulation to crack and lose its protective properties. Regular
                        testing helps identify these issues before they create dangerous conditions.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-elec-yellow mb-3 text-base">
                      Continuity and Earth Loop Impedance Problems
                    </p>

                    <div className="space-y-4">
                      <p className="text-xs sm:text-sm text-foreground">
                        High continuity readings in protective conductors indicate poor connections,
                        corrosion, or missing links in the earthing system. Loose connections at
                        earth terminals are particularly common, often resulting from inadequate
                        tightening torque or failure to clean contact surfaces before connection.
                        These faults can prevent protective devices from operating correctly during
                        earth faults.
                      </p>
                      <p className="text-xs sm:text-sm text-foreground">
                        Missing or inadequately sized protective conductors create serious safety
                        hazards and will show as open circuits during continuity testing. This
                        defect is sometimes found in older installations where earthing requirements
                        have changed, or in DIY work where the importance of protective conductors
                        is not understood. The consequences can be fatal if metalwork becomes live
                        during a fault.
                      </p>
                      <p className="text-xs sm:text-sm text-foreground">
                        High earth loop impedance readings often result from poor supply earth
                        connections, inadequate main earthing conductor sizing, or high resistance
                        in the supply system. These issues prevent protective devices from operating
                        within required disconnection times, leaving circuits and equipment
                        unprotected during earth faults. The problem may affect multiple circuits or
                        the entire installation.
                      </p>
                      <p className="text-xs sm:text-sm text-foreground">
                        Neutral-earth faults can cause both continuity and RCD test failures. These
                        faults typically occur where neutral and earth conductors have been
                        incorrectly connected together downstream of the main earth terminal. This
                        creates parallel earth paths that can cause RCDs to fail to operate
                        correctly and may result in dangerous neutral potential rise during faults.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <InlineCheck
            ...
            options={[
              ...
              'Equipment damage',
              'Failure of protective devices to operate correctly',
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-elec-yellow mb-3 text-base">
                      Polarity and RCD Defects
                    </p>

                    <div className="space-y-4">
                      <p className="text-xs sm:text-sm text-foreground">
                        Polarity errors create immediate and serious shock hazards by leaving
                        equipment permanently live even when switched off. The most dangerous
                        polarity error is switching the neutral conductor instead of the line
                        conductor, which means that equipment remains energized at line potential
                        even when the switch is in the "off" position. This is particularly
                        hazardous for maintenance work or lamp changing.
                      </p>
                      <p className="text-xs sm:text-sm text-foreground">
                        Reversed polarity at socket outlets can affect the safety of connected
                        equipment, particularly items with exposed metalwork. Some appliances rely
                        on correct polarity for their internal protection arrangements to function
                        properly. Additionally, reversed polarity can affect the operation of some
                        electronic equipment and may create problems with certain types of
                        protective devices.
                      </p>
                      <p className="text-xs sm:text-sm text-foreground">
                        RCD operation failures often result from neutral-earth faults that create
                        alternative current paths bypassing the RCD's detection mechanism. These
                        faults can occur anywhere in the protected circuit and prevent the RCD from
                        detecting genuine earth leakage currents. The result is that the RCD
                        provides no protection despite appearing to be correctly installed and
                        functioning.
                      </p>
                      <p className="text-xs sm:text-sm text-foreground">
                        Incorrect RCD wiring, including reversed line and neutral connections or
                        missing neutral connections, will prevent proper operation. Some RCDs are
                        sensitive to the direction of current flow and must be wired correctly to
                        function. Additionally, connecting the neutral conductor to earth downstream
                        of the RCD will cause nuisance tripping or prevent operation entirely.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <CardContent>
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Always investigate unusual or borderline readings — they often point to real
                  defects
                </span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>
                  Be alert to signs of poor workmanship, such as loose screws, nicked insulation, or
                  untidy wiring
                </span>
              </li>
              <li className="flex items-start gap-2">
                ...
                <span>
                  Record defects clearly in the test documentation, noting their nature and location
                </span>
              </li>
              <li className="flex items-start gap-2">
                <XCircle className="w-5 h-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                <span>
                  Never ignore a fault just because it is "small"; even minor defects can escalate
          ...
          <div className="space-y-4 text-sm sm:text-base">
            <div>
              ...
              <p className="text-white/80">
                ...
                loop impedance readings exceeding BS 7671 limits.
              </p>
            </div>
            <div>
              ...
              <p className="text-white/80">
                ...
                showed loose earth connections in several distribution boards.
              </p>
            </div>
            <div>
              ...
              <p className="text-white/80">
                ...
                earth terminal connections over time.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-white/80">
                ...
                created a serious shock hazard for maintenance staff.
              </p>
            </div>
            <div>
              ...
              <p className="text-white/80">
                ...
                preventive measures would have cost.
              </p>
            </div>
            <div className="p-3 sm:p-4 bg-card rounded-lg border border-green-500/20">
              <p className="text-green-700 dark:text-green-300 font-medium">
                ✅ Lesson: Multiple installation defects often occur together and can compound
                safety risks. Regular testing identifies developing problems before they become
                dangerous, and systematic investigation reveals the full extent of defects rather
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-gradient-to-br from-primary/5 to-elec-yellow/10 border border-primary/20">
          ...
          <div className="mt-4 sm:mt-6 p-3 sm:p-4 rounded-lg bg-primary/10 border border-primary/20">
            <p className="text-center text-sm sm:text-base font-medium text-foreground">
              💡 Remember: Systematic testing reveals installation defects that visual inspection
              alone cannot detect!
            </p>
          </div>
        </Card>
