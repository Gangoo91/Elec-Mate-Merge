  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'PUWER stands for Provision and Use of Work Equipment Regulations 1998. This legislation sets requirements for all work equipment to be suitable for purpose, properly maintained, and safely used.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'Regulation 4 (Suitability) requires work equipment to be suitable for its intended use. For electricians, this means using test instruments with correct CAT ratings, tools appropriate for the task, and PPE matched to the hazards present.',
    },
    {
      id: 3,
      ...
      correctAnswer: 1,
      explanation:
        'Regulation 5 places a duty on employers to ensure work equipment is maintained in an efficient state, in efficient working order, and in good repair. Where maintenance logs are required, they must be kept up to date.',
    },
    {
      id: 4,
      question:
        'Under PUWER Regulation 6, when must work equipment be inspected by a competent person?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'Regulation 6 requires inspection by a competent person where the safety of equipment depends on how it is installed. This includes inspection after installation, before first use, and at suitable intervals thereafter.',
    },
    {
      id: 5,
      question:
        'How often must lifting equipment used for lifting PERSONS undergo thorough examination under LOLER?',
      options: ['Every 3 months', 'Every 6 months', 'Every 12 months', 'Every 24 months'],
      correctAnswer: 1,
      explanation:
        'Under LOLER, lifting equipment used for lifting persons (such as MEWPs/cherry pickers) must undergo thorough examination at least every 6 months. This higher frequency reflects the greater risk when people are being lifted.',
    },
    {
      id: 6,
      question:
        'What is the thorough examination interval for lifting equipment NOT used for lifting persons?',
      options: ['Every 6 months', 'Every 12 months', 'Every 18 months', 'Every 24 months'],
      correctAnswer: 1,
      explanation:
        'Lifting equipment not used for lifting persons (such as hoists for materials) must undergo thorough examination at least every 12 months, or in accordance with an examination scheme drawn up by a competent person.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'Before using any power tool, electricians should visually inspect for damage to cables, plugs and casings, verify PAT test labels are current, ensure guards and safety features work, and confirm the tool is suitable for the specific task.',
    },
    {
      id: 8,
      question:
        'What must be done with a power tool found to have damaged insulation during pre-use inspection?',
      options: [
      ...
      correctAnswer: 2,
      explanation:
        'Damaged equipment must be immediately withdrawn from use, clearly labelled as defective, and removed from the work area. It must be repaired by a competent person or disposed of. Never continue using damaged electrical equipment.',
    },
    {
      id: 9,
      ...
      correctAnswer: 2,
      explanation:
        'LOLER requires that reports of thorough examinations are kept and made available. Equipment must also be clearly marked with its Safe Working Load (SWL). Operating lifting equipment without valid documentation is a breach of LOLER.',
    },
    {
      id: 10,
      ...
      correctAnswer: 1,
      explanation:
        'IPAF (International Powered Access Federation) is the industry standard body providing training and certification for MEWP operators. LOLER requires operators to be adequately trained and competent for the equipment they use.',
    },
    {
      id: 11,
      ...
      correctAnswer: 1,
      explanation:
        'SWL stands for Safe Working Load - the maximum load the equipment is designed to lift safely. Before any lifting operation, you must check the SWL is adequate for the intended load. Exceeding SWL can cause catastrophic failure.',
    },
    {
      id: 12,
      question:
        'Under PUWER, who has the primary duty to ensure work equipment is suitable and safe?',
      options: ['The equipment manufacturer', 'The employee using it', 'The employer', 'The HSE'],
      correctAnswer: 2,
      explanation:
        'Employers have the primary duty under PUWER to provide suitable, maintained, and safe equipment. However, employees also have duties to use equipment properly, report defects, and cooperate with safety measures.',
    },
  ];
        ...
        <div className="max-w-3xl mx-auto space-y-8 sm:space-y-12">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="p-4 sm:p-5 rounded-xl bg-elec-yellow/10 border border-elec-yellow/20">
              ...
              <ul className="space-y-2 text-sm text-white/80">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow mt-1">*</span>
                  <strong className="text-white">Use:</strong> Equipment suitable for task, within
                  safe limits
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow mt-1">*</span>
                  <strong className="text-white">Check:</strong> Inspection dates, SWL markings,
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white">
                PUWER Requirements - Suitability, Maintenance, Inspection
              </h2>
            </div>
            <div className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10 space-y-4">
              <p className="text-white/80 text-sm sm:text-base leading-relaxed">
                ...
                applies to all work equipment provided for use at work. "Work equipment" includes
                any machinery, appliance, apparatus, tool, or installation used at work - from a
                simple screwdriver to complex multifunction test instruments.
              </p>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/20">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  As an electrician, you're particularly at risk because your work involves both
                  electrical hazards and mechanical hazards from tools.
                </p>
              </div>
              ...
              <div className="space-y-4 mt-4">
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    must be rated for the voltage being tested. Test instruments must have
                    appropriate CAT ratings for the installation type. Using a CAT III instrument in
                    a CAT IV environment would breach suitability requirements - and could result in
                    injury or death if an arc flash occurs.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    . Where equipment has a maintenance log, it must be kept up to date. For
                    electricians, this covers regular servicing of power tools, calibration of test
                    instruments, and prompt repair or replacement of any defective items.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    by a competent person. This applies to fixed equipment as well as portable
                    tools. Records of inspections must be kept. The frequency of inspection depends
                    on the risk - high-use tools on construction sites need more frequent inspection
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white">
                Electrical Equipment Under PUWER
              </h2>
            </div>
            <div className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10 space-y-4">
              <p className="text-white/80 text-sm sm:text-base leading-relaxed">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    properly maintained, and regularly calibrated. Test leads and probes must be
                    inspected for damage before use. Instruments should carry calibration
                    certificates showing they are within accuracy specifications - typically
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    are preferred on construction sites to reduce shock risk, but they still require
                    the same inspection regime as 230V equipment.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    schedules. A damaged extension lead can cause fire or electric shock - treat
                    them with the same care as any other electrical equipment.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/20">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    determined by risk assessment. Failed equipment must be immediately removed from
                    service, clearly labelled as defective, and either repaired by a competent
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">
                      ...
                      prevents accidents. If you find a defect, DO NOT USE the equipment - withdraw
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white">
                LOLER Requirements - Lifting Equipment
              </h2>
            </div>
            <div className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10 space-y-4">
              <p className="text-white/80 text-sm sm:text-base leading-relaxed">
                ...
                apply to all lifting equipment and lifting operations in the workplace. For
                electricians, this commonly includes MEWPs (cherry pickers), scaffold hoists,
                lifting slings, and any equipment used to lift loads or people.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    reflects the greater consequence of failure when people are being lifted.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    lifting beams. An examination scheme by a competent person may specify different
                    intervals based on use.
                  </p>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  does not exceed this limit. Overloading lifting equipment can cause catastrophic
                  failure - chains can snap, hydraulics can fail, structures can collapse. Never
                  exceed the SWL under any circumstances.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  <strong className="text-white">cannot be repaired and reused</strong> - they must
                  be disposed of. A worn chain link or frayed sling could fail under load with fatal
                  consequences.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/20">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  without valid documentation is a breach of LOLER - and puts you at risk if the
                  equipment fails.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    certificates. This should become automatic - it only takes a few minutes but
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    familiarisation, perform pre-use checks per the operator's manual, and ensure
                    rescue plans are in place. Never operate a MEWP without valid documentation.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    ensure the load is properly secured before lifting, and keep the area below
                    clear during lifting operations.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    equipment or accessories in the field - this must be done by competent persons
                ...
                <div className="p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/20">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    MEWPs, specific operator training such as IPAF certification. You should not use
                    equipment you haven't been trained on.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="p-4 sm:p-6 rounded-xl bg-gradient-to-br from-amber-500/10 to-red-500/10 border border-amber-500/20">
            ...
            <div className="space-y-3 text-sm text-white/80">
              <p>
                ...
                to access high-level installation points. The site foreman directed the electrician
                to a MEWP available on site.
              </p>
              <p>
                <strong className="text-white">The Near Miss:</strong> The electrician noticed the
                thorough examination sticker showed it was 8 months since the last examination - 2
                months overdue. When he raised this with the foreman, he was told "it's fine, we've
                been using it for weeks." The electrician refused to use the equipment and reported
                the issue.
              </p>
              <p>
                <strong className="text-white">The Investigation:</strong> An HSE inspector visited
                following the report. The MEWP was examined and found to have significant hydraulic
                issues that could have caused the platform to fail during use. The site manager
                received an Improvement Notice and faced potential prosecution.
              </p>
              <p>
                <strong className="text-white">The Lesson:</strong> Always check examination dates
                before using lifting equipment. The electrician's knowledge of LOLER requirements
                and refusal to use non-compliant equipment potentially prevented a serious accident.
                Never assume equipment is compliant - verify it yourself.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10">
            <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">
              Practical Guidance - Compliance Checklists
            </h2>
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            ...
            <div className="space-y-4">
              <details className="group">
                <summary className="cursor-pointer font-medium text-white hover:text-elec-yellow active:text-elec-yellow transition-all touch-manipulation flex items-center justify-between">
                  ...
                  <span className="text-elec-yellow group-open:rotate-180 transition-transform">
                    +
                  </span>
                </summary>
                <p className="mt-2 text-white/70 text-sm pl-4 border-l-2 border-elec-yellow/30">
                  ...
                  self-employed, you have the same duties as an employer for equipment you provide.
                </p>
              </details>
              <details className="group">
                <summary className="cursor-pointer font-medium text-white hover:text-elec-yellow active:text-elec-yellow transition-all touch-manipulation flex items-center justify-between">
                ...
                <p className="mt-2 text-white/70 text-sm pl-4 border-l-2 border-elec-yellow/30">
                  ...
                  schedules when used on their sites.
                </p>
              </details>
              <details className="group">
                <summary className="cursor-pointer font-medium text-white hover:text-elec-yellow active:text-elec-yellow transition-all touch-manipulation flex items-center justify-between">
                ...
                <p className="mt-2 text-white/70 text-sm pl-4 border-l-2 border-elec-yellow/30">
                  ...
                  and rescue. Familiarisation training is also required for specific machine types.
                </p>
              </details>
              <details className="group">
                <summary className="cursor-pointer font-medium text-white hover:text-elec-yellow active:text-elec-yellow transition-all touch-manipulation flex items-center justify-between">
              ...
              <details className="group">
                ...
                <p className="mt-2 text-white/70 text-sm pl-4 border-l-2 border-elec-yellow/30">
                  ...
                  reasonably believe puts you in serious and imminent danger.
                </p>
              </details>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-6 rounded-xl bg-gradient-to-br from-elec-yellow/10 to-elec-yellow/5 border border-elec-yellow/20">
            <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">
              Pocket Guide - PUWER & LOLER Quick Reference
            </h2>
            <div className="grid sm:grid-cols-2 gap-4 text-sm">
              <div className="space-y-2">
                ...
                <ul className="space-y-1 text-white/80">
                  ...
                  <li>
                    * <strong className="text-white">Reg 5:</strong> Must be maintained in good
                    repair
                  </li>
                  <li>
                    * <strong className="text-white">Reg 6:</strong> Inspection by competent person
                  </li>
              ...
              <div className="space-y-2">
                ...
                <ul className="space-y-1 text-white/80">
                  ...
                  <li>
                    * <strong className="text-white">12 months:</strong> Lifting materials only
                  </li>
