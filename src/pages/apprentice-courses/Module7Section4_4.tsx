      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <header className="text-center mb-12">
            ...
            <p className="text-white text-lg">Split and Isolate Method</p>
          </header>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm font-medium text-white mb-2">Halving Progression</p>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-white mb-2">Testing Strategy</p>
                    <ul className="text-sm text-white space-y-1">
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <ol className="text-sm text-white space-y-1 list-decimal pl-4">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm font-medium text-white mb-2">Healthy Half Results</p>
                    <ul className="text-sm text-white space-y-1">
                  ...
                  <div>
                    <p className="text-sm font-medium text-white mb-2">Faulty Half Indicators</p>
                    <ul className="text-sm text-white space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    • <strong className="text-white">First division:</strong> Fault located to
                    specific half of ring (50% reduction)
                  </li>
                  <li>
                    • <strong className="text-white">Second division:</strong> Faulty half
                    subdivided again (75% total elimination)
                  </li>
                  <li>
                    • <strong className="text-white">Third division:</strong> Further subdivision
                    narrows to small section (87.5% elimination)
                  </li>
                  <li>
                    • <strong className="text-white">Final location:</strong> Fault pinpointed to
                    specific cable run or connection
                  </li>
                  <li>
                    • <strong className="text-white">Verification:</strong> Final testing
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="text-sm text-white space-y-1">
                      <li>
                        • <strong className="text-white">Level 1:</strong> Main distribution
                        board zones
                      </li>
                      <li>
                        • <strong className="text-white">Level 2:</strong> Sub-distribution board
                        areas
                      </li>
                      <li>
                        • <strong className="text-white">Level 3:</strong> Floor or wing sections
                      </li>
                      <li>
                        • <strong className="text-white">Level 4:</strong> Individual final
                        circuits
                      </li>
                      <li>
                        • <strong className="text-white">Level 5:</strong> Component-level
                        testing
                      </li>
                    </ul>
                  </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    • <strong className="text-white">Office buildings:</strong> Floor-by-floor or
                    department-based zones
                  </li>
                  <li>
                    • <strong className="text-white">Factories:</strong> Production line or
                    process area divisions
                  </li>
                  <li>
                    • <strong className="text-white">Retail spaces:</strong> Trading area or
                    department zones
                  </li>
                  <li>
                    • <strong className="text-white">Hospitals:</strong> Ward or department-based
                    isolation
                  </li>
                  <li>
                    • <strong className="text-white">Schools:</strong> Building or teaching area
                    sections
                  </li>
                  <li>
                    • <strong className="text-white">Data centres:</strong> Rack row or
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-white mb-2">Record-Keeping System</p>
                    <ul className="text-sm text-white space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm font-medium text-white mb-2">Role Division</p>
                    <ul className="text-sm text-white space-y-1">
                      <li>
                        • <strong className="text-white">Tester:</strong> Carries out
                        measurements and tests
                      </li>
                      <li>
                        • <strong className="text-white">Recorder:</strong> Documents results and
                        progress
                      </li>
                      <li>
                        • <strong className="text-white">Both:</strong> Verify isolation and
                        safety procedures
                      </li>
                      <li>
                        • <strong className="text-white">Communication:</strong> Constant liaison
                        on progress
                      </li>
                    </ul>
                  </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    • <strong className="text-white">Safe isolation:</strong> Verify each zone is
                    properly isolated before testing
                  </li>
                  <li>
                    • <strong className="text-white">Proving unit:</strong> Test voltage
                    indicators before and after each measurement
                  </li>
                  <li>
                    • <strong className="text-white">Lockout/tagout:</strong> Secure isolation
                    points to prevent accidental re-energisation
                  </li>
                  <li>
                    • <strong className="text-white">PPE requirements:</strong> Appropriate
                    protective equipment for each testing phase
                  </li>
                  <li>
                    • <strong className="text-white">Communication:</strong> Clear communication
                    with other personnel about testing activities
                  </li>
                  <li>
                    • <strong className="text-white">Emergency procedures:</strong> Establish
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <div className="space-y-4">
                  <div>
                    <p className="text-sm font-medium text-white mb-2">Scenario</p>
                    <p className="text-sm text-white">
                  ...
                  <div>
                    <p className="text-sm font-medium text-white mb-2">Zone Division Process</p>
                    <ol className="text-sm text-white space-y-1 list-decimal pl-4">
                      <li>
                        <strong className="text-white">Initial division:</strong> Split circuit
                      ...
                      <li>
                        <strong className="text-white">Final location:</strong> Fault narrowed to
                        specific section between two sockets
                      </li>
                      <li>
                        <strong className="text-white">Fault identified:</strong> CPC not
                        connected properly at one socket outlet
                      </li>
                      <li>
                        <strong className="text-white">Repair completed:</strong> Proper
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ol className="text-sm text-white space-y-1 list-decimal pl-4">
                      <li>
                        <strong className="text-white">Level 1 division:</strong> Isolated one
                        half of warehouse lighting at distribution board
                      </li>
                      <li>
                        <strong className="text-white">Fault identification:</strong> Problems
                        only occurred in isolated half, confirming fault location
                      </li>
                      <li>
                        <strong className="text-white">Level 2 division:</strong> Further divided
                        faulty half into smaller zones using sub-circuits
                      </li>
                      <li>
                        <strong className="text-white">Final location:</strong> Narrowed fault to
                        specific junction box serving affected area
                      </li>
                      <li>
                        <strong className="text-white">Root cause:</strong> Loose neutral
