...
const FunctionalSkillsModule2Section4 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "'Each' is a singular subject, so it requires a singular verb — 'Each of the RCDs was tested individually' is correct. This is a common subject-verb agreement error. 'Each' always takes a singular verb, even when followed by a plural noun.",
    },
    {
      id: 6,
      ...
      correctAnswer: 2,
      explanation:
        "The correct sentence starts with a capital letter, uses a comma before 'and' when joining two independent clauses (both could stand alone as sentences), and ends with a full stop. Abbreviations like EICR should always be in capitals.",
    },
    {
      id: 7,
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              grammar, they may question whether the same lack of attention was applied to the
              wiring. When a building inspector reads an observation that is vague, misspelt or
              grammatically incorrect, it undermines the credibility of the entire report.
            </p>
            <p>
              This is not about being pedantic or academic. It is about professionalism. Every
              Electrical Installation Certificate (EIC), every Electrical Installation Condition
              Report (EICR), every email to a client, and every method statement you write carries
              your name and your company's reputation. Getting the spelling, grammar and punctuation
              right is just as important as getting the wiring right.
            </p>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                your certificates are often a client's first impression of your competence.
              </p>
            </div>

            <h4 className="text-white font-semibold pt-2">
              Where spelling and grammar matter most
            </h4>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  ...
                  questions about the validity of the certification.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
            ...
            <p>Consider these scenarios where poor writing has real consequences:</p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  An EICR observation that says "earth to small" instead of "earth too small" — the
                  spelling error changes the meaning entirely and could be misinterpreted
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  A quotation email with "your" instead of "you're" and no full stops — the client
                  may choose a competitor who writes more professionally
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  A method statement with ambiguous instructions because of missing commas — workers
                  may interpret the sequence incorrectly, creating a safety risk
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  A day sheet that records "tested all circuits" with no specific details — in a
                  legal dispute, this vague record provides no useful evidence
                </span>
              </li>
            </ul>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                Taking pride in your written work protects your professional standing.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              reports and emails matters for your professional credibility. A misspelt technical
              term on an official document is like a loose connection in a consumer unit — it might
              not cause an immediate problem, but it shows a lack of attention to detail.
            </p>

            <h4 className="text-white font-semibold pt-2">Commonly misspelt electrical terms</h4>
            <p>
              These are the words that trip up electricians most frequently. Learn them, and you
              will avoid the most common errors in the trade:
            </p>
            ...
            <p>
              As a UK-based electrician, you must use UK English spellings on all official
              documentation. Many spell checkers default to American English, so you need to be
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                spell checker does not recognise.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              checkers will not catch them because the word itself is spelt correctly — just used in
              the wrong context. As an electrician, you will use many of these words daily in your
              certificates, emails and reports.
            </p>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              colloquial language should be replaced with the correct technical term. Knowing when
              to use abbreviations and when to write the full term is equally important.
            </p>

            <h4 className="text-white font-semibold pt-2">
              BS 7671 terms — use the correct definitions
            </h4>
            <p>
              BS 7671 has specific definitions for many terms. Using the wrong word can change the
              meaning entirely:
            </p>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-2">
            ...
            <p>
              The electrical trade uses many abbreviations. Always ensure you know what they stand
              for:
            </p>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-2">
            ...
            <h4 className="text-white font-semibold pt-2">
              When to use full terms vs abbreviations
            </h4>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Write the full term the first time you use it, with the abbreviation in brackets
                    — then use the abbreviation thereafter. Example: "The Residual Current Device
                    (RCD) was tested. The RCD tripped within 28ms."
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Use full terms when writing for non-technical audiences (clients, building
                    managers, letting agents)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Abbreviations are acceptable in technical reports, test schedules, and
                    communication with other electricians
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    On certificates, standard abbreviations (RCD, MCB, RCBO, Zs, Ze) are understood
                    and acceptable
                  </span>
                </li>
              </ul>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              not to impress. Every sentence you write on a certificate, in a report, or in an email
              should pass one test: would the reader understand exactly what you mean on the first
              reading?
            </p>

            <h4 className="text-white font-semibold pt-2">Complete sentences</h4>
            <p>
              A complete sentence needs a subject (who or what) and a verb (what they are doing or
              what happened). Sentence fragments are incomplete and cause confusion:
            </p>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-red-300">Fragment:</strong> "Tested and found
                    satisfactory." (Who tested? What was tested?)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-green-300">Complete:</strong> "The insulation resistance
                    of Circuit 3 was tested and found satisfactory at 200 MΩ."
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-red-300">Fragment:</strong> "Because the RCD did not
                    trip."
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-green-300">Complete:</strong> "The circuit was
                    de-energised because the RCD did not trip within the required time."
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-red-300">Fragment:</strong> "Loose connections
                    throughout."
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-green-300">Complete:</strong> "Loose connections were
                    found at multiple socket outlets throughout the ground floor."
                  </span>
                </li>
              </ul>
            </div>
            ...
            <p>
              Active voice is clearer, shorter, and more direct than passive voice. In active voice,
              the subject does the action. In passive voice, the action is done to the subject:
            </p>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-green-300">Active:</strong> "Isolate the supply before
                    starting work"
                  </span>
                </li>
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-green-300">Active:</strong> "I tested the circuit and
                    the readings were satisfactory"
                  </span>
                </li>
              </ul>
            </div>
            <p>
              Note: In some formal documents like EICR observations, passive voice is conventional
              ("The installation was found to be..."). Use whichever voice is appropriate for the
              document type, but in general, prefer active voice for clarity.
            </p>

            <h4 className="text-white font-semibold pt-2">One idea per sentence</h4>
            <p>
              Long sentences that try to convey multiple ideas are harder to read and more likely to
              contain errors. Break them up:
            </p>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <span className="text-red-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-red-300">Too long:</strong> "The consumer unit was
                    replaced with a new metal-clad unit fitted with RCBOs to all circuits and the
                    earthing arrangement was confirmed as TN-C-S and the main earth was measured at
                    0.12 ohms and all circuits were tested and the results were satisfactory."
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-green-300">Better:</strong> "The consumer unit was
                    replaced with a new metal-clad unit fitted with RCBOs to all circuits. The
                    earthing arrangement was confirmed as TN-C-S, with a main earth reading of 0.12
                    Ω. All circuits were tested and the results were satisfactory."
                  </span>
                </li>
              </ul>
            </div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Use imperative mood (commands): "Isolate the supply" not "The supply should be
                  isolated"
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>One instruction per sentence — do not chain multiple actions together</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Be specific: "Test at 500 V DC" not "Test at the appropriate voltage"</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Include quantities and measurements: "Install 4mm² twin and earth cable" not
                  "Install suitable cable"
                </span>
              </li>
            </ul>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              safety risks. A missing comma in a list of actions can merge two separate steps into
              one. A misplaced apostrophe can change a plural into a possessive. These are the
              punctuation marks you need to use correctly in your everyday work.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Every sentence must end with a full stop (or question mark / exclamation mark)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Use them in abbreviations only where convention requires — 'e.g.' is acceptable;
                    'BS 7671' does not need full stops
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    In bullet point lists, use full stops at the end of each point if the points are
                    complete sentences. If they are short phrases, full stops are optional but be
                    consistent.
                  </span>
                </li>
              </ul>
            ...
            <p>
              Apostrophes have only two jobs — showing possession and indicating contractions. They
              are NEVER used to make plurals. This is one of the most common errors in the trade.
            </p>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-red-300">NOT for plurals:</strong> "3 RCDs" is correct —
                    "3 RCD's" is WRONG. "All circuits" is correct — "All circuit's" is WRONG.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-red-300">NOT with decades:</strong> "1990s" is correct —
                    "1990's" is WRONG (unless you mean something belonging to the year 1990).
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                is it a shortened form? If neither, do not use an apostrophe.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              to see rather than what is actually written. These techniques will help you catch
              mistakes that you would otherwise miss.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Read the document aloud, slowly and deliberately — your ear will catch errors
                    that your eye misses
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>If a sentence sounds awkward when spoken, it probably needs rewriting</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    This is especially effective for spotting missing words, wrong homophones, and
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    If you cannot read aloud on site, move your lips silently — this still engages
                    the 'hearing' part of your brain
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Read the last sentence first, then the one before, and work your way to the
                    beginning
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    This breaks the flow of meaning and forces you to focus on each sentence
                    individually
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Particularly useful for spotting spelling errors and punctuation problems
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    For individual word spelling, you can read each word in isolation by covering
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    If time allows, write the document and then review it the following day
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Fresh eyes spot errors that tired eyes miss — this is especially valuable for
                    important documents like quotations and reports
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Even a 30-minute break between writing and proofreading makes a significant
                    difference
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Never rely on spell check alone — it is a tool, not a substitute for careful
                    reading
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Are all technical terms spelt correctly? (accessory, fluorescent, maintenance,
                    luminaire)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Have I used the correct homophones throughout? (their/there/they're,
                    your/you're, its/it's, to/too)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>Are all sentences complete — with a subject and a verb?</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>Is the punctuation correct — especially apostrophes?</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>Have I used UK English spellings throughout?</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>Are abbreviations consistent and correctly capitalised?</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>Is the tense consistent throughout the document?</span>
                </li>
              </ul>
            </div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              a checklist before submitting certificates, reports, emails and other professional
              documents.
            </p>
            ...
            <p>
              Let us apply everything from this section to a real-world task: writing a professional
            ...
            <div className="bg-white/5 border border-red-500/30 rounded-xl p-4">
              ...
              <p className="text-xs text-white mt-3">
                ...
                stops, fragment sentence ("needs replacing"), missing apostrophe (theres), vague
                language, no specific location, no observation code, no regulation reference.
              </p>
            </div>
            ...
            <div className="bg-white/5 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white italic">
                ...
                and 5 are undersized for the associated overcurrent protective devices. Accessory
                faceplates in the kitchen are loose and not secured to the back boxes. (C2 —
              ...
              <p className="text-xs text-white mt-3">
                ...
                included, observation code with recommended action.
              </p>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-red-300">NEVER for plurals:</strong> RCDs, MCBs,
                    circuits, accessories, 1990s — no apostrophe
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>Spelling checked — especially trade-specific words?</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&#10003;</span>
                  <span>Homophones correct throughout?</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&#10003;</span>
                  <span>All sentences complete with subject and verb?</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&#10003;</span>
                  <span>Punctuation correct — especially apostrophes?</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&#10003;</span>
                  <span>Tense consistent throughout?</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&#10003;</span>
                  <span>UK English spellings used?</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&#10003;</span>
                  <span>Correct technical terminology used?</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&#10003;</span>
                  <span>
                    Would someone unfamiliar with the job understand what you have written?
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                clients expect in your electrical work. An electrician who writes well is an
                electrician who is taken seriously.
              </p>
            </div>
          </div>
        </motion.div>
