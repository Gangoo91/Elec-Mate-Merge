...
const DESCRIPTION =
  'Learn how current splits and voltage is equal across branches in parallel circuits. UK electricians, BS 7671 aligned.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'Zero on all branches',
      'Depends on resistance',
    ],
    correctIndex: 1,
    explanation:
      'Each parallel branch receives the full supply voltage - this is a fundamental parallel circuit rule.',
  },
  {
    id: '2',
    question: 'Which statement about total current in parallel circuits is correct?',
    options: [
      'Total current equals branch current',
      'Total current is the sum of all branch currents',
      'Total current is always 1A',
      'Total current equals supply voltage',
    ],
    correctIndex: 1,
    explanation:
      "By Kirchhoff's Current Law, total current equals the sum of all branch currents: It = I1 + I2 + I3...",
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Each additional branch provides another path for current flow, reducing the overall opposition to current. The total resistance is always less than the smallest branch resistance.',
  },
  {
    question: 'How do I check parallel circuit calculations on site?',
    answer:
      'Measure voltage across each branch (should equal supply), measure branch currents and verify they sum to total current, and check that protective devices are correctly rated.',
  },
  {
    question: 'What happens if one branch fails in a parallel circuit?',
    answer:
      'Other branches continue to operate normally - this is why household sockets remain powered when one appliance fails. Only the failed branch loses power.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Series LED string in a driver',
      'Ring final circuit socket outlets',
      'A single filament lamp',
  ...
  },
  {
    ...
    options: [
      ...
      'Guessing currents',
      'Using any conductor size',
    ],
    correctAnswer: 1,
    explanation:
      'Design and verification must consider voltage drop and disconnection times with correct Zs.',
  },
  {
    id: 6,
    question:
      'If one branch in a parallel circuit has 2Ω and another has 6Ω, the equivalent resistance is...',
  ...
  },
  {
    ...
    options: [
      ...
      'Only the total load',
      'Wire temperature only',
    ],
    correctAnswer: 1,
    explanation:
      'All factors affecting safety and performance must be verified according to BS 7671.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      'Each new parallel branch provides another current path, reducing total resistance and increasing total current drawn from the supply.',
  },
  {
    id: 10,
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Voltage:</strong> Same across each branch (Vbranch = Vs)
              </li>
              <li>
                <strong>Current splits:</strong> It = I1 + I2 + ...
              </li>
              <li>
                <strong>Req:</strong> Lower than any single branch
              </li>
              <li>
                <strong>Two-resistor formula:</strong> (R1×R2)/(R1+R2)
              </li>
              <li>
                <strong>Failure mode:</strong> Open branch doesn't stop other branches
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Ring finals, multiple luminaire circuits, control panels
              </li>
              <li>
                <strong>Use:</strong> Load-balancing checks, verifying Zs/volt drop
              </li>
              <li>
                <strong>Apply:</strong> Socket outlet testing, multi-core cable applications
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              In parallel circuits, each branch provides a separate path for current flow. This
              creates three fundamental rules:
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Quick Example:</strong> 12V supply, two branches: R1 = 6Ω, R2 = 12Ω
              <br />
              I1 = 12V ÷ 6Ω = 2A, I2 = 12V ÷ 12Ω = 1A
              <br />
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Current divides inversely proportional to resistance - lower resistance branches draw
              more current.
            </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>Step 1:</strong> Calculate branch currents
                </li>
                <li className="ml-4">I1 = 24V ÷ 120Ω = 0.2A</li>
                <li className="ml-4">I2 = 24V ÷ 80Ω = 0.3A</li>
                <li className="ml-4">I3 = 24V ÷ 240Ω = 0.1A</li>
                <li>
                  <strong>Step 2:</strong> Total current = 0.2 + 0.3 + 0.1 = 0.6A
                </li>
                <li>
                  <strong>Step 3:</strong> Equivalent resistance = 24V ÷ 0.6A = 40Ω
                </li>
                <li>
                  <strong>Check:</strong> 1/40 = 1/120 + 1/80 + 1/240 = 0.025
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Parallel circuits form the backbone of electrical installations - from socket outlets
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>BS 7671 Design Considerations:</strong>
              <br />
              Voltage Drop: Calculate for maximum demand, ensure 3% for lighting, 5% for power
              <br />
              Protective Devices: Must disconnect in required time based on Zs values
              <br />
              Cable Sizing: Each branch must carry its design current safely
              <br />
              Fault Protection: Verify earth fault loop impedance for each outlet
              <br />
        ...
        <section className="mb-10">
          ...
          <div className="mt-6 p-5 rounded-lg bg-transparent">
            <h3 className="text-sm font-medium text-white mb-4">
              Quick Reference: Parallel Circuit Rules
            </h3>
