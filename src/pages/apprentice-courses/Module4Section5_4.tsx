...
const TITLE =
  'Using Ferrules, Sleeving, Glands, and Crimps - Module 4.5.4 | Level 2 Electrical Course';
const DESCRIPTION =
  'Master cable termination accessories including ferrules, sleeving, glands, and crimps. Learn proper selection, fitting techniques, and BS 7671 compliance for safe electrical installations.';
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Uninsulated ferrules:</strong> Bare copper or tinned copper for
                    general use
                  </li>
                  <li>
                    • <strong>Insulated ferrules:</strong> Colour-coded plastic sleeves for
                    identification
                  </li>
                  <li>
                    • <strong>Twin ferrules:</strong> For terminating two conductors in one terminal
                  </li>
                  <li>
                    • <strong>Long ferrules:</strong> Extended support in vibration applications
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10 pt-8 border-t border-white/10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Green/Yellow:</strong> Circuit Protective Conductor (CPC/Earth) -
                    mandatory
                  </li>
                  <li>
                    • <strong>Blue:</strong> Neutral conductor identification where required
                  </li>
                  <li>
                    • <strong>Brown:</strong> Line conductor identification in control circuits
                  </li>
          ...
          <section className="mb-10 pt-8 border-t border-white/10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Metallic glands:</strong> For armoured cables, provide earth
                    continuity
                  </li>
                  <li>
                    • <strong>Plastic glands:</strong> Common for indoor flexible cable terminations
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>IP68:</strong> Complete protection against dust and continuous water
                    immersion
                  </li>
                  <li>
          ...
          <section className="mb-10 pt-8 border-t border-white/10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Ring crimps:</strong> For bolted terminations, secure mechanical
                    connection
                  </li>
                  <li>
                    • <strong>Spade crimps:</strong> For quick-connect terminals, easy disconnection
                  </li>
                  <li>
                    • <strong>Butt crimps:</strong> For joining conductors end-to-end
                  </li>
                  <li>
            ...
            <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
              ...
              <div className="p-3 bg-green-500/10 border border-green-500/20 rounded">
                <p className="text-green-400 text-sm">
                  <strong>Lesson learned:</strong> Quality termination techniques prevent expensive
                  failures. The rework cost significantly more than doing it correctly initially.
                </p>
              </div>
            </div>
          </section>
          ...
          <Quiz
            ...
            title="Test your knowledge of ferrules, sleeving, glands, and crimps"
          />
