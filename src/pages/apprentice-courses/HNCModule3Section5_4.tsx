...
const quickCheckQuestions = [
  {
    ...
    options: ['1500 rev/min', '1000 rev/min', '3000 rev/min', '750 rev/min'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['75-100A', '150-200A', '25-50A', '250-300A'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Cylindrical', 'Wound rotor', 'Squirrel cage', 'Salient pole'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1000 rev/min', '1500 rev/min', '750 rev/min', '3000 rev/min'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['0.85 lagging', '0.2-0.3 lagging', '0.95 lagging', '0.5 lagging'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['15.3 kVA', '31.2 kVA', '26.5 kVA', '45.0 kVA'],
    correctAnswer: 1,
    explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/h-n-c-module3-section5"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The retained Ecodesign motor regulation makes IE3 the legal minimum for three-phase
              induction motors placed on the UK market since 2021, IE4 for 75&ndash;200 kW since
              2023. As the BSE designer you specify motors against this benchmark and document
              compliance in the Part L 2021 / SBEM submission. Sub-IE3 motors cannot be supplied for
              new installations &mdash; rejection of non-compliant submissions is normal practice.
            </>
          }
        ...
        <ConceptBlock title="Motor Construction - Stator and Rotor">
          <p>
            ...
            carrying the three-phase windings, and a rotating rotor. The type of rotor construction
            determines the motor's characteristics and applications.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Construction</strong> — Aluminium/copper bars short-circuited by end rings —
              Three-phase windings connected to slip rings
            </li>
            <li>
              <strong>External connections</strong> — None - completely enclosed — Slip rings and
              brushes for external resistance
            </li>
            <li>
              <strong>Maintenance</strong> — Very low - bearings only — Higher - brushes and slip
              rings require attention
            </li>
            <li>
              <strong>Starting current</strong> — High (6-8 x FLC) — Controllable via external
              resistance
            </li>
            <li>
              <strong>Starting torque</strong> — Moderate (1.5-2.5 x rated) — High and adjustable
            </li>
            <li>
              <strong>Speed control</strong> — VSD required for variable speed — Limited control via
              rotor resistance
            </li>
            <li>
            ...
            <li>
              <strong>Typical applications</strong> — HVAC fans, pumps, general machinery — Cranes,
              hoists, large compressors
            </li>
          </ul>
        ...
        <ConceptBlock title="Rotating Magnetic Field Principle">
          <p>
            ...
            operation. Three-phase currents, displaced by 120 degrees in time, flow through windings
            displaced by 120 degrees in space, creating a magnetic field that rotates at synchronous
            speed.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Synchronous Speed Formula</p>
          <p>
            <strong>
              n<sub>s</sub> = (120 x f) / p
            </strong>
          </p>
          <p>Where: ns = synchronous speed (rev/min), f = frequency (Hz), p = number of poles</p>

          <p className="text-sm font-medium text-elec-yellow/80">Synchronous Speeds at 50Hz</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2</strong> — 3000 rev/min — 2850-2950 rev/min — Small pumps, fans
            </li>
            <li>
              <strong>4</strong> — 1500 rev/min — 1420-1480 rev/min — Most HVAC motors, general
              purpose
            </li>
            <li>
              <strong>6</strong> — 1000 rev/min — 940-980 rev/min — Larger fans, cooling towers
            </li>
            <li>
              <strong>8</strong> — 750 rev/min — 700-740 rev/min — Low-speed applications
            </li>
          </ul>

          <p className="text-sm font-medium text-white">How the rotating field develops:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              At any instant, the three-phase currents have different magnitudes and directions
            </li>
            <li>The resultant magnetic field has constant magnitude but rotates in space</li>
            <li>The field completes one revolution per cycle for a 2-pole motor</li>
            <li>More poles means more field reversals per revolution, hence lower speed</li>
            <li>Reversing any two supply phases reverses the direction of rotation</li>
          </ul>

          <p>
            <strong>Key insight:</strong> The rotating field speed depends only on supply frequency
            and number of poles. VSDs control motor speed by varying supply frequency.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Slip - The Essential Speed Difference">
          ...
          <p>Where: s = slip (per-unit or %), ns = synchronous speed, nr = rotor speed</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Rotor conductors must cut through the rotating magnetic field</li>
            <li>Relative motion induces EMF in rotor (Faraday's law)</li>
            <li>EMF drives current through the shorted rotor bars</li>
            <li>Rotor current interacts with stator field to produce torque</li>
            <li>As load increases, speed drops, slip increases, more torque produced</li>
          </ul>
          ...
          <p>
            <strong>Question:</strong> A 6-pole motor on 50Hz supply runs at 960 rev/min. Calculate
            the slip.
          </p>
          ...
          <p>This indicates the motor is operating near full load</p>
        ...
        <ConceptBlock title="Torque-Speed Characteristics">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Starting torque</strong> — s = 1 (100%) — 1.5-2.5 x rated — Motor stationary,
              maximum slip
            </li>
            <li>
              <strong>Pull-up torque</strong> — s = 0.6-0.8 — Minimum during acceleration — Must
              exceed load torque at all speeds
            </li>
            <li>
              <strong>Breakdown torque</strong> — s = 0.15-0.30 — 2-3 x rated (maximum) — Pull-out
              point - motor stalls if exceeded
            </li>
            <li>
              <strong>Full load</strong> — s = 0.03-0.05 — Rated torque — Normal operating point
            </li>
            <li>
              <strong>No load</strong> — s = 0.01-0.02 — Minimal (friction only) — Near synchronous
              speed
            </li>
            <li>
              <strong>Synchronous</strong> — s = 0 — Zero — Theoretical - never reached
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Stable Operating Region</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fans and pumps:</strong> Torque proportional to speed squared (T ~ n squared)
              - easy starting
            </li>
            <li>
              <strong>Compressors:</strong> May require high starting torque, often started unloaded
            </li>
            <li>
              <strong>Conveyors:</strong> Constant torque loads - starting torque must exceed load
              torque
            </li>
          </ul>
        ...
        <ConceptBlock title="Starting Current and Starting Methods">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Supply authority limitations (often 100A maximum starting current)</li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Direct On Line (DOL)</strong> — 6-8 x FLC — 100% — Small motors up to 7.5kW
            </li>
            <li>
              <strong>Star-Delta</strong> — 2-2.7 x FLC — 33% — Medium motors, light starting loads
            </li>
            <li>
              <strong>Autotransformer</strong> — Adjustable (40-80%) — Proportional to voltage
              squared — Large motors, adjustable reduction needed
            </li>
            <li>
              <strong>Soft Starter</strong> — 2-4 x FLC (adjustable) — Adjustable ramp — Pumps,
              conveyors, smooth acceleration
            </li>
            <li>
              <strong>VSD (Variable Speed Drive)</strong> — 1-1.5 x FLC — Up to 150% available — All
              HVAC applications with speed control
            </li>
            <li>
              <strong>Wound Rotor (resistance)</strong> — 1.5-2 x FLC — High and adjustable —
          ...
          <p>
            <strong>Question:</strong> A 22kW motor has FLC of 42A. Calculate starting currents for
            DOL and star-delta.
          </p>
          ...
          <p>Star-delta reduces current to 1/3 but also reduces torque to 1/3</p>

          <p>
            <strong>Building services standard:</strong> VSDs are now the preferred starting method
            for HVAC motors as they provide soft starting (low starting current), speed control for
            energy saving, and eliminate the need for star-delta changeover.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Power Factor Variation with Load">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Power Factor vs Loading</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>No load</strong> — 0.15-0.30 — Mainly magnetising current (reactive)
            </li>
            <li>
              <strong>25% load</strong> — 0.50-0.60 — Increasing active power component
            </li>
            <li>
              <strong>50% load</strong> — 0.70-0.80 — Active and reactive comparable
            </li>
            <li>
              <strong>75% load</strong> — 0.80-0.88 — Approaching optimum
            </li>
            <li>
              <strong>100% load</strong> — 0.85-0.92 — Best power factor for the motor
            </li>
            <li>
              <strong>Overload</strong> — 0.88-0.93 — Slight improvement but not sustainable
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Effects of Poor Power Factor</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Question:</strong> A 15kW load at 0.7 pf vs 0.9 pf on 400V three-phase. Compare
            currents.
          </p>
          ...
          <p>Improving pf from 0.7 to 0.9 reduces current by 22%</p>
        ...
        <ConceptBlock title="Motor Nameplate Data Interpretation">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Typical Nameplate Information</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Rated power</strong> — 15 kW — Load matching, energy calculations
            </li>
            <li>
              <strong>Voltage</strong> — 400V Delta / 690V Star — Connection configuration, VSD
              compatibility
            </li>
            <li>
              <strong>Full load current</strong> — 28.5A — Cable sizing, protection settings
            </li>
            <li>
              <strong>Frequency</strong> — 50 Hz — VSD frequency range
            </li>
            <li>
              <strong>Speed</strong> — 1460 rev/min — Pole number (4-pole), slip calculation
            </li>
            <li>
              <strong>Efficiency class</strong> — IE3 — Energy performance, regulatory compliance
            </li>
            <li>
              <strong>Power factor</strong> — 0.86 — Supply sizing, pf correction
            </li>
            <li>
              <strong>Duty type</strong> — S1 — Continuous (S1), intermittent (S3), etc.
            </li>
            <li>
              <strong>Insulation class</strong> — F — Maximum winding temperature (155 degrees C)
            </li>
            <li>
              <strong>IP rating</strong> — IP55 — Protection against dust and water jets
            </li>
            <li>
              <strong>Frame size</strong> — 160M — Mounting dimensions, replacement
            </li>
          </ul>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Duty Types (IEC 60034-1)</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Building Services Applications">
          <p>
            Induction motors are the workhorses of building services, driving HVAC equipment, water
            systems, and building infrastructure. Understanding application-specific requirements
            ensures correct motor selection and efficient operation.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">HVAC Applications</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>AHU supply fan</strong> — SCIM + VSD — 5-75 kW — Variable flow control, energy
              saving
            </li>
            <li>
              <strong>Extract fan</strong> — SCIM (DOL or VSD) — 0.5-15 kW — Often constant speed,
              simple control
            </li>
            <li>
              <strong>Chilled water pump</strong> — SCIM + VSD — 7.5-55 kW — Variable flow, pressure
              control
            </li>
            <li>
              <strong>Condenser water pump</strong> — SCIM (DOL) — 11-45 kW — Often constant flow,
              high reliability
            </li>
            <li>
              <strong>Cooling tower fan</strong> — SCIM + VSD — 7.5-37 kW — Temperature control,
              energy saving
            </li>
            <li>
              <strong>Chiller compressor</strong> — SCIM or scroll — 50-500 kW — High starting
              torque, soft starting
            </li>
          </ul>
          ...
          <p>Centrifugal fans and pumps follow the affinity laws:</p>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">VSD Benefits for HVAC</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Question:</strong> An AHU requires 12m cubed per second at 800Pa total pressure.
            Fan efficiency is 75%. Select motor size.
          </p>
          ...
          <p>
            <strong>Energy efficiency:</strong> Motors typically run for 3000-8000 hours annually in
            building services. Energy costs over the motor lifetime far exceed the purchase price -
            specifying high-efficiency motors pays back quickly.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              The supply fan AHU motor on a school&rsquo;s main hall has failed after 15 years. The
              original was 22 kW IE2 with a star-delta starter. The maintenance contractor proposes
              a like-for-like IE3 replacement. The BSE consultant overseeing the school&rsquo;s
              decarbonisation pathway requires evaluation against IE4 + VSD as alternative.
            </>
          }
          whatToDo={
            <>
              Run the lifecycle: IE3 motor input = 22/0.926 = 23.76 kW; IE4 motor input = 22/0.936 =
              23.50 kW. The fan operates 4500 hours/year typical school occupancy. IE4 saves 1170
              kWh vs IE3 (~&pound;234/year + 0.16 t CO&#x2082;). Adding a VSD to ramp speed with
              occupancy (BMS-controlled) typically saves a further 25&ndash;30 % on top via cube-law
              fan affinity &mdash; another ~5000 kWh/year. Specify IE4 motor + VSD; remove the
              obsolete star-delta starter; document the saving against the school&rsquo;s Climate
              Change Levy / DEC reporting.
            </>
          }
          whyItMatters={
            <>
              Decarbonising a public-sector estate is now policy-driven (Net Zero 2050; Public
              Sector Decarbonisation Scheme grants). The HNC engineer signs off the motor + drive
              selection that delivers the saving and the evidence the funding application depends
              on.
            </>
          }
        />
