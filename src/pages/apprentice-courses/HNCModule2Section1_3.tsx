...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['3672 W/m²', '918 W/m²', '7344 W/m²', '1836 W/m²'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ["α = ε (Kirchhoff's Law)", 'α + ε = 1', 'α × ε = 1', 'α = 1 - ε'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE provides the UK design framework for radiative analysis. As an HNC designer your
              spec choices on glazing g-value, low-e coatings and radiant panel area follow directly
              from this framework. Building Regulations Part L sets the regulatory ceiling.
            </>
          }
        ...
        >
          <p>
            ...
            in the infrared spectrum. Unlike conduction and convection, radiation requires no medium
            and can transfer heat through a vacuum - this is how the Sun heats the Earth.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Radiation power increases with T⁴ (doubling temperature increases radiation 16-fold)
            </li>
          ...
          <p>
            <strong>Critical insight:</strong> The T⁴ relationship makes radiation dominant at high
            temperatures. At furnace temperatures (1000°C+), radiation accounts for over 90% of heat
            transfer.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            A black body is a theoretical surface that absorbs all incident radiation and emits the
            maximum possible radiation at any temperature. Real surfaces are compared to this ideal
            through emissivity. View factors determine how radiation is distributed between
            surfaces.
          </p>
          <p>
          ...
          <p>
            <strong>Practical tip:</strong> View factors can be found in charts and tables in CIBSE
            guides or calculated using software. For complex geometries, numerical methods are
            typically used.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            from radiant heating system design to window specification and thermal comfort
            assessment.
          </p>
          <p>
          ...
          <p>
            <strong>Surface temperature considerations:</strong> Cold internal surfaces (below 14°C)
            cause radiant asymmetry discomfort and risk condensation. Well-insulated construction
            with low-e glazing maintains higher internal surface temperatures.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Q = <strong>531W</strong> (panel output: 266 W/m²)
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              (a) Standard glass both sides: εeff = 1 / (1/0.84 + 1/0.84 - 1) = 1 / (1.19 + 1.19 -
              1) = 1 / 1.38 = <strong>0.72</strong>
            </li>
            <li>
              (b) One low-e surface: εeff = 1 / (1/0.84 + 1/0.05 - 1) = 1 / (1.19 + 20 - 1) = 1 /
              20.19 = <strong>0.05</strong>
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              (a) Dark bitumen: Q = 0.90 × 600 = <strong>540 W/m²</strong>
            </li>
            <li>
              (b) White coating: Q = 0.25 × 600 = <strong>150 W/m²</strong>
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A new office atrium has 80 m² of south-facing vertical glazing. The architect wants
              the &ldquo;clear glass&rdquo; visual look. The mechanical designer warns the cooling
              load will exceed plant capacity in summer.
            </>
          }
          whatToDo={
            <>
              Run the radiative analysis. Specify a low-e + solar-control double-glazed unit with
              g-value ≤ 0.30 (from BS EN 410), light transmittance ≥ 0.65 (preserves visual
              clarity), U ≤ 1.4 W/m²·K (Part L compliance). Add external solar shading where the
              g-value alone is insufficient. Re-run the cooling load — the radiative + transmitted
              solar should now be within plant capacity. Document the trade-off in the Part L
              submission and a thermal comfort report.
            </>
          }
          whyItMatters={
            <>
              Glazing is the largest single radiative gain on most buildings. A clear untreated
              assembly delivers a g-value of 0.7+; a properly specified solar-control unit can halve
              the gain at the same light transmittance.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Convection</div>
          </button>
          <button
