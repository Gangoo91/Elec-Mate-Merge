...
const DESCRIPTION =
  'Master PPE selection criteria, maintenance schedules, and inspection procedures for electrical safety compliance.';
  ...
  const quickCheckQuestions = [
    {
      ...
      correctIndex: 2,
      explanation:
        'PPE should be inspected before each use and undergo formal periodic inspections according to manufacturer guidelines and workplace procedures.',
    },
    {
      id: 2,
      ...
      correctIndex: 1,
      explanation:
        'Employers are legally responsible for providing suitable PPE free of charge when risks cannot be adequately controlled by other means.',
    },
  ];
  ...
  const quizQuestions = [
    {
      ...
      options: ['Price and colour', 'Hazard and task', 'Brand and availability', 'Size and weight'],
      correctAnswer: 1,
      explanation:
        'When selecting PPE, you must consider the hazard (what could cause harm) and the task (what work is being performed) to ensure appropriate protection.',
    },
    {
      id: 2,
      ...
      correctAnswer: 2,
      explanation:
        'Both employers and employees have responsibilities: employers must provide, replace, and maintain PPE, while employees must use it correctly, check it, and report issues.',
    },
    {
      id: 3,
      ...
      correctAnswer: 1,
      explanation:
        'PPE should be taken out of use when damaged, when it no longer fits properly, after its expiry or test date, or when visibly contaminated or worn.',
    },
    {
      id: 4,
      question: 'What markings must approved PPE have?',
      options: ['Made in UK marking', 'CE or UKCA markings', 'Company logo', 'Serial number only'],
      correctAnswer: 1,
      explanation:
        "Approved PPE must have CE or UKCA markings to ensure it's legally approved and tested to meet safety standards.",
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'False. PPE that looks clean may still be damaged, past its expiry date, or have invisible defects that compromise its protective capability.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Never use PPE that doesn't fit correctly. Inform your supervisor immediately and request properly fitting equipment. Ill-fitting PPE can provide inadequate protection or create additional hazards.",
    },
    {
      question: 'Can I modify PPE to make it more comfortable?',
      answer:
        'No, never modify PPE as this can compromise its protective properties and void certifications. If comfort is an issue, speak to your supervisor about alternative approved options that provide the same level of protection.',
    },
    {
      question: 'How do I know when insulating gloves need testing?',
      answer:
        "Insulating gloves must be tested every 6 months or after any suspected damage. Many gloves have test dates marked on them. If in doubt, don't use them - get them tested or replaced.",
    },
    {
      question: 'What records should be kept for PPE?',
      answer:
        'Keep records of issue dates, inspection schedules, test results (for items like insulating gloves), replacement dates, and any training provided. This helps demonstrate compliance and track equipment lifecycle.',
    },
    {
      question: 'Can I take work PPE home for personal use?',
      answer:
        'Generally no, unless specifically authorised. Work PPE is provided for workplace hazards and should remain in the workplace. Personal use may lead to contamination, damage, or the equipment not being available when needed for work.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-foreground">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Selection:</strong> Choose PPE based on risk assessment and task
                  requirements.
                </li>
                <li>
                  <strong>Inspection:</strong> Before each use plus formal periodic checks.
                </li>
                <li>
                  <strong>Maintenance:</strong> Clean, store, and maintain per manufacturer
                  instructions.
                </li>
                <li>
                  <strong>Records:</strong> Keep documentation of inspections, tests, and
                  replacements.
                </li>
                <li>
                  <strong>Training:</strong> Ensure all users understand proper use and care.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Worn PPE, wrong protection level, poor storage, missed
                  inspections.
                </li>
                <li>
                  <strong>Use:</strong> PPE assessments, maintenance schedules, training records.
                </li>
                <li>
                  <strong>Apply:</strong> Right PPE for right risk, regular checks, proper care.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-elec-yellow/5 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <p className="font-medium text-blue-800 dark:text-white mb-3">
                Selecting the right PPE requires careful analysis of the work environment, tasks,
                and potential hazards. The selection must be based on a thorough risk assessment.
              </p>
            </div>
        ...
        <div className="mb-8 border-l-4 border-orange-500 p-6 bg-card rounded-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-foreground">
              Responsibilities for PPE Management
            </h2>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg p-3">
              <p className="text-amber-800 dark:text-amber-200 text-sm">
                <strong>Key Takeaway:</strong> Always check test dates on electrical PPE and never
                use equipment that is overdue for testing. Electrical protection can fail invisibly,
                making regular testing critical for safety.
              </p>
            </div>
          </div>
        </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <ul className="space-y-2 text-foreground">
            ...
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Daily inspection before use and periodic formal inspection are both required
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
