...
const questionBank: Question[] = [
  // Section 1: Understanding Electrical Faults (42 questions)
  {
    ...
    correctAnswer: 0,
    explanation:
      'An open circuit fault is characterised by the interruption of current flow, preventing electricity from completing its intended path.',
    difficulty: 'basic',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'A short circuit causes very high current flow, which will cause protective devices like fuses or MCBs to operate immediately to protect the circuit.',
    difficulty: 'basic',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Loose connections are the most common cause of intermittent faults, as they can make and break contact depending on temperature, vibration, or movement.',
    difficulty: 'basic',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'An earth fault occurs when current flows from a live conductor to earth, either through damaged insulation or accidental contact with earthed metalwork.',
    difficulty: 'basic',
  },
  {
    id: 5,
    question: 'What type of fault is characterised by increased resistance in the circuit?',
    options: ['Short circuit', 'Open circuit', 'High resistance joint', 'Earth fault'],
    correctAnswer: 2,
    explanation:
      'A high resistance joint creates additional resistance in the circuit, often causing voltage drop, heating, and reduced performance.',
    difficulty: 'basic',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'An exposed live conductor poses the greatest shock risk as it provides direct contact with live electrical parts at full voltage.',
    difficulty: 'basic',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'A dead short circuit produces very high fault current, whilst a high resistance fault produces relatively low fault current.',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "Insulation breakdown typically creates a path for current to flow where it shouldn't, resulting in short circuits or earth faults.",
    difficulty: 'basic',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Transient faults occur briefly and may clear themselves, making them difficult to diagnose as they may not be present during testing.',
    difficulty: 'intermediate',
  },
  {
    id: 10,
    ...
    correctAnswer: 2,
    explanation:
      'Environmental factors such as heat, moisture, and UV exposure are the primary causes of cable insulation deterioration over time.',
    difficulty: 'basic',
  },
  {
    id: 11,
    question: 'A fault that only occurs under specific load conditions is described as:',
    options: ['Permanent fault', 'Load-dependent fault', 'Installation fault', 'Design fault'],
    correctAnswer: 1,
    explanation:
      'Load-dependent faults only manifest when specific electrical loads are applied, making them challenging to diagnose under no-load conditions.',
    difficulty: 'intermediate',
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      'Underground cables are particularly susceptible to earth faults due to moisture ingress through damaged cable sheaths or joints.',
    difficulty: 'intermediate',
  },
  {
    id: 13,
    question: 'Which electrical parameter is most affected by a high resistance joint?',
    options: ['Frequency', 'Voltage across the joint', 'Power factor', 'Earth loop impedance'],
    correctAnswer: 1,
    explanation:
      'High resistance joints cause voltage drop across the connection point due to I²R losses, reducing available voltage downstream.',
    difficulty: 'intermediate',
  },
  {
    id: 14,
    ...
    correctAnswer: 1,
    explanation:
      'A symmetrical fault affects all three phases equally, maintaining system balance but with fault conditions present.',
    difficulty: 'advanced',
  },
  {
    id: 15,
    ...
    correctAnswer: 1,
    explanation:
      'Creeping earth faults gradually worsen over time as insulation continues to break down, potentially leading to complete failure.',
    difficulty: 'advanced',
  },
  {
    id: 16,
    ...
    correctAnswer: 2,
    explanation:
      'Intermittent high resistance faults are difficult to detect as they may not be present during testing and require specialised monitoring.',
    difficulty: 'advanced',
  },
  {
    id: 17,
    ...
    correctAnswer: 1,
    explanation:
      'Corona discharge indicates high voltage stress in insulation systems, which can lead to insulation breakdown over time.',
    difficulty: 'advanced',
  },
  {
    id: 18,
    ...
    correctAnswer: 1,
    explanation:
      'A bolted fault is characterised by a low impedance metallic connection, allowing maximum fault current to flow.',
    difficulty: 'intermediate',
  },
  {
    id: 19,
    ...
    correctAnswer: 2,
    explanation:
      'Tracking occurs when moisture combines with contamination on insulation surfaces, creating a conductive path.',
    difficulty: 'intermediate',
  },
  {
    id: 20,
    ...
    correctAnswer: 1,
    explanation:
      'Arcing faults involve intermittent current flow through ionised air (plasma), creating dangerous high-temperature conditions.',
    difficulty: 'advanced',
  },
  {
    id: 21,
    question: 'What is the typical voltage level at which step potential becomes dangerous?',
    options: ['12V', '25V', '50V', '230V'],
    correctAnswer: 2,
    explanation:
      'Step potential becomes dangerous at around 50V, which is considered the safe voltage limit for human contact in most conditions.',
    difficulty: 'basic',
  },
  {
    id: 22,
    question: 'Which fault type is most likely to cause electromagnetic interference?',
    options: ['Open circuit', 'Arcing fault', 'High resistance joint', 'Solid short circuit'],
    correctAnswer: 1,
    explanation:
      'Arcing faults generate electromagnetic interference due to the rapid current changes and plasma formation during arc strikes.',
    difficulty: 'intermediate',
  },
  {
    id: 23,
    question:
      'A fault that affects power quality without tripping protective devices is typically:',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'High resistance faults can affect power quality through voltage drop and harmonics without drawing enough current to trip protective devices.',
    difficulty: 'intermediate',
  },
  {
    id: 24,
    ...
    correctAnswer: 0,
    explanation:
      'Harmonic currents, particularly third harmonics, add in the neutral conductor and can cause overloading and conductor failure.',
    difficulty: 'advanced',
  },
  {
    id: 25,
    ...
    correctAnswer: 2,
    explanation:
      'Polarisation index testing can detect developing insulation faults by measuring how insulation resistance changes over time.',
    difficulty: 'advanced',
  },
  {
    id: 26,
    ...
    correctAnswer: 0,
    explanation:
      'Ground fault and earth fault are different terms for the same phenomenon - current flowing from a live conductor to earth/ground.',
    difficulty: 'basic',
  },
  {
    id: 27,
    ...
    correctAnswer: 1,
    explanation:
      'Series arcing faults occur within the same conductor path, often at loose connections or damaged conductors.',
    difficulty: 'intermediate',
  },
  {
    id: 28,
    ...
    correctAnswer: 1,
    explanation:
      'Parallel arcing faults can draw high currents and present significant fire risk due to the high temperatures generated.',
    difficulty: 'intermediate',
  },
  {
    id: 29,
    ...
    correctAnswer: 2,
    explanation:
      'Sustained partial discharge gradually carbonises insulation, creating conductive paths that lead to complete insulation failure.',
    difficulty: 'advanced',
  },
  {
    id: 30,
    question: 'What type of fault is indicated by a tripping RCD but no obvious damage?',
    options: ['Open circuit fault', 'Short circuit fault', 'Earth leakage fault', 'Neutral fault'],
    correctAnswer: 2,
    explanation:
      'An RCD trips due to earth leakage current, which may not be visible but indicates current flowing to earth through insulation faults.',
    difficulty: 'basic',
  },
  {
    id: 31,
    ...
    correctAnswer: 1,
    explanation:
      'Available fault current determines the severity of electrical faults, affecting arc energy, equipment damage, and safety risks.',
    difficulty: 'intermediate',
  },
  {
    id: 32,
    ...
    correctAnswer: 1,
    explanation:
      'Developing cable faults show gradual degradation of electrical properties like insulation resistance and voltage withstand capability.',
    difficulty: 'intermediate',
  },
  {
    id: 33,
    ...
    correctAnswer: 1,
    explanation:
      'Combined thermal and electrical stress most commonly causes insulation aging, accelerating chemical breakdown processes.',
    difficulty: 'intermediate',
  },
  {
    id: 34,
    ...
    correctAnswer: 1,
    explanation:
      'A fault is a detectable deviation from normal operation, whilst a failure is when equipment ceases to perform its intended function.',
    difficulty: 'intermediate',
  },
  {
    id: 35,
    question: 'Which electrical parameter best indicates developing cable faults?',
    options: ['Voltage only', 'Current only', 'Insulation resistance trends', 'Frequency only'],
    correctAnswer: 2,
    explanation:
      'Monitoring insulation resistance trends over time provides the best indication of developing cable faults before complete failure.',
    difficulty: 'advanced',
  },
  {
    id: 36,
    ...
    correctAnswer: 0,
    explanation:
      'Touch potential is the dangerous voltage that exists between two parts that a person might touch simultaneously during a fault.',
    difficulty: 'intermediate',
  },
  {
    id: 37,
    ...
    correctAnswer: 1,
    explanation:
      'Exposed live parts at hazardous voltage create immediate shock risk and require immediate disconnection for safety.',
    difficulty: 'basic',
  },
  {
    id: 38,
    ...
    correctAnswer: 1,
    explanation:
      "Thermal runaway is indicated by continuously rising temperature that doesn't stabilise even when load is reduced.",
    difficulty: 'advanced',
  },
  {
    id: 39,
    ...
    correctAnswer: 1,
    explanation:
      'Flexible cables most commonly fail due to conductor fracture caused by repeated flexing and mechanical stress.',
    difficulty: 'basic',
  },
  {
    id: 40,
    question: 'What distinguishes a progressive fault from a sudden fault?',
    options: ['Location only', 'Rate of development', 'Voltage level', 'Current magnitude'],
    correctAnswer: 1,
    explanation:
      'Progressive faults develop gradually over time, whilst sudden faults occur instantaneously without warning.',
    difficulty: 'basic',
  },
  {
    id: 41,
    ...
    correctAnswer: 1,
    explanation:
      'Rapidly decreasing insulation resistance indicates accelerating breakdown and imminent insulation failure.',
    difficulty: 'intermediate',
  },
  {
    id: 42,
    ...
    correctAnswer: 1,
    explanation:
      'High impedance earth faults may not draw enough current to trip protective devices, leaving dangerous voltages on metalwork.',
    difficulty: 'intermediate',
  },
  ...
  // Section 2: Common Fault Types (42 questions)
  {
    ...
    correctAnswer: 2,
    explanation:
      'Loose connections create high resistance, leading to overheating, arcing, and significant fire risk due to localised heat generation.',
    difficulty: 'intermediate',
  },
  {
    id: 44,
    ...
    correctAnswer: 1,
    explanation:
      'A short circuit creates a very low resistance path, causing high fault current that will immediately operate protective devices like MCBs or fuses.',
    difficulty: 'basic',
  },
  {
    id: 45,
    ...
    correctAnswer: 1,
    explanation:
      'Cable damage in buried installations often causes earth faults, leading to regular operation of RCDs or other protective devices.',
    difficulty: 'intermediate',
  },
  {
    id: 46,
    ...
    correctAnswer: 2,
    explanation:
      'Intermittent high resistance faults are difficult to diagnose because they may not be present during testing and can vary with environmental conditions.',
    difficulty: 'advanced',
  },
  {
    id: 47,
    ...
    correctAnswer: 1,
    explanation:
      'Insulation failure is commonly caused by age, moisture ingress, excessive heat, mechanical damage, or chemical contamination.',
    difficulty: 'basic',
  },
  {
    id: 48,
    ...
    correctAnswer: 1,
    explanation:
      'Outdoor overhead lines are particularly susceptible to weather-related flashovers caused by rain, snow, ice, or contamination.',
    difficulty: 'intermediate',
  },
  {
    id: 49,
    ...
    correctAnswer: 1,
    explanation:
      'Cable joints and terminations are most susceptible to thermal cycling damage due to different expansion rates of materials.',
    difficulty: 'intermediate',
  },
  {
    id: 50,
    ...
    correctAnswer: 1,
    explanation:
      'Motor winding faults most commonly result from insulation breakdown caused by overheating due to overloading or blocked ventilation.',
    difficulty: 'basic',
  },
  {
    id: 51,
    ...
    correctAnswer: 1,
    explanation:
      'Cable bends, especially tight bends, commonly cause conductor fracture due to mechanical stress concentration.',
    difficulty: 'basic',
  },
  {
    id: 52,
    ...
    correctAnswer: 1,
    explanation:
      'Nuisance RCD tripping is typically caused by accumulation of normal earth leakage currents from multiple connected equipment.',
    difficulty: 'intermediate',
  },
  {
    id: 53,
    ...
    correctAnswer: 1,
    explanation:
      'A single-phase to earth fault typically causes fuses to blow on only the affected phase, leaving other phases operational.',
    difficulty: 'intermediate',
  },
  {
    id: 54,
    ...
    correctAnswer: 1,
    explanation:
      'Old rubber-insulated cables commonly fail due to perished insulation that becomes brittle and cracks with age.',
    difficulty: 'basic',
  },
  {
    id: 55,
    ...
    correctAnswer: 1,
    explanation:
      'Loss of neutral commonly results from loose neutral connections at distribution boards or consumer units.',
    difficulty: 'basic',
  },
  {
    id: 56,
    ...
    correctAnswer: 1,
    explanation:
      'Cable sheath damage most commonly occurs due to mechanical damage during installation or subsequent excavation work.',
    difficulty: 'basic',
  },
  {
    id: 57,
    ...
    correctAnswer: 1,
    explanation:
      'Inadequate tightening of connections is a common fault associated with poor workmanship during installation.',
    difficulty: 'basic',
  },
  {
    id: 58,
    ...
    correctAnswer: 1,
    explanation:
      'Earth electrode resistance commonly increases due to soil drying out around the electrode or corrosion of the electrode itself.',
    difficulty: 'intermediate',
  },
  {
    id: 59,
    ...
    correctAnswer: 0,
    explanation:
      'Ballast failure is the most common fault in fluorescent lighting circuits, often caused by overheating or component aging.',
    difficulty: 'basic',
  },
  {
    id: 60,
    ...
    correctAnswer: 1,
    explanation:
      'Cable pulling points commonly develop conductor stretching and eventual fracture due to excessive tension during installation.',
    difficulty: 'intermediate',
  },
  {
    id: 61,
    question: 'Which component commonly fails in consumer units?',
    options: ['Enclosure only', 'Main switch and MCB contacts', 'Wiring only', 'Earth bar only'],
    correctAnswer: 1,
    explanation:
      'Main switches and MCB contacts commonly fail in consumer units due to arcing, overheating, and contact wear.',
    difficulty: 'basic',
  },
  {
    id: 62,
    ...
    correctAnswer: 1,
    explanation:
      'Loose connections at socket outlets are the most common fault, often caused by poor installation or thermal cycling.',
    difficulty: 'basic',
  },
  {
    id: 63,
    ...
    correctAnswer: 1,
    explanation:
      'Electric shower installations commonly suffer from overheating due to inadequate cable sizing for the high current demands.',
    difficulty: 'intermediate',
  },
  {
    id: 64,
    ...
    correctAnswer: 1,
    explanation:
      'Temporary installations commonly suffer mechanical damage to flexible cables due to rough handling and environmental exposure.',
    difficulty: 'basic',
  },
  {
    id: 65,
    ...
    correctAnswer: 1,
    explanation:
      'Aluminium conductors are susceptible to oxidation, which creates high resistance joints if not properly treated with joint compound.',
    difficulty: 'intermediate',
  },
  {
    id: 66,
    ...
    correctAnswer: 1,
    explanation:
      'Switchgear contact failure commonly results from arcing and contact erosion caused by switching electrical loads.',
    difficulty: 'intermediate',
  },
  {
    id: 67,
    ...
    correctAnswer: 1,
    explanation:
      'Outdoor electrical equipment commonly suffers from water ingress and corrosion due to weather exposure.',
    difficulty: 'basic',
  },
  {
    id: 68,
    ...
    correctAnswer: 1,
    explanation:
      'Three-phase motor connections commonly suffer from phase loss or imbalance, causing overheating and motor damage.',
    difficulty: 'intermediate',
  },
  {
    id: 69,
    ...
    correctAnswer: 1,
    explanation:
      'Electric heating circuits commonly experience heating element burn-out and contactor failure due to high current switching.',
    difficulty: 'basic',
  },
  {
    id: 70,
    ...
    correctAnswer: 1,
    explanation:
      'Cable entry points commonly suffer from water ingress leading to insulation breakdown if not properly sealed.',
    difficulty: 'intermediate',
  },
  {
    id: 71,
    ...
    correctAnswer: 1,
    explanation:
      'Industrial motor control circuits commonly experience contactor contact welding due to high inrush currents and frequent switching.',
    difficulty: 'intermediate',
  },
  {
    id: 72,
    ...
    correctAnswer: 1,
    explanation:
      'Buried cable installations commonly fail due to mechanical damage from excavation and water ingress through damaged sheaths.',
    difficulty: 'basic',
  },
  {
    id: 73,
    ...
    correctAnswer: 1,
    explanation:
      'High-vibration environments typically cause connection loosening, leading to high resistance joints and arcing faults.',
    difficulty: 'intermediate',
  },
  {
    id: 74,
    ...
    correctAnswer: 1,
    explanation:
      'Extension lead plugs commonly develop bent pins and poor contact due to frequent plugging and unplugging.',
    difficulty: 'basic',
  },
  {
    id: 75,
    ...
    correctAnswer: 1,
    explanation:
      'Cable drums commonly overheat when partially unwound because coiled cable cannot dissipate heat effectively.',
    difficulty: 'intermediate',
  },
  {
    id: 76,
    ...
    correctAnswer: 1,
    explanation:
      'Protective devices commonly fail due to repeated fault clearing operations and component aging from thermal and mechanical stress.',
    difficulty: 'intermediate',
  },
  {
    id: 77,
    ...
    correctAnswer: 1,
    explanation:
      'LED lighting installations commonly experience driver/power supply failure due to component stress and heat generation.',
    difficulty: 'basic',
  },
  {
    id: 78,
    ...
    correctAnswer: 1,
    explanation:
      'Underground cable joints commonly fail due to water ingress if the joint is not properly sealed and protected.',
    difficulty: 'intermediate',
  },
  {
    id: 79,
    question: 'Which component commonly fails in electrical panels?',
    options: ['Enclosure only', 'Busbar connections', 'Labels only', 'Doors only'],
    correctAnswer: 1,
    explanation:
      'Busbar connections commonly fail in electrical panels due to thermal cycling, corrosion, and inadequate contact pressure.',
    difficulty: 'intermediate',
  },
  {
    id: 80,
    ...
    correctAnswer: 1,
    explanation:
      'Cable tray installations commonly suffer from corrosion and support failure, especially in corrosive environments.',
    difficulty: 'basic',
  },
  {
    id: 81,
    ...
    correctAnswer: 1,
    explanation:
      'High-temperature environments cause accelerated insulation aging, leading to premature insulation breakdown.',
    difficulty: 'intermediate',
  },
  {
    id: 82,
    ...
    correctAnswer: 1,
    explanation:
      'Earth continuity faults commonly result from broken or disconnected earth conductors, often due to mechanical damage.',
    difficulty: 'basic',
  },
  {
    id: 83,
    ...
    correctAnswer: 1,
    explanation:
      'Power factor correction equipment commonly experiences capacitor failure due to voltage stress and aging.',
    difficulty: 'intermediate',
  },
  {
    id: 84,
    ...
    correctAnswer: 1,
    explanation:
      'Marine environments cause salt corrosion of electrical connections, leading to high resistance and eventual failure.',
    difficulty: 'intermediate',
  },
  ...
  // Section 3: Signs and Symptoms (42 questions)
  {
    ...
    correctAnswer: 2,
    explanation:
      'High resistance joints often first manifest as flickering lights or voltage fluctuations due to the increased resistance affecting voltage levels.',
    difficulty: 'intermediate',
  },
  {
    id: 86,
    ...
    correctAnswer: 1,
    explanation:
      'A burning smell from electrical equipment is a clear indication of overheating, usually caused by loose connections, overloading, or insulation breakdown.',
    difficulty: 'basic',
  },
  {
    id: 87,
    ...
    correctAnswer: 1,
    explanation:
      'Frequent RCD operation typically indicates an earth leakage fault somewhere in the installation that needs investigation and rectification.',
    difficulty: 'basic',
  },
  {
    id: 88,
    ...
    correctAnswer: 1,
    explanation:
      'A neutral conductor fault can cause voltage variations between different circuits, as the return path is compromised affecting voltage distribution.',
    difficulty: 'intermediate',
  },
  {
    id: 89,
    ...
    correctAnswer: 1,
    explanation:
      'Excessive heat at connections indicates high resistance, usually due to loose connections or corrosion, causing I²R losses and heating.',
    difficulty: 'basic',
  },
  {
    id: 90,
    ...
    correctAnswer: 1,
    explanation:
      'Black carbon deposits around electrical contacts are a clear visual sign of arcing activity and contact deterioration.',
    difficulty: 'basic',
  },
  {
    id: 91,
    ...
    correctAnswer: 1,
    explanation:
      'Crackling or sizzling sounds from electrical equipment typically indicate arcing or corona discharge, both serious fault conditions.',
    difficulty: 'basic',
  },
  {
    id: 92,
    ...
    correctAnswer: 1,
    explanation:
      'Motor bearing failure is indicated by unusual noise and vibration, often accompanied by increased operating temperature.',
    difficulty: 'basic',
  },
  {
    id: 93,
    ...
    correctAnswer: 1,
    explanation:
      'Dimming lights during motor starting indicates voltage drop in the supply system due to the high starting current drawn by the motor.',
    difficulty: 'intermediate',
  },
  {
    id: 94,
    ...
    correctAnswer: 1,
    explanation:
      'Decreasing insulation resistance readings over time indicate possible insulation breakdown and developing fault conditions.',
    difficulty: 'intermediate',
  },
  {
    id: 95,
    ...
    correctAnswer: 1,
    explanation:
      'A metallic taste or ozone smell near electrical equipment indicates corona discharge or arcing, which produces ozone gas.',
    difficulty: 'intermediate',
  },
  {
    id: 96,
    ...
    correctAnswer: 1,
    explanation:
      'Overloaded circuits show symptoms of warm or hot cables and connections due to excessive current flow causing I²R heating.',
    difficulty: 'basic',
  },
  {
    id: 97,
    ...
    correctAnswer: 1,
    explanation:
      'Erratic operation of electronic equipment often indicates power quality problems or electrical interference affecting sensitive components.',
    difficulty: 'intermediate',
  },
  {
    id: 98,
    ...
    correctAnswer: 1,
    explanation:
      'Water ingress in electrical equipment is indicated by visible corrosion, water marks, and mineral deposits on internal components.',
    difficulty: 'basic',
  },
  {
    id: 99,
    ...
    correctAnswer: 1,
    explanation:
      'Discoloration around electrical connections typically indicates overheating caused by high resistance due to loose connections.',
    difficulty: 'basic',
  },
  {
    id: 100,
    ...
    correctAnswer: 1,
    explanation:
      'Earth electrode deterioration is indicated by increasing earth electrode resistance due to corrosion or soil condition changes.',
    difficulty: 'intermediate',
  },
  {
    id: 101,
    ...
    correctAnswer: 1,
    explanation:
      'Voltage imbalance in three-phase systems causes motor overheating and vibration due to unequal phase loading.',
    difficulty: 'intermediate',
  },
  {
    id: 102,
    ...
    correctAnswer: 1,
    explanation:
      'Cable sheath damage is indicated by moisture ingress leading to earth leakage current and possible RCD operation.',
    difficulty: 'intermediate',
  },
  {
    id: 103,
    ...
    correctAnswer: 1,
    explanation:
      'Sparking at switch contacts indicates contact deterioration or overloading, often leading to contact welding or burning.',
    difficulty: 'basic',
  },
  {
    id: 104,
    ...
    correctAnswer: 1,
    explanation:
      'Transformer overloading is indicated by excessive temperature rise and increased noise due to magnetic saturation and thermal stress.',
    difficulty: 'intermediate',
  },
  {
    id: 105,
    ...
    correctAnswer: 1,
    explanation:
      'Intermittent operation typically indicates loose connections or failing components that make and break contact randomly.',
    difficulty: 'basic',
  },
  {
    id: 106,
    ...
    correctAnswer: 1,
    explanation:
      'Harmonic distortion is indicated by overheating of neutral conductors, as triplen harmonics add arithmetically in the neutral.',
    difficulty: 'advanced',
  },
  {
    id: 107,
    ...
    correctAnswer: 1,
    explanation:
      'Buzzing sounds from fluorescent fittings typically indicate ballast failure or lamp approaching end-of-life conditions.',
    difficulty: 'basic',
  },
  {
    id: 108,
    ...
    correctAnswer: 1,
    explanation:
      'Cable joint failure is indicated by local heating around the joint and possible smoke from burning insulation or joint compound.',
    difficulty: 'intermediate',
  },
  {
    id: 109,
    ...
    correctAnswer: 1,
    explanation:
      'Reduced light output from lamps typically indicates voltage drop in the supply circuit or lamp deterioration approaching end-of-life.',
    difficulty: 'basic',
  },
  {
    id: 110,
    ...
    correctAnswer: 1,
    explanation:
      'Motor winding failure is indicated by excessive current draw and overheating due to insulation breakdown creating turn-to-turn faults.',
    difficulty: 'intermediate',
  },
  {
    id: 111,
    ...
    correctAnswer: 1,
    explanation:
      'Visible corona around high voltage equipment indicates insulation stress and potential insulation failure due to electric field concentration.',
    difficulty: 'advanced',
  },
  {
    id: 112,
    ...
    correctAnswer: 1,
    explanation:
      'Contactor coil failure is indicated by chattering contacts or failure to hold in due to insufficient magnetic force from the coil.',
    difficulty: 'basic',
  },
  {
    id: 113,
    ...
    correctAnswer: 1,
    explanation:
      'Power factor deterioration in motors typically indicates winding deterioration or mechanical problems affecting motor efficiency.',
    difficulty: 'advanced',
  },
  {
    id: 114,
    ...
    correctAnswer: 1,
    explanation:
      'Busbar overheating is indicated by discoloration of connections and movement at expansion joints due to thermal expansion.',
    difficulty: 'intermediate',
  },
  {
    id: 115,
    ...
    correctAnswer: 1,
    explanation:
      'Premature lamp failure often indicates voltage fluctuations or poor power quality that stress lamp filaments and reduce life.',
    difficulty: 'intermediate',
  },
  {
    id: 116,
    ...
    correctAnswer: 1,
    explanation:
      'Cable pulling damage is indicated by conductor stretching, insulation scoring, or compression damage from excessive pulling force.',
    difficulty: 'intermediate',
  },
  {
    id: 117,
    ...
    correctAnswer: 1,
    explanation:
      'Unusual motor starting characteristics often indicate supply voltage problems, motor winding faults, or mechanical issues.',
    difficulty: 'intermediate',
  },
  {
    id: 118,
    ...
    correctAnswer: 1,
    explanation:
      'A tingling sensation from metalwork in wet conditions indicates dangerous earth leakage current and immediate safety risk.',
    difficulty: 'basic',
  },
  {
    id: 119,
    ...
    correctAnswer: 1,
    explanation:
      'Protective device nuisance tripping often indicates marginal fault conditions, device aging, or sensitivity to transient conditions.',
    difficulty: 'intermediate',
  },
  {
    id: 120,
    ...
    correctAnswer: 1,
    explanation:
      'Cable thermal damage is indicated by brittle or discolored insulation that has been degraded by excessive heat exposure.',
    difficulty: 'basic',
  },
  {
    id: 121,
    ...
    correctAnswer: 1,
    explanation:
      'Electrical noise in audio equipment often indicates electromagnetic interference from electrical faults or poor earthing arrangements.',
    difficulty: 'intermediate',
  },
  {
    id: 122,
    ...
    correctAnswer: 1,
    explanation:
      'Deteriorating cable support systems are indicated by cable sagging, mechanical stress points, or visible support structure corrosion.',
    difficulty: 'basic',
  },
  {
    id: 123,
    ...
    correctAnswer: 1,
    explanation:
      'Irregular magnetic field patterns often indicate internal winding faults, core lamination problems, or magnetic circuit defects.',
    difficulty: 'advanced',
  },
  {
    id: 124,
    ...
    correctAnswer: 1,
    explanation:
      'Semiconductor device failure is typically indicated by erratic operation, complete failure to switch, or thermal runaway conditions.',
    difficulty: 'intermediate',
  },
  {
    id: 125,
    ...
    correctAnswer: 1,
    explanation:
      'Capacitor failure is often indicated by a swollen case due to internal pressure buildup or measured reduction in capacitance value.',
    difficulty: 'intermediate',
  },
  {
    id: 126,
    ...
    correctAnswer: 1,
    explanation:
      'Magnetic contactor problems are indicated by loud operation, contact chatter, or visible arcing at contact points during switching.',
    difficulty: 'basic',
  },
  ...
  // Section 4: Fault-Finding Process (42 questions)
  {
    ...
    correctAnswer: 2,
    explanation:
      'The first step in fault-finding is always to gather information about the fault symptoms, when it occurred, and any recent changes to the installation.',
    difficulty: 'basic',
  },
  {
    id: 128,
    ...
    correctAnswer: 1,
    explanation:
      'Logical progression from supply to load ensures systematic fault-finding and prevents missing faults or creating additional problems.',
    difficulty: 'basic',
  },
  {
    id: 129,
    ...
    correctAnswer: 2,
    explanation:
      'Safe isolation is essential before fault-finding to protect against electric shock and ensure safe working conditions during testing and repair.',
    difficulty: 'basic',
  },
  {
    id: 130,
    ...
    correctAnswer: 1,
    explanation:
      'Comprehensive information gathering includes fault symptoms, recent changes, circuit details, and operational history to guide effective diagnosis.',
    difficulty: 'intermediate',
  },
  {
    id: 131,
    ...
    correctAnswer: 1,
    explanation:
      'The half-split method involves dividing the circuit roughly in half and testing each section to quickly isolate which half contains the fault.',
    difficulty: 'intermediate',
  },
  {
    id: 132,
    ...
    correctAnswer: 2,
    explanation:
      'Circuit diagrams should be consulted before starting fault-finding to understand the circuit operation and identify critical test points.',
    difficulty: 'basic',
  },
  {
    id: 133,
    ...
    correctAnswer: 1,
    explanation:
      'Functional testing verifies that equipment operates correctly after fault rectification and that no additional problems exist.',
    difficulty: 'basic',
  },
  {
    id: 134,
    ...
    correctAnswer: 1,
    explanation:
      'Intermittent faults require monitoring and recording fault patterns to identify triggers and timing for effective diagnosis.',
    difficulty: 'intermediate',
  },
  {
    id: 135,
    ...
    correctAnswer: 2,
    explanation:
      'If a fault cannot be identified, reassess the symptoms, test methodology, and consider alternative fault possibilities or seek assistance.',
    difficulty: 'intermediate',
  },
  {
    id: 136,
    ...
    correctAnswer: 1,
    explanation:
      'Continuity testing is most appropriate for open circuit faults as it verifies the presence of complete electrical paths.',
    difficulty: 'basic',
  },
  {
    id: 137,
    ...
    correctAnswer: 1,
    explanation:
      'Voltage measurement provides valuable live circuit information about supply availability and circuit operation during fault conditions.',
    difficulty: 'basic',
  },
  {
    id: 138,
    ...
    correctAnswer: 1,
    explanation:
      'Replacement parts should only be fitted after fault location is confirmed to avoid unnecessary component replacement and costs.',
    difficulty: 'basic',
  },
  {
    id: 139,
    ...
    correctAnswer: 1,
    explanation:
      'Isolation verification confirms that circuits are dead and safe to work on before commencing fault-finding activities.',
    difficulty: 'basic',
  },
  {
    id: 140,
    ...
    correctAnswer: 1,
    explanation:
      'Installation records and maintenance logs should be updated to provide a history of faults and repairs for future reference.',
    difficulty: 'basic',
  },
  {
    id: 141,
    ...
    correctAnswer: 1,
    explanation:
      'Systematic approaches ensure thorough and efficient diagnosis, reducing diagnostic time and preventing missed faults.',
    difficulty: 'basic',
  },
  {
    id: 142,
    ...
    correctAnswer: 1,
    explanation:
      'Fault-finding should be postponed when safe working conditions cannot be achieved, prioritising safety over urgency.',
    difficulty: 'basic',
  },
  {
    id: 143,
    ...
    correctAnswer: 1,
    explanation:
      'Recording test results, observations, and actions taken provides valuable information for pattern analysis and future reference.',
    difficulty: 'basic',
  },
  {
    id: 144,
    ...
    correctAnswer: 1,
    explanation:
      'Fault-finding strategy should be influenced by the type of installation and specific fault symptoms to ensure appropriate methods are used.',
    difficulty: 'intermediate',
  },
  {
    id: 145,
    ...
    correctAnswer: 1,
    explanation:
      'Before re-energising, verify repair quality, circuit safety, and that no additional hazards have been created during the repair process.',
    difficulty: 'basic',
  },
  {
    id: 146,
    ...
    correctAnswer: 1,
    explanation:
      'Testing should progress from known good points towards the fault location to systematically narrow down the fault location.',
    difficulty: 'intermediate',
  },
  {
    id: 147,
    ...
    correctAnswer: 1,
    explanation:
      'Comparative testing helps identify differences between faulty and healthy circuits, highlighting abnormal conditions.',
    difficulty: 'intermediate',
  },
  {
    id: 148,
    ...
    correctAnswer: 1,
    explanation:
      'Environmental factors should always be considered as they significantly affect fault development, especially moisture and temperature.',
    difficulty: 'intermediate',
  },
  {
    id: 149,
    ...
    correctAnswer: 1,
    explanation:
      'Load testing reveals faults that only manifest under operational conditions, such as thermal or stress-related problems.',
    difficulty: 'intermediate',
  },
  {
    id: 150,
    ...
    correctAnswer: 1,
    explanation:
      'Multiple faults should be prioritised by safety risk and isolated individually to prevent masking effects and ensure complete resolution.',
    difficulty: 'advanced',
  },
  {
    id: 151,
    ...
    correctAnswer: 1,
    explanation:
      'Test equipment selection should be guided by the fault type being investigated and safety requirements of the installation.',
    difficulty: 'intermediate',
  },
  {
    id: 152,
    ...
    correctAnswer: 1,
    explanation:
      'Expert assistance should be sought when fault complexity exceeds personal competence or specialist knowledge is required.',
    difficulty: 'basic',
  },
  {
    id: 153,
    ...
    correctAnswer: 1,
    explanation:
      'Post-repair monitoring verifies long-term repair effectiveness and helps identify any developing related problems.',
    difficulty: 'intermediate',
  },
  {
    id: 154,
    ...
    correctAnswer: 1,
    explanation:
      'Systematic testing methodology is most important for accurate fault location, ensuring thorough and logical investigation.',
    difficulty: 'intermediate',
  },
  {
    id: 155,
    ...
    correctAnswer: 1,
    explanation:
      'Fault rectification planning should consider safety implications, cost factors, and impact on system operation.',
    difficulty: 'intermediate',
  },
  {
    id: 156,
    ...
    correctAnswer: 1,
    explanation:
      'Strategic isolation of only the minimum necessary circuits minimises system disruption while maintaining safety.',
    difficulty: 'intermediate',
  },
  {
    id: 157,
    ...
    correctAnswer: 1,
    explanation:
      'Historical fault data helps identify patterns, recurring problems, and guides preventive maintenance strategies.',
    difficulty: 'intermediate',
  },
  {
    id: 158,
    ...
    correctAnswer: 1,
    explanation:
      'Temporary repairs should only be used for immediate safety measures while planning and implementing proper permanent repairs.',
    difficulty: 'basic',
  },
  {
    id: 159,
    ...
    correctAnswer: 1,
    explanation:
      'Fault rectification urgency should be determined by safety risk assessment and system criticality analysis.',
    difficulty: 'basic',
  },
  {
    id: 160,
    ...
    correctAnswer: 1,
    explanation:
      'Effective fault analysis requires circuit diagrams, test records, maintenance history, and operational documentation.',
    difficulty: 'basic',
  },
  {
    id: 161,
    ...
    correctAnswer: 1,
    explanation:
      'After fault repairs, verify system function, safety compliance, and performance meet required standards.',
    difficulty: 'basic',
  },
  {
    id: 162,
    ...
    correctAnswer: 1,
    explanation:
      'Safe fault investigation requires assuming all circuits are live until proven dead through proper testing procedures.',
    difficulty: 'basic',
  },
  {
    id: 163,
    ...
    correctAnswer: 1,
    explanation:
      'Photographic documentation provides valuable visual records of fault conditions, damage extent, and repair procedures.',
    difficulty: 'basic',
  },
  {
    id: 164,
    ...
    correctAnswer: 1,
    explanation:
      'Fault-finding work should be suspended immediately when safety conditions deteriorate or become unacceptable.',
    difficulty: 'basic',
  },
  {
    id: 165,
    ...
    correctAnswer: 1,
    explanation:
      'The primary goal is accurate identification of the root cause to ensure effective repair and prevent recurrence.',
    difficulty: 'basic',
  },
  {
    id: 166,
    ...
    correctAnswer: 1,
    explanation:
      'Systematic approach and proper preparation most significantly affect fault-finding efficiency and success rates.',
    difficulty: 'intermediate',
  },
  {
    id: 167,
    ...
    correctAnswer: 1,
    explanation:
      'Users should be informed about fault causes, repair actions taken, and any prevention measures to avoid recurrence.',
    difficulty: 'basic',
  },
  {
    id: 168,
    ...
    correctAnswer: 1,
    explanation:
      'Testing should progress from simple to complex and safe to hazardous to maximise information gain while maintaining safety.',
    difficulty: 'intermediate',
  },
  ...
  // Section 5: Safe Practices and Equipment (42 questions)
  {
    ...
    correctAnswer: 1,
    explanation:
      'Test instruments must be rated for the voltage and environmental conditions they will be used in, with appropriate safety categories and CAT ratings.',
    difficulty: 'basic',
  },
  {
    id: 170,
    ...
    correctAnswer: 1,
    explanation:
      'Multimeters should be checked for calibration and proved on a known source before use to ensure accurate and safe measurements.',
    difficulty: 'basic',
  },
  {
    id: 171,
    ...
    correctAnswer: 2,
    explanation:
      'CAT III rated equipment is required for testing at distribution boards and fixed installation circuits in buildings.',
    difficulty: 'intermediate',
  },
  {
    id: 172,
    ...
    correctAnswer: 1,
    explanation:
      'The prove-test-prove method ensures the voltage indicator is working before testing for dead, then confirms it still works afterwards.',
    difficulty: 'basic',
  },
  {
    id: 173,
    ...
    correctAnswer: 0,
    explanation:
      'Test leads should be visually inspected before each use for damage, as damaged leads present serious safety risks during testing.',
    difficulty: 'basic',
  },
  {
    id: 174,
    question: 'What is the minimum voltage rating for test equipment used on 230V systems?',
    options: ['230V', '400V', '600V', '1000V'],
    correctAnswer: 2,
    explanation:
      'Test equipment should be rated at least 600V for use on 230V systems to provide adequate safety margin for transient voltages.',
    difficulty: 'intermediate',
  },
  {
    id: 175,
    ...
    correctAnswer: 1,
    explanation:
      'Insulated gloves and eye protection are essential PPE when working on or near live electrical systems to prevent shock and arc flash injuries.',
    difficulty: 'basic',
  },
  {
    id: 176,
    ...
    correctAnswer: 1,
    explanation:
      "A proving unit tests voltage indicator functionality to ensure it detects voltage correctly and hasn't failed in a dangerous mode.",
    difficulty: 'basic',
  },
  {
    id: 177,
    ...
    correctAnswer: 1,
    explanation:
      'Insulated tools should be used when working on or near live electrical equipment to provide additional protection against accidental contact.',
    difficulty: 'basic',
  },
  {
    id: 178,
    ...
    correctAnswer: 1,
    explanation:
      '50V is generally considered the maximum safe working voltage for unskilled persons in normal dry conditions.',
    difficulty: 'basic',
  },
  {
    id: 179,
    ...
    correctAnswer: 1,
    explanation:
      'Physical disconnection and locking off provides the highest safety level by preventing accidental re-energisation.',
    difficulty: 'basic',
  },
  {
    id: 180,
    ...
    correctAnswer: 1,
    explanation:
      'After isolation, immediately test for dead using appropriate equipment, then apply temporary earth bonding if required.',
    difficulty: 'basic',
  },
  {
    id: 181,
    question: 'Which test instrument provides the safest method for initial voltage detection?',
    options: ['Digital multimeter', 'Two-pole voltage indicator', 'Oscilloscope', 'Analogue meter'],
    correctAnswer: 1,
    explanation:
      "Two-pole voltage indicators provide the safest initial voltage detection as they're specifically designed for this purpose with appropriate safety features.",
    difficulty: 'basic',
  },
  {
    id: 182,
    ...
    correctAnswer: 1,
    explanation:
      'Temporary earth bonding provides additional safety by ensuring metalwork remains at earth potential during work on isolated circuits.',
    difficulty: 'intermediate',
  },
  {
    id: 183,
    question:
      'When working in confined spaces with electrical equipment, what additional precaution is essential?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Confined spaces require additional ventilation, rescue arrangements, and often permit-to-work systems due to increased risks.',
    difficulty: 'intermediate',
  },
  {
    id: 184,
    ...
    correctAnswer: 1,
    explanation:
      '3 metres is the minimum safe approach distance for unqualified persons from overhead power lines to prevent flashover risk.',
    difficulty: 'intermediate',
  },
  {
    id: 185,
    ...
    correctAnswer: 1,
    explanation:
      'Detection of unexpected voltage requires immediate work stoppage as it indicates isolation failure or backfeed conditions.',
    difficulty: 'basic',
  },
  {
    id: 186,
    ...
    correctAnswer: 1,
    explanation:
      'Arc flash protection protects against intense thermal energy and molten metal ejected during electrical arc faults.',
    difficulty: 'intermediate',
  },
  {
    id: 187,
    ...
    correctAnswer: 1,
    explanation:
      'Rubber insulating mats provide additional electrical insulation when working on energised electrical equipment in suitable conditions.',
    difficulty: 'intermediate',
  },
  {
    id: 188,
    ...
    correctAnswer: 1,
    explanation:
      'Always use appropriate voltage detection equipment before approaching suspected live equipment to confirm electrical status safely.',
    difficulty: 'basic',
  },
  {
    id: 189,
    ...
    correctAnswer: 1,
    explanation:
      'Safety equipment selection must be based on voltage levels and available fault energy to ensure adequate protection.',
    difficulty: 'intermediate',
  },
  {
    id: 190,
    ...
    correctAnswer: 1,
    explanation:
      'Inconsistent readings indicate possible equipment malfunction - stop use immediately and verify equipment condition before continuing.',
    difficulty: 'basic',
  },
  {
    id: 191,
    ...
    correctAnswer: 1,
    explanation:
      'Working alone may be acceptable on dead circuits with appropriate safety measures, risk assessment, and emergency arrangements.',
    difficulty: 'intermediate',
  },
  {
    id: 192,
    ...
    correctAnswer: 1,
    explanation:
      'Electrical safety barriers prevent accidental contact with live parts, providing physical protection for workers and the public.',
    difficulty: 'basic',
  },
  {
    id: 193,
    question: 'Which environmental condition most increases electrical safety risks?',
    options: ['Bright lighting', 'Wet or damp conditions', 'Warm temperatures', 'Low noise levels'],
    correctAnswer: 1,
    explanation:
      'Wet or damp conditions significantly increase electrical safety risks by reducing insulation effectiveness and human body resistance.',
    difficulty: 'basic',
  },
  {
    id: 194,
    ...
    correctAnswer: 1,
    explanation:
      'Before removing temporary earth bonds, verify work completion and that circuits remain properly isolated for safety.',
    difficulty: 'intermediate',
  },
  {
    id: 195,
    ...
    correctAnswer: 1,
    explanation:
      'Remote measurement techniques minimise exposure to electrical hazards by maintaining safe distances during testing procedures.',
    difficulty: 'intermediate',
  },
  {
    id: 196,
    ...
    correctAnswer: 1,
    explanation:
      'Unknown installations should be treated as highest possible voltage until verified through proper testing procedures.',
    difficulty: 'basic',
  },
  {
    id: 197,
    ...
    correctAnswer: 1,
    explanation:
      'Emergency procedures should be reviewed before starting electrical work to ensure all personnel know appropriate responses.',
    difficulty: 'basic',
  },
  {
    id: 198,
    question: 'What is the primary hazard when working near capacitors?',
    options: ['Low voltage', 'Stored electrical energy', 'Light weight', 'Small size'],
    correctAnswer: 1,
    explanation:
      'Capacitors store electrical energy and can remain dangerous even after power is removed - they must be safely discharged.',
    difficulty: 'intermediate',
  },
  {
    id: 199,
    ...
    correctAnswer: 1,
    explanation:
      'Proper insulation rating is the most important tool feature for electrical safety, ensuring protection against the voltages encountered.',
    difficulty: 'basic',
  },
  {
    id: 200,
    ...
    correctAnswer: 1,
    explanation:
      'Unsafe conditions require immediate work stoppage and area securing to prevent accidents until conditions can be made safe.',
    difficulty: 'basic',
  },
  {
    id: 201,
    ...
    correctAnswer: 1,
    explanation:
      'Arc flash boundary is determined by available fault current and protective device clearing time, which affect the energy released.',
    difficulty: 'advanced',
  },
  {
    id: 202,
    ...
    correctAnswer: 1,
    explanation:
      'Lockout/tagout procedures prevent unexpected energisation of equipment during maintenance or repair work.',
    difficulty: 'basic',
  },
  {
    id: 203,
    ...
    correctAnswer: 1,
    explanation:
      'Electrical safety working space must be maintained clear to provide safe access and egress during electrical work.',
    difficulty: 'basic',
  },
  {
    id: 204,
    ...
    correctAnswer: 1,
    explanation:
      'Before opening electrical enclosures, check for warnings, assess potential hazards, and ensure appropriate safety precautions.',
    difficulty: 'basic',
  },
  {
    id: 205,
    ...
    correctAnswer: 1,
    explanation:
      'Wet outdoor high-voltage work requires the highest safety precautions due to multiple compounding risk factors.',
    difficulty: 'basic',
  },
  {
    id: 206,
    ...
    correctAnswer: 1,
    explanation:
      'Suspected damaged cables should be treated as live and contact avoided until proper testing confirms their electrical status.',
    difficulty: 'basic',
  },
  {
    id: 207,
    ...
    correctAnswer: 1,
    explanation:
      'Safety data sheets should be consulted before using any chemical products to understand hazards and safe handling procedures.',
    difficulty: 'basic',
  },
  {
    id: 208,
    ...
    correctAnswer: 1,
    explanation:
      'Electrical safety training develops hazard recognition skills and safe work practices to prevent accidents and injuries.',
    difficulty: 'basic',
  },
  {
    id: 209,
    ...
    correctAnswer: 1,
    explanation:
      'Situational awareness and caution are the most important personal attributes for electrical safety, enabling hazard recognition and appropriate response.',
    difficulty: 'basic',
  },
  {
    id: 210,
    ...
    correctAnswer: 1,
    explanation:
      'Damaged electrical equipment should be immediately removed from service and tagged as defective to prevent unsafe use.',
    difficulty: 'basic',
  },
  ...
  // Section 6: Recording and Reporting (40 questions)
  {
    ...
    correctAnswer: 1,
    explanation:
      'Accurate fault recording helps identify patterns, trends, and recurring issues, enabling preventive maintenance and system improvements.',
    difficulty: 'basic',
  },
  {
    id: 212,
    ...
    correctAnswer: 1,
    explanation:
      'Comprehensive fault reports should include symptoms, exact location, root cause analysis, and details of remedial actions taken.',
    difficulty: 'basic',
  },
  {
    id: 213,
    ...
    correctAnswer: 1,
    explanation:
      'After rectification, appropriate testing should verify the repair is effective and the circuit is safe before re-energising.',
    difficulty: 'basic',
  },
  {
    id: 214,
    ...
    correctAnswer: 2,
    explanation:
      'Significant faults should be reported to relevant personnel including safety representatives to ensure proper follow-up and prevention measures.',
    difficulty: 'intermediate',
  },
  {
    id: 215,
    ...
    correctAnswer: 1,
    explanation:
      'Temporary repairs should only be used as immediate safety measures when permanent repair cannot be completed immediately, with proper planning for permanent rectification.',
    difficulty: 'intermediate',
  },
  {
    id: 216,
    ...
    correctAnswer: 1,
    explanation:
      'Completed repairs should be documented with test results, materials used, compliance verification, and appropriate certificates.',
    difficulty: 'basic',
  },
  {
    id: 217,
    ...
    correctAnswer: 1,
    explanation:
      'Fault pattern analysis requires comprehensive data including date, time, environmental conditions, and operational factors.',
    difficulty: 'intermediate',
  },
  {
    id: 218,
    ...
    correctAnswer: 1,
    explanation:
      'Fault logs help track trends, identify recurring problems, and develop improved maintenance strategies to reduce future faults.',
    difficulty: 'basic',
  },
  {
    id: 219,
    ...
    correctAnswer: 1,
    explanation:
      'Incident reports should be completed for all safety-related occurrences to maintain comprehensive safety records and improve procedures.',
    difficulty: 'basic',
  },
  {
    id: 220,
    ...
    correctAnswer: 1,
    explanation:
      'Safety issues require recording the nature of hazard, risk assessment, and recommended corrective actions for proper follow-up.',
    difficulty: 'basic',
  },
  {
    id: 221,
    ...
    correctAnswer: 1,
    explanation:
      'Significant fault reports should be distributed to management, safety teams, and relevant maintenance personnel for coordinated response.',
    difficulty: 'intermediate',
  },
  {
    id: 222,
    ...
    correctAnswer: 1,
    explanation:
      'Electrical fault records should be retained for minimum 10 years or equipment life to support long-term trend analysis and legal requirements.',
    difficulty: 'intermediate',
  },
  {
    id: 223,
    ...
    correctAnswer: 1,
    explanation:
      'Warranty claims should be initiated immediately upon identifying premature failure to recover costs and improve equipment reliability data.',
    difficulty: 'basic',
  },
  {
    id: 224,
    ...
    correctAnswer: 1,
    explanation:
      'Effective root cause analysis requires complete operational history, environmental data, maintenance records, and failure sequence information.',
    difficulty: 'intermediate',
  },
  {
    id: 225,
    ...
    correctAnswer: 1,
    explanation:
      'Structured forms with photographic evidence provide clear, complete, and consistent fault documentation for analysis and reference.',
    difficulty: 'basic',
  },
  {
    id: 226,
    ...
    correctAnswer: 1,
    explanation:
      'Environmental documentation should include temperature, humidity, weather conditions, and operational factors that may influence fault development.',
    difficulty: 'intermediate',
  },
  {
    id: 227,
    ...
    correctAnswer: 1,
    explanation:
      'Preliminary reports should be issued immediately for safety-critical faults to alert relevant personnel and initiate protective measures.',
    difficulty: 'basic',
  },
  {
    id: 228,
    ...
    correctAnswer: 1,
    explanation:
      'Fault reports should include before and after measurements with instrument details to demonstrate fault condition and repair effectiveness.',
    difficulty: 'basic',
  },
  {
    id: 229,
    ...
    correctAnswer: 1,
    explanation:
      'All personnel involved in electrical work should be trained in fault reporting procedures to ensure consistent and complete documentation.',
    difficulty: 'basic',
  },
  {
    id: 230,
    ...
    correctAnswer: 1,
    explanation:
      'Digital systems enable improved data analysis, trend identification, automated reporting, and better information sharing across organisations.',
    difficulty: 'intermediate',
  },
  {
    id: 231,
    ...
    correctAnswer: 1,
    explanation:
      'Customers should be notified when faults affect safety, operation, or require access for repairs, with clear information about implications.',
    difficulty: 'basic',
  },
  {
    id: 232,
    ...
    correctAnswer: 1,
    explanation:
      'Material documentation should include type, quantity, specifications, and batch numbers for quality tracking and future reference.',
    difficulty: 'basic',
  },
  {
    id: 233,
    ...
    correctAnswer: 1,
    explanation:
      'Supervisor review and verification processes ensure fault reports are accurate, complete, and follow established standards.',
    difficulty: 'basic',
  },
  {
    id: 234,
    ...
    correctAnswer: 1,
    explanation:
      'Insurance claims require complete fault investigation documentation with supporting evidence to establish cause and validate claims.',
    difficulty: 'intermediate',
  },
  {
    id: 235,
    ...
    correctAnswer: 1,
    explanation:
      'Regulatory authorities should be notified for serious safety incidents, public hazards, or when required by specific regulations.',
    difficulty: 'intermediate',
  },
  {
    id: 236,
    ...
    correctAnswer: 1,
    explanation:
      'Lessons learned should document fault causes, contributing factors, prevention measures, and improved procedures for future reference.',
    difficulty: 'intermediate',
  },
  {
    id: 237,
    ...
    correctAnswer: 1,
    explanation:
      'Reliability analysis requires fault frequency, duration, mean time between failures, and other statistical measures to assess system performance.',
    difficulty: 'advanced',
  },
  {
    id: 238,
    ...
    correctAnswer: 1,
    explanation:
      'Work permit documentation should include permit numbers, specified conditions, and verification of compliance with safety requirements.',
    difficulty: 'intermediate',
  },
  {
    id: 239,
    ...
    correctAnswer: 1,
    explanation:
      'Fault trend reports should be generated regularly to identify developing patterns and implement preventive measures before major failures.',
    difficulty: 'intermediate',
  },
  {
    id: 240,
    ...
    correctAnswer: 1,
    explanation:
      'Follow-up documentation should include monitoring schedules, verification testing, and any special inspection requirements post-repair.',
    difficulty: 'basic',
  },
  {
    id: 241,
    ...
    correctAnswer: 1,
    explanation:
      'Maintenance prioritisation requires fault history, equipment criticality assessment, and consequence analysis to optimise resource allocation.',
    difficulty: 'intermediate',
  },
  {
    id: 242,
    ...
    correctAnswer: 1,
    explanation:
      'Environmental documentation should cover emissions, waste generation, contamination, and any remediation requirements from electrical faults.',
    difficulty: 'intermediate',
  },
  {
    id: 243,
    ...
    correctAnswer: 1,
    explanation:
      'Complex or high-consequence fault investigations should be peer-reviewed to ensure thoroughness and accuracy of analysis.',
    difficulty: 'intermediate',
  },
  {
    id: 244,
    ...
    correctAnswer: 1,
    explanation:
      'Emergency communication protocols should establish clear escalation paths, contact procedures, and information sharing requirements.',
    difficulty: 'basic',
  },
  {
    id: 245,
    ...
    correctAnswer: 1,
    explanation:
      'Training records should document competency assessments, continuing education, and specific qualifications for fault investigation work.',
    difficulty: 'basic',
  },
  {
    id: 246,
    ...
    correctAnswer: 1,
    explanation:
      'Contractor documentation should include qualifications, specific work performed, compliance verification, and quality assessment.',
    difficulty: 'basic',
  },
  {
    id: 247,
    ...
    correctAnswer: 1,
    explanation:
      'Fault reports should be updated immediately when relevant new information becomes available to maintain accuracy and completeness.',
    difficulty: 'basic',
  },
  {
    id: 248,
    ...
    correctAnswer: 1,
    explanation:
      'Benchmarking against industry standards and best practices helps identify improvement opportunities in fault management processes.',
    difficulty: 'intermediate',
  },
  {
    id: 249,
    ...
    correctAnswer: 1,
    explanation:
      'Fault reporting systems should incorporate feedback from operations, maintenance, and management to ensure systems meet user needs.',
    difficulty: 'intermediate',
  },
  {
    id: 250,
    ...
    correctAnswer: 1,
    explanation:
      'The ultimate goal is continuous improvement in electrical system reliability through data-driven decision making and preventive actions.',
    difficulty: 'basic',
  },
];
...
const getRandomQuestions = (
  ...
  const intermediateCount = Math.round(
    (count * difficultyDistribution.intermediate) / totalPercentage
  );
...
const validateQuestionBank = () => {
  ...
  console.log(
    `Basic: ${basicCount}, Intermediate: ${intermediateCount}, Advanced: ${advancedCount}`
  );
  console.log(
    `Distribution: ${Math.round((basicCount / questionBank.length) * 100)}% basic, ${Math.round((intermediateCount / questionBank.length) * 100)}% intermediate, ${Math.round((advancedCount / questionBank.length) * 100)}% advanced`
  );
};
            ...
            <CardContent className="p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-white/80 mb-6">
                  Test your knowledge of electrical fault finding procedures, fault types, symptom
                  identification, safe practices, and recording requirements.
                </p>
              </div>
                ...
                <div className="grid gap-2">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm text-white/80 leading-relaxed">
                      30 questions randomly selected from Module 7 content
                    </p>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0" />
              ...
              {filteredQuestions.length === 0 && (
                <Card className="bg-card border-elec-yellow/30">
                  <CardContent className="p-8 text-center">
                    <div className="text-white/80">No questions match the selected filter.</div>
                  </CardContent>
                </Card>
              )}
            </div>
          ...
          <Card className="border-elec-yellow/30 bg-card">
            <CardContent className="p-6 sm:p-8">
              <div className="text-center mb-8">
                ...
                <h2 className="text-lg text-elec-yellow mb-6">
                  Mock Exam 7: Electrical Fault Finding and Diagnosis
                </h2>

                {/* Score Display */}
                <div className="bg-card p-6 rounded-xl border border-elec-yellow/30 mb-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8">
                  ...
                  <Card className="bg-card border-muted/20 sm:col-span-1 col-span-2">
                    <CardContent className="p-4 text-center">
                      <div className="text-2xl font-bold text-elec-yellow">{stats.flagged}</div>
                      <div className="text-sm text-white/80">Flagged</div>
                    </CardContent>
                  </Card>
                </div>
