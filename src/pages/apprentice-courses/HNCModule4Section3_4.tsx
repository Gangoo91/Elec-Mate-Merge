...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['MCCB - MCCB', 'HRC fuse - MCB', 'RCD - RCD', 'MCB - MCB'],
    correctAnswer: 1,
    explanation:
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              discrimination, so that fault disconnection is restricted to the smallest possible
              part of the installation. As designer you must demonstrate the coordination —
              typically using manufacturer selectivity tables, time-current characteristic overlays,
              or computed I²t comparisons. Document the analysis alongside the cable schedule.
            </>
          }
        ...
        <ConceptBlock title="Discrimination Fundamentals">
          ...
          <p>
            ...
            before the upstream device, regardless of fault current level up to the system maximum.
          </p>
          <p>
            <strong>Partial discrimination:</strong> Discrimination achieved up to a specific fault
            current level. Above this, both devices may operate together.
          </p>
          <p>
            <strong>
              Discrimination study hierarchy (level / typical devices / discrimination priority):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Key principle:</strong> Invest most discrimination effort at higher levels where
            fault impact is greatest.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Time Discrimination">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Different characteristics — fuse + MCB combination — sub-distribution to finals</li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Current Discrimination and Energy Let-Through">
          ...
          <p>
            <strong>Energy let-through (I²t):</strong> I²t represents the energy passing through a
            device during fault clearance. For discrimination, the downstream device must clear with
            lower I²t than the upstream device's let-through threshold.
          </p>
          <p>
        ...
        <ConceptBlock title="Cascade Protection and Selectivity Tables">
          <p>
            Cascade (back-up) protection allows a downstream device with lower breaking capacity to
            be used where the prospective fault current exceeds its rating, provided an upstream
          ...
          <p>
            <strong>
              Example selectivity table — simplified (upstream / 16A Type B / 32A Type B / 32A Type
              C):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Design note:</strong> Always verify discrimination using manufacturer's specific
            tables for the actual devices specified. Generic guidance may not apply to all
            combinations.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Sub-board 100A MCCB settings: STD = 100ms (allows MCBs to clear first); Im = 10 × Ir
            </li>
          ...
          <p>
            <strong>Example 3 — cascade back-up verification:</strong> A 6kA MCB is used where Ipf =
            10kA. Verify cascade protection with 80A HRC fuse upstream. Cable is 4mm² PVC/copper.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A 200&nbsp;A 400&nbsp;V three-phase sub-main feeds a ward DB carrying critical medical
              equipment. The DB has 20 × MCBs (mostly C16 and C20). The current design has a
              200&nbsp;A Type B MCCB upstream. A short on a single C16 has tripped both the C16 and
              the upstream MCCB — taking out the entire ward including life-support equipment.
            </>
          }
          whatToDo={
            <>
              Apply Reg 536.4.202: coordination must restrict disconnection to the smallest possible
              part of the installation. Replace the upstream MCCB with one that has an adjustable
              instantaneous trip set above the maximum let-through of the downstream C16 / C20
              (typically 10–12 × I_n_downstream = ≈ 200&nbsp;A on the C20). Or specify an HRC fuse
              upstream (BS 88) — HRC discriminates more reliably with downstream MCBs because of its
              sharply current-limiting let-through. Verify with the manufacturer&rsquo;s selectivity
              table for the actual device pairing. Document the discrimination analysis in the
              design submission.
            </>
          }
          whyItMatters={
            <>
              In a hospital, loss of supply to critical care is a life-safety event. Reg 536.4.202
              explicitly requires coordination so that disconnection is restricted to the smallest
              possible part. A discrimination analysis is design evidence, not a nice-to-have, and
              forms part of the Part 6 verification.
            </>
          }
        />
