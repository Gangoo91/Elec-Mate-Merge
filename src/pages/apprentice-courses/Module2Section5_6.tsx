...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Long cable runs with high resistance cause voltage drop, reducing voltage at the load end and making lights appear dimmer.',
  },
  {
    id: 2,
    question:
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Voltage drop causes higher current draw. Larger CSA or shorter route reduces resistance and voltage drop.',
  },
  {
    id: 7,
  ...
  },
  {
    id: 9,
    question:
      'A cable installed in a hot environment (40°C ambient) carries the same current as one at 20°C. What happens to its resistance?',
    options: [
      'Resistance decreases',
      'Resistance increases',
      'No change in resistance',
      'Depends on cable type only',
    ],
    correctAnswer: 1,
    explanation:
      'Cable resistance increases with temperature. At 40°C, copper resistance is about 8% higher than at 20°C, requiring derating calculations.',
  },
  {
    id: 10,
    question:
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-base sm:text-lg text-white/80 max-w-2xl mx-auto">
            Identifying and solving resistance problems: overheating, voltage drop, and equipment
            failures
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Real problems:</strong> Overheating, dim lights, equipment failures
                </li>
                <li>
                  <strong>Root cause:</strong> Excessive resistance in cables and connections
                </li>
                <li>
                  <strong>Effects:</strong> Safety risks, energy waste, equipment damage
                </li>
                <li>
                  <strong>Solutions:</strong> Proper sizing, good connections, regular checks
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Warm outlets, dim lights, nuisance tripping
                </li>
                <li>
                  <strong>Use:</strong> Thermal imaging, voltage measurements, torque checks
                </li>
                <li>
                  <strong>Apply:</strong> Cable sizing, connection quality, design limits
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
              <h3 className="font-semibold text-elec-yellow mb-2 flex items-center gap-2">
                <Thermometer className="w-4 h-4" /> Overheating Issues
              </h3>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <div className="rounded-lg p-4 bg-transparent border border-amber-400/30">
              <h3 className="font-semibold text-amber-300 mb-2 flex items-center gap-2">
                <TrendingDown className="w-4 h-4" /> Voltage Drop Problems
              </h3>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
              <h3 className="font-semibold text-elec-yellow mb-2 flex items-center gap-2">
                <Zap className="w-4 h-4" /> Protection Issues
              </h3>
              <ul className="list-disc pl-6 space-y-1">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div className="border border-elec-yellow/30 rounded-lg p-4 bg-elec-yellow/5">
              ...
              <Collapsible>
                <CollapsibleTrigger className="mt-3 inline-flex text-elec-yellow text-sm underline min-h-[44px] touch-manipulation">
                  Show solution & calculation
                </CollapsibleTrigger>
                <CollapsibleContent className="mt-3 p-3 border border-elec-yellow/30 rounded text-sm">
                  ...
                  <div className="space-y-2">
                    <p>
                      <strong>Current calculation:</strong> mV/A/m = 29 for 1.5mm² T&E
                    </p>
                    <p>
                      <strong>Voltage drop:</strong> (29 × 8 × 120) ÷ 1000 = 27.8V = 12.1%
                    </p>
                    <p>
                      <strong>Fix:</strong> Upgrade to 2.5mm² (18 mV/A/m) → (18 × 8 × 120) ÷ 1000 =
                      17.3V = 7.5%
                    </p>
                    <p>
                      <strong>Better fix:</strong> Upgrade to 4mm² (11 mV/A/m) → (11 × 8 × 120) ÷
                      1000 = 10.6V = 4.6% ✓
                    </p>
                    <p className="text-elec-yellow font-medium">
                      Result: Proper lighting levels restored, no more driver shutdowns
                    </p>
                  </div>
                </CollapsibleContent>
              </Collapsible>
            ...
            <div className="border border-border/30 rounded-lg p-4 bg-transparent">
              ...
              <Collapsible>
                ...
                <CollapsibleContent className="mt-3 p-3 border border-elec-yellow/30 rounded text-sm">
                  ...
                  <div className="space-y-2">
                    <p>
                      <strong>Starting voltage drop:</strong> 4mm² SWA = 11 mV/A/m
                    </p>
                    <p>
                      <strong>Calculation:</strong> (11 × 66 × 160) ÷ 1000 = 116V drop per phase!
                    </p>
                    <p>
                      <strong>Available voltage:</strong> 230V - 116V = 114V (50% of rated!)
                    </p>
                    <p>
                      <strong>Fix:</strong> Upgrade to 16mm² SWA (2.8 mV/A/m)
                    </p>
                    <p>
                      <strong>New drop:</strong> (2.8 × 66 × 160) ÷ 1000 = 29.6V drop
                    </p>
                    <p>
                      <strong>New voltage:</strong> 230V - 29.6V = 200.4V (87% - acceptable)
                    </p>
                    <p className="text-elec-yellow font-medium">
                      Result: Motor starts reliably, no more nuisance tripping
                    </p>
                  </div>
                </CollapsibleContent>
              </Collapsible>
            ...
            <div className="border border-elec-yellow/30 rounded-lg p-4 bg-elec-yellow/5">
              ...
              <Collapsible>
                ...
                <CollapsibleContent className="mt-3 p-3 border border-elec-yellow/30 rounded text-sm">
                  ...
                  <div className="space-y-2">
                    <p>
                      <strong>Current setup:</strong> 6mm² SWA buried = 7.8 mV/A/m
                    </p>
                    <p>
                      <strong>Voltage drop:</strong> (7.8 × 32 × 80) ÷ 1000 = 20V drop
                    </p>
                    <p>
                      <strong>Percentage:</strong> 20V ÷ 240V = 8.3% (exceeds 5% limit)
                    </p>
                    <p>
                      <strong>Charger derates:</strong> Below 220V to protect itself
                    </p>
                    <p>
                      <strong>Fix:</strong> Upgrade to 10mm² SWA (4.7 mV/A/m)
                    </p>
                    <p>
                      <strong>New drop:</strong> (4.7 × 32 × 80) ÷ 1000 = 12V drop
                    </p>
                    <p>
                      <strong>New voltage:</strong> 240V - 12V = 228V (5% - acceptable)
                    </p>
                    <p className="text-elec-yellow font-medium">
                      Result: Full 7kW charging restored, no more derating
                    </p>
                  </div>
                </CollapsibleContent>
              </Collapsible>
            ...
            <div className="border border-border/30 rounded-lg p-4 bg-transparent">
              ...
              <Collapsible>
                <CollapsibleTrigger className="mt-3 inline-flex text-elec-yellow text-sm underline min-h-[44px] touch-manipulation">
                  Show solution & safety action
                </CollapsibleTrigger>
                <CollapsibleContent className="mt-3 p-3 border border-border/30 rounded text-sm">
                  <p className="font-medium mb-2 text-elec-yellow">
                    IMMEDIATE DANGER - ISOLATE SUPPLY
                  </p>
                  <div className="space-y-2">
                    <p>
                      <strong>Problem:</strong> Loose terminal has contact resistance ~0.01Ω
                    </p>
                    <p>
                      <strong>Power loss:</strong> P = I²R = 28² × 0.01 = 7.8W of heat at connection
                    </p>
                    <p>
                      <strong>Temperature rise:</strong> Enough to damage insulation and create fire
                      risk
                    </p>
                    <p>
                      <strong>Immediate action:</strong> Isolate circuit, lock off, investigate
                      safely
                    </p>
                    <p>
                      <strong>Solution:</strong> Replace damaged components, re-terminate to correct
                      torque
                    </p>
                    <p>
                      <strong>Prevention:</strong> Regular thermal surveys, torque checking schedule
                    </p>
                    <p className="text-elec-yellow font-medium">
                      Result: Fire risk eliminated, equipment operates safely
                    </p>
                  </div>
                </CollapsibleContent>
              </Collapsible>
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="bg-card border border-border/30 p-4 rounded-lg">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Look for:</strong> Discolouration, burning marks, melted plastic
                </li>
                <li>
                  <strong>Check:</strong> Terminal tightness, cable entry points
                </li>
                <li>
                  <strong>Identify:</strong> Oversized fuses, temporary connections
                </li>
                <li>
                  <strong>Document:</strong> Take photos before and after repairs
                </li>
              </ul>
            </div>
            <div className="bg-card border border-amber-400/30 p-4 rounded-lg">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Under load:</strong> Take images during normal operation
                </li>
                <li>
                  <strong>Compare:</strong> Similar circuits and phases
                </li>
                <li>
                  <strong>Hotspots:</strong> Look for &gt;10°C temperature differences
                </li>
                <li>
                  <strong>Regular:</strong> Schedule surveys for critical circuits
                </li>
              </ul>
            </div>
            <div className="bg-card border border-elec-yellow/30 p-4 rounded-lg">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Voltage drop:</strong> Measure at load under normal current
                </li>
                <li>
                  <strong>Zs testing:</strong> Check earth fault loop impedance
                </li>
                <li>
                  <strong>IR testing:</strong> Look for insulation degradation
                </li>
                <li>
                  <strong>Current measurement:</strong> Check for overloading
                </li>
              </ul>
            </div>
            <div className="bg-card border border-border/30 p-4 rounded-lg">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Torque check:</strong> Use calibrated torque tools
                </li>
                <li>
                  <strong>Pull test:</strong> Verify mechanical integrity
                </li>
                <li>
                  <strong>Contact resistance:</strong> Measure across connections
                </li>
                <li>
                  <strong>Retighten:</strong> Follow manufacturer specifications
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm text-white">
            <div className="bg-card border border-white/10 p-4 rounded-lg">
              ...
              <ol className="list-decimal pl-6 space-y-1">
                <li>
                  <strong>Check voltage:</strong> Measure at equipment terminals under load
                </li>
                <li>
                  <strong>Calculate drop:</strong> Compare with supply voltage
                </li>
                <li>
                  <strong>Identify cause:</strong> Long run, small cable, or poor connections
                </li>
                <li>
                  <strong>Verify current:</strong> Is the load what you expect?
                </li>
                <li>
                  <strong>Check connections:</strong> All tight and in good condition?
                </li>
                <li>
                  <strong>Consider solutions:</strong> Larger cable, shorter route, or reduced load
                </li>
              </ol>
            </div>
            ...
            <div className="bg-card border border-white/10 p-4 rounded-lg">
              ...
              <ol className="list-decimal pl-6 space-y-1">
                <li>
                  <strong>ISOLATE IMMEDIATELY:</strong> Safety first - dangerous temperatures
                </li>
                <li>
                  <strong>Thermal survey:</strong> Identify all hot spots when safe to do so
                </li>
                <li>
                  <strong>Check connections:</strong> Retorque all terminations
                </li>
                <li>
                  <strong>Inspect damage:</strong> Replace heat-damaged components
                </li>
                <li>
                  <strong>Test IR and Zs:</strong> Verify system integrity
                </li>
                <li>
                  <strong>Monitor closely:</strong> Check temperatures after repairs
                </li>
              </ol>
            </div>
            ...
            <div className="bg-card border border-white/10 p-4 rounded-lg">
              ...
              <ol className="list-decimal pl-6 space-y-1">
                <li>
                  <strong>Check voltage drop:</strong> High drop can cause high starting currents
                </li>
                <li>
                  <strong>Verify MCB rating:</strong> Correct for cable and load?
                </li>
                <li>
                  <strong>Measure Zs:</strong> High resistance can affect protection
                </li>
                <li>
                  <strong>Check load diversity:</strong> Multiple loads starting together?
                </li>
                <li>
                  <strong>Consider type:</strong> MCB characteristics (B, C, D types)
                </li>
                <li>
                  <strong>Review installation:</strong> Any changes since last working?
                </li>
              </ol>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-xs sm:text-sm text-white">
            <div className="border border-white/10 rounded-lg p-4">
              ...
              <p>
                <strong>Issue:</strong> Critical production machinery kept shutting down
                unexpectedly, costing £1000s per hour.
              </p>
              <p>
                <strong>Investigation:</strong> Voltage drop on 100m feeder during high-demand
                periods caused control systems to reset.
              </p>
              <p>
                <strong>Solution:</strong> Upgraded 16mm² to 35mm² cable, reducing voltage drop from
                8% to 3%.
              </p>
              <p>
                <strong>Result:</strong> Zero unplanned shutdowns, improved product quality,
            ...
            <div className="border border-white/10 rounded-lg p-4">
              ...
              <p>
                <strong>Issue:</strong> Critical medical equipment showing power quality alarms
                during operations.
              </p>
              <p>
                <strong>Investigation:</strong> Aging connections in IT supply system creating
                voltage variations.
              </p>
              <p>
                <strong>Solution:</strong> Complete re-termination program with silver-plated
                connections and regular thermal monitoring.
              </p>
              <p>
                <strong>Result:</strong> Rock-solid power quality, patient safety maintained,
            ...
            <div className="border border-white/10 rounded-lg p-4">
              ...
              <p>
                <strong>Issue:</strong> High electricity bills and frequent lamp replacements in
                large retail space.
              </p>
              <p>
                <strong>Investigation:</strong> Poor power factor and voltage drop causing
                inefficient operation of lighting and HVAC.
              </p>
              <p>
                <strong>Solution:</strong> Power factor correction, cable upgrades, and LED
                conversion with proper voltage levels.
              </p>
              <p>
                <strong>Result:</strong> 25% reduction in energy costs, 80% reduction in
                maintenance, better customer experience.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="bg-card border border-white/10 p-4 rounded-lg">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Section 525:</strong> Voltage drop limits and calculations
                </li>
                <li>
                  <strong>Section 526:</strong> Electrical connections quality
                </li>
                <li>
                  <strong>Section 421:</strong> Protection against fire
                </li>
                <li>
                  <strong>Section 422:</strong> Protection against thermal effects
                </li>
                <li>
                  <strong>Appendix 4:</strong> Voltage drop calculation methods
                </li>
              </ul>
            </div>
            <div className="bg-card border border-amber-400/30 p-4 rounded-lg">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
              ...
              <p>
                New classroom block 45m from main panel. 20A lighting load, using 2.5mm² T&E clipped
                direct. Calculate voltage drop and determine if acceptable for lighting circuit.
              </p>
              <Collapsible>
                <CollapsibleTrigger className="mt-2 inline-flex text-elec-yellow text-sm underline min-h-[44px] touch-manipulation">
                  Show solution
                </CollapsibleTrigger>
                <CollapsibleContent className="mt-2">
                  <p>
                    mV/A/m = 18, Length = 90m total, Vd = (18 × 20 × 90) ÷ 1000 = 32.4V = 14.1%.
                    FAILS - needs 4mm² minimum.
                  </p>
                </CollapsibleContent>
              </Collapsible>
            </div>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
              ...
              <p>
                Socket outlet reads 85°C on thermal camera, serving 25A load. Normal temperature
                should be &lt;60°C. What's the most likely cause and solution?
              </p>
              <Collapsible>
                <CollapsibleTrigger className="mt-2 inline-flex text-elec-yellow text-sm underline min-h-[44px] touch-manipulation">
                  Show solution
                ...
                <CollapsibleContent className="mt-2">
                  <p>
                    Likely cause: Loose connection creating contact resistance. Solution: Isolate,
                    check/retighten all connections, replace any heat-damaged components, retest.
                  </p>
                </CollapsibleContent>
              </Collapsible>
            </div>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
              ...
              <p>
                15kW motor won't start on 70m cable run. Starting current 90A, cable is 10mm² SWA.
                Calculate starting voltage and suggest solutions.
              </p>
              <Collapsible>
                <CollapsibleTrigger className="mt-2 inline-flex text-elec-yellow text-sm underline min-h-[44px] touch-manipulation">
                  Show solution
                ...
                <CollapsibleContent className="mt-2">
                  <p>
                    Vd = (4.4 × 90 × 140) ÷ 1000 = 55.4V. Starting voltage = 175V (24% drop).
                    Solutions: 25mm² cable, star-delta starter, or soft starter.
                  </p>
                </CollapsibleContent>
              </Collapsible>
            </div>
        ...
        <InlineCheck
          ...
          options={[
            ...
            'Excessive voltage drop on supply cable',
            'Wrong type of MCB',
            'RCD sensitivity issue',
          ]}
          correctAnswer={1}
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/apprentice/level2/module2/section5/5-5">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous
            </Link>
          </Button>
