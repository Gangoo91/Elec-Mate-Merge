    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-base text-muted-foreground mb-12">
          This section covers energy management principles and practices for commercial buildings.
          You'll learn about energy auditing, metering strategies, monitoring and targeting
          techniques, ISO 50001 energy management systems and how to identify and implement energy
          efficiency measures.
        </p>
