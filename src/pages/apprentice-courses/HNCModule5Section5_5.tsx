...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['5 working days', '48 hours', '24 hours', '10 working days'],
    correctIndex: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Code M makes witnessing a managed process — planned, notified, supported with
              documentation. Surprise tests where the witness arrives to find the contractor
              unprepared damage the project relationship and risk failed acceptance. Discipline at
              witness stage signals the project's overall quality posture.
            </>
          }
        ...
        <ConceptBlock title="Purpose of Witness Testing">
          <p>
            ...
            being performed on installed systems to verify they meet specification requirements. It
            provides independent assurance that the installation functions correctly before handover
            and acceptance.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fire alarm:</strong> 100% detector test, cause and effect, sounders — Half to
              full day
            </li>
            <li>
              <strong>Emergency lighting:</strong> 3-hour duration test, lux level verification — 3+
              hours
            </li>
            <li>
        ...
        <ConceptBlock title="Notification Requirements and Attendance">
          ...
          <p>
            ...
            clause: if the contractor provides proper notice and the client fails to attend without
            requesting postponement, the contractor may proceed and the test is deemed witnessed.
            Document everything - notification sent, no response received, test proceeded as
            scheduled.
          </p>
          <p>
        ...
        <ConceptBlock title="Documentation and Sign-off Procedures">
          <p>
            ...
            of test outcomes. Well-prepared documentation demonstrates professionalism and protects
            all parties.
          </p>
          <p>
          ...
          <p>
            ...
            witness test documentation. Tests conducted with uncalibrated equipment may be rejected
        ...
        <ConceptBlock title="Failed Test Procedures and Acceptance Protocols">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Document resolution:</strong> Link re-test results to original failure record
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Partial acceptance:</strong> Some areas/systems accepted while others require
              further work
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Recorded failure:</strong> Zone 3 detection did not trigger output to MagLock
              2
            </li>
            <li>
              <strong>Investigation:</strong> Cause and effect programming error - output not mapped
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — Emergency lighting witness test:</strong> Conduct a 3-hour duration
            test on emergency lighting installation.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — Recording a partial failure:</strong> Fire alarm 100% detector test
            - 2 detectors out of 150 fail to respond.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              The witness test for the chilled water system is scheduled. The client's engineer
              attends. The test fails: balancing is out of tolerance, two zones cannot achieve
              design flow. The contractor rebooks for two weeks later; the client engineer charges a
              re-attendance fee of £2,500. After re-balancing, the system passes. Total cost: £2,500
              attendance fee + £1,800 contractor rework + 1-week programme impact.
            </>
          }
          whatToDo={
            <>
              Pre-witness internal testing is essential. The commissioning team should run the full
              test on their own and confirm it passes before notifying the witness. If anything is
              uncertain, defer notification — never notify and hope. Build pre-witness testing into
              the programme as a 1-week preceding activity. The cost of pre-testing is a fraction of
              the cost of failed witness.
            </>
          }
          whyItMatters={
            <>
              Witness testing is the formal acceptance gate. A failed witness signals weak
              commissioning discipline; a passed one signals professional execution. The client's
              perception of project quality is shaped at witness events more than at any other
              moment.
            </>
          }
        />
