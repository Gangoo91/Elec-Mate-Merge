        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Purpose:</strong> Independent verification systems meet specification
              </li>
              <li className="pl-1">
                <strong>Notice period:</strong> Minimum 5 working days typically required
              </li>
              <li className="pl-1">
                <strong>Documentation:</strong> Signed test sheets with pass/fail status
              </li>
              <li className="pl-1">
                <strong>Failed tests:</strong> Record, rectify, re-test with notice
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Fire alarm:</strong> 100% detector test, cause and effect
              </li>
              <li className="pl-1">
                <strong>Emergency lighting:</strong> 3-hour duration test
              </li>
              <li className="pl-1">
                <strong>HVAC systems:</strong> Air flow, temperature control
              </li>
              <li className="pl-1">
                <strong>BMS:</strong> Sequence of operations verification
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Key objectives of witness testing:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Verification:</strong> Confirm installed systems meet specified
                  performance criteria
                </li>
                <li className="pl-1">
                  <strong>Transparency:</strong> Demonstrate test procedures and results to the
                  client
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical Witness Tests in Building Services
              </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        100% detector test, cause and effect, sounders
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        3-hour duration test, lux level verification
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Phase rotation, protection coordination, load test
                      </td>
                      <td className="border border-white/10 px-3 py-2">Half to full day</td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Load bank test, auto-start, synchronisation
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Point-to-point verification, alarms, graphics
                      </td>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-amber-500/10 border border-amber-500/30">
              ...
              <p className="text-sm text-white">
                Most contracts include a deemed witnessed clause: if the contractor provides proper
                notice and the client fails to attend without requesting postponement, the
                contractor may proceed and the test is deemed witnessed. Document everything -
                notification sent, no response received, test proceeded as scheduled.
              </p>
            </div>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Witness Test Schedule Example
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Sign-off section:</strong> Spaces for signatures, names, dates, and
                  comments
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-3">
                Witness Test Record Sheet - Key Fields
              </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Test conducted per procedure, results accurate
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">Contractor</td>
                      <td className="border border-white/10 px-3 py-2">
                        Test overseen, resources adequate
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Test witnessed, results accepted
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Test meets specification intent (if attending)
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                All test equipment must have valid calibration certificates. Record instrument
                serial numbers and calibration dates on witness test documentation. Tests conducted
                with uncalibrated equipment may be rejected and require repetition.
              </p>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ol className="text-sm text-white space-y-2 list-decimal list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Agree the deficiency:</strong> Ensure client representative agrees with
                  the failure assessment
                </li>
                <li className="pl-1">
                  <strong>Investigate cause:</strong> Determine whether installation error,
                  equipment fault, or design issue
                </li>
                <li className="pl-1">
                  <strong>Propose rectification:</strong> Provide method and timescale for
                  correction
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Real-World Example: Fire Alarm Cause and Effect Failure
              </p>
              <p className="text-sm text-white mb-2">
                <strong>Scenario:</strong> During witness testing of a fire alarm cause and effect
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Emergency Lighting Witness Test
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Managing Non-Attendance
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Recording a Partial Failure
              </h3>
              <p className="text-sm text-white mb-2">
