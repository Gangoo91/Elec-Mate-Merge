...
const DESCRIPTION =
  'Master series circuit behaviour: current flow, voltage division, and resistance calculations. BS 7671 aligned for UK electricians.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      'Current varies between components',
      'Current is the same through all components',
      'Current is zero',
      'Current doubles at each component',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'In series circuits, voltage divides between components in proportion to their resistance values.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Household socket rings',
      'LED strings and chains',
      'Main distribution boards',
      'Individual room lighting',
    ],
    correctAnswer: 1,
    explanation:
      'LED strings often use series connections for voltage division and current limiting.',
  },
  {
    id: 9,
    ...
    options: [
      ...
      'Measure between supply terminals',
      'Use a clamp around all wires',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Voltage divider rule calculates how supply voltage divides across series components.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Because there's only one path for current to flow. Current cannot accumulate or disappear - what flows into one component must flow out of it and into the next. It's like water flowing through a single pipe.",
  },
  {
    question: 'How do I use the voltage divider rule in practice?',
    answer:
      'The voltage divider rule (Vx = Vsupply × Rx/Rtotal) lets you predict voltage across any component in a series chain. This is essential for LED strings, sensor circuits, and understanding how voltage drops distribute.',
  },
  {
    question: "What's the most common mistake with series circuits?",
    answer:
      'Assuming current changes between components. Remember: current is identical throughout the entire series path - only voltage changes as it divides between components.',
  },
  {
    question: 'How does this relate to BS 7671 installations?',
    answer:
      'While most building circuits are parallel, series effects appear in: LED strings, voltage dividers in controls, fault loop impedance calculations, and voltage drop across cable runs.',
  },
  {
    question: 'Why do series resistances simply add together?',
    answer:
      "Each resistor opposes current flow, and in series they're all in the same current path. It's like having multiple obstacles in a single lane - each adds to the total resistance to flow.",
  },
  {
    question: 'What safety considerations apply to series circuits?',
    answer:
      'Always isolate before measuring. Remember that opening a series circuit stops all current flow, but closing a short circuit can cause dangerous current surges. Follow safe isolation procedures.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Current:</strong> Same everywhere in series (single path)
              </li>
              <li>
                <strong>Voltage:</strong> Divides between components according to resistance
              </li>
              <li>
                <strong>Total resistance:</strong> Rt = R1 + R2 + R3... (adds up)
              </li>
              <li>
                <strong>Voltage divider:</strong> Vx = Vs × Rx/Rtotal
              </li>
              <li>
                <strong>Failure mode:</strong> One open circuit stops everything
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> LED strings, Christmas lights, sensor dividers
              </li>
              <li>
                <strong>Use:</strong> Voltage calculations, current predictions, fault finding
              </li>
              <li>
                <strong>Apply:</strong> LED installations, control circuits, voltage drop
                calculations
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              In a series circuit, there is only one path for current to flow. This single path
              means:
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Current:</strong> Identical through every component (I₁ = I₂ = I₃ =
                  Itotal)
                </li>
                <li>
                  <strong>Resistance:</strong> Values add together (Rtotal = R₁ + R₂ + R₃...)
                </li>
                <li>
                  <strong>Path:</strong> Components connected end-to-end in a chain
                </li>
                <li>
                  <strong>Current calculation:</strong> I = Vsupply / Rtotal
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Example:</strong> Three 10Ω resistors in series = 30Ω total. On 12V supply: I
              = 12V ÷ 30Ω = 0.4A through each resistor.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              In series circuits, supply voltage divides between components according to their
              resistance values. Higher resistance takes a larger share of the voltage.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Worked Example:</strong> 24V supply, R1=150Ω, R2=450Ω in series
              <br />
              Rtotal = 150 + 450 = 600Ω
              <br />
              V1 = 24V × 150Ω/600Ω = 6V
              <br />
              V2 = 24V × 450Ω/600Ω = 18V
              <br />
              Check: 6V + 18V = 24V
            </p>
          </div>
          ...
          <div className="text-white space-y-6 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Total resistance:</strong> Rt = R₁ + R₂ + R₃...
                  </li>
                  <li>
                    <strong>Current (same everywhere):</strong> I = V/Rt
                  </li>
                  <li>
                    <strong>Voltage across each:</strong> V = I × R
                  </li>
                  <li>
                    <strong>Voltage divider:</strong> Vx = Vs × Rx/Rt
                  </li>
                  <li>
                    <strong>Power in each:</strong> P = V × I = I²R
                  </li>
                </ul>
              </div>
              <div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>Problem 1:</strong> 9V battery, three 1kΩ resistors in series. Find
                  current and voltage across each.
                </li>
                <li>
                  <strong>Problem 2:</strong> 230V supply, R₁ = 50Ω, R₂ = 100Ω, current = 1.5A.
                  What's the third resistor R₃?
                </li>
                <li>
                  <strong>Problem 3:</strong> LED needs 2.1V at 15mA, supply is 12V. Calculate
                  limiting resistor value and power.
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-elec-yellow/70">
                <strong>Guidance:</strong> These calculators support understanding only. Always
                verify against manufacturer data and apply BS 7671 design rules for real
                installations.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Where you'll find series circuits
                </p>
                <ul className="text-sm text-white space-y-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Real-world example: LED string installation</strong>
              <br />
              LED tape with series segments must respect driver voltage/current limits. If one
              segment fails open, the whole string stops. Calculate total current with I = V/Rt and
              check cable voltage drop. Always follow manufacturer wiring guidance and verify
              polarity before energising.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="mt-6 p-5 rounded-lg bg-transparent">
            <h3 className="text-sm font-medium text-white mb-4">
              Quick Reference Card - Series Circuits
            </h3>
        ...
        {/* Quiz */}
        <section className="mb-10">
          <Quiz title="Test Your Knowledge - Series Circuits" questions={quizQuestions} />
        </section>
