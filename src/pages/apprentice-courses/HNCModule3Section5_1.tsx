...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Ohms', 'Farads', 'Webers', 'Henrys'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Transformers and motors', 'Socket outlets', 'LED lighting', 'Earth electrodes'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS EN 60076 is the umbrella standard for the distribution and isolating transformers
              you specify on every BSE project. Faraday&rsquo;s law is the physics; BS EN 60076
              turns the physics into the loss limits, vector groups, insulation classes and overload
              tolerances you select against. Knowing the law lets you read a transformer datasheet
              critically rather than accept the vendor&rsquo;s defaults.
            </>
          }
        ...
        <ConceptBlock title="Faraday's Law of Electromagnetic Induction">
          <p>
            Michael Faraday's 1831 discovery that a changing magnetic field induces an electromotive
            force (EMF) in a conductor revolutionised electrical engineering. This principle
            underlies all generators, transformers and induction motors.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Faraday's Law Statement</p>
          <p>
            <strong>e = -N &#215; (d&#934;/dt)</strong>
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>The negative sign represents Lenz's law (opposition to change)</li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Methods of Inducing EMF</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Moving conductor</strong> — Conductor cuts field lines — Generators
            </li>
            <li>
              <strong>Moving magnet</strong> — Field moves relative to coil — Dynamos, sensors
            </li>
            <li>
              <strong>Varying current</strong> — Electromagnet field changes — Transformers
            </li>
            <li>
              <strong>Rotating coil</strong> — Coil angle to field varies — AC generators
            </li>
          </ul>

          <p>
            <strong>Remember:</strong> No change in flux = no induced EMF. Static conditions produce
            no induction regardless of field strength.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Lenz's Law and Direction of Induced EMF">
          <p>
            ...
            induced current will flow in a direction that opposes the change in flux that caused it.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>If flux increases, induced current creates an opposing field</li>
        ...
        <ConceptBlock title="Flux Linkage and Rate of Change">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Flux Linkage Definition</p>
          <p>
            <strong>&#923; = N &#215; &#934;</strong>
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Maximum flux when field is perpendicular to area (&#952; = 0)</li>
          </ul>
          ...
          <p>
            <strong>e = -(&#923;&#8322; - &#923;&#8321;) / t</strong>
          </p>
          <p className="text-white text-xs text-center">For average EMF over time interval t</p>
        ...
        <ConceptBlock title="Motional EMF: e = Blv">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Diesel generator</strong> — Rotating coil in field — Standby power systems
            </li>
            <li>
              <strong>Wind turbine</strong> — Rotating magnetic field — Renewable generation
            </li>
            <li>
              <strong>Vehicle alternator</strong> — Belt-driven rotor — Mobile equipment
            </li>
            <li>
              <strong>Micro-hydro</strong> — Water-driven turbine — Remote installations
            </li>
          </ul>
        ...
        <ConceptBlock title="Transformer EMF: e = -N(d&#934;/dt)">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Transformer EMF Equations</p>
          ...
          <p>Same flux links both windings, so: e&#8322;/e&#8321; = N&#8322;/N&#8321;</p>

          <p className="text-sm font-medium text-white">Transformer voltage relationship:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>V&#8322;/V&#8321; = N&#8322;/N&#8321;</strong> - voltage ratio equals turns
              ratio
            </li>
            <li>Step-up: N&#8322; &gt; N&#8321; gives V&#8322; &gt; V&#8321;</li>
            <li>Step-down: N&#8322; &lt; N&#8321; gives V&#8322; &lt; V&#8321;</li>
            <li>Ideal transformer: V&#8321;I&#8321; = V&#8322;I&#8322; (power conserved)</li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Distribution transformer</strong> — 11kV:400V — HV to LV supply
            </li>
            <li>
              <strong>Bell transformer</strong> — 230V:8V — Door bells, chimes
            </li>
            <li>
              <strong>Isolating transformer</strong> — 1:1 — Safety isolation
            </li>
            <li>
              <strong>LED driver</strong> — 230V:12V/24V — Low voltage lighting
            </li>
            <li>
              <strong>Site transformer (CTE)</strong> — 230V:110V — 55-0-55V for safety
            </li>
          </ul>
        ...
        <ConceptBlock title="Self and Mutual Inductance">
          <p>
            ...
            Self-inductance relates to a single coil; mutual inductance relates to coupling between
            two coils.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Self-Inductance (L)</p>
          <p>
            <strong>e = -L &#215; (di/dt)</strong>
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Unit: Henry (H) - 1H induces 1V when current changes at 1A/s</li>
            <li>Increases with: more turns, larger area, magnetic core material</li>
            <li>L proportional to N&#178; (doubling turns quadruples L)</li>
            <li>Stored energy: E = 0.5 &#215; L &#215; I&#178;</li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Practical Effects of Inductance</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Motor back-EMF</strong> — Self-inductance of windings — Limits running current
            </li>
            <li>
              <strong>Inductive reactance</strong> — Opposition to AC — X&#8343; = 2&#960;fL (Ohms)
            </li>
            <li>
              <strong>Switch arcing</strong> — Stored energy release — Contact wear, EMC issues
            </li>
            <li>
              <strong>Lagging power factor</strong> — Current lags voltage — Reactive power demand
            </li>
          </ul>
        ...
        <ConceptBlock title="Eddy Currents and Their Effects">
          ...
          <p>
            ...
            material. This drives circulating currents (eddies) that follow closed loops within the
            conductor, generating heat through I&#178;R losses.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Unwanted Effects (Losses)</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Reducing Eddy Current Losses</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Laminated cores</strong> — Thin sheets restrict eddy paths — Transformers,
              motors
            </li>
            <li>
              <strong>Silicon steel</strong> — Higher resistivity reduces currents — Power
              transformers
            </li>
            <li>
              <strong>Ferrite cores</strong> — Non-conductive magnetic material — High-frequency
              transformers
            </li>
            <li>
              <strong>Non-magnetic enclosures</strong> — No field interaction — Switchgear, cable
              routes
            </li>
          </ul>
        ...
        <ConceptBlock title="Building Services: Generators, Motors, Transformers">
          <p>
            ...
            installations. Understanding these principles aids specification, installation and fault
            diagnosis.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Generators in Building Services</p>

          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Standby generators:</strong> Essential for hospitals, data centres, high-rise
              buildings
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Motors in Building Services</p>

          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Induction motors:</strong> Most common type - rotating magnetic field induces
              rotor current
            </li>
            <li>
            ...
            <li>
              <strong>Back-EMF:</strong> Generated by rotor motion, reduces net voltage and hence
              current
            </li>
            <li>
            ...
            <li>
              <strong>VSD control:</strong> Variable Speed Drives control motor speed by varying
              frequency
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Isolation:</strong> Medical locations (IT systems), bathrooms, swimming pools
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Key Installation Considerations</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Large motors</strong> — High starting current — Suitably rated MCB/fuses,
              consider soft-start
            </li>
            <li>
              <strong>Transformers</strong> — Magnetising inrush — Time-delayed protection,
              inrush-rated MCB
            </li>
            <li>
              <strong>Generators</strong> — Voltage regulation — AVR settings, load shedding
              sequence
            </li>
            <li>
              <strong>Single-core cables</strong> — Induced EMF in metalwork — Non-ferrous glands,
              trefoil formation
            </li>
          </ul>

          <p>
            <strong>BS 7671 note:</strong> Regulation 521.5 requires all conductors of a circuit to
            be contained in the same cable or enclosure to prevent eddy current heating.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            ...
            rotating at the edge of a 0.15m radius drum at 1500 rpm in a 0.9T field. Calculate the
          ...
          <p>Total EMF depends on series/parallel conductor arrangement</p>

          <p className="text-sm font-medium text-elec-yellow/80">
            Example 2: Transformer Turns Ratio
          </p>
          <p>
            <strong>Question:</strong> A bell transformer has 1150 turns on the primary and 40 turns
            on the secondary. If connected to 230V mains, what is the secondary voltage?
          </p>
          ...
          <p>
            <strong>Question:</strong> A 400-turn coil is in a magnetic field. The flux through the
            coil changes from 0.08Wb to 0.02Wb in 50ms. Calculate the induced EMF.
          </p>
          ...
          <p>The positive result indicates EMF opposes the decreasing flux</p>
          ...
          <p>This is why relay contacts arc - the back-EMF can be much higher than supply</p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A site operator reports increased monthly kWh consumption from a 800 kVA cast-resin
              distribution transformer feeding a quiet office building. The transformer is audibly
              louder than at commissioning two years ago. No-load loss measurement shows 1.8 kW
              continuous (commissioning value 1.1 kW).
            </>
          }
          whatToDo={
            <>
              Investigate via three avenues: (a) Check supply voltage. If the DNO is running
              consistently at 245&ndash;253 V (within the 230 V +10 % BS EN 50160 tolerance), core
              flux density rises beyond design point and the iron saturates — drives both no-load
              loss and acoustic noise. Specify a tap changer adjustment to bring secondary nominal
              closer to 230 V. (b) Check downstream harmonic content — significant 5th/7th
              distortion increases eddy-current loss. (c) Visually / thermally inspect for
              delaminated core stacking or loose tie-bolts.
            </>
          }
          whyItMatters={
            <>
              A 0.7 kW continuous no-load increase is 6132 kWh/year &mdash; ~&pound;1230 at 20
              p/kWh, plus the carbon penalty under any building&rsquo;s ESOS or BREEAM-In-Use audit.
              Transformer no-load loss runs 24/7 regardless of downstream load, so detecting and
              correcting drift is high-leverage on BSE energy management.
            </>
          }
        />
