      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Single-phase:</strong> 230 V line-to-neutral — domestic and light commercial
              </li>
              <li className="pl-1">
                <strong>Three-phase:</strong> 400 V line-to-line — industrial motors, large loads
              </li>
              <li className="pl-1">
                <strong>Star (Y):</strong> VL = √3 x VP, provides both 230 V and 400 V
              </li>
              <li className="pl-1">
                <strong>Delta (Δ):</strong> IL = √3 x IP, used for motor windings and distribution
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Maximum demand:</strong> Typically 60-100 A for domestic (14-23 kW),
                  limited by the DNO service fuse
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>No rotating field:</strong> Single-phase cannot produce a rotating
                  magnetic field — single-phase motors require additional starting mechanisms
                  (capacitor start, shaded pole, etc.)
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Rotating magnetic field:</strong> Three phases naturally produce a
                  rotating magnetic field in three-phase motors — simple, robust, self-starting (no
                  capacitors or centrifugal switches needed)
                </li>
                <li className="pl-1">
                  <strong>Efficient power transmission:</strong> Three-phase transmits 73% more
                  power than single-phase using only 50% more conductors (3 vs 2) and 75% of the
                  copper weight
                </li>
                <li className="pl-1">
                  <strong>Dual voltage levels:</strong> Star connection provides both line (400 V)
                  and phase (230 V) voltages from the same system
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    Used for: distribution transformers, motor starting, generators
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    Used for: motor running, power distribution, transformers
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Step 3 — Delta:</strong> Motor connected in delta. Each winding receives
                  VP = VL = 400 V. Motor operates at full voltage, full speed, full torque
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Star:</strong> U2, V2, W2 linked together (star point). Supply connected
                  to U1, V1, W1
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Always verify:</strong> Check the motor nameplate rating matches the
                  supply voltage and the correct link configuration before energising
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Three-Phase Power Formulae (Balanced Loads)
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              <p className="text-sm font-medium text-red-400 mb-2">
                Neutral Overloading — A Hidden Danger
              </p>
              <p className="text-sm text-white mb-3">
                ...
                carry more current than the line conductors. This occurs because:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Third harmonic currents:</strong> Non-linear loads generate significant
                  third harmonic (150 Hz) current. Unlike fundamental frequency currents, third
                  harmonics from all three phases are in phase with each other and add
                  arithmetically in the neutral
                </li>
                <li className="pl-1">
                  <strong>Result:</strong> The neutral current can reach up to 1.73 times the line
                  current in extreme cases
                </li>
                <li className="pl-1">
                  <strong>Risk:</strong> Overheated neutral conductors, insulation damage, fire —
                  particularly in older installations where the neutral was sized at 50% of line
                  conductors
                </li>
                <li className="pl-1">
                  <strong>Solution:</strong> Size the neutral at 100% of line conductors (or larger)
                  in installations with significant non-linear loads. BS 7671 requires this
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>ST1426 link:</strong> The maintenance technician must be able to identify
              single-phase and three-phase supplies, understand star and delta connections,
              calculate three-phase power and recognise the importance of load balancing. Phase
              rotation verification before motor connection is a critical maintenance procedure.
            </p>
          </div>
        </section>
