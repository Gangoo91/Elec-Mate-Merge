      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="rounded-lg p-4 bg-emerald-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 mt-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-blue-700 dark:text-emerald-400 mb-2">Critical Safety Statistics</p>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">1. Why Safety Planning Matters - Comprehensive Analysis</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-3">Human and Moral Imperatives</p>
                    
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Preventing Accidents and Injuries:</strong></p>
                        <p className="text-xs sm:text-sm text-foreground mb-3">Every worker has the right to return home safely each day. Electrical work involves high-risk activities including:</p>
                        
                        <div className="grid md:grid-cols-2 gap-4">
                          <div>
                            <p className="text-base text-foreground mb-2"><strong>Fatal Risks:</strong></p>
                          ...
                          <div>
                            <p className="text-base text-foreground mb-2"><strong>Injury Risks:</strong></p>
                            <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                      ...
                      <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded border border-red-200 dark:border-red-800">
                        <p className="font-medium text-red-700 dark:text-emerald-400 mb-2">Real Consequences</p>
                        <p className="text-xs sm:text-sm text-foreground">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">1.1 Business and Economic Benefits of Safety Planning</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
                ...
                <div className="rounded-lg p-4 bg-emerald-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                  ...
                  <p className="text-xs text-blue-700 dark:text-emerald-400 mt-2">Productivity: 15-25% improvement</p>
                </div>
                ...
                <div className="rounded-lg p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
                  ...
                  <p className="text-xs text-purple-700 dark:text-emerald-400 mt-2">Contracts: 30% higher success rate</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">2. UK Legislation and Standards - Detailed Framework</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-red-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-red-600 dark:text-emerald-400 mb-3">Health and Safety at Work etc. Act 1974 (HASAWA)</p>
                    
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Fundamental Principles:</strong></p>
                        <p className="text-xs sm:text-sm text-foreground mb-3">The overarching legislation that establishes the framework for workplace health and safety in the UK.</p>
                        
                        <div className="grid md:grid-cols-2 gap-4">
                          <div>
                            <p className="text-base text-foreground mb-2"><strong>Employer Duties (Section 2):</strong></p>
                            <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                          ...
                          <div>
                            <p className="text-base text-foreground mb-2"><strong>Employee Duties (Section 7):</strong></p>
                            <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                      ...
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Penalties and Enforcement:</strong></p>
                        <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded border border-red-200 dark:border-red-800">
                          <ul className="text-xs sm:text-sm text-foreground list-disc pl-6 space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">2.1 Electricity at Work Regulations 1989 (EAWR)</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  <span className="flex-shrink-0 w-8 h-8 bg-emerald-500 text-white rounded-full flex items-center justify-center text-sm font-bold">⚡</span>
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-3">Key Requirements for Electrical Installation</p>
                    
                    <div className="space-y-4">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          <p className="text-base text-foreground mb-2"><strong>Design and Construction (Reg 4):</strong></p>
                          <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                        ...
                        <div>
                          <p className="text-base text-foreground mb-2"><strong>Work on Equipment (Reg 14):</strong></p>
                          <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                      ...
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Live Working Restrictions (Reg 14):</strong></p>
                        <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded border border-orange-200 dark:border-orange-800">
                          <p className="text-xs sm:text-sm text-foreground mb-2">Live working is only permitted when:</p>
                          <ul className="text-xs sm:text-sm text-foreground list-disc pl-6 space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">2.2 Work at Height Regulations 2005 (WAHR)</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>1. Avoid Working at Height:</strong></p>
                        <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                      ...
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>2. Prevent Falls (if height work necessary):</strong></p>
                        <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                      ...
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>3. Minimise Distance/Consequences of Falls:</strong></p>
                        <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">2.3 BS 7671 Wiring Regulations - Safety in Design</h3>
            <p className="text-base text-foreground mb-4">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">3. Common Hazards in Electrical Installation - Comprehensive Analysis</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-3">Electrical Hazards - High Risk Categories</p>
                    
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Electric Shock and Electrocution:</strong></p>
                        <div className="grid md:grid-cols-2 gap-4">
                          <div>
                            <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Primary Causes:</strong></p>
                            <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
          ...
          />
                      ...
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Arc Flash and Burns:</strong></p>
                        <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded border border-orange-200 dark:border-orange-800">
                          <p className="text-xs sm:text-sm text-foreground mb-2">Arc flash incidents can cause:</p>
                          <ul className="text-xs sm:text-sm text-foreground list-disc pl-6 space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">3.1 Working at Height Hazards - Detailed Risk Assessment</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
                <div className="rounded-lg p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
                  ...
                  <p className="text-xs text-red-700 dark:text-emerald-400 mt-2">47% of construction fatalities</p>
                </div>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">3.2 Manual Handling and Environmental Hazards</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="flex flex-col h-full">
                  <h4 className="font-medium text-foreground mb-3">Manual Handling Risks</h4>
                  <ul className="list-disc pl-6 space-y-1 text-xs sm:text-sm text-foreground mb-3 flex-grow">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">4. Risk Assessments and Method Statements (RAMS) - Systematic Approach</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-3">Risk Assessment Process - 5 Steps to Safety</p>
                    
                    <div className="space-y-4">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          <p className="text-base text-foreground mb-2"><strong>Step 1: Identify Hazards</strong></p>
                          <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                        ...
                        <div>
                          <p className="text-base text-foreground mb-2"><strong>Step 2: Identify Who Might Be Harmed</strong></p>
                          <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                      ...
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Step 3: Evaluate Risks and Control Measures</strong></p>
                        <div className="bg-purple-50 dark:bg-purple-900/20 p-3 rounded border border-purple-200 dark:border-purple-800">
                          <p className="text-xs sm:text-sm text-foreground mb-2">Risk Assessment Matrix:</p>
                          ...
                          <p className="text-xs text-purple-700 dark:text-emerald-400 mt-2">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          <p className="text-base text-foreground mb-2"><strong>Step 4: Record Findings</strong></p>
                          <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                        ...
                        <div>
                          <p className="text-base text-foreground mb-2"><strong>Step 5: Review and Update</strong></p>
                          <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
          ...
          {/* Method Statements */}
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">4.1 Method Statements - Safe Systems of Work</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-4 bg-emerald-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Work Description:</strong></p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                  ...
                  <div>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Safety Procedures:</strong></p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
              <div>
                <h3 className="font-medium text-foreground mb-3">Essential Safety Practices</h3>
                <ul className="list-disc pl-6 space-y-1 text-xs sm:text-sm text-foreground">
              ...
              <div>
                <h3 className="font-medium text-foreground mb-3">Daily Safety Checks</h3>
                <ul className="list-disc pl-6 space-y-1 text-xs sm:text-sm text-foreground">
