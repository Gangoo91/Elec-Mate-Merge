...
const TITLE =
  'Health and Safety Considerations During Planning - Module 5.3.6 | Level 2 Electrical Course';
const DESCRIPTION =
...
const Module5Section3_6 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 0,
      explanation:
        'False. BS 7671 includes comprehensive safety requirements alongside performance standards for electrical installations.',
    },
    {
      id: 5,
      question: 'What does a method statement describe?',
      ...
      correctAnswer: 1,
      explanation:
        'A method statement provides detailed instructions on how to carry out a specific task safely.',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Serious accidents can result in HSE investigations, substantial fines, legal action, and potential site closure.',
    },
    {
      id: 10,
  ...
  const faqs = [
    {
      ...
      answer:
        'No — live work is only permitted under exceptional circumstances and with strict controls. The time saved is never worth the risk of injury or death. All circuits must be isolated before work begins.',
    },
    {
      question: 'Who is responsible for health and safety on site?',
      answer:
        'Everyone has responsibility for health and safety, but the site manager leads enforcement. Each worker must follow safe systems of work and report hazards immediately.',
    },
    {
      question: 'Are PPE and safe systems optional if the job is small?',
      answer:
        "No — all jobs require appropriate safety measures, regardless of size. Small jobs can still result in serious injuries if proper precautions aren't taken.",
    },
  ];
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                work, and compliance with legislation. Planning with safety in mind not only
                protects workers but also prevents costly delays and ensures legal compliance.
              </p>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30">
                ...
                <div className="mt-4 p-3 rounded bg-red-500/20">
                  ...
                  <ul className="text-sm text-white/70 list-disc pl-5 space-y-1">
                    ...
                    <li>
                      <strong>Up to 2 years imprisonment</strong> for individuals
                    </li>
                    <li>
                      <strong>Corporate manslaughter charges</strong> for fatal incidents
                    </li>
                    <li>
                      <strong>Prohibition notices</strong> stopping dangerous work
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30">
                <p className="font-medium text-elec-yellow mb-3">
                  Key Requirements for Electrical Installation
                </p>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
                <p className="font-medium text-orange-400 mb-3">
                  Electrical Hazards - High Risk Categories
                </p>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-purple-500/10 border border-purple-500/30">
                <p className="font-medium text-purple-400 mb-3">
                  Risk Assessment Process - 5 Steps to Safety
                </p>
                  ...
                  <div>
                    ...
                    <div className="p-3 rounded bg-purple-500/20">
                      ...
                      <div className="grid grid-cols-4 gap-2 text-xs text-center">
                        ...
                        <div className="bg-orange-500/30 p-2 rounded">
                          High Risk
                          <br />
                          5-8
                        </div>
                        <div className="bg-red-500/30 p-2 rounded">
                          Very High
                          <br />
                          9-15
                        </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
                <h3 className="font-medium text-blue-400 mb-3">
                  Essential Components of Method Statements
                </h3>
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-white/90">
                ...
                accidents. Good safety planning protects workers, avoids legal consequences, and
