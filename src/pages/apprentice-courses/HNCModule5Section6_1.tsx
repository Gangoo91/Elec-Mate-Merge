...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['110V centre-tapped earth', '230V single phase', '400V three phase', '50V SELV'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'Under HSE welfare guidance, how many toilets are recommended where there are 6 to 25 workers on site?',
    options: ['4', '3', '2', '1'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['100 metres', '50 metres', '25 metres', 'No specific limit'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['50 lux', '100 lux', '200 lux', '150 lux'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['2.0 metres', '2.4 metres', '1.2 metres', '1.8 metres'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['3 metres', '10 metres', '6 metres', '15 metres'],
    correctAnswer: 1,
    explanation:
...
const HNCModule5Section6_1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 6 · Subsection 1"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CDM 2015 places explicit welfare duties on the principal contractor — Schedule 2
              minimums must be in place from the start of work, not "when convenient". Site
              organisation is therefore a CDM compliance matter, not an operational nicety. HSE
              inspectors check welfare on every visit.
            </>
          }
        ...
        <ConceptBlock title="Site Setup Planning">
          <p>
            Effective site organisation begins before construction starts. The principal contractor
            must plan the compound layout, access routes, and temporary services to support safe and
            efficient work throughout the project duration.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Offices:</strong> Meeting space, document storage — Near entrance, overlooking
              site
            </li>
            <li>
        ...
        <ConceptBlock title="Security and Access Control">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>CCTV:</strong> IP cameras, remote monitoring — Surveillance, incident evidence
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Sign-in/out system:</strong> Electronic or manual register for fire evacuation
              roll call
            </li>
            <li>
          ...
          <p>
            <strong>Best practice:</strong> Use electronic access control cards that integrate with
            time recording and automatically prevent access for workers with expired inductions.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Temporary Services Coordination">
          <p>
            Temporary electrical supplies, water, and other services are critical infrastructure for
            construction operations. The building services contractor often leads this coordination
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Main distribution board:</strong> 100-200A three-phase — Near DNO supply point
            </li>
            <li>
          ...
          <p>
            <strong>Handover planning:</strong> As permanent electrical and mechanical services are
            commissioned, plan phased transfer from temporary supplies. Maintain temporary backup
            until permanent systems proven reliable.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — Welfare provision calculation:</strong> A construction site has peak
            workforce of 85 workers. What welfare facilities are required?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — Security assessment:</strong> A city centre site has high-value M&E
            equipment arriving for installation. What security measures are appropriate?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Consider: coordinated delivery with immediate installation to avoid overnight storage
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              An MEP refurbishment of an occupied office. The contractor is using two portable
              toilets shared with the existing building's cleaners; no dedicated welfare cabin;
              nowhere to dry wet PPE; nowhere to eat. After a worker complaint, HSE visits. The
              inspector issues a prohibition notice: works to stop until CDM Schedule 2 welfare is
              provided. Two-week stoppage; reputational damage with client.
            </>
          }
          whatToDo={
            <>
              Welfare is mobilisation Day 1, not Week 4. Engage early with the client about welfare
              cabin location, drainage and power. If the building is occupied and external space
              limited, lease a remote welfare cabin and provide transport. Brief subcontractors that
              they cannot start without the welfare facilities being in place. Use the Construction
              Phase Plan to formalise the welfare arrangement — HSE inspectors read this on first
              visit.
            </>
          }
          whyItMatters={
            <>
              Welfare is both a legal duty and a productivity issue. Operatives without proper
              facilities lose time, develop health issues, and leave the site for the wrong reasons.
              CDM enforcement on welfare is increasingly active — a prohibition notice carries
              reputational and commercial consequences far beyond the cost of the cabin.
            </>
          }
        />
