  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'HASAWA Section 2 requires employers to provide and maintain plant and systems of work that are, so far as is reasonably practicable, safe and without risks to health.',
    },
    {
      id: 2,
      question:
        'At what employee threshold must an employer have a WRITTEN health and safety policy?',
      options: [
        '1 or more employees',
        '5 or more employees',
      ...
      correctAnswer: 1,
      explanation:
        'Under HASAWA, employers with 5 or more employees must have a written health and safety policy that is communicated to all staff. Smaller employers must still have a policy, just not necessarily written.',
    },
    {
      id: 3,
      ...
      correctAnswer: 1,
      explanation:
        'Section 7 places a duty on employees to take reasonable care for their own health and safety and that of others who may be affected by their acts or omissions at work.',
    },
    {
      id: 4,
      ...
      correctAnswer: 2,
      explanation:
        'Section 8 makes it an offence for any person to intentionally or recklessly interfere with or misuse anything provided in the interests of health, safety, or welfare - such as fire extinguishers, guards, or PPE.',
    },
    {
      id: 5,
      question:
        'What is the maximum fine an employer can face for serious HASAWA breaches in Crown Court?',
      options: ['£5,000', '£20,000', '£50,000', 'Unlimited'],
      correctAnswer: 3,
      explanation:
        'For serious breaches tried in Crown Court, there is no limit on fines. Recent cases have seen fines of several million pounds. In cases of gross negligence, individuals can also face imprisonment.',
    },
    {
      id: 6,
      ...
      correctAnswer: 1,
      explanation:
        'Employees have an implied duty to report hazards and defects they identify. Employers are responsible for risk assessments, providing PPE, and writing safety policies.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'A Prohibition Notice is issued when there is risk of serious personal injury and requires dangerous activities to stop immediately until the risk is eliminated. An Improvement Notice allows time to fix issues.',
    },
    {
      id: 8,
      ...
      correctAnswer: 2,
      explanation:
        'Employees who fail to use provided PPE can face disciplinary action from their employer and, in serious cases, personal prosecution under HASAWA Sections 7 and 8.',
    },
    {
      id: 9,
      ...
      correctAnswer: 2,
      explanation:
        'Employers have a legal duty to consult with employees or their safety representatives on matters affecting their health and safety - this includes changes to work processes and safety training.',
    },
    {
      id: 10,
      ...
      correctAnswer: 1,
      explanation:
        'Employees can be personally prosecuted under HASAWA for breaching their duties under Sections 7 and 8, with potential fines and even imprisonment for serious offences.',
    },
    {
      id: 11,
      question:
        'What happens if an employer fails to conduct risk assessments and an accident occurs?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'Failure to conduct risk assessments is a serious breach. If an accident occurs, employers can face HSE prosecution with unlimited fines and, where gross negligence is proven, imprisonment of responsible individuals.',
    },
    {
      id: 12,
      question: 'Under HASAWA, who has the PRIMARY duty for workplace safety?',
      options: ['Employees', 'Employers', 'The HSE', 'Insurance companies'],
      correctAnswer: 1,
      explanation:
        'While employees have important duties, employers carry the PRIMARY responsibility for workplace safety under Section 2 of HASAWA - they must ensure, so far as reasonably practicable, the health, safety and welfare of all employees.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="p-4 sm:p-5 rounded-xl bg-elec-yellow/10 border border-elec-yellow/20">
              ...
              <ul className="space-y-2 text-sm text-white">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow mt-1">*</span>
                  <strong className="text-white">Use:</strong> Safety policies, training records,
                  risk assessments
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow mt-1">*</span>
                  <strong className="text-white">Check:</strong> Who is responsible? Are duties
                  being met?
                </li>
              </ul>
            </div>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white">
                Employer Duties (HASAWA Section 2)
              </h2>
            </div>
            <div className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10 space-y-4">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/20">
                ...
                <p className="text-white text-sm">
                  ...
                  proportionate measures are expected.
                </p>
              </div>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white">
                Employee Duties (HASAWA Sections 7 & 8)
              </h2>
            </div>
            <div className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10 space-y-4">
              <p className="text-white text-sm sm:text-base leading-relaxed">
                ...
                isn't something that's done TO you, it's something you actively participate in.
              </p>
              ...
              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  at work. Your actions on site affect everyone around you.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
                ...
                <p className="text-white text-sm leading-relaxed">
                  ...
                  following safety rules, attending training, and participating in safety
                  procedures.
                </p>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      ...
                      includes fire extinguishers, safety guards, warning signs, PPE, and emergency
                      equipment. Tampering with safety equipment is a criminal offence.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3 mt-4">
                ...
                <ul className="space-y-2 text-sm text-white">
                  <li className="flex items-start gap-2">
                    ...
                    report dangers, defective equipment, and unsafe conditions to your employer or
                    supervisor
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">*</span>
                    <strong className="text-white">Use equipment as trained:</strong> Only use
                    equipment in accordance with the training and instructions provided
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">*</span>
                    <strong className="text-white">Wear provided PPE:</strong> Use personal
                    protective equipment correctly and report any damage or defects
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">*</span>
                    <strong className="text-white">Follow safe working procedures:</strong> Adhere
                    to established safety procedures, method statements, and permits
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white">
                Consequences of Breach - For Both Parties
              </h2>
            </div>
            <div className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10 space-y-4">
              <p className="text-white text-sm sm:text-base leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <ul className="space-y-2 text-sm text-white">
                  <li className="flex items-start gap-2">
                    ...
                    employers (and individual directors/managers) for breaches
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-400">*</span>
                    <strong className="text-white">Unlimited Fines:</strong> For serious offences in
                    Crown Court, fines are unlimited - recent cases have reached millions of pounds
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-400">*</span>
                    <strong className="text-white">Imprisonment:</strong> For gross negligence
                    causing death, individuals can face corporate manslaughter charges and prison
                    sentences
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-400">*</span>
                    <strong className="text-white">Prohibition Notices:</strong> HSE can immediately
                    stop dangerous work until risks are eliminated
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-400">*</span>
                    <strong className="text-white">Improvement Notices:</strong> Require specific
                    safety improvements within a set timeframe
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
                ...
                <ul className="space-y-2 text-sm text-white">
                  <li className="flex items-start gap-2">
                    ...
                    warnings, or dismissal for safety breaches
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400">*</span>
                    <strong className="text-white">Personal Prosecution:</strong> Employees can be
                    prosecuted under HASAWA Sections 7 and 8
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400">*</span>
                    <strong className="text-white">Fines:</strong> Personal fines for breaching
                    safety duties can be substantial
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400">*</span>
                    <strong className="text-white">Imprisonment:</strong> For serious offences,
                    employees can face prison sentences
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400">*</span>
                    <strong className="text-white">Summary Dismissal:</strong> Gross misconduct
                    related to safety can result in immediate dismissal
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="p-4 sm:p-6 rounded-xl bg-gradient-to-br from-amber-500/10 to-red-500/10 border border-amber-500/20">
            ...
            <div className="space-y-3 text-sm text-white">
              <p>
                ...
                had not enforced its use or provided proper training on when it was required. The
                employee, an experienced electrician, knew PPE was available but chose not to wear
                it for a "quick" fault-finding task on live equipment.
              </p>
              <p>
                <strong className="text-white">The Incident:</strong> An arc flash occurred during
                fault-finding, causing serious burns to the electrician's hands and face. The
                investigation revealed multiple failures by BOTH parties.
              </p>
              <p>
                <strong className="text-white">The Consequences:</strong> The employer was
                prosecuted for failing to provide adequate training and supervision, and for not
                enforcing PPE use - they received a fine of £180,000. The employee was ALSO
                prosecuted under Section 7 for failing to take reasonable care - he received a
                personal fine of £5,000. Both faced consequences.
              </p>
              <p>
                <strong className="text-white">The Lesson:</strong> Safety responsibilities are
                shared. The employer should have ensured training was adequate and PPE use was
                enforced. The employee should have worn available PPE and not taken shortcuts with
                live working. When either party fails, the consequences affect everyone.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10">
            ...
            <div className="space-y-4">
              ...
              <details className="group">
                <summary className="cursor-pointer font-medium text-white hover:text-elec-yellow active:text-elec-yellow transition-all touch-manipulation flex items-center justify-between">
                  <span>
                    What's the difference between an Improvement Notice and Prohibition Notice?
                  </span>
                  <span className="text-elec-yellow group-open:rotate-180 transition-transform">
                    +
                  </span>
          ...
          <div className="p-4 sm:p-6 rounded-xl bg-gradient-to-br from-elec-yellow/10 to-elec-yellow/5 border border-elec-yellow/20">
            <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">
              Pocket Guide - Employer & Employee Duties
            </h2>
