    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Produce comprehensive specifications and documentation that effectively communicate design
          intent and support project delivery
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the documentation and specification requirements for building services
          electrical design. Clear, comprehensive documentation is essential for successful project
          delivery, ensuring designs are correctly interpreted and constructed.
        </p>
