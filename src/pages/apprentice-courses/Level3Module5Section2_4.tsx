      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Documenting findings using C1, C2, C3, and FI classification codes
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Record observations accurately with location and description",
              "Complete all sections of the EICR correctly",
              "Document limitations and their implications",
              "Complete Schedules of Inspections and Test Results",
              "Issue appropriate documentation for dangerous conditions",
