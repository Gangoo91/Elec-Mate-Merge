        ...
        <section className="mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-sm text-white">
              This section covers communication and teamworking including client communication,
              technical reporting, working with other trades,
              conflict resolution, and technical presentations.
            </p>
          </div>
        </section>
