...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Open circuit', 'Purely resistive', 'Inductive', 'Purely capacitive'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Phase angle', 'RMS magnitude', 'Frequency', 'Time period'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['53.13 degrees', '45 degrees', '60 degrees', '36.87 degrees'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['SOHCAHTOA', 'CIVIL', 'ROY G BIV', 'ELI the ICE man'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['90 degrees', '120 degrees', '60 degrees', '180 degrees'],
    correctAnswer: 1,
    explanation:
...
const HNCModule3Section3_3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 3 · Subsection 3"
        title="Phase Difference and Vector Representation"
        backTo="/study-centre/apprentice/h-n-c-module3-section3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Understanding phasor diagrams and phase relationships for AC circuit analysis in building
          services
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              energising. As the BSE engineer you must use a sequence-indicating instrument (Megger
              PSI, Fluke 9040 or equivalent) on every new three-phase final circuit, not assume the
              colours match the rotation. Wrong sequence can spin a centrifugal pump dry, run a lift
              the wrong way against a limit switch, or push a fan into stall.
            </>
          }
        ...
        <ConceptBlock title="Phase Angle - Definition and Measurement">
          ...
          <p>
            <strong>Phase Angle Definition:</strong> phi = (delta t / T) x 360 degrees. Where delta
            t = time difference, T = period of one cycle.
          </p>
          <p>Key concepts:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>In phase:</strong> phi = 0 degrees - V and I peak together (resistive)
            </li>
            <li>
              <strong>Leading:</strong> phi positive - current peaks before voltage
            </li>
            <li>
              <strong>Lagging:</strong> phi negative - current peaks after voltage
            </li>
          ...
          <p>
            <strong>Remember:</strong> Power factor = cos(phi). A smaller phase angle means higher
            power factor and more efficient use of the supply.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Leading and Lagging Currents">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>ELI</strong> — In an L (inductor): E (voltage) leads I (current). Current lags
              voltage by up to 90 degrees.
            </li>
            <li>
              <strong>ICE</strong> — In a C (capacitor): I (current) leads E (voltage). Current
              leads voltage by up to 90 degrees.
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Why Current Lags in Inductors:</strong> An inductor opposes changes in current.
            When voltage is applied, the magnetic field builds up, which opposes current flow. The
            current gradually increases, reaching its maximum 90 degrees (quarter cycle) after the
            voltage peak. This is why motors, which are essentially large inductors, have lagging
            power factor.
          </p>
          <p>
            <strong>Why Current Leads in Capacitors:</strong> A capacitor allows current to flow
            freely when uncharged. Maximum current flows at the instant voltage begins rising (to
            charge the capacitor). As voltage reaches its peak, the capacitor is fully charged and
            current drops to zero. Current therefore peaks 90 degrees before voltage.
          </p>
          <p>
        ...
        <ConceptBlock title="Vector and Phasor Representation">
          <p>
            ...
            Phasor diagrams simplify AC circuit analysis by converting time-varying sine waves into
            static vector diagrams.
          </p>
          <p>Phasor properties:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Length:</strong> Represents the RMS magnitude of the quantity
            </li>
            <li>
              <strong>Angle:</strong> Represents the phase relative to a reference (usually voltage)
            </li>
            <li>
              <strong>Direction:</strong> Anti-clockwise rotation represents positive angle
            </li>
            <li>
              <strong>Rotation:</strong> Phasors rotate at angular frequency omega = 2 x pi x f
            </li>
            <li>
              <strong>Reference:</strong> Voltage is typically placed along the positive x-axis
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Draw current phasor at the appropriate angle: in phase (same direction), lagging
              (rotated clockwise), leading (rotated anti-clockwise)
            </li>
          ...
          <p>
            <strong>Note:</strong> j is used in electrical engineering (instead of i) to represent
            the square root of -1, as i already represents current.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Adding Phasors Graphically">
          <p>
            ...
            phasors must be added vectorially, not algebraically. The phase relationships determine
            whether quantities reinforce or partially cancel each other.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Quadrature (90 degrees) — Resultant = sqrt(V1 squared + V2 squared) (Pythagoras
              applies)
            </li>
          ...
          <p>
            ...
            phasors: Resultant Vx = V1x + V2x, Resultant Vy = V1y + V2y. Magnitude = sqrt(Vx squared
            + Vy squared); Angle = arctan(Vy / Vx).
          </p>
          <p>
            <strong>Practical application:</strong> In three-phase systems, the line voltage is the
            phasor difference between two phase voltages, giving 400V = 230V x sqrt(3) from the
            120-degree phase relationship.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Phase Relationships in R, L, C Circuits">
          ...
          <p>
            <strong>Key insight:</strong> In a series circuit, current is the reference phasor (same
            through all components). Voltage phasors are drawn relative to this common current.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Phase Sequence in Three-Phase Systems">
          <p>
            In three-phase systems, the three phases (L1, L2, L3) are separated by 120 degrees. The{' '}
            <strong>phase sequence</strong> determines the order in which each phase reaches its
            positive peak, which is critical for motor rotation direction.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Positive sequence (ABC or L1-L2-L3):</strong> Standard rotation, phases reach
              peak in order L1 then L2 then L3
            </li>
            <li>
              <strong>Negative sequence (ACB or L1-L3-L2):</strong> Reverse rotation, phases reach
              peak in order L1 then L3 then L2
            </li>
          ...
          <p>
            <strong>Phase Sequence Indicators:</strong> Always use a phase sequence indicator before
            connecting three-phase motors. Modern indicators show rotation direction with LED
            lights. The instrument is connected to L1, L2, L3 and indicates whether the sequence
            will give clockwise or anti-clockwise motor rotation.
          </p>
          <p>
            <strong>Testing tip:</strong> After installation, briefly run motors unloaded to verify
            rotation before coupling to driven equipment.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Power Factor Relationship to Phase Angle">
          <p>
            Power factor is the cosine of the phase angle between voltage and current. It indicates
            what proportion of the apparent power (VA) is converted to useful work (Watts).
          </p>
          <p>
          ...
          <p>
            ...
            Real power: P = V x I x cos(phi). Reactive power: Q = V x I x sin(phi). Apparent power:
            S = V x I = sqrt(P squared + Q squared). Phase angle: phi = arccos(pf) = arccos(kW /
            kVA).
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply capacity:</strong> Low pf means higher current for same real power
            </li>
            <li>
              <strong>Cable losses:</strong> I squared R losses increase with higher current
            </li>
            <li>
              <strong>Voltage drop:</strong> Higher current causes greater voltage drop
            </li>
            <li>
              <strong>Transformer sizing:</strong> Transformers rated in kVA, not kW
            </li>
            <li>
              <strong>Utility charges:</strong> Penalties applied for pf below 0.95
            </li>
          </ul>
          <p>
            <strong>Example:</strong> A 100kW load at 0.7 pf draws 143kVA (current for 143kVA). At
            0.95 pf, it draws only 105kVA - a 26% reduction in current.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Services: Motor Starting and Capacitor Effects">
          ...
          <p>
            ...
            current (locked rotor current) because the rotor is stationary. At standstill, the motor
            acts almost as a short-circuited transformer with very low impedance.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Direct-on-line (DOL) — Starting Current 6-8 x FLC, Starting Torque 100%, Application:
              Small motors less than 7.5kW
            </li>
            <li>
              Star-delta — Starting Current 2-3 x FLC, Starting Torque 33%, Application: Pumps, fans
              (low starting load)
            </li>
            <li>
              Soft starter — Starting Current 2-4 x FLC, Starting Torque Adjustable, Application:
              General purpose, conveyors
            </li>
            <li>
              VFD (Variable Frequency Drive) — Starting Current 1-1.5 x FLC, Starting Torque
              Adjustable, Application: Speed control required
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Star Connection (Start) — Each winding sees 230V (phase voltage); Current reduced by
              factor of sqrt(3); Power reduced to 1/3; Torque reduced to 1/3
            </li>
            <li>
              Delta Connection (Run) — Each winding sees 400V (line voltage); Full rated current;
              Full power capability; Full torque available
            </li>
          </ul>
          <p>
            <strong>Power Factor Correction Capacitors:</strong> Capacitors provide leading reactive
            current that cancels the lagging reactive current drawn by motors. This reduces the
            total current from the supply. Required kVAr = kW x (tan(phi1) - tan(phi2)). Where phi1
            = original phase angle = arccos(original pf), phi2 = target phase angle = arccos(target
            pf).
          </p>
          <p>
            <strong>Example:</strong> 100kW at 0.7 pf, improve to 0.95. phi1 = arccos(0.7) = 45.6
            degrees. phi2 = arccos(0.95) = 18.2 degrees. kVAr = 100 x (tan(45.6) - tan(18.2)) = 100
            x (1.02 - 0.33) = <strong>69 kVAr</strong>.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Individual motor — Reduces cable current, switched with motor; Higher total cost, many
              units to maintain
            </li>
            <li>
              Group correction — Lower cost per kVAr, easier maintenance; Distribution cables not
              relieved
            </li>
            <li>
              Central automatic — Lowest cost, adapts to load changes; No cable relief, complex
              control
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            ...
            factor of 0.82 lagging at full load. Calculate the phase angle and the reactive power
            drawn.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              Reactive power: Q = S x sin(phi) = 26.83 x sin(34.9) = 26.83 x 0.572 ={' '}
              <strong>15.35 kVAr</strong>
            </li>
            <li>
          ...
          <p>
            <strong>Example 2: Adding Phasors.</strong> Two currents of 10A at 0 degrees and 8A at
            60 degrees flow into a junction. Find the resultant current.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Resultant magnitude: I = sqrt(14 squared + 6.93 squared) = sqrt(196 + 48) ={' '}
              <strong>15.6A</strong>
            </li>
            <li>
              Resultant angle: theta = arctan(6.93 / 14) = arctan(0.495) ={' '}
              <strong>26.3 degrees</strong>
            </li>
          </ul>
          <p>
            <strong>Example 3: Power Factor Correction.</strong> An installation has a load of 150kW
            at 0.75 power factor lagging. Calculate the capacitor bank size needed to improve to
            0.95 pf.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              kVAr = 150 x (0.882 - 0.329) = 150 x 0.553 = <strong>83 kVAr</strong>
            </li>
            <li>Standard capacitor bank: 90 kVAr (next standard size up)</li>
          </ul>
          <p>
            <strong>Example 4: Three-Phase Line Voltage.</strong> Using phasor addition, show why
            three-phase line voltage is sqrt(3) times the phase voltage.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Magnitude = sqrt(1.5 squared + 0.866 squared) x Vp = sqrt(2.25 + 0.75) x Vp = sqrt(3)
              x Vp = <strong>1.732 x Vp</strong>
            </li>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Power factor = cos(phi)</strong> - phase angle to power factor
            </li>
            <li>
              <strong>phi = arccos(pf)</strong> - power factor to phase angle
            </li>
            <li>
              <strong>kVAr = kW x (tan(phi1) - tan(phi2))</strong> - capacitor sizing
            </li>
            <li>
              <strong>VL = sqrt(3) x Vph</strong> - line to phase voltage relationship
            </li>
            <li>
              <strong>Resultant = sqrt(Vx squared + Vy squared)</strong> - phasor magnitude
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Three-phase separation: <strong>120 degrees</strong>
            </li>
            <li>
              sqrt(3) = <strong>1.732</strong>
            </li>
            <li>
              Target power factor: <strong>0.95 or better</strong>
            </li>
            <li>
              DOL starting current: <strong>6-8 x FLC</strong>
            </li>
            <li>
              Star-delta starting current: <strong>1/3 of DOL</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Calculator mode:</strong> Ensure calculator is in degrees (not radians) for
                trigonometry
              </li>
              <li>
                <strong>Sign convention:</strong> Lagging = negative angle, leading = positive
              </li>
              <li>
                <strong>Adding phasors:</strong> Cannot simply add magnitudes - must use vector
                methods
              </li>
              <li>
                <strong>Oversizing capacitors:</strong> Can cause self-excitation and overvoltage
              </li>
              <li>
                <strong>Phase sequence:</strong> Always verify before connecting motors
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A supermarket refrigeration upgrade adds 250 kW of compressor load at an aggregate
              0.78 pf lagging (mostly direct-on-line scroll compressors). The DNO supply contract
              levies a kVA-based capacity charge and excess reactive kVArh charges below 0.95 pf.
              You need to size a switched PFC bank.
            </>
          }
          whatToDo={
            <>
              Calculate kVAr = kW &times; (tan&phi;&#x2081; &minus; tan&phi;&#x2082;) = 250 &times;
              (tan(arccos 0.78) &minus; tan(arccos 0.95)) = 250 &times; (0.802 &minus; 0.329) = 118
              kVAr. Specify a 125 kVAr automatically switched detuned PFC bank (5.67 % or 7 %
              reactor blocking factor) sited at the MCC. Detuning is non-negotiable in supermarket
              installations because chiller VSDs inject 5th and 7th harmonics that resonate with
              bare capacitors.
            </>
          }
          whyItMatters={
            <>
              Wrongly sizing a bare-capacitor bank into a harmonic environment causes resonant
              amplification, capacitor failure, and potentially damages the upstream transformer.
              Detuning shifts the bank resonance below the 5th harmonic. The kVAr saving cuts the
              DNO capacity charge and removes the reactive penalty, typically paying back in
              18&ndash;30 months.
            </>
          }
        />
