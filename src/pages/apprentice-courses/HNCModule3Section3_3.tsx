      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Phase angle (phi):</strong> Angular displacement between V and I
              </li>
              <li className="pl-1">
                <strong>Leading:</strong> Current reaches peak before voltage (capacitive)
              </li>
              <li className="pl-1">
                <strong>Lagging:</strong> Current reaches peak after voltage (inductive)
              </li>
              <li className="pl-1">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Motors:</strong> Lagging power factor, starting current
              </li>
              <li className="pl-1">
                <strong>PFC capacitors:</strong> Correct lagging power factor
              </li>
              <li className="pl-1">
                <strong>Three-phase:</strong> 120-degree phase separation
              </li>
              <li className="pl-1">
                <strong>Phase sequence:</strong> Critical for motor rotation
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Phase Angle in Different Circuits
              </p>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p>
                    In an <strong>L</strong> (inductor):
                  </p>
                  <p>
                ...
                <div>
                  ...
                  <p>
                    In a <strong>C</strong> (capacitor):
                  </p>
                  <p>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white/90">
                ...
                are essentially large inductors, have lagging power factor.
              </p>
            </div>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white/90">
                ...
                peaks 90 degrees before voltage.
              </p>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Angle:</strong> Represents the phase relative to a reference (usually
                  voltage)
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              ...
              <ol className="text-sm text-white space-y-1.5 list-decimal list-outside ml-5">
                <li className="pl-1">
                  Draw the reference phasor (usually voltage) horizontally to the right
                </li>
                <li className="pl-1">Scale the length to represent RMS magnitude</li>
                <li className="pl-1">
                  Draw current phasor at the appropriate angle:
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        V angle phi or V at phi degrees
                      </td>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Head-to-Tail Method (Polygon Method)
              </p>
              <ol className="text-sm text-white space-y-1.5 list-decimal list-outside ml-5">
                <li className="pl-1">Draw the first phasor from the origin</li>
                <li className="pl-1">
                  Draw the second phasor with its tail at the head of the first
                </li>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Parallelogram Method (Two Phasors)
              </p>
              <ol className="text-sm text-white space-y-1.5 list-decimal list-outside ml-5">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Series R-L Circuit (Typical Motor)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Positive sequence (ABC or L1-L2-L3):</strong> Standard rotation, phases
                  reach peak in order L1 then L2 then L3
                </li>
                <li className="pl-1">
                  <strong>Negative sequence (ACB or L1-L3-L2):</strong> Reverse rotation, phases
                  reach peak in order L1 then L3 then L2
                </li>
                <li className="pl-1">Swapping any two phases reverses the sequence</li>
                <li className="pl-1">
                  Line voltage = sqrt(3) x phase voltage = 1.732 x 230V = 400V
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Phase Sequence Importance in Building Services
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Poor - significant reactive power
                      </td>
                    </tr>
                    <tr>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Star-Delta Starting - Phase Relationships
              </p>
              <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="my-6">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  kVAr = 100 x (1.02 - 0.33) = <strong>69 kVAr</strong>
                </p>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Capacitor Installation Options
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Reduces cable current, switched with motor
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Higher total cost, many units to maintain
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Group correction</td>
                      <td className="border border-white/10 px-3 py-2">
                        Lower cost per kVAr, easier maintenance
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Distribution cables not relieved
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Central automatic</td>
                      <td className="border border-white/10 px-3 py-2">
                        Lowest cost, adapts to load changes
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        No cable relief, complex control
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white/90 space-y-1 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Never exceed motor no-load magnetising current with individual capacitors
                </li>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Phase Angle from Power Factor
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  I = sqrt(14 squared + 6.93 squared) = sqrt(196 + 48) = <strong>15.6A</strong>
                </p>
                <p className="mt-2">Resultant angle:</p>
                <p>
                  theta = arctan(6.93 / 14) = arctan(0.495) = <strong>26.3 degrees</strong>
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 4: Three-Phase Line Voltage
              </h3>
              <p className="text-sm text-white mb-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Calculator mode:</strong> Ensure calculator is in degrees (not radians)
                  for trigonometry
                </li>
                <li className="pl-1">
