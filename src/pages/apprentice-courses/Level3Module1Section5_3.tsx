...
const quickCheckQuestions = [
  {
    ...
    options: ['30-45 minutes', '5-15 minutes', '1-2 hours', 'All day'],
    correctIndex: 1,
    explanation:
      'Toolbox talks should be short and focused, typically 5-15 minutes. This keeps attention high and allows workers to get back to productive work quickly while still receiving important safety information.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'Site inductions must be completed BEFORE any work begins on site. This is a legal requirement under CDM Regulations and ensures workers know site-specific hazards and emergency procedures before they are at risk.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 2,
    explanation:
      'Anyone without proper induction must be stopped from working until they complete the induction. Inform the site supervisor immediately. This protects both the uninducted person and others on site.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      'Recording attendance provides evidence that safety information has been communicated. This is important for legal compliance, demonstrating due diligence, tracking who needs refresher training, and investigating any future incidents.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'A toolbox talk is a short (typically 5-15 minute), focused safety briefing covering a specific topic relevant to the work being carried out. They are informal but effective ways to communicate safety messages.',
  },
  {
    id: 2,
    question:
      'How often should toolbox talks typically be conducted on an active construction site?',
    options: [
      'Once a year',
      'Once a month',
    ...
    correctAnswer: 2,
    explanation:
      'On active construction sites, toolbox talks are typically held weekly or more frequently. The frequency should reflect the changing nature of work, new hazards introduced, and any incidents or near misses that occur.',
  },
  {
    id: 3,
    question:
      'Under the CDM Regulations 2015, who is responsible for ensuring workers receive site inductions?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'The principal contractor is responsible for ensuring all workers (including subcontractors) receive appropriate site inductions before starting work. This is a key duty under CDM Regulations 2015.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Site inductions must cover practical safety information including site rules, emergency procedures (fire points, first aid, assembly points), specific hazards on site, welfare facilities, and reporting procedures.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Toolbox talk topics should be relevant to the work being done, address hazards workers will face, respond to recent incidents or near misses, and reflect seasonal or environmental factors.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Effective toolbox talks are interactive - use demonstrations where possible, encourage questions and discussion, use plain language, and check understanding. This engages workers and helps information stick.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Visitors must receive a basic induction covering essential safety information, emergency procedures, and any areas they are restricted from. They should typically be escorted and wear appropriate PPE.',
  },
  {
    id: 8,
    ...
    correctAnswer: 0,
    explanation:
      'Safety messages are forgotten over time - this is human nature. Refreshing key topics reinforces the message, especially before high-risk activities. Repetition improves retention and maintains safety awareness.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'The emergency procedures section ensures every worker knows: evacuation routes, assembly points, alarm sounds, fire extinguisher locations, first aid facilities, and who to contact. This knowledge saves lives in emergencies.',
  },
  {
    id: 10,
    question:
      'An electrician moves to a different area of a large site to work on a different phase of the project. What should happen?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'When moving to a different area with different hazards, workers should receive an additional briefing on hazards specific to that area. The original induction covered general site information, but each area may have unique risks.',
  },
  {
    id: 11,
    ...
    correctAnswer: 1,
    explanation:
      'Proper documentation includes: date and time, topic covered, key points discussed, name of presenter, attendee signatures or names, and any questions raised. This provides evidence of safety communication.',
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      "Toolbox talks are most effective when they relate directly to the workers' trade. For electricians, this means using electrical examples, discussing electrical hazards specifically, and demonstrating relevant safe practices.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes. Every site has different hazards, emergency procedures, welfare facilities, and rules. A site induction from one location does not cover another. You need a new induction for each site, even sites belonging to the same company. This is a legal requirement, not optional.',
  },
  {
    question: 'How long should an induction take?',
    answer:
      'Site inductions typically take 30 minutes to 2 hours depending on site complexity. Large construction sites with many hazards require longer inductions than smaller domestic projects. The key is that all essential information is covered properly, not rushing to save time.',
  },
  {
    question: "What's the difference between a toolbox talk and a method statement briefing?",
    answer:
      'A toolbox talk is a general safety briefing on a topic relevant to the workforce. A method statement briefing is specific to a particular task, explaining exactly how that task will be completed safely. Method statement briefings are typically given to those directly involved in that task before work begins.',
  },
  {
    question: 'Can toolbox talks be done online or must they be in person?',
    answer:
      'While face-to-face delivery is generally most effective (allows demonstrations, questions, and reading body language), online toolbox talks became common during COVID-19. They can work well for office-based workers or when supported by good materials. However, practical demonstrations and site-specific talks usually work better in person.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-8 text-gray-200">
        ...
        <header className="mb-8">
          ...
          <p className="text-lg text-gray-300">
            Effective methods for communicating safety information and ensuring workers are prepared
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              <strong className="text-white">Toolbox talks</strong> (also called safety briefings or
              tailgate meetings) are short, informal meetings held on site to discuss specific
              safety topics. They're a cornerstone of effective safety communication.
            </p>

            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              <h4 className="font-semibold text-white mb-3">
                Characteristics of Effective Toolbox Talks:
              </h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    <li>
                      <strong>Short:</strong> 5-15 minutes maximum
                    </li>
                    <li>
                      <strong>Focused:</strong> One topic per talk
                    </li>
                    <li>
                      <strong>Relevant:</strong> Related to current work
                    </li>
                    <li>
                      <strong>Interactive:</strong> Questions encouraged
                    </li>
                  </ul>
                </div>
                <div>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    <li>
                      <strong>Practical:</strong> Include demonstrations
                    </li>
                    <li>
                      <strong>Documented:</strong> Attendance recorded
                    </li>
                    <li>
                      <strong>Regular:</strong> Weekly or more often
                    </li>
                    <li>
                      <strong>Accessible:</strong> Plain language used
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                <strong>At the start of the shift/week:</strong> Sets safety expectations
              </li>
              <li>
                <strong>Before new activities:</strong> Prepares workers for new hazards
              </li>
              <li>
                <strong>After incidents or near misses:</strong> Shares lessons learned
              </li>
              <li>
                <strong>When hazards change:</strong> Weather, site conditions, new equipment
              </li>
              <li>
                <strong>Seasonal reminders:</strong> Heat stress in summer, ice in winter
              </li>
            </ul>

            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              <h4 className="font-semibold text-white mb-3">
                Toolbox Talk Topics for Electricians:
              </h4>
            ...
            <div className="bg-yellow-900/30 border border-yellow-600/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                Research shows that regular safety communication significantly reduces accident
                rates. Toolbox talks keep safety "front of mind" - when workers are reminded about
                hazards and controls, they're more likely to work safely.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              A <strong className="text-white">site induction</strong> is a mandatory briefing given
              to all workers before they start work on a construction site. Under the CDM
              Regulations 2015, the principal contractor must ensure all workers receive appropriate
            ...
            <div className="bg-red-900/30 border border-red-500/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                No one should undertake any work on a construction site unless they have received a
                site induction covering health and safety information. This is not optional - it is
                a legal requirement under CDM 2015.
              </p>
            </div>
            ...
            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm">
                    What dangers exist on this particular site - underground services, asbestos
                    locations, live services, overhead lines, confined spaces, etc.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">2. Emergency Procedures</p>
                  <p className="text-sm">
                    Fire alarm sounds, evacuation routes, assembly points, first aid locations and
                    first aiders, accident reporting procedures.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">3. Site Rules</p>
                  <p className="text-sm">
                    PPE requirements, smoking areas, prohibited areas, speed limits, permit
                    requirements, working hours.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">4. Welfare Facilities</p>
                  <p className="text-sm">
                    Location of toilets, rest areas, drying rooms, drinking water, canteen
                    facilities.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm">
                    Who to report to, how to report hazards, signing in/out procedures, near-miss
                    reporting.
                  </p>
                </div>
              </div>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                <strong>Company induction:</strong> General company policies (often done once at
                employment)
              </li>
              <li>
                <strong>Site induction:</strong> Site-specific information (required for EVERY new
                site)
              </li>
              <li>
                <strong>Area induction:</strong> Specific briefing for different areas of a large
                site
              </li>
              <li>
                <strong>Visitor induction:</strong> Abbreviated version for short-term visitors
              </li>
            </ul>
            ...
            <div className="bg-blue-900/30 border border-blue-500/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                Having a CSCS (Construction Skills Certification Scheme) card does not exempt you
                from site inductions. Your CSCS card confirms your qualifications and health &
                safety awareness, but every site has unique hazards that only a site-specific
                induction can cover.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              Whether delivering a toolbox talk or contributing to inductions, how you communicate
              safety information is as important as what you communicate. Poorly delivered briefings
              fail to engage workers and waste everyone's time.
            </p>
            ...
            <ul className="list-disc list-inside space-y-2 mt-2">
              <li>
                <strong>Visual:</strong> Pictures, diagrams, demonstrations, videos
              </li>
              <li>
                <strong>Auditory:</strong> Clear verbal explanations, discussions
              </li>
              <li>
                <strong>Kinesthetic:</strong> Hands-on practice, handling equipment
              </li>
              <li>
                <strong>Reading:</strong> Written materials to take away
              </li>
            </ul>
            ...
            <div className="bg-yellow-900/30 border border-yellow-600/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                Don't just tell workers what to do - explain WHY. "Wear hearing protection" is less
                effective than "Wear hearing protection because the noise levels here exceed 85 dB,
                which can cause permanent hearing damage that you won't notice until it's too late."
                Understanding the reason makes compliance more likely.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              Proper documentation of toolbox talks and inductions is essential for legal
              compliance, demonstrating due diligence, and tracking training across the workforce.
            </p>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                <strong>Legal defence:</strong> Demonstrates you provided information and training
              </li>
              <li>
                <strong>HSE inspections:</strong> Inspectors will ask to see training records
              </li>
              <li>
                <strong>Accident investigation:</strong> Shows what training the injured person
                received
              </li>
              <li>
                <strong>Gap analysis:</strong> Identifies who needs refresher training
              </li>
              <li>
                <strong>Audit trails:</strong> Required for safety management system certification
              </li>
            </ul>
            ...
            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-sm">
                <li>
                  <strong>Induction records:</strong> Keep for duration of employment + 3 years
                  minimum
                </li>
                <li>
                  <strong>Toolbox talk records:</strong> Keep for at least 3 years
                </li>
                <li>
                  <strong>Where accidents occurred:</strong> Keep related records for at least 6
                  years (statute of limitations)
                </li>
                <li>
                  <strong>Apprentices/young workers:</strong> Keep until they reach 21 + 3 years
                </li>
              </ul>
            </div>
            ...
            <div className="bg-blue-900/30 border border-blue-500/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                Either format is acceptable. Electronic systems offer easier searching, backup, and
                analysis. Paper records are often used on site initially, then digitised. Whatever
                system you use, ensure it is organised, secure, and accessible when needed.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="bg-[#282828] border border-gray-700 rounded-lg p-5">
            ...
            <div className="space-y-3 text-gray-300">
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Introduction (1 min):</strong> State the topic and why it's relevant today
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-elec-yellow font-bold">2.</span>
                <span>
                  <strong>Key Points (5-8 min):</strong> Cover 3-5 main points with examples
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-elec-yellow font-bold">3.</span>
                <span>
                  <strong>Demonstration (2-3 min):</strong> Show correct practice where applicable
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-elec-yellow font-bold">4.</span>
                <span>
                  <strong>Questions (2-3 min):</strong> Invite and answer questions
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-elec-yellow font-bold">5.</span>
                <span>
                  <strong>Summary (1 min):</strong> Recap the key takeaways
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-elec-yellow font-bold">6.</span>
                <span>
                  <strong>Sign-off:</strong> Get attendance signatures
                </span>
              </div>
            </div>
          </div>
        ...
        {/* Quiz */}
        <section className="mb-10">
          <Quiz title="Section 5.3 Knowledge Check" questions={quizQuestions} />
        </section>
