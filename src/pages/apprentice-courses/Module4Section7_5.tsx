...
const DESCRIPTION =
  'Learn effective workplace organisation and housekeeping practices. Master safe storage, waste management, and maintaining clear access routes for improved safety and productivity.';
...
const Module4Section7_5 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'The Health and Safety at Work Act places a legal duty on employers and employees to keep the workplace safe and without risks to health.',
    },
    {
      id: 10,
  ...
  const faqs = [
    {
      ...
      answer:
        'Everyone on site – not just labourers or cleaners. Good housekeeping is a shared responsibility that contributes to overall site safety and efficiency. Each trade and individual worker should maintain their work area and contribute to general site cleanliness.',
    },
    {
      question: 'Can waste be left in voids or risers if hidden?',
      answer:
        'No – this poses fire risks and breaches regulations. Waste in voids can interfere with building services, create fire hazards, and make future maintenance work dangerous. All waste must be properly disposed of in designated areas.',
    },
    {
      question: 'Do small tools need to be stored properly even if used frequently?',
      answer:
        "Yes – leaving them lying around increases trip hazards and risks of damage or theft. Frequently used tools should be kept in tool belts, pouches, or designated areas where they're secure but easily accessible.",
    },
  ];
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/80 text-sm space-y-1 list-disc ml-4">
                  ...
                  <li>
                    Legal duties under HASAWA 1974 and CDM 2015 require maintaining safe and
                    organised workspaces.
                  </li>
                  <li>
                    Proper tool storage, waste management, and 'clear as you go' practices are
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/80 text-sm space-y-1 list-disc ml-4">
                  ...
                  <li>
                    <strong>Use:</strong> Tool belts, cable stands, waste bins, designated storage
                    areas, daily tidy-up routines.
                  </li>
                  <li>
                    <strong>Check:</strong> Clear access routes, secure tool storage, proper waste
                    disposal, organised material storage.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-red-500/5 border-l-2 border-red-500/50">
                ...
                <ul className="text-white/80 text-sm space-y-2 list-disc ml-4">
                  ...
                  <li>
                    <strong>Fire hazards</strong> - flammable waste materials left near heat
                    sources, electrical equipment, or ignition points
                  </li>
                  <li>
                    <strong>Projectile risks</strong> - loose materials and tools that can fall from
                    heights or be displaced by movement
                  </li>
                  <li>
                    <strong>Access obstruction</strong> - blocked pathways preventing emergency
                    evacuation or routine movement
                  </li>
                  <li>
                    <strong>Tool and material damage</strong> - equipment left exposed to damage
                    from foot traffic, weather, or impact
                  </li>
                  <li>
                    <strong>Security risks</strong> - valuable tools and materials left unattended
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/80 text-sm space-y-2 list-disc ml-4">
                  ...
                  <li>
                    <strong>CDM Regulations 2015</strong> - require housekeeping standards to be
                    maintained throughout construction projects
                  </li>
                  <li>
                    <strong>Workplace Regulations 1992</strong> - specify requirements for workplace
                    cleanliness, lighting, and organisation
                  </li>
                  <li>
                    <strong>Management Regulations 1999</strong> - require systematic approach to
                    health and safety management including housekeeping
                  </li>
                  <li>
                    <strong>Fire Safety Order 2005</strong> - mandate keeping escape routes clear
                    and managing combustible materials
                  </li>
                  <li>
                    <strong>Employer obligations</strong> - provide adequate facilities, training,
                    and systems for maintaining workplace organisation
                  </li>
                </ul>
              </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
                ...
                <ul className="text-white/80 text-sm space-y-2 list-disc ml-4">
                  ...
                  <li>
                    <strong>Progressive clearance</strong> - clear packaging and waste as work
                    progresses, not at end of shift only
                  </li>
                  <li>
                    <strong>Route maintenance</strong> - keep walkways, access points, and fire
                    exits free from obstruction at all times
                  </li>
                  <li>
                    <strong>Cable management</strong> - coil and secure trailing leads using
                    appropriate stands, hooks, or storage systems
                  </li>
                  <li>
                    <strong>Clean as you go</strong> - maintain cleanliness throughout work
                    activities, not just during designated clean-up periods
                  </li>
                  <li>
                    <strong>Daily inspection</strong> - conduct end-of-shift checks to identify and
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-white/70 text-sm list-disc ml-4 space-y-1">
                  ...
                  <li>
                    <strong>Set in order:</strong> Organise remaining items logically
                  </li>
                  <li>
                    <strong>Shine:</strong> Clean and maintain the work area
                  </li>
                  <li>
                    <strong>Standardise:</strong> Establish consistent procedures
                  </li>
                  <li>
                    <strong>Sustain:</strong> Maintain standards through regular review
                  </li>
                </ul>
              </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
                ...
                <ul className="text-white/80 text-sm space-y-2 list-disc ml-4">
                  ...
                  <li>
                    <strong>Cable reel management</strong> - label reels clearly and store off the
                    floor using stands or designated areas
                  </li>
                  <li>
                    <strong>Ergonomic storage</strong> - keep heavy items at waist level to reduce
                    manual handling injury risk
                  </li>
                  <li>
                    <strong>Environmental protection</strong> - protect materials from weather,
                    contamination, and physical damage
                  </li>
                  <li>
                    <strong>Inventory control</strong> - maintain accurate records of tool and
                    material locations and condition
                  </li>
                  <li>
                    <strong>Security measures</strong> - secure valuable items in lockable storage
                    or supervised areas
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-white/70 text-sm list-disc ml-4 space-y-1">
                  ...
                  <li>
                    <strong>Regular use tools:</strong> Secure vehicle storage or site toolbox
                  </li>
                  <li>
                    <strong>Occasional use tools:</strong> Lockable site storage with check-out
                    system
                  </li>
                  <li>
                    <strong>Specialist equipment:</strong> Controlled storage with training records
                  </li>
                </ul>
              </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
                ...
                <ul className="text-white/80 text-sm space-y-2 list-disc ml-4">
                  ...
                  <li>
                    <strong>Designated disposal</strong> - use provided skips and bins, avoid
                    accumulating waste near work areas
                  </li>
                  <li>
                    <strong>Hazardous waste management</strong> - follow special procedures for
                    contaminated or dangerous materials
                  </li>
                  <li>
                    <strong>Facility monitoring</strong> - report overflowing or inadequate waste
                    facilities to supervisors immediately
                  </li>
                  <li>
                    <strong>Documentation</strong> - maintain records for hazardous waste disposal
                    and recycling activities
                  </li>
                  <li>
                    <strong>Environmental responsibility</strong> - minimise waste generation and
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-white/70 text-sm list-disc ml-4 space-y-1">
                  ...
                  <li>
                    <strong>Plastic waste:</strong> Cable insulation, conduit, trunking, and plastic
                    accessories
                  </li>
                  <li>
                    <strong>Packaging:</strong> Cardboard, plastic wrapping, and protective
                    materials
                  </li>
                  <li>
                    <strong>Hazardous waste:</strong> Contaminated materials, batteries, and
                    fluorescent tubes
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  procedures and seek guidance when uncertain.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-white/70 text-sm space-y-1 list-disc ml-5">
                  ...
                  <li>
                    Keep a small brush and pan for quickly clearing debris from confined workspaces
                  </li>
                  <li>
                    At the end of every shift, spend 5 minutes checking the area for potential
                    hazards
                  </li>
                  <li>
                    Report housekeeping issues immediately rather than allowing problems to
                    accumulate
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-white/70 text-sm space-y-1 list-disc ml-5">
                  ...
                  <li>
                    Coil and hang extension leads when not in use to prevent trip hazards and cable
                    damage
                  </li>
