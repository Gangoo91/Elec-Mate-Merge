...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1500 rev/min', '500 rev/min', '1000 rev/min', '750 rev/min'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Understanding synchronous motors, generators, and their critical role in building services
          power systems
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Any synchronous alternator on a BSE site that may parallel with the DNO (CHP, standby
              that runs across the changeover, embedded PV with a synchronous interface) is in scope
              of G99. As BSE designer you specify the protection relay (G99-compliant LoM, RoCoF,
              U/V, U/F, vector shift) and submit the connection application to the DNO. Failing to
              comply risks islanding hazards to DNO staff during supply outages and disconnection by
              the DNO if discovered.
            </>
          }
        ...
        <ConceptBlock title="In 30 seconds">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Synchronous speed:</strong> ns = 120f/p (no slip)
            </li>
            <li>
              <strong>Excitation control:</strong> Adjusts power factor
            </li>
            <li>
              <strong>Synchronous condensers:</strong> Large-scale PF correction
            </li>
            <li>
              <strong>PMSMs:</strong> High-efficiency VSD applications
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Building Services Context</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Standby generators:</strong> Emergency power supply
            </li>
            <li>
              <strong>PF correction:</strong> Large commercial/industrial sites
            </li>
            <li>
              <strong>PMSM drives:</strong> Chillers, fans, pumps
            </li>
            <li>
              <strong>Grid paralleling:</strong> CHP and renewable integration
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Synchronous Speed">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">The Synchronous Speed Formula</p>
          <p>
            <strong>
              n<sub>s</sub> = 120f / p
            </strong>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2</strong> — 3000 rev/min — High-speed turbine generators
            </li>
            <li>
              <strong>4</strong> — 1500 rev/min — Standard generators, large motors
            </li>
            <li>
              <strong>6</strong> — 1000 rev/min — Medium-speed applications
            </li>
            <li>
              <strong>8</strong> — 750 rev/min — Direct-drive applications
            </li>
            <li>
              <strong>12</strong> — 500 rev/min — Low-speed hydro generators
            </li>
          </ul>
        ...
        <ConceptBlock title="Synchronous Motor Construction">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Rotor Construction Comparison</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Construction</strong> — Projecting poles — Distributed winding in slots
            </li>
            <li>
              <strong>Speed range</strong> — Low to medium — High speed
            </li>
            <li>
              <strong>Pole number</strong> — 4 to many — Usually 2 or 4
            </li>
            <li>
              <strong>Typical use</strong> — Hydro, diesel generators — Turbo-generators
            </li>
          </ul>

          <p className="text-sm font-medium text-white">Starting Methods</p>
          <p>
            Synchronous motors cannot self-start because the rotating field reverses too quickly for
            the rotor inertia. Common starting methods include:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Damper winding start:</strong> Acts as induction motor cage during start-up
            </li>
            <li>
            ...
            <li>
              <strong>Reduced voltage:</strong> Star-delta or soft starter reduces starting current
            </li>
          </ul>

          <p>
            <strong>Excitation requirement:</strong> DC field current is typically 1-5% of the rated
            stator current, supplied via slip rings or brushless exciter.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Excitation and Power Factor Control">
          <p>
            ...
            adjusting the DC field excitation. This makes them valuable for power factor correction
            as well as providing mechanical drive.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Under-excited</strong> — Lagging — Current lags voltage — Inductive (like a
              coil)
            </li>
            <li>
              <strong>Normal excitation</strong> — Unity (1.0) — Current in phase with voltage —
              Resistive
            </li>
            <li>
              <strong>Over-excited</strong> — Leading — Current leads voltage — Capacitive
            </li>
          </ul>
       ...
       |________________|________________
         ...
         Under-excited  |  Over-excited`}
          ...
          <p className="text-xs text-white mt-2">
            Each curve represents a different mechanical load. Higher loads shift the entire curve
            upward.
          </p>
          ...
          <p>
            <strong>Operating point:</strong> Running slightly over-excited (0.95 leading) provides
            a safety margin whilst contributing to site power factor correction.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Synchronous Condensers for Power Factor Correction">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Control</strong> — Continuously variable — Stepped (switched banks)
            </li>
            <li>
              <strong>VAr direction</strong> — Generate or absorb — Generate only
            </li>
            <li>
              <strong>Harmonics</strong> — None generated — Can amplify harmonics
            </li>
            <li>
              <strong>Response time</strong> — Seconds — Milliseconds (thyristor-switched)
            </li>
            <li>
              <strong>Cost</strong> — High capital, low running — Lower capital, minimal running
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Grid stability:</strong> Providing inertia as rotating generation decreases
            </li>
            <li>
        ...
        <ConceptBlock title="Permanent Magnet Synchronous Motors (PMSMs)">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">PMSM Rotor Configurations</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Surface-mounted (SPM)</strong> — On rotor surface — Simple, good torque, speed
              limited
            </li>
            <li>
              <strong>Interior (IPM)</strong> — Buried in rotor — Higher speed, field weakening
              possible
            </li>
            <li>
              <strong>Spoke type</strong> — Radially arranged — Flux concentration, ferrite magnets
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Standard induction (11kW)</strong> — 89-91% — IE2-IE3
            </li>
            <li>
              <strong>Premium induction (11kW)</strong> — 91-93% — IE3-IE4
            </li>
            <li>
              <strong>PMSM (11kW)</strong> — 94-96% — IE4-IE5
            </li>
          </ul>
          ...
          <p>
            <strong>ErP Directive:</strong> EU regulations increasingly mandate IE4+ efficiency for
            motors, driving PMSM adoption in new building services installations.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Hunting and Damper Windings">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Damper (Amortisseur) Windings</p>
          <p>
            Damper windings are short-circuited copper or aluminium bars embedded in the rotor pole
            faces, similar to a squirrel cage.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Excitation control:</strong> Fast-acting AVR reduces electrical disturbances
            </li>
            <li>
        ...
        <ConceptBlock title="Synchronous Generators (Alternators)">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Generator Output Equations</p>
          ...
          <p>
            <strong>Three-phase power:</strong> P = sqrt(3) x V<sub>L</sub> x I<sub>L</sub> x cos
            phi Watts
          </p>

          <p className="text-xs text-white mt-2">
            Where: p = poles, n = speed (rev/min), N = turns, phi = flux, k<sub>w</sub> = winding
            factor
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Generator Voltage Regulation</p>
          <p>
            Terminal voltage varies with load due to armature reaction and internal impedance. The
            Automatic Voltage Regulator (AVR) adjusts field current to maintain constant voltage.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lagging (inductive)</strong> — Voltage drops significantly — Increase
              excitation
            </li>
            <li>
              <strong>Unity</strong> — Moderate voltage drop — Moderate increase
            </li>
            <li>
              <strong>Leading (capacitive)</strong> — Voltage may rise — Decrease excitation
            </li>
          </ul>
        ...
        <ConceptBlock title="Building Services Applications">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Standby Generator Systems</p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Emergency lighting</strong> — 50-200 kVA — &lt;15 seconds — BS 5266
            </li>
            <li>
              <strong>Hospital essential</strong> — 500-2000 kVA — &lt;15 seconds — HTM 06-01
            </li>
            <li>
              <strong>Data centre Tier III</strong> — 1000-3000 kVA — &lt;10 seconds — Uptime
              Institute
            </li>
            <li>
              <strong>Fire pump</strong> — 100-500 kVA — &lt;10 seconds — BS EN 12845
            </li>
          </ul>
          ...
          <p>When paralleling generators with each other or the grid, the following must match:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Combined Heat and Power (CHP)</p>
          <p>Synchronous generators in CHP systems can export power to the grid, requiring:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            ...
            (Low voltage generating sets) including earth fault loop impedance verification and RCD
            coordination.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A standby generator has 4 poles and must produce 50Hz. What
            speed must the diesel engine maintain?
          </p>
          ...
          <p>The engine governor must maintain 1500 +/-0.5% for frequency stability</p>

          <p className="text-sm font-medium text-elec-yellow/80">
            Example 2: Generator Sizing for Building Load
          </p>
          <p>
            <strong>Question:</strong> A hospital has 800kW essential load at 0.85 pf lagging. Size
          ...
          <p>
            <strong>Question:</strong> A factory has 500kW load at 0.75 pf. Calculate kVAr required
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Example 4: PMSM Energy Savings</p>
          <p>
        ...
        <Scenario
          ...
          situation={
            <>
              A hospital essential supply has a 1100 kVA diesel-driven synchronous alternator on a
              30-second AMF (automatic mains failure) changeover. A proposed upgrade adds a 5 second
              &ldquo;test in synchronism&rdquo; routine that briefly parallels generator and DNO
              during weekly testing. This brings the installation into G99 scope.
            </>
          }
          whatToDo={
            <>
              Install a G99-compliant generator interface protection panel: under-/ over-voltage
              relay (BS EN 60255), under-/over-frequency relay, rate-of-change-of-frequency (RoCoF)
              relay, vector-shift relay, and loss-of-mains protection. Submit the G99 connection
              application to the DNO with the protection settings, witness-test the interlocks
              before the first parallel run, and update the installation&rsquo;s O&amp;M manuals.
              Operate parallel only within DNO-agreed periods.
            </>
          }
          whyItMatters={
            <>
              Uncontrolled paralleling of a building generator with the DNO can back-feed an outage
              and electrocute DNO staff working on what they believe is dead network. G99 protection
              (or G98 for &le; 16 A single-phase / 16 A per phase 3-phase generators) is
              non-negotiable. The HNC engineer&rsquo;s sign-off on the protection scheme is the
