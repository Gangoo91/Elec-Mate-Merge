      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Visual:</strong> Trained eye detects overheating, damage, moisture, vermin
              </li>
              <li className="pl-1">
                <strong>Thermal:</strong> IR cameras reveal hot spots in connections and busbars
              </li>
              <li className="pl-1">
                <strong>Insulation:</strong> Megger testing with trending reveals degradation
              </li>
              <li className="pl-1">
                <strong>Statutory:</strong> Emergency lighting and fire alarm test schedules
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Distribution Board Visual Checklist
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Burning smell — acrid odour indicates arcing or overheating
                </li>
                <li className="pl-1">Water damage — staining, drips, condensation</li>
                <li className="pl-1">
                  Vermin evidence — droppings, nesting material, gnawed cables
                </li>
                <li className="pl-1">
                  Cable entries — glands tight, bushing intact, no gaps in IP rating
                </li>
                <li className="pl-1">
                  Labelling — circuit schedule complete, accurate and legible
                </li>
                <li className="pl-1">Clearance — adequate working space maintained per BS 7671</li>
                <li className="pl-1">
                  Ventilation — air paths clear, fans operational, filters clean
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Terminal box — cover secure, glands tight, connections not discoloured
                </li>
                <li className="pl-1">
                  Bearing area — no grease leakage, no unusual noise or vibration
                </li>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Record what you find, not just what you check. A checklist
              entry of "distribution board inspected — satisfactory" has far less value than "DB-03
              inspected — minor dust accumulation on busbars, all connections appear tight, no
              discolouration, IP rating intact. Recommend cleaning at next shutdown."
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Thermographic Survey Severity Classification
              </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Monitor — re-check at next scheduled survey
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Plan repair — schedule within next maintenance window
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Urgent repair — schedule as soon as possible, monitor closely
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Immediate action — may require emergency shutdown
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                Thermographic surveys must be carried out while equipment is energised and under
                load — an unloaded connection will not generate heat even if it is loose. Surveys
                should be conducted at the same time of day and similar load conditions each time to
                allow meaningful comparison. The emissivity setting on the camera must be correct
                for the material being measured (bare copper = ~0.07, oxidised copper = ~0.65,
                painted surface = ~0.95).
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Trending Best Practice
                </h3>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">
                    Test at the same temperature (or apply correction factors)
                  </li>
                  <li className="pl-1">
                    Test at the same time of year to minimise humidity variation
                  </li>
                  <li className="pl-1">
                    Record all readings in CMMS with date, temperature and conditions
                  </li>
                  <li className="pl-1">Plot readings graphically over time</li>
                  <li className="pl-1">
                    A 50% drop from the previous reading warrants investigation
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    Disconnect sensitive electronic equipment (VSD, PLC, etc.)
                  </li>
                  <li className="pl-1">
                    Discharge capacitance after testing — cables and motors store charge
                  </li>
                  <li className="pl-1">
                    Warning signs displayed: "Insulation testing in progress"
                  </li>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Fire Alarm Test Schedule (BS 5839-1)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Annually</td>
                      <td className="border border-white/10 px-3 py-2">
                        Full service — all detectors functionally tested, batteries checked, cause
                        and effect verified
                      </td>
                    </tr>
                  </tbody>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> All test results must be recorded in a log book kept on
              the premises (or in the CMMS). The fire authority can inspect these records at any
              time. Failure to maintain adequate records is a breach of the RRO 2005 and can result
