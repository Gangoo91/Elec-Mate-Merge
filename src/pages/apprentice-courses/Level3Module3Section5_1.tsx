...
const DESCRIPTION =
  'Master P = VI, P = I squared R, P = V squared / R power equations and their practical applications for City & Guilds Level 3.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'P = I squared x R = 20 squared x 0.5 = 400 x 0.5 = 200 W. This represents cable losses.',
  },
  {
    id: 'qc3',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'P = I squared x R is most useful for cable losses because you typically know the current and cable resistance, and want to find the power wasted as heat.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 'Watts',
    explanation:
      'P = VI gives power in watts when V is in volts and I is in amperes. For kW, divide by 1000.',
  },
  {
    id: 'q2',
    ...
    explanation:
      'R = V squared / P = 230 squared / 3000 = 52900 / 3000 = 17.6 ohms. Rearranging P = V squared / R.',
  },
  {
    id: 'q3',
    ...
    explanation:
      'P = I squared x R, so if I doubles, P increases by 2 squared = 4 times. Power is proportional to current squared.',
  },
  {
    id: 'q4',
  ...
  },
  {
    ...
    explanation:
      'P = V x I x pf = 230 x 15 x 0.8 = 2760 W. For AC circuits with reactive loads, include power factor.',
  },
  {
    id: 'q7',
    ...
    options: [
      'Voltage is unknown',
      'Current is constant along the cable',
      'Resistance varies with temperature',
      'It gives the highest value',
    ],
    correctAnswer: 'Current is constant along the cable',
    explanation:
      'In a series circuit, current is the same throughout. Cable resistance is known, so P = I squared x R directly gives power loss.',
  },
  {
    id: 'q8',
  ...
  },
  {
    ...
    explanation:
      'P = V squared / R. If V halves, P = (V/2) squared / R = V squared / 4R = P / 4. Power quarters.',
  },
  {
    id: 'q10',
    ...
    options: [
      'P = 3 x V x I',
      'P = sqrt(3) x V_L x I_L x pf',
      'P = V x I x pf',
      'P = 3 x V x I x pf',
    ],
    correctAnswer: 'P = sqrt(3) x V_L x I_L x pf',
    explanation:
      'Three-phase power uses the factor sqrt(3) = 1.732 with line voltage and line current: P = sqrt(3) x V_L x I_L x cos(phi).',
  },
  {
    id: 'q11',
  ...
  },
  {
    ...
    explanation:
      'I squared R losses cause conductor heating (affecting insulation life) and voltage drop along the cable length, both critical design considerations.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Power is the rate of energy transfer, measured in watts (joules per second). Energy = Power x Time. A 1000 W heater running for 1 hour uses 1000 Wh = 1 kWh of energy. Electricity meters measure energy consumption in kWh. The formula E = Pt links power (watts), time (seconds), and energy (joules).',
  },
  {
    question: 'How do I calculate the resistance of a heating element?',
    answer:
      'Use R = V squared / P or R = P / I squared. For a 3 kW heater at 230 V: R = 230 squared / 3000 = 17.6 ohms. This resistance value is used for cable sizing calculations and understanding the load characteristics. Note that element resistance increases when hot due to positive temperature coefficient.',
  },
];
              ...
              <div>
                ...
                <ul className="space-y-2 text-white">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Apply the three forms of the power equation to solve practical problems
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 shrink-0" />
                    <span>
                      Calculate power dissipation in cables, resistors and heating elements
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 shrink-0" />
                    <span>
                      Understand the significance of I squared R losses in electrical installations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 shrink-0" />
        ...
        <div className="prose prose-invert max-w-none">
            ...
            <Card className="bg-white/5 border-white/10 my-6">
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold text-white mb-4">
                  Understanding I squared R Losses
                </h3>
                ...
                <div className="p-4 bg-white/5 rounded-lg">
                  ...
                  <ul className="text-white text-sm space-y-2">
                    ...
                    <li>
                      <strong>Voltage drop:</strong> Lost power means voltage drop along the cable
                      (V = IR)
                    </li>
                    <li>
                      <strong>Efficiency:</strong> Power lost in cables is not delivered to the load
                    </li>
                    <li>
                      <strong>Cable sizing:</strong> Larger cables have lower R, reducing losses
                    </li>
                  </ul>
                </div>
              </CardContent>
          ...
          <section className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold text-white m-0">
                Heating Elements: P = V squared / R
              </h2>
            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="p-4 bg-white/5 rounded-lg">
                        ...
                        <ul className="text-sm text-white space-y-1">
                          ...
                          <li>
                            <strong>P = I squared R:</strong> Cable losses, voltage drop
                          </li>
                          <li>
                            <strong>P = V squared / R:</strong> Heating element sizing
                          </li>
                          <li>
                            <strong>Include pf:</strong> Motors, transformers, electronics
                          </li>
                        </ul>
                      </div>
                      <div className="p-4 bg-white/5 rounded-lg">
