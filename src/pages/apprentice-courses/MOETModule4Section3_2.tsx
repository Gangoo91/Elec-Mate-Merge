...
const DESCRIPTION =
  'Structured fault-finding methodology including half-split, input-to-output, six-point and function testing techniques for electrical maintenance technicians.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'At the supply end, working through each device in turn',
      'At the load end, working back towards the supply',
      'At the component most likely to have failed based on experience',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Isolate, lock off, prove dead, repair, re-test, return to service',
      'Inspect, test dead, test live, record results, certify, hand over',
      'Identify symptom, replace component, test, repeat until the fault clears',
  ...
  },
  {
    ...
    options: [
      'Start replacing components one at a time until the fault clears',
      'Return the equipment to service, as the original fault may have cleared itself',
      'Return to the evidence, review your analysis, and form a new hypothesis based on the test results',
      'Repeat the same test several more times to be certain of the result',
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'It removes the need for any test instruments during fault finding',
      'It minimises diagnostic time by eliminating possible causes logically rather than randomly',
      'It guarantees the fault is found on the very first test every time',
      'It avoids the need to understand how the circuit actually works',
    ],
    correctAnswer: 1,
    explanation:
      'A systematic approach uses logic and evidence to eliminate possible causes efficiently. Trial-and-error is random and can be extremely time-consuming, especially in complex systems where there are hundreds of potential fault locations.',
  },
  {
    id: 2,
    question:
  ...
  },
  {
    ...
    options: [
      'The supply to the control circuit has failed upstream of the contactor coil',
      'The main contactor contacts have welded closed, energising the motor continuously',
      'The motor overload relay has tripped on the load side of the contactor',
  ...
  },
  {
    ...
    options: [
      'The supply isolator, since voltage was only proved at its output and not at its input terminals',
      'The control circuit between the fuses and the contactor coil — typically a control switch, interlock or overload contact',
      'The motor windings, which must be open-circuit to prevent the coil from energising',
      'The contactor main contacts, which have failed to close and broken the control supply',
    ],
    correctAnswer: 1,
    explanation:
      'Following the signal flow: supply is confirmed at the isolator and fuse outputs, but is lost before reaching the contactor coil A1. The fault lies in the control circuit between these two points. This section typically contains start/stop buttons, interlock contacts, overload relay contacts, and emergency stop devices — any of which could be open-circuit.',
  },
  {
    id: 6,
    question:
    ...
    options: [
      'Testing each of the 40 inputs and outputs in turn from the first terminal to the last until the fault appears',
      'Replacing the PLC processor module first, as it is the most likely single point of failure in the system',
  ...
  },
  {
    ...
    options: [
      'Record the fault in the maintenance log and return the equipment to service without further testing',
      'Replace any components that are near the end of their service life while the equipment is accessible',
      'Confirm only that the specific component you replaced now functions, ignoring the wider system',
  ...
  },
  {
    ...
    options: [
      ...
      'A single open-circuit phase causing the motor to single-phase',
      'The supply frequency being set too high at the variable speed drive',
      'An earth fault on one of the motor winding connections',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'At the start button, as the first device in the control circuit sequence',
      'At the contactor coil, working backwards towards the supply from there',
      'At the supply terminal, to confirm voltage is present before testing any device',
  ...
  },
  {
    ...
    options: [
      ...
      'Only the final repair carried out, since the intermediate tests are not relevant once the fault is fixed',
      'Just the name of the component replaced and the date, with no record of the diagnostic steps',
      'A list of every component in the circuit, whether or not it was tested during the diagnosis',
    ],
    correctAnswer: 0,
    explanation:
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              initial symptom through to a confirmed repair, ensuring nothing is missed and the root
              cause is addressed. This technique is explicitly referenced in electrical engineering
              training standards including the ST1426 Maintenance and Operations Engineering
              Technician pathway, and you should be able to describe and apply all six stages.
            </p>
            <p>
              Unlike ad-hoc or trial-and-error methods, the six-point technique forces discipline at
              every stage. It prevents the common pitfall of jumping to conclusions, where a
              technician assumes the cause based on past experience without verifying it for the
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              principle: by testing at the midpoint of a circuit, you immediately eliminate half of
              the possible fault locations. Repeating this process on the remaining half, and then
              again on the quarter, you can locate a fault in a circuit with hundreds of components
              in remarkably few tests.
            </p>
            <p>
              Consider a series control circuit with 16 devices — start button, stop button,
              interlocks, overload contacts, auxiliary contacts, emergency stops and the contactor
              coil. Testing every device sequentially from the start could require up to 16 tests.
              Using half-split, you test at the midpoint (device 8). If the signal is present, the
              fault is in devices 9 to 16. Test at device 12 (midpoint of the remaining half).
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              final output or load. At each stage, you verify that the expected signal is present
              and correct. When you reach a point where the signal is lost or corrupted, you have
              located the fault.
            </p>
            <p>
              This method is particularly effective for circuits with a clear sequential flow — such
              as motor starter control circuits, process control loops, and communication systems.
              It mirrors the way the circuit actually works, making it intuitive to follow. However,
            ...
            <p>
              ...
              suspect the fault is near the load end of the circuit. For example, if a motor is not
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              for sequential control systems, automated processes and interlocked systems where the
              failure manifests as the sequence stopping at a specific point. By identifying where
              the sequence halts, you immediately narrow the fault to the device or condition
              required to advance to the next stage.
            </p>
            <p>
              For example, consider a conveyor system that should start when a start button is
              pressed, provided all interlocks are satisfied. If pressing the start button does not
              energise the contactor, function testing involves checking each interlock in turn:
              guard switch, emergency stop, level sensor, temperature switch. The first interlock
              that is not in its correct state is the likely cause of the failure. Many modern
