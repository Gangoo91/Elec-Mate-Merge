      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>DC flows in one direction</strong> — from negative to positive
                (conventional: positive to negative)
              </li>
              <li className="pl-1">
                <strong>Batteries</strong> — series increases voltage, parallel increases capacity
              </li>
              <li className="pl-1">
                <strong>Rectification</strong> — converts AC to DC via half-wave or full-wave bridge
                circuits
              </li>
              <li className="pl-1">
                <strong>Applications</strong> — battery systems, UPS, solar PV, EV charging, data
                centres
              </li>
            </ul>
          </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Thermocouples:</strong> Generate a small DC voltage from the junction of
                  two dissimilar metals at different temperatures — used extensively in temperature
                  measurement
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Common Battery Types in Maintenance
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Lead-acid (flooded):</strong> Cell voltage 2.0 V. Used in UPS systems,
                  standby power and emergency lighting. Requires electrolyte level checking,
                  specific gravity testing and terminal cleaning. Produces hydrogen gas during
                  charging — ventilation essential
                </li>
                <li className="pl-1">
                  <strong>Lead-acid (VRLA/sealed):</strong> Cell voltage 2.0 V. Valve-regulated,
                  maintenance-reduced (not maintenance-free). Used in UPS, telecommunications and
                  fire alarm panels. No electrolyte topping-up but still requires temperature
                  monitoring and impedance testing
                </li>
                <li className="pl-1">
                  <strong>Lithium-ion (Li-ion):</strong> Cell voltage 3.6-3.7 V. High energy
                  density, low self-discharge. Used in portable tools, EV charging infrastructure
                  and battery energy storage systems (BESS). Requires battery management systems
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Short circuit:</strong> Batteries deliver massive fault currents — a
                  spanner across lead-acid terminals can weld itself and cause explosive arcing
                </li>
                <li className="pl-1">
                  <strong>Hydrogen gas:</strong> Lead-acid batteries produce hydrogen during
                  charging — explosive concentration reached at 4% in air. Adequate ventilation and
                  no ignition sources required
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  overcharged, physically damaged or operated above temperature limits — resulting
                  in fire and toxic gas emission
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  ...
                  half-cycle passes; the negative half-cycle is blocked. Simple but inefficient —
                  50% of the input waveform is wasted. Ripple frequency equals the supply frequency
                  (50 Hz). Average DC output = 0.318 x V_peak
                </li>
                <li className="pl-1">
                  <strong>Full-wave centre-tap:</strong> Uses two diodes and a centre-tapped
                  transformer. Both half-cycles are utilised, doubling the output frequency to 100
                  Hz. Requires a special transformer with a centre-tap — less common in modern
                  circuits
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  ...
                  Acceptable ripple depends on the application — typically less than 1% for
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              <p className="text-sm font-medium text-red-400 mb-2">
                Maintenance Warning — Capacitor Safety
              </p>
              <p className="text-sm text-white">
                ...
                capacitor in a VSD can store sufficient energy to cause a fatal shock. Always follow
                the manufacturer's specified discharge time before working inside equipment. Verify
                with a suitable voltage indicator that the capacitors have discharged to a safe
                level. Never rely on bleeder resistors alone — they can fail open-circuit.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Fault-finding tip:</strong> A common failure in power supplies is a dried-out
              or failed smoothing capacitor. Symptoms include excessive ripple on the DC output,
              audible hum from connected equipment, flickering LED drivers and intermittent
              operation of sensitive electronics. An oscilloscope or a multimeter with AC
              measurement on the DC output can confirm excessive ripple.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Shunt-wound:</strong> Field winding connected in parallel with the
                  armature. Provides relatively constant speed under varying load — good for machine
                  tools, conveyors and pumps. Speed controlled by field current or armature voltage
                </li>
                <li className="pl-1">
                  <strong>Series-wound:</strong> Field winding in series with the armature. Very
                  high starting torque — ideal for cranes, hoists, traction motors and starter
                  motors. Speed varies greatly with load; must never be run unloaded (can reach
                  dangerously high speeds)
                </li>
                <li className="pl-1">
                  <strong>Compound-wound:</strong> Combines series and shunt field windings.
                  Provides a compromise between the constant speed of shunt motors and the high
                  starting torque of series motors. Used in rolling mills, presses and elevators
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                DC Testing and Measurement
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Polarity verification:</strong> Use a multimeter on DC volts range.
                  Positive reading = correct polarity; negative reading = reversed. Essential before
                  connecting any polarity-sensitive equipment
                </li>
                <li className="pl-1">
                  <strong>Battery voltage (open circuit):</strong> Measure across terminals with no
                  load connected. Compare to the nominal voltage. A fully charged lead-acid cell
                  reads approximately 2.1 V; fully discharged approximately 1.75 V
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Ripple measurement:</strong> Set multimeter to AC volts and measure across
                  a DC supply. The AC reading represents the ripple component. Alternatively, use an
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                DC Distribution in Industry
              </p>
              <p className="text-sm text-white mb-3">
                DC distribution is experiencing a renaissance driven by the proliferation of
                DC-native loads and generation sources. Key applications include:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  system for decades. The negative polarity minimises electrolytic corrosion on
                  copper conductors
                </li>
                <li className="pl-1">
