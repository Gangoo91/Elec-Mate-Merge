    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Understand heating system design and the electrical services that support modern heating
          installations
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers heating systems from an electrical services perspective. You'll learn
          about boiler systems, heat pump integration, underfloor heating, radiator circuits and the
          control systems that optimise heating system performance and energy efficiency.
        </p>
