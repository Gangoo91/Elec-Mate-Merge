    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Every candidate feels nervous walking into AM2 - it's the industry's benchmark test and
          there's pressure to pass first time. NET assessors know this and expect you to feel under
          stress. What they are measuring is not whether you look calm, but whether you can still
        ...
        <ConceptBlock title="Managing Nerves is Essential for AM2 Success">
          <p>
            <strong className="text-red-300">Critical.</strong> If nerves make you rush, skip safety
            procedures, or forget critical steps, marks are lost instantly. Safety-critical errors
            due to panic result in automatic failure. Assessors expect you to work safely and
            methodically under pressure — this is a core competency being tested in AM2.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Why Nerves Matter">
          ...
          <p>
            ...
            steady, professional behaviour. Being slightly slow but safe still earns marks; rushing
            and unsafe = instant fail.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Strategies to Reduce Nerves Before Exam">
          ...
          <p>
            <strong>1. Preparation Builds Confidence.</strong> Practise safe isolation daily and run
            through testing procedures until they feel automatic. The more natural the task feels,
            the less nerves will interfere.
          </p>
          <p>
        ...
        <ConceptBlock title="Techniques During Exam">
          ...
          <p>
            ...
            back for 10 seconds, inhale slowly through your nose, exhale slowly through your mouth.
            This resets your focus. 4-7-8 Technique: Inhale for 4, hold for 7, exhale for 8.
          </p>
          <p>
            <strong className="text-green-400">Break Tasks into Chunks.</strong> Instead of thinking
            about an 8.5-hour install, focus on the next step: mark out, containment, wiring,
            terminations. One section at a time reduces overwhelm.
          </p>
          <p>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Record Results.</strong> Write down test results as you go so you don't forget
              under pressure.
            </li>
            <li>
        ...
        <ConceptBlock title="Real-World Examples">
          ...
          <p>
            <strong className="text-red-400">Example 1.</strong> Candidate skipped re-proving tester
            in safe isolation due to nerves — instant fail.
          </p>
          <p>
          ...
          <p>
            ...
            deadline pressure maintained safety standards despite client pressure. Same approach in
            AM2 = success.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Frequently Asked Questions">
          ...
          <p>
            <strong>Q2: What if I forget steps in testing because of panic?</strong> Pause, breathe,
            reset. Assessors prefer slow but correct over rushed and wrong.
          </p>
          <p>
        ...
        <ConceptBlock title="Summary">
          <p>Nerves are normal in AM2, but you must control them. NET wants to see that you can:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-green-400/70">
        ...
        <Scenario
          ...
          situation={
            <>
              Section C. The assessor stops talking and gestures at the rig. You pick up the tester
              and your hands have started shaking. You can feel everyone watching. Your mind has
              gone blank on which conductor combination to test first.
            </>
          }
          whatToDo={
            <>
              Stop. Take a breath. Put the tester down for ten seconds. Say to yourself out loud:
              "prove the tester first". Pick up the proving unit. The procedure takes over once you
              start it. Assessors don’t fail you for visible nerves — they fail you for skipping
              steps. Slow is fine. Frozen is fine for ten seconds. Skipping a prove is not.
            </>
          }
          whyItMatters={
            <>
