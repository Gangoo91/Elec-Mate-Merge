          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                current-carrying capacity after correction factors.
              </p>
            </div>
            ...
            <p>
              These ratings assume a 30&deg;C ambient temperature, a single circuit (not grouped
              with others), and no thermal insulation surrounding the cable. If any of these
              conditions differ, you must apply correction factors to determine the true effective
              capacity.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              current ratings for the same cable size. The more enclosed the cable, the lower its
              rating.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="font-medium text-green-400 mb-2">
                Comparison: 2.5mm&sup2; T&amp;E by Method
              </h4>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                restrictive section determines the method unless it is less than 0.5m.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              If cooler, the rating can be slightly increased. Table 4B1 provides the Ca values.
            </p>

            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="font-medium text-green-400 mb-3">
                Table 4B1 &mdash; Ca Values (PVC Insulation)
              </h4>
              <div className="space-y-1 text-sm">
                <div className="flex justify-between border-b border-white/10 pb-1">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-1 text-sm text-white/80">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Any additional derating (grouping etc.) would push it below &mdash; consider
                    10.0mm&sup2;
                  </span>
                </li>
              </ul>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              circuits grouped together, the lower the factor and the less current each cable can
              carry safely.
            </p>

            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="font-medium text-green-400 mb-3">
                Table 4C1 &mdash; Cg Values (Bunched or Enclosed)
              </h4>
              <div className="space-y-1 text-sm">
                <div className="flex justify-between border-b border-white/10 pb-1">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-1 text-sm text-white/80">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    If these are 20A MCB circuits, 18.9A &lt; 20A &mdash;{' '}
                    <strong className="text-white">the cable fails</strong>
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Upgrade to 4.0mm&sup2; (36 &times; 0.70 = 25.2A &ge; 20A) &mdash; pass
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                cable diameter apart can sometimes allow a more favourable Cg value.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              is often the limiting factor for cable sizing, especially on longer runs.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-1 text-sm text-white/80">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    6.96V &gt; 6.9V &mdash; <strong className="text-white">fails by 0.06V!</strong>
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Solution: upgrade to 2.5mm&sup2;. VD = 18 &times; 8 &times; 30 / 1000 = 4.32V
                    &mdash; pass
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <span className="text-green-400 font-mono text-xs bg-green-500/15 px-2 py-0.5 rounded-full flex-shrink-0 mt-0.5">
                    1
                  </span>
                  <div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-sm text-white/80">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Installation method determines the base current rating from BS 7671 tables
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Correction factors Ca, Cg and Ci always reduce the effective cable rating
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Voltage drop must be checked separately and can force a larger cable on long
                    runs
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Good cable routing that avoids insulation and grouping saves money and
                    complexity
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    When in doubt, go up one cable size &mdash; the small extra cost provides a
