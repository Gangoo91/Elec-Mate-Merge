...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['8000K to 10000K', '1000K to 2000K', '2700K to 6500K', 'Fixed at 4000K'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="Scene Controllers and Preset Configurations">
          ...
          <p>
            <strong>Key scene controller components:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Scene memory:</strong> Stored values in drivers (DALI) or central controller
            </li>
            <li>
              <strong>Fade time settings:</strong> Transition speed from current to recalled state
            </li>
          </ul>
          <p>
            <strong>Typical Scene Configurations by Space Type</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Boardroom:</strong> Meeting (80%) — Presentation (30%) — Video call (60%) —
              All off
            </li>
            <li>
              <strong>Restaurant:</strong> Lunch (70%, 4000K) — Dinner (40%, 2700K) — Cleaning
              (100%) — Closed (5%)
            </li>
            <li>
              <strong>Retail:</strong> Trading (100%) — Evening (80%) — Closed (security) — Restock
              (100%)
            </li>
            <li>
              <strong>Healthcare ward:</strong> Day (5000K) — Evening (3000K) — Night (dim amber) —
              Examination
            </li>
          </ul>
          <p>
            <strong>DALI Scene Commands</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Recall scene 1:</strong> GOTO SCENE 0 (broadcast to group)
            </li>
            <li>
              <strong>Store current as scene 2:</strong> STORE DTR AS SCENE 1
            </li>
            <li>
              <strong>Scene storage:</strong> 16 scenes per DALI group (0-15)
            </li>
            <li>
              <strong>Fade time:</strong> Configurable 0-90 seconds
            </li>
          </ul>
          <p>
            <strong>Design principle:</strong> Scene names should be intuitive for end users—avoid
            technical labels like "Scene 3" in favour of descriptive names like "Presentation Mode."
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Tunable White (CCT Adjustment)">
          ...
          <p>
            <strong>Tunable White Control Methods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DALI DT8 (Tc):</strong> Single address, CCT + level commands — Commercial,
              healthcare installations
            </li>
            <li>
              <strong>Dual channel (0-10V):</strong> Separate warm/cool white channels — Retrofit,
              simple installations
            </li>
            <li>
              <strong>DMX:</strong> Multiple channels per luminaire — Entertainment, architectural
            </li>
            <li>
              <strong>Wireless (Bluetooth/Zigbee):</strong> App or gateway control — Residential,
              small commercial
            </li>
          </ul>
          <p>
            <strong>Tunable White Specification Considerations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>CCT range:</strong> Ensure range covers application needs (wider range = more
              flexibility)
            </li>
            <li>
              <strong>Colour consistency:</strong> Specify MacAdam ellipse (3-step or better) across
              CCT range
            </li>
            <li>
              <strong>Dimming performance:</strong> Check minimum dim level maintains CCT accuracy
            </li>
            <li>
              <strong>CRI consistency:</strong> Verify CRI &gt;80 (preferably &gt;90) across full
              CCT range
            </li>
            <li>
              <strong>Efficacy variation:</strong> Note that efficacy typically drops at extreme CCT
              values
            </li>
          </ul>
          <p>
            <strong>Best practice:</strong> When specifying tunable white, ensure the control system
            supports smooth CCT transitions to avoid visible colour stepping during adjustments.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Colour Changing Systems (RGB/RGBW)">
          <p>
            ...
            create a wide gamut of colours through additive mixing. RGBW systems add a dedicated
            White channel for improved white light quality and efficiency.
          </p>
          <p>
            <strong>Additive Colour Mixing Principles</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Red + Green =</strong> Yellow
            </li>
            <li>
              <strong>Red + Blue =</strong> Magenta
            </li>
            <li>
              <strong>Green + Blue =</strong> Cyan
            </li>
            <li>
              <strong>Red + Green + Blue =</strong> White (approximate)
            </li>
          </ul>
          <p>
            <strong>RGB vs RGBW Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Control channels:</strong> 3 (R, G, B) — 4 (R, G, B, W)
            </li>
            <li>
              <strong>White light quality:</strong> Poor CRI, pinkish tint — Good CRI, clean white
            </li>
            <li>
              <strong>Efficiency at white:</strong> Lower (all LEDs running) — Higher (dedicated
              white LED)
            </li>
            <li>
              <strong>Pastel colours:</strong> Limited quality — Better with white mixing
            </li>
            <li>
              <strong>Cost:</strong> Lower — Higher
            </li>
            <li>
              <strong>Application:</strong> Saturated colour effects — Architectural, hospitality
            </li>
          </ul>
          <p>
            <strong>DMX512 for Colour Changing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Addressing:</strong> Each luminaire occupies 3 (RGB) or 4+ (RGBW) consecutive
              channels
            </li>
            <li>
          ...
          <p>
            <strong>Colour Changing Applications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Installation note:</strong> RGB/RGBW installations require careful attention to
            colour consistency between luminaires. Specify binning requirements and consider
        ...
        <ConceptBlock title="Circadian and Human-Centric Lighting">
          ...
          <p>
            <strong>Circadian Rhythm and Light</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Morning (6am-9am):</strong> 5000K-6500K (cool) — High — Suppress melatonin,
              increase alertness
            </li>
            <li>
              <strong>Midday (9am-3pm):</strong> 4000K-5000K — Moderate-high — Maintain alertness,
              support concentration
            </li>
            <li>
              <strong>Afternoon (3pm-6pm):</strong> 3500K-4000K — Moderate — Gradual transition,
              reduce stimulation
            </li>
            <li>
              <strong>Evening (6pm onwards):</strong> 2700K-3000K (warm) — Low — Allow melatonin
              production, prepare for sleep
            </li>
          </ul>
          <p>
            <strong>Melanopic Metrics Explained</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Melanopic lux (EML/EDI):</strong> Measures biological effectiveness of light
            ...
            <li>
              <strong>Measurement:</strong> Vertical illuminance at eye level, not horizontal task
              illuminance
            </li>
            <li>
          ...
          <p>
            <strong>WELL Building Standard - Lighting Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>L01 Light Exposure:</strong> &gt;150 melanopic EDI at eye — Circadian
              entrainment
            </li>
            <li>
              <strong>L02 Visual Lighting Design:</strong> Appropriate task illuminance — Visual
              comfort and performance
            </li>
            <li>
              <strong>L03 Circadian Lighting Design:</strong> &gt;200 melanopic EDI option —
              Enhanced circadian support
            </li>
            <li>
              <strong>L04 Glare Control:</strong> UGR limits per task — Visual comfort
            </li>
            <li>
              <strong>L06 Visual Balance:</strong> Surface luminance ratios — Reduce eye strain
            </li>
            <li>
              <strong>L07 Electric Light Quality:</strong> CRI &gt;80, R9 &gt;0 — Colour rendering
              quality
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Workplace Applications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Smart lighting</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
