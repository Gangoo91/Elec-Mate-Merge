...
const seoDescription =
  'Learn about professional conduct, accountability, and maintaining high standards in electrical fault diagnosis work, including ethics, CPD requirements, and industry responsibilities.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      'Only being responsible when things go wrong',
      'Taking responsibility for your work, decisions, and their consequences',
      'Blaming others when problems occur',
      'Following instructions without question',
    ],
    correctAnswer: 1,
    explanation:
      'Accountability means taking full responsibility for your work, the decisions you make, and their consequences - both positive and negative. It involves standing behind your work and addressing any issues that arise.',
  },
  {
    question:
      'Under the Electricity at Work Regulations 1989, who has duties regarding electrical safety?',
    options: [
      'Only employers',
      'Only employees',
      'Both employers and employees, plus the self-employed',
      'Only building owners',
    ],
    correctAnswer: 2,
    explanation:
      'The Electricity at Work Regulations 1989 place duties on employers, employees, and the self-employed. Everyone involved in work activities has responsibilities for electrical safety to the extent of their control and capability.',
  },
  {
    question: 'What is the purpose of Continuing Professional Development (CPD)?',
    options: [
      'To increase earning potential only',
      'To maintain and enhance competence throughout your career',
      "It's only required for registered professionals",
      'To gain qualifications for new career paths',
    ],
    correctAnswer: 1,
    explanation:
      'CPD ensures you maintain and enhance your competence throughout your career. As regulations, technology, and best practices evolve, CPD keeps your knowledge current and demonstrates commitment to professional standards.',
  },
  {
    question: 'When should you refuse to carry out work?',
    options: [
      'Never - always do what customers ask',
      "When you don't feel like it",
      'When the work would be unsafe, non-compliant, or beyond your competence',
      "Only when the customer can't pay",
    ],
    correctAnswer: 2,
    explanation:
      'Professional practice requires refusing work that would be unsafe, non-compliant with regulations, or beyond your competence. Your primary duty is to safety and legal compliance, not customer demands.',
  },
];
...
const quizQuestions = [
  {
    question:
      'What is the primary purpose of competent person schemes in electrical installation work?',
    options: [
      'To increase costs for contractors',
      'To provide self-certification of compliance with Building Regulations',
      'To eliminate the need for testing',
      'To replace local authority inspection',
    ],
    correctAnswer: 1,
    explanation:
      'Competent person schemes allow registered members to self-certify that their work complies with Building Regulations, avoiding the need for separate building control notification while maintaining standards through scheme oversight.',
  },
  {
    question:
      'What should you do if you discover that a colleague has carried out substandard work?',
    options: [
      "Ignore it - it's not your responsibility",
      'Report it to the appropriate authority if safety is at risk',
      'Criticise them publicly',
      'Fix it without telling anyone',
    ],
    correctAnswer: 1,
    explanation:
      'Professional responsibility may require reporting serious safety concerns to appropriate authorities. While the approach should be measured, public safety must take precedence. Consider discussing with the individual first if appropriate.',
  },
  {
    question: 'How does BS 7671 define a competent person?',
    options: [
      'Anyone with electrical qualifications',
      'Someone with relevant knowledge, skills, and experience for the work',
      'Only those registered with schemes',
      'Anyone who has completed an apprenticeship',
    ],
    correctAnswer: 1,
    explanation:
      'BS 7671 defines competence as having adequate training, skills, knowledge, and experience to carry out the specific work safely. Competence is task-specific - you may be competent for some work but not others.',
  },
  {
    question: 'What is your responsibility regarding knowledge of current regulations?',
    options: [
      'Only know regulations from when you qualified',
      'Stay current with all applicable regulations and standards',
      'Wait until inspected to learn new rules',
      'Only employers need to know regulations',
    ],
    correctAnswer: 1,
    explanation:
      'Professional electricians must stay current with applicable regulations, amendments, and standards. This is part of competence and essential for carrying out work that meets current requirements.',
  },
  {
    question:
      "What ethical principle should guide decisions about work that isn't strictly non-compliant but is of poor quality?",
    options: [
      "If it's legal, it's acceptable",
      'Professional integrity requires recommending improvement',
      'Only address if the customer notices',
      'Leave it for the next electrician',
    ],
    correctAnswer: 1,
    explanation:
      'Professional integrity goes beyond minimum legal requirements. Even work that technically complies but is of poor quality should be addressed, with recommendations for improvement to meet professional standards.',
  },
  {
    question: "How should you handle confidential information about customers' installations?",
    options: [
      'Share freely with other tradespeople',
      'Keep information confidential unless disclosure is legally required',
      'Post details on social media for advice',
      'Discuss with competitors to compare experiences',
    ],
    correctAnswer: 1,
    explanation:
      "Customer information should be kept confidential. Only share information when legally required (such as notifying authorities of dangerous situations) or with the customer's explicit consent.",
  },
  {
    question: 'What is the significance of maintaining accurate records of your work?',
    options: [
      'Only required by large companies',
      'Protects you professionally and helps future maintenance',
      'Takes time away from productive work',
      'Only needed for inspection and testing',
    ],
    correctAnswer: 1,
    explanation:
      'Accurate records protect you in case of disputes or claims, demonstrate compliance with requirements, and provide valuable information for future maintenance and fault diagnosis. Records are a professional responsibility.',
  },
  {
    question: 'When is it appropriate to work on systems beyond your competence?',
    options: [
      'When the customer insists',
      'When the pay is good enough',
      'Never - work should match your competence level',
      'When you can learn on the job',
    ],
    correctAnswer: 2,
    explanation:
      'You should never work on systems beyond your competence level. This could result in unsafe work, harm to people, and legal liability. Refer such work to appropriately qualified specialists.',
  },
  {
    question: 'What responsibility do you have for work done by others under your supervision?',
    options: [
      'None - they are responsible for their own work',
      'Full responsibility for the quality and safety of their work',
      'Only if you specifically tell them what to do',
      'Shared equally regardless of experience levels',
    ],
    correctAnswer: 1,
    explanation:
      'When supervising others, you take responsibility for ensuring their work meets required standards. This includes appropriate oversight, checking their work, and ensuring they work within their competence level.',
  },
  {
    question: 'How should professional electricians approach competition with other contractors?',
    options: [
      "Criticise competitors' work to win customers",
      'Compete on value, quality, and service, not by undermining others',
      'Undercut all prices regardless of viability',
      'Form agreements to fix prices',
    ],
    correctAnswer: 1,
    explanation:
      "Professional competition should be based on the value, quality, and service you provide. Criticising competitors or engaging in anti-competitive practices damages the industry's reputation and may be illegal.",
  },
  {
    question:
      "What is your responsibility if a customer asks you to sign off work you haven't done?",
    options: [
      'Do it if they pay extra',
      'Refuse - certification must reflect reality',
      'Only refuse for large jobs',
      'Agree if they seem honest',
    ],
    correctAnswer: 1,
    explanation:
      "Never certify work you haven't done or properly inspected. False certification is fraudulent, potentially dangerous, and could result in criminal prosecution, loss of scheme membership, and civil liability.",
  },
  {
    question: 'How does professional behaviour contribute to industry reputation?',
    options: [
      "Individual behaviour doesn't affect the industry",
      "Every professional's conduct affects how the industry is perceived",
      'Only large company behaviour matters',
      'Reputation is determined by regulations',
    ],
    correctAnswer: 1,
    explanation:
      "Every electrician's behaviour affects industry reputation. Professional conduct builds public trust, while poor practice damages perception of all electricians. You represent the profession in every customer interaction.",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <ul className="list-disc pl-5 text-white/80 text-sm space-y-2">
              ...
              <li>
                <strong>Civil claims:</strong> For negligence causing injury or damage
              </li>
              <li>
                <strong>Professional sanctions:</strong> Loss of scheme membership or registration
              </li>
              <li>
                <strong>Contractual liability:</strong> Breach of contractual obligations
              </li>
            </ul>
          </div>
        </section>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-gradient-to-r from-yellow-400/10 to-amber-500/10 rounded-lg p-4 border border-yellow-400/20 mb-4">
              ...
              <ul className="list-disc pl-5 text-white/80 text-sm space-y-2">
                ...
                <li>
                  <strong>Skills:</strong> Practical ability to perform work correctly
                </li>
                <li>
                  <strong>Experience:</strong> Familiarity from having done similar work
                </li>
                <li>
                  <strong>Attitude:</strong> Professional approach to safety and quality
                </li>
                <li>
                  <strong>Task-specific:</strong> Competence relates to specific work, not general
                  ability
                </li>
              </ul>
            </div>
            ...
            <ul className="list-disc pl-5 text-white/80 text-sm space-y-2">
              ...
              <li>
                Develop competence through proper training, not trial and error on customers'
                installations
              </li>
            </ul>
          </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 rounded-lg p-4 border border-red-500/20 mb-4">
              ...
              <ul className="list-disc pl-5 text-white/80 text-sm space-y-2">
                ...
                <li>
                  <strong>Commercial pressure vs quality:</strong> Employer pressure to cut corners
                  to save money
                </li>
                <li>
                  <strong>Loyalty vs public interest:</strong> Colleague doing substandard work
                </li>
                <li>
                  <strong>Confidentiality vs safety:</strong> Information about dangerous
                  installations
                </li>
                <li>
                  <strong>Profit vs honesty:</strong> Opportunity to recommend unnecessary work
                </li>
              </ul>
            </div>
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <h3 className="text-lg font-semibold text-white mt-6 mb-3">
              Handling Complaints and Callbacks
            </h3>
            <div className="bg-gradient-to-r from-yellow-400/10 to-amber-500/10 rounded-lg p-4 border border-yellow-400/20 mb-4">
              ...
              <ul className="list-disc pl-5 text-white/80 text-sm space-y-2">
                ...
                <li>
                  <strong>Listen first:</strong> Understand the customer's concern before responding
                </li>
                <li>
                  <strong>Investigate thoroughly:</strong> Determine what happened and why
                </li>
                <li>
                  <strong>Take responsibility:</strong> If the fault is yours, acknowledge and
                  correct it
                </li>
                <li>
                  <strong>Be fair:</strong> If not your fault, explain clearly and offer to help
                </li>
                <li>
                  <strong>Learn and improve:</strong> Use feedback to prevent recurrence
                </li>
                <li>
                  <strong>Document everything:</strong> Keep records of complaints and resolution
                </li>
              </ul>
            </div>
            ...
            <ul className="list-disc pl-5 text-white/80 text-sm space-y-2">
              ...
              <li>
                <strong>Professional indemnity:</strong> Covers claims for professional negligence
              </li>
              <li>
                <strong>Employer's liability:</strong> Required if you employ others
              </li>
              <li>
                <strong>Adequate cover levels:</strong> Ensure limits are appropriate for your work
              </li>
              <li>
                <strong>Continuous cover:</strong> Maintain cover even when retiring or changing
                work
              </li>
            </ul>
            ...
            <ul className="list-disc pl-5 text-white/80 text-sm space-y-2">
              ...
              <li>
                <strong>Employers:</strong> For competent work and following procedures
              </li>
              <li>
                <strong>Regulatory bodies:</strong> For compliance with laws and regulations
              </li>
              <li>
                <strong>Scheme operators:</strong> For meeting scheme requirements
              </li>
              <li>
                <strong>The public:</strong> For safety of installations you work on
              </li>
              <li>
                <strong>The profession:</strong> For maintaining industry standards
              </li>
            </ul>
          </div>
        </section>
        ...
        {/* Quiz Section */}
        <section className="mb-8 sm:mb-12">
          <Quiz title="Section 6.4 Knowledge Check" questions={quizQuestions} passingScore={75} />
        </section>
