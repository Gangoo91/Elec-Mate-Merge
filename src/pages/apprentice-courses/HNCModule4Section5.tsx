    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Design robust power distribution systems that provide reliable, high-quality electrical
          supplies throughout buildings
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the design of power distribution infrastructure for building services,
          from main switchgear through to final distribution boards. Understanding these systems is
          essential for creating reliable, maintainable and efficient electrical installations.
        </p>
