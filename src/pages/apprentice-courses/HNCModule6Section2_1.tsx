...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['6 kW per phase', '3.68 kW per phase', '16 A per phase', '50 kW total'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['500 W/m²', '1,000 W/m²', '800 W/m²', '1,200 W/m²'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['-1.0% per °C', '-0.1% per °C', '-0.35% to -0.45% per °C', '+0.5% per °C'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['0.85-0.90', '0.95-1.00', '1.05-1.10', '0.70-0.75'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['120 V DC', '600 V DC', '1,500 V DC', '1,000 V DC'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['MCS 012', 'MCS 020', 'MCS 001', 'MCS 025'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['1,500-2,000 kWh', '7,000-8,000 kWh', '3,200-4,000 kWh', '5,000-6,000 kWh'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['10 years', '20 years', '1 year', '5 years'],
    correctAnswer: 0,
    explanation:
...
const HNCModule6Section2_1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 2 · Subsection 1"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Section 712 governs every PV installation. DC-side faults are the highest fire-risk
              failure mode — segregated routing, double-insulated cabling, IP65 connectors and DC
              isolators within reach of the array are non-negotiable. BS EN 62446 sets the
              commissioning, documentation and routine verification standard.
            </>
          }
        ...
        <ConceptBlock title="PV Cell Technology and Panel Specifications">
          ...
          <p>
            <strong>PV Cell Technology Comparison:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Monocrystalline:</strong> 18-22% — Uniform black appearance, highest
              efficiency, performs well in low light — Premium residential, limited roof space
            </li>
            <li>
              <strong>Polycrystalline:</strong> 15-18% — Blue speckled appearance, lower cost,
              slightly lower efficiency — Budget residential, commercial arrays
            </li>
            <li>
              <strong>Thin Film (CdTe/CIGS):</strong> 10-13% — Flexible, lightweight, better shade
              tolerance, lower efficiency — BIPV, curved surfaces, large commercial
            </li>
            <li>
              <strong>Half-cut cells:</strong> 19-22% — Reduced resistive losses, better shade
              performance, higher power density — Modern premium installations
            </li>
          </ul>
          <p>
            <strong>Key Panel Specifications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Wp (Peak Watts):</strong> Rated power output at STC (1,000 W/m², 25°C, AM 1.5)
            </li>
            <li>
            ...
            <li>
              <strong>Vmp (Voltage at Maximum Power):</strong> Operating voltage at peak power point
            </li>
            <li>
            ...
            <li>
              <strong>Imp (Current at Maximum Power):</strong> Operating current at peak power point
            </li>
            <li>
          ...
          <p>
            <strong>Standard Test Conditions (STC)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            Real-world performance differs due to varying irradiance, higher cell temperatures, and
            system losses.
          </p>
          <p>
        ...
        <ConceptBlock title="System Sizing and Annual Yield Calculations">
          <p>
            Accurate system sizing requires understanding solar irradiation data, system losses, and
            electrical parameters. String voltage calculations ensure inverter compatibility and
            safe operation across temperature extremes.
          </p>
          <p>
            <strong>UK Solar Irradiation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Orientation Factors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>System Losses (PR)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Annual Yield Calculation</strong>
          </p>
          <p>Formula:</p>
          ...
          <p>
            <strong>String Voltage Calculations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Maximum Voc:</strong> -10°C (UK minimum) — Voc × [1 + (Tc × (Tmin - 25))] —
              Inverter max DC input
            </li>
            <li>
              <strong>Minimum Vmp:</strong> +70°C (roof max) — Vmp × [1 + (Tc × (Tmax - 25))] —
          ...
          <p>
            <strong>Critical check:</strong> String Voc at -10°C must not exceed inverter maximum DC
            voltage (typically 600-1,000 V), and string Vmp at 70°C must remain above MPPT minimum
            voltage.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Inverter Technology and DNO Connection Requirements">
          ...
          <p>
            <strong>Inverter Types</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>String Inverter:</strong> Central unit for one or more strings —
              Cost-effective, easy maintenance, high efficiency — Shade affects entire string,
              requires matching
            </li>
            <li>
              <strong>Microinverter:</strong> Individual unit per panel — Panel-level MPPT, no
              high-voltage DC, shade tolerant — Higher cost, more components to fail
            </li>
            <li>
              <strong>DC Optimiser + Inverter:</strong> Panel-level optimiser with string inverter —
              Panel-level MPPT, string inverter benefits — Additional cost, still has DC cabling
            </li>
            <li>
              <strong>Hybrid Inverter:</strong> PV input plus battery interface — Integrated storage
              solution, backup capability — Higher cost, more complex installation
            </li>
          </ul>
          <p>
            <strong>G98 vs G99 Requirements</strong>
          </p>
          <p>
            <strong>G98 (Notification Only)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>G99 (Application Required)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Inverter Safety Features (G98/G99 Compliance)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Voltage monitoring:</strong> Disconnects if voltage outside 207-253 V (230 V
              +10%/-10%)
            </li>
            <li>
        ...
        <ConceptBlock title="MCS Standards and Performance Monitoring">
          ...
          <p>
            <strong>MCS Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Installation Documentation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Generation meter only:</strong> Total kWh generated — Basic verification, SEG
              compliance
            </li>
            <li>
              <strong>Inverter monitoring:</strong> Real-time power, daily yield, fault codes —
              Remote fault detection, performance tracking
            </li>
            <li>
              <strong>Panel-level monitoring:</strong> Individual panel output — Identify
              underperforming panels, shade impact
            </li>
            <li>
              <strong>Weather-compensated:</strong> Irradiance, temperature, actual vs expected —
              True performance ratio calculation
            </li>
          </ul>
          <p>
            <strong>Performance Ratio Monitoring</strong>
          </p>
          <p>Performance Ratio (PR) calculation:</p>
          <p>PR = Actual Energy Output ÷ (Installed kWp × Plane of Array Irradiation ÷ 1,000)</p>
          <p>Expected values:</p>
          <p>
            New system: <span>0.80-0.85</span>
          </p>
          <p>
            After degradation (10+ years): <span>0.75-0.80</span>
          </p>
          <p>
            Indicating fault: <span>&lt; 0.70</span>
          </p>
          <p>
            <strong>Maintenance consideration:</strong> Panels typically degrade 0.5-0.7% per year.
            Inverters have 10-15 year typical lifespan. Factor replacement costs into lifecycle
            analysis.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            Voc at -10°C = 49.5 × 1.1015 = <span>54.5 V</span>
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Determine connection requirements for a 6 kWp single-phase
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Omitting DC isolation</strong> - DC isolator at inverter required, fireman's
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              fit-and-inform applied because the inverter is single-phase per string, but the total
              per-phase current exceeds 16 A. The DNO refuses to register the system, demands a G99
              application, and the export limit is now under negotiation.
            </>
          }
          whatToDo={
            <>
              Submit a full G99 application immediately — typical lead time is 8–13 weeks for a
              connection offer. While waiting, the system can run in zero-export mode (with active
              export limitation) under DNO temporary acceptance. Verify the inverter has the
              certified export-limiting function. Update the customer expectation: revenue from SEG
              cannot start until the DNO formally accepts the connection. Always check threshold per
              phase against the inverter rating before tendering.
            </>
          }
          whyItMatters={
            <>
              Misapplying G98 vs G99 is one of the most common installer errors and creates
              programme risk on every commercial PV project. The DNO can refuse connection or impose
              constraints (export limiting, voltage management) that materially change project
              economics. Determine the route at design stage, not commissioning.
            </>
          }
        />
