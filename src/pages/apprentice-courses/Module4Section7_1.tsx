...
const TITLE =
  'Safe Manual Handling of Equipment and Materials - Module 4.7.1 | Level 2 Electrical Course';
const DESCRIPTION =
  'Learn safe manual handling techniques for electrical equipment and materials. Master lifting techniques, mechanical aids, and legal requirements to prevent workplace injuries.';
...
const Module4Section7_1 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Gloves protect hands from cuts and sharp edges, while safety glasses protect eyes from debris or fragments when handling sharp materials.',
    },
    {
      id: 10,
  ...
  const faqs = [
    {
      ...
      answer:
        'Yes, you have the right to stop and request assistance or equipment. Safety comes before speed. Under the Health and Safety at Work Act, you have both the right and responsibility to refuse unsafe work.',
    },
    {
      question: "What if there's no lifting aid available?",
      answer:
        'Break down the load into smaller parts, ask for help, or notify your supervisor. Never attempt to lift something that could cause injury - there are always alternatives or solutions available.',
    },
    {
      question: 'How heavy is too heavy to lift alone?',
      answer:
        "There's no fixed weight, but anything over 25 kg should normally require assistance or aids. Consider the load's size, shape, your physical condition, and the lifting environment when assessing risk.",
    },
  ];
            ...
            <div className="grid md:grid-cols-2 gap-4 text-white/80">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    Manual handling injuries are a major cause of workplace accidents in electrical
                    work, including back strains, muscle injuries, and dropped load accidents.
                  </li>
                  <li>
                    Proper lifting techniques, mechanical aids, and team lifting can prevent most
                    manual handling injuries.
                  </li>
                  <li>
                    Legal requirements under MHOR 1992 place duties on both employers and employees
                    to ensure safe handling practices.
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Spot:</strong> Heavy cable drums being carried by one person, awkward
                    lifting positions, no lifting aids available.
                  </li>
                  <li>
                    <strong>Use:</strong> Sack trucks, drum jacks, team lifting, proper lifting
                    technique.
                  </li>
                  <li>
                    <strong>Check:</strong> Load weight and size, clear routes, appropriate footwear
                    and gloves.
                  </li>
                </ul>
              </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
                ...
                <ul className="text-sm list-disc pl-6 space-y-1">
                  <li>
                    <strong>Back injuries and spinal damage</strong> - herniated discs, muscle
                    strains, and chronic pain conditions
                  </li>
                  <li>
                    <strong>Repetitive strain injuries (RSI)</strong> - affecting shoulders, wrists,
                    and knees from poor handling techniques
                  </li>
                  <li>
                    <strong>Acute injuries from dropped loads</strong> - crushing injuries to feet,
                    cuts from sharp materials
                  </li>
                  <li>
                    <strong>Long-term musculoskeletal disorders</strong> - affecting quality of life
                    and career longevity
                  </li>
                  <li>
                    <strong>Secondary accidents</strong> - falls and collisions while carrying
                    awkward loads
                  </li>
                  <li>
                    <strong>Fatigue-related incidents</strong> - increased accident risk from
                    overexertion
                  </li>
                </ul>
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm list-disc pl-6 space-y-1">
                  <li>
                    <strong>Manual Handling Operations Regulations 1992 (MHOR)</strong> - primary
                    legislation covering all manual handling activities
                  </li>
                  <li>
                    <strong>Employer duties</strong> - assess risks, provide training, supply
                    equipment, and monitor compliance
                  </li>
                  <li>
                    <strong>Employee responsibilities</strong> - follow safe systems, use provided
                    equipment, report hazards
                  </li>
                  <li>
                    <strong>Risk assessment requirements</strong> - formal evaluation of manual
                    handling tasks and control measures
                  </li>
                  <li>
                    <strong>Training obligations</strong> - provision of suitable instruction in
                    safe handling techniques
                  </li>
                  <li>
                    <strong>Equipment provision</strong> - supply of appropriate lifting aids and
                ...
                <div className="mt-3 p-3 bg-black/20 rounded text-sm">
                  ...
                  <ul className="text-white/70 list-disc pl-4 space-y-1">
                    ...
                    <li>
                      <strong>Assess</strong> - evaluate unavoidable manual handling operations
                    </li>
                    <li>
                      <strong>Reduce</strong> - implement measures to reduce risk of injury
                    </li>
                    <li>
                      <strong>Review</strong> - monitor and update assessments regularly
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-green-500/10 border-l-2 border-green-500/50">
                ...
                <ul className="text-sm list-disc pl-6 space-y-1">
                  <li>
                    <strong>Plan the lift</strong> - assess the load, plan the route, clear
                    obstacles, and ensure safe footing
                  </li>
                  <li>
                    <strong>Position yourself correctly</strong> - feet shoulder-width apart, close
                    to the load
                  </li>
                  <li>
                    <strong>Adopt the right posture</strong> - squat down, keep back straight, head
                    up
                  </li>
                  <li>
                    <strong>Secure your grip</strong> - use whole hand, not fingertips, get a firm
                    hold
                  </li>
                  <li>
                    <strong>Lift smoothly</strong> - use leg muscles, keep load close to body, avoid
                    jerky movements
                  </li>
                  <li>
                    <strong>Move carefully</strong> - turn with feet not spine, avoid twisting while
                    loaded
                  </li>
                </ul>
                ...
                <div className="mt-3 p-3 bg-black/20 rounded text-sm">
                  ...
                  <ul className="text-white/70 list-disc pl-4 space-y-1">
                    ...
                    <li>
                      <strong>Legs</strong> - strongest muscles do the lifting work, not the back
                    </li>
                    <li>
                      <strong>Core</strong> - abdominal muscles support spine during lift
                    </li>
                    <li>
                      <strong>Back</strong> - maintains natural curves, acts as rigid beam
                    </li>
                    <li>
                      <strong>Arms</strong> - keep load close, avoid extended reaches
                    </li>
                    <li>
                      <strong>Hands</strong> - secure grip using whole palm and fingers
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-orange-500/10 border-l-2 border-orange-500/50">
                ...
                <ul className="text-sm list-disc pl-6 space-y-1">
                  <li>
                    <strong>Cable drums and reels</strong> - use drum jacks, trolleys, or mechanical
                    lifts for weights over 25kg
                  </li>
                  <li>
                    <strong>Conduit and trunking</strong> - carry long lengths with two people,
                    support at multiple points
                  </li>
                  <li>
                    <strong>Cable trays and ladders</strong> - balance load evenly, use team lifting
                    for large sections
                  </li>
                  <li>
                    <strong>Consumer units and distribution boards</strong> - lift from base, not
                    from door or covers
                  </li>
                  <li>
                    <strong>Switchgear and panels</strong> - use lifting equipment, never attempt
                    manual lifting alone
                  </li>
                  <li>
                    <strong>Boxes of accessories</strong> - break down into smaller loads rather
                    than carrying full boxes
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-purple-500/10 border-l-2 border-purple-500/50">
                <p className="font-semibold text-purple-400 mb-2">
                  Equipment and Teamwork Solutions
                </p>
                <ul className="text-sm list-disc pl-6 space-y-1">
                  <li>
                    <strong>Wheeled aids</strong> - sack trucks, platform trolleys, pallet trucks
                    for ground-level transport
                  </li>
                  <li>
                    <strong>Lifting equipment</strong> - hoists, cranes, and lifting tables for
                    heavy items
                  </li>
                  <li>
                    <strong>Specialist tools</strong> - drum jacks, cable pulling systems, panel
                    lifts
                  </li>
                  <li>
                    <strong>Team lifting</strong> - coordinated lifting with clear communication
                    protocols
                  </li>
                  <li>
                    <strong>Vacuum lifts</strong> - for large flat panels and sheets of material
                  </li>
                  <li>
                    <strong>Conveyor systems</strong> - for repetitive material movement tasks
                  </li>
                </ul>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-white/70 space-y-1 list-disc ml-4">
                      ...
                      <li>
                        Use safety glasses when moving materials overhead or in confined spaces
                      </li>
                      <li>Ensure work boots have good grip and ankle support for load carrying</li>
                      <li>
                        Wear high-visibility clothing when moving materials in active work areas
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-white/70 space-y-1 list-disc ml-4">
                      ...
                      <li>
                        Store heavy items at waist height to reduce bending and lifting strain
                      </li>
                      <li>Keep work boots clean to avoid slips while carrying heavy objects</li>
                      <li>
                        Clear routes of obstacles and debris before beginning material movement
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-white/70 space-y-1 list-disc ml-4">
                      ...
                      <li>
                        Brief all team members on manual handling procedures at daily toolbox talks
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-green-400">
                      <strong>Prevention:</strong> A £50 sack truck hire or team lift with a
                      colleague would have prevented this £5,000+ incident.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-green-500/10 border-l-2 border-green-500/50">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-green-400">
                      <strong>Result:</strong> Zero injuries, installation completed ahead of
                      schedule, and client commended the professional approach.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <ul className="list-disc pl-6 space-y-2 text-white/80">
                ...
                <li>
                  You know the legal requirements under MHOR 1992 and the responsibilities of
                  employers and employees.
                </li>
                <li>
                  You can apply correct lifting techniques to reduce injury risk in electrical work.
                </li>
                <li>
                  You understand how to select and use appropriate mechanical aids and team lifting
                  approaches.
                </li>
                <li>
                  You've learned practical tips for handling electrical materials safely and
                  efficiently.
                </li>
              </ul>
            </div>
