      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Pressure test:</strong> OFN at 1.1x design pressure per BS EN 378
              </li>
              <li className="pl-1">
                <strong>Evacuation:</strong> Below 500 microns, hold for 30+ minutes
              </li>
              <li className="pl-1">
                <strong>Superheat/subcooling:</strong> 5-8K and 5-10K respectively
              </li>
              <li className="pl-1">
                <strong>F-Gas records:</strong> Retain for minimum 5 years
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>CIBSE Code M:</strong> Commissioning procedures and documentation
              </li>
              <li className="pl-1">
                <strong>BS EN 378:</strong> Refrigeration system safety requirements
              </li>
              <li className="pl-1">
                <strong>F-Gas Regulations:</strong> Certification and leak check requirements
              </li>
              <li className="pl-1">
                <strong>BSRIA:</strong> Standard commissioning procedures
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Standing vacuum:</strong> Hold for minimum 30 minutes with no pressure
                  rise
                </li>
                <li className="pl-1">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Standard for R410A, R32, blends
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Charge through liquid line valve, system off initially
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Vapour charging</td>
                      <td className="border border-white/10 px-3 py-2">
                        Single-component refrigerants only
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Charge through suction side, compressor running
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Weigh-in method</td>
                      <td className="border border-white/10 px-3 py-2">
                        All systems - most accurate
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Pre-calculated charge weighed using electronic scales
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Superheat method</td>
                      <td className="border border-white/10 px-3 py-2">
                        Fixed orifice systems, top-up
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Charge until target superheat achieved
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Subcooling method</td>
                      <td className="border border-white/10 px-3 py-2">
                        TXV systems, verification
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Charge until target subcooling achieved
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Never charge liquid refrigerant directly into the suction (low-pressure) side
                </li>
                <li className="pl-1">
                  Always invert cylinder when liquid charging through manifold
                </li>
                <li className="pl-1">
                  Wear appropriate PPE: safety glasses, gloves, and ensure ventilation
                </li>
                <li className="pl-1">
                  Only F-Gas certified personnel may handle fluorinated refrigerants
                </li>
                <li className="pl-1">
                  Never mix different refrigerant types - complete system recovery required first
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                VRF Additional Charge Calculation
              </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Best practice:</strong> Always record the exact refrigerant quantity charged
              on the system label and in the commissioning documentation. This is a legal
              requirement under F-Gas Regulations.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                BS EN 378 Test Pressures for Common Refrigerants
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ol className="text-sm text-white space-y-1.5 list-decimal list-outside ml-5">
                ...
                <li className="pl-1">
                  Open all service valves and ensure refrigerant circuit is complete
                </li>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Performance verification confirms that the installed system meets design
              specifications. Key parameters including superheat, subcooling, airflow rates, and
              temperatures must be measured and compared against design criteria per CIBSE Code M
              requirements.
            </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Evaporator outlet (suction line)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Actual temp - Saturation temp (at suction pressure)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Saturation temp (at discharge pressure) - Actual temp
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Discharge temp - Saturation temp (at discharge pressure)
                      </td>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              ...
              <div className="font-mono text-sm space-y-1">
                ...
                <p className="mt-2 text-green-400">
                  Superheat = 12°C - 6°C = 6K (within normal range)
                </p>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                CIBSE Code M Performance Verification Checklist
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Airflow measurement:</strong> Verify supply and return airflow rates
                  against design
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Refrigerant temperatures:</strong> Suction, liquid, discharge as per
                  design
                </li>
                <li className="pl-1">
                  <strong>Electrical parameters:</strong> Voltage, current, power factor within
                  rated values
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Documentation requirement:</strong> Record all measured values alongside
              design parameters. Document any deviations with explanations and corrective actions
              taken.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Refrigerant type, quantity, date, technician details
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Refrigerant type, charge (kg), GWP, CO2e (tonnes)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Date, method, results, leaks found/repaired
                      </td>
                      <td className="border border-white/10 px-3 py-2">5 years minimum</td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Refrigerant added/recovered, technician F-Gas cert no.
                      </td>
                      <td className="border border-white/10 px-3 py-2">5 years minimum</td>
                    </tr>
                  </tbody>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        All activities - leak checking, recovery, installation, maintenance
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-bold">Category II</td>
                      <td className="border border-white/10 px-3 py-2">
                        Recovery, installation, and maintenance (no leak checking)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-bold">Category III</td>
                      <td className="border border-white/10 px-3 py-2">
                        Recovery for systems &lt;3kg hermetically sealed
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-bold">Category IV</td>
                      <td className="border border-white/10 px-3 py-2">
                        Leak checking only (no breach of refrigerant circuit)
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                O&M Manual Contents for HVAC Systems
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Operating procedures:</strong> Start-up, normal operation, shutdown,
                  seasonal changeover
                </li>
                <li className="pl-1">
                  <strong>Emergency procedures:</strong> Refrigerant leak response, electrical
                  isolation
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Equipment data sheets:</strong> All manufacturer literature and
                  specifications
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Spare parts:</strong> Recommended spares list with part numbers and
                  suppliers
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                Commissioning Record Sheet Contents
              </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Documentation review:</strong> O&M manuals, as-builts, certificates
                  location
                </li>
                <li className="pl-1">
                  <strong>System demonstration:</strong> Control panel operation, setpoint
                  adjustment
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Mandatory Leak Check Frequencies (F-Gas)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Commissioning a Split System
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Diagnosing Performance Issue
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  Result: Superheat returned to 6K, capacity restored
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Charge refrigerant by weight per manufacturer specification
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Liquid slugging:</strong> Never charge liquid refrigerant into suction
                  side
                </li>
                <li className="pl-1">
