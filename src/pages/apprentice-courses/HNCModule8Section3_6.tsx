...
const HNCModule8Section3_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 3 · Subsection 6"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Refrigerant Charging Procedures">
          <p>
            Correct refrigerant charging is critical to system performance, efficiency, and
            longevity. The charging process must follow a methodical sequence to ensure safety and
            achieve optimal system operation from the outset.
          </p>
          <p>
            <strong>Pre-Charging Requirements:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pressure test:</strong> System tested with OFN at 1.1x maximum allowable
              pressure
            </li>
            <li>
              <strong>Leak detection:</strong> Electronic detector check on all joints and
              connections
            </li>
            <li>
              <strong>Evacuation:</strong> Triple evacuation recommended, final vacuum below 500
              microns
            </li>
            <li>
              <strong>Standing vacuum:</strong> Hold for minimum 30 minutes with no pressure rise
            </li>
            <li>
              <strong>Charge calculation:</strong> Factory pre-charge plus additional charge per
              pipe length
            </li>
          </ul>
          <p>
            <strong>Refrigerant Charging Methods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Liquid charging:</strong> Standard for R410A, R32, blends — Charge through
              liquid line valve, system off initially
            </li>
            <li>
              <strong>Vapour charging:</strong> Single-component refrigerants only — Charge through
              suction side, compressor running
            </li>
            <li>
              <strong>Weigh-in method:</strong> All systems - most accurate — Pre-calculated charge
              weighed using electronic scales
            </li>
            <li>
              <strong>Superheat method:</strong> Fixed orifice systems, top-up — Charge until target
              superheat achieved
            </li>
            <li>
              <strong>Subcooling method:</strong> TXV systems, verification — Charge until target
              subcooling achieved
            </li>
          </ul>
          <p>
            <strong>Critical Safety Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>VRF Additional Charge Calculation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>System:</strong> R410A VRF with 85m liquid line (9.52mm dia)
            </li>
            <li>
              <strong>Factory charge:</strong> 8.5 kg (outdoor unit)
            </li>
            <li>
              <strong>Additional charge factor:</strong> 25 g/m for 9.52mm liquid line
            </li>
            <li>
              <strong>Calculation:</strong> 85m x 25g/m = 2,125g = 2.125 kg
            </li>
          </ul>
          <p>Total system charge: 8.5 + 2.125 = 10.625 kg</p>
          <p>
            <strong>Best practice:</strong> Always record the exact refrigerant quantity charged on
            the system label and in the commissioning documentation. This is a legal requirement
        ...
        <ConceptBlock title="System Testing and Leak Detection">
          <p>
            Comprehensive testing ensures system integrity and compliance with safety standards. BS
            EN 378 specifies requirements for pressure testing, leak detection, and evacuation that
            must be followed before introducing refrigerant.
          </p>
          <p>
            <strong>Pressure Testing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>BS EN 378 Test Pressures for Common Refrigerants</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>R410A:</strong> 28-30 — 31-33 — ~25
            </li>
            <li>
              <strong>R32:</strong> 28-30 — 31-33 — ~25
            </li>
            <li>
              <strong>R134a:</strong> 15-18 — 17-20 — ~12
            </li>
            <li>
              <strong>R407C:</strong> 24-26 — 26-29 — ~20
            </li>
          </ul>
          <p>
            <strong>Evacuation Procedure Sequence</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>F-Gas requirement:</strong> Electronic leak detectors must be capable of
            detecting leaks of 5 grams per year minimum for compliance with current regulations.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Performance Verification">
          <p>
            ...
            Key parameters including superheat, subcooling, airflow rates, and temperatures must be
            measured and compared against design criteria per CIBSE Code M requirements.
          </p>
          <p>
            <strong>Superheat and Subcooling Measurement</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Superheat:</strong> Evaporator outlet (suction line) — Actual temp -
              Saturation temp (at suction pressure) — 5-8 K (TXV systems)
            </li>
            <li>
              <strong>Subcooling:</strong> Condenser outlet (liquid line) — Saturation temp (at
              discharge pressure) - Actual temp — 5-10 K
            </li>
            <li>
              <strong>Discharge superheat:</strong> Compressor discharge line — Discharge temp -
              Saturation temp (at discharge pressure) — 20-40 K
            </li>
          </ul>
          <p>
            <strong>Superheat Calculation Example</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>System:</strong> R410A DX split system
            </li>
            <li>
              <strong>Suction pressure:</strong> 8.5 bar (gauge) = 9.5 bar (abs)
            </li>
            <li>
              <strong>Saturation temp at 9.5 bar abs:</strong> 6°C (from P-T chart)
            </li>
            <li>
              <strong>Measured suction temp:</strong> 12°C
            </li>
          </ul>
          <p>Superheat = 12°C - 6°C = 6K (within normal range)</p>
          <p>
            <strong>Interpreting Superheat/Subcooling Readings</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Undercharge:</strong> High (&gt;10K) — Low (&lt;3K) — Add refrigerant
            </li>
            <li>
              <strong>Overcharge:</strong> Low (&lt;3K) — High (&gt;15K) — Remove refrigerant
            </li>
            <li>
              <strong>Restriction:</strong> High — Normal/High — Check filter drier/TXV
            </li>
            <li>
              <strong>Low airflow:</strong> Low — Normal — Check fan/filters/ductwork
            </li>
          </ul>
          <p>
            <strong>CIBSE Code M Performance Verification Checklist</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Airflow measurement:</strong> Verify supply and return airflow rates against
              design
            </li>
            <li>
              <strong>Temperature differential:</strong> Air-on/air-off across cooling coil
              (typically 8-12K)
            </li>
            <li>
              <strong>Refrigerant temperatures:</strong> Suction, liquid, discharge as per design
            </li>
            <li>
              <strong>Electrical parameters:</strong> Voltage, current, power factor within rated
              values
            </li>
            <li>
              <strong>Condensing pressure:</strong> Within manufacturer limits for ambient
              conditions
            </li>
            <li>
              <strong>Control operation:</strong> Setpoint response, staging, defrost cycles
            </li>
          </ul>
          <p>
            <strong>Cooling Capacity Verification</strong>
          </p>
          <p>
            <strong>Air Side Method</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Q = m x Cp x ΔT</li>
          ...
          <p>
            <strong>Water Side Method (Chillers)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Q = m x Cp x ΔT</li>
          ...
          <p>
            <strong>Documentation requirement:</strong> Record all measured values alongside design
            parameters. Document any deviations with explanations and corrective actions taken.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Commissioning Documentation and Handover">
          ...
          <p>
            <strong>F-Gas Record Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Installation record:</strong> Refrigerant type, quantity, date, technician
              details — 5 years minimum
            </li>
            <li>
              <strong>Equipment label:</strong> Refrigerant type, charge (kg), GWP, CO2e (tonnes) —
              Permanent on equipment
            </li>
            <li>
              <strong>Leak check records:</strong> Date, method, results, leaks found/repaired — 5
              years minimum
            </li>
            <li>
              <strong>Service records:</strong> Refrigerant added/recovered, technician F-Gas cert
              no. — 5 years minimum
            </li>
          </ul>
          <p>
            <strong>F-Gas Certification Categories</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Category I:</strong> All activities - leak checking, recovery, installation,
              maintenance
            </li>
            <li>
              <strong>Category II:</strong> Recovery, installation, and maintenance (no leak
              checking)
            </li>
            <li>
              <strong>Category III:</strong> Recovery for systems &lt;3kg hermetically sealed
            </li>
            <li>
              <strong>Category IV:</strong> Leak checking only (no breach of refrigerant circuit)
            </li>
          </ul>
          <p>
            <strong>O&M Manual Contents for HVAC Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>System description:</strong> Overview, schematics, component locations
            </li>
            <li>
              <strong>Operating procedures:</strong> Start-up, normal operation, shutdown, seasonal
              changeover
            </li>
            <li>
              <strong>Emergency procedures:</strong> Refrigerant leak response, electrical isolation
            </li>
            <li>
              <strong>Maintenance schedules:</strong> PPM tasks, frequencies, competence
              requirements
            </li>
            <li>
              <strong>Equipment data sheets:</strong> All manufacturer literature and specifications
            </li>
            <li>
              <strong>Commissioning records:</strong> All test results and certificates
            </li>
            <li>
              <strong>As-built drawings:</strong> Updated schematic, layout, wiring diagrams
            </li>
            <li>
              <strong>Spare parts:</strong> Recommended spares list with part numbers and suppliers
            </li>
          </ul>
          <p>
            <strong>Commissioning Record Sheet Contents</strong>
          </p>
          <p>
            <strong>System Identification</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Measured Parameters</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Handover Meeting Agenda</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Documentation review:</strong> O&M manuals, as-builts, certificates location
            </li>
            <li>
              <strong>System demonstration:</strong> Control panel operation, setpoint adjustment
            </li>
            <li>
              <strong>Emergency procedures:</strong> Isolation points, leak response, shutdown
            </li>
            <li>
              <strong>Maintenance requirements:</strong> Filter changes, leak checks, service
              intervals
            </li>
            <li>
              <strong>Warranties:</strong> Equipment warranties, registration requirements
            </li>
            <li>
              <strong>Training sign-off:</strong> Attendee list, competence confirmation
            </li>
            <li>
              <strong>Contacts:</strong> Installer, manufacturer, emergency callout
            </li>
          </ul>
          <p>
            <strong>Mandatory Leak Check Frequencies (F-Gas)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>&lt;5 tonnes CO2e:</strong> No mandatory check — N/A
            </li>
            <li>
              <strong>5-50 tonnes CO2e:</strong> Annually — Every 2 years
            </li>
            <li>
              <strong>50-500 tonnes CO2e:</strong> Every 6 months — Annually
            </li>
            <li>
              <strong>&gt;500 tonnes CO2e:</strong> Every 3 months — Every 6 months
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Test pressure: <strong>1.1 x maximum allowable pressure</strong>
            </li>
            <li>
              Evacuation target: <strong>&lt;500 microns (0.67 mbar)</strong>
            </li>
            <li>
              Normal superheat: <strong>5-8 K</strong> (TXV systems)
            </li>
            <li>
              Normal subcooling: <strong>5-10 K</strong>
            </li>
            <li>
              Leak detector sensitivity: <strong>5 g/year minimum</strong>
            </li>
            <li>
              F-Gas record retention: <strong>5 years minimum</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Insufficient evacuation:</strong> Moisture causes acid formation and
                compressor failure
              </li>
              <li>
                <strong>Liquid slugging:</strong> Never charge liquid refrigerant into suction side
              </li>
              <li>
                <strong>Wrong charge calculation:</strong> Always follow manufacturer pipe length
                factors
              </li>
              <li>
                <strong>Missing F-Gas records:</strong> Legal requirement - penalties for
                non-compliance
              </li>
              <li>
                <strong>Incomplete handover:</strong> O&M manuals and training essential for
                warranty
              </li>
            </ul>
          }
