  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Faulty or poorly maintained instruments can give misleading results, create safety hazards, or expose users to electric shock.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'A comprehensive visual inspection should cover the instrument casing, test leads, probes, and internal fuses where accessible.',
    },
    {
      id: 3,
      ...
      correctAnswer: 1,
      explanation:
        'GS38 compliance ensures probe tips are properly shrouded and finger guards are present to prevent accidental contact with live conductors.',
    },
    {
      id: 4,
      ...
      options: [
        ...
        'Check the calibration sticker only',
      ],
      correctAnswer: 1,
      explanation:
        'Testing against a proving unit or known live supply confirms the instrument correctly detects and indicates the presence of voltage.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        "The Prove-Test-Prove procedure ensures the instrument was working correctly before the test and hasn't failed during the testing process.",
    },
    {
      id: 6,
      question: 'What is the role of calibration in test equipment?',
      options: [
        'To make instruments look professional',
      ...
      correctAnswer: 1,
      explanation:
        'Calibration ensures instruments provide accurate readings within specified tolerance limits, essential for reliable test results.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'False. Distribution boards require CAT III rated instruments as they can safely handle the higher energy transients present at distribution level.',
    },
    {
      id: 8,
      ...
      options: [
        ...
        'Fix it yourself',
        'Use it for non-critical tests only',
      ],
      correctAnswer: 1,
      explanation:
        'Any instrument that fails safety checks must be immediately removed from service and reported to prevent unsafe use.',
    },
    {
      id: 9,
      ...
      options: [
        ...
        'Poor test lead condition',
        'Incorrect calibration',
      ],
      correctAnswer: 1,
      explanation:
        "The voltage indicator's internal fuse had blown months earlier, causing it to fail to register live voltage, but this wasn't detected due to lack of proving checks.",
    },
    {
      id: 10,
      question: 'How did the apprentice in the second example confirm isolation correctly?',
      options: [
        'Used a non-contact tester only',
        'Followed the Prove-Test-Prove procedure with a proving unit',
        'Checked the switch position',
        'Asked a colleague to confirm',
      ],
      correctAnswer: 1,
      explanation:
        'The apprentice properly used a proving unit to verify the voltage indicator worked before testing, confirming the circuit was live, then dead after isolation.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-10">
            <p className="text-white/80 leading-relaxed">
              ...
              learning how to check equipment before use is just as important as learning how to
              operate it. Instruments must be inspected, proven safe, and verified for accuracy
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-4">
              <div className="space-y-4 text-sm text-white/80">
                <p>
                  ...
                  could expose internal components. Any damage to the casing can compromise both
                  safety and measurement accuracy. Look for signs of impact damage, overheating, or
                  chemical corrosion.
                </p>

                <p>
                  <strong className="text-white">Test lead condition:</strong> Examine the entire
                  length for cuts, kinks, or damage. Pay special attention to connection points
                  where stress concentrates, particularly at the instrument and probe ends. Damaged
                  insulation can expose conductors, creating shock risks.
                </p>

                <p>
                  <strong className="text-white">GS38 probe compliance:</strong> Probe tips must be
                  shrouded to expose no more than 2mm of conductor. Finger guards and insulated
                  shafts are mandatory for safety. Check that probe shrouds are intact and properly
                  secured — loose or damaged shrouds defeat the safety protection.
                </p>

                <p>
                  <strong className="text-white">Internal fuse verification:</strong> Where
                  accessible, verify fuses are the correct rating and type as specified by the
                  manufacturer. Blown or incorrect fuses can render safety features ineffective or
            ...
            <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50 mb-4">
              <div className="space-y-4 text-sm text-white/80">
                <p>
                  ...
                  Essential for voltage indicators and non-contact testers. Proving units provide a
                  controlled, safe means of verifying instrument operation without relying on live
                  electrical systems.
                </p>

                <p>
                  <strong className="text-white">Known live supply verification:</strong> Using a
                  confirmed live source to verify the instrument detects voltage correctly. This
                  method requires certainty that the supply is indeed live — never assume a supply
                  is live without independent verification.
                </p>

                <p>
                  <strong className="text-white">The Prove-Test-Prove sequence:</strong> Test the
                  instrument on a known live source, perform the actual isolation test, then retest
                  on the live source to confirm continued operation. This critical safety procedure
                  ensures the instrument was working before testing and hasn't failed during the
                  process.
                </p>

                <p>
                  <strong className="text-white">Continuity function verification:</strong> Test
                  continuity function using a short test lead or known low-resistance path to ensure
                  accurate readings. The instrument should display near-zero resistance, typically
                  less than 0.01Ω, confirming the measurement circuit is functioning correctly.
                </p>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50 mb-4">
              <div className="space-y-4 text-sm text-white/80">
                <p>
                  ...
                  Formal documentation proving the instrument meets accuracy standards within
                  specified tolerance limits. Required for certification work and compliance with
                  quality management systems. Certificates must show traceability to national
                  standards.
                </p>

                <p>
                  <strong className="text-white">Calibration intervals and schedules:</strong>{' '}
                  Typically 12 months for precision instruments used in electrical installation
                  testing, though manufacturers may specify different periods based on usage
                  patterns. Heavy use or harsh environments may require more frequent calibration.
                </p>

                <p>
                  <strong className="text-white">
                    Tolerance limits and accuracy requirements:
                  </strong>{' '}
                  Instruments must read within specified accuracy bands (e.g., ±2% of reading ±2
                  digits for insulation resistance testers) to be considered reliable for
                  professional use. These tolerances are defined by relevant standards such as BS EN
                  61557.
                </p>

                <p>
                  <strong className="text-white">Calibration failure implications:</strong> Using
                  instruments with expired calibration invalidates test results and may breach
                  professional standards or insurance requirements. Uncalibrated instruments may
                  still function but their readings cannot be trusted for compliance certification.
                </p>
              </div>
            </div>
            ...
            <InlineCheck
              ...
              options={[
                ...
                'Annually',
                'Every 2 years',
                'Only when they appear inaccurate',
              ]}
              correctIndex={1}
            ...
            <div className="p-4 rounded-lg bg-red-500/5 border-l-2 border-red-500/50 mb-4">
              <div className="space-y-4 text-sm text-white/80">
                <p>
                  ...
                  voltage 300V to earth. Suitable for final circuit testing but not distribution
                  systems.
                </p>

                <p>
                  <strong className="text-white">CAT III - Distribution level systems:</strong>{' '}
                  Required for fixed installations, distribution boards, and feeder circuits.
                  Designed for higher energy transients that can occur in distribution systems.
                  Essential for testing at consumer units and fixed wiring systems.
                </p>

                <p>
                  <strong className="text-white">CAT IV - Primary supply level:</strong> Designed
                  for overhead lines, underground cables, and service entrance equipment. Highest
                  energy rating for utility supply systems. Required for testing at meter positions
                  and service heads.
                </p>

                <p>
                  <strong className="text-white">Energy withstand and safety implications:</strong>{' '}
                  Using a lower-rated instrument on a higher-energy system creates serious safety
                  risks. Higher categories can safely handle greater transient energies during
                  switching operations, fault conditions, or lightning-induced surges.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-red-500/5 border-l-2 border-red-500/50">
                ...
                <p className="text-sm text-white/80 leading-relaxed">
                  ...
                  the instrument's internal fuse had blown months earlier, but because no checks
                  were carried out, the fault went unnoticed.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
                ...
                <p className="text-sm text-white/80 leading-relaxed">
                  ...
                  ensured there was no chance of a false reading. This method provided absolute
                  confidence that the circuit was safe.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-white/80 leading-relaxed">
                ...
                ensures accuracy over time, and instruments must always be category-rated for the
                system under test. Using unchecked or faulty instruments puts electricians and
                clients at risk. A disciplined checking routine ensures safe, reliable results every
                time.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            <Quiz
              ...
              title="Test Your Knowledge: Checking Instruments for Safety and Accuracy"
            />
          </section>
