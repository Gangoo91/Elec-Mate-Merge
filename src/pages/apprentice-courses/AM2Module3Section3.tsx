        ...
        <div className="space-y-6 text-xs sm:text-sm text-white">
          ...
          <div className="bg-white/5 border border-red-500/30 rounded-xl p-4">
            ...
            <ul className="space-y-1 text-sm text-white">
              ...
              <li>
                <strong className="text-red-400">Poor conductor identification</strong> - Confusion
                during testing and future maintenance
              </li>
              <li>
                <strong className="text-red-400">Loose terminations</strong> - Arcing, overheating,
                fire risk
              </li>
              <li>
                <strong className="text-red-400">Exposed copper at terminals</strong> - Risk of
                short circuit and electrocution
              </li>
              <li>
                <strong className="text-red-400">CPC not sleeved</strong> - Identification failure,
                doesn't meet BS7671
              </li>
              <li>
                <strong className="text-red-400">Cable damaged during installation</strong> -
        ...
        <div className="space-y-6 text-xs sm:text-sm text-white">
          ...
          <div className="bg-white/5 border border-red-500/30 rounded-xl p-4">
            ...
            <ul className="space-y-1 text-sm text-white">
              ...
              <li>
                <strong className="text-red-400">Using wrong cable types</strong> - Twin & earth
                instead of 3-core between switches
              </li>
              <li>
                <strong className="text-red-400">Poor conductor identification</strong> - Confusion
                about which strapper is which
              </li>
              <li>
                <strong className="text-red-400">Neutral through switch terminals</strong> -
                Dangerous and incorrect practice
              </li>
              <li>
                <strong className="text-red-400">CPC not continuous</strong> - Safety regulation
                failure
              </li>
              <li>
                <strong className="text-red-400">Mixed up COM terminals</strong> - Circuit
        ...
        <div className="space-y-6 text-xs sm:text-sm text-white">
          ...
          <div className="bg-white/5 border border-red-500/30 rounded-xl p-4">
            ...
            <ul className="space-y-1 text-sm text-white">
              ...
              <li>
                <strong className="text-red-400">Poor strapper identification</strong> - Impossible
                to trace faults
              </li>
              <li>
                <strong className="text-red-400">Using 4-core cable</strong> - Not required, wastes
                conductor
              </li>
              <li>
                <strong className="text-red-400">Neutral through intermediate</strong> - Bypass all
                switches completely
              </li>
              <li>
                <strong className="text-red-400">Inconsistent sleeving</strong> - Testing and
