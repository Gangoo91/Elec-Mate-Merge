...
const AM2Module3Section3 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['All wires', 'Neutral wire', 'Live wire', 'Earth wire'],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: ['4 terminals', '3 terminals', '2 terminals', '6 terminals'],
      correctAnswer: 0,
      explanation:
    ...
    },
    {
      ...
      options: ['Twin & earth cable', '3-core & earth cable', 'Flex cable', 'Single core cable'],
      correctAnswer: 1,
      explanation:
    ...
    },
    {
      ...
      options: ['Brown conductor', 'Green/yellow conductor', 'Blue conductor', 'Black conductor'],
      correctAnswer: 2,
      explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Master lighting circuit installation for AM2 assessment - one-way, two-way, and
          intermediate switching with professional workmanship standards.
        </p>
        ...
        <ConceptBlock title="1. One-Way Switching - Complete Installation Guide">
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              earth cable. Ensure adequate support every 300mm horizontally, 400mm vertically. Cable
              must be mechanically protected where required.
            </li>
            <li>
              <strong>Continue cable from switch to ceiling rose.</strong> Maintain cable integrity.
              No joints in inaccessible areas. Use proper cable entry methods into back boxes and
              ceiling roses.
            </li>
            <li>
              <strong>Strip cable ends - Switch: 15mm, Ceiling rose: 20mm.</strong> Use proper cable
              strippers. No damage to conductor cores. Remove exactly the right amount of sheath -
              too much exposes cable, too little prevents proper termination.
            </li>
            <li>
              <strong>Apply green/yellow sleeving to CPC at both ends.</strong> Sleeving must cover
              all exposed copper CPC. Ensure sleeving doesn't interfere with terminations.
            </li>
          </ol>
          <p>
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70" start={5}>
            <li>
              <strong>Connect live feed (brown) to COM terminal.</strong> This is the permanent live
              from the consumer unit. Ensure tight connection with no exposed copper outside
              terminal.
            </li>
            <li>
            ...
            <li>
              ...
              bypass the switch. Use proper connector block rated for the application. No joints in
              switch back box if possible.
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Exposed copper at terminals</strong> - Risk of short circuit and electrocution
            </li>
            <li>
          ...
          <p>
            <strong className="text-elec-yellow">Key Point:</strong> In one-way switching, only the
            live conductor is switched. The neutral must go directly to the fitting, not through the
            switch terminals.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              you'll be fitting a BS 67 ceiling rose or a BS EN 60598 luminaire. Don't make a joint
              in the void with a connector block and tape it up; that's not on the list.
            </>
          }
        ...
        <ConceptBlock title="2. Two-Way Switching - Complete Installation Guide">
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              carries the permanent live feed. Ensure proper cable support and protection throughout
              run.
            </li>
            <li>
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70" start={4}>
            <li>
              <strong>Connect permanent live (brown) to COM terminal.</strong> This is the live feed
              from the consumer unit. Ensure maximum contact area and tight connection.
            </li>
            <li>
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70" start={7}>
            <li>
              ...
              light fitting. When either switch position allows continuity through strappers, light
              will operate.
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Incorrect strapper connections</strong> - Light operates from one switch only
            </li>
            <li>
          ...
          <p>
            ...
            connections means one switch position won't work. Always check both switches operate the
        ...
        <ConceptBlock title="3. Intermediate Switching - Complete Installation Guide">
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Run 3-core & earth from first two-way to intermediate switch.</strong> Carries
              the two strappers from first switch. Plan cable route to avoid damage.
            </li>
            <li>
              <strong>Run 3-core & earth from intermediate to final two-way switch.</strong> Carries
              modified strapper signals to final switch. Multiple intermediates can be chained.
            </li>
          </ol>
          <p>
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70" start={4}>
            <li>
              <strong>Connect first strapper from Switch 1 to Terminal 1.</strong> Input from L1 of
              first two-way switch. Maintains brown identification sleeving.
            </li>
            <li>
              <strong>Connect second strapper from Switch 1 to Terminal 2.</strong> Input from L2 of
              first two-way switch. Maintains black identification sleeving.
            </li>
            <li>
            ...
            <li>
              <strong>Connect second strapper to Switch 2 from Terminal 4.</strong> Output to L2 of
              final two-way switch. Complete strapper circuit through intermediate.
            </li>
          </ol>
          <p>
          ...
          <p>
            <strong>How Intermediate Switching Works — Internal Crossing:</strong> The intermediate
            switch internally crosses its connections when operated. This allows it to "reverse" the
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              turns the light on and off correctly. Switch B does nothing — light stays in whatever
              state Switch A left it. Cabling is correct, all terminations look tight, nothing
              tripped.
            </>
          }
          whatToDo={
          ...
          whyItMatters={
            <>
              Two-way switching is one of the most common AM2 fail points because the cabling "looks
              right" — both switches operate, both have continuity, but the logic is broken.
              Catching it dead with a continuity test before energising is what an assessor expects
              to see.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Power Circuits</div>
          </button>
          <button
