      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Radiator output:</strong> Rated at Delta T 50K, correct for actual
                conditions
              </li>
              <li className="pl-1">
                <strong>Pipe sizing:</strong> Balance velocity (&lt;1.5 m/s) with pressure drop
              </li>
              <li className="pl-1">
                <strong>Index circuit:</strong> Path with highest resistance determines pump size
              </li>
              <li className="pl-1">
                <strong>TRVs:</strong> Sense room temp, modulate radiator flow
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Two-pipe systems:</strong> Constant flow temp to all radiators
              </li>
              <li className="pl-1">
                <strong>Balancing:</strong> Equal heat-up time using lockshield valves
              </li>
              <li className="pl-1">
                <strong>Bypass:</strong> Essential when TRVs installed throughout
              </li>
              <li className="pl-1">
                <strong>Pump sizing:</strong> Match to index circuit plus margin
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Standard Test Conditions (BS EN 442):
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Radiator Types and Output Comparison:
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Design tip:</strong> Size main distribution pipes generously (lower velocity)
              to reduce total pressure drop and allow for future additions.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                TRV Settings and Temperature Guide:
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Room with thermostat:</strong> Do NOT fit TRV - radiator must always
                  respond to room stat
                </li>
                <li className="pl-1">
                  <strong>Bypass valve:</strong> Required when all other radiators have TRVs
                </li>
                <li className="pl-1">
                  <strong>Sensor position:</strong> Must sense room air, not radiant heat from
                  radiator
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Remote sensor:</strong> Sensor on capillary tube, placed away from
                  radiator heat
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Opens when differential pressure exceeds setpoint (typically 10-15 kPa)
                </li>
          ...
          <div className="text-white space-y-6 leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2">
                  1. Identify all possible flow paths (pump to each radiator and back)
                </p>
                ...
                <p className="mt-2 text-green-400">
                  Usually the most distant radiator, but not always!
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="mt-4">
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    Select pump where operating point is in efficient range (mid-curve)
                  </li>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                Two-Pipe System Characteristics
              </h3>
              <p className="text-sm text-white mb-3">
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Complete Radiator System Design
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Heat Pump Radiator Upsizing
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> An existing radiator rated 2kW at Delta T 50K is to be
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Balancing Temperature Measurement
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> During balancing, the index radiator has flow 68 degrees
