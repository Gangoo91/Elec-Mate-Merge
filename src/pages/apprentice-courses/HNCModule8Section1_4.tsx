...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Delta T 60K', 'Delta T 30K', 'Delta T 50K', 'Delta T 40K'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1.0 m/s', '1.5 m/s', '2.5 m/s', '0.5 m/s'],
    correctAnswer: 1,
    explanation:
...
const HNCModule8Section1_4 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 1 · Subsection 4"
        title="Radiator Systems"
        backTo="/study-centre/apprentice/h-n-c-module8-section1"
      />
      <HubBody>
        ...
        <ConceptBlock title="Radiator Heat Output and Delta T">
          <p>
            Radiator output depends on the temperature difference between the water inside the
            radiator and the surrounding room air. This difference is called Delta T (temperature
            difference). Understanding Delta T is crucial for correctly sizing radiators.
          </p>
          <p>
            <strong>Understanding Delta T</strong>
          </p>
          <p>Mean Water Temp</p>
          <p>(Flow + Return) / 2</p>
          <p>-</p>
          ...
          <p>
            <strong>Delta T = Mean Water Temp - Room Temp</strong>
          </p>
          <p>
            <strong>Standard Test Conditions (BS EN 442):</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Delta T = 70 - 20 = 50K</strong> (standard rating condition)
            </li>
          </ul>
          <p>
            <strong>Delta T Correction Factors</strong>
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>50:</strong> 1.00 — Traditional boiler system
            </li>
            <li>
              <strong>45:</strong> 0.88 — Condensing boiler optimised
            </li>
            <li>
              <strong>40:</strong> 0.79 — Low temperature system
            </li>
            <li>
              <strong>35:</strong> 0.67 — Heat pump hybrid
            </li>
            <li>
              <strong>30:</strong> 0.56 — Air source heat pump
            </li>
            <li>
              <strong>25:</strong> 0.45 — Ground source heat pump
            </li>
          </ul>
          <p>Formula: Correction factor = (Delta T / 50)^1.3 approximately</p>
          <p>
            <strong>Worked Example: Radiator Selection</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Step 1:</strong> Calculate Delta T
          </p>
          <p>Mean water temp = (70 + 50) / 2 = 60 degrees C</p>
          <p>Delta T = 60 - 21 = 39K</p>
          <p>
            <strong>Step 2:</strong> Find correction factor
          </p>
          <p>Factor for Delta T 39K is approximately 0.76</p>
          <p>
            <strong>Step 3:</strong> Calculate required rated output
          </p>
          <p>Required = Heat loss / Factor = 1800 / 0.76 = 2368W</p>
          <p>
            <strong>Step 4:</strong> Add design margin (10%)
          </p>
          <p>
            Specified output = 2368 x 1.1 = <strong>2605W at Delta T 50K</strong>
          </p>
          <p>Select radiator rated at 2600W or greater</p>
          <p>
            <strong>Radiator Types and Output Comparison:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type 10:</strong> Single panel, no fins — 50%
            </li>
            <li>
              <strong>Type 11:</strong> Single panel, single convector — 100% (base)
            </li>
            <li>
              <strong>Type 21:</strong> Double panel, single convector — 150%
            </li>
            <li>
              <strong>Type 22:</strong> Double panel, double convector — 200%
            </li>
            <li>
              <strong>Type 33:</strong> Triple panel, triple convector — 280%
            </li>
          </ul>
          <p>
            <strong>Remember:</strong> Lower flow temperatures (for heat pumps) require
            significantly larger radiators or alternative emitters like underfloor heating.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Pipe Sizing and Pressure Drop">
          <p>
            Correct pipe sizing ensures adequate water flow to all radiators without excessive noise
            or energy consumption. The key factors are water velocity and pressure drop.
          </p>
          <p>
            <strong>Pipe Sizing Principles</strong>
          </p>
          <p>Velocity Limit</p>
          ...
          <p>
            Q = 0.0239 L/s = 1.43 L/min = <strong>86 L/hour</strong>
          </p>
          <p>
            <strong>Copper Pipe Sizing Guide</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>10mm:</strong> 0.07 L/s (4.2 L/min) — Up to 3kW
            </li>
            <li>
              <strong>15mm:</strong> 0.18 L/s (11 L/min) — Up to 9kW
            </li>
            <li>
              <strong>22mm:</strong> 0.45 L/s (27 L/min) — Up to 22kW
            </li>
            <li>
              <strong>28mm:</strong> 0.75 L/s (45 L/min) — Up to 37kW
            </li>
            <li>
              <strong>35mm:</strong> 1.24 L/s (74 L/min) — Up to 62kW
            </li>
          </ul>
          <p>Heat load assumes 20K temperature drop. Reduce for lower Delta T systems.</p>
          <p>
            <strong>Pressure Drop Components:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pipe friction:</strong> Use published tables (Pa/m for flow rate)
            </li>
            <li>
              <strong>Fittings:</strong> Add 30-50% to straight pipe losses
            </li>
            <li>
              <strong>Radiator valves:</strong> Typically 1-5 kPa each depending on opening
            </li>
            <li>
              <strong>TRVs:</strong> 3-10 kPa when fully open
            </li>
            <li>
              <strong>Boiler/heat source:</strong> Check manufacturer data (typically 10-30 kPa)
            </li>
          </ul>
          <p>
            <strong>Pressure Drop Worked Example</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Design tip:</strong> Size main distribution pipes generously (lower velocity) to
            reduce total pressure drop and allow for future additions.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="TRVs and System Control">
          ...
          <p>
            <strong>TRV Operating Principle</strong>
          </p>
          ...
          <p>
            <strong>3. Flow Modulation</strong>
          </p>
          <p>Pin movement adjusts valve opening and water flow</p>
          <p>
            <strong>TRV Settings and Temperature Guide:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>* (frost):</strong> 6-8 degrees C — Frost protection only
            </li>
            <li>
              <strong>1:</strong> 12 degrees C — Unoccupied rooms, storage
            </li>
            <li>
              <strong>2:</strong> 16 degrees C — Hallways, utility rooms
            </li>
            <li>
              <strong>3:</strong> 20 degrees C — Living rooms (recommended)
            </li>
            <li>
              <strong>4:</strong> 24 degrees C — Bathrooms
            </li>
            <li>
              <strong>5:</strong> 28 degrees C — Maximum - rarely needed
            </li>
          </ul>
          <p>
            <strong>Critical Installation Rules</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Room with thermostat:</strong> Do NOT fit TRV - radiator must always respond
              to room stat
            </li>
            <li>
              <strong>Bypass valve:</strong> Required when all other radiators have TRVs
            </li>
            <li>
              <strong>Sensor position:</strong> Must sense room air, not radiant heat from radiator
            </li>
            <li>
              <strong>Minimum one radiator:</strong> Without TRV to ensure minimum system flow
            </li>
          </ul>
          <p>
            <strong>TRV Types:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Standard wax element:</strong> Most common, reliable, 2-3 degrees C
              proportional band
            </li>
            <li>
              <strong>Liquid-filled:</strong> Faster response, more accurate, higher cost
            </li>
            <li>
              <strong>Remote sensor:</strong> Sensor on capillary tube, placed away from radiator
              heat
            </li>
            <li>
              <strong>Programmable electronic:</strong> Time scheduling, remote control, highest
              accuracy
            </li>
          </ul>
          <p>
            <strong>Bypass Valve Function</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Building Regulations:</strong> Part L requires TRVs on all radiators in new
            installations, except in rooms with a room thermostat.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="System Balancing and Pump Sizing">
          <p>
            <strong>The Index Circuit</strong>
          </p>
          <p>
            The index circuit is the flow path from pump through the system that has the highest
          ...
          <p>
            <strong>Pump Sizing</strong>
          </p>
          <p>
            The pump must provide adequate head to overcome the index circuit resistance whilst
            delivering the design flow rate.
          </p>
          <p>
            <strong>Flow Rate Required:</strong>
          </p>
          <p>Q = Total heat / (4186 x Delta T)</p>
          <p>Example: 15kW / (4186 x 20) = 0.18 L/s</p>
          <p>
            <strong>Head Required:</strong>
          </p>
          <p>H = Index circuit drop x 1.15 to 1.25</p>
          <p>Example: 30 kPa x 1.2 = 36 kPa head</p>
          <p>
            <strong>Pump Selection Process:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>System Balancing Procedure</strong>
          </p>
          <p>
            Balancing ensures all radiators reach design temperature simultaneously by adjusting
          ...
          <p>
            <strong>Target Temperature Drop:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Traditional boiler:</strong> 20K — 18-22K
            </li>
            <li>
              <strong>Condensing boiler:</strong> 20K — 18-25K (higher = more condensing)
            </li>
            <li>
              <strong>Heat pump:</strong> 5-7K — 5-10K
            </li>
          </ul>
          <p>
            <strong>Two-Pipe System Characteristics</strong>
          </p>
          <p>
            Two-pipe systems have separate flow and return mains, with each radiator receiving water
            at full flow temperature.
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Step 2: Room Heat Loads and Radiator Sizing</strong>
          </p>
          ...
          <p>
            <strong>Question:</strong> An existing radiator rated 2kW at Delta T 50K is to be used
            with a heat pump at flow 45 degrees C, return 40 degrees C, room 20 degrees C. Will it
            be adequate for a room heat loss of 1.2kW?
          </p>
          <p>
          ...
          <p>
            <strong>Find correction factor:</strong>
          </p>
          <p>Factor = (22.5 / 50)^1.3 = 0.45^1.3 = 0.36</p>
          <p>
            <strong>Calculate actual output:</strong>
          </p>
          <p>
            Actual output = 2000 x 0.36 = <strong>720W</strong>
          </p>
          <p>
            <strong>Compare to requirement:</strong>
          </p>
          <p>Required: 1200W, Available: 720W</p>
          <p>Shortfall: 480W - radiator is NOT adequate</p>
          <p>
            <strong>Required rated output:</strong>
          </p>
          ...
          <p>
            <strong>Question:</strong> During balancing, the index radiator has flow 68 degrees C
            and return 48 degrees C. A nearby radiator shows flow 70 degrees C and return 42 degrees
            C. What adjustment is needed?
          </p>
          <p>
          ...
          <p>
            <strong>Nearby radiator (to adjust):</strong>
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Mean water temp = (Flow + Return) / 2</strong>
            </li>
            <li>
              <strong>Flow rate Q = Heat (W) / (4186 x Delta T)</strong>
            </li>
            <li>
              <strong>Corrected output = Rated output x (actual Delta T / 50)^1.3</strong>
            </li>
            <li>
              <strong>Pump head = Index circuit pressure drop x 1.15 to 1.25</strong>
            </li>
          </ul>
          <p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Ignoring Delta T correction:</strong> Undersized radiators for low-temp
                systems
              </li>
              <li>
                <strong>No system balancing:</strong> Near radiators too hot, far ones too cold
              </li>
              <li>
                <strong>TRV on thermostat room:</strong> Boiler runs continuously
              </li>
              <li>
                <strong>Undersized pipes:</strong> Noise, high pressure drop, pump failure
              </li>
              <li>
                <strong>No bypass:</strong> Pump damage when TRVs close
              </li>
            </ul>
          }
