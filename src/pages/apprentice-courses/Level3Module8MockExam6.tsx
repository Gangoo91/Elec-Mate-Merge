                ...
                <div className="grid gap-2 sm:gap-2">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm sm:text-sm text-white leading-relaxed">
                      30 questions randomly selected from 200 Module 6 questions
                    </p>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 sm:h-1.5 sm:w-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 sm:h-1.5 sm:w-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0" />
                    <p className="text-sm sm:text-sm text-white leading-relaxed">
                      Topics: Design Principles, Load Calculations, Cable Selection, Protection,
                      Earthing & Bonding
                    </p>
                  </div>
                </div>
            ...
            <CardContent className="space-y-4 sm:space-y-6 px-3 sm:px-6">
              ...
              <div className="flex flex-col gap-3 pt-2">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Link
                    to="/study-centre/apprentice/level3-course/module8-section6"
                    className="flex-1"
                  >
                    <Button
                      variant="outline"
