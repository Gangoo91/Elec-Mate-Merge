...
import {
  ...
  type Question,
  M6_SECTION_TOPIC,
} from '@/data/apprentice-courses/level3/module6/questionBank';
...
const Level3Module8MockExam6 = () => {
  ...
  const examExit = useExamExit('/study-centre/apprentice/level3-course/module8-section6');
  ...
  const history = useMockExamHistory('level3-module8-mock6', user?.id ?? null);
  const failureRates = useQuestionFailureRates(
    'level3-module8-mock6',
  ...
  useEffect(() => {
    ...
    recordMockExamAttempt({
      examSlug: 'level3-module8-mock6',
      source: 'in_app',
      examName: 'Level 3 Mock Exam 6',
      questions: examQuestions,
