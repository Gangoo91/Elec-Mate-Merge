...
const DESCRIPTION =
  'Learn the fundamentals of load estimation and circuit requirements in electrical design, covering calculation methods, diversity factors, and BS 7671 compliance for UK installations.';
...
const quickCheckQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'True or False: All appliances in a house are assumed to be used at the same time when calculating load.',
    options: ['True', 'False'],
    correctIndex: 1,
    explanation:
      'False - diversity factors are applied because not all appliances are used simultaneously.',
  },
  {
    id: 3,
...
const Module5Section2_2 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 0,
      explanation:
        'Underestimating loads can lead to overheating cables or constant breaker tripping.',
    },
    {
      id: 5,
    ...
    },
    {
      ...
      options: [
        'It reduces the assumed load because not all appliances are used simultaneously',
        'It increases the cable size needed for every circuit',
        'It guarantees every appliance runs at full power at once',
        'It removes the need for any protective devices',
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Reduced voltage drop across the cable',
        'Cable overheating, breaker tripping, or fire risk',
        'Improved insulation resistance over time',
        'A lower earth fault loop impedance reading',
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'The smallest possible consumer unit',
      ],
      correctAnswer: 2,
  ...
  const faqs = [
    {
      ...
      answer:
        'List all equipment with their power ratings, convert to current using I = P ÷ V, apply appropriate diversity factors, and sum the results to get maximum demand.',
    },
    {
      question: 'What diversity factors should I apply?',
      answer:
        'Diversity varies by application - typically 40-60% for socket outlets, 66% for lighting, and 100% for fixed appliances like cookers and immersion heaters.',
    },
    {
      question: 'How do I size protective devices correctly?',
      answer:
        "The protective device must be rated to protect the cable but also carry the expected load. It should not exceed the cable's current-carrying capacity.",
    },
    {
      question: 'What happens if I overestimate the load?',
      answer:
        "Overestimating leads to oversized cables and protective devices, increasing material costs unnecessarily, though it's safer than underestimating.",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="text-center mb-12">
            <div className="inline-flex items-center gap-2 text-elec-yellow text-sm mb-3">
              ...
              <span className="text-white">Section 5.2.2</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">
              Load Estimation and Circuit Requirements
            </h1>
            <p className="text-white text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
              Master the fundamentals of calculating electrical loads and planning circuit
              requirements in line with BS 7671 regulations.
            </p>
          </header>
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <ul className="text-white text-sm space-y-1 list-disc pl-4">
                  <li>
                    <strong>Spot:</strong> Ring final (32A, 2.5mm²), lighting (6A, 1.5mm²).
                  </li>
                  <li>
                    <strong>Use:</strong> BS 7671 Reg 433.1/434.1 for protection.
                  </li>
                  <li>
                    <strong>Check:</strong> Cable size matches protective device rating.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <ul className="text-white space-y-2 list-disc pl-6">
              ...
              <li>
                Identify typical circuit requirements for domestic and commercial installations.
              </li>
          ...
          <section className="mb-10">
            ...
            <p className="text-white mb-4">
              Load estimation involves calculating the electrical demand of an installation to
              ensure circuits can safely handle the expected current.
            </p>
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-white mb-2">
                    <strong>Definition:</strong> Load estimation = calculating the electrical demand
                    of an installation (in watts or kilowatts).
                  </p>
                  <p className="text-white text-sm">
                    This involves determining how much electrical energy your circuit or
                    installation will actually use under normal and maximum demand conditions.
                  </p>
                </div>

                <div>
                  <p className="text-white mb-2">
                    <strong>The Basic Formula:</strong> I = P ÷ V
                  </p>
                  <div className="p-3 bg-white/5 rounded mb-2">
                    <ul className="text-white text-sm space-y-1">
                      <li>
                        <strong>I</strong> = Current in amperes (A)
                      </li>
                      <li>
                        <strong>P</strong> = Power in watts (W)
                      </li>
                      <li>
                        <strong>V</strong> = Voltage in volts (V)
                      </li>
                    </ul>
                  </div>
                  <div className="p-2 bg-blue-500/10 rounded text-sm text-white border border-blue-500/30">
                ...
                <div>
                  <p className="text-white mb-2">
                    <strong>Step-by-Step Load Calculation Process:</strong>
                  </p>
                  <ol className="text-white text-sm space-y-1 list-decimal pl-4">
                    <li>
                      <strong>Inventory all equipment:</strong> List every appliance, light, and
                      electrical device
                    </li>
                    <li>
                      <strong>Identify power ratings:</strong> Check nameplates, specifications, or
                      manufacturer data
                    </li>
                    <li>
                      <strong>Calculate individual currents:</strong> Use I = P ÷ V for each item
                    </li>
                    <li>
                      <strong>Group by circuit type:</strong> Separate lighting, heating, sockets,
                      etc.
                    </li>
                    <li>
                      <strong>Apply diversity factors:</strong> Account for non-simultaneous use
                    </li>
                    <li>
                      <strong>Sum maximum demand:</strong> Add up the realistic maximum load
                    </li>
                    <li>
                      <strong>Add safety margin:</strong> Include 10-20% for future expansion
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  <p className="text-white mb-2">
                    <strong>Types of Electrical Loads:</strong>
                  </p>
                ...
                <div className="p-3 bg-green-500/10 rounded border border-green-500/30">
                  <p className="font-medium text-green-400 mb-2 text-sm">
                    Worked Example: Small Kitchen
                  </p>
                  <div className="text-white text-sm space-y-1">
                    ...
                    <p>
                      <strong>Total connected load:</strong> 31.7A
                    </p>
                    <p>
                      <strong>With 60% diversity:</strong> 31.7A × 0.6 = 19.0A
                    </p>
                    <p>
                      <strong>Recommended circuit:</strong> 20A or 32A MCB with 2.5mm² cable
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-10">
            ...
            <p className="text-white mb-4">
              Circuits must be designed to handle expected loads safely whilst providing adequate
              protection:
            </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50 mb-6">
              <p className="font-semibold text-green-400 mb-3">
                Essential Circuit Design Requirements
              </p>

              <div className="space-y-4">
                <div>
                  <p className="text-white mb-2">
                    <strong>Current handling:</strong> Handle the expected current safely.
                  </p>
                  <ul className="text-white text-sm space-y-1 list-disc pl-4">
                ...
                <div>
                  <p className="text-white mb-2">
                    <strong>Protection:</strong> Protect cables from overload and fault current.
                  </p>
                  <ul className="text-white text-sm space-y-1 list-disc pl-4">
                ...
                <div>
                  <p className="text-white mb-2">
                    <strong>Voltage drop:</strong> Supply equipment without excessive voltage drop.
                  </p>
                  <ul className="text-white text-sm space-y-1 list-disc pl-4">
              ...
              <div className="mt-4 p-2 bg-white/5 rounded text-sm text-white">
                <strong>Key principle:</strong> Circuit design must balance safety, functionality,
                and economy
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <p className="text-white mb-4">
              Diversity factors recognise that not all equipment operates simultaneously, allowing
              for realistic load calculations:
            </p>
            ...
            <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50 mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-white mb-2">
                    <strong>Concept:</strong> Not all equipment is used at the same time.
                  </p>
                  <ul className="text-white text-sm space-y-1 list-disc pl-4">
                ...
                <div>
                  <p className="text-white mb-2">
                    <strong>Typical diversity factors:</strong>
                  </p>
                  <ul className="text-white text-sm space-y-1 list-disc pl-4">
              ...
              <div className="mt-4 p-2 bg-white/5 rounded text-sm text-white">
                <strong>Example:</strong> In a domestic kitchen, not all appliances (kettle, oven,
                microwave) will run simultaneously
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <ul className="text-white space-y-2 text-sm">
                <li>
                  <strong>Lighting circuits:</strong> 6 A MCB, 1.0/1.5 mm² cable.
                </li>
                <li>
                  <strong>Ring final circuit:</strong> 32 A MCB, 2.5 mm² cable.
                </li>
                <li>
                  <strong>Cooker circuit:</strong> 30/32 A MCB, 6 mm² cable.
                </li>
                <li>
                  <strong>Immersion heater:</strong> 16 A MCB, 2.5 mm² cable.
                </li>
                <li>
                  <strong>Electric shower:</strong> 40/45 A MCB, 10 mm² cable.
                </li>
                <li>
                  <strong>Radial socket circuit:</strong> 20 A MCB, 2.5 mm² cable.
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <ul className="text-white space-y-2 text-sm">
                <li>
                  <strong>Maximum demand:</strong> Circuits must be designed to meet maximum demand.
                </li>
                <li>
                  <strong>Compatibility:</strong> Cable size, protective devices, and installation
                  method must all be compatible.
                </li>
                <li>
                  <strong>Regulation 433.1:</strong> Protection against overload.
                </li>
                <li>
                  <strong>Regulation 434.1:</strong> Protection against fault current.
                </li>
                <li>
                  <strong>Regulation 525:</strong> Voltage drop limitations (3% lighting, 5% other
                  uses).
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
                ...
                <ul className="text-white text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Create equipment list:</strong> Note all appliances and their power
                      ratings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Convert to current:</strong> Use I = P ÷ V (current = power ÷ voltage)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Example calculation:</strong> 2000 W heater ÷ 230 V = 8.7 A
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Account for power factor:</strong> Consider reactive loads in AC
                      circuits
                    </span>
                  </li>
                </ul>
              ...
              <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
                ...
                <ul className="text-white text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Research usage patterns:</strong> Understand how equipment is actually
                      used
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Apply appropriate factors:</strong> Use recognised diversity factors
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Conservative approach:</strong> Don't underestimate demand - allow
                      safety margins
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Document assumptions:</strong> Record diversity factors used for
                      future reference
                    </span>
                  </li>
                </ul>
              ...
              <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
                ...
                <ul className="text-white text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>EV charging provision:</strong> Consider 32A supply for future
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Heat pump readiness:</strong> Allow for potential heating system
                      upgrades
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Smart home technology:</strong> Plan for IoT devices and home
                      automation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Spare capacity:</strong> Allow 20-25% spare capacity in consumer units
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
                <p className="font-semibold text-orange-400 mb-2">
                  Step 4: Protection Verification
                </p>
                <ul className="text-white text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Cable protection:</strong> Ensure protective device ratings don't
                      exceed cable capacity
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Load compatibility:</strong> Verify protective devices can carry
                      expected loads
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Breaking capacity:</strong> Confirm adequate breaking capacity for
                      fault currents
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Discrimination:</strong> Ensure proper coordination between protection
                      devices
                    </span>
                  </li>
                </ul>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
              <p className="font-semibold text-orange-400 mb-2">
                The Student House Circuit Overload
              </p>
              <p className="text-white mb-3 text-sm">
                <strong>The Scenario:</strong> An electrician installed a ring final circuit in a
                student house without considering diversity properly. Each bedroom had multiple
                high-power devices (heaters, kettles, hair dryers, laptop chargers, and gaming
                equipment).
              </p>
              ...
              <div className="p-3 bg-white/5 rounded mb-3">
                ...
                <ul className="text-white text-sm space-y-1 list-disc pl-4">
                  <li>
                    <strong>Assumed load per room:</strong> 13A heater + 10A kettle + 8A hair dryer
                    = 31A potential
                  </li>
                  <li>
                    <strong>Six bedrooms total:</strong> 6 × 31A = 186A theoretical maximum
                  </li>
                  <li>
                    <strong>Applied incorrect diversity:</strong> Used 40% diversity giving 74A
                    demand
                  </li>
                  <li>
                    <strong>Real-world usage:</strong> Winter mornings saw 4-5 heaters + multiple
                    kettles simultaneously
                  </li>
                </ul>
              </div>
              ...
              <div className="p-3 bg-red-500/10 rounded mb-3 border border-red-500/30">
                ...
                <ul className="text-white text-sm space-y-1 list-disc pl-4">
                  <li>
                    <strong>Daily tripping:</strong> 32A breaker tripped multiple times daily,
                    especially mornings
                  </li>
                  <li>
                    <strong>Safety hazard:</strong> Students started bypassing the MCB (extremely
                    dangerous)
                  </li>
                  <li>
                    <strong>Voltage drop issues:</strong> Equipment performance suffered due to
                    overloaded circuit
                  </li>
                  <li>
                    <strong>Tenant complaints:</strong> Constant inconvenience and heating failures
                  </li>
                  <li>
                    <strong>Emergency callouts:</strong> £200+ per callout for "nuisance" trips
                  </li>
                </ul>
              </div>
              ...
              <div className="p-3 bg-green-500/10 rounded border border-green-500/30">
                ...
                <ul className="text-white text-sm space-y-1 list-disc pl-4">
                  <li>
                    <strong>Separate circuits:</strong> Install individual 20A radial circuits for
                    each room
                  </li>
                  <li>
                    <strong>Consumer unit upgrade:</strong> Larger CU to accommodate additional
                    circuits
                  </li>
                  <li>
                    <strong>Cable installation:</strong> New 2.5mm² cables to all rooms
                  </li>
                  <li>
                    <strong>Total cost:</strong> £3,200 for remedial work vs £800 if done correctly
                    initially
                  </li>
                  <li>
                    <strong>Disruption:</strong> Two weeks of work with students in residence
                  </li>
                </ul>
              </div>

              <div className="mt-3 p-2 bg-white/5 rounded text-sm text-white">
                <strong>Key lesson:</strong> Correct load estimation saves expensive corrections.
                Always consider real-world usage patterns, especially in high-demand environments
          ...
          <section className="mb-10">
            ...
            <div className="mt-4 p-3 bg-white/5 rounded text-center">
              <p className="text-white text-sm">
                <strong>Remember:</strong> Accurate load estimation prevents overheating, tripping,
                and safety hazards. Always balance safety, functionality, and economics in your
                calculations.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-white">
              In this subsection, you learned the basics of estimating loads and planning circuits.
              You explored the role of diversity in reducing assumed maximum demand, reviewed
              typical circuit designs, and saw how BS 7671 regulates overload and fault protection.
              You also looked at the consequences of poor load estimation and how to avoid them.
            </p>
          </section>
