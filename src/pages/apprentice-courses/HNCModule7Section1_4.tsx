...
const quickCheckQuestions = [
  {
    ...
    options: [
      'The practice of selecting all protective devices in an installation from the same manufacturer',
      'The simultaneous operation of every protective device in series when any fault occurs',
      'The ability of the device nearest the fault to operate and isolate it whilst upstream devices remain closed',
      'The method of choosing cable sizes so that the smallest conductor is protected first',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Total discrimination uses fuses only, whereas partial discrimination uses circuit breakers only',
      'Total discrimination applies to single-phase circuits and partial discrimination to three-phase circuits',
      'Total discrimination is required by BS 7671 while partial discrimination is never permitted',
  ...
  },
  {
    ...
    options: [
      'Operating time of the protective device in seconds',
      'Ambient temperature around the protective device',
      'Prospective fault current (typically in multiples of In or Amperes)',
      'The let-through energy (I²t) of the protective device',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Fitting a second identical device in parallel so that one takes over if the other fails to trip',
      'Providing a standby generator that energises a circuit if the main protective device operates',
      'Adding a time delay to the downstream device so the upstream device always clears the fault first',
...
const quizQuestions = [
  {
    ...
    options: [
      '1.2:1 for HRC fuses (gG type)',
      '1.6:1 for HRC fuses (gG type)',
      '3:1 for HRC fuses (gG type)',
      '1:1 for HRC fuses (gG type)',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The two device curves cross within the range of expected fault currents',
      'The upstream and downstream devices have the same time-current characteristic',
      'The downstream device curve is entirely to the left of and below the upstream curve at all fault levels',
      'The upstream device operates faster than the downstream device at every fault level',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'HRC fuses can be reset after operating, avoiding the need for replacement',
      'HRC fuses provide adjustable thermal and magnetic settings for precise grading',
      'HRC fuses inherently provide RCD-type earth fault protection in addition to overcurrent protection',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'That the downstream device has a higher breaking capacity than the upstream device',
      'The combination has been tested by the manufacturer and the enhanced breaking capacity is stated',
      'That both devices are the same rating so they share the fault current equally',
      'That a minimum 0.4 second time delay is set on the downstream device',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only the rated current of each protective device in the installation',
      'The ambient lighting levels and luminaire layout of the building',
      'Prospective fault currents at each point, device characteristics, cable data, and system configuration',
      'The historical maintenance records and previous fault logs for the site',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Two MCBs of identical rating can never be installed in series in the same circuit',
      'MCBs cannot provide thermal overload protection, only magnetic short-circuit protection',
      'MCBs have no published time-current curves, so coordination cannot be verified',
  ...
  },
  {
    ...
    options: [
      ...
      'It is the reactive power drawn by the protective device while carrying its rated current',
      'It is the time delay in seconds before a magnetic trip operates at a given fault current',
      'It is the voltage drop across the device measured during normal full-load operation',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Mechanically links the operating handles of adjacent breakers so they trip together',
      'Uses communication between relays to achieve faster clearing at fault location whilst maintaining backup protection',
      'Divides the installation into zones each fed from a separate transformer for redundancy',
      'Locks out a circuit so it cannot be re-energised until a fault has been investigated',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'That backup protection may be assumed from device ratings without any verification',
      'That all protective devices in a backup arrangement must be of the fuse type',
      ...
      'That backup protection is prohibited and every device must independently meet the full fault current',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A full decade (100%) of horizontal separation',
      'Exactly half (50%) of a decade of horizontal separation',
      'A fixed 2 cm gap regardless of the scale used',
  ...
  },
  {
    ...
    options: [
      ...
      'The fixed trip points remove any need to verify discrimination with curves',
      'Adjustable settings increase the breaking capacity of the device beyond its rating',
      'The settings automatically prevent the downstream device from ever operating',
    ],
    correctAnswer: 0,
    explanation:
      ...
      <HubBody>
        ...
        <ConceptBlock title="Fundamentals of Discrimination">
          <p>
            ...
            ensure that only the device nearest to a fault operates to clear it, whilst all upstream
            devices remain closed. This fundamental principle minimises the impact of faults on the
            wider installation.
          </p>
          <p>
            <strong>Key discrimination principles:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fault isolation:</strong> Only the device nearest to the fault should operate
            </li>
            <li>
            ...
            <li>
              <strong>Current grading:</strong> Different pickup settings create selectivity zones
            </li>
          </ul>
          <p>
            <strong>Types of Discrimination</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Total Discrimination:</strong> Selectivity achieved for all fault currents up
              to the maximum prospective fault current — Critical installations, hospitals, data
              centres
            </li>
            <li>
              <strong>Partial Discrimination:</strong> Selectivity achieved only up to a defined
              discrimination limit (I_s) — General commercial and industrial where occasional
              simultaneous operation is acceptable
            </li>
            <li>
              <strong>No Discrimination:</strong> Both devices may operate for any fault - no
              coordination — Not recommended - indicates poor design
            </li>
          </ul>
          <p>
            <strong>BS 7671 Requirement</strong>
          </p>
          <p>
            Regulation 536.4 states that where backup protection is used, the characteristics of the
            devices shall be coordinated such that the energy let-through of the upstream device
            does not exceed that which the downstream device and protected conductors can withstand.
          </p>
          <p>
            <strong>Design principle:</strong> Discrimination should be verified at the design stage
            using manufacturer data and coordination studies, not assumed based on ratings alone.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Time-Current Characteristic Curves">
          ...
          <p>
            <strong>Curve Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Curve position (left/right):</strong> Current at which device operates —
              Downstream should be left of upstream
            </li>
            <li>
              <strong>Curve position (up/down):</strong> Operating time for given current —
              Downstream should be below upstream
            </li>
            <li>
              <strong>Band width (tolerance):</strong> Manufacturing variation range — Bands must
              not overlap for discrimination
            </li>
            <li>
              <strong>Curve intersection point:</strong> Discrimination limit (I_s) — Above this
              current, both may operate
            </li>
            <li>
              <strong>Vertical region (magnetic):</strong> Instantaneous trip zone — Most difficult
              region for discrimination
            </li>
          </ul>
          <p>
            <strong>Example: MCB Discrimination Analysis</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Upstream:</strong> 63A Type C MCB (magnetic trip 5-10 x In = 315-630A)
            </li>
            <li>
              <strong>Downstream:</strong> 32A Type B MCB (magnetic trip 3-5 x In = 96-160A)
            </li>
          </ul>
          <p>
            <span>Analysis:</span>
          ...
          <p>
            ...
            when verifying discrimination - minimum time for downstream, maximum time for upstream.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Discrimination Margins and Calculations">
          ...
          <p>
            <strong>Discrimination Ratios (Typical Guidelines)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HRC Fuses (gG):</strong> Ratio &gt; 1.6:1 (upstream:downstream rating)
            </li>
            <li>
              <strong>MCBs same type:</strong> Ratio &gt; 2:1 often needed for thermal region
            </li>
            <li>
              <strong>MCCB to MCB:</strong> Use manufacturer coordination tables
            </li>
            <li>
              <strong>Time delay relays:</strong> Minimum 0.3-0.4s grading margin
            </li>
          </ul>
          <p>Note: Always verify with manufacturer data - these are indicative only</p>
          <p>
            <strong>I²t Energy Coordination</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Time Grading Margins</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electromechanical relays:</strong> 0.4 - 0.5 seconds — Accounts for overshoot
              and reset time
            </li>
            <li>
              <strong>Digital/numerical relays:</strong> 0.2 - 0.3 seconds — Faster operation, less
              overshoot
            </li>
            <li>
              <strong>MCCBs with time delay:</strong> 0.1 - 0.2 seconds — Manufacturer specific -
              verify data
            </li>
            <li>
              <strong>Fuses only:</strong> Use I²t analysis — Time comparison less reliable for
              fuses
            </li>
          </ul>
          <p>
            <strong>Calculation Example: Fuse Discrimination</strong>
          </p>
          <p>Given:</p>
          <p>
            <span> Upstream: 100A gG fuse, I²t let-through = 15,000 A²s at 10kA </span>
          </p>
          <p>
            <span> Downstream: 63A gG fuse, Pre-arcing I²t = 8,000 A²s at 10kA </span>
          </p>
          <p>Verification:</p>
          <p>
            <span> Upstream total I²t (15,000) &gt; Downstream pre-arcing I²t (8,000) </span>
          </p>
        ...
        <ConceptBlock title="Cascading and Backup Protection">
          <p>
            ...
            high breaking capacity supplements a downstream device with lower breaking capacity.
            This allows use of smaller, more economical devices where prospective fault currents are
            high.
          </p>
          <p>
            <strong>Cascading principles:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Tested combinations:</strong> Only manufacturer-verified pairings are valid
            </li>
            <li>
              <strong>Enhanced rating:</strong> Combination achieves higher breaking capacity than
              individual devices
            </li>
          </ul>
          <p>
            <strong>Cascading Requirements (BS 7671 / BS EN 60947-2)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type-tested combination:</strong> Devices must be tested together per
              standards — Manufacturer coordination tables
            </li>
            <li>
              <strong>Stated enhanced Ics:</strong> Combined service breaking capacity documented —
              Technical datasheets, software
            </li>
            <li>
              <strong>Same manufacturer:</strong> Generally required for cascading validity —
              Manufacturer confirmation
            </li>
            <li>
              <strong>Cable protection maintained:</strong> I²t let-through &lt; cable k²S² —
              Adiabatic calculation
            </li>
          </ul>
          <p>
            <strong>Advantages of Cascading</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            selectivity. Discrimination and cascading are different coordination objectives that may
            conflict.
          </p>
          <p>
            <strong>Cascading Example</strong>
          </p>
          <p>Installation conditions:</p>
          <p>
            <span> Prospective fault current at distribution board: 25kA </span>
          </p>
          <p>Without cascading:</p>
          <p>
            <span> MCB required breaking capacity: ≥25kA (expensive, limited options) </span>
          </p>
          <p>With cascading (manufacturer-verified):</p>
          <p>
            <span> MCCB upstream: 50kA breaking capacity (current limiting) </span>
          </p>
          <p>
            <span>MCB downstream: 10kA individual rating</span>
          </p>
          <p>
            <span> Combined enhanced rating: 25kA (from coordination tables) </span>
          </p>
          ...
          <p>
            ...
            discrimination is also required. If both upstream and downstream devices operate, supply
            to all downstream circuits is lost - this may or may not be acceptable.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Verify discrimination between 100A Type C MCB (upstream) and
            32A Type B MCB (downstream).
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Verify discrimination between 160A and 100A gG HRC fuses at
            20kA fault level.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Mixing cascading and discrimination:</strong> These are different objectives
              </li>
              <li>
                <strong>Not documenting coordination:</strong> Required for design verification
              </li>
              <li>
                <strong>Ignoring motor contribution:</strong> Motors add to fault current initially
              </li>
              <li>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Power quality</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
