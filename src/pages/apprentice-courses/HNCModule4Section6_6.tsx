...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['LOD 500', 'LOD 100', 'LOD 350/400', 'LOD 200'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Microsoft Word', 'Autodesk Revit MEP', 'Microsoft Excel', 'Adobe Photoshop'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              automatic generation is no excuse for non-compliance — every output must still read
              against BS EN 61082-1 (document preparation), IEC 60617 (symbols), the BS 7671
              Appendix 6 schedule pro-formas, and Section 514 notice wording. Configure your model
              templates to enforce this at source — do not bolt it on at handover.
            </>
          }
        ...
        <ConceptBlock title="BIM Fundamentals and ISO 19650">
          ...
          <p>
            <strong>UK BIM mandate:</strong> UK government projects require BIM Level 2 (now termed
            'BIM according to ISO 19650'). This means federated models, structured data exchange,
            and collaborative working using a Common Data Environment.
          </p>
          <p>
        ...
        <ConceptBlock title="Level of Development (LOD)">
          ...
          <p>
            <strong>
              LOD definitions for electrical elements (LOD / stage / electrical content):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="COBie and Data Exchange">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Distribution board — rating, ways, manufacturer, model, serial number</li>
          ...
          <p>
            ...
            (xlsx) with standardised worksheets for each data category. It can be exported directly
            from BIM software or compiled from multiple sources. The format is designed for import
            into CAFM systems.
          </p>
          <p>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              compliant). EIR specifies LOD 300 at Stage 4, LOD 350 at Stage 5, COBie at handover,
              federated coordination via Navisworks, CDE on BIM 360. Architect, M&amp;E and
              structural all in Revit. Client’s FM team will adopt the COBie into Concept Evolution.
            </>
          }
          whatToDo={
            <>
              Set up the electrical model from the BEP. Use parametric families that carry the full
              BS 7671 attribute set: Tag, Type, Manufacturer, Model, IP, IK, kW, V, PF, CCT, Em,
              UGR, Ra, etc. Place objects with parameters populated as you go. Enforce IEC 60617
              symbol mapping in the annotation families so the auto-generated single-line and
              schedules read compliantly with Reg 514.9.2. Run weekly clash detection in Navisworks
              (containment vs structure, conduit vs ductwork). At each CDE status gate (WIP → Shared
              → Published) run a model-check rule set: parameter completeness, naming convention,
              IEC 60617 symbol audit. COBie tabs (Component, Type, System, Space) populated
              progressively. At Stage 5 handover: model + COBie + BS 7671 Appendix 6 schedules + EIC
              + O&amp;M, all referenced through the same Tag = single source of truth for the FM
              team. The Reg 514.9.2 cross-check is explicitly run before each issue.
            </>
          }
          whyItMatters={
            <>
              A BIM model that auto-generates a non-compliant single-line is worse than a hand-drawn
              one — it’s wrong at scale. Configure the model to comply once, and every output is
              compliant. Skip the configuration and every output fails Reg 514.9.2.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">HNC Module 5</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
