...
const DESCRIPTION =
  'Master safe isolation procedures including proving dead techniques, approved voltage indicators, and the critical sequence that protects electricians from electrical shock.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Neutral conductors can become live due to broken PEN conductors, incorrect wiring, or borrowed neutrals. The protective conductor could be live if incorrectly connected. Never assume any conductor is safe - prove ALL conductors dead.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'A proving unit generates a known voltage to confirm your voltage indicator is functioning correctly. You MUST prove your tester works BEFORE testing the circuit and AGAIN AFTER testing. This proves it was working throughout the test.',
  },
  {
    id: 'check-3',
    question:
      "An electrician isolates a circuit, tests it dead, but doesn't re-prove their tester afterwards. Why is this dangerous?",
    options: [
    ...
    correctIndex: 1,
    explanation:
      'If your voltage indicator fails during testing (battery dies, internal fault), it shows no voltage even on a live circuit. Re-proving on a known live source or proving unit confirms it was working correctly when you tested. Without this, you cannot be certain the circuit is dead.',
  },
  {
    id: 'check-4',
    question:
      'A circuit has multiple sources of supply (e.g., PV system and mains). What additional action is required?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      "Modern installations often have multiple sources: solar PV, battery storage, generators, or UPS systems. Each source must be identified and isolated. Missing one source could result in electrocution even though the 'main' supply is off. Always check for back-fed supplies.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The safe isolation sequence is: 1) Prove your tester on a known live source or proving unit, 2) Identify and isolate the circuit, 3) Secure the isolation (lock off/tag), 4) Prove the circuit dead on ALL conductors, 5) Re-prove your tester to confirm it was working. This sequence ensures no false sense of security.',
  },
  {
    id: 2,
    question:
      'According to GS38, what is the maximum exposed metal probe tip length for voltage indicators?',
    options: ['2mm', '4mm', '6mm', '10mm'],
    correctAnswer: 1,
    explanation:
      'GS38 specifies a maximum 4mm exposed probe tip to prevent accidental contact with adjacent conductors or earthed metalwork. Longer tips increase the risk of short circuits and arc flash. Many approved voltage indicators have spring-loaded shrouded tips that meet this requirement.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'Multimeters on the wrong range (e.g., resistance instead of voltage) or with low batteries can display no reading even when voltage is present. Approved voltage indicators (two-pole testers) are designed to fail safe and provide positive indication of both presence and absence of voltage.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      "Proving dead only confirms no voltage at the test point at that instant. It doesn't guarantee the circuit won't become live again (e.g., someone switches it back on, capacitor discharge, induced voltages). That's why secure isolation (locking off) is equally essential.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'A 0V reading only means no voltage IF your tester is working. You must re-prove on a known live source or proving unit to confirm your tester is still functioning. Only then can you be confident the circuit is genuinely dead and safe to work on.',
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      'Always prove dead at the point where you will be working. Lighting circuits can have multiple switches, two-way/intermediate wiring, and dimmer packs. Test all conductors present - line, switched live, neutral, and earth. A circuit may be partially live even when apparently isolated.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'GS38 recommends CAT III rated equipment for distribution level work and CAT IV for origin/meter level. Higher CAT ratings provide better protection against transient overvoltages. Using under-rated equipment risks instrument failure, arc flash, and injury.',
  },
  {
    id: 8,
    question:
      "An electrician uses a 'volt stick' (non-contact voltage detector) to check a circuit is dead. Is this acceptable?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Non-contact voltage detectors (volt sticks) are useful for initial indication but can be affected by shielded cables, weak batteries, or adjacent conductors. They cannot be used to prove dead - only approved two-pole voltage indicators with proving should be used for safe isolation.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      "Warning labels must identify who isolated the circuit, when, why, and how to contact them. This prevents others from unknowingly re-energising the circuit and provides traceability. The label should clearly state 'Do not switch on' or similar warning.",
  },
  {
    id: 10,
    question:
      'Why might a circuit still be dangerous even after the main isolator is switched off?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Hazards remain from: capacitor discharge (especially in motor circuits and power factor correction), back-feed from PV/generators/UPS, induced voltages from adjacent circuits, or incorrectly wired installations. Always prove dead at the work point, not just at the isolator.',
  },
  {
    id: 11,
    question: 'A proving unit typically generates what voltage?',
    options: ['12V DC', '50V AC', '230V or 400V AC at safe current', '500V DC'],
    correctAnswer: 2,
    explanation:
      "Proving units generate a voltage similar to mains (230V or 400V) but at a current-limited, safe level (typically a few milliamps). This tests your voltage indicator under realistic conditions without the danger of mains current. Always check your proving unit's specifications.",
  },
  {
    id: 12,
    question:
      'What is the minimum IP rating recommended for voltage indicators used on construction sites?',
    options: ['IP2X', 'IP44', 'IP54 or higher', 'No IP rating required'],
    correctAnswer: 2,
    explanation:
      'Construction sites expose equipment to dust and water splash. IP54 provides protection against dust ingress and water splashing from any direction. Using equipment with insufficient protection risks failure when you need it most. Check the environment matches your equipment rating.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Generally yes, but check both are compatible. Most proving units generate standard voltages (230V/400V) that any compliant voltage indicator should detect. However, some voltage indicators have specific proving units designed to work together. Always verify your combination works correctly before relying on it for safety.',
  },
  {
    question: 'How often should voltage indicators be calibrated or replaced?',
    answer:
      'GS38 recommends equipment is regularly inspected and maintained. Most manufacturers recommend formal calibration annually, though this depends on use frequency and environment. Daily visual checks for damage, and proving before every use, are essential. If dropped or damaged, stop using immediately.',
  },
  {
    question: "What if I can't lock off the isolator?",
    answer:
      'You must find a way to secure the isolation. Options include using isolator lock-off devices, padlocks on distribution boards, withdrawing fuses and keeping them on your person, or posting a competent person to guard the isolator. Work should not proceed until isolation is secure - your life depends on it.',
  },
  {
    question: 'Is it safe to prove dead on the supply side of the isolator?',
    answer:
      "You can test on the supply side to verify your tester, but always prove dead on the LOAD side (downstream) and at your actual work point. Testing only the supply side doesn't confirm isolation of the circuit you're working on - there could be multiple sources or bypass wiring.",
  },
  {
    question: 'Why do we test between all conductors and not just line-to-earth?',
    answer:
      'Testing line-to-earth might show 0V if the earth path is broken. Testing line-to-neutral confirms supply voltage. Testing neutral-to-earth can reveal borrowed neutrals or TN-C-S issues. A comprehensive test between ALL combinations gives you the full picture and catches more faults.',
  },
  {
    question: "Can I rely on an electrician's certificate saying a circuit is isolated?",
    answer:
      'Never. Always prove dead yourself before working. Certificates can be wrong, circumstances change, and someone else may have restored power. The safe isolation procedure is your personal responsibility every single time. Trust nothing - verify everything.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Sequence:</strong> Prove tester - Isolate - Lock off - Prove dead - Re-prove
                tester
              </li>
              <li>
                <strong>Test all:</strong> Line, neutral, AND earth - never assume any conductor is
                safe
              </li>
              <li>
                <strong>Use approved:</strong> Two-pole voltage indicators meeting GS38, not
                multimeters
              </li>
              <li>
                <strong>Every time:</strong> No shortcuts, no assumptions, no exceptions
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> All isolation points, multiple supplies, lock-off provisions
              </li>
              <li>
                <strong>Use:</strong> GS38-compliant voltage indicator with proving unit
              </li>
              <li>
                <strong>Apply:</strong> Full sequence at every job - domestic, commercial,
                industrial
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Every year, electricians die or suffer life-changing injuries from electric shock. In
              almost every case, the cause is the same: they believed a circuit was dead when it
              wasn't. Safe isolation isn't paperwork or procedure for its own sake - it's the
              barrier between you and a potentially fatal mistake.
            </p>
            <p>
              The human body cannot detect the presence of electricity before contact. By the time
              you feel a shock, current is already flowing through you. At 230V, ventricular
              fibrillation can occur in milliseconds. Your heart stops. Without immediate
              defibrillation, you die. This is why we prove dead - not because regulations say so,
              but because your life depends on certainty.
            </p>
            ...
            <div className="my-6 p-4 rounded bg-red-500/10 border border-red-500/20">
              ...
              <p className="text-sm text-white">
                ...
                years in recovery. The correct equipment and procedure would have taken 30 seconds.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Safe isolation is not about following rules - it's about
              creating certainty where doubt could kill you.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The sequence is fixed and must be followed in order. Each step exists because of
              incidents where skipping that step killed someone. Learn it, practise it, and never
              deviate from it.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>The Golden Rule:</strong> Prove - Isolate - Secure - Prove Dead - Re-Prove.
              Five steps. Every time. No exceptions.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              HSE Guidance Note GS38 sets out the requirements for electrical test equipment. These
              aren't arbitrary specifications - each requirement exists because inadequate equipment
              has caused deaths. Understanding GS38 helps you choose the right tools and use them
              correctly.
            </p>
            ...
            <div className="my-6 p-4 rounded bg-white/5">
              ...
              <p className="text-sm text-white">
                ...
                set to the "wrong range" because they only do one job: detect voltage.
              </p>
            </div>
            ...
            <p className="text-sm text-white italic">
              ...
              work, reveals 230V on what you thought was a dead cable. The circuit had a separate
              supply you hadn't identified. The five-minute proving procedure just saved your life.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Modern installations increasingly have multiple sources of supply. What looks like a
              simple domestic installation might have solar PV, battery storage, or an EV charger
              with vehicle-to-grid capability. Commercial and industrial sites often have backup
              generators, UPS systems, or dual supplies. Every source must be identified and
              isolated.
            </p>
            ...
            <div className="my-6 p-4 rounded bg-red-500/10 border border-red-500/20">
              ...
              <p className="text-sm text-white">
                ...
                hazard. Always test the neutral conductor.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Best Practice:</strong> Before any work, ask: "What sources of supply exist
              here?" Check with the client, examine the installation, look for PV panels, battery
              units, generator connections. Never assume a single point of isolation makes
              everything safe.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Commercial/Industrial Safe Isolation
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Testing at the wrong point</strong> - Always at point of work, not just at
                  the board
                </li>
                <li>
                  <strong>Skipping re-proving</strong> - Tester could have failed during test
                </li>
                <li>
                  <strong>Trusting labels</strong> - Circuit charts are often wrong or outdated
                </li>
                <li>
                  <strong>Using volt sticks alone</strong> - Only for initial indication, never for
                  proving dead
                </li>
                <li>
                  <strong>Rushing</strong> - The sequence takes 2-3 minutes. Your life is worth
                  more.
                </li>
              </ul>
            </div>
