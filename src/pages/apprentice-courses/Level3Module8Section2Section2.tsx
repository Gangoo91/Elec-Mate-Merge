...
const TITLE = 'Question analysis techniques for the L3 paper | Level 3 Module 8.2.2 | Elec-Mate';
const DESCRIPTION =
...
const faqs = [
  {
    question: 'What command words do L3 papers use most often, and what do they each demand?',
    answer:
  ...
  {
    question: 'How do L3 distractors differ from L2 distractors?',
    answer:
  ...
  {
    question: 'On EICR coding questions, how do I decide between C2 and C3 reliably?',
    answer:
...
export default function Level3Module8Section2Section2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 2 · Subsection 2"
        title="Question analysis techniques for the L3 paper"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          How to read L3 closed-book MC questions properly — command words that change the answering
          strategy, distractor patterns built from BS 7671 mis-references, multi-step calculation
          discipline and the EICR coding C2-vs-C3 boundary that wins or loses Unit 304.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Read 1 — context</strong>: what kind of installation, what kind of circuit,
              what kind of question (recall, calculation, judgement)?
            </li>
            <li>
              <strong>Read 2 — specifics</strong>: the numbers (current, length, temperature,
              voltage), the negatives (NOT, EXCEPT, OTHER THAN), the command word, and any
              constraints that rule answers in or out.
            </li>
            <li>
              <strong>Both reads should take ~20 seconds combined.</strong> More than 30 seconds
              reading and you are over-thinking — pick the most likely command interpretation and
              start working.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Most suitable</strong> — balance compliance with economy. The answer is the
              cable, device, or method that satisfies all BS 7671 constraints AND is reasonably
              economic. Not the cheapest, not the largest — the smallest compliant option that also
              handles the foreseeable installation conditions.
            </li>
            <li>
              <strong>Minimum</strong> — squeeze to the smallest compliant value. Used in
              cable-sizing questions (smallest CSA that satisfies CCC + voltage drop) and in
              disconnection-time questions (smallest device rating that disconnects within Table
              41.1 limits).
            </li>
            <li>
              <strong>Maximum</strong> — largest permitted value. Used in Zs questions (largest
              measured Zs that satisfies the disconnection requirement at the given device rating),
              insulation-resistance questions, and grouping derating questions.
            </li>
            <li>
              <strong>In accordance with</strong> — read the regs literally. The answer is whichever
              option matches the actual BS 7671 wording or table value exactly. Creative
              interpretation is punished.
            </li>
            <li>
              <strong>Recommended</strong> — best practice, may exceed minimum compliance. Used in
              design questions and inspection-frequency questions.
            </li>
            <li>
              <strong>Identify / State</strong> — recall a fact or a definition. No calculation
              required. Most common in Unit 308 and on the Part 1/Part 2 BS 7671 questions in Units
              304 and 305.
            </li>
            <li>
              <strong>Calculate</strong> — apply a formula to the values given. Use rough paper.
              Round sensibly. Match against answer options.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Near-miss numerical</strong> — the answer one missing derating factor away
              from correct. Cable CCC questions love this — the option that would be right if you
              forgot Cg (grouping) or Ci (thermal insulation) is often present.
            </li>
            <li>
              <strong>Wrong-condition right-number</strong> — a real BS 7671 value, but for the
              wrong installation type. For example, the 80A Zs limit for a 32A Type B MCB at 230V
              (wrong device, right table).
            </li>
            <li>
              <strong>Clause confusion</strong> — Part 4 vs Part 5 vs Part 6 mis- allocation. The
              option that names the wrong Part of BS 7671 for the question's subject.
            </li>
            <li>
              <strong>Unit error</strong> — same number, wrong units. mA where it should be A; mV
              where it should be V; mm where it should be mm&sup2;.
            </li>
            <li>
              <strong>Plausible-but-wrong word</strong> — for definition questions, the option that
              contains a related-but-incorrect term (e.g., calling a supplementary equipotential
              bonding conductor a 'main equipotential bonding conductor').
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Rung 1 — safety filter</strong>: rule out anything that would violate BS 7671
              or HASAWA in obvious ways. Options that lower disconnection times below the required
              value, or that omit required protective measures, go first.
            </li>
            <li>
              <strong>Rung 2 — physical-plausibility filter</strong>: rule out impossible values (a
              1.5mm&sup2; cable carrying 100A; a Zs of 0.0001&Omega; in a TT system; a voltage drop
              of 50% on a 32A radial).
            </li>
            <li>
              <strong>Rung 3 — clause-fit filter</strong>: of the remaining options, which actually
              answers the question the setter asked? An option about bonding when the question is
              about earthing goes here.
            </li>
            <li>
              <strong>Rung 4 — instinct + best fit</strong>: of the surviving options, which feels
              closest to your training? Trust the trained instinct — it is usually right.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Voltage drop</strong>: Vd = (mV/A/m &times; Ib &times; L) / 1000. Limit: 3%
              lighting, 5% other (typical) — but check the table.
            </li>
            <li>
              <strong>Earth fault loop impedance</strong>: Zs = Ze + (R1 + R2). Compare to Table
              41.1 for the given device rating and disconnection time.
            </li>
            <li>
              <strong>Cable CCC after derating</strong>: It (effective) = It (tabulated) &times; Ca
              &times; Cg &times; Ci. Then check Iz &gt;= Ib (and In &gt;= Ib, and Iz &gt;= In).
            </li>
            <li>
              <strong>Power (single phase)</strong>: P = V &times; I &times; cos&phi;. Apparent
              power: S = V &times; I.
            </li>
            <li>
              <strong>Three-phase star (Y)</strong>: V_line = V_phase &times; root-3 (1.732); I_line
              = I_phase. Power: P = root-3 &times; V_line &times; I_line &times; cos&phi;.
            </li>
            <li>
              <strong>Three-phase delta</strong>: V_line = V_phase; I_line = I_phase &times; root-3.
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Candidate reads a voltage-drop question, immediately starts typing into the on-screen
              calculator (28 &times; 18 &times; 1.5 &divide; 1000 = 0.756). They pick the closest
              option (0.8V) and move on. The right answer was 0.756V (3.3% of 230V) — but the
              question asked for the percentage drop, not the volt drop. The 0.8V option was a
              deliberate trap. The right option was 3.3%.
            </>
          }
          doInstead={
            <>
              Write &quot;Vd = (mV/A/m &times; Ib &times; L) / 1000&quot; on rough paper. Then write
              &quot;Vd as percentage = (Vd / 230) &times; 100&quot;. Then plug numbers. The two
              lines force you to ask &quot;is the question asking for volts or percent?&quot; before
              committing — and that single check catches the trap nine times out of ten.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>C1 — Danger present, risk of injury</strong>: exposed live conductors, broken
              accessories with live parts accessible, no earth where one is required and a fault
              path exists.
            </li>
            <li>
              <strong>C2 — Potentially dangerous</strong>: no RCD on circuits supplying socket
              outlets used by ordinary persons (post-17th edition), missing main bonding to
              extraneous-conductive-parts on a TN system, accessory damage that exposes terminals to
              touch.
            </li>
            <li>
              <strong>C3 — Improvement recommended</strong>: BS 3036 fuses on installations
              compliant when built, no AFDD on circuits where now recommended (per A4:2026), wiring
              colours pre-2006 (red/black) that are otherwise sound, single-pole switching of
              neutrals in pre-15th edition installs.
            </li>
            <li>
              <strong>FI — Further investigation required</strong>: signs of overheating that can't
              be diagnosed without dismantling, suspected hidden damage behind a permanent fixture,
              intermittent fault behaviour that wasn't captured during the inspection.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              Question: &quot;A consumer is planning a new 32A radial circuit to supply a heat pump
              in a detached garage 35m from the consumer unit. The cable will run buried in the
              ground in conduit, then surface-mounted along an outside wall, then through 200mm of
              mineral wool loft insulation. Ambient temperature is taken as 25&deg;C. No grouping.
              The installation is TN-C-S (PNB) with a measured Ze of 0.32&Omega;. State the MOST
              SUITABLE cable size in mm&sup2;.&quot;
            </>
          }
          whatToDo={
            <>
              Read 1 — context: 32A radial, 35m run, mixed install methods, TN-C-S, no grouping,
              command word &quot;most suitable&quot;. Read 2 — specifics: 25&deg;C ambient, 200mm
              thermal insulation, Ze = 0.32&Omega;. Scan the options — they will be a list of
              mm&sup2; values (likely 4, 6, 10, 16). Now work the ladder: (a) CCC after derating —
              pick the install method giving lowest CCC (loft insulation), apply Ci, then check the
              cable carries 32A; (b) voltage drop — Vd = (mV/A/m &times; 32 &times; 35) / 1000, must
              be &lt;5% of 230V (11.5V); (c) Zs check — Zs = 0.32 + (R1+R2 for 35m of selected
              cable), must satisfy Table 41.1 for 32A Type B MCB and 0.4s disconnection. The MOST
              SUITABLE answer is the smallest cable that passes ALL three checks. Don&apos;t
              over-spec.
            </>
          }
          whyItMatters={
            <>
              Unit 305 design questions are the tightest pacing test on the L3 papers because they
              require three independent compliance checks. The command-word literacy (&quot;most
              suitable&quot; means smallest compliant, not largest safe) and the formula-first
              discipline are what get you through them inside 3 minutes.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              &quot;Which of the following is NOT a TN system?&quot; — three options will be valid
              TN-system descriptions (TN-S, TN-C, TN-C-S) and one will be a TT or IT description.
              Easy to miss the NOT and pick the first TN you see.
            </li>
            <li>
              &quot;All of the following are required EXCEPT...&quot; — three required items, one
              not required. Easy to pick a required item if you skim.
            </li>
            <li>
              &quot;Which statement is FALSE?&quot; — three true statements, one false. Easy to pick
              a true statement if you read for true-ness.
            </li>
            <li>
              The fix: write a small dot or underline mentally against the negation word, and
