...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Only if the error is small',
      'Only on digital transmitters',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'They are performed in the same location',
      ...
      'Bench calibration is less accurate',
      'In-situ calibration cannot use reference standards',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Sets the fail-safe position',
      'Adjusts the supply pressure',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The physical distance it can measure',
      ...
      'The distance between the transmitter and the control room',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It makes the calibration take longer, showing thoroughness',
      ...
      'It is only important for pressure instruments',
      'Stabilisation is not necessary for digital instruments',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only power supply variations',
      'Drift does not occur in modern transmitters',
    ],
    correctAnswer: 1,
    explanation:
