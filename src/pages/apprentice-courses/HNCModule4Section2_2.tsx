    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 525.202 makes voltage-drop compliance a measured outcome at the end of the cable,
              not just a calculation. The Appendix 4 limits (3% lighting, 5% other) are cumulative
              from the supply origin to the final outlet. As the designer, your budget split —
              typically 1–2% on the sub-main, 3% on the final circuit — has to add up. Long runs,
              high power-factor loads and grouped circuits all eat the budget faster than the basic
              tables suggest.
            </>
          }
        ...
        <ConceptBlock title="BS 7671 Voltage Drop Limits">
          <p>
            ...
            correctly and efficiently. These limits apply from the origin of the installation to the
            most distant point.
          </p>
          <p>
          ...
          <p>
            <strong>Allocating voltage drop:</strong> the total permitted drop can be split between
        ...
        <ConceptBlock title="The mV/A/m Method">
          <p>
            ...
            simplifies voltage drop calculations by combining cable resistance and reactance into a
            single value.
          </p>
          <p>
          ...
          <p>
            <strong>
              Typical mV/A/m values (PVC/copper at 70°C, 2-core 1φ / 3-4-core 3φ / typical use):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Three-Phase Calculations">
          <p>
            ...
            values. The result is the line-to-line voltage drop, which is compared against the 400V
            supply.
          </p>
          <p>
            <strong>Three-phase voltage drop:</strong> Vd = (mV/A/m₃φ × IL × L) / 1000, where IL is
            the line current and L is the cable length in metres.
          </p>
          <p>
          ...
          <p>
            <strong>Reactive loads — power factor correction:</strong> For inductive loads (motors),
            calculate effective mV/A/m using resistance (r) and reactance (x) components: mV/A/m =
            (r × cos φ) + (x × sin φ). Where cos φ is the power factor; for pf = 0.85, sin φ =
            0.527.
          </p>
          <p>
        ...
        <ConceptBlock title="Motor Starting and Long Cable Runs">
          <p>
            ...
            These situations often determine the final cable size rather than current-carrying
            capacity.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Local sub-distribution:</strong> reduce final circuit lengths by adding local
              DBs
            </li>
            <li>
          ...
          <p>
            ...
            may tolerate brief dips. Check manufacturer specifications for minimum starting voltage.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — single-phase socket circuit:</strong> A 32A radial circuit uses 4mm²
            cable for a 35m run. Calculate voltage drop and check compliance.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 2 — lighting circuit:</strong> A lighting circuit serves luminaires 45m
            from the DB. Maximum current 8A. What cable size?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Lighting limit: 3% of 230V = 6.9V maximum</li>
            <li>Try 1.5mm² (mV/A/m = 29): Vd = (29 × 8 × 45) / 1000 = 10.4V — exceeds 3% limit</li>
            <li>
              Try 2.5mm² (mV/A/m = 18): Vd = (18 × 8 × 45) / 1000 = 6.5V (2.8%) — within 3% limit
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              From tables (3φ values): 16mm² = 2.4 mV/A/m (too high), 25mm² = 1.5 mV/A/m (adequate)
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              Connected design current I_b = 80&nbsp;A. The site target is 1.5% V_d on the sub-main,
              leaving 3.5% headroom for the workshop final circuits (a CNC machine with a
              high-inertia motor among them).
            </>
          }
          whatToDo={
            <>
              V_d_max = 1.5% × 400 = 6&nbsp;V. Required mV/A/m = (V_d × 1000) / (I_b × L) = (6 ×
              1000) / (80 × 75) = 1.0&nbsp;mV/A/m. From Appendix 4 Table 4D1B reference method E,
              three-phase XLPE: 25&nbsp;mm² gives ≈ 1.5&nbsp;mV/A/m, 35&nbsp;mm² gives ≈
              1.1&nbsp;mV/A/m, 50&nbsp;mm² gives ≈ 0.81&nbsp;mV/A/m. Pick 50&nbsp;mm². Verify the
              impedance value (z) — the CNC has a low-pf inrush so use the mV/A/m_z column, not just
              the resistive r column. Document on the cable schedule against Reg 525.202.
            </>
          }
          whyItMatters={
            <>
              Reg 525.202 makes the V_d limit a deemed-to-satisfy compliance test. Skimp on the
              sub-main and every final circuit downstream starts with less budget — the CNC then
              sees voltage dips on motor inrush, trips on under-voltage relays, and the workshop
              loses production hours. Larger cable upfront is cheaper than a rip-and-replace later.
            </>
          }
        />
