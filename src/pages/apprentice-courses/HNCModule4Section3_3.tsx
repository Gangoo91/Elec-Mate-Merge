...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Only affects voltage drop', 'No effect', 'Increases Ipf', 'Decreases Ipf'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['0.88Ω', '1.46Ω', '0.60Ω', '0.10Ω'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['28.9kA', '10.2kA', '24.1kA', '16.7kA'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['0.08Ω maximum', '0.35Ω maximum', '21Ω maximum', '0.80Ω maximum'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.79Ω', '0.95Ω', '0.44Ω', '1.14Ω'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 643.7.3.201 makes the PFC determination a mandatory verification step, not an
              optional design comfort. It must be done at the origin AND at other relevant points
              (DBs, sub-panels, points with reduced fault levels). The figures from this
              verification confirm the breaking capacity of every protective device, the adiabatic
              check on every cable, and the disconnection time at every endpoint. Either measure
              (loop tester at origin and at relevant points) or calculate from DNO data plus cable
              impedance — and document.
            </>
          }
        ...
        <ConceptBlock title="Prospective Fault Current (Ipf)">
          ...
          <p>
            <strong>Design rule:</strong> Protective device breaking capacity must exceed Ipf at the
        ...
        <ConceptBlock title="Transformer Impedance and Fault Level">
          ...
          <p>
            <strong>Transformer fault current formula:</strong> I<sub>fault</sub> = I<sub>FL</sub> /
            (%Z / 100) — where I<sub>FL</sub> = kVA / (√3 × V<sub>L</sub>) for three-phase
            transformers.
          </p>
          <p>
            <strong>
              Typical transformer fault levels at 400V secondary (rating / %Z / FLC / fault
              current):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Cable Impedance and Fault Level Reduction">
          ...
          <p>
            <strong>
              Cable resistance values — copper at 20°C (size mm² / R mΩ/m / R1+R2 for T&amp;E):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>1.5 — 12.1 — 24.2</li>
          ...
          <p>
            ...
            beneficial for downstream device selection but must be verified for disconnection times.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Earth Fault Loop Impedance (Zs)">
          ...
          <p>
            <strong>
              Maximum Zs for 0.4s disconnection — 230V, TN (BS 7671:2018+A4:2026 — device / rating A
              / max Zs Ω):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Step 1 — calculate full load current: I<sub>FL</sub> = S / (√3 × V<sub>L</sub>)
            </li>
            <li>
          ...
          <p>
            <strong>Example 2 — Zs calculation and verification:</strong> A 20A Type B MCB protects
            25m of 2.5mm² T&amp;E cable. Ze = 0.35Ω. Verify protection is adequate.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Step 4 — check against maximum: from BS 7671:2018+A4:2026 Table 41.3 max Zs for 20A
              Type B = 2.19Ω
            </li>
            <li>0.865Ω &lt; 2.19Ω — protection adequate</li>
          </ul>
          <p>
            <strong>Example 3 — sub-distribution fault level:</strong> A sub-board is fed by 30m of
            35mm² SWA from a main board where Ipf = 18kA. Calculate Ipf at the sub-board.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A 32&nbsp;A B-curve MCB protects a final-circuit ring. Loop impedance measured at the
              furthest socket Z_s = 1.20&nbsp;Ω. The installer thinks this is fine because earlier
              guidance gave Z_s_max ≈ 1.44&nbsp;Ω for B32 (A2 / older edition figures). You need to
              confirm against current A4:2026 values.
            </>
          }
          whatToDo={
            <>
              Open BS 7671:2018+A4:2026 Table 41.3 — current Z_s_max for B32 is 1.37&nbsp;Ω (NOT
              1.44&nbsp;Ω, which was the older edition). Measured 1.20&nbsp;Ω is below 1.37&nbsp;Ω
              so the disconnection time is satisfied. Apply the rule-of-thumb 0.8 × multiplier for
              design margin: design Z_s_max = 1.37 × 0.8 = 1.10&nbsp;Ω. Measured 1.20 exceeds the
              0.8 design margin — investigate. Likely causes: higher-than-assumed Z_e, longer cable
              run, smaller CPC, or warm cables on the day of test. Document the measured Z_s, the
              Table 41.3 limit (A4:2026), and whether design margin is met against Reg 643.7.
            </>
          }
          whyItMatters={
            <>
              Using the wrong Z_s_max value (older 1.44 instead of A4:2026 1.37) is a regulatory
              regression. Reg 643.7.3.201 requires the verification to use current edition values.
              Quote the wrong figure on an EIC and the certificate is technically non-compliant.
              A4:2026 also moved B32 from 1.44 to 1.37&nbsp;Ω — tighter, but defensible.
            </>
          }
        />
