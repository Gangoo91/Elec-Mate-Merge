...
const TITLE =
  'Risks and Consequences of Electrical Faults - Module 7.1.3 | Level 2 Electrical Course';
const DESCRIPTION =
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Electric shock and electrocution represent the most serious direct safety risks, potentially causing serious injury or death.',
  },
  {
    id: 2,
...
const Module7Section1_3 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Serious electrical faults require immediate isolation of the circuit and reporting to prevent accidents and legal consequences.',
    },
    {
      id: 10,
  ...
  const faqs = [
    {
      ...
      answer:
        'Contact with live parts due to poor isolation procedures or unidentified faults is the leading cause of electrical accidents in the workplace.',
    },
    {
      question: 'How much can electrical faults cost a business?',
      answer:
        'Costs can range from thousands for equipment damage to millions for major fire damage, plus legal costs, compensation claims, and lost business.',
    },
    {
      question: 'Can electrical faults affect insurance coverage?',
      answer:
        "Yes, insurance companies may refuse claims or increase premiums if they find that proper electrical maintenance and fault management wasn't carried out.",
    },
  ];
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                operations. Understanding these risks is essential for every electrician, as it
                drives the urgency and care required when dealing with electrical installations.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="text-sm">
                  <strong className="text-elec-yellow">Why This Matters:</strong> HSE statistics
                  show that electrical incidents cause over 1,000 workplace accidents annually in
                  the UK, with approximately 30% of structural fires being electrical in origin.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-sm">
                  <strong className="text-elec-yellow">Industry Standard:</strong> BS 7671 requires
                  that installations are safe for persons, livestock, and property. Any fault that
                  compromises this safety must be treated as a priority requiring immediate action.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-3 leading-relaxed">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  Identify immediate safety risks from electrical faults including shock, fire, and
                  arc flash hazards.
                </li>
                <li>
                  Understand legal and financial consequences of fault-related incidents including
                  prosecution and liability.
                </li>
                <li>
                  Recognise impacts on business operations including downtime, data loss, and
                  reputation damage.
                </li>
                <li>
                  Appreciate why immediate action is required when faults are discovered to prevent
                  escalation.
                </li>
                <li>
                  Evaluate the cost-benefit relationship between preventive maintenance and incident
                  response.
                </li>
                <li>
                  Apply risk assessment principles to electrical fault scenarios in different
                  environments.
                </li>
              </ul>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                protecting both workers and the general public.
              </p>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
                <p className="text-sm">
                  <strong className="text-red-400">Critical Understanding:</strong> Electrical
                  faults create unpredictable hazards that can escalate rapidly. Even apparently
                  minor faults can become life-threatening under certain conditions, making
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-white/70">
                  ...
                  <li>
                    <strong>Compensation:</strong> Can reach millions for serious injury cases
                  </li>
                  <li>
                    <strong>Insurance:</strong> Policies may be invalidated if proper maintenance
                    not carried out
                  </li>
                  <li>
                    <strong>Property damage:</strong> Fire damage can cost millions to rectify
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-amber-500/10 border-l-2 border-amber-500/50">
                <p className="text-sm">
                  <strong className="text-amber-400">Important Note:</strong> Personal liability
                  applies to individuals as well as companies. Electricians can face personal
                  prosecution, fines, and imprisonment for safety breaches under EAWR 1989.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-purple-500/10 border-l-2 border-purple-500/50">
                <p className="text-sm">
                  <strong className="text-purple-400">Long-term Consequences:</strong> Business
                  impact extends beyond immediate costs. Loss of customer confidence, difficulty
                  obtaining insurance, and regulatory restrictions can affect operations for years
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-sm">
                  <li>
                    Treat all electrical faults as potential safety hazards until proven otherwise.
                  </li>
                  <li>
                    Isolate faulty circuits immediately and secure against unauthorised
                    energisation.
                  </li>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-sm">
                  <li>
                    Document all faults and corrective actions taken with timestamps and details.
                  </li>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-sm">
                  ...
                  <li>
                    Maintain appropriate insurance coverage with proper electrical maintenance
                    records.
                  </li>
            ...
            <div className="p-4 rounded-lg bg-amber-500/10 border-l-2 border-amber-500/50">
              ...
              <div className="text-white/80 space-y-3 text-sm leading-relaxed">
                <p>
                  ...
                  eventually escalated when moisture ingress combined with the existing earth fault
                  to create a sustained arc. The resulting fire destroyed a significant portion of
                  the facility, injured two employees, and led to a six-month production shutdown.
                </p>
                <p>
                  <strong>Consequences:</strong> The company faced £2.4 million in direct fire
                  damage, £1.8 million in lost production, £500,000 in legal costs, and unlimited
                  fines for EAWR 1989 breaches. Two employees required hospital treatment for smoke
                  inhalation, and the company's insurance claim was partially rejected due to
                  inadequate electrical maintenance records.
                </p>
                <p>
                  <strong>The Reality:</strong> What started as a minor earth fault that could have
                  been corrected for a few hundred pounds ultimately cost the business over £5
                  million and resulted in criminal prosecution of the facilities manager.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <ul className="list-disc pl-5 space-y-2 text-white/80 text-sm">
                ...
                <li>
                  Legal consequences include prosecution under EAWR 1989 with unlimited fines,
                  imprisonment, and civil liability for damages.
                </li>
                <li>
                  Business impacts include production losses, data loss, reputation damage, and
                  long-term regulatory scrutiny.
                </li>
                <li>
                  Immediate action is required when faults are discovered to prevent escalation and
