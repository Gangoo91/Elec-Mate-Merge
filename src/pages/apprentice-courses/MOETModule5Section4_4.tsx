      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Globe valves:</strong> Best for modulating/throttling -- linear stem-to-flow
              </li>
              <li className="pl-1">
                <strong>Cv/Kv:</strong> Flow coefficient used for sizing -- operate 20-80% open
              </li>
              <li className="pl-1">
                <strong>Pneumatic actuators:</strong> Spring-return provides fail-safe action
              </li>
              <li className="pl-1">
                <strong>Smart positioners:</strong> Auto-calibration, diagnostics and predictive
                maintenance
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Precise throttling/modulating control
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Linear stem-to-flow, excellent rangeability
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Ball valve</td>
                      <td className="border border-white/10 px-3 py-2">
                        On/off and moderate throttling
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        V-notch or segmented designs for control
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Corrosive, viscous, or slurry fluids
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Fluid does not contact moving parts
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Globe valves are the default choice for modulating control
              because of their excellent throttling capability, good rangeability, and predictable
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-3 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  Equal increments of stem travel produce equal changes in flow. The graph is a
                  straight line. Used where the system pressure drop is relatively constant across
                  the operating range.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  Equal increments of stem travel produce equal percentage changes in the existing
                  flow, giving a logarithmic curve. The most common choice for process control
                  because it compensates for varying system pressure drops.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">Quick-Opening</h3>
                <p className="text-sm text-white">
                  Large flow increase with small initial travel, levelling off at higher openings.
                  Used for on/off applications and safety relief, not for modulating control.
                </p>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Upstream and downstream pressures determine the available pressure drop
                </li>
                <li className="pl-1">
                  Oversized valves operate near the closed position where control is poor
                </li>
                <li className="pl-1">Undersized valves cannot deliver the required maximum flow</li>
                <li className="pl-1">
                  Design target: operate between 20-80% open at the design flow rate
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Practical tip:</strong> If a control valve is constantly operating below 20%
              or above 80% open, it is likely incorrectly sized. This should be flagged for review
              as it leads to poor control, increased wear, and potential process issues.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  The most common in process industries. Instrument air (3-15 psi / 0.2-1.0 bar, or
                  6-30 psi for larger valves) acts on a flexible diaphragm opposed by a spring. The
                  spring provides inherent fail-safe action without any additional mechanism.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    Fast response, simple construction, suitable for hazardous areas
                  </li>
                  <li className="pl-1">
                    Fail-safe direction determined by process safety requirements
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  Provide higher thrust than diaphragm types for large or high-pressure valves. They
                  can be single-acting (with spring return for fail-safe) or double-acting
                  (requiring a separate fail-safe mechanism such as a stored-energy accumulator).
                  Used where diaphragm actuators cannot generate sufficient force.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  <strong>Electric actuators</strong> use a motor and gearbox, offer precise
                  positioning without an air supply, but require additional measures for fail-safe
                  action (battery backup, spring return module).
                  <strong> Hydraulic actuators</strong> provide very high forces for large valves
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              <p className="text-sm font-medium text-orange-400 mb-2">
                Fail-Safe Selection Is Critical
              </p>
              <p className="text-sm text-white">
                ...
                can have serious safety consequences -- always verify the fail-safe action during
                commissioning and after any maintenance on the actuator.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>ST1426 link:</strong> Maintenance technicians must understand actuator types
              and fail-safe configurations to correctly verify valve operation during functional
              testing and to diagnose actuator faults.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Smart (Digital) Positioner Capabilities
              </p>
              <p className="text-sm text-white mb-3">
                Smart positioners incorporate microprocessor-based control with digital
                communication protocols (HART, Foundation Fieldbus, Profibus PA). They provide
                capabilities far beyond simple position control:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Packing condition, guide wear, stem corrosion
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Actuator pressure profile
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Diaphragm/spring condition, air supply issues
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Travel deviation</td>
                      <td className="border border-white/10 px-3 py-2">
                        Positioner calibration drift, linkage wear
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Cycle count</td>
                      <td className="border border-white/10 px-3 py-2">
                        Valve utilisation for maintenance planning
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Practical tip:</strong> When commissioning a control valve with a smart
              positioner, always run the auto-calibration routine and record a baseline valve
              signature. This provides the reference against which future diagnostic data can be
              compared to detect degradation.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  ...
                  that collapse violently, causing severe erosion of valve internals. Symptoms
                  include distinctive crackling noise, vibration, and visible damage to the plug and
                  seat
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Seat leakage:</strong> The valve does not shut off completely, allowing
                  flow past the seat when closed. Caused by erosion, corrosion, foreign material
                  trapped in the seat, or mechanical damage
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Check for external leakage (packing, body joints, actuator)
                </li>
                <li className="pl-1">
                  Verify actuator air supply pressure and regulator operation
                </li>
                <li className="pl-1">
                  Stroke the valve through full range and check for smooth travel
                </li>
                ...
                <li className="pl-1">
                  Review smart positioner diagnostic data for developing trends
                </li>
                <li className="pl-1">
                  Check handwheel operation (if fitted) and ensure it is disengaged
                </li>
              </ul>
            </div>

            <p className="text-sm text-white/90 italic">
              <strong>Note:</strong> Control valves are critical components in process control
              loops. Understanding valve types, actuator configurations, and diagnostic techniques
              covered here provides the foundation for effective maintenance of final control
              elements as required by ST1426.
            </p>
          </div>
        </section>
