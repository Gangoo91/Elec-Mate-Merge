...
const DESCRIPTION =
  'Diagnose problems with earthing arrangements and protective bonding, understand TN, TT, and IT systems, and identify faults that compromise electrical safety.';

const quickCheckQuestions = [
  {
    id: 'check-1',
    question:
      'Earth fault loop impedance (Zs) on a circuit measures 2.5 ohms, but the maximum permitted for a 32A Type B MCB is 1.37 ohms. What is the consequence?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'High Zs means lower fault current, meaning the MCB takes longer to trip. With Zs of 2.5 ohms, fault current would be only 92A (230/2.5), requiring the MCB to operate on thermal rather than magnetic trip. This may exceed the 0.4s disconnection time required for socket circuits, creating shock risk.',
  },
  {
    id: 'check-2',
    question:
      'You measure 0V between the main earth terminal and incoming water pipe, but 8V between the MET and incoming gas pipe. What does this indicate?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'In a correctly bonded installation, all bonded services should be at the same potential as the MET - very low or zero voltage between them. 8V between MET and gas pipe indicates the bonding connection is broken, has high resistance, or is missing entirely. This is a serious safety issue requiring immediate attention.',
  },
  {
    id: 'check-3',
    question:
      'A TT installation has an earth electrode resistance of 180 ohms. The RCD is 30mA. Is this arrangement compliant?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'For a TT system, BS 7671 requires RA x IΔn is less than or equal to 50V. Here, 180 x 0.03 = 5.4V, well within the 50V limit. The RCD will trip before dangerous touch voltages develop. However, very high electrode resistance can cause RCD testing issues and is generally improved where practical.',
  },
  {
    id: 'check-4',
    question:
      'During testing, you discover the earthing conductor from the consumer unit to the MET has been routed through a steel conduit. Is this acceptable?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Running an earthing conductor through steel conduit creates a parallel path for fault current through the conduit itself. This may reduce effective earthing conductor cross-section if the conduit is not rated, or create confusion during testing. The earthing conductor should be routed separately and clearly identified.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      "An installation has PME (TN-C-S) earthing but the DNO cut-out label warns 'PME restrictions apply - check with DNO before connecting'. What requires special attention?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'PME restrictions relate to the risk of the combined PEN conductor becoming open-circuit, which could make bonded metalwork rise to dangerous potential. Special consideration is needed for installations with extraneous-conductive-parts in contact with true earth (outdoor installations, farms, petrol stations) where alternative earthing may be required.',
  },
  {
    id: 2,
    question:
      "You're testing main bonding and find 0.12 ohms between the MET and the water stopcock. The bonding conductor is 10mm2. Is this acceptable?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      '10mm2 copper has resistance around 1.83 milliohms per metre. For a typical short bonding run of 3-4 metres, expected resistance is 0.005-0.007 ohms. 0.12 ohms is much higher, indicating a loose clamp, corroded connection, or damaged conductor. Investigate and rectify.',
  },
  {
    id: 3,
    question:
      'An older property has no main bonding to water or gas services. The supply is TN-S. What is the first consideration?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "BS 7671 Regulation 411.3.1.2 requires main protective bonding in all TN and TT systems. The type of supply earth doesn't eliminate the need - bonding equalises potential between extraneous-conductive-parts and the installation earth. Recommend installation of appropriate main bonding conductors.",
  },
  {
    id: 4,
    question:
      'During an EICR, you find supplementary bonding in a bathroom connecting all exposed and extraneous-conductive-parts, but no RCD protection on bathroom circuits. What is your classification?',
    options: [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "Four sections at 0.15 ohms each should total 0.6 ohms if series-connected. The end-to-end reading of 0.6 ohms matches, but this is coincidental. More likely, there's a high-resistance joint adding resistance that masks in full testing. Test each joint individually to locate the poor connection.",
  },
  {
    id: 7,
    question:
      'An agricultural installation uses TT earthing. The customer has installed a new metal feeding system that makes contact with the ground. What bonding consideration applies?',
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'The bonding requirement is for metallic services that could introduce earth potential or become live during a fault. If the incoming gas pipe is now plastic, bonding that plastic achieves nothing. Relocate the bonding clamp to the first accessible metallic pipework after the plastic section (often at the gas boiler inlet).',
  },
  {
    id: 9,
    question:
      'A Zs reading of 0.45 ohms is obtained on a ring circuit. When testing at a socket, external earth fault loop tester reads 0.52 ohms. What explains the difference?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Calculated Zs (Ze + R1+R2) should equal measured Zs. A measured value 0.07 ohms higher suggests additional resistance in the actual earth path - typically at socket terminals, the accessory back box connection, or the connection to the wiring. Check terminations at the socket tested.',
  },
  {
    id: 10,
    question:
      'During refurbishment, you discover the main earthing conductor passes through a void before reaching the MET and has been partially damaged by rodents. What should you do?',
    options: [
  ...
  },
  {
    id: 11,
    question:
      'A property has multiple earth electrodes for different outbuildings, all connected to the main MET. Ze measures 0.35 ohms, but individual electrode resistance tests show 40 ohms, 55 ohms, and 60 ohms. What explains this?',
    options: [
  ...
  },
  {
    id: 12,
    question:
      'Testing supplementary bonding in a bathroom, you measure 0.5 ohms between the bath waste connection and a metallic radiator. Maximum permitted is 0.04 ohms (derived from 50V/(1200/Zs)). What action is required?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'With 30mA RCD protection on all bathroom circuits (as required by current BS 7671), supplementary bonding may be omitted provided the main bonding and circuit CPCs are adequate. If RCD protection is confirmed, the lack of supplementary bonding meeting the 0.04 ohm limit is not necessarily a defect.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>High Zs:</strong> Slow disconnection, shock risk - check earth path
              </li>
              <li>
                <strong>High Ze:</strong> Supply earth problem or TT system issues
              </li>
              <li>
                <strong>Bonding voltage:</strong> Should be near zero between MET and services
              </li>
              <li>
                <strong>Missing bonding:</strong> Potential shock hazard - install immediately
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Corroded clamps = failing bonding connection
              </li>
              <li>
                <strong>Spot:</strong> Voltage between MET and services = bonding issue
              </li>
              <li>
                <strong>Use:</strong> R2 test verifies CPC continuity throughout circuit
              </li>
              <li>
                <strong>Use:</strong> Ze vs Zs comparison reveals circuit earth problems
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The earthing system determines how an installation connects to the general mass of
              earth and how it responds during a fault. Different systems have different
              vulnerabilities and testing requirements. Recognising the earthing system type is the
              first step in diagnosing earthing faults.
            </p>
            ...
            <p>
              Each system has characteristic faults. TN-S suffers from corroding cable connections.
              TN-C-S has inherent PEN conductor risks requiring bonding consideration. TT systems
              need regular electrode testing, especially after dry summers when soil resistivity
              increases dramatically.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>BS 7671 Reference:</strong> Chapter 31 specifies earthing arrangements and
              conductor sizes. Regulation 411.4.2 covers TN system automatic disconnection
              requirements. Regulation 411.5 covers TT system requirements including mandatory RCD
              protection.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Main protective bonding connects extraneous-conductive-parts (metalwork not part of
              the electrical installation but capable of introducing a potential) to the main
              earthing terminal. This ensures that during a fault, all accessible metalwork rises
              and falls together, preventing dangerous potential differences that could cause shock.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Main bonding requirements (BS 7671):
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Water installation:</strong> Connect to incoming metal water service pipe,
                  within 600mm of the stopcock
                </li>
                <li>
                  <strong>Gas installation:</strong> Connect to incoming metal gas installation
                  pipe, within 600mm of the meter
                </li>
                <li>
                  <strong>Other services:</strong> Oil supply pipes, central heating systems, any
                  metal structure entering the building
                </li>
                <li>
                  <strong>Conductor size:</strong> Minimum 6mm2 copper, or half the supply earthing
                  conductor size, or as per Table 54.8
                </li>
              </ul>
            </div>

            <p>
              Common bonding faults include: disconnected clamps after service work, corroded
              connections especially in damp locations, undersized conductors on older
              installations, and bonding attached to plastic sections where services have been
            ...
            <p className="text-sm text-white/90 italic">
              ...
              the heating system (connected via gas bonding). Cleaning and replacing the water
              bonding clamp resolves the issue.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The circuit protective conductor (CPC) provides the return path for earth fault
              current on each circuit. It must have sufficiently low resistance to ensure enough
              fault current flows to trip the protective device quickly. CPC faults are among the
              most dangerous as they may not be apparent until a fault occurs - then there's no
              protection.
            </p>
            ...
            <p>
              Testing CPCs requires systematic approach. End-to-end testing on ring circuits reveals
              breaks. Socket-by-socket r1+r2 testing reveals high-resistance joints. Always test at
              the furthest point from the consumer unit where impedance is highest. Compare
              calculated Zs (Ze + R1+R2) with measured Zs - a significant difference indicates CPC
              problems.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>Practical tip:</strong> When Zs is much higher than calculated, but R1+R2
              tests correctly, check connections at the consumer unit earth bar and the main
              earthing terminal. These joints carry fault current from multiple circuits and can
              develop high resistance from thermal cycling.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              In TT systems (and some special installations), the earth electrode is the
              installation's connection to earth. Unlike TN systems where the supply provides a
              low-impedance earth path, TT systems rely entirely on the electrode's contact with the
              soil. This creates unique maintenance and testing requirements.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Factors affecting electrode resistance:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Soil type:</strong> Clay and loam have low resistivity; sand, gravel, rock
                  have high resistivity
                </li>
                <li>
                  <strong>Moisture content:</strong> Dry soil dramatically increases resistance -
                  summer readings often higher than winter
                </li>
                <li>
                  <strong>Electrode depth:</strong> Deeper electrodes reach more stable moisture
                  levels and more soil
                </li>
                <li>
                  <strong>Electrode condition:</strong> Corrosion reduces effective contact area
                  over time
                </li>
                <li>
                  <strong>Connections:</strong> Clamps can corrode, especially in acidic soils
                </li>
              </ul>
            </div>

            <p>
              Earth electrode testing requires the fall-of-potential method using auxiliary
              electrodes. Simple resistance measurement with a multimeter doesn't give accurate
              electrode resistance. Record readings and monitor trends - gradually increasing
            ...
            <p className="text-sm text-white/90 italic">
              ...
              current, touch voltage would reach 12V (within limit), but the RCD tester can't inject
              sufficient current to actually trip the device. Watering the electrode area
              temporarily reduces resistance; long-term solution is additional electrode(s) or soil
              treatment.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Earthing Fault Diagnosis Sequence
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Assuming bonding is present</strong> - Always physically trace and test
                  bonding connections
                </li>
                <li>
                  <strong>Testing Ze with bonding connected</strong> - Parallel paths give falsely
                  low readings
                </li>
                <li>
                  <strong>Accepting high Zs on TT</strong> - Even TT systems have Zs limits; high
                  readings need RCD verification
                </li>
              </ul>
            </div>
          </div>
