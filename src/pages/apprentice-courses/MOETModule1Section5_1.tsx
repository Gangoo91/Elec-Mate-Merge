      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Duty of care:</strong> Legal responsibility for waste from creation to
                disposal
              </li>
              <li className="pl-1">
                <strong>Waste hierarchy:</strong> Prevent, reduce, reuse, recycle, recover, dispose
              </li>
              <li className="pl-1">
                <strong>Waste categories:</strong> Hazardous, non-hazardous and inert
              </li>
              <li className="pl-1">
                <strong>Key legislation:</strong> EPA 1990, WEEE Regs 2013, Hazardous Waste Regs
                2005
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Common hazardous waste:</strong> Fluorescent tubes, batteries, transformer
                oil
              </li>
              <li className="pl-1">
                <strong>WEEE:</strong> Luminaires, switchgear, distribution boards, controls
              </li>
              <li className="pl-1">
                <strong>Segregation:</strong> Copper, plastics, hazardous items in separate streams
              </li>
              <li className="pl-1">
                <strong>ST1426:</strong> Maps to environmental awareness and sustainability KSBs
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  ...
                  care for waste (Section 34) and the offence of unlawful deposit of waste (Section
                  33 — fly-tipping)
                </li>
                <li className="pl-1">
                  <strong>Waste (England and Wales) Regulations 2011:</strong> Transposes the EU
                  Waste Framework Directive; establishes the waste hierarchy as a legal obligation
                </li>
                <li className="pl-1">
                  <strong>Hazardous Waste (England and Wales) Regulations 2005:</strong> Controls
                  the movement and disposal of hazardous waste; requires consignment notes and
                ...
                <li className="pl-1">
                  <strong>Controlled Waste Regulations 2012:</strong> Defines which types of waste
                  are controlled and subject to the duty of care
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                ...
                revocation of environmental permits. Fixed penalty notices of up to £400 can be
                issued for minor duty of care breaches.
              </p>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-2">
                Anyone who transports controlled waste must be registered as a waste carrier with
                the Environment Agency. There are two tiers of registration:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Lower tier:</strong> Free registration for businesses that carry their own
                  non-construction/demolition waste, or only carry waste that does not normally need
                  a licence (e.g., animal by-products)
                </li>
                <li className="pl-1">
                  <strong>Upper tier:</strong> Required for any business that carries other people's
                  waste, or carries construction and demolition waste. Costs approximately £154 for
                  3 years
                </li>
              </ul>
              <p className="text-sm text-white mt-2">
                Many electrical maintenance companies need upper tier registration because they
                carry construction/demolition waste (e.g., old distribution boards, cables,
                trunking) from client premises. Always check your company's registration status —
                carrying waste without registration is an offence.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 space-y-3">
              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/30">
                ...
                <p className="text-sm text-white">
                  ...
                  ordering the correct quantities of materials, using accurate measurements to
                  minimise cable offcuts, specifying durable equipment that lasts longer, and
                  maintaining equipment to extend its service life rather than replacing it
                  prematurely. Prevention also includes designing installations that are easy to
                  maintain and upgrade without generating waste.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-green-500/5 border border-green-500/20">
                ...
                <p className="text-sm text-white">
                  ...
                  instead of mercury-containing fluorescent tubes), and use modular components that
                  can be partially replaced rather than discarding entire assemblies.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
                ...
                <p className="text-sm text-white">
                  Use items again for the same or a different purpose without reprocessing.
                  Salvageable distribution boards, cable tray, trunking, conduit fittings and
                  sometimes cables can be reused on other projects if they are in good condition and
                  meet current standards. Always verify that reused electrical equipment is safe and
              ...
              <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
                ...
                <p className="text-sm text-white">
                  ...
                  recycled. Proper segregation on site is essential to maximise recycling value —
                  mixed waste is much harder and more expensive to recycle than source-separated
                  materials.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-orange-500/5 border border-orange-500/20">
                ...
                <p className="text-sm text-white">
                  ...
                  recovery (incineration with energy capture). Some non-recyclable plastics and
                  mixed waste can be sent to energy-from-waste plants rather than landfill. This is
                  preferable to disposal but should only be used when recycling is not feasible.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-red-500/5 border border-red-500/20">
                ...
                <p className="text-sm text-white">
                  Landfill or incineration without energy recovery. This is the option of last
                  resort and carries the highest environmental cost, including landfill tax. Every
                  tonne of waste sent to landfill incurs a standard rate tax of £103.70 (2024 rate),
                  making it the most expensive disposal route and providing a strong financial
                  incentive to move waste up the hierarchy.
                </p>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white">
                Before disposing of any material, ask yourself: Can I prevent this waste? Can I
                reduce it? Can it be reused? Can it be recycled? Only when the answer to all of
                these is genuinely "no" should you consider recovery or disposal. Document your
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Waste that poses a risk to human health or the environment due to its
                        chemical or physical properties
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Fluorescent tubes (mercury), lead-acid batteries, PCB capacitors,
                        transformer oil, asbestos-containing cables, SF6 gas
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Hazardous Electrical Waste — Detailed Breakdown
              </p>
              <ul className="text-sm text-white space-y-2 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Batteries (lead-acid):</strong> UPS batteries, emergency lighting
                  batteries and standby power batteries contain lead and sulphuric acid. Store
                  upright in acid-resistant bunds. EWC code: 16 06 01*.
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>PCB-containing equipment:</strong> Pre-1986 capacitors and some
                  transformers may contain polychlorinated biphenyls. These are persistent organic
                  pollutants requiring specialist high-temperature incineration. EWC code: 16 02
                  09*.
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  be recovered by certified technicians during maintenance or decommissioning —
                  never vented to atmosphere. Classified under F-Gas Regulations.
                </li>
                <li className="pl-1">
                  <strong>Asbestos-containing cables:</strong> Some pre-1990 cables used asbestos
                  yarn as insulation or packing. If suspected, treat as asbestos waste — do not
                  disturb without an asbestos survey. EWC code: 17 06 05*.
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  WEEE is stored separately from general waste in secure, covered areas
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  WEEE is transferred to an AATF or a distributor operating a take-back scheme
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  Required for all non-hazardous controlled waste transfers.
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    Name, address and carrier registration number of the transferee
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  Required for all hazardous waste movements.
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">
                    Unique consignment note code (from the Environment Agency)
                  </li>
                  ...
                  <li className="pl-1">
                    Consignee (destination facility) details and permit number
                  </li>
                  <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white">
                ...
                carrier, you can use a 'season ticket' — a single waste transfer note that covers
                multiple transfers over a period of up to 12 months. This reduces paperwork for
                routine waste streams (e.g., regular collection of copper cable offcuts by a scrap
                merchant) while maintaining legal compliance. Each individual collection must still
                be recorded with the date and quantity.
              </p>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>WEEE:</strong> Whole electrical items kept separate from stripped
                  materials
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                On larger maintenance projects or refit works, skips are the primary waste
                containers. Proper skip management is essential for legal compliance and cost
                control:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Use colour-coded or clearly labelled skips for different waste streams
                </li>
                <li className="pl-1">
                  Never mix hazardous and non-hazardous waste in the same skip — this contaminates
                  the entire load
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  Skips on the public highway need a licence from the local authority, with lights
                  and reflectors for visibility
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white mb-2">
                Landfill tax is a powerful economic instrument designed to reduce the amount of
                waste sent to landfill. Understanding the rates helps you appreciate the financial
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  Liquids (oils, acids) must be stored in bunded areas capable of containing at
                  least 110% of the largest container. Storage time is limited — you must not
                  accumulate more than 12 months' worth of hazardous waste without an environmental
                  permit.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  Store tubes vertically in purpose-built 'coffin' containers to prevent breakage.
                  Never place loose tubes in a skip or bin bag — broken tubes release mercury
                  vapour. Limit storage quantities and arrange regular collection by a specialist
                  lamp recycler. Record quantities stored and disposed of for your hazardous waste
                  records. Some manufacturers and distributors operate take-back schemes for waste
                  lamps.
                </p>
              </div>
            </div>
