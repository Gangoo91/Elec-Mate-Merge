...
const DESCRIPTION =
  'Break down installation work into logical tasks, sequence them efficiently, and coordinate on-site to avoid rework and delays.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Job breakdown is the method of dividing large electrical installation projects into smaller, manageable tasks.',
  },
  {
    id: 2,
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Job breakdown divides large electrical installation projects into smaller, manageable tasks to ensure work is completed safely and efficiently.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Adjust the sequence with supervisor's approval and communicate changes to the team to maintain safety and efficiency.",
    },
    {
      id: 10,
  ...
  const faqs = [
    {
      ...
      answer:
        "Yes, but only if they don't interfere with each other or cause safety risks. For example, you might run cables in one area while another team installs containment in a different area.",
    },
    {
      question: 'Who decides the sequence of tasks?',
      answer:
        'Usually the site supervisor or project manager decides the overall sequence, but electricians must understand and follow it. Input from experienced tradespeople is often considered.',
    },
    {
      question: 'How do I handle last-minute changes?',
      answer:
        "Adjust the sequence with your supervisor's approval and communicate with your team immediately. Document any changes and their reasons for future reference.",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/80 text-sm space-y-1 list-disc pl-4">
                  ...
                  <li>
                    <strong>Use:</strong> Gantt charts, task lists, daily standups
                  </li>
                  <li>
                    <strong>Check:</strong> Dependencies met before starting next phase
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                logical steps and planning them in the most efficient order. This ensures work is
                completed safely, efficiently, and without unnecessary delays or clashes with other
                trades.
              </p>
              ...
              <p>
                <strong className="text-white">Real Impact:</strong> A well-sequenced electrical
                installation on a typical commercial project can save 15-20% in labour costs and
                reduce project completion time by 1-2 weeks compared to poorly planned work.
              </p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ul className="text-sm text-white/70 list-disc pl-4 space-y-1">
                      ...
                      <li>
                        Examples: setting out containment, running cables, installing accessories,
                        testing
                      </li>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ol className="text-sm text-white/70 list-decimal pl-4 space-y-1">
                      ...
                      <li>
                        <strong>Containment:</strong> Install trunking, conduit, cable trays
                      </li>
                      <li>
                        <strong>Cabling:</strong> Run cables through containment systems
                      </li>
                      <li>
                        <strong>Terminations:</strong> Connect cables to accessories and equipment
                      </li>
                      <li>
                        <strong>Testing:</strong> Inspect and test the completed installation
                      </li>
                    </ol>
                  </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
                  ...
                  <div>
                    ...
                    <ol className="text-sm text-white/70 list-decimal pl-4 space-y-2">
                      <li>
                        ...
                        <p className="mt-1">
                          Study electrical layouts, cable schedules, and equipment specifications
                          thoroughly
                        </p>
                      </li>
                      <li>
                        ...
                        <p className="mt-1">
                          Break down into specific, measurable activities with clear deliverables
                        </p>
                      </li>
                      <li>
                        <strong>Order them logically</strong>
                        <p className="mt-1">
                          Follow the sequence: groundwork → containment → cabling → terminations →
                          testing
                        </p>
                      </li>
                      <li>
                        ...
                        <p className="mt-1">
                          Consider other trades — wait for walls to be plastered before fixing
                          accessories
                        </p>
                      </li>
                      <li>
                        ...
                        <p className="mt-1">
                          Allocate realistic time for each task including potential delays
                        </p>
                      </li>
                      <li>
                        <strong>Identify critical path</strong>
                        <p className="mt-1">
                          Determine which tasks, if delayed, would affect the overall project
                          timeline
                        </p>
                      </li>
                    </ol>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="font-medium text-white mb-3">
                  Example Task Breakdown — Office Floor Installation:
                </p>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div className="p-4 rounded-lg bg-orange-500/10 border-l-2 border-orange-400/50">
                ...
                <ul className="text-sm text-white/70 list-disc pl-4 space-y-2">
                  ...
                  <li>
                    <strong>Avoids clashes with other trades</strong> — coordinate with plasterers,
                    carpenters, etc.
                  </li>
                  <li>
                    <strong>Helps meet deadlines and milestones</strong> — keeps project on schedule
                  </li>
                  <li>
                    <strong>Improves safety and organisation on site</strong> — reduces hazards and
                    confusion
                  </li>
                  <li>
                    <strong>Optimises resource allocation</strong> — tools and materials are
                    available when needed
                  </li>
                  <li>
                    <strong>Maintains quality standards</strong> — proper sequence prevents damage
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-400/50">
              ...
              <ul className="text-sm text-white/70 list-disc pl-4 space-y-2">
                ...
                <li>
                  <strong>Increased accidents or unsafe conditions</strong> — rushing or working
                  around problems
                </li>
                <li>
                  <strong>Delays caused by rework or obstruction of other trades</strong> — knock-on
                  effects
                </li>
                <li>
                  <strong>Non-compliance with project schedule</strong> — penalties and damage to
                  reputation
                </li>
              </ul>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="text-sm text-white/70 list-disc pl-4 space-y-2">
                ...
                <li>
                  <strong>Coordinate daily:</strong> Don't run cables if ductwork or plastering is
                  due in that area
                </li>
                <li>
                  <strong>Safety first sequencing:</strong> Ensure containment is secure before
                  pulling cables
                </li>
                <li>
                  <strong>Clear communication:</strong> Brief team members about their specific
                  tasks and timing
                </li>
                <li>
                  <strong>Daily progress reviews:</strong> Check progress and adjust sequence if
                  unexpected issues arise
                </li>
                <li>
                  <strong>Trade coordination:</strong> Regular liaison with other trades to avoid
                  conflicts
                </li>
                <li>
                  <strong>Material staging:</strong> Ensure materials arrive when needed, not too
                  early or late
                </li>
                <li>
                  <strong>Quality checkpoints:</strong> Build in inspection points at key sequence
                  stages
                </li>
              </ul>
            </div>
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              good planning and sequencing at the start saves time, money, and frustration
