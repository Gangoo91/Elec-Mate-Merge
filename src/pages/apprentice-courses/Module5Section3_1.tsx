      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <header className="mb-6 sm:mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 rounded-lg bg-card">
              <Clipboard className="w-6 h-6 text-foreground" />
            </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">1. What is Job Breakdown?</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-3">Breaking Down Large Projects</p>
                    
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Splitting Large Jobs:</strong></p>
                      ...
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Clear Responsibilities:</strong></p>
                        <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
          ...
          {/* Sequencing Work */}
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">2. Sequencing Work</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Typical Electrical Sequence:</strong></p>
                      ...
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Example of Poor Sequencing:</strong></p>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">3. Steps in Task Sequencing</h3>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-3">Systematic Planning Process</p>
                    
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-foreground mb-3"><strong>Essential Planning Steps:</strong></p>
                        <ol className="list-decimal ml-4 space-y-3 text-base text-foreground">
                          <li>
                            <strong>Review installation drawings and specifications</strong>
                            <p className="text-sm text-muted-foreground mt-1">Study electrical layouts, cable schedules, and equipment specifications thoroughly</p>
                          </li>
                          <li>
                            <strong>List all required tasks</strong>
                            <p className="text-sm text-muted-foreground mt-1">Break down into specific, measurable activities with clear deliverables</p>
                          </li>
                          <li>
                            <strong>Order them logically</strong>
                            <p className="text-sm text-muted-foreground mt-1">Follow the sequence: groundwork → containment → cabling → terminations → testing</p>
                          </li>
                          <li>
                            <strong>Factor in dependencies</strong>
                            <p className="text-sm text-muted-foreground mt-1">Consider other trades - wait for walls to be plastered before fixing accessories</p>
                          </li>
                          <li>
                            <strong>Estimate timeframes</strong>
                            <p className="text-sm text-muted-foreground mt-1">Allocate realistic time for each task including potential delays</p>
                          </li>
                          <li>
                            <strong>Identify critical path</strong>
                            <p className="text-sm text-muted-foreground mt-1">Determine which tasks, if delayed, would affect the overall project timeline</p>
                          </li>
                        </ol>
                      </div>

                      <div className="bg-background/50 p-4 rounded border">
                        <p className="font-medium text-foreground mb-2">Example Task Breakdown - Office Floor Installation:</p>
                      ...
                      <div className="bg-emerald-50 dark:bg-blue-900/20 p-3 rounded border border-blue-200 dark:border-blue-800">
                        <p className="font-medium text-blue-700 dark:text-emerald-400 mb-2">Dependencies Example</p>
                        <p className="text-xs sm:text-sm text-foreground">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">4. Why Sequencing Matters</h3>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-3">Benefits of Proper Sequencing</p>
                    
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-foreground mb-3"><strong>Key Benefits:</strong></p>
                        <ul className="list-disc ml-4 space-y-2 text-base text-foreground">
                      ...
                      <div className="bg-background/50 p-4 rounded border">
                        <p className="font-medium text-foreground mb-2">Cost Impact Analysis:</p>
                        <div className="grid md:grid-cols-2 gap-4 text-sm">
                          <div>
                          ...
                          <div>
                            <p className="font-medium mb-2 text-red-600 dark:text-emerald-400">Poor Sequencing:</p>
                            <ul className="list-disc ml-4 space-y-1 text-muted-foreground">
                      ...
                      <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded border border-orange-200 dark:border-orange-800">
                        <p className="font-medium text-orange-700 dark:text-emerald-400 mb-2">Industry Insight</p>
                        <p className="text-xs sm:text-sm text-foreground">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">5. Risks of Poor Breakdown/Sequencing</h3>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-red-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-red-600 dark:text-emerald-400 mb-3">Consequences of Poor Planning</p>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-4">
            <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
              <h3 className="font-semibold text-emerald-400 dark:text-emerald-400 mb-3">On-Site Best Practices</h3>
              <ul className="list-disc pl-6 space-y-2 text-base text-foreground">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
            <div className="space-y-4">
              <div className="rounded-lg p-3 sm:p-4 bg-card border border-emerald-500/30">
                <h3 className="font-semibold text-emerald-600 dark:text-emerald-400 mb-3">Quick Task Breakdown</h3>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
                <h3 className="font-semibold text-emerald-400 dark:text-emerald-400 mb-3">Planning Tools</h3>
                <ul className="list-disc pl-6 space-y-1 text-xs sm:text-sm text-foreground">
