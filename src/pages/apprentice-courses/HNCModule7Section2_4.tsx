        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Generator sizing:</strong> kVA = kW ÷ power factor + starting allowance
              </li>
              <li className="pl-1">
                <strong>AMF panels:</strong> Detect mains failure and auto-start generator
              </li>
              <li className="pl-1">
                <strong>Transfer time:</strong> Typically 10-15 seconds total
              </li>
              <li className="pl-1">
                <strong>Testing:</strong> Weekly no-load, monthly on-load
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Critical facilities:</strong> Hospitals, data centres require N+1 redundancy
              </li>
              <li className="pl-1">
                <strong>Fuel storage:</strong> 24-72 hours autonomy typical
              </li>
              <li className="pl-1">
                <strong>Load shedding:</strong> Priority-based load management
              </li>
              <li className="pl-1">
                <strong>Compliance:</strong> BS 7671, HTM 06-01 for healthcare
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Step 1:</strong> Calculate total connected load in kW from distribution
                  board schedules
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Step 5:</strong> Apply derating factors for altitude and ambient
                  temperature
                </li>
                <li className="pl-1">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Add starting kVA to running load
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Higher ambient reduces cooling efficiency
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Affects sensitive equipment operation
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="font-mono text-sm space-y-1">
                ...
                <p>
                  <span className="text-green-400">
                    Selected generator: 400 kVA (next standard size with margin)
                  </span>
                </p>
              </div>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Design note:</strong> Always verify generator voltage dip during motor
              starting remains within 15% to prevent nuisance tripping of other equipment.
            </p>
          </div>
        </section>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        4-hour fire-rated enclosure indoor
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Automatic shut-off at 95% capacity
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Oil Storage Regulations 2001
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Annual testing, polishing if required
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Contents, capacity, emergency contact
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Oil Storage Regulations 2001
                      </td>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Mains monitoring:</strong> Voltage, frequency, phase sequence, and phase
                  loss detection
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Load transfer:</strong> Changeover contactor control with
                  break-before-make operation
                </li>
                <li className="pl-1">
                  <strong>Protection:</strong> Overcurrent, reverse power, earth fault, and
                  over/under voltage
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                Mains Failure Starting Sequence
              </p>
              <div className="font-mono text-sm space-y-1">
                <p>
                ...
                <p>
                  <span className="text-green-400">Total transfer time: 10-15 seconds typical</span>
                </p>
              </div>
            </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Most installations, simplest design
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Closed transition</td>
                      <td className="border border-white/10 px-3 py-2">
                        Make-before-break (no outage)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Sensitive loads, requires synchronisation
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Soft loading</td>
                      <td className="border border-white/10 px-3 py-2">
                        Gradual load transfer via synchronising
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Large motors, reducing transients
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Mains restored and stable for minimum 30 seconds (adjustable)
                </li>
                <li className="pl-1">
                  Mains voltage and frequency within acceptable limits confirmed
                </li>
                <li className="pl-1">Load transfer back to mains (open or closed transition)</li>
                <li className="pl-1">
                  Generator runs at no load for cool-down period (3-5 minutes)
                </li>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Load priority classification:</strong> Essential, important, and
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical Load Priority Classification
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Security, BMS, IT infrastructure, lifts
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Comfort cooling, general lighting
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Catering, water heaters, EV charging
                      </td>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Test annually for degradation
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Fuel polishing/replacement
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Annual test, replace if degraded
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Load test before replacement due
                      </td>
                    </tr>
                    <tr>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Hospital Generator Sizing
              </h3>
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  Specify: 2 × 1,000 kVA generators (N+1 redundancy per HTM 06-01)
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: AMF Panel Specification
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Load Shedding Scheme
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  Essential load (250 kW) well within 400 kW capacity
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Exhaust routing with thermal insulation and rain protection
                </li>
                <li className="pl-1">Anti-vibration mounting to prevent structural transmission</li>
                <li className="pl-1">
                  Acoustic treatment to meet planning/environmental requirements
                </li>
