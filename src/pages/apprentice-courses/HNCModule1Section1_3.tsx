...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['The Client', 'The Principal Contractor', 'The Principal Designer', 'The HSE'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['Principal Designer', 'Client', 'Principal Contractor', 'Designer'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              As a building services designer your duty is not just to make it work — it is to make
              it buildable, maintainable and replaceable safely. Cable routes, switchroom
        ...
        <ConceptBlock title="Duty Holders and Their Responsibilities">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Client</strong> — Who: Anyone for whom construction work is carried out. Key
              Duties: Make suitable arrangements, appoint duty holders, provide pre-construction
              information
            </li>
            <li>
              <strong>Principal Designer</strong> — Who: Designer appointed by Client (projects with
              more than one contractor). Key Duties: Plan, manage and coordinate pre-construction
              phase H&S, prepare H&S File
            </li>
            <li>
              <strong>Designer</strong> — Who: Anyone who prepares or modifies designs. Key Duties:
              Eliminate or reduce foreseeable risks, provide information about residual risks
            </li>
            <li>
              <strong>Principal Contractor</strong> — Who: Contractor appointed by Client (projects
              with more than one contractor). Key Duties: Plan, manage and coordinate construction
              phase, prepare CPP, ensure welfare
            </li>
            <li>
              <strong>Contractor</strong> — Who: Anyone who carries out or manages construction
              work. Key Duties: Plan and manage own work safely, cooperate with Principal Contractor
            </li>
          </ul>

          <p className="text-sm font-medium text-white mb-2">Key principles of CDM 2015:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Duties are proportionate to the ability to influence project H&S</li>
            <li>
            ...
            <li>Competence requirements removed - focus on skills, knowledge, experience</li>
          </ul>
        ...
        <ConceptBlock title="Client Duties and F10 Notification">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Ensure a Construction Phase Plan is in place before construction starts</li>
          ...
          <div className="p-3 rounded bg-black/30">
            ...
            <p className="text-sm text-white">More than 500 person-days of construction work</p>
          </div>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Date construction phase is planned to start and estimated duration</li>
            <li>Maximum number of workers and contractors on site at any one time</li>
        ...
        <ConceptBlock title="Principal Designer Role">
          <p>
            ...
            Unlike the coordinator role, the Principal Designer must be a designer themselves - they
            cannot simply coordinate without having design capability and understanding.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Ensure designers comply with their duties under Regulation 9</li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cable containment routes</strong> — Risk Consideration: Work at height for
              installation/maintenance. Mitigation Example: Route at lower level where practicable
            </li>
            <li>
              <strong>Distribution board location</strong> — Risk Consideration: Access for testing,
              maintenance, isolation. Mitigation Example: Adequate working space, good lighting
            </li>
            <li>
              <strong>Heavy equipment (transformers)</strong> — Risk Consideration: Manual handling,
              lifting operations. Mitigation Example: Access for mechanical handling, lifting points
            </li>
            <li>
              <strong>Service penetrations</strong> — Risk Consideration: Structural integrity, fire
              stopping. Mitigation Example: Coordinate with structural engineer early
            </li>
            <li>
              <strong>Roof-mounted equipment</strong> — Risk Consideration: Edge protection, access
              routes. Mitigation Example: Design permanent access and fall protection
            </li>
          </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            before construction completion, they must pass the H&S File to the Principal Contractor
            who then maintains and completes it.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Principal Contractor and Construction Phase Plan">
          <p>
            ...
            construction work. The CPP is the key document that sets out how the construction phase
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Shared routes:</strong> Cable trays, pipework, ductwork competing for ceiling
              void space
            </li>
            <li>
            ...
            <li>
              <strong>Live systems:</strong> Working near or on energised equipment requires permits
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>As-built drawings showing cable routes, containment, equipment locations</li>
            ...
            <li>Hazardous materials (asbestos surveys, refrigerant types, PCBs)</li>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Client responsibility:</strong> The Client must keep the H&S File available for
            inspection and ensure it is revised if further construction work takes place. The file
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1: Notification Calculation</strong>
          </p>
          <p className="text-sm text-white mb-2">
            <strong>Question:</strong> A new office fit-out will take 12 weeks. The workforce will
            ramp up from 5 workers in weeks 1-2, to 15 workers in weeks 3-8, then 8 workers in weeks
            9-12. Is F10 notification required?
          </p>
          <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
            <p>Check threshold 1: More than 30 days with more than 20 workers?</p>
            <p>
              Maximum workers = 15 (does not exceed 20) - <span className="text-red-400">NO</span>
            </p>
          ...
          <p>
            <strong>Example 2: Designer Risk Considerations</strong>
          </p>
          <p className="text-sm text-white mb-2">
            <strong>Scenario:</strong> An M&E consultant is designing the electrical installation
            for a warehouse with 10m high ceilings. What CDM considerations apply to luminaire
            specification?
          </p>
          <div className="bg-black/30 p-3 rounded text-sm text-white">
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Reduce:</strong> Use high-level access with lowering winches for maintenance
              </li>
              <li>
          ...
          <p>
            <strong>Example 3: Duty Holder Identification</strong>
          </p>
          <p className="text-sm text-white mb-2">
            <strong>Scenario:</strong> A property management company commissions a rewire of a
            commercial unit. They appoint an electrical contractor who designs and installs the new
            system. Identify the duty holders.
          </p>
          <div className="bg-black/30 p-3 rounded text-sm text-white">
            <p>
            ...
            <p className="text-white text-xs ml-4">- Must consider risks in design decisions</p>
            <p className="mt-2">
              <strong>Principal Designer:</strong> Electrical contractor (single contractor project)
            </p>
            <p className="text-white text-xs ml-4">
            ...
            <p className="text-white text-xs ml-4">- Must prepare CPP if project is notifiable</p>
            <p className="mt-2">
        ...
        <ConceptBlock title="Practical Guidance">
          <div>
            <p>
              <strong>Key Regulations to Know</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
          ...
          <div>
            <p>
              <strong>Notification Thresholds Summary</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>Display F10 in site office (or where impracticable, keep available)</li>
            </ul>
          </div>
        ...
        <Scenario
          ...
          situation={
            <>
              You are designing the electrical refit of a 14-flat residential block. The contractor
              estimates the project will run 35 working days with 18 trades on site most days. The
              client believes CDM doesn&rsquo;t apply because it is a domestic project.
            </>
          }
          whatToDo={
            <>
              Flag two CDM points in writing. First, even on a domestic client project the CDM
              duties are transferred to the contractor (Reg 7) — duties do not disappear, they
              migrate. Second, the project exceeds the 30-working-day notification threshold, so the
              client (or by extension the contractor) must submit an F10 to HSE before construction
              starts and appoint a principal designer and principal contractor in writing.
            </>
          }
          whyItMatters={
            <>
              Failure to notify is a strict-liability offence. As an HNC engineer signalling the
              requirement early protects the client from a Prohibition Notice and protects you from
              being drawn into an HSE investigation under Reg 13.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Section 1.4</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
