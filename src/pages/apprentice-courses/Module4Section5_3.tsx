...
const TITLE =
  'Terminating Twin & Earth, Singles, and Flex - Module 4.5.3 | Level 2 Electrical Course';
const DESCRIPTION =
  'Master safe cable termination techniques for Twin & Earth, single-core, and flexible cables. Learn preparation, stripping, dressing, and testing procedures according to BS 7671.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      'For identification and safety requirements',
      'Purely to improve the appearance of the work',
      'To reduce the resistance of the earth path',
    ],
    correctIndex: 0,
    explanation:
      'BS 7671 requires the CPC to be clearly identified with green/yellow sleeving to prevent confusion and ensure safety during maintenance.',
  },
  {
    id: 2,
    ...
    options: [
      ...
      'To prevent fine strands from spreading',
      'To improve the appearance of the termination',
    ],
    correctIndex: 1,
    explanation:
      'Ferrules prevent fine strands from spreading when inserted into terminals, ensuring reliable connection and preventing loose strands.',
  },
  {
    id: 3,
    question: 'What check confirms that a conductor is firmly secured in a terminal?',
    options: ['A visual inspection only', 'An insulation resistance test', 'A gentle tug test'],
    correctIndex: 2,
    explanation:
      'A gentle tug test verifies mechanical security of the connection, ensuring the conductor cannot be pulled out of the terminal.',
  },
];
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'How must the bare CPC in T&E cable be treated at a termination?',
    options: [
      'It must be sleeved with green/yellow identification',
      'It may be left bare if it is clearly visible',
      'It may be wrapped with red tape for identification',
      'It only needs sleeving in domestic installations',
    ],
    correctAnswer: 0,
    explanation:
      'BS 7671 requires the CPC to be sleeved with green/yellow identification regardless of how identifiable it appears.',
  },
  {
    id: 3,
  ...
  {
    id: 6,
    question: 'Why should the insulation end just inside the terminal?',
    options: [
      'To make the cable easier to pull out later',
      'To leave a length of bare copper for testing',
      'To ensure good electrical contact without exposed copper',
      'To allow the conductor to move freely in the terminal',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To protect against moisture ingress and maintain the IP rating',
      'To increase the current rating of the cable',
      'To remove the need for a circuit protective conductor',
      'To allow conductors to be terminated without tools',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Selecting the correct ferrule size',
      'Carrying out a tug test on each connection',
      'Over-tightening terminals and damaging the conductor',
    ],
    correctAnswer: 3,
    explanation:
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            <p className="text-white text-sm leading-relaxed">
              ...
              of electrical failures and fire hazards.
            </p>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h4 className="font-medium text-white mb-2">
                  Twin & Earth (T&E) Cable Construction
                </h4>
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Primary applications:</strong> Fixed wiring in domestic and commercial
                    installations
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Applications:</strong> Conduit and trunking installations
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Construction:</strong> Stranded copper conductors for flexibility and
                    movement
                  </li>
          ...
          <section className="mb-10 pt-8 border-t border-white/10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Live (brown):</strong> Connect to L terminal, ensure full insertion
                  </li>
                  <li>
                    • <strong>Neutral (blue):</strong> Connect to N terminal with secure tightening
                  </li>
                  <li>
                    • <strong>CPC (green/yellow sleeved):</strong> Connect to earth terminal
                  </li>
            ...
            <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
              ...
              <div className="p-3 bg-green-500/10 border border-green-500/20 rounded">
                <p className="text-green-400 text-sm">
                  <strong>Lesson learned:</strong> The rework took three days and cost significantly
                  more than doing it correctly initially. Always use ferrules on stranded conductors
                  and never rely on twisted strands alone.
                </p>
              </div>
            </div>
          </section>
