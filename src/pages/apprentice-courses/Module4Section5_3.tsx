      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Understanding Cable Types and Applications</h3>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Twin & Earth (T&E) Cable Construction</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Primary applications:</strong> Fixed wiring in domestic and commercial installations for socket and lighting circuits.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Construction details:</strong></p>
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Installation environments:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Single-Core Cable Systems</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>System applications:</strong> Conduit and trunking installations where individual conductor routing is required.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Advantages of single-core systems:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Standard colour codes (BS 7671):</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Flexible Cables (Flex) Characteristics</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Construction features:</strong> Stranded copper conductors for flexibility and movement capability.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Application categories:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Conductor specifications:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Cable Preparation and Stripping Techniques</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Planning approach:</strong> Measure twice, cut once to avoid waste and ensure adequate conductor length.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Length calculations:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Cutting tools and techniques:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Twin & Earth preparation:</strong> Remove outer sheath without damaging inner conductors.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Stripping procedures for T&E:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Single-core preparation:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Stranded conductor handling:</strong> Special techniques required to prevent strand separation.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Flex preparation steps:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Ferrule selection and application:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Termination Techniques and Best Practices</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Twin & Earth Termination Procedures</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Standard termination sequence:</strong> Systematic approach ensures consistent, safe connections.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Connection procedures:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Terminal tightening specifications:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Single-Core Cable Installation</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Routing and management:</strong> Systematic approach to conductor routing within containment systems.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Installation procedures:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Termination considerations:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Flexible Cable Termination with Strain Relief</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Mechanical protection:</strong> Essential to prevent strain on electrical connections.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Ferrule application:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Cord grip installation:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Testing and Quality Assurance</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">Mechanical Security Testing</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Tug testing procedures:</strong> Verify mechanical integrity of all terminations.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Testing methodology:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">Electrical Continuity and Polarity Verification</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Testing requirements:</strong> Verify electrical integrity and correct conductor identification.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Continuity testing:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Polarity verification:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">BS 7671 Compliance and Documentation</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Regulatory requirements:</strong> All terminations must provide mechanical and electrical security.</p>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-sm">
            <div>
              <h3 className="font-medium text-foreground mb-3">Tools and Techniques</h3>
            ...
            <div>
              <h3 className="font-medium text-foreground mb-3">Quality and Safety</h3>
              <ul className="space-y-2 text-foreground">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-muted/50 rounded-lg border">
              <p className="font-medium text-foreground mb-2">Why must T&E earth conductors be sleeved before termination?</p>
              <p className="text-sm text-muted-foreground">BS 7671 requires clear identification of protective conductors with green/yellow sleeving to prevent confusion and ensure safety.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg border">
              <p className="font-medium text-foreground mb-2">What is the purpose of ferrules on flexible conductors?</p>
              <p className="text-sm text-muted-foreground">Ferrules prevent fine strands from spreading in terminals, ensuring reliable connections and preventing loose strands.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg border">
              <p className="font-medium text-foreground mb-2">How do you verify a conductor is securely terminated?</p>
              <p className="text-sm text-muted-foreground">Perform a gentle tug test to confirm the conductor cannot be withdrawn from the terminal under reasonable force.</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-medium text-foreground mb-2">Q: Can I use T&E cable in conduit?</h3>
              <p className="text-sm text-muted-foreground">A: It's not standard practice — single-core cables are better suited for conduit installations as they're easier to pull and replace.</p>
            </div>
            <Separator />
            <div>
              <h3 className="font-medium text-foreground mb-2">Q: Is twisting stranded conductors always necessary?</h3>
              <p className="text-sm text-muted-foreground">A: Yes, unless a ferrule is fitted — it prevents strands from spreading when inserted into the terminal and ensures reliable connection.</p>
            </div>
            <Separator />
            <div>
              <h3 className="font-medium text-foreground mb-2">Q: How much insulation should be stripped from a conductor?</h3>
              <p className="text-sm text-muted-foreground">A: Just enough to ensure full contact with the terminal without leaving bare copper exposed — typically 12-15mm for most accessories.</p>
            </div>
          </div>
        </Card>
