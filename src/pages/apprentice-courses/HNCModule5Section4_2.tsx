...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['24-48 hours', 'Same day', '2 hours', '7 days'],
    correctIndex: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Initial verification under BS 7671 is mandatory and progressive — inspection and
              testing happen during erection (rough-in) AND on completion (final). The ITP is how
              this is planned and tracked: rough-in inspection before walls close up, continuity
              tests before energisation, full sequence at handover. Skipping the progressive
              verification means defects buried in the fabric.
            </>
          }
        ...
        <ConceptBlock title="ITP Format and Content">
          <p>
            ...
            process. For MEP works, the ITP ensures quality requirements from BS 7671, CIBSE guides,
            and project specifications are met at each critical stage.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Containment installation (W):</strong> Routing, fixings, segregation — Drawing
              series E-100
            </li>
            <li>
              <strong>Cable installation pre-cover (H):</strong> Types, routes, support spacing — BS
              7671, Spec clause 5.3
            </li>
            <li>
          ...
          <p>
            <strong>Key principle:</strong> The ITP captures quality gates - points where quality is
            verified before work proceeds. Missing an inspection point risks defects being concealed
            or costly rework.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Hold Points vs Witness Points">
          ...
          <p>
            <strong>Contract requirement:</strong> The specification typically defines minimum Hold
            Points. Contractors may add additional quality gates in their ITP.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Notification Requirements and Procedures">
          ...
          <p>
            ...
            tracking, audit trails, and dashboard visibility of inspection status. Common platforms
            include Aconex, Procore, and project-specific QA systems.
          </p>
          <p>
            <strong>Record keeping:</strong> Always retain proof of notification (email timestamps,
            system logs) in case of disputes about inspection attendance.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Inspection Scheduling and Sign-off Procedures">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Dependent trades:</strong> Coordinate with following trades awaiting sign-off
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Audit trail:</strong> The completed ITP with all sign-offs, NCRs, and supporting
            records forms a key part of the O&M manual and demonstrates quality compliance
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>H4:</strong> Fire authority witness test — minimum 5 days notice to authority,
          ...
          <p>
            <strong>Example 3 — Programme integration:</strong> A 5-day cabling activity requires a
            pre-cover Hold Point with 48hr notice. How should this be programmed?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Missing records</strong> — cannot demonstrate quality compliance at handover
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              Your ITP defines a hold point at "containment installation, before cabling pulled".
              The electrical sub installs containment over a weekend and starts pulling cable before
              the inspection. On Monday the QA inspector finds the containment is wrongly sized in
              two zones; the cable already pulled has to be removed, the containment replaced, the
              cable re-pulled. Cost of rework: £18k. Programme impact: 1 week.
            </>
          }
          whatToDo={
            <>
              Reinforce hold-point discipline at the next site meeting. Update the ITP register so
              all subcontractors know which points are HOLD vs WITNESS vs INSPECTION. Re-issue site
              notice that work proceeding past a HOLD without sign-off is contractually a defect —
              rework at subcontractor cost. Implement a pre-pour / pre-cover walkover with the
              inspector for any concealed work. Close the NCR with corrective action.
            </>
          }
          whyItMatters={
            <>
              ITP discipline is what catches defects before they are buried. A hold point breached
              is not an inconvenience — it is an early warning of weak supervision and undisciplined
              working. Tighten now or pay at handover.
            </>
          }
        />
