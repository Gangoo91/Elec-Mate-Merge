      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>ITP:</strong> Documents all inspection and verification stages
              </li>
              <li className="pl-1">
                <strong>Hold Point:</strong> Work stops until formal sign-off
              </li>
              <li className="pl-1">
                <strong>Witness Point:</strong> Notification given; work proceeds if no attendance
              </li>
              <li className="pl-1">
                <strong>Purpose:</strong> Ensures quality at every critical stage
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Pre-concealment:</strong> Critical Hold Point for hidden work
              </li>
              <li className="pl-1">
                <strong>Pre-energisation:</strong> Mandatory inspection before power on
              </li>
              <li className="pl-1">
                <strong>Fire systems:</strong> Multiple witness/authority inspections
              </li>
              <li className="pl-1">
                <strong>Commissioning:</strong> Staged verification with sign-offs
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical ITP Structure for Electrical Installation
              </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Correct specification, undamaged
                      </td>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30">
                ...
                <p className="text-xs text-red-400/70 mt-2">
                  Failure to observe: serious quality breach
                </p>
              </div>
              <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
                ...
                <p className="text-xs text-blue-400/70 mt-2">
                  Notification period must be observed
                </p>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Building Services Hold Point Examples
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Electrical:</strong> Pre-concealment cable check, pre-energisation
                  testing, EICR before handover
                </li>
                <li className="pl-1">
                  <strong>Fire alarm:</strong> Cause and effect testing, fire authority witness
                ...
                <li className="pl-1">
                  <strong>Data/comms:</strong> Pre-cover structured cabling, final test
                  certification
                </li>
                <li className="pl-1">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Unique identification of inspection point
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Activity description</td>
                      <td className="border border-white/10 px-3 py-2">
                        Clear statement of what will be inspected
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Test results, drawings, method statements
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Safety equipment needed for inspection area
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Inspection Scheduling Example - Distribution Board Installation
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Board installation, cable glanding
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2 text-red-400">
                        Issue notification for H1 (48hr)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Complete testing, prepare records
                      </td>
                      <td className="border border-white/10 px-3 py-2">-</td>
                    </tr>
                    <tr>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Non-Conformance Handling at Inspections
              </p>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Fire Alarm ITP Development
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-amber-400">
                  Please confirm attendance or nominate alternate.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Programme Integration
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-green-400">
                  Best practice: Build 1-day float after Hold Points
                </p>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Include statutory inspections (fire authority, building control)
                </li>
