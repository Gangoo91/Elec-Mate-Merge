                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Individual control, feedback, 64 addresses
                      </td>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Dual function with general lighting
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Longer but less disruptive overall
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Compromised by existing housing
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Optimised as integrated system
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Limited by existing wiring
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Full DALI/wireless capability
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Aesthetics</td>
                      <td className="border border-white/10 px-3 py-2">
                        Retains existing appearance
                      </td>
                      <td className="border border-white/10 px-3 py-2">
