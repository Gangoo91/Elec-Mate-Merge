...
const quickCheckQuestions = [
  {
    ...
    options: ['IE2 High', 'IE1 Standard', 'IE3 Premium', 'IE4 Super Premium'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['80-100 lm/W', '50-70 lm/W', '200-250 lm/W', '120-160 lm/W'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['lm/W', 'kWh/m2/year', 'W/m2', 'lux'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['6.6kW', '4.9kW', '8.2kW', '3.3kW'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['40-60%', '20-30%', '10-15%', '70-80%'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['BS EN 1838', 'Both B and C', 'BS EN 12464-1', 'BS 5266-1'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['15 kWh/m2/year', '25 kWh/m2/year', '10 kWh/m2/year', '35 kWh/m2/year'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Approved Document L Volume 2 (2021) requires LENI calculation and automatic lighting
              controls on every commercial new-build or major refurbishment. As BSE designer you
              produce the LENI sum (lamp wattage &times; hours of use &times; control factor / floor
              area) and document automatic switching for occupancy and daylight zones. The Building
              Control submission requires this evidence; the BREEAM Hea / Ene credits claim it.
            </>
          }
        ...
        <ConceptBlock title="In 30 seconds">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>IE3/IE4 motors:</strong> Premium efficiency required by EU regulation
            </li>
            <li>
              <strong>LED efficacy:</strong> 120-160 lm/W for quality commercial luminaires
            </li>
            <li>
              <strong>Controls:</strong> PIR, daylight dimming, DALI for Part L compliance
            </li>
            <li>
              <strong>LENI:</strong> Target 10-15 kWh/m2/year for offices
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Building Services Context</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Motors:</strong> 40-60% of building electrical load
            </li>
            <li>
              <strong>Lighting:</strong> 15-25% of commercial building energy
            </li>
            <li>
              <strong>Part L 2021:</strong> Sets minimum efficiency standards
            </li>
            <li>
              <strong>TM54:</strong> Predicts actual operational energy
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="IE Efficiency Motor Classes and Selection">
          <p>
            ...
            by IEC 60034-30-1, provides a standardised framework for motor efficiency comparison and
            selection.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>IE1</strong> — Standard — 88.1% — No longer permitted (new)
            </li>
            <li>
              <strong>IE2</strong> — High — 90.1% — Minimum for VSD-driven only
            </li>
            <li>
              <strong>IE3</strong> — Premium — 91.4% — Minimum for DOL 0.75-375kW
            </li>
            <li>
              <strong>IE4</strong> — Super Premium — 93.3% — Best available technology
            </li>
            <li>
              <strong>IE5</strong> — Ultra Premium — 94.6% — Emerging technology
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Since July 2023: IE4 minimum for 75-200kW motors (certain types)</li>
            <li>VSD-driven motors: IE2 minimum when combined with IE2 rated VSD</li>
            <li>Applies to 2, 4, 6 and 8 pole motors operating 50Hz or 60Hz</li>
          </ul>
        ...
        <ConceptBlock title="Motor Sizing - Avoiding Oversizing">
          <p>
            ...
            and running costs. Studies indicate that 60% of installed motors are oversized by 20% or
            more, wasting energy and reducing power factor.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Effects of Oversizing</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Optimal Operating Range</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Motor Sizing Methodology</p>
          <ol className="text-sm text-white space-y-1.5 list-decimal list-outside ml-5">
            ...
            <li>Add margin for starting torque requirements (typically 10-25%)</li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Standard Motor Sizes (kW)</p>
          <p>IEC standard frame sizes:</p>
          <p className="text-sm font-mono text-white">
            0.37, 0.55, 0.75, 1.1, 1.5, 2.2, 3, 4, 5.5, 7.5, 11, 15, 18.5, 22, 30, 37, 45, 55, 75,
            90, 110, 132, 160, 200, 250, 315, 375
          </p>
        ...
        <ConceptBlock title="LED Lighting Efficacy (lm/W)">
          <p>
            Luminous efficacy measures how effectively a light source converts electrical power into
            visible light, expressed in lumens per watt (lm/W). LED technology has transformed
            lighting efficiency, with modern luminaires achieving 120-180 lm/W compared to 60-80
            lm/W for fluorescent.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Incandescent</strong> — 10-17 — 1,000 — Banned (general service)
            </li>
            <li>
              <strong>Halogen</strong> — 15-25 — 2,000-4,000 — Being phased out
            </li>
            <li>
              <strong>Compact fluorescent</strong> — 50-70 — 8,000-15,000 — Legacy
            </li>
            <li>
              <strong>T5 fluorescent</strong> — 80-100 — 20,000-30,000 — Legacy
            </li>
            <li>
              <strong>LED (budget)</strong> — 80-100 — 25,000-35,000 — Available
            </li>
            <li>
              <strong>LED (quality commercial)</strong> — 120-160 — 50,000-80,000 — Recommended
            </li>
            <li>
              <strong>LED (high performance)</strong> — 160-200 — 80,000-100,000 — Premium
              specification
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>System efficacy:</strong> Total lumens output divided by total circuit watts
              (including driver)
            </li>
            <li>
          ...
          <p>
            <strong>Important:</strong> Always use system efficacy (luminaire lumens/circuit watts)
            for design calculations, not bare LED chip efficacy which ignores optical and driver
            losses.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Lighting Controls: PIR, Daylight Dimming">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Daylight-Linked Dimming</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1-10V</strong> — Analogue — Simple, low cost — Basic group dimming
            </li>
            <li>
              <strong>DALI</strong> — Digital — Individual control, feedback, 64 addresses —
              Commercial buildings
            </li>
            <li>
              <strong>DALI-2</strong> — Digital — Standardised, interoperable — New commercial
              projects
            </li>
            <li>
              <strong>KNX</strong> — Digital bus — BMS integration, multi-service — Intelligent
              buildings
            </li>
            <li>
              <strong>Wireless (Bluetooth/Zigbee)</strong> — Wireless — Retrofit friendly, flexible
              — Refurbishments
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Automatic occupancy and/or daylight detection for areas &gt;30m2</li>
            <li>Time scheduling capability for all general lighting</li>
            <li>Separate control of luminaires within 3m of windows</li>
            <li>Manual local switching with maximum 4 luminaires per switch</li>
        ...
        <ConceptBlock title="Emergency Lighting Efficiency">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Emergency Lighting Types</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Self-contained maintained</strong> — Always on — Full luminaire power — Dual
              function with general lighting
            </li>
            <li>
              <strong>Self-contained non-maintained</strong> — Emergency only — 1-3W charging — Low
              standby consumption
            </li>
            <li>
              <strong>Central battery maintained</strong> — Always on — Central system — Efficient
              for large installations
            </li>
            <li>
              <strong>Central battery slave</strong> — Emergency only — None (slave) — Most
              efficient for large buildings
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Efficiency Considerations</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Retrofit vs Replacement Analysis">
          <p>
            When upgrading existing lighting installations, the choice between retrofitting existing
            luminaires with LED lamps/modules or complete luminaire replacement requires careful
            analysis of technical, financial, and practical factors.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Comparison Matrix</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Capital cost</strong> — Lower (30-50% of replacement) — Higher but better
              value long-term
            </li>
            <li>
              <strong>Installation time</strong> — Faster (lamp swap) — Longer but less disruptive
              overall
            </li>
            <li>
              <strong>Efficacy achieved</strong> — 80-120 lm/W typical — 120-160+ lm/W achievable
            </li>
            <li>
              <strong>Thermal management</strong> — Compromised by existing housing — Optimised as
              integrated system
            </li>
            <li>
              <strong>Expected life</strong> — 25,000-40,000 hours — 50,000-100,000 hours
            </li>
            <li>
              <strong>Warranty</strong> — Often 2-3 years — Typically 5-7 years
            </li>
            <li>
              <strong>Controls integration</strong> — Limited by existing wiring — Full
              DALI/wireless capability
            </li>
            <li>
              <strong>Aesthetics</strong> — Retains existing appearance — Modern, updated appearance
            </li>
          </ul>
          ...
          <p>
            <strong>Life cycle analysis:</strong> Calculate total cost of ownership over 10-15 years
            including energy, maintenance, and replacement costs. Full replacement often provides
        ...
        <ConceptBlock title="Luminaire Selection Criteria">
          <p>
            Selecting the right luminaire requires balancing multiple technical requirements against
            cost and aesthetic considerations. A systematic approach ensures compliant, efficient,
            and practical solutions.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Technical Selection Criteria</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Efficacy (lm/W)</strong> — &gt;120 — &gt;100 — &gt;140
            </li>
            <li>
              <strong>UGR</strong> — &lt;19 — &lt;22 — &lt;25
            </li>
            <li>
              <strong>CRI</strong> — &gt;80 — &gt;90 — &gt;70
            </li>
            <li>
              <strong>CCT</strong> — 4000K — 3000-4000K — 4000-5000K
            </li>
            <li>
              <strong>L80B10 life (hrs)</strong> — &gt;50,000 — &gt;50,000 — &gt;80,000
            </li>
            <li>
              <strong>IP rating</strong> — IP20 — IP20-40 — IP65
            </li>
            <li>
              <strong>Controls</strong> — DALI-2 — DALI/DMX — 1-10V/DALI
            </li>
          </ul>
          ...
          <ol className="text-sm text-white space-y-1.5 list-decimal list-outside ml-5">
            <li>
              <strong>Define requirements:</strong> Illuminance, uniformity, glare control (UGR),
              CRI, CCT
            </li>
            <li>
              <strong>Calculate quantity:</strong> Use lighting design software (DIALux, Relux) or
              lumen method
            </li>
            <li>
          ...
          <p>
            <strong>Specification tip:</strong> Request IES/LDT photometric files from manufacturers
            for accurate lighting design calculations. Generic assumptions can lead to over or
            under-lit spaces.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Services: LENI Calculations, TM54 Assessments">
          ...
          <p>
            Where W<sub>L</sub> = Lighting energy, W<sub>P</sub> = Parasitic energy, A = Floor area
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Office (air-conditioned)</strong> — 12-15 — &lt;10 — &gt;25
            </li>
            <li>
              <strong>School</strong> — 10-12 — &lt;8 — &gt;18
            </li>
            <li>
              <strong>Retail</strong> — 25-35 — &lt;20 — &gt;50
            </li>
            <li>
              <strong>Hospital</strong> — 30-40 — &lt;25 — &gt;55
            </li>
            <li>
              <strong>Warehouse</strong> — 15-20 — &lt;12 — &gt;30
            </li>
          </ul>
          ...
          <p>
            TM54 provides a methodology to predict actual building energy consumption, addressing
            the "performance gap" between design predictions and operational reality.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Performance Gap Factors</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Extended operating hours beyond design assumptions (+20-40%)</li>
          ...
          <p>
            <strong>BREEAM credit:</strong> A TM54 assessment demonstrating predicted energy within
            10% of BREEAM benchmark contributes to Ene 01 credits. Document assumptions clearly for
            verification.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> Compare annual energy costs for an 11kW pump motor running
            6000 hours/year using IE2 (89.8%) versus IE4 (93.3%) efficiency at 12p/kWh.
          </p>
          ...
          <p className="text-white">Excellent result - well below typical 10-12 W/m2 benchmark</p>
          ...
          <p>
            ...
            lighting, operating 2500 hours/year with 0.8 occupancy factor and 0.7 daylight factor.
          </p>
          ...
          <p>
            <strong>Question:</strong> A 22kW supply fan operates at 80% speed for 6000 hours/year.
            Calculate energy saved compared to full speed with damper control.
          </p>
        ...
        <Scenario
          ...
          situation={
            <>
              A 1500 m&sup2; open-plan office is being refurbished. Existing 4&times;36 W T8
              fluorescent (~3.5 W/m&sup2;/100 lux) is being replaced with LED troffers at 1.7
              W/m&sup2;/100 lux + presence + daylight linking. Architect target 400 lux average per
              BS EN 12464-1. Operating hours 2400/year. Building Control require LENI evidence per
              Part L 2021.
            </>
          }
          whatToDo={
            <>
              Compute LENI per BS EN 15193: installed power (Pn) = 1.7 W/m&sup2; per 100 lux &times;
              4 (for 400 lux) = 6.8 W/m&sup2; (or use the manufacturer&rsquo;s photometric calc
              directly). Operating profile: presence factor F&#x2092; = 0.8 (typical office),
              daylight factor F&#x1d05; = 0.7 (perimeter zones), constant-illumination factor
              F&#x1d04; = 0.95 maintained-output. Annual lighting energy = Pn &times; hours &times;
              F&#x2092; &times; F&#x1d05; &times; F&#x1d04; / 1000 &asymp; 8.7 kWh/m&sup2;/yr LENI
              &mdash; well below Part L 2021 LENI benchmark of ~15 kWh/m&sup2;/yr for offices.
              Submit calc to Building Control with control schedule.
            </>
          }
          whyItMatters={
            <>
              LED + controls is the highest-impact electrical-services energy retrofit in commercial
              buildings &mdash; routinely 50&ndash;65 % saving over T8 fluorescent. The LENI
              methodology is the regulator-required evidence. The HNC engineer who can produce a
              defensible LENI calc with manufacturer-cited control factors carries the BREEAM and
              Part L submission.
            </>
          }
        />
