...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['R only', 'Zero', 'XL + XC', 'Maximum value'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['11th harmonic', 'Fundamental (50 Hz)', '3rd harmonic', '5th or 7th harmonic'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Zd = LC/R', 'Zd = R', 'Zd = R/(LC)', 'Zd = L/(CR)'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['2300V', '6900V', '7.67V', '230V'],
    correctAnswer: 1,
    explanation:
...
const HNCModule3Section2_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 2 · Subsection 6"
        title="Resonance in RLC Circuits and Practical Issues"
        backTo="/study-centre/apprentice/h-n-c-module3-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Understanding resonance phenomena and avoiding dangerous conditions in building electrical
          systems
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              IEEE 519 is the international reference for harmonic limits at the point of common
              coupling. The capacitor-resonance clause is exactly why building services PFC banks
              are detuned — a plain capacitor on a system with meaningful harmonic content can
              resonate with the supply impedance, push THD beyond 5 % and cook the capacitors.
            </>
          }
        ...
        <ConceptBlock title="Series Resonance - The Acceptor Circuit">
          <p>
            Series resonance occurs when a resistor, inductor, and capacitor are connected in series
            and the supply frequency matches the circuit's natural resonant frequency. At resonance,
            the inductive and capacitive reactances are equal and opposite, leaving only resistance
            to limit current.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">The Resonant Frequency Formula</p>
          <p>
            f<sub>0</sub> = 1 / (2pi x sqrt(LC)) — Where L is inductance (H) and C is capacitance
            (F)
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Below resonance:</strong> Capacitive (XC &gt; XL). Impedance higher than R.
              Current less than maximum. Current leads voltage.
            </li>
            <li>
              <strong>At resonance:</strong> Resistive (XL = XC). Impedance minimum = R. Current
              maximum = V/R. Phase angle 0 degrees (in phase).
            </li>
            <li>
              <strong>Above resonance:</strong> Inductive (XL &gt; XC). Impedance higher than R.
              Current less than maximum. Current lags voltage.
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p>
            ...
            greater than the supply voltage: <strong>VL = VC = Q x VS</strong>. With Q factors of
            20-50 common in power circuits, a 230V supply can create over 10,000V across components,
            causing insulation breakdown and catastrophic failure.
          </p>
          <p className="text-sm text-elec-yellow/70">
            <strong>Remember:</strong> Series resonance is called the "acceptor" circuit because at
            resonance it readily accepts current (minimum opposition). This makes it dangerous in
            power systems where harmonic currents can be greatly amplified.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Parallel Resonance and Quality Factor">
          ...
          <p>
            Z<sub>d</sub> = L / (CR) — Where R is the coil resistance (the capacitor is assumed
            ideal)
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p>
            The quality factor Q indicates how "sharp" or selective the resonance is. Higher Q means
            narrower bandwidth and greater magnification of voltages or currents at resonance.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>From resonance:</strong> Q = omega0 x L/R = 1/(omega0 x CR) — Angular
              frequency known
            </li>
            <li>
          ...
          <p>
            Bandwidth B = f<sub>0</sub>/Q = f<sub>2</sub> - f<sub>1</sub> — Where f1 and f2 are the
            half-power (-3dB) frequencies
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Q = 10:</strong> B = 5 Hz (at 50 Hz)
            </li>
            <li>
              <strong>Q = 25:</strong> B = 2 Hz (at 50 Hz)
            </li>
            <li>
              <strong>Q = 50:</strong> B = 1 Hz (at 50 Hz)
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Voltage and Current Magnification">
          ...
          <p>
            V<sub>L</sub> = V<sub>C</sub> = Q x V<sub>S</sub> — Voltage across L or C is Q times
            supply voltage
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p>
            I<sub>L</sub> = I<sub>C</sub> = Q x I<sub>S</sub> — Circulating current is Q times
            supply current
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">Magnification Examples</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Q = 10, supply 230V:</strong> Component voltage 2,300V — Moderate risk
            </li>
            <li>
              <strong>Q = 25, supply 230V:</strong> Component voltage 5,750V — High risk
            </li>
            <li>
              <strong>Q = 50, supply 230V:</strong> Component voltage 11,500V — Extreme risk
            </li>
            <li>
              <strong>Q = 30, supply 400V (3-ph):</strong> Component voltage 12,000V — Extreme risk
            </li>
          </ul>
          ...
          <p>
            When a system resonates at a harmonic frequency, that specific harmonic is amplified by
            the Q factor. A 5th harmonic voltage of just 5V could become 5V x 30 = 150V if Q = 30.
            This adds to the fundamental, distorting the waveform and stressing equipment.
          </p>
          <p className="text-sm text-elec-yellow/70">
            <strong>Critical point:</strong> Always check if the system resonant frequency coincides
            with any significant harmonic present in the installation. Even small harmonic sources
            can cause major problems when amplified by resonance.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Resonance Issues in Building Services">
          <p>
            ...
            where power factor correction capacitors interact with transformer and cable inductance
            in the presence of harmonic-producing loads like VSD drives and LED drivers.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
            System Resonant Frequency Calculation
          </p>
          <p>
            f<sub>r</sub> = f<sub>1</sub> x sqrt(S<sub>sc</sub> / Q<sub>c</sub>) — Where f1 = 50 Hz,
            Ssc = short-circuit power (MVA), Qc = capacitor rating (MVAr)
          </p>
          <p>
            <strong>Example:</strong> With Ssc = 25 MVA and Qc = 0.5 MVAr: fr = 50 x sqrt(25/0.5) =
            50 x sqrt(50) = 50 x 7.07 = <strong>354 Hz</strong> (near 7th harmonic!)
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Capacitor Switching Transients</p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>High frequency oscillation:</strong> kHz-range transients stress insulation
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Solutions: Detuning Reactors</p>
          <p>
            Detuning reactors prevent harmonic resonance by shifting the system resonant frequency
            below the lowest significant harmonic.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>7% reactor:</strong> Tuning frequency 189 Hz (3.78th) — Standard, below 5th
              harmonic
            </li>
            <li>
              <strong>14% reactor:</strong> Tuning frequency 134 Hz (2.68th) — Heavy harmonics,
              below 3rd
            </li>
            <li>
              <strong>5.67% reactor:</strong> Tuning frequency 210 Hz (4.2th) — Low harmonics, just
              below 5th
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">When to Use Detuned Capacitors</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            A commercial building installed 150 kVAr of standard (non-detuned) PFC capacitors. With
            VSD drives on the HVAC system, the 5th harmonic current was amplified by resonance.
            Within 6 months, all capacitors failed due to overheating. The solution required detuned
            capacitors with 7% reactors, at 40% higher cost but with reliable operation thereafter.
          </p>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> Calculate the resonant frequency of a series circuit with L =
            50mH and C = 20uF. Also determine the Q factor if R = 5 ohms.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Question:</strong> A series RLC circuit has Q = 25 and is connected to a 230V
            supply at resonance. Calculate the voltage across the capacitor and assess the risk.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Question:</strong> A 1000 kVA transformer has Uk = 6% and supplies 200 kVAr of
            PFC capacitors. Calculate the system resonant frequency and assess the risk.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Always conduct a harmonic study before specifying PFC. Use 7% or 14% detuned reactors
              when VSDs or significant non-linear loads are present. Size detuning reactors for full
              harmonic current spectrum. Convert all units to base SI for resonance calculations.
              Specify capacitors with uplifted voltage rating to suit the detuning factor.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A workshop with eight 22 kW VFD-driven extract fans has a 200 kVAr plain capacitor
              bank that has failed twice in 18 months — swollen cans, blown in-line fuses, evidence
              of sustained over-current on the bank ammeter. The supply impedance and the bank
              capacitance happen to resonate near the 5th harmonic (250 Hz) of the 50 Hz supply.
            </>
          }
          whatToDo={
            <>
              Compute the system resonant frequency: f₀ = 1 / (2π√(L_supply × C_bank)). If f₀ sits
              at or near 250 Hz (5th) or 350 Hz (7th), the supply impedance and the bank are forming
              a parallel resonant circuit that amplifies the harmonic current pulled from the VFDs
              into the capacitors. Replace the bank with a detuned bank to BS EN 61921 — typically 7
              % series reactor (tunes around 134 Hz, well below 250 Hz) so the bank looks inductive
              at the harmonic frequencies and presents low impedance only at the fundamental 50 Hz.
              Re-measure THD and capacitor current after commissioning; expect both to drop sharply.
            </>
          }
          whyItMatters={
            <>
              Unintentional resonance is the classic mistake when adding bulk PFC to a modern
              non-linear load. Knowing the resonance theory (X_L = X_C at f₀) turns a mysterious
              recurring fault into an obvious design defect with a standard fix.
            </>
          }
        />
