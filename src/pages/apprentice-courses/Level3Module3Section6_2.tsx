...
const DESCRIPTION =
  "Understand the relationship between conductor resistance and voltage drop in electrical circuits. Learn how Ohm's law applies to cable voltage drop and why it matters.";
...
const quickCheckQuestions = [
  {
    id: 'check-1',
    question:
      'A 10A current flows through a cable with 0.5 ohms resistance. What is the voltage drop?',
    options: ['0.5V', '5V', '20V', '50V'],
    correctIndex: 1,
    explanation:
      "Using Ohm's law: Voltage Drop = I x R = 10 x 0.5 = 5V. The voltage at the load will be 5V less than at the supply.",
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'Excessive voltage drop means equipment receives less than rated voltage, potentially causing motors to overheat, lights to dim, or electronic equipment to malfunction. BS 7671 sets maximum voltage drop limits to ensure adequate voltage at the load.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 0,
    explanation:
      'BS 7671 Appendix 4 states voltage drop should not exceed 3% for lighting circuits and 5% for other uses. For a 230V supply: lighting max = 6.9V, power max = 11.5V.',
  },
  {
    id: 'check-4',
    question:
      'A circuit has 0.2 ohms total cable resistance (line + neutral). With 15A load, what voltage reaches the equipment if supply is 230V?',
    options: ['227V', '230V', '233V', '215V'],
    correctIndex: 0,
    explanation:
      'Voltage drop = I x R = 15 x 0.2 = 3V. Voltage at equipment = 230 - 3 = 227V. This is within the 5% limit (11.5V) for power circuits.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: ["V = I x R (Ohm's law)", 'V = I / R', 'V = R / I', 'V = I + R'],
    correctAnswer: 0,
    explanation:
      "Voltage drop follows Ohm's law: V = I x R. The current flowing through the cable's resistance causes a voltage drop proportional to both the current and resistance.",
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'In a single-phase circuit, current flows out through the line conductor and returns through the neutral. Both conductors have resistance, so voltage drop occurs in both. Total voltage drop = current x (R line + R neutral).',
  },
  {
    id: 3,
    ...
    correctAnswer: 0,
    explanation:
      'mV/A/m is the voltage drop in millivolts for each ampere of current per metre of cable length. This allows quick calculation: Vd = (mV/A/m x I x L) / 1000 volts.',
  },
  {
    id: 4,
    question: 'BS 7671 maximum voltage drop of 3% for a 230V lighting circuit equals:',
    options: ['3V', '6.9V', '11.5V', '23V'],
    correctAnswer: 1,
    explanation:
      '3% of 230V = 0.03 x 230 = 6.9V maximum voltage drop for lighting circuits. The lamps must receive at least 223.1V.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Longer cables have more resistance (R = rho x L/A), causing more voltage drop. To keep drop within limits while supplying the required current, conductor cross-sectional area must increase to reduce resistance.',
  },
  {
    id: 6,
    question:
      'A 2.5mm squared cable has mV/A/m of 18. A 30m circuit carrying 20A has voltage drop of:',
    options: ['10.8V', '1.08V', '108V', '0.108V'],
    correctAnswer: 0,
    explanation:
      'Voltage drop = (mV/A/m x I x L) / 1000 = (18 x 20 x 30) / 1000 = 10800 / 1000 = 10.8V. This exceeds the 6.9V limit for lighting but is within 11.5V for power circuits.',
  },
  {
    id: 7,
    question: 'Power loss in a cable due to resistance is calculated as:',
    options: ['P = I x R', 'P = I squared x R', 'P = V x R', 'P = V squared / I'],
    correctAnswer: 1,
    explanation:
      'Power loss = I squared x R. This is why current is so critical - doubling current increases losses four times. This power is dissipated as heat in the cable.',
  },
  {
    id: 8,
    ...
    correctAnswer: 0,
    explanation:
      'For balanced three-phase circuits, neutral current is zero, so only line conductor resistance matters. Voltage drop = root 3 x I x R x cos phi for three-phase circuits.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Increasing conductor size reduces resistance, reducing voltage drop. This is the most practical solution in most cases. Reducing circuit length or splitting into multiple circuits are alternatives where feasible.',
  },
  {
    id: 10,
    ...
    correctAnswer: 2,
    explanation:
      'Under-voltage causes motors to draw more current, overheat, and fail prematurely. Lighting output reduces. Electronic equipment may malfunction or reset. This is why voltage drop limits are specified.',
  },
  {
    id: 11,
    ...
    correctAnswer: 1,
    explanation:
      'The total voltage drop from source to load includes both distribution and final circuits. If a distribution circuit uses 3% and a final circuit uses 3%, total is 6% - exceeding limits. Distribution circuit drop should be minimised.',
  },
  {
    id: 12,
    question: 'At higher temperatures, voltage drop in cables:',
    options: ['Decreases', 'Increases', 'Stays the same', 'Becomes negligible'],
    correctAnswer: 1,
    explanation:
      'Higher temperature increases conductor resistance, which increases voltage drop for the same current. This is another reason why cable operating temperature matters and why voltage drop calculations should consider operating conditions.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'They refer to the same thing - the reduction in voltage between the supply and the load due to cable resistance. Voltage drop is the preferred technical term. The dropped voltage is converted to heat in the cable (power loss = I squared x R).',
  },
  {
    question: 'Why are there different voltage drop limits for lighting and power?',
    answer:
      'Lighting is more sensitive to voltage changes - a 10% reduction in voltage can reduce light output by 30%. Motors and other power equipment can tolerate slightly lower voltages. The 3% lighting / 5% power limits ensure acceptable performance.',
  },
  {
    question: 'How do I calculate voltage drop for a ring final circuit?',
    answer:
      'For a ring circuit with load connected at the mid-point (worst case), the effective cable length is quarter of the ring length and conductors work in parallel. For socket outlets positioned elsewhere, specific calculations are needed. The IET On-Site Guide provides guidance.',
  },
  {
    question: 'Does voltage drop affect the neutral conductor differently?',
    answer:
      'In single-phase circuits, the neutral carries the same current as the line, so has equal voltage drop. In three-phase balanced systems, neutral current is zero, so neutral voltage drop is zero. Unbalanced three-phase loads will have neutral current and associated voltage drop.',
  },
  {
    question: 'Can voltage drop ever be beneficial?',
    answer:
      'While excessive voltage drop is problematic, some applications deliberately use cable resistance for current limiting (e.g., battery charging circuits). However, in normal installations, voltage drop represents wasted energy and should be minimised within practical limits.',
  },
  {
    question: 'What if my calculated voltage drop exceeds the limit?',
    answer:
      'Options include: increasing conductor size (most common), reducing circuit length (if possible), using multiple circuits to share the load, or accepting higher voltage drop with customer agreement (documented in design). For motor circuits, consider starting current impact.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Cause:</strong> Current flowing through cable resistance
              </li>
              <li>
                <strong>Formula:</strong> Vd = I x R (Ohm's law)
              </li>
              <li>
                <strong>Limits:</strong> 3% lighting, 5% power (BS 7671)
              </li>
              <li>
                <strong>Solution:</strong> Increase conductor size or reduce length
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Dimming lights at end of long circuits
              </li>
              <li>
                <strong>Use:</strong> mV/A/m values from BS 7671 tables
              </li>
              <li>
                <strong>Apply:</strong> Vd = (mV/A/m x I x L) / 1000
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Every conductor has resistance, no matter how good the material. When current flows
              through this resistance, some voltage is dropped across the cable, leaving less
              voltage available for the connected equipment. This is a direct application of Ohm's
              law.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key Point:</strong> The dropped voltage is not lost - it is converted to heat
              in the cable. This represents wasted energy and contributes to cable heating.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 7671 specifies maximum permissible voltage drop to ensure equipment receives
              adequate voltage for proper operation. The limits are expressed as percentages of the
              nominal supply voltage and differ for lighting and other circuits.
            </p>
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20 my-6">
              ...
              <p className="text-xs text-white/90">
                ...
                distribution circuit has 2% drop and a final circuit has 2% drop, total is 4% -
                within the 5% power limit but exceeding the 3% lighting limit.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Cable tables in BS 7671 provide mV/A/m values - the voltage drop in millivolts per
              ampere of current per metre of cable. This simplifies calculations by combining the
              cable's resistance characteristics into a single value.
            </p>

            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              <p className="text-sm font-medium text-white mb-3">
                Voltage Drop Formula Using mV/A/m:
              </p>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-white/10 my-6">
              <p className="text-sm font-medium text-white mb-2">
                Sample mV/A/m Values (2-core flat cable, copper):
              </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white/80 space-y-2 font-mono">
                ...
                <p className="text-green-400 mt-2">
                  4.64V is within the 6.9V (3%) limit for lighting - ACCEPTABLE
                </p>
              </div>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Note:</strong> The mV/A/m values account for both line and neutral resistance
              - no need to double them for single-phase circuits.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              When voltage drop exceeds acceptable limits, equipment performance suffers. Different
              types of equipment respond differently to under-voltage conditions, but all are
              negatively affected.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Increase conductor size</strong> - most common solution
                </li>
                <li>
                  <strong>Reduce circuit length</strong> - relocate distribution board closer
                </li>
                <li>
                  <strong>Split the load</strong> - use multiple circuits
                </li>
                <li>
                  <strong>Use higher voltage</strong> - three-phase instead of single-phase
                </li>
                <li>
                  <strong>Review design current</strong> - is diversity correctly applied?
                </li>
              </ul>
            </div>
