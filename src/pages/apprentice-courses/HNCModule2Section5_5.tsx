...
const quickCheckQuestions = [
  {
    ...
    options: ['-0.5 to +0.5', '-1 to +1', '-3 to +3', '0 only'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['18-20°C', '23-25°C', '21-23°C', '25-28°C'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Hot', 'Thermally neutral', 'Warm', 'Slightly warm'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1.2 Met', '1.0 Met', '0.8 Met', '1.5 Met'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS EN ISO 7730 + CIBSE TM52/TM59 are the reference standards for sizing conditioning
              and assessing overheating risk. As HNC engineer you cite them in the design risk
              register, in the TM52 study report, and in any planning Net-Zero submission where
              overheating is in scope.
            </>
          }
        ...
        >
          <p>
            Professor Ole Fanger developed the most widely used thermal comfort model, based on heat
            balance between the human body and its environment. The model predicts average thermal
            sensation and percentage of dissatisfied occupants.
          </p>
          <p>
          ...
          <p>
            <strong>Note:</strong> Even at PMV = 0 (neutral), 5% of people will be dissatisfied due
            to individual variation. Perfect comfort for everyone is impossible; design aims for
            acceptable levels.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>Design note:</strong> Summer temperatures can be 2°C higher than winter because
            occupants wear lighter clothing (lower clo value), maintaining thermal balance at higher
            air temperature.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Building type:</strong> PMV - mechanically conditioned; adaptive - naturally
              ventilated
            </li>
            <li>
              <strong>Temperature range:</strong> PMV - fixed narrow band; adaptive - varies with
              outdoor temp
            </li>
            <li>
            ...
            <li>
              <strong>Energy implication:</strong> PMV - higher energy use; adaptive - lower energy
              use
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Hours of exceedance:</strong> Max 3% occupied hours where ΔT &gt; 1K above
              limit
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Simplified method:</strong> Glazing area limits by orientation, max g-value,
              min free area for ventilation, cross-vent required
            </li>
            <li>
              <strong>Dynamic simulation:</strong> Full TM59 assessment, DSY weather file required,
              all three criteria assessed, more design flexibility
            </li>
          </ul>
          <p>
        ...
        >
          <p>
            <strong>Example 1 - Operative temperature:</strong> An office has air temperature 22°C
            and mean radiant temperature 24°C (due to warm ceiling). Calculate operative
            temperature.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 - Velocity offset:</strong> If air velocity increases from 0.1 to 0.4
            m/s, approximately how much higher temperature can be tolerated while maintaining
            comfort?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 4 - TM52 Criterion 1 check:</strong> A building is occupied 3000 hours
            per year. Dynamic simulation shows 120 hours above the adaptive comfort limit. Does it
            pass Criterion 1?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>FAIL:</strong> 120 &gt; 90 hours (4% exceedance)
            </li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 96-unit BtR residential block in central London is going through planning. The local
              plan requires a CIBSE TM59 overheating assessment for all naturally-ventilated
              bedrooms. Initial dynamic simulation shows three south-west aspect bedrooms failing
              TM59 Criterion A (operative temperature threshold).
            </>
          }
          whatToDo={
            <>
              Verify the TM59 weather file (DSY1 London for 2020s) and the bedroom occupancy profile
              (8 hours single occupancy 23:00–07:00). Identify the fail driver: solar gain through
              glazing or insufficient night ventilation. Apply mitigation in priority order:
              external shading (brise-soleil or shutters), reduced g-value glazing, increased
              openable area, then mechanical cooling as a last resort. Re-run the simulation.
              Document the design decisions in the TM59 report submitted with the planning
              application.
            </>
          }
          whyItMatters={
            <>
              A TM59 fail blocks planning consent. Once the building is occupied and overheating is
              confirmed, the developer is exposed to litigation under the Homes (Fitness for Human
              Habitation) Act 2018. Getting TM59 right at design stage is a multi-million-pound
