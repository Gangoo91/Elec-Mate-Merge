...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['5-10%', '10-20%', '50-100%', '20-40%'],
    correctAnswer: 3,
    explanation:
...
const HNCModule6Section6_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 6 · Subsection 6"
        title="Post-Occupancy Evaluation"
        backTo="/study-centre/apprentice/h-n-c-module6-section6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Performance monitoring, user satisfaction, lessons learned, and continuous improvement for
          building services
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE TM61–63 is the UK technical reference for POE. Government Soft Landings (GSL)
              makes POE mandatory on central government projects. BUS Methodology survey is the most
              widely-used occupant satisfaction tool in the UK. POE outputs feed lessons learned
              into future projects and inform corrective action (re-commissioning, controls
              adjustment, training) on the current building.
            </>
          }
        ...
        <ConceptBlock title="POE Fundamentals and Soft Landings">
          ...
          <p>
            <strong>Key POE objectives:</strong>
          </p>
          ...
          <p>
            <strong>Soft Landings Framework Stages</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stage 1:</strong> Inception and Briefing — Define performance targets, agree
              POE scope
            </li>
            <li>
              <strong>Stage 2:</strong> Design Development — Reality checking, metering strategy,
              user input
            </li>
            <li>
              <strong>Stage 3:</strong> Pre-Handover — Commissioning reviews, O&M preparation
            </li>
            <li>
              <strong>Stage 4:</strong> Initial Aftercare (0-12 months) — Resident on-site support,
              fine-tuning
            </li>
            <li>
              <strong>Stage 5:</strong> Extended Aftercare (1-3 years) — Formal POE, seasonal
              reviews, user surveys
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Performance Monitoring and Sub-Metering">
          <p>
            ...
            disaggregation of energy use by system, zone, and end use. Without sub-metering,
            identifying performance issues and optimisation opportunities becomes impossible.
          </p>
          <p>
            <strong>Energy Metering</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Recommended Sub-Metering Strategy</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HVAC:</strong> Chillers, boilers, AHUs, pumps, fans — Plant efficiency
              analysis
            </li>
            <li>
              <strong>Lighting:</strong> General, emergency, external — Lighting energy density
              (W/m²)
            </li>
            <li>
              <strong>Small Power:</strong> Floor/zone distribution boards — Unregulated load
              assessment
            </li>
            <li>
              <strong>Lifts and Escalators:</strong> Per lift/bank — Transportation energy
            </li>
            <li>
              <strong>Server Rooms:</strong> IT load and cooling — PUE calculation
            </li>
          </ul>
          <p>
            <strong>Monitoring tip:</strong> Data without analysis is useless - implement automated
            fault detection and diagnostics (FDD) to convert data into actionable insights.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="User Satisfaction and BUS Methodology">
          <p>
            User satisfaction assessment provides essential feedback on how occupants experience the
            building environment. The Building Use Studies (BUS) methodology offers a standardised,
            benchmarked approach enabling comparison against hundreds of similar buildings.
          </p>
          <p>
            <strong>BUS Survey Categories</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Building Factors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Survey Implementation Best Practice</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Timing:</strong> Conduct surveys at consistent times (avoid holiday periods,
              extreme weather)
            </li>
            <li>
          ...
          <p>
            <strong>Interpreting BUS Results</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>&gt;75th percentile:</strong> Excellent - top quartile performance — Maintain,
              share best practice
            </li>
            <li>
              <strong>50th-75th percentile:</strong> Good - above average — Minor improvements
              possible
            </li>
            <li>
              <strong>25th-50th percentile:</strong> Fair - below average — Investigate and address
              issues
            </li>
            <li>
              <strong>&lt;25th percentile:</strong> Poor - bottom quartile — Priority intervention
              required
            </li>
          </ul>
          <p>
            <strong>User engagement:</strong> Involve occupants in POE from the start - they provide
            invaluable operational insight and their buy-in improves survey response rates.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Lessons Learned and Continuous Improvement">
          ...
          <p>
            <strong>Performance Gap Causes and Solutions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Unregulated loads excluded:</strong> +30-50% energy use — TM54 operational
              energy modelling
            </li>
            <li>
              <strong>Extended operating hours:</strong> +20-40% energy use — Realistic occupancy
              assumptions
            </li>
            <li>
              <strong>Poor controls commissioning:</strong> +15-30% energy use — Extended
              commissioning, seasonal proving
            </li>
            <li>
              <strong>Specification changes:</strong> Variable — Change impact assessment on energy
            </li>
            <li>
              <strong>User behaviour differences:</strong> +10-20% energy use — User guides,
              displays, engagement
            </li>
          </ul>
          <p>
            <strong>Continuous Commissioning</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Lessons Learned Categories</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Feedback Loop Implementation</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Step 5 - Implement:</strong> Update specifications, checklists, and procedures
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> An office building was designed to achieve 85 kWh/m²/year but
            is consuming 195 kWh/m²/year after 12 months. Analyse the gap.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> A newly occupied building scores 4.2/7 for summer temperature
            comfort (benchmark mean 4.8). Interpret and recommend actions.
          </p>
        ...
        <Scenario
          ...
          situation={
            <>
              A 12-month POE on a new office building shows the lighting controls (DALI scenes with
              daylight harvesting and presence detection) are the largest single source of occupant
              complaint — 68% rate dissatisfied. The energy data (TM63) shows lighting consumption
              35% below benchmark — the design works technically, but occupants find the dimming
              response erratic and find ceiling sensors triggering unwanted scene changes during
              meetings.
            </>
          }
          whatToDo={
            <>
              Investigate cause: typically (1) commissioning set scene transitions too rapid for
              human comfort (target 30–60 second fade); (2) presence sensors not zoned tightly
              enough — meeting rooms picked up by adjacent corridor sensors; (3) daylight harvesting
              target lux too aggressive (350 lux design vs occupant preference closer to 500).
              Re-commission with longer fades, tighter zoning, increased target lux. Re-survey at 6
              months. Update the design standard for future projects: DALI commissioning is a
              comfort design decision, not just a technical setting.
            </>
          }
          whyItMatters={
            <>
              POE catches the gap between technical performance and occupant experience. Many
              "energy-saving" features fail in practice because the user experience is not designed
              alongside the energy intent. Lighting controls is the most common offender. Without
              POE, this learning never feeds back into design — and the same mistakes are repeated
              on the next project.
            </>
          }
        />
