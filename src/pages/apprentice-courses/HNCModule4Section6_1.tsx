    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              NBS clauses describe products and performance, but Reg 510.3 is the BS 7671 guarantee
              that each item is also selected and erected to comply with the Wiring Regulations and
              the manufacturer’s instructions. A specification that says "Switchgear shall comply
              with BS EN 61439-2" is fine; one that omits the BS 7671 selection chain (Chapter 41
              disconnection times, Chapter 43 fault levels, Chapter 52 environmental ratings) leaves
              a gap the contractor will fall into.
            </>
          }
        ...
        <ConceptBlock title="Introduction to NBS Specifications">
          <p>
            ...
            construction specifications in the UK. For building services engineers, NBS ensures that
            design requirements are communicated clearly and consistently to contractors.
          </p>
          <p>
          ...
          <p>
            <strong>Key point:</strong> NBS specifications complement drawings — they define quality
            and performance while drawings show location and quantity.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="NBS Create and Managing Amendments">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Cross-reference:</strong> Ensure amendments don't conflict with other clauses
            </li>
            <li>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Use definitive language: 'shall' for requirements, 'should' for recommendations</li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Over-specification</strong> — unnecessary detail that restricts options and
                increases cost
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              tender. Project carries Education Funding Agency standards on lighting, small power
              and emergency lighting. Six weeks to occupation after construction handover.
            </>
          }
          whatToDo={
            <>
              Open NBS Chorus, set the project profile, pull in Y70 (general HV/LV), Y71 (LV
              switchgear and controlgear assemblies), Y73 (luminaires and lamps), Y74 (emergency
              lighting). For each work section: 100s — general scope, applicable standards (BS
              7671:2018+A4:2026, EFA standards, BS 5266); 200s — products (performance: classroom Em
              300 lx maintained, UGR ≤ 19, Ra ≥ 80; or prescriptive: named LED panel) ; 300s —
              execution (cable routing, segregation, terminations to Reg 559.5.1); 400s — system
              performance (LENI, lighting controls narrative, emergency lighting test regime per BS
              5266-1); 500s — completion (commissioning, EIC, O&amp;M structure). Cross-reference
              Reg 510.3 in the preliminaries so the contractor can’t gold-plate or value-engineer
              outside the BS 7671 envelope. Add an amendment register with date, author, and reason
              for every deviation from standard NBS clauses.
            </>
          }
          whyItMatters={
            <>
              A loose spec gets exploited at tender (cheapest LED that just hits 300 lx average, no
              controls strategy, no commissioning record). A precise spec drives a fair comparable
              tender and a maintainable building. Specification is engineering, not paperwork.
            </>
          }
        />
