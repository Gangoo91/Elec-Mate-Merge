      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              ...
              <li className="pl-1">
                <strong>Purpose:</strong> Account for non-simultaneous operation
              </li>
              <li className="pl-1">
                <strong>BS 7671:</strong> Table 1A for domestic guidance
              </li>
              <li className="pl-1">
                <strong>ADMD:</strong> After Diversity Maximum Demand
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Lighting:</strong> 90% typical (high coincidence)
              </li>
              <li className="pl-1">
                <strong>Small power:</strong> 30-50% typical
              </li>
              <li className="pl-1">
                <strong>HVAC:</strong> 70-100% depending on system
              </li>
              <li className="pl-1">
                <strong>Emergency:</strong> 100% (no diversity)
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical Diversity Factors by Load Type
              </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Most lights on during occupied hours
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Desks not all occupied, PCs vary
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Runs continuously at design load
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Variable air volume reduces average
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Not all cars run simultaneously
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">1.0</td>
                      <td className="border border-white/10 px-3 py-2">
                        All on during emergency (no diversity)
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                BS 7671 Table 1A - Domestic Diversity
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        100% of largest + 100% of 2nd largest + 25% remainder
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Thermal storage heaters</td>
                      <td className="border border-white/10 px-3 py-2">
                        100% (all charge together overnight)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        100% of largest circuit + 40% of others
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Daytime operation, variable occupancy
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">0.7-0.8</td>
                      <td className="border border-white/10 px-3 py-2">
                        High lighting, lower small power
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Constant IT load, minimal diversity
                      </td>
                    </tr>
                    <tr>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Additional allowance (with diversity)
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Development ADMD Calculation Steps
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  Step 2: Apply inter-dwelling diversity factor based on number of dwellings
                </li>
                <li className="pl-1">
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Domestic Consumer Unit
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Residential Development ADMD
              </h3>
              <p className="text-sm text-white mb-2">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Select diversity factors from CIBSE or engineering judgement
                </li>
