      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              manufacturer data. As the designer, you are accountable for the diversity factors you
              apply: document them, justify them against CIBSE / measured data, and never compound
              diversity across multiple distribution layers without spelling out where it has been
              applied. Get caught using domestic Table A2 factors on a commercial job and your
              design submission will not survive scrutiny.
            </>
          }
        ...
        <ConceptBlock title="Understanding Diversity">
          <p>
            ...
            simultaneously at full rated capacity. Understanding and correctly applying diversity is
            essential for economical yet safe electrical system design.
          </p>
          <p>
        ...
        <ConceptBlock title="Commercial Building Services Diversity">
          ...
          <p>
            <strong>Remember:</strong> Commercial diversity factors require justification. Document
            your assumptions and the basis for diversity applied.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="ADMD Calculations">
          <p>
            ...
            developments where multiple dwellings share infrastructure. DNOs publish ADMD tables for
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Step 1: Determine individual dwelling ADMD (from DNO tables or engineering assessment)
            </li>
            <li>Step 2: Apply inter-dwelling diversity factor based on number of dwellings</li>
            <li>Step 3: Add landlord services (lifts, lighting, pumps) at appropriate diversity</li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Example 3 — residential development ADMD:</strong> Calculate maximum demand for
            30 × 2-bed flats (gas heating) with communal lighting 5kW and lift 15kW.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A mixed-use scheme: 24 × 2-bed flats over 2 retail units (one a small supermarket with
              continuous refrigeration, one a coffee shop). Communal services include a lift,
          ...
          whatToDo={
            <>
              ...
              diversities — emergency lighting at 1.0 (no diversity), lift at 0.6, heat pump at 1.0
              during peak winter. Sum to a single supply figure. Document every factor against CIBSE
              Guide F and keep the breakdown for the Part L submission and the metering schedule.
            </>
          }
          whyItMatters={
            <>
              Reg 311.1 makes the diversity decision the designer&rsquo;s. Mis-apply inter-dwelling
              diversity to a continuously-loaded supermarket and you under-size the supply. Apply
              diversity to the emergency lighting and you have a life-safety breach. Tenure-split
              documentation is also what the metering contractor needs to position CTs and meters
              correctly.
            </>
          }
        />
