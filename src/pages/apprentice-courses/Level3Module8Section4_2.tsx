...
const DESCRIPTION =
  'Learn to analyse your mock exam results effectively. Identify patterns in your performance, understand common weak areas, and develop targeted revision strategies.';
...
const quickCheckQuestions = [
  {
    id: 'check-1',
    question:
      'You scored 45% on inspection and testing questions across three mock exams. What does this indicate?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Consistent low scores in a specific topic area indicate a genuine knowledge gap. This requires targeted revision on inspection and testing rather than general study.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'Understanding the underlying concept you misunderstood is crucial. This prevents similar errors and builds deeper understanding rather than just memorising correct answers.',
  },
  {
    id: 'check-3',
    question:
      'Your time analysis shows you spent 3 minutes on calculation questions but only 30 seconds on theory questions. What action should you take?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'While calculations do take longer, 3 minutes per question may indicate inefficiency. Practice calculation techniques to improve speed without sacrificing accuracy.',
  },
  {
    id: 'check-4',
    question:
      'You consistently score well on BS 7671 regulation references but poorly on practical application questions. What does this suggest?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'This pattern suggests you can recall regulations but struggle to apply them to practical scenarios. Focus revision on worked examples and case studies that apply regulations in context.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 2,
    explanation:
      'While overall scores are useful, the main purpose of analysis is to identify specific weak areas so you can target your revision effectively.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Looking for patterns across multiple mock exams reveals genuine strengths and weaknesses rather than one-off variations.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Analysing time spent per question type reveals where you need to improve efficiency. Targeted practice on slow areas improves speed while maintaining accuracy.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Tracking performance by topic across multiple attempts shows whether your targeted revision is working and where further focus is needed.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Misreading questions is a common error that can be reduced with practice. Develop a habit of re-reading questions before answering, especially under time pressure.',
  },
  {
    id: 6,
    question:
      'You scored 70% overall but only 40% on cable sizing calculations. Your revision priority should be:',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'A significant gap in one topic area should be addressed specifically. Cable sizing is also likely to appear in the real exam, making it a high priority.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Comparing confidence with actual results reveals where you might be overconfident (high confidence but wrong) or underconfident (low confidence but correct).',
  },
  {
    id: 8,
    question:
      'When analysing patterns in wrong answers, discovering that you consistently chose option B suggests:',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Consistent patterns in answer choice positions may indicate unconscious bias. Being aware of this helps you evaluate each option more objectively.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      "Confidently wrong answers reveal misconceptions or misunderstandings that you're not aware of. These need careful analysis to correct your understanding.",
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'An effective revision log includes weak topics, the specific concepts misunderstood, and concrete revision activities planned to address each gap.',
  },
  {
    id: 11,
    question:
      'If your performance varies significantly between mock exams on the same topics, this might indicate:',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Variable performance on the same topics suggests your knowledge is not yet solid. Further study and practice is needed to consolidate your understanding.',
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      'Results analysis is only valuable if followed by targeted action. Create a specific revision plan that addresses the weaknesses and misconceptions you identified.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Ideally, analyse at least 3-4 mock exams to identify reliable patterns. Single exam results may reflect random variation or one-off errors rather than genuine knowledge gaps.',
  },
  {
    question: 'Should I analyse every wrong answer in detail?',
    answer:
      'Focus detailed analysis on questions you were confident about but got wrong, and questions in recurring weak topic areas. Quick guesses on unfamiliar topics simply need more study on that topic.',
  },
  {
    question: 'How do I track time spent per question in mock exams?',
    answer:
      'Use timestamps at regular intervals (every 10-15 questions) or time individual question types separately. Some online mock exams track this automatically.',
  },
  {
    question: 'What if I score well on mocks but poorly in real exams?',
    answer:
      'This often indicates exam anxiety or unfamiliarity with exam conditions. Practice under realistic conditions - timed, no notes, quiet environment - to reduce the gap between mock and real performance.',
  },
  {
    question: 'How often should I re-analyse my results?',
    answer:
      'Review your overall progress weekly, but conduct deep analysis after completing 2-3 new mock exams. This gives enough data to spot new patterns while maintaining focus on improvement.',
  },
  {
    question: 'Should I analyse mocks from different providers differently?',
    answer:
      "Yes, different providers may emphasise different topics. Track which provider's mocks you're using and note any patterns - but focus on your own performance patterns across all sources.",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Categorise:</strong> Group results by topic area
              </li>
              <li>
                <strong>Pattern:</strong> Look for consistent strengths/weaknesses
              </li>
              <li>
                <strong>Understand:</strong> Analyse WHY answers were wrong
              </li>
              <li>
                <strong>Action:</strong> Create targeted revision plan
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Recurring weak topics across multiple exams
              </li>
              <li>
                <strong>Use:</strong> Topic-by-topic percentage tracking
              </li>
              <li>
                <strong>Apply:</strong> Focus revision on identified gaps
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Effective results analysis begins with categorising your answers by topic area. This
              reveals where your strengths and weaknesses truly lie, rather than relying on overall
              percentage scores alone.
            </p>

            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              <p className="text-sm font-medium text-white mb-3">
                Key Topic Categories for Level 3:
              </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key Insight:</strong> This analysis reveals that despite an overall score
              around 60%, cable calculations need urgent attention while BS 7671 references are a
              strength.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Understanding WHY you got questions wrong is more valuable than simply noting the
              correct answer. Different types of errors require different remediation strategies.
            </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white space-y-2">
                ...
                <p>
                  <strong>Your answer:</strong> 1.44 ohms
                </p>
                <p>
                  <strong>Correct answer:</strong> 1.15 ohms
                </p>
                <p>
                  <strong>Error type:</strong> Misconception
                </p>
                <p>
                  <strong>Analysis:</strong> Confused Zs values for Type B and Type C MCBs. Type B
                  operates at 3-5 times In, Type C at 5-10 times In.
                </p>
                <p>
                  <strong>Action:</strong> Create comparison table of Zs values for different MCB
                  types and protective device ratings.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Analysing how you spend your time during mock exams reveals efficiency issues that may
              be costing you marks. Combine time analysis with performance analysis for complete
              insight.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              ...
              <ul className="text-sm text-white space-y-2">
                ...
                <li>
                  <strong>Calculation questions:</strong> These typically take longer - aim for no
                  more than 3 minutes each
                </li>
                <li>
                  <strong>Theory questions:</strong> Should be quicker if you know the answer -
                  under 1 minute
                </li>
                <li>
                  <strong>Review time:</strong> Aim to finish with 10-15 minutes to review flagged
                  questions
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Target:</strong> Aim to complete all questions with 10-15 minutes remaining
              for review. If you consistently run out of time, this is a priority issue to address.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Analysis is only valuable if it leads to action. Convert your findings into a
              structured revision plan that addresses specific identified weaknesses.
            </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white space-y-2 font-mono">
                ...
                <p>
                  <strong>Root Cause:</strong> Uncertain on formula application, mixing up mV/A/m
                  values
                </p>
                <p>
                ...
                <p>
                  <strong>Deadline:</strong> Complete within 3 days
                </p>
                <p>
                  <strong>Verification:</strong> Re-attempt related questions from mock exams
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="p-5 rounded-lg bg-transparent border border-elec-yellow/20">
            <h3 className="text-sm font-medium text-white mb-4">
              Quick Reference - Results Analysis
            </h3>
