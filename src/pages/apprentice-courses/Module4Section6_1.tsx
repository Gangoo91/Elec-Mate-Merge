...
const DESCRIPTION =
  'Master systematic visual inspection techniques for electrical installations. Learn to identify defects, ensure compliance with BS 7671, and maintain safety standards before testing begins.';
  ...
  const faqs = [
    {
      ...
      answer:
        'No — it is a complementary step that must be performed before testing but does not verify electrical performance. Both visual inspection and electrical testing are required for full compliance.',
    },
    {
      question: 'What if I find a dangerous fault during inspection?',
      answer:
        'Stop work immediately, report to the supervisor, and make the area safe before proceeding. Do not continue with any further work until the dangerous condition is resolved.',
    },
    {
      question: 'Do I need specialist tools for visual inspection?',
      answer:
        'Mostly basic hand tools, but a good light source and an inspection mirror are essential for hard-to-see areas. A camera for documentation is also highly recommended.',
    },
    {
      question: 'How detailed should the visual inspection documentation be?',
      answer:
        'Documentation should be comprehensive, including location of defects, categorisation of severity, and photographic evidence where possible. This supports quality assurance and regulatory compliance.',
    },
    {
      question: 'What happens if multiple defects are found?',
      answer:
        'All defects must be recorded and categorised by severity. Dangerous defects require immediate action, while minor issues can be scheduled for correction before final testing.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-white leading-relaxed">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  <li>
                    Visual inspection is the mandatory first step before electrical testing begins
                  </li>
                  <li>
                    It identifies visible defects and ensures compliance with BS 7671 requirements
                  </li>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  <li>
                    <strong>Spot:</strong> Damaged components, incorrect installations, missing
                    safety features
                  </li>
                  <li>
                    <strong>Use:</strong> Systematic approach, proper documentation, categorisation
                    methods
                  </li>
                  <li>
                    <strong>Check:</strong> Compliance with regulations, safety standards, quality
                    requirements
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-5 space-y-2 text-white leading-relaxed">
              ...
              <li>
                Identify common defects and safety hazards that can be detected through visual
                examination
              </li>
              <li>
                Follow a structured, systematic approach to carry out compliant visual inspections
              </li>
              <li>
                Record findings accurately using appropriate documentation and categorisation
                methods
              </li>
              <li>
                Understand when to halt further work due to visual inspection failures and safety
                concerns
              </li>
            </ul>
          </section>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm mb-2">
                  <strong>BS 7671 compliance verification:</strong> Ensuring installations meet
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  ...
                  <li>
                    Verification of compliance with Chapters 13-15 of BS 7671 covering design and
                    installation requirements
                  </li>
                  <li>
                    Confirmation that installation methods align with manufacturer instructions and
                    guidance notes
                  </li>
                  <li>
                    Assessment of workmanship standards against industry best practice and
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  ...
                  <li>
                    Verification of protection against electric shock through proper installation
                    methods
                  </li>
                  <li>
                    Assessment of fire risk factors including proper cable support and containment
                  </li>
                  <li>
                    Confirmation of environmental protection appropriate to installation location
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  <li>
                    Socket outlets: Correct type for location, proper earthing, secure mounting, and
                    appropriate IP rating
                  </li>
                  <li>
                    Switches: Correct rating for load, proper orientation, secure fixing, and
                    appropriate height
                  </li>
                  <li>
                    Light fittings: Suitable for environment, correctly supported, and proper lamp
                    compatibility
                  </li>
                  <li>
                    Distribution boards: Appropriate size, correct labelling, and secure cable
                    terminations
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-blue-500/50">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  <li>
                    Safe zone compliance: Cables routed in prescribed zones to prevent accidental
                    damage
                  </li>
                  <li>
                    Support spacing: Adequate fixings at intervals compliant with BS 7671
                    requirements
                  </li>
                  <li>Bend radius protection: Cables not subject to excessive bending or stress</li>
                  <li>
                    Environmental suitability: Cable types appropriate for installation conditions
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  <li>
                    No exposed copper: All live conductors properly insulated with no bare metal
                    visible
                  </li>
                  <li>
                    Proper cable preparation: Correct stripping lengths and undamaged conductor
                    cores
                  </li>
                  <li>
                    Secure connections: All terminations tight and properly secured according to
                    manufacturer specifications
                  </li>
                  <li>
                    Correct polarity: Live, neutral, and earth conductors connected to appropriate
                    terminals
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  <li>
                    Main supply connection: Verify proper earthing, bonding, and supply
                    characteristics
                  </li>
                  <li>
                    Consumer unit inspection: Check RCD operation, MCB ratings, and circuit
                    identification
                  </li>
                  <li>
                    Circuit distribution: Follow each circuit from origin to final connection point
                  </li>
                  <li>
                    Sub-distribution verification: Additional boards correctly fed and protected
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  <li>
                    Main earthing connections: Secure, accessible, and properly identified
                    connections
                  </li>
                  <li>
                    Equipotential bonding: All required metalwork bonded with appropriate conductors
                  </li>
                  <li>
                    Circuit protective conductors: Continuous throughout installation with proper
                    termination
                  </li>
                  <li>
                    Bonding continuity: Visual verification of effective electrical connection
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  <li>
                    <strong>Dangerous:</strong> Immediate risk to safety requiring urgent action
                    before any further work
                  </li>
                  <li>
                    <strong>Requires improvement:</strong> Non-compliance with regulations requiring
                    correction before certification
                  </li>
                  <li>
                    <strong>Minor:</strong> Aesthetic or minor non-compliance issues that should be
                    addressed
                  </li>
                  <li>
                    <strong>Recommendation:</strong> Suggestions for improvement beyond minimum
              ...
              <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/30">
                <p className="text-sm text-amber-200">
                  <strong>Legal importance:</strong> Documentation provides evidence of due
                  diligence and supports certification
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  ...
                  <li>
                    Inspection mirror for viewing inaccessible areas behind accessories and in tight
                    spaces
                  </li>
                  <li>
                    Basic screwdriver set for opening enclosures and checking connection security
                  </li>
                  <li>
                    Digital camera or smartphone for documenting defects and installation details
                  </li>
                  <li>Measuring tape for verifying spacing, heights, and safe zone compliance</li>
                  <li>
                    Safety equipment including safety glasses and appropriate protective clothing
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-amber-500/10 border-l-2 border-amber-500/50">
              ...
              <div className="text-white text-sm space-y-2">
                ...
                <p>
                  <strong>Discovery:</strong> The visual inspection revealed that several socket
                  back boxes throughout multiple properties were missing grommets at cable entry
                  holes - a systematic installation error.
                </p>
                <p>
                  <strong>Resolution:</strong> All affected socket boxes were retrofitted with
                  appropriate grommets before testing commenced. Additional quality checks were
                  implemented.
                </p>
                <p>
                  <strong>Outcome:</strong> Early identification prevented potential long-term
                  insulation damage, safety hazards, and costly post-testing rework.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="list-disc pl-5 space-y-1 text-sm text-white">
                ...
                <li>
                  <strong>Chapter 61:</strong> Initial verification requirements including visual
                  inspection and testing procedures
                </li>
                <li>
                  <strong>Regulation 132.16:</strong> Accessibility for inspection, testing, and
                  maintenance throughout installation life
                </li>
                <li>
                  <strong>Part 5:</strong> Selection and erection of equipment affecting visual
                  inspection requirements
                </li>
                <li>
                  <strong>Regulation 514.9:</strong> Identification and marking requirements for
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-white leading-relaxed">
                ...
                problems are identified early when correction is most cost-effective. Following BS
                7671 requirements ensures that installations are safe, compliant, and ready for
                energisation.
              </p>
            </div>
          </section>
