...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['1.5 years', '2.0 years', '3.0 years', '2.5 years'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['3,495 kgCO₂', '5,495 kgCO₂', '4,495 kgCO₂', '2,495 kgCO₂'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['IE4 Super Premium', 'IE2 High', 'IE3 Premium', 'IE1 Standard'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['42.2 m³/h', '25.0 m³/h', '37.5 m³/h', '66.7 m³/h'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['£9,900', '£12,870', '£25,740', '£19,800'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['2.5 years', '3.33 years', '3.0 years', '2.73 years'],
    correctAnswer: 3,
    explanation:
...
const HNCModule8Section4_5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 4 · Subsection 5"
      ...
      <HubBody>
        ...
        <ConceptBlock title="The Affinity Laws for Fans and Pumps">
          ...
          <p>
            <strong>The Three Affinity Laws</strong>
          </p>
          <p>Flow Rate (Q)</p>
          <p>
          ...
          <p>
            <strong>Understanding the Cubic Power Law</strong>
          </p>
          <p>
            The cubic relationship between power and speed is the key to VSD energy savings. Small
            speed reductions yield large power reductions because power varies with the{' '}
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>90%:</strong> 90% — 81% — 72.9% — 27.1%
            </li>
            <li>
              <strong>80%:</strong> 80% — 64% — 51.2% — 48.8%
            </li>
            <li>
              <strong>70%:</strong> 70% — 49% — 34.3% — 65.7%
            </li>
            <li>
          ...
          <p>
            <strong>Why VSDs Beat Throttling</strong>
          </p>
          <p>
            ...
            immediately dissipated as turbulence and noise. A VSD reduces motor speed to match
            demand, exploiting the cubic power relationship to dramatically cut energy consumption.
          </p>
          <p>
            <strong>When Affinity Laws Apply</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Limitations to Consider</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Remember:</strong> The affinity laws assume the system curve scales with the
            square of flow. Systems with static head (pumping to height) have a minimum pressure
            requirement that must be maintained regardless of flow rate.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Energy Savings Calculations: Fixed vs Variable Speed">
          ...
          <p>
            <strong>Energy Calculation Methodology</strong>
          </p>
          ...
          <p>
            <strong>Typical HVAC Load Profile Example</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>100% load:</strong> 500 — 10% — 100% — 100%
            </li>
            <li>
              <strong>80% load:</strong> 1,500 — 30% — 51.2% — 100%
            </li>
            <li>
              <strong>60% load:</strong> 2,000 — 40% — 21.6% — 100%
            </li>
            <li>
              <strong>40% load:</strong> 1,000 — 20% — 6.4% — 100%
            </li>
            <li>
              <strong>Total:</strong> 5,000 — 100% — Weighted avg: 35% — 100%
            </li>
          </ul>
          <p>
            This profile shows 65% energy saving potential - typical for variable air volume systems
          </p>
          <p>
            <strong>Worked Example: AHU Supply Fan</strong>
          </p>
          ...
          <p>
            E<sub>VSD</sub> = 15 × [500 + 768 + 432 + 64] = 15 × 1,764 = 26,460 kWh
          </p>
          <p>
            Cost = 26,460 × £0.18 = <strong>£4,763/year</strong>
          </p>
          <p>
            Annual saving = £13,500 - £4,763 = <strong>£8,737/year (65%)</strong>
          </p>
          <p>
            <strong>Important: VSD Losses</strong>
          </p>
          <p>
            VSDs are not 100% efficient. Typical VSD efficiency is 95-98% at full load but drops at
            partial loads. Include VSD losses in calculations by applying approximately 3-5%
            additional loss factor. Modern drives with active front ends have better partial load
            efficiency.
          </p>
          <p>
            <strong>Design tip:</strong> Obtain actual load profile data from BMS trending where
            possible. If unavailable, use standardised profiles from CIBSE Guide F or manufacturer
            data. Conservative assumptions lead to more reliable payback predictions.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Simple Payback Analysis">
          <p>
            ...
            investment. It's a quick screening tool for comparing projects but has limitations as it
            ignores benefits beyond the payback period and the time value of money.
          </p>
          <p>
            <strong>Simple Payback Formula</strong>
          </p>
          ...
          <p>
            <strong>Net Annual Savings</strong> = Energy savings - Additional maintenance
          </p>
          <p>
            <strong>Typical VSD Payback Periods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>VAV AHU fans:</strong> &gt;4,000 — High (40-100%) — 1-2 years
            </li>
            <li>
              <strong>CHW pumps:</strong> &gt;3,000 — Medium-High — 2-3 years
            </li>
            <li>
              <strong>Cooling tower fans:</strong> &gt;2,500 — Medium — 2-4 years
            </li>
            <li>
              <strong>Extract fans:</strong> &gt;3,500 — Low-Medium — 3-5 years
            </li>
            <li>
              <strong>Constant volume fans:</strong> Any — None — &gt;10 years
            </li>
          </ul>
          <p>
            <strong>Worked Example: Pump VSD Installation</strong>
          </p>
          <p>Capital costs:</p>
          ...
          <p>
            Net annual saving: <strong>£5,490</strong>
          </p>
          <p>
            Simple payback = £5,100 / £5,490 = <strong>0.93 years (11 months)</strong>
          </p>
          <p>
            <strong>Factors Improving Payback</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Factors Lengthening Payback</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            to gain approval without additional justification (carbon targets, reliability, noise
            reduction).
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="NPV Calculations, Carbon Savings and Part L Compliance">
          <p>
            ...
            compliance (Part L), this forms a comprehensive business case for energy efficiency
            investments.
          </p>
          <p>
            <strong>Net Present Value Formula</strong>
          </p>
          <p>
          ...
          <p>
            <strong>n</strong> = Year number (1, 2, 3... to equipment lifespan)
          </p>
          <p>
            <strong>Present Value Factors (Cumulative)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>5:</strong> 4.21 — 3.99 — 3.79 — 3.60
            </li>
            <li>
              <strong>10:</strong> 7.36 — 6.71 — 6.14 — 5.65
            </li>
            <li>
              <strong>15:</strong> 9.71 — 8.56 — 7.61 — 6.81
            </li>
            <li>
              <strong>20:</strong> 11.47 — 9.82 — 8.51 — 7.47
            </li>
          </ul>
          <p>Multiply annual savings by factor to get present value of all future savings</p>
          <p>
            <strong>NPV Worked Example</strong>
          </p>
          ...
          <p>
            NPV = £46,994 - £5,100 = <strong>£41,894</strong>
          </p>
          <p>Positive NPV indicates excellent investment - proceed!</p>
          <p>
            <strong>Carbon Savings Calculations</strong>
          </p>
          <p>
            Carbon savings add environmental value to energy efficiency projects. The UK grid carbon
            factor represents the CO₂ emissions per unit of electricity consumed.
          </p>
          ...
          <p>
            Carbon saving = 48,540 × 0.233 = <strong>11,310 kgCO₂ (11.3 tonnes/year)</strong>
          </p>
          <p>If carbon priced at £50/tonne:</p>
          <p>
            Additional value = 11.3 × £50 = <strong>£565/year</strong>
          </p>
          <p>
            <strong>Part L Building Regulations</strong>
          </p>
          <p>
            Part L of the Building Regulations sets minimum energy efficiency standards for building
            services, including motors and their control systems.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Motor efficiency class:</strong> Minimum IE3 Premium (or IE2 with VSD)
            </li>
            <li>
              <strong>Variable speed control:</strong> Required for fans/pumps &gt;1.1 kW in
              variable demand systems
            </li>
            <li>
              <strong>Building log book:</strong> Motor ratings and efficiency classes must be
              documented
            </li>
            <li>
              <strong>Metering:</strong> Sub-metering required for motors &gt;15 kW
            </li>
            <li>
              <strong>Commissioning:</strong> Motor systems must be commissioned to design
              efficiency
            </li>
          </ul>
          <p>
            <strong>Motor Efficiency Classes (IEC 60034-30-1)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>IE1:</strong> Standard — ~86.5% — Below minimum - not permitted
            </li>
            <li>
              <strong>IE2:</strong> High — ~89.0% — Only with VSD
            </li>
            <li>
              <strong>IE3:</strong> Premium — ~91.0% — Minimum standard
            </li>
            <li>
              <strong>IE4:</strong> Super Premium — ~93.0% — Best practice
            </li>
            <li>
              <strong>IE5:</strong> Ultra Premium — ~94.5% — Future standard
            </li>
          </ul>
          <p>
            <strong>ErP Directive Requirements</strong>
          </p>
          <p>
            ...
            Motors 0.12-0.75 kW must meet IE2. Check current requirements for your application as
            regulations continue to tighten.
          </p>
          <p>
            <strong>Compliance tip:</strong> Document motor selections at design stage showing IE
            class, power rating, and justification for any exemptions. This evidence is required for
            Building Control sign-off under Part L.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            Annual cost = 96,480 × £0.18 = <strong>£17,366</strong>
          </p>
          <p>
            Annual saving = £17,766 - £17,366 = <strong>£400/year</strong>
          </p>
          <p>Premium for IE4: approximately £350</p>
          <p>
            Simple payback = £350 / £400 = <strong>0.88 years</strong>
          </p>
          <p>
            Over 20 year motor life: £400 × 20 = <strong>£8,000 saving</strong>
          </p>
          <p>
          ...
          <p>
            New power = 0.80³ × 5.5 = 0.512 × 5.5 = <strong>2.82 kW</strong>
          </p>
          <p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Q₂/Q₁ = N₂/N₁</strong> - Flow proportional to speed
            </li>
            <li>
              <strong>H₂/H₁ = (N₂/N₁)²</strong> - Pressure proportional to speed squared
            </li>
            <li>
              <strong>P₂/P₁ = (N₂/N₁)³</strong> - Power proportional to speed cubed
            </li>
            <li>
              <strong>Simple Payback = Capital Cost / Annual Savings</strong>
            </li>
            <li>
              <strong>NPV = (Savings × PV Factor) - Capital</strong>
            </li>
            <li>
              <strong>CO₂ = kWh × Grid Factor</strong>
            </li>
          </ul>
          <p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Ignoring static head</strong> - Affinity laws only apply to friction losses
              </li>
              <li>
                <strong>Optimistic load profiles</strong> - Use measured data where available
              </li>
              <li>
                <strong>Forgetting VSD losses</strong> - Add 3-5% for drive inefficiency
              </li>
              <li>
                <strong>NPV without inflation</strong> - Energy costs typically rise over time
              </li>
              <li>
                <strong>Ignoring minimum speed limits</strong> - Motors need minimum cooling airflow
              </li>
            </ul>
          }
