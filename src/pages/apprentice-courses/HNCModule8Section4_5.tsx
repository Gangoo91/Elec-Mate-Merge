      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Flow:</strong> Q ∝ N (linear with speed)
              </li>
              <li className="pl-1">
                <strong>Pressure:</strong> H ∝ N² (square of speed)
              </li>
              <li className="pl-1">
                <strong>Power:</strong> P ∝ N³ (cube of speed)
              </li>
              <li className="pl-1">
                <strong>50% speed = 12.5% power</strong>
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>HVAC fans:</strong> AHUs, FCUs, extract systems
              </li>
              <li className="pl-1">
                <strong>Pumps:</strong> CHW, HHW, condenser water
              </li>
              <li className="pl-1">
                <strong>Part L:</strong> IE3 minimum efficiency
              </li>
              <li className="pl-1">
                <strong>Typical savings:</strong> 30-50% with VSDs
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              ...
              <p className="text-sm text-white">
                ...
                match demand, exploiting the cubic power relationship to dramatically cut energy
                consumption.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3">
                  <span className="bg-elec-yellow/20 text-elec-yellow px-2 py-0.5 rounded text-xs font-medium">
                    1
                  </span>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical HVAC Load Profile Example
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              investment. It's a quick screening tool for comparing projects but has limitations as
              it ignores benefits beyond the payback period and the time value of money.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Net Present Value (NPV) provides a more sophisticated investment analysis by
              accounting for the time value of money. Combined with carbon savings calculations and
              regulatory compliance (Part L), this forms a comprehensive business case for energy
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Present Value Factors (Cumulative)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-green-400">
                  Positive NPV indicates excellent investment - proceed!
                </p>
              </div>
            </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Minimum IE3 Premium (or IE2 with VSD)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Required for fans/pumps &gt;1.1 kW in variable demand systems
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Motor ratings and efficiency classes must be documented
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Metering</td>
                      <td className="border border-white/10 px-3 py-2">
                        Sub-metering required for motors &gt;15 kW
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Motor systems must be commissioned to design efficiency
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              class, power rating, and justification for any exemptions. This evidence is required
              for Building Control sign-off under Part L.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Complete VSD Business Case
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: IE3 vs IE4 Motor Comparison
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Fan Speed Reduction Calculation
              </h3>
              <p className="text-sm text-white mb-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Ignoring static head</strong> - Affinity laws only apply to friction
                  losses
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Ignoring minimum speed limits</strong> - Motors need minimum cooling
                  airflow
                </li>
              </ul>
            </div>
