          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              ...
              <div className="p-3 rounded bg-transparent">
                ...
                <p className="text-white text-xs">Test results recorded, design available</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">Communication</p>
                <p className="text-white text-xs">All persons notified, area clear</p>
              </div>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent">
                ...
                <p className="text-white text-xs">30mA in 300ms max at 1x, 40ms at 5x</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">Loop Test</p>
                <p className="text-white text-xs">Zs must not exceed Table 41 values</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">Ipf Test</p>
                <p className="text-white text-xs">Must not exceed device Icn</p>
              </div>
            </div>
