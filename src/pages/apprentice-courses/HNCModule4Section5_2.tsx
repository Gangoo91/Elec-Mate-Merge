...
const quickCheckQuestions = [
  {
    ...
    options: ['105 ways', '126 ways', '130 ways', '115 ways'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['300mm', '1400mm', '1000mm', '450mm'],
    correctIndex: 3,
    explanation:
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              method, location, wording. It’s how the next dutyholder knows when their EICR is due.
              The exception for domestic premises applies, but commercial/industrial DBs always
              carry the notice.
            </>
          }
        ...
        <ConceptBlock title="Ways Calculation">
          <p>
            ...
            and future expansion. Under-sizing leads to expensive modifications; over-sizing wastes
            resources and space.
          </p>
          <p>
          ...
          <p>
            <strong>
              Standard distribution board sizes (type / common sizes / typical application):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Diversity Application">
          ...
          <p>
            <strong>
              Diversity factors per IET On-Site Guide Appendix A (circuit type / diversity factor /
              notes):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Caution:</strong> Do not apply diversity to single-circuit loads or where loads
            are known to operate continuously.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Access Requirements and IP Ratings">
          ...
          <p>
            <strong>
              IP ratings for different locations (location / minimum IP / considerations):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — DB sizing for office floor:</strong> Design a distribution board for
            a 400m² office floor.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — maximum demand with diversity:</strong> Calculate maximum demand for
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              Lighting, small power, mechanical services, IT comms cabinet, hand dryers, AC FCUs.
              Spare capacity for a future tea-point. 400 V incomer, 250 A. Loads schedule is in
              Excel. The contractor wants a single-line diagram and labelling spec by end of week.
            </>
          }
          whatToDo={
            <>
              Sum the active circuits: 27 used + 9 spare (25 % headroom) = 36 ways. Apply OSG
              Appendix A diversity to the lighting (90 %) and small power (40 % beyond the first),
              AC FCUs full load. Phase balance: walk down the schedule and rotate circuits across
              L1/L2/L3 so each phase carries 80–90 A on the maximum-demand calc. Specify Type B
              RCBOs (30 mA) on every circuit — granular protection beats a board-level RCD that
              nuisance-trips half the office. Spec engraved Traffolyte way labels, plus a printed
              and laminated circuit chart inside the door, plus the Reg 514.12.1 periodic-inspection
              notice on the door front. Add Reg 514.15.1 warning notice if there’s a backup source.
              Single-line diagram references the BS EN 61439 board reference and the
              form-of-separation drawing.
            </>
          }
          whyItMatters={
            <>
              A 36-way board with no spare ways becomes a £4 k modification when the client adds a
              coffee point. A board with 30 % imbalance trips the protective device on the heaviest
              phase first. A board without a 514.12.1 notice fails the next EICR. Design choices,
              not site choices.
            </>
          }
        />
