...
const AM2Module5Section4 = () => {
  ...
  const quickCheckQuestions: Array<{
  ...
  }> = [
    {
      ...
      options: [
        'Replace the entire socket circuit back to the consumer unit',
        'Disconnect the socket and leave it permanently isolated',
        'Swap line and neutral connections into correct terminals at the socket outlet',
        'Fit a 30 mA RCD to compensate for the reversed polarity',
      ],
      correctIndex: 2,
      explanation:
        'Reversed polarity is corrected by swapping the line and neutral into their correct terminals at the affected accessory, then re-testing polarity.',
    },
    {
      ...
      options: [
        ...
        'Carry out an insulation resistance test only',
        'Confirm the circuit is still isolated and dead',
        'Measure the supply voltage at the origin',
      ],
      correctIndex: 0,
      explanation:
        'A high resistance joint raises the earth fault loop impedance (Zs), so re-testing Zs proves the repair has brought it back within limits.',
    },
    {
  ...
  const quizQuestions = [
    {
      ...
      options: [
        'Yes - you must complete every repair before time runs out',
        'No - just describe rectification and re-testing',
        'Only the faults the assessor specifically asks you to fix',
        'Only faults that involve replacing an accessory',
      ],
      correctAnswer: 1,
      explanation:
        'In AM2 you describe what rectification would be needed and how you would prove it safe - no physical repairs are carried out.',
    },
    {
      id: 2,
      ...
      options: [
        ...
        'As briefly as possible to save time',
        'Action + Location + Re-test',
        'Using as much technical jargon as possible',
      ],
      correctAnswer: 2,
      explanation:
        'The rule for rectification phrasing is: Action (what to do) + Location (where) + Re-test (how to prove safe).',
    },
    {
      id: 3,
      question: 'Give an example of rectification for an open circuit fault.',
      options: [
        'Replace the protective device feeding the circuit',
        'Re-energise the circuit and check for a spark',
        'Tighten every terminal in the consumer unit',
        'Reconnect line conductor at loose termination, then re-test continuity',
      ],
      correctAnswer: 3,
      explanation:
        "'Reconnect line conductor at loose termination, then re-test continuity' shows the exact action, location and verification.",
    },
    {
      id: 4,
      ...
      correctAnswer: 0,
      explanation:
        'A short circuit is a breakdown of insulation between conductors, so an insulation resistance test confirms the repair.',
    },
    {
      id: 5,
      question: 'What rectification is required for reversed polarity at a socket?',
      options: [
        'Replace the socket with a higher-rated unit',
        'Swap line and neutral into the correct terminals',
        'Fit additional RCD protection to the circuit',
        'Increase the size of the circuit protective conductor',
      ],
      correctAnswer: 1,
      explanation:
        'Polarity faults are corrected by swapping line and neutral into their correct terminals at the affected accessory.',
    },
    {
      id: 6,
      question: 'After remaking a high resistance joint, what test proves safety?',
      options: [
        'A visual inspection of the joint only',
        'An insulation resistance test between live conductors',
        'Zs test to confirm impedance within limits',
        'A polarity check at the consumer unit',
      ],
      correctAnswer: 2,
      explanation:
        'A high resistance joint raises earth fault loop impedance, so a Zs test proves the joint is now within acceptable limits.',
    },
    {
      id: 7,
      question: 'Which of these is acceptable wording for a rectification statement?',
      options: [
        "'Fix fault'",
        "'Sort the wiring out'",
        "'Repair as needed'",
        "'Reconnect CPC at SO2 and re-test continuity and Zs'",
      ],
      correctAnswer: 3,
      explanation:
        "Vague wording like 'fix fault' scores no marks; a complete statement names the action, the location and the re-test that proves safety.",
    },
    {
      id: 8,
      ...
      options: [
        ...
        'To record the purchase price of the equipment',
        'To satisfy the client that the work looks tidy',
        'To shorten the time spent on the certificate',
      ],
      correctAnswer: 0,
      explanation:
        'Re-testing proves the circuit is safe and compliant after rectification, which BS 7671 requires for any altered circuit.',
    },
    {
      id: 9,
      question: 'How should you record rectification of a faulty accessory?',
      options: [
        'Note that the accessory looked damaged',
        'Replace defective accessory with new unit, then re-test circuit',
        'Recommend the client monitors it for faults',
        'Isolate the circuit and leave the accessory in place',
      ],
      correctAnswer: 1,
      explanation:
        'Complete rectification includes replacing the faulty accessory and re-testing the circuit to confirm integrity.',
    },
    {
      id: 10,
      ...
      options: [
        'Fault + Tools + Materials',
        'Problem + Cost + Signature',
        'Action + Location + Re-test',
        'Diagnose + Isolate + Replace',
      ],
      correctAnswer: 2,
      explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/am2/module5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          In AM2 fault diagnosis, identifying the fault is only half the task. The assessor also
          expects you to state how you would rectify it and then how you would prove it safe
          afterwards.
        </p>
        ...
        <div className="space-y-6">
            ...
            whatHappens={
              <>
                <p className="text-ios-callout text-white mb-3 leading-relaxed">
                  ...
                  professional language that shows you understand both the problem and the complete
                  solution.
                </p>
          ...
          <ConceptBlock title="3. Examples of Rectification by Fault Type">
            ...
            <p>
              <strong>Short Circuit:</strong> "Re-terminate damaged cable at luminaire, then re-test
            ...
            <p>
              <strong>Polarity Fault:</strong> "Swap conductors into correct terminals, then re-test
              polarity."
            </p>
            <p>
          ...
          <Scenario
            ...
            situation={
              <>
                Your Zs at SO3 measured 4.2 Ω — well over the 1.37 Ω maximum for the 32A Type B MCB
                feeding the ring final. After visual inspection at the consumer unit, you found the
                line conductor termination was loose at the MCB. The assessor asks you to record
                your rectification.
              </>
            }
            whatToDo={
              <>
                ...
                <em>
                  ...
                  ring final R1+Rn continuity, then re-test Zs at SO3 to confirm reading within 1.37
                  Ω maximum for protective device."
                </em>{' '}
            ...
            whyItMatters={
              <>
                ...
                identify which connection or which MCB. The 1.37 Ω figure shows you know the BS 7671
                A4:2026 maximum Zs for that protective device — that's the level of detail that
                separates pass marks from full marks.
              </>
            }
          />
          ...
          <ConceptBlock title="5. Assessor Expectations">
            ...
            <p>
              <strong className="text-elec-yellow">Professional Standards — Communication:</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <RegsCallout
            ...
            meaning={
              <>
                ...
                Location + Re-test" is the format: it mirrors what you'd do on a real job to comply
                with BS 7671 Reg 643.1. Skipping the re-test on AM2 isn't just losing marks — it's
                saying you wouldn't comply with the regs in real life.
              </>
            }
          ...
          <CommonMistake
            ...
            doInstead={
              <>
                Add the verification target: "Reconnect CPC at SO2 — re-test R2 continuity and Zs at
                SO2, confirming Zs within 1.37 Ω maximum for 32A Type B." Now the assessor knows you
                understand both the test AND the pass criterion. Same effort, double the detail,
                full marks.
              </>
            }
          />
          ...
          <ConceptBlock title="6. Advanced Rectification Scenarios">
            ...
            <p>
              <strong>Rectification:</strong> "1. Reconnect CPC at loose terminal in socket backbox.
              2. Correct L-N connections at same socket. 3. Re-test continuity and polarity for
              entire ring."
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <p>
              <strong>Rectification:</strong> "Reconnect main earthing conductor to MET and re-test
              Zs on all affected circuits to confirm earth integrity restored."
            </p>
          ...
          <ConceptBlock title="7. Documentation and Legal Requirements">
            <p>
              <strong className="text-elec-yellow">What Must Be Updated Post-Rectification:</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                <strong>Circuit details:</strong> Any changes to cable routes, sizes, or accessories
              </li>
              <li>
          ...
          <ConceptBlock title="8. Practical Guidance for Success">
            ...
            <p>
              <strong>Example:</strong> "Reconnect neutral at CU terminal and re-test continuity and
              polarity."
            </p>
          ...
          <ConceptBlock title="9. Real-World Examples">
            ...
            <p>
              <strong>Scenario:</strong> On-site, an electrician repaired a joint but didn't re-test
              Zs.
            </p>
            <p>
            ...
            <p>
              <strong>Lesson:</strong> In AM2, skipping the re-test equals lost marks - and in real
              work, potential danger.
            </p>
          </ConceptBlock>
