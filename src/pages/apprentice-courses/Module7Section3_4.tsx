...
const DESCRIPTION =
  'Identifying and responding to buzzing, arcing and sparking in electrical installations according to BS 7671.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Electrical arcing creates extremely high temperatures that pose immediate fire and explosion risks, especially in flammable atmospheres.',
  },
  {
    id: 2,
    ...
    correctIndex: 1,
    explanation:
      'Buzzing typically indicates loose connections causing arcing or magnetostriction in transformers and chokes.',
  },
  {
    id: 3,
    ...
    correctIndex: 1,
    explanation:
      'Electrical arcing requires immediate isolation to prevent fire, explosion, or serious injury from high-energy discharge.',
  },
];
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Persistent buzzing indicates loose connections causing intermittent arcing or loose core laminations in transformers.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'Electrical arcs generate temperatures exceeding 3000°C, creating serious fire and explosion risks, especially near flammable materials.',
    },
    {
      id: 3,
      ...
      correctAnswer: 1,
      explanation:
        'Sparking indicates worn switch contacts or high inductive loads that create back-EMF during switching operations.',
    },
    {
      id: 4,
      ...
      correctAnswer: 1,
      explanation:
        'Dangerous arcing leaves carbon tracks, contact pitting, scorch marks, and metal vapour deposits on surrounding surfaces.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'Electrical arcing requires immediate isolation and area security to prevent escalation to fire or explosion.',
    },
    {
      id: 6,
      ...
      correctAnswer: 1,
      explanation:
        'Ultrasonic detectors identify high-frequency sounds from arcing, while thermal imaging shows hotspots from poor connections.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'Buzzing indicates developing electrical faults that can rapidly escalate to dangerous arcing, fires, or equipment failure.',
    },
    {
      id: 8,
      ...
      correctAnswer: 1,
      explanation:
        'Moisture reduces insulation resistance, contamination creates tracking paths, and corrosive atmospheres degrade connections.',
    },
    {
      id: 9,
      ...
      correctAnswer: 1,
      explanation:
        'Arcing faults require comprehensive documentation including hazard assessment, immediate actions, and remedial work completed.',
    },
    {
      id: 10,
      ...
      correctAnswer: 1,
      explanation:
        'Progressive buzzing and visible sparking indicated contact deterioration leading to dangerous arcing and potential fire risk.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'Normal switching may produce brief, small sparks that extinguish immediately. Dangerous arcing is sustained, bright, produces carbon deposits, and may be accompanied by buzzing or crackling sounds.',
    },
    {
      question: 'Can electrical arcing cause fires in non-flammable environments?',
      answer:
        "Yes, electrical arcs generate extreme temperatures that can ignite dust, vapours, or any combustible materials present. Even 'non-flammable' environments often contain packaging, cleaning materials, or other ignition sources.",
    },
    {
      question: 'What should maintenance personnel know about arcing hazards?',
      answer:
        'Train staff to recognise buzzing, crackling sounds, and unusual light flashes. Emphasise that these signs require immediate reporting and that work should stop until qualified electricians investigate.',
    },
    {
      question: 'How often should equipment prone to arcing be inspected?',
      answer:
        'High-use switching equipment, contactors, and motor controls should be inspected quarterly. Critical systems may need monthly checks, while domestic installations typically require annual visual inspections.',
    },
    {
      question: 'What makes some electrical equipment more prone to arcing?',
      answer:
        'Equipment with mechanical contacts (switches, contactors), high-current circuits, inductive loads, and equipment in harsh environments are most susceptible to arcing faults.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <ul className="text-white/80 space-y-1 text-sm list-disc pl-4">
              ...
              <li>
                Early detection and proper response are critical for safety and preventing
                escalation.
              </li>
            </ul>
          </div>
          ...
          <section className="mb-10">
            ...
            <ul className="text-white/80 space-y-2 text-sm list-disc pl-4">
              ...
              <li>
                Identify visual indicators of sparking and arcing including carbon tracking and
                contact deterioration.
              </li>
              <li>
                Understand the causes and progression of electrical arcing faults and their extreme
                fire risks.
              </li>
              <li>
                Apply systematic investigation procedures for buzzing and sparking electrical
                equipment.
              </li>
              <li>
                Implement immediate safety measures and remedial actions for arcing and sparking
                faults.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                high-energy electrical disturbances requiring immediate investigation.
              </p>

              <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
                <p className="font-medium text-white mb-2">Buzzing and Humming Sounds</p>
                <p className="text-sm mb-2">
                  <strong className="text-white">Transformer and choke buzzing:</strong>{' '}
                  Magnetostriction causing core lamination vibration.
                </p>
                ...
                <p className="text-sm mb-2">
                  <strong className="text-white">Connection buzzing:</strong> Arcing at loose or
              ...
              <div className="p-3 rounded bg-red-500/10 text-sm">
                <strong className="text-red-400">Emergency response:</strong> Isolate supply
                immediately - buzzing often precedes dangerous arcing and fire.
              </div>
            </div>
          </section>
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-orange-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong className="text-white">Arc formation:</strong> Electrical discharge
                  through ionized air gap between conductors.
                </p>
                <ul className="text-sm list-disc pl-4 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <p className="text-sm mb-2">
                  Normal and abnormal sparking during switching operations:
                </p>
                <ul className="text-sm list-disc pl-4 space-y-1">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm list-disc pl-4 space-y-1 text-white/80">
                  ...
                  <li>
                    Thermal imaging reveals hotspots indicating poor connections before visible
                    damage occurs
                  </li>
                  <li>
                    Low-resistance ohmmeters can identify high-resistance connections prone to
                    arcing
                  </li>
                  <li>
                    Visual inspection under UV light may reveal carbon tracking not visible in
                    normal light
                  </li>
                </ul>
              </div>
