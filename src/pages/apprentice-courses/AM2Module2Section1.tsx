...
const AM2Module2Section1 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['Automatic fail', 'You can try again', 'You get a warning', 'You lose some marks'],
      correctAnswer: 0,
      explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/am2/module2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Critical safe isolation procedures for AM2 - instant fail if wrong. Complete guide to NET
        ...
        <ConceptBlock title="Instant fail if wrong">
          <p>
            <strong className="text-red-300">Critical.</strong> Safe isolation is the foundation of
            electrical safety and the most unforgiving part of the AM2. If you get it wrong, you
            fail — regardless of how well you perform elsewhere. In real working life, safe
        ...
        <ConceptBlock title="Why Safe Isolation Matters">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              "save time" — resulted in fatality and company prosecution under Section 37 of Health
              &amp; Safety at Work Act.
            </li>
            <li>
              <strong>Serious Injury (2021):</strong> Apprentice received 11kV shock when supervisor
              failed to follow lock-off procedure — 6 months recovery, permanent nerve damage.
            </li>
            <li>
              <strong>AM2 Impact:</strong> 2023 data shows 7 out of 10 AM2 failures directly linked
              to incomplete or incorrect safe isolation procedures.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Real-World Examples">
          <p>
            <strong className="text-red-400">Example 1: Forgotten Re-Prove.</strong> A candidate did
            everything correctly but forgot to re-prove the tester during safe isolation. The
            assessor stopped the test and recorded a fail.{' '}
            <strong className="text-elec-yellow">Lesson:</strong> never skip the final tester
            proving step.
          </p>
          <p>
            <strong className="text-red-400">Example 2: Wrong Lock-Off.</strong> Candidate used tape
            instead of a lock-off device. Unsafe — instant fail.{' '}
            <strong className="text-elec-yellow">Lesson:</strong> only proper padlocks are
            acceptable.
          </p>
          <p>
            <strong className="text-red-400">Example 3: Missing Warning Notice.</strong> A candidate
            isolated a lighting circuit correctly but didn't attach a warning notice. Lost critical
            marks, failed the section. <strong className="text-elec-yellow">Lesson:</strong>{' '}
            lock-off AND warning notice are both mandatory.
          </p>
          <p>
            <strong className="text-red-400">Example 4: Wrong Circuit Isolated.</strong> Candidate
            misread the circuit schedule and isolated the wrong circuit. Despite perfect procedure,
            this was a critical fail. <strong className="text-elec-yellow">Lesson:</strong> always
            double-check circuit identification first.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="What Assessors Look For">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Correct Sequence</strong> — assessors check you follow the exact NET sequence
              without shortcuts
            </li>
            <li>
              <strong>Equipment Handling</strong> — proper use of test equipment, proving before and
              after
            </li>
            <li>
        ...
        <ConceptBlock title="Frequently Asked Questions">
          <p>
            <strong>Q1: Can I just switch off at the consumer unit without locking off?</strong> No.
            Locking off and warning notices are mandatory under regulations.
          </p>
          <p>
          ...
          <p>
            <strong>Q5: Can I talk through the process instead of demonstrating it?</strong> No. You
            must physically demonstrate the procedure.
          </p>
          <p>
            <strong>Q6: How long should safe isolation take?</strong> Allow 10-15 minutes including
            all tests and documentation.
          </p>
          <p>
            <strong>Q7: What if the tester fails during the process?</strong> Stop immediately, get
            a replacement tester, and start again.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              wired so you can demonstrate this — your job is to identify the right device, isolate
              it, lock it off and prove dead. Skip any step and you’ve broken the regulation.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              This is the regulatory basis for lock-off. The device alone isn’t enough — it must be
              secured against being switched back on. On AM2, "I closed the breaker" is not
        ...
        <Scenario
          ...
          situation={
            <>
              Section C. The assessor points at a three-phase isolator feeding a small distribution
              board. You have a two-pole tester, a proving unit, a padlock and a warning notice. The
              clock starts.
            </>
          }
          whatToDo={
            <>
              Prove the tester on the proving unit. Identify the circuit on the schedule. Switch the
              isolator off. Apply your padlock and retain the key. Post the warning notice. Test
              between every pair of conductors — L1-L2, L2-L3, L3-L1, each line to neutral, each
              line to earth, neutral to earth. Re-prove the tester on the proving unit. Only then is
              the board safely isolated.
            </>
          }
          whyItMatters={
            <>
              On a three-phase isolation, missing one combination (especially neutral-to-earth) is a
              critical fail. The test sequence isn’t just for show — a damaged neutral can leave you
              with a hidden live path even after the breaker is open.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You isolate, dead-test, then think about the padlock. In the gap between switching off
              and locking off, somebody could walk past and re-energise the circuit — the assessor
              included, as a deliberate test.
            </>
          }
          doInstead={
            <>
              Lock off <em>immediately</em> after switching off, before you do anything else. Then
              prove the tester, then dead-test. The order is: switch off → lock off → warning notice
              → prove tester → test dead → re-prove tester.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Back to Module</div>
          </button>
          <button
