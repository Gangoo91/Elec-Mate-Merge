...
const DESCRIPTION =
  'Master professional earthing techniques for metallic containment systems. Learn BS 7671 requirements, CPC selection, testing procedures, and fault protection for safe electrical installations.';
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "A separate CPC is required when containment is mechanically weak, has mixed materials, or poor conductivity that doesn't meet BS 7671 requirements.",
  },
  {
    id: 6,
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/80 text-sm space-y-1 list-disc pl-4">
                  ...
                  <li>
                    Proper earthing provides fault current paths and enables protective device
                    operation
                  </li>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/80 text-sm space-y-1 list-disc pl-4">
                  ...
                  <li>
                    <strong>Use:</strong> Earth clamps, bonding straps, internal links, continuity
                    testers
                  </li>
                  <li>
                    <strong>Check:</strong> Joint conductivity, resistance values, mechanical
                    integrity
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-2 leading-relaxed">
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Identify when containment systems can act as circuit protective conductors and
                  when separate CPCs are required
                </li>
                <li>
                  Select and install appropriate earthing conductors, clamps, and bonding
                  accessories for different containment types
                </li>
                <li>
                  Perform comprehensive continuity testing on metallic containment systems using
                  appropriate test equipment
                </li>
                <li>
                  Apply BS 7671 regulations and manufacturer guidance for compliant earthing
                  arrangement design and installation
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Protective device operation: Ensures MCBs/RCDs operate within required
                    disconnection times
                  </li>
                  <li>
                    Touch voltage limitation: Maintains safe potential differences {'<'}50V during
                    faults
                  </li>
                  <li>
                    Step/touch potential control: Prevents dangerous voltage gradients around
                    equipment
                  </li>
                </ul>
                <p className="text-white/80 text-sm mb-2">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Electricity at Work Regulations 1989: Duty to prevent danger from electrical
                    equipment
                  </li>
                ...
                <div className="text-sm text-elec-yellow/80 bg-elec-yellow/5 p-2 rounded mt-2">
                  <strong>Critical requirement:</strong> Earth fault loop impedance must ensure
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-red-500/50">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Mechanical damage: Cable damage during installation exposing live conductors
                  </li>
                  <li>
                ...
                <div className="text-sm text-red-400/80 bg-red-500/5 p-2 rounded mt-2">
                  <strong>Safety standard:</strong> Disconnection times: {'<'}0.4s for final
                  circuits, {'<'}5s for distribution
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Fault current rating: Must withstand prospective fault current for disconnection
                    time
                  </li>
                </ul>
                <p className="text-white/80 text-sm mb-2">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Trunking 50×50mm: 1.5mm wall = ~290mm² effective area (suitable for 35mm²
                    circuits)
                  </li>
                  <li>
                    Cable tray: Calculate based on actual steel cross-section, not overall
                    dimensions
                  </li>
                ...
                <div className="text-sm text-green-400/80 bg-green-500/5 p-2 rounded mt-2">
                  <strong>Design requirement:</strong> Calculate containment thermal capacity using
                  k-factor method
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-blue-500/50">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Surface preparation: Clean to bright metal, remove paint/oxidation at contact
                    points
                  </li>
                  <li>
                    Environmental protection: Use corrosion-resistant bolts, consider galvanic
                    compatibility
                  </li>
                </ul>
                <p className="text-white/80 text-sm mb-2">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Joint-by-joint testing: Individual joint resistance measurements for quality
                    control
                  </li>
                  <li>
                    Load testing: High-current testing to verify thermal performance under fault
                    conditions
                  </li>
                  <li>
                    Documentation: Record all measurements and joint details for maintenance records
                  </li>
                </ul>
                <div className="text-sm text-blue-400/80 bg-blue-500/5 p-2 rounded mt-2">
                  <strong>Quality standard:</strong> Re-test annually or after any containment
                  modifications
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Corrosion protection: Hot-dip galvanised or equivalent coating system for 25+
                    year life
                  </li>
                  <li>Thermal cycling: Designed for temperature range without joint loosening</li>
                  <li>
                    Vibration resistance: Secure fixing design to prevent fatigue failure of
                    connections
                  </li>
                </ul>
                <p className="text-white/80 text-sm mb-2">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Temperature extremes: Expansion joint design for thermal movement accommodation
                  </li>
                </ul>
                <div className="text-sm text-purple-400/80 bg-purple-500/5 p-2 rounded mt-2">
                  <strong>Assessment requirement:</strong> Environmental conditions must not
                  compromise CPC function
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-orange-500/50">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Lightweight trunking: Domestic-grade systems not rated for commercial fault
                    currents
                  </li>
                  <li>
                    Flexible systems: Any containment with intentional flexibility requires separate
                    CPC
                  </li>
                  <li>
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Coated/uncoated interfaces: Paint or plating preventing reliable electrical
                    contact
                  </li>
                  <li>
                    Different manufacturers: Joint compatibility issues affecting electrical
                    performance
                  </li>
                </ul>
                <div className="text-sm text-orange-400/80 bg-orange-500/5 p-2 rounded mt-2">
                  <strong>Design rule:</strong> Any break in material continuity requires separate
                  CPC provision
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-red-500/50">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Industrial chemicals: Process fluids attacking protective coatings and base
                    metals
                  </li>
                  <li>
                    Agricultural settings: Ammonia and organic acids compromising electrical
                    contacts
                  </li>
                  <li>
                    External weather exposure: UV, temperature cycling, and moisture affecting
                    performance
                  </li>
                </ul>
                <p className="text-white/80 text-sm mb-2">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    High-level installations: Safety risks preventing regular inspection and testing
                  </li>
                  <li>
                    Process-critical areas: Downtime restrictions limiting maintenance opportunities
                  </li>
                  <li>
                    Specialist access requirements: Additional safety systems needed for maintenance
                  </li>
                </ul>
                <div className="text-sm text-red-400/80 bg-red-500/5 p-2 rounded mt-2">
                  <strong>Maintenance requirement:</strong> All CPC systems must allow safe periodic
                  verification
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Material compatibility: Brass/bronze for steel containment, avoid
                    aluminium/steel contact
                  </li>
                  <li>
                    Surface preparation: Clean 50×50mm area to bright metal, remove all coatings
                  </li>
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Route protection: Mechanical protection where subject to damage, minimum bend
                    radius 6×diameter
                  </li>
                  <li>
                    Identification: Green/yellow sleeve full length, 'SAFETY ELECTRICAL CONNECTION'
                    labels
                  </li>
                </ul>
                <div className="text-sm text-purple-400/80 bg-purple-500/5 p-2 rounded mt-2">
                  <strong>Installation standard:</strong> All bonding connections must be accessible
                  for inspection
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Termination method: Crimped lugs with heat-shrink sealing, no soldered joints
                  </li>
                </ul>
                <div className="text-sm text-green-400/80 bg-green-500/5 p-2 rounded mt-2">
                  <strong>Quality requirement:</strong> Earth straps must withstand 100,000 movement
                  cycles minimum
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-blue-500/50">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Busbar earth systems: Continuous copper busbar for high-fault-current
                    applications
                  </li>
                  <li>
                    Spring-loaded contacts: Automatic earth connection for modular trunking systems
                  </li>
                  <li>
                    Bolt-on earth bars: Retrofit solutions for existing installations lacking
                    continuity
                  </li>
                </ul>
                <p className="text-white/80 text-sm mb-2">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Exothermic welding: Superior connection reliability for outdoor/corrosive
                    environments
                  </li>
                  <li>
                    Compression connections: High-pressure mechanical joints for aluminium
                    containment
                  </li>
                  <li>
                    Earth monitoring systems: Continuous monitoring of earth circuit integrity
                  </li>
                </ul>
                <div className="text-sm text-blue-400/80 bg-blue-500/5 p-2 rounded mt-2">
                  <strong>Selection criteria:</strong> Choose method based on fault current,
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-red-500/50">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Test lead resistance: Compensated measurement to eliminate lead resistance
                    errors
                  </li>
                  <li>
                    Environmental conditions: Dry conditions, temperature 15-25°C for accurate
                    readings
                  </li>
                </ul>
                <p className="text-white/80 text-sm mb-2">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Joint testing: Individual joint resistance {'<'}5mΩ for bolted, {'<'}2mΩ for
                    welded
                  </li>
                  <li>
                    Load testing: High-current test to verify thermal performance (where applicable)
                  </li>
                </ul>
                <div className="text-sm text-red-400/80 bg-red-500/5 p-2 rounded mt-2">
                  <strong>Acceptance standard:</strong> Earth fault loop impedance must enable
                  protective device operation
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Containment schedule: Lengths, cross-sections, joint types, and earth
                    arrangements
                  </li>
                ...
                <ul className="text-white/70 text-sm ml-4 mb-2 list-disc space-y-1">
                  ...
                  <li>
                    Photographic records: Document earth connections, clamp installations, and test
                    points
                  </li>
                  <li>
                    Training provision: Operate and maintain instructions for client personnel
                  </li>
                  <li>Warranty conditions: Performance guarantees and maintenance requirements</li>
                </ul>
                <div className="text-sm text-green-400/80 bg-green-500/5 p-2 rounded mt-2">
                  <strong>Legal requirement:</strong> Electrical Installation Certificate required
                  for all new work
                </div>
              </div>
            </div>
                ...
                <div className="grid sm:grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    <ul className="text-white/60 text-xs space-y-1 list-disc pl-4">
                      ...
                      <li>
                        <strong>Total prevention: £1,000</strong>
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="text-white/60 text-xs space-y-1 list-disc pl-4">
                      ...
                      <li>
                        <strong>ROI: 1,000% cost saving</strong>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4 text-white/80">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm">
                  A: Cable tray can be used as a CPC only if it meets BS 7671 requirements for
                  cross-sectional area, continuity, and mechanical robustness. The manufacturer must
                  also approve its use as a CPC. Ladder-type trays often lack sufficient
                  cross-sectional area for larger circuits, while solid-bottom trays generally
                  provide adequate capacity. Always calculate the effective steel cross-section and
                  verify against the required CPC area for your specific circuit.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <p className="font-medium text-white mb-1">
                  Q: How can I check if joints maintain good electrical continuity?
                </p>
                <p className="text-sm">
                  A: Use a low-resistance ohmmeter with a test current of at least 200mA to measure
                  resistance across each joint. Individual joint resistance should be {'<'}5mΩ for
                  bolted connections and {'<'}2mΩ for welded connections. Test immediately after
                  installation and annually thereafter. High resistance indicates poor contact due
                  to corrosion, loose connections, or paint/coating interference.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <p className="font-medium text-white mb-1">
                  Q: What should I do if measured earth resistance is too high?
                </p>
                <p className="text-sm">
                  A: First, identify the source of high resistance through section-by-section
                  testing. Clean and re-make poor joints, install bonding conductors or earth straps
                  across high-resistance sections, or fit internal earth links. If containment
                  resistance cannot be reduced sufficiently, install a separate CPC of appropriate
                  size alongside the containment. Document all remedial work and re-test to verify
                  compliance.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <p className="font-medium text-white mb-1">
                  Q: Are earth monitoring systems required for containment earthing?
                </p>
                <p className="text-sm">
                  A: Earth monitoring is not mandatory for standard installations but is recommended
                  for critical applications such as hospitals, data centres, or hazardous areas.
                  These systems continuously monitor earth circuit integrity and provide alarms if
                  continuity is lost. They are particularly valuable where earthing system failure
                  could cause serious safety hazards or operational disruption.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-white/80 text-sm leading-relaxed">
                ...
                must be established, verified through testing, and maintained throughout the
                installation's life. Proper earthing methods, quality installation techniques, and
                comprehensive testing ensure compliance with BS 7671 requirements and provide
                reliable protection against electrical faults. Regular inspection and maintenance of
                earth connections are essential for continued safety and performance.
              </p>
            </div>
          </section>
