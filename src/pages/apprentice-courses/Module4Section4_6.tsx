      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Purpose and Legal Requirements for Earthing Metallic Containment</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Legal and compliance requirements:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Risk factors without proper earthing:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">When Containment Can Act as Circuit Protective Conductor</h3>
            <p className="text-xs sm:text-sm text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>BS 7671 Table 54.7 minimum CPC areas:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Containment cross-section calculations:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Joint and connection standards:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Continuity verification procedures:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Mechanical integrity requirements:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Environmental assessment criteria:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">When to Install Separate Circuit Protective Conductors</h3>
            <p className="text-xs sm:text-sm text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Mixed material system issues:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Maintenance accessibility issues:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Professional Earthing Methods and Installation Techniques</h3>
            <p className="text-xs sm:text-sm text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Bonding conductor sizing and installation:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Earth strap specification and installation:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Specialist earthing techniques:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Comprehensive Testing and Verification Procedures</h3>
            <p className="text-xs sm:text-sm text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-red-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Testing methodology and acceptance criteria:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-red-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Quality assurance and handover:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">Real-World Example: Commercial Lighting Project Earth Continuity Failure</h2>
          
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 mb-4">
            <div>
              <h3 className="font-semibold text-white mb-2">The Installation Issue</h3>
            ...
            <div>
              <h3 className="font-semibold text-white mb-2">Cost Impact and Resolution</h3>
              <p className="text-xs sm:text-sm text-white mb-3">
                <strong>Remedial work required:</strong>
              </p>
              <ul className="text-xs sm:text-sm text-white space-y-1 mb-3">
          ...
          <div className="bg-muted/50 p-4 rounded-lg">
            <h3 className="font-semibold text-white mb-2">Prevention Analysis and Best Practice</h3>
            <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
              <div>
                <p className="font-medium text-white mb-1">Correct Procedure</p>
              ...
              <div>
                <p className="font-medium text-white mb-1">Technical Solution</p>
                <ul className="text-xs text-white space-y-1">
              ...
              <div>
                <p className="font-medium text-white mb-1">Learning Outcomes</p>
                <ul className="text-xs text-white space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold text-white mb-2">Q: Can cable tray be used as a CPC in all installations?</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div>
              <h3 className="font-semibold text-white mb-2">Q: How can I check if joints maintain good electrical continuity?</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div>
              <h3 className="font-semibold text-white mb-2">Q: What should I do if measured earth resistance is too high?</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div>
              <h3 className="font-semibold text-white mb-2">Q: Are earth monitoring systems required for containment earthing?</h3>
              <p className="text-xs sm:text-sm text-white">
