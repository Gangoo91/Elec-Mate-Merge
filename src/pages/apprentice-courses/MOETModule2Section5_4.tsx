...
const DESCRIPTION =
  'Comprehensive guide to electrical test equipment for maintenance technicians: multimeters, clamp meters, insulation resistance testers, loop impedance testers, RCD testers, GS38 compliance and safe testing practices.';
...
const faqs = [
  {
    ...
    answer:
      "Most manufacturers and the IET recommend annual calibration for test instruments used for BS 7671 verification. Calibration must be performed by a UKAS-accredited laboratory or equivalent, and a calibration certificate must be issued showing the instrument's accuracy within specified tolerances. Some instruments may need more frequent calibration if subjected to heavy use, harsh conditions, or if dropped. Always check the calibration due date before using any test instrument — results from an out-of-calibration instrument are invalid.",
  },
  {
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              often additional parameters such as capacitance, frequency and temperature. However, a
            ...
            <p>
              The measurement category (CAT) rating is the most important safety specification on
              any meter. It defines the maximum transient overvoltage the meter can safely withstand
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              ...
              The MFT injects a brief test current and measures the resulting voltage drop to
              calculate the impedance. For a 32 A Type B MCB, the maximum Zs at the furthest point
            ...
            <p>
              ...
              through the RCD between line and earth. Standard tests include 50% of rated current
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              the validity of every electrical installation certificate or periodic inspection
