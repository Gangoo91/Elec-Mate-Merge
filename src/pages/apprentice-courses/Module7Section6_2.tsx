...
const DESCRIPTION =
  'How to report faults promptly and professionally to supervisors or duty holders';
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Minor defects can escalate into serious safety hazards. Prompt reporting prevents accidents and demonstrates professional responsibility.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'The site supervisor or appointed responsible person has the authority and responsibility to act on fault reports.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'In rental properties, the landlord or their appointed agent typically holds responsibility for electrical safety.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Casual language lacks specificity and can lead to misunderstandings about the nature, location, or urgency of faults.',
  },
  {
    id: 5,
    ...
    correctAnswer: 2,
    explanation:
      'Professional reports include specific circuit references, exact locations, observed conditions, actions taken, and next steps required.',
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      'Verbal reporting ensures immediate action can be taken, while written reports provide permanent documentation for legal and safety purposes.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Comprehensive documentation must include all relevant details to enable proper action and provide legal protection.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'All faults, regardless of apparent severity, must be reported immediately as they can escalate and create serious hazards.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      'The fault was observed but not formally reported, meaning no remedial action was taken, allowing it to escalate.',
  },
  {
    id: 10,
    ...
    correctAnswer: 2,
    explanation:
      'Following proper reporting procedures ensured the dangerous circuit was isolated and repaired before it could cause harm.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. Make safe or isolate if there's a risk. Then report immediately and document the action taken.",
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              indicate overheating and become a fire risk if ignored. Prompt reporting ensures that
              faults are addressed before they escalate.
            </p>
            <p>
              Delay not only increases risk but can also place legal responsibility on the
              electrician who noticed the problem but failed to act. Under the Electricity at Work
              Regulations 1989, all persons have a duty to prevent danger. If you observe a fault
            ...
            <p>
              Remember: what appears minor today could become a major incident tomorrow.
              Professional electricians report everything, no matter how insignificant it may seem.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              understanding of the chain of responsibility prevents delays and ensures
              accountability.
            </p>
            <p>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>
                <strong>Construction sites:</strong> Site supervisor, site manager, or electrical
                contractor
              </li>
              <li>
                <strong>Commercial premises:</strong> Facilities manager, building services manager,
                or appointed duty holder
              </li>
              <li>
                <strong>Rental properties:</strong> Landlord, letting agent, or property management
                company
              </li>
              <li>
                <strong>Industrial facilities:</strong> Maintenance manager, plant engineer, or
                safety officer
              </li>
              <li>
                <strong>Public buildings:</strong> Estates manager, technical services, or
                designated responsible person
              </li>
            </ul>
            <p>
              If unsure who to report to, ask your immediate supervisor. Never assume someone else
              will handle it. The duty holder is the person with legal responsibility for electrical
              safety in that particular premises or installation.
            </p>
            <p>
              <strong>Key principle:</strong> Report upwards in the hierarchy. An apprentice reports
              to their supervisor, who may then escalate to the duty holder or client as
              appropriate.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              Both verbal and written reporting are important: verbal provides immediate
              communication, written creates a permanent record for legal compliance and future
              reference.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>
                <strong>Date and time:</strong> When the fault was discovered
              </li>
              <li>
                <strong>Location:</strong> Precise details (building, floor, room, specific
                equipment)
              </li>
              <li>
                <strong>Circuit reference:</strong> Board designation and circuit number
              </li>
              <li>
                <strong>Fault description:</strong> What was observed or measured
              </li>
              <li>
                <strong>Action taken:</strong> Isolation, labelling, making safe
              </li>
              <li>
                <strong>Who reported to:</strong> Name and position of person notified
              </li>
              <li>
                <strong>Signature:</strong> Your name and signature
              </li>
              <li>
                <strong>Recommendation:</strong> Required follow-up action
              </li>
            </ul>
            <p>
            ...
            <p>
              <strong>Legal protection:</strong> Proper documentation demonstrates that you
              fulfilled your duty of care under the Electricity at Work Regulations 1989. It
              transfers responsibility to the appropriate person while protecting you from potential
              liability.
            </p>
            <p>
              <strong>Important:</strong> Once reported, apprentices must not attempt to rectify
              faults unless specifically authorised and competent to do so. Follow your supervisor's
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            <ol className="space-y-2 text-white text-sm">
              ...
              <li>
                <strong>2. Assess Urgency:</strong> Determine if immediate evacuation or emergency
                services are needed
              </li>
              <li>
                <strong>3. Gather Information:</strong> Note circuit references, exact location,
                what you observed
              </li>
              <li>
                <strong>4. Report Verbally:</strong> Contact supervisor/duty holder immediately by
                phone or in person
              </li>
              <li>
                <strong>5. Document in Writing:</strong> Complete formal report using company
                procedures
              </li>
              <li>
                <strong>6. Follow Up:</strong> Ensure your report was received and action is being
                taken
              </li>
            </ol>
          </div>
        ...
        <section className="mb-10">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-white space-y-2 text-sm">
              ...
              <li>
                • Use clear, factual language with circuit/board IDs, location, and action taken
              </li>
              <li>
                • Document both verbal and written reporting for traceability and compliance (BS
                7671, EAWR 1989)
              </li>
