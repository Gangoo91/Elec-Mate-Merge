...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Node voltages', 'Total resistance', 'Loop currents', 'Power in each component'],
    correctAnswer: 2,
    explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/h-n-c-module3-section1"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              KCL at a three-phase node says ΣI = 0. With balanced linear loads the neutral current
              is zero; with single-phase imbalance or triplen-harmonic content (LED drivers, VFDs)
              the neutral can carry as much as or more than the phase current. KCL is the arithmetic
              that proves the neutral conductor selection is fit for purpose.
            </>
          }
        ...
        <ConceptBlock title="Kirchhoff's Current Law (KCL)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Current is assigned positive entering the node, negative leaving (or vice versa - be
              consistent)
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              I3 = <strong>12A</strong> leaving the node
            </li>
          </ul>
        ...
        <ConceptBlock title="Kirchhoff's Voltage Law (KVL)">
          <p>
            Kirchhoff's Voltage Law, also known as Kirchhoff's second law or the loop rule, is based
            on the conservation of energy. The work done on a charge around any closed path must
            equal zero - energy gained equals energy lost.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">Mathematical Statement</p>
          <p>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Remember:</strong> KVL applies to any closed path, whether it contains a source
            or not. It's the basis for voltage drop calculations.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Applying KCL and KVL">
          <p>
            ...
            approaches exist: node voltage analysis (primarily using KCL) and mesh current analysis
            (primarily using KVL).
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Step 2: Apply KCL at Nodes</strong> — Write KCL equation for each node (except
              reference). Express branch currents in terms of unknowns. Gives (n-1) equations for n
              nodes
            </li>
            <li>
              <strong>Step 3: Apply KVL around Loops</strong> — Identify independent loops (meshes),
              write KVL equation for each loop, use Ohm's Law (V = IR) for resistor drops
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Node Voltage:</strong> Primary law KCL. Best for circuits with fewer nodes
              than loops.
            </li>
            <li>
              <strong>Mesh Current:</strong> Primary law KVL. Best for circuits with fewer loops
              than nodes.
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Distribution Board Analysis">
          <p>
            Kirchhoff's Laws are essential for practical building services calculations. From sizing
            main cables at distribution boards to calculating earth fault loop impedance, these laws
            underpin safe electrical installation design.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Total (no diversity): <strong>148A</strong>
            </li>
        ...
        <ConceptBlock title="Fault Current Paths">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            Earth Loop Calculation (applying KVL)
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>CPC: 0.65 Ω</li>
            <li>
              Total Zs: <strong>1.40 Ω</strong>
            </li>
            <li>
              Fault current: If = 230 / 1.40 = <strong>164A</strong>
            </li>
        ...
        <ConceptBlock title="Parallel Branch Currents and Voltage Drop (KVL)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              By KVL around loop: 230V = V<sub>cable</sub> + V<sub>load</sub>
            </li>
            <li>
              V<sub>cable</sub> = I × R = 13.04 × 0.37 = 4.8V
            </li>
            <li>
              V<sub>load</sub> = 230 - 4.8 = 225.2V
            </li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            ...
            2 socket circuits (18A, 22A), and a 3kW immersion heater. Calculate the main switch
            rating required.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Question:</strong> Three resistors (10 Ω, 20 Ω, 40 Ω) are connected in parallel
            across a 20V supply. Calculate each branch current and the total supply current.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              By KCL at junction: I_total = I1 + I2 + I3 = 2 + 1 + 0.5 = <strong>3.5A</strong>
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p>
            <strong>Question:</strong> A 230V supply feeds three series resistors (15 Ω, 25 Ω, 6 Ω).
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              By KVL around fault loop: Zs = Ze + R1 + R2 = 0.30 + 0.222 + 0.363 ={' '}
              <strong>0.885 Ω</strong>
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Sign errors from inconsistent current direction conventions. Missing components in KVL
              loops (forgetting CPC in fault loops). Applying KCL along wires instead of at
        ...
        <Scenario
          ...
          situation={
            <>
              A three-phase 400 V distribution board feeds three single-phase lighting circuits: L1
              carries 18 A, L2 carries 12 A, L3 carries 22 A — all LED luminaires with switched-mode
              drivers known to inject third-harmonic current. You need to confirm the existing 16
              mm² neutral is adequate.
            </>
          }
          whatToDo={
            <>
              Apply KCL at the neutral node. For balanced linear loads the neutral current would be
              |I_L1 + I_L2 + I_L3| (vectorially) at the phase angles 0°, 120°, 240° — about 8.7 A
              here. But with significant third-harmonic content the triplen harmonics from each
              phase add arithmetically in the neutral, so the harmonic component in the neutral can
              exceed the fundamental phase current. Reference BS 7671 Section 524 and IEC 61000-3-2
              limits, then size the neutral for the worst-case combined fundamental + harmonic
              current. If the existing neutral is undersized, derate the circuit, upgrade to the
              next conductor size or fit harmonic mitigation.
            </>
          }
          whyItMatters={
            <>
              Kirchhoff’s laws are not abstract theory — they are how you spot a neutral that is hot
              to the touch even though every phase MCB is well within rating. Failing to apply KCL
              with harmonic content has caused neutral fires in LED-retrofit office buildings.
            </>
          }
        />
