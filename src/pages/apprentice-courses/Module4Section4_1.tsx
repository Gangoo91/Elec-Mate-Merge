...
const TITLE =
  'Fixing and Supporting Containment Systems - Module 4.4.1 | Level 2 Electrical Course';
const DESCRIPTION =
  'Master fixing and supporting techniques for conduit, trunking, and cable trays. Learn proper spacing, load calculations, and BS 7671 compliance for secure installations.';

const quickCheckQuestions = [
  {
    id: 1,
    question:
      'Why is it essential to follow manufacturer spacing guidelines for containment supports?',
    options: [
      'To save materials',
      'To prevent sagging and maintain load capacity',
      'To make installation faster',
    ],
    correctIndex: 1,
    explanation:
      'Correct spacing prevents sagging, maintains structural integrity, and ensures the containment can safely carry its intended load without failure.',
  },
  {
    id: 2,
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/70 text-sm space-y-1">
                  ...
                  <li>
                    • <strong>Use:</strong> Correct fixings, proper spacing, appropriate tools
                  </li>
                  <li>
                    • <strong>Check:</strong> Level installation, secure fixings, no sagging
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <ul className="text-white/80 space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Identify correct fixings and supports for different containment systems and
                  substrates
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                <span>
                  Apply manufacturer guidelines and BS 7671 spacing requirements effectively
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                <span>
                  Select appropriate fixing methods for various wall, ceiling, and floor materials
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                <span>
                  Install containment systems that are secure, aligned, and load-compliant
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
            ...
            <div className="text-white/80 space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Primary choice:</strong> Wall plugs (brown for masonry, grey for dense
                  block) with corrosion-resistant screws.
                </p>
                <p className="text-sm mb-2">
                  <strong>Load capacity:</strong> 8mm plugs = 25kg, 10mm plugs = 40kg, 12mm plugs =
                  60kg per fixing point.
                </p>
                <p className="text-sm mb-2">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Drop-in anchors:</strong> M8 = 500kg, M10 = 800kg, M12 = 1200kg safe
                  working load.
                </p>
                <p className="text-sm mb-2">
                  <strong>Chemical anchors:</strong> For highest loads and critical applications (up
                  to 2000kg per point).
                </p>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Plasterboard:</strong> Spring toggles (25kg), metal cavity fixings (15kg),
                  or find studs for screw fixing (40kg+).
                </p>
                <p className="text-sm mb-2">
                  <strong>Steel framework:</strong> Self-drilling screws with EPDM washers, M6-M8
                  for light loads, M10-M12 for heavy.
                </p>
                <p className="text-sm">
                  <strong>Timber substrates:</strong> Coach screws minimum 50mm penetration, pilot
                  holes at 80% thread diameter.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-orange-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Damp locations:</strong> Marine-grade stainless steel (316L) or hot-dip
                  galvanised to BS EN ISO 1461.
                </p>
                <p className="text-sm mb-2">
                  <strong>External installations:</strong> A4 stainless steel minimum, with
                  appropriate gaskets and sealing.
                </p>
                <ul className="text-sm ml-4 space-y-1">
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Steel conduit spacing:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
                  <li>
                    • Horizontal runs: 2.5m maximum, 2.0m preferred for professional appearance
                  </li>
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>PVC conduit spacing (more flexible):</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Standard spacing guidelines:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Service detection protocol:</strong>
                </p>
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Accurate marking techniques:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                <p className="font-medium text-white mb-2">
                  Drilling and Fixing Installation Process
                </p>
                <p className="text-sm mb-2">
                  <strong>Drilling best practices:</strong>
                </p>
                <ol className="text-sm ml-4 list-decimal space-y-1">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Quality installation checks:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-orange-500/50">
                <p className="font-medium text-white mb-2">
                  Over-Tightening and Deformation Issues
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
              <div className="text-white/80 space-y-4 text-sm">
                <p>
                  ...
                  installation time. The tray was initially acceptable when empty, but once loaded
                  with the full complement of power and control cables (approximately 45kg per
                  metre), significant sagging occurred.
                </p>
                <p>
                  The sagging caused cables to compress against each other, damaging insulation and
                  creating potential fire risks. During the electrical inspection, the installation
                  failed due to visible deformation and non-compliance with manufacturer
                  specifications.
                </p>
                <p>
                  The rework cost included 3 days additional labour, new support materials, and
                  project delay penalties. The total additional cost was over £8,000 - far exceeding
                  the original £300 saving from reducing support points.
                </p>
                <div className="p-3 rounded bg-white/5 mt-4">
                  <p className="font-medium text-white mb-2">Lesson Learned</p>
                  <ul className="space-y-1">
                    <li>
                      • Always follow manufacturer spacing guidelines - they account for full load
                      conditions
                    </li>
                    <li>
                      • Factor in the complete cable load during support design, not just tray
                      weight
                    </li>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <div className="text-white/80 space-y-3 text-sm">
                <p>
                  ...
                  based on substrate type, load requirements, and environmental conditions ensures
                  reliable performance throughout the installation's life.
                </p>
                <p>
                  Adherence to manufacturer spacing guidelines and BS 7671 requirements prevents
                  sagging, stress concentration, and premature failure. Quality installation
                  techniques, including proper marking, drilling, and torque application, deliver
                  professional results that meet inspection requirements and client expectations.
                </p>
                <p>
                  Understanding common faults and prevention strategies enables proactive quality
                  control, reducing costly remedial work and ensuring first-time compliance with
                  electrical standards and building regulations.
                </p>
              </div>
            </div>
          </section>
