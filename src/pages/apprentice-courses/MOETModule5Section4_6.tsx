...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['1:1', '2:1', '4:1 or better', '10:1 minimum'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'Checking five different instruments',
      'Checking the instrument at 0%, 25%, 50%, 75%, and 100% of range in both ascending and descending directions',
      'Checking five parameters simultaneously',
      'A five-minute quick test',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The instrument drifting over time',
      'A difference in reading at the same input value depending on whether the input is increasing or decreasing',
      'The instrument responding too slowly',
      'The instrument reading fluctuating randomly',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To prove the instrument was purchased legitimately',
      'To document the as-found and as-left readings, reference standards used, environmental conditions, and traceability',
      "To calculate the instrument's remaining lifespan",
      'To authorise the instrument for use in a specific country',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Testing the weight of instruments',
      'Generating precise, known pressures for calibrating pressure instruments',
      'Measuring dead load on structures',
      'Testing valve actuation force',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'A standard thermometer from a hardware shop',
  ...
  },
  {
    ...
    options: [
      ...
      'Exactly once per year for all instruments',
      'Every five years as standard',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Calibrating each component separately',
      ...
      'Calibrating in a circular pattern',
      'Testing the control loop response',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Adjustment is done first, then calibration',
      'Calibration is only done in laboratories',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only if they display incorrect units',
    ],
    correctAnswer: 1,
    explanation:
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Calibration:</strong> Compare instrument against traceable reference
                standard
              </li>
              <li className="pl-1">
                <strong>TUR 4:1:</strong> Reference must be 4x more accurate than instrument
              </li>
              <li className="pl-1">
                <strong>Five-point check:</strong> 0%, 25%, 50%, 75%, 100% up and down
              </li>
              <li className="pl-1">
                <strong>Documentation:</strong> As-found and as-left readings with traceability
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>ISO/IEC 17025:</strong> Laboratory competence standard for calibration
              </li>
              <li className="pl-1">
                <strong>UKAS:</strong> UK accreditation body for calibration laboratories
              </li>
              <li className="pl-1">
                <strong>Drift monitoring:</strong> As-found data enables interval optimisation
              </li>
              <li className="pl-1">
                <strong>Loop calibration:</strong> End-to-end testing of entire measurement chain
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Higher TURs provide greater confidence in the calibration result
                </li>
                <li className="pl-1">
            ...
            <p>
              ...
              made, as-left readings, the pass/fail determination, and the technician's signature.
              This documentation is essential for quality management systems (ISO 9001) and
              regulatory compliance.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Without traceability, a calibration has no demonstrated
              validity. Always verify that your reference standards are within their calibration due
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              across its range:
              <strong> 0%, 25%, 50%, 75%, and 100%</strong>. The input is applied in the ascending
              direction (0% to 100%), then in the descending direction (100% to 0%), recording the
              instrument's output at each point in both directions.
            </p>

            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Three Types of Error Revealed
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Zero error:</strong> An offset that shifts all readings by a constant
                  amount -- corrected by zero adjustment
                </li>
                <li className="pl-1">
                  <strong>Span error:</strong> The sensitivity is incorrect, causing increasing
                  error at higher readings -- corrected by span adjustment
                </li>
                <li className="pl-1">
                  <strong>Linearity error:</strong> The relationship between input and output is not
                  a straight line, with varying error across the range -- requires multi-point
                  characterisation
                </li>
              </ul>
              <p className="text-sm text-white mt-3">
                Comparing ascending and descending readings reveals <strong>hysteresis</strong> --
                the lag between readings at the same input depending on the direction of approach.
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example: 4-20 mA Pressure Transmitter (0-10 bar)
              </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">0.0</td>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Practical tip:</strong> Always allow adequate stabilisation time at each test
              point before recording readings. Rushing introduces errors that may appear as
              linearity problems but are actually measurement artefacts.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  using calibrated weights on a piston. Portable pressure calibrators (e.g. Beamex
                  MC6, Fluke 721) provide digital pressure measurement and generation for field use.
                  Hand pumps generate the test pressure while the calibrator measures and displays
                  the reference value.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  <strong>Dry-block calibrators</strong> provide stable temperatures for sensor
                  testing. <strong>Stirred liquid baths</strong> offer superior uniformity for
                  high-accuracy work. Reference PRTs (Platinum Resistance Thermometers) provide
                  traceable temperature measurement. Millivolt sources can simulate thermocouple
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  signals. <strong>HART communicators</strong>
                  (Emerson 475/Trex) provide digital access to smart transmitters for configuration,
                  calibration, and diagnostics. Documenting calibrators automatically record results
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>ST1426 link:</strong> Maintenance technicians must be competent in using
              calibration equipment appropriate to the instruments they maintain, and must ensure
              all reference standards are within their calibration due dates.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Instrument identification:</strong> Tag number, serial number,
                ...
                <li className="pl-1">
                  <strong>Environmental conditions:</strong> Temperature, humidity during
                  calibration
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Practical tip:</strong> Always record as-found data before making any
              adjustments. This data is the basis for drift trending and calibration interval
              optimisation. Without it, you lose valuable information about the instrument's
              long-term behaviour.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">ISO/IEC 17025</td>
                      <td className="border border-white/10 px-3 py-2">
                        Laboratory competence for calibration and testing
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">ISO 9001 (Clause 7.1.5)</td>
                      <td className="border border-white/10 px-3 py-2">
                        Monitoring and measuring resource requirements
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">UKAS</td>
                      <td className="border border-white/10 px-3 py-2">
                        UK accreditation body for calibration laboratories
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">IEC 60381-1</td>
                      <td className="border border-white/10 px-3 py-2">
                        Analogue signal standard (4-20 mA)
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-white/90 italic">
              <strong>Note:</strong> Calibration of process instruments is a core competency for
              electrical maintenance technicians. The principles covered here provide the foundation
              for the more detailed calibration topics in Section 5.5 (Testing and Calibration of
              Systems).
            </p>
          </div>
        </section>
