      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Type B MCB:</strong> 3-5 × In - resistive loads, domestic
              </li>
              <li className="pl-1">
                <strong>Type C MCB:</strong> 5-10 × In - motors, fluorescent
              </li>
              <li className="pl-1">
                <strong>Type D MCB:</strong> 10-20 × In - high inrush loads
              </li>
              <li className="pl-1">
                <strong>HRC fuses:</strong> Current-limiting, 80kA+ breaking
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Distribution boards:</strong> MCBs for final circuits
              </li>
              <li className="pl-1">
                <strong>Main switchboards:</strong> MCCBs and HRC fuses
              </li>
              <li className="pl-1">
                <strong>Motor starters:</strong> aM fuses or Type D MCBs
              </li>
              <li className="pl-1">
                <strong>HVAC systems:</strong> Type C for fan motors
              </li>
            </ul>
          </div>
        </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Resistive loads, lighting, socket outlets, domestic
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Motors, fluorescent lighting, IT equipment
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Transformers, welding, X-ray, high inrush
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Sets continuous current rating
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Allows downstream discrimination
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                <ol className="text-sm text-white space-y-2 list-decimal list-outside ml-5">
                  <li className="pl-1">
                    <strong>Current rating:</strong> In ≥ Ib and In ≤ Iz (after derating factors)
                  </li>
                  <li className="pl-1">
                    <strong>Breaking capacity:</strong> Icn ≥ Ipf at installation point
                  </li>
                  <li className="pl-1">
                    <strong>Type/characteristics:</strong> Appropriate for load inrush current
                  </li>
                  <li className="pl-1">
                    <strong>Disconnection time:</strong> Zs meets requirements for device type
                  </li>
                  <li className="pl-1">
                    <strong>Discrimination:</strong> Coordinates with upstream/downstream devices
                  </li>
                  <li className="pl-1">
                    <strong>Number of poles:</strong> Appropriate for circuit configuration
                  </li>
                </ol>
              </div>
            </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Low inrush, good Zs sensitivity
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Mixed loads, additional protection
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        High fault level, adjustability
                      </td>
                    </tr>
                    <tr>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: MCCB Settings
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> An MCCB with In = 250A protects a busbar feeding several
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: HRC Fuse vs MCB Selection
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  BS EN 60898: Max 10kA <span className="text-red-400">✗ Inadequate</span>
                </p>
                <p>
                  BS EN 60947-2: Max 25kA <span className="text-yellow-400">⚠ Marginal</span>
                </p>
                <p className="mt-2">
