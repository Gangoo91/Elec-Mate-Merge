...
const quickCheckQuestions = [
  {
    ...
    options: ['2-3 × In', '10-20 × In', '5-10 × In', '3-5 × In'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Socket outlets', 'Domestic lighting', 'Motor circuits', 'IT equipment'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['3-5 × In', '10-20 × In', '5-10 × In', '20-50 × In'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['BS 88', 'BS EN 60898', 'BS EN 60947-2', 'BS 3036'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['100A (5 × In)', '60A (3 × In)', '40A (2 × In)', '200A (10 × In)'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['2:1', '3:1', '1.5:1', 'They cannot discriminate reliably'],
    correctAnswer: 0,
    explanation:
...
const HNCModule4Section3_2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 3 · Subsection 2"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              upstream and downstream devices, and the relevant standard (BS EN 60898 for MCBs, BS
              EN 60947-2 for MCCBs, BS 88 for HRC fuses, BS EN 61009 for RCBOs). Pick the wrong
              device class and either fault clearance or coordination fails — often only discovered
              at first fault.
            </>
          }
        ...
        <ConceptBlock title="Moulded Case Circuit Breakers (MCCBs)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Icu:</strong> ultimate breaking capacity — maximum fault current, may damage
              MCCB
            </li>
            <li>
          ...
          <p>
            <strong>Design note:</strong> For critical applications, base selection on Ics not Icu
            to ensure the MCCB remains serviceable after clearing a fault.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="HRC Fuses (BS 88)">
          <p>
            ...
            locations. They provide excellent current-limiting capability and very high breaking
            capacities.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>gG</strong> — general purpose, full-range — cable protection, general circuits
            </li>
            <li>
              <strong>gM</strong> — motor circuit, full-range — motor circuits with overload relay
            </li>
            <li>
          ...
          <p>
            ...
            devices. During a fault, the fuse element melts and an arc forms within the silica sand
            filling. This arc rapidly increases resistance, limiting the fault current before it
            reaches its prospective peak.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Selection Criteria and Time-Current Curves">
          ...
          <p>
            <strong>
              Common applications summary (application / recommended device / reason):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — MCB type selection:</strong> A 3kW three-phase motor (400V, 0.85 pf)
            has a starting current of 6× FLC. Select the appropriate MCB type.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            feeding several final circuits. The cable Iz is 270A and normal load is 180A. Calculate
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Wrong MCB type for load</strong> — Type B may nuisance trip on motor start
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 250&nbsp;A sub-main feeds a workshop DB. Prospective short-circuit current at the
              main switchpanel is 25&nbsp;kA. Discrimination with the 32&nbsp;A Type C MCBs
              downstream is required. The choice is between a 250&nbsp;A MCCB (36&nbsp;kA Icu) with
              adjustable instantaneous trip, or an HRC gG fuse (BS 88-2, 80&nbsp;kA breaking) with a
              250&nbsp;A switch-fuse housing.
            </>
          }
          whatToDo={
            <>
              Both meet PSCC. The MCCB offers adjustable thermal (typically 0.7–1.0 × I_n) and
              instantaneous (typically 5–10 × I_n) settings — great for tuning discrimination and
              easy to reset after a trip. The HRC fuse offers stronger current-limiting (let-through
              I²t much lower for the downstream cable adiabatic check), narrower let-through energy
              band, and discriminates with downstream MCBs more reliably. For a workshop with
              frequent fault risk and competent maintenance, the MCCB is often preferred for
              resettability. For a cleaner discrimination story and cheaper plant, the HRC fuse
              wins. Document the selection and the discrimination analysis on the cable schedule per
              Reg 432.1.
            </>
          }
          whyItMatters={
            <>
              Reg 432.1 makes the device-type decision a design choice. Pick the wrong device class
              and either the fault clearance trips the upstream as well (loss of discrimination) or
              fails to clear within disconnection time. Both are defendable design failures.
            </>
          }
        />
