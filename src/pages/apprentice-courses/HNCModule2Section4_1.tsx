...
const quickCheckQuestions = [
  {
    ...
    options: ['800-1200nm', '100-400nm', '1000-2000nm', '380-780nm'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['2700K', '5000K', '4000K', '6500K'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Chromatic vision', 'Photopic vision', 'Scotopic vision', 'Mesopic vision'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['4000K', '2700K', '8000K', '5500-6500K'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['0.01 cd/m²', '3 cd/m²', '10 cd/m²', '0.001 cd/m²'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Warm white', 'Very warm', 'Daylight', 'Cool white/neutral'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['CRI 70', 'CRI 80', 'CRI 95+', 'CRI 90'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['450nm (blue)', '507nm (blue-green)', '630nm (red)', '555nm (yellow-green)'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The CIBSE/SLL Lighting Guides translate visual-perception theory into the hard numbers
              you cite on the lighting schedule. As HNC engineer you reference LG7 (offices) when
              defending a 500 lux maintained design, LG5 in classrooms and LG2 in clinical spaces.
            </>
          }
        ...
        >
          <p>
            Colour temperature and colour rendering are two distinct but related properties of light
            sources. Both significantly impact visual comfort, task performance, and the appearance
          ...
          <p>
            ...
            emitted by an ideal black body radiator heated to that temperature. Lower values appear
            warm (yellow/orange), higher values appear cool (blue/white).
          </p>
          <p>
          ...
          <p>
            <strong>Kruithof curve:</strong> Research suggests pleasing combinations of light level
            and colour temperature - warm light suits lower levels, cool light suits higher levels.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The human visual system operates in three distinct modes depending on the ambient light
            level. Understanding these modes is essential for designing lighting for different
            environments, particularly external and emergency lighting where light levels may be
            low.
          </p>
          <p>
          ...
          <p>
            <strong>S/P Ratio (Scotopic/Photopic):</strong> The S/P ratio indicates how effective a
            light source is under mesopic conditions relative to photopic lumens. Light sources with
            higher blue content have higher S/P ratios and can appear brighter in peripheral vision
            at low light levels.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            ...
            mesopic lumens rather than just photopic lumens, particularly for road and area lighting
            where peripheral detection is important.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            requires lighting. The design brief specifies a professional, productive atmosphere with
            good daylight integration. What colour temperature should be specified?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>This balances warmth with alertness and blends well with daylight (5500-6500K).</li>
          </ul>
          <p>
            <strong>Example 2: CRI Specification.</strong> A fashion retailer requires lighting for
            clothing displays. What CRI should be specified and why?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              R9 (saturated red) is particularly important for skin tones and warm fabric colours.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              A 4000K LED (S/P ~1.4) will provide better peripheral visibility than 2700K (S/P ~1.1)
              at the same photopic lux level.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A 1990s open-plan office (1,800 m²) is being relit as part of a Cat-A refurb. The
              client wants higher comfort, stronger sustainability story and better
              video-conferencing colour. The existing 4000 K, CRI 80 T8 fluorescent scheme is being
              replaced.
            </>
          }
          whatToDo={
            <>
              Specify 4000 K neutral white as the primary CCT to balance daylight integration and
              visual comfort. Lift CRI to Ra ≥ 90 (TM-30 Rf ≥ 88, Rg ≥ 95) to handle skin tones on
              Teams/Zoom calls. Verify maintained illuminance against LG7 (500 lux task, 300 lux
              background, U₀ ≥ 0.6) and UGR ≤ 19 with the manufacturer&rsquo;s photometric file.
              Document on the lighting schedule with CIBSE LG7 reference.
            </>
          }
          whyItMatters={
            <>
              CCT and CRI are not aesthetic preferences — they drive visual fatigue, wellbeing
              scores in WELL/BREEAM, and how staff appear on camera. Getting them wrong forces a
              costly relamp 18 months in. The CIBSE LG-cited specification is auditable and
              defendable.
            </>
          }
        />
