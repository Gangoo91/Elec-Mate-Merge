      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="flex flex-col-reverse sm:flex-row justify-between gap-3">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/apprentice/level2/module3/section3/3-4">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous: Tool Inspection
            </Link>
          </Button>
          <Button className="min-h-[44px] touch-manipulation active:scale-[0.98]" asChild>
            <Link to="/study-centre/apprentice/level2/module3/section3/3-6">
              Next: PPE Associated with Tool Use
