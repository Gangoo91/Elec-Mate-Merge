        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              ...
              <li className="pl-1">
                <strong>Classes:</strong> A (solids), B (liquids), C (gases), D (metals), F (cooking
                oils)
              </li>
              <li className="pl-1">
                <strong>Electrical fires:</strong> Isolate first, CO2 or dry powder only
              </li>
              <li className="pl-1">
                <strong>Standards:</strong> BS 5839, RRFSO 2005, BS EN 3
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Common causes:</strong> Overloaded circuits, loose connections, arcing
              </li>
              <li className="pl-1">
                <strong>Detection:</strong> Smoke, heat, flame and aspirating detectors
              </li>
              <li className="pl-1">
                <strong>Alarm categories:</strong> L1-L5 (life), P1-P2 (property)
              </li>
              <li className="pl-1">
                <strong>ST1426:</strong> Maps to fire safety awareness KSBs
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Heat (ignition source):</strong> Electrical arcing, overheated
                  connections, sparks from grinding, hot surfaces, naked flames. In electrical work,
                  heat is most commonly generated by high-resistance joints, overloaded conductors
                  and arcing faults
                </li>
                <li className="pl-1">
                  <strong>Fuel (combustible material):</strong> Cable insulation (PVC, XLPE, LSF),
                  wooden trunking, cardboard packaging, dust accumulation, flammable liquids used
                  for cleaning, building materials. Switchrooms often contain significant quantities
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  CO2 Extinguishers — The Electrician's Choice
                </h3>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">Safe on live electrical equipment up to 1000 V</li>
                  <li className="pl-1">
                    Leaves no residue — important for protecting sensitive equipment
                  </li>
                  <li className="pl-1">
                    Horn becomes extremely cold during discharge — never hold it
                  </li>
                  <li className="pl-1">
                    Rapid dissipation — fire may re-ignite if heat source not removed
                  </li>
                  <li className="pl-1">Not effective outdoors due to wind dispersal</li>
                  <li className="pl-1">
                    Risk of asphyxiation in confined spaces — use with caution
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    Reduces visibility — can cause disorientation in enclosed spaces
                  </li>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Step 3:</strong> Only if the fire is small and you are trained, use a CO2
                  or dry powder extinguisher
                </li>
                <li className="pl-1">
                  <strong>Step 4:</strong> If the fire cannot be controlled, evacuate immediately
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Heat detector:</strong> Activates when temperature reaches a fixed
                  threshold (typically 57°C or 90°C) or when temperature rises rapidly (rate of
                  rise). Less prone to false alarms than smoke detectors. Used in kitchens, garages,
                  boiler rooms and dusty environments
                </li>
                <li className="pl-1">
                  <strong>Multi-sensor detector:</strong> Combines optical smoke and heat detection
                  in a single unit. Uses algorithms to reduce false alarms while maintaining
                  sensitivity. Increasingly common in modern installations
                </li>
                <li className="pl-1">
                  <strong>Flame detector:</strong> Detects infrared (IR) or ultraviolet (UV)
                  radiation from flames. Used in high-ceiling areas, outdoor installations and
                  petrochemical facilities where smoke detection is impractical
                </li>
                <li className="pl-1">
                  <strong>Aspirating smoke detection (ASD):</strong> Continuously draws air samples
                  through a pipe network to a central laser-based detector. Extremely sensitive —
                  can detect smoke at pre-combustion stage. Used in server rooms, switchrooms, data
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Detection throughout the entire building including roof voids and floor
                        voids
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-2">
                In addition to automatic detection, all fire alarm systems include manual call
                points (MCPs) — the familiar red "break glass" units. BS 5839-1 requires MCPs to be
                installed on every storey at every exit point leading to a place of safety, at a
                height of 1.4 m from floor level. They must be clearly visible and accessible, with
                a maximum travel distance of 45 m from any point in the building to the nearest MCP.
              </p>
              <p className="text-sm text-white">
                An M-category system consists of manual call points only, with no automatic
                detection. This is the minimum standard for most non-domestic premises but may not
                be sufficient for buildings with sleeping risk or unattended operation.
              </p>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    Compartments limit fire spread, giving occupants time to evacuate
                  </li>
                  <li className="pl-1">
                    Typical compartment walls provide 30, 60 or 120 minutes fire resistance
                  </li>
                  <li className="pl-1">
                    Any penetration through a compartment wall or floor must be fire-stopped
                  </li>
                  <li className="pl-1">
                    Cable penetrations are a major source of compartment breach — always fire-stop
                  </li>
                  <li className="pl-1">
                    Fire stopping must match the fire resistance period of the wall or floor
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    Must have intumescent strips (expand in heat to seal gaps)
                  </li>
                  <li className="pl-1">
                    Cold smoke seals prevent smoke spread at ambient temperature
                  </li>
                  <li className="pl-1">
                    Must be self-closing — never wedge open unless held by automatic release
                  </li>
                  <li className="pl-1">
                    Electromagnetic holders release doors on fire alarm activation
                  </li>
                  <li className="pl-1">
                    Regular inspection: check strips, seals, closers, gaps (max 3 mm)
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                Every building must have adequate means of escape — safe routes from any point in
                the building to a place of safety outside. Approved Document B of the Building
                Regulations sets out the requirements for means of escape, including maximum travel
                distances, minimum corridor and stairway widths, and the number of exits required.
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Travel distances:</strong> Maximum distance from any point to the nearest
                  exit varies by building type — typically 18 m in one direction, 45 m if
                ...
                <li className="pl-1">
                  <strong>Exit signage:</strong> Illuminated or photoluminescent exit signs to BS
                  ISO 7010 / BS 5499 at every exit and change of direction
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Overloaded circuits:</strong> When conductors carry more current than
                  their rated capacity, they overheat. The insulation degrades, softens and
                  eventually ignites. Overloading is often caused by adding loads without upgrading
                  the circuit, daisy-chaining extension leads, or bypassing protective devices
                </li>
                <li className="pl-1">
                  <strong>Loose connections:</strong> A loose terminal or crimped connection creates
                  a high-resistance joint. The power dissipated at the joint (P = I²R) generates
                ...
                <li className="pl-1">
                  ...
                  surrounding materials. Arc fault detection devices (AFDDs) are now recommended in
                  BS 7671 for certain locations
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  higher than the cable's current-carrying capacity, it will not disconnect the
                  supply before the cable overheats. Using 30 A fuse wire in a 5 A circuit is a
                  classic example
                </li>
                <li className="pl-1">
                  <strong>Faulty equipment:</strong> Poorly maintained equipment with worn bearings,
                  blocked ventilation or internal faults can overheat and ignite. Regular PAT
                  testing and maintenance programmes reduce this risk
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                Preventive Measures for Maintenance Technicians
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Thermal imaging:</strong> Use infrared thermography during maintenance to
                  identify hot spots at connections, busbars and cable joints before they become
                  fire hazards. This is increasingly standard practice during periodic inspection
                </li>
                <li className="pl-1">
                  <strong>Torque tightening:</strong> Use a torque screwdriver to tighten terminals
                  to the manufacturer's specified torque. BS 7671 Regulation 526.2 requires
                  connections to be mechanically and electrically sound
                </li>
                <li className="pl-1">
                  <strong>Visual inspection:</strong> Look for signs of overheating — discolouration
                  of conductors, melted insulation, burning smells, brown marks on enclosures.
                  Report and rectify immediately
                </li>
                <li className="pl-1">
                  <strong>Correct cable selection:</strong> Ensure cables are rated for the
                  installed conditions — ambient temperature, grouping, thermal insulation,
                  installation method (Appendix 4 of BS 7671)
                </li>
                <li className="pl-1">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  During a periodic inspection of a distribution board, a maintenance technician
                  used thermal imaging to identify a connection running at 85°C — well above the
                  normal operating temperature. Investigation revealed a loose busbar connection
                  that had been gradually degrading for months. If left unchecked, this would likely
                  have resulted in a fire. The connection was re-torqued and the board returned to
                  service safely.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  BS 7671:2018+A2:2022 includes specific requirements related to fire prevention:
                  Regulation 421 covers protection against fire caused by electrical equipment;
                  Regulation 422 addresses precautions where particular risks of fire exist; and
                  Section 527 covers measures to minimise the spread of fire through wiring systems
                  (fire barriers, fire stopping, selection of cable types).
                </p>
              </div>
            </div>
