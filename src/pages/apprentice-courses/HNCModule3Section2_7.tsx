...
const quickCheckQuestions = [
  {
    ...
    options: ['1-2 times FLC', '6-8 times FLC', '3-4 times FLC', '10-12 times FLC'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['2nd, 4th, 6th', '3rd, 9th, 15th', 'All even harmonics', '5th, 7th, 11th, 13th'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['15.4A', '10.8A', '12.7A', '18.1A'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['0.95 lagging', '0.95 leading', '0.5-0.6 lagging', 'Unity'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['2.4 kVAr', '7.4 kVAr', '3.2 kVAr', '5.0 kVAr'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['20.2 kW', '27.2 kW', '25.0 kW', '23.9 kW'],
    correctAnswer: 3,
    explanation:
...
const HNCModule3Section2_7 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 2 · Subsection 7"
        title="Applications in Lighting, HVAC and Motors"
        backTo="/study-centre/apprentice/h-n-c-module3-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Practical application of reactive component principles in building services equipment and
          systems
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Building services HVAC motors above 0.75 kW must meet IE3 minimum (or IE2 if fed from
              a VFD) under the EU MEPS regulation — still in force in UK building services specs.
              Pick efficiency class against the load profile, because IE3/IE4 motors run cooler,
              draw less line current, have better PF and recover their cost premium quickly on
              annual energy bills.
            </>
          }
        ...
        <ConceptBlock title="Motor Circuits and Starting Current">
          <p>
            ...
            compressors and lifts. Understanding their electrical characteristics - particularly the
            high starting current and variable power factor - is essential for correct circuit
            design.
          </p>
          ...
          <p>
            ...
            stationary (slip = 1) and rotor impedance is at minimum. As the motor accelerates, slip
            decreases and current falls to the running value.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Direct-on-line (DOL):</strong> Starting current 6-8 × FLC, starting torque
              100% — Small motors up to ~7.5kW
            </li>
            <li>
              <strong>Star-delta:</strong> Starting current 2-3 × FLC, starting torque 33% — Fans,
              pumps (low starting torque)
            </li>
            <li>
              <strong>Soft starter:</strong> Starting current 2-4 × FLC, adjustable torque — Pumps,
              conveyors
            </li>
            <li>
              <strong>VSD (variable speed):</strong> Starting current 1-1.5 × FLC, 150%+ torque
              possible — Variable speed applications
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>100% (Full load):</strong> Power factor 0.85 - 0.90, efficiency 90 - 95%
            </li>
            <li>
              <strong>75%:</strong> Power factor 0.80 - 0.85, efficiency 89 - 94%
            </li>
            <li>
              <strong>50%:</strong> Power factor 0.70 - 0.75, efficiency 85 - 90%
            </li>
            <li>
              <strong>25%:</strong> Power factor 0.45 - 0.55, efficiency 75 - 82%
            </li>
          </ul>
        ...
        <ConceptBlock title="Induction Motor Equivalent Circuit and Slip">
          <p>
            ...
            Understanding slip is fundamental to this analysis and explains why motor
            characteristics change with load.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">Slip Definition</p>
          <p>
            s = (N<sub>s</sub> - N<sub>r</sub>) / N<sub>s</sub> — Where Ns = synchronous speed, Nr =
            rotor speed
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2 poles:</strong> Synchronous 3000 rpm, running 2850-2950 rpm — Fans, small
              pumps
            </li>
            <li>
              <strong>4 poles:</strong> Synchronous 1500 rpm, running 1420-1480 rpm — Most HVAC
              applications
            </li>
            <li>
              <strong>6 poles:</strong> Synchronous 1000 rpm, running 950-980 rpm — Large fans,
              cooling towers
            </li>
            <li>
              <strong>8 poles:</strong> Synchronous 750 rpm, running 710-740 rpm — Low-speed
              applications
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Equivalent Circuit Components</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Key Insight: R₂/s Variation</p>
          <p>
            At standstill (s = 1), R₂/s = R₂, giving minimum impedance and maximum current. As the
            motor accelerates and slip decreases (say s = 0.04), R₂/s = 25R₂, representing the
            mechanical load being driven. This is why current drops as the motor reaches running
            speed.
          </p>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Lighting Ballasts and LED Driver Circuits">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Magnetic vs Electronic Ballasts</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Operating frequency:</strong> Magnetic 50 Hz (mains) — Electronic 25-40 kHz
            </li>
            <li>
              <strong>Power factor (uncorrected):</strong> Magnetic 0.5 lagging — Electronic 0.95+
              (with PFC)
            </li>
            <li>
              <strong>Flicker:</strong> Magnetic 100 Hz visible flicker — Electronic none
              (imperceptible)
            </li>
            <li>
            ...
            <li>
              <strong>Dimming capability:</strong> Magnetic limited — Electronic excellent (DALI,
              1-10V)
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">LED Driver Power Quality</p>
          <p>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">EN 61000-3-2 Harmonic Limits</p>
          <p>
        ...
        <ConceptBlock title="HVAC Equipment, VSDs and Cable Sizing">
          <p>
            ...
            with fans, pumps and chillers accounting for 40-60% of total consumption. Variable speed
            drives offer major energy savings but introduce harmonic considerations.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
            The Affinity Laws (Fan and Pump Laws)
          </p>
          <p>
            These fundamental relationships govern centrifugal fans and pumps, making them ideal for
            variable speed control.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Q ∝ N:</strong> Flow proportional to speed
            </li>
            <li>
              <strong>H ∝ N²:</strong> Head proportional to speed²
            </li>
            <li>
              <strong>P ∝ N³:</strong> Power proportional to speed³
            </li>
          </ul>
          <p>Example: Reducing fan speed by 20% reduces power consumption by 1 - 0.8³ = 49%</p>
          <p className="text-sm font-medium text-elec-yellow/80">Variable Speed Drive Harmonics</p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>5th (250 Hz):</strong> 25-40% of fundamental — Negative sequence, motor
              heating
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Harmonic Mitigation Methods</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Transformer Considerations</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>K-factor rating:</strong> Required for non-linear loads (K-13 typical for VSD
              loads)
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Cable Sizing for Motor Circuits</p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A 15kW, 400V three-phase motor has efficiency 91% and power
            factor 0.87 at full load. Calculate the full load current and expected DOL starting
            current.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Question:</strong> A supply fan with 11kW motor normally runs at full speed. If
            a VSD reduces speed to 75% for 60% of operating hours, calculate annual energy savings.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Question:</strong> A lighting installation has 100 LED fittings, each with a 45W
            driver. Compare the supply current with drivers having (a) pf = 0.55 and (b) pf = 0.95.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Good PFC reduces current by 42%, enabling smaller cables and potentially fewer
              circuits
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p>
            <strong>Question:</strong> A 4-pole induction motor operates on 50Hz supply with 3.5%
            slip at full load. Calculate the synchronous speed and actual running speed.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Motor Circuit Design Checklist</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Using output power as input (forgetting efficiency). Ignoring starting current when
              selecting protection. Specifying poor LED drivers leading to excessive current and
              harmonics. Forgetting VSD harmonics affect other equipment and protection. Oversizing
              motors causing poor power factor and efficiency. Ignoring transformer inrush which can
          ...
          doInstead={
            <>
              ...
              inrush (Type D MCB or MCCB). Specify LED drivers with PFC ≥0.9 and THD ≤20%. Conduct
              harmonic study for VSD-rich installations. Right-size motors to run at 75-100% load.
              Allow ride-through margin for transformer energisation.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A 22 kW three-phase chiller compressor needs to start on a 1000 kVA supply serving a
              small mixed-use building with sensitive IT load. DOL inrush would be roughly 6 × FLC ≈
              240 A, dipping the supply voltage by 6–7 % — outside the 4 % limit the IT supplier
              insists on for clean operation.
            </>
          }
          whatToDo={
            <>
              Compare the three realistic options. (1) Star-delta: cuts starting current to roughly
              1/3 (≈80 A), but needs the motor to be specifically wound for it and gives a torque
              dip on transition. (2) Soft-starter: smooth thyristor-based ramp, peak typically 3 ×
              FLC, no harmonic content during run. (3) VFD: full speed control, peak start typically
              1 × FLC, also gives part-load energy savings on a chiller, but needs harmonic
              mitigation per IEEE 519. For this compressor and supply, a VFD is the right pick — it
              solves both the starting dip and the part-load efficiency problem, and the harmonic
              mitigation is a known cost line.
            </>
          }
          whyItMatters={
            <>
              Picking the starting method is a direct application of AC theory — starting impedance,
              voltage drop, harmonic content. The wrong choice causes rolling brownouts on adjacent
              loads, premature compressor failure, or both.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Section 3</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
