...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['WiFi only', 'Fibre optic only', 'Power line carrier', 'RS-485 serial connection'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Demand response', 'Absence detection', 'Task tuning', 'Daylight harvesting'],
    correctAnswer: 3,
    explanation:
...
const HNCModule7Section4_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 4 · Subsection 6"
      ...
      <HubBody>
        ...
        <ConceptBlock title="BMS/BEMS Fundamentals">
          ...
          <p>
            <strong>BMS Architecture Layers:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Field level:</strong> Sensors, actuators, luminaires, and local controllers
            </li>
            <li>
            ...
            <li>
              <strong>Enterprise level:</strong> Integration with IT systems, analytics, and cloud
              services
            </li>
          </ul>
          <p>
            <strong>BMS Functions for Lighting</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Monitoring:</strong> Real-time status of all lighting circuits — Visibility of
              building-wide operation
            </li>
            <li>
              <strong>Control:</strong> Remote on/off and dimming commands — Centralised management
              without site visits
            </li>
            <li>
              <strong>Scheduling:</strong> Time-based automatic operation — Consistent operation,
              energy savings
            </li>
            <li>
              <strong>Alarming:</strong> Notification of faults and failures — Rapid maintenance
              response
            </li>
            <li>
              <strong>Trending:</strong> Historical data logging and analysis — Performance
              optimisation, M&amp;V
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Communication Protocols">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Data model:</strong> Objects &amp; properties — Registers &amp; coils —
              Datapoints &amp; groups
            </li>
            <li>
              <strong>Topology:</strong> Client-server — Master-slave — Peer-to-peer
            </li>
            <li>
              <strong>Discovery:</strong> Automatic (Who-Is) — Manual configuration — ETS software
            </li>
            <li>
              <strong>Complexity:</strong> Medium-high — Low — Medium
            </li>
            <li>
              <strong>Typical use:</strong> Large commercial — Industrial, retrofit — Premium
              residential, commercial
            </li>
          </ul>
          <p>
            <strong>BACnet Object Types for Lighting</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Binary Output (BO):</strong> On/off switching control
            </li>
            <li>
              <strong>Analogue Output (AO):</strong> Dimming level (0-100%)
            </li>
            <li>
              <strong>Binary Input (BI):</strong> Switch/sensor status
            </li>
            <li>
              <strong>Analogue Input (AI):</strong> Light level sensor (lux)
            </li>
            <li>
              <strong>Schedule:</strong> Time-based automation
            </li>
            <li>
              <strong>Notification Class:</strong> Alarm routing
            </li>
          </ul>
          <p>
            <strong>Integration tip:</strong> Protocol gateways (e.g., DALI-BACnet) enable DALI
            lighting systems to communicate with BMS platforms, translating between protocols whilst
        ...
        <ConceptBlock title="Scheduling and Control Strategies">
          ...
          <p>
            <strong>Scheduling Types</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Weekly schedule:</strong> Standard operating hours (e.g., 07:00-19:00 Mon-Fri)
            </li>
            <li>
              <strong>Calendar schedule:</strong> Different profiles for holidays, special events
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1 (Highest):</strong> Life safety — Emergency lighting activation — Until
              reset
            </li>
            <li>
              <strong>2:</strong> Critical override — Security incident response — Manual release
            </li>
            <li>
              <strong>3:</strong> Demand response — Grid signal load reduction — Event duration
            </li>
            <li>
              <strong>4:</strong> BMS operator — Facilities manager override — Timed (e.g., 2 hours)
            </li>
            <li>
              <strong>5:</strong> Local user — Wall switch or app — Timed (e.g., 30 mins)
            </li>
            <li>
              <strong>6 (Lowest):</strong> Schedule — Time-based automation — Continuous
            </li>
          </ul>
          <p>
            <strong>Demand Response Integration</strong>
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Load shedding:</strong> Turn off non-critical lighting (car parks, corridors)
            </li>
            <li>
            ...
            <li>
              <strong>Pre-cooling/heating:</strong> Coordinate with HVAC for thermal mass strategies
            </li>
          </ul>
          <p>
            <strong>Best practice:</strong> Always include timed auto-revert for manual overrides to
            prevent lights being left on indefinitely after occupant intervention.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Energy Monitoring and System Optimisation">
          <p>
            ...
            optimisation. Effective systems combine sub-metering, trending, analytics, and automated
            control adjustments to minimise energy consumption whilst maintaining comfort and
            productivity.
          </p>
          <p>
            <strong>Energy Monitoring Components</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Optimisation Strategies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Daylight harvesting:</strong> Photocell-based dimming to maintain lux target —
              20-40% perimeter zones
            </li>
            <li>
              <strong>Occupancy control:</strong> PIR/ultrasonic detection with timeout — 30-50%
              intermittent spaces
            </li>
            <li>
              <strong>Task tuning:</strong> Reduce maximum output to actual requirement — 10-20%
              over-lit areas
            </li>
            <li>
              <strong>Schedule optimisation:</strong> Align schedules with actual occupancy patterns
              — 10-30% after-hours
            </li>
            <li>
              <strong>Demand limiting:</strong> Cap maximum power during peak periods — Peak demand
              reduction
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lighting Power Density:</strong> W/m² (target &lt; 10 W/m² for offices)
            </li>
            <li>
              <strong>Operating hours:</strong> Actual vs scheduled hours
            </li>
            <li>
              <strong>Occupancy ratio:</strong> Occupied hours / lit hours
            </li>
            <li>
              <strong>Energy per m²:</strong> kWh/m²/year for benchmarking
            </li>
            <li>
              <strong>Demand factor:</strong> Peak demand / connected load
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fault detection:</strong> Automatic identification of stuck dampers, failed
              sensors, or control errors
            </li>
            <li>
              <strong>Performance monitoring:</strong> Track energy consumption against baselines
              and targets
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Specify BMS points for lighting energy monitoring on a floor
            plate.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Incomplete point lists</strong> - Always specify all required points before
                installation
              </li>
              <li>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Smart lighting</div>
          </button>
          <button
