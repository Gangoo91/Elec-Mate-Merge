...
const HNCModule2Section6_3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 6 · Subsection 3"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE AM11 + TM63 frame the design-to-operation workflow. As HNC engineer you cite
              AM11 to justify the simulation tool choice, the input assumptions and the calibration
              approach — and TM63 to commit to post-handover performance verification.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Timestep calculation:</strong> Solves heat balance equations at each timestep
              (typically hourly)
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Suitable for:</strong> Steady-state heating loads; dynamic cooling, energy,
              comfort
            </li>
            <li>
          ...
          <p>
            <strong>Key insight:</strong> Dynamic simulation captures the time lag between when heat
            enters a building and when it affects indoor temperature - critical for understanding
            peak cooling times.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>
              Typical simulation capabilities (capability / description / typical use):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Practical tip:</strong> Always document the weather file used - results are only
            meaningful in the context of the weather data applied.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Analytical:</strong> Compare to known mathematical solutions - software
              testing
            </li>
            <li>
        ...
        >
          ...
          <p>
            <strong>Professional responsibility:</strong> Communicate uncertainty to clients. Don't
            present simulation results with false precision - acknowledge the limitations of the
            analysis.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Example 1 - Zoning decision:</strong> A 2,000m² open-plan office has south and
            north facades. How should it be zoned?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Recommended zoning: south perimeter zone (4-5m depth), north perimeter zone (4-5m
              depth), core zone (remainder)
            </li>
            <li>Minimum 3 zones to capture different thermal conditions</li>
            <li>
              For TM52 assessment, may need finer perimeter zoning to identify worst-case locations
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Report as range: <strong>Design cooling: 150 kW (range 135-175 kW)</strong>
            </li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 14-storey office in Manchester is going to planning. The local plan requires a CIBSE
              TM52 overheating assessment using a 2050s DSY weather file. The architect&rsquo;s
              envelope (50% glazing, g = 0.45) and the proposed mixed-mode HVAC need to be tested.
            </>
          }
          whatToDo={
            <>
              Build a multi-zone dynamic model in IES VE / DesignBuilder / TAS. Set weather to DSY1
              Manchester 2050s. Apply CIBSE Guide A occupancy and gain profiles. Model the
              mixed-mode HVAC: natural ventilation 19–24 °C, mechanical cooling cut-in at 24 °C. Run
              TM52 Criteria A, B, C across worst-case zones (south-west aspect, top floor). Where
              any zone fails two of three criteria, iterate: external shading, lower g-value,
              increased openable area, mechanical cooling extension. Document in the TM52 report.
            </>
          }
          whyItMatters={
            <>
              Manchester planning explicitly requires TM52 evidence for new commercial buildings
              &gt; 1,000 m². A TM52 fail blocks consent. Once consented and built, an
              overheating-prone office becomes a leasing problem within five years as climate warms.
              The dynamic simulation is the design-stage insurance.
            </>
          }
        />
