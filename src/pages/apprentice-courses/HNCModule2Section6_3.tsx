...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Because Building Regulations require it',
      'To match utility billing periods',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Average monthly temperatures only',
      'Peak summer and winter design conditions',
  ...
  },
  {
    ...
    options: [
      ...
      'Building Regulations mandate it',
