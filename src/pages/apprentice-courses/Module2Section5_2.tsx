...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'Twist the conductors together and tape the joint',
      'Solder the two metals directly together',
      'Use bimetallic connectors and follow manufacturer guidance',
      'Use a standard copper-rated terminal block',
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Aluminium has higher resistivity than copper, so a larger CSA is needed for the same current. Silver and gold are actually better conductors than copper.',
  },
  {
    id: 2,
    question: 'Which statement about aluminium terminations is correct?',
    options: [
      'They never loosen once tightened',
      'They use the same terminals as copper',
      'They may require bimetallic lugs and specific torque',
      'They do not need re-torquing in service',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'PVC has a higher temperature rating than XLPE',
      'Both have an identical 70°C rating',
      'XLPE is rated lower than PVC',
  ...
  },
  {
    ...
    options: [
      'Sections 521 and 526',
      'Part 1 only',
      'Inspection forms only',
      'Earthing only',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      'Raise the temperature rating of the cable',
      'Lower the resistivity of the conductor',
      'Reduce smoke and toxic fumes in fire',
      'Increase the cable’s current-carrying capacity',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Solder the two conductors together directly',
      'Twist the conductors and tape the joint',
      'Use a standard copper terminal for both',
  ...
  },
  {
    ...
    options: [
      ...
      'The type of terminal used at each end',
  ...
  },
  {
    ...
    options: [
      'For fixed wiring in a domestic consumer unit',
      'For underground SWA distribution cables',
      'For flexible applications and harsh environments',
      'For high-temperature mineral-insulated runs',
    ],
    correctAnswer: 2,
    explanation:
