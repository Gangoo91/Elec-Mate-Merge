...
const quickCheckQuestions = [
  {
    ...
    options: ['Current quadruples', 'Current doubles', 'Current halves', 'Current stays the same'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Copper wire', 'Heating element', 'Fixed resistor', 'LED'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Doubles', 'Decreases by 50%', 'Stays the same', 'Increases by 50%'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['3.85V', '30.8V', '15.4V', '7.7V'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['I = V/R', 'I = R/V', 'I = VR', 'I = V + R'],
    correctAnswer: 0,
...
const HNCModule3Section1_2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 1 · Subsection 2"
        title="Ohm's Law"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Voltage drop is the headline application of Ohm’s law in BS 7671. Use cable mV/A/m
              tables (or the underlying mO/m × length × 2 calculation) and check against 6.9 V
              (lighting) or 11.5 V (power) at 230 V nominal.
            </>
          }
        ...
        <ConceptBlock title="Ohm's Law Fundamentals">
          ...
          <p>
            Cover what you want to find — the remaining show the formula. V at the top, I and R at
            the bottom: V over (I × R).
          </p>
        ...
        <ConceptBlock title="Ohmic vs Non-Ohmic Devices">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            Ohmic (Linear) Devices — Resistance remains constant:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            Non-Ohmic (Non-Linear) Devices — Resistance varies with conditions:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Application 1: Cable Voltage Drop">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              As percentage of 230V: (8.9/230) × 100 = <strong>3.9%</strong> ✓ Within 5% limit for
              power circuits
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Application 2: Earth Fault Loop Impedance">
          <p>
            Ohm's Law calculates fault current, which determines if protective devices operate fast
            enough.
          </p>
          <p>
            <strong>
        ...
        <ConceptBlock title="Application 3: LED Current Limiting">
          <p>
            LEDs require current-limiting resistors because they are non-ohmic - without limiting,
            current would destroy them.
          </p>
          <p>
            <strong>
          ...
          <p>
            <strong>BMS Application:</strong> Status indicator LEDs on control panels commonly use
            this calculation.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Temperature Effects on Resistance">
          <p>
            Conductor resistance increases with temperature. This is important for cable sizing and
            testing.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
        ...
        <Scenario
          ...
          situation={
            <>
              You have just installed a new 32 A radial circuit in a basement plant room feeding a
              control-panel power supply 28 m from the distribution board on 4 mm² thermoplastic.
              The Zs measured at the furthest socket reads 1.10 Ω. The protective device is a 32 A
              Type B MCB.
            </>
          }
          whatToDo={
            <>
              Apply Ohm’s law to the loop: I_f = U₀ / Z_s = 230 / 1.10 ≈ 209 A. A Type B MCB needs 5
              × I_n = 160 A to disconnect within 0.1 s, so 209 A clears the requirement comfortably.
              Cross-check Z_s against BS 7671 Table 41.3 (or the 80 % rule of thumb on the
              manufacturer’s figure) before signing the certificate. Record the measured value, the
              calculated I_f and the disconnection time on the schedule of test results.
            </>
          }
          whyItMatters={
            <>
              Ohm’s law is the single calculation that decides whether a fault is cleared fast
              enough to be safe. A circuit that meets voltage drop but fails on Z_s is non-compliant
              and unsafe to energise. As the engineer of record, your name is on the certificate —
              the math has to be defendable.
            </>
          }
        />
