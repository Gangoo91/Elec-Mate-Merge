    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Analyse the environmental factors that influence building energy performance and occupant
          comfort
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers solar geometry and gains, internal and external heat sources, thermal
          mass effects, air movement, and thermal comfort assessment - the physical principles that
          underpin energy-efficient building design and HVAC system sizing.
        </p>
