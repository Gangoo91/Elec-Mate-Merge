        ...
        <PageFrame>
          ...
          <ConceptBlock title="Maximum Demand Fundamentals">
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Connected load:</strong> Sum of all equipment ratings - always greater than
                MD
              </li>
              <li>
          ...
          <ConceptBlock title="Diversity Factors by Load Type">
            <p>
              ...
              diversity to be taken into account, but it does not tabulate the allowances — those
              are published in the IET On-Site Guide, Appendix A (current demand and diversity).
              Commercial and industrial applications sit outside that guidance and require
              engineering judgement and industry-specific data.
            </p>
            <p>
              <strong>
          ...
          <ConceptBlock title="DNO Supply Capacity">
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Acceptance:</strong> Contract agreement — Agree terms, pay connection
                charges
              </li>
              <li>
                <strong>Energisation:</strong> Supply connected — Installation complete,
                certificates issued
              </li>
            </ul>
            <p>
          ...
          <ConceptBlock title="Load Growth and Future Expansion">
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Domestic (new build):</strong> 20-30% — EV charging, heat pumps, home
                working
              </li>
              <li>
