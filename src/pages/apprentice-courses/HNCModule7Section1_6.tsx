...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['142.5 kW', '150 kW', '157.9 kW', '158 kW'],
    correctAnswer: 0,
    explanation:
...
const HNCModule7Section1_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 1 · Subsection 6"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Maximum Demand Fundamentals">
          <p>
            ...
            at any point in time. It forms the basis for sizing the incoming supply, main
          ...
          <p>
            <strong>Key maximum demand principles:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Connected load:</strong> Sum of all equipment ratings - always greater than MD
            </li>
            <li>
          ...
          <p>
            <strong>Maximum Demand vs Connected Load</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Domestic dwelling:</strong> 50-80 kW — 8-15 kW — 0.15-0.25
            </li>
            <li>
              <strong>Office building:</strong> Variable — 40-80 VA/m² — 0.4-0.7
            </li>
            <li>
              <strong>Retail premises:</strong> Variable — 50-150 VA/m² — 0.5-0.8
            </li>
            <li>
              <strong>Industrial (process):</strong> Variable — Process dependent — 0.6-0.9
            </li>
          </ul>
          <p>
            <strong>Maximum Demand Formula</strong>
          </p>
          <p>
            <span>Maximum Demand (MD):</span>
          </p>
        ...
        <ConceptBlock title="Diversity Factors by Load Type">
          <p>
            ...
            simultaneously. BS 7671 Reg 311.1 requires maximum demand to be determined and permits
            diversity to be taken into account, but it does not tabulate the allowances — those are
            published in the IET On-Site Guide, Appendix A (current demand and diversity).
            Commercial and industrial applications sit outside that guidance and require engineering
            judgement and industry-specific data.
          </p>
          <p>
            <strong>
              On-Site Guide Appendix A, Table A2 — allowances for diversity (domestic)
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              ...
              total current demand up to 10 A, plus 50% of any current demand in excess of 10 A
            </li>
            <li>
              <strong>Cooking appliances:</strong> 10 A + 30% f.l. of connected cooking appliances
              in excess of 10 A + 5 A if a socket-outlet is incorporated in the control unit
            </li>
            <li>
              <strong>Water heaters (instantaneous):</strong> 100% f.l. of the largest appliance +
              100% f.l. of the second largest + 25% f.l. of the remaining appliances
            </li>
            <li>
              <strong>
                Water heaters (thermostatically controlled), floor warming, thermal storage space
                heating:
              </strong>{' '}
              no diversity allowable
            </li>
            <li>
              <strong>Motors</strong> (other than lift motors): <em>not applicable</em> for
              individual household installations
            </li>
            <li>
              <strong>Standard final circuit arrangements</strong> (to On-Site Guide Appendix H):
              100% of the current demand of the largest circuit + 40% of every other circuit
            </li>
            <li>
              <strong>Socket-outlets and stationary equipment</strong> not covered above: 100% of
              the current demand of the largest point of utilization + 40% of every other point
            </li>
          </ul>
          <p className="text-white">
            Two cautions the On-Site Guide itself gives. Table A2 has not been updated for some time
            and does not necessarily align with modern loads and usages, so the values may be
            increased or decreased as the designer decides — and no guidance is given at all for
            blocks of dwellings, large hotels, or industrial and large commercial premises.
            Separately, distribution boards and consumer units must be rated for the total load
            connected to them
            <em> without</em> any diversity applied.
          </p>
          <p>
            <strong>Commercial/Industrial Diversity</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Multiple Dwellings Diversity</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Commercial Socket Outlet Assessment</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>General office:</strong> 25-35 — Standard office with PCs
            </li>
            <li>
              <strong>Dealing room/IT intensive:</strong> 50-80 — High equipment density
            </li>
            <li>
              <strong>Retail (general):</strong> 15-25 — Shop floor areas
            </li>
            <li>
              <strong>Restaurant/kitchen:</strong> 100-200 — Commercial kitchen equipment
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="DNO Supply Capacity">
          ...
          <p>
            <strong>Standard DNO Supply Options</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single-phase domestic:</strong> 60A, 80A, or 100A (230V)
            </li>
            <li>
              <strong>Three-phase domestic:</strong> 60A or 100A per phase (400V)
            </li>
            <li>
              <strong>Small commercial LV:</strong> Up to 150 kVA (typically)
            </li>
            <li>
              <strong>Larger commercial LV:</strong> Up to 1 MVA (network dependent)
            </li>
            <li>
              <strong>HV supply:</strong> &gt;1 MVA, customer owns HV equipment
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Budget estimate:</strong> Preliminary cost indication — Approximate load,
              location, phasing
            </li>
            <li>
              <strong>Formal application:</strong> Detailed assessment request — Max demand, load
              breakdown, power factor
            </li>
            <li>
              <strong>Connection offer:</strong> DNO quote for supply — Review capacity, costs,
              timescales
            </li>
            <li>
              <strong>Acceptance:</strong> Contract agreement — Agree terms, pay connection charges
            </li>
            <li>
              <strong>Energisation:</strong> Supply connected — Installation complete, certificates
              issued
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Planning tip:</strong> Engage with the DNO early in design. Network constraints
            may require design changes or alternative strategies such as on-site generation or
            demand management.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Load Growth and Future Expansion">
          <p>
            Prudent electrical design considers future load growth to avoid costly upgrades. BS 7671
            recommends allowing for future expansion. The appropriate allowance depends on building
            type, client intentions, and technological trends.
          </p>
          <p>
            <strong>Typical Load Growth Allowances</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Domestic (new build):</strong> 20-30% — EV charging, heat pumps, home working
            </li>
            <li>
              <strong>Office building:</strong> 15-25% — Technology changes, tenant fit-out
            </li>
            <li>
              <strong>Data centre:</strong> 30-50% — Rapid IT growth, cooling demands
            </li>
            <li>
              <strong>Industrial:</strong> 20-30% — Process expansion, automation
            </li>
            <li>
              <strong>Healthcare:</strong> 25-35% — Medical equipment, imaging technology
            </li>
          </ul>
          <p>
            <strong>Emerging Load Considerations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Load Growth Calculation Example</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Current assessed maximum demand:</strong> 200 kVA
            </li>
            <li>
              <strong>Growth allowance (20%):</strong> 40 kVA
            </li>
            <li>
              <strong>Design maximum demand:</strong> 240 kVA
            </li>
            <li>
              <strong>With EV charging (10 × 7 kW):</strong> +70 kVA (with diversity 0.3 = 21 kVA)
            </li>
            <li>
              <strong>Revised design MD:</strong> 261 kVA → specify 300 kVA supply
            </li>
          </ul>
          <p>
            <strong>IET On-Site Guide Appendix A Guidance</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            larger infrastructure at installation is typically much less than retrofitting upgrades
            later.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Calculate maximum demand for a 4-bedroom house with electric
            cooker (12 kW), immersion heater (3 kW), electric shower (9.5 kW), and standard ring
            circuits.
          </p>
          <p>
            Lighting: 100 outlets × 100W = 10 kW × 66% = <span>6.6 kW</span>
          </p>
          ...
          <p>
            Lighting: 12 W/m² × 2,000 m² × 0.9 diversity = <span>21.6 kW</span>
          </p>
          <p>
            Small power: 30 VA/m² × 2,000 m² × 0.5 diversity = <span>30 kVA</span>
          </p>
          ...
          <p>
            Total HVAC: <span>101.3 kW</span>
          </p>
          <p>
            Lifts: 2 × 15 kW × 0.3 (diversity for 2) = <span>9 kW</span>
          </p>
          <p>
            Ancillary (BMS, security, etc.): <span>5 kW</span>
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Calculate maximum demand for a pump room with 3 motors: 22
            kW, 15 kW, and 11 kW.
          </p>
          ...
          <p>
            Total: <span>101A</span>
          </p>
          <p>
            In kVA: 101 × √3 × 400 / 1000 = <span>70 kVA</span>
          </p>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Power quality</div>
          </button>
          <button
