...
const quizQuestions = [
  {
    ...
    options: ['Regulation 5', 'Regulation 4', 'Regulation 8', 'Regulation 12'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Regulation 14', 'Regulation 13', 'Regulation 4', 'Regulation 16'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Regulation 10', 'Regulation 5', 'Regulation 6', 'Regulation 4'],
    correctAnswer: 3,
    explanation:
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              designer/supervisor you cannot rely on a cost-benefit argument for Reg 4(3); the duty
              must be met. This is why &ldquo;safe by design&rdquo; choices in BS 7671 (RCDs, AFDDs,
              SPDs, robust earthing) carry through into your specification every time.
            </>
          }
        ...
        <ConceptBlock title="Key Regulations Overview (Regulations 3-16)">
            ...
            whatHappens={
              <>
                <p className="text-sm text-white">
                  EAWR 1989 is enforced by the Health and Safety Executive (HSE). Breaches can
                  result in unlimited fines for organisations, and individuals can face personal
                  prosecution with penalties including imprisonment. This distinguishes EAWR from BS
                  7671, which is a technical standard without direct legal force.
                </p>
              </>
            }
            doInstead={
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1-3</strong> — Coverage: Interpretation and duties. Key Requirements: Defines
              terms; establishes who has duties
            </li>
            <li>
              <strong>4-5</strong> — Coverage: Systems and equipment. Key Requirements: Construction
              and maintenance; equipment strength
            </li>
            <li>
              <strong>6-9</strong> — Coverage: Protective provisions. Key Requirements: Environment;
              insulation; earthing; integrity
            </li>
            <li>
              <strong>10-12</strong> — Coverage: Protective devices. Key Requirements: Connections;
              excess current; isolation
            </li>
            <li>
              <strong>13-16</strong> — Coverage: Working practices. Key Requirements: Dead working;
              live working; space/access; competence
            </li>
            <li>
              <strong>29</strong> — Coverage: Defence. Key Requirements: Due diligence defence for
        ...
        <ConceptBlock title="Duties on Systems, Equipment and Conductors">
          ...
          <div className="bg-white/5 p-4 rounded-lg">
            <p className="text-sm text-white mb-3">
              <strong>4(1):</strong> All systems shall at all times be of such construction as to
            ...
            <p className="text-sm text-white">
              ...
              equipment. 'Maintained' includes regular inspection, testing, repair and replacement
              as necessary.
            </p>
          </div>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 5 (Strength)</strong> — Building Services Example: Switchgear rated for
              prospective fault current
            </li>
            <li>
              <strong>Reg 6 (Environment)</strong> — Building Services Example: IP-rated equipment
              in plant rooms; ATEX zones
            </li>
            <li>
              <strong>Reg 7 (Insulation)</strong> — Building Services Example: Cable insulation;
              busbars in trunking
            </li>
            <li>
              <strong>Reg 11 (Excess current)</strong> — Building Services Example: MCBs, fuses,
              RCBOs properly coordinated
            </li>
            <li>
              <strong>Reg 12 (Isolation)</strong> — Building Services Example: Local isolators at
              AHUs; emergency stops
            </li>
          </ul>
        ...
        <ConceptBlock title="Work on Live Equipment (Regulation 14)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Critical services:</strong> Where isolation would cause greater risk (e.g.,
              life support)
            </li>
            <li>
              <strong>Functional testing:</strong> Verifying correct operation of protective devices
            </li>
          </ul>
        ...
        <ConceptBlock title="Competence Requirements and Defence of Due Diligence">
          <p>
            ...
            persons undertake electrical work. Regulation 29 provides a defence for duty holders who
          ...
          <div className="grid sm:grid-cols-3 gap-3 text-center text-sm">
            ...
            <p className="text-white text-xs">Practical skills developed through hands-on work</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Simple replacement (lamp, fuse)</strong> — Competence Indicators: Basic
              electrical awareness. Supervision Level: General supervision
            </li>
            <li>
              <strong>Circuit installation</strong> — Competence Indicators: NVQ Level 3 / AM2 or
              equivalent. Supervision Level: Periodic checking
            </li>
            <li>
              <strong>Distribution board work</strong> — Competence Indicators: Qualified
              electrician with relevant experience. Supervision Level: Self-supervising
            </li>
            <li>
              <strong>HV switchgear</strong> — Competence Indicators: HV authorisation; specific
              equipment training. Supervision Level: Authorised person system
            </li>
          </ul>
          ...
          <div className="my-6 p-4 rounded-lg bg-green-500/10 border border-green-500/30">
            ...
            <p className="text-sm text-white mb-3">
              In criminal proceedings, it is a defence to prove that all reasonable steps were taken
              and all due diligence was exercised to avoid committing the offence.
            </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Proactive management:</strong> Systematic approach to electrical safety, not
              reactive
            </li>
            <li>
              <strong>Competent advice:</strong> Using qualified persons for design, installation
              and inspection
            </li>
            <li>
              <strong>Regular inspection:</strong> EICR at appropriate intervals (typically 5 years
              commercial)
            </li>
            <li>
              <strong>Prompt remediation:</strong> Acting on defects identified during inspections
            </li>
            <li>
              <strong>Record keeping:</strong> Comprehensive documentation of all safety measures
            </li>
          </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            does not apply - these regulations do not include 'so far as is reasonably practicable'.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Services Applications">
          <p>
            <strong>Application 1: Commercial Office Building</strong>
          </p>
          <p className="text-sm text-white mb-2">
          ...
          <p>
            <strong>Application 2: Industrial Facility</strong>
          </p>
          <p className="text-sm text-white mb-2">
          ...
          <p>
            <strong>Application 3: Healthcare Facility</strong>
          </p>
          <p className="text-sm text-white mb-2">
        ...
        <ConceptBlock title="Practical Guidance">
          <div>
            <p>
              <strong>Key Regulations Summary</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
          ...
          <div>
            <p>
              <strong>Common Non-Compliances</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You are commissioning a new sub-circuit on a 24/7 data centre distribution board. Full
              isolation would require a planned shutdown the client refuses to fund. Live testing is
              being requested for IR and load checks.
            </>
          }
          whatToDo={
            <>
              Apply Reg 14 in writing: prove (a) that making dead is unreasonable (production loss
              case), (b) that live working is reasonable (small scope, tested operatives, Class II
              tools), and (c) that precautions are suitable (CAT IV instruments, GS38 leads, mats,
              two-person rule, defined exclusion zone, permit-to-work). Issue the permit only if all
              three are documented and signed by the responsible engineer.
            </>
          }
          whyItMatters={
            <>
              EAWR 1989 carries unlimited fines and personal prosecution. The HSE will request the
              Reg 14 documentation as the first piece of evidence after any incident — if you cannot
              produce it, the breach is presumed.
            </>
          }
        />
