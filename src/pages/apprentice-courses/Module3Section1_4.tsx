...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'A type of cable stripper',
      'A curved earthing washer',
      'A bending tool',
      'A weatherproof seal',
    ],
    correctIndex: 1,
    explanation:
      'A banjo is a curved earthing washer that ensures good electrical contact between the gland and the enclosure.',
  },
  {
    id: 'swa-glands',
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The steel wire armour provides mechanical protection against physical damage, impacts, and crushing forces.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "False. SWA can be used indoors where mechanical protection is needed, though it's heavier than standard cables.",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Glands earth the armour and provide IP-rated sealing against moisture and dust ingress.',
  },
  {
    id: 6,
...
const Module3Section1_4: React.FC = () => {
  ...
  const faqs = [
    {
      q: 'Can SWA cable be used indoors?',
      a: 'Yes, although it is heavier than standard cables and often over-specified unless mechanical protection is needed.',
    },
    {
      q: 'Can the armour act as the only earth conductor?',
      a: 'In many cases, yes — if the cable design and regulations permit — but a separate CPC may be required in some installations.',
    },
    {
      q: "What's the difference between PVC and LSZH SWA?",
      a: 'LSZH (Low Smoke Zero Halogen) reduces toxic smoke emissions in a fire, making it safer for enclosed public spaces.',
    },
    {
      q: 'How do you calculate the correct gland size for SWA?',
      a: "Match the gland size to the cable's outer diameter and ensure it's rated for the environmental conditions (IP rating).",
    },
  ];
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm text-white/80">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li>
                    Multicore cable with steel wire armour providing exceptional mechanical
                    protection.
                  </li>
                  <li>
                    Suitable for direct burial and exposed runs where standard cables would be
                    damaged.
                  </li>
                  <li>
                    Armour can serve as earth conductor when properly terminated with appropriate
                    glands.
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li>
                    <strong>Spot:</strong> Black outer sheath with visible steel wire armour
                    underneath when stripped.
                  </li>
                  <li>
                    <strong>Use:</strong> Underground supplies, industrial environments, car parks,
                    external installations.
                  </li>
                  <li>
                    <strong>Check:</strong> Gland termination, armour earthing, burial depth,
                    warning tape above.
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4 text-sm text-white/80">
              ...
              <div className="p-4 rounded-lg bg-card/50 border border-white/10">
                <p className="font-medium text-white mb-2">Core Construction (Inside to Outside)</p>
                <ol className="list-decimal pl-4 space-y-1">
                  <li>
                    <strong>Conductor:</strong> Stranded copper (or aluminium in larger sizes) for
                    flexibility and current carrying
                  </li>
                  <li>
                    <strong>Insulation:</strong> Cross-linked polyethylene (XLPE) or PVC depending
                    on specification and operating temperature
                  </li>
                  <li>
                    <strong>Bedding:</strong> Protective layer between insulation and armour to
                    prevent mechanical damage during installation
                  </li>
                  <li>
                    <strong>Armour:</strong> Galvanised steel wires wound around the cable core
                    providing mechanical protection
                  </li>
                  <li>
                    <strong>Sheath:</strong> Outer PVC or LSZH jacket for environmental protection
                    and identification
                  </li>
                </ol>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-green-500/10 border border-green-400/30">
                  <p className="font-medium text-white mb-2">Standard SWA Types</p>
                  <ul className="list-disc pl-4 space-y-1">
                    <li>
                      <strong>2-core:</strong> Live and neutral (plus armour earth)
                    </li>
                    <li>
                      <strong>3-core:</strong> Live, neutral, earth (plus armour earth)
                    </li>
                    <li>
                      <strong>4-core:</strong> 3-phase and neutral (plus armour earth)
                    </li>
                    <li>
                      <strong>5-core:</strong> 3-phase, neutral, earth (plus armour earth)
                    </li>
                    <li>
                      <strong>Multicore:</strong> Control and instrumentation cables
                    </li>
                  </ul>
                </div>
                <div className="p-4 rounded-lg bg-card/50 border border-white/10">
                  <p className="font-medium text-white mb-2">Sheath Options</p>
                  <ul className="list-disc pl-4 space-y-1">
                    <li>
                      <strong>PVC:</strong> Standard black sheath for general use
                    </li>
                    <li>
                      <strong>LSZH:</strong> Low smoke zero halogen for public buildings
                    </li>
                    <li>
                      <strong>UV Stabilised:</strong> For extended outdoor exposure
                    </li>
                    <li>
                      <strong>Oil Resistant:</strong> For industrial environments
                    </li>
                    <li>
                      <strong>Flame Retardant:</strong> Enhanced fire performance
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="space-y-4 text-sm text-white/80">
              ...
              <div className="p-4 rounded-lg bg-card/50 border border-white/10">
                ...
                <div className="grid md:grid-cols-2 gap-4 mt-3">
                  <ul className="list-disc pl-4 space-y-1">
                    <li>
                      <strong>Underground supplies:</strong> Garden buildings, street lighting, car
                      parks
                    </li>
                    <li>
                      <strong>Industrial sites:</strong> Factories, workshops, agricultural
                      buildings
                    </li>
                    <li>
                      <strong>Commercial projects:</strong> Shopping centres, office blocks,
                      hospitals
                    </li>
                    <li>
                      <strong>Infrastructure:</strong> Transport hubs, utilities, outdoor
                      installations
                    </li>
                  </ul>
                  <ul className="list-disc pl-4 space-y-1">
                    <li>
                      <strong>Marine environments:</strong> Coastal installations, offshore
                      platforms
                    </li>
                    <li>
                      <strong>Mining operations:</strong> Quarries, extraction sites, processing
                      plants
                    </li>
                    <li>
                      <strong>Sports facilities:</strong> Floodlighting, scoreboards, external power
                    </li>
                    <li>
                      <strong>Emergency services:</strong> Fire stations, ambulance depots, police
                      facilities
                    </li>
                  </ul>
                </div>
            ...
            <div className="space-y-4 text-sm text-white/80">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-card/50 border border-white/10">
                  ...
                  <ul className="list-disc pl-4 space-y-1">
                    <li>
                      <strong>Depth:</strong> 600mm minimum in gardens, 750mm in driveways/roads
                    </li>
                    <li>
                      <strong>Bedding:</strong> 100mm sand bed below cable
                    </li>
                    <li>
                      <strong>Protection:</strong> 100mm sand cover above cable
                    </li>
                    <li>
                      <strong>Warning tape:</strong> 150mm above cable at 300mm depth
                    </li>
                    <li>
                      <strong>Route marking:</strong> Record positions for future reference
                    </li>
                  </ul>
                </div>
                <div className="p-4 rounded-lg bg-card/50 border border-white/10">
                  <p className="font-medium text-white mb-2">Above Ground Installation</p>
                  <ul className="list-disc pl-4 space-y-1">
                    <li>
                      <strong>Support spacing:</strong> Every 300-600mm depending on cable size
                    </li>
                    <li>
                      <strong>Clips:</strong> Trefoil cleats for larger cables, saddle clips for
                      smaller
                    </li>
                    <li>
                      <strong>Bend radius:</strong> Minimum 6x cable diameter (8x for larger cables)
                    </li>
                    <li>
                      <strong>UV protection:</strong> Use UV-stabilised cable or additional
                      protection
                    </li>
                    <li>
                      <strong>Expansion:</strong> Allow for thermal movement on long runs
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="space-y-4 text-sm text-white/80">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    <p className="font-medium text-white mb-2">Cutting & Stripping</p>
                    <ul className="list-disc pl-4 space-y-1">
                  ...
                  <div>
                    <p className="font-medium text-white mb-2">Termination</p>
                    <ul className="list-disc pl-4 space-y-1">
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-4 space-y-1">
                      <li>Bulldog benders (25mm2 and above)</li>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-card/50 border border-white/10">
                  <p className="font-medium text-white mb-3">SWA Cable Stripping Process</p>
                  <ol className="list-decimal pl-4 space-y-2">
                    <li>
                      <strong>Mark cutting positions:</strong> Measure 50-75mm for sheath removal,
                      25-40mm for armour (depending on gland size)
                    </li>
                    <li>
                      <strong>Score outer sheath:</strong> Use cable knife to score circumference -
                      cut just through PVC/LSZH, not into armour
                    </li>
                    <li>
                      <strong>Remove outer sheath:</strong> Peel back and cut off to expose steel
                      armour wires
                    </li>
                    <li>
                      <strong>Cut armour wires:</strong> Use hacksaw to cut cleanly around armour -
                      ensure square cut without damaging bedding
                    </li>
                    <li>
                      <strong>Remove bedding:</strong> Carefully strip bedding material to expose
                      individual insulated conductors
                    </li>
                    <li>
                      <strong>Strip conductors:</strong> Strip individual insulation to required
                      length (typically 10-15mm for termination)
                    </li>
                  </ol>
                </div>

                <div className="p-4 rounded-lg bg-green-500/10 border border-green-400/30">
                  <p className="font-medium text-white mb-3">Gland Termination & Banjo Earthing</p>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <p className="font-medium text-white mb-2">Gland Installation Steps</p>
                      <ol className="list-decimal pl-4 space-y-1">
                        <li>Select correct gland size for cable diameter</li>
                        <li>Disassemble gland components</li>
                        <li>
                          Thread gland components onto cable (back nut, compression ring, sealing
                          washers)
                        </li>
                        ...
                        <li>Tighten back nut: hand tight plus 1/4 turn</li>
                      </ol>
                    </div>
                    <div>
                      <p className="font-medium text-white mb-2">Banjo Earthing Process</p>
                      <ul className="list-disc pl-4 space-y-1">
                ...
                <div className="p-4 rounded-lg bg-card/50 border border-white/10">
                  <p className="font-medium text-white mb-3">Cable Bending & Bulldog Benders</p>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <p className="font-medium text-white mb-2">When to Use Bulldog Benders</p>
                      <ul className="list-disc pl-4 space-y-1">
                        <li>Cables 25mm2 and above (essential for larger sizes)</li>
                    ...
                    <div>
                      <p className="font-medium text-white mb-2">Bending Best Practices</p>
                      <ul className="list-disc pl-4 space-y-1">
          ...
          <section className="mb-10">
            ...
            <div className="text-sm text-white/80 space-y-3">
              <div className="p-4 rounded-lg bg-green-500/10 border border-green-400/30">
                ...
                <p className="mb-3">
                  A commercial car park installation required power supplies to 12 lamp posts across
                  the site. SWA cable was chosen for its mechanical strength and suitability for
                  direct burial in the trafficked areas.
                </p>
                <ul className="list-disc pl-6 space-y-1">
                  <li>Used 4mm2 3-core SWA for lighting circuits rated at 32A</li>
                ...
                <p className="mt-3">
                  The installation provided reliable power distribution whilst protecting against
                  vehicle traffic and maintenance activities. The accessible gland terminations
                  allowed easy connection to each lamp post without compromising the buried cable
                  integrity.
                </p>
              </div>
            </div>
          ...
          <section className="mb-16">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 text-sm text-white/80 space-y-3">
              <p>
                ...
                options, its ability to withstand harsh conditions makes it ideal for underground
                and external runs.
              </p>
              <p>
                Correct installation, termination, and earthing are critical for safety and
                compliance. Key success factors include:
              </p>
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  Proper cable stripping leaving armour wires long enough for gland termination
                </li>
