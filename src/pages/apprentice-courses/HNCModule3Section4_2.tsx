...
const quickCheckQuestions = [
  {
    ...
    options: ['VL = Vph', 'VL = Vph / √3', 'VL = √3 × Vph', 'VL = 2 × Vph'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['IL = 3 × Iph', 'IL = √3 × Iph', 'IL = Iph / √3', 'IL = Iph'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['L1-L3-L2', 'R-Y-B', 'L1-L2-L3', 'A-B-C'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    id: 8,
    question:
      'For percentage voltage drop in three-phase circuits, which nominal voltage is used as the base?',
    options: [
  ...
  },
  {
    ...
    options: ['Multimeter', 'Phase rotation meter', 'Clamp meter', 'Oscilloscope only'],
    correctAnswer: 1,
    explanation:
...
const HNCModule3Section4_2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 4 · Subsection 2"
        title="Line and Phase Voltage/Current Relationships"
        backTo="/study-centre/apprentice/h-n-c-module3-section4"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Voltage drop in three-phase circuits uses the formula V&#x1d05; = &radic;3 &times; I
              &times; (R cos&phi; + X sin&phi;) &times; L &mdash; the &radic;3 comes from the
              line-to-line measurement convention. As BSE designer you evidence compliance with
              Appendix 4 Section 6.4 limits (3 % for lighting, 5 % for other uses on single-phase; 5
              % cumulative on three-phase distribution + final). This calculation is your
              second-largest reason to know the &radic;3 factor (the first being three-phase power).
            </>
          }
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Star:</strong> V<sub>L</sub> = √3 × V<sub>ph</sub>, I<sub>L</sub> = I
              <sub>ph</sub>
            </li>
            <li>
              <strong>Delta:</strong> V<sub>L</sub> = V<sub>ph</sub>, I<sub>L</sub> = √3 × I
              <sub>ph</sub>
            </li>
            <li>
              <strong>UK supply:</strong> 400V line, 230V phase
            </li>
            <li>
              <strong>Phase angle:</strong> 120° between phases
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Building Services Context</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Distribution:</strong> 400V between phases at DB
            </li>
            <li>
              <strong>Single-phase:</strong> 230V phase-to-neutral loads
            </li>
            <li>
              <strong>Motors:</strong> Phase sequence determines rotation
            </li>
            <li>
              <strong>Cable sizing:</strong> Consider connection type
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Star (Wye) Connection Relationships">
          <p>
            In a star connection, the three windings or loads share a common neutral point. Current
            flows from each line through the phase winding to neutral, making line and phase
            currents identical.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Phase windings subjected to lower voltage (V<sub>L</sub> ÷ √3)
            </li>
        ...
        <ConceptBlock title="Delta (Mesh) Connection Relationships">
          <p>
            In a delta connection, windings are connected end-to-end forming a closed triangle. Each
            winding is connected directly across two lines, so phase voltage equals line voltage.
          </p>
        ...
        <ConceptBlock title="UK Supply: 400V Line, 230V Phase">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Line voltage (L-L):</strong> Nominal 400V, ±10% tolerance, range 360V - 440V
            </li>
            <li>
              <strong>Phase voltage (L-N):</strong> Nominal 230V, +10% / -6% tolerance, range 216V -
              253V
            </li>
            <li>
              <strong>Frequency:</strong> Nominal 50Hz, ±1% tolerance, range 49.5Hz - 50.5Hz
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pre-1995:</strong> UK used 415V/240V (higher than continent)
            </li>
            <li>
              <strong>1995 harmonisation:</strong> Changed to 400V/230V nominal
            </li>
            <li>
              <strong>Overlap:</strong> Tolerance bands mean 240V still within range
            </li>
            <li>
              <strong>Equipment:</strong> Most rated for 220-240V or 380-415V works fine
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
            <strong>Practical note:</strong> Despite harmonisation, UK supply voltages often measure
            around 240V phase due to the +10% tolerance.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Vector Diagrams Showing Relationships">
          <p>
            Vector (phasor) diagrams are essential for understanding three-phase relationships. They
            show both magnitude and phase angle of voltages and currents.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">Three-Phase Voltage Phasors</p>
          <p>
            Three-phase voltages with V_L1 at reference 0°, V_L2 at 120°, V_L3 at 240°. Rotation:
            anti-clockwise (positive sequence). Phase separation: 120°. Period: 20ms (at 50Hz).
          </p>
          <p className="text-sm font-medium text-white">Key vector diagram principles:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Length:</strong> Represents magnitude (voltage or current)
            </li>
            <li>
              <strong>Angle:</strong> Represents phase relationship
            </li>
            <li>
              <strong>Rotation:</strong> Anti-clockwise for positive sequence
            </li>
            <li>
              <strong>Reference:</strong> Usually L1 at 0° (horizontal right)
            </li>
            <li>
              <strong>Addition:</strong> Head-to-tail for series voltages
            </li>
            <li>
              <strong>Subtraction:</strong> Reverse direction then add
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              |V<sub>L</sub>|² = |V<sub>ph</sub>|² + |V<sub>ph</sub>|² - 2|V<sub>ph</sub>|²cos(120°)
            </li>
            <li>
              |V<sub>L</sub>|² = 2|V<sub>ph</sub>|² - 2|V<sub>ph</sub>|²(-0.5)
            </li>
            <li>
              |V<sub>L</sub>|² = 2|V<sub>ph</sub>|² + |V<sub>ph</sub>|² = 3|V<sub>ph</sub>|²
            </li>
            <li>
              Therefore: |V<sub>L</sub>| = √3 × |V<sub>ph</sub>|
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Phase Sequence (L1, L2, L3)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>UK Modern:</strong> L1 (Brown), L2 (Black), L3 (Grey)
            </li>
            <li>
              <strong>UK Old:</strong> R (Red), Y (Yellow), B (Blue)
            </li>
            <li>
              <strong>International:</strong> A / U, B / V, C / W
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Motors:</strong> Wrong sequence reverses rotation (dangerous for pumps, fans)
            </li>
            <li>
              <strong>Lifts:</strong> Phase sequence relays prevent reverse operation
            </li>
            <li>
              <strong>Compressors:</strong> Reverse rotation can damage scroll compressors
            </li>
            <li>
              <strong>Generators:</strong> Must match grid sequence for synchronisation
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
            <strong>Always verify:</strong> Use a phase rotation meter before connecting three-phase
            motors.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Measuring Line and Phase Quantities">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>
                Line voltage V<sub>L1-L2</sub>:
              </strong>{' '}
              L1 to L2 — Expected 400V ±10%
            </li>
            <li>
              <strong>
                Line voltage V<sub>L2-L3</sub>:
              </strong>{' '}
              L2 to L3 — Expected 400V ±10%
            </li>
            <li>
              <strong>
                Line voltage V<sub>L3-L1</sub>:
              </strong>{' '}
              L3 to L1 — Expected 400V ±10%
            </li>
            <li>
              <strong>
                Phase voltage V<sub>L1-N</sub>:
              </strong>{' '}
              L1 to N — Expected 230V +10%/-6%
            </li>
            <li>
              <strong>
                Phase voltage V<sub>L2-N</sub>:
              </strong>{' '}
              L2 to N — Expected 230V +10%/-6%
            </li>
            <li>
              <strong>
                Phase voltage V<sub>L3-N</sub>:
              </strong>{' '}
              L3 to N — Expected 230V +10%/-6%
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Current Measurements</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Line current:</strong> Clamp meter around any line conductor
            </li>
            <li>
              <strong>Neutral current:</strong> Clamp meter around neutral (ideally zero if
              balanced)
            </li>
            <li>
              <strong>Phase current (delta):</strong> I<sub>ph</sub> = I<sub>L</sub> ÷ √3
              (calculated)
            </li>
            <li>
              <strong>Balance check:</strong> All three line currents should be within 10%
            </li>
          </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Safety:</strong> Always use test equipment rated for the voltage and prospective
        ...
        <ConceptBlock title="Voltage Drop in Three-Phase Cables">
          <p>
            Three-phase voltage drop calculations differ from single-phase due to the √3 factor and
            the need to consider both star and delta connected loads.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
            Three-Phase Voltage Drop Formula
          </p>
          <p>
            V<sub>d</sub> = √3 × I<sub>L</sub> × L × (r cos φ + x sin φ) — Or simplified: V
            <sub>d</sub> = √3 × I<sub>L</sub> × L × z
          </p>
          <p>
            Where: I<sub>L</sub> = line current, L = length (m), r = resistance (Ω/m), x = reactance
            (Ω/m). z = impedance per metre from BS 7671 tables (mV/A/m).
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              As percentage of 400V: 21.75/400 × 100 = <strong>5.4%</strong>
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Public supply:</strong> Lighting 3% (6.9V at 230V) — Other 5% (11.5V at 230V)
            </li>
            <li>
              <strong>Private supply:</strong> Lighting 6% — Other 8%
            </li>
            <li>
              <strong>Three-phase (400V):</strong> Lighting 12V max — Other 20V max
            </li>
          </ul>
          <p className="text-sm font-medium text-white">Important considerations:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Three-phase V<sub>d</sub> calculated as line-to-line voltage drop
            </li>
            <li>
              For star loads, phase V<sub>d</sub> = line V<sub>d</sub> ÷ √3
            </li>
            <li>
              Motor starting current (5-8× F.L.C.) causes temporary increased V<sub>d</sub>
            </li>
            <li>Long sub-main runs may require larger cable for voltage drop</li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
            <strong>Design tip:</strong> Check voltage drop at both maximum load and motor starting
            conditions.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Services: Distribution Board Voltages">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Small motors (&lt;2.2kW):</strong> 230V — Single-phase (L-N)
            </li>
            <li>
              <strong>Large motors (&gt;2.2kW):</strong> 400V — Three-phase (L-L)
            </li>
            <li>
              <strong>Lighting:</strong> 230V — Single-phase (L-N)
            </li>
            <li>
              <strong>Socket outlets:</strong> 230V — Single-phase (L-N)
            </li>
            <li>
              <strong>3-phase heaters:</strong> 400V — Delta or Star
            </li>
            <li>
              <strong>HVAC chillers:</strong> 400V — Three-phase
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Neutral current:</strong> Unbalanced phases cause neutral current flow
            </li>
            <li>
              <strong>Voltage unbalance:</strong> Lightly loaded phases rise in voltage
            </li>
            <li>
              <strong>Motor heating:</strong> Unbalanced supply causes rotor heating
            </li>
            <li>
              <strong>Maximum unbalance:</strong> Should not exceed 2% for sensitive equipment
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A star-connected heater bank has each phase rated at 230V,
            10A. Calculate the line voltage and total power.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>Line voltage:</li>
            <li>
              V<sub>L</sub> = √3 × V<sub>ph</sub> = 1.732 × 230 = <strong>398V ≈ 400V</strong>
            </li>
            <li>
              Line current (star: I<sub>L</sub> = I<sub>ph</sub>):
            </li>
            <li>
              I<sub>L</sub> = <strong>10A</strong>
            </li>
            <li>Total power:</li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Phase voltage (delta: V<sub>ph</sub> = V<sub>L</sub>):
            </li>
            <li>
              V<sub>ph</sub> = <strong>400V</strong>
            </li>
            <li>Phase current:</li>
            <li>
              I<sub>ph</sub> = I<sub>L</sub> / √3 = 30 / 1.732 = <strong>17.3A</strong>
            </li>
            <li>Total power:</li>
            <li>
            ...
            <li>
              P = 1.732 × 400 × 30 × 0.85 = <strong>17.6kW</strong>
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p>
            <strong>Question:</strong> A 15kW (pf 0.85) three-phase load is supplied by 50m of 6mm²
            cable. Calculate line current and voltage drop. Table value: 6.4 mV/A/m (three-phase).
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Line current:</li>
            <li>
            ...
            <li>
              I<sub>L</sub> = 15000 / 588.9 = <strong>25.5A</strong>
            </li>
            <li>Voltage drop:</li>
            <li>
            ...
            <li>
              V<sub>d</sub> = (6.4 × 25.5 × 50) / 1000 = <strong>8.16V</strong>
            </li>
            <li>
              As percentage: (8.16 / 400) × 100 = <strong>2.04%</strong>
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Percentage unbalance: (3.7 / 48.3) × 100 = <strong>7.7%</strong>
            </li>
            <li>Approximate neutral current (simplified):</li>
            <li>
              I<sub>N</sub> ≈ max difference = 52 - 45 = <strong>~7A</strong>
            </li>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Power:</strong> P = √3 × V<sub>L</sub> × I<sub>L</sub> × cos φ
            </li>
            <li>
              <strong>V drop:</strong> V<sub>d</sub> = mV/A/m × I × L / 1000
            </li>
            <li>
              <strong>√3 = 1.732</strong> (memorise this)
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Key Values to Remember</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              UK line voltage: <strong>400V</strong>
            </li>
            <li>
              UK phase voltage: <strong>230V</strong>
            </li>
            <li>
              Phase angle: <strong>120°</strong> apart
            </li>
            <li>
              Sequence: <strong>L1-L2-L3</strong> (positive)
            </li>
            <li>
              √3 factor: <strong>1.732</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              calculations. Not checking phase sequence before motor connection. Using the wrong
              reference voltage when calculating percentage voltage drop.
            </>
          }
          doInstead={
            <>
              Identify connection type first, then apply correct formula. Match equipment voltage
              rating to supply (line vs phase). Always include cos φ in motor power. Verify sequence
              with a phase rotation meter before energising motors. Use the appropriate nominal
              voltage (230V or 400V) as the percentage base.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A 90 m three-phase submain feeds a roof plantroom MCC carrying 120 A continuous. The
              cable is 70 mm&sup2; XLPE/SWA copper with mV/A/m of 0.65 (from BS 7671 Appendix 4
              Table 4D2B). The site origin is at the LV switchroom; cumulative voltage drop budget
              for distribution + final is 5 %.
            </>
          }
          whatToDo={
            <>
              Apply Vd = (mV/A/m &times; I &times; L) / 1000 = (0.65 &times; 120 &times; 90) / 1000
              = 7.02 V three-phase. Express as a percentage: 7.02 / 400 &times; 100 = 1.76 %.
              Acceptable for the distribution leg (leaves 3.24 % for the final circuits). If the
              load was 200 A the drop would be 11.7 V (2.92 %) and you would consider upgrading to
              95 mm&sup2; — always evidence the calculation in the design submission against
              Appendix 4 &sect;6.4.
            </>
          }
          whyItMatters={
            <>
              Voltage drop above the BS 7671 limits causes equipment to misoperate (motors run hot,
              lighting flickers under inrush, electronics trip on undervoltage) and breaches
              Appendix 4. Underspec&rsquo;d submains are expensive to retrofit because the
              conduit/tray runs are typically installed first and concealed.
            </>
          }
        />
