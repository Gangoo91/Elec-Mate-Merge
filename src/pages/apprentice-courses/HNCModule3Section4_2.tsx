    ...
    Period: 20ms (at 50Hz)`}
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p>
                  |V<sub>L</sub>|² = |V<sub>ph</sub>|² + |V<sub>ph</sub>|² - 2|V<sub>ph</sub>
                  |²cos(120°)
                </p>
                <p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Motors:</strong> Wrong sequence reverses rotation (dangerous for pumps,
                  fans)
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Long sub-main runs may require larger cable for voltage drop
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Wrong formula:</strong> Applying star formula to delta or vice versa
                </li>
                <li className="pl-1">
                  <strong>Voltage confusion:</strong> Using 230V when 400V is needed (or vice versa)
                </li>
                <li className="pl-1">
                  <strong>Forgetting pf:</strong> Motor calculations need power factor
                </li>
                <li className="pl-1">
                  <strong>Phase sequence:</strong> Not checking before motor connection
                </li>
                <li className="pl-1">
                  <strong>
                    V<sub>d</sub> reference:
                  </strong>{' '}
                  Using wrong voltage for percentage calculation
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs text-white">
              <div>
                ...
                <ul className="space-y-0.5">
                  <li>
                    V<sub>L</sub> = √3 × V<sub>ph</sub> = 1.732 × V<sub>ph</sub>
                  </li>
                  <li>
                    I<sub>L</sub> = I<sub>ph</sub>
                  </li>
              ...
              <div>
                ...
                <ul className="space-y-0.5">
                  ...
                  <li>
                    I<sub>L</sub> = √3 × I<sub>ph</sub> = 1.732 × I<sub>ph</sub>
                  </li>
                  <li>No neutral</li>
