...
const quickCheckQuestions = [
  {
    ...
    options: ['Concealed wiring', 'Surface wiring', 'Both are equally accessible'],
    correctIndex: 1,
    explanation:
    ...
    <div className="bg-[#1a1a1a] overflow-x-hidden">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  Surface: visible on walls/ceilings, faster install, easier access, less aesthetic.
                </li>
                <li>
                  Concealed: hidden in walls/ceilings, neater finish, harder to modify, higher cost.
                </li>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Visible trunking/conduit (surface), flush sockets
                  (concealed).
                </li>
                <li>
                  <strong>Use:</strong> Surface for industrial/plant rooms, concealed for
                  offices/homes.
                </li>
                <li>
                  <strong>Check:</strong> Safe zones, access points, mechanical protection,
                  aesthetics.
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/20">
              ...
              <ul className="list-disc pl-6 space-y-1 text-white">
                <li>
                  <strong>Ignoring safe zones for concealed wiring</strong> - Risk of cable damage
                  during future work
                </li>
                <li>
                  <strong>Inadequate mechanical protection</strong> - Cables vulnerable to damage
                  from nails/screws
                </li>
                <li>
                  <strong>No access points for concealed systems</strong> - Cannot inspect or test
                  installations
                </li>
                <li>
                  <strong>Poor documentation</strong> - Cannot locate cables for future work or
                  emergency repairs
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/20">
              ...
              <ul className="list-disc pl-6 space-y-1 text-white">
                <li>
                  <strong>Inconsistent surface mounting</strong> - Unprofessional appearance
                  affecting client satisfaction
                </li>
                <li>
                  <strong>Poor chasing technique</strong> - Structural damage or inadequate cable
                  protection
                </li>
                <li>
                  <strong>Mixing methods inappropriately</strong> - Aesthetically poor transitions
                  between surface and concealed
                </li>
                <li>
                  <strong>Inadequate finishing</strong> - Visible damage or poor making good after
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-4 bg-indigo-500/10 border border-indigo-400/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Section 522:</strong> Selection and erection of wiring systems
                </li>
                <li>
                  <strong>Section 522.6:</strong> Cables concealed in walls and partitions
                </li>
                <li>
                  <strong>Section 528:</strong> Proximity to other services
                </li>
                <li>
                  <strong>Section 543:</strong> Protective conductor continuity
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-slate-400/30">
            ...
            <p className="text-sm mb-4">
              In a school refurbishment, surface-mounted trunking was used in classrooms to reduce
              cost and allow easy access for future IT upgrades. In contrast, concealed wiring was
              used in the new administrative offices to maintain a high-quality interior finish
              appropriate for client meetings and professional presentation.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-xs sm:text-sm text-white">
            <p>
              Surface wiring is quicker, cheaper, and easier to maintain, but less attractive in
              finished spaces. Concealed wiring provides a neater look and better protection from
              damage but is more expensive and harder to modify. The choice depends on environment,
              budget, aesthetics, and safety requirements.
            </p>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="rounded-lg p-4 bg-transparent border border-green-400/30">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <ul className="space-y-1">
                  <li>
                    <strong>Industrial:</strong> Surface preferred
                  </li>
                  <li>
                    <strong>Domestic:</strong> Concealed preferred
                  </li>
                  <li>
                    <strong>Budget tight:</strong> Surface cheaper/faster
                  </li>
                  <li>
                    <strong>Aesthetics critical:</strong> Concealed better
                  </li>
                  <li>
                    <strong>Future changes likely:</strong> Surface easier
                  </li>
                  <li>
                    <strong>Protection needed:</strong> Concealed safer
                  </li>
                </ul>
              </div>
              <div>
        ...
        <section className="mb-10">
          ...
          <div className="text-xs sm:text-sm text-white space-y-2">
            <p>
              <strong>BS 7671:</strong> IET Wiring Regulations (18th Edition) - Sections 522, 528,
              543
            </p>
            <p>
              <strong>IET On-Site Guide:</strong> Practical guidance for electrical installations
            </p>
            <p>
              <strong>Building Regulations:</strong> Part P - Electrical safety in dwellings
            </p>
            <p>
              <strong>IET Guidance Note 1:</strong> Selection and erection of equipment
            </p>
          </div>
        </section>
