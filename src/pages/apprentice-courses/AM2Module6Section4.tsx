    ...
    >
      ...
      <AM2ContentCard>
        ...
        <div className="space-y-4 text-sm sm:text-base leading-relaxed">
          ...
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">Underline or note</strong> what is actually being
              asked
            </li>
            <li>
              - <strong className="text-white">Don't answer what you think is asked</strong> -
              answer what is written
            </li>
          </ul>

          <h3 className="text-base sm:text-lg font-semibold text-elec-yellow mt-6 mb-3">
            Detailed Reading Strategies:
          </h3>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-4 bg-white/5 border border-white/10 rounded-lg">
              ...
              <ul className="space-y-1 text-xs sm:text-sm text-white">
                ...
                <li>
                  - <strong className="text-white">"Must"</strong> vs{' '}
                  <strong className="text-white">"Should"</strong> (legal vs recommended)
                </li>
                <li>
                  - <strong className="text-white">"NOT"</strong> or{' '}
                  <strong className="text-white">"EXCEPT"</strong> (reverse logic)
                </li>
                <li>
                  - <strong className="text-white">"All"</strong> vs{' '}
                  <strong className="text-white">"Some"</strong> (absolute vs partial)
                </li>
                <li>
                  - <strong className="text-white">"Always"</strong> vs{' '}
                  <strong className="text-white">"Usually"</strong> (frequency)
                </li>
              </ul>
            </div>
            <div className="p-4 bg-white/5 border border-white/10 rounded-lg">
      ...
      <AM2ContentCard>
        ...
        <div className="space-y-4 text-sm sm:text-base leading-relaxed">
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">Narrowing 4 options to 2</strong> gives you a 50/50
              chance even if unsure
            </li>
            <li>
              - <strong className="text-white">Elimination also reduces panic</strong> and clears
              your head
            </li>
          </ul>
          ...
          <div className="mt-4 p-4 bg-amber-950/20 rounded-lg border border-amber-800/30">
            ...
            <div className="space-y-1 text-xs text-amber-300">
              <p>
                X <del>10.5O</del> - Way too high (obviously wrong)
              </p>
              <p>
                X <del>7.28O</del> - This is for 6A, not 32A (context wrong)
              </p>
              <p>
                X <del>2.73O</del> - This is for 16A, close but wrong (context check)
              </p>
      ...
      <AM2ContentCard>
        ...
        <div className="space-y-4 text-sm sm:text-base leading-relaxed">
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">Maths errors:</strong> not rounding properly,
              forgetting Ohm's law basics
            </li>
            <li>
              - <strong className="text-white">Overcomplicating:</strong> many questions only need a
              simple calculation
            </li>
            <li>
              - <strong className="text-white">Changing answers unnecessarily:</strong> trust your
              first instinct unless you're sure it's wrong
            </li>
          </ul>
        </div>
      </AM2ContentCard>
      ...
      <AM2ContentCard>
        ...
        <div className="space-y-4 text-sm sm:text-base leading-relaxed">
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">Break the test mentally</strong> into smaller chunks
              (10 questions at a time)
            </li>
            <li>
              - <strong className="text-white">Don't let one question shake your confidence</strong>{' '}
              - the pass mark allows for errors
            </li>
            <li>
              - <strong className="text-white">Remind yourself:</strong> you only need around 60-65%
              to pass, not 100%
            </li>
          </ul>

          <h3 className="text-base sm:text-lg font-semibold text-elec-yellow mt-6 mb-3">
            Pressure Management in Detail:
          </h3>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <ul className="space-y-2 ml-4 text-white">
                ...
                <li>
                  - <strong className="text-white">Remind yourself:</strong> "I know this material"
                </li>
                <li>
                  - <strong className="text-white">Focus on the current question only</strong> - not
                  the whole test
                </li>
                <li>
                  - <strong className="text-white">Use the 'chunk' method:</strong> think "10
                  questions done, 3 to go"
                </li>
                <li>
                  - <strong className="text-white">Positive self-talk:</strong> "I can work this
                  out"
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 ml-4 text-white">
                ...
                <li>
                  - <strong className="text-white">Racing heart?</strong> Slow, controlled breathing
                </li>
                <li>
                  - <strong className="text-white">Sweaty palms?</strong> Wipe them, reset posture
                </li>
                <li>
                  - <strong className="text-white">Mind blank?</strong> Skip question, come back
                  fresh
                </li>
                <li>
                  - <strong className="text-white">Time anxiety?</strong> Check clock every 15 mins
                  only
                </li>
              </ul>
            </div>
      ...
      <AM2ContentCard>
        ...
        <div className="space-y-4 text-sm sm:text-base leading-relaxed">
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">If unsure,</strong> eliminate, guess, and move on
            </li>
            <li>
              - <strong className="text-white">Use flagging</strong> to return later
            </li>
            <li>
              - <strong className="text-white">Manage energy:</strong> avoid spending too long on
              maths-heavy questions early
            </li>
          </ul>

          <h3 className="text-base sm:text-lg font-semibold text-elec-yellow mt-6 mb-3">
            Strategic Answering - The FAST Method:
          </h3>
      ...
      <AM2ContentCard>
        ...
        <ul className="space-y-2 text-sm text-white">
          ...
          <li>
            - <strong className="text-white">Walk in positive.</strong> Anxiety costs marks - calm
            confidence wins them
          </li>
        </ul>
      </AM2ContentCard>
      ...
      {/* Navigation Footer */}
      <AM2NavigationFooter
        prevHref="/study-centre/apprentice/am2/module6/section3"
        prevLabel="Time Management"
        nextHref="/study-centre/apprentice/am2/module7"
