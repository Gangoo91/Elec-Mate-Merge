...
const AM2Module6Section4 = () => {
  ...
  const quickCheckQuestions: Array<{
    ...
    },
    {
      ...
      options: ['Neither - use seconds only', '0.28 ms', 'Both are correct', '280 ms'],
      correctIndex: 3,
      explanation:
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['5-8 questions', '10-12 questions', '15-20 questions', '12-14 questions'],
      correctAnswer: 3,
      explanation:
    ...
    },
    {
      ...
      options: ['kW and W', 'Ohms and siemens', 'Volts and amps', 'Hz and kHz'],
      correctAnswer: 0,
      explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The AM2 online knowledge test is as much about exam discipline and mindset as it is about
          knowledge. Many candidates know the material but lose marks because they misread
          questions, panic under pressure, or second-guess themselves. This section teaches you how
          to approach questions with the right techniques, avoid common pitfalls, and maintain a
          confident, professional mindset.
        </p>
          ...
          whatHappens={
            <>
              <p className="text-ios-callout text-white mb-2">
                ...
                exam technique. Misreading questions, panicking under pressure, and second-guessing
                yourself are guaranteed routes to failure.
              </p>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Spot the keywords: <strong>MAXIMUM PERMISSIBLE</strong> and <strong>LIGHTING</strong>{' '}
              and <strong>FROM THE ORIGIN</strong>. BS 7671 Appendix 4: max voltage drop for
              lighting from origin is <strong>3%</strong>. (Other circuits = 5%; 1% is too tight, 8%
              would be a fail.) Answer: B) 3%. Now imagine if the question said "for non-lighting
              circuits" — answer would be C) 5%. Same reg, different keyword, different correct
              option.
            </>
          }
          whyItMatters={
            <>
              ...
              highest-return habit in exam technique. Read the question. Read the options. Then read
              the question again to make sure you're answering what was actually asked.
            </>
          }
        />
        ...
        <ConceptBlock title="2. Using Elimination to Your Advantage">
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Best Fit:</strong> Choose the most complete and accurate answer from remaining
              options.
            </li>
          </ol>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You answered question 17 with option C, felt OK about it, moved on. At question 25 you
              start panicking. You go back to question 17 thinking "maybe I should change it to B".
              You click B, submit, and the result later confirms C was right. You just gave away a
              mark you'd already earned.
            </>
          }
          doInstead={
            <>
              Trust your first instinct unless you can specifically articulate WHY the first answer
              is wrong (e.g. "I just realised I misread the question" or "I now see the regulation
              applies differently"). Vague unease is not a reason to change. Multiple-choice
              research shows changes are wrong more often than right. Stick with your first pick
              unless you've found a real error.
            </>
          }
        />
        ...
        <ConceptBlock title="4. Staying Calm Under Pressure">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Break the test mentally</strong> into smaller chunks (10 questions at a time)
            </li>
            <li>
        ...
        <ConceptBlock title="5. Strategic Answering">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Manage energy:</strong> avoid spending too long on maths-heavy questions early
            </li>
          </ul>
        ...
        <ConceptBlock title="Real-World Examples">
          <p>
            <strong className="text-elec-yellow">Example 1:</strong> Candidate misread "maximum" as
            "minimum" in a regs question. Gave opposite answer - lost easy marks.
          </p>
          <p>
            <strong className="text-elec-yellow">Example 2:</strong> Candidate flagged 4 questions,
            came back fresh, and answered 3 correctly - passed comfortably.
          </p>
          <p>
            <strong className="text-elec-yellow">Example 3:</strong> Candidate panicked, rushed, and
