...
const AM2Module4Section4 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['Milliseconds (ms)', 'Seconds (s)', 'Minutes (min)', 'Microseconds (us)'],
      correctAnswer: 0,
      explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          After insulation resistance, continuity, Zs, and RCD tests, you must carry out functional
          and operational testing to confirm that the installation performs as intended.
        </p>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              real-world operation and safety — operate every switch, prove every socket, run every
              RCD trip test.
            </>
          }
        />
        ...
        >
          <p>
            ...
            accessories. RCD/RCBO operation and trip times. Protective devices operating correctly.
            Functional operation of motors or specialist equipment. Polarity verification at
            outlets.
          </p>
          <p>
            <strong>Why It's Essential:</strong> Confirms installation works as designed. Identifies
            wiring errors not found in electrical tests. Proves safety systems operate correctly.
            Demonstrates professional competence to assessor. Required for certification completion.
          </p>
        </ConceptBlock>
        ...
        <div className="my-6">
          <VideoCard
            ...
            caption={
              <>
                The Engineering Mindset on why an MCB cannot protect a person — and why the RCD must
                trip within the BS 7671 limits when you push 1×IΔn on AM2 day. The principle behind
                the trip-time test, before you reach for the meter.
              </>
            }
          />
        </div>
        ...
        >
          ...
          <p>
            <strong>Power Circuits:</strong> Test socket outlets (correct polarity, supply present).
            Ring/radial continuity verified, now prove operational. Cooker circuit: confirm supply
            at control unit. Switched spurs: test switching function.
          </p>
          <p>
          ...
          <p>
            <strong>Recording Requirements:</strong> Record actual trip times in milliseconds. Note
            if RCD fails to trip within limits. Include manual test button operation.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              your way out of an RCD on a domestic socket. Functional test the trip on every one of
              those circuits.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              Forgetting to function-test sockets after electrical tests. Not carrying out 1×IΔn RCD
              test on every RCD-protected circuit. Failing to test motor start/stop controls.
              <strong> Recording and Procedure Errors:</strong> Recording RCD trip times incorrectly
              or in wrong units. Rushing through tests without systematic approach. Not explaining
              procedures to assessor. Leaving installation in unsafe state after testing.
            </>
          }
          doInstead={
            <>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              operation. Done. If your MFT auto-runs a ½×IΔn pre-check (RCD must NOT trip), that's a
              meter feature, not a separate row on the schedule. Some old training materials still
              reference 5× — they're out of date.
            </>
          }
        />
        ...
        >
          ...
          <p>
            <strong>Technical Requirements:</strong> Record results in correct units (ms for RCDs).
            Leave installation in a safe state after functional tests. Complete all required test
            combinations. Verify results against BS 7671 requirements.
          </p>
          <p>
        ...
        >
          ...
          <p>
            <strong>Motor Circuit Testing:</strong> Check start and stop controls operate correctly.
            Confirm overloads reset correctly. Verify emergency stop functions.
          </p>
          <p>
            <strong>Efficient Testing:</strong> Work steadily — rushing causes missed checks. Follow
            a systematic sequence for each circuit type. Record results immediately — don't rely on
            memory.
          </p>
          <p>
        ...
        >
          ...
          <p>
            ...
            but missed the manual test button on a circuit's RCBO. Incomplete — lost marks. Lesson:
            The full 1×IΔn + manual test sequence is mandatory under A4:2026. Missing a step =
          ...
          <p>
            ...
            Lesson: Systematic, complete testing with clear communication demonstrates professional
            competence.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Troubleshooting Failed Tests:</strong> RCD fails to trip — check test equipment,
            verify connections. Switch doesn't control lamp — verify switching wiring. Motor won't
            start — check control circuit, overloads. Socket tester shows fault — investigate wiring
            errors.
          </p>
          <p>
        ...
        >
          <p>Functional and operational testing proves that circuits and devices actually work.</p>
          <p>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              nothing. Both switches operated again from upstairs first — same. The light works from
              one switch but not the other.
            </>
          }
          whatToDo={
            <>
              Don't sign it off as functional. Re-isolate, lift the switch fronts and check the
              strappers — the most common cause is a strapper landed on the common terminal instead
              of L1, or both strappers swapped between the two switches. Re-energise, test every
              combination: down/up, up/down, both up, both down. All four states must light or
              extinguish the lamp correctly. Record the fix on the EIC alterations / commentary
              section, re-test, sign off only when every combination works.
            </>
          }
          whyItMatters={
            <>
              A two-way wired wrong is a classic NET test rig fault. Assessors plant it because they
              want to see whether you're functional-testing every combination, or just clicking the
              first switch and assuming the rest. Spot it, fix it, document it = full marks. Sign it
              off as working from one switch = fail.
            </>
          }
        />
