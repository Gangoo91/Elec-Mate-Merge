...
const Module7Section2_3 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Leakage currents can cause nuisance RCD tripping, loss of supply, and potential overheating over time.',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'False. Some earth faults, particularly through high impedance paths, may not cause high currents but are still dangerous.',
    },
    {
      id: 8,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Earth-leakage clamp meters are specifically designed to measure small currents flowing to earth without breaking the circuit.',
    },
    {
      id: 10,
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              <strong className="text-white">Leakage currents</strong> are smaller, persistent flows
              that can cause nuisance RCD tripping and operational problems.
            </p>
          </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="bg-red-500/10 rounded-lg p-4 border border-red-500/30">
                  ...
                  <p className="text-sm mb-3 text-red-200/80">
                    An electrical fault where a live conductor makes direct contact with earth or
                    exposed conductive parts, creating an immediate dangerous condition.
                  </p>
                ...
                <div className="bg-amber-500/10 rounded-lg p-4 border border-amber-500/30">
                  ...
                  <p className="text-sm mb-3 text-amber-200/80">
                    Small amounts of current that flow continuously to earth through insulation or
                    designed paths (such as EMC filters).
                  </p>
              ...
              <h4 className="font-medium text-elec-yellow mt-6">
              ...
              <div className="bg-red-500/10 rounded-lg p-4 border border-red-500/30">
                ...
                <ul className="text-sm space-y-1 text-red-200/80">
                  <li>
                    • <strong className="text-red-300">Mechanical damage:</strong> Nails, screws, or
                    tools penetrating cable insulation
                  </li>
                  <li>
                    • <strong className="text-red-300">Water ingress:</strong> Moisture entering
                    electrical equipment or accessories
                  </li>
                  <li>
                    • <strong className="text-red-300">Insulation failure:</strong> Age, heat, or
                    chemical degradation of cable insulation
                  </li>
                  <li>
                    • <strong className="text-red-300">Installation errors:</strong> Loose
                    connections allowing conductors to touch metalwork
                  </li>
                  <li>
                    • <strong className="text-red-300">Environmental factors:</strong> Rodent
                    damage, UV degradation, or corrosive atmospheres
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-500/10 rounded-lg p-4 border border-amber-500/30">
                ...
                <ul className="text-sm space-y-1 text-amber-200/80">
                  <li>
                    • <strong className="text-amber-300">EMC filters:</strong> Built-in capacitors
                    in IT equipment (normal operation)
                  </li>
                  <li>
                    • <strong className="text-amber-300">Capacitive coupling:</strong> Long cable
                    runs creating natural capacitance to earth
                  </li>
                  <li>
                    • <strong className="text-amber-300">Moisture ingress:</strong> Gradual water
                    penetration reducing insulation resistance
                  </li>
                  <li>
                    • <strong className="text-amber-300">Deteriorating insulation:</strong> Gradual
                    breakdown allowing small current paths
                  </li>
                  <li>
                    • <strong className="text-amber-300">Dirty surfaces:</strong> Contaminated
                    insulators providing conductive paths
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Electric shock:</strong> Exposed metalwork
                    becomes live and dangerous to touch
                  </li>
                  <li>
                    • <strong className="text-white">Fire risk:</strong> Arcing at fault points can
                    ignite combustible materials
                  </li>
                  <li>
                    • <strong className="text-white">Equipment damage:</strong> Fault currents can
                    damage sensitive electronic equipment
                  </li>
                  <li>
                    • <strong className="text-white">Loss of protection:</strong> Earth fault
                    affecting protective conductor systems
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Nuisance tripping:</strong> RCDs operate
                    unnecessarily, causing supply interruption
                  </li>
                  <li>
                    • <strong className="text-white">Reduced availability:</strong> Frequent supply
                    interruptions affect productivity and safety systems
                  </li>
                  <li>
                    • <strong className="text-white">Cumulative effects:</strong> Multiple small
                    leakage currents can sum to trip 30mA RCDs
                  </li>
                  <li>
                    • <strong className="text-white">Heating effects:</strong> Persistent leakage
                    can cause localised heating and further insulation degradation
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                  ...
                  <ul className="text-sm space-y-1">
                    <li>
                      • <strong className="text-white">30mA:</strong> Personal protection, socket
                      outlets, bathrooms
                    </li>
                    <li>
                      • <strong className="text-white">100mA:</strong> Fire protection in older
                      installations
                    </li>
                    <li>
                      • <strong className="text-white">300mA:</strong> Large installations requiring
                      discrimination
                    </li>
                    <li>
                      • <strong className="text-white">RCBOs:</strong> Combined overcurrent and
                      residual current protection
                    </li>
                    <li>
                      • <strong className="text-white">Time-delayed:</strong> Upstream
                      discrimination in series arrangements
                    </li>
                  </ul>
                </div>
              </div>

              <h4 className="font-medium text-green-400 mt-6">
                BS 7671 Requirements and Standards
              </h4>
              ...
              <div className="bg-blue-500/10 rounded-lg p-4 border border-blue-500/30">
                ...
                <ul className="text-sm space-y-1 text-blue-200/80">
                  <li>
                    • <strong className="text-blue-300">Section 411:</strong> Protective measures -
                    basic protection and fault protection
                  </li>
                  <li>
                    • <strong className="text-blue-300">Section 531:</strong> Selection and erection
                    of RCDs and protective devices
                  </li>
                  <li>
                    • <strong className="text-blue-300">30mA additional protection:</strong>{' '}
                    Required for socket outlets up to 20A and mobile equipment
                  </li>
                  <li>
                    • <strong className="text-blue-300">Maximum disconnection times:</strong> 0.4s
                    for final circuits, 5s for distribution circuits
                  </li>
                  <li>
                    • <strong className="text-blue-300">Special locations:</strong> Enhanced
                    protection requirements (bathrooms, swimming pools, etc.)
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-purple-500/10 rounded-lg p-4 border border-purple-500/30">
                ...
                <ul className="text-sm space-y-1 text-purple-200/80">
                  <li>
                    • <strong className="text-purple-300">Discrimination and selectivity:</strong>{' '}
                    Use time-delayed RCDs in series arrangements
                  </li>
                  <li>
                    • <strong className="text-purple-300">Split-load design:</strong> Separate
                    circuits to prevent total loss of supply
                  </li>
                  <li>
                    • <strong className="text-purple-300">RCD sensitivity selection:</strong>{' '}
                    Balance between protection and nuisance tripping
                  </li>
                  <li>
                    • <strong className="text-purple-300">Leakage assessment:</strong> Consider
                    cumulative leakage when grouping circuits
                  </li>
                  <li>
                    • <strong className="text-purple-300">RCBO per circuit:</strong> Individual
                    protection reduces nuisance tripping impact
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="mt-6">
              <InlineCheck
                ...
                options={['Section 411', 'Section 531', 'Section 514', 'Section 522']}
                correctIndex={1}
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <ol className="text-sm space-y-2 list-decimal list-inside">
                  <li>
                    <strong className="text-white">Initial assessment:</strong> Review symptoms,
                    check RCD operations, gather user reports
                  </li>
                  <li>
                    <strong className="text-white">Visual inspection:</strong> Check for obvious
                    damage, water ingress, loose connections, or burning
                  </li>
                  <li>
                    <strong className="text-white">Safe isolation:</strong> Ensure circuits are
                    safely isolated before detailed investigation
                  </li>
                  <li>
                    <strong className="text-white">CPC continuity testing:</strong> Verify earth
                    paths are intact using low-resistance ohmmeter
                  </li>
                  <li>
                    <strong className="text-white">Insulation resistance tests:</strong> Test with
                    sensitive equipment isolated to avoid damage
                  </li>
                  <li>
                    <strong className="text-white">RCD functional testing:</strong> Perform ramp
                    test and time measurement using RCD tester
                  </li>
                  <li>
                    <strong className="text-white">Earth leakage measurement:</strong> Use clamp
                    meter to measure actual leakage currents
                  </li>
                  <li>
                    <strong className="text-white">Load assessment:</strong> Evaluate individual
                    circuit contributions to total leakage
                  </li>
                  <li>
                    <strong className="text-white">Documentation:</strong> Record findings and
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                  ...
                  <ul className="text-sm space-y-1">
                    <li>
                      • <strong className="text-white">Earth leakage clamp meter:</strong> Measures
                      current to earth without circuit interruption
                    </li>
                    <li>
                      • <strong className="text-white">Insulation resistance tester:</strong> 500V
                      DC test for cable and equipment insulation
                    </li>
                    <li>
                      • <strong className="text-white">RCD tester:</strong> Functional testing and
                      trip time measurement
                    </li>
                    <li>
                      • <strong className="text-white">Low resistance ohmmeter:</strong> CPC
                      continuity and bonding verification
                    </li>
                    <li>
                      • <strong className="text-white">PAT tester:</strong> Portable appliance earth
                      leakage measurement
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                  ...
                  <ul className="text-sm space-y-1">
                    <li>
                      • <strong className="text-white">Insulation resistance:</strong> Minimum 1MΩ
                      for final circuits
                    </li>
                    <li>
                      • <strong className="text-white">RCD trip time:</strong> Maximum 300ms at
                      rated current for 30mA devices
                    </li>
                    <li>
                      • <strong className="text-white">Earth leakage per circuit:</strong> Typically
                      &lt; 1mA for lighting, &lt; 3.5mA for other circuits
                    </li>
                    <li>
                      • <strong className="text-white">Total installation leakage:</strong> Should
                      not exceed 25% of RCD rating
                    </li>
                    <li>
                      • <strong className="text-white">Class I appliances:</strong> Leakage
                      typically &lt; 3.5mA
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-red-500/10 rounded-lg p-4 border border-red-500/30">
                ...
                <ul className="text-sm space-y-1 text-red-200/80">
                  <li>
                    • <strong className="text-red-300">Identify cumulative leakage:</strong> Test
                    individual circuits to find high contributors
                  </li>
                  <li>
                    • <strong className="text-red-300">Temporary disconnection:</strong> Isolate
                    suspected circuits to confirm source
                  </li>
                  <li>
                    • <strong className="text-red-300">Load redistribution:</strong> Move
                    high-leakage equipment to separate RCD
                  </li>
                  <li>
                    • <strong className="text-red-300">Equipment assessment:</strong> Check IT
                    equipment, fluorescent lighting, motors
                  </li>
                  <li>
                    • <strong className="text-red-300">Environmental factors:</strong> Consider
                    moisture, temperature, and installation conditions
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-amber-500/10 rounded-lg p-4 border border-amber-500/30">
                ...
                <ul className="text-sm space-y-1 text-amber-200/80">
                  <li>
                    • <strong className="text-amber-300">Earth fault present:</strong> High current
                    flow preventing reset
                  </li>
                  <li>
                    • <strong className="text-amber-300">Damaged RCD:</strong> Internal mechanism
                    failure requiring replacement
                  </li>
                  <li>
                    • <strong className="text-amber-300">Mechanical obstruction:</strong> Physical
                    damage to reset mechanism
                  </li>
                  <li>
                    • <strong className="text-amber-300">Persistent fault:</strong> Ongoing earth
                    fault maintaining trip condition
                  </li>
                  <li>
                    • <strong className="text-amber-300">Neutral-earth short:</strong> N-E fault in
                    downstream circuits
                  </li>
                </ul>
              </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong className="text-white">RCD tester:</strong> For trip time and
                    sensitivity testing
                  </li>
                  <li>
                    • <strong className="text-white">Insulation resistance tester:</strong> 500V
                    minimum for circuits
                  </li>
                  <li>
                    • <strong className="text-white">Earth leakage clamp meter:</strong> To measure
                    actual leakage currents
                  </li>
                  <li>
                    • <strong className="text-white">Low resistance ohmmeter:</strong> For earth
                    continuity testing
                  </li>
                  <li>
                    • <strong className="text-white">Proving unit:</strong> To verify test
          ...
          <section className="mb-10">
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <div className="space-y-3 text-sm">
                <p>
                  <strong className="text-white">Problem:</strong> An office building experienced
                  repeated RCD tripping on the ground floor lighting and power circuits, causing
                  disruption to computer equipment and loss of productivity.
                </p>
                <p>
                  <strong className="text-white">Investigation:</strong> Initial testing showed no
                  obvious faults - insulation resistance values were acceptable and RCD sensitivity
                  was correct. However, earth leakage clamp meter readings revealed 25mA of leakage
                  current on the circuit.
                </p>
                <p>
                  <strong className="text-white">Root Cause:</strong> Water had seeped into a
                  floor-level socket outlet through damaged trunking, creating a leakage path to
                  earth. The 30mA RCD was operating correctly but nuisance tripping occurred during
                  peak load periods when the additional leakage pushed total current above the trip
                  threshold.
                </p>
                <p>
                  <strong className="text-white">Solution:</strong> The damaged socket was replaced,
                  trunking was resealed, and the circuit was transferred to an RCBO to provide
                  individual protection and prevent future nuisance tripping affecting other
                  circuits.
                </p>
                <p>
                  <strong className="text-white">Lesson:</strong> Even small amounts of leakage
                  current can cause significant operational problems. Regular testing and use of
                  appropriate test equipment is essential for identifying problems before they cause
                  disruption.
                </p>
              </div>
            </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2 text-sm">
                <div>
                  ...
                  <ul className="space-y-1 text-white/70">
                    ...
                    <li>
                      • Both conditions require systematic testing and proper protective devices
                    </li>
          ...
          <Quiz
            ...
            title="Test your knowledge of earth faults and leakage currents"
          />
