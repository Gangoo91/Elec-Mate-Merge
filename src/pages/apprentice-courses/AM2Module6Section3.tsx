  ...
  const quizQuestions = [
    {
      ...
      options: ['60 minutes', '90 minutes', '75 minutes', '120 minutes'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ['3 minutes', '1 minute', '2 minutes', '4 minutes'],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: ['8-10 questions', '15-20 questions', '10-12 questions', 'All 40 questions'],
      correctAnswer: 2,
      explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The AM2 online knowledge test is 90 minutes long with around 30-40 questions. That gives
          you roughly 2-3 minutes per question. Candidates often fail not because they lack
          knowledge, but because they mismanage time - either spending too long on one tricky
          question or rushing and making careless mistakes. Time management ensures you attempt
          every question, work steadily, and stay calm under pressure.
        </p>
        ...
        <Scenario
          ...
          whyItMatters={
            <>
              ...
              now: spend 4 more minutes here, or 4 minutes on 4 fresh questions. The fresh questions
              will almost always score better.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You glance at the timer after every question. Each glance breaks your focus, increases
              anxiety, and adds 5–10 seconds across the test. By question 20 you're mentally
              exhausted from clock-watching, and you've lost the equivalent of 2–3 minutes of actual
          ...
          doInstead={
            <>
              ...
              (all done, 10 min for review). Only check at those points. Between checkpoints, ignore
              the clock and focus on the question in front of you. Pace by chunks of 10 questions,
              not by seconds.
            </>
          }
        />
