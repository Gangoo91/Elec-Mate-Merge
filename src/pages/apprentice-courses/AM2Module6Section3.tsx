    ...
    >
      ...
      <AM2ContentCard>
        ...
        <div className="space-y-4 text-sm sm:text-base leading-relaxed">
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">40 questions = 2 minutes each</strong>
            </li>
            <li>
              -{' '}
              <strong className="text-white">Aim to finish with 10 minutes spare for review</strong>
            </li>
          </ul>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-4 bg-white/5 border border-white/10 rounded-lg">
              ...
              <ul className="space-y-1 text-xs sm:text-sm text-white">
                ...
                <li>
                  - <strong className="text-white">Next 30 minutes:</strong> 10-12 medium questions
                </li>
                <li>
                  - <strong className="text-white">Next 20 minutes:</strong> Remaining questions
                </li>
                <li>
                  - <strong className="text-white">Final 10 minutes:</strong> Review flagged
                  questions
                </li>
              </ul>
            </div>
            <div className="p-4 bg-white/5 border border-white/10 rounded-lg">
              ...
              <ul className="space-y-1 text-xs sm:text-sm text-white">
                ...
                <li>
                  - <strong className="text-white">Good pace:</strong> 2/3 complete at 60 minutes
                </li>
                <li>
                  - <strong className="text-white">Warning:</strong> Less than 1/4 at 30 minutes
                </li>
                <li>
                  - <strong className="text-white">Crisis:</strong> Less than 1/2 at 60 minutes
                </li>
              </ul>
            </div>
          </div>
      ...
      <AM2ContentCard>
        ...
        <div className="space-y-4 text-sm sm:text-base leading-relaxed">
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">Eliminate wrong answers.</strong> Narrow to 2 options
              before guessing
            </li>
            <li>
              - <strong className="text-white">Don't overthink.</strong> Usually the most
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-white/5 border border-white/10 rounded-lg">
              ...
              <ul className="space-y-1 text-xs sm:text-sm text-white">
                ...
                <li>
                  - <strong className="text-white">Simple calculation (1-2 minutes):</strong>{' '}
                  "Current drawn by 3kW heater at 230V?"
                </li>
                <li>
                  - <strong className="text-white">Application questions (2-3 minutes):</strong>{' '}
                  "RCD requirements in bathroom zones"
                </li>
                <li>
                  - <strong className="text-white">Complex scenarios (3-5 minutes):</strong>{' '}
                  Multi-step calculations or interpretations
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 bg-white/5 border border-white/10 rounded-lg">
              ...
              <ul className="space-y-1 text-xs sm:text-sm text-white">
                ...
                <li>
                  - <strong className="text-white">If 10 minutes behind:</strong> Speed up
                  elimination, guess more confidently
                </li>
                <li>
                  - <strong className="text-white">If 5 minutes behind:</strong> Reduce checking,
                  trust first instincts
                </li>
                <li>
                  - <strong className="text-white">Last 15 minutes:</strong> Ensure every question
                  has an answer
                </li>
              </ul>
            </div>
      ...
      <AM2ContentCard>
        ...
        <div className="space-y-4 text-sm sm:text-base leading-relaxed">
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">Don't look at the clock constantly</strong> - check
              time every 10-15 minutes instead
            </li>
            <li>
              - <strong className="text-white">Think of it as 3 small 30-minute tests</strong>{' '}
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-4 bg-white/5 border border-white/10 rounded-lg">
              ...
              <ul className="space-y-1 text-xs sm:text-sm text-white">
                ...
                <li>
                  - <strong className="text-white">Shoulder roll:</strong> Release tension every 15
                  minutes
                </li>
                <li>
                  - <strong className="text-white">Posture reset:</strong> Sit back, straighten
                  spine
                </li>
                <li>
                  - <strong className="text-white">Hand shake:</strong> If sweaty palms, quick shake
                  and wipe
                </li>
              </ul>
            </div>
            <div className="p-4 bg-white/5 border border-white/10 rounded-lg">
              ...
              <ul className="space-y-1 text-xs sm:text-sm text-white">
                ...
                <li>
                  - <strong className="text-white">Progress focus:</strong> "10 down, only 5 more to
                  go"
                </li>
                <li>
                  - <strong className="text-white">Reset mantras:</strong> "One question at a time"
                </li>
                <li>
                  - <strong className="text-white">Confidence anchors:</strong> Remember recent
                  successes
                </li>
              </ul>
            </div>
      ...
      <AM2ContentCard>
        ...
        <div className="space-y-4 text-sm sm:text-base leading-relaxed">
          ...
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">Work methodically</strong> through the paper
            </li>
            <li>
              - <strong className="text-white">Manage time</strong> without panicking or skipping
              whole sections
            </li>
          </ul>
      ...
      <AM2ContentCard>
        ...
        <ul className="space-y-2 text-sm text-white">
          ...
          <li>
            - <strong className="text-white">Second pass for flagged questions.</strong> Spend more
            time on tricky ones later
          </li>
          <li>
          ...
          <li>
            - <strong className="text-white">Use spare minutes wisely.</strong> Double-check flagged
            answers first, not the whole paper
          </li>
          <li>
      ...
      {/* Navigation Footer */}
      <AM2NavigationFooter
        prevHref="/study-centre/apprentice/am2/module6/section2"
        prevLabel="Core Topics"
        nextHref="/study-centre/apprentice/am2/module6/section4"
