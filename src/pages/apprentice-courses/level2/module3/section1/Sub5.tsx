...
const checks = [
  ...
  },
  {
    ...
    options: [
      "A new requirement to colour all CPC conductors blue.",
      ...
      "Removal of all RCD requirements.",
      "Cancellation of Part 6.",
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      "Part 1 = special locations; Part 2 = scope; Part 3 = appendices.",
      ...
      "All Parts cover the same content from different angles.",
  ...
  },
  {
    ...
    options: [
      "Page 411 of edition 3, paragraph 4.",
      ...
      "It's a citation to an external document.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "BS 7671 is a Statutory Instrument.",
      ...
      "BS 7671 is enforced by NICEIC.",
      "It only applies to industrial work.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "It doesn't — Part 2 is decorative.",
  ...
  },
  {
    ...
    options: [
      "Once certified, the install never has to be updated.",
      ...
      "All previous certificates become invalid.",
      "Only commercial work needs updating.",
    ],
    correctAnswer: 1,
    explanation:
