...
const faqs = [
  ...
  {
    question:
      'If I genuinely have to do something live (e.g. proving dead with a voltage indicator), how does Reg 14 apply?',
    answer:
  ...
  {
    question:
      'How does EAWR interact with the Electrical Safety Standards in the Private Rented Sector (England) Regulations 2020?',
    answer:
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 1 · Subsection 4"
        title="EAWR 1989 deep dive"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The Electricity at Work Regulations 1989 — Reg 4(1)–(4) safe systems, Reg 13 precautions
          for work on equipment made dead, Reg 14 work on or near live conductors (the
          three-condition test), Reg 16 competence. Each one unpacked with the practical install-day
          implication.
        </p>
        ...
        >
          ...
          <p>
            ...
            insulation, 8 earthing, 9 conductor integrity, 10 connections, 11 means of protection
            from excess current, 12 isolation, 15 working space and lighting) read like chapter
            headings in BS 7671 — that&apos;s deliberate. BS 7671 is the technical standard built to
            demonstrate compliance with each of those EAWR regs.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The verbatim wording (paraphrased to highlight structure):</p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                <strong>4(1)</strong> — &quot;All systems shall at all times be of such construction
              ...
              <p className="mb-2">
                ...
                maintenance of a system and work near a system, shall be carried out in such manner
                as not to give rise to danger, so far as is reasonably practicable.&quot;
              </p>
              <p>
                <strong>4(4)</strong> — &quot;Any equipment provided under these Regulations for the
                purpose of protecting persons at work on or near electrical equipment shall be
          ...
          meaning={
            <>
              ...
              that&apos;s the BS 7671 design / install hook. (2) The system in use has to stay safe
              — that&apos;s the EICR / maintenance hook. (3) The work activity itself has to be safe
              — that&apos;s the safe-isolation hook. (4) The kit you use to keep yourself safe
              during the work has to be fit for purpose — that&apos;s the GS38 / calibration /
              lock-off hook. All four are simultaneously in play on every job.
            </>
          }
        ...
        >
          <p>
            The duty under Reg 4(1) attaches to the system as built. The duty-holder is whoever is
            responsible for the construction — the designer, the installer, the firm. After
            ...
            construction. So a CU change you did 8 years ago that turns out to have a wiring fault
            is still your Reg 4(1) issue.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 4(2) is qualified by &apos;as may be necessary to prevent danger&apos; and &apos;so
            far as is reasonably practicable&apos; — so the maintenance regime has to be
            proportionate. The duty-holder discharges Reg 4(2) by:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Arranging periodic inspection (an EICR) at the recommended frequency for the premises
              type.
            </li>
            <li>
            ...
            <li>
              Keeping the records (EICR + remedial works invoices + retest evidence) so the audit
              trail is in place if questioned later.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            operation (turning the system on / off), use (running it), maintenance (servicing it),
            AND work NEAR a system (where you&apos;re not directly working on the live parts but
            they&apos;re close enough to be a risk). That breadth is why Reg 4(3) is the
            most-charged EAWR regulation — almost any electrical-incident scenario fits at least one
            limb.
          </p>
          <p>
        ...
        >
          <p>
            ...
            in-calibration MFT used outside its measurement range still breaches Reg 4(4) under the
            &apos;properly used&apos; limb. The CPS scheme assessor will check calibration certs at
            every visit precisely because Reg 4(4) is so easy to evidence — or to fail to evidence.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              precautions&apos; is what BS 7671, IET Guidance Note 2 (Isolation and Switching), the
              JIB safe-isolation procedure and your firm&apos;s RAMS all describe in detail.
              Lock-off kit, key in pocket, warning notice, voltage proving on a known live source
              before AND after, communication with anyone on site who could interfere — those
              collectively are what &apos;adequate&apos; looks like in 2026 practice.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Three conditions, all required, all simultaneously. (a) is the &apos;unreasonable to
              be dead&apos; test — almost never true for a domestic install or fit-out. (b) is the
              &apos;reasonable to do live&apos; test — requires positive justification, documented
              before the work. (c) is the &apos;suitable precautions&apos; test — insulated tools,
              mats, gloves to the appropriate standard, second authorised person where required,
              permit-to-work. Apprentices in their early years are almost never authorised under (b)
              and almost never have the competence under (c) — so live working will be rare exposure
              for you and you should question any instruction to do it.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              &apos;appropriate&apos; supervision. The supervision route is the apprentice route.
              &apos;Appropriate&apos; scales with task danger AND trainee experience — so a
              first-year on a CU change is direct hands-on supervision, a third-year on socket
              extensions is lighter supervision, and a fully-qualified electrician on routine work
              needs no supervision at all. The supervisor&apos;s own competence is in scope under
              their own Reg 16 — token oversight from someone who isn&apos;t themselves competent
              for the specific work doesn&apos;t meet the regulation.
            </>
          }
        ...
        >
          <p>The pattern for a typical serious electrical incident:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>EAWR Reg 13</strong> — failure to take adequate precautions for dead working
              (added if isolation failed).
            </li>
            <li>
              <strong>EAWR Reg 14</strong> — unauthorised live working (added if any live work was
              involved without the three conditions met).
            </li>
            <li>
            ...
            <li>
              <strong>HASAWA s.2 / s.3</strong> — broader employer duties to employees / the public
              (charged against the firm).
            </li>
            <li>
            ...
            <li>
              <strong>HASAWA s.37</strong> — director / officer liability (charged against named
              directors where neglect is in evidence).
            </li>
          </ul>
          <p>
            The defence has to answer every single charge. The technical evidence base — BS 7671
            compliance, GS38 instrument records, RAMS, supervisor sign-off, EIC / EICR paperwork —
            is what answers them all simultaneously. That&apos;s why scheme membership, calibrated
            kit and proper paperwork aren&apos;t bureaucracy. They&apos;re the multi-charge defence
            file you build BEFORE you need it.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Electrician opens a CU, switches off what they think is the right MCB, removes the
              lock-off from the previous job (still in the kit), starts work without voltage
              proving. Turns out they switched the MCB next to the right one. The circuit
              they&apos;re working on is live. Shock. After the incident the HSE charges Reg 4(3)
              (failure of safe work activity), Reg 13 (failure of dead-working precautions) AND Reg
              16 (competence — the operative didn&apos;t carry out the step that any competent
              electrician knows is mandatory).
            </>
          }
          doInstead={
            <>
              Voltage proving on every isolation, every time, no exceptions. Live source &rarr;
              suspected-dead source &rarr; live source again. GS38-compliant indicator. The whole
              sequence takes about 30 seconds. It is the single most-prosecuted procedure gap in UK
              electrical incidents and there is no shortcut.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer is in a rush, supervisor wants the job finished. Instruction: just swap the
              accessory live, it&apos;s only 5 minutes. The apprentice does as told. Either nothing
              goes wrong (and a dangerous habit forms) or something goes wrong and the whole crew is
              exposed under EAWR Reg 14 — including the apprentice under their own Reg 14 / Reg 16 /
              HASAWA s.7. The defence &apos;I was told to&apos; doesn&apos;t discharge the personal
              duty.
            </>
          }
          doInstead={
            <>
              ...
              conditions (a) and (b)? Are the precautions under (c) in place? If the answer to any
              of those is no, the work isn&apos;t lawful and you&apos;re entitled — and obliged
              under HASAWA s.7 — to refuse. Raising it discharges your personal duty even if the
              supervisor overrides you.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re on a CU upgrade in a domestic. Lock-off in place on the main switch, key
              in your pocket, warning notice on the board. Customer&apos;s 9-year-old wanders past
              while you&apos;re in the loft pulling cable, sees the bright orange lock-off, tries to
              open it. Can&apos;t — but tells the parent &apos;the man left it locked up, can we
              open it?&apos;. Parent assumes you&apos;re finished (you&apos;ve been up there 10
              minutes), goes to find the original key for the consumer-unit casing, considers
              swapping the lock. You come down, see them about to do it, intervene.
            </>
          }
          whatToDo={
            <>
              Stop, secure the situation, complete the work as planned, document the near-miss in
              writing for your firm&apos;s incident log. Note that the lock-off itself worked
              &mdash; the precaution chain held. But the foreseeable risk (curious household member
              trying to defeat the isolation) was real and you should brief the customer at the
              start of the next job: explain what the lock-off is, ask them to keep household
              members away from the board area, and make sure the warning notice is visible. That
              conversation is part of Reg 13 &apos;adequate precautions&apos; on a domestic.
            </>
          }
          whyItMatters={
            <>
              Reg 13&apos;s &apos;adequate precautions&apos; isn&apos;t just the physical lock-off.
              It includes the foreseeable interference risk and what you do to control it &mdash;
              including the customer briefing. The HSE&apos;s prosecution playbook on domestic
              incidents has expanded over the last decade specifically because customer-side
              interference is now a recognised foreseeable hazard category, not an unforeseeable
              freak event.
            </>
          }
        />
