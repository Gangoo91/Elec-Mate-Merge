...
const checks = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "Scheme withdrawal is the non-statutory framework's commercial equivalent of a criminal sanction, and often more damaging in practice. Every notifiable job now needs LABC notification (delays + fees); most PL insurers require scheme membership as a condition of cover so the policy is likely cancelled; the NICEIC logo must come off the van / website / quotes (continued use is fraud); and tier-1 contractors remove the firm from approved-supplier lists. All hit at once. Most contractors remediate before it reaches suspension because the alternative is the end of the trading firm.",
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "EL is one of the few genuinely compulsory insurances under UK law. The minimum is £5m (set by the 1969 Act) but most policies default to £10m because the underwriter's pricing difference is small. Failure to insure is a criminal offence with daily-rate fines up to £2,500 for each uninsured day, and the certificate-display rule is separately enforceable — HSE inspectors check it during routine visits. Apprentices count as employees from day one of the contract.",
  },
  {
    id: 3,
    question:
    ...
    correctAnswer: 3,
    explanation:
      "Civil claims for electrical-incident damage almost always plead both routes. Contract (Consumer Rights Act 2015 implied terms) gives the customer a route based on the relationship; negligence (the common law tort — duty, breach, causation, loss) gives them a route based on the harm, and is usually the lead because it covers property damage, consequential loss and injury where contract claims may be limited by exclusion clauses. The PL insurer's defence team fights both in parallel, relying on the non-statutory framework (BS 7671 compliance, scheme paperwork, EIC) as the documentary evidence.",
  },
  {
    id: 4,
    question:
...
const faqs = [
  ...
  {
    question:
      "Why does Part P need a Competent Person Scheme at all — couldn't anyone just notify LABC?",
    answer:
  ...
  {
    question:
      "If my firm loses its scheme membership, what happens to the work I've already certified?",
    answer:
