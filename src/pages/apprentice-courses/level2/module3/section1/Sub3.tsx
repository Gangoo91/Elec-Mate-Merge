...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'Which phrase qualifies most HASAWA duties and what does it mean in practice?',
    options: [
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 1 · Subsection 3"
        title="HASAWA 1974 deep dive"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The parent Act every UK trade works under. Sections 2, 3, 6, 7 and 37 unpacked — what each
          one obliges, who they bind, how the HSE and Local Authority enforce them, and what
          sentencing on indictment actually looks like for electrical-installer breaches.
        </p>
        ...
        >
          <p>
            HASAWA splits into four parts. Part I (sections 1 to 54) is the bit that does the real
            work — the general duties, the powers of inspectors, the offences, the enforcement
            notices. Parts II to IV deal with the Employment Medical Advisory Service, amendments to
            other Acts, and supplementary provisions. For an electrician you only need Part I.
          </p>
          <p>The five sections in Part I that an electrician genuinely needs to know:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>s.6</strong> — duties on designers, manufacturers, importers and suppliers of
              articles for use at work. Catches you when you design or supply a bespoke assembly.
            </li>
            <li>
              <strong>s.7</strong> — the personal duty on every individual at work.
            </li>
            <li>
              <strong>s.37</strong> — director / officer personal liability when the company offence
              is attributable to their consent, connivance or neglect.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <p>
                ...
                risks to health; (b) arrangements for ensuring, so far as is reasonably practicable,
                safety and absence of risks to health in connection with the use, handling, storage
                and transport of articles and substances; (c) the provision of such information,
                instruction, training and supervision as is necessary to ensure, so far as is
                reasonably practicable, the health and safety at work of his employees; (d) so far
                as is reasonably practicable as regards any place of work under the employer&apos;s
                control, the maintenance of it in a condition that is safe and without such risks,
                and the provision and maintenance of means of access to and egress from it that are
                safe and without such risks; (e) the provision and maintenance of a working
                environment for his employees that is, so far as is reasonably practicable, safe,
          ...
          meaning={
            <>
              Five subheadings under s.2(2). For an electrical contractor: (a) tools, MFTs, vans,
              RAMS, isolation procedures; (b) handling cable drums, ladders, batteries,
              COSHH-controlled materials; (c) the apprenticeship itself, toolbox talks, scheme CPD,
              supervisor sign-off; (d) site access, scaffolds, working platforms, the workshop; (e)
              welfare facilities on site (toilets, mess, drying area). Every line of s.2(2) maps
              onto something the firm has to put in place AND maintain.
            </>
          }
        ...
        >
          <p>
            ...
            outcomes — the documented procedures, the supervisor regime, the training records, the
            calibration schedule for test instruments, the written safe-isolation procedure that
            everyone has to follow. The kit is plant; the procedures are the system.
          </p>
          <p>
            For an electrical contractor, the &quot;system of work&quot; for a typical job looks
            like: a job-specific risk assessment, a method statement covering isolation and access,
            a competence record proving the operative is suitable for the work, a calibrated MFT, a
            written safe-isolation procedure that every operative follows, a supervisor sign-off on
            the test results, an EIC issued at the end. Take any one of those out and the s.2(2)(a)
            defence weakens.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <p>
                <strong>s.3(2)</strong> — &quot;It shall be the duty of every self-employed person
                to conduct his undertaking in such a way as to ensure, so far as is reasonably
                practicable, that he and other persons (not being his employees) who may be affected
          ...
          meaning={
            <>
              ...
              low-risk solo work — but the Health and Safety at Work etc. Act 1974 (General Duties
              of Self-Employed Persons) (Prescribed Undertakings) Regulations 2015 explicitly keep
              electrical work as a prescribed undertaking, so a self-employed electrician owes the
              full s.3(2) duty without exception).
            </>
          }
        ...
        >
          <p>s.6 in summary requires the designer / manufacturer / importer / supplier to:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              Provide adequate information about the use for which the article was designed, the
              conditions necessary to ensure safe use, and any risks attendant on its use.
            </li>
            <li>
          ...
          <p>
            For an electrical contractor designing a one-off, that translates into: design to BS
            7671 + relevant product standards (BS EN 61439 for assemblies), test the panel before
            despatch, provide a handover pack with single-line, schedule of components, test sheet,
            declared rating, recommended maintenance interval, and notify the customer of any
            subsequent product recalls or safety advisories you become aware of. Skip any of those
            steps and the s.6 duty is in play.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Two limbs. Limb (a) is the personal-care duty — be careful for yourself and anyone
              affected by what you do or fail to do. Limb (b) is the co-operation duty — follow your
              employer&apos;s safety arrangements and don&apos;t undermine them. Lifting a
              colleague&apos;s lock-off, ignoring a posted method statement, refusing to wear PPE,
              all bite under limb (b) as well as (a).
            </>
          }
        ...
        >
          <p>
            The wording (paraphrased): where an offence committed by a body corporate is proved to
            have been committed with the consent or connivance of, or to be attributable to any
            neglect on the part of, any director, manager, secretary or other similar officer, that
            individual as well as the body corporate is guilty of the offence and is liable to be
            proceeded against and punished accordingly.
          </p>
          <p>
            Three triggers — consent, connivance or neglect. The first two are deliberate; the third
            is omission. The Sentencing Council Definitive Guideline (2016) treats individual
            sentences for s.37 cases on the same matrix as organisational sentences, with custodial
            sentences available on indictment up to two years. Suspended custodial sentences for
            sole directors of small electrical contracting firms are a real and growing pattern
            after fatalities.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Three things to remember about SFAIRP:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              The cost is judged at the time of the decision, not after the incident. But hindsight
              bias is real — what looked optional before the fire looks negligent after.
            </li>
            <li>
              The bar is set by what a competent person in the trade would have done, not by what
              the duty-holder happened to think was reasonable.
            </li>
            <li>
              The burden of proving SFAIRP is on the defendant (s.40 HASAWA). The prosecution
              doesn&apos;t have to prove it WASN&apos;T reasonably practicable — you have to prove
              it WAS. That&apos;s a quietly massive shift from normal criminal procedure.
            </li>
          </ul>
          <p>
            ...
            didn&apos;t ask is not a defence. Designing-out an RCD on a server room because nuisance
            tripping would crash a hospital&apos;s patient records, with documented alternative
            protection, might be reasonably practicable. The reasoning has to be in writing before
            the incident — not invented afterwards.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The two formal notices the inspector can issue:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Improvement notice (s.21)</strong> — there is a breach but no immediate
              danger. The notice gives a deadline (minimum 21 days from issue) by which the breach
              must be remedied. Work can continue in the meantime.
            </li>
            <li>
              <strong>Prohibition notice (s.22)</strong> — there is a risk of serious personal
              injury. The activity must stop immediately and cannot resume until the conditions in
              the notice are met. Can be issued with immediate effect or deferred.
            </li>
          </ul>
          <p>
            Both notices can be appealed to the Employment Tribunal within 21 days. Appealing an
            improvement notice suspends its effect; appealing a prohibition notice does NOT
            automatically suspend it (you have to apply separately for that). Failure to comply with
            either notice is itself a criminal offence — and is prosecuted as a stand-alone charge
        ...
        >
          <p>Two prosecution venues, two sentence ceilings:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Magistrates&apos; court (summary)</strong> — most HASAWA / EAWR offences now
              carry an unlimited fine and/or up to 6 months&apos; imprisonment for individuals
              (raised by the Health and Safety (Offences) Act 2008 and subsequent amendments).
              Magistrates handle smaller cases without a jury.
            </li>
            <li>
              <strong>Crown Court (on indictment)</strong> — unlimited fine and/or up to 2
              years&apos; imprisonment for individuals; unlimited fine for organisations. Trial by
              jury for contested cases. The Sentencing Council Definitive Guideline (2016) applies.
              This is the venue for any case involving a fatality.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              reference first to the offender&apos;s culpability and then to the seriousness of harm
              risked&hellip; The court should then identify the relevant starting point and category
              range&hellip; Having determined the offence category at step one, and taking into
              account turnover or equivalent, the court should refer to the table below to identify
              the starting point and category range&hellip;&quot;
            </>
          }
          meaning={
            <>
              The Definitive Guideline introduced a structured matrix the court must follow. Step 1
              — culpability (very high / high / medium / low). Step 2 — harm category (1 to 4) based
              on the seriousness of harm risked AND the likelihood of that harm arising. Step 3 —
              for organisations, the turnover band (large / medium / small / micro). Combine those
              three and the matrix produces a starting-point fine and a category range. The result
              is that the same fact-pattern produces a six-figure fine for a small contractor and a
              seven-figure fine for a large one — turnover scales the penalty even though the breach
              is identical.
            </>
          }
        ...
        >
          <p>
            ...
            &apos;safe systems of work&apos;, but HASAWA itself doesn&apos;t tell you HOW to make an
            electrical installation safe. The way you prove you did is by showing your work followed
            BS 7671. So the chain runs HASAWA &rarr; EAWR &rarr; HSR25 &rarr; BS 7671. Get that
            chain straight and you understand why the technical standard everyone reaches for is
            non-statutory but legally critical.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice spots a clear isolation-procedure breach by the senior electrician running
              the job — lock-off removed, no voltage proof, board re-energised before
              ...
              supervisor (s.2 / EAWR Reg 4) AND the apprentice (s.7 — failure to take reasonable
              care AND failure to co-operate with the employer&apos;s safety arrangements) are in
              scope for prosecution.
            </>
          }
          doInstead={
            <>
              Speak up at the time — that&apos;s exactly what s.7 limb (b) requires. If you&apos;re
              uncomfortable challenging the supervisor directly, raise it with a more senior person
              or use the firm&apos;s incident-reporting channel. The act of raising it discharges
              your s.7 duty even if the supervisor overrides you. Silence does not.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Director takes a shortcut on supervision because the firm is busy and the apprentices
              are competent enough. Incident happens. Company pleads guilty under EAWR Reg 4 /
              HASAWA s.2 and pays the fine. Director assumes that&apos;s the end of it. Six months
              later the director is summonsed personally under s.37 — &apos;neglect&apos; — facing a
              separate fine and a suspended custodial sentence on their own record. The company plea
              didn&apos;t cover them. The corporate veil doesn&apos;t reach into criminal H&amp;S
              liability where s.37 applies.
            </>
          }
          doInstead={
            <>
              Treat HASAWA s.7 and s.37 as personal — they are. The company&apos;s plea covers the
              company. Individuals get charged separately. For the apprentice the takeaway is small
              but real: nobody&apos;s indemnifying you out of your s.7 obligations, and the
              firm&apos;s insurance won&apos;t pay your personal fine.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              distribution boards feeding the building site don&apos;t have 30 mA RCD protection on
              the socket outlets being used by other trades. The hire-supplied DBs are technically
              compliant for general construction but not for the way they&apos;re being used
              (handheld tools, outdoor extension leads, damp conditions). The inspector serves an
              improvement notice on the principal contractor with a 21-day deadline.
            </>
          }
          whatToDo={
            <>
              The principal contractor (and your firm if you&apos;re the electrical trade
              responsible for the temporary supplies) has 21 days to remedy. Realistic options: swap
              the DBs for ones with 30 mA RCD on the socket circuits, fit RCD-protected outlet
              adaptors, or restrict use to plug-in tools that have their own integral protection.
              Document the remedy. Notify the inspector by the deadline. Keep the evidence on the
              job file. The improvement notice itself doesn&apos;t produce a fine if you comply
              &mdash; but failing to comply by the deadline is a separate criminal offence, and the
              original breach can still be prosecuted if the inspector decides to escalate.
            </>
          }
          whyItMatters={
            <>
              ...
              problem into a stand-alone prosecution for the firm and (under s.37) potentially for
              the named director. The whole site H&amp;S regime is built around not letting this
              happen.
            </>
          }
        />
