...
const faqs = [
  ...
  {
    question:
      'What about the “embedded carbon” argument — that PV panels take so much energy to make they don’t pay back?',
    answer:
  ...
  {
    question:
      'A customer asks if they can “go off-grid” with PV and battery. Should I encourage this?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Why customers want them. Why they sometimes regret. Why a competent electrician needs to
          know both sides — to give honest advice rather than parrot the sales brochure. The final
          Sub of Module 3.
        </p>
        ...
        >
          <p>
            Subs 6.1 and 6.2 covered the kit and the regulations. This Sub covers the conversation.
            A first-year apprentice doesn’t close PV sales, but they’re asked questions about
            renewables constantly — by customers on other jobs, by friends and family, in the
            college classroom. The expectation isn’t that you’re a sales engineer; the expectation
            is that you can give an accurate, balanced view.
          </p>
          <p>
        ...
        >
          <p>
            ...
            freezers, broadband, a kettle on demand. Whenever the PV is generating more than the
            house is using, the surplus goes back to the grid (and earns the SEG rate). Whenever the
            PV is generating less than the house is using, the shortfall comes from the grid (at the
            import rate). Whenever the PV exactly matches the house demand, neither happens.
          </p>
          <p>
            Self-consumption matters because the import rate (currently around 25–30p/kWh on a
            typical variable tariff) is much higher than the SEG rate (3–15p/kWh). A battery shifts
            surplus daytime generation into the evening when the house is using power, lifting
            self-consumption from a typical 25–35% on a PV-only system to 70%+ on a PV-plus-battery
            system.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            rapidly as more wind and solar comes online, but at typical 2026 grid carbon factors a 4
            kW PV install offsets in the order of 1,000–1,200 kg CO₂ per year. Over 25 years that’s
            25–30 tonnes of CO₂.
          </p>
          <p>
            Heat pumps deliver an even bigger carbon win on a per-install basis, because they
            replace gas combustion (high carbon) with electric drive (much lower carbon, especially
            on a decarbonising grid). This is why heat pump rollout is policy-driven: it’s one of
            the fastest ways to cut UK domestic emissions.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            (boiler controls, fridge, lighting, sockets) on one half that the battery can supply
            during an outage.
          </p>
          <p>
        ...
        >
          <p>
            <strong>Inflation hedge.</strong> UK electricity prices have moved sharply in recent
            years and the long-term trend is upward (carbon costs, grid reinforcement, capacity
            charges). Self-generated electricity is priced at the marginal cost of operating the PV
            system (essentially zero — the kit is paid for, maintenance is light) regardless of what
            the import rate does. For a customer planning to stay in their home for 10+ years, that
            hedge is real. For a short-term resident, less so.
          </p>
          <p>
            <strong>House-value uplift.</strong> The EPC (Energy Performance Certificate) rating
            directly affects house saleability and mortgage availability. PV improves the EPC, often
            pushing a B-rated house into the A bracket. Prospective buyers value low running costs.
            The combination tends to add 1–4% to the sale price for a properly installed and
            certified system. The MCS certificate is what makes the value transferable — non-MCS
            installs give the buyer no easy way to evidence compliance, and some lenders flag that
            during the survey.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Smart Export Guarantee (SEG):</strong> All large licensed energy suppliers
              must offer an SEG tariff to customers exporting from MCS-certified micro-generation.
              Rates currently roughly 3–15p per kWh exported, varying by supplier.
            </li>
            <li>
              <strong>Boiler Upgrade Scheme (BUS):</strong> Currently around £7,500 grant towards an
              air-source or ground-source heat pump install in England and Wales (subject to scheme
              rules and changes).
            </li>
            <li>
            ...
            <li>
              <strong>Devolved nations:</strong> Scotland, Wales and Northern Ireland have their own
              grant schemes from time to time. Always check what applies at the time of quote.
            </li>
          </ul>
          <p>
            Quote what’s available right now. Don’t promise what may have closed by the time the
            install completes.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Realistic 2026 UK install costs:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            Most customers finance these from savings or with a green-finance loan. The capital cost
            is the single biggest barrier to install volume — it’s why government schemes focus on
        ...
        >
          <p>
            Payback depends on three variables: install cost, electricity import price, and how much
            of the generation is self-consumed (vs exported at the lower SEG rate). Typical 2026
            numbers for a 4 kW PV install:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Simple payback: £7,000 ÷ £490 = <strong>~14.3 years</strong>.
            </li>
          </ul>
          <p>
            Add a battery and self-consumption can rise to 70%+, lifting savings to £700–£900/year
            and shortening payback to around 12–14 years for the combined PV+battery system. Heat
            pump payback is harder to pin down because it depends heavily on what fuel it’s
            replacing — vs oil, payback can be 5–8 years; vs natural gas, often 10+ years.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            UK PV output by month (rough percentages of annual yield for a south-facing 4 kW
            install):
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>June/July:</strong> 13–14% per month — peak generation.
            </li>
            <li>
              <strong>December/January:</strong> 1–2% per month — bare minimum.
            </li>
          </ul>
          <p>
          ...
          <p>
            Wind has the opposite seasonal profile (windier in winter), which is why combined
            wind+PV installs make sense on suitable sites — they’re partially anti-correlated.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Planning side.</strong> For most UK domestic installs, PV sits under Permitted
            Development Rights — no planning permission needed as long as the panels meet the size
            and visibility limits. But the following typically require full planning permission:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            Planning officers can refuse on visual-impact grounds. Customers in those areas need a
            proper planning application BEFORE the install is committed — otherwise they’ve paid for
            a system they may not be allowed to use.
          </p>
          <p>
            ...
            customer-owned PV adds complexity. Each LV cable, fuseboard and transformer has a finite
            capacity. Once local PV penetration crosses a threshold, the DNO has to either reinforce
            the network (expensive) or limit further connections. Customers in heavily-PV areas
            (especially the South West and rural areas with lots of early adopters) are increasingly
            hitting refusals or export-limit conditions on G99 applications. The fix is either an
            export-limited install (the inverter is configured to never push more than X kW back to
            the grid, even when generating more) or a customer-funded network reinforcement (often
            £10,000+).
          </p>
          <p>
            The DNO has a statutory duty to provide and maintain the connection under ESQCR Reg 24,
            but that duty is balanced against the safety and stability of the wider network — which
            is why a refusal on capacity grounds is a legitimate engineering answer rather than an
            obstruction. Always run a DNO pre-application check on G99 jobs; don’t commit the
            customer to a quote until you know the connection will be allowed.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              battery system and micro-CHP unit larger than the G98 16 A/phase threshold needs a DNO
              connection agreement before it’s commissioned. The DNO can refuse on capacity grounds,
              impose an export limit, or require customer-funded reinforcement. As an electrician
              you don’t commission a G99 install on the strength of a verbal "yeah it’ll be fine" —
              the written DNO consent has to be in the file before the inverter sees AC. Source:
              Energy Networks Association Engineering Recommendation G99 (current amendment).
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              (typically 70–80% of original capacity). Replacement cost depends on chemistry and
              capacity.
            </li>
            <li>
          ...
          <p>
            ...
            dedicated facilities are limited. Lithium battery recycling is similarly developing —
            the chemistry is recoverable but the infrastructure is years off mature.
          </p>
          <p>
            <strong>Fire-risk side.</strong> The AC arc fault problem (covered in Module 2.6) is
            partly mitigated by the fact that AC arcs self-extinguish 100 times a second at the
            zero-crossings of the 50 Hz waveform. DC arcs do not. Once a DC arc strikes, it sustains
            itself until either the conductors melt apart or the circuit is interrupted by an
            isolator/fuse. PV string voltages of 300–500 V DC are well above the threshold for
            sustained arcing. Mitigations:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Properly torqued and crimped MC4 (or equivalent) connectors at every panel-to-panel
              and panel-to-cable joint.
            </li>
            <li>
              Correct DC string overcurrent protection per Section 712.431/712.432, sized to the
              module and string ratings.
            </li>
            <li>Rodent-resistant cable routing (DC cables in particular).</li>
            <li>
              AFDD on the AC supply circuit per Reg 421.1.7 and BS EN 62606 (covers the AC side; the
              trade is actively discussing dedicated DC AFDDs).
            </li>
            <li>
              Periodic inspection — checking connectors, looking for thermal damage, verifying
              isolators operate correctly.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              outside in all weather for decades; insulation degrades from UV, thermal cycling,
              rodent damage and connector corrosion. An IMD (typically built into the modern
              inverter) checks DC-side insulation continuously and alarms if it drops below
              threshold — catching incipient faults long before they become fires. The customer
              should know their inverter does this; the electrician needs to know to check the
              inverter event log at periodic inspection.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Renewables installs intersect with building regs as well as BS 7671. Approved Document
              L (energy efficiency) treats PV, batteries and heat pumps as notifiable work because
              they affect the building’s energy performance and EPC rating. The normal route to
              discharge the notification is MCS — the installer’s competent person scheme reports
              the install to the local authority on the customer’s behalf. Skip MCS and the customer
              is left with a Building Control submission to make themselves, plus the loss of SEG
              eligibility. Source: Approved Document L, Volume 1 (Dwellings), current edition
              published on gov.uk.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              about five years”. The customer signs the £8,000 install on that basis. Three years
              in, they’ve seen £1,500 of savings (not the £4,800 the five-year figure implied). They
              feel misled. They tell their neighbours. The trade gets another customer who thinks
              renewables installers are a bunch of cowboys.
            </>
          }
          doInstead={
            <>
              Quote the realistic 2026 figure: 9–12 years for a typical PV install at current SEG
              and import rates, with a battery shortening that and poor self-consumption lengthening
              it. Show the customer the actual sums (annual generation × self-consumption × prices).
              The five-year payback figure is from the FIT era which closed in 2019 — it’s no longer
        ...
        <Scenario
          ...
          whyItMatters={
            <>
              ...
              competent electrician says no when it’s the right answer — and ends up with a
              longer-term customer who refers friends and family.
            </>
          }
        />
        ...
        >
          <p>
            Module 3 closed off the theory side of Level 2. You’ve covered the science (units,
            mechanics, R-V-I, AC, electronics), the supply (how electricity gets to the cut-out, how
            it can come back the other way), and the regulations that frame all of it. Module 4
            turns those principles into the install.
          </p>
          <p>Coming up:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Tools (hand and power)</strong> — and how to choose the right one for each
              job. The kit list a competent first-year electrician carries on the van.
            </li>
            <li>
            ...
            <li>
              ...
              blocks, flex into connectors and ferrules, glands and ferrules on SWA, crimps on
              bigger terminations.
            </li>
            <li>
            ...
            <li>
              <strong>Dead testing</strong> — continuity of CPC, ring final continuity (R1+R2, r1,
              rn, r2), insulation resistance, polarity, functional tests. The full Initial
              Verification sequence per BS 7671 Part 6.
            </li>
          </ul>
          <p>
