...
const checks = [
  {
    ...
    question: 'BS 7671 Part 2 defines an extraneous-conductive-part as:',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'Which of these is most likely to be missed on a domestic main bonding survey?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'I’m on a job where the gas main is in plastic but the meter and internal pipework is copper. The copper bonded back to the MET reads 2000 Ω. What now?',
    answer:
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 4 · Subsection 4"
        title="Extraneous conductive parts"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Bigger trap than exposed-conductive-parts. Metalwork outside the installation that brings
          in a potential — gas, water, structural steel — and the 1667 Ω test that decides whether
          you bond.
        </p>
        ...
        >
          <p>
            The BS 7671 Part 2 definition: an <strong>extraneous-conductive-part</strong> is "a
            conductive part liable to introduce a potential, generally earth potential, and not
            forming part of the electrical installation". Two qualifying conditions:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              structure, or services from another trade. If it’s electrical equipment, it’s exposed
              (Sub 4.3), not extraneous.
            </li>
          </ul>
          <p>
            The two BS 7671 categories are mutually exclusive in this sense. Exposed-conductive
            parts can become live <em>under fault</em>; extraneous-conductive-parts already sit at a
            different potential <em>before any fault occurs</em>. The protective measure for each is
            different: CPCs and protective devices for exposed; main protective bonding to the MET
            for extraneous.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              items, requires connection to the MET (not to a CPC or to an arbitrary earth point),
              references Chapter 54 for sizing, and explicitly excludes copper pipework fed from a
              plastic incomer. It also brings lightning protection into scope when LPS is fitted.
            </>
          }
        ...
        >
          <p>
            ...
            earth fault loop impedance Zs for a 30 mA RCD at U₀ = 230 V is 1667 Ω, derived from the
            touch-voltage limit:
          </p>
          ...
          <p>
            U_L = 50 V (the conventional touch voltage limit in dry conditions), IΔn = 0.030 A (the
            residual operating current of a standard RCD). Below 1667 Ω, a 230 V supply could push
            enough leakage current to earth that the touch voltage could rise above 50 V — so the
            part is treated as extraneous and bonded.
          </p>
          <p>The test method on site:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Above 1667 Ω:</strong> not extraneous — no main bonding required. Document the
              result in EIC notes for future inspectors.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The 1667 Ω in Table 41.5 (the maximum permitted Zs for a 30 mA RCD at 230 V) doubles
              up as the industry threshold for the "extraneous-conductive-part" test. Below it, a
              part can leak enough current to be hazardous and must be bonded; above it, it cannot.
              Same number, two uses.
            </>
          }
        ...
        >
          <p>The textbook items, all listed in Reg 411.3.1.2 or commonly tested:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Incoming metal oil service</strong> — usually only on rural properties with an
              outdoor tank. Bond at the entry point.
            </li>
            <li>
            ...
            <li>
              <strong>Lightning protection system (LPS) earth</strong> — bonded to the MET per Reg
              411.3.1.2 and BS EN 62305. Critical for tall buildings.
            </li>
            <li>
              <strong>Central heating and air-conditioning systems</strong> — generally bonded via
              the boiler/AHU casing CPC, but worth a continuity test on long runs.
            </li>
            <li>
        ...
        >
          <p>Reg 544.1 governs main bonding conductor sizing:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>TN-S and TT supplies (no PEN):</strong> not less than half the cross-sectional
              area of the earthing conductor, with a 6 mm² Cu minimum.
            </li>
            <li>
              <strong>TN-C-S supplies with PME conditions:</strong> Table 54.8 sets the minimum
              against the supply neutral cross-section. For neutrals up to 35 mm² Cu equivalent, 10
              mm² Cu minimum. Bigger supply neutrals → bigger bonding conductors (16/25/35/50 mm²
              Cu).
            </li>
            <li>
              <strong>Maximum cross-section requirement</strong> — bonding conductors do not need to
              exceed the cross-section of the earthing conductor.
            </li>
            <li>
              <strong>Mechanical protection</strong> — bonding conductors not protected against
              mechanical damage need to be larger; refer to Table 54.8 directly for the applicable
              column.
            </li>
          </ul>
          <p>
            On a typical UK domestic PME with a 25 mm² Cu supply neutral, the answer is{' '}
            <strong>10 mm² Cu</strong> for both incoming gas and water bonding. Each part runs back
            to the MET on its own dedicated conductor — no daisy-chaining.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You walk into a property, see a yellow plastic concertina coupling on the gas incomer,
              decide "plastic incomer = no bonding needed" and move on. You miss the fact that 600
              mm before the meter the supply transitions back to copper buried in the garden —
              meaning the internal copper pipework is still in conductive contact with the
              soil-earth via that buried section. Months later a fault elsewhere drives potential
              through the pipework; the customer’s metal cooker shell goes live during a fault
              clearance.
            </>
          }
          doInstead={
            <>
              ...
              shortcut only works when the entire incoming run is genuinely plastic from the supply
              main to the meter. Test it; don’t assume.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re reviewing an EICR drafted by another contractor on a 1990s commercial refurb.
              The previous electrician has fitted a 16 mm² Cu bonding conductor from an exposed
              structural RSJ over the entrance to the MET — proudly labelled "structural metalwork
              bonded per BS 7671". Your check measurement reads 4500 Ω from the RSJ to earth — well
              above the 1667 Ω threshold.
            </>
          }
          whatToDo={
            <>
              Recommend the bonding be removed. The RSJ isn’t extraneous (it can’t introduce a
              hazardous potential — it’s electrically isolated from ground at 4.5 kΩ), so bonding it
              provides no safety benefit. Worse, it now creates a parallel earth path between the
              MET and a previously-isolated structural element, dragging fault currents through the
              steel and creating EMF / circulating-current issues. Document the test result,
              recommend removal of the bond, and re-assess after removal.
            </>
          }
          whyItMatters={
            <>
              Over-bonding is as much a fault as under-bonding. It creates parallel earth paths,
              circulating currents, and drags fault current onto metalwork that wasn’t designed to
              carry it. The 1667 Ω test isn’t just about deciding what to bond — it’s about deciding
              what NOT to bond. Test, document, justify both directions of decision in EIC notes.
            </>
          }
        />
        ...
        >
          <p>Common items overlooked on real surveys:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Concealed pipework</strong> — in-floor or in-wall copper runs that originate
              from a separate cold-water tank or boiler and join the rest of the pipework only
              behind plasterboard. The visible portion in the airing cupboard is bonded; the buried
              section that links to ground gets forgotten.
            </li>
            <li>
              <strong>Rebar in concrete slabs</strong> with conductive joints (older construction).
              Acts as a buried earth electrode network. Rarely detectable from visual inspection —
              only test for it where suspected.
            </li>
            <li>
              <strong>Hidden expansion vessels</strong> in heating systems, particularly inside
              airing cupboards. The steel vessel is metal-pipework-connected via a copper T-piece;
              the entire heating circuit can be extraneous if it routes back to a shared earth
              elsewhere.
            </li>
            <li>
              <strong>Grease traps and drainage with conductive joints</strong> — commercial
              kitchens, in particular, where the cast iron drain bonds back to ground via the pipe
              network.
            </li>
            <li>
              <strong>Conduit/trunking between buildings</strong> on multi-block sites. The
              conductive route may bridge two earthing systems, requiring careful design to avoid
              parallel earth paths.
            </li>
            <li>
              <strong>Lightning protection earth not bonded to the MET</strong> — common on older
              installations where the LPS was retrofitted by a separate contractor. Reg 411.3.1.2
              explicitly requires this bond.
            </li>
            <li>
              <strong>External metalwork in plant rooms</strong> — metal boiler stand, chiller plant
              base, generator skid frames. Each can be extraneous if buried fixings link them to
              ground.
            </li>
          </ul>
        </ConceptBlock>
