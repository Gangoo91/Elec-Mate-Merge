...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['0.80 ohm', '0.50 ohm', '1.07 ohm', '1.37 ohm'],
    correctAnswer: 0,
    explanation:
  ...
  {
    id: 5,
    question: 'Which of these is the most common over-bonding mistake on a modern UK new-build?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Three real installs walked end-to-end — domestic TN-C-S (PME), commercial TT, small
          industrial IT. Same five-step pattern (system, ADS, exposed parts, extraneous parts, Zs),
          three flavours of practice.
        </p>
        ...
        <ConceptBlock title="Five Subs in, you have the toolkit — this Sub puts it on three real installs">
          <p>
            Sub 4.1 introduced the five earthing systems (TN-S, TN-C-S PME, TN-C-S PNB, TT, IT) and
            how to identify each at the cut-out. Sub 4.2 broke down ADS into its component chain —
            source, line conductor, fault, exposed part, CPC, MET, earthing conductor, supply path —
            with the disconnection times in Table 41.1. Sub 4.3 defined exposed-conductive-parts
            (Part 2 verbatim — equipment metalwork that can become live under fault) and the Class
            II exception. Sub 4.4 defined extraneous-conductive-parts (Part 2 verbatim — metalwork
            outside the installation that can introduce a potential), the 1667 ohm test and the
            over-bonding trap. Sub 4.5 walked the earth fault loop (Ze + R1+R2 = Zs), the Tables
            41.3 and 41.5 maximum values, and the 0.8 hot-cable correction.
          </p>
          <p>
            This Sub takes the same five-step pattern and applies it to three contrasting installs.
            Same theory, three flavours of practice — what changes is the supply arrangement, the
            protective device strategy and the Zs you should expect to measure.
          </p>
          <p className="text-[13px] text-white/75 italic">
            Tool-bag thread: an MFT (multi-function tester) reads Ze at the MET, R1+R2 along each
            circuit and Zs at the furthest point. Same instrument, three different expected ranges
            depending on which earthing system you are testing.
          </p>
        </ConceptBlock>
        ...
        >
          <p>You arrive on day one. Open the cut-out cover. You see:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>A single combined N+PE conductor arriving from the DNO (the PEN).</li>
            <li>
              The PEN splits at the service position into the supply neutral going to the meter and
              an earth strap going up to the MET inside the consumer unit.
            </li>
            <li>
              The MET is a labelled terminal block in or beside the CU, with the earthing conductor
              (typically 16 mm² on a domestic PME), main protective bonding conductors out to gas
              and water (10 mm² on PME), and the CPCs from every final circuit all landing on it.
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Step 1 — system identified. Step 2 — walk the ADS chain.">
          <p>The ADS chain on a TN-C-S install (Sub 4.2):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Source — distribution transformer secondary, neutral point earthed at the substation.
            </li>
            <li>
              Line conductor through the supply cable to the cut-out, through the meter and CU main
              switch, through the RCBO for Cct 5 (kitchen ring), through the 2.5 mm² T&E line, to
              the appliance.
            </li>
            <li>
              Fault — line conductor touches the metal case of, say, a kitchen fridge-freezer.
            </li>
            <li>Exposed-conductive-part — the appliance casing.</li>
            <li>
              CPC — the 1.5 mm² CPC of the kitchen ring, back through the ring to the CU CPC bar, to
              the MET.
            </li>
            <li>Earthing conductor — MET back down to the cut-out earth strap.</li>
            <li>Cut-out earth strap → DNO PEN → back to the substation neutral point.</li>
          </ul>
          <p>
            Loop closed. Fault current flows. The 32 A Type B RCBO sees ~5x trip current and
            disconnects in well under 0.4 s. The 30 mA RCD function provides additional protection
            per Reg 411.4 / 415.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Step 3 — exposed parts. Step 4 — extraneous parts (with the over-bonding trap).">
          <p>
            <strong>Exposed parts in this kitchen extension:</strong> the steel back-boxes behind
            every socket and switch, the metal faceplates if specified, the metal housing of the
            integrated oven and induction hob, the metal case of the boiler (Class I), the CU
            enclosure itself if metal-clad. Each is fed via a CPC back to the MET. The
            double-insulated kettle (Class II — the concentric squares symbol) has no
            exposed-conductive-part requiring CPC connection.
          </p>
          <p>
            <strong>Extraneous parts:</strong> the incoming gas service (still metal in this 1990s
            build) and the incoming water service (also metal). Both got main protective bonding at
            the original install — 10 mm² Cu (PME minimum). Verify both bonds are still in place and
            tight before energising the new circuit. Apply the 1667 ohm test if there is any doubt
            about whether a particular metal item (e.g. an old oil-line stub coming through a wall)
            qualifies as extraneous.
          </p>
          <p>
            <strong>The over-bonding trap on a modern equivalent:</strong> if this had been a
            new-build instead, with plastic incoming water and plastic incoming gas, the internal
            copper stubs do NOT need bonding (NOTE to Reg 411.3.1.2 — they are unlikely to be
            extraneous because they have no external earth path). Bonding them anyway can actually
            introduce a potential onto floating metalwork during a PME diverted-neutral event —
            making things worse, not better.
          </p>
        </ConceptBlock>

        <ConceptBlock title="Step 5 — measure Zs at the furthest socket on the new ring.">
          <p>Final circuit: 32 A Type B RCBO. From Sub 4.5 / Table 41.3:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Table 41.3 max Zs for B32 at 0.4 s, 230 V: <strong>1.37 ohm</strong>.
            </li>
            <li>
              Apply 0.8 hot-cable correction: max permitted measured Zs = 1.37 x 0.8 ={' '}
              <strong>1.10 ohm</strong>.
            </li>
            <li>
              Measured Ze at MET (loop test with installation isolated): <strong>0.30 ohm</strong>.
            </li>
            <li>
              Maximum allowable measured R1+R2: 1.10 - 0.30 = <strong>0.80 ohm</strong>.
            </li>
          </ul>
          <p>
            You measure R1+R2 by continuity test across line and CPC at the furthest socket with a
            wander lead, or by direct Zs measurement with the MFT loop function. Reading Zs = 0.55
            ohm — pass with comfortable margin. Reading Zs = 1.05 ohm — just compliant, investigate
            (long run? slack termination? CPC undersized?). Reading Zs = 1.20 ohm — fail, do not
            energise.
          </p>
        </ConceptBlock>
        ...
        >
          <p>You arrive on day one. Open the meter cabinet. You see:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Overhead supply terminating in a service head — line and neutral only, NO earth from
              the DNO.
            </li>
            <li>
              A 1.2 m copper-clad steel earth electrode driven into the ground next to the cabinet,
              with a green/yellow earthing conductor (10 mm² typical) running into the building to
              the MET.
            </li>
            <li>
              Origin protection: 100 A main switch + 100 mA S-type (selective / time-delayed) RCD at
              the origin, then 30 mA Type A RCBOs on each final circuit.
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Step 1 — system identified. Step 2 — walk the ADS chain.">
          <p>The ADS chain on a TT install (Sub 4.2):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Source — distribution transformer secondary, neutral point earthed at the substation
            ...
            <li>
              ...
              the 100 mA RCD, through the final-circuit RCBO, to the appliance.
            </li>
            <li>
              Fault — line conductor touches the metal case of (say) an electric heater in the
              office.
            </li>
            <li>Exposed-conductive-part — heater casing.</li>
            <li>CPC — back through the final circuit to the CU CPC bar to the MET.</li>
            <li>Earthing conductor — MET to your local earth electrode.</li>
            <li>Earth electrode → soil → substation electrode → back to the source neutral.</li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Step 3 — exposed parts. Step 4 — extraneous parts (TT version).">
          <p>
            ...
            metal-cased equipment, SWA armouring on any external runs. Each fed by a CPC back to the
            MET, which is connected to the local earth electrode.
          </p>
          <p>
            <strong>Extraneous parts:</strong> on a small rural office, the candidates are fewer
            than a kitchen — no incoming gas service, water may come in via a private metal supply
            pipe from a well or via mains-fed copper. Apply the 1667 ohm test — measure between the
            suspect metalwork and the MET. Below 1667 ohm = bond. Above = do not.
          </p>
          <p>
            <strong>The TT-specific bonding wrinkle:</strong> on TT, the entire installation is sat
            at "MET potential" which is referenced to your local electrode, not to the DNO earth
            (because there is no DNO earth). Diverted-neutral concerns from PME do not apply — but
            the fact that your MET potential and the DNO neutral potential can differ during a fault
            means main protective bonding becomes even more important for keeping touch voltages
        ...
        <ConceptBlock title="Step 5 — measure Zs and verify Ra x I-delta-n <= 50 V.">
          ...
          <p>
            The condition to verify (Reg 411.5.3): <strong>Ra x I-delta-n &lt;= 50 V</strong>. Where
            Ra = electrode resistance + protective conductor + CPC; I-delta-n = RCD trip threshold.
          </p>
          <p>
            Measured Ra (electrode resistance test): 35 ohm. RCD I-delta-n = 0.030 A. Touch voltage
            = 35 x 0.030 = <strong>1.05 V</strong>. Comfortably under 50 V — pass.
          </p>
          <p>
            Repeat the same calculation for the 100 mA origin RCD: 35 x 0.100 = 3.5 V — also fine.
            And cross-check Ra is well under the Table 41.5 limit (1667 ohm for 30 mA, 500 ohm for
            100 mA) — yes, 35 ohm is comfortably within both.
          </p>
          <p>
            The third check: Ra should be as low as practically achievable. Typical UK rural soil
            gives 20-50 ohm on a single 1.2 m rod. Anything above 200 ohm is flagged in the regs as
            potentially unstable (changes with soil moisture, freezing, etc) — if your reading is up
            there, drive a longer rod or add a second rod in parallel.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The legal anchor for TT installations. The RCD does the work, the electrode gives the
              fault current somewhere to flow, and Ra x I-delta-n must keep the touch voltage on
              exposed-conductive-parts below 50 V during the disconnection time. Table 41.5 gives
              the headline maximum Zs values: 1667 ohm at 30 mA, 500 ohm at 100 mA, 167 ohm at 300
              mA, 100 ohm at 500 mA. Apprentices regularly under-spec the protection on TT thinking
              "TT just works like TN-C-S" — Reg 411.5.3 is what you point at to explain why it does
              not.
            </>
          }
        ...
        >
          <p>You arrive at the theatre plant room. You see:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              A medical isolating transformer (typically 7-10 kVA for a single theatre) — the source
              for the IT-supplied circuits.
            </li>
            <li>
              The transformer secondary is isolated from earth (or earthed via a high impedance,
              depending on the design).
            </li>
            <li>
              An insulation monitoring device (IMD) on the secondary side, continuously measuring
              insulation resistance to earth on every conductor.
            </li>
            <li>
              A visual + audible alarm at the theatre operating panel — illuminates and beeps when
              the IMD detects a first fault.
            </li>
            <li>
        ...
        <ConceptBlock title="Step 1 — system identified. Step 2 — walk the ADS chain.">
          <p>The ADS chain on an IT install (Sub 4.2 + Reg 411.6):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Source — medical isolating transformer secondary, NOT directly earthed.</li>
            <li>Line conductor through theatre distribution to the equipment.</li>
            <li>
              <strong>First fault</strong> — one conductor touches an exposed-conductive-part.
              Because the source is not earthed, there is no low-impedance return path. Fault
              current is limited to the small leakage / capacitance of the rest of the system. Touch
              voltage stays well below 50 V (Reg 411.6.2: Ra x Id &lt;= 50 V is satisfied because Id
              is tiny on first fault). The IMD detects the change in insulation resistance and
              raises the alarm. The system stays running. Theatre staff finish the surgery.
            </li>
            <li>
              <strong>Engineer responds.</strong> Locate the first fault using insulation fault
              location systems (IFLS, optional but common on critical IT) or by systematic
              isolation. Repair before a second fault occurs.
            </li>
            <li>
              <strong>Second fault</strong> on a different live conductor (BEFORE the first is
              cleared) — now closes a fault loop through the interconnecting CPCs. Fault current
              rises to TN-style levels. Per Reg 411.6.5(a), the protective device disconnects in the
              same disconnection time as the equivalent TN system (Table 41.1: 0.4 s for AC final
              circuits at 230 V).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Step 3 — exposed parts. Step 4 — extraneous parts (IT version).">
          <p>
            <strong>Exposed parts:</strong> on an IT theatre — the metal casings of every piece of
            medical equipment, the operating table mount, theatre lights, anaesthesia machine cases,
            trunking, back-boxes. All interconnected by protective conductor and earthed (the "I" of
            IT means the SOURCE is not earthed — exposed parts of the installation absolutely are,
            per Reg 411.6.2).
          </p>
          <p>
            <strong>Extraneous parts:</strong> the metalwork of any incoming services to the theatre
            (medical gases pipework, water for sinks, structural steel of the suspended ceiling grid
            if it is part of the theatre envelope, the floor itself if conductive). All bonded to a
            Patient Equipotential Bonding Bar (PEBB or similar) to keep every touchable surface in
            the theatre at the same potential. The 1667 ohm test still applies for deciding whether
            a metal item is extraneous.
          </p>
          <p>
            <strong>The IT-specific bonding philosophy:</strong> on IT in critical environments
            (theatres, life-support, MRI), equipotential bonding is taken to a higher level than
            TN/TT. Every conceivable touchable conductive surface in the patient zone is bonded
            together. Touch voltages between any two bonded surfaces stay near zero even during a
            first fault.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Step 5 — Zs and the second-fault disconnection.">
          <p>
            On IT, Zs takes a different meaning. There is no normal fault loop on first fault (the
            source is not earthed). The Zs that matters is the fault loop on the SECOND fault — Reg
            411.6.5(a) gives the conditions where exposed parts are interconnected by a CPC.
          </p>
          <p>
            For a 32 A Type B circuit (AC, 230 V), the second-fault disconnection time per Table
            41.1 (TN values) is <strong>0.4 s</strong>. The fault loop on a second fault comprises
            the line conductor of one circuit, the interconnecting CPC, and the protective conductor
            + neutral path back through the other faulty circuit. The maximum Zs is the same 1.37
            ohm Table 41.3 value (corrected to 1.10 ohm on the hot-cable basis) — the same maths as
            Walk 1, just only relevant once two faults have happened.
          </p>
          <p>
            In practice, on a well-maintained IT system the first fault is repaired long before a
            second occurs. The IMD is continuously monitoring; the alarm is loud and visible; the
            maintenance regime is more disciplined than TN/TT. The whole point of IT is that the
            SECOND fault is the protective event, not the first.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Verbatim. The "I" of IT is about the source (isolated from earth or high-impedance
              earthed). Exposed-conductive-parts on the installation side are still earthed —
              individually, in groups or collectively. The 50 V touch-voltage condition still
              applies on first fault, but Id is small (because the source is not directly earthed)
              so the condition is easily satisfied. Common apprentice misconception: "IT means no
              earthing" — wrong, see Quiz 3.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The reason there is an IMD beeping in the theatre. IT systems designed to keep running
              through a first fault MUST have insulation monitoring with an audible and/or visual
              alarm that persists until cleared. This is what gives staff the window to finish the
              surgery and call the engineer rather than losing supply mid-procedure. Engineers must
              respond to first-fault alarms — they are the trigger for a controlled repair before a
              second fault makes it dangerous.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              IT: medical isolating transformer / process supply, source isolated or high-impedance
              earthed.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              TN-C-S: low Ze means MCB/RCBO sees high fault current, disconnects on overcurrent in
              0.4 s.
            </li>
            <li>
              TT: high Ze means RCD does the work, mandatory at origin per Reg 411.5.3, disconnects
              in 0.2 s.
            </li>
            <li>
              IT: first fault does not disconnect, IMD raises alarm; second fault disconnects per TN
              times (Reg 411.6.5).
            </li>
          </ul>
          <p>
            <strong>Exposed parts (Step 3):</strong> identical philosophy on all three — equipment
            metalwork, all CPC-connected back to the MET. Class II exception applies to all three.
          </p>
          <p>
            <strong>Extraneous parts (Step 4):</strong> 1667 ohm test applies on all three. Bonding
            sized per Reg 544.1: 6 mm² typical TN-S, 10 mm² minimum on PME (or 25 mm² on large
            supplies). On IT in patient areas, additional Patient Equipotential Bonding takes it
            further.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              TN-C-S B32: Table 41.3 = 1.37 ohm, hot-cable corrected = 1.10 ohm. Ze ~0.30 ohm
              typical.
            </li>
            <li>
              TT 30 mA RCD: Table 41.5 = 1667 ohm. Ra x I-delta-n &lt;= 50 V is the binding test,
              not Zs.
            </li>
            <li>
              IT: first-fault Zs irrelevant; second-fault Zs same as equivalent TN per Reg
              411.6.5(a).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice tasked with running new circuits into a theatre extension hears "this is
              IT" and assumes earthing is not required. They terminate the new accessories without
              connecting CPCs to the theatre back-boxes. First fault on one of the new circuits
              causes the IMD to alarm; engineer investigates and finds an entire run with no
              equipotential bonding. Whole batch of new work has to be redone before the theatre can
              be commissioned.
            </>
          }
          doInstead={
            <>
              The "I" of IT refers to the SOURCE being isolated from earth. The installation side
              absolutely still needs CPCs, MET, equipotential bonding — Reg 411.6.2 requires exposed
              parts to be earthed (individually, in groups or collectively). Equipotential bonding
              is even more important on IT in critical settings because the second-fault
              disconnection times depend on the fault loop impedance through the interconnecting
              CPCs. If anything, the wiring discipline on IT is tighter than on TN/TT, not looser.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice on a barn conversion (TT supply) wires a new 32 A radial for an immersion.
              Fits a B32 MCB, no RCD function, on the basis "MCB worked fine for the same circuit at
              home". Day after first-fix, an inspector spots no RCD on origin or final-circuit
              protection. The whole CU has to be swapped for one with RCBOs throughout.
              Embarrassment and cost both at the apprentice's firm's expense.
            </>
          }
          doInstead={
            <>
              TT requires RCD protection per Reg 411.5.3 — not as a custom but as a regulation
              requirement. Earth electrode resistance is too high for an MCB to ever clear an earth
              fault in the required disconnection time. Fit RCBOs (combined RCD + overcurrent) on
              every final circuit, with a 100 mA S-type at origin for discrimination if required.
              Same logic applies to caravans, marinas, agricultural buildings — anywhere TT is used.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              neutral, the lead sheath carries a green/yellow strap to the MET. Your supervisor is
              on the phone and waves you in. You start carcassing the new ground-floor ring final
              assuming TN-S Ze around 0.8 ohm and B32 RCBOs throughout. Half an hour later the
              supervisor comes off the phone and tells you the DNO upgraded the supply to TN-C-S
              (PME) six months ago — but the cabling and bonding in the cabinet were never updated.
            </>
          }
          whatToDo={
            <>
              Stop, do not energise anything, raise the issue with the supervisor immediately. The
              bonding is sized for TN-S (6 mm² typical) when the supply is now PME (10 mm² minimum
              on a domestic, more on a commercial). The earthing arrangement at the cut-out has to
              be brought up to PME spec before you carry on with the install. Verify the supply
              system in writing with the DNO if there is doubt — never assume from the look of the
              cabinet. The lead sheath connection might still be in place from the old TN-S days but
              with a PME supply now sat on top of it, everything downstream needs reviewing.
            </>
          }
          whyItMatters={
            <>
              ...
              certificate. The DNO is responsible for the supply side; the installer is responsible
              for getting the installation-side decisions right against whatever the DNO has
              provided. A five-minute conversation to confirm the supply system before you start
              saves a re-do of all the bonding later.
            </>
          }
        />
