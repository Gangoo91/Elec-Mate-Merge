...
const TITLE = 'UK distribution network components (5.4) | Level 2 Module 3.5.4 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question: 'The Main Earthing Terminal (MET) on a typical TN-C-S installation is located:',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'The fuse inside the DNO cut-out on a typical UK domestic property is:',
    options: [
  ...
  {
    id: 4,
    question: 'On a TN-C-S (PME) supply, the consumer’s earth comes from:',
    options: [
...
const faqs = [
  ...
  {
    question:
      'What is the difference between a service head, a cut-out, and a service termination?',
    answer:
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 5 · Subsection 4"
        title="UK distribution network components"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Tour the kit between the transmission grid and your CU. Eight named items every
          electrician sees in the wild — from the grid supply point at the top, through primary and
          secondary substations, all the way to the cut-out, meter and MET inside the customer’s
          premises.
        </p>
        ...
        >
          ...
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70 marker:font-semibold">
            <li>
              <strong>Grid supply point (GSP).</strong> The substation where the transmission
              network (NGET / SPT / SHET) hands off to the distribution network (DNO). Steps voltage
              down from 400 kV / 275 kV to 132 kV / 66 kV / 33 kV depending on region.
            </li>
            <li>
              <strong>Primary substation.</strong> 33 kV in, 11 kV out. Town-scale, fenced outdoor
              compound. Two transformers typical, 30–60 MVA each. Owned by DNO.
            </li>
            <li>
              <strong>11 kV switchgear.</strong> Inside the primary substation and at strategic
              switching points along the 11 kV feeders. Lets the DNO open, close, isolate and
              protect sections of the network. Houses the protection relays that decide fault
              current flowing downstream.
            </li>
            <li>
              <strong>Secondary substation.</strong> 11 kV in, 400 V three-phase / 230 V
              single-phase out. Street-scale. Three forms: pole-mount can (PMT), pad-mount kiosk,
              indoor brick housing. Capacity 200–800 kVA typical, feeding 50–200 properties.
            </li>
            <li>
              <strong>Service cable.</strong> The DNO-owned cable that runs from the secondary
              substation (or a joint box in the street) to the property. Modern cable is concentric
              ALPVC (aluminium with a concentric neutral); older installs use PILC (paper-insulated
              lead-covered) — still common under city pavements.
            </li>
            <li>
              <strong>DNO cut-out.</strong> The sealed housing inside the property containing the
              supply fuse (BS 1361 or BS 88-3, typically 60 A / 80 A / 100 A) and the supplier’s
              earth terminal. Last item the DNO owns.
            </li>
            <li>
              <strong>Electricity meter.</strong> Owned by the MOP (Meter Operator), contracted by
              the energy supplier. Records kWh consumed (and exported, for generators). Smart meters
              increasingly standard since the 2014 rollout.
            </li>
            <li>
              <strong>Main earthing terminal (MET).</strong> The customer-side hub for the
              installation’s earth. Connected via the earthing conductor to the supplier’s earth
              terminal at the cut-out (on TN-C-S and TN-S) or to the customer’s own earth electrode
              (on TT). Protective conductors (CPCs) and bonding conductors fan out from the MET into
              the installation.
            </li>
          </ol>
          <p>
            Downstream of the MET sits the main isolator (often a 100 A double-pole switch installed
            by the customer or contractor), the meter tails on the customer side, and the consumer
            unit. From the consumer unit, BS 7671 governs everything. Before the cut-out, ESQCR
            governs everything. The boundary at the meter is the electrician’s working line.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            typically 4–6 m wide, 6–8 m long, 4 m tall, weighs 60–80 tonnes, and is filled with
            mineral oil for both insulation and cooling. The transformer steps down from 33 kV
            three-phase to 11 kV three-phase, with a tap-changer on the high- voltage winding to
            compensate for daily and seasonal voltage changes upstream.
          </p>
          <p>
            Switchgear at the primary substation manages both the 33 kV side (incoming) and the 11
            kV side (outgoing). Each outgoing 11 kV feeder has its own circuit breaker, with
            overcurrent and earth-fault protection relays that will trip the breaker if a fault
            appears anywhere on that feeder. Modern installs use SF6 metal-clad indoor switchgear;
            older installs are open-air outdoor with porcelain disconnectors.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Three secondary substation forms in common UK use:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pole-mounted transformer (PMT).</strong> A galvanised steel or fibreglass can
              hung between two poles, 4–6 m off the ground. 11 kV in on a cross-arm above (with
              three drop-out fuse mounts as protection); 400 V three- phase out on a smaller
              cross-arm below, with the LV cable dropping into an underground feeder or onto an
              overhead service line. Typical capacity 50, 100 or 200 kVA. Common in rural areas,
              villages, isolated farms.
            </li>
            <li>
              <strong>Pad-mounted (kiosk) transformer.</strong> A sealed metal cabinet (or in older
              installs, a brick housing) sitting on a concrete pad, 1.5–2 m tall and 2–3 m wide. 11
              kV switchgear inside (often a ring-main unit, RMU, so the substation can be looped in
              and out of the 11 kV ring without disconnecting other downstream substations);
              transformer; LV fuse cabinet. Output cables run underground to the houses. Typical
              capacity 315–800 kVA. Most modern urban substations are this form.
            </li>
            <li>
              <strong>Indoor substation.</strong> A brick or precast concrete building containing
              the transformer, 11 kV switchgear and LV distribution board. Used where load is large
              enough to need a 1–2 MVA unit, or where space doesn’t permit an outdoor kiosk — flats,
              supermarkets, hospitals, small industrial estates.
            </li>
          </ul>
          <p>
            ...
            properties on the street) is what shapes prospective fault current, voltage drop, supply
            impedance and supply quality at every cut-out. A small overloaded 200 kVA PMT with a
            long radial feeder behind it gives a very different supply profile from a fresh 800 kVA
            kiosk feeding a tight underground LV ring.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The service cable enters the property either through an under-floor sleeve, an external
            wall sleeve, or up the side of the building from an overhead connection (rare in modern
            builds but very common in older rural property). It terminates at the cut-out — usually
            within 2 m of where the cable enters the property.
          </p>
          <p>
            Service cable sizing is driven by maximum demand and length. For a typical UK domestic
            single-phase 100 A service cable is 25 mm² ALPVC; for three-phase 100 A per phase it’s
            35 mm² four-core. Older 60 A and 80 A services often used 16 mm² or 25 mm² PILC. The DNO
            sizes the service for the agreed maximum demand declared when the connection was first
            installed; if the customer adds load (EV charger, heat pump) that exceeds it, the DNO
            has to be notified and may need to uprate the cable.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The cut-out has three principal jobs:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Overcurrent protection.</strong> The internal HRC fuse (60 A, 80 A or 100 A
              typical for domestic) protects the service cable from any fault current that would
              otherwise destroy it. A bolted line-earth or line-neutral fault downstream of the
              cut-out blows the fuse, isolating the property from the network.
            </li>
            <li>
              <strong>Isolation point.</strong> Pulling the cut-out fuse is the only way to
              completely de-energise the customer’s installation (since the meter has no isolator on
              the load side). This is why CU swaps need DNO attendance — the fuse has to come out
              for the duration of the work.
            </li>
            <li>
              <strong>Supplier’s earth terminal.</strong> A small terminal block on the outside of
              the cut-out housing where the customer’s earthing conductor connects to the supply
              earth. On TN-C-S this is where the PEN conductor splits into separate N and PE.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            Meter tails on the meter side (between cut-out and meter) are the MOP’s. Meter tails on
            the load side (between meter and consumer unit) are the customer’s and fair game for the
            electrician. Both look identical (typically 25 mm² single-core singles in red/black or
            brown/blue) but they’re separated by a regulatory line that runs through the middle of
            the meter terminals.
          </p>
          <p>
            When you’re replacing a consumer unit, you’re replacing everything from the load-side
            meter terminals onwards. The MOP-side tails stay put. If they’re damaged or undersized
            you have to ask the MOP to attend — not do it yourself.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            How the MET is fed depends on the supply earthing arrangement (covered in detail in §4
            of this module — recap here for context):
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>TN-C-S (PME).</strong> The most common modern UK supply. The MET is fed from
              the supplier’s earth terminal at the cut-out, which in turn comes from the combined
              PEN conductor of the service cable. Earth and neutral share a conductor all the way
              back to the substation.
            </li>
            <li>
              <strong>TN-S.</strong> Older urban supplies, often where the service cable is PILC.
              The earth comes from the lead sheath of the service cable, separate from the neutral
              all the way back to the substation. Increasingly rare in modern installs but still
              common in pre-1980s urban property.
            </li>
            <li>
              <strong>TT.</strong> No DNO-supplied earth. The customer installs their own earth
              electrode (typically a 1.2 m copper-bonded rod driven into the ground) and the MET
              connects to it. Common on rural overhead supplies, on installations where TN-C-S has
              been refused (e.g. caravans, fuel stations where PEN faults could cause fire), and on
              some boatyards / marinas. Always requires RCD protection because the earth fault loop
              impedance through soil is too high to rely on overcurrent protection alone.
            </li>
          </ul>
          <p>
            The MET is the electrician’s anchor point for every protective conductor in the
            installation. Get the MET wrong (loose connection, oversize bond bolted with undersize
            lug, missing bonding to a metal water service) and the whole earthing system fails —
            every CPC in the install is only as good as the connection at the MET.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DNO assets:</strong> service cable, cut-out, supplier’s earth terminal.
              Sealed. Hands off without DNO authority.
            </li>
            <li>
              <strong>MOP assets:</strong> meter, plus the meter tails between cut-out and meter
              (the ‘meter side’ tails). Not sealed in the same way as the cut-out, but still not the
              electrician’s to replace or modify without MOP authority.
            </li>
            <li>
              <strong>Customer assets:</strong> the meter tails between meter and main
              isolator/consumer unit, the main isolator (if fitted), the consumer unit itself, and
              everything downstream. Fair game for the electrician. BS 7671 applies.
            </li>
          </ul>
          <p>
            The practical implication for jobs: a CU swap means working only on the customer side.
            You need the supply isolated (DNO pulls the fuse). You don’t need to touch the meter,
            the meter-side tails, or the cut-out — the DNO/MOP do that side for you. If the
            meter-side tails are knackered or undersized for the new CU, you flag it to the MOP and
            they attend separately.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The DNO has a statutory duty to provide an earth where it’s practicable — that’s why
              most modern UK supplies are TN-C-S (PME). It’s only TT (no DNO earth) where TN-C-S or
              TN-S can’t be safely supplied — typically at the end of long overhead rural feeders.
              The form of earthing is declared by the DNO on the connection certificate; the
              electrician designs the installation to suit. See §4 of this module for the full
              earthing systems coverage.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The MET is the customer-side compulsory hub. BS 7671 requires it to exist, to be
              accessible (so future inspection and testing can verify the connections), and to be
              reliable (no loose bolts, no painted-over surfaces, no daisy-chained conductors). In
              practice: the MET is the first thing to inspect when you arrive at an unfamiliar
              installation — its condition tells you everything about the rest of the earthing
              system.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice on a CU swap finds the DNO is busy, the customer is impatient, they figure
              they’ll just cut the seal, pull the fuse, do the work, and put a new seal on. Three
              things wrong. First, breaking the seal without authority is a criminal offence under
              the Theft Act if any abstraction is alleged (which the DNO can and sometimes does).
              Second, every electrical scheme membership condition (NICEIC, NAPIT, ELECSA) requires
              you to leave DNO kit alone — breach can mean removal from the scheme. Third, you have
              no idea what seal type the DNO is using on the network — fitting your own ‘seal’ may
              actually flag the property to the DNO as tampered.
            </>
          }
          doInstead={
            <>
              Phone 105 (or your DNO’s direct line) and book the supply isolation with them. They
              will attend, break the seal, pull the fuse, leave you to do the work, and re-seal
              afterwards. Cost is usually free if the customer is on a domestic supply and the work
              is routine. Some DNOs run a Withdrawal of Consent agreement that lets registered
              contractors break and replace seals themselves on agreed properties — apply for it
              through your scheme provider if you’re doing CU swaps regularly. Either way, it’s
              organised work, not ad-hoc.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You arrive at a property to commission a 4 kW PV install. The DNO cut-out fuse is
              rated 60 A and the property’s existing total demand + PV inverter output exceeds it.
              The qualified supervisor isn’t on site yet. The customer is pushing to get the system
              live before they go on holiday tomorrow. Your apprentice mate quietly suggests cutting
              the cut-out seal, pulling and upsizing the fuse to 80 A, and resealing it before
              anyone notices. What do you do?
            </>
          }
          whatToDo={
            <>
              Stop, full stop. The cut-out fuse rating is set by the DNO to match the service cable
              rating — you cannot arbitrarily upsize it without the DNO attending and verifying that
              the underlying service cable can handle the higher current. Even if the cable can, the
              change has to be recorded on the DNO’s asset records or future maintenance gets the
              rating wrong. And the PV connection itself needs notification to the DNO under ENA G98
              (small generator): you can’t just energise it and walk away. The right answer: phone
              the DNO, declare the proposed PV connection (G98 form, online), book a service uprate
              if needed, and only commission the PV once the paperwork is done. If the customer
              can’t wait — that’s their problem to solve, not yours. Never the apprentice’s problem
              to solve by cutting a seal.
            </>
          }
          whyItMatters={
            <>
              The cut-out seal is the most visible enforcement device in the whole supply chain. Cut
              it without authority and you create a paper trail (DNO inspection later finds the
              resealed cut-out, asset records don’t match) that ends with the customer being
              recharged for tampering, your scheme membership being reviewed, and the PV install
              being disconnected. The downside of doing it right is one phone call and a delay. The
              downside of doing it wrong is career-ending.
            </>
          }
        />
        ...
        <Quiz title="Distribution network components — knowledge check" questions={quizQuestions} />

        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level2/module3/section5/5-3')}
