...
const TITLE = 'Transmission voltages (5.2) | Level 2 Module 3.5.2 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question: 'Which of the following is NOT one of the three principal UK transmission voltages?',
    options: ['400 kV', '132 kV', '275 kV', '66 kV'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['132 kV', '400 kV', '275 kV', '500 kV'],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 6,
    question: 'A grid supply point (GSP) is the substation where:',
    options: [
  ...
  {
    id: 7,
    question: 'Why does GB transmission use AC and not DC for cross-country transfers?',
    options: [
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 5 · Subsection 2"
        title="Transmission voltages"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Once electricity leaves the generator it goes UP to silly voltages to travel cheaply, then
          comes back DOWN. Three transmission tiers — 400 kV, 275 kV, 132 kV — owned and operated by
          the transmission companies, governed by ESQCR and the Grid Code rather than BS 7671.
        </p>
        ...
        >
          <p>
            The power transferred down a three-phase line is <strong>P = √3 × V × I × cos φ</strong>
            . For a given power demand, the only way to lower the current is to raise the voltage.
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>At 11 kV three-phase:</strong> I = 1000 × 10⁶ / (1.732 × 11,000) ≈ 52,500 A.
              P_loss = 52,500² × 5 ≈ 13.8 GW. That is more than the power being sent. Physically
              impossible.
            </li>
            <li>
              <strong>At 132 kV:</strong> I ≈ 4,374 A. P_loss = 4,374² × 5 ≈ 95.6 MW. Roughly 9.5%
              loss. Still painful but technically workable.
            </li>
            <li>
              <strong>At 400 kV:</strong> I ≈ 1,443 A. P_loss = 1,443² × 5 ≈ 10.4 MW. Roughly 1%
              loss. Acceptable.
            </li>
          </ul>
          <p>
            That is why every cross-country transfer in GB happens at 400 kV. The voltage gets
            stepped up at the power-station transformer (from ~26 kV at the alternator terminals to
            400 kV) and stepped back down at the grid supply point. The transformers cost money and
            have their own losses (~0.5% each), but the saving on line losses dwarfs both.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            Midlands, and the western route through Lancashire, the Midlands and the South West.
            Most major power stations connect at 400 kV (or to the lower 275 kV tier and step up
            further at a switching station).
          </p>
          <p>
            A typical 400 kV pylon carries two complete circuits — six phases in total arranged in
            two stacks of three, each phase being a bundle of 2 or 4 sub-conductors held apart by
            aluminium spacers. The bundling reduces corona losses and lowers the line reactance,
            raising the power transfer capability.
          </p>
          <p>
            Owners: <strong>NGET</strong> (National Grid Electricity Transmission) in England and
            Wales, <strong>SP Transmission (SPT)</strong> in Southern Scotland,
        ...
        >
          <p>
            275 kV is widely used on the eastern side of the country and around the major English
            conurbations. Pylons are noticeably smaller than 400 kV — typically 25–35 m — and
            conductors are usually single rather than bundled.
          </p>
          <p>
            In some areas (particularly Scotland and the south-east of England) the 275 kV system
            feeds directly into 132 kV and 33 kV networks without going through 400 kV at all. In
            other areas it acts as a step between the 400 kV super-grid and the 132 kV system.
          </p>
          <p>
            Same owners as 400 kV: NGET, SPT, SHET. The line current at 275 kV for the same power
            transfer is √(400/275) ≈ 1.45× the 400 kV current — so I²R losses are roughly twice the
            400 kV equivalent. That is why long-distance bulk transfers prefer 400 kV.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            132 kV is the original UK transmission voltage. The first National Grid was completed in
            1933 at 132 kV and ran for two decades before 275 kV super-grid extensions began in the
            late 1950s. Today 132 kV survives as the lower transmission tier — and in some regions
            as the upper distribution tier.
          </p>
          <p>The classification depends on geography:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>England and Wales:</strong> 132 kV is distribution, owned by the local DNO
              (e.g. UK Power Networks own the 132 kV ring round London). Counted as ‘extra-high
              voltage distribution’ in industry parlance.
            </li>
          </ul>
          <p>
            Either way, it acts as the network that takes power from the grid supply point into the
            primary substations that feed individual towns. Power transfer at 132 kV for a typical
            primary feeder might be 60–120 MVA — enough to supply a town of 50,000 people.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Why three-phase has won for over a century:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Smooth power.</strong> The instantaneous power in a single-phase circuit
              pulses at twice the supply frequency — falling to zero 100 times a second on UK 50 Hz
              mains. The sum of three balanced phases is constant. No pulsation, no flicker, no
              torque ripple in motors.
            </li>
            <li>
              <strong>Less copper for the same job.</strong> A balanced three-phase system doesn’t
              need a return conductor (the three line currents add to zero in the star point). Three
              wires carry the same power that three single-phase pairs (six wires) would.
            </li>
            <li>
              <strong>Self-starting motors.</strong> Three-phase windings produce a smooth rotating
              magnetic field automatically. Single-phase motors need extra start windings,
              capacitors or shaded poles to break symmetry — fiddly and inefficient at large scale.
            </li>
            <li>
              <strong>Compatible with delta and star transformer connections.</strong> A three-phase
              transformer can derive a single-phase 230 V supply (line-to-neutral) from a 400 V
              three-phase secondary effortlessly. The next Sub covers the maths: 400 / √3 = 230.
            </li>
          </ul>
          <p>
            Every transmission voltage in this Sub — 400 kV, 275 kV, 132 kV — is three-phase AC.
            Every distribution voltage in the next Sub — 33 kV, 11 kV, 400 V — is also three-phase
            AC. Single-phase is only created at the very end of the chain, by tapping one phase off
            a three-phase distribution transformer.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The acceptable envelope is <strong>49.5 Hz to 50.5 Hz</strong> (ESQCR Reg 27, ±1% on the
            declared 50 Hz nominal). NESO operates much tighter than that — typically within ±0.2 Hz
            of nominal — using three layers of response:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Inertia.</strong> The mechanical mass of every spinning generator on the grid
              resists frequency change. A bigger pool of synchronous machines means slower frequency
              drift after a fault — important as the grid moves to inverter- based wind and solar,
              which have no inertia of their own.
            </li>
            <li>
              <strong>Frequency response.</strong> Generators contracted to NESO ramp output up or
              down within seconds of a frequency excursion. Dinorwig pumped storage can be at full
              output in ~16 seconds; some battery sites respond in under a second.
            </li>
            <li>
              <strong>Reserve.</strong> Slower-acting generation called on within minutes if the
              imbalance persists — typically gas peakers and interconnector imports.
            </li>
          </ul>
          <p>
            Below 48.8 Hz, automatic Low Frequency Demand Disconnection (LFDD) sheds blocks of load
            to keep the grid stable. That’s the last line of defence — and the reason competent
            electricians have a working knowledge of why supply quality is what it is.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Copper loss (I²R).</strong> Resistive heating in the primary and secondary
              windings. Proportional to the square of the load current — double the load and the
              copper loss quadruples. Same physics as voltage drop on a long radial circuit, just
              inside the transformer.
            </li>
            <li>
              <strong>Iron loss (core loss).</strong> Hysteresis loss as the core steel is
              magnetised and demagnetised 100 times a second on a 50 Hz supply, plus eddy- current
              loss in the core laminations. Roughly constant whenever the transformer is energised —
              independent of load.
            </li>
          </ul>
          <p>
            On a typical 500 kVA street transformer, full-load efficiency is around 98–99%. At
            quarter load or no load, iron loss dominates and efficiency drops sharply. Designers
            size transformers to operate near their efficiency sweet spot for expected load —
            over-sized kit is wasteful in iron loss, under-sized kit is wasteful in copper loss and
            runs hot.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The economics of the whole transmission chain comes down to one inequality:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Loss in the conductor:</strong> P_loss = I² × R. Quadratic in current — halve
              the current, quarter the loss.
            </li>
            <li>
              <strong>Cost of insulation:</strong> roughly linear in voltage — doubling the voltage
              roughly doubles the insulation thickness on the conductor and the clearance to earth.
            </li>
          </ul>
          <p>
            So the trade-off is: insulation cost rises linearly with voltage, but loss falls with
            the square of the current (and current falls linearly as voltage rises). For
            long-distance transfers the loss saving wins by a huge margin — which is why every grid
            in the world steps up at the source and down at the load.
          </p>
          <p>
            The customer can’t use 400 kV — there’s no insulator a kettle could safely sit behind —
            so the chain has to come back down through five transformers to the 230 V single-phase
            supply at the cut-out. Every step is engineered to balance the loss saving on the next
            leg against the cost and loss of the transformer itself.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>At the power station.</strong> A typical CCGT alternator has output terminals at
            around 22 kV. The transformer immediately downstream steps it up to 400 kV (or 275 kV)
            for transmission. This is one of the heaviest single components on the site — a 1 GW
            step-up transformer can weigh 400 tonnes and is filled with mineral oil for cooling and
            insulation. It’s usually the limiting item for transport when a new station is built
            (specialist road or rail consignments).
          </p>
          <p>
            <strong>At the grid supply point (GSP).</strong> Where the transmission network meets
            the distribution network, a step-down transformer drops the voltage from 400 kV (or 275
            kV) to 132 kV, 66 kV or 33 kV — depending on the region and the size of the load
            downstream. This is the boundary between NGET (transmission owner) and the DNO
            (distribution owner). The DNO takes the power from this point and steps it down again
            through primary and secondary substations to the consumer.
          </p>
          <p>
            The GSP is also the legal handover point — the licence boundary between the transmission
            and distribution licence holders. Power flowing the other way (embedded generation
            exporting from the distribution system back into transmission) crosses the same GSP
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The same statutory framework that holds frequency to 50 Hz ±1% holds the voltage at
              the consumer’s terminals to <strong>−6% / +10%</strong>. On a declared 230 V nominal
              that gives a legal envelope of <strong>216 V to 253 V</strong>. The whole transmission
              and distribution chain — from the 400 kV step-up at the power station, through every
              transformer down to the cut-out — is engineered to keep the customer-end voltage
              inside that envelope despite changing demand and changing generator availability.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              transmission system — generators, distribution operators, large industrial customers.
              It sits underneath ESQCR (the statutory framework) and translates it into operational
              requirements. Practical takeaway: if you ever hear a CCGT plant ‘fast-ramping for
              frequency response’ on the news, this is what it’s obeying — the same Grid Code that
              ultimately keeps the 50 Hz on your meter tails stable.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice sees ‘400 kV transmission’ in their notes and thinks it’s relevant to the
              cable they’re terminating. It isn’t. 400 kV is the voltage between two phases of a
              three-phase system at the very top of the supply chain — long before any DNO
              transformer, never present at any customer-facing kit. A second version of the same
              mistake: apprentice sees ‘400 V three-phase’ at a commercial install and thinks it’s
              the same thing as the 400 kV super-grid — they’re separated by a thousand-fold
              step-down and four substations.
            </>
          }
          doInstead={
            <>
              Keep the chain in your head: <strong>400 kV / 275 kV / 132 kV</strong> (transmission,
              with NGET / SPT / SHET) → <strong>33 kV / 11 kV / 400 V / 230 V</strong>{' '}
              (distribution, with the DNO). Two separate worlds, two separate ownerships, two
              separate regulatory frameworks. Section 5.3 covers the distribution voltages.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re reading a planning notice for a new 350 MW onshore wind farm in the Borders.
              The application includes a connection from the wind farm collector substation to the
              existing transmission network. Which voltage will the connection be at, and who owns
              it?
            </>
          }
          whatToDo={
            <>
              ...
              collector substation on the wind farm typically aggregates the individual turbines at
              33 kV. The export connection to the grid would step that up to 132 kV, 275 kV, or 400
              kV depending on what is closest. In the Borders, SPT runs the 275 kV and 400 kV
              networks, so the connection contract is with SPT and NESO (system operator) jointly.
              Anything under ~100 MW would more likely connect at distribution voltage (33 kV or 132
              kV) under a DNO contract — known as ‘distributed generation’.
            </>
          }
          whyItMatters={
            <>
              Generation connection is one of the biggest engineering bottlenecks on the GB system
              right now — there are queues of ~10 years for transmission connections in some regions
              because the existing network can’t accept any more power without reinforcement. NESO
              is overhauling the queue with the ‘Connections Reform’ programme. For an electrician,
              the relevant takeaway is just understanding where each generator plugs in: small ones
              into distribution, big ones into transmission, with a hard line between the two at
              ~100 MW.
            </>
          }
        />
        ...
        <Quiz title="Transmission voltages — knowledge check" questions={quizQuestions} />
