...
const checks = [
  {
    ...
    options: [
      'Higher voltage means lower current for the same power, so I-squared-R cable losses on the long run to the substation are far smaller.',
      'The grid only accepts power at exactly 33 kV, so the turbine output must be matched before it can connect.',
      'Stepping up the voltage also raises the frequency to the 50 Hz the grid requires for synchronisation.',
      'Higher voltage makes the cable safer to bury, reducing the trench depth the regulations call for.',
    ],
    correctIndex: 0,
    explanation:
      'Same physics that justifies the 400 kV super-grid (covered in Sub 5.2): move the same power at higher voltage and the current drops, so line loss falls with the square of the current. A wind farm with cables running kilometres back to the onshore grid connection has to step up early, otherwise the cable would have to be enormous and the losses crippling. Frequency is set by the generator, not the transformer, and is unaffected by the voltage step.',
  },
  {
    ...
    options: [
      'The Meter Operator (MOP) owns it — the service cable is part of the metering installation.',
      'The customer owns it — anything on their side of the property boundary is theirs.',
      'The Distribution Network Operator (DNO) owns it — service cable, cut-out and supplier earth terminal are all DNO assets.',
      'The energy supplier owns it — they own everything up to the consumer unit.',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    question: 'Why does every UK installation have to operate at 50 Hz exactly?',
    options: [
      'BS 7671 requires every consumer unit to be tested at exactly 50 Hz before it can be signed off.',
      'Transformers can only step voltage up or down at a supply frequency of precisely 50 Hz.',
      'Every generator on the GB grid is synchronously locked together, all turning in step at 50 Hz.',
      'An RCD will only sense an earth fault and operate correctly at a supply frequency of 50 Hz.',
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      '400 V (LV) → 11 kV → 33 kV → 132 kV → 400 kV → 690 V at the generator terminals',
      '690 V or 11-25 kV (generation) → 400 kV → 132 / 33 kV → 11 kV → 400 / 230 V (LV)',
      '230 V → 400 V → 400 kV → 11 kV → 33 kV → 132 kV at the customer end of the chain',
      '11 kV (generator) → 400 V (transmission) → 33 kV → 132 kV → 230 V at the LV customer',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'About 13 A — the current is the same on both sides of the transformer',
      'About 620 A — the current rises as the voltage rises towards transmission level',
      'About 0.27 A — stepping the voltage up by ~48x cuts the current by the same factor',
      'About 2.6 A — the current falls by a factor of five, matching the turns ratio',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The local Distribution Network Operator (DNO) for that region',
      'The energy supplier the customer pays their monthly bill to',
      'The National Energy System Operator (NESO), which owns all transmission assets',
      'National Grid Electricity Transmission (NGET) — the transmission asset owner',
    ],
    correctAnswer: 3,
    explanation:
  ...
  {
    id: 4,
    question: 'What is the role of the DNO cut-out in the supply chain?',
    options: [
      'It is the last DNO-owned device — a sealed fuse plus the supplier earth terminal at the supply origin.',
      'It is the customer’s main isolation switch, used to safely de-energise the whole installation.',
      'It is the metering device that records the energy used and reports it back to the supplier.',
      'It is the consumer unit’s main switch, owned and maintained by the electrician on site.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Nothing happens — the grid simply runs on less power until the wind picks up again',
      'Frequency dips slightly and NESO calls on reserve generation to rebalance; if unbalanced too long, load shedding kicks in',
      'The grid voltage rises sharply because there is less generation pulling it down',
      'The frequency climbs above 50 Hz as the remaining generators speed up to compensate',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A local earth electrode driven into the ground at the property by the customer',
      'The metal water service pipe entering the building, bonded at the stop tap',
      'The supplier earth terminal on the cut-out, connected to the combined PEN conductor in the DNO service cable',
      'The separate metallic sheath of the supply cable, kept apart from the neutral throughout',
    ],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 7,
    question: 'What does the National Energy System Operator (NESO) do that NGET does NOT?',
    options: [
      'Owns the 400 kV pylons and substations across England and Wales',
      'Bills the customer for the energy they consume each month',
      'Installs and maintains the service cable and cut-out at each property',
      'Operates the second-by-second balancing of the GB power system — NESO is the operator, NGET the owner',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'That the rating and condition of the existing equipment, including the distributor, is adequate for the altered circumstances.',
      'You must upgrade the cut-out fuse to 100 A yourself before adding any new load to the supply.',
      'You only need to confirm the new circuit complies; the existing installation is the previous installer’s responsibility.',
      'You must convert the TN-S supply to TN-C-S before any EV charger can be connected to it.',
    ],
    correctAnswer: 0,
    explanation:
...
const faqs = [
  {
    question: 'Why does the UK keep 50 Hz when other countries (USA, Canada) run at 60 Hz?',
    answer:
  ...
  {
    question: 'If the National Grid is one connected system, why do we still have power cuts?',
    answer:
  ...
  {
    question: 'Who owns "the grid" — is it one company?',
    answer:
  ...
  {
    question: 'What is the carbon intensity of a kilowatt-hour at any moment?',
    answer:
  ...
  {
    question: "Why does the cut-out fuse limit the customer's prospective fault current?",
    answer:
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 5 · Subsection 5"
        title="From generation to your CU — full network walkthrough"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Trace one electron from a wind turbine to the customer's kettle. The complete UK supply
          network in one Sub. Every voltage step, every owner, every protective device — Subs 5.1,
          5.2, 5.3 and 5.4 stitched into one continuous walk.
        </p>
        ...
        >
          <p>
            Every electrician at a customer cut-out is staring at the end of a chain that began
            hundreds of miles away with a fuel source and a spinning shaft. The chain has between
            four and six clearly defined stages, depending on how you count, and every one of them
            is owned by a different commercial entity. By the end of this Sub you should be able to
            draw the chain on the back of a napkin from memory and name every component along it.
          </p>
          <p>
            This Sub is the synthesis of Subs 5.1 (generation), 5.2 (transmission), 5.3
            (distribution voltages) and 5.4 (named components). Nothing new is being introduced — it
            is the full picture, end to end, as one continuous story.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Recall from Sub 5.1: GB electricity comes from six main sources — combined-cycle gas
            turbines (CCGT, the largest dispatchable source), nuclear (baseload), wind (onshore and
            offshore), solar PV, hydro (including pumped storage), and biomass / CHP. At the
            generation site the alternator produces three-phase AC at one of two scales:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Wind turbines</strong> — typically 690 V three-phase at the generator
              terminals. Modern offshore turbines may run higher, but 690 V is the most common.
            </li>
            <li>
              <strong>Large thermal alternators</strong> (CCGT, nuclear, hydro) — typically 11 kV up
              to about 25 kV at the alternator terminals. Limited by the insulation of the rotor
              windings and the physics of the slip rings.
            </li>
          </ul>
          <p>
            Whatever the source, the electricity leaves the generator as three-phase 50 Hz AC at a
            relatively modest voltage. It cannot stay that voltage for the journey.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Immediately after the alternator, a step-up transformer raises the voltage dramatically.
            For a wind farm the typical jump is 690 V → 33 kV at the turbine, then 33 kV → 132 kV at
            an offshore or onshore substation before injection into the transmission grid. For a
            CCGT plant the jump is 11 kV (or 25 kV) → 400 kV direct to transmission.
          </p>
          <p>
            The reason is purely economic and is the foundation of every grid in the world (and was
            hammered home in Sub 5.2): conductor loss is I-squared-R. To carry the same kilowatt at
            half the current quarters the heating loss in the cable. Move the same megawatt at
            thirty times the voltage and the loss collapses by a factor of about nine hundred.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The transmission tier (covered in detail in Sub 5.2) carries power across the country at
            three principal voltages:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>400 kV — the super-grid.</strong> The biggest interconnection, used to shift
              gigawatts from generation centres (e.g. North Sea wind, nuclear in the south-west) to
              the demand centres (London, the Midlands).
            </li>
            <li>
              <strong>275 kV — the grid.</strong> Older voltage class, much of it being upgraded to
              400 kV over time.
            </li>
            <li>
              <strong>132 kV — sub-transmission.</strong> Owned by the transmission operators in
              Scotland and (historically) by DNOs in England and Wales.
            </li>
          </ul>
          <p>
            Three-phase, 50 Hz, no neutral. Distances of 100 miles or more between points of
            consumption are routine. Owned by NGET in England and Wales, SPT in southern Scotland,
            SHET in northern Scotland. Operated as one synchronous interconnected system by NESO
            since 2024.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              synchronous generator on the GB grid is locked to. Frequency drift is the first sign
              that demand and generation are out of balance — NESO watches it second-by-second and
              dispatches reserve to keep it inside the envelope. Equipment design across the entire
              industry assumes 50 Hz; that is why the synchronous-clock motor in your customer's old
              central heating timer keeps accurate time over the long run.
            </>
          }
        ...
        >
          <p>
            A Grid Supply Point (GSP) is a major transmission-to-distribution substation — about 300
            of them across GB. The transformers are typically rated in the hundreds of MVA,
            oil-filled, with on-load tap changers to maintain output voltage as load varies through
            the day.
          </p>
          <p>
            At the GSP, ownership of the asset and operational responsibility for the power it
            carries transfers from NGET (the transmission owner) to the local DNO (the distribution
            owner). The same kilowatt-hour now sits inside the distribution network and will work
            its way down through the rest of the chain under DNO ownership.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The primary substation steps the voltage down again — typically 33 kV in, 11 kV out —
            and feeds a network of 11 kV ring-main or radial feeders that cover a town, a city
            quarter or a rural distribution area. Each primary substation feeds a few thousand
            customers depending on density. Recall Sub 5.3 for the full distribution voltage
            hierarchy.
          </p>
          <p>
            The 11 kV network is the workhorse of the distribution system. Most of the underground
            cables you might dig up on a domestic job site at 0.5 m depth, if they are not service
            cables, are 11 kV mains. Sectionalising switchgear at strategic points means a fault on
            one section can be isolated without losing the whole feeder.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            This is the last transformer in the chain. Eleven thousand volts in on the HV side, 400
            V three-phase out on the LV side. The secondary winding is connected in star (Y), giving
            you 400 V line-to-line and 400 / sqrt(3) = 230 V line-to-neutral — the maths covered in
            Sub 5.3.
          </p>
          <p>Three forms of secondary substation are common in the UK:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ground-mounted (kiosk).</strong> Brick or GRP enclosure on a small concrete
              plinth on a public verge or housing estate. Most common in modern suburbs.
            </li>
            <li>
              <strong>Pole-mounted (PMT).</strong> Transformer hung off a wood pole. Common in rural
              areas. Usually feeds a handful of houses on TT supply.
            </li>
            <li>
              <strong>Indoor.</strong> Inside a brick building (often the corner of an older
              industrial estate or block of flats). Higher capacity, dedicated customer or shared.
            </li>
          </ul>
          <p>
            Capacity is typically 200, 315, 500 or 800 kVA for ground-mounted units, less for
            pole-mounted. The kVA rating is the limit on how much load all the connected customers
            can pull at once.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The DNO service cable is what physically delivers the supply from the LV distributor
            (the cable running under the street) into the building. It is a DNO asset — the customer
            does not own it and must not modify it. Two main types in the UK:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Concentric ALPVC</strong> — modern. Single-phase typically 25 mm² or 35 mm²
              aluminium centre conductor, with the neutral / PEN as a concentric wire screen. PVC
              outer.
            </li>
            <li>
              <strong>Older PILC</strong> — Paper-Insulated Lead-Covered. Three-core lead-sheathed
              cable from the pre-1970s era, still in service in older areas. The lead sheath acts as
              the supplier earth on TN-S supplies.
            </li>
          </ul>
          <p>
            The service cable terminates inside the meter cabinet at the cut-out. The cable, the
            cut-out and the supplier earth terminal are all DNO property. The electrician's hands
            stop here.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            In every UK property the same three components sit at the supply origin, in the same
            order:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cut-out</strong> — sealed BS 1361 or BS 88-3 fuse, typically 60 / 80 / 100 A
              in domestic. Last DNO asset. Provides the supplier earth terminal (TN-C-S or TN-S
              supplies).
            </li>
            <li>
              <strong>Meter</strong> — owned by the Meter Operator (MOP). Modern smart meters
              (SMETS2) communicate to the supplier via the Data Communications Company (DCC) WAN.
            </li>
            <li>
              <strong>MET</strong> — Main Earthing Terminal. The customer-side hub for the earthing
              conductor, the protective conductor of every circuit, and the main protective bonding
              conductors. Required by BS 7671 to exist, be accessible and be reliable.
            </li>
          </ul>
          <p>
            These three components are covered in detail in Sub 4.1 (TN / TT systems and earthing
            arrangements), Sub 4.2 (the MET itself) and the next Sub 5.6 (the boundary in
            operational detail). The full handover from DNO to MOP to customer all happens in this
            one cabinet.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The classification of the supply (TN-S, TN-C-S or TT) is decided entirely by what the
              supply side does — the DNO declares it on the connection certificate. The electrician
              designs the installation to suit. You cannot turn a TT installation into a TN-C-S one
              by your own efforts; the supplier earth terminal either exists or it does not. See
              Module 3 Section 4 for the full earthing-systems treatment.
            </>
          }
        ...
        >
          <p>
            Out of the load-side terminals of the meter, the customer installation begins. In a
            typical domestic install:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Meter tails</strong> — typically 25 mm² single-core 6181Y, the customer-side
              conductors from the meter to the main isolator or consumer unit. Length kept as short
              as practicable.
            </li>
            <li>
              <strong>Main switch / isolator</strong> — required for safe isolation of the whole
              installation.
            </li>
            <li>
              <strong>Consumer unit</strong> — RCBOs / SPDs / AFDDs as specified by the designer,
              distributing to final circuits (covered in Module 2 Section 6.6 and later modules of
              this course).
            </li>
            <li>
              <strong>Final circuits</strong> — the wiring to socket outlets, lighting, showers,
              ovens, EV chargers and any other fixed load.
            </li>
          </ul>
          <p>
            Every component from the load-side meter terminals onwards is the electrician's to
            design, install, test and certify. The chain has now arrived at its destination.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Every job that touches an existing installation starts with a check upstream. Cut-out
              fuse rating adequate for the new total demand? Service cable adequate? Declared earth
              fault loop impedance still valid? Earthing arrangement (TN-S / TN-C-S / TT) still as
              recorded? If the answer to any of those is "no", the design changes — or you escalate
              to the DNO. This regulation is why the first ten minutes of any addition or alteration
              are spent in the meter cabinet, not at the customer's new circuit.
            </>
          }
        ...
        >
          <p>
            Synchronous generators are mechanically locked to grid frequency. The rotor speed is
            determined by the grid frequency, not the other way around. When demand suddenly exceeds
            generation (someone switched on a kettle, a million someones), every generator on the
            grid simultaneously feels the extra load and slows microscopically, dragging the
            frequency down. NESO sees the dip and dispatches reserve — synchronous generators ramp
            up, pumped storage starts generating, interconnectors import.
          </p>
          <p>
            The acceptable envelope is 50 Hz +/- 1% (so 49.5 to 50.5 Hz), per ESQCR Reg 27. Outside
            that envelope, automatic frequency response acts within seconds. At 48.8 Hz, automatic
            Low Frequency Demand Disconnection (LFDD) sheds blocks of load. The August 2019 power
            cut (Hornsea-1 wind farm tripped, frequency fell to 48.8 Hz, ~1 million customers lost
            supply) is the textbook example of the system doing its job.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The DNO has a statutory duty to provide an earth where it is practicable, which is why
              most modern UK supplies are TN-C-S (PME). It is only TT (no DNO earth,
              customer-installed earth electrode required) where TN-C-S or TN-S cannot be safely
              supplied — typically the end of long overhead rural feeders. The form of supply is
              declared by the DNO; the electrician designs to suit. Ties straight back to BS 7671
              Reg 312.2.1 on how the chosen system is identified and arranged.
            </>
          }
        ...
        >
          <p>
            A customer kettle pulls roughly 3 kW (13 A at 230 V). Trace that back through every step
            of the chain — using P = V x I and assuming an idealised lossless transformer at each
            stage:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>At the kettle:</strong> 230 V x 13 A = 3000 W. Cable from CU to kettle is 2.5
              mm² copper twin-and-earth, no problem.
            </li>
            <li>
              <strong>On the meter tails (still 230 V):</strong> 13 A. Same current. Same voltage.
              25 mm² 6181Y handles it with margin.
            </li>
            <li>
              <strong>On the LV street distributor (400 V three-phase):</strong> Spread over three
              phases the contribution from this one kettle is roughly 4.3 A on its phase conductor.
              The whole street's 50+ kettles add up to maybe 200 A during the morning rush.
            </li>
            <li>
              <strong>On the 11 kV side of the secondary transformer:</strong> 3000 W / 11000 V =
              0.27 A for this one kettle. The whole street worth of load is only ~20 A on the 11 kV
              feeder. That is why a single 11 kV cable can serve a whole housing estate.
            </li>
            <li>
              <strong>On the 33 kV side of the primary transformer:</strong> 3000 / 33000 = 0.09 A.
              A whole town is only a few hundred amps.
            </li>
            <li>
              <strong>On the 400 kV transmission line:</strong> 3000 / 400000 = 0.0075 A. A national
              level of demand is only a few thousand amps on a single 400 kV line. That is why one
              set of pylons can carry the load of a city.
            </li>
          </ul>
          <p>
            Same kilowatt all the way through. The current is what changes — and that is the entire
            economic and engineering reason the chain exists in the form it does.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A customer asks why their bill is high. You say "phone the grid". They phone Octopus,
              who tell them to phone UK Power Networks, who tell them the meter question is for the
              MOP, who tell them the export rate is set by the supplier. Three transferred calls and
              a frustrated customer because you muddled five separate industry roles into one.
            </>
          }
          doInstead={
            <>
              Hold the five layers separately in your head. <strong>NESO</strong> operates the
              system. <strong>NGET / SPT / SHET</strong> own the transmission pylons. The{' '}
              <strong>DNO</strong> (one of six groups) owns the distribution network up to and
              including the cut-out. The <strong>MOP</strong> owns the meter. The
              <strong> supplier</strong> sells the energy and bills the customer. Different question
              = different phone call. Knowing which layer is responsible saves the customer an hour
              and saves you looking like you do not know your industry.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              It is 18:00 on a cold January evening. A 33 kV overhead line in your area is taken out
              by a fallen tree. The local primary substation drops the affected feeder. About 4,000
              properties lose power. Your customer phones, panicked — their UPS is keeping the home
              server alive, the gas combi boiler has lost power and stopped, and the customer wants
              to know whether it is the wider grid or just them.
            </>
          }
          whatToDo={
            <>
              Reassure them this is a local distribution fault, not a national grid event. Tell them
              to phone <strong>105</strong> — the universal UK number that routes to their DNO
              emergency line — and check the DNO's online outage map for an estimated restoration
              time. The wider 400 kV grid is not affected; NESO will see a tiny drop in demand
              (4,000 properties is a fraction of a percent) and the frequency will not move. The UPS
              is doing its job because supply has gone, full stop. The gas combi boiler will not
              restart because it needs the 230 V mains for its electronic ignition and pump — the
              gas is still flowing but useless without the controls.
            </>
          }
          whyItMatters={
            <>
              Customers usually do not understand that "no power" is a local distribution event, not
              a Met Office headline. Knowing the chain — and being able to explain it calmly — is
