...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 2 · Subsection 3"
        title="IEC 60617 graphical symbols"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The standard symbol library you read on every UK installation drawing — switches, sockets,
          lights, protective devices, accessories. Memorise the common ones. You'll see them daily.
        </p>
        ...
        >
          <p>
            ...
            installation drawing — domestic, commercial, industrial — should use this set. It's the
            alphabet that makes drawings universally readable: a UK electrician can pick up a
            drawing produced anywhere in Europe and understand it because the symbols are the same.
          </p>
          <p>
            The standard groups symbols into families: power sources, conductors, switches, outlets,
            luminaires, protective devices, accessories, instruments, transformers and motors. The
            families below cover the symbols an apprentice meets in the first six months on site.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The three most common power-source symbols you'll meet:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Transformer</strong> — two coils side by side (often as two adjacent loops or
              stacked horizontal lines), usually with a vertical line between them indicating the
              iron core. Auto-transformers, current transformers (CT) and voltage transformers (VT)
              all have specific variants.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Conductor conventions:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Conductor</strong> — single line. On a colour drawing the colour matches the
              conductor (brown = line, blue = neutral, green/yellow = CPC).
            </li>
            <li>
            ...
            <li>
              ...
              line indicate the number of conductors in that cable. Three slashes = three-core (e.g.
              L + N + CPC); five slashes = five-core (e.g. 3-phase + N + CPC).
            </li>
            <li>
              <strong>Twisted pair</strong> — two lines drawn with helical crossings, used for data
              and instrumentation cables to denote twisted-pair construction.
            </li>
            <li>
            ...
            <li>
              ...
              installation earth. A circle around the earth lines indicates clean/instrument earth.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            The switch family runs from the simplest single-pole single-throw all the way to ganged
            multi-pole switches. Below are interactive symbol cards for the common ones — tap or
            hover to view.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="The everyday accessory variants">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>1-gang 2-way (1G/2W)</strong> — one switch on a plate that's one of a matched
              pair on a 2-way (stairwell-style) circuit.
            </li>
            <li>
              <strong>2-gang 1-way (2G/1W)</strong> — two physically separate switches on a single
              plate, each controlling its own circuit. Common at room entrances controlling main +
              accent lighting.
            </li>
            <li>
              <strong>Intermediate</strong> — used in the MIDDLE of a stairwell circuit with three
              or more switch positions. Symbol shows two crossed strappers indicating it swaps
              L1↔L2.
            </li>
            <li>
              <strong>2-pole</strong> — switches both line and neutral simultaneously. Used for
              isolation of higher-risk equipment (showers, immersions in some cases). Symbol shows
              two ganged contacts with a mechanical link.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Twin (double) socket</strong> — half-circle with the gang count '2' alongside,
              or two half-circles back-to-back.
            </li>
            <li>
              <strong>Switched socket</strong> — adds a switch symbol next to or above the socket.
              Standard in the UK; unswitched are unusual outside specific applications.
            </li>
            <li>
            ...
            <li>
              ...
              marking and the fuse rating (typically 13 A). Switched and unswitched variants exist;
              the switched FCU has a switch symbol beside it.
            </li>
            <li>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>General luminaire (pendant / ceiling rose)</strong> — a circle with an 'X' or
              cross through it, often with a small line dropping to indicate a pendant cord.
            </li>
            <li>
              <strong>Downlighter (recessed)</strong> — a circle with a single short line inside.
              Sometimes annotated with the lamp type (LED, CFL, halogen).
            </li>
            <li>
            ...
            <li>
              <strong>Fluorescent batten</strong> — a long thin rectangle, sometimes with a wavy
              line or fluorescent tube indication inside.
            </li>
            <li>
            ...
            <li>
              <strong>Exit sign</strong> — a small rectangle with a directional arrow inside (or the
              running-man pictogram on a more detailed drawing).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Junction box</strong> — a small filled circle or square, often with the box
              reference and conductor count noted.
            </li>
            <li>
              <strong>MET (Main Earthing Terminal)</strong> — a horizontal line with multiple short
              branching lines (each terminal point), labelled 'MET'.
            </li>
            <li>
              <strong>Smoke detector</strong> — a circle with 'SD' inside, often with an arrow or
              annotation indicating linked/standalone.
            </li>
            <li>
            ...
            <li>
              <strong>Telephone / data outlet</strong> — typically a triangle (data) or 'T' in a box
              (telephone). Often labelled with the cable type (Cat 5e, Cat 6, fibre).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Protective devices — the most common symbols on a board diagram
        </ContentEyebrow>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              (high-breaking-capacity HRC) and BS 1362 (plug-top) all use the same base symbol with
              the fuse type/rating annotated.
            </li>
            <li>
              ...
              trip-curve type. E.g. 'B32' = Type B, 32 A. Trip curves: B (3-5×In), C (5-10×In), D
              (10-20×In).
            </li>
            <li>
            ...
            <li>
              <strong>RCBO (Residual Current Breaker with Overcurrent)</strong> — combines the MCB
              and RCD symbols. Carries BOTH the rating + trip curve (e.g. B32) AND the residual
              current (e.g. 30 mA).
            </li>
            <li>
        ...
        >
          <p>Tap any symbol below to view it.</p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The flip-side of the symbols story. On the drawing, every device has a symbol with a
              marking. On the install, every device has to have a label that matches the drawing
              (e.g. 'Cooker Cct 6'). When you wire a board, the symbols on the drawing drive the
              labels you put on the actual board — so getting the symbols right on the drawing is
              also the basis for getting the board labelling right.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice looking at a board diagram sees an RCBO marked '30 mA' next to 'B32' and
              assumes it's a 30 mA (i.e. 0.03 A) load device. Or worse — sees 'RCD 100 mA' on a
              fire-protection RCD and tries to use it for additional shock protection on
              socket-outlets, which need 30 mA, not 100 mA.
            </>
          }
          doInstead={
            <>
              Drill it: <strong>mA</strong> on a protective device means RESIDUAL operating current
              (the trip threshold for the RCD function — how much earth-fault current it takes to
              trip). <strong>A</strong> means RATED load current (what it carries continuously
              without tripping on overload). 30 mA = additional shock protection. 100 mA / 300 mA =
              fire / earth-fault protection. The unit tells you which parameter you're looking at.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice asked to fit '2-way switches throughout the upstairs hallway' fits 2-gang
              switches by mistake (because they look 'bigger' on the symbol legend). Comes back to
              find half the switches do nothing and the homeowner wants their landing light to
              actually work from both ends of the hallway.
            </>
          }
          doInstead={
            <>
              Get the language straight. <strong>2-way</strong> = SPDT, one of a matched pair on a
              circuit you can switch from two positions (stairwell, corridor).
              <strong> 2-gang</strong> = two physically separate switches on a single plate, each
              controlling a different circuit. <strong>2-pole</strong> = a single switch that breaks
              both line AND neutral simultaneously. The symbols look different — train your eye on a
              side-by-side comparison until you can spot which is which without thinking.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              there's a blob with 'X' on the kitchen layout that nobody can identify, and the symbol
              legend at the bottom of the drawing is incomplete.
            </>
          }
          whatToDo={
            <>
          ...
          whyItMatters={
            <>
              Symbols only work if everyone uses the same set. The day you start guessing what a
              non-standard symbol means is the day you wire the wrong type of device into the wrong
              position. The standard exists to remove that ambiguity — and the regulation exists so
              the inspector can flag drawings that don't comply.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Drawing types</div>
          </button>
          <button
