      ...
      <HubBody>
        ...
        >
          <p>
            ...
            wiring diagrams, layout/floor plans, single-line diagrams for the board. (Sub 2 breaks
            down each type.)
          </p>
          <p>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Drawing types</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
