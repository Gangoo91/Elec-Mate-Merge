    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          ...
          opens before lifting a tool. Front sheet to as-built, applying everything from Subs
        ...
        <ConceptBlock title="Four Subs in, you have the toolkit — this Sub puts it on a real pack">
          <p>
            ...
            block, schematic, wiring, circuit, layout, as-built — and what each one is for. Sub 2.3
            gave you the IEC 60617 / IEC 60617 graphical symbol set, the visual alphabet for every
            UK installation drawing. Sub 2.4 covered scale notation and the conversion between paper
            and real dimensions, with the do-not-scale rule for resized prints.
          </p>
          <p>
