...
const checks = [
  {
    ...
    question: 'A drawing has a scale of 1:50. What does that actually mean?',
    options: [
  ...
  },
  {
    ...
    options: ['45,000 mm (45 m)', '4500 mm (4.5 m)', '450 mm (0.45 m)', '4.5 mm'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['350 mm', '35 mm', '70 mm', '140 mm'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['300 mm (0.3 m)', '600 mm (0.6 m)', '3000 mm (3 m)', '12,000 mm (12 m)'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['60 mm', '6 mm', '600 mm', '0.6 mm'],
    correctAnswer: 0,
    explanation:
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 2 · Subsection 4"
        title="Scale conversion"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Drawings are scaled. The cable run isn't 30 cm on the wall — read the scale and the actual
          run is 15 m. Get this wrong and your materials list is a joke.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>1:10</strong> — 1 unit on paper = 10 units real. So 1 cm paper = 10 cm real,
              or 1 mm paper = 10 mm real. (Detail scale.)
            </li>
            <li>
              <strong>1:50</strong> — 1 unit on paper = 50 units real. So 1 cm paper = 50 cm = 0.5 m
              real. (Room layout scale.)
            </li>
            <li>
              <strong>1:100</strong> — 1 unit on paper = 100 units real. So 1 cm paper = 1 m real.
              (Floor plan scale — the most common.)
            </li>
            <li>
              <strong>1:200</strong> — 1 unit on paper = 200 units real. So 1 cm paper = 2 m real.
              (Whole-building overview.)
            </li>
            <li>
              <strong>1:1250</strong> — 1 unit on paper = 1250 units real. So 1 cm paper = 12.5 m
              real. (Ordnance Survey site plan.)
            </li>
          </ul>
          <p>
            The bigger the second number, the smaller the drawing (you fit more onto the page).
            That's why a site plan at 1:1250 fits an entire estate onto one A3 sheet, while a detail
            at 1:5 might only fit one socket-outlet onto the same sheet.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1:1, 1:5</strong> — component drawings. A connector, a back-box internal, a
              switch contact arrangement. You see these in manufacturer literature more than on
            ...
            <li>
              <strong>1:50</strong> — individual room or specific area layouts. A bathroom plan with
              all the fittings shown in their real-world positions; a kitchen with sockets, FCUs,
              cooker outlet and lighting marked.
            </li>
            <li>
              <strong>1:100</strong> — general floor plans. The most common scale for the main
              electrical layout of a single floor of a dwelling, office or small commercial.
            </li>
            <li>
              <strong>1:200</strong> — whole-building or whole-floor overview on larger buildings.
              Used when 1:100 won't fit on a sensible paper size.
            </li>
            <li>
        ...
        >
          <p>
            <strong>Paper to real</strong> (most common — you've measured something on the drawing
            and want to know how big it actually is):
          </p>
          ...
          <p>
            Example: a wall measures 60 mm on a 1:50 drawing. Real length = 60 × 50 = 3000 mm = 3 m.
          </p>
          <p>
            <strong>Real to paper</strong> (less common — you're plotting something onto the drawing
            or checking if a known real distance matches the drawing):
          </p>
          <p className="bg-white/[0.04] border border-white/10 rounded-lg p-3 text-[13.5px]">
            <strong>paper dimension = real dimension ÷ scale denominator</strong>
          </p>
          <p>
            Example: a 7 m cable run on a 1:50 layout would be drawn at 7000 ÷ 50 = 140 mm long on
            paper.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>At 1:100</strong>, 1 cm paper = 1 m real. Easiest scale to do in your head. A
              4.5 cm wall = 4.5 m real.
            </li>
            <li>
              <strong>At 1:50</strong>, 1 cm paper = 0.5 m real (= 50 cm). A 6 cm wall = 3 m real.
              Or: 2 cm paper = 1 m real.
            </li>
            <li>
              <strong>At 1:20</strong>, 1 cm paper = 20 cm real. A 12 mm trunking section on paper =
              240 mm real.
            </li>
            <li>
        ...
        <ConceptBlock title="From drawing to materials list">
          <p>
            You've been handed a 1:50 layout of a kitchen. You measure the following with your scale
            rule (set to the 1:50 face, so the rule reads real dimensions directly):
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Distance from CU to first kitchen socket back-box: <strong>4.2 m</strong>
            </li>
            <li>
              Run from socket 1 to socket 2 (along skirting): <strong>1.6 m</strong>
            </li>
            <li>
              Run from socket 2 to socket 3: <strong>1.4 m</strong>
            </li>
            <li>
              Drop from socket 3 up to under-cupboard FCU: <strong>1.2 m</strong>
            </li>
            <li>
              FCU to extractor: <strong>0.8 m</strong>
            </li>
          </ul>
          <p>
            Total cable run for the radial: 4.2 + 1.6 + 1.4 + 1.2 + 0.8 = <strong>9.2 m</strong>.
            Add 10% for terminations, slack, drops into back-boxes and any vertical wall following:{' '}
            <strong>~10.2 m</strong>. Round up to <strong>11 m</strong> on the materials list to
            give a small safety margin.
          </p>
          <p>
            Without scale conversion you'd either have to physically measure every run on site
            (slow, can't do until the building's open) or guess. With the drawing and a scale rule
            you produce a defensible cable estimate before the first day on site.
          </p>
        </ConceptBlock>
        ...
        >
          <p>A standard triangular architect's scale rule has six faces, typically:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>1:1 + 1:100</li>
            <li>1:5 + 1:50</li>
            <li>1:10 + 1:200</li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Read the number where the rule meets the other end. The number on that face is in REAL
              units (m or mm) — no multiplication needed.
            </li>
          </ul>
          <p>
            If the drawing is at a non-standard scale (e.g. 1:75), use the closest standard scale
            face and do the maths to convert. Or print/scale the drawing to a standard ratio first.
          </p>
        </ConceptBlock>
        ...
        >
          <p>You'll mostly meet imperial scales on three types of drawing:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            The notation <strong>1/8&quot; = 1&apos;-0&quot;</strong> means &apos;one eighth of an
            inch on paper equals one foot in real life&apos;. So:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1/8&quot; = 1&apos;-0&quot;</strong> ≈ 1:96 metric equivalent (close to 1:100,
              the standard metric floor-plan scale).
            </li>
            <li>
              <strong>1/4&quot; = 1&apos;-0&quot;</strong> ≈ 1:48 (close to 1:50, the standard
              metric room layout scale).
            </li>
            <li>
              <strong>1/2&quot; = 1&apos;-0&quot;</strong> ≈ 1:24 (close to 1:25 / 1:20, detail
              scale).
            </li>
          </ul>
          <p>
            Conversion: 1 inch = 25.4 mm; 1 foot = 304.8 mm; 1 metre ≈ 3.281 ft. Keep these factors
            handy if you're working across both systems.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              The original drawing is at a non-standard scale and gets resized to fit standard
              paper.
            </li>
          </ul>
          <p>
            ...
            Named dimensions are TEXT, so they survive printing at any scale. If a wall is labelled
            '4250' and you measure 50 mm with your scale rule on a 1:100 drawing, trust the 4250.
          </p>
          <p>
            Sanity check: when measurements off the scale rule consistently disagree with the named
            dimensions, the print isn't full scale — flag it and use the dimensions only.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              positions and dimensions taken off the layout drawing ('Cct 6 — Cooker outlet, 450 mm
              AFFL, kitchen wall'). If the apprentice has scaled the drawing wrong and the label
              says 450 mm but the actual position is 600 mm, the label and the install disagree —
              and 514.1.1 requires labels that can be relied on. Accurate scale conversion feeds
              into accurate labelling.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              plans are, and start scaling. The drawing is actually at 1:50. Every measurement you
              take is half what it should be. You end up cutting back-box positions in completely
              the wrong place, or ordering 30 m of cable when the actual run needs 60 m.
            </>
          }
          doInstead={
            <>
              Make 'check the title block' the first thing you do on every new drawing. The scale is
              normally in the bottom-right title block alongside drawing number, revision, project
              name and date. If the scale isn't shown explicitly, look for a printed scale BAR on
              the drawing. If there's neither, the drawing is unreliable for scaling and you can
              only trust named dimensions.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You see '1:100' and brain interprets it as '100 paper units = 1 real unit' instead of
              the other way round. Your measurements come out 10,000× too big or too small. Comedy
              if you spot it; disaster if you don't.
            </>
          }
          doInstead={
            <>
              The first number is ALWAYS paper. The second number is ALWAYS real. 1:100 = 'one
              paper, one hundred real'. If you ever feel uncertain, sanity-check on a known feature:
              a typical room is 3-5 m wide. If your scale conversion gives a 30 cm room, you've got
              it inverted. If it gives a 30 m room, you've got it inverted the other way.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You're a year-one apprentice asked to put together the cable take-off for a new garage
              circuit. You glance at the drawing, measure the run from CU to garage consumer unit —
              65 mm on paper — and write '65 m of 6 mm² T&E' on the materials list, treating the
              paper-millimetres as if they were real-metres. Job day arrives, the merchant delivers
              a full 65 m drum, and within an hour your supervisor is asking why you've ordered five
              times more cable than the run needs.
            </>
          }
          whatToDo={
            <>
              ...
              terminations and a 10% margin → you only needed about 16 m, not 65 m. Confess the
              mistake to the supervisor immediately, return the unused drum to the merchant if
              possible, and from now on confirm the scale before touching the rule.
            </>
          }
          whyItMatters={
            <>
              Materials waste costs money and ties up working capital — a 65 m drum of 6 mm² T&E
              isn't cheap. Going the other way is even worse: under-order and the run can't be
              completed in one piece, joints get added that shouldn't have been there, fault loop
              impedance goes up, the install becomes technically inferior to what was specified. Get
              the scale conversion right at the planning stage and the rest of the job runs
              smoothly.
            </>
          }
        />
