...
const TITLE = 'Spacing factor of wiring enclosures | Level 2 Module 3.3.6 (AC 3.6) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    question: 'The maximum recommended fill factor for trunking under OSG Appendix H is:',
    options: ['25%', '45%', '35%', '60%'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    question: 'Cramming more cables into a trunking than the OSG fill factor allows causes:',
    options: [
  ...
  },
  {
    ...
    question: 'A "cable factor" in OSG Appendix H is best described as:',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question: 'OSG Appendix H gives the recommended maximum fill factor for trunking as:',
    options: ['25%', '45%', '40%', '60%'],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 2,
    question: 'You add up the cable factors for every cable in a trunking and compare them to:',
    options: [
  ...
  {
    id: 6,
    question: 'Conduit fill rules differ from trunking because:',
    options: [
  ...
  {
    id: 8,
    question: 'You break the OSG fill factor by 20%. The most likely consequences are:',
    options: [
...
export default function Sub6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 3 · Subsection 6"
        title="Spacing factor of wiring enclosures"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Conduit and trunking aren’t infinite. There’s a maths rule for how many cables fit. Cram
          extra in and you’re heating the cable, can’t pull new ones through, and you’ve broken the
          OSG (and quietly busted Sub3’s grouping derate too).
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heat retention</strong> — bunched cables can’t shed heat to surrounding air.
              Each cable’s effective Iz drops. The Sub3 grouping factor Cg was calculated for a
              specific cable count; over-fill changes that count and busts the original CCC sizing.
            </li>
            <li>
              <strong>Can’t pull new cables</strong> — even rod-and-draw can’t force a new cable
              through a near-full conduit. The next install team has to either remove cables or run
              a new container alongside.
            </li>
            <li>
              <strong>Compliance failure</strong> — the original install’s 433.1.1 calc was done
              assuming a specific Cg. If the trunking’s now over-stuffed, every cable in it has to
              be re-derated against the actual cable count. Often shows existing cables
              non-compliant.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            The heat angle: PVC insulation is rated for a maximum continuous conductor temperature
            of 70°C. Stay under that and the insulation lasts decades. Cross it even by a few
            degrees and the PVC ages noticeably faster — measurable in years off the cable’s service
            life. Over-filled trunking is the most common cause of that kind of slow aging because
            the symptoms (cracking, embrittlement) don’t show up for years.
          </p>
          <p>
            The futureproofing angle: the difference between specifying 50×50 trunking and 75×50
            trunking on a 30 m corridor run is maybe £40 of materials. The difference between adding
            three new circuits to under-filled trunking versus over-filled trunking is a full day on
            site, two electricians, and a re-test. If there’s any realistic chance the install will
            grow, size up at design.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Indicative cable factors for stranded copper singles (OSG Table 5C, longer runs and
            trunking):
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-[13px] text-white/75">
            These are indicative values from common OSG editions — always verify against the edition
            you’re working to before signing off design. The 45% fill is built into the tabulated
            trunking factor, so summing cable factors and comparing directly is compliant by
            definition.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The reason for the split is physics. A short straight conduit lets cables slide through
            easily, so the fill limit can be more generous (Tables 5A/5B). A long conduit with
            bends, or a trunking run with end terminations, makes pulling much harder, so the fill
            limit tightens (Tables 5C/5D). Use the strict pair on anything non-trivial and you’ll
            never be wrong.
          </p>
          <p>
            Cable factors are listed for stranded singles by CSA. Trunking factors are listed for
            each enclosure size and shape. The tables don’t care about colour, voltage band or
            circuit function — only physical dimensions. Singles with the same CSA have the same
            factor whether they’re red, black, blue or green-and-yellow.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            If the sum exceeds the enclosure factor, you have three choices: bigger enclosure, fewer
            cables in this enclosure, or a separate route for the surplus. Adding more cables is not
            an option — the original choice has to change.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              50 × 50 mm trunking factor (OSG Table 5D) ≈ <strong>1037</strong>.
            </li>
            <li>
              1026 ≤ 1037 → <strong>FITS</strong>. ✓
            </li>
            <li>Headroom: 1037 − 1026 = 11 units (about 1%). Effectively at capacity.</li>
          </ul>

          <p>
            <strong>Step 4 — sanity check.</strong> The maths says yes. But the headroom is tiny —
            any future addition will breach the fill rule. For a corridor that might see new
            circuits added later, sensible design would step up to 75 × 50 mm trunking (factor ≈
            1555) — gives plenty of headroom and lower Cg derate too. Cost difference is small;
            flexibility is huge.
          </p>

          <p>
            <strong>Step 5 — link back to Sub3.</strong> 80 conductors in one trunking is a LOT of
            grouping. Cg from OSG Table 4C1 for 80+ circuits is well below 0.5 — every cable’s Iz is
            approximately halved. The original CCC sizing (Sub3) needs to have accounted for that
            BEFORE the fill calc. Don’t do these calcs in isolation.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              5 × 2.5 mm² stranded copper singles → cable factor each ≈ 30 (OSG Table 5C, long-run /
              with-bends).
            </li>
          </ul>
          ...
          <p>
            <strong>Step 3 — look up conduit factor.</strong> 20 mm conduit, 4 m straight + one bend
            (OSG Table 5D) ≈ <strong>264</strong>.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              150 ≤ 264 → <strong>FITS</strong>. ✓
            </li>
            <li>
              Headroom: 264 − 150 = 114 units (about 43% of total). Lots of room for future
              additions.
            </li>
          </ul>

          <p>
            <strong>Step 5 — sanity check.</strong> Plenty of margin in 20 mm. If the spec changes
            and you need 8 × 2.5 mm² (8 × 30 = 240), still inside 264. At 9 × 2.5 mm² (270) you’d
            bust it and need to step up to 25 mm conduit (factor ≈ 442 in same configuration).
            Always size with future modification in mind — stepping up one conduit size at install
            is cheap; ripping it out later isn’t.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The most common patterns where fill calcs save real money:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Mid-life extensions</strong> — adding circuits to existing trunking. Do the
              calc on what’s already in there before adding. Half the time the existing fill is
              already at 70–80% and your addition busts the limit.
            </li>
            <li>
              <strong>Sub-mains upgrades</strong> — uprating a sub-main from 4 mm² singles to 10 mm²
              singles in existing conduit. Cable factors more than double — what fitted before may
              not fit now.
            </li>
            <li>
              <strong>Tenant fit-out reuse</strong> — landlord trunking serving multiple tenancies.
              Each new tenant adds load, eventually the shared trunking fills. Get the calc into the
              design pack and the landlord has a defensible answer when a tenant complains about a
              refused new circuit.
            </li>
            <li>
              <strong>EICR remedials</strong> — finding existing over-fill on inspection. The calc
              gives you the evidence to code it (typically C3, sometimes C2 if loaded cables are
              non-compliant on Cg) and quote the remedial honestly.
            </li>
          </ul>
          <p>
            Ten minutes with the OSG before any of these jobs is the cheapest insurance you’ll buy
            all month.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              already running past the wall, and the existing install used 6491X singles. You drop
              new 2.5 mm² red and black singles into the trunking and connect them up. Job’s a good
              ‘un, you think — bill it and move on. Trouble is, the existing trunking was already at
              95% fill (Appendix H factors) from the previous fit-out. Your new singles push it to
              102%. The Cg for everything in there has just dropped from 0.7 to 0.65 — every cable
              is now over its real Iz. Three months in, the customer reports an MCB tripping
              intermittently. You go back, megger-test, and discover the busiest existing circuit
              has been running 10°C above its insulation rating ever since you added the new
              singles. Insulation is starting to fail.
            </>
          }
          doInstead={
            <>
              Before adding ANY new cable to existing containment, do the fill calc on the actual
              current contents. Most commercial trunking is sized with future-proof headroom — but
              only if you check. If the existing run is at limit, run a separate trunking for the
              new circuit, or up-size the existing trunking. Also re-derate the existing cables for
              the new total Cg. If any cable was at limit and is now over, it has to be uprated
              (bigger CSA) or the new addition can’t go ahead. That’s the conversation to have with
              the customer — explain why the easy answer might not be the safe answer.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re fitting out the IT block of a secondary school. The original M&E design spec
              called for 50×50 mm trunking down the main corridor with 25 circuits in it. During
              value-engineering, the M&E team swapped the design to consolidate three runs into one
              — now 80 circuits in the same 50×50 trunking. You’re first-fix and you do the fill
              calc: it busts.
            </>
          }
          whatToDo={
            <>
              Stop and flag through the chain — designer, M&E lead, contracts manager. Don’t quietly
              install non-compliant. Two technical fixes possible. (1) Up-size the trunking to 75×75
              (factor ≈ 2371) — gives plenty of headroom and lower Cg derate bonus. (2) Split into
              two parallel 50×50 trunkings (factor 2 × 1037 = 2074 combined; Cg better because each
              trunking has fewer circuits). Either fix has cost implications — that’s why it goes to
              the chain to decide. What’s NOT an option is jamming 80 circuits into 50×50 and
              walking away. Document the design non-compliance, propose the fix, get the variation
              signed off, then install per the corrected design.
            </>
          }
          whyItMatters={
            <>
              Value engineering during design is meant to remove waste, not reduce safety margins.
              An apprentice or improver who spots a design fault and flags it is more useful than a
              senior who installs whatever’s on the drawings without checking. The fill calc takes
              ten minutes; saves the firm from a defect-period reinstall that costs ten thousand.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The OSG is the practical cable-fill bible — it codifies the 45% trunking limit and the
              conduit-fill calculations into tabulated factors that make the maths quick. BS 7671
              itself doesn’t tabulate fill but requires the install to comply with the cable
              manufacturer’s install guidance and to keep cables from damage and overheating — both
              of which the OSG fill rules satisfy. Paraphrased — verify the specific tables in the
              edition of the OSG you’re working to.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 521.10.1 sits behind the whole fill calculation — non-sheathed singles MUST be
              enclosed, and the enclosure MUST be designed and sized to accept the cables without
              damage. ‘Designed and sized’ is where Appendix H comes in. Stuffing too many cables
              into the enclosure breaches the spirit of 521.10.1 even before any fill-factor table
              is consulted.
            </>
          }
