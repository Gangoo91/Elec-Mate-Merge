...
const TITLE = 'Specialised wiring-system equipment | Level 2 Module 3.3.5 (AC 3.5) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    id: 'crimp-tool-check',
    question: 'You’re terminating a 70 mm² SWA tail onto a copper crimp lug. The right tool is:',
    options: [
  ...
  },
  {
    ...
    question: 'Rod-and-draw kit is used for:',
    options: [
  ...
  },
  {
    ...
    question: 'A clean 90° bend in 25 mm steel conduit is best made using:',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question: 'A "draw rope" or "draw line" left in a conduit during first fix is for:',
    options: [
  ...
  {
    id: 2,
    question: 'Cable rollers (mounted at intervals along a long route) are used to:',
    options: [
  ...
  {
    id: 3,
    question: 'Cable lubrication (specialist water-based gel) is applied:',
    options: [
  ...
  {
    id: 4,
    question: 'A trunking "fish tape" (steel coiled tape) is preferred over rod-and-draw for:',
    options: [
  ...
  {
    id: 5,
    question: 'Hydraulic crimping tools are typically used for cable CSAs:',
    options: [
  ...
  {
    id: 6,
    question: 'The "manufacturer’s instructions" for a crimp lug typically specify:',
    options: [
  ...
  {
    id: 7,
    question: 'A "saddle" or "pipe vice" set up on a tripod is used by an electrician to:',
    options: [
  ...
  {
    id: 8,
    question: 'A "trunking notcher" or trunking jig speeds up:',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Six pieces of kit you’ll never have used at home but live on every commercial van. Get
          good with them and you’re a useful electrician; skip them and you’re bodging.
        </p>
        ...
        >
          <p>
            The seven categories below cover almost every specialist tool you’ll meet on install
            work. Each one is the answer to a problem hand-tools simply can’t solve at practical
            commercial scale.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Leave a draw rope in the conduit when you’re done with the first cable — saves rodding
              for the next pull.
            </li>
        ...
        >
          ...
          <p>
            ...
            consistent internal diameter, anything where you’ll be pulling multiple cables. The two
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Protects the cable jacket</strong> — a sharp tray edge will cut PVC at 30 N
              pull. A roller spreads the load.
            </li>
            <li>
              <strong>Reduces pulling tension</strong> — every bend in the route doubles the pulling
              tension at the leading end (capstan effect). Rollers cut friction.
            </li>
            <li>
              <strong>Stays inside manufacturer’s tension spec</strong> — exceed it and the copper
              conductors stretch inside the jacket, weakening the cable invisibly.
            </li>
          </ul>
          <p>
            For really long pulls (50 m+), use a winch with a tension gauge or a sock that grips the
            cable jacket evenly. Don’t pull on the conductors themselves.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Electrical: deforms the strands together into a gas-tight contact, low resistance.
            </li>
          ...
          <p>
            ...
            index (matched to lug barrel), the crimp position(s) on the barrel, and the number of
            crimps. Follow them exactly. Reg 526.1 is the regulatory hook (durable continuity,
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              cycling). The MIs for the lug, the matched die and the right tool are how you evidence
              compliance.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Maintains earth continuity</strong> — galvanised steel conduit is part of the
              CPC. Cracks at a kink can degrade the earth path.
            </li>
            <li>
              <strong>Looks professional</strong> — a clean bend in galvanised steel is the mark of
              an electrician who knows their craft.
            </li>
          </ul>
          <p>
            <strong>Bend radius rule</strong>: minimum bend radius is typically 6× the conduit outer
            diameter — tighter than that and you risk cracking. The bender’s former is already
            shaped to the right radius — use it as designed and you can’t go wrong.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Lower tension means staying inside the cable manufacturer’s pulling-tension spec.
            </li>
          ...
          <p>
            ...
            attack PVC / XLPE / LSZH jackets. Don’t use grease, petroleum jelly or WD-40 — they can
            degrade the cable jacket over time.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Notcher / nibbler</strong> — punches a 90° wedge out of the trunking wall and
              lid for an internal bend.
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You’re on a job, the spec is a 50 mm² lug onto a SWA tail. The hydraulic crimper is
              back at the firm’s depot 40 minutes away. Customer is waiting. You think — I’ll just
              give it a really hard squeeze with the hand crimps. Lug looks crimped on, feels solid,
              you tighten the bolt onto the busbar and energise. Six months later the lug starts
              heating because the crimp wasn’t gas-tight; copper oxidises between the strands and
              the lug; resistance climbs; finally arcs at the joint. The whole sub-board fries
              because of one shortcut.
            </>
          }
          doInstead={
            <>
              Stop. If you don’t have the right tool, you’re not finishing the job today. Either go
              back for the crimper, get the apprentice to bring it out, or downsize the lug to one
              your hand crimper can handle (and re-spec the connection). Reg 526.1 requires durable
              continuity. A hand-crimped 50 mm² lug doesn’t provide that, full stop. The right tool
              isn’t optional kit — it’s the only way to get a compliant joint at that CSA.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re pulling 4-core 35 mm² SWA through a 60 m run of underground ducting from the
              main board to a substation transformer. The duct has three 90° bends along the route.
              Half-way through, the cable jams. You add more pulling effort — it still won’t move.
              The lead bagman starts shouting that the crew is getting tired.
            </>
          }
          whatToDo={
            <>
              Stop pulling. Pulling harder will exceed the cable’s manufacturer-spec tension and
              damage it invisibly. Three checks. (1) Is there enough lubricant? Re-feed lube gel
              into the duct from both ends. (2) Are rollers set up at every bend pit? If not,
              position them now to cut the capstan-effect friction at each bend. (3) Is the cable
              kinked at the duct entry? Pull back 1 m, check, re-feed. If you’ve done all three and
              it still won’t pull, you need a winch with a tension gauge to get the cable through
              under controlled load — not crew brute force. And if the tension gauge says you’re at
              the max spec already, the route needs re-engineering — extra pit, more lubricant,
              fewer bends.
            </>
          }
          whyItMatters={
            <>
              A damaged cable jacket today is an insulation-resistance failure tomorrow and a fault
              in two years. Specialist kit exists to keep you inside the cable’s published limits.
              Skip the kit and you skip the spec — and the spec is what the MFT will measure on
              commissioning.
            </>
          }
        />
        ...
        <Quiz
          title="Specialised wiring-system equipment — knowledge check"
