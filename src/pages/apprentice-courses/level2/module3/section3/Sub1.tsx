...
const TITLE = 'Final circuit types | Level 2 Module 3.3.1 (AC 3.1) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: ['Radial', 'FCU spur', 'Ring final', 'Lighting loop-in'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'A standard 6 A or 10 A lighting circuit is most commonly wired in:',
    options: ['2.5 mm² T&E', '1.0 mm² T&E', '4 mm² T&E', '1.5 mm² T&E'],
    correctAnswer: 3,
    explanation:
  ...
  {
    id: 4,
    question: 'A 7 kW EV charge point on a single-phase supply is closest to:',
    options: ['32 A', '20 A', '16 A', '45 A'],
    correctAnswer: 0,
    explanation:
  ...
  {
    id: 7,
    question: 'A heat-only domestic boiler with a 3 A internal fuse is wired:',
    options: [
...
const faqs = [
  ...
  {
    question:
      'Why is the lighting circuit always wired in 1.5 mm², even for one little LED downlight?',
    answer:
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 3 · Subsection 1"
        title="Final circuit types"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Six circuit shapes you’ll meet daily on UK installs. Get the shape wrong and you’ve got
          nuisance trips, dead lights or — worst case — a fire.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Radial</strong> — single cable out, branches at accessories. Default shape for
              almost every dedicated load.
            </li>
            <li>
              <strong>Ring final</strong> — two cables looping back to the same MCB. UK-only quirk
              that lets 32 A run on 2.5 mm².
            </li>
            <li>
              <strong>Lighting (loop-in)</strong> — radial in topology, but with a specific wiring
              style at each rose to keep junctions accessible.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              take everything offline. That principle is exactly why you don’t see one giant ring
              serving the whole house — you see a kitchen ring, a downstairs sockets ring, an
              upstairs sockets ring, separate lighting per floor, and dedicated specials.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>20 A radial</strong> — 2.5 mm² T&E, sockets up to 50 m² floor area (per the
              OSG informal guidance).
            </li>
            <li>
              <strong>32 A radial</strong> — 4 mm² T&E (or 6 mm² depending on derating), sockets up
              to 75 m² floor area.
            </li>
          </ul>
          <p>
            <strong>Failure mode:</strong> open circuit anywhere on the run takes down everything
            downstream of the break. A short to earth trips the protective device. Both fault modes
            are easy to localise because the break tells you where to look.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The clever bit: a 32 A ring on 2.5 mm² T&E works because the cable’s own Iz only has to
            carry half the load at the worst point — the other half is going round the long way.
            That’s why the regs allow 2.5 mm² (rated about 27 A clipped direct) on a 32 A MCB, when
            a single 32 A radial would need 4 or 6 mm².
          </p>
          <p>
            <strong>Spurs:</strong> one unfused single or twin socket per teed-off point on the ring
            (OSG and 433.1.204). For more sockets at one location, hang a 13 A switched FCU off the
            ring — the FCU’s fuse polices the spur, so you can run as many sockets as you like
            downstream.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The headline numbers for every UK ring final: 30 A or 32 A device, 2.5 mm² minimum T&E
              (or 1.5 mm² MICC). The reg also names the device families allowed — including old BS
              3036 rewireable fuses, which you’ll still meet on Victorian terraces with their
              original DBs.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              circuit; 10 A is used where a lot of LED transformers or older filament loads sit on
              the same circuit.
            </li>
            <li>
              <strong>Lamp count</strong>: BS 7671 doesn’t mandate a maximum, but BS 7671 Table A2
              and the OSG suggest 100 W per lamp position for design current calcs even on LED
              installs (so the same circuit can take a future swap-out).
            </li>
          </ul>
          <p>
            <strong>Failure mode:</strong> open-circuit on the loop drops every lamp downstream of
            the break. Open-circuit on a switch drop just kills that one lamp.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Standard 7 kW electric oven + 7 kW hob</strong> ≈ 14 kW total, but diversity
              (OSG Appendix A) reduces design current to about 10 + 30% remainder + 5 A for the
              socket. Typically lands on a 32 A MCB, 6 mm² T&E.
            </li>
            <li>
              <strong>9.5 kW shower</strong>: I = 9500 ÷ 230 ≈ <strong>41 A</strong> → 40 or 45 A
              MCB on 6 mm² T&E (clipped direct, short run).
            </li>
            <li>
              <strong>10.5 kW shower</strong>: I = 10500 ÷ 230 ≈ <strong>46 A</strong> → 50 A MCB on
              10 mm² T&E.
            </li>
          </ul>
          <p>
            Both appliances need local isolation — the 45 A cooker switch or the bathroom pull cord
            — so the customer can power them down without going to the consumer unit. Reg 462.1
            (provisions for isolation from each supply) is the hook.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Fuse rating sized to the appliance</strong> — 3 A for boilers and door bells,
              5 A for low-power equipment, 13 A for general fixed-load circuits. Manufacturer
              instructions specify it.
            </li>
          </ul>
          <p>
            <strong>Special case:</strong> on a 32 A ring, you can run as many spur sockets as you
            like off a single FCU because the FCU collectively protects the lot. That’s the standard
            approach for kitchen extensions where you’ve added more sockets than the ring will take
            as unfused spurs.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Boiler (combi or system)</strong>: switched 13 A FCU with a 3 A or 5 A fuse,
              fed off the ring or its own short radial. Local isolation is mandatory.
            </li>
            <li>
              <strong>Immersion heater (3 kW)</strong>: I = 3000 ÷ 230 ≈ 13 A → dedicated 16 A or 20
              A radial, 2.5 mm² T&E, with a double-pole 20 A switch by the cylinder.
            </li>
            <li>
              <strong>EV charger (7.4 kW)</strong>: dedicated 32 A radial, 6 mm² T&E, RCD with Type
              A + 6 mA DC detection (or per the charger’s manual). BS 7671 Section 722 gives the
              install rules.
            </li>
            <li>
            ...
            <li>
              <strong>Heat pump</strong>: dedicated radial sized for the steady-state plus start-up
              current — typically 25 or 32 A on 6 mm² T&E.
            </li>
          </ul>
          <p>
            <strong>Why dedicated:</strong> nuisance trips on a shared circuit can disable a fridge
            full of food, a boiler in winter, or a charging EV. The reg-level hook is 314.1 (avoid
            danger, minimise inconvenience). The practical hook is the manufacturer’s MIs, which are
            enforceable under BS 7671 510.3 (manufacturer’s instructions).
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              spurs from one point — a clear breach of OSG / 433.1.204. If both sockets pull close
              to 13 A each on a heavy load (gaming PC + amp + Sky), the spur cable’s running over
              its Iz with no fuse in front of it. Insulation cooks slowly. By the time the ring MCB
              notices, you’ve already had a fire risk on hand.
            </>
          }
          doInstead={
            <>
              One unfused spur per teed-off point on the ring. If you need more outlets in one
              location, fit a 13 A switched FCU on the ring and run the additional sockets in 1.5
              mm² downstream of the FCU — collectively protected at 13 A, no breach, no fire risk.
              Costs two minutes and a tenner more in fittings.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              kettle, microwave and toaster are on at once. Customer says it’s been like this since
              the previous tenant added a couple of extra sockets behind the worktop. You pull the
              consumer unit off — the kitchen ring shows two cables out, two cables back. Standard
              ring. But when you trace, you find the previous job ran an unfused spur to a third
              double socket between two existing ones — and the spur is in 1.5 mm² T&E.
            </>
          }
          whatToDo={
            <>
              Two problems. One — 1.5 mm² spur off a 32 A ring with no fuse is non-compliant
              (433.1.1, 433.1.204). Two — the trip is overload, not earth fault. Either replace the
              1.5 mm² spur in 2.5 mm² (compliant unfused spur), or — better — fit a 13 A switched
              FCU at the tee point and feed the extra socket in 1.5 mm² off the FCU (compliant fused
              spur, 13 A protection on the small cable). Then have a chat with the customer about
              not running every kitchen appliance simultaneously, or splitting the kitchen onto its
              own ring next rewire.
            </>
          }
          whyItMatters={
            <>
              The shape of a final circuit isn’t just about today’s tripping. It’s about who can
              safely add to it later, what the cable can carry under a future load, and whether the
              next periodic inspector signs it off or codes it C2. Compliance now saves a rewire in
              five years.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              charger isolator — each one is the local isolation provision for that dedicated final
              circuit. It’s why dedicated specials almost always have a switch outside the consumer
              unit.
            </>
          }
