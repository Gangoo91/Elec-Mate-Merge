...
const TITLE = 'Designing a small installation (3.1–3.6) | Level 2 Module 3.3.8 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Type D', 'Type B', 'No MCB — fuse only', 'Type C'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['~1.75 V', '~52.6 V', '~17.5 V', '~175 V'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 7,
    question: 'AFDDs (Reg 421.1.7) on this small commercial install (no sleeping accommodation):',
    options: [
...
const faqs = [
  ...
  {
    question:
      'I have specced everything correctly but the customer wants to add a sauna later — what do I do?',
    answer:
...
export default function Sub8() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 3 · Subsection 8"
        title="Designing a small installation"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Take a real spec — a small commercial unit, 200 m², single-phase 100 A TN-C-S supply.
          Design every circuit. Apply every concept from §3 Subs 1 to 7. Produce a complete circuit
          schedule with protective devices, cable sizes, containment and a fill check.
        </p>
        ...
        >
          <p>
            ...
            TN-C-S supply, declared Ze = 0.35 Ω, 100 A cut-out fuse. New fit-out from bare shell.
          </p>
          <p>
            <strong>Areas:</strong> customer-facing area (~120 m²), back-of-house with staff area +
            kitchenette (~50 m²), plant room (~15 m²), rear yard with EV bay (~15 m²).
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>4 lighting circuits</strong> — general LED throughout, emergency lighting on
              its own circuit, external bulkhead/PIR, illuminated signage.
            </li>
            <li>
              <strong>6 socket circuits</strong> — general staff area, kitchen ring, IT rack
              dedicated, plant-room sockets, EV charger dedicated, retail-floor ring.
            </li>
            <li>
              <strong>3 dedicated circuits</strong> — HVAC condenser, water heater, server PDU.
            </li>
          </ul>
          <p>
            <strong>Supply, origin and CU layout:</strong> 100 A switch-fuse at the origin, SPD Type
            2 fitted at the origin, distribution board with RCBO ways. Main bonding to MET.
            Containment along the back-of-house ceiling void in 50&times;50 mm metal trunking; T&E
            elsewhere; SWA for the buried run to the EV bay.
          </p>
        ...
        >
          <p>Connected load summary (before diversity):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Lighting (4 circuits) — 4 &times; ~6 A &asymp; 24 A.</li>
            <li>
              Sockets — retail ring, staff ring, kitchen ring, plant ring &asymp; 4 &times; 32 A
              &asymp; 128 A worst-case (almost never realised).
            </li>
          ...
          <p>
            <strong>Connected total:</strong> ~242 A — well over the 100 A supply if every circuit
            ran at full load simultaneously, which it will not.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              General socket circuits — 100 % of largest + 50 % of remainder = 32 + (3 &times; 32
              &times; 0.5) = 32 + 48 = 80 A.
            </li>
          ...
          <p>
            ...
            allows tighter diversity than this. After applying realistic OSG Appendix A diversity
            for a small commercial unit (typically 25–40 % on general sockets after the largest),
            the after-diversity demand for the unit comes out at approximately
            <strong> 78–92 A</strong>, comfortably inside the 100 A supply but with limited headroom
            for future expansion.{' '}
            <em>
              This is exactly why a senior designer would flag the customer about a possible future
              3-phase upgrade if more EV bays or kitchen kit are likely.
            </em>
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 314.1 is the regulation that justifies the 13-circuit split. We do not run all the
              lighting on one circuit because (a) and (c) — a single fault would plunge the whole
              unit into darkness. We do not run sockets and IT on the same RCBO because (d) — IT
              equipment generates protective conductor current that nuisance-trips RCDs sharing the
              load. We give the EV its own circuit and its own RCD because (a) and (b). Every split
              in this design points back to one or more clauses of 314.1.
            </>
          }
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>L1 — Customer-area lighting</strong> — 6 A loop-in radial, 1.5 mm² T&E, 6 A or
              10 A Type B MCB.
            </li>
            <li>
              <strong>L2 — Back-of-house lighting</strong> — same.
            </li>
            <li>
              <strong>L3 — Emergency lighting</strong> — 6 A radial, dedicated, fed from same RCBO
              bank but flagged "Emergency — DO NOT switch off".
            </li>
            <li>
              <strong>L4 — External / signage</strong> — 6 A radial, IP-rated fittings, controlled
              by photocell or timer.
            </li>
            <li>
              <strong>S1 — Retail floor sockets</strong> — 32 A ring final, 2.5 mm² T&E, 30 mA RCBO
              Type A.
            </li>
            <li>
              <strong>S2 — Staff area sockets</strong> — 32 A ring final, same.
            </li>
            <li>
              <strong>S3 — Kitchen sockets</strong> — 32 A ring final dedicated to kitchenette, 30
              mA RCBO Type A.
            </li>
            <li>
              <strong>S4 — IT rack</strong> — 16 A dedicated radial, 2.5 mm² T&E, 30 mA RCBO Type A
              on its own way (avoid sharing nuisance-trip risk with general sockets).
            </li>
            <li>
              <strong>S5 — Plant room sockets</strong> — 20 A radial, 2.5 mm² T&E, 30 mA RCBO Type
              A.
            </li>
            <li>
              <strong>S6 — EV charger</strong> — 32 A dedicated radial, 6 mm² SWA buried + T&E
              indoors, 30 mA RCBO Type B (or Type A if charger has integrated DC RCM).
            </li>
            <li>
              <strong>D1 — HVAC condenser</strong> — 20 A dedicated radial, 4 mm² T&E, 20 A Type C
              MCB (motor inrush).
            </li>
            <li>
              <strong>D2 — Water heater</strong> — 16 A dedicated radial, 2.5 mm² T&E, 16 A Type B
              MCB.
            </li>
            <li>
              <strong>D3 — Server PDU</strong> — 16 A dedicated radial, 2.5 mm² T&E, 16 A Type B
              AFDD-RCBO (server room arc-fault risk).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Customer area</strong> — T&E (6242Y) chased into stud walls and dropped to
              socket positions, capped, finished. Reg 522.6.202 satisfied via 30 mA RCD additional
              protection on every socket circuit.
            </li>
            <li>
              <strong>Back-of-house ceiling void</strong> — 50&times;50 mm metal trunking carrying
              singles for the 6 socket circuits and the 4 lighting circuits, plus T&E for any short
              drops to fittings. Trunking grounds to MET.
            </li>
            <li>
              <strong>Plant room</strong> — galvanised conduit and trunking — all surface-mount, no
              concealed work, mechanical protection from impact.
            </li>
            <li>
              <strong>Rear yard to EV bay</strong> — 6 mm² SWA buried at minimum 600 mm depth (BS
              7671 Reg 522.8.10 typical), warning tape above, marker posts at the property boundary.
            </li>
            <li>
              <strong>External lighting / signage</strong> — IP-rated SWA or LSF flex out to
              fittings.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Stage 4 — Cable sizing per circuit (Sub 3.7 ten-gate process)
        </ContentEyebrow>
        ...
        >
          <p>
            Schedule (after the ten-gate calc on each circuit). Numbers verified — Method C clipped
            direct, 30 °C ambient assumed indoors, derates applied where grouping or insulation
            justifies it.
          </p>
              ...
              >
                <div className="flex items-center justify-between border-b border-white/[0.08] pb-2 mb-2.5">
                  <div className="flex items-baseline gap-2.5">
                    ...
                    <span className="text-white text-[14px] font-medium">{row.desc}</span>
                  </div>
          ...
          <p className="text-[12.5px] text-white/70 italic">
            Vd % uses indicative mV/A/m: 1.5&nbsp;T&E = 29, 2.5 = 18, 4 = 11, 6 = 7.3 (clipped
            direct). All circuits clear the 5 % limit (3 % for lighting). Numbers rounded to two
            decimals.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lighting (L1–L4)</strong> — Type B MCB integrated into a Type A RCBO. Type A
              handles the pulsating DC fault waveforms from LED drivers.
            </li>
            <li>
              <strong>General socket rings (S1–S3, S5)</strong> — Type B MCB integrated into a Type
              A RCBO at 32 A (or 20 A for plant). Reg 411.3.3 mandates 30 mA RCD on socket outlets
              up to 32 A.
            </li>
            <li>
              <strong>IT rack (S4)</strong> — its own Type A RCBO to keep the IT-driven PE current
              off the shared general-sockets RCBO. Stops the routine "RCD trip every Monday morning
              when the office lights up" failure mode.
            </li>
            <li>
              <strong>EV charger (S6)</strong> — Type B RCBO (or Type A + integrated DC RCM in the
              charger). BS 7671 Section 722 + Reg 722.531.3.5 require DC fault protection.
            </li>
            <li>
              <strong>HVAC (D1)</strong> — Type C MCB (5–10× In magnetic trip) to ride out the
              compressor inrush. RCBO if the condenser is outdoors.
            </li>
            <li>
              <strong>Water heater (D2)</strong> — Type B MCB at 16 A. Steady resistive load, no
              inrush.
            </li>
            <li>
            ...
            <li>
              ...
              534). No exposed overhead supply, no external lightning protection system, so Type 1
              is not required.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 411.3.3 makes 30 mA RCD additional protection the default on every socket outlet
              up to 32 A, in any installation. The only escape route is a documented risk assessment
              (and that escape is not available in a dwelling). For our small commercial unit, every
              general socket circuit gets a 30 mA RCBO. The IT rack and the plant-room sockets are
              also socket outlets and also get the 30 mA RCBO — the documented risk assessment
              exception is reserved for fault-finding on industrial control systems where
              nuisance-tripping a production line would create greater danger.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 411.3.4 applies <strong>only</strong> to domestic premises. In our commercial unit
              it does not bite, so 30 mA RCD on lighting is a design choice, not a regs mandate.
              Most modern RCBO consumer-unit fits have RCBOs on every way anyway, so all four
              lighting circuits end up RCD-protected — but the regs do not force it commercially.
              Worth knowing because a domestic-trained electrician will sometimes apply 411.3.4 by
              reflex on commercial work and miss that the requirement is location-specific.
            </>
          }
        ...
        >
          <p>Cable factors from OSG Appendix H Table H4 (singles, copper):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            lighting circuits &times; 3 cores = 12 of 1.5 mm² (or 2 cores switched live runs are a
            separate calc; we will assume worst case 3 cores for sizing).
          </p>
          <p>
          ...
          <p>
            ...
            maximum. Spare capacity ≈ (1037 &times; 0.45) − 301.2 = 466.65 − 301.2 = 165.45 factor
            units — enough headroom for one or two more 2.5 mm² circuits later.
          </p>
          <p>
            <strong>Cg derate cross-check:</strong> from BS 7671 Table 4C1, 10 grouped circuits
            gives Cg ≈ 0.50. Our 32 A ring circuits in 2.5 mm² T&E have a tabulated CCC of ~27 A
            clipped direct (Method C); after Cg = 0.50 the derated Iz = ~13.5 A — which would{' '}
            <strong>fail</strong> Reg 433.1.1 against a 32 A device. To make the trunking work as
            designed we either (a) split the trunking into two parallel 50&times;50 mm runs to halve
            the grouping per trunking, or (b) use larger CSA singles — 4 mm² for the rings — to
            absorb the Cg hit.{' '}
            <em>
              This is exactly the kind of finding that surfaces during the fill check and forces a
              redesign upstream.
            </em>
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Section 443 says fit an SPD unless a risk assessment says otherwise — fair enough. You
              spec a Type 1 SPD at the consumer unit on every job, including this small commercial
              unit with no overhead supply and no external lightning protection system. The Type 1
              costs three times the Type 2, takes more space in the CU, and brings tighter
              installation rules (16 mm² minimum connecting conductor per Reg 534.4.10). You have
              over-engineered the protection at the customer&rsquo;s expense.
            </>
          }
          doInstead={
            <>
              Type 1 is for direct-strike protection — required where the building has an external
              BS EN 62305 lightning protection system, an exposed overhead supply, or specific
              risk-assessment outcomes pointing to direct lightning current exposure.{' '}
              <strong>
                Type 2 at the origin is the standard fit for a typical small commercial unit
              </strong>{' '}
              — handles switching surges and indirect lightning, with sensible Reg 534.4.10 sizing.
              Type 3 is added at sensitive equipment downstream where a final layer of clamping is
              justified. Read Section 443 + the BS EN 62305 risk assessment, then size the SPD to
              the answer — not by reflex.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You are halfway through the Stage 4 schedule. Circuit S6 — the EV charger — is shown
              on the architect&rsquo;s drawing as wall-mounted at the back of the rear yard, 80 m by
              route from the consumer unit (round the perimeter, down a kerb, across the yard). At
              30.4 A on 6 mm² SWA the Vd is (7.3 &times; 30.4 &times; 80) / 1000 ={' '}
              <strong>17.76 V</strong> — that is <strong>7.7 %</strong> of 230 V. Well over the 5 %
              non-lighting limit.
            </>
          }
          whatToDo={
            <>
              Three options, in order of preference. (1) Re-route the SWA to shorten the run — the
              architect&rsquo;s drawing assumed perimeter routing; a direct buried route across the
              yard cuts to ~50 m and brings Vd to 4.8 %. (2) If routing is fixed, size up to 16 mm²
              SWA — Vd drops to ~6.7 V (2.9 %) but the cable cost more than doubles. (3) Move the EV
              bay closer to the building (~30 m route) — needs customer sign-off but is the cheapest
              fix electrically. Flag all three to the supervisor with cost and disruption notes; let
              the customer choose.
            </>
          }
          whyItMatters={
            <>
              This is exactly the value an apprentice adds during design review. The architect drew
              the EV bay where it looked best on the site plan. The Vd gate catches it before the
              cable goes in the ground. The cost of changing a drawing is zero; the cost of changing
              a buried SWA run is enormous.
            </>
          }
        />
        ...
        >
          <p>The deliverable for the supervisor and customer:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Header block</strong> — 230 V single-phase TN-C-S, declared Ze = 0.35 Ω, 100 A
              cut-out, after-diversity maximum demand ~80 A.
            </li>
            <li>
              <strong>Distribution board</strong> — 13-way RCBO board, Type 2 SPD at the origin, MET
              with main bonding to gas and water service entries.
            </li>
            <li>
              <strong>Circuit schedule</strong> — 13 rows (Stage 4 table) with Ib / In / cable /
              route / Vd / device. Each row defendable column by column.
            </li>
            <li>
              <strong>Containment</strong> — 50&times;50 mm steel trunking BoH ceiling void, 29 %
              fill, with the Cg redesign decision documented.
            </li>
            <li>
              <strong>Wiring systems</strong> — T&E concealed (Reg 522.6.202 satisfied via 30 mA
              RCD), singles in trunking BoH, SWA buried to EV.
            </li>
            <li>
              <strong>Sign-off</strong> — supervisor reviews, signs the schedule, then procurement
              and install proceed.
            </li>
          </ul>
          <p>
        ...
        >
          <p>
            Section 4 takes the earthing-system assumption you made all through this Sub (TN-C-S, Ze
            = 0.35 Ω) and explains where every part of it comes from:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              The three earthing system types — TN-S, TN-C-S (PME), TT — and how to identify each on
              site.
            </li>
            <li>
              The fault loop in detail — Ze, R1 + R2, Zs, and the disconnection times in BS 7671
              Table 41.1 and 41.3.
            </li>
            <li>
              Main protective bonding, supplementary equipotential bonding, and where each is
              required.
            </li>
            <li>The earth electrode arrangement on a TT system and how to test it.</li>
            <li>
              RCD additional protection — when it is required and when it is the only path to ADS
              compliance.
            </li>
          </ul>
          <p>
            Cable sizing and earthing are two halves of the same compliance story — Reg 433.1.1 and
            Reg 411 working together. Section 4 closes the loop.
          </p>
        </ConceptBlock>
