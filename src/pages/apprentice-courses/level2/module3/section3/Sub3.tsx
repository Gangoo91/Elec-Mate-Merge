...
const TITLE = 'Minimum current carrying capacity | Level 2 Module 3.3.3 (AC 3.3) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: ['Ib ≤ Iz ≤ In', 'Iz ≤ In ≤ Ib', 'In ≤ Ib ≤ Iz', 'Ib ≤ In ≤ Iz'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Method 100', 'Method C', 'Method A', 'Method B'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  {
    id: 6,
    question: 'Required It (the tabulated current the cable must have) is calculated by:',
    options: [
      'It = In × Ca × Cg × Ci × Cf',
      'It = Ib ÷ (Ca × Cg)',
      'It = In ÷ (Ca × Cg × Ci × Cf)',
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Every cable has a current limit. Real-world derating brings that limit down. Skip this
          calc and the cable’s the next thing on fire — and the device that should have tripped
          doesn’t.
        </p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ib (design current)</strong> — the actual load the circuit will carry, in
              amperes. Calculated from kW, kVA or appliance schedule with diversity if applicable.
            </li>
            <li>
              <strong>In (rated current of device)</strong> — the standard MCB / RCBO / fuse rating
              chosen, e.g. 6, 10, 16, 20, 32, 40, 50 A.
            </li>
            <li>
          ...
          <p>
            Plus there’s a sub-clause: <strong>I2 ≤ 1.45 × Iz</strong>, where I2 is the current that
            causes effective operation of the device. For BS EN 60898 / BS EN 61009 RCBOs this is
            built-in to the standard — you don’t check it separately. For BS 3036 rewireable fuses
            you DO have to check it (which is exactly why Cf for BS 3036 is 0.725 — it forces an
            oversized cable that satisfies 1.45 × Iz automatically).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              capacity. Plus the device’s actual trip current can’t exceed 1.45 × cable Iz. Modern
              MCBs and RCBOs handle the 1.45 limit by design — only old BS 3036 fuses force you to
              derate the cable to comply (that’s the Cf = 0.725 in the next section).
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Method A</strong> — single-core insulated cables in conduit in an insulated
              wall.
            </li>
            <li>
              <strong>Method B</strong> — single-core or multi-core cable in conduit on a wooden
              wall (or in insulated wall but cable not touching insulation).
            </li>
            <li>
              <strong>Method C</strong> — multicore cable clipped direct to a non-metallic wall,
              free air at least one side. The most generous Iz column for T&E.
            </li>
            <li>
            ...
            <li>
              <strong>Method 100</strong> — T&E in stud wall covered by thermal insulation on at
              least one side. New-build domestic reality. Iz noticeably lower than Method C.
            </li>
            <li>
              <strong>Method 101</strong> — completely surrounded by thermal insulation. Worst case
              — Iz can be half the Method C value.
            </li>
          </ul>
          <p>
            <strong>Pick the worst</strong>: if a cable run passes through different methods (say,
            Method C in the loft, Method 100 through a stud wall), you size for the worst (Method
            100). The whole cable is one continuous conductor and it’s only as good as its hottest
            point.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Ci (thermal insulation)</strong> — applied via Method 100/101 or Reg 523.9
              explicit factors. Touching insulation one side ≈ 0.78; surrounded ≈ 0.55.
            </li>
            <li>
              <strong>Cf (BS 3036 fuse)</strong> — 0.725 if and only if the protective device is a
              BS 3036 rewireable fuse. Modern devices (BS 88, BS EN 60898 MCB, BS EN 61009 RCBO): Cf
              = 1.0.
            </li>
          </ul>
          <p>
          ...
          <p>
            That’s the It column value you need to find or beat in the Appendix 4 table for your
            chosen Reference Method. The CSA whose tabulated It first equals or exceeds this number
            is your minimum compliant size.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            tabulated It on the assumption that none of those additions are happening. The moment
            any of them ARE happening, the It is too high and the cable will run hotter than its
            rating.
          </p>
          <p>
            The correction factors aren’t guesses either — they come from decades of test-rig data
            on real cables in real configurations. A Cg of 0.65 for four grouped cables isn’t
            arbitrary; it’s what BSI tested. Trusting the factor is trusting the test result.
            Skipping it because the calc “looks fine without it” is the apprentice mistake that
            comes back in three years as a callback.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            across the columns (with sub-columns for 2-core loaded vs 3-core loaded). The numbers in
            the cells are tabulated It values in amperes. There’s nothing more to it than that —
            once you’ve got your cable type and Method, it’s a single lookup.
          </p>
          <p>
            The first time you do it on paper it takes ten minutes because you’re flipping between
            Table 4A2 (to confirm the Method), Table 4D5 (for the It value), Table 4B1 (for Ca) and
            Table 4C1 (for Cg). After ten or twenty cable sizings you’ll know which table is which
            without flipping. Memorise table numbers, not values — the values change with each
            amendment, the table structure doesn’t.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Ambient 35°C, 70°C PVC → Ca ≈ <strong>0.94</strong> (Table 4B1).
            </li>
            <li>
              3 circuits grouped clipped direct → Cg ≈ <strong>0.70</strong> (Table 4C1).
            </li>
            <li>
              No thermal insulation around the cable → Ci = <strong>1.00</strong>.
            </li>
            <li>
              Modern MCB (BS EN 60898) → Cf = <strong>1.00</strong>.
            </li>
          </ul>
          ...
          <p>So we need a tabulated It ≥ 48.6 A in the Method C column of Table 4D5.</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              10 mm² → It ≈ 64 A → <strong>passes</strong> (64 ≥ 48.6). ✓
            </li>
          </ul>
          ...
          <p className="text-[12.5px] text-white/70 italic">
            Note — Iz here is the install-corrected current capacity (the tabulated 64 A from Step 4
            multiplied through by Ca × Cg × Ci × Cf = 64 × 0.658 = 42.1 A). The tabulated 64 A
            figure is what the cable can carry under the BS 7671 reference conditions; the 42.1 A
            figure is what it can carry in this circuit&rsquo;s actual install conditions, and that
            is the number the inequality compares against In.
          </p>
          <p>
            The inequality holds — 10 mm² T&E is the minimum compliant CSA. 6 mm² would have been
            close enough to tempt some installers, but the maths says no — derated 6 mm² comes out
            at Iz ≈ 30.9 A, which fails the In = 32 A check.
          </p>

          <p>
            <strong>Step 6 — move on to voltage drop.</strong> Now check Vd at the chosen 10 mm²
            against the route length using the mV/A/m table for 10 mm² T&E. If voltage drop fails
            (over a long run), you’d step up to 16 mm² and re-do steps 4 and 5. We covered voltage
            drop properly in Module 2 §3.4.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Reasons to size up one step from the calc minimum:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              The calc lands within ~10% of the next size down — small changes in install conditions
              (extra grouping, hotter ambient) could push it non-compliant.
            </li>
            <li>
              The route passes through changeable conditions — a loft that might get insulated, a
              riser that might get extra circuits added.
            </li>
            <li>
              The voltage-drop check is going to be tight on a long run — sizing up the CSA fixes
              both Iz and Vd at once.
            </li>
            <li>
              The circuit is for kit the customer is likely to upgrade (EV charger, shower, cooker)
              — small CSA bump now beats a full rewire later.
            </li>
          </ul>
          <p>
            Reasons NOT to size up: cost, terminating bigger CSA into existing accessories (10 mm²
            won’t fit a standard socket terminal), and the cable just being physically harder to
            route. Sizing up is a judgement call, not an automatic rule. Document the reasoning in
            your design notes so the next person on the install knows why.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You add a new 32 A radial into a cable basket that already had three circuits running
              through it. The new cable’s sized for a single-circuit install (Cg = 1), so 6 mm² T&E
              looks fine on its own. But now there are FOUR circuits in the basket, Cg is 0.65, and
              every cable in there is over its real Iz. The new cable doesn’t trip immediately — it
              heats up, slowly cooks the others around it, and a year later you’ve got insulation
              cracking and intermittent earth faults across all four circuits.
            </>
          }
          doInstead={
            <>
              Before adding any circuit to a shared containment, look at every cable already there.
              Re-derate the lot for the new total grouping count. If the existing cables were sized
              at the limit, adding a fifth circuit might force every cable in the basket to be
              replaced. Better to spec a separate route for the new circuit, or accept that you’re
              committing to a basket re-pull.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You pick up a job to replace a faulty 32 A shower circuit. The previous installer ran
              6 mm² T&E through the loft, route length 25 m. The 6 mm² Method C value (47 A) looks
              comfortably above the In = 32 A. Job seems straightforward. You open the loft hatch
              and find the entire ceiling is now covered in 270 mm of mineral wool insulation — the
              cable runs through the middle of it, completely surrounded. Customer added the loft
              insulation last year for energy efficiency.
            </>
          }
          whatToDo={
            <>
              Reference Method changed without anyone telling you. Surrounded by insulation = Method
              101 — Iz roughly halved from Method C. 6 mm² Method 101 ≈ 23 A, which is comfortably
              below In = 32 A. The 6 mm² is now non-compliant against 433.1.1. Two options. (1)
              Re-route the cable above the insulation, on the joists, clipped direct — back to
              Method C, 6 mm² compliant again. (2) Up-size to 10 or 16 mm² and accept the Method 101
              derate. Option 1 is usually cheaper and faster, plus it stops the cable cooking.
              Either way, write the loft insulation install up as a contributing factor in the
              report.
            </>
          }
          whyItMatters={
            <>
              ...
              upgrade insulation, fit-out tenants stack new circuits in shared trunking, summer heat
              changes ambient. A cable that was compliant at install can become non-compliant later
              — and that’s a periodic-inspection finding (C2 if loaded above Iz, C1 if showing
              thermal damage). Always re-survey before adding to or modifying an existing circuit.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Appendix 4 is the canonical source for everything in this Sub. Reference Methods are
              defined in Tables 4A1–4A2; correction factors in Tables 4B–4C; tabulated It values in
              Tables 4D–4J. You don’t have to memorise the numbers — you need to know the recipe and
              where to look. Paraphrased from the appendix introduction; verify exact wording in the
              published BS 7671 Appendix 4 text.
            </>
          }
