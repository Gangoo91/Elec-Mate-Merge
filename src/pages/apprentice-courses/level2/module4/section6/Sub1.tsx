...
const quizQuestions = [
  {
    id: 1,
    question:
      'Which BS 7671 regulation requires continuity of every protective conductor to be verified by measurement of resistance?',
    options: ['643.3.1', '643.2.1', '411.4.5', '514.16.1'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    id: 4,
    question:
      'For a circuit protected by a 32 A Type B RCBO on a TN-C-S supply, you measure R1+R2 at the far socket = 0.45 Ω. Ze previously measured at the MET = 0.30 Ω. Compute Zs and decide pass/fail against the A4:2026 Table 41.3 limit using the 0.8 method.',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'You measure the CPC continuity of a 1.5/1.0 mm² lighting circuit and get 0.00 Ω at the far light fitting. What is the most likely explanation?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'When testing the continuity of a main bonding conductor from the MET to the gas service:',
    options: [
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 6 · Subsection 1"
        title="Test continuity of protective conductor"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The R1+R2 and R2-only methods for proving the CPC works end-to-end — instrument setup,
          lead nulling, the test sequence and how the reading feeds into your Zs calculation.
        </p>
        ...
        >
          <p>
            ...
            CPC will read open-circuit and look fine — even though there is a serious safety defect
            waiting for the moment you energise.
          </p>
          ...
          <p>Continuity is the foundation. Get it wrong and every later test result is suspect.</p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Every CPC and every bonding conductor must be continuity-tested by measurement — not
              by visual inspection alone. The ring-final live-conductor part of (b) is covered in
              Sub 2; the protective-conductor part of (a) is what this Sub covers. Note: it is not
              enough to confirm the CPC is connected — you must measure resistance and record the
              value.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Calibration in date.</strong> 12-month calibration cycle is industry standard.
              The certificate should be available on request and the sticker in date.
            </li>
            <li>
            ...
            <li>
              <strong>Lead null performed.</strong> Touch the probes together, press null/zero, read
              0.00 Ω. Repeat after every lead change.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The nulling routine on a typical MFT:</p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>Switch the meter to the continuity range (often labelled R-LO or similar).</li>
            <li>
              Connect both test leads to the meter — usually red to + and black to common/COM.
            </li>
            <li>
            ...
            <li>
              Press the null/zero button (often marked with a Ø or 0). The reading should snap to
              0.00 Ω.
            </li>
            <li>
              Separate the probes. The meter should now read OL (open) — confirming nulling stored
              correctly.
            </li>
          </ol>
          <p>
            Without nulling, every reading is over-stated by the lead resistance. On a 30 m lighting
            run with R1+R2 ≈ 0.90 Ω that might not matter; on a short bonding run expected to read
            0.04 Ω it would push the reading to 0.20 Ω and trigger an unnecessary investigation.
          </p>
        </ConceptBlock>
        ...
        >
          <p>R1+R2 step-by-step on a domestic radial:</p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Verify safe isolation.</strong> Per the JIB sequence: identify the circuit,
              isolate, lock off, prove the proving unit is working, prove the circuit dead at point
              of work, prove the proving unit again.
            </li>
            <li>
              <strong>Disconnect the circuit at the consumer unit.</strong> Lift the line and CPC of
              the circuit out of the protective device and earth bar respectively. This stops the
              meter seeing parallel paths through other circuits.
            </li>
            <li>
              <strong>At the far end of the circuit</strong> (the furthest accessory or the socket
              nearest the end of the cable), link the line and CPC together with a short jumper or
              by squeezing them into a single connector block.
            </li>
            <li>
              <strong>Back at the consumer unit</strong>, connect one MFT lead to the line conductor
              and the other to the CPC. Press TEST. Note the reading.
            </li>
            <li>
              <strong>Record the value</strong> on the Schedule of Test Results in the R1+R2 column
              for that circuit.
            </li>
            <li>
              <strong>Remove the link</strong> at the far end and re-connect line and CPC into the
              protective device and earth bar at the CU.
            </li>
          </ol>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Your measured R1+R2 plus the Ze you measured at the MET gives Zs. Compare Zs to Table
              41.3 (with the 0.8 multiplier for cold-cable test conditions). If Zs is too high, the
              protective device cannot guarantee 0.4 s disconnection — you must reduce R1+R2
              (thicker cable, shorter run, fix bad terminations) or change the protective device
              rating, then re-test.
            </>
          }
        ...
        >
          <p>
            The choice between R1+R2 and R2-only is mostly about access and what's actually there to
            loop:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Use R1+R2 when</strong> you have a circuit final with a line conductor and a
              CPC running together, both ends accessible, and you want the value that feeds directly
              into Zs = Ze + (R1+R2). Default for every domestic radial and (via the three-part
              test) every ring final.
            </li>
            <li>
              <strong>Use R2-only when</strong> there is no L to loop with — main bonding,
              supplementary bonding in special locations, standalone earth conductors to structural
              steel — or when the far end of a circuit cannot be reached to fit a link.
            </li>
            <li>
              <strong>R2-only on a long lead</strong> is also the right call when you want to
              spot-check a single accessory mid-run on a long radial — wander lead from the MET out
              to the suspect terminal lets you verify the CPC is intact at that point without
              disturbing the whole circuit.
            </li>
          </ul>
          <p>
            On a typical domestic install you might use R1+R2 for every final circuit (8-12
            readings) and R2-only with the wander lead for the 2-3 main bonding runs. On a swimming
            pool or zone-rich bathroom rebuild you'll do far more R2-only work because of the
        ...
        >
          <p>
            The MFT continuity range injects a small DC current (≥ 200 mA per BS EN 61557-4) and
            reads the voltage drop across whatever's between the probes. Test leads themselves are
            conductors and add their own resistance to the reading — typically 0.10 to 0.30 Ω
            depending on lead length and condition. Nulling tells the meter to subtract that lead
            resistance from every subsequent reading.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Probe-tip oxide</strong> — the thin oxide layer that builds up on probe tips
              between uses. The 200 mA test current punches through it but it still adds a small
              resistance the meter has to know about.
            </li>
            <li>
              <strong>Connector contact resistance</strong> — where the leads plug into the meter.
              Worn sockets add resistance.
            </li>
          </ul>
          <p>
            <strong>Calibration drift:</strong> over time the meter's internal reference can drift
            slightly, especially on instruments that haven't been calibrated in 12+ months. The null
            routine compensates for short-term drift but not for major reference error — that's what
            the annual calibration cycle is for. If you find yourself nulling and the meter won't
            snap to 0.00 (it sits at 0.05 or higher even with probes touching), the meter needs a
            service before it goes any further on the job.
          </p>
          <p>
        ...
        >
          <p>Cases where R2-only with a wander lead is the right call:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Bonding conductors.</strong> A 10 mm² main bonding cable from the MET to the
              gas service has no line conductor to loop with. R2-only is the only way.
            </li>
            <li>
              <strong>Supplementary bonding in special locations.</strong> Bathroom supplementary
              bonding (where still required), swimming-pool zone bonding, agricultural bonding —
              these are stand-alone CPCs without an associated L conductor.
            </li>
            <li>
              <strong>Inaccessible far ends.</strong> If the far end of a circuit is buried in a
              wall void or a sealed enclosure and cannot be opened to fit a link, R2-only from the
              MET to the nearest accessible point can prove the CPC.
            </li>
            <li>
              <strong>Bonding continuity to extraneous parts</strong> like structural steel, where
              you want to prove the bonding clamp works — measure from the MET via wander lead to
              the metalwork itself.
            </li>
          </ul>
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Connect the wander lead to the MET clamp (or to the bonding clamp / earth bar at the
              consumer unit, depending on what you are proving).
            </li>
            <li>
              Null the leads — null with the wander lead in circuit, not just the short MFT leads,
              otherwise you are not zeroing out the wander-lead resistance.
            </li>
            <li>
              Touch the probe end of the wander lead to the far point — the bonding clamp at the gas
              service, the CPC terminal at a socket, the accessible metalwork.
            </li>
        ...
        >
          ...
          <div className="hidden sm:block bg-[hsl(0_0%_10%)] border border-white/[0.08] rounded-xl p-4 text-[14px] font-mono">
            <div className="grid grid-cols-3 gap-2 text-white/90">
              ...
              <div className="text-elec-yellow/80 text-[12px] uppercase tracking-wide">
                Max Zs (table)
              </div>
              <div className="text-elec-yellow/80 text-[12px] uppercase tracking-wide">
                Measured limit (×0.8)
            ...
            {[
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 mt-1.5 text-white/80">
                  <div>
                    <div className="text-[10.5px] uppercase tracking-wide text-white/50">
                      Max Zs (table)
                    </div>
                    <div>{row.table}</div>
                  </div>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You test R1+R2 on a 25 m radial circuit. The meter reads 0.00 Ω. You think "perfect"
              and write it down. The reality: you forgot to disconnect the CPC at the earth bar in
              the consumer unit. The meter is reading a parallel path back through the main earthing
              terminal and bonding to the far end via another circuit's CPC. Your circuit's actual
              CPC could be completely broken and you would never know until a fault occurred and the
              path through the bonding loop saturates or disconnects.
            </>
          }
          doInstead={
            <>
              For any continuity test on a CPC, disconnect the CPC of the circuit being tested from
              the earth bar at the consumer unit. The meter then sees only the cable you are
              testing. A 25 m run of 2.5/1.5 T&E should give R1+R2 ≈ 0.49 Ω — a reading anywhere
              near zero on a sensible cable run is a red flag, not a pass. Re-test with the CPC
              properly isolated.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Mid-job you change from short prod-tip leads to a long crocodile-clip lead set so you
              can reach inside a deep back-box. You forget to re-null. Every subsequent reading is
              over-stated by an extra 0.20-0.40 Ω. A B32 ring final reading 1.05 Ω R1+R2 (which when
              added to a Ze of 0.30 gives Zs of 1.35 Ω — already at the corrected limit) gets
              recorded as 1.45 Ω — and you re-design the circuit unnecessarily, or worse, you mark a
              perfectly fine circuit as a fail.
            </>
          }
          doInstead={
            <>
              Re-null the leads any time you change them, even briefly. Modern MFTs make this a
              single button press. Develop the habit: change leads → null → test. The thirty seconds
              it takes is much less than the time you would lose chasing a phantom fault on a
              circuit that was actually compliant.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You have just installed a kitchen ring final circuit on a domestic refurb. T&E 2.5/1.5
              mm², measured route length around the ring ≈ 28 m. Protective device is a 32 A Type B
              RCBO. Ze previously measured at the MET = 0.30 Ω (TN-C-S supply). You are about to
              take the R1+R2 reading at the furthest socket (the one nearest the halfway point of
              the ring electrically). You measure 0.45 Ω.
            </>
          }
          whatToDo={
            <>
              Compute Zs: Zs = Ze + (R1+R2) = 0.30 + 0.45 = 0.75 Ω. Compare against Table 41.3
              (A4:2026) Type B 32 A = 1.37 Ω. Apply the 0.8 multiplier: corrected measured limit =
              1.37 × 0.8 = 1.10 Ω. Your measured Zs of 0.75 Ω is comfortably below 1.10 Ω. Pass.
              Record 0.45 Ω in the R1+R2 column of the STR for that circuit, and note Zs = 0.75 Ω in
              the calculated-Zs column. Headroom of 0.35 Ω means you have margin to absorb terminal
              degradation, future cable warming or minor DNO supply changes.
            </>
          }
          whyItMatters={
            <>
              A 0.45 Ω R1+R2 on a 28 m ring of 2.5/1.5 T&E is exactly what you would expect from
              first-principles cable resistance: 28 m × 19.5 mΩ/m ÷ 4 (the ring divides loop in four
              when measured at the electrical midpoint) ≈ 0.14 Ω calculated cold. You are reading
              higher than the cold calc because the meter is measuring real-world terminations, not
              idealised cable. The 0.45 Ω includes the resistance of every outlet box terminal and
              the RCBO outgoing terminal — perfectly reasonable on a fresh install. If the reading
              came in at 1.05 Ω, you would be looking at three or four marginal terminations adding
              up — worth investigating before sign-off.
            </>
          }
        />
