...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'For an 8-circuit domestic CU swap-out, single-phase, TN-C-S, all RCBOs (Type A 30 mA), how many R1+R2 readings will you take at minimum during the dead-test sequence?',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'IR test: what test voltage and acceptance value for a standard 230 V circuit per A4:2026 Table 64?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'When you reach the polarity test in the dead sequence, what specifically are you verifying per Reg 643.6?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'A circuit feeding an EV charger — what additional disconnections do you need before the IR test?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'On a 12-circuit CU you have completed all dead tests. One circuit fails IR (reads 0.7 MΩ). You investigate and find a back-box where the cable sheath has been pinched against a sharp burr on the metal box. After re-routing and protecting the cable, what is the correct next action?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'After all dead tests pass, you energise the CU. What is the FIRST live test you carry out?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'A 32 A Type B RCBO ring final on TN-C-S. You measure (live test) Zs at the furthest socket = 0.78 Ω. Ze you measured earlier = 0.30 Ω. From the dead-test you computed Zs = 0.75 Ω. A4:2026 Table 41.3 max Zs for B32 = 1.37 Ω. Decide.',
    options: [
...
const faqs = [
  {
    question:
      'Why is the dead-test sequence ordered the way it is — could you not do them in any order?',
    answer:
  ...
  {
    question:
      'What if I cannot complete the dead-test sequence in one visit (e.g. customer needs to live in part of the property)?',
    answer:
  ...
  {
    question:
      "Are there any tests in the dead-test sequence that don't apply to a TT installation?",
    answer:
...
export default function Sub7() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 6 · Subsection 7"
        title="A4:2026 dead-test sequence end-to-end"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The complete BS 7671 dead-test sequence walked through on a domestic CU swap-out — 8
          circuits, single-phase, TN-C-S — with realistic readings at each step and the bridge to
          live tests after first energisation.
        </p>
        ...
        >
          ...
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              Identify the circuit, isolate, lock off, prove the proving unit, prove the circuit
              dead at the point of work, prove the proving unit again. Documented under Reg 132.16
              (cross-reference) and Reg 537 (isolation devices).
            </li>
            <li>
              <strong>Phase 1 — Continuity of CPCs and bonding</strong> (Sub 1, Reg 643.2.1). R1+R2
              loop method on every final circuit. R2-only with wander lead on every bonding
              conductor.
            </li>
            <li>
              <strong>Phase 2 — Ring final continuity</strong> (Sub 2, Reg 643.2.1(b)). Three-part
              test on every ring: end-to-end r1/rn/r2; L-N cross-connection at every socket; L-CPC
              cross-connection at every socket.
            </li>
            <li>
            ...
            <li>
              ...
              L terminal of every accessory; OL to N terminal. Verify single-pole devices in line,
              BC/ES outer contacts on neutral.
            </li>
            <li>
              <strong>Phase 5 — Earth electrode resistance (TT only)</strong> (Reg 643.7.2). 3-spike
              or stake-less clamp method. Typical 50-200 Ω for a single domestic electrode; verify
              against Table 41.5 max Zs for the RCD rating.
            </li>
            <li>
              <strong>Phase 6 — Bridge to LIVE tests.</strong> Re-make all CU terminations, fit any
              temporary covers / blanks for safety. Verify safe-to-energise. First energisation.
              Then live polarity → Ze → PFC → Zs at far end of every circuit → RCD trip times →
              functional.
            </li>
          </ol>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              When a test fails: fix the fault, then re-do that test AND any earlier tests in the
              sequence whose results could have been distorted by the same fault. Example: IR fails
              because of a pinched cable. The pinch could also have affected the earlier continuity
              reading (parallel path via the box). After fixing the pinch, re-test continuity and
              IR. Document: original failing reading, corrective action, post-correction passing
              reading.
            </>
          }
        ...
        >
          ...
          <p>
            Plus: SPD module on incoming side; main bonding to gas (15mm copper, ~5m run from MET).
          </p>
        ...
        >
          ...
          <div className="hidden sm:block bg-[hsl(0_0%_10%)] border border-white/[0.08] rounded-xl p-4 text-[13px]">
            <div className="grid grid-cols-3 gap-3 text-white/90">
              ...
              <div>C1 — Lighting d/s (1.5/1.0)</div>
              <div>0.95 Ω</div>
              <div>1.30 Ω (max for B6 = 7.28 → corrected 5.82 → pass)</div>
              <div>C2 — Lighting u/s (1.5/1.0)</div>
              <div>0.78 Ω</div>
              <div>1.13 Ω → pass for B6</div>
              <div>C3 — Ring d/s (2.5/1.5, post Part 3)</div>
              <div>0.21 Ω</div>
              <div>0.56 Ω → pass for B32 (max 1.37→corrected 1.10)</div>
              <div>C4 — Ring u/s (2.5/1.5)</div>
              <div>0.18 Ω</div>
              <div>0.53 Ω → pass for B32</div>
              <div>C5 — Kitchen ring (2.5/1.5)</div>
              <div>0.22 Ω</div>
              <div>0.57 Ω → pass for B32</div>
              <div>C6 — Cooker (6.0/2.5)</div>
              <div>0.11 Ω</div>
              <div>0.46 Ω → pass for B32</div>
              <div>C7 — Immersion (2.5/1.5)</div>
              <div>0.18 Ω</div>
              <div>0.53 Ω → pass for B16 (max 2.73→corrected 2.18)</div>
              <div>C8 — EV (10/4 SWA)</div>
              <div>0.06 Ω</div>
              <div>0.41 Ω → pass for C40 (Type C tighter limit ~0.55 Ω corrected)</div>
            </div>
          </div>
          ...
          <p>
            All eight circuits comfortably below the corrected A4:2026 Table 41.3 limits. Bonding:
            10 mm² main bonding to gas measured 0.04 Ω end-to-end — pass (well below the 0.05 Ω rule
            of thumb). Continuity phase complete.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Part 1 — end-to-end:</strong> r1 = 0.32 Ω, rn = 0.34 Ω, r2 = 0.55 Ω. r1 ≈ rn
              (within 6 %, fine); r2 ≈ r1 × 1.7 (close to expected 1.63 ratio). Pass.
            </li>
            <li>
              <strong>Part 2 — L-N cross-connection:</strong> readings at all 8 sockets between 0.16
              and 0.18 Ω. Constant within 12 % across all sockets. Intact ring on L and N. Pass.
            </li>
            <li>
              <strong>Part 3 — L-CPC cross-connection:</strong> readings at all 8 sockets between
              0.20 and 0.22 Ω. Highest = 0.22 Ω → R1+R2 for the circuit.
            </li>
            <li>
              <strong>Zs (calc):</strong> Ze + R1+R2 = 0.35 + 0.22 = 0.57 Ω. Pass against B32
              corrected limit 1.10 Ω.
            </li>
          </ul>
          <p>
            Same procedure for C3 and C4 — both pass. Cross-connection jumpers removed at the CU;
            all conductors re-landed in correct terminals; visual polarity check at the terminations
            confirms L into protective device, N into neutral bar.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Pre-test: lift SPD module from CU; isolate EV charger at port; switch lighting dimmers
            off (or remove if removable). Switch every functional switch ON so all downstream
            cabling is included.
          </p>
          ...
          <ul className="space-y-1 list-disc pl-5 marker:text-elec-yellow/70 text-[13px]">
            ...
            <li>C3: &gt;999 MΩ</li>
            <li>
              C4: 480 MΩ — investigate (reading lower than peers, but well above 1 MΩ minimum)
            </li>
            <li>C5: &gt;999 MΩ</li>
            <li>C6: &gt;999 MΩ</li>
            <li>C7: &gt;999 MΩ</li>
          ...
          <p>
            ...
            MΩ. Per Reg 643.7.2, also re-test continuity on C4 — R1+R2 still 0.18 Ω, no change.
            Document original 480 MΩ reading, corrective action, corrected &gt;999 MΩ on STR.
          </p>
        ...
        >
          <p>
            Methodical work-through each circuit, tick each accessory as it passes. Total accessory
            count on this install: ~50 (8 ceiling lights, 12 wall switches, 32 sockets, 1 cooker
            outlet, 1 immersion isolator, 1 EV charger isolator). Estimated time: 60-90 minutes. All
            pass — no reverse polarity errors found. Tick polarity column on STR for every circuit.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            TN-C-S supply means the earth fault path returns via the DNO PEN conductor, not via a
            property earth electrode. No earth electrode test required. Document on STR as "N/A —
            TN-C-S supply" in the earth electrode column.
          </p>
          <p>
            For comparison: on a TT install you would carry out the earth electrode test here,
            expecting 50-200 Ω for a single domestic electrode, well within the Table 41.5 limit of
            1667 Ω for a 30 mA RCD.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Live polarity at the CU:</strong> approved voltage indicator between L and E
              reads ~230 V; between N and E reads near zero. Confirms supply polarity is correct
              (meter tails not swapped at installation).
            </li>
            <li>
              <strong>Ze at the MET:</strong> loop tester between L of the supply and the MET, with
              the installation isolated. Measure. On this install, measured Ze = 0.32 Ω — close to
              DNO published 0.35 Ω. Use measured value for all Zs verification.
            </li>
            <li>
              <strong>PFC at origin:</strong> prospective fault current measurement. Records the
              maximum fault current available at the CU — used for switchgear breaking capacity
              verification.
            </li>
            <li>
              <strong>Zs at far end of every circuit:</strong> loop tester at the furthest accessory
              of each circuit. Records actual loop impedance under live conditions. Compare against
              dead-test calc; should agree to within ~0.05-0.10 Ω.
            </li>
            <li>
              <strong>RCD trip times:</strong> instrument-based test at 1 × IΔn for every RCD/RCBO.
              ≤ 300 ms acceptance (general non-delay). Record per A4:2026 Reg 643.7.3 / 643.8.
            </li>
            <li>
              <strong>Functional tests:</strong> integral RCD test buttons, AFDD test facilities,
              switchgear function, emergency stops, control logic.
            </li>
          </ol>
          <p>
            For this install all Zs measurements come in within 0.05 Ω of the dead-test calcs. All
            RCD trip times between 22 ms and 35 ms (well under 300 ms). All functional tests pass.
            EIC + Schedule of Inspections + STR completed and issued. NICEIC upload within 24 hours.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              was making intermittent contact — perfect for normal load but the increased Zs caused
              the RCBO to nuisance-trip on transient faults. A simple R1+R2 measurement at install
        ...
        <Scenario
          ...
          situation={
            <>
              Mid-way through the IR phase on a 12-circuit commercial unit refit, you measure the IR
              on the air conditioning circuit. Reading: 0.4 MΩ — fail. You investigate. It turns out
              the AC contactor and its control relay had been left landed during the IR test (you
          ...
          whyItMatters={
            <>
              ...
              certificates that pass on paper but fail in service. Customers, insurers and future
              inspectors all rely on the test sequence having been done correctly — short-cuts here
              are the most expensive kind of saved time in the industry.
            </>
          }
        />
