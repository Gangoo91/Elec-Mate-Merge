...
const checks = [
  ...
  },
  {
    ...
    options: [
      'Drop the test voltage to 250 V DC for the whole circuit so the electronics survive, and accept a minimum of 0.5 MΩ as if it were a SELV circuit.',
      ...
      'Leave the electronics connected and test at 500 V DC anyway — a single brief test will not harm modern equipment and gives the most representative reading of the circuit as installed.',
      'Skip the insulation test on that circuit entirely and record it as a limitation, because circuits with electronics cannot be insulation-tested.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Fail and do not energise — 18 MΩ is below the Table 64 minimum of 100 MΩ for a domestic circuit, so the insulation is defective and must be traced.',
      'Record it as a clear pass and move on — at 18 MΩ the insulation is well above the 1 MΩ minimum, so there is nothing to investigate and the order of magnitude is irrelevant.',
      ...
      'Re-test at 250 V DC — 18 MΩ at 500 V usually means the test voltage is too high for the cable, and the lower voltage will give the true reading.',
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      '(a) the CPC and the earth electrode only; insulation between live conductors is covered by the continuity test rather than the IR test.',
      '(a) line and earth, and (b) neutral and earth — these two readings alone are sufficient and line-to-neutral need not be tested.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    id: 2,
    question:
      'You are testing IR on a circuit that includes a single-pole switch. The switch is in the OFF position. Which conductors does the test cover?',
    options: [
      'The whole circuit, both sides of the switch — the IR test signal jumps an open switch, so the switch position makes no difference to what is tested.',
      'Only the cable downstream of the switch — with the switch open the upstream section is connected to the supply side and is excluded from the test.',
      ...
      'Nothing useful — an open switch invalidates the whole IR test, so the reading must be discarded and the circuit re-tested with the supply on.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 3,
    question:
      'On a 12-circuit domestic CU you have completed circuit-by-circuit IR testing. Each circuit reads >100 MΩ. You then test the whole installation as one (everything connected). Reading: 5 MΩ. Why?',
    options: [
      'There is a genuine insulation fault somewhere — testing the whole installation at once is the definitive method, and a 5 MΩ result overrides the individual readings and means the install fails.',
      'The meter battery is low — a whole-installation test draws more current than a single circuit, so the voltage sags and the reading drops; recharge and re-test.',
      'Capacitance between the bunched conductors has stored charge that the meter reads as leakage; leave the test running for a minute and the reading will climb back above 100 MΩ.',
  ...
  },
  {
    ...
    options: [
      ...
      'A mandatory thermal-imaging scan of each termination immediately after the IR test to confirm no leakage path is heating up.',
      'A second IR test taken 24 hours later to confirm the insulation reading has not drifted overnight, with both readings recorded on the schedule.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      'You are testing a SELV circuit (12 V LED downlights with a transformer). Which test voltage do you use and what is the minimum acceptance per Table 64?',
    options: [
      '500 V DC, 1.0 MΩ.',
      '250 V DC, minimum 0.5 MΩ.',
  ...
  },
  {
    id: 6,
    question:
      'Combined L+N to earth test on a typical 230 V circuit reads 0.45 MΩ. What does this mean?',
    options: [
      'A clear pass — 0.45 MΩ is above the 0.25 MΩ minimum that applies to combined L+N tests, so the circuit can be energised.',
      'Borderline but acceptable — anything above 0.1 MΩ passes for a combined test because the two conductors share the leakage, so no action is needed.',
      ...
      'A meter error — 0.45 MΩ is impossibly low for new cable, so the leads need nulling and the test repeating; the true value will be in the hundreds of megohms.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 7,
    question:
      'Why does BS 7671 require disconnection of equipment "likely to influence the test or be damaged" before the IR test?',
    options: [
      'Because connected equipment adds extra cable length to the circuit, which lowers the insulation reading below the 1 MΩ minimum even when the wiring itself is sound.',
      'Because the test current would flow through the equipment and energise it, creating a shock risk to anyone touching it during the test.',
      'Because leaving equipment connected slows the test down — the meter has to charge the equipment first, so disconnecting it simply speeds the reading up without affecting accuracy.',
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The 500 V DC test that proves cable insulation is intact between live conductors and to
          earth. Disconnect electronics first, retest at 250 V DC after reconnection per the A4:2026
          update.
        </p>
        ...
        >
          <p>
            ...
            or thermosetting compound around each core) and the outer sheath of the cable itself.
            Both are designed to withstand the rated voltage of the cable plus a margin — typically
            450/750 V for T&E, well above the 230 V working voltage.
          </p>
          <p>
            The IR test applies 500 V DC between conductors that should be isolated from each other
            (L-N, L-E, N-E) and measures the resistance of the insulation between them. Healthy
            insulation: leakage current is in nanoamps, resistance reads as gigohms or "above range"
            on the MFT. Damaged insulation: leakage is in microamps to milliamps, resistance drops
            to megohms or kilohms.
          </p>
          <p>The test catches three classes of defect:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Wiring errors</strong> — a neutral terminated on the earth bar, two conductors
              swapped at a junction box, a borrowed neutral from another circuit.
            </li>
            <li>
              <strong>Aging and environmental damage</strong> — moisture ingress at outdoor
              accessories, UV degradation on exposed cables, vermin damage, heat damage from chronic
              over-current.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <div className="hidden sm:block bg-[hsl(0_0%_10%)] border border-white/[0.08] rounded-xl p-4 text-[13px]">
            <div className="grid grid-cols-3 gap-3 text-white/90">
              ...
              <div>SELV and PELV</div>
              <div>250 V</div>
              <div>0.5 MΩ</div>
              <div>Up to and including 500 V (with the exception of the above)</div>
              <div>500 V</div>
              <div>1.0 MΩ</div>
              <div>Above 500 V</div>
              <div>1000 V</div>
          ...
          <div className="sm:hidden space-y-2">
            {[
              ...
              {
                v: 'Up to and including 500 V (with the exception of SELV/PELV)',
                test: '500 V DC',
                min: '1.0 MΩ',
              },
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 mt-2">
                  <div>
                    <div className="text-elec-yellow text-[10.5px] uppercase tracking-wide">
                      Test V
                    </div>
          ...
          <p>
            ...
            the primary side of the source and shall meet all the test requirements for low voltage
            circuits — Table 64 footnote.
          </p>

          <p>
            <strong>Real-world expectations:</strong> a healthy 500 V DC test on new T&E should read
            in the high megohms or gigohms. A reading right at 1.0 MΩ is acceptable per Table 64 but
            indicates significant insulation degradation that warrants investigation before
            sign-off.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>LED dimmers and LED driver electronics</strong> — input EMC filter capacitors
              conduct DC test current readily, giving a false low reading. Dimmers with electronic
              switch elements may be destroyed by the test voltage.
            </li>
            <li>
              <strong>EV charger control boards</strong> — most have isolation monitoring circuitry
              that will trigger or be damaged by the test signal.
            </li>
            <li>
              <strong>AFDDs (Arc Fault Detection Devices)</strong> — internal electronics vulnerable
              to DC stress.
            </li>
            <li>
            ...
            <li>
              <strong>Induction hob driver boards, smart appliances</strong> — disconnect at the
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              isolator (spur, FCU, plug-in connection).
            </li>
            <li>
              Run the standard 500 V DC test per Reg 643.3.2. Confirm the cabling itself meets the
              1.0 MΩ minimum (and ideally reads in the high megohms / gigohms).
            </li>
            <li>Reconnect the equipment.</li>
            <li>
              Apply a 250 V DC test between live conductors and the protective conductor. Minimum
              acceptance: 1.0 MΩ.
            </li>
            <li>
              Document both test results — note which equipment was disconnected for the main test,
              and the 250 V follow-up reading.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Identify electronics.</strong> Walk the circuit. Note: SPDs in the CU, LED
              dimmers in living areas, the EV charger isolator, integral electronic switches.
              Disconnect by unplugging, switching off at FCUs, or lifting from terminals as
              appropriate.
            </li>
            <li>
              <strong>Switch every functional switch ON</strong> so the entire downstream cable is
              included in the test. Two-way switches: set both throws to the closed position.
            </li>
            <li>
              <strong>Set the MFT to the 500 V IR range.</strong> Connect leads.
            </li>
            <li>
              <strong>Test L to E:</strong> probe to L of the protective device, probe to the earth
              bar (or to the CPC of the circuit if isolated). Press TEST. Hold until reading
              stabilises. Record.
            </li>
            <li>
              <strong>Test N to E:</strong> probe to the N terminal of the circuit, probe to earth.
              Press TEST. Record.
            </li>
            <li>
            ...
            <li>
              <em>Optional shortcut for the live-to-earth tests:</em> link L and N at the CU, then
              probe to the linked node and to earth. Single test reading. Faster on multi-circuit
              boards but loses some diagnostic detail if it fails.
            </li>
            <li>
            ...
            <li>
              <strong>Move to next circuit.</strong> Do not skip — every circuit gets its own set of
              readings.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>
            The disconnect-required equipment list has grown significantly with A4:2026 because of
            the proliferation of electronics in modern installations:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>SPD (Surge Protective Device) modules.</strong> Almost universal in modern UK
              CUs since A2. Pull the module from its base before any 500 V DC IR testing — the SPD's
              internal MOV will clamp the test voltage to a few hundred volts, giving a false low
              reading and either tripping the SPD's disconnect mechanism or sacrificing the MOV.
            </li>
            <li>
              <strong>AFDD (Arc Fault Detection Device) units.</strong> Required on certain
              higher-risk installations under A4:2026. Internal electronics vulnerable to DC stress.
            </li>
            <li>
              <strong>LED drivers and dimmer modules.</strong> Input EMC filter capacitors conduct
              DC test current readily, giving false low readings. Many dimmers will not survive a
              500 V DC stress on the input. Lift these at the FCU or remove from the lighting
              circuit before testing.
            </li>
            <li>
              <strong>EV charger control boards.</strong> Most have isolation monitoring circuitry
              (PME fault detection) that will trigger or be damaged. Disconnect at the charger's own
              isolator, not just at the CU.
            </li>
            <li>
              <strong>Smart switches and smart sockets.</strong> Anything with a microprocessor and
              a transformer or capacitor coupling to mains.
            </li>
            <li>
              <strong>Some types of RCD/RCBO.</strong> Rare but exists — certain electronic RCDs
              have an internal electronics path that the 500 V test can trigger. Check manufacturer
              data; if in doubt, disconnect at the RCD's load side.
            </li>
          </ul>
          <p>
            <strong>Workflow:</strong> walk the circuit (or whole CU) before testing, list every
            electronic device by location, disconnect each one, tick off the list. Run the 500 V DC
            tests. Reconnect everything. Apply the A4:2026 250 V DC follow-up test. Document the
            disconnections on the STR notes column.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>&gt; 999 MΩ (off scale, or "OL" on the IR range).</strong> Healthy insulation.
              The leakage current is below the meter's detection threshold. Document as "&gt;999 MΩ"
              or "&gt;200 GΩ" depending on the instrument range. This is what new T&E should read in
              normal conditions.
            </li>
            <li>
              <strong>100-999 MΩ.</strong> Acceptable. Some leakage is being detected — common in
              slightly damp environments, with some classes of electronic load left in, or where
              there's been brief surface contamination. Worth a moment to consider but not a defect.
            </li>
            <li>
              <strong>10-100 MΩ.</strong> Pass per Table 64 but warrants a quick investigation. Most
              likely cause on a domestic install: residual moisture in newly installed walls, a
              slightly compromised back-box, or surface contamination. Identify and fix before
              sign-off if you can.
            </li>
            <li>
              <strong>1-10 MΩ.</strong> Pass per Table 64 but a real concern. Real insulation
              degradation is happening — water ingress, a damaged cable sheath, a partial breakdown
              at a termination. Find and fix before sign-off; if you cannot identify the cause,
              document fully on the STR notes column with recommendation for early periodic
              re-inspection.
            </li>
            <li>
              <strong>&lt; 1 MΩ.</strong> FAIL. Do not energise. Real insulation breakdown somewhere
              in the circuit. Common causes: pinched cable in a back-box, water ingress at an
              outdoor accessory, neutral conductor touching CPC at a terminal. Find, fix, retest.
            </li>
          </ul>
          <p>
            The 1 MΩ pragmatic threshold dates back to the 17th edition era when more installations
            had genuinely degraded insulation than today. With modern PVC insulation systems and dry
            installations, anything below 100 MΩ is unusual on a new install and should be
            investigated even though it passes the regulation.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>
                SELV (Separated Extra Low Voltage) and PELV (Protective Extra Low Voltage):
              </strong>{' '}
              250 V DC test, minimum 0.5 MΩ. Use for 12 V LED downlight circuits (transformer side
              downstream), shaver socket SELV side, marine / outdoor low-voltage lighting. The lower
              test voltage protects the SELV equipment which is not designed for 500 V DC stress.
            </li>
            <li>
              <strong>Circuits up to and including 500 V (excluding the SELV/PELV row):</strong>
              500 V DC test, minimum 1.0 MΩ. The catchall for standard 230 V single-phase and 400 V
              three-phase circuits. This is the row that covers the vast majority of UK installation
              work — domestic, commercial, light industrial.
            </li>
            <li>
              ...
              standard work — when you do meet them, the higher test voltage matches the higher
              operating voltage of the cable's insulation system.
            </li>
          </ul>
          <p>
            The principle: test voltage is roughly twice the rated voltage of the circuit (within
            the band). Higher test voltage stresses the insulation more, revealing partial
            breakdowns that lower-voltage tests would miss. But test too high and you can damage
            equipment or the insulation itself — Table 64 is the calibrated balance of those two
            pressures.
          </p>
          <p>
            ...
            primary side and meet the LV requirements. Most installers don't encounter pure FELV
            systems often, but it's the catch — a FELV circuit gets tested at 500 V DC, not 250 V
            DC.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Steady reading around 0.4-0.8 MΩ on L-E or N-E.</strong> Most likely a pinched
              cable at a back-box or junction box where the sheath has been compressed against a
              sharp metal edge. Trace by isolating sections — disconnect at one accessory at a time
              and re-test until the reading jumps. The pinched accessory is the one that fixes it.
            </li>
            <li>
              <strong>
                Reading climbs slowly during the test (e.g. 0.3 MΩ rising to 5 MΩ over 15 seconds).
              </strong>{' '}
              Capacitive coupling — usually because an electronic device was left in. Most common
              cause: a forgotten LED driver or SPD. Stop the test, identify the device, disconnect,
              retest.
            </li>
            <li>
            ...
            <li>
              <strong>Failing reading only on N-E, not L-E.</strong> Strong indication of a wired-up
              neutral that's touching the earth bar or earth conductor somewhere — a "borrowed
              neutral" or a misterminated N at the consumer unit. Check the CU terminations first.
            </li>
            <li>
              <strong>Failing reading on outdoor or bathroom circuits in damp conditions.</strong>
              Water ingress at an outdoor accessory (junction box, garden socket) or at a bathroom
              IP-rated fitting that's been incorrectly sealed. Inspect and re-seal. Often improves
              over a few hours of dry weather but doesn't fix permanently without a re-seal.
            </li>
            <li>
              <strong>
                Failing reading on a brand-new circuit through freshly plastered walls.
              </strong>
              Residual moisture in the plaster carrying leakage. Often improves significantly over a
              few weeks as the plaster dries. Best practice: don't sign off until the plaster is
              fully dry, or re-test on a follow-up visit and amend the STR.
            </li>
          </ul>
          <p>
            Method of investigation: when an IR fault is found, work the circuit in halves — isolate
            at the midpoint, test each half. The half that still fails contains the defect. Halve
            again until you've localised to a single accessory or cable section. On a long radial
            this takes 10-15 minutes; on a short circuit, 3-5 minutes.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              modules are designed to lift out of a base for exactly this reason — pull the module,
              set it aside, run the tests, refit when done. After refitting apply the A4:2026 250 V
              DC follow-up to confirm the SPD itself is sound. Same routine for AFDDs, smart-switch
              modules and any other SPD-style protection in the CU.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              per-circuit reading is what matters and is what goes on the schedule of test results.
              Twelve good circuits at above 100 MΩ each is twelve passes; combined as a
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              with electronic dimmers in living areas, a kitchen ring with no electronic loads, a
              separate cooker circuit, an EV charger sub-circuit, and the usual mix of
          ...
          whatToDo={
            <>
              ...
              <br />
              <br />
              Per-circuit tests: 500 V DC, link L and N at the protective device, probe to earth bar
              — record. Probe L to N (with the link removed) — record. Repeat for every circuit.
              Document anything below 100 MΩ for further investigation.
              <br />
              <br />
              Reconnect electronics: SPD module back in base; dimmers re-fitted; EV charger isolator
              returned. Apply 250 V DC follow-up test per Reg 643.3.3 between linked L+N and earth
              at the incoming side of the CU — record this single whole-installation reading;
              confirm ≥ 1.0 MΩ. Document on STR with note "Initial 500 V test with SPD/dimmers/EV
              control disconnected per Reg 643.3.3; 250 V follow-up reading taken at incoming side
              after reconnection: X MΩ."
            </>
          }
          whyItMatters={
            <>
              ...
              near-universal SPD requirement and the prevalence of LED dimmers. Recording both the
              500 V cabling test and the 250 V whole-installation follow-up gives the next inspector
              a complete picture and proves you followed the regulation correctly.
            </>
          }
        />
