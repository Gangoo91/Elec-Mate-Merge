...
const checks = [
  {
    ...
    options: [
      'Polarity, insulation and continuity.',
      ...
      'Loop impedance, RCD trip and earth fault.',
      'r1 only, then rn only.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'To use up time.',
      'Because the regs require three different instruments.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Connect L of leg 1 to N of leg 1 at the CU.',
      ...
      'Bridge L of leg 1 to L of leg 2 at the CU.',
      'No cross-connection is needed for Part 2.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'The CPC is longer than the line.',
      'r2 should always be lower than r1.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'The MFT is set to the wrong range.',
      'The N is broken instead.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Unlimited spurs of any size are allowed.',
      'Spurs cannot be detected by testing.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'A perfectly compliant socket.',
      'The cable is the wrong size.',
      'The earth electrode is at fault.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Skip insulation resistance and energise.',
      'Fit the customer\'s cooker first.',
    ],
    correctAnswer: 1,
    explanation:
