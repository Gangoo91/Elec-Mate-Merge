...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      'Per-circuit columns on the IET model Schedule of Test Results include all of the following except:',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'Modern multifunction testers can download test data to a phone or PC. Does this replace the requirement to complete an STR?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'A circuit on the STR has Zs (calc) = 0.75 Ω from the dead test continuity values, and Zs (measured) = 0.78 Ω from the live test at the far end of the circuit. What does this slight difference mean?',
    options: [
...
export default function Sub6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 6 · Subsection 6"
        title="Record test results"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The Schedule of Test Results, Schedule of Inspections and Electrical Installation
          Certificate — the three forms that turn a successful test sequence into a defensible
          handover pack.
        </p>
        ...
        >
          ...
          <div className="hidden sm:block bg-[hsl(0_0%_10%)] border border-white/[0.08] rounded-xl p-4 text-[13px]">
            <div className="grid grid-cols-3 gap-3 text-white/90">
              ...
              <div>
                Top-level: address, designer / constructor / inspector signed declarations, supply
                characteristics, departures, recommendations, next inspection due date
              </div>
              <div>New installations + major alterations</div>

              <div>Schedule of Inspections</div>
              <div>
                Visual checklist: connection / identification of conductors, presence of devices,
                labels, barriers, fault protection, polarity, isolation methods
              </div>
              <div>Always paired with EIC</div>

              <div>Schedule of Test Results (STR)</div>
              <div>
                Per-circuit readings: continuity (R1+R2), ring final readings, IR (L-L/L-E/N-E),
                polarity tick, Zs (calc + measured), RCD trip times, AFDD test
              </div>
              ...
              <div>
                Single page: identification of altered portion, test readings for that portion,
                signed declaration
              </div>
              <div>
                Minor additions / alterations only — NOT for new circuits or CU replacements
              </div>

              <div>Electrical Installation Condition Report (EICR)</div>
              <div>
                Periodic inspection report: extent of inspection, observations, classifications
                (C1/C2/C3/FI), recommended next inspection
              </div>
            ...
            {[
              {
                ...
                captures:
                  'Top-level: address, signed declarations (designer/constructor/inspector), supply characteristics, departures, recommendations',
                when: 'New installations + major alterations',
              },
              {
                form: 'Schedule of Inspections',
                captures:
                  'Visual checklist: conductor connection / identification, presence of devices, labels, barriers, fault protection, polarity',
                when: 'Always paired with EIC',
              },
              {
                form: 'Schedule of Test Results (STR)',
                captures:
                  'Per-circuit: continuity, ring readings, IR, polarity, Zs (calc+measured), RCD trip times, AFDD test',
                when: 'Always paired with EIC; also used for EICR',
              },
              {
                form: 'Minor Works Certificate (MEIWC)',
                captures:
                  'Single page: altered portion identification, test readings, signed declaration',
                when: 'Minor alterations — NOT new circuits or CU swaps',
              },
              {
                form: 'Electrical Installation Condition Report (EICR)',
                captures:
                  'Periodic report: observations, classifications (C1/C2/C3/FI), recommended next inspection',
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The EIC certifies the installation is safe and compliant at the moment of issue. You
              cannot issue a clean EIC for an installation with a known IR fault, a non-compliant
              Zs, a missing CPC continuity, or any other defect identified during testing. Fix
              first, retest, then certify. This is the regulatory backbone of the "test then
              certify" sequence — without it, the certificate becomes a meaningless tick-box
              exercise.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Circuit identification:</strong> circuit number, description (e.g. "Kitchen
              ring final"), location.
            </li>
            <li>
              <strong>Wiring data:</strong> type of wiring (e.g. "T&E"), reference method (BS 7671
              Appendix 4 codes — 100/101/102/A-G), CSA of L conductor (mm²), CSA of CPC (mm²).
            </li>
            <li>
              <strong>Protective device data:</strong> type and rating of OCPD (e.g. "B32 RCBO BS EN
              61009"), max Zs from Table 41.3 for that device, IΔn for RCBOs (e.g. 30 mA), RCD type
              (AC, A, F, B), AFDD presence and type if fitted.
            </li>
            <li>
              <strong>Continuity readings:</strong> R1+R2 from cross-connection or radial test; r1,
              rn, r2 for ring finals.
            </li>
            <li>
              <strong>IR readings:</strong> L-L (or L1-N for single-phase), L-E, N-E (or combined
              L+N to E if linked).
            </li>
            <li>
            ...
            <li>
              <strong>Zs measured:</strong> live test reading at the far end of the circuit after
              first energisation.
            </li>
            <li>
              <strong>RCD data:</strong> trip time at 1 × IΔn (and at 5 × IΔn if reported by the
          ...
          <p>
            Sub 8 walks through every column with a fully worked example for a 32 A Type B RCBO ring
            final.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Details of the client / installation:</strong> address, occupier name, use of
              installation (domestic / commercial / industrial).
            </li>
            <li>
              <strong>Extent of installation covered:</strong> "complete installation" or
              "alteration to ground floor lighting circuit and addition of new EV charger circuit" —
              be specific.
            </li>
            <li>
              <strong>Supply characteristics:</strong> nominal voltage, frequency, prospective fault
              current at origin, Ze, system earthing arrangement (TN-S / TN-C-S / TT / IT). Number
              of phases.
            </li>
            <li>
              <strong>Designer declaration:</strong> "I, being the person responsible for the design
              ... certify ..." Signed and dated.
            </li>
            <li>
              <strong>Constructor declaration:</strong> "I, being the person responsible for the
              construction ..." Signed and dated. Same person can sign as designer + constructor on
              small jobs.
            </li>
            <li>
            ...
            <li>
              <strong>Comments / recommendations:</strong> anything the customer or future inspector
              needs to know — e.g. "RCD on socket-outlet circuit C5 omitted under Reg 411.3.3
              risk-assessment exception; risk assessment dated [date] held by client".
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              Schedule of Inspections plus EIC for new work; MEIWC for minor work) is prescribed;
              the contents are your test data plus the supporting context. Records are part of the
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Customer:</strong> full pack — EIC + Schedule of Inspections + STR. They need
              it for: any future EICR (so the inspector can compare current readings against the
              original installation values), property sale (solicitors increasingly ask for current
              EIC), insurance claim (proof the installation was certified at the time of an
              incident).
            </li>
            <li>
              <strong>Contractor:</strong> file copy retained per Limitation Act (six years minimum
              for civil liability) and per professional indemnity insurance (often 10-25 years).
          ...
          <p>
            For non-Part P work (e.g. minor maintenance, commercial installations not subject to
            building control), the CPS upload is not required but contractor / customer copies still
            are.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              document. Captures: address, supply characteristics (system type, Ze, PFC), designer /
              constructor / inspector declarations (each separately signed), any departures from BS
              7671 with reasoning, comments, recommended next inspection date. Signed by the
              competent persons in each role (often the same person on small jobs). Issued for new
              installations and major alterations.
            </li>
            <li>
              <strong>Schedule of Inspections.</strong> The visual checklist. Captures: tick items
              confirming connection of conductors, identification of conductors, presence of warning
              notices and labels, presence of fault and additional protection, methods of safe
              isolation, polarity verification at the installation level, etc. Always paired with
              the EIC. Signed by the inspector.
            </li>
            <li>
              <strong>Schedule of Test Results (STR).</strong> The per-circuit measurements.
              Captures: continuity readings (R1+R2 for radials, r1/rn/r2 plus R1+R2 for rings),
              insulation resistance readings (L-L, L-E, N-E), polarity per circuit, Zs (calc and
              measured), RCD trip times, AFDD test where fitted. Always paired with EIC. Signed by
              the inspector.
            </li>
            <li>
              <strong>Minor Electrical Installation Works Certificate (MEIWC).</strong> The
              single-page form for minor alterations to existing circuits — adding a single socket
              on an existing ring, replacing a damaged accessory like-for-like. Captures the test
              results for the altered portion only. Signed by the installer. NOT for new circuits or
              CU replacements.
            </li>
            <li>
              <strong>Electrical Installation Condition Report (EICR).</strong> The periodic
              inspection report — used to assess the condition of an existing installation rather
              than to certify new work. Captures: extent of inspection, observations with
              C1/C2/C3/FI classifications, recommended next inspection. Uses the STR for test data
              capture. Signed by the inspector.
            </li>
          </ul>
          <p>
            On a domestic CU swap (major alteration) — full EIC + Schedule of Inspections + STR. On
            a single-socket spur added to an existing ring — MEIWC alone. On a tenanted property's
            5-year periodic inspection — EICR with STR data underneath. Mixing up which form goes
            when is a sign-off error that invalidates the certification.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>On-site capture:</strong> meter records each test result with circuit ID, test
              type, value, time, and meter serial. Some meters let you assign results to circuits by
              labelling on the spot; others batch results and you assign post-test.
            </li>
            <li>
              <strong>Phone or tablet sync:</strong> manufacturer apps (Megger Powersuite Pro, Fluke
              Connect, Kewtech KEWPER) sync the meter via Bluetooth and store the results in a job
              folder. Photos and notes can be attached to each circuit.
            </li>
            <li>
              <strong>Certification software import:</strong> NICEIC Online, ElecCert, EasyCert,
              ElectricalCertificateSoftware etc. import the meter data and auto-populate the STR
              fields. The inspector reviews and adds any missing data (visual check items,
              departures, comments).
            </li>
            <li>
              <strong>Inspector review and sign:</strong> CRITICAL step. Review every auto-imported
              value for sense — does R1+R2 of 4.5 Ω make sense for a 25 m kitchen ring? (No — 30×
              expected; check the meter wasn't reading mΩ when the form expects Ω.) The inspector's
              signature certifies the data is correct.
            </li>
            <li>
              <strong>Issue and store:</strong> PDF generated, emailed to customer, uploaded to the
              Competent Person Scheme (NICEIC, NAPIT, Stroma, ECA), filed in the contractor's
              archive.
            </li>
          </ol>
          <p>
            The big productivity gain: 30-50% time saving on a typical CU swap-out compared to
            manual STR completion. The big risk: the auto-import process can introduce wrong-units
            errors, transposed circuit numbers, or stale data from the previous job. Inspector
            review before signing is the firewall.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sealed enclosures.</strong> Some accessories (sealed industrial enclosures,
              hospital theatre IPS panels) cannot be opened during routine certification without
              breaking IP seals. Document: "Limitation: enclosure not opened — visual inspection
              only via inspection window per manufacturer guidance."
            </li>
            <li>
              <strong>Sleeping rooms or occupied medical environments.</strong> Cannot disturb
              patients or sleeping residents to test polarity at every accessory. Document:
              "Limitation: testing of accessories in rooms 12-15 deferred to next scheduled
              maintenance window per ward sister's request; sample testing completed."
            </li>
            <li>
              <strong>Customer access restrictions.</strong> Customer has not provided keys to
              certain rooms or storage areas. Document: "Limitation: garage / outhouse / store room
              not accessed at first visit due to no key available; testing deferred to follow-up
              visit."
            </li>
            <li>
              <strong>Equipment that cannot be disconnected.</strong> Process-critical equipment
              that the customer cannot afford to take offline (e.g. a server, an MRI scanner, a
              computer-controlled production line). Document: "Limitation: IR test on circuit X not
              performed because the connected equipment could not be disconnected at the time of
              testing; visual inspection of cabling and terminations completed; periodic re-test
              recommended at next scheduled outage."
            </li>
            <li>
              <strong>Concealed cabling.</strong> Cables behind plaster, in walls, in floors cannot
              be visually inspected. Document: "Cable type and reference method determined by
              accessory inspection and voltage drop calculation; visual inspection limited to
              terminations at accessible accessories."
            </li>
            <li>
              <strong>Plaster / concrete drying time.</strong> A new install through freshly
              plastered walls may give borderline IR readings due to residual moisture. Document:
              "Initial IR readings within Table 64 minimum but lower than expected due to plaster
              moisture; re-test recommended at 6 months after dry-out for comparison."
            </li>
          </ul>
          <p>
            All limitations go in the STR Notes column for the affected circuit AND in the EIC
            Comments / Recommendations section at the top level. Set a follow-up date in your
            scheduling system — most limitations should be resolved by a follow-up visit within a
            defined window.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electrical Installation Certificate (EIC)</strong> with all declarations
              signed and dated.
            </li>
            <li>
              <strong>Schedule of Inspections</strong> with every applicable item ticked or noted.
            </li>
            <li>
              <strong>Schedule of Test Results (STR)</strong> with every per-circuit row completed.
            </li>
            <li>
              <strong>Building Control Compliance Certificate</strong> (for Part P notifiable work
              in England / Wales) — generated by the Competent Person Scheme after upload, posted to
              the customer separately by the scheme.
            </li>
            <li>
              <strong>Operational instructions for the customer</strong> — typically a written
              summary (or verbal walk-through with leaflet backup) covering: location of CU and main
              isolator; how the RCDs work and their monthly test routine; any special features
              (SPDs, AFDDs, smart switches with manuals); maintenance expectations; next inspection
              due date.
            </li>
            <li>
              <strong>As-built drawings</strong> where applicable — circuit schedules, panel
              schedules, single-line diagrams for larger commercial installations. Often affixed
              inside the CU door for the simplest residential cases.
            </li>
            <li>
              <strong>Manufacturer's manuals</strong> for any equipment installed (RCBOs, AFDDs, EV
              chargers, smart switches, SPDs).
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Customer:</strong> printed copy at hand-over plus PDF emailed for their
              records. They need it for any future EICR, property sale, insurance claim. Lifetime
              retention from their side.
            </li>
            <li>
              <strong>Contractor:</strong> file copy retained per Limitation Act (six years minimum
              for civil liability) and per professional indemnity insurer requirements (often 10-25
              years). Cloud storage of PDFs is standard.
            </li>
            <li>
              <strong>Competent Person Scheme:</strong> upload within scheme's notification window
              (typically 30 days) for Part P notifiable work in England / Wales. The scheme
              generates the Building Control Compliance Certificate that goes to the customer.
            </li>
            <li>
              <strong>Building Control:</strong> for non-CPS notifiable work, direct notification to
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You complete testing on a domestic install and find one circuit has a marginal IR
          ...
          doInstead={
            <>
              ...
              clean. If the customer is pressing for handover, explain that the certificate cannot
              be issued for an installation with known defects (Reg 644.1.1) and that the only path
              to handover is fixing the defect. Most defects (back-box pinch, damaged cable section)
              can be fixed in an hour. The conversation about delaying handover by an hour is much
        ...
        <Scenario
          ...
          situation={
            <>
              You have completed a domestic CU swap-out. 8 circuits, single-phase, TN-C-S, all RCBOs
              (Type A 30 mA), measured Ze = 0.30 Ω at the MET. All dead tests pass; live tests pass;
              RCD trip times all between 22 ms and 35 ms (well within 300 ms). Customer is the
              home-owner. Property is owner-occupied, no rented portion. You are NICEIC registered.
            </>
          }
          whatToDo={
            <>
              <strong>Schedule of Test Results:</strong> per circuit (8 rows) — record circuit
              number, description ("Kitchen ring final" etc.), wiring type (T&E), reference method
              (typically 100 or 101 for clipped direct or in stud wall), CSA L+CPC, OCPD type and
              rating (B32 etc.), RCBO IΔn (30 mA Type A), max Zs from Table 41.3 (1.37 Ω for B32,
              2.73 Ω for B16, etc.), R1+R2 (or r1/rn/r2 for rings), IR readings (L-L, L-E, N-E),
              polarity tick, Zs measured (live test), RCD trip time.
              <br />
              <br />
              <strong>Schedule of Inspections:</strong> tick every applicable item — connection of
              live conductors, identification of conductors with sleeving and labels, connection of
              single-pole devices in line, polarity verified, presence of fault protection (RCDs
              verified), presence of additional protection (30 mA RCDs on socket circuits per Reg
              411.3.3), presence of warning notices and labels at the CU, presence of diagrams and
              instructions, methods of safe isolation marked.
              <br />
              <br />
              <strong>EIC:</strong> address, occupier, "Major alteration — Consumer unit replacement
              to existing installation", supply characteristics (230 V, 50 Hz, single-phase, TN-C-S,
              Ze = 0.30 Ω, PFC = X kA, IR (the 250 V follow-up reading) = X MΩ). Designer /
              constructor / inspector all signed by you (single competent person job). Departures:
              none. Comments: any client-relevant notes (e.g. "Existing wiring retained downstream
              of CU; condition assessed as satisfactory during the alteration but full EICR
              recommended within five years"). Next inspection due: 10 years (owner-occupied
              domestic).
              <br />
              <br />
              <strong>Distribution:</strong> customer pack (printed and emailed); contractor file
              (cloud); NICEIC online portal upload within 30 days for Part P Building Control
              notification.
            </>
          }
          whyItMatters={
