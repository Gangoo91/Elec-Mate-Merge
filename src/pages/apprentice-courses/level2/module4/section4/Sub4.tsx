...
const checks = [
  {
    ...
    question: 'Which instrument and range do you use to test main bonding continuity?',
    options: [
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 4 · Subsection 4"
        title="Test continuity of main bonds"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 643.2.1 mandatory initial verification test. Low-resistance ohmmeter, leads nulled,
          reading recorded on the Schedule of Test Results. The test that proves the bond actually
          does its job.
        </p>
        ...
        >
          <p>
            ...
            produce a high continuity reading.
          </p>
          <p>
            The continuity test is also the verification that protective bonding actually exists
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              circuit protective conductor), every main protective bonding conductor (to gas, water,
              oil, structural steel etc.), and the ring legs of every ring final circuit. The test
              method is "by measurement of resistance" — meaning a low-resistance ohmmeter, not a
              buzzer continuity check. Document each result on the Schedule of Test Results.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Test current:</strong> 200 mA (not the lower 10 mA "no-trip" range). Higher
              current burns through surface oxide and gives a real measure of joint resistance.
            </li>
            <li>
              <strong>Resolution:</strong> 0.01 ohm or better. Typical bond readings are 0.02 to
              0.10 ohm — you need an instrument that can resolve those small differences
              meaningfully.
            </li>
            <li>
              <strong>Range:</strong> 0-2 ohm or 0-20 ohm autoranging. Some MFTs have a dedicated
              "continuity" range (with audible buzzer) and a "low ohm" range; use the low ohm range
              for bonding measurements as the buzzer continuity is typically less precise.
            </li>
            <li>
              <strong>Null/zero function:</strong> labelled "NULL", "ZERO" or "REL" depending on
              manufacturer. Subtracts the current reading so subsequent measurements exclude lead
              resistance.
            </li>
            <li>
              <strong>Calibration certificate:</strong> in date. BS 7671 Reg 643.1 requires test
              instruments to be appropriate for the test, and trade practice plus most Approved
              Contractor schemes require calibration on a 12-month cycle.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            Lead resistance is the silent enemy of accurate continuity measurement. A 1 m pair of
            croc-clip leads typically reads 0.10 to 0.20 ohm with the clips touched together. A 5 m
            extension lead pair can read 0.50 ohm or more. Without nulling, every bond reading is
            corrupted by this baseline.
          </p>
          <p>The right setup:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Short test leads (1-2 m) with secure crocodile clips or 4 mm probe tips.</li>
            <li>
              Inspect the clip jaws — clean copper contact, no corrosion. Replace the leads if any
              sign of damage.
            </li>
            <li>
              Touch the clips together at the start of every test session and check the instrument
              reads near zero (after a small null adjustment).
            </li>
            <li>
              Re-null whenever you change leads, change clip type, or after any rough handling.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Isolate the supply</strong> at the main switch. Lock off if possible. Prove
              dead at the MET using a GS38 voltage tester confirmed against a known live source
              first.
            </li>
            <li>
              <strong>Disconnect the bond at one end</strong> — typically the MET end. Loosen the
              terminal screw, withdraw the conductor, position it clear of the MET busbar. This
              breaks any parallel paths.
            </li>
            <li>
              <strong>Set up the MFT</strong> — continuity range, 200 mA test current. Connect the
              test leads.
            </li>
            <li>
              <strong>Null the leads</strong> — touch the clips together and press the NULL button.
              Confirm the instrument now reads 0.00 ohm with the clips together.
            </li>
            <li>
            ...
            <li>
              ...
              m: 0.02 to 0.05 ohm. Anything above 0.10 ohm — investigate.
            </li>
            <li>
              <strong>Reconnect the bond</strong> at the MET end. Strip if necessary, ferrule, land,
              torque per Sub 2 procedure.
            </li>
            <li>
              <strong>Optional in-circuit retest</strong> — with the bond reconnected, you can
              re-measure to confirm the in-circuit reading (will be slightly lower due to parallel
              paths via earthing conductor). Useful as a sanity check on the installation as a
              whole.
            </li>
            <li>
            ...
            <li>
              <strong>Document</strong> — record the disconnected continuity value on the Schedule
              of Test Results against the relevant bond ("Main bonding to gas", "Main bonding to
              water" etc.).
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>Cable resistance per metre at 20 °C from BS 7671 Appendix 4 / IET On-Site Guide:</p>
          ...
          <p>Worked examples — disconnected bond continuity readings:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>10 mm² Cu, 5 m run</strong> — cable: 5 × 1.83 = 9.15 mOhm = 0.009 ohm. Plus
              terminations (typically 5-15 mOhm each): expected reading 0.02-0.05 ohm.
            </li>
            <li>
              <strong>10 mm² Cu, 10 m run</strong> — cable: 10 × 1.83 = 18.3 mOhm = 0.018 ohm. Plus
              terminations: expected reading 0.03-0.06 ohm.
            </li>
            <li>
              <strong>16 mm² Cu, 5 m run</strong> — cable: 5 × 1.15 = 5.75 mOhm = 0.006 ohm. Plus
              terminations: expected reading 0.02-0.04 ohm.
            </li>
            <li>
              <strong>25 mm² Cu, 8 m run</strong> — cable: 8 × 0.727 = 5.8 mOhm = 0.006 ohm. Plus
              terminations: expected reading 0.02-0.04 ohm.
            </li>
          </ul>
          <p>
            Anything dramatically above these expected ranges flags a contact resistance problem at
            one of the terminations. Use the disconnected-end method, then visually inspect each
            termination, then re-make if necessary.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Section 644 of BS 7671 sets out the certification requirements. The Schedule of Test
            Results is the test data that supports the EIC — every value measured at initial
            verification gets a row. For main protective bonding conductors:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Description of the bond — e.g. "Main bonding to gas service", "Main bonding to water
              service", "Main bonding to structural steel", etc.
            </li>
            ...
            <li>
              Pass/fail (or comment) — a typical 0.02-0.05 ohm reading is a clear pass; a reading
              above 0.10 ohm would warrant a comment and investigation before sign-off.
            </li>
          </ul>
          <p>
            The completed Schedule is part of the legal record of the installation. If a future EICR
            engineer (or insurance assessor or court) ever queries the bonding, the Schedule shows
            the as-built state at handover.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The reason this matters in numbers. A 1 m pair of standard croc-clip MFT leads measures
            around 0.13 to 0.18 ohm with the clips touched together. A 5 m extension lead pair can
            hit 0.40 ohm. Healthy main bond resistance on 10 mm² Cu over 4-5 m is 0.02 to 0.05 ohm.
            Without nulling, every reading is corrupted: a 0.04 ohm bond looks like 0.18 ohm, a 0.15
            ohm faulty bond looks like 0.30 ohm — both above the 0.10 ohm trade alarm threshold but
            not in a way that distinguishes good from bad.
          </p>
          <p>The null routine on the major UK trade MFTs:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Megger MFT1741 / MFT1731 series.</strong> Continuity range selected. Touch
              clips together. Press the TEST button — instrument measures and stores the lead
              resistance. Display shows "NULL" indicator. Subsequent readings have lead resistance
              subtracted.
            </li>
            <li>
              <strong>Fluke 1664FC / 1663 series.</strong> Continuity (Ω) range. Touch clips, press
              the TEST button or hold ZERO for two seconds depending on model. ZERO indicator
              appears. Some models also store lead resistance per-test profile so a multi-conductor
              test sequence keeps the null between measurements.
            </li>
            <li>
              <strong>Kewtech KT64+ / KT63.</strong> Low-Ω range. Press and hold the NULL button
              while clips are touched together; release when ZERO appears. Re-null any time you
              change clips.
            </li>
            <li>
              <strong>Metrel MI3155 EurotestXC.</strong> Continuity menu, R LOW sub-test. Press COMP
              (compensation). Touch clips. Press TEST. Display reads "Compensation OK" and stores
              the lead value.
            </li>
          </ul>
          <p>
            All four behave the same logically — they store the lead resistance and subtract it from
            subsequent readings. They differ in button labels and exact sequence. Read the manual
            for the specific MFT on your van; the technique only takes a minute to learn but
            skipping it corrupts every reading you take that day.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The physics. The MFT injects a controlled test current (typically 200 mA) at one clip
            and measures the voltage drop across the test loop. On a disconnected bond cable the
            loop is "MFT lead → MET-end conductor → bond cable → clamp-end conductor → MFT other
            lead". The reading is the bond cable + termination resistance only — what you want.
          </p>
          <p>
            On a fully-connected installation the loop has multiple parallel paths: the bond cable
            itself, the earthing conductor back through the MET to the supplier earth and round
            through the supplier neutral / electrode network, plus every other bond from gas /
            structural steel / etc. The MFT sees all paths in parallel and reports the combined
            resistance — typically 1/4 to 1/10 of the bond-cable-only value. You'd see, say, 0.005
            ohm where the disconnected reading would be 0.04 ohm. Misleading: the bond looks better
            than it is.
          </p>
          <p>The disconnect-at-one-end procedure isolates the bond under test:</p>
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              Isolate, lock off, prove dead at the MET using a GS38 voltage tester verified against
              a known live source (see Module 1 §3 safe isolation).
            </li>
            <li>
              Identify the bond conductor under test at the MET. Trace the cable from the MET
              terminal to the BS 951 clamp visually so you're confident which conductor is which
              (mis-identification under a live install is a real risk).
            </li>
            <li>
              Loosen the MET terminal screw and withdraw the bond conductor only. Leave every other
              CPC and bond connected — they're not under test.
            </li>
            <li>
              Position the disconnected end clear of the MET busbar and clear of any other bonded
              metalwork. Tape it to the cabinet wall with insulating tape if it's springy and wants
              to flop back onto the busbar.
            </li>
            <li>
              Connect the MFT clip to the disconnected MET end of the bond. Connect the other clip
              to the BS 951 clamp body or the conductor at the clamp end.
            </li>
            <li>Take the reading. Healthy: 0.02-0.05 ohm on 10 mm² Cu over 4-5 m.</li>
            <li>Reconnect at the MET — ferrule the strands, torque to spec per Sub 2 procedure.</li>
            <li>
              Optional but useful: retest in-circuit. Reading will be lower (parallel paths). The
              difference between disconnected and in-circuit confirms the parallel path is
              functional — i.e. the rest of the bonding system is sound. A disconnected of 0.04 ohm
              and an in-circuit of 0.03 ohm tells you the bond and the parallel earthing system are
              both healthy.
            </li>
          </ol>
          <p>
            Never test bonding continuity with the supply live. Multiple safety reasons (shock risk
            if you touch the wrong terminal) and multiple measurement reasons (parallel paths
            corrupt the reading, transient noise on the supply earth corrupts MFT accuracy).
            Isolate, disconnect, test, reconnect, restore — every time.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              you never nulled the leads — the 0.20 ohm baseline IS the lead resistance, not a bond
              fault.
            </>
          }
          doInstead={
            <>
              ...
              together, press NULL, confirm the instrument reads 0.00 ohm with the clips together.
              NOW your subsequent readings reflect actual bond resistance. Re-null whenever you
              change leads or after rough handling. Make a habit of "click clips, check zero, take
              reading" — three steps, every time.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              (1) Isolate at the main switch in the consumer unit, lock off, prove dead at the MET
              using a GS38 voltage tester. (2) Open the meter cabinet, disconnect the gas bonding
              conductor at the MET — loosen the terminal screw, withdraw the conductor, position it
              clear of the busbar. (3) Set MFT to continuity range (200 mA test current, low-ohm
              scale). (4) Touch test lead clips together, press NULL, confirm 0.00 ohm. (5) Connect
              one clip to the disconnected MET end of the gas bonding conductor; second clip to the
              BS 951 clamp body or conductor end under the sink. (6) Read: expecting ~0.02-0.05 ohm
              for a healthy 4.5 m run on 10 mm² Cu (cable resistance 4.5 × 1.83 = 8.2 mOhm + ~10-30
              mOhm at the two terminations). (7a) HAPPY RESULT: 0.04 ohm — within expected band,
              bond is sound, document on Schedule. (7b) RED FLAG: 0.50 ohm — way above the 0.06 ohm
              upper expected band. Investigate: visually inspect the BS 951 clamp (clean? bare
              metal? torque?), inspect the MET end (was the conductor damaged?), re-tug-test both
              ends. Re-make whichever joint looks suspect. Retest. (8) When passing, reconnect the
              bond at the MET — ferrule, land, torque to spec, retest in-circuit (should read
              slightly lower due to parallel paths). (9) Restore supply, document the disconnected
              reading on the Schedule of Test Results.
            </>
          }
          whyItMatters={
            <>
