...
const checks = [
  {
    ...
    options: [
      'There is no functional difference — main and supplementary bonding both connect the same extraneous-conductive-parts to the MET, and the two terms are simply the older and newer names for the same conductor. Modern BS 7671 keeps both words for historical reasons only.',
      ...
      'Main bonding protects the cable against overcurrent by providing a low-impedance fault return path, while supplementary bonding protects against voltage drop by reinforcing the neutral. Main bonding is sized from the line conductor and supplementary bonding from the neutral conductor.',
      "Main bonding is the earthing connection from the MET back to the supply source (the PEN, sheath or electrode), while supplementary bonding is the connection of each circuit's CPC to the earth bar. Main bonding carries fault current to the source and supplementary bonding distributes it to the circuits.",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A single condition: the bathroom must be fitted with a 30 mA RCD on the lighting circuit only. Once the lighting is RCD-protected, supplementary bonding can always be omitted regardless of how the other circuits in the room are protected.',
      'Two conditions: the building must be on a TN-C-S (PME) supply, and the main bonding must be upgraded to 10 mm². Supplementary bonding is only ever omittable on PME supplies, never on TN-S or TT, because the earthing arrangement is what carries the fault.',
      'Three conditions: the room must contain no metal pipework, all accessories must be IP X4 rated, and the floor must be tiled rather than carpeted. When the room has no extraneous-conductive-parts and the right IP ratings, supplementary bonding serves no purpose and can be left out.',
  ...
  },
  {
    ...
    options: [
      'R < 25 V / I_a (the touch-voltage limit is halved to 25 V for AC supplementary bonding, because wet locations require a lower threshold than the general 50 V).',
      'R < I_a / 50 V (the operating current is divided by the touch-voltage limit, giving the maximum conductance the bond must achieve rather than the maximum resistance).',
      ...
      'R < 50 V × I_a (the touch-voltage limit is multiplied by the device operating current to give the maximum permitted bond resistance for an AC system).',
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Reg 544.1', 'Reg 411.3.1.2', 'Reg 415.2', 'Reg 514.13.1'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Remove it. Once the omission conditions of Reg 701.415.2 are met the supplementary bonding becomes a non-conformance and must be taken out, because the regulation prohibits supplementary bonding wherever the three conditions are satisfied.',
      'Replace it with a 10 mm² conductor. Existing supplementary bonding in an older bathroom is undersized to modern standards, so it must be upgraded to main-bonding cross-section before the installation can be certified.',
      'Code it C2 on the certificate. Supplementary bonding in a fully RCD-protected bathroom is potentially dangerous because it creates a parallel earth path, so it must be flagged as a defect requiring remedial action.',
  ...
  },
  {
    ...
    options: [
      ...
      'Yes — supplementary bonding is mandatory in every room containing a bath or shower without exception, because the wet environment always requires local equipotential bonding regardless of RCD protection or main bonding.',
      'Yes — but only between the towel rail circuit and the copper pipes, because that is the one combination of metal parts that the 30 mA RCD does not cover. The bath and the other pipework can be left unbonded.',
      'No — but only because the bathroom is a new build. On any existing dwelling supplementary bonding would still be required, as the omission permission of Reg 701.415.2 applies to new installations only.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A flat 4 mm² minimum in all cases, regardless of the CPC sizes — supplementary bonds between exposed-conductive-parts always use 4 mm² because that is the smallest cross-section permitted for any bonding conductor.',
      ...
      'Half the cross-section of the larger CPC connected to the two exposed-conductive-parts, with a 6 mm² minimum, mirroring the sizing rule used for main protective bonding on a non-PME supply.',
      'Equal to the line conductor of the circuit supplying the equipment, because a supplementary bond between two exposed-conductive-parts must be able to carry the full load current of the larger of the two circuits.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 6,
    question: 'In Reg 415.2.2, the "I_a" term for an overcurrent protective device is defined as:',
    options: [
      "The rated current (In) printed on the device — for a 32 A MCB, I_a is simply 32 A, because the bond must keep touch voltage under 50 V at the device's nominal rating.",
      'The 0.1 s operating current of the device — the current needed to clear the fault within the 0.1 s instantaneous-trip window, because supplementary bonding is designed for fast disconnection.',
      ...
      'The prospective fault current at the device — the maximum current the supply can deliver into a fault, because the bond resistance must be calculated against the worst-case fault the circuit could see.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Because they are sized from different conductors. Main bonding is sized from the line conductor of the largest circuit and supplementary bonding from the neutral, so BS 7671 separates them to make clear which conductor each is derived from.',
      'Because they apply to different supply types. Main bonding is required only on TN-C-S (PME) supplies and supplementary bonding only on TT supplies, so the two terms exist to distinguish the earthing arrangements they belong to.',
      'Because they are tested differently. Main bonding is verified by an insulation-resistance test and supplementary bonding by a continuity test, so the two names exist to indicate which test procedure applies to each.',
  ...
  },
  {
    ...
    options: [
      ...
      'Prohibited — once the omission conditions are met, fitting supplementary bonding becomes a breach of Reg 701.415.2 because the regulation forbids redundant bonding, and the additional conductor would have to be coded C2 on the certificate.',
      'Permitted, but only if you uprate the bond to 10 mm². Supplementary bonding fitted for redundancy in a fully-bonded bathroom must match main-bonding cross-section, otherwise it is undersized and creates a non-conformance.',
      'Prohibited — supplementary bonding in a fully RCD-protected bathroom introduces a parallel earth path that can carry circulating currents, so BS 7671 does not allow it to be fitted once the RCD provides additional protection.',
    ],
    correctAnswer: 0,
    explanation:
...
const faqs = [
  ...
  {
    question:
      'What counts as "all final circuits of the location have additional protection by means of an RCD"?',
    answer:
  ...
  {
    question:
      'How do I prove "main bonding to extraneous-conductive-parts" for the omission condition?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Main bonding (Reg 411.3.1.2 + 544.1) at the building intake — system-wide. Supplementary
          bonding (Reg 415.2) at a specific high-risk location — local. Different conductors,
          different sizing, different regs, sometimes both required and sometimes one can be
          omitted.
        </p>
        ...
        >
          <p>
            Main protective equipotential bonding is part of the BS 7671 ADS strategy (Reg 411.3).
            The Reg 411.3.1.2 mandate: "extraneous-conductive-parts liable to introduce a dangerous
            potential difference shall be connected to the main earthing terminal by protective
            bonding conductors complying with Chapter 54." The protective function is system-wide:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Without main bonding:</strong> a fault on a circuit raises the CPC and MET to
              fault potential. Extraneous services (gas pipe, water pipe) are still at ground
              potential via the soil. Touch voltage between MET-bonded metalwork and a gas pipe =
              full fault voltage = lethal.
            </li>
            <li>
              <strong>With main bonding:</strong> the same fault raises the MET, CPC AND every
              bonded extraneous part to the same potential. Touch voltage between any bonded metal
              and any other bonded metal = near zero. Fault is cleared by the protective device
              within Table 41.1 disconnection times; nobody touching the metalwork is exposed to
              lethal touch voltage during the disconnection period.
            </li>
          </ul>
          <p>
        ...
        >
          <p>
            Reg 415.2 — supplementary bonding is "additional protection" beyond ADS. It addresses
            scenarios where the standard ADS disconnection times (0.4 s on TN final circuits) are
            too slow to prevent harm. In a bathroom:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              The user is in contact with water and metalwork — body resistance drops dramatically
            ...
            <li>
              Touch voltages that would be uncomfortable but survivable in a dry kitchen can be
              lethal in a wet bathroom.
            </li>
          </ul>
          <p>
            Supplementary bonding addresses this by tying metal items at the location to each other
            directly (not just to the distant MET). If a fault raises the towel rail to full line
            potential, the supplementary bond pulls the copper pipe to the same potential within
            microseconds — touch voltage between towel rail and pipe stays near zero regardless of
            how long the upstream protective device takes to clear the fault.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Supplementary bonding ties together every simultaneously accessible exposed (Class I
              appliance bodies) and extraneous (metal pipes, structural steel) conductive part at
              the location. Plus to the CPC of every circuit serving the location including
              socket-outlets. The resistance between any two such parts must satisfy R &lt; 50/I_a —
              a tight limit for fast-tripping devices (30 mA RCD gives 1667 Ω so almost any joint
              passes), much tighter for high-current overcurrent devices.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Condition (e) — 30 mA RCD additional protection.</strong> Every final circuit
              serving the bathroom must have additional protection by 30 mA RCD per Reg 415.1.1.
              Could be an RCBO per circuit or an upstream RCD covering all bathroom circuits. The 30
              mA value matters — higher (e.g. 100 mA) does NOT count for additional protection.
            </li>
            <li>
              <strong>Condition (f) — main bonding compliant.</strong> All extraneous-
              conductive-parts (gas, water, structural steel) must be effectively connected to the
              protective equipotential bonding per Reg 411.3.1.2. "Effectively connected" implies
              verification — continuity tested per Sub 4 of this Section.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The full 701.415.2 in plain reading. First half: supplementary bonding requirement
              (CPCs of every Class I and II circuit + extraneous-conductive-parts in the bathroom).
              Second half: omission permission when ALL THREE conditions met (ADS + RCD additional
              protection + main bonding compliant). The omission is a permission, not a mandate —
              fitting supplementary bonding when not strictly required is still compliant.
            </>
          }
        ...
        >
          ...
          <div className="bg-[hsl(0_0%_10%)] border border-white/[0.08] rounded-xl p-4 text-[14px]">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-4 text-white/90">
              ...
              <div className="text-white/70 sm:text-white/90">
                half earthing CSA, min 6 mm², max 25 mm² Cu
              </div>
            </div>
          </div>
        </ConceptBlock>
            ...
            <div className="grid grid-cols-1 gap-y-3 text-white/90">
              <div>
                <div className="font-semibold text-emerald-300">
                  Reg 544.2.1 — exposed to exposed
                </div>
                <div className="text-white/70 mt-1">
                  Conductance not less than the smaller CPC connected to the exposed parts. Min 4
                  mm² if not mechanically protected.
                </div>
              </div>

              <div>
                <div className="font-semibold text-emerald-300">
                  Reg 544.2.2 — exposed to extraneous
                </div>
                <div className="text-white/70 mt-1">
                  Conductance not less than half the CPC of the exposed-conductive-part. Min 4 mm²
              ...
              <div>
                <div className="font-semibold text-emerald-300">
                  Reg 544.2.3 — extraneous to extraneous
                </div>
                <div className="text-white/70 mt-1">
                  2.5 mm² minimum if mechanically protected (in conduit, sheath, etc.) or 4 mm²
                  minimum if not mechanically protected.
                </div>
              </div>
            </div>
          </div>
          <p>
            Trade shorthand: 4 mm² on view, 2.5 mm² in conduit, half-the-CPC for exposed-side bonds
            where the CPC is bigger than 4 mm² (rare in domestic).
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>For RCDs:</strong> the rated residual operating current I_Δn — typically 30 mA
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>30 mA RCD:</strong> R &lt; 50 / 0.030 = 1667 ohm. Almost any supplementary
              bond joint passes.
            </li>
            <li>
              <strong>Type B 32 A MCB (5×In = 160 A):</strong> R &lt; 50 / 160 = 0.3125 ohm. Tighter
              — needs a clean low-resistance bond.
            </li>
            <li>
              <strong>Type C 32 A MCB (10×In = 320 A):</strong> R &lt; 50 / 320 = 0.156 ohm. Tighter
              still.
            </li>
            <li>
        ...
        >
          <p>
            The Reg 701.415.2 omission permission has been on the books since the 17th edition and
            has stayed put through 18th edition Amendment 2 and into the BS 7671:2018+A4:2026
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              411.3.2 disconnection times — 0.4 s on a TN final circuit at 230 V. Verified by Zs
              measurement at sign-off. Modern installs almost always meet this — the RCD drives Zs
              requirements way down (the RCD trips on residual current, not on Zs).
            </li>
            <li>
              <strong>
                (e) 30 mA RCD additional protection on every final circuit of the location.
              </strong>{' '}
              The bathroom lighting, the shower, the towel rail circuit, the extractor fan, the
              shaver socket — every one of these must be on a 30 mA RCD or RCBO. 100 mA RCDs do NOT
              count for additional protection — must be 30 mA. The check: open the consumer unit,
              identify every circuit feeding any equipment in the bathroom, confirm each one has 30
              mA RCD/RCBO upstream.
            </li>
            <li>
              <strong>
                (f) Main bonding to extraneous-conductive-parts effectively connected.
              </strong>{' '}
              Effectively connected = installed AND verified by continuity test (per Sub 4). On a
              refurb, retest the existing main bonds before relying on the omission. On a new
              install, fit and test main bonding before the bathroom rough-in.
            </li>
          </ul>
          <p>
            The A4:2026 angle. A4 hasn't moved Reg 701.415.2 itself, but the broader A4 push toward
            universal RCD protection (every socket, every lighting circuit, every final circuit in
            dwellings) means more installations meet condition (e) by default. The omission becomes
            the routine answer on new builds and modern refurbs, where five years ago it was less
            common because some boards still had a non-RCD'd "essential services" section. Document
            the assessment in the EIC each time — the regulation gives you the freedom, the
            documentation evidences your competent decision.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              metal pipework) and every exposed-conductive-part of fixed equipment in the zone. The
              Reg 701.415.2 omission permission does NOT apply to pools — supplementary bonding is
              essentially mandatory in Zone 1 regardless of RCD protection. Reasoning: a person in
              or beside a pool is in maximum body-conductivity state (wet skin, full immersion in
              many cases) and the touch-voltage limits drop way below the bathroom threshold.
            </li>
            <li>
              <strong>Section 703 — sauna heaters and rooms with sauna heaters.</strong> Tighter IP
              ratings on accessories, no socket-outlets in Zone 1, supplementary bonding
            ...
            <li>
              ...
              Supplementary bonding to protect livestock (cattle, horses, sheep) which have much
              lower touch-voltage tolerance than humans. Bonding ties together every metalwork item
              livestock might contact — feeding troughs, milking stalls, gates, fence posts. RCD
              additional protection at 30 mA on every final circuit. The special-location rules
              effectively make supplementary bonding mandatory across a much larger zone than a
              bathroom.
            </li>
            <li>
              <strong>Section 708 — caravan and camping parks.</strong> TN-S or TT supplies
              preferred over PME because of the broken-PEN risk on touring caravans and static homes
              (where the metal frame becomes the broken-PEN return path). Supply pillars require RCD
              protection at 30 mA per pitch. Bonding considerations include the metal hookup pillar
              itself plus on-site service pipework.
            </li>
            <li>
              ...
              hulled boat's electrical earth to a copper-bonded shore supply via the bonding system
              creates a galvanic cell that corrodes the boat's hull over months. Section 709
              mandates galvanic isolation transformers or other isolation devices between shore
              supply and vessel earth.
            </li>
            <li>
              <strong>Section 711 — exhibitions, shows and stands.</strong> Temporary installations
              with frequent changes, supplementary bonding requirements relax in some cases (because
              nothing is permanent) but tighten in others (public access to live equipment must be
              impossible).
            </li>
          </ul>
          <p>
            The general rule: when you're working in any special location, read the relevant Section
            of Part 7 before designing the bonding strategy. The general Chapter 41 / Chapter 54 /
            Reg 415.2 framework is the baseline; the Section adds and overrides. The bathroom
            omission permission is unusually permissive — most other special locations push the
            other way (tighter rules, more bonding, fewer omissions).
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Check the three Reg 701.415.2 omission conditions before deciding. New build with full
              RCBO protection + main bonding compliant + ADS verified = supplementary may be
              omitted. Document the omission decision in the EIC. The labour and cable saved per
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              RCBO-protected (every circuit on its own 30 mA RCBO including the bathroom lighting
              and shower circuits). Main bonding to gas and water at the building intake is being
              upgraded to 10 mm² G/Y as part of the same job and will be continuity-tested.
              Decision: keep, remove, or replace the bathroom supplementary bonding?
            </>
          }
          whatToDo={
            <>
              Apply the Reg 701.415.2 three-condition test. (1) ADS compliance — yes, all bathroom
              circuits will be verified by Zs measurement at sign-off. (2) 30 mA RCD additional
              protection — yes, every bathroom circuit is on its own 30 mA RCBO. (3) Main bonding
          ...
          whyItMatters={
            <>
              Reg 701.415.2 is permissive, not prohibitive. The decision tree for refurb work:
              existing bonds in place → leave them. New bathroom build with full RCD protection →
              omission permitted, decide based on customer/labour preference. Older bathroom without
              RCD protection → supplementary required. Always document the assessment. The
              regulation gives you freedom; the EIC documents your choice.
            </>
          }
        />
