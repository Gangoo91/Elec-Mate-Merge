...
const checks = [
  {
    ...
    options: [
      ...
      'Main bonding is for live conductors, supplementary for earth.',
      'Main bonding is older, supplementary is the modern replacement.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Just one condition — the bathroom is new.',
      ...
      'Only if the bathroom has no metal pipes.',
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Reg 411.3.1.2', 'Reg 415.2', 'Reg 544.1', 'Reg 514.13.1'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Remove all supplementary bonding immediately — Reg 701.415.2 says omit.',
      ...
      'Cut every supplementary bond.',
      'Replace all the bathroom pipework.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Yes — supplementary is always required in bathrooms.',
  ...
  },
  {
    ...
    options: [
      ...
      'Historic naming — they\'re the same thing.',
