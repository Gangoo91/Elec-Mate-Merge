...
const quizQuestions = [
  ...
  {
    id: 7,
    question: 'What is the function of the "as near as practicable" qualifier in Reg 544.1.2?',
    options: [
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 4 · Subsection 3"
        title="Connect bonding clamps"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 951 earth clamps onto gas, water, oil and structural steel — consumer side of the
          meter, within 600 mm where practicable, on cleaned bare-metal pipework, with jointing
          paste, torqued to spec, labelled per Reg 514.13.1.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>U-bolt or strap</strong> — wraps around the pipe and tightens with two nuts to
              a saddle that grips the pipe between the U-bolt and the clamp body.
            </li>
            <li>
            ...
            <li>
              <strong>Yellow plastic warning label</strong> — clips around the bonding cable at the
              clamp end, pre-printed with "Safety Electrical Connection — Do Not Remove".
            </li>
            <li>
              <strong>Data label</strong> — moulded into the body or stuck on the bag, giving model
              number, conductor size range, pipe diameter range, and gas/water/oil suitability.
            </li>
          </ul>
          <p>
            Clamps come in size bands: small (6-22 mm pipe, 4-10 mm² conductor), medium (22-54 mm
            pipe, 10-16 mm² conductor), large (54-150 mm pipe, 16-25 mm² conductor) and bigger. Pick
            the band that comfortably accepts both the pipe diameter and the bonding conductor —
            never force a clamp onto an undersized or oversized pipe.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Three hard requirements: (1) consumer side of the meter; (2) on the consumer's hard
              metal pipework, before any branch; (3) within 600 mm of the meter outlet union where
              practicable. Plus a softer "as near as practicable to the point of entry of that part
              into the premises" — the regulation acknowledges site reality where the strict 600 mm
              can't be met, but the consumer-side / before-branch rules are absolute.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HARD: Consumer side of the meter</strong> — never bond on supplier pipework
              (the bit feeding the meter from the street). The meter is the boundary; everything
              downstream is consumer pipework, everything upstream is the supplier.
            </li>
            <li>
        ...
        >
          <p>
            Reg 544.1.2 explicitly handles the external-meter case: "...within 600 mm of the meter
            outlet union or at the point of entry to the building if the meter is external." On a
            typical new-build with a gas meter in an outside cabinet:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              The supply pipe enters the building through the wall — usually a sealed gland or duct.
            </li>
            <li>
        ...
        >
          ...
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              Identify the clamp position — consumer side of meter, before any branch, within 600 mm
              if possible.
            </li>
            <li>
              Mark the pipe with a permanent marker — a ring around the pipe at each end of the band
              you'll clean. The clamp jaw width is typically 25-40 mm; clean a band 10 mm wider on
              each side.
            </li>
            <li>
              File or abrade the pipe surface in the marked band. Steel pipe — fine-cut file in
              circular strokes around the pipe, then perpendicular file marks for grip. Copper pipe
              — fine wire wool or 240-grit emery paper. Aluminium pipe (rare on services) — emery,
              then immediately apply paste before re-oxidation.
            </li>
            <li>
              Wipe the cleaned band with a clean dry cloth to remove all filings and dust. Do NOT
              wipe with anything oily.
            </li>
            <li>
              Inspect — the pipe should be bright bare metal across the full clamp jaw width. Any
              remaining paint, oxide or contamination — clean again.
            </li>
            <li>
              Apply a thin film of jointing paste (CuPro for copper, Penetrox for aluminium,
              conductive grease for steel) across the cleaned area immediately before fitting the
              clamp.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            contacts the pipe, only the high points actually touch — the rest of the contact area
            has air or moisture in the gaps. Conductive jointing paste fills these voids, massively
            increasing the effective contact area and preventing the air/moisture in the gaps from
            corroding the joint over years.
          </p>
          <p>Common products:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>CuPro / Cuprosolv</strong> — proprietary copper-loaded grease, standard for
              copper pipe to brass clamp joints.
            </li>
            <li>
            ...
            <li>
              <strong>Petroleum jelly / Vaseline</strong> — lower-grade alternative on short-term
              jobs; not officially conductive but seals out moisture. Better than nothing if you
              have nothing else, but proper jointing paste should be in the van.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Mandatory warning notice at three places: every earth electrode connection, every main
              bonding connection to an extraneous-conductive-part, and the MET (where separate from
              main switchgear). The standard yellow plastic label that comes with every BS 951 clamp
              satisfies the requirement — clip it onto the bonding cable at the clamp end and the
              bond is compliant.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Hand-tighten the pipe-clamping nuts evenly — alternate sides to draw the clamp onto
              the pipe square, not skewed.
            </li>
            <li>
              Torque the pipe-clamping nuts to the manufacturer spec, alternating between sides in 1
              Nm increments until you hit the final value.
            </li>
            <li>
            ...
            <li>
              Tug-test the bonding conductor at the clamp — it should not move under firm hand pull.
            </li>
            <li>Wipe excess jointing paste off the outside of the clamp.</li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>
            Every bonding clamp comes with a pre-printed warning label — usually a yellow plastic
            clip that snaps around the bonding cable at the clamp end, marked with the required
            text. Fit it as you finish the bond. Reg 514.13.1 also requires the warning notice at
            the MET if the MET is separate from the main switchgear (i.e. housed in its own
            enclosure rather than inside the consumer unit) — same text, fitted at the MET enclosure
            or terminal.
          </p>
          <p>
        ...
        >
          <p>
            The metal-to-metal contact between the BS 951 clamp jaw and the cleaned pipe is the
            entire bond. If that joint is anything less than bright bare metal pressed tight
            together with conductive paste filling the micro-voids, you have a high-resistance joint
            with a slow-failure clock running. Different pipe metals need different prep:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Copper pipe (water, internal gas runs, central heating).</strong> 000-grade
              wire wool or 240-grit emery cloth in a 30-50 mm band around the pipe. Wipe with a
              clean dry cloth. Apply CuPro paste — proprietary copper-loaded grease that's
            ...
            <li>
              <strong>
                Galvanised steel pipe (older gas service rises, structural steel, external water).
              </strong>{' '}
              Fine-cut half-round file in a 30-50 mm band. File until the bright steel is visible
              through the zinc coating — you want the clamp jaw contacting steel, not zinc. Wipe
              clean. Apply a generic non-acidic conductive grease (Cuprosolv, electrical jointing
              paste from MK or Marshall-Tufflex). Refit the clamp; the zinc coating around the
              cleaned band continues to give corrosion protection to the rest of the pipe.
            </li>
            <li>
              <strong>
                Aluminium pipe (rare on services but you'll see it on solar PV mounting rails and
                some commercial chillers).
              </strong>{' '}
              Emery cloth in a tight band, then IMMEDIATELY apply Penetrox A or similar
              aluminium-rated paste — bare aluminium re-oxidises within minutes of being abraded and
              the paste has to seal the cleaned surface before that re-oxide layer forms. Penetrox
              is loaded with zinc particles that bite through any thin oxide and maintain conductive
              contact.
            </li>
            <li>
              ...
              Stainless oxide is invisible but tenacious; the paste plus a tight clamp jaw is what
              makes the joint reliable.
            </li>
          </ul>
          <p>
            The trade-off everyone makes: jointing paste is messy. Fitters often skip it on "clean"
            indoor copper bonds because the joint reads under 0.05 ohm at the initial continuity
            test and looks fine. Five years on, the joint that wasn't pasted is the one that has
            crept up to 0.5 ohm on the next EICR. Five seconds of paste is hours of saved
            investigation work later. Always paste; wipe the excess off the outside of the clamp.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The standard EICR inspection checklist for the bonding system:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>MET visible and accessible?</strong> If the MET is buried behind plaster or
              sealed inside an enclosure with no access, that's a C3 (improvement recommended) — Reg
              514.13 wants the MET identifiable and Reg 543.3.2 wants the connections accessible.
            </li>
            <li>
              <strong>Each bonding conductor labelled at the MET end?</strong> Missing labels are a
              C3 — the bond is functional but harder to inspect on the next round. Carry a roll of
              self-laminating cable labels and a marker to fix on the spot where the customer
              agrees.
            </li>
            <li>
              <strong>Conductor CSA correct for the supply?</strong> Read the supplier head — PME
              with PEN ≤ 35 mm² wants 10 mm² Cu minimum bonding. A 6 mm² Cu bond on a modern PME
              supply (common on 1980s installs that pre-date the current Table 54.8 values) is a C2
              — undersized for a broken-PEN fault.
            </li>
            <li>
              <strong>
                Clamp present, on consumer side, before any branch, within 600 mm where practicable?
              </strong>{' '}
              A bond on the supply side of the meter is wrong location (not necessarily a code, but
              flag for relocation). A bond on the wrong side of a branch (the bonded section of pipe
              is no longer the only path to the rest of the metal pipework) is a C2 — the bonding
              doesn't actually equalise the downstream metalwork.
            </li>
            <li>
              <strong>Pipe surface clean, paste applied, jointing visible?</strong> An oxidised or
              painted-over clamp face is a C2 if the visible-paint or visible-rust evidence suggests
              the joint has poor electrical continuity. Confirm with a continuity test — if R reads
              above 0.10 ohm, code C2 and re-make.
            </li>
            <li>
              <strong>Warning label fitted?</strong> Reg 514.13.1 — missing label is a C3. Yellow
              plastic clip-on labels cost pence; fit one before leaving site if the customer agrees.
            </li>
            <li>
              <strong>Accessibility for inspection.</strong> A bond clamp behind a plumbed-in
              kitchen unit with no removable panel — flag for relocation, code C3. A bond cable
              disappearing into a wall void (mid-run joint hidden) — C2 per Reg 543.3.2.
            </li>
            <li>
              <strong>What's missing.</strong> An installation with metal incoming services and NO
              main bonding to one or more of them — that's where the code escalates. On a TT or PME
              supply with no bonding to gas or water, the broken-PEN / broken-electrode fault
              scenario can put the entire metalwork at line potential. Typically C2 (potentially
              dangerous) — fit the missing bond, retest, document.
            </li>
          </ul>
          <p>
            ...
            insulation is damaged, the strands are visibly damaged on inspection, or the continuity
            reading is anomalously high after re-making the terminations. The clamp is cheap; the
            labour to refit is the cost — quote the labour and replace wherever there's any doubt
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Time is tight, the gas pipe is painted gloss white, and the clamp grips the paint when
              you tighten the nuts. Continuity test reads 0.05 ohm — looks fine. Six months later
              the paint slowly creeps under continued thermal cycling and vibration, the contact
              resistance climbs into the ohms, the bond is now effectively open. A subsequent EICR
              Zs reading is anomalously high, the engineer investigates, finds the painted-pipe
              bond, codes it C2.
            </>
          }
          doInstead={
        ...
        <Scenario
          ...
          situation={
            <>
              You are doing a kitchen refurb and need to upgrade the main bonding to the cold water
              service. The supply enters the building through the floor under the kitchen sink,
              rises 200 mm, hits the main internal stop-tap, then branches to feed the cold mains
              tap and a downstream hot-water cylinder. The pipe is 22 mm copper. The MET is in the
              meter cabinet 4 m away in the under-stairs cupboard. Walk the bond install end-to-end.
            </>
          }
          whatToDo={
            <>
              (1) Verify the pipe is consumer-side: yes — the supply has come into the building from
              ...
              cabinet, up to the MET busbar). (13) Land at the MET as covered in Sub 2 — strip,
              ferrule, torque, label "WATER SERVICE". (14) Continuity test from MET to clamp follows
              in Sub 4.
            </>
          }
          whyItMatters={
            <>
              A textbook water bond done in under 30 minutes once you have the kit assembled. Each
              step satisfies a specific BS 7671 requirement — clamp position (Reg 544.1.2), clean
              contact (Reg 526.1), torque (Reg 526.1(f) locking arrangements), label (Reg 514.13.1),
              conductor identification at MET (Section 514). The same 14-step sequence applies on
              every water bond you ever do; only the specific values change.
            </>
          }
        />
