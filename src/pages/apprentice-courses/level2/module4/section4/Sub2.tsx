...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Reg 411.5.3', 'Reg 543.4.1', 'Reg 543.3.2', 'Reg 514.13.1'],
    correctAnswer: 2,
    explanation:
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 4 · Subsection 2"
        title="Terminate bonding cables"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Stripping, sleeving, ferruling and landing the bonding conductor at the MET and the BS 951
          clamp. Continuous run, no mid-run joints, every termination accessible for inspection per
          Reg 543.3.2.
        </p>
        ...
        >
          <p>
            ...
            extraneous-conductive-part (gas pipe, water service, structural steel) back to the MET —
            at all times, including under the worst-case fault current the supply can deliver. The
            cable itself, sized per Reg 544.1.1 / Table 54.8 (covered in Sub 1), can easily handle
            that current. What kills bonds is the joints at each end:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Loose terminals</strong> — screws not torqued, vibration loosens further over
              years, oxide film builds at the contact face, resistance climbs, joint heats under any
              current, eventual mechanical failure.
            </li>
            <li>
            ...
            <li>
              <strong>Hidden joints</strong> — junction boxes in wall voids, joints inside ceiling
              roses, splices behind kitchen units. Inaccessible for inspection, degraded over time,
              fail silently.
            </li>
            <li>
          ...
          <p>
            Every bullet on that list is preventable with correct technique and the right kit. Reg
            526.1 requires "durable electrical continuity and adequate mechanical strength and
            protection" — the rest of this Sub is how that gets achieved on site.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Two requirements — electrical continuity and mechanical strength — and a checklist of
              what to think about when selecting the connection method. Bonding conductors are
              stranded copper, multiple strands, heavy CSA. The factors that matter for them are
              material (copper to brass clamp, fine; copper bare onto steel pipe, needs inhibitor),
              strand count (ferrule before cage-clamp), CSA (right die for the crimper), terminal
              temperature (correct torque to keep contact tight), and locking in vibration (apply
              Loctite or use serrated washers on industrial gear).
            </>
          }
        ...
        >
          ...
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              Hold the cable steady. Pick a strip length that matches the terminal depth (read the
              terminal spec — usually 12 to 15 mm for a 10 mm² into a 12 mm cage clamp).
            </li>
            <li>
              Place a sharp knife perpendicular to the cable at the strip length. Rotate the cable
              while applying light pressure — score the insulation only halfway through. Stop. Do
              NOT cut through to the conductor.
            </li>
            <li>
          ...
          <p>
            Dedicated cable stripping tools (Knipex MultiStrip, Klein, Jokari) speed this up on big
            jobs but the principle is the same — score, snap, slide. Avoid the rotating tools that
            "auto-strip" by squeezing closed on the conductor; they almost always nick the strands
            of stranded G/Y. The hand technique is faster and cleaner once practiced.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Bootlace ferrules (also called "wire-end ferrules" or "cord-end terminals") are short
            brass tubes with a coloured plastic insulation funnel on the unloaded end. Standard
            sizes match standard cable CSAs and the colour code is BS standard:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            Crimp with a hex jaw die (six-sided) that matches the ferrule CSA. Square dies deform
            the ferrule and conductor, leaving voids in the contact area. The ratchet should be a
            calibrated mechanical or hydraulic crimper — manufacturers like Knipex, Klauke, Phoenix
            Contact, Weidmüller all sell trade-grade tools. After crimping, tug-test the ferrule. It
            should not pull off under firm hand pressure.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Steps for a 16 mm² G/Y to BS 951 clamp termination:</p>
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              Strip the cable to match the lug barrel length (usually 18-22 mm for a 16 mm² lug).
            </li>
            <li>
              Slide the lug onto the conductor. The conductor end should sit flush with the back of
              the barrel, with no strands sticking out beyond.
            </li>
            <li>
              Position the lug in the ratchet crimper using the correct hex die for the lug barrel
              size. Squeeze the ratchet through to its full release point — the ratchet won't
              release until full compression force is reached.
            </li>
            <li>
              Inspect the crimp. The barrel should be visibly compressed into a hex shape, no
              flaring at the ends, no escaped strands. Tug-test the lug — it should not move under
              firm pull.
            </li>
            <li>
              Apply a small amount of anti-corrosion grease (e.g. Cuprosolv, petroleum jelly,
              Vaseline) to the lug ring and the BS 951 clamp screw thread. This prevents galvanic
              corrosion at the dissimilar-metal joint over years of service.
            </li>
            <li>
        ...
        >
          ...
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              additional MET extension or a larger busbar. Never double-up two conductors in one
              hole — that creates a poor-contact joint and fails Reg 526.1.
            </li>
            <li>Strip the conductor to terminal depth, ferrule the strands.</li>
            <li>
              Insert the ferrule into the terminal hole. The ferrule should sit fully inside — no
              bare conductor visible outside the terminal body. If it's a screw-clamp, check the
              screw is fully backed off so the terminal jaws are open.
            </li>
            <li>
              Tighten the terminal screw to the manufacturer torque spec (typically 2.5 to 4.0 Nm
              for domestic MET busbars). Use a calibrated torque screwdriver — never eyeball it.
            </li>
            <li>Tug-test the conductor. It should not move under firm hand pull.</li>
            <li>
              Apply a permanent label at the conductor entry to identify what the bond goes to ("Gas
              service", "Water service", "Structural steel", etc.). Cable-tie label or heat-shrink
              label sleeve, both acceptable.
            </li>
          </ol>
          <p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Compression lug method (preferred for 16 mm² and above)</strong> — strip 18-22
              mm, fit copper lug, hex-die crimp, bolt through BS 951 clamp screw with washer and
              anti-corrosion grease. Most reliable for larger conductors.
            </li>
            <li>
              <strong>Direct screw-clamp method (10 mm² in cage-clamp BS 951)</strong> — strip 12-15
              mm, ferrule the strands, insert into the clamp screw aperture, tighten the screw.
              Faster but only suitable for smaller conductors and only on BS 951 clamps designed for
              this. Read the clamp manufacturer instructions.
            </li>
          </ul>
          <p>
            Either way, the warning label "SAFETY ELECTRICAL CONNECTION — DO NOT REMOVE" goes on the
            clamp body or on the conductor at the clamp end. Reg 514.13.1 makes this mandatory and
            the BS 951 clamp typically comes with a yellow plastic label that clips around the
            cable. Sub 3 covers the labelling requirements in detail.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              cabinet (cabinet door opens, all terminations visible) — accessible. A BS 951 clamp on
              a gas pipe under a kitchen sink (cupboard door opens, clamp visible) — accessible. A
              junction box buried in a wall void (would need plaster removed to inspect) — NOT
              accessible. Reg 526.3 lists narrow exceptions (buried-in-ground, encapsulated,
              in-equipment manufacturer joints) — wall-void splices do not qualify.
            </>
          }
        ...
        >
          <p>
            The hex-die crimp lug is the universal trade choice for landing a bonding conductor into
            a screw or bolt terminal. The two halves of the die compress the brass barrel of the lug
            onto the conductor in a six-sided crush — even pressure all the way round, no voids,
            gas-tight contact between conductor strands and lug barrel. Once crimped, the joint is
            mechanically and electrically permanent for the life of the install. The major
            manufacturers all certify their lug + die + crimper combinations to specific BS / IEC
            standards — typical reference is BS 4579-1 for compression joints in copper conductors.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              colour-coded by CSA. The YA10C-2N is a 10 mm² lug with two M8 stud holes — common for
              MET busbars.
            </li>
            <li>
              <strong>ABB / Thomas &amp; Betts (T&amp;B) Sta-Kon</strong> — short-barrel
              tinned-copper lugs in 10, 16, 25 mm² ranges with M6/M8/M10 stud sizes. Trade standard
              for switchgear earth bars.
            </li>
            <li>
              <strong>Klauke 100R-series</strong> — German-made hex-die lugs widely stocked at UK
              wholesalers, paired with the Klauke K05 manual or EK60 hydraulic crimper.
            </li>
            <li>
              <strong>Cembre A-series</strong> — Italian equivalent, very common on commercial jobs
              where Cembre crimping kit is on the van.
            </li>
          </ul>
          <p>
            Hammer-on (sometimes "anvil") lugs are an emergency fix only — you put the lug on the
            conductor, place it on a steel anvil, hit it with a hammer to crush the barrel. The
            crimp is uneven, not gas-tight, and not certified for any specific BS standard.
            Acceptable to get an install live in a genuine emergency (you're at a remote site, the
            crimper has failed, the customer's freezer is dripping); not acceptable as a primary
            termination method on a bonding job. Always replace a hammer-on lug with a proper
            hex-die crimp at the next opportunity.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The boundary between an exposed bonding conductor and its termination is a magnet for
            corrosion. Water creeps along the strands inside the insulation, sits in the lug barrel
            or terminal cavity, and oxidises the copper. Two years on, what was a 0.04 ohm bond is
            reading 0.5 ohm on the next EICR. Heatshrink seals this boundary before the install goes
            live and keeps it sealed for the life of the cable.
          </p>
          <p>The technique:</p>
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              Cut a piece of adhesive-lined heatshrink long enough to cover the lug barrel plus
              25-40 mm of insulated conductor on either side. Diameter — pick the one that slides
              over the lug just snug.
            </li>
            <li>
              Slide the heatshrink onto the conductor BEFORE you crimp the lug. (You will forget.
              Fit a second piece on the next conductor as a reminder for next time.)
            </li>
            <li>Crimp the lug. Bolt it into the terminal. Tighten to torque spec.</li>
            <li>
              Slide the heatshrink up over the lug barrel. Centre it so it covers the lug, the
              conductor entry and a band of insulation either side.
            </li>
            <li>
              Apply heat with a hot air gun (Steinel, DeWalt, or any 1500W+ trade heat gun). Start
              at the centre, work outwards in both directions. The shrink ratio is typically 4:1 —
              the tube collapses tight onto the lug and conductor. Adhesive lining melts and flows
              out at the ends, sealing the cable entry.
            </li>
            <li>
              Let it cool before disturbing. Check for any gaps in the seal — if you see them, fit a
              second layer over the top.
            </li>
          </ol>
          <p>
            On bonding clamps in external meter cabinets, also fit heatshrink over the BS 951 clamp
            body and conductor entry. Same product, same technique. The cost is pence per bond; the
            saved time on the next EICR investigation is hours.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You ran out of 10 mm² G/Y on a kitchen first-fix and were one metre short to reach the
              gas service. Rather than going back to the wholesaler, you spliced the cable inside
              the wall void using a brown screw connector, sleeved it with PVC tape, and plastered
              over. The bond passed initial verification because continuity was fine. Two years
              later the customer sells the house, the buyer's surveyor flags it as "no visible main
              bonding terminations to inspect" and the EICR comes back with a Code C2 against Reg
              543.3.2. The wall has to be opened, the joint ripped out, the cable replaced.
            </>
          }
          doInstead={
            <>
              Run the bonding conductor as one continuous length from MET to BS 951 clamp. Always.
              If the cable is short, drive to the wholesaler. If you are mid-job and stuck,
              terminate the existing length into the MET, fit a junction terminal block INSIDE THE
              METER CABINET (where it is accessible), and run a fresh length from the JB out to the
              clamp. The joint sits inside the cabinet, behind the door, visible whenever the
              cabinet is opened — Reg 543.3.2 satisfied. Never bury a bonding joint where it cannot
              be seen.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              bonding to the gas service. New 10 mm² G/Y single-core, run from the MET in the meter
              cabinet under the stairs to a BS 951 clamp on the consumer side of the gas meter in
              the kitchen, total length 4.2 m. You are at the MET end ready to land the conductor.
            </>
          }
          whatToDo={
            <>
              (1) Cut the cable to length leaving 200 mm of slack at the MET end for service loop.
              (2) Strip 12 mm of insulation using the ring-cut technique — score, snap, slide. (3)
              Inspect strands: bright copper, no nicks. (4) Slide a 10 mm² ivory bootlace ferrule
              over the bare strands and crimp with a hex-die ratchet crimper. Tug-test the ferrule.
              (5) Identify a free terminal hole on the brass MET busbar. Back the screw fully off.
              (6) Insert the ferrule into the terminal — bare conductor not visible outside the
              terminal body. (7) Tighten the screw to the manufacturer's torque spec (typically
              2.5-3.0 Nm) using a calibrated torque screwdriver. (8) Tug-test the conductor at the
              terminal — no movement. (9) Fit a heat-shrink "GAS SERVICE" label sleeve at the MET
              end. (10) Photograph the termination for the EIC record. (11) Continuity test from
              this end to the clamp end follows in Sub 4 of this Section.
            </>
          }
          whyItMatters={
            <>
              A textbook MET termination is what every inspection looks for. Every step on that list
              satisfies a specific BS 7671 requirement: strip technique to no damaged strands per
              Reg 526.1; ferrule to "number and shape of wires forming the conductor" per Reg
              526.1(b); torqued to spec to "adequate locking arrangements" per Reg 526.1(f);
              labelled to identification per Section 514; accessible inside cabinet to Reg 543.3.2.
              Missing any one of those steps degrades the termination from a 25-year asset to a
              future EICR finding.
            </>
          }
        />
