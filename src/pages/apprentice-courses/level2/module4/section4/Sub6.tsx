...
const checks = [
  {
    ...
    options: [
      'No bonding is needed anywhere, because the plastic supply pipe breaks the path to true earth.',
      'On the plastic supply pipe at the boundary, using a clamp rated to grip plastic pipework.',
      'On the metal consumer-side pipework, within 600 mm of the meter outlet union per Reg 544.1.2.',
      'On the gas meter body itself, which is the most accessible metal point in the installation.',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Structural steel never needs bonding because it is buried in concrete, which earths it directly.',
      'A single bond from the nearest column is sufficient regardless of overall building size.',
      'The steel frame is bonded only to the earth electrode in the slab, never back to the MET.',
      'Per Reg 411.3.1.2 it is an extraneous-conductive-part, bonded to the MET at multiple points.',
    ],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'No bonding of the array frame is needed, since the DC side is isolated from the AC system.',
      'Only the inverter casing needs bonding; the rails and panel frames are left fully unbonded.',
      'Per Section 712, the array frame and rails are bonded back to the inverter or PV earthing terminal.',
      'The array frame must be bonded directly to a separate dedicated earth rod, never to the building MET.',
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'The LPS must be kept completely separate from the electrical earth so lightning cannot enter at all.',
      'The LPS down-conductors are connected to the supplier neutral, never to the building earth.',
      'Per BS EN 62305, the LPS earth network is bonded to the MET — directly or via a spark gap.',
      'The LPS earth replaces the electrical earth entirely, so no separate earthing conductor is needed.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'No additional requirements — a swimming pool is treated exactly like a domestic bathroom for bonding.',
      'Supplementary bonding may be omitted entirely in pool zones because every circuit has RCD protection.',
      'Only the pool pump motor needs bonding; the surrounding pool-zone metalwork is outside scope.',
      'Section 702 — extensive supplementary bonding in Zones 0/1/2, and the omission permission does not apply.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Bonding required per Reg 411.3.1.2 — bond the metal oil pipe per Reg 544.1.2 with an oil-rated clamp.',
      'No bonding required — oil pipework is exempt from bonding because oil does not conduct electricity.',
      'Bond only the external storage tank, not the metal supply pipe entering the building at all.',
      'Bonding required, but the oil pipe must be bonded directly to the gas service bond, not to the MET.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It provides the sole earth return path, so the driven rod electrode can be omitted entirely.',
      'It carries the installation neutral current during normal operation to balance the phases.',
      'It equalises the frame potential with the MET during a fault, minimising touch voltage.',
      'It isolates the steel frame from the electrical system so a fault cannot energise the structure.',
    ],
    correctAnswer: 2,
    explanation:
      'The primary purpose is equipotential bonding — equalising the steel frame potential with the MET during a fault so touch voltage is minimised. As a secondary effect, structural steel buried in concrete with extensive ground contact often acts as a substantial parallel earth path, lowering Ze for the installation as a whole. On TT installations particularly, the structural steel can be the dominant earth path — much lower resistance than a single rod.',
  },
  {
    id: 7,
    question:
    ...
    options: [
      'Remove the bond entirely, because the new plastic supply means no bonding is required anywhere.',
      'Move the bond onto the new PE supply pipe at the property boundary using a plastic-pipe clamp.',
      'Add a second bond directly to the gas meter body to compensate for the new plastic supply pipe.',
      'Verify the bond is still on consumer-side metal pipework before any branch — if so, no change needed.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Bond every service independently back to the MET — gas, water, steel and LPS each on its own cable.',
      'Daisy-chain every service together with one continuous cable, then run a single bond to the MET to save cable.',
      'Bond the gas and water to each other, and bond the structural steel and LPS to a separate dedicated earth rod.',
      'Bond only the structural steel frame, since it connects to every other metallic service in the building anyway.',
    ],
    correctAnswer: 0,
    explanation:
...
const faqs = [
  ...
  {
    question:
      'How is bonding handled on a TT installation in a commercial unit with a structural steel frame?',
    answer:
  ...
  {
    question:
      "What about a domestic with a TN-S supply that's been converted to TN-C-S (PME) by the DNO?",
    answer:
  ...
  {
    question:
      'Does bonding apply to small-diameter incoming services like a single 15 mm copper water pipe?',
    answer:
  ...
  {
    question:
      'A modern fire suppression system has metal sprinkler pipes throughout the building. Do they need bonding?',
    answer:
...
export default function Sub6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 4 · Subsection 6"
      ...
      <HubBody>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              conductive — no bond on the plastic. The consumer-side pipework (typically still steel
              or copper) is still extraneous and gets bonded normally.
            </li>
            <li>
        ...
        >
          <p>Water service bonding is the most common bond install:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Bond the metal incoming water pipe — copper or galvanised steel typically.</li>
            <li>
              On consumer side of the main stop-tap, before any branch (the cold-water tank feed,
              hot-water cylinder feed, etc.).
            </li>
            <li>
              Within 600 mm of the stop-tap or point of entry to the building (where the pipe comes
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              potential gets bonded to the MET. "Extraneous-conductive-part" is defined in Part 2 as
              a conductive part liable to introduce a potential (generally earth potential) and not
              forming part of the electrical installation. This covers gas, water, oil, structural
              steel, lightning protection earth, and any other metallic services. Plastic incoming
              pipes are not conductive → not extraneous → no bond required.
            </>
          }
        ...
        >
          <p>
            ...
            oil supply pipe running from an external storage tank to the boiler. That pipework is
            extraneous-conductive (steel, enters the building from outside) and is bonded per Reg
            411.3.1.2.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              branch, within 600 mm of point of entry to the building where practicable.
            </li>
            <li>
        ...
        >
          <p>Structural steel framework characteristics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              touching the same conductor as everyone else touching any other column. Equipotential
              reference is critical.
            </li>
          </ul>
          <p>The bonding strategy:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Multiple bond points</strong> — typically 2-4+ depending on building size.
              Each bond independent, each routed back to the MET.
            </li>
            <li>
              <strong>Sized per Reg 544.1.1</strong> — large commercial PEN often requires 25 mm² or
              35 mm² Cu bonding per Table 54.8.
            </li>
            <li>
            ...
            <li>
              <strong>Document on the EIC</strong> — list every bond point, location, cable size,
              continuity reading.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            BS EN 62305 (lightning protection) and BS 7671 (electrical) work together via the
            equipotential bonding system. The two main configurations:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            Without an LPS-to-MET bond (in either configuration), a lightning strike can produce
            kV-range potential differences between the LPS earth and the electrical earth — causing
            flashover across air gaps inside the building, equipment damage, and shock hazards to
            anyone touching electrical equipment during the strike.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              sides limit lightning-induced surges from coupling into the PV system.
            </li>
            <li>
              <strong>
                BS 7909 + the IET Code of Practice for Grid-Connected Solar Photovoltaic Systems
              </strong>{' '}
              provide additional industry guidance.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            Battery energy storage systems (Tesla Powerwall, GivEnergy, Solax, Sonnen, etc.) add
            complexity beyond straight PV:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Section 701 — bath/shower rooms.</strong> Supplementary bonding rules with the
              Reg 701.415.2 omission permission (covered in Sub 5).
            </li>
            <li>
              <strong>Section 702 — swimming pools and other basins.</strong> Extensive
              supplementary bonding inside Zones 0/1/2 around the pool. Omission permission does NOT
              apply in pool zones.
            </li>
            <li>
              <strong>Section 703 — rooms containing sauna heaters.</strong> Special equipment rules
              in Zones 1/2 around the heater.
            </li>
            <li>
              ...
              particularly in livestock areas where touch-voltage thresholds are lower for animals.
            </li>
            <li>
              <strong>Section 708 — caravan and camping parks.</strong> TT installation rules with
              specific bonding for the caravan supply.
            </li>
            <li>
              <strong>Section 711 — exhibitions, shows and stands.</strong> Temporary install rules
              with TT supply considerations.
            </li>
            <li>
          ...
          <p>
            When working in any special location, ALWAYS read the relevant Section in addition to
            the general Chapter 41 / Chapter 54 rules. The Section overrides or supplements the
            general framework.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              heating mains, fire suppression supplies, and any other metallic service that enters
              the building. The 600 mm / consumer side / before branch position rules apply to all
              of them. Each service gets its own independent bond cable back to the MET.
            </>
          }
        ...
        <Scenario
          ...
          whyItMatters={
            <>
              ...
              each one documented, each one labelled. Multi-service buildings live or die on bonding
              quality during a fault.
            </>
          }
        />
