...
const faqs = [
  ...
  {
    question: 'How do I tell the customer I cannot energise today because of a non-conformance?',
    answer:
...
const nonConformances = [
  {
    ...
    fix: 'Loosen the terminal, remove conductor, re-strip to correct length (calibrated cable stripper or careful measurement), re-terminate, torque to manufacturer’s spec with a torque screwdriver.',
    avoid:
  ...
  },
  {
    ...
    fix: 'Investigate. Test sub-sections of the circuit until you isolate the problem joint. Re-make the joint properly (proper terminal block, full conductor strip, screw torqued, no insulation trapped). Retest end-to-end.',
    avoid:
  ...
  },
  {
    ...
    fix: 'Disconnect circuit. Re-terminate the affected accessory with line on L, neutral on N, CPC on E. Retest polarity at every accessory on the circuit, not just the one you fixed.',
    avoid:
  ...
  },
  {
    ...
    fix: 'Bring CPC back to the correct length (or replace cable section if too short), sleeve in green/yellow, terminate at the earth terminal of the accessory. Retest continuity.',
    avoid:
  ...
  },
  {
    ...
    fix: 'Trace the bonding cable end-to-end. Re-make any joint or unclamped connection. Verify continuity between the MET and each bonded service is acceptably low (typically < 0.05 Ω after lead null).',
    avoid:
  ...
  },
  {
    ...
    fix: 'Replace plastic clips with metallic clips, fire-rated cleats, or contain cables in metallic conduit / tray. Verify all cables on escape routes are properly supported.',
    avoid:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The classic apprentice traps a supervisor catches on first install inspection —
          terminations, polarity, missing CPC, wrong RCD type, AFDD gaps, missing notices — and how
          to avoid them.
        </p>
        ...
        >
          <p>
            The ten non-conformances below are not exhaustive — they are the highest-frequency
            patterns you will see flagged on a first inspection. Each one maps to a BS 7671
            regulation and to a specific Schedule of Inspections item. Each one has a recognisable
            signature, a known fix, and a habit you can build to avoid it next time.
          </p>
          <p>
            Treat this Sub as your &ldquo;watch out for&rdquo; reference. Read it before your first
            independent inspection. Read it again after the supervisor has caught one or two
            defects. By the time you have done five or six full inspections, the patterns are second
            nature.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>The dressing of the tails</strong> — neat, supported, no strain at the
              terminations, sheath stripped to the right point.
            </li>
            <li>
              <strong>The way labelling</strong> — handwritten panic labels versus printed legible
              labels matching the schedule.
            </li>
            <li>
              <strong>The busbar arrangement</strong> — RCBOs all the right way up, line and neutral
              on correct poles, no missing modules.
            </li>
            <li>
              <strong>The CPC arrangement</strong> — every CPC sleeved and to the earth bar, no
              orphan CPCs, no &ldquo;temporary&rdquo; choc-block joints.
            </li>
            <li>
              <strong>The notices</strong> — periodic inspection, RCD test, mixed colours, SPD,
              AFDD, EV, PV — fitted as appropriate.
            </li>
            <li>
              <strong>The first impression</strong> — does this look like the work of someone who
              cared, or someone who rushed? An install built with care rarely has hidden defects;
              one built in a rush usually has several.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <div className="space-y-3">
            {nonConformances.map((nc) => (
              <div key={nc.n} className="rounded-xl border border-white/10 bg-white/[0.03] p-3.5">
                <div className="flex items-baseline gap-2.5 border-b border-white/[0.08] pb-2 mb-2.5">
                  ...
                  <span className="text-white text-[14px] font-semibold flex-1">{nc.title}</span>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 411.3.1.1 fixes the rule that catches non-conformance #4 — the missing CPC. Every
              Class I exposed-conductive-part has to be connected to the protective conductor
              system. The only exception is a lampholder with no exposed-conductive-parts (e.g. a
              plastic batten holder) suspended from a point that has the CPC terminated. Every
              metal-bodied luminaire, socket faceplate, switch faceplate, FCU, accessory — CPC
              required.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 514.13 catches non-conformance #9 — missing BS 951 bonding label. Every main
              bonding clamp must carry the &ldquo;Safety Electrical Connection — Do Not
              Remove&rdquo; label so plumbers and others working on the service know not to remove
              the bond. Sticky-back BS 951 labels live in your van — fit one at every clamp as you
              go.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              Section 722. Spec Type A from day one on every quote.
            </>
          }
        ...
        <ContentEyebrow>
          Communicating non-conformances — to the customer, to the team
        </ContentEyebrow>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/80 text-[13.5px]">
            <li>
              <strong>State the defect plainly:</strong> &ldquo;During the inspection we&rsquo;ve
              found that the polarity at one of the bedroom sockets is reversed.&rdquo;
            </li>
            <li>
              <strong>Explain the risk in plain language:</strong> &ldquo;That means the live pin is
              in the wrong place, which is a shock risk for anyone unplugging an appliance.&rdquo;
            </li>
            <li>
              <strong>Explain the fix:</strong> &ldquo;We&rsquo;ll re-terminate the socket properly
              and re-test. Takes about 20 minutes.&rdquo;
            </li>
            <li>
              <strong>Confirm the timeline:</strong> &ldquo;You&rsquo;ll have the power back on by
              [time]. Thank you for being patient — this is the kind of thing the inspection step is
              designed to catch before energising.&rdquo;
            </li>
          </ol>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Blame other tradespeople (&ldquo;the previous electrician&rdquo;, &ldquo;the
              apprentice&rdquo;) — even if true, the customer does not care.
            </li>
            <li>
              Hedge or downplay (&ldquo;it&rsquo;s probably fine but...&rdquo;) — gives the customer
              permission to push you to energise.
            </li>
            <li>
              Catastrophise (&ldquo;could burn the house down&rdquo;) — even if true, creates panic
              and damages trust.
            </li>
            <li>
              Apologise excessively — the inspection working is exactly what the customer is paying
              for. You found a defect at the right time.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Calibrate strip length</strong> — adjustable cable stripper with a stop, set
              once, used always. No copper past the brass, ever.
            </li>
            <li>
              <strong>Tug-test every termination</strong> — gentle, controlled, immediately after
              termination. If it pulls out, re-strip and re-make.
            </li>
            <li>
              <strong>Sleeve the CPC at every termination</strong> — green/yellow on every bare CPC.
              Never leave bare copper on a CPC at any termination, including back-box flying leads.
            </li>
            <li>
              <strong>Identify switched lives</strong> — brown sleeving at both ends of any switched
              live. Eliminates polarity confusion at the rose / switch.
            </li>
            <li>
              <strong>Test as you build</strong> — continuity at every termination, IR before
              energising, polarity at every accessory before the faceplate goes on.
            </li>
            <li>
              <strong>Label every CU way before closing the cover</strong> — handwritten in pencil
              during build, replaced with printed labels at handover.
            </li>
            <li>
              <strong>Carry a label kit</strong> — BS 951 stickers, RCD test notice, periodic
              inspection notice, mixed-colour notice, SPD notice. Fit as you go.
            </li>
            <li>
              <strong>Photograph every termination</strong> at first-fix before the accessory
              faceplate goes on. Builds a portfolio audit trail and discourages corner-cutting.
            </li>
            <li>
              <strong>Use the MFT memory</strong> — every test value saved with circuit identifier
              on the instrument. Download at end of day. No transcription errors.
            </li>
            <li>
              <strong>Run the inspection rhythm</strong> in the same order every time. Origin →
              distribution → circuits → bonding → notices. Repetition builds speed without
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EIC (new install):</strong> Schedule of Inspections and Schedule of Test
              Results both clean (✓ throughout, honest LIMs documented, zero ✗). Any defect = fix
              before EIC issued.
            </li>
            <li>
              <strong>EICR (periodic inspection):</strong> Observations coded C1 (immediate danger —
              power off the affected part of the install immediately), C2 (potentially dangerous —
              fix soon), C3 (improvement recommended — not strictly non-compliant but worth fixing),
              FI (further investigation — cannot determine compliance without additional work).
            </li>
            <li>
              <strong>Minor Works Certificate:</strong> Used for additions or alterations that are
              not a complete install. Same logic — defects in the new work must be fixed before the
              certificate is issued.
            </li>
          </ul>
          <p>
            The Level 2 apprentice&rsquo;s job is to deliver clean inspection findings on new work.
            The I&T qualification (2391 / 2392 series) covers the observation-coding nuances of EICR
            work.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The customer is on site, the kettle is unplugged, the freezer is defrosting, and they
              are pushing you hard to energise. You have one terminal you are not 100% sure about —
              copper might be showing past the brass on the line of circuit 4 — but you have not
              opened the CU again to check. You decide to call it ✓ on the Schedule of Inspections,
              energise, and "fix it on the next visit if it’s a real issue". That single decision
              puts you on a path that ends in a callback, a potential fault, and a difficult
              conversation with your supervisor.
            </>
          }
          doInstead={
            <>
              Slow down. The cost of a five-minute re-check is nothing compared to the cost of a
              defect caught after energisation. Tell the customer honestly: &ldquo;We&rsquo;ve found
              one item to verify before we energise — give us ten minutes.&rdquo; Open the CU, look
              at the terminal in question, fix if needed, retest if needed. Then energise.{' '}
              <strong>
                The whole point of inspection-before-energisation is that defects are cheap to fix
                at this stage and expensive to fix later.
              </strong>{' '}
              A customer who pushes you to energise an install with a known suspicion is asking you
              to put their safety after their convenience. You do not negotiate with that.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You have just wired your first ring final under supervision. Two upstairs bedroom
              sockets and three downstairs sockets, 2.5 mm² T&E, 32 A RCBO Type A, all terminations
              made by you. The supervisor walks in, opens the CU, opens one socket, glances at the
              cable runs, and says &ldquo;right — talk me through your inspection of this
              circuit&rdquo;. The five things they are about to catch are predictable.
            </>
          }
          whatToDo={
            <>
              Walk the circuit honestly. Open every socket faceplate (loose, so you can see the
              terminations). At the CU, look at the line, neutral and CPC terminations of the RCBO —
              copper to the brass, no excess past, sleeve on the CPC, no insulation trapped. At each
              socket, the same — line on L, neutral on N, CPC on E with green/yellow sleeve, all
              secure, all behind grommets in metal back-boxes. The five things the supervisor
              catches: (1) one termination at the CU with a millimetre of copper showing past the
              brass — re-strip and re-terminate; (2) one socket where the back-box grommet is
              missing — fit one; (3) the CPC at one back-box without sleeving on the flying lead —
              sleeve it; (4) the way label on the CU says &ldquo;sockets&rdquo; instead of
              &ldquo;upstairs sockets ring&rdquo; — update the label; (5) on the ring final
              continuity test, R1+R2 readings vary by more than expected at one socket — sounds like
              one of the connections is not as tight as it should be, re-check and re-make. Five
              fixes, fifteen minutes, then re-test.
            </>
          }
          whyItMatters={
            <>
              These are the five most common defects on a first ring final inspection. Catching them
              at supervised inspection is exactly what the apprentice phase is for. By the time you
              have wired and inspected ten ring finals, you will spot all five before the supervisor
              does. By the time you have wired and inspected fifty, you will have built the habits
              that prevent them at the build stage. That progression is the apprenticeship.
            </>
          }
        />
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Caught at inspection (before energisation):</strong> Cost = 5–20 minutes of
              fixing. Customer impact = minimal delay. Reputation impact = positive (the inspection
              worked as designed).
            </li>
            <li>
              <strong>Caught at testing (defect picked up by IR or continuity):</strong>
              Cost = 30–60 minutes of investigation plus the fix. Customer impact = small delay.
              Reputation impact = neutral.
            </li>
            <li>
              <strong>Caught on callback (customer reports a fault):</strong> Cost = travel + 1–2
              hours on site + apologies + opening the install back up + potentially disturbing
              customer&rsquo;s decorating. Reputation impact = damaged.
            </li>
            <li>
              <strong>Caught after a fault (fire, shock, near-miss):</strong> Cost = potential
              personal injury claim, insurance excess, possible HSE / EAWR / Building Safety Act
              investigation, criminal prosecution risk. Reputation impact = severe; potentially
              career-ending for the signing electrician.
            </li>
            <li>
              <strong>Caught at next periodic inspection (5–10 years later):</strong>
              Cost = customer pays for full remedial work plus EICR, you may be liable under the
              original EIC if the defect was present at original install. Reputation impact =
              damaging.
            </li>
          </ul>
          <p>
            The five-minute fix at inspection time is not a delay — it is the lowest-cost option in
            this entire chain. Treat every inspection as the gate it is meant to be.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/80 text-[13.5px]">
            <li>
              <strong>Observe (months 1–6):</strong> You carry the clipboard, hold the torch, write
              down what the senior electrician calls out. You watch the rhythm. You ask
              &lsquo;why&rsquo; after the inspection, not during.
            </li>
            <li>
              <strong>Assist (months 6–18):</strong> You start running the Schedule of Inspections
              form yourself. You are catching the obvious defects yourself and flagging them.
              Supervisor catches a handful per inspection.
            </li>
            <li>
              <strong>Lead with sign-off (months 18–36):</strong> You run the inspection on small
              installs yourself, hand the form to the supervisor for review and counter-signature.
              Supervisor catches the occasional finding.
            </li>
            <li>
              <strong>Sign off independently (post-qualification):</strong> You sign your own
              inspections on installs you have built or supervised. EICR work via the I&T
              qualification adds another layer of certification.
            </li>
          </ol>
          <p>
            Year 1 you should not be embarrassed by defects flagged. Year 3 you should be slightly
            embarrassed when one is. By the end of the apprenticeship the supervisor finds nothing
            because the habits have been built.
          </p>
        </ConceptBlock>
        ...
        <Quiz title="Common non-conformances — knowledge check" questions={quizQuestions} />
