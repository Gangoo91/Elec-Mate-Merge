...
const TITLE = 'Fix accessories to dimensions (3.3) | Level 2 Module 4.3.3 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question: 'A 25 mm flush metal back-box has knockouts on which faces?',
    options: [
  ...
  {
    id: 2,
    question: 'Plasterboard back-boxes (dry-line boxes) are fixed by:',
    options: [
  ...
  {
    id: 3,
    question: 'A surface back-box (pattress) is mounted because:',
    options: [
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 3 · Subsection 3"
        title="Fix accessories to dimensions from drawings"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Back-boxes, surface pattresses, dado trunking, dry-line boxes — fixed plumb, level, flush
          and at the height the drawing specifies. The detail is in box depth, fixings by substrate,
          and knowing when to chase deeper rather than force a proud box.
        </p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Galvanised steel flush back-box</strong> — Stamped steel, knockouts on every
              face, lugs on top and bottom for screw fixings. Standard depths 16, 25, 35, 47 mm.
              Used in chased masonry. Robust, screws in well, takes conduit entries cleanly.
            </li>
            <li>
              <strong>Plastic dry-line / cavity box</strong> — PVC or polycarbonate with integrated
              spring jaws or grip plates. For plasterboard stud installations. Lighter than steel,
              cheaper, but cracks under retrofit chiselling.
            </li>
            <li>
              <strong>Surface pattress</strong> — Mounted on the wall surface, accessory mounts on
              the front of the pattress. Steel (industrial / agricultural / wet areas) or plastic
              (light commercial, dado fronts). For installs where chasing is impossible or the
              design is intentionally surface.
            </li>
            <li>
              <strong>Dado trunking accessory plate</strong> — Mounts directly onto the front of a
              50/100/170 mm dado trunking. The trunking sets the level; the plate clips onto the
              trunking face. Used in commercial fit-outs.
            </li>
            <li>
              <strong>Floor-box (recessed)</strong> — A specialist surface box recessed into a
              screed floor for desk power feeds. Comes with a hinged lid and gasket.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>16 mm</strong> — Shallow boxes for low-profile single light switches. Tight on
              cable space; not for sockets or FCUs.
            </li>
            <li>
              <strong>25 mm</strong> — Standard flush depth for 13 A sockets and most twin sockets
              with rear-loaded terminals. Adequate for 1.5 / 2.5 mm² T&E.
            </li>
            <li>
            ...
            <li>
              <strong>47 mm</strong> — Cooker switches, shower switches, larger CSAs (6+ mm²), grid
              switches with multiple modules.
            </li>
          </ul>
          <p>
            Cable space inside the box matters as much as terminal space. A 25 mm box with 4 cables
            landing in it is tight; a 35 mm box gives room for the conductors to fold rather than
            pinch. Going one size deeper is rarely wrong.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 522.8.1 is what stands behind back-box choice. A box that is too shallow pinches
              the cable and damages the insulation; a box without grommets exposes the cable to the
              sharp knockout edge; a box that is loose stresses the conductor terminations. Box
              selection and fixing are part of how you comply with 522.8.1, not separate concerns.
              Get either wrong and you have a 522.8.1 failure waiting to be found.
            </>
          }
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Solid brick / block / concrete</strong> — Frame fixing (combined plug + screw)
              is the modern standard for back-boxes. Faster than separate plug + screw, no risk of
              mismatched sizes. Use 60 mm length for standard back-box lugs through the chase.
            </li>
            <li>
              <strong>Cavity / aerated block</strong> — Specialised cavity wall plugs that expand
              inside the cavity (Fischer SX, Rawl R-LX). Avoid frame fixings in aerated block — the
              plug crumbles the soft block.
            </li>
            <li>
              <strong>Plasterboard stud wall</strong> — Use a dry-line box (jaws clamp the board),
              not separate plasterboard plugs around a flush box. For non-box accessories (cable
              cleats, brackets) use spring-toggle or self-drive plasterboard fixings rated for the
              load.
            </li>
            <li>
              <strong>Timber stud (the box lands on a stud)</strong> — Wood screws (#8 × 25 or 30
              mm), straight into the stud. Pilot-drill if the stud is hardwood.
            </li>
            <li>
              <strong>Steel stud / partition framing</strong> — Self-drilling self-tapping screws
              designed for the stud gauge, OR a dry-line box that clamps the stud face.
            </li>
            <li>
              <strong>Surface mounting on any substrate</strong> — Surface pattress fixed with the
              appropriate fixing for the substrate behind. Pattress flange has fixing holes at
              corners; usually 4 fixings per box.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            The legacy method — drill, push in a separate plug, then drive a screw through the box
            into the plug — still works fine. It needs a steady hand to keep the plug from spinning
            and a matching screw size for the plug. Frame fixings eliminate both potential failure
            modes. Either method is acceptable; frame fixings are faster.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Standard chase depth maths:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            For a 35 mm box on a wall that will get a 12 mm finish: 35 + 12 + 2 + 1 = ~50 mm. Chase
            to ~50 mm and verify with the box dry-fitted before you mortar or fix. The chase floor
            needs to be flat enough that the box sits without rocking — clean out loose mortar and
            brick fragments before fitting.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The check sequence for every box: dry-fit, check vertical (small level on left edge),
            check horizontal (level on top edge), check square to wall (eye it from the side, look
            for any tilt), check depth (faceplate edge or plaster gauge), then fix. The whole
            sequence takes 30 seconds per box and pays back many-fold in second fix quality.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 134.1.1 is the workmanship regulation that sits behind every back-box that goes in
              a wall. A flush box that is plumb, level, recessed to the right depth, and securely
              fixed is good workmanship; a box that is twisted, proud, or loose is a 134.1.1 failure
              that propagates through the rest of the install. Take the time at first fix and the
              second-fix electrician (often you, weeks later) thanks you.
            </>
          }
        ...
        >
          <p>The cut sequence for a dry-line box:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Mark the box outline on the plasterboard (use the box itself or a template).</li>
            <li>
              Cut with a jab saw or a plasterboard cut-out tool. Cut just inside the line; you can
              always shave more, you cannot put it back.
            </li>
            <li>
              Test-fit the box. The face flange should sit flat on the plasterboard; the jaws should
              clear the cut.
            </li>
            <li>Pull cable through the back of the box.</li>
            <li>
              Push the box into the hole. The jaws fold flat to enter, then spring out behind the
              board.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Box centre lands within 50 mm of a stud edge</strong> — move the accessory ±50
              mm sideways into the bay. Architecturally invisible unless aligned to a feature.
            </li>
            <li>
              <strong>Box position is critical (aligned to a feature)</strong> — use a side-fix
              dry-line box that grabs the stud as one of its fixing points. Appleby Type B
              ("stud-side") boxes do this.
            </li>
            <li>
              <strong>Move not possible, side-fix not available</strong> — raise an RFI with the
              designer. The accessory may need to move to the next stud bay, with the cable route
        ...
        >
          <p>The fix sequence for a steel surface pattress on a masonry wall:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Cut the trunking front-face aperture for each accessory plate (most dado systems have
              a pre-cut module that pops out).
            </li>
            ...
            <li>
              Snap the cover on. Visible row of plates is automatically aligned because the trunking
              is straight.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Worked example — chasing in a flush back-box on existing plaster
        </ContentEyebrow>
        ...
        <Scenario
          ...
          situation={
            <>
              Customer wants a new twin socket added on an existing plastered wall. The wall is
              solid brick with a 12 mm finishing plaster coat on top. You have already set out the
              height and centre, marked a 75 × 75 mm square outline for a 25 mm deep flush
              double-gang box, and you have a route from the floor void up to the box position via a
              chase.
            </>
          }
          whatToDo={
            <>
              <strong>Step 1.</strong> Score the plaster around the marked outline with a Stanley
              knife — gives a clean edge and stops the plaster cracking outside the chase.
              <br />
              <br />
              <strong>Step 2.</strong> Chase out the box pocket using a wall chaser (clean,
              dust-extracted) or a hammer drill + cold chisel (slower, dustier). Target depth ~40 mm
              (25 mm box + 12 mm plaster + 3 mm recess). Verify with the box dry-fitted — face
              should sit ~3 mm below the plaster line.
              <br />
              <br />
              <strong>Step 3.</strong> Chase the cable route from the box down to the floor void in
              a straight vertical line (Reg 522.6.202 safe zones — vertical above and below an
              accessory). Depth ~30 mm to allow capping or conduit + plaster cover.
              <br />
              <br />
              <strong>Step 4.</strong> Pull cable up through the chase. Knock out the bottom rear
              knockout of the box, fit a grommet, push the cable through with ~200 mm tail in the
              box.
              <br />
              <br />
              <strong>Step 5.</strong> Check the chase floor is clean and flat under the box.
              Frame-fix the box through the lugs into the brick (60 mm × 6 mm frame fixings). Snug,
              do not over-tighten.
              <br />
              <br />
              <strong>Step 6.</strong> Verify with a small spirit level: box face is plumb
              vertically, level horizontally, and ~3 mm below plaster line all the way round.
              <br />
              <br />
              <strong>Step 7.</strong> Fit cable capping (or oval conduit) over the cable in the
              chase, clipped or pinned in place.
              <br />
              <br />
              <strong>Step 8.</strong> Leave for the plasterer. They will fill the chase with
              bonding coat, then skim up to the box rim. The plate goes on at second fix; if the box
              is set right, the plate sits flat on the plaster with no gap.
            </>
          }
          whyItMatters={
            <>
              The chase depth and box setting determine the second-fix quality. A box set 3 mm
              proud, or twisted, or with no recess, becomes a 30-minute remedial faceplate fight at
              second fix — and the customer can see the gap. A box set right disappears once the
              plate is on. The hidden craft is what shows.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The chase was a touch shallow, you fixed the box anyway "because the plasterer can
              build round it". The plasterer skims to the wall surface and the box stands 4 mm
              proud. At second fix the faceplate sits on the box rim, tilted forward, with a visible
              gap between the plate edge and the wall all the way round. The screws have to be
              over-tightened to pull the plate down, which compresses the cable against the back of
              the box (526.1 risk). The customer notices. The plate is rocked back and forth trying
              to find position. None of it is right.
            </>
          }
          doInstead={
            <>
              Always verify chase depth with the box dry-fitted before mortaring or fixing. The face
              of the box should sit 1-3 mm BELOW the line of the surrounding plaster. If the chase
              is too shallow, deepen it now — five more minutes of chasing saves twenty minutes of
              second-fix fight. If you discover the box is proud after plastering, the only good fix
              is to knock the box out, deepen the chase, refit, and ask the plasterer to make-good.
              Living with a proud box is a bodge that the customer or inspector will always notice.
            </>
          }
        />
        ...
        <Quiz
          title="Fixing accessories to dimensions — knowledge check"
