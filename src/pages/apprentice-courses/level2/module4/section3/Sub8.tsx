...
const checks = [
  ...
  },
  {
    ...
    options: [
      ...
      'BS 7671 requires it everywhere.',
      'It looks better.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Standard PVC T&E — same as the rest of the lighting circuit.',
