...
const TITLE = 'Select materials from drawings (3.1) | Level 2 Module 4.3.1 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'The CU schedule (consumer-unit schedule) tells you everything except:',
    options: [
  ...
  {
    id: 3,
    question: 'Why do you typically add 10–20 % to the cable schedule length when you order?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reading the cable schedule, accessory schedule, containment schedule and CU schedule on a
          typical drawing pack. Cross-checking against the layout and schematic, taking off
          quantities, and applying allowances before you order. Get this right and the install runs;
          get it wrong and you spend the job chasing missing parts.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single-line schematic</strong> — circuit topology. Shows what feeds what, from
              incomer through CU through final circuits to outlets. No physical dimensions, just
              logic.
            </li>
            <li>
              <strong>1:50 floor-plan layout</strong> — physical positions of every accessory, cable
              route lines, datum dimensions for setting out. Sometimes a separate ceiling-plan
              layout for lighting.
            </li>
            <li>
            ...
            <li>
              <strong>Accessory schedule</strong> — every wall-end and ceiling-end fitting. Columns:
              ref, type, finish, location, fixings.
            </li>
            <li>
          ...
          <p>
            Smaller jobs (a kitchen rewire, a single-circuit alteration) often skip the schedules
            and just give you the layout. That is fine — but you become the schedule. Write it down,
            get it signed, then order.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            For a typical 3-bed semi rewire, the schematic shows: incomer (DNO cut-out) → meter
            tails (25 mm² typically) → consumer unit (often 14-18 way dual-RCD or all-RCBO) → 8-12
            final circuits (lighting, sockets, cooker, shower, smoke alarm chain, fan, EV charger if
            specified, garden supply if any) → outlet positions.
          </p>
          <p>
            You should be able to look at the schematic and say "the kitchen ring is on way 6, RCBO
            Type A 32 A, feeds 6 utilisation outlets". If you cannot, slow down and re-read the
            schematic.
          </p>
        </ConceptBlock>
          ...
          <div className="space-y-2.5 sm:hidden">
            <div className="rounded-xl bg-[hsl(0_0%_11%)] border border-white/[0.06] p-3.5">
              ...
              <p className="text-[13px] text-white/85 mt-1">
                Way number on the CU. Cross-references the CU schedule.
              </p>
            </div>
            <div className="rounded-xl bg-[hsl(0_0%_11%)] border border-white/[0.06] p-3.5">
              <div className="text-[11px] font-semibold uppercase tracking-wider text-elec-yellow/85">
              ...
              <p className="text-[13px] text-white/85 mt-1">
                "Kitchen ring", "Upstairs lights", "Shower", "EV charger".
              </p>
            </div>
            <div className="rounded-xl bg-[hsl(0_0%_11%)] border border-white/[0.06] p-3.5">
              <div className="text-[11px] font-semibold uppercase tracking-wider text-elec-yellow/85">
              ...
              <p className="text-[13px] text-white/85 mt-1">
                1.0 / 1.5 / 2.5 / 4 / 6 / 10 / 16 mm² typically.
              </p>
            </div>
            <div className="rounded-xl bg-[hsl(0_0%_11%)] border border-white/[0.06] p-3.5">
              <div className="text-[11px] font-semibold uppercase tracking-wider text-elec-yellow/85">
              ...
              <p className="text-[13px] text-white/85 mt-1">
                PVC T&E (6242Y), PVC singles, SWA, FP200, MICC, LSF/LSZH variants.
              </p>
            </div>
            <div className="rounded-xl bg-[hsl(0_0%_11%)] border border-white/[0.06] p-3.5">
              <div className="text-[11px] font-semibold uppercase tracking-wider text-elec-yellow/85">
              ...
              <p className="text-[13px] text-white/85 mt-1">
                Designer&rsquo;s point-to-point estimate. Verify against layout. Add 10-20 %.
              </p>
            </div>
            <div className="rounded-xl bg-[hsl(0_0%_11%)] border border-white/[0.06] p-3.5">
              <div className="text-[11px] font-semibold uppercase tracking-wider text-elec-yellow/85">
              ...
              <p className="text-[13px] text-white/85 mt-1">
                Method A/B/C/E/F/100/103 — drives the CCC calc and the containment.
              </p>
            </div>
          </div>
          <ul className="hidden sm:block space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Circuit ref</strong> — Way number on the CU. Cross-references the CU schedule.
            </li>
            <li>
              <strong>Circuit name</strong> — "Kitchen ring", "Upstairs lights", "Shower", "EV
              charger".
            </li>
            <li>
              <strong>CSA</strong> — 1.0 / 1.5 / 2.5 / 4 / 6 / 10 / 16 mm² typically.
            </li>
            <li>
              <strong>Cable type</strong> — PVC T&E (6242Y), PVC singles, SWA, FP200, MICC, LSF/LSZH
              variants.
            </li>
            <li>
              <strong>Route length</strong> — Designer&rsquo;s point-to-point estimate. Verify
              against layout. Add 10-20 %.
            </li>
            <li>
              <strong>Install method</strong> — Method A/B/C/E/F/100/103 — drives the CCC calc and
              the containment.
            </li>
          </ul>
          <p>
            Some schedules add a "device" column (the MCB/RCBO/AFDD rating) and a "termination"
            column (loop in/out, ferrule type). Both are useful but redundant — if your CU schedule
            and cable schedule disagree on the device, you raise an RFI.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The verification is quick — get a scale rule, lay it on the layout, follow the cable run
            line, add a generous tail at each termination point, multiply for drops and rises. On a
            complex run with multiple changes of direction, a piece of string on the layout works
            better than a rule. Always round up.
          </p>
          <p>
            If your measured length is more than 10 % over the schedule, flag it. If it is more than
            25 % over, raise an RFI before ordering — the route may have changed since the design
            was issued, or you may be missing a critical detail.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Type</strong> — twin socket / single socket / 13 A FCU / 20 A DP switch / grid
              switch / cooker switch / shower switch / smoke alarm.
            </li>
            <li>
              <strong>Finish</strong> — white moulded / white metalclad / black nickel / brushed
              steel / chrome / antique brass — finish drives wholesale unit cost significantly.
            </li>
            <li>
              <strong>Box depth</strong> — 25 mm for shallow stud-wall; 35 mm standard flush; 47 mm
              for cooker switches and shower switches with thicker terminals.
            </li>
            <li>
              <strong>Quantity</strong> — count from the layout, never trust the schedule quantity
              in isolation.
            </li>
            <li>
              <strong>Mounting</strong> — flush in masonry / flush in stud / surface on pattress /
              dry-line box for plasterboard.
            </li>
          </ul>
          <p>
            Don&rsquo;t forget the consumables. Every back-box needs rubber or plastic grommets on
            the cable entries. Every line conductor in a switch needs brown sleeving on the
            neutral/blue conductor when used as a switch line. Every screw needs the right wall plug
            (frame fixings for masonry, plasterboard plugs for plasterboard, wood screws for
            timber). Add 10-20 % to every consumable count.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              strong, protected. Selecting accessories from drawings is the upstream side of this.
              Specifying a 25 mm shallow box where a 35 mm box is needed means the T&E pinches
              against the back, the screw terminal cannot be properly torqued, and the connection
              eventually fails. The accessory choice is a 526.1 decision, not just a finish
              decision.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Saddles / clips</strong> — typically every 1 m on horizontal PVC, every 1.2 m
              on vertical, every 0.6 m next to a box. Steel conduit needs spacing bar saddles or
              P-clips at 1.2-1.5 m intervals.
            </li>
            <li>
              <strong>Bushes / locknuts</strong> — every box entry, both sides. Brass for steel
              conduit, plastic for PVC.
            </li>
            <li>
            ...
            <li>
              ...
              compartment penetration (cavity wall, floor void, fire-rated stud wall). One of the
              easiest things to forget on take-off and one of the most expensive to retrofit.
            </li>
          </ul>
          <p>
            For trunking, the same principle — measure straight lengths, round up to whole sticks,
            count corners (internal/external), tees, end caps, lid-clips per stick, and the cable
            retaining clips. Pre-formed copex/flexible conduit needs its own line for the entry
            fittings.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The standard pieces: straight section (3 m), 90° bend (radius matched to cable minimum
            bend radius), 45° bend, tee, cross, reducer, dropout, and the brackets themselves
            (cantilever, trapeze, channel). Every change of direction is a fitting; every bracket
            position is a count. The schedule should list these individually — if it does not, you
            take-off the layout drawing direct.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>RCD / RCBO type</strong> — Type AC (legacy, AC fault current only), Type A
              (most modern domestic, includes pulsating DC), Type F or B (EV chargers, solar PV,
            ...
            <li>
              <strong>Pole arrangement</strong> — single-pole switching standard; double-pole where
              N-isolation is required.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cable</strong> — 10 % new build, 15-20 % refurb / chasing rewire, 25 % if you
              have ever worked on lath-and-plaster or solid-brick Victorian walls. Always round up
              to the next standard drum size (50 m, 100 m, 200 m).
            </li>
            <li>
              <strong>Conduit / trunking</strong> — round up to whole 3 m sticks, then add 10 %
              spare on top (offcuts, miscut bends, second pull if first one fails).
            </li>
            <li>
              <strong>Accessories</strong> — 5 % allowance for breakage and missed quantities.
              Faceplates crack when dropped, screws strip, sockets get scuffed.
            </li>
            <li>
              <strong>Consumables</strong> — 20 % allowance on grommets, brown sleeving, wall plugs,
              screws, tape, lubricant, intumescent putty. The cheap stuff you always run out of half
              a day before the wholesaler shuts.
            </li>
            <li>
              <strong>CU and devices</strong> — exact count on the devices, but always spec a CU
              with at least 25 % spare ways for future circuits.
            </li>
          </ul>
          <p>
            The total cost of "over-ordering" by 10-20 % is small. The total cost of stopping site
            to drive to a wholesaler at 11am on a Wednesday is huge — labour cost of two operatives
            standing around, plus the wholesaler markup on the one-off purchase, plus the loss of
            momentum.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>The brief.</strong> Drawing pack for a 3-bed semi rewire. Cable schedule row 6:
            "Kitchen ring — 2.5 mm² T&E — 30 m — Method C clipped/Method 100 in stud wall — 32 A
            RCBO Type A". Layout: 4 twin sockets + 2 FCUs (washing machine and dishwasher) on the
            kitchen wall. CU schedule way 6: RCBO Type A, 32 A, Type B characteristic. Containment
            schedule: "Kitchen ring — clipped through floor void, in 32 mm chase down to FCUs at
            worktop level".
          </p>
          <p>
            <strong>Step 1 — verify the schedule against the layout.</strong> Scale-rule the route
            on the layout drawing. Out of CU, across upstairs floor void to kitchen corner (5 m),
            drop down inside stud wall to floor level (3 m), along floor void to first socket (4 m),
            then daisy-chain socket to socket to FCU to FCU back to CU (4 + 2 + 3 + 2 + 4 + 5 + 4 =
            24 m). Total: 5 + 3 + 24 = 32 m. Schedule says 30 m. Within tolerance, no RFI needed.
          </p>
          <p>
            <strong>Step 2 — apply allowances.</strong> 32 m × 1.20 (15 % routing + 5 % spare) =
            38.4 m. Round up to next drum increment — buy a 50 m drum (you will use the rest on
            another circuit) or a 100 m if you are doing the whole rewire.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              6 × 35 mm flush metal back-box, single gang for FCU, double gang for sockets (so 2 ×
              single gang and 4 × double gang)
            </li>
            ...
            <li>
              Plasterboard fixings — if any boxes land in stud wall sections, count separately
            </li>
          </ul>
          <p>
            <strong>Step 4 — containment take-off.</strong> 32 mm chase from floor level up to
            worktop height for the FCU drops — the schedule says channel/oval conduit for mechanical
            protection in the chase. 2 × 1 m of 32 mm oval PVC (one per FCU drop), plus capping for
            the chase fill, plus intumescent putty if any of the floor-void penetration is through a
            fire compartment.
          </p>
          <p>
            <strong>Step 5 — CU device.</strong> 1 × 32 A Type A RCBO Type B characteristic,
            matching the CU manufacturer (Hager NDN132A or equivalent). Already in the CU schedule
            total — just confirm it is on the order.
          </p>
          <p>
            <strong>Step 6 — write the line on the order.</strong> One row per item, with part
            number, description, quantity, supplier, expected delivery date. The accessories all
            come from one wholesaler in one delivery; the CU and devices come from another (you may
            bulk-order the CU and devices for the whole rewire together). The cable comes by the
            drum.
          </p>
          <p>
            That is one circuit. A 3-bed semi rewire has 8-12 circuits. The take-off for the whole
            job is the same exercise repeated 12 times, then totalled, then cross-checked against
            the schedule pages, then sent out for ordering. Allow half a day for a careful take-off
            on a small rewire — and the half day saves you three days of chasing missing parts on
            site.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Schedule says "Upstairs lighting — 1.5 mm² T&E — 35 m". You order a 50 m drum. On
              site, the actual route through the joists, dropping at every ceiling rose, climbing up
              to switch positions and looping back to the CU, works out at 58 m. You finish 7 m
              short on the last drop, the wholesaler cannot deliver until tomorrow, and the
              plasterer walks off because he was expecting first-fix complete.
            </>
          }
          doInstead={
            <>
              Always scale-rule the layout to verify the schedule before ordering. Add 15-20 %
              routing allowance over the verified figure, then round up to the next drum size. The
              cost of an extra 50 m drum you might not fully use is trivial compared to the cost of
              stopping site for a missing length of cable.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You are halfway through a kitchen rewire. Materials are on site, take-off signed off,
              install proceeding. Customer phones the supervisor — they have just bought an EV and
              want a 7 kW charger added to the install. No updated drawing pack, just a verbal "can
              you fit it in".
            </>
          }
          whatToDo={
            <>
              Stop. An EV charger is not just a circuit — it is a 32 A radial that needs its own
              RCBO Type A or Type B (depending on the charger&rsquo;s integral protection), a
              separate cable run from the CU to the charger position (typically 6 mm² T&E or SWA),
              the OZEV / smart-charging compliance, possibly a CT clamp for load management, and
              possibly an SPD upgrade. None of that is on the take-off, and the CU may not have a
              spare way of the right type. Email the customer to confirm the request in writing.
              Raise the variation with the designer (or you, if you are also designing). Do a full
              take-off addendum — extra cable, extra device, possibly a larger CU. Order. Then
              install. Never just "fit it in" — that is how scope-creep turns into a callback.
            </>
          }
          whyItMatters={
            <>
              Take-off is not just a one-off exercise at the start of the job. Any change to the
              design triggers a take-off addendum. Customer-driven variations are where small jobs
              lose money — the labour for the variation is easy to quote, but the additional
              materials, the design time, and the rework to fit the new circuit into the existing CU
              are easy to forget.
            </>
          }
        />
        ...
        <Quiz
          title="Selecting materials from drawings — knowledge check"
