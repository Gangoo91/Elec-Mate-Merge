...
const TITLE = 'JIB safe isolation procedures (3.7) | Level 2 Module 4.3.7 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  {
    id: 'lockout-physical',
    question: 'Step 5 of the published JIB procedure (lock and label) requires you to:',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question: 'EAWR Reg 14 (1989) places restrictions on:',
    options: [
  ...
  {
    id: 2,
    question: 'The first step of the JIB 9-step safe isolation procedure is:',
    options: [
  ...
  {
    id: 4,
    question: 'A "proving unit" (e.g. Martindale GVD2, Kewtech KEWPROVE) is used to:',
    options: [
  ...
  {
    id: 7,
    question: 'A "permit to work" interacts with the JIB procedure how?',
    options: [
...
export default function Sub7() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 3 · Subsection 7"
        title="Use JIB safe isolation procedures"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The JIB-mandated 9-step safe isolation procedure, end to end. Every step named, every
          action explained, every gotcha called out. EAWR Reg 12 / 13 / 14, HSE GS38 voltage
          indicators, lockout-tagout kit, and a full worked example on a 3-phase board. The
          procedure that keeps you and the people around you alive.
        </p>
        ...
        >
          <p>The three core EAWR regulations:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 12</strong> — Means of cutting off supply / isolation. Every circuit must
              have an effective means of isolation that is clearly identified, securable, and
              accessible for use.
            </li>
            <li>
              <strong>Reg 13</strong> — Precautions for work on equipment made dead. Adequate
              precautions to prevent inadvertent re-energisation while work is in progress.
            </li>
            <li>
              <strong>Reg 14</strong> — Working on or near live conductors. Prohibited unless three
              conditions are ALL met: unreasonable to make dead AND reasonable to work live AND
              suitable precautions taken.
            </li>
          </ul>
          <p>
            The JIB&rsquo;s 9-step procedure operationalises Reg 13. The HSE&rsquo;s GS38 guidance
            specifies the voltage indicator characteristics. Together these form the recognised
            safe-isolation standard for UK electrical work.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              EAWR Reg 12 is the regulation that requires isolation to be available in the first
              place. The means must be suitable (the right device for the voltage and current
              involved), identified (so the user knows which device isolates which circuit), located
              so it can be reached, and securable (lockable). Modern consumer units satisfy this
              with labelled MCBs and lockable enclosures; older installations sometimes do not, and
              a periodic inspection should flag inadequate isolation provision as a finding.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 13 is the regulation that requires lockout. Once you have made equipment dead, you
              must take "adequate precautions" to prevent it being made live again during the work.
              A switched-off MCB is not adequate precaution by itself — it can be switched back on
              by you, by another worker, by the customer, by a child. Adequate precaution = physical
              lockout (lockout device + padlock + warning notice) OR removal of the fuse and
              retention in your custody. The JIB procedure step 4 implements this directly.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 14 is the regulation that almost prohibits live work. Three conditions must ALL be
              met before live work is permitted: (a) unreasonable to be dead, (b) reasonable to work
              live, AND (c) suitable precautions. For the vast majority of installation work,
              conditions (a) and (b) cannot be met — there is no good reason to leave the equipment
              live, and isolation is always reasonable. Live work is the exception, not the default.
              When in doubt, isolate. When supervisor pressure or programme pressure pushes toward
              live work, you push back and reference Reg 14 — the burden of proof is on the person
              proposing live work, not on the person refusing.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Shrouded probes</strong> — only ~4 mm of bare metal exposed at the tip; the
              rest of the probe is insulated. Reduces shock risk to the user if the test point is
              live.
            </li>
            <li>
              <strong>Current limiting</strong> — the indicator draws minimal current (typically
              &lt;3 mA) so that contact with a live source does not draw a fault current that could
              endanger the user.
            </li>
            <li>
              <strong>Fixed function</strong> — no user-selectable range or function dial. The
              indicator is for voltage detection only, AC and DC, pre-programmed. No way to use it
              incorrectly.
            </li>
            <li>
              <strong>Visible AND audible indication</strong> — LED bar showing voltage level,
              audible buzzer rising in pitch with voltage. Both indicators must work; either one
              alone is insufficient.
            </li>
            <li>
              <strong>No user-replaceable fuses</strong> — internal protection only, replaced by the
              manufacturer or by service. No risk of a blown fuse making the indicator falsely read
              dead.
            </li>
            <li>
              <strong>Self-test function</strong> — proves the indicator&rsquo;s circuit is working
              before you trust its reading. Some indicators self-test automatically; others require
              a button-press test.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              GS38 is the HSE guidance that defines a safe voltage indicator. Every piece of test
              equipment used to prove dead must meet these characteristics — shrouded probes,
              current limited, fixed function, proven before and after use. A multimeter or socket
              tester does not meet these requirements and cannot be used for safe isolation
              verification. Reg 12 of EAWR cross-references "suitable means" which the HSE
              interprets via GS38; using non-compliant test equipment is therefore both an EAWR
              breach and an HSE guidance breach.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Plug a lamp into the suspect circuit; switch MCBs one at a time until the lamp goes
              off.
            </li>
            <li>Use a circuit tracer (sender + receiver) for cables in conduit / trunking.</li>
            <li>
              Talk to the householder about which lights / sockets they think are on which breaker.
            </li>
            <li>
              Document any errors found in the circuit chart and update before completing the work.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Isolation method by device type:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Switch fuse</strong> — operate the switch to OFF, then verify the fuse
              position.
            </li>
            <li>
              <strong>BS 88 / BS 1361 cartridge fuse</strong> — remove the fuse element from the
              carrier.
            </li>
            <li>
              <strong>BS 3036 rewireable fuse (legacy)</strong> — remove the fuse-carrier from the
              holder.
            </li>
            <li>
              <strong>Plug-and-socket isolation</strong> — for portable / appliance work, unplug the
              appliance.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Lockout options by device type:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single-pole MCB</strong> — snap-on plastic lockout clip + small padlock
              through the clip&rsquo;s padlock hole.
            </li>
            <li>
              <strong>RCBO</strong> — same as MCB; same clip type usually fits.
            </li>
            <li>
              <strong>3-pole / 4-pole MCB</strong> — wider lockout clip that covers all poles
              together; or individual clips per pole.
            </li>
            <li>
              <strong>Main switch / isolator</strong> — most have a built-in padlock hole; add the
              padlock + warning notice.
            </li>
            <li>
              <strong>Fused isolator (legacy or industrial)</strong> — fuse element already removed
              at step 4; retain it in your pocket. Fuse-pulling tools available for large fuses.
            </li>
            <li>
              <strong>Plug-and-socket isolation</strong> — for portable / appliance work, lockout
              the plug end if it could be reinserted (lockable plug enclosures available).
            </li>
          </ul>
          <p>
            Warning notice — "CAUTION: Do not switch / Work in progress" with date, time, technician
            name, and contact number. Notice goes on the device / panel face, positioned so anyone
            approaching the device sees it. EAWR Reg 13 requires "adequate precautions" — the
            physical lockout PLUS the visible warning are what "adequate" looks like in practice.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Single-phase test pattern (three tests, all at point of work):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>Three-phase test pattern (ten tests, all at point of work):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            If ANY test shows voltage, STOP. The isolation is incomplete or wrong. Investigate
            before continuing — most likely you isolated the wrong device, or there is back-feed, or
            the cable identification is wrong. Never start work on a circuit where any test reads
            non-zero.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              If the indicator works — step 6 was reliable; the circuit is genuinely dead. Proceed.
            </li>
            <li>
              If the indicator fails — step 6 was unreliable; the circuit may be live. Replace the
              indicator and repeat steps 3, 6 and 7.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Polarity check options:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Continuity test (no power required)</strong> — using an MFT or continuity
              tester, verify continuity from the L terminal at the point of work back to the L
              bus-bar in the CU; same for N and E.
            </li>
            <li>
              <strong>Visual inspection</strong> — confirm conductor colours and terminal markings
              match. Brown / red on L; blue / black on N; green-and-yellow on E.
            </li>
            <li>
              <strong>For socket replacements</strong> — many socket testers (e.g. Martindale ST120)
              can confirm polarity once the supply is restored, but this is verification AFTER work,
              not pre-work polarity check.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The minimum record:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Circuit identifier — e.g. "Way 6, kitchen ring, 32 A RCBO".</li>
            <li>
              Isolation method — "MCB locked off + warning notice" or "fuse removed and retained".
            </li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 3-phase commercial distribution board in a small office. Way 4 on Phase L2 has a
              faulty RCBO that keeps tripping under no apparent fault. The decision is to replace it
              with an identical Hager NDN132A. The DB is a Hager Vega/HE-class 3-phase 18-way,
              supply via a 100 A Type B MCCB from the riser. The faulty RCBO supplies a 32 A radial
              to a small kitchen pantry on the second floor. The job is during business hours on a
              Wednesday morning.
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 — Identify.</strong> Open the DB door. Read the circuit chart. Way 4,
              Phase L2, "Pantry kitchen socket". Confirm with the office manager which kitchen this
              serves. Plug a lamp into a pantry socket; confirm it is on the suspect way by
              switching the way on/off and watching the lamp.
              <br />
              <br />
              <strong>Step 2 — Notify.</strong> Tell the office manager the pantry circuit will be
              off for ~30 minutes. Email the building manager (the building has shared facilities).
              Post a "DO NOT SWITCH — work in progress" notice on the DB door and on the pantry
              door.
              <br />
              <br />
              <strong>Step 3 — Prove the indicator.</strong> Use a Martindale GVD2 proving unit.
              Apply the Kewtech KEWPROVE+2 voltage indicator probes to the proving unit. LED reads
              ~230 V; buzzer sounds at expected pitch. Indicator is working.
              <br />
              <br />
              <strong>Step 4 — Isolate (turn off the device).</strong> Switch off the Hager NDN132A
              on Way 4, L2. The device toggle moves to OFF. Physical disconnection of the circuit
              from the supply is now done; the next step makes that disconnection secure.
              <br />
              <br />
              <strong>Step 5 — Lock and label.</strong> Apply a Hager-compatible MCB lockout clip
              over the toggle. Padlock the clip closed; pocket the key. Apply a fresh warning notice
              with date, time, name, contact number on the DB face next to the locked-off way.
              <br />
              <br />
              <strong>Step 6 — Test for dead at the point of work.</strong> Travel to the pantry.
              Open the back of a pantry socket. Apply the indicator probes to the line and neutral
              terminals; reads 0 V. Apply L-E; reads 0 V. Apply N-E; reads 0 V. All three tests show
              no voltage.
              <br />
              <br />
              <strong>Step 7 — Re-prove the indicator.</strong> Travel back to the DB area (or use a
              portable proving unit at the pantry). Touch the same indicator probes to the GVD2
              proving unit. Reads ~230 V; buzzer sounds. Indicator is still working — step 6 was
              reliable.
              <br />
              <br />
              <strong>Step 8 — Polarity at the point of work.</strong> Continuity check from L
              terminal at the pantry socket back to the L2 bus-bar at the DB. Confirm continuity
              (low resistance reading on MFT). Same for N and E. Polarity confirmed correct.
              <br />
              <br />
              <strong>Step 9 — Record and proceed.</strong> Log the isolation in your day log:
              "10:35 isolated DB Way 4 L2 (Pantry kitchen socket), Hager NDN132A 32 A. Lockout clip
              + padlock + notice. Tested L-N L-E N-E at pantry socket — all 0 V. Indicator:
              KEWPROVE+2 SN12345, cal Aug 2026. Proving unit GVD2 SN67890. Polarity verified. Work
              commences 10:40, expected restoration ~11:10."
              <br />
              <br />
              <strong>Now do the work.</strong> Replace the RCBO. Re-test the terminations. Restore
              supply (remove lockout, switch back on). Re-test downstream functionality. Update the
              log with restoration time and any observations. Tell the office manager the pantry is
              back on.
            </>
          }
          whyItMatters={
            <>
              A 3-phase board has nine possible voltage combinations at any single point in the
              system. A wrong-circuit isolation on a 3-phase board can leave 400 V phase-to-phase
              live at the point of work — instant fatality on contact. The 9-step procedure,
              executed properly, makes this impossible. Skipping or short-cutting any step re-opens
              the failure mode that the step closes. Five minutes of procedure beats a
              coroner&rsquo;s inquiry.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You finish first-fix on a kitchen ring and need to verify isolation before
              terminating. You use the Martindale ST120 socket tester you have in your bag — it
              shows "no voltage detected" on the suspect socket. You start work. Three minutes in,
              you contact a live conductor — the socket tester missed the voltage because it tests
              for socket wiring patterns, not for safe isolation. The socket tester was the wrong
              tool. Best case: an unforgettable shock. Worst case: arc flash, burns, fall from a
              step ladder, fatality.
            </>
          }
          doInstead={
            <>
              Use a GS38-compliant voltage indicator (Martindale VI-13800, Kewtech KEWPROVE, Fluke
              T6-1000) for ALL safe-isolation verification. A socket tester is a wiring verification
              tool — useful for checking that a completed circuit is correctly wired and live, NOT
              for proving dead. A multimeter is a measurement tool — too many user-selectable
              settings, no fixed function, fused leads that can blow undetected. The voltage
              indicator costs ~£100, lasts a decade, and is the only correct instrument for safe
              isolation verification. Buy one. Use it every time.
            </>
          }
        />
