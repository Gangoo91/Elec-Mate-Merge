...
const TITLE = 'Terminate wiring systems (3.5) | Level 2 Module 4.3.5 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question: 'Reg 526.1 (BS 7671) requires every termination to provide:',
    options: [
  ...
  {
    id: 3,
    question: 'A "loop in, loop out" termination at a 13 A socket means:',
    options: [
  ...
  {
    id: 5,
    question: 'Crimped lugs (compression terminations) are typically used for:',
    options: [
  ...
  {
    id: 7,
    question: 'BS 7671 Reg 526.5 requires every termination to be made:',
    options: [
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 3 · Subsection 5"
        title="Terminate wiring systems"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Conductor preparation, strip length, ferrules, torque, crimp lugs, the differences between
          accessory / device / panel terminations. The skill that makes the difference between a
          circuit that works for thirty years and one that fails its first IR test.
        </p>
        ...
        >
          <p>The three requirements drive every termination decision:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Durable electrical continuity</strong> — the joint conducts properly forever.
              Implies clean strip, correct strip length, correct torque, correct terminal type for
              the conductor. A nicked conductor or a loose terminal fails this.
            </li>
            <li>
              <strong>Adequate mechanical strength</strong> — the joint does not pull apart. Implies
              cable supported back from the termination (Reg 522.8.5), proper terminal grip, no
              strain on the connection. A cable hanging from its terminal fails this.
            </li>
            <li>
              <strong>Adequate protection</strong> — the joint is enclosed and the live conductor is
              not exposed. Implies the termination is inside an accessory, an equipment enclosure,
              or a non-combustible enclosure (Reg 526.5). A joint floating in a loft on chocolate
              block fails this.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 526.1 is the headline termination regulation. Read items (a) through (f) — they
              are the design considerations every termination decision must respect. Item (b) covers
              the ferrule-on-flex requirement (fine-stranded CL5/CL6 needs ferrules for cage-clamp
              terminals); item (e) covers the torque-by-spec requirement (over-torque heats the
              terminal in service); item (f) covers vibration applications where spring washers or
              thread-locking compounds may be needed (motor terminations, vehicle electrics).
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 526.5 is the regulation that bans the floating loft join. Every termination in
              live conductors must live inside a suitable accessory (socket back-box, FCU, switch
              enclosure), inside equipment (consumer unit, isolator, switch fuse, motor terminal
              box), OR inside an enclosure made of non-combustible material (a metal JB, a Wago
              Click-Pro maintenance-free connector inside a JB, a fire-rated cement-bound enclosure
              for permanent joints). The era of "twist and tape" or "chocolate block in the loft" is
              long over — these have been 526.5 fails for two decades. Modern equivalent: Wago lever
              blocks inside an Ashley or Hager metal JB.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Outer sheath</strong> on T&E — cut along the seam with a sharp blade (Stanley,
              hooked T&E knife, or proper T&E sheath stripper). Pull the sheath back; never pull the
              conductors out and re-sheath.
            </li>
            <li>
              <strong>Inner insulation</strong> — use a wire stripper sized for the conductor CSA.
              Set the gauge to the manufacturer strip length. Strip without nicking the copper.
            </li>
            <li>
              <strong>Inspect the copper</strong> — bright, undamaged, no missing strands. Any nick
              or missing strand reduces the effective CSA at the termination and is a 526.1 fail.
              Cut back and re-strip.
            </li>
            <li>
              <strong>Ferrule (if applicable)</strong> — slide a ferrule sized for the conductor
              over the strip, crimp with a ferrule-crimper.
            </li>
            <li>
        ...
        >
          <p>
            The cure: a quality wire stripper (automatic or hand-set), the right gauge for the
            conductor, and the discipline to inspect every strip. Cheap "cable knife" type strippers
            are the worst offenders for nicking. A Knipex or Wiha automatic stripper costs ~£40 and
            pays back in zero nicked conductors over its lifetime.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The ferrule sequence:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Strip the flex to ~12 mm (or the ferrule-recommended length, usually printed on the
              ferrule packet).
            </li>
            <li>
              Twist the strands lightly between thumb and finger to gather them into a single
              bundle.
            </li>
            <li>
              Slide the ferrule over the strands — full ferrule length engaged with the conductor.
            </li>
            <li>
              Crimp the ferrule with a ferrule-specific crimping tool (square or hex jaws, sized for
              the ferrule). Tube ferrules need a square crimp; cup ferrules need a specific cup-die.
            </li>
            <li>
              Inspect — the crimped ferrule should be tightly bonded to the conductor with no
              individual strands projecting from the rear collar.
            </li>
            <li>
              Insert ferruled conductor into the cage-clamp terminal, full ferrule length engaged.
            </li>
            <li>Tighten / actuate the terminal per the device manufacturer spec.</li>
          </ul>
          <p>
            Ferrule colours follow IEC 60228 — yellow for 1.0 mm², red for 1.5 mm², blue for 2.5
            mm², grey for 4 mm², black for 6 mm², and so on. The colour matches the conductor CSA so
            you can verify at a glance that the right ferrule went on.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Typical torque ranges (always verify with the data sheet):</p>
          ...
          <ul className="hidden sm:block space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Domestic RCBO circuit terminal</strong> — ~1.0-1.5 Nm.
            </li>
            <li>
              <strong>Consumer-unit incomer / main switch</strong> — ~3.5-4.5 Nm.
            </li>
            <li>
              <strong>Sub-main / 3-phase MCCB terminal</strong> — ~8-12 Nm.
            </li>
            <li>
              <strong>13 A socket terminal (BS 1363)</strong> — ~0.6-0.8 Nm.
            </li>
            <li>
              <strong>Light switch terminal (BS EN 60669)</strong> — ~0.5-0.7 Nm.
            </li>
            <li>
              <strong>M5 / M6 stud termination</strong> — ~3-5 Nm / ~6-9 Nm.
            </li>
          </ul>
          <p>
            Buy a torque screwdriver in the 1-5 Nm range (covers most domestic and light
            commercial); add a 5-25 Nm wrench for heavier work. Get them calibrated annually for
            paid work. Record the torque value on the test certificate where required.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Tooling and calibration essentials:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Range</strong> — 1.0-5.0 Nm covers most domestic and light commercial work.
              Add a 5-25 Nm wrench for incomers, sub-main, MCCB and stud terminations.
            </li>
            <li>
              <strong>Mechanism</strong> — preset (set once, click at value) or adjustable (dial in
              the value, click at value). Preset is faster on repetitive terminations of the same
              value; adjustable is more flexible across mixed work.
            </li>
            <li>
              <strong>Bit holder</strong> — 1/4&quot; hex insert standard. Carry a set of quality
              insulated bits — slot, Pozi, Phillips, Torx — sized for the terminals you are working
              on.
            </li>
            <li>
              <strong>Calibration interval</strong> — annually for paid work is the widely-accepted
              standard (NICEIC and NAPIT both expect this). Industrial / heavy commercial may demand
              6-monthly. Keep the calibration certificate with the tool.
            </li>
            <li>
              <strong>Storage</strong> — torque DIALLED DOWN to lowest setting after use. Storing a
              click driver at high torque overnight loads the internal spring and shifts the
              calibration.
            </li>
            <li>
              <strong>Field check</strong> — periodic spot-check against a calibrated reference
              torque (a beam-style wrench or a calibrated transducer) is good practice between
              formal calibrations. Cheap to do, catches drift early.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The five visible cues:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Conductor fully home</strong> — the strip length matches the terminal depth;
              no insulation pinched in the terminal jaws; no bare copper projecting beyond the
              terminal entry.
            </li>
            <li>
              <strong>Insulation right up to the terminal</strong> — no gap of bare conductor
              exposed between terminal entry and inner sheath / outer sleeve. Gap = shock risk +
              identification fail.
            </li>
            <li>
              <strong>Tug test</strong> — gentle pull on the conductor in the direction it leaves
              the terminal, confirm zero movement. Movement means the strip was wrong (insulation in
              the terminal) or the torque was wrong / set too low. Re-strip and re-torque.
            </li>
            <li>
              <strong>Conductor not crushed</strong> — over-torque is hidden by a screw that visibly
              bites into the conductor through to the underside. If the conductor looks flattened or
              the strands are escaping past the terminal under-surface, the torque was too high. Cut
              back, re-strip, re-torque using the calibrated tool at spec.
            </li>
            <li>
              <strong>Sleeving / colour identification correct</strong> — CPC sleeved green/yellow
              along its full length inside the enclosure (Reg 514.4.2); neutral conductor used as a
              switch line sleeved brown; phase identifiers where required for three-phase. The right
              colour at every termination is part of "durable continuity" because the next person
        ...
        >
          <p>Crimp lug sequence:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Strip the conductor to the lug barrel length (usually printed on the lug).</li>
            <li>
              Slide the lug barrel over the stripped conductor — full barrel engagement, no gap at
              the rear.
            </li>
            <li>Position the lug in the correct hex-die size on the crimper.</li>
            <li>
              Crimp — typically two crimps per lug for larger sizes (one near the rear, one near the
              front of the barrel).
            </li>
            <li>
              Inspect — visible hex shape on the crimped barrel, no projecting strands, no cracks in
              the lug.
            </li>
          ...
          <p>
            For even larger conductors (95 mm² and up) hydraulic crimpers are essential — the manual
            long-arm crimpers cannot generate enough force for a reliable crimp above ~50 mm². Hire
            or buy a battery-electric hydraulic crimper for the job.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You are second-fixing a kitchen rewire. The cooker circuit is 6 mm² T&E running ~12 m
              from a Hager 14-way Design 30 CU to the cooker isolator. The CU device is a Hager
              NDN132A 32 A Type B RCBO Type A. The CU has been installed (back box screwed to wall,
              dual-pole isolator confirmed locked off). The cable is in the CU, ~250 mm of tail at
              the device end.
            </>
          }
          whatToDo={
            <>
              <strong>Step 1.</strong> Confirm safe isolation — incomer locked off, MCB main switch
              locked off, voltage indicator proved against a known supply, tested at the device
              terminal. (Sub 7 details the JIB 9-step procedure.)
              <br />
              <br />
              <strong>Step 2.</strong> Strip the T&E outer sheath back ~150 mm, expose the line,
              neutral and CPC conductors. CPC sleeve with green/yellow PVC sleeving along its full
              length inside the CU (Reg 514.4.2 — colour identification).
              <br />
              <br />
              <strong>Step 3.</strong> Cut the conductors to the right length so they land cleanly
              at the RCBO without strain. Allow ~80 mm spare in the CU bus-bar gutter for future
              rework.
              <br />
              <br />
              <strong>Step 4.</strong> Strip 8 mm of inner insulation off each conductor (Hager spec
              for the NDN132A cage-clamp terminal — verify on the device or the data sheet). Wire
              stripper set to 6 mm² gauge. Inspect each strip — no nicks, no missing strands, bright
              copper.
              <br />
              <br />
              <strong>Step 5.</strong> Insert line into the bottom right terminal of the NDN132A
              (line-circuit-out). Insert neutral into the bottom left terminal
              (neutral-circuit-out). Insert CPC into the earth bar of the CU at a free terminal way.
              <br />
              <br />
              <strong>Step 6.</strong> Torque each terminal to 1.2 Nm using a calibrated torque
              screwdriver (Wera Klick-Plus or equivalent). Confirm "click" on each terminal. NEVER
              over-torque "by feel" — 1.2 Nm is the spec.
              <br />
              <br />
              <strong>Step 7.</strong> Tug-test each conductor — gentle pull on the conductor in the
              direction it leaves the terminal, confirm no movement. A loose conductor on tug-test
              means the strip was wrong (insulation in the terminal) or the torque was wrong.
              Re-strip and re-torque if needed.
              <br />
              <br />
              <strong>Step 8.</strong> Visually inspect — line and neutral fully home in the
              terminals, no bare copper projecting beyond, no insulation pinched under the
              cage-clamp, CPC fully sleeved with green/yellow up to the earth bar terminal.
              <br />
              <br />
              <strong>Step 9.</strong> Snap the RCBO module onto the bus-bar (verify the bus-bar
              comb is positioned correctly and the device clicks home). Confirm the bus-bar links to
              the device line-input terminal.
              <br />
              <br />
              <strong>Step 10.</strong> Record on the test certificate — torque value (1.2 Nm),
              conductor CSA (6 mm²), device (Hager NDN132A 32 A Type A Type B), termination type
              (cage-clamp), date, technician initials.
            </>
          }
          whyItMatters={
            <>
              A bad termination at a CU is the most common single cause of failed periodic
              inspections in domestic installations. The fix is procedural — strip to spec, torque
              to spec, document. Two minutes of discipline per termination beats two hours of
              remedial work in three years. Reg 526.1 says it has to be durable; this sequence is
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You snug the screw down hard, "to make sure it is tight". Stranded copper under the
              terminal crushes flat — effective CSA reduces by 20-30 %. The joint resistance goes
              up. Under load, the local heating goes up. Six months later the terminal is visibly
              discoloured (heat browning), and a thermography survey shows a hot spot at the device.
              The next periodic inspection catches it as a C2 observation; the customer is in the
              works.
            </>
          }
          doInstead={
            <>
              Use a torque screwdriver, set to the manufacturer spec, every time. A Wera Klick-Plus
              1-5 Nm torque screwdriver is ~£80 and lasts a decade. It clicks audibly when the spec
              torque is reached and prevents over-tightening even if you keep going. Record the
              torque value on the test certificate where required (NICEIC and NAPIT both expect this
              on new domestic installations from 2026 onwards). The discipline is small; the
              failure-mode reduction is enormous.
            </>
          }
        />
