...
const TITLE = 'Mark out dimensions from drawings (3.2) | Level 2 Module 4.3.2 | Elec-Mate';
const DESCRIPTION =
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              quick checks on a single accessory. Cumulative error grows fast on leap-frogged
