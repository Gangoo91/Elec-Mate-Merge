...
const TITLE = 'Cable-prep tools deep dive (supplementary) | Level 2 Module 4.1.4 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: [
      'Red — under DIN 46228-4 red is the 2.5 mm² ferrule, the barrel sized to take a 2.5 mm² stranded core and crimp down onto it cleanly.',
      'Blue — under DIN 46228-4, blue is the 2.5 mm² ferrule, sized to take the stranded core and crimp cleanly onto it.',
      'Grey — grey is the 2.5 mm² ferrule in the DIN code, sitting between the black 1.5 mm² and the yellow 6.0 mm² in the sequence.',
      'Black — black is the 2.5 mm² ferrule; it is the most common size on a domestic board so it gets the neutral black colour to match.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It deforms the screw, strands and bus-bar pocket beyond their design envelope, voids the warranty and breaches BS 7671 526.1 — passing test today but degrading to fail a future EICR.',
      'None — more torque always means a tighter, more reliable joint. The published value is a minimum, so exceeding it gives a better connection and there is no downside to going to 4 Nm.',
      'The conductor is held more firmly, which improves continuity, but the extra force shortens the life of the torque driver itself — the consequence is on the tool, not the termination.',
      "It trips the RCBO's internal mechanism — the terminal screws link to the trip linkage, so over-torquing them leaves the device permanently tripped and it must be reset before use.",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A plier crimper is actually preferred because it lets you feel the resistance and judge compression by hand — the ratchet removes that feedback, so an experienced electrician gets a better crimp.',
      'There is no real difference — both squeeze the ferrule onto the strands, so the choice comes down to whichever is in the pouch; the ratchet is just heavier and slower.',
      "A ratchet crimper applies a controlled, repeatable force and won't release until full compression — unlike a plier crimper, which depends on hand strength and can under-crimp.",
      'A ratchet crimper grips the ferrule but leaves it loose enough to slide off again for re-use, whereas a plier crimper permanently deforms it — so the ratchet is chosen mainly to save on ferrules.',
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      "It doesn't — 526.1 only governs the screw torque at the terminal, so the crimp at the conductor end is outside its scope and the choice of crimper is a workmanship preference, not compliance.",
      "Directly — 526.1 needs durable continuity and adequate mechanical strength, which a ratchet crimp delivers consistently but a pliers crimp can't, varying with operator strength.",
      'Only on stranded conductors above 25 mm² — below that size the crimp tool makes no difference to 526.1 because small ferrules carry too little current to loosen, so a plier crimp is fully compliant.',
      'It affects appearance but not compliance — a hand crimp looks untidy but still meets 526.1 because the terminal screw provides all the required mechanical strength once tightened.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A single self-adjusting ratchet crimper — modern self-adjusting tools cover the whole 0.5 to 50 mm² range from one handle, so an apprentice needs only the one crimper for every termination.',
      'Two plier crimpers — a small one for ferrules and a large one for lugs. Plier crimpers flex to suit any size, so two of them span the full range without needing a hydraulic tool.',
      'Three crimpers — a ratchet H-die for ferrules and small lugs (0.5–6 mm²), a hex-die ratchet for compression lugs (10–25 mm²), and a hydraulic for the large stuff (25–240 mm²).',
      'A hydraulic crimper on its own — because it can be set to any pressure, one hydraulic tool with a full die set handles everything from a 0.5 mm² ferrule up to a 50 mm² lug, making smaller crimpers redundant.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'An auto-adjusting wire stripper — the same tool used for individual cores. Set it to the SWA diameter and it removes the outer sheath in one squeeze without touching the armour beneath.',
      'A pair of side cutters — nibble round the sheath in short cuts, then peel it back. The flush blade gives a clean edge and there is no risk of reaching the inner cores.',
      'A junior hacksaw — score right round the sheath with the blade, then snap it off. The fine teeth cut the PVC cleanly and stop short of the steel armour.',
      'A rotary cable stripper — sized to the SWA outer diameter, it runs cleanly around the sheath and exposes the armour without scoring the inner cores, where a knife risks cutting through.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  {
    id: 4,
    question: 'Why does the standard DIN 46228-4 ferrule colour code matter on a panel build?',
    options: [
      'Speed and inspection — colour-coded ferrules let you grab the right size at a glance, and a supervisor can verify the colour matches the conductor CSA across a whole panel instantly.',
      'The colour identifies which phase the conductor belongs to — brown, black and grey ferrules mark L1, L2 and L3, so the colour code is really a phase-identification system rather than a sizing one.',
      "The colour shows the current rating the ferrule can carry — a higher-rated circuit needs a 'hotter' colour, so the code tells the inspector the maximum load each termination is good for.",
      'The colour denotes the insulation voltage rating of the ferrule collar — blue for 230 V, red for 400 V — so the code confirms the ferrule is rated for the circuit it sits on.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The screw has reached the bottom of its thread — the click is the screw head seating against the terminal, confirming the screw is fully home rather than any particular torque figure.',
      "The set torque has been reached — a spring-loaded cam slips at the preset value, giving an audible click that signals 'stop turning'; pushing past it over-torques the connection.",
      'The driver has slipped (cammed out) of the screw head — the click warns you the tip has lost engagement and you should reposition before the screw is damaged.',
      "The tool has reached its maximum capacity and locked out to protect itself — the click means you have exceeded the driver's range and must switch to a larger tool to finish the joint.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It is a sales aid — manufacturers publish a torque value so installers feel the product is precision-engineered; the figure is advisory only, so an experienced electrician can tighten by feel.',
      'The value tells you how much current the terminal can carry — a higher torque rating means a higher-rated terminal, so the published figure is really a current spec dressed up as a torque number.',
      'The terminal is engineered to clamp at a specific force range — too little runs hot, too much cracks the parts — so the published value is the spec, and ignoring it breaches BS 7671 134.1.1.',
      'It sets the warranty period — the torque figure is the manufacturer stating how long the terminal is guaranteed for, so following it extends the warranty rather than affecting joint integrity.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "(1) Twist the stranded core tight by hand. (2) Fold it back on itself to double the thickness. (3) Insert into the terminal. (4) Tighten hard with a manual screwdriver until it won't turn. Folding the strands gives a bigger contact area than any ferrule.",
      '(1) Strip the insulation with a Stanley knife. (2) Tin the strands with solder so they hold together. (3) Insert into the terminal. (4) Tighten by feel. Soldering the end is the tidiest way to stop a stranded core splaying in the screw clamp.',
      '(1) Crop the cable with side cutters. (2) Strip with the same side cutters. (3) Insert the bare strands. (4) Nip the screw up with whatever driver is to hand. A single tool for the whole job keeps things fast on a busy board.',
      "(1) Crop square to length. (2) Auto-strip the insulation without nicking strands. (3) Slip on a grey 4 mm² ferrule and ratchet-crimp. (4) Insert and torque with a preset driver to the maker's value.",
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Directly — the right cable-prep tools deliver the consistent, manufacturer-spec terminations that 'good workmanship' demands; the wrong tools produce work that fails 134.1.1 even if it tests OK.",
      "It doesn't connect at all — 134.1.1 is about the competence of the person, so it is satisfied by the operative holding the right qualification; the tools they use are irrelevant.",
      'Only loosely — 134.1.1 is an aspirational statement with no enforcement behind it, so the toolkit is good practice rather than compliance, and an EICR never checks workmanship against it.',
      "Through materials only — 134.1.1 covers 'proper materials', so it governs the cable and accessories you choose, not the tools you prepare them with; tool selection sits outside it entirely.",
    ],
    correctAnswer: 0,
    explanation:
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 1 · Subsection 1.4 · Supplementary"
        title="Cable-prep tools deep dive"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The precision tools that turn a cable end into a BS 7671 526.1-compliant termination.
          Strippers, cutters, ratchet crimpers, ferrule kits and preset torque drivers — what each
          is for, the DIN 46228-4 colour code, and the typical 1.2–3.5 Nm torque settings on UK
          distribution boards.
        </p>
        ...
        >
          <p>The four-step cable-prep sequence:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Step 1 &mdash; Strip</strong>. Remove the insulation from the conductor
              without nicking the copper. Auto-stripper or preset-jaw stripper for cores; rotary
              cable stripper or knife (sheath only) for outer sheath.
            </li>
            <li>
              <strong>Step 2 &mdash; Ferrule (where appropriate)</strong>. Slip a colour-coded
              bootlace ferrule onto the stripped end and ratchet-crimp it. Strongly preferred for
              stranded conductors entering screw terminals; not used for solid conductors.
            </li>
            <li>
              <strong>Step 3 &mdash; Terminate</strong>. Insert the prepared end into the terminal.
              Conductor or ferrule fully home; no insulation trapped under the screw.
            </li>
            <li>
              <strong>Step 4 &mdash; Torque</strong>. Tighten with a preset torque driver set to the
              manufacturer&apos;s specified value. Click-stop signal means &quot;done&quot;.
            </li>
          </ul>
          <p>
            Each step has a dedicated tool. Use the right one at each step and the termination is
            consistent, repeatable and BS 7671 526.1 / 134.1.1 compliant. Skip the tool or
            substitute the wrong one and the termination becomes operator-dependent &mdash; and
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Three requirements in one sentence. Durable continuity &mdash; the connection has to
              keep working over time, not just on day one. Adequate mechanical strength &mdash; the
              connection has to stay clamped under thermal cycling, vibration and cable pull.
              Protection &mdash; the connection has to be physically safe (no exposed conductor
              outside the terminal). The cable-prep toolkit delivers all three: clean strip
              preserves continuity, correct ferrule + ratchet crimp + torque deliver mechanical
              strength, terminal seating with no insulation trapped delivers protection.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;Good workmanship by competent persons and proper materials shall be used in the
              erection of the electrical installation. Erection methods shall be in accordance with
              this section and with manufacturers&apos; instructions.&quot;
            </>
          }
          meaning={
            <>
              134.1.1 is the umbrella workmanship regulation. Two parts &mdash; (a) good workmanship
              + proper materials, (b) compliance with manufacturers&apos; instructions. The torque
              values published by Hager / Schneider / Wylex / MK ARE manufacturers&apos;
              instructions and ignoring them breaches the second leg of 134.1.1 directly. The
              cable-prep toolkit (preset torque driver, ratchet crimper, ferrule kit) is how 134.1.1
        ...
        >
          ...
          <p>
            Beyond these three: jacket-cutting knives (Stanley with fresh blade) for the outer
            sheath of T+E only &mdash; never for the inner cores. Sub 1.1 covered the basic
            categories; this is the deep dive.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The three crimper families in detail:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ratchet H-die crimper</strong> &mdash; spring-loaded ratchet locks the jaws
              until full compression, then releases. Forms a square or trapezoidal cross-section on
              the ferrule barrel. Range typically 0.25&ndash;6 mm&sup2; (some go to 10 mm&sup2;).
            ...
            <li>
              ...
              bonding tails, battery cables). Range typically 10&ndash;25 mm&sup2;, sometimes up to
              35 mm&sup2;. Tools: Knipex 97 51 19, Cembre HN1, Klauke ES 25.
            </li>
            <li>
              <strong>Hydraulic crimper</strong> &mdash; hand-pumped or battery-electric; delivers
              thousands of newtons of compression force. Range typically 25&ndash;240 mm&sup2;.
              Battery-electric models (Klauke EK 50, Cembre B 1300, Milwaukee M18 Force Logic) are
              now standard for industrial work; hand-pump units are still common for one-off pulls
              or hire-centre kit. The die is removable so the same body handles different lug sizes.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The standard colour code for insulated bootlace ferrules:</p>
            ...
            <table className="hidden sm:table w-full text-left">
              ...
              <tbody className="text-[13.5px] text-white/90">
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">0.25 mm&sup2;</td>
                  <td className="py-1.5">Light blue</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">0.34 mm&sup2;</td>
                  <td className="py-1.5">Turquoise</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">0.5 mm&sup2;</td>
                  <td className="py-1.5">White</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">0.75 mm&sup2;</td>
                  <td className="py-1.5">Grey</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">1.0 mm&sup2;</td>
                  <td className="py-1.5">Red</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">1.5 mm&sup2;</td>
                  <td className="py-1.5">Black</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">2.5 mm&sup2;</td>
                  <td className="py-1.5">Blue</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">4.0 mm&sup2;</td>
                  <td className="py-1.5">Grey (or orange)</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">6.0 mm&sup2;</td>
                  <td className="py-1.5">Yellow</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">10.0 mm&sup2;</td>
                  <td className="py-1.5">Red</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">16.0 mm&sup2;</td>
                  <td className="py-1.5">Blue</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">25.0 mm&sup2;</td>
                  <td className="py-1.5">Yellow</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">35.0 mm&sup2;</td>
                  <td className="py-1.5">Red</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">50.0 mm&sup2;</td>
                  <td className="py-1.5">Blue</td>
                </tr>
              </tbody>
            </table>
          ...
          <p>
            Notice the same colour repeats at different sizes (red 1.0 / 10 / 35; blue 2.5 / 16 /
            50; yellow 6 / 25). The colour-by-size pattern is consistent because of the way the
            standard cycles. The ferrule barrel diameter still differs &mdash; you can&apos;t fit a
            10 mm&sup2; red ferrule onto a 1.0 mm&sup2; conductor, the colour just identifies the
            family.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Typical UK distribution-board terminal torque values (always verify against the
            manufacturer&apos;s install literature for the specific product):
          </p>
          <div className="space-y-3">
            <div className="space-y-2 sm:hidden">
              {[
            ...
            <table className="hidden sm:table w-full text-left">
              ...
              <tbody className="text-[13.5px] text-white/90">
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">Accessory screws (sockets, switches, plates)</td>
                  <td className="py-1.5">1.0&ndash;1.2 Nm</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">RCBO conductor terminals (typical UK domestic)</td>
                  <td className="py-1.5">2.0&ndash;2.5 Nm</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">MCB conductor terminals (typical UK domestic)</td>
                  <td className="py-1.5">2.0&ndash;2.5 Nm</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">Main switch / isolator conductor terminals</td>
                  <td className="py-1.5">3.0&ndash;3.5 Nm</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">Bus-bar set screws (CU phase / neutral bar)</td>
                  <td className="py-1.5">3.0&ndash;3.5 Nm</td>
                </tr>
                <tr className="border-t border-white/[0.06]">
                  <td className="py-1.5 pr-4">SWA gland nut (compression)</td>
                  <td className="py-1.5">Hand-tight + 1/2 turn typical</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p>
            Always verify against the manufacturer&apos;s installation literature. The values above
            are typical for Hager, Schneider, Wylex, MK and Crabtree UK domestic kit. Industrial
            gear (Eaton, ABB, Siemens) sometimes runs higher, particularly on bus-bar terminations.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              Hager RCBO terminal, tightens to torque. Looks fine. But under the screw the strands
              have splayed sideways — the screw caught about 70% of the strands and pinched the rest
              outside the clamp. On test the loop impedance reads OK because the gripped strands are
              enough for steady-state current. Six months later thermal cycling has loosened the
              clamp slightly, the loose strands have oxidised, and the terminal is running hot.
              Eventually fails on the next EICR — &quot;loose connection at outgoing terminal&quot;.
            </>
          }
          doInstead={
            <>
              For ALL stranded conductors entering screw terminals, slip a colour-coded bootlace
              ferrule on (blue for 2.5 mm&sup2;) and ratchet-crimp it. The ferrule converts the fan
              of strands into a single cylindrical end that the screw clamps cleanly across its full
              circumference. Termination is consistent, repeatable, and stays clamped under thermal
              cycling. The 30 seconds the ferrule adds saves a re-attendance call in 18 months.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice tightens the conductor terminal screws on a Hager bus-bar with a standard
              VDE Pozidriv driver, &quot;tight enough to feel firm&quot;. Some terminations end up
              at ~5 Nm (over-torqued, screws stripped), some at ~1.5 Nm (under-torqued, conductors
              loose). Manufacturer&apos;s spec is 3.5 Nm. The CU tests OK on the day but the
              over-torqued screws have damaged the bus-bar pockets and the under-torqued
              terminations run hot. Insurance claim a year later because of a thermal incident
              points back to the install date. BS 7671 134.1.1 (manufacturer&apos;s instructions) is
              now in the witness statement.
            </>
          }
          doInstead={
            <>
              Use a calibrated preset torque driver (Wera Click-Torque or similar) set to the
              manufacturer&apos;s value. Listen for the click and STOP. For UK consumer-unit work,
              two preset drivers (one at 1.2 Nm, one at 2.5 Nm) plus a switchable preset for higher
              values cover almost every termination. Annual UKAS-traceable calibration keeps them
              honest. The cost of the kit is paid back the first time it stops a re-attendance call.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              supervisor has handed you a ferrule kit (DIN 46228-4) and a preset Wera Click-Torque
              set to 2.5 Nm. The conductor strips are all the same length and the cable entry has
              been routed tidily. What&apos;s the per-termination sequence and how do you know
              it&apos;s right?
            </>
          }
          whatToDo={
            <>
              Per-termination sequence: (1) Crop end square with side cutters or T+E shears. (2)
              Auto-strip about 10 mm of insulation off the core (auto-stripper automatically sized).
              (3) Slip a blue 2.5 mm&sup2; bootlace ferrule on; insulation shoulder of the ferrule
              butts up against the core insulation. (4) Ratchet-crimp the ferrule (Knipex 97 53 04
              or similar — squeeze until ratchet releases at bottom of stroke). (5) Insert the
              ferrule into the RCBO terminal until it&apos;s fully home. (6) Tighten with the preset
              Wera at 2.5 Nm — apply firm steady force until you feel/hear the click, STOP. Repeat
              for each of the eight cores. After all eight, tug-test each conductor — none should
          ...
          whyItMatters={
            <>
              ...
              practice. The cable-prep toolkit makes that level of consistency achievable for any
              operative, regardless of hand strength or how tired they are at the end of the shift.
              Without the toolkit, the same eight terminations would be operator-dependent and
              inconsistent &mdash; and that&apos;s where future EICR failures live.
            </>
          }
        />
