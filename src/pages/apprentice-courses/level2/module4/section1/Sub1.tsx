...
const TITLE = 'Hand tools for different tasks (1.1) | Level 2 Module 4.1.1 | Elec-Mate';
const DESCRIPTION =
...
const faqs = [
  {
    question:
      'Do I really need to spend £200+ on Knipex / Wera / Wiha kit, or are budget tools fine?',
    answer:
  ...
  {
    question:
      'Why do some screws on consumer units take Pozidriv and others take Phillips? They look the same.',
    answer:
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 1 · Subsection 1"
        title="Hand tools for different tasks"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The eight categories of hand tool an electrician carries — cutting, forming, stripping,
          terminating, measuring, marking, fixing and cable management. Which one fits which job,
          the brand-realism around what apprentices actually inherit, and how PUWER 1998 frames
          'right tool for the job' as a legal duty.
        </p>
        ...
        >
          <p>
            The eight categories that sit behind almost everything an apprentice does on
            installation work:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cutting</strong> — side cutters, T+E shears, jacket-cutting knife, hacksaw
              (for trunking and conduit), aviation snips (for tray and ducting).
            </li>
            <li>
              <strong>Forming</strong> — combination pliers, long-nose pliers, side-cutter pliers
              (for grip-and-twist tasks).
            </li>
            <li>
              <strong>Stripping</strong> — auto-adjusting strippers, preset-jaw strippers, jacket
              cutters for outer sheath, knife for sheath only.
            </li>
            <li>
              <strong>Terminating</strong> — VDE-insulated screwdrivers (Pozidriv, Phillips,
              slotted, Torx), torque drivers, ratchet crimpers, hex die crimpers for compression
              lugs.
            </li>
            <li>
              <strong>Measuring</strong> — tape measure (5 m / 8 m), scale rule, spirit level
              (torpedo + 600 mm), plumb bob, laser level for longer runs.
            </li>
            <li>
              <strong>Marking</strong> — pencil, chinagraph (waxy marker for dark or oily surfaces),
              scriber for metal, centre punch for drilling pilots.
            </li>
            <li>
              <strong>Fixing</strong> — claw hammer (joist clips, cable clips), club hammer (chasing
              brick / breaking out), bolster (chasing), chisel set.
            </li>
            <li>
              <strong>Cable management</strong> — fish tape (steel or fibreglass), draw rope, cable
              lubricant, pulling grips, cable rollers for heavy SWA.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Reg 4 has three limbs in practice:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Suitability of design</strong> — the tool must be the right type for the job
              (long-nose for forming, side cutters for cutting).
            </li>
            <li>
              <strong>Suitability of condition</strong> — the tool must be in working order, not
              damaged or modified.
            </li>
            <li>
              <strong>Suitability of use</strong> — the tool must be used in the way the
              manufacturer intended (no screwdrivers as chisels, no spanners as hammers, no tin
              snips as can openers).
            </li>
          </ul>
          <p>
            Layered on top of Reg 4 is Reg 5 (maintenance — covered properly in Sub 1.3) and Reg 9
            (training — the supervisor's duty to make sure you know how to use the tool before
            handing it to you). Together they form the everyday backbone of how site work equipment
            is managed.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <p>
                ...
                equipment is used only for operations for which, and under conditions for which, it
                is suitable.&quot;
              </p>
            </>
          }
          meaning={
            <>
              ...
              suitable for. A perfectly good Stanley knife is suitable equipment under Reg 4(1) but
              using it to strip solid copper conductor breaches Reg 4(3) because that&apos;s not
              what the knife is for. Both legs of the Reg are tested at any HSE investigation.
            </>
          }
        ...
        >
          <p>The cutting category breaks into four jobs:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cropping cable runs</strong> — T+E shears (Knipex 95 02 165) for sheathed
              cable; cable cutters (rotary or scissor-style) for SWA and larger cables. Square,
              clean cut without crushing the cores inside.
            </li>
            <li>
              <strong>Trimming conductors</strong> — side cutters (Knipex Cobra or generic 160 mm).
              Flush cut at the screw terminal so no whisker pokes out past the insulation.
            </li>
            <li>
              <strong>Slitting outer sheath</strong> — jacket-cutting knife (CK Dextra, Knipex
              ErgoStrip) OR a Stanley with a fresh blade used carefully along the length of the
              sheath. Apprentices learn the &apos;score and snap&apos; method early — score the
              sheath without going deep enough to touch the cores, then flex it open.
            </li>
            <li>
              <strong>Cutting trunking, conduit, tray</strong> — junior hacksaw (32 TPI blade for
              thin-wall conduit, 24 TPI for trunking and tray). Aviation snips (red / yellow / green
              for left / straight / right) for sheet tray and basket.
            </li>
          </ul>
          <p>
            The single rule that unifies the category — the cutting edge is for cutting, not
            gripping. Side cutters used as pliers will roll the edge in a week. T+E shears used to
            grip a stuck cable end will spring the pivot. Each tool earns its keep doing one job;
            using it for another wastes the tool and breaches PUWER Reg 4(3).
          </p>
        </ConceptBlock>
        ...
        >
          <p>Walk through each:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Combination pliers</strong> (Knipex 03 02 180) — workhorse. Heavy-duty grip on
              the flat jaws for twisting solid conductors, a serrated grip below for round stock, a
              side-cutting edge near the pivot for occasional cutting of soft material. NOT for
              forming small loops (jaws too thick) and not for fine cutting (rough edge).
            </li>
            <li>
              <strong>Long-nose / needle-nose pliers</strong> (Knipex 25 02 160) — slim tapered
              jaws. The forming tool. Wraps a conductor around a screw thread, reaches into a deep
              recess, holds a small terminal nut while you tighten. NOT for cutting (jaws too
              narrow, will spring) and not for heavy gripping.
            </li>
            <li>
              <strong>Side cutters / diagonal cutters</strong> (Knipex 70 02 160) — flat jaw,
              cutting edge. The dedicated cutting tool for individual conductors. Flush-cuts so no
              whisker projects beyond the insulation. NOT for forming, not for gripping.
            </li>
          </ul>
          <p>
            Most apprentices carry the three Knipex (or Wera Kraftform / CK Redline equivalent) as
            the core of their pouch, plus a fourth pair — water pump (slip-joint) pliers for gland
            nuts, locknuts and the occasional pipework fitting on bonding work.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Three families of stripping tool:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Preset-jaw strippers</strong> (Knipex 11 06 160, Klein 11061) — fixed stations
              sized 0.5 / 0.75 / 1.0 / 1.5 / 2.5 / 4.0 mm². Slightly cleaner cut than auto-strippers
              if you&apos;re only working one or two sizes. Common for repeat work like a panel
              build.
            </li>
            <li>
              <strong>Jacket-cutting knives and rotary cable strippers</strong> — for the OUTER
              sheath of T+E, SWA armour, and conduit-type cables. Stanley with a fresh blade is fine
              for the T+E sheath. SWA needs a dedicated armour-cutting tool (covered in Sub 1.4).
            </li>
          </ul>
          <p>
            The general rule: knives are for sheaths, dedicated strippers are for cores. Apprentices
            who default to knives for everything end up with a string of failed terminations — and
            the supervisor signs them off the test schedule until they switch tools.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Three requirements packed into one sentence — durable continuity, mechanical strength,
              protection. The stripping tool affects the second leg directly. A nicked conductor
              doesn&apos;t have full mechanical strength; thermal cycling pulls the stress riser
              apart and continuity fails. The terminal screw can be perfectly tightened and the
              connection can still fail 526.1 because of what happened upstream at the stripping
              stage.
            </>
          }
        ...
        >
          <p>
            The terminating category covers everything that secures a conductor to a piece of
            equipment:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>VDE-insulated screwdrivers</strong> (Wera Kraftform 7-piece, Wiha SoftFinish,
              CK Dextro). Look for the IEC 60900 double-triangle and &quot;1000 V&quot; marking on
              the shaft. Tip types: Pozidriv (PZ1 / PZ2 / PZ3), Phillips (PH1 / PH2), slotted (3.5 /
              5.5 / 6.5 mm), Torx (T15 / T20 / T25 — common on industrial control gear).
            </li>
            <li>
              <strong>Torque screwdrivers</strong> — preset (Wera 7440 Click-Torque, Wiha
              torqueVario) for site work, dial-set for workshop. Apprentices typically inherit a 1.2
              Nm preset for class-2 control equipment and a 3.5 Nm preset for distribution-board
              terminations. Torque tools are covered in detail in Sub 1.4.
            </li>
            <li>
              <strong>Crimpers</strong> — ratchet crimpers for bootlace ferrules and small lugs (red
              1.0 / grey 0.75 / black 1.5 / blue 2.5 / yellow 4 / red 6 mm² ferrules), hex-die
              crimpers for compression lugs above 6 mm², hydraulic crimpers above 50 mm². Sub 1.4
              unpacks the colour codes and dies in detail.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The measuring and marking kit:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Tape measure</strong> — 5 m for short work, 8 m for whole rooms. Stanley
              FatMax or Tajima with a magnetic hook. Always your own (sharing tapes never works).
            </li>
            <li>
              <strong>Spirit levels</strong> — 200 mm torpedo level for back-boxes, 600 mm for
              socket lines, 1.2 m for panel installs. Magnetic base for steelwork is worth the extra
              fiver.
            </li>
            <li>
              <strong>Plumb bob</strong> — for vertical drops where a level can&apos;t reach. Mostly
              replaced by laser cross-line levels on bigger jobs but still a pouch staple.
            </li>
            <li>
              <strong>Pencil</strong> — soft (HB or 2B) for plaster and timber, harder pencil for
              blockwork. Carpenter&apos;s flat pencil holds an edge longer than a round one.
            </li>
            <li>
              <strong>Chinagraph</strong> — waxy marker that writes on dark / oily / dusty surfaces
              where pencil won&apos;t. Standard for marking up trunking covers, panel internals,
              switchgear.
            </li>
            <li>
              <strong>Scriber and centre punch</strong> — scriber for metalwork (back-of-trunking
              marking), centre punch for drilling pilot dimples on steel.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The fixing tools:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Claw hammer</strong> — 16 oz for general work. Cable clips, masonry nails for
              clipping, joist staples. The claw is for pulling crooked nails, not for chasing.
            </li>
            <li>
              <strong>Club hammer (lump hammer)</strong> — 1.1 kg / 2.5 lb. The driving force behind
              the bolster and chisel for chasing. Always paired with a bolster, never used directly
              on plaster.
            </li>
            <li>
              <strong>Bolster</strong> — wide flat blade for chasing brick and lifting back boxes
              out of pre-formed pockets. Always with a hand-guard (the rubber donut around the
              shaft).
            </li>
            <li>
              <strong>Cold chisel set</strong> — narrow chisel for splitting brick on a chase,
              masonry chisel for blockwork. Less used than the bolster but in the toolbox for the
              awkward chases.
            </li>
          </ul>
          <p>
            Modern alternative — the SDS hammer drill on a chiselling setting (covered in Sub 1.2)
            replaces a lot of bolster work. Most apprentices still learn the manual route first
            because the SDS isn&apos;t always to hand and the wrist control you build with a bolster
            transfers to the SDS later.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fish tape</strong> — flat steel tape on a winder (CK MightyRod, Klein flat
              tape) or fibreglass rod set (CK MightyRod PRO, Super Rod CRSGS). Steel for shorter
              runs (10–20 m); fibreglass rods for longer pulls and for runs through conduit where
              the rod has to push as well as pull.
            </li>
            <li>
              <strong>Draw rope</strong> — heavier-duty pull for SWA and bigger cables.
              Polypropylene or pre-spliced nylon, 3 mm or 5 mm diameter, on a winder. Pre-installed
              in a duct as a draw cable for future pulls.
            </li>
            <li>
              <strong>Cable lubricant</strong> — water-based gel (Polywater J, Klein 51010) for
              friction-sensitive runs in conduit. Doesn&apos;t damage PVC insulation. Essential for
              full-fill conduits and tight bends.
            </li>
            <li>
              <strong>Pulling grips / cable socks</strong> — woven steel mesh sleeves that grip a
              cable along its length so you can pull on the cable without pulling on the conductor.
              Standard for SWA and larger flexes where pulling on the conductor risks stretching the
              copper.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice runs out of patience with the auto-stripper, picks up a Stanley knife and
              circumferentially cuts the insulation around a 1.5 mm² conductor. Knife goes 4&ndash;5
              strands deep into the copper. Termination tightens fine. Six months later the
              supervisor is back on the job because a socket on the ring final won&apos;t pass an
              EICR R1+R2 test &mdash; the conductor has fractured at the nick under thermal cycling
              and the ring is now a radial. The whole socket has to come off, the cable end has to
              be re-cropped past the damage, and the customer&apos;s warranty conversation is
              awkward.
            </>
          }
          doInstead={
            <>
              Use auto-strippers (Knipex 12 62 180) or preset-jaw strippers (Knipex 11 06 160) for
              ALL conductor cores. The Stanley is for the OUTER sheath of T+E only, used with the
              &apos;score and snap&apos; method &mdash; score the sheath, never the cores. If you
              must strip a core in an emergency without strippers to hand, circumferential ring-cuts
              with side cutters at the right depth are safer than a knife &mdash; but the right
              answer is &apos;never strip cores with a knife&apos;.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice has a PH2 driver in their pouch and tries to terminate into a Hager RCBO
              (Pozidriv PZ2 terminals). PH2 looks like it fits but the angle is shallower and there
              are no engaging ribs. Half a turn in, the driver cams out and chews the head of the
              screw. Terminal can&apos;t now grip cleanly; either the RCBO has to be replaced
              (£30+), or the supervisor has to extract a damaged screw with mole grips. Either way
              the apprentice has to explain why the firm just lost an hour and a part.
            </>
          }
          doInstead={
            <>
              Carry a Pozidriv set (PZ1, PZ2, PZ3) AND a Phillips set (PH1, PH2) and learn to spot
              the difference at sight. Pozidriv has four extra ribs at 45&deg; to the main cross;
              Phillips has only the cross. UK domestic and commercial DBs (Hager, Schneider, Wylex,
              MK, Crabtree) are almost universally Pozidriv. American gear (Square D US, some Klein
              products) is more often Phillips. Match the tip to the screw and the cam-out problem
              disappears.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              mm&sup2; T+E and says &quot;crack on with the kitchen ring &mdash; eight sockets, run
              already chased, just clip and fit&quot;. You open your tool roll and check what
              you&apos;ve got. What&apos;s essential and what would slow you down if it was missing?
            </>
          }
          whatToDo={
            <>
          ...
          whyItMatters={
            <>
              The first day&apos;s work is what the supervisor uses to gauge how much hand-holding
              you need on the rest of the job. A tidy first kitchen ring with clean cuts, square
              strips, neat terminations and level back boxes earns trust that lets you onto the more
              interesting work earlier. A sloppy job with knife strips and crooked boxes earns
              supervision on every single termination for the next month. The tools you carry are
