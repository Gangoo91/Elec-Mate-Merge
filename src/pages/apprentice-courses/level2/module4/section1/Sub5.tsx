...
const TITLE = 'Test instruments overview (supplementary) | Level 2 Module 4.1.5 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  {
    id: 'mod4-s1-sub5-mft',
    question: "What is a Multifunction Tester (MFT) and what's the apprentice-grade brand realism?",
    options: [
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: "What's the difference between a multimeter and an MFT (Multifunction Tester)?",
    options: [
  ...
  {
    id: 7,
    question: 'Why do most modern test instruments now include data storage and download to PC?',
    options: [
...
const faqs = [
  ...
  {
    question:
      "What's the difference between a Megger and a Fluke MFT — does it matter which one I learn on?",
    answer:
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 1 · Subsection 1.5 · Supplementary"
        title="Test instruments overview"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The family of test instruments an electrician carries — multimeter, MFT, clamp meter,
          proving unit + voltage tester, insulation tester, socket tester. What each does, the GS38
          finger-guard requirement, calibration intervals, and how this primes the LO6 inspect /
          test deep dives in §5 and §6.
        </p>
        ...
        >
          <p>The six test-instrument families:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Multimeter</strong> &mdash; general fault-finding; DC volts, AC volts,
              current, resistance, continuity. Apprentice-grade: Fluke 117, Megger TPT320,
              Martindale MM45.
            </li>
            <li>
              <strong>MFT (Multifunction Tester)</strong> &mdash; BS 7671 verification; continuity
              (R1+R2), IR, loop impedance (Zs / Ze / PFC), RCD time and current, earth electrode
              resistance. Apprentice-grade: Megger MFT1741+, Fluke 1664FC, Kewtech KT64+, Martindale
              ET4500.
            </li>
            <li>
              <strong>Clamp meter</strong> &mdash; non-invasive AC current measurement on energised
              circuits. Apprentice-grade: Fluke 376FC, Megger DCM330, Kewtech KT200.
            </li>
            <li>
              <strong>Voltage tester + proving unit</strong> &mdash; safe isolation (prove tester
              &rarr; test circuit &rarr; prove tester again). Apprentice-grade: Martindale VI-13800
              + GVD2, Drummond DTL10 + Lite, Fluke T130 + PRV240.
            </li>
            <li>
              <strong>Insulation tester</strong> &mdash; standalone 500 V / 1000 V DC IR test (built
              into MFT but standalone units exist for HV work). Apprentice-grade: Megger MIT2500,
              Fluke 1577.
            </li>
            <li>
              <strong>Socket tester</strong> &mdash; first-pass screening of domestic sockets (L-N-E
              presence and approximate polarity). Apprentice-grade: Kewtech KT1717, Martindale
              CP501.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The three GS38 requirements:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Finger guards</strong> &mdash; moulded flange or barrier on the probe body
              that prevents fingers contacting the metal tip during use. Stops accidental
              finger-to-tip contact when reaching into a confined terminal.
            </li>
            <li>
              <strong>Limited exposed metal</strong> &mdash; the conductive tip exposes a maximum of
              4 mm (older GS38 versions specified 2 mm). Limits the chance of accidental shorting
              between probes when working in confined spaces.
            </li>
            <li>
              <strong>Insulated leads + optional fuse</strong> &mdash; the leads themselves are
              insulated and rated for the working voltage (typically 1000 V CAT III / IV). Some sets
              include in-line fuses (HRC, typically 500 mA) that limit fault current if the probes
              do short.
            </li>
          </ul>
          <p>
            Modern Fluke / Megger / Martindale lead sets are GS38-compliant out of the box. If you
            inherit older kit, replace the leads &mdash; they&apos;re not expensive
            (&pound;30&ndash;50 a set) and they&apos;re the difference between a tidy test and a
            hospital trip.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              shaped to guard against inadvertent hand contact with live conductors under test. The
              metal tip should expose no more than 4 mm of conductor. Leads should be adequately
              insulated, colour-coded for polarity where appropriate, and protected against
              mechanical damage. The use of fused leads is recommended where reasonably
              practicable.&quot;
            </>
          }
          meaning={
            <>
              GS38 is HSE guidance, not statute &mdash; but under PUWER Reg 4 (suitability) and EAWR
              Reg 4 (safe systems), test equipment that doesn&apos;t meet GS38 is treated as
              unsuitable for use on energised LV systems. Any incident where non-GS38 leads are
              involved gets the firm a hard time. The cost of GS38-compliant leads is small; the
              cost of a Reg 4 prosecution is not.
            </>
          }
        ...
        >
          <p>Standard ranges on an apprentice-grade multimeter:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>AC volts</strong> &mdash; 0&ndash;600 V or 0&ndash;1000 V auto-ranging. For
              voltage checks at terminals, sockets, switches.
            </li>
            <li>
              <strong>DC volts</strong> &mdash; 0&ndash;600 V or 0&ndash;1000 V auto-ranging. For
              battery checks, control-circuit work.
            </li>
            <li>
              <strong>Resistance / continuity</strong> &mdash; 0&ndash;40 M&Omega; auto-ranging plus
              an audible continuity beep below ~30 &Omega;.
            </li>
            <li>
              <strong>Diode test</strong> &mdash; checks PN junctions, useful for solid-state
              circuits.
            </li>
            <li>
              <strong>Current (where built in)</strong> &mdash; in-line current measurement. Some
              multimeters include current; others rely on a separate clamp meter.
            </li>
          </ul>
          <p>
            CAT rating on the body tells you where in the system it&apos;s safe to use. Fluke 117 is
            CAT III 600 V / CAT IV 300 V &mdash; safe for distribution-board work but NOT at the
            supply origin. For supply-side work you need CAT IV 600 V or higher (Fluke 87V or Megger
            TPT320 CAT IV 600V).
          </p>
        </ConceptBlock>
        ...
        >
          <p>The standard MFT functions:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Continuity (low-resistance ohms)</strong> &mdash; 0&ndash;200 &Omega; range.
              Used for R1+R2 (line + protective conductor end-to-end), R2 (protective conductor
              only), and bonding tail continuity.
            </li>
            <li>
              <strong>Insulation resistance</strong> &mdash; 250 V DC (SELV / control), 500 V DC
              (standard LV), 1000 V DC (over 500 V). Limit typically &gt;&nbsp;1 M&Omega; for new
              installations.
            </li>
            <li>
              <strong>Loop impedance (Zs / Ze / PFC)</strong> &mdash; live test, measures the
              phase-to-earth fault loop impedance and the prospective fault current.
            </li>
            <li>
              <strong>RCD operating time and trip current</strong> &mdash; live test, applies a
              controlled fault current at multiples of the rated trip and measures the operating
              time. Limits: 30 mA RCD must trip within 300 ms at 1&times; In and within 40 ms at
              5&times; In.
            </li>
            <li>
              <strong>Earth electrode resistance</strong> &mdash; for TT systems and earth
              electrodes. Three-wire test at the electrode.
            </li>
          </ul>
          <p>
            All five tests in one instrument. Sub 6.x of this Module unpacks each test in detail
            with procedure, instrument settings, expected results, and the BS 7671 612.x
            cross-reference.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The three-step prove-dead routine:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Prove the tester on the proving unit</strong>. Touch the probes to the
              proving unit&apos;s terminals; the tester should read the proving voltage (typically
              240 V or 110 V AC). Confirms the tester is functioning.
            </li>
            <li>
              <strong>2. Test the circuit</strong>. Touch the probes to the conductors at the point
              of work. Should read 0 V (or below the tester&apos;s threshold). Confirms the circuit
              is dead.
            </li>
            <li>
              <strong>3. Prove the tester on the proving unit again</strong>. Touch the probes to
              the proving unit&apos;s terminals again; should still read the proving voltage.
              Confirms the tester is still functioning &mdash; so the &apos;dead&apos; reading in
              step 2 was real, not a tester fault.
            </li>
          </ul>
          <p>
            Without step 3 you can&apos;t be sure the tester didn&apos;t fail BETWEEN step 1 and
            step 2 &mdash; in which case the &apos;dead&apos; reading in step 2 would be a false
            negative on a live circuit. That&apos;s how electricians get killed. The proving unit
            removes the doubt.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Two important safety notes:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single conductor only</strong> &mdash; the clamp must go around ONE conductor
              (line OR neutral, not both). Clamping around both gives a near-zero reading because
              the magnetic fields cancel.
            </li>
            <li>
              <strong>CAT rating still matters</strong> &mdash; clamping around a 400 V three-phase
              sub-main needs a CAT IV-rated clamp; clamping at a 230 V socket-feeder is CAT III
              territory. Match the rating to the location.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What a socket tester does NOT detect:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Borrowed neutrals</strong> &mdash; where a circuit&apos;s neutral has been
              cross-connected to another circuit&apos;s neutral somewhere upstream.
            </li>
            <li>
              <strong>Reversed polarity at the supply</strong> &mdash; if L and N are swapped at the
              cut-out, the socket tester reads as &apos;wiring correct&apos; because it can&apos;t
              see beyond the consumer unit.
            </li>
            <li>
              <strong>Undersized or shared protective conductors</strong> &mdash; the tester sees
              earth presence but not its size, route or impedance.
            </li>
            <li>
              <strong>High-impedance earths</strong> &mdash; an earth path that exists but is too
              high in impedance to clear a fault in time.
            </li>
            <li>
              <strong>RCD failure to trip in time</strong> &mdash; the tester may have an RCD-trip
              button that confirms the RCD trips, but doesn&apos;t measure the trip TIME against BS
              7671 limits.
            </li>
          </ul>
          <p>
            Use the socket tester as a first sweep. Use the MFT for the actual verification. Sign
            nothing based on a green light alone.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The calibration story:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Interval</strong> &mdash; annual is the universal standard. Some firms shorten
              to 6-monthly for daily-use MFTs.
            </li>
            <li>
              <strong>Provider</strong> &mdash; manufacturer (Megger, Fluke, Kewtech, Martindale all
              offer in-house cal) or third-party UKAS-accredited lab. Cost &pound;40&ndash;80 per
              instrument.
            </li>
            <li>
              <strong>Certificate</strong> &mdash; UKAS-traceable, listing the instrument serial
              number, the tests carried out, the as-found readings, the as-left readings, and the
              next-due date.
            </li>
            <li>
              <strong>Register</strong> &mdash; firm keeps a register of calibrated instruments and
              their next-due dates. NICEIC, NAPIT and ELECSA all check this at scheme audit.
            </li>
            <li>
              <strong>Consequence of out-of-date</strong> &mdash; an EIC issued with results from an
              out-of-date instrument is technically invalid. The firm has to re-test (with a
              calibrated instrument) and reissue.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              that&apos;s actually still live at supply potential. Hopefully an RCD on the circuit
              catches the fault current; not always.
            </>
          }
          doInstead={
            <>
              Use a two-pole voltage tester (Martindale VI-13800, Drummond DTL10, Fluke T130) with
              its associated proving unit. The voltage tester has the right input impedance, the
              right GS38 finger guards, the right insulated leads, and works as a pair with the
              proving unit so you can prove the tester at both ends of the test. Multimeters belong
              in fault-finding, not safe-isolation. Same lesson the senior electrician will teach
              you on day one of testing work.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              Investigation shows a borrowed neutral on one of the ring-final spurs &mdash; socket
              tester didn&apos;t see it, MFT R2 / IR test would have. The cert is technically false;
              the firm faces a NICEIC re-issue and a customer complaint.
            </>
          }
          doInstead={
            <>
              Socket tester for first-pass screening only. Full BS 7671 Chapter 61 verification with
              the MFT &mdash; R1+R2 on every circuit, IR between L-N / L-E / N-E, polarity check at
              every accessory, RCD operating time at every RCD, Zs at the furthest point of every
              circuit. Fill in the test schedule from the MFT readings, not from a green LED. The
              socket tester is a useful screening tool; it&apos;s never the evidence basis for a
              sign-off.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re shadowing the senior electrician on a domestic CU change. The new Hager 6
              kA board is in, terminations are torqued to spec, all circuits are connected. Time to
              verify before energising. The senior electrician lays out their kit on the worktop
              &mdash; Megger MFT1741+ in a hard case, Fluke 376FC clamp meter, Martindale VI-13800
              voltage tester + GVD2 proving unit, Kewtech KT1717 socket tester, Fluke 117
              multimeter. Walks you through which instrument does what at which step.
            </>
          }
          whatToDo={
            <>
              The sequence: (1) Multimeter and voltage tester both used during the safe-isolation
              routine before any test work begins (verify supply isolated, prove via tester +
              proving unit). (2) MFT runs the dead-test sequence on every new circuit &mdash;
              continuity (R1+R2, R2), insulation resistance (L-N, L-E, N-E at 500 V DC), polarity
              check from origin to accessory. (3) Energise the supply. (4) MFT runs the live-test
              sequence &mdash; Ze at the origin, Zs at the furthest point of each circuit, RCD
              operating time at each RCD. (5) Clamp meter checks load currents on each circuit
              during functional testing. (6) Socket tester does a final first-pass sweep on every
              socket as a sanity check. (7) Senior electrician transcribes (or downloads) the
              readings into the EIC test schedule. Six instruments, one verification, fully BS 7671
              Chapter 61 compliant.
            </>
          }
          whyItMatters={
            <>
              The first time you watch a full verification done properly is when the LO6 content of
              this Module makes sense. The instruments in this Sub aren&apos;t academic &mdash;
              they&apos;re the kit you&apos;ll spend a third of your testing career holding. Knowing
              which one does which test BEFORE you get to the procedural Subs in &sect;5 / &sect;6
              means those Subs can dive into procedure without stopping to introduce each tool. This
              Sub is the orientation; the deep dives start after.
            </>
          }
        />
