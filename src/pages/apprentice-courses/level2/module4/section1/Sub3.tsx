...
const TITLE = 'Safety checks used for tools (1.3) | Level 2 Module 4.1.3 | Elec-Mate';
const DESCRIPTION =
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              pre-use checks discharge Reg 4(2) at the same time as PUWER Reg 5 &mdash; one routine,
              two regs covered.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Earth continuity test (Class I tools)</strong> &mdash; checks the path from
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              at scheme audits. Sub 1.5 covers test instruments in detail.
            </li>
          </ul>
          <p>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              switch, label. Ten seconds per tool. The label is one of the six checks, not a
