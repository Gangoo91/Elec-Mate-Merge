...
const TITLE = 'Power tools for different tasks (1.2) | Level 2 Module 4.1.2 | Elec-Mate';
const DESCRIPTION =
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 1 · Subsection 2"
        title="Power tools for different tasks"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The power tools an electrician plugs in or charges — drilling, cutting, grinding, heat and
          specialist. The 110 V vs 230 V vs cordless story on a UK construction site, the
          battery-platform reality, and the PUWER 1998 framework that makes 'right tool, fit for
          purpose, with training' a legal duty.
        </p>
        ...
        >
          <p>The five families and what sits in each:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Drilling</strong> — combi drill (timber, plasterboard, light fixings), hammer
              drill (occasional masonry), SDS-Plus (regular masonry, brick, block), SDS-Max (heavy
              concrete, coring above 50 mm).
            </li>
            <li>
              <strong>Cutting</strong> — reciprocating saw (rough cuts in awkward places), jigsaw
              (curved or controlled cuts in timber and thin metal), oscillating multi-tool (confined
              or finished space cuts), angle grinder (metal cutting — SWA armour, tray, conduit).
            </li>
            <li>
              <strong>Grinding</strong> — angle grinder again (the one tool that does both —
              different disc), bench grinder (workshop only — sharpening hand tools).
            </li>
            <li>
              <strong>Heat</strong> — heat gun (for shrink-wrap on splices, glue-lined heat-shrink,
              removing old paint), gas torch (for soldered joints — niche electrical use, mostly for
              plumbing trades on bonding tails).
            </li>
            <li>
              <strong>Specialist</strong> — cordless impact wrench (tray supports, gland nuts), nail
              gun (occasional joist clipping), pull-press tools for compression lugs (Klauke /
              Cembre), rotary cable strippers for SWA armour (Jokari / Knipex).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The technical setup is straightforward:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Site transformer steps 230 V single phase down to 110 V single phase. Centre tap of
              the secondary winding is earthed.
            </li>
            <li>
              Each &apos;leg&apos; of the 110 V supply sits at &plusmn;55 V to earth. Phase to
              neutral is 110 V; phase to earth is 55 V.
            </li>
            <li>
              Output sockets are BS EN 60309-2 yellow CEEform plugs and sockets &mdash; 16 A 4h or
              32 A 4h depending on the tool current.
            </li>
            <li>
              30 mA RCD protection is fitted at the transformer output. So even if a fault develops,
              the RCD trips inside 40 ms at 5&times; tripping current.
            </li>
          </ul>
          <p>
            The result &mdash; a tool fault that would deliver a fatal shock at 230 V delivers a
            survivable shock at 55 V to earth, AND the RCD trips inside the typical fibrillation
            threshold time. Two layers of protection for the price of a transformer and a couple of
            yellow leads.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              fault, the voltage to earth does not exceed 55 V, which significantly reduces the risk
              of fatal shock.&quot;
            </>
          }
          meaning={
            <>
              HSE guidance is not statute &mdash; it&apos;s a recommendation. But under PUWER Reg 4,
              &apos;suitable equipment&apos; for a construction-site environment is read in light of
              HSE guidance. Using 230 V portable tools on site without a documented risk-assessed
              reason is treated as a Reg 4 breach in any post-incident investigation. Most principal
              contractors enforce 110 V as a contractual site rule under their CDM duties as a
              result.
            </>
          }
        ...
        >
          <p>Walk through the four:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Combi drill</strong> (Makita DHP484, DeWalt DCD796, Milwaukee M18 FUEL)
              &mdash; cordless 18 V, three modes (drill / driver / light hammer). Standard chuck
              takes any twist bit, flat bit, hole saw, screwdriver bit. The everyday tool.
              Apprentices spend 80% of their drilling time on this one.
            </li>
            <li>
              <strong>Dedicated hammer drill</strong> &mdash; 230 V or 110 V corded. Heavier
              percussion than the combi&apos;s hammer mode but still uses a standard chuck.
              Increasingly replaced by cordless SDS-Plus tools.
            </li>
            <li>
              <strong>SDS-Plus rotary hammer</strong> (Makita HR2811, DeWalt D25134K, Bosch GBH
              2-28) &mdash; the masonry workhorse. SDS-Plus shank holds a rotary-hammer bit that
              delivers ~3 J impact energy per blow. Drills 6&ndash;30 mm holes in brick, block,
              concrete. Most also have a rotation-only mode for screwdriving and a hammer-only mode
              for light chiselling. Cordless versions (Makita DHR242, DeWalt DCH273) are now the
              apprentice-friendly default.
            </li>
            <li>
              <strong>SDS-Max</strong> (Hilti TE 70, Makita HR4013C) &mdash; bigger shank, bigger
              impact (~10&ndash;20 J), for through-wall coring above 50 mm and serious concrete
              demolition. Hire-only for most apprentices &mdash; not in the standard van loadout.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The four cutting tools and what each is for:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reciprocating saw / sabre saw</strong> (Milwaukee Super Sawzall, Makita
              JR3070CT) &mdash; powerful straight-line cuts in awkward access. Great for cropping
              joists, cutting through old conduit, demolition cuts. Wood blades, metal blades,
              demolition (bi-metal) blades. Aggressive and not precise &mdash; not for finishing
              cuts.
            </li>
            <li>
              <strong>Jigsaw</strong> (Bosch GST 90 BE, Makita 4329K) &mdash; controlled curved or
              straight cuts in timber and thin metal. Variable speed, orbital cut adjustment.
              Apprentice-friendly &mdash; the first power saw most people learn. Standard for
              cutting back-box apertures in MDF kitchen carcasses, shaping panel cutouts.
            </li>
            <li>
              <strong>Oscillating multi-tool</strong> (Fein MultiMaster, Bosch GOP 30-28) &mdash;
              the precision tool for confined cuts. Plunge cuts into existing plasterboard, scrapes
              out old caulk, cuts back-box apertures into already-finished walls. Low dust, low
              noise. Increasingly the default for second-fix retrofit work.
            </li>
            <li>
              <strong>Angle grinder</strong> (Makita DGA452 cordless, DeWalt DWE4217 corded 115 mm)
              &mdash; metal cutting and grinding. SWA armour, steel conduit, threaded rod, tray and
              basket. The most dangerous tool an electrician uses regularly &mdash; full PPE every
              time, formal training before first use under PUWER Reg 9.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Two tools, narrow use cases:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heat gun</strong> (Makita HG6531CK, DeWalt D26414) &mdash; corded or cordless.
              Variable temperature 50&ndash;650&deg;C. Standard use is shrinking heat-shrink tubing
              over splices and joints, and glue-lined heat-shrink over outdoor or marine cable
              connections. Also useful for softening old PVC tape adhesive when removing.
            </li>
            <li>
              <strong>Gas torch</strong> (MAPP gas or propane, Sievert / Rothenberger pencil torch)
              &mdash; rarely used in pure electrical work. Mostly a plumber&apos;s tool that an
              electrician borrows occasionally for bonding-clamp work where a soldered seal is
              required to old pipework. Hot-work permit required on most commercial sites.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The headline specialist tools an apprentice will meet:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cordless impact wrench</strong> (Makita DTW1002, Milwaukee M18 FUEL High
              Torque) &mdash; high-torque short-burst tool for steelwork. Tray and basket assembly,
              gland nut tightening, threaded-rod fixings, panel chassis bolts.
            </li>
            <li>
              <strong>Hydraulic / battery-electric crimpers</strong> (Klauke EK 50, Cembre B1300)
              &mdash; for compression lugs above 50 mm&sup2; where a hand crimper can&apos;t deliver
              enough force. Hire-only or shared kit on most jobs.
            </li>
            <li>
              <strong>Rotary cable strippers</strong> (Jokari Quadro, Knipex 16 95 02 SBE) &mdash;
              cylindrical strippers for SWA armour and round multicore cables. Saves the
              angle-grinder route for many smaller SWA jobs. Covered in detail in Sub 1.4.
            </li>
            <li>
              <strong>Cordless nail gun</strong> &mdash; less common in pure electrical work; used
              for clipping cable to joists at speed on big jobs.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 4 &mdash; suitability</strong>. The tool must be designed for the job, in
              suitable condition, and used in the manner intended. Same Reg 4 as Sub 1.1 covered for
              hand tools.
            </li>
            <li>
              <strong>Reg 5 &mdash; maintenance</strong>. The tool must be kept in efficient working
              order. Pre-use visual checks, in-service inspection, PAT cycle. The full inspection
              routine sits in Sub 1.3.
            </li>
            <li>
              <strong>Reg 9 &mdash; training</strong>. Every operative must have received adequate
              training before using a piece of work equipment, including the risks involved and the
              precautions. The supervisor handing you an SDS, an angle grinder or a recip saw
              without an induction breaches Reg 9 &mdash; and you have a HASAWA s.7 duty to ASK for
              the training rather than just pick it up.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              received adequate training for purposes of health and safety, including training in
              the methods which may be adopted when using the work equipment, any risks which such
              use may entail and precautions to be taken.&quot;
            </>
          }
          meaning={
            <>
              Reg 9 is the training duty. It binds the employer absolutely &mdash; no
              &quot;reasonably practicable&quot; qualifier. The supervisor must give an operative
              training before handing them a piece of equipment, and must ensure that training
              covers (a) how to use it, (b) what could go wrong, and (c) what to do about it. For
              apprentices this means: don&apos;t pick up an angle grinder, recip saw, SDS or impact
              wrench until someone has walked you through it. If they haven&apos;t, ask &mdash;
              that&apos;s your s.7 duty discharged.
            </>
          }
        ...
        >
          <p>The four UK-dominant 18 V cordless platforms:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Makita LXT (18 V)</strong> &mdash; the most-installed platform in UK domestic
              and small commercial contracting. Wide tool range, reliable batteries (BL1850B 5.0 Ah,
              BL1860B 6.0 Ah). Fits most apprentice budgets.
            </li>
            <li>
              <strong>DeWalt XR (18 V / 20 V Max)</strong> &mdash; equally widespread. The XR
              brushless line is the higher-end option (DCD796 combi, DCH273 SDS). Good battery
              longevity.
            </li>
            <li>
              <strong>Milwaukee M18 (18 V)</strong> &mdash; the Fuel sub-line is the most powerful
              18 V tool family on the market for many categories (M18 FUEL Super Sawzall, M18 FUEL
              High Torque impact wrench). Premium price; popular with industrial and HVAC
              contractors.
            </li>
            <li>
              <strong>Bosch Professional (18 V)</strong> &mdash; the European workhorse. Strong on
              hammer drills (GBH 18V-21) and inspection cameras. Less common in UK domestic;
              standard on large continental contractors.
            </li>
          </ul>
          <p>
            Higher voltage platforms (Makita XGT 40 V, DeWalt FlexVolt 54 V, Milwaukee MX FUEL) are
            beginning to appear for the heaviest-duty work (SDS-Max replacements, breakers, large
            grinders). Not standard for an apprentice but worth knowing the names.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice is standing under a kitchen ceiling with an SDS-Plus loaded with the 25 mm
              masonry bit they used on the brick wall outside. Joist needs a 25 mm hole for the T+E
              run. They put the SDS on rotary mode, lean in, and the bit (designed for pulverising
              masonry, not slicing wood) tears a ragged hole, splinters the joist edge, and binds
              inside the joist. Wrist takes the kickback. The joist is now weaker than it was. The
              supervisor adds a sister joist and the apprentice gets a lecture.
            </>
          }
          doInstead={
            <>
              Walk to the van and pick up the cordless combi with a 25 mm spade bit (or, better, a
              25 mm Forstner bit if you want a clean hole). Combi runs at 1500&ndash;2000 rpm with
              no hammer action &mdash; cuts through the joist in three seconds with a clean round
              hole. SDS is for masonry. Combi is for timber and plasterboard. Match the tool to the
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice arrives on a commercial fit-out with their own personal 230 V combi drill
              and plugs it into a 230 V site socket they&apos;ve found. Site agent walks past, spots
              the blue plug on a tool that should be yellow, and pulls the apprentice off the job
              for the day. Firm has to pay them out for the lost shift, the apprentice has to
              explain to their tutor, and the firm&apos;s relationship with the principal contractor
              takes a hit.
            </>
          }
          doInstead={
            <>
              ...
              don&apos;t-look-stupid move. Most firms keep a 110 V site box for any site work and a
              230 V box for finished-property second-fix.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re second-month into your apprenticeship on a house extension. The supervisor
              needs to run 2.5 mm&sup2; T+E from the kitchen consumer unit out through three
              softwood joists in the new extension to a series of socket positions on the far wall.
              Each joist needs a 25 mm hole for the cable to pass through. You have a Makita
              SDS-Plus loaded with a 25 mm masonry bit (just used on the chimney breast outside) and
              a Makita 18 V combi drill with a 25 mm spade bit and a 25 mm Forstner bit on the
              bench. Which do you reach for, and why does it matter?
            </>
          }
          whatToDo={
            <>
              Combi drill, every time. Joists are softwood; SDS is for masonry. The 25 mm Forstner
              bit gives the cleanest hole (centre point, flat-bottomed cut) which is ideal for cable
              that may sit in the hole long-term. The 25 mm spade bit is faster but rougher. SDS on
              timber tears the joist, weakens the structural member, and kicks back into your wrist.
              Five seconds of forethought saves the joist, your wrist, and the supervisor having to
              explain to the customer why a sister joist is now needed.
            </>
          }
          whyItMatters={
            <>
              ...
              use them the wrong way and you damage the tool, the workpiece or yourself. PUWER Reg 4
              makes &quot;right tool for the substrate&quot; a legal duty, and the fastest way to
              demonstrate competence on a job is to walk to the van for the right tool rather than
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">1.1 Hand tools</div>
          </button>
          <button
