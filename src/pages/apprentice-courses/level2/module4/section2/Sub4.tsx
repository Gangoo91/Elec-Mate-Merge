...
const TITLE = 'Site-type prep deep dive | Level 2 Module 4.2.4 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: "What's a 'construction phase plan' under CDM 2015, and who's responsible for it?",
    options: [
...
const faqs = [
  {
    question:
      "Why does the apprenticeship cover all these site types if I'll only ever work in one?",
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The same wiring system, completely different prep workflow depending on the environment.
          Domestic, commercial, industrial, construction, healthcare and education each have their
          own access, hazard and admin profile.
        </p>
        ...
        >
          <p>The dimensions that change between site types:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Working hours</strong> — daytime, out-of-hours, term-time, holiday, planned
              shutdown.
            </li>
            <li>
            ...
            <li>
              <strong>Documentation chain</strong> — verbal agreement vs RAMS vs construction phase
              plan vs HTM permit.
            </li>
            <li>
              <strong>Coordination requirements</strong> — single homeowner vs principal contractor
              vs facilities team vs clinical estates vs school business manager.
            </li>
            <li>
        ...
        >
          <p>Occupied-domestic prep checklist:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Floor protection from the van to the work area, throughout the work area.</li>
            <li>
              Agreed working hours and rooms in use — written or texted to avoid misunderstanding.
            </li>
            <li>
              Identify all occupants — children, elderly relatives, vulnerable adults, pets. Confirm
              who&apos;s home when.
            </li>
            <li>
              Locate gas isolation, water isolation, fire extinguisher, customer&apos;s phone
              position.
            </li>
            <li>Brief the customer on which areas are no-go during the work and why.</li>
            <li>End-of-day tidy — tools secured, work area cleaned, partial work made safe.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Void-property prep differences:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Key chain of custody — sign in/out with the holder, return at end of shift.</li>
            <li>
              Supply status — meter present? Live? Suspended? Disconnected? Builder&apos;s supply?
            </li>
            <li>Temporary lighting if no power — the property may be unlit during your work.</li>
            <li>
              Lone-working arrangements — check-in / check-out call to the office, mobile signal
              coverage in the property.
            </li>
            <li>Security — windows, doors, ladders left out overnight (don&apos;t).</li>
            <li>
        ...
        >
          <p>Commercial out-of-hours prep:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Sign-in / sign-out arrangements with security or facilities.</li>
            <li>
              Fire-alarm isolation if needed (typically requires a dedicated permit and the
              facilities team&apos;s sign-off — see Sub 5).
            </li>
            <li>Lift access if working above ground floor — lift may be locked out-of-hours.</li>
            <li>Welfare — bring your own water, food, first-aid; toilets may be locked.</li>
            <li>
              Lone-working / two-person rule for circuits over a certain rating, depending on firm
              policy.
            </li>
            <li>
        ...
        >
          <p>Industrial-site prep elements:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>LOTO interface</strong> — your personal lock, the site&apos;s isolation hasps,
              and the multi-lock scissor system that lets multiple operatives all isolate the same
              supply at once.
            </li>
            <li>
              <strong>Production coordination</strong> — work scheduled around scheduled outages,
              often weekend nights or planned annual shutdowns.
            </li>
            <li>
              <strong>ATEX zones</strong> — process plants with combustible vapour, gas, mist or
              dust. Equipment certification required (ATEX 1, 2, 3) and BS EN 60079 installation
              standards apply. Level 2 apprentices wouldn&apos;t be working in zoned areas
              independently but recognising them is basic prep.
            </li>
            <li>
              <strong>Permit-to-work</strong> — most industrial sites use formal permits for hot
              work, confined space, live work and high-energy isolation.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pre-construction information</strong> from the client / principal designer —
              site survey, asbestos register, existing services drawings, ground conditions,
              planning constraints. Available on request before you arrive.
            </li>
            <li>
              <strong>Construction phase plan</strong> from the principal contractor — site rules,
              hazards, welfare, induction process, emergency procedures. Extracts relevant to your
              work are part of induction.
            </li>
            <li>
              <strong>Site induction</strong> per Reg 13(4) — formal first-day briefing. Mandatory
              for everyone on site, including visitors.
            </li>
            <li>
            ...
            <li>
              <strong>Permit-to-work</strong> — for hot work, confined space, live work, work near
              overhead lines. See Sub 5.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Permit-to-work</strong> — formal hospital permit for any switching, signed by
              AP and accepted by the operative.
            </li>
            <li>
              <strong>Clinical coordination</strong> — agreed outage window with the ward /
              department affected, often involving moving patients or rescheduling procedures.
            </li>
            <li>
            ...
            <li>
              <strong>Infection control</strong> — clean-down protocols for tools, dust control in
              clinical areas, sometimes specific PPE (scrubs, hair covers).
            </li>
            <li>
        ...
        >
          <p>Education-sector prep elements:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DBS check</strong> — Disclosure and Barring Service check on all operatives
              where unsupervised contact with pupils is foreseeable. Most school contracts require
              enhanced DBS for all on-site staff.
            </li>
            <li>
            ...
            <li>
              <strong>Sign-in / visitor pass</strong> — most schools use a visitor pass lanyard,
              sometimes with photo. You wear it at all times.
            </li>
            <li>
              <strong>Fire alarm coordination</strong> — schools have multi-zone alarms; any work
              near a detector head or in a roof void requires coordination with the facilities team.
            </li>
            <li>
              <strong>School calendar awareness</strong> — exam periods (deep-quiet zones),
              parents&apos; evenings, school events all affect when work can be noisy or disruptive.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              board. Treats it like a commercial job — turns up, finds the supply, isolates at the
              local DB, gets to work. What he doesn&apos;t know is that the DB feeds two clinic
              rooms with mid-procedure equipment, and the clinic staff have no advance warning that
              the supply is going down. Procedures are interrupted, equipment has to be reset, the
              trust raises a serious incident report, the firm loses the contract.
            </>
          }
          doInstead={
            <>
              On any hospital site the rule is &quot;authorise before you isolate&quot;. The
              Authorised Person is the only person who signs off the switching. The clinical team is
              briefed in advance and confirms when the outage is acceptable. A permit is raised,
              accepted by you, and the work proceeds within the permit window. Yes, this takes
              longer than a domestic isolation. The longer prep is what separates hospital work from
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice arrives at a fit-out site to drop off a roll of cable for the next day.
              Sign-in is busy, induction is half an hour, and the apprentice decides he can drop the
              cable off and leave without going through the induction. While he&apos;s on site he
              uses the toilet, walks across an unprotected slab edge, and is stopped by the
              principal contractor&apos;s safety officer. Apprentice is sent off site, the firm gets
              a non-conformance notice, and the principal contractor logs a near-miss against the
              firm&apos;s safety record.
            </>
          }
          doInstead={
            <>
              On a CDM site, no induction = no work. Even a five-minute drop-off counts as being on
              site, and the induction is the formal mechanism for being inside the site H&amp;S
              system. If you genuinely don&apos;t have time, leave the cable in the office reception
              and arrange for a site-inducted operative to collect it. The induction is the cost of
              admission, not optional.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re asked to install a 32A radial circuit for a new piece of equipment. Day 1
              — domestic kitchen, customer at home. Day 2 — open-plan office, occupied during the
              day, work has to happen out-of-hours. Day 3 — outpatient clinic at the local hospital,
              clinic operates 9am-5pm Monday-Friday. The technical install is identical &mdash; what
              changes?
            </>
          }
          whatToDo={
            <>
              <strong>Day 1 (domestic)</strong> — walk-round on arrival, brief the customer on which
              areas will be affected, dust sheet the route, agree working hours, watch for
              children/pets, end-of-day tidy. Single homeowner, single point of contact, informal
              documentation. <strong>Day 2 (commercial out-of-hours)</strong> — arrive at agreed
              time (typically 6pm-7am), sign in with security, set up temporary lighting and
              welfare, work through the night, fire-alarm coordination if working near detectors,
              formal hand-back at end of shift listing what&apos;s done and what&apos;s left
              isolated, area cleaned and ready for trading by 7am.
              <strong>Day 3 (hospital outpatient)</strong> — coordinate weeks in advance with
              clinical estates and the clinic manager, agree an outage window (typically Saturday
              morning when the clinic is closed), Authorised Person raises a permit- to-work, you
              accept the permit, isolate within the permitted scope only, work within the time
              window, hand back to the AP at the end with formal sign-off. Three identical circuits,
              three completely different prep workflows.
            </>
          }
          whyItMatters={
            <>
              The technical install transfers; the workflow doesn&apos;t. Recognising the difference
              and adapting your prep accordingly is what makes you employable across site types.
              Apprentices who don&apos;t adapt &mdash; who try to apply domestic prep to a
              commercial site or commercial prep to a hospital &mdash; cause disruption, lose the
              firm&apos;s contracts and damage their own progression.
            </>
          }
        />
