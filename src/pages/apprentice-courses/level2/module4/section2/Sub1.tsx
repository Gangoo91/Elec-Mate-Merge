...
const TITLE = 'Identifying hazards in the workspace (2.1) | Level 2 Module 4.2.1 | Elec-Mate';
const DESCRIPTION =
  ...
  return (
    <HubPage>
      ...
      <HubBody>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              separately in Sub 3 (access equipment) but flagged here because the walk-round is when
              you decide what access kit to bring.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              they form an extraneous-conductive-part (covered in Module 4 Section 4 on bonding).
        ...
        >
          <p>Sub 5 of this section covers RAMS in detail. The points to keep in mind here:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
