...
const checks = [
  {
    ...
    options: [
      ...
      'Risk Acceptance Management System.',
      'Recognised Approved Method Statement.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'You just need a verbal OK from the customer.',
      'You can do live work as long as you wear gloves.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Using a template at all is forbidden.',
  ...
  },
  {
    ...
    options: [
      ...
      'Toolbox talks are about toolboxes only.',
      'Formal training is shorter.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Drilling a hole in plasterboard.',
      ...
      'Replacing a 13A plug.',
      'Installing a single light fitting in a domestic kitchen.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Anywhere narrower than 1m.',
      'Any place where you can\'t hear the radio.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'There is no chain — each document stands alone.',
      ...
      'Just the permit matters.',
      'Just the RAMS matters.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'No role — you just do as you\'re told.',
      ...
      'Sign the documents but ignore the content.',
      'Refuse to attend any briefings.',
    ],
    correctAnswer: 1,
    explanation:
