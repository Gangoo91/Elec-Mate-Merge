...
const TITLE = 'RAMS, toolbox talks, permits | Level 2 Module 4.2.5 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    question: "What does RAMS stand for and what's the difference between the two halves?",
    options: [
  ...
  },
  {
    ...
    question: "What's a toolbox talk and what's it FOR?",
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question: "What's the role of the RAMS document on a typical electrical install?",
    options: [
  ...
  {
    id: 3,
    question: 'How is a toolbox talk different from a formal training course?',
    options: [
  ...
  {
    id: 4,
    question: 'Which of these activities typically requires a permit-to-work in addition to RAMS?',
    options: [
  ...
  {
    id: 5,
    question: "What's typically on a hot-work permit?",
    options: [
  ...
  {
    id: 7,
    question: "What's the documentation chain from pre-construction to permit?",
    options: [
  ...
  {
    id: 8,
    question: "As an apprentice, what's your role in the RAMS / toolbox / permit chain?",
    options: [
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 2 · Subsection 5"
        title="RAMS, toolbox talks, permit-to-work"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The documentation chain that wraps the work. RAMS sets the strategy, toolbox talks brief
          the shift, permits authorise the higher-risk activities. How the apprentice fits into each
          link of the chain.
        </p>
        ...
        >
          <p>The chain runs in this order:</p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pre-construction information</strong> — site conditions, existing hazards,
              asbestos register, services drawings, ground conditions. Provided by the client /
              principal designer to anyone bidding for or working on the project.
            </li>
            <li>
            ...
            <li>
              <strong>RAMS</strong> — risk assessment + method statement for each work package.
              Owned by the contractor doing the work.
            </li>
            <li>
            ...
            <li>
              ...
              activities (hot work, confined space, live work). Time-bounded, signed in and signed
              out.
            </li>
            <li>
        ...
        >
          <p>What a good RAMS includes:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Project / site identification</strong> — address, contract reference, client,
              dates.
            </li>
            <li>
            ...
            <li>
              <strong>Hazards identified</strong> — from the walk-round, the pre-construction info,
              the trade experience.
            </li>
            <li>
              <strong>Risk evaluation</strong> — likelihood and consequence rating, often via a 5x5
              matrix.
            </li>
            <li>
              <strong>Control measures</strong> — for each hazard, the controls applied in hierarchy
              order (eliminate, substitute, engineering, admin, PPE).
            </li>
            <li>
              <strong>Method statement</strong> — step-by-step procedure for doing the work safely.
            </li>
            <li>
              <strong>Operatives</strong> — who&apos;s involved, their competence, their training
              records.
            </li>
            <li>
            ...
            <li>
              <strong>Sign-off</strong> — author, reviewer, operatives confirming they&apos;ve read
              and understood.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                ...
                conduct by him of his undertaking&hellip;&quot;
              </p>
              <p>
                ...
                source, adapt the work to the individual, adapt to technical progress, replace the
                dangerous with the less dangerous, develop a coherent overall prevention policy,
          ...
          meaning={
            <>
              Reg 3 mandates the assessment; Reg 4 mandates that the controls follow the hierarchy
              in Schedule 1. The RAMS is how the firm demonstrates compliance with both. A risk
              assessment that doesn&apos;t apply the principles of prevention isn&apos;t
              &apos;suitable and sufficient&apos; under Reg 3 even though it exists.
            </>
          }
        ...
        >
          <p>Effective toolbox-talk topics for an electrical team:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Safe isolation procedure refresh — particularly after any near-miss elsewhere in the
              firm.
            </li>
            <li>Working-at-height kit selection on today&apos;s job.</li>
            <li>A specific tool — proper use, common faults, when to take it out of service.</li>
            <li>A recent industry incident — what happened, what we&apos;d do differently.</li>
            <li>Manual handling for the day&apos;s deliveries (cable drums, switchgear).</li>
            <li>Asbestos awareness refresher when working in pre-2000 buildings.</li>
            <li>Fire-safety procedures specific to the site.</li>
            <li>
              Mental health / wellbeing topics — increasingly part of construction site culture.
            </li>
          </ul>
          <p>
            The HSE leaflet INDG259 (Toolbox talks: a step-by-step guide) is the established
            guidance. Free template content is also widely available from PASMA, IPAF, JIB and the
        ...
        >
          <p>The three permits an electrical apprentice is most likely to encounter:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Hot-work permit</strong> — for any work involving open flame, sparks or high
              heat (gas torch on copper bonding, grinding, welding). Required on commercial premises
              and increasingly on domestic insurance-driven contracts.
            </li>
            <li>
              <strong>Confined-space permit</strong> — required by the Confined Spaces Regulations
              1997 for entry to a confined space. Includes atmospheric monitoring, rescue
              arrangements, communication.
            </li>
            <li>
              <strong>Live-work permit</strong> — required by EAWR 1989 Reg 14 for any work on or
              near live conductors. Must demonstrate that all three Reg 14 conditions are met
              (unreasonable to do dead, reasonable to do live, suitable precautions).
            </li>
          </ul>
          <p>
            On industrial and healthcare sites you&apos;ll also see permits-to-isolate (formal
            isolation authorisation), permits for high-voltage switching, and access permits for
            restricted areas.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Hot-work permit minimum content:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Location and specific activity.</li>
            <li>Operative names and competence.</li>
            <li>Permit start time and end time.</li>
            <li>
              Precautions: combustibles cleared (typically 11m radius for welding, less for light
              torch work), fire blanket and extinguisher within arm&apos;s reach, fire detection
              isolation if needed (with separate sub-permit).
            </li>
            <li>Fire watch arrangements: who, for how long after work ceases.</li>
            <li>Sign-on by issuer + operative.</li>
            <li>Sign-off by operative + fire watch on completion.</li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 14 makes live work the explicit exception. ALL THREE limbs (a) (b) (c) have to be
              satisfied — it has to be unreasonable to make the conductor dead AND reasonable to
              work on it live AND suitable precautions in place. The permit-to- work is how the firm
              demonstrates that all three have been considered. Without a permit, any live work is
              prima facie a Reg 14 breach.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                <strong>Reg 4(1)</strong> — &quot;No person at work shall enter a confined space to
                carry out work for any purpose unless it is not reasonably practicable to achieve
                that purpose without such entry.&quot;
              </p>
              <p>
                <strong>Reg 5(1)</strong> — &quot;Without prejudice to regulation 4, so far as is
                reasonably practicable, no person at work shall enter or carry out any work in or
                (other than as a result of an emergency) leave a confined space otherwise than in
                accordance with a system of work which, in relation to any relevant specified risks,
                renders that work safe and without risks to health.&quot;
              </p>
            </>
          }
          meaning={
            <>
              ...
              without entering — the &apos;don&apos;t enter if you can avoid it&apos; rule. Reg 5
              requires a safe system of work for entry where it can&apos;t be avoided — in practice
              this means an entry permit, atmospheric monitoring, communications, and rescue
              arrangements. Reg 5(1) also requires emergency exit arrangements. Failures here have
              killed multiple electricians on industrial and infrastructure sites.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice is given a template RAMS by the office for a domestic CU change. Same
              template the firm uses for every CU change. Fills in the address and the date,
              doesn&apos;t change anything else, signs it. On site the property turns out to be a
              1930s end-terrace with a TT earthing system, a meter that&apos;s 60 years old, a
              cellar with a textured ceiling, and three children present. None of this is in the
              RAMS. After-incident audit finds the RAMS was a copy of the previous customer&apos;s
              document with the address swapped. HSE inspector treats it as evidence the assessment
              wasn&apos;t suitable and sufficient under MHSWR Reg 3. Firm gets a notice; supervisor
              gets a personal interview under caution.
            </>
          }
          doInstead={
            <>
              Templates are fine as a starting point but they have to be tailored. Walk the site,
              identify the specific hazards that aren&apos;t in the template, add them to the
              document with the controls. If the conditions on site differ materially from the
              template, stop and have the RAMS revised before work starts. The five minutes spent
              tailoring is what turns the document from prosecution evidence into defence evidence.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              we&apos;ll be done in five minutes&quot;. No permit. Apprentice watches and learns the
              wrong lesson. A slip with a probe causes a phase-to-phase arc fault, melted copper
              sprays the operative&apos;s face, eye injury, partial vision loss. Investigation
              finds: no permit (EAWR Reg 14 breach), no PPE for live work (PPE Regs Reg 4 breach),
              no honest answer to whether the work could have been done dead (it could). HSE
              prosecution follows; insurance claim from the apprentice for the witnessed trauma;
              firm loses the contract.
            </>
          }
          doInstead={
            <>
              Live work is the exception, not the rule. EAWR Reg 14 requires a documented
              justification. The permit-to-work is the standard mechanism for that justification. No
              permit = no live work, full stop. The apprentice should also refuse to be in the area
              during unauthorised live work — HASAWA s.7 makes that a personal duty. Speak up before
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re second-year on a commercial maintenance contract. The site manager at a
              busy gastropub asks you to add a soldered earth bond on a copper cold-water pipe in
              the kitchen during opening hours. The kitchen is full of staff prepping for service,
              the gas hobs are on, oil is heating in fryers, towels and aprons are everywhere, and
              the customer wants the work done in the next hour. What permits, toolbox talks and
              RAMS are needed before this can proceed?
            </>
          }
          whatToDo={
            <>
              Stop. This work cannot proceed in this environment under these conditions. The
              soldered joint requires a gas torch (hot work) in an environment full of combustibles
              (oils, towels, paper) with multiple ignition sources already present. Required
              documentation chain before any work can start: <strong>RAMS</strong>— site-specific
              risk assessment identifying the kitchen environment, the combustibles, the staff
              present, the gas isolation route, the alternative methods (clamp-on bonding clamp
              instead of solder eliminates the hot work entirely). <strong>Toolbox talk</strong> —
              pre-shift briefing on the specific fire risks of hot work in food-prep environments,
              the fire-watch requirement, and the agreed precautions.{' '}
              <strong>Hot-work permit</strong> — issued by the site manager / duty fire warden,
              listing the time window (preferably outside opening hours), the precautions (kitchen
              cleared of combustibles in working radius, fryers off, fire blanket/extinguisher to
              hand, fire watch for 60 minutes post-work), and the fire-detection isolation if needed
              (with separate sub- permit). <strong>Realistic outcome</strong> — the right answer is
              to substitute a clamp-on bonding clamp for the soldered joint (eliminate the hot work
              entirely), or to reschedule the work to outside opening hours when the kitchen is
              empty. Trying to do this during a busy service with paying diners in the premises is
              the textbook prosecutable failure.
            </>
          }
          whyItMatters={
            <>
              Customer pressure to do work in the wrong window, in the wrong way, with the wrong
              precautions, is the most common cause of preventable incidents in commercial
              maintenance. The documentation chain — RAMS, toolbox talk, permit &mdash; isn&apos;t
              bureaucracy; it&apos;s the structured pause that gives you the time and the standing
              to push back on the unreasonable request. As an apprentice your role is to flag the
              absence of any link in the chain to your supervisor &mdash; HASAWA s.7 makes that a
              personal duty.
            </>
          }
        />
