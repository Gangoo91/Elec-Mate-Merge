...
const TITLE = 'Statutory legislation and guidance (2.1) | Level 2 Module 5.2.1 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: [
      ...
      "Yes — BS 7671 is itself an Act of Parliament, passed in 2018 and amended in 2022, which is why it's called 'the Wiring Regulations'. Breaching any regulation in it is a criminal offence prosecuted directly by the HSE, the same way EAWR 1989 is enforced. The 'Regulations' in the title is the legal giveaway — only law gets called Regulations, so anything titled that way is binding statute you can be fined for breaking.",
      'Only on commercial and industrial sites. BS 7671 is legally binding the moment the installation is in a workplace, because the Electricity at Work Regulations 1989 incorporate the standard by reference into Reg 4. In a private dwelling, though, BS 7671 has no legal force at all — domestic work is entirely unregulated, which is why homeowners are allowed to do their own wiring without any certification or notification.',
      'Yes, but only the parts dealing with earthing and bonding. Those sections were given statutory force by the Building Act 1984, while the rest of BS 7671 — cable sizing, protective device selection, inspection and testing — remains pure guidance with no legal weight. A court can only enforce the earthing chapters; everything else is advisory and a departure from it carries no consequence in law.',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'There is no real difference — both a statutory regulation and an ACoP are passed by Parliament and carry identical criminal penalties. The HSE uses the two labels interchangeably depending on which department drafted the document, and a court treats a departure from either one exactly the same way, with the same fines and the same burden of proof falling on the prosecution to show fault.',
      ...
      "An ACoP outranks a statutory regulation, because 'Approved' means it has been signed off by a Minister, whereas a regulation is only secondary legislation made by a civil servant. Where the two conflict, the court follows the ACoP and disregards the regulation, and an inspector will always prosecute on the ACoP first because it carries the heavier maximum penalty of the two documents.",
      'A statutory regulation only applies to employers, while an ACoP only applies to employees — the two documents split the workforce between them. So an employer can never breach an ACoP and an employee can never breach a statutory regulation; each side of the workforce is judged exclusively against its own document and never against the other.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Your firm's internal job-pack notes and the method statement for this job — these are the documents the firm has approved for use, so they are the authoritative source for what the regulations require. If the RAMS doesn't mention the regulation, you can treat it as not applying to this job, because anything genuinely required would have been written into the paperwork before you started.",
      'A general internet search and the top trade-forum threads that come up — practising electricians answer these questions every day, so the consensus on the forums is the most current and reliable statement of what a regulation says. Forum answers are written by people doing the actual work, which makes them more authoritative than the official text, which is often years out of date.',
      ...
      "The On-Site Guide and whichever edition of BS 7671 you were trained on at college — the edition you learned is the one that applies to you personally for the rest of your career, because that's the standard you were assessed against. Buying a newer copy isn't necessary, since amendments only bind electricians who qualified after they were published, not those already in the trade.",
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      "The Electricity at Work Regulations 1989 (EAWR). As the regulation that deals specifically with electrical safety, it is the parent document that every other UK health and safety law is made under — HASAWA, CDM and COSHH all derive their authority from EAWR's enabling powers, which is why electrical safety sits at the top of the H&S hierarchy.",
      ...
      'The Management of Health and Safety at Work Regulations 1999 (MHSWR). Because it requires the risk assessment that every other safety duty depends on, it is treated as the umbrella document, and the HSE charges a breach of MHSWR Reg 3 in place of HASAWA in almost every modern prosecution, having effectively replaced the 1974 Act.',
      "The Construction (Design and Management) Regulations 2015 (CDM). Since nearly all electrical installation happens on construction projects, CDM is the overarching framework, and the duties it places on clients, designers and contractors are the source from which HASAWA's employer and employee duties were later copied across into the wider workplace.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A Statutory Instrument is the older, weaker form of the two — it can only be enforced by a civil claim for damages in the County Court. A British Standard is the more powerful document because the HSE prosecutes breaches of it directly in the criminal courts. So in practice you should worry far more about a BS 7671 departure than an EAWR breach, since only the standard carries the criminal sanction.',
      'There is no legal difference — a Statutory Instrument and a British Standard are simply two names for the same thing, published by the same body. Both are voluntary, both are advisory, and a court treats a departure from either as equally serious. The choice of which name to use depends only on whether the document covers electrical work or general workplace safety.',
      ...
      'A Statutory Instrument applies only to new installations, while a British Standard applies only to existing ones being inspected. The two never overlap, so on any given job you follow one or the other but never both — a new install is judged purely against the SI and an EICR purely against the BS, with the courts keeping the two regimes entirely separate.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'British Standard BS 7671 (the IET Wiring Regulations). As the document that sets out cable sizing, protective devices and inspection and testing, it is the legal instrument that governs all electrical work in the UK, and the HSE enforces it directly as the primary electrical safety law in every workplace.',
      'The Building Regulations 2010 Approved Document P. Because it deals with electrical safety in buildings, it is the regulation covering the design, construction, operation and maintenance of all electrical systems in the UK, applying equally to dwellings, commercial premises and industrial installations.',
      'The Electrical Safety, Quality and Continuity Regulations 2002 (ESQCR). As the SI that deals with electricity supply, it governs the whole electrical landscape from the generator to the final socket, covering the design, construction, operation and maintenance of every electrical system on both sides of the meter.',
  ...
  },
  {
    ...
    options: [
      ...
      'It requires every electrical installation in every type of building — domestic, commercial, industrial and agricultural — to be inspected and certified by a registered competent person before it can be energised. Part P is the universal certification regime that sits above BS 7671 and applies wherever a fixed installation is being worked on, not just in dwellings.',
      'It bans any DIY electrical work in the home outright, making it a criminal offence for a homeowner to change so much as a socket front or a light fitting. All electrical work in a dwelling, however minor, must be carried out by a scheme-registered electrician under Part P, with no exceptions for non-notifiable jobs.',
      'It sets the specific technical values an installer must meet — maximum Zs figures, RCD trip times, minimum insulation resistance and disconnection times. Part P is essentially a condensed rulebook of test thresholds that replaces the need to consult BS 7671, giving Building Control a single set of numbers to check a dwelling installation against.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      "HSG107 — 'Maintaining portable electric equipment in low-risk environments'. It's the HSE guidance that sets the standard for test leads and probes, specifying finger barriers, the maximum length of exposed metal tip, and when fused leads are needed. An inspector treats HSG107 as the benchmark for whether your test equipment is safe to use in the field.",
      ...
      "HSR25 — the HSE's memorandum of guidance on the Electricity at Work Regulations. As the document that explains EAWR in practice, it is also where the detailed specification for probes, leads and voltage indicators lives, telling you the maximum exposed metal length and when a fused lead is required.",
      'BS EN 61010 — the product standard the instruments themselves are manufactured to. Because it defines the CAT III / CAT IV measurement categories printed on a tester, it is also the reference an HSE inspector uses to judge whether your probes and leads are safe, including the permitted length of bare metal at the probe tip.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 6,
    question: 'What is RIDDOR 2013 and what does it require an electrical contractor to do?',
    options: [
      'Risk Identification and Dangerous Defect Outcome Reporting 2013. It requires an electrical contractor to log every dangerous defect found during inspection and testing — C1 and C2 codes on an EICR — and submit the report to Building Control within 28 days, so that a register of unsafe installations can be maintained nationally.',
      "Registration of Installers, Designers and Distributors of Reportable equipment 2013. It places a duty on contractors to register every fixed installation they complete on a central HSE database, recording the address, the installer's name and the certificate number, so that any later fault can be traced back to the responsible firm.",
      ...
      'Recording of Installation Defects and Dangerous Occurrences Register 2013. It requires the contractor to keep an on-site register of every near-miss and equipment fault, reviewed weekly by the principal contractor, and to forward any entry involving electrical equipment to the manufacturer for a product-safety investigation.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "The Management of Health and Safety at Work Regulations 1999 (MHSWR). As the regulation that requires the risk assessment for any work activity, it is the one that governs construction projects from planning to handover, setting out the duties of clients, designers and contractors and the worker's duty to co-operate with the site safety arrangements.",
      'The Provision and Use of Work Equipment Regulations 1998 (PUWER). Because construction is dominated by the use of plant, tools and access equipment, PUWER is the framework that runs a project end to end, defining the responsibilities of the client, the principal contractor and each worker for the duration of the build.',
      'The Construction (Health, Safety and Welfare) Regulations 1996. This is the SI that covers construction projects in full — the duties of clients, designers, principal contractors and workers from the planning stage through to handover — including the notification thresholds for larger projects and the welfare arrangements on site.',
  ...
  },
  {
    ...
    options: [
      ...
      'The Dangerous Substances and Explosive Atmospheres Regulations 2002 (DSEAR). Because any leaking drum could create a flammable atmosphere, DSEAR is the regulation that governs the response to a chemical spill in every case, requiring the immediate area to be classified as a zoned hazardous area before any further work, electrical or otherwise, can continue.',
      'The Hazardous Waste Regulations 2005. As the SI dealing with chemicals on site, it requires the apprentice to contain the spill, decant the substance into a labelled hazardous-waste drum and complete a consignment note before reporting to the supervisor, since the leak is legally classified as controlled waste the moment it escapes the container.',
      'The Environmental Protection Act 1990. Since the leak is a pollution incident, this Act governs the response — the duty is to stop the spread to any drain or watercourse, log it in the site environmental record, and notify the Environment Agency, with workplace exposure being a secondary concern dealt with afterwards.',
    ],
    correctAnswer: 0,
    explanation:
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 2 · Subsection 1"
        title="Statutory legislation and guidance"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Three layers of rules — statutory law, official guidance, industry standards. Where
          HASAWA, EAWR, CDM, BS 7671 and Approved Document P sit, and which ones a court treats as
          binding.
        </p>
        ...
        >
          <p>The three tiers in practical order:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Statutory law</strong> — Acts of Parliament and the Statutory Instruments made
              under them. Published on legislation.gov.uk. Breach is a criminal offence with fines
              and (in serious cases) imprisonment available. Examples: HASAWA 1974, EAWR 1989, CDM
              2015, MHSWR 1999, RIDDOR 2013, COSHH 2002, Manual Handling Regs 1992, PPE at Work Regs
              1992 (as amended 2022), Working at Height Regulations 2005, Equality Act 2010,
              Building Regulations 2010.
            </li>
            <li>
              <strong>Official guidance</strong> — HSE-published documents. The top tier is an
              Approved Code of Practice (ACoP) under HASAWA s.16, which has special evidential
              status — a court will assume an ACoP departure is a breach unless you prove the
              alternative was equally good. Below ACoPs sit the HSG (Health &amp; Safety Guidance),
              INDG (Industry Guidance), and GS (General Series) documents — strong evidence of best
              practice but no s.16 status.
            </li>
            <li>
              <strong>Industry standard</strong> — British Standards published by BSI, often in
              collaboration with the IET. BS 7671 (the Wiring Regulations) is the headline example.
              Voluntary in their own right, but routinely cited by statute (Approved Document P), by
              insurance contracts, by scheme membership rules, and by the courts as the practical
              benchmark for what 'safe' looks like.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;The provisions of this Part shall have effect with a view to — (a) securing the
              health, safety and welfare of persons at work; (b) protecting persons other than
              persons at work against risks to health or safety arising out of or in connection with
              the activities of persons at work; (c) controlling the keeping and use of explosive or
              highly flammable or otherwise dangerous substances, and generally preventing the
              unlawful acquisition, possession and use of such substances; (d) controlling the
              emission into the atmosphere of noxious or offensive substances from premises of any
              class prescribed for the purposes of this paragraph.&quot;
            </>
          }
          meaning={
            <>
              HASAWA s.1 sets the purpose of the entire UK workplace H&amp;S regime. Two duties
              matter most for the apprentice. (a) protects you and your colleagues while you&apos;re
              at work — that&apos;s the s.2 duty on the employer and the s.7 duty on you. (b)
              protects everyone else who could be affected by what you do — customers, the public,
              other trades — and is the s.3 duty on the employer. The rest of the H&amp;S
              Regulations you&apos;ll meet (EAWR, CDM, MHSWR, RIDDOR and so on) are Statutory
              Instruments made under HASAWA&apos;s enabling powers, so they all inherit this
              purpose.
            </>
          }
        ...
        >
          <p>The HASAWA sections most relevant to an apprentice:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>s.7</strong> — duty of every employee to take reasonable care for their own
              H&amp;S and that of others affected by their acts or omissions, AND to co-operate with
              the employer&apos;s arrangements.
            </li>
            <li>
              <strong>s.8</strong> — no person shall intentionally or recklessly interfere with or
              misuse anything provided for H&amp;S purposes (e.g. removing a guard, defeating an
              interlock, taking down a barrier).
            </li>
            <li>
              <strong>s.37</strong> — director / senior manager personal liability where an offence
              by the company is committed with their consent, connivance or neglect.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The EAWR regulations a Level 2 apprentice meets first:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 3</strong> — the duty to comply with EAWR extends to ALL persons working
              on electrical systems, including apprentices and the self-employed, not just the
              employer.
            </li>
            <li>
              <strong>Reg 4</strong> — all electrical systems shall, so far as is reasonably
              practicable, be of such construction as to prevent danger; and be maintained so as to
              prevent danger.
            </li>
            <li>
              ...
              reasonable in all the circumstances to do the work live, AND suitable precautions are
              taken to prevent injury.
            </li>
            <li>
              <strong>Reg 16</strong> — no person shall be engaged in any work activity where
              technical knowledge or experience is necessary to prevent danger, unless they possess
              such knowledge or experience or are under appropriate supervision.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The key Statutory Instruments to recognise at Level 2:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>MHSWR 1999</strong> — Management of Health and Safety at Work Regulations 1999
              (SI 1999/3242). Reg 3 is the duty to make a &apos;suitable and sufficient&apos; risk
              assessment. Reg 5 is the duty to plan, organise, control, monitor and review. The SI
              that turns HASAWA s.2 / s.3 into a paperwork regime.
            </li>
            <li>
              <strong>CDM 2015</strong> — Construction (Design and Management) Regulations 2015 (SI
              2015/51). Covers construction projects, with extra duties on notifiable projects (over
              30 working days with 20+ workers, or over 500 person-days). Reg 13 is site induction.
              Reg 8 is the duty on every worker.
            </li>
            <li>
            ...
            <li>
              ...
              specified injuries, over-7-day absences, occupational diseases and listed dangerous
              occurrences via the F2508 form on hse.gov.uk.
            </li>
            <li>
            ...
            <li>
              ...
              Equipment at Work Regulations 1992 (SI 1992/2966). Last resort in the hierarchy of
              control. The 2022 amendment extended duties to most limb (b) (casual / agency)
              workers.
            </li>
            <li>
              <strong>WAHR 2005</strong> — Working at Height Regulations 2005 (SI 2005/735). Covers
              anything where a fall could cause injury. The hierarchy: avoid, prevent, mitigate.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>How BS 7671 acquires legal weight even though it isn&apos;t statute:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Approved Document P (England)</strong> names BS 7671 as the recognised way to
              meet the statutory Schedule 1 Part P requirement for &apos;reasonable provision&apos;
              in dwelling installations. So a domestic departure from BS 7671 is evidence of a
              Building Regs breach, which IS statute.
            </li>
            <li>
              <strong>EAWR Reg 4</strong> requires electrical systems to be &apos;safe&apos;. The
              HSE and the courts treat BS 7671 as the practical benchmark for what &apos;safe&apos;
              looks like in fixed installations.
            </li>
            <li>
              <strong>Insurance contracts</strong> typically require BS 7671 compliance — breach can
              void cover after an incident.
            </li>
            <li>
              <strong>Scheme membership</strong> (NICEIC, NAPIT, Stroma, ELECSA, NAPIT, Certsure and
              similar) requires BS 7671 compliance and audits to it. Persistent breach gets you
              removed from the scheme.
            </li>
            <li>
              <strong>Most commercial contracts</strong> explicitly write in BS 7671 compliance as a
              contract term — breach is a contractual claim before it&apos;s anything else.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Schedule 1 Part P is the statutory hook that turns BS 7671 from a voluntary standard
              into the de facto law for dwelling installations in England. The Building Regulations
              2010 are a Statutory Instrument made under the Building Act 1984 — full statute. The
              duty in P1 is to provide &apos;reasonable&apos; protection. The Approved Document P
              guidance then tells you what &apos;reasonable&apos; means in practice — and it names
              BS 7671 as the route. So a domestic install that breaches BS 7671 is evidence of a P1
              breach, which is statutory and prosecutable. Wales has equivalent provisions; Scotland
              operates its own Building Standards system with similar effect.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <p>
                <strong>Reg 4(2)</strong> — &quot;As may be necessary to prevent danger, all systems
          ...
          meaning={
            <>
              EAWR Reg 4 is the legal duty to make and keep electrical systems safe. The HSE and the
              courts treat BS 7671 as the practical benchmark for what &apos;safe&apos; construction
              and maintenance look like — so a breach of BS 7671 in a fixed installation is also
              evidence of a breach of EAWR Reg 4. &apos;Reasonably practicable&apos; (SFAIRP) means
              the cost of further precaution must be weighed against the risk it would prevent — but
              the burden of proving SFAIRP sits on the duty-holder.
            </>
          }
        ...
        >
          <p>The HSE documents an electrician meets most often:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HSR25</strong> — Memorandum of guidance on the Electricity at Work Regulations
              1989. The HSE&apos;s explanation of how EAWR works in practice.
            </li>
            <li>
            ...
            <li>
              <strong>HSG230</strong> — Keeping electrical switchgear safe. Industrial switchgear
              maintenance and operation.
            </li>
            <li>
              <strong>GS38</strong> — Electrical test equipment for use by electricians. Probe and
              lead specifications, voltage indicators, instrument selection.
            </li>
            <li>
            ...
            <li>
              <strong>INDG259</strong> — An introduction to health and safety. The HSE pocket-guide
              covering H&amp;S basics for any worker.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The four authoritative sources for UK electrical compliance:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>legislation.gov.uk</strong> — the official source for the current consolidated
              text of every Act and Statutory Instrument. Free, indexed, version- controlled. The
              text a court reads. Acts (HASAWA), SIs (EAWR, CDM, MHSWR, RIDDOR, COSHH, Building
              Regs).
            </li>
            <li>
              <strong>HSE.gov.uk</strong> — the official source for ACoPs (the L-series), HSG / INDG
              / GS guidance, RIDDOR reporting and inspector contact. Includes the public Notices and
              Convictions databases.
            </li>
            <li>
              <strong>The IET Wiring Regulations (BS 7671)</strong> — the standard. Available in
              print from BSI / IET, in digital form via the IET&apos;s online subscription, and on
              the IET&apos;s online courses. The current edition is BS 7671:2018 incorporating
              Amendments 1, 2 and the upcoming A4:2026.
            </li>
            <li>
              <strong>GOV.UK Building Regulations</strong> — the Approved Documents (Part L, Part M,
              Part P, Part S, etc.) for England. Wales has its own equivalent published by the Welsh
              Government; Scotland has the Scottish Building Standards published by the Scottish
              Government.
            </li>
          </ul>
          <p>
            What is NOT authoritative — Wikipedia, trade-forum threads, old college notes without
            date stamps, AI-generated summaries, manufacturer-marketing interpretations of
            standards, and out-of-date printed copies of regulations. Fine for orientation; useless
        ...
        >
          <p>The practical ESQCR rules every apprentice meets:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>The cut-out fuse is DNO property.</strong> You don&apos;t pull it for your own
              work. If you need a temporary isolation, you ask the DNO or the meter operator. The
              exception (in some scheme rules and DNO codes of practice) allows a competent person
              to pull the cut-out under specific conditions for a CU change — but this is granted by
              code of practice, not by ESQCR itself, and the conditions are strict.
            </li>
            <li>
              <strong>The meter is the meter operator&apos;s property.</strong> You don&apos;t break
              the seal. If you need to move the meter, the meter operator does it.
            </li>
            <li>
              <strong>
                The meter tails are usually DNO / MOP responsibility up to the meter terminals.
              </strong>{' '}
              Beyond that, your responsibility starts.
            </li>
            <li>
              <strong>Earthing arrangement (TN-S, TN-C-S / PME, TT)</strong> is set by the DNO under
              ESQCR. Your installation has to work safely with whatever the DNO has provided —
              TN-C-S in particular has implications for bonding which BS 7671 Section 411 then
              governs.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              &apos;passed the regs&apos;. Apprentice answers &quot;yes, BS 7671 is the law, and the
              old one breaks it.&quot; Customer challenges this on the basis that BS 7671 isn&apos;t
              actually an Act of Parliament — they&apos;ve looked it up. Apprentice doubles down.
              Customer loses confidence, complains to the firm, and the firm has to apologise for
              the technically incorrect statement even though the underlying advice (replace the
              board) was sound. The credibility damage is avoidable.
            </>
          }
          doInstead={
            <>
              Be precise. &quot;BS 7671 isn&apos;t an Act of Parliament. But for a domestic install
              in England the Building Regulations Approved Document P names BS 7671 as the way to
              meet the statutory requirement for electrical safety, so in practice the courts and
              Building Control treat BS 7671 compliance as required. Your old board doesn&apos;t
              meet the current standard, so it doesn&apos;t meet the route Building Control expect
              for a notifiable change. That&apos;s why we&apos;re replacing it.&quot; This wording
              is accurate, defensible and explains the WHY in language the customer can verify.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice reads HSG230 on switchgear safety, decides the precautions are excessive
              for the small panel they&apos;re working on, and skips the lock-off check. Six weeks
              later there&apos;s an incident — not the apprentice but a colleague switches the wrong
              way and gets a flash. The HSE investigation identifies HSG230 as the relevant
              guidance, finds the firm departed from it without any documented alternative, and
              treats the departure as evidence of an EAWR Reg 4 breach. The fact that HSG230 is
              &apos;guidance, not law&apos; doesn&apos;t save the firm — the underlying Regulation
              is law, and the guidance is the court&apos;s yardstick for what compliance looks like.
            </>
          }
          doInstead={
            <>
              Treat HSE guidance as the working benchmark for safe practice. If you have a good
              reason to depart, document it in writing in your firm&apos;s safety system, with the
              alternative control and the rationale. Being able to say &quot;we knew about the
              guidance, here&apos;s why our alternative was at least as safe, here&apos;s the
              documented decision&quot; is what turns a prosecution into a defendable position.
              Silently ignoring guidance gives you nothing to point at when the investigation
              arrives.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Walk the customer through the layered answer. (1) The work YOU&apos;re doing today has
              to comply with the current edition of BS 7671 — that&apos;s a contractual and Building
              Regs Part P requirement on a notifiable circuit change. The new kitchen and bathroom
              circuits will meet BS 7671:2018+A2:2022 (and the upcoming A4:2026 once it&apos;s in
              force). (2) The existing parts of the installation are not retrospectively required to
              comply with the current edition — installations are tested against the edition in
              force at the time they were installed, with safety judged against the current edition
              for the purpose of an EICR. (3) However, if the EICR shows the existing wiring is
              unsafe (rubber insulation perished, bonding inadequate, no RCD protection on bathroom
              circuits) then BS 7671 511.1 and the EICR coding (C1 / C2) flag those as requiring
              action. (4) The customer has the choice — fix the EICR-coded items now while the
              contractor is on site, or accept the report and decide later, knowing that an insurer
              or future buyer&apos;s surveyor will see the same report. (5) Walk through the cost
              and risk implications honestly.
            </>
          }
          whyItMatters={
            <>
              This is the exact moment a Level 2 apprentice often loses credibility — by saying
              &quot;yeah it&apos;s probably fine&quot; or &quot;the law says you have to replace it
              all&quot;. Both are wrong. The correct answer is layered and accurate — current
              edition for new work, edition-of-installation for existing work, EICR coding for
              safety judgement, customer choice on remediation. Knowing the three-tier structure
              (statutory, guidance, standard) is what makes that answer possible.
            </>
          }
        />
        ...
        <Quiz
          title="Statutory legislation and guidance — knowledge check"
