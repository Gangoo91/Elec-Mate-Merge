...
const TITLE = 'Equality Act 2010 — fair treatment on site (2.4) | Level 2 Module 5.2.4 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question: "What is the Equality Act 2010 and what's its purpose?",
    options: [
  ...
  {
    id: 3,
    question: "What's 'victimisation' under the Equality Act 2010 s.27?",
    options: [
  ...
  {
    id: 8,
    question: "Where does the apprentice's responsibility under the Equality Act actually sit?",
    options: [
...
const faqs = [
  ...
  {
    question:
      "What if I genuinely didn't mean anything by a comment that someone took the wrong way?",
    answer:
  ...
  {
    question:
      'What should I do if I see a colleague being treated badly because of a protected characteristic?',
    answer:
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 2 · Subsection 4"
        title="Equality Act 2010 — fair treatment on site"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Level 2 awareness — nine protected characteristics, reasonable adjustments for disabled
          workers, harassment, the banter trap, and the apprentice's own legal exposure.
        </p>
        ...
        >
          <p>The four main types of unlawful conduct under the Act:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Direct discrimination (s.13)</strong> — treating someone less favourably
              BECAUSE OF a protected characteristic. Example: refusing to hire an apprentice because
              they&apos;re female.
            </li>
            <li>
            ...
            <li>
              <strong>Victimisation (s.27)</strong> — treating someone less favourably because they
              have done a &apos;protected act&apos; (typically raising a complaint or supporting
              another&apos;s complaint).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Section 4 of the Equality Act 2010 lists the &apos;protected characteristics&apos;
              recognised by the Act as — (paraphrased)
              <em>
                {' '}
              ...
              Discrimination, harassment or victimisation BECAUSE OF a protected characteristic is
              prohibited in employment, education, the provision of services, public functions and
              the disposal of premises.
            </>
          }
          meaning={
            <>
              The nine protected characteristics are the closed list of categories that the Act
              protects. Any unlawful conduct under the Act has to be linked back to one of these
              nine. For an apprentice, the practical takeaway is that decisions about you
              (recruitment, training, allocation, pay, dismissal) cannot lawfully be made because of
              any of these nine characteristics, AND comments / jokes / treatment directed at you OR
              at colleagues based on these characteristics is unlawful. Sex, race and disability are
              the most-litigated, but pregnancy / maternity and age claims are also common.
            </>
          }
        ...
        >
          <p>The three sub-duties under s.20:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Adjust the practice</strong> — change a &apos;provision, criterion or
              practice&apos; that puts the disabled person at a substantial disadvantage. Example:
              standard 8am team brief replaced (or supplemented) by a written version emailed the
              day before, for an apprentice with autism who needs prep time.
            </li>
            <li>
              <strong>Adjust the physical feature</strong> — alter or remove a physical feature that
              puts the disabled person at a substantial disadvantage. Example: providing a step or
              ramp for access to a site cabin, or an adapted workbench for a worker with a
              wheelchair or crutches.
            </li>
            <li>
              <strong>Provide an auxiliary aid</strong> — provide an aid or service that helps the
              disabled person. Example: screen-reader software, a sign-language interpreter for an
              induction, captioned videos for safety briefings.
            </li>
          </ul>
          <p>
            &apos;Reasonable&apos; is judged on factors including the cost, the resources of the
            employer, the disruption to the work, and the size of the disadvantage being addressed.
            A FTSE 100 client and a four-person electrical contractor will have different ranges of
            &apos;reasonable&apos; — but the duty applies to both, proportionately.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Common impairments that meet the s.6 test in many cases:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sensory</strong> — sight or hearing impairment that has substantial, long-term
              effect.
            </li>
            <li>
            ...
            <li>
              <strong>Cognitive / neurodevelopmental</strong> — dyslexia, dyspraxia, ADHD, autism
              spectrum, where the effect on day-to-day activity is substantial.
            </li>
            <li>
            ...
            <li>
              <strong>Long-term medical</strong> — diabetes, epilepsy, MS, cancer (deemed disability
              from diagnosis), HIV (deemed disability from diagnosis), and others.
            </li>
          </ul>
          <p>
            The deemed-disability provisions (Schedule 1 Part 1, paragraph 6) automatically treat
            cancer, HIV and MS as disabilities from diagnosis, regardless of effect. Other
            progressive conditions can qualify as disabilities even before they have a substantial
            effect, where the effect is likely to develop.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Section 20 of the Equality Act 2010 places a three-part duty on employers (and others
              to whom the duty applies) to make reasonable adjustments where a &apos;provision,
              criterion or practice&apos;, a physical feature, or the absence of an auxiliary aid
              puts a disabled person at a substantial disadvantage in comparison with persons who
              are not disabled. The first requirement is to take such steps as it is reasonable to
              take to avoid the disadvantage; the second is to take such steps to alter or remove
              the physical feature; the third is to provide the auxiliary aid. The duty is
              anticipatory in some contexts (provision of services) and reactive in employment
              (kicks in once the employer knows or ought reasonably to know).
            </>
          }
          meaning={
            <>
              The reasonable-adjustments duty is the most practically powerful part of the Equality
              Act for many disabled workers. It&apos;s a positive duty — the employer has to do
              something, not just refrain from discriminating. The kick-in test (knowledge or
              constructive knowledge of the disability) means that an apprentice who needs
              adjustments should make the request in writing, with specifics. From the moment the
              employer is on notice, the duty applies. Failure to make reasonable adjustments is
              itself a separate unlawful act under s.21 — claimable in the Employment Tribunal
              alongside any disability-discrimination claim.
            </>
          }
        ...
        >
          <p>The s.26 test broken down:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Unwanted conduct</strong> — anything from a spoken comment to a physical act,
              an email, a WhatsApp message, a meme, a poster.
            </li>
            <li>
              <strong>Related to a relevant protected characteristic</strong> — the conduct has to
              be linked to one of the nine. Random unkindness isn&apos;t s.26 harassment (though it
              may breach a different policy). A comment specifically about race, gender, sexuality,
              religion etc. is.
            </li>
            <li>
              <strong>Purpose OR effect</strong> — the &apos;or&apos; is critical. If the speaker
              intended to harass, that&apos;s s.26. If the speaker didn&apos;t intend to but the
              effect on the recipient was to violate dignity or create an offensive environment,
              that&apos;s ALSO s.26.
            </li>
            <li>
              <strong>The court considers</strong> — the perception of the recipient, the other
              circumstances of the case, AND whether it is reasonable for the conduct to have that
              effect. So a hyper-sensitive complaint over a trivial remark might fail the
              &apos;reasonable&apos; test, but most genuine harassment claims pass it comfortably.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Two parallel routes to legal liability for harassment:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              Personal liability includes financial liability for compensation if the employer is
              unable to pay.
            </li>
            <li>
              <strong>The employer</strong> is vicariously liable under s.109 unless they can prove
              the &apos;all reasonable steps&apos; defence. A successful defence requires more than
              just a written policy — it needs evidence of training, monitoring and enforcement.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Section 26 of the Equality Act 2010 defines harassment as: A person (A) harasses
              another (B) if (paraphrased) A engages in unwanted conduct related to a relevant
              ...
              offensive environment for B. In deciding whether the conduct has that effect, the
              court takes into account the perception of B, the other circumstances of the case, AND
              whether it is reasonable for the conduct to have that effect. Separate provisions
              cover sexual harassment and harassment for rejecting or submitting to conduct.
            </>
          }
          meaning={
            <>
              The s.26 test is deliberately broad. The &apos;or effect&apos; element is what catches
              the &apos;banter&apos; defence — speaker intent isn&apos;t the only factor; the effect
              on the recipient and what is reasonable for the conduct to produce that effect are
              also weighed. The recipient&apos;s perception is a starting point, not the only test —
              the court still asks whether it&apos;s &apos;reasonable&apos; for the conduct to have
              that effect, which filters out hypersensitive claims while still catching most genuine
              harassment. For an apprentice the practical lesson is: if a comment relates to one of
              the nine protected characteristics and could reasonably affect dignity, don&apos;t
              make it. Don&apos;t laugh at it either — joining in puts you on the s.110 hook
              personally.
            </>
          }
        ...
        >
          <p>What ACAS guidance typically covers (paraphrased — current text on acas.org.uk):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Definitions</strong> — what counts as bullying, what counts as harassment, the
              overlap with Equality Act unlawful conduct.
            </li>
            <li>
              <strong>Examples by setting</strong> — workplace, on-site, online, in formal meetings,
              in informal conversation.
            </li>
            <li>
              <strong>Practical responses</strong> — how to raise a concern, how a manager should
              respond, how to investigate, what records to keep.
            </li>
            <li>
              <strong>Mediation and conciliation</strong> — the ACAS Early Conciliation process is
              now a mandatory step before most Employment Tribunal claims.
            </li>
            <li>
              <strong>Policy templates</strong> — model policies that small firms can adopt or
              adapt.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Practical guidance for an apprentice navigating the Act on site:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Don&apos;t make jokes about protected characteristics</strong> — even ones
              that &quot;everyone laughs at&quot;. The legal test isn&apos;t whether everyone
              laughs; it&apos;s whether the conduct could reasonably affect the dignity of the
              recipient.
            </li>
            <li>
              <strong>Don&apos;t join in</strong> when others do. Laughing along, repeating the
              joke, posting the meme — all potentially s.110 conduct. Walk away or redirect the
              conversation.
            </li>
            <li>
              <strong>Speak up</strong> when something obviously unlawful is happening. If
              you&apos;re not comfortable speaking up to the perpetrator directly, raise it with the
              supervisor or H&amp;S contact in writing. Witnesses make or break Tribunal claims.
            </li>
            <li>
              <strong>If you need a reasonable adjustment</strong>, request it in writing with
              specifics. The employer&apos;s s.20 duty kicks in from the point they know or ought
              reasonably to know. A specific written request is the cleanest way to put them on
              notice.
            </li>
            <li>
              <strong>If you&apos;re on the receiving end</strong> of discriminatory or harassing
              conduct, log what happened (date, time, what was said, who was present). Use the
              firm&apos;s grievance procedure first if you can. ACAS conciliation is free. Tribunal
              is the formal route — strict time limits apply (typically 3 months less one day from
        ...
        >
          <p>The four-stage escalation route in detail:</p>
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Informal raise</strong> — raise the concern with the supervisor or directly
              with the colleague involved, where safe to do so. Document the conversation in writing
              afterwards (email summary is fine).
            </li>
            <li>
              <strong>Formal grievance</strong> — invoke the firm&apos;s written grievance
              procedure. ACAS publishes a Code of Practice on Disciplinary and Grievance Procedures
              that every employer is expected to follow.
            </li>
            <li>
              <strong>ACAS Early Conciliation</strong> — mandatory step before most Tribunal claims.
              Free, confidential, time-limited (typically 6 weeks). Many cases settle here.
            </li>
            <li>
              <strong>Employment Tribunal claim</strong> — formal claim filed within the statutory
              time limit (typically 3 months less one day from the act complained of, sometimes
              extended by ACAS conciliation). Hearings, evidence, cross-examination, judgment,
              remedy.
            </li>
          </ol>
          <p>
            The apprenticeship provider, the union (if you&apos;re a member) and Citizens Advice are
            useful sources of free advice at any stage. Specialist employment solicitors offer
            initial consultations and may take cases on no-win-no-fee terms for stronger claims.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              colleague&apos;s religion — taking the mick about prayer times, dietary restrictions,
              religious dress. The colleague says nothing in the moment but eventually raises a
              grievance. The senior&apos;s defence in the internal investigation is &quot;it was
              just banter, no-one ever complained&quot;. The investigation finds the conduct amounts
              to s.26 harassment regardless of intent, the colleague brings a Tribunal claim, the
              firm settles for a five- figure sum, and the senior is dismissed for gross misconduct.
              The apprentices and other colleagues who laughed along during the comments are also
              exposed to s.110 personal-liability arguments and disciplinary action.
            </>
          }
          doInstead={
            <>
              Treat the s.26 test seriously. If a comment relates to a protected characteristic AND
              could reasonably affect someone&apos;s dignity, don&apos;t make it — and don&apos;t
              laugh at it when others do. &apos;Banter&apos; that touches on the nine protected
              characteristics is a Tribunal claim waiting to happen. The professional move is to
              redirect the conversation, walk away, or (if you&apos;re confident) call it out at the
              time — &quot;mate, that&apos;s not on, leave it&quot;. Apprentices who laugh along get
              caught in the same net as the perpetrator; apprentices who don&apos;t are
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A new apprentice with dyslexia asks for written instructions to be supplemented with a
              verbal walk-through and asks for a few extra minutes to read RAMS documents. The
              supervisor responds &quot;we don&apos;t do special treatment here, you need to keep up
              like everyone else&quot;. The apprentice struggles, makes errors that look like
              incompetence, gets disciplined, eventually raises a grievance about the failure to
              make reasonable adjustments. The Tribunal claim under s.21 (failure to make reasonable
              adjustments) succeeds because the supervisor&apos;s &apos;keep up&apos; response was
              on record and the firm had no documented consideration of the request. The
              compensation award includes injury to feelings (Vento middle band), lost earnings, and
              a recommendation that the firm overhauls its disability policies.
            </>
          }
          doInstead={
            <>
              Treat reasonable-adjustment requests seriously and document the response. If the
              request is reasonable, provide the adjustment — most adjustments cost very little and
              many improve safety and performance for everyone (e.g. clearer briefings benefit the
              whole crew). If the request isn&apos;t reasonable for some specific reason, document
              why, consider alternatives, and explain the decision in writing. The legal framing
              (s.20 duty kicks in once the employer knows or ought reasonably to know) means
              refusing without consideration is the worst possible answer. Reasonable adjustments
              aren&apos;t &apos;special treatment&apos; — they&apos;re the legal floor for fair
              treatment of disabled workers, and they&apos;re cheap insurance against expensive
              Tribunal claims.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              12-page RAMS document with dense small-print text and lots of acronyms. The supervisor
              reads through it at speed and asks everyone to sign. You&apos;re struggling to keep up
              but you don&apos;t want to be the one slowing the brief. The supervisor says
              &quot;just sign it, you can read it later&quot;.
            </>
          }
          whatToDo={
            <>
              The reasonable-adjustment route is yours by right under Equality Act s.20. Practical
              steps: (1) Tell the supervisor in writing (text or email is fine) that you have
              dyslexia and need an adjustment. Be specific — &quot;please can I have RAMS documents
              in large-print or as an audio file the day before, OR a one-to-one walk-through before
              signing&quot;. (2) Don&apos;t sign anything you haven&apos;t been able to properly
              read — signing is taken as confirmation you&apos;ve understood the controls, and
              that&apos;s a HASAWA s.7 co-operate point too. (3) The employer&apos;s duty kicks in
              from the moment they know or ought reasonably to know; your written request puts them
              on notice. (4) If the supervisor refuses without a defensible reason, escalate to the
              firm&apos;s H&amp;S contact or HR equivalent. (5) If the firm fails to engage, the
              formal routes are internal grievance → ACAS conciliation → Employment Tribunal claim
              under s.21 (failure to make reasonable adjustments). Most adjustments cost very little
              and most disputes resolve internally — but the legal framework gives you real
              leverage.
            </>
          }
          whyItMatters={
            <>
              This scenario is one of the most common practical Equality Act issues for apprentices.
              Dyslexia, dyspraxia, ADHD, ASD, hearing impairment, mobility impairment — all are
              recognised disabilities under s.6 / Schedule 1 if the impairment has a substantial and
              long-term adverse effect on day-to-day activities. The reasonable-adjustments duty is
              the law&apos;s recognition that fair treatment doesn&apos;t mean identical treatment —
              it means equal access to opportunities and information. Apprentices who don&apos;t
              know to ask end up struggling, getting disciplined for &apos;poor performance&apos;
              that&apos;s actually unmet adjustment needs, and (often) leaving the trade.
              Apprentices who do know to ask get the adjustments and progress normally. The firm
              benefits too — the alternative is a Tribunal claim that costs more than a year of
