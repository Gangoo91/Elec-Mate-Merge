...
const TITLE = 'HASAWA & EAWR — your duties (2.2) | Level 2 Module 5.2.2 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question: 'What does HASAWA s.7 require of every employee personally?',
    options: [
  ...
  {
    id: 2,
    question: 'What does HASAWA s.8 prohibit?',
    options: [
  ...
  {
    id: 3,
    question: 'Under EAWR Reg 3, who exactly owes the duty to comply with the Regulations?',
    options: [
  ...
  {
    id: 5,
    question: "What's the penalty range for a serious EAWR breach prosecuted in the Crown Court?",
    options: [
  ...
  {
    id: 6,
    question: 'EAWR Reg 16 covers competence. What does it actually require?',
    options: [
  ...
  {
    id: 7,
    question: "What's HASAWA s.37 and when does it become relevant to an electrician's career?",
    options: [
...
const faqs = [
  {
    question:
      'Can I really be prosecuted personally as an apprentice, or is that just to scare us?',
    answer:
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 2 · Subsection 2"
        title="HASAWA & EAWR — your duties"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The personal-duty layer. HASAWA s.7, s.8 and s.37, and EAWR Reg 3, Reg 14 and Reg 16 —
          what they actually require of you on Monday morning, and what happens if you breach them.
        </p>
        ...
        >
          <p>The five legal hooks that land directly on the individual:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HASAWA s.7(a)</strong> — take reasonable care for the H&amp;S of yourself and
              of anyone affected by your acts or omissions at work.
            </li>
            <li>
            ...
            <li>
              <strong>HASAWA s.8</strong> — don&apos;t intentionally or recklessly interfere with or
              misuse anything provided in the interests of H&amp;S (guards, interlocks, barriers,
              lock-offs, RCDs, smoke detectors, signs).
            </li>
            <li>
              <strong>EAWR Reg 3</strong> — every employee engaged in electrical work has a personal
              duty to comply with EAWR insofar as it relates to matters within their control.
            </li>
            <li>
              <strong>EAWR Reg 16</strong> — no person shall be engaged in work where technical
              knowledge or experience is needed to prevent danger, unless they have it OR they are
        ...
        <RegsCallout
          ...
          meaning={
            <>
              s.7 is the personal hook for every worker, including apprentices and trainees. Limb
              (a) covers active care (don&apos;t do unsafe things) and passive care (don&apos;t
              ignore unsafe things you could address). Limb (b) covers co-operation — attending
              toolbox talks, following RAMS, wearing PPE, signing in, working within permits. Both
              limbs are personal criminal duties. The HSE has successfully prosecuted individual
              operatives under s.7 for ignoring safety instructions, defeating controls and carrying
              out work they knew was unsafe.
            </>
          }
        ...
        >
          <p>What &apos;reasonable care&apos; looks like in practice for an apprentice:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              Following the safe-isolation procedure every time, on every job, regardless of size —
              no shortcuts because &quot;it&apos;s just a quick one&quot;.
            </li>
            <li>
              Wearing and maintaining the PPE provided — including the boring stuff (safety glasses
              for chasing, FFP3 for masonry dust, gloves for sharp materials).
            </li>
            <li>
              Reporting defects — broken lock-offs, damaged leads, missing signs, expired first-aid
              kit. Reporting is part of co-operating; ignoring is part of breaching.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Examples of s.8 breaches an apprentice should never commit:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Removing a guard from a circular saw, grinder or chasing machine because it gets in
              the way.
            </li>
            <li>Cutting or taping over an RCD that keeps tripping instead of finding the fault.</li>
            <li>
              Pulling someone else&apos;s lock-off without permission because you &quot;need to get
              the supply back on quickly&quot;.
            </li>
            <li>
              Defeating a permit-to-work — extending the work beyond what the permit authorises, or
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Connivance</strong> — the director knew about the breach and turned a blind
              eye.
            </li>
            <li>
              <strong>Neglect</strong> — the director failed to take steps a reasonable director
              should have taken (e.g. failure to oversee H&amp;S, failure to act on a reported risk,
        ...
        >
          <p>Practical Reg 3 implications for an apprentice:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              You have a personal duty under EAWR — not just a duty mediated through your employer.
            </li>
            <li>
              You have to actively co-operate with the employer&apos;s compliance arrangements (e.g.
              the safe-isolation procedure, the lock-off / tag-out system, the permit-to-work
              scheme).
            </li>
            <li>
              You have to comply with EAWR yourself for matters within your control — isolating
              before working, testing dead, not working live without justification, working within
              your competence.
            </li>
            <li>
              The HSE can prosecute you personally for an EAWR breach — alongside the firm, not
              instead of it.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            issued by a competent senior person before the work starts and signed off at completion.
            As an apprentice you would not be authorised to do live work alone — you&apos;d be
            working under a permit issued to a senior, who carries the legal responsibility for the
            Reg 14 justification.
          </p>
          <p>Things that are NOT live work under Reg 14:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Voltage indication on a presumed-dead conductor with a GS38-compliant voltage
              indicator (this is the test that proves dead — you have to do it for it to be safe).
            </li>
            <li>
              Approaching a known live system to operate a switch or isolator from outside the live
              envelope (the operating handle is typically outside the danger zone).
            </li>
            <li>
          ...
          <p>Things that ARE live work and need a Reg 14 justification:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Any work inside the live envelope of energised equipment.</li>
            <li>Fault-finding on a powered-up board with the cover off.</li>
            <li>
              Live testing for current, voltage or earth fault loop impedance with the installation
              energised (the live elements of an EICR / commissioning sequence).
            </li>
            <li>
              Anything that brings exposed conductive parts to within unsafe reach of an operative
              or their tools.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The three conditions are conjunctive — every one of (a), (b) and (c) has to be met. In
              practice (a) — &apos;unreasonable for it to be dead&apos; — is what fails most
              live-work justifications: in installation work it is almost always reasonably
              practicable to isolate. The standard mechanism for proving compliance with Reg 14 is a
              permit-to-work. As an apprentice you would not be the issuer or holder of a Reg 14
              permit; you would be working under one issued to a competent senior. Unauthorised live
              work — even a single screw on a live terminal — is a criminal offence under Reg 14,
              prosecutable against the firm AND the individual.
            </>
          }
        ...
        >
          <p>What &apos;appropriate supervision&apos; means in practice:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>The supervisor is competent in the work being supervised.</li>
            <li>
              The level of supervision is matched to the task and the apprentice&apos;s stage —
              year-one apprentice on first-fix containment work needs much more direct oversight
              than a year-three apprentice on a familiar task.
            </li>
            <li>
              The supervisor is close enough (physically and in attention) to intervene before an
              error becomes an incident — not three rooms away or two floors down.
            </li>
            <li>
              The supervisor checks the work before it&apos;s energised, and signs off certificates
              as the qualified person.
            </li>
            <li>
              If supervision can&apos;t be provided, the work has to wait — &quot;crack on without
              me&quot; on a task you haven&apos;t mastered is a Reg 16 set-up for an accident.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            The Sentencing Council Definitive Guideline for Health and Safety Offences (in force
            since 2016, periodically updated) is the document the courts use. It works in five
            steps:
          </p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Categorise the culpability</strong> — Very High, High, Medium, Low. Deliberate
              breaches, repeat offences, ignored warnings = High / Very High.
            </li>
            <li>
              <strong>Categorise the harm</strong> — Level A (death or serious injury), Level B
              (lesser injury or significant risk), Level C (minor injury or low risk), Level D
              (negligible).
            </li>
            <li>
              <strong>Read off the starting-point fine / sentence</strong> from the matrix using
              culpability + harm.
            </li>
            <li>
              <strong>Adjust for size of organisation</strong> (turnover bands for companies),
              aggravating factors (cost-cutting motive, repeat offending) and mitigating factors
              (early co-operation, remediation).
            </li>
            <li>
              <strong>Apply credit for guilty plea</strong> (typically up to 1/3 reduction for early
              plea).
            </li>
          </ol>
          <p>
            Realistic outcomes from recent electrical-trade prosecutions have included six-figure
            fines for medium-sized contractors after near-miss flashovers, suspended prison
            sentences for individual operatives after fatal contact incidents, and director
            disqualifications under the Company Directors Disqualification Act 1986 alongside the
            criminal sentence.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Per Section 33, breach of HASAWA s.7 is an either-way offence. Summary conviction
              (Magistrates&apos; Court) — fine of up to the statutory maximum (now generally
              unlimited for offences committed after 12 March 2015 under s.85 LASPO 2012) and / or
              imprisonment up to 6 months. Conviction on indictment (Crown Court) — unlimited fine
              and / or imprisonment up to 2 years. (Paraphrased summary — for the precise current
              text and applicable maxima see legislation.gov.uk s.33 as amended.)
            </>
          }
          meaning={
            <>
              The penalty range for personal HASAWA offences (s.7, s.8 in particular) is serious —
              unlimited fines and prison are both available. For corporate offences (s.2, s.3, EAWR
              Reg 4) fines scale with turnover and have run into seven and eight figures in serious
              cases. The Sentencing Council Definitive Guideline 2016 made the matrix predictable;
              the predictability has, on average, pushed sentence levels UP not down. As an
              individual, conviction also typically results in a criminal record on the DBS, which
              can end a career in regulated trades.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice is asked to do a task they haven&apos;t been trained for — terminating a
              3-phase distribution board live because the supervisor &quot;needs to keep the
              customer&apos;s server running&quot;. Apprentice agrees, reasoning that &quot;the firm
              carries the H&amp;S liability, not me&quot;. The work goes wrong, a flashover injures
              a colleague, and the HSE investigation finds the apprentice was outside their
              competence (EAWR Reg 16 personal breach), carrying out unauthorised live work (EAWR
              Reg 14 personal breach), and acting outside reasonable care (HASAWA s.7 personal
              breach). Charges are laid against the firm, the supervisor, the director (under HASAWA
              s.37), AND the apprentice. The apprentice receives a personal fine and a criminal
              record — career-ending in a regulated trade.
            </>
          }
          doInstead={
            <>
              Refuse the instruction. Cite the Reg — &quot;EAWR Reg 14 needs all three conditions
              met before live work is lawful, and Reg 16 means I&apos;d need to be competent or
              supervised, and I&apos;m neither for this task.&quot; Put the refusal in writing
              immediately (text, email, app note) — this becomes your evidence later. Escalate to
              the supervisor&apos;s manager / H&amp;S contact / apprenticeship provider as needed.
              The HASAWA s.7 personal duty is on you; discharging it by refusing is what protects
              you in court.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice on a CU change finds the customer&apos;s lock-off pad won&apos;t fit the
              breaker because the breaker is an unusual brand. Instead of pausing, photographing the
              issue and asking for a different lock-off, they put a label on the breaker saying
              &quot;DO NOT SWITCH&quot; and crack on. A passing trade ignores the label, switches
              the breaker, and the apprentice receives an electric shock from the now-live
              conductors they&apos;re working on. HSE investigation finds defeated isolation under
              EAWR Reg 13 / 14 and a HASAWA s.8 issue (failure to use the safety system as
              intended). Personal exposure for the apprentice as well as the firm.
            </>
          }
          doInstead={
            <>
              Stop work. Get the right lock-off — every electrician&apos;s tool kit should include a
              multi-brand lock-off set. If you genuinely can&apos;t lock off (rare), escalate to the
              supervisor and use the next-best control under the safe- isolation hierarchy: pull a
              cartridge fuse and pocket it; remove a circuit breaker entirely if removable; isolate
              at a higher level (sub-main, distribution board, main switch) where you CAN lock off.
              The label-only approach is not safe isolation under any HSE guidance and is a textbook
              EAWR / HASAWA personal breach.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              fault-finding on a single-phase circuit that keeps tripping. The supervisor says:
              &quot;Just leave it energised and meter across the terminals — we haven&apos;t got
              time to take the whole board down.&quot; There&apos;s no permit-to-work, no risk
              assessment for live work, no PPE for live working provided, and you haven&apos;t been
              trained in live testing.
            </>
          }
          whatToDo={
            <>
              Refuse the instruction politely. Say something like: &quot;I&apos;m not authorised to
              do live work on my own under EAWR Reg 14 and Reg 16, and there&apos;s no
              permit-to-work for this. The right move is either (a) you do the live test yourself
              with the right PPE and a documented Reg 14 justification, or (b) we isolate the board
              and I do it dead. I&apos;ll go and prep for whichever you decide.&quot; Then text or
              email yourself a one-line note with the date, time, location and what you were asked
              to do — that&apos;s your contemporaneous evidence. If the supervisor escalates the
              pressure, refuse again and contact your firm&apos;s H&amp;S manager or your
              apprenticeship provider directly. HASAWA s.7 puts the personal duty on you; ERA 1996
              s.44 protects you from detriment for the refusal. The supervisor and the firm carry
              the real prosecution exposure for asking — the apprentice should be the one walking
              out of any later HSE investigation with a clean record.
            </>
          }
          whyItMatters={
            <>
              Live work without a Reg 14 justification is one of the most-prosecuted EAWR breaches.
              Asking an apprentice to do it without a permit, training, supervision or PPE is a
              layered breach (Reg 14, Reg 16, MHSWR Reg 3, HASAWA s.2). The apprentice&apos;s
              correct response — refuse, document, escalate — is also the response that the HSE will
              look for in the investigation. Apprentices who comply with this kind of instruction
              get caught in the prosecution net alongside the supervisor and the firm. Apprentices
              who refuse and document have a clean evidential record showing they discharged their
              personal duty.
            </>
          }
        />
