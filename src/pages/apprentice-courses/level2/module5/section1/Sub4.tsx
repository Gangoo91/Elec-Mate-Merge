...
const quizQuestions = [
  {
    id: 1,
    question: 'What does CDM stand for and what regulations apply currently?',
    options: [
  ...
  {
    id: 3,
    question: "What's the Principal Designer's primary duty under CDM 2015 Reg 11?",
    options: [
  ...
  {
    id: 4,
    question: "What's the Principal Contractor's primary duty under CDM 2015 Reg 12?",
    options: [
  ...
  {
    id: 6,
    question: "What's the Construction Phase Plan (CPP) and who writes it?",
    options: [
  ...
  {
    id: 7,
    question: "What's the Pre-Construction Information (PCI) and who writes it?",
    options: [
...
const faqs = [
  ...
  {
    question:
      "What's the difference between the CPP (Construction Phase Plan) and RAMS (Risk Assessment + Method Statement)?",
    answer:
  ...
  return (
    <HubPage>
      ...
      <HubBody>
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Plans, manages, monitors and co-ordinates H&amp;S in pre-construction. Identifies,
                eliminates or controls foreseeable risks via the design. Liaises with the PC.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Plans, manages and monitors construction work under their control to ensure it is
                carried out without risks to H&amp;S. Complies with the PC&apos;s arrangements. Each
                trade contractor (electrical, mechanical, joinery).
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
        ...
        >
          <p>The Client's headline duties under Reg 4:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Make suitable arrangements for managing the project (Reg 4(1)).</li>
            <li>Ensure adequate time, resources and competence are allocated (Reg 4(1)).</li>
            <li>
              Provide Pre-Construction Information to every designer and contractor (Reg 4(4)).
            </li>
            <li>
              Appoint a Principal Designer and a Principal Contractor in writing where there is more
              than one contractor (Reg 5).
            </li>
            <li>Notify HSE on F10 if the project is notifiable (Reg 6).</li>
            <li>
              Ensure the Construction Phase Plan is in place before construction starts (Reg 4(5)).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The PD's headline duties under Reg 11:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Plan, manage, monitor and co-ordinate H&amp;S during pre-construction (Reg 11(1)).
            </li>
            <li>Identify, eliminate or control foreseeable risks via the design (Reg 11(3)).</li>
            <li>Ensure designers comply with their Reg 9 duties (Reg 11(4)).</li>
            <li>Prepare and provide the Pre-Construction Information (Reg 11(6)).</li>
            <li>
              Liaise with the Principal Contractor for the duration of the appointment (Reg 11(7)).
            </li>
            <li>Prepare or update the H&amp;S File for the project (Reg 12(8)).</li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Plan, manage, monitor and co-ordinate the construction phase (Reg 12(1)).</li>
            <li>Take into account the general principles of prevention (Reg 12(2)).</li>
            <li>
              Liaise with the Principal Designer for the duration of the appointment (Reg 12(7)).
            </li>
            <li>Prepare and update the Construction Phase Plan (Reg 12(1)).</li>
            <li>Provide and update the H&amp;S File information for the building (Reg 12(8)).</li>
            <li>
              Ensure suitable site induction, prevention of unauthorised access and welfare
              facilities (Reg 13(4)).
            </li>
            <li>Engage with workers in matters affecting their H&amp;S (Reg 14).</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What the PCI typically contains:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Project description and key dates.</li>
            <li>Site description (location, access, neighbours, existing use).</li>
            <li>Existing structures and services (drawings, surveys, asbestos register).</li>
            <li>Existing H&amp;S file (from any previous CDM project on the site).</li>
            <li>
              Any specific risks identified (hazardous substances, fragile materials, height
              exposure).
            </li>
            <li>Client&apos;s arrangements for managing the project.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Description of the project and programme.</li>
            <li>Management of the work (responsibilities, supervision, communication).</li>
            <li>
              Arrangements for controlling significant risks (asbestos, working at height, live
              services, manual handling, work near water).
            </li>
            <li>Arrangements for site rules, welfare, fire, first-aid and emergency procedures.</li>
            <li>
              Arrangements for engagement with workers (toolbox talks, suggestion routes, near-miss
              reporting).
            </li>
            <li>Arrangements for monitoring, review and update.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What the H&amp;S File typically contains:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              As-built drawings for all services (electrical, mechanical, public health, fire, BMS).
            </li>
            <li>Specifications and operating manuals for installed equipment.</li>
            <li>Asbestos register (if applicable).</li>
            <li>Structural calculations and any residual structural risks.</li>
            <li>Cleaning, maintenance and access arrangements designed in.</li>
            <li>Materials of fragile composition or high hazard.</li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                <strong>Reg 4(1)</strong> &mdash; &quot;A client must make suitable arrangements for
                managing a project, including the allocation of sufficient time and other
                resources.&quot;
              </p>
              <p className="mb-2">
                <strong>Reg 4(2)</strong> &mdash; &quot;Arrangements are suitable if they ensure
                that &mdash; (a) the construction work can be carried out, so far as is reasonably
                practicable, without risks to the health or safety of any person affected by the
                project; and (b) the facilities required by Schedule 2 are provided in respect of
                any person carrying out construction work.&quot;
              </p>
              <p>
                <strong>Reg 4(4)</strong> &mdash; &quot;A client must provide pre-construction
                information as soon as is practicable to every designer and contractor appointed, or
          ...
          meaning={
            <>
              ...
              arrangements&quot; covers time, resources, competence and information. PCI under Reg
              4(4) is the H&amp;S information designers and contractors need to plan safely. A
              Client who under-resources the project or fails to provide PCI is in breach of Reg 4
              even if no incident has occurred &mdash; the duty is to set things up properly, not
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                <strong>Reg 12(1)</strong> &mdash; &quot;The principal contractor must plan, manage
                and monitor the construction phase and co-ordinate matters relating to it to ensure
                that, so far as is reasonably practicable, construction work is carried out without
                risks to health or safety.&quot;
              </p>
              <p>
                <strong>Reg 12(7)</strong> &mdash; &quot;The principal contractor must liaise with
                the principal designer for the duration of the principal designer&apos;s appointment
                and share with the principal designer information relevant to the planning,
                management and monitoring of the pre-construction phase and the co-ordination of
                health and safety matters during the pre-construction phase.&quot;
              </p>
            </>
          }
          meaning={
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                <strong>Reg 13(1)</strong> &mdash; &quot;The principal contractor must &mdash; (a)
                liaise with the client and principal designer for the duration of the principal
                designer&apos;s appointment and share with them information relevant to the
                planning, management and monitoring of the pre-construction phase and the
                co-ordination of health and safety matters during the pre-construction phase; and
                (b) inform a contractor whose work is to be undertaken on or in connection with the
                project of the minimum amount of time which will be allowed to them for planning and
                preparation before they begin work on the construction site.&quot;
              </p>
              <p>
                <strong>Reg 13(4)</strong> &mdash; &quot;The principal contractor must ensure that
                &mdash; (a) a suitable site induction is provided; (b) the necessary steps are taken
                to prevent access by unauthorised persons to the construction site; and (c)
                facilities that comply with the requirements of Schedule 2 are provided throughout
          ...
          meaning={
            <>
              ...
              facilities. As an apprentice you experience the PC&apos;s discharge of Reg 13 on day
              one (induction), every day (welfare), and whenever a visitor arrives (escorted
              access). Reg 13(1)(b) is also a useful one to know &mdash; it requires the PC to give
              contractors enough time to plan and prepare. Crash programmes that don&apos;t allow
              planning time are a Reg 13(1)(b) breach.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              &quot;just paperwork&quot;, ignores the CPP entirely. Doesn&apos;t attend the site
              induction properly (turns up late, doesn&apos;t sign), doesn&apos;t engage with
          ...
          doInstead={
            <>
              Treat the site induction and the toolbox talks as your access route to the CPP. You
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              area). Fire muster point and emergency procedures. First-aid arrangements and accident
              reporting route. PPE policy (mandatory PPE on site, specific PPE for specific areas).
              Site rules (sign-in/sign-out, no-go areas, hot-works permits, photography).
              Construction Phase Plan headlines (high-risk activities, key dates, trade-clash
