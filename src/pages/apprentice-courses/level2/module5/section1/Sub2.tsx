...
const TITLE = 'Individuals reporting to site management (1.2) | Level 2 Module 5.1.2 | Elec-Mate';
const DESCRIPTION =
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              apprenticeship. Portfolio sign-off, three-way reviews, AM2 prep. Covered in detail in
              Sub 5.
            </li>
          </ul>
        </ConceptBlock>
