...
const faqs = [
  {
    question:
      "What's the difference between an Apprenticeship Standard and an Apprenticeship Framework?",
    answer:
  ...
  {
    question:
      "What if my College Tutor and my Workplace Mentor disagree on whether I'm ready for AM2?",
    answer:
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 1 · Subsection 5"
        title="Apprenticeship triangle + UK trade-body landscape"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          College Tutor, Workplace Mentor, Employer — the three-way relationship that runs the
          apprenticeship. Plus EPA, schemes (NICEIC, NAPIT, ELECSA, STROMA), trade bodies (ECA,
          SELECT, JIB) and industry charities.
        </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Delivers the 2365 syllabus. Marks coursework and exams. Owns AM2 preparation. Sees
                you typically one day a week (day release) or in block. Calibrates with the Mentor
                at three-way reviews.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                ...
                Approved or Technician grade). Signs portfolio entries, calibrates gradings with the
                College Tutor, attends three-way reviews, first point of escalation for apprentice
                issues.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Your apprenticeship contract (formal indenture). Pays your wages. Provides suitable
                work and supervision. Signs the off-the-job training declaration (minimum 20% of
                paid working hours). HASAWA s.2 duties to you.
              </p>
            </div>
          </div>
        </ConceptBlock>
        ...
        >
          <p>A typical three-way review agenda:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Last month&apos;s targets &mdash; what was achieved, what wasn&apos;t, why.</li>
            <li>Academic progress &mdash; coursework marks, knowledge gaps, exam preparation.</li>
            <li>
              Practical progress &mdash; portfolio entries since last review, on-site competence
              demonstrated, gaps identified.
            </li>
            <li>
              Calibration &mdash; do the academic and practical pictures agree? If not, why not?
            </li>
            <li>Next month&apos;s targets &mdash; specific, measurable, agreed by all three.</li>
            <li>
              Pastoral / contractual issues &mdash; anything that isn&apos;t strictly academic or
              practical (workload, mental health, travel, programme).
            </li>
            <li>
              EPA gateway readiness (in later stages) &mdash; are we on track to book the EPA at the
              planned point?
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>EPA components for Installation and Maintenance Electrician:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              environment. AM2E adds the wider Electrotechnical scope; AM2S covers Solar PV and
              renewables.
            </li>
            <li>
              <strong>Multiple-choice knowledge tests</strong> &mdash; covering BS 7671, the Wiring
              Regulations, design principles, regulatory frameworks (HASAWA, CDM, Building
              Regulations).
            </li>
            <li>
              <strong>Professional discussion</strong> &mdash; a structured conversation with the
              EPAO assessor exploring portfolio examples, decision-making and reflective thinking.
              Demonstrates breadth beyond the AM2.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The AM2 day in summary:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Day 1</strong> &mdash; installation. Set up the bay, install containment, run
              cables, terminate, fit accessories. Time-pressured.
            </li>
            <li>
              <strong>Day 2</strong> &mdash; testing and inspection. Initial verification on the
              install you just did. Demonstrate the test sequence and complete certificates.
            </li>
            <li>
              <strong>Fault-finding</strong> &mdash; an introduced fault on a separate rig. Diagnose
              using meters and logical reasoning.
            </li>
            <li>
              <strong>Online elements</strong> &mdash; some knowledge questions and write-up may be
              online during or after the practical.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The main schemes:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>NICEIC</strong> &mdash; the oldest and largest scheme. Approved Contractor and
              Domestic Installer streams.
            </li>
            <li>
            ...
            <li>
              <strong>ELECSA</strong> &mdash; electrical-focused scheme, now operated by Certsure
              (the same company that operates NICEIC).
            </li>
            <li>
        ...
        >
          <p>What JIB membership does for an apprentice:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>JIB pay rate</strong> &mdash; the minimum hourly rate for your grade, annually
              negotiated between ECA (employer side) and Unite (worker side).
            </li>
            <li>
            ...
            <li>
              ...
              training, supervision, mentoring and grading progression for apprentices in JIB-graded
              firms.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The ECS card progression for an apprentice:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Apprentice card</strong> &mdash; issued during the apprenticeship. Requires
              CSCS-equivalent H&amp;S test pass and proof of registered apprenticeship.
            </li>
            <li>
            ...
            <li>
              <strong>Electrician card</strong> &mdash; post-AM2. The full Electrician JIB grade.
              Most common card on UK sites.
            </li>
            <li>
            ...
            <li>
              <strong>Technician card</strong> &mdash; additional formal qualifications (HNC, HND or
              degree) plus Approved status. Senior design and commissioning grade.
            </li>
            <li>
              <strong>Endorsements</strong> &mdash; specialist add-ons such as Solar PV (after AM2S)
              or EV Charging. Recorded on the same card.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                &quot;An apprenticeship agreement is an agreement entered into in connection with a
                recognised English framework or standard under which &mdash; (a) the apprentice
                undertakes to work for the other party (the employer) for reward, (b) the agreement
                is in the prescribed form, and (c) the agreement states that it is governed by the
          ...
          meaning={
            <>
              The apprenticeship agreement is a specific form of employment contract recognised by
              statute. It binds you and your Employer into the apprenticeship framework or standard
              and triggers the Employer&apos;s duty to provide the off-the-job training (currently a
              minimum of six hours per week on a 30-hour-week basis under the Apprenticeship
              Standards model). It&apos;s a serious contract &mdash; not a handshake. Treat it
              accordingly.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              HASAWA s.2(2)(c) is the explicit training duty on the Employer. It applies in full to
              apprentices &mdash; arguably more so than to fully-qualified electricians because the
              apprentice is &quot;in the process of obtaining&quot; competence and needs more
              training and supervision than a qualified colleague. An Employer who under-supervises
              an apprentice or who skips training is in breach of s.2(2)(c) and is also typically in
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                  Every apprentice has a named workplace Mentor who supports portfolio development
                  and on-site learning.
                </li>
                <li>
                  Apprentices are paired with an Approved Electrician for direct supervision of the
                  work face.
                </li>
                <li>
                  The apprentice attends college (day release or block) for the off-the-job learning
                ...
                <li>
                  Three-way reviews happen at agreed intervals between the apprentice, the college
                  tutor and the workplace mentor.
                </li>
              </ul>
            </>
          }
          meaning={
            <>
              The Code of Practice is paraphrased here from JIB-published guidance. It&apos;s not
              statute but it&apos;s the industry-standard expectation for JIB-graded firms and is
              commonly written into the apprenticeship contract itself. As an apprentice you can
              refer to the Code as evidence of what good supervision and training look like &mdash;
              and your Mentor and Tutor can use it to calibrate progress against the standard.
            </>
          }
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Charity raising mental health awareness across the construction industry. Training
                programmes, workplace toolkits and campaigning. matesinmind.org
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Free 24/7 Construction Industry Helpline (0345 605 1956). Financial grants, mental
                health support, crisis intervention for construction workers and families.
                lighthouseclub.org
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Financial and welfare support specifically for the electrical industry. Hardship
                grants, mental health support, family support and bereavement counselling.
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              Spends months in mock-AM2 environments, doesn&apos;t engage with the wider portfolio,
              doesn&apos;t prepare for the knowledge tests or the professional discussion. Passes
              the AM2 itself but then struggles in the discussion because they can&apos;t articulate
              the design decisions in their portfolio examples or explain how they applied BS 7671
              in real situations. The EPAO assessor flags the breadth gap. The apprentice has to
              re-take the discussion.
            </>
          }
          doInstead={
            <>
              Treat the EPA as a holistic assessment of the whole apprenticeship. The AM2 is the
              practical centrepiece but the knowledge tests and the professional discussion are
              equally weighted. Prepare across all three: practice the AM2, revise BS 7671 and the
              regulatory frameworks for the knowledge tests, and practice talking through your
              portfolio examples for the discussion. The three-way reviews are where you check
              you&apos;re prepared across all three strands &mdash; not just the AM2.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              review your College Tutor says &quot;you&apos;ve not done enough portfolio evidence in
              the last two months &mdash; I don&apos;t think you&apos;re on track for AM2 in the
              planned window&quot;. Your Workplace Mentor says &quot;he&apos;s been doing solid work
              on site every day &mdash; I think he&apos;s practically ready and the portfolio just
              needs writing up&quot;. You sit between them feeling pulled both ways and the meeting
              is getting tense.
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; surface the actual evidence</strong>. Both Tutor and Mentor are
              partially right. The Tutor sees the portfolio (the formal record); the Mentor sees the
              work face (the actual competence). The disagreement is usually about whether the
              formal record reflects the actual competence. Walk through the portfolio together and
              identify the specific gaps the Tutor is flagging.
              <br />
              <br />
              <strong>Step 2 &mdash; agree a write-up plan</strong>. If the Mentor is right that the
              practical work has been solid, the gap is in writing it up as portfolio evidence.
              Agree a specific number of portfolio entries to be drafted by the apprentice and
              signed by the Mentor in the next four weeks. Tutor reviews the drafts ahead of the
              next three-way.
              <br />
              <br />
              <strong>Step 3 &mdash; agree calibration moments</strong>. Schedule two additional
              check-ins (one Tutor-Apprentice, one Mentor-Apprentice) before the next full three-way
              to keep the work on track. Make sure the Employer&apos;s training lead is in the loop
              &mdash; if the off-the-job training time is insufficient that&apos;s their issue to
              fix.
              <br />
              <br />
              <strong>Step 4 &mdash; agree a contingency on AM2 booking</strong>. If the portfolio
              gap can&apos;t be closed, agree how the AM2 booking date moves. Be honest with
              yourself &mdash; rushing into AM2 underprepared and failing is worse than booking it
              three months later and passing first time. Tutor and Mentor will respect honesty about
              readiness more than they&apos;ll respect bravado.
              <br />
              <br />
              <strong>Step 5 &mdash; record the decision</strong>. Whatever you agree gets written
              up in the three-way review record so all four (Apprentice, Tutor, Mentor, Employer)
              are on the same page. The record protects everyone if the conversation gets revisited
              in three months.
            </>
          }
          whyItMatters={
            <>
              Tension between Tutor and Mentor is normal and is exactly what the three-way review is
              designed to resolve. Each has a piece of the picture: Tutor sees the portfolio and the
              academic record; Mentor sees the on-site competence; you see both. The apprenticeship
              triangle works because the disagreements get surfaced in a structured forum rather
              than left to fester. Bringing all three together and walking through the actual
              evidence is almost always how it resolves. Pretending the disagreement isn&apos;t
              happening is what kills apprenticeships.
            </>
          }
        />
        ...
        <Quiz
          title="Apprenticeship triangle and trade bodies — knowledge check"
