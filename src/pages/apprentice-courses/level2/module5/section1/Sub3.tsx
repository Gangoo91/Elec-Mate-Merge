...
const TITLE = 'Site visitors key roles (1.3) | Level 2 Module 5.1.3 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: [
      'Refuse to answer anything until your supervisor is present — an apprentice working alone has no obligation to speak to an inspector.',
      "Tell the inspector what you think they want to hear, embellishing the detail you're unsure of so the visit goes smoothly.",
      'Answer their direct factual questions politely, never speculate or lie, and ask to fetch your supervisor for anything substantive.',
      'Down tools and leave the area immediately so the inspector can examine your work undisturbed without you present.',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Whether the price charged to the customer was fair and whether the contracted completion date was met.',
      'Whether the electrician holds a current ECS card and is a paid-up member of a recognised trade union.',
      'Compliance with the Building Regulations 2010 — chiefly Approved Document P for electrical safety in dwellings.',
      "Whether the firm's public liability insurance is in date and a copy is displayed at the property.",
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "They prosecute the firm in the Magistrates' Court if any installation is found to fall short of BS 7671.",
      'They issue Improvement and Prohibition Notices under HASAWA, with the same statutory powers as an HSE inspector.',
      'They retest every installation the firm has completed in the past year and re-issue all the affected certificates.',
      "They review the firm's quality management system, sample-inspect recent jobs and certificates, and witness the Qualified Supervisor testing.",
    ],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'LABC inspectors check the full Building Regulations while Approved Inspectors check only electrical safety and nothing else.',
      'Both check Building Regulations compliance; LABC is the public-sector route while Approved Inspectors are private CICAIR-registered firms.',
      "An Approved Inspector is the more senior role and can overrule an LABC inspector's decisions on any project.",
      'LABC inspectors enforce health and safety law while Approved Inspectors enforce the Building Regulations side.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 2,
    question: 'Under HASAWA s.21 what is an Improvement Notice?',
    options: [
      'A notice that immediately stops a dangerous activity until the underlying risk has been removed.',
      'A notice issued by Building Control requiring an installation to be brought up to current BS 7671.',
      'A formal HSE notice requiring a contravention to be remedied within a specified period of at least 21 days.',
      'A notice warning a firm it may be removed from its competent-person scheme unless standards improve.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 3,
    question: 'Under HASAWA s.22 what is a Prohibition Notice?',
    options: [
      'A notice giving a firm 21 days to correct a paperwork failure such as missing risk assessments.',
      'A notice from Building Control preventing a building from being occupied until it is formally signed off.',
      "A notice from a competent-person scheme suspending a firm's right to self-certify Part P work.",
      'A formal HSE notice that prohibits an activity involving risk of serious personal injury, taking immediate effect.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To verify that design assumptions held up and that the pre-construction H&S information is being used.',
      'Because the PD takes over the day-to-day running of the site if the Principal Contractor is unavailable.',
      'Because the PD is responsible for inspecting and signing off the finished electrical installation.',
      'Because the PD must personally supervise every high-risk activity that is carried out on site.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  {
    id: 5,
    question: "What's the SOP for ANY visitor arriving on a CDM site?",
    options: [
      'Walk straight to the relevant work area, since signing in is only required for operatives working on site.',
      'Sign in, attend a brief visitor induction, wear correct PPE and be escorted by a competent person.',
      'Provide proof of relevant insurance and a copy of their own risk assessment before entering the gate.',
      'Pass an AM2 or equivalent competence test before being allowed anywhere on the construction site.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'They may walk the site freely without signing in, because the client owns the project and has automatic access.',
      'They must wait at the gate until the works are complete, as clients are never allowed on a live site.',
      'Sign in, get a brief visitor induction, wear correct PPE and be escorted — usually by the Project or Site Manager.',
      'They must be supervised by an HSE inspector at all times while they are on the construction site.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Because consumer unit changes are not notifiable work and so Building Control has no interest in them.',
      'Because the HSE, not Building Control, is the body that inspects all domestic electrical work in dwellings.',
      'Because the client must arrange their own inspection and Building Control never attends domestic jobs at all.',
      "Because the contractor's competent-person scheme self-certifies, and the Local Authority accepts that certificate.",
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Report it via your own chain — your Foreman first, escalating to the Site Manager if it's site-wide.",
      'Walk straight over to the HSE inspector and report it directly to them, bypassing your own management.',
      "Say nothing — it's in a different part of the site, so it's not really your responsibility to report it.",
      "Fix the hazard yourself immediately, even though it's outside your own work area and competence.",
    ],
    correctAnswer: 0,
    explanation:
...
const faqs = [
  ...
  {
    question:
      "What's the difference between an Environmental Health Officer (EHO) and an HSE Inspector?",
    answer:
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 1 · Subsection 3"
        title="Site visitors key roles"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Building Inspector, HSE Inspector, Local Authority EHO, scheme assessors, Designer, CDM
          Principal Designer, Client representative — who turns up on site, why and what they want
          from you.
        </p>
        ...
        >
          <p>The inspector's powers under HASAWA s.20 include:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Right of entry at any reasonable time (or without restriction in case of danger).
            </li>
            <li>Examination and investigation of the premises and equipment.</li>
            <li>Photographs, measurements, recordings and sampling.</li>
            <li>Taking possession of articles and substances for testing.</li>
            <li>Requiring the production of documents and copies.</li>
            <li>Taking statements (under caution if suspected of an offence).</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>When each notice is typically used:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Improvement Notice (s.21)</strong> &mdash; for contraventions that aren&apos;t
              immediately dangerous. Examples: incomplete RAMS, missing risk assessment for a noisy
              activity, inadequate welfare facilities, poor record- keeping on PAT.
            </li>
            <li>
              <strong>Prohibition Notice (s.22)</strong> &mdash; for activities involving (or likely
              to involve) risk of serious personal injury. Examples: working at height without edge
              protection, live electrical work without controls, unsafe scaffolding, unsafe
              excavation.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>EHOs typically deal with:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Workplace health and safety in offices, shops, restaurants, hotels.</li>
            <li>
              Food safety (separate function but often the same officer in smaller authorities).
            </li>
            <li>Public health, statutory nuisance, environmental protection.</li>
            <li>Some asbestos enforcement and some EAWR enforcement in their premises category.</li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;If an inspector is of the opinion that a person &mdash; (a) is contravening one
              or more of the relevant statutory provisions; or (b) has contravened one or more of
              those provisions in circumstances that make it likely that the contravention will
              continue or be repeated, he may serve on him a notice (in this Part referred to as
              &quot;an improvement notice&quot;) stating that he is of that opinion, specifying the
              provision or provisions as to which he is of that opinion, giving particulars of the
              reasons why he is of that opinion, and requiring that person to remedy the
              contravention or, as the case may be, the matters occasioning it within such period
              (ending not earlier than the period within which an appeal against the notice can be
              brought under section 24) as may be specified in the notice.&quot;
            </>
          }
          meaning={
            <>
              Improvement Notices are appealable to an Employment Tribunal within 21 days, but the
              burden is on the recipient to justify the appeal. Most notices are complied with
              rather than appealed. Failure to comply is itself an offence under s.33, carrying an
              unlimited fine and (on indictment) imprisonment up to two years.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the person on whom the notice is served, the activities involve or, as the case may
              be, will involve a risk of serious personal injury, the inspector may serve on that
              person a notice (in this Part referred to as &quot;a prohibition notice&quot;).&quot;
            </>
          }
          meaning={
            <>
              A Prohibition Notice can take immediate effect &mdash; the activity stops there and
              then. The threshold is &quot;risk of serious personal injury&quot;, which is a high
              bar but a familiar one to inspectors. Continuing to work after a Prohibition Notice
              has been served is itself an offence under s.33. As an apprentice, if a Prohibition
              Notice affects your work area, you stop, secure the area and fetch your supervisor.
            </>
          }
        ...
        >
          <p>What the Building Inspector checks on electrical work:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              inspected to BS 7671. Notifiable work includes consumer unit changes, work in special
              locations (bathrooms, kitchens with new circuits), and any new circuit.
            </li>
            <li>
              <strong>Approved Document B (Fire Safety)</strong> &mdash; fire alarms, emergency
              lighting, fire-rated penetrations where electrical containment passes through fire
              compartments.
            </li>
            <li>
            ...
            <li>
              <strong>Approved Document L (Energy)</strong> &mdash; lighting energy efficiency and
              metering.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The competent-person schemes typically encountered in electrical work:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>NAPIT</strong> &mdash; multi-trade competent-person scheme covering electrical
        ...
        >
          <p>When designers visit:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Periodic walk-rounds during construction (often weekly or fortnightly).</li>
            <li>
              Witness commissioning of larger systems (HV, BMS, fire detection, complex lighting
              controls).
            </li>
            <li>Change-control meetings on site when the client wants a variation.</li>
            <li>Hand-over walks before practical completion.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The PD's primary duties under CDM 2015 Reg 11:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Plan, manage, monitor and co-ordinate H&amp;S during the pre-construction phase.
            </li>
            <li>Identify, eliminate or control foreseeable risks via the design.</li>
            <li>Ensure designers comply with Reg 9.</li>
            <li>Prepare and provide the pre-construction information.</li>
            <li>Liaise with the Principal Contractor for the duration of the appointment.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Why the Client visits:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Programme verification &mdash; are we on track?</li>
            <li>Quality verification &mdash; does the work look right?</li>
            <li>Variation discussion &mdash; can we add or change scope?</li>
            <li>
              CDM duty &mdash; verifying that the suitable arrangements under Reg 4 are working.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 13(4)(b) is the legal hook for the visitor SOP &mdash; sign-in, escort and visitor
              induction are how the Principal Contractor discharges this duty in practice. Visitors
              who walk on site unaccompanied or without signing in are &quot;unauthorised
              persons&quot; for the purpose of this regulation. As an apprentice, if you spot
              someone in your work area who hasn&apos;t signed in, politely ask who they&apos;re
              with and direct them to the welfare cabin or fetch your Foreman.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice gets caught short by an HSE inspector questioning their lock-off procedure.
              Tries to embellish &mdash; &quot;oh yeah I always do it that way and we&apos;ve got
              the certificates somewhere&quot; &mdash; without actually knowing if the certificates
              exist or if the lock-off was correctly recorded. Inspector checks the records, finds
              the embellishment doesn&apos;t match reality, treats the whole company&apos;s evidence
              as suspect for the rest of the visit. The visit escalates from a routine inspection to
              a serious investigation. The apprentice gets a difficult conversation with their
              employer afterwards.
            </>
          }
          doInstead={
            <>
              Be politely factual. &quot;Yes I locked off, here&apos;s the lock and the key,
              here&apos;s the test cert.&quot; If you don&apos;t know, say &quot;I don&apos;t know,
              I&apos;ll fetch my supervisor&quot; &mdash; that&apos;s a perfectly acceptable answer.
              Never lie, never speculate, never try to look more knowledgeable than you are. HSE
              inspectors are experienced at spotting embellishment and they treat it as evidence of
              a wider problem. Politely factual + fetch the supervisor is the correct approach every
              time.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re working alone (paired Approved Electrician has popped to the loo) on a
              panel termination on the third floor of a commercial fit-out. An HSE inspector arrives
              unannounced at the welfare cabin downstairs, signs in, gets escorted up to your floor
              by the main contractor&apos;s Site Manager. They walk over to your work area. The
              inspector asks: &quot;can you talk me through the lock-off you&apos;ve got on this
              panel?&quot; Your supervisor isn&apos;t back yet. The Site Manager is standing next to
              the inspector but hasn&apos;t spoken.
            </>
          }
          whatToDo={
            <>
              <strong>Answer the direct factual question</strong> &mdash; show them the lock, the
              key, the LOTO tag if you&apos;ve used one, the test cert in your job pack that
              confirms safe-isolation. &quot;Yes I locked off at 8:30am, here&apos;s the lock,
              here&apos;s the test cert, here&apos;s my safe-isolation procedure in the RAMS
              pocket.&quot;
              <br />
              <br />
              <strong>Don&apos;t speculate or guess</strong> &mdash; if they ask anything you
              don&apos;t know (procedure across multiple panels, RIDDOR history, RAMS authorship),
              say &quot;I don&apos;t know &mdash; can I fetch my supervisor?&quot;. Asking is fine;
              guessing is dangerous.
              <br />
              <br />
              <strong>Don&apos;t lie under any circumstances</strong> &mdash; including small lies
              of embellishment. Inspectors check what you say against records and they treat any
              inconsistency as evidence of a wider problem.
              <br />
              <br />
              <strong>Ask to fetch your supervisor</strong> &mdash; politely. &quot;Could I grab my
              supervisor for the next bit?&quot; is a perfectly fine sentence. The inspector will
              usually wait. If your Approved Electrician is unreachable, the Site Manager standing
              there can fetch the Foreman or the Contracts Manager.
              <br />
              <br />
              <strong>Don&apos;t obstruct or refuse</strong> &mdash; HASAWA s.20 gives the inspector
              a statutory right to question you and refusing is itself an offence under s.33.
              Co-operate fully, just don&apos;t over-reach.
            </>
          }
          whyItMatters={
            <>
              HSE visits define the firm&apos;s record. An inspector who leaves with the impression
              of a well-run, honest, co-operative team writes a different report from one who leaves
              with the impression of an evasive operation. As an apprentice you can&apos;t make the
              visit go well by yourself, but you can avoid making it go badly. The rule of three
              &mdash; politely factual, never lie, fetch the supervisor &mdash; covers almost every
              scenario. RIDDOR-reportable items already in the system (because your firm reports
              promptly) will be cross-referenced; the inspector won&apos;t be surprised by anything
              if the firm&apos;s housekeeping is in order.
            </>
          }
        />
