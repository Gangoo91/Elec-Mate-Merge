...
const TITLE = 'Site diary and time sheets | Level 2 Module 5.3.5 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question: "Which records make up the apprentice's day-to-day paper trail?",
    options: [
  ...
  {
    id: 2,
    question: 'What is the specific purpose of the daily site diary, separate from the time sheet?',
    options: [
  ...
  {
    id: 6,
    question: "What does JIB grading have to do with the apprentice's records?",
    options: [
...
const faqs = [
  ...
  {
    question:
      "Do I have to fill in the off-the-job training log if my training provider doesn't ask for it?",
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Daily diary, weekly time sheet, NVQ portfolio, off-the-job training log, monthly review
          forms. What each record is for, who reads it, and what happens if it is blank.
        </p>
        ...
        >
          <p>The full chain you'll be expected to maintain:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Daily site diary</strong> — your contemporaneous record of what you did, who
              you worked with, what materials, what events. Source for the portfolio.
            </li>
            <li>
              <strong>Weekly time sheet</strong> — hours worked, signed by you and countersigned by
              the supervisor or employer. The basis of pay.
            </li>
            <li>
            ...
            <li>
              <strong>Off-the-job training log</strong> — record of all training activity outside
              normal productive work. Apprenticeship standards audit basis.
            </li>
            <li>
              <strong>Monthly apprentice review forms</strong> — record of the three-way meeting
              (you + employer + tutor / assessor). Progress audit.
            </li>
            <li>
            ...
            <li>
              ...
              permit records. Often kept by the principal contractor but you should know they exist.
            </li>
          </ul>
        </ConceptBlock>
            ...
            <div className="sm:hidden space-y-2">
              {[
                ...
                >
                  ...
                  <div className="mt-1 text-[12px] text-white/75">Purpose: {row.purpose}</div>
        ...
        >
          <p>What a typical daily diary entry should include:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Date and site address</strong> — non-negotiable on every entry.
            </li>
            <li>
              <strong>Hours</strong> — start, end, breaks. Cross-reference to the weekly time sheet.
            </li>
            <li>
            ...
            <li>
              <strong>Tasks and circuits</strong> — what you actually did, in detail. &quot;Worked
              on lighting&quot; isn&apos;t enough; &quot;first-fixed lighting circuits L1, L2, L3 in
              upstairs bedrooms, terminated at the consumer unit&quot; is.
            </li>
            <li>
              <strong>Materials</strong> — what you used, in particular anything unusual or not on
              the original spec.
            </li>
            <li>
              <strong>Variations or scope changes</strong> — the customer asked for an additional
              socket; the supervisor authorised an extra circuit.
            </li>
            <li>
              <strong>Incidents and near-misses</strong> — anything that should be flagged, even if
              minor.
            </li>
            <li>
              <strong>Learning</strong> — what you learnt or were taught (this feeds into portfolio
              entries and off-the-job hours).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The diary entry quality test &mdash; would it still be useful six months from now?</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Are circuits, accessories and equipment named specifically (model number, circuit
              reference, location) rather than generically?
            </li>
            <li>
              Are the people you worked with named (supervisor, second-year, other trades) with
              their role?
            </li>
            <li>
            ...
            <li>
              Are timings recorded for anything significant (start and end of overtime, isolation in
              / isolation out, induction time)?
            </li>
            <li>
              Are unusual events flagged (near-misses, customer disputes, equipment failures,
              deliveries delayed)?
            </li>
            <li>
              Is anything you learnt or were taught captured (this feeds straight into NVQ portfolio
              entries and off-the-job training hours)?
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What a standard weekly time sheet captures:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Week ending date.</li>
            <li>Daily start time, end time and unpaid break duration.</li>
            <li>Site / job reference for each day.</li>
            <li>
              Overtime hours separately recorded (any time outside standard contracted hours).
            </li>
            <li>Travel time where the JIB rules or your contract treats this as paid.</li>
            <li>Lodging or expenses claims where applicable.</li>
            <li>Apprentice signature and supervisor / employer countersignature.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>How a portfolio entry typically gets built:</p>
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Source from diary</strong> &mdash; identify the day(s) on which the relevant
              work happened. Pull the detail from the diary entries.
            </li>
            <li>
              <strong>Map to learning outcomes</strong> &mdash; identify which qualification units /
              ACs the work evidences. Most training providers supply a mapping template.
            </li>
            <li>
              <strong>Write the narrative</strong> &mdash; describe the work, your role, what you
              did, what you learnt. Specific and concrete.
            </li>
            <li>
              <strong>Attach evidence</strong> &mdash; photos of the completed work, copies of any
              certificates produced, supervisor or assessor sign-off.
            </li>
            <li>
              <strong>Submit for review</strong> &mdash; through the training provider&apos;s portal
              (OneFile, Smart Apprentices, similar). The assessor reviews and either accepts or asks
              for amendments.
            </li>
            <li>
              <strong>Repeat monthly</strong> &mdash; build the portfolio steadily across the full
              apprenticeship. Last-minute portfolio compilation in year three is visible to the EPA
              assessor and weakens the result.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>What counts as off-the-job training:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Structured study time</strong> — homework, revision, NVQ portfolio writing-up
              time.
            </li>
            <li>
              <strong>Shadowing</strong> — accompanying a more senior operative on a task outside
              your normal work area for learning purposes.
            </li>
            <li>
            ...
            <li>
              <strong>Mentoring and coaching</strong> — formal sessions with a tutor or assessor.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              apprenticeship. Off-the-job training is defined as &quot;learning that takes place
              outside the normal day-to-day working environment and leads towards the achievement of
              an apprenticeship&quot;. The apprentice and employer are jointly responsible for
              ensuring the requirement is met; the training provider is responsible for monitoring
              and reporting.
            </>
          }
          meaning={
            <>
              The 20% rule is funded under the apprenticeship levy and audited by the Education and
              Skills Funding Agency (ESFA). A log that shows substantial gaps triggers compliance
              action against the training provider, which feeds back to the employer and ultimately
              puts the apprenticeship at risk. As an apprentice your job is to keep the log current
              and to flag any month where off-the-job hours are clearly insufficient.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              The JIB (Joint Industry Board) Working Rules set the industry-standard grading, pay
              rates, overtime, travel time and lodging arrangements for the electrical contracting
              industry in England and Wales. The Apprentice Grading scheme tracks progression from
              year 1 through year 4 with grade-specific rates. Time sheets, portfolio evidence and
              JIB grading entries form the documentary basis for grade progression where the JIB
              rules apply.
            </>
          }
          meaning={
            <>
              Most reputable electrical contracting firms reference the JIB Working Rules in their
              apprentice contracts even where they aren&apos;t formal JIB members. The Apprentice
              Grading scheme is the industry-standard pay framework for apprentices. Keeping your
              records current is part of how you progress through the grades on time and at the
              right pay.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;The principal contractor must — (a) plan, manage and monitor the construction
              phase and coordinate matters relating to health and safety during the construction
          ...
          meaning={
            <>
              ...
              principal contractor on notifiable construction sites. In practice this includes site
              sign-in / sign-out registers, attendance at toolbox talks, RAMS sign-on records and
              permit records. From the apprentice&apos;s perspective these PC records supplement and
              reinforce your own (diary, time sheet) and form a fuller, mutually corroborating
              record set.
            </>
          }
        ...
        >
          <p>Common digital tools used by UK electrical firms:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Procore mobile</strong> — full construction management; common on larger
              commercial fit-outs.
            </li>
            <li>
              <strong>Sypol / Alcumus</strong> — COSHH register, RAMS sign-on, training records.
            </li>
            <li>
              <strong>Training-provider portals</strong> — typically include a portfolio builder and
              off-the-job training log (e.g. OneFile, Smart Apprentices).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              they&apos;ll fill in the diary on Friday afternoon when things calm down. By Friday
              the days have blurred together &mdash; they remember roughly what they did, but not
              which specific circuits, not the materials they used, not the conversation with the
              customer about the extra socket, not the near-miss with the loose joist. The Friday
              entry becomes a vague summary that&apos;s useless for the portfolio and weak as
              evidence in any later dispute. Repeated weekly, this produces a thin diary across the
              entire apprenticeship and a thin portfolio at the EPA.
            </>
          }
          doInstead={
            <>
              Five minutes at the end of every shift &mdash; in the van before you drive home, in
              the kitchen with a cup of tea on arrival, on the phone in the moment. Whatever the
              format (paper notebook, app, voice memo transcribed later), the discipline is daily,
              not weekly. The detail you capture in those five minutes is what makes the diary worth
              having; the detail you lose by Friday is what makes the catch-up version useless. By
              year three the daily habit is automatic.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              supervisor asked you to come in, you went, you worked the day, you went home. Time
              sheet was submitted normally and pay arrived as expected. Now there&apos;s an HR
              review at the firm and a question has been raised about overtime authorisation that
              day. The supervisor who asked you in has since left the firm and is denying he ever
              authorised it. The firm is suggesting your overtime that day was unauthorised and may
              need to be clawed back.
            </>
          }
          whatToDo={
            <>
              Three pieces of contemporaneous evidence save you. First: your daily site diary entry
              for that Saturday &mdash; date, address, hours, supervisor name, what you did, who
              else was there. Second: the weekly time sheet for that week with Saturday hours
              recorded and the supervisor&apos;s countersignature on the sheet. Third: any digital
              trail (text message from the supervisor asking you in, WhatsApp confirmation, call log
              on your phone, app entry from the firm&apos;s job system). Combine the three and the
              dispute resolves quickly &mdash; the evidence is contemporaneous, witnessed, and
              corroborated across multiple sources. Without them, you&apos;re relying on memory
              against the firm&apos;s position. The HR review is exactly the situation the records
              exist for. Submit them in writing through the firm&apos;s grievance procedure.
            </>
          }
          whyItMatters={
            <>
              Pay disputes after the fact are one of the harder situations an apprentice can end up
              in. The Employment Rights Act 1996 protects you from detriment for raising the issue,
              but you still need evidence of what actually happened. The site diary, the
              countersigned time sheet and the digital trail are the evidence. Apprentices who keep
              them current are protected; apprentices who don&apos;t end up arguing from memory and
              losing.
            </>
          }
        />
        ...
        <Quiz title="Site diary and time sheets — knowledge check" questions={quizQuestions} />
