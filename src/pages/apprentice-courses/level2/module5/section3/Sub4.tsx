...
const TITLE = 'Manufacturer instructions (Reg 526.1 + warranty) | Level 2 Module 5.3.4 | Elec-Mate';
const DESCRIPTION =
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 7671 Reg 526.1 ties durable connections to manufacturer instructions. Torque values,
          ferrule requirements, sequence — reading the data sheet is part of the regs, not optional
          reference.
        </p>
        ...
        >
          <p>The chain of regulations governing manufacturer-instruction compliance:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 510.3</strong> — equipment shall be selected and erected to allow
              compliance with the regs and shall take account of manufacturers' instructions. The
              bridge.
            </li>
            <li>
              <strong>Reg 526.1</strong> — every connection shall provide durable electrical
              continuity and adequate mechanical strength and protection. The connection regulation
              that depends on torque and termination method.
            </li>
            <li>
            ...
            <li>
              <strong>Reg 132.13</strong> — the designer shall provide the information necessary for
              safe operation, inspection and maintenance. Mfr data is part of that information pack.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 526.1 is the headline connection regulation. &apos;Durable&apos; means it stays
              good over time. &apos;Adequate mechanical strength&apos; means it doesn&apos;t fail
              under foreseeable stress. &apos;Protection&apos; covers the electrical and physical
              containment. All three depend on doing the connection the way the manufacturer
              designed it &mdash; correct conductor preparation, correct torque, correct ferrules
              where specified, correct sequence. Skip any of those and the connection is not
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              code-compliant install. The phrase &apos;take account of&apos; has been interpreted in
              industry practice as &apos;follow unless there&apos;s a documented reason not to&apos;
              &mdash; ignoring the instructions is not an option that the regulation contemplates.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              erection of the electrical installation. Such installation shall include all items of
              electrical equipment selected as defined in Chapter 51 ...&quot;
            </>
          }
          meaning={
            <>
              Reg 134.1.1 is the workmanship test. &apos;Good workmanship&apos; is a flexible term
              but in practice it covers correct torque, neat terminations, secure containment,
              conductor preparation, proper labelling, and the visible quality of the install. An
              EICR observation of poor workmanship will typically cite Reg 134.1.1 alongside the
              more specific regulation that the poor workmanship caused a breach of (Reg 526.1 for a
              poor connection, Reg 522 for poor mechanical protection).
            </>
          }
        ...
        >
          <p>The four properties of a Reg 526.1-compliant connection:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Durable electrical continuity</strong> &mdash; the connection conducts current
              with low and stable resistance over the install&apos;s life. Depends on clean
              conductors, correct preparation, and the manufacturer&apos;s specified contact
              pressure.
            </li>
            <li>
              <strong>Adequate mechanical strength</strong> &mdash; the connection holds under
              foreseeable mechanical stress (vibration, thermal cycling, conductor tension). Depends
              on torque value and any ferrule / strain-relief provisions.
            </li>
            <li>
              <strong>Adequate protection</strong> &mdash; the connection is protected from contact,
              ingress and mechanical damage. Depends on the enclosure, IP rating and termination
              accessibility.
            </li>
            <li>
              <strong>Operating-life durability</strong> &mdash; pulls in material compatibility
              (don&apos;t mix dissimilar metals without protection), thermal compatibility
              (don&apos;t terminate inside a hot enclosure with heat-sensitive conductors), and
              environmental compatibility (correct IP rating for the location).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <div className="space-y-3">
            <p className="text-[14px] leading-relaxed">
              Typical domestic CU torque values across the major UK brands — table for desktop, card
              list for mobile. Always verify against the specific product data sheet.
            </p>
              ...
              {[
                ...
                >
                  ...
                  <div className="text-[12px] text-white/75">
                    Incomer / busbar: <span className="text-elec-yellow/90">{row.incomer}</span>
                  </div>
            ...
            <p className="text-[12px] text-white/55 italic leading-relaxed">
              These values are typical examples for domestic consumer-unit terminations. They are
              not a substitute for the manufacturer&apos;s current data sheet for the specific
              product you are installing. Values can change between product revisions &mdash; verify
              before every job.
            </p>
          </div>
        </ConceptBlock>
        ...
        >
          <p>The professional kit and care:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Range</strong> &mdash; 0.5&ndash;5 Nm covers most domestic CU work (circuit
              terminals 1.0&ndash;1.2 Nm, incomers up to 3.5 Nm). Industrial work often needs a
              higher-range unit (5&ndash;25 Nm) as well.
            </li>
            <li>
              <strong>Click action</strong> &mdash; an audible click at the set value signals
              you&apos;ve reached torque. Don&apos;t keep turning after the click.
            </li>
            <li>
              <strong>Calibration</strong> &mdash; annual recalibration is the standard. The service
              centre supplies a calibration certificate; keep it with your tools.
            </li>
            <li>
            ...
            <li>
              ...
              manufacturer (usually a specific Pozidriv or hex). Wrong bit = damaged terminal head.
            </li>
            <li>
              <strong>Don&apos;t double-up</strong> &mdash; don&apos;t use the torque screwdriver as
              a regular driver between calibrations. The shock loading shortens its useful life.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Connection method by typical product type:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Domestic CU RCBO / MCB</strong> — typically screw terminals. T&amp;E up to
              6mm² straight in. Stranded panel wire above 1mm² often needs a ferrule per the data
              sheet.
            </li>
            <li>
              <strong>Industrial / commercial board</strong> — typically cage clamp on control gear,
              screw on power. Ferrules effectively standard on stranded conductors.
            </li>
            <li>
              <strong>Switchgear / contactors</strong> — varies. Some manufacturers require ferrules
              above 0.5mm² stranded; others above 1mm² or 2.5mm². Always read the data sheet.
            </li>
            <li>
              <strong>EV charger / solar inverter terminals</strong> — typically heavy-duty screw
              terminals with strict torque values. Ferrules mandatory on stranded conductors.
              Warranty depends on it.
            </li>
            <li>
              <strong>Accessories (sockets, switches)</strong> — typically screw terminals. Solid
              T&amp;E straight in. Stranded flex usually needs preparation per the accessory
        ...
        >
          <p>The six places, ranked by speed of access on site:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Inside the CU lid</strong> &mdash; printed label with the headline torques.
              Quick reference; not the full data sheet.
            </li>
            <li>
              <strong>Manufacturer&apos;s website</strong> &mdash; always the latest version. Most
              have a downloads section indexed by product.
            </li>
            <li>
              <strong>Original packaging insert</strong> &mdash; if you still have the packaging
              from when the unit was unboxed.
            </li>
            <li>
              <strong>Wholesaler&apos;s product portal</strong> &mdash; CEF, City Electrical
              Factors, Edmundson, Rexel and others publish data sheets on their product pages.
            </li>
            <li>
              <strong>Trade reference apps</strong> &mdash; cross-product references for checking
              when you can&apos;t find the manufacturer&apos;s own.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Where warranty conditions typically bite:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Torque value</strong> — &quot;installed in accordance with the data sheet
              torque specifications&quot; is a standard warranty condition. Records of torque value
              used, screwdriver ID and date are evidence in dispute.
            </li>
            <li>
              <strong>Product registration</strong> — common on EV chargers, solar inverters and
              some heat pumps. Failure to register within (typically) 30 days voids extended
              warranty.
            </li>
            <li>
              <strong>Environmental conditions</strong> — IP rating, temperature range, humidity.
              Installing an indoor-rated unit outdoors voids warranty. Section 9 of the data sheet
              gives the limits.
            </li>
            <li>
              <strong>Connection type</strong> — using twisted strands where ferrules are specified,
              using the wrong cable type, exceeding the conductor CSA limit. All deviations from the
              data sheet.
            </li>
            <li>
              <strong>Commissioning</strong> — some manufacturers require specific commissioning
              steps (test sequence, firmware update, configuration). Skipping them voids warranty.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Where the torque value typically gets recorded:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Schedule of test results</strong> &mdash; many firms add a torque column or a
              tick box per circuit. The schedule is part of the BS 7671 Reg 132.13 handover pack, so
              the torque record travels with the install.
            </li>
            <li>
              <strong>Photo evidence</strong> &mdash; a quick phone photo of the torque screwdriver
              (showing the set value) next to the completed termination, with the CU label in shot
              for context.
            </li>
            <li>
              <strong>Digital app entry</strong> &mdash; firms using job-management apps (Tradify,
              Powered Now, Procore) typically have a place to log torque values and tool serial
              numbers per termination.
            </li>
            <li>
              <strong>Tool calibration record</strong> &mdash; the calibration certificate for the
              torque screwdriver, kept with the firm&apos;s QA records. Links the actual torque
              applied to a calibrated instrument with traceability.
            </li>
            <li>
              <strong>Manufacturer registration</strong> &mdash; for products requiring registration
              for extended warranty (EV chargers, solar inverters), the registration record itself
              confirms install in accordance with the data sheet.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice and electrician are completing a CU change late in the day. The calibrated
              torque screwdriver has been left in the other van. The electrician says &quot;just nip
              them up firm, it&apos;ll be fine&quot;. The apprentice tightens the circuit terminals
              as instructed. Six months later one of the circuits starts tripping intermittently
              under load; investigation finds the terminal screw is loose and the conductor has been
              crushed. The fault wasn&apos;t a defect in the RCBO &mdash; it was the termination.
              The manufacturer refuses the warranty claim because the install records don&apos;t
              show torque values. The firm pays for the replacement RCBO, the call-out, and the
          ...
          doInstead={
            <>
              ...
              standard. If the calibrated tool isn&apos;t available, the work doesn&apos;t start.
              &quot;Nip them up firm&quot; isn&apos;t a defensible installation method under BS 7671
              Reg 526.1 or under any manufacturer warranty. Record the torque value used (a tick on
              the schedule of test results, or a photo of the screwdriver next to the completed
              termination, is enough). The discipline takes seconds; the alternative is the
              call-back and the warranty fight.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re terminating a 6mm² twin-and-earth into a Hager RCBO during a CU change.
              You&apos;ve isolated, proved dead, prepared the conductors (stripped to the right
              length, sleeved the CPC). The supervisor is on the phone in the kitchen. You
              don&apos;t remember the torque value off the top of your head and the lid label has
              been removed during the work.
            </>
          }
          whatToDo={
            <>
              ...
              installation section (typically around 1.2 Nm for the circuit terminals). Second: the
              manufacturer&apos;s website &mdash; data sheets are typically in the downloads
              section. Third: the data sheet inside the RCBO packaging &mdash; if you still have it.
              Set the calibrated torque screwdriver to the specified value (for an unknown product,
              default to 1.2 Nm circuit / 3.5 Nm incomer pending confirmation). Make the
              termination, listen for the click, record the value used on the schedule of test
              results. If you&apos;re uncertain about any aspect of the data sheet (e.g. whether
              ferrules are needed for a stranded conductor), stop and ask the supervisor before
              completing.
            </>
          }
          whyItMatters={
            <>
              The pre-termination data-sheet check is one of the cleanest professional habits you
              can build. It takes 30 seconds, removes any ambiguity about the value, creates a
              record (the schedule entry), and protects the firm against warranty fights.
              Apprentices who build the habit early carry it through their career; those who
              don&apos;t end up either guessing or being challenged on terminations they made years
              ago.
            </>
          }
        />
