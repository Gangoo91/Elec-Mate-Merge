...
const TITLE = 'Reading RAMS and method statements | Level 2 Module 5.3.2 | Elec-Mate';
const DESCRIPTION =
...
const faqs = [
  ...
  {
    question:
      "What if I notice halfway through a task that the RAMS doesn't actually cover what I'm doing?",
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          How to read a RAMS like a tradesperson, not skim it like a chore. Generic vs
          site-specific, sign-on responsibility, and stopping work when the document does not match
        ...
        >
          <p>The two halves and what each contains:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Risk Assessment</strong> — hazard, who is at risk, current controls,
              likelihood / consequence rating, residual risk after controls, additional actions.
            </li>
            <li>
              <strong>Method Statement</strong> — scope of work, sequence of operations, tools, PPE,
              access kit, persons affected, emergency response, sign-on.
            </li>
            <li>
              <strong>Cover sheet</strong> — site, date, contract reference, author, version, review
              date, sign-on grid for every operative on the task.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              employees AND non-employees affected by the work. Reg 3(6) is the recording duty for
              firms of five or more. Almost every electrical contracting firm crosses that threshold
              so written RAMS are effectively required across the contracting industry. The HSE
              inspector after an incident asks &apos;show me your risk assessment&apos; — and if the
              answer is &apos;we didn&apos;t write one&apos; or &apos;here&apos;s a generic
              template&apos;, that&apos;s the start of an investigation that doesn&apos;t end well.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              include in particular — (a) the provision and maintenance of plant and systems of work
              that are, so far as is reasonably practicable, safe and without risks to health.&quot;
            </>
          }
          meaning={
            <>
              HASAWA s.2(2)(a) is the umbrella duty on the employer to provide a safe system of
              work. The RAMS is how that safe system is documented and communicated for a specific
              activity. A &apos;system of work&apos; that exists only in the supervisor&apos;s head
              doesn&apos;t satisfy the duty. The RAMS turns the abstract obligation in s.2 into a
              specific, auditable instruction set for a specific job.
            </>
          }
        ...
        >
          <p>The audiences for a RAMS, in order of how often they read it:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>The operatives</strong> — every time the work is done. Daily on a long-running
              job.
            </li>
            <li>
            ...
            <li>
              <strong>The principal contractor</strong> — at induction, at periodic site audit, at
              any incident.
            </li>
            <li>
              <strong>The firm&apos;s H&amp;S officer</strong> — at internal audit, at any near-miss
              review.
            </li>
            <li>
              <strong>The HSE inspector</strong> — at any reactive visit, after any incident. Treats
              a defective RAMS as evidence of a wider H&amp;S culture problem.
            </li>
            <li>
              <strong>The insurance assessor</strong> — after any claim. A defective RAMS can affect
        ...
        <RegsCallout
          ...
          meaning={
            <>
              HASAWA s.7 is the personal duty on every operative &mdash; including apprentices. Two
              limbs: take reasonable care, and co-operate with the employer&apos;s safety
              arrangements. In RAMS terms that means reading the document, working to it, raising
              defects, and not working outside the documented controls. &apos;Following orders&apos;
              from a supervisor who authorises an unsafe deviation isn&apos;t a defence to an s.7
              prosecution. The personal duty exists precisely to prevent that argument.
            </>
          }
        ...
        >
          <p>The recommended scan order:</p>
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cover sheet</strong> — site address, contract reference, date, version number,
              author, review date. Wrong site or out-of-date version = stop.
            </li>
            <li>
              <strong>Scope of work</strong> — read the description of what's covered. Does it match
              what you're being asked to do today? Activities outside the scope = stop.
            </li>
            <li>
              <strong>Hazards identified</strong> — do they include the hazards you can see on site?
              If a hazard is missing (e.g. live cables on a refurb when the document only mentions
              new install) = raise it.
            </li>
            <li>
            ...
            <li>
              <strong>Persons affected</strong> — does it cover everybody actually on or near the
              work area? Missing trades / public / customer = raise it.
            </li>
            <li>
              <strong>Emergency response</strong> — assembly point, first aiders, route to A&amp;E,
              isolation procedure if a circuit needs killing fast.
            </li>
            <li>
              <strong>Sign-on</strong> — only after the above is satisfactory. Once your signature
              is on the sheet you've adopted the document.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>What signing on commits you to:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              You have read the document, including the risk assessment, the method statement and
              the appendices.
            </li>
            <li>
              You understand the hazards identified, the controls in place and the working method.
            </li>
            <li>
              You will work to the documented method, will not deviate without authorisation, and
              will use the controls (PPE, access kit, permits) as specified.
            </li>
            <li>
              You will raise anything on site that doesn't match the document — additional hazards,
              missing equipment, conditions outside the assumed scope.
            </li>
            <li>
              If the document is later challenged in any forum, your signature is evidence the
              briefing happened.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The method-statement read-through checks:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Does each step name a specific action (not &quot;install electrical equipment&quot;
              but &quot;terminate the 6mm² T&amp;E into the new RCBO at 1.2 Nm using a calibrated
              torque screwdriver&quot;)?
            </li>
            <li>
              Are isolation, lock-off and proof-of-dead steps present and in the right place (before
              any live work)?
            </li>
            <li>
              Are functional checks specified after terminations (e.g. RCBO test button, continuity
              check, polarity)?
            </li>
            <li>
              Are the access kit and PPE specified for each step that needs them, not just at the
              start of the document?
            </li>
            <li>
              Is the customer / client / public-protection arrangement clear (barriers, warning
              notices, communications)?
            </li>
            <li>
              Is the end-of-shift handover specified (lock-off retained, work area secured, customer
              briefed)?
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Tell-tale signs of a template-trap RAMS:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Same scope wording across jobs</strong> — &quot;electrical installation works
              to current edition of BS 7671&quot; with no actual task description.
            </li>
            <li>
              <strong>Generic hazard list</strong> — &quot;electrical, working at height, manual
              handling, slips and trips&quot; with no site-specific hazards from the walk-round.
            </li>
            <li>
            ...
            <li>
              <strong>No reference to specific access kit</strong> for working-at-height tasks (just
            ...
            <li>
              <strong>No emergency response section</strong> — assembly point, first aiders, route
              to A&amp;E.
            </li>
            <li>
              <strong>Identical wording</strong> across the firm&apos;s portfolio when you compare
              RAMS from different jobs.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The escalation routine when you spot a mismatch:</p>
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stop work</strong> — don't continue while the mismatch is unresolved.
            </li>
            <li>
              <strong>Raise it in writing</strong> — text, email, app comment. Be specific: what
              does the RAMS say, what's actually on site, what's the gap.
            </li>
            <li>
              <strong>Wait for response</strong> — the supervisor either clears the obstruction
              (sources the right access kit, isolates the live circuit, removes the missing control)
              or formally amends the RAMS and re-signs everyone.
            </li>
            <li>
              <strong>Don't restart on a verbal</strong> — &quot;just do it the old way&quot; from
              the supervisor doesn&apos;t change the documented safe system of work.
            </li>
            <li>
              <strong>If unresolved, escalate up the chain</strong> — your supervisor's supervisor,
              your firm's H&S officer, your training provider's tutor.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>Why the calculus favours escalation:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>The cost of raising a defect = five minutes of writing.</li>
            <li>
              The cost of not raising and the work going wrong = anywhere from a snag list to an HSE
              prosecution. Often weeks of unpicking.
            </li>
            <li>
              Raising it creates a record that protects you personally if the work later goes wrong.
            </li>
            <li>
              Raising it triggers the supervisor&apos;s duty under HASAWA s.2 to provide a safe
              system of work &mdash; you&apos;ve put the issue on their desk.
            </li>
            <li>
            ...
            <li>
              Most supervisors react reasonably. The ones who don&apos;t are the ones the protection
              exists for.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              operatives are queuing to sign on. The supervisor is moving fast. The apprentice signs
              the sheet without reading the document, picks up the toolbox, and heads to the work
              area. Two hours in, an incident occurs — a foreseeable hazard that was actually
              flagged in the RAMS but not communicated verbally. The HSE inspector arrives, asks who
              was briefed and how, and the sign-on sheet shows the apprentice as briefed. The
              defence &quot;I didn&apos;t read it&quot; is gone the moment the signature appears.
            </>
          }
          doInstead={
            <>
              Two minutes of reading at the briefing is non-negotiable. If the supervisor is moving
              too fast, ask politely for the time to read before signing — most supervisors will
              accept it precisely because they know what it means if you signed without reading. If
              the queue is long, take the document with you to a quiet corner, read it, and sign
              when you&apos;re ready. The signature is a positive declaration; treat it as one.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re asked to install a new patch panel in a small comms cupboard at the back
              of a commercial unit. The RAMS handed to you is the firm&apos;s generic &quot;working
              at height&quot; template — it lists ladders, podiums and towers as &quot;suitable
              equipment&quot; with no specification of which one for this task. The cupboard is
              partly full of stored boxes, has poor lighting, and the only access kit on site this
              morning is a fibreglass step ladder. The supervisor says &quot;just use the step
              ladder, it&apos;ll be fine for an hour&apos;s work&quot;.
            </>
          }
          whatToDo={
            <>
              Stop and raise it in writing. The RAMS is generic — it doesn&apos;t name the podium
              that the actual task needs (the WAHR 2005 Reg 6 hierarchy puts a podium above a ladder
              for short-duration light work in a confined space). The cupboard conditions (boxes,
              poor lighting) are additional hazards not addressed. The verbal instruction to use the
              step ladder is an undocumented deviation from any proper safe system of work. Text the
              supervisor: &quot;The RAMS for the patch panel install is generic and doesn&apos;t
              cover the specific access in cupboard X. Boxes need clearing, lighting needs a
              temporary task light, and the access kit needs to be a podium per WAHR Reg 6. Please
              can the RAMS be amended and the kit sourced before I start?&quot;. Then wait. The five
              minutes of writing discharges your HASAWA s.7 duty and your s.44 protection kicks in
              if the supervisor pushes back.
            </>
          }
          whyItMatters={
            <>
              The combination of a generic RAMS, a confined working area and a verbal instruction to
              substitute equipment is the textbook setup for a fall-from-height incident. The HSE
              has prosecuted contractors and individual operatives in exactly these circumstances.
              The five-minute pause to raise it in writing is the difference between a documented
              safe system and an injury. Apprentices feel pressure not to push back; the legal
              protection in s.44 exists precisely for that pressure.
            </>
          }
        />
        ...
        <Quiz title="Reading RAMS — knowledge check" questions={quizQuestions} />
