...
const faqs = [
  {
    question: "Aren't labels just decoration? Surely the wiring is what matters?",
    answer:
  ...
  {
    question: "What's the difference between a BS 951 label and a generic 'do not remove' sticker?",
    answer:
  ...
  {
    question: 'What about labels in plain English vs symbols only — do the regs say anything?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Supplementary to Unit 210 — the install itself is a regulated form of communication.
          Labels are how the install talks to whoever opens the CU next.
        </p>
        ...
        <div className="rounded-2xl border border-amber-500/30 bg-amber-500/[0.06] p-4 text-[13px] text-amber-200/90 leading-relaxed">
          ...
          <p>
            ...
            specific 210 assessment criterion. It builds the install-as-communication layer that
            connects BS 7671 (Section 514) to the broader 210 themes about how information flows on
            a job. Knowledge here is also examinable under Modules 6 (Inspection &amp; Testing) and
            Unit 210 communication ACs.
          </p>
        </div>
        ...
        >
          <p>Three audiences a label set has to serve:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>The customer in an emergency</strong> — burning smell at 11pm, needs to find
              and operate the main switch. The label is the rapid-find tool.
            </li>
            <li>
              <strong>The next electrician on a fault visit</strong> — opens the CU and needs to
              understand the layout before touching anything. The schematic and circuit labels are
              their orientation.
            </li>
            <li>
              <strong>The EICR engineer in five years</strong> — formally inspecting the install and
              recording compliance with BS 7671 as it stood at the date of installation. Missing
              labels = non-conformances on the report.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Where the 514.13.1 notice is required:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              At every connection of an earthing conductor to an earth electrode (TT installs).
            </li>
            <li>
              At every connection of a bonding conductor to an extraneous-conductive-part (gas-meter
              bond, water-stopcock bond, structural-steel bond, lightning protection bond).
            </li>
            <li>
              At the main earthing terminal where it's separate from the main switchgear (common in
              installs with a remote MET).
            </li>
            <li>
              The notice may be provided on the clamp itself (BS 951 plate) or on the warning label
              provided with the clamp. Either is compliant.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Wording per the reg:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              "The protective bonding conductors associated with the electrical installation in this
              location MUST NOT BE CONNECTED TO EARTH."
            </li>
            <li>
              "Equipment having exposed-conductive-parts connected to earth must not be brought into
              this location."
            </li>
            <li>
              Notice must be durably marked, securely fixed, in a visible position at the relevant
              location.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What the notice needs to communicate:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>The presence of more than one supply, with each supply identified.</li>
            <li>
              The location of each isolation point (PV DC isolator, battery isolator, generator
              changeover switch).
            </li>
            <li>
              That opening the main switch does NOT necessarily isolate the entire installation.
            </li>
            <li>
              The procedure required to safely isolate the install for work (e.g. open main switch +
              open PV DC isolator + lock-off both).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What a domestic schematic should contain (minimum):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Circuit number, description (e.g. "R1 — kitchen ring", "L2 — upstairs lighting").
            </li>
            <li>Protective device type and rating (RCBO 32A B, etc.).</li>
            <li>
              Cable size and type if it deviates from the assumed (e.g. 4mm² rather than 2.5mm² on a
              long ring run).
            </li>
            <li>RCD grouping if circuits share an upstream RCD.</li>
            <li>
              Any specific notes (e.g. "circuit serves outdoor sockets — RCD-protected at consumer
              unit AND at socket").
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <p className="mb-1">
                ...
                extraneous-conductive-part; and
              </p>
              <p className="mb-2">
          ...
          meaning={
            <>
              Reg 514.13.1 is the canonical label reg for an apprentice. Three locations, exact
              wording, BS 951-aligned plates. The reg uses &quot;clearly and durably marked&quot;
              and &quot;securely fixed in a visible position&quot; &mdash; both phrases are testable
              on EICR. Missing labels are normally C3 (improvement recommended) but escalate to C2
              where the absence creates real risk of the connection being inadvertently disturbed
              (e.g. plumber thinking the bond clamp is a redundant earth strap and removing it). On
              every CU change, every consumer unit job, every install you walk away from &mdash;
              check every location and replace any missing or degraded label.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              provided indicating in particular the type and composition of each circuit (points of
              utilisation served, number and size of conductors, type of wiring), the method used
              for protection against electric shock, the information necessary for the
              identification of devices performing the functions of protection, isolation and
              switching and their location, and any circuit or equipment vulnerable to a typical
              electrical test. For simple installations a simplified equivalent is acceptable for
              domestic (household) premises.
            </>
          }
          meaning={
            <>
              Reg 514.9.1 is the schematic / circuit-list reg. The &quot;simplified equivalent&quot;
              exception for domestic is what allows a laminated A4 inside the CU door instead of a
              full CAD diagram. The reg explicitly mentions that the diagram supports identification
              of devices for protection, isolation and switching &mdash; the next electrician needs
              this to safely work on the install. For larger or more complex installs (commercial,
              multi-supply, anything with sub-boards or unusual circuits) the schematic needs to be
        ...
        >
          <p>The apprentice's standard label checklist for a CU change:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Main earthing terminal — BS 951 'Safety Electrical Connection' notice fitted and
              legible.
            </li>
            <li>Gas-meter bond clamp — BS 951 plate fitted and visible.</li>
            <li>Water-stopcock bond clamp — BS 951 plate fitted and visible.</li>
            <li>
              Any other bonded extraneous part (structural steel, oil tank, lightning protection) —
              BS 951 plate fitted.
            </li>
            <li>CU door — RCD test notice fitted (where applicable).</li>
            <li>CU door — single-line diagram / circuit list laminated and fitted inside.</li>
            <li>
              Each MCB/RCBO — circuit identification label fitted (kitchen ring, upstairs lights,
              etc.).
            </li>
            <li>
              Isolators — labelled to indicate function (e.g. 'PV DC isolator', 'EV charger', 'shed
              sub-circuit').
            </li>
            <li>Mixed-supply notice fitted where PV / battery / generator present.</li>
            <li>SPD presence label fitted (commercial; optional but good practice in domestic).</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Typical EICR codes for label issues:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Missing main-earth notice (514.13.1) — typically C3, escalates to C2 where disturbance
              risk is real.
            </li>
            <li>Missing bonding-clamp notice — typically C3.</li>
            <li>Illegible / faded notices — C3.</li>
            <li>Missing schematic / circuit list (514.9.1) — C3.</li>
            <li>Inadequate or missing circuit identification — C3.</li>
            <li>
              Missing mixed-supply notice (PV/battery present) — C2 (real safety issue) escalating
              to C1 only in unusual cases of immediate danger.
            </li>
            <li>
              Missing isolator labels — C3, escalating to C2 where ambiguous isolation creates real
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice finishes a CU change late on a Friday and rushes the close-out. Schematic
              isn&apos;t laminated, just slid into the CU door. Main-earth notice isn&apos;t
              replaced because the original looked &quot;fine&quot;. Circuit labels are hand-written
              sticky notes that won&apos;t survive a year in a heated meter cupboard. Two years
              later the property gets an EICR and the inspector codes the lot as C3s &mdash; the
              customer comes back to the firm asking why the install they paid £900 for is now
              showing as &quot;unsatisfactory in part&quot;. Reputation hit, free remediation visit,
              lost referral.
            </>
          }
          doInstead={
            <>
              Build the label set into your end-of-job procedure. Print labels off-site and bring
              them with you. Use a label-printer for circuit IDs. Use BS 951 plates for
              earthing/bonding (most clamps ship with one already attached). Laminate the schematic.
              Do the labels FIRST (so they&apos;re ready to fix as you finish each section) rather
              than last. Allocate 10-15 minutes at the end of the job specifically for the label
              sweep. The five minutes you save by skipping them costs you the EICR-clean reputation
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Domestic PV install added to an existing CU. PV inverter and DC isolator fitted in the
              loft, AC connection back to the CU. No mixed-supply notice fitted at the CU because it
              &quot;feels obvious&quot; that there&apos;s PV. Two years later an electrician comes
              out for an unrelated fault, opens the CU main switch to make safe, and starts work
              assuming the install is dead. Inverter is still energised from the DC side and
              back-feeds the AC bus-bar during a brief sun gap in the cloud cover. Electrician gets
              a shock. RIDDOR report. HSE investigation. The original PV installer&apos;s firm gets
              named.
            </>
          }
          doInstead={
            <>
              Mixed-supply notices are non-negotiable on any install with PV, battery, generator or
              any second supply source. Fit the notice at the CU and at the inverter / battery
              location. Notice should clearly state: more than one supply, locations of isolators,
              procedure to fully isolate. Use a printed BS-style warning label, not a hand-written
              one. Walk the customer through the notice during handover so they understand it too
              &mdash; they&apos;ll often be the one explaining it to the next electrician.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;ve just finished a CU change in a 1970s domestic property. The CU is in the
              under-stairs cupboard, the main earth runs up to a cut-out outside in the meter box.
              The property has a gas supply (boiler in kitchen), a water main entering at the front,
              and a small PV install added five years ago by a previous installer (inverter in the
              loft). The old CU is removed, the new one is wired and tested, all circuits energise
              correctly. You&apos;re ready to close up. What&apos;s your label checklist before you
              walk away?
            </>
          }
          whatToDo={
            <>
              Run the label sweep in order: (1) main earthing terminal in the meter box &mdash;
              check the BS 951 plate is fitted and legible, replace if not. (2) Gas-meter bond clamp
              &mdash; check the BS 951 plate, replace if missing. (3) Water-stopcock bond clamp
              &mdash; same. (4) New CU door &mdash; fit the RCD test notice on the inside or outside
              per the manufacturer&apos;s standard. (5) Inside CU door &mdash; fit the laminated
              single-line diagram / circuit list with each circuit identified in plain English. (6)
              Each MCB/RCBO &mdash; fit the circuit ID label (kitchen ring, lights, etc). (7) Loft
              inverter location &mdash; check the PV system has a clear isolation label and that the
              CU has a mixed-supply warning notice indicating PV is present and where its isolators
              are. (8) Any sub-circuit isolators (e.g. shed power) &mdash; labelled to indicate
              function. Walk the customer through what each notice means before leaving, especially
              the mixed-supply warning so they understand the install isn&apos;t fully isolated by
              the main switch alone.
            </>
          }
          whyItMatters={
            <>
              The label set is the install&apos;s user manual attached to the install itself. Done
              well, it serves the customer in an emergency, the next electrician on a fault visit,
              and the EICR engineer at the next periodic. Done badly or skipped, it transfers cost
              and risk to all three. The mixed-supply notice in particular is now almost universal
              on domestic installs as PV penetration grows &mdash; missing it is a real safety
              issue, not just a paperwork failure. Five minutes of label-sweep time at the end of
              the job is the difference between an install that earns repeat referrals and one that
              comes back as a complaint after the next EICR.
            </>
          }
        />
