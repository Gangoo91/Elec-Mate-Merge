...
const TITLE = 'GDPR and DPA — customer data, photos, retention | Level 2 Module 5.4.3 | Elec-Mate';
const DESCRIPTION =
...
const faqs = [
  {
    question: "I'm just an apprentice — does GDPR really apply to me, or only to the firm?",
    answer:
  ...
  {
    question: "What's a 'data breach' and what should I do if I think I've caused one?",
    answer:
  ...
  {
    question: "Are photos of customer property really 'personal data'?",
    answer:
  ...
  {
    question: 'Can I use customer photos for my AM2 portfolio?',
    answer:
  ...
  {
    question: 'Is sending customer details by personal WhatsApp ever OK?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Supplementary to Unit 210 — the data-protection layer that didn't exist when the syllabus
          was written but is unavoidable on every job today.
        </p>
        ...
        <div className="rounded-2xl border border-amber-500/30 bg-amber-500/[0.06] p-4 text-[13px] text-amber-200/90 leading-relaxed">
          ...
          <p>
            This Sub extends LO2 of Unit 210 (Information sources) but is not directly mapped to a
            specific 210 assessment criterion. It builds the data-protection layer that the 210
            syllabus pre-dates. Knowledge here supports the AC 2.3 / 2.4 material in Subs 4.1 and
            4.2 and is examinable under modern customer-handling standards (NICEIC code of practice,
            NAPIT scheme rules).
          </p>
        </div>
        ...
        >
          <p>The headline rules in plain English:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Only collect data you actually need (data minimisation).</li>
            <li>Tell the customer why you're collecting it (transparency, via privacy notice).</li>
            <li>Keep it secure — encrypted devices, access controls, locked vehicles.</li>
            <li>
              Keep it only as long as you need it (retention policy with a defensible period).
            </li>
            <li>
            ...
            <li>
              Report any breach to the firm's data controller / supervisor immediately so the
              72-hour ICO clock can be managed.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The six bases (UK GDPR Article 6(1)):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>(a) Consent</strong> — the customer has given clear consent for the specific
              purpose. Used for marketing emails, portfolio photo use, anything the customer can
              genuinely opt in or out of.
            </li>
            <li>
              <strong>(b) Contract</strong> — processing is necessary to perform a contract with the
              customer. Covers the core work — name, address, payment, certs.
            </li>
            <li>
              <strong>(c) Legal obligation</strong> — processing is required to comply with a legal
              duty (e.g. retaining tax records under HMRC rules).
            </li>
            <li>
              <strong>(d) Vital interests</strong> — processing is necessary to protect someone's
              life. Rare for trades.
            </li>
            <li>
              <strong>(e) Public task</strong> — for public-sector functions. Doesn't apply to
              private contractors.
            </li>
            <li>
              <strong>(f) Legitimate interests</strong> — processing is necessary for the legitimate
              interests of the firm or a third party, balanced against the customer's rights. Common
              for warranty record-keeping, fraud prevention, some forms of customer follow-up.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Controller responsibilities the firm bears (and you support):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Identify the lawful basis for each processing activity.</li>
            <li>
              Provide a clear privacy notice to customers (typically on the website, on the quote,
              in the customer portal).
            </li>
            <li>
              Honour data-subject rights (access, rectification, erasure, restriction, portability,
              objection).
            </li>
            <li>Maintain records of processing activities (Article 30).</li>
            <li>
              Have appropriate security measures in place (encrypted devices, access controls,
              secure backups).
            </li>
            <li>Have DPAs in place with all data processors.</li>
            <li>Report breaches to the ICO within 72 hours where notifiable (Article 33).</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Categories of photo and the typical lawful basis:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Job-evidence photos (before, during, after)</strong> — basis: contract
              (necessary to deliver the work and prove it was done). Stored in the firm's CRM,
              retained per the firm's retention policy.
            </li>
            <li>
              <strong>Photos for the cert / drawing</strong> — basis: contract + legal / regulatory
              (BS 7671 cert is a defensible record; as-installed drawing supports the install).
            </li>
            <li>
              <strong>Portfolio photos for AM2 / training</strong> — basis: explicit consent. Get it
              in writing, specify the purpose, allow withdrawal.
            </li>
            <li>
              <strong>Marketing photos (website, social media)</strong> — basis: explicit consent
              (preferred) or legitimate interest with a documented LIA. Anonymise where possible.
            </li>
            <li>
              <strong>Photos shared with mates / on personal channels</strong> — no lawful basis.
              Don't.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Realistic social-media rules for an apprentice:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Don't post photos of customer property without explicit written consent.</li>
            <li>
              Don't post about specific customer jobs by name, address or distinctive features.
            </li>
            <li>
              Don't post images that include customer identifying details (post, family photos,
              named pets, security setups).
            </li>
            <li>
              Don't WhatsApp customer photos to mates at other firms — that's also processing
              without basis.
            </li>
            <li>
              Generic trade content (training, kit reviews, day-in-the-life with no identifiable
              customer property) is fine. Stick to that.
            </li>
            <li>
              Read your firm's social-media policy. Most have one. If you breach it the disciplinary
              process kicks in independently of the GDPR exposure.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              transparent manner; (b) collected for specified, explicit and legitimate purposes; (c)
              adequate, relevant and limited to what is necessary; (d) accurate and kept up to date;
              (e) kept in a form which permits identification of data subjects for no longer than is
              necessary; and (f) processed in a manner that ensures appropriate security. Plus
          ...
          meaning={
            <>
              Article 5 is the headline ground rules of UK GDPR. Everything else flows from these
              principles. For a trade contractor, the practical translations are: (a) identify your
              lawful basis and write a clear privacy notice; (b) collect customer data for the work,
              not for unspecified future use; (c) don&apos;t ask for the customer&apos;s NI number
              to wire a socket; (d) update changed addresses; (e) have a written retention policy
              (typically 6+ years for certs, shorter for casual marketing); (f) encrypt devices,
              lock vehicles, secure backups. Accountability means you have to be able to PROVE
              you&apos;re doing all of this, not just assert it.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              Paraphrased: The DPA 2018 supplements UK GDPR for &quot;special category data&quot;
              (race, ethnicity, political views, religion, trade union membership, genetic data,
              biometric data for ID, health data, sex life or sexual orientation). Processing of
              special category data requires a stronger lawful basis under UK GDPR Article 9 PLUS
              one of the conditions in DPA 2018 Schedule 1 (e.g. employment law, health, social
              care, public interest). Schedule 1 also imposes additional safeguards including the
              requirement for an Appropriate Policy Document.
            </>
          }
          meaning={
            <>
              Most electrical contracting work doesn&apos;t touch special category data &mdash;
              you&apos;re not processing health records or biometric data. But two areas to watch:
              customer disability information (e.g. when adapting an install for a disabled
              household member, you may inadvertently capture health data) and employee HR records
              (sickness reasons, occupational health). For both, the firm&apos;s privacy framework
              has to step up to special-category protection &mdash; usually meaning explicit consent
              or a specific Schedule 1 condition, plus the Appropriate Policy Document.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              Paraphrased: Where personal data is captured by photographs or CCTV, the controller
              must identify a lawful basis, provide clear notice to data subjects (typically signage
              for CCTV, conversation for photographs), retain only as long as necessary, store
              securely, and honour subject access requests including providing copies of footage /
              images on request. Posting identifying images to public-facing channels (websites,
              social media) without consent is a high-risk processing activity and the ICO expects
              controllers to perform a Legitimate Interests Assessment or obtain explicit consent.
            </>
          }
          meaning={
            <>
              The ICO&apos;s photography and CCTV guidance applies to the firm&apos;s job-site
              photography. Practical implications: be transparent with the customer about the photos
              being taken, use them only for the stated purpose, store them in the firm&apos;s
              controlled systems (not personal phones), respect requests to delete or restrict, and
              never publish identifying images publicly without explicit consent. The same logic
              applies to body-worn cameras some firms now use for installer safety.
            </>
          }
        ...
        >
          <p>Typical retention periods for an electrical contractor:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EICs / EICRs / MWCs</strong> — 6 years minimum, often retained for the
              lifetime of the install.
            </li>
            <li>
              <strong>Job sheets / customer correspondence</strong> — 6 years (mirrors the cert
              retention).
            </li>
            <li>
            ...
            <li>
              <strong>Marketing consent records</strong> — for the duration consent is valid plus a
              defensible period to evidence the consent (typically 1-2 years after withdrawal).
            </li>
            <li>
              <strong>CCTV / body-worn camera footage</strong> — typically 30-90 days unless flagged
              for incident review (ICO guidance).
            </li>
            <li>
              <strong>HR records (employee files)</strong> — 6 years post-termination of employment,
              with some longer requirements for pension and health-and-safety records.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The headline rights and what they mean in practice:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Right of access (Article 15)</strong> — the SAR. One month to provide a copy
              of the data plus context (purposes, recipients, retention, source).
            </li>
            <li>
              <strong>Right to rectification (Article 16)</strong> — correct inaccurate data without
              undue delay. Address typos, name changes, etc.
            </li>
            <li>
              <strong>Right to erasure / 'right to be forgotten' (Article 17)</strong> — delete data
              in defined circumstances (e.g. consent withdrawn, no longer needed). Subject to
              overriding legal obligations (e.g. cert retention).
            </li>
            <li>
              <strong>Right to restrict processing (Article 18)</strong> — pause processing while a
              dispute is resolved.
            </li>
            <li>
              <strong>Right to data portability (Article 20)</strong> — receive personal data in a
            ...
            <li>
              <strong>Rights around automated decision-making (Article 22)</strong> — not normally
              relevant in trade contracting.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common breach scenarios and what to do:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Lost/stolen phone with customer data on it — report immediately, supervisor triggers
              remote wipe, firm assesses notifiability.
            </li>
            <li>
              Email sent to wrong recipient with customer cert / personal data attached — report
              immediately, supervisor contacts unintended recipient to request deletion, firm
              assesses notifiability.
            </li>
            <li>
              Customer photo posted to personal social media without consent — take down, report to
              supervisor, firm assesses customer notification.
            </li>
            <li>
              Van break-in with customer paperwork stolen — report immediately, firm contacts
              affected customers as a precaution.
            </li>
            <li>
              USB stick or laptop lost — report immediately, supervisor confirms encryption status
              (encrypted devices are usually NOT notifiable; unencrypted are).
            </li>
            <li>
              Suspicion of phishing or unauthorised access to firm's CRM — report immediately;
              security incident response kicks in.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice opens a CU and finds a melted bus-bar. Pulls out their personal phone,
              snaps three photos, drops them into a WhatsApp group with mates from their old college
              course at other firms with caption &quot;look at this state of this kitchen&quot;. One
              of the mates&apos; girlfriend works at the customer&apos;s accountancy firm and
              recognises the address. Word gets back. The customer rings the firm threatening an ICO
              complaint. The ICO doesn&apos;t fine but does send a stern letter and adds the firm to
              its &quot;awareness raising&quot; contact list. The firm has to update its policies,
              run mandatory training and discipline the apprentice.
            </>
          }
          doInstead={
            <>
              Photos for the supervisor and the firm&apos;s CRM only. If you want to share a
              learning moment with mates at other firms, do it without identifying info &mdash;
              describe it in words, or use a sketch, or share an anonymised photo with the address
              and any identifying features blurred. UK GDPR doesn&apos;t care about the channel
              &mdash; the duty travels with the data. Personal WhatsApp doesn&apos;t insulate you,
              encryption doesn&apos;t insulate you, &quot;they&apos;ll never know&quot; doesn&apos;t
              insulate you.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice carries a folder of recent EICs and customer details in the van for quick
              reference on follow-ups. Van gets broken into overnight outside their house. Folder is
              taken along with the toolbox. Apprentice doesn&apos;t flag it because the tools were
              the obvious target. Three weeks later one of the customers reports an attempted
              ID-theft scam using their address. The link to the stolen folder is made. The firm has
              to notify the ICO (potentially a notifiable breach), inform every customer in the
              folder, and review its physical-data policies. The apprentice gets a written warning
              for not flagging the loss promptly.
            </>
          }
          doInstead={
            <>
              Don&apos;t carry physical customer data unless absolutely necessary. Use the
              firm&apos;s CRM on an encrypted phone or tablet for on-site reference. If you must
              carry paper, lock it in a secure container in the van and out of sight. If anything is
              lost or stolen, tell your supervisor IMMEDIATELY &mdash; the 72-hour ICO notification
              clock starts when the firm becomes aware, not when the breach happened. Faster
              reporting gives the firm more time to investigate and may avoid the breach being
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re mid-way through your second-year apprenticeship and the AM2 is on the
              horizon. You want to start building a portfolio of clean install work to support your
              assessment. On a domestic kitchen rewire you&apos;ve just finished, the work looks
              textbook &mdash; neat trunking, labelled CU, tidy terminations. You want to photograph
              it. Is it OK to just snap and save?
            </>
          }
          whatToDo={
            <>
              Get explicit consent first. The customer&apos;s already happy with the work so
              it&apos;s an easy ask &mdash; &quot;would you mind if I took a couple of photos for my
              apprenticeship portfolio? They&apos;ll only be seen by my assessor and my college, and
              I&apos;ll crop out anything identifying.&quot; If they agree, ask them to confirm in a
              quick text or signed slip so you have a record. Take the photos, crop out the address
              and any distinctive features (post, view through the window, named appliances), store
              them in a portfolio folder NOT on personal social media, and use them only for the AM2
              assessment. If you later want to use them for marketing or trade press, ask the
              customer again with the new purpose specified &mdash; consent for AM2 doesn&apos;t
              cover Instagram. If the customer refuses, find another job to photograph.
            </>
          }
          whyItMatters={
            <>
              AM2 portfolios are great evidence of competence but they involve customer data. Doing
              it right (explicit consent, clear purpose, minimal identifying info, stored securely)
              protects you from a data complaint, protects the firm from a GDPR exposure, and
              demonstrates the kind of professional handling that contractor-scheme audits look for.
              The same discipline applies to anything you might want to use customer photos for
              after qualification &mdash; trade press, awards, marketing, training material. Always:
              lawful basis, customer informed, minimal data, stored securely, retained per policy.
            </>
          }
        />
