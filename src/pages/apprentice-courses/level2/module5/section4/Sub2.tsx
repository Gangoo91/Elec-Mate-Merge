...
const TITLE = 'Company policies and working relationships (2.4) | Level 2 Module 5.4.2 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: [
      "Accept it graciously — refusing a tip from a long-standing customer is rude and risks the relationship. Pocket the cash, thank them warmly, and there's no need to mention it back at the office because a personal tip to you isn't company income and doesn't affect the firm's certificates or quotes in any way.",
  ...
  },
  {
    ...
    options: [
      ...
      "Deal with it yourself directly — confront the other apprentice firmly in front of the rest of the gang so everyone sees it's been dealt with. Raising a formal grievance just escalates a small personality clash and marks you out as someone who can't handle the banter, which can count against you when the firm reviews your progress.",
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      "Accept one can to be polite, then leave the rest. A single drink at the end of the working day is fine because the formal shift is over, the work is finished and a small social gesture from the customer keeps the relationship friendly. The drink-drive limit allows for one, so there's no real risk in driving the van home afterwards.",
  ...
  {
    id: 5,
    question: "How does the Equality Act 2010 define 'harassment' in a workplace context?",
    options: [
  ...
  {
    id: 6,
    question: 'What does a SOCIAL MEDIA POLICY typically prohibit and why?',
    options: [
      "Only posts made from official company accounts during working hours — anything on a personal account in your own time is private and outside the firm's reach. As long as you don't tag the firm or post while clocked on, you can share photos of jobs, name customers and comment on competitors freely.",
  ...
  },
  {
    ...
    options: [
      ...
      "Because sub-contractors are self-employed and carry their own insurance and scheme registration, the firm has no responsibility for how they behave on site. Once a sub-contractor is engaged the relationship is purely commercial — the firm pays the invoice and any conduct or quality issues are entirely the sub-contractor's own concern.",
  ...
  },
  {
    ...
    options: [
      ...
      'To make sure employees take the most direct routes between jobs so the firm saves time, and to set a dress code for the office. Vehicle and expense rules are mainly about projecting a tidy company image to customers rather than about tax, insurance or preventing misuse of company assets.',
...
const faqs = [
  {
    question: "Where do I find my firm's policies — is there a standard place they all sit?",
    answer:
  ...
  {
    question: 'Do I have to read the policies, or only follow them when something comes up?',
    answer:
  ...
  {
    question: 'How do company policies relate to my own legal duties as an apprentice?',
    answer:
  ...
  {
    question: "What's the difference between a 'policy' and a 'procedure'?",
    answer:
  ...
  {
    question: "What's the role of a contractor scheme (NICEIC, NAPIT) in setting policies?",
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The internal rules that govern how your firm works — and how they shape every working
          relationship you'll have with customers, co-workers and sub-contractors.
        </p>
        ...
        >
          <p>Three things every policy does:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sets the rule</strong> — what the firm expects, in plain English.
            </li>
            <li>
              <strong>Protects the parties</strong> — by setting clear expectations, the policy
              reduces the chance of misunderstanding and gives both sides a defensible position if
              there's a dispute.
            </li>
            <li>
              <strong>Translates law into practice</strong> — abstract legal duties (e.g. 'protect
              customer personal data') become concrete actions ('don't post photos of customer
              property to social media without consent').
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>A typical safety policy includes:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              The general statement — usually a single page signed by the MD or the most senior
              person, committing the firm to safe practices.
            </li>
            <li>
              The organisation chart for safety responsibilities — who is the appointed competent
              person, who reports to whom, what each role is responsible for.
            </li>
            <li>
              Arrangements — risk assessment process, PPE provision, training, accident reporting,
              first aid, fire procedures, contractor management.
            </li>
            <li>
              References to detailed procedures — RAMS templates, permit-to-work systems, emergency
              procedures, near-miss reporting.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>A typical quality policy commits the firm to:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Compliance with BS 7671 and other applicable standards (BS 5839 fire alarms, BS 5266
              emergency lighting, BS 7430 earthing).
            </li>
            <li>Use of qualified, scheme-registered staff for all electrical work.</li>
            <li>
              Calibration of test instruments to manufacturer schedules and traceable records.
            </li>
            <li>Retention of certs and records for 6+ years.</li>
            <li>A complaints process and a continual-improvement loop.</li>
            <li>CPD for staff to keep up with regs amendments and new technology.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Standard HR policy set:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Grievance</strong> — how you raise a concern (informal first, then written,
              meeting, outcome, appeal).
            </li>
            <li>
              <strong>Disciplinary</strong> — how the firm investigates and acts on misconduct, with
              stages (verbal, written, final written, dismissal) and a right of appeal.
            </li>
            <li>
              <strong>Equality and diversity</strong> — commitment to non-discrimination under the
              Equality Act 2010 across all nine protected characteristics.
            </li>
            <li>
              <strong>Drugs and alcohol</strong> — typically zero-tolerance for working hours /
              driving, with random or for-cause testing in some firms.
            </li>
            <li>
              <strong>Smoking</strong> — typically prohibited on customer premises, in vehicles and
              in any uniform.
            </li>
            <li>
              <strong>Social media</strong> — restricts posting customer property, colleague info or
              anything that could damage the firm's reputation.
            </li>
            <li>
              <strong>Absence and sickness</strong> — how to report, when self-cert applies, when GP
              fit-note required.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What a typical commercial policy covers:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Company vehicles — business use only (with social/domestic exception if granted), no
              smoking, daily walk-around check, accident reporting.
            </li>
            <li>
              Fuel cards — for business mileage in the company van only, receipts retained, personal
              mileage logged and reimbursed.
            </li>
            <li>
              Expenses — what's claimable (out-of-area meals, parking, tools), what isn't (alcohol,
              personal items), the receipt rule and the monthly cut-off.
            </li>
            <li>
              Uniform and PPE — turn up in the firm's uniform, full PPE on site, no personalisation
              that misrepresents you.
            </li>
            <li>
              Customer-facing conduct — turn up on time, dressed cleanly, polite, no swearing, no
              smoking on customer premises, no eating customer food without offer.
            </li>
            <li>
              Tipping and gifts — typically a no-tips policy, with a process for what to do if a
              customer insists.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What confidentiality typically covers:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Customer personal data</strong> — name, address, phone, email, photos of
              property, security system layouts, anything identifying the customer or their
              property. (GDPR covered separately in Sub 3.)
            </li>
            <li>
              <strong>Commercially sensitive firm info</strong> — pricing strategy, supplier
              discounts, profit margins, win rates on quotes, employee salaries.
            </li>
            <li>
              <strong>Customer-imposed confidentiality</strong> — NDAs on commercial projects
              (offices, hospitals, retail, secure premises) where the customer requires
              non-disclosure as a condition of the contract.
            </li>
            <li>
              <strong>Intellectual property</strong> — the firm's templates, designs, processes,
              training materials.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              HASAWA s.2(3) is the statutory hook for the company written safety policy. Three
              components in the wording &mdash; the &quot;general policy&quot; statement, the
              &quot;organisation&quot; (who is responsible for what), and the
              &quot;arrangements&quot; (how the policy is delivered in practice). The employer also
              has to bring the policy to staff attention &mdash; usually via induction, staff
              handbook, intranet or noticeboard. The five-or-more-employees threshold is in
              regulations made under the Act; below that the duty to manage safety still exists but
              the written-policy requirement may not.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              Paraphrased: The Code sets minimum standards for handling discipline and grievance
              issues at work. Employers and employees should raise and deal with issues promptly,
              act consistently, carry out necessary investigations to establish the facts, inform
              employees of the basis of the problem and give them an opportunity to put their case
              in response before any decisions are made, allow employees to be accompanied at any
              formal meeting, and allow an employee to appeal against any formal decision made.
              Tribunals can adjust an award by up to 25% if either side has unreasonably failed to
              comply.
            </>
          }
          meaning={
            <>
              The ACAS Code is statutory guidance, not legislation, but tribunals MUST take account
              of it under the Trade Union and Labour Relations (Consolidation) Act 1992 s.207. Most
              firm grievance and disciplinary policies mirror the Code &mdash; informal first,
              written, meeting (with right to be accompanied), outcome, appeal. As an apprentice the
              practical takeaway: if you have a grievance, follow the firm&apos;s procedure; if a
              grievance is raised against you, expect to be informed and given a chance to respond
              before any decision.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;A person (A) harasses another (B) if &mdash; (a) A engages in unwanted conduct
              related to a relevant protected characteristic, and (b) the conduct has the purpose or
              effect of &mdash; (i) violating B&apos;s dignity, or (ii) creating an intimidating,
              hostile, degrading, humiliating or offensive environment for B.&quot;
            </>
          }
          meaning={
            <>
              Equality Act 2010 s.26 sets the legal definition of harassment. The &quot;purpose OR
              effect&quot; wording is critical &mdash; behaviour can be harassment even if the
              perpetrator didn&apos;t intend it that way, provided a reasonable person would have
              considered it to have that effect. The protected characteristics are: age, disability,
              gender reassignment, marriage and civil partnership, pregnancy and maternity, race,
              religion or belief, sex, and sexual orientation. Vicarious liability under s.109 means
              the firm is liable for the acts of its employees in the course of their work &mdash;
              which is why most firms build harassment training and a clear complaints route into
              their HR policy stack.
            </>
          }
        ...
        >
          <p>Practical baseline for customer-facing conduct:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Turn up on time. If you're going to be late, ring ahead with a realistic ETA.</li>
            <li>Wear the firm's uniform, full PPE on site, clean overshoes in domestic.</li>
            <li>
              Introduce yourself, show ID if relevant (customer's expecting you under your name).
            </li>
            <li>
              Explain what you're going to do in plain English before you do it. Get the customer's
              agreement to anything that affects their day (power off, noise, dust).
            </li>
            <li>
              Don't smoke or vape on customer premises. Don't accept alcohol. Decline tips politely.
            </li>
            <li>
              Clean up as you go and at the end. Take the rubbish with you. Hoover up any dust.
            </li>
            <li>
              At the end, walk the customer through what you've done, hand over the paperwork, take
        ...
        >
          <p>Specific co-worker behaviours that company policy normally addresses:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Bullying and harassment</strong> — never acceptable; covered by Equality Act
              2010 s.26 plus the firm's dignity-at-work policy.
            </li>
            <li>
              <strong>Conflict resolution</strong> — informal first (talk it through), escalate to
              supervisor if it doesn't resolve, formal grievance if needed.
            </li>
            <li>
              <strong>Confidentiality between colleagues</strong> — don't share other people's
              salary, performance reviews, sickness reasons, personal issues.
            </li>
            <li>
              <strong>Helping apprentices</strong> — qualified staff have a mentoring duty that's
              often baked into the apprenticeship agreement.
            </li>
            <li>
              <strong>Raising safety concerns</strong> — open culture, no victimisation under
        ...
        >
          <p>Standard sub-contractor relationship rules:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Vet the sub-contractor before engaging — insurance certs, scheme membership,
              references, sample work, RAMS for their portion.
            </li>
            <li>Agree scope, price and payment terms in writing BEFORE work starts.</li>
            <li>
              Brief them on site rules during induction (CDM 2015 Reg 13 on notifiable projects).
            </li>
            <li>
            ...
            <li>
              Hold them to the same conduct standards (no swearing on customer premises, no smoking,
              follow PPE rules).
            </li>
            <li>
              Escalate quality or behaviour concerns to your supervisor / the PC promptly, not via
              on-site arguments.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice finishes a particularly grim CU swap-out &mdash; old VIR, no main earth,
              melted plastic. Snaps a few photos. Posts to Instagram with caption &quot;massive
              nightmare today, customer had ZERO earth, lucky to be alive&quot;. Doesn&apos;t name
              the customer, doesn&apos;t tag the firm. Two days later the customer&apos;s daughter
              sees the post (the unique kitchen tile gives it away), shows her dad, who recognises
              his own house. Customer rings the firm threatening a complaint to the ICO and a
              defamation claim. The firm has to apologise, take the post down, and discipline the
              apprentice.
            </>
          }
          doInstead={
            <>
              Photos of customer property are personal data under UK GDPR &mdash; the duty travels
              with the data, not with whether you named anyone. The firm&apos;s social-media policy
              almost certainly prohibits posting customer property without explicit written consent.
              The fix: take the photo for the supervisor and the firm&apos;s case management system
              only, never post to personal social media. If you want trade content for Instagram or
              LinkedIn, get explicit written consent from the customer in advance, crop out anything
              identifying (postcode, view, distinctive fittings), and run it past your supervisor
              before posting.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Two apprentices on the same crew &mdash; one keeps making belittling comments about
              the other&apos;s work in front of customers. The targeted apprentice tries to ignore
              it, hoping it&apos;ll stop. It escalates over three weeks &mdash; comments become
              personal, then turn on the apprentice&apos;s background and accent. Eventually the
              targeted apprentice quits in frustration. The firm loses an apprentice, the
              perpetrator faces a tribunal claim under the Equality Act, and HR has to investigate
              something that could have been a five-minute supervisor conversation in week one.
            </>
          }
          doInstead={
            <>
              Raise it informally first &mdash; tell the other apprentice the comments are unwanted,
              and that you want them to stop. If they continue, escalate to your supervisor. If
              still unresolved, raise a formal grievance in writing under the firm&apos;s grievance
              policy (ACAS-aligned). The Equality Act 2010 s.26 covers harassment based on protected
              characteristics, and the Employment Rights Act 1996 protects you from being penalised
              for raising the grievance. Quitting closes off most of your remedies; raising the
              grievance opens them.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You finish a CU change for a long-standing customer. As you&apos;re packing the van
              the customer comes out with £50 in cash and says &quot;you&apos;ve been brilliant, I
              want to give you a little extra&quot;. Your firm&apos;s staff handbook explicitly says
              no tips &mdash; the firm&apos;s anti-bribery policy frames any unsolicited customer
              payment as a risk because it could later look like an inducement to issue a favourable
              cert or a discounted quote. The customer is being genuine and might be offended if you
              decline.
            </>
          }
          whatToDo={
            <>
              Decline politely but warmly. &quot;Thank you, that&apos;s really kind, but the firm
              has a no-tips policy &mdash; we&apos;re paid via the invoice and that&apos;s how it
              stays clean. What would mean a lot is if you could leave a Google review for us, or
              recommend us to your neighbours.&quot; That preserves the relationship, redirects the
              goodwill into something the firm actually benefits from (reviews, referrals), and
              keeps you on the right side of the policy. Mention the offer to your supervisor when
              you get back so there&apos;s a record &mdash; not because you&apos;ve done anything
              wrong, but because the firm tracks these moments and may want to write a thank-you
              card to the customer.
            </>
          }
          whyItMatters={
            <>
              The no-tips policy isn&apos;t about being precious &mdash; it&apos;s about keeping the
              firm&apos;s certs and quotes auditable and untainted. If a customer pays you cash and
              you later issue them a favourable EICR, the contractor-scheme audit could question
              whether the cert was independent. Refusing keeps the relationship clean. It&apos;s
              also a good moment to redirect the customer&apos;s goodwill into something measurable
              &mdash; a review or a referral &mdash; which is worth a lot more to the firm than
        ...
        <Quiz
          title="Company policies and working relationships — knowledge check"
