...
const checks = [
  {
    ...
    options: [
      ...
      "Brief him quickly in English exactly as you would a native speaker — slowing down or simplifying is patronising. A nod and a 'yes, OK' confirm he's understood, and if anything goes wrong it's his responsibility for not asking questions about the parts he didn't follow.",
  ...
  },
  {
    ...
    options: [
      ...
      "Speak loudly and slowly, exaggerating each word so it's easier to lip-read, and stand with the light behind you so your face is well lit. Keep the permit document to yourself and explain it verbally — handing him paperwork suggests you don't trust him to follow a spoken briefing.",
...
const quizQuestions = [
  {
    ...
    options: [
      'The duty not to discriminate. The employer must simply avoid treating a disabled employee less favourably than other staff — provided everyone is given exactly the same briefings, assessments and working conditions, the duty is met. There is no obligation to do anything extra or different for the disabled employee.',
  ...
  },
  {
    ...
    options: [
      ...
      "Around 1% of the UK population has dyslexia, so it's rare enough that most apprentice cohorts won't include anyone affected. Because the trade is hands-on rather than paperwork-heavy, dyslexia has little practical impact on an electrician's day-to-day work and reasonable adjustments are seldom needed.",
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Deliver the standard English briefing once to the whole group and have the English-speaking labourers translate informally for the others afterwards. A nod from each worker confirms understanding, and providing translated handouts or a back-brief would slow the start of work and isn't required as long as the information was given.",
  ...
  {
    id: 7,
    question: "What does 'plain English' actually mean as a communication standard?",
    options: [
...
const faqs = [
  ...
  {
    question:
      "What's the difference between a disability under the Equality Act and one under the SEND Code?",
    answer:
  ...
  {
    question:
      'Do I need a formal diagnosis to claim a reasonable adjustment under the Equality Act?',
    answer:
  ...
  {
    question:
      "I'm an apprentice and I think I might be dyslexic but I've never been assessed. What should I do?",
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reasonable adjustments under the Equality Act 2010 — physical disabilities, learning
          differences (dyslexia, ADHD, autism) and English-as-a-second-language workers. Plain
          English, visual aids, demonstration, back-briefing.
        </p>
        ...
        <ContentEyebrow>
          Why effective communication is a statutory duty, not a courtesy
        </ContentEyebrow>
        ...
        >
          <p>The framework in three lines:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Equality Act 2010 s.20</strong> — duty to make reasonable adjustments where a
              provision, criterion or practice puts a disabled person at a substantial disadvantage.
            </li>
            <li>
              <strong>Equality Act 2010 s.4</strong> — protected characteristics: age, disability,
              gender reassignment, marriage and civil partnership, pregnancy and maternity, race,
              religion or belief, sex and sexual orientation.
            </li>
            <li>
              <strong>MHSWR 1999 Reg 10</strong> — duty to provide comprehensible and relevant
              safety information.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Practical adjustments for hearing-impaired colleagues:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Face-to-face position for lip-reading; good lighting on your face.</li>
            <li>Normal pace and volume — not slow, not loud, not exaggerated.</li>
            <li>
              Written backup for technical detail (permit-to-work documents, RAMS key points,
              manufacturer instructions).
            </li>
            <li>
              BSL interpreter for formal briefings and safety-critical material — Access to Work can
              fund this.
            </li>
            <li>
              Visual hand signals as primary channel for shared work where radio isn&apos;t
              available to the lip-reader.
            </li>
            <li>Visual fire alarms in the welfare cabin and on site (not just audible).</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Practical adjustments for visually impaired colleagues:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Large print versions of written material — 14pt or 18pt minimum, sans-serif, high
              contrast.
            </li>
            <li>
              Audio versions of briefings — recorded toolbox talks, audio descriptions of drawings.
            </li>
            <li>
              Screen-reader-friendly digital documents — properly tagged PDFs, not scanned images of
              paper documents.
            </li>
            <li>Tactile markings on critical equipment where appropriate.</li>
            <li>
              Verbal description of any visual content — &quot;this is the consumer unit, the main
              switch is on the right-hand side at the top&quot;.
            </li>
            <li>Sighted guide for unfamiliar locations on first visit.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Practical adjustments for mobility-impaired colleagues:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Accessible route from parking to welfare cabin and briefing area — step-free where
              possible.
            </li>
            <li>Sit-down option for toolbox talks and briefings.</li>
            <li>
              Accessible toilet and welfare provision — Workplace (Health, Safety and Welfare)
              Regulations 1992 covers welfare standards.
            </li>
            <li>Ergonomic adjustments to workstations for office-based roles.</li>
            <li>Flexible working arrangements where the role allows.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common adjustments for dyslexic apprentices and electricians:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Extra time on written assessments</strong> — typically 25% additional time,
              more for severe dyslexia.
            </li>
            <li>
              <strong>Alternative assessment format</strong> — verbal or practical- demonstration
              assessment alongside or instead of written, where the qualification framework allows.
            </li>
            <li>
              <strong>Material in advance</strong> — briefing notes and training content provided
              ahead of the session so the apprentice can read at their own pace.
            </li>
            <li>
              <strong>Audio versions</strong> — recorded toolbox talks, audio versions of training
              material.
            </li>
            <li>
              <strong>Plain English</strong> — at a B1/B2 reading level for safety- critical
              material; technical terms used precisely and only where needed.
            </li>
            <li>
              <strong>Coloured-overlay readers</strong> — some dyslexic readers find a tinted
              background reduces visual stress.
            </li>
            <li>
              <strong>Voice-to-text software</strong> — for written report writing, site diaries and
              portfolio evidence; Access to Work can fund.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common adjustments for colleagues with ADHD:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Short briefings (10-15 minutes) or scheduled breaks in longer ones.</li>
            <li>Written summaries of verbal briefings and meetings.</li>
            <li>Structured task lists with clear priorities and deadlines.</li>
            <li>Advance notice of changes to the schedule where possible.</li>
            <li>
              Quiet space for focused work — particularly for written portfolio evidence or report
              writing.
            </li>
            <li>Flexibility on the order in which tasks are completed where the work allows it.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common adjustments for colleagues with autism:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Written schedules for the day, week and project.</li>
            <li>Advance notice of any changes to plans.</li>
            <li>
              Clear, unambiguous instructions — &quot;start at 8am at the kitchen, first job is the
              back-boxes, second is the cable drops, finish by lunch&quot;, not &quot;sort the
              kitchen out&quot;.
            </li>
            <li>
              Avoid &quot;common sense&quot; or &quot;you should know&quot; — make expectations
              explicit.
            </li>
            <li>Quiet space for breaks — sensory overload is a real factor on noisy sites.</li>
            <li>
              One-to-one briefings rather than large group sessions where possible for the
              apprentice&apos;s preference.
            </li>
            <li>Predictable routine where the role allows it.</li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The first requirement (s.20(3)) is, where a provision, criterion or practice (PCP)
                of A puts a disabled person at a substantial disadvantage in relation to a relevant
                matter compared with persons who are not disabled, to take such steps as it is
                reasonable to have to take to avoid the disadvantage.
              </p>
              <p className="mb-2">
                The second requirement (s.20(4)) is, where a physical feature puts a disabled person
                at a substantial disadvantage in comparison to non- disabled persons, to take such
                steps as it is reasonable to have to take to avoid the disadvantage.
              </p>
              <p>
                The third requirement (s.20(5)) is, where a disabled person would, but for the
                provision of an auxiliary aid, be put at a substantial disadvantage in relation to a
                relevant matter, to take such steps as it is reasonable to have to take to provide
                the auxiliary aid.
              </p>
            </>
          }
          meaning={
            <>
              Three triggers, one duty. The PCP trigger covers things like a written- only
              assessment regime that disadvantages a dyslexic apprentice. The physical-feature
              trigger covers things like a step into a welfare cabin that disadvantages a wheelchair
              user. The auxiliary-aid trigger covers things like a BSL interpreter for a Deaf signer
              or a screen reader for a blind worker. &quot;Reasonable&quot; is judged on cost,
              effectiveness, employer size and resources — most adjustments in the trade are
              low-cost and clearly reasonable. Access to Work funds the rest.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;Every employer shall provide his employees with comprehensible and relevant
              information on — (a) the risks to their health and safety identified by the
              assessment; (b) the preventive and protective measures; (c) the procedures referred to
              in regulation 8(1)(a); (d) the identity of those persons nominated by him in
              accordance with regulation 8(1)(b); and (e) the risks notified to him in accordance
              with regulation 11(1)(c).&quot;
            </>
          }
          meaning={
            <>
              The word doing the work in Reg 10 is &quot;comprehensible&quot;. A briefing in dense
              legal English to a labourer with English-as-a-second- language doesn&apos;t satisfy
              the duty. A written-only assessment to a dyslexic apprentice doesn&apos;t satisfy the
              duty. An audible-only fire alarm in a workshop with a Deaf colleague doesn&apos;t
              satisfy the duty. Reg 10 is the statutory hook for plain English, visual
              demonstration, translated material and accessible communication. It converts what
              could be dismissed as &quot;courtesy&quot; into a statutory duty owed to every worker
              on site.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              discrimination, harassment and victimisation. &quot;Race&quot; is broadly defined and
              covers nationality and ethnic origin, so discriminating against a Polish or Romanian
              worker because of their nationality is race discrimination. First language isn&apos;t
              itself a protected characteristic, but the practical effect is similar — and the duty
              under MHSWR Reg 10 to provide &quot;comprehensible&quot; safety information does most
              of the same work.
            </>
          }
        ...
        >
          <p>Practical communication for non-English-first-language workers:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Plain English at slow pace</strong> — short sentences, common words, one idea
              at a time.
            </li>
            <li>
              <strong>Visual demonstration</strong> — show the procedure on the actual equipment,
              not just describe it.
            </li>
            <li>
              <strong>Back-briefing</strong> — ask the worker to demonstrate or explain back
              what&apos;s been covered (&quot;show me what you&apos;d do if&hellip;&quot;).
            </li>
            <li>
              <strong>Translated material</strong> — HSE provides safety leaflets in Polish,
              Romanian, Lithuanian, Portuguese, Bulgarian and several other languages at hse.gov.uk.
            </li>
            <li>
              <strong>Translated signage and PPE labels</strong> — for sites with a consistent
              multilingual workforce.
            </li>
            <li>
              <strong>Bilingual co-worker as informal interpreter</strong> — useful for
              clarification but not a substitute for properly briefed material on safety-critical
              content.
            </li>
            <li>
              <strong>Professional interpreter for formal briefings</strong> — site induction,
              formal training, formal grievance proceedings.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice briefs a Polish-speaking labourer on the safe-isolation procedure. The
              labourer nods politely throughout the briefing, smiles, says &quot;yes, OK&quot;.
              Apprentice walks away. Ten minutes later the labourer connects a tail to a busbar that
              hasn&apos;t been isolated. Receives a shock. Investigation finds the labourer
              hadn&apos;t understood the briefing — the nodding was politeness, not comprehension.
              The apprentice is interviewed under HASAWA s.7 and the firm under s.2.
            </>
          }
          doInstead={
            <>
              Never accept a nod as confirmation of understanding for a safety- critical briefing.
              Use the back-brief — &quot;show me what you&apos;d do if you saw this switch in this
              position&quot;. The labourer demonstrating the procedure on the actual equipment is
              the only reliable evidence of understanding. If they can&apos;t demonstrate it,
              re-brief — slower, with more visual content, with a bilingual co-worker if available,
              and with translated written material as backup. Document the back-brief in your notes.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice with disclosed dyslexia asks for the standard written assessment to be
              supplemented with the option of a verbal or practical-demonstration assessment.
              Trainer refuses on the basis that &quot;everyone else does the written assessment, no
              exceptions&quot;. Apprentice fails the written assessment despite clearly having the
              practical knowledge. Apprentice raises a grievance under the Equality Act 2010 s.20
              reasonable-adjustments duty. Training provider faces an employment tribunal claim that
              they&apos;re likely to lose. Apprentice also loses motivation, falls behind, and the
              relationship with the training provider breaks down.
            </>
          }
          doInstead={
            <>
              Equality Act 2010 s.20 reasonable-adjustments duty is statutory, not optional. The
              standard adjustments for dyslexia (extra time, alternative assessment format, audio
              material, advance briefing) are well-established, low-cost and required. Asking the
              apprentice what helps and implementing the agreed adjustment is much faster, cheaper
              and fairer than refusing and ending up at tribunal. The same applies to ADHD, autism,
              hearing impairment, visual impairment and any other disability under the Act.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re running a toolbox talk on safe isolation for a team of six — three native
              English speakers, two Polish-speaking labourers with limited English, and one
              Lithuanian labourer with intermediate English. The talk needs to cover the
              safe-isolation procedure for a three-phase distribution board you&apos;ll all be
              working around for the next two weeks. You&apos;ve been told by your supervisor that
              you have 15 minutes to brief everyone before work starts.
            </>
          }
          whatToDo={
            <>
              Don&apos;t try to deliver one briefing for everyone. Plan for two rounds. Round 1:
              deliver the briefing in plain English at slow pace to the whole group, with visual
              demonstration on the actual board — show the lock-off, the dead-test, the proving-test
              sequence in front of everyone. Use clear language, short sentences, one step at a
              time. Round 2: pull the two Polish labourers aside individually and back-brief — ask
              each of them to demonstrate the lock-off, the dead-test and the proving-test on the
              actual board. Confirm in writing (a checklist, ideally translated) that you&apos;ve
              briefed them and they&apos;ve demonstrated back. Document the briefing in the site
              diary — date, who was present, the back-brief was given, checklist signed. If anything
              is still unclear, escalate to your supervisor before any work proceeds.
            </>
          }
          whyItMatters={
            <>
              Safe isolation is the highest-stakes procedure on most sites — getting it wrong is how
              electricians die. The duty under MHSWR Reg 10 to provide comprehensible information is
              statutory, not a courtesy. The duty under HASAWA s.2 to provide a safe system of work
              extends to briefing the workers on that system in a form they can understand. A
              briefing that the Polish labourers can&apos;t follow isn&apos;t a briefing — it&apos;s
              a paperwork exercise that leaves them exposed and you exposed under HASAWA s.7
              (personal duty to look after yourself and others). The back-brief plus written
              checklist plus signed sheet is the package that discharges the duty.
            </>
          }
        />
        ...
        <Quiz
          title="Effective communication across disabilities and language — knowledge check"
