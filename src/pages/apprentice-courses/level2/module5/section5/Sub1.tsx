...
const TITLE = 'Suitable communication methods (3.1) | Level 2 Module 5.5.1 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question: "What's the core principle for picking a communication method on site?",
    options: [
  ...
  {
    id: 3,
    question: 'When is WhatsApp an appropriate communication method on a site?',
    options: [
  ...
  {
    id: 8,
    question: "What's an RFI (Request For Information) and when do you use one?",
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Verbal, written, visual and formal — each has a job, and the wrong medium for the message
          is how variations don't get paid and contract disputes end up in court with WhatsApp
        ...
        >
          <p>The four families of communication on a building site:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Verbal</strong> — face-to-face conversations, phone calls, two-way radio,
              public-address (tannoy), toolbox talks. Fast, immediate, allows tone and questions,
              leaves no record unless one is actively created.
            </li>
            <li>
              <strong>Written</strong> — email, text, WhatsApp, formal letter, site diary, formal
              report. Slower than verbal, but creates a record by default and supports more complex
              content.
            </li>
            <li>
              <strong>Visual</strong> — sketch, photograph, video, redline on a drawing, screenshot,
              animated explainer. Best when the message is about position, geometry or process —
              what something looks like or where it is.
            </li>
            <li>
              <strong>Formal</strong> — RAMS, certificate, contract, variation order, Request For
              Information (RFI), grievance letter. Structured, signed, logged, often legally
              significant. The medium of last resort and of permanent record.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>When face-to-face is the right medium:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Anything relationship-critical — first contact with a new customer, a difficult
              conversation, breaking bad news (the job will overrun, the price has gone up).
            </li>
            <li>
              Toolbox talks and team briefings — the standard format for transferring hazard
              information and getting buy-in.
            </li>
            <li>
              Coaching an apprentice or training a less-experienced colleague — text or video can
              supplement, but the in-person conversation is the core.
            </li>
            <li>
              Conflict resolution — Sub 5.3 covers this in detail. The default for a live conflict
              is in-person, calmly, in a neutral location.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>When phone is the right medium:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Urgent coordination where text would be too slow.</li>
            <li>A customer query that needs a real answer rather than a holding email.</li>
            <li>
              Following up on an email that hasn't been answered and the matter is time- sensitive.
            </li>
            <li>
              Anything where you suspect the receiver has misread the tone of a written message —
              switching to voice usually defuses it.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Radio etiquette on site:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Identify yourself and the recipient at the start of each transmission (&quot;Lift core
              to third floor&quot;).
            </li>
            <li>
              Keep messages short and direct — &quot;pull&quot;, &quot;stop&quot;, &quot;copy&quot;,
              &quot;over&quot;.
            </li>
            <li>
              Confirm receipt — never assume the other end heard you. &quot;Confirm copy&quot; is
              the standard ack.
            </li>
            <li>
              If you lose comms, default to the agreed safe action — usually &quot;stop&quot; —
              never default to carrying on without contact.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>When email is the right medium:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Variations and scope changes — written confirmation before work proceeds.</li>
            <li>
              Customer-facing communication where the response will form part of the project record.
            </li>
            <li>Internal handover notes — shift change, job handover to a colleague.</li>
            <li>
              Confirming verbal agreements — &quot;further to our call earlier, to confirm…&quot;.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Where WhatsApp / text fits:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Logistics and coordination — arrival times, parking, who's bringing what.</li>
            <li>
              Quick photos for context — &quot;is this the right cable&quot; with a photo attached.
            </li>
            <li>Group coordination among the immediate site team.</li>
          </ul>
          <p className="pt-2">Where it doesn&apos;t fit:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Variations, scope changes or any conversation about price.</li>
            <li>Formal warnings, grievances or anything HR-relevant.</li>
            <li>Safety briefings of record — those are toolbox talks with sign-on sheets.</li>
            <li>Complaints from customers — switch to email or phone immediately.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>When each is the right medium:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Site diary</strong> — every working day. The personal record that supports
              your portfolio, your timesheet and your defence in any later dispute.
            </li>
            <li>
              <strong>Formal letter</strong> — contract notices, formal warnings, formal complaints,
              grievance escalations. The heavy artillery — use sparingly but use properly.
            </li>
            <li>
              <strong>Formal report</strong> — incident reports under RIDDOR (Reporting of Injuries,
              Diseases and Dangerous Occurrences Regulations 2013), defect reports, structured
              inspection reports, AM2 portfolio evidence reports.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The duty is to provide &quot;comprehensible and relevant&quot; information — both
              words matter. &quot;Comprehensible&quot; rules out information that&apos;s technically
              correct but pitched in language the worker can&apos;t follow. &quot;Relevant&quot;
              rules out information dumps that bury the important point. The whole apparatus of
              toolbox talks, plain- English RAMS summaries and translated safety briefings flows
              from this regulation. Reg 10 is what makes communication a statutory duty rather than
              good practice.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;Where two or more employers share a workplace (whether on a temporary or a
              permanent basis) each such employer shall — (a) co-operate with the other employers
              concerned so far as is necessary to enable them to comply with the requirements and
              prohibitions imposed upon them by or under the relevant statutory provisions and by
              Part II of the Fire Precautions (Workplace) Regulations 1997; (b) (taking into account
              the nature of his activities) take all reasonable steps to co-ordinate the measures he
              takes to comply with the requirements and prohibitions imposed upon him by or under
              the relevant statutory provisions and by Part II of the Fire Precautions (Workplace)
              Regulations 1997 with the measures the other employers concerned are taking to comply
              with the requirements and prohibitions imposed upon them by or under those provisions;
              and (c) take all reasonable steps to inform the other employers concerned of the risks
              to their employees&apos; health and safety arising out of or in connection with the
              conduct by him of his undertaking.&quot;
            </>
          }
          meaning={
            <>
              Reg 11 is the duty to communicate between employers sharing a workplace — exactly the
              situation on every fit-out. The electrical contractor must co-operate with the M&E
              contractor, the joiner, the plasterer and every other trade on co-ordinating safety.
              The mechanism is communication, both verbal (toolbox talks, daily co-ordination
              meetings) and written (RAMS shared, programme issued, site rules signed). Failing to
              communicate hazards between trades is a Reg 11 breach.
            </>
          }
        ...
        >
          <p>When visual is the right medium:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>As-built records</strong> — chases, cable runs, back-box positions before
              plastering. Five minutes with a phone camera saves hours of detective work later.
            </li>
            <li>
              <strong>Defect or snag records</strong> — photo of the fault, with a ruler or coin in
              shot for scale, geotagged and timestamped.
            </li>
            <li>
              <strong>Position queries</strong> — &quot;is this the right location for the
              socket?&quot; with a photo annotated with markup is much faster than a written
              description.
            </li>
            <li>
              <strong>Process demonstration</strong> — a short video of a manufacturer&apos;s
              installation procedure or a colleague&apos;s technique is often the clearest training
              material.
            </li>
            <li>
              <strong>Drawing redlines</strong> — formal markup of as-built changes on the design
              drawings, signed off and returned to the design team.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The headline formal communication artefacts on an electrical job:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>RAMS</strong> — Risk Assessment + Method Statement. The safe system of work,
              signed off before work starts.
            </li>
            <li>
              <strong>Certificates</strong> — Electrical Installation Certificate (EIC), Minor Works
              Certificate, EICR. Statutory record of electrical compliance under BS 7671 and Part P.
            </li>
            <li>
              <strong>Variation order</strong> — formal record of any change to scope or price,
              signed by the customer before work proceeds.
            </li>
            <li>
              <strong>RFI</strong> — Request For Information. Formal query to the design team when
              drawings or specs are unclear, logged and tracked to resolution.
            </li>
            <li>
              <strong>Permit-to-work</strong> — formal authorisation for high-risk tasks (live work,
              hot work, confined-space entry) issued by the responsible person and signed back on
              completion.
            </li>
            <li>
              <strong>Handover documentation</strong> — Operations & Maintenance manuals, as-built
              drawings, test certificates bundled and handed to the client at project completion.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                <strong>Reg 13(1)</strong> — &quot;The principal contractor must plan, manage and
                monitor the construction phase and co-ordinate matters relating to health and safety
                during the construction phase to ensure that, so far as is reasonably practicable,
                construction work is carried out without risks to health or safety.&quot;
              </p>
              <p>
                <strong>Reg 13(2)</strong> — &quot;In fulfilling the duties in paragraph (1), and in
                particular when — (a) preparing the construction phase plan; and (b) organising
                co-operation between contractors and co- ordinating their work, the principal
          ...
          meaning={
            <>
              Reg 13 puts a duty on the principal contractor to communicate hazard information
              forwards (to operatives) and to co-ordinate communication sideways (between trades).
              The construction phase plan is the headline written artefact, the site induction is
              the verbal mechanism, the daily briefings and toolbox talks are the ongoing
              communication. The whole CDM 2015 framework is a structured communication regime.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer messages on WhatsApp at the end of the day asking if the apprentice can
              &quot;just add a couple more sockets&quot; while they&apos;re on site tomorrow.
              Apprentice replies &quot;yeah no problem&quot;. The work happens, gets added to the
              invoice with an additional charge, and the customer disputes it because the original
              quote didn&apos;t mention them. The dispute goes to the Small Claims Court. The
              evidence on both sides is a thread of casual WhatsApp messages with no clear scope or
              price agreement. The court finds for the customer because the contractor cannot
              demonstrate the variation was properly documented before work commenced.
            </>
          }
          doInstead={
            <>
              Acknowledge the request verbally or by message for the relationship. Switch
              immediately to a formal medium for the contract — a written variation document by
              email, listing the additional work, the additional cost, the additional time impact
              and the customer&apos;s confirmation requirement. Don&apos;t start the additional work
              until the written confirmation is back. Five minutes of formal documentation prevents
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice on a fit-out is briefed via the RAMS to isolate a sub- distribution board
              before working on a downstream circuit. Supervisor arrives and says &quot;don&apos;t
              bother, the load downstream is light, just crack on live, we&apos;re behind
              schedule&quot;. Apprentice does what the supervisor said. Receives a shock.
              Investigation finds the apprentice departed from the documented safe system of work,
              on a verbal instruction that was never recorded. HASAWA s.7 personal liability sits on
              the apprentice; the supervisor faces s.7 too plus potential employer liability under
              s.2.
            </>
          }
          doInstead={
            <>
              Stop. Politely ask the supervisor to put the change in writing — even a one-line email
              or a revised method statement signed by both of you. If the supervisor refuses,
              escalate via your employer&apos;s safety route. The written method statement is the
              authoritative safe system until it&apos;s formally revised. &quot;I was told to&quot;
              is not a defence to a HASAWA s.7 prosecution and Employment Rights Act 1996 s.44
              protects you from being penalised for raising the safety concern.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re on a kitchen rewire that you&apos;re due to finish tomorrow. The customer
              rings at 4pm, friendly and casual. &quot;Could you fit an EV charger on the front of
              the house while you&apos;re here? I know it&apos;s last minute but the car&apos;s
              being delivered Friday.&quot; The original quote covers a kitchen rewire only — no
              outside work, no EV charger, no supply assessment. You&apos;ve got the rest of the day
              on site to wrap up first-fix.
            </>
          }
          whatToDo={
            <>
              Acknowledge the request warmly on the phone — &quot;I hear you, let&apos;s see
              what&apos;s possible&quot;. Don&apos;t commit verbally. Explain that an EV charger is
              a separate piece of work that needs a supply assessment (DNO notification under ESQCR
              2002 plus BS 7671 Section 722 considerations), a separate quote and probably a
              separate visit because the kit needs ordering. Offer to send a written variation
              proposal within 24 hours covering scope, cost and earliest install date. Send the
              email the same evening with the variation laid out clearly. Don&apos;t carry out any
              EV-charger-related work until the customer has confirmed in writing. Document the call
              in your job pack — date, time, what was discussed, what you&apos;re doing next.
            </>
          }
          whyItMatters={
            <>
              The temptation to say yes on the phone is enormous — the customer is friendly, the
              work is in your skill range, and turning it down feels rude. But agreeing on the phone
              bypasses the design and notification duties (DNO consent for EV chargers, supply
              capacity check, Part P notification, BS 7671 Section 722 compliance), exposes you to a
              contract dispute if the price isn&apos;t agreed in writing, and risks non-compliant
              work if it&apos;s rushed. The right medium for a contract change is written, every
              time. The verbal acknowledgement is for the relationship; the written variation is for
              the file.
            </>
          }
        />
