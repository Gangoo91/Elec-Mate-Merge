...
const TITLE = 'Mental health and neurodiversity in the trade | Level 2 Module 5.5.5 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'What is the Lighthouse Construction Industry Charity?',
    options: [
  ...
  {
    id: 3,
    question: 'What is Mates in Mind?',
    options: [
  ...
  {
    id: 4,
    question: 'What is the Electrical Industries Charity?',
    options: [
  ...
  {
    id: 7,
    question: 'What workplace adjustments are commonly helpful for an apprentice with autism?',
    options: [
...
const faqs = [
  ...
  {
    question:
      "I think I might be neurodivergent (dyslexic / ADHD / autistic) but I haven't been formally diagnosed. What should I do?",
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Construction has the highest suicide rate of any UK sector (ONS data). Mates in Mind,
          Lighthouse Club and the Electrical Industries Charity exist for a reason. Neurodiversity
          is common in the trade. This Sub equips you to help a peer and to seek help yourself — it
          does not diagnose.
        </p>
        ...
        <div className="rounded-2xl border border-amber-400/30 bg-amber-400/[0.06] p-5 mb-2">
          ...
          <p className="text-white/85 text-[13px] sm:text-[14px] leading-relaxed">
            This Sub extends LO3 of Unit 210 with industry-relevant well-being and neurodiversity
            awareness. Mental health is treated here as a peer-support and signposting topic, not a
            clinical one. The Sub does not provide medical advice and it does not diagnose. UK
            charity helplines and NHS routes are signposted throughout. If you are struggling, the
            Lighthouse Construction Industry Charity helpline is{' '}
            <span className="font-semibold text-white">
              0345 605 1956 (24/7, free, confidential)
            </span>{' '}
            and Samaritans is{' '}
        ...
        >
          <p>
            The factors most consistently identified by ONS, HSE and the construction charities as
            drivers of the sector&apos;s mental health profile:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Long hours and transient work patterns</strong> — early starts, long days,
              working away from home, weekend work for tight programmes.
            </li>
            <li>
              <strong>Financial pressure</strong> — particularly for self-employed workers, who
              carry the cost of any time off, and apprentices, who are on low wages while juggling
              work and college.
            </li>
            <li>
              <strong>Historically &apos;tough it out&apos; culture</strong> — discouraged talking
              about feeling low and treated mental health as weakness. The cultural shift is real
              but the history is long.
            </li>
            <li>
              <strong>Isolation</strong> — particularly for workers travelling for work, away from
              family and support networks.
            </li>
            <li>
              <strong>Substance use as coping</strong> — alcohol and other substances are frequently
              used to manage stress in the sector, often masking the underlying issue.
            </li>
            <li>
              <strong>Predominantly male workforce</strong> — and in UK society generally, men are
              statistically less likely to seek help for mental health issues.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Lighthouse Club services:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>24/7 helpline 0345 605 1956</strong> — free, confidential, anonymous if you
              want it.
            </li>
            <li>
              <strong>Helpline app</strong> — text-based access for those who prefer not to call.
            </li>
            <li>
              <strong>Financial assistance fund</strong> — grants for trade workers facing hardship
              (illness, bereavement, redundancy, cost of living).
            </li>
            <li>
              <strong>Mental Health First Aid training</strong> — well-respected across the
              industry, often funded by employers.
            </li>
            <li>
              <strong>Critical incident response</strong> — support for sites and firms after
              serious incidents.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Mates in Mind services:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Free resources</strong> — toolbox-talk templates, signposting cards, posters
              and guidance, available to download.
            </li>
            <li>
              <strong>Training programmes</strong> — mental health awareness, manager training,
              peer-support training.
            </li>
            <li>
              <strong>Strategy support for firms</strong> — helping construction businesses build
              mental health into their existing safety management systems.
            </li>
            <li>
              <strong>Signposting</strong> — to Samaritans (116 123), Lighthouse helpline (0345 605
              1956) and other support routes.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Electrical Industries Charity services:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Financial assistance grants</strong> — cost-of-living support, bereavement,
              illness, redundancy, family emergencies.
            </li>
            <li>
              <strong>Emotional support and counselling</strong> — confidential counselling pathway
              for industry workers and family members.
            </li>
            <li>
              <strong>Debt advice</strong> — connecting with regulated debt advice services where
              money pressure is a factor.
            </li>
            <li>
              <strong>Apprentice support</strong> — specifically aimed at apprentices in the
              electrical sector facing difficulty.
            </li>
            <li>
              <strong>Careers service</strong> — supporting retraining and career change for
              tradespeople who need to leave the trade for health or other reasons.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Universal UK mental health support:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Samaritans</strong> — 116 123, 24/7, free from any phone. samaritans.org.
              Email: jo@samaritans.org. The headline crisis support line in the UK.
            </li>
            <li>
              <strong>Mind</strong> — 0300 123 3393. mind.org.uk. Information line for mental health
              support, advice and signposting.
            </li>
            <li>
              <strong>NHS 111</strong> — for urgent (but not life-threatening) mental health support
              out of hours.
            </li>
            <li>
              <strong>NHS Talking Therapies</strong> — free CBT and other therapy via your GP
              referral or self-referral in many areas.
            </li>
            <li>
              <strong>999 or A&amp;E</strong> — for life-threatening mental health crises.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The peer-support framework:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ask twice</strong> — the first answer is usually reflexive. The second ask is
              the one that opens the conversation.
            </li>
            <li>
              <strong>Listen properly</strong> — don&apos;t interrupt, don&apos;t problem-solve,
              don&apos;t minimise. Acknowledge what they say.
            </li>
            <li>
              <strong>Don&apos;t diagnose</strong> — you&apos;re not a clinician. Naming what they
              have isn&apos;t your job.
            </li>
            <li>
              <strong>Signpost gently</strong> — the helplines and the GP exist for this. Mention
              them as options, not orders.
            </li>
            <li>
              <strong>Don&apos;t break confidence without asking</strong> — but be honest if you
              genuinely think they&apos;re at risk that you may need to escalate.
            </li>
            <li>
              <strong>Follow up</strong> — a check-in a few days later shows it wasn&apos;t a
              one-off conversation. This is what most peer support actually looks like.
            </li>
            <li>
              <strong>Look after yourself too</strong> — supporting a peer is heavy. The same
              charities are available to you.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common neurodivergent strengths in the trade:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Visual-spatial reasoning</strong> — often associated with dyslexia. Reading a
              layout drawing, picturing a cable route through a building, visualising a circuit
              diagram.
            </li>
            <li>
              <strong>Pattern recognition and problem-solving</strong> — often associated with
              autism and ADHD. Diagnosing a fault, finding the anomaly in a test result.
            </li>
            <li>
              <strong>Hyperfocus on interesting work</strong> — often associated with ADHD.
              Sustained attention on a complex install or fault-finding.
            </li>
            <li>
              <strong>Attention to detail in areas of interest</strong> — often associated with
              autism. Particularly suited to inspection, testing, and certification work.
            </li>
            <li>
              <strong>Practical hands-on aptitude</strong> — often a strength across neurodivergent
              profiles in the trade.
            </li>
          </ul>
          <p className="pt-2">
            Common challenges and the standard adjustments under Equality Act 2010 s.20 (covered in
            Sub 5.2):
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Dyslexia</strong> — extra time on written assessments, alternative assessment
              formats, audio versions of training material, plain English at B1/B2 reading level,
              voice-to-text software.
            </li>
            <li>
              <strong>ADHD</strong> — short structured briefings, written summaries of verbal
              instructions, advance notice of changes, structured task lists, quiet space for
              focused work.
            </li>
            <li>
              <strong>Autism</strong> — written schedules, advance notice of changes, clear and
              unambiguous instructions, predictable routine, designated quiet space for breaks where
              sensory overload is a factor.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The HSE Management Standards approach identifies six key areas of work design that, if
              not properly managed, are associated with poor health, lower productivity and
              increased accident and sickness absence rates: Demands, Control, Support,
              Relationships, Role, and Change. The Standards are not a regulatory requirement but
              reflect the duty under MHSWR 1999 Reg 3 to assess risks to the health of employees —
              including psycho-social risks.
            </>
          }
          meaning={
            <>
              The HSE Stress Management Standards (hse.gov.uk/stress) are the practical guidance for
              employers on managing work-related stress. The framework makes psycho-social risk a
              legitimate part of workplace risk assessment. The Standards aren&apos;t themselves a
              legal requirement, but they discharge the MHSWR Reg 3 duty to assess risks to the
              health of employees — and a tribunal would treat conformity with the Standards as
              evidence of a reasonable approach. For apprentices, the Standards are useful as a way
              of naming what&apos;s wrong when work feels overwhelming — high demands, low control,
              poor support, difficult relationships, role ambiguity, frequent change. The
              signposting routes to the construction-industry charities are the practical response.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              Reg 3(1) requires every employer to make a suitable and sufficient assessment of the
              risks to the health and safety of employees and others affected by the work. HSE
              guidance on the regulation makes clear that &quot;health&quot; includes mental as well
              as physical health, and that psycho-social risks (work-related stress, bullying,
              excessive workload) fall within the assessment duty.
            </>
          }
          meaning={
            <>
              Reg 3 is normally cited for physical risk assessment but the duty extends to mental
              health where work-related factors create risk. HSE Stress Management Standards are the
              practical framework. For an apprentice, this matters because excessive workload, role
              ambiguity and lack of support are not &quot;just part of the job&quot; — they are
              workplace risks the employer is required to assess and manage. The training-provider
              tutor and the construction charities are appropriate escalation routes if the
              assessment isn&apos;t happening.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              carry out normal day-to-day activities. (Section 6(1).) &quot;Long-term&quot; means it
              has lasted, or is likely to last, 12 months or more, or is likely to last for the rest
              of the affected person&apos;s life. (Schedule 1.)
            </>
          }
          meaning={
            <>
              Equality Act 2010 s.6 covers mental impairment as well as physical. Where a mental
              health condition (depression, anxiety disorders, PTSD, bipolar disorder and others)
              has a substantial and long-term effect on day-to-day activities, it&apos;s a
              disability under the Act. Once disclosed to the employer, the s.20
              reasonable-adjustments duty applies. Common adjustments include flexible hours during
              recovery, time off for therapy appointments, a phased return after a
              mental-health-related absence, and adjustments to high-pressure deadlines. Disclosure
              is the apprentice&apos;s choice — but the legal protection is real once disclosed.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice tells a more experienced colleague he&apos;s not been sleeping, missed two
              weeks of college, feels like he&apos;s letting everyone down. Colleague replies
              &quot;you need to man up, we all feel like that, just get on with it&quot;. Apprentice
              doesn&apos;t mention it again. Withdraws from the team over the following weeks. Stops
              asking for help with work he&apos;s struggling with. Eventually leaves the
              apprenticeship, and the trade. The colleague&apos;s response was meant to be tough
              love — but it shut the conversation down at exactly the moment when opening it would
              have helped. Multiplied across the sector, this is the cultural pattern that ONS data
              has been measuring for decades.
            </>
          }
          doInstead={
            <>
              Listen. Acknowledge what the apprentice said (&quot;that sounds hard&quot;).
              Don&apos;t minimise (&quot;we all feel like that&quot; often translates to &quot;your
              feelings don&apos;t matter&quot;). Don&apos;t diagnose (&quot;sounds like
              depression&quot; — leave that to clinicians). Mention the support routes — Lighthouse
              Club helpline 0345 605 1956 (24/7, free, confidential), Samaritans 116 123, GP,
              training-provider tutor. Follow up in a few days. The conversation doesn&apos;t need
              to fix anything; it needs to keep the door open. Talking saves lives.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice is overwhelmed — money pressure, training pressure, relationship issues at
              home. Starts drinking more in the evenings to switch off. The drinking initially helps
              with sleep but makes concentration worse the next day. Performance at work and college
              slips. Apprentice drinks more to manage the stress of the slipping performance. Cycle
              accelerates. The substance use masks the underlying issue and adds a new one on top.
              The HSE has identified substance use as a significant factor in construction-sector
              mental health and accident statistics.
            </>
          }
          doInstead={
            <>
              Notice the pattern early — if you&apos;re reaching for alcohol (or anything else) to
              manage how you feel, the substance is masking the issue, not solving it. Talk to your
              GP — they will not judge and they will signpost to the right support. Talk to the
              Lighthouse Club helpline (0345 605 1956). The Electrical Industries Charity has
              support pathways including counselling. Drinkline (0300 123 1110, weekdays 9-8,
              weekends 11-4) is a free national alcohol helpline. Frank (0300 123 6600, 24/7) covers
              other substances. Asking for help is hard but it&apos;s much easier than addressing
              the issue later. The trade has lost too many people to this pattern.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re halfway through your second year. A fellow apprentice in your cohort tells
              you, on the way back from college, that he hasn&apos;t been sleeping, missed two weeks
              of college, can&apos;t concentrate at work, and feels like he&apos;s letting everyone
              down. He says he&apos;s been thinking about quitting the apprenticeship. He
              hasn&apos;t spoken to anyone else about it. He asks you not to make a fuss.
              You&apos;re worried about him but you don&apos;t know what to say.
            </>
          }
          whatToDo={
            <>
              Stop and listen properly. Don&apos;t try to fix it on the bus. Acknowledge what
              he&apos;s said — &quot;that sounds really hard&quot;. Don&apos;t minimise
              (&quot;everyone feels like that&quot;). Don&apos;t guess what&apos;s going on
              (&quot;sounds like depression&quot;). Don&apos;t rush to advice. Once he&apos;s
              finished, gently mention the support routes — &quot;there&apos;s a 24/7 helpline for
              the construction industry, 0345 605 1956, Lighthouse Club, free and confidential — you
              don&apos;t have to be in crisis to call. The GP is also a good first step.
              There&apos;s also Mates in Mind for resources, and the Electrical Industries Charity
              if money is part of what&apos;s grinding you down.&quot; Ask whether he&apos;d like
              you to mention to your training-provider tutor — but don&apos;t break his confidence
              without asking. Be honest that if you ever genuinely worry about his safety you&apos;d
              need to escalate — that&apos;s not a betrayal, that&apos;s looking after him. Follow
              up in a few days — &quot;just checking in, how&apos;s your week been&quot;. Keep
              listening over time. Look after yourself too — supporting a peer through something
              heavy is heavy work, and the same support resources are available to you.
            </>
          }
          whyItMatters={
            <>
              The trade has lost too many people to a problem we now know how to talk about. ONS
              data shows male construction workers at around three times the national male suicide
              rate — the highest of any UK occupation group. The cultural pattern of &quot;man up,
              we all feel like that, just get on with it&quot; is what perpetuates the statistic.
              The cultural shift over the last decade — driven by the construction-industry
              charities, by trade unions, by manufacturers, by HSE guidance — has been real, and it
              works because of small ordinary conversations like this one. You&apos;re not expected
              to fix what&apos;s going on for him. You&apos;re expected to listen, acknowledge,
              signpost, and follow up. That&apos;s what peer support in the trade looks like in
              practice. Most of the time the apprentice doesn&apos;t need rescue — he needs a
              colleague who took him seriously and pointed him at the support that exists. Talking
              saves lives. Doing nothing is not a neutral choice.
            </>
          }
        />
        ...
        >
          <p>The apprentice basics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sleep</strong> — protect 7-9 hours wherever possible. Sleep debt accumulates,
              affects concentration, mood and immune function. Persistent sleep problems are worth a
              GP conversation.
            </li>
            <li>
              <strong>Food</strong> — three meals where possible, water through the day, low
              caffeine after lunch. Skipping meals across a long site day is a known cause of low
              mood and poor concentration.
            </li>
            <li>
              <strong>Exercise</strong> — most trade work has a meaningful physical component, which
              helps. Active rest (walking, swimming, cycling) outside work hours is associated with
              lower stress.
            </li>
            <li>
              <strong>Talk</strong> — to a peer, to a mentor, to a tutor, to a family member, to a
              helpline. The single biggest protective factor in the trade context. Don&apos;t wait
              until things are bad.
            </li>
            <li>
              <strong>Boundaries on substances</strong> — alcohol and other substances mask issues
              rather than solve them. If you&apos;re using them to manage how you feel, that&apos;s
              the signal to talk to someone (GP, Drinkline 0300 123 1110, Frank 0300 123 6600).
            </li>
            <li>
              <strong>Use the support that exists</strong> — Lighthouse Club 0345 605 1956 (24/7),
              Electrical Industries Charity (financial and emotional support), Samaritans 116 123
              (24/7), Mind 0300 123 3393, GP. None require you to be in crisis to call.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Quiz
          title="Mental health and neurodiversity in the trade — knowledge check"
