...
const TITLE = 'Effects of poor communication (3.4) | Level 2 Module 5.5.4 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: "Under HASAWA s.7, what's the personal duty on every employee?",
    options: [
  ...
  {
    id: 3,
    question: 'What does Mgmt H&S Regs 1999 Reg 14 require of employees?',
    options: [
  ...
  {
    id: 4,
    question: "What's the relationship between near-misses and serious incidents?",
    options: [
  ...
  {
    id: 5,
    question: 'What financial effect does an undocumented variation have on a project?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Financial, safety, reputational and legal — what happens when the message does not land.
          Rework, scheme withdrawal, RIDDOR-reportable incidents, prosecution under HASAWA s.7. Each
          cost is real and each is recoverable from someone at the end of the day.
        </p>
        ...
        >
          <p>The four cost categories — each gets its own block below:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Financial</strong> — rework, variations not invoiced, fines, warranty void,
              customer refunds, increased insurance premiums.
            </li>
            <li>
              <strong>Safety</strong> — near-miss escalating to RIDDOR-reportable incident,
              live-conductor exposure, injury, fatality.
            </li>
            <li>
              <strong>Reputational</strong> — scheme withdrawal, social media damage, lost
              referrals, loss of repeat business, damage to industry standing.
            </li>
            <li>
              <strong>Legal</strong> — breach of contract claim, professional negligence,
              prosecution under HASAWA s.7, prosecution under EAWR 1989, Mgmt H&amp;S Regs 1999 Reg
              14 enforcement.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The headline financial-cost categories:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Rework</strong> — re-doing an install because the spec wasn&apos;t
              communicated, the design intent wasn&apos;t understood, or the customer wanted
              something different from what was on the drawings. Labour cost falls on the firm;
              materials cost too if they can&apos;t be reused.
            </li>
            <li>
              <strong>Variations not invoiced</strong> — additional work agreed verbally but never
              documented. Likely unrecoverable in dispute. Multiplied across many small variations,
              it&apos;s a material annual loss.
            </li>
            <li>
              <strong>Fines</strong> — HSE prohibition notice or improvement notice for missing
              safety briefings, missing risk assessments, or missing safe systems of work. Direct
              cost plus the cost of the remedial action.
            </li>
            <li>
              <strong>Warranty void</strong> — customer wasn&apos;t briefed on how to operate or
              maintain the kit, the kit fails, the customer claims under warranty. Manufacturer
              rejects the claim because operation was outside specification. Cost falls on the firm.
            </li>
            <li>
              <strong>Customer refunds and price reductions</strong> — under Consumer Rights Act
              2015 s.49, the customer has a statutory right to a price reduction or repeat
              performance where the service wasn&apos;t performed with reasonable care and skill.
            </li>
            <li>
              <strong>Increased insurance premiums</strong> — repeat claims, particularly negligence
              claims, drive up professional indemnity premiums.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The safety-cost cascade:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Unsafe act / unsafe condition</strong> — the bottom of the safety pyramid.
              Skipping a step, taking a shortcut, working with a defective tool. Most don&apos;t
              lead anywhere — but they&apos;re the base of the pyramid.
            </li>
            <li>
              <strong>Near-miss</strong> — an event that could have caused harm but didn&apos;t. The
              gateway from unsafe acts to actual incidents. Reporting and investigating near-misses
              is what stops the next level.
            </li>
            <li>
              <strong>Minor injury</strong> — first-aid level injury that doesn&apos;t require time
              off work. Not RIDDOR-reportable but should be in the accident book.
            </li>
            <li>
              <strong>Reportable injury</strong> — RIDDOR-reportable injuries under the 2013
              Regulations: specified injuries, injuries causing more than 7 days incapacity,
              occupational diseases.
            </li>
            <li>
              <strong>Major injury or fatality</strong> — the top of the pyramid. The HSE will
              investigate and prosecute. Communication failures in the days, weeks or months before
              the incident will be examined and often form the basis of the prosecution.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 14(2) is the personal communication duty on every employee. Two triggers: (a) a
              serious and immediate danger, and (b) a shortcoming in the protection arrangements.
              Both apply to near-misses that exposed a defect in the safe system of work — the
              failed lock-off, the missing permit-to-work, the colleague who didn&apos;t know a
              circuit was live. The duty is personal — the employee has to make the report. Not
              reporting is a Reg 14 breach. The duty exists because the employer can&apos;t fix what
              they don&apos;t know about, and most workplace incidents are preceded by near-misses
              or shortcomings someone on the team had spotted but not raised.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              HASAWA s.7 is the personal criminal duty on every employee. The duty covers acts AND
              omissions — failing to communicate a hazard you identified is an &quot;omission&quot;
              that affects others. The HSE has prosecuted individual employees under s.7 for not
              briefing a successor on a permit-to-work, for not communicating that a circuit was
              still live, and for not raising concerns about defective safe systems of work. &quot;I
              was told to&quot; is not a defence — the personal duty stays on the employee
              regardless of supervisor instructions. &quot;I assumed someone else would tell
              them&quot; is also not a defence.
            </>
          }
        ...
        >
          <p>The reputational-cost categories:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Scheme withdrawal</strong> — NICEIC, NAPIT, ELECSA suspension or withdrawal
              for repeated complaints, non-compliant work, or refusal to engage with the complaints
              process. See Module 3 §1 Sub 6 on certification schemes for the full picture.
            </li>
            <li>
              <strong>Social media damage</strong> — one-star reviews, public complaints on Google /
              Trustpilot / Checkatrade, social media posts from disgruntled customers. Visible to
              every potential future customer.
            </li>
            <li>
              <strong>Lost referrals</strong> — most domestic electrical work comes via word of
              mouth. A bad customer experience kills the referral pipeline from that customer&apos;s
              network.
            </li>
            <li>
              <strong>Loss of repeat business</strong> — the customer doesn&apos;t book the firm for
              the next job. Lifetime value of a domestic customer is meaningful when you add up
              boiler installs, EV chargers, EICRs, consumer-unit upgrades over the years.
            </li>
            <li>
              <strong>Damage to industry standing</strong> — visible failures of particular firms
              damage trust in the trade as a whole.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The legal-cost categories:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Breach of contract — Consumer Rights Act 2015 s.49</strong> — services to
              consumer must be performed with reasonable care and skill. Breach gives the consumer a
              right to repeat performance or price reduction. Pursued via Small Claims Court,
              accessible without legal representation.
            </li>
            <li>
              <strong>Professional negligence</strong> — common-law tort claim where the work falls
              below the standard of a reasonably competent electrician. Damages can include rework,
              consequential loss (replacement of damaged property, alternative accommodation costs)
              and personal injury where applicable.
            </li>
            <li>
              <strong>HASAWA s.7 personal prosecution</strong> — where a communication failure
              caused or contributed to harm. Unlimited fine on conviction in the Crown Court;
              possible imprisonment for serious safety offences.
            </li>
            <li>
              <strong>HASAWA s.2 / s.3 employer prosecution</strong> — where the employer&apos;s
              safe system of work failed and the failure was a communication breakdown.
            </li>
            <li>
              <strong>Mgmt H&amp;S Regs 1999 Reg 14 enforcement</strong> — for employee failures to
              communicate hazards or shortcomings.
            </li>
            <li>
              <strong>EAWR 1989 prosecution</strong> — Electricity at Work Regulations 1989 for
              electrical-specific breaches, often involving a communication failure in the
        ...
        >
          <p>
            The taxonomy in practice — typical hard and soft costs of a single communication failure
            (an undocumented variation that ends in dispute):
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Hard — rework labour</strong> — the half-day of additional work that
              wasn&apos;t invoiced. Direct cost on the firm&apos;s wages bill.
            </li>
            <li>
              <strong>Hard — additional materials</strong> — the extra cable, MCB, accessories,
              consumables for the unrecovered variation. Direct cost on the firm&apos;s materials
              bill.
            </li>
            <li>
              <strong>Hard — variation amount unrecovered</strong> — the agreed value of the
              additional work that the customer disputes and the firm can&apos;t prove in the Small
              Claims Court. Direct loss to the firm&apos;s gross margin.
            </li>
            <li>
              <strong>Hard — HSE improvement notice or fine</strong> — where the same communication
              failure also breached a safety duty. Direct cost to the firm.
            </li>
            <li>
              <strong>Soft — lost referrals from the customer&apos;s network</strong>— the customer
              who would have recommended you to two friends doesn&apos;t. Each lost referral is the
              lifetime value of a domestic customer (boiler installs, EV chargers, EICRs,
              consumer-unit upgrades over the years).
            </li>
            <li>
              <strong>Soft — reputation in the trade</strong> — other contractors hear about the
              dispute, your name is associated with it. Future joint-venture work or sub-contracting
              opportunities quietly disappear.
            </li>
            <li>
              <strong>Soft — scheme-membership scrutiny</strong> — repeated customer complaints to
              NICEIC / NAPIT / ELECSA trigger additional supervision requirements, more frequent
              assessment visits, or in serious cases scheme withdrawal. Once you&apos;re on the
              scheme&apos;s watch list it&apos;s hard to come off.
            </li>
            <li>
              <strong>Soft — internal morale and retention</strong> — staff who spend their time
              firefighting communication failures get tired and leave. Replacement cost of an
              electrician is meaningful.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            Worked case study — illustrative HSE-investigation cost pattern following a serious
            electrical incident with a communication-failure root cause:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Direct investigation cost</strong> — HSE inspector site visits, document
              requests, interviews under caution with the apprentice, supervisor, contracts manager
              and director. Each interview takes the firm&apos;s time off the next job and requires
              legal representation. Typical firm-side cost runs into the thousands of pounds before
              any enforcement action is decided.
            </li>
            <li>
              <strong>Improvement notice or prohibition notice</strong> — issued by the inspector
              requiring specific remedial action within a fixed timescale. The firm has to do the
              work (revised RAMS, updated safe-isolation procedure, re-briefing all operatives) and
              pay the inspector&apos;s fee for the notice — Fee For Intervention (FFI) is charged at
              the published HSE hourly rate for the inspector&apos;s time on the case.
            </li>
            <li>
              <strong>Fine on conviction</strong> — for a HASAWA s.2 or s.3 breach, fines in the
              Crown Court are unlimited and the Sentencing Council&apos;s definitive guideline ties
              the fine to the firm&apos;s turnover and the seriousness of the harm. For a small
              contractor a fine in the tens of thousands of pounds for a serious incident is
              realistic; for a larger firm the figure can be in the hundreds of thousands.
            </li>
            <li>
              <strong>Personal HASAWA s.7 prosecution</strong> — where the investigation finds an
              individual employee&apos;s communication failure caused or contributed to harm.
              Unlimited fine on conviction in the Crown Court, possible custodial sentence for the
              most serious safety offences. The conviction stays on the individual&apos;s record.
            </li>
            <li>
              <strong>Ongoing monitoring</strong> — the HSE may require follow-up visits, additional
              reporting or revised arrangements for a defined period. The firm carries the cost of
              the inspector time and the internal time spent demonstrating compliance.
            </li>
            <li>
              <strong>Reputational follow-on</strong> — HSE prosecutions are publicly reported on
              the HSE register and picked up by trade press and local news. Major customers
              (commercial clients, main contractors) consult the register before awarding contracts.
              A live entry on the register can lock the firm out of tendering opportunities for
              years.
            </li>
            <li>
              <strong>The discipline that prevents all of this</strong> — the near-miss report at
              the start. Five minutes of an apprentice&apos;s time, written up in the firm&apos;s
              near-miss register, investigated and acted on by the supervisor. The communication
        ...
        >
          <p>The five turns of the reputational-loss cycle:</p>
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Trigger — one bad customer experience</strong> — a communication failure
              (missed handover, undocumented variation, argued-back response to a complaint) ends
              with an unhappy customer. The customer posts a one-star review on Google, Trustpilot
              or Checkatrade.
            </li>
            <li>
              <strong>Amplification on review platforms</strong> — the review is visible to every
              potential future customer who searches the firm. Algorithms surface negative reviews
              prominently; review count and average rating are weighted in search results. One bad
              review affects dozens of future search outcomes.
            </li>
            <li>
              <strong>Spread on social media</strong> — the customer posts about the experience on
              Facebook, in local community groups, or on tradesperson-recommendation pages. The post
              is shared, other customers comment, the original complaint takes on a life of its own
              outside the firm&apos;s control.
            </li>
            <li>
              <strong>Lost contracts</strong> — potential customers who would have booked the firm
              see the reviews or the social-media posts and pick a competitor. The lost revenue
              compounds — each lost customer doesn&apos;t generate referrals into their network
              either.
            </li>
            <li>
              <strong>Scheme audit and bonded loop</strong> — repeated customer complaints to NICEIC
              / NAPIT / ELECSA trigger investigation, additional supervision visits, or in serious
              cases scheme suspension. The firm now has higher costs (additional supervision fees,
              remedial work) AND lower revenue (lost contracts), which makes it harder to invest in
              the staff training, customer-service systems and quality discipline that would break
              the cycle. The loop is bonded — each turn makes the next turn more likely.
            </li>
          </ol>
          <p className="mt-3">
            Breaking the cycle takes deliberate work — calm public responses to negative reviews,
            proactive collection of positive reviews from satisfied customers, investment in
            customer-communication training, and consistent communication discipline on every job.
            The cheapest point of intervention is upstream — preventing the communication failure in
            the first place. The apprentice&apos;s five-minute discipline of writing the variation,
            photographing the chase, and reporting the near-miss is what stops the cycle starting.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Section 49 is the statutory standard for service quality in consumer contracts.
              &quot;Reasonable care and skill&quot; is the test — it&apos;s an objective standard
              judged against what a reasonably competent practitioner in the trade would do.
              Communication failures are routinely cited as part of negligence claims under s.49 —
              failure to advise the customer of a safety risk, failure to handover properly, failure
              to explain scope. Breach gives the customer rights including repeat performance and
              price reduction. Pursued via Small Claims Court without legal representation.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice tests a sub-board they thought was isolated. Test prods touch a phase
              conductor that&apos;s still live. No contact, no shock — they step back, heart
              pounding. Don&apos;t tell the supervisor because &quot;no harm done&quot;. Two weeks
              later another apprentice on the same circuit, with the same lock-off procedure,
              isn&apos;t as careful. Receives a serious electric shock. HSE investigates. The
              investigation identifies the prior near-miss and the failure to report it. The first
              apprentice is interviewed under HASAWA s.7 and Mgmt H&amp;S Regs 1999 Reg 14. The
              employer is interviewed under HASAWA s.2 and EAWR 1989. Multiple regulatory and
              personal liabilities.
            </>
          }
          doInstead={
            <>
              Report every near-miss, even (especially) when no harm was done. Mgmt H&amp;S Regs
              1999 Reg 14(2) makes this a personal statutory duty. The report allows the employer to
              investigate, identify the root cause (defective lock-off, missing permit-to-work,
              briefing that didn&apos;t land), fix it, brief the team, and prevent the next
              incident. &quot;No harm done&quot; is the phrase that should make you reach for the
              report form, not walk away. The HSE consistently identifies failure to act on prior
              near-misses as a precursor to fatal incidents.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer asks for an extra circuit on day three of a five-day kitchen rewire.
              Apprentice agrees verbally. The work is done — takes half a day, two extra cable runs,
              an additional MCB and associated test work. Apprentice adds the cost to the final
              invoice. Customer disputes the additional charge — &quot;I never agreed to that
              price&quot;. Firm has no documented variation, no agreed price, no signed scope
              change. Disputes goes to the Small Claims Court. Court finds for the customer because
              the contractor cannot demonstrate the variation was properly documented. The half-day
              of labour, the additional materials, the late completion of the job — all sit on the
              firm&apos;s profit margin. The same pattern, repeated across many small variations on
              many jobs, is a material annual loss.
            </>
          }
          doInstead={
            <>
              The moment a customer asks for additional work, switch from verbal to written. A short
              written variation document by email — listing the work, the cost, the time impact,
              requesting the customer&apos;s confirmation — takes five minutes. Don&apos;t start the
              additional work until the written confirmation is back. The variation document
              protects payment, scope and warranty. The verbal yes is for the relationship; the
              written variation is for the file.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re testing a sub-distribution board you thought had been isolated and
              locked-off by the supervisor 30 minutes earlier. You proved the tester at the proving
              unit, did your dead test on the conductors, and one of them registered as live. You
              stepped back — no contact, no shock, no injury. Investigation in the moment shows the
              lock-off had been put on the wrong switch — the supervisor isolated the wrong
              sub-board. You re-do the isolation properly, lock-off correctly, dead-test, and
              proceed with the work. You&apos;re shaken but uninjured. Nobody else saw what happened
              and the supervisor doesn&apos;t mention it. You consider whether to report it.
            </>
          }
          whatToDo={
            <>
              Report it. Write up the near-miss in the firm&apos;s near-miss register or accident
              book — date, time, location, what you expected (board isolated, dead-test confirms
              dead), what you found (conductor live, lock-off on wrong switch), what action you took
              (re-isolated, locked-off, dead-tested, proved tester, proceeded). Tell the supervisor
              face-to-face calmly — &quot;I need to flag a near-miss from earlier&quot;. Mgmt
              H&amp;S Regs 1999 Reg 14(2) makes this a personal statutory duty — the lock-
              off-on-wrong-switch is both a serious and immediate danger AND a shortcoming in the
              protection arrangements. Report it to the employer&apos;s nominated person if the
              supervisor is the source of the shortcoming. The employer is required to investigate,
              identify the root cause (was the supervisor briefed on which board to isolate? did
              they have the right drawings?), and fix the safe system of work to prevent the next
              incident. If you don&apos;t report it, the same defect is in place for the next
              apprentice — who may not be as lucky.
            </>
          }
          whyItMatters={
            <>
              The HSE&apos;s &quot;accident triangle&quot; consistently shows that for every
              fatality there are dozens of serious injuries, hundreds of minor injuries, and
              thousands of near-misses with similar root causes. Reporting and acting on near-misses
              is the single most effective way to prevent the next serious incident. Failing to
              report a near-miss leaves the same defect in place. Two weeks after the unreported
              near-miss, another apprentice on the same circuit, with the same lock-off procedure,
              isn&apos;t as careful and gets a serious shock. HSE investigates, finds the prior
              near-miss was known and not reported, and prosecutes both the employer (HASAWA s.2,
              EAWR 1989) AND the original apprentice (HASAWA s.7, Mgmt H&amp;S Regs 1999 Reg 14).
              The personal liability cannot be transferred to the employer or the supervisor.
              Reporting takes five minutes and prevents the entire downstream cost.
            </>
          }
        />
