...
const TITLE = 'Efficiency, inter-relationships and calculations | Level 2 Module 2.2.6 | Elec-Mate';
const DESCRIPTION =
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        >
          ...
          <p>
            Most Level 2 mechanics problems are just two or three of these stitched together. Spot
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Two checks. (1) Inrush current — induction motors draw 5-7× their running current at
