...
const checks = [
  {
    ...
    options: ['78.5 N', '8 N', '8 kg', '0.82 N'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['m = W × g', 'W = m ÷ g', 'g = m × W', 'W = m × g'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['196.2 N', '2 N', '20 N', '981 N'],
    correctAnswer: 0,
    explanation:
  ...
  {
    id: 6,
    question: 'Why is the SI unit of force (and therefore weight) the newton, not the kilogram?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Mass is the amount of stuff in an object. Weight is the force gravity pulls on it. Mix the
          two up and you’ll lose marks in the exam — and pick the wrong-rated bracket on site.
        </p>
        ...
        >
          <p>
            ...
            bundles, tool bags up a ladder. Every one of those moments is a mechanics problem. Mass
            and weight are the two words you need to get straight before any of it makes sense.
          </p>
          <p>
            The exam tests this in the first ten minutes of the paper. The on-site version tests it
            the first time you fit a fixing into plasterboard with a 25 kg unit hanging off it. Both
            versions punish you for mixing the units up.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            The key thing about mass: it’s a property of the object itself. Take a 5 kg drill to the
            top of Snowdon, into a basement, into orbit, onto the Moon — it’s still 5 kg. That’s why
            labels and spec sheets use kilograms: they’re true everywhere.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Weight is a force. Specifically, it’s the force that gravity pulls down on a mass with.
            Because it’s a force, it’s measured in <strong>newtons (N)</strong>, not in kilograms.
          </p>
          ...
          <p>
            Where W is weight in newtons, m is mass in kilograms, and g is the local gravitational
            field strength in metres per second squared (m/s²). On Earth, g is taken as{' '}
            <strong>9.81 m/s²</strong> for proper work. For a quick site estimate, ×10 is close
            enough.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              <strong>Force (and so weight) in N.</strong> Every BS EN standard, every spec sheet,
              every lift plan you’ll meet uses these. Get the unit wrong on an exam answer and you
              lose the mark.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>On the Moon (g ≈ 1.6):</strong> W = 5 × 1.6 = <strong>8 N</strong>. Same tin,
              six times lighter to lift.
            </li>
            <li>
        ...
        >
          <p>
            The HSE guideline figure for a single-person waist-height lift is around 25 kg for a fit
            adult male and 16 kg for a fit adult female. That’s a mass — what a set of scales would
            show. The force on your spine when you actually lift it is mass × g, so you’re fighting
            roughly 245 N (or 157 N) every time. Lift it badly and the stress concentrates on a tiny
            part of your lower back.
          </p>
          <p>
            Brackets and fixings work the other way round. The spec sheet for a wall plug might say
            "rated to 50 kg per fixing" — that’s really shorthand for "rated to a downward force of
            about 490 N". When BS EN test labs verify those ratings, they apply the force in
            newtons.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Real gravity is 9.81 m/s² in the UK. The shortcut of 10 makes you off by about 2%, which
            is well inside the safety factors built into any rated kit. So:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            Use the shortcut to think on your feet. Use 9.81 for paperwork. Always say which one you
            used in an exam answer — examiners credit either, as long as you’re consistent.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The question says "calculate the weight of a 20 kg motor". You write "20 kg". Examiner
              crosses it out. The unit kg is for mass — you needed newtons. Whole mark gone, even
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              That’s above the single-person guideline. Get a second pair of hands, or use a trolley
              or a small lift. Note the change on the RAMS so the next person doesn’t make the same
              call you didn’t.
            </>
          }
          whyItMatters={
            <>
              ...
              reasonably practicable — but s.7 of HASAWA puts the duty on YOU not to crack on with a
              lift you know is over the line. "It was only 3 kg over" is a poor opening line in a
              back injury claim.
            </>
          }
        />
        ...
        >
          <p>
            ...
            drum is hard to push along the floor even on castors — gravity isn’t involved sideways,
            but you’re still fighting the mass.
          </p>
          <p>
