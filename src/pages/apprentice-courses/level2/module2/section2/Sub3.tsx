...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['A wheelbarrow', 'A pair of scissors', 'A spoon flicking peas', 'A seesaw'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['MA 4, pull 4 m', 'MA 0.25, pull 1 m', 'MA 2, pull 2 m', 'MA 4, pull 1 m'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The three simple machines you’ll meet over and over — in your tool bag, on a hoist, inside
          the drill. They all do the same job: trade distance for force, or speed for torque.
        </p>
        ...
        >
          <p>
            ...
            7671?” The honest answer: nowhere directly — and everywhere through the back door. Three
            places it lands every week on site:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              tray — these are pulley/winch problems, governed by the same MA = load ÷ effort you’re
              about to learn. Get the MA wrong and someone gets hurt or the cable gets damaged.
            </li>
            <li>
              <strong>Hoist and winch use — LOLER 1998.</strong> Any chain block, hoist or winch
              lifting electrical kit (transformers, distribution boards, motor frames) is regulated
              lifting equipment. Knowing the MA isn’t a substitute for the LOLER competent-person
              plan, but it’s the maths underneath whether the lift is feasible in the first place.
            </li>
          </ul>
          <p>
        ...
        >
          <p>
            The six classic simple machines — lever, pulley, wheel and axle, inclined plane, wedge
            and screw — all do the same thing: change the direction or magnitude of a force. They
            never create energy out of nothing. Whatever you save in effort, you pay back in
            distance.
          </p>
        ...
        >
          <p>
            ...
            effort is applied at one place, a load at another. The classes differ only in the order
            of the three:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Class 1 — fulcrum in the middle:</strong> seesaw, crowbar, pliers, side
              cutters, scissors. MA depends on which side is longer. Levering up a stuck floor cover
              with a long pry bar is a class 1 with a big MA in your favour.
            </li>
            <li>
            ...
            <li>
              ...
              tool, a fishing rod. MA always less than 1 — you’re trading force for speed and range
              of motion. Useful when you need precision, not power.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <LeverDiagram
          leverClass={1}
          eyebrow="Class 1 — fulcrum in the middle"
          caption="Crowbar, pliers, side cutters. The longer the effort arm, the bigger the MA."
        />
        <LeverDiagram
          leverClass={2}
          eyebrow="Class 2 — load in the middle"
          caption="Wheelbarrow, bottle opener. Always MA > 1, so always multiplies force."
        />
        <LeverDiagram
          leverClass={3}
          eyebrow="Class 3 — effort in the middle"
          caption="Tweezers, forearm with a tool. MA < 1 — trades force for speed and range."
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              could in principle move anything — provided you didn’t mind covering vast distance at
              the input end. <strong>Effort × effort distance = Load × load distance.</strong> Same
              rule whether you’re cutting wire or moving a planet.
            </>
          }
        ...
        >
          <p>
            ...
            <strong> 3.5 N·m</strong>. That's a torque — a turning force — and it's the same lever
            maths from the law of the lever above:
          </p>
          <p className="font-mono text-[15px] text-elec-yellow bg-white/[0.04] border border-white/[0.06] rounded-lg px-4 py-2.5">
            Torque (N·m) = Force (N) × distance from pivot (m)
          </p>
          <p>Here's the conversion both ways so the number stops being abstract:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1 metre bar.</strong> A 350 g weight (≈ 3.5 N — close enough; weight in
              newtons = mass in kg × 9.81) hung from the end of a 1 m bar gives 3.5 N × 1 m = 3.5
              N·m. So picture pressing on a 1 m bar with about the weight of a tin of beans on its
              end. That's the torque the manufacturer wants on a consumer unit screw. Doesn't feel
              like much — and it isn't.
            </li>
            <li>
              <strong>250 mm torque wrench (typical short bench wrench).</strong> Same torque,
              shorter arm, so more force at the handle: F = 3.5 ÷ 0.25 = 14 N. That's about 1.4 kg
              of push at the handle — roughly the weight of a full kettle pulling down on the end of
              the wrench. Still not heavy.
            </li>
            <li>
          ...
          <p>
            ...
            knowing the arm you're applying force at, the actual N·m on the screw could be anywhere
            from 2 N·m to 20 N·m. Buy a torque tool, set it to the manufacturer's number, click it.
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single fixed pulley:</strong> the wheel is bolted overhead. The rope changes
              direction (you pull down, the load goes up). MA ≈ 1 — you don’t save force, you just
              change the angle.
            </li>
            <li>
              <strong>Single movable pulley:</strong> the wheel is attached to the load itself. Two
              rope segments support the load, so the effort is roughly half. MA ≈ 2.
            </li>
            <li>
              <strong>Block and tackle (compound):</strong> a set of fixed and movable pulleys with
              rope wound back and forth. MA ≈ the number of rope segments supporting the load. A
              4-segment system gives MA ≈ 4.
            </li>
          </ul>
          <p>
            The trade is always the same: MA × 4 means you have to pull 4× the rope length to lift
            the load 1 unit. Energy in = energy out (ignoring friction).
          </p>
        </ConceptBlock>

        <PulleySystem
          pulleys={1}
          eyebrow="Single fixed pulley"
          caption="Changes direction only — pull down, load goes up. MA ≈ 1."
        />
        <PulleySystem
          pulleys={2}
          eyebrow="Single movable pulley"
          caption="Load hangs from a movable wheel — two rope segments share the load. MA ≈ 2."
        />
        <PulleySystem
          pulleys={3}
          eyebrow="Block and tackle"
          caption="Compound system — multiple wheels in two blocks. MA ≈ number of supporting segments."
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Pulleys, hoists and chain blocks are <strong>lifting equipment</strong> under LOLER.
              Picking the right MA matters, but so does planning the lift, checking the gear is in
              date, and putting an exclusion zone under the load. Knowing the MA isn’t a substitute
              for planning the lift properly.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              six-monthly for accessories, twelve-monthly for the lifting machine itself. Look for
              the certificate / colour code before you trust any lifting gear on site. No in-date
              paperwork = the gear doesn't get used, however well it looks.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              When pulleys and hoists are used to lift cable, kit or tools at height — running 70
              mm² SWA up a four-storey riser, lifting a CU into a loft hatch — WAHR's falling-object
              rule applies on top of LOLER. Exclusion zone below the lift, no-one directly
              underneath, tool tethers on hand kit at the working level. Pulley mechanics tell you
              the lift is feasible; WAHR tells you who has to be clear of the load path while it
              happens.
            </>
          }
        ...
        >
          ...
          <p>
            A 12-tooth driver turning a 36-tooth driven gives a ratio of 3:1 — the driven turns 3×
            slower with 3× the torque. Useful for lifting, drilling masonry, anything that needs
            grunt over speed.
          </p>
          <p>
            Reverse the situation (36-tooth driver, 12-tooth driven) and you get a 1:3 ratio — the
            driven turns 3× faster but with only 1/3 the torque. Useful when you want speed, like a
            fan or a small angle grinder.
          </p>
          <p>Power in still equals power out (ignoring friction losses). Gears just reshape it.</p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              An apprentice at the back of the class works out that a 4:1 hoist lets them lift 100
              kg with 25 kg of effort and decides it’s magic. Then they try to lift the load 2 m and
              wonder why they’ve pulled 8 m of rope through.
            </>
          }
          doInstead={
            <>
              Always remember the trade. <strong>Force × distance is conserved.</strong> If you save
              force, you pay distance. The total energy is the same (and a bit less in practice,
              because friction always takes a cut).
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re running a length of 70 mm² SWA up a service riser to a sub-main DB. The drum’s
              on the ground floor. Pulling that lot up by hand isn’t happening — friction in the
              riser plus the cable’s own weight is too much.
            </>
          }
          whatToDo={
            <>
              Use a snatch block at the top with a couple of movable pulleys, or set up a powered
              cable winch. The block-and-tackle gives you MA — a single person can manage what would
              otherwise need three. Make sure the gear is rated for the load (LOLER), the anchor
              point is sound, and the riser is clear of people during the lift.
            </>
          }
          whyItMatters={
            <>
              Right pulley setup turns a four-person, half-day fight into a tidy two-hour job. Wrong
              setup (or no MA at all) gets someone strained, and probably gets the cable dropped. A
              bit of mechanics knowledge here pays for itself instantly.
            </>
          }
        />
        ...
        >
          <p>Three more "simple machines" round out the family:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Inclined plane (ramp):</strong> moving a 100 kg load up a 1-in-4 slope needs
              roughly a quarter of the force of lifting it straight up — but you push it four times
              further.
            </li>
            <li>
              <strong>Wedge:</strong> two inclined planes back-to-back. Used to split, pry or fix.
              Chisels, axe heads, doorstops.
            </li>
            <li>
              <strong>Screw:</strong> an inclined plane wrapped around a cylinder. A jack screw or a
              wood screw concentrates a small turning force into massive linear force — which is why
              you can compress a stack of pipework together with a couple of bolts.
            </li>
          </ul>
          <p>
            These get treated more in Level 3 mechanical units. For Level 2, just recognise them as
