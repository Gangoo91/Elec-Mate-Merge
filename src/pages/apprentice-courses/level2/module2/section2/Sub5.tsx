    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <p className="text-[13.5px] text-white/85 leading-relaxed border-l-2 border-cyan-400/40 pl-4 italic">
          ...
          Sub4.5 (electrical power — exactly the same P = W ÷ t and the watt as a unit, just with P
          = V × I as the way to get there). The mechanical-vs-electrical distinction is the input,
          not the maths.
        </p>
