      ...
      <HubBody>
        ...
        >
          ...
          <p>
            ...
            power — the rest leaks out as heat in the windings and friction in the bearings. Sub6
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>
                The energy in a charged capacitor that bites you (E = ½CV²) — preview Sub6.3.
              </strong>{' '}
