    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          ...
          power formulas end-to-end. Two full multi-step examples and the diagnostic checks that go
          with them.
        </p>
        ...
        <ConceptBlock title="Five Subs in, you’ve got the toolkit — this Sub puts it on real circuits">
          <p>
            Sub 4.1 gave you Ohm’s law (V = I × R) — the one equation you’ll use on every problem
            from here on. Sub 4.2 introduced series circuits — single path, current the same
            everywhere, voltages add up to the supply. Sub 4.3 introduced parallel circuits — shared
            voltage, branch currents add up to the total. Sub 4.4 showed how to combine the two by
            collapsing parallel blocks first, then summing the series chain. Sub 4.5 added power —
            three formulas, same physics — plus the I²R rule that makes cable heating bite. This Sub
            is where it all comes together on the kind of mixed circuits you’ll meet on site.
          </p>
          <p className="text-[13px] text-white/75 italic">
            ...
            MFT you met in <strong>Sub1.5</strong> measures Zs (the field version of total
            resistance — Ze + R1 + R2 in series) directly at any socket on the install. That’s the
            practical end of everything in this Sub: paper says one number, MFT says another, and
        ...
        >
          ...
          <p>
            <strong>Step 1 — cold resistance (Sub3.3, R = ρL/A).</strong> Round-trip means out and
            back, so length doubled:
            <br />R = 0.0172e-6 × 28 × 2 ÷ 6e-6 = <strong>0.16 Ω</strong> round-trip at 20°C.
          </p>
          <p>
            <strong>Step 2 — voltage drop at full load (Sub3.4, Method B).</strong> Use the mV/A/m
          ...
          <p>
            <strong>Step 3 — heat dumped in the cable (Sub3.5, P = I²R).</strong> Using the cold
          ...
          <p>
            <strong>Step 4 — power delivered to the load (Sub4.5, P = V × I).</strong> Shower at
            full draw:
            <br />
          ...
          <p>
            That single calculation touched <strong>four prior Subs</strong> — Sub3.3 (resistance
            from ρL/A), Sub3.4 (voltage drop via mV/A/m), Sub3.5 (I²R cable heating) and Sub4.5
            (load power from V × I). That’s what synthesis means: the cable doesn’t care which Sub
            it lives in, and neither does the customer paying the bill.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worth memorising — the Section 4 formula sheet">
          <p>
            Every formula you’ve used across Sub 4.1 to Sub 4.5, gathered in one place. Screenshot
