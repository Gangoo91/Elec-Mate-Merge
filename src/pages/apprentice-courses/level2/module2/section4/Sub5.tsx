...
const TITLE = 'Power in series and parallel circuits | Level 2 Module 2.4.5 (AC 4.6) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: ['P = I² × R', 'P = V × I', 'P = V² ÷ R', 'P = R ÷ V'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    question: 'You double the current in a cable. How much does the I²R heating change?',
    options: ['It halves', 'It doubles', 'It quadruples (×4)', 'It stays the same'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Both the same', 'A 920 Ω load', 'Need current to decide', 'A 460 Ω load'],
    correctAnswer: 3,
    explanation:
      'P = V² ÷ R. Lower R on the same V gives more power. 230² ÷ 460 ≈ 115 W; 230² ÷ 920 ≈ 57.5 W.',
  },
  {
    id: 4,
    question: 'You know I and R but not V. Which power formula fits?',
    options: ['P = I² × R', 'P = V × I', 'P = V² ÷ R', 'P = V ÷ I'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Three formulas, one rule. Pick the formula that uses the values you have, sum the
          component powers for the total, and remember — heat in cables goes up with the SQUARE of
          the current.
        </p>
        ...
        >
          <p>
            Power is energy per second. Measured in watts (W), where 1 W = 1 J/s. Three formulas all
            describe the same thing:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>P = V × I</strong> — most common. Use it when you have voltage and current.
              Nameplate readings, meter values, quick estimates.
            </li>
            <li>
              <strong>P = I² × R</strong> — use when you have current and resistance. Cable losses,
              heat in conductors, power lost in series components.
            </li>
            <li>
              <strong>P = V² ÷ R</strong> — use for fixed-voltage resistive loads. Heater elements,
              kettle elements, filament lamps. Fixed mains, known resistance.
            </li>
          </ul>
          <p>
            All three are derived from V = I × R. Substitute one into another and you get the other
            two — they’re the same equation in three outfits.
          </p>
        </ConceptBlock>

        <PowerTriangle
          variant="dc"
          caption="P = I × V — the DC power triangle. Cover the value you want; the formula falls out."
        />
        ...
        >
          <p>Start with P = V × I. Now substitute Ohm's law two different ways:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Replace V with I × R: P = (I × R) × I = <strong>I² × R</strong>. This is the form you
              use when you know current and resistance — handy for cable losses where you always
              know I (the load current) and R (the cable resistance).
            </li>
            <li>
              Replace I with V ÷ R: P = V × (V ÷ R) = <strong>V² ÷ R</strong>. This is the form you
              use when you know voltage and resistance — handy for fixed-mains heater elements where
              V is 230 V and R is the element's resistance.
            </li>
            <li>
              Leave both alone: <strong>P = V × I</strong>. The original form. Use when you have a
              meter on the live circuit and can read both directly.
            </li>
          </ul>
          <p>
            All three give the same numerical answer for the same circuit — they're just different
            starting points. If you're ever stuck for which to use, pick the one that uses the
            values you have without conversion. If you have all three values (V, I and R), use any
            of them as a cross-check on each other.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            In a series circuit, the same current flows through every component. Plug that into P =
            I² × R and you can see straight away — the resistor with the largest R dissipates the
            most power, because it’s the only thing that varies.
          </p>
          <p>
            <strong>Worked example.</strong> 12 V supply, R₁ = 100 Ω, R₂ = 200 Ω, R₃ = 300 Ω all in
            series.
          </p>
          <p>
          ...
          <p>
            Notice R₃ (the biggest) takes 0.12 W — half the total. R₁ takes a quarter as much as R₃.
            That ratio is just the resistance ratio: 100 : 200 : 300 = 1 : 2 : 3, same as the power
            ratio.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            In parallel, every branch sees the supply voltage. Plug that into P = V² ÷ R and the
            branch with the SMALLEST R dissipates the most power — opposite to series.
          </p>
          <p>
            <strong>Worked example.</strong> 24 V supply with three parallel branches: R₁ = 120 Ω,
            R₂ = 80 Ω, R₃ = 240 Ω.
          </p>
          <p>
          ...
          <p>
            Cross-check using P = V × I on the whole circuit: total current = 0.6 A (worked out in
            Sub 3). P = 24 × 0.6 = 14.4 W ✓. Same total either way you slice it.
          </p>
          <p>
            R₂ (the smallest at 80 Ω) takes the most power — 7.2 W out of 14.4 W. The biggest
            resistor (240 Ω) takes the least. That’s the opposite of series, and worth burning into
            memory.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="The power calculator">
          <p>
            Plug in any two of voltage, current, resistance or power and the calculator returns the
            rest. Use it to check the worked examples above and any of your own. The exam doesn’t
            let you bring this in — keep practising the manual maths.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The heat dissipated in a conductor is P = I² × R, where R is the cable’s own resistance.
            The current term is squared — it dominates everything else.
          </p>
          <p>
            <strong>Worked example.</strong> A 32 A radial circuit, 6 mm² T&amp;E, 40 m run. Cable
            resistance roughly 3.08 mΩ per metre per conductor. Round-trip resistance (line +
            neutral): 2 × 3.08 × 40 = 246 mΩ ≈ 0.246 Ω.
          </p>
          <p>
            At full load: P(loss) = I² × R = 32² × 0.246 = 1024 × 0.246 ≈ 252 W lost as heat in the
            cable. (Roughly double the figure you might have seen using single-conductor resistance
            — be clear whether you’re working with line-only or both legs.)
          </p>
          <p>
            That heat has to escape. Group cables together, push them into thermal insulation, or
            run them in a hot ceiling void and the derating factors in BS 7671 Appendix 4 kick in to
            keep the conductor temperature inside its rating.
          </p>
          <p>
            <strong>
              The squared rule, in numbers — 2.5 mm² T&amp;E, R/m ≈ 7.41 mΩ/m per conductor:
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70 font-mono tabular-nums">
            ...
            <li>
              20 A → I²R = 20² × 0.00741 = 2.96 W per metre per conductor (4× the 10 A figure).
            </li>
            <li>
              30 A → I²R = 30² × 0.00741 = 6.67 W per metre per conductor (9× the 10 A figure).
            </li>
          </ul>
          <p>
            Read the column. Doubling current (10 A → 20 A) doesn’t double the heat — it quadruples
            it. Tripling current (10 A → 30 A) gives nine times. That squared relationship is what
            cooks an undersized cable when the load creeps up. The cable hasn’t changed; the heat
            has.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Translation — extra current sources (like harmonic distortion from non-linear loads)
              push extra I²R losses into conductors and especially the neutral. The regs require you
              to apply derating factors so the cable still stays within its temperature rating. Same
              I²R maths you’ve just used, but with realistic site-condition adjustments.
            </>
          }
        ...
        >
          <p>
            Your supplier doesn’t care about peak watts — they bill per kWh of energy. The maths is
            simple:
          </p>
          <p>
          ...
          <p>
            <strong>Worked example 1.</strong> A 3 kW kettle, on for 6 minutes (0.1 h). Energy = 3 ×
            0.1 = 0.3 kWh. At 28p per kWh, the cup of tea costs 0.3 × £0.28 = £0.084 (8p of energy).
          </p>
          <p>
            <strong>Worked example 2.</strong> A 2 kW heater on for 4 hours. Energy = 2 × 4 = 8 kWh.
            At 28p per kWh, that’s 8 × £0.28 = £2.24 to keep one room warm for an evening.
          </p>
          <p>
            The kWh is the same energy unit you’ll see on inverter logs, EV dashboards and every
            electricity bill in the UK. Get comfortable with the conversion both ways.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>The main supply</strong> — total connected load × diversity factor ≤ supply
              head capacity (typically 60-100 A for domestic).
            </li>
            <li>
              <strong>Sub-mains and tails</strong> — feeder cable from the cut-out to the consumer
              unit, sized for the after-diversity figure not the raw connected load.
            </li>
            <li>
              <strong>Distribution boards</strong> — incoming switch and the busbar, sized for the
              realistic total of all the outgoing circuits running together.
            </li>
          </ul>
          <p>
            The OSG (On-Site Guide) Section A2 tables are the standard reference for domestic
            diversity factors. Worked example for a typical UK house: 6 kW shower + 7.2 kW cooker +
            3 kW immersion + sockets + lighting can total ~25 kW connected, but with diversity
            applied lands around 14 kW — comfortable on a 100 A (23 kW) supply at 230 V.
          </p>
          <p>
            Don't use diversity on circuits that genuinely DO run at full power simultaneously (e.g.
            an EV charger on a long charge cycle, an instantaneous shower while the cooker is on at
            dinner time). When in doubt, design for the worst-case simultaneous load — under-sized
            supply tails are an expensive mistake to dig up.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You write P = I × R for cable losses — using the formula for voltage drop instead of
              power. Your number is way too small. Then on a slightly overloaded run you think the
              heating’s fine when it’s actually four times what you calculated.
            </>
          }
          doInstead={
            <>
              Cable heating is P = I² × R. The I term is squared. If you use the wrong formula,
              you’ll under-estimate heating by a factor equal to the current itself — easy to see
              why undersized cables cook even though “the maths said it was OK”.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A 9.5 kW electric shower has been retro-fitted on a circuit that previously fed an 8.5
              kW one. Same cable, same breaker. The shower runs for a few minutes, then trips the
              protective device every time.
            </>
          }
          whatToDo={
            <>
              Work the current. I = P ÷ V = 9500 ÷ 230 ≈ 41.3 A. The old 8.5 kW unit drew about 37
              A. The new one is asking for about 41 A through the same cable. Cable heating goes up
              with I², so 41² ÷ 37² ≈ 1.23 — the cable runs about 23 % hotter. On a 40 A breaker the
              new shower is past its rating, hence the trips. The fix is a properly designed circuit
              for the larger unit — bigger cable AND bigger protective device — not a hotter trip
              setting.
            </>
          }
          whyItMatters={
            <>
              Power calcs aren’t academic. They tell you whether the existing circuit can take the
              new load before you energise it. “It worked yesterday with the smaller shower” isn’t a
              design — every uplift needs the I and the I²R re-checked.
            </>
          }
        />
        ...
        <p className="text-[13.5px] text-white/85 leading-relaxed border-l-2 border-emerald-400/40 pl-4 italic">
          ...
          series/parallel maths from Sub4.1-4.4 — synthesis is where the power calcs really land.
        </p>
