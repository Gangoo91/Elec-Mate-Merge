...
const checks = [
  {
    ...
    options: ['I = V × R', 'I = V ÷ R', 'I = R ÷ V', 'I = R − V'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['2.5 A', '0.25 A', '0.025 A', '25 A'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['I = R ÷ V', 'I = V × R', 'I = V ÷ R', 'I = V + R'],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ['0.035 Ω', '1840 Ω', '238 Ω', '28.75 Ω'],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ['200 Ω', '5 Ω', '0.2 Ω', '5000 Ω'],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ['12 Ω', '4.8 Ω', '240 Ω', '120 Ω'],
    correctAnswer: 3,
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          V = I × R. Three letters, one formula, three rearrangements. Get this nailed and the rest
          of the course gets a lot easier.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Voltage (V)</strong> — the electrical pressure or push, measured in volts. UK
              domestic mains is nominally 230 V. Like water pressure in a pipe.
            </li>
            <li>
              <strong>Current (I)</strong> — the flow of charge that the pressure causes, measured
              in amps. The bigger the flow, the more heat in the cable. Letter is <em>I</em> from
              the French <em>intensité du courant</em>.
            </li>
            <li>
              <strong>Resistance (R)</strong> — opposition to current, measured in ohms (Ω). A long
              thin wire has more resistance than a short fat one. A heater element is designed to
              have a specific resistance so the right current flows for the right heat.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            Georg Ohm worked it out in 1827. For a metal conductor at a steady temperature, the
            current that flows is directly proportional to the voltage applied, and inversely
            proportional to the resistance. Twice the voltage gives twice the current. Twice the
        ...
        >
          <p>
            Ohm’s law expects the base units — volts, amps, ohms. If your value is in milliamps or
            kilohms, convert it FIRST. The formula doesn’t care about prefixes and it won’t warn you
            if you mix them.
          </p>
          <ul className="space-y-1 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Example 1 — finding current from voltage and resistance">
          ...
          <p>
            <strong>Step 1 — pick the right rearrangement.</strong> You know V and R, you want I, so
            use I = V ÷ R.
          </p>
          <p>
            <strong>Step 2 — units already in base form.</strong> Volts and ohms — no conversion
            needed.
          </p>
          <p>
          ...
          <p>
            <strong>Step 4 — sanity check.</strong> A small heater drawing 2.5 A on UK mains feels
            right (a 575 W heater). A 13 A plug top would handle it comfortably. The answer is
            reasonable.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Example 2 — finding voltage from current and resistance">
          <p>
            <strong>Given:</strong> a sensor on a control panel draws 200 mA through a 3.3 kΩ series
            resistor.
            <br />
            <strong>Find:</strong> the voltage drop across the resistor.
          </p>
          <p>
            <strong>Step 1 — convert units first.</strong> 200 mA = 0.2 A. 3.3 kΩ = 3300 Ω. Now
            everything is in base units.
          </p>
          <p>
          ...
          <p>
            <strong>Step 4 — sanity check.</strong> 660 V across one resistor in a control panel is
            a red flag — you’d expect tens, not hundreds, of volts on a typical control circuit.
            Either the question is a teaching example with fictional values, or the resistor is
            wrong for the job. Worth flagging on a real install.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Example 3 — finding resistance from voltage and current">
          ...
          <p>
            <strong>Step 1 — pick the right rearrangement.</strong> You know V and I, you want R, so
            use R = V ÷ I.
          </p>
          <p>
          ...
          <p>
            <strong>Step 4 — sanity check.</strong> 200 Ω is a sensible value for a small control
            coil or relay winding. The answer is plausible.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="The Ohm’s law calculator">
          <p>
            Punch any two values in and the calculator returns the other two. Use it to check your
            manual maths after you’ve worked through it on paper — not as a replacement for
            understanding the formula. The exam doesn’t let you bring this in.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            You don’t quote Ohm’s law on a certificate, but it’s behind every calculation that does
            end up there. The current a cable can carry, the disconnection time of a breaker on an
            earth fault, the voltage left at the far end of a long run — all of it pivots on V = I ×
            R.
          </p>
          <p>
            This Sub gets the formula nailed. The next four Subs apply it to series, parallel and
            mixed circuits — and the Sub after that uses it to calculate power.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Translation — the protective device has to trip BEFORE the cable’s current-carrying
              capacity is overcooked. Working out the actual current in a fault uses Ohm’s law (I =
              V ÷ Z). This is why the formula matters in real cable / breaker selection, not just on
              a quiz.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              <strong>R = 24 ÷ 250 = 0.096 Ω</strong> straight into the calculator. Looks small,
              must be right. Except the real answer is <strong>R = 24 ÷ 0.25 = 96 Ω</strong> — 1000×
              bigger. Same numbers, totally different circuit.
            </>
          }
          doInstead={
            <>
              Before you touch the formula, convert every value to base units. Write it out: “V =
              24, I = 0.25, R = ?”. Then calculate. The two-second conversion saves the whole
              question.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re commissioning a new ring final. At the consumer unit you take a Zs (earth fault
              loop impedance) reading on the incoming side and get <strong>0.62 Ω</strong>. The
              circuit is protected by a 32 A Type B MCB on a 230 V TN-S supply. Before you tick the
              cert, decide — does it pass?
            </>
          }
          whatToDo={
            <>
              Two checks, both Ohm’s law underneath.{' '}
              <strong>(1) Compare to the BS 7671 Table 41.3 limit</strong> — max Zs for a 32 A Type
              B at 230 V is <strong>1.09 Ω</strong>. Your reading of 0.62 Ω is well under.{' '}
              <strong>(2) Apply the 80% rule (Reg 643.3) for measurement uncertainty</strong> — you
              want your site reading to sit at or under 0.8 × 1.09 = <strong>0.87 Ω</strong>. 0.62 Ω
              is inside that too, with about 30% headroom for cable temperature rise. Then use Ohm’s
              law to find the prospective fault current:{' '}
              <strong>I = U ÷ Zs = 230 ÷ 0.62 = 371 A</strong>. A Type B MCB’s instantaneous
              magnetic trip is 5 × In = 5 × 32 = <strong>160 A</strong>. 371 A is well clear of 160
              A — the MCB will trip instantaneously on a line-to-earth fault. Result:{' '}
              <strong>pass</strong>.
            </>
          }
          whyItMatters={
            <>
              Every BS 7671 disconnection-time check is Ohm’s law in disguise. Zs is just the R; the
              supply voltage is the V; the prospective fault current is the I. Get comfortable
              rearranging V = I × R and the certificate stops being maths and starts being a
              checklist.
            </>
          }
        />
