...
const checks = [
  ...
  },
  {
    ...
    options: [
      'Nothing — light bulbs draw thousands of amps',
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1840 Ω', '28.75 Ω', '0.035 Ω', '238 Ω'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['0.2 Ω', '5 Ω', '200 Ω', '5000 Ω'],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ['1.2 A = 120 mA', '4.7 kΩ = 470 Ω', '3.3 kΩ = 3300 Ω', '250 mA = 2.5 A'],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ['12 Ω', '4.8 Ω', '120 Ω', '240 Ω'],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      ...
      'Because volts and amps cancel out',
      'Because UK supplies use AC',
    ],
    correctAnswer: 1,
    explanation:
