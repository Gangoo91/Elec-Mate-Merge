        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              parallel reduction maths in this Sub is exactly what cable design software is doing
        ...
        >
          <ul className="space-y-2.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              Same KCL you’ll meet in <strong>Sub4.6</strong> at the consumer-unit scale.
            </li>
            <li>
              <strong>Zs as a series sum (Ze + R1 + R2).</strong> The earth fault loop impedance
              from <strong>Sub4.6</strong> is just resistors in series — the external loop (Ze) plus
              the line conductor’s R1 plus the CPC’s R2. Zs = Ze + R1 + R2, exactly the “series
              resistances add” rule from this Sub. That sum decides whether the MCB trips fast
