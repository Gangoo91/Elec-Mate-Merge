...
const checks = [
  {
    ...
    options: ['Henry (H)', 'Ohm (Ω)', 'Volt (V)', 'Farad (F)'],
    correctIndex: 3,
    explanation:
  ...
  {
    id: 'time-constant',
    question: 'A 100 µF capacitor charges through a 10 kΩ resistor. What is the time constant τ?',
  ...
  },
  {
    id: 'motor-cap-job',
    question:
      'What is a motor-start (or motor-run) capacitor doing on a single-phase induction motor?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 4,
    question:
      'After one time constant τ (= R × C), a charging capacitor reaches roughly what percentage of supply voltage?',
    options: ['63%', '37%', '20%', '100%'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      'After one time constant τ, a discharging capacitor falls to roughly what percentage of starting voltage?',
    options: ['20%', '37%', '100%', '63%'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    id: 7,
    question:
      'You replace a faulty motor-run capacitor on a single-phase compressor. The new cap is the same µF but a lower voltage rating. Is that OK?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'Why does BS 7671 require compensation capacitors over a certain size to be used with discharge resistors?',
    options: [
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 2 · Section 6 · Subsection 3" title="Capacitors" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The other big component you’ll meet on every PCB — and the one apprentices most often
          underestimate. Stores charge. Holds it. Bites if you forget to discharge it.
        </p>
        ...
        >
          <p>
            Before the maths, picture it like a bucket. Imagine the plates as a bucket. Voltage is
            how full the bucket gets. Capacitance is how big the bucket is. Charge is the amount of
            water inside. Push current in and the bucket fills. Tip it up and the water flows out —
            that’s discharge. The bigger the bucket (more capacitance), the more charge it holds for
            the same fill level (voltage).
          </p>
          <p>
          ...
          <p>The defining equation is dead simple — and it’s the bucket analogy in symbols:</p>
          <p className="text-center text-[16px] font-semibold tracking-wide">C = Q / V</p>
          <p>
            Capacitance C in farads (F) equals the charge Q in coulombs (C) stored per unit voltage
            V (volts) across the plates. The farad is a huge unit — 1 F is more charge than most
            circuits will ever see. Real components are usually:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Picofarads (pF)</strong> — 10⁻¹² F. Small ceramic caps in radio circuits.
            </li>
            <li>
              <strong>Nanofarads (nF)</strong> — 10⁻⁹ F. Decoupling on chips, snubbers across
              switches.
            </li>
            <li>
              <strong>Microfarads (µF)</strong> — 10⁻⁶ F. Smoothing supplies, motor caps, PFC.
            </li>
            <li>
              <strong>Millifarads / farads</strong> — bus capacitors in EV inverters, super-caps in
              UPS systems.
            </li>
          </ul>
        ...
        >
          <p>The dielectric material decides the type, and each type has its own job:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              ...
              rated, used on single-phase motors. Run caps are continuous; start caps are short-duty
              and switched out at speed.
            </li>
            <li>
        ...
        >
          <p>
            When you connect a discharged capacitor to a DC supply through a resistor, the voltage
            on the cap rises along an exponential curve. The shape of that curve is set by one
            number: the <strong>time constant τ</strong>:
          </p>
          <p className="text-center text-[16px] font-semibold tracking-wide">τ = R × C</p>
          <p>R in ohms, C in farads, τ in seconds. The behaviour is fixed by physics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              At <strong>1τ</strong>: capacitor voltage = 63% of supply.
            </li>
            <li>
              At <strong>2τ</strong>: 86%.
            </li>
            <li>
              At <strong>3τ</strong>: 95%.
            </li>
            <li>
              At <strong>5τ</strong>: 99%+ — for all practical purposes, fully charged.
            </li>
          </ul>
          <p>
        ...
        >
          <p>
            Discharging is the same shape, just falling instead of rising. After 1τ the voltage has
            dropped to 37% of where it started; after 5τ it’s near zero.
          </p>
          <p>
            That’s why bleed resistors exist on big DC bus capacitors — the manufacturer chooses R
            so the cap discharges to a safe level (typically below 50 V) within a known time after
            the supply is removed. No bleed resistor (or a failed one) means the cap can hold full
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Anything more than ~0.5 µF can hold enough charge to give you a serious belt minutes
              after the supply’s been removed. Power factor correction banks specifically must
              include discharge resistors so the cap drains to a safe voltage in a known time.
              Capacitors built into appliances (motor-run caps, smoothing caps inside drives) are
              exempt from this specific reg, but the manufacturer still specifies a discharge time
              you must respect.
            </>
          }
        ...
        >
          <p>
            ...
            switch-mode primary) → bridge rectifier → big electrolytic capacitor → DC output. The
            cap is doing all the smoothing. Bigger cap = less ripple voltage between pulses =
            cleaner DC. Modern switch-mode supplies use much smaller caps because they switch at
            high frequency (tens of kHz), but the principle is the same.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            roughly 90 electrical degrees. The result is an artificial rotating field that gets the
            rotor moving in a definite direction.
          </p>
          <p>Two flavours:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Capacitor-start motors</strong> — large electrolytic cap (typical 100–400 µF)
              on the start winding only, switched out by a centrifugal switch once the motor reaches
              running speed. High starting torque.
            </li>
            <li>
              <strong>Capacitor-start, capacitor-run (PSC) motors</strong> — both a start cap and a
              smaller (5–60 µF) oil-filled run cap that stays in circuit. Smoother running and
              better efficiency.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            network has to deliver more apparent power (kVA) than the actual real power (kW) being
            used — and the supplier charges for that. Banks of capacitors fitted at the main intake
            panel inject leading current that cancels out the lag, dragging the power factor close
            to 1.
          </p>
          <p>
            You’ll see PFC banks as switchgear-style cabinets with rows of capacitor cans inside,
            switched in and out by contactors as the load changes. Modern installations use static
            (no moving parts) PFC, but the core component is still the capacitor.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              terminals. There’s a flash, you drop the screwdriver, and the customer is wondering
              what just happened.
            </>
          }
          doInstead={
            <>
              ...
              discharge time (often 1–5 minutes), then prove the cap with your meter. For larger kit
              (drives, PFC, EV chargers) use a discharge resistor with insulated leads or a
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              reach in to disconnect it from the windings — and get a sharp jolt across the wrist.
              You let go, swearing. The unit was off. The cap was not.
            </>
          }
          whatToDo={
            <>
              Stop. Step back. The cap was holding around 400 V from the last starting cycle —
              isolation removed the supply but didn’t bleed the cap. Discharge it properly: clip an
              insulated discharge tool (or a 10 kΩ, 5 W resistor with insulated leads and a series
              resistor, never a bare screwdriver) across the cap terminals. Wait a few seconds.
              Re-prove with your meter on DC volts — should read close to zero. THEN you can
              disconnect. Lesson burnt in: caps don’t lose charge when you flip the switch — they
              hold what they had.
            </>
          }
          whyItMatters={
            <>
              ...
              heart muscle. BS 7671 Reg 559 demands discharge resistors on compensation capacitors
              over 0.5 µF for exactly this reason — but built-in motor caps aren’t covered by that
              reg, so the manufacturer’s discharge time is the only thing between you and a serious
              shock. Treat every isolated cap as live until your meter says otherwise.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re replacing a smart light switch the customer fitted themselves. They tell you
              the light won’t turn fully off — it glows faintly even when they hit the off button on
              the app. Inside the wall plate you find a tiny module: a small bridge rectifier, a 470
              nF cap, and a relay.
            </>
          }
          whatToDo={
            <>
              The cap is the explanation. To power its electronics, the smart switch needs to pull a
              tiny current through the lamp circuit even when the relay is open — it charges the cap
              from that trickle. Modern LEDs need so little current that the trickle is enough to
              glow. Either fit a smart switch designed for LED loads (with a separate neutral), or
              fit a bypass capacitor across the lamp to absorb the trickle. Same physics, different
              wiring.
            </>
          }
          whyItMatters={
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Capacitors are key to making electronic kit EMC-compliant — they’re the decoupling
              components that stop chips spitting noise back into the supply, and they’re the X- and
              Y-class safety caps fitted across mains conductors in every switch-mode supply. Cheap
              unbranded kit often fails EMC because the manufacturer left out (or undersized) the
              very capacitors that quiet it down.
            </>
          }
