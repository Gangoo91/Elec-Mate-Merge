...
const checks = [
  {
    ...
    options: [
      'They’re the same — different brand names.',
      ...
      'Relays use AC, contactors use DC.',
      'Contactors don’t need a coil.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'It detects heat from the fault.',
      'It senses earth resistance directly.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Keeps the supply voltage at 230 V indefinitely.',
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Because contactors don’t need coils.',
      ...
      'It is wrong — coils must always match the load voltage.',
      'Because the coil produces its own voltage.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Chapter 41', 'Section 443 (with installation rules in 534)', 'Chapter 71', 'Chapter 12'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'To save copper.',
      'BS 7671 doesn’t actually say that.',
    ],
    correctAnswer: 1,
    explanation:
