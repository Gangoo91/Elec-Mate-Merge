...
const checks = [
  ...
  },
  {
    ...
    options: ['1 kΩ ± 5%', '100 Ω ± 5%', '10 Ω ± 5%', '10 kΩ ± 10%'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['47 kΩ ± 5%', '4.7 kΩ ± 5%', '470 kΩ ± 5%', '4.7 MΩ ± 5%'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['220 Ω', '650 Ω', '100 Ω', '550 Ω'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    id: 8,
    question:
      'On a smart RCBO PCB, you see a resistor with a burnt mark. What’s the right next step?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'What’s the difference between a fixed resistor and a variable resistor (potentiometer)?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Every modern board, every AFDD, every smart switch has electronics inside. You don’t need
          to design them — you need to recognise the parts and know what each one does. Start with
          the resistor.
        </p>
        ...
        >
          <p>
            ...
            — coils, contacts, springs, levers. You could open a contactor and see exactly what was
            switching what. From around BS 7671 Amendment 3 onwards (and especially since AFDDs,
            smart RCBOs and EV chargers became mainstream), nearly every protective device has a
            small PCB inside making decisions about when to open the contacts.
          </p>
          <p>
            You won’t design any of this kit, and you won’t repair the boards. But when a customer’s
            AFDD keeps tripping, when a smart switch refuses to pair, when an EV charger throws an
            obscure fault code — the engineer who can talk about resistors, capacitors, diodes and
            relays in plain English is the one who fixes the job. The one who can’t calls the
            manufacturer and waits.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            Electronic engineering uses tiny currents (often microamps) and tiny voltages (often 3.3
            V or 5 V on a chip) to sense things, decide things and switch larger circuits on and
            off. The two live side by side inside almost every modern device. A smart RCBO has the
            electronic side watching the leakage current and the electrical side breaking a 230 V
            circuit when it tells it to.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            the bigger the resistance, the smaller the current. Same Ohm’s law you saw in Section 4:
          </p>
          ...
          <p>
            ...
            delicate component doesn’t cook), <strong>drop voltage</strong> in a controlled way (so
            a 5 V chip can read a 12 V signal safely), <strong>divide voltage</strong> (two
        ...
        >
          <p>
            Old-school resistors carry coloured bands instead of printed numbers. To read the value
            you have to remember which colour means which digit. The trick is a daft phrase the
            whole trade has used for decades:
          </p>
          <p className="text-center text-[16px] font-semibold tracking-wide">
            BB ROY of Great Britain Very Good Wife
          </p>
          <p>Each letter is a colour, and each colour is a digit:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>B</strong> — Black — 0
            </li>
            <li>
              <strong>B</strong> — Brown — 1
            </li>
            <li>
              <strong>R</strong> — Red — 2
            </li>
            <li>
              <strong>O</strong> — Orange — 3
            </li>
            <li>
              <strong>Y</strong> — Yellow — 4
            </li>
            <li>
              <strong>G</strong> — Green — 5
            </li>
            <li>
              <strong>B</strong> — Blue — 6
            </li>
            <li>
              <strong>V</strong> — Violet — 7
            </li>
            <li>
              <strong>G</strong> — Grey — 8
            </li>
            <li>
              <strong>W</strong> — White — 9
            </li>
          </ul>
          <p>
            Worked example with a real four-band part — <em>brown, black, red, gold</em>. Run it
            through the mnemonic: brown = 1, black = 0, red = ×100, gold = ±5%. So the value is 10 ×
            100 = 1,000 Ω = <strong>1 kΩ ±5%</strong>. The actual resistance will measure somewhere
            between 950 Ω and 1,050 Ω on a meter.
          </p>
          <p>
        ...
        >
          ...
          <p>
            Worked example: <em>red, red, brown, gold</em> = 2, 2, ×10, ±5% = 220 Ω ±5%. The actual
            value sits somewhere between 209 Ω and 231 Ω.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              transistors) has to be EMC compliant — meaning it doesn’t spit electromagnetic noise
              into the supply or the air. The CE/UKCA mark on the kit is the manufacturer saying it
              meets the BS EN 61000 series. If you fit unmarked or grey-import kit and it interferes
              with the customer’s smart meter or radio, that’s on you.
            </>
          }
        ...
        >
          ...
          <p>
            Resistors in <strong>parallel</strong> always give a total smaller than the smallest one
            in the bunch. For two:
          </p>
          <p className="text-center text-[16px] font-semibold tracking-wide">
            R total = (R₁ × R₂) / (R₁ + R₂)
          </p>
          <p>
            For more than two, use the reciprocal form: 1/R = 1/R₁ + 1/R₂ + 1/R₃ … then flip the
            answer. Two equal resistors in parallel always halve. Three equal ones third. Quick
            mental check before you reach for the calculator.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>LED drivers</strong> — current-limiting resistor in series with the LED string
              keeps the current at the rated value.
            </li>
            <li>
            ...
            <li>
              ...
              meter is built from precision resistors. That’s why dropping a meter often kills its
              calibration.
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer’s LED downlight driver dies. You open it, see a black resistor, source a
              replacement, solder it in, plug it back in. Three days later it’s dead again. Now the
              customer thinks you’ve botched it.
            </>
          }
          doInstead={
            <>
              A charred resistor on a safety-critical or factory-built PCB is almost always
              downstream of the actual failure. Replace the whole sealed unit (driver, RCBO, smart
              switch — whatever it is) and recycle the dead one. We don’t repair manufacturer-sealed
              boards on site, and we don’t replace component-level parts on a protective device.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              “proper” dimmer they bought online. They flicker. They claim “the lights are broken”
              and want them swapped.
            </>
          }
          whatToDo={
            <>
              Explain it in component terms. The dimmer relies on the load looking like a resistive
              heater. LEDs aren’t resistive — there’s a small driver inside each fitting full of
              resistors and capacitors that confuses the dimmer’s timing circuit. Fit a proper
              trailing-edge LED dimmer rated for the actual load. Lights aren’t broken; the dimmer
              was the wrong tool.
            </>
          }
          whyItMatters={
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Even at apprentice level, the rule is: don’t component-repair safety devices. Reg
              134.11 ties you to the manufacturer’s instructions for every piece of kit you fit —
              and no manufacturer of an RCBO, AFDD or smart switch publishes "instructions" for
              desoldering a resistor on the PCB. Pull a component off and resolder a new one and
              you’ve gone outside the manufacturer’s assembly — the device’s third-party
              certification (BS EN 61009, BS EN 62606) no longer applies.
            </>
          }
        ...
        >
          <p>
            ...
            together in Subsection 6.6, where you’ll see resistors inside the smart RCBO, AFDD and
            SPD circuits on a real consumer unit. Same colour code, same series/parallel maths, same
            power rating logic — applied to the actual kit you’ll be opening on the tools.
          </p>
        </ConceptBlock>
        ...
        <Quiz
          title="Resistors and on-site electronics — knowledge check"
