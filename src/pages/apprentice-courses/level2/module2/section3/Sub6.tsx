    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <p className="text-[13.5px] text-white/85 leading-relaxed border-l-2 border-emerald-400/40 pl-4 italic">
          ...
          <strong>Sub3.1</strong> said electrons in motion is what current IS. This Sub shows what
          happens when those electrons start swapping ions in solutions, gases or solids — the
          chemistry of charge transfer. Same particles, different behaviour: Sub3.1 was the physics
          of free electrons drifting through a metal, Sub3.6 is the chemistry of electrons being
          handed off at an electrode. The two halves of one story.
        </p>
        ...
        >
          ...
          <p>
            ...
            to solve them by hand for Level 2, but recognise that electroplating is just controlled
