...
const TITLE = 'Conductors and insulators | Level 2 Module 2.3.2 (AC 4.2) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: ['Steel', 'Aluminium', 'Copper', 'Carbon'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['300 mm²', '25 mm²', '50 mm²', '95 mm²'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['XLPE', 'Rubber', 'PVC', 'Cotton'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Part 5', 'Part 4', 'Part 1', 'Part 2'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Why we wrap a metal core in plastic and call it a cable. The material choices behind every
          install — conductor, insulator, and what to pick for which environment.
        </p>
        ...
        >
          <p>In BS 7671 land, you'll see two conductor materials again and again:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              copper but needs roughly 1.6× the CSA for the same current. Used for the supply tails
              on some installs, big sub-mains, overhead lines and bus-bars. Needs the right
              termination kit (bimetallic lugs, jointing paste) because it oxidises and creeps under
              pressure.
            </li>
          </ul>
          <p>
            You'll occasionally hear about silver as the best conductor on Earth. It is — but the
            price ruins it for installation work. Steel turns up where mechanical strength matters
            more than conductivity (SWA armour, structural earthing of pylons), but it's never the
        ...
        >
          <p>
            ...
            effectively no current flows through it. Copper has a resistivity around 1.7 × 10⁻⁸ Ω·m.
            PVC sits around 1 × 10¹⁵ Ω·m — twenty-three orders of magnitude bigger. The electrons in
            a PVC molecule are locked into bonds with their atoms and won't shift under 230 V.
          </p>
          <p>
            The insulator's job inside a cable is two things: stop the current leaking from one core
            to another, and stop it leaking from a core to anything outside the cable (including
            you). Insulation is the difference between a useful cable and a fault.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PVC (polyvinyl chloride)</strong> — 70°C continuous. The default insulator on
              domestic T&E sheaths and cores. Cheap, easy to work, good for normal indoor
              environments. Releases halogen gas when it burns, which is the reason it's not used in
              life-safety areas.
            </li>
            <li>
              <strong>XLPE (cross-linked polyethylene)</strong> — 90°C continuous. Standard
              insulation on SWA cable cores and larger feeder cables. The higher temperature rating
              means the cable can carry more current without the insulation breaking down.
            </li>
            <li>
            ...
            <li>
              ...
              fire. Required in stairwells, hospitals, schools, public buildings — anywhere people
              need to escape through the smoke a cable fire would produce.
            </li>
            <li>
              <strong>Mineral insulation (MICC, "Pyro")</strong> — magnesium oxide powder between
              the conductor and a copper sheath. Not flammable. Survives fire long enough for sirens
              and emergency lighting to keep working. You'll see it on fire-alarm and
        ...
        <RegsCallout
          ...
          meaning={
            <>
              You can't just stick PVC anywhere. The ambient temperature plus the temperature rise
              from current flow has to keep the insulation under its rated limit (70°C for PVC, 90°C
              for XLPE). Loft spaces, near boilers, inside thermal insulation — all need correction
              factors from Appendix 4.
            </>
          }
        ...
        >
          <p>Every cable choice is a balance of:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Mechanical protection</strong> — SWA for buried or exposed runs; conduit for
              plant rooms; T&E behind plasterboard with a 50 mm safe zone.
            </li>
            <li>
            ...
            <li>
              <strong>Cost and availability</strong> — the perfect cable nobody stocks isn't much
              use. Pick something the wholesalers can deliver tomorrow.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The conductor inside any cable is either:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Solid</strong> — one thick wire. Cheap, easy to terminate in screw and cage
              clamps, mechanically stiff. Standard on fixed wiring up to 4 mm² T&E. Fine for runs
              that won't move.
            </li>
            <li>
              <strong>Stranded</strong> — multiple thinner wires twisted together. More flexible,
              much better for cables that bend or move. Required for flex (appliance cords, pendant
              drops, equipment tails) and standard for fixed cores 6 mm² and above (where solid
              would be unworkably stiff).
            </li>
            <li>
              <strong>Fine-stranded / "Class 5" or "Class 6"</strong> — extra-fine strands for very
              flexible flex (welder leads, drum-reel cable). Needs the right ferrule terminal —
              squashing fine-stranded direct under a screw frays the strands and strands escape the
              terminal, eventually shorting.
            </li>
          </ul>
          <p>
            Get the conductor class wrong at the terminal and the joint either won't grip (loose
            strands), or work-hardens and snaps (solid in something that flexes). Either way it ends
            up in §526.1's territory — a connection that fails to give "durable electrical
            continuity".
          </p>
        </ConceptBlock>
        ...
        >
          <p>The outer sheath has three jobs that the core insulation can't do alone:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Mechanical protection</strong> — abrasion resistance during installation and
              over the cable's life. PVC sheaths take a knock and survive; bare core insulation
              would chafe through against masonry, joists or metal trunking edges.
            </li>
            <li>
            ...
            <li>
              <strong>Fire performance</strong> — LSF/LSZH sheaths cut smoke and acid-gas output
              during a fire, which is why they're mandatory in stairwells, hospitals, schools and
              other escape-route environments. Mineral-insulated cable goes further again — survives
              the fire and keeps fire-alarm circuits running.
            </li>
          </ul>
          <p>
            The sheath isn't structural insulation under BS 7671 — the core insulation is. But
            damage to the sheath that exposes the core insulation to UV, moisture or mechanical
            abuse will eventually take the core insulation down with it. Treat sheath damage
            seriously, even when the cores still test clean today.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Most materials fall cleanly into "conductor" (low resistivity) or "insulator" (very high
            resistivity). A handful sit in between, with conductivity that depends on temperature,
            light, voltage or impurities. The big one for electricians is <strong>silicon</strong>:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pure silicon</strong> at room temperature has very few free electrons — it
              behaves nearly as an insulator.
            </li>
            <li>
              Add a tiny amount of phosphorus or boron (parts per million) and the conductivity
              changes by orders of magnitude. The doped material becomes a controlled semiconductor
              — used to build diodes, transistors, MOSFETs, SCRs, the silicon inside every modern
              protective relay, inverter and LED driver.
            </li>
            <li>
              Photoconductors (like the cadmium sulphide in an LDR) work the same way — resistance
              drops sharply when light energy frees electrons. That's how a dusk-till-dawn sensor
              works.
            </li>
          </ul>
          <p>
            You don't need the device-physics for Level 2 — but recognise that BS 7671's "conductor"
            / "insulator" framework is a useful simplification for cables and fittings. Inside the
            components themselves, the boundary is blurrier and more controllable. Sub6.1 onwards
            picks this up.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice spots a nick in the sheath of a kitchen ring during the periodic. Slap a
              couple of turns of self-amalgamating tape on it. Pen the EICR as 'C3 — improvement
          ...
          doInstead={
            <>
              ...
              dangerous). Tape is not a repair. Either replace the section properly with a joint
              kit, or replace the whole cable. If you can't fix it on the visit, write it up clearly
              and recommend immediate remedial action.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Customer wants a single double-socket on the back of the shed, 30 m from the consumer
              unit. You've got SWA in the van and T&E in the loft. Which one?
            </>
          }
          whatToDo={
            <>
              SWA. The cable's going outdoors and possibly buried — T&E sheath isn't rated for UV or
              mechanical knocks, and it has no armour. Use 2.5 mm² SWA with the armour as the CPC,
              glanded properly at both ends, RCD protected at 30 mA per Section 411. Run it in a
              deep enough trench with marker tape above.
            </>
          }
          whyItMatters={
            <>
              The conductor is doing the same job in either cable. The difference is the insulator
              and the sheath system — SWA's XLPE cores plus armour plus outer PVC are rated for the
              abuse a buried cable takes. T&E in the same place fails inspection, fails BS 7671
              §522, and eventually fails in service.
            </>
          }
        />
        ...
        >
          <p>
            ...
            <strong>1 MΩ</strong> for low-voltage circuits (Table 64). Anything below that and the
            install fails — you've got moisture ingress, damaged sheathing, a swarf-bridged
            terminal, or worse.
          </p>
          <p>
            You'll come back to insulation resistance properly in I&T (LO5 territory and the EICR
            work in Module 5). For now: insulation isn't just a passive layer — it's something you
            actively test, every initial verification and every periodic.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              If a final circuit measures less than 1 MΩ, the install fails and you don't energise
              it. Common causes: moisture, swarf in a back-box, a crushed cable behind a screw, a
              faulty appliance left plugged in. Investigate before you certify.
            </>
          }
