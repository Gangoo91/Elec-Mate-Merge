...
const TITLE = 'Resistance and resistivity (R = ρL/A) | Level 2 Module 2.3.3 (AC 4.3) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: ['σ (sigma)', 'Ω (omega)', 'ρ (rho)', 'α (alpha)'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Stays the same', 'Halves', 'Quadruples', 'Doubles'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Halves', 'Quadruples', 'Doubles', 'Stays the same'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['172 nΩ·m', '1.72 nΩ·m', '1.72 mΩ·m', '17.2 nΩ·m'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['0.21 Ω', '0.021 Ω', '2.1 Ω', '21 Ω'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['R_T = R_20 × [1 + α(T − 20)]', 'R = ρL/A', 'V = I × R', 'P = I² × R'],
    correctAnswer: 0,
    explanation:
  ...
  {
    id: 7,
    question: 'A loose terminal in a junction box — what changes about the local resistance?',
    options: [
  ...
  },
  {
    ...
    options: ['Appendix 4', 'Appendix 7', 'Appendix 1', 'Appendix 3'],
    correctAnswer: 0,
    explanation:
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 3 · Subsection 3"
        title="Resistance and resistivity"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          What decides how much a conductor resists current — material, length, cross-sectional area
          and temperature. The formula R = ρL/A and how to actually use it on site.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              property of the material itself. Copper ≈ 17.2 nΩ·m at 20°C; aluminium ≈ 28.2 nΩ·m.
              Tiny numbers — that's the scale of how easily metals conduct.
            </li>
            <li>
              <strong>L</strong> — length of the conductor in <strong>metres</strong>. For voltage
              drop you use the loop length (out and back). For raw resistance, just the length of
              the conductor itself.
            </li>
            <li>
              <strong>A</strong> — cross-sectional area in <strong>square metres (m²)</strong> in
              the formal SI version. On site you'll see it in <strong>mm²</strong> — that's what the
              cable's marked with (1.5, 2.5, 4.0, etc.). Convert: 2.5 mm² = 2.5 × 10⁻⁶ m².
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              and the operating temperature. <strong>You don't need to use ρ directly</strong> in
              everyday design — but knowing R = ρL/A is what tells you why the table values change
              the way they do.
            </>
          }
        ...
        >
          <p>
            ...
            maths is linear: R goes up in lockstep with L. A 60 m run of 2.5 mm² copper has exactly
            twice the resistance of a 30 m run of the same cable.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            through. Same number of electrons, twice the room — half the resistance. Going up one
            CSA step (1.5 to 2.5, or 2.5 to 4.0) drops the resistance noticeably; going up two steps
            drops it more.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Material (ρ) — fixed once you've picked the metal">
          <p>
            ...
            fixed (at any given temperature). Aluminium's resistivity is about 1.6× copper's, so the
            same job in aluminium needs about 1.6× the CSA.
          </p>
        </ConceptBlock>
        ...
        >
          <p>For metals, R rises with temperature. The formula:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            That's why BS 7671 Appendix 4 quotes mV/A/m at the operating temperature of the cable's
            insulation system — 70°C for PVC, 90°C for XLPE — not at 20°C. Designing with cold-cable
            numbers undersizes the conductor.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Question: a single radial spur, 30 m of 2.5 mm² copper at 20°C. What's the resistance of
            one core?
          </p>
          ...
          <p>
            Now warm the cable up to its 70°C operating temperature: R_70 ≈ 0.206 × [1 + 0.004 × 50]
            = 0.206 × 1.20 = <strong>0.247 Ω</strong>. About 20% more — exactly what Appendix 4
            builds in.
          </p>
          <p>
            And remember: for voltage drop you'd use the <strong>loop length</strong> (out and back)
            — so you'd double the L for that calculation. We'll do that properly in 3.4.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A consumer-unit busbar terminal is hand-tight. Looks fine. But the contact resistance
              is, say, 0.05 Ω instead of effectively zero. With a 32 A load, the power dissipated at
              that one screw = I²R = 32² × 0.05 = <strong>51 W</strong> — half a kettle element, in
              a screw the size of a fingernail. Insulation cooks, terminal browns, eventually arcs.
            </>
          }
          doInstead={
            <>
              Torque every terminal to the manufacturer's spec. Use the right driver and the torque
              setting on the back of the consumer-unit door. Re-check at first periodic. A
              high-resistance joint isn't just a bit of voltage drop — it's a fire risk.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              T&E, clipped direct. The voltage drop on Appendix 4 figures is 9.0% at full load. The
              5% limit for sockets is blown.
            </>
          }
          whatToDo={
            <>
              Look at R = ρL/A. You can't change ρ (still copper). The route's already as short as
              it can be (L is fixed). The load current isn't optional. The only knob left is{' '}
          ...
          whyItMatters={
            <>
              Every voltage drop fix on site comes down to R = ρL/A. Knowing the formula tells you
              which lever is available before you start guessing.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              install. A loose terminal that develops contact resistance breaches 526.1. That's why
              every screwed terminal gets a torque setting — and why crimps, push-fits and Wago
              connectors all have manufacturers' instructions you have to follow.
            </>
          }
