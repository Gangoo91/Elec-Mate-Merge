...
const TITLE = 'Voltage drop — Method A and Method B | Level 2 Module 2.3.4 (AC 4.7) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  {
    id: 'vd-limit-check',
    question: 'BS 7671 Appendix 4 gives recommended voltage drop limits of:',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['8.6 V', '4.3 V', '17.3 V', '0.86 V'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['CSA increases', 'Length increases', 'Cable is shortened', 'Voltage increases'],
    correctAnswer: 1,
    explanation:
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 2 · Section 3 · Subsection 4" title="Voltage drop" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Why some of your 230 V never reaches the load. The two methods of calculating it, the BS
          7671 limits, and how to fix a circuit that fails.
        </p>
        ...
        >
          ...
          <p>
            Mathematically it's just <strong>Vd = I × R</strong>. The R here is the resistance of
            the whole loop the current flows through — out along the line conductor, back along the
            neutral. The bigger the current and the bigger the cable's resistance, the more volts go
            missing.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The reg itself is short. The deemed-compliance numbers (3% lighting, 5% other) live in
              Appendix 4 Section 6.4. The actual reg principle is broader: the voltage at the load's
              terminals must not be so low that the equipment can't work safely or properly. The
              3%/5% limits are the industry's way of meeting that.
            </>
          }
        ...
        <ContentEyebrow>
          Before the methods — why Appendix 4 doesn’t just give you ρL/A
        </ContentEyebrow>
        ...
        >
          <p>
            ...
            <strong> cold conductor at 20°C</strong> with no allowance for what AC actually does in
            real cables. Three things the formula leaves out, that Appendix 4 quietly builds in:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Operating temperature.</strong> A loaded PVC cable runs at{' '}
              <strong>70°C</strong> (XLPE at 90°C), not 20°C. The temperature coefficient from
              Sub3.3 (α ≈ 0.004/°C for copper) means a 70°C conductor has roughly 20% more
              resistance than the same cable cold. Appendix 4 quotes mV/A/m at the cable’s rated
              operating temperature — so the table has the temperature correction already done.
            </li>
            <li>
              ...
              domestic cables, growing noticeably for larger CSAs (16 mm² and up). R = ρL/A ignores
              this entirely. The Appendix 4 column for the relevant CSA bakes in the AC impedance,
              not just the DC resistance.
            </li>
            <li>
              <strong>The standard installation method.</strong> mV/A/m values are tabulated per BS
              7671 reference method (clipped direct, in conduit, buried, etc.). Pick the right
              column and the heat-dissipation conditions of your install are already accounted for.
            </li>
          </ul>
          <p>
            Net effect: <strong>mV/A/m is the “ready to use” form</strong> for real installations.
            You just plug in current and route length. R = ρL/A is the physics behind it; mV/A/m is
            the engineered shortcut. Method A and Method B below show how both are used — but on
            every job you’ll do for the next decade, Method B is the default for exactly the reasons
            above.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Calculate R for one loop: R ≈ 0.0172 × L_loop ÷ A for copper, or read from Appendix 4
              table.
            </li>
          ...
          <p>
            Method A is fine for one-off mental checks. It's also what your brain does when someone
            asks "would 4 mil be enough for that run?" — you're rough-calculating R and I in your
            head.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              installation method. Already includes both loop legs and the operating temperature.
            </li>
            <li>
            ...
            <li>Divide by 1000 because the table gives millivolts and you want volts.</li>
          </ul>
          <p>
            Common mV/A/m values for Twin & Earth (clipped direct, single-phase): 1.0 mm² = 44; 1.5
            mm² = 29; 2.5 mm² = 18; 4.0 mm² = 11; 6.0 mm² = 7.3; 10 mm² = 4.4.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              These are the design percentages everyone quotes. On a 230 V supply:{' '}
              <strong>3% = 6.9 V</strong> max for lighting, <strong>5% = 11.5 V</strong> max for
              sockets and other circuits. The limits apply to the worst-case load condition — full
              design current — not to a casual measurement with light loading.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Limit: lighting circuit, so <strong>3% of 230 V = 6.9 V</strong>.
            </li>
          </ul>
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Divide by 1000 to convert millivolts to volts: 6,090 ÷ 1000 = <strong>6.09 V</strong>.
            </li>
            <li>
              Compare to the limit: 6.09 ÷ 230 = <strong>2.65%</strong> — inside the 3% lighting
              limit. PASS.
            </li>
          </ol>
          <p>
            Same recipe, every cable, every job. The mV/A/m number is the Appendix 4 table already
            doing the R = ρL/A maths for you at the cable’s operating temperature, both loop legs
            included. AM2 papers can ask the calculation either way — Method A as Vd = I × R using
            the raw resistance, or the engineered form above — and both give the same answer when
            you’ve used the right R for the cable’s operating temperature.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Limit: socket circuit, so 5% of 230 V = <strong>11.5 V</strong>.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Vd = (18 × 20 × 35) ÷ 1000 = <strong>12.6 V</strong> = 5.5%. FAIL.
            </li>
          </ul>
          <p>Two options. Either shorten the route, or upsize the cable:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Upsize to 4 mm² T&E (mV/A/m = 11): Vd = (11 × 20 × 35) ÷ 1000 = <strong>7.7 V</strong>{' '}
              = 3.3%. PASS.
            </li>
          </ul>
          <p>
            That's R = ρL/A in action — bigger A drops the resistance, drops the voltage drop. Same
            physics, applied through the Appendix 4 table.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Two consequences when voltage drop is high:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Equipment underperforms.</strong> Resistive heaters give less heat (P = V²/R).
              Filament lamps go yellow. Discharge lamps flicker or fail to strike. Motors draw more
              current to deliver the same torque, which makes the voltage drop worse, which makes
              them draw even more current... thermal runaway.
            </li>
            <li>
              <strong>Energy gets wasted as cable heat.</strong> The volts lost in the cable get
              dissipated as I²R heating along the entire run. Long undersized cables on heavy loads
              get genuinely hot — that's lost money, lost performance, and (if the cable's already
              at its current rating) potentially lost insulation.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice working out Vd from R = ρL/A. Plugs the route length (say 30 m) into the
              formula and gets the answer for one core only. Forgets the current goes out AND back.
              Their Vd is half the real value. Circuit looks fine on paper but fails a Method B
              check or an on-site measurement.
            </>
          }
          doInstead={
            <>
              <strong>Method A:</strong> use the loop length (out and back, so 60 m for a 30 m run).{' '}
              <strong>Method B:</strong> use the route length (the 30 m); the mV/A/m value already
              accounts for both loop legs. Mix the two and you halve or double the answer.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Customer wants a 32 A workshop circuit in a garden outbuilding 40 m from the house.
              Plans a 6 mm² SWA sub-main with a small CU at the workshop end feeding lights and
              sockets.
            </>
          }
          whatToDo={
            <>
              Method B check: 6 mm² SWA at ~7.3 mV/A/m × 32 A × 40 m ÷ 1000 = <strong>9.3 V</strong>{' '}
              = 4.0%. That's just for the sub-main — but the limit applies to the WHOLE path from
              origin to load, so add the workshop final-circuit drop too. If the final lighting
              circuit adds another 1.5%, total = 5.5%, fail for lighting (3%). Either shorten the
              run, upsize to 10 mm² SWA (drops sub-main Vd to 2.4%), or accept the workshop will
              have its own slightly dim lighting.
            </>
          }
          whyItMatters={
            <>
              Voltage drop adds up. A garden outbuilding looks like 'just one circuit' but it's two
              cables in series — sub-main plus final circuit. Both eat into the same 3%/5% budget.
              Always design from the origin, not just from the local CU.
            </>
          }
        />
