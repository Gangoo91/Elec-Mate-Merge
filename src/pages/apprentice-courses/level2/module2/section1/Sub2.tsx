...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Pound', 'Newton', 'Gram', 'Kilogram'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Volts ÷ amperes', 'Just the ampere', 'Watts ÷ volts', 'Coulombs ÷ seconds'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Force', 'Power', 'Charge', 'Energy'],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 6,
    question: 'What unit do UK electricity suppliers use to bill consumers for energy used?',
    options: ['Watts (W)', 'Joules (J)', 'Kilowatt-hours (kWh)', 'Volt-amps (VA)'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 8,
    question: 'Why does it matter that electrical units are SI rather than imperial?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The seven SI base units, the handful of derived units electricians use daily, and why
          getting the case of a single letter wrong can blow your test sheet up by a factor of a
          million.
        </p>
        ...
        >
          <p>
            Before SI, every country and every trade had its own units — pounds-force, horsepower,
            BTUs, fluid ounces, candles, cubits. A motor labelled in horsepower in the US wouldn't
            mean exactly the same as horsepower in the UK because they were defined differently. The
            SI system fixed that by agreeing seven BASE units, with watertight definitions, and
            building every other unit out of those seven.
          </p>
          <p>
            For a Level 2 apprentice, that means three useful things. (1) The numbers on every piece
            of equipment you'll touch in the UK are SI. (2) The formulas in BS 7671 and the OSG
            assume SI. (3) Your test instruments report in SI by default — you don't need to
            convert.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Kilogram (kg)</strong> — mass. The only base unit with a prefix in its name.
            </li>
            <li>
              <strong>Second (s)</strong> — time. Trip times, switching delays, frequencies are all
              built on the second.
            </li>
            <li>
            ...
            <li>
              <strong>Kelvin (K)</strong> — thermodynamic temperature. Cable derating, motor thermal
              limits.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              maintained by the Bureau International des Poids et Mesures (BIPM). UK manufacturers,
              BS 7671 and your test instruments all derive from this single source. If a number on a
              product datasheet has a unit, it's almost certainly SI.
            </>
          }
        ...
        >
          <p>
            Most of the units an electrician touches are DERIVED — combinations of the base seven.
            You don't have to memorise the derivation, but understanding the principle stops the
            units feeling like magic. A few examples:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Newton (N)</strong> — force. 1 N = 1 kg·m/s². Underpins fixings, ladder loads,
              motor torque.
            </li>
            <li>
              <strong>Joule (J)</strong> — energy. 1 J = 1 N·m. The amount of energy needed to push
              1 N through 1 m.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              derived electrical units, all from the ampere base. You'll wire them into Ohm's law in
              Sub1.3 and Sub3.4.
            </li>
            <li>
              <strong>The cable label</strong> — mm² for cross-sectional area (CSA), m for the metre
              length on the drum. Both built on the metre base. CSA drives every cable- sizing calc
              you'll do in Module 4.
            </li>
            <li>
              <strong>The MCB / RCBO rating</strong> — A for the rated trip current, kA for the
              breaking capacity. Same ampere underneath, different prefix. Sizing protective devices
              is the whole of Module 6.
            </li>
            <li>
              <strong>The kWh meter</strong> — kilowatt-hours, the customer's bill unit. Energy
              (joules) at a friendlier scale. You'll work with kWh in Sub4.5 (electrical power) when
              you cost a load.
            </li>
            <li>
              <strong>The motor nameplate</strong> — kW, V, A, Hz, kg all on one plate. Real power,
              voltage, current, frequency, mass — five separate SI quantities you'll act on. The kW
              comes back hard in Sub4.5 power calcs and Sub5.x motor theory.
            </li>
            <li>
              <strong>The torque setting on a CU terminal</strong> — N·m (newton-metres), force ×
              distance from the lever pivot. You'll see this again in Sub2.3 (levers) and on every
              consumer unit you ever wire.
            </li>
          </ul>
          <p>
        ...
        >
          <p>
            The strict SI unit of energy is the joule. But for billing and load calcs, electricians
            (and everyone else) use the kilowatt-hour (kWh) — power in kW × time in hours. They both
            measure energy; kWh is just a friendlier scale for the kind of numbers a home or shop
            actually uses.
          </p>
          <p>
            Quick example. A 2 kW heater on for 3 hours uses 2 × 3 = 6 kWh. At roughly 28p per kWh,
            that's £1.68 of leccy. Customer wants the heater off the ring final because it's
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              1 newton = 1 kg × 1 m/s² (no fudge factor — just the base units multiplied together).
            </li>
          ...
          <p>
            ...
            you start, the answer comes out in the right derived unit at the end. Plug 230 V × 13 A
            into P = V × I and you get 2,990 W — straight out, no conversion. Plug 230 V × 13,000 mA
            in and you get 2,990,000 mVA, which is the same number expressed in a unit you never
            wanted. Convert before, not after.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Every SI calculation can be unit-checked. The trick is to write the units alongside the
            numbers and treat them like algebra. Cancel matching units top and bottom; the remainder
            is the unit your answer is in. If that doesn't match the unit you expected, your formula
            is wrong.
          </p>
          <p>
            Example. Cable resistance heating: P = I² × R. Plug in I in amps and R in ohms. The
            units: A² × Ω = A² × (V/A) = A × V = W. Comes out in watts — exactly what you'd want for
            a power. Now imagine you'd remembered the formula as P = I × R by mistake: A × Ω = A ×
            V/A = V. Comes out in volts — that's voltage drop, not power. The unit check tells you
            instantly that you've used the wrong formula.
          </p>
          <p>
            Make this a habit on every calc. It costs five seconds and catches the kind of slip that
            fails a calc paper, mis-sizes a cable, or worse.
          </p>
        </ConceptBlock>
        ...
        >
          <p>SI symbols are case-sensitive. Some examples that catch apprentices out:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>n (lower)</strong> = nano (÷ 1,000,000,000). <strong>N (upper)</strong> =
              newton (force).
            </li>
          </ul>
          <p>
            Two more rules: unit symbols don't take a plural "s" (5 kg, not 5 kgs), and they don't
            take a full stop unless they're at the end of a sentence (5 A, not 5 A.). Look fussy but
            they're conventions BS 7671 and the manufacturer datasheets stick to.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              drop-down menus enforce the correct case — use them rather than free-typing the unit.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You're commissioning a three-phase motor. The nameplate shows: 7.5 kW, 400 V, 14.5 A,
              50 Hz, cos φ = 0.85, IP55, weight 65 kg. Six different SI units in three lines.
            </>
          }
          whatToDo={
            <>
              ...
              cables and overload for. 50 Hz is the supply frequency. cos φ = 0.85 is the power
              factor (no unit — just a ratio). IP55 is the ingress rating (also no unit — a code).
              65 kg is what you'll be lifting onto the bracket.
            </>
          }
          whyItMatters={
            <>
