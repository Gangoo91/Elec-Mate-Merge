...
const checks = [
  {
    ...
    options: ['I = V ÷ P', 'I = P ÷ V', 'I = V × P', 'I = P × V'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['220 V', '207 V', '216 V', '200 V'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['250,000,000 Ω', '2,500,000 Ω', '0.25 Ω', '250,000 Ω'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['1/2 = 50 m', '1/4 = 25 m', '1/3 ≈ 33 m', '1/5 = 20 m'],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 3,
    question: 'Transpose V = I × R to make R the subject.',
    options: ['R = I ÷ V', 'R = V × I', 'R = I × V', 'R = V ÷ I'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['0.35 mA', '35 mA', '3.5 mA', '350 mA'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Fractions, percentages, ratios, transposition, indices and scientific notation — the maths
          you actually use on site, not GCSE algebra for its own sake.
        </p>
        ...
        >
          ...
          <p>
            The trap isn't the maths itself — it's getting careless with decimal places or units. A
            30 mA RCD that gets recorded as 30 A on a test sheet is the kind of typo that fails an
            EICR. So is a 2.5 mm² cable mis-spec'd as 25 mm². Slow down for the units.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            On site you'll see all three forms. Decimals on instrument readouts (0.05 Ω continuity,
            1.27 Ω earth loop). Fractions when something is split (a two-way switch splitting a
            circuit, a cable run halved between two boxes). Percentages on tolerances (±10% on 230
            V) and on diversity factors when you size a board.
          </p>
          <p>
        ...
        >
          <p>Percentages turn up in three big places at Level 2:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply tolerance:</strong> ESQCR sets the supply at 230 V with an asymmetric
              tolerance of −6% / +10%. That means anywhere from roughly 216 V to 253 V is still
              compliant at the cut-out.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              drop allowed for lighting; 5% = 11.5 V for everything else. Exceed it, your cable size
              is wrong and your installation fails the design check.
            </>
          }
        ...
        >
          <p>
            You'll meet ratios most often in transformer turns ratios (a 230:12 V transformer steps
            voltage down by about 19:1, since 230 ÷ 12 ≈ 19.2) and in current splits across parallel
            circuits. Two identical lamps wired in parallel split the current 1:1. Three resistors
            in parallel where one is half the resistance of the other two carry current in a 2:1:1
            split.
          </p>
          <p>
            Quick check: if a 240 V primary winding has 1000 turns and a secondary has 50 turns, the
            ratio is 1000:50, which simplifies to 20:1. Secondary voltage = 240 ÷ 20 = 12 V. You
            don't need the formula — just understand the proportional drop.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The two formulas that come up constantly at Level 2:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <OhmsLawTriangle variant="V" caption="V = I × R · cover V to see why." />
          <PowerTriangle
            variant="dc"
        ...
        <ConceptBlock title="Worked example — transposing for current">
          <p>A 9 kW shower runs from a 230 V supply. What current does it pull?</p>
          <p>
            Start with P = V × I. Transpose for I: <strong>I = P ÷ V</strong>. Convert kW to W first
            (9 kW = 9000 W). Then 9000 ÷ 230 = 39.1 A. So the shower needs at least a 40 A MCB and a
            cable rated for 40 A in its install method — typically 10 mm² T&E.
          </p>
          <p>
            Notice three things you did automatically: transposed the formula, converted units (kW →
            W), and sanity-checked the answer (a 9 kW shower wanting roughly 40 A is in the right
            ballpark — domestic showers are notorious current pigs).
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Indices are shorthand for repeated multiplication. 4² = 4 × 4 = 16. 4³ = 4 × 4 × 4 = 64.
            They're not optional decoration on Level 2 — they sit inside two formulas you'll use
            weekly:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>P = I² × R</strong> — power dissipated in a resistor (e.g. heat in a
              conductor). Double the current and you quadruple the heat. Why undersized cables cook
              so quickly.
            </li>
            <li>
        ...
        >
          <p>
            ...
            milliamps (mA — thousandths of an amp). Capacitance is in microfarads (μF — millionths
            of a farad). Writing those out as "0.00003 A" is asking for a typo. Writing them as 30
            mA, or 3 × 10⁻⁵ A in scientific notation, is cleaner and harder to misread.
          </p>
          <p>The prefix table you actually need:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>M (mega)</strong> = × 1,000,000 — insulation resistance, supply impedances.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              and you'd write up a dangerous installation as compliant. Get the prefix right before
              you sign anything.
            </>
          }
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Do a mental sanity check before trusting the screen. A 9 kW shower at 230 V should be
              in the tens of amps — not three or four hundred, not less than ten. Build the habit of
              asking "does this look about right?" before you write anything down.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You're shadowing on an EICR. The previous electrician filled out the test sheet by
              hand — under the RCD section, where the trip current should be 30 mA, he's written "30
              A". Just an A instead of mA. The certificate has been issued and is sitting on the
              customer's records.
            </>
          }
          whatToDo={
