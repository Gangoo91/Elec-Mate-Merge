...
const quizQuestions = [
  {
    id: 1,
    question:
      'A multimeter switched to AC volts (V~) and connected across L and N at a UK socket should read approximately:',
    options: ['12 V', '230 V', '110 V', '400 V'],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 2,
    question: "What does 'CAT III' on a multimeter or its leads mean?",
    options: [
  ...
  {
    id: 7,
    question: 'Insulation resistance must NOT be measured on a live circuit because:',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Multimeter, clamp meter, insulation tester, multifunction tester, voltage indicator — what
          each one measures, when to pick which, and the HSE GS38 rules that keep them (and you)
          safe.
        </p>
        ...
        >
          <p>The five instruments you'll meet in your first two years and what each is FOR:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Clamp meter</strong> — measures current without breaking the circuit.
              Essential for load surveys, motor running currents, balancing three-phase
              distribution.
            </li>
            <li>
              <strong>Insulation resistance tester</strong> — applies 250/500/1000 V DC and reads IR
              in MΩ. Used dead, never live. Often built into the MFT.
            </li>
            <li>
              <strong>Multifunction tester (MFT)</strong> — the certification box. Does IR, Zs, PFC,
              RCD trip times, continuity. You need one to issue an EIC or EICR.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              source (a proving unit or a known live circuit) <strong>before and after</strong> the
              dead test. Catches a flat battery, a broken probe, or a damaged lead — any of which
              could give you a false "dead" reading.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              supply origin (cut-out, meter tails). Probes must have finger barriers and a maximum 4
              mm of exposed tip — anything longer is a shock hazard. If your kit doesn't meet GS38,
              it doesn't go on the job.
            </>
          }
          cite="Reference: HSE GS38 — Electrical test equipment for use on low voltage electrical systems (4th edition)"
        />
        ...
        >
          ...
          <p>The classic multimeter incidents come from one of three things:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Wrong function setting.</strong> Set to amps, leads connected across a voltage
              source = near-short circuit through the meter. HBC fuse blows in best case; meter
              explodes in worst case if CAT rating is wrong.
            </li>
            <li>
            ...
            <li>
              <strong>Damaged or non-GS38 leads.</strong> Exposed tips, frayed insulation, no finger
              barriers. Replace immediately, don't bodge.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The dial markings on every multimeter follow the same conventions:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>V⎓ or V−</strong> — DC voltage. Batteries, control circuits, PV panel outputs.
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              milliseconds. If the meter's CAT rating is wrong for the location, the energy exceeds
              what the case can contain and the meter can rupture in your hand.
            </>
          }
          doInstead={
            <>
        ...
        >
          <p>
            Clamp meters come in AC-only and AC+DC (Hall-effect) flavours. For most UK domestic and
            commercial work, an AC clamp meter does the job. Typical uses:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Load surveys</strong> — what's each circuit actually drawing right now? Useful
              for checking diversity assumptions and chasing nuisance trips.
            </li>
            <li>
              <strong>Motor running currents</strong> — compare against the nameplate FLC to catch
              overloaded motors.
            </li>
            <li>
            ...
            <li>
              ...
              for three-phase) and read the residual. Healthy circuit reads near zero; leakage shows
              up as anything significant.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            An insulation resistance tester applies a known DC voltage (250 V for SELV/PELV, 500 V
            for normal LV, 1000 V for above 500 V) and measures the leakage current to calculate
            insulation resistance in MΩ. The whole point: confirm that the cable insulation,
            accessory bodies and all connected gear are properly isolating live conductors from each
            other and from earth.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              isn't a tick-box exercise — it's a specific procedure with a defined test voltage and
              a defined minimum reading. For a normal 230 V circuit, that's 500 V DC and ≥ 1 MΩ
              between live conductors and between live and earth. Below that, the installation fails
              verification.
            </>
          }
        ...
        >
          <p>
            The rule of thumb across the trade: calibrate your MFT and any instrument used to issue
            certificates annually, with a UKAS-traceable certificate. Between calibrations, do
            informal site checks — if your meter starts reading noticeably differently from a
        ...
        <Scenario
          ...
          whyItMatters={
            <>
              The whole BS 7671 verification regime relies on the readings being trustworthy. If the
              kit isn't proven trustworthy via calibration, the certificate is too. Same logic that
              backs your duties under EAWR Reg 4 — using untested kit creates the same legal
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              kicks in. You arrive, switch the lights off, and probe a nearby socket: L-N reads 245
              V. Looks fine — well within the ESQCR ±10% window. But the moment the kettle comes on,
              the lights visibly dip and you can hear a slight buzz from the CU.
            </>
          }
          whatToDo={
            <>
              ...
              <strong> N-E reads ~8 V</strong> — and that last reading is the smoking gun. The three
              voltages have to add up consistently: if N has lifted 8 V above earth under load,
              that's voltage being dropped across a high-resistance joint somewhere on the neutral
              path. Switch the load off and N-E falls back to near zero. Trace back from socket → CU
              neutral bar → main neutral → cut-out: retorque each connection, looking for a loose
              neutral terminal, a discoloured screw or a corroded service-head joint. If the fault
              is on the supply (DNO) side of the cut-out, it's their problem — call it in.
            </>
          }
          whyItMatters={
            <>
              A floating neutral is one of the most-Googled apprentice faults precisely because the
              line voltage looks normal at idle — it only misbehaves under load. Left unfound, the
              load on one circuit causes voltage to lift on every other circuit sharing that
              neutral; lights flicker, electronics fail prematurely, and on a three-phase install
              with a broken neutral you can end up with 400 V across a 230 V appliance. The N-E
              reading under load is the diagnostic — same three probes you've always carried, just
              used to triangulate where the bad joint is hiding.
            </>
          }
        />
        ...
        <p className="text-[13.5px] text-white/85 leading-relaxed border-l-2 border-cyan-400/40 pl-4 italic">
          ...
          (KVL/KCL sanity checks on real circuits using the multimeter and clamp meter) and Sub6.6
          (the MFT and two-pole indicator used to verify RCD and AFDD performance). Same five
          instruments, deeper jobs.
        </p>
