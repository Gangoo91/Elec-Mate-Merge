...
const checks = [
  {
    ...
    options: ['0.03 A', '0.003 A', '3 A', '0.0003 A'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['0.05 Ω is lower', 'They are the same', '50 mΩ is lower', '50 mΩ is ten times lower'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['750 W', '75,000 W', '7,500 W', '75 W'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1,000,000 mA', '10 mA', '1,000 mA', '100 mA'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['240 W', '24 W', '24,000 W', '2,400 W'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['0.047 F', '0.000047 F', '0.00047 F', '0.0000047 F'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['5,000 mA', '50 mA', '500 µA', '0.5 A'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['250,000 Ω', '250,000,000 Ω', '2,500,000 Ω', '25,000,000 Ω'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['7,200 W', '180 W', '720 W', '1,800 W'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          milli, kilo, mega, micro, nano — the prefix system that lets one number cover everything
          from a 30 mA RCD trip to a 250 MΩ insulation reading. Convert it cleanly or fail the cert.
        </p>
        ...
        >
          <p>Each step up multiplies by 1,000. Each step down divides by 1,000.</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>M — mega</strong> — × 1,000,000 (a million). MΩ for insulation, MVA for large
              transformers, MW for grid loads.
            </li>
            <li>
            ...
            <li>
              <strong>m — milli</strong> — ÷ 1,000 (a thousandth). mA (RCD trip currents), mΩ (cable
              continuity), ms (RCD trip times).
            </li>
            <li>
              <strong>µ — micro</strong> — ÷ 1,000,000 (a millionth). µF (capacitors), µA (very low
              leakage currents).
            </li>
            <li>
        ...
        >
          <p>The prefix ladder, with the multiplier between each step:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              G (giga) ← × 1,000 ← M (mega) ← × 1,000 ← k (kilo) ← × 1,000 ← <strong>BASE</strong> ←
              × 1,000 ← m (milli) ← × 1,000 ← µ (micro) ← × 1,000 ← n (nano).
            </li>
            <li>Going LEFT (towards bigger prefixes) divides the number by 1,000 each step.</li>
            <li>
              Going RIGHT (towards smaller prefixes) multiplies the number by 1,000 each step.
            </li>
          </ul>
          <p>
            Worked example. 5 mΩ to MΩ. Three steps to the LEFT (m → base → k → M), so divide by
            1,000 three times = ÷ 1,000,000,000. 5 mΩ ÷ 10⁹ = 5 × 10⁻⁹ MΩ = 0.000000005 MΩ.
            Microscopic — which makes sense, because milliohms are tiny and megohms are huge.
          </p>
          <p>
            Worked example. 0.5 MΩ to mΩ. Three steps to the RIGHT (M → k → base → m), so multiply
            by 1,000 three times = × 1,000,000,000. 0.5 MΩ × 10⁹ = 500,000,000 mΩ. Vast — same logic
            in reverse.
          </p>
          <p>
        ...
        >
          <p>Three rules to keep them apart:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Anchor each to a familiar value.</strong> 30 mA = the standard RCD trip
              current. 470 µF = a typical motor-run capacitor. 4 µA = the kind of leakage current a
              healthy circuit draws to earth at standby. Keep one solid example for each prefix in
              your head.
            </li>
            <li>
              <strong>Spell it out when in doubt.</strong> "30 milliamps" or "30 mA" are unambiguous
              in writing — "30 ma" is not. The Greek µ doesn't appear on a UK keyboard easily, so
              people sometimes substitute "u" or "mu" — both acceptable as long as they're
              consistent.
            </li>
            <li>
              <strong>Use the dropdown, not the keyboard.</strong> On every digital cert software
              the prefix is a separate selectable field. Pick from the list and the case can't go
              wrong. Free-typing the unit is the source of half the prefix errors on a typical EICR.
            </li>
          </ul>
          <p>
            The penalty for a m/µ mix-up: 1,000×. A 30 µA leakage written as 30 mA is the difference
            between an installation that's healthy and one that should already be off. Slow down for
            the prefix on every value you record.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The convention electricians and engineers follow for "what prefix should the answer be
            in?":
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              If the result is below 0.1, step DOWN to a smaller-base prefix (e.g. 0.05 A → 50 mA).
            </li>
            <li>
              If the result is above 1,000, step UP to a larger-base prefix (e.g. 4,700 V → 4.7 kV).
            </li>
            <li>
          ...
          <p>
            Why bother? Two reasons. First, the next person reading your cert reads numbers faster
            and more accurately when there are fewer zeros to count. Second, sanity-checks get
            easier — "13 A drawn by a kettle" is recognisable; "13,000,000 µA drawn by a kettle" is
            the same value but the digit count alone makes it harder to spot whether it's right or
            wrong. Tidy maths is safer maths.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Three prefix-reading habits that catch typos before they ship:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Read the screen, then read the unit, then write down both together.</strong>{' '}
              Don't write the digits, look away, then come back and add the unit — that's where the
              m/M slips happen.
            </li>
            <li>
              <strong>Sanity-check against the expected range</strong> before recording. If the ring
              final R1+R2 should be 0.4-0.8 Ω and the meter says 0.45, that fits — record it. If it
              says 450, you've got the wrong range or you're reading mΩ as Ω. Stop and check.
            </li>
            <li>
              <strong>Re-read the prefix on auto-ranging meters every time.</strong> The same test
              on the same circuit might display in mΩ, Ω or kΩ depending on what the meter decides
              is the most readable scale. Don't assume the prefix from the previous reading carries
              over.
            </li>
          </ul>
          <p>
            Insulation testers in particular love to switch from MΩ to GΩ when the reading goes very
            high. A 250 MΩ reading on Tuesday and a 0.5 GΩ reading on Wednesday are not "different"
            — they're the same level of healthy insulation, just displayed in different prefixes.
            Train yourself to read the unit every time.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              protection on top of basic and fault protection — not a replacement for them. Note the{' '}
              <strong>m</strong> in <strong>mA</strong> — lower-case, milli, ÷ 1,000. 30 mA is 0.03
              A. Write it as 30 A on a test sheet (upper-case A only) and you've described an RCD
              that wouldn't trip until far above the lethal threshold.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              requirement on the device itself (BS EN 61008/61009), referenced by BS 7671 Reg
              643.7.3 and Table 41.1 as the test pass criterion — it is not the wording of Reg
              415.1.1. Same goes for the time figure — <strong>ms</strong> is milliseconds, not
              megaseconds. Apprentices regularly mis-attribute this clause; the regs and the product
              standards do separate jobs.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Convert all values into BASE units</strong> — kW becomes W, kΩ becomes Ω, mA
              becomes A. Multiply or divide by 1,000 (or 1,000,000) as needed.
            </li>
            <li>
        ...
        >
          <p>A kettle is marked 3 kW, 230 V, 50 Hz. What current does it draw?</p>
          <p>
            <strong>Step 1 — base units.</strong> 3 kW = 3 × 1,000 = 3,000 W. 230 V is already base.
            50 Hz is the frequency, not used here.
          </p>
          <p>
            <strong>Step 2 — calc.</strong> P = V × I, so I = P ÷ V = 3,000 ÷ 230 ≈ 13.04 A.
          </p>
          <p>
            <strong>Step 3 — sensible prefix.</strong> 13 A is already a sensible scale. No need to
            re-prefix. Result: kettle pulls ~13 A — right at the limit of a 13 A plug fuse, which is
            exactly why kettles run that fuse and not, say, a 3 A.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              current is 250 mA. You key 12 × 250 = 3,000 into the calculator and write "3,000 W" on
              the test sheet. Wrong. The current was MILLI-amps. The actual answer is 12 × 0.25 = 3
              W.
            </>
          }
          doInstead={
            <>
              Convert mA to A before the multiplication. 250 mA ÷ 1,000 = 0.25 A. Then 12 × 0.25 = 3
              W. Get into the habit of writing units next to numbers in your working — it forces you
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Print the M clearly upper-case for mega. Use digital cert software where the prefix is
              a dropdown rather than free-typed. When in doubt, write the long form (megohms /
        ...
        <Scenario
          ...
          situation={
            <>
              You're checking a colleague's EICR before sign-off. R1+R2 reads 0.45 Ω. Zs reads 0.78
              mΩ on the same circuit. Something looks wrong — Zs should always be at least as big as
              R1+R2.
            </>
          }
          whatToDo={
            <>
              Spot the prefix slip. 0.78 mΩ is way too low for a real Zs reading (that would mean an
              almost perfect fault loop). Almost certainly the colleague meant 0.78 Ω — they added a
              stray "m" out of habit. Talk to them, retest if you can't be sure, correct the cert
          ...
          whyItMatters={
            <>
              ...
              that says "this Zs is OK for this MCB" relies on the value being read correctly. Catch
              it on the desk, not in court.
            </>
          }
        />
