...
const checks = [
  ...
  },
  {
    ...
    options: ['Ohms', 'Megohms', 'Milliohms', 'Microhms'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Ohms (Ω)', 'Volts (V)', 'Amperes (A)', 'Coulombs (C)'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['240 V', '110 V', '400 V', '230 V'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Volts, amps, ohms and watts — what each one really represents, the values you should
          expect on UK installations, and how to determine them from instruments and product labels.
        </p>
        ...
        >
          <p>
            The volt (V) is the SI derived unit of electric potential difference. Strictly: 1 V = 1
            joule of work per coulomb of charge moved. In plain terms — the higher the voltage, the
            harder the supply pushes electrons through the circuit.
          </p>
          <p>UK nominal voltages a Level 2 apprentice meets:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>12 V / 24 V</strong> — SELV / PELV control circuits, garden lighting, vehicle
              systems.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            The ampere (A) is the SI BASE unit for electric current. It's the only base unit on the
            electrical side; volts, ohms and watts are all derived from it (and the metre, kilogram
            and second).
          </p>
          <p>Typical UK currents you'll see:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>30 mA</strong> — RCD trip current for shock protection (additional protection
              per BS 7671 411.3.3).
            </li>
            <li>
        ...
        >
          <p>Take a typical 7.5 kW UK industrial three-phase induction motor. The plate reads:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>7.5 kW</strong> — rated mechanical OUTPUT power at the shaft. Watts (W), with
              the kilo prefix (× 1,000), so 7,500 W of useful turning power. Not the electrical
              input — the input is higher because the motor isn't 100% efficient.
            </li>
            <li>
              ...
              line-to-line). Older plates may still read 415 V (the pre-1995 nominal); the tolerance
              bands overlap so the motor still runs, but design Vd / fault calcs should use 230/400
              V.
            </li>
            <li>
            ...
            <li>
              ...
              = 10.0 × 0.85 ≈ 8.5 kW of electrical input. The 7.5 kW rating is what comes out of the
              shaft, so motor efficiency η ≈ 7.5 ÷ 8.5 ≈ 88%. Apprentice rule of thumb: a modern
              induction motor of this size lands around 85-90% on both PF and efficiency.
            </li>
            <li>
              <strong>IP55</strong> — ingress protection. First digit (5) = dust-protected. Second
              digit (5) = protected against water jets. Suitable for most workshop and
            ...
            <li>
              ...
              height stores 65 × 9.81 × 2 ≈ 1,275 J of potential energy — drop it and that all comes
              back as a wrecked floor.
            </li>
          </ul>
          <p>
            Every number on that plate is a unit you've just learned. V, A, Hz, W, kW, kg — they're
            not exam fluff, they're literally the numbers you read off the wall.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            body's vulnerability is current-based, not voltage-based. Approximate effects of 50/60
            Hz AC across the chest:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>~30 mA</strong> — risk of ventricular fibrillation if the current crosses the
              heart for more than a few hundred milliseconds.
            </li>
            <li>
        ...
        >
          <p>
            ...
            of pressure to push one amp through one ohm of resistance. That's Ohm's law expressed as
            a unit definition.
          </p>
          <p>Three big resistance contexts on Level 2:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>R1 + R2 (continuity / CPC)</strong> — measured in ohms or milliohms. Typical
              reading on a short ring final R1+R2: 0.4-0.8 Ω. High readings = poor connection.
            </li>
            <li>
              <strong>Insulation resistance (IR)</strong> — measured in megohms. Minimum acceptance
              per Table 64 of BS 7671: 1.0 MΩ at 500 V DC for normal LV circuits. Healthy
              installations read hundreds of MΩ or "OL" (over-limit).
            </li>
            <li>
              <strong>Earth fault loop impedance (Zs)</strong> — also in ohms. Caps depend on the
              protective device and disconnection time. A 16 A Type B MCB to BS EN 60898 needs Zs ≤
              1.09 Ω at 230 V for the required disconnection time (BS 7671 Regulation 411.4.204(a) /
              Table 41.3 row for 16 A Type B). Heavier-rated MCBs need a tighter Zs — a 32 A Type B
              is well below 1 Ω.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            <em>impedance</em> (Z) — also measured in ohms. You'll meet these properly in Section 4
            onwards. For now, recognise the three component symbols you'll see on every schematic.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The watt (W) is the SI derived unit of power. For DC and resistive AC loads:</p>
          ...
          <p>
            ...
            appliance pulls (I = P ÷ V), which then tells you the cable size, the protective device,
            and whether the existing circuit will cope.
          </p>
          <p>Common UK power ratings to anchor your sense of scale:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer rings up about a high bill. They say "the immersion heater is 3 kWh — that's
              why the bill is huge". You crack on assuming the immersion is the problem and end up
              replacing a healthy element. Wrong. <strong>kW</strong> is power (rate);{' '}
              <strong>kWh</strong> is energy (rate × time). A 3 kW immersion only uses 3 kWh per
              hour of running — if it's running 8 hours a day, that's 24 kWh. THAT'S where the bill
              comes from.
            </>
          }
          doInstead={
            <>
              Always separate the rating (kW) from the consumption (kWh). When a customer complains
              about bills, the question is "how long is it on for?" — not just "what's it rated at?"
              Same kit, very different bill depending on usage.
            </>
          }
        />
