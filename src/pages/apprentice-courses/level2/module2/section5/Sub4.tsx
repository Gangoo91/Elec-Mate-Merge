    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The reverse of last subsection. There, current made magnetism. Here, changing magnetism
        ...
        >
          <p>
            ...
            <strong>F = B × I × L</strong> from Sub3. Fleming’s LEFT-hand rule gives you the
        ...
        >
          ...
          <p>
            ...
            field, induced EMF appears at the terminals, current flows when you connect a load. Sub5
            walks through the geometry of a single-loop AC generator step by step.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              the Level 2 exam. Some apprentices write it on the back of their hand on the day of
        ...
        >
          <p>
            ...
            go and collapses in microseconds. Lenz’s law (Sub5.4’s rule) says the coil has to fight
            that collapse: it does so by inducing a big EMF in the direction that tries to keep the
            current flowing. Faraday’s law (also Sub5.4) says the size of that induced EMF is
          ...
          <p>
            ...
            by every contactor switching upstream of them. When Sub6.6 builds out the AFDD
            electronics, the back-EMF problem you’ve just met is one of the things the device has to
            design around.
          </p>
        </ConceptBlock>
