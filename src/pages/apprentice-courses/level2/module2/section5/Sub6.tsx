...
const TITLE = 'Sine waves — peak, RMS, frequency, period (5.5) | Level 2 Module 2.5.6 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: ['230 V', '253 V', '460 V', '325 V'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['10 ms', '20 ms', '100 ms', '50 ms'],
    correctIndex: 1,
    explanation:
  ...
  {
    id: 'sync-speed',
    question: 'A 4-pole induction motor on UK 50 Hz mains has a synchronous speed of about:',
    options: ['1500 rpm', '750 rpm', '3000 rpm', '6000 rpm'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['253 V', '230 V', '460 V', '325 V'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Increases T', 'Decreases T', 'Makes T negative', 'No change'],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 6,
    question: 'When MUST you use a true-RMS meter rather than an average-responding one?',
    options: [
  ...
  },
  {
    ...
    options: ['1500 rpm', '3000 rpm', '750 rpm', '1000 rpm'],
    correctAnswer: 3,
    explanation:
...
export default function Sub6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 5 · Subsection 6"
        title="Sine waves — peak, RMS, frequency, period"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The vocabulary you need to talk about every AC supply you’ll ever isolate. Peak, RMS,
          period, frequency — UK 230 V RMS, 325 V peak, 20 ms period, 50 Hz, every socket on the
          island.
        </p>
        ...
        <ConceptBlock title="The Section 5 thread, in one line">
          <p>
            Sub 5.4 said: changing flux through a coil = induced EMF. Sub 5.5 showed what shape that
            EMF takes from a single rotating coil — sinusoidal. This Sub answers the next practical
            question: how do we measure a sine wave?
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            consequence of constant rotation through a uniform field. Now we put numbers on that
            wave.
          </p>
          <p>
            UK public mains supply is a sine wave at <strong>50 Hz</strong> with an RMS voltage of{' '}
            <strong>230 V</strong>. That sine wave reaches a peak of about <strong>325 V</strong>{' '}
            twice per cycle (once positive, once negative), crosses zero twice per cycle, and
            completes one full cycle every <strong>20 ms</strong>.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            actually mean? It’s the <strong>root mean square (RMS)</strong> value — defined as the
            equivalent DC voltage that would dissipate the same average power in a resistor. That
            makes RMS the natural choice for nameplates and ratings: a 230 V RMS supply genuinely
            produces 230 V × I worth of heat in a 230 V kettle.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Same √2 ratio applies to current: I_RMS = I_peak / √2.</li>
          </ul>
          <p>
            For UK mains: V_peak = 230 × √2 ≈ 325 V. That 325 V is the figure your insulation has to
            withstand twice per cycle, every 20 ms, for the next forty years on the installation.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked example — peak from RMS, RMS from peak">
          ...
          <p>
            <strong>Question 2.</strong> A control transformer has a 24 V RMS secondary. What is the
            peak voltage your test probe would see across it?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>V_peak = V_RMS × √2 = 24 × 1.414 ≈ 34 V</li>
          </ul>
          <p>
            The same trick scales up. A 400 V three-phase supply (line-to-line, RMS) hits about 565
            V peak at every line-to-line crossing. Insulation class on the switchgear has to suit.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              positive), averaging it over one cycle, and taking the square root. For a sine wave
              that whole calculation simplifies to V_peak / √2. For a square wave it gives V_peak
              (no √2 factor). For weird shapes (drives, SMPS), only a true-RMS meter actually does
        ...
        >
          <p>
            <strong>Frequency</strong> (symbol <strong>f</strong>) is the number of complete cycles
            per second, measured in <strong>hertz (Hz)</strong>. UK public mains frequency is fixed
            at 50 Hz by ESQCR 2002.
          </p>
          <p>
            <strong>Period</strong> (symbol <strong>T</strong>) is the time taken for one complete
            cycle, measured in seconds. The two are inverses of each other:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>T = 1 / f</strong>
          ...
          <p>Worked examples — quick conversions:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              UK 50 Hz → T = 1/50 = 0.02 s = <strong>20 ms</strong>
            </li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Declared frequency in the UK is 50 Hz. The legal tolerance is ±1%, so the supply must
              stay between <strong>49.5 Hz and 50.5 Hz</strong>. National Grid (now NESO) keeps it
              inside that window minute by minute by balancing generation against demand. If you
              ever see a meter reading 49.7 or 50.2 — that’s normal, not a fault.
            </>
          }
        ...
        >
          <p>
            For an AC induction motor, the rotational speed is set by mains frequency and the number
            of magnetic poles built into the stator:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              2-pole: (120 × 50) / 2 = <strong>3000 rpm</strong>
            </li>
            <li>
              4-pole: (120 × 50) / 4 = <strong>1500 rpm</strong> (most common industrial)
            </li>
            <li>
              6-pole: (120 × 50) / 6 = <strong>1000 rpm</strong>
            </li>
            <li>
              8-pole: (120 × 50) / 8 = <strong>750 rpm</strong>
            </li>
          </ul>
          <p>
            <strong>Slip.</strong> An induction motor’s real running speed sits 2–5% below
            synchronous because the rotor needs to be slightly slower than the field to generate the
            induced current that creates its torque (Faraday’s law again — Sub4). A 4-pole motor
            with 3% slip runs at 1500 × 0.97 = 1455 rpm at full load.
          </p>
          <p>
            <strong>Synchronous and PMSM motors</strong> lock exactly to mains frequency — no slip.
            They’re used where precise speed matters (timing, conveyors that have to stay in step
            with each other, paper machines).
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The √2 conversion only works on pure sine waves. Take an average-responding meter and
            put it on:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              The output of a <strong>variable frequency drive (VFD)</strong> — the waveform is a
              chopped pulse-width modulated (PWM) shape, not a sine.
            </li>
            <li>
              The DC bus or output of a <strong>switched-mode power supply (SMPS)</strong> — square
              waves with sharp edges.
            </li>
            <li>
              The output of an <strong>LED driver or dimmer</strong> — phase-cut sine waves with
              chunks missing.
            </li>
            <li>
              The output of a <strong>UPS in inverter mode</strong> — often a stepped approximation,
              not a true sine.
            </li>
          </ul>
          <p>
            On all of these, an average-responding meter applies the wrong conversion factor and
            gives a reading that can be 10–40% off. A <strong>true-RMS meter</strong> actually
            integrates the waveform over a cycle and gives a correct RMS value regardless of shape.
            Spec one with at least CAT III 600 V for distribution-board work; CAT IV at the origin.
          </p>
          <p>
            <strong>Tool-bag thread.</strong> The True-RMS clamp meter you’ll need here is the same
            instrument family as the basic multimeter you met back in Sub1.5 — except where Sub1.5’s
            meter LIES on a non-sinusoidal LED-driver waveform, the True-RMS version reads
            correctly. Same body, smarter brain. The upgrade pays for itself the first time it stops
            you chasing a ghost fault on a VFD or LED job.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked example — when the meter lies — non-sinusoidal current">
          <p>
            ...
            average-responding one — reads <strong>13 A</strong> on the cable feeding one of the LED
            drivers. What’s the peak current the cable actually sees?
          </p>
          <p>
            <strong>If it were a clean sine wave</strong> (which is what the meter assumes), you’d
            work out the peak with the standard √2 factor:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              I_peak = I_RMS × √2 = 13 × 1.414 ≈ <strong>18 A peak</strong>
            </li>
          </ul>
          <p>
            That’s what the meter is implicitly telling you — because under the hood it measured the
            average rectified current and applied the sine-wave form factor of 1.11 to display
            "RMS".
          </p>
          <p>
            <strong>But this is an LED driver.</strong> Half the LED drivers an electrician meets
            are non-sinusoidal — switched-mode supplies that pull current in short, sharp pulses
            near the peak of each mains half-cycle. The peak-to-RMS ratio (the "crest factor") for a
            clean sine wave is √2 = <strong>1.414</strong>. For a typical LED-driver current
            waveform it’s anywhere from <strong>2 to 3</strong>. Same RMS reading, very different
            peak:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Crest factor 2 → I_peak = 13 × 2 = <strong>26 A peak</strong>
            </li>
            <li>
              Crest factor 3 → I_peak = 13 × 3 = <strong>39 A peak</strong>
            </li>
          </ul>
          <p>
            So the real cable peak could be anywhere from <strong>26 to 39 A</strong> against the 18
            A peak the meter implies. The cable, the breaker and the connectors are all sitting in
            that current spike every half-cycle, even though the displayed RMS says everything’s
            fine.
          </p>
          <p>
            <strong>Conclusion:</strong> use a True-RMS meter on LED-heavy installations. An
            average-responding meter doesn’t just under-read RMS on these waveforms — it also makes
            any "what’s the peak?" calculation you try to do off it meaningless. If you’re sizing
            protection or auditing inrush on an LED job, the cheap meter will quietly point you at
            the wrong answer.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            UK three-phase distribution carries three line conductors, each with its own voltage
            waveform. Each phase is a sine wave of the same amplitude and frequency, but offset in
            time so the peaks land 120° apart (one-third of a 20 ms cycle, so about 6.67 ms).
            Three-phase is a Level 3 / Module 3 topic — but the building blocks (peak, RMS,
            frequency, period) are exactly what you’ve just learned.
          </p>
          <p>
            Each single phase to neutral measures 230 V RMS (50 Hz). Line-to-line measures 400 V RMS
            — the √3 factor that comes from the geometry of phasors 120° apart. Everything you’ll
            ever measure on UK mains, single or three-phase, comes from applying this subsection’s
            rules to one or three sine waves.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You assume "the supply is only 230 V" and pick test gear or insulation rated for that.
              Reality is the supply hits 325 V peak twice per cycle, and transient surges regularly
              push it briefly past 1000 V. Cheap test leads flash over. Insulation fails after a few
              years. RCBOs explode on a fault. You’ve under-specified the whole installation.
            </>
          }
          doInstead={
            <>
              Always design and select for the <strong>peak</strong> voltage and the expected
              <strong> transient</strong> overvoltage class. UK 230 V supplies want CAT III 600 V
              minimum on test gear (CAT IV at the supply origin), 500 V DC insulation resistance
              test kit, components rated for at least 600 V working voltage. BS 7671 puts numerical
              limits on this — design out from the peak, not the RMS.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              average-responding meter reads 180 V on the motor terminals when the drive is set to
              50 Hz output. You panic — the motor is rated for 400 V. Where’s the missing voltage?
            </>
          }
          whatToDo={
            <>
              Borrow a true-RMS meter and re-measure. The reading jumps to about 400 V — which is
              what should have been there all along. The drive’s output isn’t a sine wave, it’s a
              chopped PWM waveform that an average-responding meter can’t handle. The motor is fine.
              The drive is fine. Your meter is just lying. Same scenario plays out daily on
              commissioning jobs across the UK; if you don’t know the meter’s limitations, you chase
              ghost faults for hours.
            </>
          }
          whyItMatters={
            <>
              A true-RMS meter costs twice as much as an average-responding one, but pays for itself
              the first time it stops you spending a day chasing a non-existent fault on a VFD
              installation. As soon as you start working on commercial, industrial, EV charging or
              anything with switched-mode supplies, average-responding meters aren’t fit for
              purpose.
            </>
          }
        />
        ...
        >
          <p>
            Up to now this Sub has dealt with single-phase — one sine wave, 230 V RMS, 50 Hz, one
            socket on a domestic wall. <strong>Three-phase</strong> takes the same idea and triples
            it. Three coils inside a single alternator, spaced 120° (one third of a revolution)
            apart around the rotor. As the rotor turns, each coil hits its peak EMF a third of a
            cycle (about 6.67 ms) after the one before. The result is three sine waves of identical
            amplitude and frequency, all delivered together on three line conductors.
          </p>
          <p>What you get from generating three together instead of one:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Smoother total power delivery.</strong> When one phase is at zero EMF, the
              other two are still pushing. The total instantaneous power across all three phases is
              constant (for a balanced load), instead of pulsing 100 times a second like
              single-phase. That’s why every motor above a few kW runs on three-phase — no torque
              pulsations.
            </li>
            <li>
              <strong>Higher voltages from the same kit.</strong> Each phase is 230 V RMS to
              neutral. But because the three peaks land 120° apart, the line-to-line voltage between
              any two phases is <strong>400 V RMS</strong> — the √3 factor that comes from phasor
              geometry. Same alternator, two voltage levels: 230 V where you need a phase + neutral,
              400 V where you need line-to-line.
            </li>
            <li>
              ...
              bigger than a domestic boiler pump — all three-phase. As soon as you leave domestic
              work behind, you’re into three-phase territory.
            </li>
          </ul>
          <p>
            Module 3 covers all of it properly — line vs phase voltage, the √3 factor, balanced vs
            unbalanced loads, star and delta connection, three-phase metering, three-phase fault
            current. <strong>The peak/RMS/period maths from THIS Sub all carries over.</strong>{' '}
            Every individual phase IS a 230 V RMS sine wave at 50 Hz with a 325 V peak and a 20 ms
            period. You already know how to measure one of them. Module 3 just teaches you what
            happens when you have three at once.
          </p>
        </ConceptBlock>
        ...
        <Quiz
          title="Sine waves — peak, RMS, frequency — knowledge check"
          questions={quizQuestions}
        />

        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level2/module2/section5/5-5')}
          ...
          <button
            onClick={() => navigate('/study-centre/apprentice/level2/module2/section6')}
