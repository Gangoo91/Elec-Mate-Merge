...
const TITLE = 'Magnetic flux and flux density (5.2) | Level 2 Module 2.5.2 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: ['Weber (Wb)', 'Tesla (T)', 'Henry (H)', 'Ampere-turn (At)'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['25 Wb', '10 Wb', '0.025 Wb', '0.01 Wb'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Magnetic force', 'Magnetic flux', 'Magnetic flux density', 'Magnetic charge'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1 m²/Wb', '1 Wb', '1 V/Wb', '1 Wb/m²'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      'A coil sits in a 0.8 T field. The cross-section of the coil is 50 cm². What is the flux through it?',
    options: ['4 Wb', '0.004 Wb', '0.0016 Wb', '40 Wb'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['About 5 T', 'About 50 mT', 'About 0.5 T', 'About 50 µT'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Flux Φ in webers, flux density B in tesla, and the simple equation that ties them
          together. The numerical language behind every transformer kVA rating and every motor
          nameplate.
        </p>
        ...
        >
          <p>
            ...
            pipe per second is the <strong>flux</strong> — how much "stuff" is getting through. How
            fast that water is moving in any one cross-section is the <strong>density</strong> — how
            packed the flow is at one specific spot. Squeeze the same flux into a smaller pipe and
            the density goes up; widen the pipe and the density drops, even though the total flow
            hasn’t changed.
          </p>
          <p>
            ...
            <strong>magnetic flux density B</strong>, measured in <strong>tesla (T)</strong>. Tied
            together by one short equation:
          </p>
          ...
          <p>
            The next blocks unpack each of these properly — units, scale, worked examples — and then
            you’ll see why every transformer designer in the country lives inside this one equation.
            You won’t do those design calcs on site, but you’ll see the units everywhere: on
            transformer plates, on motor data sheets, in BS 7671 itself.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Magnetic flux</strong> (symbol <strong>Φ</strong>, the Greek capital "phi") is
            the total amount of magnetic field crossing a particular area. It’s measured in
          ...
          <p>
            The bigger the surface, or the stronger the field passing through it, the more flux you
            have. If the surface is tilted at an angle to the field, you only count the component of
            the field that’s perpendicular to the surface — but for the Level 2 exam, you’ll always
            be given the case where field and surface are at right angles to each other.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              In English: flux is the total of the flux density over the whole surface you care
              about. For a uniform field at right angles to the surface — which is what Level 2
              questions always assume — that simplifies down to <strong>Φ = B × A</strong>. Don’t
              panic at the formal wording; the version you’ll actually use is the simple one.
            </>
          }
        ...
        >
          <p>
            <strong>Magnetic flux density</strong> (symbol <strong>B</strong>) is the strength of
            the field at a particular point — the flux per square metre of cross-section. It’s
            measured in <strong>tesla (T)</strong>, where:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>A few real-world numbers to anchor the scale:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Earth’s magnetic field at the surface:</strong> about 50 µT — weak, but enough
              to swing a compass.
            </li>
            <li>
            ...
            <li>
              <strong>A typical neodymium "rare earth" magnet:</strong> 0.5 to 1.4 T at the surface.
            </li>
            <li>
              <strong>A transformer core at full load:</strong> 1.0 to 1.7 T — pushed to the point
              where the iron is just shy of saturating.
            </li>
            <li>
              <strong>A medical MRI scanner magnet:</strong> 1.5 to 3 T over a much bigger volume.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>For a uniform field B passing through an area A at right angles, the total flux is:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Φ = B × A</strong>
            </li>
        ...
        <ConceptBlock title="Worked example — flux through a coil">
          <p>
            A bar magnet produces a uniform field of <strong>B = 0.5 T</strong> in the gap between
            its poles. A small rectangular coil with cross-section <strong>A = 0.02 m²</strong> sits
            squarely in the gap, perpendicular to the field.
          </p>
          ...
          <p>
            In the next subsection — and again in Sub5, the AC generator — you’ll see that the EMF
            induced in a coil depends on how fast Φ changes, multiplied by the number of turns.
            That’s why this number matters: it’s the input to every induction calculation that
            follows.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked example — finding flux density from flux">
          <p>
            ...
            total flux through it is <strong>Φ = 4 mWb</strong>. What is the flux density inside the
            core?
          </p>
          ...
          <p>
            That’s right at the top end of normal operation for silicon steel — push it any higher
            and the core saturates and starts heating up badly. This is exactly the maths a
            transformer designer is doing when they spec the laminations.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            property is called <strong>permeability</strong> (symbol µ). Air has a permeability very
            close to 1. Soft iron is about 5,000 times higher. Grain-oriented silicon steel (the
            stuff transformer cores are stamped from) can hit 40,000.
          </p>
          <p>
            Practical consequence: for the same magnetising current, a coil wound round a
            silicon-steel core produces a flux density thousands of times higher than the same coil
            in air. That’s why every transformer, every motor and every solenoid has a core of
            magnetic material running through the middle of its windings — without it the device
            would need to be the size of a fridge to do the same job.
          </p>
          <p>
            There’s a limit, though. Pile too much flux into a piece of iron and the domains run out
            of room to align — the iron <strong>saturates</strong>. Push past that and the extra
            magnetising current just gets dissipated as heat. That’s why transformer designers aim
            for B around 1.5 T in silicon steel — close to the limit, but not over it.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              lamination" on a transformer spec sheet, this standard is what’s behind the numbers.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              transformer to operate around <strong>1.5 T</strong> peak in the silicon steel — close
              to saturation but not over it. If supply voltage drifts up to the top of the ±10%
              ESQCR window (so 253 V instead of 230 V), the peak flux in the core climbs with it.
              Push past the saturation knee and the iron stops carrying extra flux — the magnetising
              current shoots up instead and the core overheats. That’s why a transformer running on
              a permanently high supply gets warm even at light load.
            </li>
            <li>
              <strong>A contactor coil pulling in unreliably below 80% supply voltage.</strong> The
              coil is sized to develop the flux density needed to overcome the spring and pull the
              armature in. The standard rule of thumb is the coil must work at <strong>80%</strong>{' '}
              of nominal supply (so 184 V on a 230 V coil) and reliably drop out below 65% — flux
              density scales with coil voltage, and below the 80% threshold there isn’t enough B to
              hold the armature in against the spring.
            </li>
            <li>
              <strong>The "1.5 T" line on a relay coil data sheet.</strong> When a relay or solenoid
              coil spec quotes a peak operating flux density (often 1.0 to 1.7 T for soft-iron
              parts), that’s the B the magnetic circuit needs to develop for the armature to pull in
              cleanly. Below it, the contacts chatter or won’t close. Above it, the iron saturates
              and you waste the rest as heat.
            </li>
          </ul>
          <p>
        ...
        <Scenario
          ...
          situation={
            <>
              You’re called to a workshop where a 230 V contactor feeding a small extraction fan
              keeps "chattering" — pulling in, dropping out, pulling in again, two or three times a
              second. The audible buzz is brutal. The control circuit is a simple latch: push a
              start button, the contactor pulls in, an auxiliary contact holds it. You check the
              supply at the coil terminals while it’s trying to hold in. Your meter reads{' '}
              <strong>180 V</strong> across the coil — on a contactor whose nameplate says "230 V
              AC, pickup 80% nominal".
            </>
          }
          whatToDo={
            <>
              Do the maths. 180 V on a 230 V nominal coil is <strong>78%</strong> of nominal — below
              the 80% pickup threshold the contactor needs. Translation: the coil isn’t generating
              enough flux density to hold the armature in against its spring. The armature pulls
              partway in, the air gap drops, the coil draws more current briefly, the supply drops
              further (because it was already weak), the contactor drops out, the cycle repeats —
              that’s the chatter. <strong>Trace the supply drop first.</strong> Most likely a long
              thin control-circuit cable run from the panel with too much voltage drop under the
              inrush current; sometimes a knackered upstream contact, sometimes a worn neutral. If
              the supply genuinely is 180 V at the panel bus and there’s nothing you can do about it
              (a long sub-main on a difficult site), then specify a coil rated for the actual
              voltage you’ve got — most contactor ranges sell 110 V or 24 V coils for exactly this
              case, with a separate control transformer feeding them.
            </>
          }
          whyItMatters={
            <>
              Flux density isn’t abstract physics. The 80% pickup threshold on a coil is the line
              between "kit holds in cleanly" and "kit chatters, contacts weld, motor runs
              single-phase, building burns down". A contactor stuck chattering can weld its main
              contacts in seconds and lose phase isolation on whatever it’s feeding. The number that
              decides which side of that line you sit on is B in the magnetic circuit of the coil —
              exactly the quantity this Sub puts numbers on.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              <strong>0.4 T</strong>. You write Φ = 0.4 × 50 = 20 Wb and confidently underline it.
              But 20 Wb is enormous — bigger than the flux inside a small transformer. The actual
              answer is <strong>0.4 × 0.005 = 0.002 Wb (2 mWb)</strong>. You’ve dropped a factor of
              10,000.
            </>
          }
          doInstead={
            <>
              Always convert the area to <strong>square metres</strong> first: 1 cm² = 0.0001 m² = 1
              × 10⁻⁴ m². So 50 cm² = 50 × 10⁻⁴ = 0.005 m². Then plug into Φ = B × A. The same trap
              catches people with mm² (1 mm² = 1 × 10⁻⁶ m²). Get the units right before you press
              the equals sign.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              ordered. One line reads <strong>"Peak core flux density: 1.5 T"</strong>. The manager
              asks you what it means in plain language.
            </>
          }
          whatToDo={
            <>
              Tell them: 1.5 tesla is how packed the magnetic field gets inside the silicon steel
              core at the peak of each AC cycle. That figure is chosen by the designer deliberately
              — high enough to make the transformer compact and efficient, but low enough to stay
              below the saturation point of the steel (around 1.7-2.0 T). Push higher and the core
              overheats and the transformer wastes energy and trips on temperature.
            </>
          }
          whyItMatters={
            <>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level2/module2/section5/5-1')}
          ...
          <button
            onClick={() => navigate('/study-centre/apprentice/level2/module2/section5/5-3')}
