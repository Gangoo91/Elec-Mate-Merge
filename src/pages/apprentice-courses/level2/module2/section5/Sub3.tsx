      ...
      <HubBody>
        ...
        >
          ...
          <p>
            ...
            is the permeability of free space (4π × 10⁻⁷ Tm/A). For Level 2 you don’t need to crunch
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              is reserved for Fleming’s left-hand rule (motor force, next subsection). Pin it on the
        ...
        <ConceptBlock title="Forward reference — this is what an RCD sees">
          <p>
            ...
            current transformer relies on — Sub6.6 builds on this directly when we get to RCD and
            AFDD electronics.
          </p>
        </ConceptBlock>
