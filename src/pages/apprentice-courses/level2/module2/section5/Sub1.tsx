...
const TITLE = 'Magnets, poles, attraction and repulsion (5.1) | Level 2 Module 2.5.1 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Cancel out', 'Attract', 'Repel', 'Nothing'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Brass', 'Copper', 'Aluminium', 'Iron'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The first proper lesson on magnetism. Get the poles, the fields and the attract/repel rule
          sound here, and the next five subsections — flux, induction, generators, AC — fall into
          place. Without magnetism, no UK electrical industry.
        </p>
        ...
        >
          <p>
            ...
            fault, every contactor that pulls in when the switch closes — they all run on the same
            poles, fields and forces you’re about to meet.
          </p>
          <p>
            Get this section solid and you’ve got the physics behind half the kit you’ll touch for
            the next forty years on site. Skip it and AC supplies, motors and transformers in later
            modules will feel like magic. They’re not — they’re this.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            You can’t separate them. Snap a bar magnet in half and you don’t get a lone north piece
            and a lone south piece — you get two smaller magnets, each with its own N and S. Snap
            those in half and you’ve got four. There’s no such thing as a magnetic monopole —
            physicists have looked, and we still haven’t found one.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Bring the north pole of one magnet near the north pole of another and you can feel the
            resistance — they push each other away. Same with two south poles. Bring a north near a
            south and they pull together hard.
          </p>
          <p>
            This isn’t a courtesy of the magnets being polite — it’s a real, measurable force. The
            closer they are, the stronger it gets, falling off roughly with the square of distance
            (the same inverse-square pattern you see with gravity and electric charges).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Two things to take away. First — a magnet is defined by what it <em>does</em> (exerts
              forces), not what it’s made of. Second — that field can be <strong>persistent</strong>{' '}
              (a permanent magnet) or <strong>induced</strong> (a soft-iron piece that becomes
              magnetic only while a current flows nearby — that’s your contactor coil, your relay,
              your solenoid valve).
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Outside the magnet, they run from N to S.</strong> They leave the north pole,
              curve through the air, and re-enter at the south pole.
            </li>
            <li>
            ...
            <li>
              <strong>They never cross each other.</strong> If two field patterns meet, the lines
              bend around each other or combine into one new pattern.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            spread out in the middle. That tells you the field is strongest at the poles — that’s
            where a paperclip will stick first if you slide it along.
          </p>
          <p>
            Move a piece of iron away from the pole and the pull weakens fast. The field doesn’t
            fall off in a straight line — it drops roughly with the square of the distance, the same
            way electric force from a point charge does. Double the distance, roughly quarter the
            force.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              magnets. Iron, nickel, cobalt, most steels (mild and tool steels), and a few alloys
              like alnico and ferrite. This is the group that matters for your trade.
            </li>
            <li>
              <strong>Paramagnetic</strong> — very weakly attracted, only detectable with sensitive
              lab gear. Aluminium, platinum, oxygen. You won’t notice this on site.
            </li>
            <li>
              <strong>Diamagnetic</strong> — very weakly repelled (yes, repelled). Copper, water,
              gold, most plastics. Same story — too weak to feel.
            </li>
          </ul>
          <p>
            For everyday electrical work, the practical line is this:{' '}
            <strong>
              iron and steel respond to magnets — copper, aluminium, brass and plastics don’t.
            </strong>{' '}
            That’s what your magnet on a string is testing for when you’re fishing a screw out from
            under a floorboard.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            stays fixed once you’ve set it — alnico, ferrite, neodymium. Once magnetised, they hold
            that field for years. Drop them, hammer them or heat them and the alignment can get
            scrambled.
          </p>
          <p>
            <strong>Induced (or temporary) magnets</strong> are made from "soft" magnetic materials
            — usually low-carbon iron. They line up easily when another magnet or a current is near,
            but lose the alignment the moment that source goes away. That’s perfect for transformer
            cores and contactor armatures, where you want the magnetism to switch on and off cleanly
            with the current.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            <strong>domains</strong> — typically a fraction of a millimetre across. Each domain has
            all its atoms’ magnetic moments lined up the same way, so it’s a small magnet on its
            own. But across the whole bar, the domains point in random directions, so they cancel
            out and the bar shows no net magnetism.
          </p>
          <p>
            Stroke the bar with a magnet, or run a strong current through a coil wrapped around it,
            and the domains pivot to line up with the external field. Once enough of them are
            aligned, the whole bar acts as a single magnet. Heat it past its Curie point (about
            770°C for iron) and the alignment shakes apart again.
          </p>
          <p>
            <strong>Read the diagram below:</strong> the loop shape tells you whether a material
            ‘remembers’ a magnetic field after the source is removed. A wide loop = a hard magnet
            that holds its alignment (good for permanent magnets). A narrow loop = a soft magnet
            that lets go easily (good for transformer cores and contactor armatures, where you want
            the magnetism to switch on and off cleanly with the current).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The standard splits magnetic materials into <strong>soft</strong> (easy to magnetise
              and demagnetise — used for transformer cores, motor laminations, solenoids) and{' '}
              <strong>hard</strong> (hold their magnetism stubbornly — used for permanent magnets in
              DC motors, sensors and instrument needles). When a manufacturer quotes a
              "grain-oriented silicon steel" core, that’s a soft magnetic material from this
              standard.
            </>
          }
        ...
        <ConceptBlock title="A practical sort: which of these are magnetic?">
          <p>
            Pretend you’ve dropped your van keys into a tray of mixed offcuts. You’ve got a strong
            neodymium magnet on a string. Which bits will it pick up, and which will it leave
            behind?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Copper 22mm pipe offcut</strong> — no. Copper is diamagnetic, which to your
              hand looks like "no reaction at all".
            </li>
            <li>
              <strong>Aluminium trunking lid</strong> — no. Aluminium is paramagnetic — too weakly
              attracted to feel.
            </li>
            <li>
            ...
            <li>
              <strong>Galvanised steel screw</strong> — yes. The galvanising (zinc coating) isn’t
              magnetic, but the steel underneath is.
            </li>
            <li>
              <strong>Stainless steel washer</strong> — depends on the grade. 304 and 316
              (austenitic, the common ones) are weakly magnetic at best. 410 and 430 (martensitic
              and ferritic) are strongly magnetic. A magnet test is the easy way to tell them apart.
            </li>
          </ul>
          <p>
            That last one is the trick that catches a lot of apprentices out: not all "stainless" is
            the same. Quick magnet check on the bench tells you which grade you’re holding before
            you order more.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              tripping the contacts open. That magnetic latch is the difference between a breaker
              that trips in 10 ms on a fault and one that doesn’t. Sub5.3 takes that apart properly.
            </li>
            <li>
              <strong>The magnetised tip on your screwdriver.</strong> Holds a screw on the end so
              you can start it one-handed in the back of a CU. Useful — until it grabs swarf you
              didn’t mean to pick up, or trips a hall-effect sensor on a control board you’re
              working near.
            </li>
            <li>
              <strong>The magnet-on-the-end-of-a-fishing-rod trick.</strong> Drop a screw into a
              floor void or behind a kitchen unit and the small telescopic magnetic pickup tool from
              your kit fishes it out. Same idea as a magnet on a string — only steel and iron come
              back, copper and brass stay where they fell.
            </li>
            <li>
              <strong>The cup magnet on a contractor’s level.</strong> Lets you stick the level onto
              a steel beam, RSJ or steel stud track to mark out a level run hands-free. The cup
              shape concentrates the field at a flat face, which is why those magnets pull so much
              harder than a flat fridge magnet of the same size.
            </li>
            <li>
              <strong>The toroidal core inside an RCD.</strong> Not a magnet itself — but a
              purpose-built ring of soft magnetic material that detects an imbalance between line
              and neutral by sensing the changing field. Sub6.6 builds this directly out of the
              principles in this section, so file it away for now.
            </li>
          </ul>
          <p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You’re sliding a small bar magnet along a steel ruler to check it really is steel. You
              hold it by the middle and slide it across — barely any drag. Wrong end of the magnet
              doing the work. The middle of a bar magnet is where the field is <em>weakest</em>, not
              strongest.
            </>
          }
          doInstead={
            <>
              Touch one of the <strong>ends</strong> of the magnet to the metal — that’s where the
              field lines are densest and the pull is strongest. Same applies when you’re using a
              magnetic torch or a pickup tool: the working end is the pole, not the shaft.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re second-fixing a domestic CU. Every time you dip your Phillips into the bag of
              small grub screws for a busbar shroud, two or three jump up and stick to the tip.
              Annoying — but worse, when you’re working inside the consumer unit, a tiny screw drops
              off the bit and disappears down behind the DIN rail. Third one today. You weren’t
              magnetised this morning. What changed?
            </>
          }
          whatToDo={
            <>
              The tip of your screwdriver has been magnetised — almost certainly by sitting near a
              strong field on a job earlier in the week (the speaker cabinet you helped lift in for
              the AV install on Tuesday is a likely culprit; speaker drivers carry serious neodymium
              magnets). The tip’s domains have lined up and now it grabs ferrous bits without you
              asking. <strong>Three ways to degauss it:</strong> (1) spin the tip fast inside the
              coil of a commercial degausser if you’ve got one in the van; (2) rotate or flick it
              briskly past the open end of an AC mains transformer (same principle, free); (3)
              cruder but works in a pinch — give the shaft a sharp tap on a hard non-magnetic
              surface (a concrete kerb, the side of a brass tap), which physically jolts the domains
              back out of alignment. Re-test on the screw bag — if they still cling, repeat.
            </>
          }
          whyItMatters={
            <>
              Magnetism isn’t a textbook curiosity — it’s a daily annoyance. A magnetised tip that
              grabs swarf you didn’t mean to pick up can short a live busbar; a screw lost inside a
              powered CU is a dead-front violation waiting to happen. Worse, on control boards with
              hall-effect sensors, a magnetised tool waved past the wrong IC can trigger nuisance
              trips you can’t debug. Knowing magnetism is something you can both create and undo on
              the bench is part of being on site.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            onClick={() => navigate('/study-centre/apprentice/level2/module2/section5/5-2')}
