      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-2 pb-24">
        <PageFrame>
          ...
          <RegsCallout
            ...
            meaning={
              <>
                Reg 131.6.4 — together with the design and certification regs in Part 1 / Part 6 —
                is why prospective fault current (PFC) belongs on the Electrical Installation
                Certificate. PFC isn’t just nice-to-know — it’s a mandatory measured value on the
                EIC, recorded so anyone working on the installation in future knows what devices
                the design can safely accept.
              </>
            }
