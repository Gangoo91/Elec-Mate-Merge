/**
 * Module 1 · Section 2 · Subsection 2 — Overloads, short circuits and arcing
 ...
 *     in the workplace (protective device selection / coordination).
 */
...
const TITLE = 'Overloads, Short Circuits and Arcing | Level 2 Module 1.2.2 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question:
      'What’s the maximum continuous operating temperature for standard PVC cable insulation?',
    options: ['40°C', '90°C', '70°C', '120°C'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    id: 5,
    question:
      'What does Regulation 433.1.1 require about the operating current of an overload device?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'You’re on site and notice scorch marks around a connector block in a junction box. What does that tell you?',
    options: [
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 2 · Subsection 2"
        title="Overloads, short circuits and arcing"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Three things that turn a healthy circuit into a fire — too much current, conductors
          touching, or a sustained arc. What causes them, what they do to the cable, and how the
          protective device is meant to clear them before anyone gets hurt.
        </p>
        ...
        >
          <p>
            ...
            just plugged too much in. Current might be 1.5 to 5 times the rating. The cable starts
            to heat up.
          </p>
          <p>
            ...
            can hit hundreds or thousands of amps in a few milliseconds. That’s a fault current, and
            it has to be cleared instantly.
          </p>
          <p>
            ...
            conductor instead of the neutral. This is where RCDs come in — a tiny earth leakage (30
            mA) doesn’t trip the MCB, but it’ll kill someone holding the metalwork.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The textbook examples are usually:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Too much load on the circuit</strong> — several high-power appliances stacked
              on one socket circuit, or extension leads daisy-chained off each other.
            </li>
            <li>
              <strong>Motor stalled or stuck</strong> — a jammed pump or fan keeps drawing
              locked-rotor current (which can be 6–8 × the running current) until something gives.
            </li>
            <li>
              <strong>Cable undersized for the load</strong> — someone fitted 1.5 mm² where 2.5 mm²
              was needed. The MCB’s sized for the cable, but the load was sized for the appliance.
              They don’t match.
            </li>
            <li>
              <strong>Bad design call</strong> — wrong diversity factor used at the design stage, so
              the actual real-world load exceeds what was assumed.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              than <strong>1.45 × the cable’s capacity</strong>. So a 2.5 mm² cable with an Iz of 24
              A can’t be sat behind anything that takes more than 34.8 A to trip — otherwise the
              cable would cook for ages before the device decided there was a problem. It’s why MCB
              rating selection isn’t a free choice.
            </>
          }
        ...
        >
          <p>
            A short circuit happens when something bridges line to neutral (or line to line)
            directly, with no load in between. The usual culprits:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Damaged insulation</strong> — cable nicked when it was pulled in, or degraded
              over time from heat or UV.
            </li>
            <li>
            ...
            <li>
              <strong>Water ingress</strong> — a leaking soil pipe drips into a junction box. Water
              is conductive enough to bridge terminals.
            </li>
            <li>
              <strong>Vermin</strong> — mice love chewing through cable insulation. So do squirrels
              in lofts.
            </li>
            <li>
          ...
          <p>
            ...
            circuit current can reach 2–6 kA at the consumer unit. Industrial settings can be 25 kA
            or more.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            An arc is a sustained electrical discharge through ionised gas — effectively a localised
            plasma between two conductors. Temperature in the arc itself can hit 19,000°C. That’s
            hotter than the surface of the sun. Even a tiny arc will scorch metalwork and ignite
            anything combustible nearby (cable insulation, dust, sawdust, cardboard).
          </p>
          <p>Two flavours, both bad:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Series arc</strong> — happens at a loose connection that’s in series with the
              load. The load still works, the current looks normal, the MCB sees nothing wrong. But
              the loose terminal cooks away in the background. Classic cause of fires that start in
              junction boxes weeks after an installation. The MCB and RCD will both miss it.
            </li>
            <li>
              <strong>Parallel arc</strong> — happens between conductors when insulation breaks
              down. Acts like a high-resistance short circuit. May or may not draw enough current to
              trip the MCB depending on the contact area.
            </li>
          </ul>
          <p>
            <strong>AFDDs</strong> (Arc Fault Detection Devices) are the only standard protective
            device designed to spot the high-frequency electrical signature of arcing and disconnect
        ...
        <RegsCallout
          ...
          meaning={
            <>
              A4:2026 turned what used to be a recommendation into a hard requirement across four
              premises types: <strong>HRRBs</strong> (residential buildings over 18 m),{' '}
              <strong>HMOs</strong>, <strong>purpose-built student accommodation</strong> and{' '}
              <strong>care homes</strong>. Every standard 32 A or smaller socket-outlet final
              circuit in those premises needs an AFDD on it. Recommended (not yet mandatory)
              everywhere else.
            </>
          }
          cite="Source: BS 7671:2018+A4:2026 Part 4, Chapter 42, Reg 421.1.7"
        />
        ...
        >
          <p>
            Standard PVC-insulated cable is rated to{' '}
            <strong>70°C continuous operating temperature</strong>. Past that, the insulation starts
            to lose its mechanical properties. It goes brittle. It cracks. Eventually it ignites.
            Higher-spec thermosetting insulation (XLPE, LSF/LSZH) handles 90°C, but even that has a
            hard ceiling.
          </p>
          <p>The chain of damage usually goes:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
            <li>
              <strong>Cable insulation degrades</strong> — first sign on site is discoloured cable
              sheath at terminations, or a faint smell of hot plastic.
            </li>
            <li>
              <strong>Equipment damage</strong> — connected appliances run on degraded supply, often
            ...
            <li>
              <strong>Fire ignition</strong> — either from the cable itself, or from arcing where
              the insulation has finally broken down.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fuses</strong> (BS 88, BS 1361, BS 3036) — simple, cheap, very high breaking
              capacity. Used for the main supply fuse and on industrial distribution. Once blown,
              they’re replaced, not reset.
            </li>
            <li>
              <strong>MCBs</strong> (BS EN 60898) — reusable. Types B (3–5 × In), C (5–10 × In) and
              D (10–20 × In) cover different inrush profiles. Protect against overload AND short
              circuit.
            </li>
            <li>
            ...
            <li>
              <strong>RCBOs</strong> (BS EN 61009) — MCB and RCD in one. The standard final circuit
              device in modern boards.
            </li>
            <li>
              <strong>AFDDs</strong> (BS EN 62606) — detect the high-frequency signature of series
              and parallel arcs. Often combined with RCBO functionality.
            </li>
          </ul>
        </ConceptBlock>

        <RegsCallout
          source="BS 7671:2018+A4:2026 — Sections 433 and 434 (paraphrased)"
          clause="A protective device providing protection against both overload current and fault current must fulfil the relevant requirements of Section 433 (protection against overload current) and Section 434 (protection against fault current). The standalone Regulation 435.1 was deleted by BS 7671:2018+A4:2026 — the requirement is now covered by Sections 433 and 434 directly."
          meaning={
            <>
              If one device is doing both jobs (which is what an MCB or RCBO does), it has to
              satisfy BOTH the overload rules (Section 433 — the 1.45 × Iz limit, the In ≥ Ib rule)
              AND the fault current rules (Section 434 — disconnection times, breaking capacity,
              energy let-through). Not a pick-and-choose.
            </>
          }
          cite="Verbatim wording paraphrased — see BS 7671:2018+A4:2026 Part 4, Chapter 43, Sections 433 and 434 for the full text. Regulation 435.1 was deleted in A4:2026."
        />
        ...
        >
          <p>
            ...
            (e.g. "6000" or "6 kA" for a typical domestic MCB; 10 kA or 25 kA for higher-spec ones).
            That’s the maximum fault current it can safely interrupt without the contacts welding
            shut, the casing rupturing, or the device disintegrating.
          </p>
          <p>
          ...
          <p>
            The rule: every protective device’s breaking capacity must be at least equal to the PFC
            at its installed location. Get this wrong and the device fails when you actually need
            it.
          </p>
        </ConceptBlock>

        <RegsCallout
          source="BS 7671:2018+A4:2026 — Regulation 131.6.4"
          clause="The installation shall have an adequate level of immunity against electromagnetic disturbances so as to function correctly in the specified environment, in accordance with Section 444. The installation design shall take into consideration the anticipated electromagnetic emissions, generated by the installation or the installed equipment, which shall be suitable for the current-using equipment used with, or connected to, the installation."
          meaning={
            <>
              Reg 131.6.4 — together with the design and certification regs in Part 1 / Part 6 — is
              why prospective fault current (PFC) belongs on the Electrical Installation
              Certificate. PFC isn’t just nice-to-know — it’s a mandatory measured value on the EIC,
              recorded so anyone working on the installation in future knows what devices the design
              can safely accept.
            </>
          }
          cite="Source: BS 7671:2018+A4:2026 Part 1, Chapter 13, Regulation 131.6.4."
        />
        ...
        >
          <p>Plenty of fault conditions warn you they’re coming if you know what to look for:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
            <li>
            ...
            <li>
              <strong>Scorch marks inside accessories</strong> — sockets, switches, junction boxes,
              MCB shrouds. Open one up and look.
            </li>
            <li>
              <strong>Smell of hot insulation</strong> — distinctive burnt-plastic smell. If the
              customer mentions it, treat it seriously.
            </li>
            <li>
              <strong>Repeated tripping</strong> — not nuisance tripping, but the same MCB going
              every time the same load runs. Something’s wrong on that circuit.
            </li>
            <li>
              <strong>Melted shrouds or distorted plastic</strong> — around terminations on the
              busbar in a consumer unit.
            </li>
            <li>
              <strong>Crackling or buzzing</strong> from a board, junction box or accessory — series
              arcing in real time.
            </li>
            <li>
              <strong>Warm cables, sockets or switch plates</strong> — they shouldn’t be warm to
              touch. Resistive heating.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer rings up: "my upstairs sockets keep tripping". You drive over, push the RCBO
              back up, it stays in. Job done? No. The fault is still there, you just left it armed.
              Next time something draws current it’ll trip again — or worse, this time it doesn’t
              trip and the cable cooks until it ignites.
            </>
          }
          doInstead={
            <>
              A device tripped for a reason. Isolate, do an IR test, check accessories for damage,
              check terminations for scorching or looseness, look for what’s changed since it last
              worked. Find the cause. EAWR Regulation 4 says no work should be carried out on or
              near live conductors unless it’s unreasonable for them to be dead — by extension, you
              don’t leave a known-faulty circuit live.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Don’t just add the socket. Isolate, take the existing one off and inspect it. Look for
              discoloured terminals (past arcing), loose conductors, undersized cable, or a back-box
              full of stretched-out terminations. Check the circuit design — if it’s a 32 A radial
              in 4 mm² you may be fine; if it’s a spur off a ring fed by 1.5 mm² you’re already over
              the cable rating. Test the circuit properly before adding any more load to it.
            </>
          }
          whyItMatters={
            <>
              A socket warm enough to feel through the faceplate is already operating outside spec.
              Adding more load to it doesn’t fix the problem — it accelerates it. This is exactly
              the kind of overcurrent condition that turns into a kitchen fire six months later, and
