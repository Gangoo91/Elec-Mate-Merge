...
const checks = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "Standard PVC tops out at 70°C continuous. Past that, the insulation degrades â it goes brittle, then it cracks, then it burns. That’s why Reg 433.1.1 limits the device operating current to 1.45 \u00D7 the cable’s capacity.",
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "AFDDs spot the high-frequency signature of an arc â a loose terminal cooking away, or insulation breaking down. An MCB only sees overcurrent; an RCD only sees imbalance. Neither catches a series arc. A4:2026 mandates AFDDs in HMOs and high-rise dwellings.",
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'No difference â same fault, different name',
    ...
    correctAnswer: 1,
    explanation:
      "Overload current is usually a few times the rating â cooks the cable slowly. Short circuit current is hundreds or thousands of times higher â needs the device to break instantly before the cable lets go.",
  },
  {
    id: 2,
    ...
    options: [
      ...
      'PVC degrades above 70°C â then it cracks, then it burns',
      'It improves conductivity at high temperatures',
      'It absorbs the extra current',
    ],
    correctAnswer: 1,
    explanation:
      "Standard PVC is rated for 70°C continuous. Cook it past that and the insulation goes brittle, exposing live conductors and feeding any fire that starts. That’s the actual hazard with overload â not the current itself, but the heat.",
  },
  {
    id: 3,
    ...
    options: [
      ...
      'Always an overload',
      "Could be a short circuit (L-N), an earth fault (L-PE), or both â depends what the nail bridges",
      'Voltage drop',
    ],
    correctAnswer: 2,
    explanation:
      "Depends what the nail hits. Line to neutral = short circuit. Line to the cpc or to a metal box = earth fault. Often it’s both at once. Either way, the device should clear it instantly â that’s why we use 50mm safe zones and capping.",
  },
  {
    id: 4,
    question: 'What’s a series arc, and why is it dangerous?',
    options: [
      'A short between two phase conductors â instant MCB trip',
      "An arc across a loose terminal in line with the load â current stays low, MCB doesn’t see it, but it generates intense heat",
      'An arc only seen on three-phase systems',
      'An arc that only happens during testing',
    ],
    correctAnswer: 1,
    explanation:
      "A loose terminal arcs as the load draws current â the current is normal, so the MCB has no reason to trip, but the arc temperature is thousands of degrees. Classic kitchen fire cause. AFDDs are the only protection that catches it.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      "Regulation 433.1.1(c). The current that actually trips the device must stay at or below 1.45 \u00D7 Iz â otherwise the cable could sit cooking forever before the device decides to do anything. It’s why MCB rating selection isn’t free choice.",
  },
  {
    id: 6,
    question: 'What’s breaking capacity, and why does it matter?',
    options: [
      'How long the device takes to reset â longer is safer',
  ...
  },
  {
    ...
    options: [
      'Normal sign of a healthy connection â ignore it',
      "There’s been arcing at a loose or high-resistance termination â isolate, investigate and remake the connection",
      'The cable needs uprating to a bigger size',
      "It’s only a problem if it’s been there over 12 months",
    ],
    correctAnswer: 1,
    explanation:
      "Scorching = past arcing. Loose terminal, dry joint, undersized terminal for the conductor â something’s been sparking. Don’t just retighten and walk away. Isolate, find the cause, replace the connector if it’s damaged. Note it on the next inspection.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Because most loads pull a brief surge when they start â motors, transformers, even an old fluorescent fitting. If the MCB tripped on every inrush you’d never keep the lights on. So MCBs have a time-current curve: small overcurrents take seconds or minutes to trip; massive overcurrents (short circuits) trip in milliseconds. That’s the difference between the thermal element (overload) and the magnetic element (short circuit) in the same device.",
  },
  {
    question: "What’s the difference between Type B, C and D MCBs?",
    answer:
      "Same overload behaviour, different magnetic trip thresholds. Type B trips at 3â5 \u00D7 In â standard for domestic/lighting/socket circuits. Type C trips at 5â10 \u00D7 In â for circuits with bigger inrush (small motors, banks of fluorescents). Type D trips at 10â20 \u00D7 In â for transformers, X-ray gear, big motors. Pick the wrong one and you’ll either get nuisance tripping or you won’t clear a fault fast enough for shock protection.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Because every protective device has a maximum fault current it can safely break. A standard 6 kA domestic MCB will explode if you ask it to interrupt 25 kA. The PFC test at the origin tells you the worst-case fault current at that point â you then prove the devices you’re fitting can handle it. Reg 132.2(c)(iv) says you have to record it on the certificate.",
  },
  {
    question: "Will an AFDD replace an RCBO?",
    answer:
      "No â they detect different things. RCBOs see overcurrent and earth/residual leakage. AFDDs see the high-frequency signature of an arc. You usually fit them together (often as a combined AFDD+RCBO module). One protects you from shock and standard overcurrent; the other catches the loose-terminal, hidden-arcing fires that the others miss.",
  },
  {
      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-2 pb-24">
        <PageFrame>
          ...
          <PageHero
            ...
            description="Three things that turn a healthy circuit into a fire â too much current, conductors touching, or a sustained arc. What causes them, what they do to the cable, and how the protective device is meant to clear them before anyone gets hurt."
            tone="emerald"
          />
          ...
          <TLDR
            points={[
              ...
              "The hazard isn’t the current â it’s the heat. PVC dies at 70°C, and an arc burns at thousands of degrees.",
          ...
          <LearningOutcomes
            outcomes={[
              ...
              "Explain why heat â not current â is what actually causes the damage.",
              ...
              "Match the right protective device to the right fault â fuse, MCB, RCBO, AFDD.",
          ...
          <ConceptBlock
            title="Overload, short circuit, earth fault â same family, different fault"
          ...
          >
            <p>
              ...
              more current than it was designed for. Cable’s intact, terminations are sound â you’ve
            ...
            <p>
              ...
              conductor instead of the neutral. This is where RCDs come in â a tiny earth leakage
          ...
          >
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Too much load on the circuit</strong> â several high-power appliances
                stacked on one socket circuit, or extension leads daisy-chained off each other.
              </li>
              <li>
                <strong>Motor stalled or stuck</strong> â a jammed pump or fan keeps drawing
                locked-rotor current (which can be 6â8 \u00D7 the running current) until something
                gives.
              </li>
              <li>
                <strong>Cable undersized for the load</strong> â someone fitted 1.5 mm² where
                2.5 mm² was needed. The MCB’s sized for the cable, but the load was sized for the
                appliance. They don’t match.
              </li>
              <li>
                <strong>Bad design call</strong> â wrong diversity factor used at the design stage,
          ...
          <RegsCallout
            source="BS 7671:2018+A4:2026 â Regulation 433.1.1(c)"
            ...
            meaning={
              <>
                ...
                Iz of 24 A can’t be sat behind anything that takes more than 34.8 A to trip â
          ...
          <ConceptBlock
            ...
            onSite="Most short circuits are mechanical â something physical brought two conductors together. Damage, water, vermin, or a screw."
          >
            <p>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Damaged insulation</strong> â cable nicked when it was pulled in, or
                degraded over time from heat or UV.
              </li>
              <li>
                <strong>Stray strands at terminations</strong> â a couple of strands of the line
                conductor flicked across to the neutral terminal during a busy second-fix.
              </li>
              <li>
                <strong>Water ingress</strong> â a leaking soil pipe drips into a junction box.
                Water is conductive enough to bridge terminals.
              </li>
              <li>
                <strong>Vermin</strong> â mice love chewing through cable insulation. So do
                squirrels in lofts.
              </li>
              <li>
                <strong>Screws, nails, drill bits through buried cable</strong> â the classic
            ...
            <p>
              ...
              circuit current can reach 2â6 kA at the consumer unit. Industrial settings can be
              25 kA or more.
            </p>
          </ConceptBlock>
          ...
          <ContentEyebrow>Arcing â the third hazard</ContentEyebrow>
          ...
          >
            <p>
              An arc is a sustained electrical discharge through ionised gas â effectively a
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Series arc</strong> â happens at a loose connection that’s in series
              ...
              <li>
                <strong>Parallel arc</strong> â happens between conductors when insulation breaks
          ...
          <RegsCallout
            source="BS 7671:2018+A4:2026 â Regulation 421.1.7 (HMOs)"
          ...
          >
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Cable insulation degrades</strong> â first sign on site is discoloured
                cable sheath at terminations, or a faint smell of hot plastic.
              </li>
              <li>
                <strong>Equipment damage</strong> â connected appliances run on degraded supply,
                often shortening their life.
              </li>
              <li>
                <strong>Voltage drop affects the rest of the circuit</strong> â lights dim, motors
                struggle to start, electronics behave erratically.
              </li>
              <li>
                <strong>Fire ignition</strong> â either from the cable itself, or from arcing
          ...
          >
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Fuses</strong> (BS 88, BS 1361, BS 3036) â simple, cheap, very high
                breaking capacity. Used for the main supply fuse and on industrial distribution. Once
                blown, they’re replaced, not reset.
              </li>
              <li>
                <strong>MCBs</strong> (BS EN 60898) â reusable. Types B (3â5 \u00D7 In), C
                (5â10 \u00D7 In) and D (10â20 \u00D7 In) cover different inrush profiles.
                Protect against overload AND short circuit.
              </li>
              <li>
                <strong>RCDs</strong> (BS EN 61008) â detect residual current (line-neutral
              ...
              <li>
                <strong>RCBOs</strong> (BS EN 61009) â MCB and RCD in one. The standard final
                circuit device in modern boards.
              </li>
              <li>
                <strong>AFDDs</strong> (BS EN 62606) â detect the high-frequency signature of
          ...
          <RegsCallout
            source="BS 7671:2018+A4:2026 â Regulation 435.1"
            ...
            meaning={
              <>
                ...
                BOTH the overload rules (Section 433 â the 1.45 \u00D7 Iz limit, the In \u2265 Ib
                rule) AND the fault current rules (Section 434 â disconnection times, breaking
          ...
          <ContentEyebrow>Breaking capacity â the bit you can’t skip</ContentEyebrow>

          <ConceptBlock
            title="Every device must safely break the worst-case fault current at its location"
            plainEnglish="If 12 kA could flow through that MCB during a fault, the MCB’s breaking capacity has to be at least 12 kA â otherwise it can’t actually clear the fault and may explode trying."
          >
            <p>
          ...
          <RegsCallout
            source="BS 7671:2018+A4:2026 â Regulation 132.2(c)(iv)"
            clause="The documentation shall include prospective fault current."
            meaning={
              <>
                The PFC isn’t just nice-to-know â it’s a mandatory entry on the
          ...
          <ConceptBlock
            title="What past or building overcurrent looks like â and smells like"
          ...
          >
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Discoloured terminations</strong> â brown or black around the screw of a
                connector that should look pristine. Past arcing.
              </li>
              <li>
                <strong>Scorch marks inside accessories</strong> â sockets, switches, junction
                boxes, MCB shrouds. Open one up and look.
              </li>
              <li>
                <strong>Smell of hot insulation</strong> â distinctive burnt-plastic smell. If
                the customer mentions it, treat it seriously.
              </li>
              <li>
                <strong>Repeated tripping</strong> â not nuisance tripping, but the same MCB
                going every time the same load runs. Something’s wrong on that circuit.
              </li>
              <li>
                <strong>Melted shrouds or distorted plastic</strong> â around terminations on
                the busbar in a consumer unit.
              </li>
              <li>
                <strong>Crackling or buzzing</strong> from a board, junction box or accessory â
                series arcing in real time.
              </li>
              <li>
                <strong>Warm cables, sockets or switch plates</strong> â they shouldn’t be
          ...
          <CommonMistake
            ...
            whatHappens={
              <>
                ...
                left it armed. Next time something draws current it’ll trip again â or worse,
            ...
            doInstead={
              <>
                ...
                or near live conductors unless it’s unreasonable for them to be dead â by
          ...
          <Scenario
            ...
            whatToDo={
              <>
                ...
                a back-box full of stretched-out terminations. Check the circuit design â if it’s
            ...
            whyItMatters={
              <>
                ...
                Adding more load to it doesn’t fix the problem â it accelerates it. This is
          ...
          <KeyTakeaways
            points={[
              ...
              "Reg 433.1.1 limits the device operating current to 1.45 \u00D7 the cable’s Iz â it’s why MCB rating isn’t a free choice.",
              "Series arcs (loose terminations) are the silent fire-starter. MCBs and RCDs miss them â only AFDDs catch them.",
