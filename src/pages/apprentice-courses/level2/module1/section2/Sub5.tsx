...
const TITLE = 'Slips, Trips and Manual Handling | Level 2 Module 1.2.5 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    options: ['Installation', 'Instruction', 'Inspection', 'Individual'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    id: 4,
    question:
      'HSE indicative guideline weight for a man lifting at waist height, close to the body, is around:',
    options: ['25 kg', '16 kg', '10 kg', '50 kg'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 8,
    question:
      'You arrive to swap a 45 kg distribution board on your own in a tight cupboard. Right call?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'Slips and trips sound minor compared to a shock. Are they really worth a whole subsection?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Not as dramatic as a 230 V belt, but these are the injuries that quietly write off more
          electrician careers than shock ever does. Worth ten minutes — your back will thank you in
          twenty years.
        </p>
        ...
        <ConceptBlock title="The injuries that actually take electricians off the tools">
          <p>
            Ask any second-year apprentice what’s going to hurt them and they’ll say electric shock.
            Look at HSE’s annual injury figures and the picture flips: slips, trips and falls on the
            same level account for around a third of reportable construction injuries. Handling,
            lifting and carrying is the biggest single cause of long-term work-related sickness —
            back, shoulder, knee.
          </p>
          <p>
            Shock kills the unlucky few. Bad lifting and a wet floor end careers steadily, year
            after year. By the time an electrician in their forties starts telling you "my back’s
            gone", that’s three decades of small, ignored injuries finally cashing in. The point of
            this subsection is to keep your back, knees and shoulders working until you decide to
            stop using them.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            MHOR 1992 (amended 2002) was put in place because handling injuries were eating UK
            industry alive — back then, more than one in four reportable injuries came from manual
            handling. The Regulations apply to any lifting, lowering, pushing, pulling or carrying
            of a load by hand or bodily force, animate or inanimate.
          </p>
          <p>
            The duty isn’t "lift correctly". It’s a strict three-step hierarchy on the employer in
            Reg 4. You’ll see it again and again in RAMS — it’s the spine of every manual-handling
            assessment.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              such manual handling operations to be undertaken by them, … (ii) take appropriate
              steps to reduce the risk of injury to those employees arising out of their undertaking
              any such manual handling operations to the lowest level reasonably practicable …
            </>
          }
          meaning={
            <>
              Three steps in order: <strong>AVOID</strong> the lift, <strong>ASSESS</strong> what
              you can’t avoid, <strong>REDUCE</strong> the risk. Notice what’s NOT on the list —
              there is no "give them a back belt and crack on". If avoidance hasn’t been considered
              first, the regulation has been breached, full stop.
            </>
          }
        ...
        >
          <p>
            TILE is HSE’s plain-English way of doing a manual handling assessment under MHOR Reg 4.
            Four headings, asked in order. If any one of them flags an issue, the lift gets
            re-planned — different person, different kit, different route, mechanical aid, or split
            the load.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>T — Task.</strong> What’s the lift? How far, how high, how often? Twisting
              involved? Reaching above shoulder? Carrying down stairs? The further the load is from
              your spine, the more it loads your back — exponentially.
            </li>
            <li>
              <strong>I — Individual.</strong> You. Trained for this? Carrying an old injury? Tired
              at the end of a long week? Pregnant? New to the trade and the technique isn’t second
              nature yet? Be honest — nobody else can do that for you.
            </li>
            <li>
              <strong>L — Load.</strong> Weight is the obvious bit, but shape, grip, stability and
              contents shifting matter just as much. A 15 kg coil of SWA with sharp ends behaves
              nothing like a 15 kg neat box.
            </li>
            <li>
              <strong>E — Environment.</strong> Floor surface, lighting, space to manoeuvre,
              temperature, weather. A consumer unit going onto a backing board in a tight airing
              cupboard is a totally different lift from the same unit on a workshop bench.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            You’ll see "25 kg for men, 16 kg for women" thrown around as if it’s a hard limit. It
            isn’t. HSE publishes a graphic showing how the
            <em> indicative</em> safe weight changes with hand position relative to the body. At
            full arm’s reach above shoulder height, the figure for a man drops to around 5 kg.
            That’s the difference between a coil of 1.5 mm² and a small downlight.
          </p>
          <p>
            For electrical work the implication is simple. Anything overhead — cable tray, lighting,
            fire alarm sounders, smoke detectors — is a high-load lift even when the kit is light.
            Anything in a confined cupboard with a twist is a high-load lift. Anything down low
            (below knee) is a high-load lift. "It’s only 10 kg" isn’t an answer.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The Workplace (Health, Safety and Welfare) Regulations 1992 are the quiet workhorse
            behind every clean walkway on site. Reg 12 puts duties on the employer about the
            construction and condition of floors and traffic routes — they have to be suitable,
            properly maintained and kept free of obstructions and substances likely to cause a slip,
            trip or fall.
          </p>
          <p>
            Reg 8 covers lighting — enough to allow people to work and move about safely. Most
            electrician slip/trip incidents come back to one of these two regulations on the
        ...
        <RegsCallout
          ...
          meaning={
            <>
              "Every floor". Every traffic route. Not just the main ones. The walkway you’ve left a
              drill case in counts. The corridor full of cable offcuts counts. The leads you’ve
              draped across the apprentices' route to the welfare cabin count. If someone goes over,
              the investigation follows the leads back to whose kit it was.
            </>
          }
        ...
        <ConceptBlock title="The four electrician trip hazards you’ll see today">
          <p>
            Same four show up on almost every site. They’re worth recognising on sight because the
            fix is in your hands — none of them needs a meeting.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Trailing leads.</strong> Extension reels and 110 V flexes routed across
              doorways and corridors. Fix: route round the perimeter, tape down where you can’t, use
              cable covers (drop-over rubber tracks) where pedestrians cross.
            </li>
            <li>
              <strong>Tools and cases left in walkways.</strong> Drill case open on the floor,
              impact driver under a stair tread. Fix: tools go back in the bag the second you’re not
              using them. Habit, not effort.
            </li>
            <li>
              <strong>Offcuts and packaging.</strong> Trunking ends, tray offcuts, pulled-back
              cardboard — slips when wet, trips when dry. Fix: skip trips throughout the day, not
              just at end-of-shift.
            </li>
            <li>
              <strong>Loose floor sections during second-fix.</strong> Lifted boards in a riser,
              lifted carpet in an office. Fix: warning tape, edge protection, never leave the area
        ...
        >
          <p>
            Slip control on site is layered. Best is to remove the source — drips from a leaking
            pipe, condensation from a chiller, water tracked in from outside. Next best is to
            contain it — mat at the door, drip tray under the leak. Then mark it — wet floor signs,
            barriers. Last line of defence is what’s on your feet.
          </p>
          <p>
            Site-spec safety boots should carry an SRC slip rating where you’re working on smooth or
            wet surfaces. They’re not waterproof boots, they’re slip-resistant boots — the sole is
            graded against tile + soap and steel + glycerol. If your boots are bald or the tread is
            packed with mud, the rating means nothing.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You’re 19, you can lift it, so you do. Solo, no aid, twisting onto a backing board.
              Nothing happens that day. Or that month. Three years later you wake up with a bulged
              disc and a doctor signing you off the tools for six weeks. Your boss’s insurance
              investigates — no TILE, no team lift requested, no record. The injury claim falls
              flat.
            </>
          }
          doInstead={
            <>
              Manual handling is a planning test, not a strength test. If a lift fails TILE on any
              of the four headings, ask for a second person, a board lifter, a sack truck, or a
              re-plan. The strongest electrician on site is the one still on site at 55 — not the
              one who can dead-lift a consumer unit at 19.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re sent to swap a TP&N distribution board in a basement plant cupboard. You arrive
              — it’s a 45 kg board, the cupboard is barely shoulder-width, lighting is one
              fluorescent tube, and the floor’s damp from a recent leak. Your supervisor isn’t on
              site. Just you and a second-year.
            </>
          }
          whatToDo={
            <>
              Stop. TILE it on the spot. Task: high lift, twist, awkward access. Individual: two of
              you, one a second-year. Load: 45 kg, well over the indicative figure even for ideal
              conditions. Environment: wet floor, poor light, confined space. Phone the supervisor.
              Ask for a board lifter or strap kit, an extra body, a temporary task light, and the
              leak dealt with before you go in. Note the call.
            </>
          }
          whyItMatters={
            <>
              MHOR Reg 4 doesn’t ask whether you <em>could</em> do it. It asks whether the risk of
              injury has been reduced to as low as reasonably practicable. Cracking on without
              raising it puts you in breach of HASAWA s.7 as well — "the supervisor wasn’t here"
              doesn’t transfer the blame.
            </>
          }
        />
        ...
        >
          <p>
            Housekeeping looks like a soft topic until you read the prosecutions. The vast majority
            of slip/trip claims come down to a walkway someone didn’t clear, a spill someone didn’t
            mop, or a cable nobody routed properly. None of it needs equipment or training — just a
            habit of putting things away as you go.
          </p>
          <p>
            The crew habits that matter most: clear leads back to the reel at every break, sweep
            cuttings into a rubble bag at the end of each section of work, never leave a tool case
            open in a corridor, and any time you create a temporary hazard (lifted board, opened CU
            front, extension lead across a route), you own it until it’s safe.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Housekeeping is a section 7 duty for you personally. Leaving leads across a walkway is
              an "act". Walking past a spill without flagging it is an "omission". Both put you in
              scope of s.7 if someone goes over because of it — the boss having a tidy site policy
              doesn’t take that off you.
            </>
          }
        ...
        <ConceptBlock title="The kit that takes the strain off your back">
          <p>
            MHOR’s preferred fix for a heavy or awkward lift isn’t a stronger electrician — it’s a
            piece of kit. The common ones on electrical jobs:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sack truck / barrow.</strong> Cable drums, motors, switchgear, anything
              wheel-able down a corridor. Plates the load on its wheels instead of on your spine.
            </li>
            <li>
              <strong>Board lifter / panel jack.</strong> Specialist for distribution boards,
              especially commercial TP&N units. Lifts and holds the board on the wall while you fix
              it. Hire kit, not stocked in every van — but cheap to hire for the day.
            </li>
            <li>
              <strong>Cable drum stand and roller.</strong> Lets you pull cable off the drum without
              lifting the drum itself. Saves you and stops the cable kinking.
            </li>
            <li>
              <strong>Genie lift / pump-up lifter.</strong> For overhead trunking, cable tray,
              lighting bars. Replaces the "pass it up the stepladder" fight.
            </li>
            <li>
              <strong>Team-lift straps.</strong> When you can’t avoid two people lifting, straps
              share the load and force good posture (load close, back straight, knees doing the
              work).
            </li>
          </ul>
          <p>
            The boss’s job under MHOR Reg 4(1)(b)(ii) is to take "appropriate steps to reduce the
            risk of injury … to the lowest level reasonably practicable". If a £40 hire stops a
            £40,000 back-injury claim, the "reasonably practicable" call is obvious.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            When the lift can’t be avoided and the kit isn’t available, the technique still matters.
            The HSE method, in plain English:
          </p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Plan it.</strong> Where’s it going? Route clear? Place to set it down? Don’t
              pick anything up you haven’t already worked out where to set down.
            </li>
            <li>
              <strong>Stable base.</strong> Feet shoulder-width apart, one slightly forward for
              balance.
            </li>
            <li>
              <strong>Bend the knees, not the back.</strong> Squat to the load. Spine in its natural
              curve.
            </li>
            <li>
              <strong>Get a firm grip.</strong> Both hands. Test the weight by rocking it before
              committing.
            </li>
            <li>
              <strong>Lift smoothly.</strong> Drive up with the legs. Keep the load close to your
              trunk — the further out, the more force on your spine.
            </li>
            <li>
              <strong>Don’t twist.</strong> If you need to turn, move your feet. Twisting under load
              is what wrecks discs.
            </li>
            <li>
              <strong>Set down the same way.</strong> Knees, not back. Don’t drop the last few
              inches.
            </li>
          </ol>
        </ConceptBlock>
