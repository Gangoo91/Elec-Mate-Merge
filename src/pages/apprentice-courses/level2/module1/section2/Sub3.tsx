...
const TITLE = 'Fire hazards and explosive environments | Level 2 Module 1.2.3 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    question:
      'On an electrical fire, which leg of the fire triangle does the fault usually provide?',
    options: [
  ...
  },
  {
    ...
    question:
      'Where an RCD’s installed for ADDITIONAL fire protection, what’s the maximum residual operating current BS 7671 allows?',
  ...
  },
  {
    id: 'dsear-zone-check',
    question:
      'You’re going to wire some lighting in a small chemical store where solvent vapour might escape during normal operation. Which zone is that?',
...
const quizQuestions = [
  {
    ...
    options: ['Around 250', 'Around 25,000', 'Around 2,500', 'Around 250,000'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    id: 2,
    question:
      'Which Chapter of BS 7671 covers protection against thermal effects and fire from electrical equipment?',
    options: ['Chapter 43', 'Chapter 41', 'Chapter 42', 'Chapter 44'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 3,
    question:
      'A cable passes through a fire-rated wall. What does BS 7671 say about the hole afterwards?',
    options: [
  ...
  },
  {
    ...
    options: ['CO₂ (black)', 'Foam (cream)', 'Water (red)', 'Wet chemical (yellow)'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 7,
    question:
      'You’re cutting trunking with an angle grinder in a plant room. What’s the minimum the boss should put in place?',
    options: [
...
const faqs = [
  {
    question:
      'How does an electrical fault actually start a fire? Most cables don’t catch fire when they’re working.',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Why electrical work starts so many UK fires, how BS 7671 Chapter 42 stops them, and what
          DSEAR means the day you walk into a paint shop or a petrol forecourt.
        </p>
        ...
        >
          <p>
            ...
            electrical job, the building supplies the fuel (PVC sheath, timber joists, dust on top
            of the consumer unit, plasterboard paper) and the air supplies the oxygen. That leaves
            the heat — and that’s where electricity comes in.
          </p>
          <p>
            The heat comes from one of three places: a loose connection turning into a
            high-resistance joint, a cable carrying more current than its CSA can shed, or an arc —
            a flash of electricity jumping a gap. Any of those gets hot enough to ignite what’s
            around them if it goes on long enough.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            electricity or have an electrical product involved. People die in those fires — dozens
            of them every year — and many more end up in hospital with smoke inhalation.
          </p>
          <p>
            ...
            causes come up again and again, which is exactly why BS 7671 has a whole chapter on fire
            and why the City &amp; Guilds syllabus puts it front and centre.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The general fire duty. Protect <strong>people</strong>, <strong>animals</strong> and{' '}
              <strong>property</strong> from heat and fire generated by electricity OR propagated
              through it. Every other Chapter 42 reg flows from this one.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Wrong protective device.</strong> Bigger MCB fitted because "it kept
              tripping". Fault current now sails through the cable until something else gives.
            </li>
            <li>
              <strong>Water ingress.</strong> IP-rated kit fitted by someone who didn’t seal the
              gland properly. Tracking, corrosion, eventual fault. Outdoor sockets and bathroom fans
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              pass through escape routes, run in voids, or sit in bundles, the bar gets higher (CPR
              classes Cca-s1b,d1,a1 and BS 6387 fire-resistant categories like CWZ).
            </>
          }
        ...
        >
          ...
          <p>
            That covers two things: the cable itself (it needs to pass the right fire test for the
            location), and the surrounding gap (intumescent material that swells in heat and chokes
            off the hole). Both go into the test inspection schedule on the EIC. Get this wrong and
            the BCO will spot it on a building control sign-off.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Chapter 42 lets you use RCDs as additional fire protection. The catch: the rating can’t
            go above <strong>300 mA</strong>, and where the fault could be resistive (think overhead
            heating film, where a slow earth leakage just heats things up) it tightens to{' '}
            <strong>30 mA</strong>. The RCD must disconnect ALL live conductors when it trips.
          </p>
          <p>
            ...
            earth leakage that an MCB can’t see — exactly the kind of leakage that quietly chars a
            junction box for weeks before anyone notices.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            the current waveform and detect the high-frequency noise that comes off a series or
            parallel arc — exactly the kind of fault that an MCB sails past because the current’s
            still tiny.
          </p>
          <p>
        ...
        >
          <p>
            Reg 422.1.3 makes it a hard rule: a temperature cut-out used as a fire-protection device
            must be <strong>manual reset only</strong>. Same logic in 422.3.7 for motors — if the
            motor is automatically/remotely controlled or unsupervised, the over-temperature device
            that protects it has to be manual reset too.
          </p>
          <p>
            Why it matters: an auto-reset cut-out hides the underlying fault. A manual reset forces
            someone to walk over, look at it, find out why it tripped, and fix that before the kit
            comes back on. That’s the whole point.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            start. That permit will demand: combustibles cleared or covered (fire blankets), a named
            fire watcher who stays on for at least 30-60 minutes after work stops, an extinguisher
            within arm’s reach, and notification of the building’s fire systems team if there’s any
            chance of false-alarming the panel.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You’re second-fix on a refurb. The new socket position needs the back box trimmed with
              the angle grinder. Office is half-occupied, carpet tiles down, paperwork on desks two
              metres away.
            </>
          }
          whatToDo={
            <>
              Stop. Get a hot work permit raised before you strike a spark. Move the desks or cover
              them with a fire blanket. Ask the FM team to put the relevant smoke heads on test so
              you don’t trigger the alarm. CO₂ extinguisher next to you, not down the corridor. Fire
              watch stays on for at least 30 minutes after the last spark. Sign off the permit when
              you’re done.
            </>
          }
          whyItMatters={
            <>
              ...
              buildings have burned down hours after the electrician left because a cinder
              smouldered quietly in a void.
            </>
          }
        />
        ...
        >
          <p>
            The Dangerous Substances and Explosive Atmospheres Regulations 2002 came in to bring the
            UK into line with the European ATEX directives. They sit alongside HASAWA and the
          ...
          <p>
            ...
            procedures. As the electrician, you don’t classify zones — but you do have to read them
            and install kit that matches.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Zones rank an area by how often and for how long an explosive atmosphere is likely to be
            there:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              ...
              the dispensing hoses on a forecourt, the spray area of a paint booth, the area around
              a flour-handling machine.
            </li>
            <li>
          ...
          <p>
            Each zone needs equipment certified for use in it. A Zone 1 fitting will work in Zone 2;
            a Zone 2 fitting will NOT work in Zone 1. Always read up, never down.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You’re sent to fault-find on a small motor in the spray-paint mixing room. You walk in
              with your standard Fluke and a head torch. Both have switches and batteries that can
              spark. The room’s vapour level is borderline. One spark, one flash fire — and you’re
              in the middle of it.
            </>
          }
          doInstead={
        ...
        >
          <p>
            ...
            tackled by a different extinguisher type, and each extinguisher carries a coloured band
            so you can tell them apart at a glance:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Class A — solids</strong> (wood, paper, fabric, plastics). Use{' '}
              <strong>water (red band)</strong> or <strong>foam (cream)</strong>. Dry powder (blue)
              and wet chemical (yellow) also work on Class A.
            </li>
            <li>
            ...
            <li>
              ...
              <strong>wet chemical (yellow)</strong>. Never water on a chip-pan fire.
            </li>
            <li>
              <strong>"Electrical" — not a class, but a hazard overlay.</strong> Any fire with live
              equipment in it. Use <strong>CO₂ (black band)</strong> first choice — no conductive
              residue, smothers the fire, won’t damage kit. Dry powder works in emergency but it’s
              messy and ruins electronics.
            </li>
          </ul>
          <p className="text-orange-300">
            <strong>Never use water or foam on live electrical equipment.</strong> Both conduct, and
            the jet can put you straight into the circuit. Isolate the supply first, then CO₂ if you
            have to fight it.
          </p>
          <p>
