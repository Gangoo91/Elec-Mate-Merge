...
export default function Sub6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 2 · Subsection 6"
      ...
      <HubBody>
        ...
        >
          <p>
            The City &amp; Guilds 2365-02 syllabus puts asbestos in LO4 alongside the other hazards
          ...
          <p>
            AC 2.3 sits in LO2 because it's the broader principle. Asbestos is one trigger; live LV
