...
const TITLE = 'The Health and Safety at Work Act 1974 (HASAWA) | Level 2 Module 1.1.1 | Elec-Mate';
const DESCRIPTION =
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The big safety law. The one underneath every PPE rule, every RAMS, every lock-off you’ll
          meet on site. Worth ten minutes — it’s the bit that protects you when things go wrong.
        </p>
        ...
        <ConceptBlock title="It came out of one bad decade for British workers">
          <p>
            Before HASAWA, UK workplace safety law was a patchwork of trade-specific Acts going back
            to the Victorian era. By the early 1970s, around 1,000 people a year were dying at work
            and another half a million were getting injured. The Robens Report (1972) said it was
            time to scrap the patchwork and put one general duty on every employer.
          </p>
          <p>
        ...
        >
          <p>
            ...
            customer walking past. The detail (lock-off, cable sizes, RCDs) lives in other regs that
            hang off it.
          </p>
          <p>
            The Act applies to <em>every</em> workplace in the UK. Big construction site or a boiler
            swap in a flat — same Act, same duties, scaled to how risky the job is.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              <strong>"So far as is reasonably practicable"</strong> means the boss has to weigh the
              risk against the time, money and effort of fixing it. Bigger the risk → more they’ve
              got to do — even if it’s expensive.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>(d) Safe place of work</strong> — you shouldn’t have to dodge holes, fight a
              wonky ladder or climb over scaffold to get to the consumer unit.
            </li>
            <li>
              <strong>(e) Welfare</strong> — toilets, somewhere to eat, hot water, warm in winter.
              Not a perk. Not optional.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            On a typical job there’ll be other trades, the customer, deliveries, neighbours. Section
            3 says the boss can’t just look after their own crew and ignore the rest. Same applies
            to you when you’re a self-employed electrician on someone else’s site — you’re a
            duty-holder under s.3 too.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Don’t be the cause.</strong> Look after yourself. Watch out for the next mate
              too. Even what you DON’T do counts — leaving a tool on the stairs, walking past a
              missing trip switch, not flagging a hot wire.
            </li>
            <li>
              <strong>Get on with the system.</strong> RAMS, PPE, briefings, isolation procedures.
              If your boss puts it in place, you use it. Refusing to play ball is on you, not them.
            </li>
          </ol>
          <p>
            Section 8 adds a third bit: don’t intentionally mess with anything that’s there for
            safety. Removing a guard for speed, defeating an interlock, taking the lock off someone
            else’s lock-off — all s.8 breaches, all sackable.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Absolute duty vs reasonably practicable">
          <p>
            Most HASAWA duties are <strong>"reasonably practicable"</strong> — you balance the risk
            against the cost, time and trouble of preventing it. Bigger the risk → the more you have
            to do, even if it gets expensive.
          </p>
          <p>
            A few duties are <strong>absolute</strong> — they MUST be met, no excuses. EAWR 1989 Reg
            4 is the big one for electrical work: where danger may arise, no work shall be carried
            out on or near any live conductor unless it’s unreasonable for it to be dead AND it’s
            reasonable for the work to be carried out live AND suitable precautions are taken.
            That’s why "prove dead" is the rule, not the exception.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              like this, mate". He must know what he’s on about, right? You crack on. Something goes
              wrong. Now <em>you’re</em> personally on the hook under s.7 — apprentice card or not.
            </>
          }
          doInstead={
            <>
              From day one, you’re a duty-holder just like him. If a job feels wrong, stop. Say
              something. The law backs you for asking. It does NOT back you for cracking on because
              someone with more grey hair told you to.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Sent to swap a socket. The foreman tells you "it’s off, breaker’s flipped, crack on".
              No padlock on the breaker, no warning notice up, no test instrument anywhere in sight.
            </>
          }
          whatToDo={
            <>
              Don’t touch it. Ask for the lock-off and the prove-dead. Politely — they’re probably
              just rushing. If they push back, mention you’ve got a personal duty under s.7. If they
              STILL push, escalate above them. Note it down — date, time, who said what.
            </>
          }
          whyItMatters={
            <>
              Cracking on because someone told you to is not a defence in court. EAWR 1989 Reg 4
              says working dead is the default — and s.7 means it’s your call too, not just theirs.
            </>
          }
        />
        ...
        >
          <p>
            ...
            are made under it and apply just to electrical work. They put hard duties on everyone
            involved.
          </p>
          <p>
            <strong>BS 7671</strong> isn’t law itself. It’s the British Standard for electrical
            installations. But sticking to BS 7671 is generally accepted as proof that you’ve met
            EAWR — and through that, HASAWA. Deviate from BS 7671 and you’ll have to prove your way
            is just as safe. Easier to follow it.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              <strong>instructed</strong> and <strong>ordinary</strong>. As an apprentice you’re an{' '}
              <em>instructed person</em> — you can crack on with stuff once someone’s shown you, but
              anything that needs proper electrician judgement (sizing a circuit, deciding if
              something’s safe to energise) isn’t yours yet. Get a sign-off.
            </>
          }
        ...
        <ConceptBlock title="Real penalties, in real numbers">
          <p>
            HASAWA isn’t toothless. The HSE prosecutes hundreds of breaches a year. The Sentencing
            Council’s guidelines (since 2016) tie fines to company turnover and to how seriously the
            breach risked harm.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
            ...
            <li>
              <strong>For companies:</strong> fines have hit £15m+ for the worst cases. Average fine
              for serious breaches is now in the £100k+ bracket.
            </li>
          </ul>
          <p>
            And it’s not just bosses who get done. Workers and supervisors regularly get prosecuted
            under s.7 — if you knew it was unsafe and did it anyway, the supervisor’s "I told him
            to" defence won’t save you.
          </p>
        </ConceptBlock>
