...
const checks = [
  {
    ...
    question:
      "What is the 'Duty of Care' under section 34 of the Environmental Protection Act 1990?",
    options: [
  ...
  },
  {
    id: 'weee-check',
    question:
      'Your last job left you with a box of dead LED drivers and two old fluorescent fittings. Where do they legally go?',
    options: [
  ...
  },
  {
    ...
    question:
      'You pick up a tin of cable lubricant on site. The label has a black exclamation mark in a red diamond. What does that pictogram mean?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'Which Act is the parent piece of UK environmental legislation that sets the Duty of Care for waste?',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'Under WEEE 2013, who is responsible for the cost of recycling commercial electrical equipment at end of life?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'A fluorescent tube smashes in the back of your van. Why does that matter beyond the broken glass?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'You finish a job and drop the customer’s broken washing machine at a mate’s metal yard who isn’t licensed. What’s the legal risk?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Fines aren’t just for spills — your van’s full of WEEE. The EPA, the Hazardous Waste Regs,
          WEEE 2013, the nine GB CLP pictograms, and what to actually do with the box of dead
          fluorescent tubes after a strip-out.
        </p>
        ...
        <ConceptBlock title="Fines aren’t just for oil spills — your van’s a mobile waste site">
          ...
          <p>
            When the Environment Agency turns up at a fly-tipping site and finds three old consumer
            units in a layby, they don’t just trace the white van. They trace the boxes back to the
            wholesaler invoice, then back to the firm, then to the electrician who signed the job
            sheet. That’s the Duty of Care chain in action — and it ends with whoever dropped the
            ball, not whoever did the dumping.
          </p>
          <p>
            Same way HASAWA puts a personal duty on you (s.7), the EPA puts a personal duty on you
            for any waste you’ve handled. "I just put it in the van, the foreman dealt with it"
            isn’t a defence under s.34. You touched it, you’re in the chain.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The EPA is to environmental law what HASAWA is to safety law — the umbrella. It came in
            to clean up a patchwork of older Acts (Control of Pollution Act 1974, Public Health
            Acts) and put one general framework over the top.
          </p>
          <p>The bits that matter on site:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Section 33</strong> — offence to deposit, treat or dispose of controlled waste
              without an environmental permit. This is the fly-tipping offence. Unlimited fine, up
              to 5 years inside on indictment.
            </li>
            <li>
              <strong>Section 34</strong> — the Duty of Care. Anyone who imports, produces, carries,
              keeps, treats or disposes of waste has to take all reasonable steps to make sure it’s
              handled properly and only passed to an authorised person.
            </li>
            <li>
              <strong>Section 79</strong> — statutory nuisance (noise, smoke, fumes, dust).
              Electricians meet this when running gennies overnight or generating dust on a refurb.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Plain English: if you’ve touched the waste, you’re responsible for what happens to it
              next. You have to (a) stop it escaping, (b) only hand it to someone licensed, and (c)
              provide written paperwork describing what it is. That’s the basis of every waste
              transfer note and every hazardous waste consignment note you’ll ever sign.
            </>
          }
        ...
        >
          <p>
            ...
            Regulations in Scotland) define a long list of waste types as "hazardous" using the List
            of Wastes (LoW) codes. The ones an electrician meets regularly:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>16 06 01*</strong> — lead-acid batteries (vehicle batteries, larger UPS packs,
              some emergency lighting batteries).
            </li>
            <li>
              <strong>16 06 04 / 05</strong> — alkaline and other batteries (PP9, AAs from
              detectors). Not all are starred-hazardous, but treated as WEEE / batteries separately
              under the Batteries Regs 2009.
            </li>
            <li>
          ...
          <p>Two key procedural differences from non-hazardous waste:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Mixing is an offence.</strong> Putting hazardous waste in with general waste,
              or mixing two different hazardous wastes, is a separate offence under reg 19 — even if
              you eventually take it to a permitted site.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            "Producer Responsibility" — the person who first puts the kit on the UK market is on the
            hook for what happens at end of life.
          </p>
          <p>WEEE is split into 14 categories. The ones an electrician meets:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Category 5 (lighting equipment)</strong> — fluorescent fittings, LED fittings,
              control gear, drivers, transformers.
            </li>
            <li>
          ...
          <p>For an electrician, the practical impact:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              On commercial jobs, the WEEE waste stream is usually arranged separately by the main
              contractor — you’ll see the WEEE cage on site.
            </li>
            <li>
              Transfer notes still apply — a DCF will give you (or the firm) a receipt that doubles
              as the paperwork.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              playground. Foreman from another trade says "stick the lot in there, mate, easier that
              way".
            </>
          }
          whatToDo={
            <>
              Don’t. The tubes are hazardous waste (mercury, code 20 01 21*) AND WEEE (gas discharge
              lamps). They go in dedicated tube boxes — most wholesalers loan them out — kept
              upright, packed so they can’t break, and collected by a permitted carrier with a
              hazardous waste consignment note. The fittings themselves are WEEE Category 5 —
              separate cage on site, transfer note from the WEEE recycler. Two waste streams, two
              pieces of paperwork.
            </>
          }
          whyItMatters={
            <>
              ...
              low-thousands per breach and can go to unlimited on indictment. Plus the school will
              fail their environmental audit and your firm won’t be back next year.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              cuts a sorter on the conveyor, mercury exposure gets logged. RIDDOR notification kicks
              in, the Environment Agency follows the trail back through the transfer note, two
              breaches stack: EPA s.34 (Duty of Care, mixed waste streams) plus Hazardous Waste Regs
              reg 19 (mixing). Fixed penalty around £300 minimum, easily £5k+ if it goes formal.
            </>
          }
          doInstead={
            <>
              Tubes go in the tube box, full stop. If the box isn’t there, leave the tubes somewhere
              safe (upright, taped together, out of traffic) until it is. Five minutes of
              inconvenience beats a Duty of Care prosecution and an injured worker.
            </>
          }
        />
        ...
        >
          <p>
            ...
            projects over £300k in England. They were revoked in 2013 as part of a deregulation push
            — but practically, they didn’t go anywhere because:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            ...
            you’re not sure which skip something goes in. Wrong skip = SWMP breach = the firm gets
            pulled up at the next site walk.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Copper prices move with global markets but clean copper has been worth roughly £4–£7/kg
            over the last few years. A busy commercial electrician generates several kilos a week.
            That adds up.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Clean copper</strong> (stripped, no sleeve, no tinning) — best price, straight
              to the metal merchant.
            </li>
            <li>
          ...
          <p>
            ...
            It’s illegal under the Environmental Permitting Regs (uncontrolled combustion of waste)
            AND the Clean Air Act AND it releases dioxins, which are very persistent carcinogens.
            Mechanical strippers exist, or send mixed cable to a licensed cable recycler who runs it
        ...
        >
          <p>
            ...
            amount, but mercury bioaccumulates and is toxic to the nervous system. Multiply by the
            200 tubes from a school strip-out and you’re moving a regulated quantity.
          </p>
          <p>
            <strong>Whole tubes (the normal case):</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Stored upright in a dedicated tube box (most wholesalers loan them).</li>
            <li>Box labelled "Hazardous Waste" with the LoW code 20 01 21*.</li>
            <li>Collected by a permitted hazardous waste carrier with a consignment note.</li>
          </ul>
          <p>
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-orange-400/70">
            <li>
              <strong>Ventilate the area</strong> — open doors and windows, leave for at least 10–15
              minutes.
            </li>
            <li>
              <strong>Don’t hoover.</strong> A hoover spreads mercury vapour through its exhaust and
            ...
            <li>Wear nitrile gloves. Skin contact with mercury is bad news.</li>
            <li>
              Double-bag the lot in a sealed plastic bag, label it, treat it as hazardous waste.
            </li>
            <li>Ventilate the room for several hours afterwards if you can.</li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            Producers fund the recycling through compliance schemes. Disposal routes differ by type.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>AAs, PP3, button cells</strong> — battery drop-off bin at any retailer selling
              more than 32kg of batteries a year (most supermarkets, builders' merchants,
              wholesalers).
            </li>
            <li>
              <strong>Lithium drill packs / power tool batteries</strong> — return to retailer under
              their producer compliance, OR a permitted WEEE site that handles lithium. NEVER in
              general waste — fire risk in compactors.
            </li>
            <li>
            ...
            <li>
              <strong>Smoke-alarm batteries (PP3 lithium long-life)</strong> — battery drop-off if
              removed; some have a sealed 10-year battery integrated, in which case the whole alarm
              goes WEEE.
            </li>
          </ul>
          <p>
            Lithium fires in waste vehicles are a growing problem nationally — one bin lorry fire
            from a single damaged drill pack can write off a £200k vehicle. That’s why the
        ...
        >
          <p>
            Under GB CLP (which mirrors the EU CLP Regulation 1272/2008 — kept post-Brexit), every
            hazardous substance sold in Great Britain has to carry the appropriate pictogram(s) plus
            a signal word ("Warning" or "Danger"), hazard statements (H-codes) and precautionary
            statements (P-codes). The nine pictograms:
          </p>
          <ul className="space-y-2 list-none pl-0">
            ...
            <li>
              ...
              oxygen and intensify fire. Less common on site but you’ll meet it on some industrial
            ...
            <li>
              <strong>6. Skull and crossbones (GHS06) — Acute toxic.</strong> Life-threatening even
              at small doses (oral, dermal, inhalation). Less common on an electrician’s tools but
            ...
            <li>
              <strong>8. Health hazard (GHS08) — Serious health hazard.</strong> Outline of a person
              with a starburst over the chest. Carcinogens, mutagens, reproductive toxicity, target
              organ toxicity (liver, kidney), respiratory sensitisers (asthma). Some old paint
              solvents and degreasers carry this.
            </li>
            <li>
              <strong>9. Environment (GHS09) — Hazardous to the environment.</strong> Dead tree and
              dead fish. Aquatic toxicity. Some lubricants and surface coatings. Means: don’t let it
              reach drains or watercourses.
            </li>
          </ul>
          <p>
            ...
            <strong>P-statements</strong> (Precautionary) on the label. Your COSHH risk assessment
            for a substance is built straight off this label data.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              signal word + H-statements + P-statements + supplier details. That label IS your first
              risk assessment for the substance. Read it before you crack the seal.{' '}
        ...
        <ConceptBlock title="EPA → Hazardous Waste Regs / WEEE / Batteries → SWMP → your skip choice">
          <p>
            ...
            Duty of Care (s.34) and the disposal offences (s.33). Under it sit the specific-stream
            regs: <strong>Hazardous Waste Regs 2005</strong>, <strong>WEEE Regs 2013</strong>,{' '}
            <strong>Waste Batteries Regs 2009</strong>,{' '}
            <strong>Packaging (Essential Requirements) Regs 2015</strong>. The{' '}
            <strong>Site Waste Management Plan</strong> on a commercial job is how all of those get
            implemented in one place — colour-coded skips, named carriers, target percentages. Your
            bit, on site, is the segregation at the point of generation.
          </p>
          <p>
            And <strong>GB CLP</strong> sits across the top of all of it on the substance side — the
            labels on every can and tube tell you what kind of waste it’ll be at end of life, what
            kind of PPE you need now, and what kind of paperwork has to go with it when it leaves
            site.
          </p>
        </ConceptBlock>
