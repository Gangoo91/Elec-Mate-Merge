...
const checks = [
  {
    ...
    options: [
      ...
      'Report every workplace accident to the HSE',
      'Provide all PPE free of charge to employees',
      'Inspect all work equipment before each shift',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Issue everyone an FFP3 dust mask before work starts',
      'Put up a warning sign and brief the team on the risk',
      'Fit local exhaust ventilation to extract the dust or fume',
  ...
  },
  {
    ...
    options: [
      'No — you weren’t off work for more than 7 days afterwards',
      'No — RIDDOR only covers fatalities and amputations',
      'Only if the circuit caused a fire as well as the shock',
...
const quizQuestions = [
  {
    ...
    options: [
      'An annual PAT test of every portable tool on site',
      'A suitable and sufficient risk assessment of work activities',
      'A report to the HSE before any electrical work begins',
      'A full insulation-resistance test of every circuit',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A drill that keeps nuisance-tripping the RCD on site',
      'A near-miss where nobody was hurt and no fire occurred',
      'An electric shock that puts you in hospital with a serious burn',
      'A minor cut that needs a plaster from the first-aid kit',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The hazardous substances you breathe in while chasing brick',
      'The reporting of any over-7-day injury to the HSE',
      'The risk assessment you must do before every work activity',
  ...
  },
  {
    ...
    options: [
      'You — but the employer reimburses half the cost',
      'The main contractor running the site, not your employer',
      'Whoever issued the job sheet for that particular task',
  ...
  },
  {
    id: 8,
    question:
      'Under CDM 2015, who is the duty-holder responsible for managing the construction phase?',
    options: ['The principal contractor', 'The apprentice', 'The client', 'The principal designer'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Yeah, it’s a soup of acronyms. Stick with me — you only need to know what each one COVERS,
          not chapter and verse. Each of these tackles a specific risk that HASAWA on its own
          doesn’t get into.
        </p>
        ...
        <ConceptBlock title="HASAWA is the umbrella. These are the spokes.">
          <p>
            ...
            site with twelve trades on it. So Parliament added a stack of more specific regulations{' '}
            <em>under</em> HASAWA — each one tackling a particular risk.
          </p>
          <p>
          ...
          <p>
            You’re not expected to recite them. You ARE expected to know what each one is about, so
            when your supervisor says "this is a COSHH job" or "have we got a working-at-height
        ...
        >
          <p>
            MHSWR is the management framework that sits between HASAWA and everything else. The big
            duties:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 3 — Risk assessment.</strong> Every work activity. Has to be "suitable and
              sufficient". If you’ve got 5+ employees, the significant findings have to be recorded.
            </li>
            <li>
            ...
            <li>
              <strong>Reg 5 — Health and safety arrangements.</strong> Have a system. Plan,
              organise, control, monitor and review.
            </li>
            <li>
            ...
            <li>
              <strong>Reg 10 — Information for employees.</strong> You have to be told the risks and
              the controls. Site induction = this in action.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Big sentence. Boils down to:{' '}
              <strong>
                risk assess everything you do, for everyone affected — your crew AND the public
              </strong>
              . The assessment has to be "suitable and sufficient" — not perfect, not exhaustive,
              but sensible and proportionate. With 5+ employees it has to be in writing. That
              writing turns into the RAMS your foreman hands you on the first day.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Over-7-day injuries</strong> — if a work-related injury keeps you off normal
              duties for more than 7 days (not counting the day of the accident). Reported within 15
              days.
            </li>
            <li>
          ...
          <p>
            For us as electricians, the big ones to remember:{' '}
            <strong>
              any electric shock injury that needs treatment is almost always reportable
            </strong>
            , and so is any short circuit that causes a fire. If you’ve taken a belt, even one that
            left you "fine", tell someone. Cardiac issues can show up hours later, which is exactly
            why RIDDOR takes shocks seriously.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              One person — the "responsible person" (usually the employer) — has to make the report.
              You don’t do it yourself, but you DO have to flag the incident the same day. Reporting
              timescales:{' '}
              <strong>fatal/specified injuries — without delay then within 10 days</strong>,{' '}
              <strong>over-7-day injuries — within 15 days</strong>. Records kept for 3 years
              minimum.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Suitable</strong> for the actual job and the conditions you’re using it in. A
              110V drill on a building site, not a domestic 230V lump on a wet sub-floor.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Four things:{' '}
              <strong>suitable, safe, used by trained people, with safety features fitted</strong>.
              That’s PUWER in a sentence. If your drill is knackered, you haven’t been shown how,
              the guard’s missing, or it isn’t right for the environment — that’s a PUWER breach.
              Stop, swap it out, flag it.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              Long-term exposure causes silicosis. Use on-tool extraction, water suppression, and an
              FFP3 mask if you must.
            </li>
            <li>
              <strong>Solder fumes</strong> from terminations and joint work. Rosin-based fluxes can
              cause occupational asthma. Ventilation and fume extraction.
            </li>
            <li>
          ...
          <p>
            Every hazardous substance comes with a <strong>Safety Data Sheet (SDS)</strong> from the
            manufacturer. The boss has to make these available; you should know how to read one when
            you need to.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You’re chasing brick all day for back boxes — no extraction, no water suppression, a
              basic dust mask from the van. Two weeks of that on a refurb. Long term, that’s a
        ...
        <Scenario
          ...
          situation={
            <>
              Pre-2000 commercial unit. You’re popping a hole through a partition for a cable run.
              The board crumbles unusually. White-grey, fibrous, slightly chalky. The dust is
              everywhere.
            </>
          }
          whatToDo={
            <>
              ...
              check the asbestos register and get a survey done. If you’ve inhaled significant dust,
              that’s a doctor visit AND a near-miss report. Could become a RIDDOR
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              guardrails, scissor lift, scaffold tower assembled by a trained person. Last choice: a
              ladder, and only for short-duration light work.
            </li>
            <li>
          ...
          <p>
            ...
            Ladder rules: secured top and/or bottom, good footing, proper angle (1-out, 4-up), three
            points of contact, no overreaching, no work above head height for sustained periods.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The regs follow the same avoid-assess-reduce model. First:{' '}
            <strong>avoid the lift if you can</strong> — get it delivered closer, use a sack truck,
            pallet truck, hoist or two people. Then assess what you can’t avoid using{' '}
            <strong>TILE</strong>:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Task</strong> — what’s the lift? Carry, twist, low to high, sustained holding?
            </li>
            <li>
            ...
            <li>
              <strong>Environment</strong> — where? Stairs, ladders, narrow corridors, rough ground,
              tight space?
            </li>
          </ul>
          <p>
            Then reduce the risk that’s left — handling aids, splitting the load, two-person lifts,
            training. Manual handling causes{' '}
            <strong>more than one in four reportable injuries</strong> on site, and most of them are
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              gloves for stripping armour. Voltage-rated gloves for live work. FFP3 for silica dust.
              Class 1/2 helmet for working at height. Tested to the relevant standard.
            </li>
            <li>
            ...
            <li>
              <strong>Training</strong> — you should know when to wear it, how to put it on, and how
              to maintain it.
            </li>
            <li>
          ...
          <p>
            The 2022 update extended the regs to "limb (b)" workers — basically casuals, freelancers
            and gig-economy workers. If you’re effectively under someone’s control on site, PPE
            rules apply.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              people. For private domestic clients, the contractor takes on the client’s CDM duties.
            </li>
            <li>
              <strong>Principal designer</strong> — coordinates pre-construction safety: identifying
              hazards in the design before site work starts, producing the pre-construction info
              pack.
            </li>
            <li>
          ...
          <p>
            CDM kicks in for projects with more than one contractor, or that last more than 30 days
            with 20+ workers at any peak point, or 500+ person-days total. Bigger jobs need a
            "health and safety file" produced and handed over to the client at the end — the ongoing
            record of what’s there and what to watch out for in future maintenance.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="DSEAR and DSE — the niche ones">
          <p>
            ...
            flammable and explosive substances — petrol, LPG, paint solvents, dust clouds, hydrogen
            from battery rooms. Sets minimum standards to control fire and explosion risks. Most
            apprentices won’t see DSEAR work directly, but you might bump into it on petrol
            stations, biomass plants, big battery rooms or industrial sites with stored flammables.
            There’ll usually be an EX-rated zone and special intrinsically-safe equipment
            requirements.
          </p>
          <p>
            <strong>DSE 1992 (Display Screen Equipment)</strong> covers anyone who uses a screen for
            a significant chunk of the day — workstation assessments, eye tests, breaks. As an
            apprentice on site you won’t deal with this much. As a designer or estimator later in
        ...
        >
          ...
          <p>
            ...
            duty. That’s the map. The RAMS for the actual job pulls all of it into one set of steps
            you can follow.
          </p>
        </ConceptBlock>
