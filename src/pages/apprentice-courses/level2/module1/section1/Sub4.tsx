...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['The IET and BSI jointly', 'NICEIC', 'The HSE', 'The government'],
    correctAnswer: 0,
    explanation:
...
const faqs = [
  ...
  {
    question:
      "My boss says I have to do a job in a bathroom but the firm isn't Part P registered. What happens?",
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          HSE, NICEIC, NAPIT, JIB, IET, ECA, BSI. If alphabet soup is the vibe so far, you’re not
          wrong. Just need the basics — what each does, who to call when. Ten minutes here saves a
        ...
        <ConceptBlock title="The state can’t supervise every workplace — so the job’s split">
          <p>
            ...
            regulator doing the lot, the work’s been split between a stack of bodies — each one with
            a specific job.
          </p>
          <p>
            <strong>Enforcement</strong> sits with the HSE (and your local authority).{' '}
            <strong>Competent person schemes</strong> (NICEIC, NAPIT, ELECSA) handle Part P sign-off
            in domestic. <strong>Employment standards</strong> — pay, holidays, grading — sit with
            the JIB. <strong>Professional standards</strong> for engineers sit with the IET.{' '}
            <strong>Trade representation</strong> sits with the ECA.{' '}
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Issue a Prohibition Notice</strong> — stop this work right now until it’s made
              safe. Goes up immediately, no appeal needed first.
            </li>
            <li>
            ...
            <li>
              <strong>Charge fees for intervention</strong> — if they find a serious breach, you pay
              for the time their inspector spent on you.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              deals with them — but you cooperate, you tell the truth, and you don’t move anything
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HSE covers:</strong> construction sites, factories, agriculture, engineering,
              mines and quarries, nuclear, offshore, hospitals, schools (in some cases).
            </li>
            <li>
              <strong>LA covers:</strong> shops, offices, hotels, restaurants, pubs, leisure, care
              homes, residential.
            </li>
          </ul>
          <p>
            In practice it’s the council’s <strong>Environmental Health Officers</strong> (EHOs) who
            turn up. Same powers as HSE inspectors — improvement and prohibition notices,
            prosecution, the lot. Just badged differently.
          </p>
          <p>
            The split also matters for <strong>RIDDOR</strong> (the injury reporting reg). A serious
            shock in a factory? HSE. Same shock in a Tesco? Local Authority. Same form, different
            inbox.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            These are <strong>Competent Person Schemes</strong> (CPS). They were set up after Part P
            came into force in 2005 to give electricians a route to self-certify their own
            notifiable domestic work — without that, every consumer unit swap or bathroom job would
            need a separate Building Control notification.
          </p>
          <p>The big four for electrical work in England:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>NICEIC</strong> — the biggest. Owned by Certsure. Their "Approved Contractor"
              and "Domestic Installer" schemes are the ones you’ll see most often.
            </li>
            <li>
              <strong>NAPIT</strong> — the other big one. Same job, slightly different paperwork,
              often a bit cheaper.
            </li>
            <li>
          ...
          <p>
            All four are government-approved. All four require an annual assessment (an assessor
            visits, picks a recent job, audits your paperwork and tests). All four come with
            insurance-backed warranties for the customer (typically 6 years).
          </p>
          <p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You finish your apprenticeship and tell people you’re "NICEIC qualified" or "NICEIC
              certified". Customer rings round for a quote, asks for proof of your personal NICEIC
              card. You haven’t got one — because that’s not how it works. Awkward.
            </>
          }
          doInstead={
            <>
              NICEIC (and NAPIT, ELECSA, STROMA) certify <em>firms</em>, not individuals. Your
              qualifications are your <strong>NVQ Level 3 + AM2 + 18th Edition</strong>. The firm’s
              CPS registration is what lets the firm self-cert Part P work. If you go self-employed
              and want to do domestic, <em>you</em> apply to a scheme as a sole trader.
            </>
          }
        />
        ...
        >
          ...
          <p>Part P splits work into two buckets:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Non-notifiable</strong> — minor work like adding a socket to an existing
              circuit, replacing a like-for-like accessory. Still has to comply with BS 7671 and you
              still need a Minor Works Certificate, but you don’t have to tell anyone.
            </li>
            <li>
              <strong>Notifiable</strong> — installing a new circuit, replacing a consumer unit, or
              doing any work in a "special location" (bathrooms, swimming pools, saunas). Must be
              either signed off by a CPS-registered firm OR notified to Building Control before
              starting.
            </li>
          </ul>
          <p>
            Scotland uses Building Standards (Section 4); Wales has its own Approved Document P
            (similar to England’s); Northern Ireland uses Building Regs Part F (Technical Booklet).
            Same idea, slightly different paperwork.
          </p>
          <p>
            Doing notifiable work without notification — and then trying to sell the house — is
            where this catches people. The buyer’s solicitor asks for the cert, there isn’t one, the
            seller has to pay for a retrospective Building Control inspection (or hire a third-party
            certifier). Don’t be the electrician who put them in that mess.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You’re handed a job sheet: install a shaver socket in a domestic bathroom. Customer’s
              nice, job’s a couple of hours. Then you remember the firm dropped its NICEIC
              registration last year to save money. There’s no Building Control notice logged
              either.
            </>
          }
          whatToDo={
            <>
              ...
              start (council does the inspection at the end), or bring in a third-party certifier
              (an organisation like Stroma’s "third-party certifier" route). Skipping both is the
              firm committing an offence under Building Regs — and you’re the one holding the
              screwdriver.
            </>
          }
          whyItMatters={
            <>
              Bathrooms are a "special location" under Approved Document P, so this is notifiable.
              If something goes wrong years later — fire, shock, sale falls through because there’s
              no cert — the trail comes back to who did the work. "Boss told me to" doesn’t help
              under HASAWA s.7 either.
            </>
          }
        />
        ...
        >
          <p>
            The Joint Industry Board for the Electrical Contracting Industry (the JIB) is a joint
            body run by the ECA (employers' side) and Unite (union side). Covers England, Wales and
            Northern Ireland. Scotland has its own equivalent — the SJIB.
          </p>
          <p>What the JIB actually does:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sets national pay rates</strong> by grade — apprentice (year 1, 2, 3, 4 as a %
              of qualified rate), Electrician, Approved Electrician, Technician.
            </li>
            <li>
          ...
          <p>
            Not every firm follows JIB rates — small firms often set their own. But the JIB rate is
            the industry benchmark, and if you ever end up on a unionised site or a big-contractor
            framework, JIB rates are usually the floor.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ECS is the UK’s national skills card for the electrical industry. To get one you need:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            ECS is part of the <strong>CSCS</strong> family of construction site cards (the umbrella
            scheme for all trades). Most main contractors won’t let any trade on site without a
            valid card, full stop.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>It publishes BS 7671</strong> jointly with BSI — the actual book on the shelf
              is an IET publication. Same with the IET Guidance Notes (GN1–GN8), the On-Site Guide,
              and the IET Wiring Matters magazine.
            </li>
            <li>
              <strong>It runs the professional registration routes</strong> — Eng Tech (Engineering
              Technician), IEng (Incorporated Engineer), CEng (Chartered Engineer). These are
              letters after your name, recognised internationally.
            </li>
            <li>
              <strong>Apprentice and Student membership is cheap</strong> (sometimes free through
              your college) — gets you online access to BS 7671, the technical helpline, CPD events.
            </li>
          </ul>
          <p>
            The IET is a <em>professional body</em>. Joining doesn’t qualify you to do anything.
            It’s about professional development, networking, and the recognition that comes with
            letters after your name later in your career.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Trade body recognition</strong> — the ECA logo carries weight with clients,
              and ECA-vetted firms appear on procurement lists.
            </li>
            <li>
              <strong>Insurance-backed guarantees</strong> for customers (similar in concept to CPS
              warranties, but offered as a trade-body benefit).
            </li>
            <li>
              <strong>Technical, legal and HR helplines</strong> for member firms.
            </li>
            <li>
              <strong>A voice in industry policy</strong> — the ECA lobbies government on things
              like skills shortages, Part P, and the next BS 7671 amendment.
            </li>
          </ul>
          <p>
            ECA membership is NOT a substitute for NICEIC/NAPIT registration — different things. A
            firm can be in the ECA and not in any CPS, or vice versa, or both, or neither. They
        ...
        >
          <p>
            BSI publishes British Standards on everything from biscuits to electrical installations.
            For electricians the big one is{' '}
            <strong>BS 7671 — Requirements for Electrical Installations</strong> — published jointly
            by BSI and the IET.
          </p>
          <p>A British Standard isn’t automatically law. But:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Many regs (like EAWR) reference standards as the way to comply.</li>
            <li>
              Courts treat following the relevant British Standard as strong evidence you’ve done
              what’s reasonably practicable.
            </li>
            <li>Insurance and certification schemes assume you’re working to the standard.</li>
          </ul>
          <p>
            Other BSIs you’ll meet on site: BS 5839 (fire alarm systems), BS 5266 (emergency
            lighting), BS EN 60898 (MCBs), BS EN 61008/61009 (RCDs/RCBOs). All published by BSI.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="The 'who do I call?' matrix">
          <p>Boil it down to the moment you actually need each one:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-emerald-400/70">
            ...
            <li>
              <strong>Got electrocuted in a Tesco</strong> → Local Authority Environmental Health
              (still RIDDOR, different inbox).
            </li>
            <li>
              <strong>Want to sign off your own consumer unit swap in a house</strong> → NICEIC,
              NAPIT, ELECSA or STROMA (CPS).
            </li>
            <li>
              <strong>Doing notifiable work but firm isn’t in a CPS</strong> → Building Control at
              the local council, before you start.
            </li>
            <li>
            ...
            <li>
              <strong>Need a card to walk through the gate on a commercial site</strong> → ECS
              (issued by JIB), with the H&S assessment up to date.
            </li>
            <li>
              <strong>
                Want to be a member of a professional body / get letters after your name
              </strong>{' '}
            ...
            <li>
              <strong>Need to look up a British Standard</strong> → BSI publishes them; IET members
              get BS 7671 included online.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              grading exist. Each one is the industry’s answer to this reg, for a different slice of
              the work.
            </>
          }
