...
const TITLE = 'The Electricity at Work Regulations 1989 (EAWR) | Level 2 Module 1.1.2 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Reg 12', 'Reg 13', 'Reg 16', 'Reg 4'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    id: 7,
    question:
      "You’re sent to swap a faulty socket. The lead electrician says 'breaker’s off, crack on'. No padlock, no tester out. What do you do?",
    options: [
  ...
  },
  {
    id: 8,
    question:
      "What’s the difference between an 'absolute' duty and a 'reasonably practicable' one in EAWR?",
    options: [
...
const faqs = [
  ...
  {
    question:
      "I’ve heard 'absolute' and 'reasonably practicable' used about EAWR — what’s the deal?",
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The electrical version of HASAWA. It’s the reg behind every prove-dead, every lock-off,
          every 'no, isolate it first' you’ll hear on site. Learn it once — it’s on you for the rest
          of your career.
        </p>
        ...
        <ConceptBlock title="HASAWA covers everything. EAWR covers electricity.">
          ...
          <p>
            ...
            <strong>1 April 1990</strong> and they’ve barely been touched since — because they still
            work. Almost every electrical safety prosecution in the UK is brought under EAWR, not
            HASAWA.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              bits within YOUR control: doing what you’ve been shown to do, properly, and not doing
              what you haven’t.
            </>
          }
        ...
        >
          <p>
            Most of HASAWA is "so far as is reasonably practicable" — you balance risk against cost,
            time and trouble. EAWR is harder. Some of its regs are <strong>absolute</strong>: they
            have to be met, full stop, no balancing.
          </p>
          <p>
            ...
            maintained to prevent danger). <strong>Regs 5, 7 and 8</strong> (strength and capability
            of equipment, insulation, and earthing or other suitable precautions) are also absolute.
            Most of the others — including Reg 4(3), Reg 4(4) and Regs 12–16 — are qualified by "so
        ...
        >
          <p>
            If you only remember one regulation in EAWR, make it Reg 4. It’s split into four bits:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>4(1) — Construction (absolute):</strong> any system at work has to be built so
              as to prevent danger. That covers your installation, your CU, your tails, the lot.
            </li>
            <li>
              <strong>4(2) — Maintenance (absolute):</strong> the system has to be maintained so as
              to prevent danger. PAT testing, EICRs and routine checks all sit under this.
            </li>
            <li>
              <strong>4(3) — Work activities (reasonably practicable):</strong> any work activity —
              including work near a system — has to be carried out in a way that doesn’t give rise
              to danger, so far as is reasonably practicable. This is where safe isolation and
              dead-working sit.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              <strong>"At all times"</strong> is the bit that bites — there’s no excuse for "it was
              safe last week". And the duty is on the person doing the work too, not just the
              designer.
            </>
          }
        ...
        >
          <p>
            Reg 13 is short but mighty. Once you’ve isolated something to work on it, the reg says
            you have to take "adequate precautions" to stop it being made live again — by accident,
            by someone else, by anything — while the work’s going on.
          </p>
          <p>In practice, "adequate precautions" means the standard safe isolation kit:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lockable isolator</strong> — physically prevent reset.
            </li>
            <li>
              <strong>Padlock + key on you</strong> — your lock, your work, your key. Don’t leave it
              in.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              Functional switch isn’t enough. A breaker someone could flip back on isn’t enough. You
              need a lockable means of isolation, controlled by you, with a label and a prove-dead
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>It’s unreasonable for the conductor to be dead</strong> — eg you’re testing or
              fault-finding and you actually need it live to see what’s happening.
            </li>
            <li>
          ...
          <p>
            "It would take longer to isolate", "the customer doesn’t want power off", "it’s just a
            quick one" — none of those tick test (1) or (2). Live work that gets prosecuted is
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Three tests. <strong>All three</strong>. As an apprentice you’ll almost never be in a
              position where (b) is satisfied for you specifically — your competence isn’t there
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Skilled person</strong> — has the technical knowledge AND experience to avoid
              danger. Time-served electrician with the right tickets and the right hours.
            </li>
            <li>
            ...
            <li>
              <strong>Ordinary person</strong> — the customer, the joiner on site, anyone who’s not
              in either of the above. Should not be doing electrical work, full stop.
            </li>
          </ul>
          <p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Quick socket swap. The lead electrician flicks the breaker, says "right, off you go".
              No lock, no label, no prove-dead. You crack on. Halfway through, another electrician
              in the cupboard sees the breaker tripped and helpfully resets it. You’re now holding
              live conductors.
            </>
          }
          doInstead={
            <>
              Reg 13 says the equipment has to <em>stay</em> dead while you work on it. That means a
              lockable isolator, your padlock, your key on YOU, a warning label, and a prove-dead at
              the point of work with a GS38 voltage indicator (proved on a known source before AND
              after). Every. Single. Time. No exceptions for "small jobs".
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              legal under Reg 14 — but only for someone competent for that work, with the right kit,
              with a documented justification. It’s not legal for you yet, regardless of who tells
              you to crack on. Your job here is to learn, not to reach in.
            </>
          }
          whyItMatters={
            <>
              Reg 14’s three tests have to be satisfied <em>for the person doing the work</em>. You
              being supervised is great, but it doesn’t transfer his competence onto you for live
              working specifically. And Reg 16 means if it goes wrong while you’ve got the probe in
              your hand, the "I told him to" defence won’t save the supervisor or you.
            </>
          }
        />
        ...
        >
          <p>
            EAWR is the legal duty. <strong>BS 7671</strong> is the British Standard that tells you
            the technical "how" — cable sizes, protective devices, earthing, testing schedules. BS
            7671 isn’t law on its own, but the HSE explicitly accepts that following BS 7671 is
            generally accepted as one way of meeting EAWR.
          </p>
          <p>
        ...
        <ConceptBlock title="EAWR has teeth">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
            <li>
              <strong>Magistrates' court:</strong> unlimited fine and/or up to 6 months in prison.
            </li>
            <li>
          ...
          <p>
            ...
            around <strong>30 of those are fatal</strong>. Most of the fatal ones come from contact
            with live conductors during work that should have been done dead. Reg 14 and Reg 13
            exist because of those numbers, not in spite of them.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">HASAWA 1974</div>
          </button>
          <button
