...
const checks = [
  {
    ...
    question:
      'A circuit is correctly switched off and locked off, but the conductor is still live. What is the most likely cause?',
    options: [
  ...
  },
  {
    ...
    question:
      'You discover a circuit you’d locked off was actually still live (PV backfeed). Nobody got hurt. What do you do?',
    options: [
  ...
  },
  {
    ...
    question:
      'You arrive on Monday and find a lock-off and tag from an electrician who didn’t come back on Friday. The site needs the circuit back on. What’s the right process?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 4,
    question:
      'You proved dead at Step 5 but skipped re-proving on the proving unit afterwards. What might have happened?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'The customer turned the main switch back on while you were eating lunch. What does that tell you about the isolation?',
    options: [
...
const faqs = [
  {
    question:
      'What if I pushed back on a corner-cut and the supervisor threatened my apprenticeship?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The failure modes that show up over and over in HSE prosecutions: backfeeds, the
          locked-off-but-live trap, mis-labelled breakers, ‘quick look’ working, single-pole
          isolation of three-phase. Knowing them is half the defence.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
            <li>
              <strong>PV inverter</strong> feeding the AC bus while the panels see daylight. You
              isolated the DNO main switch — the inverter is still pushing.
            </li>
            <li>
              <strong>UPS-fed circuit</strong> staying live for the duration of the battery (5-30
              minutes is common, sometimes hours). You took the DB off — the UPS is holding the
              essential bus up.
            </li>
            <li>
              <strong>Generator on auto-start.</strong> Mains failure (which is what your isolation
              looks like to the system) triggers the genset. Bus is back live a few seconds after
              you ‘isolated’.
            </li>
            <li>
              <strong>Borrowed neutral</strong> from another circuit. The neutral you proved dead
              L-N is actually carrying line voltage from the next ring downstairs. Catches you on
              N-E if you tested it; on the conductor if you didn’t.
            </li>
            <li>
              <strong>Dual-incomer board</strong> with the other incomer still live. You isolated
              incomer A, the bus tie is closed, incomer B is still feeding the board.
            </li>
            <li>
            ...
            <li>
              <strong>Capacitor banks</strong> (motor PFC, large industrial loads) — can hold a
              charge for tens of seconds after the supply is off, sometimes longer if discharge
              resistors have failed.
            </li>
          </ul>
          <p>
            ...
            responsible person, look for warning labels at the CU (modern domestic PV installs get
            ‘DUAL SUPPLY’ stickers for exactly this reason).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Each source = its own isolation. ‘Single isolation when other sources are present’ is
              one of HSG85’s explicit warnings — it’s the most common contributing factor in
              ‘locked-off but live’ incidents the HSE investigates.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
            ...
            <li>
              <strong>Proved on the meter, then didn’t re-prove.</strong> Indicator failed silently
              between Step 4 and Step 6. ‘Dead’ reading was actually ‘can’t read anything’.
            </li>
            <li>
              <strong>Single-pole isolated a three-phase circuit.</strong> Switched off one phase,
              treated the contactor or bus as dead. Other two phases still live.
            </li>
            <li>
              <strong>Used a multimeter instead of a GS38 voltage indicator.</strong> Multimeter set
              to amps, or with leads in the wrong sockets, reads 0 V on a live conductor.
            </li>
            <li>
              <strong>Didn’t lock off (or shared a key).</strong> Customer / cleaner / other trade
              re-energised mid-job.
            </li>
            <li>
            ...
            <li>
              <strong>Skipped N-E test on single-phase.</strong> Borrowed neutral hidden, conductor
              at line potential.
            </li>
            <li>
          ...
          <p>
            ...
            prosecution report ends the same way: ‘…had safe isolation been carried out correctly,
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The freezer’s full of stock and the customer doesn’t want it down for an hour. The
              job’s a faceplate change. The supervisor says ‘crack on, two-minute job, just be
              careful, it’s only 230 V’. You take the screws out live. Your screwdriver slips,
              bridges the line and earth terminals, and you take a hand-to-hand shock across the
              chest. You’re lucky — you get away with palpitations and a hospital visit. The HSE
              turns up the next morning.
            </>
          }
          doInstead={
            <>
              There’s no ‘only’ at 230 V. Hand-to-hand at 230 V is the textbook fibrillation path
              covered in §2.1. The customer’s freezer is not on the legal balance the way EAWR Reg
              14 sets it up — convenience isn’t one of the three tests. Power down the relevant
              circuit for 10 minutes, do the work safely, the freezer will be fine. If you need to
              argue for it: ‘the law wants this dead, and I’m the one in court if it goes wrong.’
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              CU labelled ‘RING — KITCHEN’. You want the kitchen ring off, you snap that breaker,
              see the kitchen sockets die on a plug-in tester, lock it off. Pull the back box out —
              get a shock. Turns out somebody re-used a spare way ten years ago to add a hob
              ignition supply, never updated the label, and the breaker labelled ‘kitchen ring’ also
              feeds a small JB above the units that you’ve just disturbed.
            </>
          }
          doInstead={
            <>
              Labels are starting points, not facts. Always prove dead at the actual point of work —
              every conductor, every combination — with a proved GS38 indicator. The label tells you
              which breaker to flip first; the proving unit + indicator tells you whether you got it
              right.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Job done. Customer wants the power back on. You walk to the CU, take your padlock off
              the MCB, snap it on, head back to the van. Nobody wrote down the isolation sequence —
              when it went on, when it came off, what was tested in between. Three weeks later
              there's a query from the customer's insurer about the work, or a near-miss report from
              another trade who says they saw a live conductor where they shouldn't have. There's no
              audit trail. Your word against theirs. The HSE inspector who turns up later asks the
              firm 'show me your isolation log' and the firm has nothing.
            </>
          }
          doInstead={
            <>
              The isolation only ends on PAPER. Lock-off goes on, stays on until the isolation log
              entry is complete: time on, time off, what was tested, which indicator, which proving
              unit, who carried out the work, sign-off. THEN the padlock comes off and the supply
              gets restored. The log is what proves the isolation happened correctly — without it,
              you've done the work and lost the evidence. Most firms now use a printed permit/log
              book or a tablet entry; some schemes require it. Either way, paperwork before
              padlock-off, every time.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Your padlock, your key.</strong> One key per person, kept on the person whose
              padlock it is. No shared rings. No keys in the meter cupboard.
            </li>
            <li>
              <strong>Multi-hasp for shared work.</strong> Two electricians on the same circuit?
              Multi-hasp on the lockout, one personal padlock per person. Circuit comes back live
              only when the LAST padlock is removed.
            </li>
            <li>
              <strong>Only the person who applied a padlock removes it.</strong> Not the supervisor.
              Not the supervisor. Not ‘a mate who has the same brand of key’.
            </li>
            <li>
              <strong>Formal lock removal process</strong> for genuine emergencies (the named person
              is unreachable AND the work needs to continue). Typically requires: a manager, a
              competent electrician to verify the work area is safe, written record of the reason,
              and notification of the original lock-applier. NEVER bypass this because it’s
              convenient.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The personal-lock principle is HSE’s official position, not just custom and practice.
              The formal removal procedure exists for genuine ‘person off sick on Monday and
              Friday’s lock is still on’ cases — not for ‘the customer wants it back on now’. If you
              find yourself wanting to cut a padlock off because it’s inconvenient, that’s the
              warning sign that you need to call the supervisor first.
            </>
          }
          cite="Reference: HSE HSG85 (Edition 4) Chapter 4 — Safe working procedures"
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re on a CU change in a small office. You isolated at the DNO main switch, but the
              lockout you had with you didn’t fit cleanly so you posted a paper sign on the CU door
              (‘DO NOT OPERATE’) and assumed the office manager would understand. Lunchtime. You
              walk to the van. The office manager comes back from a meeting, sees the door panel
              hanging loose, ‘helpfully’ snaps the main switch back on so the staff can use the
              kettle. Five minutes later you walk back in, open the CU door, and reach for a tail.
            </>
          }
          whatToDo={
            <>
              Right call: stop the moment something looks different from when you left. Re-prove
              dead at the point of work BEFORE any tool touches a conductor. If you’re standing in
              front of a CU you ‘know’ is dead but you’ve been off site for even five minutes —
              re-prove. Then deal with the cause: get a proper lockout that fits (ALL ways including
              the main switch should have a lockable means of isolation under BS 7671 537), apply
              your personal padlock, brief the office manager in person about what the sign means
              and that the circuit MUST stay off until you say otherwise.
            </>
          }
          whyItMatters={
            <>
              ‘Proved dead’ is a moment-in-time test. Every break in your physical presence (lunch,
              van trip, end of day, even a five-minute toilet) is a window where someone could
              re-energise. Either physically lock it off so they CAN’T (which is the law-compliant
              answer), or re-prove every time you come back to the work area. Both, ideally.
            </>
          }
        />
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-orange-400/70">
            <li>
              <strong>Immediate response:</strong> isolate (if safe), 999, first aid, preserve the
              scene. Don’t tidy up.
            </li>
            <li>
              <strong>RIDDOR notification:</strong> the responsible person notifies the HSE under
              the Reporting of Injuries, Diseases and Dangerous Occurrences Regulations 2013.
              Fatalities, specified injuries, &gt;7-day incapacities, and ‘dangerous occurrences’
              all qualify.
            </li>
            <li>
              <strong>HSE investigation:</strong> inspector arrives, often within 24 hours for
              fatalities. They want the safe isolation procedure (written), test instrument records,
              RAMS, training records, the permit-to-work if any. Witness statements. Photos.
            </li>
            <li>
            ...
            <li>
              <strong>Court:</strong> magistrates (unlimited fine, 6 months) or Crown (unlimited
              fine, 2 years). If a death and gross negligence — manslaughter (life maximum).
              Sentencing Council guidelines tie fines to company turnover and harm level.
            </li>
            <li>
              <strong>Career impact:</strong> conviction stays on your DBS-equivalent record. JIB /
              ECS card revocation is common after serious convictions. End-of-trade for most.
            </li>
            <li>
              <strong>Civil claim:</strong> the injured person (or family) sues for damages.
              Insurance covers some of it, but not directors’ personal liability or criminal fines.
            </li>
          </ol>
          <p>
            And the bit nobody talks about: even if no charges follow, the incident sits in your
            head for the rest of your career. Electricians who’ve had a near miss describe it the
            same way years later — the moment, the smell, the silence. Worth ten extra seconds on
            the procedure.
          </p>
        </ConceptBlock>
        ...
        >
          <p>That’s it. Read it back, slowly. Every word in that sentence is doing work:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-emerald-400/70">
            ...
            <li>
              <strong>‘Until you have personally proved’</strong> — not until someone TOLD you it’s
              dead. Personal control under HASAWA s.7.
            </li>
            <li>
              <strong>‘At the actual point of work’</strong> — not at the CU, not at the breaker. At
              the conductor your tools are about to touch.
            </li>
            <li>
          ...
          <p>
            Apply that rule without exception and you’ve closed the door on basically every failure
            mode in this section. Add ‘identify all sources of supply at Step 1’ and you’ve closed
            the door on the rest. Everything else is detail and habit.
          </p>
        </ConceptBlock>
