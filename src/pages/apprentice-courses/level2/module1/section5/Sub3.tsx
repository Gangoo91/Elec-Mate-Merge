...
const checks = [
  ...
  },
  {
    ...
    question:
      'You and another electrician are working on the same isolated sub-main. How should the lock-off be arranged?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      'Your voltage indicator’s LEDs work but the haptic/buzzer doesn’t. Is the indicator still safe to use?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'What is a CAT rating on test equipment, and what should you use for distribution-board work?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'A pull-out fuse carrier is the only means of isolation and you can’t fit a lock-off. What do you do?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The kit on your belt that turns the procedure into reality. Lockouts, padlocks,
          multi-hasps, tags, GS38 voltage indicators, proving units. What to carry, how to use each
          piece, and when to take a damaged item out of service.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lock-off devices</strong> — the bits that physically prevent the isolating
              device being switched on. Different shapes for MCBs, RCBOs, rotary isolators,
              plug-and-socket connections, fuse carriers.
            </li>
            <li>
              <strong>Personal padlocks</strong> — keyed-different (your key only opens YOUR lock).
              Bright colour helps anyone glancing at the board see ‘someone is working on this’. 4-6
              in a kit is normal.
            </li>
            <li>
              <strong>Multi-hasp</strong> — a clamp that fits onto a single lock-off device and
              accepts up to 6 padlocks, so multiple workers can each apply their own lock to the
              same isolation.
            </li>
            <li>
              <strong>Tags / warning labels</strong> — pre-printed laminated tags with space for
              name, date, work description, contact number.
            </li>
            <li>
              <strong>Voltage indicator (GS38)</strong> — two-pole, fixed leads, multiple indication
              modes (LED + buzzer + vibration is typical), CAT III 600 V minimum.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fixed leads</strong> — can’t be plugged into the wrong sockets. No ‘tester
              reads zero because leads are in the amps holes’ failure mode.
            </li>
            <li>
              <strong>No range switch</strong> — typically auto-ranges across LV bands (12 V, 24 V,
              50 V, 120 V, 230 V, 400 V, 690 V) with LEDs to show the band detected.
            </li>
            <li>
              <strong>Multiple indication modes</strong> — usually a row of LEDs (bright, easy to
              see in a CU shadow), a buzzer (audible in a noisy plant room), and often a vibration
              alert (haptic — felt through gloves). One failure mode doesn’t leave you blind.
            </li>
            <li>
              <strong>GS38 probes</strong> — finger barriers (the moulded ridge stops your finger
              sliding onto the conductor), ≤4 mm exposed tip (preferably 2 mm), often with
              retractable shrouds.
            </li>
            <li>
              <strong>Continuity test</strong> — many include a low-voltage continuity test you can
              use without batteries, useful for ringing out cables.
            </li>
          </ul>
          <p>
            Common UK brands: Martindale VI-13700 series, Fluke T100/T150, Megger TPT420. Whichever
            brand, look for GS38 marking and the IEC 61010 CAT rating you need (CAT III 600 V
            minimum for distribution work, CAT IV 600 V if you’re anywhere near the supply origin).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The probe specification is the bit you can SEE every time you pick the kit up. If your
              VI’s probes have more than 4 mm of bare metal at the tip — or no finger barrier — they
              don’t meet GS38. Old-school multimeter probes with long bare tips and no guards are
              common in older toolboxes; bin them and buy GS38 sets.
            </>
          }
        ...
        >
          <p>
            A proving unit is a battery-powered device that generates a known voltage you can touch
            the VI’s probes against to confirm the VI is working. Two designs are common:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Switched output</strong> — press a button, the unit generates ~230 V AC (and
              often a DC test voltage and lower AC bands too) for a few seconds across two contact
              points.
            </li>
            <li>
              <strong>Always-on contact pad</strong> — touch both probes to the marked pads, voltage
              is generated automatically.
            </li>
          </ul>
          <p>
            Modern units typically generate three test voltages (e.g. 50 V, 230 V, 400 V) so you can
            confirm the indicator’s LEDs light up across the range, not just one band.
          </p>
          <p>
            <strong>When to take it out of service:</strong> any cracks in the case (battery voltage
            exposed, indicator may be unreliable), failure to generate the test voltage when the VI
            is known good, batteries that won’t hold charge, expired calibration sticker if your
            firm calibrates annually. Replacement is ~£40-80 — well under the cost of a single
            near-miss.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Universal MCB lockouts</strong> — colour-coded clips that fit over the toggle
              of a switched-off MCB and present a padlock hole. ‘Universal’ models cover most modern
              slim breakers; older or unusually-shaped breakers may need a manufacturer-specific
              lockout.
            </li>
            <li>
              <strong>Wide-jaw lockouts</strong> — for breakers with a wider toggle (some older
              Crabtree, Wylex Standard, MEM). Same idea, larger jaws.
            </li>
            <li>
              ...
              fixed-equipment supplies. Slide over the rotary handle in the off position and accept
              a padlock.
            </li>
            <li>
              <strong>Plug-and-socket lockouts</strong> — boxes that enclose a 13 A plug or a BS EN
              60309 commando connector so it can’t be plugged back in. Useful where the only means
              of isolation is unplugging.
            </li>
            <li>
              <strong>Multi-hasps</strong> — the multi-padlock clamp that fits onto a lock-off’s
              padlock hole and accepts up to 6 personal padlocks, one per worker.
            </li>
          </ul>
          <p>
            Padlocks are <strong>keyed-different</strong> (your key, your lock, only one works).
            Bright colour (red, yellow) is the convention so anyone glancing at the CU sees ‘someone
            is working on this — leave it alone’. Combination locks are not used for personal
            isolation — anyone observing you set the combination can re-use it.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              regulation behind why we lock off, and behind why a flick-switch with no provision for
              a padlock isn’t a means of isolation. If a device can’t be secured, you have to use
              the next device upstream that CAN be secured.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Optional: company name, permit number (on permit-to-work jobs).</li>
          </ul>
          <p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Your voltage indicator has LED + buzzer + vibration. The buzzer’s broken (you’ve been
              meaning to replace it for weeks). You prove on the proving unit, all the LEDs light
              up, but your hand’s on the case so you don’t notice the buzzer is silent. Test on the
              circuit — no LEDs light, you call it dead. Two days later the LEDs themselves fail in
              a way you don’t spot, and your ‘dead’ reading is actually ‘can’t indicate anything’.
            </>
          }
          doInstead={
            <>
              Multiple indication modes is GS38’s redundancy. If ANY of them stops working — an LED
              out, the buzzer silent, the haptic dead — the indicator is out of service until
              repaired or replaced. ‘It still works mostly’ is exactly the failure-mode trail that
              GS38 was written to break.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              little green / amber / red plug-in unit), all the LEDs are off, you assume the circuit
              is dead and start unscrewing the faceplate. The socket tester reads 'no power' for all
              sorts of reasons that aren't 'circuit is isolated and dead' — a broken neutral
              elsewhere on the ring, the tester's own internal LEDs failing, or a partial isolation
              that drops voltage to one socket but leaves the line conductor live. You take a shock
              from the line terminal as you pull the faceplate off.
            </>
          }
          doInstead={
            <>
              A socket tester is a quick functional check, not a means of proving dead. It is NOT a
              GS38-compliant voltage indicator and HSE GS38 explicitly excludes it from the
              safe-isolation procedure. Prove dead with a proper two-pole voltage indicator on a
              proving unit, test L-E / L-N / N-E at the actual conductors with the faceplate already
              off, then re-prove on the proving unit. The plug-in tester tells you about polarity
              and continuity once power is back; it tells you nothing reliable about whether the
              conductors you're about to touch are dead.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You arrive at a 1970s flat to swap a damaged 32 A ring final MCB. The CU has a main
              switch, but it’s a Wylex Standard with rewireable fuses — the ‘breakers’ on the ring
              final are actually pull-out fuse carriers. There’s no MCB lock-off that fits, the main
              switch isn’t lockable either, and the customer needs the freezer circuit (different
              fuseway) to stay live.
            </>
          }
          whatToDo={
            <>
              Withdraw the fuse carrier for the ring final and put it in your tool bag. Post a ‘DO
              NOT OPERATE — fuse withdrawn for work in progress’ sign on the empty fuseway AND on
              the CU door. Brief the customer. The circuit physically cannot be re-energised without
              you putting the fuse carrier back in. HSG85 explicitly recognises this as a valid
              method where lockable devices aren’t fitted. Keep the carrier on YOU, not on top of
              the CU — that’s the equivalent of ‘key in the lock’.
            </>
          }
          whyItMatters={
            <>
              Older installs frequently lack lockable isolating devices. The procedure adapts:
              physical removal of the fuse / carrier achieves the same outcome (circuit cannot be
              re-energised by anyone without you). Skipping isolation because ‘there’s nothing to
              lock’ is the wrong answer.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
            ...
            <li>Any indication mode not working (LED, buzzer, vibration). One failure = out.</li>
            <li>Failure to register on the proving unit at any voltage band.</li>
            <li>
              Drop or impact (especially proving units — battery electrolyte can leak into the
              voltage-generation circuitry).
            </li>
            <li>
              Calibration sticker expired (where the firm or the manufacturer specifies an interval
              — usually annually).
            </li>
            <li>
          ...
          <p>
            Don’t leave failed kit in the toolbox where you might absent-mindedly grab it next week.
            Bin it, or quarantine it in a clearly-marked ‘NOT FOR USE’ pouch until it gets
            repaired/replaced.
          </p>
        </ConceptBlock>
        ...
        <Quiz
          title="Lock-off, tag-out and prove–test–prove knowledge check"
