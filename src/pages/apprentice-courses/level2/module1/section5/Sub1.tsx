...
const checks = [
  ...
  },
  {
    ...
    question:
      'Your supervisor told you to crack on without proving dead. Something goes wrong. Who can the HSE prosecute?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'Roughly how many electric-shock and burn incidents are reported to the HSE each year in the UK?',
    options: ['Around 10,000', 'Around 100', 'Around 1,000', 'Around 100,000'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 3,
    question:
      'Which regulation makes "dead by default" the legal rule for electrical work in the UK?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      "What's the maximum prison sentence on conviction for an individual under HASAWA / EAWR in the Crown Court?",
    options: ['2 years', '6 months', '3 months', '10 years'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      "An apprentice sees their supervisor working live on a CU 'just for two minutes'. What's the apprentice's position in law?",
    options: [
  ...
  },
  {
    id: 7,
    question:
      'You disturb a 230 V circuit you "knew was off" and it shocks you. You feel fine ten minutes later. What do you do?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The single most important habit on site. Around 30 electricians a year die at work in the
          UK and most of them are on the same 230 V and 400 V systems you’ll work on every day.
          Here’s why dead-by-default is the law, not the suggestion.
        </p>
        ...
        <ConceptBlock title="It’s the procedure between you and a fatal shock">
          ...
          <p>
            The HSE’s long-running figures put around{' '}
            <strong>
              1,000 electric-shock and burn accidents at work in front of them every year
            </strong>
            , with about <strong>30 fatal</strong>. Most of the fatalities involve direct contact
            with ‘ordinary’ Low Voltage systems — 230 V single-phase and 400 V three-phase. The same
            voltages you’ll work on every day from your first week as an apprentice.
          </p>
          <p>
            Skipping the procedure isn’t a personality trait or a test of who’s ‘proper
            time-served’. It’s the single most reliable way to end up dead, in court, or both.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            workplace where electrical work is done. <strong>Reg 14</strong> is the bit that decides
            what’s allowed:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Suitable precautions (training, PPE, instruments, supervision) must be in place.
            </li>
          </ul>
          <p>
            All three at once. If any one of them isn’t met, the work has to be done dead — and that
            means safely isolated. In practice, almost nothing on a domestic or commercial site
            clears all three. The textbook example of legitimate live work is fault-finding that
            genuinely cannot be done dead, by a competent person, with the right kit. Even then,
            you’re still expected to make as much of the surrounding work dead as possible.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Three tests, ALL of which have to be passed before anyone touches a live conductor. If
              your boss can’t honestly say all three are met, the legal answer is to isolate. ‘It’s
              only a small job’ doesn’t pass test (a). ‘The shop won’t close for half an hour’
              doesn’t pass (a) either — that’s convenience, not necessity.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 13 is the lock-off reg. Once you’ve made it dead, you’ve got to keep it dead. That
              means physically locking off (so it can’t be switched on by anyone else), tagging (so
              anyone wandering past knows what’s going on), and checking (proving dead before any
              tool goes near a conductor). All three of those are precautions Reg 13 expects.
            </>
          }
        ...
        >
          <p>
            The HSE’s headline figures for the UK have been broadly stable for years — even as the
            workforce has grown:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>~1,000</strong> reported electric-shock or burn accidents at work each year.
            </li>
            <li>
              <strong>~30</strong> of those are fatal — about one funeral every other Tuesday.
            </li>
            <li>
              Most fatalities involve <strong>direct contact with conductors at LV</strong> — the
              230 V or 400 V you handle daily.
            </li>
            <li>
              A large share of survivors carry <strong>permanent damage</strong> — burns that need
              grafts, heart-rhythm issues, neurological problems, falls from height after shock.
            </li>
          </ul>
          <p>
            ...
            maintenance — exactly the work apprentices are sent to do. The pattern is almost always
            the same: the conductor was thought to be dead and wasn’t, OR it was made dead but
            wasn’t locked off and somebody re-energised it.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Read that sentence again. The HSE’s own analysis is that most accidents happen for two
              reasons: (a) people work on stuff that hasn’t been made dead, or (b) they work on
              stuff that wasn’t <em>proved</em> dead. Safe isolation as you’ll learn it in §5.2-5.5
              is the procedure that closes both of those gaps.
            </>
          }
        ...
        >
          <p>Three stacked duties make this personal:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HASAWA s.7</strong> — every employee has a personal duty to take reasonable
              care for themselves and others, and to cooperate with the employer’s safety system.
            </li>
            <li>
            ...
            <li>
              ...
              screwdriver in the live conductor, you breached it personally, regardless of who told
              you to.
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
            ...
            <li>
              On top of any of those: <strong>permanent loss of competence card</strong> (ECS, JIB,
              etc.) and effective exit from the trade.
            </li>
          </ul>
          <p>
            You don’t need someone to die for it to be career-ending. A serious shock, a near miss
            with a witness, a recorded incident — any of those can be enough for an improvement
            notice or a prohibition notice that follows you around for years.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You walk up to a CU. The breaker is labelled ‘Kitchen sockets’ and that’s the circuit
              you want off. You flip the breaker, watch the kitchen sockets go dead on a plug-in
              tester, and assume you’re sorted. You start work. Turns out the breaker for the
              kitchen DOWNLIGHTS is in there too — somebody re-used a spare way without updating the
              label — and you’ve just opened a junction box on a circuit that’s still live.
            </>
          }
          doInstead={
            <>
              Labels are a clue, not a fact. Always prove dead at the actual point of work, on every
              conductor (line-line, line-neutral, line-earth, neutral-earth as appropriate), with a
              proven GS38 voltage indicator. The label tells you where to start; the proving unit +
              voltage indicator tells you whether you’re right.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              connection without re-testing AT the point of work. In between, the apprentice from
              the other firm has reset what he thought was a tripped breaker, the standby
              generator's auto-start has kicked in for ten seconds, or you've simply walked to a
              different circuit than the one you isolated. The conductor you treated as dead was
              live the moment you touched it.
            </>
          }
          doInstead={
            <>
              Dead-at-point-of-work is a separate test, every time, on every conductor you’re about
              to touch — even if you isolated five minutes ago at the CU you can still see. Walk
              back to the indicator, prove on the proving unit, test L-E / L-N / N-E at the
              conductor, prove on the proving unit again, THEN connect. Time-lag and changed
              location are exactly when re-energisation incidents happen.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A second-year is asked to swap a damaged single 13 A socket-outlet in a small shop.
              The supervisor says: ‘Just snap the breaker off, two minutes, customer doesn’t want
              the freezer down.’ No lock-off. No proving unit on him — it’s on the van. He flips the
              breaker, removes the screws and pulls the socket out. The cleaner walks past the open
              CU door, sees ‘a flipped breaker’ and helpfully resets it. He gets a hand-to-hand
              shock as he’s pulling the cable through the back box.
            </>
          }
          whatToDo={
            <>
              Two things should never have happened. First: the supervisor told him to skip lock-off
              and proving — that’s an EAWR Reg 13 / Reg 14 breach the supervisor’s on the hook for.
              Second: he went along with it. HASAWA s.7 puts that breach on him too. Right move on
              the day was: ‘I’ll grab the lock-off kit from the van — five more minutes.’ If pushed:
              ‘I can’t work on it without isolating, that’s the law, not me being awkward.’
            </>
          }
          whyItMatters={
            <>
              That electrician was lucky — A&E, a few weeks of palpitations, kept his job. The HSE
              investigated. The company was fined £24k, the supervisor was fined personally and got
              a suspended sentence. The apprentice escaped prosecution because he’d only just
              started — but the next year up he’d have been named too.
            </>
          }
        />
        ...
        >
          <p>
            In Section 2.1 you covered what current does to a body and how BS 7671 layers protection
            — basic (insulation, enclosures), fault (ADS, earthing, bonding), additional (30 mA
            RCDs). All of that is designed to stop a shock during
            <em> normal use </em>of the installation.
          </p>
          <p>
            The moment you remove an accessory cover, open a CU, or expose a conductor for
            maintenance, every one of those protective layers is briefly bypassed. Insulation: gone.
            Enclosure: open. RCDs: still there but they only trip after current has already started
            flowing. The only protection that remains is the procedure you follow — safe isolation.
            That’s why this section sits where it does in your learning, and why every other section
            builds on it.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 132.12 is the design-side companion to safe isolation. The reason isolators, main
              switches and CUs have to be accessible is so that competent people can actually carry
              out a safe isolation when work is needed. If you turn up to a job and the means of
              isolation is buried behind a dishwasher or above a 4 m ceiling with no access, that’s
              a 132.12 issue — flag it, don’t just shrug. (Reg 132.16 is a separate provision
              covering additions and alterations to an installation.)
            </>
          }
