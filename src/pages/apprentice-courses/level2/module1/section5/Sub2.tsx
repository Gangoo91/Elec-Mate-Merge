...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'You isolate a circuit and lock it off. What MUST you do before any tool touches a conductor?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'You’re isolating at the main switch of a TT installation for a CU change. What extra check matters because it’s TT?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'The customer asks if they can leave a temporary fan plugged into the next ring socket while you work. What do you do?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'You finish the job and remove your lock-off. What is the LAST thing you should do before you leave?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The seven steps the JIB, NET and IET expect from a competent person — from identifying the
          correct point of isolation to confirming the circuit is reinstated. Learn it in this
          order, in your sleep.
        </p>
        ...
        <ConceptBlock title="Seven steps, in this exact order">
          <p>
            Read these once, then we’ll walk through each with the on-site detail. The order is not
            negotiable — every step is there to catch a failure of the previous one:
          </p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Identify</strong> the circuit, the point of isolation, and any other possible
              sources of supply.
            </li>
            <li>
            ...
            <li>
              <strong>Test</strong> the circuit at the point of work — every conductor combination —
              to confirm dead.
            </li>
            <li>
          ...
          <p>
            Some training centres and employers expand this to 9 — typically by splitting steps 4-6
            into ‘prove indicator, test circuit, prove indicator’ as three named steps, and adding
            ‘safely re-instate and verify function’ as the closing step. Same procedure either way.
            We cover the closing step explicitly later.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>The right device.</strong> Which MCB / RCBO / switch-disconnector controls the
              circuit you want dead. Cross-reference the schedule, the label, AND a circuit
              identifier or load test.
            </li>
            <li>
              <strong>The whole supply.</strong> Is this circuit fed from one source or two? UPS-fed
              sub-mains, PV inverters, EV chargers with V2G, generators, two-way switching from
              another consumer unit, and the classic ‘borrowed neutral’ from the next circuit are
              all real backfeed paths.
            </li>
            <li>
              <strong>The voltage and number of phases.</strong> Single-phase 230 V? Three-phase 400
              V? DC? Get the wrong indicator out and the procedure falls apart.
            </li>
            <li>
              <strong>That the device is suitable for isolation.</strong> Under BS 7671 Section 537
              the device must be capable of fully isolating ALL live conductors and must be
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Isolation of the neutral conductor moved out of Section 537 in A4:2026 — it’s now in
              Chapter 46 (Reg 461.2). On TN-S and most TN-C-S (PNB) installs, you typically isolate
              line conductors only — the neutral is bonded back to the supply transformer earth and
              sits close to 0 V. On TT (your own earth electrode) and IT (no system earth at all),
              the neutral has to be isolated too because it isn’t tied to a known earth reference.
              That’s why three-pole switches with N-link are common on TT mains.
            </>
          }
        ...
        >
          <p>Two practical points that matter on the day:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Operate to off, not to ‘probably off’.</strong> A breaker can sit in a middle
              ‘tripped’ position that LOOKS off but isn’t fully open mechanically. Push it firmly to
              the off detent. RCDs/RCBOs you typically push down past the trip position to a clean
              ‘O’.
            </li>
            <li>
              <strong>Watch what dies.</strong> If the customer is in, ask them what they expect to
              lose (lighting, fridge, computer). Confirm those go off when you operate the device.
              If they don’t, you’re probably on the wrong device — back to Step 1.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            The detail of lock-off devices, multi-hasps, group lock boxes and tag systems is covered
            in §5.3. For the procedure, you need to know:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lock-off goes ON THE DEVICE</strong> you’ve just operated to off. Not the CU
              door. Not a nearby switch.
            </li>
            <li>
              <strong>Tag</strong> includes your name, the date, the circuit, and a contact number.
              Pre-printed laminated tags are clearer than scribbled biro.
            </li>
            <li>
              <strong>Your key, your pocket.</strong> If you walk away from site, the key walks away
              with you, and the lock-off stays. The HSE has investigated multiple deaths where the
              key was ‘left on the meter cupboard ledge’ and someone re-energised.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              done? Their lock stays on. The circuit doesn’t go live until the LAST padlock has come
              off.
            </>
          }
        ...
        >
          <p>
            <strong>Step 4 — Prove.</strong> Put the voltage indicator across the proving unit’s
            output (or across a known live source — a socket on a confirmed-live circuit works in a
            pinch, but a proving unit is the safer default). Confirm both the AC and DC indicators
            (or the relevant voltage band on the indicator) light up.
          </p>
          <p>
            <strong>Step 5 — Test.</strong> At the actual point of work — not at the breaker — put
            the indicator across every relevant conductor combination. On a single-phase 230 V
            circuit:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            All three should read 0 V (or whatever the indicator shows for ‘dead’). If any one reads
            anything significant, STOP. You’ve got a backfeed, a borrowed neutral, a wrong breaker,
            or a cable still in service somewhere upstream. Don’t carry on, don’t ‘assume it’s
            residual capacitance’ — investigate.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              GS38 is the document that defines what counts as ‘safe’ test kit. For safe isolation
              that means: a two-pole voltage indicator (not a multimeter), fixed fused leads, finger
              guards and ≤4 mm exposed tip, and proving on a known source before AND after. We dig
              into the kit in §5.3 and §1.4.
            </>
          }
        ...
        >
          <p>
            The padlock and tag on the device are for the device. The warning notice is for everyone
            else who might wander past — customers, cleaners, other trades, the supervisor, the
            apprentice that turns up to ‘help’.
          </p>
          <p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You prove the indicator on a known live source. You test the circuit, get a ‘dead’
              reading on all three combinations, get on with the job. The indicator’s internal fuse
              blew silently somewhere between proving and testing — common failure on cheaper
              indicators. Your ‘dead’ reading was actually a ‘can’t read anything’ reading. The
              conductor was still live.
            </>
          }
          doInstead={
            <>
              Prove – test – prove. Every time. Every circuit. The whole procedure takes 30 seconds
              and it’s the entire reason GS38 exists. If you only ever remember one thing from this
              section, make it ‘re-prove on the proving unit at the end’.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You're working in a sub-board and the labels are vague. You snap what you think is the
              correct MCB to off, hang your padlock and caveat tag on it, and start work — but the
              device you locked off isn’t the one feeding the circuit you’re working on. The
              customer reports their kettle stopped working five minutes later — that's because the
              breaker you locked off was actually the kitchen ring, not the lighting circuit you
              wanted. Worse: the lighting circuit is still live, and your indicator showed dead
              because the lighting was simply switched off at the wall switch, not isolated at the
              board.
            </>
          }
          doInstead={
            <>
              Identify the correct device by tracing the circuit (function-test the load on the way
              down, walk the wiring back if you have to) BEFORE you lock anything off. Confirm the
              device you've chosen by switching it and watching the actual load you intend to work
              on go dead — at the load, not at a label. THEN lock off. THEN prove dead at the point
              of work. Lock-off without correct identification is just a padlock on the wrong
              breaker.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A first-fix is being added to a 1960s house. You’ve identified the lighting circuit on
              the schedule, switched off the relevant MCB at the CU, locked it off with your
              padlock, posted a notice on the door. You prove your indicator on the proving unit,
              test the lighting circuit at the rose: L-E reads 0 V, L-N reads 0 V, but N-E reads
              about 230 V.
            </>
          }
          whatToDo={
            <>
              ...
              potential — almost certainly a borrowed neutral from the kitchen ring downstairs where
              someone in 1985 ran a downlight off the nearest convenient pair. Switch off the next
              likely circuit (kitchen ring), lock that off too with a separate padlock, re-test.
              When all three combinations finally read 0 V, you’re truly isolated. Update the
              schedule afterwards so the next electrician doesn’t have to rediscover it.
            </>
          }
          whyItMatters={
            <>
              A borrowed neutral is a textbook reason for testing N-E in addition to L-N and L-E. If
              you’d skipped that combination — common on rushed jobs — you would have worked on a
              ‘dead’ neutral that was actually carrying line voltage from another circuit. Same
              fatal outcome as touching a live line conductor.
            </>
          }
        />
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Function-test: confirm the circuit you worked on does what it’s supposed to (socket
              reads 230 V, light comes on the right switch, etc.).
            </li>
            <li>
              Glance at the rest of the board. Anything you nudged that needs resetting (clocks,
              alarms, immersion timers)?
            </li>
          ...
          <p>
            ...
            procedure. NICEIC technical bulletins and JIB guidance both call it out as a required
            closing step — a ‘safe isolation’ that doesn’t end with safe re-instatement isn’t really
            finished.
          </p>
        </ConceptBlock>
