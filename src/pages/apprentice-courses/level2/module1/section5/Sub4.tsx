...
const checks = [
  {
    ...
    question:
      'How many conductor combinations should you test on a 400 V three-phase circuit (with neutral and earth)?',
    options: [
      'Three (each line to neutral only)',
      'Six (line-line and line-neutral pairs only)',
      'Eight (line-line, line-neutral and line-earth pairs)',
      'Ten (line-line, line-N, line-E and N-E)',
    ],
    correctIndex: 3,
    explanation:
      'On three-phase TN with N: L1-L2, L2-L3, L1-L3, L1-N, L2-N, L3-N, L1-E, L2-E, L3-E, N-E — ten combinations. Miss any one and a backfeed or borrowed neutral can hide.',
  },
  {
    id: 's5-4-pv-isolation-check',
    question:
      'You’re isolating a CU on a domestic install with rooftop PV. The DNO main switch is off. Are you safe?',
    options: [
      'Yes — the DNO main switch removes every source of supply',
      'No — the PV is a second source; its AC and DC sides each need their own isolation',
      'Yes — once the inverter stops exporting, the whole system is dead',
      'Yes — covering the panels makes the DC side safe to work on',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    question:
      'Reg 14 of EAWR allows live working when three tests are met. What does this look like for fault-finding?',
    options: [
      'Diagnostic work that genuinely cannot be done dead, by a competent person, with the right kit and a plan',
      'Any fault-finding job, since the supply must stay on to diagnose any fault at all',
      'The customer’s written permission to leave the supply on for the whole job',
      'Any live fault-finding, provided you are wearing the correct insulating gloves',
    ],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  {
    id: 1,
    question:
      'You’re changing a single 13 A socket on a 230 V ring. Which combinations do you prove dead at the back box?',
    options: ['Just L-N', 'L-N, L-E and N-E', 'L-N and L-E', 'Whichever feels right at the time'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    id: 2,
    question:
      'You’re isolating a 400 V three-phase distribution board for a sub-main change. Where is your point of isolation?',
    options: [
      'Any one of the outgoing MCBs feeding loads from the board',
      'The first single-phase final circuit you can conveniently switch off',
      'The switch-disconnector on the supply side of this board (or the upstream board)',
      'The local rotary isolator next to the nearest three-phase motor',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Yes — the neutral must always be isolated on every system type without exception',
      'No — the neutral never needs isolating on any installation under any circumstances',
      'Only the lines matter, because the neutral carries no current and sits at zero volts',
      'Not always — you may leave N where it’s reliably at earth potential, but isolate if in doubt',
    ],
    correctAnswer: 3,
    explanation:
      'On TN-S and most TN-C-S (PNB) systems the neutral is bonded back to the supply transformer earth and sits very close to 0 V, so the regulations permit leaving it un-isolated. On TT and IT systems you MUST isolate the neutral too. When in doubt — older installs, suspected DNO neutral problem — isolate it anyway.',
  },
  {
    id: 4,
    question:
      'A factory has a UPS that holds essential circuits up for 30 minutes. You isolate the relevant DB. What might still be live downstream?',
    options: [
      'Any final circuits fed from the UPS, until the UPS itself is isolated and proved dead',
      'Nothing — isolating the DB removes every source of supply',
      'Only the circuits with capacitors that hold a charge briefly',
      'Only the lighting circuits, which have their own back-up',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      'You arrive to fault-find on an EV charger that keeps tripping. The customer wants it tested live. What’s your approach?',
    options: [
      'Test it live straight away, since that is exactly what the paying customer has asked for',
      'Isolate first, exhaust the dead tests, then plan any live test under EAWR Reg 14',
      'Refuse the job outright on the grounds that EV chargers cannot be tested safely',
      'Replace the charger without any testing, because it keeps tripping the protective device',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    id: 6,
    question:
      'On a domestic install with a 6 kW PV system, the homeowner says ‘I’ve put the inverter into shutdown mode, you’re fine’. Are you?',
    options: [
      'Yes — inverter shutdown removes voltage from the whole system',
      'Yes — the AC side is dead, and the DC side is always safe',
      ...
      'Yes — DC at PV string voltages is too low to be dangerous',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 7,
    question:
      'A site has a backup generator with auto-start on mains failure. You isolate the DB at the switchroom. What additional risk?',
    options: [
      'None — isolating the DB at the switchroom makes everything dead',
      'The generator only feeds the lighting, so the rest is safe',
      'The risk is just noise from the generator, not electrical',
  ...
  },
  {
    ...
    options: [
      ...
      '230 V is below the threshold where Reg 14 applies, so it’s allowed',
      'Live working is fine at 230 V as long as you’re quick about it',
      '230 V is too low to cause a fatal shock, so the rule is relaxed',
    ],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The same seven steps adapt for the rest of the trade — three-phase distribution,
          sub-mains, fault-finding, PV, EV, generators, UPS. The places people get caught out are
          usually places where there’s a SECOND source of supply nobody mentioned.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Identify:</strong> the MCB or RCBO at the CU. Cross-check by switching off and
              confirming the load (socket, light) actually dies.
            </li>
            <li>
              <strong>Switch off, lock off:</strong> universal MCB lockout, personal padlock, tag,
              key in pocket.
            </li>
            <li>
              <strong>Prove – test – prove:</strong> at the actual point of work (the back box, the
              rose, the FCU). Three combinations: <strong>L-N</strong>, <strong>L-E</strong>,{' '}
              <strong>N-E</strong>. All three must read 0 V (or whatever the indicator shows for
              ‘dead’).
            </li>
            <li>
          ...
          <p>
            The N-E combination is the one most often skipped — and the one that catches borrowed
            neutrals. On older properties (1960s-80s) that have been part-rewired, borrowed neutrals
            are not rare. Always test N-E.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            On a 400 V three-phase circuit with neutral and earth, the conductor combinations you
            should prove dead at the point of work are:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>L1-L2, L2-L3, L1-L3</strong> — the three line-line combinations.
            </li>
            <li>
              <strong>L1-N, L2-N, L3-N</strong> — each line to neutral.
            </li>
            <li>
              <strong>L1-E, L2-E, L3-E</strong> — each line to earth.
            </li>
            <li>
          ...
          <p>
            Ten combinations. Sounds like a lot; takes about a minute with a half-decent indicator.
            Skip any of them and you can be working on a conductor sitting at line potential —
            particularly common on systems where one phase has been left in service to feed a
            different load via the same enclosure.
          </p>
          <p>
            <strong>Point of isolation:</strong> always a switch-disconnector capable of breaking
            ALL live conductors simultaneously. Outgoing MCBs on a board only isolate downstream
            loads — not the busbar. For sub-main work, isolate at the switch-disconnector on the
            supply side of the board you’re working on (or upstream if the board has no incoming
            switch).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              Section 537 anymore. On TN-S / TN-C-S the neutral can usually be left in service (it’s
              bonded close to earth potential at the supply transformer). On TT (your own earth
              electrode) and IT (no system earth) the neutral has to be isolated too. When in doubt
              — older installs, suspected DNO neutral problem, anywhere the system earth is suspect
              — isolate the neutral as well. ‘Belt and braces’ is rarely wrong here.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PV (rooftop solar):</strong> a SECOND source feeding the same AC bus. The
              inverter has a dedicated AC isolator (between inverter and CU) AND a dedicated DC
              isolator (between inverter and panels). Both must be operated and locked off
              independently. The DC side is live whenever the panels see daylight — including
              diffuse light on a cloudy day.
            </li>
            <li>
              <strong>Battery storage / home batteries:</strong> often paired with PV. Same pattern
              — separate AC and DC isolators. Battery DC is dangerous in its own right (high
              discharge current, sustained arcing on DC).
            </li>
            <li>
              <strong>EV charge points (especially V2G/V2H capable):</strong> can theoretically
              export back to the AC bus. Most current UK domestic chargers don’t, but commercial /
              fleet chargers increasingly do. Isolate at the charger’s dedicated isolator AS WELL as
              at the supplying CU.
            </li>
            <li>
            ...
            <li>
              <strong>UPS:</strong> holds essential circuits up for 5-30 minutes (sometimes longer).
              Use the maintenance bypass switch to take the UPS out of the supply chain, then
              isolate the downstream circuit normally. UPS internal work is competent-person
              territory, not apprentice work.
            </li>
            <li>
              <strong>Dual incomers (large commercial / industrial):</strong> a board fed from two
              transformers via a bus-tie or auto-changeover. Both incomers need isolating before the
              busbar is dead.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Each source = one isolating device. Each isolation = a discrete operation. And the
              regulation specifically requires that the earthing arrangement is properly managed so
              that anyone operating ONE isolator can rely on the system being safe. On a domestic PV
              install you’ll typically see warning labels at the CU saying ‘DUAL SUPPLY — isolate at
              PV AC isolator AND PV DC isolator before working on the AC bus’.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Symptom triage</strong> — what trips, when, what was the customer doing? Often
              this alone narrows the circuit to one or two candidates.
            </li>
            <li>
              <strong>Visual inspection</strong> — burn marks, smell, loose connections, chewed
              cable in the loft. Eyes first.
            </li>
            <li>
              <strong>Dead tests</strong> — isolate the suspect circuit (full safe isolation
              procedure), then insulation resistance, continuity, polarity. About 80% of faults show
              up here.
            </li>
            <li>
              <strong>Live measurements (if dead tests are inconclusive)</strong> — under EAWR Reg
              14: written plan, GS38 kit, insulated tools, PPE, only the minimum exposure needed for
              the measurement, ideally a competent person watching with the means to disconnect
              quickly.
            </li>
          </ol>
          <p>
            The key thing: live testing is the last step, not the first. An electrician who walks up
            to a CU, opens it and starts probing live with their multimeter is breaking EAWR Reg 14
            — and skipping the dead tests that would have found the fault faster anyway.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Three-phase contactor, controlling a three-phase motor. The contactor is fed from the
              busbar via three single-pole MCBs (one per phase). You want to work on the contactor
              terminals. You snap the three MCBs to off ‘one at a time, all three off now’, lock
              off… two of them, because the third lockout doesn’t fit cleanly. Tell yourself ‘all
              three are off, the lock’s on most of them, that’s fine’. The un-locked breaker gets
              nudged back on by someone closing the CU door — you’ve still got 230 V on one phase of
              the contactor.
            </>
          }
          doInstead={
            <>
              Isolate at a switch-disconnector that breaks ALL three lines in one operation. THAT
              device gets locked off. If the only available isolation is three separate single-pole
              devices (which is poor design but exists on older boards), each ONE gets its own
              lock-off, individually, and you don’t start work until all three are physically
              locked. Better still — isolate further upstream at a single three-phase switch.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You prove the indicator on the proving unit (good). You test L-E / L-N / N-E at the
              conductor — all three combinations read dead (good). You start work without re-proving
              the indicator on the proving unit afterwards. Two hours later, the indicator's
              internal fuse has failed silently — most likely because it took a hit when you tested
              across a borrowed neutral and didn't realise. The 'dead' reading you trusted at 09:30
              was a 'can't indicate anything' reading by 09:31. Every conductor you worked on after
              that point you treated as dead with no working indicator behind the call.
            </>
          }
          doInstead={
            <>
              Prove – test – PROVE. The post-test prove is the half of the procedure that people
              skip because the test already showed dead. That's exactly when it matters most — it
              confirms the indicator was still functional at the moment of the test, not just at the
              start. Skip the post-test prove and you remove the only safety net GS38 builds in for
              indicator failure during the test sequence.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A retail unit calls you out for an intermittent fault on the lighting ring. You turn
              up, switch off the main switch on the CU, lock it off, prove dead at the light fitting
              — all three combinations read 0 V. Start work. Halfway through pulling a fitting down,
              you notice the LED indicator on a small enclosure above the CU door is glowing —
              labelled ‘PV INVERTER 4kW’.
            </>
          }
          whatToDo={
            <>
              ...
              inverter was in night mode, whatever. The moment the sun comes back, the inverter can
              re-energise the bus. Get the fitting back together, re-prove, then operate the
              dedicated PV AC isolator (it’ll be near the inverter), lock it off, operate the
              dedicated PV DC isolator at the same enclosure, lock that off too. Re-prove all
              combinations dead. Then resume work. Update the schedule and the CU label so the next
              electrician knows.
            </>
          }
          whyItMatters={
            <>
              ‘Proved dead’ is a moment-in-time test. With a generator on the system (PV, battery,
              UPS, standby genset), a circuit can become live again at any point after you proved it
              dead. Hence the rule: each source gets its own isolation, each isolation gets locked
              off, the SET is what makes the bus dead.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Pulling DNO seals or working on the supply side of the meter — that’s the DNO’s or the
              supplier’s job, not yours.
            </li>
            <li>
              Large UPS systems with battery isolation (battery banks at 400+ V DC carry their own
              arc and burn risks).
            </li>
            <li>
            ...
            <li>
              Critical-environment work (data centres, hospital theatres, chemical plant) where the
              permit-to-work system is the actual control and the procedure is heavily customised.
            </li>
          </ul>
          <p>
            EAWR Reg 16 (technical knowledge or experience) is the regulation behind this. You can
            ASSIST a competent person on this work — you can’t LEAD it.
          </p>
        </ConceptBlock>
        ...
        <Quiz
          title="Safe isolation in different scenarios knowledge check"
