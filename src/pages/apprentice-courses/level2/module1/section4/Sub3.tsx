...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 4 · Subsection 3"
      ...
      <HubBody>
        ...
        >
          <p>
            Looking at the bigger picture of Section 4: §4.1 told you PPE is the LAST line of
            defence. §4.2 listed the specific PPE for electricians. This subsection is about making
            sure the TEST INSTRUMENT itself isn’t a source of risk — because you’ll spend more of
            your career holding test gear than holding insulated tools, and a non-GS38 setup turns a
            routine dead-test into the incident.
          </p>
          <p>
            §5 (next section) will cover the formal safe isolation procedure that uses all of this
            together: lock-off the supply, post warning notices, use GS38-compliant kit to PROVE
            dead state, then work. Each step is dependent on the next. GS38 underpins the whole
            thing.
          </p>
        </ConceptBlock>
