...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      'An electrician says "We don’t need to isolate, just stick the gloves on". What’s wrong with that?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      "Your supervisor hands you a 'one-size-fits-all' high-vis that drowns you and gloves two sizes too big. Is this OK?",
    options: [
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 4 · Subsection 1"
        title="The purpose of PPE"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Why PPE exists, where it sits in the hierarchy of control, and why it’s the LAST line of
          defence — not the first. Get this clear and the rest of Section 4 makes sense.
        </p>
        ...
        >
          <p>
            The Personal Protective Equipment at Work Regulations 1992 (amended 2022) define PPE as{' '}
            <em>
              "all equipment (including clothing affording protection against the weather) which is
              intended to be worn or held by a person at work and which protects them against one or
              more risks to their health or safety"
            </em>
            .
          </p>
          <p>
            Key word: <strong>protects the person</strong>. PPE doesn’t make the cable dead. It
            doesn’t catch the falling brick before it falls. It doesn’t suck the dust out of the
            air. It just changes what happens to YOU when one of those things gets to you.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              harnesses, RPE, hearing protection, even thermal kit for outdoor winter working. If
              its job is to protect YOU rather than control the source of the hazard, it’s PPE and
              these regs apply.
            </>
          }
        ...
        >
          <p>
            Every UK risk assessment uses the same hierarchy. It’s baked into the Management of
            Health and Safety at Work Regulations 1999 and into PPER 2022 itself. The order is
            deliberate — each step DOWN is less reliable because it depends more on human behaviour:
          </p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Eliminate</strong> — remove the hazard entirely. Don’t do the job live. Use a
              battery tool instead of mains. Re-route the cable. Best option.
            </li>
            <li>
              <strong>Substitute</strong> — swap the hazard for something less dangerous. LED panel
              instead of high-pressure halogen. Battery drill instead of 110 V.
            </li>
            <li>
              <strong>Engineering controls</strong> — physical kit that controls the hazard. Guards,
              interlocks, isolators, RCDs, dust extraction, fume cupboards. Works whether or not
              someone remembers to use it.
            </li>
            <li>
              <strong>Administrative controls</strong> — procedures, training, RAMS, permits,
              signage, supervision. Relies on people doing the right thing.
            </li>
            <li>
              <strong>PPE</strong> — the last layer. Protects only the wearer, only if fitted, worn,
              and looked after.
            </li>
          </ol>
          <p>
            The further down you go, the more weight is on YOU as a person doing the right thing
            every single time. That’s why PPE is the bottom — it’s the most fragile link in the
            chain. Use it AS WELL AS the higher controls, never INSTEAD OF.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The legal version of "PPE is the last resort". You only fall back on PPE when the risk{' '}
              <em>cannot</em> be controlled by something higher in the hierarchy. If a job could be
              eliminated, substituted, or engineered safer, the employer has to do that FIRST — and
              PPE only fills the gap that remains.
            </>
          }
        ...
        <ConceptBlock title="The hazards on a normal electrician’s day">
          <p>
            You’ll meet most of these every week. PPE doesn’t fix any of them — it just softens the
            blow when something gets to you:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electric shock</strong> — insulated gloves (IEC 60903), insulated tools (BS EN
              60900). Covered in §4.2.
            </li>
            <li>
              <strong>Arc flash + arc burns</strong> — arc-rated face shields and clothing (BS EN
              61482), rated in cal/cm². Covered in §4.2.
            </li>
            <li>
              <strong>Falling objects + impact</strong> — safety helmet (BS EN 397) or bump cap,
              depending on the site. Steel/composite toe-cap boots (EN ISO 20345 SB minimum).
            </li>
            <li>
            ...
            <li>
              <strong>Hand injury</strong> — cuts, burns, chemical, electrical. Different glove
              standards for each (cut: BS EN 388; heat: BS EN 407; insulating: IEC 60903).
            </li>
            <li>
              <strong>Hearing damage</strong> — power tools, drilling. Ear defenders or plugs (BS EN
              352), rated in dB SNR.
            </li>
            <li>
              <strong>Respiratory</strong> — dust from drilling/chasing, fume from soldering. RPE
              (filter masks BS EN 149 — FFP1/FFP2/FFP3).
            </li>
            <li>
              <strong>Visibility</strong> — being seen by plant, traffic, other trades. Hi-vis vest
              or jacket (EN ISO 20471).
            </li>
            <li>
              <strong>Falls from height</strong> — harness + lanyard (BS EN 361 / 354). Always last
              resort under WAH 2005 — eliminate the height first if you can.
            </li>
          </ul>
          <p>
            Each item is rated for a specific hazard. Wearing the wrong rating is almost as bad as
            wearing nothing — you THINK you’re protected. We’ll go through the electrical-specific
            ones in detail in §4.2.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The 2022 amendment to PPER tightened things up — most importantly, it widened the duties
            to cover ‘limb (b) workers’ (a lot of agency and zero-hours staff). Whether you’re a
            direct employee, an apprentice, or a casual worker, your employer must:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Provide suitable PPE free of charge</strong> when other controls can’t
              adequately reduce the risk (Reg 4).
            </li>
            <li>
              <strong>Make sure it FITS</strong> you and is compatible with any other PPE you’re
              also wearing (Reg 4(3)).
            </li>
            <li>
              <strong>Maintain, replace and store it properly</strong> — including any periodic test
              or recertification (Reg 7).
            </li>
            <li>
              <strong>Train you</strong> in how to use, fit, look after and report defects in the
              kit (Reg 9).
            </li>
            <li>
              <strong>Keep it CE / UKCA compliant</strong> — only PPE meeting the relevant supply
              regulations may be used (Reg 4(2)).
            </li>
          </ul>
          <p>
            Not optional. Not "if budget allows". HSE inspectors prosecute PPER breaches regularly —
            fines have hit £100k+ for serious cases.
          </p>
        </ConceptBlock>
        ...
        >
          <p>You don’t get a free ride here. PPER Reg 10 puts three duties on you as the wearer:</p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Use the PPE</strong> in accordance with your training and instructions.
            </li>
            <li>
            ...
            <li>
              <strong>Report any loss or defect</strong> to your employer. If the gloves fail a
              visual check, the boots split, the helmet takes a knock — flag it.
            </li>
          </ol>
          <p>
            These sit on top of your general HASAWA s.7 duty to cooperate with the safety system
            (covered in §1.1). Refusing to wear required PPE without a good reason is a sackable
            offence and personally on you if something goes wrong.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              <strong>report defects</strong>. Doesn’t sound like much, but it’s the bit most often
              broken — left in the van, hung off a nail in the welfare cabin until it’s mouldy, or
              quietly used after it’s clearly knackered. All of those are PPER Reg 10 breaches.
            </>
          }
        ...
        >
          <p>
            Since Brexit, UK-supplied PPE carries either the <strong>UKCA</strong> mark or the{' '}
            <strong>CE</strong> mark (CE is still accepted indefinitely as of 2024). Either is
            valid. What matters is that it’s there, alongside the standard the kit is certified to.
          </p>
          ...
          <p>
            Cheap import gloves with no markings, or markings that look photocopied, are a hard
            refuse. There have been documented cases of Class 0-marked gloves from non-UK sources
            failing dielectric tests at well below 1 kV. The mark on the glove is your only
            assurance — and if it’s fake, the assurance is fake.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Job needs isolation. Supervisor says "it’ll take ages, just whack the gloves on". You
              wear the gloves, work it live, nothing goes wrong this time. Next time the gloves have
              a pinhole you didn’t spot, or the voltage is higher than you thought, or the
              screwdriver slips and arcs across two phases. Now the gloves are doing a job they were
              never meant to do — they were the BACKSTOP, not the plan.
            </>
          }
          doInstead={
            <>
              Argue for the proper control. EAWR Reg 14: live work needs (a) it being unreasonable
              to make it dead, (b) it being reasonable to do it live, AND (c) suitable precautions.
              PPE is part of (c) — but only AFTER (a) and (b) are justified. If isolation is
              genuinely possible, isolation wins. PPE goes on top, not instead.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              electrician. He throws you a pair of standard work gloves — leather, no markings. You
              ask about insulated gloves. He says "we don’t bother for domestic — just don’t touch
              the live bits". The supply’s coming in on a TT system, the meter’s already
              disconnected, but the CU still has tails dangling.
            </>
          }
          whatToDo={
            <>
              Don’t crack on. Politely raise it: "the tails could still be live if the meter’s
              reconnected, and PPER 2022 Reg 4 means I should have insulated gloves rated for the
              voltage. Could you arrange a pair?". If he pushes back, escalate to the contracts
              manager or your training provider — apprentices have a direct line for safety issues
              without it being seen as snitching. Note the date, the conversation, the supply state.{' '}
              <strong>HASAWA s.7</strong> makes the failure to wear suitable PPE PERSONALLY yours if
              you go ahead — not his.
            </>
          }
          whyItMatters={
            <>
              "Don’t touch the live bits" is not a control — it’s a hope. PPER 2022 Reg 4 says if
              there’s a foreseeable risk of contact with a live part, the employer must provide PPE
              rated for it. A first-year apprentice working on tails with no insulated gloves and no
              proven dead state is exactly the situation HSE prosecutes employers over. And it’s
              exactly the situation that turns into a fatality at 230 V.
            </>
          }
        />
        ...
        <ConceptBlock title="The PPE conversation belongs in the RAMS">
          <p>
            You met RAMS in §3 — the Risk Assessment and Method Statement that turns law into actual
            steps for an actual job. PPE selection lives in there. A proper method statement names
            the kit: "operatives shall wear EN ISO 20345 SB safety footwear, EN 397 helmet, EN 166
            eye protection. For the live cap-off only: IEC 60903 Class 0 insulated gloves and an
            arc-rated face shield to BS EN 61482-2 minimum 8 cal/cm²."
          </p>
          <p>
            That specificity isn’t bureaucracy — it’s how you (and your employer) prove you’ve
            thought through the hazards and chosen kit that actually matches them. When the assessor
            at the end of your apprenticeship asks "why those gloves", the answer comes from the
            RAMS, not from "the supervisor told me to wear them".
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Knowing what PPE the job needs IS technical knowledge. As a first-year apprentice
              you’re an <em>instructed person</em> under BS 7671 — you need a competent person
              specifying the PPE for you and supervising. By the end of your apprenticeship, you
              should be the one specifying it for the job. Knowing the hierarchy + the regs is how
