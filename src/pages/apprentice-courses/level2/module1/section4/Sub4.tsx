  ...
  return (
    <HubPage>
      ...
      <HubBody>
        ...
        >
          <p>
            PUWER + EAWR both reference ‘competent person’. As a Level 2 apprentice you’re competent
        ...
        >
          <p>
            Section 5 (next) ties this all together into the formal SAFE ISOLATION PROCEDURE — the
            standard sequence every UK electrician uses to take a circuit dead, prove it dead, lock
            it, and work on it safely. It uses the PPE from §4.2, the test gear from §4.3, and the
            daily habits from this subsection. Without those foundations, the safe-isolation
            procedure is just words on paper.
          </p>
        </ConceptBlock>
