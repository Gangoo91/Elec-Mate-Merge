...
const TITLE = 'General workplace emergency procedures | Level 2 Module 1.6.6 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question: 'Which national emergency number do you call for a suspected gas leak in the UK?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'I’m a self-employed electrician working alone in domestics all day — what counts as a lone worker arrangement?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Gas leaks, structural collapse, extreme weather, security incidents, mental health crises
          — the responses for every workplace emergency that isn’t fire or shock. The pattern
          repeats: stop, isolate if safe, evacuate, escalate.
        </p>
        ...
        <ConceptBlock title="Different emergencies, same skeleton response">
          <p>
            Section 6 has covered electric shock (§6.1), first aid (§6.2), the legal reporting
            machinery (§6.3), investigation (§6.4) and fire (§6.5). This final subsection covers the
            other workplace emergencies you’ll meet — and the same underlying response pattern shows
            up in every one:
          </p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Make safe</strong> what you can <em>without taking on additional risk</em>.
              Isolate a supply if it’s upstream and reachable. Don’t enter a collapsed area to
              "check".
            </li>
            <li>
              <strong>Evacuate / cordon.</strong> Get yourself and others out of the danger zone.
              Stop new people walking in.
            </li>
            <li>
              <strong>Escalate to the right service.</strong> 999 is always valid; specialist
              numbers (gas, power cuts, terrorism) get you triaged faster when you know which one
              fits.
            </li>
            <li>
              <strong>Stay until released.</strong> Roll call, brief the responding professionals,
              accept their authority, don’t go back in.
            </li>
          </ol>
          <p>
            The skeleton is the same; the specifics change with the emergency. Each one below is a
            quick-reference for the situations an apprentice realistically meets.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The protocol if you smell gas (sulphur / rotten eggs odour added by the gas
            distributor):
          </p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stop work.</strong> Don’t operate ANY electrical switch — not lights, not
              phones, not the consumer unit, not the meter.
            </li>
            <li>
            ...
            <li>
              <strong>Turn off the gas at the meter</strong> IF the meter is accessible AND you can
              do it without entering the leak area.
            </li>
            <li>
              <strong>Call 0800 111 999</strong> from outside the property. National Gas Emergency
              Service — free, 24/7, UK-wide. They dispatch the local gas distribution engineer.
            </li>
            <li>
          ...
          <p>
            <strong>Carbon monoxide</strong> is the silent killer — odourless, colourless, kills
            around 30 people a year in the UK. CO alarms are now mandatory in properties with any
            combustion appliance under the Smoke and Carbon Monoxide Alarm (England) Regulations
            2022. If a CO alarm is going off, treat it as gas leak protocol — evacuate, ventilate,
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              leak — and the GSIUR puts the duty to act on whoever is in the property, including a
              tradesperson working there. The "responsible step" is to evacuate and notify (0800 111
              999). Failure to act is a prosecutable offence.
            </>
          }
        ...
        >
          <p>
            The protocol if you witness a partial collapse (suspended ceiling, scaffold, wall,
            floor, dropped load):
          </p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stop. Get clear yourself first.</strong> Move yourself to a safe distance — at
              least the height of the structure away.
            </li>
            <li>
              <strong>Raise the alarm.</strong> Shout "collapse, evacuate", hit the fire alarm if
              there’s no specific evacuation alarm.
            </li>
            <li>
            ...
            <li>
              ...
              approximate scale, casualties trapped or visible. They’ll dispatch USAR (Urban Search
              and Rescue) — specialist Fire and Rescue teams trained for building-collapse
              extraction.
            </li>
            <li>
              <strong>Don’t enter the collapsed area.</strong> Even if you can hear a colleague.
              Voice contact only — shout encouragement, ask if they can move, relay status to 999.
              Don’t try to lift debris or crawl in.
            </li>
            <li>
            ...
            <li>
              <strong>Cordon the area</strong> until the fire service or HSE inspector releases it.
              Preserve the scene — there’ll be an investigation (covered in §6.4).
            </li>
          </ol>
          <p>
            <strong>Why no rescue?</strong> Because you don’t have the equipment to assess what’s
            about to fail next, and a second collapse on top of you means there are now two
            casualties, both inaccessible. USAR teams have shoring kit, atmospheric monitoring,
            search dogs and the trained eye to read the structure. Wait for them.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Workmate is half-trapped under a section of fallen ceiling. You go in, start lifting
              tiles, trying to get to him. The next bay’s bracket fails because the load shifted
              when you moved the first piece. Now you’re both under it. The fire service finds two
              casualties instead of one, and it takes them twice as long to extract.
            </>
          }
          doInstead={
            <>
              Voice contact only. Tell the trapped colleague help is on the way, ask if they can
              describe their injuries, keep talking to them. Get others out, call 999, brief on
              arrival. Yes it feels wrong to "stand and watch" — but it’s the response that gets the
              most people out alive. Trained USAR teams will do the extraction safely.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>30/30 rule:</strong> if thunder follows lightning within 30 seconds, take
              shelter. Wait 30 minutes after the LAST thunder before going back up.
            </li>
            <li>
              Get OFF roofs, scaffold, masts, anything elevated. Avoid open spaces, single trees,
              metal fences.
            </li>
            <li>
              Best shelter: substantial building. Second best: car / van with metal roof (Faraday
              cage). Worst: open ground, pylon shelter, under a tree.
            </li>
            <li>
              Lightning strike casualties — DR ABC, 999, CPR if needed. Casualties are NOT live
              after the strike (charge dissipates instantly).
            </li>
          </ul>
          <p>
            <strong>Heat exhaustion / heat stroke:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heat exhaustion</strong> (early stage): pale, clammy, headache, weak, heavy
              sweating. → cool place, loosen clothes, cool water to drink, damp cloths on neck and
              wrists. Should improve in 30 min.
            </li>
            <li>
              <strong>Heat stroke</strong> (medical emergency, 40°C+ core temp): confusion, hot dry
              skin (sweating may stop), rapid breathing, can lose consciousness or fit. → 999
              immediately. Aggressive cooling — wet sheets, fans, ice packs in armpits and groin,
              hose if available.
            </li>
            <li>
              Recent UK summers have produced multiple construction fatalities from heat stroke.
              Don’t assume British weather can’t kill — it has.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Confusion, slurred speech, intense shivering (then stopping — bad sign), pale cold
              skin, slow pulse.
            </li>
            <li>
              → indoors, off cold surfaces, dry layers, warm (not hot) drinks if conscious, gradual
              rewarming.
            </li>
            <li>
              Severe hypothermia (under 32°C, unconscious) → 999, gentle handling, slow rewarming
              under medical guidance — rewarming too fast can trigger cardiac arrest.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Suspect packages — the HOT protocol:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>If it scores on H/O/not-T → treat as suspicious.</li>
          </ul>
          <p>
            <strong>Then the 4 Cs:</strong>
          </p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Clear</strong> the area — evacuate at least 100 m away if outside, or to the
              far side of a substantial building if indoors.
            </li>
            <li>
            ...
            <li>
              <strong>Control</strong> — call 999 (police), brief them, follow their instructions.
              They’ll dispatch EOD (Explosive Ordnance Disposal) if needed.
            </li>
          </ol>
          <p>
            <strong>Aggression on site:</strong> de-escalate calmly if safe, position yourself
            between the person and the exit (you keep your escape route), don’t crowd them, don’t
            turn your back. If they have a weapon or won’t calm — leave, raise the alarm, lock
            yourself in a room if you have to, call 999. Don’t try to physically restrain — it’s
            outside your training and your insurance.
          </p>
          <p>
            <strong>Anti-Terrorism Hotline:</strong> 0800 789 321 — for non-emergency intelligence.
            999 if there’s an immediate threat.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The Office for National Statistics has consistently found that male construction workers
            under 45 have one of the highest suicide rates of any UK occupational group —
            significantly above the national male average. The reasons are well understood: long
            hours, lone working, sub-contracting precarity, machismo culture that discouraged
            talking, and (until recently) almost no occupational mental health support.
          </p>
          <p>
            This has changed fast in the last 5–10 years. Mental health first aid is now required on
            most major construction sites. Industry charities have stepped up. Helplines are free
            and 24/7.
          </p>
          <p>
            <strong>The routes to help, by urgency:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Immediate danger of self-harm or suicide:</strong> 999. This is a medical
              emergency, same as a heart attack. Do not leave the person alone.
            </li>
            <li>
            ...
            <li>
              ...
              Construction Industry Charity — 0345 605 1956, 24/7 helpline + financial support
              specifically for construction workers and families.
            </li>
            <li>
              <strong>Ongoing support:</strong> GP, NHS Talking Therapies (self-referral), EAP if
              your firm has one, occupational health.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Listen.</strong> Don’t fix, don’t lecture, don’t minimise ("could be worse").
              Just listen.
            </li>
            <li>
              <strong>Take it seriously.</strong> If they mention suicide, ask directly — "are you
              thinking about ending your life?" Asking doesn’t plant the idea. Knowing the answer
              changes what you do next.
            </li>
            <li>
              <strong>Signpost.</strong> Get them the right helpline number. If they’re in immediate
              danger, don’t leave them — call 999 with them.
            </li>
            <li>
              <strong>Confidentiality bends when life is at risk.</strong> Tell them you can keep
              most things private but you can’t keep secrets that put their life at risk — and
              you’re going to make sure they get the help they need.
            </li>
            <li>
              <strong>Look after yourself afterwards.</strong> Hearing this from a colleague is
              heavy. Talk to a mental health first aider, your line manager, your own GP, or one of
              the helplines yourself.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Mental health risk is a HASAWA risk — not a soft "wellbeing" extra. Employers must
              assess and manage stress, support workers in crisis, and provide access to help.
              Bigger sites and major contractors are expected to have mental health first aiders
              trained and named, and to publish helpline information widely. If yours doesn’t, ask
              why.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pre-job dynamic risk assessment.</strong> Is this property safe to enter
              alone? (Hostile customer, dodgy structure, isolated location, unknown dog?) Walk away
              if it isn’t.
            </li>
            <li>
              <strong>Tell someone where you are.</strong> Office, partner, mate. Job address,
              expected start and finish times.
            </li>
            <li>
              <strong>Scheduled check-ins.</strong> Text on arrival, on departure, every couple of
              hours during long jobs. Lone-worker apps (Skyguard, StaySafe, Reliance Protect)
              automate this and add a panic button.
            </li>
            <li>
              <strong>Escalation path.</strong> If you miss a check-in by more than X minutes, the
              office calls. If no answer, they call 999 and dispatch help to the address.
            </li>
            <li>
              <strong>Carry the right kit.</strong> Phone with charge, first aid, water, in cold
              weather a foil blanket. The basics that turn an hour-long wait for rescue into a
              survivable one.
            </li>
          </ul>
          <p>
            The system only works if you USE it. Every missed check-in that turns out to be "I
            forgot" trains the office to ignore the next missed check-in too.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You’re halfway through swapping a CU in a customer’s kitchen. The CU cover’s off,
              you’re stripping back tails, the breaker’s out and locked off. The customer comes in
              and says "I’m smelling gas in the back room — can you have a look?" There’s a definite
              sulphur smell when she opens the door.
            </>
          }
          whatToDo={
            <>
              <strong>STOP.</strong> Do not put the CU cover back on. Do not operate the main switch
              (creating a spark). Tell the customer to leave the property and stay outside. You
              leave too — taking phone, keys, nothing else. Open windows and doors on the way out IF
              you can do that without operating any switches. Once outside, call 0800 111 999
              (National Gas Emergency Service). They’ll dispatch an engineer. Do not re-enter until
              the engineer says it’s safe. Once safe, you can return to finish the CU job — but the
              gas leak is the urgent thing and your CU work is irrelevant until it’s sorted. Note
              the incident in your day notes, and let your supervisor know.
            </>
          }
          whyItMatters={
            <>
              A small leak in a confined room can hit LEL fast. Operating a switch (any switch, not
              just the main switch you’re about to use) is enough to ignite it. The "no spark" rule
              is absolute around suspected gas leaks — it doesn’t care that you’re mid-job. Get out,
              ventilate from outside, call. Letting the customer "have a quick look" with you is the
              wrong answer; so is trying to isolate gas yourself if you’re not Gas Safe.
            </>
          }
        />
        ...
        <ConceptBlock title="The thread through everything you’ve covered">
          <p>
            Module 1 has taken you from the Big Law (HASAWA in §1) through electrical hazards (§2),
            PPE (§3), site safety (§4), safe isolation (§5) and emergency response (§6). The thread
            running through all six sections is the same:{' '}
            <em>
              UK electrical work is safe by design when it’s done by the rules, and the rules exist
              because the lessons were paid for in blood
            </em>
            .
          </p>
          <p>
            You don’t need to learn all of it word-for-word. You need to know the SHAPE of it well
            enough to recognise when something’s going wrong and act. The next module shifts gear
            into electrical principles — the science behind why the regs are the regs. Same
            approach: learn the shape, build the muscle memory, ask when you’re not sure.
          </p>
          <p>
            Final thing: every emergency in this section gets easier the more you’ve thought about
            it BEFORE it happens. Don’t wait for the day. Run the scenarios in your head on the
            drive home. Know where the alarms, isolators and exits are on every site. The first time
            you do this for real should not be the first time you’ve done it at all.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Module 1 told you how to stay alive around 230 V and 400 V. Module 2 explains why 230 V
            at 50 Hz exists in the first place, where it comes from, and what it’s doing inside
            every conductor, terminal and protective device you’ll ever fit.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Maths and SI units</strong> — fractions, percentages, transposition, ratios,
              the seven SI base units, the prefixes (k, M, m, μ) and the instruments you’ll measure
              with. The maths the rest of the trade is written in.
            </li>
            <li>
              <strong>Basic mechanics</strong> — mass vs weight, force and Newtons, levers, gears,
              pulleys, work, energy, mechanical power, efficiency. The physics that shows up
              wherever you lift, hoist or torque on site.
            </li>
            <li>
              <strong>Electron theory, resistance, voltage and current</strong> — opening a
              conductor up and showing you what’s actually moving inside it. Conductors, insulators,
              resistivity, voltage drop, thermal and chemical effects.
            </li>
            <li>
              <strong>DC circuits — series, parallel and power</strong> — Ohm’s law in the wild,
              current and voltage division, total resistance in real circuits, P = I²R, worked
              examples that you’ll meet on every cable calc.
            </li>
            <li>
              <strong>Magnetism and electromagnetism</strong> — magnets, flux, the magnetic effect
              of a current, induction, EMF, the AC generator, sine waves at 50 Hz. Where AC actually
              comes from.
            </li>
            <li>
              <strong>Electronic components in electrical systems</strong> — resistors, diodes,
              capacitors, transistors, sensors and the on-site electronics inside every relay, RCD,
              AFDD and SPD on the board.
            </li>
          </ul>
          <p>
            Module 2 starts properly — every formula you’ll meet for the next 30+ Subs builds on it.
          </p>
        </ConceptBlock>
        ...
        <Quiz
          title="General workplace emergency procedures — knowledge check"
