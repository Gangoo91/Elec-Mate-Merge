...
const TITLE = 'Fire emergency procedures | Level 2 Module 1.6.5 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    question: 'A laptop charger is on fire on the bench — which extinguisher class do you grab?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Fire alarm, evacuation, the six fire classes and the right extinguisher for each, the PASS
          technique, and the special cases — lithium-ion, switchgear arc, hot works — that need
          careful handling.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Water</strong> — cools the fuel below its ignition temperature. Removes HEAT.
            </li>
            <li>
              <strong>Foam</strong> — forms a blanket over the fuel, sealing in the vapours. Removes
              OXYGEN (and provides some cooling).
            </li>
            <li>
              <strong>CO₂</strong> — displaces oxygen in the immediate area. Removes OXYGEN.
            </li>
            <li>
              <strong>Dry powder</strong> — interrupts the chemical chain reaction of combustion.
              Knocks out the fourth side of the tetrahedron.
            </li>
            <li>
              <strong>Wet chemical</strong> — saponifies hot oil into a soap-like foam. Removes
              OXYGEN and cools.
            </li>
          </ul>
          <p>
            Choosing the wrong one doesn’t just fail to put the fire out — it can make things much
            worse. Water on hot oil flash-explodes. Water on live electricity conducts the fault
            back through the spray to you. Foam on a Class D metal fire reacts violently. Match the
            extinguisher to the class.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              <strong>WATER (red label)</strong> or <strong>FOAM (cream label)</strong>. Both cool
              and smother. Most common workplace fire.
            </li>
            <li>
              ...
              <strong>DRY POWDER (blue)</strong>. Never water — water sinks below the liquid and
              pushes it around, spreading the fire.
            </li>
            <li>
              <strong>Class C — Flammable gases</strong> (LPG, butane, methane). Default tactic:{' '}
              <strong>ISOLATE THE SUPPLY</strong> (close the valve, isolate at the meter), then
              evacuate. Most UK extinguishers don’t carry a Class C rating because extinguishing
              without isolation leaves an unburned gas cloud waiting for an ignition source.
            </li>
            <li>
              <strong>Class D — Combustible metals</strong> (sodium, magnesium, lithium, titanium).
              Use: <strong>SPECIALIST DRY POWDER (Class D powder, e.g. M28 or L2)</strong>. Standard
              ABC powder doesn’t work and water reacts violently. Rare in domestic / commercial
              sites; common in lab and industrial settings.
            </li>
            <li>
              <strong>Class F — Cooking oils and fats</strong>. Use:{' '}
              <strong>WET CHEMICAL (yellow label)</strong>. Saponifies the oil into foam. Never
              water (steam explosion), never foam (sinks and spreads).
            </li>
            <li>
              <strong>Electrical (live equipment)</strong>. Use: <strong>CO₂ (black)</strong> —
              non-conductive, leaves no residue, won’t damage nearby electronics. Dry powder also
              rated for electrical but it goes everywhere and ruins kit. Water and foam are
              CONDUCTIVE — never on live equipment.
            </li>
          </ul>
          <p>
            Once you’ve isolated the supply (drop the main switch), the electrical risk is gone and
            you can treat the fire by whatever the burning material is — usually Class A. But while
            it’s live, CO₂ first.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Since 1997, all UK extinguishers have been red bodied with a coloured panel on the
              front. Memorise the five panel colours — they’re the same on every site, in every
              building, every time. The panel also lists the fire classes the extinguisher CAN be
              used on, plus an electrical-rating icon if applicable.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>P — Pull the safety pin.</strong> Located near the handle, usually with a tag.
              The pin locks the handle — pull it before squeezing or nothing happens.
            </li>
            <li>
              <strong>A — Aim at the BASE of the fire.</strong> Not the flames. The base contains
              the fuel — that’s what needs to be cooled, smothered or starved of oxygen. Aiming at
              the flames does nothing useful.
            </li>
            <li>
              <strong>S — Squeeze the handle.</strong> Slow, steady pressure. Most extinguishers
              will discharge their entire contents in 8–15 seconds — don’t waste them with
              intermittent bursts.
            </li>
            <li>
              <strong>S — Sweep side to side.</strong> Cover the whole base of the fire, working
              back-to-front. Keep going until the fire is out OR the extinguisher is empty OR you
              have to retreat.
            </li>
          </ol>
          <p>
            <strong>If the extinguisher empties and the fire isn’t out — get out.</strong> Don’t
            waste time going for a second one. Close doors behind you to slow the fire, raise the
            alarm if you haven’t already, evacuate.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The Home Office figures show that workplace fires kill more people through attempted
            firefighting that goes wrong than through evacuation that takes too long. The four
            pre-conditions before you even consider tackling a fire:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              The alarm has already been raised (you’ve hit the manual call point or someone else
              has).
            </li>
            <li>
              The fire is small (incipient — wastebasket, single appliance, small spill — NOT
              room-engulfed).
            </li>
            <li>You’re trained on the type of extinguisher and the type of fire.</li>
            <li>
              You have a clear escape route behind you — fire never between you and the exit. If you
              can’t back away, you can’t fight.
            </li>
          </ul>
          <p>
            If ANY of those four is missing — get out. The HSE’s Fire Safety guidance is clear that
            no piece of equipment, no document, no work-in-progress is worth your life. Things can
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Stop work immediately.</strong> Make safe what you can in seconds — turn off
              torches, drop tools — but do NOT pack up.
            </li>
            <li>
              <strong>Leave by the nearest safe exit.</strong> Use the stairs, never the lift. Touch
              doors with the back of your hand before opening — heat means fire on the other side.
            </li>
            <li>
              <strong>Close doors behind you</strong> as you go (slows fire spread). Don’t lock
              them.
            </li>
            <li>
              <strong>Go to the assembly point.</strong> Specified at site induction. NOT the car
              park, NOT the pub, NOT the van.
            </li>
            <li>
              <strong>Report to your supervisor / fire warden.</strong> Roll call confirms everyone
              is out. If you wander off, the fire service may go back into a burning building
              looking for you.
            </li>
            <li>
              <strong>Stay at the assembly point</strong> until told it’s safe to return OR released
              by the fire warden. Don’t go back for tools / phone / anything.
            </li>
          </ol>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The RRFSO is the master fire-safety law in England and Wales (Scotland and Northern
              Ireland have similar parallel legislation). It puts the duty on the "responsible
              person" — usually the employer or person in control of premises — to do a fire risk
              assessment, keep it current, provide alarms / extinguishers / signage, train staff,
              and have a documented evacuation plan. As an apprentice, you’re entitled to know all
              of this — ask at induction.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>Raise the fire alarm. Get the building evacuating.</li>
            <li>
              Isolate at the main switch upstream of the fire — drop it whether or not it’s "yours"
              to operate. Lock-off after if you have time.
            </li>
            <li>
              If the CU itself is the source AND you can’t isolate above it, isolate at the MEM
              cut-out by pulling the company fuse — only if competent and safe to do so. Otherwise
              call the DNO (105) and the fire service.
            </li>
            <li>
              If the fire is still small after isolation: CO₂ extinguisher, PASS technique, stand
              back from the rapidly-cooling enclosure (CO₂ horn drops to about -78°C — metal
              contracts, can crack).
            </li>
            <li>
              If the fire is bigger than incipient — get out. CU fires can punch through
              plasterboard fast and the smoke from burning insulation is genuinely toxic. Fire
              service.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              Dispersion) or specialist Li-ion encapsulators. These are increasingly common on
              EV-charging sites and battery-storage installations.
            </li>
            <li>
              <strong>Copious cooling water</strong> — large volumes, sustained, until the cell
              temperature drops below thermal-runaway threshold. Domestic extinguishers don’t carry
              enough.
            </li>
            <li>
              <strong>Isolation and containment</strong> — get the burning device outside if you can
              do it safely. Concrete floor, away from anything else flammable. Let it burn out under
              fire-service supervision.
            </li>
            <li>
              <strong>Evacuate and call 999</strong> — the default if the fire isn’t controlled in
              seconds. Fumes from burning Li-ion include hydrogen fluoride and other genuinely
              dangerous gases. Don’t hang around to "watch".
            </li>
          </ul>
          <p>
            Standard CO₂, dry powder and water extinguishers will all FAIL on a sustained Li-ion
            fire. They might knock the flames down briefly but the cells re-ignite as soon as the
            agent disperses. The only durable solution is cooling the cells below the runaway
            threshold — which usually means the fire service with a hose.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Foam extinguisher on a chip-pan fire. The foam sinks into the hot oil, water content
              flashes to steam, oil ejects everywhere, and a small kitchen fire becomes a
              kitchen-engulfing fire that takes the ceiling. Or: water extinguisher on a live
              electrical fire — the spray gives you a 230 V shock through the water column.
            </>
          }
          doInstead={
            <>
              Take the two seconds to check the panel — colour and the icons of fire classes it’s
              rated for. If you’re not sure of the class, default to evacuate. The wrong
              extinguisher is worse than no extinguisher in many cases. Better-trained companies put
              a quick-reference sticker next to each extinguisher showing what it is and what it’s
              for.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re second-fixing on a commercial fit-out. A delivery of cordless impact drivers
              arrived this morning — about 30 batteries on charge in the corner. You smell something
              acrid; one of the chargers is smoking, and as you turn round one of the battery packs
              starts venting white-yellow smoke and hissing. Within seconds it’s on fire. The site
              has standard CO₂ and water extinguishers in the corridor.
            </>
          }
          whatToDo={
            <>
              Hit the fire alarm immediately. Shout for evacuation. Do NOT engage with standard
              extinguishers — CO₂ will displace flames briefly but Li-ion cells self-oxidate and
              will re-ignite. Water in domestic-extinguisher quantities is useless and conducts back
              the live charger circuit. <strong>Get out.</strong> On the way past, isolate the
              chargers at the wall socket if you can do it in under 5 seconds without going past the
              fire. Once at the assembly point, brief the fire service on arrival: "lithium-ion
              battery thermal runaway, charging rack, approximately 30 batteries". They have
              specialist tools and training. Don’t go back in.
            </>
          }
          whyItMatters={
            <>
              Li-ion thermal runaway is increasingly common on fit-outs because of cordless tool
              culture, e-bikes / e-scooters charging on site, and EV / solar storage installations.
              The lethal mistake is treating a Li-ion fire like a normal Class A or electrical fire.
              The fumes alone (hydrogen fluoride, carbon monoxide) can kill at concentrations small
              enough to be inside a single room. Get out, call 999, brief the fire service.
            </>
          }
        />
        ...
        <ConceptBlock title="Hot works permits — angle grinders, soldering, blowtorches">
          <p>
            Most insurance and most site H&S regimes require a hot works permit for any activity
            that produces sparks, flames or significant heat — angle grinding, cutting metal
            trunking with a disc, soldering joints, brazing, pipe-thawing torches, even a
            heat-shrink gun in some interpretations. The permit:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Confirms the area is clear of combustibles (or that combustibles have been shielded
              with fire blankets).
            </li>
            <li>
              Specifies a fire watch (a person standing by with an extinguisher, often for an hour
              AFTER the work finishes — embers can smoulder for 30 minutes plus).
            </li>
            <li>Specifies the extinguisher type, location and capacity.</li>
            <li>Has a defined start and end time — work outside the permit window is a breach.</li>
            <li>Names the worker doing the hot works AND the fire watch.</li>
          </ul>
          <p>
            As an apprentice you may be asked to act as a fire watch. Take it seriously — your job
            is to look at the work area, not at your phone. If anything starts to smoulder, tackle
            small / get out big.
          </p>
        </ConceptBlock>
