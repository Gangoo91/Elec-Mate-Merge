...
const TITLE = 'RIDDOR — what must be reported | Level 2 Module 1.6.3 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Over-7-day injury', 'Specified injury', 'Dangerous occurrence', 'No report needed'],
    correctAnswer: 0,
    explanation:
  ...
  {
    id: 8,
    question: 'What is the difference between the company accident book and a RIDDOR report?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The legal duty to report serious accidents to the HSE. The four reportable buckets, the
          clocks, who reports, the F2508 form, and what happens if you’re late.
        </p>
        ...
        <ConceptBlock title="RIDDOR is a regulation made under HASAWA — not a separate law">
          <p>
            The Reporting of Injuries, Diseases and Dangerous Occurrences Regulations 2013 are a
            statutory instrument under HASAWA. They set out a legal duty on the "responsible person"
            to notify the HSE — or in some sectors the local authority — when certain serious
            workplace incidents happen.
          </p>
          <p>
            The point isn’t paperwork. It’s pattern-spotting. The HSE uses RIDDOR data to direct
            inspections, publish industry guidance, push enforcement against persistent offenders,
            and decide where to focus resources. A scaffolding firm with three fall-from-height
            RIDDORs in a year is an inspection target. A switchgear range with multiple
            electrical-burn RIDDORs across the country is a manufacturer call-in.
          </p>
          <p>
            For you as an apprentice, RIDDOR almost never lands on your desk personally — but you
            will witness incidents, and you have to know what triggers a report so you can flag it
            to the supervisor while there’s still time on the clock.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              Contact Centre at the earliest practical moment (0345 300 9923 in hours, same number
              out-of-hours routes to a duty officer), confirm in writing on F2508 within 10 days.
              Reg 5 covers specified injuries, Reg 6 over-7-day, Reg 7 dangerous occurrences, Reg 8
              occupational diseases, Reg 9 gas-related.
            </>
          }
        ...
        >
          <p>
            This bucket also includes deaths caused by acts of physical violence at work, and the
            death of any self-employed person killed working on someone else’s premises. Reporting
            is by quickest practical means — phone — followed by F2508 within 10 days.
          </p>
          <p>
        ...
        >
          <p>
            Schedule 1 of RIDDOR 2013 lists eight categories of specified injury. The big ones for
            electrical work:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Permanent loss of sight</strong> or reduction of sight, or temporary blindness
              from an arc flash.
            </li>
            <li>
              <strong>Crush injuries</strong> to the head or torso causing damage to the brain or
              internal organs.
            </li>
            <li>
            ...
            <li>
              <strong>Scalpings</strong> (loss of skin from the scalp) requiring hospital treatment.
            </li>
            <li>
              <strong>Loss of consciousness</strong> caused by head injury or asphyxia (including
              from electric shock).
            </li>
            <li>
              Any other injury arising from work in an enclosed space leading to
              <strong>hypothermia, heat-induced illness</strong> or requiring resuscitation or
              admission to hospital for more than 24 hours.
            </li>
          </ul>
          <p>
            Specified injuries are reported "without delay" and the F2508 must be in within 10 days.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            light alternative duties (filing paperwork instead of climbing ladders) is still counted
            as incapacitated for RIDDOR.
          </p>
          <p>
            Over-7-day injuries report on the F2508 within 15 days of the accident. The extra 5 days
            vs specified injuries is to give time for it to become clear the casualty isn’t coming
            back to normal work quickly.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Schedule 2 lists 27 specific dangerous occurrences. The ones most relevant to electrical
            work:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electrical short or overload</strong> causing fire or explosion that stops
              plant for more than 24 hours OR has the potential to cause death.
            </li>
            <li>
              <strong>
                Collapse, overturning or failure of load-bearing parts of lifts or lifting
                equipment.
              </strong>
            </li>
            <li>
              <strong>Unintended collapse</strong> of any building or structure under construction
              (or part of one) involving a fall of more than 5 tonnes of material.
            </li>
            <li>
              <strong>Unintended explosion</strong> of pressure vessels.
            </li>
            <li>
              <strong>Accidental release of biological agents</strong> capable of causing severe
              human disease.
            </li>
            <li>
              <strong>Unintentional release of any substance</strong> liable to cause harm to the
              public.
            </li>
          </ul>
          <p>
            Dangerous occurrences are reportable WITHIN 10 DAYS. They report on the F2508 same as
            specified injuries.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Employee injured on a third party’s premises:</strong> still the EMPLOYER. The
              fact you were on a customer’s premises doesn’t shift the duty.
            </li>
            <li>
              <strong>Self-employed electrician working on someone else’s premises:</strong> the
              PERSON IN CONTROL of those premises is the responsible person. Usually the principal
              contractor or site owner.
            </li>
            <li>
              <strong>Self-employed electrician working on their own premises:</strong> THEMSELVES.
            </li>
            <li>
              <strong>Member of the public injured by a work activity:</strong> the EMPLOYER or
              person in control of the work activity.
            </li>
          </ul>
          <p>
            As an apprentice, you’re an employee — your employer is the responsible person, even
            when you’re on a customer’s site. Your job is to flag the incident internally fast
            enough that the boss can hit the legal clock.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              form for each bucket (injury, dangerous occurrence, gas, disease). Generates an F2508
              reference number on submission. This is the route to use for everything except fatals.
            </li>
            <li>
              <strong>Telephone for fatals:</strong> HSE Incident Contact Centre, 0345 300 9923.
              Used to be the route for everything urgent — now mainly for fatals. Followed by the
              online F2508 within 10 days.
            </li>
          </ul>
          <p>
            The form needs: details of the responsible person, the casualty (where there is one),
            the location and time, what happened, what caused it, what the injury was, what the
            outcome was, and details of any witnesses. Keep notes from the day so this can be filled
            in accurately later.
          </p>
          <p>
            <strong>Keep a copy of the report for at least three years.</strong> Required by RIDDOR
            Reg 12.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The HSE can ask to see RIDDOR records during an inspection — usually as part of
              investigating a later incident. Three years is the minimum, but most companies keep
              them indefinitely as part of the company H&S file. Keep your own personal copy of any
              incident you’re a witness or casualty for — useful if a civil claim arises later.
            </>
          }
        ...
        >
          <p>
            ...
            Security (Claims and Payments) Regulations. It’s an internal record of every workplace
            accident — first-aid only events, near-misses, the lot. Used for internal
            trend-spotting, supervisor sign-off, and any later insurance or Industrial Injuries
            claim by the casualty.
          </p>
          <p>
            The RIDDOR report is a separate, EXTERNAL legal notification to the HSE. Only the four
            serious buckets (death / specified injury / over-7-day / dangerous occurrence) trigger
            one.
          </p>
          <p>
            <strong>Sequence:</strong> accident → first aid → accident book entry IMMEDIATELY →
            supervisor briefed → if it hits a RIDDOR bucket, employer files F2508 within the
            relevant window. The book entry happens for everything; the F2508 only for the serious
            stuff.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice falls off a stepladder Monday. Sprained wrist, off Tuesday and the rest of
              the week. Over the following weekend it’s clear he’s not going to be back in normal
              duties this week either. Now you’re into day 8, day 9, day 10 of incapacity. By the
              time someone clocks "ah, this is RIDDOR territory" and starts the form, it’s already
              11–12 days since the original accident. The 15-day clock for over-7-day injuries
              doesn’t care that you only realised it was reportable last Friday — it started ticking
              on Tuesday. File late and you’re also breaching Reg 6.
            </>
          }
          doInstead={
            <>
              Treat any "off normal duties" injury as a candidate RIDDOR from day 1. The appointed
              person should diary a check at day 7 — if the casualty isn’t back to normal duties by
              then, prep the F2508 in case it tips over. If they recover early, you bin the prep —
              no harm done. If they don’t, the report goes in on day 8 not day 12.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Your supervisor asks: "the labourer who tripped on the cable on Wednesday — he was off
              Thursday, Friday, didn’t work the weekend, came back Monday but on light duties only.
              Is that one a RIDDOR?"
            </>
          }
          whatToDo={
            <>
              Walk through the buckets. Death? No. Specified injury (Sched 1)? No — it was a bruise,
              no fracture, no unconsciousness. Over-7-day? Day of accident (Wednesday) excluded.
              Days off normal duties: Thu, Fri (didn’t work weekend so Sat/Sun don’t count — he
              wasn’t SCHEDULED to work them), Mon on light duties = still incapacitated for
              over-7-day purposes. So that’s 3 days incapacitated so far. Not yet over 7. Dangerous
              occurrence? No. <strong>Not RIDDOR yet.</strong> BUT: accident book entry is mandatory
              regardless. AND if the labourer is still on light duties through to next
              Wednesday/Thursday, he tips over the seven-day mark and IT BECOMES RIDDOR. Diary it.
              Check on day 7. The 15-day clock will already be running by then.
            </>
          }
          whyItMatters={
            <>
              The numbers seem fiddly until they bite you. The over-7-day rule is the most commonly
              under-reported RIDDOR category in the UK because supervisors think "the casualty is
              back at work, no big deal" without realising "back on light duties" still counts as
              incapacitated. When the HSE digs into a workplace later they will absolutely
              cross-check accident book entries against RIDDOR submissions and ask why the gap.
            </>
          }
        />
        ...
        <ConceptBlock title="What you do as an apprentice in the system">
          <p>
            You’re unlikely to be the person submitting the F2508. Your job in the RIDDOR chain is:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Witness an incident → tell the supervisor immediately.</strong> Don’t wait for
              end-of-day, don’t wait for the casualty to recover, don’t wait to "see if it gets
              worse". Every clock starts from the time of the incident.
            </li>
            <li>
              <strong>Make sure the accident book entry happens.</strong> If you’re the casualty,
              write it up yourself (BI 510 form, or the company digital equivalent). If you
              witnessed it, prompt the casualty / supervisor.
            </li>
            <li>
              <strong>Note details while they’re fresh.</strong> Time, location, what was being
              done, what was used, who was there, what state the equipment was in. A page in the
              back of your notebook beats relying on memory two weeks later.
            </li>
            <li>
            ...
            <li>
              <strong>Get your own copy of any RIDDOR report you’re named in.</strong> If a civil
              claim or workplace dispute happens later, it’s yours to refer back to.
            </li>
          </ul>
        </ConceptBlock>
