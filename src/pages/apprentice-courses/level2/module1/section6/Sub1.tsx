...
const TITLE = 'First response to electric shock | Level 2 Module 1.6.1 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  {
    id: 8,
    question: 'You’ve treated the casualty, paramedics have taken them. What about the scene?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The first 60 seconds when a mate gets caught on a live conductor. Isolate first, DR ABC,
          recovery position, when to start CPR. Don’t end up as casualty number two.
        </p>
        ...
        <ConceptBlock title="Around 30 UK electrical fatalities a year — most are 230 V, most are at work">
          <p>
            The HSE records around <strong>1,000 electric-shock and burn accidents</strong> at UK
            workplaces every year, and roughly <strong>30 of those are fatal</strong>. Almost all of
            them happen at "low" voltage — 230 V single-phase or 400 V three-phase, the same
            supplies an apprentice meets every day. The killer isn’t exotic voltages. It’s the
            everyday stuff handled badly.
          </p>
          <p>
            Section 2 of this module covered what electricity does to a body — the thresholds, the
            burns, the fibrillation. This subsection covers what YOU do in the first sixty seconds
            when it’s already happened. Treat it like fire drill — rehearse the order now, so you’re
            not making it up under pressure later.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The order of operations the first time you find someone in contact with a live source:
          </p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Isolate the supply.</strong> Main switch, the relevant MCB, the plug —
              whichever drops it fastest. Lock it off if you’ve got the kit on you. If you haven’t,
              leave a clear warning at the isolation point so nobody flips it back on.
            </li>
            <li>
              <strong>Check for danger before approaching.</strong> Tools resting on the conductor?
              Anything else live nearby? A ladder about to fall? Make the area safe before kneeling
              next to anyone.
            </li>
            <li>
              <strong>DR ABC primary survey.</strong> See the next block. Don’t skip steps, don’t do
              them out of order.
            </li>
            <li>
              <strong>Call 999.</strong> Tell them "electrical injury" — paramedics bring cardiac
              monitoring on that call.
            </li>
            <li>
              <strong>Treat.</strong> Recovery position if breathing, CPR if not. Deal with burns
              once the bigger threats are handled.
            </li>
            <li>
              <strong>Hand over and preserve the scene.</strong> Brief the paramedics, lock off the
              supply, photograph if you can, brief the supervisor. Don’t tidy up.
            </li>
          </ol>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The HSE’s own first-line guidance — drill it into your head so it comes out under
              pressure. The order is supply OFF first, casualty second. If you genuinely can’t
              isolate (HV, fallen line, inaccessible main switch), use a dry, non-conducting object
              to break the contact. Never use anything metal, never anything damp.
            </>
          }
        ...
        >
          <p>
            DR ABC is the standard UK first-aid primary survey. It works because it forces you to
            deal with the things that kill fastest, first.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>D — Danger.</strong> Look at the scene before you walk in. Is the supply
              isolated? Anything else live? Anything about to fall? If you’re not safe, the casualty
              stops being your problem and you become a second one.
            </li>
            <li>
              <strong>R — Response.</strong> Talk to them. "Can you hear me, mate?" Squeeze their
              shoulder. If they respond — even just groaning — they’re conscious. If nothing,
              they’re unconscious; act accordingly.
            </li>
            <li>
              <strong>A — Airway.</strong> Tilt the head back gently, lift the chin. This opens the
              airway. If anything’s in the mouth (vomit, broken teeth, dentures), clear it.
            </li>
            <li>
            ...
            <li>
              <strong>C — Circulation.</strong> If they’re breathing normally → recovery position,
              monitor, call 999. If they’re not breathing or only gasping → start CPR, send someone
              for an AED.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Bring the other arm across the chest. Place the back of that hand against the cheek
            ...
            <li>
              Pull on the bent knee to roll the casualty towards you onto their side. Adjust so the
              upper leg is bent at right angles at the hip and knee.
            </li>
            <li>
              Tilt the head back gently to keep the airway open. Check breathing. Stay with them
              until paramedics arrive.
            </li>
          </ol>
          <p>
            If you have to leave them to call 999 (you’re alone, no phone signal nearby), recovery
            position FIRST, then go. Recheck breathing every few minutes — cardiac issues can
            develop after the initial shock.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Adult CPR, the way Resuscitation Council UK currently teaches it:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Hand placement:</strong> heel of one hand in the centre of the chest (lower
              half of the breastbone). Other hand on top, fingers interlocked.
            </li>
            <li>
              <strong>Depth:</strong> 5–6 cm, straight down. Arms locked, weight over the hands.
            </li>
            <li>
              <strong>Rate:</strong> 100–120 compressions per minute. The rhythm of the Bee Gees’
              "Stayin’ Alive" or Queen’s "Another One Bites the Dust" — both around 103 bpm.
            </li>
            <li>
              <strong>Ratio:</strong> 30 compressions then 2 rescue breaths if you’re trained in
              rescue breathing. If you’re not, hands-only CPR is fine — keep going.
            </li>
            <li>
              <strong>Don’t stop</strong> unless: the casualty starts breathing normally, a
              defibrillator is being attached, paramedics take over, or you’re too exhausted to
              continue. If there’s another trained person, swap every 2 minutes — proper CPR is
              exhausting.
            </li>
          </ul>
          <p>
            <strong>AED:</strong> if there’s a public-access defibrillator nearby, send someone for
            it. Switch it on, follow the voice prompts, peel the pads, stick them where the pictures
            show, stand clear when it tells you to. AEDs are designed to refuse to shock a
            non-shockable rhythm — you cannot make things worse.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              citizenship, military. They’re what 999 operators talk people through over the phone.
              Memorise them: <strong>30:2, 5–6 cm, 100–120 bpm</strong>.
            </>
          }
        ...
        <ConceptBlock title="Tell them it’s an electrical injury — it changes the response">
          <p>
            When you call 999, the operator triages the response. "Electrical injury" triggers a
            different protocol from "fall" or "general unwell" — paramedics dispatch with cardiac
            monitoring kit because heart rhythm issues are the most dangerous delayed effect of an
            electric shock.
          </p>
          <p>Give them, in this order:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Location.</strong> Postcode, house number / building name. Site name if it’s a
              construction site. What3Words is great if you’re on a remote site.
            </li>
            <li>
              <strong>Type of injury.</strong> "Electrical injury — adult, casualty was in contact
              with a 230 V supply." Mention "supply now isolated" if it is.
            </li>
            <li>
              <strong>Casualty status.</strong> Conscious / unconscious. Breathing / not breathing.
              Visible burns. Anything else relevant.
            </li>
            <li>
              <strong>Your number.</strong> Stay on the line. They will give you instructions. Don’t
              hang up.
            </li>
            <li>
              <strong>Send a gateway.</strong> If you can spare someone, post them at the gate or
              front door to wave the ambulance in. Saves minutes that matter.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You ring, you give the postcode, you say "he’s collapsed, hurry up". Paramedics roll
              up assuming a faint or a fall. They don’t bring the cardiac monitor up the stairs
              because nobody told them to. The casualty develops an arrhythmia twenty minutes later.
          ...
          doInstead={
            <>
              <strong>
                First sentence to the 999 operator should include "electrical injury".
              </strong>{' '}
              Mention the voltage if you know it. Confirm whether the supply is now isolated —
              paramedics need to know it’s safe to enter the scene. They’ll guide you on everything
              else.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Mate is locked onto a live tail. You see his face go grey. Instinct says grab. You
              grab. The current that’s flowing through him now finds a second path — through you,
              into the floor. You both hit the deck. The third-year who walks in a minute later is
              suddenly looking at two unconscious people and no idea what happened.
            </>
          }
          doInstead={
            <>
              The fastest possible action is the ISOLATION, not the rescue. Main switch, MCB, plug —
              whichever is closer. Most CUs are within arm’s reach of the work; most socket-fed
              tools have a plug a metre away.{' '}
              <strong>Touch the SWITCH first, the CASUALTY second.</strong>
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You come back from the van with a roll of T&E. Your work-mate is sat on the floor in
              front of an open consumer unit, head against the cabinet, eyes closed, screwdriver
              still in his hand. The cover’s off. The main switch is up — supply is still on. You
              can’t tell from the doorway whether he’s actually in contact with anything live.
            </>
          }
          whatToDo={
            <>
              <strong>Don’t walk in to "check" first.</strong> From the doorway, hit the main switch
              (right there in the unit, top of the bank). Take a breath. NOW go in. DR ABC — danger
              (supply off, no other live parts), response (talk to him, squeeze shoulder), airway,
              breathing. If breathing → recovery position. If not → CPR, shout for someone to call
              999 and grab the AED. Tell the operator: "
              <em>electrical injury, 230 V, supply now isolated, casualty unconscious</em>". When
              paramedics arrive, leave the scene as you found it (post-isolation), brief them, brief
              the supervisor. Burns get treated by the paramedic — you don’t need to start picking
              at them.
            </>
          }
          whyItMatters={
            <>
              Hand-to-hand across the chest at 230 V is the textbook fibrillation path. The person
              who turns up second is the one who decides whether it stays at one casualty or becomes
              two. You earn your place on site by being the second-in who gets it right.
            </>
          }
        />
        ...
        <ConceptBlock title="Hand-over, RIDDOR, and the bit nobody talks about">
          <p>
            Once the casualty is in safe hands and the scene is locked off, the job changes shape.
            Don’t go back to the work. Things that have to happen:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Preserve the scene.</strong> Lock-off stays in place. Photograph everything
              before anyone touches it — the test instruments used, the lock-off kit (or lack of),
              the cable ends, the screwdriver, the labels.
            </li>
            <li>
              <strong>Write down what you saw and did.</strong> Times, names, who said what. Memory
              fades fast and fades wrong. A page of notes the same day is worth a thousand
              recollections a fortnight later.
            </li>
            <li>
              <strong>Look after yourself.</strong> Watching a colleague go down isn’t nothing. Many
              firms now have access to confidential mental-health support — use it if you need to.
              There’s no medal for bottling it up.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Quiz
          title="First response to electric shock — knowledge check"
