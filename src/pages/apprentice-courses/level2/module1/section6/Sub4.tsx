...
const TITLE = 'Accident investigation and lessons learned | Level 2 Module 1.6.4 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'Which of the following is an example of an UNDERLYING cause of an accident?',
    options: [
  ...
  {
    id: 3,
    question: 'How many "whys" should you typically ask in a 5 Whys analysis?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Why incidents get investigated — to LEARN, not to blame. Root cause analysis, the 5 Whys,
          the four-stage HSE model, and how lessons learned actually change site behaviour.
        </p>
        ...
        <ConceptBlock title="Investigation is a learning tool, not a punishment exercise">
          <p>
            The HSE’s "Investigating accidents and incidents" (HSG245) is the canonical UK guide. It
            frames investigation as a way for an organisation to learn from what went wrong so that
            it doesn’t happen again — not as a way to identify the person to discipline.
          </p>
          <p>
            That distinction matters because the moment investigations are perceived as blame-hunts,
            near-misses stop being reported. People hide them because they don’t want to be the one
            in the meeting room. The company loses its early-warning system. The next near-miss
            becomes an incident; the incident becomes a fatality.
          </p>
          <p>
            Good investigations are matter-of-fact. They look at what happened, work out WHY, and
            produce a list of changes — to procedures, kit, training, supervision — that make the
            same thing harder to repeat. The casualty’s name barely features in the recommendations.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              If your workplace’s investigation process feels like a witch-hunt, that’s a cultural
              problem worth flagging. The HSE’s default position is that blame cultures kill workers
              — because they kill the reporting that catches the next near-miss. Companies that
              investigate well typically report MORE near-misses, not fewer.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Gather information.</strong> Photographs (before anything moves), witness
              statements (while memory is fresh — within hours, ideally), the state of the equipment
              as found, environmental conditions (weather, lighting, noise), relevant documents
              (RAMS, permits, training records, equipment maintenance logs).
            </li>
            <li>
              <strong>Analyse the information.</strong> Identify the immediate cause (what
              physically did the damage), the underlying causes (the conditions that allowed it),
              and the root cause(s) (the system-level gaps). Tools: 5 Whys, fishbone / Ishikawa
              diagram, fault-tree analysis for serious cases.
            </li>
            <li>
              <strong>Identify control measures.</strong> What changes will stop this happening
              again? Apply the hierarchy of control: eliminate → substitute → engineer out →
              administrative (procedure / training) → PPE. Engineering changes always beat
              procedural changes because they don’t rely on human memory.
            </li>
            <li>
              <strong>Action plan and implementation.</strong> Each control measure gets a named
              owner, a target date and a check-in date. Without these, the plan rots. Re-audit at
              the check-in date. Update the RAMS, brief the workforce, change the induction.
            </li>
          </ol>
          <p>
            For a minor accident this might take an hour and result in a tweak to the RAMS. For a
            fatal it could take months and produce a wholesale change in working practices. Same
            four stages, scaled to severity.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Underlying causes:</strong> Lock-off kit wasn’t used. The supply was still
              live during work. The voltage indicator wasn’t proved before/after. The electrician
              was working alone with no second-set-of-eyes check.
            </li>
            <li>
              <strong>Root causes:</strong> Lock-off kit was never issued to that crew. The
              supervisor doesn’t routinely check lock-off compliance. The site induction doesn’t
              cover lock-off. There’s informal pressure from the supervisor to "crack on" that
              overrides safe-isolation procedure on tight jobs.
            </li>
          </ul>
          <p>
            <strong>Fix the immediate cause</strong> ("isolate the supply for that job") and the
            next job has the same problem. <strong>Fix the underlying cause</strong>
            ("everyone uses lock-off this week") and it slides back next month when the pressure’s
            on. <strong>Fix the root cause</strong> (kit issued + induction updated + supervisor
            accountable + visible compliance metric) and the behaviour actually changes.
          </p>
          <p>
            The deeper you go, the more it costs to fix — but the more permanent the fix becomes.
            Most companies under-invest in root-cause fixes because the immediate cost is visible
            and the avoided-future-incidents cost isn’t.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <div className="rounded-lg bg-[hsl(0_0%_10%)] border border-white/[0.08] p-4 my-2">
            ...
            <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70 text-[13.5px] text-white">
              <li>
                <strong>Why?</strong> Because the supply was live when he opened the enclosure.
              </li>
              <li>
                <strong>Why was it live?</strong> Because the breaker hadn’t been tripped and locked
                off.
              </li>
              <li>
                <strong>Why hadn’t it been locked off?</strong> Because no lock-off kit was on the
                van.
              </li>
              <li>
                <strong>Why was no kit on the van?</strong> Because the last padlock was lost three
                weeks ago and never replaced.
              </li>
              <li>
                <strong>Why was it never replaced?</strong> Because there’s no process for reporting
                / re-stocking missing safety kit on the vans.
              </li>
            </ol>
            <p className="text-[13.5px] text-white mt-2">
              <strong>Root cause:</strong> No process to keep safety kit replenished on the vans.{' '}
              <strong>Fix:</strong> add a weekly van H&S check, with named owner, and a same-day
              re-supply route. Plus tighten the supervisor sign-off so jobs can’t start without
              confirmation that lock-off kit is on board.
            </p>
          </div>
          <p>
            Note that the answer never settled on "the apprentice was careless" — that would be
            Why-1 stopping point. The real cause sits at Why-5, in the company’s system. Fix THAT
            and the apprentice has the kit he needs next time.
          </p>
          <p>
            <strong>5 is a guideline, not a rule.</strong> Sometimes you reach a system cause in
            three. Sometimes it takes seven. Stop when the answer is something the company can act
            on — never when the answer is just a person’s name.
          </p>
        </ConceptBlock>
        ...
        >
          <p>For a typical electrical job, the layers might be:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Training and competence</strong> — the worker has the right qualifications and
              current refreshers.
            </li>
            <li>
            ...
            <li>
              <strong>Supervision</strong> — appropriate to the experience level of the worker.
            </li>
            <li>
              <strong>Site discipline</strong> — toolbox talks, peer challenge, near-miss reporting
              culture.
            </li>
            <li>
          ...
          <p>
            When all of these are working, even a moment of poor judgement gets caught by the other
            layers. When they all degrade together — RAMS not read, no permit, lapsed training,
            dodgy kit, absent supervisor, no toolbox talks — the holes line up and an accident
            happens. Fix the layers, not just the moment.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The Heinrich (1931) and Bird (1969) ratios are the classic accident-pyramid figures,
            refined over decades but broadly still standing. The numbers vary by industry and study
            — but the shape is what matters: most of the data sits in the "near-miss / unsafe
            condition" base, not in the rare fatal at the top.
          </p>
          <p>
            The implication is the foundation of modern safety practice:{' '}
            <strong>
              most fatalities are preventable IF the pyramid below them is being acted on
            </strong>
            . That’s why companies push so hard on near-miss reporting (covered in §6.5). Each
            near-miss is a free lesson — the casualty is hypothetical, the data is real, the fix is
            cheap.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Toolbox talks.</strong> Short (5–15 min), focused, ideally with the actual
              incident sketched out (anonymised). Delivered by the supervisor at the start of a
              shift. Signed attendance sheet so the company can prove it happened.
            </li>
            <li>
              <strong>RAMS updates.</strong> The Risk Assessment / Method Statement gets a new
              control measure added. New jobs use the updated version; existing crews get
              re-briefed.
            </li>
            <li>
              <strong>Site induction changes.</strong> New starters get the lesson built into their
              first-day brief.
            </li>
            <li>
              <strong>Bulletins / safety alerts.</strong> Industry-wide alerts (e.g. from a
              manufacturer, the HSE, an industry body) covering equipment defects or emerging risks.
              Worth subscribing to.
            </li>
            <li>
              <strong>Equipment changes.</strong> The most permanent fix — engineer the hazard out
              so the procedural lesson isn’t even needed (e.g. install lockable main switches as
              standard, replace old non-lockable CUs).
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Plan written, names attached, dates noted. Folder closed. Six months later the same
              near-miss happens because nobody checked whether the actions were actually done — kit
              on the vans, induction updated, supervisor checks happening. The plan was paperwork,
              not action.
            </>
          }
          doInstead={
            <>
              Every action gets a CHECK-IN DATE as well as a target date. At the check-in, someone
              (named, accountable) verifies the action is actually in place — not just signed off.
              Close-out happens on evidence (kit photo, induction screenshot, supervisor’s checklist
              signed) — not on the action-owner’s word.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Your firm’s done three RIDDORs and a string of internal investigations on near-misses
              involving a particular brand of MCB that’s tripping unexpectedly under load. After the
              first investigation, the action plan said "brief electricians to monitor and report
              further incidents". The brief was done. Six months later it’s happened again on a
              different site, same MCB type, this time someone falling off a ladder when the lights
              dropped.
            </>
          }
          whatToDo={
            <>
              The pattern says the original investigation found the immediate cause (faulty MCB
              type) but stopped short of fixing it. "Brief and monitor" is a documentation action,
              not a control measure — it doesn’t take the bad MCBs out of service. Re-investigate
              with a 5 Whys focus on why the original action was so weak. Likely root causes: nobody
              had authority to scrap a whole batch of stock; cost concerns blocked replacement;
              manufacturer hadn’t issued a recall so legally it was "good kit". Real fix: take the
              affected MCBs out of stock now, write to the manufacturer, raise it with the HSE for a
              potential industry alert, brief the workforce on identification and replacement during
              scheduled visits.
            </>
          }
          whyItMatters={
            <>
              ...
              indicate either that the original investigation didn’t find the root cause, or that
              the action plan was paperwork rather than action. Either way it’s a second chance —
              taking it can prevent the fourth incident becoming the first fatality.
            </>
          }
        />
        ...
        <ConceptBlock title="Your role isn’t to lead the investigation — it’s to enable a good one">
          <p>
            You’re very unlikely to be running an investigation yourself in your first couple of
            years. What you ARE expected to do:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Give an honest, factual statement</strong> while memory is fresh — same day if
              at all possible. Stick to what you saw, not what you think happened. Don’t embellish,
              don’t cover for anyone.
            </li>
            <li>
              <strong>Read the lessons-learned briefings</strong> when they come round. Apprentices
              are statistically more likely to be the next casualty — the lessons are aimed at you.
            </li>
            <li>
              <strong>Report near-misses.</strong> Every single one. The data goes into the pyramid
              base. Your near-miss this week is the brief that stops next month’s accident.
            </li>
            <li>
              <strong>Push back on weak action plans.</strong> If your supervisor says "right, we’ve
              been told to be more careful with X", that’s not a control measure. Politely ask
              what’s actually being changed in the kit / process / supervision. You’re in your
              rights under HASAWA s.7 to ask.
            </li>
          </ul>
        </ConceptBlock>
