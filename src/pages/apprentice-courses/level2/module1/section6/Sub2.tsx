...
const TITLE = 'First aid for electrical injuries | Level 2 Module 1.6.2 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'What is "arc eye" and how does it present?',
    options: [
  ...
  {
    id: 5,
    question: 'You used the eyewash bottle on Tuesday for a small splash. What should happen next?',
    options: [
  ...
  {
    id: 8,
    question: 'How often should the workplace first aid kit be checked, by whom?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Burns, arc eye, AED, cardiac arrhythmia — what actually goes wrong with a body after
          current passes through it, and the right treatment for each. Plus the rules every first
          aid box runs on.
        </p>
        ...
        <ConceptBlock title="Burns, arc eye, secondary trauma, and the cardiac one nobody sees coming">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Thermal / contact / internal burns</strong> — at the entry/exit points of the
              current path. Often look minor on the surface, much worse underneath.
            </li>
            <li>
            ...
            <li>
              <strong>Secondary trauma</strong> — falls, impact, cuts. The shock makes them jump,
              jerk or pass out — they hit the floor, the scaffold, the bench. Concussion and broken
              bones aren’t rare.
            </li>
            <li>
              <strong>Cardiac arrhythmia</strong> — the heart’s rhythm thrown off by current across
              the chest. Can be immediate (fibrillation, cardiac arrest) or delayed (irregular
              rhythm developing minutes to hours later).
            </li>
          </ul>
          <p>
            §2.1 covered the physiology — what current does to nerves, muscle and the heart. This
            subsection covers the practical first aid for each injury type.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stop the source.</strong> If clothing is on fire, smother it (foil blanket,
              jacket, drop and roll). If it’s an electrical contact burn, the supply is already
              isolated by now — don’t skip back to a live source.
            </li>
            <li>
              <strong>Cool the burn under cool running water for at least 20 minutes.</strong>
              Cool tap water — not cold, not iced. If clothing is stuck to the burn, leave it — cool
              through the fabric. Don’t peel.
            </li>
            <li>
              <strong>Remove jewellery and tight clothing</strong> from around the burn area (not
              from the burn itself). Burns swell. A ring on a burned finger becomes a tourniquet
              within minutes.
            </li>
            <li>
              <strong>Cover loosely</strong> with cling film (loose, not wrapped tight) or a clean,
              non-fluffy sterile dressing. Cling film is brilliant: see-through (the paramedic can
              assess without lifting), non-stick, and it holds in moisture.
            </li>
            <li>
              <strong>Keep the rest of the casualty warm</strong> — foil blanket round the shoulders
              if needed. Cooling a big burn for 20 min can drop their core temperature, especially
              in winter.
            </li>
            <li>
              <strong>Hospital.</strong> Any electrical burn, any burn bigger than the casualty’s
              palm, any burn to the face / hands / feet / genitals, any burn on a child or elderly
              casualty — A&E. Same applies if there’s any doubt about depth.
            </li>
          </ol>
          <p>
            <strong>Never put on a burn:</strong> butter, oils, toothpaste, antiseptic creams,
            ointments, ice, fluffy dressings (cotton wool especially). All of them either lock in
            heat, cause secondary damage, or stick to the wound and tear tissue when removed.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The 20-minute number is not folklore — it’s the duration the BBA and NHS use as the
              cut-off below which deep tissue damage is statistically worse. Memorise it. It’s the
              same for thermal, electrical, chemical and friction burns:{' '}
              <strong>20 minutes minimum</strong>.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Casualty took a shock — small black entry mark on the palm, looks no worse than a
              kettle burn. You cool it for a couple of minutes, slap on a plaster, send him back to
              work. Hours later he can’t move his hand — the muscle along the current’s path has
              been cooked from the inside, and the tissue is starting to swell against the tendons.
            </>
          }
          doInstead={
            <>
              Any electrical burn, however small the entry mark, gets the full 20-minute treatment
              AND a hospital check. Internal damage from current flowing through tissue can be
              invisible at the skin surface — A&E can do bloods (CK, troponin) to spot muscle and
              cardiac damage. Don’t guess.
            </>
          }
        />
        ...
        >
          <p>
            ...
            eyeball every time you blink. It’s temporary in most cases (24–72 hours) but it’s agony,
            and it’s easily complicated by infection.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Don’t rub — even when it feels gritty, there’s nothing physical in there to rub out.
              You’ll just damage the cornea further.
            </li>
            <li>
              A&E or out-of-hours GP — they’ll prescribe lubricating drops and anaesthetic eye
              drops, and rule out anything more serious.
            </li>
            <li>
              Recovery is usually full and within a few days. But repeated arc-eye episodes cause
              cumulative damage — that’s why arc-flash PPE includes face shields rated for arc, and
              why you don’t look at switchgear racking with the naked eye.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Switch it on.</strong> The voice prompt starts immediately. Listen and follow.
            </li>
            <li>
              <strong>Bare the casualty’s chest.</strong> Cut clothing if you have to. Dry the skin
              if it’s wet. Shave excessive chest hair if there’s a razor in the kit (most have one).
            </li>
            <li>
              <strong>Place the pads</strong> exactly where the diagrams on the pads show: one on
              the upper-right chest below the collar bone, one on the lower-left side below the
              armpit. The pad images are foolproof.
            </li>
            <li>
              <strong>Stand clear when the AED says to.</strong> "Analysing rhythm — do not touch
              the casualty." Look up, hands off, sweep nearby people back.
            </li>
            <li>
              <strong>If a shock is advised: "Stand clear, shock now."</strong> Press the shock
              button if it’s a semi-automatic. Fully-automatic AEDs deliver the shock themselves.
            </li>
            <li>
              <strong>Resume CPR immediately</strong> after the shock — 30:2 — until the AED
              analyses again (every 2 minutes). Don’t stop unless paramedics arrive, the casualty
              starts breathing, or the AED tells you to.
            </li>
          </ol>
          <p>
            Cardiac arrest from electric shock is most often a shockable rhythm — VF caused by
            current crossing the heart. Of all causes of out-of-hospital cardiac arrest,
            electrically-induced VF has one of the better survival rates IF an AED arrives fast.
            Time matters more than anything: every minute without defibrillation drops survival
            roughly 10%.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The headline: AEDs hand-hold you through it. You don’t need to know the rhythms, you
              don’t need to make any clinical decisions. Switch it on, follow the voice, push the
              button when told, restart CPR. Children, pregnant women, casualties with pacemakers —
              there are minor placement adjustments but the basic protocol doesn’t change.
            </>
          }
        ...
        >
          <p>
            The reason every electric-shock casualty gets a hospital check, no exceptions, is this:
            current that crossed the chest can damage the cardiac conduction system without an
            immediate visible effect. The heart compensates, then later the rhythm destabilises. A&E
            will run an ECG, often hold the casualty for observation, and do bloods to check for
            muscle damage along the current path.
          </p>
          <p>
            <strong>Don’t accept "I’m fine" as a clinical opinion.</strong> Casualties who walk away
            from a shock are routinely admitted overnight — that’s normal practice, not an
            over-reaction. The cost of a few hours’ observation is nothing compared to what happens
            if you send them home and they collapse on the M6 at 3 a.m.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            aspirin, antihistamines), any cream (antiseptic, antibiotic, hydrocortisone), any eye
            drops, any inhalers, any medical adhesive sprays. None of it. Workplace first-aiders are
            not authorised to dispense medication.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The boss has to provide the kit, the trained first-aider (or appointed person), and
              the time/space to use them. The HSE’s First Aid at Work guidance (L74) takes the
              regulation and turns it into practical numbers — kit contents, first aider:headcount
              ratios, low/high-risk categorisation. Your boss does a First Aid Needs Assessment to
              size all of that for the workplace.
            </>
          }
        ...
        >
          <p>
            The four-rule version of AC 3.6 — what every apprentice needs to internalise about the
            kit:
          </p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Don’t raid it for non-medical jobs.</strong> Need tape for a cable? Use proper
              tape. Need cling film for lunch? Buy a roll. The kit is for injuries.
            </li>
            <li>
              <strong>Use only what you need.</strong> One plaster for one cut, not three "in case".
              Don’t take the whole pack of dressings back to the van.
            </li>
            <li>
              <strong>Tell the first aider when you’ve used something.</strong> They keep a stock
              list and order replacements monthly. If they don’t know you used it, the box is short
              next time.
            </li>
            <li>
              <strong>Never administer something you’re not trained for.</strong> Even if a
              colleague asks for it. Even if it seems harmless. Painkillers, eye drops, sting creams
              — not your job, not your liability. Point them at a pharmacy.
            </li>
          </ol>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>After every use</strong> — restock immediately. Don’t leave it for "the end of
              the day".
            </li>
            <li>
              <strong>Weekly</strong> — appointed first aider does a 30-second look: tamper seal
              intact, contents present, nothing obviously expired.
            </li>
            <li>
              <strong>Monthly</strong> — full audit against the BS 8599-1 contents list, expiry
              dates checked (eyewash, sterile dressings, AED pads all have shelf lives).
            </li>
            <li>
              <strong>Annually</strong> — replace the whole kit if it’s been heavily used or stored
              in a hot/damp environment (van in summer, outside cabin in winter).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You catch a flake of paint in your eye on Tuesday. Pop the eyewash bottle, flush it
              out, feel better, get on with the job. Don’t mention it. On Friday a labourer takes a
              face-full of plaster dust — eyes streaming, already going red. He fumbles for the
              bottle. It’s empty. By the time someone runs to a chemist, the damage is worse than it
              had to be.
            </>
          }
          doInstead={
            <>
              <strong>Tell the first aider every single time you use anything.</strong> One plaster.
              One dressing. The eyewash. The cling film. Doesn’t matter if it feels trivial — the
              kit can’t restock itself, and the next person to need it might be in a worse state
              than you were.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A junior labourer takes a flash from a switchgear cabinet — small contact burn on the
              palm, plus he’s rubbing his eyes complaining the light has gone funny. You’ve already
              isolated the supply, called 999 and put him on a chair. You’re the only EFAW on site
              and the kit is the standard medium BS 8599-1 box on the wall.
            </>
          }
          whatToDo={
            <>
              Burn first — sink, cool tap water, palm under the flow for 20 minutes. Don’t put
              anything on it. While he’s under the tap, the eye complaint worries you more — flash,
              hours-later onset of pain is classic arc eye. Cool damp cloth over closed eyes (gauze
              + saline pod from the kit), darken the room. After 20 minutes, cover the burn loosely
              with cling film from the kit (or kitchen roll wrapped in cling film if you’re short).
              Foil blanket round his shoulders so he doesn’t go cold. Brief paramedics on arrival:
              230 V flash, contact burn to right palm, suspected arc eye, fully conscious, GCS 15.
              Hand over. Then tell the appointed first aider what you used — at minimum: eyewash
              pod, cling film, hydrogel burn dressing, saline pod. They’ll restock before close of
              business.
            </>
          }
          whyItMatters={
            <>
              One incident, three injuries (burn + arc eye + the hidden cardiac risk that forces the
              hospital trip). Each gets its own first aid. The kit handles all three IF it’s been
              kept stocked. AC 3.6 in action: if the previous apprentice had quietly used the
              eyewash on Tuesday and not told anyone, the labourer’s eye gets nothing.
            </>
          }
        />
        ...
        <Quiz
          title="First aid for electrical injuries — knowledge check"
