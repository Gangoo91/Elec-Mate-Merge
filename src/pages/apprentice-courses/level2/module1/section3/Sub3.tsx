...
const TITLE = 'Method statements and safe systems of work | Level 2 Module 1.3.3 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question:
      'You’re reading a method statement for a CU change. Which of these would you EXPECT to see written down?',
    options: [
  ...
  },
  {
    id: 2,
    question:
      "The MS step says 'isolate at the main switch and prove dead'. The site reality: the main switch is locked behind a panel only the building manager has the key to, and they’re off today. What do you do?",
    options: [
  ...
  },
  {
    id: 3,
    question:
      'Which BEST describes the relationship between a risk assessment, a method statement and a permit-to-work?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'You’re shown a method statement that’s 80 pages long for installing a single LED downlight. What’s most likely wrong?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'What’s the FIRST thing you should do at the start of a shift covered by a method statement?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      "Your RAMS bundle includes a method statement that references 'Procedure SOP-014: Safe Isolation'. The procedure isn’t attached and you’ve never seen it. What do you do?",
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          How the controls from your risk assessment turn into a step-by-step plan you can actually
          work to — and how permits, safe isolation procedures and toolbox talks layer on top to
          make a complete safe system of work.
        </p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Risk assessment (RA)</strong> — identifies the significant hazards, who could
              be harmed and the controls. The 'what' and 'why'.
            </li>
            <li>
              <strong>Method statement (MS)</strong> — describes the actual sequence of work given
              those controls. The 'how' and 'when' and 'who'.
            </li>
            <li>
              <strong>RAMS</strong> — the combined document or pack. What you’ll be handed on site.
            </li>
            <li>
              <strong>Safe system of work (SSoW)</strong> — the whole way the job is run safely.
              RAMS plus competence, supervision, communication, permits, monitoring, training. The
        ...
        <RegsCallout
          ...
          meaning={
            <>
              'Safe systems of work' is a HASAWA phrase, not a regulation invented later. The duty
              is on the employer to <em>provide</em> them AND <em>maintain</em> them. Provision is
              RAMS, training, kit, permits. Maintenance is reviewing, updating, supervising, and
              stopping work when the system breaks down.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              electrical accident traces back to a missing or inadequate method of work. It’s why
              every electrical job — however small — needs SOMEONE to have thought through how it’s
              being done safely. RAMS is how you evidence that thinking.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Scope</strong> — what work is in (and what’s explicitly out). Stops scope
              creep being rolled in without a fresh assessment.
            </li>
            <li>
            ...
            <li>
              <strong>Personnel and roles</strong> — who’s on the team, who’s the competent person
              in charge, who’s authorised for what (apprentice / instructed / skilled).
            </li>
            <li>
            ...
            <li>
              <strong>Plant, tools and equipment</strong> — what kit is needed and what spec.
              Voltage indicator (must be GS38 compliant). Lock-off kit. Test instruments. Insulated
              tools.
            </li>
            <li>
            ...
            <li>
              <strong>Emergency arrangements</strong> — first aid, who’s the first-aider, AED
              location, emergency contacts, fire muster point, ambulance access. Read it BEFORE you
              need it.
            </li>
            <li>
          ...
          <p>
            Right-sized to the job. A single-socket replacement MS might be a one-page form with
            these sections in compressed form. A commercial CU upgrade might be 15-20 pages. An
            LV/HV interface job could be 40+. The principle is proportionate — not minimum, not
            maximum.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Generic templates exist because most jobs share a common shape. CU changes, socket
            additions, lighting refurbs — your firm will have a pattern. The risk is treating the
            generic as the finished article.
          </p>
          <p>
            The HSE’s 'suitable and sufficient' test (and its method-statement equivalent under the
            safe systems of work duty) demands site-specific application. That means walking the
            actual site, naming the actual hazards present, listing the actual people involved, and
            writing the controls for THIS job. Generic templates with site-specific overlays are
            normal. Generic templates run unchanged are a prosecution starter.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            authorised under named conditions. Closed permit = system back to normal, barriers down,
            lock-offs removed. The discipline of opening and closing the permit is what stops 'I
            thought you’d done that' incidents.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              HSG85 is the HSE’s practical guide for electrical work. The permit-to-work section is
              short but firm: for higher-risk electrical work, formal written authorisation is the
              expected standard. On larger sites you’ll see permit systems used routinely. On
              smaller jobs they may be used only for specific tasks (live testing, work near HV).
            </>
          }
        ...
        >
          ...
          <p>
            ...
            circuit topology, an additional occupant), stop and escalate. Don’t improvise. The MS
            has to be amended (Step 5) before you carry on. Sub 4 covers point-of-work checks in
            detail — they’re the live, in-the-moment version of the same idea.
          </p>
          <p>
            Close-out: every isolation restored OR formally left in a known state. Every permit
            closed. Every lock removed (yours, by you). Customer briefed on anything they need to
            know. Paperwork completed. The job isn’t finished until the system is documented as back
            to normal.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              it, doesn’t share the detail with the apprentice. Apprentice gets stuck into the work
              knowing only what they’ve been told verbally. Halfway through there’s a step the
              apprentice didn’t know about (e.g. 'temporary feed required to keep the alarm system
              live during the CU change'). Alarm goes down, building evacuates, money lost,
              supervisor blames apprentice, apprentice has no defence because they never read the
              document.
            </>
          }
          doInstead={
            <>
              If your name is on the team, the MS applies to YOU. Read it. The whole thing, or at
              minimum every section that mentions your role or your part of the work. If the
              supervisor hasn’t shared it, ask. 'Can I read the MS before we start?' is a completely
              normal request — and any supervisor who refuses is making a problem for themselves
              later.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re on a small commercial fit-out, second day. The method statement is explicit:
              cable pulling requires direct supervision of the apprentice (you). The supervisor
              steps outside to take a call from the office, says it’ll be 'two minutes'. Twenty
              minutes later they’re still not back. The job is on a schedule and you’re aware time’s
              being lost. The other electrician on site (not your supervisor, not in the MS for your
              supervision) says 'just keep going, I’m here'.
            </>
          }
          whatToDo={
            <>
              Stop pulling cable. The MS specifies 'direct supervision' — not 'someone else in the
              building'. Either wait for your named supervisor to return, OR get the MS amended on
              the spot (someone competent has to formally authorise the other electrician as your
              supervisor for the duration). Don’t carry on under informal cover. While you wait, do
              something the MS doesn’t require supervision for — tidy the route, prep the next pull,
              label cables. You’re working productively without breaching the system of work.
            </>
          }
          whyItMatters={
            <>
              The MS is the safe system of work for that activity. 'Someone else is here' is not the
              same as 'direct supervision'. If something goes wrong (you damage the cable, you
              injure yourself, you damage the building) and you were working outside the MS, you’ve
              got no defence — and your supervisor is also in the wrong for leaving you. EAWR Reg 16
              (technical knowledge or experience) and HASAWA s.2(2)(c) (supervision) both apply.
              Your willingness to stop the job is a sign of competence, not weakness.
            </>
          }
        />
        ...
        >
          <p>
            You met the legal layers in Section 1 (HASAWA, EAWR, BS 7671). Section 2 covered the
            hazards. Sub 1 of this section explained why we do risk assessments. Sub 2 gave you the
            five-step method.
          </p>
          <p>
            This subsection is the bridge to actual delivery: how the controls turn into a sequence
            of work (MS), how higher-risk steps get authorised (permits), and how all of it sits
            inside the bigger 'safe system of work' duty.
          </p>
          <p>
            Sub 4 takes it to the next level: how RAMS gets used live on site — toolbox talks before
            work starts each morning, point-of-work risk assessments throughout the day, what to do
            when reality stops matching the plan. That’s where the system meets the floor.
          </p>
        </ConceptBlock>
        ...
        <Quiz
          title="Method statements and safe systems of work knowledge check"
