...
const TITLE = 'Working with RAMS on site | Level 2 Module 1.3.4 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question:
      'You spot something on site that doesn’t match the RAMS — different layout, extra hazard, missing kit. What’s your duty?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'Toolbox talk this morning covered isolation procedure for the CU change. Two hours in, the architect adds a new circuit you weren’t expecting. What’s the right move?',
    options: [
  ...
  },
  {
    id: 2,
    question:
      'You sign the toolbox-talk attendance sheet without listening. Three hours later something on the talk would have warned you about goes wrong. Where’s the legal exposure?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'You arrive at a job and there’s no toolbox talk. The supervisor just hands out tasks. What’s the right response?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'Mid-job, you notice the lock-off you applied this morning has been removed by someone else. What do you do?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'You spot a near miss — your mate nearly drilled into a buried cable that wasn’t marked on the RAMS. Nobody got hurt. What should happen next?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'You’re asked to take part in delivering a toolbox talk to your apprentices below you. What’s the structure of a useful talk?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'You finish your part of the job 30 minutes early and the supervisor’s left site. There’s no other task in the RAMS for you. What do you do?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          How RAMS gets used live on site — toolbox talks each morning, point-of-work checks
          throughout the day, near-miss reporting, and what to do when reality stops matching the
          plan. The bit that turns paperwork into actual safety.
        </p>
        ...
        <ConceptBlock title="The gap between the RAMS in the office and the work on the floor">
          <p>
            You’ve learnt what a risk assessment is for (Sub 1), the five-step method to produce one
            (Sub 2), and how method statements and safe systems of work turn controls into a
            sequence of work (Sub 3). All of that is preparation. This subsection is where it meets
            the floor.
          </p>
          <p>
            Most safety incidents in UK electrical work don’t happen because someone didn’t have
            RAMS. They happen because the RAMS was on a clipboard somewhere while the job changed
            underneath it. New trades arrive. Walls come down. The kit doesn’t show up. The weather
            turns. The architect adds three sockets. Reality moves; the paperwork doesn’t.
          </p>
          <p>
            Your job — every day, on every site — is to keep the gap between paperwork and reality
            small enough that nobody falls through it. That’s what toolbox talks, point-of-work
            checks and near-miss reporting are for.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Scope of today’s work</strong> — what we’re doing, which area, who’s on which
              task.
            </li>
            <li>
              <strong>Significant hazards</strong> — the three or four things that could
              realistically hurt someone today. Not the full RAMS list — just what’s live for THIS
              shift.
            </li>
            <li>
              <strong>Controls in place</strong> — isolation arrangements, lock-off, RCDs, permits,
              supervision, PPE required, exclusion zones.
            </li>
            <li>
              <strong>Other trades / site-wide hazards</strong> — what else is happening, where the
              deliveries are coming, where the scaffolders are working overhead.
            </li>
            <li>
              <strong>Emergency arrangements</strong> — first-aider on shift, AED location, muster
              point, fire warden, ambulance access. Restated daily because day-one inductions fade.
            </li>
            <li>
              <strong>Check-back questions</strong> — supervisor asks 2-3 questions to confirm
              understanding. 'Where’s the muster point?' 'What’s the isolation point for the CU
              change?' 'Who’s the first-aider today?'
            </li>
            <li>
              <strong>Sign-on</strong> — every attendee signs to confirm they were briefed and
              understood. The signature is evidence — both of attendance AND of personal acceptance
              of the plan.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The legal hook for toolbox talks. The employer has to give workers 'comprehensible and
              relevant information' about the hazards, the controls and who’s responsible for what.
              A pile of RAMS dropped on a desk doesn’t meet that test. A daily briefing in language
              the team understands does.
            </>
          }
        ...
        >
          <p>
            The HSE doesn’t name 'point-of-work assessment' as a specific document type, but it’s
            the practical expression of MHSWR Reg 3(3) (review when no longer valid) and HASAWA s.7
            (workers cooperate with the system). It catches the things the morning toolbox talk
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Encountering an unexpected condition (open ceiling, exposed wiring, water leak).
            </li>
          ...
          <p>
            The check itself takes seconds. Look up, look down, look around. Identify hazards you
            didn’t expect. Decide if existing controls handle them. If not, stop, raise it, get the
            RAMS amended (Step 5), then carry on. The few seconds you spend on the check are the
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stop the relevant work</strong> (you don’t have to stop the whole site if only
              one task is affected — but stop the affected work).
            </li>
            <li>
            ...
            <li>
              <strong>Document</strong> — note what you spotted, when, what was changed in the RAMS,
              who signed off the amendment.
            </li>
            <li>
              <strong>Resume</strong> — under the amended system of work, with the team aware of the
              change.
            </li>
          </ol>
          <p>
            The whole sequence might take fifteen minutes. Compare that to the consequences of NOT
            doing it. The HSE’s investigation files are full of incidents that began with 'and then
            we just carried on'.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              <em> omissions</em>, things you didn’t do. Second: cooperate with the safety system.
              Spotting a mismatch and saying nothing is a textbook s.7 omission. So is signing a TBT
              attendance sheet without listening. Personal liability is real.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 14 is the worker-side bookend to the employer’s Reg 3 duty. You have a positive
              duty to TELL someone when you spot a serious and immediate danger or a shortcoming in
              the safety arrangements. Spotting a mismatch and staying quiet isn’t neutral — it’s a
              Reg 14 breach.
            </>
          }
        ...
        >
          <p>Examples of near misses on electrical work:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Drill nearly went into a buried cable that wasn’t shown on the drawings.</li>
            <li>
              Voltage indicator showed dead but you hadn’t function-tested it that morning — turned
              out it was faulty.
            </li>
            <li>
              Lock-off was found removed by someone unauthorised; you spotted before re-energising.
            </li>
            <li>Step ladder slipped but you caught yourself.</li>
            <li>
              You felt a mild tingle off a metal enclosure that should have been at earth potential.
            </li>
          </ul>
          <p>
            None of those caused injury. All of them could have. Logging them lets the firm spot
            patterns (the same supplier’s voltage indicators failing repeatedly, the same drawings
            being inaccurate on every job) and act before someone gets hurt. RIDDOR doesn’t require
            near misses to be reported externally (with one exception — 'dangerous occurrences' as
            defined in Schedule 2), but internal logging is best practice and increasingly mandated
            by client safety standards.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Two things back you up legally when you refuse unsafe work:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              ...
              raising health and safety concerns or refusing genuinely unsafe work. Your employer
              cannot lawfully sack you, cut your hours, or discipline you for refusing work you
              reasonably believed to be dangerous.
            </li>
          </ul>
          <p>
            That second one matters. Apprentices sometimes hesitate to push back because they’re
            worried about being seen as awkward or losing their position. The law is explicit:
            you’re protected. Note dates, names and what was said in case the dispute escalates —
            but most don’t. Most supervisors, when properly approached ('I’m not happy with this for
            X reason — can we sort it before I carry on?'), will fix the issue.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              covers six items including 'isolation point for the kitchen ring is in DB-3, tagged
              red, key with the supervisor'. You’re half-asleep, you nod, you sign. Three hours
              later you’re in the kitchen, you assume the local lighting circuit is dead because it
              looks dead, you don’t check DB-3 or ask for the key, you cut a cable. There’s a flash.
              You’re lucky — only lost an eyebrow. The investigation pulls the TBT sheet. Your
              signature. Your s.7 problem.
            </>
          }
          doInstead={
            <>
              Treat your signature on the TBT sheet exactly the same as your signature on the RAMS.
              It’s evidence you were briefed. If you weren’t listening, that’s on you. Two minutes
              of attention saves you from a catalogue of trouble. If something in the talk was
              unclear, ask BEFORE signing. 'Just to confirm — isolation for the kitchen is DB-3, key
              with supervisor?' is a perfect check-back.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Day three on a fit-out. You notice the RAMS lists a single isolation point for the
              area you’re working in — but on site there are clearly two DBs, both feeding the area.
              You think 'somebody must know' and crack on. You isolate the one the supervisor
              pointed at. The other one is still live, feeding a circuit you’re working on. You
              touch a 'dead' conductor that isn’t. Best case: you jump. Worst case: front page of
              the local paper.
            </>
          }
          doInstead={
            <>
              Speak up the moment you spot it. 'I’ve noticed there are two DBs feeding this area —
              does the RAMS need updating?' is a five-second sentence. Apprentices catch things
              experienced electricians have stopped seeing precisely BECAUSE they’re experienced.
              Your fresh eyes are a safety asset. The senior who tells you 'do less talking and more
              working' isn’t a senior — they’re a problem. Note that conversation in case anything
              later goes wrong.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re on a small commercial fit-out, week two. This morning’s toolbox talk was clear:
              any drilling near electrical equipment requires the local DB to be isolated and proved
              dead first. You’re fitting trunking and need to drill through a partition near a
              sub-DB. You’re setting up the lock-off when the site supervisor walks past and says
              'leave it, don’t bother with that, it’s only a sub-board, just crack on. We’re behind
              schedule and that drill bit couldn’t reach anything live anyway.'
            </>
          }
          whatToDo={
            <>
              Don’t crack on. The verbal override doesn’t change the safe system of work that was
              agreed at this morning’s TBT. Your reply: 'I get the time pressure, but the morning
              brief said isolate first — happy to do this either way but I’m not happy doing it
              without isolation. If we want to change the approach can we update the RAMS / get the
              supervisor to authorise it formally?' If they push, escalate above them — your own
              employer, the principal contractor, whoever signs your timesheet. While you wait, do
              something productive within scope (prep the next pull, sort the cable, tidy). Note the
          ...
          whyItMatters={
            <>
              ...
              someone else’s say-so, the HSE prosecution lands on YOU under HASAWA s.7 (knowingly
              breached the safe system you’d been briefed on) AND the supervisor (who instructed you
              to). Both go down. 'He told me to' is not a defence under s.7. The TBT briefing — and
              your signature on it — is evidence of what you knew. The RAMS is the agreed plan;
              verbal contradictions on the floor don’t change it. ERA 1996 s.44 protects you against
              any comeback for refusing the unsafe instruction.
            </>
          }
        />
        ...
        >
          <p>
            Risk assessment is the planning. Method statements are the sequence. Toolbox talks and
            point-of-work checks are how the plan stays alive on the floor. All four together are
            how an electrical job runs without anyone getting hurt.
          </p>
          <p>
            Section 4 (next) covers PPE — the bottom rung of the hierarchy of control, but the layer
            that catches the consequences when everything above has failed. Section 5 then takes you
            into safe isolation — the procedure that turns the most common control measure
            ('eliminate the hazard') from a phrase in the RAMS into the actual sequence of switches,
            padlocks, warning notices and prove-dead checks on the day.
          </p>
        </ConceptBlock>
