...
const TITLE = 'Purpose of risk assessments | Level 2 Module 1.3.1 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question:
      'You arrive on site and your supervisor hands you a RAMS document. What’s the first thing you should do with it?',
    options: [
  ...
  },
  {
    id: 2,
    question:
      "The site RAMS says 'isolate at the local DB before drilling'. The DB you’re drilling near isn’t labelled and the supervisor says 'just kill the lighting circuit, you’ll be fine'. What do you do?",
    options: [
  ...
  },
  {
    id: 5,
    question:
      'A mate gets electrocuted because the RAMS missed a buried live cable. The RAMS was a copy-paste from the last job. Who can the HSE prosecute?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'Your firm employs 4 electricians including you. Does the law require risk assessments to be written down?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'RAMS, risk assessment, method statement, safe system of work — what’s the difference?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Why every job on every site starts with a piece of paper that names the things that could
          hurt you — and what happens to the apprentices who treat it as paperwork to sign rather
          than a plan to read.
        </p>
        ...
        <ConceptBlock title="The whole point: stop the accident before it happens">
          <p>
            ...
            on site that quietly hurt electricians (slips, manual handling, working at height). A
            risk assessment is the bridge between those two.
          </p>
          <p>
            The HSE prosecutes around <strong>1,000 electrical incidents at work each year</strong>.
            Most of them weren’t caused by missing knowledge — they were caused by someone skipping
            the planning step. Drilling without checking what was behind the wall. Working live
            because nobody wrote down a safe isolation procedure. A buried cable nobody mapped.
          </p>
          <p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Hazard</strong> — anything with the potential to cause harm. A live conductor,
              a step ladder, a drum of cable, a wet floor, asbestos in the ceiling void.
            </li>
            <li>
              <strong>Risk</strong> — the chance the hazard actually causes harm × how bad the harm
              would be. Same hazard, different risks: a 230 V tail in a sealed enclosure has a low
              risk until you take the cover off, then it’s very high.
            </li>
            <li>
              <strong>Control measure</strong> — what you put in place to reduce the risk.
              Isolation, PPE, barriers, training, supervision, written procedures. Most jobs need
              several layers.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The legal hook. Every employer (and any self-employed electrician working for
              themselves) has to assess the risks before work happens. It covers <em>employees</em>{' '}
              AND <em>everyone else affected by the work</em> — customers, the public, other trades.
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              ones that could realistically cause harm. Trivial risks (a paper cut from the spec
              sheet) you can ignore.
            </li>
            <li>
              <strong>Identify who’s affected</strong> — yourself, mates, other trades, the
              customer, the public, vulnerable people (kids, elderly, anyone with a disability).
            </li>
            <li>
              <strong>Be appropriate to the nature of the work</strong> — proportionate. Bigger and
              more dangerous the job, more detailed the assessment.
            </li>
            <li>
              <strong>Identify the period of time it remains valid</strong> — when it gets reviewed
              and what triggers an early review.
            </li>
          </ol>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Straight from HSE. Risk assessment is a thinking exercise, not a paperwork exercise.
              The output is sensible controls, not a document for the filing cabinet. Anyone telling
              you otherwise has missed the point — and the HSE inspector who turns up after an
              accident has missed nothing.
            </>
          }
        ...
        >
          <p>
            MHSWR Reg 3(6) only forces written records when the employer has 5 or more employees.
            Below that, the assessment still has to happen — the employer just isn’t legally forced
            to write it down.
          </p>
          <p>
            In practice this distinction barely matters. Insurance won’t cover you without written
            records. Larger clients won’t let you on site without RAMS. And if anything ever goes
            wrong, the HSE will ask 'show me your assessment' — and 'I had it in my head' is not an
            acceptable answer.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            Section 1.1) and runs through every UK safety reg. It defines what 'good enough' looks
            like. Three regions:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Intolerable</strong> — the risk is so high it cannot be justified, whatever
              the benefit. Working on a live HV busbar without authorisation. Not negotiable.
            </li>
            <li>
              <strong>ALARP / tolerable</strong> — the risk is real but you’ve pushed it down to
              where further reduction would cost grossly more than the safety benefit. This is where
              most well-controlled work lives.
            </li>
            <li>
              <strong>Broadly acceptable</strong> — the risk is so low it’s not worth doing more
              about it (within reason). Routine tasks with proven controls.
            </li>
          </ul>
          <p>
            The risk assessment is where you make the ALARP call for each significant hazard. The
            HSE inspector who turns up after an incident asks one question: was the risk ALARP at
            the time? If yes, you defended yourself. If no, prosecution.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Eight blokes on a site. RAMS comes round on a clipboard. Everyone signs it without
              reading because that’s what they always do. Three weeks in, an apprentice drills into
              a buried cable that the RAMS specifically warned about. He’s lucky — burns to the hand
              and a six-month cardiac follow-up. The HSE looks at the clipboard, sees his signature,
              sees he never actually read the document. Now it’s his s.7 problem too — not just the
              supervisor’s.
            </>
          }
          doInstead={
            <>
              Treat the signature like a contract you’ve actually read. Two minutes per page. Find
              the hazards listed, find your name, find what you’re supposed to do differently. If
              something doesn’t make sense, ASK before you sign. 'I just want to check what this
              section means' is a normal, professional question — not a pain in the supervisor’s
              side.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              arrangements, fire muster point — you nod through it. Three months later you’re still
              on the same job and the conditions have completely changed (a wall came down, scaffold
              went up, a new sub-contractor arrived). You’re working off the day-one mental model.
              None of the new hazards are in your head. Easy way to walk into an accident.
            </>
          }
          doInstead={
            <>
              The RAMS lives in the site office or the cabin for a reason. Re-read the bits relevant
              to your work each morning — takes 60 seconds. If anything has changed on site, the
              RAMS should have been reviewed. If it hasn’t, that’s your point-of-work check (Sub 4)
              — flag it. Old RAMS + new hazards = the textbook prosecution pattern.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You’re on a small commercial fit-out, second week. RAMS for the day’s work clearly
              says any drilling near electrical equipment requires the local distribution board to
              be isolated and proved dead first. You’re fitting trunking and need to drill through a
              partition near a sub-DB. The site supervisor walks past, sees you setting up the
              lock-off, and says 'leave it, don’t bother with that, it’s only a sub-board, just
              crack on.'
            </>
          }
          whatToDo={
            <>
              Don’t crack on. The RAMS is the legal document that controls how the work gets done —
              the supervisor verbally overriding it doesn’t make that legal. Politely: 'The RAMS
              says I need to isolate first — I’m happy to do it the way it’s written but I’m not
              happy ignoring it. Can we get the RAMS amended if we want to do it differently, or
              shall I just isolate?' If they push back, escalate above them — principal contractor,
              your own employer, whoever signs your timesheet. Note the conversation: time, name,
              what was said.
            </>
          }
          whyItMatters={
            <>
              If you drill into a live cable because you ignored the RAMS on someone else’s say-so,
              the HSE prosecution lands on YOU under HASAWA s.7 (you knowingly breached a written
              safe system of work) AND the supervisor (he instructed you to). Both go down. 'He told
              me to' is not a defence. The RAMS is the agreed plan — and it changes only on paper,
              not on the say-so of a supervisor under time pressure.
            </>
          }
        />
        ...
        >
          <p>
            You met HASAWA in Section 1.1 and the specific hazards in Section 2. The risk assessment
            is what stitches them together for a real job. It’s where the law becomes a list of
            actions you do today.
          </p>
          <p>
            The next three subsections walk through the practical mechanics — the five-step HSE
            method (Sub 2), how method statements turn the controls into a sequence of work (Sub 3),
            and how RAMS gets used live on site through toolbox talks and point-of-work checks (Sub
            4). Section 5 then drills into safe isolation — the single most-used control measure in
            any electrical RAMS.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              anything significant changes — new equipment, new people, a near miss, a different
              layout, weather conditions. Most jobs have a 'live document' field on the RAMS for
              exactly this reason. Your point-of-work checks (Sub 4) are the ground-floor version of
              this same duty.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 4 + Schedule 1 is the legal hierarchy of prevention. It's the regulation that says
              you can't jump to PPE — you have to consider avoiding the risk first, then
              engineering, then collective protection, with PPE last. Every controlled risk on your
              RAMS should map back to one of these nine principles. If the assessor can't show which
              principle the chosen control came from, the RAMS is weak.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              On any CDM-notifiable project (most commercial / industrial work), the principal
              contractor has a legal duty to brief every worker — you included — on the
              site-specific risks, controls and emergency arrangements BEFORE you pick up a tool.
              The site induction is the document that turns the project risk assessment into your
              day-one knowledge. If you walk on site without an induction, that's a CDM Reg 13
              breach by the principal contractor — and your cue to stop and ask for one.
            </>
          }
