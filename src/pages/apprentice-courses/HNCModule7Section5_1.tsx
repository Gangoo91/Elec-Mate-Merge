...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['130 lumens', '50 lumens', '2.6 lumens', '6,500 lumens'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Phosphor coating', 'The semiconductor die', 'The heat sink', 'The lens optic'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['2700K warm white', '3000K warm white', '6500K daylight', '4000K neutral white'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          LED fundamentals, driver types, thermal management, lifetime prediction, and specification
          considerations
        </p>
        ...
        <ConceptBlock title="LED Fundamentals">
          <p>
            ...
            electroluminescence. When forward-biased, electrons cross the p-n junction and recombine
            with holes, releasing energy as photons. The wavelength (colour) depends on the
            semiconductor bandgap energy.
          </p>
          <p>
            <strong>LED chip technologies:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Phosphor-converted:</strong> Various phosphor blends for warm white, high CRI
              applications
            </li>
            <li>
          ...
          <p>
            <strong>LED Package Types</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>SMD (Surface Mount):</strong> Individual LEDs in small packages (e.g., 2835,
              5050) — LED tape, panels, linear luminaires
            </li>
            <li>
              <strong>COB (Chip on Board):</strong> Multiple dies on single substrate under one
              phosphor — Downlights, spotlights, high-bay
            </li>
            <li>
              <strong>CSP (Chip Scale Package):</strong> Minimal packaging - die is the package —
              Compact high-density arrays
            </li>
            <li>
              <strong>Mid-power:</strong> 0.2-0.5W per LED, good efficacy — Troffers, general area
              lighting
            </li>
            <li>
              <strong>High-power:</strong> 1-5W+ per LED, requires heat management — Outdoor,
              industrial, spotlights
            </li>
          </ul>
          <p>
            <strong>LED Electrical Characteristics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Forward voltage (Vf):</strong> 2.8V - 3.5V typical for white LED
            </li>
            <li>
              <strong>Drive current:</strong> 350mA (1W), 700mA (3W), 1050mA (5W) typical
            </li>
            <li>
              <strong>Vf temperature coefficient:</strong> -2mV/°C (decreases with temperature)
            </li>
            <li>
              <strong>Junction temperature max:</strong> 125°C typical, optimal &lt;85°C
            </li>
          </ul>
          <p>
            <strong>Key principle:</strong> LED light output is proportional to current, but forward
            voltage changes with temperature - this is why current control is essential.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="LED Driver Types">
          ...
          <p>
            <strong>Constant Current (CC) Drivers</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Constant Voltage (CV) Drivers</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Driver Dimming Types</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DALI / DALI-2:</strong> Digital signal on dedicated pair, addressable —
              Commercial buildings, scene control, monitoring
            </li>
            <li>
              <strong>1-10V:</strong> Analogue DC voltage controls output level — Warehouse,
              industrial, simple zone dimming
            </li>
            <li>
              <strong>Phase-cut (leading edge):</strong> Triac chops AC waveform - traditional
              dimmer — Domestic retrofit where existing dimmers
            </li>
            <li>
              <strong>Phase-cut (trailing edge):</strong> MOSFET dims from end of cycle - smoother —
              Better LED compatibility, less flicker
            </li>
            <li>
              <strong>PWM (Pulse Width):</strong> High-frequency on/off switching — RGB control,
              theatrical, architectural
            </li>
            <li>
              <strong>Wireless (Bluetooth/Zigbee):</strong> Smart protocol in driver, no control
              wiring — Retrofit, smart buildings, IoT integration
            </li>
          </ul>
          <p>
            <strong>In-Rush Current Considerations</strong>
          </p>
        ...
        <ConceptBlock title="Thermal Management">
          ...
          <p>
            <strong>Thermal pathway components:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Temperature Effects on LED Performance</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Light output:</strong> Decreases (reversible if within limits) — -0.3% to
              -0.5% per °C rise
            </li>
            <li>
              <strong>Forward voltage:</strong> Decreases — -2mV per °C rise
            </li>
            <li>
              <strong>Colour temperature:</strong> Shifts warmer (lower CCT) — -2K to -5K per °C
              rise
            </li>
            <li>
              <strong>Lifetime:</strong> Exponentially reduces — Halves for every 10°C above optimal
            </li>
            <li>
              <strong>Phosphor efficiency:</strong> Decreases, colour shifts — Accelerated
              degradation above 100°C
            </li>
          </ul>
          <p>
            <strong>Thermal Calculation Example</strong>
          </p>
          <p>
            <span>Given:</span>
          </p>
          ...
          <p>
            <span>Junction temperature calculation:</span>
          </p>
          <p>Total Rth = 2 + 0.5 + 5 = 7.5°C/W</p>
          <p>Temperature rise = 7W × 7.5°C/W = 52.5°C</p>
          <p>Tj = 25°C + 52.5°C = 77.5°C (acceptable)</p>
          <p>
            <strong>Installation Derating Factors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Recessed mounting:</strong> Reduced airflow - verify IC (Insulation Contact)
              rating and Ta rating
            </li>
            <li>
              <strong>Insulated ceilings:</strong> Additional derating may be needed if insulation
              contacts luminaire
            </li>
            <li>
              <strong>High ambient:</strong> Derate or specify higher Ta-rated luminaires for plant
              rooms, atriums
            </li>
            <li>
          ...
          <p>
            ...
            temperature (Ta). A luminaire rated at Ta 25°C will have reduced life in a ceiling void
            at 35°C.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Lifetime and Specification Considerations">
          <p>
            ...
            Understanding the metrics - Lx, By, and Cy values - is essential for specifying
            luminaires that will meet maintained illuminance requirements throughout their service
            life.
          </p>
          <p>
            <strong>LED Lifetime Metrics Explained</strong>
          </p>
          <p>
          ...
          <p>
            <strong>By (Failure Rate):</strong> Percentage of complete failures by stated hours
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            Example: L70B10 at 60,000 hours means after 60,000 hours, the surviving luminaires (90%)
            will still produce at least 70% of initial lumens.
          </p>
          <p>
            <strong>Key Specification Parameters</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Luminous flux:</strong> Total light output in lumens — Varies - state initial
              lumens
            </li>
            <li>
              <strong>Luminous efficacy:</strong> Light output per watt (lm/W) — 100-200 lm/W
              (higher = better)
            </li>
            <li>
              <strong>CCT (Colour temp):</strong> Warmth/coolness in Kelvin — 2700K warm to 6500K
              daylight
            </li>
            <li>
              <strong>CRI / Ra:</strong> Colour Rendering Index (0-100) — &gt;80 general, &gt;90
              retail/healthcare
            </li>
            <li>
              <strong>TM-30 Rf:</strong> Fidelity Index (0-100) — &gt;85 good, &gt;90 excellent
            </li>
            <li>
              <strong>UGR:</strong> Unified Glare Rating — &lt;19 office, &lt;22 industrial
            </li>
            <li>
              <strong>MacAdam ellipse:</strong> Colour consistency (SDCM) — ≤3 step (imperceptible
              variation)
            </li>
            <li>
              <strong>Flicker / SVM:</strong> Temporal light artefacts — &lt;3% flicker, SVM &lt;0.4
            </li>
          </ul>
          <p>
            <strong>Maintenance Factor Calculation</strong>
          </p>
          ...
          <p>
            <strong>Typical Efficacy Ranges (2024)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Common Specification Pitfalls</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Specify driver for a 36W LED panel requiring DALI dimming in
            an office.
          </p>
          <p>Requirements:</p>
          <p>Panel power: 36W</p>
          ...
          <p>
            <strong>Scenario:</strong> Calculate maintenance factor for LED luminaires in an office
            with 3-year cleaning cycle.
          </p>
          <p>Given data:</p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Using constant voltage drivers for discrete LED luminaires</strong> - causes
                thermal runaway
              </li>
              <li>
              ...
              <li>
                <strong>Mixing incompatible dimmers and drivers</strong> - causes flicker, buzz, and
                failure
              </li>
            </ul>
          }
