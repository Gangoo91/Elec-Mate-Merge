        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              electricity that flows one way to passive consumers — is being replaced by a smart
              grid with distributed generation, active demand management, energy storage, and
              two-way power flows. This transformation is driven by the need to integrate renewable
              energy, electrify heating and transport, and achieve net zero emissions.
            </p>
            <p>
              For the maintenance technician, this means the electrical systems you maintain are
              increasingly interconnected, digitally monitored, and actively managed. Understanding
              the smart grid context helps you appreciate why systems are designed and operated as
              they are, and enables you to diagnose faults more effectively when equipment behaves
              differently from what you might expect on a traditional passive network.
            </p>
            <p>
              The DNO-to-DSO transition is at the heart of this change. Traditional DNOs simply
              delivered power from the transmission grid to consumers, with limited real-time
              visibility of conditions at LV (low voltage) level. DSOs actively manage a complex,
              two-way network using sensors, communications, and automated control. This enables
              integration of millions of distributed energy resources (solar PV, batteries, EVs,
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              deployed smart grid technology. For maintenance technicians, understanding smart meter
              technology is essential because these devices are present in almost every domestic and
              small commercial installation, and they interact with the systems you maintain.
            </p>
            <p>
              The SMETS2 specification was developed to address the shortcomings of the earlier
              SMETS1 meters. SMETS1 meters used supplier-specific communication systems, meaning
              they often lost their smart functionality when a consumer switched energy supplier.
              SMETS2 meters communicate via the DCC national network, ensuring interoperability with
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                ...
                (abstracting electricity) and the Electricity Act 1989. The maintenance technician
                must: never break meter seals; never disconnect meter tails without supplier
                authority; never interfere with the communications hub; and report any suspected
                meter tampering to the energy supplier. If electrical work requires meter
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              meters lost smart functionality when consumers switched supplier. Understanding this
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              instructions. As the UK moves to a highly electrified energy system (heat pumps, EV
              charging, cooking), the peak demand on the network will increase significantly.
              Without DSR, massive network reinforcement would be needed. With DSR, existing network
              capacity can be used more efficiently.
            </p>
            <p>
              For the maintenance technician, DSR has direct practical implications. The equipment
              you maintain — EV chargers, heat pumps, battery storage systems — is increasingly
              operated on DSR schedules. An EV charger that does not start immediately when plugged
              in is not necessarily faulty; it may be waiting for an off-peak tariff window. A heat
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              charging, a heat pump modulates output, or a battery charges at 3 am helps you
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              cyber-attack could disrupt power supply to millions of consumers. For maintenance
              technicians, this means following security protocols when accessing smart meter and
              control systems, and being aware of the broader security landscape.
            </p>
            <p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              demand-side response schedules, and network automation all influence the loads,
              voltages, and operating patterns of the electrical installations in your care.
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              smart meter data, DSR schedules, and network automation can diagnose faults more
