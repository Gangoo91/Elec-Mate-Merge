...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['6.13A', '1.53A', '3.07A', '17.25A'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Series cell stacks in NiCd or LiFePO₄ emergency luminaire packs are sized so that the
              end-of-life cell voltage × number of cells still drives the LED string at rated lumen
              output. Series circuit analysis is the design arithmetic that proves the duration
              claim.
            </>
          }
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Voltage:</strong> Divides across components (V<sub>T</sub> = V<sub>1</sub> + V
              <sub>2</sub> + V<sub>3</sub>)
            </li>
            <li>
        ...
        <ConceptBlock title="Series Circuit Fundamentals">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Current:</strong> I<sub>T</sub> = I<sub>1</sub> = I<sub>2</sub> = I
              <sub>3</sub> — Same through all components
            </li>
            <li>
              <strong>Voltage:</strong> V<sub>T</sub> = V<sub>1</sub> + V<sub>2</sub> + V
              <sub>3</sub> — Divides across components
            </li>
            <li>
              <strong>Resistance:</strong> R<sub>T</sub> = R<sub>1</sub> + R<sub>2</sub> + R
              <sub>3</sub> — Adds up (sum of all)
            </li>
          </ul>
          ...
          <p>
            ...
            charge is conserved in electrical circuits. Every coulomb entering a component must exit
            it.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Calculating Total Resistance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              R<sub>T</sub> = 1.2kΩ + 3.3kΩ + 2.7kΩ = <strong>7.2kΩ</strong>
            </li>
          </ul>
        ...
        <ConceptBlock title="Voltage Divider Rule">
          <p>
            The voltage divider rule allows direct calculation of the voltage across any resistor in
            a series circuit without first calculating the current. This is particularly useful for
            sensor circuits and reference voltage generation.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              V<sub>out</sub> = 12V × (1kΩ / 3kΩ) = 12V × 0.333 = <strong>4V</strong> ✓
            </li>
          </ul>
          <p className="text-sm font-medium text-white">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              V<sub>out</sub>/V<sub>in</sub> = R<sub>2</sub>/(R<sub>1</sub>+R<sub>2</sub>) = 5/24 =
              0.208
            </li>
            <li>
            ...
            <li>
              0.208 = 10k/(R<sub>1</sub>+10k) → R<sub>1</sub> + 10k = 10k/0.208 = 48.1kΩ
            </li>
            <li>
        ...
        <ConceptBlock title="Application 1: Emergency Lighting Battery Packs">
          <p>
            Emergency lighting units typically use NiCd or NiMH cells connected in series to achieve
            the required voltage. Each cell provides approximately 1.2V.
          </p>
          <p>
            <strong>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              n = V<sub>required</sub> / V<sub>cell</sub> = 24V / 1.2V = <strong>20 cells</strong>
            </li>
            <li>
              End of discharge (1.0V/cell): V<sub>min</sub> = 20 × 1.0V = 20V
            </li>
        ...
        <ConceptBlock title="Application 4: Control Panel Indicator LEDs">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Power dissipation: P<sub>R</sub> = 0.0145² × 1200 = 0.25W (use 0.5W resistor)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Always double cable runs for Vd. Use high-impedance loads (or buffer the divider with
              an op-amp). Convert all resistances to a single unit before adding. Remember: series =
              same current, parallel = same voltage.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You are specifying a self-contained 3 h maintained emergency luminaire for a hotel
              escape route. The LED engine needs 24 V DC at 0.4 A under emergency operation. You are
              using LiFePO₄ cells (3.2 V nominal, 2.8 V end-of-life) in series.
            </>
          }
          whatToDo={
            <>
              Pick the cell count from the end-of-life voltage so the lamp still runs at spec when
              the battery is at the bottom of its discharge curve: ceiling(24 V / 2.8 V) = 9 cells
              in series (giving 25.2 V end-of-life, 28.8 V nominal). Then size the series
              current-limiting resistor (or constant-current driver) to drop the surplus voltage to
              the LED engine’s forward voltage at 0.4 A. Finally, pick a cell capacity (Ah) of at
              least I_load × duration × derating factor — typically 0.4 A × 3 h × 1.25 ≈ 1.5 Ah
              minimum.
            </>
          }
          whyItMatters={
            <>
              The whole BS 5266-1 duration claim rests on series-circuit arithmetic. Get the cell
              count wrong and the lamp dims out before the 3 h is up — a certifiable non-compliance
              and a life-safety failure on the day it is needed.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Ohm's Law</div>
          </button>
          <button
