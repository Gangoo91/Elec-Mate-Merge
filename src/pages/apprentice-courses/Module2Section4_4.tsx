...
import { ArrowLeft, Lightbulb, CheckCircle, AlertTriangle } from "lucide-react";
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li><strong>Motor speed:</strong> Roughly proportional to frequency (2-pole ≈ 3000rpm at 50Hz)</li>
                <li><strong>Timing:</strong> Some equipment depends on mains frequency for timing reference</li>
                  ...
                  <div className="space-y-3">
                    <div className="bg-card border border-border/30 p-4 rounded-lg">
                      ...
                      <ul className="list-disc pl-6 space-y-1 text-sm text-blue-100">
                        ...
                        <li><strong>Visualization:</strong> 50 complete sine waves in one second</li>
                      </ul>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="bg-card border border-amber-400/30 p-4 rounded-lg">
                      ...
                      <ul className="list-disc pl-6 space-y-1 text-sm text-amber-100">
                        ...
                        <li><strong>Lighting dimmers:</strong> Phase-angle control synchronized to mains</li>
