      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Conservation of fuel and power in buildings - legal requirements for electrical installations
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Purpose and scope of Building Regulations Part L",
              "Different Part L volumes and their applications",
              "Minimum lighting efficacy requirements",
              "Notifiable work and Building Control processes",
              "SAP and SBEM calculation methodologies",
