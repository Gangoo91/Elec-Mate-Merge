...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['5 wires', '2 wires', '3 wires', '4 wires'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['IL = IP / root3', 'IL = IP', 'IL = IP x root3', 'IL = 3 x IP'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Delta-delta', 'Star-delta', 'Delta-star', 'Both delta-delta and star-delta'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Delta-delta (Dd)', 'Delta-star (Dyn11)', 'Star-star (Yy)', 'Zig-zag (Zn)'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The two fundamental three-phase winding arrangements that underpin power distribution and
          motor control
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The star-point of the DNO transformer is the system origin under BS 7671 312.2.1.1 —
              earthed to provide the system reference for TN-S or TN-C-S operation. As a BSE
              designer you must know which earthing system the DNO provides at the cut-out
              (typically TN-C-S/PME on UK urban supplies, TN-S on older urban, TT on rural overhead)
              because that determines bonding, protection and ADS calculations for the entire
        ...
        <ConceptBlock title="Delta (D) Connection - The 3-Wire System">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Line current (IL):</strong> IL = IP x root3 — Line carries currents from two
              phases
            </li>
            <li>
        ...
        <ConceptBlock title="Line vs Phase - Understanding the Difference">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>UK example (400V line):</strong> Star VP = 230V across winding — Delta VP =
              400V across winding
            </li>
            <li>
          ...
          <p>
            A motor rated <strong>230V/400V</strong> (D/Y) means: 230V delta OR 400V star. In both
            cases, each winding sees 230V (phase voltage). The rating tells you which connection to
            use depending on your supply voltage.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="When to Use Star vs Delta">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Higher fault tolerance:</strong> Can operate with one phase lost (open delta)
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Main distribution board:</strong> Star (4-wire) — Single-phase circuits need
              neutral
            </li>
            <li>
            ...
            <li>
              <strong>Large motor starting:</strong> Star then delta — Reduce starting current to
              1/3
            </li>
            <li>
              <strong>Distribution transformer:</strong> Dyn11 — Delta blocks harmonics, star gives
              neutral
            </li>
            <li>
        ...
        <ConceptBlock title="Star-Delta Motor Starting">
          <p>
            Star-delta (Y-D) starting is a reduced voltage starting method for three-phase induction
            motors. It temporarily connects the motor in star during starting, then switches to
            delta for normal running.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">Star-Delta Starting Sequence</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Star (Start):</strong> Motor connected in star. Winding voltage = 230V.
              Current = 1/3 of DOL.
            </li>
            <li>
              <strong>2. Transition:</strong> Timer (5-10 seconds). Motor accelerates to ~80% speed.
              Contactors changeover.
            </li>
            <li>
              <strong>3. Delta (Run):</strong> Motor reconnected in delta. Winding voltage = 400V.
              Full torque available.
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Star-Delta Starting Analysis</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Power consumption:</strong> Star reduced (acceleration) — Delta rated
              (running)
            </li>
          </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Building services note:</strong> Star-delta starting is commonly used for large
            AHU fans, chiller compressors, and pump motors above 7.5kW where direct-on-line starting
            would cause unacceptable voltage disturbance.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Transformer Winding Connections">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Common Transformer Connections</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Dyn11:</strong> Primary delta, secondary star + neutral — UK distribution
              (standard)
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Understanding Vector Groups</p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>11:</strong> Secondary voltage leads primary by 330 degrees (11 x 30 degrees =
              11 o'clock position)
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Delta primary:</strong> Blocks third harmonic currents from circulating in the
              supply
            </li>
            <li>
        ...
        <ConceptBlock title="Neutral Earthing in Star Systems">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Functions of Neutral Earthing</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Voltage stabilisation:</strong> Maintains consistent phase-to-neutral voltages
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>TN-S:</strong> Earthed at source, separate N and PE — Older installations,
              dedicated earth
            </li>
            <li>
              <strong>TN-C-S (PME):</strong> Combined PEN in supply, split at origin — Most UK
              buildings (standard)
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">PME and Neutral-Earth Faults</p>
          <p>
        ...
        <ConceptBlock title="Building Services Applications">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Distribution System Design</p>
          <p>A typical commercial building electrical distribution uses:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Incoming supply transformer (Dyn11):</strong> 11kV/400V, delta primary, star
              secondary with neutral
            </li>
            <li>
            ...
            <li>
              <strong>Final circuits:</strong> Single-phase from each phase to neutral (balanced
              loading)
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Chiller compressors:</strong> 30-100kW+, Star-delta or soft start — Delta
              running
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Load Balancing in Star Systems</p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A balanced three-phase load draws 45A per phase from a 400V
            star-connected supply. Calculate the line voltage, phase voltage, and total power
          ...
          <p>
            <strong>Question:</strong> A three-phase heater is delta-connected to a 400V supply and
            draws 30A line current. Calculate the phase current and total power.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>In delta: VL = VP = 400V</li>
            <li>Line current IL = 30A</li>
            <li>
              Phase current IP = IL / root3 = 30 / 1.732 = <strong>17.3A</strong>
            </li>
          ...
          <p>
            ...
            direct-on-line in delta. What starting current will it draw using star-delta starting?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Star starting current = 180 / 3 = <strong>60A</strong>
            </li>
          ...
          <p>
            <strong>Question:</strong> A motor nameplate shows 230V/400V (D/Y). Explain what this
            means and how to connect it to a UK 400V supply.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              For UK 400V supply: <strong>Connect in Star (Y)</strong>
            </li>
            <li>Each winding will receive: 400V / 1.732 = 230V</li>
            <li>This matches the winding's rated voltage</li>
            <li>
              Star-delta starting: Start in Star, run in Delta would give winding 133V during start
              - too low. Use correct rating motor.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              root3 = <strong>1.732</strong>
            </li>
            <li>
              UK line voltage: <strong>400V</strong>
            </li>
            <li>
              UK phase voltage: <strong>230V</strong> (400 / 1.732)
            </li>
            <li>
              Star-delta starting current reduction: <strong>1/3</strong>
            </li>
            <li>
              Star-delta starting torque reduction: <strong>1/3</strong>
            </li>
            <li>
              Dyn11 phase shift: <strong>330 degrees</strong> (11 x 30)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              overvoltage. Attempting single-phase loads from delta without a transformer. Premature
              changeover from star to delta before motor reaches speed causes a current surge.
              Unbalanced loading overloads one phase and causes neutral current and voltage
              imbalance. Ignoring harmonics by under-sizing the neutral for non-linear loads.
            </>
          }
          doInstead={
            <>
              Match motor winding rating to supply (230V/400V D/Y → star on 400V). Derive a neutral
              via Dyn11 transformer if single-phase loads are needed from delta. Wait until 75-80%
              of full speed before star-to-delta changeover. Distribute single-phase loads across
              phases for balance within 10-15%. Use full-size (or up to 1.45x) neutral where 3rd
        ...
        <Scenario
          ...
          situation={
            <>
              The mechanical schedule shows a 22 kW air-handling unit supply fan with fixed-speed
              operation acceptable to the AHU OEM. The contractor proposes a star-delta starter to
              reduce inrush from ~6&times; full-load current (DOL) to ~2&times;. The BSE engineer
              must decide between star-delta and a VSD-based soft starter / drive.
            </>
          }
          whatToDo={
            <>
              Specify a VSD even though variable speed isn&rsquo;t strictly required. Reasons: (a)
              VSD soft-start eliminates inrush completely (1.0&ndash;1.5&times; FLC), removing
              voltage dip on the busbar; (b) IE3+ motor + VSD is the Approved Document L 2021
              default for AHU fans; (c) future-proofing for BMS-driven flow modulation; (d)
              star-delta requires the motor to be delta-rated for 400 V which limits choice in
              modern catalogues. Document the variation if the original spec was star-delta.
            </>
          }
          whyItMatters={
            <>
              Star-delta is largely a legacy starting method now. New BSE installations default to
              VSDs because the energy savings (typically 20&ndash;30 % on fan/pump duty under cube
              law) and the soft-start benefit usually pay for the VSD inside three years. The HNC
              engineer must make the comparison explicit on the design submission, not default to
              the contractor&rsquo;s proposal.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Section 3.7</div>
          </button>
          <button
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Section 4.2</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
