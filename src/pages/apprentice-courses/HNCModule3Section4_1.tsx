                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Winding connected across lines
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Phase voltage (VP)</td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Line carries currents from two phases
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Single-phase circuits need neutral
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Full torque, balanced 3-phase load
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Reduce starting current to 1/3
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Delta blocks harmonics, star gives neutral
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">Delta</td>
                      <td className="border border-white/10 px-3 py-2">
                        Balanced load, no neutral needed
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Earthed at source, separate N and PE
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Older installations, dedicated earth
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">TN-C-S (PME)</td>
                      <td className="border border-white/10 px-3 py-2">
                        Combined PEN in supply, split at origin
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Most UK buildings (standard)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">TT</td>
                      <td className="border border-white/10 px-3 py-2">
                        Source earthed, local earth electrode
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Unearthed or impedance earthed
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Hospitals, critical systems
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1 mt-2 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Oversize neutral (up to 1.45 x phase) for very high harmonic loads
                </li>
                <li className="pl-1">
                  Consideration of harmonic filters or active front-end drives
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Delta: IL = IP x root3</strong> - Line current is root3 times phase
                  current
                </li>
                <li className="pl-1">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Wrong connection:</strong> Connecting 230V rated windings in delta on 400V
                  supply (overvoltage)
                </li>
                <li className="pl-1">
                  <strong>Missing neutral:</strong> Attempting single-phase loads from delta without
                  transformer
                </li>
                <li className="pl-1">
                  <strong>Premature changeover:</strong> Switching to delta before motor reaches
                  speed (current surge)
                </li>
                <li className="pl-1">
                  <strong>Unbalanced loading:</strong> Overloading one phase, causing neutral
                  current and voltage imbalance
                </li>
                <li className="pl-1">
                  <strong>Ignoring harmonics:</strong> Under-sizing neutral for non-linear loads
                </li>
              </ul>
            </div>
          </div>
