...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['100mm', '150mm', '300mm', '50mm'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Orange or Yellow', 'Green', 'Red', 'Blue'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ISO 19650 is the international successor to PAS 1192-2. Where the employer's
              information requirements (EIR) call for BIM Level 2, federated coordination through a
              common data environment is contractually obligatory. Coordination is no longer a "nice
              to have" optional process — it is the deliverable that controls clash risk and
              as-built O&M information quality.
            </>
          }
        ...
        <ConceptBlock title="MEP Coordination Fundamentals">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Security:</strong> CCTV, access control cabling — Small, typically shares data
              routes
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="BIM Clash Detection">
          <p>
            ...
            elements would physically clash, allowing resolution during design rather than expensive
          ...
          <p>
            <strong>
              BIM Level of Development (LOD) for Coordination (LOD — Description — Suitable For):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Installation Sequencing and Priorities">
          <p>
            ...
            is that inflexible services must be installed first, with more flexible services working
            around them. Getting the sequence wrong leads to costly rework and delays.
          </p>
          <p>
        ...
        <ConceptBlock title="Coordination Drawings and Interface Management">
          <p>
            ...
            all MEP services on single drawings showing how conflicts have been resolved. Interface
            management ensures clear responsibility boundaries between contractors at connection
            points.
          </p>
          <p>
          ...
          <p>
            <strong>Service Zone Allocation Example —</strong> Ceiling void depth: 600mm (FFL +3000
            to structure +3600). Zone allocation (from structure down):
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>
              Interface Management Matrix (Interface Point — Responsibility A — Responsibility B):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>BMS sensor:</strong> Controls: sensor and cable — Mechanical: duct penetration
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Documentation tip:</strong> All coordination decisions must be recorded. If it's
            not documented, it didn't happen — and will likely cause disputes later.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — Ceiling Void Clash Resolution:</strong> A 450mm supply duct clashes
            with a 150mm electrical cable tray at the same level (+3200).
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Not attending coordination meetings</strong> — Decisions are made; your work
                gets rerouted
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You are managing a hospital MEP package. The mechanical contractor installs the AHU
              plant before electrical containment is coordinated. When the electrical sub arrives to
              install the LV riser, the busbar route clashes with a primary ductwork run that is
              already insulated and fixed. The structural slab penetration was sized for the
              original electrical route only.
            </>
          }
          whatToDo={
            <>
              Stop the works. Issue a coordination NCR. Convene a clash-resolution meeting with
              structural, mechanical, electrical and the architect. Use the federated BIM model to
              identify three options: relocate busbar (added cost, no programme impact), break out
              and re-form penetration (cost and programme impact), or oversize busbar enclosure
              (commercial impact). Cost and programme each option, present to client, agree
              mitigation. Update coordination drawings and re-issue.
            </>
          }
          whyItMatters={
            <>
              Coordination clashes discovered on site cost 10–100× more than the same clash resolved
              on a model. The contractor that installed first and "moved on" usually owns the cost —
              but the programme hit is shared by everyone. Discipline at coordination stage protects
              the entire project.
            </>
          }
        />
