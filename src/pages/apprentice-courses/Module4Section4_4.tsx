...
const TITLE =
  'Cable Pulling Techniques - Single-Core and Multi-Core Cables | Level 2 Electrical Course';
const DESCRIPTION =
  'Master professional cable pulling techniques for single-core and multi-core cables. Learn preparation methods, tension control, and damage prevention for BS 7671 compliance.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      'To increase pulling speed',
      'To reduce friction and prevent cable damage',
      'To reduce the number of workers needed',
    ],
    correctIndex: 1,
    explanation:
      'Cable rollers reduce friction and prevent abrasion damage by supporting the cable and creating smooth contact points during pulling operations.',
  },
  {
    id: 2,
    question: 'What is the purpose of using a pulling lubricant?',
    options: [
      'To clean the cable during installation',
      'To reduce friction during pulling',
      'To protect from UV damage',
    ],
    correctIndex: 1,
    explanation:
      'Pulling lubricant reduces friction between the cable and containment surfaces, making pulls easier and preventing jacket damage, especially in long runs or tight bends.',
  },
  {
    id: 3,
    ...
    options: [
      ...
      'To prevent permanent conductor and insulation damage',
      'To reduce installation time',
    ],
    correctIndex: 1,
    explanation:
      'Exceeding minimum bend radius can cause permanent damage to conductors and insulation, leading to reduced performance, early failure, and safety hazards.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Pulling lubricant reduces friction between the cable and containment surfaces, preventing damage and making installation easier.',
  },
  {
    id: 2,
    question:
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Cable rollers and pulling lubricant are two primary methods to reduce friction and prevent abrasion during cable installation.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Pulling single-core cables together ensures even tension distribution and maintains proper phase arrangement, avoiding crossover issues inside containment.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Cable rollers support heavy cables in long tray runs, reducing friction and preventing damage during pulling operations.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Without proper support in vertical pulls, cable weight can cause excessive stretching, potentially damaging conductors and compromising electrical integrity.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      "Twisting or coiling multi-core cables during pulling can damage the internal structure and compromise the cable's performance and safety.",
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'A tension gauge provides real-time monitoring of pulling force, ensuring manufacturer limits are not exceeded and preventing cable damage.',
  },
];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="text-center mb-12">
            ...
            <p className="text-white text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
              Master professional cable pulling techniques that protect conductor insulation,
              prevent stretching, and ensure BS 7671 compliance for safe installations.
            </p>
          </header>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white text-sm space-y-1 list-disc pl-4">
                  <li>
                    Proper cable pulling protects conductor insulation and prevents stretching
                  </li>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white text-sm space-y-1 list-disc pl-4">
                  <li>
                    <strong>Spot:</strong> Long cable runs, vertical pulls, tight containment bends
                  </li>
                  <li>
                    <strong>Use:</strong> Cable rollers, tension gauges, pulling lubricant, draw
                    wire
                  </li>
                  <li>
                    <strong>Check:</strong> Bend radius, cable tension, insulation integrity
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-2 leading-relaxed">
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  Prepare containment systems and cables for pulling operations using professional
                  techniques
                </li>
                <li>
                  Select suitable cable pulling methods for different cable types, weights, and
                  installation routes
                </li>
                <li>
                  Minimise mechanical strain and damage during installation through proper support
                  and technique
                </li>
                <li>Identify common cable pulling faults and implement prevention strategies</li>
                <li>
                  Apply safe working practices during cable pulling operations to protect personnel
                  and equipment
                </li>
              </ul>
            </div>
          ...
          <section className="mb-10">
            ...
            <p className="text-white mb-4 leading-relaxed">
              Thorough preparation is essential for successful cable installation and prevents
              costly damage or rework:
            </p>

            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                <p className="font-medium text-white mb-2">
                  Containment Inspection and Preparation
                </p>
                <p className="text-white text-sm mb-2">
                  <strong>Sharp edge protection requirements:</strong>
                </p>
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Route verification procedures:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <div className="text-sm text-elec-yellow/80 bg-elec-yellow/5 p-2 rounded mt-2">
                  <strong>Critical requirement:</strong> No containment opening should exceed 90%
                  fill capacity
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <div className="text-sm text-green-400/80 bg-green-500/5 p-2 rounded mt-2">
                  <strong>Professional tip:</strong> Mark cable length at regular intervals before
                  pulling starts
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Personnel requirements by cable type:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Communication protocol standards:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <div className="text-sm text-purple-400/80 bg-purple-500/5 p-2 rounded mt-2">
                  <strong>Safety requirement:</strong> Designate one person as pull coordinator with
                  override authority
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <p className="text-white mb-4 leading-relaxed">
              Method selection depends on cable weight, route complexity, and available access
              points:
            </p>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Application parameters:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Technique requirements:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <div className="text-sm text-green-400/80 bg-green-500/5 p-2 rounded mt-2">
                  <strong>Ergonomic limit:</strong> Individual pulling force should not exceed 25%
                  of body weight
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-blue-500/50">
                <p className="font-medium text-white mb-2">
                  Mechanical Pulling Systems and Control
                </p>
                <p className="text-white text-sm mb-2">
                  <strong>Winch specifications and setup:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Cable tension limits by type:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <div className="text-sm text-blue-400/80 bg-blue-500/5 p-2 rounded mt-2">
                  <strong>Critical safety:</strong> Never exceed manufacturer's stated maximum
                  pulling tension
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-orange-500/50">
                <p className="font-medium text-white mb-2">
                  Support Equipment and Friction Reduction
                </p>
                <p className="text-white text-sm mb-2">
                  <strong>Cable roller specifications:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Pulling lubricant applications:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <div className="text-sm text-orange-400/80 bg-orange-500/5 p-2 rounded mt-2">
                  <strong>Environmental note:</strong> Use only biodegradable lubricants in outdoor
                  installations
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <p className="text-white mb-4 leading-relaxed">
              Different cable types require specific handling techniques to prevent damage and
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                <p className="font-medium text-white mb-2">
                  Single-Core Cable Installation Procedures
                </p>
                <p className="text-white text-sm mb-2">
                  <strong>Simultaneous pulling requirements:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Separation and spacing control:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <div className="text-sm text-purple-400/80 bg-purple-500/5 p-2 rounded mt-2">
                  <strong>BS 7671 requirement:</strong> Single-core cables must be arranged to
                  minimise inductance
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                <p className="font-medium text-white mb-2">
                  Multi-Core Cable Protection and Support
                </p>
                <p className="text-white text-sm mb-2">
                  <strong>Bend radius calculations:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Support and deformation prevention:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <div className="text-sm text-elec-yellow/80 bg-elec-yellow/5 p-2 rounded mt-2">
                  <strong>Quality check:</strong> Measure cable diameter after installation to
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-red-500/50">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Abrasion protection measures:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Post-installation verification:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <div className="text-sm text-red-400/80 bg-red-500/5 p-2 rounded mt-2">
                  <strong>Rejection criteria:</strong> Any visible damage to outer sheath requires
                  cable replacement
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <p className="text-white mb-4 leading-relaxed">
              Professional cable pulling requires adherence to safety protocols and quality
              standards:
            </p>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-red-500/50">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Critical errors to avoid:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Prevention protocols:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <div className="text-sm text-red-400/80 bg-red-500/5 p-2 rounded mt-2">
                  <strong>Industry standard:</strong> Stop work immediately if any resistance
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Weight distribution strategies:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <p className="text-white text-sm mb-2">
                  <strong>Environmental adaptations:</strong>
                </p>
                <ul className="text-white text-sm ml-4 mb-2 list-disc space-y-1">
                ...
                <div className="text-sm text-green-400/80 bg-green-500/5 p-2 rounded mt-2">
                  <strong>Best practice:</strong> Record ambient temperature and cable condition for
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-orange-500/5 border-l-2 border-orange-500/50">
              <p className="text-white text-sm mb-3">
                <strong>Scenario:</strong> During a commercial installation, a team pulled a heavy
                95mm² 4-core SWA cable through 80m of steel trunking without using cable rollers or
                lubricant.
              </p>
              <p className="text-white text-sm mb-2">
                <strong>Problems encountered:</strong>
              </p>
              <ul className="text-white text-sm list-disc pl-6 mb-3 space-y-1">
                ...
                <li>
                  Failed insulation resistance test due to moisture ingress through damaged sheath
                </li>
              </ul>
              <p className="text-white text-sm mb-2">
            ...
            <div className="space-y-4 text-white">
              <div className="p-4 rounded-lg bg-white/5">
                <p className="font-medium text-white mb-1">
                  Q: Can I exceed the bend radius just for pulling, if I straighten the cable
                  afterwards?
                </p>
                <p className="text-sm">
                  A: No. Exceeding the bend radius can cause permanent internal conductor damage
                  that cannot be repaired by straightening. Always maintain manufacturer
                  specifications.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <p className="font-medium text-white mb-1">
                  Q: Is pulling lubricant always necessary?
                </p>
                <p className="text-sm">
                  A: Not always, but it's essential for long runs over 30m, routes with multiple
                  bends, or tight conduit installations. The cost of lubricant is minimal compared
                  to potential cable damage.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <p className="font-medium text-white mb-1">
                  Q: What if a cable gets stuck mid-pull?
                </p>
                <p className="text-sm">
                  A: Stop immediately, reverse slightly to relieve tension, and locate the
                  obstruction. Never force the pull as this risks serious cable damage. Investigate
                  and clear the problem before continuing.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <p className="font-medium text-white mb-1">
                  Q: How do I calculate maximum pulling tension for a specific cable?
                </p>
                <p className="text-sm">
                  A: Refer to the manufacturer's datasheet for maximum pulling tension. As a general
                  rule: PVC cables = 5 × cable weight, XLPE cables = 7 × cable weight. Never exceed
                  these limits.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <p className="font-medium text-white mb-1">
                  Q: What spacing should I use for cable rollers in long tray runs?
                </p>
                <p className="text-sm">
                  A: Install rollers every 1-2 metres for standard cables, every 1 metre for heavy
                  cables over 50mm². The roller diameter should be at least 10 times the cable
                  diameter.
                </p>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <ul className="text-white text-sm space-y-2 list-disc pl-4">
                <li>
                  Effective cable pulling relies on thorough preparation, proper equipment
                  selection, and coordinated teamwork to ensure safe, compliant installations
                </li>
                <li>
                  Different techniques are required for single-core versus multi-core cables, with
                  specific attention to tension distribution and bend radius limitations
                </li>
                <li>
                  Support equipment including cable rollers, pulling lubricant, and tension
                  monitoring devices are essential for preventing damage during installation
                </li>
                <li>
                  Following manufacturer tension limits and maintaining minimum bend radius prevents
                  costly cable replacement and ensures long-term system reliability
                </li>
                <li>
                  Professional installation practices, including environmental considerations and
                  safety protocols, ensure compliance with BS 7671 and protect both personnel and
                  equipment
                </li>
              </ul>
            </div>
          ...
          {/* Quiz */}
          <section className="mb-10">
            <Quiz questions={quizQuestions} title="Cable Pulling Techniques Knowledge Check" />
          </section>
