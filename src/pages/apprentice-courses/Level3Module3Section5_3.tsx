...
const DESCRIPTION =
  'Master energy calculations, kilowatt-hours and practical energy consumption analysis for City & Guilds Level 3.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'Energy = Power x Time = 3 kW x 4 h = 12 kWh. Both answers C and D are correct as 12 kWh = 12000 Wh.',
  },
  {
    id: 'qc2',
...
const quizQuestions = [
  {
    ...
    explanation:
      'Energy equals power multiplied by time. E = Pt gives energy in watt-seconds (joules) or kilowatt-hours.',
  },
  {
    id: 'q2',
    ...
    explanation:
      '1 kWh = 1000 W x 3600 s = 3,600,000 J = 3.6 MJ. The kWh is a larger, more practical unit for billing.',
  },
  {
    id: 'q3',
  ...
  },
  {
    ...
    explanation:
      'Electricity meters (revenue meters) measure energy consumption in kilowatt-hours for billing purposes.',
  },
  {
    id: 'q6',
  ...
  },
  {
    ...
    explanation:
      'Standing charges are fixed daily/monthly fees covering meter rental, connection maintenance, and supply infrastructure.',
  },
  {
    id: 'q8',
    ...
    options: [
      'Total energy used',
      'Highest kW or kVA in a period',
      'Average power',
      'Power factor',
    ],
    correctAnswer: 'Highest kW or kVA in a period',
    explanation:
      'Maximum demand is the highest power drawn during a billing period, typically measured in 30-minute intervals.',
  },
  {
    id: 'q9',
  ...
  },
  {
    ...
    explanation:
      'Saving = (60-10) x 8 x 365 / 1000 x 0.15 = 50 x 2920 / 1000 x 0.15 = 146 x 0.09 = 13.14 pounds.',
  },
  {
    id: 'q11',
    ...
    options: [
      'During peak hours',
      'For 7 hours overnight',
      'On weekends only',
      'For commercial users only',
    ],
    correctAnswer: 'For 7 hours overnight',
    explanation:
      'Economy 7 provides cheaper electricity for 7 hours overnight (typically 12am-7am) for off-peak use like storage heaters.',
  },
  {
    id: 'q12',
    question: 'Smart meters allow:',
    options: [
      'Only estimated billing',
    ...
    explanation:
      'Smart meters provide real-time consumption data, enabling better energy management and accurate billing without manual readings.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Power (measured in watts or kilowatts) is the rate of energy transfer at any instant. Energy (measured in joules or kilowatt-hours) is the total amount transferred over time. A 3 kW heater has a power rating of 3 kW, but the energy it uses depends on how long it runs. Energy = Power x Time.',
  },
  {
    question: 'Why do we use kWh instead of joules for electricity billing?',
    answer:
      'The joule is too small for practical billing - a 1 kW heater uses 3.6 million joules per hour. The kilowatt-hour is more convenient: 1 kWh = 1000 watts for 1 hour = 3.6 MJ. Typical household consumption of 3000-4000 kWh per year is easier to understand than billions of joules.',
  },
  {
    question: 'How do I calculate electricity running costs?',
    answer:
      'Cost = Power (kW) x Time (hours) x Rate (pence per kWh). For example, a 2 kW heater running 5 hours at 15p/kWh costs 2 x 5 x 15 = 150p = 1.50 pounds. For appliances rated in watts, divide by 1000 to get kW first.',
  },
  {
    question: 'What is maximum demand and why does it matter?',
    answer:
      'Maximum demand is the highest power drawn during a billing period, typically measured in 30-minute windows. Commercial tariffs often charge for maximum demand separately because the supply infrastructure must handle peak loads. Reducing peaks (load shifting) can significantly reduce costs.',
  },
  {
    question: 'How do smart meters benefit energy management?',
    answer:
      'Smart meters provide real-time consumption data visible on in-home displays, helping identify high-consumption appliances. They enable accurate billing without estimates, time-of-use tariffs, and remote reading. Half-hourly data helps businesses analyse usage patterns and reduce costs.',
  },
  {
    question: 'What is the typical electricity consumption for common appliances?',
    answer:
      'Examples: LED lamp 5-10 W, laptop 30-50 W, TV 80-150 W, microwave 800-1200 W, kettle 2-3 kW, electric shower 7-10 kW, oven 2-3 kW, tumble dryer 2-3 kW. Energy use = power x time, so a 3 kW kettle boiling for 3 minutes uses only 0.15 kWh (3 x 3/60 = 0.15).',
  },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
              ...
              <div>
                ...
                <ul className="space-y-2 text-white/80">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Calculate electrical energy consumption in kilowatt-hours and joules
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 shrink-0" />
                    <span>
                      Calculate electricity costs for domestic and commercial applications
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 shrink-0" />
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4 pt-8 border-t border-white/10">
          ...
          <Button className="bg-blue-600 hover:bg-blue-700 text-white" asChild>
            <Link to="/study-centre/apprentice/level3-module3-section5-4">
