...
const quickCheckQuestions = [
  {
    ...
    options: [
      'A government grant scheme for funding renewable energy projects',
      'A mandatory carbon tax applied to building services contractors',
      'A trading platform for buying and selling carbon offset credits',
  ...
  },
  {
    ...
    options: [
      '1.5°C allows a longer timescale to reach net-zero',
      '1.5°C applies only to Scope 1 emissions',
      'There is no practical difference between the two pathways',
  ...
  },
  {
    ...
    options: [
      ...
      'The total absolute emissions in the base year',
      'The national average emissions for the sector',
      'The amount of carbon offsets purchased that year',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      '1-2 years from submission',
      '15-20 years from submission',
      'By 2050 in every case',
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'The United Nations Framework Convention on Climate Change alone',
  ...
  },
  {
    ...
    options: [
      'Independent verification by an ISO-accredited auditor only',
      'Approval by the company board with no external review',
      'Submission to SBTi for technical assessment against criteria',
      'Registration with the national environmental regulator',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['2.5% per year', '1.5% per year', '7% per year', '4.2% per year'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only when the company has more than 500 employees',
      'When Scope 3 emissions exceed 40% of total emissions',
      'In every case, regardless of how small Scope 3 is',
      'Only once near-term Scope 1 and 2 targets are achieved',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Residual emissions may be left unaddressed once 90% is cut',
      'Residual emissions can be cancelled out by avoidance offset credits',
      'Residual emissions (typically 5-10%) must be neutralised through carbon removal',
      'Residual emissions must be reduced to zero before any neutralisation',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Absolute targets cover Scope 1 only; intensity targets cover Scope 3 only',
      'Absolute targets are voluntary; intensity targets are legally mandated',
      'Absolute targets use a base year; intensity targets ignore the base year',
  ...
  },
  {
    ...
    options: [
      ...
      'Embodied carbon in construction materials only, excluding operation',
      'A fixed cap on the floor area that any new building may occupy',
      'Mandatory on-site renewable generation for every new development',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The final certificate confirming validated targets have been met',
      'Public commitment to develop science-based targets within 24 months',
      'A private internal memo with no obligation to act on it',
      'An annual progress report submitted after targets are validated',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The target year by which net-zero must finally be achieved',
      'The first year in which a company reports zero emissions',
      'The year the company signs its initial commitment letter',
  ...
  },
  {
    ...
    options: [
      ...
      'An automatic fine levied by the SBTi proportional to the shortfall',
      'Legal prosecution by the UN Framework Convention on Climate Change',
      'Immediate cancellation of the company trading licence by regulators',
    ],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              SBTi is the strictest mainstream net-zero methodology — much tougher than vague
              "net-zero by 2050" pledges. The 42% by 2030 absolute reduction target effectively
              rules out reliance on offsetting for the bulk of decarbonisation. Built-environment
              targets must address embodied carbon, which is increasingly difficult to reduce by 42%
              without supply-chain intervention.
            </>
          }
        ...
        <ConceptBlock title="The SBTi Framework">
          <p>
            The Science Based Targets initiative (SBTi) provides a rigorous framework for companies
            to set greenhouse gas emission reduction targets aligned with climate science.
            Established as a partnership between CDP, the UN Global Compact, World Resources
            Institute (WRI), and WWF, SBTi translates global climate goals into actionable corporate
            targets.
          </p>
          <p>
            <strong>Core principles of science-based targets:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Science-aligned:</strong> Targets consistent with keeping global warming to
            ...
            <li>
              <strong>Independently validated:</strong> Assessed by SBTi technical experts before
              approval
            </li>
          </ul>
          <p>
            <strong>Temperature Pathway Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1.5°C aligned:</strong> ~4.2% per year — 50% reduction from base year —
              Required for new submissions
            </li>
            <li>
              <strong>Well-below 2°C:</strong> ~2.5% per year — 25-30% reduction — Legacy targets
              only
            </li>
            <li>
              <strong>2°C aligned:</strong> ~1.5% per year — ~15% reduction — No longer accepted
            </li>
          </ul>
          <p>
            <strong>SBTi Validation Process</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Step 1:</strong> Commit
            </li>
            <li>
              <strong>Step 2:</strong> Develop
            </li>
            <li>
              <strong>Step 3:</strong> Submit
            </li>
            <li>
              <strong>Step 4:</strong> Validate
            </li>
            <li>
              <strong>Step 5:</strong> Communicate
            </li>
          </ul>
          <p>
            <strong>Key point:</strong> Since July 2022, SBTi only accepts 1.5°C-aligned targets for
            new submissions, reflecting updated climate science urgency.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Target Types and Methodologies">
          ...
          <p>
            <strong>Intensity Targets</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>GHG Protocol Scopes</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Scope 1:</strong> Direct emissions from owned sources — Company vehicles, site
              generators, gas heating
            </li>
            <li>
              <strong>Scope 2:</strong> Indirect emissions from purchased energy — Office
              electricity, workshop power, site electricity
            </li>
            <li>
              <strong>Scope 3:</strong> All other indirect emissions — Materials, subcontractors,
              employee commuting, installed equipment operation
            </li>
          </ul>
          <p>
            <strong>Target Setting Methods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Economic Intensity Approach:</strong> Reduction in emissions per value-added
              (less common)
            </li>
            <li>
              <strong>Physical Intensity Approach:</strong> Reduction per physical unit (m², kWh,
              tonne produced)
            </li>
          </ul>
          <p>
            <strong>Scope 3 threshold:</strong> If Scope 3 emissions exceed 40% of total emissions,
            companies must set a separate Scope 3 target covering at least 67% of total Scope 3
            emissions.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Near-Term and Net-Zero Targets">
          ...
          <p>
            <strong>Near-Term Targets (5-10 Years)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Coverage:</strong> 95%+ of emissions — 67%+ of emissions (if &gt;40%)
            </li>
            <li>
              <strong>Ambition level:</strong> 1.5°C aligned (~4.2%/year) — Well-below 2°C minimum
            </li>
            <li>
              <strong>Timeframe:</strong> 5-10 years from submission — 5-10 years from submission
            </li>
            <li>
              <strong>Offsetting:</strong> Not accepted — Not accepted
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Deep decarbonisation:</strong> Reduce all scopes by at least 90% (typically
              90-95%)
            </li>
            <li>
              <strong>Neutralise residual:</strong> Address remaining 5-10% through permanent carbon
              removal only
            </li>
            <li>
          ...
          <p>
            <strong>Carbon Removal vs Offsetting</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Beyond Value Chain Mitigation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Buildings Sector Pathway and Reporting">
          <p>
            ...
            guidance through the Buildings Pathway, with intensity metrics particularly relevant to
            building services professionals.
          </p>
          <p>
            <strong>Buildings Sector Intensity Metrics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>kgCO2e/m² (operational):</strong> Building portfolio performance — &lt;20
              kgCO2e/m² for offices
            </li>
            <li>
              <strong>kgCO2e/kWh (energy):</strong> Energy supply decarbonisation — &lt;0.15
              kgCO2e/kWh
            </li>
            <li>
              <strong>kgCO2e/£M revenue:</strong> Economic intensity — Varies by business type
            </li>
          </ul>
          <p>
            <strong>Annual Reporting Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Methodology consistency:</strong> Use same calculation approach as base year
            </li>
            <li>
          ...
          <p>
            <strong>Building Services Contractor Scope 3 Categories</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Purchased goods:</strong> Materials, equipment, consumables — Very high
              (30-50%)
            </li>
            <li>
              <strong>4. Upstream transport:</strong> Material delivery to sites — Medium (5-10%)
            </li>
            <li>
              <strong>6. Business travel:</strong> Flights, hotels, taxis — Low (1-3%)
            </li>
            <li>
              <strong>7. Employee commuting:</strong> Staff travel to work/sites — Medium (5-15%)
            </li>
            <li>
              <strong>11. Use of sold products:</strong> Lifetime energy of installed systems — Very
              high (often largest)
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> An MEP contractor with 2020 base year emissions wants to set
          ...
          <p>
            <strong>Scenario:</strong> Determining if Scope 3 targets are required for an electrical
            contractor.
          </p>
        ...
        <Scenario
          ...
          situation={
            <>
              A property developer signed an SBTi commitment in 2023. Their 2030 target requires
              Scope 3 (mostly embodied carbon in new build) to fall 30% per m² vs 2020 baseline. The
              current pipeline of speculative offices is on track to miss by ~15 percentage points.
              The client now requires every new construction contract to include an embodied carbon
              target with contractual penalties.
            </>
          }
          whatToDo={
            <>
              Update procurement and contract documentation: (1) JCT 2024 with bespoke amendment
              clauses for embodied carbon target (kgCO₂e/m² A1–A5) with verification at handover;
              (2) Tender evaluation weighted on EPD-backed material specifications; (3)
              Pre-construction WLCA at Stage 2 with target ranges; (4) Quarterly embodied carbon
              reporting during construction. Brief the supply chain — most M&E subcontractors have
              not done this and will need EPDs from suppliers.
            </>
          }
          whyItMatters={
            <>
              SBTi is moving from corporate disclosure into project specification. Contractors and
              consultants who cannot quote embodied carbon will progressively lose work as developer
              pipelines align to SBTi. The technical capability to measure, report and reduce
              embodied carbon is becoming a core M&E design competence.
            </>
          }
        />
