...
const quickCheckQuestions = [
  {
    ...
    options: ['12V DC', '5V DC', '16V DC nominal', '24V DC'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1-5 minutes', '2 hours', '30-60 minutes', '10-20 minutes'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Digital control systems for energy efficiency, comfort and flexibility in modern building
          services.
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              modular ceilings and play nicely with DALI head-ends. The control protocol is laid on
              top of a compliant termination — it doesn’t replace it.
            </>
          }
        ...
        <ConceptBlock title="DALI Protocol — Digital Addressable Lighting Interface">
          ...
          <p>
            <strong>DALI-2:</strong> The updated standard adds standardised control devices, colour
            control (Tc, RGBW) and improved interoperability. Specify DALI-2 for new installations.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Presence and Absence Detection">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Ultrasonic — sound wave reflection — fine movement, partitioned spaces</li>
        ...
        <ConceptBlock title="Time Scheduling and Scene Setting">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Video conference — 70% (face lighting important) — meeting rooms with cameras</li>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — DALI system sizing:</strong> An open plan office has 48 luminaires
            to be controlled with DALI. How many buses are required?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 2 — control zone layout:</strong> An office is 15m deep with windows on
            one side. How many daylight control zones are appropriate?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — energy savings estimate:</strong> Estimate annual energy savings for
            lighting controls in a 500m² office operating 2500 hours/year.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              You’re drafting the controls narrative for an open-plan office: 96 luminaires across
              12 desk pods, glazed south façade, three meeting rooms off the floor, a breakout zone
              and a print bay. Client wants Part L compliance, BREEAM Hea 06 credit and zero
              complaints in the first month.
            </>
          }
          whatToDo={
            <>
              Architect the DALI loop: two universes of 64 addresses give you headroom (96 fits in
              one but split for resilience). Group by row of three luminaires for daylight response
              — closest-to-glass row dimmed first, mid-row second, deepest row manually-set
              baseline. Set the strategy to absence detection across the open plan (occupants press
              to turn on, sensor turns off after 15 min absence) and presence in the meeting rooms
              and print bay. Daylight setpoint 500 lx maintained, dimming rate 30 s minimum to avoid
              distraction. Three scenes per meeting room (Present, Video Call, Cleaning). Wire DALI
              gateway → BACnet/IP into the BMS for monitoring and time schedules (07:30 ramp-up,
              19:00 ramp-down, weekend lock-out with manual override). Document everything on the
              controls schedule so the commissioning engineer knows the intent, not just the
              addresses.
            </>
          }
          whyItMatters={
            <>
              ...
              team gets blamed for poor performance, and the BREEAM credit is lost. DALI is only as
              smart as the brief that goes with it.
            </>
          }
        />
