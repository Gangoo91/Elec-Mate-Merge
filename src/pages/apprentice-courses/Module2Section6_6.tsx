...
const Module2Section6_6: React.FC = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: [
        'Domestic bills charge reactive energy separately',
        'PF has no effect on cable heating',
        'Poor PF can raise current but most domestic bills are based on kWh only',
        'PF always damages the meter',
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'Feeling the room is cooler',
        'Changing supplier only',
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Plug‑in monitor rated for the load with good ventilation',
        'Use a 3‑way adaptor chain',
        'Remove the earth for less leakage',
        'Open the compressor housing',
      ],
      correctAnswer: 0,
