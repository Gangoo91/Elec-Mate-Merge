...
const Module2Section6_6: React.FC = () => {
  ...
  const faqs = [
    {
      q: 'What is a kWh on my bill?',
      a: "A kilowatt‑hour is one kilowatt used for one hour. It's the unit you pay for.",
    },
    {
      q: 'Why do I pay a standing charge?',
      a: 'It covers fixed costs for supplying electricity, regardless of how much you use.',
    },
    {
      q: 'Are plug‑in energy monitors safe?',
      a: 'Use CE/UKCA‑marked devices within their rating, do not daisy‑chain high loads, and keep ventilation clear.',
    },
    {
      q: 'How do I estimate EV charging cost?',
      a: 'Energy (kWh) × unit rate. On time‑of‑use tariffs, schedule off‑peak to reduce the unit rate.',
    },
    {
      q: 'Can I install a CT clamp anywhere?',
      a: 'Only as per manufacturer instructions on a single live conductor where safe. Never inside equipment you are not competent to access.',
    },
    {
      q: 'Do smart automations work without internet?',
      a: 'Many schedules run locally, but cloud features and remote access may need connectivity. Check the product details.',
    },
    {
      q: "What's the difference between kW and kWh?",
      a: 'kW is power at an instant (like car speed), kWh is energy over time (like distance travelled). Bills charge for kWh.',
    },
    {
      q: 'How accurate are smart meter readings?',
      a: 'Very accurate for billing purposes. In-home displays may round figures but meter readings are precise.',
    },
    {
      q: 'Can I monitor three-phase supplies safely?',
      a: 'Yes, but requires appropriate equipment and competence. Consider professional installation for permanent monitoring.',
    },
    {
      q: 'What causes high standing charges?',
      a: 'Standing charges cover network costs, meter rental, and supplier overheads. They vary by region and supplier.',
    },
    {
      q: 'Are prepayment meters more expensive?',
      a: 'Unit rates can be higher, but they help with budgeting. Smart prepay meters offer more flexibility than traditional ones.',
    },
    {
      q: 'How do I read an analogue electricity meter?',
      a: 'Read from left to right, note the lower number when the pointer is between two digits. Ignore red dials (these show decimal places).',
    },
  ];
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: [
        'Estimate the load from the appliance label only',
        'Splice an extra cable into the circuit by hand',
        'Use a household multimeter left connected in series',
        'Use a suitable, rated monitoring device or sub‑meter per manufacturer instructions',
      ],
      correctAnswer: 3,
      explanation:
        'Use equipment designed for the job and install safely in line with BS 7671 and instructions.',
    },
    {
      id: 4,
      question:
        'Which smart feature most often saves money for EV charging on time‑of‑use tariffs?',
      options: [
        'Scheduled off‑peak charging',
        'Charge immediately at peak',
        'Random start',
    ...
    },
    {
      ...
      options: [
        'Poor power factor stops appliances working entirely',
        'Poor PF can raise current but most domestic bills are based on kWh only',
        'Domestic bills charge directly for reactive power',
        'Power factor has no effect on current at all',
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Estimate the saving from the device packaging',
        'Assume the saving matches the advertised figure',
        'Compare monitored kWh before and after under similar use',
        'Check whether the appliance feels cooler to touch',
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        'Around the CPC only',
        'Around both line and neutral together',
        'Around the neutral only',
        'Around the live only, as per instructions',
      ],
      correctAnswer: 3,
      explanation: 'Clamping both conductors cancels the current; follow instructions and safety.',
    },
    {
      id: 8,
      question: 'Which is the safest method to monitor a fridge freezer?',
      options: [
        'A plug‑in monitor rated for the load with good ventilation',
        'A homemade adaptor wired in to the socket',
        'An undersized travel adaptor between plug and socket',
        'A monitor rated well below the appliance load',
      ],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [
        'Fire alarm',
        'EV charging',
        'Emergency lighting test during an emergency',
        'Life‑safety systems',
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Only the date the device was purchased',
        'Just the name of the appliance being monitored',
        'Equipment ratings, installation location, and initial baseline readings',
        'Only the monthly cost shown on the bill',
      ],
      correctAnswer: 2,
      explanation:
        'Proper documentation helps with maintenance, troubleshooting, and demonstrating compliance with regulations.',
    },
  ] as const;
    ...
    <div className="bg-[#1a1a1a] overflow-x-hidden">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> High‑duty heaters, always‑on IT kit, refrigeration cycling
                  too often.
                </li>
                <li>
                  <strong>Use:</strong> Plug monitors, sub‑meters, smart sockets and app dashboards.
                </li>
                <li>
                  <strong>Check:</strong> Ratings, instructions and BS 7671 when installing
                  monitors/relays.
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <BarChart3 className="w-5 h-5" /> Understanding your bill (plain English)
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
              <li>
                <strong>Unit rate (p/kWh):</strong> what you pay for each kilowatt‑hour used.
              </li>
              <li>
                <strong>Standing charge:</strong> a daily fee added regardless of usage.
              </li>
              <li>
                <strong>Time‑of‑use tariffs:</strong> cheaper off‑peak, pricier peak. Shift flexible
                loads where safe.
              </li>
              <li>
                <strong>Simple cost idea:</strong> Power in kW × hours used × unit rate. Add
                standing charge and VAT for the bill total.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <Activity className="w-5 h-5" /> Monitoring loads
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
              <li>
                <strong>Plug‑in monitors:</strong> Great for portable appliances. Do not exceed the
                device rating and avoid daisy‑chains.
              </li>
              <li>
                <strong>Smart meters and IHD:</strong> Whole‑home view; useful trends day‑to‑day.
              </li>
              <li>
                <strong>Sub‑metering/CT clamps:</strong> For circuits or larger loads. Install per
                manufacturer guidance and BS 7671.
              </li>
              <li>
                <strong>Data logging:</strong> Look for overnight baseload and unexpected spikes to
                find savings.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <Smartphone className="w-5 h-5" /> Smart tech and automations
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
              <li>
                Scheduling: water heating, EV charging, signage and HVAC warm‑up where appropriate.
              </li>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <PlugZap className="w-5 h-5" /> Practical examples
            </h3>
            <ul className="space-y-4 text-xs sm:text-sm text-white">
              <li className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
                ...
                <p>
                  Measure baseload overnight, then switch off/replace always‑on items such as old
                  routers or media boxes. Use smart sockets on office gear to power down after
                  hours.
                </p>
              </li>
              <li className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
                ...
                <p>
                  Monitor fridges/freezers for cycling and door‑left‑open alarms. Maintain seals and
                  clear ventilation. Schedule signage lighting separately to reduce peak use.
                </p>
              </li>
              <li className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
                <p className="font-medium">3) EV charging</p>
                <p>
                  Use the EVSE/app to schedule off‑peak charging. Confirm circuit capacity, RCD type
                  and earthing arrangement meet BS 7671 before use.
                </p>
              </li>
            </ul>
          </section>
          ...
          <InlineCheck
            ...
            options={[
              'Any plug will do',
              'Use a device rated for the load and keep protective devices unchanged',
              'Remove the fuse to save energy',
              'Cover vents to keep it quiet',
            ]}
            correctIndex={1}
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <Percent className="w-5 h-5" /> BS 7671 context and good practice
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
              <li>
                When adding monitoring or smart control, follow manufacturer instructions and
                maintain disconnection times and protective coordination.
              </li>
              <li>
                Consider grouping, ambient temperature and enclosure space for any extra devices
                installed.
              </li>
              <li>
                Keep records of settings, schedules and any measured savings as part of the job
                documentation.
              </li>
            </ul>
            <div
            ...
            >
              ...
              <p className="text-white text-sm">
                Isolate, lock‑off and prove dead. Never bypass protective devices to attach monitors
                or controls.
              </p>
            </div>
          </section>
        ...
        <section className="mb-10">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <BarChart3 className="w-5 h-5" /> Bill deep‑dive: tariff notes
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
              <li>
                Time‑of‑use tariffs favour shifting flexible loads (EV, water heating). Avoid moving
                safety‑critical loads.
              </li>
              <li>Unit rate applies to kWh; standing charge applies per day. Budget both.</li>
              <li>
                Small businesses may see capacity/demand charges; check the contract and avoid
                avoidable peaks.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <Activity className="w-5 h-5" /> Monitoring checklist
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
              <li>
                Choose a method: plug‑in monitor (portable loads), sub‑meter/CT (circuits), smart
                meter data (whole site).
              </li>
          ...
          <InlineCheck
            ...
            options={[
              'Around both live and neutral together',
              'On the live only, in the correct direction, per instructions',
              'On the CPC',
              'Anywhere inside without isolation',
            ]}
            correctIndex={1}
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <Smartphone className="w-5 h-5" /> Smart tech pitfalls and fixes
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
          ...
          <section className="mb-6">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-4 bg-gradient-to-r from-elec-yellow/10 to-elec-yellow/10 border border-border/30">
                <h4 className="font-medium mb-2 text-blue-700 text-elec-yellow">
                  Data analysis and interpretation
                </h4>
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Baseload identification:</strong> Measure overnight consumption to find
                    always-on loads
                  </li>
                  <li>
                    <strong>Peak demand analysis:</strong> Identify when highest power is used and
                    potential for load shifting
                  </li>
                  <li>
                    <strong>Load profiling:</strong> Understand daily, weekly, and seasonal patterns
                  </li>
                  <li>
                    <strong>Anomaly detection:</strong> Spot unusual consumption that may indicate
              ...
              <div className="rounded-lg p-4 bg-gradient-to-r from-elec-yellow/10 to-elec-yellow/10 border border-elec-yellow/30">
                <h4 className="font-medium mb-2 text-elec-yellow text-elec-yellow">
                  Smart home integration
                </h4>
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Home automation platforms:</strong> Integrate multiple smart devices for
                    coordinated control
                  </li>
                  <li>
                    <strong>Voice control:</strong> Use assistants for manual override of automated
                    systems
                  </li>
                  <li>
                    <strong>Smartphone apps:</strong> Remote monitoring and control with usage
                    notifications
                  </li>
                  <li>
                    <strong>Interoperability:</strong> Ensure devices can communicate using
                    standards like Zigbee or Z-Wave
                  </li>
                </ul>
              </div>

              <div className="rounded-lg p-4 bg-gradient-to-r from-amber-500/10 to-amber-600/10 border border-amber-400/30">
                <h4 className="font-medium mb-2 text-amber-700 dark:text-amber-300">
                  Commercial and industrial applications
                </h4>
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Sub-metering strategies:</strong> Department or process-level monitoring
                    for cost allocation
                  </li>
                  <li>
                    <strong>Demand response:</strong> Automatic load reduction during peak pricing
                    periods
                  </li>
                  <li>
                    <strong>Power quality monitoring:</strong> Track voltage, current, and power
                    factor for equipment health
                  </li>
                  <li>
                    <strong>Energy management systems:</strong> Centralised control and reporting
