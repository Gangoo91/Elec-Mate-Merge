...
const DESCRIPTION =
  'Comprehensive guide to cable terminations and connectors for electrical maintenance technicians: crimping, soldering, mechanical connectors, gland types, torque requirements and BS 7671 compliance under ST1426.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Correct torque is essential for reliable electrical connections. Under-torqued connections have insufficient contact pressure, creating a high-resistance joint that generates heat proportional to I squared R. Over time, this causes oxidation, further increases resistance, and can lead to thermal runaway, insulation damage and fire. Over-torqued connections can deform or shear conductors, crack terminal housings and damage threads, creating equally dangerous conditions.',
  },
  {
    id: 'ferrule-purpose',
    question:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'They can carry higher currents',
      'They are colour-coded',
    ],
    correctAnswer: 1,
    explanation:
      'Spring-cage terminals use a precision spring to maintain constant contact pressure on the conductor. Unlike screw terminals, they do not loosen due to thermal cycling, vibration or conductor creep (particularly important with aluminium conductors). This eliminates the need for periodic retorquing during maintenance. They also provide faster, tool-free wiring for stranded conductors with ferrules.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    options: [
      ...
      '200 degrees C',
      'The same as the cable insulation rating',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Using a standard BW gland with foil tape',
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              a gas-tight, mechanically strong, low-resistance connection between the conductor and
              the terminal lug. The quality of the joint depends entirely on using the correct lug,
              the correct tool, and the correct technique.
            </p>
            <p>
              The crimping process permanently deforms the lug barrel around the conductor,
              compressing the individual strands into intimate contact with the barrel wall. This
              creates a cold-weld joint that is mechanically stronger than the conductor itself.
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              torque applied to the terminal fastener. Too little torque creates a loose,
              high-resistance connection; too much torque damages the conductor, the terminal or
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              consistent contact pressure and vibration resistance. However, they require correct
              conductor preparation — particularly the use of ferrules on stranded conductors — to
              achieve reliable connections.
            </p>
            <p>
              Ferrules (also called bootlace ferrules or cord-end ferrules) are small metal sleeves
              crimped onto the stripped end of a stranded conductor, converting it into a solid,
              precisely sized termination. They are colour-coded by conductor size and must be
              crimped with the correct ferrule crimping tool — never with pliers or side cutters.
