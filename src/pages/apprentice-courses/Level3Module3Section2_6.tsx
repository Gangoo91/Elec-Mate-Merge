...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'At resonance, inductive reactance equals capacitive reactance (XL = XC). They cancel each other out, leaving only resistance to limit current flow.',
  },
  {
    ...
    options: [
      ...
      'Impedance equals R (minimum)',
      'Impedance equals XL + XC',
    ],
    correctIndex: 2,
    explanation:
      'At series resonance, XL and XC cancel (X = 0), so impedance Z = sqrt(R^2 + 0^2) = R. This is the minimum possible impedance, causing maximum current.',
  },
  {
    ...
    correctIndex: 0,
    explanation:
      'f0 = 1 / (2 x pi x sqrt(LC)) = 1 / (2 x 3.142 x sqrt(0.1 x 0.00001)) = 1 / (2 x 3.142 x 0.001) = 159 Hz.',
  },
  {
    ...
    options: [
      ...
      'Current is minimum',
      'Current equals zero',
      'Current equals supply voltage',
    ],
    correctIndex: 1,
    explanation:
      'At parallel resonance, the impedance is maximum and the line current is minimum. The circulating current between L and C can be much higher than the line current.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctIndex: 0,
    explanation:
      'f0 = 1 / (2 x pi x sqrt(LC)) = 1 / (2 x 3.142 x sqrt(0.05 x 0.00002)) = 1 / (6.284 x 0.001) = 159 Hz.',
  },
  {
    question:
      'A series RLC circuit has R = 10 ohms, L = 0.1 H and C = 100 microfarads. What is the Q-factor?',
    options: ['1', '3.16', '10', '31.6'],
    correctIndex: 1,
    explanation:
      'Q = (1/R) x sqrt(L/C) = (1/10) x sqrt(0.1/0.0001) = 0.1 x sqrt(1000) = 0.1 x 31.6 = 3.16. Alternatively Q = XL/R at resonance.',
  },
  {
    question:
      'At series resonance, if the supply voltage is 100V and R = 20 ohms, what is the current?',
    options: ['2 A', '5 A', '0 A', 'Cannot be determined'],
    correctIndex: 1,
    explanation:
      'At series resonance, Z = R. Therefore I = V/Z = V/R = 100/20 = 5 A. The reactances cancel, leaving only resistance.',
  },
  {
    ...
    correctIndex: 0,
    explanation:
      'Bandwidth BW = f0 / Q = 1000 / 50 = 20 Hz. This is the frequency range between the half-power points.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'High Q means high selectivity - the circuit responds strongly to a narrow range of frequencies. Higher Q gives narrower bandwidth (BW = f0/Q).',
  },
  {
    question:
      'What is the dynamic impedance of a parallel resonant circuit with L = 100 mH, C = 100 microfarads and R = 5 ohms?',
    options: ['100 ohms', '200 ohms', '1000 ohms', '5 ohms'],
    correctIndex: 1,
    explanation:
      'Dynamic impedance Zd = L / (CR) = 0.1 / (0.0001 x 5) = 0.1 / 0.0005 = 200 ohms. This is the impedance at parallel resonance.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Series resonant circuits are called acceptor circuits because they have minimum impedance at resonance, allowing maximum current at that frequency to pass.',
  },
  {
    question:
      'At what frequency does a 2 H inductor have the same reactance as a 50 microfarad capacitor?',
    options: ['15.9 Hz', '50 Hz', '100 Hz', '159 Hz'],
    correctIndex: 0,
    explanation:
      'At resonance XL = XC, so f0 = 1 / (2 x pi x sqrt(LC)) = 1 / (2 x 3.142 x sqrt(2 x 0.00005)) = 1 / (6.284 x 0.01) = 15.9 Hz.',
  },
  {
    question:
      'The Q-factor of a parallel resonant circuit is 40 and the resonant frequency is 2 kHz. What are the half-power frequencies?',
    options: [
      '1975 Hz and 2025 Hz',
      '1950 Hz and 2050 Hz',
      '1900 Hz and 2100 Hz',
    ...
    correctIndex: 1,
    explanation:
      'BW = f0/Q = 2000/40 = 50 Hz. Half-power frequencies are f0 +/- BW/2 = 2000 +/- 25 = 1975 Hz and 2025 Hz. Actually BW/2 = 25 Hz each side.',
  },
  {
    question: 'Why are parallel resonant circuits called rejector circuits?',
    options: [
      'They reject all frequencies',
      'They have maximum impedance at resonance, rejecting that frequency',
      'They reject DC',
      'They reject harmonics only',
    ],
    correctIndex: 1,
    explanation:
      'At parallel resonance, impedance is maximum, so current at the resonant frequency is minimum (rejected). Frequencies away from resonance pass more easily.',
  },
  {
    question:
      'If the capacitance in a tuned circuit is increased, what happens to the resonant frequency?',
    options: ['Increases', 'Decreases', 'Stays the same', 'Becomes zero'],
    correctIndex: 1,
    explanation:
      'f0 = 1 / (2 x pi x sqrt(LC)). Increasing C increases sqrt(LC), which decreases f0. Resonant frequency is inversely proportional to sqrt(C).',
  },
  {
    question:
      'A series resonant circuit has a bandwidth of 100 Hz and resonant frequency of 5 kHz. What is the Q-factor?',
    options: ['20', '50', '100', '500'],
    correctIndex: 1,
    explanation:
      "Q = f0 / BW = 5000 / 100 = 50. The Q-factor indicates how selective or 'sharp' the resonance peak is.",
  },
];
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'In series resonance, impedance is minimum (equal to R) and current is maximum - these are called acceptor circuits. In parallel resonance, impedance is maximum and line current is minimum - these are called rejector circuits. Both occur at the same frequency for given L and C values, but their effects on circuit behaviour are opposite.',
  },
  {
    question: 'What is Q-factor and why is it important?',
    answer:
      "Q-factor (Quality factor) indicates how 'sharp' or selective a resonant circuit is. High Q means narrow bandwidth and sharp frequency response - the circuit responds strongly only to frequencies very close to resonance. Q is the ratio of reactive power to resistive power, or XL/R at resonance. It affects bandwidth (BW = f0/Q) and voltage magnification in series circuits.",
  },
  {
  ...
  },
  {
    ...
    answer:
      'At series resonance, the voltage across the inductor or capacitor can be much greater than the supply voltage. The voltage magnification factor equals Q, so VL = VC = Q x VS. For example, with Q = 50 and 10V supply, the voltage across L or C could be 500V. This is why high-Q circuits require careful voltage rating of components.',
  },
  {
    question: 'How can unwanted resonance be prevented in electrical installations?',
    answer:
      'Unwanted resonance can be prevented by: avoiding combinations of capacitance and inductance that resonate at harmonic frequencies, using detuned power factor correction capacitors, installing harmonic filters, and ensuring adequate damping (resistance) in the circuit. In switchgear, ferroresonance with voltage transformers must be considered.',
  },
];
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-blue-900/30 border border-blue-500/50 rounded-lg p-6 mb-8">
          ...
          <ul className="text-white/80 space-y-2">
            ...
            <li className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 mt-1 text-green-400 flex-shrink-0" />
              Distinguish between series resonance (acceptor) and parallel resonance (rejector)
              circuits
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 mt-1 text-green-400 flex-shrink-0" />
          ...
          <div className="mb-12">
            ...
            <div className="bg-[#242424] rounded-lg p-6 border border-white/10">
              ...
              <ul className="text-white/80 space-y-2 mb-4">
                ...
                <li>
                  Energy oscillates between inductor and capacitor at twice the resonant frequency
                </li>
                <li>
                  The amplitude of oscillation depends on how much resistance (damping) is present
                </li>
              </ul>
          ...
          <div className="mb-12">
            ...
            <div className="bg-[#242424] rounded-lg p-6 border border-white/10">
              ...
              <p className="text-white/80 mb-4">
                ...
                radio tuning to select specific stations.
              </p>
          ...
          <div className="mb-12">
            ...
            <div className="bg-yellow-900/30 border border-yellow-500/50 rounded-lg p-6">
              ...
              <ul className="text-white/80 space-y-2">
                ...
                <li>
                  <strong>Filter circuits:</strong> Band-pass filters use series resonance,
                  band-stop filters use parallel resonance to pass or reject specific frequency
                  ranges.
                </li>
                <li>
                  <strong>Harmonic resonance:</strong> If PFC capacitors resonate with system
                  inductance at a harmonic frequency, dangerous voltage magnification can occur. Use
                  detuned capacitors (typically 7% reactor).
                </li>
                <li>
                  <strong>Ferroresonance:</strong> Non-linear resonance between transformer
                  magnetising inductance and cable capacitance can cause overvoltages. Common issue
                  with voltage transformers.
                </li>
                <li>
                  <strong>Induction heating:</strong> High-frequency resonant circuits generate heat
                  in metal workpieces for hardening and welding applications.
                </li>
              </ul>
            </div>
          </div>
