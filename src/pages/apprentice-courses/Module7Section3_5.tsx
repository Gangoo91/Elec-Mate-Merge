...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'User complaints often identify developing electrical problems before they become dangerous, providing valuable early warning signs.',
  },
  {
    id: 2,
    ...
    options: [
      ...
      'Tell them to use less appliances',
      'Replace the kettle',
    ],
    correctIndex: 1,
    explanation:
      'This indicates potential voltage drop due to overloading or poor connections, requiring circuit investigation.',
  },
  {
    id: 3,
    ...
    options: [
      ...
      'Only the specific fault',
      'Just when it happens',
      'Only who reported it',
    ],
    correctIndex: 0,
    explanation:
      'Comprehensive information about timing, conditions, location, and circumstances helps identify patterns and guide effective testing.',
  },
];
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'User complaints often identify electrical problems in their early stages, before they become dangerous or cause major failures.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'Dimming lights during appliance startup indicates voltage drop caused by circuit overloading or high-resistance connections.',
    },
    {
      id: 3,
      ...
      correctAnswer: 1,
      explanation:
        'Electric shock reports require immediate isolation and urgent investigation as they indicate serious earth fault or insulation failure.',
    },
    {
      id: 4,
      ...
      correctAnswer: 1,
      explanation:
        'Rain-related tripping typically indicates water ingress into electrical equipment causing earth leakage faults.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'Documenting complaints helps identify recurring patterns, prioritise investigations, and track fault development over time.',
    },
    {
      id: 6,
      ...
      correctAnswer: 1,
      explanation:
        'Comprehensive information about intermittent faults helps identify patterns and conditions that trigger the problems.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'User complaints help identify potentially dangerous conditions that require immediate attention versus routine maintenance items.',
    },
    {
      id: 8,
      ...
      correctAnswer: 1,
      explanation:
        'Burning smells without obvious sources require systematic thermal investigation to prevent potential fire hazards.',
    },
    {
      id: 9,
      ...
      correctAnswer: 1,
      explanation:
        'Minor electrical symptoms often indicate the early stages of faults that can develop into serious safety hazards.',
    },
    {
      id: 10,
      ...
      correctAnswer: 1,
      explanation:
        'The computer reset complaints led to discovery of loose neutral connections causing voltage variations that affected sensitive equipment.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'Create clear reporting procedures, emphasise that no problem is too minor, provide multiple reporting methods (phone, email, app), and always follow up to show that reports are taken seriously.',
    },
    {
      question: "What should you do when user descriptions don't match your technical findings?",
      answer:
        'Remember that users describe symptoms they observe, not technical causes. Use their observations as clues to guide your investigation, and explain your findings in terms they can understand.',
    },
    {
      question: 'How can recurring user complaints help identify systemic problems?',
      answer:
        'Track complaint patterns over time and locations. Multiple similar complaints may indicate design issues, installation problems, or environmental factors affecting multiple circuits or areas.',
    },
    {
      question: "Should you investigate complaints about 'slight tingles' from equipment?",
      answer:
        'Absolutely. Any sensation of electric shock, no matter how minor, indicates a potential earth fault or insulation failure that could become dangerous. These require immediate investigation.',
    },
    {
      question: 'How do you handle complaints about electrical problems that you cannot reproduce?',
      answer:
        "Intermittent faults are common and serious. Gather detailed information about conditions when problems occur, use data logging equipment, and perform comprehensive testing even if problems aren't currently evident.",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-10">
            ...
            <ul className="text-white/80 space-y-2 text-sm list-disc pl-4">
              ...
              <li>
                Apply systematic questioning techniques to gather comprehensive fault information
                from users.
              </li>
              <li>
                Identify patterns in user reports that indicate specific types of electrical
                problems.
              </li>
              <li>
                Prioritise investigation activities based on safety implications of reported
                symptoms.
              </li>
              <li>
                Implement effective communication strategies for gathering and responding to
                electrical fault reports.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                behaviour that precede serious failures.
              </p>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong className="text-white">Sensitivity to change:</strong> Users notice subtle
                  variations in normal electrical behaviour.
                </p>
                <ul className="text-sm list-disc pl-4 space-y-1">
                  <li>Lights dimming slightly when appliances start (indicating voltage drop)</li>
                  <li>
                    Increased sensitivity of RCD devices (suggesting developing earth leakage)
                  </li>
                  <li>
                    Appliances running warmer or noisier than usual (overloading or poor
                    connections)
                  </li>
                  <li>
                    Intermittent operation of electrical equipment (loose connections developing)
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-amber-500/50">
                ...
                <p className="text-sm mb-2">
                  Complaints often indicate developing dangerous conditions:
                </p>
                <ul className="text-sm list-disc pl-4 space-y-1">
              ...
              <div className="p-3 rounded bg-white/5 text-sm">
                <strong className="text-white">Key principle:</strong> Every electrical complaint
                should be investigated - minor symptoms often indicate major developing problems.
              </div>
            </div>
          </section>
              ...
              <div className="space-y-3">
                <div className="p-3 rounded-lg bg-white/5">
                  ...
                  <ul className="text-xs list-disc pl-4 space-y-1">
                    <li>
                      "Lights dim when the kettle/washing machine starts" - circuit overloading
                    </li>
                    ...
                    <li>
                      "Everything seems less bright lately" - neutral or supply connection issues
                    </li>
                  </ul>
                </div>
                ...
                <div className="p-3 rounded-lg bg-white/5">
                  <p className="font-medium text-orange-400 text-sm mb-2">
                ...
                <div className="p-3 rounded-lg bg-white/5">
                  ...
                  <ul className="text-xs list-disc pl-4 space-y-1">
                    <li>
                      "Circuit breaker trips when using multiple appliances" - circuit overload
                    </li>
                    <li>
                      "Extension leads getting hot" - excessive current through inadequate cables
                    </li>
