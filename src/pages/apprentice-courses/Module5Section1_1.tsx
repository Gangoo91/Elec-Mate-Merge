...
const TITLE =
  'What Is a Specification and Why It Matters - Module 5.1.1 | Level 2 Electrical Course';
const DESCRIPTION =
  'Learn about electrical specifications - formal documents defining materials, standards and methods. Essential for BS 7671 compliance and safe installation practices.';
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'A specification defines the materials, standards, methods, and performance criteria for an installation, ensuring consistency and compliance.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Drawings show the location and routing of installations, whilst specifications explain the methods, materials and standards - both are essential for complete information.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'Only if approved by the supervisor and compliant with the specification. Never assume materials are equivalent - always confirm changes with the project manager or client representative before making substitutions.',
    },
    {
      question: 'What if the specification conflicts with BS 7671?',
      answer:
        "BS 7671 always takes precedence as it's the statutory standard. The issue must be raised immediately with the project manager, as the specification will need to be amended to ensure compliance.",
    },
    {
      question: 'Are specifications legally binding?',
      answer:
        'Yes, they form part of the contract and must be followed. Failure to comply with specifications can result in contractual disputes, failed inspections, and potential legal action.',
    },
  ];
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <ul className="text-white/80 space-y-1 text-sm">
              ...
              <li>
                • Must be used alongside drawings - drawings show where, specifications show how
              </li>
            </ul>
          </div>
          ...
          <section className="mb-10">
            ...
            <ul className="text-white/80 space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Define what a specification is and explain its purpose in electrical installation
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />
              ...
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />
                <span>
                  Recognise the importance of following specifications for compliance and safety
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-green-500 mt-1 flex-shrink-0" />
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • States what must be achieved (e.g., "lighting levels must achieve 500 lux")
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • States precisely what must be used (e.g., "use PVC trunking 50mm x 50mm")
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <p className="text-sm">
                  Combines performance and prescriptive elements - prescriptive for critical safety
                  items, performance for other aspects.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500">
              <div className="flex items-start gap-3">
                ...
                <div className="text-white/80 space-y-2 text-sm">
                  ...
                  <p>
                    <strong className="text-white">Costly rework:</strong> Material and labour costs
                    for reinstallation
                  </p>
                  <p>
                    <strong className="text-white">Safety hazards:</strong> Undersized cables,
                    inadequate earthing
                  </p>
                  <p>
                    <strong className="text-white">Legal disputes:</strong> Breach of contract
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <ul className="space-y-2 text-sm text-white/80">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Always read</strong> specifications before
                    starting work
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                  <span>
                    <strong className="text-white">Highlight</strong> key requirements (materials,
                    methods, standards)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                  <span>
                    <strong className="text-white">Cross-check</strong> with drawings and site
                    conditions
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                  <span>
                    <strong className="text-white">Report</strong> any conflicts or unclear
                    instructions
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                  <span>
                    <strong className="text-white">Never assume</strong> — always confirm changes
                  </span>
                </li>
              </ul>
            </div>
          ...
          {/* Quiz */}
          <div className="mb-10">
            <Quiz title="Test Your Knowledge: Specifications" questions={quizQuestions} />
          </div>
