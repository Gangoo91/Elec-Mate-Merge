...
const quickCheckQuestions = [
  {
    ...
    options: ['100Hz', '250Hz', '200Hz', '150Hz'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['3rd and 9th', '11th and 13th', '2nd and 4th', '5th and 7th'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Low-pass filter', 'Tuned passive filter', 'Band-stop filter', 'High-pass filter'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['3rd harmonic', '9th harmonic', '5th harmonic', '7th harmonic'],
    correctAnswer: 2,
    explanation:
...
const HNCModule3Section3_5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 3 · Subsection 5"
        title="Harmonics - Sources, Effects and Mitigation"
        backTo="/study-centre/apprentice/h-n-c-module3-section3"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              G5/5 (which superseded G5/4-1 in 2020) is the UK DNO&rsquo;s harmonic planning
              standard. Any large LED retrofit, multi-VSD HVAC plant or EV charger array may trigger
              a Stage 2 (estimated emission) or Stage 3 (measured) assessment. As the BSE engineer
              you specify the mitigation (line reactors, AFE drives, active filters) that keeps the
              project below the limit at the PCC and provides the compliance evidence with the DNO
        ...
        <ConceptBlock title="Harmonic Fundamentals">
          <p>
            ...
            fundamental supply frequency. In the UK's 50Hz system, the 3rd harmonic is at 150Hz, the
            5th at 250Hz, and so on. These harmonics combine with the fundamental to create
            distorted waveforms.
          </p>
          <p>Key harmonic concepts:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Harmonic order (h):</strong> The multiple of the fundamental frequency (3rd,
              5th, 7th...)
            </li>
            <li>
              <strong>Fundamental (h=1):</strong> The 50Hz component - the intended power frequency
            </li>
            <li>
              <strong>THD:</strong> Total Harmonic Distortion - measures overall harmonic content
            </li>
            <li>
              <strong>Fourier analysis:</strong> Any periodic waveform can be decomposed into
              harmonics
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Sequence matters:</strong> Positive sequence harmonics (1, 4, 7, 10...) rotate
            in the same direction as the fundamental. Negative sequence (2, 5, 8, 11...) rotate
            opposite. Zero sequence (3, 6, 9, 12...) do not create a rotating field but add in the
            neutral.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Odd, Even and Triplen Harmonics">
          <p>
            Understanding the different categories of harmonics is essential for predicting their
            effects and selecting appropriate mitigation strategies. Each type behaves differently
          ...
          <p>
            ...
            harmonics are all in-phase (zero-sequence) and ADD together. Neutral current (triplen) =
            3 × Phase triplen current. Example: If each phase has 40A of 3rd harmonic current: Iₙ =
            3 × 40A = <strong>120A in neutral</strong>. This can exceed the phase current, causing
            neutral overheating.
          </p>
          <p>
            <strong>Why Odd Harmonics Dominate:</strong> Most electronic loads draw current
            symmetrically on both half-cycles of the AC waveform. This half-wave symmetry means the
            positive and negative half-cycles are mirror images, which mathematically results in
            only odd harmonic components. Even harmonics would require asymmetry between half-cycles
            - typically indicating a fault condition or unusual load characteristic.
          </p>
          <p>
            <strong>Design rule:</strong> When third harmonic current exceeds 15% of the
            fundamental, consider increasing neutral conductor size per BS 7671 Regulation 523.6.3.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Sources of Harmonics in Building Services">
          <p>
            Non-linear loads draw current in a non-sinusoidal pattern, generating harmonics. Modern
            buildings are increasingly dominated by these loads, making harmonic management a
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              6-pulse VSD — 5th, 7th, 11th, 13th — Typical THDᵢ 30-80% — Application: HVAC fans,
              pumps
            </li>
            <li>
              LED drivers (SMPS) — 3rd, 5th, 7th — Typical THDᵢ 20-150% — Application: Lighting
              throughout
            </li>
            <li>
              Computers/servers — 3rd dominant — Typical THDᵢ 60-100% — Application: Offices, data
              centres
            </li>
            <li>
              UPS systems — 5th, 7th, 11th — Typical THDᵢ 25-35% — Application: Data centres,
              critical loads
            </li>
            <li>
              Lift drives — 5th, 7th — Typical THDᵢ 40-60% — Application: Vertical transportation
            </li>
            <li>
              Fluorescent lighting — 3rd, 5th — Typical THDᵢ 15-25% — Application: Legacy
              installations
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>IT Equipment and Data Centres:</strong> Server power supplies use switch-mode
            rectification, drawing current only at the peak of each half-cycle. This creates a
            characteristic current waveform with very high 3rd harmonic content - often 80% of the
            fundamental or more. A data centre with 1MW of IT load may generate 800kW equivalent of
            3rd harmonic current, requiring careful neutral conductor sizing and transformer
            specification.
          </p>
          <p>
            <strong>Design consideration:</strong> In modern buildings, assume 60-80% of loads are
            non-linear when calculating harmonic effects unless specific load data is available.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Effects of Harmonics on Electrical Systems">
          <p>
            ...
            Understanding these effects is essential for designing robust building electrical
            systems.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Transformers — Increased eddy current and hysteresis losses — Reduced capacity,
              shortened life
            </li>
            <li>
              Cables — Skin effect increases AC resistance — Overheating, insulation degradation
            </li>
            <li>
              Neutral conductors — Triplen harmonic currents add — Can exceed phase current capacity
            </li>
            <li>Motors — Opposing torques, rotor heating — Reduced efficiency, vibration</li>
            <li>
              Capacitors — Dielectric heating at high frequencies — Premature failure, potential
              fire
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            utilities and inaccurate energy management data. Modern electronic meters conforming to
            BS EN 50470 are more accurate for distorted waveforms.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>RCDs:</strong> May nuisance trip due to high-frequency leakage currents
            </li>
            <li>
              <strong>MCBs:</strong> Magnetic trip may occur at lower RMS currents
            </li>
            <li>
              <strong>Fuses:</strong> Peak currents cause faster deterioration
            </li>
            <li>
              <strong>Electronic relays:</strong> May misoperate if not rated for harmonics
            </li>
          </ul>
          <p>
            <strong>Motor effect:</strong> The 5th harmonic creates a reverse-rotating magnetic
            field that opposes motor torque, causing additional heating and reducing net output by
            2-5% in severe cases.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Harmonic Mitigation Techniques">
          <p>
            Several strategies can reduce harmonic levels to acceptable limits. The choice depends
            on the severity of the problem, available space, budget, and whether mitigation is
            applied at source or system-wide.
          </p>
          <p>
            <strong>Passive Harmonic Filters:</strong> Tuned LC circuits providing a low-impedance
            path for specific harmonic frequencies, diverting them from the supply.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Advantages: Simple, robust technology; No power electronics; Also provide reactive
              power compensation; Cost-effective for single harmonics
            </li>
            <li>
              Limitations: Must be tuned to specific frequency; Risk of resonance at other
              frequencies; Large physical size; Fixed compensation only
            </li>
          </ul>
          <p>
            <strong>Active Harmonic Filters:</strong> Power electronic devices that inject currents
            equal and opposite to measured harmonics, actively cancelling distortion.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Advantages: Adapts to changing loads; Corrects multiple harmonics simultaneously;
              Compact size; No resonance risk
            </li>
            <li>
              Limitations: Higher initial cost; Requires maintenance; Power electronics can fail;
          ...
          <p>
            K-factor indicates increased heating capacity. A K-13 transformer can handle harmonic
            loads that would cause a K-1 transformer to overheat by 13 times.
          </p>
          <p>
            <strong>Phase-Shifting Transformers:</strong> Using multiple transformers with different
            phase shifts can cancel specific harmonics. A delta-star and delta-delta pair with 30°
            phase shift eliminates 5th and 7th harmonics when loads are balanced.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Line reactors (3-5%):</strong> Reduce THD from VSDs by 30-50%
            </li>
            <li>
              <strong>DC link chokes:</strong> Smooth current drawn by VSD input rectifier
            </li>
            <li>
              <strong>Combined approach:</strong> Can reduce VSD THD from 80% to 30%
            </li>
          ...
          <p>
            ...
            reactors) before system-wide solutions (filters). This is usually more cost-effective
            and reduces distribution losses.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="BS 7671 Requirements for Harmonic Environments">
          <p>
            BS 7671:2018+A4:2026 includes specific requirements for installations with significant
            harmonic content, particularly regarding neutral conductor sizing and equipment
            selection.
          </p>
          <p>
            <strong>Regulation 523.6.3 - Neutral Conductor Sizing.</strong> Where the third harmonic
            content of line conductors is greater than 15%, the neutral conductor shall have a
            cross-sectional area at least equal to that of the line conductors. Where third harmonic
            content exceeds 33%, the neutral current may exceed the phase current. In such cases,
            the neutral conductor may need to be sized based on the neutral current rather than the
            phase current, potentially requiring a larger neutral than phase conductors.
          </p>
          <p>
          ...
          <p>
            ...
            Association, G5/5 sets limits for harmonic distortion at the point of common coupling
            (PCC) with the distribution network:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Voltage THD limit:</strong> Typically 5% at LV point of common coupling
            </li>
            <li>
              <strong>Individual harmonic limits:</strong> Vary by harmonic order
            </li>
            <li>
              <strong>Applies to:</strong> Connections above certain power thresholds
            </li>
            <li>
              <strong>Assessment:</strong> May be required for large non-linear loads
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              If I₃ &gt; 33%: Calculate Iₙ = 3 × I₃ and size neutral based on Iₙ if &gt; Iphase
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Building Services Applications">
          ...
          <p>
            <strong>Data Centres:</strong> The most demanding environment for harmonic management,
            with IT loads often representing 70-90% of total building consumption.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Typical THD:</strong> 30-50% current distortion at transformer
            </li>
            <li>
              <strong>Transformer:</strong> K-13 minimum, K-20 for high density
            </li>
            <li>
              <strong>UPS selection:</strong> Specify input THD and PF requirements
            </li>
            <li>
              <strong>Neutral sizing:</strong> Often 150-200% of phase conductor
            </li>
            <li>
              <strong>PDU design:</strong> Consider active filtering at rack level
            </li>
          </ul>
          <p>
            <strong>Modern Office Buildings:</strong> High concentration of computers, LED lighting,
            and variable air volume (VAV) systems create cumulative harmonic loading.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>IT load:</strong> Computers, monitors, printers - high 3rd harmonic
            </li>
            <li>
              <strong>Lighting:</strong> LED drivers throughout - 3rd, 5th harmonics
            </li>
            <li>
              <strong>HVAC:</strong> VSD-controlled AHUs and FCUs - 5th, 7th harmonics
            </li>
            <li>
              <strong>Recommendation:</strong> K-4 to K-13 transformers, check neutral sizing
            </li>
          </ul>
          <p>
            <strong>Industrial Facilities:</strong> Variable speed drives for motors often dominate
            the harmonic profile, but loads are typically more predictable than commercial
            buildings.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>VSD specification:</strong> Consider 12-pulse or AFE drives for large motors
            </li>
            <li>
              <strong>Line reactors:</strong> Standard 3% reactors on all VSDs
            </li>
            <li>
              <strong>Capacitor PFC:</strong> Use detuned reactors to avoid resonance
            </li>
            <li>
              <strong>Centralised filtering:</strong> May be cost-effective for large installations
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Future-proofing:</strong> With increasing electrification (EV charging, heat
            pumps) and renewable integration (inverters), harmonic levels in buildings are expected
            to increase. Design with margin for future harmonic growth.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1: Neutral Current Calculation.</strong> A three-phase 100A per phase
            lighting circuit has LED drivers generating 40% third harmonic current. Calculate the
            neutral current.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Third harmonic neutral current (adds): Iₙ(3rd) = 3 × 40A = <strong>120A</strong>
            </li>
            <li>
              Total neutral RMS (if only 3rd harmonic): Iₙ ≈ <strong>120A</strong>
            </li>
            <li>Neutral current exceeds phase current — Neutral must be sized for 120A minimum</li>
          </ul>
          <p>
            <strong>Example 2: K-Factor Selection.</strong> A transformer supplies a data centre
            with the following harmonic profile. Calculate the K-factor and recommend transformer
            rating. I₁ = 100%, I₃ = 80%, I₅ = 60%, I₇ = 40%, I₉ = 20%.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>K-factor = Σ(Iₕ² × h²) / Σ(Iₕ²)</li>
            <li>
              Numerator = (1² × 1²) + (0.8² × 3²) + (0.6² × 5²) + (0.4² × 7²) + (0.2² × 9²) = 1 +
              5.76 + 9 + 7.84 + 3.24 = 26.84
            </li>
            <li>Denominator = 1² + 0.8² + 0.6² + 0.4² + 0.2² = 1.84</li>
            <li>
              K-factor = 26.84 / 1.84 = <strong>14.6</strong>
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              THD = √951 / 100 × 100% = 30.8 / 100 × 100% = <strong>30.8%</strong>
            </li>
            <li>
              This is typical for a 6-pulse VSD without filtering — Consider 3% line reactor to
              reduce to ~20%
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Harmonic frequency:</strong> fₕ = h × f₁ (e.g., 3rd = 3 × 50 = 150Hz)
            </li>
            <li>
              <strong>THD:</strong> √(ΣIₕ²) / I₁ × 100%
            </li>
            <li>
              <strong>Neutral triplen current:</strong> Iₙ = 3 × I(triplen per phase)
            </li>
            <li>
              <strong>6-pulse harmonics:</strong> h = 6n ± 1 (5, 7, 11, 13...)
            </li>
            <li>
              <strong>12-pulse harmonics:</strong> h = 12n ± 1 (11, 13, 23, 25...)
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              3rd harmonic: <strong>150Hz</strong> - triplen, adds in neutral
            </li>
            <li>
              5th harmonic: <strong>250Hz</strong> - negative sequence, reverse motor rotation
            </li>
            <li>
              Neutral sizing threshold: <strong>15%</strong> third harmonic
            </li>
            <li>
              Voltage THD limit (G5/5): Typically <strong>5%</strong> at PCC
            </li>
            <li>
              Line reactor THD reduction: <strong>30-50%</strong> improvement
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Assuming balanced neutral:</strong> Triplen harmonics do not cancel
              </li>
              <li>
                <strong>Ignoring skin effect:</strong> AC resistance increases at higher frequencies
              </li>
              <li>
                <strong>Standard capacitors in harmonic environment:</strong> Causes resonance
              </li>
              <li>
                <strong>K-1 transformer for IT loads:</strong> Will overheat and fail prematurely
              </li>
              <li>
                <strong>Not documenting harmonic considerations:</strong> Affects future
                modifications
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A new commercial HQ has five 75 kW air-cooled chillers each with 6-pulse VSDs feeding
              screw compressors. Total VSD load = 375 kW on a 1000 kVA DNO supply. The DNO has
              flagged the connection for G5/5 Stage 2 assessment; pre-energisation harmonic study
              estimates THDv at the PCC of 6.8 % &mdash; above the 5 % limit.
            </>
          }
          whatToDo={
            <>
              Three options to bring THDv under 5 %: (a) specify each VSD with a 5 % line reactor
              (cheap, drops VSD-side THDi from ~80 % to ~35 %, normally gets you compliant); (b)
              upgrade two VSDs to 12-pulse drives (eliminates 5th and 7th, costly but elegant); (c)
              install a single 200 A active harmonic filter at the MCC (adaptive, future-proofs for
              further EV / LED additions). Run the harmonic study again with the chosen mitigation
              and submit to the DNO with the G5/5 application.
            </>
          }
          whyItMatters={
            <>
              If the project energises without G5/5 compliance the DNO can disconnect the supply,
              and you will be back-fitting mitigation under live conditions. Active filters
              retro-fitted later cost 2&ndash;3&times; the price of a designed-in solution, plus
              disruption to building operation.
            </>
          }
        />
