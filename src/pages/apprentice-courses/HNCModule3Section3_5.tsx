        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Harmonics:</strong> Currents/voltages at multiples of 50Hz fundamental
              </li>
              <li className="pl-1">
                <strong>Sources:</strong> VSDs, LED drivers, IT equipment, UPS systems
              </li>
              <li className="pl-1">
                <strong>Triplen (3rd, 9th, 15th):</strong> Add in neutral - can exceed phase current
              </li>
              <li className="pl-1">
                <strong>Mitigation:</strong> Filters, K-rated transformers, phase shifting
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Data centres:</strong> High THD from IT loads - K-13 transformers typical
              </li>
              <li className="pl-1">
                <strong>LED lighting:</strong> Poor power factor drivers generate harmonics
              </li>
              <li className="pl-1">
                <strong>HVAC VSDs:</strong> Major harmonic source in commercial buildings
              </li>
              <li className="pl-1">
                <strong>BS 7671:</strong> Neutral sizing for harmonic loads (Reg 523.6.3)
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Harmonic order (h):</strong> The multiple of the fundamental frequency
                  (3rd, 5th, 7th...)
                </li>
                <li className="pl-1">
                  <strong>Fundamental (h=1):</strong> The 50Hz component - the intended power
                  frequency
                </li>
                <li className="pl-1">
                  <strong>THD:</strong> Total Harmonic Distortion - measures overall harmonic
                  content
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Harmonic Frequencies in a 50Hz System
              </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Reverse rotating field in motors
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">Positive</td>
                      <td className="border border-white/10 px-3 py-2">
                        Forward rotating field in motors
                      </td>
                    </tr>
                    <tr>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  I<sub>N</sub> = 3 × 40A = <strong>120A in neutral</strong>
                </p>
                <p className="mt-2 text-red-400">
                  This can exceed the phase current, causing neutral overheating!
                </p>
              </div>
            </div>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white/90">
                ...
                harmonics would require asymmetry between half-cycles - typically indicating a fault
                condition or unusual load characteristic.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              Modern buildings are increasingly dominated by these loads, making harmonic management
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Reduced capacity, shortened life
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Triplen harmonic currents add
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Can exceed phase current capacity
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Motors</td>
                      <td className="border border-white/10 px-3 py-2">
                        Opposing torques, rotor heating
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Reduced efficiency, vibration
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Capacitors</td>
                      <td className="border border-white/10 px-3 py-2">
                        Dielectric heating at high frequencies
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Premature failure, potential fire
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    If resonant frequency matches a harmonic, current magnifies
                  </li>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white/90">
                ...
                data. Modern electronic meters conforming to BS EN 50470 are more accurate for
                distorted waveforms.
              </p>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Data centres, high IT load offices
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        VSD-heavy industrial, large UPS
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Two transformers with 30° shift: Cancels 5th, 7th harmonics
                </li>
                <li className="pl-1">
                  Three transformers with 20° shift: Cancels 5th, 7th, 11th, 13th
                </li>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Neutral sizing for harmonic loads
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        All harmonic-rich circuits
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="ml-4">
                  Calculate: I<sub>N</sub> = 3 × I₃
                </p>
                <p className="ml-4">
                  Size neutral based on I<sub>N</sub> if &gt; I<sub>phase</sub>
                </p>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>VSD specification:</strong> Consider 12-pulse or AFE drives for large
                  motors
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Centralised filtering:</strong> May be cost-effective for large
                  installations
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Design Checklist for Harmonic-Rich Environments
              </p>
              <div className="grid sm:grid-cols-2 gap-2">
                {[
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              pumps) and renewable integration (inverters), harmonic levels in buildings are
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  I<sub>N(3rd)</sub> = 3 × 40A = <strong>120A</strong>
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  → Specify K-20 transformer (next standard rating above)
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Harmonic frequency:</strong> f<sub>h</sub> = h × f<sub>1</sub> (e.g., 3rd
                  = 3 × 50 = 150Hz)
                </li>
                <li className="pl-1">
                  <strong>THD:</strong> √(ΣI<sub>h</sub>²) / I<sub>1</sub> × 100%
                </li>
                <li className="pl-1">
                  <strong>Neutral triplen current:</strong> I<sub>N</sub> = 3 × I
                  <sub>triplen per phase</sub>
                </li>
                <li className="pl-1">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Ignoring skin effect:</strong> AC resistance increases at higher
                  frequencies
                </li>
                <li className="pl-1">
