    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Select and size cables correctly to ensure safe operation, compliance with BS 7671 and
          optimal system performance
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the complete cable selection process from determining current-carrying
          capacity through to installation methods. Understanding these principles is essential for
          designing safe, compliant and cost-effective building services installations.
        </p>
