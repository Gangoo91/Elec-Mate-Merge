...
const Level3Module7Section3_3 = () => {
  useSEO(
    "Working with Other Trades and Coordination on Site - Level 3 Career Awareness & Professional Development",
    "Collaborative working practices and effective coordination with other trades"
  );
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 lg:py-12">
        <h1 className="text-xl sm:text-2xl lg:text-xl sm:text-2xl md:text-3xl font-bold text-foreground mb-4 sm:mb-6">
          3.3 Working with Other Trades and Coordination on Site
        </h1>
        ...
        <div className="prose prose-invert max-w-none">
          <p>Content for Working with Other Trades and Coordination on Site will be added here.</p>
        </div>
      </div>
    </div>
  );
