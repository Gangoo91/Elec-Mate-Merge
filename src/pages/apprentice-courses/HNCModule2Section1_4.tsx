...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['U = 1/RT', 'U = RT × 2', 'U = RT + Rsi + Rse', 'U = RT²'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['0.10 m²K/W', '0.13 m²K/W', '0.04 m²K/W', '0.17 m²K/W'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.26 W/m²K', '0.18 W/m²K', '0.30 W/m²K', '0.35 W/m²K'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['0.50 W/m²K', '0.10 W/m²K', '0.20 W/m²K', '5.0 W/m²K'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['R = λ/d', 'R = λ × d', 'R = d + λ', 'R = d/λ'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Windows', 'Ground floor slab', 'Insulated cavity wall', 'Flat roof'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['0.022 W/mK', '0.035 W/mK', '1.0 W/mK', '0.18 W/mK'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.4 m²K/W', '4.0 m²K/W', '2.5 m²K/W', '40 m²K/W'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['0.31 W/m²K', '0.35 W/m²K', '0.28 W/m²K', '3.22 W/m²K'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['0.11 W/m²K', '0.18 W/m²K', '0.16 W/m²K', '0.25 W/m²K'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['125 W', '1000 W', '500 W', '250 W'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['0.18 m²K/W', '0.25 m²K/W', '0.04 m²K/W', '0.09 m²K/W'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Understanding heat transfer through building elements for energy-efficient design and Part
          L compliance.
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Part L sets minimum (limiting) standards and notional &ldquo;target&rdquo; values for
              the SAP / SBEM compliance calculation. As an HNC building services designer your
              fabric assumptions feed straight into the energy model and the Part L submission to
              Building Control.
            </>
          }
        ...
        >
          ...
          <p>
            <strong>Definition:</strong> U = Heat flow rate / (Area × Temperature difference). Unit:
            W/m²K (Watts per square metre per Kelvin).
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lower is better:</strong> A U-value of 0.15 W/m²K loses less heat than 0.30
              W/m²K
            </li>
            <li>
            ...
            <li>
              <strong>Perpendicular flow:</strong> Measures heat flow through the element, not along
              it
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <p>
            <strong>R-value calculation:</strong> R = d / λ, where d = thickness (m) and λ = thermal
            conductivity (W/mK).
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              EPS (expanded polystyrene): λ = 0.032-0.038 W/mK (R ≈ 2.63-3.13 m²K/W per 100mm)
            </li>
        ...
        >
          <p>
            ...
            thermal resistance of each layer, add them together with surface resistances, then take
            the reciprocal.
          </p>
          <p>
            <strong>Method:</strong> RT = Rsi + R1 + R2 + ... + Rn + Rse, then U = 1 / RT. Where Rsi
            = internal surface resistance and Rse = external surface resistance.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Total RT = <strong>2.70 m²K/W</strong>
            </li>
            <li>
              U-value = 1/RT = 1/2.70 = <strong>0.37 W/m²K</strong>
            </li>
            <li>
        ...
        >
          ...
          <p>
            <strong>Heat loss calculation for HVAC sizing:</strong> Qfabric = Σ(U × A × ΔT). Where Q
            = heat loss (W), A = area (m²), ΔT = temperature difference (K).
          </p>
          <p>
          ...
          <p>
            <strong>Building services impact:</strong> Better U-values reduce heating/cooling loads,
            allowing smaller HVAC systems, lower energy consumption, and reduced carbon emissions.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>Example 2 - roof U-value check:</strong> Flat roof construction: 150mm concrete
            deck | 120mm PIR | waterproof membrane. Does it meet Part L?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 - total building heat loss:</strong> Calculate total fabric heat loss
            for a small office building. ΔT = 24K. Walls: 200m² at U = 0.25 W/m²K. Windows: 40m² at
            U = 1.4 W/m²K. Roof: 150m² at U = 0.18 W/m²K. Floor: 150m² at U = 0.20 W/m²K.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A new-build dwelling needs an external wall achieving U ≤ 0.18 W/m²·K (better than the
              limiting standard, to balance other elements in the SAP calculation). The proposed
              build-up is brick / 100 mm cavity / 100 mm aerated block / 25 mm plasterboard.
            </>
          }
          whatToDo={
            <>
              Calculate the as-drawn U from R values: R_si (0.13) + R_brick (0.05) + R_cavity (0.18
              unfilled) + R_block (0.55) + R_plaster (0.05) + R_se (0.04) = 1.0, U = 1.0 W/m²·K.
              That misses by a factor of 5. Fill cavity with 100 mm full-fill mineral wool (R 2.7),
              refigure: U ≈ 0.27 W/m²·K. Still over. Increase to 150 mm partial-fill PIR (R 6.8)
              within a wider cavity, refigure: U ≈ 0.16 W/m²·K. Pass. Add the BS EN ISO 6946
              correction for wall ties (~5%) and document on the SAP submission.
            </>
          }
          whyItMatters={
            <>
              The first-pass &ldquo;clear cavity&rdquo; build-up is a Part L failure that would be
              caught by Building Control before sign-off. Iterating early avoids a re-design when
              foundations are in.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Radiation</div>
          </button>
          <button
