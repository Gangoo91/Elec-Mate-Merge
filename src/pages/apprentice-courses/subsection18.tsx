...
const DESCRIPTION =
  'Understanding the critical importance of safe isolation procedures for electrical safety and legal compliance.';
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'The three core steps are: 1) Isolate the supply, 2) Lock off to prevent re-energising, and 3) Prove the circuit is dead using an approved tester.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'Locking off prevents others from accidentally switching the circuit back on while work is in progress, which could cause serious injury or death.',
    },
    {
      id: 3,
      ...
      correctAnswer: 1,
      explanation:
        'The Electricity at Work Regulations 1989, specifically Regulation 13, makes safe isolation a legal requirement before working on electrical systems.',
    },
    {
      id: 4,
      ...
      correctAnswer: 1,
      explanation:
        'Common failures include forgetting to test circuits after isolation, not using proper test equipment, or failing to lock off the isolator.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'False. Light switches and visual indicators alone cannot confirm isolation. You must always use proper test equipment to prove a circuit is dead.',
    },
  ];
    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-foreground">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Isolation:</strong> Make electrical systems completely dead before work.
                </li>
                <li>
                  <strong>Lock-off:</strong> Prevent accidental re-energising by others.
                </li>
                <li>
                  <strong>Prove dead:</strong> Use approved test equipment to confirm.
                </li>
                <li>
                  <strong>Legal duty:</strong> Required under EAWR 1989.
                </li>
                <li>
                  <strong>Lives saved:</strong> Prevents electric shock, burns, and death.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Live working, no lock-off, visual checks only, untested
                  circuits.
                </li>
                <li>
                  <strong>Use:</strong> Isolation procedures, approved testers, lock-off devices.
                </li>
                <li>
                  <strong>Apply:</strong> Isolate-Lock-Prove sequence every time.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-elec-yellow/5 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <p className="font-medium text-blue-800 dark:text-white mb-3">
                Safe isolation is the process of making an electrical system completely dead,
                locking it off to prevent re-energising, and proving that no voltage is present
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">
                      Turn off the circuit using the appropriate isolator or MCB
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">
                      Prevent re-energising by others using locks and warning labels
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">
                      Prove it is dead using an approved voltage tester
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">
                      Place warning labels or signs to inform others
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm mt-1">
                      You can't tell by looking if something is live - there are no visible signs of
                      danger
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-muted/50 border border-border rounded-lg p-4">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm mt-1">
                      Touching live parts can cause electric shock, severe burns, or death
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-muted/50 border border-border rounded-lg p-4">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm mt-1">
                      Without proper lock-off, someone could switch the circuit back on while you're
                      working
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-muted/50 border border-border rounded-lg p-4">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm mt-1">
                      Mandated under the Electricity at Work Regulations 1989
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-muted/50 border border-border rounded-lg p-4">
              <ul className="space-y-3 text-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Forgetting to test the circuit</strong> after switching off
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <XCircle className="h-4 w-4 text-elec-yellow mt-1 flex-shrink-0" />
                  <span>
                    <strong>Not locking off the isolator</strong> properly or at all
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <XCircle className="h-4 w-4 text-elec-yellow mt-1 flex-shrink-0" />
                  <span>
                    <strong>Using incorrect test equipment</strong> or faulty testers
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <XCircle className="h-4 w-4 text-elec-yellow mt-1 flex-shrink-0" />
                  <span>
                    <strong>Allowing others to switch</strong> the circuit back on during work
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <XCircle className="h-4 w-4 text-elec-yellow mt-1 flex-shrink-0" />
                  <span>
                    <strong>Relying on visual indicators</strong> (like lamps) alone without proper
                    testing
                  </span>
                </li>
              </ul>
          ...
          <div className="space-y-6">
            <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
              ...
              <p className="text-amber-700 dark:text-amber-300 italic text-sm">
                ...
                unless it is unreasonable to be dead and suitable precautions are taken."
              </p>
            </div>
            ...
            <p className="text-foreground">
              Safe isolation is taught and assessed as a core competency in all electrical training
              programmes, and competence must be demonstrated for certification.
            </p>
          </div>
        </div>
        ...
        <div className="mb-8 border-l-4 border-rose-500 p-6 bg-card rounded-lg">
          ...
          <div className="space-y-4">
            <div className="bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-800 rounded-lg p-4">
              <h4 className="font-semibold mb-2 text-rose-800 dark:text-rose-200">
                Case Study: Office Lighting Circuit Maintenance
              </h4>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h5 className="text-red-800 dark:text-red-200 font-medium mb-2">
                      Apprentice Electric Shock Incident
                    </h5>
                    <p className="text-red-700 dark:text-elec-yellow text-sm leading-relaxed">
                      An apprentice believed a lighting circuit was off because the switch was down.
                      He began removing a fitting and received a full electric shock. The MCB had
                      not been isolated and proved dead. The apprentice was hospitalised, and the
                      employer was fined for lack of supervision and training.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-4">
            <div className="border-b border-border/20 pb-4">
              <h4 className="font-semibold text-elec-yellow mb-2">
                Can I rely on a circuit breaker being "off" to confirm isolation?
              </h4>
              <p className="text-white/80 text-sm">
                No. Circuit breakers can fail or be switched back on by others. Always use proper
                test equipment to prove dead and apply lock-off procedures.
              </p>
            </div>
            <div className="border-b border-border/20 pb-4">
              <h4 className="font-semibold text-elec-yellow mb-2">
                What if I'm only doing a quick job?
              </h4>
              <p className="text-white/80 text-sm">
                There are no exceptions. Safe isolation must be followed for every job, regardless
                of duration. Most accidents happen during 'quick jobs'.
              </p>
            </div>
            <div className="border-b border-border/20 pb-4">
              <h4 className="font-semibold text-elec-yellow mb-2">Who can remove my lock-off?</h4>
              <p className="text-white/80 text-sm">
                Only the person who applied it, except in genuine emergencies with proper
            ...
            <div>
              ...
              <p className="text-white/80 text-sm">
                Use approved voltage testers to GS38 standards. Always prove the tester is working
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-4">
            <p className="text-foreground">
              Safe isolation protects lives. No matter how routine the job is, always follow the
              correct process — never work on a circuit unless it is isolated, locked off, and
              proven dead.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
              ...
              <div className="text-center p-4 bg-muted/50 rounded-lg">
                ...
                <p className="text-white/80 text-xs">Test with approved equipment</p>
              </div>
            </div>
          </div>
        </Card>
