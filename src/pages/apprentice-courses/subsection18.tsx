          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
              ...
              <div className="text-center p-4 bg-muted/50 rounded-lg">
                ...
                <p className="text-white text-xs">Test with approved equipment</p>
              </div>
            </div>
          </div>
        </Card>
