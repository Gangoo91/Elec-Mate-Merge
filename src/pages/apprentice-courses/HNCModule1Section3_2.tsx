    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Section 2(6) makes worker consultation a statutory duty. Culture is built on the
              assumption that operatives can speak honestly without retaliation — and the law
              underwrites that assumption.
            </>
          }
        ...
        <ConceptBlock title="Understanding Safety Culture">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pathological</strong> — Characteristics: Power-oriented, low cooperation.
              Response to Safety Info: Messengers are "shot"
            </li>
            <li>
              <strong>Bureaucratic</strong> — Characteristics: Rule-oriented, modest cooperation.
              Response to Safety Info: Messengers are tolerated
            </li>
            <li>
              <strong>Generative</strong> — Characteristics: Performance-oriented, high cooperation.
              Response to Safety Info: Messengers are trained and rewarded
            </li>
          </ul>
        ...
        <ConceptBlock title="Safety Leadership">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Regular site visits and safety conversations</strong> — Impact: Demonstrates
              personal commitment and interest
            </li>
            <li>
              <strong>Always wearing correct PPE on site</strong> — Impact: Models expected
              behaviour - "walk the talk"
            </li>
            <li>
              <strong>Stopping unsafe work immediately</strong> — Impact: Shows safety is not
              negotiable for production
            </li>
            <li>
              <strong>Allocating resources for safety</strong> — Impact: Proves commitment beyond
              words
            </li>
            <li>
              <strong>Recognising and rewarding safe behaviour</strong> — Impact: Reinforces what is
              valued
            </li>
            <li>
              <strong>Acting on safety suggestions and concerns</strong> — Impact: Builds trust and
        ...
        <ConceptBlock title="Behavioural Safety">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Antecedents:</strong> Factors that trigger behaviour (training, procedures,
              equipment)
            </li>
            <li>
            ...
            <li>
              <strong>Consequences:</strong> What happens after the behaviour (positive or negative
              reinforcement)
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Observe</strong> — Activity: Watch work activity without interrupting.
              Purpose: See how work is actually done
            </li>
            <li>
              <strong>2. Record</strong> — Activity: Note safe and at-risk behaviours. Purpose:
              Gather data for analysis
            </li>
            <li>
              <strong>3. Engage</strong> — Activity: Have a conversation with the worker. Purpose:
              Understand the 'why'
            </li>
            <li>
              <strong>4. Reinforce</strong> — Activity: Recognise safe practices observed. Purpose:
              Encourage continuation
            </li>
            <li>
              <strong>5. Analyse</strong> — Activity: Review trends and patterns. Purpose: Identify
              systemic issues
            </li>
            <li>
              <strong>6. Act</strong> — Activity: Address root causes identified. Purpose: Make
        ...
        <ConceptBlock title="Worker Engagement and Culture Indicators">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>High near-miss reporting rate</strong> — Lagging Indicators: Accident
              frequency rates
            </li>
            <li>
              <strong>Safety training completion rates</strong> — Lagging Indicators: Days lost to
              injury
            </li>
            <li>
              <strong>Safety observation frequency</strong> — Lagging Indicators: Workers'
              compensation costs
            </li>
            <li>
              <strong>Hazard reporting and close-out rates</strong> — Lagging Indicators:
              Enforcement notices received
            </li>
            <li>
              <strong>Safety meeting attendance/quality</strong> — Lagging Indicators: Civil claims
              and costs
            </li>
          </ul>
          ...
          <p className="text-sm text-white italic">
            ...
            colleagues - not because of rules, but because they genuinely care about everyone going
            home safely.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Application">
          <p>
            <strong>Example 1: Improving Near-Miss Reporting</strong>
          </p>
          ...
          <div className="bg-black/30 p-3 rounded text-sm text-white">
            <p>
              <strong>Analysis:</strong> Workers fear blame; previous reports led to investigations
            ...
            <p className="mt-2 text-green-400">
              Result: Reporting increased 400% within 6 months, enabling proactive hazard control
            </p>
          </div>

          <p>
            <strong>Example 2: Leadership Safety Walks</strong>
          </p>
          <p className="text-sm text-white mb-2">
            <strong>Objective:</strong> Demonstrate visible leadership commitment across multiple
            sites.
          </p>
          <div className="bg-black/30 p-3 rounded text-sm text-white">
            <p>
        ...
        <ConceptBlock title="Key Points Summary">
          <div>
            <p>
              <strong>Culture Change Essentials</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>Culture change starts at the top - leadership must model desired behaviours</li>
              <li>Actions speak louder than words - what you do under pressure matters most</li>
              <li>Build trust through consistent, fair responses to safety issues</li>
          ...
          <div>
            <p>
              <strong>Behavioural Safety Principles</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <div>
            <p>
              <strong>Warning Signs of Poor Culture</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              Your firm&rsquo;s near-miss reporting drops 80% over two months. You discover a
              director told the team &ldquo;we&rsquo;ve got too many of these — sort it out on the
              floor.&rdquo; Reports stopped, but the underlying near-misses did not.
            </>
          }
          whatToDo={
            <>
              Take the data to the SHE meeting. Restate just-culture principles — every report
              welcomed, no retribution for honest mistakes, learning shared. Brief the director
              privately on the consequence of the comment. Reset the reporting baseline by
              relaunching with visible felt leadership: the MD on site, in person, thanking
              operatives who report. Track the metric monthly.
            </>
          }
          whyItMatters={
            <>
              Suppressed near-miss data masks rising risk. The HSE will trace any incident back to
              leading indicators — and an unexplained drop in reporting is itself a red flag.
            </>
          }
        />
