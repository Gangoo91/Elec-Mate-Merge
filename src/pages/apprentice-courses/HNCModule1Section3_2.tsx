...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Increasing penalties for unsafe acts',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Low accident rate only',
      'Workers voluntarily reporting near misses',
      'Managers never visiting site',
      'Safety discussed only after accidents',
    ],
    correctIndex: 1,
    explanation:
