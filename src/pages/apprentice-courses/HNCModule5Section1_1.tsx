      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>WBS:</strong> Hierarchical decomposition of project scope
              </li>
              <li className="pl-1">
                <strong>100% rule:</strong> Must capture all project deliverables
              </li>
              <li className="pl-1">
                <strong>Work packages:</strong> Lowest level elements for control
              </li>
              <li className="pl-1">
                <strong>Coding system:</strong> Unique identification for tracking
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>MEP systems:</strong> Typically Level 2 elements
              </li>
              <li className="pl-1">
                <strong>Decomposition:</strong> 4-6 levels typical
              </li>
              <li className="pl-1">
                <strong>Work packages:</strong> 8-80 hours duration
              </li>
              <li className="pl-1">
                <strong>Integration:</strong> Links to cost codes and schedule
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Hierarchical:</strong> Parent elements summarise all child elements
                  beneath
                </li>
              </ul>
            </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Systems or sub-deliverables
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Electrical, Mechanical, Public Health, Fire, BMS
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        HV, LV Distribution, Lighting, Small Power
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        DB-G01 Installation, Submain to Level 2
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Distribution board installation (40 hrs)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Reporting Period</td>
                      <td className="border border-white/10 px-3 py-2">
                        Complete within 1-2 reporting cycles
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Cables installed, tested, labelled
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Single Owner</td>
                      <td className="border border-white/10 px-3 py-2">
                        One accountable person/team
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Electrical subcontractor foreman
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Containment can proceed while others cable
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Map WBS codes to cost codes
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Cost tracking by deliverable
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Schedule (Gantt)</td>
                      <td className="border border-white/10 px-3 py-2">
                        Work packages become activities
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Material requirements by WBS
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Delivery aligned to need dates
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Document control</td>
                      <td className="border border-white/10 px-3 py-2">
                        Drawings linked to WBS elements
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Complete document sets per package
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Quality/ITP</td>
                      <td className="border border-white/10 px-3 py-2">
                        Inspection points per work package
                      </td>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical MEP WBS Structure (Level 2-3)
              </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Work Package Example - Electrical Distribution
              </p>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Office Building WBS Development
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Cost Code Integration
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="text-green-400">
                  This enables cost analysis at both detailed and summary levels
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Applying the 100% Rule
              </h3>
              <p className="text-sm text-white mb-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Review contract scope, specifications, and drawings thoroughly
                </li>
