      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3">
            Ensuring Compliance with BS 7671 After Repair
          </h1>
          <p className="text-white/80">
            Verification requirements and compliance obligations for remedial work
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Understand BS 7671 requirements for repair work compliance",
              "Apply Regulation 132.12 principles to remedial work",
              "Identify which tests are required after specific repairs",
              "Handle situations where existing installations have non-compliances",
              "Select appropriate certification for different repair scenarios",
              "Verify protective device coordination after repairs"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module4-section5-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module4-section5-3">
