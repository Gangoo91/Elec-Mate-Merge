...
const quickCheckQuestions = [
  {
    ...
    options: ['Employees', 'Employers', 'Local authorities', 'The HSE'],
    correctIndex: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              As an HNC engineer you sit on both sides of this duty: an employee yourself, but soon
              a supervising or designing duty-holder. Every safe-system, every risk assessment and
              every spec decision you sign off has to demonstrate the SFARP test was applied — risk
              weighed against time, cost and effort to control it.
            </>
          }
        ...
        <ConceptBlock title="Introduction and Structure of HSWA 1974">
          <p>
            ...
            covering occupational health and safety in Great Britain. It established the Health and
            Safety Commission (now merged into HSE) and created a framework for all subsequent
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Risk-based:</strong> Duties qualified by 'so far as reasonably practicable'
              (SFARP)
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Section 2</strong> — Duty Holder: Employers. Summary: Duty to employees
            </li>
            <li>
              <strong>Section 3</strong> — Duty Holder: Employers/Self-employed. Summary: Duty to
              non-employees
            </li>
            <li>
              <strong>Section 4</strong> — Duty Holder: Premises controllers. Summary: Duty
              regarding premises
            </li>
            <li>
              <strong>Section 6</strong> — Duty Holder: Manufacturers/suppliers. Summary: Duty
              regarding articles and substances
            </li>
            <li>
              <strong>Section 7</strong> — Duty Holder: Employees. Summary: Duty to take care and
              cooperate
            </li>
            <li>
              <strong>Section 8</strong> — Duty Holder: Everyone. Summary: Duty not to interfere
              with safety provisions
            </li>
          </ul>

          <p className="text-sm text-elec-yellow/70">
            <strong>Remember:</strong> HSWA 1974 applies to all work activities. The Electricity at
            Work Regulations 1989, made under HSWA, provide specific requirements for electrical
            safety.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Employer Duties - Sections 2 and 3">
          <p>
            ...
            foundation of workplace safety management and apply to all building services contractors
            and employers.
          </p>

          <p>
            <strong>Section 2 - Duties to Employees</strong>
          </p>
          <p className="text-sm text-white mb-3">
            <strong>Section 2(1):</strong> "It shall be the duty of every employer to ensure, so far
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>(c) Information, instruction, training and supervision</strong> - Competence
              for electrical work
            </li>
            <li>
              <strong>(d) Safe workplace and access/egress</strong> - Working at height, confined
              spaces, site conditions
            </li>
            <li>
          ...
          <p>
            <strong>Section 3 - Duties to Non-Employees</strong>
          </p>
          <p className="text-sm text-white mb-3">
            <strong>Section 3(1):</strong> "It shall be the duty of every employer to conduct his
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Client staff</strong> - Building occupants during installation or maintenance
            </li>
            <li>
          ...
          <div>
            ...
            <p className="text-sm text-white mb-2">
              Section 2(3) requires employers with <strong>5 or more employees</strong> to prepare
              and revise a written health and safety policy statement, including:
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Key point:</strong> Section 3 means building services contractors must consider
            the safety of everyone who might be affected by their work, not just their own
            employees.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Employee Duties - Sections 7 and 8">
          ...
          <p>
            <strong>Section 7 - Employee Duties</strong>
          </p>
          ...
          <p>
            <strong>Section 8 - Duty Not to Interfere</strong>
          </p>
          <p className="text-sm text-white">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>S.7(a) Care for self</strong> — Compliance Example: Using safe isolation
              before work. Breach Example: Working live without justification
            </li>
            <li>
              <strong>S.7(a) Care for others</strong> — Compliance Example: Posting warning signs,
              barriers. Breach Example: Leaving live conductors exposed
            </li>
            <li>
              <strong>S.7(b) Cooperate</strong> — Compliance Example: Attending safety training.
              Breach Example: Ignoring safety instructions
            </li>
            <li>
              <strong>S.8 Not interfere</strong> — Compliance Example: Keeping guards/covers in
              place. Breach Example: Bypassing RCD protection
            </li>
          </ul>
            ...
            whatHappens={
              <>
                <p className="text-sm text-white">
                  ...
                  not proceedings are taken against the employer. Individuals can face personal
        ...
        <ConceptBlock title="HSE Enforcement and Penalties">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Enter premises at any reasonable time (or any time if dangerous)</li>
            ...
            <li>Seize and render harmless any article causing imminent danger</li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Breach of Sections 2-6</strong> — Magistrates' Court: Unlimited fine. Crown
              Court: Unlimited fine
            </li>
            <li>
              <strong>Breach of Section 7 (employees)</strong> — Magistrates' Court: Unlimited fine.
              Crown Court: Unlimited fine
            </li>
            <li>
              <strong>Breach of Improvement Notice</strong> — Magistrates' Court: Unlimited fine.
              Crown Court: Unlimited fine and/or 2 years prison
            </li>
            <li>
              <strong>Breach of Prohibition Notice</strong> — Magistrates' Court: Unlimited fine
              and/or 6 months prison. Crown Court: Unlimited fine and/or 2 years prison
            </li>
          </ul>
          ...
          <p className="text-sm text-white italic">
            <strong>Note:</strong> Corporate Manslaughter and Corporate Homicide Act 2007 creates a
            separate offence with unlimited fines for organisations whose gross breach causes death.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Services Applications">
          <p>
            <strong>Section 2 - Safe Systems of Work</strong>
          </p>
          <p className="text-sm text-white mb-3">For electrical work, safe systems include:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Safe isolation procedure:</strong> Switch off, isolate, secure, prove dead,
              post warnings
            </li>
            <li>
              <strong>Permits to work:</strong> High voltage work, energised work when unavoidable
            </li>
            <li>
              <strong>Risk assessments:</strong> Task-specific assessments for non-routine work
            </li>
            <li>
              <strong>Method statements:</strong> Step-by-step procedures for complex installations
            </li>
          </ul>

          <p>
            <strong>Section 2(2)(c) - Information, Instruction, Training</strong>
          </p>
          <p className="text-sm text-white mb-3">
          ...
          <p>
            <strong>Section 3 - Occupied Premises</strong>
          </p>
          <p className="text-sm text-white mb-3">When working in occupied buildings, consider:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Coordination:</strong> Inform building manager/FM of work schedule and risks
            </li>
            <li>
        ...
        <ConceptBlock title="Practical Guidance">
          <div>
            <p>
              <strong>Key Sections to Remember</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
          ...
          <div>
            <p>
              <strong>SFARP Assessment</strong>
            </p>
            <p className="text-sm text-white mb-2">
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>If sacrifice is grossly disproportionate to risk, measure may not be required</li>
              <li>Burden of proof is on the duty holder to show impracticability</li>
            </ul>
          </div>

          <div>
            <p>
              <strong>Common Building Services Breaches</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>Inadequate isolation procedures (working live unnecessarily)</li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              director. It is the legal basis for refusing an unsafe instruction and for raising a
              written safety concern through your firm&rsquo;s safety management system.
            </>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              pushes to energise the main switchboard a week early so HVAC commissioning can start,
              even though the panel build is incomplete and the certifying engineer has not signed
              off.
            </>
          }
          whatToDo={
            <>
              ...
              isolation, lock-off and a permit-to-work for the limited commissioning scope. Record
              the decision in the site safety log.
            </>
          }
          whyItMatters={
            <>
