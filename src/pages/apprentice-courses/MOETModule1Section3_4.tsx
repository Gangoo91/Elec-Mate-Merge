        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>RAMS:</strong> Risk Assessment Method Statement — the combined safety plan
              </li>
              <li className="pl-1">
                <strong>Structure:</strong> Step-by-step with hazards and controls per step
              </li>
              <li className="pl-1">
                <strong>Briefing:</strong> Walk through before work; sign-off confirms understanding
              </li>
              <li className="pl-1">
                <strong>Review:</strong> Update when conditions change, not just once and file
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>CDM 2015:</strong> Method statements form part of the construction phase
                plan
              </li>
              <li className="pl-1">
                <strong>Isolation:</strong> Each step of the safe isolation procedure should be a
                separate step
              </li>
              <li className="pl-1">
                <strong>Testing:</strong> Commissioning and testing steps need their own hazard
                analysis
              </li>
              <li className="pl-1">
                <strong>ST1426:</strong> Contribute to RAMS preparation and follow them on site
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                RAMS — The Combined Approach
              </p>
              <p className="text-sm text-white mb-3">
                In practice, the risk assessment and method statement are often prepared together as
                a combined document known as a RAMS (Risk Assessment Method Statement). This ensures
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Construction work under CDM 2015:</strong> The construction phase plan
                  must include or reference method statements for all significant work activities
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Client or principal contractor requirements:</strong> Many clients and
                  main contractors require RAMS for all work on their sites
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 space-y-4">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    Tools and equipment (including test equipment, voltage indicators)
                  </li>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30">
                <h3 className="text-sm font-medium text-elec-yellow mb-2">
                  Step-by-Step Work Procedure — The Core of the Document
                </h3>
                <p className="text-sm text-white mb-2">
                  This is the most important section. Each step should be presented in a table
                  format:
                </p>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    Electric shock emergency procedure (disconnect, CPR, call 999)
                  </li>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                Example Method Statement — DB Changeover (Abridged)
              </h3>
              <div className="overflow-x-auto">
                <table className="text-xs text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-2 py-1.5">
                        Check cable avoidance before drilling; hearing protection; torque
                        connections to manufacturer spec
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-2 py-1.5">
                        Match labelling to circuit schedule; torque all connections; visual
                        inspection before energising
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-2 py-1.5">
                        Insulation resistance, continuity and polarity tests before energising;
                        record results on schedule of test results
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-2 py-1.5">
                        ...
                        worn during switching; confirm all outgoing MCBs off before main
                        energisation
                      </td>
                    </tr>
                    <tr>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                The construction phase plan (CPP) is the overarching document that sets out how
                health and safety will be managed during the construction phase. It must be prepared
                before construction work begins (Regulation 12). The CPP includes or references:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">A description of the project and the management structure</li>
                <li className="pl-1">
                  Site rules and arrangements for welfare, first aid and emergency procedures
                </li>
                <li className="pl-1">
              ...
              <p className="text-sm text-white mt-3">
                As an electrical maintenance technician working on a construction project, your
                method statements will form part of the principal contractor's construction phase
                plan. You must submit them in advance, usually as part of your RAMS package, and
                they must be accepted before work begins.
              </p>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                CDM 2015 applies to all "construction work", which is defined broadly and includes
                installation, repair, maintenance and dismantling of electrical systems. However,
                the regulations apply proportionately — a simple like-for-like replacement of a
                socket outlet does not require the same level of documentation as a major rewire.
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Timing:</strong> Before work begins — ideally on the same day, so
                  conditions are current
                </li>
                <li className="pl-1">
                  <strong>Content:</strong> Walk through each step of the method statement,
                  explaining the activity, hazards and controls. Point out physical features on site
                  that relate to the method statement
                </li>
                <li className="pl-1">
                  <strong>Interaction:</strong> Encourage questions and concerns. Workers at the
                  point of work often identify issues that the person writing the method statement
                  has missed
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                One of the most common failures in method statement management is the "sign and go"
                approach — where workers are handed a document, asked to sign it, and sent to work
                without any meaningful briefing or discussion. This creates a paper trail without
                providing any real safety benefit. If you are ever asked to sign a method statement
                without being properly briefed, ask for a briefing. Your signature should confirm
                that you have been briefed and understood the content — not merely that you have
                seen the document.
              </p>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When to Update the Method Statement
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Conditions on site differ from those described in the method statement
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  The planned work method proves impractical and needs to be changed
                </li>
                <li className="pl-1">
                  Personnel change — a new team member needs to be briefed, or a change in
                  competence levels
                </li>
                <li className="pl-1">An incident or near-miss occurs during the work</li>
                <li className="pl-1">
                  The work scope changes — additional tasks or changed sequence
                </li>
                <li className="pl-1">Equipment or materials are different from what was planned</li>
              </ul>
              <p className="text-sm text-white mt-3">
                Updates should be documented — mark the original method statement as revised, note
                the changes, re-brief the team, and obtain fresh signatures on the sign-off sheet
