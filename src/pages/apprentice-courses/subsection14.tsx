...
const DESCRIPTION =
  'Learn about PPE types, standards, and best practices for electrical work safety compliance.';
  ...
  const quickCheckQuestions = [
    {
      ...
      correctIndex: 1,
      explanation:
        'PPE is the last line of defense in the hierarchy of control, used when other safety measures cannot completely eliminate risks.',
    },
    {
      id: 2,
      question: 'Which PPE item is essential for all electrical work?',
      options: ['Hard hat', 'Safety gloves', 'Safety boots', 'High-visibility vest'],
      correctIndex: 2,
      explanation:
        'Safety boots with electrical insulation are essential for all electrical work to protect against electric shock through the feet.',
    },
  ];
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'PPE stands for Personal Protective Equipment - clothing or gear designed to protect you from injury or exposure to hazards on site.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'Insulated gloves, safety glasses, and flame-resistant clothing are all essential PPE for electrical work to protect against various hazards.',
    },
    {
      id: 3,
      ...
      correctAnswer: 2,
      explanation:
        "Flame-resistant clothing protects against arc flash burns by using materials that won't melt onto the skin during an electrical arc event.",
    },
    {
      id: 4,
      ...
      correctAnswer: 1,
      explanation:
        'Under UK law, the employer is responsible for providing PPE free of charge to workers.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        "False. PPE should never replace good safety practices - it's the last line of defence when other safety measures aren't enough.",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'PPE should be inspected before each use for visible damage, wear, or contamination. Additionally, formal periodic inspections should be carried out according to manufacturer guidelines and workplace procedures.',
    },
    {
      question: 'Who is responsible for providing PPE?',
      answer:
        'Employers are legally required to provide suitable PPE free of charge when risks cannot be adequately controlled by other means. This includes initial provision, replacement when worn out, and maintenance.',
    },
    {
      question: 'Can I use my own PPE instead of company-provided equipment?',
      answer:
        'You can only use personal PPE if it meets the same standards as company-provided equipment and has been approved by your employer. All PPE must be suitable for the specific risks and work environment.',
    },
    {
      question: 'What should I do if my PPE is damaged?',
      answer:
        'Stop work immediately if the damage affects protection, report the damage to your supervisor, and obtain replacement PPE before continuing. Damaged PPE must be taken out of service and properly disposed of.',
    },
    {
      question: 'Is training required for PPE use?',
      answer:
        'Yes, employers must provide information, instruction, and training on proper PPE selection, use, maintenance, and storage. Workers must understand how to inspect PPE and recognise when replacement is needed.',
    },
  ];
    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-foreground">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Last Line:</strong> PPE is the final defense when other controls fail.
                </li>
                <li>
                  <strong>Standards:</strong> Must meet BS EN standards for electrical protection.
                </li>
                <li>
                  <strong>Essential:</strong> Safety boots, gloves, and eye protection are key
                  items.
                </li>
                <li>
                  <strong>Inspection:</strong> Check before each use for damage or wear.
                </li>
                <li>
                  <strong>Training:</strong> Proper use and maintenance training is mandatory.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Live work, arc flash risks, overhead lines, confined
                  spaces.
                </li>
                <li>
                  <strong>Use:</strong> Risk assessments, method statements, job briefings.
                </li>
                <li>
                  <strong>Apply:</strong> Right PPE for right risk, proper fit, regular inspection.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-elec-yellow/5 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <p className="text-blue-800 dark:text-white font-medium">
                ...
                individuals to protect against safety and health risks. In electrical work, PPE
                serves as the last line of defence when other safety measures cannot completely
                eliminate risks.
              </p>
            </div>

            <p className="text-white/80">
              PPE should never be the first choice for risk control. According to the hierarchy of
              control, you should first try to eliminate, substitute, or engineer out the hazard.
              PPE is used when these primary methods cannot adequately reduce the risk to an
              acceptable level.
            </p>
            ...
            <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
              ...
              <p className="text-amber-700 dark:text-amber-300 text-sm">
                PPE should be considered only after elimination, substitution, engineering controls,
                and administrative controls have been assessed and implemented where reasonably
                practicable.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="grid md:grid-cols-1 gap-4">
              ...
              <div className="bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
                ...
                <p className="text-sm text-purple-700 dark:text-elec-yellow mb-2">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-orange-50 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
                <p className="text-orange-800 dark:text-orange-200 text-sm mb-2">
                  Arc flash protection is categorised by energy levels measured in calories per
                  square centimetre (cal/cm²):
                </p>
                <ul className="text-orange-700 dark:text-elec-yellow text-xs space-y-1">
                  <li>
                    • <strong>Category 1:</strong> 4 cal/cm² - Minimum for electrical work
                  </li>
                  <li>
                    • <strong>Category 2:</strong> 8 cal/cm² - Standard for most electrical
                    installations
                  </li>
                  <li>
                    • <strong>Category 3:</strong> 25 cal/cm² - High-energy systems
                  </li>
                  <li>
                    • <strong>Category 4:</strong> 40 cal/cm² - Maximum protection available
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-lg p-4">
                ...
                <p className="text-red-700 dark:text-elec-yellow text-sm">
        ...
        <div className="mb-8 border-l-4 border-elec-yellow p-6 bg-card rounded-lg">
          ...
          <div className="space-y-4">
            <p className="text-white/80">
              <strong>Scenario:</strong> An electrician was called to fault-find on a commercial
              lighting circuit. The circuit kept tripping the RCD, and the client was pressuring for
              a quick fix as it was affecting their business.
            </p>

            <p className="text-white/80">
              <strong>The Problem:</strong> The electrician wore his regular work gloves instead of
              Class 0 insulating gloves, thinking the circuit was isolated. When testing revealed
              the circuit was still live, he received a shock through his non-insulating gloves.
            </p>

            <p className="text-white/80">
              <strong>The Learning:</strong> Always assume circuits are live until proven otherwise.
              The right PPE (insulating gloves) would have prevented this incident. PPE standards
              exist for a reason - they are the minimum requirement, not the maximum.
            </p>

            <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg p-3">
              <p className="text-amber-800 dark:text-amber-200 text-sm">
                <strong>Key Takeaway:</strong> Never compromise on PPE standards due to time
                pressure or assumptions about circuit state. Proper PPE inspection and selection
                takes minutes but can prevent life-changing injuries.
              </p>
            </div>
          </div>
        </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <ul className="space-y-2 text-foreground">
            ...
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Essential PPE includes safety boots, gloves, eye protection, and hard hats
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
