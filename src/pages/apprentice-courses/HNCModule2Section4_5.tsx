...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Lining the room walls with sound-absorbing material',
      'Fitting hearing protection for occupants downstream',
      'Selecting a fan operating at its best efficiency point',
      'Increasing the fan speed to push air through faster',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Noise generated by turbulence at dampers and bends',
      'Sound that escapes from open ends of the ductwork',
      'Noise caused by the fan vibrating against its mounts',
  ...
  },
  {
    ...
    options: [
      ...
      'Equal additional reduction for every metre of extra height',
      'No further reduction once line of sight is first broken',
      'A reduction that increases sharply with each added metre',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Lower overall weight for the same sound reduction',
      'Higher sound reduction at most frequencies',
      'No coincidence dip at any frequency',
      'Better performance only at low frequencies',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Reflecting sound back towards the source by impedance mismatch',
      'Cancelling the noise with an anti-phase loudspeaker signal',
      'Converting sound energy to heat in porous material',
      'Adding mass to the duct walls to block transmission',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A frequency where mass law gives maximum sound reduction',
      'The point where two partitions of equal mass perform identically',
      'A low frequency where the cavity resonates between two leaves',
  ...
  },
  {
    ...
    options: [
      'To add mass to the enclosure panels for better insulation',
      'To prevent build-up of reverberant sound inside',
      'To provide vibration isolation between equipment and enclosure',
      'To allow ventilation air to pass without attenuation',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Noise that radiates through the duct walls into rooms',
      'Noise reflected back to the fan by a reactive silencer',
      'Noise re-emitted by absorptive lining after it warms up',
    ],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Approved Document E sets the legal floor for sound insulation between dwellings and
              rooms for residential purposes — directly relevant when building services plant
              adjoins residential walls or floors. The HNC engineer evidences compliance via
              partition mass-law calculations and pre-completion sound testing where required.
            </>
          }
        ...
        >
          <p>
            Source control is the most effective and cost-efficient approach to noise management. By
            selecting quieter equipment and ensuring optimal operating conditions, noise problems
            can often be eliminated before they arise.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Compressors:</strong> Scroll vs reciprocating type, variable speed operation
            </li>
            <li>
        ...
        >
          ...
          <p>
            <strong>The Mass Law:</strong> R ≈ 20 log₁₀(f × m) - 48 dB. R = sound reduction index, f
            = frequency (Hz), m = surface mass (kg/m²). Doubling mass or frequency increases R by
            approximately 6 dB.
          </p>
          <p>
        ...
        >
          <p>
            Silencers (attenuators) reduce noise travelling through ductwork and pipework. They are
            essential for preventing plant noise from reaching occupied spaces through the
            ventilation system.
          </p>
          <p>
          ...
          <p>
            <strong>
              Typical Silencer Attenuation (Rectangular, 900mm) — Insertion Loss (dB):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>125 Hz: 8 dB</li>
          ...
          <p>Values are indicative — always use manufacturer's data for specific products.</p>
          <p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Rubber pads:</strong> Light equipment, low isolation, natural frequency 15-30
              Hz
            </li>
            <li>
            ...
            <li>
              <strong>Steel springs:</strong> AHUs, chillers, large pumps, natural frequency 3-8 Hz
            </li>
            <li>
          ...
          <p>
            <strong>Critical point:</strong> A single rigid connection (unbypassed pipe, taut cable)
            can completely short-circuit vibration isolation. All connections must be flexible.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            discharge. The target at the nearest grille is 40 dB(A). Natural duct attenuation is 12
            dB. What silencer insertion loss is required?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Example 3: Vibration Isolation.</strong> A pump runs at 1450 rpm. What isolator
            natural frequency is needed for 90% isolation?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 6,000 l/s mixed-air AHU is located in a roof-level plant room directly above a
              12-person meeting room with a CIBSE NR 30 design target. The fan produces 78 dB(A)
              inlet SWL, peaking at 250 Hz. The supply ductwork is rectangular 800 × 400 mm, 12 m
              run before the first diffuser.
            </>
          }
          whatToDo={
            <>
              Calculate untreated breakout: free-field, plenum, diffuser. Compare against NR 30 (≈
              35 dB(A)). Specify a 1.2 m absorptive splitter silencer sized for ≥ 18 dB(A) insertion
              loss at 250 Hz, and a lined plenum for the final 3 m. Verify pressure drop is within
              fan curve allowance. Add a 10 mm acoustic lining to the duct break-in length.
              Coordinate with structural engineer for AVM mounts at ≥ 98% isolation efficiency at
              the fan&rsquo;s shaft speed.
            </>
          }
          whyItMatters={
            <>
              A meeting room over-target by 5 dB(A) is unusable for video conferences and is a
              defect liability item. Retrofitting splitter silencers in a finished ceiling void is
              brutally disruptive and expensive — the design-stage attenuator schedule is the
              cheapest acoustic protection the project will ever buy.
            </>
          }
        />
