  ...
  const quizQuestions = [
    {
      ...
      options: [
        'A low-resistance path that lets excessive current flow',
        'When a conductor is broken or disconnected, preventing current flow',
        'A direct connection between line and earth at a terminal',
        'Insulation breakdown allowing leakage between conductors',
      ],
      correctAnswer: 1,
      explanation:
    ...
    },
    {
      ...
      options: [
        ...
        'Cables grouped too closely together',
        'An undersized protective device',
        'Excessive supply voltage at the origin',
      ],
      correctAnswer: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'The circuit will draw a much higher running current',
        'The line and neutral conductors will overheat',
        'The protective conductor will not function when needed',
        'The supply voltage at the load will rise above 230 V',
      ],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: [
        ...
        'Insulation testing only checks the line conductor, never the CPC',
        'A broken CPC actually improves insulation resistance readings',
        'The test voltage is too low to find any fault at all',
      ],
      correctAnswer: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Increase the size of the protective device',
        'Apply more insulation tape around the joint',
        'Repair or replace the damaged conductor and retest',
        'Leave the circuit isolated and report it only',
      ],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: [
        ...
        'The wrong cable size was used for the circuit',
        'The socket was wired with reversed polarity',
        'The ring final circuit was left as a radial',
      ],
      correctAnswer: 0,
      explanation:
