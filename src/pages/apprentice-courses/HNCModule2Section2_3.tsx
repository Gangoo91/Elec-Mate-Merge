...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Pressure only', 'Pipe diameter', 'Temperature', 'Flow rate'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['6.3 m/s', '4.5 m/s', '10 m/s', '20 m/s'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Thermometer', 'Pitot-static tube', 'Flow switch', 'Pressure gauge'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['5 m/s', '50 m/s', '25 m/s', '10 m/s'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Metres', 'kg/m³', 'Pascals', 'Watts'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Energy conservation for flowing fluids — pressure, velocity, and elevation in balance.
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Bernoulli is the legal-quality basis for every differential-pressure flow measurement
              in building services. Heat-meter installations on LTHW and CHW circuits, regulated
              under the Heat Network (Metering and Billing) Regulations 2014, rely directly on this
              physics.
            </>
          }
        ...
        >
          ...
          <p>
            ...
            flow), Dynamic (½ρv², the kinetic energy per unit volume), Total or stagnation (static +
            dynamic, what a pitot tube reads when flow is brought to rest).
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Sudden expansions decelerate flow (some pressure recovery, plus loss to turbulence)
            </li>
            <li>
              Pump suctions: high local velocity can drop pressure below vapour pressure →
              cavitation
            </li>
          </ul>
          <p>
        ...
        >
          <p>
            <strong>Venturi meter:</strong> Gradual converging and diverging sections. Pressure drop
            at the throat relates to velocity via Bernoulli. Permanent loss only ~10% — the meter
            recovers most of the pressure downstream.
          </p>
          <p>
            <strong>Orifice plate:</strong> A simple flat plate with a hole. Cheap and easy, but the
            abrupt restriction loses 60-70% permanently. Common for steam and gas measurement.
          </p>
          <p>
            <strong>Pitot tube / pitot-static tube:</strong> Faces upstream so flow stagnates at the
            tip → measures total (stagnation) pressure. Combined with a static-pressure tap (or a
            coaxial static port on a pitot-static tube), the difference gives dynamic pressure: v =
            √(2 × ΔP / ρ). Standard for measuring duct air velocity.
          </p>
          <p>
        ...
        >
          ...
          <p>
            <strong>Why this matters:</strong> Pump selection means matching Hpump to the required
            system head — which equals friction loss + elevation change + any destination pressure
            requirement.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Example 1 - venturi velocity:</strong> Pressure drop across a venturi throat is
            20 kPa. Approach velocity negligible. Throat velocity?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>ΔP = ½ρv² → v = √(2ΔP/ρ)</li>
            <li>
              v = √(2 × 20,000 / 1000) = √40 = <strong>6.32 m/s</strong>
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              v = √(2 × 90 / 1.2) = √150 = <strong>12.2 m/s</strong>
            </li>
            <li>Typical for a supply air duct</li>
          </ul>
          <p>
            <strong>Example 3 - jet rising from a nozzle:</strong> A water jet rises 5m vertically
            from a nozzle. Exit velocity? (g = 10 m/s²)
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Energy conservation: ½v² = gh → v = √(2gh)</li>
            <li>
              v = √(2 × 10 × 5) = √100 = <strong>10 m/s</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Confusing static and total pressure</strong> — A pitot reads total, a flush
                gauge reads static
              </li>
              <li>
                <strong>Applying across pumps</strong> — Use extended form when energy is added or
                removed
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A high-rise building has a 10 m³ cold-water break tank fed via a 50 mm DN feed off the
              incoming main. The pressure at the main is 4 bar. The fill requirement is 1 L/s (3.6
              m³/h). Distance from main to tank inlet is 12 m with negligible elevation rise.
            </>
          }
          whatToDo={
            <>
              Apply Bernoulli with friction. Available head = 40 m at the main. Static head loss = 0
              (level). Friction loss along 12 m of 50 mm pipe at 1 L/s ≈ 0.5 m. Velocity head at
              tank inlet (v = Q/A ≈ 0.5 m/s) ≈ 0.013 m. Required pressure at tank inlet ≈ 0.5 m.
              Available - required = 39 m surplus, well above what the float-operated valve needs.
              Sized correctly. If the surplus were &lt; 5 m you would consider a booster set or
              larger feed pipe.
            </>
          }
          whyItMatters={
            <>
              Bernoulli + continuity applied as a five-line calculation gives a defendable answer to
              &ldquo;will it fill fast enough?&rdquo; — and protects the building from low-pressure
              incidents on the cold-water service.
            </>
          }
        />
