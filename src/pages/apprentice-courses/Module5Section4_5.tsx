      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            <div className="space-y-3">
              <h4 className="font-medium text-foreground">Coordination Planning Skills</h4>
            ...
            <div className="space-y-3">
              <h4 className="font-medium text-foreground">Problem Prevention Skills</h4>
              <ul className="space-y-2 text-muted-foreground text-sm">
                <li className="flex items-start">
                  <span className="text-emerald-400 mr-2 font-bold">•</span>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="space-y-3">
              <h4 className="font-medium text-foreground">System Implementation</h4>
              <ul className="space-y-2 text-muted-foreground text-sm">
                <li className="flex items-start">
                  <span className="text-emerald-400 mr-2 font-bold">•</span>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="border-l-4 border-emerald-500 pl-6 space-y-4">
                <div className="flex items-start gap-4">
                  <div className="flex items-center justify-center w-10 h-10 rounded-full bg-emerald-500 text-white text-lg font-bold flex-shrink-0">
                    1
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-medium text-emerald-400 mb-3">Why Coordination Matters</h3>
                    ...
                    <div className="mt-4 p-4 rounded-lg border border-green-500/30 bg-card">
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground mb-4">2. Common Problems from Poor Coordination</h3>
              ...
              <div className="border-l-4 border-green-500 pl-6 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <h4 className="font-medium text-foreground mb-3">Key issues:</h4>
                    <ul className="space-y-2 text-muted-foreground">
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground mb-4">3. Coordinating Equipment Effectively</h3>
              <p className="text-muted-foreground mb-6">
              ...
              <div className="border-l-4 border-purple-500 pl-6 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-medium text-emerald-400 mb-3">Effective Coordination Process</h3>
                    <h4 className="font-medium text-foreground mb-3">Key steps:</h4>
                    <ul className="space-y-2 text-muted-foreground">
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground mb-4">4. Communication and Teamwork</h3>
              <p className="text-muted-foreground mb-6">
              ...
              <div className="border-l-4 border-orange-500 pl-6 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-medium text-emerald-400 mb-3">Communication Process</h3>
                    <h4 className="font-medium text-foreground mb-3">Key actions:</h4>
                    <ul className="space-y-2 text-muted-foreground">
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground mb-4">5. Risks of Poor Coordination</h3>
              <p className="text-muted-foreground mb-6">
              ...
              <div className="border-l-4 border-red-500 pl-6 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-medium text-emerald-400 mb-3">Risk Assessment</h3>
                    <h4 className="font-medium text-foreground mb-3">Key risks:</h4>
                    <ul className="space-y-2 text-muted-foreground">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-6">Quick Knowledge Check</h2>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-foreground">Pocket Guide – Coordinating Equipment</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-4">
