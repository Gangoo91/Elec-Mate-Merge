    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Integrate sustainable design principles throughout the building services engineering
          process
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers how sustainable design principles are integrated into building
          services engineering from concept through to operation. You'll learn about passive design,
          fabric first approach, whole life carbon assessment and how to deliver truly sustainable
