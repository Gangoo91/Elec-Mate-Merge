    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-base text-muted-foreground mb-12">
          This section covers motor control systems used in HVAC applications. You'll learn about
          motor fundamentals, starting methods, variable speed drives, motor protection and the
          energy efficiency benefits of modern motor control in building services.
        </p>
