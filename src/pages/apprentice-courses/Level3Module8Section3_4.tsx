...
const DESCRIPTION =
  'Master stress management techniques for electrical exams. Learn to control exam anxiety, maintain focus under pressure, and perform at your best when it matters most.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The 4-7-8 technique involves breathing in for 4 seconds, holding for 7 seconds, and exhaling for 8 seconds. This activates the parasympathetic nervous system, reducing heart rate and promoting calm. It can be used discreetly during exams.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      "Sleep is essential for memory consolidation - the process of transferring information from short-term to long-term memory. Sleep deprivation also impairs concentration, decision-making, and recall. One good night's sleep is more valuable than an all-night study session.",
  },
  {
    id: 'check-3',
    ...
    correctIndex: 2,
    explanation:
      "Cognitive reframing involves changing your interpretation of a situation. Instead of 'This exam will ruin my career', reframe to 'This exam is one step in my journey - I can retake if needed'. This reduces the perceived threat and associated stress.",
  },
  {
    id: 'check-4',
    ...
    correctIndex: 2,
    explanation:
      'Pause and breathe before anything else. Taking 30-60 seconds to calm your physiological response prevents panic from escalating. Grounding (feeling your feet on floor, chair beneath you) returns focus to the present. Then continue - a brief pause costs less than a panic spiral.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "The fight or flight response releases stress hormones that redirect blood from the brain to muscles, impairing memory recall and complex thinking. While helpful for physical danger, it's counterproductive for exams. Learning to manage it improves performance.",
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'Stick to your normal caffeine routine. Sudden increase causes jitteriness and increased anxiety. Sudden reduction can cause withdrawal headaches and fatigue. Your body performs best when conditions are familiar.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Exercise releases endorphins (natural mood boosters) and reduces cortisol (stress hormone). Even a 20-minute walk can significantly reduce anxiety. Regular exercise during revision improves sleep, mood, and cognitive function.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      "Catastrophising is imagining worst-case scenarios (failing exam = ruined career = life over). This amplifies stress beyond what's warranted. Counter it by asking: 'What's actually likely to happen?' and 'What would I do if the worst happened?'",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      "Preparation is the most effective stress reducer. Knowing you've covered the material thoroughly builds genuine confidence. Much exam anxiety comes from uncertainty about content - systematic preparation addresses this directly.",
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      "The night before should focus on rest, not cramming. Light revision of key points, an early dinner (easy to digest), relaxing activity, and 7-8 hours sleep. New learning attempted this late won't consolidate and cramming increases anxiety.",
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Grounding techniques bring attention to the present moment: feel feet on floor, hands on desk, notice five things you can see. This interrupts spiralling thoughts and restores focus. Use when feeling overwhelmed or losing focus during exams.',
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      "Negative self-talk ('I'm going to fail', 'I'm not smart enough') creates anxiety that impairs performance, potentially becoming a self-fulfilling prophecy. Replace with realistic positive statements: 'I've prepared well', 'I'll do my best'.",
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'The Yerkes-Dodson law shows performance follows an inverted-U curve: moderate stress/arousal optimises performance, but too little (boredom) or too much (anxiety) impairs it. Goal is finding your optimal arousal level, not eliminating stress entirely.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Visualising successful performance (calm arrival, confident answering, positive completion) activates similar brain pathways as actual experience. This builds familiarity and confidence, reducing fear of the unknown. Athletes use this extensively.',
  },
  {
    id: 11,
    ...
    correctAnswer: 2,
    explanation:
      "Stop what you're doing and breathe slowly and deeply for 30-60 seconds. Use grounding (feel chair, floor, notice surroundings). Then return to an easier question to rebuild confidence. This brief pause prevents a full panic spiral and is worth the time investment.",
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      'Arriving 20-30 minutes early allows time to find the room, use the bathroom, settle nerves, and enter the exam calmly. Rushing increases cortisol levels and starts the exam in a stressed state. Being early shows self-care and preparation.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Blanking is usually caused by high anxiety triggering the fight-or-flight response. Practice relaxation techniques during revision so they're automatic. In the exam, if you blank, stop, breathe slowly for 30 seconds, then start with the easiest question you can find. Movement helps too - shift in your seat, stretch fingers.",
  },
  {
    question: 'Is some stress actually helpful for exams?',
    answer:
      "Yes - moderate stress (sometimes called 'eustress') improves alertness and performance. The goal isn't zero stress but optimal stress. Too little and you may be complacent; too much and performance drops. View some nervousness as your body preparing to perform.",
  },
  {
    question: 'How do I stop negative thoughts before an exam?',
    answer:
      "Notice when negative thoughts occur and actively challenge them. Ask: 'Is this thought true? Is it helpful?' Replace with realistic alternatives: 'I've prepared as well as I can' rather than 'I'm definitely going to fail'. This takes practice but becomes easier.",
  },
  {
    question: "What if I didn't prepare enough and feel panicked?",
    answer:
      'Accept the situation - you cannot change the past. Focus on maximising performance with what you know. Read questions carefully, eliminate wrong answers, and attempt every question. Post-exam, reflect on preparation strategies for next time.',
  },
  {
    question: 'Should I talk to others about exam stress?',
    answer:
      "Sharing concerns can help, but avoid 'stress contagion' from very anxious peers. Talk to supportive people who help you feel calmer. If stress is severe or persistent, professional support (counsellor, GP) is available and nothing to be ashamed of.",
  },
  {
    question: 'Can I take medication for exam anxiety?',
    answer:
      'Some people use beta-blockers or anti-anxiety medication prescribed by a GP. However, medication is not a substitute for preparation and coping strategies. Any medication should be trialled before exam day to understand its effects on you. Always consult a healthcare professional.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Some stress is good:</strong> Moderate arousal improves performance
              </li>
              <li>
                <strong>Breathe:</strong> 4-7-8 technique activates calm
              </li>
              <li>
                <strong>Prepare:</strong> Best anxiety reducer is thorough preparation
              </li>
              <li>
                <strong>Sleep:</strong> Essential for memory and clear thinking
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Racing heart, shallow breathing, negative thoughts
              </li>
              <li>
                <strong>Use:</strong> Deep breathing to restore calm
              </li>
              <li>
                <strong>Apply:</strong> Grounding when feeling overwhelmed
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Exam stress is a normal response to a challenging situation. Your body's 'fight or
              flight' system evolved to help you survive physical threats, but it can be triggered
              by psychological challenges like exams. Understanding this response helps you manage
              it effectively.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key Insight:</strong> Some stress is beneficial - it's your body's way of
              preparing to perform. The goal is not zero stress, but optimal stress. Learn to
              interpret nervous feelings as readiness, not weakness.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Relaxation techniques work by activating your parasympathetic nervous system - the
              'rest and digest' response that counteracts 'fight or flight'. With practice, these
              techniques become automatic tools you can deploy whenever stress rises.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Much exam anxiety comes from unhelpful thought patterns rather than the exam itself.
              Catastrophising, negative self-talk, and perfectionism amplify stress beyond what's
              warranted. Cognitive techniques help you think more realistically and helpfully.
            </p>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-elec-yellow/20 my-6">
              ...
              <ol className="text-xs text-white/90 space-y-1">
                ...
                <li>
                  2. <strong>Question</strong> it ("Is this definitely true? What's the evidence?")
                </li>
                <li>
                  3. <strong>Challenge</strong> it ("What would I tell a friend thinking this?")
                </li>
                <li>
                  4. <strong>Replace</strong> with a realistic alternative ("I've prepared well.
            ...
            <p className="text-sm text-elec-yellow/70 mt-4">
              <strong>Reality Check:</strong> Even if you did fail, what would actually happen? You
              could retake. Your career wouldn't be over. Most people won't even know. Examining
              worst-case scenarios often reveals they're not as catastrophic as anxiety suggests.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              How you manage the exam day itself significantly affects performance. A calm, prepared
              approach sets you up for success. These strategies cover before, during, and (if
              needed) recovering from moments of anxiety.
            </p>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-white/10 my-6">
              ...
              <ol className="text-xs text-white/90 space-y-2">
                ...
                <li>
                  <strong>2. BREATHE</strong> - 30-60 seconds of slow, deep breathing (4-7-8 if
                  you've practised it).
                </li>
                <li>
                  <strong>3. GROUND</strong> - Feel feet on floor, hands on desk. Notice 5 things
                  you can see.
                </li>
                <li>
                  <strong>4. RESTART EASY</strong> - Return to an easier question to rebuild
                  confidence.
                </li>
                <li>
                  <strong>5. PROCEED</strong> - Continue systematically. Brief pause was worth it.
                </li>
              </ol>
            </div>
        ...
        <section className="mb-10">
          <div className="p-5 rounded-lg bg-transparent border border-elec-yellow/20">
            <h3 className="text-sm font-medium text-white mb-4">
              Quick Reference - Stress Management
            </h3>
