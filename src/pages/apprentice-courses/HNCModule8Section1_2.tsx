...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['35-45degC', '75-80degC', '20-25degC', '55-65degC'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['5.0-6.0', '1.5-2.0', '7.0-8.0', '2.5-3.5'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['20-30 litres', '50-100 litres', '200+ litres', '10 litres'],
    correctAnswer: 1,
    explanation:
...
const HNCModule8Section1_2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 1 · Subsection 2"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Heat Pump Principles - ASHP and GSHP">
          <p>
            ...
            vapour compression refrigerant cycle, the same principle as refrigerators but in reverse
            - moving heat into the building rather than out of it.
          </p>
          <p>
            <strong>Air Source Heat Pumps (ASHP)</strong>
          </p>
          ...
          <p>
            <strong>Ground Source Heat Pumps (GSHP)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>The Refrigerant Cycle</strong>
          </p>
          <p>1. Evaporator (Outdoor)</p>
          <p>Low-pressure liquid refrigerant absorbs heat from air/ground, becoming a gas</p>
          <p>2. Compressor</p>
          <p>
            Compresses the gas, raising its temperature significantly (this is where electricity is
            used)
          </p>
          ...
          <p>
            <strong>COP and SCOP Calculations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>COP:</strong> Heat Output (kW) / Electrical Input (kW) — Instantaneous
              efficiency at test conditions
            </li>
            <li>
              <strong>SCOP:</strong> Total Heat (kWh) / Total Electricity (kWh) — Seasonal average
              including all operating modes
            </li>
            <li>
              <strong>SPF:</strong> Measured annual heat / annual electricity — Actual field
              performance (varies by installation)
            </li>
          </ul>
          <p>
            <strong>Example: COP Calculation</strong>
          </p>
          <p>
        ...
        <ConceptBlock title="System Integration and Buffer Vessels">
          <p>
            ...
            operating characteristics with building heat demand. Unlike boilers that can modulate
            quickly, heat pumps prefer steady-state operation and are sensitive to short cycling and
            rapid load changes.
          </p>
          <p>
            <strong>Buffer Vessel Functions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Prevent short cycling:</strong> Provides thermal mass for minimum compressor
              run times (typically 6+ minutes)
            </li>
            <li>
              <strong>Defrost support:</strong> Supplies heat during defrost cycles when heat pump
              reverses
            </li>
            <li>
              <strong>Zone balancing:</strong> Accommodates flow variations when TRVs or zone valves
              close
            </li>
            <li>
              <strong>Hydraulic separation:</strong> Decouples heat pump flow from heating circuit
              flow rates
            </li>
            <li>
          ...
          <p>
            <strong>Buffer Vessel Sizing Guidelines</strong>
          </p>
          ...
          <p>
            <strong>Buffer Vessel Configuration Options</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2-pipe buffer:</strong> Standard residential — Simple, cost-effective, good
              for single-zone
            </li>
            <li>
              <strong>4-pipe buffer:</strong> Multi-zone systems — Better stratification, separates
              HP and heating circuits
            </li>
            <li>
              <strong>Low-loss header:</strong> Variable flow systems — Minimal storage, hydraulic
              separation only
            </li>
            <li>
              <strong>No buffer:</strong> Wide-modulating inverter HP — Only if HP can modulate
              &gt;5:1 and single large zone
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Primary circuit:</strong> Heat pump to buffer - constant flow, pump sized for
              HP requirements
            </li>
            <li>
              <strong>Secondary circuit:</strong> Buffer to emitters - variable flow based on demand
            </li>
            <li>
              <strong>Blending valve:</strong> May be required to achieve specific flow temperatures
            </li>
            <li>
              <strong>Expansion vessel:</strong> Sized for total system volume including buffer
            </li>
            <li>
              <strong>Pressure relief:</strong> Set according to system pressure rating (typically 3
              bar)
            </li>
          </ul>
          <p>
            <strong>Critical Design Points</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Never bypass the buffer vessel - this leads to short cycling and compressor damage
            </li>
          ...
          <p>
            <strong>MCS requirement:</strong> The MCS Heat Pump Standard (MIS 3005) specifies buffer
            vessel sizing methodology. Non-compliance can affect warranty and grant eligibility.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Low Temperature Heating and Flow Temperatures">
          <p>
            ...
            requires careful consideration of heat emitter selection and building fabric
            performance.
          </p>
          <p>
            <strong>Why Low Flow Temperatures Matter</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reduced temperature lift:</strong> Smaller difference between source and sink
              = higher COP
            </li>
            <li>
              <strong>COP improvement:</strong> Each 1degC reduction in flow temperature increases
              COP by approximately 2-3%
            </li>
            <li>
              <strong>Part L compliance:</strong> Low-temperature operation essential for meeting
              SCOP requirements
            </li>
            <li>
          ...
          <p>
            <strong>Heat Emitter Options for Low Temperature Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Underfloor heating (UFH):</strong> 30-40degC — Excellent - ideal partner for
              heat pumps
            </li>
            <li>
              <strong>Fan convectors:</strong> 35-45degC — Very good - forced air improves output
            </li>
            <li>
              <strong>Oversized radiators (2-2.5x):</strong> 40-50degC — Good - requires larger
              radiators
            </li>
            <li>
              <strong>Standard radiators:</strong> 55-70degC — Poor - significantly reduces COP
            </li>
          </ul>
          <p>
            <strong>Radiator Output at Different Flow Temperatures</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Weather Compensation Control</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Steeper curves:</strong> For poorly insulated buildings or undersized emitters
            </li>
            <li>
              <strong>Shallower curves:</strong> For well-insulated buildings with UFH
            </li>
            <li>
              <strong>Parallel shift:</strong> Adjusts overall level while maintaining curve slope
            </li>
          </ul>
          <p>
            <strong>Typical Weather Compensation Settings</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>15degC:</strong> 25degC — 30degC
            </li>
            <li>
              <strong>7degC:</strong> 32degC — 40degC
            </li>
            <li>
              <strong>0degC:</strong> 38degC — 48degC
            </li>
            <li>
              <strong>-5degC:</strong> 42degC — 55degC
            </li>
          </ul>
          <p>
            <strong>Defrost Cycle Management</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>When required:</strong> Typically -7degC to +7degC outdoor with high humidity
            </li>
            <li>
            ...
            <li>
              <strong>Heat source:</strong> Uses building heat (via buffer vessel) during defrost
            </li>
            <li>
          ...
          <p>
            ...
            outdoor temperature (-3degC typical for UK). This ensures efficient operation across the
            heating season.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Hybrid Systems, Electrical Requirements and Part L Compliance">
          ...
          <p>
            <strong>Hybrid System Operation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Bivalent point:</strong> Outdoor temperature at which boiler supplements heat
              pump
            </li>
            <li>
            ...
            <li>
              <strong>Cost optimisation:</strong> Controllers can switch based on electricity/gas
              price
            </li>
            <li>
          ...
          <p>
            <strong>Hybrid System Control Strategies</strong>
          </p>
          <p>
            <strong>Temperature-Based</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>&lt;8kW heat output:</strong> Single-phase 20A — 20A Type C MCB or RCBO
            </li>
            <li>
              <strong>8-12kW heat output:</strong> Single-phase 32A — 32A Type C MCB or RCBO
            </li>
            <li>
              <strong>12-16kW heat output:</strong> Single-phase 40A or 3-phase — 40A Type C or TP
              16A per phase
            </li>
            <li>
              <strong>&gt;16kW heat output:</strong> Three-phase supply — TP&N sized to manufacturer
              spec
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Cable sizing:</strong> As per BS 7671 Table 4D1A/B/C - consider route length
              and grouping
            </li>
            <li>
              <strong>External isolator:</strong> Rotary isolator required adjacent to outdoor unit
              (within 3m)
            </li>
            <li>
            ...
            <li>
              <strong>Controls wiring:</strong> Low voltage connections to cylinder, room stats, BMS
            </li>
          </ul>
          <p>
            <strong>DNO Notification Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Part L Compliance Requirements (England 2021)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Design methodology:</strong> MCS Heat Pump Calculator or equivalent required
            </li>
            <li>
            ...
            <li>
              <strong>Commissioning:</strong> Evidence of proper balancing and performance testing
            </li>
          </ul>
          <p>
            <strong>MCS Certification Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>MIS 3005:</strong> Heat pump installation standard - mandatory for BUS grants
            </li>
            <li>
            ...
            <li>
              <strong>Performance estimate:</strong> Annual heat demand, electricity consumption,
              running costs
            </li>
            <li>
          ...
          <p>
            ...
            installers qualify for the Boiler Upgrade Scheme. Ensure all documentation is completed
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A 10kW ASHP has a COP of 3.5 at 2degC outdoor/40degC flow.
            Compare running cost with a 90% efficient gas boiler. Electricity = 28p/kWh, Gas =
            8p/kWh.
          </p>
          ...
          <p>
            <strong>Question:</strong> Size a buffer vessel for a 12kW ASHP with 6-minute minimum
            run time and 5K temperature differential.
          </p>
          ...
          <p>
            ...
            varies with outdoor temperature. Electricity 30p/kWh, Gas 10p/kWh, Boiler 90% efficient.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Oversized heat pump:</strong> Leads to short cycling and reduced efficiency
              </li>
              <li>
              ...
              <li>
                <strong>Incorrect refrigerant charge:</strong> Affects performance (F-gas work only)
              </li>
            </ul>
          }
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Boiler systems</div>
          </button>
          <button
