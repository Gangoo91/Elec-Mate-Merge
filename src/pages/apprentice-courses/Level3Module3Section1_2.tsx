      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            The fundamental building blocks of electrical measurement
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Define the five main electrical quantities and their units",
              "Understand how electrical units relate to each other",
              "Convert fluently between SI prefixes",
              "Distinguish between energy and power",
              "Recognise quantity symbols on equipment and drawings",
              "Apply units correctly in calculations"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module3-section1-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous: Ohm's Law
            </Link>
          </Button>
