...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['GBP 3,025,000', 'GBP 3,057,600', 'GBP 3,150,000', 'GBP 2,775,000'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['10-15%', '50-60%', '25-40%', '70-80%'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['GBP 320,000', 'GBP 400,000', 'GBP 200,000', 'GBP 332,800'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Your budget structures both the tender price and the basis of interim payment. Cost
              plans aligned to the bills of quantities and the WBS support straightforward
              valuation; mismatched structures lead to disputed interim certificates and cash-flow
              problems. Build the budget in the same shape as you will measure work.
            </>
          }
        ...
        <ConceptBlock title="Cost Plan Structure and Development">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Stage 3:</strong> Cost Plan 2 - developed elemental budget with specification
            </li>
            <li>
          ...
          <p>
            <strong>
              Typical Cost Plan Structure for MEP Works (Element — Description — Typical %):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Contingency and Risk Allowances">
          ...
          <p>
            <strong>
              Contingency Reduction by Stage (Stage — Design — Construction Risk — Total):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Preliminaries and Site Costs">
          <p>
            Preliminaries are the indirect costs required to deliver the MEP installation, distinct
            from the measured works costs of materials and labour. Understanding preliminaries
            structure is essential for accurate budget development and tender assessment.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Site Management:</strong> Project manager, site supervisor, QS — Time-related
            </li>
            <li>
          ...
          <p>
            <strong>Budgeting tip:</strong> Longer projects have proportionally higher preliminaries
            due to time-related costs. A 24-month project will not have double the preliminaries of
            a 12-month project, but the time-related element will double.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Overhead, Profit and Inflation Allowances">
          <p>
            ...
            budget, accounting for contractor margins and anticipated price movements. Understanding
            these allowances is essential for realistic budget setting and tender evaluation.
          </p>
          <p>
          ...
          <p>
            <strong>Inflation Calculation Example:</strong> Estimate base date January 2024; tender
            July 2024 (6 months); construction period 18 months; mid-point 9 months from start.
            Total inflation period: 6 + 9 = 15 months. Forecast annual inflation 4%. 15-month
            inflation: 4% × (15/12) = 5.0%. Applied to measured works + preliminaries before OH&P.
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Total contingency: GBP 216,000 (18%)</strong> — Higher than new-build due to
              existing conditions uncertainty.
            </li>
          </ul>
          <p>
            <strong>Example 3 — Preliminaries Build-Up:</strong> Build up preliminaries for GBP 4M
            MEP package, 15-month programme, city centre site.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              You won a £4m MEP package on a fixed-price basis in 2024 for handover in late 2026.
              Your tender used 2024 supplier prices with 3% inflation built in. By mid-2025, copper
              has risen 18%, electrical components 12%, and labour rates 9% under the JIB wage
              settlement. Your forecast cost-to-complete now exceeds the budget by £180k.
            </>
          }
          whatToDo={
            <>
              Treat inflation as a quantified risk on long programmes — index forward to programme
              mid-point using BCIS or commodity-specific indices, not a flat 3%. For the current
              project, pursue value engineering options aggressively, accelerate procurement of
              unfixed materials at current prices where storage allows, and review supplier
              contracts for inflation-linked clauses. Update the cost report transparently with
              client and finance — surprises at month 18 are unacceptable.
            </>
          }
          whyItMatters={
            <>
              Budget integrity protects the project margin. Hidden assumptions (3% inflation, no
              extension, no scope creep) become hidden losses. Build budgets that survive contact
              with reality, not budgets that flatter the bid.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Cost control</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
