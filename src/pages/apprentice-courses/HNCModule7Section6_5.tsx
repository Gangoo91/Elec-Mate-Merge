...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['0.5 MΩ', '10 MΩ', '2.0 MΩ', '1.0 MΩ'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1000V DC', '250V DC', '500V DC', '230V AC'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['0.4 seconds', '0.2 seconds', '0.1 seconds', '5 seconds'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 6,
    question:
      'What is the maximum trip time for a general (non-delay) 30mA RCD tested at its rated residual operating current (1 × IΔn = 30mA) under BS 7671:2018+A4:2026?',
...
const HNCModule7Section6_5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 6 · Subsection 5"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Pre-Commissioning Checks">
          <p>
            Pre-commissioning checks form the essential first stage of verification, conducted
            before any electrical testing begins. This systematic visual inspection identifies
            installation defects, ensures completeness, and confirms the installation is ready for
            safe testing.
          </p>
          <p>
            <strong>Pre-Commissioning Checklist Items:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Connection integrity:</strong> All terminations tight, cables correctly
              identified
            </li>
            <li>
              <strong>Cable installation:</strong> Correct support, bend radii, segregation
              maintained
            </li>
            <li>
              <strong>Enclosure security:</strong> All covers fitted, IP ratings maintained,
              knockouts sealed
            </li>
            <li>
              <strong>Earthing system:</strong> All earth connections made, bonding conductors
              installed
            </li>
            <li>
              <strong>Labelling:</strong> Circuit identification, warning notices, safety signs in
              place
            </li>
          </ul>
          <p>
            <strong>Visual Inspection Requirements per BS 7671 Regulation 643.1</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Conductor selection:</strong> CSA for current and voltage drop — Undersized
              cables, incorrect type
            </li>
            <li>
              <strong>Connection of conductors:</strong> Correct method, accessibility — Loose
              terminals, inaccessible joints
            </li>
            <li>
              <strong>Protective devices:</strong> Type and rating correct — Wrong MCB type,
              oversized fuses
            </li>
            <li>
              <strong>Basic protection:</strong> Insulation, barriers, enclosures — Exposed live
              parts, damaged insulation
            </li>
            <li>
              <strong>Presence of diagrams:</strong> Wiring diagrams at DB, circuit charts — Missing
              or incomplete documentation
            </li>
          </ul>
          <p>
            <strong>Critical requirement:</strong> Visual inspection must be completed and any
            defects rectified before proceeding to electrical testing. Never test an installation
        ...
        <ConceptBlock title="Initial Verification - Dead Tests">
          <p>
            Dead tests are performed with the supply isolated and the installation de-energised.
            These tests verify the fundamental safety of the installation before any live testing or
          ...
          <p>
            <strong>Polarity Verification</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Insulation Resistance Test Requirements per BS 7671</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Up to and including 500V (except SELV/PELV):</strong> 500V — &gt;1.0 MΩ
            </li>
            <li>
              <strong>Above 500V up to 1000V:</strong> 1000V — &gt;1.0 MΩ
            </li>
          </ul>
          <p>
            <strong>Ring Final Circuit Continuity Test Procedure</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Step 1:</strong> Measure end-to-end resistance of L conductors (r1)
            </li>
            <li>
              <strong>Step 2:</strong> Measure end-to-end resistance of N conductors (rn)
            </li>
            <li>
              <strong>Step 3:</strong> Measure end-to-end resistance of CPC (r2)
            </li>
            <li>
              <strong>Step 4:</strong> Cross-connect L1 to L2 and N1 to N2, test each socket (should
              equal r1/4 + rn/4)
            </li>
            <li>
              <strong>Step 5:</strong> Cross-connect L1 to CPC2, test L-CPC at each socket to obtain
              R1+R2
            </li>
            <li>
              <strong>Result:</strong> All readings should be consistent; significant deviation
              indicates spurs or faults
            </li>
          </ul>
          <p>
            <strong>Test instrument requirement:</strong> All test equipment must be calibrated and
            comply with GS38 for electrical test equipment used by electricians.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Live Testing and RCD Verification">
          ...
          <p>
            <strong>Earth Fault Loop Impedance (Zs) Testing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Measurement:</strong> Use earth loop impedance tester at furthest point of
              circuit
            </li>
            <li>
              <strong>Temperature correction:</strong> Measured value must not exceed 80% of maximum
              tabulated value
            </li>
          </ul>
          <p>
            <strong>Maximum Earth Fault Loop Impedance Values (BS 7671 Table 41.3)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>6A:</strong> 7.28 — 3.64 — 1.82
            </li>
            <li>
              <strong>16A:</strong> 2.73 — 1.37 — 0.68
            </li>
            <li>
              <strong>32A:</strong> 1.37 — 0.68 — 0.34
            </li>
            <li>
              <strong>63A:</strong> 0.69 — 0.35 — 0.17
            </li>
          </ul>
          <p>
            Values from BS 7671:2018+A4:2026 Table 41.3 (Cmin = 0.95 applied). Apply 0.8 multiplier
            to account for conductor temperature rise during fault conditions.
          </p>
          <p>
            <strong>RCD Testing Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>No-trip test:</strong> 50% IΔn (15mA for 30mA RCD) — N/A — Must NOT trip
            </li>
            <li>
              <strong>Full test (AC):</strong> 100% IΔn (30mA) — 300ms — Must trip ≤300ms
            </li>
            <li>
          ...
          <p>
            <strong>Safety note:</strong> RCD testing causes earth leakage that will trip the
            device. Ensure connected equipment can tolerate sudden disconnection and reset all RCDs
            after testing.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Functional Testing and Handover Documentation">
          <p>
            Functional testing verifies that all systems operate as intended after successful
            completion of safety verification tests. This includes testing controls, interlocks, and
            operational sequences, followed by comprehensive documentation and formal handover.
          </p>
          <p>
            <strong>Functional Testing Requirements</strong>
          </p>
          <p>
            <strong>Lighting Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Certification Documentation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electrical Installation Certificate (EIC):</strong> New installations, new
              circuits — Schedule of Inspections, Schedule of Test Results
            </li>
            <li>
              <strong>Minor Works Certificate:</strong> Additions/alterations without new circuits —
              Test results on certificate form
            </li>
            <li>
              <strong>Electrical Installation Condition Report (EICR):</strong> Periodic inspection
              of existing installation — Condition report, observations, schedules
            </li>
          </ul>
          <p>
            <strong>EICR Classification Codes</strong>
          </p>
          <p>
            <strong>C1 - Danger present:</strong> Risk of injury exists. Immediate remedial action
            required.
          </p>
          <p>
          ...
          <p>
            <strong>C3 - Improvement recommended:</strong> Not compliant with current standards but
            no immediate danger.
          </p>
          <p>
            <strong>FI - Further investigation:</strong> Cannot determine condition without further
            investigation.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EIC/Minor Works/EICR:</strong> Completed and signed by competent person
            </li>
            <li>
              <strong>Schedule of Test Results:</strong> All circuits with measured values
            </li>
            <li>
              <strong>As-built drawings:</strong> Final installation layout, distribution schematics
            </li>
            <li>
              <strong>O&amp;M manual:</strong> Manufacturers' literature, maintenance schedules
            </li>
            <li>
              <strong>Part P notification:</strong> Building Control notification where applicable
            </li>
            <li>
              <strong>Warranties:</strong> Equipment guarantees and installer warranties
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> A 32A Type B MCB protects a ring final circuit. Ze measured
            at origin = 0.35Ω. Verify the circuit is compliant.
          </p>
          ...
          <p>
            Note: BS 7671:2018+A4:2026 (Reg 643.3) verifies at IΔn only — the older 5×IΔn shot and
            Appendix 3 Table 3A have been deleted.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              RCD trip time at IΔn (BS 7671:2018+A4:2026 Reg 643.3, single AC test):{' '}
              <strong>≤300ms</strong>
            </li>
            <li>
            ...
            <li>
              Temperature correction factor: <strong>0.8</strong> (multiply max Zs)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Testing before visual inspection</strong> - Always inspect first, test
                second
              </li>
              <li>
                <strong>Energising with failed IR</strong> - Never energise circuits below 1.0 MΩ
              </li>
              <li>
                <strong>Forgetting temperature correction</strong> - Apply 0.8 factor to tabulated
                Zs values
              </li>
              <li>
                <strong>Incomplete documentation</strong> - All test results must be recorded
              </li>
            </ul>
          }
