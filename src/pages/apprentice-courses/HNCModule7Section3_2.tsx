...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['104,167 lumens', '83,333 lumens', '96,154 lumens', '120,000 lumens'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['480 lux', '384 lux', '432 lux', '288 lux'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['320 lux', '500 lux', '480 lux', '400 lux'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.9, 0.7, 0.3', '0.3, 0.2, 0.1', '0.7, 0.5, 0.2', '0.5, 0.3, 0.1'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="The Lumen Method Formula">
          ...
          <p>
            <strong>Lumen Method Formula</strong>
          </p>
          <p>E = (n × F × UF × MF) / A</p>
          ...
          <p>= Room area (m²)</p>
          <p>
            <strong>Rearranged Forms of the Formula</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Illuminance (E):</strong> E = (n × F × UF × MF) / A — Verify existing
              installation
            </li>
            <li>
              <strong>Number of luminaires (n):</strong> n = (E × A) / (F × UF × MF) — New lighting
              design
            </li>
            <li>
              <strong>Total flux required:</strong> Φ = (E × A) / (UF × MF) — Luminaire selection
            </li>
          </ul>
          <p>
            <strong>Key assumptions of the lumen method:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Uniform distribution:</strong> Luminaires are evenly spaced across the ceiling
            </li>
            <li>
            ...
            <li>
              <strong>Average illuminance:</strong> Calculates mean value, not minimum or maximum
            </li>
            <li>
        ...
        <ConceptBlock title="Room Index Calculation">
          <p>
            The room index (K) is a dimensionless number that describes room proportions relative to
            the luminaire mounting height. It determines how effectively light from luminaires
            reaches the working plane.
          </p>
          <p>
            <strong>Room Index Formula</strong>
          </p>
          <p>K = (L × W) / [Hm × (L + W)]</p>
          ...
          <p>
            <strong>Mounting Height (Hm)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Typical K Values</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Room Index Example Calculations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Small office:</strong> 6 × 4 — 2.0 — 24 / (2.0 × 10) — 1.2
            </li>
            <li>
              <strong>Open plan:</strong> 20 × 15 — 2.4 — 300 / (2.4 × 35) — 3.57
            </li>
            <li>
              <strong>Classroom:</strong> 10 × 8 — 2.15 — 80 / (2.15 × 18) — 2.07
            </li>
            <li>
              <strong>Warehouse:</strong> 40 × 25 — 6.0 — 1000 / (6.0 × 65) — 2.56
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Utilisation Factors">
          ...
          <p>
            <strong>Factors Affecting Utilisation Factor</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Example UF Table (Typical Recessed LED Panel)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>0.75:</strong> 0.41 — 0.37 — 0.33
            </li>
            <li>
              <strong>1.00:</strong> 0.48 — 0.44 — 0.39
            </li>
            <li>
              <strong>1.25:</strong> 0.53 — 0.49 — 0.44
            </li>
            <li>
              <strong>1.50:</strong> 0.57 — 0.53 — 0.47
            </li>
            <li>
              <strong>2.00:</strong> 0.63 — 0.58 — 0.52
            </li>
            <li>
              <strong>2.50:</strong> 0.67 — 0.62 — 0.56
            </li>
            <li>
              <strong>3.00:</strong> 0.70 — 0.65 — 0.58
            </li>
          </ul>
          <p>Values are illustrative. Always use manufacturer's actual photometric data.</p>
          <p>
            <strong>Linear Interpolation for UF</strong>
          </p>
          <p>When K falls between tabulated values, interpolate linearly:</p>
          <p>UF = UF₁ + [(K - K₁) / (K₂ - K₁)] × (UF₂ - UF₁)</p>
          <p>
            Example: For K = 1.75 between K = 1.5 (UF = 0.57) and K = 2.0 (UF = 0.63): <br /> UF =
            0.57 + [(1.75 - 1.5) / (2.0 - 1.5)] × (0.63 - 0.57) = 0.57 + 0.5 × 0.06 = 0.60
          </p>
          <p>
            <strong>Practical tip:</strong> Dark walls and ceilings significantly reduce UF. In
            industrial spaces with dark surfaces, UF may be 30-40% lower than in offices with light
            finishes.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Maintenance Factors">
          <p>
            ...
            lamp depreciation, luminaire soiling, and room surface degradation. It ensures the
            maintained illuminance meets requirements at the end of the maintenance cycle.
          </p>
          <p>
            <strong>Maintenance Factor Components</strong>
          </p>
          ...
          <p>
            <strong>Typical Component Values</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>LLMF (LED at 50,000h):</strong> 0.90 — 0.90 — 0.90
            </li>
            <li>
              <strong>LMF (3-year cycle):</strong> 0.95 — 0.90 — 0.80
            </li>
            <li>
              <strong>RSMF (3-year cycle):</strong> 0.98 — 0.95 — 0.90
            </li>
            <li>
              <strong>Combined MF:</strong> 0.84 — 0.77 — 0.65
            </li>
          </ul>
          <p>
            <strong>Environment Categories</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Maintenance Cycle Impact</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Initial vs Maintained Illuminance</strong>
          </p>
          <p>
            <strong>Initial illuminance</strong> = E / MF (what you get when luminaires are new){' '}
            <br /> <strong>Maintained illuminance</strong> = E (what you get at end of maintenance
            period) <br /> <br /> Example: If design requires 500 lux maintained and MF = 0.8:{' '}
            <br /> Initial illuminance = 500 / 0.8 = 625 lux
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Brief:</strong> Design general lighting for an office 15m × 12m with 3m ceiling
            height and 0.85m working plane. Required illuminance: 500 lux maintained. Using LED
            panels rated at 4,000 lumens each.
          </p>
          ...
          <p>
            <strong>Brief:</strong> A classroom 10m × 8m has 18 luminaires installed, each rated at
            3,600 lumens. Ceiling height 3m, working plane 0.85m. Surface reflectances: ceiling 0.7,
            walls 0.5, floor 0.2. Verify maintained illuminance with MF = 0.75.
          </p>
          ...
          <p>
            <strong>Brief:</strong> Calculate luminaires for a workshop 30m × 20m with 6m ceiling
            height (floor-level working plane). Required: 300 lux. High-bay LED luminaires rated at
            20,000 lumens. Environment: normal industrial.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Wrong mounting height:</strong> Using ceiling height instead of Hm (ceiling
                to working plane)
              </li>
              <li>
                <strong>Ignoring reflectances:</strong> Using standard UF without considering actual
                surface colours
              </li>
              <li>
              ...
              <li>
                <strong>Forgetting to verify:</strong> Not recalculating illuminance with the actual
