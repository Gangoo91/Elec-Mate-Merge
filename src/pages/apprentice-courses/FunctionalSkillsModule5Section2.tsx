        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              prepare for the higher expectations and complexity of questions.
            </p>
            <p>
              Achieving Level 2 is a requirement for completing your electrical apprenticeship
              End-Point Assessment (EPA). It is also recognised by employers as equivalent to GCSE
              grade 4, opening doors to further training, supervisory roles, and career progression
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Multi-step problems:</strong> Questions require two
                  or more calculations or reasoning steps to reach an answer
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Independent problem-solving:</strong> You must
                  decide which mathematical operations to use without being guided through steps
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Complex contexts:</strong> Problems are set in more
                  realistic and detailed real-world scenarios
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Higher accuracy in English:</strong> More
                  sophisticated vocabulary, varied sentence structures, and stronger argument
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Multiple sources:</strong> You may need to
                  interpret information from two or more documents and compare them
                </span>
              </li>
            </ul>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Maths:</strong> Ratio and proportion, scale
                  drawings, compound measures, percentage increase/decrease, probability, more
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">English:</strong> Persuasive writing, report
                  writing, comparing texts, evaluating arguments, inference and deduction
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Digital:</strong> More complex spreadsheet
                  formulae, data presentation, combining information from multiple sources
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
              ...
              <div className="space-y-3">
                <div className="bg-white/5 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 text-xs text-white">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Fractions, decimals, and percentages without calculator support</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Estimation and approximation skills</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Simple ratio calculations and unit conversions</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 text-xs text-white">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Complex area, perimeter, and volume calculations</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Interpreting data from tables, charts, and graphs</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Percentage change, ratio, proportion, and scale</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Probability and mean, median, mode, and range</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Ratio and Proportion:</strong> Dividing quantities
                  in given ratios, scaling recipes and mixtures, understanding direct proportion
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Scale Drawings:</strong> Reading and interpreting
                  scale drawings (e.g., 1:50 means 1 cm = 50 cm real life). Essential for reading
                  architectural plans.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Compound Measures:</strong> Speed = distance/time,
                  density = mass/volume, and rearranging these formulae
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Percentage Change:</strong> Calculating percentage
                  increase and decrease, including VAT calculations at 20%
                </span>
              </li>
            </ul>
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <div className="bg-white/5 rounded-lg p-3 mt-2">
                ...
                <p className="text-xs text-white">
                  ...
                  <br />
                  Sand = 30 divided by 5 x 4 = <strong className="text-white">24 kg</strong>
                  <br />
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <div className="bg-white/5 rounded-lg p-3 mt-2">
                ...
                <p className="text-xs text-white">
                  ...
                  <br />
                  Step 3: Labour + VAT = £135 + £27 = £162
                  <br />
                  Step 4: Total = £162 + £120 materials ={' '}
                  <strong className="text-white">£282.00</strong>
                </p>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <div className="bg-white/5 rounded-lg p-3 mt-2">
                ...
                <p className="text-xs text-white">
                  ...
                  <br />
                  Step 3: Round up (cannot buy part-tiles) = 24 m²
                  <br />
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <div className="bg-white/5 rounded-lg p-3 mt-2">
                ...
                <p className="text-xs text-white">
                  ...
                  <strong className="text-white">48 mph</strong>
                </p>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                your approach saves time and reduces errors.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              well-structured writing with accurate spelling, punctuation, and grammar.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-xs text-white">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Duration:</strong> Approximately 1 hour
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Texts:</strong> Longer passages (500-800 words),
                    may include multiple documents to compare
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Skills tested:</strong> Inference, deduction,
                    comparing viewpoints, evaluating arguments, understanding bias and persuasion
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Question types:</strong> Extended responses
                    requiring explanation and evidence from the text
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-xs text-white">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Tasks:</strong> Formal letters, reports,
                    articles, persuasive writing, or discursive essays
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Length:</strong> Typically 250-350 words, with
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Marking:</strong> Content and ideas (30-40%),
                    Organisation (20-25%), Language use (20-25%), SPaG (15-20%)
                  </span>
                </li>
              </ul>
            </div>
            ...
            <p>
              Inference means reading between the lines — understanding what the writer implies
              without stating it directly. This is a critical Level 2 skill that distinguishes it
              from Level 1.
            </p>
            ...
            <p>
              For persuasive and discursive writing at Level 2, use the PEEL structure for each body
              paragraph:
            </p>
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <div className="bg-white/5 rounded-lg p-3 text-xs text-white italic mb-2">
                ...
                <p className="mb-2">
                  "The electrical industry is facing a skills shortage that could last a decade.
                  With an ageing workforce and insufficient apprenticeship starts, the sector needs
                  to attract more young people. Investment in training and competitive wages are
                  essential to secure the future of the trade."
                </p>
                <p className="mb-1 font-semibold not-italic text-green-400">
                  Source B — Industry Body Report
                </p>
                <p>
                  "Recent data shows that apprenticeship completions have risen by 8% this year,
                  suggesting the skills gap may be narrowing. However, critics argue that the
                  quality of training varies significantly between providers, and completion rates
                  alone do not indicate workplace readiness."
                </p>
              </div>
              ...
              <div className="bg-white/5 rounded-lg p-3 mt-2">
                ...
                <ul className="space-y-1 text-xs text-white">
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Title:</strong> Health and Safety Report —
                      [Specific Issue]
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Introduction:</strong> The purpose of this
                      report is to bring to your attention a safety concern I observed on [date] at
                      [location]...
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Findings:</strong> During my work on [area], I
                      noticed that [describe the issue in detail]. This poses a risk because
                      [explain the danger]...
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Recommendations:</strong> I recommend the
                      following actions: (1) Immediately [short-term fix], (2) Arrange for
                      [longer-term solution], (3) Brief all site operatives on [relevant safety
                      measure]...
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Conclusion:</strong> I trust this report will
                      be given prompt attention. I am happy to discuss further if needed.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 rounded-lg p-3 mt-2">
                ...
                <ul className="space-y-1 text-xs text-white">
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Rhetorical question:</strong> "Why would you
                      saddle yourself with university debt when you could earn while you learn?"
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Statistics:</strong> "Qualified electricians
                      earn an average of £35,000-£45,000 per year, with many self-employed
                      electricians earning significantly more."
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Rule of three:</strong> "An electrical
                      apprenticeship offers practical skills, financial independence, and a career
                      for life."
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-white">Counter-argument:</strong> "Some may argue that
                      university offers broader opportunities, but with the growing demand for
                      skilled electricians and the shift towards renewable energy, this trade has
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              to combine information from multiple digital sources.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-xs text-white">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Duration:</strong> Approximately 2 hours 30
                    minutes for practical tasks
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Format:</strong> Scenario-based tasks requiring
                    you to use multiple applications
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Skills tested:</strong> Advanced formatting,
                    complex spreadsheet formulae, data analysis, evaluating information reliability
                  </span>
                </li>
              </ul>
            </div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Spreadsheets:</strong> IF functions, VLOOKUP,
                  conditional formatting, creating charts that communicate data effectively, sorting
                  and filtering data
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Word Processing:</strong> Using styles and
                  headings, creating contents pages, mail merge basics, professional document layout
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Presentations:</strong> Slide design principles,
                  effective use of images and data, appropriate transitions, audience awareness
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Online Safety:</strong> Understanding phishing,
                  secure passwords, data protection principles, evaluating website reliability
                </span>
              </li>
            </ul>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 mt-2">
              ...
              <p className="text-xs text-white">
                ...
                total. Add conditional formatting to highlight any items costing over £100 in red.
                Create a pie chart showing the cost breakdown by category.
              </p>
            </div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              is that you must decide which methods to use — the question will not guide you through
              each step.
            </p>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Step 1 — Read:</strong> Read the entire question
                  twice. Underline key information and the specific question being asked.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Step 2 — Plan:</strong> Before calculating, decide
                  what operations you need and in what order. Write a brief plan.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Step 3 — Calculate:</strong> Work through each step
                  carefully, showing all working.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Step 4 — Check:</strong> Does your answer make
                  sense in context? Is the unit correct? Is the magnitude reasonable?
                </span>
              </li>
            </ul>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
              ...
              <p className="text-sm text-white">
                ...
                £185. Add 10% contingency to the material total, then add 20% VAT to the entire
                quotation. What is the final price?
              </p>
              <div className="bg-white/5 rounded-lg p-3 mt-2">
                <p className="text-xs font-semibold text-green-400 mb-1">Worked Solution</p>
                <p className="text-xs text-white">
                  ...
                  <br />
                  Step 3: Materials = £111.00 + £185.00 (consumer unit) = £296.00
                  <br />
                  Step 4: Contingency = £296.00 x 1.10 = £325.60
                  <br />
                  Step 5: Labour = 16 x £40 = £640.00
                  <br />
                  Step 6: Subtotal = £325.60 + £640.00 = £965.60
                  <br />
                  Step 7: VAT = £965.60 x 0.20 = £193.12
                  <br />
                  Step 8: Total = £965.60 + £193.12 ={' '}
                  <strong className="text-white">£1,158.72</strong>
                </p>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-xs text-white">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Method marks (M):</strong> Awarded for using the
                    correct approach, even if the final answer is wrong
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Accuracy marks (A):</strong> Awarded for reaching
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Follow-through marks:</strong> If you make an
                    error in step 1 but correctly apply it in step 2, you can still earn marks for
                    step 2
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Communication marks:</strong> For showing clear,
                    logical working and giving your answer with correct units
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Final mock exam:</strong> Complete one full timed
                  paper under exam conditions. Mark it and focus your remaining revision on weak
                  areas only.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Confirm logistics:</strong> Check the exam venue
                  address, room number, start time, and what you need to bring. Plan your journey.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Light revision only:</strong> Review flashcards and
                  key formulae. Do not try to learn new topics — this is about consolidation.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Rest properly:</strong> Get good sleep in the days
                  leading up to the exam. Your brain consolidates learning during sleep.
                </span>
              </li>
            </ul>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>Pack everything you need (see checklist below) the evening before</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>Set two alarms to ensure you wake up on time</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>Avoid heavy revision — read through key notes once, then stop</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>Do something relaxing in the evening to help you sleep well</span>
              </li>
            </ul>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  Eat a proper breakfast — your brain needs fuel to concentrate for 90 minutes or
                  more
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>Leave early — aim to arrive 15-20 minutes before the start time</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  Avoid panic conversations with other candidates — other people's anxiety is
                  contagious
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>Use waiting time for calm breathing, not last-minute cramming</span>
              </li>
            </ul>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <ul className="space-y-2 text-xs text-white">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    Scientific calculator with fresh batteries (check it works the night before)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Two black pens (in case one runs out)</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Pencil, eraser, and sharpener (for diagrams and rough work)</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Clear ruler (30 cm preferred)</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Clear water bottle with label removed</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Watch or small clock (phones are not allowed)</span>
                </li>
              </ul>
            </div>
            ...
            <p>
              If you feel anxious during the exam, pause for 30 seconds and take three deep breaths.
              Then read the next question slowly and carefully. Remember: you are prepared, you have
              practised, and you can do this. If a question seems too difficult, skip it and come
              back later — do not let one difficult question derail your entire paper.
            </p>
