...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['1 week', '6 weeks', '4 weeks', '2 weeks'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Defect', 'Early warning matter', 'Termination event', 'Compensation event'],
    correctAnswer: 3,
    explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        title="NEC Contracts"
        backTo="/study-centre/apprentice/h-n-c-module5-section2"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Early warning is mutual — both Contractor and PM have the duty. Failure to give an
              early warning when it would have helped the other party can lead to reduced
              compensation under Clause 63.7. Embed early warning as a weekly meeting agenda item;
              treat the early warning register as the live risk register.
            </>
          }
        ...
        <ConceptBlock title="NEC4 ECC Structure and Main Options">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>B:</strong> Priced - Bill of Quantities — Quantity risk with Employer — Scope
              defined but quantities uncertain
            </li>
            <li>
          ...
          <p>
            <strong>Building Services Example — Option C:</strong> A complex HVAC installation where
            design will develop during construction suits Option C. The target is agreed, but as
            design evolves, the pain/gain share incentivises the contractor to deliver efficiently
            whilst the employer shares some risk.
          </p>
          <p>
            <strong>Selection principle:</strong> Match the option to project risk profile. Greater
            uncertainty warrants more risk sharing (Options C/D/E).
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Early Warning Procedures">
          <p>
            ...
            traditional contracts where parties often conceal problems until claiming, NEC requires
          ...
          <p>
            ...
            <strong>increase the total of the Prices</strong>, <strong>delay Completion</strong>,{' '}
            <strong>delay meeting a Key Date</strong>, or{' '}
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Changes to Scope required:</strong> Modify AHU specification if preferred unit
              unavailable
            </li>
            <li>
          ...
          <p>
            <strong>Failure to Give Early Warning:</strong> If the Contractor fails to give an early
            warning they were aware of, and the matter becomes a compensation event, the event is
            assessed as if they had given early warning. This reduces any additional cost
          ...
          <p>
            ...
            architect's ceiling grid layout conflicts with the containment routes shown in the M&E
            coordination drawings. Rather than waiting for installation and claiming delay, they
            raise an early warning. A risk reduction meeting identifies the clash early, allowing
            the design team to resolve it without site disruption. This is NEC working as intended.
          </p>
          <p>
            <strong>Best practice:</strong> Raise early warnings liberally. It is better to raise an
            early warning that proves unnecessary than to withhold one that was needed.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Compensation Events">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>2.</strong> Contractor notifies compensation event — Within 8 weeks (time bar)
            </li>
            <li>
            ...
            <li>
              <strong>6.</strong> PM accepts, requests revision, or makes own assessment — Within 2
              weeks
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Time element:</strong> Delay to planned Completion shown on Accepted Programme
            </li>
            <li>
          ...
          <p>
            <strong>M&E Example — Access:</strong> The mechanical contractor cannot access the plant
            room on the stated date because builder's work is incomplete. This is CE 60.1(2). The
            quotation includes standing time for the ductwork installation team, re-mobilisation
            costs, and demonstrates critical path delay using the Accepted Programme.
          </p>
          <p>
        ...
        <ConceptBlock title="Programme Management and Secondary Options">
          <p>
            ...
            as the baseline for assessing compensation events, managing float, and demonstrating the
            effect of changes on completion.
          </p>
          <p>
          ...
          <p>
            ...
            Completion Date is Week 52, a CE causing 3 weeks delay moves planned Completion to Week
            51 and Completion Date to Week 55 — the 4-week float is preserved.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Does not comply with contract:</strong> Completion shown after Completion Date
            </li>
            <li>
          ...
          <p>
            <strong>
              Key Secondary Options (X Clauses) — (Clause — Purpose — Building Services Relevance):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            ...
            collaborative mechanisms. On a hospital M&E project, the electrical contractor raises an
            early warning about switchgear lead times. At the risk reduction meeting, the team
            ...
            event quotation reflects the current (mitigated) programme — everyone benefits from the
            proactive approach.
          </p>
          <p>
            <strong>Programme tip:</strong> Update and resubmit the programme regularly. An outdated
            programme makes compensation event assessment extremely difficult and often
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — Option Selection:</strong> A 10-storey office building requires full
            M&E fit-out. Design is 70% complete with some elements still developing. Budget is tight
            but firm.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — Early Warning Response:</strong> Electrical subcontractor identifies
            that cable delivery from overseas will be 4 weeks late due to shipping delays.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Letting programme lapse</strong> — Outdated programme damages CE assessments
              </li>
              <li>
                <strong>Withholding early warnings</strong> — Damages trust and reduces entitlement
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You discover at week 14 that a critical valve manufacturer has gone into
              administration, threatening a 10-week impact on commissioning. You internally consider
              alternatives but do not issue an early warning notice for three weeks while you
              investigate. By the time you notify, the cheaper alternative supplier's lead time has
              expired. You raise a CE for the additional cost and time of the more expensive
              supplier.
            </>
          }
          whatToDo={
            <>
              Under Clause 63.7, the PM is entitled to assess the CE as if early warning had been
              given on day one — meaning the cheaper supplier was still available. The award is
              reduced to the difference between the day-one alternative and the original supplier —
              not the reality of what you actually paid. Issue early warnings reflexively the moment
              any risk emerges. The cost of issuing too many early warnings is zero; the cost of
              missing one is significant.
            </>
          }
          whyItMatters={
            <>
              NEC4 enforces collaborative behaviour through commercial sanctions. Clause 63.7 means
              the contractor that hoards problems gets penalised — the contractor that shares them
              gets fairly compensated. Operating NEC honestly is the cheapest commercial posture.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">JCT contracts</div>
          </button>
          <button
