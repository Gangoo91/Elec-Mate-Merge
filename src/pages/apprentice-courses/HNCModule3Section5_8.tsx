                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Up to 500V (including 400V motors)
                      </td>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Do not energise - investigate immediately
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Monitor trend, investigate if declining
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Bearing-specific frequencies
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Electrical (2× line freq)
                      </td>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Monitor and repair at next maintenance
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Schedule repair as soon as practical
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Repair within days, increase monitoring
                      </td>
                    </tr>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Bearing defects</td>
                      <td className="border border-white/10 px-3 py-2">
                        Bearing frequencies modulated on f
                      </td>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr className="bg-red-500/10">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        All methods, audible noise
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Excessive clearance, heat
                      </td>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Visual inspection, listen for abnormal noise
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Check operating temperature, current draw
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Bearing lubrication (if grease points)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Insulation resistance test, alignment check
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Bearing replacement (based on running hours)
                      </td>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Oil level, temperature, leaks
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Annually</td>
                      <td className="border border-white/10 px-3 py-2">
                        IR test, thermography, clean
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Oil sample, IR test, thermography
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">3 Years</td>
                      <td className="border border-white/10 px-3 py-2">
                        Detailed inspection, torque connections
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Turns ratio test, PD test
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Full oil processing, comprehensive tests
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Smoke extract fans, fire pumps
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Weekly run tests, vibration, IR
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Current, travel time, door cycles
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Battery condition, fuel, load tests
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Temperature, partial discharge, IR
                      </td>
                    </tr>
                  </tbody>
                </table>
