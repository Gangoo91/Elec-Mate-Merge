...
const quickCheckQuestions = [
  {
    ...
    options: ['0.5 MΩ', '5 MΩ', '1 MΩ', '10 MΩ'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Inner race defect', 'Rolling element defect', 'Outer race defect', 'Cage defect'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['80°C', '125°C', '155°C', '105°C'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Quarterly', 'Annually', 'Weekly', 'Monthly'],
    correctAnswer: 0,
    explanation:
...
const HNCModule3Section5_8 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 5 · Subsection 8"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS 7671 134.2.1 + Chapter 65 sets the framework for periodic inspection and testing
              (EICR). Motor and transformer condition forms part of any comprehensive EICR on a
              commercial building &mdash; recording IR, polarisation index, winding temperature
              trend and vibration baseline lets the next EICR engineer compare like-for-like and
              trigger remedials before failure. BS 7671 doesn&rsquo;t prescribe motor maintenance
              interval but it does require competent recording of the test results that drive the
              regime.
            </>
          }
        ...
        <ConceptBlock title="In 30 seconds">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Insulation testing:</strong> Minimum 1 MΩ at 500V DC
            </li>
            <li>
              <strong>Vibration analysis:</strong> Detects mechanical faults early
            </li>
            <li>
              <strong>Thermography:</strong> Identifies hot spots and connections
            </li>
            <li>
              <strong>MCSA:</strong> Detects rotor faults from current spectrum
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Building Services Context</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HVAC motors:</strong> AHUs, chillers, pumps, fans
            </li>
            <li>
              <strong>Critical systems:</strong> Life safety, data centres
            </li>
            <li>
              <strong>PPM schedules:</strong> SFG20 and manufacturer guidance
            </li>
            <li>
              <strong>Condition monitoring:</strong> Predictive maintenance approach
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Insulation Resistance Testing">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>SELV and PELV</strong> — 250V — 0.5 MΩ
            </li>
            <li>
              <strong>Up to 500V (including 400V motors)</strong> — 500V — 1 MΩ
            </li>
            <li>
              <strong>Above 500V</strong> — 1000V — 1 MΩ
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Polarisation Index (PI) Test</p>
          <p>
            The PI test extends IR testing by comparing readings at 1 minute and 10 minutes. This
            ratio indicates the condition of insulation independent of temperature effects.
          </p>
          <p>
            <strong>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>&lt; 1.0</strong> — Dangerous — Do not energise - investigate immediately
            </li>
            <li>
              <strong>1.0 - 1.5</strong> — Poor (contaminated/wet) — Clean and dry, retest
            </li>
            <li>
              <strong>1.5 - 2.0</strong> — Questionable — Monitor trend, investigate if declining
            </li>
            <li>
              <strong>2.0 - 4.0</strong> — Good — Normal maintenance schedule
            </li>
            <li>
              <strong>&gt; 4.0</strong> — Excellent — Continue monitoring
            </li>
          </ul>

          <p className="text-sm font-medium text-white">IR Testing Best Practice:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Disconnect motor from supply and discharge capacitance before testing</li>
            <li>
              Record ambient temperature - IR decreases by approximately 50% for each 10°C rise
            </li>
            <li>Test phase-to-earth and phase-to-phase on three-phase machines</li>
            <li>Discharge windings safely after test (high voltage stored)</li>
            <li>
              Compare results with previous readings - trend is more important than absolute value
            </li>
          </ul>
        ...
        <ConceptBlock title="Winding Resistance Measurement">
          ...
          <p className="text-sm text-white mt-3">
            Temperature correction formula: R<sub>2</sub> = R<sub>1</sub> × (234.5 + T<sub>2</sub>)
            / (234.5 + T<sub>1</sub>) for copper
          </p>
          ...
          <p>
            ...
            digital multimeters lack the precision required - always use a dedicated low-resistance
            ohmmeter with four-wire (Kelvin) connections to eliminate lead resistance errors.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Vibration Analysis">
          <p>
            ...
            machinery. By analysing the frequency spectrum of machine vibration, specific mechanical
            and electrical faults can be identified long before failure occurs.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Common Fault Frequencies</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Mechanical imbalance</strong> — 1× shaft speed — Dominant radial vibration
            </li>
            <li>
              <strong>Misalignment (angular)</strong> — 1× and 2× shaft speed — High axial vibration
            </li>
            <li>
              <strong>Misalignment (parallel)</strong> — 2× shaft speed — Radial at 2× running speed
            </li>
            <li>
              <strong>Looseness</strong> — Harmonics: 1×, 2×, 3×... — Multiple harmonics present
            </li>
            <li>
              <strong>Bearing defects</strong> — BPFO, BPFI, BSF, FTF — Bearing-specific frequencies
            </li>
            <li>
              <strong>Electrical (2× line freq)</strong> — 100Hz (UK) — Rotor bars, eccentricity
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Bearing Defect Frequencies</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Small machines (&lt;15kW)</strong> — &lt;0.71 — 0.71-1.8 — 1.8-4.5 — &gt;4.5
            </li>
            <li>
              <strong>Medium (15-75kW)</strong> — &lt;1.12 — 1.12-2.8 — 2.8-7.1 — &gt;7.1
            </li>
            <li>
              <strong>Large rigid (&gt;75kW)</strong> — &lt;1.8 — 1.8-4.5 — 4.5-11.2 — &gt;11.2
            </li>
          </ul>
        ...
        <ConceptBlock title="Thermographic Inspection">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1-10°C above ambient</strong> — Low — Monitor and repair at next maintenance
            </li>
            <li>
              <strong>10-25°C above ambient</strong> — Medium — Schedule repair as soon as practical
            </li>
            <li>
              <strong>25-40°C above ambient</strong> — High — Repair within days, increase
              monitoring
            </li>
            <li>
              <strong>&gt;40°C above ambient</strong> — Critical — Immediate action required
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Common Findings - Motors</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Common Findings - Distribution</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm font-medium text-white">Thermographic Inspection Best Practice:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Inspect under normal operating load (minimum 40% of rated load)</li>
            <li>Allow equipment to reach thermal equilibrium before inspection</li>
        ...
        <ConceptBlock title="Motor Current Signature Analysis (MCSA)">
          ...
          <p>
            For example, broken rotor bars create sidebands at frequencies: f<sub>brb</sub> = f × (1
            ± 2s) where f is supply frequency and s is slip.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Detectable Faults</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Broken rotor bars</strong> — f × (1 ± 2s) — &gt;-50dB indicates fault
            </li>
            <li>
              <strong>Air gap eccentricity</strong> — f × (1 ± (1-s)/p) — Varies with severity
            </li>
            <li>
              <strong>Bearing defects</strong> — Bearing frequencies modulated on f — Early
              detection possible
            </li>
            <li>
              <strong>Load oscillations</strong> — f ± mechanical frequency — Coupling/alignment
              issues
            </li>
          </ul>
        ...
        <ConceptBlock title="Bearing Failure Diagnosis">
          <p>
            Bearings are the most common failure point in rotating machinery. Understanding failure
            modes and their diagnostic signatures enables proactive maintenance before catastrophic
            failure.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1 - Sub-surface</strong> — Ultrasonic, HF vibration — Microscopic fatigue —
              Months
            </li>
            <li>
              <strong>2 - Surface damage</strong> — Vibration (bearing frequencies) — Spalling,
              pitting — Weeks to months
            </li>
            <li>
              <strong>3 - Advanced damage</strong> — Vibration, temperature, noise — Large spalls,
              wear — Days to weeks
            </li>
            <li>
              <strong>4 - Failure imminent</strong> — All methods, audible noise — Excessive
              clearance, heat — Hours to days
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Common Bearing Failure Causes</p>
        ...
        <ConceptBlock title="Preventive Maintenance Schedules">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Daily/Weekly</strong> — Visual inspection, listen for abnormal noise —
              Operator rounds
            </li>
            <li>
              <strong>Monthly</strong> — Check operating temperature, current draw —
              Instrumentation/BMS
            </li>
            <li>
              <strong>Quarterly</strong> — Vibration analysis, thermography — Condition monitoring
            </li>
            <li>
              <strong>6-Monthly</strong> — Bearing lubrication (if grease points) — Preventive
              maintenance
            </li>
            <li>
              <strong>Annually</strong> — Insulation resistance test, alignment check — Planned
              shutdown
            </li>
            <li>
              <strong>3-5 Years</strong> — Bearing replacement (based on running hours) — Major
              overhaul
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Monthly</strong> — Visual, temperature check — Oil level, temperature, leaks
            </li>
            <li>
              <strong>Annually</strong> — IR test, thermography, clean — Oil sample, IR test,
              thermography
            </li>
            <li>
              <strong>3 Years</strong> — Detailed inspection, torque connections — DGA, winding
              resistance
            </li>
            <li>
              <strong>5+ Years</strong> — Turns ratio test, PD test — Full oil processing,
              comprehensive tests
            </li>
          </ul>
          ...
          <p>
            SFG20 provides comprehensive maintenance schedules for building services equipment. It
            covers mechanical, electrical, and specialist systems with task frequencies based on:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Building Services: Planned Maintenance and Condition Monitoring">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HVAC</strong> — AHU fans, pumps, chillers — Vibration, temperature, current,
              pressure
            </li>
            <li>
              <strong>Life Safety</strong> — Smoke extract fans, fire pumps — Weekly run tests,
              vibration, IR
            </li>
            <li>
              <strong>Lifts</strong> — Motors, drives, door operators — Current, travel time, door
              cycles
            </li>
            <li>
              <strong>Standby Power</strong> — Generators, UPS systems — Battery condition, fuel,
              load tests
            </li>
            <li>
              <strong>Distribution</strong> — Transformers, switchgear — Temperature, partial
              discharge, IR
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Asset register:</strong> Equipment identification, specifications, location
            </li>
            <li>
            ...
            <li>
              <strong>Statutory compliance:</strong> Fixed wiring tests, emergency lighting, fire
              systems
            </li>
            <li>
          ...
          <p>
            ...
            statutory compliance and basic care with CBM for high-value or critical equipment where
            monitoring investment is justified.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Annual thermographic survey shows a motor terminal box with
            Phase A at 85°C, Phase B at 52°C, and Phase C at 48°C. Ambient temperature is 25°C.
          </p>
        ...
        <Scenario
          ...
          situation={
            <>
              A 132 kW chiller compressor motor on a hospital cooling plant shows IR test history:
              Year 1 = 1500 M&Omega;, Year 2 = 850 M&Omega;, Year 3 = 420 M&Omega;, Year 4 = 80
              M&Omega; (still well above the 1 M&Omega; BS 7671 minimum but the trend is clearly
              downward). PI ratio 1.4 (declining from 2.8 at install). Compressor still running but
              the trend is alarming.
            </>
          }
          whatToDo={
            <>
              Treat as imminent failure even though absolute IR is still &gt; minimum. Run a
              tan-&delta; (loss-tangent) test at next outage to quantify insulation deterioration;
              arrange for a swap-out replacement compressor within the next 6 months while the
              existing one still works (controlled changeover beats failure during patient cooling
              load). Document the trend and decision in the building log book; raise the predictive
              maintenance budget to capture similar early-warning trends across the rest of the
              chiller fleet.
            </>
          }
          whyItMatters={
            <>
              Critical-load motor failures cost not just the motor but the consequential downtime
              &mdash; on hospital cooling, that may be patient transfers and CQC reportable
              incidents. Trend-based predictive maintenance (IR + PI + vibration + thermography over
              years) catches degradation while it&rsquo;s still benign. The HNC engineer designs the
              maintenance regime that makes this possible.
            </>
          }
        />
