...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['70-80%', '30-40%', '90% or more', '50-60%'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              GLA Circular Economy Statements are mandatory for London major referable schemes. The
              95% landfill diversion target exceeds typical SWMP performance. End-of-life strategy
              (deconstruction plan, material passport) is increasingly required at planning stage.
              BS 8895 provides the methodology — design for disassembly, modularity, and reuse from
              concept stage.
            </>
          }
        ...
        <ConceptBlock title="Circular Economy Fundamentals">
          <p>
            ...
            can be maintained, upgraded, recovered, and reused rather than demolished and
            landfilled.
          </p>
          <p>
            <strong>Core circular economy principles:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Keep products in use:</strong> Maximise lifespan through maintenance, repair,
              and reuse
            </li>
            <li>
              <strong>Regenerate natural systems:</strong> Return biological materials safely to the
              earth
            </li>
            <li>
              <strong>Preserve embedded value:</strong> Retain the energy and resources invested in
              products
            </li>
          </ul>
          <p>
            <strong>Linear vs Circular Economy Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Resource flow:</strong> Take → Make → Dispose — Reduce → Reuse → Recycle →
              Recover
            </li>
            <li>
              <strong>Design focus:</strong> Minimum initial cost — Whole-life value and recovery
            </li>
            <li>
              <strong>End of life:</strong> Demolition and landfill — Disassembly and reuse
            </li>
            <li>
              <strong>Ownership model:</strong> Purchase and own — Service and lease options
            </li>
            <li>
              <strong>Material value:</strong> Lost at disposal — Recovered and retained
            </li>
          </ul>
          <p>
            <strong>UK Construction Waste Statistics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              • Construction, demolition and excavation waste: approximately 62% of UK total waste
            </li>
          ...
          <p>
            <strong>Design principle:</strong> Consider the entire lifecycle from extraction through
            manufacture, installation, operation, maintenance, and end-of-life when specifying
            building services.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Design for Disassembly">
          ...
          <p>
            <strong>Connection Strategies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Containment Design</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>DfD Strategies for Electrical Installations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cable containment:</strong> Cast into screed, clipped direct — Surface
              trunking, accessible trays
            </li>
            <li>
              <strong>Distribution boards:</strong> Flush-mounted, plastered around —
              Surface-mounted, bolted fixings
            </li>
            <li>
              <strong>Lighting:</strong> Recessed with fixed connections — Track or plug-in systems
            </li>
            <li>
              <strong>Final circuits:</strong> Hard-wired throughout — Prefabricated wiring,
              connectors
            </li>
            <li>
              <strong>Busbar systems:</strong> Custom fabricated, bolted — Plug-in modular systems
            </li>
          </ul>
          <p>
            <strong>DfD Design Checklist</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Material Passports and Documentation">
          ...
          <p>
            <strong>Material Passport Contents</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Material Passport Data Structure</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Identity:</strong> Unique ID, location, installation date — Tracking and
              inventory
            </li>
            <li>
              <strong>Composition:</strong> Materials, weights, certifications — Recycling decisions
            </li>
            <li>
              <strong>Environmental:</strong> Embodied carbon, EPD data — Sustainability reporting
            </li>
            <li>
              <strong>Maintenance:</strong> Service history, condition, remaining life — Reuse
              assessment
            </li>
            <li>
              <strong>End of life:</strong> Disassembly instructions, disposal guidance — Recovery
              planning
            </li>
          </ul>
          <p>
            <strong>BIM Integration for Material Passports</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Lifecycle tracking:</strong> Maintenance events recorded against components
            </li>
            <li>
          ...
          <p>
            <strong>Example: Distribution Board Material Passport Entry</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Asset ID:</strong> DB-L2-01
            </li>
            <li>
              <strong>Manufacturer:</strong> Schneider Electric
            </li>
            <li>
              <strong>Model:</strong> Prisma Plus P 400A
            </li>
            <li>
              <strong>Install date:</strong> 2024-03-15
            </li>
            <li>
              <strong>Expected life:</strong> 25 years
            </li>
            <li>
              <strong>Steel content:</strong> 45kg (recyclable)
            </li>
            <li>
              <strong>Copper content:</strong> 12kg (recyclable)
            </li>
            <li>
              <strong>Plastic content:</strong> 8kg (PP - recyclable)
            </li>
            <li>
              <strong>Disassembly:</strong> See procedure DIS-DB-001
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Circular Business Models and End-of-Life Planning">
          <p>
            ...
            repairability, and material recovery. Product-as-a-service models shift equipment
            ownership to providers who benefit from designing for durability and end-of-life value.
          </p>
          <p>
            <strong>Business Model Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Traditional purchase:</strong> Client owns — Low initial cost — Client
              disposal responsibility
            </li>
            <li>
              <strong>Lease/rental:</strong> Provider owns — Provider maintains asset value —
              Provider recovery
            </li>
            <li>
              <strong>Product-as-a-service:</strong> Provider owns — Performance and longevity —
              Provider reuse/recycle
            </li>
            <li>
              <strong>Take-back schemes:</strong> Client owns — Recovery discount — Manufacturer
              recovery
            </li>
          </ul>
          <p>
            <strong>Lighting-as-a-Service Benefits</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>End-of-Life Planning Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Waste Hierarchy Application</strong>
          </p>
          <p>
          ...
          <p>
            <strong>4. Recovery:</strong> Extract energy from materials that cannot be recycled
          </p>
          <p>
            <strong>5. Disposal:</strong> Landfill only as absolute last resort
          </p>
          <p>
            <strong>Component Reuse Potential</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cable tray/trunking:</strong> High — Inspect for damage, clean
            </li>
            <li>
              <strong>Luminaire housings:</strong> Medium-High — Replace lamps/drivers, test
            </li>
            <li>
              <strong>Switchgear enclosures:</strong> Medium — Refurbishment required
            </li>
            <li>
              <strong>Cables:</strong> Low-Medium — Insulation testing, length limits
            </li>
            <li>
              <strong>Protective devices:</strong> Low — Standards compliance critical
            </li>
          </ul>
          <p>
            <strong>Regulatory note:</strong> Reused components must comply with current standards.
            WEEE regulations apply to electrical equipment disposal, requiring proper handling of
            hazardous materials.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Create material passport system for new commercial building
            services.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Initial cost focus:</strong> Present whole-life cost case including recovery
              value
            </li>
            <li>
              <strong>Standards compliance:</strong> Ensure reclaimed items meet current regulations
            </li>
            <li>
              <strong>Supply chain:</strong> Develop relationships with recovery and reuse providers
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 1990s office is being refurbished. The design team had specified disposal of all
              existing electrical switchgear (3 × 1,250 A LV panels, 12 distribution boards) as
              waste, replacing with new. The Circular Economy Statement requires material reuse
              strategy. Initial estimate: 8 tonnes of electrical equipment to landfill.
            </>
          }
          whatToDo={
            <>
              Engage a switchgear refurbishment specialist (e.g. Spark Switchgear, Henley
              Electrical) for technical assessment. Most LV panels of this age are refurbishable to
              current BS EN 61439 standards: replace ACBs with current types, refurbish busbars,
              re-test, re-certify. Cost typically 30–50% of new with 60–80% embodied carbon saving.
              Where panels cannot be refurbished, donate to circular-economy marketplaces (e.g.
              Globechain, Construction Reuse Network) for use in lower-tier applications. Document
              for the CE Statement.
            </>
          }
          whyItMatters={
            <>
              Construction waste is 60% of total UK waste by mass. M&E equipment is high-value,
              high-embodied-carbon — the highest-priority candidate for reuse. The barrier is rarely
              technical (refurbishment standards exist) but commercial (warranty, liability, supply
              chain). Circular Economy Statements force the conversation; the technical and
              commercial frameworks are catching up.
            </>
          }
        />
