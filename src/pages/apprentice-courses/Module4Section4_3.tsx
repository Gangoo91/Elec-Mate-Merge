...
const DESCRIPTION =
  'Master the use of couplers, saddles, and bushes for containment assembly. Learn proper joining techniques, electrical continuity, and BS 7671 compliance for safe installations.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'To support conduit runs',
    ],
    correctIndex: 1,
    explanation:
      'Bushes are fitted to conduit ends to protect cables from sharp edges and prevent insulation damage, as required by BS 7671.',
  },
  {
    id: 2,
    ...
    options: [
      ...
      'To act as protective conductor (CPC)',
      'To prevent thermal expansion',
    ],
    correctIndex: 1,
    explanation:
      'Metallic containment may be used as a protective conductor (CPC), so electrical continuity must be maintained throughout the installation.',
  },
  {
    id: 3,
    question: 'What torque consideration applies when fitting saddles to PVC conduit?',
    options: [
      'Over-tightening can deform PVC',
      'Maximum torque for strength',
      'No torque limits apply',
    ],
    correctIndex: 0,
    explanation:
      "Excessive torque on saddles can deform PVC conduit and create stress points. Follow manufacturer's torque specifications.",
  },
];
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Couplers are specifically designed to join two sections of containment together, ensuring mechanical strength and continuity.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Clean contact surfaces or use earth straps to maintain electrical continuity where paint or coatings interfere.',
    },
    {
      id: 6,
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/70 text-sm space-y-1">
                  ...
                  <li>
                    • <strong>Use:</strong> Manufacturer datasheets, torque specifications,
                    continuity tester
                  </li>
                  <li>
                    • <strong>Check:</strong> Bush protection, proper alignment, electrical
                    continuity
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <ul className="text-white/80 space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Identify different containment fittings (couplers, saddles, bushes) and their
                  specific functions
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                <span>
                  Correctly select and install appropriate fittings for different containment types
                  and materials
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                <span>
                  Ensure joints maintain mechanical strength and electrical continuity as required
                  by BS 7671
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                <span>
                  Apply proper assembly sequence to prevent cable damage and ensure professional
                  installation
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                <span>
                  Avoid common assembly mistakes that compromise safety and regulatory compliance
                </span>
              </li>
            </ul>
          </section>
            ...
            <div className="text-white/80 space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Steel conduit couplers:</strong>
                </p>
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>PVC conduit joining methods:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Pre-assembly requirements:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Critical alignment procedures:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Cable tray couplers:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Trunking assembly methods:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Fixed saddles specifications:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Adjustable saddle features:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm mb-2">
                  <strong>PVC containment saddles:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Metal containment considerations:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Bush material specifications:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Special application requirements:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-orange-500/50">
                <p className="font-medium text-white mb-2">
                  Electrical Continuity Testing and Maintenance
                </p>
                <p className="text-sm mb-2">
                  <strong>Testing requirements (BS 7671):</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Earth strap installations:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-red-500/50">
                <p className="font-medium text-white mb-2">
                  Professional Assembly Standards and Common Errors
                </p>
                <p className="text-sm mb-2">
                  <strong>Assembly sequence checklist:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
            ...
            <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
              <div className="text-white/80 space-y-4 text-sm">
                <p>
                  ...
                  cable insulation, causing a short circuit that resulted in:
                </p>
                ...
                <div className="p-3 rounded bg-white/5 mt-4">
                  ...
                  <p>
                    The remedial work involved cutting out all affected sections, properly deburring
                    all new cuts, and fitting appropriate bushes at every cable entry point. The
                    installation now meets BS 7671 requirements and has operated fault-free for over
                    three years. Total remedial cost exceeded £8,000 - far more than the original
                    bush cost of £50.
                  </p>
                </div>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-white/80 text-sm">
                ...
                ensuring electrical continuity where required creates safe, compliant installations
                that meet BS 7671 standards and provide long-term reliability.
              </p>
            </div>
          </section>
