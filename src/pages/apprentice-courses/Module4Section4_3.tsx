      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Couplers and Basic Assembly Principles</h3>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Coupler Types and Applications</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Steel conduit couplers:</strong></p>
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>PVC conduit joining methods:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Assembly Sequence and Preparation</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Pre-assembly requirements:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Critical alignment procedures:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Tray and Trunking Joining Systems</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Cable tray couplers:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Trunking assembly methods:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Saddles and Support Systems</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Fixed saddles specifications:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Adjustable saddle features:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>PVC containment saddles:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Metal containment considerations:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Saddle positioning guidelines:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>High-vibration environments:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Bushes and Cable Protection</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Bush Types and BS 7671 Requirements</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Regulatory compliance:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Bush material specifications:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Installation Techniques and Sizing</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Sizing criteria:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Special application requirements:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Electrical Continuity and Professional Assembly</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">Electrical Continuity Testing and Maintenance</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Testing requirements (BS 7671):</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Earth strap installations:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">Professional Assembly Standards and Common Errors</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Assembly sequence checklist:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Critical errors to avoid:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-8 p-6 bg-card border-border/20">
          ...
          <div className="text-xs sm:text-sm text-foreground mb-4">
          ...
          <ul className="list-disc pl-6 text-xs sm:text-sm text-foreground mb-4 space-y-1">
        ...
        {/* Practical guidance */}
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-4">Enhanced Practical Guidance</h2>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-medium text-foreground mb-2">Q: Can I mix fittings from different manufacturers?</h3>
            ...
            <div>
              <h3 className="font-medium text-foreground mb-2">Q: Are bushes required for PVC conduit installations?</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <div>
              <h3 className="font-medium text-foreground mb-2">Q: What if paint on steel conduit interferes with electrical continuity?</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <div>
              <h3 className="font-medium text-foreground mb-2">Q: How do I prevent galvanic corrosion between different metals?</h3>
              <p className="text-sm text-muted-foreground">
