...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['24 months', '36 months', '12 months', '6 months'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['20-30%', '5-10%', '40-50%', '70-80%'],
    correctAnswer: 0,
    explanation:
...
const HNCModule5Section4_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 4 · Subsection 6"
        title="Defects and Snagging"
        backTo="/study-centre/apprentice/h-n-c-module5-section4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Defect identification, snagging procedures, tracking systems, rectification management and
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The Rectification Period (commonly 12 months) is the contractor's opportunity to make
              good defects without cost dispute. After the Schedule of Defects is issued, the
              contractor must rectify within a reasonable period. Failure to rectify entitles the
              client to engage others and deduct from retention. Manage the DLP actively — not as an
              afterthought.
            </>
          }
        ...
        <ConceptBlock title="Snagging Walkthrough Procedures">
          <p>
            ...
            does not comply with the contract specification. Effective snagging protects all parties
            by creating a clear record of the installation's condition at handover.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Initial snagging:</strong> 2-4 weeks before PC - joint walkthrough with client
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Preparation:</strong> Review drawings, specifications, O&M requirements — M&E
          ...
          <p>
            <strong>Best practice:</strong> Conduct walkthroughs in consistent lighting conditions.
            Bring a torch for ceiling voids and risers.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Tracking Systems and Rectification Management">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Ready for Inspection:</strong> Work complete, awaiting sign-off — Client / CA
              to inspect
            </li>
            <li>
        ...
        <ConceptBlock title="Close-out Documentation and Defects Liability Period">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Seasonal commissioning (6 months post-PC):</strong> Verify heating/cooling in
              opposite season
            </li>
            <li>
          ...
          <p>
            <strong>Latent defects and limitation periods:</strong> Beyond the DLP, contractors may
            still be liable for latent defects (hidden issues) under:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              1. Emergency exit sign not illuminated → Category A (Critical) - Safety system
              non-functional
            </li>
            <li>
          ...
          <p>
            <strong>Example 2 — DLP timeline:</strong> Practical Completion achieved 15 March 2024.
            When does the DLP expire and what are key milestones?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — Defect close-out:</strong> Defect #247 - BMS point for AHU-01 supply
            fan showing incorrect status. Document the close-out.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Description:</strong> BMS graphic shows supply fan OFF when physically running
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Late snagging</strong> — Start too late, no time for rectification before PC
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You handed over a school MEP package six months ago. The school's facilities manager
              has logged 47 defects via email but you have not responded. At the 12-month
              inspection, the architect schedules the defects and gives you 14 days to rectify. You
              miss the deadline. The school engages a different MEP contractor; the cost is deducted
              from your retention plus 20% for client management. Net cost to you: £35k against £28k
              retention — a £7k loss to settle.
            </>
          }
          whatToDo={
            <>
              Treat DLP as a managed phase, not a passive period. Maintain a defects register from
              PC onwards. Respond to every defect notification within 5 working days — visit,
              assess, schedule rectification. Communicate with the FM regularly. At 11 months,
              conduct a pre-end-of-DLP inspection to find anything before the architect does. The
              end-of-DLP report is a closure event, not a surprise.
            </>
          }
          whyItMatters={
            <>
              Retention release is the project's bottom-line margin. DLP defects unaddressed eat
              retention faster than budget overruns. Active DLP management protects margin and
              reputation — a satisfied client at end-of-DLP is the foundation of repeat business.
            </>
          }
        />
