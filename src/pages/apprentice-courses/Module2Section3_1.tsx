...
const DESCRIPTION =
  'Master series and parallel circuits for UK electrical installations. Learn circuit types, characteristics, and BS 7671 applications for apprentice electricians.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'In parallel circuits, each branch is connected directly to the supply, so voltage is the same across all branches.',
  },
  {
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Adding more lamps in series increases total resistance, reducing current flow, so all lamps get dimmer.',
  },
  {
    id: 3,
    question:
  ...
  },
  {
    id: 5,
    question:
      'In a series circuit, if one component fails and creates an open circuit, what happens?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'In series circuits, if one component fails and breaks the circuit, no current can flow so all components stop working.',
  },
  {
    id: 6,
    question:
  ...
  },
  {
    ...
    options: [
      'All current goes through one resistor',
      'Current divides equally',
      'Current goes through the first resistor only',
      'Current direction reverses',
    ],
    correctAnswer: 1,
    explanation:
      'With identical parallel resistors, current divides equally between them since they have the same resistance.',
  },
  {
    id: 10,
...
const faqs = [
  {
    ...
    answer:
      'In series circuits, components are connected end-to-end in a single path, so current flows through each component in turn. In parallel circuits, components are connected alongside each other, creating multiple paths for current to flow.',
  },
  {
    question: 'Why do Christmas lights sometimes all go out when one bulb fails?',
    answer:
      'Older Christmas lights were wired in series. When one bulb failed (creating an open circuit), it broke the complete circuit path, so no current could flow to any of the bulbs. Modern Christmas lights often use parallel wiring or special bulbs that maintain the circuit when they fail.',
  },
  {
    question: 'Which circuit type is better for household wiring?',
    answer:
      "Parallel circuits are much better for household wiring. Each outlet, light, or appliance can operate independently. If one device fails or is switched off, it doesn't affect the others. Also, each device gets the full supply voltage.",
  },
  {
    question: 'What happens to current when you add more branches to a parallel circuit?',
    answer:
      "Total current increases because you're providing more paths for current to flow. Each new branch draws its own current, so the supply must provide the sum of all branch currents.",
  },
  {
    question: 'Why does voltage drop in series circuits but not in parallel?',
    answer:
      'In series circuits, components share the supply voltage between them - each component uses up some voltage. In parallel circuits, each branch is connected directly across the supply, so each gets the full supply voltage.',
  },
  {
    question: 'How do I recognise series vs parallel circuits in practice?',
    answer:
      'Look at the connections: Series circuits have components connected end-to-end in a chain. Parallel circuits have components connected side-by-side with separate paths. In building wiring, most circuits are parallel - each socket or light has its own connection back to the distribution board.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Series:</strong> Components connected end-to-end, current same everywhere,
                voltage divides
              </li>
              <li>
                <strong>Parallel:</strong> Components side-by-side, voltage same everywhere, current
                divides
              </li>
              <li>
                <strong>Series resistance:</strong> R₁ + R₂ + R₃... (adds up)
              </li>
              <li>
                <strong>Parallel resistance:</strong> 1/Rtotal = 1/R₁ + 1/R₂... (gets smaller)
              </li>
              <li>
                <strong>UK practice:</strong> Most building circuits are parallel for independent
                operation
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Christmas lights (series), household sockets (parallel), car
                headlights (parallel)
              </li>
              <li>
                <strong>Use:</strong> Circuit design, fault finding, load calculations, cable sizing
              </li>
              <li>
                <strong>Apply:</strong> Ring circuits, radial circuits, emergency lighting,
                distribution boards
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              In series circuits, components are connected end-to-end in a single path. Current has
              only one route to follow, so it must be the same through every component.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Current:</strong> Same everywhere (I₁ = I₂ = I₃ = Itotal)
                </li>
                <li>
                  <strong>Voltage:</strong> Divides between components (Vsupply = V₁ + V₂ + V₃)
                </li>
                <li>
                  <strong>Resistance:</strong> Adds together (Rtotal = R₁ + R₂ + R₃)
                </li>
                <li>
                  <strong>Failure:</strong> One component fails, whole circuit stops
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Real Example:</strong> Old-style Christmas lights were wired in series. When
              one bulb failed, all the lights went out because the circuit path was broken.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              In parallel circuits, components are connected side-by-side across common points. This
              creates multiple paths for current to flow, like lanes on a motorway.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Voltage:</strong> Same across all branches (V₁ = V₂ = V₃ = Vsupply)
                </li>
                <li>
                  <strong>Current:</strong> Divides between branches (Itotal = I₁ + I₂ + I₃)
                </li>
                <li>
                  <strong>Resistance:</strong> 1/Rtotal = 1/R₁ + 1/R₂ + 1/R₃ (gets smaller)
                </li>
                <li>
                  <strong>Independence:</strong> Each branch works independently
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Real Example:</strong> Household sockets are wired in parallel. Each appliance
              gets full 230V and if one fails, the others keep working.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Important:</strong> In parallel, total resistance is always less than the
              smallest individual resistance. Adding more parallel branches decreases total
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Understanding series and parallel circuits is essential for UK electrical
              installations and BS 7671 compliance.
            </p>

            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Common Series Applications
                </p>
                <ul className="text-sm text-white space-y-1">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Confusing voltage and current behaviour:</strong> Remember voltage divides
                  in series, current divides in parallel
                </li>
                <li>
                  <strong>Wrong resistance calculations:</strong> Series adds directly, parallel
                  uses reciprocals
                </li>
                <li>
                  <strong>Ignoring cable resistance:</strong> Long cable runs add series resistance
                </li>
                <li>
                  <strong>Poor connections:</strong> Loose connections create unwanted series
                  resistance
                </li>
                <li>
                  <strong>Overloading parallel circuits:</strong> Each new branch adds to total
                  current
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Practice calculations:</strong> Work through examples until formulas
                  become natural
                </li>
                <li>
                  <strong>Identify circuits:</strong> Look at real installations and identify
                  series/parallel sections
                </li>
                <li>
                  <strong>Use test equipment:</strong> Measure voltage and current to verify your
                  understanding
                </li>
                <li>
                  <strong>Think about consequences:</strong> What happens when loads are added or
                  removed?
                </li>
                <li>
                  <strong>Connect to BS 7671:</strong> Understand how circuit types affect
