...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Weekly or monthly', 'Daily', 'Annually', 'Only at project completion'],
    correctIndex: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Under NEC4, programme revisions are a contractual rhythm — typically 4 weekly. Each
              revision is a CPM-disciplined update against actuals, accepted compensation events and
              forecast changes. The revised programme is the basis of monthly payment certification.
              Skipping or sloppy revisions break the contract's commercial logic.
            </>
          }
        ...
        <ConceptBlock title="Daily Site Diaries">
          <p>
            The site diary is the most important contemporaneous record on any construction project.
            For building services contractors, it provides essential evidence of progress, delays,
            instructions, and site conditions that may be needed months or years later for claims,
            disputes, or simply understanding what happened and when.
          </p>
          <p>
          ...
          <p>
            <strong>
              Best practice — photographic records. Complement diary entries with date-stamped
              photographs showing:
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Progress Reports and Programme Updates">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>3. Analysis:</strong> Compare to baseline, identify variances — Critical path
              status, float consumed
            </li>
            <li>
        ...
        <ConceptBlock title="Progress Meetings and Communication">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Previous actions:</strong> Review completion status of actions — 10 minutes
            </li>
            <li>
            ...
            <li>
              <strong>5. Design/RFIs:</strong> Outstanding information, drawing status — 10 minutes
            </li>
            <li>
          ...
          <p>
            ...
            accurately reflect what was said or agreed, respond in writing within 7 days requesting
            correction.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Performance Measurement and Delay Analysis">
          <p>
            ...
            identification of problems and supports evidence-based decision making. When delays
            occur, formal delay analysis establishes cause, effect, and entitlement.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>RFI response time:</strong> Average days to receive response — Target ≤ 5 days
            </li>
          </ul>
          <p>
            <strong>
              Earned value analysis example — Week 8 of 20-week programme, Budget = £500,000:
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Excusable, compensable:</strong> Client-caused delay (entitlement to time and
              money)
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              The project is running two weeks behind. The site diary review shows that, over the
              last six weeks, the electrical sub has averaged 09:30 starts (against a 08:00
              contractual start), losing approximately 7.5 hours per week per operative. With 12
              operatives, that is 90 lost hours per week, or roughly 540 hours over the period —
              equivalent to two weeks of work on a 5-day/8-hour basis.
            </>
          }
          whatToDo={
            <>
              Use the site diary as evidence in a performance meeting with the subcontractor.
              Document the pattern; agree corrective action (8:00 start enforced, supervisor on site
              for tea and morning brief, late starts logged as time-related contractor cost). Track
              for two weeks; if not corrected, escalate to formal warning under the subcontract. The
              site diary is the contemporaneous evidence base — without it, the conversation becomes
              "your word against theirs".
            </>
          }
          whyItMatters={
            <>
              Progress monitoring is what catches drift before it becomes crisis. The disciplined
              site diary, weekly progress report and monthly programme update create the audit trail
              that supports every commercial conversation — from subcontractor performance
              management to NEC compensation event assessment.
            </>
          }
        />
