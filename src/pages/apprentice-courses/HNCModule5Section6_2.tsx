...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'The safest route through site',
      'The sequence of activities that determines project duration',
      'The most expensive work packages',
      'The path taken by project managers',
    ],
    correctIndex: 1,
    explanation:
