    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Understand the professional and ethical responsibilities of building services engineers
          regarding health and safety
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the professional obligations that building services engineers must
          uphold - from legal duties of care and maintaining competence, through to understanding
          the role of safety representatives, acting ethically, and committing to continuous
          professional development in health and safety matters.
        </p>
