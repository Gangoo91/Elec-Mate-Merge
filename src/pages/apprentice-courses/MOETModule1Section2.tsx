  ...
  const subsections = [
    {
      ...
      icon: Zap,
      href: "../m-o-e-t-module1-section2-2-1"
    },
    {
      number: "1.2.2", 
      ...
      icon: Wrench,
      href: "../m-o-e-t-module1-section2-2-2"
    },
    {
      number: "1.2.3",
      ...
      icon: Shield,
      href: "../m-o-e-t-module1-section2-2-3"
    },
    {
      number: "1.2.4",
      ...
      icon: AlertTriangle,
      href: "../m-o-e-t-module1-section2-2-4"
    },
    {
      number: "1.2.5",
      ...
      icon: Activity,
      href: "../m-o-e-t-module1-section2-2-5"
    }
  ];
