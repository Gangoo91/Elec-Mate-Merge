    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The AM2 is not just a test of technical skill - it is a test of whether you can be trusted
          to work safely in the electrical industry. Assessors are trained to watch for safe
          behaviour at all times, not only during specific tasks like isolation. If you show unsafe
          practice, it can result in instant failure, regardless of how well you complete the rest
          of the exam.
        </p>
        ...
        <ConceptBlock title="Safety is Everything in AM2">
          <p>
            ...
            objective is to prove you are safe to work unsupervised. Every action is being assessed
        ...
        <ConceptBlock title="Why Safety is Everything">
          ...
          <p>
            <strong className="text-green-400">Remember:</strong> Every action is being assessed for
            safety compliance. The assessor is constantly evaluating whether you can be trusted to
        ...
        <ConceptBlock title="Showing the Assessor">
          <p>
            It's not just about being safe — it's about making it clear to the assessor that safety
            is your priority:
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-blue-400/70">
            <li>
              <strong>Talk through steps:</strong> e.g., "I am now proving my tester on a known live
              source"
            </li>
            <li>
              <strong>Double-check visibly:</strong> show that you re-sleeve CPCs, torque terminals,
              re-fit trunking lids
            </li>
            <li>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <p>
            ...
            <strong>Do:</strong> connect CPCs first with proper sleeving, torque terminals to spec.{' '}
            <strong>Say:</strong> "Connecting the CPC first for safety, using green/yellow
          ...
          <p>
            ...
            verifying CPC continuity". <strong>Why:</strong> prevents dangerous situations and shows
            systematic approach.
          </p>
          <p>
        ...
        <ConceptBlock title="Real-world Examples">
          ...
          <p>
            ...
            energised a circuit with no CPC — shock incident. Same behaviour in AM2 = instant fail.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Frequently Asked Questions">
          ...
          <p>
            ...
            immediately, inform the assessor, isolate if necessary, and correct it properly. Honesty
            and immediate correction show professional integrity.
          </p>
          <p>
          ...
          <p>
            <strong>Q5: What happens if my test equipment fails during the exam?</strong> Stop work
            immediately, inform the assessor, and request replacement equipment. Never continue with
            faulty or unsafe test equipment.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Summary">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-blue-400/70">
            ...
            <li>
              Show the assessor, clearly and confidently, that safety is always your first priority
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              both a regulatory breach and an AM2 critical safety error. The visual walk-through is
              where you find the obvious problems — exposed conductors, missing barriers,
        ...
        <Scenario
          ...
          situation={
            <>
              It’s 12:30 on day one. You’re mid-task — consumer unit cover off, conductors partially
              terminated, supply isolated and locked off. The assessor calls lunch. You grab your
              jacket and head for the canteen.
            </>
          }
          whatToDo={
            <>
              Before you walk away: replace the cover or post a clear warning, confirm the supply is
              still isolated and your padlock is in place, leave a safe-condition note on the rig.
              On site, leaving an uncovered consumer unit unattended is a serious H&S breach. On AM2
              it’s a marked criterion.
            </>
          }
          whyItMatters={
            <>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You ace safe isolation in Section C, but the rest of the day you’ve had safety glasses
              on your head, gloves in your back pocket, and tools in places where someone could walk
              into them. The assessor logs an H&S issue every couple of hours. By close of play
              you’ve accumulated enough to fail on H&S.
            </>
          }
          doInstead={
            <>
              Treat safety as a continuous behaviour, not a section. Glasses on whenever you’re
              cutting, drilling or stripping. Tidy workspace at every break. PPE matched to the task
              from your RAMS. Make safety visible.
            </>
          }
        />
