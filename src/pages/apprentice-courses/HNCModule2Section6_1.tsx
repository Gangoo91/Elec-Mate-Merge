...
const quickCheckQuestions = [
  {
    ...
    options: ['CIBSE Guide F', 'CIBSE Guide M', 'CIBSE Guide A', 'CIBSE Guide B'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['7:00 PM', '3:00-5:00 PM', '9:00 AM', '12:00 noon'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['0.8-0.9', '0.4-0.5', '1.0', '0.6-0.7'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['0.5-0.6', 'It varies too much to generalise', '0.7-0.8', '0.9-1.0'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['0.1-0.25 ACH', '2.5-3.0 ACH', '1.5-2.0 ACH', '0.5-1.0 ACH'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE Guide A + B1/B3 is the canonical UK approach. As HNC engineer you cite them on
              the load schedule cover sheet so the M&amp;E commissioning engineer, BREEAM assessor
              and Part L SBEM modeller are all working from the same load-derivation methodology.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fabric losses:</strong> Heat flow through walls, roof, floor, windows (Q = U ×
              A × ΔT)
            </li>
            <li>
          ...
          <p>
            <strong>
              CIBSE design temperatures (UK), heating design temp / notes (1% exceedance):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Basic heating load formula:</strong> Q_total = Q_fabric + Q_infiltration +
            Q_ventilation. Where Q = heat loss rate (W), typically calculated at design ΔT.
          </p>
          <p>
        ...
        >
          <p>
            Cooling load calculations are more complex than heating, involving solar gains, internal
            heat sources, and the dynamic response of building thermal mass. The CIBSE admittance
            method accounts for these time-varying effects.
          </p>
          <p>
          ...
          <p>
            <strong>Sol-air temperature concept:</strong> T_sol-air = T_ao + (α × I / h_o) - (ε × ΔR
            / h_o). Where T_ao = outside air temp, α = solar absorptance, I = solar intensity, h_o =
        ...
        >
          <p>
            Diversity factors recognise that not all installed equipment operates simultaneously at
            full capacity. Applying appropriate diversity reduces oversizing while maintaining
            adequate capacity for realistic operating conditions.
          </p>
          <p>
            <strong>
              CIBSE recommended diversity factors (load type / building type / factor):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          <p>
            Design margins account for calculation uncertainties, minor future changes, and the need
            for robust operation. However, excessive margins lead to oversized, inefficient systems
            that operate poorly at part-load.
          </p>
          <p>
        ...
        >
          <p>
            <strong>Example 1 - Office heating load:</strong> Calculate the peak heating load for a
            500m² office floor in Birmingham with U-values: walls 0.25 W/m²K, windows 1.4 W/m²K,
            roof 0.18 W/m²K. Assume wall area 200m², window area 80m², roof 500m².
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Infiltration (0.25 ACH, 3m height): V = 500 × 3 × 0.25 = 375 m³/h, Q = 0.33 × 375 × 24
              = 2,970W
            </li>
            <li>
          ...
          <p>
            <strong>Example 2 - Cooling load with diversity:</strong> Calculate the internal gains
            for a 200m² open-plan office with 20 workstations.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              With diversity: lighting × 0.75 = 1,800W; small power × 0.7 = 2,800W; occupancy × 0.75
              = 1,350W
            </li>
            <li>
          ...
          <p>
            ...
            fresh air for 20 people at 12 l/s per person. External: 28°C/50%RH, Internal:
            24°C/50%RH.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Fresh air rate: 20 × 12 = 240 l/s = 0.24 m³/s</li>
            <li>
              Sensible: Q_s = ρ × c_p × V̇ × ΔT = 1.2 × 1.02 × 0.24 × (28-24) ={' '}
              <strong>1.18 kW</strong>
            </li>
            <li>
              Latent: from psychrometric chart, Δg ≈ 2 g/kg, Q_L = 1.2 × 0.24 × 0.002 × 2450 ={' '}
              <strong>1.41 kW</strong>
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Incorrect diversity</strong> — Don't apply diversity to already-diversified
                figures
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              You are producing the Stage-3 cooling load schedule for a 4,500 m² speculative office.
              The architect has fixed glazing ratio (40% south, 30% north), G-value 0.4, opening
              lights for purge ventilation. Tenant fit-out density is unknown — speculative.
            </>
          }
          whatToDo={
            <>
              Apply CIBSE Guide A typical office densities: 1 person per 10 m², 25 W/m² small power,
              8 W/m² lighting (post-LED). Use July 21 design irradiance from Guide A for solar gain.
              Apply diversity 0.8 IT, 1.0 people, 0.9 lighting for spec-office worst case. Sum
              sensible loads at peak hour (typically 15:00 south-facing zones, 17:00 west-facing).
              Add a 15% margin on cooling-coil duty for tenant uplift, and a 10% margin on chiller
              duty for diversity across zones.
            </>
          }
          whyItMatters={
            <>
              Spec offices are sized once and sold for 25 years. Undersize: tenant moves out,
              building gets a poor reputation in the market. Oversize: capex hit, EPC deterioration,
              ESG credentials suffer. CIBSE-grounded diversities and margins give the defendable
              middle ground.
            </>
          }
        />
