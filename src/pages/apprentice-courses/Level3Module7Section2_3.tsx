      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Essential certification, testing records, and professional documentation
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Understand the different types of electrical certification",
              "Know when to issue each type of certificate",
              "Complete schedules of inspections and test results",
              "Understand EICR coding and classifications",
              "Maintain proper records and retention policies",
              "Recognise the legal importance of documentation"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module7-section2-2">
              <ArrowLeft className="w-4 h-4 mr-2" />
