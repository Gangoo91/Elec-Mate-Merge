  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 2,
      explanation:
        'Proper isolation, testing, and lockout procedures are the most effective way to prevent electric shock. This ensures circuits are dead before work begins.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'Trailing cables and poor housekeeping are the most common causes of trips on electrical sites, along with wet floors and debris.',
    },
    {
      id: 3,
      ...
      correctAnswer: 2,
      explanation:
        'Water-based extinguishers should never be used on electrical fires as water conducts electricity and increases the risk of electric shock.',
    },
    {
      id: 4,
      question:
        'What should be your first action when discovering someone has received an electric shock?',
      options: [
      ...
      correctAnswer: 2,
      explanation:
        'The first action should be to switch off the power source if safe to do so. Never touch someone who may still be in contact with electricity.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'Ladder accidents can be prevented through proper access planning, using appropriate equipment, maintaining three points of contact, and avoiding overreaching.',
    },
    {
      id: 6,
      ...
      correctAnswer: 1,
      explanation:
        'Burns represent approximately 25% of electrical injuries, often from arc flash or contact with live parts.',
    },
    {
      id: 7,
      question: 'What is the average cost of a major workplace injury?',
      options: ['£8,000', '£12,000', '£18,000', '£25,000'],
      correctAnswer: 2,
      explanation:
        'The average cost per major injury is £18,000, including medical costs, lost time, investigation, and legal expenses.',
    },
    {
      id: 8,
      ...
      correctAnswer: 2,
      explanation:
        'Rushing or time pressure is one of the most common human factors in workplace accidents, leading to skipped safety checks and poor decisions.',
    },
    {
      id: 9,
      ...
      correctAnswer: 3,
      explanation:
        'For every major injury reported, there are typically 10 minor injuries and 300 near misses that go unreported.',
    },
    {
      id: 10,
      ...
      correctAnswer: 1,
      explanation:
        'Immediate response should focus on securing the scene, providing first aid, notifying management and emergency services, and preserving evidence for investigation.',
    },
  ];
      ...
      <div className="border-b border-border/20 bg-card sticky top-0 z-10 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <Button variant="ghost" asChild>
            <Link
              to=".."
              className="inline-flex items-center gap-2 text-elec-yellow hover:text-white"
            >
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
            <div className="bg-card border border-border/20 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                Electrical work presents multiple accident risks - from electric shock and burns to
                slips, falls, and manual handling injuries. Understanding these common accident
                types, their causes, and prevention methods is essential for maintaining a safe
                working environment and protecting yourself and colleagues.
              </p>
            </div>
            <div className="bg-card border border-elec-yellow/30 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                <strong>Spot:</strong> Trailing cables, poor lighting, damaged tools, rushed work
                practices.
                <br />
                <strong>Use:</strong> Proper isolation procedures, good housekeeping, correct access
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              ...
              <span className="text-white">
                Identify common accident types (shock, burns, slips/trips/falls, manual handling,
                cuts/impact, vehicle incidents)
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
            ...
            <div className="flex-1">
              ...
              <div className="bg-card border border-border/30 rounded-lg p-4">
                ...
                <p className="text-white text-sm">
                  For every major injury reported, there are typically 10 minor injuries and 300
                  near misses that go unreported. Prevention at all levels is crucial.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mb-8 border-l-4 border-slate-500 p-6 bg-card rounded-lg">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">
                Summary and Prevention Checklist
              </h2>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-white text-sm">
                      Complete proper isolation and testing before work
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                    <span className="text-white text-sm">
                      Maintain good housekeeping and cable management
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                    <span className="text-white text-sm">
                      Use appropriate access equipment for height work
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                    <span className="text-white text-sm">
                      Wear correct PPE and use proper manual handling techniques
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
