...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['0.075 m', '0.30 m', '0.15 m', '1.5 m'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['PSI per foot', 'Pa per metre of pipe', 'Bar total', 'Metres head'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['h_f = ρgh', 'h_f = fLv²/2gD', 'h_f = P/ρg', 'h_f = Kv²/2g'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['10 kPa', '15 kPa', '13 kPa', '20 kPa'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['50 Pa/m', '100 Pa/m', '500 Pa/m', '250-350 Pa/m'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Halves', 'Reduces to 1/32', 'Quarters', 'Doubles'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Darcy-Weisbach, the Moody diagram, K-factors, equivalent lengths, and the CIBSE tables
          you'll use to size pipework on a real job.
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE Guide C is the UK reference for pipe friction calculations. As an HNC designer
              your spec choices on pipe size, material and fittings feed directly into the pump
              duty, the operating cost and the long-term reliability of the system.
            </>
          }
        ...
        >
          <p>
            The Darcy-Weisbach equation calculates friction head loss in a length of straight pipe
            based on flow conditions and pipe properties.
          </p>
          <p>
            <strong>Equation:</strong> hf = f × (L/D) × (v²/2g). hf = friction head loss (m), f =
            Darcy friction factor (dimensionless), L = pipe length (m), D = internal diameter (m), v
            = velocity (m/s), g = 9.81 m/s².
          </p>
          <p>
        ...
        >
          <p>
            The Moody diagram plots Darcy friction factor f against Reynolds number Re for different
            values of relative roughness ε/D. It's the standard reference for turbulent flow
            friction factors.
          </p>
          <p>
          ...
          <p>
            <strong>Colebrook-White equation:</strong> 1/√f = -2 log₁₀(ε/(3.7D) + 2.51/(Re√f)). The
            implicit equation behind the Moody diagram. Solved iteratively.
          </p>
          <p>
            <strong>Aging:</strong> Roughness increases with corrosion and scale. Add 10-20% safety
            margin on pressure drop for design.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Fittings, valves, and changes in pipe section cause additional ('minor') losses beyond
            straight-pipe friction. Despite the name, these often dominate in building services
            where pipework is short but heavily fitted.
          </p>
          <p>
            <strong>K-factor method:</strong> hloss = K × v²/(2g). Each fitting has its own K value.
          </p>
          <p>
        ...
        >
          <p>
            CIBSE Guide C provides pre-calculated pressure drop tables for common pipework materials
            and water temperatures. For each pipe size and flow rate, the table gives pressure drop
            in Pa/m and velocity in m/s.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Pick pipe size keeping pressure drop near target Pa/m and velocity below noise limit
            </li>
        ...
        >
          <p>
            ...
            0.0015mm) carrying water at 2 m/s. Re = 100,000. Moody diagram gives f ≈ 0.018. Find
            head loss.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>hf = f × (L/D) × v²/(2g) = 0.018 × (50/0.05) × 2²/(2×9.81)</li>
            <li>
              hf = 0.018 × 1000 × 0.204 = <strong>3.67 m head</strong>
            </li>
            <li>
              ΔP = ρg × hf = 1000 × 9.81 × 3.67 ≈ <strong>36 kPa</strong>
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              h = K × v²/(2g) = 0.75 × 2²/(2 × 10) = 0.75 × 0.2 = <strong>0.15 m</strong>
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Total loss = 65 × 200 = 13,000 Pa = <strong>13 kPa</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Wrong friction factor</strong> — Use 64/Re only for laminar; Moody for
                turbulent
              </li>
              <li>
                <strong>Wrong fluid properties</strong> — Use viscosity at actual operating
                temperature
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You need to size the LTHW flow-and-return between a plant room and an AHU heating coil
              60 m away. Coil duty 80 kW, design ΔT 20 K (water in 80, out 60). Two 90° bends, four
              flanged isolation valves, one strainer, the AHU control valve.
            </>
          }
          whatToDo={
            <>
              Calculate flow rate: Q = P/(ρcΔT) = 80,000/(970 × 4,180 × 20) ≈ 0.99 L/s. From CIBSE
              Guide C, pick DN50 steel: velocity ≈ 0.5 m/s (within range), friction loss ≈ 0.06
              kPa/m × 60 m = 3.6 kPa straight pipe. Add minor losses: bends K=0.5, valves K=0.2
              each, strainer K=2, control valve sized for ~50% authority. Sum ≈ 8 kPa. Total pipe
              head ≈ 11.6 kPa flow-and-return. Document in the pump-head calculation, add to AHU
              coil pressure drop and other circuit elements.
            </>
          }
          whyItMatters={
            <>
              Under-sized pipework forces a bigger pump, more energy, more noise, more cost over 25
              years. Over-sized pipework wastes capital and slows transient response. The Darcy
              calculation gives the defendable middle ground.
            </>
          }
        />
