      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Darcy-Weisbach:</strong> h<sub>f</sub> = f(L/D)(v²/2g)
              </li>
              <li className="pl-1">
                <strong>Moody diagram:</strong> f from Re and ε/D
              </li>
              <li className="pl-1">
                <strong>Minor losses:</strong> h = Kv²/2g for fittings
              </li>
              <li className="pl-1">
                <strong>CIBSE tables:</strong> Pa/m for quick sizing
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Design rate:</strong> 250-350 Pa/m typical
              </li>
              <li className="pl-1">
                <strong>Index circuit:</strong> Highest resistance path
              </li>
              <li className="pl-1">
                <strong>Fittings:</strong> Often dominate total losses
              </li>
              <li className="pl-1">
                <strong>Noise limit:</strong> Max 2-3 m/s velocity
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The Darcy-Weisbach equation is the fundamental relationship for calculating friction
              head loss in pipes. It applies to both laminar and turbulent flow.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Pressure form:</strong> ΔP = f × (L/D) × (ρv²/2) Pa
                </li>
                <li className="pl-1">
                  <strong>Pressure rate:</strong> ΔP/L = f × (ρv²/2D) Pa/m
                </li>
                <li className="pl-1">
                  Convert head to pressure: ΔP = ρg × h<sub>f</sub>
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Head loss is proportional to v² - doubling velocity
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The Moody diagram graphically relates friction factor to Reynolds number and relative
              roughness. It's the standard tool for determining friction factors in turbulent pipe
              flow.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Absolute Roughness Values (ε)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">
                    <strong>Laminar:</strong> Single line, f = 64/Re
                  </li>
                  <li className="pl-1">
                    <strong>Transition:</strong> Re 2300-4000 (avoid)
                  </li>
                  <li className="pl-1">
                    <strong>Smooth turbulent:</strong> Curves converge
                  </li>
                  <li className="pl-1">
                    <strong>Rough turbulent:</strong> Horizontal lines
                  </li>
                </ul>
              </div>
              <div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Practical tip:</strong> For building services with typical pipe sizes and
              velocities, f is usually in the range 0.02-0.04.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Fittings, valves, and changes in section cause additional pressure losses beyond pipe
              friction. These are called 'minor' losses but often dominate in building services with
              many fittings.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Convert K to equivalent length: L<sub>e</sub> = K × D / f
                </li>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Design note:</strong> For initial estimates, add 30-50% to straight pipe
              length to account for fittings. Refine in detailed design.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              CIBSE provides pre-calculated pipe sizing tables that simplify design. These tables
              give pressure drop rates and velocities for standard pipe sizes and flow rates.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Using CIBSE Pipe Sizing Tables
              </p>
              <ol className="text-sm text-white space-y-1.5 list-decimal list-outside ml-5">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Recommended Pressure Drop Rates
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Index Circuit Calculation
              </p>
              <p className="text-sm mb-2">
                The index circuit is the flow path with highest total pressure drop. Pump selection
                is based on this circuit.
              </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Maximum velocity limits (noise control):
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Occupied spaces:</strong> 1.5 m/s maximum
                </li>
                <li className="pl-1">
                  <strong>Service corridors:</strong> 2.0 m/s maximum
                </li>
                <li className="pl-1">
                  <strong>Plant rooms:</strong> 3.0 m/s maximum
                </li>
                <li className="pl-1">
                  <strong>Pump suction:</strong> 1.5 m/s maximum (cavitation)
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Darcy-Weisbach Calculation
              </h3>
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  h<sub>f</sub> = 0.025 × (30/0.05) × (2²/(2×9.81))
                </p>
                <p>
                  h<sub>f</sub> = 0.025 × 600 × 0.204 = <strong>3.06 m</strong>
                </p>
                <p className="mt-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  h = 14 × 0.115 = <strong>1.6 m</strong>
                </p>
                <p className="mt-2">
                  ΔP = 1000 × 9.81 × 1.6 = <strong>15.7 kPa</strong>
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Index Circuit Sizing
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  Total = 31.5 + 20 + 10 = <strong>61.5 kPa</strong>
                </p>
                <p className="mt-2">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>h = Kv²/2g</strong> — Minor loss
                </li>
                <li className="pl-1">
                  <strong>ε/D</strong> — Relative roughness
                </li>
                <li className="pl-1">
                  <strong>f = 64/Re</strong> — Laminar friction factor
                </li>
                <li className="pl-1">
                  <strong>ΔP = ρgh</strong> — Head to pressure conversion
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Typical f for turbulent: <strong>0.02-0.04</strong>
                </li>
                <li className="pl-1">
                  CIBSE design rate: <strong>250-350 Pa/m</strong>
                </li>
                <li className="pl-1">
                  Max velocity (occupied): <strong>1.5 m/s</strong>
                </li>
                <li className="pl-1">
                  Globe valve K: <strong>6-10</strong>
                </li>
                <li className="pl-1">
                  90° elbow K: <strong>0.75</strong>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Ignoring fittings:</strong> Can equal or exceed pipe losses
                </li>
                <li className="pl-1">
                  <strong>Wrong diameter:</strong> Use internal, not nominal diameter
                </li>
                <li className="pl-1">
                  <strong>Temperature effects:</strong> Viscosity affects friction factor
                </li>
                <li className="pl-1">
                  <strong>Forgetting return:</strong> Index circuit is flow AND return
                </li>
              </ul>
            </div>
          </div>
