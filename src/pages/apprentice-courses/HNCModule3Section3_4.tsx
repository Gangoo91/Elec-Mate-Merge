      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Sinusoidal:</strong> Pure sine waves at 50 Hz fundamental
              </li>
              <li className="pl-1">
                <strong>Non-sinusoidal:</strong> Square, triangular, sawtooth waves
              </li>
              <li className="pl-1">
                <strong>Distorted:</strong> Fundamental plus harmonic components
              </li>
              <li className="pl-1">
                <strong>THD:</strong> Total Harmonic Distortion measurement
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Non-linear loads:</strong> VSDs, LEDs, SMPS, UPS
              </li>
              <li className="pl-1">
                <strong>Neutral sizing:</strong> Triplen harmonics require oversizing
              </li>
              <li className="pl-1">
                <strong>Standards:</strong> IEEE 519, IEC 61000, G5/5
              </li>
              <li className="pl-1">
                <strong>Mitigation:</strong> Filters, K-rated transformers
              </li>
            </ul>
          </div>
        </div>
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Peak voltage (V<sub>pk</sub>)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        V<sub>rms</sub> x 1.414
                      </td>
                      <td className="border border-white/10 px-3 py-2">325V</td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Peak-to-peak (V<sub>pp</sub>)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        2 x V<sub>pk</sub>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        V<sub>pk</sub> x 0.637
                      </td>
                      <td className="border border-white/10 px-3 py-2">207V</td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        RMS value (V<sub>rms</sub>)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        V<sub>pk</sub> x 0.707
                      </td>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <div className="bg-white/5 p-3 rounded text-sm font-mono">
                  <p>
                    v(t) = (4V<sub>pk</sub>/pi) x [sin(omega t) +{' '}
                  </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              high-frequency harmonic content. Square waves have the sharpest edges, hence the
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="text-center font-mono mb-3">
                <p className="text-elec-yellow">
                  f(t) = a<sub>0</sub> + Sum[a<sub>n</sub>cos(n omega t) + b<sub>n</sub>sin(n omega
                  t)]
                </p>
              </div>
              <div className="grid sm:grid-cols-3 gap-3 text-xs text-white">
                ...
                <div>
                  <strong>n = 1</strong> = Fundamental (50 Hz)
                </div>
                <div>
                  <strong>n = 2, 3, 4...</strong> = Harmonics
                </div>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Harmonic Orders and Frequencies (50 Hz System)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Harmonic sequence pattern (in a balanced three-phase system):
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Negative sequence</strong> (2, 5, 8, 11...): n = 3k + 2 - rotates opposite
                  to fundamental
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="text-center font-mono mb-3">
                <p className="text-elec-yellow text-lg">
                  THD = sqrt(V<sub>2</sub>
                  <sup>2</sup> + V<sub>3</sub>
                  <sup>2</sup> + V<sub>4</sub>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>6-pulse drives</strong> produce harmonics of order 6n +/- 1 (5th, 7th,
                  11th, 13th...)
                </li>
                <li className="pl-1">
                  <strong>12-pulse drives</strong> eliminate 5th and 7th harmonics using
                ...
                <li className="pl-1">
                  <strong>Active front-end (AFE)</strong> drives have near-sinusoidal input current
                  (THD less than 5%)
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white mb-3">
                While energy-efficient, LED drivers are single-phase non-linear loads with high 3rd
                harmonic content:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              phase currents cancel. However, triplen harmonics (3rd, 9th, 15th...) are
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                With significant 3rd harmonic content, the neutral current can exceed the phase
                current by up to 1.73 times (square root of 3). This can cause neutral conductor
                overheating in installations designed with reduced neutral sizes.
              </p>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                BS 7671 Requirements for Neutral Sizing
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Same as phase (can reduce in some cases)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Neutral sized for I<sub>N</sub> (may exceed phase)
                      </td>
                    ...
                    <tr className="bg-red-500/10">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Neutral sized 1.45-2 times phase
                      </td>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Equipment emission limits (less than 16A)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Equipment emission limits (16-75A)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Compatibility levels (industrial)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Planning limits for UK networks
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        DNO connection agreements
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                IEC 61000-3-2 Equipment Classes
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Class A:</strong> Balanced three-phase and other equipment not in B, C, or
                  D
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Class D:</strong> Equipment with 'special waveshape' (PCs, monitors with
                  power 75-600W)
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Modern commercial and industrial buildings require proactive harmonic management due
              to the prevalence of non-linear loads. This section covers practical assessment and
              mitigation strategies for building services engineers.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                When to Conduct Harmonic Assessment
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">VSD capacity exceeds 30% of transformer rating</li>
                <li className="pl-1">
                  Large LED lighting retrofit (greater than 50% of lighting load)
                </li>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: THD Calculation
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> A current waveform has the following harmonic content: I
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                <p>
                  ...
                  <sup>2</sup> + I<sub>7</sub>
                  <sup>2</sup>) / I<sub>1</sub> x 100%
                </p>
                <p className="mt-2">
                  THD = sqrt(40<sup>2</sup> + 20<sup>2</sup> + 14<sup>2</sup>) / 100 x 100%
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Neutral Current Assessment
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2">
                  Total phase RMS = sqrt(20<sup>2</sup> + 7<sup>2</sup>) = 21.2A
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: VSD Harmonic Assessment
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 4: Waveform RMS Calculation
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                <p>
                  ...
                  <sup>2</sup> + V<sub>7</sub>
                  <sup>2</sup>)
                </p>
                <p className="mt-2">
                  V<sub>rms</sub> = sqrt(230<sup>2</sup> + 15<sup>2</sup> + 10<sup>2</sup>)
                </p>
                <p>
                  V<sub>rms</sub> = sqrt(52900 + 225 + 100)
                </p>
                <p>
                  V<sub>rms</sub> = sqrt(53225) = <strong>230.7V</strong>
                </p>
                <p className="mt-2">
                  THD<sub>V</sub> = sqrt(15<sup>2</sup> + 10<sup>2</sup>) / 230 x 100% = 7.8%
                </p>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>
                    V<sub>pk</sub> = V<sub>rms</sub> x 1.414
                  </strong>{' '}
                  - Peak from RMS
                </li>
                <li className="pl-1">
                  <strong>
                    THD = sqrt(sum of V<sub>n</sub>
                    <sup>2</sup>) / V<sub>1</sub>
                  </strong>{' '}
                  - Total harmonic distortion
                </li>
                <li className="pl-1">
                  <strong>
                    I<sub>N</sub> = 3 x I<sub>3</sub>
                  </strong>{' '}
                  - Neutral current from 3rd harmonic
                </li>
                <li className="pl-1">
                  <strong>
                    f<sub>n</sub> = n x f<sub>1</sub>
                  </strong>{' '}
                  - Harmonic frequency
                </li>
                <li className="pl-1">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  THD<sub>V</sub> limit (LV, G5/5): <strong>5%</strong>
                </li>
                <li className="pl-1">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Undersizing neutrals</strong> - Always consider triplen harmonics in
                  LED/IT circuits
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Assuming compliance</strong> - Individual compliant equipment can
                  aggregate to exceed limits
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs text-white">
              <div>
                ...
                <ul className="space-y-0.5">
                  ...
                  <li>
                    Triangular - Odd harmonics, 1/n<sup>2</sup>
                  </li>
