...
const quickCheckQuestions = [
  {
    ...
    options: ['100 Hz', '60 Hz', '25 Hz', '50 Hz'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['2nd, 4th, 6th', '3rd, 9th, 15th', 'All odd harmonics', '5th, 7th, 11th, 13th'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Sawtooth wave', 'Square wave', 'Triangular wave', 'Pure sinusoid'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['IEEE 1547', 'IEEE 519', 'IEEE 446', 'IEEE 1159'],
    correctAnswer: 1,
    explanation:
...
const HNCModule3Section3_4 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 3 · Subsection 4"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS 7671 524.2 plus Appendix 4 Section 5.5 is the controlling reg for neutral sizing on
              harmonic-rich circuits. As the BSE designer of any modern lighting or IT distribution
              board, you must apply the rating factors in Appendix 4 Table 4Aa for triplen content
              above 33 % &mdash; in dense LED or data-centre circuits the neutral may need to be
              sized 1.45&times; or 2&times; the phase conductor.
            </>
          }
        ...
        <ConceptBlock title="Pure Sinusoidal Waveforms">
          <p>
            ...
            frequency with no harmonic content. The UK mains supply is designed to be sinusoidal at
            50 Hz, though in practice some distortion is always present.
          </p>
          <p>
        ...
        <ConceptBlock title="Square, Triangular, and Sawtooth Waveforms">
          <p>
            Non-sinusoidal waveforms are common in electronic circuits, control systems, and as the
            current waveforms drawn by many modern loads. Each type has a characteristic harmonic
            content that can be analysed using Fourier series.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Square wave — Harmonics: Odd only (1, 3, 5, 7...); Amplitude decay 1/n; THD 48.3%
            </li>
            <li>
              Triangular wave — Harmonics: Odd only (1, 3, 5, 7...); Amplitude decay 1/n²; THD 12.1%
            </li>
            <li>
              Sawtooth wave — Harmonics: All (1, 2, 3, 4, 5...); Amplitude decay 1/n; THD 80.3%
            </li>
            <li>
              Half-wave rectified — Harmonics: DC + all harmonics; Amplitude decay Complex; THD 121%
            </li>
            <li>
              Full-wave rectified — Harmonics: DC + even harmonics; Amplitude decay Complex; THD
              48.3%
            </li>
          </ul>
          <p>
            <strong>Square Wave Fourier Series:</strong> v(t) = (4Vpk/pi) x [sin(omega t) + sin(3
            omega t)/3 + sin(5 omega t)/5 + ...]. Contains only odd harmonics, amplitudes decrease
            as 1/n.
          </p>
          ...
          <p>
            <strong>Key insight:</strong> The faster the rate of change (sharper edges), the more
            high-frequency harmonic content. Square waves have the sharpest edges, hence the highest
            harmonic content.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Complex Waveforms and Fourier Analysis">
          ...
          <p>
            ...
            bₙsin(n omega t)]. Where a₀ = DC component (average value); n = 1 = Fundamental (50 Hz);
            n = 2, 3, 4... = Harmonics.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Positive sequence</strong> (1, 4, 7, 10...): n = 3k + 1 - rotates same
              direction as fundamental
            </li>
            <li>
              <strong>Negative sequence</strong> (2, 5, 8, 11...): n = 3k + 2 - rotates opposite to
              fundamental
            </li>
            <li>
              <strong>Zero sequence</strong> (3, 6, 9, 12...): n = 3k - does not rotate, adds in
              neutral (triplen harmonics)
            </li>
          </ul>
          <p>
            <strong>Practical note:</strong> Power quality analysers perform Fast Fourier Transform
            (FFT) to decompose measured waveforms into their harmonic components for analysis.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Total Harmonic Distortion (THD)">
          ...
          <p>
            <strong>THD Calculation:</strong> THD = sqrt(V₂² + V₃² + V₄² + ...) / V₁ x 100%. Where
            V₁ = fundamental RMS, V₂, V₃, etc. = harmonic RMS values.
          </p>
          <p>
          ...
          <p>
            ...
            THD-F (relative to full RMS) gives lower values for the same waveform - ensure you know
            which is being used.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Sources of Waveform Distortion in Building Services">
          ...
          <p>
            <strong>Variable Speed Drives (VSDs):</strong> VSDs are increasingly common for HVAC
            control but are significant harmonic sources:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>6-pulse drives</strong> produce harmonics of order 6n +/- 1 (5th, 7th, 11th,
              13th...)
            </li>
            <li>
              <strong>12-pulse drives</strong> eliminate 5th and 7th harmonics using phase-shifted
              transformers
            </li>
            <li>
              <strong>18-pulse drives</strong> further reduce harmonics but at higher cost
            </li>
            <li>
              <strong>Active front-end (AFE)</strong> drives have near-sinusoidal input current (THD
              less than 5%)
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Effects on Neutral Conductor Sizing">
          ...
          <p>
            <strong>Neutral Current Calculation:</strong> Iₙ = 3 x I₃ (for 3rd harmonic only). For
            balanced loads with only 3rd harmonic content. If each phase carries 10A of fundamental
            and 5A of 3rd harmonic:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              0-15% 3rd harmonic — Same as phase (can reduce in some cases) — Mixed loads, resistive
            </li>
            <li>15-33% 3rd harmonic — Same as phase conductor — General office</li>
            <li>
              33-45% 3rd harmonic — Neutral sized for Iₙ (may exceed phase) — Dense LED/IT loads
            </li>
            <li>
              Greater than 45% 3rd harmonic — Neutral sized 1.45-2 times phase — Data centres, large
              LED
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Oversize neutral:</strong> Specify neutral equal to or larger than phase
              conductors
            </li>
            <li>
              <strong>Separate neutrals:</strong> Consider individual neutrals per phase for
              distribution boards
            </li>
            <li>
              <strong>Zig-zag transformer:</strong> Provides low-impedance path for triplen
              harmonics
            </li>
            <li>
              <strong>Active filters:</strong> Inject compensating current to cancel harmonics
            </li>
            <li>
              <strong>K-rated transformers:</strong> Designed to handle non-linear loads
            </li>
          </ul>
          <p>
            <strong>Important:</strong> BS 7671 Appendix 4 provides specific guidance on rating
            factors for harmonic currents. Always assess harmonic content when designing circuits
            for LED lighting or IT equipment.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="IEEE and IEC Harmonic Standards">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              IEC 61000-3-2 — Equipment emission limits (less than 16A) — Small appliances, LEDs
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Class A:</strong> Balanced three-phase and other equipment not in B, C, or D
            </li>
            <li>
              <strong>Class B:</strong> Portable tools (higher limits than Class A)
            </li>
            <li>
              <strong>Class C:</strong> Lighting equipment (limits as % of fundamental)
            </li>
            <li>
              <strong>Class D:</strong> Equipment with 'special waveshape' (PCs, monitors with power
              75-600W)
            </li>
          </ul>
          <p>
            <strong>UK context:</strong> Engineering Recommendation G5/5 sets planning limits for
            harmonic voltage distortion in UK distribution networks. DNOs may require harmonic
            studies for large non-linear loads.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Services: Harmonic Assessment and Mitigation">
          <p>
            ...
            the prevalence of non-linear loads. This section covers practical assessment and
            mitigation strategies for building services engineers.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Phase-shifting transformer — Multiple similar loads — Cancels specific harmonics
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              THD = sqrt(2196) / 100 x 100% = 46.86 / 100 x 100% = <strong>46.9%</strong>
            </li>
            <li>This is high THD typical of a single-phase SMPS load</li>
          </ul>
          <p>
            <strong>Example 2: Neutral Current Assessment.</strong> A three-phase balanced lighting
            circuit has 20A per phase with 35% third harmonic content. Calculate the neutral
            current.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              3rd harmonic neutral current = 3 x 7A = <strong>21A</strong>
            </li>
            <li>Total phase RMS = sqrt(20² + 7²) = 21.2A</li>
            <li>
              Neutral carries 21A while phases only carry 21.2A — Neutral should be sized same as or
              larger than phases
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              VSD proportion = 180kW / (500kVA x 0.8 pf) x 100% = 180 / 400 x 100% ={' '}
              <strong>45%</strong>
            </li>
            <li>This exceeds the 30% guideline threshold</li>
            <li>
              Recommendation: Specify either Active harmonic filters at main LV panel; Low-harmonic
              VSD variants (AFE or with filters); or 12-pulse drives for larger motors
            </li>
          </ul>
          <p>
            <strong>Example 4: Waveform RMS Calculation.</strong> A voltage waveform has V₁ = 230V,
            V₅ = 15V, V₇ = 10V. What is the true RMS voltage?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Vrms = sqrt(V₁² + V₅² + V₇²) = sqrt(230² + 15² + 10²)</li>
            <li>
              Vrms = sqrt(52900 + 225 + 100) = sqrt(53225) = <strong>230.7V</strong>
            </li>
            <li>
              THDᵥ = sqrt(15² + 10²) / 230 x 100% = 7.8% — This exceeds the 5% limit - investigation
              needed
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Vpk = Vrms x 1.414</strong> - Peak from RMS
            </li>
            <li>
              <strong>THD = sqrt(sum of Vₙ²) / V₁</strong> - Total harmonic distortion
            </li>
            <li>
              <strong>Iₙ = 3 x I₃</strong> - Neutral current from 3rd harmonic
            </li>
            <li>
              <strong>fₙ = n x f₁</strong> - Harmonic frequency
            </li>
            <li>
              <strong>Form factor = 1.11</strong> - For pure sinusoid
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              UK fundamental frequency: <strong>50 Hz</strong>
            </li>
            <li>
              3rd harmonic frequency: <strong>150 Hz</strong>
            </li>
            <li>
              THDᵥ limit (LV, G5/5): <strong>5%</strong>
            </li>
            <li>
              VSD threshold for mitigation: <strong>30% of transformer</strong>
            </li>
            <li>
              Maximum neutral current factor: <strong>1.73 x phase</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Undersizing neutrals</strong> - Always consider triplen harmonics in LED/IT
                circuits
              </li>
              <li>
                <strong>Using average-reading meters</strong> - Only true-RMS meters give correct
                readings for distorted waveforms
              </li>
              <li>
                <strong>Ignoring harmonic resonance</strong> - PFC capacitors can resonate with
                system inductance at harmonic frequencies
              </li>
              <li>
                <strong>Assuming compliance</strong> - Individual compliant equipment can aggregate
                to exceed limits
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              distribution boards, designed for incandescent and T8 fluorescent loads. After a full
              LED retrofit the FM team reports neutral overheating at one board, with the busbar
              test showing 32 A neutral against 28 A average phase current. Power-quality analyser
              shows 38 % third harmonic and 18 % fifth on each phase.
            </>
          }
          whatToDo={
            <>
              Apply BS 7671 Appendix 4 Table 4Aa: with 38 % third harmonic, the neutral rating
              factor is 0.86 of the phase conductor capacity, but the actual neutral current = 3
              &times; (28 &times; 0.38) = 32 A &mdash; above the phase RMS. Either (a) replace the
              SWA with a cable having an equal-or-larger neutral, (b) split the lighting across two
              boards to halve the harmonic concentration, or (c) install a zig-zag transformer or
              active filter at the board to suppress triplen content. Document the solution against
              G5/5 limits.
            </>
          }
          whyItMatters={
            <>
              Neutral overheating is invisible until the cable insulation degrades and fails — at
              which point you have a fire risk in a concealed riser. Modern LED retrofits in older
              buildings routinely surface this problem. Failing to act breaches BS 7671 132.6
              (mutual detrimental influence) and Reg 524.2 (neutral sizing).
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Harmonics</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
