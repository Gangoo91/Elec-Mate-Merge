...
const quickCheckQuestions = [
  {
    ...
    options: ['3rd, 9th, 15th', '2nd, 4th, 6th', '5th, 7th, 11th', '1st, 2nd, 3rd'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['G5/4-1', 'EN 50160', 'BS 7671', 'IEC 61000-3-2'],
    correctAnswer: 0,
    explanation:
...
const HNCModule3Section4_7 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 4 · Subsection 7"
        title="Harmonics and Power Quality Issues"
        backTo="/study-centre/apprentice/h-n-c-module3-section4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Harmonic distortion sources, effects on three-phase systems, and mitigation techniques for
          building services
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The 2026 amendment expanded the harmonic-rating-factor table in Appendix 4 &sect;5.5.
              As BSE designer of any modern three-phase distribution serving LED lighting, IT load
              or EV charging, you must apply the relevant factor (e.g. 0.86 above 33 %, dropping
              further for higher triplen content) and choose between cable upsize, parallel
              neutrals, or active filtering. This is the regulatory anchor for the whole section.
            </>
          }
        ...
        <ConceptBlock title="What Are Harmonics?">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Even harmonics (2nd, 4th, 6th...): Rare, indicate asymmetrical waveforms</li>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Note:</strong> THD(I) is Total Harmonic Distortion of current. Values above 100%
            indicate harmonic content exceeds fundamental current magnitude.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Three-Phase Harmonic Patterns and Sequences">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Positive:</strong> 1st, 4th, 7th, 10th, 13th... — rotation same as fundamental
              — motor heating, torque ripple
            </li>
            <li>
            ...
            <li>
              <strong>Zero (Triplen):</strong> 3rd, 6th, 9th, 12th, 15th... — no rotation (in phase)
              — sum in neutral, transformer heating
            </li>
          </ul>
        ...
        <ConceptBlock title="Triplen Harmonics in Neutral Conductors">
          ...
          <p className="text-sm font-medium text-white">
            Why triplen harmonics sum in the neutral:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Fundamental currents are 120° apart and sum to zero in a balanced system</li>
            <li>3rd harmonic: Each phase current is at 3 × 120° = 360° = 0° - all in phase</li>
          ...
          <p>
            ...
            lighting), the neutral current can be 1.5 to 1.7 times the phase current due to triplen
            harmonic summation. Standard neutral sizing (equal to phase) is inadequate.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
        ...
        <ConceptBlock title="Harmonic Heating Effects on Cables and Transformers">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Skin effect:</strong> Higher frequencies force current to conductor surface,
              increasing effective resistance
            </li>
            <li>
              <strong>Proximity effect:</strong> Adjacent conductors create additional eddy current
              losses
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            Calculating Harmonic RMS Current
          </p>
          <p>
          ...
          <p className="text-sm text-white italic">
            ...
            supplying non-linear loads. A transformer with 30% current THD may need to be derated to
            70-80% of nameplate capacity to prevent overheating.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Power Quality Standards (EN 50160, G5/4-1)">
          ...
          <p>Defines voltage quality at the point of supply to customers. For harmonics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Stage 2: Harmonic current allocation based on agreed supply capacity</li>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Practical application:</strong> Any installation with VSDs totalling &gt;25% of
            supply capacity, or single VSD &gt;12.5% of supply, triggers G5/4-1 Stage 2 assessment.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Active and Passive Harmonic Filters">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Multi-pulse rectifiers:</strong> 12-pulse, 18-pulse, or 24-pulse VSDs cancel
            ...
            <li>
              <strong>Phase shifting transformers:</strong> Cancel harmonics between multiple drives
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="K-Factor Transformers">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            K-Factor Ratings and Applications
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>K-20:</strong> Broadcast, severe industrial — SCR drives, very high harmonic
              content
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Electrostatic shields:</strong> Reduce capacitive coupling of high-frequency
              noise
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Building Services: Data Centres and VSD Installations">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>IT load profile:</strong> SMPS draw current in narrow peaks, 70-120% current
              THD typical
            </li>
            <li>
            ...
            <li>
              <strong>Transformer selection:</strong> K-13 minimum, consider K-20 for high-density
              facilities
            </li>
            <li>
            ...
            <li>
              <strong>Cable sizing:</strong> Additional derating for harmonic heating and oversized
              neutrals
            </li>
          </ul>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            VSD Harmonic Mitigation Comparison
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Active front-end (AFE):</strong> &lt;5% THD(I) — typical cost premium 50-80%
            </li>
          </ul>
          <p className="text-sm text-white italic">
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            ...
            50A, 3rd harmonic 30A, 5th harmonic 25A, 7th harmonic 10A. Calculate the THD(I) and RMS
            current.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              THD(I) = √(I<sub>3</sub>² + I<sub>5</sub>² + I<sub>7</sub>²) / I<sub>1</sub> × 100%
            </li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Example 3: K-Factor Calculation</p>
          <p>
            <strong>Question:</strong> Calculate the K-factor for a load with the following harmonic
            current spectrum (per unit of fundamental): I1=1.0, I3=0.8, I5=0.6, I7=0.4, I9=0.2.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              K = Σ(I<sub>h</sub>² × h²) / Σ(I<sub>h</sub>²)
            </li>
            <li>Numerator: (1×1) + (0.8²×9) + (0.6²×25) + (0.4²×49) + (0.2²×81)</li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              present. Using average-reading meters that under-read distorted currents. Adding bare
              PFC capacitors with VSDs — they resonate and amplify harmonics. Specifying standard
              transformers for IT-heavy or VSD-heavy loads. Underestimating cable heating (skin
              effect plus higher RMS).
            </>
          }
          doInstead={
            <>
              Use Table 5.4a / 200% neutrals for triplen-rich loads. Use true-RMS meters and
              power-quality analysers. Add detuned reactors (typically 7% or 14%) to PFC banks where
              VSDs are present. Specify K-rated transformers (K-9 office, K-13 data centre). Apply
              derating factors for both increased RMS current and skin effect.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A new tier-III data centre has 1500 kVA of computing load via dual-feed UPS systems
              plus 200 kVA of cooling (CRAC units with EC fans). Vendor power-quality estimate: THDi
              35&ndash;45 % at the UPS input, falling to ~10 % through the UPS double-conversion.
              You must specify the upstream LV transformer.
            </>
          }
          whatToDo={
            <>
              Specify a K-13 (or K-20 for headroom) cast-resin or oil-filled transformer rated 2000
              kVA. Reasoning: K-13 handles the eddy/stray heating from THDi up to ~50 %, with 12 %
              over-rating for harmonic-derived losses. Provide a separately-derived neutral (a star
              secondary with its own substantial neutral), and consider a zig-zag transformer at the
              LV panel if triplen content exceeds 33 % at any board. Document G5/5 compliance at the
              PCC with the DNO connection application.
            </>
          }
          whyItMatters={
            <>
              A standard K-1 transformer of the same nameplate kVA would overheat within 6&ndash;12
              months of energising a data-centre load profile, with accelerated insulation breakdown
              and eventual failure. The cost of upgrading post-energisation includes site shutdown
              of the entire IT workload &mdash; six-figure consequence for a five-figure transformer
              spec error. K-rating is the defining transformer decision on every BSE data-centre
              project.
            </>
          }
        />
