      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Odd harmonics (3rd, 5th, 7th...): Most prevalent from non-linear loads
                </li>
                <li className="pl-1">
                  Even harmonics (2nd, 4th, 6th...): Rare, indicate asymmetrical waveforms
                </li>
                <li className="pl-1">
                  Inter-harmonics: Non-integer multiples, caused by cycloconverters
                </li>
              </ul>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-2">
                The sequence of harmonic h can be determined by:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  h = 3n + 1 (where n = 0,1,2,3...): <strong>Positive sequence</strong> (1, 4, 7,
                  10, 13...)
                </li>
                <li className="pl-1">
                  h = 3n + 2 (where n = 0,1,2,3...): <strong>Negative sequence</strong> (2, 5, 8,
                  11, 14...)
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Being in phase, they add rather than cancel: IN(3rd) = 3 × Iph(3rd)
                </li>
                <li className="pl-1">
                  Neutral current can exceed phase current even with balanced loads
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    <strong>Neutral heating:</strong> Triplen harmonics cause unexpected neutral
                    heating
                  </li>
                  <li className="pl-1">
                    <strong>Dielectric losses:</strong> Higher frequencies increase insulation
                    losses
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              ...
              <p className="text-sm text-white mb-2">
                Engineering Recommendation G5/4-1 sets planning levels for harmonic voltage
                distortion and requires assessment of customer installations that may cause network
                harmonic issues.
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Stage 3: Detailed assessment for large or complex installations
                </li>
                <li className="pl-1">
                  DNO approval required for installations exceeding Stage 1 limits
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-3 rounded bg-white/5">
                  ...
                  <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                    ...
                    <li className="pl-1">
                      Assess voltage distortion at PCC using network impedance
                    </li>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Network impedance at each harmonic
                      </td>
                    </tr>
                    <tr>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  LC circuits tuned to specific harmonic frequencies:
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  Power electronic devices injecting anti-phase currents:
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Predictable spectrum, cost-effective
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Variable loads, wide harmonic spectrum
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Base filtering with adaptive trim
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Diverse loads, changing tenants
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Resistive heating, incandescent lighting
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Mixed loads, some electronic equipment
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Significant IT load, LED lighting
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        High-density IT, medical equipment
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">K-20</td>
                      <td className="border border-white/10 px-3 py-2">
                        Broadcast, severe industrial
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        SCR drives, very high harmonic content
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                K-factor transformer design features:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Generator sizing:</strong> Alternator must handle harmonic currents
                  without overheating
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>G5/4-1 assessment:</strong> Usually required for VSD load &gt;25% of
                  supply capacity
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Capacitor protection:</strong> PFC capacitors require detuning reactors
                  when VSDs present
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: THD Calculation
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> A non-linear load draws the following currents:
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Equal neutral sizing:</strong> Triplen harmonics require oversized
                  neutrals
                </li>
                <li className="pl-1">
                  <strong>Using average-reading meters:</strong> Only true-RMS meters are accurate
                  for harmonics
                </li>
                <li className="pl-1">
                  <strong>Ignoring PFC resonance:</strong> Capacitors can amplify harmonics without
                  detuning
                </li>
                <li className="pl-1">
                  <strong>Standard transformer selection:</strong> K-factor rating essential for
                  non-linear loads
                </li>
                <li className="pl-1">
                  <strong>Underestimating cable heating:</strong> Both increased RMS and skin effect
                  matter
                </li>
              </ul>
            </div>
