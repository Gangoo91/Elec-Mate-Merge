...
const DESCRIPTION =
  'Understanding corrective and preventive actions following root cause analysis, including CAPA systems, hierarchy of corrective measures, verification of effectiveness and continuous improvement for ST1426 maintenance technicians.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'The hierarchy of controls applies to preventive actions just as it does to safety management. Elimination (redesign to remove the failure mode) is most effective. Engineering controls (add protection, improve the specification) are next. Procedural controls (change the maintenance method, improve work instructions) are less reliable because they depend on human compliance. Administrative controls (training, awareness) are the least effective on their own but support the other levels.',
  },
  {
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Procedure updates are Method-category preventive actions. If the root cause analysis identified that the existing procedure was inadequate (missing a critical step, wrong sequence, unclear instruction), updating the procedure addresses this root cause directly. However, procedure-based preventive actions are only effective if the updated procedure is communicated, trained and followed — they depend on human compliance.',
  },
  {
    id: 6,
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              preventive action that addresses the root cause to prevent the same fault from
              recurring. These two types of action are complementary — corrective actions deal with
              the present, preventive actions protect the future.
            </p>
            <p>
              In practice, most maintenance organisations are good at corrective actions (replacing
              failed components, repairing damage) but weaker at preventive actions (changing
              procedures, modifying designs, improving maintenance strategies). This imbalance leads
              to the frustrating cycle of recurring faults — the same equipment fails repeatedly
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              CAPA system, actions get agreed in meetings but never implemented, temporary repairs
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              you are assuming that the action worked, and assumptions are not evidence.
