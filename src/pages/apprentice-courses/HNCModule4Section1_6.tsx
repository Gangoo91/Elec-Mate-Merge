...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Warehouse', 'Air-conditioned office', 'Hospital', 'Data centre'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['60-70%', '10-20%', '30-50%', '80-90%'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['10-20%', '90-100%', '70-80%', '30-50%'],
    correctAnswer: 3,
    explanation:
...
const HNCModule4Section1_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 1 · Subsection 6"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 311.1 requires the designer to base sizing on realistic loading, not absolute
              connected load. Load profiles are the evidence that diversity has been applied
              honestly: peak overlap (HVAC + lighting + small power coincident at 10:00–14:00),
              seasonal extremes (winter heating vs summer cooling), and tariff-driven dispatch
              (battery / demand response). Without a profile, your diversity numbers are guesses.
            </>
          }
        ...
        <ConceptBlock title="HVAC Load Patterns">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>VAV (variable air volume):</strong> varies with zone demand, diversity 0.7-0.8
            </li>
            <li>
        ...
        <ConceptBlock title="Lighting Load Profiles">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Task/ambient:</strong> lower general light, higher task light (10-20% saving)
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 12,000&nbsp;m² mid-rise office is being refurbished. The previous CIBSE benchmark
              (90&nbsp;VA/m²) gives 1,080&nbsp;kVA. The client argues the workforce is 60% hybrid,
              mid-week peak occupancy is 70%, and LED + occupancy controls cut lighting load 50%.
              They want to argue for a 750–800&nbsp;kVA DNO supply instead of 1,080.
            </>
          }
          whatToDo={
            <>
              Build a 24-hour profile per system: HVAC (cooling-led, peaks 12:00–15:00, 60% of
              connected at peak), lighting (occupancy-modulated, 50% of connected at peak), small
              power (40% of connected at peak), lifts (cycle-driven, 50%). Overlay them to find the
              coincident peak. Cross-check against measured half-hourly data from two comparable
              hybrid-pattern offices. Document the profile as the diversity evidence for Reg 311.1.
              Lodge a 800&nbsp;kVA DNO request with the profile as appendix — DNO will challenge the
              numbers, so they have to be defendable.
            </>
          }
          whyItMatters={
            <>
              A 280&nbsp;kVA reduction is a smaller DNO TX, smaller switchgear, smaller cables,
              smaller standby plant — typically £150k–£300k capital saving plus lower DNO connection
              charge and standing charge. But it has to be evidenced — Reg 311.1 makes maximum
              demand determination mandatory, and the DNO will refuse a under-cooked submission.
            </>
          }
        />
