...
const DESCRIPTION =
  'Understand legal requirements for UK electrical contractors. Learn about consumer rights, contracts, data protection, employment law, and regulatory compliance.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The Consumer Rights Act 2015 requires services to be carried out with reasonable care and skill. If no time is agreed, it must be done in a reasonable time. If no price is agreed, the price must be reasonable.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 2,
    explanation:
      'Under the Consumer Contracts Regulations, consumers have a 14-day cooling off period for contracts signed away from business premises (including in their home). They can cancel without giving a reason. Know the rules about when work can start during this period.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 1,
    explanation:
      'GDPR applies to all businesses processing personal data. You must process data fairly and lawfully, keep it secure, only collect what you need, keep it accurate, and not retain it longer than necessary. You also need a lawful basis for processing.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      "Written contracts or terms and conditions protect both parties. They should cover scope of work, payment terms, variations procedure, cancellation, liability limitations, and dispute resolution. They don't need to be complex but should be clear.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The Consumer Rights Act 2015 protects consumers when purchasing services. It requires services to be performed with reasonable care and skill, and gives consumers remedies if work is substandard.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      "The limitation period is the time within which legal action must be brought. For simple contracts it's 6 years from breach. For contracts under deed it's 12 years. This is why you should keep records for at least 6 years.",
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Under consumer protection law, if work is not done with reasonable care and skill, you must put it right. Investigate complaints fairly, and if the work is defective, remedy it. This maintains your reputation and meets legal obligations.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      "A retention of title clause states that materials you supply remain your property until paid for. This protects you if a customer doesn't pay - you can legally reclaim unpaid materials. Include in your terms and conditions.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'CDM applies to all construction work, though some duties only apply to certain project types or sizes. Even domestic work has requirements. Understanding your duties under CDM, especially as a contractor, is essential.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Most businesses that process personal data must register with the ICO and pay a fee. Some exemptions exist for very small businesses processing limited data, but most contractors handling customer data need to register.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      "Vicarious liability means employers can be held responsible for wrongful acts of employees committed during their employment. This is why employers' liability insurance is required, and why proper training and supervision matter.",
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'You can and should refuse work that would breach regulations (BS 7671, Building Regulations), be unsafe, or be illegal. You cannot agree to install non-compliant work even if the customer requests it.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'A valid contract requires: offer and acceptance, consideration (something of value exchanged), intention to create legal relations, and parties with capacity to contract. Contracts can be verbal but written is recommended for clarity.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      "GDPR requires reporting data breaches to the ICO within 72 hours if they're likely to result in risk to individuals. If the breach is high risk, you must also notify affected individuals. Document all breaches even if not reportable.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      'While verbal contracts are legally valid, written contracts or terms and conditions are strongly recommended. They provide clarity for both parties, evidence if disputes arise, and demonstrate professionalism. At minimum, have clear written terms on your quotations.',
  },
  {
    question: "What happens if a customer won't pay?",
    answer:
      "First, send reminders and try to resolve any issues. If unpaid, you can send a formal 'letter before action', then pursue through small claims court (for smaller sums) or county court. You cannot disconnect work you've done or remove installed materials without going through legal processes.",
  },
  {
    question: 'Can I limit my liability in contracts?',
    answer:
      'You can limit liability in contracts, but limitations must be reasonable. You cannot exclude liability for death or personal injury from negligence. Consumer contracts have additional restrictions - unfair terms can be struck out. Get legal advice on your terms.',
  },
  {
    question: 'What employment law applies if I take on staff?',
    answer:
      "Taking on employees brings significant legal obligations: employment contracts, minimum wage, holiday pay, workplace pension (auto-enrolment), employer's liability insurance, health and safety duties, and anti-discrimination laws. Consider getting HR advice when first employing.",
  },
  {
    question: 'Do I need to register for data protection?',
    answer:
      'Most businesses processing personal data need to register with the ICO and pay an annual fee (currently 40-60 GBP for most small businesses). You must also have a privacy policy explaining how you handle data, and processes to keep data secure and respond to data subject requests.',
  },
  {
    question: 'What should I do if a customer threatens legal action?',
    answer:
      "Take it seriously. Review the facts objectively. Try to resolve the issue amicably - most disputes don't need to go to court. If you're at fault, acknowledge and offer remedy. If you believe you're not at fault, document your position. Consider mediation before litigation. Inform your insurance company if relevant.",
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Consumer Rights:</strong> Work must be done with reasonable care and skill
              </li>
              <li>
                <strong>Contracts:</strong> Written terms protect both parties
              </li>
              <li>
                <strong>Data Protection:</strong> GDPR applies to all customer data you hold
              </li>
              <li>
                <strong>Compliance:</strong> Know your regulatory and safety obligations
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Situations requiring legal awareness
              </li>
              <li>
                <strong>Use:</strong> Written contracts and proper procedures
              </li>
              <li>
                <strong>Apply:</strong> Compliance prevents costly problems
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The Consumer Rights Act 2015 is the primary legislation protecting consumers who buy
              services. Understanding your obligations helps you provide compliant service and
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Reasonable care and skill:</strong> Work must be done to the standard
                  expected of a competent tradesperson
                </li>
                <li>
                  <strong>Reasonable time:</strong> If no completion date agreed, work must be done
                  in reasonable time
                </li>
                <li>
                  <strong>Reasonable price:</strong> If no price agreed, the price charged must be
                  reasonable
                </li>
                <li>
                  <strong>Information provided:</strong> Any information you give becomes part of
                  the contract
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> These are minimum legal requirements. Good business
              practice often exceeds legal minimums. Meeting complaints fairly and promptly protects
              your reputation better than arguing about legal minimums.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Every time you agree to do work for payment, you create a contract. While contracts
              don't need to be written to be valid, having clear written terms protects both you and
              your customer.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              to all businesses processing personal data. Customer names, addresses, contact
              details, and any other personal information you hold are covered.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Critical Point:</strong> Personal data includes any information that
              identifies someone: names, addresses, phone numbers, email addresses, and potentially
              photographs of their property. Treat all such data with care.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              When you agree contracts with consumers in their home (or away from your business
              premises), special rules apply. The Consumer Contracts (Information, Cancellation and
              Additional Charges) Regulations 2013 give consumers cooling off rights.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  If work starts during cooling off (with consumer's express consent), consumer may
                  have to pay for work done if they cancel
                </li>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>No written terms</strong> - Verbal agreements are hard to prove
                </li>
                <li>
                  <strong>Ignoring cooling off</strong> - Non-compliance has consequences
                </li>
                <li>
                  <strong>Poor data security</strong> - Customer data must be protected
                </li>
                <li>
                  <strong>Aggressive response to complaints</strong> - Makes things worse, not
                  better
                </li>
              </ul>
            </div>
