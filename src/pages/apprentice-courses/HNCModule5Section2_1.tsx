...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Fixed lump sum', 'Management fee only', 'Cost plus percentage', 'Per trade package'],
    correctIndex: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The procurement route you choose determines which JCT contract (or NEC suite, or
              bespoke) is appropriate. SBC for traditional, DB for design-build, CM/A for
              construction management. Mismatching contract to route creates ambiguity in risk
              allocation that surfaces as disputes at month nine.
            </>
          }
        ...
        <ConceptBlock title="Traditional Procurement (Lump Sum)">
          <p>
            ...
            consultants (architect, structural engineer, M&E consultant) to develop the design, then
            competitively tenders the construction work to contractors who price and build to the
            provided drawings and specification.
          </p>
          <p>
          ...
          <p>
            <strong>
              Risk Allocation in Traditional Procurement (Risk Type — Allocated To — MEP Example):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design adequacy:</strong> Client/consultant — If HVAC undersized, client pays
              to rectify
            </li>
            <li>
        ...
        <ConceptBlock title="Design and Build Procurement">
          ...
          <p>
            <strong>
              Design and Build Variants (Variant — Client Design Input — MEP Implications):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pure D&B:</strong> Output spec only — Contractor designs all MEP from scratch
            </li>
            <li>
              <strong>Develop & construct:</strong> Concept design — Contractor develops from Stage
              2-3 design
            </li>
            <li>
              <strong>Enhanced D&B:</strong> Detailed design + novation — Near-complete design with
              novated team
            </li>
            <li>
              <strong>Contractor's Designed Portion:</strong> Most design by client — Only specified
              elements (often MEP) by contractor
            </li>
          </ul>
          <p>
            <strong>Advantages for MEP:</strong>
        ...
        <ConceptBlock title="Management Contracting and Construction Management">
          ...
          <p>
            ...
            ductwork/pipework clashes, containment routing conflicts, and commissioning sequencing.
          </p>
          <p>
            <strong>Advantages for MEP:</strong>
          </p>
        ...
        <ConceptBlock title="Two-Stage Tendering">
          ...
          <p>
            <strong>Real-World Example — Data Centre Two-Stage:</strong> A 10MW data centre project
            used two-stage tendering to manage technical complexity:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Procurement Route Comparison">
          ...
          <p>
            <strong>Programme speed:</strong> Traditional Slow; D&B Fast; Mgt Routes Fast; Two-Stage
            Fast.
          </p>
          <p>
        ...
        <ConceptBlock title="Selection guidance for MEP projects">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Complex specialist M&E requiring detailed coordination (hospitals, labs)</li>
        ...
        <Scenario
          ...
          situation={
            <>
              A client procures a 12,000 m² office on a JCT DB 2024 contract with employer's
              requirements that say "BREEAM Excellent, MEP design to RIBA Stage 2". You as
              contractor accept and mobilise. At Stage 4 your design develops the BMS strategy in
              detail and the cost rises £400k above tender. The client refuses, citing fixed price;
              you argue the ER was non-compliant with BREEAM Excellent under standard
              interpretation.
            </>
          }
          whatToDo={
            <>
              Document every design decision against the original ER. Where the ER is silent or
              contradicts BREEAM, raise contractor's design submissions (CDP) under the contract.
              Negotiate change control for genuine scope additions; absorb genuine design
              development. Avoid escalation by holding monthly value engineering workshops with
              client and design team. If unresolved, the dispute will turn on the completeness of
              the original ER — written before mobilisation.
            </>
          }
          whyItMatters={
            <>
              Design and build transfers design risk to the contractor — but only as far as the ER
              goes. Vague ERs leave the contractor shouldering scope they did not price. The
              procurement route choice is therefore a design completeness choice — DB is fast only
              when the ER is properly developed.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">JCT contracts</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
