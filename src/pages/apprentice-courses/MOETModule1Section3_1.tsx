      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Hazard:</strong> Anything with the potential to cause harm
              </li>
              <li className="pl-1">
                <strong>Risk:</strong> Likelihood x severity of harm from a hazard
              </li>
              <li className="pl-1">
                <strong>Categories:</strong> Physical, chemical, biological, ergonomic,
                psychological
              </li>
              <li className="pl-1">
                <strong>Method:</strong> Systematic inspection, checklists, observation, reporting
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Electrical hazards:</strong> Exposed conductors, damaged insulation,
                overloading
              </li>
              <li className="pl-1">
                <strong>Environmental:</strong> Water ingress, confined spaces, asbestos
              </li>
              <li className="pl-1">
                <strong>Reporting:</strong> Near-miss systems, toolbox talks, photographic evidence
              </li>
              <li className="pl-1">
                <strong>ST1426:</strong> Maps to health and safety knowledge KSBs
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="p-3 rounded bg-white/5 border border-white/10">
                  ...
                  <p className="text-sm text-white">
                    Anything with the <strong>potential to cause harm</strong>. This includes
                    physical objects, substances, work activities, environmental conditions and
                    human behaviours. A hazard exists regardless of whether anyone is actually
                    exposed to it.
                  </p>
                </div>
                <div className="p-3 rounded bg-white/5 border border-white/10">
                  ...
                  <p className="text-sm text-white">
                    ...
                    <strong> severity</strong> of that harm. Risk is a measure of how dangerous a
                    hazard actually is in the specific circumstances — it depends on who is exposed,
                    for how long, and what controls are in place.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">Risk can be expressed as a simple formula:</p>
              ...
              <p className="text-sm text-white mt-3">
                ...
                identification is to find all the hazards; risk evaluation then determines which
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Everyday Examples for Electrical Maintenance Technicians
              </p>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  Physical hazards are the most common category and include anything in the
                  environment that can cause physical harm without necessarily being touched. They
                  include noise, vibration, extreme temperatures, radiation, slips, trips and falls,
                  moving machinery, and falling objects.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                    <strong>Electrical maintenance examples:</strong> Noise from generators or UPS
                    systems, heat from overloaded cables or transformers, UV radiation from arc
                    welding nearby, trip hazards from trailing cables, falling tools when working at
                    height
                  </li>
                  <li className="pl-1">
                    <strong>Identification method:</strong> Visual inspection, noise level
                    assessment, temperature checks, housekeeping review
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  Chemical hazards arise from exposure to harmful substances — solids, liquids,
                  gases, vapours, fumes or dusts. They can enter the body through inhalation,
                  ingestion, skin absorption or injection. Chemical hazards are controlled under the
                  COSHH Regulations 2002.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                    <strong>Electrical maintenance examples:</strong> Solvents for cleaning
                    contacts, flux fumes from soldering, SF6 gas in HV switchgear, battery acid from
                    UPS systems, cable lubricant, PVC fumes from overheated insulation
                  </li>
                  <li className="pl-1">
                    <strong>Identification method:</strong> COSHH data sheets, product labelling,
                    smell (though this is not always reliable), previous incident records
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  ...
                  organisms that can cause disease or infection. They may be present in water
                  systems, soil, animal droppings, or building materials.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                    ...
                    disease) in cable ducts, mould in damp switchrooms, contaminated water in
                    flooded plant rooms
                  </li>
                  <li className="pl-1">
                    <strong>Identification method:</strong> Visual inspection for animal evidence,
                    water testing records, building condition assessment, damp surveys
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  ...
                  musculoskeletal disorders (MSDs), which are the most common cause of work-related
                  ill health in the UK.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                    <strong>Electrical maintenance examples:</strong> Pulling cables through conduit
                    (repetitive strain), working overhead in ceiling voids (awkward posture),
                    lifting heavy distribution boards (manual handling), using hand tools for
                    extended periods (vibration, grip fatigue), working in cramped switchrooms
                  </li>
                  <li className="pl-1">
                    <strong>Identification method:</strong> Task analysis, manual handling
                    assessment, posture observation, worker feedback
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  Psychological hazards affect mental health and wellbeing. They include
                  work-related stress, bullying, harassment, violence, lone working, fatigue, and
                  unrealistic workload or time pressures. These hazards are increasingly recognised
                  as significant contributors to accidents because they impair concentration and
                  decision-making.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                    <strong>Electrical maintenance examples:</strong> Pressure to complete work
                    quickly leading to shortcuts on isolation procedures, lone working in remote
                    substations, fatigue from long shifts or call-outs, verbal aggression from
                    building occupants during shutdowns, anxiety about working on unfamiliar systems
                  </li>
                  <li className="pl-1">
                    <strong>Identification method:</strong> Worker surveys, stress risk assessments,
                    absence records, supervision and one-to-one discussions, observation of
                    behaviour changes
                  </li>
                </ul>
              </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                ...
                For example, replacing a distribution board in an occupied school involves
                electrical hazards (the installation itself), physical hazards (working at height,
                manual handling), chemical hazards (dust, possible asbestos), ergonomic hazards
                (awkward postures, heavy lifting) and psychological hazards (pressure to complete
                during a holiday shutdown). Your hazard identification must consider all categories,
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Rapid release of energy from a fault in an electrical system, particularly
                        at higher voltages and fault levels
                      </td>
                      <td className="border border-white/10 px-3 py-2">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                ...
                can be present on cables running parallel to high-voltage circuits. Never assume a
                circuit is safe based on appearance alone — always prove dead using an approved
                voltage indicator tested immediately before and after use in accordance with GS38.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Visual Indicators of Electrical Hazards
                </h3>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    Flickering lights or intermittent operation indicating loose connections
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Systematic Electrical Hazard Checks
                </h3>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">Check all enclosures are complete and securely fixed</li>
                  <li className="pl-1">
                    Verify warning labels and circuit identification are present and legible
                  </li>
                  ...
                  <li className="pl-1">
                    Check for evidence of overheating — thermal imaging if available
                  </li>
                  <li className="pl-1">
                    Review the condition of protective devices (MCBs, RCDs, fuses)
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              requires employers to make a "suitable and sufficient" assessment of risks, which
              begins with thorough hazard identification.
            </p>
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  Before visiting the work area, gather and review existing documentation. This
                  gives you context and alerts you to hazards that may not be visible during a
                  physical inspection.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                    Previous risk assessments and method statements for similar work
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Stage 2 — Physical Walk-Through
                </h3>
                <p className="text-sm text-white mb-2">
                  Carry out a systematic walk-through of the work area and its immediate
                  surroundings. Use a structured checklist to ensure you cover all hazard
                  categories. Walk the route you will take to and from the work area — access routes
                  can contain hazards too.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                    Start from the site entrance and follow the access route to the work area
                  </li>
                  <li className="pl-1">
                    Inspect the work area itself — look up, down and all around
                  </li>
                  <li className="pl-1">
                    Check adjacent areas that could be affected by or affect your work
                  </li>
                  <li className="pl-1">
                    Identify emergency exits, assembly points and first aid provision
                  </li>
                  <li className="pl-1">Note the activities of other workers nearby</li>
                  <li className="pl-1">
                    Assess lighting, ventilation and environmental conditions
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Stage 3 — Worker Consultation
                </h3>
                <p className="text-sm text-white mb-2">
                  Talk to people who work regularly in the area. They often know about hazards that
                  are not immediately obvious to a visitor — intermittent problems, seasonal
                  conditions, or historical issues that have not been formally recorded.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                    Ask site personnel about known hazards and previous incidents
                  </li>
                  <li className="pl-1">Consult with other contractors working on site</li>
                  <li className="pl-1">
                    Discuss the planned work with the facilities manager or duty holder
                  </li>
                  <li className="pl-1">
                    Review the site induction briefing for site-specific hazards
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                A hazard identification checklist is a structured prompt — it reminds you to
                consider hazard categories that you might otherwise overlook. However, a checklist
                should never be treated as a tick-box exercise. Each item must prompt genuine
                observation and thought about the specific conditions on site.
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Combustible materials, ignition sources, fire detection, extinguishers,
                        escape routes
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white">
                ...
                provide an objective, time-stamped record of site conditions that supports the
                written risk assessment. They are particularly useful for recording the condition of
                existing electrical installations, evidence of damage or deterioration, and any
                temporary conditions that may change before the risk assessment is formally
                reviewed. Modern smartphones produce images with embedded GPS coordinates and
                timestamps, creating a robust evidence trail. Ensure photographs are stored
                securely, labelled clearly, and referenced in the written hazard report.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> A hazard identification is only as good as the time and
              attention you give it. Rushing through a checklist to "get the paperwork done" defeats
              the entire purpose. The objective is to find the hazards that could harm you or others
              — your life may depend on how thoroughly you do it.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  ...
                  paper-based form, a digital app, or a combination of both. The system should be
                  simple to use, accessible to all workers, and result in a documented response
                  within a defined timescale.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                    <strong>What to report:</strong> Any hazard you identify that is not already
                    controlled — whether it is an existing condition you have discovered or a new
                    hazard created by work activities
                  </li>
                  <li className="pl-1">
                    <strong>How to report:</strong> Use the organisation's prescribed form or
                    system. Include the location, description of the hazard, date and time, your
                    name, and any immediate action you have taken
                  </li>
                  <li className="pl-1">
                  ...
                  <li className="pl-1">
                    <strong>Follow-up:</strong> Check that your report has been acknowledged and
                    that appropriate action has been taken. If the hazard remains uncontrolled,
                    escalate through your supervisor or safety representative
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  ...
                  but had the potential to do so. Near-miss reporting is a proactive safety tool —
                  it identifies hazards and control failures before they result in actual harm.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  ...
                  delivered at or near the work area before work begins or at the start of a shift.
                  It covers specific hazards relevant to the day's tasks and reinforces safe working
                  practices.
                </p>
                <ul className="text-sm text-white space-y-1 list-disc list-outside ml-5">
                  <li className="pl-1">
                  ...
                  <li className="pl-1">
                    <strong>Who delivers:</strong> Usually the site supervisor, foreman or team
                    leader — but any competent person can deliver a toolbox talk. As a maintenance
                    technician, you may be asked to deliver toolbox talks on electrical safety
                    topics
                  </li>
                  <li className="pl-1">
                    <strong>Content:</strong> Specific to the work being done that day — not
                    generic. Good topics for electrical maintenance include safe isolation
                    procedures, arc flash awareness, cable avoidance, and working in confined spaces
                  </li>
                  <li className="pl-1">
                    <strong>Recording:</strong> A brief record should be kept — typically a form
                    showing the date, topic, presenter, attendees and any issues raised. This
                    provides evidence of safety communication for audits
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                RIDDOR — When Formal Reporting to the HSE Is Required
              </h3>
              <p className="text-sm text-white mb-3">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  ...
                  causing fire or explosion; accidental release of a substance that could cause
                  injury; collapse of scaffolding over 5 m
                </li>
                <li className="pl-1">
