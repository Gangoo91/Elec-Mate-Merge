...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Electrical hazard', 'Chemical hazard', 'Environmental hazard', 'Ergonomic hazard'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 3 starts with hazard identification. &ldquo;Suitable and sufficient&rdquo; means
              the method matches the complexity of the work. As an HNC engineer your choice of
              technique (checklist for routine work, HAZOP for novel design) is the first defendable
              step.
            </>
          }
        ...
        <ConceptBlock title="Definition of Hazard vs Risk">
            ...
            whatHappens={
              <>
                <p className="text-sm text-white">
                  ...
                  <br />
                  <strong>Risk assessment considers:</strong> Who has access? Is it locked? How
                  often is it accessed? What voltage? Are workers trained? Is PPE available?
                  <br />
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Likelihood</strong> — Definition: Probability of harm occurring. Factors:
              Frequency, duration, existing controls
            </li>
            <li>
              <strong>Severity</strong> — Definition: Potential consequences. Factors: Minor injury
              to fatality
            </li>
            <li>
              <strong>Exposure</strong> — Definition: Number and vulnerability of people. Factors:
        ...
        <ConceptBlock title="Workplace Inspections and Task Analysis">
          <p>
            ...
            compliance, and verify that control measures are working. They range from informal daily
            checks to comprehensive formal audits.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Informal/Daily</strong> — Frequency: Daily/continuous. Conducted By: All
              workers. Purpose: Spot immediate hazards
            </li>
            <li>
              <strong>Scheduled</strong> — Frequency: Weekly/monthly. Conducted By: Supervisors,
              safety reps. Purpose: Systematic area checks
            </li>
            <li>
              <strong>Formal audit</strong> — Frequency: Quarterly/annually. Conducted By: H&S
              professionals. Purpose: Comprehensive compliance review
            </li>
            <li>
              <strong>Statutory</strong> — Frequency: As required by law. Conducted By: Competent
              persons. Purpose: LOLER, PUWER, pressure systems
            </li>
          </ul>
          ...
          <div>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>Look at normal work, not just tidy 'inspection ready' conditions</li>
              <li>Check paperwork matches reality (permits, risk assessments)</li>
          ...
          <ol className="text-sm text-white space-y-1.5 list-decimal list-outside ml-5">
            <li>
              <strong>Select the task</strong> - prioritise high-risk or frequently performed tasks
            </li>
            <li>
        ...
        <ConceptBlock title="Job Safety Analysis and Incident Data Analysis">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Select job</strong> — Action: Choose task for analysis. Output: Job title
              and scope defined
            </li>
            <li>
              <strong>2. Break down</strong> — Action: List sequential steps. Output: 10-20 discrete
              steps
            </li>
            <li>
              <strong>3. Identify hazards</strong> — Action: For each step, ask "what could go
              wrong?". Output: Hazard list per step
            </li>
            <li>
              <strong>4. Develop controls</strong> — Action: Determine preventive measures. Output:
              Control measures per hazard
            </li>
            <li>
              <strong>5. Review</strong> — Action: Validate with experienced workers. Output:
              Approved JSA document
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Transport DB to location</strong> — Hazards: Manual handling, trips.
              Controls: Trolley, clear route, two-person lift
            </li>
            <li>
              <strong>2. Mark fixing positions</strong> — Hazards: Working at height, dust.
              Controls: Stepladder, eye protection
            </li>
            <li>
              <strong>3. Drill fixings</strong> — Hazards: Buried services, dust, noise. Controls:
              CAT scan, RPE, hearing protection
            </li>
            <li>
              <strong>4. Mount enclosure</strong> — Hazards: Lifting, sharp edges. Controls:
              Two-person lift, gloves
            </li>
          </ul>
            ...
            whatHappens={
              <>
                <p className="text-sm text-white">
                  ...
                  without the human cost. Organisations with strong near-miss reporting cultures
                  have significantly lower injury rates.
                </p>
              </>
            }
            doInstead={
        ...
        <ConceptBlock title="Checklists, Observation Techniques and Hazard Categories">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Behavioural observation</strong> — Description: Watch work as normally
              performed. Best For: Identifying unsafe acts
            </li>
            <li>
              <strong>Safety tours</strong> — Description: Management walkabouts. Best For: General
              awareness, engagement
            </li>
            <li>
              <strong>Safety sampling</strong> — Description: Check specific items randomly. Best
              For: PPE compliance, housekeeping
            </li>
            <li>
              <strong>Task observation</strong> — Description: Watch complete task performance. Best
              For: Validating JSAs, training needs
            </li>
          </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Comprehensive approach:</strong> Check all four hazard categories for every task
            - electrical work involves more than just electrical hazards.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Guidance">
          <div>
            <p>
              <strong>Key Principles for Hazard Identification</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Be systematic</strong> - use checklists, categories, and structured methods
              </li>
              <li>
                <strong>Involve workers</strong> - they know the real hazards from daily experience
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>CDM Regulations 2015 - specific requirements for construction</li>
            </ul>
          </div>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              lithium-iron-phosphate battery storage installation in a basement plant room of an
              office. The novel chemistry, the location and the integration with rooftop PV make a
              generic checklist inadequate.
            </>
          }
          whatToDo={
            <>
              Run a HAZOP with the M&amp;E designer, the BMS specialist, the fire engineer and the
              FM team. Take each &ldquo;node&rdquo; (battery cabinet, BMS, inverter, ventilation,
              fire suppression, isolation) and apply the guidewords (no, more, less, reverse, other
              than) to discover hazards. Record findings in a hazard register cross-referenced to BS
              EN IEC 62619, BS 9991, DSEAR and BS 7671 Section 722. Feed the residual risks into the
              CDM pre-construction information.
            </>
          }
          whyItMatters={
            <>
              Lithium battery thermal-runaway events have killed in confined plant rooms. Generic
              risk assessments routinely miss the propagation pathway. A HAZOP forces the engineer
              to ask the questions the checklist never anticipated.
            </>
          }
        />
