...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Variable-speed operation allows the turbine to adjust rotor speed to match wind conditions, maintaining the optimum tip-speed ratio for maximum aerodynamic efficiency. The generator produces variable-frequency AC which is rectified to DC and then inverted back to 50 Hz AC for grid export. This full power conversion also enables reactive power control and fault ride-through capability. The most common configurations are DFIG (partial power conversion) and PMSG with full converter.',
  },
  {
    id: 4,
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              A wind turbine converts kinetic energy from the wind into electrical energy. The rotor
              blades extract energy from the airstream and transfer it via a shaft (and usually a
              gearbox) to an electrical generator. The generator output is conditioned by power
              electronics to match grid voltage and frequency before being exported. The entire
              system is monitored and controlled by a SCADA (Supervisory Control and Data
              Acquisition) system that adjusts blade pitch, yaw angle, and power output in response
              to changing wind conditions.
            </p>
            <p>
              The power output of a wind turbine is proportional to the cube of the wind speed —
              doubling the wind speed increases the available power by a factor of eight. This cubic
              relationship explains why site selection is critical and why even modest increases in
              hub height (accessing higher wind speeds) significantly increase energy yield.
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                ...
                turbines); rotating machinery (blades, gearbox, generator); working at height
                (nacelle access via internal ladder or external hoist); confined spaces (nacelle and
                tower interior); and stored energy (capacitors in power converters, blade inertia).
                Safe isolation must address both electrical and mechanical energy sources. Lightning
                protection systems must be maintained as turbines are prominent structures. A permit
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              must be notified or approval obtained before connection, and anti-islanding protection
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              electric heating or gas boilers.
            </p>
            <p>
              Electrical maintenance technicians will increasingly encounter heat pumps as the
              installed base grows rapidly under government policy. The electrical systems — supply
              circuits, control wiring, sensors, contactors, and inverter-driven compressors — all
              require competent maintenance. The refrigeration cycle itself (compressor, condenser,
              expansion valve, evaporator) is handled by F-Gas certified refrigeration engineers,
              but the maintenance technician must understand the complete system to diagnose faults
              effectively.
            </p>
            <p>
              The fundamental operating principle is the vapour compression cycle. A refrigerant
              fluid absorbs heat from the low-temperature source as it evaporates in the evaporator
              coil. The compressor then raises the pressure and temperature of the refrigerant gas.
              In the condenser, the high-temperature refrigerant releases its heat to the heating
              system. The expansion valve reduces the pressure, cooling the refrigerant before it
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              for grant eligibility. As the installed base grows towards the 600,000 per year
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              biomass CHP generates both heat and electricity from organic fuels, and emerging
              technologies such as hydrogen fuel cells are entering the market. Each has distinct
              electrical systems and maintenance requirements that the technician must understand.
            </p>
            <p>
              While these technologies represent a smaller share of the total installed base than
              solar PV or heat pumps, they are disproportionately important in certain sectors.
              Micro-hydro is significant in rural Scotland, Wales, and northern England. Biomass CHP
              is common in agricultural, industrial, and district heating applications. Hydrogen
              fuel cells are emerging in commercial buildings and transport hubs. The maintenance
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              anti-islanding, protection settings, and power quality standards are
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              ...
              electricity supply by 2035, install 600,000 heat pumps per year by 2028, end the sale
              of new petrol and diesel cars by 2035, and deploy grid-scale energy storage to balance
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              safely and effectively across the growing range of renewable installations encountered
              in buildings and on sites. While specialist contractors may handle the primary
              technology (turbine servicing, refrigerant handling), the electrical systems require
              competent electricians who understand the complete system context.
            </p>
            <p>
              ...
              performance data recorded for future comparison. Without this baseline, it is
              difficult to determine whether a system is degrading faster than expected or whether
              observed performance is within normal parameters. The commissioning record should
              include: rated output at specified conditions, protection settings, inverter/converter
              parameters, earthing resistance measurements, and insulation resistance values.
            </p>
            <p>
              Another cross-cutting theme is the increasing integration of multiple renewable
              technologies in a single installation. A modern domestic property may combine solar
              PV, battery storage, a heat pump, and an EV charger — all managed by an energy
              management system. The maintenance technician must understand how these systems
