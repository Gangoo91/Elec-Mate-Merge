...
const AM2Module5Section1 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['High resistance connection', 'Short circuit', 'Open circuit', 'Earth fault'],
      correctAnswer: 2,
      explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The AM2 assessment deliberately includes electrical faults that you must identify, test,
          and document. These aren't random - they're carefully selected realistic faults that
          electricians encounter in the field.
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              BS 7671 Part 6 requires. The assessor wants to see you're treating each fault check as
              a proper Part 6 verification, not a quick poke around with a meter.
            </>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              the consumer unit looks fine, and there's no obvious damage. Symptom: dead circuit, no
              power at all.
            </>
          }
          whatToDo={
            <>
              Don't start tearing accessories apart. The MCB hasn't tripped, so it's not a short or
              earth fault. A dead circuit with the MCB happily on points to an{' '}
              <strong>open circuit</strong> — most likely a loose conductor at a JB, switch or rose.
              Do continuity (R1+R2) from the consumer unit out to each accessory. The point where
              continuity fails is where your fault lives. Then state type + location + how you'd
              rectify it.
            </>
          }
          whyItMatters={
            <>
              ...
              you've burned half your time and shown the assessor you don't work systematically. BS
              7671 Reg 643.1 wants verification — and the half-split continuity method is
              verification.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              equipment, or (c) you fail safety and the assessor stops the test. All three end your
              AM2 day badly.
            </>
          }
          doInstead={
        ...
        <ConceptBlock title="3. Advanced Fault-Finding Techniques">
          ...
          <p>
            The most efficient way to locate faults in long circuits. Start testing at the midpoint,
            then eliminate half the circuit each time.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="4. Real-World Fault Scenarios">
          ...
          <p>
            <strong>Common cause:</strong> Loose neutral connection in consumer unit or junction box
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="7. Professional Testing Techniques">
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Visual inspection</strong> - Check obvious issues first (finds 70% of faults)
            </li>
            <li>
