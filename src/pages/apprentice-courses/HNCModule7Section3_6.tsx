...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['UGR < 25', 'UGR < 22', 'UGR < 16', 'UGR < 19'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Ra > 80', 'Ra > 70', 'Ra > 60', 'Ra > 90'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['750 lux', '200 lux', '500 lux', '300 lux'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['500 lux', '750 lux', '1000 lux', '300 lux'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['150 lux', '200 lux', '500 lux', '300 lux'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Uo > 0.3', 'Uo > 0.6', 'Uo > 0.4', 'Uo > 0.8'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['BS 5266', 'BS EN 1838', 'BS EN 12464-1', 'BS 7671'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['50 lux', '200 lux', '150 lux', '100 lux'],
    correctAnswer: 3,
    explanation:
...
const HNCModule7Section3_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 3 · Subsection 6"
      ...
      <HubBody>
        ...
        <ConceptBlock title="CIBSE Lighting Guides Overview">
          <p>
            ...
            lighting designers and engineers. These guides complement the statutory requirements of
            BS EN 12464-1 with practical design methodologies and best practice recommendations.
          </p>
          <p>
            <strong>Key CIBSE Lighting Guides:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>LG7 - Office Lighting:</strong> Comprehensive guidance for office environments
              including VDT areas
            </li>
            <li>
              <strong>LG10 - Daylighting:</strong> Window design, daylight factors, and integration
          ...
          <p>
            <strong>CIBSE Lighting Guide Summary</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>LG1:</strong> Industrial Lighting — Manufacturing, warehouses, heavy industry
            </li>
            <li>
              <strong>LG3:</strong> The Visual Environment — Vision science, visual comfort, health
              effects
            </li>
            <li>
              <strong>LG5:</strong> Lighting for Education — Schools, colleges, universities
            </li>
            <li>
              <strong>LG7:</strong> Office Lighting — General offices, VDT areas, meeting rooms
            </li>
            <li>
              <strong>LG10:</strong> Daylighting — Windows, rooflights, daylight factors
            </li>
          </ul>
          <p>
            <strong>Professional practice:</strong> CIBSE guides represent current best practice and
            are regularly updated to reflect advances in lighting technology and research.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="BS EN 12464-1 and Maintained Illuminance">
          <p>
            ...
            places' is the European standard adopted in the UK that specifies lighting requirements
            for indoor workplaces. It defines minimum maintained illuminance levels, uniformity
            ratios, and glare limits for different tasks and activities.
          </p>
          <p>
            <strong>Maintained Illuminance (Em)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Illuminance Uniformity (Uo)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Unified Glare Rating (UGR)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Workplace Illuminance Requirements (BS EN 12464-1)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Corridors and circulation:</strong> 100 — 28 — 40
            </li>
            <li>
              <strong>Stairs and escalators:</strong> 150 — 25 — 40
            </li>
            <li>
              <strong>Reception areas:</strong> 300 — 22 — 80
            </li>
            <li>
              <strong>General office work:</strong> 500 — 19 — 80
            </li>
            <li>
              <strong>Technical drawing:</strong> 750 — 16 — 80
            </li>
            <li>
              <strong>CAD workstations:</strong> 500 — 19 — 80
            </li>
            <li>
              <strong>Conference rooms:</strong> 500 — 19 — 80
            </li>
          </ul>
          <p>
            <strong>Compliance note:</strong> These are minimum maintained values. Designers may
            specify higher levels where task demands or occupant preferences require improved visual
            conditions.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Maintenance Factors and Calculations">
          ...
          <p>
            <strong>Maintenance Factor Formula</strong>
          </p>
          <p>
            <span>MF = LLMF x LSF x LMF x RSMF</span>
          </p>
          <p>
            <span>Where:</span>
          </p>
          <p>
            <span>LLMF</span> = Lamp Lumen Maintenance Factor (LED typical: 0.90)
          </p>
          <p>
            <span>LSF</span> = Lamp Survival Factor (planned replacement: 1.0)
          </p>
          <p>
            <span>LMF</span> = Luminaire Maintenance Factor (clean office: 0.90)
          </p>
          <p>
            <span>RSMF</span> = Room Surface Maintenance Factor (typical: 0.95)
          </p>
          <p>
            <strong>Typical Maintenance Factor Values</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Clean office:</strong> 3 years — 0.77 — 0.67
            </li>
            <li>
              <strong>Normal office:</strong> 2 years — 0.74 — 0.64
            </li>
            <li>
              <strong>Light industrial:</strong> 2 years — 0.68 — 0.58
            </li>
            <li>
              <strong>Heavy industrial:</strong> 1 year — 0.60 — 0.52
            </li>
          </ul>
          <p>
            <strong>Component Factors Breakdown</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="SLL Code for Lighting and Task Lighting">
          <p>
            ...
            Lighting, which provides comprehensive guidance on interior and exterior lighting. Task
            lighting recommendations ensure appropriate illuminance for specific visual activities
            while considering energy efficiency and occupant comfort.
          </p>
          <p>
            <strong>Task Illuminance Scale (SLL Code)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>50:</strong> Orientation/safety — Storage areas, cable routes
            </li>
            <li>
              <strong>100:</strong> Movement and basic tasks — Corridors, loading bays
            </li>
            <li>
              <strong>200:</strong> Routine work, low detail — Foyers, rest rooms, archives
            </li>
            <li>
              <strong>300:</strong> Moderate visual tasks — Classrooms, retail areas
            </li>
            <li>
              <strong>500:</strong> Standard office tasks — Offices, control rooms
            </li>
            <li>
              <strong>750:</strong> Demanding visual tasks — Drawing, inspection work
            </li>
            <li>
              <strong>1000:</strong> Very fine detail tasks — Colour matching, fine assembly
            </li>
          </ul>
          <p>
            <strong>Task Lighting Benefits</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Illuminance Ratios (SLL Recommendations)</strong>
          </p>
          <p>
          ...
          <p>
            These ratios ensure comfortable adaptation and prevent excessive contrast that causes
            visual fatigue.
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Specify lighting requirements for a 200m² open-plan office
            with VDT workstations.
          </p>
