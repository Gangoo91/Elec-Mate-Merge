...
const quickCheckQuestions = [
  {
    ...
    options: [
      'Inductance between two separate coils',
      'The property of a coil to oppose changes in its own current',
      'The resistance of an inductor',
      'The capacitance of a coil',
    ],
    correctIndex: 1,
    explanation:
      'Self-inductance is the property of a coil whereby a changing current induces an EMF in itself that opposes the change. It is measured in Henrys (H).',
  },
  {
    question:
      'A coil has inductance of 0.5 H. If current changes by 4A in 0.1s, what is the induced EMF?',
    options: ['2 V', '20 V', '0.2 V', '200 V'],
    correctIndex: 1,
    explanation:
      'e = L x (dI/dt) = 0.5 x (4/0.1) = 0.5 x 40 = 20 V. The induced EMF opposes the change in current.',
  },
  {
    question: 'What does the coefficient of coupling (k) represent?',
    options: [
      'Turns ratio between coils',
      'Fraction of flux from one coil linking another',
      'Total flux in the magnetic circuit',
      'Power transfer efficiency',
    ],
    correctIndex: 1,
    explanation:
      'The coefficient of coupling k indicates what fraction of the magnetic flux from one coil links with another coil. k = 1 means perfect coupling, k = 0 means no coupling.',
  },
  {
...
const quizQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Energy W = 0.5 x L x I squared. Therefore L = 2W / I squared = 2 x 0.5 / 4 = 0.25 H.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Time constant tau = L / R = 2 / 40 = 0.05 s = 50 ms. Current reaches 63.2% of final value in this time.',
  },
  {
    question:
      'If mutual inductance between two coils is 0.2 H and current in one changes by 5A in 10ms, what EMF is induced in the other?',
  ...
  {
    question:
      'Two inductors of 3H and 6H are connected in series with aiding mutual inductance of 2H. What is the total inductance?',
  ...
  {
    question:
      'An inductor has 500 turns, carries 2A and produces 0.01 Wb of flux. What is its inductance?',
  ...
  {
    question:
      'What happens to the coefficient of coupling when an air gap is introduced between coils?',
    options: ['Increases', 'Decreases', 'Stays the same', 'Becomes unity'],
    correctIndex: 1,
    explanation:
      'An air gap increases leakage flux and reduces the flux linking both coils, decreasing the coefficient of coupling k.',
  },
  {
    question:
      'After how many time constants does the current in an RL circuit reach approximately 99% of its final value?',
    options: ['3 time constants', '4 time constants', '5 time constants', '1 time constant'],
    correctIndex: 2,
    explanation:
      'After 5 time constants, current reaches 99.3% of final value. The 63.2% point is at 1 time constant, 86.5% at 2, 95% at 3, 98.2% at 4.',
  },
  {
  ...
  {
    question:
      'The same two 4H coils are connected in series opposing. What is the total inductance?',
  ...
  },
  {
    ...
    options: [
      ...
      'Increase inductance by concentrating flux',
      'Reduce weight',
    ],
    correctIndex: 2,
    explanation:
      'Iron cores have high permeability, concentrating the magnetic flux and greatly increasing inductance compared to air-cored coils.',
  },
  {
  ...
  },
  {
    ...
    options: [
      'High resistance',
      "Self-induced EMF opposes the change (Lenz's Law)",
      'Capacitive effects',
      'Core saturation',
    ],
    correctIndex: 1,
    explanation:
      "By Lenz's Law, the self-induced EMF opposes changes in current. An increasing current induces EMF opposing the increase, and vice versa.",
  },
];
            ...
            <div className="bg-[#242424] rounded-lg p-6 border border-white/10">
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 mb-4">
                ...
                <ul className="text-white text-sm space-y-2">
                  ...
                  <li>
                    <strong>k = 0.95 - 0.99:</strong> Tightly coupled - iron-cored transformers
                  </li>
                  <li>
                    <strong>k = 0.5 - 0.7:</strong> Loosely coupled - some air gap or separate cores
                  </li>
                  <li>
                    <strong>k approaching 0:</strong> Very weak coupling - coils far apart or at
                    right angles
                  </li>
                </ul>
              </div>
              ...
              <ul className="text-white space-y-2 mb-4">
                ...
                <li>
                  <strong>Inductive charging:</strong> Moderate k allows wireless power transfer
                </li>
                <li>
                  <strong>Isolation:</strong> Low k provides electrical isolation while transferring
                  signals
                </li>
              </ul>
          ...
          <div className="mb-12">
            ...
            <div className="bg-yellow-900/30 border border-yellow-500/50 rounded-lg p-6">
              ...
              <ul className="text-white space-y-2">
                ...
                <li>
                  <strong>Contact ratings:</strong> Switches and contactors for inductive loads need
                  DC ratings (AC-11) or inductive AC ratings (AC-12/AC-15). Standard AC ratings
                  don't apply.
                </li>
                <li>
                  <strong>Motor starters:</strong> The RL time constant affects motor starting
                  current duration. Star-delta starting reduces locked-rotor current.
                </li>
                <li>
                  <strong>Transformer inrush:</strong> Initial magnetising current can be 10-20
                  times steady-state. Protection must not trip on normal inrush.
                </li>
                <li>
                  <strong>Cable separation:</strong> Mutual inductance between parallel cables can
                  affect performance. BS 7671 Appendix 4 gives derating factors.
                </li>
              </ul>
            </div>
          </div>
