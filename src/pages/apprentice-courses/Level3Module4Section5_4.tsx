      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Apply the correct testing sequence for repair verification",
              "Perform and interpret dead tests (continuity, IR, polarity)",
              "Execute live tests safely (Zs, RCD, functional)",
              "Understand minimum acceptable values from BS 7671",
              "Select and complete appropriate certification",
              "Handle failed tests and borderline results"
            ].map((item, i) => (
