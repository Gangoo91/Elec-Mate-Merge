      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Why Spacing Matters and Basic Guidelines</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>PVC conduit spacing (closer due to flexibility):</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Trunking support requirements:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Manufacturer Guidelines and Load Considerations</h3>
            <p className="text-xs sm:text-sm text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Load capacity charts:</strong> Specify exact spacing based on expected cable weight per metre.</p>
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Environmental ratings:</strong> Adjusted spacing for temperature, humidity, and vibration.</p>
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Material-specific requirements:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Cable weight factors (typical values):</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Dynamic load considerations:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Maximum allowable deflection:</strong> L/200 (span length divided by 200) under full load.</p>
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Testing requirements:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Environmental Adjustments and Special Conditions</h3>
            <p className="text-xs sm:text-sm text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Expansion joint requirements:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Dynamic load factors:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Corrosive environment adjustments:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Common Faults and Quality Control</h3>
            <p className="text-xs sm:text-sm text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Quality control checks:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-sm">
            <div>
              <h3 className="font-medium text-white mb-3">Planning and Layout</h3>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-muted/50 rounded-lg border">
              <p className="font-medium text-white mb-2">What is the maximum recommended support spacing for PVC conduit horizontally?</p>
              <p className="text-sm text-white">PVC conduit requires supports every 1.2m maximum due to its flexibility and thermal expansion properties.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg border">
              <p className="font-medium text-white mb-2">Why should supports be closer together in high-vibration areas?</p>
              <p className="text-sm text-white">Vibration causes fatigue in fixings and containment, so closer spacing with locking nuts prevents loosening and failure.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg border">
              <p className="font-medium text-white mb-2">Where should extra supports always be placed?</p>
              <p className="text-sm text-white">On both sides of bends, junctions, and heavy accessories to prevent stress concentration and maintain structural integrity.</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-medium text-white mb-2">Q: Can I follow only BS 7671 without checking manufacturer data?</h3>
              <p className="text-sm text-white">A: No — manufacturer instructions may override general guidelines, especially for warranty and safety reasons. Always check specific product datasheets.</p>
            </div>
            <Separator />
            <div>
              <h3 className="font-medium text-white mb-2">Q: How do I deal with uneven walls or ceilings when spacing supports?</h3>
              <p className="text-sm text-white">A: Use adjustable brackets or shims to maintain consistent spacing between supports while accommodating structural irregularities.</p>
            </div>
            <Separator />
            <div>
              <h3 className="font-medium text-white mb-2">Q: Do spacing rules apply before cables are installed?</h3>
              <p className="text-sm text-white">A: Yes — containment must be adequately supported even before cables are pulled to prevent damage during installation and ensure structural integrity.</p>
            </div>
          </div>
        </Card>
