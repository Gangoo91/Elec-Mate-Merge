...
const TITLE =
  'Spacing Rules and Manufacturer Guidelines - Module 4.4.2 | Level 2 Electrical Course';
const DESCRIPTION =
  'Master spacing requirements for conduit, trunking, and cable tray supports. Learn manufacturer guidelines, BS 7671 compliance, and environmental adjustments for secure installations.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Closer spacing with vibration-resistant fixings prevents loosening and reduces fatigue damage from constant movement and vibration.',
  },
  {
    id: 3,
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white text-sm space-y-1">
                  ...
                  <li>
                    • <strong>Use:</strong> Manufacturer datasheets, load charts, spacing
                    calculators
                  </li>
                  <li>
                    • <strong>Check:</strong> No deflection, correct intervals, extra supports at
                    bends
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <ul className="text-white space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Interpret spacing requirements from manufacturer datasheets and load charts
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                <span>
                  Apply BS 7671 and industry best practice guidelines for containment spacing
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                <span>
                  Adjust spacing for different materials (PVC vs steel) and environmental conditions
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                <span>
                  Factor in cable load capacity and type when determining support intervals
                </span>
              </li>
              <li className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                <span>
                  Avoid common spacing mistakes that compromise safety and professional appearance
                </span>
              </li>
            </ul>
          </section>
            ...
            <div className="text-white space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Prevents mechanical strain:</strong> Maintains cable integrity and
                  prevents insulation damage.
                </p>
                <p className="text-sm mb-2">
                  <strong>Structural integrity:</strong> Avoids long-term deformation and system
                  failure.
                </p>
                <p className="text-sm">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>PVC conduit spacing (closer due to flexibility):</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                <p className="font-medium text-white mb-2">
                  Cable Tray and Trunking Specifications
                </p>
                <p className="text-sm mb-2">
                  <strong>Cable tray support intervals:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Trunking support requirements:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Load capacity charts:</strong> Specify exact spacing based on expected
                  cable weight per metre.
                </p>
                <p className="text-sm mb-2">
                  <strong>Environmental ratings:</strong> Adjusted spacing for temperature,
                  humidity, and vibration.
                </p>
                <p className="text-sm mb-2">
                  <strong>Material-specific requirements:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Cable weight factors (typical values):</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Dynamic load considerations:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Maximum allowable deflection:</strong> L/200 (span length divided by 200)
                  under full load.
                </p>
                <p className="text-sm mb-2">
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>PVC thermal expansion:</strong> 0.6mm per metre per 10°C temperature rise.
                </p>
                <p className="text-sm mb-2">
                  <strong>Temperature adjustment factors:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Expansion joint requirements:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-orange-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>High-vibration environments:</strong> Plant rooms, near machinery,
                  transport links.
                </p>
                <p className="text-sm mb-2">
                  <strong>Vibration mitigation measures:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Dynamic load factors:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <p className="text-sm mb-2">
                  <strong>Outdoor installation factors:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Corrosive environment adjustments:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white space-y-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-red-500/50">
                ...
                <p className="text-sm mt-2 mb-2">
                  <strong>Quality control checks:</strong>
                </p>
                <ul className="text-sm ml-4 space-y-1">
            ...
            <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
              <div className="text-white space-y-4 text-sm">
                <p>
                  ...
                  35kg/m, the tray exhibited significant sagging between supports. The electrical
                  inspector noted deflection exceeding L/200 limits and failed the installation.
                </p>
                <p>
                  Investigation revealed that the manufacturer's datasheet specified 1.5m maximum
                  spacing for loads exceeding 25kg/m. The contractor had followed BS 7671 general
                  guidelines but missed the specific manufacturer requirements for heavy-duty
                  applications.
                </p>
                <div className="p-3 rounded bg-white/5 mt-4">
                  <p className="font-medium text-white mb-2">Lesson Learned</p>
                  <p>
                    The installation required additional supports to be installed at 1.5m centres,
                    requiring partial cable removal and doubling the labour cost. Always check
                    manufacturer load charts and apply appropriate safety margins for cable weight
                    calculations. When in doubt, use closer spacing rather than risk failure.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-white text-sm">
                ...
                accurate measurement, and quality control prevent costly rework and ensure long-term
          ...
          <Quiz
            ...
            title="Test your knowledge of spacing rules and manufacturer guidelines"
          />
