...
const quickCheckQuestions = [
  {
    ...
    options: ['Cross-flow fan', 'Axial fan', 'Centrifugal fan', 'Propeller fan'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Reduce by 75%', 'Reduce by 25%', 'Reduce by 50%', 'Reduce by 87.5%'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['FEG 67', 'FEG 75', 'FEG 50', 'FEG 60'],
    correctAnswer: 0,
    explanation:
      ...
      <HubBody>
        ...
        <ConceptBlock title="Fan Types and Characteristics">
          <p>
            ...
            and efficiency targets. The three main categories are centrifugal, axial, and mixed-flow
            fans.
          </p>
          <p>
            <strong>Centrifugal Fans</strong>
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Radial/paddle:</strong> Self-cleaning, handles particulate-laden air, used in
              industrial extraction
            </li>
          </ul>
          <p>
            <strong>Axial Fans</strong>
          </p>
          <p>
            Axial fans move air parallel to the shaft axis, providing high airflow at relatively low
            pressures. Types include:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Propeller fans:</strong> Simple design for free-air applications, wall-mounted
              extract
            </li>
            <li>
            ...
            <li>
              <strong>Vane-axial:</strong> Guide vanes improve pressure and efficiency, suitable for
              ducted systems
            </li>
          </ul>
          <p>
            <strong>Mixed-Flow Fans</strong>
          </p>
          <p>
            ...
            compact form factor, making them popular for in-line duct applications where space is
            limited.
          </p>
          <p>
            <strong>Fan Type Selection Guide</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Central AHU supply/extract:</strong> Centrifugal backward-curved — High
              efficiency, stable operation
            </li>
            <li>
              <strong>Fan coil units:</strong> Centrifugal forward-curved — Compact size
            </li>
            <li>
              <strong>Car park ventilation:</strong> Axial (jet fans) — High volume, impulse
              ventilation
            </li>
            <li>
              <strong>In-line duct booster:</strong> Mixed-flow — Compact, moderate pressure
            </li>
            <li>
              <strong>Kitchen extract:</strong> Centrifugal radial — Handles grease-laden air
            </li>
            <li>
              <strong>Roof extract:</strong> Axial or mixed-flow — Weather protection, direct
              discharge
            </li>
          </ul>
          <p>
            <strong>Selection principle:</strong> Choose centrifugal fans for high-pressure systems
            (&gt;500 Pa), axial fans for high-volume low-pressure applications, and mixed-flow where
        ...
        <ConceptBlock title="Fan Laws and Performance Prediction">
          ...
          <p>
            <strong>The Three Fan Laws (for constant fan size)</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Practical Implications of Fan Laws</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Oversizing penalty:</strong> Running a large fan slowly is inefficient - motor
              and drive losses increase
            </li>
            <li>
          ...
          <p>
            <strong>Fan Laws Application Table</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>100%:</strong> 100% — 100% — 100%
            </li>
            <li>
              <strong>90%:</strong> 90% — 81% — 73%
            </li>
            <li>
              <strong>80%:</strong> 80% — 64% — 51%
            </li>
            <li>
              <strong>70%:</strong> 70% — 49% — 34%
            </li>
            <li>
              <strong>50%:</strong> 50% — 25% — 12.5%
            </li>
          </ul>
          <p>
            <strong>Density Corrections</strong>
          </p>
          <p>
            ...
            20°C at sea level (density ≈ 1.2 kg/m³). For every 1000m elevation, density reduces by
            approximately 12%.
          </p>
          <p>
        ...
        <ConceptBlock title="System Curves and Duty Point Selection">
          ...
          <p>
            <strong>Understanding System Resistance</strong>
          </p>
          <p>
            System resistance follows the square law: ΔP = kQ², where k is the system constant
            determined by ductwork configuration, fittings, filters, coils, and terminal devices. On
            a pressure-flow graph, this creates a parabolic curve starting from the origin.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>High resistance:</strong> Long duct runs, many bends, dirty filters, terminal
              devices
            </li>
            <li>
              <strong>Variable resistance:</strong> Systems with dampers, VAV terminals, or changing
              filter condition
            </li>
          </ul>
          <p>
            <strong>Fan Curve Regions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              - <strong>Stall region:</strong> Left of peak - unstable, noisy, avoid operation here
            </li>
            <li>
          ...
          <p>
            <strong>Duty Point Selection Criteria</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Flow rate:</strong> Match design requirement — Inadequate ventilation or
              overcooling
            </li>
            <li>
              <strong>Pressure:</strong> Overcome system resistance + margin — Insufficient airflow
              at terminals
            </li>
            <li>
              <strong>Efficiency:</strong> Near peak efficiency point — Excessive energy consumption
            </li>
            <li>
              <strong>Stability:</strong> Well clear of stall region — Noise, vibration, unreliable
              operation
            </li>
            <li>
              <strong>Future capacity:</strong> Margin for system changes — Unable to accommodate
              modifications
            </li>
          </ul>
          <p>
            <strong>Effect of System Changes on Duty Point</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Duct leakage:</strong> Reduced effective resistance, increased wasteful flow
            </li>
            <li>
              <strong>Speed change:</strong> Duty point moves along system curve following fan laws
            </li>
          </ul>
          <p>
            <strong>Selection guidance:</strong> Select fans to operate between 60-80% of maximum
            flow for best efficiency, with the duty point clearly within the stable operating region
            and well clear of stall.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Efficiency Standards and Regulations">
          ...
          <p>
            <strong>Specific Fan Power (SFP)</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Building Regulations Part L - SFP Limits</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Central mechanical ventilation (supply and extract):</strong> 1.6
            </li>
            <li>
              <strong>Central mechanical ventilation with heating/cooling:</strong> 1.6
            </li>
            <li>
              <strong>Local supply or extract (non-domestic):</strong> 0.5
            </li>
            <li>
              <strong>Zonal supply with central extract:</strong> 1.5
            </li>
            <li>
              <strong>Fan coil systems:</strong> 0.8
            </li>
          </ul>
          <p>
            <strong>ErP Directive and Fan Efficiency Grades (FEG)</strong>
          </p>
          <p>
            The Energy-related Products (ErP) Directive Lot 6 mandates minimum efficiency for fans.
            Compliance is measured using Fan Efficiency Grades comparing actual efficiency to an
            ideal reference fan.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>EC Motors and Variable Speed Drives</strong>
          </p>
          <p>
          ...
          <p>
            <strong>AC + VSD Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Achieving SFP Compliance</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            placed on the market. Replacement projects must use compliant products, which may affect
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Verify SFP compliance for a supply and extract system serving
            an office building.
          </p>
          <p>System data:</p>
          ...
          <p>
            <strong>Scenario:</strong> Select a fan for a VAV system requiring 1.5 m³/s at 500 Pa
            design duty, operating between 40-100% flow.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Calculate total system pressure including ductwork, fittings, filters, and terminals
            </li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Not accounting for dirty filters</strong> - system resistance increases over
                time
              </li>
              <li>
