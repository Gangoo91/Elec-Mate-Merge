...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['SAP', 'SBEM', 'CIBSE TM54', 'BREEAM'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['0.18 W/m²K', '0.26 W/m²K', '0.45 W/m²K', '0.35 W/m²K'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Part F', 'Part M', 'Part A', 'Part B'],
    correctAnswer: 0,
    explanation:
...
const HNCModule6Section1_1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 1 · Subsection 1"
        title="Introduction to Part L"
        backTo="/study-centre/apprentice/h-n-c-module6-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Part L structure, 2021 amendments, conservation of fuel and power, compliance routes, and
          building types
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Part L is a reasonable-provision regulation enforced through the Approved Documents
              (ADL Volumes 1 and 2). Building Control will not issue completion until SAP/SBEM
              as-built calculations, commissioning certificates, the air-permeability test result
              and the EPC are all on file. Get the design SAP wrong at planning and the whole
              project sequence is at risk.
            </>
          }
        ...
        <ConceptBlock title="Part L Overview and Structure">
          <p>
            ...
            building services efficiency, and overall energy consumption to reduce CO₂ emissions and
            combat climate change.
          </p>
          <p>
            <strong>Part L Document Structure:</strong>
          </p>
          ...
          <p>
            <strong>Part L Applies To</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>New dwellings:</strong> New construction — Volume 1
            </li>
            <li>
              <strong>Existing dwellings:</strong> Extensions, replacements, renovations — Volume 1
            </li>
            <li>
              <strong>New non-domestic:</strong> New construction — Volume 2
            </li>
            <li>
              <strong>Existing non-domestic:</strong> Extensions, fit-out, system replacement —
              Volume 2
            </li>
            <li>
              <strong>Mixed-use buildings:</strong> Relevant sections apply to each part — Both
              volumes
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Part L 2021 Amendments">
          ...
          <p>
            <strong>Dwellings (Part L1)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Non-Domestic (Part L2)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Notional Building Fabric Standards (Part L 2021)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>External walls:</strong> 0.18 W/m²K — 0.26 W/m²K — 0.30 W/m²K
            </li>
            <li>
              <strong>Roof:</strong> 0.11 W/m²K — 0.16 W/m²K — 0.20 W/m²K
            </li>
            <li>
              <strong>Floor:</strong> 0.13 W/m²K — 0.18 W/m²K — 0.25 W/m²K
            </li>
            <li>
              <strong>Windows:</strong> 1.2 W/m²K — 1.6 W/m²K — 2.0 W/m²K
            </li>
            <li>
              <strong>Air permeability:</strong> 5 m³/(h·m²) — 8 m³/(h·m²) — 10 m³/(h·m²)
            </li>
          </ul>
          <p>
            <strong>Future Homes Standard Pathway</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Part L 2013:</strong> Baseline standard
            </li>
            <li>
              <strong>Part L 2021:</strong> 31% improvement (current)
            </li>
            <li>
              <strong>Future Homes 2025:</strong> 75-80% improvement target
            </li>
            <li>
              <strong>Net Zero 2050:</strong> All homes zero carbon ready
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Compliance Routes and Calculation Methods">
          <p>
            Part L compliance is demonstrated through energy calculations that compare the proposed
            building against a notional building with compliant specifications. Different
            calculation methodologies apply to domestic and non-domestic buildings.
          </p>
          <p>
            <strong>Compliance Calculation Methods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>SAP (Standard Assessment Procedure):</strong> Government methodology for
              dwellings - calculates DER (Dwelling Emission Rate) and DPER (Dwelling Primary Energy
              Rate)
            </li>
            <li>
              <strong>SBEM (Simplified Building Energy Model):</strong> For non-domestic buildings -
              calculates BER (Building Emission Rate) and BPER (Building Primary Energy Rate)
            </li>
            <li>
              <strong>DSM (Dynamic Simulation Modelling):</strong> Advanced modelling tools (IES,
              TAS) approved as alternatives to SBEM for complex buildings
            </li>
          </ul>
          <p>
            <strong>Notional Building Approach</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Create notional building:</strong> Same geometry, size, orientation as
              actual — Like-for-like comparison
            </li>
            <li>
              <strong>2. Apply notional specifications:</strong> Standard U-values, systems,
              efficiencies — Establishes target performance
            </li>
            <li>
              <strong>3. Calculate target rates:</strong> TER/TPER (dwellings) or TER/TPER (non-dom)
              — Compliance threshold
            </li>
            <li>
              <strong>4. Model actual building:</strong> With specified fabric and services —
              Predicted performance
            </li>
            <li>
              <strong>5. Compare results:</strong> DER ≤ TER and DPER ≤ TPER — Pass/fail
              determination
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Non-Domestic (SBEM)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            between elements, enabling design innovation while ensuring overall performance targets
            are met.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Types and Part L Applications">
          <p>
            ...
            existing, an extension, or undergoing renovation. Understanding which requirements apply
            is essential for compliance.
          </p>
          <p>
            <strong>Requirements by Building Situation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>New build:</strong> Full compliance: fabric, services, renewables — Full
              SAP/SBEM
            </li>
            <li>
              <strong>Extension ≤50m² (domestic):</strong> Meet limiting U-values, opening areas —
              Elemental approach
            </li>
            <li>
              <strong>Extension &gt;50m² (domestic):</strong> As new build standards — SAP for
              extension
            </li>
            <li>
              <strong>Replacement windows:</strong> Meet window U-value standards — Product
              certification
            </li>
            <li>
              <strong>Boiler replacement:</strong> Meet efficiency requirements, controls — Product
              certification
            </li>
            <li>
              <strong>Renovation (&gt;25% envelope):</strong> Upgrade thermal elements affected —
              Elemental U-values
            </li>
            <li>
              <strong>Change of use:</strong> Upgrade to current standards where practical — Depends
              on situation
            </li>
          </ul>
          <p>
            <strong>New Build Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Existing Building Triggers</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Consequential Improvements (Non-Domestic &gt;1000m²)</strong>
          </p>
          <p>
            <strong>Trigger threshold:</strong> Work to existing buildings exceeding £50,000 or
            providing new/additional fixed services
          </p>
          <p>
            <strong>Improvement requirement:</strong> Energy efficiency measures with simple payback
            ≤15 years
          </p>
          <p>
          ...
          <p>
            <strong>Integration with Other Building Regulations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Part F (Ventilation):</strong> Airtight buildings require adequate ventilation
              - MVHR often needed
            </li>
            <li>
              <strong>Part O (Overheating):</strong> New 2022 regulation limiting overheating risk
              in residential buildings
            </li>
            <li>
              <strong>Part S (EV Charging):</strong> Infrastructure requirements link to electrical
              design
            </li>
            <li>
          ...
          <p>
            ...
            compliance with architectural fabric design, ensuring systems are sized for the reduced
            heating loads of well-insulated buildings.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Verify Part L compliance for a new 3-bedroom semi-detached
            house.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Calculate lighting efficacy for an office building to meet
            Part L2.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Undersizing heating</strong> - Improved fabric reduces heat loss but systems
                must still meet peak demand
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A Cat A office shell achieved Part L compliance under SBEM with notional lighting at
              45 luminaire-lumens per circuit-watt and a heat-pump heating allowance. The incoming
              tenant takes the Cat B fit-out and installs a smaller, more decorative LED scheme that
              drops the average to 38 lm/cW, plus electric panel heaters for tea-points. Building
              Control flag the variation at handover.
            </>
          }
          whatToDo={
            <>
              Re-run the SBEM model with the as-installed lighting power density and heating mix. If
              BER now exceeds TER, propose offsets within the same envelope: enhanced lighting
              controls (presence + daylight dimming), HVAC scheduling improvements, or an upgrade of
              one tea-point to instantaneous low-load. Issue an updated EPC and as-built calculation
              pack before the building is occupied — Part L compliance is judged at handover, not at
              design.
            </>
          }
          whyItMatters={
            <>
              Part L non-compliance at completion is a Building Regulations breach that can delay
              occupation, void warranties and fall back on the M&E designer under CDM Reg 9. Tenant
              fit-outs are the single most common trigger — every variation to the lighting or HVAC
              specification needs an SBEM check, not just a coordination drawing.
            </>
          }
        />
