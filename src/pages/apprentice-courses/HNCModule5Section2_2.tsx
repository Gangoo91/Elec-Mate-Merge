    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              JCT 2.27 is the Relevant Event notice — the gateway to an Extension of Time.
              "Forthwith" means immediately on it becoming apparent, not at the end of the period of
              delay. A late notice does not necessarily defeat the claim, but it weakens it and can
              lead to forfeiture of loss and expense (where time-bar applies). Embed notice
              discipline as routine, not as crisis response.
            </>
          }
        ...
        <ConceptBlock title="JCT Contract Forms Overview">
          <p>
            The Joint Contracts Tribunal (JCT) produces the most widely used standard form building
            contracts in the UK. Understanding which contract form applies to your project is
            essential for managing risk, understanding your obligations, and protecting your
            commercial position as an electrical contractor or subcontractor.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>JCT ICD (Intermediate Building Contract):</strong> Medium-complexity projects,
              simpler procedures than SBC
            </li>
            <li>
          ...
          <p>
            <strong>
              Contract Selection Guide (Form — Typical Value — Design Responsibility — Complexity):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            ...
            million pounds) is let as a domestic subcontract to an M&E contractor. Electrical design
            is provided by the employer's consulting engineers (Contractor's Design Portion
          ...
          <p>
            <strong>Key principle:</strong> Always obtain and read your subcontract terms — they may
            differ significantly from the main contract.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Key Clauses for Electrical Subcontractors">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Retention:</strong> Medium - cash flow and insolvency risk — Percentage, trust
              account, release dates
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Extensions of Time and Loss and Expense">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Late information:</strong> Drawings, details, or instructions not provided on
              time
            </li>
            <li>
              <strong>Employer's other contractors:</strong> Delays caused by direct contractors or
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Approximate quantities adjustment:</strong> Rate adjustment, extended duration
              costs
            </li>
          </ul>
          <p>
            ...
            contractor in writing immediately, (2) provide programme impact analysis, (3) record all
            affected resources and costs, (4) claim both EOT and loss and expense. Recoverable costs
            may include electrician standing time, extended site welfare, delayed material
            deliveries, and reprogramming specialist commissioning engineers.
          </p>
          <p>
            <strong>Documentation is key:</strong> Keep contemporaneous records of delays, cause and
            effect, resources affected, and costs incurred.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Completion and Defects Liability">
          <p>
            Practical completion is a pivotal contractual milestone that triggers several important
            consequences. Understanding what it means and managing the defects liability period
            effectively is essential for completing projects successfully.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Minor outstanding items (snagging) acceptable to contract administrator</li>
          ...
          <p>
            <strong>
              Defects Liability Period (Rectification Period) — (Aspect — Standard — Subcontractor
              Implication):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            the failure is a genuine defect (faulty component, poor workmanship) or misuse/external
            cause, (3) rectify defects at their own cost, (4) document the repair and root cause. If
            the failure was due to the client disconnecting the lighting circuit for their own
            alterations, this is not a defect for the subcontractor to remedy free of charge.
          </p>
          <p>
            <strong>Practical tip:</strong> Maintain good relationships with building managers
            during the defects period. Prompt response to genuine issues builds reputation and often
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Loss and expense:</strong> Extended preliminaries, possible acceleration costs
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Standing time: 2 electricians x 3 days waiting = 6 days x 280 pounds = 1,680 pounds
            </li>
        ...
        <Scenario
          ...
          situation={
            <>
              A client design change in week 12 delays the LV switchroom layout by six weeks. You
              absorb the work, do not issue a formal Clause 2.27 notice, and recover most of the
              time through acceleration. At month nine, the project completes four weeks late. You
              submit an EOT claim of six weeks. The contract administrator rejects it: no
              contemporaneous notice, no progress impact records, no contemporaneous programme
              update.
            </>
          }
          whatToDo={
            <>
              Issue Clause 2.27 notices the moment any delay event becomes apparent — even if you
              intend to mitigate. Maintain progress records (daily site diary, programme baselines,
              photographs). At each interim valuation, support the EOT with a programme update
              showing impact. Loss and expense follows the EOT under Clauses 4.20–4.26 — same notice
              discipline applies. Never rely on goodwill at the end of a project.
            </>
          }
          whyItMatters={
            <>
              JCT EOT and loss-and-expense entitlement is procedural as much as factual. Late
              notices, missing records and absent programme updates lose claims that would otherwise
              be valid. Notice discipline is the cheapest insurance on any JCT project.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">NEC contracts</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
