...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['100mm', '200mm', '150mm', '300mm'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1.5 tog', '1.0 tog', '0.5 tog', '2.5 tog'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['21 days', '28 days', '7 days', '14 days'],
    correctAnswer: 0,
    explanation:
...
const HNCModule8Section1_3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 1 · Subsection 3"
        title="Underfloor Heating"
        backTo="/study-centre/apprentice/h-n-c-module8-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Wet UFH system design, manifold configuration, pipe layouts and commissioning for building
          services
        </p>
        ...
        <ConceptBlock title="UFH Design Principles">
          <p>
            ...
            temperatures, making UFH highly efficient and compatible with heat pumps and condensing
            boilers.
          </p>
          <p>
            <strong>Key design parameters:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Heat output:</strong> 80-100 W/m² at 55°C flow, reducing at lower temperatures
            </li>
          </ul>
          <p>
            <strong>Heat Output Calculation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>35°C:</strong> 40-50 W/m² — Heat pump, Passivhaus
            </li>
            <li>
              <strong>45°C:</strong> 60-75 W/m² — Heat pump, well-insulated
            </li>
            <li>
              <strong>55°C:</strong> 80-100 W/m² — Boiler, standard insulation
            </li>
            <li>
              <strong>60°C:</strong> 100-120 W/m² — High heat loss areas
            </li>
          </ul>
          <p>
            <strong>Pipe Spacing and Heat Output</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>100mm:</strong> +20% — High heat loss, bathrooms
            </li>
            <li>
              <strong>150mm:</strong> +10% — Perimeter zones, conservatories
            </li>
            <li>
              <strong>200mm:</strong> Standard — Living areas, bedrooms
            </li>
            <li>
              <strong>250-300mm:</strong> -10 to -15% — Low heat loss areas, corridors
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Manifold Systems">
          ...
          <p>
            <strong>Manifold Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Actuator connections:</strong> Accepts thermal or electric actuators for zone
              control
            </li>
            <li>
          ...
          <p>
            <strong>Mixing Valve Options</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Flow Meter Reading and Balancing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Small (10-15m²):</strong> 1.0-1.5 l/min — 0.5-2.0 l/min
            </li>
            <li>
              <strong>Medium (15-20m²):</strong> 1.5-2.5 l/min — 1.0-3.0 l/min
            </li>
            <li>
              <strong>Large (20-25m²):</strong> 2.5-3.5 l/min — 2.0-4.0 l/min
            </li>
          </ul>
          <p>
            <strong>Flow rate formula:</strong> Q (l/min) = Heat output (W) ÷ (ΔT × 70). For a 1500W
            circuit with 10K ΔT: Q = 1500 ÷ (10 × 70) = 2.1 l/min
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Pipe Layouts and Zone Control">
          <p>
            ...
            Zone control enables individual room temperature regulation through actuators controlled
            by room thermostats.
          </p>
          <p>
            <strong>Pipe Layout Patterns</strong>
          </p>
          <p>
            <strong>Spiral (Snail) Pattern</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Serpentine Pattern</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Zone Control Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Thermal actuators:</strong> 230V or 24V, normally closed, 3-5 minute operation
              time
            </li>
            <li>
              <strong>Room thermostats:</strong> Digital, programmable, or smart thermostats with
              setback
            </li>
            <li>
          ...
          <p>
            <strong>Actuator Wiring Configurations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Thermal wax:</strong> 230V AC — NC, slow open — Most common, simple wiring
            </li>
            <li>
              <strong>Thermal wax:</strong> 24V AC — NC, slow open — Safer, requires transformer
            </li>
            <li>
              <strong>Electric motor:</strong> 230V AC — Fast, end switches — Position feedback
              available
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Screed Requirements and Commissioning">
          <p>
            The floor screed provides thermal mass for even heat distribution and structural support
            for floor finishes. Proper screed specification and curing is essential before UFH
            commissioning can begin.
          </p>
          <p>
            <strong>Screed Types and Characteristics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sand/cement:</strong> 65-75mm — 21 days minimum — Traditional, high thermal
              mass
            </li>
            <li>
              <strong>Anhydrite (calcium sulphate):</strong> 30-35mm — 7-14 days — Self-levelling,
              faster response
            </li>
            <li>
              <strong>Thin screed/tile adhesive:</strong> 15-20mm — 24-48 hours — Fast response, low
              thermal mass
            </li>
          </ul>
          <p>
            <strong>Floor Covering Thermal Resistance</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ceramic/porcelain tiles:</strong> 0.05-0.1 tog — Excellent
            </li>
            <li>
              <strong>Natural stone:</strong> 0.1-0.2 tog — Excellent
            </li>
            <li>
              <strong>Engineered wood:</strong> 0.5-0.7 tog — Good (check max temp)
            </li>
            <li>
              <strong>Laminate:</strong> 0.5-1.0 tog — Good (UFH rated)
            </li>
            <li>
              <strong>Carpet + underlay:</strong> 1.0-2.5 tog — Limited (&lt;1.5 tog total)
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>System flush:</strong> Flush with mains water until clear, check for debris
            </li>
            <li>
              <strong>Fill and pressurise:</strong> Fill with inhibited water, pressurise to 2.5 bar
            </li>
            <li>
          ...
          <p>
            <strong>Critical Installation Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            ...
            commissioning. Rapid heating can cause screed cracking and permanent damage to the floor
            structure.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A living room measures 5m × 4m with a heat loss of 50 W/m².
            Calculate the required UFH circuits.
          </p>
          ...
          <p>
            <strong>Question:</strong> Calculate the required flow rate for a UFH circuit delivering
            1500W with 10K temperature differential.
          </p>
