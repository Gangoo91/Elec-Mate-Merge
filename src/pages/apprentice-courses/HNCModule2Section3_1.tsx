      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-400/5 border-l-2 border-cyan-400/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Dry air:</strong> 78% N₂, 21% O₂, 1% other gases
              </li>
              <li className="pl-1">
                <strong>Ideal gas law:</strong> PV = mRT (R = 287 J/kg·K)
              </li>
              <li className="pl-1">
                <strong>Air density:</strong> ~1.2 kg/m³ at standard conditions
              </li>
              <li className="pl-1">
                <strong>Specific heat:</strong> cp = 1005 J/kg·K
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-400/5 border-l-2 border-cyan-400/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Air handling:</strong> Mass flow for heat calculations
              </li>
              <li className="pl-1">
                <strong>Ductwork:</strong> Volume flow for sizing
              </li>
              <li className="pl-1">
                <strong>Fan selection:</strong> Density affects fan performance
              </li>
              <li className="pl-1">
                <strong>Altitude:</strong> Corrections for elevated sites
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-cyan-400/80 mb-2">
                Air Density at Various Temperatures (at 101.325 kPa)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-cyan-400/80 mb-2">
                Example 1: Calculating Air Density
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-cyan-400/80 mb-2">
                Example 2: Mass Flow Rate Conversion
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  ṁ = ρ × V̇ = 1.226 × 8.5 = <strong>10.42 kg/s</strong>
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-cyan-400/80 mb-2">
                Example 3: Heating Coil Capacity
              </h3>
              <p className="text-sm text-white mb-2">
