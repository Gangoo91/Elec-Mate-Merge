...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['1005 J/kg·K', '8.314 J/mol·K', '287 J/kg·K', '461 J/kg·K'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1.5 kg/m³', '0.8 kg/m³', '1.2 kg/m³', '1.0 kg/m³'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['718 J/kg·K', '287 J/kg·K', '1005 J/kg·K', '1860 J/kg·K'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1.284 kg/m³', '1.084 kg/m³', '1.384 kg/m³', '1.184 kg/m³'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['378 J/kg·K', '461 J/kg·K', '718 J/kg·K', '287 J/kg·K'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['100 kPa', '1013.25 kPa', '101.325 kPa', '10.1325 kPa'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['18 g/mol', '29 g/mol', '28 g/mol', '32 g/mol'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['718 J/kg·K', '1860 J/kg·K', '287 J/kg·K', '1005 J/kg·K'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE Guide A is the UK reference for the property values you plug into ideal-gas and
              sensible-heat equations. When your client or BMS data uses different reference
              conditions, document the source so the calculation is auditable in the project
        ...
        >
          <p>
            Specific heat capacity determines how much energy is required to change the temperature
            of air. This is fundamental to all HVAC heating and cooling calculations.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Specific heat (constant volume), cv:</strong> Dry air 718 J/kg·K, water vapour
              1399 J/kg·K
            </li>
            <li>
          ...
          <p>
            <strong>Note:</strong> For moist air, the effective specific heat is slightly higher due
            to the water vapour content. A typical value of 1.02 kJ/kg·K is often used for humid air
        ...
        >
          <p>
            <strong>Example 1: Calculating Air Density.</strong> Calculate the density of dry air at
          ...
          <p>
            <strong>Example 2: Mass Flow Rate Conversion.</strong> An AHU delivers 8500 l/s at 15°C.
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Step 3: Calculate mass flow. ṁ = ρ × V̇ = 1.226 × 8.5 = <strong>10.42 kg/s</strong>
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              This is 7% less than sea level (1.205 kg/m³). Fan capacity must be increased
              accordingly.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You are sizing a 100% fresh-air AHU for a 1,200 m² office. The mechanical schedule
              asks for 8 l/s per person at 80 occupants — 6,400 l/s of outside air at -3 °C UK
              winter design — to be tempered to 18 °C before reaching the heat-recovery wheel.
            </>
          }
          whatToDo={
            <>
              Calculate density at -3 °C and 101.325 kPa using ρ = P/(RT). Convert volume flow to
              mass flow (ṁ = ρ × V̇). Apply the sensible heat equation Q̇ = ṁ × cp × ΔT with cp =
              1.005 kJ/kg·K. Add a 10% margin for fan heat gain and duct losses. Cross-check against
              the CIBSE Guide B simplified method.
            </>
          }
          whyItMatters={
            <>
              Treating air at 1.2 kg/m³ regardless of temperature understates winter coil duty by
              ~7%. The plant trips on cold morning starts, the building can&rsquo;t hit the BMS
              setpoint, and the contractor swallows a free coil upgrade in year one. The ideal-gas
              calculation gives the defendable design figure.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Psychrometrics</div>
          </button>
          <button
