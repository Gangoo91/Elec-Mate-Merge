...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Well-defined, straightforward projects typically use 5-7% contingency. Higher percentages are reserved for complex, uncertain, or refurbishment projects where unknowns are more likely.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Monte Carlo simulation runs thousands of project scenarios with varying risk outcomes to produce probability distributions for cost and schedule, giving confidence levels for project targets.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Refurbishment projects frequently encounter unknown existing conditions - asbestos, outdated wiring, structural constraints - that only become apparent once walls and ceilings are opened up.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'A risk owner is the person responsible for monitoring their assigned risk, tracking its status, and ensuring that planned mitigation or response actions are implemented effectively.',
  },
  {
    id: 10,
    ...
    correctAnswer: 0,
    explanation:
      "Contingency covers identified risks that have been assessed and planned for. Management reserve is held separately for truly unexpected 'unknown unknowns' and requires senior approval to access.",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Risk register:</strong> Living document tracking all project risks
              </li>
              <li className="pl-1">
                <strong>Assessment types:</strong> Qualitative (H/M/L) and quantitative (EMV)
              </li>
              <li className="pl-1">
                <strong>Response strategies:</strong> Avoid, transfer, mitigate, or accept
              </li>
              <li className="pl-1">
                <strong>Contingency:</strong> 10-15% typical for complex MEP projects
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Coordination:</strong> Service clashes in ceiling voids
              </li>
              <li className="pl-1">
                <strong>Procurement:</strong> Long lead items (switchgear, chillers)
              </li>
              <li className="pl-1">
                <strong>Existing conditions:</strong> Hidden services, asbestos
              </li>
              <li className="pl-1">
                <strong>Commissioning:</strong> Dependent on building completion
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Brainstorming workshops:</strong> Structured sessions with project team
                  and stakeholders
                </li>
                <li className="pl-1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Clear statement of risk event
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Switchgear delivery delayed beyond programme date
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Mitigate - early order, alternative supplier
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6">
              ...
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse text-center">
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-white/10 px-2 py-2 bg-white/5 font-medium">
                        Very High (5)
                      </td>
                    ...
                    <tr>
                      ...
                      <td colSpan={5} className="border border-white/10 px-2 py-2 text-left">
                        IMPACT →
                      </td>
                    </tr>
                  </tbody>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Redesign routing to avoid complex coordination area
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Insurance, performance bonds, subcontract clauses
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Minor coordination clashes resolved on site
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              <p className="text-sm font-medium text-red-400 mb-2">
                Risk Transfer Mechanisms in Construction
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Mitigation Actions for MEP Risks
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Contingency Calculation Approaches
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Fixed % based on project type
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Early estimates, simple projects
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Sum of EMVs</td>
                      <td className="border border-white/10 px-3 py-2">
                        Total of all risk EMV values
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Detailed risk analysis completed
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Design changes, specialist systems
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Access restrictions, disruption
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Common MEP-Specific Project Risks
              </p>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: EMV Calculation for Risk Register
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Risk Response Selection
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="text-red-400">
                  Avoid: Change switchboard specification - Not viable, client requirement
                </p>
                <p className="text-blue-400">
                  Transfer: Liquidated damages to supplier - Doesn't solve programme issue
                </p>
                <p className="text-yellow-400">
                  Mitigate: Place order immediately with advance payment
                </p>
                <p className="text-green-400">Accept: Not appropriate for red-zone risk</p>
                <p className="mt-2 text-green-400">
                  → Selected: <strong>Mitigate</strong>
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90 space-y-1">
                ...
                <p>
                  <strong>Impact:</strong> High (4) - £20,000 / 2 weeks
                </p>
                <p>
