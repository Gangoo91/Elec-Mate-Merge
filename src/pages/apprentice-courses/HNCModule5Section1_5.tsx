...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['£35,000', '£50,000', '£150,000', '£15,000'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Commercial risk', 'Programme risk', 'Safety risk', 'Technical risk'],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 9,
    question: 'A Monte Carlo simulation in risk analysis is used to:',
    options: [
  ...
  },
  {
    id: 10,
    question:
      'Which type of risk is most characteristic of building services compared to general construction?',
    options: [
...
const faqs = [
  ...
  {
    question: 'What is the difference between contingency and management reserve?',
    answer:
  ...
  {
    question: 'How do I quantify risks when I have limited historical data?',
    answer:
  ...
  {
    question: 'How do I manage risks that emerge from subcontractors?',
    answer:
  ...
  {
    question: 'What is opportunity management in the context of project risk?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Risk management on a construction project starts at design — Reg 9(2) places a
              hierarchical duty on designers to eliminate, then reduce, then control. As project
              manager you inherit the residual risks the designer could not eliminate; your risk
              register is the bridge between Reg 9(2) (design) and Reg 13 (construction) compliance.
            </>
          }
        ...
        <ConceptBlock title="Risk Identification and the Risk Register">
          <p>
            Effective risk management begins with systematic identification of potential threats and
            opportunities that could affect project objectives. For MEP projects, this requires
            input from designers, project managers, site supervisors, and specialist subcontractors.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Risk Description:</strong> Clear statement of risk event — Switchgear delivery
              delayed beyond programme date
            </li>
            <li>
        ...
        <ConceptBlock title="Risk Assessment - Qualitative and Quantitative">
          <p>
            Once risks are identified, they must be assessed to determine priority for response. Two
            complementary approaches exist: qualitative assessment for rapid prioritisation and
            quantitative analysis for precise cost and schedule impact calculation.
          </p>
          <p>
        ...
        <ConceptBlock title="Risk Response Strategies">
          <p>
            ...
            strategies for negative risks (threats) each have appropriate applications depending on
            the risk characteristics and project context.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Avoid:</strong> Eliminate the risk by changing the plan — Redesign routing to
              avoid complex coordination area
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Professional indemnity insurance:</strong> Covers design errors and omissions
            </li>
            <li>
        ...
        <ConceptBlock title="Contingency Planning and MEP-Specific Risks">
          ...
          <p>
            <strong>
              Contingency Calculation Approaches (Method — Description — When to Use):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Percentage of cost:</strong> Fixed % based on project type — Early estimates,
              simple projects
            </li>
            <li>
            ...
            <li>
              <strong>Expert judgement:</strong> Based on similar project experience — Limited data
              available
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Transfer: Liquidated damages to supplier - Doesn't solve programme issue</li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Actions:</strong> Weekly BIM coordination meetings, 3D clash detection before
              installation
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Percentage-only contingency</strong> — Should be justified by risk analysis
              </li>
              <li>
                <strong>Ignoring residual risk</strong> — Mitigation rarely eliminates risk entirely
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              During strip-out for a refurbishment, the electrical sub finds suspected asbestos
              lagging behind a riser bulkhead. The pre-construction information showed the floor as
              "asbestos-free post-2008 refurb". Work in the riser stops immediately. The principal
              designer's risk register did not flag legacy AIB risk in concealed locations.
            </>
          }
          whatToDo={
            <>
              Halt all riser works. Quarantine the area with signage. Notify the principal designer,
              principal contractor and client the same day. Engage a UKAS-accredited asbestos
              surveyor for an R&D survey in the riser, not just the visible areas. Update the risk
              register: probability raised to "occurred", impact assessed against schedule and cost,
              mitigation = HSE-licensed removal contractor. Issue early warning under the contract.
              Update the construction phase plan. Resume only after clearance certificate.
            </>
          }
          whyItMatters={
            <>
              An incomplete pre-construction information package transfers risk silently to the
              contractor. Your risk register is how you protect the project: when something
              foreseeable was not flagged by the PD, you have evidence that the residual risk was
              not in your scope. Without that audit trail, you absorb the cost.
            </>
          }
        />
