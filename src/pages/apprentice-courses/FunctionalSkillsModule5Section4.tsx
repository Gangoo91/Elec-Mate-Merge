      ...
      <div className="sticky top-0 z-10 bg-elec-dark/95 backdrop-blur-sm border-b border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-base font-bold text-white">Portfolio Building & Evidence</h1>
          </div>
        </div>
      </div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              portfolio that meets their expectations first time, avoiding delays and additional
              work.
            </p>
            <p>
              Assessors are experienced professionals who have reviewed hundreds of portfolios. They
              are not looking for perfection — they want to see genuine, authentic evidence that you
              can apply functional skills in real workplace situations. They want clarity,
              organisation, and evidence that covers every criterion.
            </p>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Clear structure:</strong> A logical layout with a
                  contents page, index, and dividers makes it easy to find evidence
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Cross-referencing:</strong> A matrix linking each
                  piece of evidence to the criteria it covers
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Variety:</strong> A mix of evidence types —
                  reflective accounts, work products, photographs, witness statements
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Real-world context:</strong> Evidence drawn from
                  genuine work activities, not artificial exercises
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Reflection:</strong> Accounts that show you
                  understand what you did and why, not just that you followed instructions
                </span>
              </li>
            </ul>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              different criteria, so understanding what is available helps you match the right
              evidence to each requirement.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-green-400 font-semibold text-xs">
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                demonstrate your competence from multiple angles.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              dated, and linked to the skills it demonstrates. Here is how to take photographs that
              assessors will value.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-xs text-white/70">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Always ask permission:</strong> Before
                    photographing on any site, ask the site manager or your supervisor. Some sites
                    prohibit photography for security or client confidentiality reasons.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Before, during and after:</strong> Take photos at
                    key stages of the work. A "before" photo shows the starting condition, "during"
                    shows your work in progress, and "after" shows the completed result.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Good lighting:</strong> Ensure the subject is
                    well-lit. Use the flash on your phone if needed. A dark, blurry photo is useless
                    as evidence.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Context and close-up:</strong> Take both a wide
                    shot showing the overall installation and close-ups showing detail. The wide
                    shot provides context; the close-up proves quality.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">No people without consent:</strong> Avoid
                    photographing colleagues or members of the public without their explicit
                    consent.
                  </span>
                </li>
              </ul>
            ...
            <p>
              Every photograph in your portfolio must have a caption. Without a caption, the
              assessor has no way of knowing what the photo shows or what your involvement was.
            </p>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <div className="bg-white/5 rounded-lg p-3 text-xs text-white/70 space-y-1">
                ...
                <p>
                  <strong className="text-white">Location:</strong> Kitchen, 42 Oak Lane, Leeds
                </p>
                <p>
                  <strong className="text-white">Description:</strong> Completed consumer unit
                  installation showing 10-way board with RCBO protection on all circuits
                </p>
                <p>
                  <strong className="text-white">My Role:</strong> I installed and wired the
                  consumer unit under supervision of my qualified electrician. I terminated all
                  circuit cables, labelled each circuit, and fitted the enclosure cover.
                </p>
                <p>
                  <strong className="text-white">Criteria covered:</strong> Unit 3, Criteria 3.2,
                  3.4
                </p>
              </div>
            </div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  Print photos clearly if using a physical portfolio — colour is strongly preferred
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  For digital portfolios, create a folder structure by job or by criterion
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  Back up your photos immediately — losing them means losing evidence you cannot
                  recreate
                </span>
              </li>
            </ul>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                and provides invaluable portfolio evidence.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              produce as part of your work can be valuable portfolio evidence, provided it is
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="bg-white/5 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 text-xs text-white/70">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Material order forms and delivery notes</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Test certificates and inspection reports</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 text-xs text-white/70">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Reports to your supervisor</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Meeting notes you have written</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Safety briefing documents</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 text-xs text-white/70">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Cost calculations and quotes</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                ...
                <div className="bg-white/5 rounded-lg p-3">
                  ...
                  <ul className="space-y-1 text-xs text-white/70">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Presentations for toolbox talks</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Formatted letters or notices</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-green-400 mt-0.5">•</span>
                      <span>Screenshots of digital work</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Annotate it:</strong> Add a brief note explaining
                  what the document is, when you created it, and which criteria it covers
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Remove sensitive information:</strong> Redact
                  customer names, addresses, or financial details that are not relevant to the
                  evidence
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Show your contribution:</strong> If the document
                  was a team effort, clearly indicate which parts were your work
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Keep copies:</strong> Always keep a copy of any
                  document you submit. Originals can be lost or damaged.
                </span>
              </li>
            </ul>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                email you write professionally, every calculation you perform, and every document
                you create is potential portfolio evidence.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              someone else vouching for your skills carries significant weight with assessors.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-xs text-white/70">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Your supervisor or line manager:</strong> The
                    most common and most valued witness — they observe your work daily
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Qualified electricians you work with:</strong>{' '}
                    Colleagues who can confirm your practical competence
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Site managers:</strong> Can confirm your
                    professionalism, communication, and adherence to site rules
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">College tutors:</strong> Can confirm your
                    academic performance and classroom contributions
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    <strong className="text-white">Clients (occasionally):</strong> Customer
                    feedback letters can support evidence of professional communication
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <div className="bg-white/5 rounded-lg p-3 text-xs text-white/70 space-y-2">
                ...
                <p>
                  <strong className="text-white">Job Title:</strong> Senior Electrician, ABC
                  Electrical Ltd
                </p>
                <p>
                  <strong className="text-white">Date:</strong> 22 January 2026
                </p>
                <p>
                  <strong className="text-white">Statement:</strong> I can confirm that [apprentice
                  name] competently assisted with the full rewire of a three-bedroom semi-detached
                  property at [address]. They independently measured and calculated cable lengths
                  for all circuits, producing an accurate material list. They correctly terminated
                  cables at the consumer unit, ensuring all connections were tight and labelled
                  correctly. Throughout the job, they communicated clearly with the customer about
                  timescales and disruption. Their work was completed to the required standard with
                  no remedial work needed.
                </p>
                <p>
                  <strong className="text-white">Criteria covered:</strong> Units 2 and 3, Criteria
                  2.1, 2.3, 3.2, 3.4
                </p>
                <p>
                  <strong className="text-white">Signature:</strong> [Signed]
                </p>
              </div>
            </div>

            <h4 className="text-white font-semibold pt-2">
              Tips for Getting Good Witness Testimonies
            </h4>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Ask promptly:</strong> Request the testimony while
                  the work is fresh in the witness's mind — not months later
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Make it easy:</strong> Provide a template or bullet
                  points of what you would like them to comment on
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Be specific:</strong> Ask them to describe specific
                  tasks, not just general praise. "They did a great job" is weak; "They accurately
                  calculated cable lengths for six circuits" is strong.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Cross-reference:</strong> Include the criteria
                  numbers the testimony covers to help your assessor
                </span>
              </li>
            </ul>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              understanding and decision-making, not just your practical ability. A good reflective
              account proves you know what you did and why.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <div className="bg-white/5 rounded-lg p-3 text-xs text-white/70 space-y-2">
                <p>
                  ...
                  lengths needed for all circuits before ordering materials from the wholesaler.
                </p>
                <p>
                  <strong className="text-green-400">Task:</strong> I was asked to measure all cable
                  runs and produce a material list with quantities and costs. I needed to measure
                  each room, calculate cable runs including drops and rises, and add a 10% wastage
                  allowance as per company policy.
                </p>
                <p>
                  <strong className="text-green-400">Action:</strong> I measured each room using a
                  tape measure, recorded the dimensions in my notebook, and calculated the cable
                  runs for each circuit. I used a spreadsheet on my phone to total the lengths and
                  applied a 10% wastage factor. I then looked up cable prices from our supplier's
                  catalogue and produced a material list totalling £342.50. I emailed this to my
                  supervisor for approval before placing the order.
                </p>
                <p>
                  <strong className="text-green-400">Result:</strong> The material list was accurate
                  and the order was placed the same day. We had enough cable for the full rewire
                  with minimal waste — only 3 metres of twin and earth was left over. My supervisor
                  confirmed the calculations were correct and said the material list was
                  well-presented. I learned that measuring carefully at the start saves both time
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                completed the work satisfactorily" do not demonstrate competence.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              overlooked, criteria appearing to be uncovered, and unnecessary delays in your
              assessment.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <div className="space-y-2 text-xs text-white/70">
                <div className="flex items-start gap-3 bg-white/5 rounded-lg p-2">
                  ...
                  <span>
                    <strong className="text-white">Front cover:</strong> Your name, apprenticeship
                    programme, training provider, and start date
                  </span>
                </div>
                <div className="flex items-start gap-3 bg-white/5 rounded-lg p-2">
                  <span className="text-green-400 font-bold min-w-[24px]">2.</span>
                  <span>
                    <strong className="text-white">Contents page:</strong> List of all evidence with
                    page numbers, updated as you add material
                  </span>
                </div>
                <div className="flex items-start gap-3 bg-white/5 rounded-lg p-2">
                  <span className="text-green-400 font-bold min-w-[24px]">3.</span>
                  <span>
                    <strong className="text-white">Cross-referencing matrix:</strong> Table showing
                    which evidence covers each assessment criterion
                  </span>
                </div>
                <div className="flex items-start gap-3 bg-white/5 rounded-lg p-2">
                  <span className="text-green-400 font-bold min-w-[24px]">4.</span>
                  <span>
                    <strong className="text-white">Personal statement:</strong> Brief introduction
                    about yourself, your role, and your apprenticeship goals
                  </span>
                </div>
                <div className="flex items-start gap-3 bg-white/5 rounded-lg p-2">
                  <span className="text-green-400 font-bold min-w-[24px]">5.</span>
                  <span>
                    <strong className="text-white">Evidence sections:</strong> Organised by
                    unit/module or by evidence type, with dividers
                  </span>
                </div>
                <div className="flex items-start gap-3 bg-white/5 rounded-lg p-2">
                  <span className="text-green-400 font-bold min-w-[24px]">6.</span>
                  <span>
                    <strong className="text-white">Certificates:</strong> Copies of all relevant
            ...
            <p>
              The cross-referencing matrix is the most important organisational tool in your
              portfolio. It is a simple table that maps each piece of evidence to the criteria it
              covers.
            </p>
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <div className="flex items-center gap-2 mb-3">
              ...
              <ul className="space-y-2 text-xs text-white/70">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    For each criterion, record which evidence item(s) cover it (e.g., "RA1" for
                    Reflective Account 1, "WS3" for Witness Statement 3, "Photo07")
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>
                    One piece of evidence can cover multiple criteria — this reduces the total
                    amount needed
                  </span>
                </li>
                <li className="flex items-start gap-2">
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                scratch in the final weeks before assessment.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white/80 leading-relaxed">
            <p>
              ...
              reduces the chance of your portfolio being returned for additional work.
            </p>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Know your evidence:</strong> Review your portfolio
                  before the visit so everything is fresh in your mind
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Navigate quickly:</strong> Practise finding
                  specific evidence using your index and cross-referencing matrix
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Be honest:</strong> If you cannot remember the
                  details of something, say so — do not make things up
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Use technical language:</strong> Where appropriate,
                  use the correct terminology — it demonstrates competence
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  <strong className="text-white">Be professional:</strong> Treat the assessment as a
                  professional meeting — be punctual, polite, and prepared
                </span>
              </li>
            </ul>
            ...
            <p>
              Assessors ask questions to confirm that the evidence is genuine and that you
              understand what you did. Common question types include:
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  "Can you tell me about this piece of evidence?" — Describe what the work was, what
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  "Why did you choose this approach?" — Explain your reasoning and any alternatives
                  you considered
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  "What would you do differently next time?" — Shows you can reflect and improve
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">•</span>
                <span>
                  "Can you show me the evidence for criterion X?" — Use your matrix to locate it
                  quickly
                </span>
              </li>
            </ul>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white/80">
                ...
                arrives, you will have a comprehensive, well-organised portfolio that demonstrates
                your competence — and the assessment will feel like a formality rather than a
                hurdle.
              </p>
            </div>
          </div>
