...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1000 kWh/kWp', '850 kWh/kWp', '950 kWh/kWp', '900 kWh/kWp'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['80-85%', '70-75%', '98-99%', '90-95%'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Mode 2', 'Mode 3', 'Mode 4', 'Mode 1'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['±0.2Hz', '±0.5Hz', '±2.5Hz', '±1.5Hz'],
    correctAnswer: 3,
    explanation:
...
const HNCModule3Section6_7 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 6 · Subsection 7"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS 7671 Sections 712, 722 and 551 are the three primary special-locations regs for
              renewables / EV / storage integration. The A4:2026 amendment specifically tightened
              PEN-fault protection on PME-supplied outdoor EV chargers. As BSE designer of any
              modern building, you orchestrate these sections plus the ENA Engineering
              Recommendations (G98, G99, G100) plus the relevant product-standard suite (IEC 62548
              PV, BS EN 62619 BESS, IEC 61851 EV) into one integrated submission.
            </>
          }
        ...
        <ConceptBlock title="Solar PV Systems and Grid Connection">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Inverters:</strong> String inverters, microinverters, or power optimisers with
              central inverter
            </li>
            <li>
              <strong>Mounting systems:</strong> Roof-mounted (pitched/flat), building-integrated
              (BIPV), ground-mounted
            </li>
            <li>
              <strong>AC distribution:</strong> Connection point, metering, protection and isolation
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">UK PV Performance Parameters</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Specific yield</strong> — 850-1000 kWh/kWp/year — South-facing, unshaded,
              optimal tilt
            </li>
            <li>
              <strong>Performance ratio</strong> — 0.75-0.85 — Actual vs theoretical output
            </li>
            <li>
              <strong>Optimal orientation</strong> — South ±30° — East/West reduces yield by ~15%
            </li>
            <li>
              <strong>Optimal tilt angle</strong> — 30-40° — Lower for self-consumption focus
            </li>
            <li>
              <strong>Area per kWp</strong> — 5-7 m² — Depends on module efficiency
            </li>
            <li>
              <strong>Degradation</strong> — 0.5-0.7% per year — Typically 80% output at 25 years
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">PV System Sizing Example</p>
          ...
          <p>
            ...
            (DC/AC ratio of 1.1-1.3) can improve economics by capturing more energy during shoulder
            periods while clipping only peak output.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="G98/G99 Requirements for Embedded Generation">
          <p>
            ...
            generation equipment to distribution networks. Compliance is mandatory for all
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>G98</strong> — ≤16kW per phase (≤50kW 3-phase) — Notification only — Within 28
              days of commissioning
            </li>
            <li>
              <strong>G99</strong> — &gt;16kW per phase (or &gt;50kW 3-phase) — Full application and
              approval — 45-90 working days typical
            </li>
          </ul>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">G98 Notification Contents</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">G99 Application Requirements</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Battery Energy Storage Systems (BESS)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lithium Iron Phosphate (LFP)</strong> — 92-96% — 6000+ — Commercial,
              grid-scale (safety focus)
            </li>
            <li>
              <strong>Lithium NMC</strong> — 90-95% — 3000-5000 — Domestic, commercial (energy
              density)
            </li>
            <li>
              <strong>Lead-acid (VRLA)</strong> — 80-85% — 500-1500 — UPS, backup power
              (cost-sensitive)
            </li>
            <li>
              <strong>Flow batteries</strong> — 70-80% — 10000+ — Large-scale, long duration
            </li>
          </ul>
          ...
          <p>→ Select 120kWh, 60kW battery system (0.5C rating)</p>
        ...
        <ConceptBlock title="Hybrid Systems and Load Matching">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Typical Self-Consumption Rates</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PV only (domestic)</strong> — 25-40% — Depends on occupancy patterns
            </li>
            <li>
              <strong>PV + battery (domestic)</strong> — 60-80% — Battery sized at ~1kWh/kWp
            </li>
            <li>
              <strong>PV only (commercial)</strong> — 40-70% — Daytime operation matches generation
            </li>
            <li>
              <strong>PV + battery (commercial)</strong> — 70-90% — Peak shaving and evening use
            </li>
          </ul>
        ...
        <ConceptBlock title="EV Charging Infrastructure">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">EV Charging Modes (IEC 61851)</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Mode 2</strong> — 2.3kW (10A max) — Standard socket + ICCB —
              Emergency/occasional use only
            </li>
            <li>
              <strong>Mode 3 (single-phase)</strong> — 3.6-7.4kW — Dedicated EVSE (Type 2) —
              Domestic, workplace
            </li>
            <li>
              <strong>Mode 3 (three-phase)</strong> — 11-22kW — Dedicated EVSE (Type 2) —
              Commercial, fleet depots
            </li>
            <li>
              <strong>Mode 4 (DC rapid)</strong> — 50-350kW — DC fast charger (CCS/CHAdeMO) — Public
              rapid charging, fleet hubs
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>EV Smart Charge Regulations 2021:</strong> Domestic chargers must have smart
              functionality
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">EV Charger Circuit Design</p>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Smart Charging Features</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Load Management Options</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            ...
            rated current for hours is normally assessed at 100% with no diversity. Reductions are
            only justified where a load management or demand-control arrangement actively limits the
            output — in which case size on the limited value and record the basis in the design.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Smart Grid Integration">
          ...
          <p className="text-sm font-medium text-white">Grid Services and Flexibility Markets</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Battery storage</strong> — &lt;1 second — Minutes to hours — Frequency
              response, DSR, arbitrage
            </li>
            <li>
              <strong>EV charging</strong> — Seconds — Hours — DSR, V2G services
            </li>
            <li>
              <strong>HVAC systems</strong> — Minutes — 15min-2hr — DSR (thermal mass provides
              buffer)
            </li>
            <li>
              <strong>Lighting</strong> — Instant — Minutes — Limited DSR (dimming)
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Communication Protocols</p>
        ...
        <ConceptBlock title="Microgrids and Islanding">
          <p>
            Microgrids are localised energy systems capable of operating independently from the main
            grid. They combine generation, storage and loads with intelligent control to provide
            resilience, optimise energy use and enable community-scale renewable integration.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Grid-connected</strong> — Normal operation, grid provides reference — Standard
              G98/G99 compliance
            </li>
            <li>
              <strong>Intentional island</strong> — Planned disconnection (maintenance) — Transfer
              switching, load shedding
            </li>
            <li>
              <strong>Unplanned island</strong> — Grid failure, automatic transition — Black-start
              capability, fast transfer
            </li>
            <li>
              <strong>Resynchronisation</strong> — Reconnection to grid — Synchronisation check
              relay
            </li>
          </ul>

          <p className="text-sm font-medium text-white">BS 7671 Section 551 Requirements</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Switching arrangements must prevent paralleling of incompatible sources</li>
            <li>Automatic changeover devices must be type-tested for the application</li>
            <li>Earth fault loop impedance must be verified for each source configuration</li>
            <li>Standby supply ratings must be adequate for connected loads</li>
            <li>Labels required at all switch positions and supply points</li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Islanding Protection Scheme</p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Office building, 100,000 kWh annual consumption, 150kW peak
            demand, aiming for 40% renewable supply with peak shaving.
          </p>
          ...
          <p>→ G99 application required (50kW exceeds G98 limit)</p>

          <p className="text-sm font-medium text-elec-yellow/80">
            Example 2: Multi-EV Charger Installation
          </p>
          <p>
            <strong>Scenario:</strong> Car park with 10 × 7.4kW chargers, 100A three-phase supply
            available.
          </p>
          ...
          <p>
            Additional annual benefit = (£810 + £135) - (£378 + £351) = <strong>£216/year</strong>
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A secondary school is adding 200 kWp rooftop solar PV + 250 kWh / 100 kW battery
              storage + 12&times;22 kW EV chargers in the staff carpark. The existing DNO supply is
              250 kVA TN-C-S (PME). The combined export capability of PV is 200 kW &mdash; well
              above the G98 single-phase threshold, so the project is in G99 scope. The carpark
              chargers raise BS 7671 722 PEN-fault questions.
            </>
          }
          whatToDo={
            <>
              Three workstreams: (a) Submit G99 application to the DNO with PV + BESS interface
              protection settings (LoM, RoCoF, U/V, U/F); apply for G100 export limitation if needed
              to cap at the existing supply capacity; (b) for the EV chargers, specify chargers with
              integrated PEN-fault detection (the cheaper compliant option than dedicated TT earth
              electrodes) per BS 7671 722.411.4.1; (c) integrate PV + BESS + EV charging on a common
              BMS controller with dispatch logic that charges BESS from PV, supplies EV charging
              from BESS / PV during daytime, and exports any surplus within the G100 limit. Document
              the whole scheme in one DNO submission and update the building log book.
            </>
          }
          whyItMatters={
            <>
              Schools, council buildings and commercial sites are all moving to the same combined PV
              + BESS + EV pattern. The HNC engineer who can navigate G98/G99/G100 + BS 7671 712 /
              722 / 551 simultaneously is the BSE profession&rsquo;s scarce skill in 2026 onwards.
              Getting the integrated submission right first time saves months of DNO back-and-forth.
            </>
          }
        />
