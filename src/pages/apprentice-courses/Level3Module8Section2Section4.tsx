...
const TITLE = 'Common pitfalls and recovery for the L3 paper | Level 3 Module 8.2.4 | Elec-Mate';
const DESCRIPTION =
...
const faqs = [
  {
    question: "What's the single most common L3 paper mistake?",
    answer:
  ...
  {
    question: 'How often should I change answers in the review pass?',
    answer:
  ...
  {
    question: 'I keep getting EICR coding questions wrong on the C2-vs-C3 boundary. What do I do?',
    answer:
  ...
  {
    question: "I panic in exams and my mock results don't reflect my real knowledge. What helps?",
    answer:
...
export default function Level3Module8Section2Section4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 2 · Subsection 4"
        title="Common pitfalls and recovery for the L3 paper"
        backTo=".."
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The mistakes that cost Level 3 candidates a pass — over-reading calculation questions,
          second-guessing right answers, EICR coding traps, time-wall panic — and the recovery
          techniques that get you back on track when a paper starts sideways.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Minutes 0-2</strong> on a stuck question — normal effort, looking for the
              formula or the right BS 7671 angle. Acceptable.
            </li>
            <li>
              <strong>Minutes 2-3</strong> — diminishing returns, but you can still justify
              finishing if you're close to converging.
            </li>
            <li>
              <strong>Past minute 3</strong> — you're now in sunk-cost territory. Every additional
              minute costs you most of an entire other question.
            </li>
            <li>
              <strong>Past minute 5</strong> — you're effectively donating marks to the paper. Stop.
              Flag. Pick the most plausible option. Move on.
            </li>
            <li>
              <strong>The reflex</strong> — drilled in every mock — is to flag-and-skip at minute 3
              without negotiation. The instinct to &quot;just finish it&quot; has to be over-ridden
              by training.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Change</strong> if you can identify a specific factual error you made first
              time — a missed clause, a misread number, a wrong-units calculation, a missed negation
              in the stem.
            </li>
            <li>
              <strong>Change</strong> if you've now done a related question that gave you new
              information bearing on this one (rare but happens).
            </li>
            <li>
              <strong>Keep</strong> if the only reason to change is &quot;option D feels more right
              now&quot; — that's second-guessing, and statistically your first answer is more likely
              correct.
            </li>
            <li>
              <strong>Keep</strong> if you're unsure — flagged answers from Pass 1 that you
              genuinely can't decide between in Pass 3 should default to your Pass 1 answer.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Minute 60-62</strong> — survey. Count the unanswered items. Sort mentally into
              three buckets: quick wins (90s each), medium (2-3 min each), pure guess (10s each).
            </li>
            <li>
              <strong>Minutes 62-77</strong> — clear the quick wins. These are the recall items, the
              obvious calculations, the easy coding calls. Bank the marks first.
            </li>
            <li>
              <strong>Minutes 77-87</strong> — medium-effort items. 3-minute hard ceiling each.
              Apply elimination ladder. Pick best of remaining options.
            </li>
            <li>
              <strong>Minutes 87-89</strong> — pure-guess sweep. 10 seconds per question. Eliminate
              the obviously wrong, pick the most plausible. Tick every blank.
            </li>
            <li>
              <strong>Minute 89-90</strong> — final blank-check. Confirm every question has an
              answer. Submit on the bell or at 89:50 — never with blanks remaining.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Three-phase line vs phase</strong> — star: V_line = V_phase &times; root-3,
              I_line = I_phase. Delta: V_line = V_phase, I_line = I_phase &times; root-3. The trap
              is always the option that uses the wrong relationship for the configuration given.
            </li>
            <li>
              <strong>Voltage drop volts vs percent</strong> — calculate volts (Vd = mV/A/m &times;
              Ib &times; L / 1000), then check whether the question asked for volts or percentage.
              The two answers always appear on the option list together as a trap pair.
            </li>
            <li>
              <strong>EICR C2 vs C3</strong> — the &quot;potentially dangerous&quot; vs
              &quot;improvement recommended&quot; line. C2 needs a credible harm pathway in normal
              use; C3 is dated but otherwise sound.
            </li>
            <li>
              <strong>Cable CCC after derating</strong> — the trap distractor is the tabulated It
              value (the cable's CCC if derating wasn't applied). Never pick the raw tabulated value
              if the question gives you derating conditions.
            </li>
            <li>
              <strong>Zs limit by device type and rating</strong> — Table 41.1 has different Zs
              limits for different MCB types (B, C, D) at the same rating. The trap is the right
              number for the wrong device type.
            </li>
            <li>
              <strong>Disconnection time TN vs TT</strong> — TN: 0.4s for socket circuits up to 32A,
              5s for distribution. TT: 0.2s for socket circuits up to 32A, 1s for distribution. The
              trap is the TN values applied to a TT scenario.
            </li>
            <li>
              <strong>Bonding vs earthing terminology</strong> — main protective bonding goes to
              extraneous-conductive-parts (water, gas pipes). Earthing goes via the protective
              conductor to the MET. Distractors mix the two.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Candidate cruises through Units 301-305 mocks at 75-80% and decides Unit 308 (Career
              Awareness) is &quot;just recall&quot; so doesn&apos;t need the same prep. Walks into
              the paper having barely revised the JIB grade names, the AM2 vs AM2E distinction, the
              professional body acronyms and the apprenticeship structure detail. Reads the first
              question on &quot;which JIB grade requires demonstrated competence in design and
              supervision&quot; and realises they only half-remember the grades. Loses 4-5 marks
              across the paper on details they could have nailed with 3 hours of revision.
            </>
          }
          doInstead={
            <>
              Treat Unit 308 like every other L3 paper. Sit at least 3 full mocks under exam
              conditions. Build a recall list of JIB grades, ECS card colours, AM2 vs AM2E,
              professional bodies (IET, ECA, NICEIC, NAPIT, JIB), apprenticeship pathways (2365 vs
              2330 vs 2356) and CPD requirements. The paper is shorter (40Q / 60min) but the
              per-question rate is the same — and the questions reward specific recall, not general
              familiarity.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You sit Unit 304. Question 8 is a multi-step Zs calculation that you spend 6 minutes
              on without converging. You flag it, but you&apos;ve already lost 4 minutes more than
              you should have. You hit minute 45 with only 25 questions answered out of 60. Cortisol
              spikes. Your reading comprehension drops. Question 26 is a coding question and you
              misread the install year as 1997 when it&apos;s 1977. You&apos;re heading for a fail
              at this rate.
            </>
          }
          whatToDo={
            <>
              Stop. Slow box breathing for 30 seconds — 4 in, 4 hold, 4 out, 4 hold. You have 45
              minutes left and 35 questions to clear. Activate triage: survey the remaining 35, sort
              into quick wins / medium / pure guess. Clear the quick wins first (target: 20
              questions in 25 minutes — most of Unit 304 has 8-10 quick recall items per paper).
              Then medium-effort in 15 minutes. Pure guess in 3 minutes. Final blank-check in 2
              minutes. You won&apos;t hit 78% but you&apos;ll likely scrape a pass at 60-65% —
              recoverable. The triage protocol is what saves the paper.
            </>
          }
          whyItMatters={
            <>
              Papers go sideways. The difference between a recoverable pass and a catastrophic fail
              is whether you have a triage protocol drilled into reflex. Candidates who panic and
              slow down lose 15+ marks in the last 30 minutes. Candidates who execute triage lose
              5-8 marks. The paper is won or lost in the recovery, not in the panic.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Week 1</strong> — get the per-topic breakdown from your tutor. The centre will
              have it — your tutor can request it. Identify the 2-3 weakest topics from the failed
              paper.
            </li>
            <li>
              <strong>Weeks 1-2</strong> — focused revision on the weak topics. Not re-reading the
              chapter — drilling worked examples, sitting topic- specific question banks, building
              flashcards for the recall items.
            </li>
            <li>
              <strong>Week 3</strong> — sit a fresh full mock under exam conditions. If you pass at
              70%+, book the re-sit. If not, another week of focused revision and another mock.
            </li>
            <li>
              <strong>Pre-re-sit</strong> — same exam-day prep as for the first attempt: error-log
              review the night before, eat well, sleep well, arrive 30 minutes early.
            </li>
            <li>
              <strong>Mindset</strong> — &quot;I&apos;ve identified the gap, drilled the gap,
              mock-tested above the pass mark. The re-sit is a controlled fix, not a re-roll.&quot;
            </li>
          </ul>
        </ConceptBlock>
