      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3">
            Pure Inductance Circuits
          </h1>
          <p className="text-white/80">
            Inductive reactance, energy storage in magnetic fields, and phase relationships
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Calculate inductive reactance using XL = 2 x pi x f x L",
              "Explain why voltage leads current by 90 degrees in inductors",
              "Determine current flow in pure inductive AC circuits",
              "Calculate energy stored in an inductor's magnetic field",
              "Understand why inductors have zero power factor",
              "Apply inductor concepts to practical electrical situations"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module3-section2-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
