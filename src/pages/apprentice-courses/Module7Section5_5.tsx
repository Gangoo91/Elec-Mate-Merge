  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Live testing is dangerous because it exposes electricians to electric shock, severe burns, and arc flash incidents, all of which can be fatal.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'The Electricity at Work Regulations 1989 require work to be carried out safely, which includes avoiding live testing unless absolutely necessary.',
    },
    {
      id: 3,
      ...
      options: [
        ...
        'Polarity testing with power off',
      ],
      correctAnswer: 2,
      explanation:
        'Earth fault loop impedance testing requires the circuit to be live to measure the actual fault current path and impedance values.',
    },
    {
      id: 4,
      ...
      correctAnswer: 1,
      explanation:
        'Safe isolation procedure must always be followed: isolate the supply, lock it off where possible, and prove dead with a proving unit and voltage indicator.',
    },
    {
      id: 5,
      question: 'What type of PPE should be worn during live testing?',
      options: [
        'Any gloves and glasses',
      ...
      correctAnswer: 1,
      explanation:
        'Insulated gloves provide protection against electric shock, while safety glasses protect eyes from arc flash and flying debris.',
    },
    {
      id: 6,
      ...
      correctAnswer: 1,
      explanation:
        'GS38-compliant leads have safety features including fused leads, insulated probes with minimal exposed metal, and finger guards to reduce shock risk.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'False. Live testing should only be carried out when absolutely necessary and safe isolation is not possible. It should never be routine.',
    },
    {
      id: 8,
      ...
      correctAnswer: 1,
      explanation:
        'Apprentices must never carry out live testing without close supervision from a competent person due to the high risks involved.',
    },
    {
      id: 9,
      ...
      correctAnswer: 1,
      explanation:
        "The electrician's probes slipped while testing live, causing a short circuit that resulted in a flashover, burns, and damage to the consumer unit.",
    },
    {
      id: 10,
      question: 'How was RCD testing carried out safely in the second example?',
      options: [
        'Working alone quickly',
        'With supervision, PPE, GS38 leads, and controlled area',
        'Using different equipment',
        'Testing during the day only',
      ],
      correctAnswer: 1,
      explanation:
        'Safe RCD testing involved supervision, proper PPE, GS38-compliant leads, keeping the area clear of non-essential people, and following strict precautions.',
    },
  ];
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <section className="mb-10">
            <p className="text-white/80 leading-relaxed">
              ...
              — such as earth fault loop impedance or RCD testing — the guiding principle for
              electricians is always to avoid live work unless absolutely necessary. Apprentices
              must understand when live testing is unavoidable, how to minimise the risks, and why
              safe isolation is the default approach in every situation.
            </p>
          </section>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-4">
              <div className="space-y-4 text-sm text-white/80">
                <p>
                  ...
                  electrician should switch off the supply, lock it off where possible, and use a
                  proving unit with a voltage indicator to confirm the circuit is dead. This removes
                  the risk of shock, burns, and arc flash completely.
                </p>

                <p>
                  <strong className="text-white">Not routine or a shortcut:</strong> Working live
                  should never be treated as routine or a shortcut to save time. The default
                  position must always be to isolate first, then test. Every electrician should ask
                  themselves: "Can this be done safely with the power off?" In the vast majority of
                  cases, the answer is yes.
                </p>

                <p>
                  <strong className="text-white">Methodical and documented procedures:</strong> Safe
                  isolation procedures must be methodical and documented. This includes identifying
                  the correct isolator, securing it in the off position with locks where possible,
                  placing warning notices, and using a proving unit to confirm the circuit is dead
                  before starting work.
                </p>

                <p>
                  <strong className="text-white">Lock-off procedures:</strong> Lock-off procedures
                  prevent accidental re-energisation while work is in progress. Where multiple
                  trades are working, a multi-lock system ensures no one person can restore the
                  supply while others are still working. Permits to work may also be required in
            ...
            <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50 mb-4">
              <div className="space-y-4 text-sm text-white/80">
                <p>
                  ...
                  fault loop impedance (Ze, Zs), verifying polarity under load, testing RCD trip
                  times and ramp testing, measuring prospective fault current, and functional
                  testing of equipment that must be energised.
                </p>

                <p>
                  <strong className="text-white">Risk reduction:</strong> Even in these cases, the
                  risks must be reduced as far as reasonably practicable. This means wearing
                  appropriate PPE such as safety glasses and insulated gloves, ensuring the work
                  area is clear of distractions, and using GS38-compliant instruments with fused
                  leads and finger guards.
                </p>

                <p>
                  <strong className="text-white">Environment control:</strong> The work environment
                  must be controlled: adequate lighting, dry conditions, clear access and egress
                  routes, and barriers to prevent interruption. All non-essential personnel should
                  be kept away from the work area during live testing.
                </p>

                <p>
                  <strong className="text-white">Risk assessments:</strong> Risk assessments for
                  live testing must consider the specific hazards: voltage level, available fault
                  current, environmental conditions, access restrictions, and the competency of
                  personnel. Higher voltages and fault levels require more stringent precautions.
                </p>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50 mb-4">
              <div className="space-y-4 text-sm text-white/80">
                <p>
                  ...
                  competent person. The risks are too high for someone still learning the trade to
                  work independently on live systems. Supervision means direct oversight, not just
                  being available nearby.
                </p>

                <p>
                  <strong className="text-white">Electricity at Work Regulations 1989:</strong>{' '}
                  These regulations place clear duties on employers and employees to prevent danger.
                  Regulation 4 requires that all electrical systems are constructed and maintained
                  to prevent danger, while Regulation 14 specifically addresses work on or near live
                  conductors.
                </p>

                <p>
                  <strong className="text-white">Competency requirements:</strong> Competency must
                  be demonstrated before any live work is undertaken. This includes understanding
                  the equipment, the hazards, the precautions needed, emergency procedures, and
                  rescue techniques. Training and assessment are legal requirements, not optional
                  extras.
                </p>

                <p>
                  <strong className="text-white">Employer duties:</strong> Employers have specific
                  duties under the regulations to ensure only competent persons carry out electrical
                  work, provide appropriate equipment and PPE, establish safe systems of work, and
            ...
            <InlineCheck
              ...
              options={[
                ...
                'No, they must be supervised by a competent person',
                'Only simple tests',
              ]}
              correctIndex={2}
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50 mb-4">
              <div className="space-y-4 text-sm text-white/80">
                <p>
                  ...
                  answer is yes, isolation should take place immediately. Do not take shortcuts or
                  assume live testing is quicker — the time saved is never worth the risk to life
                  and safety.
                </p>

                <p>
                  <strong className="text-white">Careful planning:</strong> If live testing is
                  absolutely required, plan carefully. Conduct a specific risk assessment, obtain
                  necessary permits, wear appropriate PPE, ensure the area is controlled, and
                  complete the task quickly and efficiently with the correct GS38-compliant
                  equipment.
                </p>

                <p>
                  <strong className="text-white">Documentation:</strong> Always document the reason
                  for working live and the precautions taken. This provides evidence of a
                  professional approach and helps others learn from your risk assessment and control
                  measures. Documentation also demonstrates compliance with legal duties.
                </p>

                <p>
                  <strong className="text-white">Emergency arrangements:</strong> Emergency
                  arrangements must be in place before starting live work. This includes having
                  appropriately trained personnel available for rescue, ensuring communication
                  systems work, and having emergency contact numbers readily available.
                </p>
              </div>
            </div>
            ...
            <InlineCheck
              ...
              options={[
                ...
                'The reason for working live and precautions taken',
                'Just the time taken',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-red-500/5 border-l-2 border-red-500/50">
                ...
                <p className="text-sm text-white/80 mb-3">
                  ...
                  hand, and the consumer unit was badly damaged.
                </p>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm text-elec-yellow font-medium">
                  Outcome: Essential testing completed safely with proper precautions and
                  supervision.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <ul className="space-y-2 text-sm text-white/80">
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">✓</span>
                  <span>
                    Isolate and prove dead by default—live work only when absolutely essential
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">✓</span>
                  <span>
                    If live testing is required: PPE, GS38 equipment, controlled environment, and
                ...
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">✓</span>
                  <span>
                    Working live without justification or control breaches the Electricity at Work
                    Regulations
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">✓</span>
                  <span>
                    Document reasons and precautions whenever live testing cannot be avoided
                  </span>
                </li>
              </ul>
            </div>
