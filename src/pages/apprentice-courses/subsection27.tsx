  ...
  const quickCheckQuestions = [
    {
      ...
      correctIndex: 1,
      explanation:
        'Near misses should be reported to your supervisor immediately while details are fresh and action can be taken quickly.',
    },
  ];
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        "A near miss is an unplanned event that could have caused injury, damage, or loss but didn't. It's a warning that conditions exist that could lead to an accident.",
    },
    {
      id: 2,
      ...
      correctAnswer: 2,
      explanation:
        "Near miss reporting helps identify unseen hazards, prevents future accidents, and allows issues to be fixed before someone gets hurt. It's about learning and improving, not blame.",
    },
    {
      id: 3,
      ...
      correctAnswer: 2,
      explanation:
        'Near misses should be reported to your supervisor or safety officer immediately so they can investigate and implement measures to prevent future incidents.',
    },
    {
      id: 4,
      ...
      correctAnswer: 1,
      explanation:
        'A comprehensive near miss report should include date and time, what happened, what nearly went wrong, contributing factors, and suggestions for fixing the issue.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'False. Near misses should always be reported regardless of whether anyone was hurt. They provide valuable information to prevent future accidents and improve safety systems.',
    },
    {
      id: 6,
      ...
      correctAnswer: 1,
      explanation:
        "Heinrich's Safety Triangle shows that for every major injury, there are typically 29 minor injuries and 300 near misses, demonstrating the importance of reporting near misses.",
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'A proper near miss investigation includes root cause analysis, risk assessment review, making immediate hazards safe, and implementing improvements.',
    },
    {
      id: 8,
      ...
      correctAnswer: 1,
      explanation:
        'Near miss reporting promotes openness and learning, shows safety is taken seriously, and creates shared responsibility for workplace safety.',
    },
    {
      id: 9,
      ...
      correctAnswer: 1,
      explanation:
        "Touching an unexpectedly live conductor without getting shocked is a classic near miss - it could have caused serious injury but didn't.",
    },
    {
      id: 10,
      ...
      correctAnswer: 1,
      explanation:
        'Near miss reports should include practical suggestions for preventing similar incidents in the future, focusing on system improvements rather than blame.',
    },
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-base text-foreground">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Unexpected live circuits, tools that nearly fell, cables
                  you almost tripped on.
                </li>
                <li>
                  <strong>Use:</strong> Report immediately to supervisor, include full details,
                  suggest improvements.
                </li>
                <li>
                  <strong>Learn:</strong> From investigation findings to prevent future incidents.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="rounded-lg p-6 border-l-4 border-l-red-500 bg-card">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-red-600 dark:text-elec-yellow mb-3">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-base text-foreground mb-2">
                      A near miss is any unplanned event that could have caused injury, damage, or
                      loss — but didn't.
                    </p>
                  ...
                  <div>
                    ...
                    <p className="text-base text-foreground mb-2">
                      Recognising near misses helps prevent future accidents.
                    </p>
                    <div className="grid md:grid-cols-2 gap-4">
                      <ul className="text-xs sm:text-sm text-foreground ml-4 space-y-1 list-disc">
                  ...
                  <div className="bg-background/50 p-3 rounded border">
                    <p className="text-sm font-medium text-foreground">
                      <strong>Key Point:</strong> The difference between a near miss and an accident
                      is often just luck. Next time, you might not be so fortunate.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20 border-l-4 border-l-orange-500">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-background/50 p-3 rounded border">
              <p className="text-sm font-medium text-foreground">
                <strong>Remember:</strong> Reporting is not about blaming — it's about improving the
                system and protecting everyone on site.
              </p>
            </div>
          </CardContent>
        </Card>
              ...
              <div className="flex-1">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-base text-foreground mb-2">
                      Knowing how to report a near miss properly ensures the information gets to the
                      right people.
                    </p>
                  ...
                  <div>
                    ...
                    <p className="text-base text-foreground mb-2">
                      A comprehensive near miss report should include all relevant details.
                    </p>
                    <div className="grid md:grid-cols-2 gap-4">
                      <ul className="text-xs sm:text-sm text-foreground ml-4 space-y-1 list-disc">
                  ...
                  <div className="bg-background/50 p-3 rounded border">
                    <p className="text-sm font-medium text-foreground">
                      <strong>Note:</strong> Most large sites have formal processes, but smaller
                      jobs may rely on verbal reporting to the person in charge.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-green-600 dark:text-green-400 mb-3">
                  Heinrich's Safety Triangle & Evidence
                </h3>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-base text-foreground mb-2">
                      Heinrich's Safety Triangle demonstrates why near miss reporting is
                      statistically proven to prevent serious injuries.
                    </p>
                  ...
                  <div className="bg-background/50 p-3 rounded border">
                    <p className="text-sm font-medium text-foreground">
                      <strong>Key Insight:</strong> By reporting and addressing near misses, we can
                      prevent the serious injuries at the top of the triangle.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="flex justify-between items-center">
          <Button variant="outline" asChild>
            <Link to="/study-centre/apprentice/level2/module1/section6/6-4">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous: Accident Reporting
            </Link>
          </Button>
          <Button variant="outline" asChild>
            <Link to="/study-centre/apprentice/level2/module1/section6/6-6">
