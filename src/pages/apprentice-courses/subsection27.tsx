                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-white/80 text-sm">Don't wait - report as soon as possible while details are fresh</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-white/80 text-sm">Use the site's formal reporting system if available</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-white/80 text-sm">Date, time, location, what happened, and contributing factors</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <Card className="p-6 bg-card border-border/20 mb-8">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-elec-yellow pl-4">
              ...
              <p className="text-white/80 text-sm">No. Near miss reporting is about learning and improvement, not blame. Most companies have policies protecting those who report safety concerns.</p>
            </div>
            <div className="border-l-4 border-green-500 pl-4">
              <h3 className="font-semibold text-foreground mb-1">What if it was my mistake that caused the near miss?</h3>
              <p className="text-white/80 text-sm">Still report it. Honest reporting helps identify training needs or system improvements. The focus is on preventing future incidents.</p>
            </div>
            <div className="border-l-4 border-orange-500 pl-4">
              <h3 className="font-semibold text-foreground mb-1">Should I report near misses that seem minor?</h3>
              <p className="text-white/80 text-sm">Yes. Even minor near misses can reveal important patterns. What seems small to you might be part of a bigger safety issue.</p>
            </div>
            <div className="border-l-4 border-purple-500 pl-4">
              <h3 className="font-semibold text-foreground mb-1">How long do I have to report a near miss?</h3>
              <p className="text-white/80 text-sm">Report immediately if possible, or by the end of your shift at the latest. Quick reporting allows faster action to prevent similar incidents.</p>
            </div>
            <div className="border-l-4 border-red-500 pl-4">
              <h3 className="font-semibold text-foreground mb-1">What if I witness someone else's near miss?</h3>
              <p className="text-white/80 text-sm">Encourage them to report it, and if they won't, you should report it yourself. Safety is everyone's responsibility.</p>
            </div>
            <div className="border-l-4 border-elec-yellow pl-4">
              <h3 className="font-semibold text-foreground mb-1">Do near miss reports affect safety statistics?</h3>
              <p className="text-white/80 text-sm">Near misses are typically recorded separately from accidents. High near miss reporting often indicates a positive safety culture.</p>
            </div>
          </div>
        </Card>
