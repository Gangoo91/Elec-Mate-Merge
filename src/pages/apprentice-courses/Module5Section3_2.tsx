      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">1. What Are Timescales?</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-3">Purpose of Timescales</p>
                    
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Helps organise:</strong></p>
          ...
          {/* What Are Milestones */}
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">2. What Are Milestones?</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Common Milestones:</strong></p>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">3. Setting Realistic Timescales</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-amber-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-foreground mb-2"><strong>Steps to set realistic timescales:</strong></p>
                        <ul className="text-xs sm:text-sm text-foreground ml-4 list-disc space-y-1">
                      ...
                      <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded border border-orange-200 dark:border-orange-800">
                        <p className="font-medium text-orange-700 dark:text-emerald-400 mb-2">Buffer Time Rule</p>
                        <p className="text-xs sm:text-sm text-foreground">
          ...
          {/* Benefits and Risks */}
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">4. Benefits of Realistic Timescales & Risks of Unrealistic Ones</h3>
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="rounded-lg p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
                <h4 className="font-medium text-red-700 dark:text-emerald-400 mb-3">Risks of Unrealistic Timescales</h4>
                <ul className="list-disc pl-6 space-y-1 text-xs sm:text-sm text-foreground">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">5. Adjusting Timescales</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-4 bg-emerald-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                <h4 className="font-medium text-blue-700 dark:text-emerald-400 mb-2">When to Adjust</h4>
                <ul className="list-disc pl-6 space-y-1 text-xs sm:text-sm text-foreground">
              ...
              <div className="rounded-lg p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
                <h4 className="font-medium text-purple-700 dark:text-emerald-400 mb-2">How to Adjust</h4>
                <ul className="list-disc pl-6 space-y-1 text-xs sm:text-sm text-foreground">
