...
const Level3Module6Section3_4 = () => {
  useSEO(
    "Earthing and Bonding Arrangements (TN-S, TN-C-S, TT) - Level 3 Electrical Systems Design",
    ...
    <div className="min-h-screen bg-[#1a1a1a]">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <h1 className="text-2xl md:text-xl sm:text-2xl md:text-3xl font-bold text-white mb-6">
          3.4 Earthing and Bonding Arrangements (TN-S, TN-C-S, TT)
        </h1>
        ...
        <div className="prose prose-invert max-w-none">
          <p>Content for Earthing and Bonding Arrangements will be added here.</p>
        </div>
      </div>
    </div>
  );
