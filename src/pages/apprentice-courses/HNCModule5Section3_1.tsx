...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['720,000', '500,000', '850,000', '600,000'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['15-20%', '25-35%', '70-80%', '40-60%'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              NRM2 is the RICS standard for measurement and pricing of building works including
              services. Estimates and bills of quantities aligned to NRM2 are directly comparable
              across tenderers, support fair valuation of variations, and form the basis of cost
              analytics. Diverging from NRM2 makes benchmarking and dispute resolution harder.
            </>
          }
        ...
        <ConceptBlock title="First Principles Estimating">
          ...
          <p>
            <strong>
              All-In Labour Rate Build-Up (2024 Example) — (Element — Annual Cost — Notes):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Benchmarking Data Sources">
          ...
          <p>
            <strong>
              BCIS Elemental Costs — Electrical Installations (2024 Data) (Building Type — Lower
          ...
          <p>Note: National average figures. Apply BCIS location factors for regional projects.</p>
          <p>
        ...
        <ConceptBlock title="Parametric Estimating Methods">
          <p>
            ...
            characteristics. It bridges the gap between early-stage benchmarking and detailed first
            principles estimates, providing reasonable accuracy when design information is
            developing.
          </p>
          <p>
            <strong>
              Common Parametric Units for Building Services (System — Unit — Typical Range 2024):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="MEP-Specific Pricing Considerations">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design development:</strong> MEP often designed in parallel with construction
            </li>
            <li>
          ...
          <p>
            <strong>
              MEP as Percentage of Total Construction Cost (Building — M&E % — Dominant Systems):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Working height:</strong> Reduce productivity 15-25% for ceiling work above 3m
            </li>
            <li>
              <strong>Congested areas:</strong> Allow 20-40% additional time in plant rooms, risers
            </li>
            <li>
              <strong>Existing buildings:</strong> Add 25-50% for working around existing services
            </li>
            <li>
              <strong>Occupied premises:</strong> Out-of-hours working typically costs 1.5-2x normal
              rates
            </li>
            <li>
          ...
          <p>
            <strong>Risk management:</strong> MEP estimates should include explicit risk allowances
            for design development (5-10%) and market volatility (3-5%) in addition to normal
            contingencies.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — First Principles Cable Installation:</strong> Build up the rate for
            installing 100m of 3-core 6mm2 SWA cable in surface-mounted tray.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — Location Adjustment:</strong> Adjust a national average estimate of
            850,000 for a project in Central London.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A client asks for a budget cost on a 6,000 m² office MEP fit-out. You quickly produce
              £95/m² × 6,000 = £570k based on benchmarks from your last three offices. The client
              awards on this basis. At first-principles tender, the cost comes out at £680k — £110k
              over budget. The benchmark was for cellular offices; this is open-plan with a high IT
              density and active chilled beams.
            </>
          }
          whatToDo={
            <>
              For any pre-construction estimate, always test with a second method. Even a brief
              first-principles check on lighting density (W/m²), small power outlets, IT room load
              and HVAC duty would have flagged the divergence. Make the assumptions explicit when
              issuing the budget — "based on cellular office benchmarks; open-plan or high-tech
              assumes ±15%". Push back on clients who treat benchmarks as fixed prices.
            </>
          }
          whyItMatters={
            <>
              Estimates set client expectations. A confidently-stated benchmark figure becomes the
              budget the client commits to — and you eat the difference at tender. The discipline of
              cross-checking is cheap insurance against project loss.
            </>
          }
        />
