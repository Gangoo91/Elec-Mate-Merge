  ...
  const faqs = [
    {
      ...
      answer:
        'Yes, all new installations require verification before being energised. New installations are no exception - testing verifies that installation work has been completed correctly.',
    },
    {
      question: 'What if my CPC readings vary slightly across sockets?',
      answer:
        'Small variations are normal due to differences in conductor length, but large discrepancies indicate a fault. Variations should be proportional to cable length and within expected ranges.',
    },
    {
      question: 'Is visual inspection enough?',
      answer:
        'No, physical testing is required to confirm electrical continuity. Visual inspection alone cannot detect high-resistance connections or internal cable damage.',
    },
    {
      question: 'How do I know if my readings are acceptable?',
      answer:
        'Compare results to design values or tables in BS 7671. Readings should be low and consistent with conductor size and length. Any sudden increases indicate potential faults.',
    },
    {
      question: "What's the difference between end-to-end and R1+R2 testing?",
      answer:
        'End-to-end tests only the CPC, while R1+R2 tests both line and CPC simultaneously. R1+R2 is more comprehensive and commonly used in verification testing.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                a low-resistance path for fault currents, ensuring protective devices operate
                quickly and safely.
              </p>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Provides low-resistance path for fault currents to earth (typically less than
                      1.67 ohms for domestic circuits)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Ensures protective devices (MCBs, RCDs) operate within required disconnection
                      times (0.4s for socket circuits, 5s for fixed equipment)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Prevents dangerous voltages appearing on exposed metalwork during fault
                      conditions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Enables automatic disconnection of supply (ADS) - the primary method of
                      protection in TN and TT systems
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Part P Building Regulations compliance for notifiable work in domestic
                      installations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Electricity at Work Regulations 1989 - Regulation 4 requires precautions
                      against danger
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      IET Guidance Note 3 provides detailed testing procedures and acceptable values
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <InlineCheck
            ...
            options={[
              ...
              'To ensure protective devices operate during faults',
              'To check cable insulation',
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Link line and CPC at distribution board using temporary fly lead (typically
                      4mm² or appropriate size)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Measure resistance between line and CPC at each outlet point using low
                      resistance ohmmeter
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Tests both line conductor and CPC continuity simultaneously in one measurement
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Results directly relate to fault loop impedance calculations (Zs = Ze + R1 +
                      R2)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Typical acceptable values: 0.05-2.0 ohms depending on conductor size and
                      circuit length
                    </span>
                  </li>
                </ul>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ol className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Isolate circuit completely at consumer unit/distribution board and prove dead
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow font-medium">2.</span>
                    <span>
                      Remove or disconnect any electronic equipment (dimmers, timers, smoke
                      detectors)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Zero the ohmmeter using short test leads (typically 0.01-0.02 ohms lead
                      resistance)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      For R1+R2: link line and CPC at board, measure at each outlet L-E terminals
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow font-medium">5.</span>
                    <span>
                      Record results on appropriate test certificate (EIC, EICR, or Minor Works)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow font-medium">6.</span>
                    <span>
                      Compare results to expected values based on conductor specifications
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
          ...
          <InlineCheck
            ...
            options={[
              'Normal ageing',
              'Overheating due to loose connections or overloading',
              'Recent cleaning',
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Typical domestic socket circuit (32A, 4mm²): R1+R2 should be 0.2-1.2 ohms
                      depending on length
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Lighting circuits (6A, 1.5mm²): R1+R2 typically 0.5-3.0 ohms for reasonable
                      cable runs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Cooker circuits (32A, 6mm²): R1+R2 should be 0.15-0.8 ohms for typical
                      installations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Values must ensure maximum disconnection times are met (0.4s for TN systems)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Infinite resistance (open circuit) indicates broken or disconnected CPC -
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400">⚠</span>
                    <span>
                      Unexpectedly high resistance suggests loose connections, corroded joints, or
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400">⚠</span>
                    <span>
                      Significantly different values at similar distances indicate installation
                      faults or cable damage
                    </span>
                  </li>
                </ul>
              </div>
