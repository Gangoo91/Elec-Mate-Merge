...
const Module6Section1_2 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'False – You must never sign a certificate without personally carrying out or supervising the testing. Trust is not a substitute for verification.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'BS 7671 requires initial verification for new installations and periodic inspection for existing installations.',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Employers can face prosecution and be held legally and financially liable for injuries caused by unsafe electrical installations.',
    },
    {
      id: 10,
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <ul className="text-white/80 text-sm space-y-1 list-disc pl-5">
              ...
              <li>
                Personal responsibility: whoever signs certificates accepts full legal liability.
              </li>
              <li>
                Non-compliance consequences: prosecution, fines, imprisonment, professional
                disgrace.
              </li>
            </ul>
          </div>
            ...
            <div className="text-white/80 space-y-2 leading-relaxed">
              <ul className="list-disc pl-6 space-y-2 text-sm">
                <li>
                  ...
                  1989 and their enforcement.
                </li>
                <li>
                  Explain how BS 7671 principles guide safe design, installation, and testing
                  practices in electrical work.
                </li>
                <li>
                  Understand the serious personal, professional, and criminal consequences of
                  failing to comply with regulations.
                </li>
                <li>
                  Recognise your personal legal responsibility as an installer and the limits of
                  delegation.
                </li>
                <li>
                  Appreciate the relationship between legal compliance, professional insurance, and
                  career protection.
                </li>
                <li>
                  Distinguish between criminal liability (EAWR) and civil liability (negligence
                  claims) in electrical work.
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                law behind them. They place absolute duties on both employers and employees to
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    <strong>Regulation 4(1):</strong> All electrical systems must be constructed,
                    maintained, and used in a manner that prevents danger so far as is reasonably
                    practicable
                  </li>
                  <li>
                    <strong>Regulation 4(2):</strong> Systems must be maintained in a safe condition
                    at all times, requiring ongoing verification of safety
                  </li>
                  <li>
                    <strong>Regulation 14:</strong> No person shall work on or near live conductors
                    except in specific circumstances with adequate precautions
                  </li>
                  <li>
                    <strong>Absolute duty:</strong> Employers cannot delegate their legal
                    responsibility – they remain liable for ensuring compliance
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    <strong>HSE Powers:</strong> Health and Safety Executive can prosecute
                    individuals and companies
                  </li>
                  <li>
                    <strong>Criminal Sanctions:</strong> Unlimited fines and up to 2 years
                    imprisonment for serious breaches
                  </li>
                  <li>
                    <strong>Corporate Manslaughter:</strong> Directors can face personal prosecution
                    under the Corporate Manslaughter Act
                  </li>
                  <li>
                    <strong>Improvement/Prohibition Notices:</strong> HSE can stop work immediately
                    if danger exists
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
                ...
                <p className="text-sm">
                  EAWR 1989 creates "absolute duties" – this means you cannot use cost, time
                  pressure, or difficulty as excuses for non-compliance. If electrical danger
                  exists, the law has been broken regardless of circumstances.
                </p>
              </div>
            </div>
          </section>
          ...
          <InlineCheck
            ...
            options={[
              'Advisory duty only',
              'Absolute duty that cannot be delegated',
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                definitive standard for electrical installation safety in the UK.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="font-medium text-white mb-3">Mandatory Requirements:</p>
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    <strong>Initial verification (Part 6):</strong> Mandatory testing before any new
                    installation is energised
                  </li>
                  <li>
                    <strong>Periodic inspection and testing:</strong> Regular verification that
                    existing installations remain safe
                  </li>
                  <li>
                    <strong>Test procedures:</strong> Specific sequences for continuity, insulation
                    resistance, polarity, earth fault loop impedance
                  </li>
                  <li>
                    <strong>Acceptance criteria:</strong> Clear pass/fail values for all electrical
                    parameters
                  </li>
                </ul>
              </div>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <ul className="text-sm space-y-1">
                    <li>
                      <strong>EIC:</strong> Electrical Installation Certificate (new work)
                    </li>
                    <li>
                      <strong>EICR:</strong> Electrical Installation Condition Report (periodic)
                    </li>
                    <li>
                      <strong>MWC:</strong> Minor Works Certificate (alterations/additions)
                    </li>
                  </ul>
                </div>
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <div className="p-4 rounded-lg bg-blue-500/10 border-l-2 border-blue-500/50">
                ...
                <p className="text-sm">
                  While BS 7671 is not directly law, courts accept it as the standard for safe
                  electrical installation. Deviation from BS 7671 without equivalent safety measures
                  can be used as evidence of EAWR non-compliance in legal proceedings.
                </p>
              </div>
            </div>
          </section>
          ...
          <InlineCheck
            ...
            options={[
              "17th Edition - updates aren't important",
              '18th Edition - updates reflect new safety knowledge and technology',
              '16th Edition - still current',
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                proved false or negligent. Understanding this responsibility is crucial for career
                protection.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="font-medium text-white mb-3">
                  Certificate Signature Responsibilities:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-sm">
                  <li>
                    <strong>Legal declaration:</strong> Signing creates personal legal liability for
                    accuracy of all test results
                  </li>
                  <li>
                    <strong>Competence requirement:</strong> Must be competent to carry out the work
                    being certified
                  </li>
                  <li>
                    <strong>Supervision limitations:</strong> Remain liable even when supervising
                    others' work
                  </li>
                  <li>
                    <strong>No delegation:</strong> Cannot delegate the legal responsibility that
                    comes with signature
                  </li>
                </ul>
              </div>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <ul className="text-sm space-y-1">
                    <li>
                      <strong>Scheme membership:</strong> NICEIC, NAPIT, ELECSA can remove members
                    </li>
                    <li>
                      <strong>Self-certification rights:</strong> Lost if removed from scheme
                    </li>
                    <li>
                      <strong>Annual assessments:</strong> Work quality and compliance checked
                    </li>
                  </ul>
                </div>
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <ul className="text-sm space-y-1">
                    <li>
                      <strong>Professional indemnity:</strong> May be void if working outside
                      competence
                    </li>
                    <li>
                      <strong>Public liability:</strong> Required for injury claims
                    </li>
                    <li>
                      <strong>Fraudulent work:</strong> Insurance doesn't cover deliberate
                      misconduct
                    </li>
                  </ul>
                </div>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
                ...
                <p className="text-sm">
                  Fraudulent certification or gross negligence can result in prosecution under fraud
                  laws or manslaughter charges if someone dies. Prison sentences are real – in 2019,
                  a landlord received 12 months imprisonment after a tenant died in an electrical
                  fire.
                </p>
              </div>
            </div>
          ...
          <InlineCheck
            ...
            options={[
              'The apprentice who did the work',
              'You as the person signing the certificate',
              'Both equally',
              'The employer only',
            ]}
            correctIndex={1}
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-orange-500/10 border-l-2 border-orange-500/50">
              ...
              <div className="text-white/80 text-sm space-y-3">
                ...
                <p>
                  <strong>The failures that led to conviction:</strong>
                </p>
                ...
                <p>
                  <strong>Consequences:</strong> The company was fined £750,000, and the maintenance
                  manager received a 6-month suspended prison sentence.
                </p>
                <p className="text-elec-yellow/80">
                  <strong>Lesson:</strong> This case demonstrates that electrical safety isn't just
                  about individual competence – it requires systematic compliance with legal duties
                  at every level.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1 text-white/80">
                  ...
                  <li>
                    <strong>BS 7671:</strong> Technical standard – defines compliance methods
                  </li>
                  <li>
                    <strong>Regulation 4:</strong> Systems must be constructed and maintained safely
                  </li>
                  <li>
                    <strong>Enforcement:</strong> HSE prosecution powers – unlimited fines/prison
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1 text-white/80">
                  ...
                  <li>
                    <strong>Equipment:</strong> Use calibrated, approved instruments only
                  </li>
                  <li>
                    <strong>Certificates:</strong> Only sign what you've personally verified
                  </li>
                  <li>
                    <strong>Records:</strong> Document everything for legal protection
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                technical methods, and personal responsibility ensures accountability.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="font-medium text-white mb-2">Remember the hierarchy:</p>
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Criminal law (EAWR):</strong> Creates absolute duties and penalties
                  </li>
                  <li>
                    <strong>Technical standards (BS 7671):</strong> Defines compliance methods
                  </li>
                  <li>
                    <strong>Professional responsibility:</strong> Ensures personal accountability
                  </li>
                  <li>
                    <strong>Industry reputation:</strong> Maintains public trust in electrical work
                  </li>
                </ul>
              </div>
              <p className="text-sm">
                Every time you test an installation and sign a certificate, you're not just
                completing a job – you're participating in a system designed to prevent electrical
                deaths and injuries.
              </p>
            </div>
          </section>
