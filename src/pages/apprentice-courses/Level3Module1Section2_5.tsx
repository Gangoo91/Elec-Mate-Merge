...
const DESCRIPTION =
  'Master safe systems of work for electrical installations: permits to work, lock-off/tag-out procedures, safe isolation, and the coordination required for high-risk electrical work.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'A Safe System of Work is a defined method of working, developed after systematic hazard identification and risk assessment, that eliminates hazards or minimises risks to acceptable levels. It includes all the controls - not just paperwork.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      "A permit to work provides formal control of high-risk activities through documented authorisation, clear allocation of responsibilities, verification of controls, and controlled handover between parties. It's not just paperwork - it's an active control system.",
  },
  {
    id: 'check-3',
    ...
    correctIndex: 1,
    explanation:
      'Each worker applies their own lock so that they personally control their own safety. The system cannot be re-energised until every single lock is removed. This ensures all workers have completed their work and are clear before power is restored.',
  },
  {
    id: 'check-4',
    question:
      'When proving a voltage indicator before safe isolation, what must you do AFTER testing the circuit dead?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      "You must re-prove your voltage indicator AFTER testing to confirm it was working correctly during the test. If the VI proves on a known source both BEFORE and AFTER, you can be confident the 'dead' reading was accurate, not due to instrument failure.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'A safe system of work requires: a SAFE PERSON (competent, trained, fit for work), a SAFE PLACE (hazards identified and controlled), and SAFE EQUIPMENT (correct tools, PPE, properly maintained). All three must be in place.',
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'Permits are typically required for high-risk electrical activities: live working, HV work, work on or near LV switchgear with high fault levels, work affecting multiple circuits/systems, entry to substations or secure electrical areas, and work requiring coordination with others.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      "The Authorised Person (AP) is responsible for issuing and cancelling permits, verifying isolation has been achieved, confirming the safety of equipment before work starts, and controlling access. They authorise but typically don't do the work themselves.",
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      "A lock-off device physically prevents an isolator from being switched back on. With a lock in place, even if someone wanted to re-energise, they physically cannot. This provides positive protection that doesn't rely on signs, communication, or memory.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'A multi-lock hasp allows several workers to each apply their own personal lock to a single isolation point. The equipment cannot be re-energised until every single lock is removed - ensuring all workers are clear before switching on.',
  },
  {
    id: 6,
    question:
      'According to GS38, what must you do with your voltage indicator BEFORE testing for dead?',
    options: [
      'Calibrate it',
    ...
    correctAnswer: 1,
    explanation:
      'GS38 requires you to prove your voltage indicator works on a known live source (or proving unit) BEFORE testing the isolated circuit. This confirms the instrument is functioning correctly before you rely on its readings.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'A permit must record: what equipment/area, what work is being done, what isolations are in place, what hazards exist, what controls are required, who is responsible, time/date validity, and signatures for issue, receipt, and clearance.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'A permit is cancelled when work is complete, the area has been made safe, tools and temporary earths are removed, all workers are clear, and the equipment is ready for return to service. Cancellation should involve the same rigour as issue.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'LOTO stands for Lock-Out/Tag-Out - the procedure for applying locks and warning tags to isolated equipment to prevent inadvertent re-energisation while work is in progress.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      "Tags provide vital information: who applied the lock, why (what work is being done), when, and contact details. If there's a question about the isolation, or in an emergency, this information tells you who to contact. Tags complement but don't replace locks.",
  },
  {
    id: 11,
    ...
    correctAnswer: 2,
    explanation:
      'The correct sequence is: 1) Identify the circuit, 2) Isolate at the appropriate point, 3) Secure with lock-off and tags, 4) Prove the tester on a known source, 5) Test and prove dead at the point of work, 6) Re-prove the tester. Only then can work begin.',
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      "Only the person who applied the lock should remove it - this confirms they have completed their work and are clear. Removing someone else's lock is extremely dangerous as that person may still be working on the circuit. Emergency procedures exist for exceptional circumstances.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "No. Permits are for high-risk activities where formal control and coordination are needed - live working, HV work, work affecting multiple systems, entry to secure areas. Routine LV work on isolated circuits typically uses method statements and safe isolation procedures without formal permits. Your employer's procedures will define when permits are required.",
  },
  {
    question: 'What if someone removes my lock without my knowledge?',
    answer:
      "This is a serious safety breach - potentially criminal if it results in injury. Never remove someone else's lock without following formal emergency procedures (which require senior authorisation, attempts to contact the lock owner, and physical verification that all workers are clear). Report any instances of lock removal to management immediately.",
  },
  {
    question: 'Can I use a non-contact voltage detector (volt-stick) for safe isolation?',
    answer:
      'No. Non-contact detectors can give false negatives and are NOT approved for proving dead during safe isolation. They can be used as an initial indication only. GS38 requires a proper two-pole voltage indicator with test probes that make contact with conductors. Prove the tester before AND after testing.',
  },
  {
    question: "What's the difference between isolation and switching off?",
    answer:
      'Switching off stops normal operation but the supply may still be connected - the equipment could be switched back on instantly. Isolation creates a physical break in the circuit and is secured so it cannot be easily re-energised. For safe working, equipment must be isolated and locked off, not just switched off.',
  },
  {
    question: 'How long is a permit to work valid for?',
    answer:
      'Permits are typically valid for one shift or one day maximum. If work extends beyond this, a new permit or extension must be issued after verification that conditions remain safe. Never continue working on an expired permit - the situation may have changed and controls may no longer be valid.',
  },
  {
    question: 'What if conditions change after a permit is issued?',
    answer:
      "If conditions change significantly from those stated on the permit, work must stop. The Competent Person (permit holder) should contact the Authorised Person. The permit may need to be suspended or cancelled and a new assessment done. Never continue under a permit if the actual conditions don't match what's written.",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>SSOW:</strong> Safe person + Safe place + Safe equipment
              </li>
              <li>
                <strong>PTW:</strong> Formal authorisation for high-risk work
              </li>
              <li>
                <strong>LOTO:</strong> Lock-Off/Tag-Out - physical prevention
              </li>
              <li>
                <strong>Proving:</strong> Test before AND after checking dead
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> When formal controls (permits) are needed
              </li>
              <li>
                <strong>Use:</strong> YOUR lock on every isolation point
              </li>
              <li>
                <strong>Apply:</strong> Prove-test-prove sequence every time
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A Safe System of Work (SSOW) is a formal procedure resulting from systematic
              examination of a task to identify all hazards and define the safest method of doing
              the work. It's more than just paperwork - it's the complete package of controls,
              training, equipment, and procedures that enable work to be done safely.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                The three foundations of any SSOW:
              </p>
            ...
            <p>
              <strong>Legal basis:</strong> The Management of Health and Safety at Work Regulations
              1999 requires employers to implement preventive and protective measures. For
              electrical work, the Electricity at Work Regulations 1989 requires that work is done
              dead where reasonably practicable, and where it cannot be, suitable precautions are
              taken.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Components of a safe system for electrical work:
              </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> A safe system of work isn't just documents - it's a
              complete approach to working safely, including the people, procedures, and equipment.
              The paperwork records and communicates the system, but the system is what keeps you
              alive.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A Permit to Work is a formal written document that authorises certain people to carry
              out specific work, at a specific time, and sets out the precautions required. It's
              used for high-risk activities where normal procedures need additional formal controls
              and coordination.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>1. Preparation:</strong> Risk assessment, method statement, isolation plan
                </li>
                <li>
                  <strong>2. Issue:</strong> AP confirms isolations, issues permit to CP, both sign
                </li>
                <li>
                  <strong>3. Receipt:</strong> CP accepts responsibility, briefs team, work begins
                </li>
                <li>
                  <strong>4. Monitoring:</strong> Work progresses under permit controls
                </li>
                <li>
                  <strong>5. Clearance:</strong> Work complete, area made safe, CP returns permit
                </li>
                <li>
                  <strong>6. Cancellation:</strong> AP verifies safe, cancels permit, equipment
                  returned to service
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> A permit is not just paperwork - it's an active control
              system. The permit is a communication tool that ensures everyone knows what's
              isolated, what's being done, who's responsible, and when it's safe to restore power.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Lock-Off/Tag-Out (LOTO) is the physical method of securing isolation to prevent
              inadvertent re-energisation. It combines locks (physical prevention) with tags
              (information) to provide robust protection for workers on isolated equipment.
            </p>
            ...
            <p>
              <strong>Why each worker needs their own lock:</strong> The fundamental principle is
              that you control your own safety. When you apply your personal lock, only YOU can
              remove it. Even if your colleagues finish and remove their locks, the equipment cannot
              be re-energised while your lock remains. You remove your lock when YOU are finished
              and clear - not when someone else tells you they're ready to switch on.
            </p>
            ...
            <div className="p-4 rounded bg-white/5 my-6">
              ...
              <p className="text-xs text-white mb-2">
                ...
                removes their lock. Worker C is still inside the starter. The equipment CANNOT be
                re-energised because C's lock is still on. At 3:30pm, C finishes, removes their
                lock, and only THEN can the circuit be re-energised.
              </p>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Never remove someone else's lock. If a lock owner is absent
              and re-energisation is urgent, follow emergency procedures - which require senior
              authorisation, documented attempts to contact the owner, and physical verification all
              workers are clear.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Safe isolation is the procedure for making electrical equipment dead before work
              begins. HSE Guidance Note GS38 provides the standard for this procedure, including
              requirements for test equipment. This procedure must be followed for ALL electrical
              work where equipment will be worked on - it's the foundation of electrical safety.
            </p>
              ...
              <div className="space-y-2">
                ...
                <div className="p-2 rounded bg-white/5 flex items-center gap-3">
                  ...
                  <span className="text-sm">
                    Isolate - switch off and withdraw fuse or lock MCB/isolator
                  </span>
                </div>
                <div className="p-2 rounded bg-white/5 flex items-center gap-3">
                  <span className="w-6 h-6 rounded-full bg-elec-yellow/20 text-elec-yellow flex items-center justify-center text-xs font-bold">
                ...
                <div className="p-2 rounded bg-white/5 flex items-center gap-3">
                  ...
                  <span className="text-sm">
                    Test at point of work - L-N, L-E, N-E (all phases on 3-phase)
                  </span>
                </div>
                <div className="p-2 rounded bg-white/5 flex items-center gap-3">
                  <span className="w-6 h-6 rounded-full bg-elec-yellow/20 text-elec-yellow flex items-center justify-center text-xs font-bold">
            ...
            <p className="text-sm text-white italic">
              ...
              have discovered it wasn't working.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> NEVER trust a single test. Prove-test-prove is the minimum
              safe procedure. Your life depends on your tester working - verify it every single
              time.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                On Commercial/Industrial Sites
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Not proving the tester</strong> - "It was working yesterday" isn't good
                  enough
                </li>
                <li>
                  <strong>Testing at the wrong location</strong> - Test at point of work, not just
                  the DB
                </li>
                <li>
                  <strong>Relying on labels</strong> - Circuit charts can be wrong; always verify
                </li>
                <li>
                  <strong>Using someone else's lock</strong> - Only YOUR lock gives YOU control
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="p-5 rounded-lg bg-transparent">
            <h3 className="text-sm font-medium text-white mb-4">
              Quick Reference - Safe Systems of Work
            </h3>
