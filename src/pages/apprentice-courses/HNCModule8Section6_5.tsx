    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>O&amp;M manuals:</strong> Comprehensive operation and maintenance
                information
              </li>
              <li className="pl-1">
                <strong>As-built drawings:</strong> Accurate record of installed works
              </li>
              <li className="pl-1">
                <strong>Testing records:</strong> Evidence of system performance verification
              </li>
              <li className="pl-1">
                <strong>Building log book:</strong> Part L requirement for energy management
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>BSRIA BG 8:</strong> Model O&amp;M manual guidance
              </li>
              <li className="pl-1">
                <strong>CDM 2015:</strong> Health and Safety File requirement
              </li>
              <li className="pl-1">
                <strong>COBie:</strong> Digital asset data exchange format
              </li>
              <li className="pl-1">
                <strong>Soft Landings:</strong> Progressive documentation review
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                O&amp;M Manual Structure (BSRIA BG 8)
              </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        System descriptions, operating procedures, emergency procedures
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Equipment schedules, maintenance procedures, spare parts
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Manufacturer data, product literature, certificates
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Record drawings, schematics, as-built information
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Spatial and schematic reference
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Electrical Installation O&amp;M Content
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Emergency lighting:</strong> Luminaire locations, test log templates,
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Equipment positions, cable routes, containment
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        System topology, interconnections, control sequences
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Understanding system operation, fault finding
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Distribution hierarchy, protective devices, circuit references
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Electrical distribution overview, isolation planning
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Terminal connections, cable cores, control circuits
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Combined services layouts, spatial coordination
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Access planning, clash avoidance
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Revision numbering:</strong> Clear, sequential revision system (P01, P02
                  for preliminary; C01, C02 for construction; A01, A02 for as-built)
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Testing and commissioning records provide evidence that all systems have been
              installed correctly, tested to verify performance and adjusted to meet design
              specifications. They establish a baseline for future performance monitoring and
              maintenance.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Electrical Testing Records (BS 7671)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Measured test values for each circuit
                      </td>
                      <td className="border border-white/10 px-3 py-2">Accompanies EIC</td>
                    </tr>
                  </tbody>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                System-Specific Commissioning Records
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Commissioning certificate (BS 5839-1), zone test results, cause and effect
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Commissioning certificate (BS 5266-1), duration test results, luminaire
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Point-to-point test sheets, control loop verification, trend logs,
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Motor rotation checks, VSD parameter records, interlock verification, safety
                        device tests
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        DALI addressing records, scene programming verification, sensor
                        commissioning
                      </td>
                    </tr>
                  </tbody>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The building log book (required under Part L of the Building Regulations) and the
              Health and Safety File (required under CDM 2015) are distinct legal requirements that
              ensure buildings can be operated safely and efficiently throughout their life.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Building Log Book Requirements (Part L)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Internal temperatures, fresh air rates, illuminance levels, occupancy
                        assumptions
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        System descriptions, installed capacities, control strategies, operating
                        schedules
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Lighting strategy, control types, installed load, lux levels achieved
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Metering</td>
                      <td className="border border-white/10 px-3 py-2">
                        Meter locations, sub-metering arrangements, energy monitoring provisions
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Predicted energy consumption, benchmarks, carbon emissions targets
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Maintenance</td>
                      <td className="border border-white/10 px-3 py-2">
                        Recommended maintenance schedules to maintain efficiency
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white">
                The building log book is a legal requirement for new non-domestic buildings under
                Part L of the Building Regulations. It must be provided to the building owner before
                the building is occupied or, where applicable, before the building control body
                issues a final certificate. The log book format should follow CIBSE TM31 guidance.
              </p>
            </div>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Health and Safety File (CDM 2015)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Key structural elements, safe working loads, access provisions
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Location of any hazardous materials (e.g., asbestos in existing buildings)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Services</td>
                      <td className="border border-white/10 px-3 py-2">
                        Location of services, isolation points, safety systems
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Safe access</td>
                      <td className="border border-white/10 px-3 py-2">
                        Equipment requiring access for maintenance, roof access provisions
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Risks that could not be designed out, required precautions
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              and Safety File is prepared and maintained. Failure to do so is a criminal offence
              that can result in enforcement action by the HSE.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              documentation. COBie (Construction Operations Building information exchange) provides
              a standardised format for exchanging building asset data from design through
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Building name, address, project details
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Room numbers, names, areas, usable heights
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Serial numbers, installation dates, locations
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Electrical distribution, fire alarm, HVAC
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        O&amp;M manuals, certificates, warranties
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                BS EN ISO 19650 Information Management
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>EIR:</strong> Employer's Information Requirements define what information
                  is required at handover
                </li>
                <li className="pl-1">
                  <strong>BEP:</strong> BIM Execution Plan describes how information will be
                  delivered
                </li>
                <li className="pl-1">
                  <strong>AIR:</strong> Asset Information Requirements define operational phase
                  needs
                </li>
                <li className="pl-1">
                  <strong>AIM:</strong> Asset Information Model is the delivered operational
                  database
                </li>
                <li className="pl-1">
                  <strong>Level of Information Need:</strong> Specifies detail required for each
                  asset type
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  As-built drawings in agreed format (PDF and native CAD/BIM)
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Missing test results:</strong> Certificates without supporting test
                  schedules
                </li>
                <li className="pl-1">
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                BSRIA Soft Landings Documentation Review
              </h3>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Stage 2 (50%):</strong> Review system descriptions and operating
                  procedures
                </li>
                <li className="pl-1">
                  <strong>Stage 3 (75%):</strong> Review maintenance procedures and equipment
                  schedules
                </li>
                <li className="pl-1">
