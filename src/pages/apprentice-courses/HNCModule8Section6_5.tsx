...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['10 years', '5 years', 'Until next inspection', 'Life of the installation'],
    correctAnswer: 3,
    explanation:
...
const HNCModule8Section6_5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 6 · Subsection 5"
        title="Documentation"
        backTo="/study-centre/apprentice/h-n-c-module8-section6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          O&M manuals, as-built drawings, testing records and building log book requirements for
          successful project handover
        </p>

        <ConceptBlock title="Operation and Maintenance Manuals">
          <p>
            Operation and Maintenance (O&amp;M) manuals are comprehensive documents that provide
            building owners, managers and maintenance personnel with all information required to
            safely and efficiently operate, maintain and modify building systems throughout their
            operational life.
          </p>
          <p>
            <strong>O&amp;M Manual Structure (BSRIA BG 8)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Volume 1:</strong> System descriptions, operating procedures, emergency
              procedures — Day-to-day operational reference
            </li>
            <li>
              <strong>Volume 2:</strong> Equipment schedules, maintenance procedures, spare parts —
              Planned maintenance guidance
            </li>
            <li>
              <strong>Volume 3:</strong> Manufacturer data, product literature, certificates —
              Technical reference information
            </li>
            <li>
              <strong>Volume 4:</strong> Record drawings, schematics, as-built information — Spatial
              and schematic reference
            </li>
          </ul>
          <p>
            <strong>Essential Content Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Electrical Installation O&amp;M Content</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Distribution systems:</strong> Schematic diagrams, distribution schedules,
              protective device settings
            </li>
            <li>
              <strong>Lighting:</strong> Luminaire schedules, control system programming, lamp
              replacement procedures
            </li>
            <li>
              <strong>Fire alarm:</strong> Cause and effect matrix, zone plans, test procedures
            </li>
            <li>
              <strong>Emergency lighting:</strong> Luminaire locations, test log templates, battery
              replacement schedule
            </li>
            <li>
              <strong>Access control:</strong> System architecture, user management procedures,
              credential protocols
            </li>
          </ul>
          <p>
            <strong>Practical tip:</strong> Review O&amp;M manual submissions progressively during
            construction. BSRIA Soft Landings recommends staged reviews at 25%, 50%, 75% and 100%
            completion to ensure quality and avoid last-minute problems.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="As-Built Drawings">
          <p>
            As-built drawings (also called record drawings or as-installed drawings) provide an
            accurate graphical record of the installed works. They are essential for future
            maintenance, modifications, fault finding and compliance verification.
          </p>
          <p>
            <strong>Types of As-Built Drawings</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Layout drawings:</strong> Equipment positions, cable routes, containment —
              Locating equipment, planning modifications
            </li>
            <li>
              <strong>Schematic diagrams:</strong> System topology, interconnections, control
              sequences — Understanding system operation, fault finding
            </li>
            <li>
              <strong>Single line diagrams:</strong> Distribution hierarchy, protective devices,
              circuit references — Electrical distribution overview, isolation planning
            </li>
            <li>
              <strong>Wiring diagrams:</strong> Terminal connections, cable cores, control circuits
              — Detailed fault finding, modifications
            </li>
            <li>
              <strong>Coordination drawings:</strong> Combined services layouts, spatial
              coordination — Access planning, clash avoidance
            </li>
          </ul>
          <p>
            <strong>As-Built Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Drawing Standards</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Revision and Version Control</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Revision numbering:</strong> Clear, sequential revision system (P01, P02 for
              preliminary; C01, C02 for construction; A01, A02 for as-built)
            </li>
            <li>
              <strong>Cloud markings:</strong> Identify areas of change on each revision
            </li>
            <li>
              <strong>Revision history:</strong> Document all changes with dates and reasons
            </li>
            <li>
              <strong>Superseded drawings:</strong> Clear marking and controlled disposal of
              superseded versions
            </li>
            <li>
              <strong>Digital storage:</strong> Secure repository with backup and access control
            </li>
          </ul>
          <p>
            <strong>BIM integration:</strong> Where BIM is used, as-built models should be updated
            to reflect installed conditions. The model becomes the primary record with 2D drawings
        ...
        <ConceptBlock title="Testing and Commissioning Records">
          <p>
            Testing and commissioning records provide evidence that all systems have been installed
            correctly, tested to verify performance and adjusted to meet design specifications. They
            establish a baseline for future performance monitoring and maintenance.
          </p>
          <p>
            <strong>Electrical Testing Records (BS 7671)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EIC:</strong> Electrical Installation Certificate for new installations —
              Mandatory for new work
            </li>
            <li>
              <strong>MEIWC:</strong> Minor Electrical Installation Works Certificate — Additions to
              existing circuits
            </li>
            <li>
              <strong>Schedule of Inspections:</strong> Visual inspection checklist results —
              Accompanies EIC
            </li>
            <li>
              <strong>Schedule of Test Results:</strong> Measured test values for each circuit —
              Accompanies EIC
            </li>
          </ul>
          <p>
            <strong>System-Specific Commissioning Records</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fire alarm:</strong> Commissioning certificate (BS 5839-1), zone test results,
              cause and effect verification, integration tests
            </li>
            <li>
              <strong>Emergency lighting:</strong> Commissioning certificate (BS 5266-1), duration
              test results, luminaire schedule verification
            </li>
            <li>
              <strong>BMS/controls:</strong> Point-to-point test sheets, control loop verification,
              trend logs, integration test results
            </li>
            <li>
              <strong>HVAC electrical:</strong> Motor rotation checks, VSD parameter records,
              interlock verification, safety device tests
            </li>
            <li>
              <strong>Lighting controls:</strong> DALI addressing records, scene programming
              verification, sensor commissioning
            </li>
          </ul>
          <p>
            <strong>Witness Testing Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>CIBSE Code M:</strong> Provides comprehensive guidance on commissioning
            management including record keeping, witness testing protocols and handover procedures
        ...
        <ConceptBlock title="Building Log Book and Health & Safety File">
          <p>
            The building log book (required under Part L of the Building Regulations) and the Health
            and Safety File (required under CDM 2015) are distinct legal requirements that ensure
            buildings can be operated safely and efficiently throughout their life.
          </p>
          <p>
            <strong>Building Log Book Requirements (Part L)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design criteria:</strong> Internal temperatures, fresh air rates, illuminance
              levels, occupancy assumptions
            </li>
            <li>
              <strong>HVAC systems:</strong> System descriptions, installed capacities, control
              strategies, operating schedules
            </li>
            <li>
              <strong>Lighting systems:</strong> Lighting strategy, control types, installed load,
              lux levels achieved
            </li>
            <li>
              <strong>Metering:</strong> Meter locations, sub-metering arrangements, energy
              monitoring provisions
            </li>
            <li>
              <strong>Energy targets:</strong> Predicted energy consumption, benchmarks, carbon
              emissions targets
            </li>
            <li>
              <strong>Maintenance:</strong> Recommended maintenance schedules to maintain efficiency
            </li>
          </ul>
          <p>
            <strong>Part L Compliance Note</strong>
          </p>
          <p>
            The building log book is a legal requirement for new non-domestic buildings under Part L
            of the Building Regulations. It must be provided to the building owner before the
            building is occupied or, where applicable, before the building control body issues a
            final certificate. The log book format should follow CIBSE TM31 guidance.
          </p>
          <p>
            <strong>Health and Safety File (CDM 2015)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Structure:</strong> Key structural elements, safe working loads, access
              provisions
            </li>
            <li>
              <strong>Hazardous materials:</strong> Location of any hazardous materials (e.g.,
              asbestos in existing buildings)
            </li>
            <li>
              <strong>Services:</strong> Location of services, isolation points, safety systems
            </li>
            <li>
              <strong>Safe access:</strong> Equipment requiring access for maintenance, roof access
              provisions
            </li>
            <li>
              <strong>Residual risks:</strong> Risks that could not be designed out, required
              precautions
            </li>
          </ul>
          <p>
            <strong>Electrical H&amp;S File Content</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>File Maintenance</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Legal requirement:</strong> Under CDM 2015, the client must ensure the Health
            and Safety File is prepared and maintained. Failure to do so is a criminal offence that
            can result in enforcement action by the HSE.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Digital Handover and COBie">
          <p>
            Digital handover increasingly replaces or supplements traditional paper-based
            documentation. COBie (Construction Operations Building information exchange) provides a
            standardised format for exchanging building asset data from design through construction
            to operation.
          </p>
          <p>
            <strong>COBie Data Structure</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Facility:</strong> Site and building information — Building name, address,
              project details
            </li>
            <li>
              <strong>Floor:</strong> Level information — Floor names, elevations, areas
            </li>
            <li>
              <strong>Space:</strong> Room and zone data — Room numbers, names, areas, usable
              heights
            </li>
            <li>
              <strong>Type:</strong> Asset type specifications — Manufacturer, model, specifications
            </li>
            <li>
              <strong>Component:</strong> Individual asset instances — Serial numbers, installation
              dates, locations
            </li>
            <li>
              <strong>System:</strong> System groupings — Electrical distribution, fire alarm, HVAC
            </li>
            <li>
              <strong>Document:</strong> Linked documentation — O&amp;M manuals, certificates,
              warranties
            </li>
          </ul>
          <p>
            <strong>BS EN ISO 19650 Information Management</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EIR:</strong> Employer's Information Requirements define what information is
              required at handover
            </li>
            <li>
              <strong>BEP:</strong> BIM Execution Plan describes how information will be delivered
            </li>
            <li>
              <strong>AIR:</strong> Asset Information Requirements define operational phase needs
            </li>
            <li>
              <strong>AIM:</strong> Asset Information Model is the delivered operational database
            </li>
            <li>
              <strong>Level of Information Need:</strong> Specifies detail required for each asset
              type
            </li>
          </ul>
          <p>
            <strong>Benefits of Digital Handover</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Government mandate:</strong> UK government projects require BIM Level 2 (now
            defined by BS EN ISO 19650) including COBie data drops at key project stages. Many
            private sector clients are adopting similar requirements.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Generic content:</strong> Manufacturer literature without project-specific
              information
            </li>
            <li>
              <strong>Missing test results:</strong> Certificates without supporting test schedules
            </li>
            <li>
              <strong>Outdated drawings:</strong> Design drawings not updated to as-built status
            </li>
            <li>
              <strong>Incomplete schedules:</strong> Equipment lists missing serial numbers or
              locations
            </li>
            <li>
              <strong>Poor indexing:</strong> Difficult to navigate without clear contents and
              cross-references
            </li>
            <li>
              <strong>No maintenance procedures:</strong> Manufacturer data without maintenance
              instructions
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stage 1 (25%):</strong> Review structure, format and content headings
            </li>
            <li>
              <strong>Stage 2 (50%):</strong> Review system descriptions and operating procedures
            </li>
            <li>
              <strong>Stage 3 (75%):</strong> Review maintenance procedures and equipment schedules
            </li>
            <li>
              <strong>Stage 4 (100%):</strong> Final review of complete documentation package
            </li>
          </ul>
        </ConceptBlock>
