...
const HNCModule6Section3_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 3 · Subsection 6"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Evidence quality is QA-tested by BRE before certification. Common failure modes:
              photos without metadata or location reference, calculations without
              inputs/assumptions, drawings without revision control, declarations without
              signatures. The assessor cannot fix these on submission day — the evidence pack must
        ...
        <ConceptBlock title="Documentation Requirements">
          <p>
            ...
            allow independent audit. Verbal commitments, unsigned documents, and undated records are
            not acceptable.
          </p>
          <p>
            <strong>Evidence Types Required for Building Services Credits:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Calculations:</strong> Energy models, lighting calculations, water consumption
              analyses
            </li>
            <li>
            ...
            <li>
              <strong>Product data:</strong> Manufacturer datasheets, certifications, test reports
            </li>
            <li>
          ...
          <p>
            <strong>Evidence Quality Standards</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Dated:</strong> Clear issue date visible — Specification Rev C - 15/03/2024
            </li>
            <li>
              <strong>Signed/Authorised:</strong> Named responsible person — Approved by: J. Smith
              CEng
            </li>
            <li>
              <strong>Project-specific:</strong> References project name/number — Project:
              Manchester Office - Ref: 12345
            </li>
            <li>
              <strong>Complete:</strong> All relevant information included — Full meter schedule
              with all locations
            </li>
            <li>
              <strong>Traceable:</strong> Clear reference system — Drawing ME-101 Rev D correlates
              to spec clause 5.3
            </li>
          </ul>
          <p>
            <strong>Key principle:</strong> If evidence cannot be independently verified by reading
            the document alone, it is insufficient for BREEAM assessment.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Design Stage Evidence">
          ...
          <p>
            <strong>Design Calculations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Building Services Design Stage Evidence by Credit</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ene 01 Energy Performance:</strong> SBEM/DSM calculations — M&E
              specifications, plant schedules
            </li>
            <li>
              <strong>Ene 02 Sub-metering:</strong> Metering strategy document — Meter schedule,
              schematic drawings
            </li>
            <li>
              <strong>Hea 01 Visual Comfort:</strong> Lighting design calculations — Luminaire
              specifications, control strategy
            </li>
            <li>
              <strong>Hea 02 Indoor Air Quality:</strong> Ventilation design calculations — AHU
              schedules, fresh air rates
            </li>
            <li>
              <strong>Wat 01 Water Consumption:</strong> BREEAM Wat 01 Calculator — Sanitaryware
              specifications
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Post-Construction Stage Evidence">
          ...
          <p>
            <strong>PCS Evidence Hierarchy</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Level 1:</strong> As-built drawings (shows what was installed)
            </li>
            <li>
              <strong>Level 2:</strong> Commissioning certificates (proves it works)
            </li>
            <li>
              <strong>Level 3:</strong> Site photographs (visual verification)
            </li>
            <li>
              <strong>Level 4:</strong> O&M manuals (handover documentation)
            </li>
          </ul>
          <p>
            <strong>Post-Construction Evidence Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>As-built drawings:</strong> Final installation drawings showing actual meter
              locations, equipment positions, and system configurations
            </li>
            <li>
              <strong>Commissioning records:</strong> Signed certificates demonstrating systems meet
            ...
            <li>
              <strong>Installation records:</strong> Delivery notes, installation sign-off sheets,
              quality records
            </li>
            <li>
          ...
          <p>
            <strong>Building Services PCS Evidence Examples</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ene 01 Energy Performance:</strong> Final EPC, as-built SBEM, air tightness
              test — Energy assessor
            </li>
            <li>
              <strong>Ene 02 Sub-metering:</strong> Meter commissioning certificates, as-built
              schedule — M&E contractor
            </li>
            <li>
              <strong>Hea 01 Visual Comfort:</strong> Lux level survey results, lighting
              commissioning — Electrical contractor
            </li>
            <li>
              <strong>Hea 02 Indoor Air Quality:</strong> Ventilation commissioning, air quality
              testing — Mechanical contractor
            </li>
            <li>
              <strong>Wat 01 Water Consumption:</strong> Flow rate test results, sanitaryware
              installation photos — Plumbing contractor
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Assessor Verification and Certification">
          ...
          <p>
            <strong>Certification Process Timeline</strong>
          </p>
          <p>
            <strong>Design Stage Certificate</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Post-Construction Certificate</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Assessor Verification Checks</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Evidence authenticity:</strong> Dates, signatures, project references —
              Unsigned documents, generic templates
            </li>
            <li>
              <strong>Criteria compliance:</strong> Evidence matches credit requirements — Partial
              compliance, missing elements
            </li>
            <li>
              <strong>Calculation accuracy:</strong> Methodology and inputs verified — Errors in
              BREEAM calculators
            </li>
            <li>
              <strong>Consistency:</strong> Evidence documents align — Specifications contradict
              drawings
            </li>
            <li>
              <strong>Completeness:</strong> All required evidence present — Missing commissioning
              records
            </li>
          </ul>
          <p>
            <strong>BREEAM Rating Thresholds</strong>
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Compile evidence for Ene 02 Sub-metering credits (3 credits
            targeted).
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Design Stage specified DALI lighting controls, but contractor
            installed standard switching.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Unsigned documents</strong> - All evidence requires named responsible person
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A development is targeting Excellent (70%). Pre-submission scoring shows 73% — 3%
              margin. After BRE Global QA review, six credits are withdrawn for evidence quality
              issues: three for inadequate procurement records (no signed declarations from
              suppliers), two for missing photographs (verbal confirmation only), one for outdated
              calculation (Stage 3 calc, not as-built). Final score 67% — Very Good, not Excellent.
            </>
          }
          whatToDo={
            <>
              Two-stage response: (1) immediate — appeal where there is genuine new evidence
              available (e.g. retrospective supplier declarations, post-completion site survey); (2)
              negotiate with the planning authority for a variation. Lesson: every credit on a tight
              margin must have its evidence pack QA-checked by the Assessor before submission,
              against a credit-by-credit checklist of BRE expectations. Build the evidence pack as
              construction proceeds, not at the end.
            </>
          }
          whyItMatters={
            <>
              BREEAM is won and lost on evidence quality. Clients (and contractors) often think
              compliance equals certification — it does not. BRE's QA process is rigorous; the
              assessor is your QA shield, not a rubber stamp. Budget time and fee for evidence
              collection from RIBA Stage 4 onwards.
            </>
          }
        />
