    ...
    <div className="min-h-screen overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <header className="text-center mb-12">
          <div className="inline-flex items-center gap-2 text-elec-yellow text-sm mb-3"><Zap className="h-4 w-4" /><span>Module 6.6.2</span></div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3">Installation Specifications</h1>
          <p className="text-white/80">Writing professional specifications for electrical installations</p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {["Write clear and comprehensive installation specifications", "Specify materials with appropriate quality standards", "Define workmanship and installation practices", "Include testing and certification requirements", "Reference relevant British Standards", "Create quality assurance procedures"].map((item, i) => (
        ...
        <nav className="flex flex-col sm:flex-row gap-4 justify-between pt-8 border-t border-white/10">
          <Button variant="outline" className="border-white/20 text-white hover:bg-white/5" asChild>
            <Link to="../level3-module6-section6-1"><ArrowLeft className="w-4 h-4 mr-2" />Previous: Design Documentation</Link>
          </Button>
          <Button className="bg-elec-yellow text-[#1a1a1a] hover:bg-elec-yellow/90" asChild>
            <Link to="../level3-module6-section6-3">Next: Bill of Quantities<ArrowLeft className="w-4 h-4 ml-2 rotate-180" /></Link>
          </Button>
        </nav>
      </article>
    </div>
