...
const DESCRIPTION =
  'Understanding special design requirements for electrical installations in bathrooms and wet locations, including zones, IP ratings, and supplementary bonding under BS 7671.';

const quickCheckQuestions = [
  {
    id: 'check-1',
    question:
      'What is the primary reason bathrooms require special electrical installation requirements?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Bathrooms are special locations because water and steam reduce skin resistance, wet skin provides better contact with conductive surfaces, and people may be unclothed - all factors that significantly increase the risk of electric shock at lower voltages.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'Zone 1 extends from the finished floor level to 2.25m height above the floor, bounded by the vertical plane at the edge of the bath or shower basin, or for showers without a basin, 1.2m from the showerhead fixing point.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 2,
    explanation:
      "Equipment in Zone 1 must be at least IPX4 (protection against water splashing from all directions). Where water jets are likely to be used for cleaning, this increases to IPX5. The 'X' means the solid particle rating isn't specifically required.",
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      'Regulation 701.415.2 permits omission of supplementary bonding where all final circuits in the location comply with automatic disconnection requirements using 30mA RCDs, AND all extraneous-conductive-parts are connected to the protective bonding.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Zone 0 is the interior of the bath tub or shower basin - essentially where water is intended to collect. Only SELV at 12V AC or 30V DC maximum is permitted here, with the safety source located outside Zones 0, 1 and 2.',
  },
  {
    id: 2,
    question:
      'A client wants to install a standard 13A socket outlet 2.5m from the edge of their shower tray. Is this permitted?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Zone 2 extends only 0.6m horizontally from Zone 1. At 2.5m from the shower, the socket is outside the zones (provided the room has fixed partition walls defining the bathroom). Socket outlets outside the zones must still be RCD protected at 30mA.',
  },
  {
    id: 3,
    question:
      'What special consideration applies to heating elements embedded in the floor of a bathroom?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Regulation 701.753 permits floor heating systems in any zone provided they are covered by an earthed metallic sheath connected to the protective conductor, or have an earthed metallic grid connected to the protective conductor, or are supplied by SELV/PELV.',
  },
  {
    id: 4,
    question:
      'Why is a metal bath considered an extraneous-conductive-part requiring bonding consideration?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'An extraneous-conductive-part is one not forming part of the electrical installation but liable to introduce a potential (generally earth potential). A metal bath connected to metal pipework could introduce a potential difference during a fault elsewhere in the building.',
  },
  {
    id: 5,
    question:
      'What is the maximum disconnection time for a 230V circuit in a bathroom under TN systems?',
    options: ['5 seconds', '0.4 seconds', '0.2 seconds', '0.1 seconds'],
    correctAnswer: 1,
    explanation:
      'The maximum disconnection time of 0.4s applies to all 230V circuits in TN systems as standard (Regulation 411.3.2.2). However, the 30mA RCD requirement for bathroom circuits provides much faster disconnection in most earth fault conditions.',
  },
  {
    id: 6,
    question:
      'A shower pump is to be installed in a cupboard adjacent to but not within the bathroom. What requirements apply?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Equipment located in a separate room/cupboard outside the bathroom is not subject to bathroom zone requirements. However, circuits supplying bathroom equipment still require RCD protection at 30mA, and the pump should be suitable for its environment.',
  },
  {
    id: 7,
    question: 'What IP rating must luminaires have in Zone 2 of a bathroom?',
    options: ['No specific IP requirement', 'IPX2 minimum', 'IPX4 minimum', 'IP65 mandatory'],
    correctAnswer: 2,
    explanation:
      'Luminaires in Zone 2 must have a minimum rating of IPX4 (same as Zone 1). This protects against water splashing which can occur from shower use even at the Zone 2 distances.',
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      'Socket outlets for equipment like washing machines can be installed outside Zone 2 (greater than 0.6m from the edge of Zone 1) provided they have 30mA RCD protection. Many bathrooms are too small for this, which is why washing machines are more commonly in kitchens.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      'The zones are bounded at 2.25m height. Above this level, and outside the horizontal zone boundaries, standard installation requirements apply (though circuits still need 30mA RCD protection as they are in the bathroom location).',
  },
  {
    id: 10,
    question:
      'What type of cable is recommended for circuits in bathroom walls where zone locations may change?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Where circuits must pass through zones, mechanical protection using steel conduit or MICC provides long-term reliability. Future bathroom alterations might change zone boundaries, so robust installation methods provide better future-proofing.',
  },
  {
    id: 11,
    question:
      'A hotel is designing bathrooms for guest rooms. What additional considerations apply beyond domestic requirements?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Commercial bathroom installations must consider emergency escape lighting, fire alarm integration, management controls for maintenance access, and potentially higher reliability requirements. Guest safety and operational needs add complexity to the design.',
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      'The equipotential zone ensures that during a fault, all metal parts a person could simultaneously touch remain at approximately the same voltage. This prevents dangerous potential differences that could cause current to flow through the body.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'En-suite bathrooms are treated the same as any other bathroom under BS 7671. The zones are measured from the bath or shower location. However, careful attention is needed at the door opening - socket outlets in the bedroom immediately adjacent to the en-suite door may still be outside bathroom zones but consideration of splash risk is sensible.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Zone System:</strong> Three zones (0, 1, 2) with different equipment
                requirements
              </li>
              <li>
                <strong>RCD Protection:</strong> All bathroom circuits require 30mA RCD protection
              </li>
              <li>
                <strong>IP Ratings:</strong> IPX4 minimum in Zones 1 and 2; IPX7 in Zone 0
              </li>
              <li>
                <strong>Bonding:</strong> Supplementary bonding may be omitted if conditions met
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Inadequate IP ratings on bathroom luminaires causing
                corrosion
              </li>
              <li>
                <strong>Use:</strong> Always measure zone dimensions from bath/shower edge
              </li>
              <li>
                <strong>Apply:</strong> Document bonding decisions and RCD protection status
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Bathrooms present unique electrical hazards that require specific design measures. The
              combination of water, steam, reduced clothing, and conductive surfaces creates
              conditions where electric shock is more likely and more dangerous than in normal dry
              locations.
            </p>
            <p>
              BS 7671 Section 701 addresses these risks through a zone-based approach. The closer to
              water sources, the stricter the requirements. This graduated approach allows practical
              use of electricity in bathrooms whilst maintaining safety margins appropriate to the
              risk.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> The danger isn't just direct contact with water. A person
              standing in a bath touching a faulty appliance has near-ideal conditions for a fatal
              shock - wet skin, bare feet in water, excellent earth contact through pipes.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 7671 divides bathrooms into three zones based on proximity to water sources. Each
              zone has specific requirements for what equipment can be installed and what protection
              levels apply. Understanding these zones is fundamental to bathroom electrical design.
            </p>
            ...
            <div className="grid gap-4 my-6">
              ...
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
                <p className="text-sm font-medium text-orange-400 mb-2">
                  Zone 1 - Immediately Above Bath/Shower
                </p>
                <p className="text-sm text-white mb-2">
                ...
                <ul className="text-sm text-white space-y-1 ml-4">
                  ...
                  <li>
                    Suitable items: showers, SELV luminaires, fixed instantaneous water heaters
                  </li>
            ...
            <p>
              Beyond Zone 2 (more than 0.6m from Zone 1 boundary), standard installation practices
              apply within the bathroom - though all circuits must still have 30mA RCD protection
            ...
            <p className="text-sm text-white italic">
              ...
              mirror light positioned 800mm from the bath edge would be in Zone 2 and require IPX4
              rating.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              IP (Ingress Protection) ratings define how well an enclosure protects against solid
              objects and water. In bathroom design, the second digit (water protection) is
              critical. The format IPX4 indicates the solid particle rating is not specified ('X')
              but water protection level 4 is required.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-3">
                Water Protection Ratings for Bathroom Zones:
              </p>
            ...
            <p>
              Equipment selection goes beyond IP ratings. Class II (double insulated) equipment is
              preferred in zones as it doesn't require a protective conductor connection,
              eliminating one potential fault path. Where Class I equipment is used, robust
              protective conductor connections are essential.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> IP ratings address water ingress protection but not
              necessarily the safety of internal components in damp conditions. Always select
              equipment specifically designed and tested for bathroom use, not just items with
              matching IP ratings.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Supplementary bonding in bathrooms creates a local equipotential zone by connecting
              all extraneous-conductive-parts (metal pipes, baths, radiators) to each other and to
              the circuit protective conductors. This ensures that during a fault, all touchable
              metal parts rise to approximately the same voltage, preventing dangerous potential
              differences.
            </p>

            <p>
              The 18th Edition and Amendment 2 modified these requirements. Regulation 701.415.2 now
              permits supplementary bonding to be omitted where all final circuits in the location
              meet specific conditions - a significant change from previous editions that mandated
              supplementary bonding in all bathrooms.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-green-500/10 border border-green-500/30">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                ...
                <li>
                  <strong>Condition 2:</strong> Automatic disconnection times per Section 411 are
                  achieved
                </li>
                <li>
                  <strong>Condition 3:</strong> All extraneous-conductive-parts are connected to the
            ...
            <p>
              Where these conditions cannot be confirmed - particularly the main bonding status in
              older properties - supplementary bonding should be installed. When in doubt, bond. The
              cost of bonding conductors is minimal compared to the potential consequences of an
              uncontrolled fault.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  To circuit protective conductors: at least equal to the smallest CPC of circuits
                  in the location (minimum 2.5mm<sup>2</sup> if mechanically protected)
                </li>
            ...
            <p className="text-sm text-white italic">
              ...
              the bathroom lighting or shower circuit. Use 4mm<sup>2</sup> earth cable with suitable
              clamps for pipe connections.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Electric Shower Circuit Design
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Determine shower unit power rating (7.5kW to 10.8kW typical for modern units)
                </li>
                <li>Calculate design current: I = P / V (e.g., 10.5kW / 230V = 45.6A)</li>
                <li>
                  Select cable size accounting for route length, grouping, insulation contact, and
                  ambient temperature
                </li>
                <li>
                  Typical cables: 10mm<sup>2</sup> for units up to 9.5kW, verify for longer runs
                </li>
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Lighting Circuit Considerations
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  For ceiling luminaires above baths, ensure IPX4 minimum even if outside zones by
                  height
                </li>
                <li>Pull-cord switches within zones must be insulated and non-metallic</li>
                <li>
                  Plate switches must be located outside the bathroom or in zone 2 minimum (3m from
                  Zone 1)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Wrong IP ratings</strong> - Using IPX2 luminaires in zones requiring IPX4
                </li>
                <li>
                  <strong>Zone measurement errors</strong> - Measuring from wall not bath edge,
                  forgetting 2.25m height limit
                </li>
                <li>
                  <strong>Omitting RCD protection</strong> - All bathroom circuits need 30mA RCDs,
                  not just shower
                </li>
                <li>
                  <strong>Inadequate bonding assessment</strong> - Assuming supplementary bonding
                  not needed without verifying conditions
                </li>
                <li>
                  <strong>Socket outlet placement</strong> - Installing sockets within Zone 2
                  boundaries
                </li>
              </ul>
            </div>
