...
const DESCRIPTION =
  'Comprehensive guide to electrical conductor and insulation materials for maintenance technicians: copper, aluminium, PVC, XLPE, cable construction, current-carrying capacity and BS 7671 selection.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "Copper has a resistivity of approximately 1.72 x 10^-8 ohm-metres, compared to aluminium's 2.82 x 10^-8 ohm-metres. This lower resistivity means copper can carry more current for a given cross-sectional area. Copper is also more ductile (easier to bend and form), easier to make reliable terminations with (aluminium requires special techniques), and has excellent corrosion resistance.",
  },
  {
    id: 'pvc-temperature',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "XLPE (cross-linked polyethylene) is a thermosetting insulation material with a maximum continuous operating temperature of 90°C (compared to PVC's 70°C). This higher temperature rating allows XLPE-insulated cables to carry higher currents for the same conductor size, or to use smaller conductors for the same current — making them particularly useful for sub-mains and high-current circuits.",
  },
  {
    id: 'swa-cable',
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Copper has a resistivity of approximately 1.72 x 10^-8 ohm-metres (or 17.2 nanoohm-metres) at 20°C. This is one of the lowest resistivities of any practical conductor material, exceeded only by silver. This low resistivity is why copper is the standard conductor material for electrical installations.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      "Aluminium forms an oxide layer (aluminium oxide, Al2O3) that is electrically resistive. At terminations, this oxide must be penetrated to achieve a good electrical connection. Aluminium also exhibits 'cold flow' — it slowly deforms under sustained mechanical pressure, which can loosen terminations over time. Special connectors, bi-metallic lugs and anti-oxidant compound are required for reliable aluminium terminations.",
  },
  {
    id: 3,
    question:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'When multiple current-carrying cables are grouped together, each cable generates heat that contributes to heating the others. The reduced ability to dissipate heat to the surroundings means each cable reaches its maximum insulation temperature at a lower current. Grouping factors (Cg) from BS 7671 Table 4C1 must be applied to reduce the tabulated current-carrying capacity accordingly.',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Insulation resistance is measured between conductors (and between each conductor and earth) using an insulation resistance tester that applies a DC test voltage. For circuits up to 500 V, the test voltage is 500 V DC (BS 7671 Table 6A). The minimum acceptable insulation resistance is 1 megohm (1 MΩ). Values below this indicate insulation degradation requiring investigation.',
  },
  {
    id: 9,
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              engineering: copper and aluminium. Each has distinct properties that make it suitable
              for different applications, and a maintenance technician must understand these
              differences to work safely and effectively with both materials.
            </p>
            <p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              accidental contact with live conductors (safety function). The insulation material's
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              current-carrying capacities for various cable types and installation methods. These
