      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              existing installation triggers an explicit verification — supply rating, fault level,
              earthing, bonding — before the alteration can be designed. The designer who skips that
              check has not only breached BS 7671 but also failed CDM Reg 9 (designer duty to
              eliminate or reduce foreseeable risk). The register entry says: "Existing supply
              rating verified — see Survey Report SR-XXX dated YYYY-MM-DD" or "Risk: existing supply
              rating unverified at design stage — survey required before construction."
            </>
          }
        ...
        <ConceptBlock title="Designer Duties Under CDM 2015">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>2. Reduce — minimise the risk — locate equipment at low level not height</li>
        ...
        <ConceptBlock title="Creating the Design Risk Register">
          <p>
            The design risk register documents hazards identified during design, the decisions made
            to address them, and any significant residual risks that need to be communicated to
            others.
          </p>
          <p>
        ...
        <ConceptBlock title="Risk Communication and H&S File">
          <p>
            Effective communication of design risks ensures that contractors during construction and
            maintainers throughout the building life can manage residual risks appropriately.
          </p>
          <p>
          ...
          <p>
            <strong>
              H&S file information from electrical designer (information type / examples):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              The client wants a phased ground-floor refurbishment of an occupied 5-storey office.
              Floors 1-4 stay live and tenanted throughout. Existing 1990s installation, no recent
              EICR, partial supply records. You’re leading the design and the Principal Designer
              asks for the design risk register at Stage 3.
            </>
          }
          whatToDo={
            <>
              ...
              isolation independently of floors 1-4; specify mechanical interlock and Reg 514.15.1
              warning notices at every isolation point during construction phasing.
              <br />
              ...
              survey; PCI to flag containment lift restrictions. Each risk has owner, date, action
              and review date. Living document — updated through Stage 4, signed off into the
              H&amp;S File at handover.
            </>
          }
          whyItMatters={
            <>
