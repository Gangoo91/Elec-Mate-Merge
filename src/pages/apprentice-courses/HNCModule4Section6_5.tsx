...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Only electrical risks',
      'Risks covered by regulations',
    ],
    correctIndex: 1,
    explanation:
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">
            Understanding designer duties under CDM 2015 and communicating significant residual
            risks
          </p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>CDM 2015:</strong> Construction (Design and Management) Regulations
              </li>
              <li className="pl-1">
                <strong>Designer duty:</strong> Eliminate, reduce, inform about risks
              </li>
              <li className="pl-1">
                <strong>Risk register:</strong> Record hazards, decisions, residual risks
              </li>
              <li className="pl-1">
                <strong>H&S file:</strong> Information for future maintenance/work
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Electrical hazards:</strong> Shock, arc flash, fire
              </li>
              <li className="pl-1">
                <strong>Access:</strong> Heights, confined spaces, plant rooms
              </li>
              <li className="pl-1">
                <strong>Lifecycle:</strong> Construction, operation, maintenance
              </li>
              <li className="pl-1">
                <strong>Hidden services:</strong> Cables, equipment locations
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Key designer duties (Regulation 9):
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Use SELV instead of mains in wet areas
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Locate equipment at low level not height
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Note hidden cables on drawings/register
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Key electrical hazards to consider:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Design Decisions to Eliminate/Reduce Risk
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-2 py-2">
                        Design for all maintenance to be done dead
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-2 py-2">Working at height</td>
                      <td className="border border-white/10 px-2 py-2">
                        Locate equipment at accessible heights
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-2 py-2">
                        Split into smaller components, ensure access
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-2 py-2">Confined space</td>
                      <td className="border border-white/10 px-2 py-2">
                        Adequate space, access from outside riser
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-2 py-2">Cable damage</td>
                      <td className="border border-white/10 px-2 py-2">
                        Protected routes, avoid areas of future work
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Methods of communicating design risks:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Drawing Annotation Examples
              </p>
              <div className="bg-white/5 p-4 rounded text-sm">
                <ul className="text-white space-y-2 list-none">
                  <li className="border-l-2 border-red-400/50 pl-3">
                    "WARNING: 11kV cables in this service trench - DNO isolation required"
                  </li>
                  <li className="border-l-2 border-orange-400/50 pl-3">
                    "NOTE: UPS battery room - ventilation must be operational before entry"
                  </li>
                  <li className="border-l-2 border-yellow-400/50 pl-3">
                    "Permit to work required for all work on this switchboard"
                  </li>
                  <li className="border-l-2 border-blue-400/50 pl-3">
                    "Luminaires in this area accessible from MEWP only"
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                H&S File Information from Electrical Designer
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
