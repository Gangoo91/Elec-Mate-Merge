...
const quickCheckQuestions = [
  {
    ...
    options: ['Six-monthly', 'Quarterly', 'Monthly', 'Weekly'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Daily', 'Weekly', 'Quarterly', 'Monthly'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Six-monthly', 'Monthly', 'Annually', 'Quarterly'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Quarterly', 'Monthly', 'Annually', 'Six-monthly'],
    correctAnswer: 3,
    explanation:
...
const HNCModule7Section2_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 2 · Subsection 6"
        title="Testing and Compliance"
        backTo="/study-centre/apprentice/h-n-c-module7-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Periodic testing schedules, documentation requirements, fire risk assessment coordination,
        ...
        <ConceptBlock title="Emergency Lighting Testing (BS 5266)">
          ...
          <p>
            <strong>Testing Schedule Summary</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Daily visual check:</strong> Every occupied day — Brief observation — Building
              staff
            </li>
            <li>
              <strong>Monthly functional test:</strong> Not exceeding 1 month — Brief (sufficient to
              verify operation) — Trained staff
            </li>
            <li>
              <strong>Annual duration test:</strong> Not exceeding 12 months — Full rated duration
              (typically 3 hours) — Competent person
            </li>
          </ul>
          <p>
            <strong>Monthly functional test procedure:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Annual duration test procedure:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Fire Alarm Testing (BS 5839)">
          <p>
            ...
            detection and alarm systems. Regular testing ensures systems will detect fires and alert
            occupants when required.
          </p>
          <p>
            <strong>Testing and Servicing Schedule</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Weekly test:</strong> Not exceeding 7 days — User (trained staff)
            </li>
            <li>
              <strong>Monthly checks:</strong> Monthly — User (trained staff)
            </li>
            <li>
              <strong>Quarterly inspection:</strong> Not exceeding 3 months — Competent person
            </li>
            <li>
              <strong>Six-monthly service:</strong> Not exceeding 6 months — Competent person
            </li>
            <li>
              <strong>Annual inspection:</strong> Not exceeding 12 months — Competent person
            </li>
          </ul>
          <p>
            <strong>Weekly Test Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Six-Monthly Service Includes</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Detector Testing Methods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Smoke detectors:</strong> Use approved aerosol smoke simulant or functional
              test equipment
            </li>
            <li>
        ...
        <ConceptBlock title="Documentation Requirements">
          <p>
            Comprehensive documentation demonstrates compliance, supports maintenance planning, and
            provides essential evidence following incidents. Both BS 5266 and BS 5839 mandate
            specific documentation throughout the system lifecycle.
          </p>
          <p>
            <strong>Emergency Lighting Documentation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Installation certificate:</strong> Compliance statement, system details,
              designer sign-off — Life of installation
            </li>
            <li>
              <strong>As-installed drawings:</strong> Luminaire locations, circuit details, device
              types — Life of installation
            </li>
            <li>
              <strong>Log book:</strong> All tests, defects, repairs, alterations — Ongoing (min 3
              years available)
            </li>
            <li>
              <strong>Photometric evidence:</strong> Design calculations, illumination levels
              achieved — Life of installation
            </li>
          </ul>
          <p>
            <strong>Fire Alarm Documentation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design certificate:</strong> System category, coverage, standards compliance —
              Life of installation
            </li>
            <li>
              <strong>Installation certificate:</strong> Compliance with design, workmanship
              standards — Life of installation
            </li>
            <li>
              <strong>Commissioning certificate:</strong> Test results, cause and effect
              verification — Life of installation
            </li>
            <li>
              <strong>Cause and effect matrix:</strong> System responses to each trigger condition —
              Life of installation
            </li>
            <li>
              <strong>Log book:</strong> Tests, false alarms, faults, maintenance, alterations —
              Ongoing (min 3 years available)
            </li>
          </ul>
          <p>
            <strong>Log Book Best Practice</strong>
          </p>
          ...
          <p>
            <strong>Digital log books:</strong> Electronic recording systems are acceptable provided
            they maintain audit trails, prevent unauthorised modification, and can be printed on
            demand.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Regulatory Compliance and FRA Coordination">
          ...
          <p>
            <strong>Key RRO 2005 Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>FRA and Testing Coordination</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Higher risk identified:</strong> May require more frequent testing — Review
              and enhance test schedule
            </li>
            <li>
              <strong>Building layout changed:</strong> Verify system coverage remains adequate —
              Full system test and re-certification
            </li>
            <li>
              <strong>Occupancy type changed:</strong> System category may need upgrading — Design
              review and modification
            </li>
            <li>
              <strong>Test failures recorded:</strong> FRA should reflect system reliability issues
              — Repair and update FRA
            </li>
          </ul>
          <p>
            <strong>Critical Compliance Point</strong>
          </p>
          <p>
            The fire risk assessment must be reviewed whenever there is reason to suspect it is no
            longer valid, or there has been a significant change to the premises. Emergency system
            modifications, test failures, or changes in testing arrangements are all triggers for
            FRA review.
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> During the annual duration test, 8 of 45 emergency luminaires
            fail before reaching the 3-hour duration.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> A new server room has been added to a commercial building,
            requiring fire alarm system extension.
          </p>
          <p>System changes:</p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Emergency lighting monthly:</strong> Brief functional test, record in log book
            </li>
            <li>
            ...
            <li>
              <strong>Fire alarm weekly:</strong> Different call point each week, complete cycle in
              13 weeks
            </li>
            <li>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">UPS systems</div>
          </button>
          <button
