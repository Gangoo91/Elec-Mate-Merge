...
const quickCheckQuestions = [
  {
    ...
    options: [
      'It eliminates the need for any connection to the electricity grid',
      'Higher overall efficiency by utilising waste heat that would otherwise be rejected',
      'It produces electricity at a lower voltage that is safer to distribute',
      'It removes the requirement for any back-up boiler plant',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To generate heat locally within each dwelling using an electric immersion element',
      'To meter the volume of cold water entering the building for billing purposes',
      "To transfer heat from the district network to the building's heating and hot water system",
      'To boost the network pressure before water is returned to the energy centre',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Building regulations prohibit CHP units from meeting peak heating loads',
      'A peak-sized unit cannot physically generate enough electricity for the site',
      'A constant fuel supply is only available during off-peak periods',
      'To maximise annual running hours and so secure an economic return',
    ],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Combined cycle', 'Steam turbine', 'Reciprocating gas engine', 'Gas turbine'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1.0-1.5:1', '0.5:1', '3:1', '5:1'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To strain debris and air bubbles out of the circulating water',
      'To decouple heat production from demand, enabling longer CHP running hours',
      'To accommodate thermal expansion of water and maintain stable system pressure',
      'To raise the temperature of the return water before it re-enters the boiler',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Higher grade exhaust heat (typically 450-550°C), suitable for raising steam',
      'Better efficiency when running at low part-load conditions',
      'A faster start-up time from cold, typically under one minute',
      'Lower capital cost per kilowatt of electrical output',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A gas burner, flue and combustion air fan',
      'A reciprocating engine, alternator and exhaust silencer',
  ...
  },
  {
    ...
    options: ['1,000-2,000 hours', '4,000-5,000+ hours', '2,000-3,000 hours', '8,000+ hours'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To filter and soften the make-up water added to the network',
      'To decouple heat production from demand, enabling longer CHP running hours',
      'To raise the system pressure during periods of peak heat demand',
      'To recover exhaust heat directly from the engine flue gases',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The terminal voltage and the load power factor',
      'The fuel calorific value and the air-fuel ratio',
      'The number of poles and the rotational speed',
      'The exhaust gas temperature and the cooling water flow',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It raises the network flow temperature to improve heat transfer',
      'It removes the need for plate heat exchangers at each building',
      'It eliminates standing heat losses from the distribution pipework',
      'Reduced pumping energy while still maintaining heat delivery to customers',
    ],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CP1 is the UK design standard. Low return temperatures (the single most important
              design parameter) drive efficient generation. The Heat Networks (Metering and Billing)
              Regulations 2014 mandate metering of every customer and transparent tariffs —
              non-compliance is a criminal offence enforced by the Office for Product Safety and
              Standards (OPSS).
            </>
          }
        ...
        <ConceptBlock title="CHP Fundamentals and Efficiency">
          <p>
            ...
            utilising the heat that would otherwise be wasted in conventional power generation, CHP
            systems achieve overall efficiencies of 70-90% compared to 35-45% for grid electricity.
          </p>
          <p>
            <strong>CHP efficiency compared to separate generation:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Conventional power station:</strong> 35-45% electrical efficiency; remaining
              55-65% lost as waste heat
            </li>
            <li>
              <strong>Gas engine CHP:</strong> 35-42% electrical + 45-50% thermal = 80-88% overall
            </li>
            <li>
              <strong>Gas turbine CHP:</strong> 25-40% electrical + 40-50% thermal = 70-85% overall
            </li>
            <li>
              <strong>Fuel cell CHP:</strong> 40-60% electrical + 30-40% thermal = 80-90% overall
            </li>
          </ul>
          <p>
            <strong>Heat-to-Power Ratio</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Gas engine:</strong> 1.0-1.5:1 — 50 kWe - 5 MWe — Buildings, district heating
            </li>
            <li>
              <strong>Gas turbine:</strong> 1.5-2.5:1 — 500 kWe - 50+ MWe — Large industrial,
              utilities
            </li>
            <li>
              <strong>Micro-CHP (Stirling):</strong> 6-10:1 — 1-3 kWe — Domestic, small commercial
            </li>
            <li>
              <strong>Fuel cell:</strong> 0.5-1.0:1 — 1 kWe - 2 MWe — High electrical demand sites
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Overall efficiency:</strong> η = (Pelec + Qheat) / Qfuel × 100%
            </li>
            <li>
              <strong>Electrical efficiency:</strong> ηe = Pelec / Qfuel × 100%
            </li>
            <li>
              <strong>Thermal efficiency:</strong> ηth = Qheat / Qfuel × 100%
            </li>
            <li>
              <strong>Example:</strong> 500 kW gas input, 180 kWe electrical, 250 kWth heat
            </li>
            <li>
              <strong>Overall:</strong> (180 + 250) / 500 × 100 = 86%
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Prime Movers and Heat Recovery">
          ...
          <p>
            <strong>Reciprocating Gas Engine</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Heat Recovery Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Jacket water (engine):</strong> 80-95°C — Plate heat exchanger — 25-30%
            </li>
            <li>
              <strong>Exhaust gas:</strong> 400-550°C — Exhaust heat exchanger — 20-25%
            </li>
            <li>
              <strong>Lubricating oil:</strong> 70-85°C — Oil cooler heat exchanger — 5-8%
            </li>
            <li>
              <strong>Intercooler (turbo):</strong> 40-60°C — Low-grade heat recovery — 3-5%
            </li>
          </ul>
          <p>
            <strong>Electrical Generation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Synchronous generator:</strong> Three-phase alternator producing 400V or 11kV
              output
            </li>
            <li>
              <strong>Frequency:</strong> f = (n × p) / 120 where n = RPM, p = poles (typically 1500
              RPM, 4-pole for 50 Hz)
            </li>
            <li>
        ...
        <ConceptBlock title="District Heating Networks">
          ...
          <p>
            <strong>Network Temperature Generations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>3rd Generation (current):</strong> Flow 70-90°C, Return 40-60°C, ΔT 30 K
            </li>
            <li>
              <strong>4th Generation (emerging):</strong> Flow 50-60°C, Return 25-35°C, ΔT 25 K
            </li>
            <li>
              <strong>5th Generation (ambient):</strong> Flow 10-25°C with building-level heat pumps
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pre-insulated pipe:</strong> Heat distribution — Steel carrier, PUR
              insulation, PE casing
            </li>
            <li>
              <strong>Expansion loops:</strong> Thermal expansion accommodation — U-bends, L-bends,
              or expansion joints
            </li>
            <li>
              <strong>Isolation valves:</strong> Section isolation for maintenance — Ball or
              butterfly valves, typically PN16
            </li>
            <li>
              <strong>Distribution pumps:</strong> Circulate water through network — Variable speed
              for flow modulation
            </li>
            <li>
              <strong>Pressurisation set:</strong> Maintain system pressure — Typically 3-6 bar
              depending on height
            </li>
          </ul>
          <p>
            <strong>Heat Interface Units (HIUs)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Space heating:</strong> PHE sized for design load, typically 40-60°C secondary
              flow
            </li>
            <li>
            ...
            <li>
              <strong>Heat metering:</strong> MID-approved meter for billing, typically ultrasonic
              type
            </li>
            <li>
              <strong>DPVC:</strong> Differential pressure control valve maintains stable ΔP across
              HIU
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Energy Centre Design and Optimisation">
          ...
          <p>
            <strong>Spark Spread Analysis</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Spark spread:</strong> Electricity price - (Gas price / ηe) — 15p - (3p /
              0.38) = 7.1p/kWh
            </li>
            <li>
              <strong>Heat credit:</strong> Avoided boiler gas × ηboiler — 3p × 0.90 = 2.7p/kWh
              saved
            </li>
            <li>
              <strong>Operating margin:</strong> Spark spread + heat credit - costs — Must exceed
              maintenance cost
            </li>
            <li>
              <strong>Break-even hours:</strong> Capital cost / annual saving — Target payback 5-7
              years
            </li>
          </ul>
          <p>
            <strong>Control Strategy Hierarchy</strong>
          </p>
          <p>
          ...
          <p>
            <strong>2. CHP priority:</strong> Run CHP at optimal load when spark spread positive and
            heat absorbable
          </p>
          <p>
            <strong>3. Thermal store management:</strong> Charge when CHP output exceeds demand;
            discharge to extend CHP off-periods
          </p>
          <p>
          ...
          <p>
            <strong>5. Network pump control:</strong> Variable speed to maintain ΔP at index HIU
          </p>
          <p>
            <strong>Energy Centre Plant Schedule (Typical 5 MW Peak)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Gas engine CHP:</strong> 500 kWe / 600 kWth — 2 — Lead/lag baseload operation
            </li>
            <li>
              <strong>Gas boiler:</strong> 2,000 kW — 2 — Peak and backup, N+1
            </li>
            <li>
              <strong>Thermal store:</strong> 50,000 litres — 1 — ~2 hours at average load
            </li>
            <li>
              <strong>Distribution pump:</strong> 150 m³/h @ 6 bar — 2 — Variable speed,
              duty/standby
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            ηe = 450 / 1,200 × 100 = <span>37.5%</span>
          </p>
          <p>Thermal efficiency:</p>
          <p>ηth = Qheat / Qfuel × 100</p>
          <p>
            ηth = 550 / 1,200 × 100 = <span>45.8%</span>
          </p>
          <p>Overall efficiency:</p>
          <p>ηoverall = (Pelec + Qheat) / Qfuel × 100</p>
          <p>
            ηoverall = (450 + 550) / 1,200 × 100 = <span>83.3%</span>
          </p>
          <p>Heat-to-power ratio:</p>
          <p>
            H:P = 550 / 450 = <span>1.22:1</span>
          </p>
          <p>
            <strong>Example 2: District Heating Flow Rate</strong>
          </p>
          <p>
            <strong>Scenario:</strong> A district heating network must deliver 3 MW of heat. Flow
            temperature is 85°C, return temperature is 55°C. Calculate the required flow rate.
          </p>
          <p>Given:</p>
          ...
          <p>ṁ = 3,000 / (4.18 × 30)</p>
          <p>
            ṁ = 3,000 / 125.4 = <span>23.9 kg/s</span>
          </p>
          <p>Volume flow rate:</p>
          <p>
            V̇ = 23.9 / 1,000 × 3,600 = <span>86 m³/h</span>
          </p>
          <p>
            <strong>Example 3: CHP Economic Analysis (Spark Spread)</strong>
          </p>
          <p>
            <strong>Scenario:</strong> Evaluate CHP viability with electricity at 18p/kWh, gas at
            4p/kWh, electrical efficiency 38%, and CHP output of 500 kWe.
          </p>
        ...
        <Scenario
          ...
          situation={
            <>
              A 2015-installed 350 kWe gas CHP serving a residential heat network was sized on a 3:1
              gas-to-electricity price ratio. By 2024, the spark spread is closer to 1.5:1, gas
              tariffs include carbon levies, and the CHP is now operating only 1,800 hours/year. The
              heat network operator is breaching CP1 affordability targets and customers are
              receiving high bills.
            </>
          }
          whatToDo={
            <>
              Three-stage transition: (1) immediately, run the CHP only at peak winter as a
              peak-lopping unit; (2) within 12 months, install a high-temperature heat pump (e.g.
              CO₂ refrigerant cycle to &gt;65°C) to take base load; (3) within 5 years, replace the
              CHP entirely with heat pump + thermal store. Lower the return temperature (typically
              the largest CO₂ and cost win) by replacing customer HIUs with low-return-temperature
              variants and re-balancing the network. Apply for HNIP / Green Heat Network Fund
              support.
            </>
          }
          whyItMatters={
            <>
              Every UK heat network with gas CHP needs a transition plan. The carbon and economic
              case has flipped within a decade. The institutional designs being installed today are
              heat-pump-based, often with ambient-temperature distribution loops (5GDHC) — not the
              high-temperature gas-CHP networks of 2010–2020.
            </>
          }
        />
