    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-base text-muted-foreground mb-12">
          This section covers mechanical ventilation systems from an electrical services
          perspective. You'll learn about air handling units, fan selection, heat recovery systems,
          ductwork design and the commissioning procedures required to achieve compliant, efficient
          ventilation.
        </p>
