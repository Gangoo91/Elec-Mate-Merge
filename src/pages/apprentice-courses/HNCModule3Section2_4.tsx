...
const quickCheckQuestions = [
  {
    ...
    options: ['pf = P/S', 'pf = P/Q', 'pf = Q/P', 'pf = S/P'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Induction motors', 'LED drivers', 'Resistive heaters', 'Capacitor banks'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Power factor', 'Reactive power (Q)', 'True power (P)', 'Apparent power (S)'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['60kVAr', '40kVAr', '20kVAr', '80kVAr'],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ['0.85 lagging', '0.3 to 0.4 lagging', 'Unity', '0.95 lagging'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.95 or better', '0.85 lagging', '0.5 lagging', '0.7 lagging'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['1.6kW', '3.125kW', '2.5kW', '2.0kW'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Understanding how reactive loads affect power delivery, efficiency, and costs in building
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Modern LED drivers and switching power supplies must build active PFC into the input
              stage to comply with BS EN 61000-3-2. The standard is the reason an LED-retrofit
              office no longer needs the same scale of bulk PFC banks that fluorescent installations
              did — but it also means “true” PF on the supply now includes harmonic content, not
              just the fundamental phase shift.
            </>
          }
        ...
        <ConceptBlock title="True, Reactive and Apparent Power">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>True Power (P) - Watts:</strong> Also called active or real power. This is the
              power that actually does useful work - turning motors, producing heat, or generating
              light. Measured in Watts (W) or kilowatts (kW). This is what you pay for on your
              electricity bill (kWh consumption). P = V × I × cos φ
            </li>
            <li>
              <strong>Reactive Power (Q) - Volt-Amperes Reactive:</strong> Power that oscillates
              between the source and the load, doing no useful work. Required to establish magnetic
              fields in motors and transformers. Measured in VAr or kVAr. Though it does no work, it
              still requires current to flow, increasing conductor loading. Q = V × I × sin φ
            </li>
            <li>
              <strong>Apparent Power (S) - Volt-Amperes:</strong> The total power that must be
              supplied by the source - the vector sum of true and reactive power. Measured in VA or
              kVA. Transformers, generators and cables must be rated for apparent power, not just
              true power. This is why poor power factor requires larger equipment. S = V × I (total
              current)
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>True power (P):</strong> Unit W, kW. Single-phase: V × I × cos φ. Three-phase:
              √3 × VL × IL × cos φ
            </li>
            <li>
              <strong>Reactive power (Q):</strong> Unit VAr, kVAr. Single-phase: V × I × sin φ.
              Three-phase: √3 × VL × IL × sin φ
            </li>
            <li>
              <strong>Apparent power (S):</strong> Unit VA, kVA. Single-phase: V × I. Three-phase:
              √3 × VL × IL
            </li>
          </ul>
        ...
        <ConceptBlock title="Power Factor and the Power Triangle">
          ...
          <p>
            <strong>pf = P / S = cos φ</strong> — Where φ is the phase angle between voltage and
            current
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Leading Power Factor:</strong> Current leads voltage (capacitive). Caused by
              capacitors, over-excited synchronous motors. Used for power factor correction. Q is
              negative (generating VAr).
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Causes of Poor Power Factor in Building Services">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Induction motors (unloaded):</strong> 0.30 - 0.40 lagging — Worst case, avoid
              running unloaded
            </li>
            <li>
              <strong>Induction motors (50% load):</strong> 0.70 - 0.80 lagging — Common operating
              condition
            </li>
            <li>
              <strong>Induction motors (full load):</strong> 0.85 - 0.90 lagging — Best motor pf but
              still requires correction
            </li>
            <li>
              <strong>Transformers (light load):</strong> 0.50 - 0.70 lagging — Magnetising current
              dominates
            </li>
            <li>
              <strong>Transformers (full load):</strong> 0.85 - 0.95 lagging — Load current improves
              pf
            </li>
            <li>
              <strong>Fluorescent (magnetic ballast):</strong> 0.50 - 0.60 lagging — Legacy
              equipment, replace with LED
            </li>
            <li>
              <strong>Fluorescent (HF electronic):</strong> 0.95+ near unity — Built-in pf
              correction
            </li>
            <li>
              <strong>LED luminaires (quality drivers):</strong> 0.90 - 0.98 near unity — Varies by
              manufacturer
            </li>
            <li>
              <strong>Resistance heaters:</strong> 1.00 unity — Purely resistive, no reactive
              component
            </li>
            <li>
        ...
        <ConceptBlock title="Effects on Electrical Systems and DNO Requirements">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Increased Current:</strong> For the same real power (kW), poor pf requires
              higher current. Current increases by factor 1/pf. At 0.7 pf: 1.43× higher than unity.
              At 0.8 pf: 1.25× higher. At 0.9 pf: 1.11× higher.
            </li>
            <li>
              <strong>Increased Cable Losses (I²R):</strong> Power loss in conductors is
              proportional to current squared. At 0.7 pf: losses 2.04× higher. At 0.8 pf: 1.56×
              higher. At 0.9 pf: 1.23× higher. This wasted energy appears as heat in cables,
              transformers and switchgear.
            </li>
            <li>
              <strong>Increased Voltage Drop:</strong> Higher current causes proportionally greater
              voltage drop along cables (Vd = I × R × L × 2). May require larger cables to meet the
              5% voltage drop limit for power circuits.
            </li>
            <li>
              <strong>Oversized Equipment Required:</strong> Transformers, generators, cables and
              switchgear must be rated for apparent power (kVA). A 100kW load at 0.7 pf requires
              143kVA capacity - 43% larger than at unity pf.
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">DNO Requirements and Charges</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Minimum power factor:</strong> 0.90 lagging or better — Below this, reactive
              charges apply
            </li>
            <li>
              <strong>Reactive power charge:</strong> p/kVArh (varies by DNO) — Charged on excess
              kVArh above 0.90 pf equivalent
            </li>
            <li>
              <strong>Maximum demand charge:</strong> Based on kVA not kW — Poor pf increases MD
              charges
            </li>
            <li>
              <strong>Connection agreement:</strong> May specify pf requirement — Breach may result
              in penalty or disconnection
            </li>
            <li>
              <strong>Measurement:</strong> Half-hourly metering — kWh and kVArh recorded for each
              HH period
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Commercial Impact Example</p>
          <p>A 500kW commercial building at 0.75 pf draws 667kVA apparent power. This requires:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A three-phase motor draws 45kW at 0.82 power factor lagging.
            Calculate the reactive power (Q) and apparent power (S).
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Question:</strong> A 30kW three-phase load operates at 400V. Compare the line
            current at (a) unity pf, (b) 0.85 pf, and (c) 0.70 pf.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Using: I = P / (√3 × V × pf)</li>
            <li>
              (a) At unity pf (1.0): I = 30000 / (1.732 × 400 × 1.0) = <strong>43.3A</strong>
            </li>
            <li>
              (b) At 0.85 pf: I = 30000 / (1.732 × 400 × 0.85) = <strong>50.9A</strong> (18%
              increase)
            </li>
            <li>
              (c) At 0.70 pf: I = 30000 / (1.732 × 400 × 0.70) = <strong>61.9A</strong> (43%
              increase)
            </li>
          ...
          <p>
            <strong>Question:</strong> A factory operates at 150kW average load, 0.78 pf, for 2000
            hours per year. If the DNO charges 0.45p/kVArh for reactive power above 0.90 pf
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1.00 (unity):</strong> Current 0%, Loss 0%, kVA for 100kW = 100kVA
            </li>
            <li>
              <strong>0.95:</strong> Current +5%, Loss +11%, kVA for 100kW = 105kVA
            </li>
            <li>
              <strong>0.90:</strong> Current +11%, Loss +23%, kVA for 100kW = 111kVA
            </li>
            <li>
              <strong>0.85:</strong> Current +18%, Loss +38%, kVA for 100kW = 118kVA
            </li>
            <li>
              <strong>0.80:</strong> Current +25%, Loss +56%, kVA for 100kW = 125kVA
            </li>
            <li>
              <strong>0.70:</strong> Current +43%, Loss +104%, kVA for 100kW = 143kVA
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Confusing P (kW) and S (kVA) when sizing transformers and cables. Forgetting to state
              lagging or leading. Adding kVA values directly instead of using vector addition (P and
              Q separately). Ignoring how lightly loaded motors have much worse pf. Over-correcting
              with too much capacitance, leading to resonance and voltage issues.
            </>
          }
          doInstead={
            <>
        ...
        <Scenario
          ...
          situation={
            <>
              The facilities manager has flagged a £850-per-month “reactive power” charge on the
              latest electricity bill. The building is an LED-lit office with two 30 kW chiller
              compressors and a large AHU bank. Average maximum demand is 220 kVA, average true
              power 175 kW — PF = 175 / 220 = 0.795 lagging.
            </>
          }
          whatToDo={
            <>
              Walk the switchroom: identify whether the existing PFC bank (if any) is online, that
              capacitors are still healthy (no swollen cans, fuses intact) and that contactors are
              switching as expected. Map total reactive demand: Q = √(S² − P²) = √(220² − 175²) ≈
              133 kVAr. Size new or supplementary PFC: Q_C = P × (tanφ₁ − tanφ₂) = 175 × (0.762 −
              0.329) ≈ 76 kVAr to lift PF from 0.795 to 0.95. Specify a stepped capacitor bank
              (typically 5 × 15 kVAr or detuned/harmonic-filtered if non-linear load is significant)
              to BS EN 61921. Pay-back is usually under 18 months purely on the avoided penalty.
            </>
          }
          whyItMatters={
            <>
              Power factor is a direct line on the utility bill — fix it and the saving is real,
              repeatable and easy to quantify in the energy strategy. As the HNC engineer, you are
              the one who sizes the bank, picks the standard and signs off the install — the maths
              in this section is what gets that done.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Section 2.5</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
