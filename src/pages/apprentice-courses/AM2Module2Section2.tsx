    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Complete guide to RAMS for AM2 assessment - legal requirements, common mistakes, and
        ...
        <ConceptBlock title="RAMS Documentation Requirements">
          <p>
            ...
            Statements (RAMS) are about proving you can plan safe work before starting. In the AM2,
            you will be expected to complete RAMS documentation for given tasks. This isn't just
            paperwork — it's a legal requirement in industry under the Management of Health and
            Safety at Work Regulations 1999 and Electricity at Work Regulations 1989.
          </p>
          <p>
        ...
        <ConceptBlock title="1. Purpose of RAMS">
          <p>
            ...
            controls. A systematic examination of work activities to identify what could cause harm
            to people, property, or the environment. The assessment considers the likelihood of
            occurrence and potential severity of consequences.
          </p>
          <p>
            <strong>Method Statement.</strong> Step-by-step description of how the job will be done
            safely. A detailed, logical sequence describing how work activities will be carried out,
        ...
        <ConceptBlock title="2. How RAMS Appears in AM2">
          <p>
            ...
            of every AM2 practical assessment. Candidates receive a RAMS form at the start of their
            assessment task and must complete it before beginning practical work.
          </p>
          <p>
        ...
        <ConceptBlock title="3. Step-by-Step RAMS Completion Guide">
          <p>
            <strong>1. Task Description.</strong> Write a clear, specific description of what you're
            doing.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong className="text-red-400">Personal Protective Equipment</strong> — last resort;
              specify exact type and purpose
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="4. Common Mistakes in AM2 RAMS (NET list)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-red-400/70">
            ...
            <li>Not identifying all hazards (focusing only on electrical, ignoring environment)</li>
        ...
        <ConceptBlock title="5. RAMS Hazard Identification Matrix">
          ...
          <p>
            ...
            electric shock from live parts; burns from arc flash/short circuit; fire from overheated
            connections. Typical control measures: isolation and lock-off procedures; proving unit
            verification; insulated tools and PPE.
          </p>
          <p>
          ...
          <p>
            ...
            dust from drilling/cutting; working at height (even stepladders); confined or restricted
            spaces. Typical control measures: dust masks/extraction; stable working platform;
        ...
        <RegsCallout
          ...
          meaning={
            <>
              This is the law behind every RAMS document. The employer must risk-assess the job, but
              on AM2 you complete the RAMS yourself for the task in front of you. Generic,
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              shock), working at height if the board is high (fall), heavy panel (manual handling),
              stripped strands (cut/laceration), shared walkway (slip/trip). For each, score
              likelihood × severity. Then write the method statement: isolate at the supply, lock
              off with your padlock, prove dead at the board, then dismantle. Don’t list "PPE" as
              the control for the live hazard — isolation is the control. PPE is the backstop.
            </>
          }
          whyItMatters={
            <>
              The hierarchy of control matters. Eliminate the hazard (isolate) before you reach for
              PPE. Assessors mark down RAMS that jumps straight to gloves and boots without
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              haven’t thought about the specific task — you’ve recycled a template. RAMS criteria go
              Not Yet Competent and you’ve set a defensive tone for the rest of the day.
            </>
          }
          doInstead={
            <>
