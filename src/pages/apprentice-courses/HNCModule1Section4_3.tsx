...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['7 days', '14 days', 'There is no time limit', '3 months'],
    correctIndex: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Section 2(6) is the parent duty for safety reps. The detailed mechanics live in SRSCR
              1977 and HSCER 1996 — but the underlying duty to consult is statutory.
            </>
          }
        ...
        <ConceptBlock title="Safety Representatives and the SRSC Regulations 1977">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>The union must notify the employer in writing of the appointment</li>
            <li>Represent the employees of the employer who belong to the union</li>
            <li>Can represent non-union employees if the union and employees agree</li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Investigate hazards</strong> — Description: Look into potential hazards and
              dangerous occurrences. Building Services Example: Investigating concerns about
              isolation procedures
            </li>
            <li>
              <strong>Investigate complaints</strong> — Description: Examine complaints by
              represented employees. Building Services Example: Employee concerns about PPE
              provision
            </li>
            <li>
              <strong>Make representations</strong> — Description: Raise health and safety matters
              with employer. Building Services Example: Requesting additional welfare facilities
            </li>
            <li>
              <strong>Carry out inspections</strong> — Description: Inspect workplace and documents.
              Building Services Example: Quarterly inspection of workshop areas
            </li>
            <li>
              <strong>Represent employees</strong> — Description: Liaise with HSE on employees'
              behalf. Building Services Example: Accompanying HSE inspector on site visit
            </li>
            <li>
              <strong>Attend safety committee</strong> — Description: Participate in safety
              committee meetings. Building Services Example: Presenting inspection findings to
              committee
            </li>
          </ul>
            ...
            whatHappens={
              <>
                <p className="text-sm text-white">
                  Safety representatives <strong>do not have enforcement powers</strong>. They
                  cannot issue notices or require work to stop. Their role is to represent
                  employees, investigate and raise concerns, and participate in consultation.
                  Enforcement remains with the HSE. However, their involvement significantly
                  improves workplace safety by ensuring employee concerns are heard.
                </p>
              </>
            }
            doInstead={
        ...
        <ConceptBlock title="Rights and Protections of Safety Representatives">
          <p>
            ...
            them specific rights and protections. These ensure they can carry out their role without
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Inspect when there has been substantial change in work conditions</li>
            <li>Reasonable notice required (except for accidents/dangerous occurrences)</li>
        ...
        <ConceptBlock title="Consultation Requirements and Non-Unionised Workplaces">
          <p>
            Employers have a legal duty to consult with employees on health and safety matters. The
            mechanism for consultation depends on whether the workplace has recognised trade unions.
            Either way, consultation must be meaningful and occur in 'good time'.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>New measures</strong> — Description: Introduction of measures substantially
              affecting H&S. Building Services Example: New safe isolation procedure
            </li>
            <li>
              <strong>Competent persons</strong> — Description: Appointment of persons to assist
              with H&S duties. Building Services Example: Appointing a new H&S advisor
            </li>
            <li>
              <strong>H&S information</strong> — Description: Information required to be provided to
              employees. Building Services Example: Risk assessment findings
            </li>
            <li>
              <strong>Training planning</strong> — Description: Planning and organisation of H&S
              training. Building Services Example: Annual training programme
            </li>
            <li>
              <strong>New technology</strong> — Description: H&S consequences of introducing new
              technology. Building Services Example: New testing equipment
            </li>
          </ul>
          ...
          <div className="p-4 rounded-lg bg-purple-500/10 border border-purple-500/30">
            ...
            <p className="text-sm text-white">
              Elected by the employees they represent. Employers must inform employees of names and
              provide facilities, training, and time off to perform their functions.
            </p>
          </div>
            ...
            whatHappens={
              <>
                <p className="text-sm text-white">
                  ...
                  SRSC Regulations. For example, they do not have the same detailed inspection
                  rights, and cannot request a safety committee. However, they must still be
                  consulted on the same range of matters.
                </p>
              </>
            }
            doInstead={
        ...
        <ConceptBlock title="Safety Committees">
          ...
          <p className="text-sm text-white mb-3">
            Under SRSC Regulations, if <strong>two or more safety representatives</strong> make a
            written request, the employer{' '}
            <strong>must establish a safety committee within 3 months</strong>.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Employer must consult with representatives and unions on composition</li>
            <li>Must post notice of committee establishment in the workplace</li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Study of statistics</strong> — Activities: Review accident, incident, and
              ill-health trends
            </li>
            <li>
              <strong>Examination of reports</strong> — Activities: Consider safety audit and
              inspection reports
            </li>
            <li>
              <strong>Monitoring effectiveness</strong> — Activities: Review adequacy of safety
              training, communication
            </li>
            <li>
              <strong>Linking with enforcement</strong> — Activities: Consider reports/information
              from inspectors
            </li>
            <li>
              <strong>Making recommendations</strong> — Activities: Recommend measures to improve
              health and safety
            </li>
          </ul>
        ...
        <ConceptBlock title="Practical Guidance">
          <div>
            <p>
              <strong>Working Effectively with Safety Representatives</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                <strong>Joint inspections:</strong> Include representatives in workplace inspections
              </li>
              <li>
          ...
          <div>
            <p>
              <strong>Building Services Specific Considerations</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>Shift patterns should be considered when scheduling meetings</li>
              <li>Site-specific committees may be needed for large projects</li>
              <li>JIB agreements may provide additional industry-specific arrangements</li>
            </ul>
          </div>

          <div>
            <p>
              <strong>Common Mistakes in Consultation</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                <strong>Ignoring views:</strong> Not giving proper consideration to concerns raised
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              The firm has grown from 8 to 30 people in two years. There is no recognised union, no
              elected representative of employee safety (RoES) and no safety committee. The MD asks
              you to set up the consultation arrangements.
            </>
          }
          whatToDo={
            <>
              Apply HSCER 1996 (no recognised union route). Hold an open meeting, explain the role,
              take nominations and run a confidential ballot for one or two RoES. Set up a quarterly
              safety committee with terms of reference: standing agenda (incident, near-miss, audit
              findings, training, RAMS samples, action log), voting structure, minutes published.
              Provide paid time off for RoES training (TUC or IOSH course). Brief the workforce on
              how to raise safety issues with the RoES.
            </>
          }
          whyItMatters={
            <>
              Failing to consult is a strict-liability offence under HSCER 1996. Beyond compliance,
              the safety committee is the leading-indicator forum that surfaces cultural drift
