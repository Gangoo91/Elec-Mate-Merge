        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Safety reps:</strong> Appointed by trade unions to represent employees
              </li>
              <li className="pl-1">
                <strong>Key functions:</strong> Investigate hazards, inspect workplace, represent
                employees
              </li>
              <li className="pl-1">
                <strong>Consultation:</strong> Employers must consult in good time on H&S matters
              </li>
              <li className="pl-1">
                <strong>Safety committees:</strong> Must be established if requested by two+ reps
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Unite/GMB:</strong> Main unions representing electrical workers
              </li>
              <li className="pl-1">
                <strong>Multi-employer sites:</strong> Coordination between contractor reps
              </li>
              <li className="pl-1">
                <strong>Construction sites:</strong> Consultation through CDM structures
              </li>
              <li className="pl-1">
                <strong>JIB agreement:</strong> Industry-specific consultation arrangements
              </li>
            </ul>
          </div>
        </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Look into potential hazards and dangerous occurrences
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Investigating concerns about isolation procedures
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Investigate complaints</td>
                      <td className="border border-white/10 px-3 py-2">
                        Examine complaints by represented employees
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Employee concerns about PPE provision
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Make representations</td>
                      <td className="border border-white/10 px-3 py-2">
                        Raise health and safety matters with employer
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Requesting additional welfare facilities
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Carry out inspections</td>
                      <td className="border border-white/10 px-3 py-2">
                        Inspect workplace and documents
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Quarterly inspection of workshop areas
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Represent employees</td>
                      <td className="border border-white/10 px-3 py-2">
                        Liaise with HSE on employees' behalf
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Accompanying HSE inspector on site visit
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Presenting inspection findings to committee
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Introduction of measures substantially affecting H&S
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        New safe isolation procedure
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Competent persons</td>
                      <td className="border border-white/10 px-3 py-2">
                        Appointment of persons to assist with H&S duties
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Appointing a new H&S advisor
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Planning and organisation of H&S training
                      </td>
                      <td className="border border-white/10 px-3 py-2">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Working Effectively with Safety Representatives
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Building Services Specific Considerations
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
