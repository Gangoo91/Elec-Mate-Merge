...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Minor faults are those that can be corrected quickly and safely without redesigning or replacing major parts of the installation.',
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'Loose connections create high resistance, leading to overheating, arcing, and potential fire or shock risks.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Retesting confirms that the repair is effective, safe, and compliant before the circuit is re-energised.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'The high earth continuity readings were caused by a loose CPC connection that needed re-termination.',
  },
  {
    id: 10,
...
const faqs = [
  {
    ...
    answer:
      'Loose connections, miswiring at accessories, and other straightforward termination issues.',
  },
  {
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              or switches, misconnected conductors at an accessory, or incorrectly wired polarity at
              a light fitting. Although these faults may seem simple, they can still cause serious
              risks if left unresolved — overheating, arcing, or even electric shock. Recognising
              them as important is the first step towards safe practice.
            </p>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>
                <strong>Overheating:</strong> Loose connections create high resistance, generating
                heat that can ignite surrounding materials
              </li>
              <li>
                <strong>Arcing:</strong> Poor connections cause electrical arcing, creating fire
                risk and equipment damage
              </li>
              <li>
                <strong>Electric Shock:</strong> Incorrect polarity or loose earths remove vital
                safety protection
              </li>
              <li>
                <strong>Equipment Damage:</strong> Voltage fluctuations from poor connections can
                damage connected equipment
              </li>
              <li>
                <strong>Progressive Failure:</strong> Small faults often worsen over time if not
                addressed promptly
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              should be inspected and corrected. For example, a loose conductor should be
              re-terminated, ensuring the insulation is not pinched and that the conductor is
              secured to the correct torque where required. In cases of miswiring, conductors should
              be relocated to the correct terminals following wiring diagrams or supervisor
              guidance.
            </p>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              ...
              <li>
                Switch off and lock off the protective device (use lockout/tagout where available)
              </li>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>
                Strip conductor insulation to correct length (typically 10-12mm for most terminals)
              </li>
              ...
              <li>
                Tighten terminal screws to manufacturer's specified torque (typically 0.8-1.2 Nm for
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              loose CPC, continuity should be rechecked; for polarity faults, polarity testing
              should confirm correctness after repair. This ensures that the repair is safe,
              compliant, and properly documented. Apprentices should always involve supervisors in
              retesting, both to confirm results and to reinforce learning.
            </p>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>
                <strong>Continuity Testing:</strong> Verify all protective conductors and bonding
                are continuous
              </li>
              <li>
                <strong>Polarity Testing:</strong> Confirm all single-pole devices are in the line
                conductor
              </li>
              <li>
                <strong>Insulation Resistance:</strong> Check no damage occurred during repair work
              </li>
              <li>
                <strong>Earth Fault Loop:</strong> Verify effective earthing where circuits have
                been disturbed
              </li>
              <li>
                <strong>RCD Testing:</strong> Ensure RCD protection remains effective if applicable
              </li>
              <li>
                <strong>Visual Inspection:</strong> Check workmanship meets required standards
              </li>
            </ul>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              you must always work under supervision and never sign off test records or
              certification. More complex faults — such as damaged cables in walls, failed
              insulation resistance across circuits, or design issues — must be escalated. Knowing
              where your role ends is a critical part of professional practice.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            <ol className="text-white space-y-2 text-sm">
              ...
              <li>
                <strong>2. Fault Assessment:</strong> Examine the fault, take photos if permitted,
                note all observations
              </li>
              <li>
                <strong>3. Plan Repair:</strong> Identify correct repair method, gather appropriate
                tools and materials
              </li>
              <li>
                <strong>4. Execute Repair:</strong> Re-terminate connections to correct torque,
                follow wiring diagrams
              </li>
              <li>
                <strong>5. Quality Check:</strong> Verify workmanship, check no damage to
                surrounding equipment
              </li>
              <li>
                <strong>6. Retest Circuit:</strong> Repeat original test to confirm fault correction
              </li>
              <li>
                <strong>7. Documentation:</strong> Record work done, test results, and supervisor
                verification
              </li>
              <li>
                <strong>8. Re-energise:</strong> Remove locks/labels, restore power under supervisor
                approval
              </li>
            </ol>
          </div>
        ...
        <section className="mb-10">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-white space-y-2 text-sm">
              ...
              <li>
                • <strong>Quality Matters:</strong> Proper terminations and retesting prevent future
                problems
              </li>
              <li>
                • <strong>Know Your Limits:</strong> Work under supervision and escalate complex
                issues
              </li>
            </ul>
          </div>
