        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          <div className="bg-white/5 border border-elec-yellow/20 rounded-lg p-4 sm:p-5">
            ...
            <ul className="text-left text-white text-sm space-y-1.5">
              <li>
                - <strong>DOL:</strong> Full voltage applied directly, 6-8x FLC inrush
              </li>
              <li>
                - <strong>Contactor:</strong> Electromagnetic switch, AC-3 rated for motors
              </li>
              <li>
                - <strong>Overload:</strong> Bimetallic or electronic, set to nameplate FLC
              </li>
              <li>
                - <strong>No-volt release:</strong> Prevents automatic restart after power loss
              </li>
            </ul>
          </div>
          <div className="bg-white/5 border border-elec-yellow/20 rounded-lg p-4 sm:p-5">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-4 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-3">
                Key Contactor Components
              </p>
              <ul className="text-white space-y-3 text-left">
                <li>
                  <strong className="text-elec-yellow">Main Contacts:</strong> Three sets of
                  normally open (NO) contacts that carry the motor power current. Made from
                  silver-alloy material for low contact resistance and long electrical life. Rated
                  for many thousands of operations at AC-3 duty.
                </li>
                <li>
                  <strong className="text-elec-yellow">Auxiliary Contacts:</strong> Additional
                  contacts (NO and NC) used in the control circuit for holding, interlocking and
                  status indication. Typically rated at 10 A. Can be supplemented by adding
                  auxiliary contact blocks.
                </li>
                <li>
                  <strong className="text-elec-yellow">Coil:</strong> The electromagnetic coil that
                  operates the contactor mechanism. Available in various voltages (24 V DC, 110 V
                  AC, 230 V AC, 400 V AC). DC coils are quieter and do not require shading rings.
                </li>
                <li>
                  <strong className="text-elec-yellow">Arc Chutes:</strong> Chambers above the main
                  contacts that help extinguish the arc formed when contacts open under load. They
                  split the arc into smaller segments, cooling and deionising it rapidly.
                </li>
                <li>
                  <strong className="text-elec-yellow">Shading Ring:</strong> A copper band on AC
                  coil magnetic faces that creates a phase-shifted flux component, preventing
                  armature chatter at twice the supply frequency (100 Hz).
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-4 p-4 rounded-lg bg-white/5">
              <ul className="text-white space-y-3 text-left">
                <li>
                  <strong className="text-elec-yellow">Electrical Interlocking:</strong> The NC
                  auxiliary contact of each contactor is wired in series with the opposing coil.
                  When the forward contactor is energised, its NC contact opens and prevents the
                  reverse coil from being energised, and vice versa.
                </li>
                <li>
                  <strong className="text-elec-yellow">Mechanical Interlocking:</strong> A physical
                  linkage between the two contactors prevents both armatures from closing
                  simultaneously. This provides backup protection if an electrical interlock contact
                  welds.
                </li>
              </ul>
            </div>
            <p className="text-sm text-elec-yellow/70">
              <strong>Safety requirement:</strong> Both electrical AND mechanical interlocking must
              be used together. Electrical interlocking alone can fail if a contact welds.
              Mechanical interlocking alone does not prevent both coils from being energised
              simultaneously (which could damage the interlock mechanism).
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-4 p-4 rounded-lg bg-white/5">
              <ul className="text-white space-y-2 text-left">
                ...
                <li>
                  - <strong>Duty cycle:</strong> Number of starts per hour and
                  continuous/intermittent operation -- affects contactor and overload selection
                </li>
                <li>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-4 p-4 rounded-lg bg-white/5">
              <ul className="text-white space-y-4 text-left">
                <li>
                  <strong className="text-elec-yellow">Coil Failure:</strong> The contactor does not
                  close when the start button is pressed. Check coil voltage with a multimeter. A
                  burnt coil may have a visibly damaged bobbin or a burning smell. Replace the coil
                  (or the entire contactor if the magnetic core is damaged). Coil failure is caused
                  by overvoltage, undervoltage (coil chatters, overheats and fails), or mechanical
                  seizure of the armature.
                </li>
                <li>
                  <strong className="text-elec-yellow">Contact Welding:</strong> Main contacts fuse
                  together so the motor cannot be stopped. This is a serious safety issue. The motor
                  continues to run even when the stop button is pressed. Caused by excessive
                  starting current, too many starts per hour, or undersized contacts. The contactor
                  must be replaced immediately.
                </li>
                <li>
                  <strong className="text-elec-yellow">Overload Tripping:</strong> The overload
                  relay trips repeatedly. Check the current setting matches the motor nameplate FLC.
                  Check for mechanical overload on the driven equipment. Check for single-phasing
                  (loss of one supply phase). Check for low supply voltage (motor draws more current
                  to maintain torque).
                </li>
                <li>
                  <strong className="text-elec-yellow">Chattering/Buzzing:</strong> The contactor
                  armature vibrates rapidly at twice supply frequency, producing an audible buzz.
                  Caused by low coil voltage, a broken shading ring on AC coils, or contamination on
                  the magnet faces. Clean the magnet faces with a lint-free cloth or replace the
                  contactor.
                </li>
                <li>
                  <strong className="text-elec-yellow">Contact Erosion:</strong> Main contacts
                  become pitted and eroded over time due to arcing during switching. This increases
                  contact resistance, causing overheating at the contacts. Replace the contact set
                  or the entire contactor when erosion exceeds the manufacturer's wear limits
                  (indicated by wear markers on many modern contactors).
                </li>
              </ul>
            </div>
          </div>
