...
const faqs = [
  ...
  {
    question: 'What is the typical generator capacity vs total building load?',
    answer:
  ...
  {
    question: 'How often should critical load management plans be reviewed?',
    answer:
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              levels of importance. The consequence of losing power to a fire alarm panel is
              fundamentally different from losing power to a coffee machine. Categorising every load
              into a clear priority hierarchy enables rational decisions during power emergencies.
            </p>
            <p>
              The load schedule is the master document that records every circuit's priority
              classification. It must be comprehensive, accurate and regularly reviewed. Changes in
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              importance. Buildings that have not been audited since original installation
              frequently have misallocated loads.
            </p>
            <p>
              Common audit findings include: truly critical IT equipment connected to non-backed-up
              supplies because it was installed after the original design; non-essential loads
              consuming valuable generator capacity because they were never disconnected from the
              essential distribution board; and load priorities that no longer reflect the
