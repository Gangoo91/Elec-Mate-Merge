      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-2 pb-24">
        <PageFrame>
          ...
          <PageHero
            ...
            description="Reverberation, absorption versus insulation, airborne and impact transmission, services noise criteria and the compliance landscape."
            tone="purple"
          />
          ...
          <RegsCallout
            ...
            meaning={
              <>
                Approved Document E is the compliance document you name when the question
                is sound insulation in dwellings and residential buildings. It is where
                separating walls and floors, their junction details, and the routes for
                demonstrating performance are dealt with. Design criteria for building
                services noise are a different matter: they come from the project
                specification, informed by industry guidance such as CIBSE and BS 8233,
                and they are usually written as octave-band or NR-style limits per room
                type. This page deliberately reproduces no numeric values from either —
                figures change between editions and must be read from the current
                published document for the project.
              </>
            }
          ...
          >
            <p>
              ...
              generators, lifts, transformers and the air moving through ductwork run continuously
              and predictably, which is exactly what makes them noticeable. Occupants tune out
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Airborne:</strong> the machine radiates sound into the plant room, which
                then has to cross the plant room construction — walls, floor, roof, doors and any
                gap around them — to reach the space beyond.
              </li>
              <li>
                <strong>Duct-borne:</strong> the fan puts acoustic energy straight into the
                ductwork, which carries it past every partition in the building and delivers it at
                the grille. The duct is a purpose-built path between spaces, and it is why
                attenuators exist.
              </li>
              <li>
                ...
                little loss and re-radiates as airborne noise from walls, floors and ceilings a
                long way from the plant.
              </li>
            </ul>
            <p>
              ...
              so 100 Hz and above on a 50 Hz system. Standby generators and their radiators are
              among the loudest items in any building. UPS systems, inverters, and the cooling fans
              in comms rooms run day and night. Luminaire drivers and dimming equipment can buzz or
              whistle audibly in an otherwise quiet room. And every containment run, conduit and
              cable that rigidly bridges an isolated plant base short-circuits the vibration
              isolation somebody else has carefully specified.
            </p>
            <p>
          ...
          >
            <p>
              ...
              alternately compresses and rarefies the air next to it, and that disturbance
              propagates outwards at roughly 340 m/s in air at normal room conditions. Nothing
              travels with the wave except the disturbance itself: the air molecules oscillate about
              their rest position. Because a medium is required, an air gap or a soft resilient
              layer is a genuinely effective interruption — which is the whole basis of vibration
              isolation and cavity construction.
            </p>
            <p>
              ...
              around 340 m/s, a 100 Hz tone has a wavelength of roughly 3.4 m, while a 3.4 kHz tone
              is about 100 mm. This single fact explains an enormous amount of practical acoustics.
              Low-frequency sound has wavelengths comparable with the size of rooms, doors and
              barriers, so it diffracts around obstacles, drives partitions into resonance, and
              needs thick or deep treatments. High-frequency sound behaves more like a beam: it is
              easily absorbed by thin porous layers and easily blocked by modest barriers.
            </p>
            <p>
              ...
              coefficients, attenuator insertion losses, sound reduction indices and plant sound
              power data are all published band by band, because every one of those quantities is
              strongly frequency dependent.
            </p>
            <p>
              <strong>The decibel.</strong> The ear covers an enormous range of pressures, so sound
              is expressed logarithmically relative to a reference. Sound pressure level is
              Lp = 20 log₁₀(p / p₀), where p₀ is the standard reference pressure of 20 µPa. That
              reference is why 0 dB does not mean silence — it means a pressure equal to the
              reference, which is around the threshold of hearing for a healthy young ear.
            </p>
            <p>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Two equal, independent sources sum to +3 dB</strong> at a point, not to
                double the number. Four equal sources give +6 dB, ten give +10 dB.
              </li>
              <li>
                <strong>Ten times the power is +10 dB</strong>, and a 10 dB rise is generally
                reported as sounding about twice as loud. Loudness and power are not the same thing.
              </li>
              <li>
            ...
            <p>
              <strong>Free-field distance loss.</strong> For a point source radiating into free
              space with no reflections, the same power spreads over a sphere whose area grows with
              the square of distance. Doubling the distance therefore drops the level by 6 dB.
              Inside a reverberant room this only holds close to the source; further away the
              reverberant field dominates and moving back gains you very little.
            </p>
            <p>
              ...
              into a single figure, written dB(A). It is convenient and it correlates reasonably
              with annoyance for broadband noise. Its weakness is precisely its convenience: it
              throws away the spectrum. A fan with a heavy low-frequency rumble or a discrete tone
              can meet a dB(A) figure and still be intolerable, which is why services noise is
              usually specified band by band as well.
            </p>
            <p>
              <strong>An indicative ladder, for intuition only:</strong> 0 dB is the reference at
              the threshold of hearing; a quiet rural night or an unoccupied library sits around 30
              dB; ordinary conversation at a metre is around 60 dB; a busy road at the kerb is
              around 80 dB; the threshold of pain is in the region of 120 to 130 dB. Treat these as
              orientation, not as design values — design values come from the project criteria.
            </p>
          </ConceptBlock>
          ...
          >
            <p>
              ...
              engineers, and it is worth meeting head-on. Absorption and insulation are not points
              on the same scale. They are answers to two different questions.
            </p>
            <p>
              <strong>Absorption</strong> asks: what happens to sound energy when it strikes a
              surface inside a room? A porous, open, lightweight material lets the wave in, and the
              air movement within its structure loses energy to friction as heat. Absorption
              controls the sound field <em>inside</em> the room where it is fitted. It reduces
              reflections, shortens reverberation, lowers the reverberant level and improves speech
              clarity. It is measured by the absorption coefficient α, which runs from 0 for a
              perfectly reflective surface to 1 where all incident energy is absorbed or otherwise
              not returned. It is frequency dependent, so it is quoted per octave band.
            </p>
            <p>
              <strong>Insulation</strong> asks: how much energy gets from one space to another? That
              is governed by the mass of the construction, by whether the two sides are decoupled,
              by damping, and above all by airtightness. It is measured as a sound reduction index
              in dB, band by band, and it lives in the construction, not in the room finish.
            </p>
            <p>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Open-cell foam:</strong> excellent absorber, negligible insulator. It is
                light and porous, and a porous material is by definition not airtight.
              </li>
              <li>
                <strong>A dense solid sheet:</strong> good insulator, near-zero absorber. It is
                heavy and airtight, and it reflects almost everything back into the room.
              </li>
              <li>
            ...
            <p>
              ...
              plan, that is a reverberation problem and absorption is the remedy. If the complaint
              is that you can hear a specific source in an adjacent space — the meeting next door,
              the neighbour, the plant room — that is a transmission problem and no amount of
              absorption on the receiving side will solve it. The two remedies do not substitute for
              each other, though a properly designed construction often contains both, using
              absorption inside a cavity or an enclosure to stop energy building up before it
              reaches the outer leaf.
            </p>
            <p>
              <strong>The one place absorption helps a transmission complaint</strong> is indirect:
              it lowers the reverberant level striking the partition in the source room, and the
          ...
          >
            <p>
              ...
              dense succession of reflections from every surface. Each reflection loses a fraction
              of its energy to the surface it strikes. When the source stops, the reflected field
              decays. <strong>Reverberation time, T60, is defined as the time in seconds for the
              sound pressure level in the room to fall by 60 dB after the source is switched off.</strong>{' '}
            ...
            <p>
              ...
              of the room, and the total absorption inside it. A large volume means the sound
              travels further between reflections, so it takes more reflections and more time to
              decay. More absorption means each reflection takes a bigger bite out of the energy.
              The Sabine relationship expresses exactly that:
            </p>
            <p>
              <strong>RT = 0.161 V / A</strong> — where RT is reverberation time in seconds, V is
              room volume in m³, and A is the total absorption in m² sabins, found by summing the
              area of every surface multiplied by its absorption coefficient: A = Σ (S × α).
            </p>
            <p>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                A is frequency dependent because α is, so RT must be evaluated per octave band. A
                room can be well controlled at 2 kHz and boomy at 125 Hz.
              </li>
              <li>
                It is an approximation. Sabine assumes a diffuse field with absorption spread fairly
                evenly. It over-predicts in rooms that are very absorbent or very irregular, or
                where all the absorption sits on one surface.
              </li>
            </ul>
            <p>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Floor finishes:</strong> carpet absorbs usefully at mid and high
                frequencies; hard flooring absorbs essentially nothing. Carpet swapped for hard
                floor is one of the commonest causes of a room becoming unusable after a refit.
              </li>
              <li>
              ...
              <li>
                ...
                condition, and a hall designed only for the full case will sound wrong when it is
                half empty.
              </li>
              <li>
          ...
          >
            <p>
              ...
              meeting room measures 8 m × 6 m × 3 m high. The floor is carpeted, the ceiling is
              solid plaster and the walls are painted plaster. Find the reverberation time at 500
              Hz.
            </p>
            <p>
              <em>Step 1 — volume.</em>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Walls:</strong> perimeter = 2 × (8 + 6) = 28 m; area = 28 × 3 = 84 m²,
                painted plaster α = 0.03 → 84 × 0.03 = <strong>2.52 m² sabins</strong>
              </li>
            </ul>
            <p>
            ...
            <p>
              One change of finish has taken the room from 1.37 s to 0.48 s — a factor of nearly
              three — because total absorption went up by nearly a factor of three. This is the
              practical meaning of absorption sitting in the denominator, and it is why the ceiling
              is the first thing an acoustician asks about.
            </p>
            <p>
              <strong>Example 3: Sizing wall panels to hit a target.</strong> Suppose the suspended
              ceiling is not available and the target for the original hard room is 0.80 s at 500
              Hz. How much wall panelling of α = 0.85 is needed?
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Careful:</strong> panels mounted on the wall cover wall area that already
                had α = 0.03, so the <em>net</em> gain per square metre is 0.85 − 0.03 = 0.82, not
                0.85.
              </li>
              <li>
              ...
              <li>
                <em>Check:</em> 14.7 × 0.82 = 12.05 m² sabins gained; A = 16.92 + 12.05 = 28.97;
                RT = 23.184 / 28.97 = <strong>0.80 s</strong> ✓
              </li>
            </ul>
            <p>
              Roughly 15 m² of panel out of 84 m² of available wall — a plausible scheme. Forgetting
              to deduct the covered surface is a common slip; on a room with a more absorbent
              existing finish it would leave the design meaningfully short.
            </p>
            <p>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>Convert each to a power ratio: 10^(65/10) = 3.162 × 10⁶ and 10^(59/10) = 0.794 × 10⁶</li>
            ...
            <p>
              ...
              with two <em>equal</em> sources: 65 dB and 65 dB would give 68.0 dB, the familiar +3
              dB.
            </p>
          </ConceptBlock>
          ...
          >
            ...
            <p>
              ...
              separating construction into vibration, and the construction re-radiates sound into
              the receiving room. Resistance is dominated by:
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Mass:</strong> heavier constructions are harder to drive. This is the mass
                law — in the mass-controlled region, transmission loss rises with both surface mass
                and frequency, so heavy walls beat light ones and high frequencies pass less easily
                than low ones. A useful rule of thumb, not a law of nature.
              </li>
              <li>
                <strong>Decoupling:</strong> two independent leaves with a cavity outperform a
                single leaf of the same total mass, because there is no rigid path for the vibration
                to cross. Absorption in the cavity improves it further. Any rigid tie, bridging
                fixing or debris in the cavity partly undoes the benefit.
              </li>
              <li>
                <strong>Damping and stiffness:</strong> real panels resonate and suffer a
                coincidence dip where the bending wavelength in the panel matches the airborne
                wavelength. At those frequencies performance falls well below what mass alone would
                predict.
              </li>
              <li>
                <strong>Airtightness:</strong> a small unsealed gap can dominate the result no
                matter how good the construction. Sound follows air. An undersealed door, an open
                ceiling void, an unfilled socket box or an unsealed cable penetration will define
                the outcome.
              </li>
            </ul>
            <p>
              ...
              machine on the floor above and a measurement below, and the descriptors are the
              opposite way round from airborne ones: for impact, a lower measured level is better,
              whereas for airborne insulation a higher figure is better. The remedies are resilient:
              soft floor coverings, resilient underlays, floating floor constructions on resilient
              layers, and isolated ceilings beneath.
            </p>
            <p>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>A continuous inner leaf of an external cavity wall past a separating wall junction</li>
            ...
            <p>
              <strong>The practical lesson:</strong> junction detailing, sealing and the discipline
              of the installing trades matter at least as much as the specification of the partition
              itself. On an electrical package that means agreeing penetration sealing, avoiding
              back-to-back accessories on separating constructions, and never letting containment
              form a rigid bridge across a designed acoustic break.
            </p>
          </ConceptBlock>
          ...
          >
            <p>
              Background noise from building services is steady, continuous and usually broadband
              with tonal components sitting on top. Rating it with one A-weighted number is
              convenient but blunt, so services specifications conventionally use an octave-band
              rating method, of which the <strong>Noise Rating (NR)</strong> family is the common UK
              form.
            </p>
            <p>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                To rate a measured or predicted spectrum, plot it against the family. The NR value
                is the <strong>lowest curve that no octave band exceeds</strong>. A single offending
                band sets the rating, no matter how good the others are.
              </li>
              <li>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>Start from the plant sound power level in each octave band, from the manufacturer</li>
              <li>Subtract natural attenuation along the duct run: straight runs, bends, branches, end reflection</li>
            ...
            <p>
              ...
              velocity the terminal itself is the source, and the only fix is a bigger duct, a
              larger terminal, or less pressure to throw away. Controlling velocity is therefore an
              acoustic decision as much as an energy one.
            </p>
            <p>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>In the path:</strong> attenuators sized band by band, lined plenums,
                crosstalk attenuators between rooms on a common branch, heavy sealed plant room
                construction with acoustic doors, anti-vibration mounts and inertia bases, and
                flexible connections on every duct, pipe, conduit and cable crossing an isolation
                break.
              </li>
              <li>
          ...
          >
            ...
            <p>
              <strong>1. Sound insulation in dwellings and residential buildings — Approved Document
              E.</strong> In England, the Building Regulations requirement for resistance to the
              passage of sound is supported by Approved Document E. At awareness level, its scope
              covers:
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                Protection against sound from other parts of the building and from adjoining
                buildings — separating walls and separating floors, for both airborne and impact
                sound
              </li>
              <li>Protection against sound within a dwelling-house — internal walls and floors</li>
              <li>
                Reverberation in the common internal parts of buildings containing flats or rooms
                for residential purposes — corridors, stairwells and entrance halls
              </li>
              <li>Acoustic conditions in schools</li>
            </ul>
            <p>
              <strong>How performance is demonstrated.</strong> For new-build attached dwellings
              there are two familiar routes. <strong>Pre-completion testing</strong> engages an
              acoustic tester to measure a sample of separating walls and floors in the finished
              building, reporting airborne and impact performance for comparison against the
              applicable values. Alternatively, <strong>Robust Details</strong> allows the builder to
              register plots against pre-approved separating constructions and build strictly to
              those details, in place of testing. Both routes depend entirely on workmanship: a
              bridged floating floor, a missing cavity closer, an unsealed service penetration or a
              back-to-back socket will show up in a test and will invalidate the assumptions behind
              a registered detail.
            </p>
            <p>
              ...
              nation and the construction type. Read them from the current published document for
              the project — quoting a remembered number is how people end up designing to a
            ...
            <p>
              ...
              question. It is a contractual performance question, set out in the project
              specification and the employer requirements, typically as an NR-style octave-band
              criterion or an equivalent per room type. Those criteria are informed by industry
              design guidance — CIBSE publications for building services noise and vibration, and BS
              8233 for sound insulation and noise reduction in buildings — which the specification
              writer draws on. The services engineer demonstrates compliance by calculation at design
              stage and by commissioning measurement afterwards.
            </p>
            <p>
              ...
              extract fan — is normally handled through planning conditions and an environmental
              noise assessment, with a local authority environmental health officer as arbiter.
              Occupational noise exposure in plant rooms and workshops is a separate health and
              safety regime of exposure assessment, control measures and hearing protection. Each
              has its own methods and its own numbers; never carry a figure from one into another.
            </p>
            <p>
              ...
              calculation chain that shows the design meets it. Coordinate the acoustic details
              early with the architect and structural engineer, because most of them are junctions
              and voids rather than products. And measure at commissioning with the system balanced
              — a criterion that was never verified is a criterion that was never met.
            </p>
          </ConceptBlock>
          ...
          >
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Room sounds echoey or speech is unclear</strong> → reverberation problem →
                add absorption, ceiling first
              </li>
              <li>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>Use manufacturer measured data for absorption and insertion loss, not typical values</li>
          ...
          <Scenario
            ...
            situation={
              <>
                In a mixed-use block, a ground-floor plant room containing pumps, a pressurisation
                set and an air handling unit sits directly beneath a residential bedroom on the
                floor above. The separating floor is a concrete slab. The occupier reports a
                continuous low hum that is worst at night, is audible with the windows shut, and
                does not change when the bedroom door is closed. Ventilation to the bedroom is via a
                separate system and the noise persists when it is switched off.
              </>
            }
            whatToDo={
              <>
                ...
                offender. Address the airborne component separately if measurement shows one:
                sealing the plant room construction, an acoustic door set, and treating the slab
                soffit. Re-measure against the octave-band criterion for the bedroom taken from the
                project specification, at night, with all plant in its normal operating state.
              </>
            }
            whyItMatters={
              <>
                A structure-borne complaint answered with airborne remedies is money spent for no
                change, and it destroys credibility with the client. Low-frequency hum in a bedroom
                is also the most complained-about noise problem there is, because it is steady, it is
          ...
          <Scenario
            ...
            situation={
              <>
                ...
                open up, staff seated beneath two of them report a rushing hiss and raise their
                voices to be heard. The suspended ceiling is an absorbent mineral tile, the fit-out
                is otherwise unchanged, and the AHU attenuators were specified and installed to the
                original design.
              </>
            }
            whatToDo={
            ...
            whyItMatters={
              <>
                ...
                and the client is watching. It is also routinely misdiagnosed as fan noise, leading
                to expensive attenuator work that changes nothing. And in an open plan, raised voices
                are self-reinforcing: as soon as people speak up to beat the background, the
                background is the voices, and the floor stops working as a place to concentrate.
              </>
            }
          />
