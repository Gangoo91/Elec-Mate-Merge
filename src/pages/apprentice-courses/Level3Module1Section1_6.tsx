  ...
  const quizQuestions = [
    {
      id: 1,
      question:
        "According to the Working at Height Regulations 2005, what constitutes 'working at height'?",
      options: [
      ...
      correctAnswer: 2,
      explanation:
        'The regulations define working at height as any work in a place from which a person could fall a distance liable to cause personal injury - regardless of how high it is. There is no minimum height threshold.',
    },
    {
      id: 2,
      ...
      correctAnswer: 2,
      explanation:
        'The hierarchy is: AVOID working at height where possible, PREVENT falls using the right equipment, then MITIGATE the consequences of a fall if it cannot be prevented. This order must be followed.',
    },
    {
      id: 3,
      question: 'What is the correct angle ratio for positioning a ladder against a wall?',
      options: ['1:2 ratio', '1:3 ratio', '1:4 ratio', '1:5 ratio'],
      correctAnswer: 2,
      explanation:
        'The 1:4 ratio means for every 4 metres of height, the base should be 1 metre out from the wall. This ensures stability and reduces the risk of the ladder slipping backwards or sideways.',
    },
    {
      id: 4,
      question:
        'What training certification is required for operating Mobile Elevating Work Platforms (MEWPs)?',
      options: [
        'CSCS card only',
      ...
      correctAnswer: 1,
      explanation:
        'IPAF (International Powered Access Federation) certification is the industry-recognised training standard for MEWP operators. It covers safe operation, pre-use checks, emergency procedures, and machine-specific familiarisation.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'A green tag indicates the scaffold has been inspected by a competent person and is safe for use. Red or other warning tags indicate incomplete or unsafe scaffolds that must not be used.',
    },
    {
      id: 6,
      question:
        'Which type of protection takes priority under the regulations - collective or personal?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'Collective protection measures (guard rails, netting) that protect everyone without requiring individual action are preferred over personal protection (harnesses) that only protect individuals and require correct fitting and use.',
    },
    {
      id: 7,
      ...
      correctAnswer: 2,
      explanation:
        'The 3 points of contact rule ensures stability by maintaining constant grip on the ladder - either 2 hands and 1 foot, or 2 feet and 1 hand at all times during climbing.',
    },
    {
      id: 8,
      question:
        'When working near fragile surfaces like roof lights, what precautions must be taken?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'Fragile surfaces require crawling boards to distribute weight, barriers to prevent approach, and clear warning signs. Never step directly on fragile materials - they can give way without warning.',
    },
    {
      id: 9,
      ...
      correctAnswer: 1,
      explanation:
        'Work at height should generally be suspended when wind reaches Beaufort Force 5 (17+ mph) or earlier when handling lightweight materials. Site-specific risk assessments determine exact limits.',
    },
    {
      id: 10,
      ...
      correctAnswer: 2,
      explanation:
        'Electrical shock at height is especially dangerous because the resulting involuntary muscle contractions or loss of consciousness can directly cause falls, combining two serious hazards into one potentially fatal incident.',
    },
    {
      id: 11,
      ...
      correctAnswer: 2,
      explanation:
        'Ladders must extend at least 1 metre (approximately 3 rungs) above the landing point to provide a secure handhold when stepping on and off the ladder at the top.',
    },
    {
      id: 12,
      ...
      correctAnswer: 1,
      explanation:
        'Scaffolds must be inspected by a competent person before first use, after any alteration, after any event affecting stability (like adverse weather), and at regular intervals not exceeding 7 days.',
    },
  ];
        ...
        <div className="max-w-3xl mx-auto space-y-8 sm:space-y-12">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="p-4 sm:p-5 rounded-xl bg-elec-yellow/10 border border-elec-yellow/20">
              ...
              <ul className="space-y-2 text-sm text-white/80">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow mt-1">*</span>
                  <strong className="text-white">Use:</strong> 1:4 ladder ratio, 3 points contact,
                  scaffold tags
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow mt-1">*</span>
                  <strong className="text-white">Check:</strong> Weather, equipment inspection,
                  rescue plan
                </li>
              </ul>
            </div>
          ...
          <section className="space-y-4">
            ...
            <div className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10 space-y-4">
              <p className="text-white/80 text-sm sm:text-base leading-relaxed">
                ...
                deliberately broad and has significant implications for electricians.
              </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">
                      ...
                      opening. If you could fall and be injured, the regulations apply.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p className="text-white/80 text-sm sm:text-base leading-relaxed">
                ...
                <strong className="text-white">appropriately supervised</strong>, and carried out in
                a manner that is as safe as reasonably practicable.
              </p>
            </div>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white">
                Hierarchy of Controls (Avoid, Prevent, Mitigate)
              </h2>
            </div>
            <div className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10 space-y-4">
              <p className="text-white/80 text-sm sm:text-base leading-relaxed">
                ...
                minimising consequences. You cannot skip ahead in the hierarchy.
              </p>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    Modern construction techniques often allow significant reduction in work at
                    height through better planning and prefabrication.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    <strong className="text-white">collective protection measures</strong> (those
                    protecting everyone) take priority over{' '}
                    <strong className="text-white">personal protection measures</strong> (those
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white">
                Equipment Requirements - Ladders, Scaffolds, MEWPs
              </h2>
            </div>
            <div className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10 space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white">
                Electrical Work at Height - Specific Risks
              </h2>
            </div>
            <div className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10 space-y-4">
              <p className="text-white/80 text-sm sm:text-base leading-relaxed">
                ...
                involuntary muscle contractions or loss of consciousness, directly leading to falls.
              </p>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    distances from live parts even when working on the column structure.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    additional consideration for emergency response at height.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    distances (typically 15m horizontal for lines up to 132kV).
                  </p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    ...
                    on exposed structures or near overhead lines.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="p-4 sm:p-6 rounded-xl bg-gradient-to-br from-amber-500/10 to-red-500/10 border border-amber-500/20">
            ...
            <div className="space-y-3 text-sm text-white/80">
              <p>
                ...
                hundreds of times and decided to save time by not fully isolating the supply,
                relying on the time switch to keep the circuit off during daylight hours.
              </p>
              <p>
                <strong className="text-white">What Went Wrong:</strong> Unknown to the electrician,
                a timer fault had occurred and the circuit energised while he was working at the top
                of the column. He received an electric shock that caused him to release his grip.
                Although he was wearing a harness, the shock caused him to fall sideways, striking
                his head on the column structure.
              </p>
              <p>
                <strong className="text-white">The Consequences:</strong> The electrician suffered a
                serious head injury and was unable to work for six months. The investigation
                revealed multiple failures: no proper isolation procedure, inadequate risk
                assessment, and failure to use appropriate head protection.
              </p>
              <p>
                <strong className="text-white">The Lesson:</strong> When electrical work and work at
                height combine, BOTH sets of safety procedures must be rigorously followed. Never
                take shortcuts with isolation procedures, especially when working at height where
                shock consequences are amplified by fall risk.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10">
            <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">
              Practical Guidance - Working at Height Checklist
            </h2>
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            ...
            <div className="space-y-4">
              <details className="group">
                ...
                <p className="mt-2 text-white/70 text-sm pl-4 border-l-2 border-elec-yellow/30">
                  ...
                  Many employers provide ladder safety training.
                </p>
              </details>
              <details className="group">
                <summary className="cursor-pointer font-medium text-white hover:text-elec-yellow active:text-elec-yellow transition-all touch-manipulation flex items-center justify-between">
              ...
              <details className="group">
                ...
                <p className="mt-2 text-white/70 text-sm pl-4 border-l-2 border-elec-yellow/30">
                  ...
                  prevent approach, and ensure clear warning signs are displayed.
                </p>
              </details>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-6 rounded-xl bg-gradient-to-br from-elec-yellow/10 to-elec-yellow/5 border border-elec-yellow/20">
            <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">
              Pocket Guide - Working at Height
            </h2>
            <div className="grid sm:grid-cols-2 gap-4 text-sm">
              <div className="space-y-2">
                ...
                <ul className="space-y-1 text-white/80">
                  ...
                  <li>
                    2. <strong className="text-white">PREVENT</strong> falls with equipment
                  </li>
                  <li>
                    3. <strong className="text-white">MITIGATE</strong> fall consequences
                  </li>
                </ul>
              </div>
              <div className="space-y-2">
          ...
          <nav className="flex flex-col sm:flex-row justify-between gap-4 pt-6 border-t border-white/10">
            ...
            <Link
              to="/study-centre/apprentice/level3-module1-section1-7"
