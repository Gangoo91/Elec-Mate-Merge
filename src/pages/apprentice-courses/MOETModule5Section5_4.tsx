...
const quizQuestions = [
  {
    ...
    options: [
      'Adjusting the controller tuning',
      ...
      'Putting the controller in automatic',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Checking the cable routing direction',
      'Confirming that the controller output moves in the correct direction in response to a change in the process variable',
      'Checking which way the transmitter faces',
      'Verifying the data flow direction on the network',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only for safety-critical loops',
      'Alarm testing is a separate activity',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Just an email to the supervisor',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only the SIF needs to be tested annually',
      'Safety loops do not require functional testing',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The number of tests performed per year',
  ...
  },
  {
    ...
    options: [
      'Interlocks are not relevant to loop testing',
      'Safety interlocks may trip if test signals reach alarm levels, causing unintended plant shutdowns or equipment damage',
      'Interlocks automatically disable during testing',
      'Only electrical interlocks need managing',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'It is not important',
      'Only to test the historian software',
    ],
    correctAnswer: 1,
    explanation:
