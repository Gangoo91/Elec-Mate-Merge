    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Apply the principles of lighting design and acoustic engineering to create comfortable
          building environments
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the physics of light and sound, calculation methods for illumination
          levels, lamp selection, noise control strategies, and compliance with Part E and CIBSE
          guidance - essential for designing comfortable and compliant building services.
        </p>
