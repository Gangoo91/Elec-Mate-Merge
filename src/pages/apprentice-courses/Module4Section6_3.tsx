      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Understanding Insulation Resistance Fundamentals</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Insulation Resistance Principles and Measurement</p>
                    <p className="text-base text-foreground mb-2"><strong>Definition and properties:</strong> The ability of insulating materials to resist current flow.</p>
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Safety significance:</strong> Poor insulation creates serious hazards requiring immediate attention.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Measurement principles:</strong> High voltage DC testing reveals insulation condition.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Testing Purpose and Regulatory Requirements</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Fault detection purposes:</strong> Identifying insulation damage before hazards develop.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Compliance verification:</strong> Meeting BS 7671 minimum standards and safety requirements.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Testing schedule requirements:</strong> When insulation resistance testing must be performed.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          {/* Testing Procedure */}
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Systematic Testing Procedures and Safety Protocols</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Professional Testing Methodology and Equipment Protection</p>
                    <p className="text-base text-foreground mb-2"><strong>Pre-testing safety procedures:</strong> Essential preparation for safe and accurate testing.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Equipment protection requirements:</strong> Preventing damage to sensitive devices during testing.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Testing sequence and measurements:</strong> Systematic approach for comprehensive verification.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Result recording and analysis:</strong> Proper documentation and interpretation procedures.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Result Interpretation and Common Insulation Faults</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-amber-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Acceptable test values:</strong> BS 7671 requirements and industry best practices.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Installation-related fault causes:</strong> Common problems during installation process.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Environmental degradation factors:</strong> External influences reducing insulation effectiveness.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Installation quality issues:</strong> Workmanship factors affecting insulation integrity.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          {/* Tools and Equipment */}
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Essential Equipment and Professional Testing Techniques</h3>
            <div className="space-y-4">
              ...
              <div className="rounded-lg p-4 bg-card border border-green-400/30">
                <p className="font-medium text-foreground mb-2">Professional Testing Best Practices</p>
                <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
              ...
              <div className="rounded-lg p-4 bg-card border border-amber-400/30">
                <p className="font-medium text-foreground mb-2">Field Testing Example Scenario</p>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
            <div className="space-y-4">
              <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
                <h3 className="font-medium text-foreground mb-2">Implementation Strategy</h3>
                <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
          ...
          <div className="space-y-6">
            <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  <p className="font-medium text-foreground mb-2">Cable Protection Strategy</p>
                  <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
            ...
            <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <p className="font-medium text-foreground mb-2">Testing Excellence</p>
                  <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-4">
            <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/20">
              <h3 className="font-medium text-foreground mb-2">Regulatory Requirements</h3>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
              <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
                <h3 className="font-medium text-emerald-400 dark:text-emerald-400 mb-2">Safety Assurance</h3>
                <ul className="text-xs sm:text-sm text-foreground space-y-1 list-disc pl-4">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
            <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/20">
              <h3 className="font-medium text-foreground mb-3">Testing Procedure Checklist</h3>
