...
const quickCheckQuestions = [
  {
    ...
    options: ['PVC trunking', 'Steel trunking', 'Both types'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Insulation tape', 'Grommets or bushes', 'Heat shrink tubing'],
    correctIndex: 1,
    explanation:
...
const faqs = [
  {
    ...
    answer:
      "Yes, if it's UV-stabilised and weatherproof, but steel or SWA cable may be better for mechanical strength in exposed locations.",
  },
  {
    question: 'Does steel trunking need to be earthed?',
    answer:
      'Yes, and electrical continuity must be tested between all sections to ensure safe fault current paths.',
  },
  {
    question: 'Is trunking fire-rated?',
    answer:
      'Steel trunking provides better fire resistance; PVC can be made with fire-retardant materials but will still deform under high heat.',
  },
  {
    question: "What's the maximum fill factor for cables in trunking?",
    answer:
      'Generally 45% of the internal cross-sectional area to ensure adequate heat dissipation and future access.',
  },
];
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                Enclosed channels providing easy access to cables for maintenance and additions
              </li>
              <li>
                PVC: lightweight, easy install, good for offices/domestic; Steel: tough, industrial
                strength
              </li>
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Rectangular channels with removable lids, often at skirting
                or dado height
              </li>
              <li>
                <strong>Use:</strong> PVC for offices/homes; Steel for factories/workshops with
                impact risks
              </li>
              <li>
                <strong>Check:</strong> Fill factor, segregation barriers, lid security, support
                spacing, earthing (steel)
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="p-4 rounded bg-white/5">
              <p className="font-medium text-white text-sm mb-3">
                Cable Management and Fill Factors
              </p>
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-3 rounded bg-white/5">
              ...
              <ul className="text-xs text-white/80 space-y-1">
                ...
                <li>
                  <strong>Solution:</strong> Calculate cable cross-sectional areas properly, plan
                  for 25% future expansion
                </li>
              </ul>
            </div>
            ...
            <div className="p-3 rounded bg-amber-500/10 border border-amber-400/20">
              ...
              <ul className="text-xs text-white/80 space-y-1">
                ...
                <li>
                  <strong>Solution:</strong> Install proper barriers, use separate compartments,
                  follow segregation guidelines
                </li>
              </ul>
            </div>
            ...
            <div className="p-3 rounded bg-white/5">
              ...
              <ul className="text-xs text-white/80 space-y-1">
                ...
                <li>
                  <strong>Solution:</strong> Follow manufacturer guidelines, add supports at changes
                  of direction
                </li>
              </ul>
            </div>
            ...
            <div className="p-3 rounded bg-white/5">
              ...
              <ul className="text-xs text-white/80 space-y-1">
                ...
                <li>
                  <strong>Solution:</strong> Clean all mating surfaces, use star washers, test
                  continuity, bond to main earth
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <ul className="text-sm text-white space-y-2 ml-4">
              <li>
                ...
                collapse during fire conditions
              </li>
              <li>
                <strong>Section 528.1:</strong> Segregation requirements - circuits of different
                categories must be separated or have adequate insulation
              </li>
              <li>
                <strong>Section 543.2.9:</strong> Metallic trunking as protective conductor -
                electrical continuity and cross-sectional area requirements
              </li>
              <li>
                <strong>Section 522.8.10:</strong> Selection of wiring systems appropriate to
                external influences
              </li>
              <li>
                <strong>Section 526:</strong> Electrical connections must be accessible for
        ...
        <section className="mb-10">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-sm text-white leading-relaxed">
              Trunking systems provide accessible, organised cable management with PVC offering ease
              of installation for commercial environments and steel delivering robust protection for
              industrial applications. Proper segregation, fill factor control and earthing (for
              steel) ensure safe, compliant installations.
            </p>
          </div>
        </section>
