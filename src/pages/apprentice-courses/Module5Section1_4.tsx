...
const TITLE =
  'Interpreting Floorplans and Circuit Layouts - Module 5.1.4 | Level 2 Electrical Course';
const DESCRIPTION =
  'Learn to read electrical floorplans, circuit layouts, and cable routes. Master safe cable zones and accurate positioning for compliant electrical installations.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Floorplans show the building layout with the positions of all electrical equipment, accessories, and containment systems.',
  },
  {
    id: 2,
...
const Module5Section1_4 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'False. Cable routes must follow designated safe zones to reduce the risk of accidental damage and comply with BS 7671 regulations.',
    },
    {
      id: 5,
      question: 'Why should electrical layouts be cross-checked on-site?',
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Always measure and check positions against the drawing to ensure accurate placement of electrical equipment and accessories.',
    },
    {
      id: 10,
  ...
  const faqs = [
    {
      ...
      answer:
        'Always double-check measurements using the scale and given dimensions on the drawing. Use running dimensions where provided and verify critical positions with a supervisor.',
    },
    {
      question: "What should I do if the building doesn't match the drawing?",
      answer:
        'Stop work immediately and consult your supervisor. Document the differences with photos and measurements, and obtain written approval before proceeding with any changes.',
    },
    {
      question: 'Are cable routes shown on all electrical drawings?',
      answer:
        'Not always. Some drawings show general routes while others provide detailed cable paths. Check if there are separate cable route drawings or containment layouts for your project.',
    },
    {
      question: 'How do I coordinate with other trades when setting out?',
      answer:
        'Attend coordination meetings, check for service clashes before installation, and communicate any positioning concerns early. Mark out your work clearly to avoid conflicts.',
    },
    {
      question: 'What if I find cables in areas not shown on the drawing?',
      answer:
        'Existing installations may not be shown on new work drawings. Always use cable detection equipment and treat any found cables as live until proven otherwise. Inform your supervisor immediately.',
    },
  ];
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1 text-white/80 text-sm">
                  ...
                  <li>
                    <strong>Use:</strong> Measurements for positioning, circuit codes for
                    identification.
                  </li>
                  <li>
                    <strong>Check:</strong> Site conditions, other services, coordinate with trades.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Building structure integration:</strong> Show how
                    electrical equipment fits within the physical building
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Equipment locations:</strong> Precise positions
                    of switches, sockets, lights, and distribution boards
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Containment runs:</strong> Routes for trunking,
                    conduit, and cable management systems
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Architectural coordination:</strong> Integration
                    with doors, windows, and structural elements
                  </span>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
                <p className="text-blue-300 font-medium">
                  Floorplans are the bridge between electrical design and physical installation,
                  showing exactly where everything should be positioned within the building
                  structure.
                </p>
              </div>
            </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div className="space-y-3 mb-4">
                <p>
                  ...
                  connect back to distribution boards
                </p>
                <p>
                  <strong className="text-white">Circuit identification:</strong> Each circuit has
                  unique numbers or codes (e.g., L1/01, L2/03)
                </p>
                <p>
                  <strong className="text-white">Load distribution:</strong> How electrical loads
                  are balanced across circuits
                </p>
                <p>
                  <strong className="text-white">Protection coordination:</strong> Links to MCBs,
                  RCDs, and other protective devices
                </p>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="space-y-3">
                <p>
                  <strong className="text-white">Route marking:</strong> Lines, arrows, or symbols
                  show cable pathways
                </p>
                <p>
                  <strong className="text-white">Safe zone compliance:</strong> 150mm from corners,
                  50mm from ceiling/floor edges
                </p>
                <p>
                  <strong className="text-white">Containment integration:</strong> Routes through
                  trunking, conduit, or cable trays
                </p>
                <p>
                  <strong className="text-white">Access considerations:</strong> Maintenance and
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div className="space-y-3 mb-4">
                <p>
                  ...
                  accurately locate equipment on-site
                </p>
                <p>
                  <strong className="text-white">Verification process:</strong> Check that building
                  matches drawing dimensions
                </p>
                <p>
                  <strong className="text-white">Trade coordination:</strong> Confirm positions
                  don't clash with other services
                </p>
                <p>
                  <strong className="text-white">Quality control:</strong> Mark out positions before
                  fixing or cutting
                </p>
              </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div className="space-y-3 mb-4">
                <p>
                  ...
                  plumbing, HVAC, and data installations
                </p>
                <p>
                  <strong className="text-white">Structural awareness:</strong> Avoid drilling into
                  load-bearing elements
                </p>
                <p>
                  <strong className="text-white">Access requirements:</strong> Ensure other trades
                  can reach their equipment
                </p>
                <p>
                  <strong className="text-white">Installation sequence:</strong> Plan work order
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-white/80">
                  ...
                  <p className="text-sm mb-3">
                    In a new housing project, cables were run outside of designated safe zones shown
                    in the drawings. The installation appeared correct initially, but during second
                    fix work, a joiner's drill bit hit a hidden cable while installing kitchen
                    units.
                  </p>
                  ...
                  <p className="text-sm font-medium text-white">
                    Total cost: £850 in repairs, delays, and remedial work. This could have been
                    prevented by following the safe zone routes clearly marked on the installation
                    drawings.
                  </p>
                </div>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4">
              ...
              <p className="mt-4 font-medium text-elec-yellow">
                Accurate interpretation of floorplans and layouts ensures safe, compliant, and
                well-coordinated electrical installations.
              </p>
            </div>
          </section>
          ...
          {/* Quiz */}
          <div className="mb-10">
            <Quiz title="Floorplans and Circuit Layouts Quiz" questions={quizQuestions} />
          </div>
