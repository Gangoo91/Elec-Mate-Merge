    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Design effective lighting systems that meet functional requirements, enhance wellbeing and
          minimise energy consumption
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers all aspects of lighting design for building services, from
          establishing design criteria through to specifying energy-efficient solutions. Good
          lighting design balances visual comfort, task performance, safety and sustainability.
        </p>
