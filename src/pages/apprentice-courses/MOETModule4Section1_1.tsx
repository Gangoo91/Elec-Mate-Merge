/**
 * MOET · Module 4 · Section 1 · Subsection 1 — Principles of PPM
 *
...
const MOETModule4Section1_1 = () => {
  ...
  return (
    <HubPage ground="reading">
      <HubMasthead
        section="Module 4 · Section 4.1 · Subsection 1"
      ...
      <HubBody pushContext="Get notified about your course progress, quiz streaks and new study content">
        <StudyPage>
          ...
          <TLDR
            points={[
              'PPM: Work decided and scheduled before failure, not after it.',
              'Four strategies: Reactive, preventive, predictive, condition-based.',
              'Bathtub curve: Early-life, useful-life and wear-out failure regions.',
              'Criticality: Rank by consequence of failure, then spend the hours.',
            ]}
          />
          ...
          <ContentEyebrow>What PPM is and why it exists</ContentEyebrow>

          <ConceptBlock title="Decided before anything goes wrong">
            <p>
          ...
          <ConceptBlock title="Five reasons PPM programmes exist">
            <ul className="list-disc space-y-2 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Safety:</strong> Protective devices, interlocks, emergency stops, emergency
                lighting and alarm systems only protect anybody if they still work. Unlike a
                production fault, a dormant safety fault gives you no warning that it exists — you
                only discover it at the moment you needed it to work.
              </li>
              <li>
                <strong>Statutory duty:</strong> The Electricity at Work Regulations 1989 place
                duties on those in control of electrical systems to keep them safe and maintained in
                a safe condition. The Provision and Use of Work Equipment Regulations 1998 require
                work equipment to be maintained so that it remains safe to use. Neither prescribes a
                schedule; both require the outcome.
              </li>
              <li>
              ...
              <li>
                ...
                environmental control extend the service life of plant. Neglect shortens it, and the
                shortening is usually invisible until replacement is unavoidable.
              </li>
              <li>
          ...
          <ConceptBlock
            title="The hidden-fault problem"
            onSite={
              <>
                The purpose of PPM is not to do more maintenance. It is to make sure that the
                maintenance which actually matters happens, is recorded, and is informed by what the
                equipment is telling you.
              </>
            }
          >
            <p>
              ...
              maintenance regime. A seized emergency stop, a failed RCD, an emergency luminaire with
              a dead battery — none of these announce themselves. They are found by a test, or they
              are found by an incident. PPM is how you make sure it is the first one.
            </p>
          </ConceptBlock>

          <SectionRule />

          <ContentEyebrow>The four maintenance strategies compared</ContentEyebrow>

          <ConceptBlock title="A deliberate mixture, not one strategy for everything">
            <p>
          ...
          <ConceptBlock title="Reactive (breakdown / run-to-failure)">
            <p>
              Nothing is done until the asset fails, then it is repaired or replaced. Also called
              corrective maintenance when it follows a reported fault.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>In its favour:</strong> No effort is spent on assets that never fail. Full
                component life is used. Zero planning overhead.
              </li>
              <li>
                <strong>Against it:</strong> Failure occurs at the worst moment; repair takes longer
                because access, parts and permits were not prepared; consequential damage is
                possible; and there is no evidence of a maintenance regime.
              </li>
              <li>
                <strong>Appropriate when:</strong> Consequence of failure is low, there is no safety
                or statutory function, failure cannot cascade, and a spare is on the shelf — and the
                decision has been documented rather than defaulted into.
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="Preventive (fixed interval)">
            <p>
              Work is carried out at a set interval — calendar time, running hours, operating cycles
              or throughput — regardless of the apparent condition of the asset.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                <strong>Against it:</strong> Intervals are estimates. Set them too long and you miss
                failures; set them too short and you spend hours on healthy equipment and disturb
                connections that were perfectly sound.
              </li>
              <li>
                <strong>Appropriate when:</strong> There is a known wear-out mode, a
                manufacturer-defined service life, a statutory interval, or no practical condition
                indicator to measure.
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="Condition-based maintenance (CBM)">
            <p>
              A condition indicator is measured on a schedule, and intrusive work is only carried
              out when that measurement says it is needed.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>In its favour:</strong> Intervention happens because the asset needs it, not
                because a date arrived. Healthy equipment is left alone. Most measurements are taken
                with the plant in service.
              </li>
              <li>
                <strong>Against it:</strong> Needs instruments, competence to interpret the
                readings, and a baseline. A measurement without a baseline or a trend tells you much
                less than people assume.
              </li>
              <li>
                <strong>Electrical examples:</strong> Thermographic surveys of boards and
                terminations, insulation resistance trending on motors, vibration on drive trains,
                battery impedance on standby systems.
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="Predictive maintenance (PdM)">
            <p>
              Condition data is trended over time and used to estimate when the asset will reach an
              unacceptable state, so the work can be planned into a chosen window rather than done
              at the moment a threshold is crossed.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>In its favour:</strong> Converts an emerging fault into planned work with
                ordered parts and booked access — the best of both worlds.
              </li>
              <li>
                ...
                methods, the trend is noise. Investment in instruments and analysis skills is real.
              </li>
              <li>
          ...
          <ConceptBlock
            ...
            onSite={
              <>
                The right question is never &quot;which strategy is best?&quot; It is &quot;which
                strategy suits this asset, given how it fails and what happens when it does?&quot;
              </>
            }
          >
          ...
          <ContentEyebrow>The bathtub curve</ContentEyebrow>

          <ConceptBlock title="The single most useful mental model for a fixed interval">
            <p>
          ...
          <ConceptBlock title="Region 1 — infant mortality (falling failure rate)">
            <p>
              Early in service the failure rate is high and falling. The failures are not caused by
              age; they are latent defects being flushed out — a manufacturing flaw, a termination
              that was never properly tightened, a gland that was not correctly made, a setting left
              at its factory default, a cable damaged during installation.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                Thorough commissioning and correct installation shorten this region more than any
                maintenance task can
              </li>
              <li>
                New and newly overhauled equipment deserves closer attention than long-established
                plant, which is the opposite of most people&apos;s instinct
              </li>
              <li>
                Every intrusive maintenance job restarts a small infant-mortality period on whatever
                you touched
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="Region 2 — useful life (roughly constant failure rate)">
            <p>
              ...
              transient overvoltage, a foreign object, an operating error, a one-off overload. The
              component is no more likely to fail next month than it was last month.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                This is the region where fixed-interval replacement earns least. Swapping a healthy
                item does not reduce the chance of a random event, and it exposes you to the new
                item&apos;s early-life risk
              </li>
              <li>
              ...
              <li>
                Cleaning, correct environment and protection against external influences shift the
                whole curve — they keep the asset in this region for longer
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="Region 3 — wear-out (rising failure rate)">
            <p>
              Eventually age-related mechanisms take over and the failure rate climbs: insulation
              degradation, bearing wear, contact erosion, electrolyte loss in capacitors and standby
              batteries, mechanical fatigue, seal hardening.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                This is where scheduled replacement genuinely works, because failure is age-related
                and therefore predictable across a population
              </li>
              <li>
                Condition trending is at its most valuable just before this region, because it tells
                you when an individual asset is entering it
              </li>
              <li>
                Standby batteries are the textbook example: a defined service life, a measurable
                degradation, and a failure mode that only shows up when you most need the system
              </li>
            </ul>
          </ConceptBlock>

          <CommonMistake
            title="Assuming every asset follows the classic bathtub shape"
            whatHappens={
              <>
                Many electronic and electrical components show almost no wear-out region within the
                life of the installation, so their curve is essentially flat after the early-life
                period. For those, a fixed replacement interval is close to pointless and a periodic
                functional test is what actually protects you. Other assets — filters, brushes,
                contactor tips, lamps, batteries — are dominated by wear-out and should be on a firm
                interval.
              </>
            }
            doInstead={
              <>
                Ask which shape the asset in front of you actually has before you write an interval
                into the schedule.
              </>
            }
          />
          ...
          <p className="text-[13.5px] leading-relaxed text-elec-yellow/90">
            ...
            Fixed-interval replacement is a wear-out tool. If the failure mode is random rather than
            age-related, the interval will not help and a condition or functional check will.
          </p>
          ...
          <ContentEyebrow>Building a PPM schedule</ContentEyebrow>

          <ConceptBlock title="Three inputs, asset by asset">
            <p>
          ...
          <ConceptBlock title="Step 1 — start from the asset register">
            <p>
              You cannot maintain what you have not listed. Every asset needs a unique identifier, a
              precise location, its type and rating, manufacturer and model, and its commissioning
              date. An asset that is not on the register receives no maintenance and appears in no
              report — and unregistered assets are almost always the ones that fail first, because
              nobody has looked at them for years.
            </p>
          </ConceptBlock>

          <ConceptBlock title="Step 2 — take the manufacturer guidance">
            <p>
              Manufacturer operating and maintenance documentation is the starting point for task
              content and interval. It is a starting point rather than an answer, because the
              manufacturer wrote it for a typical duty and a typical environment.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                Light duty in a clean, controlled environment may justify a longer one, provided the
                evidence supports it and no statutory floor is breached
              </li>
              <li>
                Where guidance conflicts with a statutory or standards-driven requirement, the
                requirement wins and the manufacturer interval becomes the ceiling, not the floor
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="Step 3 — assess criticality">
            <p>
              Criticality ranks assets by the consequence of their failure, not by their cost or
              their size. It is the mechanism that stops a finite maintenance team spreading itself
              evenly across a site where the risks are anything but even.
            </p>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left text-sm">
                <thead>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-white/10 px-3 py-2 text-white">
                      Planned tasks plus condition monitoring; redundancy where practicable; never
                      deferred
                    </td>
                  </tr>
                  <tr>
          ...
          <ConceptBlock title="Step 4 — identify statutory and standards-driven items">
            <p>
              Some tasks are not yours to reschedule. Life-safety systems, lifting equipment,
              pressure systems, local exhaust ventilation and the electrical installation itself all
              attract requirements arising from legislation or from the standard the system was
              installed to. These go into the schedule first, are flagged as statutory, and are
              never traded off against routine work when the month gets busy.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                Flag them distinctly in the system so they cannot be closed as &quot;not required
                this cycle&quot;
              </li>
              <li>Report their compliance separately from the overall figure — see below</li>
              <li>
                Retain the resulting certificates and reports; the record is part of the task, not
                an afterthought
              </li>
            </ul>
          </ConceptBlock>
          ...
          <ConceptBlock
            title="What BS 7671 says about maintenance"
            onSite={
              <>
                ...
                routine work and trended test results does not warrant the same inspection interval
                as a neglected one — and the quality of your records is what determines which of
                those two the inspector concludes they are looking at.
              </>
            }
          >
            <p>
              BS 7671 is a standard for design, erection and verification rather than a maintenance
              manual, but it makes maintenance an explicit design input in three places that a
              maintenance technician should know.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Chapter 34, Maintainability:</strong> the installation is to be designed and
                erected so that it can be maintained without introducing danger, with the access and
                facilities needed to carry out inspection, testing, maintenance and replacement
                safely.
              </li>
              <li>
                <strong>Regulation 341.1:</strong> an assessment shall be made of the frequency and
                quality of maintenance the installation can reasonably be expected to receive during
                its intended life, and the person or body responsible for its operation and/or
                maintenance shall be consulted. Any periodic inspection, testing, maintenance and
                repairs likely to be necessary must be readily and safely capable of being carried
                out, and the effectiveness of the protective measures must not diminish over the
                intended life.
              </li>
              <li>
                <strong>Regulation 652.1:</strong> the frequency of periodic inspection and testing
                is to be determined having regard to the type of installation, the type of equipment
                present, the use and operation of the installation, the frequency and quality of
                maintenance, the external influences to which it is subjected, and the results and
                recommendations of previous certificates and condition reports.
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="Step 5 — write the task, not just the interval">
            <p>
            ...
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>The isolation, permit and access arrangements the work requires</li>
              <li>The specific checks in order, with acceptance criteria where they exist</li>
              <li>
                The measurements to be recorded as values, not as a tick — a number can be trended,
                a tick cannot
              </li>
              <li>The tools, instruments and consumables needed</li>
              <li>
                What to do if a defect is found, including the threshold for stopping and escalating
              </li>
            </ul>
          </ConceptBlock>
          ...
          <p className="text-[13.5px] leading-relaxed text-elec-yellow/90">
            <span className="mr-1.5 font-semibold text-elec-yellow">Key point: </span>
            Manufacturer guidance sets the starting interval, criticality decides how much effort
            the asset deserves, and statutory items set a floor you do not go below.
          </p>
          ...
          <ContentEyebrow>Measuring whether it is working — KPIs</ContentEyebrow>

          <ConceptBlock title="Turning opinions into figures">
            <p>
          ...
          <ConceptBlock title="MTBF — reliability">
            <p>
            ...
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                ...
                becoming more reliable; a falling one is an early warning that something has changed
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="MTTR — speed of recovery">
            <p>
              Mean Time To Repair is the average time taken to restore the asset to service after a
              failure — including diagnosis, isolation, parts, repair and functional testing, not
              just the time spent with tools in hand.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                A high MTTR usually points at logistics rather than skill: no spare held, no drawing
                available, no permit issued, no access arranged
              </li>
              <li>
          ...
          <ConceptBlock title="Worked example — MTBF, MTTR and availability">
            <p>
              A conveyor drive is monitored over a period. It accumulates 2,400 hours of running
              time, suffers 4 failures, and the total time spent repairing those 4 failures is 12
              hours.
            </p>
            <p>
            ...
            <p>
              ...
              about 3 hours of downtime. If the next period shows MTBF falling to 400 hours while
              MTTR stays at 3, the asset is degrading and the maintenance regime needs reviewing. If
              MTBF holds at 600 but MTTR climbs to 9 hours, the asset is no worse — your spares
              holding or your response process is.
            </p>
          </ConceptBlock>

          <ConceptBlock title="Schedule compliance — discipline">
            <p>
            ...
            <p>
              <strong>Worked example:</strong> 240 PPM tasks were scheduled during the month and 216
              were completed within their window. 216 / 240 = 0.90, so compliance is 90%.
            </p>
            <p>
              <strong>Now look inside the number.</strong> Suppose 3 of the 24 tasks that were
              missed were statutory inspections. Overall compliance of 90% looks respectable, but
              statutory compliance is 3 items short of the only acceptable figure, which is 100%.
              This is why a single blended KPI is dangerous: it lets genuinely non-negotiable work
              be averaged away by a pile of routine tasks that were done on time.
            </p>
          </ConceptBlock>

          <ConceptBlock title="Reading a poor result">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                <strong>Statutory compliance below 100%:</strong> that is a finding to be escalated,
                not a trend to be watched
              </li>
            </ul>
          </ConceptBlock>

          <CommonMistake
            title="Managing the KPI instead of the equipment"
            whatHappens={
              <>
                Compliance can be pushed to 100% by signing off tasks that were not really done, by
                writing intervals so long that nothing is ever due, or by removing awkward assets
                from the schedule. All three improve the number and worsen the risk.
              </>
            }
            doInstead={
              <>
                If you are ever asked to close a PPM task you did not complete, that is a request to
                falsify a maintenance record — decline it and escalate.
              </>
            }
          />
          ...
          <ContentEyebrow>Where electrical tasks fit in a PPM programme</ContentEyebrow>

          <ConceptBlock title="Making sure the electrical tasks are the right ones">
            <p>
          ...
          <ConceptBlock title="Thermographic surveys">
            <p>
              ...
              conductors, unbalanced phases and failing components by the heat they produce. It is
              the flagship condition-based electrical task because it is carried out with the
              equipment energised and in service, so it does not disturb healthy joints.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                Survey under representative load — a lightly loaded board hides the very faults you
                are looking for
              </li>
              <li>
                Comparison is the technique: one phase against the others, one connection against
                its neighbours carrying similar current, and this survey against the last
              </li>
              <li>
              ...
              <li>
                ...
                reports — thermography is a skilled task and interpretation matters as much as the
                image
              </li>
              <li>
                Findings feed straight into planned work: a hot connection identified today becomes
                a torque-check job in the next shutdown, not an emergency callout at 3am
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="RCD testing and the test button">
            <p>
              This is an area where two different things are routinely confused, so be precise about
              which one you mean.
            </p>
            <ul className="list-disc space-y-2 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>The user test.</strong> BS 7671 Regulation 514.12.2 sets out the wording of
                a notice to be provided, instructing users to test six-monthly by pressing the
                relevant test button, which should operate the device, and afterwards to switch the
                device on manually — and if the device does not operate or indicates a fault, to
                seek expert advice. That is a duty placed on ordinary persons and communicated by a
                notice. It confirms the mechanism operates; it says nothing about tripping current
                or disconnection time.
              </li>
              <li>
                <strong>The technician test.</strong> Instrument testing of an RCD by a competent
                person is a different activity, forms part of periodic inspection and testing, and
                produces recorded values against the requirements of BS 7671.
              </li>
              <li>
                <strong>In your PPM schedule</strong> both may appear: a functional test-button task
                at a defined interval on the sites where the maintenance team carries it out, and a
                separate instrument test tied to the inspection and testing regime. Record which one
                was done. &quot;RCD tested&quot; on a work order is close to worthless if nobody can
                tell which of the two it refers to.
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="Torque checks on terminations">
            <p>
              Loose connections are one of the most common causes of overheating, nuisance tripping
              and fire in distribution equipment. Torque checking is a classic PPM task, and also a
              classic example of a task that can do harm if it is done carelessly.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                Repeatedly re-torquing the same terminal is not automatically good practice — some
                terminals are designed to be tightened once, and over-tightening damages the
                conductor and the terminal
              </li>
              <li>
                Mark checked terminals so the next technician can see what has been done, and record
                the connections checked rather than a bare &quot;all tight&quot;
              </li>
              <li>
          ...
          <ConceptBlock title="Insulation resistance trending">
            <p>
              A single insulation resistance reading tells you whether the circuit or winding is
              acceptable today. A series of readings taken the same way over several years tells you
              whether the insulation is degrading — which is far more useful for planning.
            </p>
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                Record temperature and, for motors, whether the machine was hot or cold. Insulation
                resistance is strongly temperature-dependent and a warm machine will always read
                lower
              </li>
              <li>
                Compare against the minimum value required for the circuit by BS 7671 and, just as
                importantly, against the previous readings for that asset
              </li>
              <li>
          ...
          <ConceptBlock title="Other common electrical PPM tasks">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                Functional testing of emergency lighting, fire detection, interlocks and emergency
                stops — hidden functions that only a test can verify
              </li>
              <li>
              ...
              <li>
                Cleaning and filter changes on drives, enclosures and switch rooms — dust and heat
                shorten the useful-life region for everything inside
              </li>
              <li>
                Verifying labelling, notices, schedules and drawings still match the installation —
                the paperwork is a safety control, not administration
              </li>
              <li>
                Confirming that means of isolation, access and clearances remain adequate, as the
                maintainability requirements of BS 7671 assume
              </li>
            </ul>
          </ConceptBlock>
          ...
          <p className="text-[13.5px] leading-relaxed text-elec-yellow/90">
            <span className="mr-1.5 font-semibold text-elec-yellow">Key point: </span>
            Electrical PPM earns its keep when the results are values you can trend. Tick boxes
            prove attendance; recorded measurements prove condition.
          </p>

          <SectionRule />

          <ContentEyebrow>CMMS basics and record quality</ContentEyebrow>

          <ConceptBlock title="Only as good as what technicians put into it">
            <p>
          ...
          <ConceptBlock title="What a CMMS does for a PPM programme">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                Raises the work order automatically when a task falls due, whether the trigger is a
                date, a running-hours meter or a condition reading
              </li>
              <li>Captures findings, measurements, parts used and time spent against that asset</li>
              <li>
                Calculates the KPIs from the underlying records rather than from someone&apos;s
                recollection
              </li>
              <li>
                Provides the audit trail that demonstrates the maintenance regime actually happened
              </li>
            </ul>
          </ConceptBlock>

          <ConceptBlock title="What good looks like">
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left text-sm">
                <thead>
                  <tr className="bg-white/5">
          ...
          <ConceptBlock title="Records and the law">
            <p>
              The HSE approved code of practice supporting PUWER notes that there is no legal
              requirement to keep a maintenance log, although a record is recommended for high-risk
              equipment, and that a detailed log informs future planning and tells maintenance
              personnel what has been done before. It also states that maintenance work should only
              be carried out by people competent to do it. In practice, on any site of any size, the
              record is the only thing that can demonstrate after the event that the maintenance
              actually happened — which is why organisations treat record keeping as mandatory even
          ...
          <p className="text-[13.5px] leading-relaxed text-elec-yellow/90">
            ...
            Accurate, contemporaneous record keeping and the use of maintenance data to inform
            decisions are assessed behaviours on the maintenance technician standard. Being able to
            explain why a value beats a tick is exactly the kind of point that separates a pass from
            a distinction at end-point assessment.
          </p>

          <SectionRule />

          <ContentEyebrow>Site scenarios</ContentEyebrow>

          <ConceptBlock title="What happens when it goes wrong in either direction">
            <p>
          ...
          <Scenario
            title="The skipped PPM that became a breakdown"
            situation={
              <>
                <p>
                  A quarterly thermographic survey of the main distribution boards on a distribution
                  centre falls due in a week when the team is short-handed and chasing reactive
                  calls. The task is deferred. It is deferred again the following quarter because
                  the board could not be surveyed under representative load during the shift that
                  was available. At the third attempt someone closes it in the CMMS with the comment
                  &quot;not required, no issues reported&quot;.
                </p>
                <p>
            ...
            whatToDo={
              <>
                Return the task rather than close it, so it stays in the backlog and in the
                compliance figure. Record the genuine reason. Escalate a repeatedly deferred task on
                a high-criticality asset rather than letting it roll a third time. And if load
                conditions prevent the survey, that is a scheduling problem to be fixed, not a
                reason to record the work as complete.
              </>
            }
            whyItMatters={
              <>
                The deferral was reasonable once. What was not reasonable was closing the task to
                protect the compliance figure, which erased the only record that the survey had
                never been done. The fault was of exactly the type thermography exists to find, and
                it had been developing across three survey windows.
              </>
            }
          />

          <Scenario
            title="Over-maintaining"
            situation={
              <>
                <p>
                  ...
                  more checking must therefore be better. The schedule consumes a large share of the
                  electrical team&apos;s planned hours.
                </p>
                <p>
                  Over the following two years the site sees a run of nuisance faults shortly after
                  the annual programme: a neutral not fully remade, a conductor damaged by
            ...
            whatToDo={
              <>
                Use a non-intrusive condition task to decide where intrusive work is warranted —
                survey the boards thermographically under load, then open only the ones the survey
                flags. Follow manufacturer guidance on whether a terminal should be re-torqued at
                all. Protect the functional tests on life-safety systems in the schedule so they
                cannot be squeezed out. Consider whether the interval is justified by the evidence:
                HSE guidance on maintaining portable electrical equipment applies exactly this
                logic, noting that a low failure rate indicates the interval can be lengthened and a
                high failure rate that it should be shortened.
              </>
            }
            whyItMatters={
              <>
                Intrusive work on healthy equipment is not risk-free — it restarts infant mortality
                on everything it touches. Worse, the over-maintenance displaced a hidden-function
                test on a life-safety system, which is precisely the category of task that should
          ...
          <p className="text-[13.5px] leading-relaxed text-elec-yellow/90">
            <span className="mr-1.5 font-semibold text-elec-yellow">Key point: </span>
            Both failures come from the same root — a schedule that was never reviewed against
            evidence. PPM is not a document you write once; it is a programme you tune with the data
          ...
          <KeyTakeaways
            ...
            points={[
              'Low consequence, quick to replace — documented run-to-failure.',
              'Wear-out failure mode — fixed-interval preventive.',
              'Usable condition indicator — condition-based.',
              'Critical plus gradual degradation — predictive, trend the data.',
              'Statutory or life-safety function — never deferred, 100% compliance.',
            ]}
          />
          ...
          <KeyTakeaways
            ...
            points={[
              ...
              'Compliance = completed on time / scheduled x 100%.',
              'Worked example: 2,400 h, 4 failures, 12 h repair = 600 h MTBF / 3 h MTTR / 99.5% availability.',
            ]}
          />
          ...
          <KeyTakeaways
            title="Bathtub curve"
            points={[
              'Infant mortality — falling rate, defects and workmanship.',
              'Useful life — flat rate, failures largely random.',
              'Wear-out — rising rate, age-related mechanisms.',
              'Fixed intervals pay in wear-out, not in useful life.',
            ]}
          />

          <KeyTakeaways
            title="BS 7671 reference points"
            points={[
              'Chapter 34 — maintainability; maintain without introducing danger.',
              'Reg 341.1 — assess frequency and quality of maintenance; consult duty holder.',
              'Reg 652.1 — factors determining periodic inspection frequency.',
              'Reg 514.12.2 — RCD notice, six-monthly user test-button instruction.',
            ]}
          />
          ...
          <Bleed>
            <div className="grid grid-cols-2 gap-3 pt-2">
              <button
                onClick={() => navigate('/study-centre/apprentice/m-o-e-t-module4-section1')}
