...
const Module2Section6_4: React.FC = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: [
        'It always reduces current',
        'It increases current for the same useful output',
        'It makes voltage higher',
        'It stops heating',
      ],
      correctAnswer: 1,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Good ventilation',
        'Correct cable size',
        'High ambient temperature and grouping',
        'Proper termination',
      ],
      correctAnswer: 2,
      explanation:
