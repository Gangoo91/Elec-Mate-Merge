...
const Module2Section6_4: React.FC = () => {
  ...
  const faqs = [
    {
      q: 'What are electrical losses?',
      a: 'Energy that does not become the intended output – usually wasted as heat in cables, equipment or connections.',
    },
    {
      q: 'Do all systems have losses?',
      a: 'Yes. Good design and installation keep them small and safe.',
    },
    {
      q: 'Does voltage drop mean wasted energy?',
      a: 'Some energy is lost as heat along the run; BS 7671 limits voltage drop to protect performance and safety.',
    },
    {
      q: 'How do I know if losses are excessive?',
      a: 'Look for: warm cables under normal load, discoloured terminations, humming transformers, higher than expected energy bills, frequent protective device operation.',
    },
    {
      q: "What's the most common cause of high losses in domestic installations?",
      a: 'Undersized cables for long runs (especially to outbuildings), loose connections, and old inefficient equipment like tungsten lamps and motors.',
    },
    {
      q: 'Can grouping cables increase losses?',
      a: 'Yes. Grouped cables run hotter, increasing resistance and losses. BS 7671 requires derating factors to account for this.',
    },
    {
      q: 'How does ambient temperature affect losses?',
      a: 'Higher ambient temperature increases conductor resistance, leading to higher losses. This is why cables have current ratings based on reference conditions.',
    },
    {
      q: 'Are harmonics related to losses?',
      a: 'Yes. Harmonic currents from electronic loads increase heating in neutral conductors and transformers, requiring special consideration in design.',
    },
  ];
  ...
  const quizQuestions = [
    {
      ...
      options: [
        ...
        'Current flowing through the conductor resistance',
        'The voltage being too low for the load',
        'The supply frequency being 50 Hz',
      ],
      correctAnswer: 1,
    ...
    },
    {
      id: 2,
      question:
        'A long circuit is close to voltage drop limits. What design change best reduces losses?',
      options: [
        'More bends',
        'Smaller cable size',
        'Larger cable size',
    ...
    },
    {
      ...
      options: [
        'A reduction in the overall circuit current',
        'A lower supply voltage at the origin',
        'An increase in the cable cross-sectional area',
        'Localised overheating and damage at the joint',
      ],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [
        'It increases the current for the same useful output',
        'It lowers the resistance of the conductor',
        'It reduces the load drawn by the equipment',
        'It raises the supply voltage at the origin',
      ],
      correctAnswer: 0,
      explanation:
        'Lower power factor means more current for the same useful power, so more heating in conductors.',
    },
    {
      id: 5,
      question: 'Which practice helps reduce standby (phantom) losses?',
      options: [
        'Leave devices on 24/7',
        'Use smart sockets/timers',
        'Reduce ventilation',
        'Use longer cables',
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      correctAnswer: 3,
      explanation:
        'Higher temperature increases resistance in copper and aluminium conductors, creating more losses.',
    },
    {
      id: 8,
      question: 'Which connection method typically has the lowest losses?',
      options: [
        'Properly torqued screw terminals',
        'Loosely tightened terminal screws',
        'Conductors twisted together by hand',
        'Corroded or dirty terminal contacts',
      ],
      correctAnswer: 0,
      explanation:
        'Properly made screw terminals provide good contact area and low resistance when correctly torqued.',
    },
    {
      id: 9,
      ...
      correctAnswer: 1,
      explanation:
        'Core losses are constant, but copper losses (I²R) increase with loading. Total losses peak at full load.',
    },
    {
      id: 10,
      question: 'Which installation factor most increases cable losses?',
      options: [
        'A short cable run in cool, open air',
        'Generous spacing between separate cables',
        'High ambient temperature and tight grouping',
        'A larger conductor cross-sectional area',
      ],
      correctAnswer: 2,
      explanation:
        'High ambient temperature and cable grouping both increase operating temperature, which increases resistance and losses.',
    },
  ] as const;
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-base sm:text-lg text-white max-w-2xl mx-auto">
            Where energy goes when it is not doing useful work, how to spot problem areas, and
            practical ways to keep losses low
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  Most unwanted loss shows up as heat in cables, transformers, motors and
                  terminations.
                </li>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Warm cables, discoloured terminations, humming
                  transformers, devices warm when idle.
                </li>
                <li>
                  <strong>Use:</strong> Choose suitable cable sizes, routes and efficient equipment.
                </li>
                <li>
                  <strong>Check:</strong> Torque settings, grouping, ambient temperature and
                  ventilation.
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
            ...
            <li>
              Explain why long runs, small conductors and loose terminations increase heating.
            </li>
            <li>Relate losses to current draw, voltage drop, equipment life and energy cost.</li>
            <li>
              Apply BS 7671 context: current‑carrying capacity, voltage drop limits and connection
              quality.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <Plug className="w-5 h-5" /> Common losses you will see
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
              <li>
                <strong>Cable heating:</strong> All cables have some resistance. More current and
                longer runs mean more heat and voltage drop.
              </li>
              <li>
                <strong>Loose/dirty terminations:</strong> Poor contact area increases local heating
                and risk of damage or fire.
              </li>
              <li>
                <strong>Transformer and motor losses:</strong> Heat in windings and magnetic parts;
                motors also have mechanical losses.
              </li>
              <li>
                <strong>Electronics and drivers:</strong> Power supplies waste some energy as heat;
                many draw small power even when “off”.
              </li>
              <li>
                <strong>Parasitic (standby) loads:</strong> Devices left on or on standby use energy
                continuously.
              </li>
              <li>
                <strong>Power factor issues:</strong> Poor power factor means higher current for the
                same useful output, adding heating in cables.
              </li>
              <li>
                <strong>Environment and installation:</strong> High ambient temperature, tight
                grouping and insulation reduce heat dissipation.
              </li>
            </ul>
          </section>
          ...
          <InlineCheck
            ...
            options={[
              'Cool ambient and short run',
              'Tightly grouped long run with small CSA',
              'Clean, tight terminations',
              'Ventilated trunking with spare space',
            ]}
            correctIndex={1}
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <Settings className="w-5 h-5" /> Practical ways to reduce losses
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
              <li>
                Use suitable cable size for run length and load; avoid unnecessary long routes.
              </li>
              <li>Follow torque settings; keep terminations clean and well‑made.</li>
              <li>
                Allow for ambient temperature, grouping and insulation (derating as required).
              </li>
              <li>
                Select efficient equipment (motors, transformers, LED drivers) and consider power
                factor on larger systems.
              </li>
              <li>Control standby loads with timers/smart sockets; switch off when not needed.</li>
              <li>
                Provide ventilation and keep enclosures within manufacturer temperature limits.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-6">
            ...
            <ul className="space-y-4 text-xs sm:text-sm text-white">
              <li className="rounded-lg p-4 bg-gradient-to-r from-elec-yellow/10 to-elec-yellow/10 border border-border/30">
                ...
                <p>
                  A small cable over a long distance feeds outdoor sockets. Users report warm cable
                  and dim lights under load. Upgrading cable size and route reduces heating and
                  voltage drop.
                </p>
              </li>
              <li className="rounded-lg p-4 bg-gradient-to-r from-elec-yellow/10 to-elec-yellow/10 border border-elec-yellow/30">
                ...
                <p>
                  Brown discolouration is seen on a terminal. Re‑make the joint to the correct
                  torque and check adjacent connections for damage or heat marks.
                </p>
              </li>
              <li className="rounded-lg p-4 bg-gradient-to-r from-amber-500/10 to-amber-600/10 border border-amber-400/30">
                ...
                <p>
                  Printers, screens and chargers are left on 24/7. Fitting smart sockets and timers
                  cuts wasted energy and heat build‑up overnight.
                </p>
              </li>
              <li className="rounded-lg p-4 bg-gradient-to-r from-purple-500/10 to-purple-600/10 border border-border/30">
                ...
                <p>
                  <strong>Scenario:</strong> 2.5mm² ring main serving kitchen with multiple
                  high-power appliances. Cable runs warm, frequent MCB trips.
                </p>
                <p>
                  <strong>Solution:</strong> Split load across additional radial circuits, upgrade
                  to larger CSA where needed, check connection integrity.
                </p>
              </li>
              <li className="rounded-lg p-4 bg-gradient-to-r from-rose-500/10 to-rose-600/10 border border-rose-400/30">
                ...
                <p>
                  <strong>Problem:</strong> 15kW motor cable runs very warm, high energy bills,
                  motor performance poor.
                </p>
                <p>
                  <strong>Analysis:</strong> 50m run using 6mm² cable. Cable losses ≈ 3% voltage
                  drop, motor efficiency drops, higher current drawn.
                </p>
                <p>
                  <strong>Solution:</strong> Upgrade to 10mm² cable reduces voltage drop to 1.8%,
                  cooler operation, better motor performance.
                </p>
              </li>
            </ul>
          </section>
          ...
          <section className="mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
              <div className="rounded-lg p-4 bg-gradient-to-br from-orange-500/10 to-red-500/10 border border-border/30">
                <h4 className="font-medium mb-2 text-orange-700 text-elec-yellow">
                  Temperature effects
                </h4>
              ...
              <div className="rounded-lg p-4 bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-border/30">
                <h4 className="font-medium mb-2 text-purple-700 text-elec-yellow">
          ...
          <section className="mb-6">
            ...
            <div className="rounded-lg p-4 bg-gradient-to-r from-green-500/10 to-elec-yellow/10 border border-green-400/30">
              <p className="text-sm mb-3">
                Understanding the financial impact helps justify better design and installation
                practices:
              </p>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2">
              Identifying and troubleshooting excessive losses
            </h3>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg p-4 bg-gradient-to-r from-elec-yellow/10 to-cyan-500/10 border border-border/30">
                ...
                <ol className="list-decimal pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Visual inspection:</strong> Look for signs of overheating, damage, poor
                    workmanship
                  </li>
                  <li>
                    <strong>Thermal imaging:</strong> Identify hot spots in cables, connections,
                    equipment
                  </li>
                  <li>
                    <strong>Electrical measurements:</strong> Check voltage drop, current imbalance,
                    resistance values
                  </li>
                  <li>
                    <strong>Load analysis:</strong> Verify actual vs designed loading, identify
                    phantom loads
                  </li>
                  <li>
                    <strong>Environmental check:</strong> Ambient temperature, ventilation, cable
                    grouping
                  </li>
                </ol>
              </div>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <Settings className="w-5 h-5" /> Advanced loss reduction strategies
            </h3>
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
              ...
              <div className="rounded-lg p-4 bg-gradient-to-br from-elec-yellow/10 to-elec-yellow/5 border border-elec-yellow/30">
                <p className="font-medium mb-2 text-elec-yellow text-elec-yellow">
          ...
          <section className="mb-6">
            ...
            <div className="rounded-lg p-4 bg-gradient-to-r from-slate-500/10 to-slate-600/10 border border-slate-400/30">
              ...
              <p className="mb-2">
                <strong>Scenario:</strong> 25A load, 30m run, 4mm² T&E cable (resistance ≈ 4.6mΩ/m)
              </p>
              <p className="mb-2">
                <strong>Cable resistance:</strong> 30m × 4.6mΩ/m × 2 (live + neutral) = 0.276Ω
              </p>
              <p className="mb-2">
                <strong>Power loss:</strong> I²R = 25² × 0.276 = 173W
              </p>
              <p className="mb-2">
                <strong>Voltage drop:</strong> IR = 25 × 0.276 = 6.9V (3% at 230V)
              </p>
              <p className="text-amber-700 dark:text-amber-300">
                <strong>Impact:</strong> 173W constant heat generation, reduced performance at load
                end.
              </p>
            </div>
          </section>
          ...
          <InlineCheck
            ...
            options={[
              'Reduce cable CSA',
              'Increase cable CSA or shorten the run',
              'Add more bends',
              'Ignore it if devices still work',
            ]}
            correctIndex={1}
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <Gauge className="w-5 h-5" /> BS 7671 context and good practice
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
              <li>
                Current‑carrying capacity and correction factors: Appendix 4 (ambient, grouping,
                thermal insulation).
              </li>
              <li>
                Voltage drop limits for final circuits: follow BS 7671 guidance to protect
                performance and safety.
              </li>
              <li>
                Connections: workmanship and accessibility matter; poor joints are a common source
                of overheating.
              </li>
            </ul>
            <div
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/apprentice/level2/module2/section6/6-3">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous
            </Link>
          </Button>
