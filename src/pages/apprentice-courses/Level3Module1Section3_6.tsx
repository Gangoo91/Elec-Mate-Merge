...
const DESCRIPTION =
  'Learn about Residual Current Devices (RCDs), their operation principles, types, testing requirements, and coordination with other protective devices.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "An RCD compares the current flowing in the line conductor with the current returning in the neutral. If they're not equal, current must be leaking to earth (possibly through a person). The RCD detects this imbalance and disconnects.",
  },
  {
    id: 'check-2',
    question: 'A 30mA RCD must trip within what time when tested at its rated current?',
    options: ['300ms (0.3 seconds)', '200ms (0.2 seconds)', '40ms (0.04 seconds)', '1 second'],
    correctIndex: 0,
    explanation:
      'At rated residual current (30mA), an RCD must trip within 300ms. However, at 5 times rated current (150mA), it must trip within 40ms. The faster tripping at higher fault currents provides better protection during more severe faults.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 1,
    explanation:
      'Electronic equipment often has intentional earth leakage through RFI filters. Long cable runs have capacitive leakage. Multiple circuits on one RCD can accumulate enough leakage to approach the trip threshold. Circuit design must account for this.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      'An RCBO (Residual Current Breaker with Overcurrent protection) combines an RCD and MCB in a single device. This provides both earth fault protection AND overcurrent/short-circuit protection, offering individual circuit protection without affecting other circuits.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "RCD stands for Residual Current Device. 'Residual' refers to the residual (remaining) current that should be zero if all current leaving via line returns via neutral. Any residual current indicates earth leakage.",
  },
  {
    id: 2,
    question: 'At what current level must a 30mA RCD trip within 40ms?',
    options: ['30mA', '15mA', '150mA (5 x rated)', '300mA'],
    correctAnswer: 2,
    explanation:
      'An RCD must trip within 40ms when tested at 5 times its rated residual current (5 x 30mA = 150mA). This ensures fast disconnection during more severe faults. The 300ms limit applies at rated current (30mA).',
  },
  {
    id: 3,
    question:
      'What type of RCD is required for circuits that may have DC components in the earth fault current?',
    options: ['Type AC', 'Type A', 'Type B', 'Type S'],
    correctAnswer: 2,
    explanation:
      "Type B RCDs detect AC, pulsating DC, and smooth DC residual currents. They're required where DC fault currents might occur, such as circuits supplying certain EV chargers, inverters, or variable speed drives. Type A only detects AC and pulsating DC.",
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      "RCD test buttons should be operated quarterly (every 3 months) by the user. This verifies the mechanical trip mechanism is working. It doesn't test the trip current or time - that requires proper test instruments - but confirms the device can physically disconnect.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      "Type S (time-delayed or selective) RCDs have a built-in delay allowing downstream instantaneous RCDs to trip first. This provides discrimination - only the affected circuit trips, not the entire installation. They're typically rated at 100mA or 300mA.",
  },
  {
    id: 6,
    question: 'What rating RCD provides additional protection against electric shock?',
    options: ['100mA', '300mA', '30mA or less', '500mA'],
    correctAnswer: 2,
    explanation:
      '30mA (or lower) RCDs provide additional protection against electric shock by limiting the earth fault current duration and magnitude. BS 7671 requires 30mA RCDs for circuits where the risk of direct contact shock is highest (socket outlets, outdoor circuits, bathrooms).',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      "RCDs detect imbalance between line and neutral currents. In a line-to-neutral fault, current flows out on line and returns on neutral - they're equal, so no imbalance exists. Overcurrent devices (MCBs, fuses) protect against these faults.",
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      "If the neutral is lost, the RCD has no return current to compare against the line current. It cannot detect earth faults because it can't measure the imbalance. This is why broken neutrals are dangerous - protection is lost.",
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'RCDs must trip between 50% and 100% of their rated residual current. For a 30mA RCD, this means it must trip somewhere between 15mA and 30mA. Tripping at 22mA is within this range and indicates correct operation.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'An RCCB (Residual Current Circuit Breaker) provides earth fault protection only. It does NOT provide overcurrent protection. It must be used in conjunction with an MCB or fuse for complete circuit protection. RCBOs combine both functions.',
  },
  {
    id: 11,
    question:
      "A 100mA RCD at the origin is being bypassed by an earth fault on a circuit with a 30mA RCD. What's happening?",
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "If the fault current is, say, 50mA - this exceeds the 30mA threshold (trips) but is below the 100mA threshold (doesn't trip). This is normal discrimination. For better discrimination, use a time-delayed (Type S) RCD at the origin.",
  },
  {
    id: 12,
    question:
      'What test should be performed on an RCD to verify it trips at the correct current level?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Instrument testing applies known currents (typically 50%, 100%, and 500% of rated) and measures trip times. This verifies the RCD trips at the correct current and within required times. The test button only checks mechanical function, not calibration.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Detection:</strong> RCDs sense imbalance between line and neutral (earth
                leakage)
              </li>
              <li>
                <strong>30mA:</strong> Provides additional shock protection - required for most
                circuits
              </li>
              <li>
                <strong>Types:</strong> AC (basic), A (pulsating DC), B (smooth DC), S
                (time-delayed)
              </li>
              <li>
                <strong>Testing:</strong> Button quarterly, instrument test at inspection
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> RCDs in consumer units, test buttons, rating labels
              </li>
              <li>
                <strong>Test:</strong> Press test button, use RCD tester at inspection
              </li>
              <li>
                <strong>Know:</strong> What type (AC/A/B), what rating (30/100/300mA)
              </li>
              <li>
                <strong>Check:</strong> Trip time and current during formal testing
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              An RCD continuously compares the current flowing out through the line conductor with
              the current returning through the neutral. In a healthy circuit, these should be equal
              - all current that goes out comes back. If they're not equal, current must be leaking
              somewhere - possibly through a person to earth.
            </p>
            <p>
              The RCD contains a current transformer (toroidal core) through which both line and
              neutral pass. If currents are equal, the magnetic fields cancel out and no current
              flows in the sensing coil. If there's an imbalance (residual current), a voltage is
              induced that triggers the trip mechanism.
            </p>
            ...
            <div className="my-6 p-4 rounded bg-white/5 border-l-2 border-elec-yellow">
              ...
              <ul className="text-sm text-white/90 space-y-1">
                ...
                <li>
                  <strong>Fault:</strong> 10A flows out on line, 9.97A returns on neutral = 30mA to
                  earth = TRIP
                </li>
                <li>
                  The 30mA leaking to earth could be through a faulty appliance - or through a
                  person
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> RCDs detect earth leakage, not overcurrent. They provide
              additional protection against shock, not replacement for other protective measures.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              RCDs come in different types designed to detect different waveforms of residual
              current. As electrical loads become more complex (electronic drives, EV chargers), the
              type of RCD matters more than ever.
            </p>
            ...
            <div className="my-6 p-4 rounded bg-white/5">
              ...
              <div className="grid grid-cols-3 gap-4 text-sm text-white/90">
                <div>
                  ...
                  <p>
                    Additional shock protection. Required for socket outlets, outdoors, bathrooms,
                    etc.
                  </p>
                </div>
                <div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              RCDs must be tested regularly to ensure they work when needed. There are two types of
              testing: the user test (pushing the button) and the instrument test (measuring trip
              current and time).
            </p>
            ...
            <div className="my-6 p-4 rounded bg-elec-yellow/5 border border-elec-yellow/20">
              <p className="text-sm font-medium text-elec-yellow mb-3">
                Trip Time Requirements (30mA RCD)
              </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Important:</strong> Testing creates an actual earth fault. Warn the user that
              connected equipment will lose power. Ensure nothing critical (computers, life support)
              is running. Reset the RCD after each test.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Good circuit design ensures that only the affected circuit trips during a fault
              (discrimination), and minimises nuisance tripping from normal equipment operation.
              Poor design causes widespread outages and frustrated users who may then bypass
              protection.
            </p>
            ...
            <div className="my-6 p-4 rounded bg-white/5 border-l-2 border-elec-yellow">
              ...
              <ul className="text-sm text-white/90 space-y-1">
                ...
                <li>
                  <strong>Use RCBOs</strong> - each circuit has individual protection
                </li>
                <li>
                  <strong>Find faulty equipment</strong> - disconnect items one by one to identify
                  leaky appliances
                </li>
                <li>
                  <strong>Check for moisture</strong> - outdoor accessories, underground cables
                </li>
                <li>
                  <strong>Don't increase rating</strong> - 30mA is required where specified, use
                  correct solutions
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-white/90 italic">
              ...
              Moving to individual RCBOs or splitting across two RCDs solves the problem without
              reducing protection.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p className="text-sm">
              BS 7671 specifies where 30mA RCD protection is required for additional protection
              against electric shock. The requirements have expanded in recent editions.
            </p>
            ...
            <div className="my-6 p-4 rounded bg-white/5">
              ...
              <ul className="text-sm text-white/90 space-y-1">
                ...
                <li>
                  Cables installed less than 50mm from the wall surface without mechanical
                  protection
                </li>
                <li>
                  Cables installed in walls at any depth without mechanical protection or within
                  prescribed zones
                </li>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Won't reset</strong> - fault on circuit, or RCD itself faulty
                </li>
                <li>
                  <strong>Trips on test button but not instrument test</strong> - may be faulty
                </li>
                <li>
                  <strong>Trips at less than 50%</strong> - may be over-sensitive (check
                  manufacturer specs)
                </li>
                <li>
                  <strong>Doesn't trip at 100%</strong> - definitely faulty, replace immediately
                </li>
                <li>
                  <strong>Trips too slowly</strong> - may be faulty or wrong type specified
                </li>
              </ul>
            </div>
          </div>
