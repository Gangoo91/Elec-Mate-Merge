...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['5-15 seconds', '5-10 minutes', 'Instantaneous', '1-2 minutes'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1-2 minutes', '8 hours', '1-2 hours', '5-15 minutes'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              stationary secondary batteries — and per Reg 560.6.12 must conform to BS EN 50171 in
              addition to the BS EN [IEC] 62040 series. Standby UPS for general IT/business
              continuity sits outside Chapter 56, but the safety-services compliance check is always
              the designer’s call.
            </>
          }
        ...
        <ConceptBlock title="UPS Types and Topologies">
          ...
          <p>
            <strong>Application guide:</strong> Use online UPS for critical IT, medical and process
            loads. Line-interactive suits general commercial. Offline only for basic desktop
            protection.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Battery Sizing">
          <p>
            Battery capacity determines UPS autonomy time — how long the system can support the load
            without mains power. Correct sizing balances autonomy requirements against cost and
            space constraints.
          </p>
          <p>
        ...
        <ConceptBlock title="Generator Coordination">
          ...
          <p>
            <strong>Coordination tip:</strong> Specify generator with electronic governor for stable
            frequency. Older mechanical governors may not meet UPS input requirements.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Automatic Transfer Systems">
          <p>
            Automatic Transfer Switches (ATS) manage the changeover between normal and standby power
            supplies. They are essential for coordinating mains, generator and UPS systems in
            resilient power architectures.
          </p>
          <p>
          ...
          <p>
            <strong>Closed transition:</strong> Requires synchronisation between sources. Used where
            any break is unacceptable, but more complex and costly.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              backup. Critical load 60 kW @ 0.95 PF, mechanical cooling 25 kW (also critical during
              outage), small power 8 kW. Site has a single DNO supply. Battery room can hold ~1,000
              kg of VRLA cells. You’re sizing UPS, generator and ATS for the design review.
            </>
          }
          whatToDo={
            <>
              UPS: online double-conversion, modular 2× 80 kVA in N+1 (one carries full load, second
              is redundant). Battery autonomy: generator typically starts and accepts load in 30 s,
              but allow 5 min for resilience and to ride through brief faults without runtime
              depletion. Generator: critical 85 kW + cooling 25 kW + small power 8 kW = 118 kW; add
              UPS recharge load (≈ 25 % of UPS rating ≈ 40 kW for first 30 min) and 25 % engineering
              margin → 200 kVA prime-rated set. ATS: 4-pole, mechanically interlocked, with
              adjustable retransfer delay (typically 5 min) to stop the generator hunting if the DNO
              supply is unstable. Spec the UPS to BS EN [IEC] 62040 (plus BS EN 50171 if any safety
              load is hung off it). Battery room conditioned to 20–25 °C — VRLA life halves for
              every 10 °C above 25. Step-load test the generator at commissioning. All this lands on
              the load schedule with a clear ATS sequence-of-operation diagram in the O&amp;M.
            </>
          }
          whyItMatters={
            <>
              Most outages aren’t loss of supply — they’re an underspecified ATS that hunts on a
              noisy DNO, or a generator that can’t carry UPS recharge load and trips on overload at
              the worst moment. Coordination is the deliverable, not the kit.
            </>
          }
        />
