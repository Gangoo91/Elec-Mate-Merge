...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Synchronous speed Ns = (120 x f) / p = (120 x 50) / 4 = 6000 / 4 = 1500 rpm. The formula uses pole pairs, so 4 poles gives 1500 rpm.',
  },
  {
    question:
      'An induction motor runs at 1440 rpm when the synchronous speed is 1500 rpm. What is the slip?',
    options: ['4%', '6%', '96%', '2%'],
    correctIndex: 0,
    explanation:
      'Slip s = (Ns - Nr) / Ns = (1500 - 1440) / 1500 = 60 / 1500 = 0.04 = 4%. This is typical for a loaded motor.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'The commutator is a mechanical rectifier that reverses connections to the armature coils at the correct moment, converting the AC generated in the armature to DC at the brushes.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Synchronous motors run at exactly synchronous speed (Ns = 120f/p) with no slip. They require separate DC excitation and starting means.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      'Ns = 120 x 50 / 4 = 1500 rpm. Nr = Ns x (1 - s) = 1500 x (1 - 0.03) = 1500 x 0.97 = 1455 rpm.',
  },
  {
    ...
    options: [
      ...
      'Motor runs at rated power',
      'Motor reverses direction',
    ],
    correctIndex: 1,
    explanation:
      'At synchronous speed, there is no relative motion between rotor and rotating field, so no EMF is induced in rotor conductors and no torque is produced. Some slip is essential.',
  },
  {
    question: 'In a DC motor, what determines the direction of rotation?',
    options: [
      'Supply frequency',
      'Relative polarity of field and armature current',
      'Speed of rotation',
      'Type of winding',
    ],
    correctIndex: 1,
    explanation:
      "Direction is determined by Fleming's left-hand rule: the interaction between field flux and armature current. Reversing either field OR armature polarity reverses rotation; reversing both maintains direction.",
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Auto-transformer starting provides reduced voltage while maintaining good torque/current ratio. Suitable for large motors where DOL current would be excessive but good starting torque is needed.',
  },
  {
    question:
      'A DC shunt motor runs at 1200 rpm with 200V supply. If field resistance increases, what happens?',
    options: ['Speed decreases', 'Speed increases', 'Speed stays same', 'Motor stops'],
    correctIndex: 1,
    explanation:
      'Increasing field resistance reduces field current and flux. With reduced flux, back EMF drops, armature current increases, and the motor speeds up to restore back EMF. This is field weakening.',
  },
  {
    question: 'What is the purpose of damper windings in a synchronous motor?',
    options: [
      'To improve power factor',
      'To enable starting and prevent hunting',
      'To reduce losses',
      'To increase voltage',
    ],
    correctIndex: 1,
    explanation:
      'Damper windings (amortisseur windings) allow the motor to start like an induction motor. Once running, they dampen oscillations (hunting) when load changes occur.',
  },
  {
    question: 'In a 3-phase induction motor, how is the rotating magnetic field created?',
    options: [
      'By DC excitation',
      'By the 120 degree phase displacement of 3-phase currents',
      'By mechanical rotation',
      'By capacitor phase shift',
    ],
    correctIndex: 1,
    explanation:
      'The three phases, displaced 120 degrees in time and space, create currents that produce a smoothly rotating magnetic field at synchronous speed, without mechanical movement.',
  },
  {
    ...
    options: [
      'Higher efficiency',
      'Lower cost',
      'External resistance can control starting current and torque',
      'No maintenance required',
    ],
    correctIndex: 2,
    explanation:
      'Wound rotor motors allow external resistors to be connected via slip rings. This limits starting current while providing high starting torque, and enables speed control.',
  },
  {
    question:
      'Calculate the frequency of rotor currents in a motor with 4% slip running on 50 Hz supply.',
    options: ['50 Hz', '48 Hz', '2 Hz', '52 Hz'],
    correctIndex: 2,
    explanation:
      'Rotor frequency fr = s x f = 0.04 x 50 = 2 Hz. At standstill (s = 1), rotor frequency equals supply frequency. At running speed, it is much lower.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'For a generator, f = (p x N) / 120. Rearranging: N = (120 x f) / p = (120 x 50) / 8 = 750 rpm.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'DC shunt motors have field winding in parallel with armature, so field flux is nearly constant. This gives excellent speed regulation - speed varies only slightly with load changes.',
  },
];
...
const faqItems = [
  {
    ...
    answer:
      'Induction motors work by electromagnetic induction - the rotating stator field must cut across rotor conductors to induce current. If the rotor ran at synchronous speed, there would be no relative motion, no induced EMF, no rotor current, and therefore no torque. Slip ensures continuous relative motion between field and rotor.',
  },
  {
    question: 'What is the difference between a motor and a generator?',
    answer:
      'Both are rotating machines with similar construction. A motor converts electrical energy to mechanical energy (current flows in, shaft rotates). A generator converts mechanical energy to electrical (shaft driven, current flows out). The same machine can operate as either, depending on energy flow direction.',
  },
  {
    question: 'Why are DC motors still used when AC is more common?',
    answer:
      'DC motors offer excellent speed control over a wide range, high starting torque (especially series motors), and simple reversing. They are used in traction (trains, lifts), cranes, and applications needing precise speed control. Modern power electronics make DC motor control even more versatile.',
  },
  {
    question: 'How does a variable frequency drive (VFD) control motor speed?',
    answer:
      'A VFD converts fixed-frequency AC to variable-frequency AC. Since synchronous speed Ns = 120f/p, changing frequency changes speed. The VFD also adjusts voltage proportionally (V/f ratio) to maintain constant flux and torque capability. This is the most efficient method of speed control.',
  },
  {
    question: 'What causes a motor to overheat?',
    answer:
      'Common causes include: overloading beyond rated capacity, low voltage (higher current for same torque), poor ventilation or blocked cooling, single-phasing (one phase lost), high ambient temperature, frequent starting, and bearing failures causing increased friction. Protection devices should prevent damage.',
  },
  {
    question: 'Why is power factor correction important for motors?',
    answer:
      'Induction motors draw reactive (magnetising) current, giving power factors of 0.8-0.9 at full load, worse at light loads. Poor power factor means higher current for the same power, increasing cable losses and potentially incurring utility penalties. PFC capacitors are often installed at motor terminals.',
  },
];
            ...
            <div className="bg-[#242424] rounded-lg p-6 border border-white/10">
              ...
              <div className="space-y-4 mb-4">
                <div className="bg-[#1a1a1a] rounded-lg p-4">
                  ...
                  <ul className="text-white/70 text-sm space-y-1 ml-4">
                    ...
                    <li>
                      <strong>Variable speed</strong> - speed varies greatly with load
                    </li>
                    <li>
                      <strong>Danger!</strong> Never run unloaded - can overspeed destructively
                    </li>
                ...
                <div className="bg-[#1a1a1a] rounded-lg p-4">
                  ...
                  <ul className="text-white/70 text-sm space-y-1 ml-4">
                    ...
                    <li>
                      <strong>Moderate starting torque</strong> - torque proportional to armature
                      current
                    </li>
                ...
                <div className="bg-[#1a1a1a] rounded-lg p-4">
                  ...
                  <ul className="text-white/70 text-sm space-y-1 ml-4">
                    ...
                    <li>
                      <strong>Good starting torque</strong> with reasonable speed regulation
                    </li>
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 mb-4">
                ...
                <ul className="text-white/80 space-y-2">
                  ...
                  <li>
                    <strong>Field weakening:</strong> Increase field resistance to reduce flux.
                    Speed increases. Torque reduces.
                  </li>
                  <li>
                    <strong>Armature resistance:</strong> Add series resistance. Speed reduces but
                    very inefficient (I squared R losses).
                  </li>
                </ul>
              </div>
              ...
              <InlineCheck
                ...
                options={[
                  ...
                  'Speed decreases',
                  'Motor runs away to dangerous speed',
                  'Nothing - motor continues normally',
                ]}
                correctIndex={2}
            ...
            <div className="bg-[#242424] rounded-lg p-6 border border-white/10">
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 mb-4">
                ...
                <ul className="text-white/80 space-y-2">
                  ...
                  <li>
                    <strong>Voltage:</strong> Controlled by field current (excitation)
                  </li>
                  <li>
                    <strong>Synchronisation:</strong> Must match voltage, frequency, phase sequence
                    and phase angle before connecting to grid
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 mb-4">
                ...
                <ul className="text-white/80 space-y-2">
                  ...
                  <li>
                    <strong>Self-excited:</strong> Field powered from generator output. Shunt,
                    series or compound types.
                  </li>
                  <li>
                    <strong>Voltage:</strong> E = K x Phi x N (proportional to flux and speed)
                  </li>
                </ul>
              </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-yellow-900/30 border border-yellow-500/50 rounded-lg p-6">
              ...
              <ul className="text-white/80 space-y-2">
                ...
                <li>
                  <strong>Protection:</strong> Overcurrent, thermal overload, single-phase
                  protection for 3-phase motors. Consider earth fault and stall protection.
                </li>
                <li>
                  <strong>Cable sizing:</strong> Account for starting current (voltage drop) and
                  running current (thermal). Use correction factors from BS 7671.
                </li>
                <li>
                  <strong>Earthing:</strong> Motor frame must be earthed. Use protective conductors
                  sized per BS 7671 Table 54.7.
                </li>
                <li>
                  <strong>Maintenance:</strong> Regular checks of insulation resistance, bearing
                  condition, ventilation and alignment. Vibration monitoring for critical motors.
                </li>
              </ul>
            </div>
          </div>
