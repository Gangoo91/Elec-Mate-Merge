...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['W/m²K', 'kW/m²K', 'W/mK', 'kJ/m²K'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['15 m³/h/m² @ 50Pa', '5 m³/h/m² @ 50Pa', '10 m³/h/m² @ 50Pa', '3 m³/h/m² @ 50Pa'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The NCM is the sole approved route. Hand calculations or spreadsheet shortcuts are not
              accepted by Building Control. The accredited assessor must use approved software
              (iSBEM, EDSL TAS, IES VE etc.) and submit the design-stage and as-built outputs as
              part of the Part L evidence pack.
            </>
          }
        ...
        <ConceptBlock title="SBEM Fundamentals and NCM Methodology">
          <p>
            ...
            calculating the energy performance of non-domestic buildings and demonstrating
          ...
          <p>
            <strong>Key SBEM concepts:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>BER:</strong> Building Emission Rate - calculated CO₂ emissions for the actual
              building
            </li>
            <li>
          ...
          <p>
            <strong>SBEM Calculation Process</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Geometry Input:</strong> Define zones, areas, orientations — Building
              thermal model
            </li>
            <li>
              <strong>2. Fabric Specification:</strong> Enter U-values, thermal mass, air tightness
              — Heat loss calculations
            </li>
            <li>
              <strong>3. Services Input:</strong> Define HVAC, lighting, hot water systems — System
              energy demands
            </li>
            <li>
              <strong>4. Renewables:</strong> Add PV, solar thermal, other renewables — Energy
              offset calculation
            </li>
            <li>
              <strong>5. Compliance Check:</strong> Compare BER against TER — Pass/fail and EPC
              rating
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Building Geometry and Fabric Inputs">
          <p>
            ...
            building is divided into thermal zones, each with defined areas, construction types, and
            environmental control requirements.
          </p>
          <p>
            <strong>Geometric Inputs</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Part L 2021 Fabric Standards</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>External wall:</strong> 0.35 W/m²K — 0.26 W/m²K — 0.15-0.20 W/m²K
            </li>
            <li>
              <strong>Flat roof:</strong> 0.25 W/m²K — 0.18 W/m²K — 0.10-0.15 W/m²K
            </li>
            <li>
              <strong>Ground floor:</strong> 0.25 W/m²K — 0.18 W/m²K — 0.10-0.15 W/m²K
            </li>
            <li>
              <strong>Windows:</strong> 1.60 W/m²K — 1.40 W/m²K — 0.80-1.20 W/m²K
            </li>
            <li>
              <strong>Air permeability:</strong> 10 m³/h/m² — 5 m³/h/m² — 3 m³/h/m²
            </li>
          </ul>
          <p>
            <strong>Zoning principle:</strong> Divide the building into zones with similar activity
            type, HVAC system, and solar exposure for accurate modelling.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Services Inputs">
          ...
          <p>
            <strong>HVAC System Inputs</strong>
          </p>
          <p>
            <span>System type:</span> Boiler, heat pump, VRF, chiller, etc.
          </p>
          <p>
            <span>Heating efficiency:</span> Seasonal efficiency (%) or SCOP
          </p>
          <p>
            <span>Cooling efficiency:</span> Seasonal EER or SEER
          </p>
          <p>
            <span>Fuel type:</span> Natural gas, electricity, oil, biomass
          </p>
          <p>
            <span>Distribution:</span> Pipework/ductwork losses, pump/fan powers
          </p>
          <p>
            <span>Controls:</span> Weather compensation, optimum start, zoning
          </p>
          <p>
            <strong>Lighting Inputs</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Typical Lighting Power Densities</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Office - general:</strong> 12 W/m² — 8-10 W/m² — 6-8 W/m²
            </li>
            <li>
              <strong>Classroom:</strong> 14 W/m² — 10-12 W/m² — 8-10 W/m²
            </li>
            <li>
              <strong>Retail - general:</strong> 18 W/m² — 12-15 W/m² — 10-12 W/m²
            </li>
            <li>
              <strong>Circulation:</strong> 8 W/m² — 5-6 W/m² — 3-5 W/m²
            </li>
            <li>
              <strong>Warehouse:</strong> 6 W/m² — 4-5 W/m² — 2-4 W/m²
            </li>
          </ul>
          <p>
            <strong>HVAC Efficiency Standards</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Gas boiler:</strong> 91% gross — 95%+ condensing
            </li>
            <li>
              <strong>Air source heat pump:</strong> SCOP 2.8 — SCOP 3.5-4.0
            </li>
            <li>
              <strong>Ground source heat pump:</strong> SCOP 3.5 — SCOP 4.0-4.5
            </li>
            <li>
              <strong>Air-cooled chiller:</strong> SEER 3.0 — SEER 4.0+
            </li>
            <li>
              <strong>VRF system:</strong> SCOP 3.2 / SEER 4.5 — SCOP 4.0 / SEER 6.0
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="BER, TER and Compliance Demonstration">
          <p>
            ...
            the Target Emission Rate (TER). The TER is derived from a notional building - a
            reference design with the same geometry but standardised fabric and services
            specifications.
          </p>
          <p>
          ...
          <p>
            <strong>Target Emission Rate (TER)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Building Emission Rate (BER)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Compliance Margin Calculation</strong>
          </p>
          ...
          <p>
            Margin = (25.5 - 22.3) / 25.5 × 100 = <span>12.5% improvement</span>
          </p>
          <p>
            <strong>Renewable Energy Contributions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Roof-mounted PV:</strong> kWp, orientation, tilt, shading — 5-15% BER
              reduction
            </li>
            <li>
              <strong>Solar thermal (DHW):</strong> Collector area, storage volume — 2-5% BER
              reduction
            </li>
            <li>
              <strong>Biomass boiler:</strong> Low carbon factor for fuel — 30-50% BER reduction
            </li>
            <li>
              <strong>Wind turbine:</strong> Rated output, hub height — Variable by location
            </li>
            <li>
              <strong>CHP (Combined Heat and Power):</strong> Electrical/thermal efficiency — 10-25%
              BER reduction
            </li>
          </ul>
          <p>
            <strong>SBEM Output Documents</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BRUKL document:</strong> Building Regulations UK Part L - detailed compliance
              report
            </li>
            <li>
            ...
            <li>
              <strong>Recommendations report:</strong> Improvement measures for building occupants
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            PV capacity = 47,794 / 950 = <span>50.3 kWp required</span>
          </p>
          <p>Roof check:</p>
          ...
          <p>
            <strong>Scenario:</strong> Compare BER impact of fluorescent vs LED lighting in retail
            unit.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Incorrect zoning</strong> - zones must match activity type and HVAC systems
            </li>
            <li>
              <strong>Missing thermal bridges</strong> - psi values significantly affect heat loss
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You are running the design-stage SBEM for a 4,800 m² retail unit. The architect is
              using one large open-plan zone but SBEM activity templates require separate zones for
              sales, back-of-house, and refrigerated areas. Your first pass shows BER comfortably
              under TER — but when you re-zone correctly, the refrigerated zone pulls the actual
              building into non-compliance.
            </>
          }
          whatToDo={
            <>
              Re-run with correct zoning per the NCM activity template (e.g. retail sales floor +
              cold storage + ancillary). If non-compliant, the design team must respond with reduced
              cooling demand (better envelope at the cold zone, door curtains, automatic closers) or
              upgraded refrigeration controls. Where SBEM zoning is genuinely too coarse for the
              design, switch to DSM (IES VE) which models air movement between zones rather than
              treating each as isolated.
            </>
          }
          whyItMatters={
            <>
              Wrong zoning is the most common SBEM error — and it nearly always makes the building
              look more compliant than it is. The design-stage SBEM goes to Building Control with
              the planning submission; getting it wrong means re-design, re-tender and programme
              slip when as-built reveals the gap.
            </>
          }
        />
