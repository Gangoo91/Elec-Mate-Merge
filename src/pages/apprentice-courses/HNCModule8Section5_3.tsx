...
const quickCheckQuestions = [
  {
    ...
    options: [
      'Linear actuators are only ever used on dampers, rotary only on valves',
      'Linear actuators require a 230V supply whilst rotary use 24V',
      ...
      'Linear actuators cannot provide modulating control, only rotary can',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To increase the maximum torque the actuator can deliver',
      'To allow the actuator to modulate more smoothly between positions',
      'To return the valve to a safe fail position on power loss or signal failure',
      'To reduce the running time of the actuator during normal operation',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      '2-10V delivers more torque to the actuator than 0-10V',
      '2-10V allows the actuator to run on a 230V mains supply',
      '2-10V gives finer resolution because it uses a wider voltage span',
  ...
  },
  {
    ...
    options: [
      'The colour of the damper blades for identification',
      'The required torque based on damper area and static pressure',
      'The length of control cable run to the BMS panel',
      'The ambient noise level in the surrounding plant room',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'The maximum differential pressure the valve can close against',
      'The linear travel distance of the valve stem from fully closed to fully open',
      'The voltage range of the control signal from the BMS',
      'The time taken for the actuator to complete its full travel',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Linear motion (straight-line stem travel)',
      'Reciprocating motion (rapid back-and-forth)',
  ...
  },
  {
    ...
    options: [
      'The maximum continuous duty period before the actuator must rest',
      'The delay before the actuator responds to a new control signal',
      'The time the spring takes to return the valve on power loss',
  ...
  },
  {
    ...
    options: [
      ...
      '230V AC switched live and neutral',
      '50-60Hz mains frequency pulse train',
      'A single volt-free relay contact only',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It provides far more precise positioning than analogue signals',
      'It includes built-in position feedback to the controller',
      'It allows the actuator to fail safe without a spring return',
  ...
  },
  {
    ...
    options: [
      'To allow the actuator to rotate the valve a full 90 degrees',
      'To ensure the actuator body does not rotate, potentially damaging wiring or pipework',
      'To return the valve to a fail-safe position on power loss',
      'To increase the close-off pressure rating of the valve',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['60% open', '75% open', '50% open', '40% open'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1-2 Nm/m²', '50-100 Nm/m²', '15-20 Nm/m²', '4-8 Nm/m²'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      '24V AC actuators always deliver significantly higher torque output',
      '24V AC removes the need for any control signal wiring',
      '24V AC actuators can run directly from a battery without a transformer',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Continuously variable speed that adjusts to the control signal',
      'Consistent running time regardless of load, but no intermediate positioning',
      'Higher torque output as the load on the valve increases',
      'Smooth modulating travel that can stop at any intermediate position',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The maximum static pressure the valve body can safely withstand',
      'The minimum pressure required before the valve will begin to open',
      'The maximum differential pressure against which the actuator can fully close the valve',
      'The pressure drop across the valve when it is fully open',
    ],
    correctAnswer: 2,
    explanation:
...
const HNCModule8Section5_3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 5 · Subsection 3"
        title="Actuators and Output Devices"
        backTo="/study-centre/apprentice/h-n-c-module8-section5"
      />
      <HubBody>
        ...
        <ConceptBlock title="Valve Actuator Types">
          <p>
            ...
            the required control precision. Understanding the differences between linear and rotary
            actuators is essential for correct specification.
          </p>
          <p>
            <strong>Linear Valve Actuators</strong>
          </p>
          ...
          <p>
            <strong>Rotary Valve Actuators</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Valve and Actuator Matching</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2-port globe valve:</strong> Linear — Stroke (mm), Force (N) — LTHW/CHW flow
              control
            </li>
            <li>
              <strong>3-port mixing valve:</strong> Linear — Stroke (mm), Force (N) — Temperature
              blending
            </li>
            <li>
              <strong>Ball valve:</strong> Rotary 90° — Torque (Nm) — On/off isolation, 2-way
              control
            </li>
            <li>
              <strong>Butterfly valve:</strong> Rotary 90° — Torque (Nm) — Large bore isolation, AHU
              coils
            </li>
            <li>
              <strong>Characterised ball valve:</strong> Rotary 90° — Torque (Nm) — Modulating
              control with equal percentage
            </li>
          </ul>
          <p>
            <strong>Actuator Force and Stroke Requirements</strong>
          </p>
        ...
        <ConceptBlock title="Damper Actuators">
          ...
          <p>
            <strong>Damper actuator types by mounting:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Direct-coupled:</strong> Actuator mounts directly on damper shaft, no linkage
              required
            </li>
            <li>
              <strong>Crank arm/linkage:</strong> External actuator connected via mechanical linkage
            </li>
            <li>
              <strong>Jackshaft:</strong> Multiple dampers driven from single actuator via shaft and
              linkages
            </li>
            <li>
          ...
          <p>
            <strong>Damper Actuator Torque Calculation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Opposed blade (low pressure):</strong> &lt;500 Pa — 4-8 — Standard ventilation
            </li>
            <li>
              <strong>Opposed blade (medium pressure):</strong> 500-1000 Pa — 8-12 — VAV systems
            </li>
            <li>
              <strong>Parallel blade:</strong> &lt;500 Pa — 4-6 — 2-position isolation
            </li>
            <li>
              <strong>Fire/smoke damper:</strong> Variable — 15-25 — High friction seals
            </li>
            <li>
              <strong>High-pressure industrial:</strong> &gt;1000 Pa — 12-20 — Process applications
            </li>
          </ul>
          <p>
            <strong>Torque Calculation Example</strong>
          </p>
          <p>
            <span>Given:</span>
          </p>
          ...
          <p>
            <strong>Direct-Coupled Advantages</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Linkage Applications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Installation note:</strong> Direct-coupled actuators must be correctly oriented
            on the damper shaft. Most have a rotation direction marking - verify this matches the
            required open/close action before final fixing.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Control Signals: Modulating vs On/Off">
          <p>
            Actuators receive control signals from the BMS to determine their position. The control
            type - on/off (two-position) or modulating (proportional) - fundamentally affects system
            performance, energy efficiency, and comfort. Understanding the available signal types
            enables correct specification for each application.
          </p>
          <p>
            <strong>On/Off (Two-Position) Control</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Modulating (Proportional) Control</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Analogue Control Signal Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>0-10V DC:</strong> 0V = 0%, 10V = 100% — Limited (0V valid) — 2-core screened
              — Standard HVAC
            </li>
            <li>
              <strong>2-10V DC:</strong> 2V = 0%, 10V = 100% — Good (0V = fault) — 2-core screened —
              Critical systems
            </li>
            <li>
              <strong>4-20mA:</strong> 4mA = 0%, 20mA = 100% — Good (0mA = fault) — 2-core screened,
              loop — Long distances, noisy
            </li>
            <li>
              <strong>Three-point floating:</strong> Open/Close/Stop — Limited — 3-core + common —
              Simple systems, retrofit
            </li>
          </ul>
          <p>
            <strong>0-10V vs 2-10V: The Critical Difference</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Three-Point Floating Control</strong>
          </p>
          <p>
          ...
          <p>
            Advantage: Uses simple relay outputs, no analogue channels required. Disadvantage: Less
            precise, requires periodic recalibration to end stops.
          </p>
          <p>
        ...
        <ConceptBlock title="Spring Return, Fail-Safe, and Sizing Criteria">
          ...
          <p>
            <strong>Spring return configurations:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Normally Open (NO):</strong> Spring drives valve open on power loss - used for
              heating
            </li>
            <li>
              <strong>Normally Closed (NC):</strong> Spring drives valve closed on power loss - used
              for cooling, steam
            </li>
            <li>
              <strong>Non-spring return:</strong> Actuator holds last position on power loss - used
              where safe
            </li>
          </ul>
          <p>
            <strong>Fail-Safe Selection Guide</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>LTHW heating valve:</strong> Open — Spring return NO — Prevent freeze damage,
              maintain warmth
            </li>
            <li>
              <strong>CHW cooling valve:</strong> Closed — Spring return NC — Prevent overcooling,
              condensation
            </li>
            <li>
              <strong>Data centre cooling:</strong> Open — Spring return NO — Maintain cooling for
              equipment protection
            </li>
            <li>
              <strong>Steam valve:</strong> Closed — Spring return NC — Safety - prevent
              uncontrolled steam flow
            </li>
            <li>
              <strong>Fresh air damper:</strong> Closed — Spring return NC — Prevent uncontrolled
              outside air ingress
            </li>
            <li>
              <strong>Fire/smoke damper:</strong> Closed — Spring return NC — Fire compartmentation
            </li>
            <li>
              <strong>General ventilation damper:</strong> Last position — Non-spring return — No
              safety-critical fail position
            </li>
          </ul>
          <p>
            <strong>Actuator Sizing Checklist</strong>
          </p>
          <p>
            <strong>For Valve Actuators:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>For Damper Actuators:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Running Time Considerations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>15-30 seconds:</strong> On/off actuators, quick-acting — Fast response, may
              cause hunting if used for modulating
            </li>
            <li>
              <strong>60-90 seconds:</strong> Fast modulating, small systems — Good response, suits
              tight control loops
            </li>
            <li>
              <strong>90-120 seconds:</strong> Standard HVAC modulating — Smooth control, prevents
              hunting
            </li>
            <li>
              <strong>150-240 seconds:</strong> Large dampers, high inertia systems — Stable
              control, slower response
            </li>
          </ul>
          <p>
            <strong>Common Sizing Errors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Undersized torque:</strong> Actuator struggles or fails to move damper against
              pressure
            </li>
            <li>
              <strong>Oversized actuator:</strong> Can damage valve/damper, wastes energy, causes
              hunting
            </li>
            <li>
          ...
          <p>
            <strong>Design principle:</strong> Always apply a 25% safety factor to calculated torque
            or force requirements. This accounts for bearing friction increase over time, dirt
            accumulation, and operating conditions beyond design parameters.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Size a direct-coupled actuator for an 800mm × 600mm fresh air
            intake damper operating against 600Pa static pressure.
          </p>
          <p>Given data:</p>
