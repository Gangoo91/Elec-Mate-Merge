    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Understand the components of effective safety management systems in building services
          organisations
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the systematic approach to managing health and safety in the workplace
          - from developing robust policies and fostering positive safety culture, through to
          implementing permit systems, conducting audits, and managing contractors safely on
