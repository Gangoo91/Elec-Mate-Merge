...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['1.6 kW', '2.5 kW', '3.68 kW', '6 kW'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['44% more', '20% more', '100% more', '73% more'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['5-15%', '15-30%', '50-60%', '35-45%'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['5 metres', '15 metres', '10 metres', '20 metres'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['9 metres', '20 metres', '15 metres', '11.1 metres'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['4,380 kWh', '9,636 kWh', '8,760 kWh', '43,800 kWh'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Small wind has more failure modes than PV — turbulence (especially building-mounted),
              noise to BS 4142 boundaries, ice throw, telecoms interference, and shadow flicker all
              need site assessment. MIS 3003 sets the certification standard; without it, no SEG/MCS
        ...
        <ConceptBlock title="Wind Turbine Fundamentals">
          <p>
            ...
            Understanding the fundamental physics and turbine configurations is essential for system
            design and performance prediction.
          </p>
          <p>
            <strong>Wind Power Equation</strong>
          </p>
          <p>
            <span>P = ½ρAV³</span>
          </p>
          ...
          <p>
            <strong>Turbine Type Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Typical Cp (efficiency):</strong> 0.35-0.45 — 0.25-0.35
            </li>
            <li>
              <strong>Yaw mechanism:</strong> Required (tail vane or motor) — Not required -
              omnidirectional
            </li>
            <li>
              <strong>Turbulence tolerance:</strong> Lower - affected by gusts — Higher - better in
              urban sites
            </li>
            <li>
              <strong>Starting wind speed:</strong> 2.5-4 m/s typical — Savonius: 2 m/s, Darrieus:
              4+ m/s
            </li>
            <li>
              <strong>Noise level:</strong> Moderate (tip noise) — Lower typically
            </li>
            <li>
              <strong>Market availability:</strong> Dominant (90%+ of market) — Niche applications
            </li>
          </ul>
          <p>
            <strong>Key operating parameters:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cut-in speed:</strong> Minimum wind speed for generation (typically 2.5-4 m/s)
            </li>
            <li>
              <strong>Rated speed:</strong> Wind speed at which rated power is achieved (10-14 m/s)
            </li>
            <li>
              <strong>Cut-out speed:</strong> Maximum operating wind speed before shutdown (25-30
              m/s)
            </li>
            <li>
              <strong>Survival speed:</strong> Maximum wind speed the structure can withstand (50-70
              m/s)
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Wind Resource Assessment">
          ...
          <p>
            <span>f(V) = (k/c)(V/c)^(k-1) × e^(-(V/c)^k)</span>
          </p>
          <p>Where:</p>
          ...
          <p>
            <strong>Wind Shear Correction</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>V₂/V₁ = (h₂/h₁)^α</li>
          ...
          <p>
            <strong>Site Selection Criteria</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Capacity factor method:</strong> AEY = P_rated × 8760 × CF — ±20-30%
            </li>
            <li>
              <strong>Weibull integration:</strong> AEY = ∫P(V)×f(V)dV × 8760 — ±10-15%
            </li>
            <li>
              <strong>Bin method (measured data):</strong> AEY = Σ(P_i × hours_i) — ±5-10%
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Installation Types and Planning Considerations">
          ...
          <p>
            <strong>Freestanding vs Building-Mounted Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Wind quality:</strong> Cleaner, laminar flow — Turbulent, reduced speed
            </li>
            <li>
              <strong>Expected output:</strong> 100% of rated potential — 30-60% of rated potential
            </li>
            <li>
              <strong>Structural concerns:</strong> Foundation design — Vibration, resonance, load
              transfer
            </li>
            <li>
              <strong>Permitted development (England):</strong> Possible with conditions — Generally
              not permitted
            </li>
            <li>
              <strong>Typical lifespan:</strong> 20-25 years — 10-15 years (fatigue issues)
            </li>
          </ul>
          <p>
            <strong>Permitted Development Conditions (England)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Not in Conservation Areas, AONB, World Heritage Sites, or listed building curtilage
            </li>
            <li>Noise level ≤ 45 dB(A) at nearest premises</li>
            <li>Must be removed when no longer needed</li>
          </ul>
          <p>
            <strong>Structural Requirements for Building-Mounted Turbines</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Structural assessment:</strong> Building must withstand dynamic loads (thrust
              + cyclic)
            </li>
            <li>
              <strong>Resonance check:</strong> Building natural frequency must differ from turbine
              operating frequency
            </li>
            <li>
              <strong>Mounting detail:</strong> Loads transferred to main structure, not just roof
              covering
            </li>
            <li>
          ...
          <p>
            <strong>Noise Considerations (ETSU-R-97 Guidelines)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Daytime (07:00-23:00):</strong> 35-40 dB(A) LA90 — Background + 5 dB (if
              higher)
            </li>
            <li>
              <strong>Night-time (23:00-07:00):</strong> 43 dB(A) LA90 — Background + 5 dB (if
              higher)
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Grid Connection Requirements">
          ...
          <p>
            <strong>G98 vs G99 Application</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single-phase limit:</strong> ≤ 3.68 kW (16A) — &gt; 3.68 kW
            </li>
            <li>
              <strong>Three-phase limit:</strong> ≤ 11.04 kW (16A/phase) — &gt; 11.04 kW
            </li>
            <li>
              <strong>Process:</strong> Notification (28-day wait) — Formal application required
            </li>
            <li>
              <strong>Cost:</strong> Usually free — Application and study fees apply
            </li>
            <li>
              <strong>Timeline:</strong> 28 days from notification — 45-90 days typical
            </li>
          </ul>
          <p>
            <strong>Grid Protection Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Loss of mains:</strong> Rate of change of frequency (RoCoF) or vector shift
              detection
            </li>
            <li>
          ...
          <p>
            <strong>Inverter Types for Wind Turbines</strong>
          </p>
          <p>
            <strong>AC-Coupled (Synchronous)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>DC-Coupled (PMG + Rectifier)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Electrical Installation Requirements (BS 7671)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> NOABL data gives 5.2 m/s at 10m height. Calculate wind speed
            at 15m hub height in suburban terrain (α = 0.25).
          </p>
          ...
          <p>V₁₅/V₁₀ = 1.107</p>
          <p>
            V₁₅ = 5.2 × 1.107 = <span>5.76 m/s at hub height</span>
          </p>
          <p>
            Note: This 11% increase in wind speed translates to (1.107)³ = 36% more available power
          </p>
          <p>
            <strong>Example 2: Annual Energy Yield Calculation</strong>
          </p>
          <p>
            <strong>Scenario:</strong> A 6 kW rated turbine is installed at a site with estimated
            capacity factor of 0.24. Calculate annual energy yield.
          </p>
          <p>Annual Energy Yield = Rated Power × Hours per Year × Capacity Factor</p>
          <p>AEY = P_rated × 8760 × CF</p>
          <p>AEY = 6 kW × 8760 h × 0.24</p>
          <p>
            AEY = <span>12,614 kWh/year</span>
          </p>
          <p>At electricity cost of £0.28/kWh:</p>
          <p>
            Savings = 12,614 × £0.28 = <span>£3,532/year</span>
          </p>
          <p>Plus SEG export (assume 50% exported at 10p/kWh):</p>
          <p>Export income = 6,307 × £0.10 = £631/year</p>
          <p>
            Total annual value = <span>£3,847/year</span>
          </p>
          <p>
            <strong>Example 3: Weibull Distribution Application</strong>
          </p>
          <p>
            <strong>Scenario:</strong> A site has Weibull parameters k = 2.1, c = 6.5 m/s. Estimate
            percentage of time wind speed exceeds 4 m/s (turbine cut-in).
          </p>
          ...
          <p>P(V &gt; 4) = e^(-0.354)</p>
          <p>
            P(V &gt; 4) = <span>0.702 = 70.2% of the time</span>
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Calculate the theoretical power available in wind for a 5m
            diameter rotor at 8 m/s wind speed (air density 1.225 kg/m³).
          </p>
          ...
          <p>
            P = <span>6,158 W (6.16 kW) available</span>
          </p>
          <p>With Cp = 0.40 (typical HAWT efficiency):</p>
          <p>
            Extracted power = 6,158 × 0.40 = <span>2,463 W electrical output</span>
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Ignoring turbulence</strong> - Building-mounted and urban sites have severe
        ...
        <Scenario
          ...
          situation={
            <>
              A 2.5 kW building-mounted wind turbine is installed on a four-storey commercial
              building. NOABL predicted 5.2 m/s mean wind speed but actual yield in the first six
              months is 38% of forecast. A neighbouring residential property submits a noise
              complaint; environmental health measure 7 dB(A) above background at the boundary in
              light wind, breaching BS 4142.
            </>
          }
          whatToDo={
            <>
              Building-mounted turbines almost always under-perform NOABL because of
              building-induced turbulence — and they are often noisier than freestanding equivalents
              because vibration couples through the structure. Options: (1) decommission, (2)
              anti-vibration mounting kit (limited improvement), (3) operating restriction at low
              wind speed (defeats the economics). Lesson for next time: use site-mast wind data not
              NOABL, and prefer pole-mounted standalone turbines.
            </>
          }
          whyItMatters={
            <>
              Small wind is the hardest microgeneration to make work in the UK — most installed
              building-mounted turbines under-deliver and many are removed within 5 years.
              Pole-mounted rural installations on validated wind sites can succeed but require
              careful planning consultation, measured wind data and conservative yield assumptions.
            </>
          }
        />
