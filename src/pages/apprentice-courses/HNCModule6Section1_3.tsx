...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['0.18 W/m²K', '0.35 W/m²K', '0.26 W/m²K', '0.30 W/m²K'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Rse = 0.13 m²K/W', 'Rsi = 0.13 m²K/W', 'Rsi = 0.04 m²K/W', 'Rse = 0.04 m²K/W'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['2.86 m²K/W', '0.35 m²K/W', '3.50 m²K/W', '0.29 m²K/W'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['0.18 W/m²K', '0.16 W/m²K', '0.20 W/m²K', '0.25 W/m²K'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.06 W/mK', '0.35 W/mK', '0.25 W/mK', '0.16 W/mK'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Limiting values are absolute backstops — they cannot be traded off against better
              services performance. Air permeability of 8 m³/h·m² is the legal maximum; the notional
              dwelling assumes 5 to drive design ambition. Thermal bridging defaults add a penalty
              to TER; using ACDs or calculated Ψ-values almost always pays back in SAP score.
            </>
          }
        ...
        <ConceptBlock title="U-Value Fundamentals">
          <p>
            ...
            prevents heat transfer. It represents the rate of heat flow through one square metre of
            the element for each degree of temperature difference between inside and outside air.
          </p>
          <p>
            <strong>U-Value Formula</strong>
          </p>
          <p>
            <span>
              {' '}
          ...
          <p>
            <span>R = d / λ</span> (for each layer)
          </p>
          <p>d = thickness (m), λ = thermal conductivity (W/mK)</p>
          <p>
            <strong>Surface Resistances (BS EN ISO 6946):</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Walls:</strong> Horizontal — 0.13 — 0.04
            </li>
            <li>
              <strong>Roof (ceiling):</strong> Upward — 0.10 — 0.04
            </li>
            <li>
              <strong>Floor:</strong> Downward — 0.17 — 0.04
            </li>
          </ul>
          <p>
            <strong>Common Insulation Materials</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Phenolic foam:</strong> 0.018-0.022 — Where space is limited
            </li>
            <li>
              <strong>PIR/PUR rigid foam:</strong> 0.022-0.028 — Flat roofs, wall cavities
            </li>
            <li>
              <strong>Expanded polystyrene (EPS):</strong> 0.032-0.038 — Floor insulation, EIFS
            </li>
            <li>
              <strong>Mineral wool:</strong> 0.035-0.040 — Cavity walls, loft spaces
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Part L Limiting Parameters">
          ...
          <p>
            <strong>Part L 2021 - Limiting U-Values (New Buildings)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>External walls:</strong> 0.26 — 0.26
            </li>
            <li>
              <strong>Roof:</strong> 0.16 — 0.16
            </li>
            <li>
              <strong>Ground floor:</strong> 0.18 — 0.18
            </li>
            <li>
              <strong>Windows/roof windows:</strong> 1.6 — 1.6
            </li>
            <li>
              <strong>Doors:</strong> 1.6 — 1.6
            </li>
            <li>
              <strong>Curtain walling:</strong> - — 1.6
            </li>
          </ul>
          <p>
            <strong>Limiting Values</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Target Fabric Energy Efficiency (TFEE)</strong>
          </p>
          <p>
            Part L 2021 introduces TFEE for dwellings - a metric measuring fabric performance
            independent of services. The building's Fabric Energy Efficiency (FEE) must not exceed
            the TFEE calculated for the notional building, ensuring fabric performance is not traded
            off against efficient services.
          </p>
          <p>
            <strong>Services impact:</strong> Better fabric performance reduces heating/cooling
            loads, allowing smaller plant sizes but must be correctly input to SAP/SBEM for accurate
        ...
        <ConceptBlock title="Thermal Bridging and Psi Values">
          ...
          <p>
            <strong>Types of thermal bridges:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Point (3D):</strong> Penetrations through the envelope - fixings, brackets,
              services
            </li>
            <li>
          ...
          <p>
            <strong>Psi Value (ψ) - Linear Thermal Transmittance</strong>
          </p>
          <p>
            <span>Heat loss at junction = ψ × L × ΔT</span>
          </p>
          <p>Where:</p>
          ...
          <p>
            <strong>Typical Psi Values</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Wall/floor (ground):</strong> 0.05 - 0.10 — 0.30 - 0.50
            </li>
            <li>
              <strong>Wall/roof (eaves):</strong> 0.04 - 0.08 — 0.20 - 0.35
            </li>
            <li>
              <strong>Window jamb:</strong> 0.02 - 0.05 — 0.10 - 0.15
            </li>
            <li>
              <strong>Corner (external):</strong> 0.02 - 0.05 — 0.08 - 0.15
            </li>
            <li>
              <strong>Lintel:</strong> 0.05 - 0.12 — 0.25 - 0.50
            </li>
          </ul>
          <p>
            <strong>Total Heat Loss from Thermal Bridges</strong>
          </p>
          <p>
          ...
          <p>
            ...
            SAP/SBEM uses y = 0.15 W/m²K - a significant penalty that can add 15-20% to fabric heat
            loss.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Construction Specifications and Services Impact">
          ...
          <p>
            <strong>External Wall Build-Up</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Flat Roof Build-Up</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Impact on Building Services Design</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Wall U-value:</strong> Heating/cooling load — Lower U = smaller radiators/FCUs
            </li>
            <li>
              <strong>Roof U-value:</strong> Peak summer gains — Solar gain through roof affects
              cooling
            </li>
            <li>
              <strong>Window U-value:</strong> Perimeter heating, cold spots — Higher glazing = more
              perimeter capacity
            </li>
            <li>
              <strong>Thermal mass:</strong> Control strategy, peak shifting — Heavy buildings suit
              night cooling
            </li>
            <li>
              <strong>Air permeability:</strong> Ventilation strategy — Tight buildings need MVHR
            </li>
          </ul>
          <p>
            <strong>Services Penetrations - Thermal Bridge Mitigation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ductwork:</strong> Insulate ducts through envelope, seal around penetrations
            </li>
            <li>
              <strong>Pipework:</strong> Use proprietary thermal break sleeves where passing through
              insulation
            </li>
            <li>
              <strong>Cables:</strong> Seal with intumescent mastic, maintain insulation continuity
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Determine insulation thickness required to achieve U = 0.14
            W/m²K for a flat roof.
          </p>
        ...
        <Scenario
          ...
          situation={
            <>
              The designer specified an air permeability of 5 m³/h·m² (notional value) and the SAP
              design-stage calculation is built on it. The site test on plot 14 returns 9.2 — above
              the 8 limit. Without remediation, the dwelling fails Part L and cannot complete.
            </>
          }
          whatToDo={
            <>
              Re-test after smoke-pencil identification of the leakage paths (typically penetrations
              at services, eaves and lintel junctions). If the second test still fails, two routes
              are open: (1) physical remediation (intumescent sealing, taping, membrane repair) and
              re-test, or (2) re-run SAP with the as-tested 9.2 value and demonstrate compliance via
              offsetting measures (better SCOP for the heat pump, additional PV, enhanced lighting).
              Both must be evidenced before Building Control sign-off.
            </>
          }
          whyItMatters={
            <>
              Air permeability is the headline number Building Control look at — and it cannot be
              wished away. Designing to 5 with no contingency means every plot becomes a gamble.
              Best practice is to design to 4 on paper, allow 1 for site execution drift, and target
              ≤5 measured.
            </>
          }
        />
