        ...
        <div className="max-w-3xl mx-auto">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-3">
              ...
              Trunking System Types and Applications
            </h2>
            <div className="space-y-4">
              <div className="rounded-lg p-4 bg-white/5 border border-white/10">
                ...
                <div className="space-y-3 text-sm text-white/90">
                  ...
                  <div>
                    <p className="font-medium text-elec-yellow mb-1">Key Features</p>
                    <ul className="list-disc pl-5 space-y-1">
                  ...
                  <div>
                    <p className="font-medium text-elec-yellow mb-1">Installation Requirements</p>
                    <ul className="list-disc pl-5 space-y-1">
              ...
              <div className="rounded-lg p-4 bg-white/5 border border-green-400/30">
                ...
                <div className="space-y-3 text-sm text-white/90">
                  ...
                  <div>
                    <p className="font-medium text-green-300 mb-1">Key Features</p>
                    <ul className="list-disc pl-5 space-y-1">
                  ...
                  <div>
                    <p className="font-medium text-green-300 mb-1">Installation Requirements</p>
                    <ul className="list-disc pl-5 space-y-1">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-3">
              ...
              Installation Calculations and Methods
            </h2>
            <div className="space-y-4">
              ...
              <div className="rounded-lg p-4 bg-indigo-500/10 border border-indigo-400/30">
                ...
                <div className="bg-black/30 p-3 rounded font-mono text-xs text-indigo-100">
                  ...
                  <p>- Cable: 10mm2 T&E (carrying capacity 64A)</p>
                  <p>- Cable diameter = 11.5mm (inc. sheath)</p>
                  <p>- 20 cables required for distribution</p>
                  <p>- Total cable area = 20 x pi x (11.5/2)^2 = 2077mm2</p>
                  <p>- Compartment area req. = 2077 / 0.45 = 4616mm2</p>
                  <p>- Select: 100 x 50mm compartment (5000mm2)</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              <div className="rounded-lg p-4 bg-white/5 border border-green-400/30">
                ...
                <ul className="space-y-2 text-white/90">
                  ...
                  <li>- Test earth continuity in metal trunking systems (&lt;0.05 ohm)</li>
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-3">
              ...
              Pocket Card: Trunking Installation Quick Reference
            </h2>
            <div className="grid md:grid-cols-2 gap-4 text-xs">
              <div className="rounded-lg p-3 bg-white/5 border border-white/10">
                ...
                <ul className="space-y-1 text-white/80">
                  ...
                  <li>- Earth continuity: &lt;0.05 ohm</li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <Quiz title="Underfloor and Dado Trunking Systems" questions={quizQuestions} />
          </section>
          ...
          <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 mt-8 border-t border-white/10">
            ...
            >
              <Link to="../2-6">
                Next: Fixings, Clips and Cable Ties
