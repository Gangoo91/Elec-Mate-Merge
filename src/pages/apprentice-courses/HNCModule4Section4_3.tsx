...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['1 hour', '2 hours', '4 hours', '3 hours'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['0.2 lux', '0.5 lux', '5 lux', '1 lux'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Ra 40', 'Ra 60', 'Ra 20', 'Ra 80'],
    correctAnswer: 0,
    explanation:
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              lighting. As the HNC designer you choose between a self-contained luminaire (its own
              secondary battery), a central battery system to BS EN 50171, an independent generator,
              or — rarely — a genuinely independent network feeder. Anything else isn’t a recognised
              source and won’t pass verification under Chapter 56. Your spec states which option
              (a)–(d) you’re using and why.
            </>
          }
        ...
        <ConceptBlock title="Open Area and High-Risk Task Lighting">
          <p>
            ...
            purposes from escape routes. Anti-panic lighting prevents panic in large spaces, while
            high-risk lighting enables safe shutdown of dangerous processes.
          </p>
          <p>
          ...
          <p>
            <strong>
              Emergency lighting summary (type / illuminance / uniformity / response):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Escape route — 1 lux (full width) — 40:1 max — 5s (50%), 60s (100%)</li>
            <li>Open area — 0.5 lux (floor) — 40:1 max — 5s (50%), 60s (100%)</li>
            <li>High-risk task — 10% of normal, min 15 lux — 10:1 max — 0.5s (100%)</li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Maintained vs Non-Maintained Systems">
          <p>
            ...
            used. Where lighting may be deliberately switched off while occupied, maintained systems
            are required.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Sustained</strong> — two lamps, one maintained, one not — combined normal and
              emergency function
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>3 hours:</strong> standard for most buildings (offices, retail, industrial)
            </li>
            <li>
            ...
            <li>
              <strong>Extended (to 8 hours):</strong> sleeping accommodation, hospitals, premises
              with delayed evacuation
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Testing, Maintenance and Documentation">
          <p>
            Emergency lighting is a life safety system requiring regular testing and maintenance. BS
            5266 specifies the test regime and documentation requirements. Self-test systems can
            automate some requirements but manual verification remains essential.
          </p>
          <p>
          ...
          <p>
            ...
            require 24 hours to fully recharge. Testing should be scheduled to ensure the system is
            fully charged during normal occupied periods. Avoid testing on consecutive days or
            before weekends/holidays when the building is occupied.
          </p>
          <p>
            <strong>Legal responsibility:</strong> The Regulatory Reform (Fire Safety) Order 2005
            places responsibility on the 'responsible person' (usually building owner/employer) to
            maintain emergency lighting in working order.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Self-contained may not achieve 0.5s response; consider central battery or UPS-backed
              system
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Forgetting open areas</strong> — spaces &gt;60m² need anti-panic lighting
              </li>
              <li>
                <strong>Missing safety equipment</strong> — fire extinguishers and call points need
                illumination
              </li>
              <li>
                <strong>Poor test scheduling</strong> — allow 24h recharge before occupied periods
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              You’re designing the emergency lighting for a 3-storey, 2,400 m² office refurb. Around
              140 emergency luminaires across escape routes, open areas, plant rooms and a small
              high-risk archive store. Client wants 3 h duration, monthly function tests and an
              annual full-discharge test logged centrally. The fire strategy says simultaneous
              evacuation, single staircase per zone.
            </>
          }
          whatToDo={
            <>
              Choose the source under Reg 560.6.1. Option (a) primary batteries — non-starter for a
              3 h commercial duty. Option (d) independent feeder — not realistic from a single DNO
              connection. That leaves (b) stationary secondary batteries (a central battery system
              to BS EN 50171) or (c) generator. Generator is overkill for emergency lighting alone
              and triggers gas-flue and ventilation works. Specify a central battery system (b) to
              BS EN 50171 with addressable luminaires for self-test logging, OR self-contained 3 h
              luminaires with a wireless test/monitoring head-end. Document escape route 1 lx / 0.5
              lx, open area 0.5 lx, high-risk archive 15 lx (10 % of task), and call out that the
              supply circuits are independent of normal lighting per Reg 560.7.1.
            </>
          }
          whyItMatters={
            <>
              On a 140-luminaire scheme, manual annual discharge testing is a 3-day disruption you
              only do once before the FM team rebels. Self-test (DALI / wireless) is the modern
              answer; central battery wins on long corridors and tower blocks. The 560.6.1 source
              choice cascades into every other M&amp;E decision.
            </>
          }
        />
