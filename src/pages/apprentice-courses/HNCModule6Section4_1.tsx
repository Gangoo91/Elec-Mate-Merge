...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['kW/CO2', 'CO2/year', 'tonnes/MW', 'kgCO2e/kWh'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Scope 3', 'Scope 0', 'Scope 1', 'Scope 2'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1', 'Approximately 265', 'Approximately 28', 'Approximately 1,000'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Both Scope 1 and Scope 2', 'Scope 2 only', 'Scope 3 only', 'Scope 1 only'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['GHG Protocol', 'TCFD', 'SECR', 'ISO 14064'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              SECR is mandatory annual disclosure for ~12,000 large UK organisations. The
              methodology mirrors the GHG Protocol Corporate Standard. For building services
              projects, this means project carbon emissions feed the client's SECR return — accurate
              Scope 1/2 data and supporting documentation must be supplied at handover.
            </>
          }
        ...
        <ConceptBlock title="GHG Protocol and Carbon Accounting">
          ...
          <p>
            <strong>Key GHG Protocol Principles:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Completeness:</strong> Account for all emission sources within the boundary
            </li>
            <li>
              <strong>Consistency:</strong> Use consistent methodologies for meaningful comparison
            </li>
            <li>
          ...
          <p>
            <strong>The Three Emission Scopes</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Scope 1:</strong> Direct emissions from owned/controlled sources — Gas
              boilers, backup generators, company vehicles, refrigerant leaks
            </li>
            <li>
              <strong>Scope 2:</strong> Indirect emissions from purchased energy — Grid electricity,
              purchased heat/steam, district cooling
            </li>
            <li>
              <strong>Scope 3:</strong> All other indirect emissions in value chain — Materials,
              construction, waste, commuting, water supply
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Scope Emissions in Detail">
          ...
          <p>
            <strong>Scope 3 Categories</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Scope 2 Accounting Methods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Location-based:</strong> Grid average for location — Reflects actual grid
              emissions; required for regulatory reporting
            </li>
            <li>
              <strong>Market-based:</strong> Supplier-specific or contractual — Reflects purchasing
              decisions; allows renewable tariff claims
            </li>
          </ul>
          <p>
            <strong>Scope 3 Categories (GHG Protocol)</strong>
          </p>
          <p>
            <strong>Upstream:</strong> 1. Purchased goods/services, 2. Capital goods, 3. Fuel/energy
            activities, 4. Transport (upstream), 5. Waste, 6. Business travel, 7. Commuting, 8.
            Leased assets (upstream)
          </p>
          <p>
            <strong>Downstream:</strong> 9. Transport (downstream), 10. Processing, 11. Product use,
            12. End-of-life, 13. Leased assets (downstream), 14. Franchises, 15. Investments
          </p>
          <p>
            <strong>Reporting requirement:</strong> The GHG Protocol requires dual reporting of both
            location-based and market-based Scope 2 emissions for transparency.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="CO2e and Emission Factors">
          <p>
            ...
            greenhouse gases. Emission factors convert activity data (energy consumption, fuel use)
            into carbon emissions, enabling organisations to calculate their carbon footprint.
          </p>
          <p>
            <strong>Global Warming Potential (GWP-100)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Carbon dioxide:</strong> CO2 — 1 — Combustion, grid electricity
            </li>
            <li>
              <strong>Methane:</strong> CH4 — 28 — Gas leaks, incomplete combustion
            </li>
            <li>
              <strong>Nitrous oxide:</strong> N2O — 265 — Combustion byproduct
            </li>
            <li>
              <strong>HFCs (refrigerants):</strong> Various — 140-11,700 — HVAC refrigerant leaks
            </li>
            <li>
              <strong>SF6:</strong> SF6 — 23,500 — HV switchgear insulation
            </li>
          </ul>
          <p>
            <strong>UK Government Conversion Factors (2023)</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Carbon Calculation Formula</strong>
          </p>
          ...
          <p>
            ...
            DESNZ (formerly BEIS) and should be used for the reporting year in question. Historical
            comparisons should use year-appropriate factors.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Grid Carbon Intensity and Reporting Frameworks">
          <p>
            ...
            Understanding these variations enables optimised building operation and accurate carbon
            reporting under various regulatory frameworks.
          </p>
          <p>
            <strong>UK Grid Carbon Intensity Trends</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2010:</strong> 0.500 — Coal-dominated generation
            </li>
            <li>
              <strong>2015:</strong> 0.412 — Gas replacing coal
            </li>
            <li>
              <strong>2020:</strong> 0.233 — Renewable growth, coal phase-out
            </li>
            <li>
              <strong>2023:</strong> 0.207 — Offshore wind expansion
            </li>
            <li>
              <strong>2035 (target):</strong> ~0.050 — Decarbonised grid target
            </li>
          </ul>
          <p>
            <strong>Real-Time Carbon Intensity</strong>
          </p>
          <p>Grid carbon intensity varies throughout the day, typically:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lowest:</strong> Sunny/windy afternoons (solar + wind peak) - can drop below
              0.100 kgCO2e/kWh
            </li>
            <li>
            ...
            <li>
              <strong>Implication:</strong> Shifting flexible loads (EV charging, thermal storage)
              to low-carbon periods reduces emissions
            </li>
          </ul>
          <p>
            <strong>UK Carbon Reporting Frameworks</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>SECR:</strong> Large UK companies/LLPs — Energy use, emissions, intensity
              ratio in annual report
            </li>
            <li>
              <strong>TCFD:</strong> Listed companies, large asset owners — Climate risk disclosure,
              scenario analysis
            </li>
            <li>
              <strong>ESOS:</strong> Large undertakings (250+ employees) — Energy audits every 4
              years
            </li>
            <li>
              <strong>ISO 14064:</strong> Voluntary — GHG inventory, verification, project
              accounting
            </li>
            <li>
              <strong>SBTi:</strong> Voluntary commitment — Science-based reduction targets (1.5°C
              pathway)
            </li>
          </ul>
          <p>
            <strong>SECR Reporting Requirements</strong>
          </p>
          <p>
            <strong>Applies to:</strong> UK companies meeting 2 of 3 criteria: turnover &gt;£36m,
            balance sheet &gt;£18m, &gt;250 employees
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            200,000 kWh × 0.183 kgCO2e/kWh = 36,600 kgCO2e = <span>36.6 tCO2e</span>
          </p>
          <p>
            <strong>Scope 2 (electricity):</strong>
          </p>
          <p>
            450,000 kWh × 0.207 kgCO2e/kWh = 93,150 kgCO2e = <span>93.2 tCO2e</span>
          </p>
          <p>
            <strong>Total operational carbon:</strong> <span>129.8 tCO2e/year</span>
          </p>
          <p>
            <strong>Carbon intensity:</strong> 129,750 kgCO2e ÷ 5,000 m² ={' '}
            <span>25.95 kgCO2e/m²/year</span>
          </p>
          <p>
          ...
          <p>
            450,000 × 0.207 = 93,150 kgCO2e = <span>93.2 tCO2e</span>
          </p>
          ...
          <p>
            450,000 × 0.000 = 0 kgCO2e = <span>0 tCO2e</span>
          </p>
          ...
          <p>
            Emissions: 108,696 × 0.183 = 19,891 kgCO2e = <span>19.9 tCO2e</span>
          </p>
          <p>
          ...
          <p>
            Emissions: 33,333 × 0.207 = 6,900 kgCO2e = <span>6.9 tCO2e</span>
          </p>
          ...
          <p>
            CO2e emissions: 2.5 kg × 2,088 = 5,220 kgCO2e = <span>5.2 tCO2e</span>
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Mixing units</strong> - ensure kWh for energy, kgCO2e for emissions, convert
                to tonnes where appropriate
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A 200 kW VRF system uses R410A refrigerant (GWP 2,088). After 3 years of operation, an
              annual F-Gas inspection finds a 12 kg leak — equivalent to 25 tonnes CO₂e (12 ×
              2.088). The client's SECR report shows a year-on-year emissions increase, partially
              wiping out the savings from a heat-pump space heating retrofit.
            </>
          }
          whatToDo={
            <>
              Immediate F-Gas remediation — locate, repair, leak test, recharge with reclaimed
              refrigerant where possible. Update the maintenance regime: F-Gas inspection frequency
              rises with system charge size (&gt;5 tCO₂e annual; &gt;50 tCO₂e quarterly with leak
              detection). Consider transition to lower-GWP refrigerant (R32 = 675, R454B = 467, R290
              propane = 3) at next major service or replacement. Report the leak in SECR with the
              F-Gas remediation actions.
            </>
          }
          whyItMatters={
            <>
              Refrigerant leakage is the most under-reported source of building-services emissions.
              A 1% per-year leakage rate on a high-GWP system can match the operational electricity
              emissions of the same system — so the GWP and leak rate determine real-world climate
              impact as much as the COP does. The F-Gas Regulation 517/2014 phase-down is forcing
              the industry to lower-GWP refrigerants by 2030.
            </>
          }
        />
