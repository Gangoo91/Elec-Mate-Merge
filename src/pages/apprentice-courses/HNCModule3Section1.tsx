    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Apply understanding of fundamental electrical quantities to evaluate circuits with
          constant voltages and currents
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers essential DC circuit analysis techniques used daily in building
          services engineering - from sizing cables and calculating voltage drops to analysing
          distribution systems and emergency power supplies.
        </p>
