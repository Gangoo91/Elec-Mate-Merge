    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="Fundamental Principles of Cable Sizing">
          ...
          <p>
            <strong>The three cable sizing criteria:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Voltage drop:</strong> Voltage at load must remain within acceptable limits
            </li>
            <li>
          ...
          <p>
            <strong>Key Current Values in Cable Sizing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ib:</strong> Design current — Current the circuit is intended to carry in
              normal service
            </li>
            <li>
              <strong>In:</strong> Rated current — Nominal current rating of the protective device
            </li>
            <li>
              <strong>Iz:</strong> Effective capacity — Actual current-carrying capacity after
              applying correction factors
            </li>
            <li>
              <strong>It:</strong> Tabulated current — Current rating from BS 7671 tables for given
              installation method
            </li>
            <li>
              <strong>I2:</strong> Operating current — Current causing effective operation of
              protective device
            </li>
          </ul>
          <p>
            <strong>Fundamental Coordination Requirement</strong>
          </p>
          <p>For safe operation, the following relationship must be satisfied:</p>
          <p>Ib ≤ In ≤ Iz</p>
          <p>
            The design current must not exceed the protective device rating, which must not exceed
            the cable's effective current-carrying capacity.
          </p>
          <p>
            <strong>Design approach:</strong> Start with the load current, select an appropriate
            protective device, then determine the minimum cable size to satisfy all three criteria.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Correction Factors and Current Capacity">
          <p>
            ...
            applied to determine the effective current-carrying capacity. These factors account for
            reduced heat dissipation.
          </p>
          <p>
            <strong>Ca - Ambient Temperature</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Cg - Grouping Factor</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Ci - Thermal Insulation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Cc - BS 3036 Fuse Factor</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Cable Sizing Formula</strong>
          </p>
          <p>It ≥ In / (Ca × Cg × Ci × Cc)</p>
          <p>
            The minimum tabulated current rating (It) must be greater than or equal to the
            protective device rating divided by the product of all applicable correction factors.
          </p>
          <p>
            <strong>Common Correction Factor Values</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ca:</strong> 35°C ambient (PVC) — 0.94
            </li>
            <li>
              <strong>Ca:</strong> 40°C ambient (PVC) — 0.87
            </li>
            <li>
              <strong>Cg:</strong> 2 circuits touching — 0.80
            </li>
            <li>
              <strong>Cg:</strong> 4 circuits in conduit — 0.65
            </li>
            <li>
              <strong>Ci:</strong> One side thermal insulation — 0.75
            </li>
            <li>
              <strong>Cc:</strong> BS 3036 fuse protection — 0.725
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Voltage Drop Calculations">
          <p>
            ...
            Excessive voltage drop reduces equipment efficiency, causes lamps to dim, motors to run
            hot, and may prevent proper operation. BS 7671 Regulation 525 limits voltage drop to
            maintain adequate voltage at the point of utilisation.
          </p>
          <p>
            <strong>BS 7671 Voltage Drop Limits</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lighting circuits:</strong> 3% — 6.9V
            </li>
            <li>
              <strong>Other circuits:</strong> 5% — 11.5V
            </li>
            <li>
              <strong>Where supply is within +10%/-6%:</strong> 3% + 5% combined — 18.4V total
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Example Voltage Drop Values (mV/A/m)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1.5mm²:</strong> 29 mV/A/m — 25 mV/A/m
            </li>
            <li>
              <strong>2.5mm²:</strong> 18 mV/A/m — 15 mV/A/m
            </li>
            <li>
              <strong>4mm²:</strong> 11 mV/A/m — 9.5 mV/A/m
            </li>
            <li>
              <strong>6mm²:</strong> 7.3 mV/A/m — 6.4 mV/A/m
            </li>
            <li>
              <strong>10mm²:</strong> 4.4 mV/A/m — 3.8 mV/A/m
            </li>
            <li>
              <strong>16mm²:</strong> 2.8 mV/A/m — 2.4 mV/A/m
            </li>
          </ul>
          <p>
            <strong>Voltage Drop Considerations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Starting conditions:</strong> Motor starting currents cause higher transient
              voltage drop
            </li>
            <li>
            ...
            <li>
              <strong>Power factor:</strong> For AC circuits, voltage drop has both resistive and
              reactive components
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Thermal Constraints and the Adiabatic Equation">
          ...
          <p>
            <strong>k Values from BS 7671 Table 43.1</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Copper:</strong> 115 — 143 — 115
            </li>
            <li>
              <strong>Aluminium:</strong> 76 — 94 — -
            </li>
          </ul>
          <p>
            <strong>Disconnection Times (BS 7671 Regulation 411)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Final circuits ≤32A:</strong> 0.4s — 0.2s
            </li>
            <li>
              <strong>Final circuits &gt;32A:</strong> 5s — 1s
            </li>
            <li>
              <strong>Distribution circuits:</strong> 5s — 1s
            </li>
          </ul>
          <p>
            <strong>Worked Example: Adiabatic Check</strong>
          </p>
          <p>
          ...
          <p>
            <strong>When Adiabatic Check is Critical</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Busbar systems</div>
          </button>
          <button
