        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Forced-guided contacts:</strong> Mechanically linked NO/NC ensure fault
                detection
              </li>
              <li className="pl-1">
                <strong>Dual-channel:</strong> Two independent paths — single fault does not defeat
                safety
              </li>
              <li className="pl-1">
                <strong>EDM feedback:</strong> Confirms contactor state before allowing reset
              </li>
              <li className="pl-1">
                <strong>Response time:</strong> Typically 10-30 ms for safety relay modules
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Forced-Guided Contacts (IEC 61810-3)
              </p>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Mechanical linkage:</strong> NO (safety output) and NC (monitoring)
                  contacts are mechanically linked — they cannot both be closed simultaneously
                </li>
                <li className="pl-1">
                  <strong>Weld detection:</strong> If an NO contact welds closed, the corresponding
                  NC contact is physically prevented from closing. The safety relay detects this
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  ...
                  comprehensive range for all safety functions
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              fault, the safety outputs are de-energised regardless of the other channel's state.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Cross-fault detection:</strong> The relay checks for short circuits
                  between the two channels using test pulses. A cross-fault would defeat redundancy
                  by making both channels appear identical
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  Both channels must change state within a defined time window. Used with
                  dual-channel safety devices (E-stops with two NC contacts, dual-contact guard
                  switches). The most common mode for E-stop and guard interlock monitoring.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  provides the second channel internally by alternating the test voltage. Less
                  common, used for specific device types.
                </p>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                ...
                cable. If the cable is damaged (crushed, cut, exposed to heat), a common-mode fault
                could affect both channels simultaneously, defeating the redundancy. Route Channel 1
                and Channel 2 in separate cables, ideally on different cable routes.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Wiring:</strong> A normally closed auxiliary contact from each contactor
                  is wired back to the safety relay's feedback input
                </li>
                <li className="pl-1">
                  <strong>Normal operation:</strong> When contactors are energised (running), the NC
                  feedback contacts are open. When the safety relay de-energises, the contactors
                  drop out and the feedback contacts close, confirming the stop
                </li>
                <li className="pl-1">
                  <strong>Fault detection:</strong> If a contactor welds closed, its feedback
                  contact remains open. The safety relay detects this and prevents a restart — the
                  fault must be investigated and repaired
                </li>
                <li className="pl-1">
                  <strong>Multiple contactors:</strong> Feedback contacts from multiple contactors
                  can be series-connected into the EDM input
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Automatic reset:</strong> The safety outputs re-enable as soon as the
                  safety inputs are satisfied. Used for devices with frequent cycling (light
                  curtains, safety mats) where manual reset would impede production
                </li>
                <li className="pl-1">
                  <strong>Manual reset:</strong> The operator must press a reset button after the
                  safety condition is restored. Used for E-stops and guard interlocks where
                  deliberate acknowledgement is required
                </li>
                <li className="pl-1">
                  <strong>Monitored manual reset:</strong> Requires a rising edge on the reset input
                  — the relay checks that the button is not permanently pressed (taped down or
                  stuck). ISO 13849-1 specifies which mode is appropriate based on the risk
                  assessment
                </li>
              </ul>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Siemens MSS 3RK3:</strong> Modular safety system integrated with the
                  SIRIUS range
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Function blocks:</strong> Drag-and-drop blocks for E-stop, guard
                  monitoring, two-hand control, muting, enabling switches
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Verification:</strong> The software compiles and verifies the
                  configuration, generating a CRC checksum to prevent unauthorised modification
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Advantages over Individual Relays
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Reduced panel space — one controller replaces multiple relays
                </li>
                <li className="pl-1">
                  Less wiring — safety devices connect directly to the controller I/O
                </li>
                <li className="pl-1">
                  Enhanced diagnostics — network connections for diagnostic data to PLC/SCADA
                </li>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Step 1:</strong> Check the safety relay LED diagnostics — record the
                  current status
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Step 5:</strong> Verify the reset function — confirm monitored manual
                  reset requires a rising edge
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-white/90 italic">
              <strong>Note:</strong> Under ST1426, maintenance technicians must be able to test
              safety relay systems, interpret diagnostic indicators, carry out like-for-like
              replacements, and document all maintenance actions. Never substitute a safety relay
              with a standard relay or a different model without engineering review and
              re-validation.
            </p>
          </div>
        </section>
