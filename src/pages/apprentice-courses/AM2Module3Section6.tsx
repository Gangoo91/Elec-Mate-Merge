...
const AM2Module3Section6 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['Both are equally bad', 'Neither matters', 'Incomplete work', 'Unsafe work'],
      correctAnswer: 2,
      explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          ...
          complete professional installations within strict timeframes.
        </p>
        ...
        <ConceptBlock title="1. Why Time Management Matters in AM2">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Quality maintained under pressure</strong> - Client expectations don't change
            </li>
            <li>
        ...
        <ConceptBlock title="3. Common Time-Related Mistakes">
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              perfect bends in conduit/trunking, then running out of time for critical terminations.
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Poor documentation:</strong> Incomplete test sheets fail the paperwork section
              entirely
            </li>
            <li>
        ...
        <ConceptBlock title="4. Assessor Expectations on Time Management">
          ...
          <p>
            <strong>Fixed Schedule:</strong> No extensions available regardless of circumstances or
            reasons.
          </p>
          <p>
            <strong>Completion Requirement:</strong> Unfinished work cannot be assessed or credited
            towards pass mark.
          </p>
          <p>
            <strong>Quality Expectations:</strong> Professional standards must be maintained despite
            time constraints.
          </p>
          <p>
        ...
        <ConceptBlock title="5. Practical Strategies for Time Management">
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Work sequence optimisation.</strong> Plan logical progression through phases,
              identify dependencies, prepare for efficient workflow.
            </li>
          </ol>
          <p>
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70" start={4}>
            ...
            <li>
              <strong>Professional standard focus.</strong> Work to consistent professional standard
              across all areas rather than seeking perfection in one area.
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Streamline processes</strong> - Eliminate unnecessary steps while maintaining
              quality
            </li>
            <li>
              <strong>Maintain professional standards</strong> - Better to complete less work safely
              than rush dangerously
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="6. Real-World Examples and Case Studies">
          <p>
            <strong className="text-elec-yellow">Failure Example 1: Perfectionist Approach.</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Scenario:</strong> Candidate completed installation but left only 5 minutes for
            paperwork.
          </p>
          <p>
          ...
          <p>
            <strong>Consequence:</strong> Client rejected the entire job due to delayed completion,
            despite excellent quality work.
          </p>
          <p>
            <strong>Lesson:</strong> Professional standards must be balanced with practical deadline
            management - same principle applies in AM2.
          </p>
        </ConceptBlock>

        <ConceptBlock title="Section Summary - Time Management Mastery">
          <p>
            <strong className="text-elec-yellow">Golden Rule of AM2 Time Management:</strong> "Plan,
            pace, and deliver methodically. Incomplete but safe is better than unsafe. Professional
            standards maintained throughout." Time management in AM2 is about working methodically,
            safely, and steadily to complete the whole installation within professional standards.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Planned, organised approach</strong> - Evidence of systematic working methods
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Time pressure is no defence against this clause. The assessor isn't going to forgive a
              loose terminal or a missed CPC sleeve because you had ten minutes left. Build your
              time plan around hitting Reg 134.1.4 across every joint — that means budgeting enough
              time at the end for proper terminations, not rushing them.
            </>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              Hard deadline is 17:00. You've completed the ring, two radials, lighting and the motor
              circuit — all tested. The cooker circuit is wired but not terminated at the outlet
              plate, the cooker control switch isn't fitted, and your test schedule is blank for
              three circuits. Other candidates around you look done.
            </>
          }
          whatToDo={
            <>
              Triage: paperwork first. Sit down and fill in test results for the four completed
              circuits (you've got the readings — they're in your meter or your notes). 25 minutes.
              Then attack the cooker: terminate at the outlet plate, fit the control switch, run
              continuity + IR + polarity. 50 minutes. Last 15 minutes: final visual, lid check,
              label check. You've completed five circuits cleanly with paperwork done — better than
              six circuits with a blank test schedule.
            </>
          }
          whyItMatters={
            <>
              Assessors mark only completed work. A circuit installed but un-terminated and untested
              is worth almost nothing on the mark sheet — you've used the time without banking the
              marks. Paperwork sits behind a different mark cap that's easy to fail if you leave it.
              "Less work, finished and tested" beats "more work, half done" every time.
            </>
          }
        />
