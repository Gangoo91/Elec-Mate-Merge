      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">1. Hazards in Voids, Risers, and Ceilings</h3>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-[#121212]/50 rounded border">
                      <p className="text-xs sm:text-sm text-white mb-2"><strong>Structural considerations:</strong></p>
                    ...
                    <div className="mt-3 p-3 bg-[#121212]/50 rounded border">
                      <p className="text-xs sm:text-sm text-white mb-2"><strong>Service integration risks:</strong></p>
                      <p className="text-xs text-white">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">2. Legal and Site Requirements</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-[#121212]/50 rounded border">
                      <p className="text-xs sm:text-sm text-white mb-2"><strong>Permit-to-work criteria:</strong></p>
                      <p className="text-xs text-white">
                    ...
                    <div className="mt-3 p-3 bg-[#121212]/50 rounded border">
                      <p className="text-xs sm:text-sm text-white mb-2"><strong>Competence requirements:</strong></p>
                      <p className="text-xs text-white">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">3. Safe Access and Egress</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-[#121212]/50 rounded border">
                      <p className="text-xs sm:text-sm text-white mb-2"><strong>Access equipment selection:</strong></p>
                      <p className="text-xs text-white">
                    ...
                    <div className="mt-3 p-3 bg-[#121212]/50 rounded border">
                      <p className="text-xs sm:text-sm text-white mb-2"><strong>Pre-entry inspection:</strong></p>
                      <p className="text-xs text-white">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">4. PPE and Tools Required</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-amber-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-[#121212]/50 rounded border">
                      <p className="text-xs sm:text-sm text-white mb-2"><strong>Specialised tools and equipment:</strong></p>
                    ...
                    <div className="mt-3 p-3 bg-amber-50/50 dark:bg-amber-900/10 rounded border border-amber-200/30">
                      <p className="text-xs sm:text-sm text-white mb-2"><strong>Equipment maintenance and inspection:</strong></p>
                      <p className="text-xs text-white">
          ...
          {/* Best Practices */}
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">5. Best Practices</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3 p-3 bg-[#121212]/50 rounded border">
                      <p className="text-xs sm:text-sm text-white mb-2"><strong>Documentation and records:</strong></p>
                      <p className="text-xs text-white">
                    ...
                    <div className="mt-3 p-3 bg-[#121212]/50 rounded border">
                      <p className="text-xs sm:text-sm text-white mb-2"><strong>Continuous improvement:</strong></p>
                      <p className="text-xs text-white">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-medium text-white">Risks: restricted access, hidden services, poor lighting, dust</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                <span className="font-medium text-white">Always use safe access equipment (ladders, crawl boards)</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                <span className="font-medium text-white">PPE: helmet, dust mask, head torch, gloves</span>
              </div>
            </div>
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm">
                <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                <span className="font-medium text-white">Permits may be required in risers and confined voids</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                <span className="font-medium text-white">Communicate and keep a safe exit route clear at all times</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <div className="w-2 h-2 bg-elec-yellow rounded-full"></div>
                <span className="font-medium text-white">Use cable/pipe detectors before drilling or cutting</span>
              </div>
            </div>
          </div>
        </Card>
