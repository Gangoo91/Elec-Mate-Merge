...
const DESCRIPTION =
  'Learn safe working practices for voids, risers, and ceiling spaces. Master hazard identification, safe access procedures, and legal requirements for confined and elevated work areas.';
...
const Module4Section7_4 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Cable and pipe detectors identify hidden electrical cables, water pipes, and gas lines that could cause serious injury, service disruption, or damage if accidentally contacted.',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Securing tools with lanyards prevents them from falling through openings and potentially injuring people below or creating hazards in lower areas.',
    },
    {
      id: 10,
  ...
  const faqs = [
    {
      ...
      answer:
        'Yes, in most cases permits are required due to the risks involved, including confined space hazards, critical building services, and emergency access requirements. Always check with site management and follow established procedures.',
    },
    {
      question: 'Can standard site lighting be used in voids?',
      answer:
        'Often, no. Portable, low-voltage, or battery-powered lighting is safer due to the confined nature of these spaces and potential contact with water or damaged cables. Use appropriate IP-rated equipment for the environment.',
    },
    {
      question: 'Is it safe to drill into a ceiling void without checking?',
      answer:
        'No – always use a cable and pipe detector to locate hidden services before drilling. Ceiling voids commonly contain electrical cables, water pipes, gas lines, and other services that could cause serious injury or damage if contacted.',
    },
  ];
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/80 text-sm space-y-1 list-disc ml-4">
                  ...
                  <li>
                    Work at Height Regulations 2005 and confined space procedures apply to these
                    working environments.
                  </li>
                  <li>
                    Safe access equipment, appropriate PPE, and permit-to-work systems are essential
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/80 text-sm space-y-1 list-disc ml-4">
                  ...
                  <li>
                    <strong>Use:</strong> Cable detectors, head torches, crawl boards, secure
                    ladders, communication systems.
                  </li>
                  <li>
                    <strong>Check:</strong> Permit requirements, hidden services, safe access
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-red-500/5 border-l-2 border-red-500/50">
                ...
                <ul className="text-white/80 text-sm space-y-2 list-disc ml-4">
                  ...
                  <li>
                    <strong>Hidden services</strong> - accidental contact with live electrical
                    cables, gas pipes, or water services
                  </li>
                  <li>
                    <strong>Fall hazards</strong> - weak ceiling panels, unguarded openings, and
                    unstable surfaces
                  </li>
                  <li>
                    <strong>Poor lighting conditions</strong> - inadequate visibility makes hazard
                    identification difficult
                  </li>
                  <li>
                    <strong>Dust and insulation exposure</strong> - respiratory irritation and
                    reduced visibility from airborne particles
                  </li>
                  <li>
                    <strong>Fire safety compromise</strong> - damage to fire-stopping materials can
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/80 text-sm space-y-2 list-disc ml-4">
                  ...
                  <li>
                    <strong>Confined Space Regulations 1997</strong> - may apply in risers and
                    enclosed voids with restricted access
                  </li>
                  <li>
                    <strong>Permit-to-work systems</strong> - required for many riser and ceiling
                    void access situations
                  </li>
                  <li>
                    <strong>Risk assessment requirements</strong> - detailed evaluation of specific
                    hazards and control measures
                  </li>
                  <li>
                    <strong>Emergency procedures</strong> - rescue and evacuation plans for confined
                    or elevated spaces
                  </li>
                  <li>
                    <strong>Training and competence</strong> - specific instruction for working in
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  site procedures before commencing work.
                </p>
              </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
                ...
                <ul className="text-white/80 text-sm space-y-2 list-disc ml-4">
                  ...
                  <li>
                    <strong>Three-point contact</strong> - maintain three points of contact when
                    climbing (two hands, one foot or vice versa)
                  </li>
                  <li>
                    <strong>Clear access routes</strong> - ensure voids and risers are free from
                    obstructions before entry
                  </li>
                  <li>
                    <strong>Emergency egress planning</strong> - identify and maintain clear escape
                    routes at all times
                  </li>
                  <li>
                    <strong>Weight distribution systems</strong> - use crawl boards and proper
                    support systems in ceiling voids
                  </li>
                  <li>
                    <strong>Communication protocols</strong> - establish contact procedures with
                    team members outside confined spaces
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  procedures are understood by all team members.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50">
                ...
                <ul className="text-white/80 text-sm space-y-2 list-disc ml-4">
                  ...
                  <li>
                    <strong>Respiratory protection</strong> - dust masks or respirators for
                    insulation fibres and airborne particles
                  </li>
                  <li>
                    <strong>Head torch and portable lighting</strong> - hands-free illumination for
                    adequate visibility
                  </li>
                  <li>
                    <strong>Cut-resistant gloves</strong> - protection from sharp metal edges and
                    rough surfaces
                  </li>
                  <li>
                    <strong>Protective clothing</strong> - coveralls to reduce cuts and
                    contamination from building materials
                  </li>
                  <li>
                    <strong>Safety footwear</strong> - appropriate grip and protection for varied
                    surfaces and debris
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-white/70 text-sm list-disc ml-4 space-y-1">
                  ...
                  <li>
                    <strong>Tool lanyards:</strong> Prevent tools falling through openings and
                    creating hazards below
                  </li>
                  <li>
                    <strong>Crawl boards:</strong> Distribute weight safely across ceiling joists
                    and prevent damage
                  </li>
                  <li>
                    <strong>Low-voltage lighting:</strong> Safer electrical equipment for
                    potentially damp environments
                  </li>
                  <li>
                    <strong>Communication devices:</strong> Two-way radios or mobile phones for
                    emergency contact
                  </li>
                  <li>
                    <strong>Atmosphere testing equipment:</strong> Where confined space hazards may
                    exist
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-amber-500/5 border border-amber-500/20">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  formal inspection records according to manufacturer schedules.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50">
                ...
                <ul className="text-white/80 text-sm space-y-2 list-disc ml-4">
                  ...
                  <li>
                    <strong>Communication protocols</strong> - maintain contact with team members
                    outside void/riser areas
                  </li>
                  <li>
                    <strong>Load distribution</strong> - never overload ceiling grids, use crawl
                    boards for weight distribution
                  </li>
                  <li>
                    <strong>Fire-stopping integrity</strong> - replace ceiling tiles, panels, and
                    fire-stopping materials after work completion
                  </li>
                  <li>
                    <strong>Service identification</strong> - mark and record locations of hidden
                    services for future reference
                  </li>
                  <li>
                    <strong>Emergency preparedness</strong> - ensure rescue equipment and procedures
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-white/70 text-sm space-y-1 list-disc ml-5">
                  ...
                  <li>
                    Test atmosphere in risers and confined spaces where gas accumulation is possible
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-white/70 text-sm space-y-1 list-disc ml-5">
                  ...
                  <li>
                    When working in risers, secure tools with lanyards to prevent falling hazards
                  </li>
                  <li>
                    Never exceed the working load limit of access equipment or ceiling structures
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-white/70 text-sm space-y-1 list-disc ml-5">
                  ...
                  <li>
                    Maintain clear escape routes and emergency lighting throughout work period
                  </li>
                </ul>
              </div>
            </div>
