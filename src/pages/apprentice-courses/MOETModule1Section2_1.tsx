      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Shock:</strong> Current through body — as little as 30 mA can kill
              </li>
              <li className="pl-1">
                <strong>Arc flash:</strong> Up to 20,000 °C plasma, blast pressure, molten metal
              </li>
              <li className="pl-1">
                <strong>Burns:</strong> Contact, arc and flash burns — often deep tissue
              </li>
              <li className="pl-1">
                <strong>Fire:</strong> 14-20% of UK fires are electrical in origin
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              ...
              the driving force that pushes current through the body's resistance, it is the current
              that causes physiological damage. Ohm's Law applies: I = V / R. A higher voltage will
              drive more current through the same body resistance, but environmental conditions (wet
              skin, damp floors, conductive footwear) can dramatically reduce body resistance and
              allow dangerous currents to flow even at relatively low voltages.
            </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Effects of AC Current on the Human Body (50 Hz)
              </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Painful sensation, involuntary muscle contraction begins
                      </td>
                      <td className="border border-white/10 px-3 py-2">Immediate</td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Let-go threshold — cannot voluntarily release the conductor
                      </td>
                      <td className="border border-white/10 px-3 py-2">Immediate</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Ventricular fibrillation likely — potentially fatal
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Cardiac arrest, severe burns, tissue destruction
                      </td>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                The path that current takes through the body determines which organs are affected.
                The most dangerous pathways are those that cross the heart. IEC 60479-1 provides
                data on the percentage of total current that passes through the heart for different
                pathways.
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Left hand to both feet:</strong> Heart current factor 1.0 (reference) —
                  the benchmark pathway
                </li>
                <li className="pl-1">
                  <strong>Left hand to right hand:</strong> Heart current factor 0.4 — 40% of
                ...
                <li className="pl-1">
                  <strong>Left foot to right foot:</strong> Heart current factor 0.04 — lower risk
                  but still hazardous
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>High frequency (&gt;1 kHz):</strong> Less cardiac risk but increased
                  surface heating (diathermy effect)
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Arc Flash PPE Categories (IEEE 1584 / NFPA 70E)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Arc-rated shirt and trousers, safety glasses, hearing protection
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Arc flash suit with hood, arc-rated gloves, leather boots
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Multi-layer arc flash suit, arc-rated hood with face shield, heavy-duty
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Working distance:</strong> Energy decreases with the square of the
                  distance
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Contact burns:</strong> Caused by current flowing through the tissue at
                  the point of contact with a live conductor. These burns are often deep, affecting
                  muscle, nerve and bone tissue below the skin surface. The entry and exit wounds
                  may appear small but mask extensive internal damage — the 'iceberg effect'
                </li>
                <li className="pl-1">
                  <strong>Arc burns:</strong> Caused by the intense radiant heat from an electrical
                  arc. The temperatures involved (up to 20,000 °C) can cause severe burns at
                  distances of several metres. Arc burns are often full-thickness (third-degree) and
                  may require extensive skin grafting
                </li>
                <li className="pl-1">
                  ...
                  skin and eyes. 'Arc eye' (photokeratitis) is a painful condition caused by UV
                  exposure to the cornea and can result from even brief exposure to an electrical
                  arc
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Electrical Fires — Causes and Statistics
              </p>
              <p className="text-sm text-white mb-3">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white mb-3">
                ...
                severe than the primary electrical injury. Maintenance technicians must consider
                secondary injury risks in their work planning and risk assessments.
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Fatalities:</strong> Approximately 5-10 deaths from electricity at work
                  per year (HSE RIDDOR data)
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  'supposedly dead' circuits, and use of unsuitable equipment are the most frequent
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>SELV (Separated Extra-Low Voltage):</strong> Extra-low voltage supply from
                  a safety source (e.g., safety isolating transformer) with no earth connection.
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Common Maintenance Scenarios — LV
                </h3>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Common Maintenance Scenarios — HV
                </h3>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                ...
                retain a lethal charge for several minutes after disconnection. Always follow
                manufacturer's guidance on discharge times and verify with a suitable voltage
                indicator before touching any internal components. UPS batteries present a
                continuous DC hazard that cannot be simply 'switched off' — the battery must be
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                Legal Framework — EAWR 1989 Key Regulations
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Reg 13:</strong> Adequate precautions to prevent re-energisation during
                  work
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Reg 16:</strong> Persons working on electrical systems must be competent
                  or supervised
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              there is no 'so far as is reasonably practicable' qualifier. If danger arises from a
              failure to comply, it is a criminal offence regardless of cost or convenience. Only
              Regulation 29 provides a defence of due diligence.
            </p>
          </div>
        </section>
