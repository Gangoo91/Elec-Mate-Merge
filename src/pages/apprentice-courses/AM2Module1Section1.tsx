    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Learn about the AM2 practical assessment - your pathway to becoming a qualified
          electrician.
        </p>
        ...
        <ConceptBlock title="How You'll Be Assessed">
          ...
          <p>
            <strong>Practical Skills</strong> — each task assessed as Competent / Not Yet Competent:
          </p>
          ...
          <p>
            <strong>Safe Working Practices</strong> — must demonstrate safe isolation and compliance
            throughout:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <div className="my-6">
          <VideoCard
            ...
            caption={
              <>
                Craig walks through the booking criteria — what you need under your belt before NET
                will let you sit AM2, and what's different about AM2E.
              </>
            }
          />
        </div>
        ...
        <ConceptBlock title="How to Prepare">
          ...
          <p>
            ...
            months of focused preparation, including 40-60 hours of additional practice beyond your
            regular work. Many training centres offer AM2 preparation courses which can
        ...
        <Scenario
          ...
          situation={
            <>
              You arrive at the AM2 centre. The assessor hands you a folder with a specification, a
              drawing pack and a blank certificate. Other candidates are unpacking tool bags around
              the rig. You’ve got two and a half days to prove you’re a qualified electrician.
            </>
          }
          whatToDo={
            <>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Practise the practical work. Time your installations. Run through safe isolation until
              it’s automatic. Get comfortable filling in a certificate under pressure. Theory only
              counts in the one-hour online knowledge test.
            </>
          }
        />
