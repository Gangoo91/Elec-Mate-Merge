  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex items-center gap-2 p-3 md:p-4 text-xs md:text-sm text-muted-foreground">
        ...
        <span>/</span>
        <span className="text-emerald-400">Section 1</span>
      </div>
      ...
      <div className="w-full px-4 md:px-8 lg:px-12 xl:px-16 py-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-4 md:mb-6">
          <Card className="bg-card border-emerald-500/30 text-center p-3 md:p-4">
            <div className="text-lg md:text-2xl font-bold text-emerald-400 mb-1">15,000+</div>
            <div className="text-xs text-muted-foreground">Take AM2 annually</div>
          </Card>
          <Card className="bg-card border-emerald-500/30 text-center p-3 md:p-4">
            <div className="text-lg md:text-2xl font-bold text-emerald-400 mb-1">2½ Days</div>
            <div className="text-xs text-muted-foreground">16.5 hours total</div>
          </Card>
          <Card className="bg-card border-emerald-500/30 text-center p-3 md:p-4">
            <div className="text-lg md:text-2xl font-bold text-emerald-400 mb-1">£8,000</div>
            <div className="text-xs text-muted-foreground">Avg salary increase</div>
          </Card>
          <Card className="bg-card border-emerald-500/30 text-center p-3 md:p-4">
            <div className="text-lg md:text-2xl font-bold text-emerald-400 mb-1">NVQ 3</div>
        ...
        <Card className="bg-card border-emerald-500/30 mb-4 md:mb-6">
          <div className="p-3 md:p-4">
            <h2 className="text-lg md:text-xl font-bold text-emerald-400 mb-2 md:mb-3">What is AM2?</h2>
            ...
            <div className="bg-card/80 border border-emerald-500/30 rounded-lg p-3 max-w-3xl">
              <p className="text-muted-foreground text-xs">
                <strong className="text-emerald-400">Important:</strong> This isn't just a test - it's your final step to becoming a fully qualified electrician. 
        ...
        <Card className="bg-card border-emerald-500/30 mb-4 md:mb-6">
          <div className="p-3 md:p-4">
            <h2 className="text-lg md:text-xl font-bold text-emerald-400 mb-2 md:mb-3">AM2 Assessment Components</h2>
            <div className="space-y-3 md:space-y-4 max-w-3xl">
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-3 mt-3 md:mt-4">
        ...
        <Card className="bg-card border-emerald-500/30 mb-4 md:mb-6">
          <div className="p-3 md:p-4">
            <h2 className="text-lg md:text-xl font-bold text-emerald-400 mb-2 md:mb-3">How You'll Be Assessed</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="bg-emerald-500/10 border border-emerald-500/30 rounded p-2">
                    <p className="text-emerald-400 text-xs font-semibold mb-1">Before You Book:</p>
                    <p className="text-muted-foreground text-xs">
          ...
          <div className="p-3 md:p-4">
            ...
            <div className="max-w-3xl space-y-3 md:space-y-4">
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-3">
                <h4 className="text-emerald-400 font-semibold text-sm mb-2">Recommended Preparation Time</h4>
                <p className="text-muted-foreground text-xs">
            ...
            <div className="max-w-3xl space-y-3 md:space-y-4">
              ...
              <div className="bg-card/80 border border-emerald-500/30 rounded-lg p-3">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 text-center">
                  <div>
                    <div className="text-emerald-400 font-bold text-sm md:text-base">£28-32k</div>
                    <div className="text-muted-foreground text-xs">Newly Qualified</div>
                  </div>
                  <div>
                    <div className="text-emerald-400 font-bold text-sm md:text-base">£35-42k</div>
                    <div className="text-muted-foreground text-xs">3-5 Years Experience</div>
                  </div>
                  <div>
                    <div className="text-emerald-400 font-bold text-sm md:text-base">£45-55k</div>
                    <div className="text-muted-foreground text-xs">Senior/Specialist</div>
                  </div>
                  <div>
                    <div className="text-emerald-400 font-bold text-sm md:text-base">£60k+</div>
            ...
            <div className="max-w-3xl space-y-3 md:space-y-4">
              ...
              <div className="grid gap-3 md:gap-4">
                <div className="bg-card border border-red-500/20 rounded-lg p-3">
                  <h4 className="text-emerald-400 font-semibold text-sm mb-2">Time Management Issues</h4>
                ...
                <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-3">
                  <h4 className="text-emerald-400 font-semibold text-sm mb-2">Testing Procedure Errors</h4>
                  <p className="text-muted-foreground text-xs mb-2">
                ...
                <div className="bg-card border border-emerald-500/20 rounded-lg p-3">
                  <h4 className="text-emerald-400 font-semibold text-sm mb-2">Documentation Quality</h4>
                  <p className="text-muted-foreground text-xs mb-2">
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-3">
                <h4 className="text-emerald-400 font-semibold text-sm mb-2">Success Tips</h4>
                <ul className="text-muted-foreground text-xs space-y-1">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-between">
          <Link 
            to=".."
            className="flex items-center gap-2 px-4 py-2 bg-card border border-emerald-500/30 text-foreground rounded-lg hover:border-emerald-500/50 transition-colors text-sm"
          >
          ...
          <Link 
            to="../section2"
            className="flex items-center gap-2 px-4 py-2 bg-emerald-500 text-black rounded-lg hover:bg-emerald-500/90 transition-colors text-sm"
          >
