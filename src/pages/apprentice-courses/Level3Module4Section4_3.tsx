      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Verifying correct conductor connections for safe installation operation
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Understand why correct polarity is essential for electrical safety",
              "Identify BS 7671 requirements for single-pole devices and lampholders",
              "Apply correct polarity verification methods for different circuit types",
              "Recognise symptoms and consequences of reversed polarity",
              "Understand the limitations of plug-in socket testers",
              "Document and classify polarity defects appropriately"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module4-section4-2">
              <ArrowLeft className="w-4 h-4 mr-2" />
