            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="bg-background/50 rounded-lg p-4 border border-border/20">
                ...
                <p className="text-sm text-muted-foreground">
                  Electrical inspection and testing is not only good practice – it is a legal
                  requirement. The Electricity at Work Regulations (EAWR 1989) and BS 7671 Wiring
                  Regulations set clear standards for the design, construction, inspection, and
                  testing of electrical systems. Failure to comply can result in serious injury,
              ...
              <div className="bg-background/50 rounded-lg p-4 border border-border/20">
                ...
                <p className="text-sm text-muted-foreground">
                  This subsection explains the legal framework and why compliance is critical for
                  all electricians. Understanding these requirements protects both you and your
                  clients from legal consequences and safety risks.
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-6">
            ...
            <section className="mb-8">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground mb-4">
                ...
                <li>
                  • Requires initial verification of new installations and periodic
                  inspection/testing of existing ones
                </li>
                <li>
                  • Outlines test procedures: continuity, insulation resistance, polarity, earth
            ...
            <section className="mb-8">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground mb-4">
                ...
                <li>
                  • "Ignorance of the law" is not a defence – all electricians must be competent and
                  aware of requirements
                </li>
                <li>
                  • Poor testing or fraudulent certification can result in prosecution or being
                  struck off professional registers
                </li>
              </ul>
            </section>
            ...
            <section className="mb-6">
              ...
              <div className="space-y-3 text-sm text-muted-foreground">
                ...
                <p>
                  <strong>For Employers:</strong> Liability for injury/death of workers or members
                  of the public.
                </p>
              </div>
            </section>
        ...
        <Card className="mb-8 bg-card border-elec-yellow/20">
          <CardContent className="p-6">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Keep up to date with Amendments to BS 7671 (currently 18th Edition with Amendment
                2)
              </li>
              <li>• Use only calibrated, approved test equipment</li>
              <li>
                • Never sign certificates unless you have carried out or supervised the testing
              </li>
          ...
          <CardContent className="p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm text-muted-foreground">
              <ul className="space-y-2">
                ...
                <li>
                  • <strong>Initial verification</strong> = Must be carried out before energising
                  new systems
                </li>
              </ul>
              <ul className="space-y-2">
            ...
            <div className="space-y-6 text-sm">
              <div className="border-l-4 border-elec-yellow pl-4">
                <p className="font-medium text-foreground mb-1">
                  1. What year were the Electricity at Work Regulations introduced?
                </p>
              ...
              <div className="border-l-4 border-elec-yellow pl-4">
                <p className="font-medium text-foreground mb-1">
                  2. What do Regulations 4(1) & 4(2) of EAWR require?
                </p>
              ...
              <div className="border-l-4 border-elec-yellow pl-4">
                <p className="font-medium text-foreground mb-1">
                  3. Which standard sets out the technical requirements for inspection and testing?
                </p>
              ...
              <div className="border-l-4 border-elec-yellow pl-4">
                <p className="font-medium text-foreground mb-1">
                  4. True or False: It is acceptable to sign an installation certificate without
                  testing if you trust the installer.
                </p>
              ...
              <div className="border-l-4 border-elec-yellow pl-4">
                <p className="font-medium text-foreground mb-1">
                  5. What are two key types of inspection required under BS 7671?
                </p>
                <p className="text-muted-foreground">
              ...
              <div className="border-l-4 border-elec-yellow pl-4">
                <p className="font-medium text-foreground mb-1">
                  6. What must all test instruments be?
                </p>
              ...
              <div className="border-l-4 border-elec-yellow pl-4">
                <p className="font-medium text-foreground mb-1">
                  7. Give one legal consequence of failing to comply with EAWR 1989.
                </p>
                <p className="text-muted-foreground">
              ...
              <div className="border-l-4 border-elec-yellow pl-4">
                <p className="font-medium text-foreground mb-1">
                  8. Who is legally responsible for safety once they sign the Electrical
              ...
              <div className="border-l-4 border-elec-yellow pl-4">
                <p className="font-medium text-foreground mb-1">
                  9. What could happen to an employer if an employee is injured due to unsafe
                  electrics?
                </p>
                <p className="text-muted-foreground">
              ...
              <div className="border-l-4 border-elec-yellow pl-4">
                <p className="font-medium text-foreground mb-1">
                  10. Why is BS 7671 updated periodically?
                </p>
                <p className="text-muted-foreground">
