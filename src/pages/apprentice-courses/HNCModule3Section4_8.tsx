...
const quickCheckQuestions = [
  {
    ...
    options: ['Form 1', 'Form 2', 'Form 4', 'Form 3'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Type 3 (Class III)', 'Type 1 (Class I)', 'Type 1+2 combined', 'Type 2 (Class II)'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Type A', 'Type B', 'Type D', 'Type C'],
    correctAnswer: 1,
    explanation:
...
const HNCModule3Section4_8 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 4 · Subsection 8"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS 7671 A4:2026 made SPD provision the default for all but the simplest installations.
              As the BSE designer of every commercial / industrial / public-access distribution
              board you must apply the Reg 443.4.1 consequence test, document the outcome, and
              specify SPDs to BS EN 61643-11 (Type 1 + 2 at the origin, Type 2 at sub-boards in
              long-cable runs). For all other cases protection is still the default unless the owner
              declares in writing that any loss or damage is tolerable and accepts the risk. Failure
              to do so leaves the building&rsquo;s electronics exposed to switching and atmospheric
              transients with insurance and product-liability consequences.
            </>
          }
        ...
        <ConceptBlock title="Three-Phase Distribution Board Construction">
          <p>
            Modern distribution boards are the nerve centres of building electrical systems, housing
            protection, switching, metering, and increasingly, intelligent monitoring equipment.
            Understanding their construction is essential for specification, installation, and
            maintenance.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Short-circuit withstand (Icw): Must exceed prospective fault current</li>
        ...
        <ConceptBlock title="Busbar Systems and Ratings">
          <p>
            Busbars are the backbone of any distribution system, conducting power from the incoming
            supply to outgoing protective devices. Their design determines the board's
          ...
          <p>
            ...
            harmonic content from LED lighting, IT equipment, and VFDs, triplen harmonics (3rd, 9th,
            15th) add in the neutral conductor. BS 7671 recommends:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Design tip:</strong> Always verify short-circuit withstand (Icw) rating. A 400A
            busbar may have Icw of 25kA for 1 second - this must exceed the prospective fault
        ...
        <ConceptBlock title="Phase Allocation and Load Balancing">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Option 1 - Poor allocation:</strong>
            </li>
            ...
            <li>
              <strong>Option 2 - Better allocation:</strong>
            </li>
            ...
            <li>
              <strong>Option 3 - Optimal allocation:</strong>
            </li>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Practical note:</strong> Perfect balance is theoretical. Real-world loads vary
            continuously. Design for reasonable balance at maximum demand, then monitor and adjust
            post-commissioning.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Type A, B, C Distribution Systems">
          ...
          <p>
            <strong>Configuration:</strong> Single source feeds all loads through individual radial
            circuits.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            (data, life safety) with Type A for general distribution. Cost-benefit analysis should
            consider downtime costs against infrastructure investment.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Surge Protection Devices (SPDs)">
          <p>
            ...
            equipment. SPDs divert surge energy safely to earth, protecting downstream equipment. BS
            7671:2018+A4:2026 significantly strengthened SPD requirements (Section 443/Reg 443.4).
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">SPD Types and Applications</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type 1 (Class I):</strong> Test current 10/350µs (Iimp) — origin/main intake
            </li>
            <li>
              <strong>Type 2 (Class II):</strong> Test current 8/20µs (In, Imax) — sub-distribution
              boards
            </li>
            <li>
          ...
          <p>
            ...
            by the overvoltage could result in:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            declares it is not required due to any loss or damage being tolerable and they accept
            the risk of damage to equipment and any consequential loss.
          </p>
          ...
          <p>
            Multiple SPDs must be coordinated to share surge energy effectively. The distance rule
            applies:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Installation note:</strong> SPD connecting cables should be as short as possible
            (&lt;0.5m) to minimise the voltage drop during surge conditions. Connection in a 'V'
        ...
        <ConceptBlock title="Metering and Monitoring">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fiscal:</strong> Incoming supply — utility billing — DNO meter (MID approved)
            </li>
            <li>
        ...
        <ConceptBlock title="Forms of Separation (Form 1-4)">
          <p>
            ...
            within a switchboard are segregated. Higher forms provide greater safety during
            maintenance and reduced risk of fault propagation.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Form 2a:</strong> Busbars separated; functional units not separated; terminals
              not in same compartment
            </li>
            <li>
              <strong>Form 2b:</strong> Busbars separated; functional units not separated; terminals
              in same compartment
            </li>
            <li>
              <strong>Form 3a:</strong> Busbars separated; functional units separated; terminals not
              in same compartment
            </li>
            <li>
              <strong>Form 3b:</strong> Busbars separated; functional units separated; terminals in
              same compartment
            </li>
            <li>
        ...
        <ConceptBlock title="Panel Schedules and As-Built Documentation">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cct 1:</strong> Lighting - Ground Floor — B16 — 1.5mm² T&amp;E — L1 — Ib 8.7A
              — load 2kW
            </li>
            <li>
              <strong>Cct 2:</strong> Sockets - Office 1 — B32 RCBO — 2.5mm² T&amp;E — L2 — Ib 20A —
              load 4.6kW
            </li>
            <li>
            ...
            <li>
              <strong>Cct 4:</strong> Server Room A/C — C20 — 2.5mm² FP200 — L3 — Ib 15A — load
              3.5kW
            </li>
            <li>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            circuits are added, removed, or modified. Outdated schedules create safety hazards and
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Undersizing the neutral by ignoring harmonic content. Specifying a busbar Icw below
              the prospective fault current. Leaving no spare ways. Forgetting derating above 35°C
              ambient. Long SPD connecting cables that destroy effectiveness. Outdated or missing
              panel schedules.
            </>
          }
          doInstead={
            <>
              Apply Table 5.4a / oversize neutrals for IT &amp; LED loads. Confirm Icw ≥ Ipf at the
              installation point. Allow 20% spare capacity. Derate busbars above 35°C. Keep SPD
              leads &lt;0.5m and use a V-arrangement. Update panel schedules every time a circuit
              changes.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A new hospital ward refurbishment requires a 250 A distribution board feeding 24
              single-phase final circuits (lighting, small power, medical socket-outlets) plus 4
              three-phase circuits (AHU local plant, beverage bay). Initial cost-engineer proposal
              is a Form 2 board to save ~&pound;3.5k. The BSE engineer reviews against the brief and
              HTM 06-01.
            </>
          }
          whatToDo={
            <>
              Specify Form 4 Type 7 (BS EN 61439-1). Health Technical Memorandum HTM 06-01
              (Electrical services supply and distribution) requires Form 4 for healthcare
              patient-treatment areas because it allows live working on one functional unit while
              another remains energised, with full segregation of busbars, devices and outgoing
              cables. Form 2 would force a full board shutdown for any device replacement, which is
              not acceptable on a 24-hour clinical ward. Document the Form 4 selection on the panel
              schedule.
            </>
          }
          whyItMatters={
            <>
              Selecting the wrong Form on a healthcare board breaches HTM 06-01 and creates a
              clinical risk: a full board shutdown means relocating patients and disabling ward
              equipment for the duration of the works. The Form 4 cost premium is 5&ndash;10 % of
              the panel cost and is recovered many times over the panel&rsquo;s 25-year lifecycle
              through avoided clinical disruption.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Section 5</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
