      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              current-carrying capacity, short-circuit withstand capability, and thermal
              performance.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              400A busbar may have Icw of 25kA for 1 second - this must exceed the prospective fault
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Largest continuous load, predictable
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="text-red-400">
                  → Average: 43.3kVA, Max deviation: 16.7kVA (38.5% imbalance)
                </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 space-y-2">
                <p className="text-sm text-white">
                  <strong>Configuration:</strong> Two independent sources (transformers) with
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Type C - Ring Main Distribution
              </p>
              <div className="p-4 rounded-lg bg-white/5 space-y-2">
                <p className="text-sm text-white">
                  <strong>Configuration:</strong> Closed loop feeds multiple distribution points
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              equipment. BS 7671 18th Edition significantly strengthened SPD requirements.
            </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Point of use/sensitive equipment
                      </td>
                    </tr>
                    <tr>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-2">
                CTs enable non-invasive current measurement for metering. Key specifications
                include:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example Panel Schedule Extract
              </p>
              <div className="overflow-x-auto">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Verify prospective fault current from DNO/upstream protection
                </li>
                <li className="pl-1">Calculate design current with appropriate diversity</li>
                <li className="pl-1">
                  Select busbar rating exceeding design current + growth margin
                </li>
                ...
                <li className="pl-1">
                  Consider metering requirements (fiscal, check, sub-metering)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Undersized neutral:</strong> Ignoring harmonic effects on neutral current
                </li>
                <li className="pl-1">
                  <strong>Insufficient Icw:</strong> Busbar short-circuit rating below Ipf
                </li>
                <li className="pl-1">
                  <strong>No spare capacity:</strong> Future additions require new panels
                </li>
                <li className="pl-1">
                  <strong>Ignoring temperature:</strong> Ambient above 35°C needs derating
                </li>
                <li className="pl-1">
                  <strong>SPD cable length:</strong> Long connections reduce effectiveness
                </li>
                <li className="pl-1">
                  <strong>Poor documentation:</strong> Missing or outdated panel schedules
                </li>
              </ul>
            </div>
          </div>
