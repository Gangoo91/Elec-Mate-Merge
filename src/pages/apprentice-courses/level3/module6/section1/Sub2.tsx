...
const quizQuestions = [
  {
    id: 1,
    question:
      'BS 7671 is divided into seven Parts. Which three sit above all the design work in this module?',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'Reg 312 covers division of the installation. Why does the designer care about this at design stage?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'Reg 313 covers supply characteristics. The designer must know all of the following EXCEPT:',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'Reg 314 covers external influences. Which BS 7671 Appendix gives you the full classification matrix?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'Why does the L3 designer care about Reg 132 (in Part 1) AND Reg 311 to 314 (in Part 3)?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'On a small commercial fit-out the DNO declares Ze = 0.35 ohm, PSCC = 16 kA, three-phase 400/230 V TN-C-S, 100 A per phase. Which Reg is this information collected against?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'You discover during the survey that the existing building is classified BE2 (fire propagation risk) under Appendix 5. Which design decisions follow from that?',
    options: [
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 1 · Subsection 2"
        title="BS 7671 Parts 1, 2 and 3 — the design ground"
        backTo="/study-centre/apprentice/level3-module6-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Scope, definitions and the assessment of general characteristics. The three Parts you read
          first on every new design and revisit every time something unusual lands.
        </p>
        ...
        >
          <p>BS 7671:2018+A4:2026 is structured as seven Parts plus a series of Appendices:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Part 1</strong> — Scope, object and fundamental principles (Chapters 11 to 14,
              Reg 110 to 134).
            </li>
            <li>
            ...
            <li>
              <strong>Part 3</strong> — Assessment of general characteristics (Reg 311 to 314).
            </li>
            <li>
              <strong>Part 4</strong> — Protection for safety (Chapters 41 to 46 — shock, thermal
              effects, overcurrent, voltage disturbances, isolation).
            </li>
            <li>
              <strong>Part 5</strong> — Selection and erection of equipment (Chapters 51 to 56 —
              common rules, wiring systems, accessories, earthing, other equipment, safety
              services).
            </li>
            <li>
              <strong>Part 6</strong> — Inspection, testing and certification.
            </li>
            <li>
              <strong>Part 7</strong> — Special installations or locations (701 bathrooms, 702
              pools, 703 saunas, 704 sites, 705 agriculture, 706 conducting locations, 708 caravan
              parks, 709 marinas, 710 medical, 711 exhibitions, 712 PV, 715 ELV lighting, 717 mobile
              units, 721 caravans, 722 EV, 729 corridors, 730 shore connections, 740 fairgrounds,
              753 floor and ceiling heating).
            </li>
          </ul>
          <p>
            For the L3 designer, Parts 1 to 3 do the structural work. Without the assessment in Part
            3 you have no inputs for Part 4 protection, no basis for Part 5 selection and nothing to
            verify in Part 6.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 110 names what BS 7671 covers — essentially every fixed LV installation in a
              building, on a site, on a vehicle or in a temporary structure that connects to a
              public or private LV supply. The exclusions (110.2) are equally important: HV systems
              above 1000 V AC, supply industry distribution networks, railway / aircraft / marine
              traction, and lightning protection systems (which sit under BS EN 62305). When a
              project crosses one of those boundaries you have to pull in the matching standard.
            </>
          }
        ...
        >
          <p>
            Part 2 is alphabetical and runs to dozens of pages. It defines every concept used
            elsewhere in the standard — competent person, exposed-conductive-part,
            extraneous-conductive-part, RCD, RCBO, AFDD, SPD, MET, simultaneous accessibility, basic
            protection, fault protection, additional protection, and many more.
          </p>
          <p>
            The discipline matters because the same English word can mean different things. The word
            "earth" in casual speech might mean MET, CPC, earth electrode, building structural steel
            or even just the ground. In a BS 7671 design specification each of those is a separate
            term with a separate definition and a separate regulatory consequence. Sloppy vocabulary
            in a design pack invites the installer to make assumptions you did not intend.
          </p>
          <p>
            When in doubt, write the term and the product standard together: B32 RCBO to BS EN
            61009-1, 30 mA Type A leaves no room for substitution; 32 A trip with built-in RCD
            invites the cheapest device the wholesaler has on the shelf.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 311.1 requires the designer to determine the maximum demand of the installation,
            having due regard to diversity. The output is the design current at the origin and at
            every sub-main and final circuit.
          </p>
          <p>
            Diversity recognises that not every appliance runs at full nameplate load
            simultaneously. A three-bed dwelling with 30 kW of nameplate connected load (cooker,
            immersion, shower, ring finals, lighting, EV, heat pump) typically draws 60-80 A peak —
            not the 130 A the nameplate sum implies. The diversity factors come from the IET On-Site
            Guide Table A1, IET Guidance Note 1, and manufacturer-specific data for special loads.
          </p>
          <p>
            Section 2 of this module digs into diversity in detail. For now, the Part 3 message is:
            maximum demand is an assessment, not a calculation; you document your assumptions; and
            the result feeds every cable and device size downstream.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 312 covers the structural decisions about how the installation is broken into
            circuits, sub-mains and DBs. The driver is fault containment and operational continuity:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Fault on one circuit must not deprive the whole installation of supply (Reg 314.1).
            </li>
            <li>
              Critical functions (fire alarm, emergency lighting, security, IT life-support) need
              dedicated supplies that are not affected by routine maintenance shut-downs (Reg 312
              plus Section 56 for safety services).
            </li>
            <li>
              Each part of the installation must be capable of being isolated for inspection and
              testing without shutting the whole installation down (Reg 314.2).
            </li>
            <li>
              The number and type of live conductors and the type of system earthing influence how
              circuits are grouped and how protection is set.
            </li>
          </ul>
          <p>
            On a domestic CU upgrade Reg 312 is mostly about RCD grouping (which circuits share a 30
            mA RCD bank, where RCBOs make sense to avoid nuisance loss-of-supply). On a commercial
            fit-out it is about how many DBs, where they sit, what feeds the fire-alarm panel, how
            the lift power is segregated.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 312.1 is the explicit hook for single-phase or three-phase and L-N or L-L-L-N or
              L-L. The choice cascades into device selection (single pole MCB versus three-pole
              MCCB), cable arrangement, isolation requirements, and how Zs is calculated. On many
              commercial projects the design starts with a single-phase service and grows to
              three-phase as the load assessment grows; Reg 312 is the regulatory anchor for that
              escalation. Reg 312.1.1 covers AC arrangements (figures for single-phase 2/3-wire,
              two-phase 3-wire, three-phase 3/4-wire) and Reg 312.1.2 covers DC arrangements.
            </>
          }
        ...
        >
          <p>Reg 313 lists the supply characteristics the designer must determine:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Nature of current</strong> — AC or DC (almost always AC at LV in the UK).
            </li>
            <li>
              <strong>Nominal voltage</strong> — 230 V single-phase, 400/230 V three-phase plus
              neutral, harmonised tolerances of plus 10 percent and minus 6 percent.
            </li>
            <li>
              <strong>Frequency</strong> — 50 Hz nominal, narrow tolerance.
            </li>
            <li>
              <strong>Number and type of live conductors</strong> — L+N, L+L, L+L+L+N (3-phase
              4-wire).
            </li>
            <li>
              <strong>Type of system earthing</strong> — TN-S, TN-C-S (PNB or PME), TT, IT.
            </li>
            <li>
              <strong>External earth fault loop impedance</strong> — Ze, declared by the DNO.
            </li>
            <li>
              <strong>Prospective short-circuit current</strong> — PSCC, declared by the DNO at the
              origin.
            </li>
            <li>
              <strong>Suitability for use</strong> — phases balanced, harmonics, unwanted DC content
              (relevant for EV chargers and inverter-fed loads).
            </li>
            <li>
              <strong>Maximum demand permitted</strong> — service capacity, often the gating factor
              on whether the DNO will allow a heat pump or EV charger without an upgrade.
            </li>
          </ul>
          <p>
            Note the A4:2026 update: the TN-C-S arrangement now distinguishes between PME
            (Protective Multiple Earthing — DNO carries out multiple earthings of the combined N+PE
            conductor along the network) and PNB (Protective Neutral Bonding — single earthing point
            at the consumer side, often used on private substations). The two have slightly
            different design implications, particularly around O-PEN protection on EV chargers and
            around lost-neutral risk on rural overhead lines.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 132.2(c)(i)–(v) is the modern home for the supply characteristics record. The Ze
              figure, prospective fault current and earthing arrangement cap every protective device
              decision; the maximum allowable current set by the DNO caps every load assessment; the
              inherent protective measures and any distributor-specific requirements feed device
              selection and installation method. The figures must come from the DNO in writing —
              verbal numbers are not auditable, and getting them wrong invalidates the whole design.
            </>
          }
        ...
        >
          <p>
            Reg 314 requires the designer to assess the external influences acting on the
            installation at every location. Appendix 5 gives the full classification matrix from IEC
            60364-5-51:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>AA</strong> — ambient temperature (AA1 to AA8, from below minus 60 deg C to
              above plus 60 deg C).
            </li>
            <li>
              <strong>AB</strong> — atmospheric humidity.
            </li>
            <li>
              <strong>AD</strong> — presence of water (AD1 negligible to AD8 submersion).
            </li>
            <li>
              <strong>AE</strong> — presence of foreign solid bodies, paired with IP digit.
            </li>
            <li>
              <strong>AF</strong> — presence of corrosive or polluting substances.
            </li>
            <li>
              <strong>AG</strong> — mechanical stresses (AG1 low to AG3 high, paired with IK
              rating).
            </li>
            <li>
              <strong>BA</strong> — capability of persons (BA1 ordinary persons, BA4 instructed, BA5
              skilled).
            </li>
            <li>
              <strong>BD</strong> — conditions of evacuation in emergency (BD1 normal to BD4
              difficult or high density).
            </li>
            <li>
              <strong>BE</strong> — nature of processed or stored materials (BE1 no significant
              risk, BE2 fire risk, BE3 explosion risk).
            </li>
          </ul>
          <p>
            The classification feeds equipment selection in Part 5. A switchgear cabinet in an
            outdoor enclosure that experiences AA5 (minus 25 deg C to plus 40 deg C) and AD4
            (splashing water) needs a minimum IP44 rating and a temperature derating on devices. A
            consumer unit in a domestic kitchen that experiences AA4 and AD2 (occasional moisture)
            is fine at IP2X with the standard temperature spec. Get this wrong and your installation
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>132.2</strong> — Characteristics of available supply (Reg 313 evidence).
            </li>
            <li>
              <strong>132.3</strong> — Nature of demand (loads, diversity, demand profile — Reg
              311).
            </li>
            <li>
              <strong>132.4</strong> — Local conditions affecting installation (Reg 314 external
              influences).
            </li>
            <li>
              <strong>132.5</strong> — Cross-sectional area of conductors (Reg 523, Appendix 4 CCC).
            </li>
            <li>
              <strong>132.6</strong> — Type of wiring and methods of installation (Reg 521,
              Reference Methods).
            </li>
            <li>
              <strong>132.7</strong> — Protective equipment (Chapter 41 ADS, Chapter 43 overcurrent,
              Chapter 44 voltage disturbance).
            </li>
            <li>
              <strong>132.8</strong> — Emergency control (Chapter 46 isolation and switching, Reg
              537).
            </li>
            <li>
              <strong>132.9</strong> — Disconnecting devices (Chapter 46 again, with
              discrimination).
            </li>
            <li>
              <strong>132.10</strong> — Prevention of mutual detrimental influence (segregation, EMC
              — Section 528, Section 444).
            </li>
            <li>
              <strong>132.11</strong> — Accessibility (Regulation 132.13 ergonomics, Reg 513 access
              for inspection).
            </li>
            <li>
              <strong>132.13</strong> — Identification and notices (Reg 514 labelling).
            </li>
            <li>
              <strong>132.13</strong> — Documentation (drawings, calcs, schedules — covered in Sub
              1.1).
            </li>
            <li>
              <strong>132.14</strong> — Mutual detrimental influences (combined safety services —
              Section 56).
            </li>
            <li>
              <strong>132.15</strong> — Power supplies for safety services (Section 56 again, BS
              5266 emergency lighting, BS 5839 fire alarm).
            </li>
            <li>
              <strong>132.16</strong> — Additions and alterations (Reg 132.16, EICR consideration
              before extension).
            </li>
          </ul>
          <p>
        ...
        >
          <p>The headline A4:2026 changes that touch Parts 1 to 3 directly:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 132.13 wording on documentation</strong> — clarified to expect
              documentation sufficient for the installation to be operated, maintained, altered,
              extended, inspected and tested by another competent person. The list of "operate,
              maintain, alter, extend, inspect, test" is explicit rather than implicit.
            </li>
            <li>
              <strong>TN-C-S sub-types</strong> in Reg 312/313 — the standard now distinguishes
              between PME (Protective Multiple Earthing — DNO public network) and PNB (Protective
              Neutral Bonding — single earth at the consumer side, often on private substations).
              The two have different design implications, particularly around O-PEN protection on EV
              chargers and around the lost-neutral risk profile.
            </li>
            <li>
              <strong>AFDD wording in Reg 421.1.7</strong> — moved from "may be installed" toward
              "recommending" for residential final circuits. Not yet a hard requirement for general
              use; harder for HRRB, social housing and HMOs. The L3 designer should treat AFDDs as
              the default for new dwellings unless cost or coordination justifies leaving them out —
            ...
            <li>
              ...
              AFDD presence, EV charger O-PEN protection, RCD type per circuit. The L3 designer must
              specify these per circuit so the inspector can populate the schedule honestly.
            </li>
          </ul>
          <p>
            ...
            progress complete to the previous edition with documented justification, but new designs
            from the amendment effective date must follow A4.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You have been engaged to design the electrical fit-out of a 220 m² ground-floor cafe
              in a refurbished Victorian building. The supply is to be upgraded from the existing 60
              A single-phase to a new 100 A three-phase service. Loads include lighting,
              refrigeration, electric cooking equipment, three induction hobs, EPOS and IT, an
              EV-charge-ready outlet on the side wall and an external sign.
            </>
          }
          whatToDo={
            <>
              Run the Reg 311-314 assessment as a discrete document. Reg 311: connected load 78 kVA,
              applied diversity from IET GN1 yields 42 kVA peak demand, 60 A per phase — fits within
              the new 100 A per phase service. Reg 312: one main DB at the back of the kitchen,
              sub-main to a small DB at the front for shop and signs, dedicated supply to fire alarm
              and emergency lighting (Section 56). Reg 313: DNO Form 1 confirms TN-C-S (PME), Ze =
              0.35 ohm, PSCC = 16 kA, 100 A BS 88-3 service fuse at origin. Reg 314: AA4 (minus 5 to
              plus 40 inside, hob area AA5 transient hot), AD3 spray near sink and dishwasher, AE2
              small foreign bodies, AG2 medium mechanical stress in kitchen, BA1 customers, BA2
              staff, BA5 cleaners and contractors, BD2 (low evacuation density), BE2 (commercial
              kitchen fire risk).
            </>
          }
          whyItMatters={
            <>
              The Part 3 assessment now drives every later decision. The PSCC of 16 kA forces 16
              kA-rated devices throughout. The PME earthing forces O-PEN protection at the EV-ready
              outlet. The BE2 fire risk forces LSF cables on escape routes and fire-stopped
              penetrations. The AD3 spray rating pushes the sockets near the sink to IP44 and the
              cooker switch to a remote position. Without the structured Part 3 assessment, every
              one of those decisions is a guess.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A junior designer writes a cable specification and cites Reg 525 (voltage drop) but
              never references the supply characteristics in Reg 313. The installer queries the
              cable size; the designer cannot defend it because the input data was never documented.
              The whole calc has to be redone from scratch with proper Part 3 evidence.
            </>
          }
          doInstead={
            <>
              Every design decision should cite the Part 3 input it depends on AND the Part 4 or
              Part 5 reg it satisfies. A cable spec might read: 6 mm² T+E, Reference Method C,
              derated 0.94 for ambient 35 deg C (Reg 313 location AA4 + Reg 523), satisfying Reg
              525.202 voltage drop at design current 32 A. That single line ties Part 3 to Part 5
              and to the calc — the installer or inspector can audit it without asking you.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The drawing says "earth conductor 6 mm²"; the installer fits a 6 mm² CPC and assumes
              the main protective bonding conductor is also 6 mm². Building Control inspects and
              finds the bonding undersized for a TN-C-S supply (where 10 mm² is typical). The
              installer asks for the calc; the designer realises the spec was ambiguous.
            </>
          }
          doInstead={
            <>
              Use Part 2 vocabulary precisely. Specify circuit protective conductor (CPC) 6 mm² and
              main protective bonding conductor 10 mm² as separate entries. Better still, list every
              earthing and bonding conductor in a small schedule with its CSA, function and BS 7671
              cross-reference (Reg 543 for CPC, Reg 544 for main protective bonding, Reg 415.2 for
              supplementary bonding). Ambiguous vocabulary creates ambiguous installations.
            </>
          }
        />
