    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The structural shift from L2 installer to L3 designer — new scope, new liability, new
          documentation. The design pen, the duties under BS 7671 Reg 132, and the everyday reality
          of what changes when you start being the person who decides what gets built.
        </p>
        ...
        >
          <p>
            Level 2 trains you to install electrical work to a specification — wire, terminate,
            test, certify the workmanship. The specification (which cable, what device, where the DB
            sits, what the disconnection time should be) is taken as a given. Your job is to execute
            it correctly.
          </p>
          <p>
            ...
            EFLI, and sign the design declaration on the EIC that says "this design complies with BS
            7671". The cable on the wall is then someone else's job — possibly yours, often not. But
            the design is yours.
          </p>
          <p>
            The two competences are deliberately separable. On a small domestic CU upgrade the same
            electrician designs, installs and certifies — three signatures, one person. On a
            hospital wing fit-out the designer is in an office, the installer is on site, the
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Regulation 132 is the umbrella under which the whole design module sits. It names the
              designer as a distinct role, sets out fourteen specific design considerations (supply
              characteristics, nature of demand, conductors, wiring systems, protective measures,
              isolation and switching, accessibility, documentation and so on), and makes the
              designer the responsible party. Every later Sub in this module corresponds to one or
              more of those fourteen considerations.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              for the inspection and testing of the installation... CERTIFY that the inspection and
              testing for which I have been responsible..."
            </li>
          </ul>
          <p>
        ...
        >
          <p>At the L3 design level, your specific responsibilities include:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              Calculating the maximum demand of the installation after the application of diversity
              (Reg 311.1, AC 8.3 and AC 8.1).
            </li>
            <li>
            ...
            <li>
              Selecting cables (Reg 523, AC 8.6 and AC 8.8) — Reference Method, derate stack (Ca,
              Cg, Ci), required tabulated It, voltage drop verification (Reg 525.202).
            </li>
            <li>
        ...
        >
          <p>
            ...
            equivalent products and applies workmanship; the inspector verifies. If you specify "70
            °C thermoplastic T&E to BS 6004, 6 mm² with 2.5 mm² CPC" and the installer fits
            compliant cable from a different manufacturer, that is not a deviation — that is the
            normal operation of the design. If they fit 4 mm² instead, that is a deviation, and the
            design no longer applies.
          </p>
          <p>
            If you also wear the installer or inspector hat on the same job, you do not somehow
            merge the roles into one. You sign three boxes for three responsibilities, and you are
            honest about which you can stand behind. Do not sign a box for work you did not
        ...
        >
          <p>
            BS 7671 Reg 132.13 spells out what the designer must leave behind. The list is specific:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              ...
              earth fault loop impedance, disconnection times, thermal constraints (adiabatic check
              on protective conductors).
            </li>
            <li>
          ...
          <p>
            ...
            "design pack" — the same idea by different names. On a small job it might be three A4
            sheets; on a large fit-out it might be a fifty-page document with appendices. The
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The Reg 132.1 framework is the long-term safety regulation. The next person who works
              on the installation needs to know what was designed, why, and to what calculation —
              and the framework requires the designer to determine and record the supply and
              installation information at Regs 132.2–132.5. Without that documentation every
              modification is a guess and every periodic inspection is incomplete. The minimum
              documentation floor is the EIC plus the schedule of test results plus the schedule of
              inspections; the design pack adds the calculations, device specs, and operating notes
              that make the EIC properly traceable.
            </>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A homeowner wants the works: a 100 A TN-C-S supply, existing 60 A board with no spare
              ways, a planned 7 kW EV charger on the driveway, a 4 kWp solar PV array on the south
              roof, a 5 kWh AC-coupled battery in the loft, and an 8 kW air-source heat pump
              replacing the gas boiler in eighteen months. They want it all wired in "now or in
              stages — whichever is cheaper".
            </>
          }
          whatToDo={
            <>
              Design the end state, install in stages. Specify a 14-way RCBO board (10 used now, 4
              spare for future loads). Confirm DNO maximum demand allowance is sufficient — if not,
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              design signature is preferable to a fraudulent one.
            </>
          }
        />
        ...
        >
          <p>
            CDM 2015 (Construction (Design and Management) Regulations) makes the designer a named
            dutyholder. Reg 9 of CDM requires designers to eliminate, reduce or control foreseeable
            risks that arise during construction, maintenance, cleaning, alteration, demolition or
            use of the structure. The output is a design risk register — a live document that
            travels with the design pack:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Residual risk</strong> — what the constructor and the future maintainer still
              need to manage. Documented in the design pack and in the Health and Safety File at
              handover.
            </li>
          </ul>
          <p>
            On a HRRB the risk register is part of the golden thread. On a typical commercial
            fit-out it sits in the pre-construction information. On a small domestic CU upgrade it
            can be a half-page note — the form scales, but the duty does not.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            documentation — distinct from public liability, which covers physical injury or property
            damage during the work. Examples of PI claims:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              A Vd calculation error means LED drivers cut out at the far end of a long radial. The
              customer claims for replacement equipment plus loss of trading.
            </li>
            <li>
              A discrimination scheme failure means a downstream B16 trips along with a 100 A BS 88
              main on a fault. The customer claims for the cost of restoring the main supply
              including out-of-hours call-out.
            </li>
            <li>
              An EFLI calculation that did not allow for cable temperature rise gives a measured Zs
              that exceeds Table 41.3 maxima — the periodic inspection codes the install C2, and the
              customer claims for the rework.
            </li>
          </ul>
          <p>
            Cover floors: £1m PI for small-works (single dwellings, small commercial fit-outs); £2m
            for typical commercial work; £5m+ for any HRRB, hospital, school or industrial project.
            Keep your policy aligned with the work type — under-insurance can void cover entirely.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Design has two converging objectives — safety first, function second. The competent
              designer is named as &quot;skilled persons&quot; in the regulation wording. As an L3
              apprentice you support the designer; the design judgement calls remain with the named
              competent person on the certificate.
            </>
          }
