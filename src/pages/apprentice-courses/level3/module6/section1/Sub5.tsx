...
const TITLE =
  'Sources of information that drive the design (1.5) | Level 3 Module 6.1.5 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question:
      'Which document is the source-of-truth for the supply characteristics required by Reg 313 of BS 7671?',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'On a multi-discipline project, the architect’s drawings conflict with the M&E coordinator’s service routes. The L3 designer should:',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'When the IET On-Site Guide simplification disagrees with a BS 7671 Appendix 4 detailed calc, which governs?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'Which UK regulator publishes Approved Documents A through to S that interpret the Building Regulations?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'The client brief is a primary design input. What should it include for an L3 designer to start work?',
    options: [
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 1 · Subsection 5"
        title="Sources of information that drive the design"
        backTo="/study-centre/apprentice/level3-module6-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Client brief, architect drawings, structural engineer notes, DNO supply data, manufacturer
          datasheets, IET Guidance Notes, On-Site Guide. Where each one fits, how to weight
          conflicts, and how to cite every input on the design pack so the calc is auditable years
          later.
        </p>
        ...
        >
          <p>The L3 design pack is the synthesis of multiple inputs:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Client brief</strong> — functional, performance, aesthetic, operational and
              budget requirements. Should be written and signed off, not verbal.
            </li>
            <li>
              <strong>2. Architect and structural drawings</strong> — building layout, room
              functions, structural constraints, services voids, fire compartments, accessibility
              provisions.
            </li>
            <li>
              <strong>3. M&E coordinator drawings</strong> — mechanical and other-services routes
              that the electrical design must work around or alongside.
            </li>
            <li>
              <strong>4. DNO supply data</strong> — DNO Form 1 with voltage, Ze, PSCC, earthing
              arrangement, conductor configuration, maximum demand permitted.
            </li>
            <li>
              <strong>5. BS 7671:2018+A4:2026</strong> — the core technical standard.
            </li>
            <li>
              <strong>6. IET Guidance Notes (GN1-8) and On-Site Guide</strong> — authoritative
              interpretation and worked examples.
            </li>
            <li>
              <strong>7. Manufacturer datasheets</strong> — product-specific cable, device,
              accessory and equipment data with installation requirements.
            </li>
            <li>
              <strong>8. Industry guidance</strong> — Building Regulations Approved Documents,
              BS-series standards (BS 5266 emergency lighting, BS 5839 fire alarm, BS 7430 earthing,
              BS 7671 itself), Health and Safety Executive guidance, NICEIC and NAPIT technical
              bulletins.
            </li>
          </ul>
          <p>
            Each input has a place in the design pack and a citation reference. Where two inputs
            disagree, the source-hierarchy rule resolves it — statutory law over BS 7671 over IET
            GNs over manufacturer over precedent. Document the conflict and the resolution.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 132.2(c)(iv) is the explicit hook for &quot;get the supply data from the DNO
              before you start&quot;. The DNO declaration (Form 1 or each DNO’s online equivalent)
              is the source-of-truth document — covering nominal voltage, frequency, max allowable
              current, prospective fault current and external earth fault loop impedance. It must be
              on file in the design pack and quoted on the EIC. Without it, every design decision
        ...
        >
          <p>A complete client brief covers:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Function</strong> — what the installation must do. Lighting type per room,
              socket numbers and positions, special-purpose circuits (cooker, shower, EV, PV, heat
              pump, AV, IT).
            </li>
            <li>
              <strong>Performance</strong> — loads, anticipated peak demand, criticality (which
              circuits cannot tolerate downtime), expansion provision (future EV, future PV, future
              loft conversion).
            </li>
            <li>
              <strong>Aesthetics</strong> — accessory style and finish, conspicuous-or-flush
              mounting, surface or recessed luminaires, customer-preferred brand or scheme
              membership constraints.
            </li>
            <li>
              <strong>Operation</strong> — who maintains, isolation strategy, smart-home
              integration, energy monitoring, periodic test access.
            </li>
            <li>
              <strong>Constraints</strong> — budget, timescale, planning conditions,
              conservation-area restrictions, listed-building consent if applicable.
            </li>
          </ul>
          <p>
            Where the brief is verbal or incomplete, the L3 designer writes back what they have
            understood and asks for written sign-off. This single email or short brief acceptance
            document protects against later scope-creep complaints and forms part of the design
            pack.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The UK DNOs (UK Power Networks, National Grid Electricity Distribution, Northern
            Powergrid, Electricity North West, SP Energy Networks, SSEN) each publish a supply data
            request form on their website. The standard turnaround is 5-10 working days; urgent and
            connection-application requests can be expedited.
          </p>
          <p>The DNO declaration covers:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Service type and earthing arrangement (TN-S, TN-C-S PNB or PME, TT) — and where TN-C-S
              is used, sometimes the rural overhead line lost-neutral risk note.
            </li>
            <li>Nominal voltage and tolerance.</li>
            <li>
              Maximum demand permitted (often the gating factor on EV / heat pump / PV designs).
            </li>
            ...
            <li>
              Type and rating of the supply protective device (typically 60 A or 100 A BS 88-3
              service fuse).
            </li>
            <li>
              Network conductor configuration (single-phase, three-phase 3-wire, three-phase
              4-wire).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            On any project larger than a domestic CU upgrade, the L3 designer works alongside other
            disciplines:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Architect drawings</strong> — building layout, room functions, finishes, fire
              compartments, accessibility provisions, conservation constraints.
            </li>
            <li>
              <strong>Structural engineer notes</strong> — load-bearing walls (no chasing without
              consent), steel positions, slab thickness (cable depth restrictions), penetration
              constraints.
            </li>
            <li>
              <strong>M&E coordinator drawings</strong> — HVAC routes, plumbing risers, gas service
              positions, ducting, sprinkler layouts. Your cables must avoid or work around these.
            </li>
            <li>
              <strong>Fire engineer drawings</strong> — escape routes, fire compartments,
              smoke-control zones, fire alarm device positions, evacuation lift requirements.
            </li>
            <li>
              <strong>Acoustic engineer notes</strong> — for hospitality, education and healthcare,
              where transformer noise and switchgear hum can affect compliance with acoustic
              targets.
            </li>
          </ul>
          <p>
            On larger projects these sit in a Common Data Environment (CDE) — Procore, Asite, BIM
            360, Autodesk Construction Cloud, etc. The L3 designer pulls the drawings,
            cross-references them against the electrical design, raises RFIs for conflicts and
            uploads the electrical drawings back into the CDE.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The IET Guidance Notes are the IET’s detailed elaboration of specific BS 7671 Parts and
            Chapters:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>GN1</strong> — Selection and Erection. The most-used GN; covers Part 5 in
              depth.
            </li>
            <li>
              <strong>GN3</strong> — Inspection and Testing. Covers Part 6 in depth.
            </li>
            <li>
              <strong>GN5</strong> — Protection Against Electric Shock. Covers Chapter 41 in depth.
            </li>
            <li>
              <strong>GN6</strong> — Protection Against Overcurrent. Covers Chapter 43 in depth.
            </li>
            <li>
              <strong>GN7</strong> — Special Locations. Covers Part 7 in depth.
            </li>
            <li>
              <strong>GN8</strong> — Earthing and Bonding. Covers Chapter 54 in depth.
            </li>
            <li>
              <strong>On-Site Guide (OSG)</strong> — the day-to-day pocket book for typical domestic
              and small-commercial work.
            </li>
          </ul>
          <p>
            The OSG simplifies BS 7671 selection for typical cases under explicit assumptions
            (typical Reference Methods, no exceptional grouping, no exceptional ambient). Where
            install conditions exceed those assumptions, go back to BS 7671 directly. Document the
            calc.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Manufacturer datasheets typically include:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Trip and time-current curves</strong> — for circuit-breakers and RCBOs,
              plotting tripping time against fault current.
            </li>
            <li>
              <strong>Breaking capacity (Icu, Ics)</strong> — Icu is the rated ultimate
              short-circuit breaking capacity; Ics is the rated service short-circuit breaking
              capacity (the device must remain serviceable after operation at this current).
            </li>
            <li>
              <strong>IP / IK ratings</strong> — environmental and impact protection.
            </li>
            <li>
              <strong>Ambient temperature range</strong> — devices typically rated for -5 deg C to
              +40 deg C; outdoor and high-ambient locations need rated devices or derating.
            </li>
            <li>
              <strong>Installation clearances</strong> — heat dissipation, ventilation, doorset
              clearances, conduit entry positions.
            </li>
            <li>
              <strong>Compatibility statements</strong> — RCD type compatibility (Type AC, A, F, B),
              TN-C-S / PME compatibility, fire compartment integrity.
            </li>
            <li>
              <strong>Test data</strong> — verified per IEC test procedures, with certificate
              references.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The hierarchy applies when two sources within the design give different answers:</p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Statutory law</strong> — Building Regulations, Equality Act, Electricity at
              Work Regulations, Health and Safety at Work Act. Non-negotiable.
            </li>
            <li>
              <strong>BS 7671</strong> — the recognised technical standard.
            </li>
            <li>
              <strong>IET Guidance Notes and the On-Site Guide</strong> — authoritative
              interpretation, but bounded by their stated assumptions.
            </li>
            <li>
              <strong>Manufacturer datasheets</strong> — product-specific, but specific to that
              product and its tested conditions.
            </li>
            <li>
              <strong>Trade body guidance</strong> — NICEIC, NAPIT, ECA, BEAMA technical bulletins.
              Useful supplementary, especially on fast-moving topics like AFDD, EV charger O-PEN
              protection, PV battery integration.
            </li>
            <li>
              <strong>Industry custom and previous installation precedent</strong> — weakest source.
              "We always do it this way" is not a defence if the design is challenged.
            </li>
          </ol>
          <p>
            When two sources within the same tier disagree (two manufacturer datasheets for similar
            products, two trade bulletins from different bodies), pick the more conservative or seek
            a third source. The conflict and the resolution go in the design log.
          </p>
        </ConceptBlock>
        ...
        >
          <p>A complete L3 design pack typically contains:</p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Part 3 assessment sheet</strong> — Reg 311 (max demand with diversity), Reg
              312 (division of installation), Reg 313 (supply characteristics), Reg 314 (external
              influences with Appendix 5 codes per zone).
            </li>
            <li>
            ...
            <li>
              ...
              Ci, voltage drop), EFLI Zs at design stage (Cmin 0.95 applied — Table 41.3 floors e.g.
              B32 = 1.37 ohm at A4:2026), discrimination check, thermal adiabatic check on CPCs.
            </li>
            <li>
              <strong>Schedules</strong> — circuit schedule (number, function, cable, device, Zs
              design, Zs limit), accessory schedule (heights, contrast, types), accessibility-aid
              schedule, fire-alarm device schedule.
            </li>
            <li>
              <strong>Drawings</strong> — single-line schematic, layout drawings (cable routes,
              accessory positions, DB locations, fire-stop positions), schematic of safety services
              (Section 56), refuge point comms layout where applicable.
            </li>
            <li>
              <strong>Design risk register</strong> — CDM 2015 hazard log with design action and
              residual risk per item.
            </li>
            <li>
              <strong>Change log</strong> — every revision since first issue, with reason, affected
              drawings/schedules, RFI references.
            </li>
            <li>
              <strong>Sign-off</strong> — designer signature, date, professional indemnity policy
              reference, scheme membership reference, BS 7671 amendment level cited.
            </li>
          </ol>
          <p>
            Version control matters as much as content. Every page footer should carry the project
            number, revision letter, date and "uncontrolled if printed" notice. The master pack
            lives in cloud storage with version history; superseded revisions are retained but
            clearly marked. Twenty years from now the next designer should be able to pick up the
            pack, open the change log, and reconstruct every decision since first issue.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You are designing a 12 kW air-source heat pump retrofit on an existing 100 A TN-C-S
              supply in a four-bed dwelling. The customer brief specifies a Mitsubishi Ecodan; the
              manufacturer datasheet states "minimum cable 6 mm² T+E, RCD Type A 30 mA, dedicated
              radial." The IET GN1 cable selection method gives 10 mm² for the 25 m cable run with 2
              m in 100 mm of insulation and grouping with two other circuits in a 16 mm conduit. The
              OSG simplification gives 6 mm² for typical heat pump circuits without grouping. The
              DNO Form 1 confirms the supply is TN-C-S (PME) with 100 A capacity, current peak
              demand assessed at 65 A.
            </>
          }
          whatToDo={
            <>
              Source hierarchy: BS 7671 / IET GN1 calc governs over OSG simplification because the
              install conditions exceed OSG assumptions (grouping in conduit, partial insulation
              enclosure). Specify 10 mm² T+E to GN1 method. Manufacturer datasheet 6 mm² minimum is
              satisfied (10 mm² is greater). RCD specification: manufacturer says Type A; check the
              Mitsubishi inverter spec for DC content — if the inverter generates DC fault residuals
              greater than 6 mA, BS 7671 Section 722 (analogous EV requirement) and the latest BEAMA
              bulletin push to Type B (or Type A with a DC monitoring relay). Document the cable
              calc per GN1 in the design pack with citations: BS 7671 Table 4D5 Reference Method
              100, App 4 Ca 0.94 (ambient 35 deg C), Cg 0.79 (3 circuits in conduit), Ci 0.78
              (partial insulation), Mitsubishi datasheet rev 2024-Q3, DNO Form 1 ref XXXX.
            </>
          }
          whyItMatters={
            <>
              Without the source-hierarchy discipline, the designer might cite the OSG and install 6
              mm². Six months later the cable runs hot under sustained heat pump load, the
              insulation degrades, and the fault becomes an EICR finding (or an insurance claim).
              The design pack with explicit citations defends against this — the inspector can see
              which source was used and why, and can verify the Reference Method and derating stack
              for themselves. The single page of citations turns an opinion into evidence.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A designer specifies 2.5 mm² for a 32 A ring final based on the OSG, but the install
              runs 18 m of the cable through the loft above 100 mm of insulation in a two-circuit
              grouping. The OSG’s assumed conditions do not include this grouping or insulation
              enclosure. The cable fails CCC under the actual derating stack. EICR findings six
              months later code C2.
            </>
          }
          doInstead={
            <>
              When install conditions exceed the OSG assumed conditions, go back to BS 7671 Appendix
              4 Tables and apply the Reference Method, Ca, Cg, Ci stack explicitly. Document the
              calc in the design pack with the source citations. The OSG is for typical cases within
              its own footnoted assumptions; pushing past those assumptions without going back to BS
              7671 is the source of most CCC errors.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The customer says "the usual" and the designer assumes a typical socket density. The
              customer expected dedicated AV power on every wall. The disagreement at handover
              becomes a payment dispute. Without a written brief acceptance, both parties have a
              reasonable case.
            </>
          }
          doInstead={
            <>
              After the initial conversation, write back what you have understood (functional,
              performance, aesthetic, operational, constraints — the five headings). Ask for written
              sign-off. Even a one-paragraph email reply ("yes, this is what I want") is enough. The
              brief acceptance becomes part of the design pack and protects against scope-creep.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Customer briefing closes one part of the design pack; supply characteristics close
              another. The designer must determine and record the maximum allowable current,
              alongside the other Reg 132.2 supply data — nature of current, conductor count,
              voltage and tolerances, frequency, prospective fault current, and external earth fault
              loop impedance. Assumed values are not acceptable — measurement, enquiry or
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              operating conditions and, where appropriate, for fault conditions according to: (a)
              the admissible maximum temperature; (b) the admissible voltage drop; (c) the
              electromechanical stresses likely to occur due to short-circuit and earth fault
              currents; (d) other mechanical stresses to which the conductors are likely to be
              exposed; (e) the maximum impedance for correct operation of short-circuit and earth
              fault protection; (f) the method of installation; (g) harmonics; (h) thermal
              insulation.
            </>
          }
          meaning={
            <>
              ...
              conductor sizing is the next design output the pack must demonstrate. Reg 132.6 lists
              the eight inputs the designer must consider — current rating, voltage drop, fault
              current stress, impedance for ADS, install method, harmonics, thermal insulation. Each
              input traces back to data the brief or DNO Form 1 supplied. Recording the csa
              rationale against these eight criteria is what makes the design defensible at handover
              and at the next periodic inspection.
            </>
          }
