...
const checks = [
  {
    ...
    options: [
      ...
      '150 mm to 450 mm — close to the floor so that wheelchair users do not have to reach upward.',
      '1400 mm to 1800 mm — at standing eye level so the accessories are easy to see.',
      "There is no specified range — switch and socket heights are left entirely to the installer's discretion in every dwelling.",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Install the switch at 1700 mm as the client asked — the Equality Act only applies once a disabled member of staff is actually employed, so current staffing means there is no duty yet.',
      'Refuse to do the job at all, because installing any switch outside the accessible range would make you personally liable for discrimination and there is no compliant way to proceed.',
      'Install the switch at 1700 mm but add an extra low-level switch at 1000 mm as well, doubling up so that both the tall staff member and any future disabled user are served.',
...
const quizQuestions = [
  {
    id: 1,
    question:
      'The Equality Act 2010 imposes which kind of design duty on the L3 electrical designer?',
    options: [
      'A reactive duty — the designer only has to make changes once a disabled user has been identified and has formally requested an adjustment.',
      ...
      "A voluntary duty — accessibility provisions are good practice but the Equality Act leaves them entirely to the client's discretion.",
      'A one-off duty — the designer considers accessibility only at the planning stage and has no obligation once the building is occupied.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'One — a single accessibility standard applies to all new dwellings with no categories.',
      'Two — visitable dwellings and wheelchair-user dwellings, with nothing in between.',
      ...
      'Five — graded A to E by the local authority according to the level of disabled access provided.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'At any height the homeowner prefers — Category 3 removes the reach-range rule entirely because the dwelling is designed around a specific occupant.',
      'Below 450 mm throughout, so that everything can be reached from a seated wheelchair position close to the floor.',
      'At standard heights of 450 mm for sockets and 1200 mm for switches, with no corner-setback or two-way switching requirement added.',
      '450-1200 mm above FFL, at least 350 mm from internal corners, with two-way bedroom switching from the bed position.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Lux level, uniformity, glare and colour rendering, plus accessibility provisions such as contrast trim, audible feedback and an induction loop.',
      'Only the lux level — reception lighting needs nothing more than the right brightness, with glare, contrast and hearing-loop provision irrelevant at a desk.',
      'Only the cable size feeding the luminaires — lighting design at a reception is purely a circuit-sizing exercise with no accessibility considerations.',
      'Only the emergency-lighting duration — a reception desk needs 3-hour emergency cover and nothing else from the lighting design.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      'BS 5266-1 sets emergency lighting floors. The minimum horizontal illuminance across the full width of an escape route is:',
    options: [
      ...
      '10 lux for at least 3 hours after supply failure, matching the high-risk task-area level.',
      '0.2 lux for at least 30 minutes after supply failure, with uniformity not exceeding 10:1.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Audible only, but louder than a standard chime — a high-output sounder rated at least 75 dB is sufficient for a Category 3 dwelling.',
      'Visible only — a beacon strobe with no chime, since an audible signal serves no purpose in a wheelchair-user dwelling.',
      'Audible AND visible — a beacon strobe alongside the chime, seen from the living area and bedrooms, with vibrating-pad provision.',
      'A standard mains-powered chime identical to that in any dwelling — Category 3 imposes no special doorbell requirement.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A standard light switch by the door and nothing more — accessible WCs need no special electrical provision beyond ordinary lighting.',
      'A motion-sensor light with a fast 30-second timeout, so the light switches off quickly to save energy whenever no movement is detected.',
      'An RCD-protected socket inside the cubicle for a wheelchair charger, but no pull-cord alarm, occupancy indicator or reachable controls.',
      'Reachable controls, an occupancy indicator, a slow-acting light timer, and a red emergency pull-cord alarming outside the cubicle and at reception.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Per-zone Approved Document M or BS 8300 compliance, lux calculations, an accessibility-aid schedule, and an Equality Act anticipatory-duty statement.',
      'A single tick-box on the EIC confirming "accessibility considered" — no schedule, calculations or per-zone evidence are needed beyond that one line.',
      'A verbal assurance to the client that the design is accessible, recorded in a phone note rather than in the design pack.',
      "Nothing in the design pack — accessibility is the client's responsibility once the building is occupied, so the designer keeps no evidence of it.",
    ],
    correctAnswer: 0,
    explanation:
...
const faqs = [
  ...
  {
    question:
      'A homeowner with a disability asks for non-standard switch heights. Do the Approved Document M numbers still apply?',
    answer:
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 1 · Subsection 4"
        title="Equality Act and accessibility in electrical design"
        backTo="/study-centre/apprentice/level3-module6-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The accessibility floor every L3 electrical designer must clear. How the Equality Act 2010
          anticipatory duty, Approved Document M and BS 8300 push specific design decisions on
          socket heights, switch positions, lux levels, accessibility aids and dwelling adaptation.
        </p>
        ...
        >
          <p>
            The Equality Act 2010 consolidates UK anti-discrimination law. For the L3 electrical
            designer, the most important provisions are:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Section 20 — Duty to make reasonable adjustments.</strong> Service providers,
              employers and landlords must adjust premises and procedures to remove disadvantage to
              disabled persons.
            </li>
            <li>
              <strong>The anticipatory duty.</strong> The duty is not reactive (wait for a disabled
              user to complain) but anticipatory — the design must already be
              reasonable-adjustment-ready when occupied.
            </li>
            <li>
              <strong>Section 21 — Failure to comply.</strong> Failure to make reasonable
              adjustments is unlawful discrimination, enforceable through the courts.
            </li>
            <li>
              <strong>Section 29 — Provision of services.</strong> Service providers (shops,
              restaurants, offices, healthcare, hospitality) must not discriminate. Inaccessible
              electrical fittings are part of this.
            </li>
          </ul>
          <p>
            Compliance with the Equality Act in the built environment usually means: follow Approved
            Document M for construction; follow BS 8300 for non-residential design detail; document
            the anticipatory-duty consideration on the design cover sheet; and where the user is
            known and has specific needs, design to the user (Disabled Facilities Grant adaptation
            route).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              bites the L3 electrical designer — switch and socket heights, controls reach, lux
              levels, audible-and-visible alarms, induction loops, accessible WC pull-cord systems.
              The "reasonable" qualifier means proportionate to the size of the service provider and
              the nature of the building, but the Equality and Human Rights Commission Code of
              Practice and case law have set a high floor for what counts as reasonable in new
              design and major refurbishment.
            </>
          }
        ...
        >
          <p>
            Approved Document M Volume 1 covers dwellings and divides accessibility into three
            categories. The local authority planning condition sets which category applies to a
            given new dwelling:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Category 1 — Visitable dwellings.</strong> The floor for all new dwellings.
              Step-free entrance, accessible WC at entrance level, adequate doorset widths, switches
              and sockets within the 450-1200 mm reach band.
            </li>
            <li>
              <strong>Category 2 — Accessible and adaptable dwellings.</strong> Step-free
              throughout, level access shower rooms ready for adaptation, additional structural
              provisions for future grab-rail fitting, light reinforcement above bath. Electrical:
              same 450-1200 mm reach band with additional two-way switching at the main accessible
              bedroom.
            </li>
            <li>
              <strong>Category 3 — Wheelchair user dwellings.</strong> Two sub-categories: 3a
              wheelchair adaptable and 3b wheelchair accessible. Full wheelchair turning circles,
              hoist provision in bedroom and bathroom, height-adjustable surfaces. Electrical:
              450-1200 mm range, 350 mm corner setback for wheelchair clearance, two-way switching
              at every bedroom from bed position, dual-mode doorbells (audible and visible),
              assistive-technology cabling provision.
            </li>
          </ul>
          <p>
            The category drives the electrical schedule. On a Cat 3 dwelling the schedule must show
            every switch, socket and accessory at a compliant height with a compliant clearance from
            internal corners. On a Cat 1 dwelling the floor is lower but still applies to switches,
            sockets and primary controls.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Approved Document M Volume 2 covers non-residential buildings. The principal differences
            from Volume 1:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Switches and sockets typically 750-1200 mm for primary controls, 400-1000 mm for
              secondary controls (slightly narrower than the dwelling band).
            </li>
            <li>
              Accessible WC provision per occupancy — pull-cord alarm system, audible-and-visible
              signal at the WC and at reception, lighting with a slow-acting timer to avoid trapping
              users in darkness.
            </li>
            <li>
              Reception and counter positions — induction loops at all service counters,
              accessible-height counter provision, audible feedback on call buttons.
            </li>
            <li>
              Lift provisions — accessible lift sizing and lift control accessibility (Braille
              buttons, audible floor announcement, contrasting button colours, control panel within
              reach band).
            </li>
            <li>
              Refuge points on escape routes for buildings above ground floor — communication
              systems (Type B per BS 9999) so disabled persons can summon help during evacuation.
            </li>
            <li>
              Lighting — uniform lux on circulation routes, glare control, contrast of door frames
              and accessory trim with surrounding wall.
            </li>
          </ul>
          <p>
            For deeper detail, BS 8300 (parts 1 and 2) is the comprehensive technical standard.
            Approved Document M references BS 8300 explicitly as a compliance route for the harder
            cases.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The 450-1200 mm reach band is the dwelling baseline. Below 450 mm forces wheelchair
              users to bend forward beyond their stable centre of gravity; above 1200 mm exceeds
              standing reach for some users and seated reach for most wheelchair users. The band is
              generous enough that you can group sockets at 450-500 mm (low), accessible switches at
              900-1100 mm (mid), and pendant pull cords slightly higher within the band.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Accessible WCs: 300 lux uniform, with accessible switch position and slow-acting
              timer.
            </li>
            <li>
              Schools / classrooms: 300 lux on desk, glare control to UGR less than 19, daylight
              dimming linkable.
            </li>
            <li>Healthcare bedside: 300 lux reading, 100 lux ambient, individual control.</li>
          </ul>
          <p>On top of the lux floor, accessibility considerations include:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Uniformity</strong> — minimum/average lux ratio above 0.6 across the task area
              to avoid bright/dark patches that disorient partially-sighted users.
            </li>
            <li>
              <strong>Glare</strong> — Unified Glare Rating (UGR) below 19 in offices, below 22 in
              retail.
            </li>
            <li>
              <strong>Colour rendering</strong> — Ra above 80 minimum, above 90 for healthcare and
              care homes (so users can correctly identify medication colours, food appearance,
              contrast cues).
            </li>
            <li>
              <strong>Colour temperature</strong> — 3500-4000K for general indoor; 2700-3000K for
              hospitality and care homes; 5000K+ only for high-contrast task areas.
            </li>
            <li>
              <strong>Contrast</strong> — accessory trim, switch colour, door frame, handrail and
              step-nosing must contrast with surrounding finishes (luminance contrast above 30
              percent typically).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The 1 lux escape route floor sounds small but is enough for orientation and safe
              walking pace if the uniformity is good. The 3-hour duration covers buildings where
              re-occupation may be required without waiting for full mains restoration. Anti-panic
              lighting in open areas above 60 m² is 0.5 lux. High-risk task areas (machinery
              shutdown, plant rooms) need 15 lux or 10 percent of normal task lighting, whichever is
              higher. Accessibility considerations layer on: are exit signs visible from low
              (wheelchair) viewing positions, do contrast levels at doorways guide partially-sighted
              evacuees, are the luminaires positioned to avoid glare into the line of sight?
            </>
          }
        ...
        >
          <p>Typical entries on a commercial fit-out accessibility-aid schedule:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Induction loops</strong> at reception, meeting rooms, training rooms — BS
              7594, signage with international hearing loop symbol, periodic test points, loop
              driver maintenance access.
            </li>
            <li>
              <strong>Accessible WC pull-cord alarms</strong> — red cord reaching the floor, audible
              signal at WC and at reception, visible strobe at WC outside-door indicator, reset only
              from inside.
            </li>
            <li>
              <strong>Visible alarms</strong> — xenon strobe beacons in addition to sounders for
              fire and intruder alarms in deaf-accessible dwellings or large open-plan spaces.
            </li>
            <li>
              <strong>Doorbells with dual mode</strong> — audible chime plus visible beacon strobe
              in dwellings adapted for hard-of-hearing residents.
            </li>
            <li>
              <strong>Refuge point communications</strong> — Type B emergency voice communication
              systems on stairwell refuge points (BS 9999) for buildings above ground floor.
            </li>
            <li>
              <strong>Lift accessibility</strong> — Braille and tactile buttons, audible floor
              announcement, contrasting trim, control panel reach band.
            </li>
            <li>
              <strong>Assistive-technology cabling</strong> — Cat 6 / 6A data cabling provision for
              smart home interfaces, voice control systems, environmental control units (ECUs) in
              adapted dwellings.
            </li>
          </ul>
          <p>
            Each entry on the schedule references the standard (BS 7594, BS 8300, BS 5839-6, BS
            9999), the location, the device specification and the periodic test routine. The
            schedule lives in the design pack and accompanies the EIC into the customer’s file.
          </p>
        </ConceptBlock>
        ...
        >
          <p>BS 8300 (Design of an accessible and inclusive built environment) has two parts:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>BS 8300-2:2018+A1:2020</strong> — Buildings. The detailed technical floor for
              non-residential buildings: door clearances, ironmongery contrast, accessible WC layout
              (with the pull-cord alarm system specified in detail), induction loop installation,
              lift accessibility (Braille, audible announcement, contrasting buttons, control panel
              reach), refuge point equipment.
            </li>
          </ul>
          <p>Specific L3 electrical clauses worth knowing:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Switch and socket contrast</strong> — luminance contrast above 30 percent
              between accessory plate and surrounding wall finish, helping partially-sighted users
              locate controls.
            </li>
            <li>
              <strong>Accessible WC pull-cord</strong> — red cord, two pendant rings (550 mm and 100
              mm above floor) so reachable from seated and from floor-fallen positions, audible at
              WC and at staffed reception, visible strobe outside the cubicle door, reset only from
              inside.
            </li>
            <li>
              <strong>Induction loop signal field</strong> — minimum 100 mA/m at the listening
              position, verified at commissioning with a calibrated field-strength meter to BS 7594.
            </li>
            <li>
              <strong>Lift control buttons</strong> — contrast against the panel, raised tactile or
              Braille, audible feedback, control panel within the 900-1200 mm reach band.
            </li>
            <li>
              <strong>Refuge point equipment</strong> — two-way emergency voice communication to a
              permanently-staffed location (BS 9999 Type B), red call point, instructions visible
              from wheelchair height.
            </li>
          </ul>
          <p>
            The L3 design pack on a major fit-out cites BS 8300-2 explicitly per zone alongside the
            Approved Document M reference. Professional clients (NHS Trusts, university estates,
            retail chains) will not accept a design pack that cites only Approved Document M.
          </p>
        </ConceptBlock>
        ...
        >
          <p>BS 5839 splits into two principal parts for the L3 designer:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BS 5839-6 — Fire detection and fire alarm systems for dwellings.</strong>
              Categorises systems from LD3 (smoke detector in escape route only) to LD1 (every room
              except small storage). For dwellings adapted for deaf or hard-of-hearing residents,
              additional sounder-strobe combinations and vibrating-pad accessories are specified.
            </li>
            <li>
              ...
              reasonably be heard or relied upon — typically WCs, plant rooms, areas with high
              ambient noise above 80 dB(A), and zones used by deaf or hard-of-hearing occupants.
            </li>
          </ul>
          <p>
            VAD specification follows BS EN 54-23 (visual alarm devices). The candela rating must
            produce at least 0.4 lux on every wall surface in the protected space, with viewing
            angle considered (wall-mounted, ceiling-mounted, corner-mounted devices have different
            effective ranges). Coverage volumes are specified by manufacturer per the EN 54-23
            categories C-3-x (ceiling), W-x-y (wall) or O (open).
          </p>
          <p>
            Practical L3 design rule: in any non-residential WC, plant room or sleeping zone,
            specify a VAD in addition to the sounder unless a documented BS 5839-1 risk assessment
            justifies otherwise. In any dwelling adapted for deaf or hard-of-hearing residents,
            specify sounder-strobe combinations in living areas, bedrooms and kitchens, plus a
            vibrating-pad accessory under the pillow for night-time alerting.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              between 800 mm and 1200 mm above the parking-bay surface (the 800 mm floor is higher
              than the dwelling 450 mm because the user is approaching from a wheelchair across an
              accessible parking bay rather than reaching down from a seated position inside a
              dwelling).
            </li>
            <li>
            ...
            <li>
              <strong>Authentication</strong> — contactless card or app-based authentication rather
              than PIN-only, to suit users with limited dexterity. RFID at 800-1200 mm, screen at
              the same band.
            </li>
            <li>
              <strong>Parking-bay layout</strong> — accessible chargers placed at accessible parking
              bays (typically 3.6 m wide rather than the standard 2.4 m), with hatched transfer zone
              clear of the cable run.
            </li>
            <li>
            ...
            <li>
              ...
              average illuminance during hours of darkness, with uniformity above 0.4 across the bay
          ...
          <p>
            ...
            cable, contactless authentication, and integration with the dwelling smart-home system
            if present. Document the user-led decisions in the design pack.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You are designing the electrical fit-out of a single-floor 320 m² high-street travel
              agency replacing a dated retail unit. The design includes reception counters, four
              customer pods, a training room, an accessible WC, a small staff area and a stockroom.
              The client is a national chain with an Equality Act compliance team.
            </>
          }
          whatToDo={
            <>
              The accessibility-aid schedule shows: induction loops at reception (perimeter loop,
              100 W driver) and at each customer pod (small-area loop, 30 W driver) — BS 7594;
              accessible WC pull-cord alarm with audible at WC, visible strobe at WC outside-door
              indicator and reception, reset inside; visible alarm beacons in the staff WC and
              stockroom (deaf-accessible) supplementing the BS 5839-1 Cat L3 system; lighting
              designed to CIBSE LG07 retail floor (300 lux task on counters, 200 lux ambient, UGR
              less than 22, Ra above 90 for fabric and travel literature display, 3500K colour
              temperature, 0.6 uniformity); emergency lighting to BS 5266-1 (1 lux escape route, 0.5
              lux anti-panic across the open retail area, 3-hour duration); switch heights at 1000
              mm (mid-range of 750-1200 mm for non-residential primary controls), socket heights at
              600 mm low and 1000 mm at counter level. Cover sheet declaration: Equality Act 2010
              anticipatory duty considered, BS 8300-2 referenced, accessibility-aid schedule
              attached.
            </>
          }
          whyItMatters={
            <>
              The chain’s Equality Act compliance team will audit the documentation rather than the
              install. They want to see the schedule, the standards cited, the Equality Act
              statement and the lux calc. A design that is technically perfect but undocumented
              fails their audit. A design that explicitly maps each accessibility decision to the
              standard and to the regulatory duty satisfies the audit and protects the chain from
              future complaint. This is the kind of design discipline that wins repeat work from
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The fit-out includes an accessible WC; the design shows the cubicle but not the
              pull-cord alarm system. The customer occupies the building; a disabled customer is
              trapped in the WC for 40 minutes after a fall before staff notice. The Equality Act
              complaint that follows asks why the standard accessibility provision was missing. The
              customer turns to the design pack and finds no mention.
            </>
          }
          doInstead={
            <>
              Accessible WC pull-cord alarm systems are standard expected provision. Specify on
              every accessible WC: red pull-cord reaching the floor, audible alarm inside the WC,
              visible strobe outside the cubicle door, slave indicator at reception, reset only from
              inside the WC. The system can be a stand-alone (locally-powered with battery backup)
              or integrated with the building alarm panel. Document on the accessibility-aid
              schedule with the BS standard reference (BS 8300-2 and the relevant alarm standard).
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A Cat 3 wheelchair user dwelling design specifies lighting per the lux floor but
              installs single one-way switching to bedroom lights — wall switch by the door only.
              The user cannot operate the bedroom light from the bed without a smart-home interface.
              The reasonable adjustment claim follows.
            </>
          }
          doInstead={
            <>
              Cat 3 dwellings require two-way switching from the bed position for primary lighting
              in every bedroom. Specify a wall switch at the door AND a switch within reach of the
              bed (typically pendant pull or bed-head switch). For Cat 2 the same provision is
              required for the principal bedroom only; for Cat 1 it is good practice in any double
              bedroom. The cabling cost is trivial; the accessibility and adaptability benefit is
              significant.
            </>
          }
        />
