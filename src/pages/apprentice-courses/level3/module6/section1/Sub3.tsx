...
const TITLE =
  'Statutory context — Part P, Part L, BSA 2022 (1.3) | Level 3 Module 6.1.3 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: [
      ...
      'Yes — any addition of a new socket is always notifiable in England, regardless of whether it creates a new circuit or sits in a special location.',
      'Yes — adding a socket counts as altering the consumer unit, and all consumer-unit work is notifiable under Part P.',
      'No — and no certificate of any kind is required, because adding a single socket to an existing circuit is exempt from both notification and BS 7671 certification.',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Disconnection times — Part L sets the maximum Zs and ADS requirements for final circuits in new dwellings.',
      'Earthing arrangement — Part L decides whether a new dwelling is supplied as TN-C-S, TN-S or TT.',
      'Cable sizing — Part L specifies the minimum conductor CSA for every circuit in a new build.',
      'Energy efficiency — lighting efficacy, heating control, and EV / PV / heat-pump readiness in new dwellings.',
    ],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Nothing changes for the electrical designer — the Act applies only to the cladding and structural elements, leaving the design under ordinary Part P rules.',
      'The building is exempt from BS 7671 because it falls under the Building Safety Regulator, which has its own wiring standard the design must follow instead.',
      'The building is a higher-risk residential building, so a higher competence floor, golden-thread documentation and likely mandatory AFDDs apply.',
      'The designer must downgrade every circuit to a TT earthing arrangement, because the Act prohibits PME supplies in any building over 18 m.',
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'Commercial and industrial premises only, with dwellings covered separately by the Electricity at Work Regulations.',
      ...
      'All premises of every type — Part P is the universal electrical-safety Approved Document covering dwellings, offices, factories and public buildings alike.',
      'New-build dwellings only — Part P does not apply to alterations or additions in existing homes.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Replacing a damaged socket-outlet on a like-for-like basis anywhere in the dwelling.',
      'Adding a spur to an existing ring final circuit in a bedroom or living room.',
      ...
      'Replacing a light fitting or repairing a section of damaged cable on an existing circuit.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A full consumer-unit replacement — the MWC is the certificate used whenever a board is changed.',
      'The installation of one or more entirely new circuits — the MWC certifies new circuit work.',
      'Periodic inspection of an existing installation — the MWC is the report issued at the end of an EICR.',
      'An addition or alteration to an existing circuit that does not create a new circuit.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 4,
    question:
      'The Future Homes Standard (England, 2025+) drives which electrical design changes in new dwellings?',
    options: [
      'Heat-pump-ready infrastructure, EV charging provision, PV and battery enabling, and a move away from gas connections in many new builds.',
      'A mandatory switch to TT earthing for all new dwellings, removing PME supplies to reduce broken-neutral risk.',
      'A requirement that every final circuit in a new dwelling be protected by an AFDD, replacing all standard MCBs and RCBOs.',
      'A blanket increase in the standard domestic supply from 100 A to 200 A per phase to cope with future loads.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Any residential building of three or more storeys, regardless of height or the number of units it contains.',
      'A residential building of at least 18 m in height OR at least 7 storeys, AND containing at least 2 residential units.',
      'Any building over 30 m in height, whether residential, commercial or industrial.',
      'A residential building of at least 11 m in height OR at least 4 storeys, with any number of units.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A single continuous earthing conductor running unbroken from the main earthing terminal to every accessory, coloured gold to distinguish it from the CPC.',
      'A paper site-folder kept on the plant-room wall for the duration of construction only, then discarded once the building is handed over.',
      'A digital, structured record of design and safety-critical information, maintained from design stage to handover to the Accountable Person.',
      'A fire-resistant cable type required for life-safety circuits in higher-risk residential buildings, named for its gold-coloured sheath.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 7,
    question:
      'You are designing a CU upgrade in a dwelling. Which of the following triggers Part P notification?',
    options: [
      'Re-labelling the existing circuits inside the board — updating the circuit chart is treated as a notifiable alteration.',
      'Replacing a single MCB on the existing board with a like-for-like device — swapping a protective device is notifiable.',
      'Tightening the terminations and re-testing the existing installation — routine maintenance counts as notifiable work.',
  ...
  },
  {
    ...
    options: [
      'Three gateways: Gateway 1 at planning, Gateway 2 before construction, Gateway 3 before occupation, each requiring BSR sign-off.',
      'A single gateway at handover, where the completed building is inspected once and signed off for occupation in one step.',
      'Two gateways: one before any design work starts and one after the building has been occupied for twelve months.',
      "Five annual gateways throughout the building's life, each renewing the occupation certificate for a further year.",
    ],
    correctAnswer: 0,
    explanation:
...
const faqs = [
  ...
  {
    question:
      'What is the practical difference between the Building Safety Regulator and Building Control for me?',
    answer:
  ...
  {
    question:
      'How does the Construction (Design and Management) Regulations 2015 (CDM) interact with the L3 designer role?',
    answer:
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 1 · Subsection 3"
        title="Statutory context — Part P, Part L and BSA 2022"
        backTo="/study-centre/apprentice/level3-module6-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Building Regulations Part P (notifiable work in dwellings), Part L (energy efficiency,
          increasingly driving low-carbon-ready electrical infrastructure), and the Building Safety
          Act 2022 footprint on higher-risk residential buildings.
        </p>
        ...
        >
          <p>
            The Building Regulations 2010 (England) are statutory instruments enforced by Building
            Control. They divide construction into Approved Documents A through to S:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Part A</strong> — Structure (loads on structure from your switchgear, cable
              trays, transformer pads).
            </li>
            <li>
              <strong>Part B</strong> — Fire safety (escape routes, fire alarm interfaces,
              segregation of safety services, cable selection on escape routes).
            </li>
            <li>
              <strong>Part L</strong> — Conservation of fuel and power (lighting efficacy, heating
              control, low-carbon-ready provisions).
            </li>
            <li>
              <strong>Part M</strong> — Access to and use of buildings (socket and switch heights,
              accessibility provisions).
            </li>
            <li>
              <strong>Part P</strong> — Electrical safety (dwellings only, England).
            </li>
            <li>
              <strong>Part S</strong> — Infrastructure for charging electric vehicles (new dwellings
              and major refurbishment, since 2022).
            </li>
          </ul>
          <p>
            The L3 electrical designer touches Part B, Part L, Part M, Part P and Part S as routine.
            Part A and other parts come into play on larger projects. Each Approved Document is
            government guidance on how to comply with the statutory instrument; following the
            Approved Document is one accepted way of meeting the law, but not the only way (you can
            argue equivalence, with evidence).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Part P is a single short statutory paragraph. The detail of what counts as "reasonable
              provision" is in Approved Document P, which references BS 7671 as the recognised
              technical means. Compliance with BS 7671 is therefore the recognised route to
              compliance with Part P. Notifiable work additionally requires the Building Regulations
              compliance certificate (DESC) to be issued to the homeowner and the local authority —
              this is separate from the EIC or MWC, which is the BS 7671 certificate.
            </>
          }
        ...
        >
          <p>
            Approved Document P (England, since the 2013 deregulation) names three categories of
            notifiable work in dwellings:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Installation of a new circuit</strong> — including a new ring final, a new
              radial, a new EV-charge circuit, a new PV-export circuit, a new shower or cooker
              circuit.
            </li>
            <li>
              <strong>Replacement of a consumer unit</strong> — full board change, regardless of
              whether circuits are added or moved.
            </li>
            <li>
              <strong>Any addition or alteration to existing circuits in a special location</strong>{' '}
              — bathroom zones 0, 1, 2 (BS 7671 Section 701); swimming pools (Section 702); saunas
              (Section 703).
            </li>
          </ul>
          <p>
            All other work (replacing accessories, replacing a damaged section of cable,
            fault-finding) is non-notifiable. Non-notifiable work still requires BS 7671 compliance
            and a Minor Works Certificate; what it does not require is Building Regulations
            notification.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Route 1 — Self-certification via competent-person scheme.</strong> You join a
            Government-approved scheme (NICEIC Domestic Installer, NAPIT, ELECSA, BSI, Stroma,
            Certsure). When you do notifiable work you upload the certificate within 30 days, the
            scheme issues the DESC (Domestic Electrical Installation Certificate or equivalent) to
            the homeowner and to the local authority on your behalf. Single-step, fully documented,
            defensible.
          </p>
          <p>
            <strong>Route 2 — Building Control notification.</strong> You submit a Building Notice
            or Full Plans application to the local authority before starting. They charge a fee
            (typically £200-500), inspect the work, and issue the building regulations completion
            certificate at handover. Slower, more expensive, but the only route if you are not in a
            scheme.
          </p>
          <p>
            On large projects, the Principal Contractor or the developer often holds the scheme
            membership and issues the certificate; you produce the BS 7671 EIC and supply it to
            them. On small jobs you usually hold both.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Approved Document L (Conservation of fuel and power, 2021 edition with 2022 amendments)
            sets the energy efficiency floor for new and refurbished buildings. The L3 electrical
            designer contributions are:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lighting</strong> — minimum luminaire efficacy (lumens per circuit-watt
              floors), use of LED, controls (occupancy sensing in WCs and corridors, daylight
              dimming in classrooms and offices). Lux level targets per CIBSE LG07 and similar.
            </li>
            <li>
              <strong>Heating control</strong> — thermostat per zone, programmable time controls,
              separate hot-water control. The electrical interface to wet underfloor heating, panel
              radiators, immersion heaters and heat pumps.
            </li>
            <li>
              <strong>Electric vehicle charging</strong> — Approved Document S (separate from Part L
              but co-requisite) requires every new dwelling to have an EV charging point, every
              dwelling created from material change of use to have one, and dwellings undergoing
              major refurbishment to be assessed.
            </li>
            <li>
              <strong>Low-carbon-ready provisions</strong> — capped cables to PV roof location, AC
              isolator position, battery cable from inverter to battery location, heat-pump-ready
              16-32 A radial spare way, smart meter cabling and data allowance.
            </li>
            <li>
              <strong>Future Homes Standard 2025</strong> — phases out new gas connections, requires
              heat pumps as default heating in new dwellings, raises efficiency targets further.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Approved Document S (effective June 2022) makes EV provisions a statutory floor. For
              new dwellings with a parking space: one charging point. For non-residential buildings:
              charging points scaled to the number of parking spaces. For buildings under major
              refurbishment: assessment and provision where reasonable. The L3 designer must size
              the supply, the consumer unit and the cable infrastructure for at least one EV-ready
              outlet, and demonstrate compliance through the design pack.
            </>
          }
        ...
        >
          <p>
            The Building Safety Act 2022 implements the Hackitt Review recommendations following the
            Grenfell Tower fire. The Act introduces:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>The Building Safety Regulator (BSR)</strong> — a new statutory body, sitting
              inside the Health and Safety Executive, with jurisdiction over HRRBs.
            </li>
            <li>
              <strong>Three Gateway approvals</strong> for HRRB construction: Gateway 1 at planning
              permission stage; Gateway 2 before construction work begins (full design approval);
              Gateway 3 before occupation.
            </li>
            <li>
              <strong>Dutyholder regime</strong> mirroring CDM 2015 — Client, Principal Designer,
              Principal Contractor and Designer (you) each have explicit duties for safety in design
              and construction.
            </li>
            <li>
              <strong>The golden thread</strong> — a digital, structured record of design and
              safety-critical information that must be created, maintained and handed over for the
              lifetime of the building.
            </li>
            <li>
              <strong>Competence requirements</strong> — designers and contractors must demonstrate
              competence appropriate to the work. For electrical design on HRRBs the floor is
              HNC/HND minimum, often a degree, plus structured CPD and scheme membership.
            </li>
            <li>
              <strong>Accountable Person</strong> — once occupied, a named entity (usually the
              building owner or freeholder) is responsible for fire and structural safety of the
              building in occupation, and must register the building with the BSR.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The HRRB definition is bright-line: 18 m / 7 storeys plus 2 residential units. Below
              the threshold the Act does not apply. Above it the entire dutyholder, gateway and
              golden-thread regime applies. Care homes and hospitals were brought into the regime
              under separate sections of the Act for the in-occupation safety regime, even though
              the design gateways apply principally to residential. If you are designing on a
              building near the threshold, get the height and storey count confirmed in writing —
              the threshold is calculated from the lowest external ground level to the floor of the
              topmost storey.
            </>
          }
        ...
        >
          <p>
            The golden thread is the BSA 2022 mechanism for ensuring safety-critical information
            survives the decades after construction. For HRRBs the golden thread must be:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Digital</strong> — searchable, version-controlled, accessible to dutyholders
              and the BSR.
            </li>
            <li>
              <strong>Structured</strong> — typically using BIM (Building Information Modelling) at
              LOD 350 or higher for HRRBs.
            </li>
            <li>
              <strong>Comprehensive</strong> — every design decision, material spec, manufacturer
              information, calculation, change request, risk register entry.
            </li>
            <li>
              <strong>Maintained</strong> — updated through construction, at every alteration and at
              every periodic safety case review.
            </li>
            <li>
              <strong>Handed over</strong> — at Gateway 3 to the Accountable Person, who becomes
              responsible for keeping it current for the building lifetime.
            </li>
          </ul>
          <p>
            The L3 electrical designer’s contribution is the design pack (Reg 132.13 documentation
            in BS 7671 terms) plus structured risk register entries, BIM model exports of cable
            routes and DB locations, and detailed calculations of EFLI, voltage drop and
            discrimination. On a typical HRRB this is delivered as a structured digital package that
            integrates with the architect’s and structural engineer’s submissions.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Reduce remaining risks</strong> — where elimination is not possible, design in
              mitigation: dual isolation paths, surface routing for ease of replacement, spare-way
              capacity for future loads.
            </li>
            <li>
              <strong>Control residual risks</strong> — flag in the design pack and the Health and
              Safety File: confined-space access for loft RCBO boards, asbestos surveys before
              chasing into pre-2000 plaster, working-at-height schedules for plant rooms.
            </li>
            <li>
          ...
          <p>
            Practical CDM discipline at L3 design level: a one- or two-page design risk register on
            every job (hazard, design action, residual risk, who owns it), updated as the design
            evolves and handed over with the EIC. Most L3 designers under-document this — and find
            out the importance the first time something goes wrong on a job they designed.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              competent-person scheme self-certification or Building Control. Compliance certificate
              = DESC (or scheme equivalent).
            </li>
            <li>
              ...
              deregulated. More categories of work are notifiable. NICEIC, NAPIT, ELECSA all operate
              Welsh schemes.
            </li>
            <li>
              <strong>Scotland</strong> — Building (Scotland) Regulations 2004 (as amended). Section
              3 of the Domestic Technical Handbook covers electrical safety. Different certification
              format (Building Standards completion certificate plus BS 7671 certificate). SELECT is
              the Scottish equivalent of the competent-person scheme, with statutory recognition
        ...
        <Scenario
          ...
          situation={
            <>
              You have been engaged to replace a 60 A consumer unit in a typical 1990s three-bed
              semi with a 100 A 14-way RCBO board. The customer also wants two new circuits added: a
              32 A radial for a planned EV charger and a 16 A radial for a planned heat pump. You
              hold NICEIC Domestic Installer scheme membership.
            </>
          }
          whatToDo={
            <>
              Three notifiable triggers fire: CU replacement, new EV circuit, new heat pump circuit.
              You self-certify all three under your NICEIC scheme membership. Your workflow: design
              and survey first, including the supply check (does the existing 100 A service have
              headroom for the new loads? — Reg 311 with diversity), order materials, install over
              1-2 days, complete the EIC at handover, upload the EIC and the notification to NICEIC
              within 30 days, NICEIC issues the DESC to the homeowner and to the local authority.
              The customer receives: the EIC (BS 7671), the schedule of test results, the schedule
              of inspections, and the DESC (Building Regulations). Keep your master copy on file for
              the design life — Reg 132.13 plus the scheme rules.
            </>
          }
          whyItMatters={
            <>
              A non-notified CU change is technically a Building Regulations breach even if the work
              is technically perfect. The homeowner finds out at the next sale, when the
              conveyancing solicitor asks for the DESC and finds none on file. The local authority
              can demand the work be inspected after-the-fact (at the homeowner’s expense, often
              £600+), and if the inspector finds anything non-compliant the homeowner has a real
              complaint against you. Notification is paperwork, not technical work, and skipping it
              is a sign of a designer who has not taken statutory compliance seriously.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The electrician installs a new ring final or replaces a CU in a dwelling and never
              notifies. Years later the homeowner sells the property and the conveyancing solicitor
              asks for the DESC. There is none. The local authority is approached for a
              regularisation certificate (cost: typically £400-600), the work is inspected, and any
              non-compliance has to be remediated at the original installer’s expense. The homeowner
              has a real grievance, and the original electrician’s reputation takes a hit.
            </>
          }
          doInstead={
            <>
              Notify every notifiable job. Self-certify through your competent-person scheme — it is
              a 5-minute upload and the scheme handles the homeowner certificate and the local
              authority filing. If you are not in a scheme, submit a Building Notice to the local
              authority before starting. Keep a tracker of every notifiable job you have done so you
              can prove compliance years later if asked.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A designer assumes the Building Safety Act 2022 is irrelevant to their typical
              commercial fit-out work. They never adopt the golden thread principles, never
              structure their design pack for digital handover, never update their CDM risk register
              beyond the bare minimum. Then a major client (a school district, a hospital trust, a
              developer) asks for a BIM-level design pack with structured risk register and digital
              handover, and the designer cannot produce one.
            </>
          }
          doInstead={
            <>
              Adopt the golden thread principles as a baseline for all your design work, even
              non-HRRB. Structure your design pack digitally; maintain a real risk register with
              version control; produce drawings in a format that integrates with BIM; keep records
              of every design change with the rationale. The industry is moving this way regardless
              of HRRB status, and the designers who get there first win the higher-margin work.
            </>
          }
        />
