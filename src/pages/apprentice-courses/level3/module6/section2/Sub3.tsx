...
const checks = [
  ...
  },
  {
    ...
    question: 'What goes on the diversity calc page in the design pack?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 4,
    question:
      'Applying OSG cooker diversity to a 7.2 kW cooker (31.3 A) with integrated 13 A cooker socket gives Ib of approximately:',
    options: ['~22 A', '31 A', '5 A', '13 A'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 6,
    question:
      'OZEV smart charge points regulations (2018 / 2021) require a domestic EV charger to:',
    options: [
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 2 · Subsection 3"
        title="Domestic load assessment — worked end-to-end"
        backTo="/study-centre/apprentice/level3-module6-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          One real four-bed dwelling with EV charger, heat pump and PV. Build the connected load
          schedule, apply OSG Table A1 diversity per category, derive Ib at the supply origin, and
          decide between load management, supply upgrade or hold.
        </p>
        ...
        >
          <p>
            The connected load schedule is the source data for everything that follows. A complete
            schedule for a typical four-bed dwelling looks like:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Shower (en-suite):</strong> 9.5 kW instantaneous = 41 A.
            </li>
            <li>
              <strong>Cooker (free-standing electric):</strong> 7.2 kW = 31 A nameplate, with
              integrated 13 A cooker socket.
            </li>
            <li>
              <strong>Immersion heater (cylinder):</strong> 3 kW = 13 A.
            </li>
            <li>
              <strong>Kitchen ring final:</strong> 32 A nameplate.
            </li>
            <li>
              <strong>Lounge / dining ring final:</strong> 32 A nameplate.
            </li>
            <li>
              <strong>Upstairs bedroom ring final:</strong> 32 A nameplate.
            </li>
            <li>
              <strong>Lighting (downstairs + upstairs):</strong> 1.2 kW total LED = 5 A.
            </li>
            <li>
              <strong>EV charger (driveway):</strong> 7.4 kW single-phase = 32 A, OZEV-compliant
              smart with manufacturer fall-back at 16 A.
            </li>
            <li>
              <strong>Heat pump (air-source, garden):</strong> 9 kW nameplate single-phase = 39 A.
            </li>
            <li>
              <strong>PV inverter (4 kWp roof):</strong> 16 A AC export — generator way, not a load.
            </li>
            <li>
              <strong>Battery (home storage):</strong> 5 kW charge / discharge — scheduled off-peak
              charging, peak discharge.
            </li>
            <li>
              <strong>Smoke alarms, doorbell, low-load fixed equipment:</strong> negligible total.
            </li>
          </ul>
          <p>
            Sum of nameplate active demand (excluding PV which is generation): shower 9.5 + cooker
            7.2 + immersion 3 + 3 ring finals at typical 7.36 each = 22 + lighting 1.2 + EV 7.4 +
            heat pump 9 + battery charge 5 = 64.3 kW = 280 A at 230 V. That is the connected load —
            it is not the design current. Without diversity the dwelling needs a 300 A service which
            simply does not exist for a domestic single-phase supply.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 311.1 makes the diversified maximum demand the legal design input — not the
              connected load. The wording &ldquo;may be taken into account&rdquo; sounds permissive
              but in practice not applying diversity for typical dwellings would oversize the
              supply, the cables and the devices to the point of being unreasonable. The IET On-Site
              Guide Table A1 is the recognised dwelling reference for the diversity factors
              themselves.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Shower 9.5 kW (41 A):</strong> 100 percent demand = 41 A. (Single
              instantaneous shower entry.)
            </li>
            <li>
              <strong>Cooker 7.2 kW (31 A) with cooker socket:</strong> 10 A + 30 percent (31 − 10)
              + 5 A = 10 + 6.3 + 5 = 21.3 A. Round to 22 A.
            </li>
            <li>
              <strong>Immersion 3 kW (13 A) uncontrolled:</strong> 100 percent = 13 A. (If off-peak
              only with no overlap, can be 0 percent — verify the install.)
            </li>
            <li>
              <strong>Kitchen ring final:</strong> Largest ring at peak diversified to working
              figure ~20 A.
            </li>
            <li>
              <strong>Lounge / dining ring final:</strong> 40 percent of second ring = ~13 A.
            </li>
            <li>
              <strong>Upstairs ring final:</strong> 30 percent of subsequent = ~10 A.
            </li>
            <li>
              <strong>Lighting 1.2 kW (5 A):</strong> 100 percent peak (evening all-on) = 5 A.
            </li>
            <li>
              <strong>EV charger 7.4 kW load-managed:</strong> Setpoint 16 A peak (manufacturer
              fall-back) = 16 A. Failure-mode demand (per Reg 311.2): 32 A full rate.
            </li>
            <li>
              <strong>Heat pump 9 kW (39 A):</strong> 100 percent = 39 A. (Cold-snap morning
              continuous demand.)
            </li>
            <li>
              <strong>Battery charge 5 kW:</strong> Scheduled off-peak only = 0 A at peak window.
              Failure-mode (charge during peak): 22 A.
            </li>
          </ul>
          <p>
            Sum of category Ib at peak window (normal load-management operation): 41 + 22 + 13 + 20
            + 13 + 10 + 5 + 16 + 39 + 0 = 179 A. Sum at failure-mode (EV at full + battery charging
            at peak): 41 + 22 + 13 + 20 + 13 + 10 + 5 + 32 + 39 + 22 = 217 A. Both before
            inter-category coincidence.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Inter-category coincidence is the second diversity layer. Inside a single dwelling,
            cooker peak (dinner 18:00-20:00), shower peak (morning 06:30-08:00) and EV charge peak
            (overnight or load-managed) historically did not overlap much. The coincidence factor at
            the supply origin was traditionally 0.6-0.7.
          </p>
          <p>Modern dwellings with heat pump and EV change the picture:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cold-snap morning</strong> — heat pump runs continuously, shower in use,
              kettle on, EV may still be charging from overnight. Multiple categories overlap at the
              same instant.
            </li>
            <li>
              <strong>Evening peak</strong> — cooker in use, lighting on, EV starts charging (with
              or without load management), heat pump may be on for evening warm-up. Multiple
              categories overlap.
            </li>
            <li>
              <strong>Off-peak overnight</strong> — battery charging, EV charging, heat pump for
              overnight setpoint. The overnight load on a modern dwelling is much higher than 1990s
              overnight base.
            </li>
          </ul>
          <p>
            For our worked dwelling, applying 0.65 inter-category coincidence gives normal-mode Ib =
            179 × 0.65 = 116 A; failure-mode Ib = 217 × 0.65 = 141 A. Both exceed a 100 A standard
            service. The OSG dwelling formula is conservative for traditional load mix but
            unconservative for heat-pump-and-EV mix.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Load-management failure-mode assessment falls under the Reg 132.3(c) requirement to
              record daily and yearly demand variation in the design. The design pack must record
              the normal-operation diversified Ib AND the failure-mode Ib (load-manager dropping
              out, EV charger reverting to manufacturer fall-back rate, battery charging at peak),
              with confirmation that the supply still survives the worst case. For our dwelling the
              failure-mode Ib of 141 A on a 100 A service is non-compliant — either tighten the load
              management to a fail-safe lower setpoint, upgrade the supply, or specify
              supply-protection that rides through the transient.
            </>
          }
        ...
        >
          <p>
            The diversity calc page is what an inspector or future designer reads first. Layout per
            row:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Diversity factor applied (e.g. &ldquo;100 percent&rdquo; or &ldquo;10A + 30% remainder
              + 5A&rdquo;).
            </li>
            <li>
              Source citation (e.g. &ldquo;OSG Table A1, current edition, Cooker entry&rdquo;).
            </li>
            <li>Resulting category Ib (A).</li>
          </ul>
          <p>
            Footer rows: sum of category Ib; inter-category coincidence factor and source;
            supply-origin Ib normal mode; supply-origin Ib failure mode (per Reg 311.2); supply
            rating (cut-out fuse rating); margin (A) and percent.
          </p>
          <p>
            The decision row at the bottom: HOLD (margin healthy), LOAD-MANAGE (specify EV / battery
            setpoints to bring within margin), UPGRADE (DNO supply upgrade application), or
            DOCUMENTED RISK (customer accepts the tight margin in writing, with implications spelled
            out).
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            A diversified Ib of 100 A on a 100 A service is technically compliant under Reg 433.1.1
            (Ib ≤ In ≤ Iz) but wrong as a design choice. The supply rating is for steady-state
            demand; transients exceed it briefly.
          </p>
          <p>Three things eat the margin:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Inrush transients</strong> — heat pump compressor start (3-6 second peak at
              1.5-3x running), kettle start, EV charger ramp, fridge/freezer compressor cycling.
              None show on the steady-state diversity calc but all eat margin.
            </li>
            <li>
              <strong>Future load creep</strong> — second EV, kitchen extension, hot tub, garden
              office, bigger heat pump. Customers add load; designs that left zero margin fail in
              2-3 years.
            </li>
            <li>
              <strong>Seasonal swings</strong> — cold-snap heating loads, summer cooling (becoming
              more common), high-use periods (Christmas, working from home). Diversity calc is for
              typical peak; some weeks exceed.
            </li>
          </ul>
          <p>
            Industry practice for domestic supply Ib is 75-85 percent of the service rating. On a
            100 A cut-out: aim for 75-85 A diversified Ib. On a 125 A upgrade: 95-105 A. On a
            three-phase 80 A per phase: 60-70 A per phase. The 22-25 A margin pays for the unknowns;
            the customer does not get nuisance-tripped on a cold January morning.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              Existing 100 A single-phase service. Customer wants to add 9 kW air-source heat pump
              and 7.4 kW EV charger to an existing dwelling that already has 9.5 kW shower, 7.2 kW
              cooker, immersion, three rings, lighting and PV. The L3 designer is asked: does the
              supply support the additions?
            </>
          }
          whatToDo={
            <>
              Build the load schedule (above). Apply OSG diversity per category (above). Apply
              inter-category coincidence: 0.65 traditional, but reality with heat pump cold-morning
              + EV evening is 0.85+. Use 0.85 as the realistic floor. Normal-mode Ib = 179 × 0.85 =
              152 A. Failure-mode Ib = 217 × 0.85 = 184 A. Both well above 100 A.
              {'\n\n'}
              Decision tree: (1) HOLD is not viable — the supply does not survive. (2) LOAD-MANAGE:
              tighten EV setpoint to 10 A peak (gives normal-mode 179 − 6 = 173 × 0.85 = 147 A,
              still over) — load management alone does not save it. (3) UPGRADE: DNO application for
              125 A single-phase or three-phase. 125 A gives 25 A margin at 100 A diversified,
              viable but tight. Three-phase 80 A per phase with balanced load gives ~60 A per phase,
              comfortable. (4) DOCUMENTED RISK: not appropriate — the failure-mode is non-compliant.
              {'\n\n'}
              Recommend three-phase upgrade. Document on the diversity calc page: existing 100 A
              service insufficient; proposed three-phase 80 A per phase; balanced load distribution
              across phases (heat pump on L1, EV on L2, household on L3, swap loads to balance);
              diversity calc page updated for the three-phase service. Customer accepts the DNO
              upgrade cost (typically £3000-5000 for an urban single-to-three-phase upgrade).
            </>
          }
          whyItMatters={
            <>
              Without the diversity calc, the customer would discover the supply is undersized only
              after install — typically when the heat pump runs in cold weather and the cut-out fuse
              blows mid-evening. By then the install is done; the upgrade has to be retro-fitted at
              much higher disruption cost. The diversity calc done at design stage is the single
              highest-leverage activity for the L3 designer on heat-pump and EV-rich dwellings.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A designer assumes the smart charger will always charge off-peak, removes EV from the
              diversity calc entirely, and signs off a 100 A supply on what works out as a 95 A
              diversified dwelling. Three months later the customer plugs in early evening (peak
              window, charger ramps up to manufacturer minimum delay) and the cut-out fuse blows.
            </>
          }
          doInstead={
            <>
              OZEV-compliant means the charger CAN be load-managed, not that it always defers. The
              default off-peak window is a customer-changeable setting, the randomised start delay
              is a 10-minute window not a 6-hour one, and demand-side response signals are not
              always present. Design the EV at its load-managed setpoint at peak (typically 16 A or
              20 A) AND record the failure-mode (full 32 A) per Reg 311.2.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A designer applies the same OSG dwelling formula that worked for 1990s gas-heated
              dwellings. Result: diversified Ib of 60 A on a heat-pump-and-EV dwelling whose actual
              cold-morning peak is 110 A. The 100 A supply trips on the first cold weekend of
              October; the customer is without heat for hours.
            </>
          }
          doInstead={
            <>
              Treat the heat pump and EV as 100 percent design demand items. Apply OSG diversity to
              the rest of the dwelling. Sum the heat pump (full nameplate), EV (full or load-managed
              setpoint), and the diversified rest. Apply inter-category coincidence in the 0.85-0.95
              range, not the traditional 0.65. The result for typical four-bed heat-pump-and-EV
              dwellings is 95-130 A — at or above the 100 A service. Either upgrade or refuse the
              install.
            </>
          }
        />
        ...
        >
          <p>Three-phase domestic install considerations:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DNO upgrade cost and timeline</strong> — typically £3000-5000, 4-12 weeks;
              raises the customer's project budget noticeably.
            </li>
            <li>
              <strong>Three-phase consumer unit</strong> — typical domestic install uses a Hager VML
              or Wylex NHX three-phase board with TP&N busbars and per-phase or aggregated RCD
              protection.
            </li>
            <li>
              <strong>Per-phase load allocation</strong> — heat pump on L1, EV on L2, household on
              L3 is a typical starting allocation; refine to balance.
            </li>
            <li>
              <strong>Three-phase EV charger</strong> — 22 kW (32 A per phase) units charge faster
              but are more expensive than single-phase units; some customers retain a single-phase
              charger on one leg for cost.
            </li>
            <li>
              <strong>Three-phase heat pump</strong> — larger units (over 12 kW) often available
              three-phase; smaller units stay single-phase.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Battery storage in the diversity calc:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Charge mode</strong> — adds to total demand; typical 3-5 kW for a domestic
              battery; concentrated in cheap-tariff windows.
            </li>
            <li>
              <strong>Discharge mode</strong> — offsets demand; concentrated in expensive-tariff
              windows; may export to grid if surplus.
            </li>
            <li>
              <strong>Failure mode</strong> — battery offline (fault, empty, ageing, comms loss);
              design must hold without the battery.
            </li>
            <li>
              <strong>Hybrid inverter sizing</strong> — typically 5 kW AC for a domestic system;
              sets the upper limit on the battery's contribution to demand.
            </li>
            <li>
              <strong>SEG export limit</strong> — DNO G98 / G99 caps the export; the inverter's
              export curtailment setting respects the cap.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Retrofit data sources and what they tell you:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Smart meter half-hourly data</strong> — customer portal or third-party app; 12
              months of history.
            </li>
            <li>
              <strong>Supplier energy-use breakdown</strong> — kWh per month; less useful for peak
              but confirms total annual use.
            </li>
            <li>
              <strong>PQ logger (Fluke 1738, Hioki PQ3198)</strong> — clipped on the consumer unit
              for 1-2 weeks; captures voltage, current, harmonic events.
            </li>
            <li>
              <strong>Customer pattern interview</strong> — when they cook, when they shower, when
              they charge devices, weekday vs weekend; supplements the data.
            </li>
            <li>
              <strong>Existing fuse-blowing history</strong> — has the supply ever tripped? When? If
              yes, that is the empirical ceiling and the retrofit must respect it.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Domestic load assessment depends on the supply data Reg 132.2(c)(iii) requires the
              designer to determine and document — maximum current allowable in particular. Without
              that value the diversity calculation cannot be meaningfully closed against the supply
              ceiling.
            </>
          }
