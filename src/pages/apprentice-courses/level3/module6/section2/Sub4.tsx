...
const checks = [
  {
    id: 'three-phase-conv',
    question: 'A three-phase 400 V load of 30 kW (balanced) draws what line current?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'Power factor for a typical small commercial mixed load (lighting + sockets + small motors + IT) is approximately:',
    options: ['0.45-0.55', '1.0 exactly', '0.85-0.95', '0.15-0.25'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 4,
    question:
      'A commercial kitchen with three induction hobs (7 kW each), 5 kW combination oven, 3 kW dishwasher, 8 kW refrigeration. Sub-main Ib at 400 V three-phase (assume balanced):',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'For a multi-tenant commercial building (5 retail units), the origin coincidence factor is typically:',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'For a commercial design pack, the diversity calc page should show per category, per sub-main and per origin:',
    options: [
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 2 · Subsection 4"
        title="Commercial load assessment — worked end-to-end"
        backTo="/study-centre/apprentice/level3-module6-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          320 m² mixed-use commercial unit (cafe + retail + office) on a three-phase 100 A service.
          Per-circuit Ib, sub-main coincidence, origin coincidence, balanced-phase distribution, and
          the design pack output ready for the DNO connection application.
        </p>
        ...
        >
          <p>
            The single-phase formula I = P / (V × pf) does not generalise. Three-phase line current
            for a balanced load is:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              I (per line) = P / (√3 × VL × pf), where P is total active power across all three
              phases (W), VL is line-to-line voltage (400 V in the UK), pf is power factor.
            </li>
            <li>S (apparent power, kVA) = √3 × VL × IL / 1000.</li>
            <li>
              For a single-phase load on a three-phase service: I = P / (VLN × pf), where VLN is
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              30 kW balanced three-phase load at pf 0.9: I = 30000 / (1.732 × 400 × 0.9) = 48 A per
              line.
            </li>
            <li>
              15 kW single-phase load on L1: I = 15000 / (230 × 0.95) = 68.6 A on L1 only (L2, L3
              unaffected).
            </li>
            <li>
              3 kW LED lighting per phase across L1, L2, L3 (balanced): I per line = 3000 / (230 ×
              0.98) = 13.3 A per line.
            </li>
          </ul>
          <p>
            Power factor matters. UK domestic estimates often default to pf 1.0 (resistive heating
            dominant) but commercial mixed loads with motors, IT and HVAC are typically 0.85-0.95.
            Using pf 1.0 when actual pf is 0.85 underestimates line current by ~15 percent — the
            supply size is wrong.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              inverter loads (PV, EV chargers, heat pump compressors) — they raise apparent power
              above active power and require sizing on apparent rather than active load. The L3
              designer documents the demand profile assumptions in the design pack alongside the
              diversity factors.
            </>
          }
        ...
        >
          <p>
            Worked example: 320 m² mixed-use ground-floor unit. Front 80 m² is retail (clothing).
            Middle 100 m² is cafe (kitchen + seating). Rear 60 m² is office (4 desks + meeting
            room). Plant 30 m² (HVAC, water heater, refrigeration plant). Toilets and circulation 50
            m².
          </p>
          <p>Connected load schedule per zone:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cafe kitchen:</strong> 2x induction hob 7 kW each = 14 kW; combi oven 5 kW;
              dishwasher 3 kW; coffee machine 2.5 kW; refrigeration (3 fridges + 1 freezer) 5 kW
              running; extract fan 1.2 kW; lighting 0.8 kW. Total connected ~31 kW.
            </li>
            <li>
              <strong>Retail floor:</strong> Display lighting 2 kW; ambient lighting 1 kW; 8 socket
              outlets 8 × 13 A nominal but realistic load 2 kW; EPOS 0.3 kW; signage external 1.5
              kW. Total connected ~7 kW.
            </li>
            <li>
              <strong>Office:</strong> 4 desks at 0.5 kW each = 2 kW; meeting room AV 1 kW; office
              lighting 0.6 kW; small kitchenette 1 kW. Total connected ~5 kW.
            </li>
            <li>
              <strong>HVAC:</strong> 12 kW heat-pump-based system (single unit, three-phase) for
              whole unit.
            </li>
            <li>
              <strong>Hot water:</strong> 9 kW unvented cylinder heater.
            </li>
            <li>
              <strong>Toilets / circulation lighting and small loads:</strong> 1 kW.
            </li>
          </ul>
          <p>
            Sum of connected load: 31 + 7 + 5 + 12 + 9 + 1 = 65 kW. At three-phase pf 0.9 if
            balanced and connected at full demand: I = 65000 / (1.732 × 400 × 0.9) = 104 A per line.
            Cannot fit on a 100 A three-phase service without diversity.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Run GN1 Section 7 per category (verify against current edition):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cafe cooking</strong> (induction + oven): 80 percent at lunch service peak.
              Connected 19 kW × 0.8 = 15.2 kW.
            </li>
            <li>
              <strong>Cafe ancillary</strong> (dishwasher, coffee, extract): 100 percent (run during
              service). Connected 6.7 kW × 1.0 = 6.7 kW.
            </li>
            <li>
              <strong>Refrigeration</strong>: 100 percent (compressor cycle independent of service
              times). 5 kW × 1.0 = 5 kW.
            </li>
            <li>
              <strong>Cafe lighting</strong>: 100 percent (opening hours). 0.8 kW × 1.0 = 0.8 kW.
            </li>
            <li>
              <strong>Retail display + ambient lighting</strong>: 100 percent (opening hours). 3 kW
              × 1.0 = 3 kW.
            </li>
            <li>
              <strong>Retail sockets</strong>: 50 percent (occasional plug-in stock equipment, no
              continuous heavy load). 2 kW × 0.5 = 1 kW.
            </li>
            <li>
              <strong>Retail EPOS + signage</strong>: 100 percent (continuous). 1.8 kW × 1.0 = 1.8
              kW.
            </li>
            <li>
              <strong>Office sockets</strong>: 60 percent (typical knowledge work). 2 kW × 0.6 = 1.2
              kW.
            </li>
            <li>
              <strong>Office AV + meeting room</strong>: 50 percent (intermittent). 1 kW × 0.5 = 0.5
              kW.
            </li>
            <li>
              <strong>Office + kitchenette + lighting</strong>: 80 percent. 1.6 kW × 0.8 = 1.3 kW.
            </li>
            <li>
              <strong>HVAC</strong>: 100 percent (BMS-controlled but sized for peak heating /
              cooling). 12 kW × 1.0 = 12 kW.
            </li>
            <li>
              <strong>Hot water</strong>: 100 percent (post-service recovery, peak demand at lunch
              service end). 9 kW × 1.0 = 9 kW.
            </li>
            <li>
              <strong>Toilets / circulation</strong>: 100 percent. 1 kW × 1.0 = 1 kW.
            </li>
          </ul>
          <p>
            Sum of diversified category demand: 15.2 + 6.7 + 5 + 0.8 + 3 + 1 + 1.8 + 1.2 + 0.5 + 1.3
            + 12 + 9 + 1 = 58.5 kW.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Sub-main coincidence inside a single sub-main (e.g. cafe DB feeding cafe loads) stays
            high because the categories are correlated to operating hours. Coincidence factor ~0.9
            inside one tenant.
          </p>
          <p>
            For multi-zone single-tenant (cafe + retail + office under one occupier), origin
            coincidence applies across the zones. Cafe, retail and office mostly operate during the
            same business hours but the kitchen peaks at lunch, retail peaks at weekends afternoon,
            office peaks 09:00-17:00 weekdays. Origin coincidence ~0.85.
          </p>
          <p>Apply 0.85 to the diversified sum: 58.5 × 0.85 = 49.7 kW at origin.</p>
          <p>At 400 V three-phase pf 0.9: I = 49700 / (1.732 × 400 × 0.9) = 80 A per line.</p>
          <p>
            Apparent power: S = √3 × 400 × 80 / 1000 = 55 kVA. Round up to 60 kVA for the DNO
            application.
          </p>
          <p>
            Supply margin: 80 A on a 100 A three-phase service = 80 percent of rating. Within the
            75-85 percent target band — healthy but not loose. Document growth allowance (10-15
            percent over 5 years) which would push to 88-92 A; consider the upgrade path (125 A
            three-phase) if growth is anticipated.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Allocate sub-main loads across phases:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HVAC</strong> 12 kW three-phase = balanced across all three lines (4 kW per
              phase).
            </li>
            <li>
              <strong>Cafe induction hobs</strong> 14 kW: split — hob 1 (7 kW) on L1, hob 2 (7 kW)
              on L2.
            </li>
            <li>
              <strong>Cafe combi oven</strong> 5 kW on L3.
            </li>
            <li>
              <strong>Cafe ancillary</strong> 6.7 kW: dishwasher on L1, coffee on L2, extract on L3
              (roughly balanced 2-3 kW per phase).
            </li>
            <li>
              <strong>Refrigeration</strong> 5 kW: spread across phases via individual fridge
              circuits.
            </li>
            <li>
              <strong>Hot water cylinder</strong> 9 kW: typically three-phase load = balanced 3 kW
              per phase.
            </li>
            <li>
              <strong>Retail loads</strong> ~6 kW: distribute lighting + sockets + EPOS across
              phases.
            </li>
            <li>
              <strong>Office loads</strong> ~3 kW: distribute across phases.
            </li>
          </ul>
          <p>Worked balance:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>L1:</strong> HVAC 4 + hob 1 7 + dishwasher 1.5 + refrigeration 1.5 + HW 3 +
              retail 2 + office 1 = ~20 kW.
            </li>
            <li>
              <strong>L2:</strong> HVAC 4 + hob 2 7 + coffee 2 + refrigeration 1.5 + HW 3 + retail 2
              + office 1 = ~20 kW.
            </li>
            <li>
              <strong>L3:</strong> HVAC 4 + combi oven 5 + extract 1.2 + refrigeration 2 + HW 3 +
              retail 2 + office 1 = ~18 kW.
            </li>
          </ul>
          <p>
            Per-phase apparent demand: L1 ~20 kVA (87 A), L2 ~20 kVA (87 A), L3 ~18 kVA (78 A).
            Imbalance: (87 − 78) / 84 = 11 percent. Just above the 10 percent target — swap one
            office circuit from L1 to L3 to bring within 10 percent.
          </p>
          <p>
            Final per-phase distribution and imbalance go on the diversity calc page. The design
            pack shows the L1, L2, L3 loading and the imbalance percent. The CU schedule shows which
            way feeds which phase.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 314.1 covers the design rationale for splitting commercial loads across phases and
              feeders — heavy phase imbalance, harmonic distortion and inrush events all sit under
              (e) "mitigate the effects of electromagnetic disturbances". The diversity calc and
              phase distribution feed into the circuit-division decision. For commercial sites with
              motors, refrigeration compressors, EV charging or PV inverters, harmonic and inrush
              considerations drive separate circuits / sub-mains and belong in the design pack.
            </>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              Same 320 m² mixed-use unit. Existing 100 A three-phase service. Customer is the new
              operator and asks the L3 designer for a connection design and DNO application within 4
              weeks of opening.
            </>
          }
          whatToDo={
            <>
              Build the load schedule (above), apply GN1 diversity (above), apply 0.85 origin
              coincidence, derive 80 A per line at 55 kVA. Distribute across phases for under 10
              percent imbalance. Submit DNO online application: connection point address, requested
              capacity 60 kVA (rounded up), proposed installation start date, contact details. DNO
              acknowledges within 5 working days, confirms network capacity available at the
              connection point, issues quotation for any reinforcement. For a mid-urban site with
              existing 100 A three-phase already present, the upgrade to 60 kVA is usually a
              paperwork exercise (no network reinforcement) and confirms the existing service.
              {'\n\n'}
              Diversity calc page in the design pack: 13 categories listed with diversity factor and
              source citation, sub-totals per zone, origin coincidence with source, supply origin Ib
              normal mode 80 A and failure mode (HVAC scheduler failure - 12 kW becomes uncontrolled
              but still under 100 A per phase), per-phase distribution table, growth allowance 10
              percent (5-year horizon), supply rating 100 A, decision: HOLD (within margin).
              {'\n\n'}
              Hand the calc page to the customer with the DNO application. The customer presents to
              landlord and accountant; the calc justifies any future requests for upgrade.
            </>
          }
          whyItMatters={
            <>
              The diversity calc page is the cornerstone of every commercial connection. It is what
              the DNO connection assessor reads, what the building inspector audits, what the future
              designer reuses for any change-of-use, what the customer presents to insurers and
              landlord. Done right, it lasts 10+ years; done wrong (sized on connected load, no
              source citations) it forces a re-design at every change. L3 designers earn their keep
              on this page.
            </>
          }
        />
        ...
        >
          <p>
            The physics: in a balanced three-phase system, the fundamental currents (50 Hz) on L1,
            L2, L3 are 120° apart and sum to zero in the neutral. But the 3rd harmonic at 150 Hz on
            each line is in phase with the 3rd harmonic on the others — they all peak together — and
            therefore ADD in the neutral rather than cancelling. Same for 9th, 15th and higher
            triplens.
          </p>
          <p>Practical consequences for the L3 designer:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Office with heavy LED + IT</strong> — neutral current typically 50-70 % of
              line current. Reg 524.1: neutral csa ≥ line csa.
            </li>
            <li>
              <strong>Data centre / server room</strong> — neutral current routinely 80-120 % of
              line current. Reg 524.1: neutral csa one bracket up from line csa, or full-size
              neutral on multi-core (4 × line csa instead of 4 × line + reduced neutral).
            </li>
            <li>
              <strong>EV charger ranks (multiple chargers on three-phase service)</strong> — neutral
              current 60-90 % of line current under typical use. Same neutral upsize rule.
            </li>
            <li>
              <strong>Industrial with VFDs (variable frequency drives)</strong> — harmonic content
              depends on drive type (6-pulse vs 12-pulse). Specific harmonic mitigation may be
              required to keep the supply within the DNO's connection conditions (typically THD ≤ 5
              % at the point of common coupling).
            </li>
          </ul>
          <p>
            <strong>Sizing example.</strong> Office fit-out, 80 A balanced line current per phase.
            Harmonic analysis indicates 60 % neutral current = 48 A. Reg 524.1 requires neutral csa
            ≥ line csa — but you'd typically size the neutral the same as the line (e.g. 25 mm²
            four-core SWA) anyway because manufactured cables come with full or reduced neutrals;
            the reduced-neutral option is unsuitable here. Document the harmonic assumption in the
            design pack with the source (manufacturer load profile, IEC 61000 study, measured site
            data).
          </p>
          <p>
            <strong>K-factor transformers</strong> are sometimes specified for high-harmonic loads.
            K-13 or K-20 rated transformers handle harmonic heating without derate. On commercial /
            industrial sites with significant non-linear load, the supply transformer specification
            should account for K-factor; on a fit-out where the transformer is the DNO's equipment,
            document the harmonic load on the connection application so the DNO can verify network
            capacity.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The sub-main sizing workflow:</p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Calculate diversified Ib at the sub-main</strong> — the diversified line
              current feeding the downstream DB after applying GN1 category factors and sub-main
              coincidence.
            </li>
            <li>
              <strong>Pick a standard breaker rating</strong> ≥ Ib. Standard MCCB ratings: 16, 20,
              25, 32, 40, 50, 63, 80, 100, 125, 160, 200, 250, 400, 630 A. Standard HBC fuse ratings
              (BS 88-3): similar plus intermediate values.
            </li>
            <li>
              <strong>Pick a cable size</strong> with Iz (after application of correction factors
              per Appendix 4) ≥ In × any further correction. The cable Iz must be at least the
              breaker In so the breaker reliably operates on overload before the cable cooks (Reg
              433.1.1).
            </li>
            <li>
              <strong>Check breaking capacity</strong> — the breaker's Icn or Icu must be ≥ PFC at
              its location. Standard MCCB ratings: 10 kA, 25 kA, 36 kA, 50 kA. For a commercial
              sub-main with PSCC of 16 kA, a 25 kA Icn MCCB is appropriate; lower-rated devices fail
              Reg 434.5.1.
            </li>
            <li>
              <strong>Verify Vd</strong> on the sub-main with the chosen cable size. Sub-mains
              typically size on Vd rather than CCC because route lengths are long; aim for ~2 % Vd
              to leave headroom for downstream final-circuit Vd.
            </li>
            <li>
              <strong>Verify selectivity</strong> with the upstream device (typically the supply
              intake fuse) and downstream final-circuit devices. The sub-main breaker should clear
              before the upstream device, and the downstream breaker should clear before the
              sub-main on a final-circuit fault. Selectivity tables are manufacturer-specific (Sub
              6.5).
            </li>
          </ol>
          <p>
            <strong>Worked example.</strong> Cafe sub-main, diversified Ib = 75 A, three-phase 400
            V. Pick 80 A MCCB (next standard above 75 A). Cable: 25 mm² four-core SWA in a buried
            duct, Iz ≈ 110 A — well above 80 A. PFC at the sub-main location calculated as 8 kA —
            pick 25 kA Icn MCCB for comfortable margin. Vd over the 30 m run from main switch to
            cafe DB on 25 mm² four-core: mV/A/m ≈ 1.5, Vd = (1.5 × 75 × 30)/1000 = 3.4 V = 0.85 % —
            plenty of Vd headroom for downstream final circuits.
          </p>
          <p>
            Document on the design pack: sub-main reference, route, Ib, In selected (with rationale
            for size step above Ib), cable size, Iz (with correction factors applied and source
            citations), PFC at the location, breaker Icn, Vd, selectivity outcome. The sub-main row
            is the most-audited row on a commercial design — get it right.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Single-phase loading principles:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Each single-phase circuit uses one line conductor + neutral.</strong> The line
              is L1, L2 or L3; the choice is the designer's. Voltage between line and neutral = 230
              V (UK nominal).
            </li>
            <li>
              <strong>Distribute single-phase loads in rotation</strong> — L1 first, L2 second, L3
              third, then back to L1. On a CU with 12 single-phase circuits (4 per phase), this
              rotation gives roughly balanced per-phase load if the per-circuit demand is similar.
            </li>
            <li>
              <strong>Heavy single-phase loads</strong> (cookers, electric showers, water heaters,
              EV chargers) need careful phase allocation — splitting two heavy single-phase loads
              between two different phases, or using a three-phase EV charger that draws balanced
              power.
            </li>
            <li>
              <strong>Per-tenant DBs in multi-tenant buildings</strong> — each tenant's CU is fed by
              either a single-phase sub-main (one line + neutral + CPC) drawn from one of the three
              phases at the origin, or a three-phase sub-main (all three lines + neutral + CPC).
              Single-phase sub-mains are simpler but force tenant load onto one phase only — limits
              balance.
            </li>
          </ul>
          <p>
            <strong>Multi-tenant balance worked example.</strong> A retail parade with three units,
            each with diversified Ib of 25 A, 30 A and 20 A respectively. Three single-phase
            sub-mains:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Unit 1 → L1</strong> (Ib 25 A on L1).
            </li>
            <li>
              <strong>Unit 2 → L2</strong> (Ib 30 A on L2).
            </li>
            <li>
              <strong>Unit 3 → L3</strong> (Ib 20 A on L3).
            </li>
          </ul>
          <p>
            Per-phase loading: L1 25 A, L2 30 A, L3 20 A. Imbalance: (30 − 20) / 25 = 40 % — well
            above the 10 % target. To improve, swap a heavy circuit from Unit 2 onto L3 — say a 5 A
            lighting circuit moves from L2 to L3 (achieved by allocating that circuit's MCB to a
            different phase at the origin, with Unit 2's DB carrying both L2 and L3 supply).
          </p>
          <p>
            <strong>Documentation.</strong> The CU schedule shows which phase each single-phase
            circuit is on (L1 / L2 / L3 column). The diversity calc page sums per-phase load and
            reports imbalance percentage. For three-phase tenancy DBs, all three phases enter the DB
            and the rotation logic applies internally; for single-phase tenant DBs, only one phase
            enters the DB and the building-level balance is achieved by tenant-to-phase mapping at
            the origin.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A junior designer divides the total kW by 230 V (single-phase formula) for a
              three-phase commercial load. Result: I = 30000 / 230 = 130 A per line — three times
              the actual three-phase line current of 43 A. The supply is sized at 200 A when 60 A
              would do. The customer pays £8000-15000 extra in DNO connection cost.
            </>
          }
          doInstead={
            <>
              Three-phase balanced: I = P / (√3 × VL × pf). VL = 400 V in the UK. The √3 factor is
              non-negotiable. Single-phase loads on a three-phase service use 230 V
              (line-to-neutral); three-phase balanced loads use 400 V (line-to-line) with the √3
              factor. Always check whether the kW figure is already per-phase or total; the formulas
              assume total active power across all three phases.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A designer assumes pf 1.0 for a commercial site that has motor loads, HVAC and PV
              inverter. Actual pf is 0.85. The line current is 18 percent higher than the calc
              shows. The supply is undersized; on a hot day with HVAC at peak, the cut-out fuse
              blows.
            </>
          }
          doInstead={
            <>
              ...
              commercial mixed; 0.85 if motors and HVAC dominate; 0.95+ for pure IT or LED lighting.
              Document the assumption. For larger sites with significant motor or inverter load,
              specify power factor correction (capacitor bank or active PFC) and design at the
              post-PFC pf — but include the failure-mode (PFC drops out) per Reg 311.2.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          clause={
            <>
              The documentation shall include prospective fault current. Designers shall determine
              and record the prospective (available) fault current at relevant points to select
              protective devices and ensure disconnection requirements are achievable.
            </>
          }
          meaning={
            <>
              Commercial loads with motors and large transformers raise the prospective fault
              current significantly above typical domestic levels. Reg 132.2(c)(iv) requires the
              designer to determine and record the value — protective device breaking capacity (per
              Reg 432.1) is then sized against the recorded PFC. An under-rated MCB on a high-PFC
              industrial supply is a textbook compliance failure.
            </>
          }
