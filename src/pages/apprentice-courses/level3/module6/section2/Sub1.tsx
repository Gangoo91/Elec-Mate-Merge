    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Reg 311.2 (A4:2026) explicitly requires the design to assess maximum demand under all
              foreseeable operating conditions including load-management failure. Document the EV
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Reg 311.2 foreseeable conditions</strong> — consider operating with load
              management active, then consider load management failed.
            </li>
            <li>
