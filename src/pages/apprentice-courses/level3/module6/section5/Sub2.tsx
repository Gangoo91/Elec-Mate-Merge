...
const checks = [
  {
    ...
    question: 'The Cmin factor of 0.95 in Reg 411.4.5 represents:',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question: 'Where in BS 7671:2018+A4:2026 is the voltage factor minimum Cmin = 0.95 set out?',
    options: [
  ...
  },
  {
    id: 2,
    question:
      'The pre-A4 BS 7671 (e.g. A2:2022) Table 41.3 value for a B32 MCB on TN was 1.44 Ω. The A4:2026 value is:',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'When you calculate design Zs in the field for an A4:2026 design, where does Cmin appear in your numbers?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'You calculate design Zs for a circuit and find it is at 1.40 Ω against an A4:2026 Table 41.3 max of 1.37 Ω for the B32 device fitted. The design has failed by 0.03 Ω. What is the most appropriate first response?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'The reason BS 7671 uses different voltage factors for fault current calc (Cmax) and Zs calc (Cmin) is:',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'For a TN-S supply with assumed Ze = 0.80 Ω (no Form 1 available), you design a 16 A B-curve MCB on a 50 m run of 1.5 mm² T+E (cpc 1.0 mm²). OSG Table I1: 1.5 mm² = 12.10 mΩ/m, 1.0 mm² = 18.10 mΩ/m. Will it pass the design Zs check?',
    options: [
...
const faqs = [
  {
    question:
      'Why did A4:2026 introduce Cmin 0.95 explicitly when previous editions seemed to work without it?',
    answer:
  ...
  {
    question:
      'If Cmin appears in Table 41.3, do I also need to use Cmin in my prospective fault current Ipf calculation?',
    answer:
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 5 · Subsection 2"
        title="Calculating Zs at design stage — Cmin 0.95"
        backTo="/study-centre/apprentice/level3-module6-section5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The voltage factor minimum from BS 7671 Appendix 3. What it represents, why A4:2026 made
          it explicit at 0.95, how it propagates into the Reg 411.4.5 design check and the Table
          41.3 max Zs values, and how to apply the design method end-to-end on the pack.
        </p>
        ...
        >
          <p>The Reg 411.4.5 design check is:</p>
          <p className="text-base font-semibold text-elec-yellow">Zs × Ia ≤ U0 × Cmin</p>
          <p>Rearranged for the maximum permissible Zs:</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>U0</strong> = nominal AC line voltage to earth = 230 V single-phase in the UK.
            </li>
            <li>
              <strong>Cmin</strong> = voltage factor minimum = 0.95 (given in BS 7671 Appendix 3,
              harmonised with IEC 60909-0 / HD 60364-4-41).
            </li>
            <li>
              <strong>Ia</strong> = current in amperes causing automatic operation of the protective
              device within the time required by Reg 411.3.2.2 (Table 41.1: 0.4 s for final ≤ 32 A
              on TN; 5 s for distribution and final &gt; 32 A on TN).
            </li>
          </ul>
          <p>
            For a Type B BS EN 60898 MCB at 32 A, Ia = 5 × In = 160 A (the worst-case magnetic
            threshold). max Zs = 218.5 / 160 = 1.366 Ω → rounded to 1.37 Ω in Table 41.3. That is
            exactly the published limit. The same calculation applies for every other rating and
            curve type.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 132.6(e) is the regulatory hook for the whole max Zs calculation: the conductor
              csa must be selected so that the loop impedance stays low enough for the protective
              device to operate within its required disconnection time. The U0 × Cmin / Ia formula
              is the maths that turns "maximum impedance for correct operation" into a number — Cmin
              = 0.95 is the conservative voltage assumption built into Table 41.3, ensuring the
              cable still trips the breaker at the worst credible supply voltage. Get the csa wrong
              against 132.6(e) and the install fails ADS regardless of how clean the install looks
              visually.
            </>
          }
        ...
        >
          <p>Worked examples for common BS EN 60898 MCBs at U0 = 230 V, Cmin = 0.95:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>B6:</strong> Ia = 5 × 6 = 30 A. Max Zs = 218.5 / 30 = 7.28 Ω.
            </li>
            <li>
              <strong>B10:</strong> Ia = 5 × 10 = 50 A. Max Zs = 218.5 / 50 = 4.37 Ω.
            </li>
            <li>
              <strong>B16:</strong> Ia = 5 × 16 = 80 A. Max Zs = 218.5 / 80 = 2.73 Ω.
            </li>
            <li>
              <strong>B20:</strong> Ia = 5 × 20 = 100 A. Max Zs = 218.5 / 100 = 2.19 Ω.
            </li>
            <li>
              <strong>B25:</strong> Ia = 5 × 25 = 125 A. Max Zs = 218.5 / 125 = 1.75 Ω.
            </li>
            <li>
              <strong>B32:</strong> Ia = 5 × 32 = 160 A. Max Zs = 218.5 / 160 = 1.37 Ω.
            </li>
            <li>
              <strong>B40:</strong> Ia = 5 × 40 = 200 A. Max Zs = 218.5 / 200 = 1.09 Ω.
            </li>
            <li>
              <strong>B50:</strong> Ia = 5 × 50 = 250 A. Max Zs = 218.5 / 250 = 0.87 Ω.
            </li>
            <li>
              <strong>B63:</strong> Ia = 5 × 63 = 315 A. Max Zs = 218.5 / 315 = 0.69 Ω.
            </li>
          </ul>
          <p>Type C MCBs use 10 × In for the magnetic threshold:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            {/* Zs values from canonical source: src/lib/calculators/bs7671-data/protectiveDevices.ts (BS 7671:2018+A4:2026 Table 41.3) */}
            <li>
              <strong>C16:</strong> Ia = 10 × 16 = 160 A. Max Zs = 218.5 / 160 = 1.37 Ω (interesting
              — a C16 has the same Zs limit as a B32).
            </li>
            <li>
              <strong>C32:</strong> Ia = 10 × 32 = 320 A. Max Zs = 218.5 / 320 = 0.683 Ω → 0.68 Ω
              (Table 41.3).
            </li>
            <li>
              <strong>C40:</strong> Ia = 10 × 40 = 400 A. Max Zs = 218.5 / 400 = 0.55 Ω.
            </li>
          </ul>
          <p>Type D MCBs use 20 × In for the magnetic threshold:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>D16:</strong> Ia = 20 × 16 = 320 A. Max Zs = 218.5 / 320 = 0.683 Ω → 0.68 Ω
              (Table 41.3).
            </li>
            <li>
              <strong>D32:</strong> Ia = 20 × 32 = 640 A. Max Zs = 218.5 / 640 = 0.341 Ω → rounded
              to 0.34 Ω.
            </li>
          </ul>
          <p>
            The pattern: tighter trip curves (B → C → D) need lower Zs to guarantee fast
            disconnection, because they need a bigger fault current to enter the magnetic region.
            Type B is the most permissive (5 × In threshold) and Type D is the tightest (20 × In
            threshold). For a given route length and cable, swapping a Type C for a Type B is a
            common way to bring a borderline circuit inside the limit — but check the inrush
            characteristic of the connected load does not nuisance-trip the more sensitive Type B.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              This is the formal change note that explains why the Table 41.3 numbers shifted
              between A2 and A4:2026. Pre-A4: max Zs = U0 / Ia = 230 / Ia. Post-A4: max Zs = U0 ×
              Cmin / Ia = 230 × 0.95 / Ia = 218.5 / Ia. The 5 percent reduction is the Cmin factor
              working through. Designs done under A2 with the old (more permissive) limits are not
              automatically non-compliant — the old limits were valid at the time of design — but
              any new design or any redesign as part of an EICR remedial must use the A4:2026
              numbers. The pre-A4 values like B32 max Zs = 1.37 Ω should now be regarded as obsolete
              for design purposes.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              From DNO Form 1 if available (use the declared figure; cite the document on the design
              pack).
            </li>
            <li>
              If no Form 1, use BS 7671 assumed maximum: 0.35 Ω TN-C-S; 0.80 Ω TN-S; 21 Ω TT (TT
              relies on RCD; Zs limit governed by Reg 411.5).
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Cable type (T+E, SWA, MI, singles in conduit). Line conductor CSA. cpc CSA. Cable
              construction reference (BS 6004, BS 6346, BS EN 60702-1 etc).
            </li>
            <li>
              Actual installed route length (not as-the-crow-flies). Allow vertical runs, route
              deviations, connection tails, pulling allowance.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Cold (R1 + R2) = route length × (line mΩ/m + cpc mΩ/m) / 1000, with mΩ/m values from
              IET OSG Table I1 (or GN1 Table B5 for industrial cable types).
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              For special cases (ambient above 30 degrees C, grouping pushing temperature above
              standard), use OSG Appendix B detailed correction matrix.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Look up Table 41.3 max Zs for the device fitted (A4:2026 edition with Cmin 0.95 baked
              in).
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Record on the design pack: Ze source citation, cable spec, route length, OSG citation
              for mΩ/m, temperature factor and reason, cold (R1 + R2), hot (R1 + R2), design Zs,
              Table 41.3 max cited (A4:2026), margin.
            </li>
            <li>
              Record verification target for first inspection: measured cold Zs at every accessible
              end ≤ 0.8 × Table 41.3 max.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A semi-detached 1985-built dwelling with an existing 100 A BS 1361 service fuse
              cut-out and 25 mm² tails feeding a 2010 dual-RCD CU. The customer wants a 7.4 kW (32
              A) home EV charger fitted in the porch. Run is 28 m of 6 mm² T+E (with 2.5 mm² cpc)
              from the existing CU through the loft and down the porch wall to the EV charger
              isolator. Protected by a new 32 A Type B RCBO (BS EN 61009) added to a spare way in
              the existing CU. The DNO has no Form 1 on file (as is common for an older supply);
              design uses the BS 7671 assumed maximum for TN-C-S of Ze = 0.35 Ω.
            </>
          }
          whatToDo={
            <>
              Step 1 — Ze. No Form 1 available. Use BS 7671 assumed maximum for TN-C-S: Ze = 0.35 Ω.
              Cite on design pack: 'BS 7671:2018+A4:2026 / IET GN3 assumed maximum Ze for
              TN-C-S.'\n\nStep 2 — Cable and route. 6 mm² T+E to BS 6004 with 2.5 mm² cpc. Route
              length 28 m (loft + porch wall). OSG Table I1 mΩ/m at 20 degrees C: 6 mm² line = 3.08
              mΩ/m; 2.5 mm² cpc = 7.41 mΩ/m. Loop = 10.49 mΩ/m at 20 degrees C.\n\nStep 3 — Cold (R1
              + R2). 28 × 10.49 / 1000 = 0.294 Ω.\n\nStep 4 — Temperature correction. 70-deg
              thermoplastic, operating at 70 degrees C → factor 1.20 from OSG Appendix B. Hot (R1 +
              R2) = 0.294 × 1.20 = 0.353 Ω.\n\nStep 5 — Design Zs. Ze + hot (R1 + R2) = 0.35 + 0.353
              = 0.703 Ω. Table 41.3 max Zs for B32 in A4:2026 = 1.37 Ω. Margin = 1.37 - 0.703 = 0.67
              Ω. Pass with very comfortable margin (50 percent of the limit, design is
              robust).\n\nStep 6 — Sanity check Ipf. Ipf = U0 × Cmin / Zs = 230 × 0.95 / 0.703 = 311
              A. Type B RCBO magnetic threshold = 5 × 32 = 160 A. 311 A is well above 160 A —
              disconnection is in the magnetic region of the curve, well under 100 ms — comfortably
              within the 0.4 s required.\n\nStep 7 — Document on the design pack. Full trace
              recorded as listed above. Verification target for first inspection: measured cold Zs
              at the EV charger isolator ≤ 0.8 × 1.37 = 1.10 Ω. Note: 25 mm² tails to the existing
              CU contribute almost zero additional impedance to Zs (R1 contribution roughly 1.5 m ×
              0.727 mΩ/m × 1.20 = 1.3 mΩ — negligible) so the design Zs at the EV charger isolator
              is effectively the value calculated above with full margin.
            </>
          }
          whyItMatters={
            <>
              This is the canonical 2026 domestic EV install — TN-C-S supply, 100 A service, 25 mm²
              tails, dedicated 32 A B-curve RCBO. The design Zs of 0.703 Ω against a 1.37 Ω limit
              gives 0.67 Ω of margin — enough that a 10 m route extension during install (e.g. if
              the route turns out longer than surveyed) still leaves safe margin. The 25 mm² tails
              being effectively negligible in the (R1+R2) sum is worth noting — for typical domestic
              supplies, the dominant contributors are Ze and the final-circuit cable, not the tails.
              The discipline of citing the BS 7671 assumed Ze (because no Form 1 exists) is good
              professional practice — the inspector at first verification will measure actual Ze
              (typically 0.20-0.30 Ω in built-up areas — comfortably under the 0.35 assumption); the
              design holds up regardless.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Designer uses a free online Zs lookup app (or an old PDF cheat-sheet, or an old
              spreadsheet) that gives B32 max Zs = 1.44 Ω. Calculates a design Zs of 1.40 Ω — looks
              like a pass with 0.04 Ω margin. Submits the EIC. Next year an EICR with an updated
              lookup tool flags the same circuit at 1.40 Ω against the A4:2026 limit of 1.37 Ω —
              non-compliance with margin failure. The customer is now told their year-old install
              needs remedial work.
            </>
          }
          doInstead={
            <>
              Verify your Zs lookup tool is on the A4:2026 edition. Spot check: the published B32
              max Zs should read 1.37 Ω, NOT 1.44 Ω. C32 should read 0.68 Ω, NOT 0.72 Ω. D32 should
              read 0.34 Ω, NOT 0.36 Ω. If the tool gives the higher pre-A4 numbers it is out of
              date. Use a current Megger / Fluke / Kewtech app, or the printed BS 7671:2018+A4:2026,
              or calculate from first principles every time (max Zs = 218.5 / Ia for any device).
              The 5-second check protects the design from being non-compliant the day it lands.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Designer reads about Cmin 0.95 and conscientiously multiplies their calculated design
              Zs by 0.95 'to apply Cmin' — getting 0.703 × 0.95 = 0.668 Ω. Compares against Table
              41.3 max of 1.37 Ω. The apparent margin is now bigger than reality. The design is
              over-conservative — fine in this case (still passes) but in a borderline case the Cmin
              double-count could mask a fail by making it look like a pass.
            </>
          }
          doInstead={
            <>
              Cmin is applied ONCE — in the derivation of the Table 41.3 limit (which is U0 × Cmin /
              Ia). Your design Zs in the field is just Ze + (R1 + R2) at 70 degrees C, no Cmin
              multiplier. Compare your raw design Zs against the A4:2026 Table 41.3 limit which
              already has Cmin baked in. Where you DO apply Cmin separately is in the Ipf calc (Ipf
              = U0 × Cmin / Zs = 218.5 / Zs) for the disconnection-time sanity check — a different
              calc with a different purpose.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 411.3.1.1 is the underlying duty that the Reg 411.4.5 Zs check verifies. Every
              exposed-conductive-part must connect to a protective conductor; a CPC must run to
              every point; the CPC sizing (calculated under Reg 543.1.3) must survive the fault. The
              design Zs calc you do at the desk is the proof that the CPC, chosen against this duty,
              will let the device operate inside the Table 41.1 disconnection time. If the design Zs
              fails, you cannot meet 411.3.1.1 by virtue of the device being too slow at the actual
              fault current.
            </>
          }
        ...
        >
          <p>
            The temperature correction factor is derived from R(T) = R20 × [1 + α (T − 20)], where α
            for soft-annealed copper is 0.00393 per degree C. Plugging in:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>20 to 70 degrees C (PVC thermoplastic operating point):</strong> factor = 1 +
              0.00393 × 50 = 1.20. This is the OSG Appendix B figure used for the everyday domestic
              / commercial design.
            </li>
            <li>
              <strong>20 to 90 degrees C (XLPE thermosetting operating point):</strong> factor = 1 +
              0.00393 × 70 = 1.28. Use this on industrial sub-mains where the cable family is XLPE
              rather than PVC.
            </li>
            <li>
              <strong>
                20 to 60 degrees C (mineral insulated cable, lower-rated termination):
              </strong>{' '}
              factor = 1 + 0.00393 × 40 = 1.16. Less common, but worth knowing.
            </li>
          </ul>
          <p>
            The design Zs must hold at the conductor's actual operating temperature, because that is
            the temperature the conductor will reach under the steady-state design current Ib before
            any fault occurs. A fault that arrives when the cable is already at 70 degrees C sees a
            higher loop impedance than a fault at 20 degrees C, and the device sees a lower If —
            slower clearance, longer touch-voltage exposure. The temperature factor bakes that worst
            case into the design.
          </p>
          <p>
            The 0.8 acceptance criterion at verification (Sub 5.3) is the inverse of this
            temperature factor — measured cold ≤ 0.8 × hot limit means the cold reading, when scaled
            up by 1.20 to the operating temperature, will still sit at or below the Table 41.3
            limit. The two factors fit together cleanly: design with 1.20 applied (cold to hot),
            accept measured with 0.8 applied (hot to cold).
          </p>
        </ConceptBlock>
        ...
        >
          <p>The three legitimate sources for Ze at design stage:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DNO Form 1 (the connection agreement):</strong> the DNO declares Ze for the
              specific supply position. Typical figures: TN-C-S 0.20–0.35 Ω, TN-S 0.30–0.80 Ω. The
              Form 1 is contractually binding on the DNO; the design stands or falls on this number.
            </li>
            <li>
              <strong>BS 7671 assumed maxima (no Form 1):</strong> for a TN-C-S supply with no Form
              1, use Ze = 0.35 Ω as the assumed maximum. For a TN-S supply, use Ze = 0.80 Ω. These
              are the published "if you have nothing else to go on" figures — IET Guidance Note 3
              carries the same values. Cite the source on the design pack.
            </li>
            <li>
              <strong>Measured Ze from a previous EIC:</strong> on a refurbishment, the previous
              EIC's Ze measurement is a reasonable design starting point — the supply Ze does not
              change unless the DNO has reconfigured the network. Cite the source EIC and re-measure
              at first verification to confirm.
            </li>
          </ul>
          <p>
            Ze is not the same as Zdb (the loop impedance at the distribution board) or Zs (the loop
            impedance at the load). Ze is supply-side only — Zs = Ze + (R1 + R2) for the final
            circuit. Always be precise about which value you mean on the design pack; the EIC
            schedule has separate boxes for Ze, Zdb and Zs at the furthest accessible point of every
            circuit, and the values must reconcile.
          </p>
          <p>
            For TT supplies the "Ze" figure is the soil-electrode loop impedance, typically hundreds
            of ohms — completely different design regime, RCD-driven rather than MCB-driven (Reg
            411.5 and Sub 5.4 cover TT in detail).
          </p>
        </ConceptBlock>
        ...
        >
          <p>Quick-reference cold (R1+R2) per metre for common T&E:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>SWA cables</strong> — different table; use the OSG SWA section or manufacturer
              data. SWA is heavier and the steel armour can contribute to the protective conductor
        ...
        >
          <p>Where the worst-case design margins come from:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply tolerance</strong> — Cmin 0.95 already in the Table 41.3 limit; do not
              double-count.
            </li>
            <li>
              <strong>Network change</strong> — assume Ze can rise 20 percent over the install life;
              design to leave that margin.
            </li>
            <li>
              <strong>Cable grouping</strong> — multiple circuits in a single conduit or trunking
              run hotter; cable rating drops by the Appendix 4 grouping factor.
            </li>
            <li>
              <strong>Thermal insulation</strong> — cable embedded in or under insulation runs
              hotter; rating drops by the Appendix 4 insulation factor.
            </li>
            <li>
              <strong>Ambient temperature</strong> — design ambient is 30 degrees C; ceiling voids
              in summer can hit 50-60 degrees C; rating drops by the Appendix 4 ambient factor.
            </li>
            <li>
              <strong>Periodic re-verification</strong> — measured Zs at every EICR; the 0.8
              acceptance criterion catches drift before it becomes a defect.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Table 41.3 maxima per device type at 230 V (A4:2026 figures):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>B16 / C16 / D16</strong> — limits scale roughly inversely with In; B16 around
              2.74 ohms, C16 around 1.37 ohms, D16 around 0.69 ohms.
            </li>
            <li>
              <strong>Type-selection logic</strong> — Type B for general domestic, Type C for
              moderate inrush (small motors, fluorescent ballast), Type D for heavy inrush (welders,
              capacitor banks, large motors).
            </li>
            <li>
              <strong>Cite the type on the EIC</strong> — the schedule has a column for device type
              alongside rating. Future inspectors and designers rely on the explicit citation.
            </li>
          </ul>
        </ConceptBlock>
