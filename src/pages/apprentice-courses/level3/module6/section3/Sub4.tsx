...
const quizQuestions = [
  ...
  },
  {
    id: 7,
    question:
      'Per Reg 534.4.8, the conductor length between the SPD and the live and earth busbars should be:',
    options: [
  ...
  },
  {
    id: 8,
    question:
      "On a domestic CU upgrade with no LPS, no overhead supply, and no specific Section 443.4 trigger, the L3 designer's SPD position is:",
    options: [
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 3 · Subsection 4"
        title="SPD selection — Type 1, 2, 3 cascade"
        backTo="/study-centre/apprentice/level3-module6-section3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Surge protective device design — BS EN 61643 product standard, Section 443 risk-based
          selection, Section 534 installation rules. Type 1 at the origin for direct lightning, Type
          2 at distribution for induced surges, Type 3 at sensitive equipment. Cascade and
          protection design for the L3 mixed installation.
        </p>
        ...
        >
          <p>Transient overvoltages on the LV supply come from three sources:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Direct lightning strike</strong> — to the supply network, to an overhead
              service, to the building's external lightning protection system (LPS) where present.
              Magnitude: tens of kV, tens of kA, characteristic 10/350 microsecond impulse waveform.
              Rare event but extreme energy.
            </li>
            <li>
              <strong>Induced lightning surge</strong> — from a strike a few hundred metres to a few
              kilometres away. Magnetic coupling into the supply network induces a transient surge
              that propagates through the network. Magnitude: hundreds of volts to a few kV,
              characteristic 8/20 microsecond impulse waveform. Far more common than direct strikes;
              the dominant cause of equipment damage on most UK installations.
            </li>
            <li>
          ...
          <p>
            Sensitive electronics — switchmode power supplies in IT equipment, AV gear, smart-home
            controllers, LED drivers, washing-machine and dishwasher control boards — fail when the
            supply voltage exceeds the equipment's impulse withstand voltage (typically 1.5 kV for
            Category I sensitive electronics, 2.5 kV for Category II standard appliances). SPDs
            clamp the voltage that reaches the equipment to within the withstand category,
            preventing the cascade of failures.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 443.4.1 sets the consequence-based cases for SPD provision. There are two active
              limbs — (a) serious injury to, or loss of, human life, and (c) significant financial
              or data loss; limb (b) was deleted by the BS 7671:2018+A2:2022 Corrigendum (May 2023).
              Where (a) or (c) applies, SPDs shall be provided — no cost-benefit, just protection.
              For all other cases, protection shall be provided unless the owner of the installation
              declares it is not required because any loss or damage is tolerable and they accept
              the risk. The L3 designer documents the assessment on the design pack — the
              consequence limbs checked with yes / no and reasoning, any owner declaration for the
              residual case, the conclusion 'protection provided / not provided' with the SPD
              specification or the reason for omission.
            </>
          }
        ...
        >
          <p>Type 1 SPD characteristics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Up typically 1.5-4 kV — higher let-through than Type 2; downstream Type 2 / 3 needed
              for sensitive equipment.
            </li>
            <li>
              Uc (maximum continuous operating voltage) per pole — typically 275 V or 350 V for 230
              V single-phase supplies; matched to the supply earthing arrangement (TN-S, TN-C-S, TT
              — different combinations use different SPD modes).
            </li>
            <li>
              Located at the installation origin, supply-side of the main switch where possible.
            </li>
            <li>
              Mandatory protective conductor minimum 16 mm² copper to the MET (Reg 534.4.10(b)).
            </li>
            <li>
              Live connection minimum 6 mm² copper, rated for prospective short-circuit (Reg
              534.4.10(d)).
            </li>
          </ul>
          <p>
            When to specify Type 1: building has external LPS per BS EN 62305-3; building has
            high-exposure overhead supply (rural, exposed location, high keraunic level); specific
            risk assessment indicates direct-strike pathway exists. For most urban / suburban
            installations without LPS, Type 1 is not required and Type 2 at the origin is the
            standard answer. Many manufacturers offer 'Type 1+2 combined' devices that handle both
            10/350 and 8/20 waveforms in a single module — used at the origin where LPS is present,
            replacing separate Type 1 and Type 2 devices.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Type 2 SPD characteristics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Handles 8/20 microsecond impulse waveform (induced surges, switching transients).
            </li>
            <li>
              In (nominal discharge current) typically 5-20 kA per pole; Imax (maximum discharge
              current) typically 10-40 kA per pole.
            </li>
            <li>
              Up typically 1.0-2.5 kV — lower let-through than Type 1; suitable to protect Category
              II / III equipment.
            </li>
            <li>
              Uc per pole matched to supply (typically 275 V for 230 V single-phase TN systems).
            </li>
            <li>
              Located at the installation origin / main distribution board, supply-side of the main
              switch where possible.
            </li>
            <li>
              Mandatory protective conductor minimum 6 mm² copper to the MET (Reg 534.4.10(a)).
            </li>
            <li>
              Live connection minimum 2.5 mm² copper, rated for prospective short-circuit (Reg
              534.4.10(c)).
            </li>
            <li>
              Dedicated overcurrent protection per the SPD manufacturer's specification (typically a
              25 A or 32 A MCB or HRC fuse).
            </li>
          </ul>
          <p>
            When to specify Type 2: most installations without LPS. Standard fit where a Reg 443.4.1
            consequence applies — care homes, HMOs and clinical premises engage the (a) serious
            injury / loss of human life limb; commercial premises with valuable data or business
            continuity engage the (c) significant financial or data loss limb. On owner-occupied
            domestic, none of the active consequence limbs is usually triggered, so protection shall
            be provided unless the owner declares it is not required because the loss or damage is
            tolerable — present the case to the customer and let them decide.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Type 3 SPD characteristics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Handles small residual surges that survive upstream protection.</li>
            <li>
              In typically 1-5 kA per pole; intended for the smaller residual rather than the bulk
              transient.
            </li>
            <li>
              Up typically 0.6-1.5 kV — lowest let-through, suitable to protect Category I sensitive
              electronics.
            </li>
            <li>
              Located close to sensitive equipment — within typically 5-10 metres of the equipment
              terminals.
            </li>
            <li>
              Form factors: socket-outlet integrated, dedicated DIN-rail near the load, plug-in
              surge strips for IT / AV equipment.
            </li>
            <li>
              Type 3 alone is not sufficient — requires upstream Type 2 (or Type 1+2) at the origin
              to handle the bulk of the transient energy. A Type 3 hit by a full surge would fail at
              first event.
            </li>
          </ul>
          <p>
            When to specify Type 3: server cabinets, NAS / video-surveillance rack, medical
            equipment in clinical premises, AV / studio gear in production environments, specialised
            electronic plant where the equipment's impulse withstand is below 1.5 kV and the cascade
            Up at that point would otherwise exceed the withstand. Standard residential and
            commercial installations normally do not need Type 3 — Type 2 at the consumer unit /
            main board is sufficient for the typical Category II equipment load.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 534.4.10(a)</strong> — Type 2 SPD: protective conductor minimum 6 mm²
              copper or equivalent.
            </li>
            <li>
              <strong>Reg 534.4.10(b)</strong> — Type 1 SPD: protective conductor minimum 16 mm²
              copper or equivalent.
            </li>
            <li>
              <strong>Reg 534.4.10(c)</strong> — Type 2 SPD: live connection conductor minimum 2.5
              mm² copper, rated to withstand the prospective short-circuit current.
            </li>
            <li>
              <strong>Reg 534.4.10(d)</strong> — Type 1 SPD: live connection conductor minimum 6 mm²
              copper, rated to withstand the prospective short-circuit current.
            </li>
          </ul>
          <p>
            ...
            defeating the SPD function. The 6 mm² and 16 mm² minimums are the floor; longer runs or
            higher let-through capability may justify upsizing further. The live connection
            conductor must be rated for the prospective short-circuit current at the SPD location
            because the SPD's overcurrent protection (the MCB or fuse upstream of the SPD) must be
            able to clear a short-circuit fault on the SPD itself without damaging the live
            conductor.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 534.4.10 sets two distinct CSA requirements on the SPD installation: protective
              conductor (SPD to MET / PE) minimum 6 mm² for Type 2 or 16 mm² for Type 1 at the
              origin; live connection (SPD to OPD to live busbar) minimum 2.5 mm² for Type 2 or 6
              mm² for Type 1 at the origin. The CSA floors apply at the origin; downstream SPDs
              (cascade Type 2 at sub-distribution boards, Type 3 at point-of- use) may use smaller
              CSAs per the SPD manufacturer's installation instructions. The live connection must
              additionally be rated for the prospective short-circuit current — the SPD's dedicated
              OPD must be able to clear a fault on the SPD itself without damaging the connecting
              conductor.
            </>
          }
        ...
        >
          <p>
            ...
            hundreds of volts to the let-through voltage seen by downstream equipment. Reg 534.4.8
            therefore requires the connecting conductors between the live, SPD and earth to be kept
            as short as practicable.
          </p>
          <p>Practical limits:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Total combined length (live to SPD + SPD to earth) less than 0.5 m where possible.
            </li>
            <li>
              Where short straight runs are not achievable, use the SPD manufacturer's V-connection
              method (loop the live conductor through the SPD body so the live current and the SPD
              discharge current share part of the path).
            </li>
            <li>
              For SPDs in dedicated SPD enclosures alongside the main switch, the manufacturer's
              recommended layout typically achieves the under-0.5 m total without specific design
              effort.
            </li>
            <li>
              Avoid coiled conductors, sharp bends, or routing the SPD discharge conductor parallel
              to live conductors over long distances — all increase inductance.
            </li>
          </ul>
          <p>
            The single biggest install-quality issue with SPDs is excessive connection length. The
            SPD looks fitted, the indicator shows green, but the let-through at the equipment is
            much higher than the SPD's quoted Up because the inductive voltage drop on the
            connecting conductors dominates the circuit at surge frequencies. The L3 designer
            specifies the SPD location (close to the busbars) and the maximum permissible connection
            length on the schedule, and the installer follows it. Both roles are accountable for the
            install quality.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stage 1 — Type 1 (or Type 1+2 combined) at the origin</strong> — diverts the
              bulk of the transient energy to earth. Let-through at SPD terminals: Up typically
              1.5-4 kV.
            </li>
            <li>
              <strong>Stage 2 — Type 2 at distribution</strong> — reduces the surviving surge.
              Decoupling distance from Stage 1 typically greater than 10 m of cable inductance, or
              via a dedicated decoupling inductor. Let-through at Stage 2 SPD terminals: Up
              typically 1.0-2.5 kV.
            </li>
            <li>
              <strong>Stage 3 — Type 3 at sensitive equipment</strong> — trims the residual surge to
              a level the equipment can withstand. Decoupling distance from Stage 2 typically
              greater than 5 m of cable inductance. Let-through at Stage 3 SPD terminals: Up
              typically 0.6-1.5 kV.
            </li>
          </ul>
          <p>
            Without the decoupling distances both devices may operate but the downstream device sees
            a higher let-through than its rating, defeating the cascade and potentially damaging the
            downstream device. Manufacturer cascade tables specify the maximum permissible cable
            lengths between SPDs and the resulting let-through at each stage; the L3 designer cites
            the cascade table on the design schedule and the installer follows the cable lengths.
          </p>
          <p>
            On a typical commercial fit-out the cascade is two-stage: Type 1+2 (or Type 2 alone if
            no LPS) at the origin, plus Type 2 (or sometimes Type 3) at sub-distribution boards
            serving sensitive equipment groups. On a typical residential CU the cascade is
            single-stage: Type 2 at the consumer unit only.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Category I</strong> — sensitive electronics intended to be protected by
              upstream SPD. Typical withstand at 230 V supply: 1.5 kV. Examples: small electronics,
              communication equipment, instrumentation.
            </li>
            <li>
              <strong>Category II</strong> — standard appliances and equipment connected to the
              fixed installation. Typical withstand: 2.5 kV. Examples: kitchen kit, lighting,
              sockets, most domestic and commercial appliances.
            </li>
            <li>
              <strong>Category III</strong> — distribution equipment and equipment downstream of the
              origin. Typical withstand: 4 kV. Examples: main switches, distribution boards,
              switchgear in the installation.
            </li>
            <li>
              <strong>Category IV</strong> — equipment at the origin / supply side. Typical
              withstand: 6 kV. Examples: DNO cut-out equipment, supply head terminations, intake
              fuses.
            </li>
          </ul>
          <p>
            The L3 designer chooses SPDs such that the let-through Up at the equipment terminals is
            at or below the equipment's category withstand. For Category II equipment (most
            residential and commercial appliances) a Type 2 SPD with Up in the 1.0-2.5 kV range is
            sufficient. For Category I sensitive equipment (server rack, AV studio gear), cascade
            with a Type 3 close to the equipment to bring Up below 1.5 kV. The schedule records the
            protected equipment category and the SPD Up against each row.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              building has no LPS and no overhead direct-strike risk path. The customer pays three
              times the price of a Type 2 device for protection capability they will never use.
              Worse, the higher Up of the Type 1+2 means the let-through at the customer's
              appliances is higher than a plain Type 2 would have provided — inferior protection at
              higher cost.
            </>
          }
          doInstead={
            <>
              Match the SPD type to the threat. Type 1 is for direct-strike risk paths — LPS per BS
              EN 62305-3, exposed overhead supply, specific high-exposure scenarios. For most
              domestic and small commercial installations without LPS, Type 2 at the origin is
              correct — lower Up, lower cost, better protection for the actual threat (induced
              surges and switching transients). Read the building, read the supply, read the
              keraunic exposure, then specify.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The installer fits a Type 2 SPD on a free DIN-rail position 30 cm away from the main
              switch and earth busbar. Live and earth connections are made with 1.5 m conductors
              looped around the consumer unit interior. The SPD's quoted Up is 1.5 kV but the actual
              let-through at the equipment is over 3 kV because the conductor inductance adds 1.5 kV
              at surge frequencies. A surge event damages a connected appliance even though the SPD
              operated. The customer is told 'the SPD did its job' but the equipment is still
              broken.
            </>
          }
          doInstead={
            <>
              Specify the SPD location on the schedule — adjacent to the main switch, with conductor
              lengths specified less than 0.5 m total combined. Use the SPD manufacturer's
              recommended consumer unit position (most modern consumer units have a dedicated SPD
              location). For retrofits where the existing CU has no SPD position, use a separate SPD
              enclosure mounted next to the CU with short tails to the live and earth, rather than
              fitting the SPD inside the CU with long flying leads. The let-through voltage seen by
              downstream equipment depends critically on the install quality.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              Customer values their AV and IT equipment (modest server / NAS, multi-room AV system,
              smart-home controllers).
            </>
          }
          whatToDo={
            <>
              Apply Section 443. Neither Reg 443.4.1(a) (serious injury or loss of human life) nor
              (c) (significant financial or data loss) is engaged on a single owner-occupied
              dwelling, so protection shall be provided unless the owner declares it is not required
              because the loss or damage is tolerable. Sensitive AV / IT equipment is present,
              supply-network induced surges are plausible, and the cost of replacement equipment in
              the event of a strike near-miss is substantial — so the owner is unlikely to declare
              the loss tolerable. Outcome: protection recommended. Specify a Type 2 SPD at the new
              consumer unit, supply-side of the main switch, dedicated 25 A MCB for SPD OPD, 6 mm²
              copper protective conductor to the MET (Reg 534.4.10(a)), 2.5 mm² live connections
              (Reg 534.4.10(c)), conductor lengths less than 0.5 m total combined (Reg 534.4.8). For
              the AV / IT equipment cluster, recommend Type 3 socket-outlet or plug-in surge strip.
              Document the Section 443 assessment in the design pack and customer-facing summary.
            </>
          }
          whyItMatters={
            <>
              The Section 443 consequence assessment is the L3 designer's discipline. Where a Reg
              443.4.1 consequence applies, protection is required. Where it does not, protection
              shall still be provided unless the owner declares the loss or damage tolerable — and
              on most informed customer installations the owner does not, so the answer is
              'protection recommended', particularly with connected sensitive electronics. The
              customer ends up with appropriate protection (Type 2 at the CU plus Type 3 at the AV
              cluster), proper installation discipline (short conductors, correct CSA) and
              documented assessment that supports a future periodic inspection or insurance enquiry.
              This is design done well, not over-engineered and not under-engineered.
            </>
          }
        />
        ...
        >
          <p>
            SPDs are connected in different configurations (modes) depending on the supply earthing
            arrangement:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              marketed for UK domestic / small commercial are designed for TN with appropriate mode
              arrangement.
            </li>
            <li>
              <strong>TT systems</strong> — separate installation earth electrode, no DNO PEN. The
              SPD must protect against transients arriving via the supply (live, neutral) with
              reference to the local earth electrode rather than a DNO-provided earth. Modes-3 SPDs
              (with live-neutral, live-earth, neutral-earth modes all addressed) are typical. Some
              manufacturers offer 'TT-specific' modules with a higher Uc on the neutral-earth mode
              to handle the higher neutral-to-earth voltage that can occur on TT during a fault.
            </li>
            <li>
          ...
          <p>
            The L3 designer specifies the SPD with the supply earthing arrangement on the schedule,
            and the device's nameplate Uc per mode is verified against the supply type. Wrong-mode
            SPDs do not fail catastrophically on the day of install, but they may fail prematurely
            under normal supply-voltage variation, or fail to operate correctly on a transient.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            showing green (working) or red (end-of-life), or an LED on more modern devices. The SPD
            degrades with each significant surge it handles, and may eventually fail in one of two
            modes:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Open-mode failure</strong> — SPD no longer provides surge protection but does
              not draw any continuous current. The status indicator shows red. The installation
              continues to operate but is unprotected. This is the more common end-of-life failure.
            </li>
            <li>
              <strong>Short-mode failure</strong> — SPD develops a short to earth, drawing
              continuous current. The dedicated SPD overcurrent protection (the MCB or fuse upstream
              of the SPD per the manufacturer's specification) operates and disconnects the SPD. The
              status indicator shows red.
            </li>
          </ul>
          <p>Periodic inspection should:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Visually inspect the SPD status indicator — record green / red on the schedule of
              inspections.
            </li>
            <li>
              If red — code the finding (typically C2 if the SPD function is intended to provide
              active protection and is now absent, or C3 if SPD provision was advisory rather than
              mandatory).
            </li>
            <li>
              Verify that the SPD overcurrent protection is in place and not tripped (a tripped OPD
              on the SPD circuit may mask a short-mode SPD failure).
            </li>
            <li>
              Test the SPD test button if provided (some modern devices have a self-test function —
              operate per the manufacturer's instructions).
            </li>
          </ul>
          <p>
            Replacement SPDs are sold as plug-in spare modules that fit into the existing DIN base,
            so replacement is straightforward and does not require re-terminating conductors.
            Customer handover should explain the status indicator, where it is, and what to do if it
            shows red — typically 'phone the contractor for a replacement module within a few weeks;
            the supply continues to work but the surge protection is not active until replacement'.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Appendix 16 is identified as &quot;(Informative)&quot; and titled &quot;Devices for
              protection against overvoltage&quot;. It provides guidance material related to devices
              intended to protect installations and equipment from overvoltage phenomena. As an
              appendix, it supplements the body requirements of BS 7671 with explanatory or
              selection guidance for overvoltage protective devices used in low-voltage
              installations.
            </>
          }
          meaning={
            <>
              Surge protective device (SPD) selection draws on the body requirements of Section 443
              plus the informative guidance in Appendix 16. Designers should read the appendix when
              specifying SPDs to confirm device class, location and coordination with the rest of
