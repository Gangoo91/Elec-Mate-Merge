...
const checks = [
  {
    id: 'afdd-wording',
    question: 'BS 7671 A4:2026 Reg 421.1.7 says about AFDDs:',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 4,
    question:
      "Which occupancy type currently has the strongest AFDD requirement (beyond Reg 421.1.7's general recommendation)?",
    options: [
  ...
  },
  {
    id: 8,
    question:
      "On a domestic CU upgrade in a typical owner-occupied house in 2026, the L3 designer's AFDD position is:",
    options: [
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 3 · Subsection 3"
        title="AFDD design considerations and Reg 421.1.7"
        backTo="/study-centre/apprentice/level3-module6-section3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Arc Fault Detection Device design — what AFDDs do, where Reg 421.1.7 recommends them, the
          BS EN 62606 product standard, the Building Safety Act 2022 / HRRB hardening, and how to
          specify them on a domestic CU upgrade or commercial fit-out without breaking the
        ...
        >
          <p>
            ...
            currents — line-to-earth residual current. Both miss arcing faults that sit between the
            conventional thresholds:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Series arc</strong> — single conductor with intermittent contact. A damaged
              flex, a loose terminal screw, a corroded socket-outlet contact, a worn appliance lead.
              Current sits at the load's normal operating current (a few amps) but the contact arcs
              each cycle, dissipating heat at the arc point. The magnitude does not exceed the OPD
              threshold. The arc is line-to-line / line-to-neutral, not line-to-earth, so the RCD
              does not see it. The local heat ignites the insulation or the surrounding fabric over
              hours.
            </li>
            <li>
              <strong>Parallel arc</strong> — between conductors before they fully short-circuit.
              Insulation degradation, cable damage from a nail or screw, terminal flashover. A full
              short-circuit would trip the OPD instantly; a parallel arc that sits at modest current
              for some seconds before progressing to full short can ignite the cable before the OPD
              operates.
            </li>
          </ul>
          <p>
            AFDDs detect the high-frequency signature of arcing in the load current waveform. The
            signal-processing inside the AFDD analyses the current for characteristic patterns —
            repeated current pulses, frequency content above 50 Hz, gap-filled cycles — and trips
            when the pattern matches an arc fault. The product standard BS EN 62606 sets the
            detection performance and the immunity to false trip from normal load behaviour.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              deliberately advisory ('recommending the installation') rather than mandatory ('shall
              be installed'). The competent designer reads this as 'install where the engineering
              benefit and the customer / occupancy profile justify it'. Periodic inspection of
              pre-A4 installations does not code the absence of AFDDs as C2 by default; it might
              recommend C3 (improvement recommended) if the occupancy profile makes the absence
              material. The hardening of this recommendation into a requirement for specific
              occupancy types comes from the Building Safety Act 2022 and HRRB secondary
              legislation, not from Reg 421.1.7 itself.
            </>
          }
        ...
        >
          <p>Three regulatory layers operate on AFDD requirements:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BS 7671 A4:2026 Reg 421.1.7</strong> — advisory. 'Recommending the
              installation of AFDDs.' Not a mandatory requirement at the BS 7671 level for general
              installations. Periodic inspection does not code absence as C2.
            </li>
            <li>
              <strong>Building Safety Act 2022 + HRRB regime</strong> — for higher-risk residential
              buildings (broadly residential buildings 18 m or seven storeys and above with sleeping
              accommodation), the Building Safety Regulator gateway 2 / 3 review treats AFDDs as
              effectively required on final circuits, even though BS 7671 itself remains advisory.
              HRRB design without AFDDs would face challenge.
            </li>
            <li>
            ...
            <li>
              <strong>Engineering judgement / risk profile</strong> — even where none of the above
              applies, the L3 designer may recommend AFDDs where the engineering case justifies it
              (long-life occupancy with aged cabling, sleeping accommodation, high socket-outlet
              density with extension-lead use).
            </li>
          </ul>
          <p>
            The L3 designer reads each layer in turn, applies the strictest, documents the decision.
            On a domestic CU upgrade for an owner-occupier none of the layers above the BS 7671
            advisory apply — the conversation is engineering recommendation plus customer choice. On
            an HRRB the conversation is mandatory specification with compliance evidence. The
            discipline is the same: read, apply, document.
          </p>
        </ConceptBlock>
        ...
        >
          <p>An AFDD-RCBO row on the design schedule:</p>
          <p className="font-mono bg-white/[0.05] border border-white/[0.08] rounded-lg px-3 py-2 text-[13px]">
            AFDD-RCBO 32 A Type B 6 kA Icn 30 mA Type A | BS EN 62606 + BS EN 61009-1 | Manufacturer
            X part Y | design max Zs 1.37 ohms (Table 41.3 A4:2026)
          </p>
          <p>Each element of the row matters:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>AFDD-RCBO</strong> — combined module type. Could also be AFDD-MCB (no RCD) or
              standalone AFDD (operates only on arc detection).
            </li>
            <li>
              <strong>32 A</strong> — circuit rating, matched to Ib less than or equal to In less
              than or equal to Iz per Reg 433.1.1.
            </li>
            <li>
              <strong>Type B</strong> — overcurrent characteristic (3-5 x In magnetic). Could be
              Type C for higher in-rush circuits.
            </li>
            <li>
              <strong>6 kA Icn</strong> — breaking capacity, matched to PSCC at the device per Reg
              434.5.1.
            </li>
            <li>
              <strong>30 mA Type A</strong> — RCD trip threshold and class. 30 mA is the additional
              protection threshold; Type A is the modern minimum.
            </li>
            <li>
              <strong>BS EN 62606 + BS EN 61009-1</strong> — product standards for the AFDD function
              and the RCBO function respectively.
            </li>
            <li>
              <strong>Manufacturer / part</strong> — for traceability and verification at install.
            </li>
            <li>
              <strong>Design max Zs</strong> — Table 41.3 figure for the OPD function (the AFDD
              function does not have a Zs limit in the same way; the RCD function has its own
              residual-current operating threshold).
            </li>
          </ul>
          <p>
            On a domestic CU upgrade with eight final circuits, a fully-AFDD'd schedule has eight
            such rows. On a commercial board with fifty circuits, fifty such rows. The consistency
            of the row format is the design discipline — vague rows ('AFDD on circuit 4') invite
            installer error and inspector challenge.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Immunity to nuisance trip</strong> — the device must NOT trip on normal load
              behaviour. Test waveforms include: small motor starting transients (vacuum cleaners,
              fans), fluorescent lamp starting flicker, switching transients (relay contacts,
              solenoid energisation), light-dimmer phase-cutting, switchmode supply in-rush.
            </li>
            <li>
              <strong>Combined-device requirements</strong> — for AFDD-MCB and AFDD-RCBO modules,
              the standard specifies how the AFDD function integrates with the OPD / RCD function.
              The RCD function continues to operate per BS EN 61008 / 61009-1; the OPD function
              continues to operate per BS EN 60898; the AFDD function adds on top.
            </li>
            <li>
              <strong>Marking and end-user information</strong> — the device must be clearly marked
              as AFDD and the user must be supplied with information on how to test the AFDD
              function (typically a dedicated test button, separate from the RCD test button).
            </li>
          </ul>
          <p>
            Always verify on the schedule that the specified AFDD is BS EN 62606 compliant. Devices
            marketed as 'arc-fault aware' or 'arc-tolerant' that are not BS EN 62606 tested do not
            qualify as AFDDs for design purposes.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 411.3.1.1 mandates ADS on earth faults — the OPD or RCD must operate within the
              Table 41.1 disconnection time. AFDDs are not a substitute for ADS; they operate on a
              different fault type (arcing fault, not low-impedance earth fault). A combined
              AFDD-RCBO module satisfies both — the RCD function provides ADS on earth faults (and
              additional protection at 30 mA), the OPD function provides ADS on short-circuit
              faults, the AFDD function provides additional protection against arcing faults that
              the OPD and RCD do not see. All three operate independently inside the same module.
            </>
          }
        ...
        >
          <p>
            On a typical owner-occupied domestic CU upgrade, your AFDD conversation goes something
            like:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Explain Reg 421.1.7 in plain language: BS 7671 recommends AFDDs on AC final circuits
              to reduce fire risk from arc faults in damaged cabling and worn appliances.
            </li>
            <li>
              Explain what AFDDs detect: arcing faults at low currents that conventional breakers
              and RCDs do not see. Common cause: damaged flex, worn appliance leads, loose
              terminals.
            </li>
            <li>
              Explain where the engineering benefit is greatest: bedroom and lounge socket circuits,
              kitchen sockets, anywhere with extension leads and routine plug / unplug.
            </li>
            <li>
              Explain where the engineering benefit is more modest: dedicated single-load circuits
              (shower, immersion, EV, heat pump), lighting circuits with no flex.
            </li>
            <li>
              Quote the cost — typically 3-5 x the cost of an equivalent RCBO per AFDD-RCBO module.
              Six AFDD-RCBOs on a typical CU might add £200-£400 to the project bill.
            </li>
            <li>
              Let the customer decide which circuits to AFDD-protect. Document the decision in the
              design pack — 'AFDDs offered per Reg 421.1.7; customer accepted on circuits A, B, C;
              declined on circuits D, E, F, G'.
            </li>
          </ul>
          <p>
            Documentation is the protection — for you and for them. A customer who declined AFDDs in
            writing has accepted the risk; a customer who was never offered the choice can credibly
            claim 'you should have insisted'. The conversation takes ten minutes; the documentation
            takes five. Both are part of the L3 design product.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              final circuit. You quote the upgrade with eight AFDD-RCBOs. The customer compares with
              another contractor who has read the regulation correctly, gets a quote with
              conventional RCBOs, and you lose the job. Worse, you have miscommunicated a regulation
              to a customer — they will repeat it.
            </>
          }
          doInstead={
            <>
              Read Reg 421.1.7 carefully. The wording is 'recommending', not 'shall be installed'.
              Present the case correctly: BS 7671 recommends, the engineering case is strongest on
              socket circuits, the cost premium is real, and the decision is the customer's.
              Document the decision either way. On HRRB and insurer-driven installations the
              conversation goes differently, but on a typical owner-occupied domestic CU upgrade the
              regulation is advisory and the customer chooses.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You decide AFDDs are 'just a recommendation' and do not mention them to the customer
              at all. You quote the upgrade with conventional RCBOs. Two years later a series arc
              fault in a kitchen extension lead starts a fire while the customer is asleep. The fire
              investigation flags the absence of AFDDs as a contributory factor. The customer's
              insurer pursues you for failing to discuss a relevant safety option. Your professional
              indemnity is engaged.
            </>
          }
          doInstead={
            <>
              The L3 design discipline is to surface every relevant safety option, not just the ones
              that are mandatory. AFDDs are recommended by BS 7671; that recommendation has to be
              presented to the customer with the engineering case and the cost, and the decision
              documented. Skipping the conversation because the regulation is advisory is a
              defensive failure — both regulatorily and reputationally. Inform, recommend, document.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              replaced 2010, some new from the upgrade). Customer is owner-occupier, no Building
              Safety Act 2022 applicability. No insurer or employer requirement.
            </>
          }
          whatToDo={
            <>
              Present the AFDD case to the customer. Strongest engineering benefit on the bedroom
              socket ring (sleeping accommodation, mixed-age cable, occasional lamp / charger flex),
              the lounge socket ring (long-life flex on entertainment system), and the kitchen ring
              (regular plug / unplug, mixed appliance use). Less benefit on the new shower
              (dedicated, fixed flex), new EV charger (dedicated, fixed flex, modern equipment), new
              heat pump (dedicated, fixed flex), new lighting (LED on fixed wiring, no flex). Quote
              two specifications: full AFDD on all final circuits (premium) and AFDD on the three
              socket circuits only (engineering-justified middle ground). Customer chooses the
              middle ground; you document the decision in the design pack.
            </>
          }
          whyItMatters={
            <>
              The AFDD conversation is the L3 design role at its most useful — turning a regulatory
              recommendation into a customer decision based on engineering judgement and cost. The
              customer ends up with AFDDs where they help most, conventional RCBOs where the AFDD
              function would add little, and a documented record of the decision. The schedule shows
              three AFDD-RCBO rows and five RCBO rows, each with full specification. Inspector
              verification is straightforward; future periodic inspection has documented design
              intent to verify against; insurer enquiry has evidence of regulatory compliance and
        ...
        >
          <p>When an AFDD trips repeatedly, work the diagnosis logically:</p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Press the test button</strong> on the AFDD with the circuit live (or at least
              the upstream supply live). The device should trip cleanly and reset cleanly — confirms
              the AFDD function is healthy and the test button mechanism is working.
            </li>
            <li>
              <strong>Unplug all connected loads on the affected circuit.</strong> Re-energise. Does
              it stay on? If yes, the issue is load-related; if no, the issue is in the fixed
              wiring.
            </li>
            <li>
              <strong>Plug loads back in one at a time</strong>, leaving each running for a few
              minutes before adding the next. The first load that trips the AFDD is the suspect.
            </li>
            <li>
              <strong>Inspect the suspect load</strong> — look at the flex (frayed, kinked,
              near-broken strands at the plug or appliance end), the plug terminations (loose,
              oxidised), the appliance switch (sparking, intermittent), the appliance internals
              (visible degradation around connection blocks).
            </li>
            <li>
              <strong>If no load trips</strong> the device repeatedly during the diagnostic, the
              issue is in fixed wiring — typically a loose terminal at an accessory, a poor crimp at
              a junction box, or a damaged cable in a wall void. Inspect each accessory in turn for
              signs of arcing (discoloration, scorch marks, loose terminations) and remediate.
            </li>
            <li>
              <strong>Document the diagnostic outcome.</strong> Genuine arc fault detected and
              remediated → restore service, customer education on the failure mode. Cause cannot be
              identified after thorough diagnosis → consider replacing the AFDD with a different
              manufacturer (BS EN 62606 immunity tests differ between manufacturers; some are
              tighter than others).
            </li>
          </ol>
          <p>
            <strong>Loads with elevated false-trip risk</strong> (verify with manufacturer
            compatibility data):
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Old fluorescent fittings with magnetic ballasts</strong> — starter cycling
              produces transient noise that can resemble arcing. Modern LED retrofits of these
              fittings remove the issue.
            </li>
            <li>
              <strong>Variable-speed brushed motors</strong> (food processors, hand drills, vacuum
              cleaners with brushed universal motors) — brush sparking is a near-continuous arcing
              signature. AFDDs that pass nuisance immunity testing handle these correctly, but
              ageing motors with worn brushes can trigger sensitive devices.
            </li>
            <li>
              <strong>Phase-cut dimmers with high inductive load</strong> — old rotary dimmers
              feeding inductive loads (transformer-fed halogens) can produce trip-worthy waveforms.
            </li>
            <li>
              <strong>Switch-mode PSUs with poor in-rush limiting</strong> — large in-rush at
              switch-on can occasionally trigger AFDDs on the verge of their detection threshold.
            </li>
          </ul>
          <p>
            On a domestic install where AFDD nuisance tripping is recurrent and the load mix is
            benign, consider whether the customer has accepted the right specification. The L3
            designer's job is to inform — explain that AFDDs are doing their job, that the nuisance
            trips are typically diagnosing genuine equipment issues, and that occasional resets are
            the price of additional fire protection. Where the diagnosis genuinely points to AFDD
            over-sensitivity (rare on BS EN 62606 devices from major manufacturers), the alternative
            is a conventional RCBO with the customer informed that the AFDD layer of protection has
            been removed.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            follows the same logic: target circuits where arc-fault risk is meaningful (mixed socket
            use, public spaces, sleeping accommodation in HRRBs); cite BS EN 62606 plus BS EN 60947
            for the three-phase device class; specify breaking capacity and trip characteristic for
            the OPD function. For most commercial three-phase distribution the engineering case for
            AFDD is on lower-rated final circuits (16 A or 20 A radial, three-phase socket-outlets
            in workshop / studio environments), not on upstream distribution.
          </p>
          <p>For commercial / industrial sites generally, AFDDs are growing on:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              HMO and HMO-equivalent dwellings with shared common areas (sleeping accommodation,
              mixed cable ages, multiple tenant changes).
            </li>
            <li>
              Care homes, hospices, sheltered housing — sleeping accommodation with vulnerable
              occupants.
            </li>
            <li>Hotels and student accommodation — sleeping accommodation with high turnover.</li>
            <li>
              Heritage buildings and museums — irreplaceable contents and complex installation
              history.
            </li>
            <li>Hospitals and clinical environments — life-safety adjacency.</li>
            <li>
              Premium commercial fit-outs where the client specifies AFDDs as part of the employer's
              requirements.
            </li>
          </ul>
          <p>
            The L3 designer reads the occupancy profile, the regulatory layers and the client
            specification, and proposes AFDDs where the case justifies. On a generic warehouse or
            office fit-out the engineering case is more limited and the conventional RCBO
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              For combined AFDD-RCBO, also operate the RCD test button — confirms the RCD function
              trips. Reset.
            </li>
            <li>
              Continuity, IR, polarity, Zs and RCD operating tests proceed as for any final circuit.
            </li>
            <li>
              Record AFDD test result on the schedule of test results — typically a dedicated 'AFDD
              test' column or note.
            </li>
          </ul>
          <p>At periodic inspection:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Operate the AFDD test button — should trip. If not, code as appropriate (typically C2
              if the AFDD function is intended to provide protection that is now absent).
            </li>
            <li>Operate the RCD test button — should trip. Same rule.</li>
            <li>Standard periodic test sequence proceeds.</li>
          </ul>
          <p>
            At customer handover, demonstrate the AFDD test button to the customer and explain that
            it should be pressed every six months as part of the standard RCD test routine. Most
            modern AFDD-RCBO modules have separate AFDD and RCD test buttons; older or combined-test
            models may have a single test button that exercises both functions.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              installation due to the effects of arc fault currents. The regulation&apos;s wording
              uses &quot;recommending&quot; rather than mandatory phrasing.
            </>
          }
          meaning={
            <>
              AFDDs are advisory under BS 7671 — but mandatory in high-rise residential buildings
              via the Building Safety Act 2022 framework. Designers should now default to AFDDs on
              fire-risk-elevated AC final circuits and document any decision to omit them.
              Manufacturers commonly supply AFDD-RCBO modules combining the AFDD and the RCD
