...
const TITLE = 'Correction factors Ca, Cg, Ci (4.3) | Level 3 Module 6.4.3 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['120 A', '20 A', '≈35.1 A', '11.4 A'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 3,
    question: 'What does Ca actually represent physically?',
    options: [
  ...
  {
    id: 5,
    question: 'Ci is the in-thermal-insulation correction. For Methods 100–103 you should:',
    options: [
  ...
  },
  {
    ...
    options: ['≈52.39 A', '≈49.23 A', '32 A', '≈20.96 A'],
    correctAnswer: 0,
    explanation:
...
const faqs = [
  ...
  {
    question:
      'If two circuits are grouped but only one is loaded heavily, do I still apply full Cg?',
    answer:
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 4 · Subsection 3"
        title="Correction factors Ca, Cg, Ci — the derate stack"
        backTo="/study-centre/apprentice/level3-module6-section4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Each correction factor in detail. Ca for ambient temperature (Table 4B1), Cg for grouping
          (Tables 4C1–4C5), Ci for thermal insulation (built into Methods 100–103). What each one
          represents physically, when it applies, when it stacks and when it does not, plus a worked
          stack-up calculation that takes a real circuit through the entire derate machinery.
        </p>
        ...
        >
          <p>
            The IEC heat-balance maths that produces the Appendix 4 tabulated It values assumes the
            cable sits in 30 °C ambient air, on its own (no other current-carrying cables nearby),
            and not enclosed in any thermal insulation. Those are the reference conditions. Any
            deviation reduces the cable’s ability to shed heat and therefore the current it can
            carry without exceeding the conductor’s temperature limit.
          </p>
          <p>Three deviations dominate everyday installs:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Hotter ambient.</strong> The reference is 30 °C; UK lofts in summer hit 40–45
              °C, plant rooms 50–55 °C. Ca compensates.
            </li>
            <li>
              <strong>Multiple cables together.</strong> Each grouped cable contributes I²R heat to
              the local environment, warming its neighbours. Cg compensates.
            </li>
            <li>
              <strong>Cable in thermal insulation.</strong> Mineral wool, foam, expanded polystyrene
              — anything that reduces convective and conductive heat loss. Ci compensates (or is
              built into Methods 100–103).
            </li>
          </ul>
          <p>
            Stacking them multiplicatively reflects the physics: each effect compounds the next. A
            cable in 40 °C ambient, grouped with three others, embedded in insulation, has all three
            derates applied at once — and the combined Iz can be a third or less of the as-tabulated
            It.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The standard mandates the multiplicative stacking. Several apprentices invent additive
              shortcuts (Ca + Cg or just-the-worst-factor); both are non-compliant and either over-
              or under-derate. The correct method is always Iz = It × Ca × Cg × Ci × any other
              applicable factor, as a product.
            </>
          }
        ...
        >
          <p>Indicative values from Table 4B1 for 70 °C thermoplastic cable:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            For 90 °C thermosetting cable in the same ambients, Ca is more generous because the
            cable’s higher operating ceiling provides more thermal headroom. At 45 °C, thermosetting
            Ca ≈ 0.87 (versus 0.79 for thermoplastic). That is one of the routine reasons designers
            pick thermosetting for plant rooms, even if the run is short.
          </p>
          <p>
            Important: the Ca you apply must match the cable’s own operating-temperature rating, not
            the temperature you would like it to operate at. A 70 °C thermoplastic cable used in a
            45 °C plant room must be derated to Ca = 0.79 even if the cable could in principle
            handle higher temperatures — the standard ties Ca to the cable’s rated insulation limit.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            BS 7671 Appendix 4 publishes Cg in five tables, one for each common geometric
            arrangement:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Table 4C1</strong> — multi-core cables, single layer, touching (clipped
              direct, on the floor of a tray, on a wall). The headline domestic / small commercial
              table.
            </li>
            <li>
              <strong>Table 4C2</strong> — multi-core cables, multi-layer (stacked tray work,
              bundled cables). More aggressive Cg because cables in the middle of the bundle cannot
              convect.
            </li>
            <li>
              <strong>Table 4C3</strong> — multi-core cables in trunking. The trunking adds a
              thermal layer on top of the grouping effect.
            </li>
            <li>
              <strong>Table 4C4</strong> — single-core cables in trefoil or flat formation. Used for
              large industrial single-cores carrying balanced three-phase currents.
            </li>
            <li>
              <strong>Table 4C5</strong> — multi-core cables on a perforated tray, single layer with
              spacing. Effectively the Method E geometry; Cg here is closer to 1.0 because the
              spacing allows convection between cables.
            </li>
          </ul>
          <p>Indicative Cg values from Table 4C1 (multi-core, single layer, touching):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            The pattern: each additional cable past the first reduces Cg, but the marginal effect
            tails off. Going from one cable to two takes Cg from 1.0 to 0.80 (a 20 percent
            reduction); going from nine to ten cables takes it from 0.50 to 0.48 (a 4 percent
            reduction). On large groups the per-cable effect is small.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Note 14 of BS 7671 Appendix 4 §5.1 carries the trivial-grouping relaxation: where the
            grouping persists for less than approximately one metre of run, the standard accepts
            that the local heating effect is negligible and Cg need not be applied for that brief
            section.
          </p>
          <p>
            The mechanism: a cable carries heat away by axial conduction along its own length. If
            the touching section is short, the cable’s axial conduction draws heat out of the
            bunched zone before the temperature rises significantly. Past a metre or so, axial
            conduction is no longer enough and the bunched cables warm up to a steady-state
            temperature that demands the full Cg derate.
          </p>
          <p>
            In practice, the relaxation is most often invoked at consumer-unit entry zones and at
            cable-management transitions. The conservative move is to apply Cg anyway — the cost of
            the next CSA bracket is usually small compared to the cost of a future inspection
            writing up the install. The strict-compliance move is to invoke Note 14 and document the
            touching length on the design sheet. Both are valid; pick the inspector-friendly option
            for your area.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            For everyday installs, you almost always pick one of Methods 100–103 if any thermal
            insulation is involved:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Method 102 — embedded in insulation on more than one face but not totally enclosed →
              significant derate built in.
            </li>
            <li>
              Method 103 — totally enclosed, length 0.5 m or longer → maximum derate built in
              (typically 35–50 percent reduction versus Method C).
            </li>
          </ul>
          <p>
            For cables that touch insulation in a way that does not match those four cases (e.g. a
            cable that runs in clear air for most of its length but briefly passes through a small
            zone of insulation that is not Method 100, 101 or 102), the standard lets you derive a
            custom Ci using the principles in Appendix 4 Section 5. In practice this is rare; the
            four standard methods cover virtually everything in domestic and small commercial work.
          </p>
          <p>
            The Ci = 0.5 figure that appears in older training materials and OSG editions
            specifically refers to the maximum derate for the Method 103 totally-enclosed case. It
            is the right number if you are computing CCC from Method C tabulated values and
            adjusting for total enclosure — but in modern BS 7671 you simply read Method 103
            directly and the correction is already there. Either route gives the same answer; mixing
        ...
        <RegsCallout
          source="BS 7671:2018+A4:2026 — Section 523 (Current-carrying capacity) and Appendix 4 §5 (Application of group reduction factors), with Cg tables 4C1–4C5"
          clause="The current-carrying capacity of cables installed in groups shall be reduced from the value applicable to a single circuit by an appropriate group reduction factor (Cg) given in the relevant tables of Appendix 4. The factor depends on the number of circuits, the geometric arrangement of the group and the method of installation. Section 523 of BS 7671 sets the duty; Appendix 4 §5 and Tables 4C1–4C5 provide the values and the application method."
          meaning={
            <>
              Section 523 + Appendix 4 make Cg mandatory wherever cables are grouped. The table you
              read (4C1–4C5) depends on the geometric arrangement — single-layer touching,
              multi-layer, in trunking, single-core trefoil, on perforated tray with spacing. You
              must verify the geometry on site matches the table you read; an apprentice who reads
              Table 4C5 (spaced on tray) for cables that are actually touching is under-derating and
              the install fails.
            </>
          }
          cite="Source: BS 7671:2018+A4:2026 Part 5, Section 523; Appendix 4 §5 and Cg tables 4C1–4C5."
        />
        ...
        >
          <p>
            The Ca / Cg / Ci numbers do not come from the standard — they come from the site. The
            standard publishes the lookup tables; the survey supplies the inputs to those lookups.
            Without an honest survey:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Ca is a guess. You may assume 30 °C ambient because the building feels cool when you
              visit in March; the same loft hits 42 °C in July and your design under-derates.
            </li>
            <li>
              Cg is a guess. You may not know the existing CU has six circuits sharing one entry
              zone until you arrive on installation day, by which point your spec’d 4 mm² should
              have been 6 mm².
            </li>
            <li>
              Ci is a guess. You may not realise the loft has been recently insulated to 300 mm
              depth until the Method 103 calc kicks in on site and your CSA selection needs to grow.
            </li>
          </ul>
          <p>
            Good survey practice for cable selection: take the ambient temperature in the worst part
            of the route on a hot day (or model it by adding 10–12 °C to a winter survey reading).
            Count the existing circuits at every shared entry zone. Photograph and measure every
            section where the cable would touch or pass through insulation. The whole survey takes
            15 minutes and removes 90 percent of the design risk.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>The brief:</strong> a 40 A radial feeding a kitchen extractor unit in a
            converted loft. Single-phase 230 V, TN-C-S supply. Cable is 70 °C thermoplastic two-core
            T&E. Route is 18 m long: out of the consumer unit grouped touching with three other
            final-circuit cables for 0.7 m at the entry zone, then in clear air across the rest of
            the loft floor (joists, no insulation immediate contact), with summer ambient up to 40
            °C in the loft.
          </p>
          <p>
            <strong>Step 1 — design current Ib:</strong> 40 A (worst-case nameplate of the extractor
            and its associated controls, no diversity for a single dedicated load).
          </p>
          <p>
            <strong>Step 2 — protective device In:</strong> 40 A BS EN 60898 Type C MCB (the
            extractor has a small inrush from the motor, so Type C rather than Type B). In = 40 A
            satisfies In ≥ Ib.
          </p>
          <p>
            <strong>Step 3 — Reference Method:</strong> Method C (clipped direct, multi-core,
            non-metallic surface, still air) for the 17.3 m running across the joists. The first 0.7
            m of grouping is the worst section for Cg, but it is still mechanically Method C — the
            cables are bunched together but they are clipped to the same joist with air around them.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ca</strong> at 40 °C ambient (Table 4B1, 70 °C cable) = <strong>0.87</strong>.
            </li>
            <li>
              <strong>Cg</strong> for four cables touching, single layer (Table 4C1) ={' '}
              <strong>0.65</strong>. The 0.7 m touching distance is borderline for Note 14; we apply
              Cg conservatively.
            </li>
            <li>
              <strong>Ci</strong> = <strong>1.0</strong>. Cable is not in thermal insulation
          ...
          <p>
            <strong>Step 5 — required tabulated It:</strong> It ≥ Ib / (Ca × Cg × Ci) = 40 / 0.5655
            = <strong>70.73 A</strong>.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              16 mm² → It ≈ 85 A — <strong>passes.</strong>
            </li>
          </ul>
          <p>
            <strong>Step 7 — verify Iz:</strong> Iz = 85 × 0.5655 = <strong>48.07 A</strong>. Test
            inequality: Ib (40 A) ≤ In (40 A) ≤ Iz (48.07 A) → <strong>passes.</strong>
          </p>
          <p>
            The combined derate of 0.5655 means the cable is operating at only 56.55 percent of its
            as-tabulated capacity in this install. Without the derates, a 6 mm² cable would have
            done the job (Method C It ≈ 47 A). With the derates, we needed to step all the way up to
            16 mm². That is what the derate machinery looks like in real numbers.
          </p>
          <p>
            <strong>Engineering choice:</strong> if we could relax the grouping (re-route so the
            four cables are not touching for that 0.7 m at the CU — perhaps stagger them through
            separate cable entries), Cg becomes 1.0 and the combined derate jumps to 0.87. Required
            It becomes 40 / 0.87 = 45.98 A. 6 mm² (It = 47 A) just clears. That single mechanical
            change saves two CSA brackets and a meaningful copper cost.
          </p>
        </ConceptBlock>

        <RegsCallout
          source="BS 7671:2018+A4:2026 — Section 523 (Current-carrying capacity) and Appendix 4 Reference Methods 100–103 (cables in or against thermal insulation)"
          ...
          meaning={
            <>
              The in-insulation derate is captured by the Reference Method itself. The standard’s
              preference is that you pick one of the four insulation methods (100–103) and use the
              tabulated value as-is, without applying a separate Ci. For unusual cases (cable in
              clear air for most of its length, briefly touching insulation in a way that does not
              match the standard methods), the standard lets you derive a custom Ci using the
              heat-balance principles in Appendix 4 §5. In practice, most everyday installs fall
              cleanly into Methods 100–103 and the standard’s preferred route applies.
            </>
          }
          cite="Source: BS 7671:2018+A4:2026 Part 5, Section 523; Appendix 4 Reference Methods 100–103 and §5."
        />
        ...
        >
          <p>Other correction factors that the L3 designer should at least recognise:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Triplen-harmonic rating factor (BS 7671 Appendix 4 Section 5.5).</strong>{' '}
              Three-phase circuits with significant third-harmonic content (LED drivers,
              switched-mode power supplies, UPS, large variable-speed drives) push extra current
              through the neutral conductor. The neutral can end up carrying as much as the line
              conductors, and Ch derates the multi-core cable’s overall CCC accordingly. For typical
              domestic loads Ch = 1.0 (third-harmonic content is small); for commercial loads with
              more than 15 percent third-harmonic content, Ch can drop below 0.85.
            </li>
            <li>
              <strong>Soil thermal resistivity correction (Table 4B3).</strong> Buried cables under
              Method D assume soil thermal resistivity of 2.5 K·m/W. Damp clay (around 1.0 K·m/W)
              gives a correction above 1.0; dry sand (around 3.0 K·m/W) gives a correction below
              1.0. Significant on long buried sub-mains.
            </li>
            <li>
              <strong>Depth-of-burial correction.</strong> Reference depth for direct-buried cables
              is 0.7 m. Cables buried deeper run cooler (more soil mass acts as a heat sink) and
              earn a small uplift; cables buried shallower run hotter and need a derate. The
              standard publishes the values in Appendix 4.
            </li>
            <li>
              <strong>Parallel-conductor splits.</strong> When the design current exceeds the
              largest available CSA in your cable family, you parallel two or more conductors per
              phase. Each parallel conductor must satisfy CCC for its share of the current, and
              grouping factors apply between the parallel conductors themselves. Specialist
              territory — normally only on industrial sub-mains and supply-side cables.
            </li>
          </ul>
          <p>
            You will not be expected to apply Ch or the soil correction in everyday Level 3 design
            exercises, but you must know they exist and recognise the install conditions that
            trigger them. On site, the prompt to dig deeper into Appendix 4 Section 5.5 or Table 4B3
            is usually a brief on a commercial fit-out with mixed loads, or a sub-main spec sheet
            that calls out the local soil type.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The apprentice has Ca = 0.94, Cg = 0.80, Ci = 0.85. They write the combined derate as
              0.94 + 0.80 + 0.85 − 2 = 0.59 (or some variant of additive maths) and end up either
              over-derating (combining is too aggressive) or under-derating (combining is too
              generous). The correct multiplicative answer is 0.94 × 0.80 × 0.85 = 0.6392. The cable
              comes out the wrong size and the inequality test gives the wrong answer.
            </>
          }
          doInstead={
            <>
              Always multiply, never add. Combined derate = Ca × Cg × Ci × any other applicable
              factor. Each factor is a fractional reduction; multiplying compounds them in the way
              the underlying physics actually compounds. BS 7671 Appendix 4 §5 states this
              explicitly. Check yourself by punching the multiplication into a calculator before
              writing the answer on the design sheet — it is the single cheapest sanity check in
              cable sizing.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You have just spec’d 16 mm² T&E for a circuit that the previous installer ran in 6
              mm². The customer is annoyed at the cost and the install difficulty. The difference is
              real: you have applied Ca = 0.87 (40 °C loft), Cg = 0.65 (four grouped at the CU), and
              the previous installer either ignored both or applied neither. The previous install is
              non-compliant and has been quietly ageing since it was put in.
            </>
          }
          whatToDo={
            <>
              Walk the customer through the calc on paper. Show the survey ambient (40 °C), the
              grouping count (four cables), the Ca and Cg from the tables, the multiplied combined
              derate, the required tabulated It, and the CSA selection. Make the case that the
              previous install would fail a periodic inspection on Reg 433.1.1 and that you are
              correcting a long-standing shortcut. Document the conversation. If the customer
              demands you size to match the previous install, decline politely and walk away rather
              than certify a non-compliant new install.
            </>
          }
          whyItMatters={
            <>
              Cable selection is one of the easiest design areas to short-cut and one of the hardest
              shortcuts to undo once the cable is in the wall. The derate stack is the difference
              between an install that passes a periodic inspection in twenty years and one that
              fails on day one of testing. Hold the line.
            </>
          }
        />
