      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-2 pb-24">
        <PageFrame>
          ...
          <RegsCallout
            ...
            meaning={
              <>
                Section 523 + Appendix 4 make Cg mandatory wherever cables are grouped. The
                table you read (4C1–4C5) depends on the geometric arrangement —
                single-layer touching, multi-layer, in trunking, single-core trefoil, on
                perforated tray with spacing. You must verify the geometry on site matches the
                table you read; an apprentice who reads Table 4C5 (spaced on tray) for cables
                that are actually touching is under-derating and the install fails.
              </>
            }
          ...
          <RegsCallout
            ...
            meaning={
              <>
                The in-insulation derate is captured by the Reference Method itself. The
                standard’s preference is that you pick one of the four insulation methods
                (100–103) and use the tabulated value as-is, without applying a separate Ci.
                For unusual cases (cable in clear air for most of its length, briefly touching
                insulation in a way that does not match the standard methods), the standard
                lets you derive a custom Ci using the heat-balance principles in Appendix 4
                §5. In practice, most everyday installs fall cleanly into Methods 100–103
                and the standard’s preferred route applies.
              </>
            }
