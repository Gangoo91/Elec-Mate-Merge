    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The capstone for Section 4. Take a real-world 100 A TN-C-S domestic upgrade with 7 kW EV
          charger, 4 kWp PV with battery and 8 kW heat pump end to end through CCC, Vd, EFLI and
          adiabatic gates, and synthesise the result into a single integrated cable schedule and
          design pack.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>CCC (Sub 4.2)</strong> — current-carrying capacity. Does the cable carry Ib in
              steady state without exceeding the conductor temperature limit? Reference Method,
              derate stack (Ca, Cg, Ci), required tabulated It ≥ Ib / total-derate. Result: minimum
              CSA for thermal-steady-state.
            </li>
            <li>
              <strong>Vd (Sub 4.4)</strong> — voltage drop. Does the load see enough voltage at its
              terminals? mV/A/m × Ib × L / 1000 ≤ 3 percent (lighting) or 5 percent (other). Result:
              possibly forces a CSA bigger than CCC alone needed.
            </li>
            <li>
              <strong>EFLI (Sub 5.1, run alongside cable selection)</strong> — earth fault loop
              impedance. Does Zs at the end of the circuit clear ADS in time? Zs(design) = Ze + (R1
              + R2 at operating temperature) ≤ Table 41.3 max for the device. Result: may force a
              larger CPC or larger overall cable to bring R1 + R2 down.
            </li>
            <li>
          ...
          <p>
            ...
            Document each gate’s pass/fail figure on the design sheet so the result is traceable and
            the next designer can see why each cable was chosen.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              1 × 32 A EV charger on a dedicated 6 mm² T&E radial, 25 m route to driveway, with Type
              B RCD + OPDP open-PEN protection per Section 722.
            </li>
            <li>
        ...
        >
          ...
          <p>
            Total connected: roughly 196 A worst-case-simultaneous, before considering that some of
            these are imports and some are exports.
          </p>
          <p>Apply diversity per OSG Table A2 / IET Guidance Note 1:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Sockets and lighting: 100 percent of largest + 40 percent of remainder ≈ 32 + 0.4 × 44
              = 49.6 A.
            </li>
            <li>
              Oven: 10 A + 30 percent of remainder + 5 A for socket on cooker switch = 10 + 0.3 × 22
              + 5 = 21.6 A.
            </li>
            <li>
          ...
          <p>
            Worst-case simultaneous winter evening (no PV, all heating loads on, EV charging, shower
            in use): roughly 50 + 50 + 32 + 16 + ~10 sundry = 158 A naively, before load management.
            With the EV charger and heat pump on smart load management (which throttles the EV
            charger to keep total imports under 90 A), the demand stays inside the 100 A supply
            rating with margin for surge.
          </p>
          <p>
        ...
        >
          <p>
            For a 100 A single-phase TN-C-S supply with a meter cupboard on the outside wall and the
            consumer unit inside the kitchen 4 m away, 25 mm² 6181Y or equivalent tails are the
            standard spec. CCC for 25 mm² single-core is comfortably above 100 A by Method C; Vd at
            100 A over 4 m on 25 mm² ≈ (1.75 × 100 × 4) / 1000 = 0.7 V — negligible. Some DNOs
            require 35 mm² for any 100 A supply regardless of length — check the connection
            agreement.
          </p>
          <p>
        ...
        >
          ...
          <p>
            ...
            A; 273 A magnetic, t ≈ 0.03 s. S(min) = √(273² × 0.03) / 115 = √2236 / 115 = 47.3 / 115
            = 0.41 mm². Installed CPC 1.5 mm² — pass.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>EFLI:</strong> Ze 0.35 Ω + R1+R2 for 10 mm²/4 mm² CPC at 70 °C ≈ cold 6.44 mΩ/m
            × 1.20 = 7.73 mΩ/m × 8 m = 0.062 Ω. Zs(design) = 0.35 + 0.062 = 0.412 Ω. Max Zs for B50
            (Table 41.3 A4:2026) = 0.87 Ω. Pass.
          </p>
          <p>
        ...
        >
          ...
          <p>
            <strong>EFLI:</strong> Ze 0.35 Ω + R1+R2 for 6 mm²/2.5 mm² CPC at 70 °C: cold 10.49 mΩ/m
            × 1.20 = 12.6 mΩ/m × 25 m = 0.315 Ω. Zs(design) = 0.35 + 0.315 = 0.665 Ω. Max Zs for B32
            (A4:2026) = 1.37 Ω. Pass with comfortable margin.
          </p>
          <p>
          ...
          <p>
            ...
            monitoring, e.g. integrated into the EV unit). OPDP open-PEN protection at the consumer
            end of the supply (Garo, Matt:e or Hager device — typically combined with the Type B RCD
            in one enclosure). IP54 outdoor enclosure for the EV charger itself (most domestic EV
            products are IP54 or IP65 by design). Dedicated 6 mm² T&E radial from a labelled "EV
            CHARGER" way on the consumer unit, not shared with anything else.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>Vd:</strong> short run from inverter (typically loft) to consumer unit, 5 m, 17
            A on 2.5 mm² (mV/A/m ≈ 18): Vd = (18 × 17 × 5) / 1000 = 1.53 V = 0.67 percent.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              A4:2026 deleted the old "reasonably practicable" exception that used to let designers
              off the open-PEN protection duty. On a TN-C-S (PME) domestic supply feeding an outdoor
              EV charging point, you must do one of: drive an earth electrode that limits the
              open-PEN voltage rise to 70 V (route b); fit an open-PEN detection device that
              disconnects within 5 s (route c, the OPDP / Matt:e / Garo / Hager type); or use a
              voltage-window detection device on the line-to-neutral voltage (route d). Skipping
              this and trusting the PME earth alone is a straight non-compliance.
            </>
          }
        ...
        >
          <p>
            The integrated cable schedule for this property (worked above) covers ten circuits. Each
            row records: circuit reference, description, design current Ib, route length L,
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Operating notes for the homeowner — how to reset, how to isolate, what each indicator
              means, who to call when.
            </li>
            <li>
          ...
          <p>
            The customer keeps a copy. The designer keeps the master on file for the design life of
            the installation (typically 25 years for cable, 15–20 years for protective devices and
            equipment).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              "shall". Where AFDDs become mandatory in domestic work is via the Building Safety Act
              2022 framework for higher-risk residential buildings (HRRBs), which adopt the
              recommendation as a hard duty. On the worked example here (a single-family dwelling),
              AFDDs on the EV, heat pump and battery circuits is the design call — the
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              132.16 duty when an addition or alteration is proposed. On a single-circuit job it can
              be three sheets; on a multi-load home like this worked example it can be twenty pages
              plus the EIC. The completeness floor scales with the complexity of the installation.
              The next person who works on the system — possibly fifteen years later — needs to be
              able to read this pack, understand what was designed and why, and ascertain that the
              rating and condition of equipment is adequate for the altered circumstances.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The apprentice runs the EV charger off a spare way on the existing CU, fits a Type AC
              RCD shared with the kitchen sockets, picks 4 mm² T&E because "it’s a 32 A radial like
              any other", and skips the OPDP open-PEN protection. The install passes a casual visual
              check at handover. Six months later the supply PEN breaks in a roadworks incident; the
              EV chassis goes to line voltage and someone touching the car gets shocked.
            </>
          }
          doInstead={
            <>
              Run the EV charger as its own dedicated circuit per Section 722. Fit a Type B RCD (or
              Type A with DC monitoring built into the EV unit). Fit OPDP open-PEN protection on
              TN-C-S supplies. Use the manufacturer-recommended cable size for the run length (6 mm²
              for 32 A over 20–30 m is the standard call). Never share the EV with any other
              circuit, never put it behind a Type AC RCD, and never skip the OPDP. The Section 722
              requirements exist because the EV is a uniquely hazardous load and the regulation has
              caught up.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              The customer cannot afford the EV charger, PV, battery and heat pump all at once. They
              want to budget the works over 18 months: CU upgrade and supply uplift now, EV charger
              in 3 months, PV in 6 months, battery in 9 months, heat pump in 12 months. The
              first-fix electrician is asking how to handle this without doing expensive rework at
              each stage.
            </>
          }
          whatToDo={
            <>
              ...
              position. Cap and label each cable end at the second-fix accessory positions. Document
              the supply maximum demand assuming all future loads with smart load management. At
              each subsequent commissioning visit, the install reduces to: connect the device,
              configure the load management, test, certify, hand over. Each second-fix visit is half
              a day rather than a 3-day rip-out.
            </>
          }
          whyItMatters={
            <>
              Phased installs are the normal pattern for domestic energy upgrades. The L3 designer’s
              job is to design the end state once and execute in stages. Skipping this and treating
              each stage as a fresh design produces unnecessary rework (re-routing cables,
              re-boarding consumer units, re-doing maximum demand calcs) and frustrates the
              customer. The design pack carries the staging plan so any contractor coming in
