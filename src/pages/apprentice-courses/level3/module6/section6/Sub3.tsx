...
const TITLE = 'RFI workflow + chain of accountability (5.5) | Level 3 Module 6.6.3 | Elec-Mate';
const DESCRIPTION =
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              C&G 2365-03, NICEIC scheme membership, MIET).
            </li>
            <li>
        ...
        >
          ...
          <p>
            Sub 5 covers the golden thread in detail. The RFI workflow in this Sub is the day-to-day
