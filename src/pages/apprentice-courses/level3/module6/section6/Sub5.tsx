...
const checks = [
  ...
  },
  {
    ...
    question: 'Why must the design pack be updated to as-installed values BEFORE the EIC issues?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'What is included in a complete design pack handover at the end of a commercial fit-out?',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'Which BS 7671 regulation makes the EIC conditional on as-installed documentation matching the install?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      "Under the Building Safety Act 2022, what is the 'golden thread' of building information?",
    options: [
  ...
  },
  {
    id: 5,
    question:
      'What is the CDM 2015 Health and Safety File and how does the L3 designer contribute?',
    options: [
...
const faqs = [
  {
    question:
      'Who is responsible for producing the as-installed pack — the designer or the installer?',
    answer:
  ...
  {
    question:
      'What is the difference between the operations and maintenance manual (O&M) and the Health and Safety File?',
    answer:
  ...
  {
    question:
      "What is a 'safety case' under the Building Safety Act 2022 and how does the L3 designer contribute?",
    answer:
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 6 · Subsection 5"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Closeout of Section 6. The handover deliverables, the as-installed update process, the
          operations and maintenance manual, the CDM 2015 Health and Safety File, and the Building
          Safety Act 2022 golden thread on higher-risk residential buildings.
        </p>
        ...
        >
          <p>
            ...
            operation. The L3 designer's deliverables transfer from the project team to the building
            owner (or the building owner's facilities management team). The complete handover pack
            typically contains:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>As-installed design pack</strong> — SLD, layouts, schedules (Accessories,
              Cables, Luminaires, Circuit Charts), calc sheets, design risk register, all at the
              as-installed revision.
            </li>
            <li>
              <strong>Electrical Installation Certificate (EIC)</strong> — signed by designer,
              constructor, inspector / tester, with the schedule of inspections and the schedule of
              test results.
            </li>
            <li>
              <strong>Operations and Maintenance manual (O&M)</strong> — operational handbook for
              the building owner.
            </li>
            <li>
              <strong>CDM 2015 Health and Safety File</strong> — residual-risk record, often
              coordinated by the Principal Designer.
            </li>
            <li>
              <strong>RFI register and change order log</strong> — the audit trail of design changes
              during construction.
            </li>
            <li>
              <strong>Manufacturer documentation</strong> — datasheets, test certificates, warranty
              documents for installed equipment.
            </li>
            <li>
              <strong>Commissioning records</strong> — RCD test results, emergency lighting tests,
              fire alarm cause-and-effect tests, BMS commissioning records.
            </li>
            <li>
              <strong>Golden thread information (HRRBs only)</strong> — structured digital
              information set under BSA 2022, handed to the Accountable Person.
            </li>
          </ul>
          <p>
            Handover is a contractual milestone — typically a payment milestone too, so commercial
            pressure aligns with the discipline. The L3 designer signs off the design pack as
            complete, the constructor signs off the install, the inspector signs off the
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 132.16 is what gives the handover pack its 25-year sufficiency duty. Every future
              addition or alteration has to be ascertained against the rating and condition of the
              existing equipment — and that ascertainment is only possible if the original handover
              pack carries the cable schedules, single-line diagrams, test results and
              protective-device data. The L3 designer at handover is producing documentation that
              needs to make sense to a stranger in 2051; format choice, indexing, naming conventions
              and version control all matter at that horizon.
            </>
          }
        ...
        >
          <p>The as-installed update is a structured process, not a tidy-up. Standard sequence:</p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Red-line working copy</strong> — the install team maintains a marked-up
              working copy of the design pack throughout the install, recording every deviation in
              red ink (or red layer in a digital working copy). Cable route changes, length changes,
              accessory substitutions, luminaire substitutions, circuit additions, all captured.
            </li>
            <li>
              <strong>Designer review</strong> — at handover (or at agreed milestones during a long
              install) the designer reviews the red-lined working copy. Each red-line is assessed
              for impact: does it require a calc re-run? Does it cross a regs ceiling? Does it
              affect another circuit through grouping derating?
            </li>
            <li>
              <strong>Calc re-run</strong> — for length changes, cable substitutions or grouping
              changes, the designer re-runs the affected voltage drop, Zs and discrimination calcs.
              If anything breaches Reg 525.202 (Vd) or Table 41.3 (Zs) the install must be
              corrected; if everything passes the documentation is updated.
            </li>
            <li>
              <strong>Document update</strong> — the cable schedule, the SLD cable annotations, the
              affected layouts and the affected Circuit Chart entries are all updated to
              as-installed values. Revision letters go up.
            </li>
            <li>
              <strong>Revision history log</strong> — every changed document records the change in
              its revision history table — date, drafter, what changed and why (e.g. 'Sub-main
              length updated to 51 m from 42 m due to RFI 027 route change. Vd re-checked at 4.6
              percent within Reg 525.202 ceiling. Zs re-checked within Table 41.3 maximum.').
            </li>
            <li>
              ...
              marked VOID and archived (digitally on the CDE; physically destroyed for hard copies).
            </li>
            <li>
              <strong>EIC issue</strong> — only after the documentation matches the install can the
              EIC issue under Reg 644.1.1. Schedule of inspections and schedule of test results are
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 644.1.1 is the regulatory hook for the handover gate. The inspector compares the
              install against the design pack; any disagreement is a defect or omission that must be
              corrected before the EIC issues. The fix is either to bring the install back to the
              design or to update the documentation to as-installed and re-issue. The EIC cannot
              sign off until the documentation and the install are aligned. RFIs done well during
              construction (Sub 3) and the as-installed update done properly at handover make Reg
              644.1.1 trivial.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The L3 designer assumes the install matched the design closely enough that no update
              is needed. The EIC is signed against the original design pack. Five years later a
              periodic inspection finds three circuits with slightly elevated Zs values; the
              inspector compares to the design pack and finds the cable lengths shown are not the
              cable lengths installed. The original install was actually non-compliant on one
              circuit but the design-pack values disguised it. The building owner pursues a claim
              against the original designer.
            </>
          }
          doInstead={
            <>
              Treat as-installed as a non-negotiable handover step. Even on small jobs, walk the
              install with the constructor, mark up the working copy, re-run any affected calc,
              update the documentation and re-issue. The cost is one to four hours on a small
              commercial job; the protection is decades of clean defence against future claims. PI
              insurers explicitly underwrite practice that includes as-installed discipline.
            </>
          }
        />
        ...
        >
          <p>
            The O&M manual is the day-to-day handbook for the building owner's facilities management
            team. The L3 designer's contribution typically includes:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>System overview</strong> — narrative description of the electrical
              installation, supply arrangement, distribution topology, key features.
            </li>
            <li>
              <strong>SLD and layout drawings</strong> — as-installed copies, indexed and
              cross-referenced.
            </li>
            <li>
              <strong>Schedules</strong> — Accessories, Cables, Luminaires, Circuit Charts at
              as-installed revisions.
            </li>
            <li>
              <strong>Operating instructions</strong> — how to use the main switch, how to test
              RCDs, how to test emergency lighting (monthly function test, annual three-hour
              duration test under BS 5266), how to test the fire alarm (weekly call point test under
              BS 5839).
            </li>
            <li>
              <strong>Maintenance schedule</strong> — recommended frequency for periodic inspection,
              RCD testing, emergency lighting testing, thermography of switchgear, lamp replacement
              programme.
            </li>
            <li>
              <strong>Isolation procedures</strong> — Lock-Out Tag-Out (LOTO) instructions, how to
              isolate each major circuit, how to identify and prove dead before working.
            </li>
            <li>
              <strong>Spare parts schedule</strong> — recommended spares for critical equipment
              (replacement RCBOs of matching rating and curve, emergency lighting batteries, fire
              alarm sounders).
            </li>
            <li>
              <strong>Manufacturer documentation</strong> — datasheets, warranty cards, manufacturer
              service manuals.
            </li>
            <li>
              <strong>Designer and contractor contact details</strong> — for future questions or
              claims.
            </li>
          </ul>
          <p>
            The O&M is a living document — the building owner updates it as they make changes over
            the building's life. The L3 designer's version at handover is the baseline.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            CDM 2015 (Construction (Design and Management) Regulations 2015) makes the Principal
            Designer responsible for compiling the Health and Safety File. The L3 designer
            contributes electrical-discipline content:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Residual hazards</strong> — anything in the install that future workers or
              maintainers need to know about (live-bus arrangements, restricted access work areas,
              special-location zones, hazardous-area classifications).
            </li>
            <li>
              <strong>Design choices that control hazards</strong> — earthing arrangement (TN-S,
              TN-C-S PME, PNB, TT), AFDD provision (Reg 421.1.7), RCD types and groupings (Reg
              411.3.3), supplementary bonding scope, fire-stopping locations.
            </li>
            <li>
              <strong>Information for future modifications</strong> — what was assumed about future
              loads, what spare DB ways were left and for what, what supply capacity remains for
              future expansion, what coordination decisions were made with other disciplines that
              must be respected by future modifications.
            </li>
            <li>
              <strong>Information for safe maintenance</strong> — isolation arrangements, LOTO
              procedures, special PPE requirements (e.g. arc-flash PPE for switchgear access),
              restricted-access conditions.
            </li>
            <li>
              <strong>Information for safe demolition</strong> — at end-of-life, how to safely
              de-energise and disconnect the installation; particular hazards in the cabling
              (asbestos in legacy installations, PCBs in legacy capacitors, lead in old solder).
            </li>
          </ul>
          <p>
            Some firms combine the O&M and the Health and Safety File into one document; others keep
            them separate. Either approach is fine if the content is complete and indexed. Both are
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>The Building Safety Regulator (BSR)</strong> — within the Health and Safety
              Executive (HSE). Statutory regulator for HRRBs.
            </li>
            <li>
              <strong>HRRB definition</strong> — broadly residential buildings 18 m or seven storeys
              and above with at least two residential units. Care homes and hospitals are also
              brought into scope. Commercial buildings are not directly captured though related
              changes affect commercial work.
            </li>
            <li>
              <strong>Three gateways</strong> — Gateway 1 (planning), Gateway 2 (pre-construction
              approval by BSR), Gateway 3 (occupation approval by BSR after construction). Each
              gateway is a hard stop.
            </li>
            <li>
              <strong>Dutyholders</strong> — Client, Principal Designer, Principal Contractor (CDM
              2015 roles, recognised under BSA 2022 with extra duties), plus Accountable Person and
              Principal Accountable Person for the occupation phase.
            </li>
            <li>
              <strong>Golden thread</strong> — structured digital information about the building,
              accurate and current, accessible to dutyholders and BSR, maintained throughout the
              building's life.
            </li>
            <li>
              <strong>Safety case</strong> — for occupied HRRBs, formal documented case
              demonstrating that all reasonable steps have been taken to manage building safety
              risks. Submitted to BSR for the Building Assessment Certificate.
            </li>
            <li>
              <strong>Mandatory occurrence reporting</strong> — duty to report safety occurrences to
              BSR.
            </li>
            <li>
              <strong>Competence requirements</strong> — designers and contractors on HRRBs must
              demonstrate competence to a higher standard than general construction.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Digital</strong> — paper-only is not sufficient. Must be in digital format
              that supports search, structured access and lifetime persistence.
            </li>
            <li>
              <strong>Accurate</strong> — reflects the actual current state of the building.
              As-installed updates and ongoing change updates required.
            </li>
            <li>
              <strong>Accessible</strong> — available to the dutyholders, the BSR and (within
              reason) the residents. Format must be openable without specialist tooling.
            </li>
            <li>
              <strong>Current</strong> — updated whenever the building changes. Stale information is
              a breach of the golden thread duty.
            </li>
            <li>
              <strong>Structured</strong> — organised so information can be found by topic, system,
              location or component. BIM-based delivery is well-suited; structured PDFs with indexes
              are also acceptable.
            </li>
            <li>
              <strong>Comprehensive</strong> — covers the building's design, construction,
              alterations, maintenance and safety case. Includes risk assessments, residents'
              engagement records, complaints handling records.
            </li>
          </ul>
          <p>
            The L3 designer's contribution is the as-installed electrical pack at handover, in a
            format that supports the golden thread duty. That typically means structured PDF plus
            IFC / Revit native files (if the project ran on BIM), with a clear index and metadata
            that lets the dutyholders find any item quickly.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Section 132 is the umbrella under which the L3 designer's whole duty sits — and it
              does not end at handover. The Section 132 design duty includes Reg 132.13
              (documentation), which sets the lifetime sufficiency floor. On HRRBs the BSA 2022
              golden thread duty layers on top of Reg 132.13: the documentation must be not only
              sufficient (Reg 132.13) but also digital, accurate, accessible, current and structured
              (BSA 2022). The two duties run in parallel; satisfying both is the standard for HRRB
              design work.
            </>
          }
        ...
        >
          <p>
            BSA 2022 names the Accountable Person (AP) and Principal Accountable Person (PAP) as the
            dutyholders for occupied HRRBs. Their duties include:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Maintain the safety case</strong> — keep the documented case for the
              building's safety current.
            </li>
            <li>
              <strong>Maintain the golden thread</strong> — keep the building information accurate
              and accessible.
            </li>
            <li>
              <strong>Manage building safety risks</strong> — assess, control and review the
              structural and fire safety risks throughout occupation.
            </li>
            <li>
              <strong>Engage residents</strong> — implement the residents' engagement strategy,
              handle complaints, communicate about safety.
            </li>
            <li>
              <strong>Report mandatory occurrences</strong> — notify the BSR of specified safety
              incidents.
            </li>
            <li>
              <strong>Cooperate with BSR audits</strong> — provide information for the Building
              Assessment Certificate process.
            </li>
          </ul>
          <p>
            The L3 designer hands the as-installed electrical pack to the AP / PAP at handover
            (typically through the building owner). From that point the AP / PAP is responsible for
            keeping the electrical content current as the building changes — but they may come back
            to the original designer with questions. Maintain professional contact details in the
            pack and respond to such queries within reasonable time as part of the designer's
            residual duty.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              new-build 12-storey residential block with 96 flats, plus ground-floor concierge and
              plant rooms. Construction is complete; handover is in 4 weeks. The Principal
              Accountable Person (PAP) is the building owner's facilities management arm. The BSR
              will audit the safety case for the Building Assessment Certificate within 12 months of
              occupation. Your firm has produced the design through a BIM workflow in Revit on
              Autodesk Construction Cloud; the install team red-lined deviations throughout
              construction.
            </>
          }
          whatToDo={
            <>
              ...
              as-installed update across the whole pack — review every red-line, re-run affected
              calcs, update the SLD, schedules, layouts and Circuit Charts to as-installed
              revisions. (2) Compile the O&M manual contributions — operating instructions for each
              system, maintenance schedule, isolation procedures, spare parts list. (3) Compile the
              CDM Health and Safety File contributions — residual hazards, design choices that
              control them, information for future modifications, information for safe maintenance,
              end-of-life information. (4) Prepare the golden thread package — structured PDF set
              with full index, native Revit files, IFC export, machine- readable schedule data (CSV
              or JSON for the schedules). Format must support lifetime accessibility. (5) Prepare
              the safety-case contribution — electrical risk evidence (earthing, AFDD provision,
              fire-stopping at electrical penetrations, emergency lighting design, fire detection
              wiring, residual risks). (6) Run an internal QC review — second engineer signs off the
              pack as complete and consistent. (7) Hand over to the PAP through a formal handover
              meeting. PAP signs receipt; designer retains master copies. (8) Brief the PAP's
              facilities team on how to use the pack — where to find what, how to update, how to
              contact the original designer for questions. (9) After handover, retain master copies
              indefinitely (or for at least the building's lifetime under PI policy) and respond to
              PAP queries within reasonable time.
            </>
          }
          whyItMatters={
            <>
              HRRB handover is the highest-stakes design pack closeout in UK practice. The BSA 2022
              makes the golden thread a legal duty; the BSR can audit the safety case throughout the
              building's life. The L3 designer's pack quality at handover is the evidence base for
              that audit and for any future investigation if something goes wrong. A clean,
              structured, complete pack protects the designer, supports the PAP through occupation,
              gives future contractors what they need to alter safely, and stands up to BSR
              scrutiny. A scrappy pack at HRRB handover is the start of a multi-year compliance
              problem that only gets worse with time. The 4-week investment at handover protects
              everyone in the chain for decades.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The L3 designer treats handover as the end of their involvement. They hand the full
              pack to the building owner and delete their working copies to free up server space.
              Eight years later a PI claim arrives — the customer's solicitor alleges a Vd calc
              error caused equipment damage. The original calc files are gone. The designer has no
              contemporaneous evidence of what they actually calculated. The PI insurer settles in
              the claimant's favour because there is no defence material.
            </>
          }
          doInstead={
            <>
              ...
              (simple contract) or 12 years (deed). Modern digital storage makes this trivial. Most
              firms store on a long-term archive system with structured naming and redundancy. Hand
              over copies to the building owner; keep your masters. PI policies often condition
              cover on retention of relevant project records — losing the records can void cover.
            </>
          }
        />
        ...
        >
          <p>Retention and ongoing duty:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Retention period</strong> — design life of the installation (typically 25
              years for fixed wiring) plus the legal limitation period (6 years for breach of
              contract, 12 years if executed as a deed). Total typically 25 to 37 years. PI insurers
              may require shorter or longer; check policy.
            </li>
            <li>
              <strong>Storage format</strong> — digital archive with structured naming, version
              control and redundancy. Cloud archive (Glacier, Azure Archive, S3 Deep Archive) is
              cost-effective for long-term storage. PDF + native files + IFC ensure tool
              independence.
            </li>
            <li>
              <strong>Future query response</strong> — respond to PAP, building owner or future
              contractor queries within reasonable time. This is part of the professional duty even
              after the contract has closed.
            </li>
            <li>
              <strong>BSR safety-case contribution</strong> — on HRRBs the original designer may be
              approached for evidence during BSR audits. Maintain reasonable cooperation as part of
              professional standards.
            </li>
            <li>
              <strong>PI cover</strong> — maintain professional indemnity insurance with run-off
              cover after retirement. Most PI policies have retroactive cover that depends on
              continuous insurance from the original date of design work.
            </li>
            <li>
              <strong>CPD on retained projects</strong> — when BS 7671 amendments change the
              regulatory landscape (A4:2026 brought significant changes), the designer's retained
              projects do not become non-compliant — they remain compliant with the edition they
              were designed under. But the designer should understand the changes well enough to
              advise PAPs and building owners on whether retro-fit work is recommended.
            </li>
          </ul>
        </ConceptBlock>
