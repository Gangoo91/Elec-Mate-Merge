...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Approximate guidance for common sizes: 2.5 mm² into a typical UK socket terminal (MK, Crabtree, BG, Hager) — 1.0–1.5 Nm. 1.0 mm² into a typical lighting accessory — 0.5–0.8 Nm. 6 mm² into a 32 A immersion isolator — 2.0–2.5 Nm. 16 mm² into a CU main switch — 2.5–4.0 Nm. DIN-rail RCBO / MCB terminals (Hager, Schneider, ABB) — 2.0–3.0 Nm typical. These are starting points; for the actual job, look up the exact value on the manufacturer page (5 seconds on the phone). A torque screwdriver (Wera 7440, Wiha TorqueVario, Felo 100) is essential L3 kit.',
  },
  {
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The four most common fault patterns the L3 apprentice meets — broken ring final, failed
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">
              6.1 Preparation + information sources
            </div>
          </button>
          <button
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">
              6.3 Specialised systems — 3-phase, control, EV / PV
            </div>
          </button>
        </div>
      </HubBody>
