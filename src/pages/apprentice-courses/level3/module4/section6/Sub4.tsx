    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The capstone for Module 4 — a multi-fault case study walking the full Unit 303 framework,
          then the reflective-practice discipline (Kolb cycle, After Action Review, just culture)
          that converts each visit into a learning event. The L3 metacognitive step-up that supports
          the journey from apprentice to Approved Electrician.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>09:00 ARRIVAL</strong> — greet, brief the diagnostic plan, customer access to
              the kitchen and CU.
            </li>
            <li>
              <strong>09:15 DIAGNOSTIC</strong> — isolate the kitchen ring; full Part 6 testing;
              identify the kettle's element as having degraded IR under heat (cold-vs-hot IR
              comparison).
            </li>
            <li>
              <strong>09:45 DISCOVERY</strong> — while at the CU, notice the lighting circuits are
              not RCD-protected (Code C2 territory under current standards) AND there is no visible
              main bonding to the gas service entering the property (Code C2). Inspect the gas meter
              cupboard — confirmed: no bonding cable.
            </li>
            <li>
              <strong>10:00 PRIORITISATION</strong> — original fault (kettle) is the contracted
              work. Additional findings are non-immediate-danger but warrant action. Brief the
              customer on what was found.
            </li>
            <li>
              <strong>10:15 EXECUTION</strong> — fit a new kettle (or recommend replacement; not
              strictly your work, but advise); restore the kitchen ring; verify post-rectification
              testing.
            </li>
            <li>
              <strong>11:00 DOCUMENTATION</strong> — issue Minor Works Certificate for the kitchen
              work; issue a separate Schedule of Observations / EICR-equivalent report listing the
              lighting RCD gap and the missing bonding; quote for both as separate works.
            </li>
            <li>
              <strong>11:30 CUSTOMER BRIEF</strong> — show the work, demonstrate the kitchen, hand
              over the certificate, walk through the additional findings, give the customer the
              choice and the timeline.
            </li>
            <li>
              <strong>12:00 DEBRIEF</strong> — phone the supervisor on the way back; AAR the visit;
              log the additional-findings quote in the firm's system for the office to follow up.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              HSWA s.3 puts the duty on the firm (and through it, on the L3 apprentice as the firm's
              representative on site) towards anyone who isn't an employee &mdash; the customer, the
              customer's family, the postman, the next tenant. When an L3 apprentice discovers a
              safety finding during a visit, the s.3 duty is engaged regardless of whether the
              customer asked about it. The right response is to document, brief, and offer
              rectification &mdash; not to ignore. Ignoring known safety issues breaches the duty
              and exposes the firm to civil and potentially criminal liability if harm later occurs.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>WRITTEN DOWN</strong> — externalising the reflection forces precision;
              thinking about it without writing tends to gloss.
            </li>
            <li>
              <strong>PROMPT</strong> — same-day or next-day while memory is fresh; week-old AARs
              lose detail.
            </li>
            <li>
              <strong>HONEST</strong> — the framework is for learning, not blame; honest answers
              make the learning real.
            </li>
            <li>
              <strong>ACTIONABLE</strong> — the fourth question demands a concrete change;
              reflection without change is wishful thinking.
            </li>
            <li>
              <strong>SHARED</strong> — supervisor / peer review of the AAR multiplies the learning
              across the team.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Honest mistake</strong> — competent person made a reasonable error under the
              circumstances. Response: learning, training, procedure improvement.
            </li>
            <li>
              <strong>At-risk behaviour</strong> — person knew the safer option but chose the
              riskier. Response: coaching, retraining.
            </li>
            <li>
              <strong>Reckless behaviour</strong> — person knowingly took an unjustifiable risk.
              Response: disciplinary, potential dismissal.
            </li>
            <li>
              <strong>System failure</strong> — the procedure or training itself was inadequate.
              Response: redesign the system, not the person.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Anonymised job sheet</strong> &mdash; what was found, what was done, what was
              learned.
            </li>
            <li>
              <strong>Test result extract</strong> &mdash; the readings that confirmed the
              diagnosis.
            </li>
            <li>
              <strong>Photograph (anonymised)</strong> &mdash; before / during / after.
            </li>
            <li>
              <strong>Reflection note</strong> &mdash; what went well, what surprised you, what
              you&apos;d do differently next time.
            </li>
            <li>
              <strong>Cross-reference to standard</strong> &mdash; the BS 7671 Regulation, GN3
              section, or manufacturer instruction that informed the decision.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply-side faults</strong> &mdash; cut-out, tails, service head, DNO
              equipment. Always escalate.
            </li>
            <li>
              <strong>Three-phase commercial faults</strong> beyond the scope of your training
              &mdash; motor controls, VSDs, large heating banks.
            </li>
            <li>
              <strong>Specialised-system faults</strong> &mdash; PV string side, battery storage
              internals, EV charger module replacement.
            </li>
            <li>
              <strong>Anything that doesn&apos;t add up</strong> &mdash; readings that contradict
              each other, symptoms that change between visits, equipment behaving outside its data
              sheet.
            </li>
            <li>
              <strong>
                Anything where you&apos;ve isolated, proved dead, started work, and a reading
                appears you can&apos;t immediately explain.
              </strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Pattern categories worth tracking deliberately:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Symptom patterns</strong> — burnt-plastic smell at the CU, browning around a
              socket terminal, audible humming at a fluorescent ballast, RCD that holds for 30
              seconds then trips.
            </li>
            <li>
              <strong>Customer patterns</strong> — the customer who minimises the symptom (often a
              more serious fault than reported), the customer who escalates everything (often a less
              serious fault than reported), the customer with a tight budget (drives the quoting
              strategy).
            </li>
            <li>
              <strong>Property patterns</strong> — 1970s estate with the same consumer unit type and
              the same predictable failure mode, Victorian terrace with original lead-and-rubber
              wiring, modern new-build with PME and an EV charger.
            </li>
            <li>
              <strong>Equipment patterns</strong> — particular RCBO models that fail predictably,
              particular extractor fans that leak earth, particular EV chargers with comms quirks.
            </li>
            <li>
              <strong>Failure patterns</strong> — the conductor that always fails at the
              back-of-cabinet bend, the bonding clamp that always corrodes, the outdoor accessory
              that always lets in water at the cable gland.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>CPD record items worth capturing:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Formal training</strong> — courses, certificates, signed attendance evidence;
              the heaviest evidence weight.
            </li>
            <li>
              <strong>Manufacturer training</strong> — vendor-specific certifications (heat pump
              install, EV charger installer, PV MCS pathway).
            </li>
            <li>
              <strong>Toolbox talks and team briefings</strong> — record date, topic, presenter;
              cumulative value for evidence of ongoing learning.
            </li>
            <li>
              <strong>Reading and self-study</strong> — IET wiring matters, manufacturer technical
              bulletins, electrical magazines; honest time-spent estimate.
            </li>
            <li>
              <strong>Visit reflection</strong> — significant visits where a new lesson was learned;
              counts as evidenced learning.
            </li>
            <li>
              <strong>Mentoring or peer support</strong> — helping a fellow apprentice through a
              problem; counts both ways.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The post-L3 progression milestones:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>AM2 / AM2S end-point assessment</strong> — practical and theory test; the
              gateway to the qualification.
            </li>
            <li>
              <strong>NVQ Level 3 Electrotechnical Services</strong> — portfolio evidence of
              competence across the apprenticeship experience.
            </li>
            <li>
              <strong>ECS gold card</strong> — proof of qualified-electrician status; site-access
              requirement on most CSCS sites.
            </li>
            <li>
              <strong>JIB grades</strong> — Electrician, Approved Electrician, Technician; pay
              scales and CPD requirements attached.
            </li>
            <li>
              <strong>Specialist schemes</strong> — EV (OZEV), PV (MCS), heat pump (MCS), inspector
              under BS 7671 EICR Best Practice Guide.
            </li>
            <li>
              <strong>Higher education</strong> — HNC, HND, degree-level for design / engineer /
              manager pathway.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              shall be carried out by one or more skilled persons competent to verify that the
              requirements of BS 7671 have been met. Appropriate certification shall be issued in
              accordance with Chapter 64."
            </>
          }
          meaning={
            <>
              The capstone visit ends with inspection, testing and certification by a skilled person
              competent to verify compliance. As an L3 apprentice you support the &ldquo;skilled
              person&rdquo; who signs &mdash; you don&apos;t self-certify on your own authority. Reg
              134.2.1 is the regulation that makes that sponsoring sign-off mandatory, not a
              courtesy.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Where the capstone job spans both fault rectification and a periodic inspection
              element, Reg 651.5 puts the same competence requirement on the inspecting person. The
              reflective-practice habit you build at L3 is what evidences that competence in five
              years&apos; time when you&apos;re the person being signed off as the skilled
              inspector.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              apprentice has no recorded reflection from the previous visit to draw on. Repeats the
              same minor mistake. The AAR would have captured the small lessons (the customer
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice has a close call &mdash; cuts a cable they thought was dead and it sparked,
              no harm done. Decides not to report because they're worried about getting in trouble.
              Six months later another team member meets the same condition (a drawing that
              mis-identifies a circuit) but is less lucky and is electrocuted. The investigation
              finds the original near-miss in the apprentice's memory but not in the firm's records;
              the firm couldn't act on what wasn't reported. The apprentice lives with the knowledge
              for a career.
            </>
          }
          doInstead={
            <>
              ...
              culture, the response is learning &mdash; the drawing gets corrected, a procedure is
              updated, the apprentice's experience helps the team. If the firm punishes near-miss
              reports, the firm is failing in its safety culture and the L3 apprentice should
              reflect on whether to stay long-term &mdash; but in the moment, the report is still
              the right action.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Customer in a 1985-built semi-detached reports their kitchen RCD trips when the kettle
              is used. They've had this for a fortnight. You're allocated a 2-hour visit with the
              supervisor on phone-call backup. The customer has a Wylex consumer unit fitted in 1998
              (last refit). You arrive at 09:00.
            </>
          }
          whatToDo={
            <>
              09:00 GREET + BRIEF; 09:10 isolate the kitchen ring at the Wylex DB, lock-off, prove
              dead at the kitchen socket; 09:20 visual inspection of the kettle (Bosch TWK7203)
              &mdash; element looks clean, no obvious damage. Energise; full Part 6 testing on the
              kitchen ring &mdash; R1+R2 0.42&nbsp;&Omega;, IR over 200&nbsp;M&Omega; cold, Zs
              0.51&nbsp;&Omega; (within limits), RCD trip-time 24&nbsp;ms (good). Ring tests fine
              when isolated from the kettle. 09:40 plug the kettle into a known socket and IR-test
              the kettle's element &mdash; cold reads 8.2&nbsp;M&Omega; (acceptable). Boil a kettle
              of water (3 minutes); IR-test immediately &mdash; reads 0.18&nbsp;M&Omega; (FAILED,
              well below 1&nbsp;M&Omega; threshold). DIAGNOSTIC CONFIRMED &mdash; degraded element
              under heat. Recommend customer replace the kettle (not strictly your job &mdash; it's
              the customer's portable appliance). 09:55 while at the CU, notice the lighting MCBs
              are not RCD-protected (a 1998 Wylex layout is typical &mdash; only the ring final got
              the original RCD; lighting was not RCD-protected at the time and current standards
              require 30&nbsp;mA RCD on lighting under BS 7671 411.3.4 since A3:2015). Code C2 on a
              modern EICR. 10:00 inspect the gas meter cupboard &mdash; no main bonding cable
              visible to the gas service. Code C2. 10:10 quick measurement L-N, L-E, N-E at the
              cut-out &mdash; all sound; no PEN issue. 10:15 BRIEF the customer &mdash; "the kettle
              is the cause of today's RCD trips; replace the kettle and the trip will stop. While I
              was here I also noticed two safety items that don't pose immediate danger but should
              be addressed &mdash; your lighting circuits aren't RCD-protected (current standards
              require this) and you don't have main bonding to your gas service. I can quote you for
              both as a separate visit; total ballpark &pound;200&ndash;300 for the bonding fix and
              &pound;400&ndash;500 for adding RCD protection on lighting via a CU partial-upgrade or
              RCBO replacement of the lighting MCBs. Are you happy for me to send a written quote?".
              Customer agrees to the quote. 10:30 issue the Minor Works Certificate for today's work
              (kitchen ring tested and verified, no work done on the ring itself), plus a Schedule
              of Observations listing the two findings. 10:40 hand-back + customer signature. 10:50
              leave site. 11:30 phone supervisor on the way back &mdash; brief the AAR (visit went
              fine, additional findings flagged, quote going out). 12:00 office logs the quote for
              follow-up.
            </>
          }
          whyItMatters={
            <>
              The capstone visit demonstrates the full Unit 303 framework in one realistic scenario
              &mdash; H&S framework (isolation, GS38 instruments), instruments (MFT, cold-vs-hot
              IR), fault types (insulation breakdown under heat), logical diagnosis (rule out the
              circuit, isolate the appliance, prove the failure mode), rectification (recommend
              appliance replacement &mdash; the right scope), and documentation (MWC for today,
              Schedule of Observations for the additional findings). PLUS the metacognitive layer
              &mdash; recognising the additional findings as duties not options, briefing the
              customer fairly, escalating the further work appropriately, running the AAR back at
              base. This is what L3 competence looks like in the wild.
            </>
          }
        />
        ...
        <Quiz
          title="Capstone case + reflective practice — knowledge check"
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">
              6.3 Specialised systems — three-phase, EV, PV
            </div>
          </button>
          <button
