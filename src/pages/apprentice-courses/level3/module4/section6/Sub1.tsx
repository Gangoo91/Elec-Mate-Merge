...
const quizQuestions = [
  ...
  {
    id: 6,
    question: "What's the L3 apprentice's planning routine for parts before going to site?",
    options: [
  ...
  return (
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              The work must be carried out by skilled or instructed persons (an L3 apprentice
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              typically are not. The L3 apprentice carries a GS38-compliant two-pole tester for
        ...
        >
          <p>Standard RAMS items for a typical L3 rectification visit:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <Scenario
          ...
          whyItMatters={
            <>
              Planning is the L3 step-up over L2. At L2 you turned up with the part. At L3 you turn
              up with the part, the data sheet, the baseline test results, the MWC template
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">
              6.2 Apply correction techniques to common faults
            </div>
          </button>
        </div>
      </HubBody>
