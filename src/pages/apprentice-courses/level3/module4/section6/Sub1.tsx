      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-2 pb-24">
        <PageFrame>
          ...
          <RegsCallout
            ...
            clause={
              <>
                "Test probes and leads should incorporate the following features — finger barriers or are shaped to guard against inadvertent hand contact with the live conductors under test; insulated except for the tip with a maximum of 4 mm of exposed metal at the tip (and ideally less); fused at less than 500 mA where appropriate; high-impedance to allow for safe testing of dead conductors."
              </>
            }
            meaning={
              <>
