...
const TITLE = 'GS38 + selecting test instruments (2.1) | Level 3 Module 4.2.1 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question:
      "List the seven instruments in an L3 apprentice's fault-diagnosis kit and what each is for.",
    options: [
  ...
  },
  {
    id: 8,
    question:
      'What does a CAT IV 600 V instrument cost on average and which ones are typical L3 apprentice purchases?',
    options: [
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              87V (CAT IV 600 V) and Martindale VI-13800 (CAT IV 600 V) cover most L3 work.
            </>
          }
        />
