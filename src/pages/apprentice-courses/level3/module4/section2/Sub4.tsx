...
const TITLE = 'MFT testing for fault diagnosis (2.4) | Level 3 Module 4.2.4 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'How do you test ring final continuity to verify the ring is actually a ring (not a broken-into-radial)?',
    options: [
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 2 · Subsection 4"
        title="MFT testing for fault diagnosis"
        backTo="/study-centre/apprentice/level3-module4-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The seven BS 7671 643 tests done with an MFT, framed as fault-diagnosis investigations
          rather than commissioning — continuity, IR, polarity, EFLI, RCD, current/voltage, phase
          sequence. What each tells you, the test sequence, typical readings on faulted vs healthy
          circuits.
        </p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Continuity of protective conductors</strong> (Reg 643.2.1) — R1+R2 method
              or simple continuity to a single point. Confirms CPC integrity.
            </li>
            <li>
              <strong>2. Continuity of ring final conductors</strong> (Reg 643.2.1) — three-step
              cross-connection test confirms ring topology.
            </li>
            <li>
              <strong>3. Insulation resistance</strong> (Reg 643.3) — between live conductors and
              earth, between live conductors. 500 V DC for LV (250 V for circuits with electronics).
            </li>
            <li>
              <strong>4. Polarity</strong> (Section 643) — confirms line connected to line terminal
              at every accessory; switches break line not neutral.
            </li>
            <li>
              <strong>5. Earth fault loop impedance</strong> (Reg 643.7.3) — Ze at origin, Zs at
              every protective device. Verify against Table 41.3 maximums.
            </li>
            <li>
              <strong>6. Operation of RCDs</strong> (Reg 643.8) — a single AC test at rated 1×IΔn.
              Verify the operating time against the Reg 643.8 limits (≤ 300 ms general non-delay;
              130–500 ms delay 'S' type).
            </li>
          </ul>
          <p>
            Tests 1–4 are dead tests; tests 5–6 are live. The dead-then-live order keeps you safe
            and gives clean diagnostic data.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 134.2.1 is the parent duty that the Chapter 64 test sequence implements. For fault
              diagnosis, the same tests are used to verify the installation has not departed from
              compliance — the post-fault retest is itself a 134.2.1 verification, and certification
              under Chapter 64 follows.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>R1+R2</strong> (whole circuit loop) — link L and CPC at the far end of the
              circuit; measure from the DB end. Gives the loop resistance for use in calculating Zs.
              Standard L3 method for fault diagnosis.
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Measure L–N at every socket on the ring — readings should be within 0.05 Ω of each
              other for a healthy ring.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Confirm circuit is fully isolated AND proved dead with separate two-pole tester.
            </li>
            <li>
        ...
        >
          ...
          <p>
            Use Hi-Z (no-trip) mode on RCD-protected circuits; standard mode on non-RCD circuits.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The Ra &times; I&Delta;n &le; 50&nbsp;V test is your TT-system back-stop. On a TT job
              where the EFLI looks borderline, calculate it: a 30&nbsp;mA RCD with Ra of
              200&nbsp;&Omega; gives Ra &times; I&Delta;n = 6&nbsp;V &mdash; well inside the limit.
              The same RCD with a 1700&nbsp;&Omega; electrode gives 51&nbsp;V &mdash; fail,
              regardless of what the loop tester says.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              "The requirements for RCD testing have been changed and Table 3A (Time/current
              performance criteria for RCDs) in Appendix 3 has been deleted. Regardless of RCD Type,
              an alternating current test at rated residual operating current (IΔn) is used to
          ...
          meaning={
            <>
              ...
              forma if it still has a 5&times; column.
            </>
          }
        ...
        >
          ...
          <p>
            Phase sequence test (3-phase only) confirms L1 / L2 / L3 rotation order. Wrong sequence
            reverses three-phase induction motor rotation. Tested with phase rotation indicator
            (Fluke 9040, Megger PRMA1).
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Before pressing IR test, check for electronic loads on the circuit — LED drivers,
              dimmer modules, smart switches, AFDDs. Disconnect or shunt them, OR test at 250 V
              instead of 500 V. Megger and Fluke MFTs both support 250 V; the lower voltage is BS
              7671-acceptable for circuits with electronics per GN3 guidance.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Customer reports the RCBO on the upstairs ring final keeps tripping under load
              (kettle, microwave on simultaneously). The thermal magnetic mechanism trips, not the
              RCD. You isolate, prove dead, and start MFT testing.
            </>
          }
          whatToDo={
            <>
              (1) Continuity R1+R2 — reads 1.4 Ω. Calculated expected for 35 m of 2.5 mm² T+E ring =
              0.5 Ω. R1+R2 is THREE TIMES expected — strong indicator of a high-resistance joint
              somewhere on the circuit. (2) Ring continuity three-step — readings vary across
              sockets by 0.3 Ω (should be within 0.05 Ω) — confirms the high resistance is
              concentrated at one branch of the ring. (3) IR — passes at 200 MΩ — insulation is
              fine. (4) EFLI Zs — reads 1.7 Ω against expected 0.7 Ω — confirms the additional
              resistance shows up in the loop. (5) Restore supply, set up clamp meter, energise the
              circuit and turn on the kettle. Measure voltage drop at suspect sockets — one socket
              shows 8 V drop under 13 A load (3.5%, well above 1% expected). (6) Thermal camera scan
              — the suspect socket reads 60 °C at the L terminal vs 25 °C ambient. (7) Isolate, open
              the suspect socket — terminal screw is loose, conductor is partially blackened.
              Re-strip, re-terminate, retest. R1+R2 now reads 0.55 Ω — fault corrected.
            </>
          }
          whyItMatters={
            <>
              HRJ diagnosis is the canonical L3 multi-test investigation. No single test finds the
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>×½ test</strong> — 15 mA injection on a 30 mA RCD. Should NOT trip. If it
              does, the RCD is over-sensitive (typically ageing). Diagnostic only — not part of the
              A4:2026 verification.
            </li>
            <li>
              <strong>×1 test (the BS 7671 verification)</strong> — 30 mA AC injection at rated IΔn.
              General non-delay type must disconnect within 300 ms; delay 'S' type within 130–500
              ms. This single 1×IΔn AC test is the A4:2026 pass criterion (Reg 643.8).
            </li>
            <li>
              <strong>×5 test</strong> — 150 mA injection. A legacy diagnostic that some MFTs still
              offer; the old 40 ms / 5×IΔn pass criterion and Table 3A were DELETED in A4:2026, so
              it is no longer a verification requirement.
            </li>
            <li>
              <strong>Ramp test</strong> — gradually increases current from 0 mA upward, captures
              the actual trip current. A 30 mA RCD should trip between 15 mA and 30 mA. Below 15 mA
              = nuisance-trip risk; above 30 mA = won't protect at the rated current.
            </li>
            <li>
              <strong>Type AC vs Type A vs Type B</strong> — Type AC sees only sinusoidal AC
              residual current (legacy); Type A also sees pulsating DC residual (modern domestic
              standard); Type B also sees smooth DC (required for EV chargers, VSDs, certain solar
              PV). Mismatch causes nuisance trips OR worse, no protection.
            </li>
            <li>
              <strong>Phase angle</strong> — modern MFTs let you choose 0° or 180° phase angle for
              the test. Faulty RCDs sometimes pass on one angle and fail on the other.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Correct rotation</strong> — UK standard is L1-L2-L3 clockwise (some sources
              call this "ABC"). Rotation indicator shows clockwise arrow / "1-2-3" / green LED.
            </li>
            <li>
              <strong>Wrong rotation</strong> — anticlockwise / "1-3-2" / red LED. Swap any two
              phases at the supply to reverse.
            </li>
            <li>
              <strong>Phase loss</strong> — one of L1/L2/L3 missing. Three-phase motor will hum but
              not rotate; some indicators flash to show. Voltage check L-L confirms (e.g. L1-L2 = 0
              V or 230 V instead of 400 V).
            </li>
            <li>
              <strong>Phase imbalance</strong> — voltages between phases differ significantly
              (&gt;5%). Causes motor overheating and reduced torque. Power-quality analyser logs
              over time.
            </li>
            <li>
              <strong>Open neutral on 3-phase</strong> — supplies become unbalanced; load with low
              resistance gets full L-L voltage. Catastrophic for connected single-phase equipment.
              Check N voltage to true earth at sub-DB.
            </li>
            <li>
              <strong>Earth fault on 3-phase</strong> — Type B RCD or earth-leakage relay fires. Use
              clamp meter on N + 3 phases together to confirm leakage current.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Earth electrode test (3-pole)</strong> — main electrode + auxiliary current
              stake (10-20 m away) + auxiliary potential stake (5-10 m). MFT injects current,
              measures voltage gradient. Electrode resistance read directly.
            </li>
            <li>
              <strong>Earth electrode test (stakeless)</strong> — Megger DET14C clamps around the
              electrode lead. Measures using induced current method. Needs an earth network present
              (won't work on isolated electrodes).
            </li>
            <li>
              <strong>Prospective Short Circuit Current (PSCC)</strong> — measured at origin between
              phases (or L-N for single-phase). UK domestic typically 6 kA at cut-out; commercial
              16-25 kA at TX-side. Used to confirm protective device breaking capacity (BS EN 60898
              MCBs typically 6 kA, BS EN 60947-2 MCCBs 25-50 kA).
            </li>
            <li>
              <strong>Prospective Earth Fault Current (PEFC)</strong> — measured L-E at origin.
              Often the limiting figure for breaker selection. Always less than PSCC.
            </li>
            <li>
              <strong>Insulation resistance at higher voltage</strong> — for SWA cables and larger
              motors, IR test at 1 kV (Megger MIT400-2) or 2.5 kV (MIT525). Compare to BS 7671
              643.3.3 minimum (1 MΩ at 500 V test for general circuits).
            </li>
            <li>
              <strong>Polarisation index</strong> — for motors and transformers. IR ratio at 10
              minutes vs 1 minute. PI &gt; 2.0 = good insulation; PI &lt; 1.0 = wet or damaged
              windings.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module4-section2-3')}
