...
const TITLE = 'Confirming instruments fit for purpose (2.2) | Level 3 Module 4.2.2 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      "Why is the 'function check on a known live source' specifically important for proving-dead testers?",
    options: [
  ...
  },
  {
    id: 4,
    question:
      'How do you function-check an MFT (Megger MFT1741+, Kewtech KT64+) at the start of a shift?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      "What's the legal status of measurements taken with an out-of-calibration instrument?",
    options: [
  ...
  },
  {
    id: 8,
    question:
      'If an instrument has been heavily used (e.g. 40 hours of testing in one week on a big job), should it be re-calibrated more frequently than the standard interval?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'Do I need to do a function check if the instrument was checked at the start of the shift?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The pre-use verification routine for the L3 fault-diagnosis kit — visual / calibration /
          function — plus calibration certificates, UKAS traceability, the calibration register, and
          what to do when an instrument fails any check.
        </p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Calibration</strong> — formal laboratory measurement against UKAS-traceable
              reference standards. Documented in a certificate. Annual for MFT and multimeter, every
              24 months for two-pole tester.
            </li>
            <li>
              <strong>Verification</strong> — field comparison between two instruments. E.g. compare
              MFT EFLI reading against a known reference loop or a second calibrated instrument.
              Confirms the field reading is plausible.
            </li>
            <li>
              <strong>Function check</strong> — pre-use confirmation that the instrument works AT
              ALL. Powers on, responds to a known source, returns to zero on a known dead source.
              The daily go/no-go.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              For test instruments specifically, Reg 6 is interpreted as 'inspected at suitable
              intervals' — typically pre-shift function check + scheduled calibration. Records are
              kept until the next inspection is recorded. The regulation puts the duty on the
              employer; the operative discharges it via the daily check.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Two-pole tester (Martindale VI-13800)</strong> — visual: case + leads +
              probes; calibration: sticker in date; function: prove on GVD2 — full lamp + LED +
              audible.
            </li>
            <li>
              <strong>Proving unit (Martindale GVD2)</strong> — visual: case + battery; function:
              confirm output by testing the two-pole on it.
            </li>
            <li>
              <strong>MFT (Megger MFT1741+)</strong> — visual; calibration sticker; function:
              self-test, continuity null with leads shorted, IR test with leads shorted (open at
              &gt;999 MΩ), loop test on known live socket.
            </li>
            <li>
              <strong>Multimeter (Fluke 117)</strong> — visual; calibration sticker; function:
              voltage on a known live socket, resistance on a known reference.
            </li>
            <li>
              <strong>Clamp meter (Fluke 376FC)</strong> — visual; calibration sticker; function:
              clamp on a known load (e.g. a kettle on a 13 A circuit drawing 12 A).
            </li>
            <li>
              <strong>Socket tester (Martindale CP501)</strong> — visual; function: test on a
              known-good socket — three lights all illuminate.
            </li>
            <li>
              <strong>VDE screwdrivers (Wera Kraftform)</strong> — visual: handle insulation intact,
              no cracks, blade in good condition.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Lab name and UKAS accreditation number (e.g. 'UKAS Calibration Laboratory No 0234').
            </li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Calibration is what keeps an instrument BS EN 61557-compliant in service. A meter that
              was 61557-compliant when new can drift outside spec inside 18 months &mdash; the
              certificate is the evidence that it&apos;s still inside the standard&apos;s
              performance window. No certificate, no claim of compliance.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              asks for a 5&times;I&Delta;n result, it&apos;s out of date and needs revising before
              the next audit.
            </>
          }
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              An instrument with expired calibration is not a usable instrument. Reschedule the job,
              hire/borrow a calibrated instrument, or arrange emergency calibration. The cost of a
              rescheduled job is trivial vs the cost of a void certificate.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Function check at the start of every shift, no exceptions. The Martindale + GVD2 combo
              takes 10 seconds — press the button, lamps + LED + audible — done. Skipping it to save
              10 seconds is the worst trade in the trade.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              a nearby job, hire one (Speedy Hire / HSS Hire stock Megger MFTs), reschedule the test
              phase. (4) Document everything on the job sheet — the discovery, the action, the
              supervisor briefing. (5) Send the out-of-cal MFT to the calibration lab on return to
              depot. (6) Customer brief — explain the situation honestly, no charge for the wasted
              visit if it was the firm's instrument-management failure.
            </>
          }
          whyItMatters={
            <>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Two-pole tester</strong> — prove on Martindale GVD2 (or known live socket).
              Confirm full lamp + LED + audible.
            </li>
            <li>
              <strong>Multimeter</strong> — test against 9 V battery. Test continuity by shorting
              the leads. Test resistance against a known 1 kΩ resistor.
            </li>
            <li>
              <strong>MFT continuity</strong> — short the leads, verify zero. Open the leads, verify
              OPEN. Apply a known 1 Ω resistor, verify reading.
            </li>
            <li>
              <strong>MFT IR</strong> — open leads at 500 V test, verify &gt;999 MΩ. Apply known
              resistor, verify reading.
            </li>
            <li>
              <strong>MFT loop</strong> — at a known socket on a different circuit, verify Zs
              reading matches your last recorded value (within 10%).
            </li>
            <li>
              <strong>Clamp meter</strong> — clamp around a current carrying conductor with known
              load (kettle, drill), verify expected current reading.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>UKAS certificate fields</strong> — instrument make / model / serial; date of
              calibration; calibration cycle (12 months typical); as-found readings; as-left
              readings; lab accreditation number; technician signature.
            </li>
            <li>
              <strong>Traceability chain</strong> — UKAS lab → reference standards traceable to NPL
              → SI units. Audit trail.
            </li>
            <li>
              <strong>Calibration register</strong> — the firm maintains a register: instrument
              list, calibration dates, due dates, certificate references, location of physical
              certificates.
            </li>
            <li>
              <strong>Out-of-cal handling</strong> — instrument tagged "out of service", removed
              from working kit, sent for re-calibration. Any readings taken during the out-of-cal
              period are flagged for review (in case re-calibration shows drift).
            </li>
            <li>
              <strong>Audit visit</strong> — NICEIC, NAPIT, ELECSA surveillance visits routinely
              check the calibration register and pick a sample of certificates to verify.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Failure type</strong> — physical damage (cracked case, damaged leads),
              out-of-cal (sticker expired or warning displayed), function-test failure (continuity
              reads non-zero on shorted leads, IR reads finite on open leads).
            </li>
            <li>
              <strong>Tag and isolate</strong> — physical tag "OUT OF SERVICE — DO NOT USE"
              attached, instrument placed in the firm's quarantine box.
            </li>
            <li>
              <strong>Substitute</strong> — switch to backup instrument, do the pre-use check on it,
              document the swap on the job sheet.
            </li>
            <li>
              <strong>Notify supervisor</strong> — same day, in writing (text or app message). The
              firm needs to know its kit register has a failure.
            </li>
            <li>
              <strong>Decision</strong> — if minor (e.g. a damaged lead), the firm replaces the lead
              and re-tests. If major (e.g. instrument drift), send for re-calibration or repair. If
              beyond economic repair, replace.
            </li>
            <li>
              <strong>Document review</strong> — any readings taken with the failed instrument since
              the last successful pre-use check are flagged for review. May trigger a re-test on
              affected circuits.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Earth electrode tester</strong> — Megger DET3TC, DET14C. Three-pole or
              stakeless. Used for TT installations, lightning protection systems, fault
              investigations on degraded electrodes. Typical TT electrode 50-200 Ω.
            </li>
            <li>
              <strong>Low-resistance ohmmeter (DLRO)</strong> — Megger DLRO10, DLRO10X. Measures
              sub-milliohm resistance. Used for verifying main earth bond integrity, joint
              resistance on busbars, contact resistance on switchgear.
            </li>
            <li>
              <strong>Higher-voltage IR tester</strong> — Megger MIT400-2 (1 kV), MIT525 (2.5 kV),
              MIT1025 (10 kV) for SWA cable testing, motor windings, transformers.
            </li>
            <li>
              <strong>Power quality analyser</strong> — Fluke 1730, Fluke 1760, Hioki PW3198. Logs
              voltage / current / harmonics over hours-days. Used for intermittent fault diagnosis,
              harmonic analysis, voltage dip / sag investigation.
            </li>
            <li>
              <strong>Motor analyser</strong> — Megger MTR105, Baker DX. Measures winding
              resistance, polarisation index, surge response. Used for diagnosing motor winding
              faults.
            </li>
            <li>
              <strong>Thermal camera</strong> — Fluke Ti401, FLIR E54, Seek Thermal CompactPro.
              Non-invasive hot-spot detection on terminals, busbars, motors, transformers.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Quiz
          title="Confirming instruments fit for purpose — knowledge check"
          questions={quizQuestions}
        />

        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module4-section2-1')}
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">
              2.3 Multimeter / clamp / IR camera
            </div>
          </button>
        </div>
      </HubBody>
