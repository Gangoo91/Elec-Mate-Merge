...
const TITLE = 'Equipment-side faults (3.6) | Level 3 Module 4.3.6 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Any fault code on the display means the whole job is yours. Open the inverter, read the internal board indicators and replace whichever component the code points to; a competent L3 electrician is expected to repair inverter internals before calling the manufacturer.',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Induction hobs run an inverter at 20–100 kHz that puts harmonic content on the supply; cheap LED drivers without proper EMC filtering pick it up and modulate their output, causing the flicker, while magnetic coupling to the hood's transformer / chassis is the buzz. Both items are individually compliant with BS EN IEC 61000-3 but together they're a cumulative EMC failure. EMC compatibility issues are increasingly common as customer kit (induction hobs, EV chargers, PV inverters, VSDs) gets more electronic. The L3 apprentice recognises the signature — problem starts when a specific other appliance is in use, wiring tests are clean — and helps the customer choose a fix (better-spec driver, mains filter, escalation to the manufacturer).",
  },
];
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          ...
          L3 recognition discipline that separates a wiring fault from an equipment fault, and the
        ...
        >
          <p>The standard L3 element-replacement procedure:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        >
          <p>The L3 motor-fault hypothesis tree, in priority order:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              &lsquo;equipment side&rsquo;. The L3 apprentice respects the spec.
            </>
          }
        ...
        >
          <p>The L3 cumulative-leakage diagnostic routine:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              kit items. The L3 apprentice&apos;s value here is the clear diagnosis and the
              documented evidence the customer needs to engage the manufacturer.
            </>
          }
          whyItMatters={
            <>
              EMC interaction faults are an increasing fraction of L3 fault calls as more customer
              ...
              but the combinations weren&apos;t tested by the manufacturers. The L3 apprentice
