...
const TITLE = 'Common symptoms of electrical faults (3.2) | Level 3 Module 4.3.2 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      "Customer reports 'fire alarm panel showing 'EARTH FAULT' on the LCD'. What does this mean and what's the L3 action?",
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        >
          ...
          <p>
            Investigation method: install a power quality analyser (Sub 2.3) for a week, capture
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module4-section3-1')}
