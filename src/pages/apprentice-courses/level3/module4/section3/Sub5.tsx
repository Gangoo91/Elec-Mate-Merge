...
const quizQuestions = [
  {
    id: 1,
    question:
      "What's the residual charge in a 4 µF fluorescent ballast capacitor after isolation, and how do you safely discharge it?",
    options: [
  ...
  },
  {
    id: 2,
    question:
      "What's the precaution for working near RF (radio-frequency) equipment such as induction heaters or RF welders in a workshop?",
    options: [
  ...
  },
  {
    id: 3,
    question:
      "What's the procedure for isolating an emergency lighting central battery system without compromising the building's safety?",
    options: [
  ...
  },
  {
    id: 4,
    question:
      "A customer's lift fails to operate after an unrelated fault investigation that involved isolation of the building's main supply. What might have happened?",
    options: [
  ...
  },
  {
    id: 5,
    question:
      "Customer's IT comms cabinet has a UPS. After your work, the UPS shows 'BATTERY LOW'. What's happened?",
    options: [
  ...
  },
  {
    id: 6,
    question:
      "What does 'lone working in hazardous areas' mean and what additional controls apply?",
    options: [
  ...
  },
  {
    id: 7,
    question:
      "What's the special isolation precaution for fault diagnosis on a building with PV + battery storage where the customer relies on the battery for off-grid backup?",
    options: [
  ...
  },
  {
    id: 8,
    question:
      "What's the special precaution for diagnosing faults on circuits feeding life-safety equipment (medical equipment in a care home, oxygen concentrators, mobility lifts)?",
    options: [
...
const faqs = [
  {
    question:
      'What special precaution applies for fault investigation on a circuit feeding a smart meter?',
    answer:
  ...
  {
    question:
      'How do I work safely on circuits that feed CCTV, security alarms or building access control?',
    answer:
  ...
  {
    question:
      'What precautions apply for fault work on a circuit feeding refrigeration that affects food safety?',
    answer:
  ...
  {
    question:
      "What's the precaution for circuits feeding solar PV / battery storage when investigating an unrelated fault?",
    answer:
  ...
  {
    question:
      "What's the L3 apprentice's role in fault investigation on commercial three-phase plant (motors, VFDs, large pumps)?",
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Special-environment and specialised-equipment precautions an L3 apprentice meets —
          fibre-optic eye safety, IT graceful shutdown, fluorescent ballast capacitor discharge, RF
          / induction equipment fields, fire alarm isolation procedures, emergency lighting test
          cycles, life-safety equipment coordination.
        </p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Eye safety</strong> — NEVER look down a connected fibre or its connector. Use
              a Visual Fault Locator (VFL, 650 nm red) to verify dark before inspection. Fluke /
              EXFO sell standard VFLs at ~£100.
            </li>
            <li>
              <strong>Cleanliness</strong> — single 1 µm dust particle on a connector causes signal
              loss. Clean with proper wipes (Sticklers CleanWipes, IBC Cleaning Tools); inspection
              scope (Fluke FI-3000, EXFO FIP-400B) verifies cleanliness.
            </li>
            <li>
              <strong>Breakage</strong> — broken fibre fragments are sharp and easily embedded in
              skin. Wear safety glasses + nitrile gloves; collect fragments in a designated waste
              container; never wipe surfaces by hand.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Then isolate.</li>
            <li>
              After work: restore supply, IT verifies system boot, confirms application
              availability.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Notify the alarm-receiving centre (ARC) — un-notified outage triggers fire brigade
              dispatch.
            </li>
            <li>
              Place fire watch in affected zone — designated person with extinguisher +
              alarm-raising means.
            </li>
            <li>Document in the fire log book — start, end, scope, responsible person.</li>
            <li>Carry out work; minimise outage window.</li>
            <li>
              On restoration: confirm panel returns to normal; inform ARC; close fire log entry.
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              On restoration: confirm normal operation; perform discharge test (BS 5266 3-hour);
              update log book.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Fluorescent ballasts, RF equipment, lifts, life-safety loads">
          <p>
            <strong>Fluorescent ballast capacitors</strong> — 1-minute wait after isolation, verify
            with meter (DC reading should be &lt;30 V), discharge through 5–10 kΩ resistor if still
            charged. Never short with screwdriver.
          </p>
          <p>
            <strong>RF equipment (induction heaters, RF welders)</strong> — field exposure (CEMFAW
            2016), pacemaker / implant warning, capacitor bank discharge wait per manufacturer
            manual.
          </p>
          <p>
            <strong>Lifts and escalators</strong> — LOLER 1998 / PUWER 1998 specialised plant; never
            intervene with electrics yourself; brief lift contractor before isolation.
          </p>
          <p>
            <strong>Life-safety loads (medical, mobility, oxygen)</strong> — identify in customer
            interview, brief clinical staff, agree alternative arrangements, minimise outage.
          </p>
          <p>
            <strong>UPS units</strong> — battery depletion during isolation, slow recharge after;
            brief customer on recharge timeline.
          </p>
          <p>
            <strong>Smart meters</strong> — re-handshake takes 5–15 minutes; brief customer;
            supplier call if it doesn't reconnect.
          </p>
          <p>
            <strong>CCTV / access control / intruder alarm</strong> — brief security contact; ARC
            notification 24 hours in advance.
          </p>
          <p>
            <strong>Refrigeration affecting food safety</strong> — brief food business operator;
            arrange backup; document under Food Safety Act 1990.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Specialised systems amplify the &ldquo;damage to installed equipment&rdquo; side of
              641.4. Hard power-off of an IT cabinet, an unannounced fire-alarm isolation or a
              500&nbsp;V IR test through a connected dimmer module each breach 641.4 in the same way
              &mdash; precautions weren&apos;t taken to protect equipment. The Regulation makes
              equipment damage just as much a duty failure as personal injury.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Specialised systems &mdash; fire panels, smart-meter HAN modules, BMS controllers,
              DALI lighting drivers, EV chargers, PV inverters &mdash; are exactly the
              &ldquo;equipment likely to influence the verification test or be damaged&rdquo; that
              A4:2026 has in mind. Drop the IR test voltage to 250&nbsp;V DC, leave the equipment
              connected, and you&apos;ll get a verification reading without the cost of a
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice isolates a small section of the fire alarm system at a hotel to investigate
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Class 1M</strong> — eye-safe at normal viewing distance but unsafe with
              optical aids (microscope). Most building network fibre is Class 1M.
            </li>
            <li>
              <strong>Class 3R</strong> — direct eye exposure can cause damage. WDM systems and
              longer-distance backbone fibre.
            </li>
            <li>
              <strong>Detection</strong> — Norman F8 fibre detector or Fluke FT535 photonic test set
              show whether a fibre is energised. Hold detector to fibre end; energised fibre lights
              the indicator.
            </li>
            <li>
              <strong>Don't trust labels</strong> — fibre labelling is often missing or wrong.
              Always test with the detector before handling.
            </li>
            <li>
              <strong>Cleaning</strong> — fibre ends accumulate dust that can scatter light
              dangerously. Clean with manufacturer's lint-free swabs and isopropyl alcohol; never
              with a tissue.
            </li>
            <li>
              <strong>Visible-light inspection</strong> — use a fibre microscope (200×) to inspect
              cleaved fibre ends. Visual assessment of cleave quality is part of the splicing
              competence.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PFC capacitors</strong> — typically 4-8 µF on T8 fluorescent ballasts; 30-100
              µF on HID. Hold lethal charge for several minutes after isolation.
            </li>
            <li>
              <strong>Discharge routine</strong> — 5-10 kΩ resistor with insulated leads; touch one
              end to each capacitor terminal for 10 seconds. Verify discharged with multimeter.
            </li>
            <li>
              <strong>Magnetic ballast hot</strong> — older magnetic ballasts run hot in service.
              Allow 15+ minutes to cool before handling.
            </li>
            <li>
              <strong>HID startup voltage</strong> — sodium and metal halide ballasts produce 1-5 kV
              pulse during ignition. Don't probe live circuits.
            </li>
            <li>
              <strong>PCB-containing ballasts</strong> — pre-1986 ballasts often contain PCBs.
              Hazardous waste; dispose through licensed contractor (Veolia, Suez, etc.).
            </li>
            <li>
              <strong>LED retrofit</strong> — most fluorescent fittings can be retrofitted to LED
              tubes (Aurora T8 LED, Osram SubstiTUBE) but the ballast / starter must be bypassed.
              Some retrofits keep ballast in circuit; check tube specification.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>ARC notification</strong> — customer's responsible person calls before
              isolation. Provide expected duration and contact details.
            </li>
            <li>
              <strong>Fire watch</strong> — for prolonged isolation (&gt;30 minutes), insurer or
              RRFSO often requires a person stationed to manually call 999 if a fire occurs.
            </li>
            <li>
              <strong>Panel manufacturers</strong> — Apollo, C-Tec, Advanced, Kentec, Honeywell
              Morley, Hochiki. Each has documented isolation procedures in the panel manual.
            </li>
            <li>
              <strong>Battery backup</strong> — fire alarm panels have integral 24-72 hour battery
              backup. Mains isolation alone doesn't disable the system; the battery isolator inside
              the panel must also be opened for full isolation.
            </li>
            <li>
              <strong>Causes for alarm work</strong> — most common: faulty smoke detector (replace),
              zone fault (locate cable damage), low battery (replace), addressable loop fault (cable
              break or short).
            </li>
            <li>
              <strong>Re-commissioning</strong> — after work, system must be tested per BS 5839-1.
              Walk-test of detectors, sounder test, panel functional test, all documented in the
              fire alarm log book.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Test cycle</strong> — monthly: 30-second functional. Annual: 1-hour discharge.
              Triennial: full 3-hour discharge to confirm battery capacity.
            </li>
            <li>
              <strong>Self-test units</strong> — automatic test cycle, status LED visible. Failure
              indicators differ by manufacturer (steady red, flashing red).
            </li>
            <li>
              <strong>Central battery</strong> — large battery cabinet (often 24 V or 110 V DC)
              feeds multiple light fittings via dedicated FP200 cable. Replace cells every 5-10
              years per manufacturer's spec.
            </li>
            <li>
              <strong>Battery types</strong> — sealed lead acid (older), Ni-Cd (industry standard),
              Li-ion (newer; longer life). Replace per manufacturer; don't mix types.
            </li>
            <li>
              <strong>Common failures</strong> — battery end-of-life (most common after 4-7 years);
              LED driver failure; bypass connection broken (battery sees charge but lamp doesn't see
              battery during failure).
            </li>
            <li>
              <strong>Documentation</strong> — EM lighting log book records every test, every
              failure, every replacement. Audit trail for fire safety inspections under RRFSO 2005.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module4-section3-4')}
