...
const TITLE = 'RCD and AFDD nuisance trips (3.4) | Level 3 Module 4.3.4 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      "What's the difference between Type AC, Type A, Type F and Type B RCDs and which goes where?",
    options: [
  ...
  },
  {
    id: 3,
    question:
      'Why does the 30 mA RCD threshold cause more nuisance trips on modern installations than on older ones?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      "What's the operational difference between a 'split-load' (dual-RCD) CU and an 'all-RCBO' CU?",
    options: [
  ...
  },
  {
    id: 5,
    question:
      "What's the difference between a Type AC RCD and a Type A RCD trip-time-test wise on the MFT?",
    options: [
  ...
  },
  {
    id: 6,
    question:
      "BS 7671 A4:2026 reinforced AFDD requirements. What's the current requirement for AFDD on dwelling installations?",
    options: [
  ...
  },
  {
    id: 7,
    question:
      "An AFDD won't latch on after a trip — keeps tripping the moment you press the toggle. What's likely wrong?",
    options: [
...
const faqs = [
  ...
  {
    question:
      'Can I just upgrade the RCD to a higher rating (100 mA instead of 30 mA) to stop nuisance trips?',
    answer:
  ...
  {
    question:
      "What's the practical workflow for diagnosing an RCD nuisance trip on a modern domestic installation?",
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The practical diagnosis of RCD nuisance trips (cumulative leakage, weather, appliance
          failure) and AFDD nuisance trips (electronics false trigger, switching transients) — clamp
          meter method, differential isolation, AFDD test functions, A4:2026 layer.
        </p>
        ...
        >
          ...
          <p>
            On a modern kitchen circuit with 12 LED downlighters + dishwasher + washing machine +
            microwave + kettle + toaster: total cumulative leakage easily reaches 12–20 mA at idle.
            Add a partial fault (degraded heater element on washer) and you cross 30 mA.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              "In AC systems, additional protection by means of an RCD with a rated residual
              operating current not exceeding 30 mA shall be provided for socket-outlets with a
              rated current not exceeding 32 A in locations specified by Section 411.3.3."
            </>
          }
          meaning={
            <>
              The 30 mA RCD requirement on socket-outlets is the safety-case driver for the trip
              threshold. A4:2026 strengthened this with broader application across socket-outlets
              and mobile equipment, and reinforced AFDD requirements (Reg 421.1.7).
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Energise the RCD</strong> with all appliances disconnected on the protected
              circuits.
            </li>
            <li>
              <strong>2. Clamp meter L+N together</strong> at the RCD output — note baseline leakage
              (1–3 mA on healthy installation).
            </li>
            <li>
              <strong>3. Connect appliances ONE AT A TIME</strong>, watching the clamp reading.
            </li>
            <li>
              <strong>4. The appliance whose connection causes a sudden jump</strong> (e.g. baseline
              2 mA → 18 mA on connecting the dishwasher) is the leaky one.
            </li>
            <li>
              <strong>5. For confirmation</strong>, disconnect that appliance only — leakage drops
              back.
            </li>
            <li>
              <strong>6. For appliances with intermittent leakage</strong> (e.g. heater fails on
              heat cycle only), trigger the operating mode and watch for the leakage rise.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type AC</strong> — detects AC residual only. Obsolete for most new
              installations under A2:2022.
            </li>
            <li>
              <strong>Type A</strong> — detects AC + pulsating DC. Current default for general use.
            </li>
            <li>
              <strong>Type F</strong> — detects AC + pulsating DC + composite multi-frequency.
              Required for VFDs, Class 1 PCs / servers.
            </li>
            <li>
              <strong>Type B</strong> — detects all of the above + smooth DC. Required for EV
              chargers (BS 7671 722.531), some PV inverters, three-phase rectifier loads.
            </li>
            <li>
              <strong>S-type (selective)</strong> — built-in delay (100–300 ms) for upstream
              selectivity above 30 mA downstream RCDs. Used at TT main switch, upstream of EV
              chargers.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Poorly-terminated accessories on the affected circuit (HRJ in early stages of arcing).
            </li>
            <li>
              Faulty appliance with internal arcing (failing motor brushes, wear on relay contacts).
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Switching power supplies with high-frequency content (cheap phone chargers, laptop
              PSUs).
            </li>
          ...
          <p>
            Brand notes: Hager AFB, Schneider Vigi+AF, Eaton AFDD — improving discrimination with
            each generation. A4:2026 mandates AFDD on certain dwelling final circuits (Reg 421.1.7)
            — bedrooms in HMOs, care homes, short-term accommodation, plus some
            combustible-construction buildings.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              "It is now a requirement to protect final circuits supplying socket-outlets with a
              rated current not exceeding 32 A using arc fault detection devices (AFDD) in Higher
              Risk Residential Buildings, Houses in Multiple Occupation, Purpose-built student
              accommodation and Care homes. For all other premises, the regulation recommends AFDDs
          ...
          meaning={
            <>
              ...
              recommended-elsewhere. When you&apos;re diagnosing an AFDD nuisance trip on, say, a
              private dwelling, you can&apos;t simply remove the AFDD and revert to a normal RCBO
              &mdash; that loses functionality the customer paid for, and on a mandatory-category
              property it would be a Code 2 non-compliance.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              current (IΔn) is used to verify the effectiveness of the RCD."
            </>
          }
          meaning={
            <>
              When an RCD is nuisance-tripping but appears to operate at I&Delta;n on the MFT, that
              single AC test at rated I&Delta;n is now the only required verification
              (5&times;I&Delta;n is gone in A4:2026). If the device passes the AC test but trips
              intermittently in service, the diagnosis points to cumulative leakage on the load
              side, not a faulty RCD.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice arrives at a 'RCD trips occasionally' job. Tests the RCD — trip-time fine,
              MFT measurement OK. Replaces it anyway because they don't know how to find the cause.
              Customer pays for new RCD; problem persists; firm gets called back; bad reputation.
              Real cause was a failing dishwasher heater element (1.8 mA leakage on heat cycle) — a
              30-second clamp meter measurement would have spotted it.
            </>
          }
          doInstead={
            <>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              EV chargers MUST have Type B RCD OR Type A RCD + dedicated 6 mA DC RCM in the charger
              (most modern EVSEs include the 6 mA RCM by design — Zappi, Ohme, Pod Point, Tesla).
              Verify the EVSE specification AND the upstream RCD type at install. BS 7671 722.531 is
              explicit about this.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              (1) Customer interview — when does it trip? Customer recalls: usually around 7–8pm in
              the evening, sometimes when the dishwasher is running, sometimes when the washing
              ...
              the long-term solution; quote and document.
            </>
          }
          whyItMatters={
            <>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Baseline reading</strong> — all loads off, all appliances unplugged. Clamp
              reads close to 0 mA. This is your zero baseline.
            </li>
            <li>
              <strong>Plug-back sequence</strong> — one appliance at a time. Wait 30-60 seconds for
              inrush to settle. Read clamp.
            </li>
            <li>
              <strong>Cumulative chart</strong> — note each appliance's leakage contribution. Some
              appliances (electronic SMPS loads) leak 1-3 mA continuously; some (kettle, immersion)
              leak only when running.
            </li>
            <li>
              <strong>Test under load</strong> — for cycling loads (washing machine, dishwasher),
              test through their cycle. Leakage often peaks during heating phase.
            </li>
            <li>
              <strong>Faulty appliance</strong> — single appliance leaking &gt;5 mA = faulty
              (typically heating element insulation breakdown, water ingress in motor, failed
              Y-class capacitor).
            </li>
            <li>
              <strong>Cumulative breach</strong> — total leakage from healthy loads exceeding 30 mA
              = circuit design problem (too many loads on one RCD). Solution: split circuit, upgrade
              to all-RCBO CU.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>What AFDD detects</strong> — high-frequency signatures (kHz range)
              characteristic of arcing. Not the steady-state current of a normal load.
            </li>
            <li>
              <strong>Series arc</strong> — loose terminal arcing while current flows. Most common
              cause of electrical fires in residential. AFDD catches before fire develops.
            </li>
            <li>
              <strong>Parallel arc</strong> — L-N or L-E arcing through degraded insulation. Can
              also trip MCB (overcurrent) or RCD (residual current) but AFDD catches earlier.
            </li>
            <li>
              <strong>What AFDD doesn't detect</strong> — slow degradation that hasn't yet started
              arcing; non-arcing thermal damage (HRJ generating heat without yet producing
              detectable arc).
            </li>
            <li>
              <strong>Test sequence</strong> — press the test button; AFDD should trip within ~1
              second; trip indicator (often a different colour from the standard trip indicator)
              shows AFDD function operated. Reset is normal MCB-style.
            </li>
            <li>
              <strong>BS EN 62606</strong> — the AFDD product standard. Defines test signatures and
              trip times. Type 1 is series arc only; Type 2 covers series and parallel.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Common nuisance triggers</strong> — old fluorescent ballasts (replace with LED
              retrofits), incompatible LED dimmers (use Click Mode or Aurora compatible products),
              cheap LED downlight drivers (Aurora Enlite, Collingwood, JCC Hyperion are
              AFDD-compatible), switch-mode appliances (older PCs, induction hobs).
            </li>
            <li>
              <strong>Pattern check</strong> — does it trip at the same load configuration each
              time? If yes, source identified by elimination.
            </li>
            <li>
              <strong>Voltage event correlation</strong> — Fluke 1730 PQ analyser can correlate
              trips with voltage events; if external transients are triggering, install Type 2 SPD
              upstream.
            </li>
            <li>
              <strong>AFDD type</strong> — check device datasheet. Some have higher rejection of
              common nuisance signatures (e.g. Hager AFDD-RCBO has improved rejection for dimmers vs
              older designs).
            </li>
            <li>
              <strong>Documentation</strong> — log each trip event for the customer; build pattern;
              recommend specific load replacements with quote.
            </li>
            <li>
              <strong>Don't bypass the AFDD</strong> — if AFDD is required by BS 7671 for the
              location, bypassing it (e.g. fitting a non-AFDD RCBO instead) is a code C2 finding on
              next EICR. Investigate and resolve, don't bypass.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type AC</strong> — sinusoidal AC residual only. Resistive heaters, simple
              incandescent / halogen circuits. Increasingly rare on modern installations.
            </li>
            <li>
              <strong>Type A</strong> — sinusoidal AC + pulsating DC. Modern domestic standard.
              Catches LED drivers, switch-mode power supplies, single-phase VSDs.
            </li>
            <li>
              <strong>Type F</strong> — Type A + high-frequency components. Used on certain VSD
              applications and inverter-fed loads.
            </li>
            <li>
              <strong>Type B</strong> — Type A + smooth DC. Required for EV chargers (BS 7671
              722.531.3.101), many three-phase VSDs, certain solar PV / battery storage inverters
              with DC-side faults.
            </li>
            <li>
              <strong>Identifying installed RCDs</strong> — type marked on front of device. Hager:
              Type AC has no symbol; Type A has half-sine + dotted line; Type B has all symbols.
              Schneider similar.
            </li>
            <li>
              <strong>Wrong-type symptom</strong> — Type AC on DC-injecting load: either silent
              failure (won't see fault) or nuisance trips when the DC component drives the RCD
              detection circuit into nonlinear region.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module4-section3-3')}
