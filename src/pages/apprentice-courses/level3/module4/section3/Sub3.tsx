...
const TITLE = 'Likely fault locations (3.3) | Level 3 Module 4.3.3 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question: "Where do faults typically appear in luminaires and what's the L3-relevant pattern?",
    options: [
