...
const TITLE = 'Implications of isolation (1.5) | Level 3 Module 4.1.5 | Elec-Mate';
const DESCRIPTION =
...
const faqs = [
  ...
  {
    question:
      "What if the customer says 'just turn it off, I don't care' — does that release me from the duty?",
    answer:
  ...
  {
    question:
      'Do I need to record the isolation time window on the certificate or the job sheet — and where does that live legally?',
    answer:
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 1 · Subsection 5"
        title="Implications of isolation"
        backTo="/study-centre/apprentice/level3-module4-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Isolation isn't a switch flip — it's a planned event with consequences for you, other
          operatives, the customer's business, the public in the building, and life-safety / IT /
          refrigeration / fire alarm / emergency lighting systems. The L3 pre-isolation
          continuity-planning discipline.
        </p>
        ...
        >
          <p>Run this five-stakeholder check before any isolation:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Self</strong> — your shock / arc / stored-energy risk after JIB six-step
              verification. The L2 lesson, still essential at L3.
            </li>
            <li>
              <strong>Other personnel</strong> — operatives elsewhere on the same building working
              on equipment your isolation feeds. Tell them, in writing if practical, before you
              start.
            </li>
            <li>
              <strong>Customer / client</strong> — the business is operating; tills, servers,
              refrigeration, production lines, telephone systems may depend on the supply you're
              about to drop.
            </li>
            <li>
              <strong>Public</strong> — escalators, lifts, automatic doors, ATMs, CCTV all stop when
              supply drops. Trapped lift passengers and blocked accessible exits are foreseeable.
            </li>
            <li>
              <strong>Building systems</strong> — fire alarm, emergency lighting, BMS, security,
              refrigeration, IT, HVAC have their own compliance frameworks (BS 5839, BS 5266, the
              Fire Safety Order, GDPR, LOLER, BS EN 50172).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Competence under Reg 16 covers the WHOLE planning skill, not just the technical
              knowledge of the meter. Foreseeing the consequences of isolation on the
              building&apos;s systems and the customer&apos;s business is part of competence;
              failing to plan is a Reg 16 issue regardless of whether anyone was hurt. An L3
              apprentice does this kind of planning under documented supervision &mdash; which is
              also what Reg 16 requires when the apprentice doesn&apos;t yet have the experience.
            </>
          }
        ...
        >
          <p>The standard categories the L3 apprentice scopes before isolating:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Refrigeration / freezers</strong> — Food Standards Agency safe-temperature
              windows: chilled 0–8 °C (warming above 8 °C for &gt;30 min triggers discard), frozen
              below −18 °C (warming above −15 °C for &gt;30–60 min triggers discard). Domestic
              fridges are slower; commercial cabinets warm faster because they&apos;re lit and
              customer-opened.
            </li>
            <li>
              <strong>Tills / EPOS / card terminals</strong> — uncommitted transactions in volatile
              memory; chargeable losses if dropped mid-payment.
            </li>
            <li>
              <strong>Servers / NAS / network switches</strong> — file-system corruption from
              uncontrolled power loss; controlled shutdown takes 5–15 min for small kit, longer for
              VM hosts.
            </li>
            <li>
              <strong>Production equipment</strong> — CNC, injection moulders, automated test rigs
              all scrap work-in-progress if mid-cycle power drops; some need re-homing of axes after
              re-power.
            </li>
            <li>
              <strong>Telephone / VoIP / alarm dialler</strong> — call-out alarms (intruder, lift
              entrapment, fridge over-temp) lose their notification path while supply is off.
            </li>
            <li>
              <strong>HVAC / BMS</strong> — the building management system holds setpoints in NV
              memory but logs lose continuity; large chillers may need a re-start cycle.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The fire-alarm + emergency-lighting isolation discipline:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Notify the responsible person</strong> in advance — they're the legal
              duty-holder under the Fire Safety Order. Without their authorisation you cannot
              isolate.
            </li>
            <li>
              <strong>Fire alarm to engineer test / isolated mode</strong> at the panel — logged at
              the panel and in the fire log book. Some panels send a test signal to the ARC (alarm
              receiving centre) — the ARC also needs to know.
            </li>
            <li>
              <strong>Fire watch in place</strong> for the duration — a competent person walks the
              building or watches a live CCTV feed of the protected area, with phone access to the
              fire service.
            </li>
            <li>
              <strong>Emergency lighting</strong> — maintained fittings stay lit on internal battery
              for 3 hours under BS 5266-1; recharge takes 24 hours after a full discharge. Plan the
              work to stay inside the 3-hour battery window OR coordinate supplementary cover with
              the responsible person.
            </li>
            <li>
              <strong>Restore + test</strong> — reinstate the panel from engineer mode, test that
              the alarm sounds, log the reinstate time. Emergency lights are visually checked for
              healthy status indication.
            </li>
            <li>
              <strong>Bin bags over smoke heads is NOT compliant</strong> — disturbed dust on
              removal triggers false alarms, the head is removed from the loop without the panel
              knowing, and the practice is rejected by BS 5839-1.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              "Before starting any work, even of a routine nature, you should always check that...
              arrangements are in place to deal with the loss of supply to vital systems and to
              safeguard others who may be affected by the work."
            </>
          }
          meaning={
            <>
              GS38 is normally cited for test instruments and probe design, but it also carries the
              planning duty &mdash; you check, before starting, that arrangements are in place to
              deal with the loss of supply. That sentence is the regulatory anchor for the
              &lsquo;coordinate with the building&rsquo;s responsible person&rsquo; obligation. The
              L3 apprentice doing fault diagnosis on a building with life-safety systems treats GS38
              as both an instrument standard AND a planning standard.
            </>
          }
        ...
        >
          <p>The IT-coordination steps:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Notify in advance</strong> — name the affected equipment (servers, NAS,
              network switches, telephone, CCTV recorder, building access control). Estimate the
              duration.
            </li>
            <li>
              <strong>Wait for IT to confirm safe-to-power-off</strong> — typical small NAS or
              single server: 5&ndash;15 minutes. Domain controller or VM host: longer, possibly
              hours.
            </li>
            <li>
              <strong>Isolate at the smallest scope</strong> that achieves the fault-diagnosis aim.
              Don&apos;t drop the comms-cabinet supply to fix a problem on a different sub-main if
              you can help it.
            </li>
            <li>
              <strong>On restore</strong>, let the IT side power up in dependency order &mdash;
              switches first, then routers / firewalls, then servers, then user devices. Don&apos;t
              expect everything to &lsquo;just come back&rsquo;.
            </li>
            <li>
              <strong>Document who you spoke to</strong>, when, and what they confirmed. The
              job-sheet entry is your defence if a system later turns out to be corrupted and the
              customer claims you caused it.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          BS 7671 514.10 — the warning notice that supports your isolation
        </ContentEyebrow>
        ...
        >
          <p>How the warning-notice scheme supports the five-stakeholder isolation plan:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 514.10 alternative-supply notice</strong> — at the consumer unit, the
              meter and the inverter / battery / generator. Wording typically 'Caution — this
              installation has more than one source of supply'. Identifies every isolation point.
            </li>
            <li>
              <strong>Reg 514.10.1 'voltage exceeding 230 V' notice</strong> — where voltage to
              earth exceeds 230 V at a point of access (some PV array DC strings, three-phase
              distribution boards). Required so anyone opening the enclosure sees the elevated
              voltage warning before live parts are accessible.
            </li>
            <li>
              <strong>Reg 514.13.1 'Safety Electrical Connection — Do Not Remove'</strong>— at every
              earthing conductor connection, every bonding conductor connection and the MET. Tells
              you the connection is safety-critical even if it looks redundant.
            </li>
            <li>
              <strong>Reg 514.11 isolation notice</strong> — at every point of isolation where the
              device is not adjacent to the equipment it controls. Tells the operative which circuit
              / equipment the isolator serves.
            </li>
            <li>
              <strong>Section 514 documentation chain</strong> — the warning notices on site mirror
              the SLD and schedules in the install pack. Notice missing on site or schedule mismatch
              with the SLD is a documentation defect that goes in the EICR observations.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Public-equipment categories to scope:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lifts (LOLER 1998 + BS EN 81)</strong> &mdash; lift contractor parks the car
              at ground floor before isolation; &lsquo;lift out of service&rsquo; notice; lift
              contractor on site or contactable. You don&apos;t isolate the lift on your own
              authority.
            </li>
            <li>
              <strong>Automatic doors / accessible doors (Equality Act 2010)</strong> &mdash;
              powered doors fail closed in most designs; wheelchair users and pushchair users cannot
              exit; building manager staffs the doors during the isolation.
            </li>
            <li>
              <strong>Escalators</strong> &mdash; isolated at the local control panel by the
              escalator service contractor before main supply isolation; barriered off for the
              duration; watcher on duty if the public is in the building.
            </li>
            <li>
              <strong>ATMs</strong> &mdash; bank notified in advance; queues redirected; security
              implications because cash dispensers in a powered-off state still hold the cassettes.
            </li>
            <li>
              <strong>CCTV / building access control</strong> &mdash; recording continuity breaks;
              access-control magnetic locks may fail safe (open) or fail secure (locked) depending
              on design; security manager makes the call on cover.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The lone-working framework:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Documented lone-working policy</strong> from your employer covering this
              category of work and authorising you to do it.
            </li>
            <li>
              <strong>Buddy / check-in</strong> &mdash; phone or app at 30&ndash;60 minute
              intervals; failure to check in triggers an escalation. Lone-worker apps with man-down
              accelerometer detection are standard on larger contractors.
            </li>
            <li>
              <strong>First-aid arrangements</strong> &mdash; HSE first-aid policy appropriate to
              the site; for lone working at a remote site, your phone &amp; the emergency services
              are your first-aider.
            </li>
            <li>
              <strong>Rescue / extraction plan</strong> &mdash; if you suffered a shock, who knows
              where you are, who has the keys, who comes? A site induction with an emergency contact
              name and number on the job sheet covers this.
            </li>
            <li>
              <strong>Authority limits</strong> &mdash; live work is a JIB Approved Electrician task
              with documented supervision arrangement; an apprentice does not lone-work live
              diagnosis.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Time isolation started + scope</strong> &mdash; what circuits, what equipment,
              signed.
            </li>
            <li>
              <strong>Customer notified + consented</strong> &mdash; who you spoke to, when, what
              they agreed to.
            </li>
            <li>
              <strong>Compensating measures in place</strong> &mdash; fire watch, IT shutdown
              completed, fridge stock moved, supervisor on site, etc.
            </li>
            <li>
              <strong>Time supply restored + circuits re-energised</strong> &mdash; signed.
            </li>
            <li>
              <strong>Confirmation of safe restoration</strong> &mdash; protective devices reset,
              customer&apos;s systems back up, post-work test completed.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Your isolation event IS a maintenance event in EAWR terms &mdash; you&apos;ve
              interacted with the system to keep it safe, you&apos;ve restored it, you&apos;ve
              tested it. The HSR25 / EAWR Reg 4(2) framework wants those records kept for the
              working life of the installation. The job sheet is the entry-level record; on a larger
              contract the firm&apos;s asset-management system holds the master copy. Either way,
              the contemporaneous note is the audit trail.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              provided in respect of the premises... are subject to a suitable system of maintenance
              and are maintained in an efficient state, in efficient working order and in good
              repair."
            </>
          }
          meaning={
            <>
              Article 17 puts the maintenance duty (which includes isolation and re-instatement of
              fire-alarm and emergency-lighting systems) on the &lsquo;responsible person&rsquo; for
              the premises &mdash; usually the owner, occupier or appointed M&amp;E manager. As the
              L3 electrician you support that duty by coordinating with the responsible person
              before isolation; you do not assume the duty yourself.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 134.1.1 is the &lsquo;good workmanship&rsquo; anchor BS 7671 inherits as a
              competence test. Restoration of supply after fault diagnosis is part of erection in
              the wider sense &mdash; it has to be done by a skilled person, with proper materials,
              and to the standard the regulation expects. A sloppy restoration that leaves a circuit
              live but tests not done, or a fire-alarm panel still in engineer mode after
              you&apos;ve left, is a Reg 134.1.1 failing.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              starts work. Twenty minutes later the manager comes back from the cash run to find the
              chest freezers warming, the tills offline, the card terminals offline, queues
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              office. There&apos;s a smoke head right where they need to be. They put a bin bag over
              the head with masking tape and crack on. Two hours in, they finish the work, pull the
              bag off, the trapped dust drifts down through the head, the alarm triggers, the
              building evacuates, the fire service attends, the building&apos;s responsible person
              reports it, the local fire authority writes to the contractor. BS 5839-1 breach
              because an unauthorised person isolated detection. Fire Safety Order issue because the
              responsible person was bypassed. Chargeable false-alarm callout from the fire service.
            </>
          }
          doInstead={
            <>
              Speak to the responsible person before any work. They put the relevant zone(s) into
              isolated / engineer-test mode at the panel (logged in the fire log book), they arrange
              a fire watch for the duration, you do the work, the system is reinstated and tested
              before you leave. Bin bags over heads are not BS 5839-compliant and never were &mdash;
              they&apos;re an old short-cut that only worked when no-one was watching.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              dead sub-main feeding the comms cabinet. The cabinet contains the firm&apos;s Synology
              NAS holding 3&nbsp;TB of client tax records, a network switch feeding 18 desks, an
              internal VoIP phone system, and the building&apos;s CCTV recorder. The customer wants
              the fault fixed before Monday. You&apos;ve isolated at the cut-out and proved dead at
              the sub-main &mdash; but not before the IT side has shut anything down. The NAS was
              mid-snapshot when the supply dropped.
            </>
          }
          whatToDo={
            <>
              ...
              data is corrupted, GDPR and the firm&apos;s professional-indemnity arrangements bring
              further obligations. Restore supply only when the IT side is ready to receive it;
              bring the cabinet up in dependency order (switch&nbsp;&rarr;&nbsp;NAS&nbsp;&rarr;
              &nbsp;phones&nbsp;&rarr;&nbsp;CCTV).
            </>
          }
          whyItMatters={
            <>
              ...
              uncoordinated isolation has consequences far beyond the electrical system &mdash; data
              corruption, lost client records, GDPR exposure, professional-indemnity claims. The L3
              apprentice phones the IT contact BEFORE isolating in any normal scenario; in an
              emergency dead-supply scenario where the supply is already lost, the apprentice phones
              IT as the first call AFTER making the system electrically safe and BEFORE starting
              diagnostic work. Knowing the order matters.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Section 2</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
