...
const TITLE = '5-Whys root cause + engineering decision (4.4) | Level 3 Module 4.4.4 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    question: "What's the 5-Whys discipline and how does it apply to electrical fault diagnosis?",
    options: [
  ...
  },
  {
    ...
    question: "What's the difference between a 'symptom-level fix' and a 'root-cause fix'?",
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      "Apply the 5-Whys to a customer reporting 'breaker keeps tripping when I plug in the kettle' and identify each level.",
    options: [
  ...
  },
  {
    id: 2,
    question:
      'What questions should you ask when assessing whether to repair or replace a faulty 25-year-old MCB?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      "What's the engineering response when you find a fault that suggests broader problems with the installation?",
    options: [
  ...
  },
  {
    id: 7,
    question:
      'When should an L3 apprentice escalate a diagnosis decision to the supervisor rather than make it themselves?',
    options: [
...
const faqs = [
  ...
  {
    question:
      "What if the root cause is something I can't fix (e.g. customer behaviour or original design)?",
    answer:
  ...
  {
    question:
      'How do I justify recommending a more expensive fix when the customer wants the cheap option?',
    answer:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/level3-module4-section4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The 5-Whys discipline applied to electrical faults — finding the ROOT cause (design /
          installation / maintenance failure) rather than just the visible symptom. Engineering
          decision-making for repair vs replace, redesign, escalation. Customer communication of
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Why 1:</strong> Why does the breaker trip? — Overload current exceeds magnetic
              threshold.
            </li>
            <li>
              <strong>Why 2:</strong> Why is current that high? — Existing load + kettle inrush
              exceeds breaker rating.
            </li>
            <li>
              <strong>Why 3:</strong> Why too much load? — Too many high-current appliances on the
              same circuit.
            </li>
            <li>
              <strong>Why 4:</strong> Why is the circuit inadequate? — Designed in 1995 for fewer /
              lower-rated appliances; modern kitchen has more.
            </li>
            <li>
              <strong>Why 5:</strong> Why no future-proofing? — No design margin standard at the
              time; original installer sized to immediate need.
            </li>
          </ul>
          <p>
            Root cause: undersized circuit for modern usage. Symptom-level fix (reset breaker,
            adjust load timing) doesn't address the root. Root-cause fix (upgrade circuit / add
            dedicated radial / rewire kitchen) prevents recurrence.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>COST</strong> — repair (parts + labour) vs replacement vs redesign. If repair
              &gt;60–70% of replacement, lean to replace.
            </li>
            <li>
              <strong>RELIABILITY</strong> — repaired vs new. New components rarely matched by
              repaired ones for long-term reliability.
            </li>
            <li>
              <strong>COMPLIANCE</strong> — replacement may be required to meet current standards
              (older accessories may not satisfy A4:2026).
            </li>
            <li>
              <strong>SCHEDULE</strong> — repair time + parts lead time vs replacement time + parts
              lead time.
            </li>
          </ul>
          <p>
            For non-obvious decisions, quote multiple options to the customer. Plain English + cost
            + safety implication of each. Customer makes the commercial call.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Add a dedicated circuit for high-load appliance instead of full kitchen rewire
              (compliant; cheaper).
            </li>
            <li>
              Replace one tripping RCBO instead of full all-RCBO CU upgrade (compliant; cheaper, but
              addresses only the immediate device).
            </li>
            <li>
              Patch a damaged cable section instead of replacing the full run (compliant if patch
              meets jointing requirements; cheaper).
            </li>
            <li>
              Use a Type A RCD where Type B is preferable but not required for the specific load
              (compliant; cheaper).
            </li>
          </ul>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Root cause is exactly the kind of underlying defect Reg 651.4 puts on you to record.
              When the 5-Whys turns up an undersized circuit, an unsuitable RCD type or a missing
              CPC, the report has to capture it &mdash; even if the customer hasn&apos;t authorised
              the fix yet. The record is what makes the firm&apos;s recommendation defensible later.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              "For an addition or alteration to an existing installation, it shall be verified that
              the addition or alteration complies with BS 7671 and does not impair the safety of the
              existing installation."
            </>
          }
          meaning={
            <>
              Engineering decisions on a fault repair are nearly always &ldquo;additions or
              alterations&rdquo; under Reg 641.5. The dual test is: the new bit complies AND the
              existing bit isn&apos;t made worse. A budget compromise that papers over a root-cause
              fault would arguably impair the existing installation&apos;s safety case &mdash;
              that&apos;s the regulation that says the &ldquo;just bung a Wago in&rdquo; option
              isn&apos;t available.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice replaces a melted socket. Doesn't ask why it melted. Six months later same
              socket melts again — the upstream cable has an HRJ that's progressively damaging the
              downstream socket. They replace the socket again. Cycle continues for years until the
              upstream HRJ ignites the cable inside the wall — fire damage, customer complaint,
              insurance dispute. The 5-Whys would have identified the root cause on visit 1 and the
              firm could have quoted the upstream rectification.
            </>
          }
          doInstead={
            <>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              526.1 demands suitable mechanical strength for the load).
            </>
          }
          doInstead={
            <>
              Engineering compromise must satisfy BS 7671. If the customer can't afford the right
              fix, the firm has options: (1) Decline the work (better than installing something
              unsafe). (2) Quote a smaller scope that still meets BS 7671 (e.g. dedicated radial for
              the high-load appliance, deferring the wider kitchen). (3) Escalate to senior to make
              the call. Below-spec compromise is not an option.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              (1) Document the root cause: undersized circuit for current load; symptoms will
              continue until addressed. (2) Quote three options to customer: (A) £0 — continue
              managing load timing; safe, no convenience improvement. (B) £550 — install dedicated
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>First why</strong> — immediate cause. Often a single faulty component (loose
              terminal, blown lamp).
            </li>
            <li>
              <strong>Second why</strong> — cause of the cause. Why did the terminal loosen?
              (Vibration, over-tightening, undersized conductor).
            </li>
            <li>
              <strong>Third why</strong> — design or installation issue. Why was the conductor
              undersized? (Calculation error, cost-cutting, change of use).
            </li>
            <li>
              <strong>Fourth why</strong> — process or system issue. Why was there a calculation
              error? (No design review, rushed work, untrained installer).
            </li>
            <li>
              <strong>Fifth why</strong> — root organisational issue. Why was there no design
              review? (Firm's process gap, training shortfall, customer pressure).
            </li>
            <li>
              <strong>Stop when</strong> — you reach an organisational, training or process root
              cause that requires action beyond the immediate fix.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Repair</strong> — typically chosen when the component is high-value (motor
              windings, switchgear), the fault is well-understood, and the repair brings as-new
              reliability.
            </li>
            <li>
              <strong>Replace</strong> — typically chosen when component cost is low (RCBO,
              accessory), labour cost dominates, and replacement gives compliance + reliability.
            </li>
            <li>
              <strong>Rewire local</strong> — for cable damage in inaccessible locations, often
              easier and more reliable to install a new cable parallel and disconnect the old.
            </li>
            <li>
              <strong>Compliance considerations</strong> — older accessories may not meet current BS
              7671. A repair preserves the non-compliant item; replacement upgrades to current
              standard.
            </li>
            <li>
              <strong>Customer preference</strong> — some customers want minimum cost (repair), some
              want maximum reliability (replace), some want minimum disruption (whatever is
              fastest).
            </li>
            <li>
              <strong>Document the decision</strong> — record the recommendation, the rationale, the
              customer's choice, on the job sheet.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Three options minimum</strong> — gives the customer a choice. Single option =
              take-it-or-leave-it.
            </li>
            <li>
              <strong>Cost transparency</strong> — quote inclusive of parts, labour, certificates,
              restoration of building fabric.
            </li>
            <li>
              <strong>Plain-English benefits</strong> — what each option does for the customer in
              their language.
            </li>
            <li>
              <strong>Plain-English risks</strong> — what each option doesn't address, what might
              happen if not done.
            </li>
            <li>
              <strong>Recommendation</strong> — which option do you recommend and why. Customer
              doesn't have to follow but appreciates the guidance.
            </li>
            <li>
              <strong>Document the conversation</strong> — written summary on the job sheet.
              Customer's choice recorded. Protects firm if customer later disputes.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design changes</strong> — new circuits, CU upgrades, three-phase work.
              Approved Electrician design.
            </li>
            <li>
              <strong>DNO interactions</strong> — open PEN, supply-side faults, service capacity
              changes. DNO directly, not apprentice.
            </li>
            <li>
              <strong>Certificate work</strong> — Minor Works Cert, EICR, EIC. Requires authorising
              signatory; apprentice can complete the test work but not sign the certificate.
            </li>
            <li>
              <strong>Customer disputes</strong> — when customer challenges the diagnosis or refuses
              safety advice. Escalate; don't argue on site.
            </li>
            <li>
              <strong>Out-of-scope discoveries</strong> — finding work that wasn't on the brief
              (e.g. unsafe installation discovered while diagnosing another fault). Escalate to
              discuss scope with customer.
            </li>
            <li>
              <strong>Commercial decisions</strong> — significant additional work, refunds,
              write-offs. Through supervisor and firm management.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Design failures vs installation failures vs maintenance failures
        </ContentEyebrow>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design failure</strong> — system specified wrong from the start. Fix is upsize
              / re-spec / split. Often discovered during fault analysis showing chronic overload,
              cumulative leakage, repeated nuisance trips.
            </li>
            <li>
              <strong>Installation failure</strong> — system installed wrong. Fix is re-termination,
              re-route, re-strap. Often discovered as HRJs, broken CPCs, misidentified circuits.
            </li>
            <li>
              <strong>Maintenance failure</strong> — system specified and installed correctly,
              degraded over time. Fix is replace component or update inspection regime. Often
              discovered as IR degradation, RCD slowing, accessory wear.
            </li>
            <li>
              <strong>Mixed root cause</strong> — many faults have multiple contributing causes.
              Document each; address as needed.
            </li>
            <li>
              <strong>Customer briefing</strong> — explain which category. Helps customer understand
              future risk and inspection priorities.
            </li>
            <li>
              <strong>Firm learning</strong> — design failures may need firm-wide review;
              installation failures may need training updates; maintenance failures may need
              contract reviews.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module4-section4-3')}
