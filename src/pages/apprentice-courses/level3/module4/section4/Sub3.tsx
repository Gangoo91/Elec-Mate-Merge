...
const TITLE = 'Analysing test results (4.3) | Level 3 Module 4.4.3 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question: "What's the action chain when a test result falls outside acceptable limits?",
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      "Compare the BS 7671 minimum IR for LV circuits with the typical reading on a healthy modern installation. What's the practical difference?",
    options: [
  ...
  },
  {
    id: 2,
    question:
      "What's the maximum Zs for a 32 A B-curve RCBO protecting a domestic ring final on 230 V?",
    options: [
  ...
  },
  {
    id: 3,
    question:
      'What does a continuity reading of 0.55 Ω on a 50 m run of 2.5 mm² ring final tell you?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'What does a Zs reading of 7.5 Ω on a domestic ring final protected by 32 A B-curve RCBO indicate?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      "When you find a Code 1 (Danger Present) fault, what's your immediate action sequence?",
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Turning raw readings into diagnostic conclusions — BS 7671 Appendix 3 / Table 41.3
          thresholds, the difference between pass (meets minimum) and healthy (matches expected),
          what unsatisfactory results mean, the action chain when readings fall outside expected.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>IR (insulation resistance)</strong> — pass: ≥ 1 MΩ. Healthy: 100+ MΩ. A
              reading of 2 MΩ passes but flags developing degradation.
            </li>
            <li>
              <strong>Zs (earth fault loop)</strong> — pass: within Table 41.3 maximum. Healthy:
              matches calculated expected from supply Ze + cable R1+R2. A reading 50% above expected
              (still within Table 41.3) suggests added impedance.
            </li>
            <li>
              <strong>RCD trip-time</strong> — pass: within Reg 643.7.3 maximum (300 ms at I∆n for
              general). Healthy: 10–30 ms. A reading of 250 ms passes but suggests RCD approaching
              end of life.
            </li>
            <li>
              <strong>R1+R2 / continuity</strong> — pass: any low reading. Healthy: matches
              calculated from cable mΩ/m. A reading 50% above expected suggests HRJ.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              "For protective devices listed in Table 41.3, the maximum measured earth fault loop
              impedance Zs values shown shall not be exceeded. The values are derived from the
              requirements of Reg 411.3.2 for disconnection times."
            </>
          }
          meaning={
            <>
              Table 41.3 values are the safety threshold. A measured Zs above the table value means
              the protective device cannot disconnect within BS 7671 643 time limits. The L3 fault
              investigator uses this AND the calculated expected value (from cable design) to assess
              the actual circuit health.
            </>
          }
        ...
        >
          <p>
            Calculation example for a 32 A B-curve RCBO ring final, 50 m total ring length, 2.5 mm²
            T+E:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Cable resistance per conductor: 7.41 mΩ/m at 70 °C (BS 7671 Appendix 4 Table A4.1).
            </li>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. VERIFY</strong> — repeat the test; check leads / instrument; verify with
              second instrument if available.
            </li>
            <li>
              <strong>2. IDENTIFY FAILURE MODE</strong> — what does the unsatisfactory reading
              indicate (insulation breakdown, HRJ, polarity, RCD slow trip)?
            </li>
            <li>
              <strong>3. MAKE SAFE</strong> — isolate affected circuit; label / signage; prevent
              re-energisation by others.
            </li>
            <li>
              <strong>4. DOCUMENT</strong> — record reading + verification + action + customer DCN
              if Code 1; informer customer in writing.
            </li>
            <li>
              <strong>5. RECTIFY OR ESCALATE</strong> — fix if within competence; escalate to
              supervisor / specialist if not.
            </li>
          </ul>
          <p>
            Code 1 (Danger Present) found mid-job is non-negotiable — make safe immediately even if
            outside the original call-out scope; customer permission is not required for safety
            action; customer brief on the action follows.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              "The verification shall include comparison of the results with relevant criteria to
              confirm that the requirements of BS 7671 have been met."
            </>
          }
          meaning={
            <>
              Pass / fail is a comparison of the result against criteria, not against your gut feel.
              The Regulation makes that comparison the verification step. A 1.8&nbsp;M&Omega; IR
              result on a 230&nbsp;V circuit passes the 1.0&nbsp;M&Omega; minimum &mdash; but the
              comparison only tells you that, not whether the circuit is healthy.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              A borderline reading is, by definition, &ldquo;deterioration&rdquo;. Reg 651.4 says it
              shall be recorded &mdash; not optional, not at the firm&apos;s discretion. That&apos;s
              the regulation that backs your &ldquo;passes minimum but flag for investigation&rdquo;
              entry on the job sheet.
            </>
          }
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>&gt;999 MΩ</strong> — healthy. New or well-maintained installation in dry
              conditions.
            </li>
            <li>
              <strong>100-999 MΩ</strong> — healthy. Normal range for installation 5-15 years old in
              normal conditions.
            </li>
            <li>
              <strong>10-100 MΩ</strong> — degraded but compliant. Investigate cause (moisture,
              ageing, contamination); document; recommend monitoring.
            </li>
            <li>
              <strong>1-10 MΩ</strong> — borderline. Compliant but close to limit. Recommend further
              investigation; flag in customer report.
            </li>
            <li>
              <strong>0.5-1 MΩ</strong> — fail. Code C2 on EICR. Investigate and rectify.
            </li>
            <li>
              <strong>&lt;0.5 MΩ</strong> — significant insulation failure. Often direct earth fault
              or short. Locate and rectify before re-energising.
            </li>
            <li>
              <strong>Test voltage</strong> — 500 V for circuits ≤500 V nominal; 250 V for
              SELV/PELV; 1000 V for circuits 500-1000 V (SWA, motor windings).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Expected R1+R2</strong> — depends on cable size, length, material.
              Resistance-per-metre tables are in the On-Site Guide.
            </li>
            <li>
              <strong>Measured = expected</strong> — circuit is healthy.
            </li>
            <li>
              <strong>Measured significantly higher</strong> — HRJ somewhere on the loop. Halve and
              retest to localise.
            </li>
            <li>
              <strong>Measured OPEN</strong> — broken conductor (CPC or line) somewhere on the loop.
              Walk the run to find break.
            </li>
            <li>
              <strong>Measured very low (near zero)</strong> — short circuit between line and CPC.
              Insulation failure; investigate.
            </li>
            <li>
              <strong>Wander lead method</strong> — Megger WL10 / WL20 wander lead extends the test
              to long radial circuits. Test from origin with lead at far end.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Zs limits — common devices (BS 7671:2018+A4:2026 Table 41.3)</strong> — 6 A
              B-curve MCB: 7.28 Ω; 16 A B: 2.73 Ω; 32 A B: 1.37 Ω. C-curve approx half of B values.
              RCBO: same overcurrent values, plus 30 mA RCD function.
            </li>
            <li>
              <strong>0.4 s vs 5 s disconnection</strong> — final circuits ≤32 A: 0.4 s.
              Distribution / fixed equipment: 5 s. Lower disconnection time = lower Zs limit =
              tighter requirement.
            </li>
            <li>
              <strong>Temperature correction</strong> — standard 0.8 factor (multiply measured Zs by
              1.25) to correct field measurement to working temperature.
            </li>
            <li>
              <strong>Zs above limit</strong> — protective device won't operate within required
              time. Code C1 on EICR (immediate danger). Investigate and rectify.
            </li>
            <li>
              <strong>Zs equal to limit</strong> — no margin. Recommend reducing Zs (improve CPC,
              replace HRJ) or upgrading to lower-Zs protective device (RCBO with 30 mA RCD
              function).
            </li>
            <li>
              <strong>Zs well below limit</strong> — healthy. Document; no action.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>×½ trip</strong> — RCD over-sensitive (worn, contaminated, or faulty).
              Replace.
            </li>
            <li>
              <strong>×1 trip &gt;300 ms</strong> — RCD slow. May still pass on disconnection time
              (if Zs is low enough that overcurrent device clears fault first) but RCD is no longer
              reliable. Replace.
            </li>
            <li>
              <strong>×5 trip &gt;40 ms</strong> — RCD slow on high fault current. Replace.
            </li>
            <li>
              <strong>Ramp test &gt;30 mA</strong> — RCD undertested at rated trip current. Won't
              protect at intended threshold. Replace.
            </li>
            <li>
              <strong>No trip on test button</strong> — RCD mechanism failed. Replace immediately;
              do not try to reset by force.
            </li>
            <li>
              <strong>Type mismatch</strong> — Type AC RCD on circuit feeding LED drivers / EV
              charger / VSD = wrong type. Upgrade to Type A or Type B as appropriate.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>IR pass, Zs fail</strong> — insulation is fine but earth fault loop is high.
              Suggests broken or high-resistance CPC, not insulation.
            </li>
            <li>
              <strong>IR fail, Zs pass</strong> — insulation degraded but loop is OK. Suggests
              parallel current path bridging the broken insulation.
            </li>
            <li>
              <strong>Continuity OK, thermal hot</strong> — circuit conducts but generates heat
              under load. HRJ or chronic overload; thermal camera localises.
            </li>
            <li>
              <strong>Live readings vary</strong> — supply quality issue or intermittent load. PQ
              analyser deployment.
            </li>
            <li>
              <strong>Result drift over time</strong> — instrument calibration drift OR system
              condition deteriorating. Re-prove instrument; if instrument OK, system is changing.
            </li>
          </ul>
        </ConceptBlock>
