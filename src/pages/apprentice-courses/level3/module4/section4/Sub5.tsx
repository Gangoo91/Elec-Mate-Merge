...
const checks = [
  ...
  },
  {
    ...
    options: [
      "No certificate needed for repairs.",
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      "Random.",
      "No tests needed for a switch swap.",
    ],
    correctAnswer: 1,
    explanation:
