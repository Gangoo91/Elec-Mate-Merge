...
const TITLE = 'Identifying supply + test procedure (4.2) | Level 3 Module 4.4.2 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    id: 8,
    question:
      "What's the L3 apprentice's role when supply identification reveals an unusual or unexpected arrangement (e.g. TT in a built-up area, or three-phase supply you weren't expecting)?",
    options: [
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              and certain other installation types. The L3 fault investigator on a TN-C-S
        ...
        >
          ...
          <p>
            ...
            Type B RCD at the EV charger form the layered protection. The L3 apprentice's role is
        ...
        <Scenario
          ...
          whyItMatters={
            <>
              ...
              knowing to escalate to the DNO is the L3 step-up. Continuing customer-side
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module4-section4-1')}
