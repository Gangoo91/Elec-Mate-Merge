...
const TITLE = 'Logical stages of fault diagnosis (4.1) | Level 3 Module 4.4.1 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    question: 'What are the seven logical stages of fault diagnosis used in industry?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      "How does the structured 7-stage approach differ from 'just looking around until something obvious shows up'?",
    options: [
  ...
  },
  {
    id: 5,
    question:
      'How do you decide which test to run first when you have multiple competing hypotheses?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      "What's the role of the 'visual inspection' in the logical stages, and what should you look for?",
    options: [
  ...
  },
  {
    id: 7,
    question:
      'What if the diagnosis takes longer than the time the customer is willing to pay for?',
    options: [
...
const faqs = [
  ...
  {
    question:
      "How do experienced electricians do this so quickly — they don't seem to follow stages?",
    answer:
  ...
  {
    question:
      "What if the customer thinks they know what's wrong and pressures me to just fix that?",
    answer:
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 4 · Subsection 1"
        title="Logical stages of fault diagnosis"
        backTo="/study-centre/apprentice/level3-module4-section4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The seven-stage fault diagnostic procedure — collect symptoms, formulate hypothesis, plan
          tests, execute tests, analyse results, formulate fix, execute fix. The discipline that
          turns diagnosis into a structured process rather than guesswork.
        </p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. COLLECT SYMPTOMS</strong> — customer interview (Sub 3.2 six-question
              framework) + structured visual inspection.
            </li>
            <li>
              <strong>2. FORMULATE HYPOTHESIS</strong> — what fault types match the symptoms? Narrow
              to 2–3 candidates with reasons.
            </li>
            <li>
              <strong>3. PLAN TESTS</strong> — which tests will distinguish the candidates? Order by
              safety (dead before live), discrimination (most-narrowing first), cost.
            </li>
            <li>
              <strong>4. EXECUTE TESTS</strong> — using the right instruments per Sub 2.x.
            </li>
            <li>
              <strong>5. ANALYSE RESULTS</strong> — do the readings confirm or refute each
              hypothesis? Update hypothesis if needed; loop back to stage 2.
            </li>
            <li>
              <strong>6. FORMULATE FIX</strong> — what action corrects the confirmed fault? Repair
              vs replace decision (Sub 5.1).
            </li>
            <li>
              <strong>7. EXECUTE FIX</strong> — make safe, repair / replace, verify with retest,
              document.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The framework endorses the systematic approach. The 'symptom → inspection → test →
              action' chain is the structural backbone of the seven-stage model. Premature action
              (skipping stages 2–5) is explicitly identified as a risk source.
            </>
          }
        ...
        >
          <p>
            ...
            types could produce this pattern?'. Narrow to 2–3 candidates with reasons. Each
            candidate predicts what the test results should look like. The next stage (plan tests)
            chooses tests that will distinguish the predictions.
          </p>
          <p>Example for a 'lights flicker when fridge cycles' symptom:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Hypothesis A:</strong> HRJ on the supply path to the lighting circuit.
              Predicted reading: voltage drop &gt;5% on lighting during fridge inrush; thermal
              hotspot at the HRJ location.
            </li>
            <li>
              <strong>Hypothesis B:</strong> Undersized supply tail. Predicted reading: voltage drop
              on entire installation during fridge inrush, not just lighting; no localised hotspot.
            </li>
            <li>
              <strong>Hypothesis C:</strong> Cheap LED lamps incompatible with circuit. Predicted
              reading: no voltage drop on multimeter; substituting a known-good lamp eliminates
              flicker.
            </li>
          </ul>
          <p>
            Each hypothesis predicts different test results; the tests that distinguish them go
            first.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Stage 1 (symptom collection) and stage 2 (hypothesis) are inspection work. Reg 642.1
              fixes the order: inspection comes first, normally with the part under inspection dead.
              Most failed diagnoses skip the inspection stage and dive into testing &mdash; the
              Regulation explicitly tells you not to.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The inspection in stage 1 is a structured three-part check &mdash; product standard
              compliance, correct selection / erection, and visible damage. That&apos;s the
              framework you carry into the customer&apos;s house. Skipping any of the three is how a
              fault gets missed at the inspection stage and only shows up when somebody comes back
              to a bigger fault later.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              single failing LED driver on one circuit — would have been identified in 10 minutes
              with a customer interview + targeted clamp meter test on that circuit.
            </>
          }
          doInstead={
            <>
              Always form a hypothesis before testing. Even a wrong first hypothesis is better than
              no hypothesis — it gives the testing direction. The discipline of asking 'what fault
              types could cause this symptom?' before opening any enclosure is the L3 step-up.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              apprentice was committed to the busbar hypothesis.
            </>
          }
          doInstead={
            <>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              when. They've tried replacing one of the bulbs without effect.
            </>
          }
          whatToDo={
            <>
              Stage 1 — collect symptoms. Customer interview reveals: flicker started 3 months ago,
              no building work, but they did add a smart hub for their lights about then. Visual:
              kitchen has 8 LED downlights on a Lutron dimmer connected to a smart hub. Stage 2 —
              hypothesis. Three candidates: (A) dimmer / smart hub incompatibility with the LED
          ...
          whyItMatters={
            <>
              The structured approach finds the root cause (driver-hub incompatibility) rather than
              the symptom (one bulb flicker). The fix is a one-time replacement; the customer's
              smart-hub investment is preserved. Without the structured approach, the apprentice
              might have replaced bulbs (no fix), replaced the hub (expensive, didn't fix), or
              replaced wiring (massive cost, didn't fix). The seven stages prevent the wrong fix.
            </>
          }
        />
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>WHAT exactly happens</strong> — translates customer-language to
              engineering-categories. 'Lights go funny' becomes 'flicker', 'dim brief', 'flash
              off-on', 'colour shift' — each maps to different fault hypotheses.
            </li>
            <li>
              <strong>WHEN did it start</strong> — gradual onset (HRJ developing, water ingress
              progressing) vs sudden (component failure, vermin damage, lightning event).
            </li>
            <li>
              <strong>WHERE in the property</strong> — single circuit (focus there), multiple
              circuits but one phase (phase issue), all circuits (supply issue), correlated with
              specific room (load issue).
            </li>
            <li>
              <strong>WHY do you think</strong> — customer's hypothesis. Often wrong but contains
              useful clues ('it started after the storm' = consider transient damage; 'it only
              happens when the kettle boils' = voltage drop / cumulative load).
            </li>
            <li>
              <strong>WHAT'S CHANGED</strong> — recent building work, new appliances, recent EICR /
              repair work, new neighbours' equipment. The change is often the cause.
            </li>
            <li>
              <strong>WHAT'S WORKED</strong> — previous fixes attempted, by whom, when. Avoids
              repeating dead-ends.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>List candidates</strong> — minimum 3, maximum 5. Each must be a plausible
              cause of the observed symptoms.
            </li>
            <li>
              <strong>Rank by prior</strong> — based on age of installation, customer info, recent
              changes, visual signs. Highest-prior candidate gets first test.
            </li>
            <li>
              <strong>Most-discriminating test</strong> — pick the test whose result divides the
              candidates fastest. Avoid tests where every candidate gives the same result.
            </li>
            <li>
              <strong>Update on result</strong> — Bayesian update: a positive result strongly
              supporting candidate A reduces probability of B, C, D. Re-rank after each test.
            </li>
            <li>
              <strong>Confirmation bias trap</strong> — don't only test what would CONFIRM your
              favourite candidate. Always include at least one test that would FALSIFY it.
            </li>
            <li>
              <strong>Document the reasoning</strong> — write down hypotheses and test plan before
              testing. Forces the discipline.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Test ranking</strong> — speed × discriminating-power. Fast and discriminating
              wins (e.g. clamp meter for cumulative leakage).
            </li>
            <li>
              <strong>Customer-impact factor</strong> — tests requiring isolation have customer
              impact; weigh against discriminating power.
            </li>
            <li>
              <strong>Equipment availability</strong> — thermal camera, PQ analyser, motor analyser
              may need booking from firm's tool store.
            </li>
            <li>
              <strong>Stop-criteria</strong> — define before testing what result means 'fault
              confirmed' vs 'continue investigation'. Prevents over-testing.
            </li>
            <li>
              <strong>Documentation plan</strong> — what readings to record, in what units, on what
              form. Job sheets / certificates.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The Reg 643 test ladder applied to fault diagnosis:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Visual inspection (Reg 642.2)</strong> — three-part check: BS / EN product
              compliance, correct selection and erection per manufacturer's instructions, no visible
              damage that impairs safety. Free, fast, discriminating.
            </li>
            <li>
              <strong>Continuity tests</strong> — CPC continuity end-to-end with a low-resistance
              ohmmeter; ring final continuity if the circuit is a ring. Catches broken CPCs and
              incomplete rings before any energisation.
            </li>
            <li>
              <strong>Insulation resistance (Reg 643.3)</strong> — 500 V on isolated wiring
              (electronics disconnected), 250 V on the same circuit with electronics reconnected.
              Two-stage test catches both wiring degradation and as-installed equipment leakage.
            </li>
            <li>
              <strong>Polarity</strong> — line and neutral correct at every point. Polarity errors
              are typically C2 on EICR.
            </li>
            <li>
              <strong>Earth fault loop impedance (Zs)</strong> — measured with a loop tester at the
              furthest point of each final circuit. Compared to Table 41.3 / 41.4 maximum for the
              protective device. The B32 max is 1.37 Ω in A4:2026.
            </li>
            <li>
              <strong>RCD operating time (Reg 643.7.3)</strong> — single AC test at 1×IΔn per the
              A4:2026 redraft. Operating time recorded against BS EN 61008 / 61009 limits. Drifted
              RCDs replaced regardless of other findings.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Result interpretation</strong> — read against expected (BS 7671 limits, design
              values, manufacturer specs). Document any out-of-range readings.
            </li>
            <li>
              <strong>Root cause vs symptom</strong> — confirm you've found the cause, not just an
              effect. Test by predicting what fixing the root cause will do.
            </li>
            <li>
              <strong>Repair vs replace</strong> — Sub 5.1 covers this in depth. Repair is usually
              cheaper; replace is usually more reliable; depends on age, accessibility, compliance.
            </li>
            <li>
              <strong>Compliance check</strong> — does the fix bring the installation up to current
              BS 7671? Or just restore to prior state? A4:2026 may force upgrades (AFDD, SPD, Type
              A/B RCD).
            </li>
            <li>
              <strong>Customer brief</strong> — explain the fault, the fix, the cost, the timeline.
              Get customer agreement before starting.
            </li>
            <li>
              <strong>Execution</strong> — isolation, work, retest, restore, document. Then the
              certification (Minor Works Cert for single-circuit, EICR if multi-circuit work was
              done).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module4-section4-2')}
