...
const TITLE = 'Restoring building fabric (5.3) | Level 3 Module 4.5.3 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question:
      "What's a 'make-good' standard for an electrician after rectifying a fault that involved chasing a wall?",
    options: [
  ...
  },
  {
    id: 2,
    question:
      "When chasing has been required to access a fault, what's the trade convention for cable depth and protection?",
    options: [
  ...
  },
  {
    id: 3,
    question:
      "What's the L3 apprentice's role when a fault rectification damages a customer's tiles?",
    options: [
  ...
  },
  {
    id: 4,
    question:
      "When you've cut into plasterboard to access a junction box, what's the right way to make-good?",
    options: [
  ...
  },
  {
    id: 7,
    question:
      "What's the right way to document building-fabric damage / restoration on the job sheet?",
    options: [
...
const faqs = [
  ...
  {
    question:
      'What if the customer wants me to do the full restoration to save them calling a plasterer?',
    answer:
  ...
  {
    question:
      'How do I handle damage to expensive finishes (marble worktops, hardwood floors, parquet)?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          When fault rectification has disturbed plaster / brick / tile / joist / ceiling / flooring
          — the L3 apprentice scope, the techniques, the customer brief on scope boundaries, and the
          trade coordination with plasterer / decorator / tiler / builder.
        </p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>MAKE-GOOD</strong> — close holes left by chasing / drilling, refit
              accessories, ensure no exposed cable / live parts, fire-stop penetrations. Always
              electrician's scope.
            </li>
            <li>
              <strong>BASIC PATCH</strong> — bond and skim small areas (1–2 m² internal), patch
              small plasterboard holes. Within scope at apprentice level under supervision; some
              firms include in standard quote.
            </li>
            <li>
              <strong>FULL RESTORATION</strong> — re-plaster larger areas, re-tile, re-paint,
              re-floor. Separate trade (plasterer, decorator, tiler).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              resistance prescribed for the respective element of building construction (if any)."
            </>
          }
          meaning={
            <>
              Reg 527.2 requires fire-stopping at any penetration of a fire-rated element. For
              domestic work — compartment walls (party walls between dwellings), floors between
              flats, fire-rated ceilings. For commercial — much broader. The intumescent sealing is
              the responsibility of the operative who created the penetration; the L3 apprentice
        ...
        >
          ...
          <p>
            Outside safe zones (≤ 50 mm depth) requires mechanical protection: steel conduit,
            capping / channel before plastering, OR RCD protection (30 mA on the supply).
          </p>
          <p>Cables &gt; 50 mm depth — no zone restriction (already protected by depth).</p>
          <p>
            Chase depth: no more than 1/3 of wall thickness on internal walls; no more than 1/6 on
            load-bearing external walls. Horizontal chases limited to about 1/4 of wall length.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Hilti CP 606 / CP 611A</strong> — intumescent sealant cartridge for cable
              penetrations through plasterboard / brick / block.
            </li>
            <li>
              <strong>Promat PROMASEAL</strong> — intumescent sealant range for various penetration
              sizes.
            </li>
            <li>
              <strong>Rockwool Firepro</strong> — fire-rated batts for larger penetrations and
              risers.
            </li>
            <li>
              <strong>Promat fire collars</strong> — for conduit / PVC pipe penetrations.
            </li>
            <li>
              <strong>FireFly intumescent</strong> — UK trade standard for general-purpose
              fire-stopping.
            </li>
          </ul>
          <p>
            Standard locations requiring fire-stopping: party walls between dwellings; compartment
            walls in HMOs / commercial; floors between flats; ducts and risers; protected escape
            stairwells. The fire rating of the seal must match the element rating (typically 60
            minutes for compartment walls).
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>WHO TO USE</strong> — recommend a plasterer / decorator / tiler if the
              customer needs one. Referrals are good business; the customer appreciates the help;
              the recommended trade may return the favour.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Photo before close-up</strong> &mdash; phone camera, route visible, reference
              object in frame for scale.
            </li>
            <li>
              <strong>Sketch on job sheet</strong> &mdash; rough plan, distances, depth, prescribed
              zone or 522.6.204 alternative used.
            </li>
            <li>
              <strong>Schedule of circuits update</strong> &mdash; if the repair changed circuit
              layout, update the CU schedule before you leave.
            </li>
            <li>
              <strong>Customer copy</strong> &mdash; give the customer the photo and sketch
              alongside the certificate. They keep them with the property file.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              When you re-route a cable during fault correction, it has to land in a prescribed zone
              OR be RCD-protected to 415.1.1 OR carry a 522.6.204-compliant covering. There is no
              &ldquo;buried straight across the middle of the wall and hoped for the best&rdquo;
              option in BS 7671.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The duty to leave wiring identifiable applies on every repair, not just first install.
              Updating the CU schedule, leaving a sketch, photographing the route &mdash;
              that&apos;s how you discharge 514.1.2 on a fault-correction visit.
            </>
          }
        ...
        >
          <p>Standard van make-good kit:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Filler</strong> — bonding plaster bag, multi-finish bag, ready-mix small tub,
              easy-fill tube.
            </li>
            <li>
              <strong>Plasterboard offcuts</strong> — 12.5 mm and 15 mm in manageable sizes; useful
              for cutting custom patches over old back boxes.
            </li>
            <li>
              <strong>Fire-stop sealant</strong> — Hilti CP 606 or equivalent intumescent acrylic;
              cartridge gun.
            </li>
            <li>
              <strong>Scrim tape and joint compound</strong> — for taping plasterboard joints flush.
            </li>
            <li>
              <strong>Touch-up paint</strong> — small tin of trade white emulsion plus a fine brush;
              covers patch repair after the filler has dried and been sanded.
            </li>
            <li>
              <strong>Tools</strong> — small trowel, sanding block, dust sheet, masking tape,
              measuring stick.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Standard pre-work photo set:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Wide of the work area</strong> — orientation shot.
            </li>
            <li>
              <strong>Wide of the consumer unit</strong> — board face plus surrounding wall.
            </li>
            <li>
              <strong>Close of any pre-existing damage</strong> — scuff, crack, stain, hole, paint
              mismatch.
            </li>
            <li>
              <strong>Floor / carpet condition</strong> — particularly if work involves drilling
              overhead or pulling cable through ceiling voids.
            </li>
            <li>
              <strong>Customer's adjacent items</strong> — anything breakable, valuable or
              specifically positioned by the customer.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common specialist-trade handover patterns:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Tiler</strong> — for tile removal, cutting, re-fit, grout match.
            </li>
            <li>
              <strong>Decorator</strong> — for wallpaper match, paint large-area finish, high-end
              finish work.
            </li>
            <li>
              <strong>Plasterer</strong> — for ornate cornice, ceiling rose, large-area skim coat,
              lime plaster on heritage properties.
            </li>
            <li>
              <strong>Carpet fitter</strong> — for carpet pulled back to access floorboards.
            </li>
            <li>
              <strong>Joiner</strong> — for skirting, architrave, door frame damage.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              Investigation reveals an HRJ in the bathroom lighting circuit at a hidden junction box
              behind the tiled wall. To access, you need to remove 2–3 tiles, chase the cable, fit
              the junction box, and restore.
            </>
          }
          whatToDo={
            <>
              ...
              junction box; fit / replace the junction box; restore cable; fire-stop the chase; bond
              and skim flush. (6) Hand back to customer with: tiles set aside; surface ready for
              tiler; junction box accessible; certificate documenting the work. (7) Recommend tiler
              contact details; customer arranges tile re-fit.
            </>
          }
          whyItMatters={
            <>
