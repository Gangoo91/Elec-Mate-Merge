...
const TITLE = 'Verification + functional testing (5.2) | Level 3 Module 4.5.2 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question: "What's 'functional testing' and how is it different from BS 7671 643 testing?",
    options: [
  ...
  },
  {
    ...
    question: "What's the standard customer hand-back at the end of a fault-rectification visit?",
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'What functional test verifies that an emergency lighting circuit is actually working?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'What documentation should accompany a fault-rectification visit on an EICR-coded installation?',
    options: [
...
const faqs = [
  {
    question:
      'Do I need to test the entire installation after a single-circuit fault rectification?',
    answer:
  ...
  {
    question:
      "What if the customer doesn't want to wait for the retest — they want me out the door?",
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The post-rectification verification — BS 7671 643 retest cycle on the affected circuit,
          functional testing on safety systems (emergency lighting, fire alarm, RCD), the structured
          customer hand-back demonstration, and the certification trail.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ring final</strong> — continuity R1+R2, ring continuity three-step, IR,
              polarity, EFLI, RCD trip-time.
            </li>
            <li>
              <strong>Radial final</strong> — continuity R1+R2, IR, polarity, EFLI, RCD trip-time.
            </li>
            <li>
              <strong>Lighting circuit</strong> — continuity R2, IR (250 V if electronic loads),
              polarity, EFLI, RCD trip-time.
            </li>
            <li>
              <strong>Sub-main</strong> — continuity R1+R2, IR, polarity, EFLI Zs at sub-DB.
            </li>
            <li>
              <strong>Supply origin</strong> — Ze, PSCC, polarity at cut-out.
            </li>
          </ul>
          <p>
            Document pre-rectification (failed) reading + post-rectification (corrected) reading
            with timestamps. The before/after pair is the proof.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              For fault rectification, the rectified work counts as an 'addition or alteration'
              under Reg 134.2.1; the post-work inspection and testing verify BS 7671 compliance. The
              minimum is the Chapter 64 tests applied to the affected circuit. The certification
              (MEIWC for the alteration) records the verification result.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Light switch</strong> — operates the correct light(s); no other lights
              affected.
            </li>
            <li>
              <strong>Dimmer</strong> — full range operation, no flicker, no overheat at full /
              minimum.
            </li>
            <li>
              <strong>Smoke alarm</strong> — test button activates sounder; LED indicators correct.
            </li>
            <li>
              <strong>Emergency lighting</strong> — partial discharge test (30–60 min); illumination
              throughout; switching at mains-fail simulation.
            </li>
            <li>
              <strong>Fire alarm</strong> — walk test of affected zone (specialist work, but L3
              supports).
            </li>
            <li>
              <strong>RCD</strong> — single AC operating-time test at rated 1×IΔn (Reg 643.8).
            </li>
            <li>
              <strong>Heating element / motor / pump</strong> — runs at expected current; no
              abnormal heating; correct rotation (3-phase).
            </li>
            <li>
              <strong>EV charger</strong> — handshake completes; charge cycle starts; current ramps
              as expected.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. DEMONSTRATE</strong> — show the customer that the original symptom is no
              longer present. 'Try plugging in your kettle — see, no trip.' 30 seconds; converts
              uncertainty to certainty.
            </li>
            <li>
              <strong>2. WALK THROUGH</strong> — what was found, what was fixed, what tests
              confirmed. Plain English, 2–3 minutes.
            </li>
            <li>
              <strong>3. PROVIDE DOCUMENTATION</strong> — job sheet copy, certificates (MEIWC +
              updated EICR if relevant), customer-friendly summary.
            </li>
            <li>
              <strong>4. EDUCATE ON PREVENTION</strong> — what behaviours / conditions might cause
              recurrence, what to watch for. The 60–80% of customer-behaviour faults this prevents.
            </li>
            <li>
              <strong>5. AGREE NEXT STEPS</strong> — any further work recommended, follow-up visit
              if needed, payment terms, contact for issues.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EIC</strong> &mdash; new circuit, replacement CU / DB, major alteration. Three
              signatures: design, construction, verification.
            </li>
            <li>
              <strong>MEIWC</strong> &mdash; addition or alteration to a single circuit that
              doesn&apos;t involve a new circuit or DB. One signature.
            </li>
            <li>
              <strong>EICR</strong> &mdash; if the visit was a periodic inspection rather than a
              fault job, the report is the EICR; the repair becomes a referenced supporting
              document.
            </li>
            <li>
              <strong>No formal certificate</strong> &mdash; like-for-like accessory swap, lamp
              change, fault diagnosis without alteration. Job sheet entry is enough but keep the
              photographic record.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>The repaired circuit</strong> &mdash; full continuity, IR, polarity, Zs /
              EFLI, RCD operation. The whole point of the retest.
            </li>
            <li>
              <strong>Adjacent circuits sharing the same DB / RCD group</strong> &mdash; functional
              check that nothing else has been disturbed during the repair.
            </li>
            <li>
              <strong>The CU as a whole</strong> &mdash; visual check that all breakers reset, RCD
              test button operates, no warmth or smell post-load.
            </li>
            <li>
              <strong>Skip</strong> &mdash; circuits genuinely unrelated to the repair scope (e.g.
              don&apos;t IR-test the upstairs lighting if the repair was a downstairs socket).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Safety-system retest items by system type:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Emergency lighting (BS 5266)</strong> — flash test (monthly), full duration
              test (six-monthly or annually depending on system class). Issue the EL completion
              certificate.
            </li>
            <li>
              <strong>Fire alarm (BS 5839-1)</strong> — silent and audible tests of the affected
              detector / zone, panel event log review, customer brief on disabling and re-enabling
              the system. Issue the FA completion certificate.
            </li>
            <li>
              <strong>Smoke and CO alarms (LD3 / BS 5839-6)</strong> — for domestic, test every
              alarm with the test button after work; cross-reference any dates printed on the alarm
              body.
            </li>
            <li>
              <strong>Bonding to extraneous-conductive parts</strong> — if gas, water or oil
              pipework was disturbed during the work, test continuity from the part to the MET and
              update the bonding record on the EIC.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>When a witness signature is appropriate or required:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>High-risk environment</strong> — hospitals, food production, hazardous-area
              locations under DSEAR, public-assembly premises.
            </li>
            <li>
              <strong>Commercial customer policy</strong> — large customers often require a
              witnessed test on every visit; the contract spec states it.
            </li>
            <li>
              <strong>Apprentice supervision sign-off</strong> — for apprentice-led tests where the
              supervising electrician signs the test and certifies the apprentice's work.
            </li>
            <li>
              <strong>Disputed prior work</strong> — where a previous contractor's work is in
              question; an independent witnessed test creates an unimpeachable record.
            </li>
            <li>
              <strong>Insurance-required testing</strong> — building insurer or product warranty
              conditions may require witnessed testing as evidence of the install standard.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Adjacent-circuit functional check items:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lighting in every room sharing the affected DB</strong>— switch on / off,
              dimmers respond, two-way circuits operate.
            </li>
            <li>
              <strong>Socket outlets in adjacent rooms</strong> — lamp test or trial-load to verify
              polarity and supply.
            </li>
            <li>
              <strong>Fixed appliances</strong> — boiler / heat pump fires up, immersion heats, EV
              charger handshake (if relevant).
            </li>
            <li>
              <strong>Smart controls</strong> — thermostats responsive, hub online, app reporting.
            </li>
            <li>
              <strong>Customer-reported items</strong> — the customer often mentions a 'while you're
              here' issue at the door; address or quote it on the way out.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Post-repair RCD verification is a single AC test at rated I&Delta;n in A4:2026 &mdash;
              the 5&times;I&Delta;n test is gone and Table 3A is deleted. One button press on the
              MFT: a general non-delay RCD must disconnect within 300 ms (a delay &apos;S&apos; type
              within 130&ndash;500 ms), and you have your verification.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The retest verifies both halves of Reg 641.5: the repaired bit complies with BS 7671
              AND the rest of the installation hasn&apos;t been made worse by the work. That second
              half is what the &ldquo;adjacent-circuit functional check&rdquo; is for &mdash;
              you&apos;re evidencing that nothing else has been disturbed.
            </>
          }
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Always retest after rectification. The retest is part of the job, not optional polish.
              EFLI Zs + continuity R1+R2 on the affected circuit is the minimum; full BS 7671 643
              sequence for non-trivial fixes. The 15-minute retest investment saves the 90-minute
              return visit when retest would have caught the issue.
            </>
          }
        />
        ...
        <Quiz
          title="Verification + functional testing — knowledge check"
          questions={quizQuestions}
        />

        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module4-section5-1')}
