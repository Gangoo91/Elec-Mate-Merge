...
const TITLE = 'Repair vs replace (5.1) | Level 3 Module 4.5.1 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question: "What does 'parts availability' mean for the repair decision and how do you check?",
    options: [
  ...
  },
  {
    ...
    question: 'How does manufacturer warranty affect the repair / replace decision?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 4,
    question:
      "Why might 'compliance' force a replacement even when repair is technically possible?",
    options: [
  ...
  },
  {
    id: 5,
    question:
      "What's the typical lead time for ordering specialised electrical components in the UK?",
    options: [
  ...
  },
  {
    id: 6,
    question:
      'How do environmental factors (humidity, temperature, dust, vibration) affect the repair / replace decision?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      "When is 'replace the entire system' the right answer rather than repair / replace individual components?",
    options: [
...
const faqs = [
  {
    question:
      'How do I know what a replacement RCBO costs vs the labour to repair the existing one?',
    answer:
  ...
  {
    question:
      "Are there manufacturer training programmes that improve my knowledge of what's repairable?",
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The practical decision framework for repair vs replace — cost (60–70% threshold), parts
          availability, reliability, compliance (A4:2026 layer), schedule, warranty / insurance.
          Brand-realism on what's typically repairable vs replacement-only.
        </p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. COST</strong> — repair vs replace (parts + labour). 60–70% threshold rule
              of thumb.
            </li>
            <li>
              <strong>2. PARTS AVAILABILITY</strong> — current production, local stock, lead time,
              discontinued items.
            </li>
            <li>
              <strong>3. RELIABILITY</strong> — repaired component long-term performance vs new
              component warranty + life.
            </li>
            <li>
              <strong>4. COMPLIANCE</strong> — replacement may be required to meet current standards
              (A4:2026, Building Regs).
            </li>
            <li>
              <strong>5. SCHEDULE</strong> — customer's downtime cost; emergency vs planned; lead
              time impact.
            </li>
            <li>
              <strong>6. WARRANTY / INSURANCE</strong> — in-warranty repair may be free; check
              before quoting paid work.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 132.16 means any alteration must verify the existing supports the altered work.
              For fault correction this often means: a repair that brings the installation back to
              its previous state may need additional alteration to also bring it to current
              standards. Engineering decision — repair to original state, or upgrade to current
              spec.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Individual MCBs / RCBOs within a CU (replacement of single device, not full CU).
            </li>
          </ul>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Firm:</strong> identifies which options are BS 7671 compliant. Refuses
              requests for non-compliant work.
            </li>
            <li>
              <strong>Customer:</strong> chooses between compliant options based on cost /
              convenience / preference.
            </li>
            <li>
              <strong>Joint:</strong> agreement on scope, cost, timeline, and any limitations of the
              chosen option.
            </li>
            <li>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Matched-brand replacement</strong> &mdash; Wylex Standard RCBOs do not fit a
              Hager Design 50 board; mixing brands inside a CU voids the manufacturer&apos;s
              type-test.
            </li>
            <li>
              <strong>Discontinued lines</strong> &mdash; many older accessories (Crabtree Capital,
              MEM Memera, MK Sentry early models) are out of production. Sourcing through CEF /
              Edmundson / specialist reclaim, or accept that the repair route closes and replacement
              is the only option.
            </li>
            <li>
              <strong>Lead-time tracking</strong> &mdash; commercial customers will accept a
              24&nbsp;h delay if you commit to a return slot; an open-ended &ldquo;we&apos;re
              waiting for parts&rdquo; loses the relationship.
            </li>
            <li>
              <strong>Reclaimed components</strong> &mdash; not used on safety-critical fault
              repairs. The temptation on a discontinued line is real; the BS 7671 case for using a
              second-hand RCBO is weak.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Job sheet entry</strong> &mdash; identified fault, root cause, options
              offered, customer choice, work completed, retest results.
            </li>
            <li>
              <strong>Advisory note</strong> &mdash; if the customer declined the recommended
              option, write it up, sign and counter-sign. Photo of signed advisory uploaded to the
              job record.
            </li>
            <li>
              <strong>Certificate / Minor Works</strong> &mdash; the formal record under Reg 644.4.
              Customer keeps a copy; the firm keeps a copy on the job record.
            </li>
            <li>
              <strong>Photographic evidence</strong> &mdash; before / during / after photos at the
              work point and at the CU. A well-photographed repair is the cheapest defence against a
              later complaint.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>TCO factors to surface in a customer conversation:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Recurrence likelihood</strong> — age of equipment, history of similar
              failures, manufacturer reliability data on the affected component family.
            </li>
            <li>
              <strong>Call-out cost</strong> — every future visit carries the firm's call-out fee
              plus labour minimum; that adds up.
            </li>
            <li>
              <strong>Downtime cost</strong> — for a domestic customer, no power on a winter evening
              is unwelcome; for a commercial customer, every hour of downtime has a measurable
              lost-revenue figure.
            </li>
            <li>
              <strong>Energy efficiency</strong> — older lighting, older heating controls, older
              motors all run at lower efficiency than modern equivalents; the upgrade can pay for
              itself in saved energy over its life.
            </li>
            <li>
              <strong>Insurance and conveyancing</strong> — a modern installation supports lower
              buildings insurance and easier conveyancing; the upgrade has resale value.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>EOL signs to watch for and what to do:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Manufacturer EOL announcement</strong> — published on the manufacturer's
              professional site; typically gives a year of continued spares support before stock
              dries up.
            </li>
            <li>
              <strong>Wholesaler back-order</strong> — if the trade counter cannot get a part within
              a week, that is the early warning of EOL; the manufacturer is winding the line down.
            </li>
            <li>
              <strong>Limited compatibility families</strong> — some CU lines will accept generic
              60898 MCBs; others have proprietary modules only. Check before quoting.
            </li>
            <li>
              <strong>Customer brief on EOL</strong> — explain plainly that future repairs may force
              a board upgrade; let the customer decide whether to pre-empt now or wait for the next
              failure.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Typical L3 van spares stock items:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>RCBOs</strong> — common ratings (6 A, 16 A, 20 A, 32 A B-curve) in the
              manufacturer families the firm services most (Wylex, Hager, Crabtree, BG).
            </li>
            <li>
              <strong>MCBs</strong> — same ratings, B and C curves, in the same manufacturer
              families.
            </li>
            <li>
              <strong>Common accessories</strong> — single and double sockets, light switches (1, 2
              and 3 gang), pendant lampholders, 13 A fused connection units.
            </li>
            <li>
              <strong>Cable</strong> — 1.5/1.0, 2.5/1.5, 4.0/1.5, 6.0/2.5 mm² T&E in 5 m offcuts;
              flex 0.75 mm² and 1.0 mm² for fittings.
            </li>
            <li>
              <strong>Bonding</strong> — 10 mm² and 16 mm² green-and-yellow, bonding clamps for gas
              and water meters.
            </li>
            <li>
              <strong>Low-volume or specialist parts</strong> — sourced same day from the trade
              counter; the L3 apprentice knows the local wholesaler's stock and opening hours.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Most fault repairs sit under Reg 641.5 because they alter the existing installation.
              The dual test &mdash; the new bit complies AND the existing safety case isn&apos;t
              worsened &mdash; frames the repair-vs-replace decision. A repair that puts the
              installation back to the state it failed in might leave the safety case impaired and
              trigger replacement instead.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The repair generates a certificate &mdash; either an EIC for a new circuit or
              distribution board, or a Minor Electrical Installation Works Certificate (MEIWC) for
              circuit alterations. The Regulation makes certificate issue the responsibility of the
              person who did the work, not optional and not contingent on customer request.
            </>
          }
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Apply the six-factor framework. (1) Cost: replacement RCD ~£30 + 1 hr labour = £75
              total. Repair impossible (sealed device). (2) Parts: Wylex Standard RCDs still in
              production; available next-day. (3) Reliability: 25-year-old RCD failing the test;
              replacement gives full warranty + life. (4) Compliance: replacement RCD must satisfy
              current Type A requirement (existing may be Type AC under A2:2022 retrofit guidance);
              discuss with customer. (5) Schedule: same-day replacement available. (6) Warranty:
              existing RCD out of warranty (way past 5-year manufacturer warranty). Decision:
              replace the RCD AND consider broader CU upgrade given age. Quote two options to
              customer: (A) £75 replace single RCD — addresses immediate fault; CU still 25 years
              old; further failures likely soon. (B) £450 full CU replacement to all-RCBO Wylex NHX
              — addresses fault + future-proofs for next 25 years; upgrades to A4:2026 compliant
              configuration. Customer chooses A (budget constraint). Document recommendation B as
              advisory; customer signs acceptance of A. Complete the work; retest; document.
            </>
          }
          whyItMatters={
            <>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module4-section5-2')}
