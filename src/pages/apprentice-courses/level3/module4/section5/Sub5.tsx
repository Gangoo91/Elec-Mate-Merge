...
const TITLE = 'Reporting + handover documentation (5.4/5.5) | Level 3 Module 4.5.5 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question: "Domestic kitchen, you've replaced a failed RCBO. Is this notifiable under Part P?",
    options: [
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 5 · Subsection 5"
        title="Reporting + handover documentation"
        backTo="/study-centre/apprentice/level3-module4-section5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Closing the documentary trail — Minor Works Certificate, EIC, EICR + Schedule of Remedial
          Works, Building Control under Part P, customer warranty, A4:2026 form changes. The
          certificate is the firm's protection and the customer's proof; the L3 apprentice's job is
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EIC (Electrical Installation Certificate)</strong> — new installations, new
              circuits, significant additions. Three signature panels (Designer, Constructor,
              Inspector). Test panel for the new work.
            </li>
            <li>
              <strong>EICR (Electrical Installation Condition Report)</strong> — periodic inspection
              of an existing installation. Coded observations (C1, C2, C3, FI). Snapshot of
              condition, NOT a certificate of work done.
            </li>
            <li>
              <strong>MWC (Minor Works Certificate)</strong> — alterations or additions that do not
              constitute a new circuit. Replacement of accessories or protective devices, addition
              of a single point. Most rectifications.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              "644.1.1 For a new installation, any defect or omission revealed during the inspection
              and testing shall be corrected before the Certificate is issued. 651.4 Details of any
              damage, deterioration, defects or dangerous conditions shall be recorded in a report."
            </>
          }
          meaning={
            <>
              Reg 644.1.1 is the rectification duty &mdash; defects revealed during inspection and
              testing must be corrected before the Certificate is issued. Reg 651.4 is the reporting
              duty &mdash; damage, deterioration, defects or dangerous conditions get recorded in a
              report. Together they bracket the post-verification work: rectify what you can before
              issuing the cert; record what you can&apos;t (or what was outside scope) on the
              report. For minor works the MWC is the form; the test schedules accompany it. Without
              the certificate and any associated report, the verification under BS 7671 has not been
              documentarily closed.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>NEW CIRCUITS in dwellings</strong> — notifiable. Includes a new ring final,
              new lighting circuit, new shower circuit, new EV charger circuit.
            </li>
            <li>
              <strong>CONSUMER UNIT REPLACEMENTS</strong> — notifiable.
            </li>
            <li>
              <strong>SPECIAL LOCATIONS work</strong> — notifiable. Bathroom Zone 0/1/2, swimming
              pools, saunas, agricultural locations.
            </li>
            <li>
              <strong>LIKE-FOR-LIKE replacement</strong> of existing accessories or protective
              devices on existing circuits — NOT notifiable. Maintenance, not new work.
            </li>
            <li>
              <strong>ADDITIONS to existing circuits</strong> outside special locations — NOT
              normally notifiable (e.g. adding a single socket to an existing ring).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Original EICR reference</strong> — date, certificate number, inspector.
            </li>
            <li>
              <strong>Each coded item closed</strong> — the original observation, the action taken,
              the new test result.
            </li>
            <li>
              <strong>Date of rectification</strong> — for landlord work this also evidences
              compliance with the Private Rented Sector Regulations 2020 timeline.
            </li>
            <li>
              <strong>Contractor signature</strong> — Constructor or Inspector competence as
              appropriate.
            </li>
            <li>
              <strong>Cross-reference to the MWC / EIC</strong> for the rectification work itself.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              "A private landlord who grants or intends to grant a specified tenancy must — (a)
              ensure that the electrical safety standards are met during any period when the
              residential premises are occupied under a specified tenancy; (b) ensure every
              electrical installation in the residential premises is inspected and tested at regular
              intervals by a qualified person; AND (c) ensure the first inspection and testing is
              carried out before the tenancy commences, in relation to a new specified tenancy, OR
              by 1st April 2021, in relation to an existing specified tenancy."
            </>
          }
          meaning={
            <>
              Landlords must have an EICR every five years (or sooner if the previous EICR specified
              an earlier re-inspection date), and must rectify any C1, C2 or FI finding within 28
              days (or sooner if the report specifies). Failure carries a fine of up to
              &pound;30,000 per breach. The Schedule of Remedial Works + Minor Works Certificate is
              the landlord's proof of compliance and their defence against the fine. For an L3
              apprentice rectifying landlord work, documentary turnaround speed matters as much as
              physical rectification speed.
            </>
          }
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Continuity of conductors</strong> &mdash; R1+R2 or end-to-end ring values per
              circuit.
            </li>
            <li>
              <strong>Insulation resistance</strong> &mdash; L&ndash;L, L&ndash;N, L&ndash;E,
              N&ndash;E values per circuit; record the test voltage used (250&nbsp;V or 500&nbsp;V).
            </li>
            <li>
              <strong>Polarity</strong> &mdash; tick column, with note where polarity verification
              was by other means than direct test.
            </li>
            <li>
              <strong>Earth fault loop impedance</strong> &mdash; Zs per circuit, compared against
              the 80% Table 41.3 limit (32&nbsp;A B-curve = 1.37&nbsp;&Omega; on 230&nbsp;V under
              A4:2026).
            </li>
            <li>
              <strong>RCD operation</strong> &mdash; trip current and trip time at I&Delta;n, single
              AC test under A4:2026.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Job sheet</strong> &mdash; chronological narrative of what was found, what was
              done, who authorised what.
            </li>
            <li>
              <strong>Photographs</strong> &mdash; before / during / after at the work point and at
              the CU. Wide and close, time-stamped on the phone.
            </li>
            <li>
              <strong>Sketches</strong> &mdash; cable routes, depth-from-surface, identification of
              any 522.6.204 covering used.
            </li>
            <li>
              <strong>Customer correspondence</strong> &mdash; signed quote, signed advisory if a
              recommended option was declined, signed sign-off at handover.
            </li>
            <li>
              <strong>Manufacturer documentation</strong> &mdash; data sheets for replacement
              devices retained on the job record, particularly for AFDDs and DC-capable RCDs.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What the digital platform handles automatically:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Building Control notification</strong> — for notifiable Part P work, the
              scheme submits the BCCC (Building Control Compliance Certificate) on the customer's
              behalf within 30 days.
            </li>
            <li>
              <strong>Customer copy delivery</strong> — emailed PDF to the address on file. Customer
              can download replacements at any point.
            </li>
            <li>
              <strong>Property history</strong> — addresses with multiple certificates accumulate a
              property-level history that conveyancing solicitors and future inspectors can pull.
            </li>
            <li>
              <strong>Scheme assessor sample</strong> — the competent-person scheme assessor pulls a
              random sample of certificates each quarter for the firm's QA review.
            </li>
            <li>
              <strong>Certificate retrieval</strong> — replacement copies for lost paper
              certificates available on demand from the platform.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Verbal handover talking points after a rectification visit:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>What was found and what was done</strong> — plain English, no jargon. "The RCD
              on your kitchen ring had failed; I've fitted a new one and tested the circuit;
              everything's safe and working."
            </li>
            <li>
              <strong>Test results in plain terms</strong> — "the RCD trips in under 30 milliseconds
              at fault current; that's well within the BS 7671 limit."
            </li>
            <li>
              <strong>Test button demonstration</strong> — show how to press the test button; how
              often (quarterly is typical); what to do if it does not trip.
            </li>
            <li>
              <strong>Certificate delivery</strong> — "the certificate will arrive by email today;
              the paper copy posts within five working days if you wanted one."
            </li>
            <li>
              <strong>Aftercare contact</strong> — leave a card; explain when to call back (any odd
              behaviour, repeated trips, smell of burning).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The internal record items that often get missed:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Materials used</strong> — every device, every metre of cable, every fitting.
              Drives the invoice and the stock count.
            </li>
            <li>
              <strong>Time on site</strong> — start and finish stamped; drives the labour line on
              the invoice.
            </li>
            <li>
              <strong>Photos</strong> — before, during, after; goes onto the customer record and
              protects the firm if a question arises later.
            </li>
            <li>
              <strong>Out-of-scope findings</strong> — the dodgy lighting circuit you noticed but
              were not paid to fix; the missing bonding at the gas meter; the plastic CU; flagged
              for the office to follow up with the customer.
            </li>
            <li>
              <strong>Upsell opportunities</strong> — surge protection, AFDDs, EV charger, smart
              controls, periodic inspection due in six months. The office decides whether to offer.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Whatever you discovered alongside the headline fault &mdash; the borderline IR reading
              on a different circuit, the missing label at the MET, the two breakers in the wrong
              slots &mdash; goes on the report. Reg 651.4 is the regulation that converts
              &ldquo;noticed it but it wasn&apos;t my call-out&rdquo; into &ldquo;recorded it on the
              customer&apos;s record&rdquo;.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              new circuit" at the top; the work was neither. The customer's Duty Holder records now
              contain a misleading certificate &mdash; the next inspector reading the EIC will
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              routine compliance check from the local authority's housing standards team and has the
              EICR (showing a C2) and the MWC (showing a rectification) but no documentary bridge
              between them. The C2 looks open; the landlord faces a notice of intent to fine.
            </>
          }
          doInstead={
            <>
              Always issue a Schedule of Remedial Works alongside the MWC when the rectification
              closes an EICR finding. Reference the original EICR cert number, list the coded item,
              state the action taken, attach the test result. Five extra minutes; eliminates the
              audit-trail gap.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A landlord's EICR (issued by another firm last week) has a C1 (Danger Present) against
              a kitchen socket &mdash; burnt MK Logic Plus K2747 back-box, exposed live conductors
              due to a long-running loose connection. The landlord has 28 days under the Private
              Rented Sector Regulations 2020 to rectify; their letting agent has booked you in for
              tomorrow. You arrive with a new MK socket, a new back-box, the Megger MFT1741 and an
              MWC pad on the laptop.
            </>
          }
          whatToDo={
            <>
              (1) Isolate at the Wylex DB; lock-off; prove dead at the socket with the Martindale
              VI-13800. (2) Remove the burnt socket and back-box; check the cable terminations for
              heat damage upstream &mdash; if the ring conductors are heat-damaged beyond the
              ...
              conductors with proper torque (1.2&nbsp;Nm typical for 2.5&nbsp;mm&sup2;), fit the new
              MK Logic Plus front. (4) Verify with the MFT1741 &mdash; continuity of CPC, IR at
              500&nbsp;V, polarity, R1+R2, Zs, RCD trip-time. All within BS 7671 limits. (5) Issue
              the Minor Works Certificate via the laptop app &mdash; pre-load customer details, fill
              the work-done description, enter test results, sign Designer / Constructor / Inspector
              (Inspector panel under supervisor remote sign-off as needed for an apprentice). (6)
              Issue the Schedule of Remedial Works back-referencing the EICR cert number, the C1
              observation, the action taken, the new test result, the date. (7) Email the bundle
              (MWC + Schedule) to the letting agent and the landlord; file copy in the firm's job
              system; verbal hand-back to the tenant on the way out. The landlord now has
              documentary proof of compliance within the 28-day window.
            </>
          }
          whyItMatters={
            <>
              C1 closure on landlord work is the documentary scenario where speed and accuracy BOTH
              matter. The 28-day timeline is legal, not advisory; the documentary bundle (MWC +
              Schedule + EICR) is the landlord's defence against the &pound;30,000 per-breach fine;
              the next periodic inspector will pick up the bundle and rely on it. The L3
              apprentice's role is to do the work, document it correctly, and turn it around in the
              time available. The case is the canonical illustration of why the certificate is not
              optional polish &mdash; it's the substance of compliance.
            </>
          }
        />
        ...
        <Quiz
          title="Reporting + handover documentation — knowledge check"
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">
              5.4 Safe disposal + leave area safe
            </div>
          </button>
          <button
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">
              Section 6 — Apply rectification techniques
            </div>
          </button>
        </div>
      </HubBody>
