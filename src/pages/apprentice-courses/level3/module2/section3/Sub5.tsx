...
const TITLE = 'Wind, hydro, CHP, biomass deeper (3.5) | Level 3 Module 2.3.5 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question: 'What licensing and permitting does a domestic micro-hydro install need in the UK?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'What is the L3 electrical scope on a biomass boiler install in a rural property?',
    options: [
  ...
  {
    id: 5,
    question: 'What is a Smoke Control Area and what does it mean for biomass installs?',
    options: [
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 3 · Subsection 5"
        title="Wind, hydro, CHP, biomass deeper"
        backTo="/study-centre/apprentice/level3-module2-section3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The four less-common environmental technologies — micro-wind, micro-hydro, micro-CHP and
          biomass — at deeper recognition level. Capacity factor honesty, planning and licensing
          complexity, the regulatory direction and the L3 electrical scope distinct from the
          mechanical and civil trades.
        </p>
        ...
        >
          <p>Typical UK capacity factors at apprentice level:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Domestic PV — 10-12 percent</strong>. Most of the year the array is producing
              zero (night) or partial (cloud, low sun angle). Annual yield roughly 800-1100 kWh per
              kWp.
            </li>
            <li>
              <strong>Suburban micro-wind — 5-15 percent</strong>. Turbulence from surrounding
              buildings reduces effective wind speed; the cube law amplifies the loss.
            </li>
            <li>
              <strong>Rural exposed micro-wind — 20-30 percent</strong>. Open site, clean wind,
              properly sized turbine. Genuinely useful at northern UK latitudes where winter PV is
              poor.
            </li>
            <li>
              <strong>Micro-hydro — 50-80 percent</strong>. Water flows continuously most of the
              year especially in upland UK. The dominant capacity factor across UK micro-renewables.
            </li>
            <li>
              <strong>Biomass (heat only) — N/A</strong>. Biomass boilers are dispatchable — they
              run when needed, capacity factor depends on usage, not weather.
            </li>
            <li>
              <strong>Domestic micro-CHP — 30-50 percent</strong>. Limited by heat demand in the
              summer; drops to near-zero in warm months.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              In a Smoke Control Area it is an offence to emit smoke from a chimney of a building,
              including a private domestic chimney, unless an authorised fuel is being burnt in an
              authorised (Defra exempt) appliance. Local authorities maintain smoke control area
              boundaries and have enforcement powers including fixed penalty notices. New biomass
              installs in smoke control areas must use Defra exempt appliances and authorised fuels
              that meet Ecodesign emission limits.
            </>
          }
          meaning={
            <>
              Smoke Control Areas effectively close the urban / suburban market for non-compliant
              biomass. Almost every UK urban / suburban area is in an SCA. The customer wanting a
              wood burning stove or biomass boiler in an SCA must use a Defra exempt appliance and
              authorised fuel. The L3 apprentice does not enforce SCAs but should recognise the
              regulatory direction — biomass is increasingly a rural off-gas-grid niche, not a
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Suburban back garden</strong> — almost always uneconomic. The MCS site
              assessment normally returns a yield estimate too low to justify the capital cost.
            </li>
            <li>
              <strong>Rural exposed open site</strong> — can be excellent. Hub height 15-25 m on a
              properly engineered mast, well clear of obstructions.
            </li>
            <li>
              <strong>Building-mounted micro-wind</strong> — turbulence from the building itself
              usually destroys the yield; rarely justified.
            </li>
            <li>
              <strong>Planning constraints</strong> — many local authorities treat domestic wind
              under permitted development with conditions; some require full planning. Listed
              buildings and conservation areas often refuse.
            </li>
            <li>
              <strong>MCS MIS 3003</strong> — the install standard for grant eligibility. Includes
              the site assessment methodology that filters out non-viable sites at design stage.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Turbine type by head:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pelton wheel — high head 50-300 m</strong>. Impulse turbine; jets of water hit
              cup-shaped buckets on a wheel. Common in upland UK (Lake District, Snowdonia,
              Highlands).
            </li>
            <li>
              <strong>Turgo — medium-high head 30-200 m</strong>. Impulse, similar to Pelton but
              compact.
            </li>
            <li>
              <strong>Crossflow — medium head 5-50 m</strong>. Hybrid impulse / reaction; tolerant
              of variable flow.
            </li>
            <li>
              <strong>Kaplan / propeller — low head under 10 m</strong>. Reaction turbine; axial
              flow; common on lowland river sites.
            </li>
            <li>
              <strong>Archimedes screw — very low head 1-5 m, high flow</strong>. Slow rotating
              screw; fish-friendly; popular on canal and river weir sites.
            </li>
          </ul>
          <p>
            The MCS-certified hydro designer matches turbine type to the specific site head and
            flow. The L3 electrician handles the grid connection regardless of the turbine choice —
            same G98 / G99 framework, same EIC, same install pack philosophy as any other generator.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Why the carbon argument changed:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2014 grid carbon intensity</strong> — around 400 gCO2 per kWh. On-site gas
              combustion at 200 gCO2 per kWh was significantly cleaner than buying grid electricity.
              CHP made carbon sense.
            </li>
            <li>
              <strong>2026 grid carbon intensity</strong> — around 200 gCO2 per kWh. On-site gas
              combustion at 200 gCO2 per kWh is now equivalent or worse than grid electricity. The
              carbon argument for CHP has dissolved.
            </li>
            <li>
              <strong>Future trajectory</strong> — grid carbon continues to fall as offshore wind
              and battery storage scale. CHP gets relatively dirtier each year while heat pumps get
              cleaner.
            </li>
            <li>
              <strong>Commercial CHP at 5-50 kWe</strong> — still works in constant-heat-demand
              sites (hospitals, leisure centres, industrial process) where the heat is genuinely
              useful year-round and the alternative is wasted gas.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Where biomass still makes sense in the UK:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Rural off-gas-grid farmhouse</strong> — high heat load, no mains gas, no
              electrical capacity for a single large heat pump, alternative is oil or LPG. Biomass
              is competitive here.
            </li>
            <li>
              <strong>Rural estate / multiple dwellings on a district scheme</strong> — a larger
              biomass boiler can heat several buildings via a heat network. Capital cost amortises
              over multiple users.
            </li>
            <li>
              <strong>Rural commercial / agricultural drying</strong> — biomass works where on-site
              fuel (wood waste, straw) is available cheaply.
            </li>
            <li>
              <strong>Heritage / listed buildings</strong> — where heat pump install is impossible
              or refused for fabric reasons, biomass on Defra-approved Ecodesign appliances may be
              the only viable retrofit option.
            </li>
          </ul>
          <p>
            MCS qualifications for biomass: MIS 3004 (biomass space heating boilers under 45 kW),
            MIS 3006 (biomass stoves). The MCS-certified biomass installer coordinates the install;
            the L3 electrician handles the electrical scope.
          </p>
        </ConceptBlock>
        ...
        >
          <p>AD project moving parts the L3 apprentice should recognise:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Digester</strong> — the tank where slurry or feedstock ferments; mechanical /
              process scope, not electrical.
            </li>
            <li>
              <strong>Gas storage</strong> — gas holder over the digester or a separate gas bag;
              safety-critical, ATEX-zoned area.
            </li>
            <li>
              <strong>CHP unit</strong> — engine plus alternator generating electricity and heat;
              electrical interface to the L3 apprentice's scope.
            </li>
            <li>
              <strong>G99 grid connection</strong> — DNO Connection Offer, witnessed commissioning,
              protection settings; same framework as larger PV.
            </li>
            <li>
              <strong>Smart export tariff or PPA</strong> — exported electricity sold under a Power
              Purchase Agreement to a supplier; meter accuracy and MID-class metering required.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Micro-CHP install touchpoints:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply circuit</strong> — typically 13 A on a 6-10 A MCB; the unit's own
              controls draw little electricity.
            </li>
            <li>
              <strong>G98 notification</strong> — exporting up to 1 kW generally falls within G98;
              notify within 28 days.
            </li>
            <li>
              <strong>Type-test certificate</strong> — included in the handover pack as evidence the
              unit's anti-islanding protection is type-approved.
            </li>
            <li>
              <strong>Signage</strong> — alternative supply at the consumer unit, AC and DC
              isolation points (where DC bus is exposed), meter position.
            </li>
            <li>
              <strong>Maintenance schedule</strong> — engine service intervals, customer brief;
              warranty usually requires manufacturer-approved service.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Community renewables operating context:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cooperative governance</strong> — investors are community members; AGMs and
              transparent reporting.
            </li>
            <li>
              <strong>Project scale</strong> — 50 kW to 5 MW typically; G99 grid connection, full
              DNO interaction.
            </li>
            <li>
              <strong>Site types</strong> — community-building roof PV, farmland solar, small wind,
              run-of-river hydro, community-owned EV charging hubs.
            </li>
            <li>
              <strong>Funding</strong> — community shares, social investor loans, grants; the
              financial structure feeds back into the technical commissioning timeline.
            </li>
            <li>
              <strong>Career exposure</strong> — community projects offer varied technical and
              customer-engagement work; valuable for the L3 apprentice considering a longer-term
              renewables pathway.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Solid fuel local space heaters (stoves) and solid fuel boilers placed on the market
              must meet seasonal space heating energy efficiency limits and emission limits for
              particulate matter, organic gaseous compounds, carbon monoxide and nitrogen oxides.
              The limits apply at the point of placing the appliance on the market and are enforced
              via product compliance regimes. Older appliances placed on the market before the
              regulation came into force are not subject to the limits but are subject to Smoke
              Control Area rules under the Clean Air Act 1993.
            </>
          }
          meaning={
            <>
              Ecodesign sets the emissions floor for new biomass appliances in the UK. Combined with
              Smoke Control Area rules, this effectively closes the urban / suburban market for
              older non-compliant kit. The L3 apprentice should recognise that 'just fitting any
              wood burner' is regulated — the customer needs Defra-approved Ecodesign-compliant kit
              and authorised fuel in an SCA, and the manufacturer publishes the exemption status on
              the data sheet.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer wants 'green energy' and the sales rep quotes a 5 kW micro-wind turbine on
              the basis of the manufacturer rated output. The brochure suggests 10,000 kWh per year.
              After install the actual annual yield comes in at 600 kWh — 6 percent of the brochure
              number. Customer is angry, the firm reputation suffers, and the customer is stuck with
              a high-cost low-yield asset. The MCS Wind Yield Estimator (MIS 3003) would have
              predicted the result at survey stage if it had been run.
            </>
          }
          doInstead={
            <>
              Insist on the MCS site assessment (MIS 3003) before any customer quote on micro-wind.
              The assessment uses the local wind atlas plus a turbulence factor and produces a
              realistic yield estimate. Customers who see the realistic estimate for a suburban site
              rarely proceed. Honest assessment up front prevents a complaint case at handover.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer in a Smoke Control Area asks for a wood pellet boiler. The installer quotes
              for the install and orders kit. After install the local authority environmental health
              team receives a complaint about smoke and on inspection finds the appliance is not
              Defra exempt and the fuel is not authorised. Fixed penalty notice issued; customer has
              to remove or replace the appliance; firm reputation damaged.
            </>
          }
          doInstead={
            <>
              Check Smoke Control Area status as the first step on any biomass enquiry. Confirm the
              appliance is on the Defra exempt list. Confirm the fuel is authorised. If the customer
              is in a suburban SCA and wants biomass, the honest answer is usually 'heat pump is the
              better fit'. If the customer insists, they need an exempt appliance and authorised
              fuel, and the BUS grant probably does not apply.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You are assisting on a survey for a rural Cumbrian farmhouse. Off-gas-grid (oil
              currently). Heat load 30 kW design. Electrical supply is single-phase 80 A. The farmer
              wants to reduce running cost and is considering either an ASHP or a biomass boiler.
              Mains gas is not available.
            </>
          }
          whatToDo={
            <>
              Honest framing of the trade-off: ASHP at 30 kW design heat load may need 12-15 kW
              electrical input on the coldest day — close to the 80 A supply limit (about 18 kW
              continuous). The MCS designer can specify a lower-temperature emitter design with
              fabric upgrades to reduce the heat load to nearer 20 kW, which makes the heat pump fit
              the supply. SCOP 3.0-3.5 likely. BUS grant £7,500. Biomass at 30 kW fits the load
              directly with no supply issue. SCOP not relevant; running cost depends on pellet price
              (currently competitive with oil). BUS grant £5,000 if eligibility criteria met
              (off-gas-grid rural, Defra-approved appliance). Customer accepts the operational chore
              (weekly pellet loading, ash removal). Recommend the MCS heat-loss survey to settle on
              the heat pump option after fabric assessment, with biomass as the fallback if fabric
              work is impractical or the supply upgrade cost is prohibitive.
            </>
          }
          whyItMatters={
            <>
              Rural off-gas-grid is the one segment where biomass remains competitive with heat
              pumps. As an apprentice you should recognise the technology trade-offs, the supply
              constraint, the BUS grant differences, and frame the customer choice honestly. The MCS
              designer makes the final recommendation with numbers; the apprentice on site should be
              able to discuss the trade-offs at customer level.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          clause={
            <>
              Requirements of Section 712 shall apply to PV installations not connected to a system
              for distribution of electricity to the public, in parallel with a system for
              distribution of electricity to the public, and as an alternative to a system for
              distribution of electricity to the public.
            </>
          }
          meaning={
            <>
              Off-grid renewable installs are explicitly within Section 712 scope. Don&apos;t assume
              an off-grid system is somehow exempt from BS 7671 — it is not. The DC isolation, RCD
              type, earthing arrangement and labelling rules apply identically to standalone
              systems.
            </>
          }
        ...
        <Quiz
          title="Wind, hydro, CHP, biomass deeper — knowledge check"
