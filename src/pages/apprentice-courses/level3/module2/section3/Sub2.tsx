...
const TITLE = 'Heat pumps overview (3.2) | Level 3 Module 2.3.2 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question: 'Describe the vapour-compression cycle that drives a heat pump in plain English.',
    options: [
  ...
  {
    id: 3,
    question: 'Why does heat pump SCOP suffer when the wet system is undersized old radiators?',
    options: [
  ...
  {
    id: 4,
    question: "What's the typical electrical interface for a 8-12 kW domestic ASHP?",
    options: [
  ...
  {
    id: 5,
    question: 'When is a heat pump SCOP figure of 3.5 considered "good"?',
    options: [
  ...
  {
    id: 6,
    question: "What's the F-Gas certification framework and where does it apply?",
    options: [
  ...
  {
    id: 7,
    question: 'Why does the outdoor unit of an ASHP sometimes need bonding to the MET?',
    options: [
...
const faqs = [
  ...
  {
    question:
      "What's the difference between a heat pump for heating-only and one for heating and cooling?",
    answer:
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 3 · Subsection 2"
        title="Heat pumps — overview for the L3 electrician"
        backTo="/study-centre/apprentice/level3-module2-section3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Vapour-compression cycle, ASHP vs GSHP, COP and SCOP, the electrical interface, the F-Gas
          trade boundary, and where the L3 electrician's responsibility starts and ends on a
          heat-pump install.
        </p>
        ...
        >
          <p>The four components of every heat pump:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Evaporator</strong> — outdoor coil (ASHP) or ground loop heat exchanger
              (GSHP). Refrigerant evaporates at low temperature, absorbing heat from the source.
            </li>
            <li>
              <strong>Compressor</strong> — driven by an electric motor. Squeezes the low-pressure
              vapour to high pressure, raising its temperature. This is the only component that
              consumes the electrical input.
            </li>
            <li>
              <strong>Condenser</strong> — indoor heat exchanger. The hot refrigerant condenses back
              to liquid, releasing heat into the wet system at useful temperature.
            </li>
            <li>
              <strong>Expansion valve</strong> — restricts flow, allowing the high-pressure liquid
              to expand back to low pressure for the next evaporation cycle.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>When each system fits:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>ASHP suits</strong> — most UK retrofit, typical urban / suburban domestic,
              properties without land for ground arrays, customers prioritising cost and speed of
              install. Performance is now respectable; install is straightforward.
            </li>
            <li>
              <strong>GSHP suits</strong> — new-build with land available (horizontal slinky in a
              large garden), or properties prepared to accept borehole drilling cost (50-150 m
              vertical wells). Customers wanting maximum SCOP and longest equipment life. Most often
              seen on estate-scale rural new-build.
            </li>
            <li>
              <strong>Hybrid heat pump suits</strong> — older properties where full heat-pump-only
              retrofit is impractical (undersized radiator system, hard to insulate envelope). The
              heat pump handles the bulk of the season at high SCOP; the gas boiler kicks in for
              cold spells.
            </li>
            <li>
              <strong>Water-source heat pump suits</strong> — niche; properties next to a lake,
              river or borehole well. Excellent performance where the source exists. Rare in UK
              domestic.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Typical electrical interface for a domestic ASHP:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply</strong> — dedicated radial circuit. 32 A for 8-12 kW units, 40 A for
              14-16 kW. Three-phase for larger or commercial units.
            </li>
            <li>
              <strong>Cable</strong> — 6 mm² T&E or SWA for 32 A; 10 mm² for 40 A; installation
              method (Method A clipped direct, Method C in cable trays, Method D buried) drives the
              actual rating. Voltage drop check over the run length.
            </li>
            <li>
              <strong>Protection</strong> — Type C or Type D MCB to handle compressor inrush. RCD
              per BS 7671 Section 411.3.3 / 415.1 — type per manufacturer's instruction. Some heat
              pumps require Type B RCD (DC fault detection); modern inverter-driven units may
              require RDC-DD per Section 722-style guidance.
            </li>
            <li>
              <strong>Isolation</strong> — local outdoor rotary or DP isolator at the outdoor unit.
              Maintenance and emergency interface for the F-Gas engineer.
            </li>
            <li>
              <strong>Controls</strong> — dedicated low-voltage cable for thermostat, hot water
              cylinder probe, smart controls integration. Cat5e/Cat6 increasingly common for
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              F-Gas Regulations are the assimilated EU Regulation 517/2014, retained in UK law
              post-Brexit (with some divergence). The Environment Agency enforces in England;
              equivalents in the devolved nations.
            </li>
            <li>
              Certification covers refrigerant handling, recovery, leak detection, installation and
              decommissioning. Different categories cover different charge-size ranges.
            </li>
            <li>
              Newer natural-refrigerant heat pumps (R290 propane) sit outside F-Gas but bring their
              own competence requirements — BS EN 378, COSHH, gas-installer- style competencies.
            </li>
            <li>
              Monobloc ASHP avoids on-site F-Gas work because the refrigerant circuit is
              factory-sealed inside the outdoor unit. Split ASHP requires F-Gas work for pipework
              connection.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Section 753 covers electric heating systems for surface heating, including embedded
              heating cables in floor screeds. Although heat-pump-fed underfloor heating typically
              uses water-filled pipes (not heating cables), Section 753 applies wherever the wet
              system is supplemented by, or replaced with, electric heating cables (e.g. trace
              heating on outdoor pipework, or hybrid arrangements). Section 753 has been completely
              revised in A4:2026.
            </>
          }
          meaning={
            <>
              Section 753 is the relevant BS 7671 section for any embedded electric heating. Pure
              water-based underfloor heating fed by a heat pump is governed by general requirements
              (Part 4 / 5 / 6), not Section 753. But hybrid systems combining wet underfloor with
              heating cables, or trace-heated outdoor pipework, fall within Section 753. As Unit 301
              is overview level, recognise where Section 753 sits in the regulation map.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              MIS 3005 is the MCS Installation Standard for heat pumps. It covers site survey,
              room-by-room heat-loss calculation, emitter sizing, system design, installation
              quality, commissioning, performance estimate (SCOP), customer handover documentation
              and labelling. Compliance with MIS 3005 is required for the customer to access the
              Boiler Upgrade Scheme grant and for many manufacturer warranties.
            </>
          }
          meaning={
            <>
        ...
        >
          <p>The heat-loss calc inputs and outputs:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Air permeability</strong> — measured or assumed. Drives ventilation heat loss.
            </li>
            <li>
              <strong>Design outdoor temperature</strong> — locality-specific, typically -2 degC for
              southern England, -3 to -5 degC for northern England and Scotland.
            </li>
            <li>
              <strong>Internal target temperature</strong> — typically 21 degC living spaces, 18
              degC bedrooms, 22 degC bathrooms.
            </li>
            <li>
              <strong>Output 1 — heat pump rating</strong> — total property design heat loss in kW,
              rounded to the nearest available unit.
            </li>
            <li>
              <strong>Output 2 — emitter size per room</strong> — radiator or underfloor heat output
              required at the chosen flow temperature.
            </li>
            <li>
              <strong>Output 3 — flow temperature target</strong> — typically 35-45 degC for
              new-build with underfloor or oversized radiators, 50-55 degC for retrofit with
              upgraded radiators.
            </li>
            <li>
              <strong>Output 4 — SCOP estimate</strong> — annual seasonal performance given the
              chosen flow temperature and the design heat loss.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Emitter options at heat pump flow temperatures:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Underfloor heating</strong> — best fit. Large surface area, low flow
              temperature (35-40 degC). Highest SCOP. Easy in new-build, disruptive in retrofit.
            </li>
            <li>
              <strong>Oversized radiators</strong> — typical retrofit solution. Replace single
              panels with double or triple convectors; physically larger units; flow temperature
              45-50 degC.
            </li>
            <li>
              <strong>Fan-assisted radiators</strong> — typical compact units with a small fan to
              boost convective output. Useful where physical space limits radiator size. Slight
              noise; small electrical load (typically fed from the heat pump controls).
            </li>
            <li>
              <strong>Existing radiators kept</strong> — only acceptable if the radiators are
              already oversized for the room (common in older homes with original cast-iron or large
              convector radiators) or if the customer accepts a higher flow temperature (55-60 degC)
              and the lower SCOP that comes with it.
            </li>
            <li>
              <strong>High-temperature heat pump</strong> — alternative to emitter upgrade.
              Two-stage compression or CO2 refrigerant delivers 65-80 degC flow. SCOP lower
              (2.5-3.0) but emitter upgrade avoided.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Defrost cycle facts to brief customers on:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>When it happens</strong> — outdoor temperature below 6-7 degC with humidity.
              Most common in autumn and spring; rare in dry cold spells.
            </li>
            <li>
              <strong>What it looks like</strong> — steam from the outdoor unit, water dripping from
              the coil, brief change in compressor sound.
            </li>
            <li>
              <strong>How long it lasts</strong> — typically 5-10 minutes per cycle.
            </li>
            <li>
              <strong>How often</strong> — every 30-60 minutes during defrost-prone weather; not at
              all in dry cold.
            </li>
            <li>
              <strong>Effect on room temperature</strong> — barely noticeable on a well-designed
              install with adequate emitter sizing and a buffer cylinder.
            </li>
            <li>
              <strong>When it is a problem</strong> — defrost every few minutes, or lasting more
              than 15 minutes, indicates a refrigerant or coil issue. F-Gas engineer scope.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The scheduling-and-tariff opportunity:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Octopus Cosy</strong> — cheap rates 04:00-07:00 and 13:00-16:00; expensive
              16:00-19:00. Ideal for heat pump pre-heat in the off-peak windows.
            </li>
            <li>
              <strong>Octopus Agile</strong> — half-hourly variable pricing tracking wholesale;
              HEMS-controlled scheduling adapts automatically.
            </li>
            <li>
              <strong>Intelligent Octopus Go</strong> — combined EV plus heat pump tariff with
              dispatch managed by the supplier. Customer pays a flat cheap rate during dispatched
              periods.
            </li>
            <li>
              <strong>Buffer cylinder</strong> — a thermal store between the heat pump and the wet
              system lets the heat pump run flat in cheap windows and discharge through expensive
              windows. Increasingly common on dynamic-tariff installs.
            </li>
            <li>
              <strong>Pre-heat the building fabric</strong> — well-insulated homes hold heat for
              hours; pre-heating during off-peak and coasting through peak is feasible.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              the marketing brochure and pops in a 16 A supply. First cold spell, the unit hits its
              nameplate maximum and the MCB trips. Or the cable runs warm under sustained load and
              the insulation degrades over months. The manufacturer&apos;s installation manual
              specified 32 A; the apprentice didn&apos;t read it.
            </>
          }
          doInstead={
            <>
              Always size the supply for the nameplate maximum stated in the manufacturer&apos;s
              installation manual. Heat pumps are continuous-load devices — the cable thermal rating
              is the design constraint, not the average load. Type C or Type D MCB to handle
              compressor inrush. RCD type per the manufacturer&apos;s instruction (some
              inverter-driven units require Type B for DC fault detection). Voltage-drop check over
              the run length.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer says &quot;the F-Gas guy isn&apos;t coming until next week — can you just
              connect the pipes so I can use the system?&quot;. Apprentice obliges with a few brazed
              joints. Refrigerant leaks out, the system underperforms, the manufacturer voids the
              warranty, and the apprentice is exposed to a criminal offence under the F-Gas
              Regulations.
            </>
          }
          doInstead={
            <>
              Refrigerant work is F-Gas-certified-only. Polite refusal is the only correct answer.
              Explain to the customer that the F-Gas work is a separate trade boundary — same as you
              wouldn&apos;t expect the F-Gas engineer to wire the supply. The customer&apos;s
              timeline pressure is not a justification for taking on work outside your trade.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              three-bed semi. The MCS designer&apos;s schedule specifies: 32 A radial, Type C MCB,
              Type B RCD, 6 mm² 2-core SWA buried in trench from CU to outdoor unit (28 m), local
              rotary isolator at the outdoor unit, dedicated Cat6 for smart controls back to the
              indoor cylinder location. The customer wants the supply ready for the F-Gas
              commissioning visit next week.
            </>
          }
          whatToDo={
            <>
              Run the design check first. 6 mm² 2-core SWA buried (Method D), 32 A, ambient soil
              15°C, single circuit, ungrouped — tabulated current rating ample. Volt-drop: 32 A × 28
              m × ~7.3 mV/A/m for 6 mm² = ~6.5 V = ~2.8% — within the 3% Reg 525.1.1 limit for power
              circuits with margin. Type C MCB and Type B RCD per schedule. Earth via a 4 mm² CPC
              plus the SWA armour bonded at both ends. Local outdoor rotary isolator at the unit
              (IP-rated for outdoor use, lockable). Cat6 separate from the SWA in conduit or duct.
              Verify the installation per BS 7671 — continuity, IR, polarity, Zs at the local
              isolator, RCD test. Label the CU MCB, the local isolator, and the SWA route. Hand over
              to the F-Gas engineer with a confirmed dead-test on the supply terminals at the indoor
              unit.
            </>
          }
          whyItMatters={
            <>
              The first-fix electrical supply has to be right because the F-Gas engineer arriving
              next week needs to commission the unit safely. Wrong cable size = nuisance tripping;
              wrong MCB type = inrush trips; missing isolation = unsafe refrigerant work; missing
              labelling = future maintainer confusion. The handover dead-test confirms the F-Gas
              engineer can trust the supply. Your trade boundary stops at the unit terminals — the
              F-Gas commissioning is theirs.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              A heat-pump radial is a high-current AC final circuit running for hours. The AFDD
              recommendation in 421.1.7 sits well with that profile. The wording is advisory, not
              mandatory — but in HRRBs and increasingly on competent-designer spec sheets
              you&apos;ll see AFDDs fitted as standard.
            </>
          }
