...
const TITLE = 'Heat pump system technology deeper (3.4) | Level 3 Module 2.3.4 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  {
    id: 7,
    question: 'Why does a heat pump need a Type C MCB or RCBO rather than Type B?',
    options: [
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 3 · Subsection 4"
        title="Heat pump system technology deeper"
        backTo="/study-centre/apprentice/level3-module2-section3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The vapour-compression cycle in plain English. COP / SCOP at apprentice level. Emitter
          sizing trade-offs. ASHP / GSHP / WSHP comparison. Refrigerant options and the F-Gas trade
          boundary. The electrical scope sits alongside refrigeration and plumbing — recognise where
          each starts and stops.
        </p>
        ...
        >
          <p>The four stages, in order around the loop:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Evaporator (cold side)</strong> — refrigerant at low pressure (typically 5-10
              bar) is below the source temperature. It absorbs heat from the source (outside air for
              ASHP, ground brine for GSHP, water for WSHP) and boils to a vapour. The source loses
              heat; the refrigerant gains it.
            </li>
            <li>
              <strong>Compressor (electrical work in)</strong> — the heart of the system. An
              electric motor drives a scroll, rotary or piston compressor that pressurises the
              vapour to a high pressure (typically 25-40 bar). Compression raises both the pressure
              and the temperature of the vapour. The electrical energy enters the cycle here as
              mechanical work on the refrigerant.
            </li>
            <li>
              <strong>Condenser (hot side)</strong> — the hot high-pressure vapour meets the wet
              system (radiator or underfloor circuit) which is at a lower temperature. Heat flows
              from the refrigerant to the wet system; the refrigerant condenses to a liquid. The wet
              system gains heat; the refrigerant loses it.
            </li>
            <li>
              <strong>Expansion valve (pressure reset)</strong> — the high-pressure liquid drops in
              pressure through a metering device (thermal expansion valve or electronic expansion
              valve), cooling sharply as it expands. The cycle is now ready to start again at the
              evaporator.
            </li>
          </ul>
          <p>
            Energy balance: heat delivered to the wet system = heat extracted from the source +
            electrical work done by the compressor. The COP is the ratio of the first to the third —
            useful heat delivered per kWh of electricity consumed.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Work on equipment containing fluorinated refrigerants requires personnel to hold a
              current F-Gas qualification appropriate to the work category (installation, leak
              checking, recovery, servicing). It is a regulatory offence to install, service or
              decommission F-Gas refrigerant circuits without certification. The Regulations cover
              R32, R410A, R134a, R404A, R454B and related fluorinated refrigerants. Natural
              refrigerants (R290 propane, CO2, ammonia) sit outside F-Gas but inside other
              competence frameworks (BS EN 378 hydrocarbon handling).
            </>
          }
          meaning={
            <>
              F-Gas is a hard trade boundary. The L3 electrician does NOT touch the refrigerant
              circuit unless they hold separate F-Gas certification (typically City and Guilds 2079
              or equivalent). The electrical scope (supply, isolation, controls, bonding) is BS 7671
              territory and within the L3 scope; the refrigerant scope is F-Gas territory and
              requires separate competence. The two trades work alongside each other on a heat pump
              install. Crossing the boundary without certification is a regulatory offence and an
              insurance issue.
            </>
          }
        ...
        >
          <p>Realistic UK SCOP ranges:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Underfloor heating, design flow 35 °C, well-insulated property</strong> — SCOP
              3.5 to 4.5. The best-case scenario.
            </li>
            <li>
              <strong>Oversized radiators, design flow 45 °C, reasonable insulation</strong> — SCOP
              3.0 to 3.5. The typical retrofit target.
            </li>
            <li>
              <strong>Mixed system, design flow 50 °C, average insulation</strong> — SCOP 2.8 to
              3.2. Acceptable but not optimal.
            </li>
            <li>
              <strong>
                Original boiler-sized radiators, design flow 55-60 °C, marginal insulation
              </strong>{' '}
              — SCOP 2.3 to 2.8. Warning territory; running cost may exceed customer expectations.
            </li>
            <li>
              <strong>SCOP below 2.0</strong> — install pathology. Refrigerant undercharge,
              undersized emitters causing constant high-flow operation, controls misconfigured,
              weather compensation off. Warrants investigation.
            </li>
          </ul>
          <p>
            The carbon comparison: gas combustion in a domestic boiler produces about 210 gCO2 per
            kWh of useful heat. A heat pump at SCOP 3.0 on a UK grid at 200 gCO2 per kWh of
            electricity emits about 67 gCO2 per kWh of heat — roughly three times cleaner. As the
            grid carbon intensity continues to fall, the heat pump gets cleaner without any change
            to the kit; gas boilers do not.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Underfloor heating</strong> — very large emitter surface area (whole floor).
              Runs at 30-40 °C flow. Highest SCOP. Ideal for new-build or major retrofit. Cost is
              the install (screed, manifold, controls).
            </li>
            <li>
              <strong>Oversized radiators</strong> — typical retrofit answer. Replace original
              radiators with larger units (often double-panel double-convector) sized for 45-50 °C
              flow. Lower install cost than underfloor; cosmetic impact (larger units in each room).
            </li>
            <li>
              <strong>Original radiators retained</strong> — sometimes feasible in rooms where the
              original radiator was already oversized for the load. Force the heat pump to higher
              flow temperature (55-60 °C) and accept the SCOP hit. Often the cheapest install but
              the worst running cost.
            </li>
            <li>
              <strong>Skirting heating, low-temperature trench convectors</strong> — niche emitter
              types that work well at low flow temperature. Cosmetic appeal in some properties.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Practical comparison at apprentice level:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>ASHP install cost</strong> — typically £8-15k for a 5-7 kW unit including
              emitter upgrades on a typical UK retrofit. Boiler Upgrade Scheme grant (BUS) £7,500 in
              England / Wales (subject to ongoing scheme terms).
            </li>
            <li>
              <strong>GSHP install cost</strong> — typically £15-30k including ground loop. Slinky
              horizontal £4-8k extra; borehole £10-20k extra. BUS grant £7,500 (same as ASHP — no
              premium for GSHP).
            </li>
            <li>
              <strong>WSHP install cost</strong> — site-dependent, plus Environment Agency
              permitting. Mostly commercial.
            </li>
            <li>
              <strong>SCOP comparison</strong> — ASHP 3.0-3.5 typical retrofit; GSHP 3.5-4.5 typical
              due to stable ground temperature.
            </li>
            <li>
              <strong>Maintenance burden</strong> — all three need annual service per MCS Code and
              warranty terms. ASHP has the visible outdoor unit needing occasional cleaning of fins.
              GSHP has no outdoor moving parts above ground. WSHP needs occasional inspection of the
        ...
        >
          <p>Refrigerant categories in plain terms:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>A1 (non-flammable)</strong> — older refrigerants like R410A, R134a. F-Gas
              regulated, being phased down because of high GWP.
            </li>
            <li>
              <strong>A2L (mildly flammable)</strong> — R32, R454B. F-Gas regulated. Some
              restrictions on charge size and confined space install. Most current UK ASHPs.
            </li>
            <li>
              <strong>A3 (highly flammable)</strong> — R290 (propane). Natural, non-F-Gas, very low
              GWP. Specific install rules per BS EN 378 — charge limits typically 0.152 kg of
              propane per cubic metre of room volume (indoor), generous clearances outdoor.
            </li>
            <li>
              <strong>B (toxic)</strong> — R717 ammonia. Industrial only; not domestic.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Heat-pump cylinder design factors:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cylinder size</strong> — driven by daily peak hot water draw; 250-300 L
              typical for a 4-bed.
            </li>
            <li>
              <strong>Coil rating</strong> — heat-pump-rated cylinders have an oversized coil so the
              heat pump can charge the cylinder at its low flow temperature; gas cylinders'
              undersized coils are not suitable.
            </li>
            <li>
              <strong>Storage temperature</strong> — typically 50 degrees C normal, 60 degrees C
              anti-legionella weekly.
            </li>
            <li>
              <strong>Backup immersion</strong> — typical 3 kW on a 16 A B-curve MCB with its own
              thermostat; runs as backup or as the anti-legionella heat source.
            </li>
            <li>
              <strong>Smart controls</strong> — controls schedule the heat pump for cylinder
              priority overnight (cheap-rate tariff if available); the apprentice should recognise
              the schedule pattern at handover.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Buffer tank vs volumiser — recognising the difference:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Buffer tank with separate pump</strong> — adds thermal mass and decouples the
              heat pump cycle from the emitter demand; runs the heat pump at its sweet-spot flow
              rate even when the rooms are lightly demanding heat.
            </li>
            <li>
              <strong>Volumiser inline</strong> — adds water volume to meet the manufacturer's
              minimum system volume (often 30-50 L per kW of heat pump rating); no controls or
              bonding implications.
            </li>
            <li>
              <strong>Anti-cycling on small loads</strong> — buffer tank holds the heat output when
              only one or two radiators are calling for heat; without it, the heat pump would
              short-cycle and SCOP would collapse.
            </li>
            <li>
              <strong>Smooth defrost</strong> — buffer water rides through the heat pump's defrost
              cycle (a few minutes once or twice an hour in cold weather) so the rooms do not feel
              the temperature drop.
            </li>
            <li>
              <strong>Customer brief</strong> — leave the buffer pump running; the buffer is part of
        ...
        >
          <p>Backup heating strategy options:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Bivalent (heat-pump only above bivalent point)</strong>— backup activates
              below a set outdoor temperature; the heat pump shuts down when backup is on.
            </li>
            <li>
              <strong>Bivalent-parallel (both run below bivalent point)</strong> — heat pump
              continues at part-load below the bivalent point, supplemented by the electric backup
              to reach demand.
            </li>
            <li>
              <strong>Emergency immersion only</strong> — heat pump runs alone year-round; backup
              only used if the heat pump fails. Less expensive on capital but customer is colder on
              the coldest days.
            </li>
            <li>
              <strong>Inline electric resistance vs cylinder immersion</strong> — inline heats the
              system flow water directly; immersion heats the cylinder only. Different wiring and
              controls; pick the one the design calls for.
            </li>
            <li>
              <strong>Customer brief</strong> — explain that backup may run on cold days; bills will
              rise; this is normal and already in the SCOP estimate.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              MCS MIS 3005 sets requirements for the design, installation, commissioning and
              handover of heat pump systems. It mandates a room-by-room heat-loss calculation per BS
              EN 12831, an emitter schedule sized for the chosen design flow temperature, a SCOP
              estimate disclosed to the customer, eligible product selection from the MCS-certified
              product list, refrigerant work by F-Gas certified personnel, electrical work to BS
              7671, and a commissioning certificate issued through the installer MCS umbrella
              scheme.
            </>
          }
          meaning={
            <>
              MIS 3005 is the heat pump install standard. Customer eligibility for the Boiler
              Upgrade Scheme grant depends on an MIS 3005-compliant install. The L3 apprentice on a
              heat pump install works under the MCS-certified installer competence. You do not need
              to memorise the MIS 3005 clause numbers but you should recognise it as the document
              that ties the install together — heat-loss calc, emitter sizing, SCOP disclosure,
              product selection, F-Gas refrigerant, BS 7671 electrical, commissioning evidence.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer is told this heat pump is COP 4. They read that as every kWh in produces 4
              kWh of heat all winter. In practice COP 4 is the manufacturer A7 / W35 number — a mild
              day on low-temperature underfloor. The same unit driving 60 °C radiators on a -2 °C
              frost morning is closer to COP 2.0. The customer actual seasonal performance is the
              SCOP — typically 3.0 to 3.5 on a properly designed UK retrofit, lower for marginal
              installs. When the bills come in higher than expected, the apprentice gets the phone
              call.
            </>
          }
          doInstead={
            <>
              ...
              actual building heat loss and emitter design. If you do not have SCOP at hand, say COP
              at standard conditions — actual seasonal performance will be lower and refer them to
              the MCS designer for the realistic figure.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              R290 (propane) heat pump outdoor unit specifies 1 metre clearance from openable
              windows and 3 metres from ignition sources. The electrician fits the local rotary
              isolator (a switching device with potential for arc on operation) inside the 3 metre
              zone because that was the easiest cable run. In normal operation, no problem. In a
              leak scenario (refrigerant pipe failure releasing propane), the isolator becomes an
              ignition risk during operation. Under BS EN 378 hydrocarbon handling rules this is a
              non-compliance.
            </>
          }
          doInstead={
            <>
              Read the manufacturer install manual at survey stage to identify the
              no-ignition-source zone for the specific R290 unit. Site the isolator outside the zone
              — typically on a wall 3+ metres from the unit, or inside the building near the
              consumer unit if the cable run allows. Coordinate with the MCS designer at design
              stage so the isolator location is on the install drawings and not improvised at
              install time.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You are assisting on a survey for a 1980s 4-bed detached. The customer is replacing a
              24 kW gas combi with an ASHP. The MCS-certified surveyor is running the heat-loss
              calc. The customer asks you while the surveyor is in the loft 'so will this heat pump
              actually heat my house in winter?'.
            </>
          }
          whatToDo={
            <>
              Honest framing: 'the surveyor is calculating exactly that right now. Heat pumps
              deliver heat at a lower flow temperature than your old combi — about 45-50 °C versus
              70 °C. To get the same room temperature at the lower flow, we may need to upsize some
              of your radiators. The surveyor will identify which rooms need new radiators and the
              SCOP estimate will tell you the expected running cost. If your insulation is
              reasonable, a properly sized heat pump will keep your house warm through every UK
              winter on record. If your insulation is poor, we may recommend cavity wall and loft
              top-up before the heat pump is sized — fabric first is cheaper and more effective than
              oversizing the heat pump.' Avoid promises about specific bills until the SCOP estimate
              is in.
            </>
          }
          whyItMatters={
            <>
              Customers ask the apprentice on site because the apprentice is approachable. A
              trained, honest answer protects the customer relationship and the firm reputation.
              Avoid the marketing line ('heat pumps are amazing'); deliver the physics line ('they
              work; the design has to be right; the radiators may need an upgrade'). The MCS
              designer will back the conversation with numbers in a few days.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              socket-outlets with a rated current not exceeding 32 A. There is an exception to omit
              RCD protection where, other than for a dwelling, a documented risk assessment
          ...
          meaning={
            <>
              ...
              411.3.3 32 A threshold and require RCD protection. The risk-assessment exemption only
              applies outside dwellings.
            </>
          }
        ...
        <Quiz
          title="Heat pump system technology deeper — knowledge check"
