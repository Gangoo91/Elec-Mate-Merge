...
const faqs = [
  {
    question:
      "Reg 722.411.4 talks about charging points 'located outdoors or that might reasonably be expected to be used to charge a vehicle outdoors' — what does that catch in practice?",
    answer:
  ...
  {
    question:
      'If the property is on a TN-S (separate neutral and earth) supply rather than PME, does Reg 722.411.4 still apply?',
    answer:
  ...
  {
    question:
      'Why does Section 722 prohibit non-conducting location and earth-free bonding when those measures are valid elsewhere in BS 7671?',
    answer:
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 4 · Subsection 4"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The PME earthing arrangement that works inside the property cannot safely earth an outdoor
          EV charging point. Reg 722.411.4 sets four alternative routes for managing the open-PEN
          risk. Section 722 also carves out a specific AFDD exemption for BS EN 61851 conforming
          equipment, and prohibits four protective measures unsuitable for EV charging.
        </p>
        ...
        >
          <p>
            The A4:2026 revision history of Section 722 is significant — Amendment 1:2020 (issued
            February 2020) made substantial changes to Section 722. A4:2026 incorporates A1:2020
            alongside further changes affecting EV charging installations. Anyone working from a
            pre-A1:2020 copy of BS 7671 is working from out-of-date guidance.
          </p>
          <p>Key clauses you will meet on site:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>722.31</strong> — Assessment requirement covering purposes, supplies and
              structure of the EV installation.
            </li>
            <li>
              <strong>722.41 / 722.410.3.5 / 722.410.3.6</strong> — Protection for safety and the
              prohibitions on obstacles, placing out of reach, non-conducting location and
              earth-free local equipotential bonding.
            </li>
            <li>
              <strong>722.411.4</strong> — TN system requirements where PME earthing would otherwise
              be used for outdoor charge point protective conductor contacts. The four alternative
              routes (b) to (e).
            </li>
            <li>
              <strong>722.413.1.2</strong> — Class I EV charging point supplied from a separated
              source (Annex A722 Item A example).
            </li>
            <li>
              <strong>722.421.1.7.201</strong> — AFDD exemption for BS EN 61851 conforming charging
              equipment.
            </li>
            <li>
              <strong>722.551.7.2</strong> — Normative references for the charging connector
              standards (BS EN IEC 62196-2 series), enclosures and IK ratings.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;Regulation 722.411.4 applies to TN systems and addresses requirements where a
              PME earthing facility would otherwise be used as the means of earthing for the
              protective conductor contact(s) of a charging point located outdoors or that might
              reasonably be expected to be used to charge a vehicle outdoors. It sets alternative
              methods (b) to (e) that shall be used instead of using the PME facility directly as
              the charging-point protective-earth connection.&quot;
            </>
          }
          meaning={
            <>
              The scope is unambiguous. PME (Protective Multiple Earthing — the domestic name for
              the TN-C-S arrangement most UK distribution networks use) cannot be used directly as
              the charge point's protective-earth reference for outdoor charging on a TN supply.
              Routes (b) to (e) are the four alternative methods. The 'reasonably expected to be
              used to charge a vehicle outdoors' wording catches indoor-mounted chargers with
              tethered cables long enough to reach an outdoor parking position — outdoor use is the
              trigger.
            </>
          }
        ...
        >
          <p>
            The arrangement works on one condition — that the PEN remains intact between the
            substation and the property. If the PEN breaks open between the substation and the
            property's cut-out, several things happen at once:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>The neutral function is lost</strong> — the property's neutral now floats
              relative to the substation. Single-phase loads pull the floating neutral toward the
              line voltage of whichever phase is loaded most.
            </li>
            <li>
              <strong>The earth function is lost</strong> — the property's PE is bonded to that
              floating neutral, so the entire bonding scheme inside the property rises with it.
              Every exposed-conductive-part follows.
            </li>
            <li>
              <strong>Inside the property, simultaneous-touch is still managed</strong> — because
              everything inside is bonded together, every touchable surface is at the same elevated
              potential, and you cannot get a shock by touching two things at the same potential.
            </li>
            <li>
              <strong>Outside the property, simultaneous-touch is not managed</strong> — the
              surrounding ground (driveway, lawn, pavement) is at true earth potential. Any
              metalwork brought outside that is part of the property bonding scheme sits at the
              elevated PME potential. Touching the metalwork while standing on the ground exposes
              you to the difference.
            </li>
          </ul>
          <p>
            That last point is exactly the EV-on-driveway problem. The EV chassis is connected
            through the charging cable to the property's protective earth. Under an open-PEN fault
            the chassis sits at elevated potential while the driveway concrete sits at true earth.
            Touching the car body while standing on the driveway exposes you to the difference,
            which can be lethal.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The numbers from Annex A722 Item A722.3:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>70 V RMS</strong> — the maximum permitted MET-to-true-earth voltage under a
              PEN open-circuit fault. That sets the touch-voltage envelope between the bonded car
              body and the surrounding ground.
            </li>
            <li>
              <strong>207 V to 253 V RMS</strong> — the line-to-neutral utilisation voltage window
              for route (d). Outside that window (which is 230 V plus or minus 10 percent — the
              standard tolerance) the device disconnects within 5 seconds.
            </li>
            <li>
              <strong>5 seconds</strong> — the maximum disconnection time under route (d) from the
              trigger condition being met to the device electrically isolating the vehicle from the
              live conductors and from protective earth.
            </li>
            <li>
              <strong>Annex A722 Item A722.3</strong> — the calculation route for the maximum
              permissible electrode resistance under route (b). The number depends on the supply
              characteristics; the designer back-calculates from the 70 V threshold.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              installation earth electrode by a protective conductor complying with Regulation
              544.1.1 as the means of earthing for the charging point protective conductor contact
              when using method (b). The earth electrode and protective conductor are required
              alternatives to using the PME earthing facility directly.&quot;
            </>
          }
          meaning={
            <>
              Route (b) creates a true earth reference at the property by driving an installation
              earth electrode and bonding it to the MET. Annex A722 Item A722.3 gives the
              maximum-resistance guidance — the electrode shall be low enough resistance that, under
              a PEN open-circuit fault, MET-to-earth voltage does not exceed 70 V RMS. Acceptance is
              by calculation plus measurement plus documentation. The PME earthing remains in use
              for the rest of the installation; route (b) just adds an independent earth reference
              adequate to keep the EV charging point safe under PEN-fault conditions.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              electrically disconnects the vehicle from the live conductors of the supply and from
              protective earth in accordance with Regulation 543.3.3.101(b) within 5 s in the event
              of the utilisation voltage at the charging point, between the line and neutral
              conductors, being greater than 253 V RMS or less than 207 V RMS. The device shall
              provide isolation and be selected in accordance with Table 537.4.&quot;
            </>
          }
          meaning={
            <>
              Route (d) detects the open-PEN condition indirectly through its effect on
              line-to-neutral voltage at the charging point. Outside the 207 V to 253 V window (the
              standard plus or minus 10 percent tolerance on 230 V), the device disconnects within 5
              seconds, electrically separating the EV from both the line conductors and from
              protective earth. Many modern dedicated EV chargers integrate this detection
              internally — Reg 722.411.4(e) covers the 'alternative device or equivalent
              functionality within charging equipment' route on that basis. The device shall be
              selected per Table 537.4.
            </>
          }
        ...
        >
          <p>Things that go wrong with route (b) installations:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electrode resistance too high</strong> on sandy or rocky soil. Either drive
              multiple rods (and bond them together), use an earth mat or extended buried conductor,
              or treat the rod surroundings with bentonite or proprietary earth-enhancement
              material. Document the design choice.
            </li>
            <li>
              <strong>Cable run from MET to electrode</strong> shall be sized per Reg 544.1.1 — main
              protective bonding conductor, not a thin earth wire. Mechanical protection is required
              where exposed to damage.
            </li>
            <li>
              <strong>Electrode termination</strong> shall be accessible for inspection and future
              re-test. Buried-with-no-marker terminations fail acceptance.
            </li>
            <li>
              <strong>PEN-fault detection still helpful</strong> — even with a route (b) electrode,
              many designers add route (e) functionality in the charging equipment as
              belt-and-braces.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>How to verify route (e) acceptance on site:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Manufacturer declaration</strong> — every compliant unit ships with a
              Declaration of Conformity stating the satisfied route. File the declaration in the
              install documentation.
            </li>
            <li>
              <strong>Voltage-window test</strong> — the manufacturer commissioning guide normally
              includes a self-test routine that verifies the PEN-fault detection circuit. Run the
              routine and record the pass.
            </li>
            <li>
              <strong>Trip simulation</strong> — some units allow an injected fault test during
              commissioning to verify the disconnection within 5 seconds. Where supported, run the
              test.
            </li>
            <li>
              <strong>Trip behaviour</strong> — confirm the unit electrically separates the vehicle
              from both line conductors and from protective earth on trip, not just from line. Reg
              722.411.4(e) is explicit on the disconnection requirements.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What the verifier checks to accept the AFDD exemption:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BS EN 61851 series conformity</strong> — manufacturer declaration, marking on
              the equipment, datasheet citation, or test report. Verbal assurance is not acceptance.
            </li>
            <li>
              <strong>BS EN IEC 62196-2 connector conformity</strong> — for any socket-outlet or
              vehicle connector incorporated in the EV charging equipment. Manufacturer
              documentation evidences the connector compliance.
            </li>
            <li>
              <strong>Documentation in the install file</strong> — both conformity declarations on
              file in the customer handover pack. A future verifier should be able to confirm the
              exemption from the file alone.
            </li>
            <li>
              <strong>Conventional protective measures still apply</strong> — RCD protection per
              Section 722 (Type A, Type B or equivalent depending on the charging duty cycle),
              overcurrent protection, automatic disconnection of supply. The AFDD exemption does not
              remove any other protection.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;Regulation 722.421.1.7.201 states that AFDDs are not required for circuits
              supplying EV charging equipment conforming to the BS EN 61851 series. In other words,
              where the EV charging equipment meets BS EN 61851 requirements, the installation is
              exempt from the AFDD requirement referenced in this regulation.&quot;
            </>
          }
          meaning={
            <>
              The exemption is conditional. To accept the exemption under Reg 722.421.1.7.201 the
              installer or verifier shall verify that the EV charging equipment conforms to the BS
              EN 61851 series and that any socket-outlet or vehicle connector incorporated in the EV
              charging equipment conforms to BS EN IEC 62196-2. Evidence may include manufacturer
              declaration of conformity, markings, datasheets or test reports demonstrating
              compliance.
            </>
          }
        ...
        <ContentEyebrow>
          Prohibited protective measures — Reg 722.410.3.5 / 722.410.3.6
        </ContentEyebrow>
        ...
        >
          <p>Why each prohibition exists:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Obstacles</strong> — work by physically preventing inadvertent contact with
              live parts. EV charging requires deliberate connection of a cable, so an obstacle that
              prevents inadvertent contact also prevents deliberate connection. The protection model
              fails.
            </li>
            <li>
              <strong>Placing out of reach</strong> — works by separating live parts from the user
              by distance. EV charging cables are designed to be reached and handled, often at
              ground level. The protection model fails.
            </li>
            <li>
              <strong>Non-conducting location</strong> — works by ensuring the floor, walls and
              ceiling are insulating so that simultaneous contact between an exposed-conductive-part
              and earth is impossible. EV charging happens on ordinary driveways and forecourts
              which are not non-conducting. The protection model fails.
            </li>
            <li>
              <strong>Earth-free local equipotential bonding</strong> — works by bonding a local
              zone with no connection to the building earthing scheme. EV charging requires the
              vehicle, the cable and the charging equipment to share a protective-earth reference,
              which is the opposite of earth-free. The protection model fails.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;Regulation 722.410.3.6 sits in Chapter 72 (Part 7 — Special Installations or
              Locations). The prohibition that 'non-conducting location' and 'earth-free local
              equipotential bonding' shall not be used applies within the scope of Chapter 72 where
              this clause is cited (special installations or locations covered by Chapter 72).&quot;
            </>
          }
          meaning={
            <>
              The prohibition applies wherever Reg 722.410.3 is invoked — in practice, wherever
              Section 722 governs an EV charging installation. Designers must select alternative
              protective measures permitted within Chapter 72 and elsewhere in BS 7671 — typically
              protective earthing with ADS, RCDs at the rated residual operating current required by
              Section 722, and where applicable SELV / PELV. Reg 722.410.3.5 separately prohibits
              obstacles and placing out of reach (Section 417 measures) on the same rationale.
            </>
          }
        ...
        >
          <p>
            Documentation that should be in the customer handover pack on every EV charger install:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electrical Installation Certificate (EIC)</strong> — covers the electrical
              install per BS 7671 with a Section 722 declaration.
            </li>
            <li>
              <strong>Section 722 acceptance evidence</strong> — BS EN 61851 series conformity, BS
              EN IEC 62196-2 connector conformity, AFDD exemption justification per Reg
              722.421.1.7.201.
            </li>
            <li>
              <strong>Reg 722.411.4 route documentation</strong> — for route (b), installation earth
              electrode resistance calculation per Annex A722.3 plus measured value; for route (d)
              or (e), device specification and trip-window evidence.
            </li>
            <li>
              <strong>RCD type and rating evidence</strong> — Section 722 requires Type A RCD as a
              minimum, with Type B (or equivalent) where the charging equipment does not include DC
              fault current detection.
            </li>
            <li>
              <strong>OZEV or scheme certificate</strong> — competence evidence for the installing
              firm.
            </li>
            <li>
            ...
            <li>
              <strong>Photos of install and labels</strong> — supply isolator, RCD, MCB, charger
              label, supply tails sizing label.
            </li>
            <li>
              <strong>User manual</strong> — manufacturer documentation for the charger, the user
              app (where applicable), troubleshooting and emergency disconnection procedure.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The installer reasons that PME is the property's earthing arrangement so it must be
              fine for everything on the property. Reg 722.411.4 is missed and the charging point's
              protective conductor contact is bonded straight to the PME MET. Under a normal day the
              install works perfectly. Under an open-PEN fault — a PEN failure in the street, a
              corroded joint, a third-party cable strike — the EV chassis rises toward line voltage
              while the driveway concrete stays at true earth. The customer or a passer-by touches
              the car body while standing on the driveway and experiences a potentially fatal shock.
              The Section 722 acceptance was missed and a serious incident has resulted.
            </>
          }
          doInstead={
            <>
              Apply Reg 722.411.4 from the start of the design. Pick one of routes (b), (d) or (e)
              and document the choice. Route (e) — built-in PEN-fault detection in a modern
              dedicated EV charger — is the most common modern answer for domestic installs. Route
              (b) — installation earth electrode — is the answer where the equipment does not have
              built-in detection or where the design prefers an independent earth reference. The
              scope of Reg 722.411.4 is clear — PME may not be used directly for outdoor charging on
              TN systems.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The installer hears that EV charger circuits are AFDD-exempt and skips the AFDD
              without verifying that the equipment actually conforms to BS EN 61851 series. The
              verifier accepts the install on verbal assurance. A future inspector challenges the
              AFDD exemption, asks for the BS EN 61851 conformity evidence, and finds none in the
              file. The exemption fails acceptance and the install is recorded as non-compliant.
            </>
          }
          doInstead={
            <>
              Verify the BS EN 61851 series conformity before accepting the AFDD exemption. The
              acceptance rule is explicit — manufacturer declaration, marking, datasheet or test
              report. Verify the connector conformity to BS EN IEC 62196-2. File both pieces of
              evidence in the customer handover pack. The exemption is real but conditional —
              without conformity evidence it does not apply, and the install needs an AFDD or it
        ...
        <Scenario
          ...
          situation={
            <>
              You are installing a 7 kW dedicated EV charger on the outside wall of a three-bed
              semi. The property is on a TN-C-S (PME) supply with a 100 A main fuse. The customer
              parks on the driveway. The charger is a mainstream modern unit with a Declaration of
              Conformity to BS EN 61851 series, a Type 2 connector conforming to BS EN IEC 62196-2,
              built-in Type B RCD on the charging output, built-in DC fault current detection, and a
              manufacturer Declaration that the unit satisfies Reg 722.411.4(e) by built-in
              PEN-fault detection within the 5-second window. The supply cable from the consumer
              unit is sized for 32 A (10 mm² Twin and Earth on the recommended installation method).
            </>
          }
          whatToDo={
            <>
              Start with the document check — the manufacturer Declaration of Conformity to BS EN
              61851 (acceptance evidence for Reg 722.421.1.7.201 AFDD exemption), the connector
              conformity to BS EN IEC 62196-2, and the Reg 722.411.4(e) declaration. File all three
              in the install pack. Apply Section 722 — the supply circuit gets a Type A or Type B
              RCD per the manufacturer recommendation (here Type B is built into the charger so
              upstream is Type A 30 mA RCD per Section 722 default), the AFDD is omitted under the
              documented exemption, and protective earthing applies via the PME MET because route
              (e) is satisfied by the built-in detection rather than via a route (b) electrode. Run
              the supply cable, terminate at the charger, terminate at the consumer unit, label the
              new circuit. Commission per the manufacturer guide — power up, run the self-test,
              verify the PEN-fault detection self-test passes, simulate a connect / disconnect
              cycle, confirm the unit reaches the network and the customer app pairs. Run the
              standard Section 722 inspection — continuity, insulation resistance, polarity, Zs, RCD
              trip times. Issue the EIC with the Section 722 declaration. Notify Building Control
              through the firm's Competent Persons Scheme. Hand the customer the documentation pack
              including the OZEV grant paperwork.
            </>
          }
          whyItMatters={
            <>
              Modern dedicated EV chargers make Section 722 compliance straightforward because the
              manufacturer has done the regulatory work — built-in PEN-fault detection (route e),
              Type B internal DC fault detection, BS EN 61851 conformity (AFDD exemption), BS EN IEC
              62196-2 connector conformity. The installer applies Section 722 by selecting compliant
              equipment, terminating it correctly, recording the conformity evidence and running the
              standard inspection. The customer ends up with a safe install on a TN-C-S supply, with
              the open-PEN risk managed by built-in detection and the documentation chain complete
        ...
        <Quiz
          title="Section 722 EV charging, Open-PEN and Reg 722.411.4 — knowledge check"
