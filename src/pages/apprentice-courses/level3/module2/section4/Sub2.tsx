...
const TITLE = 'BS 7671 Section 712/722/753 + ENA G98/G99 (4.2) | Level 3 Module 2.4.2 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question: 'What is BS 7671 Section 712 and what does it cover?',
    options: [
  ...
  {
    id: 2,
    question: 'What is BS 7671 Section 722 and what does it cover?',
    options: [
  ...
  {
    id: 3,
    question: 'What is BS 7671 Section 753 and what does it cover?',
    options: [
  ...
  {
    id: 4,
    question: "What's the practical 16 A per phase boundary for ENA G98 vs G99?",
    options: [
...
const faqs = [
  {
    question:
      'Does the A4:2026 amendment of BS 7671 apply immediately or is there a transition period?',
    answer:
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 4 · Subsection 2"
        title="BS 7671 Section 712/722/753 + ENA G98/G99"
        backTo="/study-centre/apprentice/level3-module2-section4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The electrical regulatory map for environmental tech — Section 712 (PV), Section 722 (EV),
          Section 753 (heating cables) of BS 7671:2018+A4:2026, plus ENA Engineering Recommendation
          G98/G99 for parallel-connected generators.
        </p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                Section 712 has been extensively revised and expanded in the A4:2026 amendment. The
                scope is unambiguous: &quot;The requirements of this section shall apply to PV
                installations:
              </p>
              ...
              <p>
                Topics within Section 712 include array DC voltage and isolation, DC and AC
                overcurrent protection, additional protection by RCD where required, equipotential
                bonding of array frames, signage and labelling, anti- islanding requirements at the
                AC interface, and PV-specific inspection and test.
              </p>
            </>
          }
          meaning={
            <>
              Section 712 is the electrical regulatory home for every PV installation in the UK —
              grid-connected, off-grid, and hybrid with battery storage. The A4:2026 revision was
              material — designers and installers must apply the current text. Section 712 sits in
              Part 7 of BS 7671 (Special Installations or Locations) and applies in addition to the
              general requirements of Parts 1-6. Detailed application is taught in MCS qualification
              2399.
            </>
          }
        ...
        <VideoCard
          ...
          caption={
            <>
              ...
              Mindset opens an inverter and walks the IGBT bridge, MPPT and anti-islanding — useful
              context before you read the regs and the G98 / G99 grid-connection rules below.
            </>
          }
        />
        ...
        >
          <p>The Section 722 specifics for an EV charging install:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>RCD selection</strong> — Type B RCD (detects AC, pulsating DC and smooth DC)
              OR Type A RCD plus RDC-DD (residual direct current detecting device that adds
              smooth-DC detection to a Type A RCD). Type AC RCD is not adequate for EV charging.
            </li>
            <li>
              <strong>PEN-fault protection</strong> — open-PEN protection device built into the
              charger, OR earth electrode for TT-earthed EV.
            </li>
            <li>
              <strong>Isolation</strong> — local accessible isolation at the charge point, dedicated
              MCB at the consumer unit.
            </li>
            <li>
              <strong>Cable selection</strong> — sized for sustained continuous load (charging
              sessions of hours), with thermal capacity the design constraint.
            </li>
            <li>
              <strong>Smart-charging compliance</strong> — the Smart Charge Point Regulations 2021
              require demand-side response capability on units sold for installation. A separate
              regulation from BS 7671 but bites at the same install.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Section 722 has been significantly amended in A4:2026 to reflect updated requirements
              for EV charging installations, including refinements to RCD selection, open-PEN
              protection requirements for PME-supplied installations, and integration with
              smart-charging functionality. Regulation 715.524.201 within Chapter 71 confirms that
              Section 722 covers electric vehicle charging installations.
            </>
          }
          meaning={
            <>
              Section 722 sits in Part 7 of BS 7671. The A4:2026 amendments are material — designers
              and installers must apply the current text. The PEN-fault risk management is the
              section&apos;s headline technical issue. As Unit 301 is overview level, recognise
              where Section 722 sits and what its main concerns are; detailed application is taught
              in EV-specific qualification 2921.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              Section 753 has been completely revised and retitled in A4:2026. Its scope has been
              extended to apply to embedded electric heating systems for surface heating. The
              requirements apply to electric heating systems for de-icing, frost prevention and
              similar applications and cover both indoor and outdoor systems. New regulations have
              been added (relocated from Chapter 53) covering impact protection and the installation
              of heating cables. Industrial and commercial heating systems complying with BS EN
              60519, BS EN 62395 and BS EN 60079 are not covered by this section.
            </>
          }
          meaning={
            <>
              Section 753 is the special-installation chapter for electric heating cables —
              typically used in electric underfloor heating, trace heating on outdoor pipework, and
              de-icing on gutters and roofs. Pure water-based underfloor heating fed by a heat pump
              uses water pipes (not heating cables) and is governed by general Part 4-6
              requirements, not Section 753. Hybrid systems combining wet underfloor with electric
              trace heating fall within Section 753. The complete revision in A4:2026 is one of the
              major changes designers and installers need to apply.
            </>
          }
        ...
        >
          <p>The two thresholds in detail:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>G98 fast-track</strong> — applies to fully-type-tested generators with output
              up to and including 16 A per phase per inverter. Connection notification can be made
              after commissioning (within 28 days). The DNO does not pre-approve the connection.
              Most domestic 4 kW PV inverters quote 3.68 kW max output to stay G98-eligible.
            </li>
            <li>
              <strong>G99 pre-application</strong> — applies to generators above 16 A per phase, and
              to all generators (regardless of size) at sites where pre- existing G98 or G99
              generators already exist. Pre-application required; the DNO assesses local network
              capacity and confirms or qualifies the connection. Typical approval timeline 2-12
              weeks depending on local conditions.
            </li>
            <li>
            ...
            <li>
              <strong>Three-phase</strong> — the 16 A per phase limit is per-phase, so three-phase
              G98 limit is 16 A × 230 V × 3 = 11.04 kW total. Some installers split a larger system
              into multiple G98 inverters across phases to avoid the G99 timeline.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Why anti-islanding is a hard safety requirement, not a configuration choice:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Line workers respond to faults by isolating the affected section of the network. They
              expect the section to stay dead while they work on it.
            </li>
            <li>
              A local generator continuing to export into the isolated section creates a live
              conductor where the line worker expects no voltage. Result: shock risk, potentially
              fatal.
            </li>
            <li>
              The G98/G99 anti-islanding requirement protects line workers, not the customer. The
              customer&apos;s &quot;but I want power in a cut&quot; is addressed via
              deliberately-islanded hybrid inverters that disconnect from the grid first.
            </li>
            <li>
              Loss-of-mains detection settings (vector shift, ROCOF, voltage / frequency limits) are
              tested at commissioning and verified at periodic inspection. Tampering with the
              settings is a criminal offence under the Electricity Safety, Quality and Continuity
              Regulations 2002.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer has an existing G98-notified PV system. Installer adds a battery with a
              separate grid-connection inverter. Each inverter is below 16 A per phase, so installer
              assumes G98 covers it. The DNO disagrees — adding a second generator at a site with a
              pre-existing G98 connection triggers G99. The connection is non-compliant; the DNO may
              require disconnection until G99 application is approved retrospectively. Customer is
              unhappy; trade gets the blame.
            </>
          }
          doInstead={
            <>
              The G98/G99 rule is &quot;G98 applies to a single generator below 16 A; G99 applies
              above 16 A OR to any second generator at a pre-existing G98/G99 site&quot;. Always
              check for pre-existing on-site generation before committing to a connection scheme.
              The MCS-certified installer manages the application; if you&apos;re first-fixing for
              the install, confirm with the installer which scheme applies before fitting any cable.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice fits an EV charger on a PME-supplied domestic property without checking the
              unit&apos;s open-PEN protection function or providing an earth electrode. PEN-fault
              eventually occurs (could be a DNO supply fault, could be corrosion at the cut-out
              neutral). The vehicle&apos;s exposed chassis rises toward line voltage relative to
              true earth; customer touching the vehicle while standing on the driveway gets a shock.
              The Section 722 / A4:2026 requirement was not satisfied.
            </>
          }
          doInstead={
            <>
              Always check the supply earthing arrangement before fitting an EV charger. On PME /
              TN-C-S, Section 722 requires either the unit&apos;s open-PEN protection function (most
              modern chargers include it) or a local earth electrode for the EV
              (TT-at-charge-point). Read the manufacturer&apos;s installation instructions — they
              usually specify exactly what protection arrangement is required. The certified
              installer signs off Section 722 compliance; if you&apos;re first-fixing, follow the
              installer&apos;s design pack precisely.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re working on a 7 kWp PV install with 10 kWh battery storage on a hybrid
              inverter rated 5 kW single-phase. Customer wants the system operational in 8 weeks for
              the spring weather. The property has no pre-existing on-site generation. The DNO is UK
              Power Networks (London). The certified installer has confirmed the grid-connection
              application route. Customer asks &quot;what regulations does this lot fall
              under?&quot;.
            </>
          }
          whatToDo={
            <>
              Walk the customer through the regulatory chain: (1) BS 7671 Section 712 — the
              special-installation chapter for the PV electrical design, including DC and AC
              isolation, RCD, anti-islanding, signage, equipotential bonding; (2) MCS MIS 3002 (PV)
              and MIS 3012 (battery storage) — the installer competence and quality standards; (3)
              ENA G99 — pre-application required because the inverter is 5 kW (above the 16 A G98
              limit). The DNO application is in. Approval timeline 4-8 weeks for a standard urban
              connection; (4) Building Regulations Part P — notifiable work, handled by the
              firm&apos;s competent-person scheme; (5) Building Regulations Part L — contributes to
              the property&apos;s SAP score, EPC will be re-issued; (6) Smart Export Guarantee —
              customer signs up with chosen supplier after commission for export tariff payment.
              Commission depends on G99 approval — so realistic commission date is when DNO clears
              the application, not when you finish first-fix.
            </>
          }
          whyItMatters={
            <>
              Customers ask &quot;what regulations apply?&quot; expecting a one-line answer. The
              honest answer is the chain — six different frameworks at different stages of the
              install. Walking the customer through it sets realistic expectations on the timeline
              (G99 is the long pole) and explains why the install pack is the size it is. As the L3
              electrician you don&apos;t run any of these processes individually, but you should
              recognise where each sits and why the customer is paying for the certified install
              rather than a cheap non-MCS alternative.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              System handover pack — operating instructions, isolation procedure, fault-finding
              flowcharts.
            </li>
            <li>DNO paperwork — G98 deemed acceptance or G99 connection agreement.</li>
            <li>
              Customer-facing quick-reference card with isolation steps and emergency contacts.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              BS 7671 EIC — issued by the competent person who designed, installed and tested the
              electrical works (often the same person on small jobs).
            </li>
            <li>
              BS 7671 Minor Works Certificate — used where the install is a small modification (rare
              on full PV / heat pump / EV jobs; common on small additions).
            </li>
            <li>
              EICR — periodic inspection report, issued by a competent person assessing an existing
              installation including any environmental tech additions.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Section 753 install considerations:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Dedicated final circuit</strong> — typically 16 A on a 30 mA RCD; sized to the
              mat's stated rating; do not share with adjacent socket circuits.
            </li>
            <li>
              <strong>RCD type</strong> — 30 mA general-purpose RCD or RCBO; Type AC adequate for
              resistive heating.
            </li>
            <li>
              <strong>Thermostat with floor sensor</strong> — sensor cable in conduit so the sensor
              is accessible for replacement without lifting the floor.
            </li>
            <li>
              <strong>Labelled isolation</strong> — at the consumer unit ('underfloor heating:
              kitchen') and at the local thermostat / isolator.
            </li>
            <li>
              <strong>Heated-area record</strong> — area of mat installed, manufacturer, mat
              reference, install date; goes on the customer pack so the future inspector can locate
              the mat without lifting the floor.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common controls-layer arrangements in a diverter / battery install:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PV-first to battery</strong> — every PV kWh charges the home battery before
              any export. Battery becomes the buffer for the household.
            </li>
            <li>
              <strong>PV-first to immersion</strong> — power diverter (myenergi Eddi or similar)
              sends excess PV to the immersion heater; battery charges only after the immersion is
              satisfied.
            </li>
            <li>
              <strong>Tariff-aware battery</strong> — battery charges from grid during cheap tariff
              windows (Octopus Go 00:30-04:30, or Agile dynamic), discharges during expensive
              evening peak.
            </li>
            <li>
              <strong>EV-first charge</strong> — Intelligent Octopus Go tariff schedules the EV
              charger and home battery jointly to cheap windows.
            </li>
            <li>
              <strong>Customer override</strong> — most apps allow a 'force charge' button for cold
              weather or guests; brief the customer at handover.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>SPD types and where each is appropriate:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type 1</strong> — direct-strike protection at the service entrance; for
              buildings with a structural lightning protection system per BS EN 62305.
            </li>
            <li>
              <strong>Type 2</strong> — switching surge and indirect lightning protection at the
              consumer unit; current standard practice for most UK installs.
            </li>
            <li>
              <strong>Type 3</strong> — equipment-end protection at sensitive accessories (server
              room, control panel, medical equipment); supplements Type 2.
            </li>
            <li>
              <strong>Type 1+2 combined</strong> — service-entrance location where the building
              lacks a lightning protection system but is at higher risk (rural, overhead supply,
              exposed location).
            </li>
            <li>
              <strong>End-of-life replacement</strong> — module-style SPDs are designed to be
              replaced when the indicator turns red; customer-friendly maintenance task.
            </li>
          </ul>
        </ConceptBlock>
