...
const TITLE = 'Pre-installation considerations (5.1) | Level 3 Module 2.5.1 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: "What's the typical DNO supply upgrade timeline and what triggers it?",
    options: [
  ...
  {
    id: 4,
    question: 'What does "trade coordination" mean on a typical heat-pump retrofit?',
    options: [
  ...
  {
    id: 5,
    question: "What's the role of a site survey before any environmental tech install?",
    options: [
  ...
  {
    id: 7,
    question: "What's the customer-facing implication of a G99 grid-connection application?",
    options: [
...
const faqs = [
  ...
  {
    question:
      "What's the first conversation to have with the customer about their existing electrical infrastructure?",
    answer:
  ...
  {
    question:
      "How should I respond when the customer asks 'can you just throw this in for cash, off the books?'",
    answer:
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 5 · Subsection 1"
        title="Pre-installation considerations"
        backTo="/study-centre/apprentice/level3-module2-section5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The work before the kit-fit — site survey, supply capacity check, MCS design pack,
          customer expectations, trade coordination, planning and grid-connection lead times. The
          dependency chain that decides whether the install hits its commission date or slips.
        </p>
        ...
        >
          <p>The MD calc inputs:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Existing loads</strong> — lighting, sockets, cooker, immersion, electric
              shower, any existing PV reverse-protection MCB. Apply diversity per On-Site Guide /
              IET Guidance Note 1.
            </li>
            <li>
              <strong>New environmental loads</strong> — heat pump (continuous, 30-40 A), EV charger
              (continuous, 30-40 A), battery import-charge (15-30 A typically), MVHR (1 A
              negligible), biomass boiler controls (1-2 A negligible).
            </li>
            <li>
              <strong>Supply capacity</strong> — main fuse rating from the cut-out (60 A, 80 A or
              100 A typical for single-phase). Three-phase available? DNO upgrade feasible?
            </li>
            <li>
              <strong>Diversity vs continuous</strong> — heat pumps and EV chargers don't diversify
              well — both can be at full load simultaneously on a cold winter evening. The
              continuous-load assumption is conservative but realistic.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;For economic and reliable design of an installation within thermal limits and
              admissible voltage drop, the maximum demand shall be determined as required by
              Regulation 311.1. When determining the maximum demand of an installation or part
              thereof, diversity may be taken into account.&quot;
            </>
          }
          meaning={
            <>
              Reg 311.1 is the regulatory hook for the MD calc. On an electrifying property the
              diversity assumptions need careful thought — heat pumps and EV chargers don&apos;t
              diversify in the way that traditional load groups do. As the L3 electrician on a
              retrofit you should challenge the installer&apos;s MD calc if it relies on optimistic
              diversity figures for continuous-load environmental kit.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-2 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Site survey</strong> — building dimensions, construction type, existing
              heating system, supply capacity, outdoor unit location options, indoor cylinder space.
            </li>
            <li>
              <strong>Heat-loss calc</strong> — per MCS MIS 3005 methodology. Room-by- room
              heat-loss at design conditions. Identifies the building&apos;s total design heat load.
            </li>
            <li>
              <strong>Flow temperature design</strong> — the lower the flow temperature, the higher
              the SCOP. Driven by the heat load and the emitter capacity. New underfloor allows
              35-45°C; upsized radiators allow 45-55°C.
            </li>
            <li>
              <strong>Emitter schedule</strong> — radiator survey, identifying which existing
              radiators need upsizing or replacing to deliver the room&apos;s heat load at the
              design flow temperature.
            </li>
            <li>
              <strong>Heat-pump selection</strong> — model and capacity to match the building heat
              load with reasonable margin. Avoid oversizing (worsens cycling and SCOP).
            </li>
            <li>
              <strong>SCOP estimate</strong> — calculated from the chosen unit&apos;s published
              performance map at the design flow temperature and UK heating season. The honest
              customer-facing running-cost number.
            </li>
            <li>
              <strong>Electrical schedule</strong> — cable size, MCB rating and type, RCD type,
              isolation arrangement, smart controls integration, bonding.
            </li>
            <li>
              <strong>Customer handover pack</strong> — all of the above plus commissioning records,
              EPC update arrangement, warranty registration, BUS grant application status.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>What MCS 020 does and does not cover:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Covers</strong> — single ASHP outdoor unit serving a single dwelling, sound
              prediction at the nearest neighbour facade, PD eligibility test for England (Wales,
              Scotland, NI follow similar approaches with their own Permitted Development codes).
            </li>
            <li>
              <strong>Does not cover</strong> — multiple units, commercial sites, ground source bore
              arrays, plant in a community heat scheme. Those need full acoustic engineer input or
              BS 4142:2014+A1:2019 assessment.
            </li>
            <li>
              <strong>Common pass strategies</strong> — choose a quieter unit, increase distance to
              boundary, fit acoustic screen on the boundary line (real pre-fab products marketed for
              ASHP screening), reposition to face a non-habitable wall, raise the unit to clear a
              fence into a quieter zone.
            </li>
            <li>
              <strong>Failure consequence</strong> — the install falls out of PD and needs a full
              planning application. Adds 8 weeks minimum, fee, and a contested application risk.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              doesn&apos;t apply (conservation areas, listed buildings, certain ASHP placements,
              large freestanding wind / hydro). 8-week statutory determination period; longer in
              practice for contested applications.
            </li>
            <li>
              <strong>Permitted Development</strong> — covers most domestic ASHP, PV, EV charging
              without separate application but subject to conditions (MCS 020 sound assessment for
              ASHP; not on listed buildings or in conservation areas without consent; not on
              principal elevations facing a highway; etc.).
            </li>
            <li>
              <strong>Grid-connection application</strong> — G98 fast-track: notify after commission
              (no timeline impact). G99 pre-application: 2-12 weeks for approval. Supply upgrade:
              4-12 weeks for DNO survey, costing and works.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common sequence dependencies:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Electrical first-fix must be ready before F-Gas commissioning — the F-Gas engineer
              needs a working supply to commission the unit.
            </li>
            <li>
              Plumbing must be charged and pressurised before the heat pump runs — dry- running or
              running into an unfilled system damages the unit.
            </li>
            <li>
              Smart controls integration depends on the heat-pump and cylinder being commissioned
              first — controls need a live system to test against.
            </li>
            <li>
              EPC update happens after commissioning — needs the new heat-pump SCOP for the updated
              rating.
            </li>
            <li>
              BUS grant claim happens after MCS sign-off — needs the install to be physically
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer asks for a heat-pump install. Apprentice (or unscrupulous installer) quotes a
              4-week commission date. MCS designer arrives, runs the MD calc, finds the
              property&apos;s 60 A main fuse can&apos;t carry the new combined load. DNO supply
              upgrade required — 6-week additional lead time. Customer is unhappy because the
              install date promised has now slipped 6 weeks. Trade gets the blame.
            </>
          }
          doInstead={
            <>
              Always run the MD calc before quoting commission dates. Where the calc shows supply
              upgrade may be needed, factor the 4-12 week DNO timeline into the customer&apos;s
              expectation. Be honest about the dependency chain — &quot;the install date depends on
              the DNO upgrade timeline; I&apos;ll confirm a date once we know that&quot;.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Heat pump goes in. Wet system reused as-is. Old radiators sized for 70-80°C gas-boiler
              flow can&apos;t deliver the room&apos;s design heat load at 45°C heat-pump flow. Heat
              pump runs at high flow temperature trying to compensate — SCOP drops to 2.5-2.8
              instead of the design 3.5+. Customer&apos;s bills go up. Customer review goes
              negative.
            </>
          }
          doInstead={
            <>
              Always check the emitter schedule against the design flow temperature. MCS MIS 3005
              requires room-by-room emitter sizing. Where existing radiators are too small, upsize
              them as part of the install. Customer- facing conversation: &quot;your old radiators
              were sized for the old gas boiler — for the heat pump to deliver the SCOP we&apos;ve
              estimated, we need to upsize 4 radiators&quot;.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Customer with 1990s 3-bed semi, 60 A single-phase main fuse, gas combi boiler, petrol
              car. Wants to electrify everything: 7 kW EV charger, 10 kW ASHP, 5 kWp PV, 10 kWh
              battery storage. Property has cavity wall insulation and decent double glazing. Roof
              is south-facing, unshaded. Customer wants everything operational in 8 weeks for the
              spring.
            </>
          }
          whatToDo={
            <>
              Run the realistic timeline through with the customer. (1) MD calc — heat pump (32 A) +
              EV (32 A) + existing baseline (15 A) = 79 A continuous, exceeds the 60 A main fuse.
              Supply upgrade or load-shedding required. (2) DNO supply upgrade to 100 A — 4-8 weeks
              lead time, customer pays the DNO directly. (3) MCS heat-pump heat-loss calc and
              emitter survey — 1-2 weeks for the certified designer; emitter upsize likely on 3-4
              radiators. (4) PV + battery G99 application (battery export inverter combined with PV
              inverter likely exceeds 16 A) — 2-8 weeks. (5) ASHP Permitted Development check
              (boundary distance, MCS 020) — typically same-day. (6) Install kit- fit — 3-5 days for
              everything together. (7) Commissioning — 1 day. Realistic total: 8-12 weeks if
              everything goes well, 12-16 weeks if the DNO upgrade is delayed. Set the
              customer&apos;s expectation accordingly — spring is plausible but not guaranteed.
            </>
          }
          whyItMatters={
            <>
              The full-electrification customer is the future of the trade. Getting their
              expectations right at the design stage is the difference between a happy long-term
              customer and a disappointed one. The electrician&apos;s honest framing of the timeline
              chain (MD calc → supply upgrade → MCS design → G99 → planning → install → commission)
              is what builds trust. Quoting a 4-week commission date because the customer wants it
              sets you and the customer up for failure.
            </>
          }
        />
        ...
        >
          <p>Upfront paper checklist before design effort starts:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EPC currency</strong> — valid EPC on the GOV.UK register, less than 10 years
              old, no fundamental insulation gaps that block grant eligibility.
            </li>
            <li>
              <strong>BUS eligibility</strong> — owner-occupied or private-rental dwelling in
              England / Wales, not new-build, no previous BUS claim on the property.
            </li>
            <li>
              <strong>Conservation / listed</strong> — affects PD eligibility for outdoor units,
              panel placement, external pipe runs. Listed Building Consent is a separate planning
              track.
            </li>
            <li>
              <strong>DNO records</strong> — request the supply ratings and any existing G98 / G99
              registrations on the meter point. Confirms the starting capacity and any earlier
              inverter still on file.
            </li>
            <li>
              <strong>Asbestos</strong> — properties built pre-2000 carry asbestos risk in soffits,
              garage roofs, behind tiles. Survey before drilling anywhere structural.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Hybrid inverter loses internet — battery still cycles on the local schedule, app
              reporting goes dark.
            </li>
            <li>
              MID generation meter fails — SEG export reading lost; PV still generates, customer
              loses tariff income until replaced.
            </li>
            <li>
              EV charger loses Wi-Fi — falls back to standalone Mode 3, smart-charge schedule
              disabled.
            </li>
            <li>
              Battery BMS comms break — pack will not arm; full power-side cabling looks fine but
        ...
        >
          <p>The pre-install planning items the apprentice should know exist:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Scaffold sign-off</strong> — erected by a NASC / CISRS-trained team, signed
              off as fit for use, weekly re-inspection during use, written handover certificate kept
              in the site file.
            </li>
            <li>
              <strong>Construction Phase Plan</strong> — required under CDM 2015 for every project;
              lists hazards, controls, PPE, emergency procedures. Domestic projects have a slimmer
              plan but still need one.
            </li>
            <li>
              <strong>Roof structural check</strong> — modern trusses are usually fine for the
              additional 12-15 kg/m² of panels but older purlin-and-rafter roofs may need sistering.
              Structural engineer report belongs in the pack on edge cases.
            </li>
            <li>
              <strong>Weather window</strong> — wind, rain and ice all affect roof access. The site
              supervisor calls the day; the apprentice does not push to work in unsafe conditions.
            </li>
            <li>
              <strong>Welfare on domestic sites</strong> — small projects often forget CDM welfare
              (toilet, hand-wash, break shelter). Customers may agree to use the property's
              facilities; that should be in the plan, not assumed.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Operating an integrated install starts with a Section 712-compliant PV array. A4:2026
              brought widespread changes to DC isolation, RCD selection and interaction with battery
              storage. If your reference book pre-dates A4:2026, check the Section 712 wording
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              verify the effectiveness of the RCD.
            </>
          }
          meaning={
            <>
              When commissioning the integrated install, RCD verification is now a single AC test at
              1×IΔn — the old multi-current sweep (½×, 1×, 5×) has been deleted. Update test
              schedules and toolbox-talk crib sheets accordingly. The change applies to all RCD
              types including the Type B units commonly fitted on EV circuits.
            </>
          }
