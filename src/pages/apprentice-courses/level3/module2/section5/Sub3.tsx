...
const TITLE = 'Maintenance requirements (5.3) | Level 3 Module 2.5.3 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question: 'How often does a typical UK domestic ASHP need a service, and what does it involve?',
    options: [
  ...
  {
    id: 2,
    question: 'What does PV array maintenance typically include?',
    options: [
  ...
  {
    id: 3,
    question: 'What does MVHR maintenance typically involve and how often?',
    options: [
  ...
  {
    id: 4,
    question: "What's the maintenance interval for a domestic biomass boiler?",
    options: [
  ...
  {
    id: 5,
    question: 'When and why do EV chargers need periodic inspection?',
    options: [
...
const faqs = [
  {
    question:
      'Who carries out the annual service on a heat pump — the original installer, the manufacturer, or someone else?',
    answer:
  ...
  {
    question:
      "What's the customer's responsibility vs the installer's responsibility for ongoing maintenance?",
    answer:
  ...
  {
    question:
      'Are there environmental waste considerations specific to the PV / battery / EV install?',
    answer:
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 5 · Subsection 3"
        title="Maintenance requirements"
        backTo="/study-centre/apprentice/level3-module2-section5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Maintenance for environmental technology systems — heat pump annual service, PV
          inspection, EV charger periodic inspection, MVHR filter changes, biomass ash and flue
          clean. Plus regulated waste streams (F-Gas, lithium-ion, WEEE) and the L3 electrician's
          responsibility on a maintenance call.
        </p>
        ...
        >
          <p>Annual service scope by trade:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>F-Gas refrigerant</strong> — charge weight verified, leak test across all
              joints, sub-cooling and superheat checks, suction / discharge pressures recorded.
            </li>
            <li>
              <strong>Wet system</strong> — system pressure, expansion vessel charge, inhibitor
              concentration test, flow rate verification, emitter balancing check, sludge / debris
              check at filter.
            </li>
            <li>
              <strong>Electrical</strong> — supply check, isolation operation, RCD test (operating
              time at I△n and 5×I△n; smooth-DC test for Type B), Zs at the outdoor isolator,
              controls integration test.
            </li>
            <li>
              <strong>Outdoor unit</strong> — fins clean of leaves / debris, condensate drain clear,
              mountings secure, no corrosion, no obstruction to airflow.
            </li>
            <li>
              <strong>Performance check</strong> — flow temperature, return temperature, ambient
              temperature, instantaneous COP measured. Compare with last year&apos;s figures and the
              design SCOP estimate.
            </li>
            <li>
              <strong>Smart controls</strong> — firmware up to date, weather compensation curve
              still appropriate, error log reviewed, customer reports addressed.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>PV maintenance schedule:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Annual visual inspection</strong> — panels secure, no physical damage, no
              significant soiling. Mountings firm, no corrosion. Cables in conduit / clipping
              intact, no rodent damage. MC4 connectors firm. Inverter ventilation clear, no
              overheating signs. Signage at consumer unit / meter / inverter / DC isolators still
              present and durable.
            </li>
            <li>
              <strong>Annual datalog review</strong> — total generation kWh, daily / weekly profile,
              error events. Compare against expected for the season. Underperformance vs expected
              suggests soiling, shading, panel degradation or inverter issue.
            </li>
            <li>
              <strong>5-year periodic inspection (EICR)</strong> — full BS 7671 inspection and test.
              Continuity, IR, polarity, Zs, RCD test on the PV circuit. Update certificate.
              Particularly important on landlord properties where the Electrical Safety Standards
              Regulations 2020 make EICR mandatory.
            </li>
            <li>
              <strong>Inverter replacement</strong> — typically year 8-15 depending on manufacturer
              warranty and inverter type. Replacement is straightforward — disconnect old, fit
              replacement of compatible spec, recommission.
            </li>
            <li>
              <strong>Soiling cleaning</strong> — as needed, typically every 1-3 years in urban /
              coastal / dusty locations. Specialist PV cleaners use deionised water and soft
              brushes; high-pressure jets damage panel surfaces.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>EV-specific maintenance points:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Cable and plug condition — look for damage, fraying, melted spots.</li>
            <li>Mounting and weatherproofing — IP rating intact, no water ingress.</li>
            <li>RCD operation — Type B or Type A + RDC-DD; smooth-DC test if Type B.</li>
            <li>
              Open-PEN protection function — confirmed working per manufacturer&apos;s test
              procedure (where the unit has built-in protection).
            </li>
            <li>
              Earthing — Zs at the charge point, earth electrode resistance if TT arrangement.
            </li>
            <li>Firmware — update to latest manufacturer-supplied version.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>MVHR maintenance schedule:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Filter changes</strong> — every 6-12 months. Kitchen and bathroom extract
              filters can clog faster.
            </li>
            <li>
              <strong>Heat exchanger clean</strong> — every 1-2 years. Vacuum or wash exchanger
              plates per manufacturer&apos;s instructions.
            </li>
            <li>
              <strong>Ductwork inspection</strong> — every 3-5 years. Look for blockages, condensate
              accumulation, rodent damage.
            </li>
            <li>
              <strong>Boost-control check</strong> — humidity sensors / PIRs operating correctly.
            </li>
            <li>
              <strong>Air-flow rate verification</strong> — at major service intervals, anemometer
              at supply / extract terminals, balanced per design.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Customer-side weekly / monthly tasks:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Top up pellet hopper as needed.</li>
            <li>Empty ash compartment monthly (more often in heavy use).</li>
            <li>Visual check of fuel feed (auger), no obstructions.</li>
            <li>Check pellet quality — kiln-dried, low-ash, manufacturer-approved.</li>
          </ul>
          <p>Annual professional service:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Full strip-down clean of combustion chamber and ash compartment.</li>
            <li>Auger inspection, lubrication, replacement of wear parts.</li>
            <li>Igniter (glow plug) check and replacement if required.</li>
            <li>Combustion fan inspection.</li>
            <li>Flue inspection (often a chimney sweep separately).</li>
            <li>Controls firmware update, electrical scope check.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The four headline regulated waste categories on environmental tech installs:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>F-Gas refrigerant</strong> — recovery only, by F-Gas-certified engineer.
              Venting is a criminal offence under Environmental Permitting Regulations. Recovered
              refrigerant goes back to the supplier or specialist recycling stream. Records kept in
              the F-Gas register.
            </li>
            <li>
              <strong>Lithium-ion batteries</strong> — hazardous waste under the Hazardous Waste
              Regulations and WEEE Regulations. Cannot go to landfill or general recycling.
              Authorised treatment centres only. Battery transport regulated under ADR. Improper
              disposal is a criminal offence with significant fines and material fire risk.
            </li>
            <li>
              <strong>Electronic equipment (inverters, controls, smart kit)</strong> — WEEE
              Regulations. Producer-take-back schemes, household waste recycling centres (HWRCs), or
              licensed WEEE carriers. Cannot go to general waste.
            </li>
            <li>
              <strong>Standard recyclables</strong> — copper cabling, aluminium frames, steel
              components, cardboard packaging. Established recycling streams; the installer&apos;s
              firm should have a waste management plan covering these.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What to bring on the EICR visit and what to record:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>MFT firmware</strong> — confirm test firmware is updated to the A4:2026 RCD
              test method (single AC test at 1×IΔn). Older firmware may still run the multi-current
              sequence; the value that goes on the schedule is the 1×IΔn reading.
            </li>
            <li>
              <strong>Camera or phone</strong> — take inverter, heat pump unit, EV charger and
              battery isolator photos. Reg 653.1 / 653.2 explicitly allow images appended to the
              report. One photo of a serial-numbered inverter label captures install state cleanly.
            </li>
            <li>
              <strong>Appendix 6 notes</strong> — the EICR producer's notes table is the template
              for guidance to the recipient. Cover the env tech findings with C1 / C2 / C3 / FI
              codes plus the recipient action expected.
            </li>
            <li>
              <strong>Photos of signage</strong> — Section 712 PV signage at consumer unit, meter
              and inverter; EV charger isolator labelling per Section 722; battery storage isolator
              and identification per the 2026-aligned scheme. Missing or illegible signage is
              typically C3.
            </li>
            <li>
              <strong>Test method note</strong> — record that the RCD verification used A4:2026
              single AC test at 1×IΔn. Older EICRs the inspector compares against will quote
              multi-current readings; document the methodology change.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Customer-side checks by frequency:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Weekly</strong> — heat pump display green-light check; PV inverter producing
              kWh in daylight; MVHR filter status indicator clean; biomass pellet hopper level; EV
              charger plug condition.
            </li>
            <li>
              <strong>Monthly</strong> — heat pump outdoor unit clear of leaves and debris; PV array
              visual from a safe vantage (no obvious cracks or shading); MVHR filters changed if
              indicator says due; biomass ash compartment emptied; EV charger plug seated firmly.
            </li>
            <li>
              <strong>Quarterly</strong> — PV daily kWh compared to expected for the season; heat
              pump bills compared to last year for the same month; smoke alarm and emergency
              lighting (flat blocks) functional test.
            </li>
            <li>
              <strong>Warning signs — ring the installer</strong> — heat pump short-cycling (turning
              on and off every few minutes); inverter showing red fault light; MVHR fan louder than
              usual; biomass repeated ignition failure; EV charger tripping on every charge attempt;
              battery storage refusing to charge or discharge; sustained higher bills with no
              obvious cause.
            </li>
            <li>
              <strong>Annual reminders</strong> — heat pump service due (calendar reminder); MVHR
              full filter replacement; PV aftercare visit; biomass full strip-down service; 5-year
              EICR if landlord property approaching the cycle.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The producer of hazardous waste (which includes WEEE, refrigerants, lithium-ion
              batteries) must ensure the waste is consigned to an authorised disposal or treatment
              route, accompanied by a consignment note, and delivered to an authorised facility.
              Improper disposal — including sending hazardous waste to landfill or to a
              non-authorised carrier — is a criminal offence.
            </>
          }
          meaning={
            <>
              The Hazardous Waste Regulations make the producer (typically the installer or service
              provider on environmental tech) responsible for the waste from the moment it&apos;s
              removed from service. The chain of consignment notes proves the waste reached an
              authorised facility. The Environment Agency (England) / Natural Resources Wales / SEPA
              (Scotland) / NIEA (NI) enforce. As the L3 electrician on a service / decommissioning
              visit you should recognise the regulatory obligation and use the firm&apos;s
              waste-handling procedure — never improvise.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer decides to skip the £200 annual service in year 2. SCOP drifts down (sludge
              in wet system, drift in compensation curve, slight refrigerant leak undetected). By
              year 4 the customer&apos;s bills are noticeably higher than they were in year 1;
              warranty has defaulted; small problems have cascaded into bigger ones. The £600 saved
              over three years has cost £2,000 in higher bills and £1,500 in non-warranty repair
              work.
            </>
          }
          doInstead={
            <>
              Stress the importance of annual service at handover. Frame it as a non-negotiable
              operating cost — comparable to an annual gas-boiler service or an MOT for a car. The
              MCS-certified installer often offers a service contract bundling 5-10 years of annual
              visits at a discount. Customers who opt out should be told plainly what they&apos;re
              giving up — warranty cover and SCOP retention.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Battery has reached end of life. Apprentice / installer removes it and drops it in the
              customer&apos;s general waste skip. Bin lorry catches fire en route to landfill
              (lithium-ion fires in waste streams are a real and growing problem). Investigation
              traces the battery back to the install firm. The firm faces a criminal prosecution
              under the Hazardous Waste Regulations, plus the bin firm&apos;s civil claim, plus
              reputational damage.
            </>
          }
          doInstead={
            <>
              Lithium-ion batteries are hazardous waste — authorised treatment only. The
              MCS-certified installer normally arranges decommissioning via the manufacturer&apos;s
              take-back scheme or a specialist battery recycler. Battery transport is itself
              regulated under ADR. As the L3 electrician on a battery decommissioning visit, never
              improvise — use the firm&apos;s waste-handling procedure and the authorised waste
              carrier.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re carrying out a 5-year EICR on a private rented property in England — a
              3-bed semi with 5 kWp PV (G98), 7 kW EV charger (PME with charger&apos;s open-PEN
              protection), 10 kW ASHP, and a 10 kWh battery. The Electrical Safety Standards
              Regulations 2020 apply. The customer is the landlord; the tenants are at home.
            </>
          }
          whatToDo={
            <>
              Plan the EICR before starting. The fixed installation includes the original house
              circuits plus the four added environmental tech circuits. Schedule with the tenants
              for power-down windows. Notify the DNO if you&apos;re going to fully isolate the
              supply. For each circuit: visual inspection, continuity, IR, polarity, Zs, RCD test
              (Type B / RDC-DD for EV), open-PEN protection function test (EV charger), DC-side
              checks (PV with both DC and AC isolators locked-off and verified dead), labelling /
              signage check at all isolation points. Issue the EICR with C1 / C2 / C3 / FI codings
              as appropriate. C1 / C2 findings remediated within 28 days (legal duty under the
              Regulations). Provide the report to the landlord and signpost the requirement to
              provide it to the tenants. Update the customer handover pack with the new EICR.
            </>
          }
          whyItMatters={
            <>
              Five-year EICR is the BS 7671 baseline + the Electrical Safety Standards Regulations
              legal requirement for landlord properties in England. Environmental tech additions are
              part of the fixed installation and fall within scope — the landlord&apos;s legal
              compliance depends on the EICR covering everything. As the L3 electrician your
              professional reputation rests on a thorough, documented inspection. Skipping the PV
              DC-side check or the EV open-PEN check leaves dangerous gaps.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              A periodic inspection (EICR) of an installation including PV, EV, battery or heat-pump
              kit follows the standard Part 6 process plus the technology-specific checks. The
              frequency is determined by Regulation 652.1 from the type of installation, its use,
              the quality of maintenance, and external influences.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              in Appendix 6) to be taken into account on the Condition Report. Regulation 653.2 now
              requires the report to include guidance for the recipient(s) based on the model in
              Appendix 6. A note has also been added pointing out that photographic and/or
              thermographic images can be appended to the report.
            </>
          }
          meaning={
            <>
              Two changes affect every EICR you produce — the Appendix 6 notes for the report
              producer must be applied, and customer-facing recipient guidance must be included.
              Photos and thermographic images can be appended; this is particularly useful on
              environmental tech additions where a single image of the inverter, battery isolator or
              EV charger label captures the install state cleanly.
            </>
          }
