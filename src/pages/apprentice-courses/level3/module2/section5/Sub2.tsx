...
const TITLE = 'Commissioning and handover (5.2) | Level 3 Module 2.5.2 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'What does PV commissioning involve beyond the BS 7671 electrical test?',
    options: [
  ...
  {
    id: 5,
    question: 'What signage is required at the consumer unit / meter position after a PV install?',
    options: [
  ...
  {
    id: 6,
    question: "What's the role of the electrical generation meter in a PV install's commissioning?",
    options: [
...
const faqs = [
  {
    question:
      "If I'm not the MCS-certified installer, what's my commissioning sign-off responsibility?",
    answer:
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 5 · Subsection 2"
        title="Commissioning and customer handover"
        backTo="/study-centre/apprentice/level3-module2-section5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The work that converts a physical install into a working, accountable system — BS 7671
          inspection and test, functional test, performance verification, customer training,
        ...
        >
          <p>What the EIC certifies for an environmental tech circuit:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Visual inspection</strong> — labelling at consumer unit, at local isolation,
              at the equipment. Conductor identification correct (brown / blue / green-and-yellow).
              Cable mechanical protection adequate. Terminal tightness verified. Equipment securely
              mounted. Manufacturer&apos;s instructions followed.
            </li>
            <li>
              <strong>Continuity of protective conductors</strong> — R1+R2 method (or equivalent)
              confirms the CPC is continuous from earth bar to the most distant terminal.
            </li>
            <li>
              <strong>Insulation resistance</strong> — measured at 500 V DC for LV circuits, between
              live conductors and between live conductors and earth. Minimum 1 MΩ per BS 7671 Table
              64.
            </li>
            <li>
              <strong>Polarity</strong> — line, neutral and earth correctly connected at every
              accessory and termination.
            </li>
            <li>
              <strong>Zs at the most distant point</strong> — measured loop impedance used to
              confirm automatic disconnection times (Section 411.3) are met.
            </li>
            <li>
              <strong>RCD test</strong> — operating time at I△n and 5×I△n, confirming BS EN 61008 /
              BS EN 61009 thresholds are met. Type B RCDs require additional smooth-DC tests.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Heat-pump system commissioning:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>F-Gas refrigerant</strong> — charge weight verified, leak test, pressure /
              temperature checks across the cycle.
            </li>
            <li>
              <strong>Wet system</strong> — pressure test, fill and bleed, flow rate verification
              per emitter, balancing, anti-corrosion inhibitor dose.
            </li>
            <li>
              <strong>Heat pump system</strong> — flow temperature setpoint configured per design,
              defrost cycle verified, weather compensation curve set, smart controls integration
              tested, hot water cylinder priority confirmed, anti- legionella cycle verified.
            </li>
            <li>
              <strong>Performance check</strong> — flow temperature and ambient at first run,
              instantaneous COP estimated, compared against design SCOP estimate.
            </li>
          </ul>
          <p>PV system commissioning:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DC-side</strong> — string Voc and Isc measured, matched against design.
              Polarity at inverter input confirmed.
            </li>
            <li>
              <strong>AC-side</strong> — inverter switch-on, anti-islanding test (simulated grid
              disconnect verifies disconnection within G98/G99 time limits), generation meter
              accuracy, export verification with smart meter.
            </li>
            <li>
              <strong>Functional check</strong> — inverter MPPT operating, error log clean, datalog
              producing readings.
            </li>
            <li>
              <strong>Performance check</strong> — irradiance at commissioning measured or
              estimated, instantaneous output compared against expected output.
            </li>
            <li>
              <strong>Signage</strong> — durable warning signs at consumer unit, meter position,
        ...
        >
          <p>The heat-pump handover talking points:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>How it works</strong> — &quot;the heat pump runs continuously at low
              temperature, not on-off cycles like a gas boiler. The flow temperature has been set to
              deliver the SCOP we estimated.&quot;
            </li>
            <li>
              <strong>Thermostat strategy</strong> — &quot;set the room thermostat to your desired
              temperature and leave it. Avoid 5°C overnight setbacks — that&apos;s a gas-boiler
              control strategy and costs you SCOP. A modest 1-2°C overnight setback is fine if you
              want it.&quot;
            </li>
            <li>
              <strong>Hot water schedule</strong> — &quot;the cylinder is heated once or twice a
              day, typically morning and evening. The smart controls handle this
              automatically.&quot;
            </li>
            <li>
              <strong>Cold spells</strong> — &quot;in cold spells the heat pump consumes more
              electricity because the temperature lift is bigger. This is normal. The SCOP estimate
              already accounts for it.&quot;
            </li>
            <li>
              <strong>Defrost</strong> — &quot;the unit briefly stops heating during defrost (a few
              minutes every hour or two in cold weather). The buffer tank rides through this without
              temperature drop.&quot;
            </li>
            <li>
              <strong>Annual service</strong> — &quot;the unit needs an annual service to keep the
              warranty valid and the SCOP at design level. We&apos;ll be in touch in 12
              months.&quot;
            </li>
            <li>
              <strong>Aftercare contacts</strong> — installer aftercare, manufacturer support,
              warranty contact, emergency contact (e.g. for a refrigerant leak).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The follow-up visit checklist:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heat meter reading</strong> — kWh of heat delivered since commissioning (most
              modern systems include an MID-class heat meter as part of the BUS grant requirement).
            </li>
            <li>
              <strong>Electricity meter reading</strong> — kWh of electricity consumed by the heat
              pump and ancillaries since commissioning.
            </li>
            <li>
              <strong>SCOP-to-date</strong> — heat / electricity. Compare to design SCOP.
            </li>
            <li>
              <strong>Datalog review</strong> — flow / return temperatures, ambient, defrost
              frequency, any error codes since commissioning.
            </li>
            <li>
              <strong>Customer feedback</strong> — what the customer has noticed (good or bad).
              Often surfaces a control-strategy issue you can correct in five minutes.
            </li>
            <li>
              <strong>Adjustment record</strong> — any changes made (weather-comp curve, schedule,
              setpoint) recorded with date and reason. Goes back into the handover pack so the next
              visit has the history.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electrical Installation Certificate (EIC)</strong> — your BS 7671 inspection
              and test record for the new electrical work.
            </li>
            <li>
              <strong>MCS Install Certificate</strong> — issued by the MCS-certified installer,
              confirming compliance with the relevant MIS standard.
            </li>
            <li>
              <strong>Building Regs Part P compliance certificate</strong> — issued by the
              firm&apos;s competent-person scheme (NICEIC, NAPIT etc.), typically posted within 30
              days of install.
            </li>
            <li>
              <strong>Updated EPC</strong> — reflecting the new SAP rating after the install.
            </li>
            <li>
              <strong>BUS / SEG enrolment confirmation</strong> — proof the customer is receiving
              the relevant funding stream.
            </li>
            <li>
              <strong>Manufacturer warranties</strong> — heat pump unit, indoor cylinder, inverter,
              panels, battery, MVHR unit. Plus the MCS Workmanship Warranty.
            </li>
            <li>
              <strong>Commissioning records</strong> — F-Gas, wet system, electrical, functional.
              Combined into a single pack.
            </li>
            <li>
              <strong>System operating instructions</strong> — written customer-facing manual,
              plain-English. Reinforces the spoken handover.
            </li>
            <li>
              <strong>System diagrams</strong> — schematic of the install, isolator locations, key
              components labelled.
            </li>
            <li>
              <strong>Aftercare and service contacts</strong> — installer, manufacturer, emergency.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The MCS Code of Practice requires certified installers to provide customers with a
              complete handover pack including: the MCS install certificate; relevant manufacturer
              documentation; commissioning records; operating instructions; performance estimate;
              warranty information; and aftercare contact details. The Code also requires the
              installer to walk the customer through the operating procedure at handover.
            </>
          }
          meaning={
            <>
              The Code makes the handover pack and walkthrough mandatory parts of MCS- certified
              installation. Skipping or skimping on either is a Code breach that can affect the
              installer&apos;s certification. As an apprentice on an MCS install your contribution
              to the pack (the EIC) is your professional responsibility; the broader pack is the
              certified installer&apos;s.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice (or installer) finishes commissioning, hands the customer the manual, and
              leaves. Customer files the manual without reading it. Customer operates the heat pump
              like a gas boiler — aggressive overnight setbacks, on-off scheduling, sometimes
              &quot;turning the radiators off in unused rooms&quot; (which messes up the
              system&apos;s flow rate balancing). SCOP posts at 2.5 instead of the design 3.5.
              Customer&apos;s bills are higher than promised. Negative review, unhappy customer,
              lost referrals.
            </>
          }
          doInstead={
            <>
              Make the spoken handover non-negotiable. Schedule it as a separate walkthrough if the
              customer wasn&apos;t around for commissioning. Walk them through how the system
              operates, what to expect, what to avoid, and where to get help. Five-to-ten minutes
              that prevents months of dissatisfaction. The MCS Code requires it; the customer
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice completes the electrical commissioning — continuity, IR, polarity, Zs, RCD
              test all pass. EIC issued. But the labelling at the consumer unit / inverter / DC
              isolator hasn&apos;t been done, the warning signs at the meter position aren&apos;t
              fitted, and the system diagram isn&apos;t in the install pack. A maintainer six months
              later doesn&apos;t realise there&apos;s a parallel generator on the property, isolates
              the main switch, and gets a shock from the still-live PV inverter terminals.
            </>
          }
          doInstead={
            <>
              The visual inspection is part of the BS 7671 initial verification — and that includes
              labelling and signage. Don&apos;t issue the EIC until the labels are on, the warning
              signs are durable and visible at every isolation point, and the system identification
              is recorded. The signage is safety- critical for future maintainers; treat it with the
              same seriousness as the continuity reading.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re commissioning a heat-pump install. The homeowner who commissioned the work
              is overseas; their elderly mother lives in the property and is the day-to-day user.
              She&apos;s sceptical about the new system, prefers her old gas boiler, and wants to
              know &quot;how she keeps warm&quot;. The MCS-certified installer asks you to do the
              customer handover walkthrough.
            </>
          }
          whatToDo={
            <>
              Slow down. The technical handover scripts assume a customer who&apos;s bought into the
              system; this customer hasn&apos;t. Start with empathy: &quot;the new system works
              differently from your old gas boiler — let me show you how to keep it simple.&quot;
              Walk her through: thermostat at her desired temperature, leave the system on, hot
              water comes on at the cylinder schedule, smart controls handle the rest. Show her
              where the emergency stop is and which button summons help. Explain that the unit
              outdoors is normal and will sound like a quiet refrigerator. Leave the operating
              manual but also write a single-side &quot;quick reference&quot; in plain English.
              Confirm the aftercare contact and reassure her that she can call. Don&apos;t leave
              until you&apos;re satisfied she knows how to use it. This is the highest-leverage
              handover you&apos;ll do all month.
            </>
          }
          whyItMatters={
            <>
              Customer-facing handovers vary wildly by customer. The technical install is the same;
              the communication is bespoke. An apprehensive elderly user needs simplification and
              reassurance; a tech-curious owner needs the detail. Reading the customer in the room
              and adapting the handover is the soft skill that separates a good install from a great
              one. The MCS- certified installer values an apprentice who can do this well — and the
        ...
        >
          <p>What the customer pack carries on the DNO side:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>G98 notification copy</strong> — installer name, MCS reference, inverter make
              / model / serial, type-test certificate (BS EN 50549-1 / -2), AC isolator type and
              location, energisation date.
            </li>
            <li>
              <strong>DNO acknowledgement reply</strong> — the email or portal record proving the
              DNO received the notification. Without this the customer cannot evidence lawful
              connection on a future house sale.
            </li>
            <li>
              <strong>Export MPAN</strong> — the supplier registers an export MPAN once the G98 is
              filed. The customer needs the MPAN to apply for Smart Export Guarantee tariff with a
              chosen supplier. Six-month delays here are common if the paperwork chain breaks.
            </li>
            <li>
              <strong>G99 Connection Offer</strong> (where applicable) — full Offer document, signed
              acceptance, evidenced commissioning settings, witness test record where the DNO
              required one.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>BUS claim moving parts at handover:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Customer authorisation</strong> — signed at handover; lets the installer
              submit the Ofgem claim on the customer's behalf.
            </li>
            <li>
              <strong>MCS Installation Certificate reference</strong> — uploaded by the installer to
              the MCS database; the Ofgem portal cross-checks the reference.
            </li>
            <li>
              <strong>EPC currency</strong> — the property must hold a valid EPC (typically less
              than 10 years old, no outstanding loft / cavity recommendations unless exempted). A
              lapsed EPC blocks the claim.
            </li>
            <li>
              <strong>Property eligibility</strong> — owner-occupied or private rental in England /
              Wales; not new-build (different scheme); not previously claimed.
            </li>
            <li>
              <strong>Discount appearing on the customer invoice</strong> — the installer takes the
              £7,500 hit upfront; Ofgem reimburses the installer once the claim is approved.
              Customers should check the invoice line.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              specific piece of equipment to be identified by role on the certificate (for example
              an EV charger&apos;s open-PEN protection device), put it explicitly on the EIC. Future
              inspectors rely on those entries to verify the protective measures.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              Regulation 643.3 has been redrafted. Where equipment is connected and the equipment is
              likely to influence the insulation resistance verification test or be damaged by other
              test voltages, a 250 V DC insulation resistance test following connection of the
              equipment shall be used. Regardless of RCD Type (AC, A, F, B etc.), an alternating
              current test at rated residual operating current (IΔn) shall be used to verify the
              effectiveness of the RCD.
            </>
          }
          meaning={
            <>
              Two practical commissioning changes — drop the IR voltage to 250 V DC where connected
              electronics could be damaged, and run a single AC test at 1×IΔn for every RCD type.
              The old multi-current sequence is gone. Test pro-formas and toolbox-talks need
              updating to match.
            </>
          }
