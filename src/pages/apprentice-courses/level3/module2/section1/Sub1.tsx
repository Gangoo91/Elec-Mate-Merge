...
const checks = [
  {
    ...
    options: [
      'It creates energy from the air — the laws of thermodynamics don\'t apply to heat pumps.',
      ...
      'It uses solar gain on the outdoor unit during the day.',
      'It runs on hydrogen from the air.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The cell heats up and a thermocouple converts the temperature difference to a voltage.',
      ...
      'The cell glows in the dark and the light is captured by an internal mirror.',
      'A small battery inside each cell is recharged by the sunlight.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It generates extra heat from the fan motors.',
      ...
      'It uses an electric heating element to warm incoming air during winter.',
      'It seals the building so no air can leave.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'Hydrogen, geothermal, tidal, biomass.',
  ...
  },
  {
    ...
    options: [
      'A safety code for the unit — Class of Protection.',
      ...
      'A motor rating — Continuous Operating Power.',
      'A grid-connection class.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The UK is too cold for temperature to ever matter.',
      ...
      'Solar cells produce more power when cold and the UK is always cold.',
      'Temperature has no effect on PV cells at all.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'There is no difference — both are renewable.',
      ...
      'Generators are AC and demand-reduction systems are DC.',
      'Generators are domestic, demand-reduction is commercial.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'It\'s falling because nuclear is being closed down.',
      'It\'s falling because demand has collapsed.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Fit a 16 kW air-source heat pump regardless — bigger is always better.',
      ...
      'Fit a wood-burning stove and call it renewable.',
      'Tell them to put a jumper on.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'There isn\'t one — it\'s purely industry choice.',
      ...
      'EU directive — but it lapsed after Brexit.',
      'A Royal Charter requirement.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Say yes to all environmental tech to make the sale.',
      ...
      'Tell them everything is carbon-neutral by default.',
