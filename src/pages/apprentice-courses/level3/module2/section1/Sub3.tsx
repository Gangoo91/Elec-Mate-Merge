      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-2 pb-24">
        <PageFrame>
          ...
          <RegsCallout
            ...
            clause={
              <>
                Chapter 82 ("Prosumer's Low Voltage Electrical Installations") provides additional requirements, measures and recommendations for the design, erection and verification of all types of low voltage installation including local production and storage of energy. Within it, Reg 826.3 covers Energy storage, sitting alongside 826.2 (interaction with the public network), 826.5 (electric vehicle charging) and 826.7 (testing and verification).
              </>
            }
            meaning={
              <>
                BS 7671 does not have a section literally titled "Electrical Energy Storage Systems (EESS)" — the EESS label is the term used by the IET Code of Practice. In the Wiring Regulations, the storage anchor is Reg 826.3 within Chapter 82 (Prosumer's installations), which applies in addition to (not instead of) the general regulations and any product-specific standards (IEC 62619 for cells, IEC 62933 for systems). The IET Code of Practice for Electrical Energy Storage Systems gives the practical implementation guidance on siting, ventilation, fire separation and isolation.
              </>
            }
