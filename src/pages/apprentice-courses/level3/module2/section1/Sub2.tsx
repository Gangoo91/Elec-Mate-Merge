...
const TITLE = 'Main types, characteristics and purposes (1.2) | Level 3 Module 2.1.2 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question: 'What does a domestic battery storage unit actually do for a customer with PV?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: "What's the typical electrical interface for a domestic ASHP install?",
    options: [
  ...
  {
    id: 4,
    question: "What's the practical difference between an MCS Mode 3 and a Mode 4 EV charger?",
    options: [
  ...
  {
    id: 5,
    question: 'When would micro-CHP (combined heat and power) make sense over a heat pump?',
    options: [
  ...
  {
    id: 6,
    question: 'What characterises biomass heating for the domestic UK customer?',
    options: [
  ...
  {
    id: 7,
    question: "What's the practical limitation that rules out wind for most UK suburban gardens?",
    options: [
...
const faqs = [
  {
    question:
      'If I had to remember just five environmental tech families, which five would they be?',
    answer:
  ...
  {
    question:
      "Why does the task sometimes call out 'MCS' before talking about the technology itself?",
    answer:
  ...
  {
    question:
      'Why does the MVHR install sometimes specify both supply and extract grilles in one room?',
    answer:
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 1 · Subsection 2"
        title="Main types, characteristics and purposes"
        backTo="/study-centre/apprentice/level3-module2-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          A working family map of environmental technology systems an electrician will meet on UK
          installs — five core families (heat pumps, PV, EV, batteries, MVHR) plus solar thermal,
          micro-CHP, biomass, wind and micro-hydro for recognition. Each system's purpose, scale,
          regulatory home and limitation.
        </p>
        ...
        >
          <p>Headline numbers per system:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>ASHP</strong> — typical domestic size 5-16 kW heat output. SCOP 2.8-3.8 across
              a UK heating season for properly designed systems. Capital cost £10-15k typical. MCS
              MIS 3005.
            </li>
            <li>
              <strong>GSHP</strong> — same heat output range. SCOP 4.0-5.0 (more stable because
              ground temperature is steady at 8-12°C). Capital cost £20-35k typical including ground
              array. MCS MIS 3005.
            </li>
            <li>
              <strong>Hybrid heat pump</strong> — small heat pump paired with gas boiler for cold
              spells. Suits older properties with under-sized radiator systems where full
              heat-pump-only retrofit is impractical.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>kWp (kilowatt-peak)</strong> — nameplate output at Standard Test Conditions
              (1000 W/m², 25°C, AM 1.5). Real-world is normally less.
            </li>
            <li>
              <strong>Annual yield</strong> — typically 800-1100 kWh per kWp per year on UK roofs.
              Orientation, pitch and shading dominate the figure.
            </li>
            <li>
              <strong>Self-consumption</strong> — without battery, typically 25-40% of generation;
              with battery, 70-90%. Self-consumption drives the financial case.
            </li>
            <li>
              <strong>Smart Export Guarantee (SEG)</strong> — payment for exported energy. Tariffs
              vary 5-15p/kWh between suppliers. MCS-certified install required.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Why Mode 3 not Mode 1/2:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Mode 1</strong> — direct connection, no protection. Banned in the UK for
              safety reasons.
            </li>
            <li>
              <strong>Mode 2</strong> — in-cable protection (the &quot;granny lead&quot;). Allowed
              for emergency / occasional use only.
            </li>
            <li>
              <strong>Mode 3</strong> — dedicated charger with full protection and communication.
              The standard for permanent installs.
            </li>
            <li>
              <strong>Mode 4</strong> — off-vehicle DC supply. Public rapid chargers and some
        ...
        >
          <p>Key sizing considerations:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Battery capacity should match the daily PV surplus and the customer's evening load
              profile. Oversizing wastes capital; undersizing wastes generation.
            </li>
            <li>
              Tariff matters — some customers benefit from time-of-use tariffs (Octopus Cosy, Agile,
              Go) where the battery charges from cheap overnight grid as well as from PV.
            </li>
            <li>
              Backup / island operation is a separate feature — not all batteries provide it. The
              customer who wants &quot;the lights to stay on in a power cut&quot; needs to specify
              backup explicitly.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            dominant air-change pathway. SAP and SBEM credit MVHR with significant savings only when
            air permeability is below threshold values (typically below 3 m³/h/m² @ 50 Pa). In a
            leaky building the fan power consumed outweighs the heat recovered.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              regulatory home for EV charging electrical installations and that A4:2026 contains
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              domestic install), off-grid (rural / island), or replacement-supply (rare) — the same
              Section 712 applies. As the L3 electrician on site you do not need to memorise which
              case is which; you do need to recognise that PV always sits under Section 712 plus the
              relevant MCS MIS standard for installer competence.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              When you walk onto an EV install, Section 722 is the first place to look — and A4:2026
              brought significant changes for PME (TN-C-S) supplies, RCD selection and connector
              requirements. Wireless charging is out of scope, but that&apos;s rare on UK domestic.
              Mode 3 AC charging on a dedicated radial circuit is what you&apos;ll meet day-to-day.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Solar thermal</strong> — collectors heat fluid that preheats DHW via a
              twin-coil cylinder. Outcompeted by PV + immersion or PV + heat pump for most
              retrofits. MCS MIS 3001.
            </li>
            <li>
              <strong>Micro-CHP</strong> — burns gas to generate electricity locally and uses waste
              heat for the wet system. Carbon advantage erodes as the grid cleans up. Mainly seen in
              larger commercial / institutional applications now.
            </li>
            <li>
              <strong>Biomass</strong> — wood-pellet or chip boilers and stoves. Best fit: rural
              off-gas-grid with fuel storage. Worst fit: urban smoke-control areas. MCS MIS 3004 /
              3006. Air-quality regulation tightening.
            </li>
            <li>
              <strong>Wind</strong> — small turbines (sub-10 kW). Suits open rural sites with tall
              masts and clean wind. Suburban back-garden installs almost always disappoint due to
              wind shear from surrounding buildings.
            </li>
            <li>
              <strong>Micro-hydro</strong> — site-specific, needs both head (vertical drop) and flow
              rate. Where the site exists, micro-hydro delivers excellent baseload renewable.
              Environment Agency / Natural Resources Wales licensing is the non-trivial step. MCS
              MIS 3008.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The five variants worth recognising:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>ASHP (air-source)</strong> — outdoor coil draws heat from ambient air.
              Monobloc (refrigerant stays outside, water pipes only inside) or split (refrigerant
              runs between outdoor and indoor units, F-Gas-certified installer required for the
              indoor connections). UK retrofit default.
            </li>
            <li>
              <strong>GSHP (ground-source)</strong> — buried horizontal slinky in a trench or
              vertical borehole. Source temperature 8-12 degC year-round so SCOP 4-5 is achievable.
              Capital is higher because of the groundworks; lifetime is longer because the
              compressor is not freezing-and-defrosting.
            </li>
            <li>
              <strong>WSHP (water-source)</strong> — heat extracted from a river, lake or aquifer.
              Site-specific; requires Environment Agency abstraction licence in most cases.
              Excellent SCOP where the water source is stable.
            </li>
            <li>
              <strong>EAHP (exhaust-air)</strong> — small (typically 1-3 kW) unit drawing heat from
              the building&apos;s ventilation extract air. Common in Passivhaus / very low-energy
              homes where total heat demand is small. Often integrated with MVHR.
            </li>
            <li>
              <strong>High-temperature ASHP (HT-ASHP)</strong> — uses two-stage compression or CO2
              (R-744) refrigerant to deliver flow temperatures of 65-80 degC. Allows retrofit onto
              existing radiators sized for gas-boiler flow temperatures. SCOP lower than a
              low-temperature install (typically 2.5-3.0) but the radiator survey is much easier to
              pass.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Quick-reference field guide:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Solar thermal (MCS MIS 3001)</strong> — flat-plate or evacuated-tube
              collectors on the roof, glycol-filled primary loop, twin-coil DHW cylinder. Typical
              scale 2-4 m2 collector area for a family home. Common failure mode: stagnation damage
              in unattended summer when the household is away. Pump and controller are the L3
              electrician&apos;s scope; the panel and the glycol loop are the heating
              engineer&apos;s.
            </li>
            <li>
              <strong>Biomass (MCS MIS 3004 / 3006)</strong> — wood-pellet or wood-chip boiler with
              a hopper or silo, automated auger feed, ash collection, flue. Typical 10-25 kW
              domestic. Common failure: ash build-up in the burner or flue blockage from
              poor-quality fuel. L3 electrician scope: supply, controls, ignition heater, flue gas
              analyser interlock. Smoke-control area rules under the Clean Air Act 1993 may restrict
              the fuel type.
            </li>
            <li>
              <strong>Micro-wind (MCS MIS 3003)</strong> — small turbine on a free-standing mast or
              building-mounted bracket. Building-mounted units almost always disappoint due to wind
              shear; mast-mounted units in genuinely open rural sites perform reasonably. Planning
              permission in many areas. ENA G98 /G99 connection. Common failure: bearings and yaw
              motors in salt-air environments.
            </li>
            <li>
              <strong>Micro-hydro (MCS MIS 3008)</strong> — Pelton, Turgo or crossflow turbine on a
              stream or river drop. Site-specific — needs head (vertical drop) and flow rate.
              Environment Agency / Natural Resources Wales abstraction licence is the non-trivial
              step. Where the site exists, excellent baseload renewable. L3 electrician scope: AC
              connection from turbine house to property, isolation, bonding of metallic structures.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Always quote both numbers and explain the relationship. &quot;Your roof will take a 4
              kWp array. UK yield on your orientation works out at around 950 kWh per kWp per year,
              so we&apos;re estimating 3,800 kWh a year — roughly the annual electricity consumption
              of a typical UK family of four.&quot; The MCS yield calculator produces the exact
              figure for the SAP and the customer handover pack.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Customer asks &quot;I&apos;ve got solar — what should I do next?&quot;. Apprentice (or
              the marketing they&apos;ve seen) suggests wind. Customer spends £8-15k on a 1-3 kW
              back-garden turbine. Real-world yield is well below the manufacturer&apos;s claim
              because wind shear from surrounding buildings makes the wind unsteady. Customer is
              unhappy, the install becomes a regret purchase, and the trade picks up the
              reputational damage.
            </>
          }
          doInstead={
            <>
              For a customer with PV, the next-step ladder is normally — battery storage (extends
              self-consumption), smart EV charger (loads the surplus into the car), then heating
              electrification (heat pump replacing gas / oil). Wind is rarely the right next step in
              suburban contexts. If the customer is in a genuinely open rural location with clean
              wind, a proper site survey by a wind specialist is the answer — not an off-the-shelf
              back-garden turbine.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              The customer is looking at a new-build with no environmental tech as standard. They
              want to know what to add to make the house &quot;as green as reasonably possible&quot;
              within a £25-30k budget on top of the base purchase price. The plot has a south-facing
              roof of 30 m² usable area, a small garden (no room for ground loops), a single-phase
              100 A supply, and the customer drives a petrol car they plan to replace with an EV in
              the next two years.
            </>
          }
          whatToDo={
            <>
              ...
              kWh/year), a 10 kWh battery (for evening self-consumption), a 7 kW EV charger
              (single-phase, ready for the EV), an air-source heat pump with low-temperature
              radiators or underfloor (replacing whatever the developer planned), and MVHR if the
              building shell is airtight enough (check the developer&apos;s air permeability test
              result). That combination consumes roughly £25-30k typically and covers all four
              operating principles. Wind doesn&apos;t fit (no clean wind), micro-hydro doesn&apos;t
              fit (no stream), solar thermal is outclassed by PV + immersion, biomass doesn&apos;t
              fit (no fuel store, urban smoke concerns).
            </>
          }
          whyItMatters={
            <>
              The customer-facing conversation needs the five-family frame. The five technologies
              cover all four operating principles (harvest, upgrade, recovery, demand reduction);
              together they hit Future Homes Standard or better. Throwing wind or micro-hydro at the
              wrong site is a textbook way to waste the customer&apos;s budget and miss the actual
              carbon goal.
            </>
          }
        />
