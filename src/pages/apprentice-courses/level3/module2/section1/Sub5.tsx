...
const TITLE = 'Whole-system integration (1.5) | Level 3 Module 2.1.5 | Elec-Mate';
const DESCRIPTION =
...
const faqs = [
  {
    question:
      'Is integrated PV plus battery plus heat pump plus EV actually common in UK domestic now?',
    answer:
  ...
  {
    question:
      'What happens if the customer adds technologies one at a time over several years rather than all at once?',
    answer:
  ...
  {
    question:
      "Does the customer need a single 'system designer' or can each technology be specified independently?",
    answer:
  ...
  {
    question:
      'What is the typical lifetime mismatch between technologies on an integrated install?',
    answer:
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 1 · Subsection 5"
        title="Whole-system integration"
        backTo="/study-centre/apprentice/level3-module2-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          How PV, battery, heat pump and EV charging are coordinated as one system on a modern UK
          domestic project — Home Energy Management Systems, the consumer unit layout, the comms
          infrastructure, the diversity calculation across the full load mix, and the apprentice's
          role across the trade interfaces.
        </p>
        ...
        >
          <p>Typical components of an integrated UK domestic install in 2024-2026:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PV array</strong> — typically 4-8 kWp on the south-facing roof. MCS MIS 3002
              governs install. ENA G98 covers grid notification.
            </li>
            <li>
              <strong>Battery storage</strong> — typically 5-20 kWh LFP wall-mounted unit. BS 7671
              Section 826 plus IET Code of Practice for EESS. MCS MIS 3012 governs.
            </li>
            <li>
              <strong>Air-source heat pump</strong> — typically 5-12 kW outdoor unit plus indoor
              cylinder and controls. MCS MIS 3005 governs install. F-Gas Regulations cover
              refrigerant work.
            </li>
            <li>
              <strong>EV charge point</strong> — typically 7.4 kW Mode 3 wall unit. BS 7671 Section
              722 plus IET Code of Practice for EV Charging Equipment Installation. OZEV Smart
              Charge Points Regulations 2021.
            </li>
            <li>
              <strong>HEMS</strong> — supervisory controller. May be a discrete unit (Loxone,
              GivEnergy GivEcoLink) or supplier-side aggregator (Octopus Intelligent, ev.energy).
            </li>
            <li>
              <strong>MVHR (sometimes)</strong> — Building Regs Part F. Standard on Future Homes
              Standard new-build.
            </li>
            <li>
              <strong>Smart heating controls (sometimes)</strong> — TRVs, programmable thermostats,
              weather compensation. Integrates with HEMS dispatch.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What a HEMS optimises:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Tariff-aware dispatch</strong> — battery charges during cheap windows,
              discharges during expensive windows. Heat pump shifts run-time toward cheap windows
              where possible.
            </li>
            <li>
              <strong>PV self-consumption</strong> — battery charges from PV surplus before
              exporting; EV charger uses PV surplus where the customer's car is plugged in during
              the day.
            </li>
            <li>
              <strong>Weather-aware forecasting</strong> — predicts tomorrow's PV output and
              pre-charges or pre-discharges the battery accordingly.
            </li>
            <li>
              <strong>Property load management</strong> — when concurrent loads approach the
              main-fuse limit, throttles or pauses the controllable loads (EV, heat pump compressor)
              to keep the property below the cut-out.
            </li>
            <li>
              <strong>Backup mode</strong> — on grid loss, isolates from the grid and feeds selected
              backup circuits from the battery (subject to inverter capability).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Worked example — typical 1990s 4-bed semi:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Existing</strong> — 9.5 kW shower, 4 kW oven, 3 kW immersion (rarely used).
              Main fuse 80 A. Headline maximum around 16.5 kW = 72 A. Fits.
            </li>
            <li>
              <strong>Add EV charger 7.4 kW</strong> — headline rises to 24 kW = 104 A. Exceeds 80
              A. Without load management, would trip cut-out under concurrent draw.
            </li>
            <li>
              <strong>Add load management</strong> — EV charger throttles when shower or oven runs.
              Realistic concurrent maximum drops to around 80 A. Fits.
            </li>
            <li>
              <strong>Add heat pump 7 kW (compressor peak)</strong> — heat pump rarely runs at full
              load; modulates to typically 2-4 kW. With load management on EV and heat pump
              scheduling via HEMS, realistic concurrent maximum stays near 80 A. Fits.
            </li>
            <li>
              <strong>Add battery storage</strong> — battery covers peak-window concurrent draw,
              further reducing grid import during expensive windows. Effective grid demand drops
              below main-fuse limit even during cooking + showering + EV charging.
            </li>
          </ul>
          <p>
            The pattern: each new technology added without coordination would push past the main
            fuse; with coordination and load management, the same property absorbs them all. The
            MCS-certified designer is the person who makes the calculation work; the apprentice's
            contribution is to install the load-management infrastructure correctly.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Comms cable types and where they go:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cat5e / Cat6</strong> — to control locations for IP-based comms, smart meter
              CAD interface, HEMS controller. Future-proof; replace easily from one end if a
              connector goes bad.
            </li>
            <li>
              <strong>BMS-to-inverter CAN bus</strong> — usually a short manufacturer-supplied cable
              inside the battery enclosure or between battery and adjacent inverter. Critical for
              safe operation.
            </li>
            <li>
              <strong>Modbus RS485</strong> — sometimes specified between battery inverter and heat
              pump or HEMS. Twisted-pair, terminated at both ends, polarity-sensitive. Read the
              manual.
            </li>
            <li>
              <strong>CT clamp signal cables</strong> — usually low-voltage shielded twisted pair
              from CT clamp at supply tail back to the consuming device. Each device that needs the
              measurement may want its own CT clamp.
            </li>
            <li>
              <strong>WiFi only</strong> — acceptable for non-safety-critical functions (e.g.
              customer app monitoring). Not acceptable for load management or PEN-fault detection
              signalling. Wired-with-WiFi-backup is the safer architecture.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              "Each protective device, switch, isolator and item of equipment shall be appropriately
              labelled to indicate its purpose. For installations including environmental technology
              systems, the labelling shall identify supply origins, isolation points, the type of
              earthing arrangement and any specific emergency operation instructions."
            </>
          }
          meaning={
            <>
              Section 514 of BS 7671 covers identification and notices for the whole installation.
              On an integrated environmental install, the labelling burden is significantly larger —
              multiple inverters, multiple isolators, multiple comms cables, multiple service
              requirements. A4:2026 has refined the requirements alongside the broader updates. The
              IET Codes of Practice for PV, battery and EV charging add product-specific labelling
              requirements; the MCS Code of Practice requires customer-facing handover
              documentation. The apprentice should expect to label more, document more and brief the
              customer more thoroughly than on a single-product install.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              and notices within the Wiring Regulations and replace or modify prior illustrations
              and examples. Illustrations of notices that previously appeared in Section 514 have
              been removed; designers and installers shall use Appendix 11 for examples of notices.
            </>
          }
          meaning={
            <>
              On an integrated PV + battery + EV install you&apos;ll need notices for every origin,
              isolation point and unique earthing arrangement. The notice illustrations now live in
              Appendix 11 — don&apos;t go looking for them in Section 514 itself. The wording
              requirements are unchanged in substance; only the location of the example layouts has
              moved.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              Where BS 7671 asks the role to be recorded, the EIC is where it goes. The inspector
              reading your certificate later relies on these entries to verify the protective
              measures match the equipment you actually installed.
            </>
          }
        ...
        >
          <p>The three approaches and where each fits:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>
                Supplier-side (Octopus Intelligent Octopus Go, ev.energy, OVO Charge Anytime)
              </strong>
              — cloud aggregator dispatches the customer&apos;s EV charger and increasingly heat
              pump and battery in exchange for a discounted tariff. Minimal on-site infrastructure
              required; depends on the customer staying with that supplier.
            </li>
            <li>
              <strong>
                Manufacturer-side (GivEnergy GivEcoLink, Tesla app, SolarEdge ONE, Sungrow
                iSolarCloud)
              </strong>{' '}
              — one vendor&apos;s controller orchestrates that vendor&apos;s products. Smooth
              integration within ecosystem; brittle when customer mixes vendors.
            </li>
            <li>
              <strong>Open-source / agnostic (Home Assistant, Loxone, evcc)</strong> —
              vendor-neutral; works with mixed kit via Modbus, MQTT, REST APIs. Requires a competent
              installer and ongoing maintenance. Strongest fit for whole-house integration where
              customer values flexibility over single-supplier convenience.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common integrated-install fault categories:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>CT clamp wrong orientation or wrong tail</strong> — the device thinks the
              property is exporting when it is importing or vice versa. Most common cause of
              &quot;the charger is not respecting load management&quot;.
            </li>
            <li>
              <strong>BMS comms cable wrong type or wrong port</strong> — the inverter cannot read
              battery state. Most common cause of &quot;battery shows full but inverter shows
              empty&quot;.
            </li>
            <li>
              <strong>HEMS dispatch setting not enabled</strong> — the device is wired correctly but
              the HEMS profile is set to &quot;manual&quot; or &quot;eco&quot; rather than &quot;PV
              surplus&quot;. Customer hears &quot;the system is broken&quot;; the install is fine,
              the setting needs a change.
            </li>
            <li>
              <strong>WiFi dropouts on safety-critical signalling</strong> — load management fails
              intermittently. Cure: pull wired Ethernet, do not depend on WiFi for safety-critical
              signalling.
            </li>
            <li>
              <strong>Tariff schedule out of date</strong> — the customer changed tariff six months
              ago and the HEMS is still using the old schedule. Battery charges at the wrong time.
        ...
        >
          <p>Handover pack contents — what every integrated install should ship with:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single-line schematic</strong> — laminated, fixed inside the consumer-unit
              door, showing PV, battery, heat pump, EV and the property supply with all isolation
              points marked.
            </li>
            <li>
              <strong>Labelled circuit list</strong> — every breaker and RCBO labelled with its
              function and any backup behaviour.
            </li>
            <li>
              <strong>Each product&apos;s install certificate</strong> — MCS PV (MIS 3002), MCS BESS
              (MIS 3012), MCS heat pump (MIS 3005), EV (Section 722 certificate). Each is registered
              with MCS and the certificate generated by the certified installer.
            </li>
            <li>
              <strong>BS 7671 Electrical Installation Certificate</strong> — for any new circuits
              installed.
            </li>
            <li>
              <strong>HEMS commissioning report</strong> — confirming dispatch settings, CT clamp
              orientations, comms link status.
            </li>
            <li>
              <strong>User guides and app credentials</strong> — for each product. Customers
              regularly forget which app does what; collated guide is appreciated.
            </li>
            <li>
              <strong>Backup-mode brief</strong> — written, with a sticker on the CU identifying
              which sockets stay live in a power cut.
            </li>
            <li>
              <strong>DNO connection paperwork</strong> — G98 / G99 confirmation.
            </li>
            <li>
              <strong>Warranty schedule and emergency contacts</strong> — who to call for what, in
              priority order.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Five trends shaping the 2026-2030 UK environmental electrical market:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Future Homes Standard mainstreaming</strong> — heat pumps and PV become the
              default on new build; gas boilers off new build by 2025+. EV charging cabling
              pre-installed at construction.
            </li>
            <li>
              <strong>Dynamic tariff penetration</strong> — Octopus Agile, Cosy, Intelligent and
              equivalent products at other suppliers reshape the customer&apos;s economic case.
              Battery storage payback drops into 6-8 year range on dynamic tariffs.
            </li>
            <li>
              <strong>V2H first, V2G next</strong> — bidirectional charging starts in pilots and
              small-scale deployments by 2026; mainstream by late 2020s as vehicle support grows and
              units become affordable.
            </li>
            <li>
              <strong>Heat pump scale-up</strong> — Boiler Upgrade Scheme (BUS), Clean Heat Market
              Mechanism on manufacturers, and rising gas prices push heat pump volumes upward
              sharply through to 2030.
            </li>
            <li>
              <strong>EICR scope expansion</strong> — periodic inspection of environmental tech is
              becoming part of the standard EICR scope. The L3 electrician is the typical inspector
              — competence in environmental interfaces will be priced into the EICR market.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice runs the mains supply to inverter, heat pump and EV charger but skips the
              Cat5e runs to each location, on the basis that 'each device has WiFi'. Six months
              later the customer reports that the EV charger sometimes does not respect the
              load-management limit; the heat pump sometimes does not enter eco mode when the
              battery is full; the HEMS dispatch is unreliable. Investigation: the WiFi signal in
              the garage and the loft is poor, the connections drop, and the safety-critical
              load-management signalling is missing key updates. Retrofit of Cat5e through a
              finished wall costs more than the whole comms run would have at first fix.
            </>
          }
          doInstead={
            <>
              Pull Cat5e or Cat6 to every control location at first fix as a matter of course.
              Network sockets cost pennies; cable and labour are cheap when the walls are open. Even
              if the chosen HEMS happens to use WiFi at commission, the customer (or the next system
              upgrade) will benefit from having wired infrastructure available. Plan the cable
              routes alongside the mains, not as an afterthought.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              is commissioned before the battery is on site; the battery is commissioned before the
              EV charger CT clamp is installed; the heat pump is commissioned before the HEMS knows
              the rest of the system exists. Each individual product passes its own commissioning
              checks, but the integrated behaviour fails — the EV charger does not see the battery
              state, the battery does not respond to HEMS dispatch, the heat pump does not get the
              signal to defer. Customer reports 'nothing works as advertised' even though every
              product is individually 'working'.
            </>
          }
          doInstead={
            <>
              Insist on a coordinated commissioning sequence from the system designer. Each
              product's commissioning depends on the others being in a known state. The sequence
              typically goes: existing baseline checks → PV install and energise → battery install
              (DC side, BMS comms, AC side, commissioning) → EV charger install (mains, CT clamp,
              PEN-fault test, OZEV-compliance settings) → heat pump electrical commissioning
              (refrigerant work is F-Gas, separate scope) → HEMS commissioning that pulls all four
              into one system → integrated test → customer handover. The apprentice should be
              familiar with the sequence and flag if it is being skipped.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You are the apprentice on a multi-week retrofit. The customer is fitting 6 kWp PV, a
              13.5 kWh LFP battery (AC-coupled retrofit because PV is being installed and the
              inverter is bought as a hybrid for a future DC upgrade), a 7 kW air-source heat pump
              replacing a 30-year-old gas boiler, and a 7.4 kW EV charger. Existing 80 A main fuse.
              Existing 9.5 kW shower and 4 kW oven. The MCS-certified designer has produced an
              integrated drawing showing the comms infrastructure (Cat6 to four locations plus CT
              clamp signal cables to the consumer unit), the consumer unit layout (new 18-way CU
              with dedicated RCBOs / AFDDs for each of the four new circuits plus the existing house
              circuits), and a coordinated commissioning sequence.
            </>
          }
          whatToDo={
            <>
              First fix: pull mains supply cables to PV inverter location, battery inverter
              location, heat pump outdoor unit location, EV charger location. Pull Cat6 to all four
              control locations plus to the metering location. Pull CT clamp signal cable from the
              consumer unit to the EV charger, the battery inverter and the HEMS controller (three
              CT clamps to install on the supply tail in the orientation each manual specifies).
              Install the new 18-way consumer unit with the labelled RCBOs / AFDDs in the agreed
              layout. Second fix: terminate at each device per the manufacturer's wiring diagrams;
              install CT clamps in the correct orientation; landing all the comms cables.
              Coordinated commissioning: assist the PV specialist with the PV side, the battery
              specialist with the battery side, the heat pump specialist with the heat pump
              electrical side, the EV specialist with the charger side; assist the HEMS
              commissioning at the end to bring the four products into one integrated system.
              Customer handover: the labelled CU, the integrated documentation pack, a five-minute
              brief on the HEMS app and what to expect from each technology.
            </>
          }
          whyItMatters={
            <>
              This is the future of UK domestic electrical work. The L3 apprentice's role is real
              and significant — first-fix infrastructure, second-fix wiring, commissioning support
              across multiple specialists, customer handover assistance. Each MCS specialist signs
              off their own scope; the apprentice keeps the integrated install coherent across the
              trade interfaces. Recognising this scope at L3 is part of being employable in the
              post-2030 UK domestic electrical market.
            </>
          }
        />
