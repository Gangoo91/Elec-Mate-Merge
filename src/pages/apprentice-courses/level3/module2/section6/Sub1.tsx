...
const faqs = [
  ...
  {
    question:
      'What happens if I open a sealed refrigerant circuit accidentally — for example clipping a pipe with a saw during a chase?',
    answer:
  ...
  {
    question:
      'If I want to expand my scope to cover refrigerant work in future, what is the route?',
    answer:
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 6 · Subsection 1"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          EU Regulation 517/2014 (retained as UK law) controls fluorinated greenhouse gas
          refrigerants. As the electrician on a heat pump or AC install your scope is supply,
          isolation, controls and bonding. Refrigerant work — brazing, evacuation, charging, leak
          check, recovery — is restricted to F-Gas-certified persons working under an F-Gas company
          certificate.
        </p>
        ...
        >
          <p>What the F-Gas Regulation controls in plain English:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Placing on market</strong> — manufacturers cannot sell new equipment using
              prohibited high-GWP refrigerants in defined product categories. The phase-down quota
              shrinks the tonnes-CO2-equivalent of HFC placed on the EU/UK market each year.
            </li>
            <li>
              <strong>Personal certification</strong> — anyone installing, servicing, repairing,
              leak-checking, decommissioning or recovering refrigerant from stationary
              refrigeration, AC or heat pump kit must hold an F-Gas Category I (or equivalent)
              personal certificate.
            </li>
            <li>
              <strong>Company certification</strong> — the employing company must hold an F-Gas
              company certificate for the activity. Both the individual and the company certificates
              have to be in place.
            </li>
            <li>
              <strong>Leak checking</strong> — equipment is leak-checked at intervals driven by the
              tonnes-CO2-equivalent of refrigerant charge. Above 5 tonnes CO2-eq once a year (less
              often with automatic leak detection), more frequently for higher charges.
            </li>
            <li>
              <strong>Recovery and labelling</strong> — refrigerant must be recovered at end of
              life, equipment must be labelled with the refrigerant data, and a logbook must be kept
              across the equipment service life.
            </li>
          </ul>
          <p>
            None of these duties fall on the apprentice electrician directly — but every one of them
            sits in the background of every heat pump and AC install you will ever attend.
            Recognising the framework is part of being a competent member of the install team.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                ...
                refrigeration, air-conditioning and heat pump equipment containing fluorinated
                greenhouse gases, shall be certified&quot;:
              </p>
          ...
          meaning={
            <>
              ...
              refrigerant work&quot; carve-out for electricians, plumbers or general building
              tradespeople. If the activity touches a refrigerant circuit it requires an F-Gas
              Category I (or equivalent) personal certificate, and the employing company must hold
              an F-Gas company certificate. The trade boundary is set by statute, not by site
              convention. The duty falls on both the individual doing the work and the company
              employing them.
            </>
          }
        ...
        >
          <p>Refrigerants you will see on UK domestic heat pump data plates today:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>R-410A (GWP ~2,088, A1)</strong> — legacy HFC, common on 2010-2020 installs,
              no longer offered in most new domestic units. Service work continues; gradually being
              decommissioned and recovered as units reach end of life.
            </li>
            <li>
              <strong>R-32 (GWP ~675, A2L)</strong> — single-component refrigerant, widely used in
              current splits and many monoblocks. Mildly flammable, lower indoor charge limits than
              A1 refrigerants.
            </li>
            <li>
              <strong>R-454B (GWP ~466, A2L)</strong> — newer blend used in some replacement-grade
              kit, similar handling rules to R-32.
            </li>
            <li>
              <strong>R-290 propane (GWP ~3, A3 flammable)</strong> — the rising default for
              monoblock heat pumps. Flammable, but contained inside the outdoor unit with only water
              pipes entering the building. Brings ATEX rules for the F-Gas engineer; electrical
              scope is standard.
            </li>
            <li>
              <strong>R-744 CO2 (GWP 1, A1)</strong> — used in some commercial refrigeration and a
              small number of high-temperature heat pumps. Operates at very high pressure;
              specialist kit and engineering.
            </li>
          </ul>
          <p>
            The F-Gas refrigerant choice is made at the equipment manufacturer level, constrained by
            the placing-on-market rules. As the apprentice you will not choose the refrigerant — but
            reading the data plate and understanding what is inside the unit is part of being a
            competent install team member.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The electrician scope on a typical domestic ASHP install:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply design and installation</strong> — typically a 32 A or 40 A radial on a
              Type C MCB for a domestic 8-12 kW unit; cable size to suit load, length and
              installation method per BS 7671 Appendix 4 / Table 4D2A.
            </li>
            <li>
              <strong>Means of isolation outside</strong> — a weather-proof local isolator within
              sight of the outdoor unit, in line with the manufacturer installation manual and BS
              7671 Section 537.
            </li>
            <li>
              <strong>Protective equipotential bonding</strong> — bond the outdoor unit chassis
              where it is an extraneous-conductive-part, in accordance with BS 7671 Chapter 41 and
              the manufacturer instructions.
            </li>
            <li>
              <strong>Controls and integration</strong> — wiring of the room thermostat, weather
              compensation sensor, smart export integration with PV and battery where present, and
              any building management system handshake.
            </li>
            <li>
              <strong>Verification at handover</strong> — continuity of protective conductors,
              insulation resistance where appropriate, Zs at the unit, RCD test where fitted, and
              completion of an Electrical Installation Certificate (EIC) or Minor Works Certificate
              as appropriate.
            </li>
          </ul>
          <p>What you do not do under any circumstances:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          <p>What the label tells you and the F-Gas engineer:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Refrigerant designation</strong> — for example R-32, R-290, R-410A. Drives the
              safety case (flammability classification A1 / A2L / A3) and the recovery cylinder
              type.
            </li>
            <li>
              <strong>Charge in kilograms</strong> — the factory-charged mass of refrigerant in the
              sealed circuit. Drives the recovery duty and the replacement charge if the unit is
              recharged after a leak.
            </li>
            <li>
              <strong>Tonnes CO2 equivalent</strong> — charge in kg multiplied by GWP divided by
              1,000. Drives leak-check frequency: above 5 tonnes CO2-eq annually, above 50 tonnes
              CO2-eq six-monthly, above 500 tonnes CO2-eq quarterly. Domestic heat pumps typically
              sit below the 5 tonnes threshold so leak checks are not statutorily required at fixed
              frequency but the manufacturer warranty often imposes its own service interval.
            </li>
            <li>
              <strong>Equipment hermetically sealed indication</strong> — where present, relaxes
              some of the certification rules at recovery (for very small charges in fully hermetic
              units).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              tonnes of CO2 equivalent or more (and not contained in foams) shall ensure that the
              equipment is checked for leaks. Frequency rises with charge: 5 to 50 tonnes CO2-eq at
              least every 12 months; 50 to 500 tonnes CO2-eq at least every 6 months; 500 tonnes
              CO2-eq or above at least every 3 months. Frequencies are halved where an automatic
              leak detection system is fitted and operational.
            </>
          }
          meaning={
            <>
              Most UK domestic heat pumps sit comfortably below the 5 tonnes CO2-eq threshold, so
              the statutory leak check frequency does not apply. That does not relieve the customer
              of the operator duty to keep the equipment in good order, and the manufacturer
              warranty often requires a service interval anyway. Larger commercial AC, heat pump and
              refrigeration plant routinely sits above the threshold and the leak check log becomes
              a serious regulatory artefact for the F-Gas engineer to maintain.
            </>
          }
        ...
        >
          <p>The four F-Gas certification categories at a glance:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Category I</strong> — all activities on stationary refrigeration, AC and heat
              pump equipment regardless of refrigerant charge size. The broadest scope and the
              working baseline for the UK domestic heat pump market.
            </li>
            <li>
              <strong>Category II</strong> — narrower scope, typically restricted to equipment with
              refrigerant charges below specified thresholds and to certain activities. Less common
              in current UK practice.
            </li>
            <li>
              <strong>Category III</strong> — recovery-only certification. Allows refrigerant
              recovery from equipment but not installation, charging or leak checking. Used by
              specialist decommissioning operators.
            </li>
            <li>
              <strong>Category IV</strong> — leak-checking-only certification. Allows leak checking
              of equipment without intervention on the refrigerant circuit itself. Used by some
              inspection-only operators on large commercial estates.
            </li>
          </ul>
          <p>
            Mobile refrigeration in road vehicles, rail vehicles and ships sits under different
            certification routes. Stationary domestic and commercial equipment is what an electrical
            contractor will normally encounter.
          </p>
        </ConceptBlock>
        ...
        >
          <p>What the apprentice should recognise on a heat pump replacement:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Recovery cylinder</strong> — labelled with the refrigerant type, tare weight,
              gross weight and the engineer details. The weighed-in quantity is logged in the F-Gas
              paperwork.
            </li>
            <li>
              <strong>Vacuum confirmation</strong> — the engineer verifies that the old circuit has
              been evacuated (typically by vacuum gauge reading) before the pipework is mechanically
              dismantled.
            </li>
            <li>
              <strong>Pipework dismantling</strong> — once vacuum-confirmed, the pipework can be cut
              and the unit physically removed. The cut surfaces are taped to keep moisture out of
              the recovered cylinder pathway.
            </li>
            <li>
              <strong>Documentation</strong> — recovery quantity logged in the F-Gas logbook for the
              equipment, the recovery cylinder consigned to a permitted refrigerant treatment
              facility, and the certificate from the facility returned for the company records.
            </li>
          </ul>
          <p>
            You should never proceed with electrical removal of a unit before the F-Gas recovery is
            confirmed complete. Cutting refrigerant pipework on a still-charged unit releases
            refrigerant to atmosphere and is both a regulatory breach and a personal safety hazard
        ...
        >
          <p>Conditions that typically need to be met for the hermetic exemption to apply:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Equipment is hermetically sealed</strong> — the entire refrigerant circuit is
              factory-sealed and the manufacturer has labelled it as hermetically sealed for F-Gas
              purposes.
            </li>
            <li>
              <strong>Refrigerant charge is below the threshold</strong> — the threshold varies by
              equipment category and is set by the F-Gas Regulation. Always check the current
              threshold for the specific equipment.
            </li>
            <li>
              <strong>Installation does not breach the circuit</strong> — no flare connections to
              make, no charging required, no on-site leak test required.
            </li>
            <li>
              <strong>Equipment is supplied with valid F-Gas labelling</strong> — refrigerant type,
              charge in kg and tonnes CO2 equivalent already declared on the data plate.
            </li>
          </ul>
          <p>
            Most monoblock R-290 domestic heat pumps fall within or close to this hermetic
            relaxation because the entire refrigerant circuit is factory sealed inside the outdoor
            unit and only water pipes enter the building. However the manufacturer commissioning
            instructions still typically require an F-Gas-certified engineer to verify the
            refrigerant pressure, perform the initial vacuum check on the water side, and confirm
            first-fire performance — so in practice the F-Gas engineer is on site regardless. The
            relaxation matters more on much smaller equipment such as split-free AC and small
        ...
        >
          <p>GWP arithmetic for the refrigerants you will see on UK domestic heat pumps:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>R-410A (GWP 2,088)</strong> — 1 kg leak = 2,088 kg CO2 eq = roughly the
              emissions of an average UK car driving 10,000 miles.
            </li>
            <li>
              <strong>R-32 (GWP 675)</strong> — 1 kg leak = 675 kg CO2 eq = roughly the emissions of
              an average UK car driving 3,200 miles.
            </li>
            <li>
              <strong>R-454B (GWP 466)</strong> — 1 kg leak = 466 kg CO2 eq.
            </li>
            <li>
              <strong>R-290 propane (GWP 3)</strong> — 1 kg leak = 3 kg CO2 eq = roughly a single
              short car journey. The shift to R-290 dramatically reduces the climate consequence of
              any leak.
            </li>
            <li>
              <strong>Equivalent context</strong> — a typical UK domestic ASHP holds 1.5-3 kg of
              refrigerant. A single full-charge venting on a 2.5 kg R-410A unit equals around 5,200
              kg CO2 — comparable to a year of typical UK household electricity emissions. The same
              venting on an R-290 unit equals 7.5 kg CO2 — comparable to one drive to the
              supermarket.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The F-Gas engineer does not turn up. The customer is on holiday next week and wants
              the system commissioned today. The employer is short-staffed and says &quot;just
              connect that last bit of pipework and we will send the F-Gas guy back to leak test
              next month&quot;. The apprentice does it because everyone above them in the chain is
              asking. The Environment Agency picks it up at a routine audit; the manufacturer voids
              the warranty because the circuit was opened by an uncertified person; the customer
              ends up with a very expensive failure that nobody insured for; the apprentice career
              and the employer F-Gas company certificate both take the hit.
            </>
          }
          doInstead={
            <>
              The trade boundary is statutory, not negotiable. Document the request in writing (text
              or email is fine), decline politely, and escalate to the contracts manager or business
              owner. Reschedule the F-Gas engineer for whatever date is available and accept the
              customer dissatisfaction in the short term. Honest scheduling failure is recoverable.
              F-Gas enforcement action and a voided warranty are not. The phrase to use with the
              customer is &quot;the law restricts refrigerant work to F-Gas certified engineers, so
              I cannot legally complete the install today, but I will get the refrigerant engineer
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              On a monoblock R-290 heat pump only water pipes enter the building, with the entire
              refrigerant circuit sealed inside the outdoor unit. A confused installer assumes that
              any pipework on the system is &quot;heat pump pipework&quot; and is therefore F-Gas
              restricted. The wet system pipework stops getting connected and the install stalls
              unnecessarily. Or the opposite happens — a poorly-designed split unit with refrigerant
              pipes running through the loft is mistaken for water pipework and an unqualified
              installer puts a saw through it.
            </>
          }
          doInstead={
            <>
              Trace every pipe from the outdoor unit and identify whether it carries refrigerant or
              water before doing any work. A refrigerant pipe is normally copper, lagged with
              closed-cell foam, sized smaller than the wet circuit pipework, and connected to the
              outdoor unit at clearly-marked refrigerant ports. A water pipe is copper or composite,
              lagged for thermal loss, and connected to clearly-marked water ports. Where in doubt
              ask the F-Gas engineer or the design pack before touching anything. On a monoblock the
              rule is simple: if it carries water you can work on it under your normal competence;
              if it carries refrigerant you cannot.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You are on a domestic ASHP install. The unit is mounted, the supply is in, the
              controls are wired and verified, and the wet system is filled. The F-Gas engineer was
              due at 1pm to evacuate and charge the circuit but is now stuck on the M25 and not
              arriving until Monday. The customer has guests coming Saturday and wants hot water.
              Your contracts manager phones and asks &quot;can you not just connect the last
              refrigerant flare and turn it on for the weekend, then he will leak test on
              Monday?&quot;. The customer is in the kitchen listening.
            </>
          }
          whatToDo={
            <>
              Decline clearly, in front of the customer if needed. Explain to the customer that
              refrigerant work is restricted by law to F-Gas certified engineers, that the
              manufacturer warranty would be voided if you opened the refrigerant circuit, and that
              the system cannot legally be charged or run without the F-Gas engineer present.
              Apologise for the inconvenience, offer to leave a temporary immersion heater
              connection if the cylinder has one, and confirm the Monday return slot in writing.
              Send a follow-up text to the contracts manager confirming the request and your refusal
              so there is a paper trail. The customer will be inconvenienced for two days; the
              alternative is illegal work and a voided warranty.
            </>
          }
          whyItMatters={
            <>
              The F-Gas trade boundary is the place where commercial pressure most often meets
              regulatory clarity. The pressure is real, the regulation is real, and the right answer
              is always the same. Apprentices are particularly vulnerable to this pressure because
              the contracts manager outranks them and the customer is right there. Practising the
              refusal in advance — literally rehearsing the sentence &quot;I cannot legally do that,
              and I am going to get the F-Gas engineer back as soon as possible&quot; — makes the
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Maintenance work on PV — replacing an isolator, swapping a faulty inverter, cleaning
              down a string — sits squarely under the revised Section 712. Pre-A4 guidance on DC
              isolation methods or RCD type selection should be cross-checked against the published
              amendment text before being relied on.
            </>
          }
        ...
        <Quiz
          title="F-Gas Regulations and the trade boundary — knowledge check"
