    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The Greenhouse Gas Protocol scope framework applied to a UK electrical contracting
          business. Carbon Reduction Plan requirements under PPN 06/21, the Streamlined Energy and
          Carbon Reporting (SECR) regime, and the Carbon Literacy Project framework for
          workforce-level climate competence. The vocabulary every apprentice now needs to be a
          credible part of the trade.
        </p>
        ...
        >
          <p>
            The fifteen scope 3 categories defined by the GHG Protocol, with notes on relevance to a
            typical UK electrical contractor:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cat 1 Purchased goods and services</strong> — typically the largest scope 3
              category. Cable, accessories, switchgear, luminaires, plant hire, professional
              services.
            </li>
            <li>
              <strong>Cat 2 Capital goods</strong> — vehicles, workshop equipment, computers, larger
              tools amortised over multi-year life.
            </li>
            <li>
              <strong>Cat 3 Fuel and energy related activities</strong> — upstream emissions for the
              fuel and electricity already counted in scopes 1 and 2.
            </li>
            <li>
              <strong>Cat 4 Upstream transportation and distribution</strong> — supplier delivery
              emissions, including wholesaler delivery vans.
            </li>
            <li>
              <strong>Cat 5 Waste generated in operations</strong> — waste transportation and
              treatment emissions.
            </li>
            <li>
              <strong>Cat 6 Business travel</strong> — train, plane, hotel, taxi, business mileage
              in employee personal vehicles.
            </li>
            <li>
              <strong>Cat 7 Employee commuting</strong> — emissions from staff commuting to
              workshop, office or first job of the day.
            </li>
            <li>
              <strong>Cat 8 Upstream leased assets</strong> — emissions from leased vehicles or
              buildings not already in scope 1 or 2.
            </li>
            <li>
              <strong>Cat 9 Downstream transportation and distribution</strong> — emissions from
              transporting sold products to customer; less relevant for contractors.
            </li>
            <li>
              <strong>Cat 10 Processing of sold products</strong> — relevant for manufacturers, less
              so for contractors.
            </li>
            <li>
              <strong>Cat 11 Use of sold products</strong> — for contractors, often the operational
              electricity drawn by the systems they install over their service life. Can be very
              large for lighting and HVAC fit-outs.
            </li>
            <li>
              <strong>Cat 12 End-of-life of sold products</strong> — emissions from treating
              installed kit at end of life.
            </li>
            <li>
              <strong>Cat 13 Downstream leased assets</strong> — emissions from leased-out assets
              (rare for contractors).
            </li>
            <li>
          ...
          <p>
            Most electrical contractors focus on the material categories — Cat 1 purchased goods
            (largest), Cat 2 capital goods, Cat 4 upstream transport, Cat 5 waste, Cat 6 business
            travel, Cat 7 employee commuting and Cat 11 use of sold products. The remaining
            categories are typically immaterial or not applicable.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              by the reporting company. Scope 2 emissions are indirect GHG emissions from the
              generation of purchased electricity, steam, heating and cooling consumed by the
              reporting company. Scope 3 emissions are all other indirect emissions occurring in the
          ...
          meaning={
            <>
              The scope definitions are the foundation of corporate GHG accounting worldwide. They
              appear directly in UK SECR regulations, in PPN 06/21 CRP templates, in CDP
              questionnaires and in BREEAM and Net-Zero Carbon Buildings Standard reporting. Knowing
              the definitions is the entry-level competence for any conversation about corporate
              carbon. The GHG Protocol Corporate Standard is freely downloadable from the GHG
              Protocol website (ghgprotocol.org) and is the authoritative methodology reference.
            </>
          }
        ...
        >
          <p>The UK carbon disclosure regimes most relevant to electrical contractors:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>SECR (Streamlined Energy and Carbon Reporting)</strong> — statutory disclosure
              in the annual report for large UK companies meeting two of three thresholds (turnover
              above 36 million pounds, balance sheet above 18 million pounds, employees above 250).
              Covers scopes 1 and 2 plus a defined subset of scope 3 (business travel in employee
              vehicles).
            </li>
            <li>
              <strong>PPN 06/21 (Carbon Reduction Plan)</strong> — procurement requirement for
              bidders for UK central government contracts above 5 million pounds annually. Requires
              a published CRP committing to net-zero by 2050 and disclosing scopes 1, 2 and a
              defined scope 3 subset.
            </li>
            <li>
              <strong>PPN 03/21 and similar updates</strong> — broader sustainability considerations
              in central government procurement, including evaluation weight given to environmental
              performance.
            </li>
            <li>
              <strong>Devolved administration equivalents</strong> — Scotland, Wales and Northern
              Ireland operate their own procurement carbon expectations, broadly aligned with PPN
              06/21 but with regional variation.
            </li>
            <li>
              <strong>Carbon Disclosure Project (CDP)</strong> — voluntary global disclosure
              framework used by many large UK companies and increasingly requested by their supply
              chain. CDP supplier questionnaires routinely land with electrical contractors selling
              to large customers.
            </li>
            <li>
              <strong>BREEAM Man 02 (Construction practices)</strong> — awards credits for
              contractor environmental management systems and carbon reporting competence, providing
              a project-level reward for the firm broader CRP investment.
            </li>
            <li>
              <strong>UK Net-Zero Carbon Buildings Standard</strong> — published in pilot form in
              2024, sets project-level whole-life carbon performance requirements that align with
              the firm-level disclosure framework.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What a typical Carbon Literacy course covers:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Climate science basics</strong> — greenhouse effect, the 1.5 degC and 2 degC
              warming pathways, carbon budget, tipping points. Pitched at trade-worker level with no
              prior science assumed.
            </li>
            <li>
              <strong>Carbon impact of the trainee role and sector</strong> — for electrical
              contractors, the role of installed systems in operational emissions and the role of
              construction in embodied emissions.
            </li>
            <li>
              <strong>Individual action</strong> — practical steps the trainee can take in personal
              life (transport, home energy, diet, consumption).
            </li>
            <li>
              <strong>Workplace action</strong> — practical steps the trainee can take at work
              (waste reduction, energy efficiency, customer conversations, data collection, supplier
              choices).
            </li>
            <li>
              <strong>Social and economic context</strong> — climate justice, just transition, the
              political economy of decarbonisation. Builds a more resilient understanding than pure
              technical training.
            </li>
            <li>
              <strong>Action commitment</strong> — every trainee commits in writing to one personal
              action and one workplace action as a condition of certification. The commitment is
              followed up later to verify implementation.
            </li>
          </ul>
          <p>
            The certification is short-form (typically a digital badge plus a certificate) but the
            underlying training is genuinely substantive. Workers completing Carbon Literacy report
            sustained behaviour change in surveys, and accredited employers (Carbon Literate
            Organisations) report measurable reductions in scope 1 and 2 emissions over the years
            following a workforce-wide rollout.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The data sources for a first scope 1 and scope 2 inventory:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fuel card statements</strong> — annual litres of diesel and petrol consumed by
              company vehicles. The fuel card provider supplies consumption data as a CSV download.
            </li>
            <li>
              <strong>Gas bills</strong> — annual kWh of gas consumed at workshops or offices,
              derived from utility bills.
            </li>
            <li>
              <strong>Electricity bills</strong> — annual kWh of electricity consumed at workshops
              and offices, similarly from utility bills.
            </li>
            <li>
              <strong>Refrigerant logs</strong> — for any company-owned AC or refrigeration plant,
              F-Gas top-up records identify fugitive refrigerant losses (multiply kg by GWP for CO2
              equivalent).
            </li>
            <li>
              <strong>UK Government Conversion Factors</strong> — DESNZ publishes annual emission
              factors for fuels (diesel, petrol, gas), grid electricity (with separate factors for
              generation, transmission losses and upstream emissions) and refrigerants. Use the
              factors for the reporting year.
            </li>
            <li>
              <strong>Reporting boundary</strong> — define which legal entity, which sites and which
              time period the inventory covers. Annual UK financial year is the standard.
            </li>
          </ul>
          <p>
            The same inventory feeds the SECR statutory disclosure (where the firm is large enough
            to be in scope), the PPN 06/21 Carbon Reduction Plan, customer sustainability
            questionnaires and the firm internal management review. One inventory, multiple uses.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The five biggest carbon reduction levers for a UK electrical contractor:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Vehicle electrification</strong> — transition the van fleet from diesel to
              electric. The largest single scope 1 reduction available. Cuts costs over time as
              electricity per mile is cheaper than diesel per mile.
            </li>
            <li>
              <strong>2. Workshop renewable electricity</strong> — rooftop PV with on-site
              consumption (and optional battery storage for time-shifting), or a renewable tariff
              with verifiable certificates of origin. Cuts scope 2 toward zero.
            </li>
            <li>
              <strong>3. EPD-backed and recycled-content procurement</strong> — specify and source
              EPD-backed cable and accessories, prioritise recycled-content products, prefer
              manufacturers with documented sustainability commitments. Cuts the largest scope 3
              category.
            </li>
            <li>
              <strong>4. Designed-out waste</strong> — accurate ordering, modular accessories,
              reusable temporary fixings, lifetime-extension of existing kit through repair rather
              than replacement. Cuts scope 3 purchased goods and scope 3 waste together.
            </li>
            <li>
              <strong>5. Carbon Literacy across the workforce</strong> — embeds the other four
              levers in daily decisions and unlocks the multiplier effect. Without workforce
              competence the technical changes underperform their potential.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common customer carbon questions and how to handle them honestly:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Will this heat pump save me carbon?</strong> — Yes, on the current UK grid
              mix. A SCOP 3 ASHP delivers heat at around 67 gCO2 per kWh on a 200 gCO2/kWh grid,
              versus around 210 gCO2 per kWh from a 90% efficient gas boiler. Roughly three times
              cleaner today, and getting cleaner each year as the grid decarbonises.
            </li>
            <li>
              <strong>What about the embodied carbon of the heat pump itself?</strong> — The MCS
              heat pump installation guide and the manufacturer EPDs (where published) carry the
              embodied carbon figures. Carbon payback is typically 2-4 years on UK grid mix; after
              that the unit is in net carbon credit for its 15-20 year service life.
            </li>
            <li>
              <strong>Are LED retrofits actually worth it?</strong> — Almost always yes. LED
              replaces halogen and fluorescent at typically 10-20% of the running energy. The
              embodied carbon of the LED itself is paid back in weeks to months by the operational
              saving. The Energy Saving Trust publishes independent payback figures.
            </li>
            <li>
              <strong>Should I get solar PV?</strong> — Depends on roof orientation, shading, hot
              water demand and EV ownership. UK PV typically pays back its own embodied carbon in
              1-3 years and runs in net carbon credit for 25+ years. The MCS yield calculation for
              the specific roof gives the honest expected output.
            </li>
            <li>
              <strong>Is the cable you are using sustainable?</strong> — Specific to the product.
              EPD-backed cable from a manufacturer with high recycled-content discloses the embodied
              carbon directly. Marketing claims without an EPD are not evidence; redirect the
              customer to the EPD if available, or refer to the project manager if not.
            </li>
            <li>
              <strong>What about end-of-life of all this kit?</strong> — Heat pumps, PV inverters,
              batteries and EV chargers all have manufacturer take-back or specialist recycling
              routes. WEEE Regulations apply. End-of-life processing is part of the whole-life
              carbon picture but typically a small fraction of operational and embodied carbon for
              these systems.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The UK carbon budget structure that maps the trajectory:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Carbon Budget 1 (2008-2012)</strong> — the first statutory five-year budget.
              Met.
            </li>
            <li>
            ...
            <li>
              <strong>Carbon Budget 4 (2023-2027)</strong> — current period. Significantly more
              ambitious than the previous three. Tracking against the budget is reported annually by
              the Climate Change Committee.
            </li>
            <li>
              <strong>Carbon Budget 5 (2028-2032)</strong> — sets the cap on emissions during the
              late 2020s and early 2030s. Implies steep cuts in transport, heating and industry.
            </li>
            <li>
              <strong>Carbon Budget 6 (2033-2037)</strong> — first budget set after the net-zero
              amendment. Implies elimination of unabated fossil fuel use in most sectors by the end
              of the period.
            </li>
            <li>
              <strong>Carbon Budget 7 (2038-2042) and Budget 8 (2043-2047)</strong> — bring the UK
              to within touching distance of net-zero, with residual emissions in hard-to-abate
              sectors offset by removals.
            </li>
            <li>
              <strong>Net-zero target year (2050)</strong> — the statutory duty under the Climate
              Change Act 2008 (as amended 2019).
            </li>
          </ul>
          <p>
            Each budget is a legally binding cap on UK emissions over the period. Failure to meet a
            budget triggers parliamentary reporting and policy action by the government. The Climate
            Change Committee is the independent statutory body that recommends each budget and
            reports on progress.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Practical career-development steps for carbon competence:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Complete Carbon Literacy training</strong> — a one-day workshop that delivers
              UK-accredited certification. Often funded by the employer or through a trade body
              (ECA, JIB, NICEIC, NAPIT).
            </li>
            <li>
              <strong>Build EPD literacy</strong> — keep a personal record of EPDs handled on each
              project, learn to read the modules and verify the programme operator.
            </li>
            <li>
              <strong>Engage with the firm CRP</strong> — ask supervisors what the CRP commits the
              firm to, where the data comes from and how progress is tracked.
            </li>
            <li>
              <strong>Learn the regulatory map</strong> — Climate Change Act, Building Regs Part L,
              MCS, BREEAM, Net-Zero Carbon Buildings Standard, PPN 06/21, SECR. Each is a
              self-contained body of knowledge.
            </li>
            <li>
              <strong>Pursue MCS qualifications</strong> — 2399 PV, 2919 ASHP/GSHP, 2921 EV charging
              are the standalone competence standards for the environmental technology side of the
              trade.
            </li>
            <li>
              <strong>Read the CCC annual progress reports</strong> — the Climate Change Committee
              publishes accessible annual reports on UK progress toward net-zero. They give the
              strategic context for the trade direction.
            </li>
            <li>
              <strong>Track the technology shifts</strong> — heat pump refrigerants moving to R-290,
              EV charging moving to 7 kW and 22 kW domestic, battery storage moving from speciality
              to commodity, V2G beginning to scale. Each shift opens new work for the trade.
            </li>
            <li>
              <strong>Network within the trade</strong> — ECA, JIB, NICEIC, NAPIT events
              increasingly feature carbon and sustainability content. The conversations are where
              the trade strategic direction emerges.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A medium-sized electrical contractor publishes a CRP because a prime contractor has
              flowed the requirement down. The CRP is drafted by marketing, signed by a director,
              and posted on the website. The underlying emissions data was estimated rather than
              measured; the workforce never sees the document; no follow-up actions are taken; the
              annual update is forgotten. Twelve months later a customer questionnaire asks for
              evidence of progress against the published targets. The firm cannot evidence anything
              because nothing has happened. The customer downgrades the supplier rating; the
              contracts manager scrambles to produce something defensible at short notice; the firm
              reputation takes a quiet hit.
            </>
          }
          doInstead={
            <>
              Treat the CRP as a working management document. Collect actual emissions data (fuel
              card downloads, electricity bills, mileage logs, waste consignment notes) for scopes 1
              and 2 from the start; build out scope 3 progressively with material categories first.
              Set realistic annual targets with named responsible managers. Update the CRP annually
              with verified data. Brief the workforce on the targets and the actions. Use the CRP as
              the basis for procurement decisions, vehicle choices and workshop energy investments.
              The CRP becomes a credible commercial asset rather than a marketing liability.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A contractor produces a CRP covering scopes 1 and 2 only because the data is easy to
              collect from fuel cards and electricity bills. Scope 3 is left blank with a note
              saying data not available. The headline emissions number looks reassuringly small. A
              prospective customer doing supplier due diligence reviews the CRP and recognises the
              omission — a contractor with no scope 3 disclosure is either a very small business or
              a business that has not done the work. The customer marks the supplier down on the
              sustainability evaluation. The contract goes to a competitor with a more complete
              disclosure even though the headline scope 1 and 2 number was higher.
            </>
          }
          doInstead={
            <>
              Build scope 3 disclosure progressively starting with the most material category —
              purchased goods and services. Use spend-based estimation as a first pass (annual
              procurement spend by category multiplied by published emission factors per pound
              spent) to produce a defensible first estimate; refine over time with supplier-specific
              data and EPDs as they become available. Disclose the scope and methodology
              transparently. A CRP with imperfect but transparent scope 3 estimates is far more
              credible than one with no scope 3 disclosure. Customers reward the disclosure effort
        ...
        <Scenario
          ...
          situation={
            <>
              Your firm has been short-listed for a 200,000 pound electrical fit-out on a regional
              NHS estate. The customer procurement team has issued a sustainability questionnaire
              asking for scope 1, scope 2 and scope 3 emissions for the last full year, the firm
              Carbon Reduction Plan, the proportion of fleet that is electric or hybrid, the
              proportion of purchased cable that is EPD-backed, and evidence of Carbon Literacy
              training for the project team. The contracts manager hands the questionnaire to you
              and says &quot;you are doing the green stuff, please fill this in by Friday&quot;.
            </>
          }
          whatToDo={
            <>
              Triage the questionnaire by what the firm can answer and what it cannot. Scope 1 (fuel
              consumption) can be derived from fuel card downloads. Scope 2 (workshop electricity)
              from electricity bills and published grid emission factors. Scope 3 is harder — start
              with purchased goods spend by category and use spend-based estimation as a first pass.
              The Carbon Reduction Plan, fleet composition and EPD procurement statistics need
              either an existing document or a straightforward stocktake. Carbon Literacy training
              certification for the project team is either there or it is not. Compile the answers
              honestly with caveats where data quality is limited; flag gaps to the contracts
              manager and recommend remedial action before submission. Do not invent data — false
              answers in a sustainability questionnaire are tender misrepresentation and can
              disqualify the bid and damage the firm reputation. A transparent partial answer beats
              a fabricated complete one. Use the exercise as a prompt to formalise the firm carbon
              management going forward.
            </>
          }
          whyItMatters={
            <>
              Sustainability questionnaires are now routine on commercial and public sector tenders
              and the data quality matters because the customer procurement teams scrutinise the
              responses. As an apprentice asked to support the response you can add real value by
              recognising the questions, sourcing the data accurately and flagging the gaps
              constructively. You are also building the competence that supports your own career as
              climate competence becomes a baseline expectation across the trade. The exercise is
              also where many medium-sized firms first realise they need a proper carbon management
              system — being the person who triggered the upgrade is a useful reputation to build
              early.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Design documentation is the regulatory home where carbon-relevant choices live — cable
              specification, equipment selection, supply characteristics. The Reg 132.1 framework
              requires the designer to record the &quot;why&quot; behind each decision.
              Carbon-intensity reasoning fits naturally inside that record.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Self-generated PV is one of the most effective scope 2 carbon-reduction interventions
              a small contractor can make on its own premises. Section 712 (as rewritten in A4:2026)
              governs the electrical installation of that PV. Pre-A4 training notes should be
              cross-checked against the current text.
            </>
          }
        ...
        <Quiz
          title="Scope 1 / 2 / 3 and carbon literacy — knowledge check"
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Module 3</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
