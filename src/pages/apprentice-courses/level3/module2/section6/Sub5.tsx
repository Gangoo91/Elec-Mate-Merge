...
const checks = [
  {
    ...
    options: [
      "All three categories cover the same emissions.",
      ...
      "Scope 1 only covers gas; scope 2 only covers electricity; scope 3 is voluntary.",
      "Scope 3 only applies to manufacturers, not contractors.",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "It is an electrical safety standard.",
      ...
      "It is a building regulation about cable colour.",
      "It applies only to manufacturers.",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "It is a cable competency assessment.",
      ...
      "It is a Level 7 university qualification only.",
      "It is mandatory for all UK electricians.",
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      "They are the same thing labelled differently.",
      ...
      "Scope 1 is voluntary, scopes 2 and 3 are mandatory.",
      "All three apply only to manufacturing companies.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Because scope 3 includes all of scope 1 and scope 2.",
      ...
      "Because scope 3 is double-counted by definition.",
      "Because scope 3 includes the entire UK national emissions inventory.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "A short marketing statement on the website.",
      ...
      "A confidential internal document only.",
      "A document required only of manufacturers.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "A voluntary code with no legal weight.",
      ...
      "SECR applies only to public limited companies.",
      "SECR is a separate scheme for offshore industries only.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Scope 2 has risen because of grid changes.",
      "Scope 2 is unaffected by grid intensity.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Drop the subject and forget about it.",
      ...
      "Refuse to do further work.",
      "Resign and report the firm publicly.",
    ],
    correctAnswer: 1,
    explanation:
