...
const faqs = [
  {
    question:
      'Is a small piece of WEEE — like a single replaced ceiling rose — really regulated waste?',
    answer:
  ...
  {
    question:
      'What is an Approved Authorised Treatment Facility (AATF) and how do I know if one is local?',
    answer:
  ...
  {
    question:
      'Are there any WEEE categories where the rules are different for installer waste versus household waste?',
    answer:
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 6 · Subsection 2"
        title="WEEE Regs 2013 and lithium-ion battery safety"
        backTo="/study-centre/apprentice/level3-module2-section6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The Waste Electrical and Electronic Equipment Regulations 2013 set
          producer-responsibility, take-back and treatment rules for everything that depends on
          electricity to work. Lithium-ion batteries sit at the high-risk end of WEEE — thermal
          runaway, segregation in storage and the safe response when a cell goes wrong are core
          apprentice safety knowledge.
        </p>
        ...
        >
          <p>The WEEE category structure (post-2019 simplification) used in UK reporting:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cat 1 Temperature exchange equipment</strong> — fridges, freezers, heat pumps,
              AC units. Often subject to F-Gas rules in addition to WEEE.
            </li>
            <li>
              <strong>Cat 2 Screens, monitors, equipment with screens</strong> — TVs, monitors,
              tablets. Often contains hazardous components.
            </li>
            <li>
              <strong>Cat 3 Lamps</strong> — fluorescent tubes, compact fluorescent lamps, certain
              LED lamps. Mercury content rules apply for fluorescents under the Hazardous Waste
              Regulations.
            </li>
            <li>
              <strong>Cat 4 Large equipment (over 50 cm)</strong> — washing machines, ovens, large
              luminaires, larger consumer units.
            </li>
            <li>
              <strong>Cat 5 Small equipment (50 cm or less)</strong> — most smoke alarms,
              accessories, small switchgear, downlighters, small transformers, small luminaires. The
              single biggest stream by item count.
            </li>
            <li>
              <strong>Cat 6 Small IT and telecoms equipment</strong> — phones, routers, small
              computing kit.
            </li>
          </ul>
          <p>
            Cable, copper offcuts and metallic fixings are not WEEE — they are metal-recyclable
            scrap. Most installers segregate copper for sale to a registered scrap merchant (which
            is itself a controlled waste activity under the Scrap Metal Dealers Act 2013). Plastics,
            packaging and inert builder waste fall outside WEEE entirely and follow the general
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;Electrical or electronic equipment&quot; means equipment which is dependent on
              ...
              for use with a voltage rating not exceeding 1000 volts for alternating current and
              1500 volts for direct current.
            </>
          }
          meaning={
            <>
              The definition catches almost everything an electrician will install or remove. The
              voltage caps (1000 V AC / 1500 V DC) cover all UK domestic and most commercial
              electrical equipment by a wide margin. Once the equipment is discarded it becomes WEEE
              and the producer-responsibility, take-back and treatment rules engage. Distributor
              Take-Back at the wholesaler is the standard installer-scale compliance route for the
              small-equipment stream that dominates rewire and accessory replacement work.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              Any person who imports, produces, carries, keeps, treats, disposes of or as a broker
              has control of controlled waste shall take all such measures applicable to him in that
              capacity as are reasonable in the circumstances to prevent the escape of waste, to
              ensure that it is transferred only to an authorised person, and that on the transfer
              there is provided a written description of the waste sufficient to enable the
              recipient to avoid contravening the law.
            </>
          }
          meaning={
            <>
              The Duty of Care is the umbrella duty across all controlled waste in the UK. It
              applies to WEEE, hazardous waste, construction waste and Li-ion batteries. The
              practical effect for an electrician is: keep WEEE contained, transfer only to a
              registered waste carrier, use a properly drawn-up waste transfer note (or hazardous
              waste consignment note where applicable), and retain the paperwork for at least two
              years. The Environment Agency, SEPA, NRW and NIEA all enforce.
            </>
          }
        ...
        >
          <p>Why Li-ion fires are so hard to put out:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>The cell carries its own oxidiser</strong> — the cathode material contains
              oxygen that is released during decomposition, so the fire does not need atmospheric
              oxygen to keep burning. Smothering does not work the way it does on a hydrocarbon
              fire.
            </li>
            <li>
              <strong>Self-heating runs the chemistry</strong> — water cools surrounding cells but
              does not interrupt the runaway chemistry inside the burning cell. The cell will burn
              until it exhausts its energy.
            </li>
            <li>
              <strong>Toxic and flammable vent gas</strong> — hydrogen fluoride, carbon monoxide,
              and various hydrocarbons. Breathing the vent gas is dangerous; the gas can also
              accumulate and explode.
            </li>
            <li>
              <strong>Propagation through the pack</strong> — heat from one runaway cell heats
              neighbouring cells through the pack body. Without a thermal break or active cooling
              the runaway propagates in seconds to minutes.
            </li>
            <li>
              <strong>Re-ignition risk</strong> — apparently extinguished cells can re-ignite hours
              later as residual energy redistributes. Treat any Li-ion-involved fire as continuing
        ...
        <RegsCallout
          ...
          clause={
            <>
              Lithium-ion cells and batteries are classified as Class 9 dangerous goods for
              transport (UN 3480 cells alone, UN 3481 cells contained in or packed with equipment).
              Damaged or defective Li-ion batteries (UN 3480/3481) are subject to special provisions
              including more robust packaging requirements and prohibition of carriage by air. The
              Carriage of Dangerous Goods Regulations apply where Li-ion batteries are carried by
              road in commercial quantities.
            </>
          }
          meaning={
            <>
              Carrying a small number of new, undamaged tool batteries between sites in a van is
              generally exempt under the small-quantity provisions. Carrying a damaged or swollen
              battery for disposal is not exempt and triggers the full Class 9 packaging, labelling
              and documentation rules. The simplest practical answer for an electrician is: do not
              transport damaged batteries in your own vehicle, arrange a specialist hazardous waste
        ...
        >
          <p>Storage and handling rules of thumb that scale from a van to a small workshop:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Segregate damaged from undamaged</strong> — never mix in the same container. A
              swollen, dented or leaking cell is in a pre-runaway state and should be physically
              isolated.
            </li>
            <li>
              <strong>Protect terminals</strong> — terminal tape, cell trays, original packaging or
              a partitioned battery storage box. Loose cells in a metal toolbox can short against
              each other or against tools.
            </li>
            <li>
              <strong>Avoid heat</strong> — hot vans in summer reach 50-60 degC, raising the rest
              state of every cell. Park in shade where possible, ventilate the van, and do not store
              in direct sunlight.
            </li>
            <li>
              <strong>Charge attended</strong> — charge during the working day on a non-combustible
              surface within view. Avoid charging overnight unattended in unmonitored spaces.
            </li>
            <li>
              <strong>Use approved chargers</strong> — manufacturer chargers or recognised
              compatible alternatives. Cheap aftermarket chargers without proper voltage regulation
              are a documented fire-risk pathway.
            </li>
            <li>
              <strong>Empty regularly</strong> — do not let damaged cells accumulate. Route to a
              battery recycling point or manufacturer take-back as soon as practical.
            </li>
            <li>
              <strong>Have a plan if a cell vents</strong> — clear evacuation route, fire service
              notification, and where possible move the venting cell outside onto a non-combustible
              surface and away from buildings.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>How the WEEE money flows under the producer responsibility model:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Producers register</strong> with the Environment Agency or join a PCS that
              registers them. They report their tonnages of equipment placed on market each year by
              category.
            </li>
            <li>
              <strong>PCSs collect fees</strong> from member producers based on tonnages placed on
              market and use the funds to deliver collection and treatment infrastructure.
            </li>
            <li>
              <strong>Approved Authorised Treatment Facilities (AATFs)</strong> are paid by the PCS
              to receive, treat and recycle WEEE. Tonnages treated are reported back to the EA to
              verify producer obligations are met.
            </li>
            <li>
              <strong>Distributor Take-Back Scheme</strong> at wholesalers is funded indirectly
              through the PCS network. Customers (including installers) deposit small WEEE free at
              the wholesaler counter.
            </li>
            <li>
              <strong>Civic amenity sites</strong> accept household WEEE through arrangements with
              PCSs and local authorities.
            </li>
            <li>
              <strong>Business WEEE</strong> is generally the responsibility of the end user to fund
              disposal, normally via a contract with a registered waste carrier — though Distributor
              Take-Back can sometimes accept small business WEEE alongside household.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Battery chemistries you will commonly meet on UK electrical strip-out:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lead-acid (Pb-PbO2)</strong> — UPS battery strings, older emergency lighting,
              older alarm systems, automotive starter batteries. EWC 16 06 01* (absolute hazardous,
              lead is a regulated heavy metal). Mature recycling industry with above-95% recovery
              rates.
            </li>
            <li>
              <strong>Nickel-cadmium (NiCd)</strong> — older battery-backed equipment, legacy
              emergency lighting. EWC 16 06 02* (absolute hazardous, cadmium is highly toxic).
              Specialist recycling route, declining in market share as EU Battery Directive
              restrictions phase out NiCd in many applications.
            </li>
            <li>
              <strong>Nickel-metal hydride (NiMH)</strong> — older portable kit, bridging chemistry
              between NiCd and Li-ion. Less hazardous than NiCd but still requires specialist
              recycling.
            </li>
            <li>
              <strong>Lithium-ion (Li-ion, NMC, LFP and others)</strong> — current default for
              cordless tools, modern emergency lighting, alarm system backup, battery storage.
              Specialist recycling, segregate damaged from undamaged, manufacturer take-back where
              available.
            </li>
            <li>
              <strong>Primary alkaline (single-use)</strong> — smoke alarm batteries, small
              accessory batteries. Not hazardous but still require recycling under the Waste
              Batteries and Accumulators Regulations. Take-back at supermarkets, DIY stores and
              civic amenity sites.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The end-of-life routine for a domestic battery storage system:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Identify the manufacturer</strong> — check the data plate for model and serial
              number. Major UK battery storage brands all operate take-back schemes.
            </li>
            <li>
              <strong>Document the condition</strong> — photograph the unit, note any damage,
              capture the data plate. Manufacturer triage often depends on the condition data.
            </li>
            <li>
              <strong>Isolate electrically</strong> — open the DC and AC isolators, lock off where
              possible. Do not try to disconnect the battery internals yourself.
            </li>
            <li>
              <strong>Contact manufacturer take-back</strong> — they will dispatch a specialist
              carrier with the right packaging and ADR compliance.
            </li>
            <li>
              <strong>Where the manufacturer is no longer trading</strong> — contact a specialist
              hazardous waste contractor licensed for Class 9 Li-ion. The EA public register lists
              licensed carriers and treatment facilities.
            </li>
            <li>
              <strong>Document the chain</strong> — keep the consignment note, the manufacturer
              reference and any photographs in the customer file. The customer holds the operator
              duty under WEEE and Battery Regulations.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The cable copper recycling routine:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Segregate at strip-out</strong> — keep cable offcuts separate from general
              WEEE and general site waste. Avoid contamination with steel, aluminium or polymer that
              will lower the scrap grade.
            </li>
            <li>
              <strong>Strip optionally</strong> — bare bright copper fetches near-spot price.
              Sheathed cable fetches less. The decision depends on volume and whether stripping is
              worth your time at the prevailing scrap price.
            </li>
            <li>
              <strong>Use a registered dealer</strong> — verify the Scrap Metal Dealers Act 2013
              registration before the first transaction. Most established dealers display the
              registration prominently.
            </li>
            <li>
              <strong>Identity check</strong> — present photo ID at first transaction. The dealer
              will record your details against every transaction.
            </li>
            <li>
              <strong>Accept traceable payment</strong> — bank transfer, cheque or similar. Cash
              payment is prohibited under the Scrap Metal Dealers Act.
            </li>
            <li>
              <strong>Retain receipts</strong> — for company records and as evidence of the lawful
              disposal route under the waste Duty of Care.
            </li>
            <li>
              <strong>Confirm BS EN 50625 downstream</strong> — for cable that is sold for
              processing rather than for direct material recovery, confirm the downstream recycler
              holds BS EN 50625 compliance documentation. This protects against cable being exported
              to unregulated open-burning operations.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>How to use the Distributor Take-Back Scheme correctly:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Segregate at source</strong> — keep WEEE separate from general waste, ideally
              in a labelled tote or bag in the van.
            </li>
            <li>
              <strong>Check the wholesaler participates</strong> — most major UK wholesalers do, but
              smaller independent merchants may not. A two-second check at the trade counter
              confirms.
            </li>
            <li>
              <strong>Deposit in the designated container</strong> — wholesalers have a dedicated
              WEEE collection cage or bin near the trade entrance.
            </li>
            <li>
              <strong>Respect the categories</strong> — most wholesaler take-back is set up for
              non-hazardous WEEE (Cat 5 small equipment dominates). Do not deposit hazardous waste
              (fluorescent tubes, PCB ballasts, batteries) in the general WEEE bin — those have
              their own routes.
            </li>
            <li>
              <strong>Aggregate intelligently</strong> — small WEEE from multiple jobs aggregated
              for a single wholesaler drop is more efficient than individual trips per job.
            </li>
            <li>
              <strong>Keep records on larger volumes</strong> — for larger quantities ask the
              wholesaler for a deposit confirmation. Most will provide one on request for trade
              customers.
            </li>
            <li>
              <strong>Escalate to registered carrier above the wholesaler limit</strong> — for large
              strip-out volumes that exceed the wholesaler take-back capacity, arrange a registered
              waste carrier collection from site with a proper waste transfer note.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              The kitchen rewire generates a small mountain of WEEE: old fuse board, downlighters,
              switches, sockets, integrated appliances, smoke alarms. The builder has a skip on site
              for the kitchen waste. The temptation is to throw the electrical waste in with the
              plasterboard and the timber and let the skip operator deal with it. The skip operator
              is a registered waste carrier for inert and mixed construction waste — but probably
              not an Approved Authorised Treatment Facility for WEEE. The Duty of Care is breached,
              no waste transfer note exists for the WEEE specifically, and on an Environment Agency
              audit of either party the trail leads back to the electrical contractor.
            </>
          }
          doInstead={
            <>
              Segregate the WEEE on site into a dedicated bag or tote. At the end of the job route
              it through the wholesaler Distributor Take-Back Scheme (most large UK electrical
              wholesalers operate this) or via a registered WEEE waste carrier. Keep the waste
              transfer note for at least two years. Document the segregation in the job pack so the
              customer can see the compliant route was followed. The compliance overhead is small
              once established as habit.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              End of day, the apprentice plugs four tool batteries into chargers on the wooden bench
              and leaves. One battery has a manufacturing defect or has taken a knock during the day
              that nobody noticed. Some time during the night a cell enters thermal runaway. The
              bench ignites. The workshop is unattended. The fire spreads to the neighbouring
              batteries, the tools, the timber stock and the building. Insurance investigators trace
              the origin to the charging station. The insurer either declines the claim or heavily
              restricts cover going forward.
            </>
          }
          doInstead={
            <>
              Charge during the working day on a non-combustible surface (metal tray, sand-filled
              tray, dedicated lithium-safe charging cabinet) with eyes-on. A purpose-made Li-ion
              charging cabinet is a one-off cost in the low hundreds of pounds. Avoid charging
              overnight unattended where practical and where it cannot be avoided do it on a
              fire-resistant surface in a space with smoke detection and ideally automatic
              suppression. The principle scales: never trust a battery you cannot see.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You arrive at a customer property to fit a new EV charger. While you are there the
              customer mentions that their original 5 kWh lithium-ion solar storage battery
              (installed eight years ago by another contractor) has started to look swollen and the
              casing seems warm to touch. They ask if you can take it away when you leave because
              they have been meaning to get rid of it for months. The battery is in the garage,
              sitting next to the consumer unit and a stack of cardboard boxes.
            </>
          }
          whatToDo={
            <>
              Decline politely to take it away in your van. Explain that a swollen Li-ion battery is
              in a pre-runaway state, is classified as dangerous goods for transport (UN 3480 Class
              9), and requires specialist packaging and labelling that you do not carry. Recommend
              the customer move the battery outside (carefully, not by the swollen face) onto a
              non-combustible surface away from the building and any other batteries. Photograph the
              state of the battery for the customer record. Identify the manufacturer from the data
              plate and check the take-back scheme — most UK domestic solar storage manufacturers
              (Tesla Powerwall, GivEnergy, Sonnen, BYD and similar) operate a free or low-cost
              end-of-life take-back. Where the manufacturer is no longer trading the customer should
              arrange a specialist hazardous-waste collection. Document the advice in writing (text
              or email) so the customer has a record and you have evidence of the correct referral.
            </>
          }
          whyItMatters={
            <>
              Customers will ask you to take dangerous things away in your van because you turned up
              in a van and seem helpful. The right answer is almost always to refer rather than to
              transport. A polite refusal with clear practical onward routing protects the customer,
              you, your employer and the environment in one move. The phrase to practise is
              &quot;that needs a specialist hazardous waste route — I will write down the right
              contact for you&quot;.
            </>
          }
        />
