...
const TITLE = 'BS 7671 Section 753 (heating) deeper (2.3) | Level 3 Module 2.2.3 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question: 'What does the F-Gas Regulations mean for the L3 apprentice on a heat pump install?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question: 'What is the typical electrical interface for a domestic air-source heat pump?',
    options: [
  ...
  {
    id: 2,
    question: 'What does Building Regs Part L require for a new-build property with a heat pump?',
    options: [
  ...
  {
    id: 4,
    question: 'What does PAS 2035 mean and when does it apply to a heat pump retrofit?',
    options: [
  ...
  {
    id: 5,
    question: 'Why does a heat pump typically use a Type C MCB or RCBO rather than a Type B?',
    options: [
  ...
  {
    id: 7,
    question: 'What labelling is required on a domestic heat pump installation per BS 7671?',
    options: [
...
const faqs = [
  ...
  {
    question:
      "How does a heat pump's flow temperature affect its SCOP and why does the apprentice care?",
    answer:
  ...
  {
    question:
      'What happens if the customer has a heat pump and an immersion heater — how does that fit Part L?',
    answer:
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 2 · Subsection 3"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Section 753 covers heating cables and embedded heating systems. The broader heat pump
          install draws on general BS 7671, F-Gas Regulations for refrigerant work, MCS MIS 3005 for
          design and installer competence, and Building Regs Part L for Part L compliance. The L3
          apprentice's electrical scope sits within this regulatory map.
        </p>
        ...
        >
          <p>Section 753 typical applications:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Underfloor electric heating</strong> — heating cable or mat embedded in floor
              screed, fed from a thermostat / programmer. Common in bathrooms and kitchens.
            </li>
            <li>
              <strong>Trace heating</strong> — heating cable wrapped around or run alongside
              pipework to prevent freezing. Common on external pipework, cold rooms, drainage in
              cold climates.
            </li>
            <li>
              <strong>Heated mirrors and handrails</strong> — small heating elements integrated into
              bathroom mirrors (anti-fogging) or commercial handrails (anti-icing).
            </li>
            <li>
              <strong>Integrated electric trim / boost in HVAC</strong> — secondary electric heating
              elements integrated into heat pump systems for specific zones or duties.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              "The requirements of this section apply to electrical heating systems with embedded
              heating cables or embedded heating film, and to surface heating systems on roofs, in
              gutters, and on pipework, vessels and walkways. The requirements supplement and modify
              the general requirements of this Standard."
            </>
          }
          meaning={
            <>
              Section 753 covers embedded electrical heating in its various forms. On a typical UK
              domestic heat pump install Section 753 applies where any electric heating element is
              integrated; the wet pipework circulating water from the heat pump is not Section 753.
              A4:2026 has refined Section 753 alongside the broader updates. The IET Codes of
              Practice for specific heating technologies (underfloor electric, trace heating) give
        ...
        >
          <p>The F-Gas trade split:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>F-Gas scope (NOT the L3 electrician without F-Gas cert)</strong> — refrigerant
              pipework, charging, recovery, leak testing, refrigerant disposal.
            </li>
            <li>
              <strong>L3 electrician scope</strong> — electrical supply, isolation, controls,
              bonding, embedded heating per Section 753, commissioning of electrical side.
            </li>
            <li>
              <strong>Joint scope</strong> — first-fix coordination (cable routes, refrigerant pipe
              routes, condensate drainage), final commissioning sign-off, customer handover.
            </li>
            <li>
              <strong>Refrigerant choice trends</strong> — R32 dominant in 2020-2024 modern systems;
              R290 (propane, natural refrigerant) increasingly common in 2024-2026 for low-GWP
              regulatory reasons. R290 has its own additional safety requirements (flammability) but
              reduces F-Gas regulatory burden.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The four-document map for a UK domestic heat pump install:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BS 7671 (general plus Section 753 where applicable)</strong> — electrical
              safety. Mandatory.
            </li>
            <li>
              <strong>F-Gas Regulations</strong> — refrigerant work. Mandatory for refrigerant
              scope; requires F-Gas certification.
            </li>
            <li>
              <strong>MCS MIS 3005</strong> — install quality and BUS grant access. Required for
              grant eligibility; effectively mandatory for UK domestic.
            </li>
            <li>
              <strong>Building Regs Part L</strong> — energy efficiency. Mandatory for new-build and
              notifiable refurbishment; the SAP calculation includes the heat pump's SCOP.
            </li>
            <li>
              <strong>PAS 2035 (where applicable)</strong> — whole-house retrofit standard for
        ...
        >
          <p>The electrical interface in numbers (typical UK domestic ASHP):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply rating</strong> — typically 32 A or 40 A radial single-phase for 5-12
              kW units. Three-phase units (large or commercial) sit above.
            </li>
            <li>
              <strong>OCPD type</strong> — Type C MCB or RCBO is the standard. Some modern
              soft-start inverter units accept Type B; check the manual.
            </li>
            <li>
              <strong>Cable size</strong> — 6 mm or 10 mm T+E typical for 32 A or 40 A circuits
              respectively, depending on length and method. SWA for outdoor runs to the unit.
            </li>
            <li>
              <strong>RCD</strong> — Type A typically acceptable for inverter-driven heat pumps;
              some larger or three-phase units may need Type B per Section 531. Manufacturer&apos;s
              manual is the binding source.
            </li>
            <li>
              <strong>Local isolator</strong> — outdoor-rated rotary or padlockable isolator within
              sight of the outdoor unit per Section 537. Allows safe isolation for service without
              going to the consumer unit.
            </li>
            <li>
              <strong>Bonding</strong> — outdoor unit chassis bonded if it forms an
              extraneous-conductive-part. Typically the case where the unit connects via metallic
              refrigerant pipes to the indoor system; check at install.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Immersion and legionella considerations:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Legionella cycle requirement</strong> — typically 60 degC for an hour at least
              once a week per L8 ACoP guidance for stored hot water.
            </li>
            <li>
              <strong>Immersion rating</strong> — typically 3 kW on 16 A circuit. Some larger
              cylinders or commercial use 6 kW on 32 A.
            </li>
            <li>
              <strong>Programmable thermostat / timer</strong> — triggers the weekly cycle; some
              heat pump cylinder controllers handle this internally given only a switched supply to
              the immersion.
            </li>
            <li>
              <strong>Customer brief</strong> — do not run the immersion routinely; the legionella
              cycle is automated; if the heat pump fails the immersion can hold hot water as
              emergency backup but at higher running cost.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The controls layer typically includes:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Weather compensation</strong> — outdoor sensor (sometimes built into the
              outdoor unit, sometimes a separate sensor near the eaves) feeds outdoor temperature;
              controller drops flow temperature on milder days. Single biggest SCOP improvement
              available.
            </li>
            <li>
              <strong>Room compensation</strong> — primary room sensor (typically the living room)
              feeds room temperature; controller modulates output to hit setpoint without overshoot.
            </li>
            <li>
              <strong>Multi-zone scheduling</strong> — separate zones (downstairs, upstairs, hot
              water) each with their own setpoint and schedule.
            </li>
            <li>
              <strong>Tariff awareness</strong> — increasingly available; heat pump pre-heats the
              cylinder during cheap-rate windows, defers compressor run during peak windows.
            </li>
            <li>
              <strong>Remote / app control</strong> — customer-facing app for schedule changes,
              holiday mode, monitoring.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The refrigerant landscape in 2026:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>R410A (legacy)</strong> — GWP 2088. Phased out for new equipment; still in
              service on 2010-2018 systems. Recovery and disposal under F-Gas.
            </li>
            <li>
              <strong>R32 (current dominant)</strong> — GWP 675. Mildly flammable (A2L). Most
              2018-2024 systems. F-Gas-certified install and service.
            </li>
            <li>
              <strong>R290 / propane (rising)</strong> — GWP 3. Fully flammable (A3). Outdoor units
              only typically; clearance rules to openings and ignition sources. F-Gas-certified plus
              additional ATEX-style safety considerations for the engineer.
            </li>
            <li>
              <strong>CO2 / R744 (commercial / DHW)</strong> — GWP 1. Used in some high-temperature
              commercial DHW heat pumps. Very high operating pressures.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The supply-upgrade trigger conditions:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Existing 60 A main fuse plus heat pump plus EV</strong> — load management
              essential; upgrade to 80 A or 100 A worth discussing.
            </li>
            <li>
              <strong>Existing 80 A plus heat pump plus EV plus other heavy loads</strong>— normally
              fits with HEMS dispatch and load management; borderline at concurrent peak.
            </li>
            <li>
              <strong>Customer planning full electrification within 5 years</strong>— push for 100 A
              or three-phase upgrade now while the supply is being touched.
            </li>
            <li>
              <strong>Three-phase already present</strong> — opens 22 kW EV charging and headroom
              for full electrification; flag the opportunity.
            </li>
            <li>
              <strong>Network reinforcement programmes</strong> — Some DNOs subsidise or free-fund
              supply upgrades for low-carbon installs. Check before quoting.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice or non-F-Gas-certified electrician handles refrigerant pipework on the
              basis that 'it is the same as plumbing'. It is not. F-Gas Regulations are a regulatory
              regime with their own competence requirements, leak-test standards, refrigerant
              handling rules and certification. Crossing the line without certification: regulatory
              offence, insurance void, F-Gas leakage risk to atmosphere (refrigerants are powerful
              greenhouse gases — R32 has 675x the GWP of CO2), system failure risk if the joint is
              not properly tested. Not worth it.
            </>
          }
          doInstead={
            <>
              Stay strictly within the electrical scope unless you hold F-Gas certification (City
              &amp; Guilds 2079 or equivalent). Coordinate with the F-Gas-certified engineer on
              first fix (cable routes alongside pipe routes), but never handle refrigerant pipework
              or charging without the certification. If the apprentice wants to expand into the
              refrigerant trade later, the route is the F-Gas qualification — there is no shortcut.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice fits a Type B MCB on the heat pump final circuit because that is what the
              consumer unit happened to have spare. The compressor's start-up inrush (5-10x
              steady-state) trips the Type B (3-5x trip threshold) on the first cold morning.
              Customer's heating is off; callback to swap the device for a Type C; reputation damage
              avoidable.
            </>
          }
          doInstead={
            <>
              ...
              otherwise. Some modern inverter-driven heat pumps with soft-start are explicitly
              compatible with Type B; most still recommend Type C. Read the manual before specifying
              the protective device. The MCS-certified designer should specify; the apprentice
        ...
        <Scenario
          ...
          situation={
            <>
              You are the apprentice on a Mitsubishi Ecodan 8.5 kW air-source heat pump install
              replacing a 1990s combi boiler at a 4-bed semi. The MCS-certified designer (holding
              MIS 3005) has produced the system design — flow temperature 45 degC into upsized
              radiators, a 250 L unvented cylinder with backup immersion, weather compensation
              control, BUS grant claim. The F-Gas-certified engineer is handling the outdoor unit,
              refrigerant pipework, indoor cylinder coil and refrigerant charging. Your electrical
              scope: 40 A radial on 10 mm T+E from the consumer unit to the outdoor unit location,
              Type C RCBO at the consumer unit, local isolator outside near the outdoor unit,
              controls cabling between outdoor unit and indoor cylinder controller
              (manufacturer-specified pairs), bonding of the outdoor chassis
              (extraneous-conductive-part criteria met because of the wet system connection), 16 A
              radial on 2.5 mm T+E to the immersion heater with programmable thermostat. No Section
              753 elements (no electric trim heaters in this design).
            </>
          }
          whatToDo={
            <>
              First fix: pull the 10 mm T+E cable through wall to outdoor unit location; pull the
              2.5 mm T+E to immersion location; pull the controls cabling per manufacturer's wiring
              diagram; coordinate cable routes with the F-Gas engineer's refrigerant pipe routes.
              Second fix: terminate at consumer unit on new Type C RCBO; install local isolator
              outside; terminate at outdoor unit per wiring diagram; terminate controls; install
              immersion thermostat and programmable timer; bond outdoor chassis. Coordinate
              commissioning with the F-Gas engineer — they handle refrigerant charge and
              pressure-test, you handle electrical commissioning and controls validation. MCS
              designer signs off the system commissioning including SCOP estimate and customer
              handover documentation. Customer briefing: which isolator does what, how the immersion
              programmer works, what to expect from the heat pump in cold weather.
            </>
          }
          whyItMatters={
            <>
              ASHP installs are now mainstream UK domestic work. The L3 apprentice's role on the
              electrical side is real and significant — the supply, the controls, the bonding, the
              immersion, the labelling. Recognising the trade boundary (F-Gas separate, MCS designer
              overall, electrician electrical) is part of working effectively on a multi-trade
              install. The customer's BUS grant depends on the MCS sign-off; the install's
              electrical safety depends on the electrician's BS 7671 work; the refrigerant safety
              depends on F-Gas. All three trades contribute; none can skip the boundary.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Heat-pump installs typically include local socket-outlets at the outdoor unit or the
              cylinder cupboard for service work. Those sockets fall under 411.3.3 and must have RCD
              protection at the 32 A threshold and below. In a dwelling there is no risk-assessment
              exemption.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              A heat-pump radial circuit is a fixed-load AC final circuit drawing high current for
              hours at a time — exactly the scenario AFDDs target. The regulation uses
              &quot;recommending&quot;, so AFDDs are not blanket-mandatory under BS 7671 for a
              domestic heat pump, but a competent designer will normally specify them anyway and
              HRRBs bring AFDDs in via the Building Safety Act framework.
            </>
          }
        ...
        <Quiz
          title="BS 7671 Section 753 and heat pump regulatory map — knowledge check"
