...
const TITLE = 'BS 7671 Section 712 (PV) deeper (2.1) | Level 3 Module 2.2.1 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question: 'Why is MCS MIS 3002 separate from BS 7671 Section 712, and what does each cover?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question: 'What is the scope statement of BS 7671 Section 712 in plain English?',
    options: [
  ...
  {
    id: 3,
    question: 'What does the term anti-islanding mean for a grid-connected PV inverter?',
    options: [
  ...
  {
    id: 4,
    question: 'On a hybrid PV-battery system, how do BS 7671 Sections 712 and 826 interact?',
    options: [
...
const faqs = [
  {
    question:
      'Why does PV need its own section in BS 7671 rather than just using the general regulations?',
    answer:
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 2 · Subsection 1"
        title="BS 7671 Section 712 (Solar PV) — deeper dive"
        backTo="/study-centre/apprentice/level3-module2-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Section 712 governs every UK PV installation. A4:2026 has substantially refreshed the
          section to reflect modern PV practice. This subsection covers the regulation map, the DC
          isolation rationale, the relationship with Section 826 on hybrid systems, the IET Code of
          Practice for Grid-Connected Solar PV, MCS MIS 3002 install certification and ENA G98/G99
          grid notification.
        </p>
        ...
        >
          <p>Section 712 is read alongside other BS 7671 sections that apply generally:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Section 411</strong> — protective measure (ADS) for general installations
              including the AC side of PV.
            </li>
            <li>
              <strong>Section 514</strong> — identification and notices, supplemented by PV-specific
              labels per Section 712 and the IET CoP.
            </li>
            <li>
              <strong>Section 522</strong> — selection and erection in relation to external
              influences (UV, temperature, mechanical for the cable side).
            </li>
            <li>
              <strong>Section 532</strong> — RCD requirements for the AC side of the inverter.
            </li>
            <li>
              <strong>Section 826</strong> — applies on hybrid PV-battery systems alongside Section
              712.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              "The requirements of this section apply to PV installations: not connected to a system
              ...
              distribution of electricity to the public. The requirements supplement and modify the
              general requirements of this Standard."
            </>
          }
          meaning={
            <>
              Section 712 is the BS 7671 anchor for every UK PV installation. A4:2026 has
              substantially refreshed the section to reflect modern PV practice including hybrid
              PV-battery systems, microinverters, module-level power electronics and refined DC
              isolation requirements. The IET Code of Practice for Grid-Connected Solar Photovoltaic
              Systems (currently 4th edition with 2026 update) is the practical implementation
              guide. MCS MIS 3002 is the installer / product certification scheme. ENA G98 / G99
              covers grid connection notification.
            </>
          }
        ...
        >
          <p>The four DC isolation considerations on a PV install:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Inverter-side isolator</strong> — required on every install by Section 712.
              Used by the installer for safe work on the inverter.
            </li>
            <li>
              <strong>Roof-side isolator</strong> — optional but increasingly recommended in the IET
              Code of Practice for fire-fighter safety. Some MCS designers specify one as standard.
            </li>
            <li>
              <strong>Module-level rapid shutdown</strong> — provided by microinverter and
              DC-optimiser systems. Drops module voltage to safe levels on signal. Best practice for
              fire safety on new installs.
            </li>
            <li>
              <strong>Labelling</strong> — the DC isolator is labelled with a warning that the array
              remains energised on the source side in light. Standard wording is given in the IET
              CoP.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Hybrid system regulation map:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BS 7671 Section 712</strong> — PV side electrical requirements.
            </li>
            <li>
              <strong>BS 7671 Section 826</strong> — EESS aspects (battery isolation, BMS, fire
              safety, signage).
            </li>
            <li>
              <strong>IET Code of Practice for Grid-Connected Solar PV</strong> — practical PV
              implementation.
            </li>
            <li>
              <strong>IET Code of Practice for Electrical Energy Storage Systems</strong> —
              practical EESS implementation.
            </li>
            <li>
              <strong>MCS MIS 3002</strong> — installer competence and product certification for PV.
            </li>
            <li>
              <strong>MCS MIS 3012</strong> — installer competence and product certification for
              storage.
            </li>
            <li>
              <strong>ENA G98 / G99</strong> — grid connection notification covering the combined
              export profile.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The four-document map at a glance:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BS 7671 Section 712</strong> — legal floor for electrical safety. Mandatory
              under the Building Regulations and CDM. A4:2026 substantially refreshed the section.
            </li>
            <li>
              <strong>IET Code of Practice for Grid-Connected Solar Photovoltaic Systems</strong> —
              practical implementation guide. Currently 4th edition with 2026 update reflecting
              A4:2026 changes. Not legally mandatory but referenced by MCS and by
              reasonable-installer expectations.
            </li>
            <li>
              <strong>MCS MIS 3002</strong> — installer competence and product certification scheme.
              Required for the customer to claim Smart Export Guarantee payments and demonstrate
              quality assurance.
            </li>
            <li>
              <strong>ENA G98 / G99</strong> — grid connection notification regulations. G98
              connect-and-notify up to 16 A per phase; G99 application-and-approval above that.
            </li>
          </ul>
          <p>
            Without any one of these four, the install has a gap. BS 7671 alone — the install is
            electrically safe but the customer cannot claim SEG and the grid connection is
            unauthorised. MCS alone — the customer has SEG eligibility but the install may not
            satisfy BS 7671. The four go together.
          </p>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Anti-islanding — the safety rail under every grid-tied PV inverter
        </ContentEyebrow>
        ...
        >
          <p>The four protection layers on every G98 / G99 inverter:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Over-voltage / under-voltage trip</strong> — disconnects if the grid voltage
              moves outside the acceptable envelope (typically 207-253 V on UK single-phase).
              Standard G98 / G99 setting.
            </li>
            <li>
              <strong>Over-frequency / under-frequency trip</strong> — disconnects if grid frequency
              moves outside the acceptable envelope (47.5-51.5 Hz typical). Detects island formation
              because an islanded section drifts quickly.
            </li>
            <li>
              <strong>Loss of mains (LOM) detection</strong> — active or passive method detecting
              that the grid reference has been lost. Active methods inject a small frequency or
              voltage perturbation and watch for an unstable response. Required by G98 / G99.
            </li>
            <li>
              <strong>Reconnection delay</strong> — after a grid trip, the inverter stays
              disconnected for a defined hold-off period (typically 60-180 seconds for G98, longer
              for G99) before attempting reconnection. Stops the inverter from oscillating in and
              out of an unstable network.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>When string fusing is required:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single string per MPPT input</strong> — typically no string fuse required. The
              inverter input fuses suffice. Most UK domestic 3-6 kWp installs.
            </li>
            <li>
              <strong>Two or three strings paralleled into one MPPT input</strong> — string fuses
              required because a faulted string can be back-fed by the parallel strings. Designer
              specifies fuse rating per the module data sheet and the IEC 62548 calculation.
            </li>
            <li>
              <strong>Microinverter systems (Enphase)</strong> — DC question disappears at the
              module boundary; AC trunk cable from microinverters to the consumer unit fuses on the
              AC side per Section 411.
            </li>
            <li>
              <strong>Module-level optimisers (SolarEdge)</strong> — depends on topology. The
              MCS-certified designer specifies.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The headline A4:2026 PV themes worth recognising:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Modern topology coverage</strong> — explicit treatment of microinverters,
              module-level optimisers, hybrid PV-battery inverters and AC-coupled retrofits. The
              original 18th Edition predated much of this kit.
            </li>
            <li>
              <strong>DC isolation refinement</strong> — clearer rules on roof-side isolators,
              module-level rapid shutdown, and the labelling that goes with them. Improves
              fire-fighter safety on rescue access.
            </li>
            <li>
              <strong>Section 826 interface clarification</strong> — hybrid PV-battery systems now
              have explicit guidance on how the two sections interact, replacing case-by-case
              interpretation.
            </li>
            <li>
              <strong>AFDDs in residential</strong> — the broader A4:2026 push on AFDDs in
              residential premises affects the AC side of PV installs in the consumer unit.
            </li>
            <li>
              <strong>Updated labelling wording</strong> — Section 514 plus 712-specific labels
              aligned with the IET CoP. Old labels from pre-2026 installs may read differently —
              they are not non-compliant retrospectively but new installs follow the updated
              wording.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>PV-specific EICR additions:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DC isolator function</strong> — operate, verify isolation, inspect for damage
              and labelling integrity.
            </li>
            <li>
              <strong>Anti-islanding test</strong> — open the AC isolator, verify the inverter
              trips, verify the reconnection delay before re-energising.
            </li>
            <li>
              <strong>Labelling audit</strong> — every required label present, legible, and aligned
              with the current IET CoP wording. Replace faded or missing labels.
            </li>
            <li>
              <strong>DC string visual inspection</strong> — UV damage to insulation where exposed,
              mechanical damage at penetration points, termination integrity at the inverter and any
              combiner boxes.
            </li>
            <li>
              <strong>Generation meter check</strong> — confirm the meter is operational and the
              generation reading aligns with the inverter portal data within reasonable tolerance.
            </li>
            <li>
              <strong>Earthing and bonding verification</strong> — the array frame bonding (if
              specified by the design) and the inverter chassis earth continuity.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice opens the AC isolator at the consumer unit, assumes the inverter is now
              de-energised, and starts work on the inverter terminals. The DC side of the inverter
              is still live — sunlight is still hitting the panels and pushing 350-600 V DC into the
              inverter input terminals. Worker takes a serious DC shock from cable terminations they
              thought were dead.
            </>
          }
          doInstead={
            <>
              Open the DC isolator before any work on the inverter or DC strings. Verify dead with
              an appropriate DC-rated tester (an AC-only voltmeter may not register DC fault
              voltages reliably). Confirm the inverter has discharged — capacitors inside hold
              residual voltage for some time after isolation. The IET Code of Practice gives the
              recommended sequence. Section 712 mandates the isolator; using it correctly is the
              apprentice's responsibility every time.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              but only labels them as 'isolator' and 'PV'. The DC isolator at the inverter is
              unlabelled. The consumer unit has no dual-supply notice. Three years later the
              customer calls a different electrician for an unrelated job; the new electrician does
              not realise the property has PV until they open the consumer unit and find an
              unlabelled feeder coming in. Investigation time wasted; safety concern raised.
            </>
          }
          doInstead={
            <>
              Use the labelling wording recommended by the IET Code of Practice — 'PV DC ISOLATOR —
              OPEN BEFORE WORKING ON INVERTER OR DC CABLES — ARRAY REMAINS ENERGISED IN LIGHT'; 'PV
              AC ISOLATOR'; 'WARNING — DUAL SUPPLY — DO NOT WORK ON THIS INSTALLATION WITHOUT
              ISOLATING BOTH GRID AND PV SUPPLY' on the CU. External label identifying the property
              as PV-equipped. The labels are cheap; the operational and safety value is high.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You are the apprentice on a 5 kWp PV plus 5 kWh battery hybrid install at a 2010s
              detached house. The MCS-certified designer (holding both MIS 3002 and MIS 3012) has
              specified a SolarEdge hybrid inverter with module-level DC optimisers, a wall-mounted
              LFP battery, and the standard package of DC isolation, AC isolation, dual-supply
              labelling and rapid-shutdown labelling. The DNO connection is being notified under G98
              because the inverter rating sits inside the 16 A per phase threshold. Cable runs
              include the PV DC strings from roof to inverter via a steel conduit through the loft,
              the battery DC connection (short run inside the same plant cupboard as the inverter),
              the inverter AC output to a new RCBO in the consumer unit, the BMS comms cable from
              battery to inverter, and Cat6 to the inverter location for the SolarEdge monitoring
              portal.
            </>
          }
          whatToDo={
            <>
              First fix: pull PV DC strings through the steel conduit from roof to plant cupboard;
              pull AC supply from CU to plant cupboard; pull Cat6 to plant cupboard. Second fix:
              terminate PV DC strings at the inverter with the DC isolator on the source side;
              terminate battery DC connection per the hybrid inverter manual; install BMS comms
              cable per the manufacturer's specified pinout; terminate AC output to the new RCBO in
              the CU; install dual-supply notice on the CU; install PV DC isolator label per the IET
              CoP wording; install external 'PV INSTALLED' label near the meter cabinet. Coordinate
              commissioning with the MCS designer: PV side energised first, battery side
              commissioned, integrated test (PV charging battery, battery discharging through
              inverter to property), G98 notification submitted within 28 days. Customer handover
              including the integrated documentation pack covering both Section 712 (PV) and Section
              826 (battery) sides.
            </>
          }
          whyItMatters={
            <>
              ...
              should expect to encounter them and recognise that two BS 7671 sections (712 and 826),
              two MCS standards (MIS 3002 and MIS 3012), two IET Codes of Practice and one ENA G98
              notification all apply. Recognising the regulation map is half the job; executing the
              wiring per the design is the other half.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              replacement-supply — the same regulation applies to all three. A4:2026 expanded and
              rewrote the section. Read the manufacturer&apos;s instructions alongside Section 712
              and the relevant MCS MIS 3002 standard for installer competence.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              residential buildings (HRRBs) bring AFDDs in as a mandatory measure via the Building
              Safety Act 2022 framework. On a typical domestic PV install you&apos;ll see AFDDs
              increasingly fitted on the AC inverter feed even though the regulation stops at
              recommendation.
            </>
          }
