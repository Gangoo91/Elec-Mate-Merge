...
const TITLE = 'Inspection and test of env tech (2.5) | Level 3 Module 2.2.5 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question: 'What does BS 7671 Part 6 require on completion of an environmental tech install?',
    options: [
  ...
  {
    id: 2,
    question: 'What is IEC 62446-1 and how does it relate to MCS MGD 003?',
    options: [
  ...
  {
    id: 4,
    question: 'How do you record signage on the EICR when inspecting an existing PV install?',
    options: [
  ...
  {
    id: 5,
    question: 'What is the test for verifying anti-islanding works on a commissioned PV install?',
    options: [
  ...
  {
    id: 6,
    question: 'What is the role of the MCS-certified umbrella scheme in commissioning?',
    options: [
  ...
  {
    id: 7,
    question: "How often must a PV install be EICR'd, and what is the customer's legal duty?",
    options: [
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 2 · Subsection 5"
        title="Inspection and test of environmental tech"
        backTo="/study-centre/apprentice/level3-module2-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The inspection and test framework for environmental technology systems pulls together BS
          7671 Part 6, IEC 62446 PV verification, MCS commissioning evidence and the EICR scope on
          env tech additions. Recognising the documentation chain is part of the L3 apprentice
          scope.
        </p>
        ...
        >
          <p>The Part 6 sequence in plain terms:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Visual inspection</strong> — kit installed correctly, isolators accessible,
              signage present, no visible damage, manufacturer instructions followed.
            </li>
            <li>
            ...
            <li>
              <strong>Insulation resistance</strong> — between live conductors, between live and
              earth, at 500 V dc (typical for 230 V circuit). Acceptable values normally above 1
              megohm. Env tech kit may need to be disconnected for the test (inverter, EV charger,
              heat pump) to avoid damage to electronic circuitry.
            </li>
            <li>
              <strong>Polarity</strong> — line and neutral correctly oriented at every point. A
              polarity error in a final circuit is a category C2 defect and usually reflects a
              mistake in the consumer unit termination.
            </li>
            <li>
              <strong>Earth fault loop impedance Zs</strong> — measured with a loop tester at the
              furthest point of each final circuit. Compared to the maximum tabulated value for the
              protective device.
            </li>
            <li>
              <strong>RCD operating time</strong> — verified with an RCD tester at the rated
              tripping current. Type B for EV chargers, Type A for many other circuits, time-delayed
              not allowed for heating per Section 753.
            </li>
          </ul>
          <p>
            Each of these tests is recorded on the EIC schedule. Modern test instruments (Megger
            MFT, Fluke 1664, Metrel MI 3155) automate the sequence and produce a digital test record
            that flows directly into the EIC.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Initial verification is mandatory for every new installation, addition or alteration
              before being put into service. Section 712 contains specific requirements for PV
              systems including additional inspection items (DC isolation accessibility, dual-source
              signage at the consumer unit and meter position, isolator identification, polarity
              verification on the DC side). The requirements are in addition to the general
              inspection and testing requirements of Part 6.
            </>
          }
          meaning={
            <>
              BS 7671 Part 6 plus Section 712 together define the inspection and test scope for PV.
              The L3 apprentice should recognise that env tech adds requirements on top of standard
              Part 6 — DC string testing, signage verification, isolator accessibility — and that
              these are recorded on the EIC supplemented by a PV-specific commissioning sheet.
              A4:2026 has tightened the PV signage and isolation requirements; check the live
              edition.
            </>
          }
        ...
        >
          <p>Common failure modes the test catches:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reverse polarity</strong> — installer crossed positive and negative at a
              junction box. Energising the inverter on a reverse-polarity string damages the
              inverter input stage. Test catches it before damage.
            </li>
            <li>
              <strong>Shorted bypass diode</strong> — a panel with a failed bypass diode shows
              abnormal Voc (one cell-string worth lower than expected). Indicates a faulty panel
              that needs replacement under warranty.
            </li>
            <li>
              <strong>Insulation defect</strong> — water in a junction box, damaged cable
              insulation, panel laminate fault. IR test below threshold rejects the string before
              energisation.
            </li>
            <li>
              <strong>Wrong number of panels in series</strong> — Voc reading low or high compared
              to expected. Either a panel is missing from the string, or an extra panel has been
              added. MCS designer verifies count.
            </li>
            <li>
              <strong>Ground fault at array</strong> — a damaged frame bonding allowing live
              conductor to touch metalwork. IR test catches it; ground fault tools in modern
              inverters also detect it after energisation.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>EICR coding for env tech findings — typical examples:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>C1 (Danger present, immediate action)</strong> — exposed live parts at a
              damaged DC isolator; missing earth at the EV charger creating a live chassis; exposed
              DC cable damaged with conductor visible.
            </li>
            <li>
              <strong>C2 (Potentially dangerous, urgent remedial)</strong> — wrong RCD type on EV
              charger (Type AC instead of Type B / Type A + RDC-DD); missing open-PEN protection on
              PME-supplied EV charger; PV DC isolator inaccessible or seized.
            </li>
            <li>
              <strong>C3 (Improvement recommended)</strong> — missing or illegible Section 712
              signage; PV install pre-dating current standards but functionally safe; heat pump
              supply on Type B MCB causing periodic nuisance trips on compressor inrush.
            </li>
            <li>
              <strong>FI (Further investigation required)</strong> — anomalous Voc reading on a PV
              string suggesting a faulty panel; intermittent inverter fault that cannot be
              reproduced on inspection day; customer report of EV charger tripping that does not
              appear during test.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Pack contents — typical PV install:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>BS 7671 EIC for the electrical work, signed by the contractor.</li>
            <li>
              PV-specific commissioning record (Voc, Isc, IR, polarity per string per IEC 62446-1 /
              MCS MGD 003).
            </li>
            <li>
              MCS Commissioning Certificate (the MCS-certified installer sign-off — required for SEG
              eligibility).
            </li>
            ...
            <li>
              Single-line electrical schematic from array → DC isolator → inverter → AC isolator →
              meter → consumer unit.
            </li>
        ...
        >
          <p>
            The two engineering recommendations that govern domestic / small commercial generation
            in the UK:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Engineering Recommendation G98:</strong> "Connect and Notify" — applies to
              type-tested fully-fitted inverter generation up to 16 A per phase per inverter, on a
              230 / 400 V LV supply. The installer fits the unit and notifies the DNO within 28 days
              using the G98 short-form notification. Multiple G98 inverters at the same property
              accumulate; over the 16 A per phase aggregate threshold, G99 applies instead.
            </li>
            <li>
              <strong>Engineering Recommendation G99:</strong> "Apply and Wait" — applies to
              anything not covered by G98. The installer (or designer) submits a G99 application to
              the DNO with the proposed scheme, the DNO issues a Connection Offer (often with
              conditions on protection settings, fault levels, or network reinforcement), the
              installer accepts and installs to the offer, then commissions and submits the G99
              commissioning record. Typical G99 projects: 4 kWp+ PV with battery export, three-phase
              EV charging banks, small commercial CHP / wind / heat pump combinations.
            </li>
            <li>
              <strong>Type-test certificates:</strong> G98 / G99 both rely on the inverter being
              type-tested to the relevant standard (currently BS EN 50549-1 / -2 in place of the
              older G83 / G59 standards). The type-test certificate must be included with the
              notification or application — without it, the inverter cannot be lawfully
              grid-connected. The MCS database carries type-tested inverter listings; check before
              specifying.
            </li>
          </ul>
          <p>
            Why this matters at L3 even though the apprentice does not personally sign the
            notification: the install evidence the apprentice records during commissioning (Voc /
            Isc / IR per string, AC isolator photo, inverter serial number, type-test certificate
            scan) is exactly what the G98 / G99 form needs. A messy commissioning record produces a
            messy notification — and a DNO audit later that finds the install does not match the
            notification can result in disconnection until the paperwork is rebuilt.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>One reading per RCD</strong> — single AC test at 1×IΔn. No five-times test, no
              half-rated test. Records the operating time in milliseconds.
            </li>
            <li>
              <strong>Same procedure across types</strong> — Type AC, Type A, Type F and Type B all
              verified by the same alternating current test. Type B sites still need DC residual
              current sensitivity verified per the manufacturer's stated method, but the BS 7671
              verification is the AC test.
            </li>
            <li>
              <strong>EV chargers</strong> — Reg 722.531.3.101 requires 30 mA RCD per connecting
              point with DC fault current protection in addition. Verify the 30 mA RCD with the AC
              test at 1×IΔn; verify the DC sensing per the manufacturer's stated method (often a
              built-in self-test in modern units).
            </li>
            <li>
              <strong>Older instruments</strong> — multi-function testers calibrated to the
              pre-A4:2026 method still produce valid readings; the 1×IΔn reading is the one that
              goes on the certificate. Some firmware updates re-label the test screens to match
              A4:2026 wording.
            </li>
            <li>
              <strong>Records</strong> — schedule of test results column for RCD operating time
              records the single 1×IΔn AC test value. Where the previous inspector's record shows
              multiple readings, note the change in test method in the EICR observations.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              fault detection devices (AFDDs) in Higher Risk Residential Buildings, Houses in
              Multiple Occupation, Purpose-built student accommodation and Care homes. For all other
              premises, the regulation recommends AFDDs for single-phase final circuits.
            </>
          }
          meaning={
            <>
              A4:2026 promoted Reg 421.1.7 from a recommendation to a requirement in four premises
              categories — HRRBs, HMOs, PBSA and care homes. Env tech additions in any of those
              categories (EV charger socket-outlets, garden-room PV supplies, heat-pump immersion
              socket-outlets where 32 A or below) need AFDD protection on top of RCD protection. For
              other premises Reg 421.1.7 still recommends rather than mandates, but the
              recommendation should be actively considered on every install — the cost differential
              between an RCBO and an AFDD-RCBO has narrowed and the safety case is well-evidenced.
            </>
          }
        ...
        >
          <p>The Section 712 / 514.10 signage scheme on a domestic PV install:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Consumer unit</strong> — durable label identifying the property has a parallel
              generator, listing the AC isolator location and the DC isolator location. Reg 514.10
              wording: 'Caution — this installation has more than one source of supply'.
            </li>
            <li>
              <strong>Meter position</strong> — same alternative-supply notice plus identification
              of the inverter make / model and the install date for the next meter operative.
            </li>
            <li>
              <strong>AC isolator at the inverter</strong> — labelled with the circuit
              identification at the consumer unit and the rating. The isolator must be accessible
              and within reach of the inverter.
            </li>
            <li>
              <strong>DC isolator</strong> — labelled with voltage rating, polarity warning and Reg
              514.10.1 'voltage exceeding 230 V to earth' notice where array Voc puts the DC string
              above 230 V to earth.
            </li>
            <li>
              <strong>Single-line schematic at the consumer unit</strong> — laminated copy showing
              array → DC isolator → inverter → AC isolator → meter → consumer unit. Carries the
              install date and the contractor reference for later traceability.
            </li>
            <li>
              <strong>Reg 514.13.1 'Safety Electrical Connection — Do Not Remove'</strong>— at the
              MET and at every bonding connection. PV install adds a bonding conductor to the array
              frame; the connection gets the standard safety label.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Why the on-site test is a sanity check rather than a full verification:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type-test covers fault response</strong> — ROCOF, vector shift, voltage and
              frequency thresholds, recovery delay. The laboratory uses programmable AC sources to
              inject the fault profiles; you cannot replicate this on site.
            </li>
            <li>
              <strong>Site test confirms the basic mechanism</strong> — the inverter actually
              monitors the AC terminals and disconnects when mains disappears. If it does not, the
              inverter is faulty or wired wrong, regardless of what the type-test certificate says.
            </li>
            <li>
              <strong>Recovery delay catches customers out</strong> — a brief grid blip makes the
              inverter shut down for the full recovery delay (one to three minutes is normal).
              Customers ring up convinced the inverter is broken. Brief them at handover so they
              recognise this as designed behaviour.
            </li>
            <li>
              <strong>Document the test</strong> — date, time, who carried out, how long the
              inverter took to disconnect, how long to recover. The record belongs in the install
              pack alongside the type-test certificate.
            </li>
            <li>
              <strong>Annual aftercare</strong> — repeat the sanity test at the annual MCS aftercare
              visit to confirm the inverter still detects loss of mains. A degraded LoM detector is
              a real failure mode that the site test catches before the type-test is re-run by the
              manufacturer.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Landlords of properties in the private rented sector in England are required to have
              the fixed electrical installation inspected and tested at intervals not exceeding five
              years by a qualified person, and to provide a copy of the report to the tenant and to
              the local authority on request. The report shall identify any unsatisfactory items and
              the remedial action required. Failure to comply is subject to civil penalty.
            </>
          }
          meaning={
            <>
              The 2020 Regulations made what was BS 7671 best practice into statutory duty for
              landlords. The EICR on a property with env tech additions covers the env tech as part
              of the whole fixed installation. As the L3 apprentice carrying out or assisting on
              landlord EICRs, recognise that the inspector is producing a statutory document for the
              landlord and that env tech findings are part of that report. Comparable regulations
              apply in Scotland (Housing (Scotland) Act 2006 with five-year EICR for most tenanted
              property; some categories on three-year cycle).
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice closes the DC isolator without running the IR test, trusting that the
              strings 'looked fine on visual'. Inverter energises, ground fault detector trips,
              inverter goes into fault state. Now the team has to find the insulation defect with
              the inverter offline and the strings still live (sunlight). Worst case the inverter
              input stage is damaged by a reverse-polarity string and the warranty is void because
              commissioning evidence shows no IR test was run.
            </>
          }
          doInstead={
            <>
              Run the full IEC 62446-1 / MCS MGD 003 sequence per string before closing the DC
              isolator: Voc, Isc, polarity, IR positive-to-earth, IR negative-to-earth. Record the
              per-string results on the commissioning sheet. The discipline takes 5-10 minutes per
              string and protects the inverter, the install warranty and the apprentice. Skip it
              once and the cost is always greater than the time saved.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              EICR on a PME-supplied property with a 32 A EV charger. The inspector tests the
              charger as a normal final circuit — Zs, RCD trip time, polarity — and signs off. But
              the inspector did not verify the open-PEN protection method (built-in detection,
              dedicated TT electrode for the EV, or external open-PEN device). If the charger is on
              PME with no open-PEN protection, a fault on the DNO neutral could rise the chassis and
              the EV body to full phase voltage — a serious shock risk to anyone touching the car.
            </>
          }
          doInstead={
            <>
              Verify the open-PEN protection method as a specific EICR check. Read the data sheet
              for the unit to confirm built-in detection, or inspect the install for a dedicated TT
              electrode for the EV side, or look for an external open-PEN device upstream. If none
              of the three is present and the supply is PME, code C2 with a recommendation to fit an
              open-PEN protection device under BS 7671 Section 722 (significantly amended in
              A4:2026).
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You are assisting on the five-year EICR of a domestic property. The property has a 4
              kWp PV array installed eight years ago under the old G83 framework, plus a 7 kW EV
              charger fitted last year. The customer cannot find the original PV commissioning pack.
              The EV charger is a Type B unit installed by an OZEV-approved firm and the customer
              has the install paperwork. The supply is PME.
            </>
          }
          whatToDo={
            <>
              For the PV: visual inspection of the consumer unit signage (note any missing — Section
              712 has tightened signage in A4:2026 but the 8-year-old install pre-dates A4:2026 so
              the older signage may be acceptable as 'fit for purpose at time of install'); check DC
              isolator accessibility and operation; visual of the array from a roof-safe vantage;
              test the AC final circuit (Zs, RCD, IR with inverter disconnected). Note the missing
              commissioning pack as an observation — the customer can request a copy from the
              original installer or their MCS umbrella scheme. For the EV charger: verify Type B RCD
              operating time; check open-PEN protection method per Section 722 (likely built-in for
              a modern unit, but verify from the data sheet); check local isolator within sight;
              test Zs and RCD trip time. Record everything on the EICR with appropriate codes and a
              recommendations section.
            </>
          }
          whyItMatters={
            <>
              A thorough EICR on a property with env tech is the inspector evidence that the whole
              fixed installation was assessed. Skipping the PV DC side or the EV open-PEN check
              leaves dangerous gaps — the next inspector inherits those gaps; the customer landlord
              may be in breach of the 2020 Regulations; the apprentice professional reputation rests
              on a thorough, documented inspection.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              has been clarified and reference is made to a 250 V DC test following the connection
              of equipment. The requirements for RCD testing have been changed and Table 3A
              (Time/current performance criteria for RCDs) in Appendix 3 has been deleted.
              Regardless of RCD Type, an alternating current test at rated residual operating
              current (IΔn) is used to verify the effectiveness.
            </>
          }
          meaning={
            <>
              Two important practical changes for environmental tech testing. First — when inverters
              or sensitive electronics are connected, drop the IR test voltage to 250 V DC to avoid
              damaging the kit. Second — the old multi-current sequence (½×IΔn, 1×IΔn, 1×IΔn) has
              been replaced by a single AC test at 1×IΔn, irrespective of RCD type. Older test
