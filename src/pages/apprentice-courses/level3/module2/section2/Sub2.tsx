...
const TITLE = 'BS 7671 Section 722 (EV) deeper (2.2) | Level 3 Module 2.2.2 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question: 'What is the scope statement of BS 7671 Section 722 in plain English?',
    options: [
  ...
  {
    id: 2,
    question: 'What is the difference between Type A and Type B RCDs in the EV charging context?',
    options: [
  ...
  {
    id: 7,
    question: 'On a TT-earthed property with no PNB / TN-C-S, does Section 722 still apply?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'What about plug-in EVSE units that connect to a 13 A socket — do those need PEN-fault protection too?',
    answer:
  ...
  {
    question:
      'Does the apprentice need to know the specific Section 722 regulation numbers by heart?',
    answer:
  ...
  {
    question:
      'How does Section 722 interact with Section 826 if a battery is added to the EV charging install?',
    answer:
  ...
  {
    question:
      'What does the OZEV Smart Charge Points Regulations 2021 require that BS 7671 Section 722 does not?',
    answer:
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 2 · Subsection 2"
        title="BS 7671 Section 722 (EV) — deeper dive"
        backTo="/study-centre/apprentice/level3-module2-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Section 722 is the EV charging regulation anchor. This subsection covers the PEN-fault
          detection methods on TN-C-S (PNB), the DC fault detection (RDC-DD) framework, the Type A
          vs Type B RCD decision, the A4:2026 refinements, and the IET Code of Practice for Electric
        ...
        >
          <p>The three acceptable methods at a glance:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Method 1 — built-in PEN-fault detection in the unit</strong>. Most modern UK
              domestic units (Zappi, Ohme, Hypervolt, Wallbox, GivEnergy, Easee) include this. The
              unit monitors voltage between the supply L and N during operation; any anomalous rise
              signals a PEN fault and the unit disconnects. Manufacturer's spec sheet confirms
              compliance with Section 722. Dominant approach in 2024-2026.
            </li>
            <li>
              <strong>Method 2 — dedicated TT earth electrode for the EV side</strong>. The EV
              charge point and any extraneous-conductive-parts within reach get a separate earth
              electrode driven into the ground at the install location, isolated from the property's
              main earthing terminal. Removes the PEN-fault risk by removing the connection to the
              PNB earth. Used where the unit does not include built-in detection or where the
              install configuration favours TT (e.g. detached garage, long cable run from the
              property).
            </li>
            <li>
              <strong>Method 3 — external PEN-fault detection device</strong>. A separate enclosure
              upstream of the unit provides the detection. Historical approach that pre-dates
              built-in detection; now uncommon on new installs because Method 1 is simpler and
              cheaper.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              "Where the supply to an electric vehicle charging point is taken from a TN-C-S (PNB)
              source, additional protective measures shall be provided to prevent the appearance of
              a hazardous voltage on the exposed-conductive-parts of the vehicle in the event of an
              open-circuit fault in the supply PEN conductor. Acceptable methods include
              detection-and-disconnection arrangements within the charging equipment, an earthing
              arrangement separate from the supply earthing (TT) for the charging point, or an
              upstream PEN-fault detection device."
            </>
          }
          meaning={
            <>
              Section 722 makes PEN-fault protection non-optional on TN-C-S (PNB) supplies and lists
              three acceptable approaches. A4:2026 has refined the technical detail of each method
              and updated the terminology (PNB alongside TN-C-S / PME). The IET Code of Practice for
              Electric Vehicle Charging Equipment Installation walks through the practical
              implementation. The MCS-certified / OZEV-authorised installer chooses the method per
              the install conditions; the apprentice executes the wiring and verifies the protection
              at commissioning.
            </>
          }
        ...
        >
          <p>The RCD decision tree:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Unit includes RDC-DD (6 mA DC detection)</strong> → Type A RCBO upstream is
              acceptable. Cost-effective. Dominant choice in 2024-2026.
            </li>
            <li>
              <strong>Unit does not include RDC-DD</strong> → Type B RCBO upstream is required.
              Around 5x cost of Type A. Rare on modern units but possible on older or imported
              equipment.
            </li>
            <li>
              <strong>Combined AFDD-RCBO devices</strong> → increasingly available. Simplify CU
              layout where AFDD is also required by the design.
            </li>
            <li>
              <strong>Always verify against unit data sheet</strong>. A substitution at install time
              can change the upstream RCD requirement.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Terminology summary:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>TN-C-S</strong> — the international terminology for an arrangement where the
              supply has a combined PEN conductor (TN-C) and the property has separate N and earth
              conductors (TN-S). UK terminology since the 17th Edition.
            </li>
            <li>
              <strong>PME (Protective Multiple Earthing)</strong> — the older UK terminology
              emphasising the multiple earthing of the PEN conductor along its run. Still in common
              use.
            </li>
            <li>
              <strong>PNB (Protective Neutral Bonded)</strong> — the A4:2026 terminology emphasising
              the protective bonding role of the combined PEN at the property. New term aligned with
              international standards.
            </li>
            <li>
              All three terms refer to the same physical earthing arrangement. Section 722's
              PEN-fault protection requirement applies to any of them.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Control-pilot states the unit is signalling at any moment:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>State A (12 V steady)</strong> — no vehicle plugged in. Unit is idle.
            </li>
            <li>
              <strong>State B (9 V square wave)</strong> — vehicle plugged in, ready but not
              charging. Unit confirms presence; vehicle has not requested charge.
            </li>
            <li>
              <strong>State C (6 V square wave)</strong> — vehicle plugged in and charging.
              Contactor closed; current flowing per the negotiated rate.
            </li>
            <li>
              <strong>State D (3 V square wave)</strong> — vehicle requesting charge with
              ventilation (rare on modern EVs; legacy vehicles only).
            </li>
            <li>
              <strong>State E / F (0 V or shorted)</strong> — fault. Contactor opens, unit reports
              error.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>AFDD considerations on the EV final circuit:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Combined AFDD-RCBO</strong> — single device handling RCD, MCB and AFDD
              functions. Simplifies CU layout and labelling. Typical UK manufacturers offer Type A
              versions suitable for EV.
            </li>
            <li>
              <strong>Cost premium</strong> — combined AFDD-RCBO is around 4-8x the cost of a plain
              Type A RCBO. Customer-facing quote should reflect.
            </li>
            <li>
              <strong>Self-test</strong> — AFDDs run a periodic internal self-test and signal fault
              state visually. Annual visual inspection includes confirming the indicator state.
            </li>
            <li>
              <strong>Customer brief on nuisance trips</strong> — early-generation AFDDs were prone
              to nuisance trips on certain loads; modern devices have largely resolved this but the
              customer should be briefed that an AFDD trip on the EV circuit is not necessarily a
              fault on the EV side.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The five OZEV requirements at a glance:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Smart functionality</strong> — capable of being scheduled, monitored and
              remotely controlled.
            </li>
            <li>
              <strong>Default off-peak charging</strong> — pre-configured windows avoiding peak
              demand. Customer can override but the default is off-peak.
            </li>
            <li>
              <strong>Randomised delay</strong> — up to 600 seconds at start of a charge session to
              avoid millions of chargers turning on at the same moment.
            </li>
            <li>
              <strong>Cybersecurity baseline</strong> — protections against remote attack; aligned
              with ETSI EN 303 645 consumer IoT baseline.
            </li>
            <li>
              <strong>Safety provision</strong> — disconnects under defined fault conditions; logs
              events.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>When supplementary bonding is typically considered:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Car port or other metallic supporting structure</strong> — bond the structure
              if it is an extraneous-conductive-part within reach of the EV.
            </li>
            <li>
              <strong>External metallic services close to the unit</strong> — typically covered by
              main bonding at the property MET; supplementary bonding only where local geometry
              creates a touch-voltage concern.
            </li>
            <li>
              <strong>TT installations with marginal earth electrode resistance</strong>—
              supplementary bonding can support compliance with disconnection-time requirements
              where the electrode is at the upper limit of acceptable.
            </li>
            <li>
              <strong>Verify main bonding first</strong> — Section 722 supplementary bonding only
              makes sense if the property&apos;s main bonding to gas and water is in place and
              adequate (10 mm minimum for typical UK domestic).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The commissioning sequence in order:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Standard BS 7671 dead tests</strong> — continuity, insulation resistance,
              polarity (per Part 6).
            </li>
            <li>
              <strong>Standard BS 7671 live tests</strong> — Zs, RCD operation (functional and
              times), prospective fault current.
            </li>
            <li>
              <strong>PEN-fault detection verification</strong> — per the unit&apos;s commissioning
              sequence; usually a self-test function on the unit menu. Observe pass; do not put the
              unit in service if it fails.
            </li>
            <li>
              <strong>RDC-DD operation verification</strong> — typically a built-in self-test on the
              unit; some units allow an external 6 mA DC injection test.
            </li>
            <li>
              <strong>Load management verification</strong> — start an EV charge at full rate;
              deliberately switch on a known concurrent load (electric shower); observe the charger
              throttle within seconds. If it does not throttle, the CT clamp orientation or the
              load-management settings need review.
            </li>
            <li>
              <strong>OZEV smart-charge schedule confirmation</strong> — confirm default off-peak
              schedule is configured; brief the customer on the randomised delay behaviour.
            </li>
            <li>
              <strong>Labelling installation</strong> — supply origin, isolation point, earthing
              arrangement, emergency stop, OZEV smart-charge indication.
            </li>
            <li>
              <strong>Customer handover</strong> — local isolator location, load-management
              behaviour, smart-charge schedule, app credentials, warranty contact.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Designer specified Brand X with built-in RDC-DD and a Type A RCBO upstream. Stock
              issue means Brand Y is fitted instead. Brand Y does not include an RDC-DD. The Type A
              RCBO upstream is no longer compliant with Section 722 and the unit cannot reliably
              detect smooth DC fault current. Compliance gap that is not visible until a fault
              occurs and the RCD does not trip in time.
            </>
          }
          doInstead={
            <>
              Read the unit's data sheet before fitting. Confirm RDC-DD presence; confirm PEN-fault
              detection method; confirm OZEV-Regulations compliance; confirm Section 722 compliance.
              If the substituted unit changes any of the upstream requirements, raise it with the
              designer before proceeding. Do not 'just fit it' on the assumption that one Mode 3
              charge point is interchangeable with another.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice fits the upstream RCBO at the consumer unit and runs the cable straight to
              the unit terminals — no local isolator. The next electrician arriving to service the
              unit has to trek back to the consumer unit to isolate; under emergency response, no
              obvious local means of disconnection. Section 537 isolation requirements not met;
              Section 722 EV-specific isolation requirements not met. The customer is paying for a
              non-compliant install they may not realise until the next inspection or the next
              service visit.
            </>
          }
          doInstead={
            <>
              Always fit a local means of isolation within sight of the unit — typically a rotary or
              padlockable isolator on the supply cable adjacent to the charge point. The IET Code of
              Practice for Electric Vehicle Charging Equipment Installation specifies the type and
              the location. The cost is small; the operational and regulatory value is large.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You are the apprentice on a Mode 3 EV install at a TN-C-S (PNB) detached property. The
              MCS-certified electrician has specified a Zappi v2.1 unit with built-in PEN-fault
              detection (Method 1) and built-in RDC-DD. Upstream device is a new Type A RCBO in the
              consumer unit. Local isolator is a 32 A rotary on the supply cable adjacent to the
              unit. CT clamp on the supply tail enables dynamic load management against the 80 A
              main fuse. Cable is 10 m of 6 mm T+E from the consumer unit to the garage where the
              unit will mount. The install is on a 2026-onwards date so A4:2026 applies.
            </>
          }
          whatToDo={
            <>
              Pull the cable, terminate at the consumer unit on the new Type A RCBO, terminate at
              the local isolator and at the unit terminals per the manufacturer's wiring diagram.
              Fit the CT clamp around the supply tail in the orientation the manual specifies.
              Configure the unit for the supply earthing arrangement (PNB). Run the unit's
              commissioning self-test for PEN-fault detection — observe the test pass; if it does
              not pass, do not put the unit in service. Verify load management with a deliberate
              concurrent load. Install the labelling per Section 514 / 722 / IET CoP — supply
              origin, isolation point, earthing arrangement, emergency isolation instructions. Hand
              over to the customer with a five-minute brief on the local isolator location, the
              load-management behaviour and the OZEV smart-charging schedule.
            </>
          }
          whyItMatters={
            <>
              This is the typical 2026 EV apprentice job — modern unit with built-in PEN-fault and
              RDC-DD, Type A RCBO upstream, dynamic load management, OZEV-compliant smart features.
              Recognising the regulation map (Section 722, IET CoP, OZEV, MCS / OZEV-authorised) and
              executing the wiring per the design is the apprentice's contribution. The
              MCS-certified electrician signs off; the apprentice keeps the install compliant in the
              detail.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          clause={
            <>
              Section 722 applies to electric vehicle charging installations. It modifies general
              requirements for protection against electric shock and includes specific requirements
              with regard to PME systems, socket-outlets and connectors, external influences,
              isolation and switching and RCD protection. The requirements of Section 722 do not
              apply to wireless charging, such as inductive charging.
            </>
          }
          meaning={
            <>
              Section 722 is the regulatory home for every wired EV install. Wireless charging falls
              outside the section and follows its own product standards instead. A4:2026 brought
              significant changes to PME / TN-C-S handling and the RCD selection rules in particular
              — pre-A4 advice on EV installs should be checked against current text.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              exception concerning reasonably practicable has been deleted. Changes have also been
              made to requirements for external influences, RCDs, socket-outlets and connectors.
            </>
          }
          meaning={
            <>
              The old &quot;not reasonably practicable&quot; let-out for fitting open-PEN protection
              on TN-C-S EV installs is gone. You either use a charger with built-in PEN-fault
              detection (the dominant route on UK domestic), or fit a TT earth electrode for the EV
              side, or install a separate PEN-fault detection device upstream. There is no longer a
              documentation-only escape.
            </>
          }
