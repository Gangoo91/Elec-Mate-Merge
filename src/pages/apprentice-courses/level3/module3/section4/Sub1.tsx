...
const TITLE = 'Magnetic circuits and properties | Level 3 Module 3.4.1 (AC 1.2) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  {
    id: 'l3-m3-4-1-mmf',
    question: 'A coil of 500 turns carries 2 A. The magnetomotive force (mmf) is:',
    options: ['500 At', '1000 At', '5000 At', '250 At'],
    correctIndex: 1,
    explanation: 'mmf = N × I = 500 × 2 = 1000 ampere-turns (At).',
  },
  {
    id: 'l3-m3-4-1-mu',
    question: 'The relative permeability μ_r of a typical transformer steel core is approximately:',
    options: ['1', '5000', '100', '5 000 000'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'mmf (in ampere-turns) drives flux around a magnetic circuit, just as EMF drives current around an electric circuit.',
  },
  {
    id: 4,
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Φ, B, H, μ. Saturation, hysteresis, eddy currents. The magnetic-circuit analogy that lets
          you design or fault-find a transformer.
        </p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Flux density B</strong> (tesla, T = Wb/m²) — flux per area. Drives the EMF in
              transformers.
            </li>
            <li>
            ...
            <li>
              <strong>Magnetising force H</strong> (At/m) = mmf / mean path length — the "stress"
              applied to the magnetic material.
            </li>
            <li>
              <strong>Permeability μ</strong> (H/m or relative μ_r) — how easily a material conducts
              flux. μ = B / H.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Magnetic Ohm's Law:</p>
          <p>
            <strong>Φ = mmf / R_m</strong>, where R_m = L / (μ × A).
          </p>
          <p>
            For a toroidal core with mean path length L = 0.5 m, area A = 4 cm² = 4 × 10⁻⁴ m², μ_r =
            4000 (so μ = 4000 × 4π × 10⁻⁷ = 5.03 × 10⁻³ H/m), driven by N = 1000 turns at I = 0.5 A:
            <br />
            mmf = 1000 × 0.5 = 500 At.
            <br />
            ...
            <br />B = Φ / A = 2 × 10⁻³ / 4 × 10⁻⁴ = 5 T → SATURATED. Designer would either reduce I,
        ...
        >
          ...
          <p>
            Designers operate at 1.4-1.6 T peak in transformer cores — below saturation, with margin
            for over-voltage events.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            1.6-2). Doubling frequency doubles hysteresis loss; doubling peak flux quadruples it.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock
          ...
          plainEnglish={
            "The alternating flux induces voltage in the core iron itself. That voltage drives circulating ('eddy') currents in the iron, dissipating energy as heat."
          }
        >
          <p>
            Suppression: laminate the core into thin (~0.3 mm) sheets, electrically insulated by an
            oxide layer. Each lamination has very high cross-sectional resistance to circulating
            currents but still conducts flux normally.
          </p>
          <p>
            <strong>Eddy loss P_e ∝ f² × B_max² × t²</strong>, where t is lamination thickness.
            Hence the obsession with thin laminations — halve the thickness, eddy loss drops by a
            factor of 4.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Iron and copper losses dissipate as heat in the transformer core and windings. Reg
              421.11 places the duty on you to size the cooling, the enclosure and the clearance to
              ensure no harmful temperature rise reaches surrounding fabric. A drystone-mounted
              dry-type transformer in a hot riser, or a sealed cabinet with no ventilation, breaches
              this regulation regardless of how clean the design calc looks on paper.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Hysteresis and eddy losses run a transformer core hot — typical insulation class F is
              155 °C maximum, class H 180 °C. The enclosure, glands and adjacent terminal blocks
              must all sit comfortably below their own temperature limits at full rated load. The
              product-standard cited on the nameplate (BS EN 60076 series for most LV transformers)
              is the link between Reg 421.1.6 and the actual material ratings used.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A 230 V/24 V transformer is connected to a 400 V supply 'just to test'. Core saturates
              instantly at the wrong flux density; magnetising current jumps from 100 mA to multiple
              amps; primary winding overheats and burns out within seconds.
            </>
          }
          doInstead={
            <>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              silicon steel (μ_r ~10 000, sat 1.9 T) or amorphous metal alloy (μ_r ~30 000, sat 1.5
              T). Customer wants premium efficiency.
            </>
          }
          whatToDo={
            <>
              Amorphous alloy gives the lowest no-load loss (~25 % of standard) because of much
              narrower hysteresis loop. Trade-off: lower saturation point, slightly larger core,
              higher cost. For a unit running 24/7 with light load (typical control panel),
              amorphous pays back in energy saving over its life.
              <br />
              Specification: amorphous-core, 100 % copper windings, IP55 enclosure, EN 50588-1 Tier
              2 compliant.
            </>
          }
          whyItMatters={
            <>
              Core material is invisible to the user but defines the no-load loss — which is ALWAYS
              there, even when the load is zero. Choosing the right material can save hundreds of
              kWh per year on a continuously energised transformer.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Quiet 100 Hz hum</strong> → healthy, normal operation.
            </li>
            <li>
              <strong>Loud 100 Hz hum</strong> → loose laminations or undersized core for load.
            </li>
            <li>
              <strong>50 Hz buzz</strong> → DC offset, asymmetric saturation, possibly a half-wave
              rectifier load.
            </li>
            <li>
              <strong>Crackling/popping</strong> → partial discharge in oil or insulation breakdown
              — take out of service.
            </li>
            <li>
              <strong>Sudden silence</strong> → primary supply lost; check upstream protection.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            Halve f and you double Φ_max → instant saturation. This is the same reason traction
            transformers (16.7 Hz on continental rail) are huge compared to a 50 Hz transformer of
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              R_m_gap = L_gap / (μ_0 × A) — air permeability is 1, so even a 1 mm gap dwarfs a 500
              mm iron path with μ_r = 5000.
            </li>
          ...
          <p>That is why bigger inductors have bigger gaps — more energy storage capacity.</p>
        </ConceptBlock>
