...
const TITLE = 'Transformer ratios — worked examples | Level 3 Module 3.4.3 (AC 1.3) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: ['6350:230.9', '11000:400', '47.6:1', 'all of these (different reference points)'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1.2 A', '5 A', '3 A', '120 A'],
    correctIndex: 2,
    explanation: 'CT ratio is 1000:5 = 200:1. Secondary = primary / 200 = 600 / 200 = 3 A.',
  },
  {
    id: 'l3-m3-4-3-eff-current',
    question: 'A 25 kVA, 230/400 V single-phase transformer (step-up). Rated primary current is:',
    options: ['108.7 A', '500 A', '62.5 A', '5750 A'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  {
    id: 1,
    question:
      'For an 11 kV / 230 V step-down distribution transformer, the turns ratio is approximately:',
  ...
  },
  {
    ...
    options: ['400 A', '100 A', '250 A', '144 A'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 3,
    question: 'A 100 kVA 3-phase 400 V star secondary. Line current is:',
    options: ['250 A', '100 A', '433 A', '144 A'],
    correctAnswer: 3,
    explanation: 'I_line = S / (√3 × V_L) = 100 000 / (1.732 × 400) = 144.3 A.',
  },
  {
    id: 4,
    question: 'Voltage transformer (VT) ratio 11 000 / 110 V. With primary 9 kV, secondary reads:',
  ...
  {
    id: 5,
    question: 'Why are CT secondaries always rated 1 A or 5 A?',
    options: [
  ...
  {
    id: 6,
    question: 'NEVER open a CT secondary with primary energised because:',
    options: [
  ...
  {
    id: 7,
    question: 'A 200 kVA 3-phase transformer 11 kV / 400 V (Dyn11). Rated primary line current:',
    options: ['288.7 A', '17.5 A', '60 A', '10.5 A'],
    correctAnswer: 3,
    explanation: 'I_primary line = S / (√3 × V_L1) = 200 000 / (1.732 × 11 000) = 10.5 A.',
  },
  {
    id: 8,
    question: 'Same 200 kVA transformer. Rated secondary line current:',
    options: ['288.7 A', '500 A', '10.5 A', '866 A'],
    correctAnswer: 0,
...
const faqs = [
  {
    question:
      'Why is the per-winding ratio different from the line-line ratio in delta-star transformers?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Pure ratio practice. Single-phase, 3-phase delta/star, instrument transformers, current
          transformers.
        </p>
        ...
        >
          ...
          <p>
            A 5 kVA single-phase transformer is to be wound with 230 V primary and 24 V secondary.
            Primary has 1000 turns. Secondary turns?
            <br />
        ...
        >
          ...
          <p>
            Accuracy classes (BS EN 61869-2): Class 0.2 for revenue metering; Class 1 for standard
            metering; Class 5P for protection relays (allowed wider error at fault currents).
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            <br />
            On metering and protection panels, you'll see two CT lugs and three VT cores feeding a
            multifunction meter that calculates V, A, kW, kVA, kVAr, pf, kWh.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              switchboard. The induced voltage can hit several kV, destroying the CT, melting the
              test leads and killing the operator. Always short the secondary first.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              neutral is never single-pole interrupted. Reg 132.14.1 is why three-phase MCBs are
              inherently triple-pole, and why neutral disconnection must be linked. CT metering and
              protection circuits sit on top of this rule — protection always acts on the line
              conductors.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Three-phase isolation must break all live conductors together. A single-pole switch in
              the neutral leg can leave the load energised through a fault current path — extremely
              dangerous. Linked switching (4-pole isolators on TN-C-S, mandatory on TT) is the
              regulation answer. Star-connected loads with a faulty neutral develop large voltage
              imbalance — same physics, same regulation lock-down.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice on a Dyn11 transformer install reads "11 kV / 400 V" and assumes a turns
              ratio of 27.5:1. Calculates expected magnetising current with that ratio. Result is
              1.73× off, every secondary calc downstream is wrong.
            </>
          }
          doInstead={
            <>
              On a Dy or Yd transformer, the per-winding ratio is what is actually wound. Either use
              line voltages with the line-ratio formula AND remember the configuration, or resolve
              to phase voltages first then apply the simple per-winding turns ratio. Pick one
        ...
        <Scenario
          ...
          situation={
            <>
              Designer specifies a 3-phase 630 A switchboard. You need to fit CTs for the ammeter
              and the multifunction meter (5 A secondary). What ratio CTs do you order, and why not
              exact match?
            </>
          }
          whatToDo={
            <>
              Pick the next standard ratio above the rated current. 800/5 is the natural choice for
              a 630 A switchboard. Reasons:
              <br />
              — Primary will run at ~80 % of CT rating (630/800), comfortably in the meter accuracy
              band.
              <br />
              — Surge or fault current up to 800 A still gives a valid 5 A secondary; above that the
              CT saturates (predictably).
              <br />— Standard ratio means you can swap the meter or relay without re-sourcing the
              CT.
            </>
          }
          whyItMatters={
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Within 0.5 %</strong> → healthy, ready for service.
            </li>
            <li>
              <strong>0.5-2 % off</strong> → check tap changer position; verify against plate.
            </li>
            <li>
              <strong>Wildly off (5%+)</strong> → likely shorted turns; transformer needs winding
              repair.
            </li>
            <li>
              <strong>Phase shift wrong</strong> → wrong vector group OR misconnected. Re-check
              terminal markings.
            </li>
            <li>
              <strong>Polarity reversed</strong> → swap a winding, then re-test.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              For 5 A secondary, 2.5 mm² cable, 30 m loop: R ≈ 0.43 Ω. Burden = 25 × 0.43 = 10.7 VA
              — significant on a 15 VA CT.
            </li>
            <li>
              Use 1 A CTs instead of 5 A on long runs — burden is 25× lower for the same cable
              resistance.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Voltage regulation at full load, pf 0.85: ≈ 4.5 × (cos φ × R/Z + sin φ × X/Z) ≈ 3.5 %
              drop.
            </li>
            <li>
              So 433 V no-load → ~418 V at full load. Tap +1 (-2.5 %) brings it back to ~428 V.
            </li>
          </ul>
        </ConceptBlock>
