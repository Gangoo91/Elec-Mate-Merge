...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Replace the main contacts when worn',
      'Control voltage',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Exactly nominal voltage', '85-110 % of nominal', '50-150 % of nominal', 'No tolerance'],
    correctAnswer: 1,
    explanation:
