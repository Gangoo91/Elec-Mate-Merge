...
const TITLE =
  'Protective devices — fuses, MCBs, RCDs, RCBOs | Level 3 Module 3.6.2 (AC 4.1) | Elec-Mate';
const DESCRIPTION =
      ...
      <HubBody>
        ...
        >
          ...
          <p>
            ...
            on a sustained overload. They must be paired with a thermal overload relay (Sub 6.1) for
