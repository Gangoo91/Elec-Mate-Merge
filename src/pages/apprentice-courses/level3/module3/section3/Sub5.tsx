...
const checks = [
  {
    ...
    question:
      'Three balanced single-phase loads (each 30 A, pf 1.0) on a 3-phase + N supply. Neutral current is:',
    options: ['0 A', '10 A', '52 A', '30 A'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    question: 'L1 = 30 A, L2 = 0 A, L3 = 0 A (single-phase load on L1 only). Neutral current is:',
    options: ['10 A', '0 A', '30 A', '52 A'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['I × 3', 'Zero', 'I × √3', 'I'],
    correctAnswer: 1,
    explanation:
      "Vector sum of three equal magnitudes 120° apart = zero. That's why balanced loads need no neutral.",
  },
  {
    id: 2,
  ...
  {
    id: 7,
    question: 'Why is balancing 3-phase loads important?',
    options: [
  ...
  {
    id: 8,
    question: 'On a heavily LED-loaded retail install, BS 7671 §523 may require:',
    options: [
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/level3-module3-section3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Why a balanced 3-phase load needs no neutral — and why a balanced LED-heavy install does.
          Triplen harmonics that add instead of cancelling.
        </p>
        ...
        >
          <p>
            The neutral conductor on a 4-wire star supply only carries the IMBALANCE between phases.
            Balanced load = no neutral current. Maximum imbalance (one phase fully loaded, others
            empty) = neutral current equals the loaded phase current.
          </p>
          <p>
          ...
          <p>This simplifies to 0 when all three are equal.</p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            concern over neutral current in modern installs full of single-phase non-linear loads.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              neutral CSA effectively becomes the limiting factor for cable sizing — sometimes you
              size up by one CSA from the line.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              "balanced" three-phase load made up of single-phase LED drivers can drive neutral RMS
              currents 1.5–1.7× the line currents. The Appendix 4 column gives you the
              fundamental-only capacity; on harmonic-rich installs apply Appendix 4 §C factors
              before comparing against the protective device rating.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Harmonic-rich power cables radiate magnetic fields at multiples of 50 Hz that couple
              straight into nearby data cabling. Reg 444.4.1 mandates a true 3-D separation — same
              tray, parallel runs and adjacent risers all count. On three-phase plant feeders
              carrying VFD output you may need 200 mm separation or full screened containment to
              keep BMS, fire-alarm and Ethernet quiet.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              replaced with 200 LED panels, each at ~30 % 3rd harmonic. Line currents balanced at 22
              A. Neutral now carries 3 × (22 × 0.3) ≈ 20 A of triplens AND any imbalance. Smell of
              burning insulation in the riser six months later.
            </>
          }
          doInstead={
            <>
              For LED-heavy installs, derate the cable per Appendix 4 grouping factor for harmonic
              loading or upsize the neutral. Common practice: 6 mm² lines, 10 mm² neutral; or use a
              5-core cable with the spare core paralleled with the neutral. Better: install at
              install — much harder to retrofit later.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              roughly evenly across L1 (17), L2 (16), L3 (17). Server PSUs draw 35 % third harmonic.
              What is the neutral current and how should the supply cable be sized?
            </>
          }
          whatToDo={
            <>
              ...
              <br />
              Cable: line conductor sized for 544 A. Neutral sized for 572 A — practically the same
              CSA (one standard size up). Most data centre busbar runs use 200 % neutral as a safety
              margin.
            </>
          }
          whyItMatters={
            <>
              On harmonic-rich loads the neutral CAN carry more than each line. A "balanced" install
              at the fundamental can still have a hot neutral. Sizing rules in BS 7671 §523 exist
              precisely because of this — and ignoring them ends in fires.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Neutral clamp on healthy install should read ~13 A. If it reads 25+ A, suspect
              harmonic content or pf variation.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>THD &lt; 5 %</strong> → no special action; standard cable sizing.
            </li>
            <li>
              <strong>THD 5-15 %</strong> → flag in test sheet; recommend PQ logger if cable runs
              hot.
            </li>
            <li>
              <strong>THD 15-33 %</strong> → BS 7671 §523.6.3 derate triggers; specify neutral ≥
              line.
            </li>
            <li>
              <strong>THD &gt; 33 %</strong> → neutral becomes limiting factor; consider 200 %
              neutral, derate cable, or fit harmonic filter.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>How to find a lost neutral systematically:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Switch off main isolator. Identify any obvious damage at the cut-out, MET or main
              switch.
            </li>
            <li>
              Test continuity from neutral bar at DB back to MET, MET to cut-out N. Identify break.
            </li>
            <li>
              If continuity is good back to cut-out, suspect DNO PEN fault (PME systems are most
              exposed) — call DNO emergency.
            </li>
            <li>
              NEVER restore supply until neutral is proven solid end-to-end. Half-fixed neutral
              kills loads twice.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Single-phase load distribution example — 36 final circuits across 3 phases:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>K=1</strong> — purely linear loads (motors, heaters, incandescent).
            </li>
            <li>
              <strong>K=4</strong> — mixed commercial: some LED, some IT, mostly conventional.
              Standard for new offices.
            </li>
            <li>
              <strong>K=13</strong> — heavy IT load, high LED density, server room. Standard for
              data centres.
            </li>
            <li>
              <strong>K=20 / K=30</strong> — pure data centre, hospital, broadcast facility.
            </li>
          </ul>
          <p>
            K-rated transformers cost ~15-30 % more than standard but avoid the 30-50 % derating you
            would have to apply to a standard transformer. Net cost is similar; reliability is much
            better.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Final circuit isolators on TT: minimum 2-pole (line + neutral) on single-phase
              circuits.
            </li>
            <li>
              Always prove dead L-N, L-PE AND N-PE on TT before working — neutral may surprise you.
            </li>
          </ul>
        </ConceptBlock>
