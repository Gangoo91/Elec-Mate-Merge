...
const TITLE = 'Single-phase vs three-phase supplies | Level 3 Module 3.3.1 | Elec-Mate';
const DESCRIPTION =
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              (LED, VFD) the neutral may need to be UPSIZED — Sub 3.6 covers this. Always think
