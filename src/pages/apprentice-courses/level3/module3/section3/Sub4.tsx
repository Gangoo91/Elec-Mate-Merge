...
const TITLE = 'Power factor correction | Level 3 Module 3.3.4 (AC 2.5, 2.6) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  {
    id: 'l3-m3-3-4-cap',
    question: 'What capacitance (μF) at 230 V single-phase 50 Hz gives 1 kVAr reactive?',
    options: ['25 μF', '240 μF', '120 μF', '60 μF'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['12/20 = 0.6× of original', 'Half', 'No change', '20/12 = 1.67×'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Q_C = P × (tan φ1 − tan φ2). Sizing capacitor banks, static vs automatic, detuned reactors
        ...
        >
          <p>The benefits of correction:</p>
        ...
        >
          ...
          <p>
            The factory needs a 168 kVAr capacitor bank. (Specify next standard size up — 175 or 200
            kVAr — and detuning to suit harmonic content.)
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Static (single fixed cap)</strong> — installed at the motor terminals. Best
              for big motors that run continuously at constant load. Switched on/off with the motor.
            </li>
            <li>
              <strong>Switched (manual stages)</strong> — a few capacitor banks switched in manually
              as load grows. Old-fashioned; rarely installed new.
            </li>
            <li>
              <strong>Automatic PFC bank</strong> — controller measures pf, switches in/out a
              stepped sequence of capacitors via contactors or thyristors. Tracks variable loads.
              Standard for mixed industrial sites.
            </li>
            <li>
              <strong>Detuned PFC bank</strong> — automatic bank with a series reactor (typically 7
              % or 14 % detuning) to lower the resonant frequency below dominant harmonics (5th,
              7th). Required where harmonic content &gt; 5 % THD.
            </li>
            <li>
              <strong>Active Harmonic Filter (AHF)</strong> — power-electronic device that injects
              opposite-phase harmonic currents in real time. Cancels harmonics back to the
              fundamental. Used on high-VFD-content sites where passive isn't enough.
            </li>
            <li>
              <strong>Static VAr Generator (SVG)</strong> — modern alternative to AHF/PFC, provides
              smooth fast leading or lagging kVAr without capacitor steps. Premium solution for
              sensitive loads.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Modern UK installs with LED lighting, VFDs, EV chargers and PV inverters routinely
              have THD &gt; 5 %. A bare PFC bank can resonate at 5th harmonic (250 Hz) and amplify
              it 10-fold, blowing capacitors. Detuning is now the default for new PFC banks.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Mutual inductance between adjacent cables transfers harmonic noise from a power feeder
              onto a data cable in the same tray. Reg 444.4.1 fixes physical separation in all three
              dimensions; where you must cross, do it at 90° to drop the coupling coefficient toward
              zero. This is the regulation that comes from the very same Faraday/coupled-circuit
              physics you've worked through in this Sub.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              screening, single-point screen earthing where appropriate, and segregated containment.
              The cable separation table (e.g. 50 mm at &lt; 35 m, 200 mm at &lt; 100 m) gives you
              defensible numbers.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Designer specifies a single 100 kVAr capacitor bank for a factory that draws 100 kW
              peak but averages 30 kW. At 30 kW load with the static bank still connected, pf goes
              leading → 0.7 leading. Voltage rises 5 V on the busbar. Capacitor over-currents trip.
              DNO not happy.
            </>
          }
          doInstead={
            <>
              ...
              machine, automatic banks are now standard practice because they handle other loads on
              the same supply gracefully.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              lighting and ancillaries 5 kW (pf 0.95). DNO has flagged poor pf and is threatening a
              kVA charge. Customer wants to bring pf to 0.95 lagging.
            </>
          }
          whatToDo={
            <>
              ...
              <br />
              Specify a 15 kVAr automatic bank, three stages of 5 kVAr each, detuned at 7 % (in case
              LED retrofit or VFDs added later).
            </>
          }
          whyItMatters={
            <>
              The arithmetic is exactly the formula in this Sub. Sum P, sum Q (separately for each
              load), find current pf, calculate Q_C from the difference. Five minutes with a
              calculator, then write the spec.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Peak P</strong> → drives Q_C calculation.
            </li>
            <li>
              <strong>Worst pf</strong> → drives target improvement.
            </li>
            <li>
              <strong>Load variability (max P / min P)</strong> → static vs automatic choice. &gt;
              2× ratio = automatic.
            </li>
            <li>
              <strong>THD I &gt; 5 %</strong> → mandatory detuning. THD I &gt; 15 % → consider AHF.
            </li>
            <li>
              <strong>5th and 7th harmonic %</strong> → drives detuning frequency choice (7 % or 14
              %).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            that tank resonates near a load harmonic, the harmonic current can be amplified 5-10×.
            Capacitors blow, fuses pop, contactors weld. Detuning forces resonance to a frequency
            where there is no harmonic to amplify.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              NEVER over-correct — leading pf at light load can cause self-excitation if the motor
              is disconnected from supply with cap still attached. Cap must switch with the motor.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            Quick cost-benefit table for typical industrial sites (UK 2026 prices, illustrative):
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            Above 100 kW with poor pf, PFC almost always pays back inside 3 years. Below 30 kW it
            rarely makes economic sense unless the kVAr penalty is already biting.
          </p>
        </ConceptBlock>
