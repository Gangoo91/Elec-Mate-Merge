...
const checks = [
  {
    id: 'l3-m3-3-3-pythag',
    question: 'P = 8 kW, Q = 6 kVAr. Apparent power S =',
    options: ['14 kVA', '10 kVA', '48 kVA', '7 kVA'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['0.8', '1.25', '0.75', '0.6'],
    correctIndex: 0,
    explanation: 'pf = cos φ = P / S = 8 / 10 = 0.8. Equivalently sin φ = Q/S = 0.6 → φ = 36.87°.',
  },
  {
    id: 'l3-m3-3-3-q',
    question: 'A motor draws S = 15 kVA at pf 0.7. Reactive power Q is approximately:',
    options: ['22 kVAr', '10.5 kVAr', '15 kVAr', '7.5 kVAr'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Real power = watts (W) or kW. The energy actually consumed and turned into heat, motion or light.',
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'Reactive power = volt-amperes reactive (VAr) or kVAr. Sloshes in/out of inductors and capacitors.',
  },
  {
    id: 3,
    ...
    correctAnswer: 3,
    explanation:
      'Apparent = volt-amperes (VA) or kVA. The product V × I (or √3 × V_L × I_L) regardless of phase angle.',
  },
  {
    id: 4,
    question: 'Power factor cos φ equals:',
    options: ['P / S', 'P / Q', 'Q / S', 'S / P'],
    correctAnswer: 0,
  ...
  {
    id: 7,
    question: 'A factory has P = 200 kW, pf 0.7 lagging. Apparent power S =',
    options: ['140 kVA', '200 kVA', '400 kVA', '286 kVA'],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ['204 kVAr', '200 kVAr', '100 kVAr', '141 kVAr'],
    correctAnswer: 0,
    explanation: 'Q = √(S² − P²) = √(286² − 200²) = √(81 796 − 40 000) = √41 796 = 204.4 kVAr.',
  },
];
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Three flavours of power, one right-angled triangle. Pythagoras and cosine to find anything
          from anything.
        </p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Real (P, W or kW)</strong> — energy actually transferred to do work (heat,
              motion, light). The kWh meter charges for this.
            </li>
            <li>
              ...
              energy = 0 over a full cycle, but the current that supports it is real and heats the
              cables.
            </li>
            <li>
              <strong>Apparent (S, VA or kVA)</strong> — the product V × I (or √3 × V_L × I_L for
              3-phase). What the cable, transformer and protective device see. Always the hypotenuse
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>S² = P² + Q²</strong> (Pythagoras)
            </li>
            <li>
              <strong>cos φ = P / S</strong> (power factor)
            </li>
            <li>
              <strong>sin φ = Q / S</strong>
            </li>
            <li>
              <strong>tan φ = Q / P</strong>
            </li>
          </ul>
          <p>
            ...
            <br />
            φ = cos⁻¹(0.8) = 36.87°.
            <br />Q = S × sin φ = 30 × 0.6 = 18 kVAr (or √(30² − 24²) = √324 = 18 kVAr).
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Convention: Q is positive for inductive loads, negative for capacitive. Power factor is
            normally quoted as a number with "lagging" or "leading" attached. A bare number defaults
            to lagging on industrial documentation.
          </p>
          <p>
            Same triangle, just flipped: leading pf has Q drawn DOWNWARDS (negative). The cosine is
            the same number; you just remember which way the current is offset.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              correction or face a kVAr or kVA charge. PFC banks pay for themselves in 18-36 months
              on a typical industrial install.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reactive current adds to apparent power without delivering useful work, but it still
              drops voltage along the cable. A motor at 0.7 pf lagging draws 1/0.7 the line current
              of the same kW at unity, so V<sub>drop</sub> rises proportionally. Reg 525.1 forces
              you to size the cable on apparent (kVA) current, not real (kW) current — apparent is
              what the conductor actually carries.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              kW vs kVA confusion bites at the motor protection step. The thermal overload relay
              setting must be matched to the FLC at the motor's rated voltage and pf — not to the
              input kVA at the supply transformer. Set the overload to nameplate FLC × service
              factor (typically 1.0–1.15). Wrong setting lets the motor cook on a stalled rotor or
              trips repeatedly on legitimate starts.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              sizes a 1000 kW load. Real power capacity is only 1000 × pf — at pf 0.85, that is 850
              kW. Customer trips the transformer overload at 90 % load.
            </>
          }
          doInstead={
            <>
              Read the unit. Transformers are rated in kVA (apparent power) because that is what
              limits the cable, the windings and the cooling. Real power capacity depends on the
              customer load mix. Do not size loads up to the kVA rating without accounting for pf.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Server room load: 12 kW IT (pf 0.95), 4 kW air-con (pf 0.75), 2 kW lighting (pf 1.0).
              UPS rated 25 kVA. Will it cope?
            </>
          }
          whatToDo={
            <>
          ...
          whyItMatters={
            <>
              ...
              Pythagoras to find S. The average pf comes out as P/S — usually somewhere between the
              worst and best individual pf. This is exactly the maths a UPS designer or
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>I²R loss in customer cables</strong> — paid for as kWh consumption. Worse pf =
              more current = more loss.
            </li>
            <li>
              <strong>DNO availability charge / kVA charge / kVAr charge</strong> — extra line items
              on commercial bills when pf falls below 0.95.
            </li>
          </ul>
          <p>For a 200 kW factory at pf 0.7, typical PFC bank cost £8-15k, payback 18-30 months.</p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              So pf is right, internal maths is right — but V × I disagrees. Likely CT polarity or
              voltage reference issue.
            </li>
          </ul>
        </ConceptBlock>
