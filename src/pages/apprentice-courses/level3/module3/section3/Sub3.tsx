...
const checks = [
  {
    ...
    options: ['10 kVA', '14 kVA', '48 kVA', '7 kVA'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['7.5 kVAr', '10.5 kVAr', '15 kVAr', '22 kVAr'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Maximum reactive power', 'No reactive power — purely resistive', 'Zero real power', 'Infinite impedance'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['140 kVA', '200 kVA', '286 kVA', '400 kVA'],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ['100 kVAr', '141 kVAr', '200 kVAr', '204 kVAr'],
    correctAnswer: 3,
    explanation:
