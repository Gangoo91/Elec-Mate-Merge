...
const TITLE = 'Star and delta calculations | Level 3 Module 3.3.2 (AC 2.8) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: ['12.96 kW', '17.6 kW', '15.25 kW', '8.8 kW'],
    correctIndex: 0,
    explanation: 'P = √3 × V_L × I_L × cos φ = 1.732 × 400 × 22 × 0.85 = 12 957 W ≈ 12.96 kW.',
  },
  {
    id: 'l3-m3-3-2-current',
    question:
      'A 7.5 kW (output) motor at 400 V 3-phase, η = 90 %, pf = 0.86. Line current is approximately:',
    options: ['21.7 A', '14.0 A', '12.5 A', '7.5 A'],
    correctIndex: 1,
    explanation:
  ...
  {
    id: 'l3-m3-3-2-delta',
    question: 'A delta-connected load with phase current 10 A. Line current is:',
    options: ['5.77 A', '10 A', '30 A', '17.32 A'],
    correctIndex: 3,
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['2 × phase current', 'Phase current', '√3 × phase current', 'Phase current / √3'],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ['V × I × cos φ', 'V × I', '√3 × V_phase × I_phase', '√3 × V_L × I_L × cos φ'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['20.8 kVA', '12 kVA', '36 kVA', '40 kVA'],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ['12 kW', '14.5 kW', '8 kW', '20.8 kW'],
    correctAnswer: 1,
    explanation: 'P = S × pf = 20.8 × 0.7 = 14.56 kW.',
  },
  {
    id: 6,
    question: 'A 3-phase motor draws 25 A line on 400 V, pf 0.8, η 85 %. Mechanical output power:',
    options: ['14.7 kW', '13.86 kW', '11.8 kW', '17.32 kW'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['7.7 A', '13.3 A', '40 A', '23.1 A'],
    correctAnswer: 3,
    explanation:
  ...
  {
    id: 8,
    question: 'A 3-phase star load: line voltage 400 V, phase impedance 25 Ω. Line current is:',
    options: ['9.24 A', '24 A', '32 A', '16 A'],
    correctAnswer: 0,
    explanation:
...
const faqs = [
  {
    question:
      'Why is the formula different for star and delta in some places but the same for power?',
    answer:
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 3 · Subsection 2"
        title="Star and delta calculations"
        backTo="/study-centre/apprentice/level3-module3-section3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The √3 maths in full. Sizing 3-phase loads, calculating line currents, checking power, and
          reading transformer plates fluently.
        </p>
        ...
        >
          ...
          <p>
            ...
            <br />
            Total power (resistive): P = 3 × V_phase × I_phase = 3 × 230.9 × 4.62 = 3201 W ≈ 3.2 kW.
            <br />
            Same answer using the line formula: P = √3 × V_L × I_L = 1.732 × 400 × 4.62 = 3199 W ≈
            3.2 kW.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            The clamp meter reads 23 A on each line conductor; each winding actually only carries
            13.3 A. Both numbers are correct — they are measured in different places.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>P (W) = √3 × V_L × I_L × cos φ</strong> — real power, what the meter charges.
            </li>
            <li>
              <strong>S (VA) = √3 × V_L × I_L</strong> — apparent power, what the cable carries.
            </li>
            <li>
              <strong>Q (VAr) = √3 × V_L × I_L × sin φ</strong> — reactive power, oscillating in
              inductance/capacitance.
            </li>
          </ul>
          <p>Triangle relationship (next Sub): S² = P² + Q². pf = P / S = cos φ.</p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              calculated above (37.4 A in our example). The protective device rating must be ≥ I_b
              but ≤ I_z. For motors, also consider starting current (4-7× I_b for DOL) — use Type C
              or D MCBs to ride the inrush.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Star/delta and three-phase motor calcs feed straight into Reg 552.1.1: cable, MCB and
              contactor must carry the full-load running current AND survive the starting surge. DOL
              inrush at 4–7× FLC, soft-starter inrush at 2–3× FLC, VFD inrush close to FLC. On
              intermittent-duty plant (compressors, hoists) the cumulative thermal effect of
              frequent restarts can dominate sizing — the cable de-rates as the duty-cycle factor
              reduces.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              overload relay, electronic motor protection, or the integral protection in a VFD or
              soft-starter. The MCB on its own protects the cable, not the motor windings. On a
              stalled rotor a 7.5 kW motor can sit at locked-rotor current (5–7× FLC) for tens of
              seconds without tripping a Type C MCB; the overload relay's I²t curve catches it.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Sum says: 3-phase 400 V load drawing 30 A, pf 1.0. Apprentice writes P = V × I = 400 ×
              30 = 12 kW. Real answer = √3 × 400 × 30 = 20.8 kW. Drives the cable size wrong.
            </>
          }
          doInstead={
            <>
              Three-phase has THREE lines doing the work, not one. Always multiply by √3 (≈ 1.732)
              when going from V_line × I_line to power. Mnemonic: "Three phases need root three."
              Single-phase is the special case where √3 is not there.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A 3-phase 4-wire sub-DB feeds a workshop with: 3 × 5.5 kW lathes (input ~6.5 kW each
              at pf 0.85), 1 × 11 kW grinder (input ~12 kW at pf 0.82), 18 kW resistive heating.
              Diversity factor 0.7 for the lathes. Calculate I_b for the sub-main and pick a cable.
            </>
          }
          whatToDo={
            <>
              ...
              <br />
              Cable: 25 mm² 4-core SWA (clipped, 90 °C XLPE) gives I_z ≈ 100 A. 80 A 3-pole MCB Type
              C. Volt-drop check separate.
            </>
          }
          whyItMatters={
            <>
              Mixing kW, pf and √3 across multiple loads is the daily 3-phase design routine.
              Per-load line currents, not total kW, drive the cable size — because the cable only
              sees current, not power.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Star:</strong> Z_phase = (V_L / √3) / I_L.
            </li>
            <li>
              <strong>Delta:</strong> Z_phase = V_L / (I_L / √3) = √3 × V_L / I_L.
            </li>
          </ul>
          <p>
            For a star-delta swap on the same load, line current changes by a factor of 3 (delta
            line current is 3× the star line current at the same line voltage). That is why DOL
            star-delta starting limits inrush to one-third.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Worked: 11 kW IE3 motor, 400 V, pf 0.86, η 0.91.</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          ...
          <p>
            On a 3-phase + N circuit serving single-phase final circuits, you may also need to check
            the L-N drop separately if the loads are unbalanced.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              In star, V_phase = 400/√3 = 231 V. I_phase = 231/Z_lr — that is 1/√3 of delta phase
              current.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>All three within 10 %</strong> → balanced, healthy.
            </li>
            <li>
              <strong>Two equal, one near zero</strong> → lost phase OR open delta winding.
            </li>
            <li>
              <strong>One high, two low</strong> → unbalanced single-phase loading; rebalance.
            </li>
            <li>
              <strong>All three reading high steady-state</strong> → overload or undervoltage; check
              supply.
            </li>
            <li>
              <strong>Wildly oscillating</strong> → motor stalling, drive instability, harmonic
              resonance.
            </li>
          </ul>
        </ConceptBlock>
