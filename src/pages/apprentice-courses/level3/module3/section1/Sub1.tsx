...
const checks = [
  {
    ...
    options: ['0.47 mA', '470 mA', '47 mA', '4.7 mA'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['23 000 mV', '0.23 mV', '23 mV', '230 000 mV'],
    correctAnswer: 3,
    explanation: 'milli is 10⁻³, so 1 V = 1000 mV. 230 V × 1000 = 230 000 mV (or 2.3 × 10⁵ mV).',
  },
  {
    id: 4,
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 1 · Subsection 1"
        title="Mathematical principles for electrical work"
        backTo="/study-centre/apprentice/level3-module3-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The maths habits L3 takes for granted: indices, scientific notation, transposition,
          trigonometry and percentages. Get these solid first — every other L3 sum depends on them.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Negative indices:</strong> flip to the denominator. 10⁻³ = 1/10³ = 1/1000 =
              0.001.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Copper resistivity ρ = 0.0000000172 Ω·m = <strong>1.72 × 10⁻⁸ Ω·m</strong>.
            </li>
            <li>
              Insulation resistance 200 000 000 Ω = <strong>2 × 10⁸ Ω</strong> = 200 MΩ.
            </li>
            <li>
              RC time constant 0.000 47 s = <strong>4.7 × 10⁻⁴ s</strong> = 0.47 ms.
            </li>
            <li>
              3-phase transformer rating 1 600 000 VA = <strong>1.6 × 10⁶ VA</strong> = 1.6 MVA.
            </li>
          </ul>
          <p>
        ...
        >
          <p>
            Take V = IR. Three variables — V, I, R. The formula gives V if you know I and R. To find
            I or R you have to rearrange. The rule is brutally simple: do the same thing to both
            sides until the variable you want is alone.
          </p>
          <p>
          ...
          <p>
            For more complex formulas the same rule applies, but the operations stack. For power
            dissipated in a resistor:
          </p>
          <p>P = I² R → divide by R → P/R = I² → square-root both sides → I = √(P/R).</p>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 132.1 places the design duty on one or more <em>skilled persons</em>. At L3 you
              sit on the gradient between competent operative and competent designer; the maths in
              this Sub is the toolkit you bring to that designer judgement — load calculations,
              voltage drop, fault current, power-factor triangles, transformer ratios. Without
              confident transposition and trigonometry the designer&apos;s output is guesswork
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 134.1.1 is the workmanship rule — the verification step that follows design. The
              maths principles (indices, scientific notation, transposition, trigonometry) carry
              across into the verification: did the chosen cable&apos;s resistance match the design
              assumption? Did the measured Z<sub>s</sub> tally with the calculated value? The
              numbers on the EIC come from the same maths you&apos;re practising here — so the
              verification only stands up if the arithmetic does.
            </>
          }
        ...
        >
          ...
          <p>
            Why this matters for L3: the power triangle. P (true power, kW) is the adjacent. Q
            (reactive power, kVAr) is the opposite. S (apparent power, kVA) is the hypotenuse. Power
            factor is cos φ = P/S. So the same maths you used for a 3-4-5 triangle in GCSE comes
            back as kVA, kW and kVAr in §3.
          </p>
          <p>
            Example: an inductive load draws P = 12 kW and Q = 5 kVAr. Apparent power S = √(12² +
            5²) = √(144 + 25) = √169 = 13 kVA. Power factor cos φ = 12/13 = 0.923.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              10 ÷ 2 × 5 = 5 × 5 = 25 (division and multiplication left-to-right; NOT 10 / 10 = 1).
            </li>
            <li>
              3-phase example: P = 1.732 × 400 × 25 × 0.85 = 14 722 W ≈ 14.72 kW. Calculator does it
              in order: 1.732 × 400 = 692.8, × 25 = 17 320, × 0.85 = 14 722. Right.
            </li>
          ...
          <p>
            ...
            steps using <code>Ans</code> rather than typing one giant expression — easier to spot a
            mistake.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            the turns ratio is 1000:50, which simplifies to 20:1 (divide both sides by 50). That
            same ratio sets the voltage ratio: V₁/V₂ = N₁/N₂. So 11 000 V primary gives 11 000 / 20
            = 550 V secondary.
          </p>
          <p>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Write the units beside every number as you enter it. mV × A × m gives you mV·A·m in
              units. Dividing by 1000 (mA per A) and noting that the m cancels gets you to volts.
              The actual drop is 14.4 mV. The job needed 2.5 mm², not 10 mm².
            </>
          }
        />
        ...
        <Scenario
          ...
          whyItMatters={
            <>
              Every step uses the maths in this Sub: percentage (3 % limit), transposition (mV/A/m
              formula), unit conversion (÷ 1000 from mV to V), and comparison. Get any one of those
              wrong and you specify the wrong cable.
            </>
          }
        />
        ...
        <Quiz title="Mathematical principles knowledge check" questions={quizQuestions} />
