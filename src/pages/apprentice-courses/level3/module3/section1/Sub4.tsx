    ...
    <HubPage>
      ...
      <HubBody>
        ...
        >
          ...
          <p>
            You'll spend Section 3 on this. For now, recognise that AC power has three flavours and
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              calculations in this Sub (P = VI cos φ for AC, I²R loss for cables, η for motors) are
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Overload coordination sits on top of the power-and-current calculation. From this Sub:
        ...
        <Scenario
          ...
          whyItMatters={
            <>
              ...
              on a high-duty-cycle application. The maths in this Sub is exactly what an M&E energy
              audit boils down to.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">1.3 Mechanics</div>
          </button>
          <button
