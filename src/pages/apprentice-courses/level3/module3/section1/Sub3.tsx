...
const TITLE = 'Mechanics: force, work, energy, power | Level 3 Module 3.1.3 (AC 1.1) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    id: 'l3-m3-1-3-mass',
    question:
      'A 50 kg motor is mounted on a wall bracket. What weight (force) does the bracket support? (g ≈ 9.81 m/s²)',
    options: ['490.5 N', '50 N', '5.1 N', '981 N'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['100 J', '10 000 J', '1000 J', '100 000 J'],
    correctIndex: 1,
    explanation:
  ...
  {
    id: 'l3-m3-1-3-power',
    question: 'The same lift takes 25 seconds. What average mechanical power output is needed?',
    options: ['100 W', '400 W', '40 kW', '4 kW'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question: 'Work done = ?',
    options: ['Mass × distance', 'Force × time', 'Power × force', 'Force × distance moved'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 4,
    question: 'Power = ?',
    options: ['Energy ÷ time', 'Energy × time', 'Force × distance', 'Force × time'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Its motion', 'Its temperature', 'Its position', 'Its mass alone'],
    correctAnswer: 0,
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/level3-module3-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Mass vs weight. Force, work and the energy ladder. The maths that lets you size a hoist
          motor, an electric gate or a lift cable.
        </p>
        ...
        >
          ...
          <p>
            <strong>
              Weight (W or F<sub>g</sub>):
            </strong>{' '}
            SI unit newton (N). The gravitational force on a body. Depends on local gravity g (about
            9.81 m/s² on Earth's surface).
          </p>
          <p>
            W = m × g. So a 70 kg person weighs about 70 × 9.81 = 687 N on Earth. On Mars (g ≈ 3.7)
            the same 70 kg person would weigh 259 N — feels light, same mass.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock
          ...
          plainEnglish={
            "A force is a push or a pull. SI unit: newton (N). 1 newton accelerates 1 kilogram at 1 m/s². Pushing a 1 kg drill harder doesn't make it heavier; it accelerates faster."
          }
        >
          <p>The everyday forces you'll meet at L3:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Friction</strong> — opposes motion between surfaces. Wastes energy as heat.
            </li>
            <li>
        ...
        <ConceptBlock
          ...
          plainEnglish={
            "Work is done when a force moves something through a distance. No movement = no work, even if you're holding a heavy weight up. SI unit of work: joule (J)."
          }
        >
          <p>
          ...
          <p>
            Example: lifting a 20 kg consumer unit 1.5 m onto its mounting position. Force = mg = 20
            × 9.81 = 196.2 N. Work = F × d = 196.2 × 1.5 = 294.3 J. That is the energy you put into
            the lift.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock
          ...
          onSite={
            "Motor plates rate output power in kW (or HP on older plates). The motor's electrical input is always more — efficiency × input = output."
          }
        >
          <p>
          ...
          <p>
            Example continued: that 294.3 J consumer-unit lift, done in 3 seconds, needs average
            power = 294.3 / 3 = 98.1 W. That's mechanical power. The motor (or your biceps) had to
            deliver at least that much, plus losses.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              A 50 kg motor is roughly 490 N of weight. Lifting that solo above shoulder height is a
              Manual Handling assessment failure. Plan the lift, use a hoist, share the load — the
              maths in this Sub is exactly what risk assessments rely on.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Designing a motor circuit needs the mechanics in this Sub: torque (Nm) sets the motor
              rating, motor rating sets the current, current sets the cable and the breaker. A
              miscalculated torque feeds straight into an undersized supply. Reg 132.1 places the
              duty on a skilled person; the mechanics is part of the skill-set you bring to the
              design.
            </>
          }
...
(c) The current (Iop) causing effective operation of the protective device shall not exceed 1.45 times the lowest current-carrying capacity (Iz) of any of the conductors.`}
          meaning={
            <>
              Reg 433.1.1 ties motor mechanics to overload protection. The design current I
              <sub>B</sub> for a motor circuit is derived from the mechanical power output, divided
              by motor efficiency, then by power factor — three of the quantities explored in this
              Sub. Get the mechanics wrong and I<sub>B</sub> is wrong; the MCB sized to that wrong I
              <sub>B</sub> either nuisance-trips or fails to protect the cable.
            </>
          }
        ...
        >
          <p>Two energy types you'll calculate:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Gravitational PE</strong> = mgh (mass × g × height). Energy stored by lifting
              something up against gravity.
            </li>
            <li>
          ...
          <p>
            A 100 kg lift cab raised 10 m gains PE = 100 × 9.81 × 10 = 9810 J = 9.81 kJ. When it
            descends, that PE turns back into kinetic energy (and into electrical energy if the lift
            has regenerative braking — common on modern lifts).
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>
              η = (P<sub>output</sub> / P<sub>input</sub>) × 100 %
            </strong>
          </p>
          <p>For a motor delivering 4 kW mechanical with 90 % efficiency:</p>
          <p>
            P<sub>input</sub> = P<sub>output</sub> / η = 4000 / 0.9 = 4444 W ≈ 4.45 kW electrical.
          </p>
          <p>
            The 0.45 kW difference (450 W) becomes heat — which is why motors get warm and need
            ventilation. Always size the supply cable for input current, not for the output rating
            on the plate.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            For an ideal (frictionless) machine, MA = VR. A pulley block with VR = 4 lifts a 200 N
            load with 50 N of effort — but you pull 4 m of rope to lift the load 1 m. Same energy:
            200 × 1 = 200 J in, 50 × 4 = 200 J out.
          </p>
          <p>
            Real pulleys, levers and gears have friction, so MA &lt; VR. Efficiency = (MA / VR) ×
            100 %.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Lifts, hoists, conveyors, automatic gates, industrial gearboxes, cable pulling winches —
            every motorised lifting or pulling job uses gears or pulleys to match the motor's
            torque-speed curve to the load. The electrician sizes the supply for the electrical
            input; the mechanical engineer sizes the gearbox for the load.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Spec sheet says: 7.5 kW industrial pump motor, 400 V 3-phase. Apprentice plugs into
              the calc: P = √3 × V × I × pf, transposes for I, gets I = 7500 / (1.732 × 400 × 0.85)
              = 12.7 A. Sizes for 16 A breaker. Trips on every start.
            </>
          }
          doInstead={
            <>
              The 7.5 kW is the OUTPUT mechanical rating. Motor efficiency at full load is typically
              88-92 %. P<sub>input</sub> = 7500 / 0.9 = 8.33 kW. I = 8333 / (1.732 × 400 × 0.85) =
              14.1 A — and that's only steady-state. Starting current can be 6-8× higher. Size the
              supply for the actual input current and pick a Type C or D MCB that survives motor
              inrush.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Workshop wants a 500 kg hoist that lifts at 0.1 m/s. The gearbox has efficiency 75 %.
              What mechanical motor power output do you need? What electrical input if the motor is
              88 % efficient?
            </>
          }
          whatToDo={
          ...
          whyItMatters={
            <>
              Two efficiencies stacked (gearbox × motor) means a 500 W mechanical lifting job needs
              750 W electrical input. Forget either efficiency and you undersize the motor and the
              supply, the breaker trips, and the customer rings you on day one.
            </>
          }
        />
