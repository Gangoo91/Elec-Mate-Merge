...
const TITLE = 'Measuring instruments | Level 3 Module 3.1.5 (AC 1.1, 2.3) | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: ['CAT III 300 V', 'CAT II 300 V', 'CAT IV 600 V', 'Any CAT rating'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['500 V dc', '250 V dc', '1000 V dc', '2500 V dc'],
    correctAnswer: 0,
    explanation:
  ...
  {
    id: 5,
    question: 'You need to measure earth fault loop impedance Zs. Which instrument?',
    options: ['Clamp meter', 'Loop tester', 'Megger insulation tester', 'Multimeter on Ω range'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Voltmeter, ammeter, multimeter, MFT, clamp meter, PQ analyser, oscilloscope. Pick the
          right tool, with the right CAT rating, and read it correctly.
        </p>
        ...
        >
          ...
          <p>
            Modern multimeters combine both — switch the function and re-arrange the leads. Most
            failures from this come from leaving the leads in the A jacks, switching to V, and
            connecting across a live circuit. The low-impedance A circuit becomes a short across the
            supply. Bang.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            AC-only clamps use a current transformer in the jaws. They cannot read DC. AC/DC clamps
            use a Hall-effect sensor — more expensive, used for inverter output, EV charging and PV
            string testing.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>CAT II</strong> — single-phase appliances and outlets at the end of a circuit
            ...
            <li>
              <strong>CAT IV</strong> — origin of the installation, supply tails, meter position,
              outdoor underground or overhead lines.
            </li>
          </ul>
          <p>
            The CAT rating is paired with a voltage (CAT III 600 V, CAT IV 1000 V). Both numbers
            matter — voltage is the steady working voltage, CAT is the impulse withstand category at
            that location.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 134.2.1 is the verification anchor — the duty to inspect and test before putting
              the installation into service. Every test in that verification (continuity, insulation
              resistance, polarity, Z<sub>s</sub>, RCD operation) is read from the instruments
              covered in this Sub. The competence Reg 134.2.1 assumes includes knowing your
              meter&apos;s CAT rating, true-RMS behaviour and accuracy class — otherwise the
              certificate is built on values you cannot defend.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 643.3 is the test that pulls a Megger MFT through its full range. The instrument
              has to deliver 500 V DC for a normal LV test, drop to 250 V DC where sensitive
              equipment is connected (LED drivers, SPDs, electronic controls), and read insulation
              in megohms accurately. A4:2026 also simplified RCD verification (the operative
              requirement is Reg 643.8) to a single AC test at 1× IΔn — a general non-delay RCD must
              disconnect within 300 ms; the ½× and 5× IΔn sequence and Appendix 3 Table 3A were
              deleted. Knowing the MFT is doing what it claims — and reading correctly through its
              lead resistance and zeroing — is part of the L3 measurement competence the regulation
              expects.
            </>
          }
        ...
        >
          ...
          <p>
            ...
            true-RMS is essential. It costs an extra £30-£50 over an averaging meter and pays for
            itself the first time it stops you under-sizing a cable.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Continuity (R1+R2, R2)</strong> — low-current 4-wire test, displays in Ω with
              milliohm resolution.
            </li>
            <li>
              <strong>Insulation resistance (IR)</strong> — 250 V, 500 V or 1000 V dc test voltage,
              displays MΩ or GΩ.
            </li>
            <li>
              <strong>
                Loop impedance (Zs, Ze, Z<sub>dB</sub>)
              </strong>{' '}
              — high- or low-current pulse to measure loop with the supply live.
            </li>
            <li>
            ...
            <li>
              ...
              residual operating current (IΔn) and measures the disconnection time. Under A4:2026
              (Reg 643.8) this single 1× test verifies effectiveness — a general non-delay RCD must
              disconnect within 300 ms; the historic ½× and 5× IΔn tests and Appendix 3 Table 3A
              were deleted.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            61000-4-30 (PQ measurement methods). UK supply must stay within ±10 % of nominal, with
            limits on harmonic distortion, flicker and short interruptions.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>SELV / PELV</strong> — 250 V dc test, min 0.5 MΩ.
            </li>
            <li>
              <strong>LV up to 500 V</strong> (230/400 V) — 500 V dc test, min 1.0 MΩ.
            </li>
            <li>
              <strong>LV 500–1000 V</strong> — 1000 V dc test, min 1.0 MΩ.
            </li>
            <li>
              Disconnect electronics (LED drivers, EVSE, surge protection) before test — 500 V dc
              will destroy them.
            </li>
          </ul>
          <p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Resolution</strong> = smallest displayed step (3½-digit DMM = 1999 counts).
            </li>
            <li>
              <strong>Accuracy</strong> = ± (% of reading + n digits). Cheap clamp ±2 % + 5 digits;
              lab DMM ±0.05 % + 1 digit.
            </li>
            <li>
              <strong>Calibration class</strong> = traceable to UKAS standard. Class 1 = ±1 %, class
              2 = ±2 %.
            </li>
            <li>
              <strong>Calibration interval</strong> = annual for installation work; six-monthly for
              high-stakes verification.
            </li>
          </ul>
          <p>
            Worked example: Z_s reading 0.42 Ω on a ±2 % + 1 digit meter at 0.01 Ω resolution.
            Tolerance = (0.02 × 0.42) + 0.01 = 0.0184 Ω. So actual Z_s could be 0.40 to 0.44 Ω. For
            BS 7671 verification you accept the worst-case reading (0.44 Ω) when comparing to the
            limit.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              GS38 sequence: prove the meter on a KNOWN live source (proving unit, or another live
              circuit), test the suspected dead circuit (should read 0 V), then re-prove on the
              known source to confirm the meter still works. If step 3 fails, treat step 2 as
              suspect and re-test before working.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              logging for an hour — captures the inrush current when the microwave starts. Likely
              peak: 60+ A for &lt;100 ms. A type B MCB will trip at 3-5× rated current, so 96-160 A.
              The instantaneous trip threshold is 96 A. Inrush from cold-magnetron microwaves easily
              hits this.
              <br />
              Solution: change to type C MCB (5-10× rated, 160-320 A trip), or split the load across
              two circuits.
            </>
          }
          whyItMatters={
