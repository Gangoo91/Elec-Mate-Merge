...
const checks = [
  ...
  },
  {
    ...
    options: ['Decreases by ~16 %', 'Stays the same', 'Increases by ~16 %', 'Doubles'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "It's halfway in price between copper and PVC",
      'Its energy band gap is small enough that doping or heat can free electrons into conduction',
      "It's only conductive in one direction",
      "It's used in cable cores",
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['Many free electrons in the conduction band', 'Few free electrons', 'High resistivity', 'A wide band gap'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['+0.004 /°C', '−0.004 /°C', '+0.4 /°C', '−4 /°C'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['It has lower resistivity', 'It is much lighter and cheaper for the same conductance', 'It corrodes less', 'It withstands higher temperatures'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.36 Ω', '0.9 Ω', '1.8 Ω', '9 Ω'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['Domestic ring finals', 'Buried supply tails', 'Fire-survival circuits like emergency lighting and alarm', 'Outdoor lighting'],
    correctAnswer: 2,
    explanation:
