...
const TITLE = 'Electron theory and conductor properties | Level 3 Module 3.2.1 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    options: ['Increases by ~16 %', 'Decreases by ~16 %', 'Doubles', 'Stays the same'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['+0.4 /°C', '−4 /°C', '+0.004 /°C', '−0.004 /°C'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Standard PVC: 70 °C continuous. XLPE goes to 90 °C; mineral insulation to 250 °C+.',
  },
  {
    id: 5,
    question:
      'A 50 m run of 1.0 mm² copper. Resistance per metre at 20 °C ≈ 18 mΩ/m. Total resistance:',
    options: ['0.36 Ω', '0.9 Ω', '9 Ω', '1.8 Ω'],
    correctAnswer: 1,
  ...
  },
  {
    id: 6,
    question:
      'If the same 1.0 mm² cable warms from 20 °C to 70 °C in service, its resistance becomes (use α = 0.004 /°C):',
    options: ['0.72 Ω', '0.9 Ω', '1.08 Ω', '1.8 Ω'],
    correctAnswer: 2,
    explanation:
      'R_70 = 0.9 × [1 + 0.004 × 50] = 0.9 × 1.20 = 1.08 Ω. That extra 20 % shows up as voltage drop and I²R losses.',
  },
  {
    id: 7,
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 2 · Subsection 1"
        title="Electron theory and conductor properties"
        backTo="/study-centre/apprentice/level3-module3-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The L3 view of conductivity — band theory, temperature coefficient α, and the cable
          property table that drives conductor selection.
        </p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              temperature a few electrons cross by thermal energy; doping with phosphorus or boron
              massively boosts the carrier count.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            Worked example: a 1 mm² copper conductor 50 m long has R<sub>20</sub> = 0.9 Ω (from 18
            mΩ/m × 50 m). At 70 °C in service, R<sub>70</sub> = 0.9 × [1 + 0.004 × 50] = 0.9 × 1.2 =
            1.08 Ω. That 20 % rise feeds straight into voltage-drop calculations — which is why
            Appendix 4 tables build in a "fully loaded" temperature assumption.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>6242Y (T&E, "twin and earth")</strong> — Cu Class 1 solid (≤4 mm²) or Class 2
              stranded (≥6 mm²), PVC insulation 70 °C, PVC sheath, BS 6004. Domestic fixed wiring.
              Indoor only.
            </li>
            <li>
              <strong>SWA (steel-wire armoured)</strong> — Cu Class 2 stranded, XLPE insulation 90
              °C, PVC sheath inner and outer, steel armour as CPC, BS 5467 / BS 6724 (LSF version).
              Outdoors, buried, plant rooms.
            </li>
            <li>
              <strong>FP200 / FP400 / FP PLUS</strong> — Cu Class 2, mica/glass insulation, LSZH
              sheath, BS 7629/BS 8434. Fire-rated for sounder, emergency lighting and BMS circuits
              in escape routes.
            </li>
            <li>
              <strong>MICC (mineral-insulated copper-clad)</strong> — solid Cu conductor in
              magnesium-oxide powder inside a copper sheath. BS EN 60702. Survives direct fire for
              2-3 hours. Premium price.
            </li>
            <li>
              <strong>H07RN-F flex</strong> — Cu Class 5, EPR insulation, polychloroprene sheath.
              Heavy-duty rubber flex for outdoor extension leads, festoon lighting, industrial
              flexible feeds.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              You can't just pick a cable that has the right CSA. The selection process must match
              conductor material, insulation system and sheath chemistry to the installation method,
              ambient conditions and fire performance the design requires. Appendix 4 ties cable
              type to current-carrying capacity by reference method.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Conductor selection by resistivity and current-carrying capacity is bounded by a hard
              minimum CSA. Table 52.3 sets the floor: even on a tiny load, you can't drop below the
              tabulated minimum for the wiring-system type. The band-theory and resistivity work in
              this Sub explains <em>why</em> bigger CSA carries more current; Reg 524.1 is the
              regulation that stops you undershooting the floor.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The temperature coefficient α and the cable property table tie directly to this rule:
              pick a cable whose insulation limit (70 °C PVC, 90 °C XLPE, 250 °C MICC) stays within
              Table 52.2 across the worst-case ambient on the job, including hot lofts, plant rooms
              and buried summer ground. R<sub>T</sub> = R<sub>20</sub>(1 + αΔT) is the maths Reg
              522.1.1 expects you to apply.
            </>
          }
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Silver</strong>: ρ ≈ 1.59 × 10⁻⁸ Ω·m (best conductor — too expensive for
              cables)
            </li>
            <li>
              <strong>Copper</strong>: ρ ≈ 1.72 × 10⁻⁸ Ω·m (the standard for fixed wiring)
            </li>
            <li>
              <strong>Aluminium</strong>: ρ ≈ 2.83 × 10⁻⁸ Ω·m (1.65× higher than Cu)
            </li>
            <li>
              <strong>Brass</strong>: ρ ≈ 7 × 10⁻⁸ Ω·m (terminals and fittings only)
            </li>
            <li>
              <strong>Steel</strong>: ρ ≈ 1.4 × 10⁻⁷ Ω·m (~8× Cu — armouring, structural)
            </li>
            <li>
              <strong>Carbon</strong>: ρ ≈ 3.5 × 10⁻⁵ Ω·m (~2000× Cu — used in resistors, brushes)
            </li>
          </ul>
          <p>
            Sanity-check: copper resistance per metre at 1 mm² CSA = ρ/A = (1.72 × 10⁻⁸) / (10⁻⁶) =
            0.0172 Ω/m. So 100 m of 1 mm² Cu has R ≈ 1.72 Ω. Memorise that single number — it lets
            you sanity-check any cable resistance answer in seconds.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>CSA</strong>: Al needs ~1.6× the area of Cu (e.g. 16 mm² Al ≈ 10 mm² Cu).
            </li>
            <li>
              <strong>Mass</strong>: Al × 1.6 area but density is 1/3 of Cu → Al is ~55 % the mass
              for same conductance.
            </li>
            <li>
              <strong>Cost</strong>: Al per kg ~25 % of Cu; for same conductance ~13 % of Cu cost —
              significant on long runs.
            </li>
            <li>
              <strong>Termination</strong>: Al needs aluminium-rated terminals, antioxidant compound
              (NoAlOx) and re-torque after first thermal cycle. Direct Al-to-brass connections fail
              in months.
            </li>
            <li>
              <strong>Allowed uses</strong>: overhead lines, large supply tails (16 mm² and above),
              busbars. NOT used in fine-strand flex or domestic ring finals.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PVC (polyvinyl chloride)</strong> — 70 °C continuous, 300/500 or 450/750 V,
              releases HCl on burning. Standard T&E.
            </li>
            <li>
              <strong>XLPE (cross-linked polyethylene)</strong> — 90 °C continuous, 600/1000 V,
              slower flame spread. SWA cables.
            </li>
            <li>
              <strong>EPR (ethylene-propylene rubber)</strong> — 90 °C continuous, very flexible,
              used in trailing flex (H07RN-F).
            </li>
            <li>
              <strong>LSZH (low-smoke zero halogen)</strong> — same temperature class as the base
              polymer but releases no hydrogen halide on burning. Mandatory in escape routes per BS
              7671 §422.
            </li>
            <li>
              <strong>Mineral (MgO)</strong> — to 250 °C+, full fire-survival, 600 V class.
              MICC/Pyro.
            </li>
            <li>
              <strong>Silicone</strong> — to 180 °C, used in heater leads and high-temperature
              plant.
            </li>
          </ul>
          <p>
            Higher temperature class = more current capacity for the same CSA (Appendix 4 tables
            show this — 90 °C XLPE columns carry roughly 15 % more than 70 °C PVC). Don't terminate
            XLPE-rated cable into a 70 °C rated terminal — the terminal becomes the weak link and
            overheats.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Class 1</strong> — solid conductor. Stiff, cheap, only used up to about 4 mm²
              in fixed wiring.
            </li>
            <li>
              <strong>Class 2</strong> — stranded fixed wiring. SWA cores, T&E ≥6 mm², most singles.
            </li>
            <li>
              <strong>Class 5</strong> — flexible (multi-strand). Standard appliance flex, pendant
              cords.
            </li>
            <li>
              <strong>Class 6</strong> — extra flexible (very fine strands). Welder leads, cable
              drums, robot arm cables.
            </li>
          </ul>
          <p>
            Class 5 and 6 must be terminated with ferrules ("bootlace" terminals) to stop strands
            escaping the screw clamp. Direct-clamping fine strands is a common installation defect
            that fails an EICR.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            mineral). Otherwise the insulation degrades, breakdown follows, and the cable eventually
            short-circuits.
          </p>
          <p>
            Derating factors C_a (ambient), C_g (grouping) and C_i (thermal insulation) multiply
            down the table value to give the actual safe current. A 32 A circuit tabled at 36 A but
            in a hot loft (C_a = 0.87) and grouped with three others (C_g = 0.65): I_max = 36 × 0.87
            × 0.65 = 20.4 A. The 32 A circuit is now overloaded — fail the design.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Cold continuity is for fault-loop checks; voltage drop in service uses the HOT cable.
              Either use Appendix 4 mV/A/m tables (already corrected for 70 °C operation) or apply
              the temperature coefficient: R_70 = 0.9 × 1.2 = 1.08 Ω → V_drop = 32 × 1.08 = 34.6 V.
              Either way, do the maths once with the right starting point.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Customer wants an outdoor festoon for an event marquee 30 m from the supply, draws 400
              W of LEDs. Cable will be temporary, lying on grass, exposed to UV and possibly rain.
            </>
          }
          whatToDo={
            <>
          ...
          whyItMatters={
            <>
              A T&E run for the same job would crack within weeks of UV exposure and become a shock
              risk. Reading the cable property table is the difference between a safe temporary
              install and a customer prosecution.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Section 1</div>
          </button>
          <button
