...
const TITLE = 'Magnetism and EMF generation | Level 3 Module 3.2.3 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    options: ['The voltage', 'The induced EMF', 'The force on the conductor', 'The magnetic field'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Motors', 'Induction', 'Generators', 'Transformers'],
    correctIndex: 0,
    explanation:
  ...
  {
    id: 'l3-m3-2-3-emf',
    question: 'A coil of 200 turns has flux changing at 0.05 Wb/s. Induced EMF magnitude:',
    options: ['100 V', '10 V', '0.25 V', '4 V'],
    correctIndex: 1,
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['No effect', 'Attract', 'Repel', 'Cancel out'],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ['Transformers', 'Motors', 'Capacitors', 'Generators (induced EMF)'],
    correctAnswer: 3,
    explanation:
  ...
  {
    id: 5,
    question: "Lenz's law states the direction of induced EMF is such that:",
    options: [
  ...
  {
    id: 7,
    question: 'A simple loop generator rotates in a magnetic field. The output waveform is:',
    options: ['Square wave', 'Triangular', 'DC', 'Sinusoidal'],
    correctAnswer: 3,
    explanation:
  ...
  {
    id: 8,
    question: 'A 4-pole alternator running at 1500 rev/min produces what frequency?',
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Magnetic fields around conductors. Fleming's hand rules. Faraday's law. The physics behind
          every motor, generator and transformer.
        </p>
        ...
        >
          ...
          <p>
            For a single straight wire, the field is concentric circles around it, weakening with
            distance (B ∝ 1/r). For a coil (solenoid), the field is concentrated along the axis,
            with N and S poles at the ends.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            EMF = 500 × (0.02 / 0.1) = 500 × 0.2 = 100 V.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            When the loop is parallel to the field (θ = 0°), the conductors move along the field
            lines — no cutting, EMF = 0. When perpendicular (θ = 90°), they move across the field at
            maximum rate — EMF peaks.
          </p>
          <p>
            <strong>
              e(t) = E<sub>peak</sub> × sin(ωt)
            </strong>
          </p>
          <p>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>MMF (F)</strong> = N × I (ampere-turns). The "voltage" of the magnetic
              circuit.
            </li>
            <li>
              <strong>Flux (Φ)</strong> in webers. The "current" — what the MMF drives through the
              core.
            </li>
            <li>
              <strong>Reluctance (S)</strong> = ℓ/(μ × A). Magnetic resistance — depends on core
              path length, area and permeability.
            </li>
            <li>
              <strong>Magnetic Ohm's Law</strong>: F = Φ × S, so Φ = F/S = (N × I)/S.
            </li>
          </ul>
          <p>
            Worked example: a coil of N = 500 turns drives I = 0.5 A through a core with reluctance
            S = 5 × 10⁵ A·t/Wb. MMF = 500 × 0.5 = 250 A·t. Flux Φ = 250 / (5 × 10⁵) = 5 × 10⁻⁴ Wb =
            0.5 mWb. If the core cross-section is 25 cm² = 2.5 × 10⁻³ m², flux density B = Φ/A = 5 ×
            10⁻⁴ / 2.5 × 10⁻³ = 0.2 T — well below the saturation limit (~1.7 T) for grain-oriented
            silicon steel.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>v_L = L × di/dt</strong> — voltage across an inductor depends on rate of current
            change.
            <br />
            <strong>v_2 = M × (di_1/dt)</strong> — voltage induced in coil 2 from current change in
            coil 1.
          </p>
          <p>
            For two perfectly coupled coils on the same core, M = √(L₁ × L₂). Real transformers have
            leakage flux, so M = k × √(L₁ × L₂) where k is the coupling coefficient (≤ 1, typically
            0.95–0.99 for power transformers).
          </p>
          <p>
            Worked example: two coils with L₁ = 100 mH and L₂ = 25 mH, coupling k = 0.98. M = 0.98 ×
            √(0.1 × 0.025) = 0.98 × √0.0025 = 0.98 × 0.05 = 0.049 H = 49 mH. A 50 Hz, 1 A current
            change at di/dt = 314 A/s in coil 1 induces v₂ = 0.049 × 314 ≈ 15.4 V in coil 2.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The three EMFs at any instant t (with f = 50 Hz, ω = 314.16 rad/s):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            At any instant the three EMFs sum to zero (geometric property of three vectors at 120°)
            — which is why a balanced 3-phase load has no neutral current. Unbalanced loads
            (different currents per phase) put the difference into the neutral. Single- phase loads
            spread across the three phases keep the neutral close to zero.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The whole UK national grid is locked to 50 Hz within tight tolerance. Every rotating
              machine connected to the grid must run at a multiple of 50 Hz divided by its pole
              pairs. The frequency is the result of millions of generators acting in synchrony — and
              is the reference for every clock and motor connected to mains.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              plate sets up an induced AC flux loop in the steel that heats the plate and can trip a
              ZS reading high. Bring all line/neutral/CPC conductors through the same hole — net
              flux cancels and the steel stays cool. This is why steel SWA glands accept all cores
              together and why singles in steel conduit must run as a complete circuit set.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              armour. For single-core AC runs use aluminium-armoured cable or unarmoured singles in
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice working out which way a motor will rotate uses the right hand by habit.
              Predicts forward; the motor spins backward. Reverses the supply, motor still spins
              backward (because the rule was wrong, not the wiring). Wastes an hour fault-finding
              what is actually correct wiring.
            </>
          }
          doInstead={
            <>
        ...
        <Scenario
          ...
          whyItMatters={
            <>
              ...
              magnetism-and-Fleming reasoning behind why swapping two phases reverses rotation is
              the L3 understanding the AM2 will test.
            </>
          }
        />
