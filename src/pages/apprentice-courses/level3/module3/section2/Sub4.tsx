...
const checks = [
  {
    id: 'l3-m3-2-4-peak',
    question: 'UK mains is 230 V RMS. Peak voltage is approximately:',
    options: ['400 V', '115 V', '230 V', '325 V'],
    correctIndex: 3,
    explanation:
  ...
  {
    id: 'l3-m3-2-4-period',
    question: 'Period of a 50 Hz sine wave:',
    options: ['50 ms', '20 ms', '10 ms', '100 ms'],
    correctIndex: 1,
    explanation: 'T = 1/f = 1/50 = 0.02 s = 20 ms. One full cycle every 20 ms.',
  },
  {
    id: 'l3-m3-2-4-rms',
    question: 'A sine wave has a peak value of 14.14 A. Its RMS value is:',
    options: ['20 A', '7.07 A', '10 A', '9 A'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['V_peak × 0.637', 'V_peak / √2', 'Zero', 'V_peak / 2'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['In phase', 'Anti-phase', '90° out of phase', 'Different frequencies'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 7,
    question: 'A 230 V supply across a pure 23 Ω resistance: the peak current is:',
    options: ['10 A', '23 A', '20 A', '14.1 A'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['650 V', '460 V', '230 V', '325 V'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          230 V RMS = 325 V peak. Period, frequency, angular velocity. Form factor 1.11 and why
          true-RMS matters on modern loads.
        </p>
        ...
        >
          <p>
            For a sine wave with peak amplitude V<sub>p</sub>:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Peak (V_p)</strong> — maximum value. Insulation must withstand this.
            </li>
            <li>
              <strong>Peak-to-peak (V_pp)</strong> = 2 × V_p. The total swing.
            </li>
            <li>
              <strong>RMS (V_RMS)</strong> = V_p / √2 ≈ 0.707 × V_p. The "DC equivalent" — does the
              same heating work as a DC of the same value.
            </li>
            <li>
              <strong>Average (V_avg over half cycle)</strong> = (2/π) × V_p ≈ 0.637 × V_p. Used
              internally by averaging meters.
            </li>
          </ul>
          <p>
            For UK mains: V_RMS = 230 V (the figure on the certificate). V_peak = 325 V. V_pp = 650
            V. V_avg (half cycle) = 207 V. Same wave, different ways of describing it.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Frequency (f)</strong> — Hz (cycles per second). UK 50 Hz.
            </li>
            <li>
              <strong>Period (T)</strong> = 1/f. UK 50 Hz → T = 20 ms.
            </li>
            <li>
              <strong>Angular frequency (ω)</strong> = 2πf rad/s. UK → ω = 314.16 rad/s. Used in
              inductive/capacitive reactance formulas: X_L = ωL, X_C = 1/(ωC).
            </li>
          </ul>
          <p>
            At higher frequencies (400 Hz aircraft, 20 kHz inverter outputs) the same maths applies.
            ω just gets bigger — and inductive reactance with it.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>Adding sine waves of the same frequency</strong>: use phasors (vectors). Two
            sines 90° apart with peak 100 V each combine to a single sine of peak √(100² + 100²) =
            141.4 V at 45°. Same Pythagoras as the impedance triangle in Sub 2.5.
          </p>
          <p>
            <strong>Anti-phase (180°)</strong>: two equal sines 180° apart cancel exactly. That's
            why a humbucker pickup, a balanced audio line, or a differential signal twin-pair
            rejects common-mode noise — equal noise picked up on both wires cancels when the
            receiver subtracts.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sine</strong>: peak/RMS = √2 ≈ 1.414; RMS/avg = 1.11.
            </li>
            <li>
              <strong>Square</strong>: peak = RMS = avg → form factor 1.0, crest factor 1.0.
            </li>
            <li>
              <strong>Triangular</strong>: form factor ≈ 1.155; crest factor ≈ 1.732 (√3).
            </li>
            <li>
              <strong>Half-wave rectified sine</strong>: RMS = V_peak / 2; avg = V_peak / π; form
              factor π/2 ≈ 1.57.
            </li>
            <li>
              <strong>SMPS input current</strong>: pulses near voltage peak; crest factor 2 to 3.
            </li>
          </ul>
          <p>
            Why crest factor matters for measurement: a true-RMS meter must handle a crest factor of
            at least 3 to read computer/LED loads accurately. Cheap meters spec CF ≤ 1.5 — only good
            for sines.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>R</strong>oot — take the square root of
            </li>
            <li>
              <strong>M</strong>ean — the average of
            </li>
            <li>
              <strong>S</strong>quare — the squared values of the waveform.
            </li>
          </ul>
          <p>
            For a pure sine wave the maths gives RMS = peak / √2. For other waveforms (square,
            triangle, distorted) the relationship is different — which is why an average-responding
            meter calibrated for sine reads wrong on a distorted wave, and true-RMS is the safer
            default.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            healthy supply has THD &lt; 5 %. LED and computer loads typically present THD 50– 100 %
            at the load terminals.
          </p>
          <p>
            Worked example: a load draws I₁ = 10 A fundamental, I₃ = 6 A (3rd harmonic), I₅ = 3 A.
            Total RMS = √(100 + 36 + 9) = √145 = 12.04 A. THD = √(36 + 9) / 10 = √45 / 10 = 6.71 /
            10 = 67 %. The cable carries 12 A while the active 50 Hz current is only 10 A — the
            harmonics ride for free.
          </p>
          <p>
            The 3rd harmonic in particular sums into the neutral on a 3-phase 4-wire system (instead
            of cancelling like the fundamental), which is why heavily-loaded 3-phase systems with
            switching loads need oversized neutrals. BS 7671 §524.2.1 covers this.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            <br />
            In phasor form: V = V_RMS ∠ φ. The phasor magnitude is the RMS value, the angle is the
            phase relative to a reference (usually L1 voltage).
          </p>
          <p>
            Why phasors are useful: instead of integrating dv/dt and di/dt for a sine input, you
            treat the inductor as an impedance jωL and the capacitor as 1/(jωC). The result is a
            complex number where the real part is the resistive component and the imaginary part is
            the reactive. Vector addition replaces calculus.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              inverter or rectifier loads, the meter will under-read the real RMS by 5-30 % or more.
              Buy true-RMS as standard for any installation work.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The 230 V RMS supply has manufacturer-tolerated bands either side. A peak of 325 V and
              an RMS of 230 V are the same waveform — what the appliance "sees" is the RMS, because
              RMS is the heating-equivalent value that drives every appliance rating. Reg 525.1 ties
              cable sizing back to the RMS at the terminals after voltage drop.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              supplies, third-harmonic currents add in the neutral and don't cancel between phases —
              neutral currents can exceed line currents. On harmonic-rich installs you upsize the
              neutral or apply the Appendix 4 §C de-rating factors. RMS measured on a true-RMS meter
              is the figure you compare against the Appendix 4 column.
            </>
          }
        ...
        >
          ...
          <p>
            ...
            <br />
            Average over a full cycle = 0 — no real power consumed; just oscillating reactive energy
            at 2 × line frequency.
          </p>
          <p>
            Worked example: 230 V RMS through a 23 Ω resistor. P_avg = V × I = 230 × 10 = 2300 W.
            Peak instantaneous power = 2 × P_avg = 4600 W (for half a cycle, twice per 50 Hz period
            — i.e. peaks at 100 Hz). The element heats steadily but the heat delivery pulses at 100
            Hz.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Specifier sees 230 V on the supply, picks 230 V-rated insulation. It works for weeks,
              then breaks down — because the insulation has to survive the PEAK (325 V) every cycle,
              not the RMS.
            </>
          }
          doInstead={
            <>
              ...
              transients. Modern XLPE insulation is typically rated 600/1000 V — well clear of 325 V
              peak even with switching transients. Old PVC at 300/500 V is marginal — that's why
              it's largely been replaced.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You're investigating a tripping problem on a 3-phase fan motor fed by a VFD. The VFD
              output is a chopped PWM (pulse-width modulated) waveform — looks square-ish. Standard
              clamp meter shows 14 A; true-RMS clamp shows 18 A. Cable is rated 20 A. Why the
              difference, and what to do?
            </>
          }
          whatToDo={
            <>
              The standard meter is averaging — assumes sine and applies form factor 1.11. The
              actual VFD waveform has higher harmonic content; the true RMS is genuinely 18 A. Cable
              at 20 A is on the edge — fine in steady state, but adds no margin for ambient
              temperature or grouping factors.
              <br />
              Action: trust the true-RMS reading, recalculate the cable using actual current (18 A ×
              derate factors) and probably upgrade one CSA. The standard meter has been lying for
              the whole survey.
            </>
          }
          whyItMatters={
            <>
              ...
              averaging meter under-reads. Cables and protection sized to the meter reading quietly
              run beyond their rating. True-RMS is the difference between a compliant install and a
              slow burn.
            </>
          }
        />
