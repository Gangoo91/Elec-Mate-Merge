...
const checks = [
  {
    ...
    options: ['0.034 Ω', '0.344 Ω', '0.172 Ω', '3.44 Ω'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    question: 'Two resistors in parallel: R1 = 6 Ω and R2 = 3 Ω. Total resistance is:',
    options: ['4.5 Ω', '2 Ω', '1.5 Ω', '9 Ω'],
    correctIndex: 1,
    explanation:
  ...
  {
    id: 'l3-m3-2-2-vdrop',
    question: 'A 32 A circuit, 6 mm² T&E, 25 m long, mV/A/m = 7.3. Voltage drop is:',
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'Three 30 Ω resistors in series. Total resistance:',
    options: ['60 Ω', '10 Ω', '90 Ω', '30 Ω'],
    correctAnswer: 2,
    explanation: 'In series, resistances add. 30 + 30 + 30 = 90 Ω.',
  },
  {
    id: 3,
    question: 'Three 30 Ω resistors in parallel. Total resistance:',
    options: ['60 Ω', '30 Ω', '90 Ω', '10 Ω'],
    correctAnswer: 3,
    explanation:
  ...
  {
    id: 5,
    question: "Kirchhoff's current law at a junction states:",
    options: [
  ...
  {
    id: 6,
    question: 'A 10 Ω resistor passes 5 A. Power dissipated is:',
  ...
  {
    id: 7,
    question: 'A 230 V supply across a 23 Ω element. Power dissipated:',
    options: ['10 W', '230 W', '5.3 kW', '2.3 kW'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['3 % of nominal', '5 % of nominal', '1 % of nominal', 'No limit'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          R = ρL/A. Series and parallel networks. Kirchhoff's laws. The voltage-drop formula behind
          every Appendix 4 cable size.
        </p>
        ...
        >
          ...
          <p>
            Watch the units: 2.5 mm² is 2.5 × 10⁻⁶ m². Forget that conversion and your answer is a
            million times wrong.
          </p>
        </ConceptBlock>
        ...
        <VideoCard
          ...
          caption={
            <>
              The Engineering Mindset walks Ohm's law and IR drops with worked examples — the same V
              = IR that drives the mV/A/m volt-drop formula in BS 7671 Appendix 4 covered later in
              this Sub.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Total resistance: R<sub>T</sub> = R₁ + R₂ + R₃ + …
            </li>
            <li>Same current through every resistor.</li>
            <li>
              Voltage across each: V<sub>n</sub> = I × R<sub>n</sub>.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              For two: R<sub>T</sub> = (R₁ × R₂) / (R₁ + R₂)
            </li>
            <li>Same voltage across every branch.</li>
            <li>
              Current through each: I<sub>n</sub> = V / R<sub>n</sub>.
            </li>
        ...
        >
          <p>Example: R₁ (10 Ω) in series with R₂ (6 Ω) which is in parallel with R₃ (12 Ω).</p>
          <p>Step 1 — simplify the parallel pair: R₂||R₃ = (6 × 12) / (6 + 12) = 72 / 18 = 4 Ω.</p>
          <p>
            Step 2 — add the series: R<sub>T</sub> = R₁ + 4 = 14 Ω.
          </p>
          <p>
            Now apply Ohm's Law to find total current. The voltage across the parallel pair is I ×
            4. The current then divides between R₂ and R₃ inversely with their resistance.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            (or algebraically: ΣI = 0, treating in and out as opposite signs).
          </p>
          <p>
        ...
        >
          ...
          <p>
            ...
            <br />V across 4 Ω = 4 V; V across 8 Ω = 8 V. Sum = 12 V = source. KVL satisfied.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>P = V × I</strong> — when you know V and I.
            </li>
            <li>
              <strong>P = I² × R</strong> — when you know I and R. (e.g. cable losses.)
            </li>
            <li>
              <strong>P = V² / R</strong> — when you know V and R. (e.g. heater on fixed supply.)
            </li>
          </ul>
          <p>
        ...
        >
          <p>
            <strong>
              V<sub>drop</sub> = (mV/A/m × I<sub>b</sub> × L) / 1000
            </strong>
          </p>
          <p>Where:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              mV/A/m = from BS 7671 Appendix 4 Tables 4D1–4J4 (depends on cable type and CSA).
            </li>
            <li>
              I<sub>b</sub> = design current (A).
            </li>
          ...
          <p>
            ...
            <br />V<sub>drop</sub> = (7.3 × 32 × 25) / 1000 = 5840 / 1000 = 5.84 V.
            <br />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              the consumer unit — so add submain drop on big installs. Equipment manufacturers may
              impose tighter limits; comply with whichever is stricter.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The 3 %/5 % design limits exist so the equipment terminal voltage never falls below
              what the appliance's product standard allows. Calculate V<sub>drop</sub> end- to-end
              and confirm that V<sub>terminal</sub> = V<sub>nom</sub> − V<sub>drop</sub>
              still sits within the appliance's accepted range, otherwise motors stall, LED drivers
              flicker and contactors chatter.
            </>
          }
          cite="Source: BS 7671:2018+A4:2026, Regulation 525.1."
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              they are the deemed-to-satisfy benchmark. Drop in mV/A/m × I × L / 1000 converts the
              table value to volts; that's the calc you owe BS 7671 in any schedule of tests or
              design pack.
            </>
          }
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              <br />
              Final 16 A radial in 2.5 mm² T&E (mV/A/m = 18), 15 m: V_drop = (18 × 16 × 15) / 1000 =
              4.32 V.
              <br />
              ...
              <br />
              But: lighting limit is 3 % = 6.9 V. Sub-main alone is already 5.48 V; lighting circuit
              drop must be &lt; 1.42 V. Check: 1 mm² T&E (mV/A/m = 44), 6 A, 12 m = 3.17 V → FAILS
              for lighting.
              <br />
