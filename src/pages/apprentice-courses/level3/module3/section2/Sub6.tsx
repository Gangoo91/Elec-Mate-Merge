...
const TITLE = 'Transient response — RC and RL time constants | Level 3 Module 3.2.6 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    id: 'l3-m3-2-6-rc-tau',
    question: 'A 100 μF capacitor charging through a 10 kΩ resistor. Time constant τ:',
  ...
  },
  {
    ...
    options: ['0.005 s', '50 ms', '5 s', '5 ms'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['37 %', '50 %', '63 %', '13 %'],
    correctAnswer: 0,
    explanation: 'V(τ) = V_0 × e⁻¹ = V_0 × 0.368. So 36.8 % left after one time constant.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    options: ['1', '2', '5', '10'],
    correctAnswer: 2,
    explanation: 'After 5τ, V ≈ 99.3 % of V_max — close enough to call it fully charged.',
  },
  {
    id: 7,
    question: 'What is the energy stored in a 470 μF capacitor charged to 100 V?',
    options: ['0.47 J', '47 J', '4.7 J', '2.35 J'],
    correctAnswer: 3,
    explanation: 'W = ½CV² = 0.5 × 470 × 10⁻⁶ × 10 000 = 2.35 J. Discharge through you would hurt.',
  },
  {
    id: 8,
    question: 'A capacitor across an AC contactor coil acts as a:',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          τ = RC, τ = L/R. Exponential charge and discharge. The maths behind contactor sparks, RCD
          trip timing and surge protection.
        </p>
        ...
        >
          ...
          <p>At t = τ: 63 % of I_max. At t = 5τ: ≈ 99 %.</p>
          <p>
            When the supply is removed, the current decays from I_0 toward zero through the same
            time constant — but only if there's still a path for the current. Open the circuit and
            the current has to drop to zero in nano-seconds, producing a huge dV/dt spike across the
            open contacts.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            Worked example: an LV solenoid coil L = 2 H carrying I = 0.3 A. Stored energy = 0.5 × 2
            × 0.09 = 0.09 J. Released as a 5 ms inductive transient = 18 W average power (small but
            capable of producing kilovolt spikes for microseconds — quite enough to kill a
            transistor or pit a contactor face).
          </p>
          <p>
            Compare to a contactor coil at 0.4 H and 12 mA: W = 0.5 × 0.4 × (0.012)² = 28.8 × 10⁻⁶ J
            = 29 μJ. Tiny — but if released as a 1 μs spike, average power = 29 W, and voltage = L ×
            di/dt = 0.4 × (0.012/10⁻⁶) = 4800 V. Energy is small; voltage and power density are
            large.
          </p>
          <p>
            That's why the size of a freewheel diode is set by AVERAGE current the diode has to
            freewheel, not peak voltage — the diode dissipates I²R in its forward voltage drop while
            the inductor energy decays. A 1N4007 (1 A continuous, 1000 V reverse) handles every
            relay coil under about 1 A.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DC inductive load:</strong> fit a freewheel diode in reverse-bias across the
              coil. When the switch opens, the diode forward-biases and lets the current circulate
              through the coil resistance until it dies. No back-EMF spike.
            </li>
            <li>
              <strong>AC inductive load:</strong> fit an RC snubber (typically 100 nF + 47 Ω) across
              the coil OR across the contacts. The cap absorbs the energy as the contacts open; the
              resistor limits the discharge current when they close.
            </li>
            <li>
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>RCD trip time</strong> — Type AC instantaneous trips in &lt; 40 ms at 1×
              rated; the residual current detection circuit has its own RC filter to ignore short
              transients (spec limits set in BS EN 61008).
            </li>
            <li>
              <strong>MCB magnetic trip</strong> — Type B 3-5× I_n; Type C 5-10×; Type D 10-20×.
              Trip is &lt; 100 ms but the breaker's electromagnet has an RL time constant
              determining minimum reliable tripping current.
            </li>
            <li>
              <strong>SPD response</strong> — Type 2 surge devices clamp in &lt; 25 ns. An MOV's
              parasitic inductance (~10 nH per terminal lead) limits how fast it can absorb energy.
            </li>
            <li>
              <strong>VFD DC bus</strong> — typical 3 kW drive has 1500 μF at 540 V (218 J stored).
              Internal bleeder via 50 kΩ → τ = RC = 75 s; to fall from 540 V to a safe 50 V takes t
              = τ × ln(540/50) = 75 × 2.38 ≈ 180 s (3 minutes). Always check with a meter.
            </li>
            <li>
              <strong>PFC bank</strong> — large industrial bank may need separate discharge
              resistors to bring voltage below 50 V within 1 minute (BS EN 60831-1).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              sub-microsecond rise times). The component RC and RL time constants determine how
              quickly the SPD can clamp the surge. BS 7671 §443 mandates SPDs in most new
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Transients and switching surges punish loose joints first — a high-impedance joint at
              a contactor terminal will arc, char and fail under repeated L·di/dt kicks. Reg 526.1
              demands the terminal selection take account of conductor class, CSA and the
              temperature reached at the terminal in normal service. Snubber circuits and SPDs only
              do their job when the joints they protect are sound.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              A4:2026 introduced 421.1.7 as a recommendation (not yet a hard requirement) for AFDDs
              in AC final circuits — exactly the kind of fault that loose connections, degraded
              snubbers and damaged cable sheaths produce. High-risk residential buildings (HRRBs)
              carry mandatory AFDD obligations via the Building Safety Act 2022. Where a final
              circuit feeds inductive loads through ageing terminations, AFDD is the right
              protective response.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>C</strong> ≈ I_load (in A) × 1 μF per ampere — typical 0.1–1 μF for control
              circuits.
            </li>
            <li>
              <strong>R</strong> ≈ V_supply / (10 × I_load) — typical 22–100 Ω for 230 V control.
            </li>
            <li>
              Cap voltage rating: ≥ 1.5 × peak supply voltage. For 230 V mains: ≥ 1.5 × 325 = 488 V
              → use 630 V class X1/X2 safety capacitor.
            </li>
            <li>
              Resistor power: I²R rating ≥ V × I × pf at the cycle rate — typically 0.25–1 W for
              control circuits.
            </li>
          </ul>
          <p>
            Worked example: 230 V AC contactor coil drawing 50 mA. Snubber C = 0.05 μF (50 nF); R =
            230 / 0.5 = 460 Ω → use 470 Ω. RC = 0.05 × 10⁻⁶ × 470 = 23.5 μs — fast enough to follow
            the contact-opening transient (typical contact-bounce gap closure ≈ 100 μs) while small
            enough to avoid affecting the steady-state coil current. Energy dissipated per cycle: ½
            × C × V² = 0.5 × 50 × 10⁻⁹ × 325² = 2.6 mJ → 0.13 W at 50 Hz. A 0.5 W resistor is fine.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type 1</strong> — at the supply origin. Handles direct lightning strike.
              Tested at 10/350 μs waveform, 25 kA per pole.
            </li>
            <li>
              <strong>Type 2</strong> — at the consumer unit. Indirect lightning and switching
              transients. 8/20 μs waveform, 20 kA per pole typical.
            </li>
            <li>
              <strong>Type 3</strong> — at the equipment. Final cleanup. 1.2/50 μs waveform, lower
              energy but tighter clamping.
            </li>
          </ul>
          <p>
            BS 7671 §443 mandates SPDs in most installations from A2:2022 onward unless a documented
            risk assessment shows they aren't required. The protection level Up (typically 1.5 kV
            for Type 2) sets what voltage gets through to downstream equipment — must be below the
            equipment's rated impulse withstand voltage Uw (typically 4 kV for Class III equipment).
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              terminals to check continuity. 540 V DC across 1500 μF caps stored 218 J. Hits them
              with their meter probes — flash-bang, meter destroyed, fingers burnt.
            </>
          }
          doInstead={
            <>
              ...
              <br />
              — Apply a discharge resistor (e.g. 1 kΩ 100 W) deliberately if the internal bleeder
              isn't fast enough.
              <br />— Treat capacitors as live until proven dead.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A 24 V DC relay coil (12 mA, 0.4 H) is switched by a transistor that fails every few
              hundred operations. The fault is the inductive spike on switch-off. Size a freewheel
              diode and explain why the existing RC snubber across the contacts isn't helping.
            </>
          }
          whatToDo={
            <>
              ...
              <br />
              Solution: 1N4007 diode in reverse across the coil (cathode to +, anode to coil). On
              switch-off, the diode forward-biases at 0.7 V, current decays through coil resistance
              with τ = L/R_coil ≈ 0.4/2000 = 0.2 ms. Transistor only sees 24 + 0.7 = 24.7 V — well
              within its rating.
              <br />
              The RC snubber across the contacts wasn't helping because there's no semiconductor
              switch in series with the coil — the snubber was protecting the wrong thing.
            </>
          }
          whyItMatters={
            <>
