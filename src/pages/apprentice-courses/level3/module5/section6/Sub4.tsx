...
const checks = [
  {
    ...
    options: [
      'BS 7671 is the statutory criminal law and EAWR is the non-statutory standard — a court tests compliance against BS 7671, with EAWR merely evidence of reasonable measures.',
      'They are the same document — EAWR 1989 is the legal title and BS 7671 is the trade name, so complying with one automatically satisfies the other.',
      'EAWR replaced BS 7671 when it came into force in 1989 — BS 7671 is now historic guidance and only EAWR has any legal standing for new electrical work.',
      'EAWR is statutory criminal law imposing duties for workplace electrical safety; BS 7671 is a non-statutory standard accepted as evidence of discharging the technical aspects.',
    ],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Installing a new circuit from the consumer unit to feed an outdoor socket in the garden — a new circuit is notifiable wherever it is installed.',
      'Replacing a damaged double socket-outlet like-for-like in a kitchen — repair work outside the special locations list, so it is NOT notifiable.',
      'Replacing a consumer unit in a domestic property — a full board change re-presents every circuit and is notifiable in its own right.',
      'Installing a new shower circuit and accessory in a bathroom — work in a special location creating a new circuit is notifiable.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'No notification is needed — only CPS-registered contractors must notify, so a non-member can carry out the work and issue the EIC with no further step.',
      'They borrow a CPS membership number from a registered colleague and upload the job under that account within 30 days of completion.',
      'Direct application to Local Authority Building Control before work starts, via a Building Notice or Full Plans submission, with LABC inspecting and certifying.',
      "They notify the DNO instead of Building Control, the DNO holding the supply records and authorising the work on the local authority's behalf.",
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'A duty to notify Building Control of every workplace electrical installation before it is energised, in the same way that Part P applies to dwellings.',
      'A duty that all systems shall at all times be of such construction as to prevent, so far as is reasonably practicable, danger.',
      'A duty to inspect and test every workplace installation to BS 7671 Part 6 every five years, retaining the report as evidence of compliance.',
      'A duty to provide every employee with the technical information needed to operate and maintain the installation, equivalent to BS 7671 Reg 132.13.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "The employer alone — EAWR places no duty on individual employees or self-employed workers, who are covered entirely by their employer's responsibilities.",
      'The building owner alone — once the installation is energised the whole EAWR duty passes to whoever owns the premises, and contractors carry none.',
      'Employers, employees and the self-employed — all three carry duties, with employees having a cooperation duty and the self-employed employer-equivalent duties.',
      'The Health and Safety Executive alone — EAWR duties rest with the regulator, which inspects and issues notices, the parties on site simply complying.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The Electricity at Work Regulations 1989 — Part P is the dwellings chapter of the EAWR, extending the workplace electrical-safety duty into the home.',
      'BS 7671 itself — Part P is one of the parts of the Wiring Regulations and is enforced through the IET rather than through legislation.',
      'The Health and Safety at Work etc. Act 1974 — Part P is a code of practice issued directly under the Act for all premises, workplace or dwelling.',
      'The Building Regulations 2010 (England) — Part P deals with electrical safety in dwellings, alongside Parts A, B, J, L, M and others.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 4,
    question:
      'A contractor finishes a notifiable job (CU swap) on a Friday and forgets to upload to NICEIC. They remember the following Friday — 7 days later. What happens?',
    options: [
      'They upload immediately — seven days is well within the 30-day window and the notification is routine, with the BCCC issued in due course.',
      'The notification is now too late — once a week has passed the work cannot be self-certified, and the contractor must make a retrospective LABC application.',
      'The EIC is invalidated by the missed week, so the contractor must re-test the installation and issue a fresh certificate before uploading.',
      'Nothing can be done — the 30-day window runs from when work begins, so a Friday-finished job must be uploaded that day or the right to notify is lost.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      'A customer wants you (a CPS-registered contractor) to do a kitchen rewire that includes new ring final, new lighting circuit and new shower circuit. The notification route is:',
    options: [
      'No notification is needed — a kitchen rewire is an alteration to existing circuits rather than new work, so an MEIWC alone covers it.',
      'Notify via your CPS within 30 days of completion, because the new circuits make it Part P notifiable in any room; the scheme issues the BCCC.',
      'Make a direct LABC application before starting, because new circuits cannot be self-certified and always require pre-work Building Control approval.',
      'Notify only the shower circuit, since it is in a special location; the ring final and lighting circuit are outside the notifiable list.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    id: 6,
    question:
      'Building Regulations Part L (energy efficiency) potentially affects electrical work how?',
    options: [
      'It does not affect electrical work at all — Part L covers only the building fabric (insulation, glazing, air-tightness), not what the electrician installs.',
      'It requires every new circuit to be RCD-protected for energy-saving reasons, because an RCD reduces standing leakage current and so wasted energy.',
      'Some electrical work (fixed lighting in new builds, certain controls and metering) falls within Part L as well as Part P, so the contractor confirms both.',
      'It sets the maximum cable size an electrician may use, capping conductor cross-section to limit the embodied carbon of copper in the installation.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 7,
    question:
      'Under EAWR, the consequence of a serious breach (e.g. a fatality from defective electrical work) can include:',
    options: [
      'A fixed penalty notice of up to £1,000 issued by Building Control, after which the matter is closed with no further action.',
      'A requirement to re-sit the relevant qualification and re-register with a Competent Person Scheme, but no criminal liability since EAWR is civil.',
      "Suspension of the contractor's scheme membership for a fixed period, with the work re-inspected by the scheme before membership is restored.",
      'Unlimited Crown Court fine, possible imprisonment, director disqualification and parallel civil claims, with reputational impact ending the business.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 8,
    question:
      'On a small commercial electrical job (workplace, not a dwelling), the notification position is:',
    options: [
      'Part P does NOT apply (it is dwellings-only); EAWR governs workplace safety, an EIC or MEIWC covers BS 7671, and no CPS upload is required.',
      'Part P applies in full and the work must be uploaded to a Competent Person Scheme within 30 days, exactly as it would be for a dwelling.',
      "No certification of any kind is required, because commercial installations fall outside both Part P and BS 7671 and rely on the client's safety policy.",
      'The work must be notified to the HSE before it starts, because all commercial electrical work is notifiable under the Electricity at Work Regulations.',
    ],
    correctAnswer: 0,
    explanation:
...
const faqs = [
  ...
  {
    question:
      'If I am a CPS member but my customer wants to engage me on a job in a brand-new build, do I still notify via the CPS?',
    answer:
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 6 · Subsection 4"
        title="EAWR, Building Regs reportable work, LABC vs CPS"
        backTo="/study-centre/apprentice/level3-module5-section6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The legal scaffold underneath the EIC — EAWR 1989 workplace electrical safety duty,
          Building Regulations Part P notifiable work scope (England), and the choice between CPS
          self-certification (NICEIC / NAPIT / ELECSA) and direct LABC notification.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 3 — persons on whom duties are imposed.</strong> Employers, employees and
              the self-employed all carry duties. Employers have the broad operational duties;
              employees have cooperation duties; self-employed have employer-equivalent duties when
            ...
            <li>
              ...
              reasonably practicable, danger. Construction here covers design, specification,
              installation and modification.
            </li>
            <li>
              <strong>Reg 4(2) — maintenance.</strong> All systems shall be maintained so as to
              prevent, so far as is reasonably practicable, danger. Periodic inspection (EICR) is
              the practical mechanism.
            </li>
            <li>
              <strong>Reg 4(3) — work activities.</strong> Every work activity, including operation,
              use and maintenance of a system, shall be carried out in such a manner as not to give
              rise, so far as is reasonably practicable, to danger. Safe-isolation procedures,
              working dead by default, lock-off, signage all sit here.
            </li>
            <li>
              <strong>Reg 13 — precautions for work on equipment made dead.</strong> Adequate
              precautions to prevent equipment becoming live while work is in progress — this is the
              regulatory home of the lock-off and warning notice routine.
            </li>
            <li>
              <strong>Reg 14 — work on or near live conductors.</strong> No person shall be engaged
              in work on or near any live conductor unless three conditions are met — unreasonable
              for it to be dead in the circumstances, reasonable for the person to be at work in
              those circumstances, and suitable precautions taken. Live work is the exception, not
              the rule.
            </li>
            <li>
              <strong>Reg 16 — competence.</strong> No person shall be engaged in any work where
              technical knowledge or experience is necessary unless they have such knowledge or
              experience or are under appropriate supervision. The competent person test that BS
              2391 / 2391-52 / 2365-03 / 2365-02 qualifications support.
            </li>
          </ul>
          <p>
            Each of these is a criminal duty. Breach is prosecuted by HSE (workplaces) or by the
            local authority HSE-equivalent for some sectors. Convictions sit on a corporate record
            indefinitely. The certification regime under BS 7671 is the industry mechanism for
            evidencing that the technical duties have been discharged.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 4 is the technical core of EAWR. Construction covers design and installation.
              Maintenance covers ongoing safe operation (EICR is the practical mechanism). Work
              activities cover the way you work (safe isolation, lock-off, competent persons). The
              phrase \"so far as is reasonably practicable\" is a defined legal test that requires
              duty-holders to weigh the cost / time / difficulty of a precaution against the risk it
              controls — not a blanket exemption but a structured judgement.
            </>
          }
        ...
        >
          ...
          <div className="hidden sm:block bg-[hsl(0_0%_10%)] border border-white/[0.08] rounded-xl p-4 text-[13px]">
            <div className="grid grid-cols-2 gap-3 text-white/90">
              ...
              <div>
                Like-for-like accessory replacement (e.g. damaged socket swapped for matching
                socket)
              </div>

              <div>Replacement of a consumer unit</div>
              <div>
                Repair work on existing circuits (e.g. re-terminating a loose connection, replacing
                a damaged cable section like-for-like)
              </div>

              <div>
                Addition or alteration of an existing circuit IN a special location (Section 701
                bathroom, swimming pool, sauna, etc.)
              </div>
              <div>
                Addition to an existing circuit OUTSIDE a special location (e.g. adding a socket to
                a kitchen ring; adding a light to a hall lighting circuit)
              </div>

              <div>
                Most non-trivial work in special locations — installation of accessories, alteration
                of zoning
              </div>
              <div>
                Maintenance work that does not alter the circuit (cleaning, lamp replacement, fuse
                replacement)
              </div>
            </div>
          </div>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Part P is the regulatory home of the dwellings electrical safety regime. The Approved
              Document defines the notifiable scope and the routes to comply (CPS self-certification
              or direct LABC). Non-notifiable work is still subject to BS 7671 (separate regime) and
              to the underlying duty in Part P that reasonable provision shall be made —
              non-notifiable does not mean unregulated, just that Building Control do not need to be
              told about it.
            </>
          }
        ...
        >
          ...
          <div className="hidden sm:block bg-[hsl(0_0%_10%)] border border-white/[0.08] rounded-xl p-4 text-[13px]">
            <div className="grid grid-cols-3 gap-3 text-white/90">
              ...
              <div className="text-elec-yellow/80 text-[11px] uppercase tracking-wide font-semibold">
                CPS self-certification
              </div>
              <div className="text-elec-yellow/80 text-[11px] uppercase tracking-wide font-semibold">
                Direct LABC application
              </div>

              <div>Who can use it</div>
              <div>
                CPS-registered contractors only (NICEIC, NAPIT, ELECSA, Stroma, Certsure, ECA, BSI
                etc.)
              </div>
              ...
              <div>
                POST-completion — within 30 days of job completion via the scheme online portal
              </div>
              <div>PRE-work — Building Notice or Full Plans application before work starts</div>

              <div>Per-job cost</div>
              <div>
                Modest scheme upload fee (single-digit pounds typically) plus annual scheme
                membership fee
              </div>
              <div>
                Substantial per-job application fee (often 100s of pounds), inspection fee, possible
                plans-checking fee
              </div>
              ...
              <div>
                Days to weeks depending on LABC workload — Building Notice gives a defined notice
                period before work can start
              </div>
              ...
              <div>
                CPS audits a sample of contractor notifications per year; assessment at scheme
                renewal
              </div>
              <div>
                LABC inspector reviews and checks during construction; design challenges possible at
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Part B — Fire safety.</strong> Emergency lighting, fire alarms, resistance to
              fire of cables passing through compartmentation, sleeving and penetrations. Often the
              dominant non-Part-P electrical Part on commercial work.
            </li>
            <li>
              <strong>Part L — Conservation of fuel and power.</strong> Minimum lamp efficacy,
              lighting controls, metering, EV charging in new builds, solar PV and battery storage
              requirements. Part L compliance often runs through the Energy Performance Certificate
              process for the building as a whole.
            </li>
            <li>
              <strong>Part M — Access to and use of buildings.</strong> Switch and socket heights,
              accessible isolators, controls reachable from wheelchair height, visual / audible
              signalling for the hearing or sight impaired in public buildings.
            </li>
            <li>
            ...
            <li>
              ...
              dwellings and commercial properties have minimum EV charging infrastructure
              requirements. Part S touches both the electrical installation and the building
              infrastructure.
            </li>
          </ul>
          <p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              to bring it to current standards). Your CPS audit catches the missing notification on
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              After an electrical fire on a workplace circuit you wired three years ago, the HSE
              inspector asks for evidence that you discharged your EAWR Reg 4(1) duty. Your defence
              is \"the work complied with BS 7671 — here is the EIC\". The HSE inspector accepts
              that as part of the evidence but reminds you that EAWR compliance is the legal test,
              not BS 7671 compliance per se. They look at the wider question: was the design
              appropriate for the workload, the location conditions, the foreseeable misuse? Was the
              inspection thorough enough? Was the EIC properly defensible? BS 7671 compliance is
              necessary but not always sufficient on its own.
            </>
          }
          doInstead={
            <>
              Treat BS 7671 compliance as the floor, not the ceiling. On workplace jobs think about
              the foreseeable use of the installation, the working conditions, the maintenance
              regime the duty-holder will run, the wider risk picture. The EAWR \"reasonably
              practicable\" test asks whether you took precautions proportionate to the risk —
              sometimes that is more than BS 7671 strict compliance, occasionally it is less (with
              documented reasoning). Document the reasoning. Keep the EIC clean. EAWR compliance is
              the legal target; BS 7671 is your standard route to it.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              certificate today because their remortgage closes tomorrow. Job is 8 circuits,
              single-phase TN-C-S, all RCBOs (Type A 30 mA), measured Ze = 0.30 Ω. You are NICEIC
              registered. The customer asks why you have to upload the EIC to NICEIC and wonders
              whether the EIC alone is enough for the lender.
            </>
          }
          whatToDo={
            <>
              <strong>Explain both regimes briefly.</strong> The EIC is the BS 7671 certification
              that the installation is technically safe and compliant. The Building Control
              Compliance Certificate is the Part P / Building Regulations evidence that the work has
              been notified to Building Control via your CPS (NICEIC). Two separate documents, two
              separate regimes, both required for a CU swap-out which is Part P notifiable.
              <br />
              <br />
              <strong>Confirm what the lender needs.</strong> Most lenders accept the EIC as
              evidence of \"current electrical certification\" — it is the document that confirms
              the electrical work is compliant. Some lenders also ask for the BCCC; if so, the
              customer can present the EIC plus the NICEIC notification reference number as evidence
              the BCCC is in process (it typically arrives by post 2-6 weeks after upload).
              <br />
              <br />
              <strong>Upload to NICEIC same day.</strong> Property address, customer name, type of
              work (\"Consumer unit replacement, owner-occupied dwelling\"), completion date today,
              scope description. Save the NICEIC notification reference to the job file. The 30-day
              window is generous but same-day upload removes any risk of the customer chasing the
              BCCC weeks later.
              <br />
              <br />
              <strong>Address the legal layer for the customer.</strong> Explain that this is the
              standard process — every CU swap goes through NICEIC notification. The certificate is
              dated today (no back-dating) and represents current certification per BS 7671 and
              current notification per Part P. The customer presents this to the lender; if the
              lender asks for the BCCC specifically, the NICEIC reference provides the bridge while
              the BCCC is in process.
              <br />
              <br />
              <strong>File contractor copy.</strong> Cloud storage with: design notes, EIC pack PDF,
              NICEIC notification reference, photos of the install, customer walk-through summary.
              Indefinite retention covers Limitation Act (6+ years), PI insurer requirements, and
              any future CPS audit sample.
            </>
          }
          whyItMatters={
            <>
              The legal layer underneath the EIC is what makes the work lawful, not just technically
              compliant. EAWR-equivalent diligence (here, Part P notification because this is a
              dwelling not a workplace) discharges the regulatory duty. BS 7671 compliance
              discharges the technical duty. The two together — EIC trio + BCCC via CPS upload —
              give the customer a complete defensible position for the remortgage today, the
              property sale in 5 years, the EICR in 10 years and any insurance interaction in
              between.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Operation and maintenance pack — isolation procedure, fault-finding flowchart,
              emergency contacts.
            </li>
            <li>
              Recommended next periodic inspection date with reminder in customer&apos;s calendar.
            </li>
        ...
        >
          <p>Common HSE prosecution patterns and lessons:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Live work without justification</strong> — EAWR Reg 14 requires dead-working
              unless live work is specifically justified; failing this is the leading prosecution
              route.
            </li>
            <li>
              <strong>Failure to notify under Part P</strong> — new circuits in dwellings notified
              late or not at all; the Building Control authority discovers and prosecutes.
            </li>
            <li>
              <strong>Inadequate isolation procedure</strong> — workers injured by an
              unexpectedly-live circuit they thought was isolated; investigation reveals no
              lock-off, no proving, no signed permit.
            </li>
            <li>
              <strong>Untrained worker</strong> — apprentice or general operative carrying out work
              outside their competence; EAWR Reg 16 prosecution against the supervising employer.
            </li>
            <li>
              <strong>Failed maintenance</strong> — fixed installation deteriorates, fault arises,
              injury follows; investigation finds no recent EICR and no maintenance plan.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Duty layers by site type:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pure-domestic owner-occupied</strong> — Consumer Protection Act, Defective
              Premises Act, tort. No EAWR.
            </li>
            <li>
              <strong>Private-rented domestic</strong> — above plus the Private Rented Sector
              Regulations 2020 (England) / equivalent; mandatory five-year EICR.
            </li>
            <li>
              <strong>Mixed-use</strong> — both layers; apply the strictest interpretation.
            </li>
            <li>
              <strong>Workplace</strong> — EAWR 1989, Health and Safety at Work etc Act 1974,
              Management of HSAW Regs 1999, CDM 2015 if construction.
            </li>
            <li>
              <strong>Public buildings</strong> — workplace plus public liability and licensing
              regimes; sometimes shorter EICR cycles per local authority licence.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Insurance interaction summary:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Buildings insurance</strong> — non-compliant installation can void a fire
              claim; customer's policy often requires evidence of recent EICR.
            </li>
            <li>
              <strong>Employer's liability</strong> — covers the firm against employee injury
              claims; safe-isolation evidence is the defence.
            </li>
            <li>
              <strong>Public liability</strong> — covers the firm against third-party injury or
              damage; clean documentation and visible signage is the defence.
            </li>
            <li>
              <strong>Professional indemnity</strong> — covers design or specification negligence;
              the design pack and departure log are the defence.
            </li>
            <li>
              <strong>Customer's home insurance</strong> — increasingly requires EICR currency;
              out-of-date or missing certificates can complicate a claim.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Section 514 (Identification and notices) of BS 7671:2018+A4:2026 has been updated with
              a number of significant changes. These changes affect requirements for identification
              and notices within the Wiring Regulations. Illustrations of notices that previously
              appeared in Section 514 have been removed; designers and installers shall use Appendix
              11 for examples of notices.
            </>
          }
          meaning={
            <>
              The customer&apos;s notices — periodic inspection notice, RCD test notice,
              emergency-isolation procedure — sit under Section 514 with example wording in Appendix
              11. The wording requirements are unchanged in substance; only the location of the
              example layouts has moved. Pre-A4 reference packs that point at Section 514
              illustrations should now point at Appendix 11.
            </>
          }
        ...
        <Quiz
          title="EAWR, Building Regs and notification routes — knowledge check"
