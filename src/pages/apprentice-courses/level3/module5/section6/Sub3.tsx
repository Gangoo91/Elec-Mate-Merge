...
const TITLE =
  'Commissioning paperwork chain — designer to customer | Level 3 Module 5.6.3 | Elec-Mate';
const DESCRIPTION =
      ...
      <HubBody>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              measured, RCD trip times, AFDD test results. The regulatory deliverable per Reg 642.4
              and Section 644.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Recommended maintenance schedule.</strong> Periodic checks the duty-holder
              should carry out — RCD test routine, visual checks, recommended EICR interval.
            </li>
            <li>
