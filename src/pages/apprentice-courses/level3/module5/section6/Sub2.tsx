...
const quizQuestions = [
  ...
  },
  {
    id: 5,
    question:
      'For non-CPS work (e.g. a contractor not registered with any scheme) on a Part P notifiable job, the notification route is:',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'The contractor uploads the EIC to NICEIC Online for a domestic CU swap completed today. Approximately when does the customer receive their Building Control Compliance Certificate?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'What if the customer wants me to email the EIC to their solicitor or lender directly?',
    answer:
  ...
  {
    question:
      'The customer says they do not want the EIC posted on the side of the CU because it looks untidy. What should I do?',
    answer:
  ...
  {
    question:
      'On a non-Part P notifiable job (e.g. like-for-like socket replacement), do I still need to issue an MEIWC?',
    answer:
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 6 · Subsection 2"
        title="Customer handover pack and scheme upload"
        backTo="/study-centre/apprentice/level3-module5-section6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The full evidence bundle the customer takes away — EIC trio, Building Control Compliance
          Certificate, operational instructions, as-built records, manuals — plus the 30-day
          Competent Person Scheme upload (NICEIC, NAPIT, ELECSA portals).
        </p>
        ...
        >
          ...
          <div className="hidden sm:block bg-[hsl(0_0%_10%)] border border-white/[0.08] rounded-xl p-4 text-[13px]">
            <div className="grid grid-cols-3 gap-3 text-white/90">
              ...
              <div>
                Top-level signed certification of the new work, visual checklist, per-circuit test
                readings
              </div>
              ...
              <div>
                Building Regulations Part P notification evidence — issued by the CPS after upload
              </div>
              <div>Property sale (solicitor request), Building Control queries</div>

              <div>Operational instructions</div>
              <div>
                Plain-English summary for the user — CU/isolator location, RCD test routine, what
                each label means
              </div>
              ...
              <div>
                Equipment-specific operation, fault codes, warranty terms, manufacturer test
                routines
              </div>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The Reg 132.1 framework is the design-side documentation requirement — the designer
              must determine and record the supply and installation information set out in Regs
              132.2–132.5 so that the design itself can demonstrate conformity with Regs
              132.6–132.16. On a domestic install this is typically the as-built circuit schedule
              inside the CU door plus the schedule attached to the EIC. On larger installations this
              extends to single-line diagrams, panel schedules and full cable books. The handover
              pack is the delivery vehicle for the Reg 132.1 documentation.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Customer copy.</strong> The duty-holder for the installation needs the full
              pack — printed at handover plus PDF for cloud filing. Lifetime retention from their
              side. Future scenarios that need it: any future EICR (next inspector compares current
              readings to your originals), property sale (solicitors increasingly request current
              EIC), insurance claim (proof of certification at time of incident), warranty claim on
              installed equipment.
            </li>
            <li>
              <strong>Contractor copy.</strong> File copy retained per Limitation Act (six years
              minimum for civil liability) and per professional indemnity insurer requirements
              (often 10-25 years). Per Competent Person Scheme audit (most CPSs require contractor
              retention for the duration of scheme membership plus a trailing period). Cloud storage
              of PDFs is now standard practice; physical paper-only filing is increasingly rare.
            </li>
            <li>
              <strong>Competent Person Scheme copy.</strong> Online upload within 30 days for Part P
              notifiable work in England. The scheme acts as the contractor's notification proxy to
              Building Control. Scheme then issues the Building Control Compliance Certificate to
              the customer at the property address (typically posted 2-6 weeks after upload).
            </li>
            <li>
              <strong>Building Control direct (non-CPS only).</strong> If the contractor is NOT
              registered with a CPS, notification goes direct to Local Authority Building Control
              before the work starts via a Building Notice or Full Plans application. LABC inspects
              and issues their own completion certificate. More expensive and slower than the CPS
              route — most contractors register with a scheme to avoid per-job LABC fees.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              schemes integrate with the major certification software products (ElecCert, EasyCert,
              ElectricalCertificateSoftware, the in-house Stroma software, the NICEIC Online tool).
              Generated PDF is what the scheme expects.
            </li>
            <li>
              <strong>Log in to the scheme portal.</strong> NICEIC Online (certsure.com), NAPIT
              eCert (napit.org.uk), ELECSA Online (elecsa.co.uk via the Certsure portal). Two-factor
              authentication standard.
            </li>
            <li>
              <strong>Enter the notification details.</strong> Property address, customer name, type
              of work (CU replacement, new circuit, special location work), completion date, scope
              description. Many schemes auto-populate from the uploaded EIC PDF using OCR.
            </li>
            <li>
              <strong>Pay the per-notification fee (where applicable).</strong> Some schemes bundle
              the fee into annual membership; others charge per notification. Typical per-job fees
              are modest — single-digit pounds per notification.
            </li>
            <li>
              <strong>Receive the upload confirmation.</strong> Scheme issues a unique notification
              reference. Save this to the job file in case the customer or Building Control queries
              it later.
            </li>
            <li>
              <strong>Building Control Compliance Certificate to the customer.</strong>
              Scheme prints and posts the BCCC to the customer at the property address. Typical lead
              time 2-6 weeks. Customer keeps this alongside the EIC for life of the installation.
            </li>
          </ol>
          <p>
            Set customer expectations on BCCC delivery at handover. Telling the customer that a
            separate document will arrive in the post 4 weeks later avoids the panicked follow-up
            phone call when they assume something was missed.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The 2013 Part P revision narrowed the notifiable scope. Notifiable work triggers the
              CPS upload requirement (or LABC direct route for non-registered contractors).
              Non-notifiable work still needs the EIC or MEIWC for BS 7671 purposes — the
              certification regime and the Part P notification regime are separate and only
              partially overlap. Always check the scope test before deciding whether the upload is
              required.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Location of the CU and main isolator.</strong> Where to go in an emergency to
              shut off the supply. Point at the main switch on the CU and the meter-side isolator
              (where fitted). Confirm the customer can identify both.
            </li>
            <li>
              <strong>RCD test routine.</strong> Demonstrate the test buttons on the RCBOs (or main
              RCDs on dual-RCD boards). Explain the monthly test routine — press the test button,
              the RCBO trips, reset by switching back on. Note that the test simulates a fault and
              confirms the device still trips correctly.
            </li>
            <li>
              <strong>Circuit labels.</strong> Walk the customer through the as-built circuit
              schedule on the CU door. Identify which circuit is which — kitchen ring, upstairs
              lights, shower, EV charger. Confirm any unusual labelling makes sense to them.
            </li>
            <li>
              <strong>New features the customer did not have before.</strong> SPDs (no customer
              action required, but explain they protect against lightning surge), AFDDs (test
              routine per manufacturer, typically a separate test button), smart switches with their
              own apps (hand over the manual and the app credentials).
            </li>
            <li>
              <strong>Recommended next inspection date.</strong> Confirm what is on the EIC —
              typically 10 years for owner-occupied domestic, 5 years for rented domestic under the
              Electrical Safety Standards in the Private Rented Sector regs. Suggest the customer
              puts a calendar reminder a few months before the date.
            </li>
            <li>
              <strong>Post-handover contact route.</strong> Hand over your card, mention your
              typical response window. Explain when to call versus when to deal with it themselves
              (e.g. RCD trip clears on reset = no need to call; persistent RCD trip = call).
            </li>
            <li>
              <strong>Building Control Compliance Certificate timing.</strong> Mention the BCCC will
              arrive separately by post from the scheme, typically 2-6 weeks after handover. This
              avoids the customer thinking it was missed.
            </li>
          </ul>
          <p>
            Five minutes done well. Customer feels in control of their new installation. Avoidable
            callouts evaporate. Recommendations arrive.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You finish a domestic CU swap in early March, hand over the EIC pack to the customer,
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You hand the customer a printed EIC at the end of a CU swap, say "all done", and
              leave. Two weeks later the customer calls in a panic — the upstairs ring has tripped
              and they cannot work out which switch to reset. They never noticed the CU door had a
              labelled circuit schedule. They cannot find the test buttons. They thought the BCCC
              would be inside the EIC pack and assume something was missed.
            </>
          }
          doInstead={
            <>
              Hand over the FULL pack — EIC trio, BCCC explanation, operational instructions,
              manuals, as-built schedule. Walk the customer through the new equipment for five
              minutes — CU and isolator location, RCD test buttons, circuit labels, any new
              features, when the BCCC will arrive. Five minutes saves an hour of follow-up calls and
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              tests pass; RCD trip times all within 22-35 ms. You are NICEIC registered. Customer is
              the homeowner, owner-occupied. The lender is likely to accept the EIC as evidence of
              "current electrical certification" but may also ask for the BCCC.
            </>
          }
          whatToDo={
            <>
              <strong>Compile the pack on site before you leave.</strong> Print the EIC, Schedule of
              Inspections and Schedule of Test Results from your certification software. Add the
              manufacturer manuals for the new RCBOs and any new accessories. Print or write the
              operational instructions sheet (CU location, main isolator, RCD test routine, monthly
              check, what to do in an emergency). Print or write the as-built circuit schedule and
              affix the small label sheet inside the CU door; include a full copy in the pack.
              <br />
              <br />
              <strong>Hand over with a five-minute walk-through.</strong> Show the customer the CU
              and main isolator. Demonstrate the RCD test buttons on two of the RCBOs and explain
              the monthly routine. Walk through the circuit labels. Explain the BCCC will arrive by
              post from NICEIC in 2-6 weeks. Hand over your card with the post-handover contact
              route.
              <br />
              <br />
              <strong>Email the PDF pack within the hour.</strong> Customer gets a redundant cloud
              copy. Confirm by email what you handed over physically.
              <br />
              <br />
              <strong>Upload to NICEIC Online same day.</strong> Property address, customer name,
              type of work ("Consumer unit replacement, owner-occupied dwelling"), completion date
              today, scope description. Save the NICEIC notification reference number to the job
              file. Set customer expectation that the BCCC will arrive by post within 2-6 weeks; in
              the meantime the EIC is the immediate evidence of certification for the lender.
              <br />
              <br />
              ...
              evidence the BCCC is in process. Most lenders accept this combination as sufficient
              interim evidence.
              <br />
              <br />
              <strong>File the contractor copy.</strong> Cloud storage with the customer pack PDF,
              the NICEIC notification reference, and any photos taken during the install (CU
              before/after, terminations, labels). Indefinite retention.
            </>
          }
          whyItMatters={
            <>
              ...
              any incident needs proof of certification at the time. Compile the pack carefully on
              the day of handover — every item has a forward use that you cannot easily go back and
              recreate.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Accessibility of test points (concealed conductors push toward larger sample of
            ...
            <li>
              Any specific concerns raised by the duty holder during the pre-inspection briefing.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>File retention obligations summary:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Six-year minimum</strong> — Limitation Act 1980; most contractor PI insurers
              require this as a baseline.
            </li>
            <li>
              <strong>Indefinite for some</strong> — heritage works, deed-of-grant work, where
              personal injury could conceivably arise.
            </li>
            <li>
              <strong>Cloud retention</strong> — firm's CRM or job system stores certificates,
              photos, test data; backups in a separate location for resilience.
            </li>
            <li>
              <strong>UK GDPR alignment</strong> — personal data kept only as long as needed, with
              the firm's published privacy notice setting customer expectations.
            </li>
            <li>
              <strong>Customer access</strong> — under UK GDPR, customers can request copies of
              their personal data; the firm responds within 30 days.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common upload pitfalls and prevention:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Mismatched circuit count</strong> — schedule shows 12 ways but certificate
              header says 14; the schemes reconcile and reject the inconsistency.
            </li>
            <li>
              <strong>Wrong supply system</strong> — TN-C-S vs TN-S vs PME vs PNB confusion; A4:2026
              introduced PNB terminology that older form templates may not match.
            </li>
            <li>
              <strong>RCD type</strong> — Type AC vs Type A vs Type B; A4:2026 mandates Type A or
              Type B for many circuits.
            </li>
            <li>
              <strong>Out-of-window submission</strong> — schemes reject submissions later than 30
              days from completion; the contractor falls back to direct LABC notification.
            </li>
            <li>
              <strong>Duplicate certificate</strong> — re-upload of an amended certificate without
              referencing the original rejected one; the scheme treats it as a new submission.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Customer-portal walkthrough at handover:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Account creation</strong> — typically pre-created by the firm; the customer
              activates with an email-link first login.
            </li>
            <li>
              <strong>Certificate download</strong> — show how to find the certificate, save the
              PDF, share it with a conveyancing solicitor or insurer.
            </li>
            <li>
              <strong>Next-inspection reminder</strong> — portal flags the date based on the
              certificate's recommended next inspection.
            </li>
            <li>
              <strong>Contact for follow-up</strong> — portal offers a 'request a visit' button that
              drops a job into the firm's booking system.
            </li>
            <li>
              <strong>Manufacturer app integration</strong> — for installations with smart devices,
              the portal links to the relevant manufacturer apps so the customer has all the
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              which it may be subjected. The results and recommendations of previous certificates
              and condition reports shall also be taken into account.
            </>
          }
          meaning={
            <>
              Frequency is professional judgement, not a rigid table. GN3 Table 3.2 gives starting
              points (10 years owner-occupied, 5 years rented domestic and commercial, 3 years
              industrial) but the regulation requires the inspector to weigh real-world factors and
              override the default where appropriate. Sample size moves with the same logic —
              high-use environments justify both shorter intervals and larger samples.
            </>
          }
        ...
        <Quiz
          title="Customer handover pack and scheme upload — knowledge check"
