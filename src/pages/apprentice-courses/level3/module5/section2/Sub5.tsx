...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      'Section 705 (agricultural / horticultural premises) supplementary bonding requirements:',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'Section 722 EV charging — PEN-fault protection where supplied from a PME source is achieved by:',
    options: [
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 2 · Subsection 5"
        title="Special locations visual checks"
        backTo="/study-centre/apprentice/level3-module5-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Visual inspection additions for Part 7 — bathrooms (701), pools (702), saunas (703),
          construction sites (704), agricultural (705), exhibitions (711), solar PV (712), EV
          charging (722) — zones, IP ratings, supplementary bonding.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              prohibited in zones (except BS EN 61558-2-5 shavers), supplementary bonding (or Reg
              701.415.2 omission).
            </li>
            <li>
              <strong>Section 702 — Swimming pools and fountains.</strong> Zones 0/1/2, IPX8 in Zone
              0, SELV / PELV at low voltages, supplementary bonding network.
            </li>
            <li>
              <strong>Section 703 — Sauna heaters.</strong> Heater zones 1/2/3, equipment for high
              temperature, isolation, IP rating.
            </li>
            <li>
            ...
            <li>
              ...
              Equipotential plane, supplementary bonding, IP rating for damp/dusty environment, EM
              compatibility considerations.
            </li>
            <li>
              <strong>Section 709 — Marinas and similar locations.</strong> Galvanic isolation, IP
              rating for berths, supply pillars, RCD requirements.
            </li>
            <li>
              <strong>Section 710 — Medical locations.</strong> Groups 0/1/2 by criticality, medical
              IT systems, 0.5 s changeover supply, equipotential bonding.
            </li>
            <li>
            ...
            <li>
              <strong>Section 715 — Extra-low voltage lighting installations.</strong> SELV / PELV
              source compliance, conductor selection for low-voltage / high-current loads.
            </li>
            <li>
              <strong>Section 722 — Electric vehicle charging installations.</strong> Type B RCD or
              Type A with integral 6 mA DC, PEN-fault protection on PME, dedicated circuit, local
              isolator.
            </li>
          </ul>
        </ConceptBlock>
...
(c) Protection against electric shock is provided by a device which electrically disconnects the vehicle from the live conductors of the supply and from protective earth in accordance with Regulation 543.3.3.101(b) within 5 s in the event of the voltage between the circuit protective conductor and Earth exceeding 70 V RMS due to an open-circuit fault in the PEN conductor of the low voltage network. The device need not operate if the voltage exceeds 70 V RMS for less than 4 s.`}
          meaning={
            <>
              The 70 V RMS / 5 s threshold is the prescriptive figure — NOT a "70 V to 250 V" range.
              On a PME supply a PEN failure can put diverted neutral current onto the vehicle
              chassis; the regulation forbids using PME as the EVSE earth unless either method (b) —
              a dedicated earth electrode sized so PEN-fault voltage stays under 70 V RMS — or
              method (c) — an O-PEN protection device that disconnects within 5 s if the
              CPC-to-Earth voltage exceeds 70 V RMS — is used. Method (a) was deleted by A2:2022.
              Visual inspection confirms which method is in use and that it matches the design.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Zone 0 — interior of bath / shower basin.</strong> IPX7 minimum (immersion).
              Equipment permitted: only fixed luminaires designed for Zone 0 (typically SELV at 12
              V). No sockets, no switches.
            </li>
            <li>
              <strong>
                Zone 1 — directly above Zone 0 to 2.25 m, plus the basin volume itself.
              </strong>
              IPX4 minimum (splash) — IPX5 if water jets used for cleaning. Equipment permitted:
              SELV/PELV at safe voltages; specific Zone 1 luminaires; instantaneous water heaters;
              whirlpool units; fixed luminaires complying with Section 701.55. No general sockets.
            </li>
            <li>
              <strong>Zone 2 — horizontal extension 0.6 m from Zone 1, to 2.25 m height.</strong>
              IPX4 minimum (IPX5 with water jets). Equipment permitted: as Zone 1 plus shaver supply
              units to BS EN 61558-2-5. Lighting fittings, heaters, fans permitted with the IP
              rating.
            </li>
            <li>
              <strong>Outside Zone 2.</strong> Unzoned space within the room. General sockets may be
              permitted (with 30 mA RCD additional protection per Reg 415.1.1) provided they are not
              within the zone areas defined.
            </li>
          </ul>
          <p>
            Visual inspection traces the zones on site (tape measure if needed), identifies each
            piece of equipment by zone, and confirms the IP rating against the zone requirement.
            Common defects: socket installed in Zone 2 (other than shaver supply), light fitting
            with insufficient IP rating, switch within Zone 1, no supplementary bonding where Reg
            701.415.2 conditions are not all met.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Dedicated final circuit.</strong> EVSE on its own circuit, not shared with
              general loads. Confirms cable sizing for the EVSE rating (typically 32 A, potentially
              40 A for higher-power units).
            </li>
            <li>
              <strong>RCD type matched to EVSE.</strong> Type B (handles smooth DC) OR Type A where
              the EVSE has integral 6 mA DC RCD per manufacturer documentation. Mismatched type =
              blinded protection.
            </li>
            <li>
              <strong>PEN-fault protection on PME.</strong> O-PEN device (commercially marketed
              PEN-fault detector inside or upstream of the EVSE) OR separate TT earth electrode for
              the EVSE. Visible at the install — either an O-PEN module in the EVSE / DB, or a
              separate TT electrode termination.
            </li>
            <li>
              <strong>Local isolator.</strong> Means of isolation accessible to user / engineer near
              the EVSE for safe maintenance.
            </li>
            <li>
              <strong>Cable management for the charging cable.</strong> Tethered or untethered; if
              tethered, the cable storage / protection from damage.
            </li>
            <li>
              <strong>Labels.</strong> Per Reg 514, including the EVSE rating, the supply origin,
              and any specific PEN-fault protection labels.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>AC isolation between inverter and consumer unit.</strong> Standard AC isolator
              at the inverter output for maintenance / fault response.
            </li>
            <li>
            ...
            <li>
              <strong>Earthing of array frame.</strong> Per the design — typically bonded to the
              customer earthing system. Confirms continuity to MET on dead testing.
            </li>
            <li>
            ...
            <li>
              <strong>Documentation and commissioning record.</strong> Per Section 712 and MCS
              requirements, the commissioning pack covering inverter setup, generation meter
              installation, G98 / G99 DNO notification.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              On the DC side of a PV array, devices without DC breaking capacity (SPD carriages,
              fuse carriers) must not be operable on-load — opening them under DC current produces a
              sustained arc that AC-only devices cannot clear. Visual inspection confirms such
              devices are inside a lockable enclosure, padlocked, or otherwise secured against
              unauthorised operation. A bare fuse carrier or unlocked SPD plug-in is a recordable
              defect on the DC side.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Inspector treats a domestic install as Sections 1-6 only. The property has a solar PV
              system and an EV charging point — both Part 7 locations. The Section 712 DC isolation
              and Section 722 PEN-fault protection are not on the inspection schedule. The EIC is
              signed without verifying these critical safety items. A later PEN failure causes a
              vehicle-chassis voltage rise; the inspector's EIC becomes evidence of inadequate
              verification.
            </>
          }
          doInstead={
            <>
              Before starting visual inspection, identify every Part 7 location that applies. Print
              the relevant section overviews. Add the location-specific items to your schedule (most
              schemes provide branded extension sheets for common locations). Tick / cross / N/A /
              LIM each item with comments. The general schedule plus the Part 7 additions = complete
              verification.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Equipotential plane in livestock areas.</strong> Steel mesh in floor bonded to
              the supplementary bonding network. Required where livestock are present — milking
              parlours especially.
            </li>
            <li>
              <strong>Supplementary bonding network.</strong> Connects exposed and
              extraneous-conductive-parts at floor level (cattle stalls, drinking water bowls, metal
              partitions, equipment frames) to the equipotential plane.
            </li>
            <li>
              <strong>RCD additional protection.</strong> 30 mA RCD on socket circuits and lighting
              in livestock areas; 100 mA delayed RCD on supply to address bulk fire protection.
            </li>
            <li>
              <strong>IP rating for damp / dusty environments.</strong> Typically IP65 or higher in
              milking parlours, IP54 in covered areas, IP44 in dry stores. Hose-down resistance
              often required.
            </li>
            <li>
              <strong>Equipment selection.</strong> Corrosion-resistant where livestock urine /
              effluent present. Covers and enclosures rated for the environment. Electrical fences
              on a separate dedicated supply.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DC isolation between array and inverter.</strong> DC-rated isolator,
              accessible for emergency disconnection, between PV array DC output and inverter DC
              input.
            </li>
            <li>
              <strong>AC isolation between inverter and consumer unit.</strong> Standard AC isolator
              at inverter output. Often a separate isolator near the inverter and at the CU.
            </li>
            <li>
              <strong>String / array configuration.</strong> Number of strings, number of modules
              per string, total array V_oc, V_mp, I_sc per module data. Compared to inverter input
              rating.
            </li>
            <li>
              <strong>DC cable selection.</strong> Cable rated for DC, UV-resistant where exposed
              (typically dual-insulated solar cable), MC4 connectors at array level.
            </li>
            <li>
            ...
            <li>
              <strong>Labels.</strong> "DANGER — DC LIVE DURING DAYLIGHT" at DC isolators. "PV ARRAY
              ON ROOF" at the supply intake / consumer unit. MCS / commissioning details.
            </li>
            <li>
              <strong>Inverter location and ventilation.</strong> Inverters generate heat; installed
              in well-ventilated locations, not enclosed in a sealed space without airflow.
            </li>
            <li>
              <strong>G98 / G99 DNO notification.</strong> For grid-connected systems, the DNO must
              be notified (G98 for systems up to 16 A per phase, G99 for larger). Visual inspection
              confirms documentation in the commissioning pack.
            </li>
            <li>
              <strong>Generation meter (where applicable).</strong> Required for some Smart Export
              Guarantee tariffs and for FiT (legacy systems).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              declaration. If TN-S or TT, the PEN-fault concern doesn't apply (TN-S has separate N
              and PE; TT has its own earth electrode).
            </li>
            <li>
              <strong>O-PEN device verification.</strong> Manufacturer marking, BS EN reference,
              operating voltage range (typically 159-253 V — disconnects supply if PEN voltage rises
              above this). Located in CU, near EVSE, or integrated within EVSE.
            </li>
            <li>
              <strong>OR TT earth electrode for EVSE.</strong> Separate buried earth electrode
              dedicated to the EVSE, with its own earthing conductor terminating at the EVSE chassis
              (not connected to the customer MET). Test link for periodic Ra retest.
            </li>
            <li>
            ...
            <li>
              <strong>Cable selection.</strong> Sized for the EVSE rating (typically 32 A — 6 mm²
              T+E or 4 mm² SWA depending on route). Outdoor-rated where exposed.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>First digit (solids).</strong> 0 = none. 1 = solids over 50 mm. 2 = over 12.5
              mm. 3 = over 2.5 mm. 4 = over 1 mm. 5 = dust-protected. 6 = dust-tight.
            </li>
            <li>
              <strong>Second digit (water).</strong> 0 = none. 1 = vertical drips. 2 = drips at 15°.
              3 = spray. 4 = splash. 5 = jets. 6 = powerful jets. 7 = immersion 1 m. 8 = continuous
              immersion. 9 = high-pressure / steam.
            </li>
            <li>
              <strong>Common ratings.</strong> IP20 = indoor, finger-touch protected. IP44 = splash
              resistant (Zone 2 bathroom, basic outdoor). IP55 = jet resistant (most outdoor). IP65
              = dust-tight + jets (harsh outdoor, washdown). IP67 = immersion- rated. IPX8 =
              continuous immersion (pool Zone 0).
            </li>
          </ul>
          <p>IK rating (impact resistance):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>IK ratings.</strong> IK00 (no impact testing) to IK10 (20 J — equivalent of 5
              kg dropped from 400 mm). IK07 (2 J) = car park bollard typical. IK10 = exposed /
              vandal-prone areas.
            </li>
            <li>
              <strong>When IK matters.</strong> Public areas, vehicle proximity, sports facilities,
              schools, anywhere with foreseeable impact. Visual inspection confirms IK selection
              matches use environment.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You are commissioning a 7 kW EV charger installed on a domestic driveway. The supply
              is PME (DNO declared). The EVSE is a Type 2 commercial unit with built-in Type A RCD
              and integral 6 mA DC RCD. The installation has no separate TT electrode. The
              contractor has fitted an O-PEN device upstream of the EVSE (in the consumer unit).
            </>
          }
          whatToDo={
            <>
              Visual inspection items: (1) Dedicated 32 A circuit from the CU — verify cable sizing
              (typical 6 mm² T+E or 4 mm² SWA depending on route and method). (2) RCD arrangement —
              Type A in the CU is acceptable because the EVSE has integral 6 mA DC RCD per
              manufacturer documentation. Verify the documentation. (3) PEN-fault protection — O-PEN
              device present, manufacturer literature confirms operating range (typically 159-253 V
              detection), labels in place. (4) Local isolator — rotary isolator next to EVSE, IP
              rating IP65 (outdoor exposed). (5) Earthing — EVSE chassis bonded to the customer
              earth via the CPC; no separate TT electrode needed because the O-PEN device provides
              the protection. (6) Labels — PEN-fault protection notice, EVSE identification at CU.
              All items tick on schedule.
            </>
          }
          whyItMatters={
            <>
              Section 722.411.4 has two valid solutions to the PME / EV problem — O-PEN device or
              separate TT earth electrode. The contractor chose O-PEN; the inspector verifies it is
              correctly installed and labelled. Get this wrong and the user is exposed to
              potentially fatal touch voltage on the vehicle chassis under PEN failure. The visual
              inspection is the gate.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              EV charging visual inspection now has to confirm one of the three accepted PEN-fault
              arrangements is in place — built-in detection in the unit, a TT electrode for the EV,
              or an upstream PEN-fault detection device. The &quot;not reasonably practicable&quot;
              exemption that some older installs relied on has been deleted.
            </>
          }
