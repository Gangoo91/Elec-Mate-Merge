...
const checks = [
  {
    ...
    options: [
      'Just one zone for the whole bathroom.',
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Be combined with the AC isolator.',
      'Only on commercial PV.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Allowed if RCD-protected.',
      'Allowed at any height.',
    ],
    correctAnswer: 1,
    explanation:
