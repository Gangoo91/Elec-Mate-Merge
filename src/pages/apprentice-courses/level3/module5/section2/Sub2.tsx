...
const checks = [
  ...
  },
  {
    ...
    question:
      'For a 25 mm² Cu PME supply tail, the minimum CSA of the main earthing conductor per Table 54.7 is:',
    options: ['6 mm² Cu.', '10 mm² Cu.', '25 mm² Cu.', '16 mm² Cu.'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      'Table 54.8 (main bonding conductor sizing) for a 35 mm² Cu PME supply tail requires a main bonding conductor of:',
    options: ['25 mm² Cu.', '10 mm² Cu.', '6 mm² Cu.', '16 mm² Cu.'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      'For a TT installation, the maximum acceptable Ra (earth electrode resistance) is governed by:',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'On an existing installation, you find the main earthing conductor is connected to the MET via a bolted connection that has corroded. Visual inspection records:',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'In a kitchen with a metal sink and metal water pipes, supplementary bonding to the sink is:',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The visual stage for the earthing and bonding arrangement — sizing tables, BS 951 labels,
          ADS arrangement (TN-S / TN-C-S / PNB / TT / IT), and the special location supplementary
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              supply terminal (TN-S, TN-C-S) or earth electrode (TT, IT). Sized per Table 54.7 (main
              earthing conductor) and Table 54.8 / Reg 543.1.4 (CPCs).
            </li>
            <li>
              ...
              voltages can appear on metalwork. Bonding ensures everything in the equipotential zone
              rises together — no dangerous voltage difference across the body.
            </li>
            <li>
              ...
              conductive parts within the location to each other, providing extra protection against
              shock from voltage differences in wet / restricted environments. Required in bathrooms
              unless Reg 701.415.2 omission criteria all met.
            </li>
          </ul>
          <p>
            Visual inspection of the earthing and bonding is methodical: identify the supply
            arrangement, find the MET, measure / verify each conductor sizing against the relevant
            table, check every connection for soundness and BS 951 labelling, follow
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              entering the building must be bonded at the MET — gas, water, oil, central heating,
              lightning, structural steel where it is in continuous contact with earth. Visual
              inspection works through the list, identifies what is present, confirms a bonding
              conductor of the correct CSA (Table 54.8) terminates from each within 600 mm of the
              point of entry where practical.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Inputs you need.</strong> Supply tail size (CSA in mm²), earthing arrangement
              (PME / TN-C-S non-PME / TN-S / TT). Conductor material (assume Cu unless stated).
            </li>
            <li>
              <strong>Common values.</strong> 16 mm² Cu PME tail gives main earthing 10 mm² Cu (or
              16 mm² Al). 25 mm² Cu PME tail gives main earthing 16 mm² Cu. 35 mm² Cu PME tail gives
              main earthing 16 mm² Cu (PME column flattens at this point). 70 mm² Cu PME tail gives
              main earthing 35 mm² Cu.
            </li>
            <li>
              <strong>Non-PME column.</strong> Slightly less stringent because no diverted neutral
              current — typically half the line CSA up to a 25 mm² minimum, then sized per Reg
              543.1.4 for larger.
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Common PME values.</strong> 16 mm² line gives 10 mm² bond. 25 mm² line gives
              10 mm² bond. 35 mm² line gives 16 mm² bond. 70 mm² line gives 25 mm² bond.
            </li>
            <li>
          ...
          <p>
            ...
            table, not memory or older copies. A4:2026 retained the Table 54.7 / 54.8 structure from
            previous editions but the supporting text was clarified.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Visual inspection checks every earthing connection against the four-part Reg 542.4.2
              test: sound (tight, intact, correct termination type), protected (no mechanical risk,
              no corrosion exposure), accessible (test link present at MET), labelled (BS 951 per
              Reg 514.13.1). Failure on any one is a cross / non-compliance.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>TN-S.</strong> Supply with separate N and PE conductors. The DNO supplies a
              dedicated earth — usually via the cable armour or a separate earth conductor. Customer
              earthing connects to the DNO earth terminal at the intake. Ze typically 0.1-0.8 ohm.
            </li>
            <li>
              <strong>TN-C-S (PME).</strong> Supply combines N and PE upstream (PEN). The DNO bonds
              N to earth at multiple points on the network, including at the supply transformer.
              Customer earthing connects to the DNO supply terminal — which is the PEN. The customer
              side has separate N and PE (the C-S of TN-C-S). Ze typically 0.1-0.35 ohm.
            </li>
            <li>
              <strong>TN-C-S (PNB).</strong> Same TN-C-S topology, but the N-E bond is performed by
              the customer at the intake — not by the DNO on the network. Visible as a customer-side
              N-E link in the intake enclosure. A4:2026 formalised this designation.
            </li>
            <li>
              <strong>TT.</strong> Customer provides their own earth electrode — the DNO supplies
              only L and N. The customer earthing connects to a buried electrode, an earth rod, an
              earth mat, or a foundation earth electrode. Ze (Ra) typically 20-200 ohm. Requires RCD
              as the primary disconnection device for fault protection.
            </li>
            <li>
              <strong>IT.</strong> Source is isolated from earth (or earthed via high impedance).
              Used in specific industrial / medical applications where first-fault continuity of
              supply is critical. Rare in UK general installations.
            </li>
          </ul>
          <p>
            Visual inspection records the arrangement at the head of the EIC and against the
            schedule sections that depend on arrangement (e.g. main bonding presence is relevant to
            all; electrode test link is relevant only to TT; PEN bond verification is relevant only
            to TN-C-S).
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Inspector ticks PME by default for any TN-C-S install. The actual arrangement is PNB —
              customer-side N-E bond. The EIC is wrong, and the maintenance responsibilities
              recorded against the install are misattributed. Future inspectors base their
              assumptions on the EIC and may not check the bond integrity that the customer is
              actually responsible for maintaining.
            </>
          }
          doInstead={
            <>
              Look at the intake. If you see a customer-side N-E link inside the customer enclosure
              (often a strap between the neutral bar and the earth bar in the supply head or origin
              distribution), it is PNB. If the bond is upstream of the customer meter and inside the
              DNO sealed enclosure, it is PME. The DNO declaration on file also confirms. A4:2026
              added the PNB designation row — use it.
            </>
          }
        />
        ...
        >
          <p>
            Reg 701.415.2 omission of supplementary bonding in a Section 701 location requires ALL
            three of:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>(a) All circuits comply with disconnection times.</strong> Verified at live
              testing (Zs at or below Table 41.3 max for the circuit).
            </li>
            <li>
              <strong>
                (b) All circuits supplying the location have additional protection by 30 mA RCD.
              </strong>{' '}
              Visual confirms RCD presence and rating; live test confirms trip time (A4:2026
              simplified — single AC test at 1 times IΔn under Reg 643.7.3, must operate within 300
              ms).
            </li>
            <li>
              <strong>
                (c) All extraneous-conductive-parts of the location are connected to the main
                earthing terminal.
              </strong>{' '}
              Visual confirms the MET bonding for the relevant pipework / structure / heating
              elements.
            </li>
          </ul>
          <p>
            If any one condition fails, supplementary bonding remains required. On EICR this often
            shows up as old houses where supp bonding was correctly installed but has since been
            disturbed (e.g. removed during a kitchen refit, lost when a copper pipe was replaced
            with plastic, broken at a connection). Cross with remediation recommended.
          </p>
          <p>
            ...
            Section 711 (exhibitions), etc. Each section has its own zone definitions and bonding
            requirements. Visual inspection adds the relevant Part 7 items where the location
            applies.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The omission is conditional on all three being verified. Visual inspection confirms
              RCD presence and bonding to MET. Live testing confirms disconnection times. If you
              record an omission of supplementary bonding without verifying all three, the EIC is
              unsupported. On EICR, missing supp bonding where any condition fails is C2
              (potentially dangerous in a wet location).
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              armour or a separate green/yellow conductor from the DNO. Customer earthing conductor
              terminates at this dedicated earth terminal. Ze typically 0.1-0.8 Ω.
            </li>
            <li>
              <strong>TN-C-S (PME).</strong> The combined PEN at the supply head. Customer earthing
              conductor terminates at the supply neutral terminal — which is also the earth on PME.
              The PEN is bonded to earth multiple times on the DNO network. Visible: no separate
              earth terminal at the supply head; customer connects to the neutral terminal.
            </li>
            <li>
              <strong>TN-C-S (PNB).</strong> Same topology but the customer bonds N to E at the
              intake. Visible: a customer-side N-E link inside the customer enclosure (often a bar
              or strap between the neutral block and the earth block at the origin distribution).
            </li>
            <li>
              <strong>TT.</strong> Customer's own earth electrode — typically an earth rod driven
              into the ground, a foundation electrode, or an earth mat. Connection at the MET via a
              test link to permit periodic Ra retest. Inspection pit / marker ideally above the
              buried electrode for future access.
            </li>
            <li>
              <strong>IT.</strong> Source isolated from earth. Specialised — medical Group 2, some
              industrial. Visible: monitoring equipment and / or earthing transformer at the source.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Conductor sized per Table 54.8.</strong> Measure or compare against the supply
              tail size. Common defect: 6 mm² where Table 54.8 requires 10 mm² for 25 mm² PME tail.
            </li>
            <li>
              <strong>BS 951 label present and legible.</strong> "Safety Electrical Connection — Do
              Not Remove". Check on every required connection.
            </li>
            <li>
              <strong>Termination clamp appropriate.</strong> BS 951 clamp for pipework (gas /
              water). Crimped lug or terminated in approved enclosure for structural metal. Plumbing
              band clip is not a bonding clamp.
            </li>
            <li>
              <strong>Connection sound.</strong> Tight, no corrosion, no movement.
            </li>
            <li>
              <strong>Routing sensible.</strong> Conductor protected from mechanical damage, not run
              through gas / fuel pipes' close vicinity, not subject to tension or strain.
            </li>
            <li>
              <strong>Within 600 mm of point of entry where practical (Reg 411.3.1.2).</strong>
              Bond should be installed close to where the service enters the building, before any
              branches or fittings.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>The PEN failure mode.</strong> A break in the combined PEN conductor upstream
              of the customer (in the supply cable or at a joint). The customer's earthing system
              suddenly becomes the only return path for normal load current.
            </li>
            <li>
              <strong>Current magnitude.</strong> In a small domestic install, the diverted current
              could be 30-80 A. In larger commercial, hundreds of amps. The conductors must safely
              carry this without overheating or damaging insulation.
            </li>
            <li>
            ...
            <li>
              ...
              during a PEN failure could be exposed to fatal voltage. Section 722.411.4 addresses
              this with O-PEN devices or TT earthing for the EVSE.
            </li>
          </ul>
          <p>
            The Table 54.7 / 54.8 PME columns are sized conservatively to handle diverted neutral
            current safely. Visual inspection enforces these by measuring conductor sizes against
            the table.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Presence at MET.</strong> Removable link between earthing conductor and MET
              busbar / terminal. Most modern installations have a link; older installations may not.
            </li>
            <li>
            ...
            <li>
              <strong>Mechanical integrity.</strong> Link is solidly attached, fasteners tight, no
              corrosion compromising the joint.
            </li>
            <li>
              <strong>Identification.</strong> "Earth — do not remove" or similar warning at the
              link, distinct from the BS 951 label which goes on the bonding conductor connection
              itself.
            </li>
            <li>
              <strong>TT-specific — accessible electrode.</strong> Earth electrode accessible for
              visual inspection where reasonably practical (inspection pit / marker above the buried
              rod). Buried electrodes per Reg 542.4 exception don't need accessibility but should be
              at known location.
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You are doing a periodic on a 1990s domestic install. The bathroom has a metal bath,
              metal towel rail, copper hot/cold pipes, and a metal-bodied shower. Visual inspection
              finds main bonding to gas and water at the MET (16 mm² Cu, BS 951 label, sound). The
              bathroom circuits are RCBO-protected at 30 mA. But the supplementary bonding cable
              that used to link the towel rail to the pipework has been disconnected — the conductor
              is hanging loose with no termination. Reg 701.415.2 conditions: Zs and disconnection
              times will be verified at live test; RCDs are present at 30 mA; the towel rail is
              metal and is potentially in continuous contact with the metal radiator pipework — but
              the lost supp bond breaks the equipotential path within the location.
            </>
          }
          whatToDo={
            <>
              Record on the schedule: supplementary bonding (Reg 701.415.2): cross. Comment:
              disconnected supplementary bond observed at towel rail in Section 701 zone. Reg
              701.415.2 omission criterion three cannot be verified as met — recommend reinstatement
              of supplementary bonding to all extraneous-conductive-parts within the location, OR
              full verification by testing extraneous-conductive-part continuity to MET. Code C2 on
              EICR (potentially dangerous — Section 701 wet location, bonding integrity not
              assured). Photograph the loose conductor.
            </>
          }
          whyItMatters={
            <>
              Section 701 is a wet location — body resistance is reduced when wet, touch voltage
              limits are stricter. Supplementary bonding equalises potential within the location so
              even during a fault before the RCD trips, the user is not exposed to dangerous voltage
              differences across body parts. A disconnected supp bond removes that protection layer.
              The RCD still works — but the layered defence the location requires is compromised.
            </>
          }
        />
