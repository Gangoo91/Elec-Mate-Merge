...
const checks = [
  {
    ...
    question:
      'For a circuit feeding a single-phase EV charger or modern variable-speed drive, the appropriate RCD type is:',
    options: [
  ...
  },
  {
    ...
    question:
      'A consumer unit MCB is marked Icn = 6 kA. The PFC measured at the origin is 8 kA. The visual inspection records:',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 4,
    question:
      'Per Reg 443.4.1, transient-overvoltage (SPD) protection is required where the consequence of the overvoltage could result in:',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'Per A4:2026 Reg 132.13, the documentation that must be made available with the installation includes:',
    options: [
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 2 · Subsection 3"
        title="Protective device inspection"
        backTo="/study-centre/apprentice/level3-module5-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Visual inspection of overcurrent devices, RCDs, AFDDs and SPDs — type matched to duty,
          breaking capacity matched to PFC, A4:2026 additions, and the labelling / accessibility
          requirements.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BS EN 60898 — MCB.</strong> Up to 125 A. Curve types B (3-5 In), C (5-10 In),
              D (10-20 In), K (8-12 In), Z (2-3 In). Domestic and small commercial. Icn typically 6
              kA or 10 kA.
            </li>
            <li>
              <strong>BS EN 61009 — RCBO.</strong> Combined MCB + RCD per circuit. Same MCB curves
              as BS EN 60898. RCD characteristic per the type marking (AC / A / F / B).
            </li>
            <li>
              <strong>BS EN 60947-2 — MCCB / ACB.</strong> Industrial moulded case / air
              circuit-breakers. Higher ratings, adjustable trip characteristics, often replaceable
              trip units.
            </li>
            <li>
              <strong>BS 88 — HRC fuses.</strong> High-rupture-capacity fuses. Used at supply origin
              (DNO cut-out fuse), in busbar trunking, and in industrial distribution. Defined
              characteristic per the manufacturer time/current curve.
            </li>
          </ul>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Visual inspection records the device standard reference (BS EN 60898 MCB, BS EN
              60947-2 MCCB, BS EN 61009-1 RCBO, BS 88 fuse). When the installed device is one of
              these standard types, satisfying In ≥ Ib and In ≤ Iz automatically satisfies the I2 ≤
              1.45 × Iz overload coordination rule — which is why these standards dominate UK
              practice. A non-listed protective device (or a BS 3036 semi-enclosed fuse) needs the
              additional 0.725 × Iz check from 433.1.202.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Type A.</strong> Detects AC + pulsating DC residual current. Suitable for most
              modern domestic and commercial circuits including general lighting and socket circuits
              with mixed electronic loads.
            </li>
            <li>
              <strong>Type F.</strong> Detects AC + pulsating DC + mixed frequencies up to about 1
              kHz. Designed for circuits with single-phase variable speed drives, modern appliances
              with inverter motors (washing machines, fridges, induction hobs).
            </li>
            <li>
              <strong>Type B.</strong> Detects AC + DC (smooth) + mixed frequencies. Required where
              smooth DC residual current can occur — three-phase VFDs, certain EV chargers (Mode 3
              without integral 6 mA DC RCD), three-phase rectifiers, some PV inverters.
            </li>
          </ul>
          <p>
            Visual inspection confirms the type marking on each RCD / RCBO matches the design intent
            for the load. A consumer unit feeding a heat pump and an EV charger but fitted with all
            Type AC devices is a documentation issue (not what the design says) and a safety issue
            (smooth DC fault could go undetected).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The selection duty sits on the designer but visual inspection verifies it. Where the
              load can produce DC fault current and the installed RCD is Type AC or Type A, that is
              non-compliant unless manufacturer documentation confirms compatibility (e.g. an EVSE
              with integral 6 mA DC RCD allows upstream Type A use). Cross on schedule, C2 on EICR
              for safety-critical mismatch.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Presence on circuits where design specifies.</strong> The design documentation
              should identify which circuits get AFDDs. For HRRBs, all final circuits typically. For
              non-HRRB installations following the A4 recommendation, often bedrooms, circuits with
              concealed wiring in combustible structure, circuits feeding hard-to-reach loads.
            </li>
            <li>
              <strong>Standard — BS EN 62606.</strong> The marking must show this standard.
            </li>
            <li>
              <strong>Type — typically combined RCBO + AFDD.</strong> Visual confirms the combined
              device provides both fault types in one unit.
            </li>
            <li>
              <strong>Test button operation.</strong> Pressed at commissioning to confirm healthy.
              Some AFDDs have status LEDs that should show normal operation.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              strike), Type 2 (overvoltage limiter for indirect strike / switching surges), Type 1+2
              combined. Domestic typically Type 2 or 1+2. Commercial / public services typically
              Type 1+2 or Type 1 + Type 2 cascaded.
            </li>
            <li>
              <strong>Status indicator.</strong> Most SPDs have a window or LED showing healthy /
              failed. Visual confirms healthy.
            </li>
            <li>
              <strong>Upstream protection.</strong> SPDs require upstream overcurrent protection per
              the manufacturer's specification (usually 32 A or 63 A fuse / MCB). Visual confirms
              presence and rating.
            </li>
            <li>
              <strong>Position.</strong> At or near origin, downstream of main switch, upstream of
              distribution. For sub-distribution, additional Type 2 or Type 3 SPDs may be installed
              near sensitive equipment per the design.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Inspector sees an RCD on a circuit, ticks the schedule, moves on. Type AC was fitted
              by an installer who used what was on the van. The circuit feeds a heat pump with a
              single-phase inverter. Smooth DC fault current under fault would blind the Type AC.
              The protection is theoretical, not actual.
            </>
          }
          doInstead={
            <>
              ...
              installed on a circuit needing higher type, cross on schedule, recommend replacement,
              code C2 on EICR if safety is materially compromised.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              banks, small motors, transformers up to a few kVA, computer / IT loads with moderate
              inrush.
            </li>
            <li>
              <strong>Type D (10-20 In).</strong> Heavy inductive loads. Large transformers, X-ray
              equipment, welding equipment, large motors with high starting current, discharge
              lighting.
            </li>
            <li>
              <strong>Type K (8-12 In).</strong> Industrial — high inductive loads where Type C is
              insufficient. Less common in UK domestic / commercial.
            </li>
            <li>
              <strong>Type Z (2-3 In).</strong> Sensitive electronic loads where fast trip is
              preferred. Less common — typically replaced by RCBO with appropriate characteristic.
            </li>
          </ul>
          <p>
            Implication for Zs: Type B has the highest tabulated max Zs for a given current rating
            (lowest fault current required to trip in 0.4 s), Type C lower, Type D lower still.
            Visual inspection of the curve marking ties to the Zs comparison from Table 41.3.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>CU enclosure material.</strong> Steel sheet, aluminium, or composite material
              that meets the non-combustible test (per the regulation). Plastic enclosures don't
              comply for new installs.
            </li>
            <li>
              <strong>Existing plastic CUs.</strong> Compliant when installed if pre-2016. On EICR,
              code depends on location and risk: C3 (improvement recommended) typical; C2
              (potentially dangerous) where the CU is in an escape route, near combustible
              materials, or in a vulnerable location.
            </li>
            <li>
              <strong>Compromised metal CUs.</strong> Holes drilled through the enclosure for cable
              entry that aren't sealed, gland plates removed, missing hole grommets — all compromise
              the fire containment.
            </li>
            <li>
              <strong>Mounting environment.</strong> CUs near combustible cladding, in airing
              cupboards with combustible material adjacent, in escape routes — all elevate the risk
              profile and may push C3 to C2 on EICR.
            </li>
            <li>
              <strong>Alternative compliance.</strong> A plastic CU enclosed in a separate
              non-combustible cabinet meets the regulation. Visible as a metal cabinet surrounding
              the original CU.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              impulse waveform from direct lightning strike. Installed at origin where direct strike
              is plausible (buildings with lightning protection systems, isolated buildings, public
              services).
            </li>
            <li>
              <strong>Type 2.</strong> Overvoltage limiter. Handles 8/20 µs impulse from indirect
              strike, switching surges. Standard at origin for most non-rural installations. Or
              downstream of Type 1 in a cascaded arrangement.
            </li>
            <li>
              <strong>Type 1+2 combined.</strong> Single device handling both. Common on domestic
              and small commercial origin where both protections needed in one unit.
            </li>
            <li>
            ...
            <li>
              <strong>Status indicator.</strong> Window or LED on every SPD showing healthy (green)
              / replace (red). End of life of the MOV / GDT components after sufficient surges
              absorbed.
            </li>
            <li>
              <strong>Upstream protective device.</strong> Per manufacturer specification —
              typically 32 A or 63 A fuse / MCB upstream of the SPD. Clears any internal SPD failure
              without disrupting the rest of the installation.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              trigger the trip mechanism. Confirms the detection coil, electronic comparator, and
              trip mechanism all function. Does NOT confirm the actual IΔn threshold or trip time.
            </li>
            <li>
              <strong>RCBO test button.</strong> Same as RCD — tests the residual-current side of
              the device. The overcurrent (MCB) side does not have a user test button — tested via
              the actual fault current at commissioning if at all (Type-test certified at
              manufacture).
            </li>
            <li>
              <strong>AFDD test button.</strong> Initiates a self-test routine that simulates the
              arc signature the device looks for. Some AFDDs perform automatic periodic self-test in
              addition to the manual button.
            </li>
            <li>
              <strong>Customer routine.</strong> Quarterly user testing recommended — press, observe
              trip, reset. Demonstrates ongoing function. After significant electrical events
              (lightning, surge, fault) re-test to confirm no damage.
            </li>
            <li>
              <strong>Commissioning record.</strong> Document button operation on the Schedule of
              Test Results. Many schemes require this confirmation alongside the instrument- tested
              trip time.
            </li>
            <li>
              <strong>Periodic instrument testing.</strong> Reg 643.7.3 — single AC test at 1×IΔn
              under A4:2026. The test button is for routine user check; the instrument test is for
              verification record.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You are doing an EICR on a 2020 domestic install. The CU is plastic-bodied (pre-Reg
              421.1.201 enforcement), all MCBs are 6 kA, the RCDs are Type AC. You measure PFC at
              the origin — 9.5 kA. The DNO has reinforced the local network since the install,
              raising PFC. The original install was compliant at 6 kA. Today it is not.
            </>
          }
          whatToDo={
            <>
              Document multiple findings on the EICR: (1) Reg 421.1.201 — plastic CU enclosure, C3
              improvement recommended unless local risk factors elevate to C2 (e.g. CU in an escape
              route). Recommend metal-clad replacement or non-combustible enclosure. (2) Reg 432.1 —
              6 kA devices on 9.5 kA PFC, C2 potentially dangerous. Devices cannot reliably clear a
              fault. Recommend upgrade to 10 kA. (3) Reg 531.3.3 — Type AC RCDs on circuits
              potentially feeding inverter loads (check appliances), C3 improvement recommended
              unless safety-critical, C2 if so. Document, photograph each finding, prioritise C2
              items for early remediation, agree with duty holder.
            </>
          }
          whyItMatters={
            <>
              A periodic catches changes in the operating environment that the original install
              could not foresee — DNO PFC rising, load profile changing, regulations advancing. The
              duty holder needs the EICR to surface these so they can act. Suppressing the findings
              to keep the report clean is a Reg 4 EAWR breach in waiting.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Visual inspection should now identify whether AFDDs are fitted on AC final circuits
              and record their absence as a recommendation when the installation is in the
              &quot;should consider&quot; category. AFDDs are recommended (Reg 421.1.7) in high-rise
              residential buildings via the Building Safety Act 2022 framework — verify the building
              category before deciding whether absence is a C3 (improvement) or higher coding.
            </>
          }
