...
const checks = [
  ...
  },
  {
    ...
    options: [
      'Acceptable — MCBs are always rated for any PFC.',
      ...
      'Acceptable if the customer agrees.',
      'Test the RCD instead.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Only socket outlets in a kitchen.',
  ...
  },
  {
    ...
    options: [
      ...
      'Only when the customer requests.',
    ],
    correctAnswer: 1,
    explanation:
