...
const TITLE =
  'Visual inspection — scope, sequence and the Schedule of Inspections | Level 3 Module 5.2.1 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  {
    id: 1,
    question:
      'During visual inspection of a new domestic CU change you find the main earthing conductor sized at 10 mm² but the supply tails are 25 mm² PME. Per Table 54.7, this is:',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'A consumer unit is installed in a domestic property less than 0.5 m above floor level in a hallway. The visual inspection should record:',
    options: [
  ...
  },
  {
    id: 4,
    question:
      "The Schedule of Inspections section header 'Methods of protection against electric shock' would include items such as:",
    options: [
  ...
  },
  {
    id: 5,
    question:
      'You arrive on site for an EICR. The original drawings are missing and the previous EIC is not available. Your visual inspection must:',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'Identification of conductors per Reg 514.3 includes which colour for L1 of a three-phase TN-S supply?',
    options: ['Red.', 'Grey.', 'Black.', 'Brown.'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 8,
    question:
      'During visual inspection of a TT installation, the earth electrode is buried with no inspection pit and no test link at the MET. The correct response is:',
    options: [
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/level3-module5-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The structured first stage of initial verification — Reg 642.3 items, the Appendix 6
          Schedule, and the methodical sequence that catches the easy issues before instruments come
          out.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Visual (Reg 642).</strong> Catches defects visible to the eye and to tactile
              checks — connections, labels, mounting, zoning, identification. No instruments needed.
            </li>
            <li>
              <strong>Dead testing (Reg 643).</strong> Continuity, IR, polarity, electrode
              resistance — all conducted with the supply isolated. Catches defects in the conductor
              paths and insulation.
            </li>
            <li>
            ...
            <li>
              <strong>Documentation (Reg 644).</strong> EIC + schedules issued, customer pack handed
              over.
            </li>
          </ul>
          <p>
            ...
            defect but it is a Reg 514 non-compliance — testing finds nothing wrong, visual catches
            it).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Before visual inspection starts, the inspector must have the design information (Reg
              132.13 — operating, maintenance, inspection and testing data) and the diagrams, charts
              and tables required by Reg 514.9 (circuit identification, distribution schematic,
              switchgear identification). No information set means the inspector cannot apply the
              correct acceptance criteria. Document this as a limitation if information is missing
              on an EICR; refuse to start initial verification until it is supplied.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              in permitted zones (horizontal/vertical from accessory, or within 150 mm of ceiling),
              or RCD protection, or earthed mechanical protection.
            </li>
            <li>
              <strong>
            ...
            <li>
              ...
              additional protection per Chapter 41. Includes ADS arrangement, RCD presence and type,
            ...
            <li>
              <strong>Methods of protection against overcurrent.</strong> Correct device type (BS EN
              60898 / BS EN 61009 / BS 88), rating, breaking capacity coordination with PFC.
            </li>
            <li>
              <strong>Earthing and bonding arrangements.</strong> Main earthing conductor sized per
              Table 54.7, main bonding to extraneous-conductive-parts per Reg 411.3.1.2,
              supplementary bonding in special locations per Section 701/702/703 etc.
            </li>
            <li>
              <strong>Labelling and notices.</strong> BS 951 bonding labels (Reg 514.13.1), circuit
              identification (Reg 514.9), RCD test notice (Reg 514.12), inspection date notice (Reg
              514.12.1), main switch identification.
            </li>
            <li>
              <strong>Selection of equipment appropriate to external influences.</strong>
              IP rating, IK rating, suitability for ambient temperature and presence of water / dust
          ...
          <p>
            Add to this list any items required by the special locations in Part 7 that apply to the
            installation. Bathrooms (701) — zoning. Pools (702). Construction sites (704). Marinas
            (709). Solar PV (712). EV charging (722). The Part 7 items for the locations present
            must be included on the schedule.
          </p>
        </ConceptBlock>
...
The warning notice may be provided on the clamp according to BS 951 or on the warning label provided with it.`}
          meaning={
            <>
              Visual inspection checks for the BS 951 label at every required location. Handwritten
              labels, missing labels, faded labels, or labels not BS 951 compliant are
              non-compliances to record on the schedule. The label is not cosmetic — it prevents
              future trades from removing what they assume is a redundant green/yellow conductor.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              comment required (though a brief positive note can help future inspectors — e.g. "all
              CPCs torque-checked, calibrated wrench").
            </li>
            <li>
              <strong>Cross (not acceptable).</strong> Item assessed, does not comply. Comment
              mandatory — what is wrong, what action is required. On EICR this triggers C-coding
              (C1/C2/C3/FI). On initial verification this means the install must be remedied before
              energising.
            </li>
            <li>
              <strong>N/A (not applicable).</strong> Item does not apply to this installation (e.g.
              SPD section on an installation without an SPD, or a special location item where the
              location does not exist). Brief comment helps the next reader confirm the N/A is
              correctly applied.
            </li>
            <li>
              <strong>LIM (limitation).</strong> Item could not be assessed within the agreed scope
              — comment explains why. Common limitations: cable routes hidden in fabric, client
              refused furniture move, energised distribution board where DDA not safe to
              de-energise. The limitation reduces the value of the verification — document clearly
              and inform the duty holder.
            </li>
          </ul>
          <p>
            On the EICR specifically, limitations and extents go on the front sheet (Section D). The
            Schedule of Inspections has space for individual item LIM markings to flag where
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              certificate gets issued. Six months later a fault reveals an undersized main earthing
              conductor — visible on day one. The schedule says it was checked. Now the inspector
              has not just missed a defect, they have created a false record of having checked it.
              That is a much worse legal position than missing the item entirely.
            </>
          }
          doInstead={
            <>
              Treat each tick as a declaration. If you have not actually verified the item against
              the standard, do not tick it. Either verify, or mark LIM with the reason. A schedule
              with a few honest LIMs is a far better legal record than a fully ticked schedule that
              does not reflect what you actually did.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>AFDD presence (per Reg 421.1.7).</strong> The regulation uses "recommending" —
              not mandating in general use. For higher-risk residential buildings (HRRBs) the
              Building Safety Act 2022 brings them into mandatory scope. Visual inspection confirms
              AFDDs are present on the circuits where the design has fitted them, the type is
              correct (typically combined RCBO + AFDD in modern consumer units), and the test button
              has been operated as part of commissioning.
            </li>
            <li>
              <strong>SPD presence (per Section 443).</strong> Required where consequences of
              overvoltage affect safety services, public services, commercial / industrial activity,
              or many people. Type 1, Type 2, Type 1+2 combinations. Visual inspection confirms SPD
              presence at origin, status indicator showing healthy, and that the downstream
              protection (often a fuse or MCB upstream of the SPD) is correctly rated.
            </li>
            <li>
              <strong>Updated layout for ADS arrangements.</strong> Schedule sections clarified for
              TN-S, TN-C-S (PME / PNB), TT, IT — including the PNB designation that A4:2026
          ...
          <p>
            ...
            Inspections to reflect A4:2026. Make sure the version you are using matches the edition
            you are certifying against.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              higher-risk residential buildings (HRRBs as defined in the Building Safety Act 2022 —
              typically buildings ≥ 18 m or ≥ 7 storeys with at least two residential units), AFDDs
              become mandatory through the Building Safety Act framework. Visual inspection confirms
              AFDD presence on circuits where the design specifies them, checks the type is BS EN
              62606 compliant, and confirms the device shows healthy indication.
            </>
          }
        ...
        >
          <p>
            Reg 642.3 categories (verbatim references) and what visual inspection covers under each:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>
                Reg 642.3(a) — Equipment correctly selected and erected per manufacturer.
              </strong>
            ...
            <li>
              ...
              Standards markings on devices, certification labels, manufacturer plate information.
            </li>
            <li>
            ...
            <li>
              <strong>
                Reg 642.3(f) — Selection of conductors for current-carrying capacity and voltage
                drop.
              </strong>{' '}
              Installed CSA matches design, installation method accounts for grouping / insulation /
              ambient temperature.
            </li>
            <li>
            ...
            <li>
              <strong>
                Reg 642.3(h) — Methods of protection against electric shock per Section 41.
              </strong>
            ...
            <li>
              ...
              Fire-rated enclosures, AFDDs per Reg 421.1.7, heat dissipation, cable management in
              insulation.
            </li>
            <li>
            ...
            <li>
              <strong>Reg 642.3(k) — Earthing arrangements.</strong> Main earthing conductor sized
              per Table 54.7, MET present, BS 951 labelled.
            </li>
            <li>
              <strong>Reg 642.3(l) — Main protective bonding.</strong> All
              extraneous-conductive-parts bonded per Reg 411.3.1.2, sized per Table 54.8.
            </li>
            <li>
            ...
            <li>
              <strong>
                Reg 642.3(o) — Items in special installations or locations per Part 7.
              </strong>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              discolouration from heat, cable insulation softening or hardening, hardware rusting.
            </li>
            <li>
              <strong>Modifications since installation.</strong> Additions not on the original EIC,
              alterations by other trades (kitchen / bathroom refurbishment that broke bonding), DIY
              interventions.
            </li>
            <li>
              ...
              assessment now triggers requirement, no AFDD on circuits where Reg 421.1.7 recommends
              them.
            </li>
            <li>
              <strong>Lost documentation.</strong> Circuit chart faded / removed, inspection notice
              missing or out of date, no design data for the installation.
            </li>
            <li>
              <strong>Environmental changes.</strong> Loft now insulated where cables were designed
              for free-air, dampness developed in basement, equipment relocated.
            </li>
            <li>
              <strong>Coding for each defect.</strong> C1 (immediate danger), C2 (potentially
              dangerous), C3 (improvement recommended), FI (further investigation needed). Not every
              defect needs a code; some are observations only.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>C1 — Danger present, immediate risk of injury.</strong> Examples: exposed live
              conductors in a public area, broken Class I appliance with live chassis, missing CPC
              on a metal-bodied accessory in regular contact. Action: make safe immediately
              (isolate, barrier, attend in person), notify duty holder in writing same day, EICR
              overall result is unsatisfactory.
            </li>
            <li>
              <strong>C2 — Potentially dangerous.</strong> Examples: undersized main bonding,
              inadequate disconnection time (Zs over Table 41.3), Type AC RCD on circuit feeding
              electronic loads with potential DC fault, no RCD additional protection on socket
              circuit. Action: priority remediation recommended, EICR overall result is
              unsatisfactory.
            </li>
            <li>
              <strong>C3 — Improvement recommended.</strong> Examples: installation complies with
              the standard at the time of installation but does not meet current standards (e.g.
              plastic CU pre-2016, no SPD on a domestic install, BS 3036 rewireable fuses still in
              service). Improvement adds resilience but lack of it is not a danger. EICR overall
              result can still be satisfactory if no C1 / C2 present.
            </li>
            <li>
              <strong>FI — Further investigation required.</strong> Examples: anomalous Zs reading
              at one circuit but no obvious defect on visual; suspected internal damage to an
              accessory needing dismantling to confirm; behaviour of an RCD on test inconsistent
              with its marking. Action: schedule follow-up investigation, report interim findings,
              hold final coding until investigation complete.
            </li>
            <li>
              <strong>No code (observation).</strong> Items that are noteworthy but do not trigger a
              code — e.g. lost original EIC documentation (worth noting but not itself a danger),
              bonding that meets current standard but has surface corrosion that doesn't yet
              compromise function. Document as an observation in the report.
            </li>
          </ul>
          <p>
            EICR overall result: SATISFACTORY (no C1 / C2) or UNSATISFACTORY (one or more C1 / C2
            present). C3 alone does not make the report unsatisfactory but should be acted on for
            ongoing improvement.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Supply intake.</strong> DNO equipment, meter, customer side, MET, main bonding
              connections.
            </li>
            <li>
            ...
            <li>
              <strong>Earth electrode (TT).</strong> Inspection pit, electrode, test link at MET.
            </li>
            <li>
            ...
            <li>
              <strong>Test instrument readings.</strong> Some inspectors photograph the instrument
              display showing the reading for key tests (Ze, Zs at far ends).
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You arrive at a domestic CU change. The previous installer terminated the meter tails
              into the new CU and signed the EIC. You are doing the periodic visual on handover. You
              find the main bonding to the gas meter is connected — but the conductor is 6 mm² where
              Table 54.8 requires 10 mm² for a 25 mm² PME supply tail. The label is in place, the
              connection is tight, the conductor is correctly identified. The fault is sizing.
            </>
          }
          whatToDo={
            <>
              Record on the Schedule of Inspections — main bonding (Reg 411.3.1.2): cross, comment
              "main bonding to gas meter installed at 6 mm² CSA — Table 54.8 requires minimum 10 mm²
              for 25 mm² PME tail. Remediation required before energising / sign off." Photograph
              the existing conductor, the meter tail size, and the connection. Notify the contractor
              or duty holder. Replace with 10 mm² before issuing your clean schedule. If existing on
              EICR, code C2 (potentially dangerous — fault protection compromised, voltage rise on
              extraneous-conductive-parts during fault exceeds the design assumption).
            </>
          }
          whyItMatters={
            <>
              Undersized main bonding is a common defect — the conductor is "there", which fools a
              casual look. Visual inspection by a competent person catches it because it checks
              against the actual table, not against general impression. Table 54.8 is short — print
              it and carry it. The cost of replacing a bonding conductor at the visual stage is
              trivial; the cost of energising an installation with undersized bonding and having
              someone shocked from a faulted gas pipe is not.
            </>
          }
        />
