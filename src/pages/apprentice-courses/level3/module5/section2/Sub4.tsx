...
const checks = [
  {
    ...
    question:
      'Reg 522.6.201 (safe zones) requires cables concealed in walls less than 50 mm from the surface to be:',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'In BS 7671:2018+A4:2026, the mixed-colours warning notice (formerly Regulation 514.14) is:',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'For a 16 A radial circuit feeding a single immersion heater, the standard cable size is typically:',
    options: ['1.5 mm²', '1.0 mm²', '6.0 mm²', '2.5 mm²'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 4,
    question:
      'Cable support — for unsupported PVC/PVC twin and earth cable runs, the maximum permitted unsupported span per IET guidance is approximately:',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'Reg 522.6.202 — where cables less than 50 mm from the surface in a wall / partition are not in a safe zone, the protection options are:',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'Cables installed in conduit shall have a fill ratio per the IET on-site guide of approximately:',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Visual inspection of cables — selection, sizing, routing in safe zones, support and
          fixing, fire stopping, identification colours and the mixed-colours notice.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Zone routing.</strong> Cable runs vertically or horizontally from an accessory
              (socket, switch, light point) — the zones a future occupant would expect a cable to
              be. Plus within 150 mm of the corner of a wall and 150 mm of the ceiling. Predictable
              = safer.
            </li>
            <li>
              <strong>30 mA RCD additional protection.</strong> If the cable is struck, the
              resulting earth fault trips the RCD within 40 ms — saving life. Most modern domestic
              socket and lighting circuits already have this for other reasons.
            </li>
            <li>
              <strong>Earthed mechanical protection.</strong> Steel capping, earthed metal conduit,
              earthed armoured cable. Physical barrier between any future tool and the live
              conductor.
            </li>
          </ul>
          <p>
            For metal-framed partitions, additional Reg 522.6.203 requirements apply — the cable
            should be in earthed metallic conduit OR have RCD protection regardless of zone (because
            the metal frame itself can become live if struck and shorts to a cable).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The regulation gives three options (or combination required for certain wall types).
              Visual inspection confirms which option(s) the design has used and verifies they are
              correctly applied. Cables outside zones, with no RCD and no mechanical protection, are
              non-compliant — cross on schedule, C2 on EICR (potentially dangerous to future
              occupants).
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Three-phase.</strong> L1 = brown, L2 = black, L3 = grey, N = blue, CPC =
              green/yellow. (Note: post-harmonisation black is L2, NOT neutral — a common error when
              working between editions.)
            </li>
            <li>
              <strong>Switch wires.</strong> May be brown (preferred) or other colour with brown
              sleeving / tape at terminations to indicate L. Common in older single-cable switch
              drops.
            </li>
            <li>
          ...
          <p>
            Where mixed colours are present, industry good practice (formerly required by Reg
            514.14, deleted by A2:2022) is a durable warning notice at the CU / origin of the
            alteration, alerting future workers to verify polarity before connection. Visual
            inspection confirms the notice presence and legibility.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              <strong>Important — what this means in practice.</strong> The mixed-colours warning
              notice is no longer a BS 7671 regulatory requirement. It remains{' '}
              <strong>industry good practice</strong> on legacy installations where
              pre-harmonisation (red/yellow/blue) and post-harmonisation (brown/black/grey) cable
              colours coexist — a durable notice at the consumer unit warning future workers to
              verify polarity is sensible engineering, but it is not mandated by the current Wiring
              Regulations. On an EICR, absence of such a notice is no longer a coded non-compliance
              against 514.14; an inspector may still record an observation under the appropriate
              current clause if mixed colours present a safety concern in the specific installation.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              manufacturer recommendation). PVC/PVC T+E typical 250 mm horizontal / 400 mm vertical
              for 1.5-2.5 mm² sizes.
            </li>
            <li>
              Fixings non-damaging to cable (correct cable cleat, P-clip, tray hook). Plastic clips
              for PVC; metal clips with cable-protecting liner for armoured.
            </li>
            <li>
              No strain at terminations — cable enters the box / accessory with adequate slack and
              is fixed close to the entry to prevent pulling.
            </li>
            <li>
              Cable trays and ladders supported per their own design — typical 1-1.5 m intervals for
              steel tray, with bracing at corners and tees.
            </li>
            <li>
              Suspension cables (e.g. lighting suspended on a pendant cable) — checked for strain
              relief and termination integrity per Reg 522.7 / 522.8.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Every penetration of a fire-resisting element is sealed.</li>
            <li>
              The product used is tested for the fire rating of the element (60 min, 120 min etc).
            </li>
            <li>
              The product is correctly applied per the manufacturer's installation drawings — depth,
              surface area, both sides where required, no gaps.
            </li>
            <li>
              The penetration is not oversized for the cable bundle (excess hole = harder to seal).
              Where oversized, additional sealing may be required.
            </li>
            <li>
          ...
          <p>
            Common failures: foam used where intumescent required, plaster fill (no fire rating),
            partial seal (one side only), missing seal entirely. All are recordable defects with
            significant fire safety implications.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              inspection confirms every penetration of a fire-resisting element is sealed to the
              rating of that element. Untested foam, partial seal, or missing seal are all
              recordable C2 / C1 defects depending on the building use (residential compartmentation
              defect is typically C2, in HRRBs often C1).
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Cable is run through a 60-min fire-rated wall in a commercial unit. Installer uses
              expanding foam to fill the gap around the cable. Foam looks neat and tidy, seals
              against draught, passes a casual look. But foam is combustible and has no tested fire
              rating — under fire, it burns out in minutes, breaching the fire compartmentation and
              allowing fire / smoke spread.
            </>
          }
          doInstead={
            <>
              Use tested intumescent products — pillows, mortar, putty, sleeves matched to the fire
              rating of the element and the cable bundle. Manufacturers (Hilti, Promat, etc) publish
              installation drawings for each product showing depth, application, bundle size limits.
              Photograph the application for the project records. On EICR, foam at a fire-rated
              penetration is a recordable defect — C2 typically, C1 in higher-risk buildings.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              manufacturer specifies wider tolerance, larger drop may be acceptable. Document as a
              departure with the manufacturer reference.
            </li>
            <li>
              <strong>Calculation method.</strong> Drop (V) = 2 × L × I × R / 1000 where L = length
              one-way (m), I = design current (A), R = single-conductor resistance (mΩ/m) from
              Appendix 4. Result is the drop on the loaded cable.
            </li>
            <li>
            ...
            <li>
              <strong>Visual inspection cross-check.</strong> Note circuit length and CSA; compute
              approximate drop; compare to limit; flag any close to or over.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lighting circuits.</strong> Typically 66% of total connected lighting load in
              domestic; 90% in commercial / industrial where lighting is largely on continuously.
            </li>
            <li>
              <strong>Socket circuits.</strong> Highest-rated point + 40% of remainder for domestic
              ring finals; varies for radials.
            </li>
            <li>
              <strong>Cookers.</strong> First 10 A + 30% of remainder + 5 A if socket included in
              cooker switch (domestic typical).
            </li>
            <li>
            ...
            <li>
              <strong>Heat pumps.</strong> Per manufacturer running current — typically full rated
              current for hours during heating cycles. Limited diversity.
            </li>
          </ul>
          <p>
            Visual inspection of the supply intake confirms tail size, main switch rating, and CU
            rating are all adequate for the calculated maximum demand. On additions (especially EV
            chargers and heat pumps), recalculate and confirm the supply still has capacity — common
            defect on retrofits is exceeding 80-100 A on a domestic supply without DNO uprating.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Post-harmonisation (BS 7671 from 2004 onwards).</strong> L1 brown, L2 black,
              L3 grey, N blue, CPC green/yellow. Black is a LINE conductor.
            </li>
            <li>
              <strong>Pre-harmonisation (BS 7671 prior to 2004).</strong> L1 red, L2 yellow, L3
              blue, N black, CPC green (very old) or green/yellow (later). Black is the NEUTRAL.
            </li>
            <li>
              <strong>Mixed colours — formerly Reg 514.14 (deleted by A2:2022).</strong> Where both
              colour systems exist in one installation, durable warning notice required at CU / DB.
              Workers must verify polarity before any termination on conductors of ambiguous colour.
            </li>
            <li>
              <strong>Common error point.</strong> A worker familiar with new colours assumes black
              = L2 and treats a pre-harmonisation black conductor as live. Or vice versa — assumes
              black = N on a post-harmonisation install and exposes themselves to live L2.
            </li>
            <li>
              <strong>Single-phase variants.</strong> Single-phase post-harmonisation L = brown, N =
              blue. Single-phase pre-harmonisation L = red, N = black. Same risks if mixed colours
              present.
            </li>
            <li>
              <strong>Sleeved conductors.</strong> Switch wires and similar may be a different base
              colour with brown sleeving / tape at terminations to indicate L. Common in older
              single-cable switch drops.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              applicable. Normal mechanical risk from future picture nails / shelves — addressed by
              safe zones / RCD / mechanical protection per Reg 522.6.
            </li>
            <li>
              <strong>Domestic exposed routes.</strong> T+E in PVC conduit / capping for aesthetic
              and minor protection. Typical loft / cellar runs exposed.
            </li>
            <li>
              <strong>Commercial fit-out.</strong> T+E or singles in steel conduit / trunking; SWA
              for any external runs or higher-risk areas.
            </li>
            <li>
              <strong>Industrial / workshop.</strong> SWA or MICC for runs subject to impact, heat,
              chemical exposure. Galvanised steel conduit for harsh environments.
            </li>
            <li>
              <strong>Underground / external.</strong> SWA at appropriate depth (typically 450 mm
              minimum), with marker tape above. Caution at any building entry — fire / smoke / water
              sealing.
            </li>
            <li>
              <strong>Hazardous areas (DSEAR / ATEX).</strong> Specific product approval for the
              zone classification — Zone 1 explosive, Zone 2 explosive, Zone 21 dust, etc.
          ...
          <p>
            Visual inspection considers the actual installation environment against the cable type
            and protection installed. Mismatches (PVC T+E exposed in a workshop floor area, for
            instance) are recordable defects — Cross on initial verification, C2 / C3 on EICR
            depending on actual risk exposure.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You are doing a periodic on a domestic install. The loft has been re-insulated since
              the original wiring — the new insulation depth is 270 mm, the cables are buried in the
              middle of the layer. Original design assumed cables in free air with 100 mm of
              insulation below. Cable size is 2.5 mm² T+E feeding bedroom lighting circuits, 6 A
              MCB.
            </>
          }
          whatToDo={
            <>
              Apply Method 100 / 101 derating from Appendix 4. 2.5 mm² T+E in Method 100 (cable
              surrounded by insulation) typically has a current-carrying capacity of around 13.5 A —
              versus 27 A in free air. Original design at 6 A loaded is still within the derated
              capacity, so no overload risk. Document on the EICR as an observation: cables now
              buried in insulation, derating applied; recommend client consider alternative routing
              or ducting if any future load increase is planned. Not a defect requiring code, but a
              documented observation for the duty holder.
            </>
          }
          whyItMatters={
            <>
              ...
              Documenting them on the EICR informs the duty holder — they may have planned changes
              (loft conversion, EV charger circuit) that change the calculation.
            </>
          }
        />
