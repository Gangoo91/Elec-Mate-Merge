...
const checks = [
  ...
  },
  {
    ...
    question:
      'Under what condition does BS 7671 / GN3 say you do NOT need to measure or calculate PFC at the origin?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      "On a typical UK domestic with TN-C-S supply, BS EN 61439-3 consumer unit, and a 100 A BS 1361 Type II main fuse upstream, what's the practical approach to PFC verification?",
    options: [
  ...
  },
  {
    id: 3,
    question:
      "Why does the protective device breaking capacity (Icn) need to exceed the PFC at the device's installation point?",
    options: [
  ...
  },
  {
    id: 7,
    question:
      "A 32 A radial socket circuit feeds an EV charger 35 m from the CU via 6 mm cable. What's the expected voltage drop at full charge (32 A)?",
    options: [
  ...
  },
  {
    id: 8,
    question:
      'PFC verification at supply origin on a small commercial installation (200 A 3-phase TN-S supply): what would you expect to see?',
    options: [
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 4 · Subsection 5"
        title="PFC + PSCC + voltage drop measurement"
        backTo="/study-centre/apprentice/level3-module5-section4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Prospective Fault Current at the supply origin — PSCC from L-N loop, PEFC from L-E loop,
          the higher reported as Ipf for protective device breaking-capacity check. Plus voltage
          drop verification under load per Reg 525 (3 percent lighting / 5 percent other).
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              applying brief test current via the L-N loop. Represents the worst-case current that
              would flow in an L-N bolted short circuit at the test point. Typical UK domestic
              origin: 800-2000 A.
            </li>
            <li>
            ...
            <li>
              ...
              Reported on the EIC as Ipf. Used to verify protective device breaking capacity (Icn).
              The "headline" prospective fault current.
            </li>
            <li>
              <strong>Formula.</strong> PFC = nominal supply voltage / measured loop impedance. For
              UK 230 V at 0.5 Omega loop = 460 A. Modern MFTs apply this automatically from the loop
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The exemption applies to dwellings using the standard UK domestic consumer unit (BS EN
              61439-3, rated 16 kA fault current) on a supply where the DNO declares PFC at 16 kA
              maximum. The combination is matched by design. For commercial / industrial
              installations or non-conforming CUs, direct PFC measurement at the origin is required.
              Document the basis on the EIC: either the measured value or "16 kA per distributor
              declaration" for the exempt dwelling case.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Premises type.</strong> Dwelling (household) or similar — typical domestic
              single occupancy, flat, maisonette. Not commercial, not industrial.
            </li>
            <li>
              <strong>Consumer unit.</strong> Conforms to BS EN 61439-3 (the UK consumer-unit
              product standard). Rated 16 kA fault current (the standard rating for this product
              category).
            </li>
            <li>
              <strong>Distributor declaration.</strong> The DNO declares maximum PFC at the supply
              of 16 kA. UK DNOs typically declare this for standard domestic supplies.
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Non-conforming distribution board.</strong> Bespoke industrial board, modular
              distribution panel, anything not BS EN 61439-3.
            </li>
            <li>
              <strong>DNO declares above 16 kA.</strong> Larger supplies (200 A 3-phase, dedicated
              commercial supplies) often have higher declared PFC. Check the connection certificate.
            </li>
            <li>
              <strong>Three-phase supplies.</strong> Even on dwellings, 3-phase supplies have
              different fault current characteristics and benefit from direct measurement.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Verify supply energised.</strong> Main switch closed, supply voltage reading
              L-N within nominal range (216-253 V for UK 230 V).
            </li>
            <li>
              <strong>Connect MFT.</strong> 3-lead test connections to L, N, E at the supply origin
              (meter tails or main switch terminals). Use insulated probes per GS38.
            </li>
            <li>
              <strong>Set MFT to Zs / PFC mode.</strong> Modern MFTs combine Zs and PFC in a single
              test cycle. For older instruments, separate L-N (PSCC) and L-E (PEFC) tests may be
              needed.
            </li>
            <li>
              <strong>Press TEST.</strong> Instrument applies brief test currents via L-N and L-E,
              computes loop impedances, derives PSCC and PEFC. Display shows both readings and / or
              the higher value as PFC.
            </li>
            <li>
              <strong>Record both PSCC and PEFC.</strong> The EIC has fields for both (or for PFC
              alone — check the certificate format). Document the higher as the PFC for
            ...
            <li>
              <strong>If PFC exceeds Icn:</strong> Replace devices with higher-Icn versions, or add
              upstream current-limiting protection. Document the design action on the EIC.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lighting circuits: 3 percent.</strong> 3 percent of 230 V = 6.9 V maximum drop
              from origin to load. Tighter limit because flicker is the most user-visible quality
              issue with lighting.
            </li>
            <li>
              <strong>Other circuits: 5 percent.</strong> 5 percent of 230 V = 11.5 V maximum drop.
              Covers sockets, fixed appliances, motors, water heaters, EV chargers.
            </li>
            <li>
              <strong>Verification by calculation (design phase).</strong> mV/A/m from GN1 Table A1
              x current x length. Compare against the limit. For 6 mm copper at 7.3 mV/A/m, 32 A x
              35 m = 8.18 V or 3.6 percent — within socket limit.
            </li>
            <li>
              <strong>Verification by measurement (commissioning, optional).</strong> Two-point
              voltage measurement under load: no-load voltage at origin minus loaded voltage at
              furthest point. Express as percentage of 230 V. Compare against limit.
            </li>
          </ul>
          ...
          <p>
            For accurate calculation use the GN1 Table A1 value for the specific cable type (T+E,
            single-core, SY, SWA), insulation (PVC vs thermosetting), and arrangement (clipped
            direct, in conduit, in containment). The values above are typical for T+E thermosetting
            flat cable; SWA and other arrangements give slightly different values.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 525.1 sets voltage drop as a verifiable design parameter. Appendix 4 gives the 3
              percent lighting / 5 percent other limits. Calculation is the primary verification
              (during design); measurement is the optional confirmation (during commissioning) for
              borderline runs. Voltage drop becomes the limiting factor on long high-current runs —
              EV chargers on long radials, outbuildings, garden offices.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>
                Domestic MCB / RCBO / AFDD-RCBO (BS EN 60898 / BS EN 61009 / BS EN 62606):
              </strong>
              Typically 6 kA Icn (Hager, Schneider, Wylex, Eaton standard ranges).
            </li>
            <li>
              <strong>Light commercial MCB (BS EN 60898 industrial range):</strong> Typically 10 kA
              Icn.
            </li>
            <li>
              <strong>Industrial MCB (BS EN 60947-2):</strong> Typically 10-25 kA Icn depending on
              application.
            </li>
            <li>
            ...
            <li>
              <strong>HRC fuse (BS 88):</strong> Very high breaking capacity — typically 80- 120 kA.
              Used as upstream protection where downstream MCB Icn is exceeded.
            </li>
            <li>
              <strong>Consumer unit busbar (BS EN 61439-3):</strong> Typically 16 kA Icw (rated
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Identify cable size and type.</strong> 1 mm, 1.5 mm, 2.5 mm, 4 mm, 6 mm, 10
              mm, 16 mm. T+E (flat), single-core, SY, SWA — different mV/A/m values.
            </li>
            <li>
              <strong>Look up mV/A/m from GN1 Table A1.</strong> Per cable size, type and
              installation method. Typical T+E thermosetting: 1.5 mm = 29, 2.5 mm = 18, 4 mm = 11, 6
              mm = 7.3, 10 mm = 4.4.
            </li>
            <li>
            ...
            <li>
              <strong>Calculate voltage drop.</strong> Current (A) x length (m) x mV/A/m / 1000 =
              voltage drop (V).
            </li>
            <li>
            ...
            <li>
              <strong>Compare against Reg 525 limit.</strong> 3 percent for lighting, 5 percent for
              other. If exceeds, upsize cable.
            </li>
            <li>
              <strong>For high-current continuous loads,</strong> consider design margin — the limit
              is for full design current; if the load is continuous (EV charging, large heating) at
              near full current, voltage drop will be near the limit in service. Aim for under 3
              percent on continuous high-current runs for comfortable margin.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Three-phase short circuit (L1-L2-L3 bolted).</strong> Highest fault current.
              Used for switchgear breaking-capacity sizing.
            </li>
            <li>
              <strong>Phase-to-phase short circuit (L1-L2, L2-L3, L1-L3).</strong> Slightly lower
            ...
            <li>
              <strong>Practical commissioning.</strong> Three-phase MFTs measure all combinations in
              a single test cycle. Document the highest as PFC; document phase-to-neutral and
              phase-to-earth values separately if the schedule format requires.
            </li>
          </ul>
          <p>
            For typical UK commercial three-phase supplies (200 A or 400 A 3-phase), PFC at origin
            is often in the 5-25 kA range. Industrial supplies (large dedicated transformers) can
            reach 40-50 kA or higher. Switchgear Icn must match.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ze (supply origin loop impedance).</strong> Measured value in ohms. Typical
              TN-C-S 0.1-0.35; TN-S 0.2-0.5; TT 30-200+.
            </li>
            <li>
              <strong>PFC (Ipf) at origin.</strong> Measured higher of PSCC / PEFC, OR "16 kA per
              distributor declaration" for the dwelling exemption case. Always state the basis.
            </li>
            <li>
              <strong>PSCC and PEFC (if separate fields).</strong> Both readings recorded where the
              certificate format provides separate fields.
            </li>
            <li>
              <strong>Supply voltage at test time.</strong> Typically 235-245 V on UK 230 V nominal
              supply. Useful for sanity-checking the PFC calculation.
            </li>
            <li>
              <strong>Protective device Icn vs PFC verification.</strong> Note that each device has
              Icn at least equal to PFC — typically a tick or "verified" entry on the certificate.
              Document any non-standard cascading arrangement.
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice familiar with domestic work assumes the BS EN 61439-3 / 16 kA exemption
              applies everywhere. On a small commercial install (200 A 3-phase supply, bespoke
              distribution board, not BS EN 61439-3), they fill the PFC field on the EIC with "16 kA
              per distributor" without measuring. Six months later an audit picks it up — the actual
              PFC is 22 kA on this supply, the downstream MCBs are 6 kA Icn, and the design is
              unsafe. Devices need replacing with 25 kA-rated versions; certificate needs
              re-issuing; the firm has a non-conformance against its scheme registration.
            </>
          }
          doInstead={
            <>
              Always check the exemption conditions. BS EN 61439-3 CU + dwelling + 16 kA distributor
              declaration = exempt. Anything else = direct measurement. Commercial / industrial /
              3-phase / non-conforming CU all require direct PFC measurement at the origin. Modern
              MFTs make this a one-button test — no excuse for skipping.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              the run, additional labour and material cost.
            </>
          }
          doInstead={
            <>
              ...
              current-carrying capacity. Use GN1 Table A1 mV/A/m: for 6 mm at 7.3 mV/A/m, 32 A x 30
              m = 7 V or 3 percent. Within limit but tight. Consider 10 mm at 4.4 mV/A/m: 32 A x 30
              m = 4.2 V or 1.8 percent — comfortable margin and lets the EV charger work at design
              performance. Cost difference between 6 mm and 10 mm is small relative to total install
              cost.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Small commercial unit in an industrial estate near Reading. 100 A single-phase TN-S
              supply (DNO declared 12 kA PFC per the connection certificate). 12-way distribution
              board (not BS EN 61439-3 — bespoke industrial design, manufacturer rated 16 kA Icw).
              Six radial circuits including a 32 A workshop ring, a 32 A welding socket, a 16 A
              office ring, lighting, immersion, an extractor fan. Long workshop ring (45 m) and
              welding socket (28 m) — voltage drop worth checking under load.
            </>
          }
          whatToDo={
            <>
              Direct PFC measurement at origin (not exempt — commercial premises with bespoke DB).
              Connect Kewtech KT64+ at the main switch terminals, set Zs / PFC mode, run 3-lead
              test. Reading PSCC = 11.4 kA, PEFC = 9.8 kA. PFC = 11.4 kA (the higher). Document on
              the EIC: PFC 11.4 kA at origin, supply per DNO declaration 12 kA. Cross-check device
              Icn: distribution board rated 16 kA Icw (exceeds PFC comfortably); MCBs and RCBOs in
              the board rated 10 kA Icn (also exceeds PFC). Pass — protective device breaking
              capacity verified. Move to voltage drop on the long runs. Workshop ring 45 m of 4 mm
              T+E cable. GN1 Table A1: 4 mm at 11 mV/A/m. Calculated drop at 32 A: 32 x 45 x 11 /
              1000 = 15.8 V or 6.9 percent — exceeds 5 percent Reg 525 limit. Investigate. Apply
              test load (2 kW heater) at furthest socket of workshop ring, measure voltage drop:
              no-load 242 V at CU, loaded 230 V at workshop socket = 12 V drop or 5.0 percent at 8.7
              A. Scale to full 32 A: 12 V x 32 / 8.7 = 44 V — confirms the calculation. Conclusion:
              4 mm cable is undersized for voltage drop on the 45 m run. Recommend upgrade to 6 mm
              (calculated drop at 32 A x 45 x 7.3 / 1000 = 10.5 V or 4.6 percent — comfortable
              pass). Document finding and recommendation. Continue verification on the shorter
              circuits — welding socket 28 m of 6 mm: drop 28 x 32 x 7.3 / 1000 = 6.5 V or 2.8
              percent, comfortable pass. Office ring 18 m of 2.5 mm: drop 18 x 16 x 18 / 1000 = 5.2
              V or 2.3 percent, pass. Document everything on the EIC: PFC, PSCC, PEFC at origin;
              per-circuit Zs and voltage drop where relevant; the workshop ring upgrade
              recommendation as a Code 3 finding (or quote for immediate upgrade if the customer
              wants it before sign-off).
            </>
          }
          whyItMatters={
            <>
              The scenario demonstrates the full live verification at supply origin and per circuit.
              PFC measurement was required because commercial premises with a non-conforming DB —
              direct measurement gave 11.4 kA, comfortably within the 10 kA Icn of the protective
              devices. Voltage drop verification on the long workshop ring caught an undersized
              cable that would have caused performance issues in service — the calculation showed
              it; the under-load measurement confirmed it; the recommendation gives the customer a
              clear path to remediation. Without the systematic PFC + voltage drop verification, the
              install would have shipped with one safety verification gap (PFC undocumented) and one
              performance problem (workshop ring voltage drop). Both caught by competent
              commissioning.
            </>
          }
        />
