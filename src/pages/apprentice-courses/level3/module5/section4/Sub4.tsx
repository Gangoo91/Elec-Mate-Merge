...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      "You've installed an AFDD-RCBO on a new kitchen socket circuit. The verification test sequence at commissioning is:",
    options: [
  ...
  },
  {
    id: 4,
    question:
      "An AFDD trips intermittently during normal kitchen use (kettle, microwave, blender). What's the diagnostic approach?",
    options: [
  ...
  },
  {
    id: 5,
    question:
      'Which of the following protective devices presents low resistance during an insulation resistance test, potentially affecting readings?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'Higher Risk Residential Buildings (HRRBs) under the Building Safety Act 2022 are typically defined as:',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'Standard cost approximation for adding AFDD protection to a typical 10-circuit domestic CU upgrade:',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          A4:2026 Reg 421.1.7 RECOMMENDS (NOT mandates) AFDDs in specified locations under BS 7671.
          HRRBs have separate mandatory requirements via the Building Safety Act 2022. Verification
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              educational establishments, and similar locations where occupants may not be able to
              react quickly to a developing fire. Wording is "recommending" — not mandatory.
            </li>
            <li>
              <strong>Building Safety Act 2022 + building regulations:</strong> Mandates AFDDs in
              Higher Risk Residential Buildings (HRRBs — 18 m+ / 7 storeys+ multi-residential
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The wording is "recommending" — not mandating. AFDDs are the recommended best practice
              for socket-outlet circuits up to 32 A in dwellings, premises with sleeping
              accommodation, and similar high-occupancy locations. The recommendation is strong but
              not strict. Higher Risk Residential Buildings have separate mandatory requirements via
              the Building Safety Act 2022. The product standard for AFDDs is BS EN 62606.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              kettle flex, vacuum cleaner cord, lamp lead — current passes through an air gap and
              arcs continuously, generating heat that can ignite the surrounding insulation and
              adjacent combustibles.
            </li>
            <li>
              <strong>Loose terminal connections.</strong> A backed-off terminal screw at a socket
              back, an under-torqued strip connector, a loose backbox terminal — current arcs across
              the gap, generating localised heat.
            </li>
            <li>
              <strong>Damaged cable insulation.</strong> Where insulation has degraded enough for
              arcing to occur between conductors or between conductor and earth without tripping a
              standard MCB or RCD.
            </li>
            <li>
              <strong>Aged accessories.</strong> Worn socket contacts that no longer make a positive
              connection, cracked accessory plates with internal arcing.
            </li>
          </ul>
          <p>What an AFDD must NOT trip on (the benign arcs):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Switching arcs.</strong> Contactor closing / opening on a motor circuit, relay
              operation, switch make / break.
            </li>
            <li>
              <strong>Motor brush sparking.</strong> Universal motor brushes (vacuum cleaners, food
              processors, hand tools) generate continuous low-level arcing during normal operation.
            </li>
            <li>
              <strong>Electronic load switching.</strong> Switch-mode PSUs, dimmers, variable- speed
              drives all create high-frequency current variations that can resemble arc-fault
              signatures to less-discriminating detection algorithms.
            </li>
          </ul>
          <p>
            ...
            significantly better. Stick to reputable manufacturers and check device datasheets for
            compliance with the current BS EN 62606 edition.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              A4:2026 Reg 643.7.3). Press the AFDD test button — device trips. Reset by switching
              back on. Document on the Schedule of Test Results.
            </li>
            <li>
            ...
            <li>
              <strong>Customer quarterly check (per Reg 132.13).</strong> Customer presses test
              button on each AFDD; if it fails to trip, call an electrician.
            </li>
            <li>
              <strong>Failed AFDD response.</strong> If the test button fails to trip the device,
              replace the AFDD. EICR coding C2 (potentially dangerous) for a failed AFDD on a
              circuit relying on it for fire protection.
            </li>
          </ol>
          <p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Dwellings.</strong> Single-family houses, flats, apartments. Final circuits
              supplying socket-outlets up to 32 A. The most common scope.
            </li>
            <li>
            ...
            <li>
              <strong>Care homes and similar.</strong> Premises with vulnerable occupants (elderly,
              disabled, medically dependent). Higher fire-risk because of evacuation difficulty.
            </li>
            <li>
            ...
            <li>
              <strong>Other locations as enumerated by the regulation.</strong> Check the current
              text of Reg 421.1.7 in BS 7671 for the full list.
            </li>
          </ul>
          <p>Higher Risk Residential Buildings (HRRB):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Definition.</strong> Buildings 18 m or more in height (typically 7 storeys or
              more) containing two or more residential units.
            </li>
            <li>
              <strong>Regulatory basis.</strong> Building Safety Act 2022 + accompanying building
              regulations. Administered by the Building Safety Regulator (HSE).
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              recommendation) and Reg 651.2(e) (initial verification confirmation). The regulatory
              triad covers: <strong>where</strong> AFDDs are recommended (421.1.7),{' '}
              <strong>what</strong> the device must comply with (532.6, referencing BS EN 62606) and{' '}
              <strong>how</strong> operation is confirmed at initial verification (651.2(e)). On
              site you confirm via the manufacturer test button and the operational indicator.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              AFDDs join RCBOs, RCCBs and SPDs as devices that can be affected by 500 V IR test
              voltage. Standard mitigations: disconnect the device for the IR test and re-fit
              afterwards; test at 250 V if the manufacturer permits; or apply IR test to the wiring
              only by isolating at the device load terminals. The manufacturer manual is the source
              of truth for what each specific device tolerates.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Visual inspection.</strong> Device fitted correctly, terminations torqued per
              manufacturer, label visible, identification on the circuit chart.
            </li>
            <li>
            ...
            <li>
              <strong>IR test.</strong> 500 V if the device manufacturer permits on the line side;
              250 V or device-disconnected if not. GN3 explicitly identifies AFDDs as devices that
              can present low resistance during IR testing.
            </li>
            <li>
            ...
            <li>
              <strong>Zs at the furthest point.</strong> No-trip mode (the RCD half is RCD). Compare
              against Type B / C / D Table 41.3 limit with 0.8 multiplier.
            </li>
            <li>
            ...
            <li>
              <strong>AFDD functional test (manufacturer button).</strong> Press T, device trips,
              reset by switching back on. Record pass / fail.
            </li>
            <li>
              <strong>Documentation.</strong> Schedule of Test Results — RCD type and trip time per
              circuit, AFDD pass / fail per circuit, BS EN 62606 product compliance noted in test
              method notes.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Investigate genuine loose connections first.</strong> Inspect every accessory
              on the circuit — sockets, switches, junction boxes, the device terminals themselves.
              Tighten with proper torque tool. Replace any worn or damaged accessories. Check
              plug-in equipment for damaged flexes.
            </li>
            <li>
              <strong>Check pattern of trips.</strong> When does it trip? Same time of day? Same
              appliance? Same socket? Pattern often points to a specific cause.
            </li>
            <li>
              <strong>Test plug-in equipment separately.</strong> Plug in suspected appliances one
              at a time. Damaged flexes on kettles, vacuum cleaners and hair dryers are common
              culprits. Replace the flex or the appliance.
            </li>
            <li>
              <strong>Assess load characteristics.</strong> Some electronic loads (cheap LED
              drivers, no-name PSUs, low-quality variable-speed drives) produce waveforms that
              less-discriminating AFDDs interpret as arc faults. Test by removing each electronic
              load.
            </li>
            <li>
              <strong>Consider device generation.</strong> First-generation AFDDs (pre-2018) are
              more prone to nuisance tripping than current BS EN 62606 compliant devices. Replace
              with a current-generation device from a reputable manufacturer (Hager, Schneider,
              Wylex, Eaton).
            </li>
            <li>
          ...
          <p>
            <strong>Never:</strong> bypass the AFDD, replace with non-AFDD device, increase the I
            delta n. Each removes the fire protection; each may breach Reg 421.1.7 expectations or
            HRRB-mandate building regulations.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Purpose of the AFDD.</strong> "These devices protect against fires caused by
              arc faults in the wiring or in plug-in equipment. They detect the signature of arcing
              — typically caused by damaged flexes, loose terminals or worn accessories — and
              disconnect the circuit before a fire can develop."
            </li>
            <li>
              <strong>Test-button protocol.</strong> "Press the T button on each AFDD-RCBO
              quarterly. The device should trip immediately. Reset by switching back on. If any
              device fails to trip on the button, contact us."
            </li>
            <li>
              <strong>What to do on a trip in service.</strong> "If an AFDD trips during normal use,
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HRRB (18 m+ / 7 storeys+ multi-residential):</strong> AFDD-RCBO MANDATORY per
              Building Safety Act 2022 building regulations.
            </li>
            <li>
              <strong>HMO, hotel, care home, sleeping accommodation:</strong> AFDD-RCBO strongly
              recommended per Reg 421.1.7. Specifier and customer education usually results in
              selection.
            </li>
            <li>
              <strong>Domestic dwelling (typical owner-occupied):</strong> AFDD-RCBO recommended per
              Reg 421.1.7 (wording is "recommending"). Customer choice; quote both options with cost
              transparency.
            </li>
            <li>
              <strong>Educational establishment, public building:</strong> AFDD-RCBO recommended for
              socket-outlet circuits per Reg 421.1.7.
            </li>
            <li>
              <strong>Commercial office, retail (no sleeping accommodation):</strong> Best practice
              but not specifically targeted by Reg 421.1.7. Consider for higher-fire-risk areas
              (kitchens, server rooms, storage of combustibles).
            </li>
            <li>
              <strong>Industrial:</strong> Generally not the typical scope — AFDDs are designed for
              socket circuits in occupied premises rather than industrial process circuits.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              RCBO-only is fully BS 7671 compliant for typical domestic work.
            </>
          }
          doInstead={
            <>
        ...
        <Scenario
          ...
          situation={
            <>
              Three-storey HMO conversion in Brighton. New 18-way consumer unit, all-AFDD-RCBO spec
              because the project specification cited Reg 421.1.7 for HMO sleeping accommodation.
              Hager AFDD-RCBOs (BS EN 62606 compliant), 30 mA Type A. TN-C-S supply. Eight bedrooms,
              three kitchens, three bathrooms, common hall lighting. Time for commissioning
              verification.
            </>
          }
          whatToDo={
            <>
              Standard commissioning sequence with AFDD-specific steps. (1) Visual inspection — all
              ...
              each AFDD-RCBO — single AC at 1 x I delta n per A4:2026 Reg 643.7.3 (the new method).
              All trip times 25-40 ms, well within 300 ms product limit and 400 ms Table 41.1 TN
              final limit. (6) AFDD test button on each device — press T, device trips, reset. All
              function correctly. (7) Document everything on the EIC: RCD type "A" per circuit, RCD
              trip time per circuit, AFDD functional test pass / fail per circuit, BS EN 62606
              device conformance noted in the test method notes. (8) Reg 132.13 documentation pack —
              Hager user manual for AFDD-RCBOs, customer brief on quarterly test-button protocol for
              both RCD and AFDD function, recommended next inspection date. Hand over to the duty
              holder with the CU label clearly identifying each AFDD-RCBO and its protected circuit.
            </>
          }
          whyItMatters={
            <>
              The HMO scope is exactly the kind of premises Reg 421.1.7 targets — sleeping
              accommodation, multiple occupants, evacuation potentially complex. AFDD protection is
              the recommended best practice and was specified for this project. The verification
              combines standard A4:2026 RCD method (single AC at 1 x I delta n) with the
              AFDD-specific functional test (manufacturer button). The customer handover under Reg
              132.13 sets the duty holder up to maintain the protection between professional
              inspections — quarterly test-button on both RCD and AFDD functions. Without that
              documentation, the AFDDs may sit unmaintained for years and the duty holder has no
              knowledge of how to verify them.
            </>
          }
        />
