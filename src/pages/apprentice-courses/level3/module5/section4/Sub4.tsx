...
const checks = [
  {
    ...
    options: [
      'Mandatory — AFDDs must be installed in all dwellings.',
  ...
  },
  {
    ...
    options: [
      'Single AC test at 1 x I delta n like an RCD.',
      ...
      'Continuity test at the device terminals.',
      'IR test at 500 V.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Heavy industrial three-phase circuits.',
...
const quizQuestions = [
  {
    ...
    options: [
      'The colour of the device label.',
  ...
  },
  {
    ...
    options: [
      'Yes, BS 7671 makes them mandatory.',
