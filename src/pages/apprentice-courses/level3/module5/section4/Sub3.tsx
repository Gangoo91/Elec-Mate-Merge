...
const TITLE =
  'RCD trip-time testing (A4:2026 single AC at 1 x I delta n) | Level 3 Module 5.4.3 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    id: 'm5-s4-sub3-types',
    question:
      'A 30 mA RCD on a circuit feeding a single-phase variable-speed drive (VSD) should be type:',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A4:2026 made a major simplification to in-service RCD testing. What was deleted from the test set?',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'Table 41.1 (A4:2026) maximum disconnection times for a 230 V final circuit not exceeding 32 A:',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'On a TT installation with Ra = 100 Omega and a 30 mA RCD, the Ra x I delta n test gives:',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'You measure RCD trip time at 1 x I delta n = 35 ms on a 30 mA RCD. Compliance per A4:2026 / Table 41.1?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'On an installation with all-RCBO consumer unit (e.g. 12 RCBOs), how many RCD tests do you carry out for verification?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      "A 30 mA RCD on a kitchen socket circuit fails the trip-time test (reads 380 ms, limit 300 ms). What's the appropriate response?",
    options: [
...
const faqs = [
  ...
  {
    question:
      'My MFT defaults to the old multi-test sequence. Should I use single-test mode instead?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          A4:2026 Reg 643.7.3 simplified the RCD verification to a single AC test at 1 x I delta n.
          The multi-test sequence at multiples of I delta n is DELETED. Covers RCD types AC / A / F
          / B / time-delayed, the 300 ms general limit, the Ra x I delta n less than or equal to 50
          V test on TT, and the manufacturer test button as a separate functional check.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Old test set (pre-A4:2026):</strong> 1/2 x I delta n (no-trip confirmation), 1
              x I delta n (trip within 300 ms), 5 x I delta n (trip within 40 ms). Three tests per
              RCD.
            </li>
            <li>
              <strong>New test set (A4:2026):</strong> 1 x I delta n AC. Single test. Trip time
              recorded.
            </li>
            <li>
              <strong>Why simplified:</strong> Modern RCDs (BS EN 61008 / BS EN 61009) have reliable
              performance across the residual-current range. If the device passes at 1 x I delta n,
              it will reliably trip faster at higher residual currents. The multi-test was
              redundant.
            </li>
            <li>
              <strong>What got removed:</strong> The 5 x I delta n test in particular is gone — not
              just optional, deleted. The 1/2 x I delta n no-trip confirmation also removed.
            </li>
            <li>
...
(b) for delay 'S' type RCD, between 130 ms minimum and 500 ms maximum.`}
          meaning={
            <>
              Single AC test at the rated residual operating current (IΔn). The acceptance limits
              live in the regulation NOTE: 300 ms maximum for general non-delay RCDs; 130 ms minimum
              to 500 ms maximum for time-delayed 'S' type. The earlier multi-test sequence (½, 1, 5
              × IΔn) is no longer required by A4:2026 — verification is the single AC test at IΔn,
              with the device deemed effective if it trips within the NOTE limits. Verification
              instrument must comply with BS EN 61557-6.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type AC.</strong> Detects pure sinusoidal AC residual current only. Blind to
              DC and pulsating DC. Suitable only for circuits with purely resistive / inductive
              loads — increasingly rare in modern installations. Often replaced by Type A in
              upgrades.
            </li>
            <li>
              <strong>Type A.</strong> Detects AC plus pulsating DC. The modern default for general
              use. Suitable for circuits with electronic loads producing pulsating DC residual
              currents (LED drivers, dimmers, PCs, single-phase motor controllers).
            </li>
            <li>
              <strong>Type F.</strong> Detects A waveforms plus high-frequency composite waveforms
              typical of single-phase variable-speed drives. Used where motor drives are present.
            </li>
            <li>
              <strong>Type B.</strong> Detects A and F waveforms plus smooth DC up to 6 mA.
              Mandatory for EV charging (Section 722) and required wherever significant smooth DC
              residual current is possible (large PV inverters, three-phase VSDs, certain industrial
              loads).
            </li>
            <li>
              <strong>Time-delayed (S) suffix.</strong> Devices with intentional delay for
              selectivity coordination. Typically used as upstream RCD with downstream non-delayed
              RCDs on individual circuits. (S) designation per BS EN 61008 / 61009 / 62423 series.
            </li>
          </ul>
          <p>Selection guidance from A4:2026:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>General domestic / commercial:</strong> Type A minimum. Type AC effectively
            ...
            <li>
              <strong>PV inverters with significant smooth DC:</strong> Type B per manufacturer
              guidance.
            </li>
            <li>
              <strong>Three-phase industrial:</strong> Type B for circuits with significant DC
              content.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Time-delayed (S) at 1 x I delta n:</strong> 130-500 ms (per device spec —
              check manufacturer).
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Multiply by RCD I delta n.</strong> 0.030 A for a 30 mA RCD, 0.100 A for 100
              mA, 0.300 A for 300 mA.
            </li>
            <li>
              <strong>Compare against 50 V limit.</strong> Result must be less than or equal to 50 V
              per Reg 411.5.3(b).
            </li>
            <li>
              <strong>If Ra x I delta n is greater than 50 V:</strong> The arrangement does not meet
              the regulation. Options: reduce Ra (additional electrodes, longer / better-coupled
              rods), reduce I delta n (smaller RCD where possible), or recognise the system is unfit
              for purpose.
            </li>
          </ul>
          <p>Worked examples:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Ra = 500 Omega, 100 mA RCD:</strong> 500 x 0.100 = 50 V. Borderline — at the
              limit. Investigate.
            </li>
            <li>
              <strong>Ra = 800 Omega, 30 mA RCD:</strong> 800 x 0.030 = 24 V. Pass — but Ra is high
              enough to warrant investigation of the electrode condition.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              before the RCD operates. 50 V is the conventional safe touch-voltage limit for normal
              dry conditions. Verifying Ra x I delta n less than or equal to 50 V confirms the RCD
              will operate before the touch-voltage reaches dangerous level.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Test button (customer, quarterly).</strong> Mechanical functional check.
              Verifies the device can trip. Does not measure trip time or current accuracy.
            </li>
            <li>
              <strong>Instrument test (inspector, EICR intervals).</strong> Performance
              verification. Single AC test at 1 x I delta n per A4:2026. Measures trip time against
              Table 41.1 system limits and the device product spec.
            </li>
            <li>
            ...
            <li>
              <strong>Documentation handover (Reg 132.13):</strong> Brief the customer on
              test-button operation, recommended frequency (quarterly), and what to do if the test
              fails.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              GN3 frames the verification programme around Chapter 41 disconnection times. Loop
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Protective device manufacturer / model.</strong> Identifies the specific RCD /
              RCBO / AFDD-RCBO. Enables traceability if a fault is later found.
            </li>
            <li>
            ...
            <li>
              <strong>Measured trip time at 1 x I delta n.</strong> The single AC test result in
              milliseconds.
            </li>
            <li>
              <strong>Test method.</strong> "Single AC at 1 x I delta n per A4:2026 Reg 643.7.3" —
              or equivalent wording confirming the simplified method was used.
            </li>
            <li>
              <strong>Pass against Table 41.1 system limit.</strong> 400 ms TN final, 200 ms TT
              final, 5 s TN distribution, 1 s TT distribution.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Same single AC test at 1 x I delta n</strong> per A4:2026 Reg 643.7.3. Trip
              time will be longer because of the intentional delay.
            </li>
            <li>
              <strong>Compare against device product spec.</strong> Manufacturer datasheet quotes
              the rated trip time at 1 x I delta n — typically 130-500 ms for S-type devices.
            </li>
            <li>
              <strong>Compare against system limit.</strong> Table 41.5 gives the system
              disconnection times for distribution circuits — 1 s for TT, 5 s for TN. Time-delayed
              devices are typically used as distribution circuit protection.
            </li>
            <li>
              <strong>Selectivity verification.</strong> The downstream non-delayed RCDs should trip
              first on a fault on their circuits. Test by faulting a downstream circuit and
              confirming only the downstream device trips, not the upstream S-type. This is a
              coordination check, separate from the A4:2026 trip-time verification.
            </li>
            <li>
              <strong>Documentation.</strong> "S" in the type column on the Schedule of Test Results
              — e.g. "A (S)" for a time-delayed Type A device. Trip time recorded as normal.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Primary verification: AC at 1 x I delta n.</strong> Per A4:2026 Reg 643.7.3 —
              same single test as any other RCD type. Trip time recorded against Table 41.1 and the
              device product spec.
            </li>
            <li>
              <strong>Optional additional DC verification.</strong> Some MFTs offer a DC residual
              current test specifically for Type B devices. Useful for full verification on
              installations with significant smooth DC content (EV chargers, large PV inverters).
            </li>
            <li>
              <strong>EV charging specific (Section 722).</strong> Type B RCD OR Type A with
              manufacturer-declared RDC-DD in the EV charge point. Verify whichever arrangement is
              installed.
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice arrives at a domestic for an EICR. Walks to the consumer unit, presses the
              test button on each RCBO, sees them all trip, ticks "RCD verified" on the schedule,
              leaves. Six months later one of the RCBOs fails to operate under a real fault — trip
              time had drifted to 800 ms, well beyond the 300 ms limit. The test button worked but
              the device was too slow. Customer or family member at risk; the EICR record is wrong;
              the firm is exposed.
            </>
          }
          doInstead={
            <>
              Always do the instrument test at 1 x I delta n for every RCD on the EICR. The test
              button is not a substitute. The instrument test measures trip time against Table 41.1
              and the product spec; the test button only confirms the device can trip mechanically.
              The two tests serve different purposes and the EICR verification needs the instrument
              test.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Same 3-bed semi from Sub2. 12-way all-RCBO consumer unit, all 30 mA Type A devices
              except the EV charger which is 30 mA Type B (per Section 722). TN-C-S supply. Zs
              verification complete. Time for RCD trip-time tests across the board.
            </>
          }
          whatToDo={
            <>
              ...
              lights 28 ms, immersion 24 ms, cooker 26 ms, smoke alarm 35 ms. All well within 300 ms
              product limit and 400 ms Table 41.1 TN final limit. EV charger Type B — same single
              test at 1 x I delta n AC, 30 ms. Pass. Reset all RCBOs. Document on the Schedule of
              Test Results: RCD type column "A" for the ten general circuits and "B" for the EV
              charger; trip time column with the measured ms reading per circuit; verification
              method "single AC test at 1 x I delta n per A4:2026 Reg 643.7.3" in the test method
              notes. Brief the customer — "All RCDs operate well within the required time. I
              recommend you press the T button on each RCD quarterly to keep verifying mechanical
              operation between inspections; if any fails to trip on the button, call us." Hand over
              the documentation pack including the test-button instructions per Reg 132.13. Move on
              to PFC / PSCC measurement in Sub 5.
            </>
          }
          whyItMatters={
            <>
              The sequence demonstrates current A4:2026 practice — single test per RCBO, fast and
              clean, results well within limits, customer briefed on the ongoing test-button
              discipline. The EV charger Type B verification follows the same method (the AC test at
              1 x I delta n is the BS 7671 verification; a separate DC test is optional for
              additional assurance on Type B devices). The schedule documents type and trip time per
              circuit; the test method note cites Reg 643.7.3. Scheme provider audit will pick up
              the A4:2026-aligned method as compliant. The customer leaves with quarterly
              test-button instructions and a clear understanding of when to call.
            </>
          }
        />
