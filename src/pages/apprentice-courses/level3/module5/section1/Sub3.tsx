...
const checks = [
  ...
  },
  {
    ...
    question:
      'GN3 contains a frequency table for periodic inspection. For an owner-occupied dwelling the recommendation is typically:',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'When the GN3 inspection-and-testing checklist refers to "periodic testing" activities, the checklist applies:',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'GN3 9th Edition + A4 update is the current edition. What changed in the A4 update relative to earlier editions?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'GN3 specifies the four-terminal earth tester for measuring earth electrode resistance because:',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'When carrying out an earth electrode test under GN3 guidance, parallel metallic paths (bonded water/gas services, adjacent earthing systems) should be:',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'The information the inspector needs to conduct initial verification (per Reg 642.1 and GN3) does NOT include:',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          GN3 9th Edition 2022 (A4 update) — the IET's practical companion to BS 7671 Part 6. Test
          methods, model forms, frequency tables, and the dynamic risk assessment requirement.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>GN3 Chapter 2 explains</strong> the R1+R2 method (line and CPC linked together
              at the CU, walk to the far end, read), the R2-only method (long lead from the MET,
              read between MET and far-end CPC), the three-part ring final method (end-to-end, then
              L-N cross-connection, then L-CPC cross-connection), how to null the leads, what the
              expected readings are for typical cable sizes, and what to do when readings do not
              match expectation.
            </li>
          </ul>
          <p>
            GN3 is a non-statutory IET publication. It does not have the force of law. But it is
            widely accepted as the standard of practice — what a competent person should know and
            apply. Using its methods and acceptance criteria is the safe route to demonstrating BS
            7671 compliance.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              requirements (those come from BS 7671) but it tells you the recommended methods and
              acceptable practice. Where Part 6 says "verify", GN3 shows you how. Where Part 6 sets
              a numerical threshold (1 MΩ IR for example), GN3 explains the test method that gets
              you to that number reliably.
            </>
          }
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Chapter 1 — Introduction.</strong> Scope, definitions, status of the guidance,
              relationship to BS 7671.
            </li>
            <li>
              <strong>Chapter 2 — Initial verification.</strong> The deep dive on Reg 641-644. Test
              methods, sequence, acceptance criteria, instrument requirements, leads to HSE GS38,
              calibration. This is where you find HOW to do every test in the BS 7671 sequence.
            </li>
            <li>
              <strong>Chapter 3 — Periodic inspection.</strong> EICR methodology — sampling, visual
              inspection, what to test (and what to skip), C1/C2/C3/FI coding rubric, report
              production. Includes the frequency table.
            </li>
            <li>
              <strong>Chapter 4 — Inspection and testing of equipment.</strong> Specific equipment
              and special-location considerations. Bonding to extraneous parts, electrode systems,
              RCD/RCBO testing in detail.
            </li>
            <li>
              <strong>Chapter 5 — Model forms and worked examples.</strong> The model Schedule of
              Inspections, model Schedule of Test Results, fully completed example certificates. Use
              these as templates and as cross-checks.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The GN3 Section 5 model is the recognised template. Scheme apps and paper forms are
              typically based on it. Using it (or a scheme derivation of it) means you cover all the
              BS 7671 Reg 642.3 items by default. Adapting for project specifics is expected — add
              Part 7 special-location items where relevant, add bespoke items for unusual
              installations.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Maximum demand</strong> of the installation, in kVA or A — to confirm supply
              and protective devices are adequately sized.
            </li>
            <li>
              <strong>Number and type of live conductors</strong> — single-phase 2-wire, three-phase
              3-wire / 4-wire, plus any control circuits.
            </li>
            <li>
            ...
            <li>
              <strong>Type and rating of overcurrent protective devices</strong> at the origin and
              for each circuit.
            </li>
            <li>
            ...
            <li>
              <strong>Conductor types, sizes, lengths and routes</strong> for each circuit being
          ...
          <p>
            ...
            device (1.37 Ω corrected to 1.10 Ω with the 0.8 multiplier — easy pass). Get the data
            first, then test.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You arrive on a 16-circuit commercial install. No design pack provided. You start the
              dead-test sequence — readings look fine. You sign the EIC based on what appears to be
              a passing set of measurements. Six months later a circuit trips spuriously and the
          ...
          doInstead={
            <>
              Always get the design data before verification. Single-line diagram, circuit schedule,
              Ze and Zs design values, protective device data with breaking capacity, cable sizing
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Domestic — rented (private rental sector).</strong> 5 years (mandatory under
              the Electrical Safety Standards in the Private Rented Sector (England) Regulations
              2020 — landlord duty, criminal offence not to comply).
            </li>
            <li>
            ...
            <li>
              <strong>Hospitals (Group 1).</strong> 5 years; Group 2 critical care areas annual or
              per local clinical engineering policy.
            </li>
            <li>
          ...
          <p>
            ...
            decision" — must be defensible if challenged. Where you set shorter than the table, note
            the rationale (high use, hostile environment, changes since last inspection).
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              low-voltage distribution systems up to 1 kV AC and 1.5 kV DC. The umbrella standard.
            </li>
            <li>
              <strong>BS EN 61557-2.</strong> Insulation resistance testers. Test voltage, accuracy,
            ...
            <li>
              <strong>BS EN 61557-4.</strong> Low-resistance ohmmeters (continuity testers). Test
              current at least 200 mA, open-circuit voltage 4-24 V, accuracy.
            </li>
            <li>
            ...
            <li>
              <strong>BS EN 61557-6.</strong> RCD testers. Test current waveforms (AC, A, F, B type
              compatibility), trip-time accuracy, no-trip current verification.
            </li>
            <li>
              <strong>BS EN 61557-9.</strong> Insulation fault location systems.
            </li>
            <li>
              <strong>BS EN 61557-10.</strong> Multifunction measuring instruments. Combines several
              functions; each must meet the corresponding individual standard.
            </li>
            <li>
              <strong>HSE GS38.</strong> Test leads, probes, and accessories — fused leads, 4 mm
              exposed metal max, no live clip terminations, finger barriers, prove-test-prove
              method.
            </li>
          </ul>
          <p>
            Calibration: typically annual via UKAS-accredited laboratory (or manufacturer service
            centre). Some scheme rules accept user-verification against a calibrated reference but
            this is not the equivalent of formal calibration. Keep certificates for at least the
            next two calibration cycles.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Table 41.3 assumes operating temperature.</strong> The maximum Zs values are
              designed to ensure ADS works under fault, when conductors heat rapidly.
            </li>
            <li>
            ...
            <li>
              <strong>0.8 multiplier compensates.</strong> 1.0 / 1.20 ≈ 0.83, rounded to 0.8 by BS
              7671 for simplicity. Applied to the tabulated value gives the ambient-temperature
              acceptance limit.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Found a circuit live that should be dead.</strong> Re-isolate, identify the
              unexpected source (cross-wired CPC, backfeed from another circuit, supply from a
              separate distribution panel not on the design), document, then proceed.
            </li>
            <li>
              <strong>
                IR reading suspiciously high (open neutral?) or low (incipient fault).
              </strong>
              Investigate before proceeding to live tests — energising into a fault is the failure
              mode this guidance prevents.
            </li>
            <li>
              <strong>Found a special location not on the design.</strong> A bathroom converted to a
              wet room, a swimming pool added in an extension, a livestock pen built onto an
              outbuilding. Add the Part 7 inspection items, reassess Zs limits, RCD type.
            </li>
            <li>
              <strong>Found undocumented protective device.</strong> An RCD added by a previous
              installer, an SPD retrofitted, an AFDD on one circuit. Verify type / rating, add to
              the test plan.
            </li>
            <li>
            ...
            <li>
              ...
              relevant point in the sequence, do not just patch and continue.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BS 7671:2018+A4:2026 — the regulation book.</strong> 600+ pages of regulations
              covering design, construction, inspection, testing. Comprehensive but heavy reading.
              The technical floor.
            </li>
            <li>
              <strong>GN3 9th Edition 2022 + A4 update — inspection and testing guidance.</strong>
              The "how to" for Part 6. Test methods, model forms, frequency tables, worked examples,
              instrument standards.
            </li>
            <li>
              <strong>IET On-Site Guide (OSG) current edition — practitioner reference.</strong>
              Cable size tables for common circuits, standard arrangements (radial, ring, lighting),
              quick reference for the everyday electrician.
            </li>
            <li>
              ...
              shock), GN6 (protection against overcurrent), GN7 (special locations), GN8 (earthing
              and bonding). Each addresses a specific Part of BS 7671 in depth.
            </li>
            <li>
              <strong>
              ...
              Different scope — equipment testing, not installation verification. Don't confuse with
              GN3.
            </li>
          </ul>
          <p>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              lighting circuit L4 (Type B 10 A) as 4.42 Ω. You glance at the BS 7671 Table 41.3
              maximum (4.37 Ω). The reading is over the maximum by 0.05 Ω. Pass or fail?
            </>
          }
          whatToDo={
            <>
              Open GN3 Chapter 2 — measured-versus-tabulated comparison. Tabulated maxima in Table
              41.3 assume conductor at full operating temperature (70°C for thermoplastic). Measured
              values at ambient (typically 15-20°C) are LOWER than they would be at operating
              temperature. GN3 mandates the 0.8 multiplier on the tabulated value for comparison
              with measured: 4.37 × 0.8 = 3.50 Ω. Your reading of 4.42 Ω is well above 3.50 Ω. FAIL.
              Investigate: cable run too long, joint resistance, undersized conductors, or
              terminations not properly tightened. Remedy and retest. Do not certify until Zs is
              below 3.50 Ω at ambient.
            </>
          }
          whyItMatters={
            <>
              Without GN3 you might naively compare 4.42 against 4.37 and conclude "marginal fail by
              0.05 Ω, probably OK". With GN3 you apply the correct multiplier and see the reading is
              about 25% over the corrected limit — a real fault. The 0.8 multiplier is in BS 7671
              Appendix 3 too, but GN3 walks you through the application. This is a typical example
              of why GN3 is essential alongside BS 7671 — it makes the regulation usable.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              2018+A4:2026 edition. This restructuring includes changes to regulation numbering to
              align Part 6 with the CENELEC standard for inspection and testing. Users should not
              rely on pre-A4 regulation numbers when consulting Part 6.
            </>
          }
          meaning={
            <>
              The renumbering of Part 6 means GN3 9th Edition + A4 update is essential — older
              editions of GN3 reference the pre-A4 numbering scheme and will mislead the inspector
              trying to cross-reference. Always work from the current GN3 edition alongside the
              current BS 7671 edition.
            </>
          }
