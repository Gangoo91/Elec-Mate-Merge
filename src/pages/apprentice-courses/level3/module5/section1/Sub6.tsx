...
const checks = [
  {
    ...
    options: [
      'To prove the electrician was on site, charged the right amount, and used the right tools.',
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Initial verification looks for deterioration; periodic looks for new work.',
      ...
      'They are identical.',
      'Initial verification is only for industrial installations.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Always 0.35 Ω regardless of supply.',
      ...
      'Always measured by the homeowner.',
      'Not required.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'A change of designer.',
      'A type of switchgear.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Sign off without testing.',
      'Test only what you can see.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only at handover of the completed building.',
