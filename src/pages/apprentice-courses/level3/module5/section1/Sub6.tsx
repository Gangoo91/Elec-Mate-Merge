...
const TITLE =
  'Initial verification — purpose and information set | Level 3 Module 5.1.6 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question:
      'Per Reg 642.1, the inspector needs to know which of the following BEFORE starting initial verification?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 4,
    question:
      "On a CU change, the inspector needs the original installation's as-built data because:",
    options: [
  ...
  },
  {
    id: 6,
    question:
      "When initial verification information is incomplete or incorrect, the inspector's correct response is:",
    options: [
...
export default function Sub6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 1 · Subsection 6"
        title="Initial verification — purpose and information set"
        backTo="/study-centre/apprentice/level3-module5-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Why we verify, what we verify, and the information you need in hand before starting —
          supply data, ADS arrangement, designer's data, as-built records.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              Section 41 protective measures in place, ADS coordinated, conductors sized for the
              load, IR within thresholds, polarity correct, RCDs operating within tolerances. The
              dead-test and live-test sequences are the methods.
            </li>
            <li>
              <strong>Legal purpose.</strong> Discharge the EAWR Reg 4(1) duty on the contractor —
              "construct so as to prevent danger" — and the Reg 14 duty — "verified before
              energising". Documentation of compliance is the legal evidence the duty was
              discharged.
            </li>
            <li>
              ...
              future alterations, periodic inspection, and any incident investigation. The documents
              have value for the life of the installation.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              measurements without context. With it, every measurement can be compared against a
              designed expectation, deviations spotted, and conclusions drawn. Get the information
              first, then test.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Maximum demand.</strong> Designer's calculation. Used to confirm supply and
              main switch are adequately sized.
            </li>
            <li>
              <strong>Number and type of live conductors.</strong> Single-phase 2-wire, 3-wire (with
              neutral and CPC), three-phase 3-wire (delta) or 4-wire (star with neutral). Affects
              every test sequence and the Schedule of Test Results layout.
            </li>
            <li>
              <strong>Type of earthing arrangement.</strong> TN-S, TN-C-S (PME or PNB under
              A4:2026), or TT. Determines the ADS strategy, electrode requirement, and Ze origin.
            </li>
            <li>
            ...
            <li>
              <strong>Prospective short-circuit current at origin.</strong> From DNO declaration
              (often 16 kA at the origin of typical urban supplies) or measured. Confirms breaking
              capacity of protective devices is adequate per Reg 434.5.
            </li>
            <li>
              <strong>Type and rating of overcurrent protective devices.</strong> MCB / RCBO type
              (B, C, D), rating (A), breaking capacity (kA). For each circuit. Drives the Zs
              comparison against Table 41.3.
            </li>
            <li>
              <strong>RCD types and IΔn values.</strong> AC, A, B, F type — with rated residual
              operating currents (typically 30 mA additional protection, 100 mA / 300 mA for fire /
              equipment protection). Drives the RCD test acceptance.
            </li>
            <li>
              <strong>Conductor types, sizes, lengths, routes.</strong> 1.5 / 2.5 / 4 / 6 / 10 mm²
              typical domestic; T&E flat or singles in conduit etc. Lengths used to compute expected
              R1+R2 from cable data tables. Routes used to identify installation method for
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              — gives them a chance to find it without delaying the project unduly.
            </li>
            <li>
              <strong>If the data cannot be obtained, document a limitation.</strong> The EIC has
              space for limitations ("LIM") — record what couldn't be verified, why, and what the
              duty holder should do (e.g. "cable lengths inaccessible — recommend physical
              investigation at next alteration").
            </li>
            <li>
              <strong>Decide whether verification can proceed.</strong> Some limitations are
              acceptable; others are show-stoppers. Use professional judgement and document the
              rationale.
            </li>
          </ol>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              disappears. No design pack provided. You start the dead-test sequence — readings fine.
              You pick up Ze at the supply intake — 0.45 Ω. You measure Zs at far ends — values come
              in around 0.8-1.2 Ω. You sign the EIC with these values, no idea whether they are
              within design intent. Six months later one circuit trips on a fault that should have
              been within the protective device's clearing time — but the circuit was actually a
              50-metre run on 1.5 mm² cable that needed a Type C 16 A MCB, not the Type B 16 A
              actually fitted. You couldn't catch the design error because you never had the design
              data.
            </>
          }
          doInstead={
            <>
              Demand the design data before starting verification. If it doesn't arrive, stop and
              escalate. If you proceed with limitations, document them clearly on the EIC. The
              verification is only as strong as the information you have to verify against. "I
              tested everything I could see" is not the standard — "I verified compliance with the
              design and identified any deviations" is.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Foreign-standard equipment with documented equivalence.</strong> European or
              international equipment built to a different standard but providing equivalent or
              superior safety. Document the standard reference and the equivalence basis.
            </li>
            <li>
              <strong>Alternative cable type / installation method.</strong> Engineering judgement
              on conductor temperature rise in a specific situation, supported by calculation rather
              than the generic Appendix 4 tables.
            </li>
            <li>
              <strong>Non-standard ADS arrangement.</strong> A design that achieves the Section 411
              protection objective via a non-standard route — e.g. using a contactor-based
              protective device with Class B isolation for a specific industrial process.
            </li>
            <li>
              <strong>Non-standard protective device coordination.</strong> Cascaded back-up fuse
              arrangement per manufacturer's tested coordination tables (Reg 434.5.1 exception).
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              limited to terminations at CU and at accessories. Recommend physical investigation at
              next alteration."
            </li>
            <li>
              ...
              window. Live-test sequence applied; dead-test sequence limited to circuits able to be
              isolated within the maintenance window."
            </li>
            <li>
              <strong>Furniture / fitted-furniture obstructing access.</strong> "Sockets behind
              fitted kitchen units inaccessible — visual confirmation limited to power availability
              via test plug. Recommend access at next kitchen refurbishment."
            </li>
            <li>
              <strong>Missing documentation on existing installation.</strong> "No design data or
              previous EIC available for the original 1980s installation. Verification limited to
              current condition assessment against current BS 7671 standards. Recommend
              reverse-engineered design assessment if alterations are planned."
            </li>
            <li>
              <strong>Special location items not fully assessable.</strong> "Section 705
              equipotential plane in the milking parlour cannot be verified for continuity without
              exposure of buried bonding mesh. Surface continuity at exposed equipment tested;
              underlying mesh integrity assumed per as-built records."
            </li>
          </ul>
          <p>
            Each limitation reduces the verification scope. The aggregate of limitations may warrant
            a recommendation for follow-up work. On EICR, individual limitations may attach to
            specific items; overall extent / limitations sit in Section D of the report front sheet.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              capacity for the new circuit. Confirm the existing earthing / bonding remains adequate
              (Table 54.7 / 54.8 still met for the new total demand). Confirm the existing
              protective devices haven't been disturbed.
            </li>
            <li>
              <strong>Maximum demand recalculation.</strong> Add the new load to the assumed
              existing demand. Confirm the supply / main switch / tails are still adequate. Notify
              the DNO if the new load exceeds the supply allocation.
            </li>
            <li>
              <strong>Special location triggered by the new work.</strong> Adding an EV charger
              creates a Section 722 location. Adding a swimming pool creates a Section 702 location.
              The Part 7 items apply to the new installation in the new location.
            </li>
            <li>
              <strong>Documentation update.</strong> Update the circuit chart at the CU. Update the
              single-line diagram if applicable. Update the inspection date notice if the next
              interval changes.
            </li>
          </ul>
          <p>
            The EIC for additions / alterations records the new work specifically. The supply
            characteristics section may include the existing values (Ze, PFC) confirmed during the
            verification. Departures specific to the new work are recorded; existing non-compliances
            are noted as observations but not the focus of this EIC.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              penetrations. Photograph everything that will be hidden. This is the only chance to
              verify Reg 522.6 zone compliance for cables that will be permanently inaccessible.
            </li>
            <li>
            ...
            <li>
              <strong>Functional and commissioning.</strong> Switchgear, interlocks, controls, fire
              alarm interfaces, BMS. Verifies the installation works for its intended use.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Alterations and additions.</strong> Cable sizes, protective device data, ADS
              arrangement all needed to size new circuits and confirm capacity.
            </li>
            <li>
            ...
            <li>
              <strong>Property sale and conveyancing.</strong> Solicitors check for current EICR and
              / or recent EIC. Missing documentation can delay or prevent a sale.
            </li>
            <li>
              <strong>Insurance claims.</strong> Following any electrical incident, insurers request
              the verification documentation. Missing or incomplete records can affect claim
              outcomes.
            </li>
            <li>
              <strong>Building Safety Act compliance (HRRBs).</strong> Higher-risk residential
              buildings have specific documentation retention requirements via the Building Safety
              Regulator.
            </li>
            <li>
              <strong>Scheme audit.</strong> The verification record is what your scheme assessor
              will examine on audit visits.
            </li>
            <li>
              <strong>HSE investigation.</strong> Following any reportable electrical incident, the
              verification documentation is one of the first things HSE will request.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A client has bought a 1980s detached house and wants the original ageing CU replaced
              with a modern 18th Edition compliant unit including AFDDs on bedroom circuits per
              A4:2026 Reg 421.1.7 recommendations. No historical EIC is available. Original circuit
              chart is faded and partial. You need to plan the verification.
            </>
          }
          whatToDo={
            <>
              Pre-quote stage: site visit to map the installation. Identify each circuit at the
              existing CU, trace where it goes (lighting circuits, ring finals, immersion, cooker,
              shower). Note cable types/sizes visible at the CU (you may need to lift some boards to
              get a clearer picture). Identify earthing arrangement (TN-S, TN-C-S, or TT) at the
              supply intake. Measure Ze. From this data construct the verification baseline yourself
              — expected Zs for each circuit, appropriate protective device sizes, RCD types based
              on downstream loads (Type A for any circuit feeding electronic equipment with DC
              components). Document your reverse-engineered design. Quote on basis of CU change +
              new EIC + full dead + live test sequence on every circuit. On the day, isolate, fit
              the new CU per your designed schedule, dead-test every circuit, energise per the test
              sequence, live-test, complete EIC + Schedule of Inspections + Schedule of Test
              Results, hand-over with new circuit chart and Reg 132.13 documentation. The reverse-
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              service, be inspected and tested to verify, so far as is reasonably practicable, that
              the requirements of BS 7671 have been met.
            </>
          }
          meaning={
            <>
              Initial verification is the regulatory anchor — every installation, every time, before
              energising. The legal companion is the Electricity at Work Regulations 1989, Reg 4(1)
              which makes maintaining the system safe a statutory duty. Initial verification
              provides the evidence that the duty was discharged at handover.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The verification process has a fixed sequence — inspection first, dead tests next,
              live tests last, all with the relevant part disconnected from the supply during the
              inspection. Pulling the sequence apart risks missing visible defects that should have
              been found before the meter ever went on the kit.
            </>
          }
        ...
        <Quiz
          title="Initial verification purpose & information set — knowledge check"
