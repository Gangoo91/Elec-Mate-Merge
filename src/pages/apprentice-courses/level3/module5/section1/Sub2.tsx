...
const quizQuestions = [
  {
    id: 1,
    question:
      'BS 7671 Reg 642.3 lists items to be checked during initial inspection. The IET position on this list is:',
    options: [
  ...
  },
  {
    id: 2,
    question:
      'On the Schedule of Inspections, item 1 ("Methods of protection against electric shock") would tick boxes for:',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'Reg 643.1 specifies the test sequence. Which of the following correctly orders the dead-test sequence?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'What is the difference between "design", "construction" and "inspection and testing" on the EIC?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 641 (general principles), Reg 642 (visual inspection items), Reg 643 (testing), Reg
          644 (certification) — the four-regulation backbone of initial verification, plus the
          Appendix 6 forms.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              service" — and "during erection" where applicable. You don't wait until the building
              is finished — you verify as you go, then a final verification before first
              energisation.
            </li>
            <li>
            ...
            <li>
              <strong>Departures.</strong> If something complies with an alternative standard or a
              designed exception, that must be documented as a "departure from BS 7671" on the EIC,
              with the alternative standard or technical justification clearly stated.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              Apply the SFAIRP test. The phrasing intentionally mirrors the EAWR formulation — BS
              7671 Part 6 is the technical mechanism by which a duty holder discharges the statutory
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              basic protection (insulation, barriers, enclosures, placing out of reach, obstacles)
              AND fault protection (ADS, Class II, electrical separation, SELV/PELV).
            </li>
            <li>
              <strong>Identification of conductors</strong> (Section 514) — line/neutral/CPC colours
              per Reg 514.3, switching identification, BS 951 warning notice for connections to
              lightning protection earthing.
            </li>
            <li>
              <strong>Cables for current-carrying capacity</strong> — appropriate to design load and
              circuit length.
            </li>
            <li>
            ...
            <li>
              ...
              enclosures, heat sources spaced from combustible materials, AFDD recommendations under
              Reg 421.1.7.
            </li>
            <li>
              <strong>Earthing arrangements and main equipotential bonding</strong> — to Section 411
              requirements, conductor sizes per Section 543 and 544.
            </li>
            <li>
          ...
          <p>
            ...
            location-specific items. A swimming pool installation needs the Section 702 items. A
            medical location needs Section 710. A construction site needs Section 704.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 642.3 is the formal inspection items list. The "where relevant" phrase recognises
              that not every item applies to every install — but where they do apply, they must be
              checked and recorded on the Schedule of Inspections. Ticking everything as "OK"
              without actually checking is professional misconduct and creates legal liability if a
              defect later causes harm.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Continuity of protective conductors (Reg 643.2).</strong> Proves the earth
              path is intact. Without this, no fault current can flow and ADS cannot operate. Test
              FIRST because everything else assumes the protective path is good.
            </li>
            <li>
              <strong>Continuity of ring final live conductors (Reg 643.2.1(b)).</strong> Where a
              ring final is installed — the three-part test (covered in L2 M4 §6.2). Proves the ring
              is actually a ring.
            </li>
            <li>
              <strong>Insulation resistance (Reg 643.3).</strong> 500 V DC for circuits up to 1000 V
              (250 V for SELV/PELV). Acceptance: at least 1 MΩ for LV circuits per Table 64, at
              least 0.5 MΩ for SELV/PELV at 250 V. Tests live conductors against each other and
              against earth — no fault current paths within the installation.
            </li>
            <li>
              <strong>Polarity (Reg 643.6 — dead).</strong> Single-pole devices in the line, line on
              the right terminals, BC/ES outer contacts on neutral. Done dead with the continuity
              tester to confirm the line side is what it should be.
            </li>
            <li>
              <strong>Earth electrode resistance (Reg 643.7.2 — TT only).</strong> Three-pole
              fall-of-potential method or stake-less loop tester depending on conditions. Acceptance
              for TT: low enough that Zs times IΔn does not exceed 50 V.
            </li>
            <li>
            ...
            <li>
              <strong>Earth fault loop impedance Ze and Zs (Reg 643.7.3).</strong> Live measurement
              at the origin (Ze) and at far ends of circuits (Zs). Compare to A4:2026 Table 41.3 max
              values, applying the 0.8 multiplier for measured-to-tabulated comparison.
            </li>
            <li>
              <strong>Prospective fault current PFC (Reg 643.7.3.201).</strong> Calculated from Zs
              or measured directly. Confirms protective devices have adequate breaking capacity per
              Reg 434.5.
            </li>
            <li>
            ...
            <li>
              ...
              button, confirm operation. AFDD recommendation under Reg 421.1.7 in A4:2026.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              before energisation; live tests (643.7 onwards) follow once safe. If a fault is found
              mid-sequence, remedy it AND repeat that test plus any earlier tests it could have
              influenced — you cannot just patch the fault and continue. This protects against tests
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              Inspection & Testing. Records the installation address, supply characteristics (TN-S /
              TN-C-S / TT, Ze, PFC, prospective short-circuit at origin), the
              designer/installer/inspector details, departures from BS 7671 if any, and the next
            ...
            <li>
              ...
              include circuit description, conductor size, protective device type/rating, RCD IΔn,
              Zs (calc and/or measured), R1+R2, IR L-N / L-E / N-E, RCD trip time, polarity tick.
              The data backbone of the EIC.
            </li>
            <li>
          ...
          <p>
            ...
            required by scheme rules) AND by the duty holder (for ongoing maintenance and future
            inspections). Best practice: retain for the life of the installation.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You sign and hand over an EIC. The Schedule of Inspections is blank ("we ticked it on
          ...
          doInstead={
            <>
              Always issue the full set: EIC + complete Schedule of Inspections + populated Schedule
              of Test Results. Every Reg 642.3 inspection item ticked (or marked N/A with reason).
              Every circuit row complete with Zs, R1+R2, IR readings, RCD trip time, polarity. The
              schedules ARE the evidence. The EIC summarises and certifies them. Without the
              schedules the EIC is just a signature on a sheet.
            </>
          }
        />
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              operating current. Acceptance: a general (non-delay) RCD must disconnect within 300
              ms; an 'S' (time-delayed) type between 130 ms and 500 ms. There is no separate site
              test at multiples of IΔn — the old ×5 IΔn / 40 ms check has been removed.
            </li>
            <li>
          ...
          <p>
            What is gone: 0.1×IΔn no-trip test (deleted), 1×IΔn trip test for additional protection
            (deleted from site test — handled in design / device standard), Table 3A trip-time
            matrix (deleted). The integral test button still required for confirmation of mechanical
            operation, but the electronic device behaviour is verified by the single AC test.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Common Type B MCB max Zs values from A4:2026 Table 41.3 (230 V, 0.4 s disconnection):
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            Type C devices need lower Zs (faster magnetic trip needs more fault current). Type D
            needs lower still. Always check the table for the device type in front of you. For 5 s
            disconnection circuits (distribution circuits per Reg 411.3.2.3) the max Zs values are
            higher — different table column.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PME (Protective Multiple Earthing).</strong> DNO bonds combined PEN to earth
              at multiple points on the LV network (substation neutral, joint pits, supply heads).
              Customer connects earthing conductor to the DNO supply terminal. Ze typically 0.1-0.35
              Ω. Diverted neutral current under PEN failure is the design concern that drives Table
              54.7 / 54.8 PME columns.
            </li>
            <li>
              <strong>PNB (Protective Neutral Bonding) — A4:2026 designation.</strong> The customer
              bonds the supply neutral to earth at the customer intake — typically where the supply
              enters a private network and the customer is the distribution operator. Common in
              private estates, larger commercial sites with private substations. Same TN-C-S
              customer-side topology as PME, but the bond is a customer responsibility.
            </li>
            <li>
              <strong>EIC implications.</strong> The A4:2026 EIC includes a tick for both PME and
              PNB so the actual arrangement is recorded. Misidentifying PNB as PME on the EIC
              misattributes the bond responsibility — future inspectors and the duty holder may not
              realise the customer maintains the bond.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Circuit identification chart at every consumer unit / DB (Reg 514.9).</li>
            <li>Single-line distribution diagram for installations with sub-DBs / sub-mains.</li>
            <li>Manufacturer literature for protective devices (MCBs, RCBOs, AFDDs, SPDs).</li>
            <li>
              Test button operation instructions for RCDs / RCBOs / AFDDs — typically a notice near
              the CU.
            </li>
            <li>SPD status interpretation guide where SPDs installed.</li>
            <li>
              Inspection date notice per Reg 514.12 — recommended next inspection, contractor /
              scheme details.
            </li>
            <li>
              EIC + Schedule of Inspections + Schedule of Test Results — the verification record.
            </li>
            <li>Building Regulations Compliance Certificate where Part P notifiable.</li>
            <li>
          ...
          <p>
            Failure to leave adequate Reg 132.13 documentation is a verification omission. The duty
            holder cannot discharge the EAWR Reg 4(2) ongoing duty without the information to
            identify, isolate, and maintain the installation. Document the handover and ideally
            retain proof of receipt.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A homeowner has had their kitchen extended. Your work: extend the existing 32 A ring
              final into the new section by adding three new sockets to the loop. No new circuit
              installed; the ring is altered in length and accessories. Existing CU, existing
              protective device, existing ADS arrangement. Test results all pass.
            </>
          }
          whatToDo={
            <>
              Issue a Minor Works Certificate. The criterion for MWC is: addition or alteration to
              an existing circuit, with no new circuit added. Adding sockets to an existing ring is
          ...
          whyItMatters={
            <>
              Picking the right document matters legally and practically. Issuing a full EIC for a
              few extra sockets is overkill (and might imply you re-tested every other circuit which
              you did not). Issuing nothing is non-compliant — every alteration must be certified
              under BS 7671 Part 6. The MWC is the right-sized tool for the job. Conversely, if the
              homeowner had asked for an additional radial circuit for a kitchen island, that would
              be a NEW circuit and an EIC would be required, even if only that single circuit is on
              the certificate.
            </>
          }
        />
