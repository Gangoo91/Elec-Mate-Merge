...
const checks = [
  {
    ...
    options: [
      'That the installation will pass periodic inspection in five years.',
      ...
      'That the design is the cheapest option available.',
      'That the client is happy with the installation aesthetically.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only on the consumer unit.',
      'Once a year, regardless of when the install was completed.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'For any work in a domestic property.',
...
const quizQuestions = [
  {
    ...
    options: [
      'It is exhaustive — only those items need checking.',
      ...
      'It is purely advisory and can be ignored.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only basic protection (insulation of live parts).',
      ...
      'Neither — that is on the EIC, not the Schedule.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Insulation resistance then continuity then polarity then ring final then earth electrode resistance.',
      ...
      'Polarity then IR then continuity then Zs.',
      'There is no required order — tests can be carried out in any sequence.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Was originally compliant when installed.',
      ...
      'Could be improved cosmetically.',
      'Has been used by competent operators.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A copy of the EIC be sent to HSE.',
      ...
      'A spare consumer unit be left on site.',
      'A signed receipt from the customer.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The model forms are the only legally acceptable formats.',
      ...
      'You can use any form you like provided you call it an EIC.',
      'Form templates change every year.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Always the same person who signs construction and test.',
