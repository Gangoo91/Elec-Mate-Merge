...
const checks = [
  ...
  },
  {
    ...
    question:
      'A commercial site has solar PV, a standby generator, and a UPS. To safely isolate a circuit fed from the main board:',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      'A two-pole voltage indicator (rather than a multimeter) is preferred for proving dead because:',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'When carrying out safe isolation in a domestic property where the occupier is at home, the implications to consider include:',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Three-phase isolation, multi-source installations (PV, generators, UPS), permits to work,
          and the safety-system thinking around inspection and testing.
        </p>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>At the work location: L1 to N, L2 to N, L3 to N — three readings.</li>
          ...
          <p>
            ...
            confirms a different potential difference is zero. A single reading shortcut is the path
            to the kind of incident that ends careers and lives.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              tips, clip-on-live) is a flagged item on any HSE inspection and a contributory factor
              in many shock incidents.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Isolate each source at its dedicated isolator.</strong> Solar PV at the AC
              isolator (and DC isolator on the array side if working on DC components). Generator at
              the changeover switch and the generator output. UPS at the bypass switch and the
              battery isolator if working on the UPS.
            </li>
            <li>
            ...
            <li>
              <strong>Wait for capacitive discharge if applicable.</strong> Some equipment (filters,
              capacitor banks, large variable-speed drives) holds charge for seconds to minutes
              after isolation. Check the manufacturer data.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>The public.</strong> If the work is in or affects public-accessible spaces
              (shops, restaurants, public buildings), loss of lighting, escape route lighting,
              payment systems may all be affected. Safety implications must be considered.
            </li>
            <li>
              <strong>Building systems.</strong> Fire alarms (panel goes into fault), automatic
              doors stop, emergency lighting batteries take over (time-limited), HVAC controls lose.
              In commercial environments, brief facilities and IT in advance.
            </li>
            <li>
              <strong>Safety-critical equipment.</strong> Medical (CPAP, dialysis, oxygen
              concentrators), security (alarms, CCTV), data (servers, backup systems). Plan for
              continuity using temporary supplies if needed.
            </li>
          </ul>
          <p>
            The implications of NOT isolating are far worse: shock, burn, arc flash injury to the
            worker; cascading damage if a fault is created; injury or death to others if
            consequences spread. EAWR Reg 4 obliges you to take precautions — and Reg 14 makes dead
            working the default. Isolation done badly causes inconvenience; not isolating causes
            incidents.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You arrive at a small commercial unit to investigate a tripping circuit. The board is
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Isolation (Section 537.2).</strong> Reliable separation, all live conductors
              of the supply (line + neutral on TT; line on TN), means to prevent re-energisation.
              Lockable. Used before working on the circuit.
            </li>
            <li>
            ...
            <li>
              <strong>Emergency switching (Section 537.4).</strong> Single action to remove supply
              quickly. Mushroom-head emergency stop is the typical device. Identified by a red
              operator on yellow background.
            </li>
            <li>
              <strong>Functional switching (Section 537.5).</strong> Normal operation on/off — light
              switch, socket switch, equipment on/off. Does not need to provide reliable separation;
              cannot be relied on for isolation.
            </li>
          </ul>
          <p>
            ...
            equipment, functional switches for normal control. Mixing them up creates a safety gap.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Issuing authority.</strong> The person responsible for the system who confirms
              it is in a safe state to work on. Often the duty holder's representative or an
              authorised engineer.
            </li>
            <li>
              <strong>Receiving worker.</strong> The competent person who accepts the permit and
              carries out the work within scope.
            </li>
            <li>
            ...
            <li>
              <strong>Identified hazards and precautions.</strong> Live parts identified, isolation
              arrangements, lock-off positions, parallel sources, additional PPE, emergency
              arrangements.
            </li>
            <li>
              <strong>Limits of work.</strong> What is permitted. What is excluded (don't open this
              panel, don't touch this circuit). Clear scope boundaries.
            </li>
            <li>
            ...
            <li>
              <strong>Cancellation / completion sign-off.</strong> Worker confirms work complete and
              area left safe. Issuing authority confirms acceptance and restores the system.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Variable speed drives (VFD / VSD).</strong> DC bus capacitors hold hundreds of
              volts for several minutes. Manufacturer specifies wait time — typically 5-15 minutes.
              Some VFDs have automatic discharge; check before assuming.
            </li>
            <li>
              <strong>Capacitor banks for power factor correction.</strong> Hold full line voltage
              briefly; discharge resistors typically bring this down within 60 seconds but check
              rating.
            </li>
            <li>
            ...
            <li>
              ...
              disconnected via the battery isolator. Even with the AC isolated, the DC bus is live
              from the battery.
            </li>
            <li>
              <strong>PV combiner boxes.</strong> The DC array side is live whenever sunlight is
              present. Even at dawn / dusk small voltages can be present. Cover the array with
              opaque material if working on the DC side.
            </li>
            <li>
              <strong>Large luminaires / signage with power supplies.</strong> Some LED drivers hold
              capacitor charge for tens of seconds after isolation.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              Single-line diagram, circuit chart, physical inspection. Multi-source installs require
            ...
            <li>
              <strong>3. Secure (lock off and tag).</strong> Padlock + hasp + tag with name, date,
              work description. Multiple workers each fit their own padlock on the hasp.
            </li>
            <li>
              <strong>4. Prove the voltage indicator.</strong> Test the indicator on a known live
              source — proving unit OR a known-live socket. Confirms the indicator is working before
              the safety-critical reading.
            </li>
            <li>
              <strong>5. Prove dead at the work location.</strong> Use the indicator to confirm ALL
              conductors are dead at every conductor pair appropriate to the circuit. THEN re-prove
              the indicator on the known live source to confirm it didn't fail during the test.
            </li>
          </ol>
          <p>
            Steps 4 and 5 together form the prove-test-prove sequence. Step 5 has TWO parts — prove
            dead at the work, then re-prove indicator. Skipping the re-prove means a "dead" reading
            might just be a faulty indicator. The two-stage prove + re-prove is what makes this
            safe.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single function.</strong> No selectable ranges — voltage is what it does. A
              multimeter on Ω instead of V will read "0" on a live circuit, falsely indicating dead.
            </li>
            <li>
              <strong>No battery dependency for the reading.</strong> Voltage indication is by
              physical phenomenon (LED bar from voltage divider, solenoid lift). Even if the battery
              is dead, the indication still works.
            </li>
            <li>
              <strong>Current-limited.</strong> Most quality two-pole indicators draw a small load
              current to discriminate against capacitively-coupled "ghost" voltages. Multimeters
              with high input impedance can read floating ghosts as significant voltages.
            </li>
            <li>
            ...
            <li>
              <strong>Rugged.</strong> Designed for site use — drop-resistant, IP-rated for damp
              conditions, simple to operate with gloved hands.
            </li>
            <li>
              <strong>Multimeter still useful.</strong> For measurement (actual voltage value,
              resistance, continuity). But the dedicated indicator is the right tool for prove dead.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              overnight, a tropical fish tank with sensitive equipment, and works from home with a
              desktop PC. The work is expected to take 4-5 hours.
            </>
          }
          whatToDo={
            <>
              ...
              bridge the supply loss (or warn the customer to source one). Identify and brief the
              customer on which circuits will be off and when. On the day, isolate at the main
              switch, lock off, prove dead, complete the CU change including all dead tests on each
              circuit, energise per the test sequence, restore supply, brief the customer on the new
              CU, hand over EIC pack. Total downtime contained, customer impacts mitigated, no
              surprises.
            </>
          }
          whyItMatters={
            <>
              ...
              without warning. Customer service AND safety are both well-served by planning the
              implications of isolation alongside the technical work itself.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Safe isolation is the doorway into the inspection itself — Regulation 642.1 requires
              the inspection to take place with the relevant part of the installation disconnected.
              Multi-source installations (PV, BESS, generators) make &quot;disconnected from the
              supply&quot; a non-trivial test in itself; every source has to be addressed before the
              inspection begins.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The DC isolation requirement on PV is the one that catches new inspectors out — a PV
              array stays live during daylight even after the AC side is open. Section 712
              (rewritten in A4:2026) is the regulatory home for the DC isolation arrangement. Pre-A4
              reference material should be cross-checked.
            </>
          }
