...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'Only on industrial sites.',
      'Never — they are bureaucratic.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only first aid for electric shock.',
  ...
  },
  {
    ...
    options: [
      'Are optional and only used in factories.',
      ...
      'Are required only on three-phase installations.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only the equipment.',
      'Nobody — the risk is exaggerated.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only loss of electric kettles.',
      'Only effects on lighting.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Test the circuit, then test the meter.',
      ...
      'Test the voltage three times.',
      'Only relevant for HV work.',
    ],
    correctAnswer: 1,
    explanation:
