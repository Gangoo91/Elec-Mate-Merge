...
const checks = [
  {
    ...
    question:
      'Under Building Regulations Part P (England), notifiable electrical work in dwellings can be certified via:',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A new circuit installed in a dwelling kitchen is notifiable under Part P. The contractor is a NICEIC-registered domestic installer. The compliance route is:',
    options: [
  ...
  },
  {
    id: 2,
    question:
      'On a new build of a 12-flat block, the design has been done by a consulting engineer, the construction by Contractor A, and the inspection and testing by Contractor B. On the EIC, the signature blocks should be:',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'A client requests an EIC be back-dated to before the installation actually started. You should:',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'A client moves into a property and contacts you for an EICR. They have no historical EIC for the installation. Your approach:',
    options: [
...
const faqs = [
  {
    question:
      'What is the difference between a "Domestic Installer" scheme and a "Full Scope" scheme?',
    answer:
  ...
  {
    question:
      "Do I need to notify Building Control if I'm only adding a socket to an existing ring?",
    answer:
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 1 · Subsection 4"
        title="The scheme certification chain"
        backTo="/study-centre/apprentice/level3-module5-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          From signed EIC through scheme portal upload, building control notification, and customer
          pack hand-over — the chain that turns a verified installation into a properly certified
          one.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Part P self-certification.</strong> You can do notifiable work in dwellings
              and have your scheme generate the Building Regulations Compliance Certificate.
            </li>
            <li>
              <strong>Online certification portals.</strong> Generate EIC, MWC, EICR via the scheme
              app or portal — automatic format compliance, integrated test instrument upload,
            ...
            <li>
              <strong>Customer-facing trust mark.</strong> The scheme logo signals competence and
              recourse if things go wrong.
            </li>
            <li>
              <strong>Audit regime.</strong> Annual or periodic scheme assessor visits — inspect
              recent jobs, verify certification quality, check instrument calibration. This is what
              makes the trust mark meaningful.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              dwellings. Notifiable work has to be either self-certified by a registered competent
              person via their scheme, or notified to building control with third-party inspection.
              The scheme route is the practical one for most contractors. Wales has its own
              equivalent. Scotland has Section 6 of the Building Standards. Northern Ireland follows
        ...
        >
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Upload to the scheme portal.</strong> Most schemes now require digital logging
              within 30 days of completion. The portal validates the form is complete and
              consistent.
            </li>
            <li>
              <strong>Building control notification.</strong> For Part P notifiable work in
              dwellings, the scheme notifies the local authority building control department on your
              behalf. You don't need to do this separately.
            </li>
            <li>
              <strong>Building Regulations Compliance Certificate issued.</strong> The scheme
              generates this and either sends it directly to the client or makes it available to you
              to hand over.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Notifiable.</strong> New circuit. CU replacement (full or split). Any work in
              a Section 701 bathroom that is not minor repair. Work in special locations (swimming
              pools, saunas). Work that adds to or modifies the earthing arrangement at the supply
              intake.
            </li>
            <li>
              <strong>Non-notifiable but still requires certification.</strong> Adding a socket to
              an existing ring final in a non-special location. Adding a light fitting on an
              existing circuit. Replacing a damaged accessory like-for-like. Repair work that does
              not extend or alter the circuit. (Issue MWC.)
            </li>
            <li>
          ...
          <p>
            Wales has its own equivalent (Building Regulations Approved Document P-Wales). Scotland
            follows Section 6 of the Building Standards Technical Handbooks. Northern Ireland
            follows similar requirements via its own Building Regulations. Always check the
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Site visit.</strong> Assessor selects 1-3 recent jobs from your portal, visits
              site (with the customer's permission), inspects the installed work against what the
              EIC says was done.
            </li>
            <li>
            ...
            <li>
              <strong>Competent person review.</strong> The qualifying supervisor / competent person
              remains current — recent CPD, awareness of A4:2026 changes, ongoing qualification.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Age of installation.</strong> New installs have full design certainty; older
              installs may have multiple owners and undocumented alterations.
            </li>
            <li>
              <strong>Defects identified.</strong> Even if not C1/C2, multiple C3s might warrant a
              shorter cycle to monitor deterioration.
            </li>
            <li>
            ...
            <li>
              <strong>Statutory or contractual requirements.</strong> Private rental sector (5 years
              statutory). Insurance contracts may impose specific intervals.
            </li>
          </ul>
          <p>
            Record the rationale on the EIC / EICR — short sentence is enough. "Recommended next
            inspection: 5 years per GN3 commercial premises, no factors elevating to shorter cycle."
            If challenged later, the documented rationale demonstrates the decision was informed.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              Inspections + Schedule of Test Results. Three signature blocks: design, construction,
              inspection &amp; testing.
            </li>
            <li>
              <strong>CU replacement (consumer unit change).</strong> EIC + schedules. Every circuit
              downstream is being newly verified through the new CU. EIC is the only appropriate
              form.
            </li>
            <li>
              <strong>New circuit added to existing installation.</strong> EIC + schedules covering
              the new circuit. The rest of the installation is not re-verified — the EIC is for the
              new work specifically.
            </li>
            <li>
              <strong>Addition / alteration with NO new circuit.</strong> MWC. Records the affected
              portion, test results for the altered portion, confirms existing installation safety
              not impaired.
            </li>
            <li>
            ...
            <li>
              <strong>
                One-off investigation (e.g. fault diagnosis, condition assessment for insurance).
              </strong>{' '}
              Investigation report — not a BS 7671 model form, but should include all relevant
              findings, test results, and a clear conclusion. Sometimes referred to as an Electrical
              Installation Condition Report Restricted Scope or similar scheme-specific terminology.
            </li>
          </ul>
          <p>
            Each form has a different legal weight and a different scheme audit position. Using the
            wrong form is a verification flaw — and on Part P notifiable work, the wrong form can
            mean the work isn't notified correctly via the scheme.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Contractor.</strong> Best practice — life of the business. Minimum — period of
              professional indemnity coverage (typically 6-10 years) plus any contractual retention
              period. Cloud storage cheap, paper storage bulky and vulnerable.
            </li>
            <li>
            ...
            <li>
              <strong>Customer / duty holder.</strong> Best practice — life of the installation. The
              certificate is the duty holder's evidence of due diligence and is needed for future
              EICRs and at any point of property sale.
            </li>
            <li>
              <strong>Building control.</strong> Notification records retained per local authority
              policy, typically several years minimum.
            </li>
            <li>
              <strong>Test instrument calibration certificates.</strong> Retain at least the most
              recent two cycles. Schemes may audit calibration.
            </li>
            <li>
              <strong>Design data and as-built records.</strong> Retain for the life of the business
              — particularly important for commercial / industrial work where future alterations
              need the design baseline.
            </li>
            <li>
              ...
              Cloud-back-up. Use these to defend any future query about what was actually installed.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Five-minute hand-over conversation. Show them the new CU, demonstrate the test buttons
              on the RCBOs and AFDDs (press, observe trip, reset). Explain the test buttons should
              be operated quarterly and after any unusual electrical event. Walk through the EIC
              pack briefly — what the headline EIC says, where the schedules are. Show them the
              recommended next inspection date (typically 10 years for owner-occupied dwelling).
              Explain the Building Regulations Compliance Certificate will arrive separately from
              the scheme. Hand over your contact details in case they have questions or notice
              anything odd. Confirm where they should store the documentation (often inside the CU
              door or with house deeds). Submit the portal upload. Job done.
            </>
          }
          whyItMatters={
            <>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Initial verification is not optional and not deferrable. The duty bites at the point
              the installation is put into service — every install gets inspected and tested first.
              The EIC is the deliverable that records the verification took place and what it found.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Inspection first, dead tests next, live tests last — and the inspection part normally
              happens with the kit isolated. This sequence is hard-wired into the EIC and the
              schedule of inspections; an inspector who pads through the dead tests first risks
              missing visible defects that should have been picked up before any meter went on the
              kit.
            </>
          }
