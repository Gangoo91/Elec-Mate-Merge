...
const checks = [
  ...
  },
  {
    ...
    options: [
      'Holding any electrical qualification at any level.',
      ...
      'Being supervised by another electrician at all times.',
      'Holding a Gold ECS card.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'BS 7671 is itself a statutory instrument and has the force of law.',
      ...
      'BS 7671 has no legal status whatsoever.',
      'BS 7671 only applies to new installations, never to existing ones.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'The wholesaler who sold the cable.',
      ...
      'The CEO of the contracting company.',
      'The apprentice who carried out the dead tests.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'This is fine because it is dead work.',
      'This is acceptable as long as the apprentice has BS 7671 to hand.',
      ...
      'This is fine because the apprentice can call the supervisor by phone.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    question: 'HSR25 is:',
    options: [
      'The High Speed Rail testing standard.',
      ...
      'A British Standard for cable insulation.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'No regulations — it\'s the inspector\'s job, not the duty holder\'s.',
      'Only the Building Regulations.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'No issue — the EIC was signed in good faith.',
      ...
      'It\'s the apprentice\'s fault for not testing properly.',
      'Wait until the next periodic inspection.',
    ],
    correctAnswer: 1,
    explanation:
