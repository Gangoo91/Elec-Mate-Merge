...
const TITLE =
  'The statutory framework for inspection and testing | Level 3 Module 5.1.1 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    question:
      'Under EAWR Reg 4(1), the duty to construct, maintain and use systems so as to prevent danger applies to:',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'EAWR Reg 14 prohibits work on or near live equipment unless three conditions are met. Which one is NOT one of those conditions?',
    options: [
  ...
  },
  {
    id: 2,
    question:
      'During a Schedule of Test Results entry on a new install, who is the "person responsible for the safety of the electrical installation" referred to on the EIC?',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'A first-year apprentice is asked to carry out the dead tests on a kitchen rewire alone, with the supervisor on a different site. Under EAWR Reg 16:',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'BS 7671 Part 6 (Inspection and Testing) is divided into chapters. Which chapter contains the requirements for INITIAL verification?',
    options: ['Chapter 64.', 'Chapter 62.', 'Chapter 65.', 'Chapter 66.'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 6,
    question:
      'A duty holder who allows an unsafe electrical installation to remain in service after an EICR has identified a C2 (potentially dangerous) defect is potentially in breach of:',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'You are inspecting an existing TT installation and find the earth electrode resistance has degraded to 800 Ω over time, with only an RCD as ADS. The C-coding for this on the EICR would be:',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'On a brand-new install, the contractor signs the EIC. They later discover a wiring error that creates a Class I metallic enclosure with no CPC connection. Their position under EAWR is:',
    options: [
...
const faqs = [
  ...
  {
    question:
      'What is the difference between a duty holder, a competent person, and the person carrying out the work?',
    answer:
  ...
  {
    question:
      'How do I balance "must work dead" (Reg 14) with the live tests required by BS 7671 (Zs, EFLI, RCD)?',
    answer:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/level3-module5-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          EAWR 1989, HSR25, BS 7671 Part 6 and the chain of duty that turns every test you carry out
          into a legal act of verification. The L3 lift on what L2 introduced.
        </p>
        ...
        >
          <p>
            ...
            locations. It applies to the duty holder, the employer, the employee, the self-employed.
          </p>
          <p>The four regulations that bear most directly on your inspection and testing work:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 3 — Duty holders.</strong> Defines who carries the duties imposed by the
              rest of the regulations. Multiple people can be duty holders for the same installation
              simultaneously, each in respect of the matters within their control.
            </li>
            <li>
            ...
            <li>
              ...
              done live, AND (c) suitable precautions have been taken to prevent injury. All three
              conditions must be met.
            </li>
            <li>
              <strong>Reg 16 — Persons to be competent to prevent danger and injury.</strong> No
              person shall be engaged in any work activity where technical knowledge or experience
              is necessary to prevent danger or injury, unless they possess such knowledge or
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              just with its installer. From the moment a client signs for an EIC, they (or whoever
              takes responsibility for the building) become the Reg 4(2) duty holder. That duty
              includes commissioning periodic inspection (the EICR), acting on identified defects,
              and not allowing the installation to deteriorate to the point of danger. This is the
              legal basis for retest intervals and the EICR coding framework you will use later in
              this module.
            </>
          }
        ...
        >
          <p>
            ...
            knowledge or experience necessary to prevent the danger that materialised". This is an
            objective test applied with hindsight.
          </p>
          <p>Building competence for inspection and testing typically follows a path:</p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Theory grounding.</strong> The L2 dead-test sequence (Module 4 §6 of this
              course) plus L3 Unit 304 (this module) gives you the underpinning knowledge.
            </li>
            <li>
              <strong>Supervised practice.</strong> Do the tests under direct supervision until you
              are competent enough to be relied upon.
            </li>
            <li>
              <strong>Independent practice on familiar circuits.</strong> Domestic dead tests, then
              live tests, before moving to commercial scale.
            </li>
            <li>
              <strong>Specialist progression.</strong> 2391 (initial verification + periodic), 2394
              (initial), 2395 (periodic) industry quals build on Unit 304 and demonstrate competence
              to scheme providers and employers.
            </li>
            <li>
          ...
          <p>
            On site, the practical test for whether you are competent for a task: could you defend
            your decision to take it on if asked by an HSE inspector after an incident? If the
            honest answer is "I was guessing", stop and escalate.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 16 sits on both you and on the person who engaged you. If your supervisor assigned
              you work beyond your competence with no supervision, the Reg 16 duty has been breached
              at two levels: by them for assigning it, and by you for accepting it if you knew you
              were not competent. The "appropriate supervision" clause is what allows apprentices to
              develop competence — but supervision must be appropriate to the task, not theoretical.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Live cable termination.</strong> (a) Easy to make dead — fail. (b) No special
              urgency — fail. Dead work required. Live termination is not justified under Reg 14 in
              normal circumstances.
            </li>
            <li>
              <strong>Live earth fault loop impedance test (Zs).</strong> (a) Cannot be done dead by
              definition — pass. (b) Test is necessary for verification — pass. (c) GS38 leads,
              single-pole probe, brief duration — pass. Reg 14 satisfied.
            </li>
            <li>
              <strong>Live RCD trip time test.</strong> Same logic as Zs — must be live for the test
              to be meaningful. Reg 14 satisfied with proper precautions.
            </li>
            <li>
              <strong>Switch replacement.</strong> Easy to make dead at the CU — fail (a). Live work
              not justified. Isolate, prove dead, work, reinstate.
            </li>
            <li>
              <strong>
                Tracing intermittent faults on a live commercial system that cannot be shut down.
              </strong>{' '}
              May satisfy (a) if downtime cost is genuinely unreasonable — but (b) and (c) require
              careful planning, additional precautions, and competent operators. Often a
              permit-to-work is needed.
            </li>
          </ul>
          <p>
            The default is dead. Every live activity needs the Reg 14 test applied consciously. For
            verification testing this is straightforward — the tests by their nature must be live.
            For other live work the bar is high and the precautions must match the risk.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              gives someone a shock because the supplementary bonding to a non-conductive surface
              was never installed and BS 7671 didn't catch it on the schedule. HSE investigate. They
              prosecute under EAWR Reg 4(2), not BS 7671. Your defence — "we followed BS 7671" —
              only goes so far if a competent person should have seen the wider safety issue.
            </>
          }
          doInstead={
            <>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Chapter 64 — Initial verification.</strong> Reg 641 (general — verify before
              placing into service), Reg 642 (visual inspection items list), Reg 643 (testing —
              sequence, dead tests, live tests), Reg 644 (certification and reporting).
            </li>
            <li>
              <strong>Chapter 65 — Periodic inspection and testing.</strong> Reg 651 (general —
              verify periodically), Reg 652 (frequency — based on installation type and use), Reg
              653 (the periodic inspection report — EICR).
            </li>
            <li>
              <strong>Chapter 66 — Inspection in special locations.</strong> Caravans, motor
              caravans, marinas — added in A3 to address recurring issues with leisure
              installations.
            </li>
            <li>
              ...
              Stroma) publish their own branded versions but the content must include all required
              fields from the model.
            </li>
          </ul>
          <p>
            A4:2026 made specific changes to Part 6: simplified RCD test method (single AC test at
            1×IΔn under Reg 643.7.3, replacing the older multi-test sequence at multiples of IΔn),
            updated Schedule of Inspections columns, AFDD recommendation under Reg 421.1.7 (with
            HRRB-specific requirements coming via Building Safety Act 2022). Documentation
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 641.1 establishes the cardinal duty: verify BEFORE energising. This applies to
              every installation, not just new ones — additions and alterations also need their
              verification before energising. The phrase "so far as is reasonably practicable"
              mirrors the EAWR formulation, tying BS 7671 verification directly to the statutory
              framework.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              Specifically — design (per Section 1 of the EIC if you designed it), construction (per
              Section 2 if you constructed it), and inspection/testing (per Section 3 always).
            </li>
            <li>
              <strong>The duty for ongoing safe condition (EAWR Reg 4(2)) transfers.</strong>
              The recipient — typically the client / building owner / occupier — becomes the duty
              holder for keeping the installation safe in use.
            </li>
            <li>
              <strong>A retest interval is recommended.</strong> Per BS 7671 Section 651 and IET
              Guidance Note 3 frequency tables — domestic owner-occupied 10 years, rented domestic 5
              years, commercial 5 years, industrial 3 years, others case by case.
            </li>
            <li>
            ...
            <li>
              <strong>Records must be kept.</strong> The EIC, schedules, and test results form the
              legal record. The duty holder must retain them for the life of the installation (best
              practice). Scheme registration (NICEIC etc.) often requires the contractor to retain
              copies too.
            </li>
          </ol>
          <p>
            The MWC (Minor Works Certificate) carries similar weight for additions and alterations
            not requiring a full EIC. The EICR (Electrical Installation Condition Report) is the
            periodic equivalent — verifies an existing installation is still safe and codes the
            defects found. All three are legally significant documents.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Designer.</strong> Reg 4(1) — system constructed to prevent danger. Discharged
              at sign-off of the design block on the EIC. Continuing duty if a design defect is
              later found.
            </li>
            <li>
            ...
            <li>
              ...
              block. Reg 16 — competent to verify. Continuing duty if a verification omission later
              contributes to harm.
            </li>
            <li>
              <strong>Duty holder post-handover.</strong> Reg 4(2) ongoing maintenance duty. Engages
              competent persons for periodic, acts on EICR codes, retains documentation.
            </li>
            <li>
              <strong>Person carrying out subsequent work.</strong> Reg 16 competence duty for their
              specific scope, plus Reg 14 dead-working duty during their work.
            </li>
          </ul>
          <p>
            Multiple duties co-exist. Signing the EIC closes the active verification duty but opens
            the ongoing duty on the recipient. Both parties have continuing exposure if defects
            emerge — one for the original work, the other for failure to maintain.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              offence. Common for documentation gaps, missing labels, undersized bonding discovered
              without immediate danger.
            </li>
            <li>
              <strong>Prohibition notice (HSWA s.22).</strong> Used where the activity involves or
              will involve a risk of serious personal injury. Takes effect immediately or deferred
              per the notice. Common for live working without justification, exposed live parts in
              public areas, defective protective devices on a high-PFC supply.
            </li>
            <li>
              <strong>Prosecution.</strong> For serious or repeat breaches, breaches that
              contributed to injury / death, or refusal to comply with notices. EAWR Reg 4 / 14 / 16
              are the most-cited regulations in electrical prosecutions.
            </li>
            <li>
              <strong>Cost recovery (FFI — Fee For Intervention).</strong> Where HSE finds a
              material breach during inspection, the duty holder pays HSE costs — currently around
              £174/hour. Adds significant financial weight to enforcement.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Circuit identification chart.</strong> Per Reg 514.9 — fixed at or near the
              consumer unit / DB. Lists every circuit, the protective device, the area served, the
              RCD coverage.
            </li>
            <li>
              <strong>Single-line diagram.</strong> For installations beyond a single small consumer
              unit. Shows distribution architecture, sub-mains, sub-DBs, key switchgear.
            </li>
            <li>
            ...
            <li>
              <strong>Test method notices.</strong> RCD test button operation, AFDD test routine,
              SPD status check, EVSE diagnostic procedures.
            </li>
            <li>
          ...
          <p>
            ...
            undermines the duty holder's ability to discharge the ongoing Reg 4(2) duty. Document
            the handover; ideally have the recipient sign that they received the pack.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You signed the EIC for a small commercial fit-out three months ago. Today the client
              phones — an electrician carrying out unrelated work has flagged that one of your
              circuits has a bonding error: a metallic equipment frame appears to have no CPC
              connection back to the MET. The client asks "what now?".
            </>
          }
          whatToDo={
            <>
              Three things at once. First — establish whether anyone is currently exposed to danger.
              If yes, instruct immediate isolation of the affected circuit pending investigation.
              Second — arrange a return visit at the earliest opportunity to investigate, confirm
              the defect, and remedy it. Third — document everything: the client notification, your
              response, the investigation findings, the remedial work, and a re-test that confirms
              the issue is resolved. Issue a corrected MWC or EIC amendment as appropriate. Notify
              your scheme provider if your scheme rules require it. Keep the records — you have just
              discharged your continuing EAWR Reg 4 duty and you may need to evidence that.
            </>
          }
          whyItMatters={
            <>
              Discovering a defect after sign-off is not a contractual problem to be argued — it is
              an EAWR matter. The right response cascades from "is anyone in danger now?" through to
              "is it remedied and documented?". Acting fast and documenting fully is the only way to
              discharge the continuing duty cleanly. Trying to argue the client is at fault, or that
              the defect was not yours, while leaving the danger in place, is the route to
              prosecution.
            </>
          }
        />
