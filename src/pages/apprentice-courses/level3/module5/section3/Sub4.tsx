...
const TITLE =
  'Insulation resistance — 500 V / 250 V SELV / 1000 V | Level 3 Module 5.3.4 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    question:
      'Per BS 7671 Table 64, the test voltage and minimum acceptable IR for a 230 V LV final circuit is:',
    options: [
  ...
  },
  {
    ...
    question:
      'Before performing an IR test on a final circuit that includes an RCBO at the CU and SPDs in the consumer unit, you should:',
    options: [
  ...
  },
  {
    ...
    question:
      'You IR test a 200 m underground submain on a commercial site. Reading is 0.8 MΩ at 500 V DC. The cable is single-core 95 mm² Al SWA, three runs in parallel per phase. What is your interpretation?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'Test voltage for circuits rated above 500 V (e.g. some 1 kV control circuits or motor feeders):',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'You measure IR L-E on a kitchen radial = 0.4 MΩ at 500 V DC. The circuit feeds a built-in dishwasher (still wired in) and a recessed 230 V LED downlight strip. Most likely cause:',
    options: [
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 3 · Subsection 4"
        title="Insulation resistance — 500 V / 250 V SELV / 1000 V"
        backTo="/study-centre/apprentice/level3-module5-section3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          IR per Reg 643.3 and Table 64. Test voltage by circuit type, disconnection of electronic
          components, parallel-path and length effects, two-stage method per Reg 643.3.3, diagnostic
          walkthrough for low IR results.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Conductor-to-conductor insulation breakdown.</strong> Short-circuit hazard
              between L and N. Detected on the L-N test. Less immediate shock risk but still
              hazardous (high fault current, possible fire).
            </li>
            <li>
              <strong>Neutral-to-earth leakage.</strong> Often missed but important — N-E leakage
              causes nuisance RCD trips and can mask real L-E faults if the residual current sums
              them. Detected on the N-E test.
            </li>
          </ul>
          <p>
            ...
            voltage but well below its breakdown voltage (typically &gt; 5 kV for PVC). 250 V for
            SELV protects sensitive components on extra-low-voltage equipment. 1000 V for HV LV
            stresses cable rated above 500 V appropriately.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Three rows in Table 64. Each row binds test voltage to acceptance threshold. 500 V at
              1 MΩ is the standard for the bulk of UK domestic and small commercial work. SELV at
              250 V / 0.5 MΩ for ELV control circuits and bell wiring. 1000 V at 1 MΩ for circuits
              above 500 V. Choose the test voltage from the circuit rating — always test L-L, L-N
              and L-E (or all combinations on three-phase).
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>RCBOs, RCDs, AFDDs at the CU.</strong> Internal electronics and varistors show
              low resistance to a 500 V DC pulse and may be damaged by the test. Lift the L and N
              from the device terminals.
            </li>
            <li>
              <strong>SPDs (Type 1, 2, 3 surge protective devices).</strong> Designed to clamp at
              over-voltages — your 500 V DC test triggers them. Isolate by removing the module or
              lifting its connections.
            </li>
            <li>
              <strong>Electronic dimmer switches.</strong> Phase-cut electronics include capacitors
              and inductors that show as low IR.
            </li>
            <li>
              <strong>Fixed appliances and white goods.</strong> Built-in dishwashers, ovens,
              washer-dryers — mains filters with Y capacitors leak appreciable current at 500 V DC.
              Disconnect at the connection unit.
            </li>
            <li>
              <strong>LED drivers, fluorescent ballasts, fan motors.</strong> Input capacitors
              contribute leakage. Disconnect downstream of the supply or isolate the lamp / fitting.
            </li>
            <li>
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stage 1 — L+N together to E.</strong> Bridge L and N at the CU end. Test from
              the L+N junction to earth at full 500 V DC. Electronics see no voltage between L and N
              (so are not stressed); the test only measures leakage to earth — the safety-critical
              path.
            </li>
            <li>
              <strong>Stage 2 — L to N.</strong> Disconnect or isolate electronics, then test L to N
              at 500 V DC to verify line-to-neutral insulation independently.
            </li>
          </ol>
          <p>
            Document both stages on the schedule. Note which components were isolated for Stage 2 —
            the next inspector will need to know.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              because installations add more electronic content over time. The principle is stable:
              anything that conducts at 500 V DC must be removed from the test path or the result
              reflects the device, not the insulation.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>L to E (line to earth).</strong> The most safety-critical reading. Failure
              mode: insulation degradation between line and CPC, or between line and an
              exposed-conductive-part. Result: exposed metal can become live.
            </li>
            <li>
              <strong>N to E (neutral to earth).</strong> Detects N-E leakage that causes nuisance
              RCD trips and can mask real L-E faults on multi-circuit RCDs.
            </li>
            <li>
              <strong>L to N (line to neutral).</strong> Catches short-circuit hazard between live
              conductors — typically less immediate shock risk but still significant for fire and
              equipment damage.
            </li>
          </ul>
          ...
          <p>
            ...
            circuit fails — and you have located the fault to whichever conductor pair gave the low
            reading.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Length.</strong> IR is inversely proportional to length. A 50 m cable reading
              200 MΩ would read approximately 100 MΩ at 100 m. The cable insulation quality is the
              same; the larger surface area leaks more.
            </li>
            <li>
              <strong>Parallel paths.</strong> Cables in parallel act like resistors in parallel for
              IR. Two equal cables in parallel halve the IR. Three reduce it to one-third. Common on
              commercial submains where multiple single-core cables run in parallel per phase to
              handle high current.
            </li>
          </ul>
          <p>
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>Test that cable in isolation to confirm the absolute IR of the suspect run.</li>
            <li>Investigate that run — terminations, cable damage, water ingress at glands.</li>
          </ol>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>{'>'} 200 MΩ (often display max):</strong> Excellent, expected on a healthy
              short dry circuit with no contributing components.
            </li>
            <li>
              <strong>50-200 MΩ:</strong> Healthy, normal range for a typical domestic radial.
            </li>
            <li>
              <strong>10-50 MΩ:</strong> Acceptable, but worth noting — early degradation, long run,
              or some contributing component still attached.
            </li>
            <li>
              <strong>1-10 MΩ:</strong> Passes the absolute minimum but warrants investigation. Long
              damp run? Fixed appliance not disconnected? Borderline insulation health?
            </li>
            <li>
              <strong>{'<'} 1 MΩ:</strong> Fails Table 64. Investigate, isolate, repair, retest. Do
              not sign off until the reading is above 1 MΩ.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Voltage choice matrix:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>250 V DC</strong> — SELV and PELV circuits (extra-low voltage), or A4:2026
              643.3 reduced-voltage test where equipment damage is a risk with electronics still
              connected.
            </li>
            <li>
              <strong>500 V DC</strong> — standard 230 V LV final circuits and most three-phase 400
              V circuits. The default for nearly every domestic and commercial final-circuit IR
              test.
            </li>
            <li>
              <strong>1000 V DC</strong> — distribution / sub-main circuits above 500 V AC, and PV
              DC string testing per IEC 62446-1 (where the array DC voltage routinely sits at
              600-1000 V Voc).
            </li>
            <li>
              <strong>Pass thresholds</strong> — 0.5 MΩ for SELV / PELV, 1 MΩ for LV circuits, 1 MΩ
              for HV. Above the minimum is acceptable; well above indicates healthy insulation.
            </li>
            <li>
              <strong>Recording</strong> — voltage used and reading per circuit. A 250 V test
              reading 1.5 MΩ is a different result from a 500 V test reading 1.5 MΩ; the next
              inspector needs to see which was applied.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>PV-specific IR considerations:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Wet vs dry conditions</strong> — IR drops in wet weather as surface leakage
              rises. IEC 62446-1 allows a temperature / humidity correction factor; on a damp roof,
              a marginal reading may be acceptable if the dry-weather retest passes.
            </li>
            <li>
              <strong>Array capacitance</strong> — large arrays act as a capacitor; allow the tester
              to settle (15-30 seconds) before reading. Modern PV testers handle this automatically.
            </li>
            <li>
              <strong>Common low-IR causes</strong> — water in the junction box of a panel, damaged
              DC cable insulation at a roof penetration, broken laminate at the corner of a panel
              where roof debris struck.
            </li>
            <li>
              <strong>Safety on the test</strong> — DC strings are live in daylight; isolate the
              inverter, work with insulated tools, never lift a live DC connector under load.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              Confirm the reading. Repeat the test, hold longer, ensure the cable has discharged
              before disconnecting probes. Drift can indicate a damp termination.
            </li>
            <li>
              Verify the test voltage is correct for the circuit type (Table 64). 500 V on a SELV
              circuit gives a low reading because it stresses components beyond their design.
            </li>
            <li>
              Check what's downstream — list every fixed appliance, dimmer, LED driver, smart relay,
              dimmable LED bulb still in the fitting.
            </li>
            <li>
              Disconnect the most suspect first (usually the most recently added or the most complex
              electronically). Retest.
            </li>
            <li>
              If the reading rises significantly, that component was contributing. Note it on the
              schedule as "tested in two-stage; component XXX disconnected for stage 2".
            </li>
            <li>
              Continue disconnecting until the reading reflects cable insulation alone (typically 50
              MΩ+).
            </li>
            <li>
            ...
            <li>
              After diagnosis: reconnect everything, retest as a final confirmation. Document the
              diagnostic process, the components disconnected, and the final readings.
            </li>
          </ol>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You test a kitchen ring with the dishwasher, washing machine and oven all wired in.
              The L-N reading comes in at 0.8 MΩ. You assume the cable has failed, log a C2 on the
              EICR, and walk away. Customer pays for cable replacement that wasn't needed. The
              actual fault was the line filter capacitors in the washing machine contributing
              leakage. A 5-minute disconnection check would have shown the cable is fine.
            </>
          }
          doInstead={
            <>
              Always check what's downstream before condemning a cable. Disconnect the suspect fixed
              appliances at their connection units, retest. If the reading jumps above 1 MΩ (and
              ideally above 50 MΩ) with the appliances disconnected, the cable is fine — the
              appliances are contributing. Log on the schedule that the test was performed with
              appliances XYZ disconnected, and verify them separately as portable appliance tests if
              appropriate.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You are commissioning a small office refurbishment in Birmingham. New 8-way CU, six
              radial circuits including an office ring final, lighting circuit with eight dimmable
              LED downlights on a wall-mounted electronic dimmer, FELV controls circuit feeding
              desk-level USB modules, and a kitchenette with a wired microwave-oven combination. You
              have completed continuity testing and now need IR per Reg 643.3 across the board.
            </>
          }
          whatToDo={
            <>
              Safe isolation, disconnect all six RCBOs at their L and N terminals. Lift SPD modules.
              Identify circuits with electronics: dimmer-controlled lighting, FELV controls, kitchen
              microwave. For each circuit decide: full disconnection or two-stage. Office ring:
              disconnect the ring at the CU, no electronics, full test at 500 V DC. L-E = &gt; 200
              MΩ; N-E = &gt; 200 MΩ; L-N = &gt; 200 MΩ. Pass. Lighting: two-stage per Reg 643.3.3 —
              bridge L+N at the CU, test to E at 500 V — reading comes in at 85 MΩ (some leakage
              from the dimmer module). Then disconnect the dimmer at its load terminals, test L-N at
              500 V — &gt; 200 MΩ. Pass with two-stage method, dimmer noted as the contributor. FELV
              controls: this is a SELV circuit, switch the Kewtech KT64+ to 250 V test voltage. L-E
              = 12 MΩ (passes the 0.5 MΩ SELV minimum comfortably). Kitchen radial: disconnect the
              microwave at its FCU, test at 500 V — all combinations &gt; 100 MΩ. Document each
              circuit on the STR with the L-E, N-E and L-N readings, the test voltage used, and any
              disconnections made. Reconnect everything, energise, and proceed to live testing in
              Section 4.
            </>
          }
          whyItMatters={
            <>
              Modern installations are full of electronics. The IR test discipline — pick the right
              test voltage from Table 64, disconnect or use the two-stage method, record what you
              did, document the readings — is what separates a verification-grade test from a number
              scribbled in a column. The next inspector picking up this board in five years can
              re-test, get similar readings, and trust the chain of evidence. The customer gets an
              installation with proven insulation health, and the next tradesperson on site can work
              confident the previous tester didn't accept a contaminated reading.
            </>
          }
        />
        ...
        >
          <p>Three-phase IR test patterns:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Full ten-combination test</strong> — slow but thorough; record every reading
              on the STR. Use on commissioning, on EICRs of unfamiliar three-phase boards, on
              circuits with reported faults.
            </li>
            <li>
              <strong>Linked-conductor shortcut</strong> — fast for healthy installs; two readings
              (linked-Ls to N, linked-Ls to E) plus N to E if the result is well above threshold. If
              marginal, switch to the full test.
            </li>
            <li>
              <strong>Three-phase motor circuits</strong> — three line conductors plus CPC, no
              neutral. Six combinations (L1-L2, L1-L3, L2-L3, L1-E, L2-E, L3-E). Disconnect the
              motor at the local isolator before testing.
            </li>
            <li>
              <strong>Star vs delta loads</strong> — both load configurations have a star point that
              can carry small standing voltages or stray capacitances; let the IR tester settle
              before reading.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              equipment shall be used to verify insulation resistance.
            </>
          }
          meaning={
            <>
              The standard 500 V DC IR test damages connected electronics — inverters, control gear,
              smart switches, surge protective devices. Where the kit is connected, drop to 250 V
              DC. Older training material that fixes 500 V for every circuit needs updating to match
              the redrafted regulation.
            </>
          }
