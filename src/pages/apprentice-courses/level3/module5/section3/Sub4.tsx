...
const checks = [
  ...
  },
  {
    ...
    options: [
      ...
      'Apply mains voltage instead.',
      'Skip the IR test on circuits with electronics.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Pass — anything above 1 MΩ is OK.',
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Leave loads connected and test L to N at the CU.',
      ...
      'Apply test voltage between L and N with the supply still on.',
      'Use the multimeter ohms range.',
    ],
    correctAnswer: 1,
    explanation:
