...
const TITLE =
  'Earth electrode resistance — TT systems and generators | Level 3 Module 5.3.6 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  ...
  },
  {
    ...
    question:
      'Per BS 7671 Reg 411.5.3(b), for an RCD-based TT installation the maximum acceptable earth electrode resistance Ra is determined by:',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A TT installation has a single earth electrode for the whole consumer side. The protective device is a 30 mA RCD on the incoming supply. The electrode is freshly installed and you measure Ra = 85 Ω. Is this compliant?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'Per BS 7671, the agricultural / horticultural location touch-voltage limit (Section 705) reduces the Ra × IΔn product to:',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'For a TT installation, the typical target electrode resistance for design (not the absolute maximum) is:',
    options: [
...
const faqs = [
  ...
  {
    question:
      'What about installations with multiple parallel electrodes — how do I test individual electrodes?',
    answer:
...
export default function Sub6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 3 · Subsection 6"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Three GN3 methods (E1 three-stake, E2 stakeless / clamp, EFLI loop). When each method
          applies, the Ra × IΔn ≤ 50 V criterion for RCD-based TT installations, and BS 7430 design
          references.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>TN-S:</strong> Supplier provides a separate earth (typically the cable sheath
              of a paper-insulated lead-covered cable). Ze typically 0.20-0.50 Ω. Similar story to
              TN-C-S for ADS.
            </li>
            <li>
              <strong>TT:</strong> Consumer provides an earth electrode. Ra typically 30-200 Ω,
              occasionally 500+ Ω in difficult soil. Ze (the loop external to the installation)
              effectively equals Ra plus the supply network impedance — for TT calculation, Ze ≈ Ra.
              Zs values are far too high for an MCB to clear in Reg 411.3.2 disconnection times.
              RCDs are mandatory for ADS; Reg 411.5.3 governs the criteria.
            </li>
          </ul>
          <p>
            <strong>Reg 411.5.3 — TT systems with RCD protection.</strong> Two requirements for ADS
            via RCD:
          </p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>(a) Disconnection times per Table 41.1.</strong> 30 mA RCD operating at IΔn or
              5 IΔn meets the 0.4 s / 0.2 s requirements by design — confirmed by the live RCD
              trip-time test (Section 4).
            </li>
            <li>
              <strong>(b) Ra × IΔn ≤ 50 V.</strong> The product of electrode resistance and rated
              residual operating current limits touch-voltage. This is the criterion verified by the
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              Condition (a) is the disconnection time (verified by live test). Condition (b) is the
              touch-voltage limit (verified by electrode resistance test). 50 V is the touch-voltage
              threshold above which the installation cannot be guaranteed safe to touch during a
              fault. For a 30 mA RCD: Ra ≤ 1667 Ω theoretical maximum. Practical engineering targets
              are much lower for reliability across seasons.
            </>
          }
        ...
        <ContentEyebrow>
          Method E1 — three-stake fall-of-potential (the gold standard)
        </ContentEyebrow>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              straight line — use the longer distance if soil is poorly conductive. Connect C2 to
              the C2 terminal on the earth electrode tester.
            </li>
            <li>
              Drive the potential stake (P2) at the midpoint between the electrode and C2. Connect
              P2 to the P2 terminal.
            </li>
            <li>
              Connect the electrode under test to the C1 and P1 terminals (most testers use a single
              connection point for both).
            </li>
            <li>
              Press TEST. Note the resistance reading. Move P2 by ±5-10 m (toward the electrode and
              toward C2). Re-test. If the three readings (P2 closer to electrode, midpoint, P2
              closer to C2) agree within a few percent, the midpoint reading is the true electrode
              resistance.
            </li>
            <li>
              If the readings vary significantly, move C2 further out and repeat. Variation means
              the potential stake is in the voltage gradient zone of either the electrode or C2.
            </li>
            <li>
              Document the resistance value, methodology used, and the ground conditions at test
              (dry / wet, temperature).
            </li>
            <li>Reconnect the earthing conductor at the MET BEFORE re-energising the supply.</li>
          </ol>
          <p>
            <strong>When E1 is the right choice:</strong> initial verification of a TT installation,
            design verification of electrode arrays, fault investigation when electrode resistance
            is suspected as the cause of unwanted RCD trips. Requires physical access to drive
            stakes 30-50 m from the building.
          </p>
          <p>
            <strong>When E1 is impractical:</strong> urban TT installations on paved areas with no
            soil access; periodic in-service testing where disconnecting the earthing conductor
            causes too much disruption; multi-storey buildings where the electrode is buried under
            foundations.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Clamp encloses the earthing conductor with two transformer windings.</li>
            <li>Injection winding induces a known voltage on the conductor.</li>
            <li>
              Resulting current flows out through the electrode under test, returns through the
              parallel earth path (other electrodes, bonded extraneous parts, building services).
            </li>
            <li>Sense winding measures the current.</li>
            <li>
              Tester displays Ra = V/I, the loop resistance from the conductor through the tested
              electrode and back via the parallel paths.
            </li>
          </ul>
          <p>
            <strong>Strengths:</strong> No stakes, no isolation of the installation required, quick
            (10-20 seconds per test), suitable for in-service periodic testing.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Requires a parallel earth path (multi-electrode, or TT with bonding network acting as
              a parallel path).
            </li>
            <li>Less accurate than E1 (no plateau check available).</li>
            <li>
              Reading includes the parallel path resistance — useful for system Ra, less useful for
              assessing the individual tested electrode.
            </li>
            <li>
              Conductor must be accessible at a point where the clamp can fit around it cleanly.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Isolate the installation from the supply.</strong> Lock off, prove dead per
            ...
            <li>
              Connect the EFLI tester between the line conductor at the source (the cut-out outgoing
              terminal) and the disconnected earthing conductor — the tester is now in the loop that
              goes line → tester → earthing conductor → electrode → soil → supply transformer earth.
            </li>
            <li>
              Press TEST. The EFLI tester drives test current and computes the loop impedance. For a
              TT installation, this loop is dominated by the electrode resistance Ra (the supply
              impedance is small in comparison).
            </li>
            <li>
              Note the reading. This is essentially the electrode resistance plus a small network
              component.
            </li>
            <li>
              Disconnect the EFLI tester. Reconnect the earthing conductor to the electrode. Verify
              the connection is mechanically tight.
            </li>
            <li>
              <strong>
                Re-energise the supply ONLY after the earthing conductor is verified reconnected.
              </strong>
            </li>
            <li>
              Document the test method, the result, and confirmation that the earthing conductor was
              reconnected.
            </li>
          </ol>
          <p>
            ...
            relative to earth. Re-energising in this state means a single insulation fault would put
            line voltage on accessible metal with no protective trip. The procedural discipline —
            isolate FIRST, reconnect BEFORE re-energising — eliminates this risk.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              GN3 codifies the three methods and the safety-critical procedural sequence for EFLI.
              E1 is the gold standard for accuracy. E2 is convenient but requires a parallel earth
              path. EFLI is the fallback when neither stakes nor a parallel path are available — but
              demands strict isolation discipline.
            </>
          }
        ...
        >
          <p>Soil resistivity bands and electrode strategy:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Wet loam / clay (10-100 ohm-m)</strong> — single 1.2 m rod usually achieves Ra
              below 100 ohms.
            </li>
            <li>
              <strong>Damp sand / gravel (100-500 ohm-m)</strong> — single 2.4 m rod or two 1.2 m
              rods in parallel typically needed.
            </li>
            <li>
              <strong>Dry sand / gravel (500-1000 ohm-m)</strong> — multiple rods, possibly with
              bentonite backfill to lower the contact resistance.
            </li>
            <li>
              <strong>Rock (above 1000 ohm-m)</strong> — buried tape arrays, plate electrodes, or
              chemical electrodes. Civil works increase substantially.
            </li>
            <li>
              <strong>Conductor type</strong> — copper-bonded steel is the UK domestic standard.
              Solid copper rod for harsh chemical environments. Galvanised steel where copper would
              set up a galvanic cell against buried steel structures.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Seasonal Ra effects to recognise:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Summer drought</strong> — dry soil reads higher resistivity; Ra rises 2-3x.
              Test reads pass in winter, fail in late August.
            </li>
            <li>
              <strong>Winter freeze</strong> — frozen surface soil isolates the top of the
              electrode; Ra rises until the thaw.
            </li>
            <li>
              <strong>New install</strong> — freshly disturbed soil takes weeks to consolidate; Ra
              often drops 10-30 percent over the first month as the soil settles around the
              electrode.
            </li>
            <li>
              <strong>Long-term trend</strong> — Ra trending up year-on-year suggests corrosion or
              soil washout; investigate before the trend reaches the trip threshold.
            </li>
            <li>
              <strong>Bentonite backfill</strong> — moisture-retentive backfill around the electrode
              dampens seasonal swing on dry-soil sites.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              / G99 grid-tie inverters with battery backup) similarly disconnect from the public
              supply during outages and supply the building from their own source. During those
              periods the building is effectively TT relative to the inverter output.
            </li>
            <li>
              <strong>BS 7430 design references</strong> govern electrode sizing, depth, materials,
              and target resistance for these scenarios. Typical targets for generator earthing
              match TT engineering practice — Ra well below the absolute regulatory maximum to
              ensure safety under all operating conditions.
            </li>
          </ul>
          <p>
            <strong>Verification approach</strong> for a building with backup generation / storage:
          </p>
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              Identify the earthing arrangement during normal operation (typically TN-C-S with the
              supply earth) and during islanding (TT with the dedicated electrode).
            </li>
            ...
            <li>
              ...
              the electrode Ra, the Ra × IΔn calculation, and any BS 7430 reference values used in
              the design.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>Parallel-electrode design rules of thumb:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Minimum spacing</strong> — at least one rod-length apart; preferably more if
              site allows.
            </li>
            <li>
              <strong>Combined Ra reduction</strong> — two rods well-spaced give about 55 percent of
              single-rod Ra; three rods about 40 percent; four rods about 30 percent. Diminishing
              returns.
            </li>
            <li>
              <strong>Bonding conductor</strong> — minimum 16 mm² copper from each rod to the MET,
              mechanically and corrosion-protected at the connection.
            </li>
            <li>
              <strong>Test each rod individually first</strong> — disconnect the others at the test
              point, measure each rod's Ra. Reject any outlier (failed connection, broken rod,
              contaminated soil pocket).
            </li>
            <li>
              <strong>Documentation</strong> — site plan showing rod positions, individual Ra per
              rod, combined Ra at the MET. Lives in the EIC and the customer file.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You complete the EFLI electrode test. Reading is good. You pack up the test gear and
              head to the CU to switch the supply back on — forgetting that the earthing conductor
              is still disconnected from the electrode at the MET. Supply re-energises with the
              installation effectively floating relative to earth. Exposed-conductive-parts have no
              defined potential. A single insulation fault downstream now puts line voltage on
              accessible metal with no protective trip. The first user to touch a faulted appliance
              gets the full fault.
            </>
          }
          doInstead={
            <>
              Make the reconnection step part of the test procedure, not an afterthought. Check the
              earthing conductor is reconnected as the LAST step before re-energising — visually
              confirm the connection at the MET, mechanically verify it is tight, test continuity
              from the MET to the electrode (back to a normal continuity test in the dead-test
              sequence). Only then close the supply isolator. Many experienced electricians do a
              final R2 wander-lead check to the electrode after EFLI test as the formal confirmation
        ...
        <Scenario
          ...
          situation={
            <>
              Old stone cottage in the Welsh hills. Refurbishment includes a new CU, RCD- main
              switch (30 mA), six final circuits. Supply is overhead TT — the cable drops to a
              single fused cut-out, then to the new CU. The original earth electrode is a 1.2 m
              copper rod next to the property, installed 20 years ago. You need to verify the
              electrode resistance during commissioning — first time the new CU is being signed off
              as Reg 411.5.3 compliant.
            </>
          }
          whatToDo={
            <>
              ...
              termination). Close the supply isolator, perform the live RCD trip-time test (Section
              4 Sub 3) to verify the 30 mA RCD trips within Table 41.1 disconnection time. Document
              on the EIC: method E1, Ra = 67 Ω, Ra × IΔn = 2.01 V, complies with Reg 411.5.3(b).
              Note ground conditions — moist after recent rainfall, summer reading would be expected
              higher.
            </>
          }
          whyItMatters={
            <>
              TT installations live or die by their electrode resistance. A 67 Ω electrode in wet
              conditions might rise to 150 Ω in a dry summer, and even then Ra × IΔn = 4.5 V — still
              well below 50 V limit. The engineering target of keeping Ra well below the absolute
              maximum gives year-round compliance. The E1 plateau-check method gives you confidence
              in the absolute number, the documentation of soil conditions explains seasonal
              variation to future inspectors, and the Ra × IΔn calculation against Reg 411.5.3(b)
              demonstrates the regulatory chain has been followed. Combined with the live RCD
              trip-time test in the next section, the TT system is verified as ADS-compliant.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          clause={
            <>
              One or more of the following types of protective device shall be used, the former
              being preferred: (a) an RCD; (b) an overcurrent protective device. NOTE 1: An
              appropriate overcurrent protective device may be used for fault protection provided a
              suitably low value of Zs is permanently and reliably assured. NOTE 2: Where an RCD is
              used for fault protection the circuit should also incorporate an overcurrent
              protective device in accordance with Chapter 43.
            </>
          }
          meaning={
            <>
              For TT systems the RCD is the preferred fault-protection route — a low Zs cannot be
              reliably assured against an electrode that varies with soil conditions. The
              overcurrent device sits alongside for short-circuit and overload, not for fault. The
              Ra × IΔn ≤ 50 V check from 411.5.3 then closes the ADS calculation.
            </>
          }
