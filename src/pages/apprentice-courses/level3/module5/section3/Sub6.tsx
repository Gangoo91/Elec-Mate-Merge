...
const checks = [
  {
    ...
    options: [
      'Every installation regardless of earthing system.',
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Energise to verify it.',
      "Remove the customer's furniture.",
    ],
    correctAnswer: 1,
    explanation:
