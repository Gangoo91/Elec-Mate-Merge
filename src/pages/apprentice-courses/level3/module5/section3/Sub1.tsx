...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'If a dead test fails (e.g. an IR result of 0.3 MΩ on a 230 V circuit, against Table 64 minimum 1 MΩ), the next step is:',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'If you discover the installation is not actually isolated when you start a dead test, the correct response is:',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'The Schedule of Test Results (Appendix 6) records, per circuit, the following dead-test entries:',
    options: [
...
const faqs = [
  ...
  {
    question:
      'What do I do if I have to interrupt a test sequence (lunch, fault investigation, etc)?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Order, dependencies, instruments, and the discipline of safe isolation. Each test a gate
          for the next — continuity, IR, polarity, electrode — before any live test is contemplated.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              exposed-conductive-part. Methods: R1+R2 (line + CPC end-to-end), or R2 only (CPC alone
              via wander lead). Result compared to expected resistance based on cable size, route,
              and length.
            </li>
            <li>
            ...
            <li>
              ...
              between conductors and between conductors and earth. Test voltage per Table 64 (500 V
              DC for LV up to 500 V circuits, expecting at least 1 MΩ). Catches damaged insulation,
              conductors with screw cuts, faulty fixed appliances.
            </li>
            <li>
              <strong>Step 4 — Polarity (Reg 643.6).</strong> Verifies single-pole devices are in
              the line conductor only (Reg 132.14), and that line / neutral / CPC are correctly
              connected at every accessory. Bad polarity = the metal case of an appliance can become
              live when the apparent 'off' switch is operated.
            </li>
            <li>
              <strong>Step 5 — Earth electrode resistance (Reg 643.7).</strong> For TT installations
              or any installation with an earth electrode. Verifies the electrode is making good
              contact with the soil mass — critical for ADS disconnection on TT.
            </li>
          </ul>
          <p>
            Then — and only then — live tests follow: Ze, PFC, Zs per circuit, RCD operation, AFDD
            operation, functional. Live testing is covered in Section 4 of this module.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              (continuity, ring final live conductor continuity, IR, polarity, electrode resistance
              for TT). Reg 643.7 onwards covers the live tests (Ze, PFC, Zs, RCD, AFDD operational
              confirmation, functional). Visual inspection (Reg 642) precedes everything. Do not
              deviate from the sequence — the dependency is built in.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Identify.</strong> Confirm the circuit / installation to be isolated. Check
              drawings, labels, follow cables. Multiple supplies (PV, generator, UPS, back-feed) are
              common gotchas — check for all sources.
            </li>
            <li>
            ...
            <li>
              <strong>Lock off and post warning.</strong> Apply a lock-out / tag-out device to
              prevent unauthorised re-energisation. Post a "WORK IN PROGRESS — DO NOT ENERGISE"
              notice with your name, date, contact.
            </li>
            <li>
              <strong>Prove voltage indicator on known live source.</strong> Use a proving unit or
              another known live source. All probes / phases. Confirms the indicator is working.
            </li>
            <li>
              <strong>Test the isolated point.</strong> Confirm absence of voltage between every
              combination — L-N, L-E, N-E, and L-L for three-phase. The point should read zero /
              no-supply on a properly isolated circuit.
            </li>
            <li>
              <strong>Prove voltage indicator again.</strong> Same proving unit, same probes.
              Confirms the indicator was still working when it said the test point was dead. If the
              indicator now fails, the previous "dead" reading was unreliable — re-test with a
              different indicator before proceeding.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              GS38 is the recognised standard for safe test equipment use. Test leads with excessive
              exposed metal, no finger barriers, or no fuses risk arc flash and shock during live
              testing. Prove-test-prove with the indicator confirms the indicator was operational at
              the moment of the test. Both apply during dead testing because safe isolation depends
              on the prove ritual being trustworthy.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Continuity (R1+R2, R2, ring) — Reg 643.2.1.</strong> Output current at least
              200 mA at no-load voltage 4-24 V. Modern multifunction testers (MFT) comply by
              default. Auto-zero for lead resistance. Resolution to 0.01 Ω.
            </li>
            <li>
              <strong>Insulation resistance — Reg 643.3 / Table 64.</strong> Test voltage 500 V DC
              for circuits up to 500 V (most LV); 250 V DC for SELV/PELV; 1000 V DC for circuits
              above 500 V. Minimum acceptable IR per Table 64 — 1 MΩ for 500 V test, 0.5 MΩ for 250
              V SELV.
            </li>
            <li>
              <strong>Polarity — Reg 643.6.</strong> Continuity test or visual indication via MFT.
              Some MFTs include a polarity indicator under continuity test. For dead testing,
              polarity is verified by checking that line goes through any single-pole switch /
              device (R = low when switch closed, high/open when switch open).
            </li>
            <li>
              <strong>Earth electrode resistance — Reg 643.7.</strong> Three-terminal stake method
              (most accurate, requires test stakes), OR loop impedance method using the supply for a
              non-RCD-protected system, OR clamp method (induced current, requires no
          ...
          <p>
            ...
            annually (or per the manufacturer's recommendation), traceable to a national standard.
            The calibration certificate accompanies the instrument; the test record should reference
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Inspector uses an old multimeter that's been knocked around. Continuity reading is 0.5
              Ω — looks fine, ticks the schedule. The meter is actually drifted — actual reading is
              closer to 2 Ω, which would have been a finding for that circuit length. Fault sits in
              the schedule undetected. EAWR-relevant defect attributed to the verification work.
            </>
          }
          doInstead={
            <>
              Use only calibrated instruments for verification testing. Check calibration date
              before the job. Record the instrument serial number and calibration expiry on the test
              record (most MFTs let you store this and print it on the results). Annual calibration
              is industry standard; some instruments need shorter intervals based on use.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You arrive on a small commercial unit to do an EICR. Drawings show a single supply
              from the local DB. You isolate the DB main switch, lock it off, post a warning. Prove
              your indicator on a proving unit. Test at the DB outgoing terminals — reads 230 V
              phase to neutral. The DB is showing live. The drawings are wrong: there's a back-feed
              from a UPS in the server room, fed via a circuit you don't have visibility on. Your
              isolation has not isolated the DB.
            </>
          }
          whatToDo={
            <>
              Stop. Do not proceed with any test. Investigate the source of the live — trace the
              cable, find the UPS, isolate at the UPS as well as the DB. Re-prove the indicator on a
              known live source. Re-test the DB. Confirm now dead. Update the drawings and the
              EICR's Section D limitations. Document the near-miss. Brief the client. Going forward:
              identify ALL supply sources during the initial visual stage — drawings can lie,
              especially in retrofitted systems with UPS, generators, PV, EVSE feeding back.
            </>
          }
          whyItMatters={
            <>
              Reg 14 EAWR is satisfied only when the install is verifiably dead before the test
              starts. Discovering an unexpected live during isolation is the system catching a
              near-miss — the prove-test-prove ritual did its job. Continuing to test on
              partly-energised systems is the route to electrocution. A near-miss is a finding to
              learn from; an actual contact is a tragedy to investigate.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Continuity of protective conductors and main / supplementary bonding (R1+R2 or R2
              method).
            </li>
            <li>
              Continuity of ring final circuits (three-part method — end-to-end on each conductor,
              then cross-connect).
            </li>
            <li>
              Insulation resistance — between every live conductor pair and live conductors to
              earth.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Prospective fault current PFC at the origin (often read on the same instrument as Ze).
            </li>
            <li>
              Earth fault loop impedance Zs at every relevant test point downstream — circuit ends,
              last sockets, isolators.
            </li>
            <li>
        ...
        >
          <p>Recovery patterns by failed test:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>High R1+R2</strong> — terminate or re-terminate at the offending point,
              retest. Common cause: loose terminal, conductor strand cut on installation, dirt or
              oxidation on a tunnel connector.
            </li>
            <li>
              <strong>Low IR L-E or N-E</strong> — disconnect connected appliances one at a time,
              retest after each. Common cause: filter capacitors in white goods, water in a JB,
              damaged cable at a roof or floor penetration.
            </li>
            <li>
              <strong>Polarity reversal at an accessory</strong> — confirm consumer-unit
              termination, follow the cable to the failed point. Common cause: cross-over at a JB or
              a back-box swap.
            </li>
            <li>
              <strong>High Ze on TT</strong> — investigate the electrode and the bonding to the MET;
              common cause is a corroded earth conductor at the rod head.
            </li>
            <li>
              <strong>Failed RCD trip</strong> — confirm the device type and rating, replace the
              device if internal fault suspected, retest. A stuck RCD is a safety-critical defect.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Quick sample-size reference for periodic testing:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Special locations (Section 700)</strong> — 100 percent inspect-and-test.
              Bathroom, kitchen, outdoor, swimming pool plant, agricultural premises, caravan parks,
              marinas, EV charging.
            </li>
            <li>
              <strong>Recently modified circuits</strong> — 100 percent inspect anything affected by
              the modification.
            </li>
            <li>
              <strong>Standard final circuits, good condition</strong> — typically 10-20 percent of
              accessories per circuit, every CPC verified end-to-end, every RCD tested,
              furthest-point Zs.
            </li>
            <li>
            ...
            <li>
              <strong>Document the sample on the EICR</strong> — explicit sample size and rationale.
              Solicitors, mortgage lenders and the next inspector all read this.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>EIC schedule of test results — what each column needs:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Circuit reference</strong> — matches the schedule of inspections and the
              consumer-unit labelling.
            </li>
            <li>
              <strong>Continuity (R1+R2)</strong> — measured ohms; for ring finals add the three
              readings (end-to-end on each conductor and the cross-connected reading).
            </li>
            <li>
              <strong>Insulation resistance</strong> — three readings for single-phase (L-N, L-E,
              N-E) or up to ten for three-phase. Test voltage used in the column heading.
            </li>
            <li>
              <strong>Polarity</strong> — pass / fail per circuit, with any accessory-specific
              notes.
            </li>
            <li>
              <strong>Ze at origin and Zs at furthest point</strong> — measured ohms; comparison
              against Table 41.3 maximum.
            </li>
            <li>
              <strong>RCD trip time at 1xIΔn</strong> — measured ms (under 300 ms for a general
              non-delay RCD). The historic 5xIΔn / 40 ms test and Appendix 3 Table 3A were deleted
              in A4:2026.
            </li>
            <li>
              <strong>Visual inspection schedule</strong> — every Reg-derived check ticked,
              observations noted.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              disconnection by the RCD shall be verified using suitable test equipment to BS EN
              61557-6. Per the NOTE: regardless of RCD Type, effectiveness is deemed verified where
              the RCD disconnects within 300 ms maximum (general non-delay type) with an
              alternating-current test at rated residual operating current (IΔn). Appendix 3 Table
              3A (Time/current performance criteria for RCDs) has been deleted.
            </>
          }
          meaning={
            <>
              The old multi-current RCD sequence (½× and 5×IΔn) has been deleted along with Table
              3A. A single AC test at 1×IΔn is the verification method for every RCD type — a
              general non-delay RCD must disconnect within 300 ms. Test schedules, EIC pro-formas
              and toolbox-talk crib sheets need updating to match.
            </>
          }
