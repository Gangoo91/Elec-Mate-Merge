...
const checks = [
  ...
  },
  {
    ...
    options: [
      ...
      'Just switched off at the main switch.',
      'Powered down via an app.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      "Multi-test sequence at 1/2, 1, 5 times IΔn.",
