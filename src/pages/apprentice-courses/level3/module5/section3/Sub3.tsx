...
const checks = [
  ...
  },
  {
    ...
    question:
      'During Step 3 (L-CPC cross-connection) you take readings at every socket on a 12-socket ring. Eleven sockets read between 0.18 and 0.20 Ω — constant. The twelfth socket reads 0.36 Ω. What does that tell you?',
    options: [
  ...
  },
  {
    ...
    question:
      'Step 1: r1 = 0.40 Ω, rn = 0.42 Ω, r2 = 0.68 Ω end-to-end. Step 3 cross-connection at the furthest socket = 0.27 Ω. Ze = 0.30 Ω. Compute Zs and check against A4:2026 Table 41.3 (Type B 32 A = 1.37 Ω).',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'Why is the ring final test split into three steps rather than just measured end-to-end like a radial?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'Why is r2 (CPC end-to-end) typically higher than r1 (line end-to-end) in a 2.5/1.5 mm² T&E ring?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'During Step 1 you measure end-to-end r1 of a ring. The reading is OL (open circuit). Most likely cause:',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'You have set up Step 3 (L-CPC cross-connection) and at one socket the reading is roughly half of every other socket reading. What does that suggest?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The IET method for satisfying Reg 643.2.1(b). End-to-end r1, rn, r2 with the ring open.
          Then L-N and L-CPC cross-connections at every socket. Spot broken rings, spurs, wiring
          errors from the pattern of readings.
        </p>
        ...
        >
          <p>
            ...
            at a single 32 A protective device, run in a loop through every socket, and return to
            the same protective device. The two paths share the load (each leg carrying roughly half
            the current under normal conditions), and the parallel arrangement gives a lower
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Step 1 — end-to-end continuity.</strong> Disconnect both legs of the ring at
            ...
            <li>
              <strong>Step 2 — L-N cross-connection.</strong> Connect L of one leg to N of the other
              at the CU. Read L-N at every socket. Constant readings prove the ring is intact on
              both L and N.
            </li>
            <li>
              <strong>Step 3 — L-CPC cross-connection.</strong> Connect L of one leg to CPC of the
              other. Read L-CPC at every socket. Constant readings prove the ring is intact on L and
              CPC. The reading also gives R1+R2 for the Zs calc.
            </li>
          </ol>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              any circuit under (a). The 3-step test (end-to-end plus two cross-connections) is the
              IET-published method that satisfies (b) for a ring final.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              At the CU, disconnect both legs of the ring from the protective device terminal (L),
          ...
          <p>
            ...
            12.10 mΩ/m. So for a typical 32 m ring loop:
          </p>
          ...
          <p>
            <strong>Red flags:</strong> r1 differs from rn by more than ~10 %; r2 not consistent
            with the cable size; OL on any reading; values an order of magnitude off (suggests a
            wrong cable size has been installed somewhere on the ring).
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            every socket, constant within a few percent. For r1 = 0.24, rn = 0.24 → expected ≈ 0.12
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              Remove the L-N jumper from Step 2. Set up the new cross-connection: L of leg 1 to CPC
          ...
          <p>
            ...
            every socket, constant within a few percent. For r1 = 0.24 Ω, r2 = 0.39 Ω → expected ≈
            0.16 Ω at every socket. Real-world numbers including terminations: 0.20-0.28 Ω is a
            sensible range for a typical domestic kitchen ring of 32 m.
          </p>
          <p>
          ...
          <p>
            For Ze = 0.30 Ω (typical TN-C-S), R1+R2 = 0.22 Ω → Zs = 0.52 Ω. Compare against A4:2026
            Table 41.3 for the device protecting the circuit. For Type B 32 A: max Zs = 1.37 Ω,
            corrected measured limit = 1.37 × 0.8 = 1.10 Ω. 0.52 Ω is comfortably below 1.10 Ω →
            pass.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              continuity testing requirement of Reg 643.2.1. The 3-step test is the IET method for
              proving the integrity of the ring as required by this regulation. Note also: same
              ...
              would show up in your readings as r1 not equal to rn or as a non-constant
              cross-connection.
            </>
          }
        ...
        >
          <p>
            Use GN3 Table B1 to back-calculate cable size from r1 / rn / r2 readings. Resistance per
            metre at 20 °C for common Cu csa:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1.0 mm²</strong> ≈ 18.10 mΩ/m
            </li>
            <li>
              <strong>1.5 mm²</strong> ≈ 12.10 mΩ/m
            </li>
            <li>
              <strong>2.5 mm²</strong> ≈ 7.41 mΩ/m
            </li>
            <li>
              <strong>4.0 mm²</strong> ≈ 4.61 mΩ/m
            </li>
            <li>
              <strong>6.0 mm²</strong> ≈ 3.08 mΩ/m
            </li>
            <li>
              <strong>10 mm²</strong> ≈ 1.83 mΩ/m
            </li>
          </ul>
          <p>Three sanity checks every time:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>r1 ≈ rn within 5-10 %.</strong> Both line and neutral are the same csa in T&E
              — if they differ by 20 %+, someone has spliced different cables together or there's a
              poor termination on one of them.
            </li>
            <li>
              <strong>r2 / r1 ratio matches the cable type.</strong> 2.5/1.5 T&E gives r2 ≈ 1.63 ×
              r1. 4/1.5 T&E gives r2 ≈ 2.62 × r1 (much higher because the CPC is much smaller
              relative to the line). 6/2.5 T&E gives r2 ≈ 1.50 × r1.
            </li>
            <li>
              <strong>Absolute value matches measured route length.</strong> Walk the cable run with
              a tape if you can, or estimate from the floor plan. r1 / 0.00741 (for 2.5 mm² Cu)
              gives the loop length in metres at 20 °C.
            </li>
          </ul>
          <p>
            An r2 that's substantially higher than r1 × 1.63 on supposed 2.5/1.5 T&E suggests a 1.0
            mm² CPC has been spliced into the ring at some point — non-compliant per Reg 433.1.5
            (same csa throughout) and a finding to investigate before progressing past Step 1.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The On-Site Guide (and Appendix 15 of BS 7671) sets out the rules for a 32 A standard
            ring final on 2.5/1.5 mm² T&E in domestic premises:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>One unfused spur per outlet</strong> on the ring. The spur cable matches the
              ring (2.5/1.5 mm² T&E for a standard 32 A ring). The spur supplies ONE accessory — one
              twin socket, or one fused connection unit feeding multiple outlets via a 13 A fuse.
            </li>
            <li>
              <strong>Fused spurs</strong> via a fused connection unit (13 A BS 1362 fuse) are
              unlimited in number and can feed multiple outlets downstream of the FCU. The fuse
              limits the current the spur can draw.
            </li>
            <li>
              <strong>Total spur load</strong> should not exceed the load that would have been on
              the ring had the spurred accessories been on it instead.
            </li>
          </ul>
          <p>
            Detecting spurs from Step 3 readings (L-CPC cross-connection, intact ring readings
            constant ≈ 0.20 Ω):
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Outlier + ~0.20 Ω</strong> = ~10 m unfused spur — long but still permitted if
              a single accessory.
            </li>
            <li>
              <strong>Multiple outliers from one cluster</strong> = a fused connection unit feeding
              several sockets via 1.5/1.0 mm² cable. Trace the FCU; it should be on the ring proper,
              with the load behind the fuse.
            </li>
          </ul>
          <p>
            Document spurs on the Schedule of Test Results: socket reference, type (fused /
            unfused), approximate cable length, accessory count. Future inspectors compare against
            your record to spot unauthorised additions.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Step 1 — end-to-end r1, rn, r2.</strong> Three readings (one per conductor)
              with the ring open at the CU. Confirms each conductor is continuous around the loop
              and gives sensible expected values.
            </li>
            <li>
              <strong>Step 2 — L-N cross-connection at every socket.</strong> Confirms the ring is
              intact on L and N. Spot wiring errors that would not show up in Step 1 alone.
            </li>
            <li>
              <strong>Step 3 — L-CPC cross-connection at every socket.</strong> Confirms the ring is
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              socket-by-socket diagnostic. Non-compliant for Reg 643.2.1(b).
            </li>
            <li>
            ...
            <li>
              <strong>"Cross-connections at one or two sockets, not all of them."</strong> Misses
              spurs at unsampled sockets. The cost of testing every socket is small — 30-60 seconds
              per socket — and the diagnostic value is high.
            </li>
          </ul>
          <p>
            On the STR you record r1, rn, r2 from Step 1 and the highest cross-connection reading
            (typically from Step 3) as R1+R2 for the circuit. Showing all three end-to-end readings
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You leave both legs of the ring landed in the 32 A RCBO and start Step 1. Your meter
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              approximately 32 m, eight twin sockets at intervals around the kitchen perimeter. 32 A
              Type B RCBO at the CU. TN-C-S supply with measured Ze = 0.30 Ω. You complete the
              3-step test on a Fluke 1664FC.
              <br />
              <br />
              <strong>Step 1:</strong> r1 = 0.36 Ω, rn = 0.38 Ω, r2 = 0.61 Ω. <br />
              <strong>Step 2 (L-N):</strong> readings at all eight sockets between 0.18 and 0.21 Ω.{' '}
              <br />
              <strong>Step 3 (L-CPC):</strong> readings at all eight sockets between 0.22 and 0.25
              Ω.
            </>
          }
          whatToDo={
            <>
              Sanity-check Step 1: r1 ≈ rn (within 6 %, fine), r2 ≈ r1 × 1.7 (close to the expected
              1.63 ratio for 2.5/1.5 T&E), absolute values consistent with 32 m of cable plus
              terminations — pass. Step 2 readings constant within ±10 % across all eight sockets —
              intact ring on L and N. Step 3 readings constant within ±15 % across all eight sockets
              — intact ring on L and CPC. Take the highest Step 3 reading (0.25 Ω) as the R1+R2 for
              the circuit. Compute Zs = Ze + R1+R2 = 0.30 + 0.25 = 0.55 Ω. A4:2026 Table 41.3 max Zs
              for Type B 32 A = 1.37 Ω; corrected measured limit = 1.37 × 0.8 = 1.10 Ω. 0.55 Ω is
              comfortably below 1.10 Ω → pass. Record on the STR: r1 = 0.36, rn = 0.38, r2 = 0.61,
              R1+R2 (highest) = 0.25, Zs (calc) = 0.55. Re-make all CU terminations and proceed to
              insulation resistance testing (Sub 4).
            </>
          }
          whyItMatters={
            <>
              ...
              reading 0.45 Ω in Step 3 (while the others are at 0.25) — that single outlier would
              tell you that socket is on a spur, the spur cable has 0.20 Ω additional resistance (so
              roughly 11 m of additional 2.5 mm² cable), and you would document that spur on the STR
              with location and approximate length.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Continuity of the protective conductor is not just a procedural test — the R1+R2
              readings feed directly into the Ra × IΔn ≤ 50 V check that Regulation 411.5.3 demands
              for RCD fault protection. A clean continuity reading is the input to a clean
              fault-protection calculation.
            </>
          }
