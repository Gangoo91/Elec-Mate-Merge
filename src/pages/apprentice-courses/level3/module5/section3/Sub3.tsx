...
const checks = [
  {
    ...
    options: [
      'A single end-to-end resistance reading at the CU.',
  ...
  },
  {
    ...
    options: [
      ...
      'Zs = 0.30 + 0.68 = 0.98 Ω. Pass.',
      'Cannot compute without rn.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'No cross-connection is needed for Step 2.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Fit the customer's appliances first.",
    ],
    correctAnswer: 1,
    explanation:
