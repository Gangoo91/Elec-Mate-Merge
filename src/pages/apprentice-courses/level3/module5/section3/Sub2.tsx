...
const TITLE =
  'Continuity of protective conductors — R1+R2 and R2-only | Level 3 Module 5.3.2 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    question:
      'You are testing a final circuit on a TN-C-S domestic install. The CU is in the cupboard under the stairs and the furthest accessory is a ceiling rose in the back bedroom. Which method is usually quicker for that single circuit?',
    options: [
      ...
      'R2-only with a wander lead from the MET — run the long lead to the back bedroom, null it at the far end, and read the CPC alone. The single wander lead is quicker than disconnecting and re-landing conductors at the CU for one circuit.',
      'Measure Zs directly with a live loop tester at the ceiling rose — a single live reading at the furthest point gives the whole earth loop in one operation, so no dead continuity test is needed for this circuit.',
      'Insulation resistance between line and CPC at the ceiling rose — a 500 V test confirms the CPC is intact end-to-end and doubles as the continuity check, saving a separate continuity measurement.',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    question:
      'You measure R1+R2 = 0.85 Ω on a Type B 32 A radial socket circuit. Ze = 0.30 Ω. Cable was at roughly 15 °C in an unheated loft when measured. A4:2026 Table 41.3 max Zs (B32) = 1.37 Ω. What do you compare against?',
    options: [
  ...
  },
  {
    ...
    question:
      'Per Reg 643.2.1 you must also verify continuity of main protective bonding conductors. The expected reading on the bond from the MET to an incoming gas service pipe (10 mm² Cu, ≈ 4 m run) is approximately:',
    options: [
      ...
      'Around 0.5 Ω. The bond shares the same 50 V / Ia formula as supplementary bonding, so anything below that calculated limit is acceptable for a main bond.',
      'Around 1-2 Ω. The bonding conductor is sized for mechanical strength, not low resistance, so a reading in this range is normal for a 4 m run to a gas pipe.',
      'Exactly 0 Ω. A main bond must read a true short circuit; any measurable resistance at all indicates a fault at the clamp or the MET.',
    ],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'Only the circuit protective conductors of each final circuit. Main and supplementary bonding are verified by inspection alone, and ring final live conductors are covered by the insulation resistance test rather than continuity.',
      'Only the main protective bonding conductors from the MET to extraneous-conductive-parts. CPCs are proven indirectly by the later Zs measurement, so a separate CPC continuity test is not required.',
      'All line and neutral conductors of every circuit, to confirm the live conductors are continuous. Protective conductors are checked by the insulation resistance test rather than by continuity.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A current of at least 25 mA at a no-load voltage between 4 V and 24 V — low test current avoids overheating fine conductor strands while still proving continuity at every termination.',
      'A current of at least 1 A at a no-load voltage of 50 V — a high test current is needed to force a reading through heavily oxidised terminations and corroded bonding clamps.',
      ...
      'A current of at least 200 mA at a no-load voltage between 230 V and 500 V — the higher voltage drives current through any insulation as well as the conductor, combining the continuity and insulation checks.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 3,
    question:
      'For a 30 m run of 1.5 mm² Cu CPC at 20 °C, the expected R2 from GN3 Table B1 is approximately:',
    options: [
      'Around 0.22 Ω. 1.5 mm² Cu = approximately 7.41 mΩ/m at 20 °C. 30 × 0.00741 = 0.222 Ω.',
      ...
      'Around 0.54 Ω. 1.5 mm² Cu = approximately 18.10 mΩ/m at 20 °C. 30 × 0.01810 = 0.543 Ω.',
      'Around 0.14 Ω. 1.5 mm² Cu = approximately 4.61 mΩ/m at 20 °C. 30 × 0.00461 = 0.138 Ω.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Safely isolate. Leave the line landed on the protective device and the CPC on the earth bar. Link the line and neutral together at the furthest accessory, then measure between L and CPC back at the CU — the reading is R1+R2 for the circuit.',
      'Safely isolate. Disconnect the neutral from the neutral bar and link it to the CPC at the CU. Measure between neutral and CPC at the furthest accessory — the reading is R1+R2 because neutral and line are the same cross-sectional area.',
      'Leave the circuit live. With the supply on, measure between the line and CPC terminals at the furthest accessory using the continuity range — the live test gives R1+R2 directly without disconnecting anything at the CU.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'You want the reading to feed straight into the Zs calculation. R2-only gives R1+R2 directly without any further measurement, so it is the faster route to Zs on every domestic radial.',
      'The cable run is short and the circuit is a simple domestic radial. On a short single circuit the wander lead is quicker than linking the line and CPC at the consumer unit.',
      'The circuit is a ring final. R2-only with a wander lead is the correct way to obtain the three end-to-end ring readings (r1, rn, r2) without opening the ring at the CU.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Supply voltage. A circuit measured on a 230 V supply reads a lower conductor resistance than the same circuit on a 400 V supply, because higher voltage drives more current through the conductor and lowers its apparent resistance.',
      'The protective device rating. A conductor protected by a 32 A device has a higher resistance per metre than the same conductor on a 6 A device, because the larger device allows a higher fault current to flow.',
      ...
      'The test lead length. A longer set of instrument leads permanently increases the conductor resistance of the circuit under test, which is why long wander leads should be avoided on radial circuits.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 7,
    question:
      'If a CPC continuity reading on a 20 m radial 2.5/1.5 mm² T&E circuit comes in at 0.85 Ω at 20 °C, you should:',
    options: [
      'Accept it. Expected R2 for 20 m of 1.5 mm² Cu is approximately 0.85 Ω, so the reading is exactly what the cable size and length predict — record it and move on to insulation resistance.',
      ...
      'Apply the 0.8 correction to the reading: 0.85 × 0.8 = 0.68 Ω. The corrected figure is within range for 20 m of 1.5 mm² CPC, so the reading passes once temperature-corrected.',
      'Re-null the leads and halve the result. Lead resistance typically doubles a short-circuit reading, so the true R2 is approximately 0.42 Ω, which is acceptable for the cable size and length.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    id: 8,
    question:
      'GN3 notes that where accessory boxes are NOT connected to the fabric of the building or other earthed elements, the continuity reading represents:',
    options: [
      'R2 alone — the CPC resistance only. With the boxes isolated from earthed metalwork, the line conductor drops out of the measurement, so the reading is the protective conductor resistance on its own.',
      'A value lower than the true R1 + R2, because the isolated boxes provide additional parallel earth paths that share the test current and reduce the apparent reading.',
      'Half of R1 + R2, because an isolated back-box splits the test current equally between the cable CPC and the box itself before the two paths recombine at the meter.',
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 3 · Subsection 2"
        title="Continuity of protective conductors — R1+R2 and R2-only"
        backTo="/study-centre/apprentice/level3-module5-section3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The two methods for verifying continuity of CPCs and bonding per Reg 643.2.1. Instrument
          requirements (200 mA at 4-24 V), expected values from GN3 Table B1, the 0.8 temperature
          correction, and how the result feeds the Zs calc.
        </p>
        ...
        >
          <p>The Reg 643.2.1 continuity test verifies three categories of protective conductor:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              structural steel, lightning protection earthing). Sized per Reg 544.1 — for TN-C-S
              typically 10 mm² Cu (or larger if the supply earth is bigger).
            </li>
            <li>
              <strong>Supplementary protective bonding conductors.</strong> In special locations
              (bathrooms before the additional protection exemption applied, swimming pools, medical
              locations). Bonds simultaneously-accessible exposed and extraneous parts local to the
              location.
            </li>
            <li>
              <strong>Circuit protective conductors (CPCs).</strong> The earth conductor in every
              final and distribution circuit, from the MET out to every exposed-conductive-part on
              that circuit (every metal accessory, every Class I appliance termination point).
            </li>
          </ul>
          <p>
            Each is tested independently — a broken bond will not be revealed by a CPC test and vice
            versa. Document each on the relevant schedule: bonding on the Schedule of Inspections,
            CPC R1+R2 (or R2) per circuit on the Schedule of Test Results.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Sub-clause (a) is the mandate for continuity testing of every protective conductor.
              The instrument capability — 200 mA at 4-24 V — is the practical requirement that
              distinguishes a verification-grade tester from a basic multimeter. The current is
              enough to detect intermittent contacts; the voltage is low enough to be safe if a
              conductor is unexpectedly partly live.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>Verify safe isolation per the prove-test-prove ritual (Sub 1).</li>
            <li>
              At the CU: identify the line and CPC of the circuit under test. Disconnect L from the
              protective device terminal; disconnect CPC from the earth bar. Tag both so they are
              not re-landed in the wrong terminal at the end.
            </li>
            <li>
              Bridge L and CPC together at the CU end with a low-resistance jumper. The jumper makes
              one continuous loop out of the circuit's L and CPC.
            </li>
            <li>
              Null the MFT continuity leads — touch the probes together, press the null button. The
              meter zeroes the lead resistance.
            </li>
            <li>
              At every accessory in turn (start at the nearest, work to the furthest), connect the
              MFT probes to the L and CPC (or earth) terminals. Press TEST. Note the reading.
            </li>
            <li>
            ...
            <li>
              After testing: remove the jumper, re-land L into the protective device terminal, CPC
              into the earth bar. Visual check polarity. Then proceed to insulation resistance (Sub
              4).
            </li>
          </ol>
          <p>
            <strong>Sanity check the reading against expected.</strong> Use GN3 Table B1 (resistance
            per metre by csa and material). For 2.5/1.5 mm² T&E at 20 °C: R1 ≈ 0.00741 Ω/m, R2 ≈
            0.01210 Ω/m. So a 25 m radial run reads R1+R2 ≈ 25 × (0.00741 + 0.01210) = 0.49 Ω. If
            your reading is significantly higher (1 Ω+), there is a poor termination or a broken
            strand somewhere — investigate before signing off.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              earth paths, the R1+R2 reading is exactly that — the sum of line and CPC resistance
              for the circuit. Add Ze and you have Zs for compliance against Table 41.3. Where
              parallel earth paths exist (metal back-boxes touching earthed steel, conduit systems,
              structural earthing), the reading can be lower than the true R1+R2 — a known
              limitation that makes verification of the CPC alone (R2-only) more reliable in certain
              installations.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              Verify safe isolation. Connect a long wander lead (typically 30-50 m, suitable gauge
              to keep its resistance low) between one MFT probe terminal and the MET.
            </li>
            <li>Walk the wander lead's free end to the first accessory.</li>
            <li>
              Null the leads — touch the wander lead probe to the local MFT probe at the accessory,
              press null. The meter zeroes the wander lead resistance plus the second probe lead.
            </li>
            <li>
              Connect the local MFT probe to the CPC at the accessory. Press TEST. Reading is R2
              from MET to that accessory.
            </li>
            <li>Move to the next accessory. Re-null if leads have changed contact. Continue.</li>
            <li>
              Document each R2 in the R2 column on the Schedule of Test Results, or note the highest
              as the circuit R2 if recording one value per circuit.
            </li>
          </ol>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              CU is in an awkward location (sealed busbar trunking termination, locked meter room)
              and you cannot easily set up the R1+R2 jumper.
            </li>
            <li>
              Large commercial site where running between CU and far accessories on every circuit is
              impractical — one technician at the MET, one walking with the meter.
            </li>
            <li>
              You want to verify the CPC in isolation — for example on a TT installation where the
              earth path is the focus.
            </li>
            <li>
              Periodic inspection where you are sampling and the wander lead is the practical tool
              for the day's work pattern.
            </li>
          </ul>
          <p>
            <strong>Limitation:</strong> R2-only does not give you R1+R2 directly. To compute Zs you
            would need R1 separately (or measure Zs by live test in Section 4). On a TN system R1+R2
            is the cleaner workflow; on TT or where CPC isolation is the priority, R2-only is the
            better tool.
          </p>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Bonding continuity — the same instrument, the MET as one probe point
        </ContentEyebrow>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              Verify safe isolation (the MET should already be at earth potential, but the circuits
              feeding the MET should be isolated for the test).
            </li>
            <li>
              Identify each main bonding conductor at the MET and trace to its clamp on the
              extraneous-conductive-part. Look at the BS 951 clamp — clean? Tight? Pipe conductive
              at the clamp point?
            </li>
            <li>
              Null the leads. One MFT probe firmly on the MET busbar / earth block. Other probe on
              the bonding clamp itself (not on the cable — the clamp termination is the potential
              failure point).
            </li>
            <li>
              Press TEST. Note the reading. Expected: under 0.05 Ω for a typical 4-6 m run of 10 mm²
              Cu, including terminations.
            </li>
            <li>
            ...
            <li>
              Supplementary bonds in special locations (older bathroom installations etc.): same
              method, both ends of the bond should be on simultaneously-accessible conductive parts.
            </li>
          </ol>
          <p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Temperature.</strong> Copper temperature coefficient ≈ 0.004 / °C. A cable at
              20 °C measured reads ~20 % lower resistance than the same cable at 70 °C operating
              temperature. Hence the 0.8 multiplier on Table 41.3 limits when comparing to a
              measured value: Zs(measured) ≤ 0.8 × Zs(table).
            </li>
            <li>
              <strong>Cross-sectional area (csa).</strong> Inverse-proportional. 1.5 mm² Cu has
              ~12.10 mΩ/m; 2.5 mm² has ~7.41 mΩ/m; 4 mm² has ~4.61 mΩ/m. Doubling csa roughly halves
              the resistance per metre.
            </li>
            <li>
              <strong>Material.</strong> Copper is the standard. Aluminium has ~1.6 × the
              resistivity of copper — a 16 mm² Al CPC has roughly the same resistance as a 10 mm² Cu
              CPC. Watch for Al on older or larger installations.
            </li>
            <li>
              <strong>Length.</strong> Linear. Doubling the cable run doubles the resistance. For
              long runs (commercial distribution, sub-mains over 50 m) the cable resistance
              dominates the R1+R2 calculation and may push Zs close to the Table 41.3 limit even
              with a healthy Ze.
            </li>
          </ul>
          <p>
            <strong>Worked correction example.</strong> 30 m of 2.5/1.5 mm² T&E radial. Expected
            R1+R2 at 20 °C from GN3 Table B1: 30 × (0.00741 + 0.01210) = 0.585 Ω. At 70 °C
            operating: 0.585 × (1 + 0.004 × 50) = 0.585 × 1.20 = 0.702 Ω. Ze on TN-C-S say 0.30 Ω.
            Operating Zs = 0.30 + 0.70 = 1.00 Ω. Table 41.3 limit for Type B 32 A = 1.37 Ω. Pass.
            Equivalent rule-of-thumb check: measured Zs (cold) = 0.30 + 0.585 = 0.885 Ω, against 0.8
            × 1.37 = 1.10 Ω — pass.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The classical R1+R2 interpretation assumes the cable is the only path from L to CPC at
            the test point. In real installations:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Metal back-boxes touching earthed metalwork.</strong> The back-box bonds via
              its mounting screws to a metal stud, which connects to the building's structural
              steel, which earths via the lightning protection MET tail. Test current splits between
              the cable CPC and this parallel route.
            </li>
            <li>
              <strong>Steel conduit systems.</strong> The conduit itself acts as a parallel CPC,
              often with very low resistance for short runs — masking a broken or undersized cable
              CPC.
            </li>
            <li>
              <strong>Cable trays and ladder racks.</strong> Where the tray is bonded at the MET
              (per Reg 542.4), every cable terminating into a tray-mounted accessory has a parallel
              path via the tray.
            </li>
          </ul>
          <p>
            The fix in verification work: use R2-only with a wander lead on installations where
            parallel paths are likely. The wander lead's path is dedicated and known. The reading is
            the CPC alone, regardless of what the building fabric is doing. Document the method on
            the test record so the next inspector knows which technique gave the value.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Reg 415.2.2 sets the continuity criterion for supplementary bonding:</p>
          <p className="font-mono text-[14px] text-emerald-300">R ≤ 50 V / Ia</p>
          <p>
            Where R is the resistance between the simultaneously-accessible parts and Ia is the
            current causing automatic operation of the protective device within 5 s (or 0.4 s for
            final circuits up to 32 A). Worked example for a B32 on a 2.5 mm² ring final:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ia for B32</strong> = 5 × 32 = 160 A (top of the magnetic instantaneous
              range).
            </li>
            <li>
            ...
            <li>
              <strong>Typical reading</strong> for a 2 m run of 4 mm² Cu plus two BS 951 clamps ≈
              0.02 Ω. Three orders of magnitude below the limit — substantial headroom.
            </li>
          </ul>
          <p>
            Document the supplementary bonding result on the Schedule of Inspections (the visual /
            continuity outcome line) and reference the calculated Ra limit. Where Reg 701.415.2
            omits supplementary bonding because ADS conditions are met, record that decision and the
            verification readings (Zs at the affected sockets, RCD trip-time test) that support it.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The data captured per circuit in the continuity section of the schedule:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>R1+R2 (Ω)</strong> — value at furthest point on the circuit, end-to-end line
              plus CPC. Used directly in Zs = Ze + (R1+R2).
            </li>
            <li>
              <strong>R2 (Ω)</strong> — CPC alone, if R2-only method used. Useful as a cross-check
              or for circuits where R2 is the only verifiable parameter.
            </li>
            <li>
              <strong>For ring finals:</strong> r1, rn, r2 from end-to-end Part 1 (with the ring
              open). R1+R2 from the Part 3 cross-connection. See Sub 3 of this section.
            </li>
            <li>
          ...
          <p>
            The instrument used and its calibration date should be recorded once on the certificate
            (under Section J of an EIC, the test instruments declaration). The R1+R2 / R2 values
            appear per circuit. The pass / fail judgement is made by comparing measured Zs against
            Table 41.3 — recorded in the Zs column.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Test leads have resistance — typically 0.05-0.15 Ω for standard MFT leads, more if you
              have a long wander lead. You measure R1+R2 at an accessory and read 0.45 Ω. You write
              it down. The actual cable resistance was 0.32 Ω; the rest was lead resistance. You
              have over-stated R1+R2 by 40 %, which on a borderline circuit could be the difference
              between pass and fail at Table 41.3.
            </>
          }
          doInstead={
            <>
              Null the leads at the start of every test session and whenever you change leads or
              swap to a wander lead. Touch the probes together (or to the wander lead end if using a
              wander), press the null button on the MFT. The meter stores the lead resistance and
              subtracts it from subsequent readings. Re-null every time you change leads. The null
              status is usually shown on the display — verify before each circuit.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              length approximately 18 m from the new metal-clad CU on the wall to the oven position
              behind the cabinet. TN-C-S supply, you have already measured Ze = 0.28 Ω at the CU
              during commissioning prep. Time to verify the circuit's continuity before insulation
              resistance.
            </>
          }
          whatToDo={
            <>
              ...
              voltage indicator on a Martindale VI-13800 proving unit before AND after testing the
              isolated point — the unit reads zero on the L-N at the CU. Proceed with R1+R2. At the
              CU: identify the kitchen circuit's L (lift from the RCBO terminal) and CPC (lift from
              the earth bar). Bridge them with a 4 mm² ferruled jumper. On the Megger MFT1741+,
              select continuity mode, touch the probes together, press the auto-null button —
              display shows 0.00 Ω. Walk to the oven connection unit, remove the front plate,
              connect probes to L and CPC at the accessory. Reading comes in at 0.32 Ω. Sanity
              check: 4 mm² Cu = ~4.61 mΩ/m; 18 m × (4.61 + 4.61) = 0.166 Ω at 20 °C (since 4 mm² T&E
              has 4 mm² CPC for some grades; if 4/1.5 then R1+R2 ≈ 18 × (4.61 + 12.10) = 0.301 Ω).
              The 0.32 Ω is consistent with 4/1.5 T&E plus terminations. Compute Zs = Ze + R1+R2 =
              0.28 + 0.32 = 0.60 Ω. A4:2026 Table 41.3 limit for Type B 32 A = 1.37 Ω; 0.8 × 1.37 =
              1.10 Ω. 0.60 is comfortably below 1.10 → pass. Document on the Schedule of Test
              Results: R1+R2 = 0.32, Zs (calc) = 0.60. Remove the jumper, re-land L into the RCBO,
              CPC into the earth bar, double-check polarity by visual inspection. Proceed to
          ...
          whyItMatters={
            <>
              ...
              regulatory limit. This is what verification looks like on the schedule — not just a
              number scribbled in a column, but a number that ties to the cable size, the route
              length, and the disconnection time the protective device needs to achieve under fault.
              The next inspector picking up this EIC in five or ten years can re-test, get a similar
              reading, and trust the chain of evidence. That trust is the entire point of Reg 643.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          clause={
            <>
              Regulation 643.3 has been redrafted. The redraft clarifies requirements for testing
              insulation resistance where connected equipment is likely to influence the
              verification test or be damaged by the test. Where equipment is connected and the
              equipment is likely to influence the insulation resistance verification test or be
              damaged by other test voltages, a 250 V DC insulation resistance test following
              connection of the equipment shall be used.
            </>
          }
          meaning={
            <>
              Continuity testing comes before IR — and Reg 643.3 now gives explicit instruction for
              the IR step where electronic equipment cannot be disconnected: drop to 250 V DC. Older
              test schedules that fixed 500 V DC for everything risk damaging connected kit and
              producing misleading readings.
            </>
          }
        ...
        <Quiz
          title="Continuity of protective conductors — knowledge check"
