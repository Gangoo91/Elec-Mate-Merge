...
const checks = [
  {
    ...
    options: [
      'The supply is at the correct voltage.',
      ...
      'The earth path is intact.',
      'The cable is the right size.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Visual inspection of cable colours alone.',
      ...
      'Apply mains voltage and check with a tester.',
      'Phase rotation meter only.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'No effect — the light still works.',
  ...
  },
  {
    ...
    options: [
      'Apply mains voltage and look for sparks.',
  ...
  },
  {
    ...
    options: [
      ...
      'Apply rubber gloves to the customer.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Red for line, black for neutral.',
      ...
      'Any colours the installer prefers.',
      'White for line, black for neutral.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Testing only at the first lamp.',
      ...
      'Leaving lamps in to make the test easier.',
      'Testing only with the lights switched on.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Polarity isn't important on B22.",
      ...
      'B22 lamps are illegal.',
      'Only screw lampholders need polarity testing.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Skip live polarity testing.',
      'Apply mains voltage to verify continuity.',
    ],
    correctAnswer: 1,
    explanation:
