...
const checks = [
  {
    ...
    options: [
      "There is no difference — both are inspections.",
      ...
      "Initial Verification is for industrial sites only; EICR is for domestic only.",
      "Initial Verification is statutory; EICR is voluntary.",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "1 year.",
      "Whenever the landlord remembers.",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "A polite reminder from the local authority.",
      ...
      "No consequences — the regulations are advisory.",
      "Just a fine of £100.",
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      "EICR within 6 months.",
      "No further inspection ever required.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "An EICR every change of tenancy regardless.",
      "Just a visual check.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Standard 5-year cycle regardless.",
      ...
      "10-year cycle because they are well-built.",
      "No EICR ever required.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "All rented properties in the UK.",
