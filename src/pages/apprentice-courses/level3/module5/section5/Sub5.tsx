...
const TITLE =
  'EICR vs Initial Verification, frequencies, landlord law | Level 3 Module 5.5.5 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    question:
      'The fundamental difference between Initial Verification and Periodic Inspection (EICR) is:',
    options: [
  ...
  },
  {
    ...
    question:
      'Per Electrical Safety First and IET GN3 frequency guidance, the typical EICR interval for a rented dwelling is:',
    options: [
  ...
  },
  {
    ...
    question:
      'A landlord receives an Unsatisfactory EICR. Under the PRS Regulations 2020 the landlord must remediate within 28 days and provide written confirmation. Failure to comply can result in:',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'BS 7671 Chapter 64 (Initial Verification) and Chapter 65 (Periodic Inspection) differ in their:',
    options: [
  ...
  },
  {
    id: 2,
    question:
      'A new build housing development reaches practical completion. The contractor issues an EIC for each dwelling. The next inspection event for each dwelling is:',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'A commercial premises (small office, no special-risk equipment, owner-occupied by a small business) typically gets an EICR every:',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'An industrial installation (small manufacturing unit with general process equipment) typically gets an EICR every:',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'Special locations (Section 700 series — bathrooms, swimming pools, agricultural premises, caravans, marinas, EV charging) typically warrant:',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'The Electrical Safety Standards in the Private Rented Sector (England) Regulations 2020 apply to:',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'After remediation of an Unsatisfactory EICR, the landlord must provide which evidence to demonstrate compliance with the PRS Regulations 2020?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'Does the PRS Regulations 2020 5-year interval apply if the property is between tenancies?',
    answer:
  ...
  {
    question:
      'What if the landlord disputes a finding on the EICR after the local authority has requested it?',
    answer:
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 5 · Subsection 5"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The lifecycle contrast — Initial Verification before energising, Periodic Inspection
          through the installation's life — and the statutory framework that turns a recommended
          interval into a legal duty for rented dwellings under the PRS Regulations 2020.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              designer / contractor under BS 7671 Reg 641.1 (and via Building Regulations Part P for
              notifiable domestic work). Periodic Inspection — owner / occupier under EAWR Reg 4(2);
              landlord under PRS Regs 2020 for rented dwellings; employer under Workplace (H&S)
              Regulations 1992 for workplace installations.
            </li>
            <li>
              <strong>Emphasis.</strong> Initial Verification — does this installation comply with
              BS 7671 at certification? Periodic Inspection — is this installation safe to remain in
              service, assessed against current BS 7671 standards?
            </li>
            <li>
              <strong>Coding system.</strong> Initial Verification — no observation codes;
              installation either passes (EIC issued) or fails and is not certified. Periodic
              Inspection — C1, C2, C3, FI codes per the BPG4 framework.
            </li>
            <li>
          ...
          <p>
            The two regimes work together across the installation lifecycle. Initial Verification
            certifies the installation as built. Periodic Inspection verifies it remains safe in
            service. Major alterations during the life of the installation trigger Initial
            Verification of the altered portion (with an EIC for that work) and may shorten the next
            Periodic Inspection interval if the alteration substantially changes the installation
            profile.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              construction". The shift is important. A periodic inspection assesses an installation
              that may have been built to an older edition of BS 7671 against current safety
              requirements; the question is whether it remains safe, not whether it complies
              retrospectively with standards that did not exist when it was built. The coding
              framework (C1/C2/C3/FI) serves this purpose by communicating ongoing-safety judgements
              rather than as-built compliance.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Owner-occupied domestic dwelling.</strong> 10 years per ESF/GN3. Most common
              interval for the UK domestic stock. Underlying duty is EAWR Reg 4(2) on the homeowner;
              no statutory periodic interval but the recommended cycle is the standard for
              discharging the duty.
            </li>
            <li>
              <strong>Rented domestic dwelling (England).</strong> 5 years per PRS Regs 2020
              statutory maximum, OR change of tenancy whichever is sooner. The 5-year interval is
              statutory; the change-of-tenancy trigger is a hard reset only if the existing
              certificate is more than 5 years old at the new tenancy.
            </li>
            <li>
              <strong>Commercial premises (offices, retail, light commercial).</strong> 5 years per
              ESF/GN3 as starting point. Adjusted shorter for higher-risk environments
              (public-facing retail, food service, public assembly) typically 3-4 years.
            </li>
            <li>
              <strong>Industrial premises (manufacturing, workshops, light industrial).</strong>3
              years per ESF/GN3 as starting point. Heavier industrial environments (foundries,
              chemical handling, 24/7 operation) typically 1-2 years; specialist hazardous-area
              regimes (DSEAR/ATEX) may run separately or in addition.
            </li>
            <li>
              ...
              critical care; public assembly venues 1-3 years per local authority licensing regime.
            </li>
            <li>
              <strong>Special locations (Section 700 series).</strong> Generally shorter than parent
              property type — bathroom inspection within parent dwelling cycle but with 100%
              inspection rather than sample; swimming pool plant rooms annual; agricultural premises
              3 years; EV charge points typically annual or per manufacturer recommendation;
              caravans and marinas per GN3 Chapter 66.
            </li>
            <li>
          ...
          <p>
            ...
            inspector adjusts based on installation-specific factors. For PRS rented dwellings the
            5-year interval is a statutory maximum that cannot be extended; for all other property
            types the intervals are recommendations, with the underlying EAWR Reg 4(2) duty driving
            compliance.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              GN3 is explicit — frequency is a judgement call rooted in the EAWR Reg 4(2) duty, not
              a fixed-table prescription. The standard intervals (5 years rented domestic, 10 years
              owner-occupied, etc.) are starting points reflecting typical condition and use; the
              inspector adjusts based on the specific installation. A new installation in excellent
              condition may justify the standard interval; an aged installation with multiple
              defects under remediation typically warrants a shorter interval to verify the
              remediation. The recommended interval goes on the EICR and the duty holder is
              responsible for commissioning the next inspection on time.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              separate regulation, lodger arrangements where the landlord shares the dwelling, long
              leases (7+ years), student halls of residence under separate regimes, and
              accommodation provided to family members.
            </li>
            <li>
              <strong>Inspection duty.</strong> Landlord must ensure the electrical installation is
              inspected and tested at intervals not exceeding 5 years, OR change of tenancy
              whichever is sooner. The inspection is the standard EICR per BS 7671 Chapter 65
              conducted by a competent person.
            </li>
            <li>
              <strong>Competent person definition.</strong> Suitably qualified and experienced to
              inspect the installation — typically a member of a Competent Person Scheme (NICEIC,
              NAPIT, Stroma, Elecsa) registered for periodic inspection and testing, or holding 2391
              / 2395 / 2394 industry qualifications with documented experience.
            </li>
            <li>
              <strong>Report provision to tenants.</strong> Landlord must provide the EICR (or
              equivalent confirmation) to existing tenants within 28 days of the inspection, to new
              tenants before they occupy the dwelling.
            </li>
            <li>
              <strong>Report provision to local authority.</strong> Landlord must provide the EICR
              to the local authority within 7 days of any request.
            </li>
            <li>
              <strong>Remedial works duty on Unsatisfactory.</strong> Where the EICR identifies C1,
              C2 or FI items requiring remedial works, the landlord must complete the remedial works
              within 28 days of the EICR (or shorter period specified on the report) and obtain
              written confirmation from a competent person that the remedial works have been
              completed and the installation now meets the safety standard.
            </li>
            <li>
              <strong>Local authority enforcement.</strong> Local authority can issue civil
              penalties up to £30,000 per breach, undertake remedial works themselves and recover
              cost from landlord, issue improvement notices, and (in extreme cases) seek property
              prohibition.
            </li>
            <li>
              <strong>Retention.</strong> Landlord must retain the EICR (and any subsequent remedial
              certification) for at least the next inspection cycle (5 years) and make available on
              request to tenants and local authority.
            </li>
          </ul>
          <p>
            The PRS Regs 2020 are the most prescriptive electrical safety regime in UK residential
            property. Inspectors working with landlord clients should treat the briefing on PRS Regs
            as part of every EICR handover; landlords frequently under-estimate the recipient duties
            and the enforcement consequences.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              GN3 explicitly references the UK Government guide as a primary source for landlords.
              Inspectors should know this resource exists and direct landlord clients to it at the
              EICR handover. The Government guide unpacks the statutory duties in plain language,
              defines competent person requirements, gives templates for the tenant notification,
              and lists the local authority enforcement powers. A landlord who has read the
              Government guide is a landlord who understands their duties; the inspector's briefing
              role is to point them to the guide and walk through the key duties relevant to their
              specific EICR.
            </>
          }
        ...
        >
          <p>Coding worked through with examples:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>C1 — Danger present</strong> — exposed live conductors at a damaged socket,
              live chassis on a faulty appliance feeding back, broken main switch handle leaving the
              disconnector unable to isolate. Must be made safe before the inspector leaves the
              property; written into the report and the customer signed off. C1 makes the report
              Unsatisfactory.
            </li>
            <li>
              <strong>C2 — Potentially dangerous</strong> — missing CPC at a metal accessory, wrong
              RCD type on an EV charger, no open-PEN protection on a PME EV install, no main bonding
              to incoming gas / water. Customer is advised urgent remedial within an agreed window
              (typically 28 days). C2 makes the report Unsatisfactory.
            </li>
            <li>
              <strong>C3 — Improvement recommended</strong> — no AFDD on a circuit where A4:2026 now
              recommends one, missing Section 712 PV signage on an older install, no surge
              protection device, plastic CU pre-2016 amendment. Sensible upgrades, not
              safety-critical. C3 alone leaves the report Satisfactory with recommendations.
            </li>
            <li>
              <strong>FI — Further investigation</strong> — anomalous test reading the inspector
              cannot resolve in the visit time, intermittent fault the customer reports but is not
              present on inspection day, suspected damaged conductor hidden behind plaster. FI makes
              the report Unsatisfactory until the investigation closes.
            </li>
            <li>
              <strong>Wrong codes carry consequences</strong> — under-coding a C2 as a C3 leaves a
              serious defect uncorrected and exposes the inspector professionally; over-coding a C3
              as a C2 forces the customer into unnecessary expense and damages the inspector's
              credibility on the next job.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Sample-size benchmarks per circuit category:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Bathroom and kitchen (special locations)</strong> — 100 percent inspection and
              test. The risk and the reg-driven extra requirements (Section 701, supplementary
              bonding history, RCD coverage) make sampling inappropriate.
            </li>
            <li>
              <strong>Recently modified circuits</strong> — 100 percent. The modification window is
              where defects get introduced; inspect everything affected.
            </li>
            <li>
              <strong>Standard final circuits in good condition</strong> — 10 percent of accessories
              per circuit, plus end-to-end CPC verification, plus furthest-point Zs, plus RCD test
              on the protective device. Adequate to evidence the circuit is healthy.
            </li>
            <li>
              <strong>Circuits with reported defects</strong> — 100 percent. The customer reported
              it; investigate it fully.
            </li>
            <li>
              <strong>Sample size on the report</strong> — record explicitly with the rationale.
              Future inspectors and the customer's solicitor / mortgage lender both look for this
              transparency.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common non-cycle triggers and what the customer expects:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Conveyancing</strong> — solicitor's pre-contract enquiries include the EICR
              question. Buyer's solicitor reads the report; an Unsatisfactory finding can re-open
              the price negotiation or stall exchange.
            </li>
            <li>
              <strong>Mortgage lender</strong> — older properties, formerly tenanted properties, or
              properties with visible electrical concerns prompt a lender retention or condition.
              Customer needs the EICR to release the retention.
            </li>
            <li>
              <strong>Buildings insurance renewal</strong> — many policies now ask about EICR
              currency. An Unsatisfactory or absent EICR can void a fire claim if traced back to
              electrical cause.
            </li>
            <li>
              <strong>Major insurer-required upgrades</strong> — RCD protection on circuits,
              plastic-CU replacement, modern bonding. Customers receive an insurer letter and need a
              contractor to inspect, quote and certify the remediation.
            </li>
            <li>
              <strong>Selling tenanted property</strong> — customer needs the current PRS-Regs EICR
              to evidence compliance through the sale to the new landlord. The cycle clock resets to
              the date of the most recent EICR, not the sale date.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              duties on landlords broadly aligned with the English PRS Regs — periodic inspection
              (typically 5 years), written confirmation to tenants, local authority enforcement. The
              Welsh framework is administered through Welsh local authorities with their own
              enforcement powers.
            </li>
            <li>
              <strong>Scotland.</strong> The Housing (Scotland) Act 2006 plus Scottish Government
              guidance on the tolerable standard and repairing standard for private rented sector
              dwellings. Includes electrical safety requirements with periodic inspection (typically
              5 years) and written confirmation duties. Administered through Scottish local
              authorities with reference to the Tolerable Standard guidance.
            </li>
            <li>
              ...
              Periodic inspection requirements broadly aligned with the English PRS Regs; local
              authority enforcement through the NIHE / district councils.
            </li>
          </ul>
          <p>
            The technical EICR is identical across all four UK nations — BS 7671 is the recognised
            standard UK-wide. The statutory framework, recipient duties, and enforcement powers
            differ. An inspector working in Cardiff applies the Welsh framework; in Edinburgh the
            Scottish framework; in Belfast the Northern Irish framework. The customer briefing
            should reflect the relevant national regime.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              GN3 acknowledges the devolved nature of UK electrical safety regulation in the rented
              sector. The Scottish framework differs from the English PRS Regs in statutory wording
              but the technical effect on the installation and the EICR is broadly similar.
              Inspectors operating in Scotland should reference the Scottish guidance on the
              tolerable and repairing standards rather than the English PRS Regs when briefing
              landlord clients on their statutory duties.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A landlord asks you to inspect a property where the previous EICR was issued 6 years
              ago. You note the certificate is over 5 years old but assume "5 years is a guideline"
              and the landlord can extend if there are no apparent issues. You issue the new EICR
              Satisfactory and date the next inspection 5 years from now. Two months later the local
              authority audits the landlord's portfolio and finds the gap between certificates
              exceeded 5 years. The landlord is fined under the PRS Regs; the audit also flags your
              contractor company as having issued the replacement certificate without challenging
              the gap. Your scheme provider opens an investigation.
            </>
          }
          doInstead={
            <>
              The 5-year interval under PRS Regs 2020 is a statutory maximum, not a guideline. A gap
              exceeding 5 years is a landlord breach regardless of whether a competent inspector
              subsequently certifies. When you find a property with an over-due previous EICR, brief
              the landlord on the breach (it has already happened — the gap exists in the historical
              record). Carry out the new EICR. Document on the Extent and Limitations note the date
              of the previous certificate and the resulting gap. Recommend the landlord seek their
              own legal advice on the historical breach. The new EICR is a clean restart of the
              cycle but does not erase the historical breach; that is between the landlord and the
              local authority.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You take on inspection work for a housing association that owns 200 social housing
              units. You apply the PRS Regs framework — 5-year statutory cycle, landlord must
              provide reports to tenants within 28 days, local authority enforcement under the PRS
              Regs. The housing association legal team challenges your approach — social housing
              tenancies are not within the scope of the PRS Regs 2020. The housing association has
              its own statutory framework under the Decent Homes Standard and the Regulator of
              Social Housing's safety standards. Your briefing has been wrong; the housing
              association's internal compliance framework is what governs.
            </>
          }
          doInstead={
            <>
              Check the regulatory scope before briefing on statutory duties. PRS Regs 2020 cover
              private rented sector dwellings in England — most ASTs, licences to occupy, and HMOs.
              Social housing is governed by separate regimes — the Decent Homes Standard, the
              Regulator of Social Housing's safety standards, the Building Safety Act 2022 for
              higher-risk residential buildings (HRRBs). Many of these regimes use the same EICR
              mechanism but with different recipient duties, different intervals, and different
              enforcement frameworks. Where a client straddles multiple regimes (a housing
              association with some private rented stock and some social housing), brief on each
              regime as it applies to the relevant units.
            </>
          }
        />
        ...
        <ContentEyebrow>
          Worked scenario — landlord 5-year periodic and the lifecycle
        </ContentEyebrow>
        ...
        <Scenario
          ...
          situation={
            <>
              You are reviewing the documentation history for a three-bed terrace your contractor
              was first engaged on in 2020. The 2020 work was a full rewire and CU replacement —
              your colleague issued an EIC at that time. The property was then let to its first
              tenants in 2021. The landlord has now phoned to commission the statutory 5-year EICR —
              due in 2026 since the EIC dated 2020 sits as the cycle start.
            </>
          }
          whatToDo={
            <>
              Review the lifecycle. The 2020 EIC under BS 7671 Chapter 64 certified the installation
              as built, with a recommended next inspection date of 5 years (per the rented-property
              recommendation on the EIC at the time, anticipating the PRS Regs framework). The first
              tenancy in 2021 was within the 5-year window of the EIC so no fresh EICR was
              statutorily required at that point under PRS Regs (the EIC effectively functions as
              the inspection record for the period). The 2026 EICR is now due — under BS 7671
              Chapter 65 not Chapter 64 — and the landlord must have it in place to maintain
              compliance with PRS Regs. Plan the EICR with the landlord — agree scope, sampling rate
              (the installation is only 6 years old and under continuous tenancy with no documented
              incidents, so a typical 10% sampling rate of accessories with full CU/DB inspection is
              appropriate). Carry out the inspection. Apply the BPG4 coding framework. Issue the
              EICR with recommended next inspection date 2031 (assuming Satisfactory). Brief the
              landlord on the PRS Regs recipient duties. Diary the next cycle. The lifecycle
              continues — EIC at construction, EICR every 5 years thereafter under PRS Regs, with
              each document evidencing the duty holder's discharge of the relevant duty at that
              point.
            </>
          }
          whyItMatters={
            <>
              The lifecycle perspective shows how Initial Verification and Periodic Inspection fit
              together over a property's life. The EIC is a one-off entry document; the EICR cycle
              is the ongoing safety record. Together they evidence the chain of competent oversight
              from construction through use. For PRS rented dwellings the 5-year cycle is statutory;
              missing one cycle is a landlord breach with civil penalty exposure up to £30,000. For
              owner-occupied dwellings the 10-year cycle is recommended rather than statutory but
              the EAWR Reg 4(2) duty on the homeowner means failure to maintain becomes a civil and
              potentially criminal matter on incident. The inspector's role spans both regimes —
              Initial Verification competence under Chapter 64 and Periodic Inspection competence
              under Chapter 65 are distinct skill sets that a Level 3 apprentice builds through the
              structured progression of this Unit 304 syllabus.
            </>
          }
        />
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              older equivalents. Plus 2382 (BS 7671 Wiring Regulations) at the current edition.
              These give the theory base.
            </li>
            <li>
              <strong>Practical competence.</strong> Apprenticeship, AM2 / AM2S assessment, or
              equivalent on-the-job competence-build. Plus inspection and testing experience under
              supervision on real installations.
            </li>
            <li>
              <strong>Periodic-specific qualification.</strong> 2391 (initial verification +
              periodic inspection of LV electrical installations), 2394 (initial verification only),
              2395 (periodic inspection only). These industry quals are the formal evidence of
              periodic inspection competence beyond the apprentice base.
            </li>
            <li>
              <strong>Scheme registration.</strong> NICEIC, NAPIT, Stroma, Elecsa — each runs a
              Competent Person Scheme that audits members and registers them as competent for
              specific work types. Periodic inspection registration is the relevant registration for
              EICR work; some schemes require demonstrated 2391/2395 qualification plus practical
              assessment.
            </li>
            <li>
              <strong>Continuing development.</strong> A4:2026 updates (Reg 643.7.3 single AC RCD
              test, Reg 421.1.7 AFDD recommendation, Table 41.3 updated Zs, Reg 132.13
              documentation, TN-C-S PNB clarification), scheme CPD requirements, ongoing practice.
              Competence is not a one-shot achievement.
            </li>
            <li>
              <strong>Specialist competence where relevant.</strong> Special-location competence (EV
              charging Section 722, agricultural Section 705, swimming pools Section 702, hazardous
              areas DSEAR/ATEX), thermographic surveying competence where used, dynamic-load testing
              competence on industrial installations.
            </li>
          </ol>
          <p>
            The competent-person requirement protects everyone — the duty holder relies on the
            inspector's competence; the inspector's professional standing depends on maintaining
            competence; the regulatory framework presumes competence underpins the certificates and
            reports it requires. An inspector who issues EICRs without the competence stack to
            support them puts themselves, their clients, and ultimately the end users at risk.
          </p>
        </ConceptBlock>
        ...
        <Quiz
          title="EICR vs Initial Verification, frequencies, landlord law — knowledge check"
