...
const checks = [
  {
    ...
    options: [
      'An Electrical Installation Certificate (EIC) — it covers everything.',
      ...
      'A PAT test certificate for fixed wiring.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'EAWR is the same document as BS 7671.',
      ...
      'GN3 overrides BS 7671 Part 6.',
      'BS 7671 is statutory; EAWR is just guidance.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'No impact — the old numbers still apply.',
      ...
      'Only Chapter 64 changed.',
      'The amendment is informative, not technical.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'To increase the inspector\'s workload.',
      ...
      'To replace all old wiring.',
      'To certify new circuits.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only the model EICR form changed.',
      'Part 6 was deleted.',
      ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Recommend a date for the next inspection.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only Building Control inspectors.',
      'Only Distribution Network Operators.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'C1 because it does not meet current BS 7671.',
  ...
  },
  {
    ...
    options: [
      'Nothing — set periods are automatic.',
  ...
  },
  {
    ...
    options: [
      ...
      'Departures are always C1.',
      'Only observations need recording.',
    ],
    correctAnswer: 1,
    explanation:
