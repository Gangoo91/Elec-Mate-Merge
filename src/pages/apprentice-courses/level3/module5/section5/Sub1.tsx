...
const checks = [
  {
    ...
    question:
      'A landlord asks you for "a safety certificate" on a recently purchased rental dwelling. What is the correct document and why?',
    options: [
  ...
  },
  {
    ...
    question:
      'How does the Electricity at Work Regulations 1989 (EAWR) relate to BS 7671 Part 6 and GN3?',
    options: [
  ...
  },
  {
    ...
    question:
      'BS 7671:2018+A4:2026 has restructured Part 6. What is the practical impact for an inspector reading older material?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'What is the primary purpose of periodic inspection and testing of an electrical installation?',
    options: [
  ...
  },
  {
    id: 2,
    question:
      'Which statutory instrument creates the legal duty for landlords in the English private rented sector to commission periodic EICRs?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'During an EICR you find an old non-compliant installation that was compliant when first installed. How do you code this?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'What must the inspector record on an EICR even if the chosen frequency follows a set licensing period?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'What is the relationship between an EICR observation and a "departure" entered on the EICR?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'My client says "we already have an EICR — why do I need to redo it?" The previous one was 4 years ago and codes look fine. What do I do?',
    answer:
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 5 · Subsection 1"
        title="EICR purpose and framework"
        backTo="/study-centre/apprentice/level3-module5-section5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Why periodic inspection and testing exists, where the EICR sits in the law, and how BS
          7671 Part 6, GN3 and the ESF Best Practice Guides interlock to give you the practical
          method for an EICR.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>MEIWC — Minor Electrical Installation Works Certificate.</strong> Issued for
              minor works on an existing circuit (a new accessory, a like-for-like board swap that
              does not add circuits). One signature. Limited scope.
            </li>
            <li>
              <strong>EICR — Electrical Installation Condition Report.</strong> Issued following
              periodic inspection of an existing installation. One signature (inspector). Reports
              condition, codes defects, recommends next inspection.
            </li>
          </ul>
          <p>
            ...
            installation is still safe — and under EAWR 1989 they carry personal liability for that.
          </p>
          <p>
            <strong>Critical distinction.</strong> An EICR codes against the CURRENT edition of BS
            7671 (today: BS 7671:2018+A4:2026) but the C1/C2/C3 codes are about danger/potential
            danger/improvement — NOT about retrospective re-compliance. An old install can be fully
            safe and properly maintained and still get a "Satisfactory" EICR with C3 observations
            noting where current standards have moved on. The EICR is not a vehicle to force every
            old installation up to today&apos;s edition.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              GN3 sets out the purpose plainly: condition, danger, deterioration, documented report.
              The EICR is the deliverable. Note the emphasis on "in service" — this is not a
              verification of new work but an in-life assessment. Findings get codes,
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Health and Safety at Work etc Act 1974.</strong> Primary legislation — general
              duties on employers and the self-employed.
            </li>
            <li>
              <strong>Electricity at Work Regulations 1989 (EAWR).</strong> Secondary legislation
              made under HSWA 1974. The key regs for inspection: <strong>Reg 4(2)</strong> (systems
              to be maintained as may be necessary to prevent danger), <strong>Reg 4(3)</strong>{' '}
              (work activities), <strong>Reg 16</strong> (no person shall be engaged in any work
              activity where technical knowledge or experience is necessary to prevent danger unless
              they possess such knowledge or experience). HSE memorandum HSR25 gives practical
              guidance.
            </li>
            <li>
              <strong>Sector-specific statutory instruments.</strong> e.g. The Electrical Safety
              Standards in the Private Rented Sector (England) Regulations 2020 (SI 2020/312) —
              five-year EICR cycle for English landlords. Wales has the Renting Homes (Wales) Act
              2016 / 2022 regulations. Scotland has the Housing (Scotland) Act 2014 standards.
              Northern Ireland has its own equivalents. HMO licensing regimes layer additional
              periods on top.
            </li>
            <li>
              <strong>BS 7671:2018+A4:2026 — Part 6 (Inspection and testing).</strong> Non-statutory
              but cited in HSE prosecutions as "the recognised standard". Part 6 was completely
              restructured and renumbered in A4:2026 to align with the CENELEC standard. Inspectors
              must use the new numbering.
            </li>
            <li>
              <strong>IET Guidance Note 3 (GN3).</strong> Practical companion to BS 7671 Part 6.
              Non-statutory guidance, but widely treated as best practice. Updated to align with
              each amendment.
            </li>
            <li>
              <strong>Electrical Safety First (ESF) Best Practice Guide 4.</strong>{' '}
              Industry-standard guidance on EICR coding (C1/C2/C3/FI) and on the application of the
              codes to common defects. This is what inspectors actually reach for when deciding what
              code to apply.
            </li>
          </ol>
          <p>
            The practical workflow: GN3 tells you HOW to do the inspection; BS 7671 Part 6 tells you
            WHAT must be verified; ESF BPG4 tells you HOW to code what you find; and EAWR 1989 tells
            you WHY it all matters legally.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Practical implication: every EIC, MEIWC and EICR template that predates A4:2026 must
              be updated. Citations on inspection reports, training material references, competent
              person scheme audit checklists — all need to use the new 64x.x numbering. If you cite
              a pre-A4 number on a current report, an auditor will flag it as a compliance gap.
            </>
          }
        ...
        >
          ...
          <p>Other relevant EAWR regulations the EICR touches:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              construction (loose terminations, damaged accessories, undersized cables) feed back
              into this duty.
            </li>
            <li>
              <strong>Reg 4(3).</strong> Work activities — including inspection and testing. The
              work of doing the EICR itself is governed by EAWR Reg 4(3). Hence safe isolation,
              dead-test sequences, live-test risk control.
            </li>
            <li>
              <strong>Reg 13.</strong> Precautions for work on equipment made dead. Aligns with safe
              isolation procedures during EICR testing.
            </li>
            <li>
              <strong>Reg 14.</strong> Work on or near live conductors. Limits live testing — only
              where the inspector has determined it is unreasonable for the work to be carried out
              dead AND suitable precautions have been taken AND the inspector is competent.
            </li>
            <li>
              <strong>Reg 16.</strong> Persons to be competent to prevent danger and injury. The
              competence requirement on the inspector themselves.
            </li>
          </ul>
          <p>
            <strong>Personal liability.</strong> Under EAWR, prosecution can target the duty-holder
            personally — directors, managers, the self-employed. A signed EICR that demonstrably
            misled the duty-holder (codes downplayed, defects missed) can draw the inspector into
            the prosecution chain too. The signature matters.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Qualified and competent inspector.</strong> The 2020 Regs do not name specific
              qualifications but the explanatory guidance points to BS 7671 Part 2 "skilled person"
              + competent person scheme membership + 2391/2394/2395 (or equivalent).
            </li>
            <li>
              <strong>28-day remediation.</strong> Any C1, C2 or FI code must be remediated within
              28 days of inspection (or within the shorter period specified in the report if
              applicable). Remedial work must be evidenced — typically a confirmation report or
              further EICR.
            </li>
            <li>
              <strong>Tenant copy within 28 days.</strong> The landlord must give the tenant a copy
              of the EICR within 28 days of inspection.
            </li>
            <li>
              <strong>New-tenant copy.</strong> Before a new tenant moves in, they must receive a
              copy of the most recent EICR.
            </li>
            <li>
              <strong>Local authority on request.</strong> Within 7 days of a written request from
              the local housing authority, the landlord must supply a copy.
            </li>
            <li>
          ...
          <p>
            ...
            practical electrical standard (BS 7671 Part 6 + GN3 + BPG4) is the same across the UK;
            the legal triggers and timescales differ.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Underlying qualification.</strong> Typically City & Guilds 2365 Level 3 (or
              2360 / 2330 / 2356 historic equivalents) — the core electrician qualification.
            </li>
            <li>
              <strong>Inspection and testing qualification.</strong> City & Guilds 2391-50/52, 2394
              (initial verification), 2395 (periodic inspection), or EAL equivalent. The 2395
              specifically covers periodic inspection / EICR scope and is the most relevant for an
              EICR signatory.
            </li>
            <li>
              <strong>Competent person scheme membership.</strong> NICEIC, NAPIT, ELECSA, Stroma,
              BSI etc. CPS audit confirms ongoing competence and gives the inspector independent
              verification of their work product.
            </li>
            <li>
              <strong>Indemnity insurance.</strong> Professional indemnity at appropriate level for
              the type of work (commercial/industrial EICRs typically demand higher cover).
            </li>
            <li>
              <strong>Demonstrable experience.</strong> Periodic inspection of similar installations
              — domestic, commercial, industrial, special location. The qualifications open the door
              but the experience is the substance.
            </li>
            <li>
              <strong>Calibrated test equipment.</strong> Per GN3: instruments shall be periodically
              calibrated. Calibration certificates with traceability to National Standards.
              Intermediate checks (instrument check box) are not a substitute for formal
              calibration.
            </li>
          </ul>
          <p>
            <strong>"The inspector" may denote one or more persons</strong> per GN3. On a large EICR
            you may have a lead inspector plus assistants. The lead inspector signs and carries the
            responsibility for the team output. Assistants document under the lead direction.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The statutory competence requirement that backs the BS 7671 "skilled person" test.
              Critical for periodic inspection: the inspector personally bears the Reg 16 duty. They
              cannot defer it to their employer or to the duty-holder. If they sign an EICR for an
              installation type they are not competent on, they are in breach of Reg 16 — even if no
              defect was missed. Practical answer: refuse the work, refer the client to a more
              suitably competent inspector.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              Live exposed conductors, broken socket showing live terminals, missing CPC at a Class
              I appliance. Make safe before leaving site; record on EICR.
            </li>
            <li>
              <strong>C2 — Potentially dangerous, urgent remedial action required.</strong> Defect
              not presenting immediate danger but creating a credible path to danger if a fault
              occurs. Loss of bonding to a service, RCD that fails to trip, MCB at an outlet showing
              signs of overheating but not yet failed.
            </li>
            <li>
              <strong>C3 — Improvement recommended.</strong> Non-compliant with current BS 7671 but
              does not present a present or potential danger. Common: lack of AFDD on a circuit
              where current edition recommends one, lack of RCD additional protection on an old
              install where it was not required at install time. The EICR can still be Satisfactory
              with C3 observations.
            </li>
            <li>
              <strong>FI — Further investigation required without delay.</strong> Inspector cannot,
              on the available information, determine the level of risk. Example: a cable disappears
              into a wall and the destination is not accessible — the inspector needs to come back,
              open up, investigate further before coding.
            </li>
          </ul>
          <p>
            The code on the report determines the overall verdict: an EICR with any C1, C2 or FI is
            "Unsatisfactory". An EICR with only C3 (or no observations) is "Satisfactory". Sub 2
            covers the rubric in full detail with worked examples for each code.
          </p>
        </ConceptBlock>
        ...
        >
          <p>GN3 frequency table (recommended maximum intervals) — typical entries:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Domestic — owner-occupied.</strong> 10 years or change of occupancy, whichever
              sooner.
            </li>
            <li>
              <strong>Domestic — rented (PRS).</strong> 5 years (statutory maximum under PRS Regs
              2020) or change of tenancy.
            </li>
            <li>
              <strong>Domestic — HMO / shared.</strong> 5 years; HMO licensing periods may shorten.
            </li>
            <li>
              <strong>Commercial — offices, retail, restaurants.</strong> 5 years or change of
              occupancy.
            </li>
            <li>
            ...
            <li>
              <strong>Hospitals and clinical environments.</strong> 5 years (1 year for medical
              group 2 locations under Section 710).
            </li>
            <li>
            ...
            <li>
              <strong>Caravan parks (sites).</strong> 1 year for hook-ups; 3 years for fixed
              installations.
            </li>
            <li>
          ...
          <p>
            The inspector adjusts the recommended interval based on: condition observed during the
            inspection, age of the installation, environment (damp, dusty, corrosive, mechanical
            wear), use pattern (24/7 operation vs intermittent), evidence of previous remedial work,
            and any C1/C2 defects identified. A heavily-defective installation under remediation may
            justify a shorter cycle to verify the remediation; a well-maintained installation in
            good condition may justify the full table interval. Document the rationale on the EICR —
            even when the chosen interval matches the table default.
          </p>
        </ConceptBlock>
        ...
        >
          <p>GN3 sampling guidance for typical installation types:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Consumer unit / distribution board.</strong> 100 % — visual inside, every
              device verified, every termination torqued where access permits, every bond verified,
              every label read.
            </li>
            <li>
              <strong>Main protective bonding.</strong> 100 % — every bond from MET to
              extraneous-conductive-part inspected and continuity-tested.
            </li>
            <li>
              <strong>Socket-outlet circuits.</strong> 100 % live tests at the furthest point of
              each circuit; 100 % visual on every accessory if practical, otherwise sample at
              minimum 10 %.
            </li>
            <li>
              <strong>Lighting circuits.</strong> Sample of fittings (typically 25-50 %) for visual
              condition; live Zs at the furthest point of each circuit.
            </li>
            <li>
              <strong>Fixed appliances (cooker, shower, immersion).</strong> 100 % — each circuit
              tested at the appliance termination box.
            </li>
            <li>
              <strong>Special locations (bathrooms, kitchens, outdoor circuits).</strong> Higher
              sample rate (typically 100 %) because of elevated risk.
            </li>
            <li>
              <strong>Concealed cables / inaccessible items.</strong> Limited sample by definition;
              record under EICR Limitations and code FI if material to safety assessment.
            </li>
          </ul>
          <p>
            The Limitations section of the EICR is the inspector's protection — it documents what
            was and wasn't inspected, why, and what the duty-holder agreed. Common limitation
            entries:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              "Sampling rate of 25 % on lighting points agreed with duty-holder; Reg 651.3 (no
              danger to persons) prevented full removal of fittings."
            </li>
            <li>
              "Tenant refused access to bedroom 2 on inspection day; circuit verified at CU only,
              recommend follow-up inspection within 28 days."
            </li>
            <li>
              "RCD trip test on circuit C5 omitted at duty-holder request — circuit feeds essential
              medical equipment; functional test deferred to scheduled maintenance window."
            </li>
            <li>
              "Concealed cables in floor void not visible; verified by continuity and IR but no
              visual confirmation of routing."
            </li>
          </ul>
          <p>
            The combination of agreed scope, documented sampling rate and explicit limitations turns
            the EICR from a tick-box exercise into a defensible audit trail. An inspector who finds
            an unforeseen limitation on the day (RCD trip would interrupt critical equipment, locked
            plant room with no key) records it, agrees with the duty-holder, and codes accordingly —
            typically FI for items the limitation prevented from being verified.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Inexperienced inspector arrives at a 1990s domestic install. No RCDs. No AFDDs. Old
              plastic CU. Fully metal back-boxes. They write up every "non-compliance with current
              BS 7671" as a C2 and the report comes back Unsatisfactory. The landlord is forced into
              a £4k rewire to address phantom defects. The local authority later rejects the report
              on appeal because the codes were not justified by the BPG4 rubric.
            </>
          }
          doInstead={
            <>
              Code per ESF Best Practice Guide 4 — C1/C2 are reserved for present or potential
              danger. Items that were compliant at install but no longer match the current edition
              are usually C3 (improvement recommended). The 1990s install with no RCDs is C3
              (improvement recommended) for the lack of additional protection — UNLESS you find a
              specific risk path (kitchen socket within 3 m of a sink with no RCD and a Class I
              appliance plugged in and showing signs of damage) which would push it to C2 for that
              specific circuit. Justify every C1/C2 against the BPG4 rubric.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A landlord, recently bought a three-bed semi in Manchester and lets it. They contact
              you for "a safety certificate before the tenants move in next week". Property has been
              empty for two months. Last EICR they could find is from 2017, six years ago, by an
              inspector who is no longer trading. Original install dates from 2003 (full rewire by a
              competent installer at the time). One alteration — a kitchen extension and new ring
              final added in 2018, with an EIC produced. Consumer unit is a metal-clad Wylex with
              RCDs on each ring final and the shower circuit. No AFDDs.
            </>
          }
          whatToDo={
            <>
              Confirm scope: full EICR on the entire installation (the previous EICR is more than 5
              years old AND the inspector cannot be contacted — start fresh). Request copy of the
              2018 EIC for the kitchen extension as evidence of that part of the install. Quote on
              the basis of: full EICR per BS 7671 Part 6 + GN3, sample rate appropriate for a
              domestic dwelling (typically 100% on socket circuits, 100% on the CU, sample on
              lighting and hard-wired accessories), report with C1/C2/C3/FI codes per BPG4. Carry
              out the inspection and testing, write up the EICR with codes, agree any C1/C2
              remediation timescales with the landlord (PRS Reg requires 28 days max), recommend
              next inspection interval (5 years under PRS Reg, or shorter if specific defects
              warrant). Issue tenant copy via the landlord within 28 days — the 2020 PRS Regs
              require it. Note in the report: lack of AFDDs is C3 (recommendation per A4:2026 Reg
              421.1.7) — not C2 — because AFDDs are recommended not required, and the install is not
          ...
          whyItMatters={
            <>
              ...
              non-compliant with the 2020 PRS Regulations the moment a tenant moves in — fines up to
              £30,000 per breach, plus tenants can withhold rent under disrepair provisions. Get the
              codes wrong (over-coding C3s as C2s) and you force the landlord into unjustified
              remedial work and damage your professional reputation when the report is challenged.
              Get them right and the landlord has a defensible document, the tenant has a copy as
              required, and the local authority cannot enforce against the landlord on this point
