...
const checks = [
  {
    ...
    options: [
      "100% of all circuits, all accessories, all enclosures — no sampling permitted on any periodic.",
      ...
      "50% of all circuits if the installation is over 10 years old, otherwise no testing required.",
      "Whatever the inspector decides on the day with no need to record the decision.",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Pad the report with disclaimers.',
      ...
      'Note the weather on the day of inspection.',
      'List the inspector\'s qualifications.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Code the three observed defects and stop sampling.",
      ...
      "Average the three defects across the whole installation and code accordingly.",
      "Re-quote the customer for additional inspection time before doing anything more.",
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      "The inspector unilaterally on the day.",
      ...
      "BS 7671 prescribes a fixed scope for every EICR.",
      "The scheme provider sets the scope and inspectors must follow it.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Agree, do the minimum the customer wants, sign the EICR.",
      "Decline the work — you cannot perform a partial EICR.",
      ...
      "Quote a low price and apply C3 to all observations to keep the customer happy.",
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Ignore the maintenance records.",
      "Triple the recommended inspection interval automatically.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "100% of all 30 flats plus all common parts.",
      ...
      "Just the common parts and ignore the flats entirely.",
      "Pick three flats randomly and pretend it represents all 30.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "10% always, no exceptions.",
      "The inspector decides on the day with no need to document.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Refuse the EICR entirely.",
      "Carry out live testing without isolation — Reg 14 doesn't apply to inspections.",
      ...
      "Pretend the items were tested even though they were not.",
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Whichever circuits are easiest to access.",
      "All lighting circuits and no socket circuits.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "A verbal understanding between inspector and customer on the day.",
      "A standard wording the inspector copies onto every EICR.",
      ...
      "Optional — only required for commercial premises.",
    ],
    correctAnswer: 2,
    explanation:
