...
const checks = [
  {
    ...
    options: [
      ...
      'C2 — potentially dangerous, action required urgently.',
      ...
      'No code — cable accessible only when the front is removed.',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "No code — installation pre-dates the requirement so it's grandfathered.",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "C1 — Zs over the limit means immediate danger.",
      "C2 — disconnection time will not be met.",
...
const quizQuestions = [
  {
    ...
    options: [
      'A statutory instrument with the force of law.',
      ...
      'A British Standard equivalent to BS 7671.',
      'A document produced solely by NICEIC for its registered contractors.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Note it on the EICR and move on.',
      ...
      'Email the client a copy of the EICR within 28 days.',
      'Refer it to the next inspection cycle.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'C1 — incorrect identification is dangerous.',
      ...
      'C3 — improvement recommended only because the circuit functions correctly.',
      'No code required.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'C1 — fire risk is immediate.',
      "C2 — escape route compromised.",
  ...
  },
  {
    ...
    options: [
      ...
      'Only if a C1 is recorded.',
      "If more than five C3s are recorded.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'C1 — failure to comply with current standard.',
      'C2 — potentially dangerous absence of arc fault protection.',
  ...
  },
  {
    ...
    options: [
      'Code C2 immediately and move on.',
      "Code C1 immediately and isolate the installation.",
      ...
      "Issue an FI and leave the bonding disconnected.",
    ],
    correctAnswer: 2,
    explanation:
