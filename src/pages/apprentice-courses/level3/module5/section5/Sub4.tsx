...
const checks = [
  {
    ...
    options: [
      "Email the report and move on to the next job.",
      ...
      "Leave the report on the kitchen table and depart.",
      "Wait 28 days then post the report.",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "All findings have equal priority.",
      ...
      "Tackle them in alphabetical order of room.",
      "Whichever is cheapest first.",
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      "Be left blank — the codes speak for themselves.",
      "Use only technical jargon to demonstrate competence.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Maximum technical jargon — they can look it up.",
      ...
      "Just say \"problem\" and let them ask.",
  ...
  },
  {
    ...
    options: [
      ...
      "Just pass/fail.",
      "Whatever the inspector chooses to record.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Choose whether to act based on cost.",
      ...
      "Wait until the next 5-year inspection.",
      "Decide whether to act based on tenant complaints.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Downgrade the C2 to a C3 to keep the customer happy.",
      ...
      "Apologise and remove the finding.",
      "Threaten the customer with HSE.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "The schedule provider's default.",
  ...
  },
  {
    ...
    options: [
      ...
      "Email the report only.",
      "Charge extra for the briefing.",
    ],
    correctAnswer: 1,
    explanation:
