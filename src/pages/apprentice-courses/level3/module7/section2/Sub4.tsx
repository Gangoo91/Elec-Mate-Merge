...
const quizQuestions = [
  ...
  },
  {
    id: 6,
    question:
      "What's the role of an Electrical Technician in healthcare estates (NHS / private hospitals)?",
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Control & instrumentation, marine & offshore, rail (PTS), fire alarm (BAFE SP203),
          CCTV/security (NSI/SSAIB), data cabling — the specialist routes that pay above standard
          rates.
        </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Offshore (oil &amp; gas, wind), CompEx hazardous areas, rail PTS-required. Day rates
                &pound;400-800+. Lifestyle demanding.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                C&amp;I (control &amp; instrumentation), healthcare estate, marine. Often permanent
                employment with strong pension; pay above standard install.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
        ...
        >
          <p>CompEx course content highlights:</p>
        ...
        >
          <p>Typical fire alarm installer pathway:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          <p>Rail electrical specialism typical entry:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Intruder alarms, CCTV, access control. NSI Gold or SSAIB registration for
                police-response systems. Steady commercial and high-net-worth domestic market.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                NHS or private-hospital electrical maintenance. HTM 06-01/06-02 standards. NHS
                Agenda for Change Band 5-7 (&pound;28-45k). Stable hours plus rota for on-call.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                PLC programming, SCADA, instrumentation calibration. Process industries (food,
                pharma, water). Often Approved + HNC + manufacturer-specific training (Siemens,
                Rockwell).
              </p>
            </div>
          </div>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The Order places duties on the Responsible Person (typically the building owner or
                employer) to:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>Carry out and maintain a fire risk assessment.</li>
                <li>
                  Identify the general fire precautions necessary to safeguard the safety of
                  relevant persons.
                </li>
                <li>
                  Ensure fire detection and alarm systems are appropriate, properly installed,
                  maintained and tested.
                </li>
                <li>Use competent persons for fire safety work.</li>
              </ul>
            </>
          }
          meaning={
            <>
              The Order is the regulatory anchor for the BAFE SP203-1 scheme&apos;s commercial
              value. Responsible Persons in non-domestic premises increasingly use BAFE registration
              as the practical evidence that they used a &quot;competent person&quot; for fire alarm
              installation and maintenance. As an electrician moving into fire alarm work the Order
              is the legal context that makes BAFE registration commercially valuable.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                UKEX (and the EU ATEX equivalent) sets the regulatory framework for equipment placed
                on the market for use in potentially explosive atmospheres:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>Equipment categorisation by intended use (mining, surface industry).</li>
                <li>Equipment Group I (mining) and Group II (other industries).</li>
                <li>
                  Equipment marked with the Ex hexagon and category, manufacturer declaration of
                  conformity.
                </li>
                <li>
                  Installation must maintain the Ex protection across the equipment boundary &mdash;
                  cable glanding, sealing, barrier maintenance.
                </li>
              </ul>
            </>
          }
          meaning={
            <>
              UKEX/ATEX is the regulatory context that makes CompEx-trained competence commercially
              valuable. Hazardous-area sites cannot use uncertified installers because the Ex
              protection must be maintained through the install. CompEx is the route to the
              technical competence that lets you legally and safely work on Ex-rated equipment.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The Network Rail Rule Book sets the operating and safety rules for trackside work on
                the UK rail network. Headline rules include:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                ...
                <li>
                  Track access must be planned, authorised and protected (typically via a PICOP/COSS
                  — Person in Charge of Possession / Controller of Site Safety).
                </li>
                <li>Sighting and warning arrangements when working on open lines.</li>
                <li>
                  Specific safe-working rules for OLE (Overhead Line Equipment), signalling and
          ...
          meaning={
            <>
              The Rule Book governs every aspect of trackside work. PTS is the entry competence that
              lets you understand and follow the Rule Book. Without PTS you simply cannot be
              admitted to operational rail sites. For an electrician moving into rail work PTS is
              the unavoidable first step &mdash; followed by discipline-specific training
              (signalling, OLE).
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Electrician spends &pound;3,000+ on CompEx, HUET, BOSIET certifications aiming for
              offshore work. Lands first offshore rotation. Discovers two weeks away from family is
              harder than imagined; the helicopter ride is genuinely unpleasant; the platform
              schedule is exhausting. After three rotations decides offshore isn&apos;t for them.
              Specialist training cost is sunk; returns to onshore work having gained no day-rate
              uplift.
            </>
          }
          doInstead={
            <>
              Before investing in offshore-specific certifications, do a single offshore day visit
              (sometimes available through main contractors as taster days) or talk to current
              offshore electricians about the lifestyle reality. Helicopter anxiety,
              time-away-from-family, platform routine all matter. CompEx itself transfers to onshore
              petrochemical work so isn&apos;t wasted; HUET / BOSIET are offshore-specific. Be
              honest about the lifestyle before investing.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re 2 years post-AM2, JIB Electrician on standard installation work. You want
              to specialise to escape generic price-pressured domestic install work. Two options on
              the table: (a) fire alarm via BAFE SP203-1 + FIA training (your firm is considering
              BAFE registration and would back you), or (b) PV via AM2S and self-funded MCS PV
              (you&apos;d need to leave current firm or set up sole trader). Which makes more sense?
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; assess employer alignment</strong>. Fire alarm has strong
              employer alignment &mdash; firm wants BAFE, will fund training, you&apos;ll be doing
              the work in your existing role. PV requires you to change firm or set up alone &mdash;
              bigger career disruption.
              <br />
              <br />
              <strong>Step 2 &mdash; assess market</strong>. Fire alarm is steady commercial work
              with insurance-driven demand. PV is grant-driven domestic work with strong but more
              cyclical demand. Both are sustainable; different demand profiles.
              <br />
              <br />
              <strong>Step 3 &mdash; assess lifestyle</strong>. Fire alarm work is typically
              business-hours commercial premises. PV install work is rooftop work (working at
              height, weather-dependent, summer-heavy). Different physical demands.
              <br />
              <br />
              <strong>Step 4 &mdash; assess investment vs payback</strong>. Fire alarm: FIA training
              cost largely employer-funded; faster payback through firm work. PV: self-funded AM2S +
              MCS firm setup &pound;3,000+; slower payback but self-employment optionality.
              <br />
              <br />
              <strong>Step 5 &mdash; pick deliberately</strong>. Both are legitimate paths. Fire
              alarm with employer support is the lower-risk, faster-payback option. PV is the
              higher-risk, higher-eventual-autonomy option. Pick deliberately based on your career
              direction (employed senior tech vs self-employed business owner) rather than tossing a
              coin.
            </>
          }
          whyItMatters={
            <>
              Specialisation is the single most reliable strategy for moving above the standard
              installation electrician rate. But specialisations are not interchangeable &mdash;
              each has its own market dynamics, lifestyle profile and career arc. Pick one that
              matches your circumstances. Doing both eventually is fine; doing neither is the real
              risk.
            </>
          }
        />
        ...
        >
          <p>CompEx qualification stack and use cases:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ex01-04 foundation</strong> &mdash; gas/vapour atmospheres install &amp;
              inspection (~&pound;1,800&ndash;2,400).
            </li>
            <li>
            ...
            <li>
              <strong>Day rates</strong> &mdash; &pound;350&ndash;450 inland, &pound;450&ndash;700+
              offshore.
            </li>
            <li>
              <strong>Sectors</strong> &mdash; petrochem, oil &amp; gas, pharma, paint,
              distilleries, mines.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Rail electrical work qualification stack:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PTS (Personal Track Safety)</strong> &mdash; Network Rail mandatory, 1-day
              course + medical.
            </li>
            <li>
              <strong>D&amp;A medical</strong> &mdash; drug &amp; alcohol screening at point of
              qualification.
            </li>
            <li>
              <strong>OLE (Overhead Line)</strong> &mdash; AC traction add-on, specialist HV
              training.
            </li>
            <li>
            ...
            <li>
              <strong>Day rates</strong> &mdash; &pound;320&ndash;450 standard,
              &pound;500&ndash;750+ on night possessions.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Fire detection qualification path:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>FIA Unit 1</strong> &mdash; Foundation Fire Alarm Designer, Installer,
              Commissioner, Maintainer.
            </li>
            <li>
            ...
            <li>
              <strong>BAFE SP203-1</strong> &mdash; firm-level scheme registration (third-party
              certified).
            </li>
            <li>
              <strong>Day rates</strong> &mdash; &pound;280&ndash;500 install/commissioning,
              &pound;400&ndash;650 senior service.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Data cabling certification ladder:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>BICSI RCDD</strong> &mdash; design qualification (Registered Communications
            ...
            <li>
              <strong>Day rates</strong> &mdash; &pound;200&ndash;500 depending on level and
              specialism.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>BMS career qualification path:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Trend Controls L2/L3</strong> &mdash; UK-strong vendor, IQ4 platform.
            </li>
            <li>
              <strong>Tridium Niagara N4</strong> &mdash; open-platform, increasingly dominant on
              new builds.
            </li>
            <li>
            ...
            <li>
              <strong>Day rates</strong> &mdash; &pound;320&ndash;700+ depending on vendor and
              project complexity.
            </li>
            <li>
              <strong>Employed salary</strong> &mdash; &pound;38&ndash;58k mid-level,
              &pound;58&ndash;95k senior controls.
            </li>
          </ul>
        </ConceptBlock>
