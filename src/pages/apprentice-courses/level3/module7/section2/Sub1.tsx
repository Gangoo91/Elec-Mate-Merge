...
const checks = [
  {
    ...
    question: 'What does the 2391-52 cover and why is it important for career progression?',
    options: [
  ...
  },
  {
    ...
    question: "What's the difference between 2394 and 2395?",
    options: [
  ...
  },
  {
    ...
    question: 'What does the 2396 cover?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The post-AM2 I&T qualification ladder — 2391-52, 2394, 2395, 2396 — what each unlocks,
          costs, study time, and why I&T qualifications are the highest-leverage CPD spend after
          AM2.
        </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                ...
                qualification. 5-10 days, &pound;1,200-1,800. Unlocks Approved Electrician grade and
                CPS QS authority.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Standalone Initial Verification (2394) and Periodic Inspection (2395). Useful for
                staged learning or single-focus roles. Same content split into two qualifications.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Design and Verification. Cable sizing, protection coordination, fault levels, BS
                7671 design compliance. 8-12 days, &pound;1,500-2,500. Bridge to design office and
                Technician JIB grade.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                BS 7671 18th Edition Wiring Regulations qualification &mdash; knowledge exam (no
                practical). Most electricians hold this from apprenticeship. Typically updated each
                major BS 7671 amendment.
              </p>
            </div>
          </div>
        </ConceptBlock>
        ...
        >
          <p>2391-52 syllabus headlines:</p>
        ...
        >
          <p>The practical assessment mirrors real-world testing &mdash; assessor wants to see:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                BS 7671 Part 6 sets out the requirements for inspection and testing of electrical
                installations:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                  Initial verification (Chapter 64) &mdash; new installations and additions
                  /alterations must be verified before being put into service. The verifier must be
                  competent, the test sequence must be carried out, and an EIC must be issued.
                </li>
                <li>
                  Periodic inspection and testing (Chapter 65) &mdash; existing installations must
                  be inspected periodically (intervals depending on type, condition and use). The
                  inspector must be competent and an EICR must be issued.
                </li>
                <li>
                  Certification and reporting (Chapter 64.1) &mdash; the prescribed certificates and
                  reports must be completed accurately and signed by competent persons.
                </li>
              </ul>
            </>
          }
          meaning={
            <>
              BS 7671 Part 6 establishes the regulatory framework that 2391-52 (and 2394 / 2395)
              academically prepare you for. Holding the qualification doesn&apos;t make you
              competent on its own &mdash; the regs require &quot;competence&quot;, which combines
              qualifications, training and experience. 2391-52 is the academic anchor; site
              experience under a competent supervisor is the practical anchor. Both together =
              competence.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              EAWR Regulation 16 is the statutory competence requirement that sits behind BS 7671
              Chapters 64 and 65. It applies to all electrical work, not just inspection and
              testing. Holding 2391-52 is one of the practical ways to evidence the technical
              knowledge required for inspection and testing work under EAWR. Competent-person scheme
              registration also depends on demonstrable competence including 2391-52 (or equivalent)
              for the QS.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Funding 2391-52 is part of the employer&apos;s s.2(2)(c) training duty, particularly
              when moving you toward inspection and testing work. Most JIB- graded employers fund
              the qualification at least in part as part of CPD investment. If the employer refuses
              to fund and you&apos;re moving into I&amp;T work as part of your role, that&apos;s a
              HASAWA point worth raising.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Newly-qualified electrician finishes apprenticeship, focuses on consolidating site
              experience. Always means to do 2391-52 &quot;next year&quot;. Year 1 becomes year 3
              becomes year 5. Each year the study habit gets harder to rebuild; each year the JIB
              Approved grade and the QS roles stay out of reach; each year the pay differential
              against peers who did the qualification widens. Eventually starts the course at year 6
              with rusty study habits and a much steeper climb.
            </>
          }
          doInstead={
            <>
              Calendar 2391-52 in the 12-18 month window after AM2 and stick to it. Talk to your
              employer about funding. If they&apos;ll fund, accept the training agreement
              (commitment to stay X months post-qualification). If they won&apos;t, self-fund and
              offset against tax. Don&apos;t let perfect become the enemy of good &mdash; the
              qualification is achievable for any post-AM2 electrician with disciplined preparation.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You finished AM2 18 months ago. You&apos;re thinking about CPD and have two options:
              (a) start 2391-52 now (5-10 day course, &pound;1,500), or (b) start an HNC in
              Electrical Engineering (2-year part-time, &pound;3,000-5,000). Your employer would
              part-fund either. You can&apos;t do both at once. Which makes more sense?
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; clarify your career direction</strong>. 2391-52 leads to
              Approved Electrician, QS roles and EICR contract work. HNC leads to Technician grade,
              design office and engineering routes. They&apos;re different destinations.
              <br />
              <br />
              <strong>Step 2 &mdash; check the cost-time-benefit ratio</strong>. 2391-52 is the
              higher leverage, faster payback. 5-10 days study, &pound;1,500, immediate
              Approved-grade pay rise (&pound;2-3/hr), QS role potential, business-setup option. HNC
              is longer payback &mdash; 2 years study, larger cost, larger eventual outcome but
              takes longer to materialise.
              <br />
              <br />
              <strong>Step 3 &mdash; consider the realistic sequence</strong>. Most electricians do
              2391-52 first because it&apos;s shorter, cheaper and immediately applicable. HNC
              builds on top &mdash; the design content in HNC assumes the testing competence from
              2391-52. Doing them in the other order is possible but harder.
              <br />
              <br />
              <strong>Step 4 &mdash; think about life balance</strong>. 2391-52 is a short,
              intensive commitment (or part-time over a few months). HNC is 2 years of evening or
              day-release study. Different demands on your time and your relationships. Pick the one
              you can actually finish.
              <br />
              <br />
              <strong>Step 5 &mdash; commit and book</strong>. The risk is doing neither. Pick one,
              book it, get the date in the diary. You can always add the other later. Most
              successful career trajectories include both eventually.
            </>
          }
          whyItMatters={
            <>
              CPD planning is the difference between drift and direction. Most newly-qualified
              electricians who never do 2391-52 are still on Electrician rate ten years later, doing
              the same install work. Those who invested in 2391-52 in the 18-month window are
              typically Approved Electricians, sometimes running their own firm or in a senior
              testing/QS role, on materially higher pay. The choice is yours; the trajectory
              follows.
            </>
          }
        />
        ...
        >
          <p>EICR pricing benchmarks (2024 UK indicative ranges):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>HMO (House in Multiple Occupation)</strong> &mdash; &pound;300&ndash;500 (more
              circuits, more rooms).
            </li>
            <li>
            ...
            <li>
              <strong>Medium commercial (10&ndash;30 circuits)</strong> &mdash;
              &pound;1,200&ndash;2,500.
            </li>
            <li>
        ...
        >
          <p>I&amp;T qualification stack at a glance:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2391-50</strong> &mdash; Initial Verification only (current short version).
            </li>
            <li>
              <strong>2391-51</strong> &mdash; Periodic Inspection &amp; Testing only (current short
              version).
            </li>
            <li>
              <strong>2391-52</strong> &mdash; Combined Initial + Periodic, the dominant post-AM2
              choice.
            </li>
            <li>
        ...
        >
          <p>Where EICR demand comes from:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PRS rental sector</strong> &mdash; mandatory 5-yearly under Electrical Safety
            ...
            <li>
              <strong>Change of use / refurbishment</strong> &mdash; before commercial fit-out
              works.
            </li>
            <li>
            ...
            <li>
              <strong>Supplementary EICR</strong> &mdash; after fault repairs to evidence
              remediation.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>QS responsibilities under a CPS scheme:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sign compliance certificates</strong> &mdash; EIC, Minor Works, EICR for the
              firm's customers.
            </li>
            <li>
              <strong>Annual scheme assessment</strong> &mdash; the QS faces the scheme's assessor
              for the firm.
            </li>
            <li>
              <strong>Calibration of the firm's standards</strong> — reviewing junior staff's work,
              second-checking certificates.
            </li>
            <li>
              <strong>Test equipment register</strong> &mdash; ensuring kit is calibrated and
              traceable.
            </li>
            <li>
              <strong>Continuing professional development</strong> &mdash; the QS must stay current
              on BS 7671 amendments.
            </li>
          </ul>
        </ConceptBlock>
