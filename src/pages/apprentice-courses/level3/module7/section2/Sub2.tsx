...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 2 · Subsection 2"
        title="MCS standalone certifications"
        backTo="/study-centre/apprentice/level3-module7-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Microgeneration Certification Scheme (MCS) — PV, Heat Pump, Solar Thermal, Battery Storage
          — qualifications, registration process, and the economic case for adding renewables to
          your portfolio.
        </p>
        ...
        >
          <p>UK Government grant schemes that require MCS-registered installation:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BUS (Boiler Upgrade Scheme)</strong> &mdash; &pound;7,500 per heat pump
              install. Administered by Ofgem.
            </li>
            <li>
              <strong>SEG (Smart Export Guarantee)</strong> &mdash; supplier payment for PV export
              to grid. Regulated by Ofgem.
            </li>
            <li>
              <strong>ECO4 (Energy Company Obligation 4)</strong> &mdash; large suppliers fund
              energy efficiency improvements including PV and heat pumps for fuel-poor households.
            </li>
            <li>
              <strong>Home Upgrade Grant (HUG)</strong> &mdash; localised energy efficiency grants
        ...
        >
          <p>The heat pump route in steps:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Hold JIB Electrician grade (post-AM2).</li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <p className="mt-2">
                MIS 3002 covers PV; MIS 3005 covers heat pumps; MIS 3001 covers solar thermal; MIS
                3012 covers battery storage.
              </p>
            </>
          }
          meaning={
            <>
              ...
              download from mcscertified.com. Read the relevant MIS standard before your MCS
              application audit; assessors expect installers to know the standard they&apos;re
              registering against. The standards are revised periodically as technology and best
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The F-Gas Regulation (EU 517/2014, retained in UK law) requires that anyone carrying
                out installation, servicing, maintenance, repair or decommissioning of stationary
                refrigeration, air-conditioning or heat pump equipment containing fluorinated gases
                must hold the relevant F-Gas certification. Categories (Cat 1-4) reflect the type of
                work and refrigerant charge size.
              </p>
              <p>
                Heat pump installation typically requires Cat 1 (full installation and recovery of
                refrigerant) or Cat 2 (limited installation work).
              </p>
            </>
          }
          meaning={
            <>
              F-Gas certification is a legal requirement for refrigerant work, not optional. Without
              F-Gas certification an electrician cannot work on the refrigerant circuit of a heat
              pump &mdash; even though the rest of the install is electrical and water-system work.
              Most heat pump installer firms have at least one F-Gas Cat 1-certified person; some
              pair an electrical lead with a refrigeration-trained partner.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                  Pre-contract information &mdash; clear quotation, system performance estimates,
                  finance options, warranties.
                </li>
                <li>
                  Deposit protection &mdash; consumer deposits protected by insurance or third-party
                  escrow.
                </li>
                <li>
                  Cooling-off period &mdash; 14 days under the Consumer Contracts Regulations 2013.
                </li>
                <li>Workmanship warranty &mdash; minimum 2-year warranty on installation.</li>
                <li>
                  Complaint handling &mdash; defined process with ADR escalation if unresolved.
                </li>
              </ul>
            </>
          }
          meaning={
            <>
              MCS-registered installers must also be members of one of the consumer codes (RECC for
              renewables, HIES for wider energy efficiency). This adds the consumer-protection layer
              alongside the technical MCS quality layer. As an apprentice or sole trader entering
              MCS work, plan for both layers simultaneously &mdash; MCS application typically
              requires evidence of consumer-code membership.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              registration. Assumes the training course covered everything they need to know.
              Doesn&apos;t read MIS 3002. MCS audit visit on a recent install &mdash; auditor finds
              design calculations don&apos;t evidence string voltage limits under cold conditions,
              doesn&apos;t evidence shading analysis, doesn&apos;t evidence structural load
              assessment to the MIS requirements. Registration deferred pending remediation. Several
              weeks of lost trading until reaudit.
            </>
          }
          doInstead={
            <>
              Read MIS 3002 (or the relevant MIS standard for your technology) cover-to- cover
              before sitting AM2S and before applying for MCS registration. The training course
              covers the basics; the MIS standard is the test of competence the auditor applies.
              Free download. A weekend of reading saves weeks of remediation.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;ve been a sole-trader Approved Electrician for 3 years doing domestic
              electrical work. Customers increasingly ask about PV. You quote £6,000 PV installs
              through a partner MCS firm and earn a £600 introduction fee per job. You&apos;re
              considering becoming MCS-registered yourself to capture the full margin. First-year
              MCS investment is around £3,000 (training + registration + extra insurance). Is it
              worth it?
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; estimate realistic PV volume</strong>. How many PV jobs would
              you realistically do in year 1 if you were MCS-registered? 6 jobs/year at &pound;6,000
              each = &pound;36,000 revenue. Materials maybe 60%, so gross margin around
              &pound;14,000. Compared to current &pound;3,600 in introduction fees (6 &times;
              &pound;600), the uplift is around &pound;10,000 &mdash; covers the &pound;3,000 setup
              cost three times over in year 1.
              <br />
              <br />
              <strong>Step 2 &mdash; assess your time capacity</strong>. PV installs take 1-3 days
              each (single-storey roof on a sunny day = 1 day; complex multi- pitch roof = 3 days).
              6 jobs at avg 1.5 days = 9 days/year. Manageable alongside existing electrical work.
              <br />
              <br />
              <strong>Step 3 &mdash; assess seasonality and pipeline</strong>. PV demand spikes
              spring and summer. Heat pump demand spikes autumn and winter. Some installers add both
              for year-round flow; pure-PV firms have a quieter winter.
              <br />
              <br />
              <strong>Step 4 &mdash; check your insurance</strong>. PI insurance for design
              liability, PL extension to cover PV-specific risks (working at height, roof-mounted
              equipment, DC system fault current), tools-in-transit. Get quotes before committing.
              <br />
              <br />
              <strong>Step 5 &mdash; commit and set a 12-month review date</strong>. The economics
              look strong for a busy sole trader. Commit, register, set a 12-month review date to
              assess actual revenue vs forecast. If volume is disappointing you can always defocus
              PV; if it&apos;s strong you can scale up.
            </>
          }
          whyItMatters={
            <>
              MCS PV is one of the strongest single business-development moves a domestic- focused
              electrician can make. The capex is modest, the per-install revenue is substantial, the
              demand is sustained by Government grant policy, and the technical content is
              accessible to any AM2-qualified electrician. Many successful sole-trader electrical
              firms have grown through adding MCS PV in year 3-5 of trading.
            </>
          }
        />
        ...
        >
          <p>UK renewable grant streams (2024-25 indicative):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BUS (Boiler Upgrade Scheme)</strong> &mdash; &pound;7,500 per air-source heat
              pump (England, Wales).
            </li>
            <li>
              <strong>SEG (Smart Export Guarantee)</strong> &mdash; 5&ndash;15p/kWh paid to
              homeowners for exported PV.
            </li>
            <li>
              <strong>ECO4</strong> &mdash; obligated supplier scheme for fuel-poverty households;
              runs to 2026.
            </li>
            <li>
              <strong>HUG2 (Home Upgrade Grant)</strong> &mdash; LA-administered whole-home retrofit
              funding.
            </li>
            <li>
              <strong>OZEV EVHS / Workplace</strong> &mdash; up to &pound;350 per EV charger for
              landlords / SMEs.
            </li>
            <li>
        ...
        >
          <p>MCS cost model per stream:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Year 1 setup</strong> &mdash; ~&pound;1,000&ndash;1,500 (application + first
              audit + first annual sub).
            </li>
            <li>
            ...
            <li>
              <strong>Technology qualification</strong> &mdash; ~&pound;700&ndash;1,500 per stream
              (BPEC PV, BPEC EV, LCL HP, etc).
            </li>
            <li>
              <strong>Sample install audit</strong> &mdash; ~1&ndash;2 installs/year inspected by
              assessor.
            </li>
            <li>
              <strong>Break-even</strong> &mdash; ~7&ndash;8 installs in year 1, ~3&ndash;4/year
              thereafter.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>MCS stream-stack economics (per converted enquiry):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PV only</strong> &mdash; ~&pound;6,500&ndash;8,500 install, ~15&ndash;20%
              gross margin.
            </li>
            <li>
            ...
            <li>
              <strong>Whole-home (PV + Battery + EV + HP)</strong> &mdash; ~&pound;25&ndash;35k
              combined.
            </li>
            <li>
              <strong>Cross-sell rate</strong> &mdash; PV-to-Battery typically 30&ndash;50%;
              PV-to-EV 20&ndash;35% (after grants stripped).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common MCS audit failure patterns and prevention:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Missing handover documentation</strong> &mdash; system manual, commissioning
              certs, customer education record.
            </li>
            <li>
              <strong>Performance shortfall</strong> &mdash; PV system output below design estimate;
              HP COP below MIS minimum.
            </li>
            <li>
              <strong>Calibration lapse</strong> &mdash; test instruments out of calibration cycle.
            </li>
            <li>
              <strong>Certificate template errors</strong> &mdash; wrong scheme logo, missing test
              results, mis-completed pages.
            </li>
            <li>
              <strong>Unresolved complaints</strong> &mdash; customer issues not closed out within
              scheme timeframe.
            </li>
            <li>
              <strong>CPD shortfall</strong> &mdash; QS or Designate Operative without current
              technology updates.
            </li>
          </ul>
        </ConceptBlock>
