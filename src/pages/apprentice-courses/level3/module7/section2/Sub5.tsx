...
const quizQuestions = [
  ...
  },
  {
    id: 7,
    question:
      "What's the role of a senior electrician acting as an apprenticeship Workplace Mentor?",
    options: [
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 2 · Subsection 5"
        title="Teaching / assessing route"
        backTo="/study-centre/apprentice/level3-module7-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          TAQA L3, IQA L4, FE teaching qualifications, college lecturer / assessor / IQA roles, EPAO
          assessor work — how senior electricians move into teaching and assessing apprentices.
        </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Day-job mentor for an apprentice. JIB Approved + experience. Unpaid / informally
                paid through normal employment. No specific qualification.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Paid assessor for college / training provider / EPAO. Visits workplace, signs
                portfolio. Sessional or hourly pay (&pound;25-40/hr typical).
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Internal quality assurance &mdash; samples and second-marks assessor work. Senior
                progression beyond TAQA. Better hourly rates and more flexible.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                FE college lecturer delivering classroom teaching. DET (Level 5 Diploma in Education
                and Training) typically required. Salary &pound;28-45k typical.
              </p>
            </div>
          </div>
        </ConceptBlock>
        ...
        >
          <p>Typical EPAO assessor entry path:</p>
        ...
        >
          <p>FE teaching qualification ladder:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>L3 Award in Education and Training</strong> &mdash; introductory. Typically
              2-3 day course; suitable for occasional sessional teaching.
            </li>
            <li>
            ...
            <li>
              <strong>L5 Diploma in Education and Training (DET)</strong> &mdash; full lecturer
              qualification. 1-2 years part-time. Required for permanent lecturer roles.
            </li>
            <li>
              <strong>PGCE / Cert Ed</strong> &mdash; equivalent academic teaching qualifications,
              typically university-delivered.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                  Apprentices to be registered against a recognised English standard (or framework
                  in older arrangements).
                </li>
                <li>
                  Off-the-job training delivered through a recognised training provider (typically
                  an FE college or independent training provider).
                </li>
                <li>
                  End-Point Assessment delivered by an independent EPAO (separate from the training
                  provider) at the end of the apprenticeship.
                </li>
                <li>
                  All assessment carried out by qualified assessors (TAQA L3 or equivalent) under
                  appropriate IQA arrangements.
                </li>
              </ul>
            </>
          }
          meaning={
            <>
              The Act establishes the formal infrastructure that makes assessor and lecturer roles
              meaningful careers. Every apprentice in England is going through this infrastructure;
              assessors and lecturers are the people who staff it. Demand is structurally permanent
              because the apprenticeship system depends on it.
            </>
          }
          ...
          clause={
            <>
              <p className="mb-2">
                ...
                characteristics (age, disability, gender reassignment, race, religion or belief,
                sex, sexual orientation, marriage and civil partnership, pregnancy and maternity) in
                education provision and assessment.
              </p>
            </>
          }
          meaning={
            <>
              As a college lecturer or assessor you have a duty to apply the Act in your teaching
              and assessment practice &mdash; reasonable adjustments for disabled learners, equal
              treatment regardless of protected characteristics, inclusive content. FE teacher
              training (DET) covers the Act in detail; assessor training (TAQA) covers it more
              briefly. Treat the Act seriously &mdash; discrimination claims by learners can damage
              your career and the college&apos;s.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The ETF Professional Standards for Teachers and Trainers in Education and Training
                set the expected standards of practice:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
          ...
          meaning={
            <>
              The ETF Professional Standards are the practitioner-level competence standards for FE
              teaching. DET training assesses against them; full lecturer appointments expect
              ongoing CPD against them. As a working electrician moving into FE you bring strong
              subject specialism but typically need to develop the pedagogy and the wider
              professional values &mdash; that&apos;s what DET covers.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Senior electrician approaches local college about lecturing. College welcomes the
              industry experience but explains that permanent lecturer roles require DET (L5 Diploma
              in Education and Training). Electrician dismisses this as bureaucracy and focuses only
              on sessional opportunities. Five years later they&apos;re still on sessional pay rates
              with no progression because they never converted to DET. Permanent lecturer salary,
              holidays and pension stay out of reach.
            </>
          }
          doInstead={
            <>
              Treat DET as a strategic CPD investment if you&apos;re serious about a lecturer
              career. 1-2 years part-time alongside sessional teaching. Many colleges fund the
              conversion in return for service commitment. The pay and conditions uplift from
              sessional to permanent lecturer is significant (sessional &pound;30-50/hr no benefits
              → permanent salaried &pound;28-45k with pension and holidays). Worth the investment.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re 45, JIB Approved Electrician with 25 years of experience (apprenticeship
              from 16, AM2 at 20, Approved at 25). The site work is getting physically harder. Your
              knees are protesting. Your local college has advertised for sessional electrical
              lecturers. You&apos;ve never taught but you&apos;ve mentored several apprentices over
              the years. Should you make the transition?
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; trial the territory</strong>. Approach the college about
              sessional teaching first. Don&apos;t commit to full transition. You&apos;ll discover
              within 6 months whether you enjoy teaching and whether you can hold an evening
              class&apos;s attention.
              <br />
              <br />
              <strong>Step 2 &mdash; do TAQA L3 first</strong>. Lower commitment than DET, useful
              for assessor work even if teaching doesn&apos;t fit. &pound;600-1,200 investment, 5-10
              days, opens paid assessor work. If teaching also fits, build on it; if not, you have
              an assessor career.
              <br />
              <br />
              <strong>Step 3 &mdash; check the financial transition realistically</strong>.
              Skilled-trade earnings at 25-years experience are typically &pound;45-55k (full-time
              JIB Approved). Sessional teaching at 4-8 hours/week supplements this; full-time
              lecturing replaces about 60-70% of skilled-trade earnings with college terms and
              conditions. Plan the transition over 2-3 years rather than overnight.
              <br />
              <br />
              <strong>Step 4 &mdash; budget for DET if you commit</strong>. If trial works and you
              want full transition, plan DET conversion (1-2 years part-time). Many colleges fund it
              in return for service commitment. Worth confirming arrangement before starting.
              <br />
              <br />
              <strong>Step 5 &mdash; keep the trade hand in</strong>. Many lecturers continue some
              trade work (limited domestic sole-trader work, weekend installs) to keep skills
              current and maintain industry credibility. Your students benefit from up-to-date
              knowledge; your bank balance benefits from supplementary income.
            </>
          }
          whyItMatters={
            <>
              The mid-career transition from skilled trade to teaching is a meaningful and
              well-trodden path. The pay differential is real but the lifestyle (term-time hours,
              holidays, pension, no more knees on hard floors) often makes the trade worthwhile. The
              college recruitment market is consistently warm for experienced electricians. Plan the
              transition deliberately rather than drifting; trial sessional teaching before
              committing to DET.
            </>
          }
        />
        ...
        >
          <p>TAQA / IQA qualification stack:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>TAQA L3 Award</strong> &mdash; assess vocationally related achievement
              (entry-level).
            </li>
            <li>
              <strong>TAQA L3 Certificate</strong> &mdash; assessing multi-method (workplace +
              simulated).
            </li>
            <li>
            ...
            <li>
              <strong>Day rates (assessment)</strong> &mdash; &pound;150&ndash;220/day part-time,
              salaried ~&pound;28&ndash;38k full-time.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>FE teaching qualification routes:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PTLLS / Award in Education and Training</strong> &mdash; sessional teaching
              entry, ~&pound;400, 1&ndash;2 weeks.
            </li>
            <li>
              <strong>CTLLS / Certificate in Education and Training</strong> &mdash; part-time
              teaching role, ~&pound;1,200, 4&ndash;6 months.
            </li>
            <li>
              <strong>DET / Diploma in Education and Training</strong> &mdash; full FE lecturer
              role, ~&pound;3&ndash;4k, 2yr part-time.
            </li>
            <li>
              <strong>PGCE</strong> &mdash; graduate route, 1yr full or 2yr part-time.
            </li>
            <li>
              <strong>QTLS via SET</strong> &mdash; final professional status, recognised as
              QTS-equivalent.
            </li>
            <li>
              <strong>Salary band</strong> &mdash; &pound;30&ndash;85k depending on role and
              seniority.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Vetting</strong> &mdash; occupational competence verification, assessment
              trial.
            </li>
            <li>
            ...
            <li>
              <strong>Lifestyle</strong> &mdash; flexible, fits alongside main role, contributes to
              CPD.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Routes into FE college teaching:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sessional / hourly paid</strong> &mdash; trial teaching,
              ~&pound;25&ndash;40/hr, no DET required initially.
            </li>
            <li>
              <strong>Part-time technician / instructor</strong> &mdash; 0.4&ndash;0.6 FTE, often
              blended with industry work.
            </li>
            <li>
              <strong>Fractional lecturer + DET in progress</strong> &mdash; college funds DET in
              exchange for retention.
            </li>
            <li>
              <strong>Full lecturer (post-DET)</strong> &mdash; 1.0 FTE, full QTLS-band salary.
            </li>
            <li>
              <strong>Course Leader / Curriculum Manager</strong> &mdash; senior FE roles,
              &pound;55&ndash;85k.
            </li>
            <li>
              <strong>Independent training provider</strong> &mdash; alternative employer to FE
              colleges.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Total compensation comparison checklist:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Headline salary</strong> &mdash; obvious but only ~60% of total compensation.
            </li>
            <li>
              <strong>Pension contribution</strong> &mdash; TPS ~28% employer + ~9% employee = ~37%
              total of pensionable salary.
            </li>
            <li>
              <strong>Holiday</strong> &mdash; 13 weeks paid term-time vs 5.6 weeks statutory + JIB
              top-up.
            </li>
            <li>
              <strong>Sick pay</strong> &mdash; full pay typically for 6 months, half pay for
              further 6 months.
            </li>
            <li>
            ...
            <li>
              <strong>Physical wear</strong> &mdash; indoor classroom vs sustained physical site
              work.
            </li>
            <li>
              <strong>Career horizon</strong> &mdash; teaching often runs longer (60s+) than
              physical site work.
            </li>
          </ul>
        </ConceptBlock>
