...
const TITLE =
  'Design route: 2382, DipBSE, EngTech / IEng / CEng | Level 3 Module 7.2.3 | Elec-Mate';
const DESCRIPTION =
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 2 · Subsection 3"
        title="Design route: 2382, DipBSE, EngTech / IEng / CEng"
        backTo="/study-centre/apprentice/level3-module7-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The academic and professional pathway from site electrician to design engineer — C&G 2382,
          IET DipBSE, HNC/HND/BEng, and Engineering Council registration (EngTech, IEng, CEng).
        </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                C&amp;G 2365-03 / NVQ Level 3 (apprenticeship anchor). C&amp;G 2382 (regs knowledge)
                typically held alongside.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                C&amp;G 2391-52 (Inspection &amp; Testing). C&amp;G 2396 (Design and Verification).
                Specialist endorsements (PV/EV/CompEx).
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                HNC (Level 4) Electrical Engineering. HND (Level 5) Electrical Engineering. IET
                DipBSE (Level 4) Building Services Engineering.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                BEng (Bachelor of Engineering, Level 6). MEng (Master of Engineering, Level 7). Open
                University, Coventry Uni and Northumbria Uni offer part-time / distance routes.
              </p>
            </div>
          </div>
        </ConceptBlock>
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Engineering Technician. Level 3 + 2-3 years experience + professional review.
                Accessible to JIB Approved Electricians. Annual fee &pound;30-50.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Incorporated Engineer. Bachelor&apos;s degree (BEng) or equivalent + competence
                evidence + professional review. Mid-career engineering registration. Annual fee
                &pound;150-200.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Chartered Engineer. Master&apos;s level (MEng) or equivalent + significant senior
                experience + professional review. Top tier UK engineering registration. Annual fee
                &pound;200-300.
              </p>
            </div>
          </div>
        ...
        >
          <p>The UK-SPEC competence areas:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>B &mdash; Design and development</strong>: applying knowledge to solve
              engineering problems.
            </li>
            <li>
              <strong>C &mdash; Responsibility, management and leadership</strong>: managing risk,
              resources and people.
            </li>
            <li>
              <strong>D &mdash; Communication and interpersonal skills</strong>: communicating
              effectively with technical and non-technical audiences.
            </li>
            <li>
              <strong>E &mdash; Professional commitment</strong>: ethical conduct, continuing
              professional development, accountability to society.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                UK-SPEC sets the professional competence standard for the three Engineering Council
                registration tiers. For each tier:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                  <strong>EngTech</strong> &mdash; competence at the engineering-technician level:
                  applying proven techniques and procedures, working under supervision on complex
                  tasks, working independently on routine work.
                </li>
                <li>
                  <strong>IEng</strong> &mdash; competence at the incorporated-engineer level:
                  applying established engineering principles, exercising independent technical
                  judgement, managing technical resources.
                </li>
                <li>
                  <strong>CEng</strong> &mdash; competence at the chartered-engineer level:
                  developing solutions to complex engineering problems using new or existing
                  technologies, leading technical and managerial work, exercising senior
          ...
          meaning={
            <>
              UK-SPEC is the framework against which your portfolio is assessed. Read it before
              applying &mdash; free download at engc.org.uk. Your portfolio of evidence (projects,
              decisions, leadership examples, CPD record) must map directly to UK-SPEC competences
              at the tier you&apos;re applying for. Most successful applications are well-organised
              against the UK-SPEC structure.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The Companies Act 2006 sets statutory duties on company directors, including:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                  s.174 &mdash; duty to exercise reasonable care, skill and diligence, including
                  specifically the care, skill and diligence that may reasonably be expected of a
                  director with the general knowledge, skill and experience that the director has.
                </li>
              </ul>
            </>
          }
          meaning={
            <>
              For an engineer-director (technical lead in an engineering firm) s.174 means the
              standard expected is informed by your professional registration and qualifications. A
              CEng director is held to a higher standard than an EngTech director on technical
              decisions because the registration evidences the competence. Professional registration
              is therefore both a credential and a responsibility.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                IET members and Engineering Council registrants are bound by professional codes of
                conduct including:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
          ...
          meaning={
            <>
              Professional registration carries professional obligations. The IET Code of Conduct
              (and the equivalent codes of other Engineering Council institutions) bind registrants
              to ethical standards and CPD. Failure to comply can lead to disciplinary action and
              ultimately removal from the register. Treat registration as ongoing commitment, not
              just a one-off credential.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              JIB Approved Electrician with 5 years post-AM2 experience and 2391-52, would qualify
              for EngTech but never applies because they assume Engineering Council registration is
              for graduates only. Hears CEng-bound colleagues talking about university degrees and
              concludes the whole register is closed to vocational-route practitioners. Misses out
              on a credential that&apos;s genuinely accessible and would meaningfully strengthen
              their CV and salary negotiation.
            </>
          }
          doInstead={
            <>
              Read the EngTech competence standard (UK-SPEC). Read the IET&apos;s EngTech
              application guidance. The Engineering Council and IET specifically promote EngTech as
              accessible to vocational-route practitioners. Get your portfolio organised, find an
              EngTech sponsor (often available through IET), and apply. Worst case &mdash; you
              don&apos;t qualify yet and get specific feedback on what to strengthen. Best case
              &mdash; you have an EngTech and a meaningful credential.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re 8 years post-AM2. Approved Electrician, hold 2391-52 and 2396, no academic
              qualifications above Level 3. You&apos;re moving into design-led work in an M&amp;E
              sub-contractor. You&apos;re considering: (a) apply for EngTech now, or (b) start an
              HNC part-time first to strengthen the academic anchor before applying. Both are valid.
              Which makes more sense?
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; check eligibility now</strong>. Read EngTech UK-SPEC. With
              Approved + 2391-52 + 2396 + 8 years experience you very likely meet the academic and
              competence anchor for EngTech without further qualifications. The portfolio of design
              projects you&apos;re building will provide the evidence.
              <br />
              <br />
              <strong>Step 2 &mdash; consider sequencing</strong>. EngTech now provides immediate
              credential and salary signal. HNC then strengthens the academic anchor for IEng later
              (typical pathway: EngTech in year 8-10, IEng in year 15-18 after HNC + further
              experience). Sequential is fine.
              <br />
              <br />
              <strong>Step 3 &mdash; talk to an IET regional ambassador</strong>. The IET has
              regional ambassadors who advise on professional registration pathways free of charge.
              They&apos;ll look at your CV and tell you whether you&apos;re EngTech-ready and what
              gaps to fill. Worth a 30-minute conversation.
              <br />
              <br />
              <strong>Step 4 &mdash; pick one and commit</strong>. The risk is doing neither because
              you can&apos;t decide. EngTech is a 20-40 hour preparation effort plus the application
              fee. HNC is 2 years part-time + £6,000-10,000. EngTech is the lower-cost
              faster-payback option to start with.
              <br />
              <br />
              <strong>Step 5 &mdash; plan the next move from there</strong>. EngTech in year 1; HNC
              starting year 2-3; IEng aim for year 7-8 after HNC complete. Sequential progression
              with credential at every stage.
            </>
          }
          whyItMatters={
            <>
              Engineering Council registration is one of the most under-used credentials in the UK
              electrical trade. Many Approved Electricians qualify for EngTech but never apply,
              missing out on a meaningful salary signal and professional credential. For
              engineering-direction careers registration is strategic CPD; for
              installation-direction careers it&apos;s less essential. Plan deliberately rather than
              drifting.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Cost</strong> &mdash; ~&pound;450&ndash;700 standard; ~&pound;200&ndash;350
              update version.
            </li>
            <li>
            ...
            <li>
              <strong>Use cases</strong> &mdash; design role gateway, 2391-52 prerequisite, scheme
              QS requirement.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>HNC / HND / BEng comparison for an electrician:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HNC</strong> &mdash; 1yr part-time, ~&pound;3&ndash;5k, opens Technician grade
              and EngTech.
            </li>
            <li>
            ...
            <li>
              <strong>BEng (full)</strong> &mdash; 3&ndash;4yr full-time, ~&pound;9&ndash;12k
              tuition, alternative to apprenticeship+top-up.
            </li>
            <li>
              <strong>Apprenticeship-funded HNC</strong> &mdash; some employers cover full HNC fees
              in exchange for retention period.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Engineering Council register summary:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EngTech</strong> &mdash; HNC + experience; competent technical practitioner.
            </li>
            <li>
              <strong>IEng</strong> &mdash; HND/BEng + design/supervisory experience; incorporated
              engineer.
            </li>
            <li>
              <strong>CEng</strong> &mdash; BEng + advanced practice + senior responsibility;
              chartered.
            </li>
            <li>
              <strong>Annual fee</strong> &mdash; ~&pound;200 EngTech, ~&pound;320 IEng, ~&pound;450
              CEng (2024).
            </li>
            <li>
              <strong>Application route</strong> &mdash; via IET (or another PEI), professional
              review interview.
            </li>
            <li>
              <strong>Use cases</strong> &mdash; design roles, M&amp;E Consultancy, public sector
              engineering, manufacturer specialists.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>DipBSE vs HNC for a design-route electrician:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HNC Electrical Engineering</strong> &mdash; broader theoretical,
              college-delivered, generic.
            </li>
            <li>
              <strong>IET DipBSE</strong> &mdash; building services specific, workplace-assessed,
              design portfolio output.
            </li>
            <li>
              <strong>HNC strength</strong> &mdash; widely recognised, opens Technician grade and
              EngTech.
            </li>
            <li>
              <strong>DipBSE strength</strong> &mdash; recognised by M&amp;E Consultants, aligns
              with IEng directly.
            </li>
            <li>
              <strong>Combination</strong> &mdash; some apprentices stack HNC then DipBSE for
              fastest IEng route.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>UK design role salary ladder (2024-25 indicative):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Junior Design Engineer</strong> &mdash; &pound;32&ndash;42k, post-HNC,
              1&ndash;2yr experience.
            </li>
            <li>
              <strong>Design Engineer</strong> &mdash; &pound;42&ndash;58k, 3&ndash;5yr, EngTech /
              IEng.
            </li>
            <li>
              <strong>Senior Design Engineer</strong> &mdash; &pound;58&ndash;78k, 5&ndash;10yr,
              IEng.
            </li>
            <li>
              <strong>Principal / Lead Design Engineer</strong> &mdash; &pound;78&ndash;110k, 10+yr,
              CEng.
            </li>
            <li>
              <strong>Design Director</strong> &mdash; &pound;100&ndash;160k+, 15+yr, CEng +
              management.
            </li>
            <li>
            ...
            <li>
              <strong>Specialist niches</strong> &mdash; +20&ndash;40% (data centres, healthcare,
              defence, pharma).
            </li>
          </ul>
        </ConceptBlock>
