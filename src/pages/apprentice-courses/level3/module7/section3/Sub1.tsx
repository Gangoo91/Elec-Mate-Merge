...
const checks = [
  ...
  {
    id: 'mod7-s3-sub1-ltd',
    question: "What's the practical difference between trading as a sole trader and a Ltd company?",
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Sole trader, partnership, Ltd company, LLP — what each means for tax (HMRC), registration
          (Companies House), liability, accounting and IR35. Choosing the right form for a small
          electrical firm.
        </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                You and the business are one. HMRC Self Assessment, no Companies House. Unlimited
                personal liability. Simplest setup; lightest admin; least tax- efficient at higher
                profits.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Two or more people trading together. Partnership Act 1890. Each partner unlimited
                liability for partnership debts. Each partner files own Self Assessment. Rare in
                modern trades.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Hybrid: limited liability + partnership taxation. Companies House registration
                required. Common in professional services; rare in trades.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Separate legal entity. Companies House + HMRC. Corporation Tax on profits. Limited
                liability for directors. Standard form for established UK electrical firms.
              </p>
            </div>
          </div>
        </ConceptBlock>
        ...
        >
          <p>Headline tax comparison for a typical small electrical firm:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sole trader at £30k profit</strong> &mdash; roughly &pound;3,500 income tax +
              &pound;2,000 Class 4 NI + &pound;180 Class 2 NI = ~&pound;5,700 deductions; net
              &pound;24,300.
            </li>
            <li>
              <strong>Ltd at £30k profit, all dividends</strong> &mdash; Corporation Tax
              ~&pound;5,700 (19% small profits rate); director takes &pound;24,300 as dividend, no
              further tax (within personal allowance + tax-free dividend allowance). Net similar to
              sole trader but admin much heavier.
            </li>
            <li>
              <strong>Sole trader at £80k profit</strong> &mdash; ~&pound;19,400 income tax +
              ~&pound;3,800 Class 4 NI + Class 2 NI = ~&pound;23,400 deductions; net ~&pound;56,600.
            </li>
            <li>
              <strong>Ltd at £80k profit, salary + dividends</strong> &mdash; Corporation Tax
              ~&pound;15,000-18,000; director takes &pound;12k salary + ~&pound;48k dividends; net
              typically ~&pound;60-63k. Better outcome than sole trader.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>IR35 status indicators (HMRC CEST tool):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Mutuality of obligation &mdash; is there an ongoing obligation to offer/accept work?
            </li>
        ...
        >
          <p>CIS in practice for an electrical sub-contractor:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              At year-end, CIS deductions credit against your final Income Tax / Corporation Tax
              bill.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>Incorporation through Companies House (online or paper).</li>
                <li>
                  Directors&apos; statutory duties (s.171-177): act within powers, promote success
                  of company, exercise reasonable care/skill/diligence, avoid conflicts of interest,
                  declare interests in proposed transactions, not accept benefits from third
                  parties.
                </li>
                <li>Annual confirmation statement and annual accounts filing requirements.</li>
                <li>
                  Limited liability: shareholders liable only for the value of their shares (subject
                  to wrongful trading and fraud exceptions).
                </li>
              </ul>
            </>
          }
          meaning={
            <>
              Setting up a Ltd company makes you a director with statutory duties. These are real
              legal obligations, not formalities. Failure to discharge them can expose you
              personally despite the &quot;limited liability&quot; structure. Keep accurate books,
              declare conflicts of interest, don&apos;t trade insolvent, file accounts on time. A
              good accountant helps you stay on the right side.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Once you employ anyone (including apprentices) HASAWA s.2(3) requires you to prepare a
              written health and safety policy. The HSE provides template policies suitable for
              small firms. The duty applies regardless of legal form &mdash; sole trader with one
              employee, partnership, Ltd, all the same. Plan the H&amp;S policy alongside the
              legal-form decision.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                ITEPA 2003 Part 2 Chapter 8 (and the off-payroll working rules in Chapter 10) set
                the framework for HMRC&apos;s anti-avoidance rules on personal services companies.
                The core test is whether, hypothetically, the worker would be an employee if the
                intermediary (e.g. the worker&apos;s Ltd company) were ignored.
              </p>
              <p>
                HMRC publishes the CEST (Check Employment Status for Tax) tool at gov.uk to help
                determine status.
              </p>
            </>
          }
          meaning={
            <>
              IR35 is real and well-enforced. For an electrician trading through their own Ltd on a
              long-term single-client engagement, get specialist advice on IR35 status. Use
              HMRC&apos;s CEST tool as a starting point. Multi-client electrical firms doing varied
              work for different customers face minimal IR35 risk.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Newly self-employed electrician sets up Ltd company in month 1 expecting immediate tax
              savings. Profits in year 1 are &pound;25k while building up the customer base.
              Accountant fees (&pound;1,200), Companies House filings, accounting software
              (&pound;400/year) and the structural overhead actually cost more than the marginal tax
              saving at that income level. Sole trader would have been simpler and similarly
              tax-efficient at &pound;25k.
            </>
          }
          doInstead={
            <>
              Start as sole trader for year 1 unless you have specific reasons for Ltd (high-risk
              contract, external investment, succession planning). Reassess at year-end. Convert to
              Ltd when profits comfortably exceed &pound;40-50k or when other Ltd-driving reasons
              emerge. The conversion is a one-evening job with an accountant; doing it 12 months
        ...
        <Scenario
          ...
          situation={
            <>
              You and a colleague (both JIB Approved Electricians) want to set up an electrical firm
              together. Equal partners, equal investment of time. Initial expectation: &pound;60-80k
              of combined profit in year 1, growing. You need to pick a legal form. Pure sole trader
              doesn&apos;t work because there are two of you. Options: partnership, LLP, or Ltd
              company. Which makes most sense?
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; rule out unincorporated partnership</strong>. Pure partnership
              (Partnership Act 1890) gives you unlimited liability for each other&apos;s actions. If
              your partner makes a mistake that triggers a liability claim, you&apos;re personally
              on the hook for the debt. Modern trades practically don&apos;t use unincorporated
              partnerships for this reason.
              <br />
              <br />
              <strong>Step 2 &mdash; weigh LLP vs Ltd</strong>. LLP gives limited liability with
              partnership tax (each partner taxed on share of profits via Self Assessment). Ltd
              gives limited liability with Corporation Tax + salary /dividends. At your expected
              profit level Ltd is typically more tax-efficient because of the lower dividend tax
              rates compared to higher-rate income tax. Plus Ltd is more familiar to commercial
              clients.
              <br />
              <br />
              <strong>Step 3 &mdash; agree shareholding and decision-making</strong>. Equal partners
              suggests 50/50 shareholding with both as directors. But 50/50 can deadlock decisions
              &mdash; agree a deadlock-resolution clause in a shareholders&apos; agreement (drafted
              by a solicitor; cost &pound;800-1,500). Worth doing properly upfront.
              <br />
              <br />
              <strong>Step 4 &mdash; set up the Ltd company</strong>. Companies House online
              incorporation &pound;50 (or use a formation agent). Open business bank account.
              Register for Corporation Tax with HMRC. Register for CIS if sub-contracting. Set up
              payroll if employing anyone. Engage an accountant for ongoing support.
              <br />
              <br />
              <strong>Step 5 &mdash; document everything</strong>. Shareholders&apos; agreement,
              employment contracts (yes, even for owner-directors), directors&apos; remuneration
              policy, expense policy, dividend declaration process. The paperwork upfront is the
              protection later if the partnership goes sideways.
            </>
          }
          whyItMatters={
            <>
              Two-person electrical partnerships go wrong more often than sole-trader firms because
              relationship dynamics get tangled with business decisions. The Ltd structure with
              proper documentation gives you the framework to handle disputes professionally. The
              cost (&pound;800-2,000 first year incl. solicitor) is a fraction of what an
              undocumented partnership dispute would cost in legal fees and lost goodwill.
            </>
          }
        />
        ...
        >
          <p>Ltd company tax stack at a glance:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Corporation Tax</strong> &mdash; 19% on first &pound;50k profit, 25% above
              &pound;250k, marginal in between.
            </li>
            <li>
              <strong>Director salary</strong> &mdash; typically ~&pound;12,570 (personal allowance,
              secondary NI threshold).
            </li>
            <li>
              <strong>Dividends</strong> &mdash; 8.75% / 33.75% / 39.35% by tax band, &pound;500
              allowance.
            </li>
            <li>
              <strong>Employer NI</strong> &mdash; saved by paying dividends instead of additional
              salary.
            </li>
            <li>
              <strong>Pension contributions</strong> &mdash; employer pension allowable as Corp Tax
              deductible expense.
            </li>
            <li>
              <strong>Annual filings</strong> &mdash; Confirmation Statement (Companies House,
              &pound;34), Accounts (Companies House + HMRC), CT600 (HMRC).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>VAT registration practical decision points:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Threshold</strong> &mdash; &pound;85,000 rolling 12-month taxable turnover
              (2024-25).
            </li>
            <li>
            ...
            <li>
              <strong>Standard scheme</strong> &mdash; 20% on outputs, reclaim 20% on inputs (vans,
              tools, materials, fuel).
            </li>
            <li>
              <strong>Flat Rate Scheme</strong> &mdash; 9.5% on gross turnover for construction,
              simpler admin.
            </li>
            <li>
              <strong>Cash Accounting</strong> &mdash; only pay VAT when customers pay you (helps
              cash flow).
            </li>
            <li>
              <strong>Reverse Charge VAT</strong> &mdash; specific construction industry scheme for
              B2B work, no VAT charged but customer accounts.
            </li>
            <li>
              <strong>De-registration</strong> &mdash; possible if turnover drops below
              ~&pound;83,000.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>IR35 status indicators:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Outside IR35 (genuine self-employment)</strong> &mdash; multiple clients,
              project-based, own tools, can substitute, business risk.
            </li>
            <li>
              <strong>Inside IR35 (deemed employment)</strong> &mdash; single client, ongoing role,
              integrated in client team, no substitution allowed.
            </li>
            <li>
              <strong>Status determination</strong> &mdash; client's responsibility for medium/large
              engagers (since April 2021).
            </li>
            <li>
              <strong>HMRC CEST tool</strong> &mdash; online check, indicative only.
            </li>
            <li>
              <strong>Mitigation</strong> &mdash; multiple clients, no exclusive contracts, avoid
              staff-equivalent perks.
            </li>
            <li>
              <strong>Penalties</strong> &mdash; backdated PAYE + NI + interest if HMRC
              reclassifies.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Companies Act 2006 director duties (paraphrased):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>s.171</strong> &mdash; Act within your powers (the company's constitution).
            </li>
            <li>
              <strong>s.172</strong> &mdash; Promote the success of the company for the benefit of
              members.
            </li>
            <li>
            ...
            <li>
              <strong>s.177</strong> &mdash; Declare interest in proposed transactions or
              arrangements.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              standards of business conduct, and (f) the need to act fairly as between members of
              the company."
            </>
          }
          meaning={
            <>
              Section 172 is the headline director duty and the most-cited in disputes. For a small
              electrical Ltd with one director-shareholder it's mostly common sense — make decisions
              that build the business long-term, treat employees and customers fairly, maintain a
              reputation for high standards. It becomes pointed when there's a dispute (e.g.
              director-shareholder splits in a partnership Ltd, family businesses with multiple
              shareholders) — the courts use s.172 as the framework for assessing director conduct.
              As a one-person Ltd you typically won't be challenged but still need to be able to
              evidence you've considered these factors in major decisions.
            </>
          }
        ...
        <Quiz
          title="Legal forms for an electrical business — knowledge check"
