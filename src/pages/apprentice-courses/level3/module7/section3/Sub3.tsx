...
const checks = [
  ...
  },
  {
    ...
    question: "What's 'retention money' on commercial work?",
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 8,
    question:
      "What's the benefit of using cloud accounting software (Xero, QuickBooks, FreeAgent)?",
    options: [
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 3 · Subsection 3"
        title="Pricing + invoicing"
        backTo="/study-centre/apprentice/level3-module7-section3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Labour rates by region, materials markup, prompt-payment legislation, day-rate vs
          fixed-price, invoice structure, retention money, getting paid.
        </p>
        ...
        >
          <p>Indicative 2024 UK self-employed electrician day rates:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Commercial sub-contracted</strong> &mdash; &pound;180-280/day (lower because
              main contractors compress sub rates).
            </li>
            <li>
              <strong>EICR / specialist testing</strong> &mdash; &pound;220-320/day plus certificate
              fee per property.
            </li>
            <li>
        ...
        >
          <p>Typical materials sources and markup approach:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Wholesaler trade price</strong> &mdash; Edmundson Electrical, City Electrical
              Factors, YESSS Electrical, Rexel. Trade discount typically 30-50% off list price for
              established account.
            </li>
            <li>
              <strong>Markup applied</strong> &mdash; typically 15-30% on top of trade price. Higher
              markup on small-value items (admin overhead higher pro-rata); lower markup on
              big-value items (competition tighter).
            </li>
            <li>
              <strong>Customer price</strong> &mdash; trade price + markup. Often this equates to
              broadly the wholesaler&apos;s list price.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>How to invoke the Act in practice:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Send original invoice with clear payment terms (Net 30 typical).</li>
            <li>If unpaid at due date, send a polite reminder.</li>
            <li>
              If still unpaid after a reasonable period (typically 30 more days), send a Statutory
              Demand citing the Late Payment Act &mdash; quoting the interest rate and the debt
              recovery fee.
            </li>
            <li>
              If still unpaid, escalate to small claims (under &pound;10k) or to a debt recovery
              agency.
            </li>
            <li>Keep all correspondence in writing &mdash; email is fine for evidence.</li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Retention practical considerations:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Diary the release dates and chase &mdash; main contractors don&apos;t automatically
              release.
            </li>
            <li>
              Consider retention bonds (insurance-backed, modest cost) to release retention at
              completion.
            </li>
            <li>
              Walk away from contracts with excessive retention (above 5%) or excessively long
              release periods (above 12 months DLP).
            </li>
            <li>
              Consider main contractor financial standing &mdash; retention you never see is lost
              margin.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Standard invoice elements (UK):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The Act establishes an implied term in commercial contracts that any debt not paid
                within the contractual or statutory period carries:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>Statutory interest at 8% above the Bank of England base rate.</li>
                <li>
                  A fixed sum for debt recovery costs (currently &pound;40 for invoices under
                  &pound;1,000, &pound;70 for &pound;1,000-9,999, &pound;100 for &pound;10,000+).
                </li>
                <li>
                  Reasonable additional costs of recovering the debt where the fixed sum is
                  insufficient.
                </li>
              </ul>
              <p className="mt-2">
                Default payment period is 30 days unless the contract specifies otherwise (and the
                contract period must be no longer than 60 days unless &quot;not grossly unfair to
                the supplier&quot;).
              </p>
            </>
          }
          meaning={
            <>
              The Act is your statutory protection against late payers. The right is automatic
              &mdash; you don&apos;t have to specify it in the contract or the invoice. For chronic
              late payers, signalling the intention to invoke the Act often triggers payment.
              Don&apos;t hesitate to use it &mdash; this is what it&apos;s for.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The Construction Act 1996 (as amended by the Local Democracy Economic Development
                and Construction Act 2009) governs payment in construction contracts. Headline
                provisions:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>Right to interim payments (regular stage payments throughout the contract).</li>
                <li>Right to a clear payment notice and pay-less notice procedure.</li>
                <li>
                  Prohibition on most &quot;pay when paid&quot; clauses (except in cases of upstream
                  insolvency).
                </li>
                <li>
                  Right to refer disputes to adjudication (a fast-track dispute resolution process).
                </li>
                <li>Right to suspend performance for non-payment.</li>
              </ul>
            </>
          }
          meaning={
            <>
              The Construction Act gives sub-contractors meaningful payment protections against main
              contractors. &quot;Pay when paid&quot; clauses you see in sub-contracts are mostly
              unenforceable. The right to adjudication (28-day dispute resolution) is a powerful
              tool for chasing payment without the cost and delay of court action. Get familiar with
              the Act if you&apos;re sub-contracting on UK construction.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The Consumer Rights Act 2015 governs domestic / consumer contracts for services:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>Service must be performed with reasonable care and skill (s.49).</li>
                <li>
                  Service must be performed within a reasonable time if no time agreed (s.52).
                </li>
                <li>Reasonable price if no price agreed (s.51).</li>
                <li>
                  Consumer entitled to repeat performance, price reduction or refund if service
                  falls below standard (s.55-56).
                </li>
              </ul>
            </>
          }
          meaning={
            <>
              Domestic customers are protected by the Consumer Rights Act 2015. Your work must be
              done with reasonable care and skill; if it isn&apos;t, the customer can require you to
              put it right (or get a price reduction / refund). State clear quotes and timeframes
              upfront. Document the work properly. The Act doesn&apos;t prevent customers from
              making frivolous claims but it gives them real rights when work falls short.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Newly self-employed electrician quotes &pound;250/day to customers based on expected
              take-home target. Year 1 actual: 200 billable days (after holidays, sick, weather,
              between jobs). Headline gross &pound;50k. After overheads (&pound;15k), tax
              (&pound;9k) actual take-home &pound;26k &mdash; below the target. Frustrated,
              increases day rate next year, loses customers to cheaper competitors, ends up
              under-earning even more.
            </>
          }
          doInstead={
            <>
              Plan day rates from desired take-home backwards. Decide target take-home (say
              &pound;35k). Add tax burden (~&pound;13k). Add overheads (&pound;15-20k). That gives
              required gross &pound;63-68k. Divide by realistic billable days (180-200). That gives
              day rate &pound;320-380. If the market won&apos;t bear that, you need either to
              specialise (premium rate) or cut overheads (sole trader vs Ltd, comparison shop
              insurance, etc.). Don&apos;t under-price out of fear.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You sub-contracted electrical work on a small office fit-out. Total &pound;8,000
              invoice issued 30 September with Net 30 terms. Today is 30 November &mdash; 60 days
              overdue. Three reminder emails ignored. Main contractor is well-known regional firm,
              not a small one-man band. You&apos;re carrying the cash flow strain; rent is due.
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; phone, don&apos;t just email</strong>. Email is easy to ignore.
              Phone the main contractor&apos;s accounts payable directly. Get a specific person on
              the line. Ask for a specific date the payment will be made. Take their name and email
              a follow-up to confirm.
              <br />
              <br />
              <strong>
                Step 2 &mdash; if the call doesn&apos;t produce a date, send a Statutory Demand
              </strong>
              . Cite the Late Payment of Commercial Debts Act 1998. Quote the statutory interest
              rate (BoE base + 8%, currently ~13-14%) and the debt recovery fee (&pound;100 for
              invoice over &pound;10k; &pound;70 for &pound;1k-9,999). Set a 7-day deadline.
              <br />
              <br />
              <strong>Step 3 &mdash; consider the Construction Act adjudication route</strong>. If
              the work was construction-sector (which fit-out is), the Construction Act 1996 gives
              you the right to refer the dispute to adjudication &mdash; a 28-day fast-track dispute
              resolution. Adjudicator decision is binding pending court resolution. Quick and cheap
              (typically &pound;500-2,000 in fees).
              <br />
              <br />
              <strong>Step 4 &mdash; small claims as backup</strong>. For undisputed debts under
              &pound;10k, the small claims court process is online, cheap (around &pound;400 issue
              fee for &pound;5k-10k claims) and quick. Issue the claim through Money Claim Online
              (mcol.gov.uk).
              <br />
              <br />
              <strong>Step 5 &mdash; learn the lesson for next time</strong>. Sub-contract terms
              with this main contractor probably specify Net 30 but don&apos;t signal what happens
              if they don&apos;t pay. For future contracts with this firm: shorter terms (Net 14),
              staged payments rather than all-on-completion, or simply don&apos;t take their work.
              Your time and capital are valuable.
            </>
          }
          whyItMatters={
            <>
              Late payment is one of the biggest threats to small electrical firms. It ties up cash
              that pays for materials, wages and your living expenses. The statutory protections
              exist for a reason &mdash; use them. Most main contractors hate the bad PR of formal
              disputes and pay quickly when chased properly. The cost of inaction (you carrying the
              loan against your business) is bigger than the cost of action (a few hours chasing
              properly).
            </>
          }
        />
        ...
        >
          <p>When to use each pricing model:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fixed price</strong> &mdash; well-defined scope (consumer unit change, EV
              charger install, EICR).
            </li>
            <li>
              <strong>Day rate</strong> &mdash; maintenance, fault-finding, additions, unscoped
              urgent work.
            </li>
            <li>
              <strong>T&amp;M with ceiling</strong> &mdash; scope uncertain but customer wants
              budget cap.
            </li>
            <li>
            ...
            <li>
              <strong>Per-point pricing</strong> &mdash; commercial fit-out (price per socket, per
              light fitting).
            </li>
            <li>
        ...
        >
          <p>Materials markup principles:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Branded high-value</strong> &mdash; near-cost where customer can price-check
              (e.g. Tesla Powerwall, specific PV panels).
            </li>
            <li>
              <strong>Trade accounts</strong> &mdash; Edmundson, Newey &amp; Eyre, CEF, City
              Electrical Factors.
            </li>
            <li>
              <strong>Trade discount</strong> &mdash; typically 30&ndash;60% off list price; varies
              by account size.
            </li>
            <li>
              <strong>Waste allowance</strong> &mdash; build 5&ndash;10% materials waste into
              estimate.
            </li>
            <li>
              <strong>Cash-flow buffer</strong> &mdash; materials paid up-front, paid back via
              customer invoice 30+ days later.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Retention money mechanics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Typical rate</strong> &mdash; 5% of each interim payment, sometimes 3% on
              large contracts.
            </li>
            <li>
            ...
            <li>
              <strong>Second half release</strong> &mdash; at end of Defects Liability Period
              (typically 12 months post-PC).
            </li>
            <li>
              <strong>Cash-flow impact</strong> &mdash; substantial &mdash; 5% of project value held
              interest-free.
            </li>
            <li>
            ...
            <li>
              <strong>Construction Act 1996</strong> &mdash; payment regulation framework; doesn't
              ban retention.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                Where a commercial debt remains unpaid past the contractual payment date (or 30 days
                from the invoice date if no contract terms), the creditor (you) is entitled to:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>Statutory interest at Bank of England base rate + 8% per annum.</li>
                <li>
                  A fixed compensation sum based on debt size: £40 for debts under £1,000, £70 for
                  £1,000–£9,999, £100 for £10,000+.
                </li>
                <li>Reasonable debt recovery costs over and above the fixed compensation.</li>
                <li>
                  The right to enforce these statutory entitlements without separate court action —
                  they apply by operation of law.
                </li>
              </ul>
            </>
          }
          meaning={
            <>
              The Late Payment regime is one of the strongest tools available to a small electrical
              contractor against late-paying commercial customers. Most small businesses never
              invoke it &mdash; either because they don't know it exists, or they fear damaging the
              customer relationship. In practice, politely citing the statutory entitlement on a
              reminder invoice often triggers payment within days. The fixed compensation sum
              (£40&ndash;£100 per overdue invoice) plus interest at base rate + 8% accumulates
              rapidly on a chunky retention or final-account payment. Don't be shy &mdash; this is
