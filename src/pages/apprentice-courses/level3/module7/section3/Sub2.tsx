...
const checks = [
  ...
  {
    id: 'mod7-s3-sub2-pi',
    question: 'What does Professional Indemnity (PI) insurance cover and who needs it?',
    options: [
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 3 · Subsection 2"
        title="Insurance stack"
        backTo="/study-centre/apprentice/level3-module7-section3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Public Liability, Employers' Liability (Compulsory Insurance Act 1969), Professional
          Indemnity, Tools-in-Transit, Business Vehicle, scheme-required cover.
        </p>
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-3">
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Employee injury / illness claims. &pound;5m statutory minimum. &pound;200-600/year.
                LEGALLY MANDATORY if you employ anyone &mdash; including apprentices.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
        ...
        >
          <p>Common additional policies and typical costs:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Business Vehicle insurance</strong> &mdash; commercial van policy with
              &quot;business use&quot; class. &pound;600-1,200/year for a small van.
            </li>
            <li>
              <strong>Defective Workmanship extension</strong> &mdash; covers post- completion
              claims for installation defects. &pound;50-200/year on top of PL.
            </li>
            <li>
              <strong>Product Recall</strong> &mdash; cost of recalling products you supplied.
              Niche; relevant for firms supplying significant equipment.
            </li>
            <li>
            ...
            <li>
              <strong>Contract Works</strong> &mdash; covers work in progress against damage.
              Sometimes required by main contractors.
            </li>
            <li>
              <strong>Plant and Equipment</strong> &mdash; covers fixed plant (e.g. test equipment,
              larger tools) against damage and theft.
            </li>
          </ul>
        </ConceptBlock>
          ...
          clause={
            <>
              ...
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                  Every employer carrying on business in Great Britain to insure against liability
                  for bodily injury or disease sustained by employees in the course of their
                  employment.
                </li>
                <li>Statutory minimum cover &pound;5 million per claim.</li>
                <li>
                  Certificate of insurance to be displayed at the workplace where employees can
                  readily see it.
                </li>
              </ul>
              <p className="mt-2">
                The Employers&apos; Liability (Compulsory Insurance) Regulations 1998 set the
                detail. HSE enforces non-compliance: fines up to &pound;2,500 per day for failure to
                insure; &pound;1,000 for failure to display the certificate.
              </p>
            </>
          }
          meaning={
            <>
              EL is non-negotiable from day one of employing anyone, including apprentices. The
              statutory minimum &pound;5m is rarely enough for a serious claim &mdash; most insurers
              offer &pound;10m as standard. The certificate must be displayed where employees can
              see it (typically the workplace noticeboard or equivalent in a small firm). HSE
              inspectors check during workplace visits. Get cover before the first day of
        ...
        <RegsCallout
          ...
          meaning={
            <>
              EL insurance is the financial backstop for HASAWA s.2 duties. If despite your best
              efforts an employee is injured at work, EL pays the resulting claim. But EL
              doesn&apos;t replace the s.2 duties &mdash; HSE prosecution for failure to manage
              safety can run alongside an EL claim. Treat health-and-safety management and EL
              insurance as complementary, not substitutes.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              Section 143 of the Road Traffic Act 1988 makes it an offence to use a motor vehicle on
              a road or other public place without an insurance policy meeting the statutory
              requirements (third-party cover for personal injury and property damage). For
              commercial use the policy must include &quot; business use&quot; class.
            </>
          }
          meaning={
            <>
              Your van must have business-use motor insurance, not just SDP (social, domestic and
              pleasure). Driving to job sites is business use. SDP-only policies are void for
              business journeys. Tools in the van are typically not covered by motor insurance
              &mdash; you need separate Tools-in-Transit. Many trades fall foul of this distinction;
              check your policy schedule shows business use.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Sole-trader electrician takes on first apprentice in week 1. Doesn&apos;t check
              insurance &mdash; assumes existing PL covers everything. Three months in HSE inspector
              visits a job site for unrelated reasons, asks to see EL certificate. None exists. HSE
              issues an Improvement Notice and considers prosecution. Apprentice is also concerned
              about their cover.
            </>
          }
          doInstead={
            <>
              Get EL in place BEFORE the apprentice&apos;s first day. Tell your insurance broker
              you&apos;re hiring &mdash; they&apos;ll add EL to the policy (typically
              &pound;200-600/year). Display the certificate at your premises or in your van. EL is
              one of the few insurance lines that&apos;s actually criminally enforced &mdash; treat
              it as a non-negotiable pre-condition of employing anyone.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Six months after you completed a kitchen rewire for a domestic customer, a fire breaks
              out and damages part of the kitchen. The insurance assessor for the customer&apos;s
              home insurance investigates and concludes the fire originated at the consumer unit you
              replaced. They&apos;re now pursuing a subrogated claim against you for &pound;15,000
              of damages. What insurance covers what?
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; notify your insurance broker / insurer immediately</strong>.
              Don&apos;t admit liability or discuss the claim directly with the customer or their
              assessor &mdash; refer them to your insurer. Most policies require prompt notification
              of any potential claim; delay can void cover.
              <br />
              <br />
              <strong>Step 2 &mdash; check which policy covers</strong>. Standard PL covers
              third-party property damage from your work &mdash; should apply if your install
              actually caused the fire. Defective workmanship extension (if you have it) covers
              post-completion defects more cleanly. Without either, the claim could fall in the gap
              and you&apos;re personally liable.
              <br />
              <br />
              <strong>Step 3 &mdash; gather your evidence</strong>. Pull the EIC for that job, your
              test results, the schedule of test results, the photos of the completed install.
              Customer would have signed off the work at the time. The evidence pack helps your
              insurer defend the claim if causation is disputed.
              <br />
              <br />
              <strong>Step 4 &mdash; cooperate with the insurer&apos;s investigation</strong>.
              Insurer may instruct an expert assessor to examine the failed equipment. Cooperate
              fully. The forensic investigation often clarifies whether your install actually caused
              the fire (vs e.g. customer subsequently overloaded the circuit, or a separate
              equipment fault).
              <br />
              <br />
              <strong>Step 5 &mdash; learn for next time</strong>. Whatever the outcome, review
              whether your evidence pack on jobs is robust enough to defend against future claims.
              Photos, test results, signed sign-off sheets, copies of certificates retained for 6
              years minimum. The paperwork is what wins (or loses) the dispute.
            </>
          }
          whyItMatters={
            <>
              Post-completion claims are the most common serious insurance claims for electrical
              firms. Without PL (or with a policy that excludes property-in-care and defective
              workmanship) you&apos;d be personally liable for the &pound;15,000. With proper cover,
              insurer handles it. The lesson: buy proper cover and keep the evidence pack robust on
              every job.
            </>
          }
        />
        ...
        >
          <p>PL practical specifics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cover level</strong> &mdash; &pound;5m typical CPS minimum, &pound;10m for
              major main contractors.
            </li>
            <li>
              <strong>Premium</strong> &mdash; &pound;200&ndash;500/yr small firm,
              &pound;500&ndash;1,500 medium.
            </li>
            <li>
              <strong>Common exclusions</strong> &mdash; property in care/custody/control, defective
              workmanship per se.
            </li>
            <li>
              <strong>Specified activities</strong> &mdash; check renewables, EV, hot work, working
              at height all included.
            </li>
            <li>
              <strong>Sub-contractor cover</strong> &mdash; some policies include occasional
              sub-contractors; clarify if you use them.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Legal basis</strong> &mdash; Employers' Liability (Compulsory Insurance) Act
              1969.
            </li>
            <li>
              <strong>Minimum cover</strong> &mdash; &pound;5m statutory, &pound;10m typically
              issued.
            </li>
            <li>
            ...
            <li>
              <strong>Sub-contractor risk</strong> &mdash; mis-classified workers may still be
              'employees' for EL purposes.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>PI cover scenarios:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design error</strong> &mdash; under-sized supply causing customer to
              over-spend on remediation.
            </li>
            <li>
              <strong>EICR misdiagnosis</strong> &mdash; missed defect leading to subsequent
              fire/incident.
            </li>
            <li>
              <strong>Specification error</strong> &mdash; non-compliant equipment specified,
              customer pays for remediation.
            </li>
            <li>
              <strong>Wrong advice</strong> &mdash; verbal or written guidance that customer relies
              on at financial cost.
            </li>
            <li>
            ...
            <li>
              <strong>Run-off cover</strong> &mdash; needed for 6+ years after ceasing trading
              (claims can arise late).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Tool/equipment cover essentials:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Tools-in-Transit</strong> &mdash; cover whilst in vehicle; typically
              &pound;3&ndash;10k per van.
            </li>
            <li>
              <strong>Tools-in-Premises</strong> &mdash; cover at home/workshop; check sub-limit.
            </li>
            <li>
              <strong>Goods-in-Vehicle</strong> &mdash; covers stock/materials in transit, often a
              sub-limit of TIT.
            </li>
            <li>
              <strong>Plant cover</strong> &mdash; for higher-value items, itemised schedule, full
              replacement value.
            </li>
            <li>
              <strong>Overnight parking conditions</strong> &mdash; off-street parking often
              required.
            </li>
            <li>
              <strong>Tool marking</strong> &mdash; UV pen, datadot, registered serial numbers help
              recovery and claim acceptance.
            </li>
            <li>
        ...
        >
          <p>Vehicle insurance class of use:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Class 3</strong> &mdash; commercial use, multiple drivers, carrying tools to
              multiple sites.
            </li>
            <li>
            ...
            <li>
              <strong>Trade plates</strong> &mdash; for vehicles being moved between trade premises
              (rarely relevant for electricians).
            </li>
            <li>
              <strong>Multi-vehicle discount</strong> &mdash; 3+ vans often pools at lower
              per-vehicle rate.
            </li>
            <li>
        ...
        >
          <p>Personal-side insurance products:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Income Protection</strong> &mdash; monthly benefit if unable to work;
              50&ndash;65% of income; until recovery.
            </li>
            <li>
              <strong>Critical Illness Cover</strong> &mdash; lump sum on diagnosis of named serious
              illness.
            </li>
            <li>
            ...
            <li>
              <strong>Personal Accident</strong> &mdash; lump sum on accidental injury, often
              bundled.
            </li>
            <li>
              <strong>Mortgage Protection</strong> &mdash; designed to clear mortgage on
              death/critical illness.
            </li>
            <li>
              <strong>Premium</strong> &mdash; varies massively by age, health, occupation, cover
              level.
            </li>
            <li>
              <strong>Backstop</strong> &mdash; Electrical Industries Charity hardship grants for
              genuine crisis.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              "Except as otherwise provided by this Act, every employer carrying on any business in
              Great Britain shall insure, and maintain insurance, under one or more approved
              policies with an authorised insurer or insurers against liability for bodily injury or
              disease sustained by his employees, and arising out of and in the course of their
              employment in Great Britain in that business... The amount for which an employer is
              required by this Act to insure and maintain insurance shall be not less than five
              million pounds in respect of claims relating to any one or more of his employees
              arising out of any one occurrence."
            </>
          }
          meaning={
            <>
              EL is one of the few genuinely compulsory insurances for a UK business. The £5m
              statutory minimum is low (most policies are issued at £10m as standard). Failure to
              hold EL when you have employees is a criminal offence carrying a fine of up to £2,500
              per day of non-compliance, and additional penalties if you fail to display the
              certificate. As an electrical firm with one or more apprentices, labourers or
              improvers, EL is non-negotiable from the moment you make the first hire. Many
