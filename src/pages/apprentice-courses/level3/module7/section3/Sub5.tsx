...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 3 · Subsection 5"
        title="Professional conduct for electricians"
        backTo="/study-centre/apprentice/level3-module7-section3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The IET Code of Conduct framework, ethical decision-making, representing your employer,
          confidentiality and professional boundaries — and the personal and business consequences
          of breach.
        </p>
        ...
        >
          <p>The IET Rules of Conduct (and the equivalent JIB and CPS scheme codes) cover:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Integrity</strong> &mdash; honest, accurate certification, clear pricing, no
              false claims about qualifications.
            </li>
            <li>
              <strong>Competence</strong> &mdash; only do work you&apos;re qualified for; keep BS
              7671 currency and specialist tickets up to date.
            </li>
            <li>
            ...
            <li>
              <strong>Professional judgement</strong> &mdash; reasoned decisions, documented, with a
              clear basis in the regs and best practice.
            </li>
            <li>
        ...
        >
          <p>Codes of conduct serve three audiences:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        >
          <p>The most common dilemma categories:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        >
          <p>The professional mistake-handling loop:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              knowledge or experience&quot; isn&apos;t just about qualifications &mdash; it covers
              ongoing CPD and applies to every individual on the job, not just the QS. Working
              outside competence is a statutory breach regardless of who instructed it. Refusal to
              do work outside your competence is a professional duty, not optional.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              HASAWA 1974 s.7 means &quot;I was only following instructions&quot; is not a defence.
              Every employee has a personal duty of care, on top of any duty owed by the employer.
              Where instructed work would breach safety duties, the right answer is push back in
              writing, escalate, and decline if necessary &mdash; the law does not excuse unsafe
              work because someone else told you to do it.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">The Bribery Act 2010 creates four main offences:</p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                ...
                <li>Section 6 &mdash; bribing a foreign public official.</li>
                <li>
          ...
          meaning={
            <>
              ...
              anything over a small threshold (typical: &pound;50). Receiving as well as giving is
              an offence &mdash; the apprentice on the receiving end is exposed too.
            </>
          }
        ...
        >
          <p>Professional representation includes:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Follow company procedures even if you disagree with them &mdash; raise disagreements
              separately.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Resource misuse</strong> &mdash; company van, tools, materials or time used
              for personal work.
            </li>
            <li>
              <strong>Cash side-jobs</strong> &mdash; off-books work that competes with the employer
              or undermines tax compliance.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Commercial information</strong> &mdash; business plans, pricing, financials,
              client lists picked up incidentally.
            </li>
            <li>
            ...
            <li>
              <strong>Photos and video</strong> &mdash; never without explicit permission; never in
              a form that identifies the property.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Two electricians on a job; one rushes off to the next call; the other is asked by the
              office to sign the certificate so the customer can get the invoice. They sign. Two
              months later the customer has a fire; investigation traces it to a missing continuity
              test on a circuit that should have failed. The signer is in personal liability
              territory under EWR 1989, plus fraud territory for signing for work not witnessed. The
              original installer may also be liable but the signer has the bigger problem.
            </>
          }
          doInstead={
            <>
              ...
              inconvenience over a couple of days is acceptable; falsified certification is not. CPS
              schemes audit this specifically.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              customer pulls you aside on the day of the job and says they&apos;d prefer to pay cash
              and skip the VAT, &quot;saving us both some paperwork.&quot; You&apos;re employed by a
              CPS-registered firm; the customer is a long-standing repeat client.
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; politely refuse on the spot</strong>. &quot;That&apos;s not
              something I can do &mdash; the firm has to invoice properly and I have to follow that.
              Happy to do the work today on the existing quote.&quot;
              <br />
              <br />
              <strong>Step 2 &mdash; don&apos;t lecture or moralise</strong>. The customer probably
              isn&apos;t a serious tax fraudster &mdash; they&apos;re testing or hoping. A firm no
              is enough. Don&apos;t flag &quot;I&apos;ll report this&quot; or threaten; that&apos;s
              not your role.
              <br />
              <br />
              <strong>Step 3 &mdash; document the conversation</strong>. Short email to the office
              that evening: &quot;Customer at [job] asked about cash payment to avoid VAT; I
              declined and proceeded with the quoted scope.&quot; This protects you if the customer
              later complains about the price or invents a different version.
              <br />
              <br />
              <strong>Step 4 &mdash; continue normally</strong>. Don&apos;t make the rest of the job
              awkward; don&apos;t reference the conversation; just do excellent work and leave the
              customer with a clean invoice. The relationship usually survives a polite refusal.
              <br />
              <br />
              <strong>Step 5 &mdash; if the customer escalates or insists</strong>, refer to the
              office &mdash; this is a customer-management issue, not a site issue. The QS /
              director can decide whether to keep that customer at all.
            </>
          }
          whyItMatters={
            <>
