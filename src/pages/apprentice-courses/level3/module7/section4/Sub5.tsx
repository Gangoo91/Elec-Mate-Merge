...
const checks = [
  {
    ...
    options: [
      'The written multiple-choice exam covering BS 7671 that an apprentice sits in the classroom at the end of the Level 3 Diploma. It is open-book and entirely theory-based, with no practical element.',
      'The annual on-site assessment a CPS scheme carries out on a registered firm, checking sample certificates and test equipment. It is a firm-level audit, not an individual apprentice assessment.',
      'A health-and-safety touch-screen test, equivalent to the CSCS test, that an apprentice must pass to get a site card. It covers hazard awareness rather than installation skills.',
  ...
  },
  {
    ...
    options: [
      'To set the technical wiring rules — cable sizing, protective device selection, disconnection times — that all electrical work in the UK must follow. Part P is the document electricians design to on every job.',
      ...
      'To licence electricians to work, by requiring every individual to hold a Part P card before they may carry out fixed wiring in homes. Working without the card is a criminal offence.',
      'To require all rented dwellings to have a five-yearly electrical inspection and to make landlords legally responsible for keeping the wiring safe between inspections.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A register of individual electricians, held by the HSE, that lists everyone judged competent to carry out electrical work. Being struck off the register bars you from working anywhere in the UK.',
      "A grading awarded to an individual electrician after their AM2, certifying them as a 'competent person' for life. It is the same thing as Gold ECS card status and is administered by the JIB.",
      ...
      'A mandatory insurance product that every electrical firm must hold, covering the cost of putting right any defective notifiable work. Without it a firm cannot legally issue an Electrical Installation Certificate.',
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'Electrical Compliance Standard — administered by the HSE. It is the statutory standard against which all fixed wiring is judged, replacing BS 7671 as the legal benchmark for installations.',
      ...
      'Electrician Competence Scheme — administered by City & Guilds. It is the awarding-body register of everyone who has passed the 2365 Diploma, used by colleges to track learner achievement.',
      "Electrical Contractors' Scheme — administered by the ECA. It is a membership badge for contracting firms that vouches for their commercial standing rather than an individual's competence.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    id: 2,
    question:
      'Which of the following is NOT a competent person scheme for Part P notifiable electrical work?',
    options: ['ELECSA.', 'NICEIC.', 'HSE.', 'NAPIT.'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The City & Guilds inspection and testing qualification, covering the practical use of a multifunction tester and the completion of EICRs and EICs.',
      'The City & Guilds Level 3 Diploma in Electrical Installation — the main classroom and workshop qualification an apprentice completes before sitting the AM2.',
      'The City & Guilds EV charging installation qualification, covering BS 7671 Section 722 and the OZEV-approved installer requirements.',
  ...
  },
  {
    ...
    options: [
      'New circuits, consumer unit replacement, and work in special locations (a room containing a bath or shower, swimming pool zones, saunas).',
      'All electrical work in a dwelling without exception, including replacing a single socket or light switch, because every alteration to fixed wiring must be notified.',
      'Only consumer unit replacements — adding new circuits and working in bathrooms are classed as minor works and do not need notifying.',
      'Only commercial and industrial installations — domestic work is outside Part P entirely and is covered solely by BS 7671.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Solar photovoltaic (PV) installation — covers BS 7671 Section 712, MCS registration requirements and DC string design for domestic and small commercial arrays.',
      ...
      'Fire detection and alarm system design and installation — covers BS 5839, the FIA/BAFE competence requirements and category L/P system selection.',
      'Hazardous-area (ATEX/CompEx) installation — covers intrinsically safe wiring, zone classification and equipment selection for petrochemical and industrial process work.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Nothing — once issued, an ECS card is valid for life and never needs renewing, so there is no ongoing requirement to maintain it.',
      'Re-sitting the AM2 practical assessment in full every five years, demonstrating you can still install and test to standard before the card is reissued.',
      'Passing a fresh insurance medical and an eyesight test each year, since site access depends on physical fitness rather than ongoing training.',
  ...
  },
  {
    ...
    options: [
      ...
      "Maintenance and Calibration Standard — the scheme that accredits the laboratories which calibrate electricians' test instruments, ensuring an MFT reads accurately for certification work.",
      'Mains Connection Scheme — the DNO process for approving the connection of new domestic supplies and meter installations to the local network.',
      'Major Contractors Scheme — a register of large construction firms approved to bid for public-sector electrical projects above a set value threshold.',
    ],
    correctAnswer: 0,
    explanation:
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 4 · Subsection 5"
        title="Industry qualifications for electricians"
        backTo="/study-centre/apprentice/level3-module7-section4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          ECS cards and JIB grades, Part P and CPS schemes, core and specialist qualifications, MCS
          / OZEV, and the route to professional registration.
        </p>
        ...
        >
          <p>ECS card bands at a glance:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Gold &mdash; Installation Electrician</strong>: Level 3 Diploma + AM2 / AM2S,
              fully qualified.
            </li>
            <li>
              <strong>Gold &mdash; Approved Electrician</strong>: Installation Electrician + C&amp;G
              2391 inspection-testing.
            </li>
            <li>
              <strong>Gold &mdash; Technician / Senior grades</strong>: additional qualifications /
              experience evidenced.
            </li>
            <li>
              <strong>Blue &mdash; Apprentice</strong>: on a recognised electrical apprenticeship
              programme.
            </li>
            <li>
              <strong>White &mdash; Provisional / Trainee</strong>: working towards full
              qualification.
            </li>
            <li>
              <strong>Green &mdash; Labourer / Operative</strong>: unskilled support; not electrical
              work in own right.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Notifiable work in dwellings (England) typically includes:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>New circuits.</li>
          ...
          <p className="mt-3">Non-notifiable but still requiring BS 7671 compliance:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          <p>CPS scheme registration requirements (typical):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <p className="mt-2">
                Approved Document P (the practical guidance) defines notifiable work, sets out the
                certification routes (CPS scheme self-certification or building control
                notification) and requires the use of recognised standards (typically BS 7671) to
          ...
          meaning={
            <>
              Part P is a short statutory provision with a wide reach. The functional requirement is
              broad; the practical detail is in Approved Document P and BS 7671. Notifiable work
              that proceeds without notification or self-certification can attract enforcement
              action and creates problems at property sale (conveyancing solicitors routinely ask
              for electrical certificates). CPS scheme self-certification is the routine way most
              electricians meet Part P.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              EWR Reg 16 is the statutory backbone of the qualifications system. The qualifications
              (Level 3, AM2, 2382, 2391, specialist tickets) are how &quot;technical knowledge or
              experience&quot; is evidenced. Apprentice and trainee grades exist precisely because
              Reg 16 also accepts supervision as an alternative to direct competence &mdash; an
              apprentice is competent for the supervised work they&apos;re trained on, not for
        ...
        >
          <p>The Installation Electrician qualification stack:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Level 2 Diploma</strong> &mdash; foundations (C&amp;G 2365-02 or equivalent).
            </li>
            <li>
              <strong>Level 3 Diploma</strong> &mdash; advanced installation (C&amp;G 2365-03 or
              equivalent).
            </li>
            <li>
        ...
        >
          <p>Inspection and testing qualification options:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>C&amp;G 2391-52</strong> &mdash; combined initial verification + periodic
              inspection.
            </li>
            <li>
            ...
            <li>
              <strong>EAL / LCL Awards equivalents</strong> &mdash; functionally similar, accepted
              by CPS schemes.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Common specialist qualifications:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Battery storage</strong> &mdash; manufacturer-specific (Tesla, Powerwall,
              etc.).
            </li>
            <li>
        ...
        >
          <p>MCS and OZEV approval scopes:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>MIET (Member)</strong> &mdash; full professional grade; typically requires
              extended experience or degree route.
            </li>
            <li>
        ...
        >
          <p>Engineering Council grades:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EngTech</strong> &mdash; Engineering Technician; achievable for working
              electricians with 3+ years post-AM2.
            </li>
            <li>
              <strong>IEng</strong> &mdash; Incorporated Engineer; degree-equivalent academic +
              significant engineering experience.
            </li>
            <li>
              <strong>CEng</strong> &mdash; Chartered Engineer; full degree route + chartered-level
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Electrician&apos;s ECS card expired 3 months ago; they&apos;ve been meaning to renew.
              Turn up Monday morning at a commercial site; gate scanner reports the card as lapsed;
              site safety officer refuses entry. Day&apos;s work lost; firm chases for an
              explanation; client may invoice for the lost day. Renewal then takes 5-10 working days
              even when actioned immediately, so it&apos;s typically 1-2 weeks before the
              electrician can return to that site.
            </>
          }
          doInstead={
            <>
              Set a calendar reminder 90 days before card expiry. Book the ECS HSEA test 60 days
              before expiry. Submit the renewal application 30 days before expiry with the
              health-and-safety certificate in hand. Carry the receipt / interim confirmation from
              JIB if there&apos;s any gap. Most firms reimburse the renewal fee but won&apos;t cover
              lost days from lapse &mdash; that&apos;s on the individual.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Sole-trader electrician does a consumer unit upgrade for a domestic customer. Not
              CPS-registered, doesn&apos;t notify building control. Three years later customer sells
              the property; conveyancing solicitor asks for the electrical certificate for the work;
              nothing is on file. Customer comes back to the electrician asking for the certificate
              &mdash; which can&apos;t be issued retrospectively without an EICR / inspection by a
              CPS-registered firm, which costs the customer hundreds to commission. Customer is
              angry, leaves a one-star review, possible small-claims action.
            </>
          }
          doInstead={
            <>
              Either join a CPS scheme before doing any Part P notifiable work, or notify building
              control on a per-job basis for any notifiable work done. CPS scheme membership cost
              (~&pound;500/year) is dramatically lower than per-job building control fees
              (~&pound;200-400 per job) for any volume of work. For occasional domestic notifiable
              work without CPS, factor the building control fee into the quote; tell the customer;
              arrange the notification properly.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              Approved Contractor doing 70% commercial, 30% domestic, with a growing EV / PV side.
              How do you plan the next 5 years of qualifications?
            </>
          }
          whatToDo={
            <>
              <strong>Year 1 (2026) &mdash; lock down Installation Electrician status</strong>. Pass
              AM2S, secure Gold ECS card, take C&amp;G 2382-26 (the A4:2026 variant) to update your
              regs currency, sit the ECS HSEA test for site access. Build the portfolio &mdash; jobs
              worked, tests carried out, fault-finding events.
              <br />
              <br />
              <strong>Year 2 (2027) &mdash; add inspection and testing</strong>. Sit C&amp;G 2391-52
              to become Approved Electrician. Adds JIB grade uplift (~10-15% pay differential),
              unlocks EICR work and certificate-issuing on the firm&apos;s CPS scheme. Cost
              &pound;500-700 to sit; many employers fund or part-fund this.
              <br />
              <br />
              <strong>Year 3 (2028) &mdash; first specialist ticket</strong>. Given the firm&apos;s
              EV / PV side, pick one &mdash; C&amp;G 2919 for EV is probably the more immediately
              commercial. Cost &pound;300-600 plus the OZEV-approved installer pathway if the firm
              wants to do grant-funded work.
              <br />
              <br />
              <strong>Year 4 (2029) &mdash; second specialist + IET / EngTech</strong>. Add C&amp;G
              2399 PV (cost &pound;400-700); position the firm for MCS PV registration. Apply for
              AMIET (IET Associate Member) at this point with 3+ years post-AM2 experience; consider
              EngTech registration too.
              <br />
              <br />
              <strong>Year 5 (2030) &mdash; depth or breadth?</strong>. Either deepen specialist
              work (e.g. add FIA fire alarms, or battery storage manufacturer training, or move
              toward design / management) or pursue MIET upgrade. Plan for A5 BS 7671 amendment
              cycle CPD in this year too (estimated mid-decade timing).
              <br />
              <br />
              <strong>Budget across 5 years</strong>: roughly &pound;2,500-4,000 in qualification /
              scheme fees; mostly amortised across pay rises and JIB grade uplifts. Many employers
              fund the regs CPD (2382) entirely and part-fund specialist tickets.
            </>
          }
          whyItMatters={
            <>
              A planned qualifications stack compounds &mdash; each addition increases earning
              potential and opens new work categories. Without a plan most electricians stall at
              Installation Electrician for years; with a 5-year plan most reach Approved Electrician
              + two specialist tickets + AMIET / EngTech inside half a decade. The difference in
              lifetime earnings is substantial. Apprentices: write the plan during your final
              apprenticeship year; revise it annually.
            </>
          }
        />
