...
const checks = [
  {
    ...
    question: 'How often does BS 7671 get a new edition or major amendment?',
    options: [
      'A new dated edition every year (e.g. BS 7671:2024, BS 7671:2025); each annual release is a full rewrite that invalidates the previous book.',
      'New edition every 7-10 years; amendments to the current edition every 2-4 years (A1, A2, A3, A4).',
      'No fixed cycle — revised reactively after fatalities or fires highlight a gap, so decades can pass between updates.',
      'A new edition every 20 years with no amendments between, deliberately spaced so electricians avoid frequent retraining.',
    ],
    correctIndex: 1,
    explanation:
  ...
  {
    id: 'mod7-s4-sub1-a4',
    question: "What's the headline change in BS 7671 A4:2026?",
    options: [
      'Broader AFDD recommendation, updated TN-C-S (PNB) handling, revised certificate schedule columns, and updated renewables requirements.',
      'The abolition of RCD protection — A4 removes 30 mA RCDs on socket circuits, replacing them entirely with AFDDs.',
      'A switch from 230 V to 240 V as the declared nominal voltage, recalculating all Zs values and cable tables to suit.',
      "Mandatory annual EICRs for all domestic dwellings, bringing private housing in line with the rental sector's inspection rule.",
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    question: 'Why do CPS schemes (NICEIC, NAPIT) require CPD for QS-named individuals?',
    options: [
      "Because the CPD requirement is just the scheme collecting the QS's First Aid and 18th Edition certificates, which renew every three years by law.",
      "Because the QS underwrites the firm's competence to self-certify notifiable work, so the scheme requires evidence the QS stays current with BS 7671 and best practice.",
      "Because HMRC only allows training as a business expense if logged through a CPS scheme, so the scheme collects the records on the QS's behalf.",
      "Because CPD hours set the firm's public liability premium, so the scheme records them to pass on to insurers.",
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'An edition is the paperback version and an amendment is the hardback version of the same content. The two are identical in substance; the difference is only the binding and the price, with editions sold to colleges and amendments sold to working electricians.',
      'Edition = a major rewrite of all sections, 7-10 years apart; amendment = a targeted update to the current edition (A1, A2, A3, A4), 2-4 years apart.',
      'An edition is the legally binding version and an amendment is advisory only. Amendments are best-practice suggestions that an electrician may choose to follow, whereas editions carry the force of law and must be complied with.',
      'An edition covers the wiring rules and an amendment covers only the certificate forms. The technical regulations never change between editions; amendments simply re-issue the model forms with updated layouts.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The Health and Safety Executive (HSE) drafts BS 7671 as a statutory instrument. Because it is law, only a government department can write it, and the IET simply prints and distributes the finished document.',
      'Ofgem and the regional Distribution Network Operators write it jointly, since they own the supply network and therefore set the rules for everything connected to it. Industry bodies are consulted but have no drafting role.',
      'JPEL/64 — the joint IET / BSI Technical Committee, drawing on the IET, BSI, ECA, NICEIC, BEAMA, JIB, manufacturers and government bodies, with public consultation before publication.',
      'The International Electrotechnical Commission (IEC) writes BS 7671 in Geneva and it is adopted unchanged in the UK. There is no UK-specific drafting body; the standard is purely an international document with a British cover.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'C&G 2382 is the inspection and testing qualification — it covers the practical use of an MFT and the completion of EICRs. It is unrelated to amendments because testing methods stay the same regardless of which edition is in force.',
      'C&G 2382 is the AM2 end-point assessment for apprentices. It is sat once at the end of the apprenticeship and never repeated, so it has no role in tracking later BS 7671 amendments.',
      'C&G 2382 is a design qualification covering cable calculations and protective device selection. It is awarded for life and does not need updating when BS 7671 amends, since the underlying maths does not change.',
      'C&G 2382 is the BS 7671 Wiring Regulations qualification — an open-book exam on the current edition, re-issued as a new variant for each major version, so the latest pass is your standard regs-currency evidence.',
    ],
    correctAnswer: 3,
    explanation:
      '2382 is the regs knowledge qualification that tracks BS 7671 versions: 2382-15 was 17th Edition; 2382-18 was 17th Edition + A3; 2382-22 is 18th Edition; 2382-26 will cover A4:2026. Holding the latest 2382 evidences current BS 7671 competence. CPS schemes typically expect QS-named individuals to hold the current 2382 within a reasonable period of each amendment — plan to take the new variant within 6-12 months of each major amendment.',
  },
  {
    id: 4,
    question: "What's an AFDD and why does A4:2026 require them more widely?",
    options: [
      'Arc Fault Detection Device — detects series and parallel arc faults that overcurrent and RCD protection can miss; A4:2026 broadens its recommendation under Reg 421.1.7.',
      'Automatic Fuse Disconnection Device — a fast-acting main-switch replacement that disconnects the whole installation on any earth fault, required by A4:2026 at every domestic origin.',
      'Auxiliary Fault Drain Device — fitted to the earth bar to drain stray leakage to earth and stop nuisance RCD tripping, required by A4:2026 on final circuits.',
      'Adjustable Frequency Drive Device — smooths the supply to inverter equipment such as heat pumps and PV, required by A4:2026 on all renewables circuits.',
    ],
    correctAnswer: 0,
    explanation:
      "AFDD = Arc Fault Detection Device. It addresses the gap that overcurrent devices and RCDs can miss — arc faults often involve intermittent low-energy current that doesn't trip MCBs or RCDs but generates enough heat to cause fires. AFDDs combine MCB and RCD functions with arc-detection electronics. Wider AFDD requirement in A4:2026 (Reg 421.1.7, 'recommending' wording — not a blanket BS 7671 mandate; HRRBs come under mandatory scope via the Building Safety Act 2022 framework) reflects evidence that arc faults are a meaningful cause of UK electrical fires. Cost typically £30-60 per AFDD; materials increase per circuit is modest, design and install changes more substantive.",
  },
  {
    id: 5,
    question: "What's TN-C-S (PNB) and why does A4:2026 update its handling?",
    options: [
      'TN-S (separate earth) is the earthing system where the DNO provides a dedicated earth conductor, usually the cable sheath. The risk addressed in A4 is corrosion of that sheath over time. A4 requires the earth-fault loop impedance of every TN-S supply to be re-measured annually.',
      "TN-C-S (combined-separate, PNB) is a UK earthing system where the DNO's combined PEN conductor splits into separate N and PE at the property; A4 updates open-PEN risk-assessment guidance, especially for EV charging.",
      'TT (earth-terra) is the system where the property has its own earth electrode rather than a DNO earth. The risk addressed in A4 is the high earth-electrode resistance of a single rod, which A4 caps at a new maximum of 20 ohms for all TT installations.',
      'IT (isolated terra) is the standard UK domestic earthing system where the supply is unearthed and the installation floats. The risk addressed in A4 is the first earth fault going undetected, so A4 requires an insulation-monitoring device on every domestic board.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'No time pressure — only update when the qualification reaches its natural expiry, which for the 18th Edition is typically every five years.',
      'Immediately and overnight — the day it publishes it is mandatory with no transition, so old-edition certificates are invalid and full retraining is required first.',
      'A 1-day refresher within 3-6 months, then the updated 2382 within 12 months — the window CPS schemes typically expect for QS-named individuals.',
      'Within three years — amendments align to the three-yearly First Aid and IPAF cycle, so the regs update folds into existing retraining.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Yes — fully retrospective. Every time BS 7671 amends, all existing installations become non-compliant and must be brought up to the new edition within 12 months or they are unlawful to use.',
      'Yes — retrospective for rented property only. Private homeowners are exempt, but landlords must upgrade every let dwelling to the current edition at each amendment as a condition of letting.',
      'Partly — retrospective only for the safety chapters (Part 4). The protection requirements apply to all installations immediately on amendment, while the rest of the standard applies only to new work.',
      'No — generally not retrospective. New work and additions/alterations must meet the current edition; existing installations are assessed against the standard they were installed to, with safety-critical exceptions.',
    ],
    correctAnswer: 3,
    explanation:
      'Non-retrospective is a fundamental principle — otherwise every installation would need rebuilding every few years. The practical effect: new installations and additions/alterations comply with the version in force when the work is done; existing installations are assessed against standards-of-the-time, with safety-critical exceptions. EICR coding applies C1/C2/C3/FI judgements that account for both current and historic standards. Knowing this matters for periodic inspection work.',
  },
  {
    id: 8,
    question: 'Where do you get CPD that counts for CPS scheme requirements?',
    options: [
      'Many sources — scheme events, accredited training providers, trade events, online platforms, manufacturer training and self-study — all accepted if logged with evidence.',
      "Only your own CPS scheme's in-house courses — schemes accept only CPD they have delivered and charged for themselves, so other providers do not count toward your annual hours.",
      'Only accredited classroom courses with a final exam — reading, online learning, manufacturer events and conferences are not recognised because CPD must always be formally assessed.',
      'Only a university or FE college — CPD must carry academic credit such as a HNC unit to count, so trade events and short courses do not qualify.',
    ],
    correctAnswer: 0,
    explanation:
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 4 · Subsection 1"
        title="BS 7671 amendment cycle"
        backTo="/study-centre/apprentice/level3-module7-section4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          A1, A2, A3, A4 — what each amendment typically changes, why they happen, the CPD
          obligation that follows, and how to stay current with the regs over a long career.
        </p>
        ...
        >
          <p>Recent BS 7671 timeline:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>17th Edition</strong> &mdash; 2008.
            </li>
            <li>
              <strong>17th Edition + A1 / A2 / A3</strong> &mdash; updates to 17th Edition through
              2010s.
            </li>
            <li>
              <strong>18th Edition</strong> &mdash; 2018, major rewrite.
            </li>
            <li>
              <strong>18th + A1</strong> &mdash; 2020 (mainly EV charging).
            </li>
            <li>
              <strong>18th + A2</strong> &mdash; 2022 (mainly editorial / corrections).
            </li>
            <li>
              <strong>18th + A3</strong> &mdash; 2024 (renewables-related).
            </li>
            <li>
              <strong>18th + A4</strong> &mdash; 2026 (AFDDs, TN-C-S handling, schedule columns,
              others).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>A4:2026 headline change topics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>AFDDs</strong> &mdash; mandatory in many circuits (socket outlets in
              higher-fire-risk locations; specific dwelling circuit categories). Cost impact per
              circuit modest (&pound;30-60 per AFDD).
            </li>
            <li>
              <strong>TN-C-S (PNB) handling</strong> &mdash; updated guidance for open-PEN risk
              assessment, particularly for EV charging.
            </li>
            <li>
              <strong>Schedule columns</strong> &mdash; revised columns on EIC and related
              certificates; CPS scheme and software vendor form updates required.
            </li>
            <li>
              <strong>Renewables and storage</strong> &mdash; updated requirements for PV, battery
              storage and wider energy systems.
            </li>
            <li>
              <strong>Special locations</strong> &mdash; revised content for bathrooms, swimming
              pools, agricultural, EV charging stations.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Typical CPD calendar for an Approved Electrician QS:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                BS 7671 (the IET Wiring Regulations) is the UK national standard for electrical
                installation. Headline structure:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                ...
                <li>
                  Appendices &mdash; cable tables, calculation methods, supplementary information.
                </li>
              </ul>
              <p className="mt-2">
                Updated through edition cycles (typically 7-10 years between editions) and amendment
                cycles (typically 2-4 years between amendments).
              </p>
            </>
          }
          meaning={
            <>
              BS 7671 is the design, install and test standard for UK electrical work. Its evolution
              is built into the framework &mdash; expect amendments every few years and editions
              every decade or so. The CPD obligation that follows is a permanent feature of working
              as a competent electrician in the UK.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              EAWR Regulation 16 is the statutory underpin of the CPD requirement. &quot;Technical
              knowledge&quot; isn&apos;t a one-time achievement &mdash; it must be current. Working
              to outdated BS 7671 standards risks breach of Regulation 16. CPD is what keeps you on
              the right side of EAWR over a long career.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                JPEL/64 is the joint IET / BSI Technical Committee responsible for drafting BS 7671.
                Membership includes:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
              ...
              <p className="mt-2">
                Drafts go through public consultation (open to all stakeholders) before final
                publication.
              </p>
            </>
          }
          meaning={
            <>
              JPEL/64 makes BS 7671 a consensus standard built by industry experts, not a top-down
              regulation. The public consultation process means anyone can submit comments on draft
              amendments. Knowing the structure helps demystify the regs &mdash; they&apos;re
              evidence-based and industry-led, not arbitrary.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Electrician completes apprenticeship under 18th Edition + A1. Five years later A2, A3
              and A4 have all landed. Electrician hasn&apos;t taken any refresher courses,
              hasn&apos;t bought updated BS 7671, hasn&apos;t sat new 2382. Designs an EV charger
              install using outdated TN-C-S guidance; misses AFDD requirements added in A4. Customer
              complaint emerges; investigation reveals work doesn&apos;t meet current standards. CPS
              scheme registration at risk; insurance claim brought.
            </>
          }
          doInstead={
            <>
              Calendar BS 7671 amendments as fixed CPD events. When an amendment lands, book a 1-day
              refresher course in the next 3-6 months and sit the updated 2382 within 12 months.
              Update your BS 7671 copy at each amendment. Most CPS schemes expect QS-named
              individuals to be current within 12 months; schemes audit at annual assessment.
              Don&apos;t treat regs CPD as optional.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              It&apos;s March 2026. BS 7671 A4 has just been published. You&apos;re a JIB Approved
              Electrician and the QS-named individual on your firm&apos;s NICEIC Domestic Installer
              registration. Your firm&apos;s annual NICEIC assessment is due in October. What&apos;s
              your CPD plan for the next 7 months?
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; buy the updated BS 7671</strong>. The Brown Book in A4:2026
              form. About &pound;100-130. Or upgrade your IET online subscription if you have one
              (always-current access).
              <br />
              <br />
              <strong>Step 2 &mdash; read the JPEL/64 list of significant changes</strong>. Free
              download from the IET. Spend 2-3 hours reading; flag anything that directly affects
              your firm&apos;s typical work (AFDDs, TN-C-S handling, schedule columns).
              <br />
              <br />
              <strong>Step 3 &mdash; book a 1-day A4 refresher course</strong>. NICEIC Training,
              NAPIT, JTL, NET, IET Academy, Elec-Mate all run them. Cost &pound;150-300. Aim to
              attend before the end of June 2026.
              <br />
              <br />
              <strong>Step 4 &mdash; sit the updated C&amp;G 2382-26</strong>. Open-book exam, 60
              multiple-choice. Cost &pound;150-250. Aim to pass before the end of September 2026, in
              good time for the October NICEIC assessment.
              <br />
              <br />
              <strong>Step 5 &mdash; update firm processes and templates</strong>. EIC and schedule
              template updates to reflect new column structure. Quote and contract templates to
              reflect AFDD requirements where applicable. Risk assessment templates to reflect
              updated TN-C-S guidance for EV. Brief any other electricians in the firm.
              <br />
              <br />
              <strong>Step 6 &mdash; log all CPD evidence</strong>. CPD log with dates, topics, time
              spent, sources. Bring to the NICEIC assessment in October. Assessor wants to see
              structured A4 currency.
            </>
          }
          whyItMatters={
            <>
              BS 7671 amendments are the most predictable CPD event in your career. They land on a
              known schedule, the CPS schemes expect currency within 12 months, and the cost is
              modest (&pound;400-600 in total). Failing to plan A4 CPD as a fixed compliance event
              puts the firm&apos;s scheme registration at risk and exposes the QS personally. Treat
              amendment CPD as the priority CPD spend of the year it lands.
            </>
          }
        />
        ...
        >
          <p>Amendment timeline (typical):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>JPEL/64 working group</strong> &mdash; drafts proposed changes (12&ndash;24
              months before publication).
            </li>
            <li>
              <strong>DPC (Draft for Public Comment)</strong> &mdash; published 6&ndash;12 months
              before final.
            </li>
            <li>
            ...
            <li>
              <strong>Transition period</strong> &mdash; typically 6&ndash;12 months both versions
              accepted.
            </li>
            <li>
            ...
            <li>
              <strong>Existing installations</strong> &mdash; not retrofit-mandated unless
              safety-critical.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>A4:2026 expected change areas:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>AFDD requirements</strong> &mdash; expanded across more circuit categories in
              higher-risk premises.
            </li>
            <li>
              <strong>TN-C-S / Open-PEN protection</strong> &mdash; clarifications particularly for
              EV installations.
            </li>
            <li>
            ...
            <li>
              <strong>Energy storage systems</strong> &mdash; updated guidance on battery
              installations.
            </li>
            <li>
            ...
            <li>
              <strong>CPD requirement</strong> &mdash; ~&pound;200&ndash;350 update course typically
              required.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>BS 7671 access formats:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Physical book (Big Yellow Book)</strong> &mdash; ~&pound;65&ndash;90,
              essential for study + certification.
            </li>
            <li>
              <strong>IET digital PDF</strong> &mdash; ~&pound;80/yr subscription, includes
              amendments.
            </li>
            <li>
              <strong>IET 18th Edition app</strong> &mdash; iOS/Android, ~&pound;40&ndash;60
              one-off, offline access.
            </li>
            <li>
              <strong>On Site Guide (OSG)</strong> &mdash; ~&pound;30, simplified domestic-focused
              reference.
            </li>
            <li>
              <strong>Guidance Notes</strong> &mdash; GN1-GN8 series, ~&pound;30&ndash;60 each,
            ...
            <li>
              ...
              &mdash; ~&pound;65, specialist reference.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Amendment CPD planning checklist (per amendment cycle):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DPC stage</strong> &mdash; read the draft, identify changes affecting your
              work.
            </li>
            <li>
              <strong>Pre-publication</strong> &mdash; book a place on a 1-day update course early
              (avoid post-publication rush).
            </li>
            <li>
              <strong>Publication month</strong> &mdash; buy the new book, update digital
              subscriptions/apps.
            </li>
            <li>
            ...
            <li>
              <strong>Working practice integration</strong> &mdash; update your certificate
              templates, design defaults, install checklists.
            </li>
            <li>
              <strong>CPD record</strong> &mdash; log course attendance and study hours for scheme
              audit.
            </li>
            <li>
        ...
        >
          <p>Transitional certificate practices:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pre-publication</strong> &mdash; clear in-progress jobs onto current-amendment
              certificates.
            </li>
            <li>
            ...
            <li>
              <strong>Existing certificates</strong> &mdash; remain valid for their lifetime (5yr
              typical).
            </li>
            <li>
