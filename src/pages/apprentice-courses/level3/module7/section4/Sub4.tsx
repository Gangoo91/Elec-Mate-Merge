...
const checks = [
  ...
  },
  {
    ...
    question: "What's the Lighthouse Construction Industry Charity helpline number?",
    options: [
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 4 · Subsection 4"
        title="Beyond the toolbox — industry charities + welfare"
        backTo="/study-centre/apprentice/level3-module7-section4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          EIC, Lighthouse, Mates in Mind, Mind, Samaritans — UK industry welfare and mental health
          charities. What they offer, how to access support, looking after yourself and colleagues.
        </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                24/7 helpline 0345 605 1956. Financial grants, mental health support, bereavement
                counselling, addiction support, debt advice. Free smartphone app.
                lighthouseclub.org.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Sector-specific welfare. 0800 652 1618. Hardship grants, mental health support,
                family services, bereavement support. Funded by industry donations.
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Construction mental health awareness. Mental Health First Aider training, workplace
                toolkits, awareness campaigns, signposting. matesinmind.org.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
        ...
        >
          <p>Why structural factors matter for construction mental health:</p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The Equality Act 2010 protects against discrimination on the basis of protected
                characteristics including disability. Mental health conditions can be a disability
                under the Act if they have a substantial and long-term adverse effect on the
                person&apos;s ability to carry out normal day-to-day activities. Headline
                implications:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                  Reasonable adjustments duty &mdash; employer must make reasonable adjustments for
                  disabled employees including those with mental health conditions.
                </li>
                <li>
                  Direct discrimination prohibited &mdash; treating someone less favourably because
                  of mental health-related disability.
                </li>
                <li>
                  Indirect discrimination prohibited &mdash; applying a provision that puts disabled
                  persons at a particular disadvantage without justification.
                </li>
              </ul>
            </>
          }
          meaning={
            <>
              Mental health conditions causing substantial long-term effects are protected under the
              Equality Act. As an employee or apprentice you have legal protection from
              discrimination and a right to reasonable adjustments. As an employer you have
              corresponding obligations. Open conversations about mental health are easier when both
              sides understand the legal context isn&apos;t hostile.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                ...
                practicable, the health, safety and welfare of all employees. The duty extends to
                mental health as well as physical health. Practical implications:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                  Risk assessment to consider mental health hazards (workload, stress, isolation).
                </li>
          ...
          meaning={
            <>
              HASAWA covers mental health as well as physical health. HSE expects employers to take
              mental health into account in risk assessments and workplace welfare. The MHFA
              movement and welfare charities are part of how the sector discharges this duty. As an
              employee or apprentice you have a right to a workplace that takes mental health
              seriously.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Working Time Regulations exist partly because excessive hours damage mental and
              physical health. JIB-graded contracts typically improve on the statutory minimum.
              Self-employed practitioners are not covered by WTR but the principles still apply
              &mdash; chronic overwork is a major mental health risk factor. Manage your own hours
              sustainably.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice or improver experiences gradual decline &mdash; sleep getting worse, mood
              low, withdrawing from social activities, drinking more. Doesn&apos;t recognise the
              pattern as mental health difficulty; treats it as personal weakness or just a bad
              period. Months pass. Eventually a crisis point hits &mdash; relationship breakdown,
              job loss, suicidal thoughts. Reaches out at this point but the crisis is harder to
              resolve than the early-warning signs would have been.
            </>
          }
          doInstead={
            <>
              Reach out early. The helplines and charities are there for any difficulty, not just
              crisis. A 30-minute call to Samaritans (116 123) when you&apos;re struggling but
              functioning is healthier than a 30-second call when you&apos;re in crisis. Talk to
              your GP early about persistent low mood, sleep problems or anxiety &mdash; many UK GPs
              are now well-equipped to signpost or prescribe early intervention. Notice your
              patterns; act on them.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;ve worked alongside Phil for two years on a JIB-graded contractor site. Last
              few weeks Phil has seemed quieter than usual, taking more sick days, snapping at small
              things, not joining in lunch conversations. Last Friday he made a passing comment
              about &quot;sometimes wondering if it&apos;s worth it&quot;. You&apos;re not sure if
              he meant work or something more. What do you do?
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; pick a moment</strong>. Wait for a quiet moment (Friday
              end-of-day works for many people; a Monday-morning canteen sit-down also works).
              Don&apos;t make it a big formal sit-down &mdash; that can feel threatening. &quot;Cup
              of tea after this job?&quot; or similar.
              <br />
              <br />
              <strong>Step 2 &mdash; mention what you&apos;ve noticed</strong>. Be specific and
              non-judgemental. &quot;I&apos;ve noticed you&apos;ve seemed a bit quieter the last few
              weeks. How are things really?&quot; Don&apos;t try to diagnose; just open the door.
              <br />
              <br />
              <strong>Step 3 &mdash; listen</strong>. If Phil opens up, listen without trying to
              fix. Don&apos;t interrupt. Don&apos;t offer advice unless asked. Just hear what
              he&apos;s actually saying. The simple act of being heard is often more valuable than
              any advice you could offer.
              <br />
              <br />
              <strong>Step 4 &mdash; signpost</strong>. Mention the helplines casually:
              &quot;Lighthouse have a 24/7 helpline if you ever want to talk to someone outside work
              &mdash; 0345 605 1956. Samaritans 116 123 too.&quot; Don&apos;t push him to call; just
              make sure he knows the numbers exist.
              <br />
              <br />
              <strong>Step 5 &mdash; check back next week</strong>. The most important thing is
              consistency. Check in casually next week (&quot;how was your weekend?&quot;); the week
              after; the week after. Persistent care over time is what makes the difference.
              <br />
              <br />
              <strong>Step 6 &mdash; if you genuinely worry about immediate safety</strong>. If Phil
              mentions suicidal thoughts directly, take it seriously. Encourage him to call
              Samaritans (116 123) right then. If you have genuine concern about immediate risk,
              calling 999 or the GP for an urgent appointment is appropriate. Better to over-respond
              than under-respond when life is potentially at risk.
            </>
          }
          whyItMatters={
            <>
              The construction industry has lost too many colleagues to mental health crisis. The
              cultural shift toward open conversation, MHFA training, and visible signposting to
              helplines has saved lives. Being the colleague who notices and quietly checks in
              &mdash; without making a fuss &mdash; is one of the most valuable things you can do.
              You don&apos;t have to be a counsellor; you just have to care enough to ask. Pass the
              helpline numbers to anyone who might need them.
            </>
          }
        />
        ...
        >
          <p>Lighthouse services and access:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Construction Industry Helpline</strong> &mdash; 0345 605 1956, 24/7, free,
              confidential.
            </li>
            <li>
            ...
            <li>
              <strong>Hardship grants</strong> &mdash; emergency financial support, typically
              &pound;250&ndash;1,500.
            </li>
            <li>
              <strong>Mental health crisis support</strong> &mdash; immediate access to trained
              advisers.
            </li>
            <li>
            ...
            <li>
              <strong>Lighthouse Beacon</strong> &mdash; community awareness, on-site mental health
              events.
            </li>
            <li>
              <strong>Funded by industry donations</strong> &mdash; not Government, free at point of
              use.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Family support</strong> &mdash; for partners and children of electrical
              workers.
            </li>
            <li>
            ...
            <li>
              <strong>Apprentice support</strong> &mdash; specific programmes for apprentices in
              difficulty.
            </li>
            <li>
              <strong>Retired worker support</strong> &mdash; for former electrical industry
              workers.
            </li>
            <li>
        ...
        >
          <p>Mates in Mind training stack:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>MHFA (Mental Health First Aid)</strong> &mdash; 2-day full certification,
              ~&pound;300.
            </li>
            <li>
            ...
            <li>
              <strong>Awareness campaigns</strong> &mdash; visible signposting (green hat sticker,
              posters, screensavers).
            </li>
            <li>
              <strong>Industry partnerships</strong> &mdash; integrated with main contractor
              inductions.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>UK mental health support contacts:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lighthouse Helpline</strong> &mdash; 0345 605 1956, 24/7,
            ...
            <li>
              <strong>Mind</strong> &mdash; 0300 123 3393, weekdays 9&ndash;6, advice and
              information.
            </li>
            <li>
            ...
            <li>
              <strong>CALM (Campaign Against Living Miserably)</strong> &mdash; 0800 58 58 58, men's
              mental health, 5pm&ndash;midnight.
            </li>
            <li>
        ...
        >
          <p>The supervisor's mental health checklist:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Notice</strong> &mdash; behaviour changes, isolation, work quality dip,
              absence patterns.
            </li>
            <li>
            ...
            <li>
              <strong>Signpost</strong> &mdash; Lighthouse 0345 605 1956, Samaritans 116 123, GP,
              MHFA.
            </li>
            <li>
            ...
            <li>
              <strong>Confidentiality</strong> &mdash; respect it absolutely; it's the trust that
