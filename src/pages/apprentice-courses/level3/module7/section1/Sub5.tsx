...
const checks = [
  {
    ...
    question: "What's Unite the Union's role in the electrical industry?",
    options: [
  ...
  },
  {
    ...
    question: 'Can your employer prevent you from joining a trade union?',
    options: [
  ...
  },
  {
    ...
    question: 'Are most UK electricians union members?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'If my firm is non-JIB and pays below JIB rates, can the union force the employer to pay JIB?',
    answer:
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 1 · Subsection 5"
        title="Trade union landscape"
        backTo="/study-centre/apprentice/level3-module7-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Unite the Union, GMB, the JIB pay framework, what trade unions do for an electrician, the
          right to join, and how union density varies across the UK electrical industry.
        </p>
        ...
        >
          <p>What Unite delivers for electrical-trade members:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Health and safety representation under the Safety Reps and Safety Committees
              Regulations 1977.
            </li>
        ...
        >
          <p>The UK union landscape touching electrical work:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Prospect</strong> &mdash; engineering professionals and managers (smaller
              electrical presence).
            </li>
            <li>
              <strong>UNISON</strong> &mdash; public-sector workers including some local authority
              electricians.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Headline TULRCA 1992 protections:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>s.137</strong> &mdash; refusal of employment on grounds related to union
            ...
            <li>
              <strong>s.152</strong> &mdash; dismissal because of union membership or activities is
              automatically unfair.
            </li>
            <li>
              <strong>s.168-170</strong> &mdash; right to paid time off for union officials to carry
              out reasonable union duties.
            </li>
            <li>
              <strong>s.226</strong> onward &mdash; lawful industrial action requires a ballot
              meeting statutory turnout and majority thresholds.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The annual JIB rate negotiation typically covers:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          <p>When to talk to the shop steward (member or not):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Pay seems wrong (Stage rate not applied, overtime not paid, JIB rate not tracked).
            </li>
            <li>Health and safety concern not being addressed by line management.</li>
            <li>Workplace dispute (bullying, harassment, unfair treatment).</li>
            <li>Disciplinary or dismissal procedure being initiated against you.</li>
            <li>
              Apprenticeship-related issue (mentor not signing portfolio, off-the-job training time
              not being given, Stage progression blocked).
            </li>
            <li>Anti-union discrimination (member or potential member).</li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              place for the sole or main purpose of &mdash; (a) preventing or deterring him from
              being or seeking to become a member of an independent trade union, or penalising him
              for doing so, [or] (b) preventing or deterring him from taking part in the activities
              of an independent trade union ...&quot;
            </>
          }
          meaning={
            <>
              If your employer treats you less favourably (denies promotion, allocates the worst
              jobs, applies more scrutiny) because you joined or supported a union, that&apos;s
              detriment under s.146. The remedy is an Employment Tribunal claim (with ACAS
              conciliation as the typical first step). Detriment claims have generous time limits
              relative to other employment claims because the pattern often takes time to recognise.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;An employer shall permit an employee of his who is an official of an independent
              trade union recognised by the employer to take time off during his working hours for
              the purpose of carrying out any duties of his, as such an official, concerned with
              negotiations with the employer related to or connected with [collective bargaining
              matters]; [or] the performance on behalf of employees of the employer of functions
              related to or connected with [collective bargaining matters].&quot;
            </>
          }
          meaning={
            <>
              Shop stewards and other union officials have a statutory right to paid time off to
              carry out reasonable union duties relating to collective bargaining. This is the legal
              basis that keeps shop stewards available on site as a practical workplace resource. As
              an apprentice you may benefit from the shop steward&apos;s availability even if
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The ACAS Code of Practice on Disciplinary and Grievance Procedures sets the expected
                standard for how UK employers handle workplace issues. Headline expectations
                include:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>Establish facts before taking action (investigation).</li>
                <li>
                  Give the employee written details of the concerns and a reasonable opportunity to
                  respond.
                </li>
                <li>
                  Allow the employee to be accompanied at formal disciplinary or grievance meetings
                  by a colleague or trade union representative.
                </li>
                <li>Provide a written outcome and a right of appeal.</li>
                <li>Follow procedures consistently and fairly.</li>
              </ul>
            </>
          }
          meaning={
            <>
              The right to be accompanied at disciplinary or grievance meetings by a trade union
              representative is statutory under the Employment Relations Act 1999 s.10. You
              don&apos;t have to be a union member to bring a colleague, but only union officials
              can act in the formal &quot;representative&quot; capacity (questioning witnesses,
              presenting your case). For serious disciplinary or grievance hearings union
              representation is the standard workplace protection &mdash; another reason members
              value membership.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice joins Unite quietly, doesn&apos;t mention it. Six months later a line
              manager makes a casual comment (&quot;you&apos;re not in the union are you?&quot;) and
              the apprentice freezes &mdash; lies, says no. The lie eats at them; they worry about
              being found out. Eventually the truth surfaces (Unite rep mentions them in a meeting).
              Apprentice now has to explain the inconsistency to a line manager who feels misled.
            </>
          }
          doInstead={
            <>
              Membership is your private business and you don&apos;t have to disclose it &mdash; but
              if asked directly, don&apos;t lie. A simple &quot;that&apos;s a personal matter, not
              really one I want to discuss at work&quot; is a fine answer that protects your privacy
              without dishonesty. If your employer pressures you on the question itself, that&apos;s
              evidence of anti-union attitudes and worth flagging to ACAS or the Unite rep.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You work for a JIB-graded contractor. Last month the firm announced unilaterally that
              it was cutting weekend overtime rates from time-and-a-half to time-and-a-quarter,
              citing &quot;commercial pressures&quot;. Several colleagues including you are unhappy
              &mdash; the JIB Working Rule Agreement specifies time-and-a-half. The firm is claiming
              the JIB WRA doesn&apos;t apply to overtime premiums. The Unite shop steward is
              preparing a response.
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; check the JIB Working Rule Agreement</strong>. The shop steward
              will pull the current WRA and identify the specific clause on overtime premiums. If
              the WRA specifies time-and-a-half for weekend overtime, the firm is in breach of the
              JIB-graded contract.
              <br />
              <br />
              <strong>Step 2 &mdash; collective grievance</strong>. The shop steward organises a
              collective grievance under the firm&apos;s grievance procedure. Multiple workers
              signing the grievance carries more weight than individual grievances. The grievance
              cites the WRA breach and asks for restoration of the time-and-a-half rate.
              <br />
              <br />
              <strong>Step 3 &mdash; escalate to JIB if needed</strong>. JIB-graded employers are
              bound to follow the WRA. If the firm refuses the grievance, the shop steward can
              escalate to the JIB national office for adjudication. JIB has dispute-resolution
              processes for WRA breaches; firms found in breach can lose JIB-graded status.
              <br />
              <br />
              <strong>Step 4 &mdash; ACAS conciliation if it gets to legal</strong>. If the
              grievance is rejected and the firm holds firm, the union can support affected members
              in unlawful deduction from wages claims at Employment Tribunal. ACAS conciliation is
              the typical first step.
              <br />
              <br />
              <strong>Step 5 &mdash; document everything</strong>. Throughout the process everything
              goes in writing. Email notifying you of the rate change; copies of payslips before and
              after; the JIB WRA clause cited; the grievance and response. The paper trail is what
              wins (or loses) the dispute.
            </>
          }
          whyItMatters={
            <>
              Unilateral changes to JIB-graded contract terms are exactly what collective bargaining
              and union representation are designed to push back on. Without a shop steward and a
              union channel, individual workers facing a unilateral pay cut would have to challenge
              it alone &mdash; risky and rare. Collective action via the union turns it into a
              procedural dispute that the firm has to take seriously. This is the practical case for
              union membership in one example.
            </>
          }
        />
        ...
        >
          <p>The annual JIB pay-round timeline:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Autumn</strong> &mdash; Unite and ECA table opening positions.
            </li>
            <li>
              <strong>Negotiation rounds</strong> &mdash; multiple meetings, sometimes facilitated
              by JIB.
            </li>
            <li>
            ...
            <li>
              <strong>Backdating</strong> &mdash; settlement may include a backdated element if
              late.
            </li>
            <li>
              <strong>Disputes</strong> &mdash; rare; would trigger formal JIB conciliation
              procedure.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Shop steward role and rights (Unite typical model):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Election</strong> &mdash; by union members at the workplace, typically annual.
            </li>
            <li>
              <strong>Statutory right to paid time off</strong> &mdash; TULRCA s.168 for reasonable
              union duties.
            </li>
            <li>
              <strong>Representation</strong> &mdash; accompany members at disciplinary, grievance,
              JIB hearings.
            </li>
            <li>
            ...
            <li>
              <strong>Training</strong> &mdash; Unite-funded shop steward training (typically 5
              days/yr).
            </li>
            <li>
              <strong>Protection</strong> &mdash; TULRCA protects against detriment for steward
              duties.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Typical Unite member benefit stack:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Employment tribunal representation</strong> &mdash; at no extra cost for
              members.
            </li>
            <li>
              <strong>JIB grading and disputes</strong> &mdash; member-level support through JIB
              processes.
            </li>
            <li>
              <strong>Education and training</strong> &mdash; TUC-aligned programmes plus
              union-funded short courses.
            </li>
            <li>
              <strong>Welfare signposting</strong> &mdash; links to Lighthouse Club, EIC, Mates in
              Mind.
            </li>
            <li>
              <strong>Discounted services</strong> &mdash; member rates on insurance, mortgages,
              holidays.
            </li>
          </ul>
        </ConceptBlock>
