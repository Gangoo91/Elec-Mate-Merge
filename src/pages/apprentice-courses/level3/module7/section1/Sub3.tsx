...
const checks = [
  {
    ...
    options: [
      'It is your formal qualification certificate — the document that proves you have passed the AM2 and the C&G 2365. The card itself is the awarding-body certificate, and without it you cannot prove to an employer that you hold the underlying electrical qualifications.',
      'It is a tax document issued by HMRC that records your CIS status and confirms tax is deducted at source. Main contractors check the card to confirm your payment status before paying invoices, and without it you cannot be paid for sub-contract work on a commercial site.',
      ...
      'It is your trade union membership card, confirming you are a paid-up member of Unite and entitled to representation. Main contractors require it because JIB-graded sites are union-only, and without it you cannot be employed on a collectively-bargained contract.',
    ],
    correctIndex: 2,
    explanation:
  ...
  {
    id: 'mod7-s1-sub3-hsa',
    question: "What's the ECS Health and Safety Assessment and how often do you need to take it?",
    options: [
      ...
      'A practical on-site assessment where an ECS assessor watches you carry out a live job and signs off your safe working. It is taken once at the start of your career and never repeated, because it permanently records your practical competence on the ECS register.',
      'A written portfolio of risk assessments and method statements you submit to JIB, marked by an examiner against the HASAWA framework. It is valid for the five-year life of the ECS card and is renewed at the same time as the card itself, in a single combined process.',
      'An annual classroom course run by your employer covering site safety, after which the employer issues an internal certificate. There is no central test or pass mark; the requirement is simply that the employer keeps a record of attendance for HSE inspection.',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    question: "What are 'endorsements' on the ECS card and why do they matter?",
    options: [
      'Endorsements are temporary site passes issued by a main contractor that allow you onto one specific project, recorded on the back of your ECS card. They expire when the project ends and have to be re-issued for each new site you work on, separate from your underlying competence.',
      ...
      'Endorsements are written references from previous employers, added to the ECS register, that vouch for the quality of your work. Main contractors read them when deciding whether to engage you, and a card with more endorsements signals a more experienced and reliable electrician.',
      'Endorsements are penalty markers placed on a card by JIB when an electrician has a safety incident or a disciplinary finding against them, similar to points on a driving licence. A card carrying endorsements may be refused at site entry until the marker is cleared.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'The HSE (Health and Safety Executive) operates the Electrotechnical Certification Scheme as a Government safety body. ECS is a statutory licensing scheme run directly by the regulator, and the HSE processes card applications, holds the register and sets the H&S assessment standard.',
      ...
      'NICEIC operates the Electrotechnical Certification Scheme as part of its competent-person scheme. ECS cards are issued automatically to electricians whose firms are NICEIC-registered, and NICEIC holds the register, sets the H&S standard and renews the cards through its assessment process.',
      'The IET (Institution of Engineering and Technology) operates the Electrotechnical Certification Scheme as the publisher of BS 7671. Because the IET writes the Wiring Regulations, it runs the competence card scheme, processes applications and holds the public register of card-holders.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Your photo, National Insurance number, home address, date of birth and bank sort code, so payroll can pay you directly from the card details. The card doubles as a payroll record, which is why it is scanned at the gate on commercial sites.',
      "Your photo, your employer's company name and registration number, the project address and the contract value, so the main contractor can verify which firm you belong to. The card is tied to a specific employer and is re-issued whenever you change firms.",
      ...
      'Your photo, a full list of every job you have worked on, the dates you attended each one, and a running tally of hours worked, so a main contractor can see your complete work history at the gate. The card builds up a permanent log over your career.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It does not expire — once issued, an ECS card is valid for life and never needs renewing. Only the H&S assessment behind it has to be kept current; the physical card itself is a permanent record of your grade and qualifications.',
      'Ten years from issue, matching the typical re-issue cycle of a UK passport. Renewal at the ten-year point requires a fresh photo and a current H&S assessment, but no qualification evidence because your grade is already on the register.',
      'One year from issue. The card must be renewed annually, in line with the annual JIB pay round, because pay grades change each year. Renewal requires only proof of continued employment, processed automatically by your employer.',
  ...
  },
  {
    ...
    options: [
      ...
      'A note on the card confirming you are insured to work at height on domestic roofs, gained by completing a PASMA or IPAF course. It is required for solar work because installs are on roofs, but it covers the access method rather than the electrical PV competence itself.',
      "A marker showing you have completed the DNO's G98 / G99 application training and may submit grid-connection applications for PV systems. It is an administrative endorsement about paperwork, separate from the practical competence to design and install the array.",
      "A confirmation that your employer is MCS-registered for solar PV, printed on every employee's card. The endorsement belongs to the firm rather than the individual, so it appears identically on the cards of everyone the firm employs, qualified or not.",
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      "CompEx (Competency in Complex Examinations) is the JIB practical re-assessment taken every five years to keep the AM2 current. Passing it confirms your core installation competence remains up to standard and earns a 're-validated' marker on your ECS card; it is unrelated to any one specialism.",
      ...
      'CompEx (Competency in EV and PV Examinations) is the combined renewables scheme covering EV charging and solar PV in one qualification. Holding it earns you a combined Renewables endorsement on your ECS card and lets you work on both MCS EV and MCS PV installs under a single registration.',
      'CompEx (Competency in Project Execution) is the management qualification for electricians moving into Project Engineer and Contracts Manager roles. It covers programme, procurement and QA, and earns a Supervisory endorsement on the ECS card needed before a firm will appoint you to run a project.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To collect a commission from JIB for every card-holder they admit to site. Main contractors are paid a small fee by the scheme for checking cards at the gate, which is why ECS card checks have become near-universal on commercial projects.',
      'Because their insurance policy is void unless every worker on site holds a current ECS card. Insurers mandate the card as a condition of the policy, so a main contractor who admitted a non-card-holder would lose all cover for the whole site.',
      ...
      'Because the JIB Working Rule Agreement makes ECS card checks a legal requirement on every construction site in the UK. The card is a statutory site-entry document, and a main contractor who failed to check it would be committing a criminal offence under the WRA.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "First-issue ECS card typically £300-400, with three-yearly renewal at a similar level. The high cost reflects the assessor's on-site visit included in the application. The H&S assessment is bundled into this fee at no extra cost. Employers rarely pay because the cost is treated as a personal qualification.",
      'The ECS card is free at first issue and on renewal — JIB funds it from main-contractor membership fees, so the only cost an electrician ever meets is the specialist course fees behind any endorsements. There is no charge for the card itself or the H&S assessment.',
      'First-issue ECS card typically £150-200, with an annual renewal fee of the same amount because the card is renewed yearly. The H&S assessment is a separate £100 charge each time. Specialist endorsements are free once the underlying course is passed.',
  ...
  },
  {
    ...
    options: [
      ...
      'Re-sit the full ECS H&S assessment and re-submit your qualification certificates, because a lost card voids your registration entirely and the scheme treats it as a fresh first-issue application. There is no replacement route; the card has to be earned again from scratch.',
      'Nothing needs doing — your ECS record lives on the public register, so a lost physical card has no effect on your site access. Site security simply looks you up by name on the register, and the plastic card is only a convenience, never a requirement.',
      'Report it to the HSE and the police, who issue an emergency interim permit valid for 28 days. The HSE administers card replacements because ECS is a statutory scheme, and you cannot work on any site until their interim permit is in hand.',
    ],
    correctAnswer: 0,
    explanation:
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 1 · Subsection 3"
        title="ECS card requirements + employer expectations"
        backTo="/study-centre/apprentice/level3-module7-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The ECS card — what it is, the H&S assessment, specialist endorsements (PV, EV, Hazardous
          Areas), how to apply, and what employers and main contractors expect on UK sites.
        </p>
        ...
        >
          <p>What appears on the card:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Photo</li>
            <li>Full name</li>
            <li>
              Formal JIB grade (Apprentice / Adult Trainee / Electrician / Approved / Technician)
            </li>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                AM2S is the Solar PV variant of AM2. Required by MCS-registered PV installers for
                staff working on grid-tied PV. Course + practical assessment around &pound;400-600.
                Endorsement valid as part of card.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                BPEC or City &amp; Guilds EV charging course (typically 2 days). Required by
                OZEV-grant-eligible installers and increasingly by main contractors on
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                ...
                offshore, fuel storage, paint shop work. 5-day course around &pound;1,000-1,500. Day
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                ...
                recognition. Required for BAFE-registered fire alarm work; typical entry point for
                fire specialism.
              </p>
            </div>
          </div>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                CDM 2015 requires the Principal Contractor (PC) and Principal Designer (PD) to
                ensure that the people working on a project have the skills, knowledge, training and
                experience to carry out the work in a way that secures health and safety.
              </p>
              <p>
                In practice the PC discharges this duty by checking competence cards at site entry
                &mdash; ECS for electrical workers, CSCS for other trades.
              </p>
            </>
          }
          meaning={
            <>
              The ECS card is the industry-recognised competence card for electrical work under CDM
              2015. The PC&apos;s duty to check competence is what drives the site-entry card check.
              Without an ECS card the PC has no audit trail that they checked your competence
              &mdash; so they refuse entry. The card is the workable bridge between your individual
              competence and the PC&apos;s regulatory duty.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;The matters to which that duty extends include in particular &mdash; (c) the
          ...
          meaning={
            <>
              HASAWA s.2(2)(c) is the explicit training duty on the Employer. Funding the ECS
              H&amp;S assessment, the AM2S, the CompEx or the BAFE training is part of discharging
              this duty &mdash; particularly when the firm is moving into a new specialism that
              requires staff to upskill. Apprentices and pre-AM2 staff should expect the employer to
              fund baseline ECS card and H&amp;S assessment costs; specialist endorsements often sit
              somewhere between employer-funded and self-funded by negotiation.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>Card valid 5 years from issue.</li>
                <li>ECS Health &amp; Safety Assessment valid 3 years from pass date.</li>
                <li>
                  Card renewal requires a current ECS H&amp;S assessment pass (within its 3-year
                  validity) and current employment / qualification evidence.
                </li>
                <li>
                  Specialist endorsements require evidence of the underlying training and (where
                  applicable) experience.
                </li>
                <li>
                  Card holder must notify JIB of changes of name, employer or qualifications during
                  the card&apos;s validity.
                </li>
                <li>
                  Lost or stolen cards can be replaced for an admin fee on application through the
                  JIB ECS portal.
                </li>
              </ul>
            </>
          ...
          meaning={
            <>
              The ECS rules are administered by JIB and the public ECS register at jib.org.uk is the
              authoritative source of card status. The rules are not statute &mdash; they&apos;re
              scheme rules &mdash; but they&apos;re the practical floor of card management and are
              accepted across the UK industry as the standard. Treat the renewal calendar seriously;
              expired cards mean immediate site lock-out.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice or electrician forgets when their ECS H&amp;S assessment expires. Three
              years pass quietly. The H&amp;S Assessment lapses; even though the ECS card itself
              runs to 5 years, the card renewal application (or the card&apos;s continued validity)
              gets blocked because a valid H&amp;S Assessment is a required condition. Cards
              effectively lock out on a Monday morning; the next site visit on Tuesday ends with a
              polite turn-around at the gate. Two weeks of lost work while the H&amp;S Assessment is
              rebooked, taken, passed, and the new card produced.
            </>
          }
          doInstead={
            <>
              Calendar the H&amp;S Assessment renewal at month 30 of its 3-year validity &mdash; six
              months of buffer before the H&amp;S pass would expire. Separately, calendar the ECS
              card renewal at year 4.5 of its 5-year validity. If you fail the H&amp;S test first
              try, you&apos;ve still got time to rebook and pass before anything lapses. Set phone
              reminders; don&apos;t rely on JIB email reminders alone &mdash; they sometimes go to
              spam.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re due on a new commercial site at 7:30am tomorrow. You&apos;re packing your
              tools tonight and check your ECS card &mdash; it expired yesterday. Your H&amp;S
              assessment lapsed two months ago. The site induction rules require a current ECS card
              for entry. You&apos;ve got one evening to fix this before you&apos;d normally be on
              site.
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; phone the main contractor&apos;s site manager tonight</strong>.
              Be honest. Don&apos;t turn up tomorrow expecting to bluff it. The site manager will
              appreciate the heads-up and may agree a short grace period (sometimes 24-48 hours) if
              you commit to fixing it within that window.
              <br />
              <br />
              <strong>Step 2 &mdash; book the ECS H&amp;S assessment for the earliest slot</strong>.
              Most testing centres have walk-in or next-day slots. JIB ECS Approved Centres
              (typically CITB-approved test centres) are the providers. Book online tonight if
              possible.
              <br />
              <br />
              <strong>Step 3 &mdash; revise tonight</strong>. JIB publishes a revision booklet free
              at jib.org.uk; the CITB H&amp;S app is also widely used. Two hours of focused revision
              &mdash; HASAWA, CDM, manual handling weights, PPE vs RPE, working at height &mdash;
              will get most people to 80%.
              <br />
              <br />
              <strong>
                Step 4 &mdash; pass the test, then submit the ECS card renewal same day
              </strong>
              . Renewal is processed through the JIB ECS portal once the H&amp;S pass is recorded.
              Expedited card production is sometimes available for an extra fee. Get a temporary
              letter of confirmation from JIB while the physical card is in production.
              <br />
              <br />
              <strong>Step 5 &mdash; learn from it</strong>. Calendar the next H&amp;S assessment
              for month 30. Better still, set two reminders &mdash; one at month 28, one at month
              30. Don&apos;t rely on memory or on JIB email reminders.
            </>
          }
          whyItMatters={
            <>
              Lost site days are lost income and lost employer trust. A first incident might be
              forgiven; a second pattern of letting cards lapse will damage your reputation with
              both your direct employer and the main contractors who run the sites you visit. The
              card renewal cycle is one of the few things in the trade that&apos;s genuinely under
              your control &mdash; treat it as a personal-admin priority.
            </>
          }
        />
        ...
        >
          <p>Common ECS endorsements and what they unlock:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Solar PV</strong> &mdash; AM2S or BPEC PV, opens MCS PV install work.
            </li>
            <li>
              <strong>EV Charging</strong> &mdash; C&amp;G 2919 / 2921 or BPEC EV, opens MCS EV and
              OZEV-grant work.
            </li>
            <li>
              <strong>Hazardous Areas (CompEx)</strong> &mdash; CompEx Ex01-Ex04, opens
              petrochemical, pharma, offshore.
            </li>
            <li>
              <strong>Fire Detection (FIA Unit)</strong> &mdash; FIA Unit 1&ndash;5 stack, opens BS
              5839 commissioning.
            </li>
            <li>
              <strong>Data Cabling</strong> &mdash; BICSI Installer or vendor (CommScope, Panduit,
              Excel), opens structured-cabling work.
            </li>
            <li>
              <strong>Rail PTS</strong> &mdash; Network Rail Personal Track Safety, opens UK rail
              projects.
            </li>
            <li>
              <strong>Heat Pump</strong> &mdash; LCL HP / MCS HP, opens MCS heat-pump install work
              and BUS grant access.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>A typical electrician's renewal calendar:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>ECS card</strong> &mdash; 5yr cycle from issue.
            </li>
            <li>
              <strong>ECS H&amp;S assessment</strong> &mdash; required for card validity, accepted
              equivalents (CITB CSCS test) recognised.
            </li>
            <li>
            ...
            <li>
              <strong>BS 7671 amendment</strong> &mdash; CPD on each new amendment (currently
              A4:2026 incoming).
            </li>
            <li>
            ...
            <li>
              <strong>MCS scheme assessment</strong> &mdash; annual (if you carry MCS endorsements
              through your firm).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>ECS Manager / Smart Check practical use:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Download</strong> &mdash; ECS Manager on iOS or Android, free.
            </li>
            <li>
              <strong>Link your record</strong> &mdash; using your JIB-registered email and ECS card
              number.
            </li>
            <li>
              <strong>Smart Check QR</strong> &mdash; live verification that your card is current;
              site gate-keepers scan it.
            </li>
            <li>
              <strong>Renewal alerts</strong> &mdash; in-app push notifications 90/60/30 days before
              expiry.
            </li>
            <li>
              <strong>Endorsement updates</strong> &mdash; new endorsements added by JIB show in-app
              within 1 working day of processing.
            </li>
          </ul>
        </ConceptBlock>
