...
const checks = [
  {
    ...
    options: [
      ...
      "The main contractor self-delivers all trades in-house — electrical, mechanical, fire, lifts — using its own directly-employed workforce, while the electrical sub-contractor is simply the name given to the main contractor's own electrical department once it reaches a certain headcount. On UK commercial projects the two terms describe the same firm at different stages of the job.",
      'The main contractor is appointed by the electrical sub-contractor to handle the non-electrical trades the electrical firm cannot self-deliver — groundworks, brickwork, plastering — so the electrical firm carries the head contract and sub-lets everything else. Most UK electrical apprentices therefore work for the main contractor, who sits above the trade packages.',
      'The main contractor and the electrical sub-contractor both hold separate direct contracts with the client and answer to the client independently, co-ordinating between themselves informally on site. Neither is responsible to the other; the client manages the interface between the two and resolves any clashes over programme and routing directly.',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "The client's own in-house facilities team, regardless of procurement route. On both traditional and D&B contracts the building owner retains a permanent engineering department that produces the full electrical design, and the sub-contractor simply installs to the client's drawings without ever carrying design responsibility of its own.",
      "The main contractor's site management team. On D&B projects the Site Manager and Project Manager produce the electrical design between site meetings, because they hold the head contract; the electrical sub-contractor receives a finished drawing pack and is never expected to design any part of the installation.",
      'Building Control at the local authority. On D&B the design is submitted to and developed by the LABC surveyor before work starts, who issues the approved electrical layout; the sub-contractor installs strictly to the Building-Control-issued design and carries no design liability.',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Groundworks, brickwork, steel framing, roofing and external cladding — the structural shell trades that build the fabric of the building before any services go in. 'Building services engineering' is the umbrella term for these structural disciplines, which the electrical sub-contractor coordinates with before first fix.",
      "Architecture, quantity surveying, planning consultancy and building control — the professional design and approval disciplines. These advisory roles together form 'building services engineering', and the electrician works alongside them at the design and sign-off stages rather than on site.",
      ...
      "Estimating, procurement, contracts management and site supervision — the commercial and management functions inside a contracting firm. 'Building services engineering' describes this office-side group, and on site the electrician coordinates with them rather than with other installation trades.",
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      "'Maintenance and Engineering' — the team responsible for keeping a building's plant running after handover, covering reactive repairs and planned maintenance. The M&E sub-contractor is the firm a building owner retains to service the systems once the construction project is complete.",
      ...
      "'Measurement and Estimating' — the commercial process of pricing a construction package from drawings and a bill of quantities. The M&E sub-contractor is the quantity-surveying firm that produces the tender price for the electrical and mechanical works.",
      "'Materials and Equipment' — the procurement category covering everything bought in for a project, from cable and containment to switchgear and luminaires. The M&E sub-contractor is the buyer who sources and supplies these items to the trades on site.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The most senior tradesperson on the gang, leading first-line supervision of a small group of electricians on the tools. The Project Engineer is essentially a working Charge Hand who fills in for the Foreman when absent, and is paid on the standard JIB Approved Electrician rate rather than a salary.',
      "The main contractor's representative who manages the whole site across all trades, sets the site-wide programme and rules, and chairs the daily coordination meetings. The Project Engineer answers to the client directly and sits above all of the sub-contractors, including the electrical firm's own staff.",
      ...
      "The commercial lead who prices tenders, agrees variations and manages the firm's profit and loss across several contracts at once. The Project Engineer is an office-based estimating and accounts role with no direct involvement in the technical detail or the on-site install of any one project.",
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Prices the electrical package at tender stage — takes off quantities from the drawings, applies labour and materials rates, and produces the bid the firm submits to win the work. The Commissioning Engineer is an office-based estimating role that finalises the contract sum before any work starts on site.',
      'Pulls in and terminates the first-fix cabling — containment, tray, conduit and the bulk wiring runs — ahead of the second-fix trades. The Commissioning Engineer is the senior installer who sets out the routes and gets the heavy cabling in before the accessories are fitted.',
      'Sources and orders the materials and equipment for a project, manages supplier relationships and negotiates trade discounts. The Commissioning Engineer is the procurement specialist who ensures the right switchgear and panels arrive on site in time for the install programme.',
  ...
  },
  {
    id: 4,
    question:
      "What's the difference between a 'Domestic Installer' firm and an 'Approved Contractor' firm under NICEIC?",
    options: [
      ...
      'Domestic Installer is the entry tier for firms working on new-build housing developments only, while Approved Contractor is reserved for firms doing repairs and rewires on existing homes. The split is by the age of the dwelling, not the building type, and both tiers carry exactly the same annual fee and assessment.',
      'Domestic Installer firms may only employ apprentices and trainees, while Approved Contractor firms may employ fully qualified electricians. The distinction is about the grade of staff a firm is allowed to take on under NICEIC rules, and has nothing to do with the scope of work or Part P self-certification.',
      'Domestic Installer is the category for sole traders who are not VAT-registered, while Approved Contractor is for VAT-registered limited companies. The two streams are a tax classification used by NICEIC, and both allow identical self-certification of Part P work across all building types.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      "What's the JIB Apprentice grade and how does it differ from the colloquial term 'Improver'?",
    options: [
      "'Apprentice' and 'Improver' are two names for the same formal JIB grade — the term simply changes between regions, with 'Apprentice' used in the south and 'Improver' in the north. Both describe a registered learner working towards the C&G 2365 and AM2, and both attract identical JIB pay rates.",
      ...
      "'Improver' is the senior of the two — it is the formal JIB grade that sits directly above Electrician, awarded once an electrician has three years' post-AM2 experience. 'Apprentice' is the entry grade. An Improver therefore outranks an Electrician on the JIB scale and can supervise and sign off work.",
      "Apprentice is the grade for under-18s and Improver is the grade for adult learners, with the distinction drawn purely on the worker's age at the start of training. Both finish at the same point — passing the AM2 — and neither term carries any difference in pay or in the qualifications required.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Produces the single-line diagrams, layout drawings and load calculations for the project from an office, then issues the drawing pack to the gang. The Foreman is the firm's Design Engineer and rarely visits site — their role is the technical design rather than the day-to-day running of the install.",
      "Prices the tender, agrees the contract sum with the main contractor and manages the firm's profit and loss across several projects. The Foreman is the commercial Contracts Manager who decides which jobs to bid for and negotiates variations, working from head office rather than on site.",
      ...
      "Energises and tests the finished systems at handover, configuring the BMS and setting the protection parameters before signing the installation over to the client. The Foreman is the firm's Commissioning Engineer, who arrives only at the end of the job once the install is complete and ready to bring to life.",
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 7,
    question:
      'Which of these roles typically requires an HNC, HND or degree in electrical engineering?',
    options: [
      'Site Foreman and Charge Hand. Running the day-to-day gang and supervising first-line work is the natural next step above Approved Electrician, and these roles require a degree-level qualification before a contractor will appoint you to them — the AM2 alone is not sufficient.',
      'Apprentice and Adult Trainee. The entry grades of the JIB ladder require an HNC or degree before you can be registered, because the design knowledge is needed from the very start of training. Qualified Electrician roles, by contrast, need only the AM2.',
      'Domestic Installer and EICR inspector. Self-certifying Part P work and signing condition reports both require a degree in electrical engineering, whereas commercial install and Project Engineer roles can be done on the AM2 and time-served experience alone.',
  ...
  },
  {
    ...
    options: [
      ...
      "'Bonding and Main Switch' — the earthing and isolation arrangement at the origin of an installation, covering main protective bonding and the main switch. BMS work is core to every electrician's job because every consumer unit has one, but it is general first-fix work rather than a specialism that pays above standard rates.",
      "'Builder's Method Statement' — the document a main contractor produces describing how the structural work will be sequenced and made safe. BMS matters to an electrician because it sets the site programme, but it is a construction-management document and there is no specialist career route attached to it.",
      "'Backup Mains Supply' — the standby generator or UPS arrangement that keeps essential circuits live during a power cut. BMS work is a growing area for electricians installing standby systems, but it is part of standard commercial install rather than a distinct programming specialism with premium rates.",
    ],
    correctAnswer: 0,
    explanation:
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 1 · Subsection 1"
        title="Industry structure and roles in building services engineering"
        backTo="/study-centre/apprentice/level3-module7-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          How the UK electrical contracting industry is structured and the roles you'll meet —
          Apprentice, Electrician, Approved Electrician, Technician, Site Foreman, Project Engineer,
          Design Engineer, Commissioning Engineer.
        </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Holds the head contract with the client (developer, end-user, framework). Owns the
                whole project — programme, cost, safety, quality across all trades. Typical names:
                Kier, Wates, Mace, ISG, Morgan Sindall, Bouygues, BAM.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Apprentice</strong> &mdash; in a registered apprenticeship. Pay scales by year
              of apprenticeship.
            </li>
            <li>
            ...
            <li>
              <strong>Electrician</strong> &mdash; AM2 passed and JIB-processed. Standard qualified
              grade. National rate around &pound;19&ndash;&pound;20/hr (2024).
            </li>
            <li>
              <strong>Approved Electrician</strong> &mdash; additional experience, signed evidence
              of competence to supervise and sign off work. Higher pay rate.
            </li>
            <li>
          ...
          <p className="mt-3 text-[13px] text-white/70">
            ...
            post-college, pre-AM2 stage. It is NOT a formal JIB grade and does not appear on the JIB
            Working Rule Agreement grade card.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Typical site roles you'll meet (sub-contractor side):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Apprentice</strong> &mdash; the learner. Paired with an Approved or
              Electrician for direct supervision.
            </li>
            <li>
            ...
            <li>
              ...
              First-line supervision under the Foreman.
            </li>
            <li>
              <strong>Site Foreman</strong> &mdash; runs the day-to-day. Daily briefings, materials,
              programme, QA, signs off install milestones.
            </li>
            <li>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                ...
                Consultant (Hoare Lea, Cundall, Aecom, WSP). Typical qualification stack: HNC or HND
                plus years of site experience.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                ...
                materials rates, produces the bid. Office-based but draws heavily on site experience
                for realism. Often a stepping-stone to Contracts Manager.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Brings systems to life at handover. Energising, testing, parameter setting, witness
                records. AM2S, BMS vendor certs (Trend, Tridium) and C&amp;G 2391/2399 feed in.
                High-rate specialism.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Public Health</strong> &mdash; potable water, grey water, drainage, rainwater.
              Watertight install discipline.
            </li>
            <li>
          ...
          clause={
            <>
              ...
              <p className="mt-2">
                ...
                Electrical Contractors&apos; Association (ECA &mdash; employer side) and Unite the
                Union (worker side) and published on jib.org.uk.
              </p>
            </>
          }
          meaning={
            <>
              The JIB grade is the industry-standard signal of an electrician&apos;s competence and
              experience. Most electrical employment contracts in the JIB-graded sector reference
              the JIB Working Rule Agreement, which means the JIB grade dictates your hourly rate,
              your overtime, your travel time payments, your sick pay and your pension. Knowing what
              grade you&apos;re on and what you need to do to step up is career-critical.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              HASAWA s.2(3) requires every employer with five or more employees to publish a written
              safety policy and to bring it to all employees&apos; notice. As an apprentice
              you&apos;re entitled to see your firm&apos;s policy at induction. The policy describes
              the organisation of safety responsibilities (who does what), the arrangements (toolbox
              talks, RAMS, PPE issue, training records) and the safety culture the employer commits
              to. A firm that can&apos;t produce its policy at induction is a firm that hasn&apos;t
              taken s.2(3) seriously &mdash; that&apos;s a signal worth noticing.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The CDM 2015 Regulations allocate health and safety duties across the construction
                project participants &mdash; Client, Principal Designer, Designer, Principal
                Contractor, Contractor and Workers. Headline allocation:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                  <strong>Client</strong> &mdash; appoints competent duty holders, allows sufficient
                  time and resource, ensures the project is properly managed.
                </li>
                <li>
                ...
                <li>
                  ...
                  construction phase. On commercial projects the main contractor is the Principal
                  Contractor.
                </li>
                <li>
                  <strong>Contractor</strong> &mdash; carries out the construction work safely. The
                  electrical sub-contractor sits here.
                </li>
                <li>
                  <strong>Worker</strong> &mdash; cooperates, follows instruction, reports hazards.
                  The apprentice and the qualified operative sit here.
                </li>
              </ul>
            </>
          }
          meaning={
            <>
              ...
              (Worker) is the first step to understanding why instructions cascade the way they do.
              The Principal Contractor (main contractor) sets site-wide rules; your firm sets
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              for ten years on the same domestic-and-light-commercial diet, and then wonders why
              their pay has plateaued and their CV looks identical to every other qualified
              electrician&apos;s. The wider BSE landscape (BMS, fire, controls, renewables, design,
              commissioning, manufacturer roles) was always there but the apprentice never explored
              it because they didn&apos;t know it existed.
            </>
          }
          doInstead={
            <>
              Treat the AM2 as the door, not the destination. Once you&apos;re a qualified
              Electrician, the JIB grade is portable and your CV is competitive across the industry.
              Spend time understanding what BMS engineers, commissioning specialists, Designers and
              Project Engineers actually do. Talk to people in those roles when you meet them on
              site. Add a CPD qualification every couple of years &mdash; the C&amp;G 2391-52, the
              C&amp;G 2396, an MCS scheme, an HNC, a vendor cert &mdash; to keep the doors open.
              Your career compounds when you keep adding to the stack.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              like in your firm. Most contractors have an internal progression from Electrician to
              Charge Hand to Foreman, and some have a side-step from Approved Electrician into
              Design or Engineering with funded CPD.
              <br />
              <br />
              <strong>Step 2 &mdash; pick the right next qualification</strong>. For Project
              Engineer or Design routes the most useful next step is C&amp;G 2391-52 (Inspection and
              Testing) and either an HNC in Electrical Engineering (one year part-time) or the
              C&amp;G 2396 (Design). 2391-52 is the gateway to inspection and testing contracts and
              is well-respected. The HNC opens the design-team door.
              <br />
              <br />
              <strong>
                Step 3 &mdash; build a portfolio of design questions you&apos;ve handled
              </strong>
              . Even as a site Electrician you&apos;ll have raised RFIs, resolved coordination
              clashes, fault-found unusual issues. Write these up briefly &mdash; they&apos;re the
              evidence that lets you cross from install to design or Project Engineer.
              <br />
              <br />
              ...
              <br />
              <br />
              <strong>Step 5 &mdash; if your firm can&apos;t support the move, move</strong>. Some
              firms are structured for upward mobility and others are not. If yours genuinely
              can&apos;t fund or support the next step, look at firms that explicitly recruit
              Project Engineers from a site background (NG Bailey, Briggs &amp; Forrester, T Clarke
              and the major M&amp;E Consultants all do). Don&apos;t burn the bridge &mdash; leave
              well, keep the references.
            </>
          }
          whyItMatters={
            <>
              The post-AM2 plateau is real and it&apos;s the moment most electricians&apos; careers
              either compound or stagnate. The early decisions &mdash; the next qualification, the
              next role, whether to stay or move &mdash; set the trajectory for the next decade. The
              best move is rarely &quot;stay where you are and hope&quot; &mdash; it&apos;s
              &quot;pick a direction, add the qualification, talk to the right people, then move
              when you&apos;re ready&quot;. The Project Engineer, Design, Commissioning and BMS
              routes all need someone to take the first deliberate step.
            </>
          }
        />
        ...
        >
          <p>The 2024 JIB national rate stack (illustrative — always check current jib.org.uk):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electrician basic</strong> &mdash; ~&pound;19.42/hr national, ~&pound;22.68/hr
              LW inside M25.
            </li>
            <li>
              <strong>Approved Electrician</strong> &mdash; ~&pound;21.21/hr national,
              ~&pound;24.47/hr LW.
            </li>
            <li>
              <strong>Travel time</strong> &mdash; paid each way above the daily threshold mileage
              (typically 15&ndash;50 miles tier-banded).
            </li>
            <li>
              <strong>Subsistence / lodging</strong> &mdash; flat daily allowance when working
              &gt;50 miles from home.
            </li>
            <li>
              <strong>Overtime</strong> &mdash; 1.5x weekday after contracted hours, 2x weekends and
              bank holidays.
            </li>
            <li>
              <strong>JIB Pension</strong> &mdash; defined-contribution, 5% employer + 5% employee
              minimum on JIB-graded contracts.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Indicative CPD payback maths (course cost vs annual extra earnings):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2391-52 + Approved upgrade</strong> &mdash; ~&pound;1,200 outlay,
              ~&pound;3,500/yr extra. Payback &lt;5 months.
            </li>
            <li>
              <strong>MCS PV/EV registration</strong> &mdash; ~&pound;1,200 setup + ~&pound;500/yr
              scheme, opens grant-funded job stream worth &pound;8&ndash;15k/yr margin.
            </li>
            <li>
              <strong>HNC Electrical Engineering</strong> &mdash; ~&pound;4k over 2yr part-time,
              opens Project Engineer band ~&pound;45&ndash;58k.
            </li>
            <li>
              <strong>BMS vendor cert (Trend Level 2)</strong> &mdash; ~&pound;1,800, opens
              commissioning day rates &pound;320&ndash;450 vs &pound;180&ndash;220 standard install.
            </li>
            <li>
              <strong>NICEIC scheme registration (own firm)</strong> &mdash;
              ~&pound;500&ndash;1,500/yr depending on streams, unlocks Part P self-cert and
              own-customer work.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Quick comparison of CIS vs PAYE JIB for a qualified Electrician:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Headline rate</strong> &mdash; CIS &pound;200&ndash;280/day, PAYE JIB
              ~&pound;19.42/hr (~&pound;155/day basic).
            </li>
            <li>
              <strong>Holiday</strong> &mdash; CIS unpaid (you carry the cost), PAYE 5.6 weeks
              statutory + JIB top-up paid.
            </li>
            <li>
              <strong>Sick pay</strong> &mdash; CIS unpaid (SSP if you self-register), PAYE company
              sick pay + SSP.
            </li>
            <li>
              <strong>Pension</strong> &mdash; CIS self-arranged (SIPP / personal), PAYE JIB DC
              scheme with employer match.
            </li>
            <li>
              <strong>Training</strong> &mdash; CIS self-funded, PAYE often employer-funded with
              study leave.
            </li>
            <li>
              <strong>Tax admin</strong> &mdash; CIS Self Assessment annually + monthly CIS
              statements, PAYE handled by employer.
            </li>
            <li>
              <strong>IR35 risk</strong> &mdash; CIS through a Ltd company sits inside IR35 rules
              &mdash; HMRC may reclassify if you're on a single contract long-term.
            </li>
          </ul>
        </ConceptBlock>
