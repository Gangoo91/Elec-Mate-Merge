...
const checks = [
  {
    ...
    options: [
      ...
      "There is no real difference — 'competent-person scheme' and 'trade association' are two names for the same type of body, and NICEIC, NAPIT and ECA all do identical jobs. A firm only ever needs to join one of them, and the choice is purely about branding.",
      'Competent-person schemes lobby for the industry and run technical events, while trade associations are the Government-authorised bodies that allow firms to self-certify Part P work. So ECA and SELECT handle the regulatory self-certification, and NICEIC and NAPIT handle the industry representation.',
      'Competent-person schemes register individual electricians and record their personal qualifications, while trade associations register firms. A sole trader therefore joins a CPS as an individual and never needs trade-association membership, which only applies to limited companies with employees.',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Registration is free for the first year as an incentive to join, with the scheme recovering its costs only from year two onwards through the annual subscription. So a new sole trader pays nothing to register beyond the cost of the 2391-52 qualification.',
      'Typical first-year cost is £5,000-8,000, dominated by a mandatory bond the firm must lodge with the scheme as a guarantee against poor work. The bond is returned after five years of clean assessments, but the up-front cost puts CPS membership out of reach for most new sole traders.',
      'Around £100 flat — the schemes charge only a nominal registration fee because they are funded by Government grant. There is no assessment cost and no qualification requirement, which is why almost every electrical firm in the UK is registered with at least one scheme.',
  ...
  },
  {
    ...
    question: 'What happens during an annual scheme assessment visit?',
    options: [
      "A written multiple-choice exam the firm's QS sits at a test centre, covering BS 7671 and Part P. Passing the exam each year is what keeps the firm registered; the assessor never visits the premises or looks at any actual jobs, because the test alone evidences continued competence.",
      "A site visit by an HSE inspector who checks the firm's health-and-safety paperwork and serves an Improvement Notice if anything is wrong. The CPS scheme relies on the HSE to police its members, so the annual assessment is a statutory safety inspection rather than a competence review.",
      ...
      'A remote desk-based review where you upload a photo of your van and a copy of your latest invoice to the scheme portal. The scheme confirms your registration from these documents alone; there is no review of qualifications, test equipment, insurance or any completed work.',
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    id: 1,
    question:
      'Who needs to hold the QS (Qualified Supervisor) qualification in a CPS-registered firm?',
    options: [
      'Every electrician working for the firm must individually hold the QS qualification — the scheme will not register a firm unless all of its operatives, including apprentices, have passed 2391-52. This is why CPS-registered firms tend to employ only fully qualified, time-served staff.',
      ...
      "The QS qualification is held by the scheme's own assessor, not by anyone in the firm. NICEIC or NAPIT supplies a qualified supervisor who oversees the firm's certification remotely, which is what the annual subscription pays for. The firm itself needs no qualified person on its books.",
      "Only the firm's company director must hold the QS qualification, regardless of whether they do any electrical work. It is a governance requirement tied to the legal ownership of the business, so a non-electrician director can satisfy it by passing 2391-52 while the actual installs are done by others.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    id: 2,
    question:
      "What's the practical advantage of CPS Part P self-certification over LABC notification?",
    options: [
      'CPS-registered firms are exempt from Part P entirely, so their notifiable work in dwellings does not have to meet the Building Regulations at all. The LABC route, by contrast, forces full Building Regulations compliance, which is why registered firms can work faster and cheaper.',
      'CPS-registered firms can charge the homeowner a higher rate because the NICEIC or NAPIT logo commands a premium. The LABC route caps what a non-registered electrician may charge for notifiable work, so the advantage is purely a pricing one rather than a process saving.',
      ...
      'CPS-registered firms can issue Electrical Installation Certificates, whereas non-registered firms going through LABC can only issue Minor Works Certificates. The advantage is the type of BS 7671 certificate you are allowed to produce, not the Building Regulations notification process.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      "Two grades of individual electrician. Domestic Installer (DI) is the grade given to apprentices and improvers, while Approved Contractor (AC) is the grade for time-served electricians. They describe a person's competence level, like a JIB grade, rather than a firm's scope of registration.",
      'Two types of certificate. Domestic Installer (DI) is the certificate issued for work in dwellings and Approved Contractor (AC) is the certificate for commercial work. A firm issues whichever certificate matches the building, but holds a single undifferentiated NICEIC registration.',
      'Two payment tiers. Domestic Installer (DI) is the budget membership that excludes the annual assessment visit, while Approved Contractor (AC) includes the assessment. Both cover identical scope of work; the only difference is whether the assessor visits each year.',
  ...
  },
  {
    ...
    options: [
      ...
      'NAPIT is the only scheme authorised for commercial and industrial work, while NICEIC is limited to dwellings. A firm doing any work outside domestic premises must therefore register with NAPIT, which is its key advantage over NICEIC for commercial contractors.',
      "NAPIT is a Government department rather than a private scheme, so its certificates carry statutory weight that NICEIC's do not. This public-body status is NAPIT's main differentiator and the reason large clients prefer NAPIT-certified firms on public-sector contracts.",
      'NAPIT does not require an annual assessment visit, relying instead on a one-off registration check. This lighter-touch model is its main difference from NICEIC, which assesses members every year — making NAPIT the cheaper long-term option for any electrical firm.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The Electrical Competence Authority — the Government body that authorises competent-person schemes. ECA membership lets a firm self-certify Part P work directly, replacing the need for NICEIC or NAPIT registration. It is the regulatory layer that sits above the schemes.',
      ...
      "The Electrical Certification Agency — the body that issues ECS competence cards to individual electricians. ECA membership provides each of a firm's electricians with their site-entry card, which is why ECA membership is checked at the gate on commercial sites.",
      "The Electricians' Co-operative Alliance — a buying group that negotiates trade discounts on materials for member firms. ECA membership is essentially a wholesale purchasing scheme, giving firms cheaper cable, containment and switchgear rather than any representational or technical benefit.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'SELECT is the Scottish competent-person scheme, authorised to self-certify Part P notifiable work in Scottish dwellings. It is the Scottish equivalent of NICEIC, and Scottish firms join SELECT instead of a trade association for their regulatory self-certification authority.',
      'SELECT is the Scottish branch of the JIB, responsible for collective bargaining north of the border. It negotiates Scottish pay rates directly with Unite and sets the SJIB grading structure, functioning as a bargaining body rather than a trade association.',
      ...
      'SELECT is the Scottish qualification awarding body, equivalent to City & Guilds, that issues the Scottish electrical qualifications and runs the AM2 in Scotland. Scottish apprentices sit SELECT exams rather than C&G ones, and firms join it to access its training routes.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 7,
    question:
      "Roughly what does the LABC charge per Part P notifiable job if you DON'T have CPS membership?",
    options: [
      'Nothing — the LABC route is free to the electrician. The Local Authority recovers its costs from general council tax rather than from the firm doing the work, so the only reason to join a CPS is the marketing benefit, not any saving on notification fees.',
      'A flat £25 administration fee per job, fixed nationally and the same in every Local Authority. Because the fee is so small, the economic case for CPS membership is weak, and most domestic installers go through LABC for every notifiable job instead.',
      'A percentage of the contract value — typically 2-3% of the job price — charged by the Local Authority on every notifiable Part P job. The cost therefore scales with job size, and CPS membership is only worthwhile on large rewires rather than small jobs.',
  ...
  },
  {
    ...
    options: [
      ...
      'Nothing — the QS is registered against the firm permanently, so it does not matter who actually holds the qualification once the firm is on the scheme. You can change QS freely without telling the scheme, because registration attaches to the business, not to a named person.',
      'Re-apply for scheme registration from scratch as a brand-new member, including a fresh first-issue assessment visit and application fee. Changing QS voids the existing registration entirely, so the firm starts the whole joining process again as if it had never been registered.',
      'Notify the HSE, who must approve the new QS before the firm can issue any further certificates. Because the QS is a statutory safety role, a change of QS triggers a Health and Safety Executive review rather than a scheme-level notification.',
    ],
    correctAnswer: 0,
    explanation:
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 1 · Subsection 4"
        title="Scheme membership economics"
        backTo="/study-centre/apprentice/level3-module7-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          NICEIC vs NAPIT vs ELECSA vs ECA vs SELECT — costs, audit cycle, what each scheme unlocks,
          and how to choose when setting up your own firm or comparing employers.
        </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                NICEIC, NAPIT, ELECSA, STROMA. Authorised by Government to allow registered
                contractors to self-certify Part P notifiable electrical work in dwellings. Annual
                assessment, QS-required, public-register listed. Certsure is the operating company
                behind NICEIC and ELECSA &mdash; not a separate scheme.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                ECA (England/Wales/NI), SELECT (Scotland). Lobby for the industry, run technical
                events, publish guidance, co-run JIB / SJIB with Unite. Member firms display logo as
                quality signal.
              </p>
            </div>
          </div>
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Oldest and largest CPS. Approved Contractor (AC) and Domestic Installer (DI)
                streams. Operated by Certsure. The household-name &quot;NICEIC tick&quot; is a
                meaningful quality signal in the consumer market.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                National Association of Professional Inspectors and Testers. Multi-trade scheme
                covering electrical, plumbing, heating, gas. Often the choice for multi-discipline
                firms.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                ...
                positioned for smaller installers, slightly cheaper than NICEIC AC, similar
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Multi-discipline certification body. Covers electrical alongside other building
                compliance areas (energy assessment, retrofit). Often chosen by firms with
        ...
        >
          <p>Typical year-1 cost breakdown for a sole-trader electrical firm joining a CPS:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Public Liability insurance</strong> &mdash; &pound;5-10m cover typically
              &pound;200-500/year.
            </li>
            <li>
              <strong>Test equipment calibration</strong> &mdash; multifunction tester annual
              calibration typically &pound;100-180.
            </li>
            <li>
              <strong>Total year 1</strong> &mdash; roughly &pound;2,000-3,500 depending on whether
              QS qualification needs buying.
            </li>
            <li>
        ...
        >
          <p>Annual assessment checklist:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          <p>What ECA / SELECT membership delivers:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                Building Regulations Part P requires &quot;reasonable provision&quot; to protect
                persons operating, maintaining or altering an electrical installation in a dwelling
                from fire or injury. Approved Document P identifies notifiable work and the routes
                for compliance:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                  Notifiable work in a dwelling must either be notified to the LABC before work
                  starts, OR self-certified by a contractor registered with a competent-person
                  scheme (CPS) authorised under Building Regulations.
                </li>
                <li>
                  The CPS issues the compliance certificate to the homeowner and notifies the LABC
                  on the homeowner&apos;s behalf, removing the need for LABC inspection.
                </li>
                <li>
                  Non-notifiable work (minor alterations, like-for-like replacements not in special
                  locations) does not require notification but must still meet BS 7671 and Part P
                  standards.
                </li>
              </ul>
            </>
          ...
          meaning={
            <>
              Part P is the regulatory mechanism that makes CPS membership economically attractive.
              Without CPS, every notifiable job in a dwelling requires LABC notification (and LABC
              fee). With CPS, the registered firm self-certifies and issues the compliance
              certificate direct &mdash; cheaper and faster. Apprentices working in a CPS-registered
              firm should know the firm&apos;s CPS and what it allows the firm to self-certify.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The Companies Act 2006 sets out the general duties of company directors, including:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>s.171 &mdash; duty to act within powers (the company&apos;s constitution).</li>
                <li>
                  s.172 &mdash; duty to promote the success of the company for the benefit of its
                  members as a whole.
                </li>
                <li>s.174 &mdash; duty to exercise reasonable care, skill and diligence.</li>
              </ul>
            </>
          }
          meaning={
            <>
              If you set up your electrical firm as a Ltd company you become a director with
              statutory duties. Maintaining CPS registration, keeping insurance current and
              discharging health-and-safety duties to staff and customers is part of discharging
              those director duties. Failure to do so can expose the director personally as well as
              the company.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">ECA membership requires applicants to demonstrate:</p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>Trading history, financial standing and reputation.</li>
                <li>Suitable insurance cover (PL, EL, PI as appropriate).</li>
                <li>
                  Competence to industry standards (typically evidenced by CPS registration,
                  qualified staff, technical resources).
                </li>
                <li>Commitment to the JIB Working Rule Agreement (for JIB-graded firms).</li>
                <li>Compliance with ECA Code of Conduct including customer-care standards.</li>
              </ul>
            </>
          }
          meaning={
            <>
              ...
              substantive. For commercial clients selecting a contractor, ECA membership provides
              reassurance that the firm is financially sound, insured, technically competent and
              commits to industry-standard working conditions. It&apos;s often the difference-maker
              on tender shortlists.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              Doesn&apos;t take the annual assessment seriously. Doesn&apos;t track QS qualification
              expiry. Lets test equipment calibration lapse. Annual visit comes round; assessor
              finds multiple paperwork failures and lapsed calibration. Registration suspended
              pending remediation; can&apos;t self-certify Part P during suspension; LABC
              notifications stack up; cash flow squeezed.
            </>
          }
          doInstead={
            <>
              Treat CPS as a regulatory compliance regime, not a marketing prop. Calendar the QS
              qualification renewal, the test equipment calibration, the insurance renewal and the
              annual assessment visit. Keep a tidy records folder for each customer job: design
              notes, certificates, photos. Use the assessment visit as a yearly health-check &mdash;
              assessors are typically helpful and want to keep you compliant.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;ve passed AM2, you&apos;ve held the 2391-52 for two years, and you&apos;ve
              decided to set up as a sole trader doing domestic and small commercial work in your
              local area. You need a CPS to self-certify Part P. You ring round and the assessor at
              NICEIC quotes you &pound;750 first year, and the assessor at NAPIT quotes &pound;680
              first year. The cost is similar. How do you choose?
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; check local market reputation</strong>. Ask local customers,
              suppliers (wholesalers like Edmundson, City Electrical Factors) and other electricians
              which scheme is best-recognised in your area. NICEIC has stronger lay-consumer
              recognition nationally; in some regional markets NAPIT is well-established. Talk to
              two or three local firms.
              <br />
              <br />
              <strong>Step 2 &mdash; check the assessor relationship</strong>. The annual visit is
              much smoother with a good assessor. Ask each scheme who the local assessor is and (if
              possible) speak to one or two firms about their experience.
              <br />
              <br />
              <strong>Step 3 &mdash; check whether you might do other trades</strong>. If
              you&apos;re also gas-qualified or planning plumbing work, NAPIT&apos;s multi-trade
              structure may save admin overhead later. If you&apos;re electrical-only, NICEIC and
              NAPIT are equivalent on capability.
              <br />
              <br />
              <strong>Step 4 &mdash; check the online portal and tools</strong>. Each scheme
              provides a portal for certificate generation, customer notifications, CPD tracking.
              Some are nicer to use than others. Most allow a free trial login &mdash; ask for one.
              <br />
              <br />
              <strong>Step 5 &mdash; decide and commit</strong>. Honestly, for a typical
              domestic-focused sole trader either scheme is a fine choice. Don&apos;t agonise. Pick,
              register, get on with the work. You can switch at annual renewal if it doesn&apos;t
              work out.
            </>
          }
          whyItMatters={
            <>
              CPS is the regulatory backbone of running a domestic-focused electrical firm. Picking
              the wrong scheme isn&apos;t a disaster &mdash; you can switch &mdash; but switching
              mid-year is painful and the assessor relationship matters more than the scheme name.
              Take a week to decide; ring round the local market; make a deliberate choice rather
              than defaulting to whichever logo you see most often.
            </>
          }
        />
        ...
        >
          <p>Indicative scheme cost stack (always verify current pricing direct):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>NICEIC Approved Contractor</strong> &mdash; ~&pound;700&ndash;1,200
              first-year, ~&pound;500&ndash;800 steady annual sub plus assessor day.
            </li>
            <li>
              <strong>NICEIC Domestic Installer</strong> &mdash; cheaper entry
              (~&pound;400&ndash;600 annual sub) but dwellings-only scope.
            </li>
            <li>
              <strong>NAPIT Approved</strong> &mdash; ~&pound;500&ndash;900 annual sub plus assessor
              day; introductory deals common.
            </li>
            <li>
              <strong>ELECSA</strong> &mdash; NICEIC sister scheme, similar pricing structure to
              NICEIC Domestic.
            </li>
            <li>
              <strong>STROMA</strong> &mdash; multi-stream certification body; price varies on
              stream count.
            </li>
            <li>
              <strong>QS qualification</strong> &mdash; C&amp;G 2391-52 (~&pound;1,200&ndash;1,800),
              required for at least one named QS in firm.
            </li>
            <li>
              <strong>LABC alternative</strong> &mdash; ~&pound;200&ndash;300 per notifiable Part P
              job, no scheme but no marketing either.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Switching scheme — the practical checklist:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Time it to year-end</strong> &mdash; align with the outgoing scheme's annual
              renewal date.
            </li>
            <li>
              <strong>Plan a fresh full assessment</strong> &mdash; the new scheme won't accept the
              previous scheme's audit.
            </li>
            <li>
              <strong>Notify your insurer</strong> &mdash; some PI cover is scheme-bundled.
            </li>
            <li>
              <strong>Re-issue templates</strong> &mdash; certificate templates carry the scheme
              logo.
            </li>
            <li>
            ...
            <li>
              <strong>Customer comms</strong> &mdash; only matters if previous certs are referenced
              (e.g. EICR follow-up jobs).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>CPS scheme vs trade association &mdash; what each does:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>CPS scheme (NICEIC, NAPIT etc)</strong> &mdash; regulatory authorisation for
              Part P self-cert; required to issue compliance certificates.
            </li>
            <li>
              <strong>ECA / SELECT</strong> &mdash; trade association; technical guidance,
              employment law, lobbying, JIB input.
            </li>
            <li>
              <strong>JIB / SJIB</strong> &mdash; collective bargaining body; sets rates,
              conditions, grading.
            </li>
            <li>
              <strong>Held together</strong> &mdash; established commercial sub-contractors
              typically hold all three plus an MCS scheme for renewables.
            </li>
          </ul>
        </ConceptBlock>
