...
const faqs = [
  ...
  {
    question:
      'Can I jump from Apprentice straight to Approved without first becoming an Electrician?',
    answer:
  ...
  {
    question:
      "What's the difference between the JIB Working Rule Agreement and a normal employment contract?",
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The formal JIB grading ladder — Apprentice Stages 1-4, Adult Trainee, Electrician,
          Approved Electrician, Technician — what each grade means, what evidence you need, and how
          the JIB pay framework links your grade to your hourly rate.
        </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Four sub-stages aligned to the years of the apprenticeship. Each Stage requires the
                corresponding college units to be complete plus portfolio evidence signed by the
                workplace mentor. Pay rises with each Stage. 2024 indicative national rates: Stage 1
                ~&pound;8.50/hr, Stage 4 ~&pound;14.50/hr.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                The formal JIB grade for a non-apprenticeship adult learner working towards the
                Level 3 qualifications and AM2. (The colloquial term &quot;Improver&quot; is
                sometimes used for the post-college, pre-AM2 stage but is NOT a formal JIB grade.)
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4 sm:col-span-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                ...
                commissioning or technical leadership. The engineering-tier JIB grade. Often the
                route into EngTech / IEng / CEng professional registration.
              </p>
            </div>
          </div>
        </ConceptBlock>
        ...
        >
          <p>Typical Stage progression triggers:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stage 1</strong> &mdash; entry to the apprenticeship. C&amp;G 2365-02 Level 2
              in progress. ECS Apprentice card issued.
            </li>
            <li>
              <strong>Stage 2</strong> &mdash; C&amp;G 2365-02 Level 2 complete; 2365-03 Level 3
              commencing. Portfolio Year 1 evidence in place.
            </li>
            <li>
              <strong>Stage 3</strong> &mdash; mid-2365-03; substantial Level 3 units complete;
              portfolio Year 2 evidence in place.
            </li>
            <li>
        ...
        >
          <p>Evidence required for each post-apprenticeship grade:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Electrician</strong> &mdash; Level 3 qualifications PLUS AM2 (or AM2E / AM2S)
              passed. Employer applies to JIB to upgrade.
            </li>
            <li>
              <strong>Approved Electrician</strong> &mdash; Electrician PLUS 2391-52 (or equivalent
              inspection and testing qualification) PLUS typically 2 years post-AM2 site experience.
            </li>
            <li>
              <strong>Technician</strong> &mdash; Approved PLUS academic qualification at HNC level
              or above (HNC/HND/foundation degree/BEng) PLUS senior experience in design,
              commissioning or technical leadership.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What the JIB Working Rule Agreement covers:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pay rates</strong> &mdash; minimum hourly rate for each grade, both national
              and London-weighted.
            </li>
            <li>
              <strong>Working hours</strong> &mdash; standard week (typically 37.5 hours), overtime
              premiums (time-and-a-half, double-time).
            </li>
            <li>
              <strong>Holiday entitlement</strong> &mdash; statutory minimum plus industry additions
              (typically 22-25 days plus bank holidays).
            </li>
            <li>
              <strong>Sick pay</strong> &mdash; the Industry Sick Pay scheme (top-up above Statutory
              Sick Pay).
            </li>
            <li>
              <strong>Pension</strong> &mdash; employer contributions to the JIB pension scheme
              (Electrical Contractors&apos; Industry Joint Industry Board pension fund).
            </li>
            <li>
              <strong>Travel and lodging allowances</strong> &mdash; daily travel time and expenses
              for distant work.
            </li>
            <li>
              <strong>Apprentice rules</strong> &mdash; Stage progression, mentor requirements, paid
              college time.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Adds typically &pound;2-3/hr to the national rate for work inside the M25. Applies
                on a per-project basis, not per-employee. JIB publishes both national and
                London-weighted rate cards each year.
              </p>
            </div>
            <div className="rounded-2xl border border-white/[0.08] bg-[hsl(0_0%_12%)] p-4">
              <div className="text-[11px] uppercase tracking-[0.18em] text-elec-yellow mb-2">
              ...
              <p className="text-[13.5px] text-white/85 leading-relaxed">
                Separately negotiated by the Scottish JIB; broadly similar to JIB rates but not
                identical. Scottish apprentices are on SJIB Stages and SJIB grade rates. Published
                at sjib.org.uk.
              </p>
            </div>
          </div>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                ...
                contracting in England, Wales and Northern Ireland. Headline provisions include:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                  Minimum hourly rates for each formal JIB grade (Apprentice Stages 1-4, Adult
                  Trainee, Electrician, Approved Electrician, Technician).
                </li>
                <li>
                  Separate national and London-weighted rate cards, renegotiated annually between
                  ECA (employer side) and Unite (worker side).
                </li>
                <li>
                  Standard working week (typically 37.5 hours), with defined overtime premiums and
                  travel allowances.
                </li>
                <li>
                ...
                <li>Holiday entitlement above the statutory minimum.</li>
                <li>
          ...
          meaning={
            <>
              The WRA is the practical floor of pay and conditions for JIB-graded employment.
              JIB-graded employers contractually undertake to follow the WRA; non-JIB employers are
              not bound but typically use JIB rates as the market reference. As an apprentice on a
              JIB-graded contract you can rely on the WRA as the minimum &mdash; if your contract
              pays less, that&apos;s a breach.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The Apprenticeship Rate of the National Minimum Wage applies in the first year of
                apprenticeship and to apprentices under 19. After year 1 (and once the apprentice is
                19 or older) the standard age-based NMW or NLW applies. Rates are set annually by
                the Low Pay Commission and published on gov.uk.
              </p>
              <p>
                Where the JIB Stage rate is higher than the applicable NMW/NLW, the JIB Stage rate
                applies under JIB-graded contracts. Where it&apos;s lower, the NMW/NLW is the legal
                floor.
              </p>
            </>
          }
          meaning={
            <>
              Even the lowest JIB Apprentice Stage rate is materially above the Apprenticeship Rate
              of the National Minimum Wage. So in practice, JIB-graded apprentices are on JIB Stage
              rates, not NMW. But the NMW/NLW remains the legal floor &mdash; if for any reason a
              JIB rate fell below NMW, NMW would still apply. Non-JIB employers can pay just NMW/NLW
              &mdash; another reason why JIB-graded firms are usually a better proposition for
              apprentices.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              The 2009 Act and the Apprenticeships (Form of Apprenticeship Agreement) Regulations
              2012 set the form of the apprenticeship agreement &mdash; a specific statutory form of
              employment contract recognised in law. The apprenticeship agreement records the
              apprenticeship framework or standard, the working hours, the off-the-job training
              requirement, and the pay.
            </>
          }
          meaning={
            <>
              JIB Stage progression sits on top of the apprenticeship agreement &mdash; the Act is
              the legal underpin, the WRA is the industry-collective layer above it. A JIB-graded
              apprentice is covered by both: the statutory apprenticeship framework and the
              collectively-bargained JIB Stage and pay framework.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice assumes that &quot;Stage 1 in Year 1, Stage 2 in Year 2&quot; is automatic.
              Falls behind on coursework in college Year 2, doesn&apos;t complete the relevant
              units. Year 2 ends but the Stage 2 evidence isn&apos;t in place &mdash; employer
              can&apos;t move them to Stage 3 in JIB&apos;s system. Stays on Stage 2 rate for an
              extra six months while the catch-up coursework gets done. Loses several thousand
              pounds in gross pay over those six months.
            </>
          }
          doInstead={
            <>
              Treat Stage progression as evidence-based, not time-based. Track your coursework
              completion against the Stage criteria. If you fall behind, raise it at the three-way
              review &mdash; the College Tutor and Workplace Mentor can help build a catch-up plan.
              Most employers will accept reasonable explanation for a one-month delay; longer delays
        ...
        <Scenario
          ...
          situation={
            <>
              You sat AM2 six weeks ago and got the pass. You&apos;ve told your line manager and
              your College Tutor. Your next payslip arrives and you&apos;re still on the final-year
              Apprentice rate (the pre-AM2 stage colloquially called the &quot;Improver&quot;
              period) &mdash; about &pound;4/hr below the Electrician rate. You ask payroll and they
              say &quot;the JIB upgrade hasn&apos;t come through&quot;. You&apos;re losing several
              hundred pounds a month while this drags on.
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; verify your AM2 result is officially with JIB</strong>. NET
              (the AM2 administrator) issues the pass certificate and notifies JIB once processed.
              Check that your AM2 pass is recorded on your JIB account (jib.org.uk login). If
              it&apos;s not, chase NET.
              <br />
              <br />
              <strong>
                Step 2 &mdash; ask your employer to formally apply for the grade upgrade
              </strong>
              . The JIB grade upgrade is initiated by the employer through the JIB portal, with your
              AM2 evidence attached. Your line manager or HR / training lead is the person to push.
              Give them the AM2 certificate number and date.
              <br />
              <br />
              <strong>Step 3 &mdash; raise it at the three-way review or with the union rep</strong>
              . If the employer is dragging their feet (or worse, hoping you won&apos;t notice),
              this is a legitimate JIB-graded contract issue. Raise it politely first, then formally
              if needed. Unite rep is the escalation route on JIB-graded sites.
              <br />
              <br />
              <strong>Step 4 &mdash; get the back-pay</strong>. Once the grade upgrade goes through,
              the new rate should be backdated to the date of your AM2 pass (or to the date your
              employer was notified, depending on contract wording). Check the back-pay arrives on
              the next payroll.
              <br />
              <br />
              <strong>Step 5 &mdash; document for the future</strong>. Keep a copy of your AM2
              certificate, your JIB upgrade date, and the date the new rate first appeared on
              payroll. If you change employer in future, that record proves you hold the Electrician
              grade and avoid being asked to re-prove it.
            </>
          }
          whyItMatters={
            <>
              The pre-AM2 to Electrician jump is the biggest single pay step of the apprenticeship
              &mdash; typically &pound;4-5/hr or &pound;8,000+/year of gross pay. Every week the
              upgrade is delayed costs you real money. JIB-graded employers are bound to process
              upgrades promptly; the practical reality is that some firms need to be reminded.
              Don&apos;t be shy about chasing &mdash; this is contractual, not optional.
            </>
          }
        />
        ...
        <ContentEyebrow>
          Beyond the headline grade — what the JIB ladder really gates
        </ContentEyebrow>
        ...
        >
          <p>The Approved Electrician application stack:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Three years post-AM2</strong> &mdash; minimum experience as a JIB Electrician.
            </li>
            <li>
              <strong>Supervisory evidence</strong> &mdash; signed-off work, witness records,
              references from a Foreman or Project Engineer confirming you've led work.
            </li>
            <li>
              <strong>Inspection &amp; Testing competence</strong> &mdash; ideally C&amp;G 2391-52
              plus signed certificates demonstrating competent application.
            </li>
            <li>
              <strong>CPD record</strong> &mdash; recent BS 7671 update, manufacturer training,
              scheme assessments.
            </li>
            <li>
              <strong>Application fee</strong> &mdash; submitted via JIB portal; nominal cost
              (typically &lt;&pound;100).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The Technician grade evidence stack:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Approved Electrician baseline</strong> &mdash; already JIB-processed.
            </li>
            <li>
              <strong>HNC, HND or BEng</strong> &mdash; in Electrical / Electrical &amp; Electronic
              Engineering or accepted equivalent.
            </li>
            <li>
              <strong>Specialist competence evidence</strong> &mdash; design work, commissioning
              records, supervisory portfolio.
            </li>
            <li>
              <strong>Optional EngTech registration</strong> &mdash; via IET as the chartered-route
              stepping-stone, often filed alongside.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Key Working Rule clauses every JIB-graded electrician should know:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Working week</strong> &mdash; typically 37.5&ndash;39 hours basic, defined per
              sector.
            </li>
            <li>
              <strong>Overtime</strong> &mdash; 1.5x after contracted hours weekdays, 2x weekends
              and bank holidays.
            </li>
            <li>
              <strong>Travel time</strong> &mdash; tier-banded allowance based on distance from the
              JIB-defined home depot.
            </li>
            <li>
              <strong>Lodging</strong> &mdash; flat daily allowance for jobs &gt;50 miles from home.
            </li>
            <li>
              <strong>Holiday</strong> &mdash; statutory 5.6 weeks plus JIB-additional, accrued
              through the Combined Benefits Stamp.
            </li>
            <li>
              <strong>Sick pay</strong> &mdash; company sick pay scheme on top of SSP, typically
              scaling with service.
            </li>
            <li>
              <strong>Disputes</strong> &mdash; formal JIB disputes procedure; sits alongside ACAS
              Code on internal grievance.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                The ACAS Code of Practice 1 sets the minimum standard for handling disciplinary and
                grievance issues in UK workplaces. Headline expectations:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                ...
                <li>
                  Employee has the right to be accompanied at formal meetings (by a colleague or
                  trade union rep).
                </li>
                <li>Right of appeal against any formal decision.</li>
                <li>
                  Employment Tribunals can adjust awards by up to 25% for unreasonable failure to
                  follow the Code.
                </li>
              </ul>
            </>
          ...
          meaning={
            <>
              The ACAS Code is not statute but tribunals weight non-compliance heavily in any
              unfair-dismissal or unpaid-wages case. For a JIB-graded apprentice the typical issue
              is a delayed grade upgrade or unpaid travel time &mdash; the right path is grievance
              under your firm's procedure first, then JIB disputes procedure if unresolved, then
              ACAS conciliation, then Employment Tribunal as a last resort. Most disputes resolve at
              stage 1 if you raise them properly in writing.
            </>
          }
