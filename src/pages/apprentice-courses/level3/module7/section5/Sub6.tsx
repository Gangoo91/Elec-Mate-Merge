...
export default function Sub6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 5 · Subsection 6"
        title="Insurance and liability"
        backTo="/study-centre/apprentice/level3-module7-section5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The full insurance stack for an electrical contracting business — PL, EL, PI, product,
          tools, contract works — plus excess, subrogation, claims-made and indemnity clause
          concepts.
        </p>
        ...
        >
          <p>Employers&apos; Liability essentials:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Statutory basis</strong>: Employers&apos; Liability (Compulsory Insurance) Act
              1969.
            </li>
            <li>
            ...
            <li>
              <strong>Display</strong>: certificate where employees can see (paper or accessible
              electronic).
            </li>
            <li>
            ...
            <li>
              <strong>&quot;Employee&quot; definition</strong>: broad &mdash; full-time, part-time,
              casual, apprentice, family worker.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                ...
                maintain insurance, under one or more approved policies with an authorised insurer
                or insurers against liability for bodily injury or disease sustained by his
                employees, and arising out of and in the course of their employment in Great Britain
                in that business.&quot;
              </p>
              <p className="mt-2">
          ...
          meaning={
            <>
              ...
              Display the certificate; retain past certificates 40 years; renew before expiry. HSE
              enforces.
            </>
          }
        ...
        >
          <p>Public Liability practicalities:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cover level</strong>: &pound;2m minimum, &pound;5m typical, &pound;10m+ for
              larger commercial.
            </li>
            <li>
              <strong>What&apos;s covered</strong>: third-party injury or property damage caused by
              your work.
            </li>
            <li>
              <strong>What&apos;s NOT covered</strong>: your own injury (Personal Accident covers
              that); damage to your own tools (Tools cover); employee injuries (EL covers that);
              economic loss from design errors (PI covers that).
            </li>
            <li>
              <strong>Premium</strong>: &pound;200-700/yr for &pound;2m sole trader; more for higher
              cover, employees or higher turnover.
            </li>
            <li>
              <strong>Excess</strong>: typically &pound;250-500 per claim.
            </li>
            <li>
              <strong>Common exclusions</strong>: hot works (welding, cutting); working at height
              beyond threshold; specialist scopes (HV, ATEX).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Professional Indemnity essentials:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cover</strong>: claims from professional advice / design / spec errors causing
              financial loss.
            </li>
            <li>
              <strong>Distinct from PL</strong>: PL covers physical-damage claims; PI covers
            ...
            <li>
              <strong>Basis</strong>: usually claims-made &mdash; covers claims notified in policy
              period.
            </li>
            <li>
              <strong>Run-off cover</strong>: needed when ceasing trade or changing insurer;
              typically 3-6 years.
            </li>
            <li>
              <strong>Limitation</strong>: align cover period with Limitation Act 1980
              simple-contract 6-year period.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Product Liability framework:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Producer</strong>: manufacturer, importer into UK, or own-brand seller liable
              as producer.
            </li>
            <li>
              <strong>Supplier</strong>: must identify the producer if asked; otherwise treated as
              producer.
            </li>
            <li>
              <strong>Insurance</strong>: usually within PL policy; check for separate Product
              Liability limits or exclusions.
            </li>
            <li>
              <strong>Practical mitigation</strong>: branded products with clear supply chains;
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Critical exclusions</strong>: theft from unattended vehicle overnight (often
              excluded); single-item limits.
            </li>
            <li>
              <strong>Scheduled items</strong>: declare high-value test equipment separately for
              full cover.
            </li>
            <li>
        ...
        >
          <p>Contract Works practicalities:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Scope</strong>: fire, flood, theft, accidental damage to work-in-progress on
              contracts.
            </li>
            <li>
              <strong>When needed</strong>: larger jobs with significant installed value not yet
              handed over.
            </li>
            <li>
              <strong>Project policies</strong>: often provided by main contractor on commercial
              sites &mdash; check contract.
            </li>
            <li>
              <strong>Cover level</strong>: matches peak installed value during the contract.
            </li>
            <li>
              <strong>Cost</strong>: varies; typical &pound;500-2,000 for &pound;50-200k contract
              value.
            </li>
            <li>
              <strong>Standard contracts</strong>: JCT, NEC contracts specify allocation of Contract
        ...
        >
          <p>Operational insurance concepts:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Excess (deductible)</strong>: amount you pay per claim before insurer pays.
            </li>
            <li>
              <strong>Subrogation</strong>: insurer&apos;s right to pursue third parties after
              paying your claim.
            </li>
            <li>
            ...
            <li>
              <strong>Claims-made basis</strong>: covers claims in policy period; typical PI; needs
              continuous cover or run-off.
            </li>
            <li>
            ...
            <li>
              <strong>Non-disclosure</strong>: undeclared material facts can void the policy
              entirely.
            </li>
            <li>
              <strong>Indemnity clauses</strong>: contractual liability transfers; align with
              insurance cover.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Fair presentation checklist at renewal:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Specialist or higher-risk activities (HV, work at height beyond threshold, hot works).
            </li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              running cable. Customer claims &pound;1,500 for the damage. Contractor wants to avoid
              &quot;an insurance hassle&quot;, pays the &pound;1,500 directly. Two months later the
              same customer claims further damage from an alleged short-circuit in the same work
              area &mdash; &pound;6,000 of follow-on damage. Contractor notifies insurer this time.
              Insurer asks about the original incident, learns about the direct settlement, and
              refuses cover on the basis that the direct settlement destroyed subrogation rights and
              was a breach of the policy condition not to admit liability or settle directly.
              Contractor personally liable for the &pound;6,000.
            </>
          }
          doInstead={
            <>
              Notify the insurer the moment a potential claim arises &mdash; even small ones. Let
              the insurer&apos;s claims team handle the negotiation; they have specialists who do
              this professionally. The excess might mean you pay the first &pound;250-500 yourself
              but the policy structure stays intact for any related follow-on claims. Direct
              settlement is almost always a false economy because of the cover-voiding consequences
              if related claims emerge later.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Sole trader does EV / PV design work for several years; carries Professional Indemnity
              insurance. Decides to stop trading; cancels all insurances at the end of the year.
              Three years later a customer&apos;s PV system underperforms; investigation traces it
              to a design error in the system sizing; customer claims &pound;25,000 for loss of FIT
              income over the system&apos;s life. Trader has no PI cover at the time of claim (PI is
              claims-made; the policy at the time of the work doesn&apos;t cover claims made years
              later); no run-off cover was purchased when ceasing trading. Trader is personally
              liable for &pound;25,000.
            </>
          }
          doInstead={
            <>
              Always buy run-off cover when ceasing trade or changing insurer if you carry
              Professional Indemnity. Typical run-off period 3-6 years (matches Limitation Act 1980
              simple-contract 6-year period). Premium typically 100-150% of one year&apos;s premium
              amortised over the run-off period &mdash; modest cost relative to the exposure. Set
              the cover to extend for the longest plausible claim window for your work types.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              phones: their child received an electric shock from a socket in the room you worked
              in; minor injury, no hospitalisation, but they&apos;re asking what you&apos;re going
              to do about it. You issued a clean EIC at the time. What do you do?
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; respond calmly and seriously</strong>. Don&apos;t deny;
              don&apos;t admit liability. &quot;I&apos;m really sorry to hear about your child
              &mdash; first thing, is everyone OK? Tell me what happened.&quot; Listen; get the
              facts.
              <br />
              <br />
              <strong>Step 2 &mdash; arrange a return visit</strong>. Go back; test the installation
              against the original EIC results. Take photographs. Bring your MFT and test gear.
              Document conditions thoroughly. If something is genuinely wrong, find out what. If
              everything tests OK, document that thoroughly too.
              <br />
              <br />
              <strong>Step 3 &mdash; notify your insurer immediately</strong>. Don&apos;t wait to
              see if the customer escalates &mdash; most policies require prompt notification of
              incidents that might lead to claims, regardless of whether a claim has materialised.
              Phone your broker / insurer&apos;s claims line; describe the incident factually;
              follow up in writing. Your insurer&apos;s claims team will take over from this point.
              <br />
              <br />
              <strong>Step 4 &mdash; preserve evidence</strong>. Keep copies of: original quotation;
              original EIC and test results; photos from the original job; photos from the return
              visit; any written communication with the customer. Insurer will ask for this evidence
              pack.
              <br />
              <br />
              <strong>Step 5 &mdash; don&apos;t admit liability or settle directly</strong>. Even if
              you suspect your work might have contributed, don&apos;t admit liability in any
              conversation or written communication with the customer. Don&apos;t offer a goodwill
              payment without insurer agreement. These actions can destroy subrogation rights and
              void cover. Refer the customer to your insurer&apos;s claims team if they want to
              pursue a formal claim.
              <br />
              <br />
              <strong>Step 6 &mdash; let the process run</strong>. The insurer&apos;s claims team
              will investigate, possibly arrange an independent inspection, negotiate with the
              customer or their solicitor. You pay the excess if the claim succeeds; the insurer
              handles the rest. Most claims like this are either resolved on facts (the work was OK;
              another cause; no contractor liability) or settled efficiently if there was a genuine
              fault.
              <br />
              <br />
              <strong>Step 7 &mdash; learn from it</strong>. Regardless of liability outcome, review
              what happened. Was the testing thorough enough? Were there any indicators you could
              have spotted? Update your processes if needed. Treat as CPD, not as personal failure.
            </>
          }
          whyItMatters={
            <>
              Personal injury claims are the highest-stakes incidents in contracting work. Insurance
              is what stands between a contained event handled professionally and a career-ending
              personal-liability outcome. The discipline matters: prompt notification, no liability
              admission, no direct settlement, full cooperation with the insurer. Done right, the
              policy works as designed. Done wrong &mdash; direct settlement, late notification,
              admitted liability &mdash; the contractor ends up personally exposed for the full
              claim. Most contractors will face one or two incidents like this in a career; how you
              handle them defines whether insurance actually protects you.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Module 7 hub</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
