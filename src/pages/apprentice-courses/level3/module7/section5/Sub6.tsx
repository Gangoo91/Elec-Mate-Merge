...
const checks = [
  ...
  },
  {
    ...
    options: [
      ...
      'Theft of your materials by an employee.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['£100,000.', '£500,000.', '£2 million to £5 million (with £10m+ for larger commercial work).', '£10 million is always required.'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only show the premium amount.',
      'Display only the policy number externally.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only tools less than 5 years old.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Try to hide it.',
      'Pay the claimant directly out-of-pocket to avoid insurance.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Claims are automatic without notification.',
    ],
    correctAnswer: 1,
    explanation:
