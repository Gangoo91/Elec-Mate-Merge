...
const checks = [
  {
    ...
    question:
      'What is the key difference between trading as a sole trader and as a limited company?',
    options: [
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 5 · Subsection 2"
        title="Running your own electrical business"
        backTo="/study-centre/apprentice/level3-module7-section5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Business structures, HMRC and Companies House registration, VAT, CIS, ICO, financial
          management, cash flow and marketing fundamentals.
        </p>
        ...
        >
          <p>Side-by-side at a glance:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sole trader</strong> &mdash; HMRC registration only; one Self Assessment per
              year; personal income tax + Class 2 + Class 4 NI; unlimited personal liability;
              minimal admin.
            </li>
            <li>
              <strong>Partnership</strong> &mdash; similar to sole trader but with shared profits
              and shared unlimited liability between partners; partnership tax return plus
              individual returns.
            </li>
            <li>
              <strong>LLP (Limited Liability Partnership)</strong> &mdash; partnership with limited
              liability; less common for electrical firms.
            </li>
            <li>
              <strong>Limited company</strong> &mdash; Companies House + HMRC registrations; annual
              accounts, Confirmation Statement, corporation tax return; salary + dividends draw;
              liability limited to company assets (with exceptions).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Things to discuss with an accountant before incorporating:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Your projected annual profit.</li>
            <li>Your other income sources (employed elsewhere? rental income?).</li>
            <li>
              Your spouse / partner&apos;s income (relevant for dividend splitting where
              appropriate).
            </li>
        ...
        >
          <p>HMRC registration sequence:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Self Assessment</strong> &mdash; online at gov.uk; within 3 months of starting
              trade; UTR issued 1-3 weeks.
            </li>
            <li>
              <strong>National Insurance</strong> &mdash; Class 2 (flat rate, paid via Self
              Assessment) and Class 4 (% of profits over threshold).
            </li>
            <li>
              <strong>VAT</strong> &mdash; if / when taxable turnover crosses the threshold
              (currently &pound;90,000).
            </li>
            <li>
              <strong>CIS</strong> &mdash; if working in construction industry; register as
        ...
        >
          <p>Registration checklist for a new electrical business:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              HMRC Self Assessment (sole trader / partnership) &mdash; within 3 months of trading
              start.
            </li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Forming a limited company is straightforward and cheap. The hidden cost is the ongoing
              admin obligation: annual statutory accounts under sections 394 onwards, Confirmation
              Statement under section 853A, corporation tax return, and director duties under
              sections 170-177 (the seven general duties). Don&apos;t incorporate lightly; do
              incorporate when liability or tax efficiency genuinely justify it.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                ...
                course of their employment in Great Britain in that business.&quot;
              </p>
              <p className="mt-2">
                Minimum statutory cover &pound;5,000,000. Penalty for trading without cover: up to
                &pound;2,500 per day.
              </p>
            </>
          }
          meaning={
            <>
              Employers&apos; Liability is the only legally-compulsory insurance for most employers.
              The moment you employ anyone &mdash; apprentice, part-time, casual, family member
              &mdash; the Act applies. Display the certificate where employees can see it (paper on
              a notice board, or electronic with accessible link). The HSE enforces. Most package
              policies include &pound;10m EL cover; &pound;5m is the statutory minimum.
            </>
          }
        ...
        >
          <p>Cash flow disciplines that work:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Invoice the same day</strong> &mdash; certificate issued = invoice issued.
            </li>
            <li>
              <strong>Deposits on larger jobs</strong> &mdash; typical 25-50% of total before work
              starts.
            </li>
            <li>
              <strong>Clear payment terms</strong> &mdash; 14 days for domestic, 30 days for
              commercial; state on the invoice.
            </li>
            <li>
              <strong>Active credit control</strong> &mdash; chase at day 7, day 14, day 21 post due
              date; escalate at day 30.
            </li>
            <li>
              <strong>Statutory interest</strong> &mdash; Late Payment Act 1998 gives 8% + BoE base
              on overdue B2B invoices.
            </li>
            <li>
              <strong>Supplier credit terms</strong> &mdash; ask for 30-day accounts after 3-6
              months of regular ordering.
            </li>
            <li>
              <strong>Cash reserve</strong> &mdash; 1-3 months of overhead held as a buffer.
            </li>
            <li>
              <strong>Separate business bank account</strong> &mdash; cleaner records, easier tax,
              more professional.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                ...
                interest at 8% over the Bank of England base rate from the due date. Suppliers also
                have a statutory right to fixed recovery costs (banded by invoice value) plus
          ...
          meaning={
            <>
              ...
              invoices. The 8% + base rate interest is meaningful (currently ~13% effective); fixed
              recovery costs add &pound;40-100 per invoice depending on banding. Use it in your
              terms and conditions; reference it in chase emails; apply it when appropriate. It
              doesn&apos;t apply to consumer invoices &mdash; that&apos;s under the Consumer Rights
              Act 2015 framework and the small claims court.
            </>
          }
        ...
        >
          <p>Reputation-marketing channels that work:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Google reviews</strong> &mdash; ask every satisfied customer; most weight in
              local search.
            </li>
            <li>
              <strong>Google Business Profile</strong> &mdash; free, essential; keep photos,
              services, hours current.
            </li>
            <li>
              <strong>Checkatrade / Trustpilot / Which? Trusted Trader</strong> &mdash; paid
              platforms; vetted enquiries.
            </li>
            <li>
              <strong>CPS scheme &quot;Find a Contractor&quot;</strong> &mdash; NICEIC, NAPIT,
              ELECSA all have free listings for registered firms.
            </li>
            <li>
              <strong>Trade referrals</strong> &mdash; builders, architects, other trades; recommend
              each other.
            </li>
            <li>
              <strong>Existing customer referrals</strong> &mdash; happy customers tell friends;
              sometimes nudge with a referral incentive.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Lower-success channels (use with caution):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Paying for &quot;SEO services&quot; without checking what&apos;s actually being
              delivered.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              Don&apos;t touch it. At year-end, your accountant calculates the actual bill; you pay
              from the tax-savings account; surplus rolls forward. The payment-on-account trap
              (paying ~150% of year-1&apos;s tax in January of year 2) is the single biggest
              cash-flow shock for new sole traders &mdash; plan for it explicitly. Cloud accounting
              software shows a running tax estimate; check it monthly.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Sole trader does &pound;6k consumer unit upgrade for a customer. Invoices a week after
              completion. Doesn&apos;t take a deposit, doesn&apos;t state payment terms, has no
              chase routine. Customer pays at day 67. Trader has paid &pound;1,800 in materials
          ...
          doInstead={
            <>
              Standard practice: take 25-50% deposit on jobs over &pound;1,500; invoice the day work
              completes; state clear payment terms (14 days domestic, 30 days commercial); chase at
              day 7 / 14 / 21 / 30 post-due-date; apply Late Payment Act 1998 interest and recovery
              costs on overdue B2B invoices. Cash collected on time funds the next job&apos;s
              materials; cash collected late forces credit-card use and erodes margin. The
              discipline saves several percentage points of net margin.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;ve given notice at your employer; last day is 6 weeks away. You&apos;re going
              sole-trader, domestic + light commercial focus, working from home with a used van. You
              have &pound;12k in savings. What&apos;s the practical start-up checklist?
            </>
          }
          whatToDo={
            <>
              <strong>Week 6 (now) &mdash; register and plan</strong>. Register with HMRC for Self
              Assessment (UTR issued in 1-3 weeks; do this now). Register with ICO for data
              protection (&pound;40, online, 10 minutes). Open a business bank account (free from
              most challenger banks; Starling, Tide, Mettle); separate from personal banking from
              day one. Set up cloud accounting software (FreeAgent, QuickBooks Self Employed;
              ~&pound;15-25/month).
              <br />
              <br />
              ...
              assessment is typically 4-8 weeks after application; book it now. Costs &pound;400-700
              for assessment + first year fee.
              <br />
              <br />
              <strong>Week 3 &mdash; equipment audit</strong>. Check test equipment calibration (MFT
              must have a current calibration certificate &mdash; required by CPS schemes).
              ...
              &pound;200-500). Business cards (&pound;30 for a few hundred). Google Business Profile
              created (free, 20 minutes; add photos, services, hours). Domain registered and a
              simple one-page website (Wix / Squarespace / Carrd; &pound;5-15/month). Set up your
              customer-quote and certificate templates.
              <br />
              <br />
              <strong>Week 1 &mdash; soft launch</strong>. Tell the network &mdash; family, friends,
              former colleagues, neighbours, trades you worked with. Most year-1 enquiries come from
              existing relationships. Ask permission to add them to a mailing list / WhatsApp
              broadcast for occasional updates.
              <br />
              <br />
              <strong>Week 0 (day one) &mdash; first job</strong>. Issue your first proper quote.
              Issue your first proper invoice. Take your first deposit. Get your first Google review
              when the job completes. The flywheel starts.
              <br />
              <br />
              ...
              capital from the &pound;12k savings. Treat the working capital as untouchable except
              for cash-flow gaps in the first 3-6 months.
            </>
          }
          whyItMatters={
            <>
              ...
              policy, invoicing-day routine, chasing schedule) BEFORE the first job &mdash; not in
              retrospect after the first late-payment crisis.
            </>
          }
        />
