...
const checks = [
  ...
  },
  {
    ...
    question:
      'What is the typical minimum Public Liability insurance cover for an electrical contractor?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'Which insurance is legally compulsory for self-employed electricians who employ anyone?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'When is the most common practical recommendation to apply for CPS scheme registration?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'What is Professional Indemnity insurance and when do electricians typically need it?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'What is the ICO and why do most self-employed electricians need to register with it?',
    options: [
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 5 · Subsection 3"
        title="Setting up as a self-employed electrician"
        backTo="/study-centre/apprentice/level3-module7-section5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The first-day setup — UTR application, Self Assessment registration, National Insurance,
          the insurance stack, banking, accounting, CPS scheme and ICO data protection.
        </p>
        ...
        >
          <p>The HMRC self-employed registration sequence:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Activate online account</strong> &mdash; can then log in and view tax
              position.
            </li>
            <li>
            ...
            <li>
              <strong>Tax payment</strong> &mdash; 31 January (balancing payment + first payment on
              account for next year); 31 July (second payment on account).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>NI summary for self-employed:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Class 2</strong> &mdash; flat weekly amount, ~&pound;180/year, paid via Self
              Assessment.
            </li>
            <li>
              <strong>Class 4</strong> &mdash; percentage of profits over the lower limit, capped at
              the upper limit.
            </li>
            <li>
              <strong>State Pension qualifying years</strong> &mdash; Class 2 secures these; check
              your record at gov.uk.
            </li>
            <li>
              <strong>Class 3 (voluntary)</strong> &mdash; fill gaps in NI record to qualify for
              full State Pension.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Premium</strong>: &pound;200-700/yr for a sole trader; more if employing or
              higher turnover.
            </li>
            <li>
              <strong>Excess</strong>: typically &pound;250-500 per claim; higher excess = lower
              premium.
            </li>
            <li>
              <strong>Exclusions</strong>: check for hot works, height limits, specialist work
              scopes.
            </li>
            <li>
              <strong>Run-off cover</strong>: needed if you stop trading &mdash; covers claims
              arising after cessation.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Employers&apos; Liability rules:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Legally compulsory</strong> if you employ anyone &mdash; the 1969 Act.
            </li>
            <li>
              <strong>Minimum &pound;5m statutory cover</strong> &mdash; &pound;10m typically
              supplied.
            </li>
            <li>
            ...
            <li>
              <strong>Penalty for non-compliance</strong> &mdash; up to &pound;2,500/day; HSE
              enforces.
            </li>
            <li>
              <strong>Broad &quot;employee&quot; definition</strong> &mdash; full-time, part-time,
        ...
        >
          <p>The supporting insurance stack:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Tools-in-Transit / Goods-in-Vehicle</strong> &mdash; theft and damage cover
              for tools in van.
            </li>
            <li>
              <strong>Commercial vehicle insurance</strong> &mdash; legally required for vehicle
              use.
            </li>
            <li>
            ...
            <li>
              <strong>Income Protection</strong> &mdash; monthly income replacement if illness keeps
              you off work long-term.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <p className="mt-2">
                Minimum statutory cover &pound;5,000,000. The certificate must be displayed where
                employees can see it. Penalty for trading without cover: up to &pound;2,500 per day.
              </p>
            </>
          }
          meaning={
            <>
              EL is the only legally compulsory insurance for the typical employer. The moment you
              employ anyone &mdash; apprentice, part-time, casual, family worker &mdash; the Act
              applies. Most package policies provide &pound;10m cover (the &pound;5m statutory
              minimum is the floor). HSE enforces. Don&apos;t employ anyone without the certificate
              in hand on day one.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                ...
                businesses processing personal data must pay an annual data protection fee to the
                Information Commissioner&apos;s Office (ICO). Tiered by size:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
                <li>
                  Tier 1 (small organisations): &pound;40 &mdash; turnover &lt; &pound;632k AND
                  fewer than 11 staff.
                </li>
          ...
          meaning={
            <>
              ...
              business holds customer personal data (names, addresses, phone numbers) &mdash; that
              triggers the obligation. &pound;40/year for a small sole trader. Application is online
              at ico.org.uk and takes 10 minutes. Don&apos;t skip this.
            </>
          }
        ...
        >
          <p>Banking and accounting setup checklist:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Open a business or dedicated personal bank account for business use.</li>
            <li>
              Sign up for cloud accounting software (FreeAgent / Xero / QuickBooks Self-Employed).
            </li>
        ...
        >
          <p>CPS scheme application sequence:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Week 1-2</strong> &mdash; pick scheme; submit application online.
            </li>
            <li>
              <strong>Week 2-3</strong> &mdash; scheme processes application; requests evidence
              (qualifications, insurance, equipment calibration).
            </li>
            <li>
              <strong>Week 3-6</strong> &mdash; line up suitable pre-assessment installations.
            </li>
            <li>
              <strong>Week 6-8</strong> &mdash; scheme assessor visits; inspects work, equipment and
              documentation.
            </li>
            <li>
              <strong>Week 8-10</strong> &mdash; certification issued; you can now self-certify
              notifiable work.
            </li>
            <li>
              <strong>Annual</strong> &mdash; surveillance assessment; CPD evidence; scheme fee
              renewal.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>ICO registration checklist:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              routinely. ICO does a sweep of unregistered trade contractors; serves a fixed penalty
              (typically a couple of thousand pounds at the lower end). Contractor pays the penalty,
              registers, and is irritated &mdash; the registration was &pound;40/year that they
              would have paid willingly if they&apos;d known.
            </>
          }
          doInstead={
            <>
        ...
        <Scenario
          ...
          situation={
            <>
              You went self-employed in May 2026. By 31 January 2028 your first Self Assessment tax
              return is due. You had &pound;55,000 of profit in the 2026-27 tax year (6 April 2026-5
              April 2027). What do you actually owe and when?
            </>
          }
          whatToDo={
            <>
              <strong>Step 1 &mdash; file the return</strong>. Online via gov.uk with your UTR. Most
              cloud accounting software (FreeAgent, QuickBooks Self-Employed) pre-populates the
              figures and submits direct to HMRC. Deadline: 31 January 2028.
              <br />
              <br />
              ...
              <ul className="space-y-1 list-disc pl-5 mt-2 text-[14px]">
                ...
                <li>
                  <strong>Year-1 balancing payment &asymp; &pound;11,969.</strong>
                </li>
              </ul>
              <br />
              <strong>Step 3 &mdash; payments on account</strong>. Plus 50% of year-1 tax as first
              payment on account for 2027-28 &asymp; &pound;5,984.{' '}
              <strong>Total due 31 January 2028 &asymp; &pound;17,953.</strong>
              <br />
              <br />
              ...
              <br />
              <br />
              <strong>Step 5 &mdash; reconcile next January</strong>. In January 2029 you file the
              2027-28 return; balancing payment is the actual 2027-28 tax minus the &pound;11,969
              already paid on account; new payments on account for 2028-29 are 50% of the actual
              2027-28 tax.
              <br />
              <br />
              <strong>Cash-planning implication</strong>: by 31 January 2028 you need &pound;17,953
              in the tax savings account, not &pound;11,969. The payments-on-account feature catches
              many new sole traders out &mdash; it&apos;s effectively paying 150% of year-1 tax in
              January of year 2. Plan for it explicitly.
            </>
          }
          whyItMatters={
            <>
              The first January tax bill is the single biggest financial event for new sole traders.
              Plan for the full amount (balancing payment + first payment on account) rather than
              just the year-1 amount. The 25-30% tax-savings habit through the year covers this
              comfortably if maintained from day one; ignoring the payment-on-account until it lands
              creates a cash crisis. Apprentices going self-employed: bake this into your year-1
              financial plan; ask your accountant to walk through the numbers with you in October so
              there are no surprises in January.
            </>
          }
        />
