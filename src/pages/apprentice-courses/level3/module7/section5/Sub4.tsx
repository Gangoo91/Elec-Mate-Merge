...
const checks = [
  {
    ...
    correctIndex: 0,
    explanation:
      "Estimate = approximate, may change; quotation = fixed price for defined scope, forming the contractual price once accepted unless scope changes (variations). The legal effect is significant under the Consumer Rights Act 2015 — a quotation once accepted is binding at that price, only changeable for genuine scope variations agreed in writing. An estimate gives more room but leaves more room for dispute about what 'reasonable' means at the end. Make sure clients understand which they're receiving — confusion here is a leading cause of payment disputes. Most professional contracts use quotations with clearly stated scope, inclusions, exclusions and assumptions.",
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "Charge-out rate must cover all costs plus profit: target take-home wage, on-costs (NI, pension), vehicle (purchase/lease, fuel, MOT, insurance, repairs), insurance (PL, EL, vehicle, tools), tools and equipment (replacement and calibration), training and CPD, CPS scheme fees, office/admin time, software, marketing and profit margin — divided by chargeable hours per year (~1,500-1,800, not the 2,000 raw availability). Most electricians' charge-out rates are 2-3× their hourly wage equivalent because of non-chargeable overhead (admin, training, sick days, weather, slow periods, depreciation). Match-the-market pricing without knowing your real costs is the fastest route to operating at a loss. Know your numbers first; price within the market second.",
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "A proper site survey on any non-trivial job assesses existing installation condition, access difficulties, cable routes, floor types and finishes, client-specific requirements (working hours, decor protection), hidden risks (asbestos, services in walls, structural issues) and customer expectations vs feasibility. It costs an hour or two and pays for itself many times over by avoiding cost surprises — it's the difference between a quote that holds and one that haemorrhages on variations. What you can't see before you start, you can't price accurately. Document findings; refer to them in the quotation; list explicit assumptions ('assumes existing ring circuit is serviceable; remedial works charged as variations'). The pre-1990s house with old wiring and asbestos prices very differently from the 2010 new-build.",
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "A Bill of Quantities is a standard tendering tool on larger commercial/public-sector projects, prepared by a quantity surveyor or the design team. It pre-defines every item of work; each tendering contractor inserts unit rates; the total is the tendered price — allowing like-for-like comparison across tenders. SMM7 (Standard Method of Measurement) and NRM2 (New Rules of Measurement) are the industry standards for BoQ preparation. Small/domestic work doesn't typically use a BoQ — quotations with clear scope descriptions suffice.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Exclusions are explicit about what's NOT covered. Standard exclusions in domestic electrical quotes: making good (plastering, painting); work by other trades (carpentry, plumbing); building control or scheme fees if charged separately; remedial work to existing non-compliant installations encountered during the work; hidden services (gas, water, structural); skip hire or scaffolding if needed. Clear exclusions don't pad the quote in a bad way — they reduce disputes about who pays for what.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "The 'you're too expensive' conversation is normal in trade pricing. Most cheap quotes are missing things — generic materials instead of branded, minimal testing, no proper certification, uninsured workmanship, no scheme guarantee. Walk through your quote explaining each element; if the gap remains large the cheap quote is probably non-compliant. If the customer still wants it, they're not your customer — let them go gracefully and never undercut your true cost. Undercutting your sustainable rate to win price-shoppers leads to operating at a loss; better to let them go than work for nothing.",
  },
];
