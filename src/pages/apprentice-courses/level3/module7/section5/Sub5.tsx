    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Consumer Rights Act 2015, cooling-off period, written contracts, CDM 2015, UK GDPR / DPA
          2018, ICO registration, vicarious liability and refusing unsafe work.
        </p>
        ...
        >
          <p>CRA 2015 service-contract sections:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Section 49</strong> &mdash; reasonable care and skill.
            </li>
            <li>
              <strong>Section 50</strong> &mdash; information from trader becomes binding term if
              relied on.
            </li>
            <li>
            ...
            <li>
              <strong>Sections 54-57</strong> &mdash; consumer remedies: repeat performance, price
              reduction.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Unfair-terms danger list (likely unenforceable):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Blanket exclusion of liability (UCTA s.2 blocks death / personal injury exclusion
              entirely).
            </li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <p className="mt-2">
                Cannot be excluded by contract terms. Consumer remedies for breach include repeat
                performance (s.55) and price reduction (s.56).
              </p>
            </>
          }
          meaning={
            <>
              CRA 2015 is the consumer-protection baseline for trader-to-consumer service contracts.
              Plan your business on s.49 compliance &mdash; reasonable care and skill is the
              substantive performance bar. Write your quotations carefully &mdash; what you say
              there is binding under s.50. Keep records of what was agreed in writing. If a
              complaint arises, the question will be: did the work meet reasonable care and skill?
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                For contracts concluded away from business premises (off-premises &mdash; including
                the consumer&apos;s home) or at a distance (online, phone), the trader must:
              </p>
              <ul className="space-y-1 list-disc pl-5 text-[14px]">
              ...
              <p className="mt-2">
                Where the consumer expressly requests work to start within the cancellation period,
                they may still cancel but the trader is entitled to payment for the work actually
                done before cancellation, subject to the proper express request and acknowledgement
                procedure.
              </p>
            </>
          }
          meaning={
            <>
              ...
              acknowledging the cancellation rights and waiving the &quot;don&apos;t start until 14
              days are up&quot; default. Failure to comply with the information requirements can
              extend the cancellation period to up to 12 months.
            </>
          }
        ...
        >
          <p>CDM 2015 Contractor duties (always apply, scale with project):</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                ...
                ensure that, so far as is reasonably practicable, it is carried out without risks to
                health and safety. Where there is more than one contractor working on a project, the
                contractor must comply with any directions given by the principal designer or
          ...
          meaning={
            <>
              ...
              contractor work. Even on small domestic jobs as a single contractor, you have planning
              and management duties. The Construction Phase Plan can be short and proportionate for
              small work &mdash; a 1-page document covering scope, risks, controls, emergency
              arrangements is often sufficient. Have one; keep it on file with the job records.
            </>
          }
        ...
        >
          <p>UK GDPR Article 5 principles:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          <p>Data breach response checklist:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          <p>Liability management framework:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Employers&apos; Liability</strong> &mdash; compulsory under the 1969 Act;
              protects against employee-injury vicarious-liability claims.
            </li>
            <li>
              <strong>Public Liability</strong> &mdash; third-party injury / property damage
              including from employee actions.
            </li>
            <li>
              <strong>Professional Indemnity</strong> &mdash; design / advice errors.
            </li>
            <li>
              <strong>T&amp;Cs liability caps</strong> &mdash; reasonable limits subject to UCTA /
              CRA framework.
            </li>
            <li>
              <strong>Training and supervision</strong> &mdash; reduces likelihood of breaches that
              trigger vicarious liability.
            </li>
            <li>
              <strong>RAMS / CDM Construction Phase Plan</strong> &mdash; documented safe systems of
              work.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              Regulations, the cancellation period was extended to 12 months because the cooling-off
              information wasn&apos;t provided. Customer can rescind the contract and claim back
              payment, even though the work is fully done.
            </>
          }
          doInstead={
            <>
              Provide the cooling-off information at the quote stage on any contract signed in the
              consumer&apos;s home or by phone / online. Standard form is available from gov.uk /
              ICO; many trade-association template T&amp;Cs include it. If the customer wants you to
              start within 14 days, get a signed express request acknowledging the cooling-off
              rights and authorising early start &mdash; this preserves your right to be paid for
              work done if they later cancel.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Sole trader has been trading for 4 years, holding customer details routinely. Never
              registered with ICO &mdash; didn&apos;t know about it. ICO does a routine sweep of
              unregistered trade contractors using cross-referenced business databases. Serves a
              fixed enforcement notice and penalty &mdash; typically a few hundred to a few thousand
              pounds. Trader pays, registers, regrets &mdash; the registration was &pound;40/year
              for the lower tier.
            </>
          }
          doInstead={
            <>
              Register with ICO at the start of trading. &pound;40/year for the small-business tier
              (turnover &lt; &pound;632k AND fewer than 11 staff). Application takes 10 minutes at
              ico.org.uk. Set up the privacy notice template at the same time. Annual renewal
              reminder in your calendar. It&apos;s one of the easiest compliance items but widely
              missed by small contractors.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              <br />
              <br />
              <strong>Step 2 &mdash; visit and assess</strong>. Go back to the property; look at the
              specific issue raised; take photos. Check against the EIC and the test results.
              ...
              <br />
              <br />
              <strong>Step 3 &mdash; document everything</strong>. Photos of the work; copy of the
              quotation showing agreed scope; copy of the EIC and test results; written summary of
              your assessment and the customer&apos;s position. This evidence pack is what
              you&apos;d need at court if it goes that far.
              <br />
              <br />
              ...
              [date] [as above]. Please make payment within 14 days or I will issue proceedings via
              ...
              <br />
              <br />
              <strong>Step 7 &mdash; throughout, stay professional</strong>. No personal attacks; no
              inflammatory emails; no social-media public-shaming. Both because it&apos;s the right
              thing and because the judge will look at conduct. The professional contractor who
              calmly enforces a clear contract wins more often than the angry one with a sloppy
              paper trail.
            </>
          }
          whyItMatters={
            <>
              ...
              resolves. CRA 2015 provides the substantive standard; the Limitation Act, Money Claim
              Online and small claims court provide the enforcement framework if needed. Most
              disputes settle short of court when you handle them properly from day one.
            </>
          }
        />
