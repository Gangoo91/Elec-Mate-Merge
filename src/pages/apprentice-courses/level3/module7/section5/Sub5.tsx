...
const checks = [
  {
    ...
    options: [
      ...
      'Completed within 24 hours regardless.',
      'Guaranteed for life.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Keep it indefinitely in case it might be useful.',
      "UK GDPR doesn't apply to small businesses.",
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      "Tell them to use the warranty and disengage.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Only if you don't feel like doing it.",
      "Only if the customer can't pay upfront.",
    ],
    correctAnswer: 1,
    explanation:
