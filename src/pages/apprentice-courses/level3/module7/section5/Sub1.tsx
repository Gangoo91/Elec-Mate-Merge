...
const checks = [
  ...
  },
  {
    ...
    question:
      'When answering a competency question in an interview, the STAR technique stands for:',
    options: [
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 5 · Subsection 1"
        title="Writing CVs and preparing for interviews"
        backTo="/study-centre/apprentice/level3-module7-section5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Electrician-specific CV structure, describing trade experience effectively, ECS card
          grades, STAR technique, practical trade tests and the follow-up.
        </p>
        ...
        >
          <p>Recommended structure for an electrician&apos;s CV:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Header</strong> &mdash; Name, location (town/city only, not full address),
              phone, email.
            </li>
            <li>
              <strong>Qualifications</strong> &mdash; Level 3 Diploma, AM2 / AM2S date, ECS card
              grade + expiry, C&amp;G 2382 edition, C&amp;G 2391, specialist tickets,
              health-and-safety certs.
            </li>
            <li>
              <strong>Employment history</strong> &mdash; most recent first; for each role include
              dates, employer, your title, types of work, project scale, equipment used.
            </li>
            <li>
              <strong>Skills</strong> &mdash; technical (test equipment familiarity, cable types
              worked with, software used), trade-specific (containment systems, fault-finding
              speciality, sectors).
            </li>
            <li>
              <strong>CPD</strong> &mdash; recent training, manufacturer courses, regs updates
              within the last 2 years.
            </li>
            <li>
              <strong>References</strong> &mdash; available on request; have two ready (current /
              recent employer + character reference).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>Trim-priority order when running long:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          <p>For each previous role, cover:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Types of work</strong> &mdash; domestic, commercial, industrial; 1st-fix,
              2nd-fix, maintenance, T&amp;C work.
            </li>
            <li>
              <strong>Project examples</strong> &mdash; sectors (retail, office, education,
              healthcare, industrial), scale, occasional named projects.
            </li>
            <li>
              <strong>Equipment</strong> &mdash; test gear brands, containment types, panel brands,
              EV / PV brands.
            </li>
            <li>
              <strong>Certifications issued</strong> &mdash; EIC, Minor Works, EICR; named-tester /
              QS status.
            </li>
            <li>
              <strong>Supervisory responsibility</strong> &mdash; team size, apprentice mentoring,
              lead-electrician roles.
            </li>
            <li>
              <strong>Quantification</strong> &mdash; project values, team sizes, certificate
              volumes where you can.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>What to tailor per application:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          <p>Research before the interview:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>The firm</strong> &mdash; website, types of work, sectors, recent projects,
              size, CPS scheme registrations, geographic reach.
            </li>
            <li>
              <strong>The role</strong> &mdash; advert requirements, qualifications needed, working
              pattern, location range.
            </li>
            <li>
              <strong>The interviewers</strong> &mdash; LinkedIn backgrounds where available; how
              they fit in the firm.
            </li>
            <li>
              <strong>The market context</strong> &mdash; current pay rates, industry trends,
              anything in trade press relevant to the firm.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Action</strong> &mdash; what you specifically did (25-35 seconds; the meat of
              the answer).
            </li>
            <li>
              <strong>Result</strong> &mdash; outcome, what was learned, what changed (10-15
              seconds).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>The professional follow-up sequence:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>If unsuccessful</strong> &mdash; ask for feedback briefly; thank them; move on
              without rancour.
            </li>
            <li>
              <strong>If successful</strong> &mdash; respond promptly to the offer; ask for 24-48
              hours to consider if needed; respond formally.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Newly-qualified electrician writes a CV based on a generic graduate-CV template they
              found online. Personal statement at the top. Education section in the middle. ECS card
              and AM2 buried on page 2. QS scanning the CV stack spends 20 seconds, doesn&apos;t
              find the qualifications quickly, moves on. Candidate gets no interview despite being
              well-qualified.
            </>
          }
          doInstead={
            <>
              Use a trade-specific CV layout: header with contact details, qualifications block at
              the top (ECS grade, AM2 date, Level 3, 2382 edition, 2391 if held, specialist
              ...
              the qualifications block at the top is everything &mdash; that&apos;s what gets the
              interview.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              they&apos;ve ever had, ending vaguely. Asked &quot;tell me about a challenging fault
              you fixed&quot;, they pause for 30 seconds then give a generic 2-sentence answer.
              Asked &quot;do you have any questions for us?&quot;, they say &quot;no, I think
              you&apos;ve covered everything.&quot; The interview feels flat; no offer materialises.
            </>
          }
          doInstead={
            <>
              ...
              answer. Rehearse 5-6 STAR stories from your experience. Write down 4-5 questions to
              ask. Print the role spec and your CV. Arrive 10-15 minutes early. That prep separates
              you from the 70% of candidates who don&apos;t do it.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              upgrade application (in progress). You&apos;ve been working as an apprentice for the
              same firm throughout the apprenticeship; you&apos;re now interviewing for an
              Installation Electrician role with a different commercial firm. Interview is at 09:00
              tomorrow at the firm&apos;s office; 30-minute conversation plus a 2-hour bench test in
              their workshop. How do you prepare?
            </>
          }
          whatToDo={
            <>
              <strong>Tonight &mdash; CV refresh</strong>. Update the CV with the AM2S pass date,
              the Gold ECS card application status, the qualifications block reflecting current
              status. Print 3 copies on plain white paper.
              <br />
              <br />
              <strong>Tonight &mdash; firm research</strong>. Read the firm&apos;s website
              thoroughly. Note their typical projects, sectors, scheme registrations (NICEIC? ECA?),
              team size if visible. Check their LinkedIn for recent posts; look up the interviewers
              if named.
              <br />
              <br />
              <strong>Tonight &mdash; STAR stories</strong>. Pick 5-6 stories from the
              apprenticeship: a fault you fixed; a customer interaction that went well; a safety
              issue you spotted; a difficult site situation. Sketch out the STAR structure for each
              in your notebook. Rehearse 2-3 aloud.
              <br />
              <br />
              <strong>Tonight &mdash; questions to ask</strong>. Write 5 questions: types of work,
              the team, development path, regs amendment training, anything specific to their
              advertised work.
              <br />
              <br />
              ...
              confirmation; ECS HSEA certificate; tools (in case the practical test wants you to use
              your own); notebook and pen. Lay out smart-casual clothes; clean shoes.
              <br />
              <br />
              <strong>Morning &mdash; arrival</strong>. Plan to arrive 10-15 minutes early. Phone on
              silent. Sit calmly; review notes briefly.
              <br />
              <br />
              <strong>Interview &mdash; key moves</strong>. 90-second &quot;tell me about
              yourself&quot; covering: apprenticeship at [firm], type of work, AM2S last month, Gold
              ECS in progress, what you&apos;re looking for next. Use STAR for competency questions.
              Honest about gaps (e.g. limited inspection-and-testing if true) and what you&apos;re
              working on. Ask the prepared questions when invited.
              <br />
              <br />
          ...
          whyItMatters={
            <>
              ...
              trade is also smaller than it looks &mdash; today&apos;s interviewer is
              tomorrow&apos;s customer or supplier; how you handle the day matters even if this
              particular role isn&apos;t the offer.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Section 5 hub</div>
          </button>
          <button
