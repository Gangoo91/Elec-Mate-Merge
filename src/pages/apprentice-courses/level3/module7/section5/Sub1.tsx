...
const checks = [
  {
    ...
    options: [
      ...
      'A creative colourful design with graphics.',
      'As much information as possible crammed onto one page.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'List the job title and dates only.',
      ...
      'Copy and paste the original job advert.',
      'Mention only your most recent role.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'As many pages as needed to include every job ever held.',
  ...
  },
  {
    ...
    options: [
      'Start with your childhood and work forward chronologically.',
  ...
  },
  {
    ...
    options: [
      ...
      "Never be asked — just accept what the interviewer tells you.",
      "Challenge the interviewer's statements about the firm.",
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Hidden by adjusting dates to overlap.',
      ...
      'Never mentioned in any way.',
      'Filled with invented employment.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only used for apprentice hiring.',
      'Always paid at your normal rate.',
    ],
    correctAnswer: 1,
    explanation:
