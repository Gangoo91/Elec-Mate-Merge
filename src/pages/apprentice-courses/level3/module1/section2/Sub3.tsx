...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'HASAWA s.7 (personal H&S duty), EAWR Reg 16 (competence), MHSWR Reg 14 (cooperate and report), CDM 2015 Reg 15 (worker), plus any specific regulation duty such as PUWER Reg 9 (training). Multiple parallel duties; same conclusion — refuse the unsafe instruction and escalate.' },
  ...
  ], correctAnswer: 3, explanation: 'It also covers being a designated H&S representative. Detriment includes sacking, demotion, removal from a job, disciplinary, victimisation and harassment. The single most-important employment-law protection for safety conduct — tribunal claim if breached.' },
  ...
  ], correctAnswer: 0, explanation: 'Qualifying disclosures cover criminal offences, breach of legal obligations, miscarriage of justice, danger to health and safety, and environmental damage. PIDA extends ERA s.44 protection to wider disclosures, including those made externally to a regulator. The key test is "reasonable belief".' },
  ...
  ], correctAnswer: 1, explanation: 'Often the firm\'s H&S manager or contracts manager — sometimes a separate H&S manager, sometimes an external consultant. They must have appropriate training, knowledge and experience. Knowing who they are in your firm is the L3 escalation address.' },
  ...
  ], correctAnswer: 3, explanation: 'Time-stamp it, retain a copy, and state the regulation cited or the risk identified. The contemporaneous written record is the strongest evidence in any subsequent ERA s.44 claim or HSE prosecution — reconstructed accounts months later are much weaker.' },
  ...
  ], correctAnswer: 0, explanation: 'At L2 most things needed supervisor sign-off; at L3 you can do more alone, but EIC sign-off, complex three-phase, hazardous areas, F-Gas, gas and asbestos licensed work all stay outside the scope. The L3 limit isn\'t fixed — it grows with experience and certification. The skill is honest self-assessment of where it sits today, for this task.' },
];
