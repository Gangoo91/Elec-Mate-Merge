...
const quizQuestions = [
  {
    id: 1,
    question:
      "What's the immediate response to discovering someone in contact with live electricity?",
    options: [
  ...
  },
  {
    id: 2,
    question:
      "After an electric shock, what's the appropriate medical response even if the casualty feels OK?",
    options: [
  ...
  },
  {
    id: 3,
    question:
      "What's the difference between an electrical burn and a thermal burn for first aid purposes?",
    options: [
  ...
  },
  {
    id: 8,
    question:
      "What's the relationship between the casualty's wishes and the supervisor's decisions after a shock?",
    options: [
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 2 · Subsection 1"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Remember from L2 — DR ABC, isolation first, 999, casualty care. At L3 the response expands
          to scene preservation, witness handling and the evidence trail the regulator will ask for
          next week.
        </p>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>ISOLATE</strong> the supply. Local switch, breaker, main fuse — whatever is
              fastest and effective.
            </li>
            <li>
              <strong>SEPARATE</strong> casualty from the source if they&apos;re still in contact.
              Non-conductive material only (dry wood, plastic).
            </li>
            <li>
              <strong>DR ABC</strong> — Danger, Response, Airway, Breathing, Circulation.
            </li>
            <li>
              <strong>999</strong> if breathing abnormal, unconscious, or any specified-injury
              indicator.
            </li>
            <li>
              <strong>CPR</strong> if breathing absent or abnormal. AED if available.
            </li>
            <li>
              <strong>Casualty care</strong> — burns cooled, casualty kept warm, monitored until
              ambulance arrives.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Superficial (1st degree)</strong> — red, painful, no blistering. Heals 3-7
              days.
            </li>
            <li>
              <strong>Partial thickness (2nd degree)</strong> — blistered, intensely painful. Heals
              2-3 weeks; scarring possible.
            </li>
            <li>
              <strong>Full thickness (3rd degree)</strong> — white / charred, often painless (nerves
              destroyed). Skin grafting often required.
            </li>
            <li>
              <strong>Electrical</strong> — surface mark may be deceptive; internal injury can be
              severe.
            </li>
            <li>
              RIDDOR Schedule 1 specified injury includes &quot;serious burns covering more than 10%
              of the body, or causing significant damage to eyes, respiratory system or other vital
              organs&quot;.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The first-aid duty. Employer must provide adequate kit and (where appropriate) trained
              first aiders. The HSE&apos;s &quot;First Aid at Work — Approved Code of Practice&quot;
              (L74) sets out how to assess what&apos;s adequate. Most construction and industrial
              sites require trained First Aiders (FAW qualification, 3-day course); domestic and
              small commercial sites may be Emergency First Aid at Work (EFAW, 1-day) at minimum. At
              L3 you should hold at least EFAW; many firms now require FAW for L3 and above.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Photographs from multiple angles — wide shot, mid-shot, close-up of the work area, the
              equipment, the locks, the voltage indicator readings, any visible damage.
            </li>
            <li>Position of all tools, instruments and PPE — leave them where they are.</li>
            <li>
              Position of all isolation devices — locks, MCBs, voltage indicators left as found.
            </li>
            <li>
              Ambient conditions noted — lighting, weather, presence of other personnel, time of
              day.
            </li>
            <li>
              Witnesses identified by name and contact, asked to write down what they saw on the day
              in their own words.
            </li>
            <li>
              Notify the firm&apos;s responsible person (H&amp;S manager, contracts manager,
              director) immediately by phone.
            </li>
            <li>Notify any principal contractor and any client representative on site.</li>
            <li>
              Do NOT speculate to anyone (witnesses, bystanders, customer) about cause or fault.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              person must follow the reporting procedure. ... Where any person at work suffers any
              of the injuries or conditions specified in Schedule 1 as a result of a work-related
              accident, the responsible person must follow the reporting procedure.&quot; Schedule 1
              specified injuries include any injury arising from working in an enclosed space which
              leads to hypothermia or heat-induced illness, and any injury requiring resuscitation.
              Reg 6: any accident causing more than 7 consecutive days&apos; incapacitation must be
              reported to HSE within 15 days.
            </>
          }
          meaning={
            <>
              After an electric shock incident, the supervisor&apos;s reporting duty under RIDDOR is
              independent of the casualty&apos;s preference. Death = immediate notification.
              Specified injury (resuscitation, unconsciousness, more than 24h hospitalisation) =
              within 10 days via the F2508 online form. Over-7-day incapacitation = within 15 days.
              Dangerous occurrence (e.g. unintended energy release with potential to cause serious
              harm even if no-one was hurt) is reportable in its own right under Schedule 2. Late
              reporting itself is an offence.
            </>
          }
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Document the recommendation in writing — text, email, job-pack note. Time-stamped.
            </li>
            <li>
              Escalate to senior manager if casualty refuses — &quot;I have a casualty refusing
              assessment, please advise&quot;.
            </li>
            <li>
              Decline to release the casualty to safety-critical work that day. They can sit in the
              van with a brew; they can&apos;t isolate live circuits.
            </li>
            <li>
              Update the firm&apos;s incident log with the full sequence, including the
              casualty&apos;s refusal.
            </li>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Early recognition and call for help</strong> — DR ABC, 999. Tell the operator
              &quot;cardiac arrest, possible electric shock&quot; — they may dispatch a community
              responder with an AED.
            </li>
            <li>
              <strong>Early CPR</strong> — chest compressions at 100-120/min, depth 5-6cm, allow
              full chest recoil. Rescue breaths if trained and willing; compressions-only if not.
            </li>
            <li>
              <strong>Early defibrillation</strong> — AED applied as soon as available. Follow the
              device&apos;s voice prompts.
            </li>
            <li>
              <strong>Post-resuscitation care</strong> — handover to ambulance crew with accurate
              timeline of events.
            </li>
            <li>
              <strong>Post-incident review</strong> — supports the AED, the responders, the rest of
              the team and the firm&apos;s future preparation.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>M — Mechanism</strong> of injury — &quot;230V shock from line conductor to
              ground via right hand&quot;.
            </li>
            <li>
              <strong>I — Injuries</strong> seen or suspected — entry / exit burns, possible cardiac
              involvement.
            </li>
            <li>
              <strong>S — Signs</strong> — pulse, breathing rate, conscious level (AVPU scale), skin
            ...
            <li>Plus: any known medical history (if available), any medications, any allergies.</li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              suitable persons as is adequate and appropriate in the circumstances for rendering
              first-aid to his employees if they are injured or become ill at work.&quot;
            </>
          }
          meaning={
            <>
              The first-aider duty. The HSE&apos;s &quot;needs assessment&quot; approach (set out in
              L74 ACoP) determines what counts as adequate. Construction and industrial sites
              typically need at least one trained First Aider per shift / site; higher-risk sites
              need more. At L3 you should hold at least Emergency First Aid at Work (EFAW); many
              firms now require First Aid at Work (FAW) for L3 and above because the role frequently
              includes site responsibility.
            </>
          }
          cite="Source: Health and Safety (First Aid) Regulations 1981 (SI 1981/917), Reg 3."
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Immediate</strong> — shock, tearfulness, withdrawal, irritability, difficulty
              concentrating, intrusive replays of the event.
            </li>
            <li>
              <strong>First 1-4 weeks</strong> — sleep disturbance, avoidance of similar situations,
              hypervigilance, mood changes. Often resolves with social support and normal life.
            </li>
            <li>
              <strong>Beyond 4 weeks</strong> — if symptoms persist or worsen, that&apos;s when
              professional support (GP, occupational health, EAP counsellor) becomes important.
            </li>
            <li>
              <strong>Risk factors for longer-term impact</strong> — close personal connection to
              the casualty, perception of personal responsibility, lack of social support,
              pre-existing mental health vulnerability.
            </li>
            <li>
              <strong>Supervisor actions</strong> — talk to affected team members; allow time off
              without penalty; signpost to EAP and GP; document the support offered.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice has a shock from a back-box that wasn&apos;t isolated. Casualty taken to
              A&amp;E by ambulance. Supervisor, anxious about how the site looks, starts
              &quot;tidying up&quot; — packs the apprentice&apos;s tools back into the toolbox,
              removes the lock-off devices that weren&apos;t in place, puts the voltage indicator
              back in its case. By the time the HSE inspector arrives the next morning the scene is
              gone. The inspector infers the firm has something to hide, formal warning, FFI
              invoiced for investigation time, prosecution likely.
            </>
          }
          doInstead={
            <>
              Photograph everything as it is. Don&apos;t move anything. Notify the firm. Wait for
              the inspector. The cost of the photos is nothing; the cost of a tidied scene is
              enormous because the firm has lost both its evidence AND the inspector&apos;s
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Casualty had a brief shock; says they&apos;re fine; insists on driving themselves
              home. Supervisor agrees. Casualty has a delayed cardiac event en route, crashes the
              van into a wall, sustains worse injuries than the original shock. Insurance
              investigates; HSE attends; the supervisor&apos;s decision to release them to drive
              becomes the central failure.
            </>
          }
          doInstead={
            <>
              Mandatory medical assessment. No driving alone. Either ambulance or a colleague drives
              them to A&amp;E. The 30-minute delay to find a driver is nothing compared to the
              consequences of an en-route cardiac event.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re running a small domestic CU change. Your L2 mate is removing an old cable
              from a back-box on a circuit you both believed was isolated. You hear a bang and a
              yelp; the L2 has had a shock from the cable&apos;s line conductor. They&apos;re
              upright but visibly shaken; their hand has a small black mark where the conductor
              touched. The customer is in the next room. The kitchen circuit you were both working
              on is no longer the only thing live — turns out the previous installer ran a separate
              spur off another circuit into the same back-box.
            </>
          }
          whatToDo={
            <>
              Step 1 — isolate the unexpected supply. Identify and lock-off the second circuit
              before doing anything else; you don&apos;t know if there&apos;s a third. Step 2 —
              assess the casualty: DR ABC, ask about feeling, look at the burn, check pulse and
              breathing. Step 3 — call 999 (mains shock, visible burn, even if casualty seems OK).
              Step 4 — phone your supervisor / contracts manager and the customer&apos;s
              point-of-contact. Step 5 — preserve the scene: photograph the back-box as found, the
              visible marking on the conductor, the position of locks and voltage indicator, the
              second circuit you discovered. Don&apos;t restore power. Don&apos;t continue work.
              Step 6 — written witness account from yourself and any other person present, on the
              day. Step 7 — once ambulance has the casualty, brief the customer factually but
              don&apos;t speculate on cause. Step 8 — RIDDOR consideration: this is potentially a
              specified injury (serious burn) and possibly a dangerous occurrence depending on
              facts. Inform the firm&apos;s responsible person who decides on the F2508. Step 9 —
              document everything in writing in the next 24 hours.
            </>
          }
          whyItMatters={
            <>
              The undiscovered second circuit is the kind of latent hazard the dynamic risk
              assessment exists to flag — but no test is perfect. Once the incident has happened,
              the L3 supervisor response is what determines whether the firm has a defensible
              position. The unexpected second circuit is now critical evidence; the moment it&apos;s
              &quot;tidied up&quot; the prosecution&apos;s job becomes much easier. Photographing it
              and preserving the scene is the single most-impactful 60 seconds of the response. The
              casualty&apos;s &quot;I&apos;m fine&quot; doesn&apos;t change the medical or
              regulatory pathway.
            </>
          }
        />
        ...
        <Quiz
          title="Accident response and electric shock — knowledge check"
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">
              2.2 Emergency procedures — running the response
            </div>
          </button>
        </div>
      </HubBody>
