...
const TITLE =
  'RIDDOR F2508 process — responsible-person walkthrough (2.5) | Level 3 Module 1.2.5 | Elec-Mate';
const DESCRIPTION =
  'L3 walkthrough of the RIDDOR F2508 / F2508A process — trigger identification, online portal flow, retention, follow-up and the inevitable HSE conversation that follows.';

const checks = [
  {
    id: 'l3-m1-s2-sub5-trigger',
    question: 'Which of these triggers an IMMEDIATE phone notification (not 10-day F2508)?',
    options: [
    ...
    correctIndex: 0,
    explanation:
      'Fatality and specified injury (fracture excl fingers/thumbs/toes) get an immediate phone to HSE on 0345 300 9923, with the F2508 within 10 days. An over-7-day injury is F2508A within 15 days; A&E attendance alone and most occupational diseases are not immediate-phone triggers.',
  },
  {
    id: 'l3-m1-s2-sub5-form',
    question: 'Who actually fills in the F2508?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      "For an employee incident on a contractor's site it's normally the contractor employer. The L3 operative escalates to the responsible person with the facts; the responsible person makes the report, not the operative directly.",
  },
  {
    id: 'l3-m1-s2-sub5-retain',
    question: 'How long must RIDDOR records be retained?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Three-year statutory minimum under Reg 12. The HSE may request retrospective access during investigations or sector reviews. Many firms retain far longer given the Defective Premises Act 30-year retrospective limit (BSA 2022 s.135) and PI insurance considerations.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question: 'How is a RIDDOR report normally submitted?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'The online portal is the standard route — F2508 for incidents/dangerous occurrences, F2508A for over-7-day injuries and occupational diseases. Phone notification is reserved for the highest-priority categories (fatality, specified injury) where immediate notification is expected.',
  },
  {
    id: 2,
    question: "What's the F2508 vs F2508A distinction?",
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Two forms; two timescales. Knowing which applies to which trigger is L3-essential.',
  },
  {
    id: 3,
    question: 'When does the 10-day clock start?',
    options: [
    ...
    correctAnswer: 3,
    explanation:
      "If a casualty is hospitalised on Monday and the firm reports the following Thursday, that's 3 days into the 10-day window. Late reports are a separate offence under Reg 6 — they add a second offence to the underlying breach.",
  },
  {
    id: 4,
    question: 'What information does the F2508 require?',
    options: [
    ...
    correctAnswer: 0,
    explanation:
      "It also captures what the casualty was doing, the kind of accident and who else was involved. Full and accurate completion is the responsible person's job; gathering the facts is often the L3 operative's job — your contemporaneous notes from the scene feed the F2508 directly.",
  },
  {
    id: 5,
    question: 'What happens after a RIDDOR report is submitted?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Whether HSE attends depends on severity and wider context (recurrence, sector trends, public interest); for specified injuries and fatalities a follow-up visit is normally expected. RIDDOR feeds the HSE's intelligence picture and reports drive enforcement decisions.",
  },
  {
    id: 6,
    question: 'Can a RIDDOR report be amended after submission?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Examples include an injury upgraded from over-3-day to over-7-day, or a fatality following an initial specified-injury report. Updates are encouraged — the HSE wants accurate intelligence and corrected reports help.',
  },
  {
    id: 7,
    question: "What's the operative's role in the F2508 process?",
    options: [
    ...
    correctAnswer: 3,
    explanation:
      "The operative also provides witness information, preserves evidence and cooperates with any HSE follow-up. They aren't normally the report-maker but are the source of the facts — operative = facts source; responsible person = report-maker. Clean separation.",
  },
  {
    id: 8,
    question: 'When should the HSE be notified BEFORE the F2508 is submitted?',
    options: [
    ...
    correctAnswer: 0,
    explanation:
      'The phone notification is the formal "without delay" requirement under Reg 6. The highest-priority categories get phone-then-form; lower categories go through the online portal direct.',
  },
];

const faqs = [
  {
    question: 'Who pays for HSE follow-up after a RIDDOR report?',
    answer:
      'If the inspector identifies a "material breach" during follow-up, FFI applies (~£170/hr inspector time billed to the dutyholder). A clean follow-up where no breach is found is free.',
  },
  {
    question: 'Should the firm always over-report rather than risk under-reporting?',
    answer:
      "When in doubt, report. The HSE doesn't penalise over-reporting. Late or missed reports ARE a separate offence (Reg 6). Defensive reporting is the safer default.",
  },
  {
    question: 'Does a RIDDOR report mean the firm has admitted fault?',
    answer:
      'No. RIDDOR is a statistical / intelligence reporting regime, not a fault admission. The HSE uses it to decide where to focus inspection and prosecution. The firm can defend the underlying breach separately.',
  },
  {
    question: 'What if the casualty refuses to consent to RIDDOR reporting?',
    answer:
      "Casualty consent isn't required — it's the responsible person's legal duty. Casualty's personal data is protected by data protection law but the report itself goes regardless of consent.",
  },
  {
  ...
  },
  {
    ...
    answer:
      'PI / EL insurers usually require notification of any incident likely to give rise to a claim — separate from RIDDOR. Late insurer notification can void cover. Many firms have an internal incident-management process that handles RIDDOR + insurance + customer comms in parallel.',
  },
  {
    question: 'Who has the right of access to RIDDOR records?',
    answer:
      'HSE inspectors have right of access under HASAWA s.20 to any RIDDOR records. Insurance companies typically request RIDDOR records as part of claim investigations or annual renewal. PQQ clients can request RIDDOR data. Employees and their representatives can request their own data under Data Protection Act 2018; redactions may apply to third-party information.',
  },
  {
    question: 'What if a self-employed contractor on our site has an incident — who reports?',
    answer:
      'The contractor as self-employed person is responsible for reporting their own RIDDOR-reportable injury to themselves. But the host firm has parallel responsibilities — they may also need to report under different categories (e.g. as "person in control of premises"), and their EAWR / CDM duties around contractor competence and supervision are likely to be relevant to the HSE investigation. Both firms should liaise on the reporting and the response.',
  },
  {
    question:
      'Does a verbal apology to the casualty after an incident count as admission of liability?',
    answer:
  ...
  {
    question: 'What if the incident happened to a member of the public, not an employee?',
    answer:
      'Public-injury incidents on your firm’s work activity are reportable under RIDDOR Reg 5 if the person was injured and taken from the scene of the accident to hospital for treatment in respect of that injury. The reporting category is different from employee injuries but the timescales are the same. The PL insurer notification runs in parallel. CDM 2015 may add design / Principal Contractor duty considerations.',
  },
  {
    question: 'Are reports submitted to RIDDOR ever published publicly?',
    answer:
      'Individual RIDDOR reports are not published, but aggregate sectoral data is published in HSE statistics and may inform sector-targeted campaigns. Where prosecution follows, court records become public; firms can also be named in HSE press releases. PQQ clients can request RIDDOR statistics under their contractual rights.',
  },
];
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 2 · Subsection 5"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'Remember from L2 — RIDDOR is the reporting regulation. At L3 the depth is the end-to-end process: trigger → escalation → form completion → submission → retention → follow-up.'
          }
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fatality</strong> — IMMEDIATE phone (0345 300 9923) + F2508 within 10 days.
            </li>
            <li>
              <strong>Specified injury (Schedule 1)</strong> — IMMEDIATE phone + F2508 within 10
              days.
            </li>
            <li>
              <strong>Over-7-day injury</strong> — F2508A within 15 days.
            </li>
            <li>
              <strong>Dangerous occurrence (Schedule 2)</strong> — F2508 within 10 days.
            </li>
            <li>
              <strong>Reportable disease (Schedule 3)</strong> — F2508A.
            </li>
            <li>
              <strong>Gas incident</strong> — separate Reg 11–12 scheme.
            </li>
            <li>
              <strong>Member of public taken to hospital (Reg 5)</strong> — F2508 within 10 days.
            </li>
            <li>
              <strong>Self-employed similar list (Reg 4(2))</strong> — F2508 within 10 days.
            </li>
            <li>
              <strong>When category uncertain</strong> — default to higher category; the HSE does
              not penalise over-reporting but does penalise under-reporting under Reg 6.
            </li>
            <li>
              <strong>Amendment after submission</strong> — supported by the portal; honest update
              preferred over stale partial record.
            </li>
          </ul>
        </ConceptBlock>

        <RegsCallout
          source="Reporting of Injuries, Diseases and Dangerous Occurrences Regulations 2013 — Reg 6"
          clause={
            <>
              "The responsible person must follow the reporting procedure when the responsible
              person becomes aware of the death of any person, the suffering of a specified injury
              at work, the suffering of an injury that results in a person being incapacitated for
              more than 7 consecutive days, the suffering of an occupational disease, or the
              occurrence of a dangerous occurrence. The reporting procedure is — (a) the responsible
              person must without delay notify the relevant enforcing authority of the death,
              accident, occurrence or case by the quickest practicable means; and (b) within 10 days
              of the death, accident, occurrence or case, the responsible person must send a report
              of it to the relevant enforcing authority in an approved manner."
            </>
          }
          meaning={
            <>
              Reg 6 puts the duty on the responsible person to follow the prescribed reporting
              procedure (phone for the highest categories, F2508/F2508A within timescales). The L3
              operative&apos;s role is to alert the responsible person promptly and accurately; the
              responsible person discharges Reg 6. The &quot;quickest practicable means&quot;
              wording sets the bar — text, phone or email; the 10-day clock for the formal F2508
              runs from the date of the incident, not from when the firm decided to act.
            </>
          }
          cite="Source: Reporting of Injuries, Diseases and Dangerous Occurrences Regulations 2013 (SI 2013/1471), Reg 6."
        />
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              For fatality / specified injury — responsible person phones 0345 300 9923 without
              delay.
            </li>
            <li>
              For all categories — responsible person submits F2508 / F2508A via riddor.hse.gov.uk
        ...
        <ConceptBlock
          ...
          plainEnglish="riddor.hse.gov.uk is the modern reporting route. F2508 and F2508A are completed online; PDF copy emailed to the firm; HSE record created. Phone 0345 300 9923 used only for fatality / specified-injury immediate notification. The portal also supports F2508G (gas incidents under Reg 11) for Gas Safe registered businesses."
          onSite="Most firms have a single account on the portal — usually the H&S manager or a director-level safety lead. Operatives feed facts to that account-holder; the account-holder submits. Multi-site firms with several reporting points should still maintain a single consolidated account for audit consistency."
        >
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Site visit — for serious incidents, fatalities, or where the inspector judges a visit
              warranted.
            </li>
            ...
            <li>
              Sector intelligence — RIDDOR reports feed HSE statistics and inform sector campaigns.
            </li>
            <li>
              Cross-reference with other regulators — Environment Agency, Fire and Rescue Service,
              scheme body, local authority where relevant.
            </li>
            <li>
              Industry alerts — the HSE may issue a sector safety alert if the incident reveals a
              pattern affecting other firms.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Right to silence</strong> — but adverse inference may be drawn if you later
              rely on something you didn&apos;t mention.
            </li>
            <li>
            ...
            <li>
              <strong>Recording</strong> — the interview is recorded (audio/video) and transcribed.
            </li>
            <li>
              <strong>Disclosure</strong> — you should be told the broad nature of the allegation
              before answering.
            </li>
            <li>
              <strong>Self-incrimination protection</strong> — you don&apos;t have to incriminate
              yourself, but you must not deceive or mislead.
            </li>
            <li>
              <strong>Post-interview</strong> — you should receive a copy of the transcript; review
              with your solicitor for accuracy.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Work undertaken</strong> — circuits, equipment, methods, isolation points.
            </li>
            <li>
              <strong>Findings</strong> — anything unexpected, anything that didn&apos;t match the
              plan.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Witness identity</strong> — full name, contact, relationship to the event
              (employee, customer, visitor, contractor).
            </li>
            <li>
            ...
            <li>
              <strong>Location</strong> of the witness during the event — were they actually in a
              position to see what they describe?
            </li>
            <li>
              <strong>Account in their own words</strong> — chronological if possible.
            </li>
            <li>
              <strong>What they saw / heard</strong> — sensory description; not opinion or cause
              attribution.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Site visit</strong> (serious cases) — inspector attends; investigation may
              extend to PACE-cautioned interviews if breach suspected.
            </li>
            <li>
              <strong>Notice of Contravention + FFI</strong> — if material breach found.
            </li>
            <li>
              <strong>Improvement / prohibition notice</strong> — if structural change required.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              person must follow the reporting procedure.&quot; And Reg 6(1): &quot;The reporting
              procedure is — (a) the responsible person must without delay notify the relevant
              enforcing authority of the death, accident, occurrence or case by the quickest
              practicable means; and (b) within 10 days of the death, accident, occurrence or case,
              the responsible person must send a report of it to the relevant enforcing authority in
              an approved manner.&quot;
            </>
          }
          meaning={
            <>
              The two-stage reporting procedure for the highest-priority categories: immediate phone
              notification (&quot;without delay ... by the quickest practicable means&quot;)
              followed by the F2508 within 10 days. For over-7-day injuries (Reg 4(2)) the timescale
              is 15 days from the incident. For diseases (Reg 8) the report follows diagnosis. The
              10-day clock is from incident, not from diagnosis or from when the firm decided to
              report — late reports are a separate offence under Reg 6 itself.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              record must be kept for at least 3 years from the date on which it was made and must
              contain such particulars as may be approved from time to time by the Executive.&quot;
            </>
          }
          meaning={
            <>
              The retention duty. Records must be kept for at least 3 years and made available on
              request to inspectors. In practice firms keep them indefinitely because the BSA 2022
              s.135 amendment to the Defective Premises Act extends liability for residential work
              to 30 years retrospectively, professional indemnity insurers expect long retention,
              and PQQs commonly ask for 5+ year histories. Digital storage with daily backup is the
              standard approach; paper accident books on their own are no longer adequate for any
              sizeable firm.
            </>
          }
        ...
        <SectionRule />
        <CommonMistake
          title="Operative tries to make the report personally"
          whatHappens={
            <>
              Apprentice on small site has incident; tries to phone HSE directly without telling the
              firm. Firm only finds out from HSE follow-up call days later. Internal communications
              / insurance notification routes broken. Firm prosecuted for late or inaccurate
              reporting because the apprentice&apos;s phone account didn&apos;t have the
              responsible-person details correct.
            </>
          }
          doInstead={
            <>
              Operative escalates to firm responsible person immediately. Responsible person makes
              the formal report. Operative provides facts and assists.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              reporting. Injury confirmed serious by Wednesday. F2508 filed on day 12. Late report =
              separate Reg 6 offence. Stacks on top of underlying breach. Two charges instead of
              one.
            </>
          }
          doInstead={
            <>
              When in doubt, report. Update the report later if facts change. Late reporting is
              itself an offence regardless of the underlying breach severity.
            </>
          }
        />

        <Scenario
          title="L3 walking through an end-to-end RIDDOR"
          situation={
            <>
              You&apos;re running a small commercial install with one L2 mate. Mid-morning the L2
              falls from a 3-step podium-style platform — the rubber feet had perished. They land
              awkwardly and immediately complain of severe ankle pain; can&apos;t put weight on it.
              You arrange transport to A&amp;E (van + you driving, customer on standby). At A&amp;E
              the X-ray confirms a fracture. The L2 will be off normal duties for at least 3 weeks.
            </>
          }
          whatToDo={
            <>
              Immediate sequence: (1) on site — render first aid, organise transport (don&apos;t let
              them drive themselves), photograph the platform with perished feet visible, photograph
              the work area, get the platform tagged out of service. (2) Notify firm responsible
              person by phone immediately — &quot;L2 has fallen from podium, possible fracture,
              transporting to A&amp;E now&quot;. (3) At A&amp;E — accompany if possible; obtain
              initial diagnosis from casualty/medical team. (4) Notify firm again with confirmed
              diagnosis — &quot;fracture confirmed, looks like 3+ weeks off&quot;. (5) Report
              writing — same day write contemporaneous account: time, sequence, condition of
              platform, weather, lighting, witnesses (yourself, customer, A&amp;E paperwork).
              Trigger identification: fracture (excl fingers/thumbs/toes) is a SPECIFIED INJURY
              under Schedule 1. Responsible person must phone HSE 0345 300 9923 today and submit
              F2508 within 10 days. (6) Witnesses — written statement from yourself; customer
              statement if they witnessed; sign-off by responsible person. (7) Equipment — pull all
              similar platforms from fleet for inspection; document the fleet check. (8) Insurance
              notification — separate to RIDDOR; firm&apos;s EL insurer notified within their
              required timescale. (9) Preserve the failed platform itself for possible HSE
              follow-up. (10) Retain all records 3+ years; in practice indefinitely.
            </>
          }
          whyItMatters={
            <>
              This is a textbook L3 supervisor walkthrough. The fracture triggers the
              highest-priority category (immediate phone notification + F2508 within 10 days). Your
              contemporaneous account, the photographs of the perished feet, and the equipment
              preservation create the evidence trail the firm&apos;s defence and the HSE&apos;s
              investigation both rely on. Pulling the rest of the fleet for inspection is the
              supervisor act that prevents the next incident — and demonstrates to the HSE that the
              firm is taking the lessons seriously, which often shapes the enforcement decision
              (notice vs prosecution).
            </>
          }
        />
        ...
        <SectionRule />
        <ContentEyebrow>
          The HSE&apos;s decision framework — Enforcement Management Model
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Potential consequence</strong> — what could have happened given the breach.
            </li>
            <li>
              <strong>Probability</strong> — how likely was harm given the situation.
            </li>
            <li>
              <strong>Risk gap</strong> — distance between actual control and benchmark standard.
            </li>
            <li>
              <strong>Public expectation</strong> — would the public expect enforcement on this
              matter (children, vulnerable persons, public-facing premises).
            </li>
            <li>
              <strong>Firm&apos;s history</strong> — repeated similar breaches, prior notices,
              prosecution history.
            </li>
            <li>
              <strong>Firm&apos;s response</strong> — cooperation, candour, remediation, visible
              commitment to change.
            </li>
            <li>
              <strong>Senior management failure</strong> — Corporate Manslaughter referral where
              applicable.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <SectionRule />
        <ContentEyebrow>
          Cross-reference table — RIDDOR vs EL / PL insurance notification
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Audience</strong> — RIDDOR goes to HSE; insurance notification goes to the EL
              / PL insurer (Employers&apos; Liability for staff incidents; Public Liability for
              third-party incidents).
            </li>
            <li>
              <strong>Trigger</strong> — RIDDOR triggers on the categories in Regs 4-8; insurance
              triggers on &quot;any circumstance likely to give rise to a claim&quot; — often a
              wider net than RIDDOR.
            </li>
            <li>
              <strong>Timescale</strong> — RIDDOR has prescribed statutory deadlines (immediate / 10
              days / 15 days); insurance is typically 7-14 days per policy terms, sometimes shorter.
            </li>
            <li>
              <strong>Format</strong> — RIDDOR uses F2508 / F2508A via portal; insurance uses the
              insurer&apos;s own notification form (online or via broker).
            </li>
            <li>
              <strong>Content</strong> — RIDDOR captures incident facts; insurance also captures
              contact details, expected severity, witness information.
            </li>
            <li>
              <strong>Privilege</strong> — insurance correspondence after notification may be
              subject to litigation privilege; RIDDOR records are not.
            </li>
            <li>
              <strong>Consequence of failure</strong> — RIDDOR lateness is a Reg 6 offence;
              insurance lateness can void cover for the specific incident.
            </li>
            <li>
              <strong>Audit trail</strong> — both regimes generate records that may be disclosed
              years later in subsequent civil claims or HSE prosecutions.
            </li>
            <li>
              <strong>Consistency</strong> — accounts to RIDDOR and to insurer must match;
              contradictions are detected and damage both processes.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <SectionRule />
        <ContentEyebrow>
          Case study — R v Conoco Phillips (UK) Ltd [2016] and the cost of inaccurate reporting
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Aggregate records become evidence</strong> — one report is a data point; five
              similar reports are a pattern; ten are a system failure.
            </li>
            <li>
              <strong>Selective reporting is detectable</strong> — operatives talk; inspectors check
              site logs against submitted reports; gaps get found.
            </li>
            <li>
              <strong>Corrective action tracking matters</strong> — what did the firm do after each
              previous report? If the answer is &quot;nothing visible&quot; the report counts
              against the firm not in its favour.
            </li>
            <li>
              <strong>The HSE&apos;s sectoral intelligence picture</strong> draws on aggregated
              RIDDOR data; firms that under-report can find themselves on sector-targeted inspection
              campaigns.
            </li>
            <li>
              <strong>PI / EL insurers also draw on RIDDOR data</strong> — significant
              under-reporting may emerge in a claim history audit and lead to coverage issues.
            </li>
            <li>
              <strong>Director knowledge</strong> — if the same director signed off each report and
              the pattern was visible, s.37 personal liability becomes hard to escape.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>(b) Amputation</strong> of an arm, hand, finger, thumb, leg, foot or toe.
            </li>
            <li>
              <strong>(c) Permanent loss of sight</strong> or reduction of sight in one or both
              eyes.
            </li>
            <li>
              <strong>(d) Crush injury</strong> to the head or torso causing damage to the brain or
              internal organs.
            </li>
            <li>
              <strong>(e) Serious burns</strong> (including scalding) which cover more than 10% of
              the body or cause significant damage to eyes, respiratory system or other vital
              organs.
            </li>
            <li>
              <strong>(f) Scalping</strong> (separation of skin from the head) requiring hospital
              treatment.
            </li>
            <li>
              <strong>(g) Loss of consciousness</strong> caused by head injury or asphyxia.
            </li>
            <li>
              <strong>(h) Injury arising from work in an enclosed space</strong> leading to
              hypothermia, heat-induced illness or requiring resuscitation, or requiring admittance
              to hospital for more than 24 hours.
            </li>
            <li>
              <strong>Self-employed similar list</strong> — Reg 4(2) applies the same categories to
              self-employed persons doing work under another&apos;s control.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <SectionRule />
        <ContentEyebrow>
          Dangerous occurrences — Schedule 2 (relevant to electrical work)
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electrical short circuit or overload</strong> causing fire or explosion
              resulting in plant stoppage for more than 24 hours, or which had the potential to
              cause death.
            </li>
            <li>
              <strong>Collapse, overturning or failure of load-bearing parts</strong> of lifts and
              lifting equipment.
            </li>
            <li>
              <strong>Failure of any closed vessel</strong> in which the internal pressure was above
              or below atmospheric, where the failure had the potential to cause death.
            </li>
            <li>
              <strong>Plant or equipment coming into contact with overhead power lines</strong>{' '}
              exceeding 200 volts.
            </li>
            <li>
              <strong>Electrical incident causing explosion or fire</strong> where the incident
              resulted in stoppage of the plant involved for more than 24 hours.
            </li>
            <li>
              <strong>Unintended collapse of any building or structure</strong> under construction,
              alteration or demolition.
            </li>
            <li>
              <strong>Unintended release of more than 100 kg of flammable liquid</strong>, or 10 kg
              of flammable liquid at temperature above its boiling point.
            </li>
            <li>
              <strong>Failure of breathing apparatus</strong> while in use or during testing
            ...
            <li>
              <strong>
                Dangerous occurrence at a mine, quarry, well, transport system, dock, pipeline or
        ...
        <SectionRule />
        <ContentEyebrow>
          Occupational diseases — Schedule 3 categories most likely to affect L3 electricians
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Carpal tunnel syndrome</strong> — work involves regular use of percussive or
              vibrating tools.
            </li>
            <li>
              <strong>Cramp of the hand or forearm</strong> — prolonged periods of repetitive
              movement of fingers, hands or arms.
            </li>
            <li>
              <strong>Occupational dermatitis</strong> — exposure to a known skin sensitiser or
              irritant.
            </li>
            <li>
              <strong>Hand-arm vibration syndrome</strong> — regular use of percussive or vibrating
              tools (drilling, breaking, chasing).
            </li>
            <li>
              <strong>Occupational asthma</strong> — exposure to a known respiratory sensitiser
              (rosin in soldering fume, certain isocyanates in adhesives).
            </li>
            <li>
              <strong>Tendonitis or tenosynovitis</strong> of the hand or forearm — physically
              demanding work involving frequent, repetitive movements.
            </li>
            <li>
              <strong>Any occupational cancer</strong> attributable to a Schedule 3 exposure —
              asbestos (mesothelioma, lung cancer, asbestosis), welding fume (since HSE 2019
              reclassification), some solvent exposures, ionising radiation.
            </li>
            <li>
              <strong>Any disease attributable to exposure to a biological agent</strong>— relevant
              where work involves wastewater, healthcare or animal contact.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">
              Section 3 — Establishing safe environment
            </div>
          </button>
        </div>
      </HubBody>
