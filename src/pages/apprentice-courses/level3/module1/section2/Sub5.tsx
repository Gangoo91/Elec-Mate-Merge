...
const checks = [
  ...
  ], correctIndex: 2, explanation: 'Reg 3 responsible person. The L3 operative\'s job is to escalate with the facts; the responsible person makes the report.' },
  ...
  ], correctIndex: 1, explanation: 'Three-year statutory minimum. Practice is often longer given Defective Premises Act 30-year retrospective limit (BSA 2022 s.135) and PI insurance considerations.' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'Online portal is the standard route. Phone reserved for the highest-priority categories.' },
  ...
  ], correctAnswer: 3, explanation: 'Clock starts at incident. Late reports add a second offence to the underlying breach.' },
  ...
  ], correctAnswer: 0, explanation: 'Comprehensive incident data. The L3 operative\'s contemporaneous notes from the scene feed the F2508 directly.' },
  ...
  ], correctAnswer: 1, explanation: 'RIDDOR feeds the HSE\'s intelligence picture. Reports drive enforcement decisions; the firm should expect follow-up for serious incidents.' },
  ...
  ], correctAnswer: 2, explanation: 'Updates are encouraged. The HSE wants accurate intelligence; corrected reports help.' },
  ...
  ], correctAnswer: 3, explanation: 'Operative = facts source; responsible person = report-maker. Clean separation.' },
  { id: 8, question: 'When should the HSE be notified BEFORE the F2508 is submitted?', options: [
    'For fatalities, specified injuries (Schedule 1) and certain serious dangerous occurrences — phone 0345 300 9923 as soon as practical, with the F2508 following within 10 days. The phone notification is the formal "without delay" requirement under Reg 6.',
  ...
  ], correctAnswer: 0, explanation: 'Highest-priority categories get phone-then-form. Lower categories online portal direct.' },
];
