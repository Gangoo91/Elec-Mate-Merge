...
const checks = [
  ...
  { id: 'l3-m1-s4-sub4-confined', question: 'What\'s a "confined space" under the Confined Spaces Regs 1997?', options: [
    ...
    'Any place which is substantially enclosed and where there is a reasonably foreseeable specified risk — fire/explosion, asphyxiation, drowning, hyperthermia, entrapment with serious injury. Examples: tank, vessel, silo, sewer, chamber, ductwork, void, sometimes lofts and cellars depending on conditions.',
  ], correctIndex: 3, explanation: 'Confined space = enclosed AND foreseeable specified risk. Not all small spaces; not all enclosed spaces. The risk profile defines it.' },
...
const quizQuestions = [
  { id: 1, question: 'What\'s a "slip" hazard situation?', options: [
    ...
    'Underfoot conditions (water, oil, dust, polished surface, weather) that reduce friction below safe level. Most common workplace injury cause; addressed by housekeeping, anti-slip surfaces, proper footwear, spillage clean-up.',
  ...
  ], correctAnswer: 1, explanation: 'Slips, trips and falls are the most common workplace injury category. Mostly preventable by housekeeping discipline.' },
  ...
  ], correctAnswer: 3, explanation: 'No legal maximum; risk assessment based. HSE filter values give starting points; assess and reduce as needed.' },
  ...
  ], correctAnswer: 0, explanation: 'Four specified risks per the 1997 Regs. Enclosed + risk = confined space; full controls apply (permit, atmosphere monitoring, rescue plan, standby person).' },
  ...
  ], correctAnswer: 1, explanation: 'Weather is a real hazard category. Dynamic risk assessment includes the day\'s weather and how it affects the planned work.' },
  ...
  ], correctAnswer: 2, explanation: 'Trip hazards = projecting at low level. Tripping electricians fall onto tools, into work areas, off edges. Major contributor to lost-time injuries.' },
  ...
  ], correctAnswer: 3, explanation: 'Housekeeping is leadership behaviour. The L3 supervisor models it; the team follows.' },
