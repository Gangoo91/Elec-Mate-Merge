...
const DESCRIPTION =
  'L3 workplace hazards — slips/trips, manual handling, working at height, confined spaces, weather. Supervisor framing and control hierarchies.';
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 4 · Subsection 4"
      ...
      <HubBody>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module1-section4-5')}
