...
const DESCRIPTION =
  'L3 CLP pictograms — nine GHS / CLP hazard pictograms, what each means, and reading the SDS for the full picture beyond the label.';
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module1-section4-2')}
