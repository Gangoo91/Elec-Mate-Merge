...
const checks = [
  { id: 'l3-m1-s4-sub1-pictograms', question: 'How many CLP / GHS hazard pictograms exist?', options: [
  ...
  ], correctIndex: 1, explanation: 'Nine pictograms in the GB CLP Regulation (UK\'s implementation post-Brexit; aligned with EU CLP): explosive, flammable, oxidising, gas under pressure, corrosive, acute toxicity, harmful / irritant, health hazard (chronic) and environmental. Knowing all nine and their headline meanings is L3-essential.' },
  { id: 'l3-m1-s4-sub1-sds', question: 'What\'s an SDS and why is the L3 reading it, not just the label?', options: [
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'GB CLP is the UK\'s post-Brexit implementation of the CLP rules (formerly EU CLP), aligned with the UN Globally Harmonised System (GHS). It defines how hazardous chemicals must be classified, labelled and packaged for supply.' },
  { id: 2, question: 'What does the "exploding bomb" pictogram indicate?', options: [
  ...
  ], correctAnswer: 2, explanation: 'The exploding-bomb pictogram covers explosive substances and articles, self-reactive substances, and organic peroxides — anything that can detonate or undergo violent self-reactive decomposition. Rare in electrical work, but check labels.' },
  { id: 3, question: 'What does the "flame" pictogram indicate?', options: [
  ...
  ], correctAnswer: 3, explanation: 'The flame pictogram covers flammable gases, aerosols, liquids and solids; pyrophoric substances (catch fire on contact with air); self-heating substances; and substances which emit flammable gases on contact with water. Common in solvents, cleaners and contact sprays.' },
  { id: 4, question: 'What does the "flame over circle" pictogram indicate?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Oxidisers feed fire. Stored separately from flammables.' },
  { id: 5, question: 'What does the "skull and crossbones" pictogram indicate?', options: [
  ...
  ], correctAnswer: 1, explanation: 'Acute toxicity means short-term harm from a single or short exposure (oral, dermal or inhalation), including acutely toxic gases, liquids and solids. It is distinguished from chronic / long-term toxicity, which needs a different management strategy.' },
  { id: 6, question: 'What does the "corrosion" pictogram indicate?', options: [
  ...
  ], correctAnswer: 2, explanation: 'The corrosion pictogram covers substances that cause skin burns and eye damage and are corrosive to metals, including strong acids and bases. Splash exposure or eye contact requires an immediate eye-wash / shower response, so an eye-wash kit and emergency shower matter for sites handling them.' },
  { id: 7, question: 'What does the "exclamation mark" pictogram indicate?', options: [
  ...
  ], correctAnswer: 3, explanation: 'The exclamation-mark pictogram covers harmful / irritant substances: acute toxicity less severe than the skull category, skin / eye irritation, skin sensitisation, respiratory tract irritation and narcotic effects. These are lower severity than the more specific pictograms, but still require PPE and the hierarchy of control — not "minor" because of the pictogram.' },
  { id: 8, question: 'What does the "environment" pictogram (dead tree and fish) indicate?', options: [
  ...
  ], correctAnswer: 0, explanation: 'The environment pictogram covers substances hazardous to the aquatic environment, acute or chronic — those that cause death of aquatic life or long-term damage to aquatic ecosystems. It triggers waste-handling and discharge controls; the disposal route is critical and these cannot go to general drainage (EPA s.34 duty of care + Environmental Permitting Regs).'  },
];
