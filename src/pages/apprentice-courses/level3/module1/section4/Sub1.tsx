...
const checks = [
  ...
  ], correctIndex: 1, explanation: 'Nine pictograms in the GB CLP Regulation (UK\'s implementation post-Brexit; aligned with EU CLP). Knowing all nine and the headline meanings is L3-essential.' },
  ...
  ], correctIndex: 2, explanation: 'The SDS is the operational reference. L3 supervisor reads it before substances come on site; ensures it\'s available to operatives.' },
  ...
  ], correctIndex: 0, explanation: 'Health hazard ≠ skull. Skull = acute toxicity (short-term). Silhouetted figure = chronic / long-term. Important distinction because the management strategy differs.' },
];
...
const quizQuestions = [
  { id: 1, question: 'What does GB CLP stand for?', options: [
    ...
    'Great Britain Classification, Labelling and Packaging Regulation. UK\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\'s post-Brexit implementation of the CLP rules (formerly EU CLP). Aligned with the UN Globally Harmonised System (GHS). Defines how hazardous chemicals must be classified, labelled and packaged for supply.',
  ...
  ], correctAnswer: 1, explanation: 'GB CLP is the UK regulation; aligns with EU CLP and GHS. Post-Brexit the UK retained the CLP framework.' },
  { id: 2, question: 'What does the "exploding bomb" pictogram indicate?', options: [
    ...
    'Explosive substances and articles, self-reactive substances, organic peroxides — anything that can detonate or undergo violent self-reactive decomposition.',
  ...
  ], correctAnswer: 2, explanation: 'Explosives and self-reactives. Rare in electrical work but check labels.' },
  { id: 3, question: 'What does the "flame" pictogram indicate?', options: [
    ...
    'Flammable substances — gases, aerosols, liquids, solids; pyrophoric (catches fire on contact with air); self-heating; substances which in contact with water emit flammable gases.',
  ], correctAnswer: 3, explanation: 'Flammables. Common in solvents, cleaners, contact sprays.' },
  ...
  ], correctAnswer: 1, explanation: 'Acute toxicity = short-term harm from a single or short exposure. Different management strategy from chronic.' },
  ...
  ], correctAnswer: 2, explanation: 'Corrosives need immediate first-aid response. Eye-wash kit and emergency shower important for sites handling them.' },
  ...
  ], correctAnswer: 3, explanation: 'Lower-severity hazards. Still requires PPE and hierarchy of control; not "minor" because of the pictogram.' },
  { id: 8, question: 'What does the "environment" pictogram (dead tree and fish) indicate?', options: [
    'Hazardous to the aquatic environment — acute or chronic. Substances that cause death of aquatic life or long-term damage to aquatic ecosystems. Triggers waste-handling and discharge controls.',
    ...
    '"C2 — Lack of earthing to exposed-conductive-parts at distribution board. Remedial action: install main earthing conductor to meet Regulation 411.3.1.1."',
  ], correctAnswer: 0, explanation: 'Environmental hazard pictogram. Disposal route critical; can\'t go to general drainage. EPA s.34 duty of care + Environmental Permitting Regs.'  },
];
