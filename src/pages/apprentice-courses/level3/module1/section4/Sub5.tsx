...
const checks = [
  ...
  ], correctIndex: 0, explanation: 'Remember from L2 — CO2 or dry powder for electrical. Water and foam conduct.' },
  { id: 'l3-m1-s4-sub5-conditions', question: 'When is it safe to use an extinguisher?', options: [
    'Only when (a) trained; (b) fire is small (waste-bin size); (c) correct extinguisher class identified; (d) escape route behind you; (e) someone else has called 999; (f) you can withdraw safely if it fails. Otherwise EVACUATE.',
  ...
  ], correctIndex: 0, explanation: 'Six conditions for safe extinguisher use. Default is evacuate; fight only when conditions met.' },
  { id: 'l3-m1-s4-sub5-class-f', question: 'What\'s a Class F fire and which extinguisher?', options: [
    ...
    'Cooking oils and fats — wet chemical extinguisher (yellow label). Don\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\'t use water (steam explosion); don\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\'t use foam (similar risk). Wet chemical creates a saponifying layer that smothers the fire.',
  ...
  ], correctIndex: 1, explanation: 'Class F = cooking oils. Wet chemical specific. Common in commercial kitchens; not usually electrical-trade encounter but worth knowing.' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'A, B, C, D, F + electrical. Six effective categories. Knowing all six is L3-essential.' },
  { id: 2, question: 'What does the "red label" extinguisher contain?', options: [
    ...
    'Water — Class A only (solids: wood, paper, fabric). NEVER use on flammable liquids, electrical or cooking oil.',
    'To allow safe internal access through the platform whilst maintaining full guardrail protection',
  ], correctAnswer: 2, explanation: 'Red = water = Class A only.' },
  { id: 3, question: 'What does the "cream label" extinguisher contain?', options: [
    ...
    'Foam — Class A and Class B (flammable liquids). Some foams are dielectrically tested for incidental electrical contact but NOT a primary electrical extinguisher.',
  ], correctAnswer: 3, explanation: 'Cream = foam = Class A + B. Most foams are not safe on electrical.' },
  { id: 4, question: 'What does the "black label" extinguisher contain?', options: [
    'CO2 — safe on electrical equipment (no conductive residue), Class B (flammable liquids). NOT effective on Class A (solids) for fire knock-down (no cooling effect on embers).',
  ...
  ], correctAnswer: 0, explanation: 'Black = CO2 = electrical + Class B. Limited on Class A because no cooling.' },
  ...
  ], correctAnswer: 1, explanation: 'Blue = dry powder = A/B/C/electrical. Mess and visibility issues; deploy carefully.' },
  { id: 6, question: 'What does the "yellow label" extinguisher contain?', options: [
    ...
    'Wet chemical — Class F only (cooking oils and fats). Creates saponifying layer that smothers fire. Common in commercial kitchens.',
    'They eliminate the need to decide what to do, preserving mental energy for important decisions',
  ], correctAnswer: 2, explanation: 'Yellow = wet chemical = Class F.' },
  { id: 7, question: 'What\'s the PASS technique?', options: [
    ...
    'Pull (pin), Aim (at base of fire), Squeeze (handle), Sweep (side to side). Standard extinguisher operation. Plus assess: am I trained, is the fire small enough, is escape behind me, is 999 being called?',
  ], correctAnswer: 3, explanation: 'PASS = the operating sequence. Plus the prior conditions assessment.' },
  { id: 8, question: 'When should you NOT attempt to use an extinguisher?', options: [
    'Untrained; fire larger than waste-bin; wrong class extinguisher; escape route compromised; fire spreading rapidly; smoke obscuring vision; ignition source unidentified; building fire alarm has sounded full evacuation. EVACUATE in any of these scenarios.',
  ...
  ], correctAnswer: 0, explanation: 'Multiple no-go conditions. Default to evacuate; only fight when ALL conditions safe.' },
];
