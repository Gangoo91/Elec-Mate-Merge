...
const checks = [
  { id: 'l3-m1-s4-sub5-electrical', question: 'What\'s the right extinguisher for a small live electrical fire?', options: [
  ...
  ], correctIndex: 0, explanation: 'CO2 or dry powder for electrical — both are safe on energised equipment. NEVER water or foam: both conduct and can shock the operator. Remember this from L2.' },
  { id: 'l3-m1-s4-sub5-conditions', question: 'When is it safe to use an extinguisher?', options: [
  ...
  ], correctIndex: 2, explanation: 'Six conditions for safe extinguisher use: (a) trained; (b) fire small (waste-bin size); (c) correct extinguisher class; (d) escape route behind you; (e) 999 being called; (f) you can withdraw safely if it fails. Default is evacuate; fight only when all are met.' },
  { id: 'l3-m1-s4-sub5-class-f', question: 'What\'s a Class F fire and which extinguisher?', options: [
  ...
  ], correctIndex: 1, explanation: 'Class F = cooking oils and fats; wet chemical (yellow label) is specific to it. Don\'t use water (steam explosion) or foam (similar risk); wet chemical creates a saponifying layer that smothers. Common in commercial kitchens.' },
];

const quizQuestions = [
  { id: 1, question: 'How many fire classes does BS EN 3 define?', options: [
  ...
  ], correctAnswer: 1, explanation: 'Five lettered classes (A, B, C, D, F) plus electrical (no class letter — uses CO2 or dry powder) = six effective categories. Knowing all six is L3-essential.' },
  { id: 2, question: 'What does the "red label" extinguisher contain?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Red = water = Class A only. NEVER use on flammable liquids, electrical or cooking oil.' },
  { id: 3, question: 'What does the "cream label" extinguisher contain?', options: [
  ...
  ], correctAnswer: 3, explanation: 'Cream = foam = Class A + B. Some foams are dielectrically tested for incidental electrical contact but foam is NOT a primary electrical extinguisher.' },
  { id: 4, question: 'What does the "black label" extinguisher contain?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Black = CO2 = electrical + Class B. Limited on Class A (solids) because it has no cooling effect on embers.' },
  { id: 5, question: 'What does the "blue label" extinguisher contain?', options: [
  ...
  ], correctAnswer: 1, explanation: 'Blue = dry powder = A/B/C/electrical. Not for Class F. Messy aftermath and disrupts visibility — don\'t use in a confined space if escape is compromised.' },
  { id: 6, question: 'What does the "yellow label" extinguisher contain?', options: [
    'Dry powder — a multi-purpose agent for Class A, B and C fires and electrical equipment.',
    'CO2 — for electrical and flammable-liquid fires, leaving no conductive residue.',
    'Wet chemical — Class F only (cooking oils and fats).',
    'Foam — for Class A solids and Class B flammable liquids.',
  ], correctAnswer: 2, explanation: 'Yellow = wet chemical = Class F. Creates a saponifying layer that smothers the fire. Common in commercial kitchens.' },
  { id: 7, question: 'What\'s the PASS technique?', options: [
  ...
  ], correctAnswer: 3, explanation: 'PASS = Pull (pin), Aim (at base of fire), Squeeze (handle), Sweep (side to side) — the standard extinguisher operating sequence. Plus the prior assessment: trained, small fire, escape behind, 999 called.' },
  { id: 8, question: 'When should you NOT attempt to use an extinguisher?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Multiple no-go conditions — untrained, large fire, wrong class, compromised escape, rapid spread, obscuring smoke, unidentified source, or full evacuation sounded. Default to evacuate; only fight when all conditions are safe.' },
];
