...
const checks = [
  { id: 'l3-m1-s4-sub6-pre2000', question: 'When was asbestos use in UK building materials banned?', options: [
  ...
  ], correctIndex: 0, explanation: 'Asbestos in new building products was banned in 1999. Buildings constructed OR significantly refurbished before 2000 should be presumed to contain asbestos until survey rules it out. CAR 2012 duty-to-manage applies to non-domestic buildings; the presumption underpins safe systems of work in any case.' },
  { id: 'l3-m1-s4-sub6-register', question: 'Under CAR 2012 Reg 4, what\'s the asbestos register?', options: [
  ...
  ], correctIndex: 2, explanation: 'Reg 4 duty to manage. The register covers ACMs in non-domestic premises (and the common parts of multi-occupied residential); the dutyholder (typically owner/landlord) maintains it and provides it to anyone working on the fabric. Ask for it before any work that may disturb materials.' },
  { id: 'l3-m1-s4-sub6-licensed', question: 'What\'s "licensed asbestos work" vs "non-licensed"?', options: [
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'CAR 2012 is THE UK asbestos regulation. It covers duty to manage (Reg 4), exposure assessment (Reg 6), prevention or reduction (Reg 7), licensed work (Reg 8), training (Reg 10), respiratory PPE, hygiene, monitoring and surveillance. Knowing it by name is L3-essential.' },
  { id: 2, question: 'What are the three main asbestos types?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Three types, all hazardous; crocidolite considered most carcinogenic. Most UK use was chrysotile in cement products and AIB, amosite in insulation board and pipe lagging, crocidolite in some sprayed insulation. Visual identification is rarely possible — sampling required.' },
  { id: 3, question: 'Where might asbestos be encountered in pre-2000 buildings?', options: [
  ...
  ], correctAnswer: 3, explanation: 'A wide range: textured ceilings (artex), insulation board (AIB), cement products (roofing, soffits, downpipes), pipe and boiler lagging, sprayed coatings, floor tiles and adhesive, gaskets and seals, some old fuse boards, bath panels, window putty, wall claddings. Presumption is the safe default.' },
  { id: 4, question: 'What\'s a "refurbishment survey"?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Refurbishment survey = pre-disturbance survey. More intrusive than a management survey, required before significant disturbance work, commissioned by the dutyholder. The L3 supervisor asks for one (or escalates) before any work likely to disturb pre-2000 materials.' },
  { id: 5, question: 'What\'s the asbestos awareness training requirement?', options: [
  ...
  ], correctAnswer: 1, explanation: 'Asbestos awareness is mandatory for trades likely to encounter asbestos. UKATA / IATP-certified asbestos awareness (1-day) is the typical baseline; higher levels (non-licensed, licensed work) require more advanced training.' },
  { id: 6, question: 'What do you do if you find suspected asbestos during work?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Stop work immediately; don\'t disturb further; vacate and close off the area; inform the dutyholder, your supervisor and the principal contractor (where appointed); don\'t restart until a survey confirms it is safe or a licensed contractor takes over. Document everything.' },
  { id: 7, question: 'What\'s the disposal route for asbestos waste?', options: [
  ...
  ], correctAnswer: 3, explanation: 'Asbestos waste is hazardous waste: double-bagged, labelled, accompanied by a Hazardous Waste Consignment Note, transported by a licensed asbestos waste carrier, disposed of at a permitted facility. CAR 2012, Hazardous Waste Regs 2005 and EPA 1990 all apply; mixing with general waste is multiple offences.' },
  ...
  ], correctAnswer: 0, explanation: 'Five-step escalation: stop work and prevent disturbance; photograph and document; phone the firm\'s contracts/H&S manager; inform the dutyholder; do NOT proceed without confirmation the material is non-asbestos or a licensed contractor has taken over. Documentation throughout protects the team and the firm.' },
];
