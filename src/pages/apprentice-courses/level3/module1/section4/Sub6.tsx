...
const DESCRIPTION =
  'L3 asbestos depth — CAR 2012, asbestos register, refurbishment surveys, licensed vs non-licensed work, and the supervisor escalation chain.';
...
export default function Sub6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 4 · Subsection 6"
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">
              Section 5 — Layered L3 depth (2357 ELTK01)
            </div>
          </button>
        </div>
      </HubBody>
