...
const checks = [
  { id: 'l3-m1-s4-sub6-pre2000', question: 'When was asbestos use in UK building materials banned?', options: [
    '1999 — all asbestos use in new building products banned. Buildings constructed OR significantly refurbished BEFORE 2000 should be presumed to contain asbestos until survey rules it out.',
  ...
  ], correctIndex: 0, explanation: 'Pre-2000 = presumed contains asbestos. CAR 2012 duty-to-manage applies to non-domestic buildings; presumption applies in any case for safe-systems-of-work.' },
  ...
  ], correctIndex: 0, explanation: 'Reg 4 duty to manage. Register must be available to those working on the fabric. Ask for it before any work that may disturb materials.' },
  { id: 'l3-m1-s4-sub6-licensed', question: 'What\'s "licensed asbestos work" vs "non-licensed"?', options: [
    'Licensed work — high-risk activities (most disturbance of friable insulation, large quantities of AIB) requiring HSE-licensed contractor under CAR 2012 Reg 8. Non-licensed work — lower-risk (some sealed cement product, very limited disturbance) by trained operatives following NNLW (Notifiable Non-Licensed Work) procedures or basic non-licensed.',
  ...
  ], correctIndex: 0, explanation: 'Licensed contractor required for high-risk work. Non-licensed has its own (lower) requirements. The L3 supervisor identifies which category and escalates to licensed where appropriate — never attempts licensed work without licence.' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'CAR 2012 is THE UK asbestos regulation. Knowing it by name is L3-essential.' },
  ...
  ], correctAnswer: 2, explanation: 'Three types; all hazardous. Visual identification rarely possible — sampling required.' },
  ...
  ], correctAnswer: 3, explanation: 'Asbestos is in many materials in pre-2000 buildings. The range is wide; presumption is the safe default.' },
  ...
  ], correctAnswer: 0, explanation: 'Refurbishment survey = pre-disturbance survey. The L3 supervisor asks for one (or escalates) before any work likely to disturb pre-2000 materials.' },
  ...
  ], correctAnswer: 1, explanation: 'Asbestos awareness is mandatory for trades likely to encounter asbestos. UKATA / IATP courses are the recognised standard.' },
  ...
  ], correctAnswer: 2, explanation: 'Stop, don\'t disturb, escalate. The L3 supervisor escalation immediately to dutyholder + firm + (if applicable) principal contractor.' },
  ...
  ], correctAnswer: 3, explanation: 'Asbestos waste is licensed-carrier, permitted-facility hazardous waste. Mixing with general waste is multiple offences.' },
  ...
  ], correctAnswer: 0, explanation: 'Five-step escalation. Documentation throughout. The L3 supervisor\'s reflex protects the team and the firm.' },
];
