...
const checks = [
  { id: 'l3-m1-s4-sub2-define', question: 'What\'s the difference between a hazard and a risk?', options: [
    ...
    'Hazard = something with the potential to cause harm. Risk = the likelihood that the hazard will cause harm × the severity if it does. Eg: live electricity is the HAZARD; touching live conductors with no isolation creates HIGH RISK from that hazard.',
  ...
  ], correctIndex: 2, explanation: 'Hazard ≠ risk. The same hazard can present very different risks depending on exposure, controls and population. The L3 distinction lets you communicate accurately on RAMS and in conversations.' },
  ...
  ], correctIndex: 3, explanation: 'Four exposure routes. Inhalation is the headline for dust and vapour; absorption for solvents and corrosives; ingestion for accidental swallowing (eating with contaminated hands); injection for sharps.' },
  ...
  ], correctIndex: 2, explanation: 'Likelihood × Severity is the standard quantification. Doesn\'t need to be exact; provides structure for the assessment and clarity on which hazards need most control.' },
];
...
const quizQuestions = [
  { id: 1, question: 'Define "hazard" in H&S terms.', options: [
    ...
    'Something with the potential to cause harm — a substance, situation, energy form, environment, equipment or activity that could injure people, damage health or harm property / environment.',
  ...
  ], correctAnswer: 1, explanation: 'Hazard = potential to cause harm. Energy, substance, situation. Doesn\'t require harm to occur; just the potential.' },
  ...
  ], correctAnswer: 2, explanation: 'Risk = quantified probability × consequence. Evaluating risk drives the control decisions.' },
  ...
  ], correctAnswer: 3, explanation: 'Five broad categories cover most workplace hazards. The L3 supervisor uses these as a hazard-spotting framework on every job.' },
  { id: 4, question: 'What\'s an "exposure route"?', options: [
    'The pathway by which a hazard reaches and affects the body — inhalation, absorption, ingestion, injection. PPE selection and engineering controls follow the route.',
  ...
  ], correctAnswer: 0, explanation: 'Knowing the route lets you target the control. RPE for inhalation; gloves for absorption; hygiene for ingestion; sharps protocol for injection.' },
  { id: 5, question: 'What\'s a "control measure"?', options: [
    ...
    'Something that reduces the risk from a hazard. Sits in the hierarchy (eliminate → substitute → engineer → administer → PPE). Control measures are the operational expression of the risk assessment.',
  ...
  ], correctAnswer: 1, explanation: 'Control measure = the action / equipment / procedure that reduces the risk. Hierarchy of control orders them by effectiveness.' },
  ...
  ], correctAnswer: 3, explanation: 'L2 often uses "hazard" and "risk" interchangeably; L3 uses them precisely. The precision drives clearer communication in RAMS and toolbox talks.' },
  ...
  ], correctAnswer: 0, explanation: 'The chain: hazard → risk → control → residual → ALARP. Understanding the chain lets you communicate the assessment intelligently.' },
];
