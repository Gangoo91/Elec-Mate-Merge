...
const checks = [
  { id: 'l3-m1-s4-sub2-define', question: 'What\'s the difference between a hazard and a risk?', options: [
  ...
  ], correctIndex: 0, explanation: 'Hazard ≠ risk. For example, live electricity is the hazard; touching live conductors with no isolation creates high risk from that hazard. The same hazard can present very different risks depending on exposure, controls and population. The L3 distinction lets you communicate accurately on RAMS and in conversations.' },
  { id: 'l3-m1-s4-sub2-routes', question: 'What are the four main routes by which a hazardous substance can affect the body?', options: [
  ...
  ], correctIndex: 3, explanation: 'Four exposure routes: inhalation (breathing in) is the headline for dust and vapour; absorption (through skin, eyes or mucous membranes) for solvents and corrosives; ingestion for accidental swallowing (eating with contaminated hands); injection for sharps. PPE selection follows the route.' },
  { id: 'l3-m1-s4-sub2-evaluate', question: 'How is risk EVALUATED on a typical risk assessment?', options: [
  ...
  ], correctIndex: 1, explanation: 'Likelihood × Severity is the standard quantification: a likelihood scale (1 rare → 5 almost certain) multiplied by a severity scale (1 minor → 5 catastrophic) gives a risk score, which a matrix (often 3×3 or 5×5) categorises as low / medium / high / very high. It doesn\'t need to be exact; it provides structure and clarity on which hazards need most control.' },
];

const quizQuestions = [
  { id: 1, question: 'Define "hazard" in H&S terms.', options: [
  ...
  ], correctAnswer: 1, explanation: 'A hazard is anything with the potential to cause harm — a substance, situation, energy form, environment, equipment or activity that could injure people, damage health or harm property / environment. It doesn\'t require harm to occur; just the potential.' },
  { id: 2, question: 'Define "risk" in H&S terms.', options: [
  ...
  ], correctAnswer: 2, explanation: 'Risk is a function of likelihood × severity — quantified probability × consequence — modified by the population exposed and the controls in place. Evaluating risk drives the control decisions.' },
  { id: 3, question: 'Name three categories of workplace hazard.', options: [
  ...
  ], correctAnswer: 3, explanation: 'Five broad categories cover most workplace hazards: physical (electrical, mechanical, noise, vibration, height, slips, fire), chemical (substances, dust, fume), biological (bacteria, viruses, allergens), psychosocial (stress, violence, fatigue) and ergonomic (manual handling, repetitive motion, posture). The L3 supervisor uses these as a hazard-spotting framework on every job.' },
  { id: 4, question: 'What\'s an "exposure route"?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Knowing the route lets you target the control: RPE for inhalation; gloves for absorption; hygiene for ingestion; sharps protocol for injection. PPE selection and engineering controls follow the route.' },
  { id: 5, question: 'What\'s a "control measure"?', options: [
  ...
  ], correctAnswer: 1, explanation: 'A control measure is the action, equipment or procedure that reduces the risk. It sits in the hierarchy (eliminate → substitute → engineer → administer → PPE), which orders measures by effectiveness, and is the operational expression of the risk assessment.' },
  { id: 6, question: 'What\'s "residual risk"?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Residual risk = what\'s left after controls. PPE protects against residual; ALARP is the test of whether further reduction is required.' },
  { id: 7, question: 'How does the L3 supervisor distinguish hazard from risk in practice?', options: [
  ...
  ], correctAnswer: 0, explanation: 'The chain runs hazard → risk → control → residual → ALARP. ALARP is achieved when residual risk is reduced to a point where further reduction would be grossly disproportionate to the cost. Understanding the chain lets you communicate the assessment intelligently.' },
];
