...
const checks = [
  { id: 'l3-m1-s4-sub3-arc', question: 'What\'s arc-flash?', options: ['A camera flash.', 'An explosive release of energy when a fault current ionises air between conductors. Temperatures reach 19,000°C+. Pressure wave + thermal radiation + molten metal projectiles. Survivable injuries common; fatalities occur. Predictable in commercial / industrial switchgear; PPE rated by ATPV (cal/cm²).', 'Welding.', 'Lightning.'], correctIndex: 1, explanation: 'Arc-flash is one of the highest-consequence electrical hazards in commercial/industrial work. EN 61482 PPE; design controls (remote racking) preferred.' },
  { id: 'l3-m1-s4-sub3-second', question: 'What\'s a "secondary injury" in electrical incidents?', options: ['Second person hurt.', 'Injury arising from the consequences of an electrical event rather than the electricity itself — e.g. fall from a step-up after a startle from a shock; tool drop from height; burn from hot equipment after fire; collision while running from smoke. Often more severe than the primary electrical injury.', 'Not real.', 'Always to bystanders.'], correctIndex: 1, explanation: 'Secondary injuries are common and often more serious than the primary shock. Risk assessment should consider the full consequence chain, not just the electrical event.' },
  { id: 'l3-m1-s4-sub3-fire', question: 'What\'s the most common cause of electrical fire on installed equipment?', options: ['Lightning.', 'Loose connections — high resistance generates heat; oxidation accelerates; eventually flashover. Other common causes: overloaded circuits, damaged cables, water ingress, manufacturing defects (counterfeit kit), inadequate cooling.', 'Magic.', 'Wind.'], correctIndex: 1, explanation: 'Loose connections cause more electrical fires than any other single cause. Periodic inspection (EICR) catches them; installation discipline (proper torque, periodic re-tightening at high-current terminations) prevents them.' },
];

const quizQuestions = [
  { id: 1, question: 'What\'s the threshold above which AC voltage is considered "dangerous" under HSE guidance?', options: ['Always dangerous.', '50V AC RMS / 120V DC ripple-free is the threshold for "danger" in EAWR / HSE practice. Below = ELV (Extra-Low Voltage) generally not considered shock-hazardous in normal conditions. Above = LV (Low Voltage), routinely shock-hazardous and full EAWR controls apply.', '230V.', '1V.'], correctAnswer: 1, explanation: '50V AC threshold. Below = ELV; above = LV. Mains 230V is well into LV territory.' },
  { id: 2, question: 'What\'s "shock"?', options: ['Surprise.', 'Physiological response to electric current passing through the body. Effects scale with current (mA): perception (1mA), pain (5-10mA), can\'t-let-go (10-20mA), respiratory paralysis (20-50mA), ventricular fibrillation (50-100mA+). Duration matters — long exposure at lower current can be lethal.', 'Cold.', 'Loud noise.'], correctAnswer: 1, explanation: 'Current matters more than voltage; mains 230V routinely produces enough current through the body to cause cardiac arrest. Knowing the rough thresholds informs the urgency.' },
  { id: 3, question: 'What\'s an "electrical burn"?', options: ['A skin reaction.', 'Tissue damage caused by current passing through the body OR by arc / flash heating the skin. Internal burns can be severe with small surface marking. Different from thermal burns (cooler at surface; hotter at depth).', 'A type of soup.', 'A type of dance.'], correctAnswer: 1, explanation: 'Electrical burns deceptive — small surface, deep internal damage. Always assume worse than it looks.' },
  { id: 4, question: 'What\'s arc-flash temperature?', options: ['100°C.', '~19,000°C — far hotter than the surface of the sun. The thermal radiation alone causes severe burns at distance; the pressure wave injuries; molten metal projectiles. PPE rated by ATPV (cal/cm²).', '50°C.', '200°C.'], correctAnswer: 1, explanation: 'Arc-flash is extreme. EN 61482 ATPV-rated PPE; design controls (remote racking, arc-resistant switchgear) preferred where reasonably practicable.' },
  { id: 5, question: 'What\'s "step potential"?', options: ['A type of dance.', 'Voltage difference between feet planted on the ground in the vicinity of an earth fault — current flowing through the ground creates voltage gradient; a person standing across that gradient experiences step potential. Significant near HV faults; can cause shock through the legs.', 'A unit of power.', 'A type of cable.'], correctAnswer: 1, explanation: 'Step potential is an HV-systems hazard. Generally not a domestic / LV concern but the L3 should know the term.' },
  { id: 6, question: 'What\'s "touch potential"?', options: ['The risk of touching anything.', 'Voltage between the hand touching an energised object and the feet on the ground. Drives current through the body if the object is energised by fault. Reason for equipotential bonding and protective conductor sizing.', 'A measurement of softness.', 'A type of socket.'], correctAnswer: 1, explanation: 'Touch potential is the headline LV hazard from earth faults. BS 7671 disconnection times and bonding addresses it.' },
  { id: 7, question: 'What\'s "induced voltage"?', options: ['Pretend voltage.', 'Voltage induced in a conductor by electromagnetic field from a nearby live conductor. Particularly relevant for cables in trefoil arrangement, parallel cable runs, and in metallic conduit / armouring. Can give shock or false-live readings on otherwise dead conductors.', 'A type of music.', 'A type of food.'], correctAnswer: 1, explanation: 'Induced voltage explains why some "dead" conductors give a tingle or a low reading. Bond and isolate; understand the source.' },
  { id: 8, question: 'How does the L3 supervisor map a hazard to the relevant regulation?', options: ['Random match.', 'Shock / direct contact → EAWR Reg 4 / 13 + BS 7671. Arc-flash → EAWR Reg 4 + 14 + COSHH (combustion products) + EN 61482 PPE. Fire → EAWR + RRFSO 2005 + Approved Doc B. Secondary injury → MHSWR Reg 3 (assessment of consequence chain). Each hazard has its regulatory home.', 'Random.', 'Customer\'s opinion.'], correctAnswer: 1, explanation: 'Mapping hazard to regulation lets the L3 supervisor cite chapter and verse in conversations. Strengthens the safety argument and demonstrates competence.' },
];
