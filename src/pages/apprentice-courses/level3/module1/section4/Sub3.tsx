...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: '50V AC RMS / 120V DC ripple-free is the threshold for "danger" in EAWR / HSE practice. Below it is ELV (Extra-Low Voltage), generally not shock-hazardous in normal conditions; above it is LV (Low Voltage), routinely shock-hazardous with full EAWR controls. Mains 230V is well into LV territory.' },
  ...
  ], correctAnswer: 2, explanation: 'Shock is the physiological response to electric current through the body, scaling with current: perception (1mA), pain (5-10mA), can\'t-let-go (10-20mA), respiratory paralysis (20-50mA), ventricular fibrillation (50-100mA+). Duration matters — long exposure at lower current can be lethal. Mains 230V routinely produces enough current to cause cardiac arrest.' },
  ...
  ], correctAnswer: 3, explanation: 'An electrical burn is tissue damage caused by current passing through the body or by an arc / flash heating the skin. Internal burns can be severe with only small surface marking, unlike thermal burns (cooler at surface, hotter at depth). Always assume worse than it looks.' },
