...
const checks = [
  { id: 'l3-m1-s5-sub6-priority', question: 'When legal duty conflicts with commercial pressure, what wins?', options: [
  ...
  ], correctIndex: 2, explanation: 'Statute trumps both contract and preference. HASAWA s.7 / EAWR Reg 16 personal duties do not bend to customer or employer commercial preference; legal duty is non-negotiable.' },
  { id: 'l3-m1-s5-sub6-cost', question: 'What\'s the cost of legal compliance vs the cost of breach?', options: [
  ...
  ], correctIndex: 3, explanation: 'Compliance is time, kit and training; breach adds fine, FFI, legal, civil, insurance, reputation and lost contracts. The Sentencing Council guideline alone puts serious-case fines into six figures.' },
  { id: 'l3-m1-s5-sub6-pressure', question: 'How does the L3 supervisor handle commercial pressure to compromise safety?', options: [
  ...
  ], correctIndex: 1, explanation: 'Refusal, documentation, escalation and framing — the L3 toolkit for difficult conversations. ERA s.44 protects from detriment and PIDA 1998 protects external escalation if the internal route fails.' },
];

const quizQuestions = [
  { id: 1, question: 'Can statutory duties be contracted away?', options: [
  ...
  ], correctAnswer: 1, explanation: 'Statute trumps contract — a foundational principle of regulatory law. A contract may shift commercial liability between parties but the statutory duty stays where Parliament put it, and the HSE prosecutes on the statutory hook.' },
  { id: 2, question: 'What\'s the typical commercial cost of an HSE prosecution?', options: [
  ...
  ], correctAnswer: 2, explanation: 'The total cost is much greater than the fine alone — once reputation damage is added it is often 3-5x the fine for serious cases. The cascade is severe.' },
  { id: 3, question: 'Can criminal fines be paid by the firm\'s insurance?', options: [
  ...
  ], correctAnswer: 3, explanation: 'Insurance does not cover criminal fines — the fine comes off the firm\'s bottom line. PI and EL cover legal defence costs and civil claims but not criminal fines.' },
  { id: 4, question: 'What\'s the customer\'s leverage in commercial pressure scenarios?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Commercial leverage is real and worth respecting but cannot override statutory duty. The L3 supervisor frames the conversation around legal compliance, not customer satisfaction.' },
  { id: 5, question: 'Who decides whether to walk away from a commercial conflict?', options: [
  ...
  ], correctAnswer: 1, explanation: 'Clean separation: the L3\'s personal duty is to refuse the unsafe instruction, while the commercial decision to walk away sits with the firm\'s decision-makers above that.' },
  { id: 6, question: 'How does the L3 supervisor frame the consequence to a customer?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Brief, calm and factual: acknowledge the pressure, state the legal framework, note that consequences cascade if corners are cut, and offer a compliant way forward. Most customers respect the boundary once it is clearly stated.' },
  { id: 7, question: 'What\'s the relationship between legal compliance and commercial reputation?', options: [
  ...
  ], correctAnswer: 3, explanation: 'Compliance and commercial success are aligned over time. HSE Public Register prosecutions and notices are a competitive disadvantage; cutting corners is short-term thinking with long-term cost.' },
  { id: 8, question: 'L3 personal protection in legal-vs-commercial conflicts?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Multiple protections for the L3 who refuses unsafe work — ERA s.44 (no detriment for raising H&S concerns), PIDA 1998 (whistleblowing including to an external regulator), HASAWA s.7 (personal duty so refusal is required) and EAWR Reg 16 (competence-based refusal). Use them.' },
];
