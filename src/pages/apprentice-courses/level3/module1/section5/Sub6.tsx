...
const checks = [
  { id: 'l3-m1-s5-sub6-priority', question: 'When legal duty conflicts with commercial pressure, what wins?', options: [
    ...
    'Legal duty - always. Statutory duties cannot be contracted out and HASAWA s.7 / EAWR Reg 16 personal duties don\\\\\\\\\\\\\\\'t bend to customer / employer commercial preference.',
  ...
  ], correctIndex: 2, explanation: 'Statute trumps contract; statute trumps preference. The L3 supervisor framing is firm: legal duty is non-negotiable.' },
  ...
  ], correctIndex: 3, explanation: 'Compliance is the cheap option. Breach is exponentially more expensive once consequences cascade.' },
  { id: 'l3-m1-s5-sub6-pressure', question: 'How does the L3 supervisor handle commercial pressure to compromise safety?', options: [
    ...
    'Refuse, document in writing, escalate up the chain, cite the regulatory framework, frame the consequence cascade. ERA s.44 protects from detriment. PIDA 1998 protects external escalation if internal fails.',
  ...
  ], correctIndex: 1, explanation: 'Refusal + documentation + escalation + framing. The L3 supervisor toolkit for difficult conversations.' },
];
...
const quizQuestions = [
  { id: 1, question: 'Can statutory duties be contracted away?', options: [
    ...
    'No - statute imposes; contract cannot remove. A contract may shift commercial liability between parties but statutory duty stays where Parliament put it. The HSE prosecutes on statutory hook.',
  ...
  ], correctAnswer: 1, explanation: 'Statute trumps contract. Foundational principle of regulatory law.' },
  { id: 2, question: 'What\'s the typical commercial cost of an HSE prosecution?', options: [
    ...
    'Fine + FFI + legal defence + civil compensation + insurance premium increase + lost contracts + reputation damage. Often 3-5x the fine alone for serious cases.',
  ...
  ], correctAnswer: 2, explanation: 'Total cost much greater than fine alone. The cascade is severe.' },
  ...
  ], correctAnswer: 3, explanation: 'Insurance doesn\'t cover criminal fines. The fine comes off the firm\'s bottom line.' },
  ...
  ], correctAnswer: 0, explanation: 'Commercial leverage is real and worth respecting; it just cannot override statute.' },
  ...
  ], correctAnswer: 1, explanation: 'L3 escalates; firm\'s commercial decision-makers decide. Clean separation.' },
  ...
  ], correctAnswer: 2, explanation: 'Brief, calm, factual. Most customers respect the boundary once it\'s clearly stated.' },
  ...
  ], correctAnswer: 3, explanation: 'Compliance and commercial success are aligned over time. Cutting corners is short-term thinking with long-term cost.' },
  ...
  ], correctAnswer: 0, explanation: 'Multiple legal protections for the L3 who refuses unsafe work. Use them.' },
];
