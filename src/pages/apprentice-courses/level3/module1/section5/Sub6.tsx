...
const DESCRIPTION =
  'L3 supervisor judgement on the priority when legal duty conflicts with commercial pressure. Statutory duties cannot be contracted out.';

const checks = [
  {
    id: 'l3-m1-s5-sub6-priority',
    question: 'When legal duty conflicts with commercial pressure, what wins?',
    options: [
      'Commercial pressure — the customer is paying, so their wishes determine how the work is done.',
      'Whichever the contract specifies — the signed agreement settles which duty takes priority.',
      'Legal duty, always — statutory duties cannot be contracted out.',
      'A compromise — part of the work done the safe way and part done the quick way.',
    ],
    correctIndex: 2,
    explanation:
      'Statute trumps both contract and preference. HASAWA s.7 / EAWR Reg 16 personal duties do not bend to customer or employer commercial preference; legal duty is non-negotiable.',
  },
  {
    id: 'l3-m1-s5-sub6-cost',
    question: "What's the cost of legal compliance vs the cost of breach?",
    options: [
      'Compliance and breach cost about the same once the fine is the only consequence considered.',
      'Breach is usually cheaper because most breaches are never detected or prosecuted.',
      'Compliance is more expensive because training and equipment cost more than any likely fine.',
      'Compliance is almost always cheaper — breach cascades into fine, FFI, legal, civil and lost contracts.',
    ],
    correctIndex: 3,
    explanation:
      'Compliance is time, kit and training; breach adds fine, FFI, legal, civil, insurance, reputation and lost contracts. The Sentencing Council guideline alone puts serious-case fines into six figures.',
  },
  {
    id: 'l3-m1-s5-sub6-pressure',
    question: 'How does the L3 supervisor handle commercial pressure to compromise safety?',
    options: [
      'Quietly comply this once to keep the customer happy, then raise it later if there is a problem.',
      'Refuse, document it, escalate up the chain and frame the consequence cascade.',
      'Do the work the unsafe way but ask the customer to sign a disclaimer accepting the risk.',
      'Walk off site immediately without telling anyone, since the operative can refuse unsafe work.',
    ],
    correctIndex: 1,
    explanation:
      'Refusal, documentation, escalation and framing — the L3 toolkit for difficult conversations. ERA s.44 protects from detriment and PIDA 1998 protects external escalation if the internal route fails.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question: 'Can statutory duties be contracted away?',
    options: [
      'Yes — a signed contract that assigns the duty to the customer fully removes it from the contractor.',
      'No — statute imposes the duty and contract cannot remove it.',
      'Yes — duties can be transferred to a subcontractor provided the transfer is recorded in writing.',
      "Only personal duties under s.7 can be contracted away; the firm's duties under s.2 and s.3 cannot.",
    ],
    correctAnswer: 1,
    explanation:
      'Statute trumps contract — a foundational principle of regulatory law. A contract may shift commercial liability between parties but the statutory duty stays where Parliament put it, and the HSE prosecutes on the statutory hook.',
  },
  {
    id: 2,
    question: "What's the typical commercial cost of an HSE prosecution?",
    options: [
      'Just the fine imposed by the court, with no further financial consequences for the firm.',
      'The fine plus a small fixed administrative charge, with insurance covering everything else.',
      'Fine plus FFI, legal defence, civil compensation, higher premiums and lost contracts.',
      'Nothing in most cases, because firms can usually recover their costs from the customer.',
    ],
    correctAnswer: 2,
    explanation:
      'The total cost is much greater than the fine alone — once reputation damage is added it is often 3-5x the fine for serious cases. The cascade is severe.',
  },
  {
    id: 3,
    question: "Can criminal fines be paid by the firm's insurance?",
    options: [
      'Yes — public liability insurance covers fines as well as compensation claims.',
      'Yes — provided the firm declared the risk when taking out the policy.',
      'Only the first £50,000 of any fine is insurable; the firm pays anything above that.',
      'No — it is against public policy to insure the cost of breaking the law.',
    ],
    correctAnswer: 3,
    explanation:
      "Insurance does not cover criminal fines — the fine comes off the firm's bottom line. PI and EL cover legal defence costs and civil claims but not criminal fines.",
  },
  {
    id: 4,
    question: "What's the customer's leverage in commercial pressure scenarios?",
    options: [
      'Contract terms, the relationship, future work and payment timing — real, but not over statute.',
      'The customer has no leverage at all; once a contract is signed they cannot influence the contractor.',
      'The customer can instruct the operative to break statutory duty, provided they accept the risk in writing.',
      "The customer's leverage is unlimited — they can require any change to the method of working at any time.",
    ],
    correctAnswer: 0,
    explanation:
      'Commercial leverage is real and worth respecting but cannot override statutory duty. The L3 supervisor frames the conversation around legal compliance, not customer satisfaction.',
  },
  {
    id: 5,
    question: 'Who decides whether to walk away from a commercial conflict?',
    options: [
      'The customer decides, since it is their project and their money at stake.',
      "The firm's contracts manager or director — the L3 escalates with the facts, they decide.",
      'The L3 apprentice decides alone, walking off site without reference to anyone else.',
      'The HSE decides, after the firm reports the conflict to them for a ruling.',
    ],
    correctAnswer: 1,
    explanation:
      "Clean separation: the L3's personal duty is to refuse the unsafe instruction, while the commercial decision to walk away sits with the firm's decision-makers above that.",
  },
  {
    id: 6,
    question: 'How does the L3 supervisor frame the consequence to a customer?',
    options: [
      'By threatening to report the customer to the HSE unless they accept the safe method of working.',
      'By refusing to discuss it at all and simply walking off site without explanation.',
      'Briefly and calmly — explain the legal framework, the cascade, and the safe options available.',
      "By agreeing to the customer's request but quietly recording that the work was done against advice.",
    ],
    correctAnswer: 2,
    explanation:
      'Brief, calm and factual: acknowledge the pressure, state the legal framework, note that consequences cascade if corners are cut, and offer a compliant way forward. Most customers respect the boundary once it is clearly stated.',
  },
  {
    id: 7,
    question: "What's the relationship between legal compliance and commercial reputation?",
    options: [
      'They are opposed — strict compliance slows work down and loses contracts to cheaper competitors.',
      'They are unrelated — reputation depends only on price and finish, not on safety record.',
      "Compliance helps only with public-sector work; private customers never check a firm's record.",
      'Aligned — a clean record wins repeat business and frameworks; register entries lose them.',
    ],
    correctAnswer: 3,
    explanation:
      'Compliance and commercial success are aligned over time. HSE Public Register prosecutions and notices are a competitive disadvantage; cutting corners is short-term thinking with long-term cost.',
  },
  {
    id: 8,
    question: 'L3 personal protection in legal-vs-commercial conflicts?',
    options: [
      'ERA 1996 s.44, PIDA 1998, HASAWA s.7 and EAWR Reg 16 between them.',
      'There is no legal protection — an operative who refuses an instruction risks dismissal with no recourse.',
      'Protection applies only after qualifying; apprentices have no statutory protection for raising concerns.',
      'Protection is limited to written warnings; an operative cannot bring any claim if they suffer detriment.',
    ],
    correctAnswer: 0,
    explanation:
      'Multiple protections for the L3 who refuses unsafe work — ERA s.44 (no detriment for raising H&S concerns), PIDA 1998 (whistleblowing including to an external regulator), HASAWA s.7 (personal duty so refusal is required) and EAWR Reg 16 (competence-based refusal). Use them.',
  },
];

const faqs = [
  {
    question: 'What if the firm pressures me to compromise?',
    answer:
      'Refuse; document; escalate. ERA s.44 protects from detriment. PIDA 1998 protects external if internal fails.',
  },
  {
    question: 'What if losing a customer would cost the firm a major contract?',
    answer:
      "Commercial decisions are the firm's; safety decisions are statutory. The L3 escalates the safety concern to the contracts manager / director who handles the commercial response.",
  },
  {
    question: 'Can a firm refuse to do work that is legally required (e.g. EICR remedial)?',
    answer:
      'A firm can decline a contract; once contracted to deliver, they must deliver compliantly or break the contract (with consequences). Refusing legally-required remedial mid-contract is breach unless safety justifies.',
  },
  {
    question:
      'How do I know when commercial pressure has tipped into asking me to do something illegal?',
    answer:
      'When the proposed action breaches statute — HASAWA / EAWR / MHSWR / RIDDOR / CAR / WAH / etc. The L3 supervisor recognises the regulatory framework and identifies when actions cross the line.',
  },
  {
    question:
      'Are there situations where commercial considerations legitimately influence safety decisions?',
    answer:
      'Yes — within the legal framework. Choice of platform vs ladder, scope of testing, frequency of inspection — all involve commercial choices within ALARP. But absolute requirements (EAWR Reg 14 three-test, MHSWR Reg 3, etc) are not commercially negotiable.',
  },
  {
    question: 'What about the customer who insists on a non-compliant install (e.g. omitting RCD)?',
    answer:
      'Refuse. BS 7671 may permit some choices but compliance with relevant safety standards is non-negotiable for the firm. Customer can refuse to engage you; they cannot direct an unsafe install.',
  },
  {
    question:
      'Does the L3 supervisor have personal exposure if the firm proceeds with non-compliant work?',
    answer:
      'Yes — HASAWA s.7 personal duty + s.36 cause-of-offence route. If the L3 supervises the non-compliant work, they share liability. ERA s.44 protection only operates where the L3 refuses; participation removes the protection.',
  },
  {
    question: 'How does the Sentencing Council guideline apply to individuals?',
    answer:
      'Separate matrix from the corporate one. Culpability (very high / high / medium / low) x harm category (1 / 2 / 3 / minor risk) maps to starting points. High culpability x category 1 harm for individuals starts at custody. Aggravating factors include previous convictions, ignoring warnings, attempting to conceal.',
  },
  {
    question: 'Can the customer recover their commercial losses from the firm if the firm refuses?',
    answer:
      'A firm that refuses to perform a contract breaches contract; the customer may have civil remedies. However, if the refusal is because performance would be illegal, the contract is unenforceable in that respect. The firm cannot be required by court order to perform an illegal act.',
  },
  {
    question: "What happens to the firm's PI insurance after a prosecution?",
    answer:
      'Premiums typically rise sharply; some insurers may decline renewal. Coverage going forward may require additional disclosures, exclusions or higher excesses. The HSE public register entry visible during placement.',
  },
];
...
export default function Sub6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 5 · Subsection 6"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            "Remember from Section 5.1 - statute imposes; contract can't remove. At L3 the practical judgement on commercial pressure: legal duty wins, every time, communicated clearly."
          }
        </p>
        ...
        <ConceptBlock
          title="The non-negotiable legal foundation"
          plainEnglish="Statute imposes duties on parties (employer / employee / dutyholder etc) regardless of any contract between them. A contract can shift commercial risk - who pays the bill, who insures, who is liable to whom - but it cannot remove or modify statutory duty. The HSE prosecutes on the statutory hook."
          onSite='The L3 reflex: when a customer or employer pushes for something non-compliant, the response framework is "the statute applies regardless of what the contract says or what we agree between us; we can&apos;t do it".'
        >
          <p>What can / can&apos;t be contracted:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>CAN be contracted</strong> - commercial price, payment terms, scope of work,
              allocation of commercial liability between parties, who handles waste disposal
              arrangements, who provides welfare facilities.
            </li>
            <li>
              <strong>CANNOT be contracted away</strong> - HASAWA duties, EAWR duties, MHSWR duties,
              CDM duties, RIDDOR duties, CAR duties, WAH duties, environment duties etc. Personal
              s.7 / Reg 16 duties on individuals.
            </li>
            <li>
              Contract clauses purporting to remove statutory duty are unenforceable; the duty stays
              where statute put it.
            </li>
          </ul>
        </ConceptBlock>

        <RegsCallout
          source="HASAWA 1974 - s.36(1)"
          clause={
            <>
              "Where the commission by any person of an offence under any of the relevant statutory
              provisions is due to the act or default of some other person, that other person shall
              be guilty of the offence, and a person may be charged with and convicted of the
              offence by virtue of this subsection whether or not proceedings are taken against the
              first-mentioned person."
            </>
          }
          meaning={
            <>
              s.36 - third party can be liable where their act or default caused another&apos;s
              breach. Means the customer who instructs a non-compliant install can be liable; the
              supplier who provides false information can be liable; the contractor who pressures
              the apprentice can be liable. Duties cascade across parties; commercial relationship
              doesn&apos;t insulate.
            </>
          }
          cite="Source: Health and Safety at Work etc Act 1974 (1974 c.37), s.36."
        />
        ...
        <ConceptBlock
          title="Compliance is cheap; breach is exponentially expensive"
          plainEnglish="The cost of compliance - time, kit, training, insurance - is small relative to revenue. The cost of breach cascades: fine, FFI, legal defence, civil compensation, insurance premium increases, lost contracts, reputation damage on HSE Public Register, possible scheme deregistration, possible director custody. Often 3-5x the fine alone for serious cases."
          onSite='Commercial framing of safety decisions starts from this asymmetry. Saving £200 on a procedure can cost £200,000 in cascade. The L3 supervisor reframes "cutting corners saves money" into "cutting corners exposes the firm to disproportionate cost".'
        >
          <p>The cascade itemised:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fine</strong> - per Sentencing Council matrix; six figures for serious cases.
            </li>
            <li>
              <strong>FFI</strong> - inspector time billed at ~£170/hr; routinely four-figure to
              five-figure invoice.
            </li>
            <li>
              <strong>Legal defence</strong> - solicitor + barrister + experts; £20k-£200k+ for
              serious cases.
            </li>
            <li>
              <strong>Civil compensation</strong> - injured party / family claims; PI insurance pays
              subject to limits.
            </li>
            <li>
              <strong>Insurance premiums</strong> - rise after claims; some insurers decline cover.
            </li>
            <li>
              <strong>HSE Public Register</strong> - listed for 5+ years; visible to clients during
              procurement.
            </li>
            <li>
              <strong>Lost contracts</strong> - public-sector frameworks often disqualify firms with
              prohibition notices; major private clients similar.
            </li>
            <li>
              <strong>Scheme deregistration</strong> - NICEIC / NAPIT may suspend / withdraw
              registration.
            </li>
            <li>
              <strong>Director custody</strong> - HASAWA s.37 + Sentencing Council; serious cases
              include immediate custody.
            </li>
            <li>
              <strong>Reputation</strong> - hardest to quantify, longest-lasting impact.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Refuse</strong> - politely, immediately. Cite the regulation if you can.
            </li>
            <li>
              <strong>Document</strong> - text, email, job-pack note. Time-stamped. Same day.
            </li>
            <li>
              <strong>Escalate</strong> - supervisor → contracts manager → QS / H&amp;S manager →
              director.
            </li>
            <li>
              <strong>Frame</strong> - consequence cascade for senior management; Sentencing Council
              bands; insurance limits.
            </li>
            <li>
              <strong>Protect</strong> - ERA s.44 + PIDA 1998 + HASAWA s.7 (personal duty so refusal
              is required).
            </li>
          </ol>
        </ConceptBlock>
        ...
        <ConceptBlock
          title="The statutory shield for raising H&amp;S concerns"
          plainEnglish="ERA 1996 s.44 protects employees from detriment imposed for taking specified action on health and safety. The protected actions include raising concerns, leaving the workplace in serious and imminent danger, and taking steps to protect oneself or others. Detriment includes dismissal, demotion, withholding of work, victimisation. The L3 supervisor refusing unsafe work has direct s.44 protection."
          onSite='The L3 reflex on retaliation: ERA s.44 makes detriment for raising H&amp;S concerns unlawful. Tribunal claim available without the usual two-year qualifying period. The framing "ERA s.44 protects this conversation" lands with HR / management precisely because it is correct.'
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Bringing reasonable concerns to the employer&apos;s attention by reasonable means.
            </li>
            <li>
              Leaving or refusing to return to a place of work in serious and imminent danger.
            </li>
            ...
            <li>
              Detriment includes dismissal, demotion, withholding overtime, transfer to worse role,
              harassment.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              any deliberate failure to act, by his employer done on the ground that — ... (c) being
              an employee at a place where there was no such representative or safety committee, or
              where there was such a representative or safety committee but it was not reasonably
              practicable for the employee to raise the matter by those means, he brought to his
          ...
          meaning={
            <>
              The detriment protection. Subsection (c) covers the standard L3 case — raising a
              concern by reasonable means (verbal, written, escalation in writing). Subsection (d)
              covers leaving the workplace in serious and imminent danger; subsection (e) covers
              taking appropriate steps. Together they form the operative&apos;s safety-refusal
              toolkit.
            </>
          }
        ...
        <RegsCallout
          source="Public Interest Disclosure Act 1998 — inserted into ERA 1996 as s.43A-L"
          clause={
            <>
              ...
              interest and tends to show one or more of the following — (a) that a criminal offence
              has been committed... (b) that a person has failed to comply with any legal
              obligation... (d) that the health or safety of any individual has been, is being or is
              likely to be endangered...&quot;
            </>
          }
          meaning={
            <>
              The whistleblowing protection. &quot;Qualifying disclosure&quot; covers six categories
              including criminal offences, breach of legal obligation, danger to health or safety.
              Reasonable-belief standard — does not need to be proven true, just reasonably
              believed. Internal route normal first; external (to prescribed person such as HSE)
              protected after internal failure or in serious cases.
            </>
          }
          cite="Source: Public Interest Disclosure Act 1998, inserting Part IVA into Employment Rights Act 1996."
        />

        <ConceptBlock
          title="PIDA 1998 — whistleblowing for external escalation"
          plainEnglish='The Public Interest Disclosure Act 1998 amended ERA 1996 to protect "qualifying disclosures" — disclosure of information tending to show a criminal offence, breach of legal obligation, danger to health or safety, environmental damage, miscarriage of justice, or concealment of any of these. Internal disclosure is the normal first route; external disclosure (to a prescribed regulator like HSE) is protected where internal route has been exhausted or where the matter is exceptionally serious.'
          onSite="The L3 supervisor who has escalated internally without action and now needs to call HSE has PIDA protection — provided the internal route was attempted and the disclosure is in the public interest. PIDA does NOT protect malicious or knowingly false disclosure."
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              External disclosure to prescribed person (HSE for safety) protected after internal
              failure or in serious cases.
            </li>
            <li>
              Wider disclosure (media) protected only in very limited exceptionally serious cases.
            </li>
        ...
        <ConceptBlock
          title="Defective Premises Act 30-year retrospective limitation"
          plainEnglish="The Building Safety Act 2022 amended the Defective Premises Act 1972 to extend the limitation period for residential defect claims — 30 years retrospective for past claims, 15 years prospective for new work. This dramatically extends contractor liability for residential work. The L3 supervisor framing: shortcuts taken today can land in court 30 years later."
          onSite="The L3 supervisor culture on residential work: digital records indefinitely; design records retained; certification packs complete and traceable. Paper certs lost in 5 years are no defence in 25 years. The 30-year retrospective extension reaches old work; the 15-year prospective applies to new work going forward."
        >
        ...
        <SectionRule />
        <CommonMistake
          title="Going along with commercial pressure to keep the customer happy"
          whatHappens={
            <>
              L3 succumbs to customer pressure to short-cut isolation. Incident occurs. HSE
              prosecution; firm + L3 + customer (under s.36 if their pressure caused the breach) all
              liable. The L3&apos;s &quot;customer wanted it&quot; defence is rejected.
            </>
          }
          doInstead={
            <>
              Refuse. The customer&apos;s commercial preference doesn&apos;t override statute.
        ...
        <CommonMistake
          title='Treating "the firm decided" as personal protection'
          whatHappens={
            <>
              Firm director instructs unsafe procedure. L3 follows because &quot;director said
              so&quot;. HSE prosecution names the L3 personally under s.7. &quot;Director told
              me&quot; rejected as defence. Director also prosecuted under s.37.
            </>
          }
          doInstead={
            <>
              HASAWA s.7 personal duty isn&apos;t reduced by employer instruction. Refuse; document;
              escalate. ERA s.44 protects from any retaliation.
            </>
          }
        />

        <Scenario
          title="Customer demands non-compliant work"
          situation={
            <>
              Customer wants you to install a circuit without the RCD that BS 7671 requires for the
              location. They argue &quot;it&apos;s my house, I don&apos;t want a nuisance
              trip&quot;. They&apos;ll go to another contractor if you refuse. Your contracts
              manager calls and says &quot;just do it — we need the customer&quot;.
            </>
          }
          whatToDo={
            <>
              Apply the toolkit. Refuse: &quot;BS 7671 requires RCD protection in this location; we
              can&apos;t install non-compliantly.&quot; Document: text the customer summarising the
              conversation; email contracts manager confirming refusal and reason. Escalate: speak
              to QS / director if contracts manager won&apos;t accept. Frame: &quot;if we install
              non-compliantly and someone is injured, the cascade is HSE prosecution under EAWR Reg
              4 + BS 7671 non-compliance, civil claim by injured party, scheme deregistration risk,
              customer themselves may be liable under HASAWA s.36 for instructing the non-compliant
              install. Insurance won&apos;t cover criminal fines. The customer&apos;s commercial
              leverage is real but the legal framework isn&apos;t negotiable.&quot; Protect: ERA
              s.44 covers refusal to do unsafe / unlawful work. The customer can refuse to use you;
              they can&apos;t direct unsafe install. Most contracts managers respect the legal
              framing once it&apos;s clearly stated.
            </>
          }
          whyItMatters={
            <>
              This is the legal-vs-commercial conflict in action. Customer commercial preference +
              contracts-manager commercial response + firm&apos;s legal duty all collide. The L3
              supervisor&apos;s toolkit gives a structured response that protects the team, the firm
              and the operative personally. Most situations resolve with calm framing; the minority
              that don&apos;t are exactly the ones where ERA s.44 and PIDA 1998 protections matter.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>CAN allocate civil cost</strong> — who pays the claim, who pays the legal
              fees, who pays the remedial.
            </li>
            <li>
              <strong>CAN shift insurance burden</strong> — who carries PI / EL / PL cover for a
              given risk.
            </li>
            <li>
              <strong>CAN set commercial penalties</strong> — for delay, defects, non-performance.
            </li>
            <li>
              <strong>CANNOT remove statutory duty</strong> — HASAWA s.2/s.3, EAWR Reg 4/13/14/16,
              MHSWR Reg 3/5 etc all sit on the dutyholder regardless.
            </li>
            <li>
              <strong>CANNOT remove personal liability</strong> — s.7 (operative), s.36 (cause of
              another&apos;s offence), s.37 (director).
            </li>
            <li>
            ...
            <li>
              <strong>CANNOT cover criminal fines</strong> — insurance policies explicitly exclude
              criminal penalties.
            </li>
            <li>
              <strong>Customer&apos;s pressure can attract s.36 liability</strong> — where pressure
              caused another&apos;s offence.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              HASAWA s.36 reaches any person whose act or default caused another&apos;s offence.
            </li>
            ...
            <li>
              Customer&apos;s commercial pressure that causes contractor breach may attract s.36.
            </li>
            <li>Personal exposure for the customer — not just the firm.</li>
            <li>
              Framing to customer: &quot;this exposes you too&quot; tends to recalibrate sharply.
            </li>
            <li>Where it does not, the conversation moves to walking away from the contract.</li>
            <li>
              Protects the firm, the supervisor, the director and the customer simultaneously.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Calm, factual, depersonalised — &quot;the framework produces X consequence&quot;.
            </li>
            <li>Have a compliant alternative path to offer.</li>
            <li>Document the conversation contemporaneously.</li>
            <li>
              Most reasonable directors recalibrate; minority require further escalation or external
              disclosure.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <SectionRule />
        <ContentEyebrow>
          Environmental Protection Act 1990 — the parallel statutory framework
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              s.34 duty of care for waste — must reach authorised disposal route with transfer
              notes.
            </li>
            <li>WEEE Regulations 2013 — separate duty for electrical equipment waste.</li>
            <li>
              F-Gas Regulations — refrigeration / heat pump refrigerant work requires certification.
            </li>
            <li>
              Hazardous Waste Regulations 2005 — additional controls for asbestos / batteries /
              oils.
            </li>
            ...
            <li>
              Criminal liability under EPA 1990 may run alongside HASAWA in the same incident.
            </li>
            <li>
              Same L3 supervisor toolkit applies — refuse, document, escalate, frame, protect.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              EAWR Reg 16 — competence or appropriate supervision required for any work where
              technical knowledge / experience is needed to prevent danger.
            </li>
            <li>Personal duty — sits on the operative, not just the firm.</li>
            <li>
              &quot;Competence&quot; is qualifications + experience + current capability for the
              specific task.
            </li>
            <li>
              Supervision must be &quot;appropriate&quot; — proximity, knowledge, availability.
            </li>
            ...
            <li>
              Calm factual framing &quot;Reg 16 requires X; I do not have it; cannot proceed&quot;.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Corporate fine — Sentencing Council matrix starting point hundreds of thousands.
            </li>
            <li>Guilty-plea credit — typically one-third reduction if early.</li>
            <li>
              FFI invoice — typically four-to-five figures depending on investigation complexity.
            </li>
            <li>Legal defence costs — six figures even on guilty plea for serious cases.</li>
            <li>
              Civil compensation — varies widely by injury severity and loss; paid by insurer
              subject to limit.
            </li>
            ...
            <li>
              Director individual conviction — record, sentencing outcome (potential custody).
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Returns: framework eligibility, insurance pricing, customer retention, clean public
              register.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              HSE Public Register lists prosecutions, improvement notices, prohibition notices,
              Crown Censures.
            </li>
            <li>Entries persist 5+ years from date of entry.</li>
            <li>Visible to anyone with internet access — competitors, clients, insurers.</li>
            <li>
              Major public-sector frameworks require disclosure of HSE entries in pre-qualification
              questionnaires.
            </li>
            <li>
              Major private clients (Tier 1 contractors, large estates) routinely check the register
              before engaging.
            </li>
            <li>Insurance underwriters use register entries in pricing renewals.</li>
            <li>
              Scheme bodies may take parallel action — NICEIC / NAPIT investigations triggered by
              HSE outcome.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Technical investigation triggered by customer complaint, building control referral or
              media coverage.
            </li>
            <li>Re-assessment visit at firm&apos;s cost.</li>
            <li>Conditional registration with mandatory remedial works.</li>
            ...
            <li>Insurance premiums often rise where scheme actions on record.</li>
            <li>
              Public-facing customer-search portals (Trustmark, scheme directories) reflect status.
            </li>
            <li>
              Faster than HSE — scheme action can resolve within weeks where HSE prosecution takes
              months to years.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Public Liability (PL)</strong> — civil claims by third parties for injury /
              property damage.
            </li>
            <li>
              <strong>Employer&apos;s Liability (EL)</strong> — statutory; civil claims by
              employees.
            </li>
            <li>
              <strong>Professional Indemnity (PI)</strong> — civil claims for professional service
              failures.
            </li>
            <li>
              <strong>Product Liability</strong> — civil claims from supplied products.
            </li>
            <li>
              <strong>NOT covered</strong> — criminal fines (public policy).
            </li>
            <li>
              <strong>NOT covered</strong> — FFI invoices (regulatory cost recovery).
            </li>
            <li>
              <strong>NOT covered</strong> — loss of contracts, framework exclusion.
            </li>
            <li>
              <strong>NOT covered</strong> — reputational damage, scheme deregistration.
            </li>
            <li>
              Premium increases routine after claims; some insurers decline renewal
              post-prosecution.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Culpability — Very high</strong> — deliberate breach of, or flagrant disregard
              for, the law.
            </li>
            <li>
              <strong>Culpability — High</strong> — actual foresight of, or wilful blindness to,
              risk; systemic failure to address known risks.
            </li>
            <li>
              <strong>Culpability — Medium</strong> — failure to put in place recognised industry
              measures.
            </li>
            <li>
              <strong>Culpability — Low</strong> — failure that fell only slightly short of the
              appropriate standard.
            </li>
            <li>
              <strong>Harm category 1</strong> — life-threatening / fatal / permanent.
            </li>
            <li>
              <strong>Harm category 2</strong> — physical or psychological harm not falling within
              category 1.
            </li>
            <li>
              <strong>Harm category 3</strong> — minor / short-term harm.
            </li>
            <li>
              <strong>Turnover bands</strong> — Large &gt; £50m, Medium £10-50m, Small £2-10m, Micro
              &lt; £2m.
            </li>
            <li>
              <strong>Starting points</strong> — vary by cell; very large companies with high
              culpability and category 1 harm start in the millions.
            </li>
            <li>
              <strong>Range adjustment</strong> — aggravating factors (previous convictions,
              deliberate concealment, vulnerable victims) push up; mitigating factors (prompt
              acceptance, cooperation, remediation) pull down.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;Step One — Determining the offence category. The court should determine the
              offence category using only the culpability and harm factors set out in the tables
              below. Where an offence does not fall squarely into a category, individual factors may
              require a degree of weighting before making an overall assessment and determining the
              appropriate offence category.&quot;
            </>
          }
          meaning={
            <>
              The matrix is structured but with judicial discretion. The court works through
              culpability and harm first, then locates the offender in a turnover band, then applies
              a starting point. The published guideline runs to over 30 pages with worked examples;
              the L3 supervisor needs the outline understanding, not the detailed calculation. The
              point is that fines are no longer arbitrary — they are structured and predictable for
              given cells of the matrix.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Very high culpability x harm 1</strong> — starting point custody around 18
              months; range 1-2 years.
            </li>
            <li>
              <strong>High culpability x harm 1</strong> — starting point custody around 12 months;
              range 36 weeks to 2 years.
            </li>
            <li>
              <strong>High culpability x harm 2</strong> — high-level community order or short
              custody.
            </li>
            <li>
              <strong>Medium culpability x harm 2</strong> — medium community order or substantial
              fine.
            </li>
            <li>
              <strong>Low culpability</strong> — typically band B-C fines.
            </li>
            <li>
              Aggravating factors push up — previous convictions, ignoring warnings, deliberate
              concealment, abuse of position.
            </li>
            <li>
              Mitigating factors pull down — early guilty plea, cooperation, genuine remorse,
              voluntary remediation.
            </li>
            <li>
              Routes to individual liability — HASAWA s.7 (operative), s.36 (cause of another&apos;s
              offence), s.37 (director).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Most reasonable customers accept the framing; the minority that do not are exactly
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Contracts manager is source of pressure → escalate to QS / H&amp;S manager / director.
            </li>
            ...
            <li>
              Brief factual escalation in writing — what was asked, framework, consequence cascade,
              action requested.
            </li>
        ...
        <Scenario
          ...
          situation={
            <>
              Your contracts manager calls late afternoon: a high-value commercial client is
              demanding the work continue overnight without scheduled isolation because their
              production line cannot afford the downtime. The work is on a 415V three-phase
              distribution board feeding the production circuits. The contracts manager says:
              &quot;just work around it, use rubber gloves, we cannot afford to lose this
              customer.&quot; Your L2 mate is on site with you.
            </>
          }
          whatToDo={
            <>
              Refuse — calmly, factually, in the language of the regulation. &quot;Live working on
              three-phase distribution is governed by EAWR Reg 14 — it requires the three-test: not
              reasonable to dead-work, properly-judged risk, suitable precautions. The
              customer&apos;s commercial preference does not satisfy any of the three. We cannot
              work live on this kit.&quot; Document immediately — text the contracts manager
              confirming the conversation; email a brief summary with the EAWR Reg 14 reference.
              Escalate — if the contracts manager pushes back, ask whether the firm&apos;s QS or
              director is available; brief them factually. Frame the consequence cascade — EAWR Reg
              14 breach + HASAWA s.2 + s.3 + s.7 personal exposure + s.37 director personal exposure
              + Sentencing Council matrix + insurance exclusion of criminal fines + HSE public
              register entry + scheme implications. Most directors at this point accept the
              constraint and call the customer to renegotiate the window. Protect — ERA s.44 covers
              your refusal; PIDA 1998 covers external escalation to HSE if internal route fails.
              Brief your L2 mate clearly that you are stopping; do not leave them in ambiguity.
            </>
          }
          whyItMatters={
            <>
              This scenario is one of the most common legal-vs-commercial conflicts in the trade.
              The customer&apos;s commercial preference, the contracts manager&apos;s commercial
              response, and the supervisor&apos;s legal duty all collide in a single late-afternoon
              phone call. The L3 supervisor&apos;s toolkit — refuse + document + escalate + frame +
              protect — gives a structured response that protects the team, the firm and the
              operative personally. The discipline matters because cases exactly like this have
              produced prosecutions, custody for directors, and firm closures. Calm factual refusal
              at the supervisor level prevents all of that.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Senior management&apos;s management or organisation was substantial element in breach.
            </li>
            <li>Triable on indictment only — Crown Court, jury trial.</li>
            <li>
              Unlimited fines (Sentencing Council guideline produces multi-million fines for serious
              cases).
            </li>
            ...
            <li>
              Pre-2007 &apos;identification doctrine&apos; problem fixed — large companies now
              prosecutable.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              in which its activities are managed or organised — (a) causes a person&apos;s death,
          ...
          meaning={
            <>
              The CMCHA offence. &quot;Managed or organised&quot; is the route that fixes the old
              identification-doctrine problem — the prosecution does not have to find a single
              directing mind. Senior management failure to manage or organise is the gravamen.
              &quot;Gross breach&quot; is a high bar — conduct falling far below what could
              reasonably be expected. The Sentencing Council guideline produces fines in the
              millions for serious cases.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HSE criminal prosecution</strong> — HASAWA / EAWR / specific regs;
              magistrates&apos; or Crown Court.
            </li>
            <li>
              <strong>Corporate Manslaughter (CMCHA 2007)</strong> — where death occurred and senior
              management failure substantial.
            </li>
            <li>
              <strong>Civil negligence claim</strong> — by injured party or family; PI / EL / PL
              insurance involvement.
            </li>
            <li>
              <strong>Defective Premises Act claim</strong> — residential work; up to 30 years
              retrospective.
            </li>
            <li>
              <strong>Coroner&apos;s inquest</strong> — where death occurred.
            </li>
            <li>
              <strong>Scheme body investigation</strong> — NICEIC / NAPIT / ELECSA / Stroma.
            </li>
            <li>
              <strong>Employment tribunal</strong> — ERA s.44 / PIDA 1998 claims by operatives.
            </li>
            <li>
              <strong>Building Safety Regulator</strong> — where HRRB involvement.
            </li>
            <li>
              <strong>Insurance investigation</strong> — separate from regulatory and civil.
            </li>
            <li>
              <strong>Police investigation</strong> — where criminal conduct beyond H&amp;S
              suspected.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module1-section5-5')}
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">
              5.5 Risk assessment as supervisor
            </div>
          </button>
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module1-section6')}
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">
              Section 6 - BSA 2022 + advanced incidents
            </div>
          </button>
        </div>
      </HubBody>
