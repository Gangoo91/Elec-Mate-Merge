...
const checks = [
  ...
  ], correctIndex: 3, explanation: 'L3 is reviewer, signer, decider, contributor and coach — also contributing to writing RAMS for routine jobs. L2 is a follower.' },
  ...
  ], correctIndex: 0, explanation: 'Objective test against actual conditions and good practice (HSG guidance, BS 7671 etc). After an incident the HSE inspector asks whether the RA engaged with the actual conditions. Templates that do not engage fail the test.' },
  ...
  ], correctIndex: 3, explanation: 'A fresh dynamic assessment supplements the RAMS for minor divergence; significant divergence means escalating for a fresh RAMS rather than managing on the fly. Document the decision.' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'An operational mindset of verification, not paperwork compliance — is anyone slipping, what has changed since the last visit, are controls still in place?' },
  ...
  ], correctAnswer: 3, explanation: 'Reg 3 is the duty to assess; Reg 5 is the POCMR cycle that runs the system operationalising the assessment. RA is one input.' },
  ...
  ], correctAnswer: 0, explanation: 'Verification by comparison and observation — and verifying HSE or industry guidance was considered. Templates that fail the "could anyone reading this understand the hazards and controls?" test fail suitable and sufficient.' },
  ...
  ], correctAnswer: 3, explanation: 'The L3 increasingly contributes to the firm\'s RAMS process — feedback on what is working, near-miss data feeding the next update, template review and coaching. Site experience feeds template improvement.' },
  ...
  ], correctAnswer: 0, explanation: 'Coaching by guided practice — ask what hazards they see, explain the reasoning behind controls, show them how to write a dynamic note and correct their calibration over time. Building L2 RA capability is part of the L3 contribution.' },
];
