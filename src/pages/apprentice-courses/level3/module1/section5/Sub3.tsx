...
const checks = [
  { id: 'l3-m1-s5-sub3-matrix', question: 'Three inputs to the corporate fine matrix?', options: [
    ...
    'Culpability (Very High / High / Medium / Low) x Harm (Cat 1/2/3 with adjustments) x Turnover band (Large £50m+ / Medium £10-50m / Small £2-10m / Micro <£2m).',
  ...
  ], correctIndex: 2, explanation: 'Three inputs; cell gives starting point and range. Adjusted for aggravating and mitigating factors.' },
  { id: 'l3-m1-s5-sub3-individual', question: 'Can individuals receive custody under the guideline?', options: [
    'Yes — for high-culpability cases the individual sentencing matrix includes immediate custody. Director liability under HASAWA s.37 plus operative liability under s.7 in serious cases.',
  ...
  ], correctIndex: 0, explanation: 'Individual sentences include custody at top end. Knowing this changes how senior conversations land.' },
  { id: 'l3-m1-s5-sub3-aggravating', question: 'Name two aggravating factors that push fines up.', options: [
    'Cost-cutting at the expense of safety; failure to heed warnings; targeting of vulnerable victims; deliberate concealment; poor safety record; risk of multiple persons; failure to react to warnings; obstruction of investigation.',
  ...
  ], correctIndex: 0, explanation: 'Long list of aggravating factors. Knowing them informs the firm\'s incident response (no concealment, full cooperation, prompt remedial = mitigating).' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: '2016 onwards. Pre-2016 fines often <£20k; post-2016 routinely six-figure to multi-million for major corporations.' },
  ...
  ], correctAnswer: 2, explanation: 'Very high = deliberate. Top of the matrix; highest sentences.' },
  ...
  ], correctAnswer: 3, explanation: 'Cat 1 = most serious; permanent / fatal. Different starting fine; range escalates.' },
  ...
  ], correctAnswer: 0, explanation: 'Turnover (not profit). Large electrical contractors regularly hit Medium / Large band.' },
  ...
  ], correctAnswer: 1, explanation: 'Top cell into the millions. Corporate manslaughter under CMCHA 2007 has unlimited fines and average ~£5-10m.' },
  { id: 6, question: 'What aggravating factors push fines UP?', options: [
    ...
    'Cost-cutting motive; failure to heed warnings; risk to multiple persons; targeting vulnerable victims; poor previous safety record; deliberate concealment; obstruction of investigation; deliberate falsification of records.',
  ...
  ], correctAnswer: 2, explanation: 'Aggravating factors are well-defined; firms can avoid them by good incident response.' },
  { id: 7, question: 'What mitigating factors push fines DOWN?', options: [
    ...
    'Early plea; prompt remedial action; full cooperation with investigation; no previous record; safety culture demonstrated; charity for victims; senior management changes; good ongoing safety performance.',
  ], correctAnswer: 3, explanation: 'Mitigating factors are equally well-defined. Good incident response demonstrably reduces sentences.' },
  ...
  ], correctAnswer: 0, explanation: 'L3 supervisor framing — the cascade is real, structured, and personal at the top end.' },
];
