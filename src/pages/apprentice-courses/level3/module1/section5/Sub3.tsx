...
const checks = [
  { id: 'l3-m1-s5-sub3-matrix', question: 'Three inputs to the corporate fine matrix?', options: [
  ...
  ], correctIndex: 2, explanation: 'Three inputs: Culpability (Very High / High / Medium / Low) x Harm (Cat 1/2/3 with adjustments) x Turnover band (Large £50m+ / Medium £10-50m / Small £2-10m / Micro <£2m). The cell gives a starting point and range, adjusted for aggravating and mitigating factors.' },
  { id: 'l3-m1-s5-sub3-individual', question: 'Can individuals receive custody under the guideline?', options: [
  ...
  ], correctIndex: 0, explanation: 'Individual sentences include custody at the top end — director liability under HASAWA s.37 plus operative liability under s.7 in serious cases. Knowing this changes how senior conversations land.' },
  { id: 'l3-m1-s5-sub3-aggravating', question: 'Name two aggravating factors that push fines up.', options: [
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'The 2016 guideline had a significant impact on fine levels. Pre-2016 fines were often under £20k; post-2016 they are routinely six-figure to multi-million for major corporations.' },
  { id: 2, question: 'Define "very high" culpability.', options: [
  ...
  ], correctAnswer: 2, explanation: 'Very high = deliberate: knew about the hazard and ignored it, knowingly used unsafe procedures, or deliberate cost-cutting that caused exposure. Top of the matrix; the highest sentences.' },
  { id: 3, question: 'Define "Category 1 harm".', options: [
  ...
  ], correctAnswer: 3, explanation: 'Cat 1 is the most serious: death, or physical / mental impairment resulting in lifelong dependency on third-party care, or significantly reduced life expectancy. It carries a different starting fine and the range escalates.' },
  { id: 4, question: 'How is the turnover band determined?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Turnover (revenue), not profit. Large = £50m+, Medium = £10-50m, Small = £2-10m, Micro = under £2m; some "very large" companies have a higher band where turnover greatly exceeds £50m. Large electrical contractors regularly hit Medium / Large band.' },
  { id: 5, question: 'What\'s the highest cell of the matrix?', options: [
  ...
  ], correctAnswer: 1, explanation: 'Very High culpability x Cat 1 harm x Large / Very Large turnover, with starting points around £4m-£10m+ and a range up to £20m+. Corporate manslaughter under CMCHA 2007 carries unlimited fines, averaging ~£5-10m (e.g. Whirlpool £15m).' },
  { id: 6, question: 'What aggravating factors push fines UP?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Aggravating factors include cost-cutting motive, failure to heed warnings, risk to multiple persons, targeting vulnerable victims, poor previous record, deliberate concealment, obstruction of the investigation and falsification of records. Firms avoid them by good incident response.' },
  { id: 7, question: 'What mitigating factors push fines DOWN?', options: [
  ...
  ], correctAnswer: 3, explanation: 'Mitigating factors include an early plea, prompt remedial action, full cooperation with the investigation, no previous record, a demonstrated safety culture, support for victims, senior management changes and good ongoing safety performance. Good incident response demonstrably reduces sentences.' },
  { id: 8, question: 'Why is the guideline relevant to the L3 apprentice?', options: [
  ...
  ], correctAnswer: 0, explanation: 'The cascade is structured by the Sentencing Council guideline, so the L3 can say roughly where an incident would land. Plus director liability under s.37 means an L3\'s observations to senior management land with weight.' },
];
