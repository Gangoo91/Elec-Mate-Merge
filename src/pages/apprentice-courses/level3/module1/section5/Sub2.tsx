...
const checks = [
  ...
  ], correctIndex: 3, explanation: 'Reg 9 = plan, manage, monitor — by themselves or by workers under their control — applying the general principles of prevention, complying with directions of the principal designer / principal contractor, and verifying client awareness. The L3 supervisor is increasingly the firm\'s eyes and ears for these duties on site.' },
  ...
  ], correctIndex: 2, explanation: 'Reg 15 = cooperate, comply, report — report to the PC / contractor anything likely to endanger health and safety. The L2 baseline; L3 keeps Reg 15 and increasingly contributes to Reg 9.' },
  ...
  ], correctIndex: 2, explanation: 'L2 is mostly Reg 15 (comply, cooperate, report). L3 starts to plan, manage and monitor as the firm\'s Reg 9 contractor representative — especially when leading a small team or running a single-contractor job alone. Still a worker, but contributing increasingly to contractor responsibilities.' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'CDM applies to all construction work with no monetary threshold. F10 notification is only required for projects over 30 days with 20+ workers, OR over 500 person-days — but CDM duties apply regardless of notifiability. Many small jobs are CDM projects.' },
  ...
  ], correctAnswer: 2, explanation: 'A wide definition: building, civil engineering or engineering construction work, including alteration, renovation, demolition, conversion, repair, maintenance, decoration, removal of structures, and installation / removal / maintenance of mechanical, electrical and similar services. Most electrical contracting falls within scope.' },
  ...
  ], correctAnswer: 0, explanation: 'CDM Reg 12 requires the CPP (drawn up by the contractor on single-contractor projects, by the principal contractor on multi-contractor projects). It must be in place BEFORE construction starts; the HSE CIS80 template suits small projects. Mandatory for every project — brief for small, detailed for complex.' },
  ...
  ], correctAnswer: 1, explanation: 'The L3 acts as the firm\'s contractor representative — verifies client awareness (Reg 9(1)), implements the CPP, briefs operatives, monitors compliance and escalates issues. The Reg 9 contractor duties run through the firm\'s representative on the day.' },
  ...
  ], correctAnswer: 2, explanation: 'Reg 9(1): the contractor must satisfy themselves the client knows their CDM client duties before starting — particularly relevant on commercial projects where the domestic-style cascade doesn\'t apply. A brief conversation, but mandatory.' },
  ...
  ], correctAnswer: 3, explanation: 'Most client duties (Reg 4) cascade from the domestic homeowner to the contractor (single-contractor) or principal contractor (multi-contractor). The homeowner remains client in name but the contractor holds the operational duty. Non-domestic clients retain their duties.' },
  ...
  ], correctAnswer: 0, explanation: 'Eight-point operational checklist: (1) verify CPP reflects the work; (2) verify client awareness; (3) brief operatives on the CPP; (4) dynamic risk assessment; (5) manage and monitor in practice; (6) document the day\'s safety actions; (7) escalate issues; (8) close out — lessons, records, cleanup.' },
];
