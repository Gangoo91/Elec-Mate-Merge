...
const DESCRIPTION =
  'L3 deep-dive on RIDDOR Schedule 1 specified injuries — fractures, amputations, sight loss, crush, burns, scalping, unconsciousness, enclosed-space.';

const checks = [
  {
    id: 'l3-m1-s5-sub4-fingers',
    question: 'Are finger fractures RIDDOR specified injuries?',
    options: [
      'YES — any bone fracture is a specified injury under Schedule 1, including fingers, thumbs and toes.',
      'YES — but only where the fracture needs surgery rather than a splint.',
      'NO — Schedule 1 excludes fractures to fingers, thumbs and toes.',
      'NO — no fracture is ever a specified injury; only amputations and crush injuries qualify.',
    ],
    correctIndex: 2,
    explanation:
      'Schedule 1 explicitly excludes fingers, thumbs and toes from the fracture category, so a finger fracture from a tool drop is not a specified injury. It may still be over-7-day reportable (F2508A) if it keeps the worker off normal duties for 8 or more days.',
  },
  {
    id: 'l3-m1-s5-sub4-burn',
    question: 'When is a burn a Schedule 1 specified injury?',
    options: [
      'Whenever a burn requires any first-aid treatment, however small the affected area.',
      'When it covers more than 10% of the body, or damages eyes, respiratory system or vital organs.',
      'Only when caused by direct contact with a live conductor rather than by an arc flash.',
      'Only when the burn covers more than 50% of the body, the life-threatening threshold.',
    ],
    correctIndex: 1,
    explanation:
      'Two triggers: more than 10% body coverage OR significant damage to eyes, respiratory system or other vital organs. Many electrical burns hit one or the other. Smaller burns may still be over-7-day reportable if incapacitating.',
  },
  {
    ...
    options: [
      ...
      'Any injury from restricted access making escape hard, even where no health effect resulted.',
      'Any injury occurring below ground level, such as in a cellar, basement or service trench.',
    ],
    correctIndex: 1,
    explanation:
      'The category covers injury arising from work in an enclosed space leading to hypothermia or heat-induced illness, OR requiring resuscitation, OR requiring admittance to hospital for more than 24 hours. Confined Spaces Regs 1997 hazards trigger it.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question: 'Where is the specified-injuries list?',
    options: ['HSG85.', 'RIDDOR 2013 Schedule 1.', 'BS 7671.', 'GS38.'],
    correctAnswer: 1,
    explanation: 'Schedule 1 RIDDOR. The full list is short; worth memorising.',
  },
  {
    id: 2,
    question: "What's the timescale for reporting a specified injury?",
    options: [
      'Within 15 days on form F2508A, the same as an over-7-day injury.',
      "Within 28 days, in the firm's next routine RIDDOR return.",
      'Without delay (telephone notification expected for fatalities and specified injuries) + F2508 within 10 days.',
      'At the end of the financial year, in the annual accident summary.',
    ],
    correctAnswer: 2,
    explanation: 'Phone immediately, F2508 within 10 days. Same as fatality timescale.',
  },
  {
    id: 3,
    question: 'Are amputations always specified injuries?',
    options: [
      'No — only the amputation of a whole limb is reportable; a finger or toe is excluded.',
      'No — an amputation is only specified if the part cannot be surgically reattached.',
      'No — amputations are reported as over-7-day injuries if the worker is off for 8 or more days.',
      'Yes — Schedule 1 covers any amputation, with no minimum size threshold.',
    ],
    correctAnswer: 3,
    explanation:
      'Schedule 1 includes amputation with no minimum size threshold. Even a partial finger-tip amputation triggers immediate phone notification plus F2508.',
  },
  {
    id: 4,
    ...
    options: [
      ...
      'A burn to the head and hair from an arc flash, regardless of the depth of tissue damage.',
      'Concussion from a blow to the head causing temporary loss of consciousness but no skin loss.',
    ],
    correctAnswer: 0,
    explanation:
      'Scalping is traumatic detachment of skin or soft tissue from the head, often from machinery contact such as rotating shafts catching hair. Rare in electrical work but possible.',
  },
  {
    id: 5,
    ...
    options: [
      ...
      'Any period of disorientation following a blow to the head, even where the casualty did not black out.',
      'Loss of consciousness caused only by a pre-existing condition such as low blood sugar or epilepsy.',
    ],
    correctAnswer: 1,
    explanation:
      'Schedule 1 covers loss of consciousness from head injury or from asphyxiation, including electrical events causing respiratory failure. Even brief loss requires immediate notification.',
  },
  {
    id: 6,
    question: "What's the difference between Schedule 1 and over-7-day?",
    options: [
      'There is no difference — both are reported on the same form within the same timescale.',
      'Schedule 1 covers injuries to employees; over-7-day covers injuries to members of the public.',
      'Schedule 1 triggers immediate phone plus F2508 within 10 days; over-7-day triggers F2508A within 15 days.',
      'Schedule 1 applies to fatalities only; over-7-day applies to every other reportable injury.',
    ],
    correctAnswer: 2,
    explanation:
      'Two distinct categories with different forms and timescales: Schedule 1 is the severe-injury list, over-7-day is an injury causing 8+ days off normal duties. An injury can be both, but is reported as specified, not over-7-day.',
  },
  {
    id: 7,
    ...
    options: [
      ...
      'Any injury from a falling object, whether or not internal organs are involved.',
      'Crushing trauma to head or torso resulting in damage to internal organs.',
    ],
    correctAnswer: 3,
    explanation:
      'Crushing trauma resulting in internal organ damage (liver, kidney, lung, abdominal organs) is a Schedule 1 specified injury. Significant force is required — commonly falling objects, vehicle impacts or structural collapse. The internal-organ aspect is the trigger.',
  },
  {
    id: 8,
    question: 'How does the L3 supervisor identify a specified injury at the scene?',
    options: [
      'Match the observed symptoms to the Schedule 1 categories and escalate if any fit.',
      'Assume every injury is specified and report all of them immediately, regardless of severity.',
      'Wait until a doctor confirms the diagnosis in writing before deciding whether anything is reportable.',
      'Treat only injuries that keep the worker off for more than seven days as reportable.',
    ],
    correctAnswer: 0,
    explanation:
      'Match symptoms to the Schedule 1 list — visible fracture (excluding finger/thumb/toe), amputation, sight loss, crush with internal symptoms, burn over 10% or vital organ, scalping, LOC, enclosed-space asphyxia or heat. When in doubt, treat as specified; over-escalation is better than a missed report.',
  },
];

const faqs = [
  {
    question: 'Does the RIDDOR responsible person have to phone before submitting F2508?',
    answer:
      'For fatalities and specified injuries, immediate phone notification (0345 300 9923) is expected. F2508 follows within 10 days online. For other categories, online F2508 / F2508A is the only required submission.',
  },
  {
    question: 'What if the injury is reported by the casualty later (not at the time)?',
    answer:
      "The 10-day clock starts at the INCIDENT, not the report. Late reporting because the casualty was slow to mention it doesn't excuse the firm. Once the responsible person becomes aware, they should report promptly even if the deadline has passed.",
  },
  {
    question: 'Are mental health injuries specified injuries?',
    answer:
      'Generally no — Schedule 1 is physical injuries. Mental health may be reportable as occupational disease (Schedule 3) in some cases. Stress claims more typically civil rather than RIDDOR territory.',
  },
  {
  ...
  },
  {
    ...
    answer:
      "No — RIDDOR is duty on responsible person, not casualty. If the responsible person believes a specified injury occurred, they report regardless of casualty's treatment decisions.",
  },
  {
    question: 'Why does the responsible person need to know the Schedule 1 list?',
    answer:
      'Because they make the categorisation decision at the moment of the incident report. Operative provides facts; responsible person matches to category and decides timescale / form.',
  },
  {
    question: 'Who counts as the "responsible person" for RIDDOR purposes?',
    answer:
      "Reg 3 RIDDOR 2013 defines it. For employees, the responsible person is the employer. For the self-employed working under someone's control, it is the person in control of the premises. For training arrangements, the placement provider. The L3 supervisor is rarely the responsible person but is usually the first to know the facts.",
  },
  {
    question: 'Can an operative submit the F2508 themselves?',
    answer:
      "F2508 is the responsible person's submission. An operative can act as agent of the firm but the legal duty sits on the responsible person. In practice the firm's H&S manager or contracts manager submits with the operative's factual input.",
  },
  {
    question: 'What is the relationship between RIDDOR and a civil claim?',
    answer:
      'RIDDOR is a criminal-side reporting duty to the regulator. A civil claim runs separately under common law negligence and the relevant statutes (PI, EL, PL). The RIDDOR report often becomes evidence in any subsequent civil claim, which is why the contemporaneous documentation discipline matters so much.',
  },
  {
    question: 'Why does HSE publish RIDDOR statistics?',
    answer:
      "RIDDOR data feeds the HSE's national statistics on workplace injury and ill health, drives intervention targeting and informs sector-specific campaigns. Under-reporting distorts the picture; the regulator routinely cross-checks RIDDOR returns against A&E data and insurance claims to identify potential under-reporting at firm level.",
  },
];
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 5 · Subsection 4"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'Remember from Section 2.5 — RIDDOR has multiple categories. This Sub deep-dives Schedule 1 (specified injuries) - the immediate-phone-notification category.'
          }
        </p>
        ...
        <ConceptBlock
          title="The full specified-injury list"
          plainEnglish="RIDDOR 2013 Schedule 1 lists the specified injuries that trigger immediate phone notification and F2508 within 10 days. Short list; worth knowing in detail because the L3 supervisor often makes the first categorisation call at the scene."
          onSite="Match symptoms to the list. When in doubt, treat as specified and escalate. Over-escalation has no penalty; under-escalation can mean late-reporting offence under Reg 6."
        >
          <p>Schedule 1 categories:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fractures</strong> (other than to fingers, thumbs and toes) — including hand,
              wrist, forearm, leg, foot (excl toes), head, ribs, pelvis, spine.
            </li>
            <li>
              <strong>Amputations</strong> — any amputation including partial (finger-tip).
            </li>
            <li>
              <strong>Permanent loss of sight or reduction of sight</strong> — any eye injury
              causing sight loss.
            </li>
            <li>
              <strong>
            ...
            <li>
              <strong>Serious burns</strong> covering more than 10% of body OR causing significant
              damage to eyes, respiratory system or other vital organs.
            </li>
            <li>
              <strong>Scalpings</strong> (separation of skin from head) requiring hospital
              treatment.
            </li>
            <li>
            ...
            <li>
              <strong>Any other injury arising from work in an enclosed space</strong> leading to
              hypothermia or heat-induced illness; OR requiring resuscitation; OR requiring
        ...
        <RegsCallout
          source="RIDDOR 2013 — Reg 4(2)"
          clause={
            <>
              "Where any person at work suffers a specified injury (Schedule 1) as a result of a
              work-related accident, the responsible person must follow the reporting procedure."
            </>
          }
          meaning={
            <>
              Reg 4(2) creates the specified-injury reporting duty. Reg 6 sets out the procedure
              (immediate notification + F2508 within 10 days). Schedule 1 lists the categories.
              Together they form the specified-injury reporting regime.
            </>
          }
          cite="Source: RIDDOR 2013 (SI 2013/1471), Reg 4(2) + Schedule 1."
        />
        ...
        <ConceptBlock
          title="Where Schedule 1 sits in the broader RIDDOR map"
          plainEnglish="RIDDOR 2013 has multiple parallel reporting categories: fatalities (Reg 6), specified injuries Schedule 1 (Reg 4), over-7-day injuries (Reg 4(3)), occupational diseases (Reg 8 + Schedule 3), dangerous occurrences (Reg 7 + Schedule 2), gas incidents (Regs 11-12), road traffic accidents at work in some cases. Each category has its own form, timescale and trigger."
          onSite="The L3 supervisor first decides which CATEGORY applies, then which FORM and TIMESCALE. Schedule 1 specified injury triggers immediate phone + F2508 within 10 days; over-7-day triggers F2508A within 15 days; dangerous occurrence triggers F2508 within 10 days regardless of injury."
        >
          <p>The category map:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fatality</strong> — Reg 6 — phone immediately + F2508 within 10 days.
            </li>
            <li>
              <strong>Specified injury (Schedule 1)</strong> — Reg 4(2) — phone immediately + F2508
              within 10 days.
            </li>
            <li>
              <strong>Over-7-day injury</strong> — Reg 4(3) — F2508A within 15 days.
            </li>
            <li>
              <strong>Over-3-day injury (record-keeping only)</strong> — kept in accident book; not
              reported to HSE.
            </li>
            <li>
              <strong>Occupational disease (Schedule 3)</strong> — Reg 8 — F2508A within 10 days of
              diagnosis.
            </li>
            <li>
              <strong>Dangerous occurrence (Schedule 2)</strong> — Reg 7 — F2508 within 10 days
              regardless of injury.
            </li>
            <li>
              <strong>Gas incident</strong> — Reg 11 — Gas-Safe-related; specific reporting.
            </li>
          </ul>
        </ConceptBlock>

        <RegsCallout
          source="RIDDOR 2013 — Reg 6 (Fatalities)"
          clause={
            <>
              &quot;Where any person dies as a result of a work-related accident, the responsible
              person must follow the reporting procedure.&quot;
            </>
          }
          meaning={
            <>
              The fatality reporting duty. Same procedure as Schedule 1 — phone immediately + F2508
              within 10 days. Coroner becomes involved separately. The L3 supervisor at the scene of
              a fatality preserves the scene completely, calls emergency services first, then the
              responsible person. Do not move the deceased except where required for first aid
              attempts.
            </>
          }
          cite="Source: RIDDOR 2013 (SI 2013/1471), Reg 6."
        />

        <ConceptBlock
          title="Dangerous occurrences — Schedule 2 in detail"
          plainEnglish="Dangerous occurrences are defined incidents that did not result in injury but could have. RIDDOR Schedule 2 lists categories — many are electrical-trade relevant: collapse / overturning of plant (e.g. MEWP failure), failure of pressure systems, failure of lifting equipment, electrical short-circuit causing fire / explosion, contact with overhead lines, contact with underground services, scaffold collapse."
          onSite="Reportable even with NO injury. The F2508 within 10 days. Common trigger that L3 misses: striking a buried electricity service when digging — that is a Schedule 2 dangerous occurrence whether or not anyone is injured."
        >
          <p>Schedule 2 dangerous occurrences relevant to electrical trade:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Collapse / overturning / failure of load-bearing parts of lifts, hoists, MEWPs,
              cranes.
            </li>
            <li>Plant or equipment coming into contact with overhead power lines.</li>
            <li>
              Failure of any closed vessel under pressure (transformer / capacitor / battery in some
              cases).
            </li>
            <li>Electrical short-circuit / overload causing fire or explosion.</li>
            <li>Unintentional ignition of explosives.</li>
            <li>
              Contact with buried services causing injury risk (cable strike, gas line strike).
            </li>
        ...
        <ConceptBlock
          title="Record-keeping and the accident book"
          plainEnglish="RIDDOR Reg 12 requires the responsible person to keep records of any reportable incident for 3 years from the date of report. Practice in residential / Defective Premises Act-relevant work is to keep indefinitely (DPA 30-year retrospective limitation under BSA 2022 reaches old records). Accident book entries (BI 510 or equivalent) are separate but related — every workplace must maintain one."
          onSite="The L3 supervisor culture: every incident logged in the accident book regardless of RIDDOR triggering. Date, time, casualty, witnesses, what happened, treatment, follow-up. The accident book is the firm’s contemporaneous record and feeds RIDDOR decisions plus the firm’s near-miss programme."
        >
        ...
        <ConceptBlock
          title="Overlap with safeguarding, coronial, and police processes"
          plainEnglish="A serious incident can trigger parallel processes: HSE under RIDDOR, coroner’s inquest where death occurred, police investigation if criminal conduct suspected (manslaughter etc), safeguarding referrals where vulnerable persons involved, scheme body investigations (NICEIC / NAPIT). Each runs independently with their own timescales and disclosure requirements."
          onSite="L3 supervisor at scene: cooperate with all but speak through firm legal / H&S contact. Do not give long impromptu interviews to anyone — provide name, basic facts, and the firm’s contact. Police interviews under caution should always be with legal representation."
        >
        ...
        <SectionRule />
        <CommonMistake
          title="Waiting for hospital confirmation before phoning the responsible person"
          whatHappens={
            <>
              Operative waits for X-ray / discharge before contacting firm. Several hours pass.
              Responsible person now has compressed window to make immediate phone notification.
              F2508 still possible within 10 days but the &quot;without delay&quot; phone duty for
              specified injury is degraded. Aggravating factor for any subsequent prosecution.
            </>
          }
          doInstead={
            <>
              Phone immediately based on observed symptoms. Update later as diagnosis confirms. The
              responsible person can phone HSE based on the operative&apos;s preliminary report and
        ...
        <RegsCallout
          source="RIDDOR 2013 — Reg 12 (Records)"
          clause={
            <>
              &quot;The responsible person must keep a record of — (a) any reportable accident,
              dangerous occurrence or diagnosis of a reportable disease... The record... must be
              kept for at least three years from the date on which it was made.&quot;
            </>
          }
          meaning={
            <>
              The record-keeping duty. Three-year minimum is the legal floor; practice in
              residential / DPA-relevant work is to keep indefinitely. Records include incident
              details, witness accounts, reporting timeline, follow-up actions.
            </>
          }
          cite="Source: RIDDOR 2013 (SI 2013/1471), Reg 12."
        />

        <ConceptBlock
          title="Scene preservation and the L3 evidence reflex"
          plainEnglish="After any specified injury or dangerous occurrence, the scene preservation discipline is critical. Photograph from multiple angles before anything is touched; note time, position, isolation status, witnesses, weather, lighting; preserve any equipment involved (do not return to stores, do not allow others to handle); secure the area."
          onSite="The L3 supervisor reflex on a serious incident: render first aid → call ambulance → call responsible person → preserve scene → photograph → witness statements. The order matters but the photographic evidence is the irreversible step — once the scene is cleaned the evidence is gone forever."
        >
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Schedule 1 exclusion of fingers does NOT exclude over-7-day reporting. Two parallel
              categories: specified injury (Schedule 1) and over-7-day. Check both.
            </>
          }
        />

        <Scenario
          title="Suspected specified injury at the scene"
          situation={
            <>
          ...
          whatToDo={
            <>
              Immediate sequence. (1) First aid — keep them still and warm; don’t move suspected
              fracture; ambulance called. (2) Identify likely Schedule 1 — fracture excluding
              fingers/thumbs/toes; lower leg fracture qualifies. (3) PHONE responsible person
              immediately — "suspected specified injury, lower leg fracture from fall from step-up".
              They will (a) contact HSE 0345 300 9923 without delay; (b) initiate F2508 process for
              submission within 10 days. (4) Preserve scene — photograph the step-up (which appeared
              damaged), the work area, the position of the casualty, isolation status, time markers.
        ...
        <SectionRule />
        <ContentEyebrow>
          Schedule 1 walked through — the specified injury list in detail
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fracture, other than to fingers, thumbs or toes</strong> — fall from ladder /
              step-up; struck by falling object; crush from equipment.
            </li>
            <li>
              <strong>Amputation of an arm, hand, finger, thumb, leg, foot or toe</strong> —
              entanglement in moving plant; severe crush.
            </li>
            <li>
              <strong>Permanent loss of sight or reduction of sight</strong> — arc-flash or chemical
              splash to eye.
            </li>
            <li>
              <strong>Crush injuries leading to internal organ damage</strong> — falling equipment,
              vehicle incident.
            </li>
            <li>
              <strong>
                Serious burns covering more than 10% of body, or causing significant damage to eyes,
                respiratory system or other vital organs
              </strong>{' '}
              — arc-flash event; chemical exposure.
            </li>
            <li>
              <strong>Scalping requiring hospital treatment</strong> — entanglement of hair in
              rotating plant.
            </li>
            <li>
              <strong>Loss of consciousness caused by head injury or asphyxiation</strong> — fall,
              confined-space gas exposure.
            </li>
            <li>
              <strong>Any other injury arising from working in an enclosed space</strong> — that
              leads to hypothermia, heat-induced illness or requires resuscitation or admittance to
              hospital for more than 24 hours.
            </li>
            <li>
              <strong>Electric shock loss of consciousness OR 24h+ hospitalisation</strong> —
              explicit Schedule 1 inclusion under the head-injury / asphyxiation limb when
        ...
        <SectionRule />
        <ContentEyebrow>
          Electric-shock incidents and the RIDDOR categorisation question
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Shock with LOC (any duration)</strong> — Schedule 1 specified injury under
              head-injury / asphyxiation limb. Immediate phone + F2508.
            </li>
            <li>
              <strong>Shock requiring hospital admission over 24 hours</strong> — Schedule 1
              specified injury under enclosed-space / 24h hospital limb where applicable. Immediate
              phone + F2508.
            </li>
            <li>
              <strong>Shock causing 7+ days off normal duties</strong> — over-7-day reportable under
              Reg 4(3). F2508A within 15 days.
            </li>
            <li>
              <strong>Shock with serious burns (over 10% body or vital organ involvement)</strong> —
              Schedule 1 under the burns limb regardless of LOC.
            </li>
            <li>
              <strong>Arc-flash with eye injury</strong> — potentially Schedule 1 under permanent
              sight loss / reduction.
            </li>
            <li>
              <strong>
                Near-miss shock without injury but from short-circuit causing fire / explosion
              </strong>{' '}
              — Schedule 2 dangerous occurrence reportable under Reg 7.
            </li>
            <li>
              <strong>Brief contact without LOC, A&amp;E cleared, no follow-up</strong>— likely
              below RIDDOR trigger; accident-book entry mandatory.
            </li>
            <li>
              <strong>Any uncertainty</strong> — escalate as specified and update later if facts
              change.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;The responsible person must, where a dangerous occurrence specified in Schedule
              2 takes place in connection with the work activity, follow the reporting
              procedure...&quot; Schedule 2 includes &quot;any electrical short-circuit or overload
              attended by fire or explosion which results in the stoppage of the plant involved for
              more than 24 hours...&quot; and &quot;any unintentional incident in which plant or
              equipment either — (a) comes into contact with an uninsulated overhead electric line
              in which the voltage exceeds 200 volts; or (b) causes an electrical discharge from
              such an electric line by coming into close proximity with it.&quot;
            </>
          }
          meaning={
            <>
              Reg 7 + Schedule 2 capture electrical-trade dangerous occurrences regardless of
              whether anyone was injured. Short-circuit causing fire or stopping plant for over 24
              hours; contact with overhead lines over 200V; close-proximity discharge from overhead
              lines. Each is reportable on F2508 within 10 days. The L3 supervisor finding any of
              these on site must flag to the responsible person — even where no injury occurred.
            </>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              An L2 mate working on a commercial DB upgrade brushes the back of their hand against
              an unexpected live conductor (230V) while reaching into the enclosure. They flinch
              back, drop their tool, and step off the step-up. They report &quot;a quick jolt&quot;
              and are slightly shaken but conscious throughout. There is a small reddened mark on
              the hand. You stop work, dynamic-assess that the supply needs immediate re-isolation
              and prove-dead testing, and confirm the customer&apos;s switch-fuse had been left
              partially closed in error by another trade. The mate goes to A&amp;E for ECG and
              observation as a precaution. They are discharged the same evening.
            </>
          }
          whatToDo={
            <>
              Phone the responsible person immediately with the facts. Categorisation discussion: no
              loss of consciousness was reported, no extended hospital admission, no burn over 10%
              body and no vital organ damage, no fracture. The shock itself does not meet Schedule 1
              trigger. However: was the mate off normal duties for 7+ days? If yes, over-7-day
              F2508A within 15 days. Was the partially-closed switch-fuse a short-circuit / overload
              event? No fire or extended plant stoppage, so probably not Schedule 2. Was there a
              clear unsafe-isolation cause? Yes — escalate to the firm&apos;s internal incident
              investigation regardless of RIDDOR status. The L3 supervisor preserves the scene
              (photographs of the DB, the partially-closed fuse, the prove-test equipment used),
              takes witness statements while events are fresh, and logs the incident in the accident
              book. The decision &quot;not Schedule 1, monitor for over-7-day&quot; is the
              responsible person&apos;s call based on the operative&apos;s factual input.
            </>
          }
          whyItMatters={
            <>
              Most electrical-trade shock incidents sit in this grey zone — not obviously Schedule
              1, but potentially over-7-day depending on recovery. The L3 supervisor&apos;s job is
              factual handover to the responsible person plus scene preservation plus internal
              incident investigation, regardless of which RIDDOR trigger eventually applies. Late
              reporting under Reg 6 is the trap when categorisation is ducked or delayed; the
              discipline is to escalate promptly with facts and let the responsible person decide.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Step 1 — Gather information</strong> — scene preservation, photographs,
              witness statements, documentary records, equipment examination.
            </li>
            <li>
              <strong>Step 2 — Analyse information</strong> — establish sequence of events, identify
              immediate causes (unsafe acts, conditions), underlying causes (job factors, individual
              factors), root causes (organisational factors, management system failures).
            </li>
            <li>
              <strong>Step 3 — Identify control measures</strong> — what would have prevented this
              incident, what mitigates similar future incidents.
            </li>
            <li>
              <strong>Step 4 — Plan implementation</strong> — assign actions, set deadlines,
              identify resource needs, communicate to workforce.
            </li>
            <li>
              <strong>Step 5 — Verify and review</strong> — confirm actions implemented, monitor
              effectiveness, feed into management review cycle.
            </li>
            <li>
              <strong>5 Whys</strong> — iterative why-questioning to drill from immediate to root
              cause.
            </li>
            <li>
              <strong>Fault tree analysis</strong> — for complex multi-causal incidents,
              particularly in higher-risk environments.
            </li>
            <li>
              <strong>Report retention</strong> — internal investigation reports kept alongside
              RIDDOR records; subject to legal privilege considerations where civil litigation
              possible.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Where in doubt about privilege scope, ask firm&apos;s solicitor before recording
              opinion.
            </li>
            <li>
              L3 supervisor contributes to operational track; senior / legal handle strategic track.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Triggered by material breach — serious enough to warrant written notification, notice
              or prosecution.
            </li>
            ...
            <li>
              Typical invoice four-figure for routine breach; five-figure for complex
              investigations.
            </li>
            ...
            <li>
              Cooperation reduces inspector hours; thorough records reduce investigation time.
            </li>
            <li>
              Invoices arrive within weeks of inspection; must be paid regardless of later
              prosecution outcome.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Actual harm and potential for harm</strong> — the &apos;risk gap&apos; between
              what happened / could happen and what the law allows.
            </li>
            <li>
              <strong>Dutyholder response history</strong> — past notices, prosecutions, compliance
              pattern.
            </li>
            <li>
              <strong>Confidence in management</strong> — RAMS quality, training, supervision,
              system controls.
            </li>
            <li>
              <strong>Attitude and cooperation</strong> — engagement with the inspector,
              transparency, corrective action plan.
            </li>
            <li>
              <strong>Public interest factors</strong> — gravity, vulnerability of those at risk,
              media interest, deterrent effect.
            </li>
            <li>
              <strong>Outcomes</strong> — advice (verbal / written), improvement notice, prohibition
              notice, prosecution, enforcement undertaking (less common).
            </li>
            <li>
              <strong>Published reference</strong> — Operational Circular OC130/8 sets out the
              structured framework.
            </li>
            <li>
              <strong>L3 supervisor implication</strong> — system controls and cooperative posture
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Improvement notice (s.21)</strong> — specific breach, period for remedy
              (typically 21+ days).
            </li>
            <li>
              <strong>Prohibition notice (s.22)</strong> — unsafe activity stops; immediate or by
              stated date.
            </li>
            <li>
              Notices specify the breach, the regulation breached, the required action and the time
              period.
            </li>
            <li>Appeal to employment tribunal within 21 days of notice issue.</li>
            <li>
              Notice operates pending appeal (for improvement notice; some flexibility for
              prohibition).
            </li>
            <li>
              Failure to comply with a notice — separate, serious offence — fine + custody possible.
            </li>
            <li>
              Notices listed on HSE public register — procurement consequence persists 5+ years.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Reg 6 late-reporting offence — strict liability, summary-only, fines under Sentencing
              Council guideline.
            </li>
            ...
            <li>
              HSE cross-checks RIDDOR returns against external data sources to identify
              under-reporting.
            </li>
            ...
            <li>
              Director personal liability under s.37 where late-reporting attributable to consent /
              connivance / neglect.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              HASAWA s.20 — inspector&apos;s statutory powers of entry, examination, document
              inspection.
            </li>
            <li>HASAWA s.21 — improvement notice power; s.22 — prohibition notice power.</li>
            <li>
              HASAWA s.33 — offences include obstruction, false information, failure to provide
              facilities.
            </li>
            <li>
              Standard cooperation: site walk, factual questions, documents, witness identification.
            </li>
            ...
            <li>
              Inspector respects reasonable requests for legal representation in formal interviews.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              (1) above; ... (k) to require any person whom he has reasonable cause to believe to be
              able to give any information relevant to any examination or investigation under
              paragraph (d) above to answer (in the absence of persons other than a person nominated
              by him to be present and any persons whom the inspector may allow to be present) such
              questions as the inspector thinks fit to ask and to sign a declaration of the truth of
              his answers...&quot;
            </>
          }
          meaning={
            <>
              The inspector&apos;s s.20 powers. Power of entry, examination, documentation
              inspection, sample-taking, photograph-taking, and interview under (k). Subsection (k)
              interviews are NOT under PACE caution but are sworn declarations of truth — false
              statements are themselves an offence. The L3 supervisor faced with an s.20(k)
              interview cooperates but may have firm&apos;s legal representative present.
            </>
          }
