...
const checks = [
  ...
  ], correctIndex: 2, explanation: 'Schedule 1 explicitly excludes fingers, thumbs and toes from the fracture category, so a finger fracture from a tool drop is not a specified injury. It may still be over-7-day reportable (F2508A) if it keeps the worker off normal duties for 8 or more days.' },
  ...
  ], correctIndex: 1, explanation: 'Two triggers: more than 10% body coverage OR significant damage to eyes, respiratory system or other vital organs. Many electrical burns hit one or the other. Smaller burns may still be over-7-day reportable if incapacitating.' },
  ...
  ], correctIndex: 1, explanation: 'The category covers injury arising from work in an enclosed space leading to hypothermia or heat-induced illness, OR requiring resuscitation, OR requiring admittance to hospital for more than 24 hours. Confined Spaces Regs 1997 hazards trigger it.' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 3, explanation: 'Schedule 1 includes amputation with no minimum size threshold. Even a partial finger-tip amputation triggers immediate phone notification plus F2508.' },
  ...
  ], correctAnswer: 0, explanation: 'Scalping is traumatic detachment of skin or soft tissue from the head, often from machinery contact such as rotating shafts catching hair. Rare in electrical work but possible.' },
  ...
  ], correctAnswer: 1, explanation: 'Schedule 1 covers loss of consciousness from head injury or from asphyxiation, including electrical events causing respiratory failure. Even brief loss requires immediate notification.' },
  ...
  ], correctAnswer: 2, explanation: 'Two distinct categories with different forms and timescales: Schedule 1 is the severe-injury list, over-7-day is an injury causing 8+ days off normal duties. An injury can be both, but is reported as specified, not over-7-day.' },
  ...
  ], correctAnswer: 3, explanation: 'Crushing trauma resulting in internal organ damage (liver, kidney, lung, abdominal organs) is a Schedule 1 specified injury. Significant force is required — commonly falling objects, vehicle impacts or structural collapse. The internal-organ aspect is the trigger.' },
  ...
  ], correctAnswer: 0, explanation: 'Match symptoms to the Schedule 1 list — visible fracture (excluding finger/thumb/toe), amputation, sight loss, crush with internal symptoms, burn over 10% or vital organ, scalping, LOC, enclosed-space asphyxia or heat. When in doubt, treat as specified; over-escalation is better than a missed report.' },
];
