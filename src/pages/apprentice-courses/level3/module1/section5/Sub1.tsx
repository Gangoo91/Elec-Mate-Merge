...
const checks = [
  { id: 'l3-m1-s5-sub1-stack', question: 'A scaffolder asks if it\'s OK to drop a hammer down to the floor below. You\'re an L3 apprentice nearby. Who has duties?', options: [
  ...
  ], correctIndex: 3, explanation: 'HASAWA stacks duties: scaffolder personal s.7; scaffolder employer s.2/s.3; principal contractor (CDM Reg 13 coordination); site manager / responsible person (RRFSO if relevant); you (s.7 if you tacitly approve). Knowing who else is on the duty list lets you escalate accurately and recognise your own exposure.' },
  { id: 'l3-m1-s5-sub1-cascade', question: 'Your immediate supervisor refuses to act on a safety concern you\'ve raised. What\'s the L3 escalation chain?', options: [
  ...
  ], correctIndex: 1, explanation: 'Escalate in writing — contracts manager, technical manager, Qualified Supervisor, director, then external (HSE) only if internal demonstrably fails (PIDA 1998). Each step builds the evidence trail. ERA 1996 s.44 protects you from detriment; the protections only work if used.' },
  { id: 'l3-m1-s5-sub1-director', question: 'Under HASAWA s.37, when can a director be personally prosecuted?', options: [
  ...
  ], correctIndex: 1, explanation: 'Three-prong test under s.37: consent, connivance, neglect. The Sentencing Council Definitive Guideline includes custody for high-culpability cases. Director liability is a real route the HSE uses against senior management — knowing this changes how senior conversations go.' },
];

const quizQuestions = [
  { id: 1, question: 'Define "dutyholder" in H&S statute.', options: [
  ...
  ], correctAnswer: 1, explanation: 'Dutyholder = statute-imposed, not contractual. Employer, self-employed, employee, occupier, manufacturer, designer, importer and controller of premises each have statute-imposed duties under HASAWA, EAWR, MHSWR, CDM, PUWER etc, and cannot contract out of them.' },
  { id: 2, question: 'How do duties stack on a single incident?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Duties stack: HASAWA s.2 (firm to employee) + s.3 (firm to non-employee) + s.7 (operative personal) + s.37 (director personal) + EAWR + MHSWR + specific daughter regs. A single incident typically means multiple charges.' },
  { id: 3, question: 'Who holds the dutyholder responsibility in a domestic CDM project?', options: [
  ...
  ], correctAnswer: 3, explanation: 'CDM 2015 has a domestic carve-out: most client duties cascade to the contractor (single-contractor) or principal contractor (multi-contractor). The homeowner remains client in name, but the contractor effectively becomes the operational client.' },
  { id: 4, question: 'What\'s "consent, connivance or neglect" under HASAWA s.37?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Three prongs of director liability: consent (knew and agreed), connivance (knew and turned a blind eye), neglect (should have known but didn\'t take reasonable steps). All three give personal liability for the corporate offence; the HSE has used all three.' },
  { id: 5, question: 'How does the dutyholder chain affect the L3 apprentice?', options: [
  ...
  ], correctAnswer: 1, explanation: 'L3 carries personal s.7 duty + EAWR Reg 16 competence + CDM Reg 15 worker + MHSWR Reg 14 employee duties, plus an emerging contributory role to the firm\'s Reg 9 contractor duties. Refusal + escalation + documentation discharges all of them.' },
  { id: 6, question: 'Why does the dutyholder mindset matter at L3?', options: [
  ...
  ], correctAnswer: 2, explanation: 'The L3 starts to be looked to as a quasi-supervisor. Knowing where you sit in the duty stack — and where else the duty sits — lets you make accurate decisions, escalate correctly, and avoid being drawn into a duty cascade you didn\'t recognise.' },
  { id: 7, question: 'What\'s the operative\'s defence to a HASAWA s.7 charge?', options: [
  ...
  ], correctAnswer: 3, explanation: 'The best defence is documentary: contemporaneous notes, written refusals, escalations — evidence the personal s.7 duty was discharged. "I was told to" is no defence; "here is the email declining the unsafe task" is. Verbal claims months later are weak.' },
  { id: 8, question: 'When does the dutyholder duty fall on the customer?', options: [
  ...
  ], correctAnswer: 0, explanation: 'A customer / occupier can be a dutyholder in specific capacities: HASAWA s.4 (controller of non-domestic premises), CAR 2012 Reg 4 (asbestos register), CDM 2015 Reg 4 (client). Domestic-customer client duties largely cascade to the contractor under CDM.' },
];
