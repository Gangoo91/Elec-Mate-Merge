...
const checks = [
  ...
  ], correctIndex: 3, explanation: 'Remember from Sub 1.1 — HASAWA stacks duties. The L3 add: knowing who else is on the duty list lets you escalate accurately AND recognise your own potential exposure.' },
  ...
  ], correctIndex: 1, explanation: 'Escalation chain in writing. Each step builds the evidence trail. ERA s.44 + PIDA 1998 are the protections; they only work if used.' },
  { id: 'l3-m1-s5-sub1-director', question: 'Under HASAWA s.37, when can a director be personally prosecuted?', options: [
    ...
    'Where a corporate offence is committed with their consent, connivance or attributable to their neglect. The Sentencing Council Definitive Guideline includes custody for high-culpability cases. Director liability is a real route the HSE uses against senior management.',
  ...
  ], correctIndex: 1, explanation: 'Three-prong test under s.37: consent, connivance, neglect. Custody possible at the top end. Knowing this changes how senior conversations go.' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'Dutyholder = statute-imposed; not contractual.' },
  ...
  ], correctAnswer: 2, explanation: 'Duties stack. Single incident → multiple charges typical.' },
  { id: 3, question: 'Who holds the dutyholder responsibility in a domestic CDM project?', options: [
    ...
    'CDM 2015 has a domestic carve-out — most client duties cascade to the contractor (single-contractor) or principal contractor (multi-contractor). Homeowner remains the client in name but contractor holds operational duty.',
  ], correctAnswer: 3, explanation: 'Domestic carve-out shifts client duties to contractor. Contractor effectively becomes the operational client.' },
  { id: 4, question: 'What\'s "consent, connivance or neglect" under HASAWA s.37?', options: [
    ...
    'Loose ratio framework: many minor near-misses : fewer minor injuries : even fewer serious injuries : rare fatalities. Common formulations 300:30:1. Conceptual point: tackle near-misses to reduce serious incidents.',
    'On every domestic install (Approved Doc P always relevant); on most residential refurbishment (Doc L for energy efficiency, Doc B for fire); on commercial work where fire-safety circuits are involved (Doc B). Wider awareness as residential market shifts to heat pumps and EV charging.',
  ...
  ], correctAnswer: 0, explanation: 'Three prongs cover knowing, looking-away, and culpable ignorance. The HSE has used all three.' },
  ...
  ], correctAnswer: 1, explanation: 'Multiple parallel personal duties. Refusal + escalation + documentation discharges all of them.' },
  { id: 6, question: 'Why does the dutyholder mindset matter at L3?', options: [
    ...
    'Harmful / irritant — acute toxicity (less severe than skull category), skin / eye irritation, skin sensitisation, respiratory tract irritation, narcotic effects. Lower-severity hazards than the more specific pictograms.',
  ...
  ], correctAnswer: 2, explanation: 'Dutyholder thinking is the L3 mental model. Influences how you communicate, escalate and act.' },
  ...
  ], correctAnswer: 3, explanation: 'Written contemporaneous evidence is the defence. Verbal claims months later are weak.' },
  ...
  ], correctAnswer: 0, explanation: 'Customer can be dutyholder in specific capacities. HASAWA s.4 for premises; CAR 2012 for asbestos; CDM Reg 4 for projects.' },
];
