...
const checks = [
  { id: 'l3-m1-s3-sub3-elec-gloves', question: 'You\'re briefed for live-test work on a 230V circuit. Which gloves do you select?', options: [
    ...
    'A type of asbestos survey carried out before refurbishment or demolition work. Locates and assesses ACMs in areas to be disturbed. More intrusive than a management survey. Required before significant disturbance work; commissioned by the dutyholder.',
  ...
  ], correctIndex: 1, explanation: 'Class 00 / Class 0 are the practical ratings for 230V work. Higher classes for higher voltages. Inspection before use is mandatory; a tiny pinhole is a fatality vector.' },
  { id: 'l3-m1-s3-sub3-arc', question: 'When is arc-flash PPE (EN 61482) appropriate?', options: [
    ...
    'When working on or near energised electrical equipment with potential for arc-flash — typically commercial / industrial switchgear, distribution boards above 32A, motor control centres. The PPE has an Arc Thermal Performance Value (ATPV cal/cm²) that must match the calculated incident energy at the working position.',
  ], correctIndex: 3, explanation: 'Arc-flash is a real risk in commercial DBs and switchgear. ATPV-rated FR clothing is the appropriate response, after engineering controls (de-energise, remote racking) have been considered.' },
  ...
  ], correctIndex: 0, explanation: 'EN markings are coded but mean specific things. Knowing the code lets you verify suitability for the task without trusting marketing claims.' },
];
...
const quizQuestions = [
  { id: 1, question: 'What\'s the standard for safety footwear?', options: [
    ...
    'EN ISO 20345. Grades S1, S1P, S2, S3, S4, S5 indicate features (toe protection, midsole protection, antistatic, water resistance, etc). For electrical work look for EH (Electrical Hazard) rating or Class 1 with insulating sole; for hazardous areas anti-static is required.',
  ...
  ], correctAnswer: 1, explanation: 'EN ISO 20345 + appropriate S-grade. Generic boots aren\'t safety footwear regardless of how they look.' },
  ...
  ], correctAnswer: 2, explanation: 'EN 397 industrial; EN 12492 some height work. Date markings matter; expired hats fail under impact.' },
  ...
  ], correctAnswer: 3, explanation: 'EN 60903 Class 00/0 covers most LV work. Higher classes for HV. Periodic dielectric testing is the maintenance regime.' },
  ...
  ], correctAnswer: 0, explanation: 'FFP3 = highest APF for negative-pressure disposable. For higher protection: powered respirators (TH3) or supplied-air. Fit-test mandatory.' },
  { id: 5, question: 'What\'s the standard for fall arrest harnesses?', options: [
    ...
    'EN 361 (full body harnesses for fall arrest). Combined with EN 354 (lanyards), EN 355 (energy absorbers) and an appropriate anchor (EN 795). Pre-use visual inspection mandatory; periodic detailed inspection by competent person every 6-12 months; service life typically 5-10 years from manufacture.',
  ...
  ], correctAnswer: 1, explanation: 'Multi-standard system — harness, lanyard, energy absorber, anchor each have their own EN. Inspection regime under PUWER + LOLER.' },
  ...
  ], correctAnswer: 2, explanation: 'PPE selection is hazard-driven and assessment-based. Off-the-shelf "general PPE pack" rarely matches all task hazards.' },
  ...
  ], correctAnswer: 3, explanation: 'Multi-trigger replacement. The cost of replacing PPE is trivial compared to the cost of a failure.' },
  ...
  ], correctAnswer: 0, explanation: 'Six-point check. The L3 supervisor doesn\'t inspect every item every time but spot-checks and intervenes when issues are seen.' },
];
