...
const checks = [
  { id: 'l3-m1-s3-sub3-elec-gloves', question: 'You\'re briefed for live-test work on a 230V circuit. Which gloves do you select?', options: [
  ...
  ], correctIndex: 1, explanation: 'Class 00 (500V AC) and Class 0 (1,000V AC) are the practical ratings for 230V work, with higher classes for higher voltages. Inspect for pinholes, damage and contamination before use, log the inspection, and never use general-purpose work gloves for live work — a tiny pinhole is a fatality vector.' },
  { id: 'l3-m1-s3-sub3-arc', question: 'When is arc-flash PPE (EN 61482) appropriate?', options: [
  ...
  ], correctIndex: 3, explanation: 'Arc-flash is a real risk in commercial DBs, distribution boards above 32A, motor control centres and switchgear. The PPE has an Arc Thermal Performance Value (ATPV in cal/cm²) that must match the calculated incident energy at the working position, and is selected after engineering controls (de-energise, remote racking) have been considered.' },
  { id: 'l3-m1-s3-sub3-marking', question: 'A pair of safety glasses is marked "EN 166 1 F". What does this mean?', options: [
  ...
  ], correctIndex: 0, explanation: 'Optical class 1 is the highest, suitable for permanent wear; "F" is low-energy impact (45 m/s). For higher-impact work look for "B" (medium, 120 m/s) or "A" (high, 190 m/s). Other letters include T (temperature extremes), K (surface scratch) and N (anti-fog). Knowing the code lets you verify suitability without trusting marketing claims.' },
];

const quizQuestions = [
  { id: 1, question: 'What\'s the standard for safety footwear?', options: [
  ...
  ], correctAnswer: 3, explanation: 'Classes 00 / 0 / 1 / 2 / 3 / 4 cover 500V / 1,000V / 7,500V / 17,000V / 26,500V / 36,000V respectively. Class 00/0 covers most LV work, higher classes for HV. Visual inspection before each use plus periodic dielectric testing (typically 6-monthly) is the maintenance regime.' },
  { id: 4, question: 'What\'s the standard for FFP3 masks?', options: [
  ...
  ], correctAnswer: 0, explanation: 'FFP1 has assigned protection factor 4, FFP2 has 10, FFP3 has 20 — the highest APF for a negative-pressure disposable. FFP3 is the standard for respirable crystalline silica, licensed asbestos-disturbance work and wood dust. A face-fit test is mandatory; for higher protection use powered respirators (TH3) or supplied-air.' },
  { id: 5, question: 'What\'s the standard for fall arrest harnesses?', options: [
  ...
  ], correctAnswer: 1, explanation: 'EN 361 (full body harness) combines with EN 354 (lanyards), EN 355 (energy absorbers) and EN 795 (anchors). Pre-use visual inspection is mandatory, periodic detailed inspection by a competent person every 6-12 months, with service life typically 5-10 years from manufacture under the PUWER + LOLER regime.' },
  { id: 6, question: 'How is suitable PPE matched to a task?', options: [
