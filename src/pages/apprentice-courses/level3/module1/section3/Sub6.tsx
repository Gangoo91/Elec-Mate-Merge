...
const TITLE =
  'Safe isolation supervision and EAWR Reg 13 (3.8 / 3.9) | Level 3 Module 1.3.6 | Elec-Mate';
const DESCRIPTION =
  'L3 supervision of safe isolation — auditing the L2 procedure, EAWR Reg 13 implications, and what happens (legally and practically) when isolation goes wrong.';
...
export default function Sub6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 3 · Subsection 6"
      ...
      <HubBody>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 462.1.1</strong> — every circuit shall be capable of being isolated from
              every live supply conductor.
            </li>
            <li>
              <strong>Reg 462.1.2</strong> — provision shall be made to prevent any electrical
              equipment from becoming inadvertently energised during isolation.
            </li>
            <li>
              <strong>Reg 462.1.3</strong> — adequate means shall be provided for securing an
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module1-section4')}
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">
              Section 4 — Hazards in the work environment
            </div>
          </button>
        </div>
      </HubBody>
