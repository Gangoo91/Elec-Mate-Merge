...
const checks = [
  ...
  ], correctIndex: 0, explanation: 'The implications are legal (EAWR Reg 13 and Reg 14, HASAWA s.2 / s.3 / s.7), commercial (insurance, contracts), reputational (HSE Public Register) and personal (s.7 prosecution). Not isolating is one of the most-prosecuted electrical safety failures and is well-documented in HSE case law.' },
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'Reg 13 is the legal hook for safe isolation. Compliance in practice means lock-off, tag-out, prove-test-prove and control of the isolation point — the six-step procedure.' },
  ...
  ], correctAnswer: 3, explanation: 'GS38 is the HSE guidance for selection and use of test instruments and probes. A GS38 indicator is purpose-built for proving dead, not a multimeter: physically robust, with a non-current-limiting fuse, finger barriers, suitable probes and low loop impedance. A multimeter on the wrong setting can give a false dead reading; GS38 indicators are designed to fail safe.' },
  ...
  ], correctAnswer: 1, explanation: 'The implication cascade is severe across legal, commercial and personal dimensions: EAWR Reg 13/14 breach; HASAWA s.2/3/7 breach; potential RIDDOR; voided insurance; personal and firm prosecution; reputational damage on the HSE Public Register; possible JIB / scheme-body deregistration; and director liability under s.37. Bypassing is one of the lowest-effort, highest-consequence safety failures.' },
  ...
  ], correctAnswer: 0, explanation: 'HSG85 is the non-statutory practitioner reference. It gives detailed guidance on EAWR compliance including isolation procedures, live working defences, competence and supervision. Knowing it exists and what it covers is L3-essential.' },
];
