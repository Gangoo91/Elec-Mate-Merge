...
const checks = [
  { id: 'l3-m1-s3-sub6-procedure', question: 'L2 mate is about to start safe isolation. What\'s the L3-grade observation list?', options: [
  ...
  ], correctIndex: 1, explanation: 'Remember from L2 — prove-test-prove + lock-off + tag-out. The L3 supervisor verifies the procedure is followed every time, not just on Mondays.' },
  { id: 'l3-m1-s3-sub6-implications', question: 'What are the legal implications of NOT carrying out safe isolation?', options: [
    'EAWR Reg 13 breach (failure to take adequate precautions). EAWR Reg 14 breach (de facto live working without the three-test). HASAWA s.2 / s.3 / s.7 breaches. RIDDOR if injury. Insurance void. Personal HASAWA s.7 prosecution. Firm prosecution. The cascade is severe and well-documented in HSE prosecution case law.',
  ...
  ], correctIndex: 0, explanation: 'The implications are legal (multiple Acts), commercial (insurance, contracts), reputational (public register) and personal (s.7). Not isolating is one of the most-prosecuted electrical safety failures.' },
  { id: 'l3-m1-s3-sub6-audit', question: 'You\'re auditing the firm\'s isolation practice across teams. What\'s the L3 supervisor\'s primary metric?', options: [
  ...
  ], correctIndex: 3, explanation: 'Audit is the verification that the documented procedure is the actual practice. Observation is the gold standard; records and training are supporting evidence.' },
];

const quizQuestions = [
  { id: 1, question: 'What\'s the EAWR Reg 13 duty?', options: [
    ...
    'Adequate precautions to prevent equipment which has been made dead from becoming electrically charged during the work, if danger may thereby arise. In practice: lock-off, tag-out, prove-test-prove, control of the isolation point.',
  ...
  ], correctAnswer: 1, explanation: 'Reg 13 is the legal hook for safe isolation. Compliance = the six-step procedure.' },
  { id: 2, question: 'What\'s the prove-test-prove procedure?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Prove-test-prove guards against indicator failure giving a false dead reading. Skipping the second prove is a common shortcut and a common cause of incidents.' },
  { id: 3, question: 'What\'s a "GS38" voltage indicator?', options: [
  ...
  ], correctAnswer: 3, explanation: 'GS38 is the HSE guidance for selection and use of test instruments and probes. Voltage indicators meeting GS38 are the appropriate tool for proving dead.' },
  { id: 4, question: 'What\'s the lock-off and tag-out procedure?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Lock-off + tag-out is per-operative. Each operative\'s lock means that operative controls when the supply can be restored. Multi-lock hasps allow multiple operatives on one isolation point.' },
  { id: 5, question: 'What\'s the implication of bypassing safe isolation?', options: [
  ...
  ], correctAnswer: 1, explanation: 'The implication cascade is severe across legal, commercial and personal dimensions. Bypassing is one of the lowest-effort, highest-consequence safety failures.' },
  { id: 6, question: 'What\'s the L3 supervisor\'s role in safe isolation?', options: [
  ...
  ], correctAnswer: 2, explanation: 'L3 supervisor = procedure custodian. The personal responsibility for ensuring isolation actually happens, not just that it\'s on paper.' },
  { id: 7, question: 'What\'s a "permit-to-work" in the isolation context?', options: [
  ...
  ], correctAnswer: 3, explanation: 'Permits formalise the isolation procedure for higher-hazard scenarios. The L3 operative may be the named person on a permit.' },
  { id: 8, question: 'What does HSG85 cover?', options: [
  ...
  ], correctAnswer: 0, explanation: 'HSG85 is the practitioner reference. Knowing it exists and what it covers is L3-essential.' },
];
