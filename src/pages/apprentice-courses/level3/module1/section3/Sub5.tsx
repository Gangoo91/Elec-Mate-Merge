...
const checks = [
  ...
  ], correctIndex: 1, explanation: 'The sequence is observation + intervention + documentation + follow-up: stop and coach on the spot, record the observation, notify the firm\'s training/supervision lead so the L2\'s competence record is updated, then observe future jobs to confirm the correction held. Repeated non-compliance escalates to formal training intervention. Coaching is one of the most valuable and lowest-effort prevention activities.' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'HASAWA s.2(2)(a) requires "the provision and maintenance of plant and systems of work that are, so far as is reasonably practicable, safe and without risks to health", and the daughter regs (PUWER, COSHH, Work at Height, etc) apply it to each activity. Safe practices are required across the regulatory regime.' },
  ...
  ], correctAnswer: 2, explanation: 'It results from systematic examination of the task and is documented in the Method Statement portion of RAMS. Permits-to-work are a specific form of SSoW for high-hazard activity. The SSoW is required under HASAWA s.2(2)(a) and embedded in MHSWR Reg 5 arrangements.' },
  ...
  ], correctAnswer: 0, explanation: 'Required under MHSWR Reg 13 (information), topics often respond to recent near-misses, regulation changes, equipment updates or seasonal risks. They turn the abstract safety policy into concrete, recent, relevant communication, and the attendance log is the evidence the topic was delivered.' },
  ...
  ], correctAnswer: 1, explanation: 'The supervisor intervenes immediately, coaches to the correct method, documents and follows up. This is not a "checking up" exercise but part of the firm\'s monitoring under MHSWR Reg 5 — the M (Monitor) in the POCMR cycle, and how the firm\'s system actually functions in practice.' },
  ...
  ], correctAnswer: 3, explanation: 'It is typically supported by no-blame reporting, structured analysis (e.g. 5-whys), feedback to the team and visible changes in practice. Heinrich\'s pyramid frames near-misses as the leading indicator of major incidents, and firms with strong near-miss reporting have lower major-incident rates over time.' },
  ...
  ], correctAnswer: 0, explanation: 'The signature is evidence the handover was done, and increasingly the L3 contributes to writing RAMS for routine jobs. Sign-off is a verification act, not a formality — the supervisor takes ownership for the day\'s work plan being safe.' },
];
