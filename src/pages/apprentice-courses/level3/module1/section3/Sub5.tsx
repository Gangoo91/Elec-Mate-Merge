...
const checks = [
  { id: 'l3-m1-s3-sub5-toolbox', question: 'What\'s a toolbox talk and why does it matter?', options: [
  ...
  ], correctIndex: 2, explanation: 'Toolbox talks are the operational delivery mechanism for ongoing safety communication. Topics: hazard of the week, near-miss lesson, regulation refresh, equipment update.' },
  { id: 'l3-m1-s3-sub5-intervention', question: 'You see a colleague about to do something unsafe. What\'s the L3-grade response?', options: [
  ...
  ], correctIndex: 2, explanation: 'Intervention culture is what stops near-misses becoming incidents. Polite, immediate, document. The peer-to-peer challenge is harder than the boss-to-worker challenge but is increasingly normalised in good firms.' },
  { id: 'l3-m1-s3-sub5-observe', question: 'You observe an L2 mate consistently skipping the prove-test-prove step on safe isolation. What do you do?', options: [
  ...
  ], correctIndex: 1, explanation: 'Observation + intervention + documentation + follow-up. The L3 supervisor\'s coaching role is one of the most valuable safety-system contributions and one of the lowest-effort prevention activities.' },
];

const quizQuestions = [
  { id: 1, question: 'What\'s the legal source of the "safe practices" duty?', options: [
  ...
  ], correctAnswer: 1, explanation: 'HASAWA s.2(2)(a) plus the daughter regs. Safe practices are required across the regulatory regime.' },
  { id: 2, question: 'What\'s a Safe System of Work (SSoW)?', options: [
  ...
  ], correctAnswer: 2, explanation: 'SSoW = the safe procedure. Permit-to-work is one form. RAMS is the documented expression. Required under HASAWA s.2(2)(a) and embedded in MHSWR Reg 5 arrangements.' },
  { id: 3, question: 'What\'s a permit-to-work?', options: [
  ...
  ], correctAnswer: 3, explanation: 'Permits formalise the SSoW for high-hazard activity. The L3 operative may be the named person on a permit; the issuing authority signs off the conditions.' },
  { id: 4, question: 'What\'s the role of toolbox talks in the safety system?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Toolbox talks turn the abstract safety policy into concrete, recent, relevant communication. The attendance log is the evidence that the topic was delivered.' },
  { id: 5, question: 'What\'s the L3 supervisor\'s observation duty?', options: [
  ...
  ], correctAnswer: 1, explanation: 'Observation is part of POCMR (the M = Monitor). The L3 supervisor\'s eyes on site are how the firm\'s system actually functions in practice.' },
  { id: 6, question: 'How is intervention different from "telling on" a colleague?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Intervention is operational; "telling on" is escalation. Both have a place; the L3 supervisor uses intervention first.' },
  { id: 7, question: 'What\'s "near-miss culture"?', options: [
  ...
  ], correctAnswer: 3, explanation: 'Near-miss culture is the high-impact preventive practice. Firms with strong near-miss reporting have lower major-incident rates over time.' },
  { id: 8, question: 'What\'s the L3 supervisor\'s sign-off role on RAMS / SSoW?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Sign-off is a verification act, not a formality. The L3 supervisor takes ownership for the day\'s work plan being safe.' },
];
