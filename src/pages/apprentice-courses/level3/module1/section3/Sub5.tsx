...
const TITLE =
  'Safe practices and procedures — supervision (3.7) | Level 3 Module 1.3.5 | Elec-Mate';
const DESCRIPTION =
  'L3 supervision of safe practices — toolbox talks, RAMS sign-off, observation, intervention, near-miss culture and the supervisor running the safety system.';
...
export default function Sub5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 3 · Subsection 5"
      ...
      <HubBody>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module1-section3-6')}
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">
              3.6 Safe isolation supervision
            </div>
          </button>
        </div>
      </HubBody>
