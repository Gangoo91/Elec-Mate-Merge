...
const checks = [
  { id: 'l3-m1-s3-sub2-purpose', question: 'What\'s the legal status of PPE in the hierarchy of control?', options: [
  ...
  ], correctIndex: 0, explanation: 'PPE Regs 1992 (as amended 2022 to cover limb workers) require the employer to provide PPE only where risks cannot be controlled by other means. Hierarchy: eliminate → substitute → engineer → administer → PPE. The L3 add is arguing for the higher controls when PPE-only is being defaulted to.' },
  { id: 'l3-m1-s3-sub2-elim', question: 'You\'re asked to drill chases for cable in plaster on a Grade II listed wall. What\'s the L3 hierarchy starting point?', options: [
  ...
  ], correctIndex: 3, explanation: 'Run the hierarchy: eliminate (surface-route in discrete trunking), substitute (different cable type/route), engineer (low-dust hand tools with on-tool extraction), administer (restricted area, time-box), PPE last. Surface mount on a listed wall is often the right answer, and listed-building consent considerations apply. The hierarchy reframes "drill the chase" as "what\'s the lowest-impact installation method?".' },
  { id: 'l3-m1-s3-sub2-engineer', question: 'A junior asks "why can\'t I just wear the mask, why do I need extraction too?". What\'s the L3 supervisor answer?', options: [
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'PPE = Personal Protective Equipment — clothing, helmets, glasses, gloves, footwear, RPE and similar items. Defined in PPE Regs 1992 (as amended 2022).' },
  { id: 2, question: 'Why is PPE the last resort in the hierarchy?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Both the wearer\'s compliance and the equipment\'s performance can fail. Higher controls (eliminate, substitute, engineer) reduce the hazard itself, which doesn\'t depend on individual compliance.' },
  { id: 3, question: 'What does PPE Regs 1992 (as amended 2022) require?', options: [
  ...
  ], correctAnswer: 3, explanation: 'PPE must be provided where risks cannot be adequately controlled by other means, and be suitable, properly maintained, properly used, with information, instruction and training. The 2022 amendment extended the duty beyond employees to limb (b) workers (gig economy, casual contractors under non-employment arrangements).' },
  { id: 4, question: 'Apply the hierarchy to "noise from a 110V cordless impact wrench in a stairwell":', options: [
  ...
  ], correctAnswer: 0, explanation: 'Noise works the hierarchy the same way as dust or live work: eliminate (quieter method), substitute (manual torque wrench), engineer (quieter tool, sound-absorbing barriers), administer (limit duration, exclude others), then ear defenders LAST. The Control of Noise at Work Regs 2005 require assessment at the 80 dB lower action level.' },
  { id: 5, question: 'What CE / UKCA marking do you check on safety footwear?', options: [
  ...
  ], correctAnswer: 1, explanation: 'EN ISO 20345 with the appropriate S-grade (S1, S1P, S3 etc) indicates features like toe and midsole protection, antistatic and water resistance. For electrical work look for the EH (Electrical Hazard) rating or class S2/S3 with an insulating sole. Generic boots aren\'t safety footwear.' },
  { id: 6, question: 'Why does FFP3 fit-testing matter for RPE?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Beard, face shape and mask model all affect the seal, so an untested fit gives a false sense of protection. Face-fit testing (qualitative or quantitative, per HSE INDG479) confirms the fit and is required at first issue and on changes such as weight, dental work or beard growth.' },
  { id: 7, question: 'Who pays for PPE — employer or employee?', options: [
  ...
  ], correctAnswer: 3, explanation: 'PPE Regs 1992 Reg 4 require the employer to provide suitable PPE, and HASAWA s.9 prohibits any charge to employees in respect of statutory provisions. Charging apprentices for required "kit" is unlawful; only personal preferences (fancier kit) can be at the employee\'s expense by agreement.' },
  { id: 8, question: 'L3 supervisor judgement on PPE — what\'s the key add over L2?', options: [
  ...
  ], correctAnswer: 0, explanation: 'At L2 you wear it; at L3 you push back on "just give them masks", ask what engineering controls have been considered, and invert to PPE only where genuinely no higher control is reasonably practicable — recording the reasoning either way.' },
];
