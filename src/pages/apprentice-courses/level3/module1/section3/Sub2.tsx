...
const DESCRIPTION =
  'L3 PPE hierarchy depth — eliminate / substitute / engineer / administer / PPE. The supervisor judgement on the higher controls before reaching for the mask.';
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 3 · Subsection 2"
      ...
      <HubBody>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module1-section3-1')}
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">
              3.1 Risk assessment as a supervisor
            </div>
          </button>
          <button
