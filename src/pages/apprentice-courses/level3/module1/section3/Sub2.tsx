...
const checks = [
  ...
  ], correctIndex: 2, explanation: 'Remember from L2 — PPE is the last line. L3 add: the supervisor argues for the higher controls when PPE-only is being defaulted to.' },
  { id: 'l3-m1-s3-sub2-elim', question: 'You\'re asked to drill chases for cable in plaster on a Grade II listed wall. What\'s the L3 hierarchy starting point?', options: [
    ...
    'On the date of the incident, NOT the date of report or diagnosis. So if a casualty is hospitalised on Monday and the firm reports on the following Thursday, that\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\'s 3 days into the 10-day window. Late reports are a separate offence under Reg 6.',
    '(1) Eliminate — can the cable be surface-routed in a discrete trunking? (2) Substitute — different cable type / route? (3) Engineer — hand-tools (lower dust) with on-tool extraction? (4) Administrative — restricted area, time-box. (5) PPE last. Listed-building consent considerations also apply.',
  ], correctIndex: 3, explanation: 'Surface mount in trunking on a listed wall is often the right answer. The hierarchy reframes "drill the chase" as "what\'s the lowest-impact installation method?".' },
  ...
  ], correctIndex: 1, explanation: 'Two layers of control = two layers of protection. Engineering reduces the hazard; PPE protects against the residual.' },
];

const quizQuestions = [
  { id: 1, question: 'What does "PPE" stand for in the H&S context?', options: [
    'Personal Protective Equipment — clothing, helmets, glasses, gloves, footwear, RPE etc designed to protect the wearer from one or more H&S risks.',
    'Personal Protective Equipment.',
    'Petty Personal Excuses.',
    'Public Personal Engagement.',
  ], correctAnswer: 1, explanation: 'PPE = Personal Protective Equipment. Defined in PPE Regs 1992 (as amended 2022).' },
  { id: 2, question: 'Why is PPE the last resort in the hierarchy?', options: [
    ...
    'It relies on the wearer using it correctly every time AND on the equipment performing as rated. Both can fail. Higher controls (eliminate, substitute, engineer) reduce the hazard itself, which doesn\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\'t depend on individual compliance.',
  ...
  ], correctAnswer: 2, explanation: 'PPE depends on user compliance + equipment performance. Higher controls reduce the underlying hazard.' },
  ...
  ], correctAnswer: 3, explanation: 'The amended PPE Regs cover not just employees but also limb (b) workers (gig economy, casual contractors). Significant expansion in 2022.' },
  ...
  ], correctAnswer: 0, explanation: 'Noise hazards work the hierarchy the same way as dust or live work. PPE last, engineering and administrative controls first.' },
  ...
  ], correctAnswer: 1, explanation: 'EN ISO 20345 + appropriate S-grade for the hazard. Generic boots aren\'t safety footwear.' },
  ...
  ], correctAnswer: 2, explanation: 'Beard, face shape, mask model — all affect fit. Untested fit = false sense of protection. Fit-testing is now standard for routine RPE use.' },
  { id: 7, question: 'Who pays for PPE — employer or employee?', options: [
    ...
    'Employer. PPE Regs 1992 Reg 4 — employer ensures suitable PPE is PROVIDED. PUWER and PPE Regs both prohibit charges to employees for required PPE under HASAWA s.9 (no charges to employees in respect of statutory provisions). Personal preferences (fancier kit) can be at employee\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\'s expense by agreement.',
  ], correctAnswer: 3, explanation: 'Employer pays. HASAWA s.9 specifically prohibits charges. Apprentices sometimes are charged for "kit" — that\'s unlawful for required PPE.' },
  ...
  ], correctAnswer: 0, explanation: 'L2 = wear it. L3 = think about whether it\'s the right control or whether higher controls have been ducked.' },
];
