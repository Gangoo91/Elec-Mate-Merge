...
const checks = [
  ...
  ], correctIndex: 3, explanation: 'Restock is non-negotiable. A first-aid kit that\'s been part-used and not restocked can fail at the next incident. The 1981 Regs require provision of first-aid; an empty box doesn\'t discharge the duty.' },
  { id: 'l3-m1-s3-sub4-faw', question: 'What\'s the difference between EFAW and FAW?', options: [
    'Emergency First Aid at Work (EFAW) — 1-day course, 3-year validity, covers immediate life-saving (CPR, AED, choking, bleeding, unconscious casualty, shock). First Aid at Work (FAW) — 3-day course, 3-year validity, EFAW content plus injuries, illness, more advanced response. Annual refresher recommended for both.',
  ...
  ], correctIndex: 0, explanation: 'EFAW + FAW are the standard certifications. Choice depends on the first-aid needs assessment outcome — typically FAW required for higher-hazard sites (construction, manufacturing).' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'The 1981 Regs are the legal source. ACOP L74 is the practitioner reference.' },
  ...
  ], correctAnswer: 2, explanation: 'The needs assessment is the structured way to decide provision. Output drives kit content, training, facilities.' },
  ...
  ], correctAnswer: 3, explanation: 'BS 8599-1 is the standard for workplace first-aid kits. Three sizes (small / medium / large) per assessment outcome.' },
  ...
  ], correctAnswer: 0, explanation: 'Monthly inspection + post-use restock is the typical regime. Some items have expiry dates (burn gel, eye-wash); check at inspection.' },
  ...
  ], correctAnswer: 1, explanation: 'Misuse = depletion + contamination + potential harm. The kit is for first aid, not for general convenience.' },
  { id: 6, question: 'What\'s an AED and where should it be?', options: [
    ...
    'Automated External Defibrillator. Increasingly available on construction sites, in commercial premises, in public locations. Delivers electric shock to restart a fibrillating heart. AED units talk the user through the process; minimal training required. Not legally mandated in most workplaces but increasingly part of needs assessment outcomes.',
  ...
  ], correctAnswer: 2, explanation: 'AED + CPR is the survival pathway after cardiac arrest. Increasingly common in workplaces and public spaces. Identifying the nearest AED is part of the L3 dynamic site assessment.' },
  ...
  ], correctAnswer: 3, explanation: 'L3 supervisor = first-aid provision custodian on site. Doesn\'t replace the firm\'s designated first aider but ensures the system is operational.' },
  ...
  ], correctAnswer: 0, explanation: 'Needs-driven, not fixed. ACOP L74 indicative ratios are starting point.' },
];
