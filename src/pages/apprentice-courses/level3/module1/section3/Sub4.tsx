...
const checks = [
  { id: 'l3-m1-s3-sub4-needs', question: 'Who decides what first-aid provision a workplace needs?', options: [
  ...
  ], correctIndex: 1, explanation: 'Restock is non-negotiable: notify the firm\'s person responsible for kit maintenance and update the contents log. A part-used, un-restocked kit can fail at the next incident, which could happen this afternoon. The 1981 Regs require provision of first-aid; an empty box doesn\'t discharge the duty.' },
  { id: 'l3-m1-s3-sub4-faw', question: 'What\'s the difference between EFAW and FAW?', options: [
  ...
  ], correctIndex: 0, explanation: 'Emergency First Aid at Work covers immediate life-saving (CPR, AED, choking, bleeding, unconscious casualty, shock); First Aid at Work adds injuries, illness and more advanced response. Both carry 3-year validity with annual refresher recommended. Choice depends on the needs-assessment outcome — typically FAW for higher-hazard sites such as construction and manufacturing.' },
];

const quizQuestions = [
  { id: 1, question: 'What does the Health and Safety (First Aid) Regulations 1981 require?', options: [
  ...
  ], correctAnswer: 1, explanation: 'Reg 3 is the main duty — adequate and appropriate provision for employees injured or taken ill at work, determined by a needs assessment. The 1981 Regs are the legal source and ACOP L74 is the practitioner reference giving the detail.' },
  { id: 2, question: 'What\'s a "first-aid needs assessment"?', options: [
  ...
  ], correctAnswer: 2, explanation: 'It considers the nature of work, hazards, employee numbers, accident history, location, vulnerable persons and distance to medical care, and is documented and reviewed periodically and after changes. The output drives kit content, training and facilities.' },
  { id: 3, question: 'What does a typical workplace first-aid kit contain (BS 8599-1 small)?', options: [
  ...
  ], correctAnswer: 0, explanation: 'At each inspection, check contents against the kit list, replace expired or used items, verify integrity and keep an inspection record. Some items have expiry dates (burn gel, eye-wash) and must be checked. Monthly inspection plus post-use restock is the typical regime.' },
  { id: 5, question: 'Why is misuse of first-aid supplies a problem?', options: [
  ...
  ], correctAnswer: 1, explanation: 'Misuse leaves the kit unavailable when needed, breaches infection control when single-use items are reused, and can cause harm (e.g. burn gel applied incorrectly). Restocking and proper use are both required by the 1981 Regs duty to provide adequate first aid; the kit is for first aid, not general convenience.' },
  { id: 6, question: 'What\'s an AED and where should it be?', options: [
  ...
  ], correctAnswer: 3, explanation: 'The supervisor checks provision is adequate for the work, inspects kits before and during work, restocks after use, ensures trained persons are available, briefs the team on the location of the kit, AED, trained persons and nearest A&E, and maintains inspection records. They are the on-site custodian, not a replacement for the firm\'s designated first aider.' },
  { id: 8, question: 'What\'s the legal minimum first-aid provision?', options: [
  ...
  ], correctAnswer: 0, explanation: 'HSE ACOP L74 gives indicative numbers — for low-hazard work 1 appointed person for under 25 employees, 1 EFAW for 25-50, 1 FAW for over 50, with more demanding ratios for high-hazard work. Construction and electrical work generally fall in the higher-hazard band. The provision is needs-driven, not fixed.' },
];
