...
const checks = [
  { id: 'l3-m1-s6-sub5-define', question: 'When is a space a "confined space" under the Regs?', options: [
    ...
    'Substantially enclosed AND foreseeable specified risk - fire/explosion, asphyxiation (oxygen deficiency or harmful atmosphere), drowning, hyperthermia, entrapment with serious injury. Both conditions required.',
  ], correctIndex: 3, explanation: 'Two conditions: enclosed AND specified risk. Not all small spaces; not all enclosed spaces.' },
  { id: 'l3-m1-s6-sub5-rescue', question: 'Who provides rescue from a confined space?', options: [
    ...
    'Pre-arranged rescue plan - typically standby person + equipment + comms + trained rescuers. NOT 999 (response too slow). The rescue plan is the entrant\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\'s pre-condition for entry; without it, no entry.',
  ...
  ], correctIndex: 1, explanation: 'Rescue planning is critical. 999 response is too slow for confined-space emergencies (asphyxiation timescales are seconds-to-minutes).' },
  { id: 'l3-m1-s6-sub5-permit', question: 'When does a permit-to-work apply for confined spaces?', options: [
    ...
    'For most confined-space entry with significant risk - permits formalise the SSoW, define the work, the controls, the personnel authorised, the time period, the rescue plan, the sign-off conditions. Mandatory in many sectors; best practice elsewhere.',
  ], correctIndex: 3, explanation: 'Permits formalise confined-space SSoW. Used routinely in higher-risk industries; appropriate for many electrical confined-space jobs.' },
];
...
const quizQuestions = [
  { id: 1, question: 'What does Confined Spaces Regs 1997 Reg 4 require?', options: [
    ...
    'No person shall enter a confined space to carry out work for any purpose unless it is not reasonably practicable to achieve that purpose without such entry. Avoidance is the principle; entry is the exception.',
  ...
  ], correctAnswer: 1, explanation: 'Avoidance principle is absolute under Reg 4(1). Entry only when not reasonably practicable to avoid.' },
  ...
  ], correctAnswer: 2, explanation: 'Comprehensive SSoW. Reg 4(2) + Reg 5 in operation.' },
  ...
  ], correctAnswer: 3, explanation: 'Multi-gas monitoring is standard. Pre-entry plus continuous during entry.' },
  ...
  ], correctAnswer: 0, explanation: 'Rescue must be immediate. Pre-arranged rescue is essential.' },
  ...
  ], correctAnswer: 1, explanation: 'Standby = comms + monitoring + rescue initiation. NEVER enters the space themselves (would just become a second casualty).' },
  ...
  ], correctAnswer: 2, explanation: 'Confined spaces in electrical work are not common but real. Industrial / commercial more than domestic.' },
  ...
  ], correctAnswer: 3, explanation: 'Multi-level training. Awareness for occasional low-risk; specialist for routine / high-risk work.' },
  ...
  ], correctAnswer: 0, explanation: 'Default to treating as confined; the consequences of mis-classification are severe.' },
];
