...
const checks = [
  { id: 'l3-m1-s6-sub5-define', question: 'When is a space a "confined space" under the Regs?', options: [
  ...
  ], correctIndex: 3, explanation: 'Two conditions: substantially enclosed AND a foreseeable specified risk (fire/explosion, asphyxiation from oxygen deficiency or harmful atmosphere, drowning, hyperthermia, entrapment with serious injury). Not all small spaces; not all enclosed spaces.' },
  { id: 'l3-m1-s6-sub5-rescue', question: 'Who provides rescue from a confined space?', options: [
  ...
  ], correctIndex: 1, explanation: 'The rescue plan is the entrant\'s pre-condition for entry; without it, no entry. 999 response is too slow for confined-space emergencies (asphyxiation timescales are seconds-to-minutes).' },
  { id: 'l3-m1-s6-sub5-permit', question: 'When does a permit-to-work apply for confined spaces?', options: [
  ...
  ], correctIndex: 0, explanation: 'The permit formalises the SSoW - defining the work, controls, authorised personnel, time period, rescue plan and sign-off conditions. Mandatory in many sectors and best practice elsewhere; appropriate for many electrical confined-space jobs.' },
];

const quizQuestions = [
  { id: 1, question: 'What does Confined Spaces Regs 1997 Reg 4 require?', options: [
  ...
  ], correctAnswer: 1, explanation: 'Avoidance is the principle and entry the exception. The avoidance principle is absolute under Reg 4(1) - entry only when it is not reasonably practicable to achieve the purpose without it.' },
  { id: 2, question: 'What\'s the safe system of work for confined-space entry?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Comprehensive SSoW (Reg 4(2) + Reg 5): risk assessment, permit, atmosphere monitoring (oxygen, flammable, toxic) before AND during entry, standby person outside in communication, rescue plan, appropriate PPE, training and emergency procedures.' },
  { id: 3, question: 'What gases are commonly tested for in confined-space atmosphere monitoring?', options: [
  ...
  ], correctAnswer: 3, explanation: 'Multi-gas monitoring is standard - oxygen (deficiency below 19.5%, enrichment above 23.5%), flammable gases at the LEL, and toxic gases such as H2S and CO. Pre-entry plus continuous during entry.' },
  { id: 4, question: 'Why is 999 inappropriate for confined-space rescue?', options: [
  ...
  ], correctAnswer: 0, explanation: 'A pre-positioned rescue plan with standby person and equipment is essential; Fire and Rescue may attend but cannot be the primary rescue route. Rescue must be immediate.' },
  { id: 5, question: 'What\'s the standby person\'s role?', options: [
  ...
  ], correctAnswer: 1, explanation: 'The standby person maintains communication, monitors the entrant\'s condition and initiates rescue if the entrant becomes unresponsive or the atmosphere deteriorates. They NEVER enter the space themselves - they would just become a second casualty.' },
  { id: 6, question: 'What are common confined spaces in electrical work?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Confined spaces in electrical work are not common but real - underfloor voids, poorly-ventilated plant rooms, lift shafts, ductwork, some basements/cellars, industrial switchrooms, tank work for instrumentation and cable-jointing manholes. Industrial / commercial more than domestic.' },
  { id: 7, question: 'What training is required for confined-space work?', options: [
  ...
  ], correctAnswer: 3, explanation: 'Multi-level training: Awareness for occasional low-risk entry up to specialist high-risk training (typically City & Guilds 6160 or equivalent), covering trained operatives, trained rescuers and a trained issuing authority for permits. Refresher training is periodic.' },
  { id: 8, question: 'What\'s the L3 supervisor\'s judgement on a borderline confined space?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Default to treating as confined - the cost of treating-as-confined is small (extra controls), but the cost of not doing so when warranted is potentially fatal. The consequences of mis-classification are severe.' },
];
