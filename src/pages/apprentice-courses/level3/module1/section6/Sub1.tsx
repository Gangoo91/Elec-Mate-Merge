...
const checks = [
  ...
  ], correctIndex: 0, explanation: 'Memorise 18m / 7 storeys plus 2 residential units, per the Higher-Risk Buildings (Descriptions and Supplementary Provisions) Regulations 2023. Hospitals and care homes are also covered for the design and construction phase.' },
  ...
  ], correctIndex: 1, explanation: 'The PAP is the in-occupation dutyholder, one per building — they register the building, prepare the safety case, engage residents and hold the golden thread.' },
  ...
  ], correctIndex: 2, explanation: 'Gateway 1 covers fire safety and access at planning; Gateway 2 is a BSR design review with no construction without approval; Gateway 3 is BSR sign-off against design and golden thread with no occupation without approval. Fail any and work stops.' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'Grenfell and the Hackitt Review are the policy origins. The Act addresses fragmented regulation, weak competence and unclear accountability.' },
  ...
  ], correctAnswer: 2, explanation: 'The BSR sits within the HSE. Its three statutory functions are to oversee building safety, facilitate competence improvement, and lead the HRRB regulatory regime including gateway approvals.' },
  ...
  ], correctAnswer: 3, explanation: 'The golden thread is the information system for HRRBs, covering design, construction and ongoing management. Records persist for the life of the building.' },
  ...
  ], correctAnswer: 0, explanation: 'PAP (one per HRRB), AP (multiple possible) and RP (under RRFSO 2005). The Building Safety Manager role is an optional appointment.' },
  ...
  ], correctAnswer: 1, explanation: 'The safety case is the PAP\'s comprehensive evidence that the building is being safely managed — fire and structural risks, mitigation strategies, residents engagement and golden-thread links.' },
  ...
  ], correctAnswer: 2, explanation: 'The 30-year retrospective limit for residential defect claims is the headline, with 15 years prospective for new work — a significant impact on contractor liability and document retention.' },
  ...
  ], correctAnswer: 3, explanation: 'BSA 2022\'s indirect effects reach all residential work: 30-year DPA liability, competence framework changes, Building Regs amendments (especially Approved Doc B fire safety) and a regulatory direction emphasising traceability and certified competence.' },
  ...
  ], correctAnswer: 0, explanation: 'The L3 contribution operationalises BSA 2022 awareness on site — recognising HRRB status, understanding the PAP role, verifying the CPP integrates with the golden thread, producing digital cert records and cooperating with PAP/AP information requests.' },
];
