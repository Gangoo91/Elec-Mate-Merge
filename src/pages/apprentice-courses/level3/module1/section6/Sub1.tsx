...
const DESCRIPTION =
  'L3 deeper on BSA 2022 - HRRB definition, in-occupation duty holders (PAP / AP / RP), Building Safety Regulator gateways, and the operational impact on electrical contractors.';

const checks = [
  {
    id: 'l3-m1-s6-sub1-hrrb',
    question: 'HRRB definition?',
    options: [
      '18m+ in height OR 7+ storeys, AND containing 2+ residential units.',
      'Any building over 11m in height containing sleeping accommodation, regardless of unit count.',
      '30m+ in height AND 10+ storeys, AND containing 4+ residential units.',
      'Any building where a fire risk assessment identifies combustible cladding on the external wall.',
    ],
    correctIndex: 0,
    explanation:
      'Memorise 18m / 7 storeys plus 2 residential units, per the Higher-Risk Buildings (Descriptions and Supplementary Provisions) Regulations 2023. Hospitals and care homes are also covered for the design and construction phase.',
  },
  {
    id: 'l3-m1-s6-sub1-pap',
    question: "Who's the Principal Accountable Person?",
    options: [
      'The Building Safety Regulator officer assigned to oversee the building once it is in occupation.',
      'The single person per HRRB responsible for the structure and exterior.',
      'The Principal Contractor appointed under CDM 2015 who managed the construction phase.',
      'A leaseholder elected by the residents association to represent them on building safety matters.',
    ],
    correctIndex: 1,
    explanation:
      'The PAP is the in-occupation dutyholder, one per building — they register the building, prepare the safety case, engage residents and hold the golden thread.',
  },
  {
    id: 'l3-m1-s6-sub1-gateways',
    question: 'Three BSA 2022 gateways?',
    options: [
      'Gateway 1 at design, Gateway 2 at handover, Gateway 3 at the first annual safety case review.',
      'Gateway 1 for fire alarms, Gateway 2 for emergency lighting, Gateway 3 for the cladding inspection.',
      'Gateway 1 at planning, Gateway 2 pre-construction, Gateway 3 pre-occupation.',
      'Gateway 1 at tender, Gateway 2 at the completion certificate, Gateway 3 at the first flat sale.',
    ],
    correctIndex: 2,
    explanation:
      'Gateway 1 covers fire safety and access at planning; Gateway 2 is a BSR design review with no construction without approval; Gateway 3 is BSR sign-off against design and golden thread with no occupation without approval. Fail any and work stops.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question: 'Why was BSA 2022 enacted?',
    options: [
      'To consolidate all UK building regulations into a single statutory code replacing the Approved Documents.',
      'In response to Grenfell (2017) and the Hackitt Review (2018).',
      'To implement EU fire safety directives following harmonised European construction product standards.',
      'To raise the minimum height threshold for sprinkler systems in commercial premises from 18m to 30m.',
    ],
    correctAnswer: 1,
    explanation:
      'Grenfell and the Hackitt Review are the policy origins. The Act addresses fragmented regulation, weak competence and unclear accountability.',
  },
  {
    id: 2,
    question: "What's the Building Safety Regulator?",
    options: [
      'A division of the Department for Levelling Up that approves planning for residential developments over 18m.',
      'An independent agency separate from the HSE that took over building control from local authorities.',
      'A function within the HSE with three statutory functions, including the HRRB gateway approvals.',
      'A trade body that certifies electrical contractors as competent to work on higher-risk buildings.',
    ],
    correctAnswer: 2,
    explanation:
      'The BSR sits within the HSE. Its three statutory functions are to oversee building safety, facilitate competence improvement, and lead the HRRB regulatory regime including gateway approvals.',
  },
  {
    id: 3,
    question: "What's the golden thread?",
    options: [
      'A continuous earth conductor running through every fire-rated compartment for equipotential bonding.',
      'A single named contractor coordinating all trades on an HRRB construction site from start to finish.',
      'The fire-rated cable specification mandated for all life-safety circuits in higher-risk buildings.',
      'A digital, accurate, accessible, secure information set for an HRRB, held by the Accountable Person.',
    ],
    correctAnswer: 3,
    explanation:
      'The golden thread is the information system for HRRBs, covering design, construction and ongoing management. Records persist for the life of the building.',
  },
  {
    id: 4,
    question: 'How many in-occupation dutyholder types are defined?',
    options: [
      'Three: Principal Accountable Person, Accountable Persons and Responsible Person.',
      'Two: the Principal Designer and the Principal Contractor, appointed by the client under CDM 2015.',
      'One: a single Building Safety Manager mandatorily appointed by the freeholder for every building.',
      'Four: the client, the designer, the contractor and the worker, each carrying CDM 2015 duties.',
    ],
    correctAnswer: 0,
    explanation:
      'PAP (one per HRRB), AP (multiple possible) and RP (under RRFSO 2005). The Building Safety Manager role is an optional appointment.',
  },
  {
    id: 5,
    question: "What's the safety case?",
    options: [
      'The legal defence a contractor relies on if their work is alleged to have caused a safety incident.',
      'The document setting out how building safety risks are identified, mitigated and managed for the HRRB.',
      'The fire risk assessment carried out by the Responsible Person under the RRFSO 2005.',
      'The set of as-built drawings and test certificates handed to building control at completion.',
    ],
    correctAnswer: 1,
    explanation:
      "The safety case is the PAP's comprehensive evidence that the building is being safely managed — fire and structural risks, mitigation strategies, residents engagement and golden-thread links.",
  },
  {
    id: 6,
    question: "What's the Defective Premises Act change?",
    options: [
      'It removed the right to bring civil claims for defects once a completion certificate is issued.',
      'It introduced a no-fault compensation scheme funded by the Building Safety Levy for residents.',
      'BSA 2022 s.135 extended limitation to 30 years retrospective and 15 years prospective.',
      'It transferred liability for residential defects from the contractor to the PAP on occupation.',
    ],
    correctAnswer: 2,
    explanation:
      'The 30-year retrospective limit for residential defect claims is the headline, with 15 years prospective for new work — a significant impact on contractor liability and document retention.',
  },
  {
    id: 7,
    question: 'How does BSA 2022 affect electrical contractors not working on HRRBs?',
    options: [
      'It has no effect at all — the Act applies only to buildings meeting the HRRB threshold.',
      'It requires every domestic installer to register their work directly with the Building Safety Regulator.',
      'It bans all product substitutions on any residential site without written approval from building control.',
      'Indirectly — via DPA liability, competence reform and Building Regs amendments.',
    ],
    correctAnswer: 3,
    explanation:
      "BSA 2022's indirect effects reach all residential work: 30-year DPA liability, competence framework changes, Building Regs amendments (especially Approved Doc B fire safety) and a regulatory direction emphasising traceability and certified competence.",
  },
  {
    id: 8,
    question: "What's the L3 contribution to BSA 2022 awareness?",
    options: [
      'Recognise HRRB sites, understand the gateway regime, produce digital records and cooperate with the PAP.',
      "Personally prepare and submit the building's safety case to the BSR on behalf of the PAP.",
      'Sign off the Gateway 3 completion certificate before residents are permitted to occupy the building.',
      "Maintain the building's golden thread information system and respond directly to BSR notices.",
    ],
    correctAnswer: 0,
    explanation:
      'The L3 contribution operationalises BSA 2022 awareness on site — recognising HRRB status, understanding the PAP role, verifying the CPP integrates with the golden thread, producing digital cert records and cooperating with PAP/AP information requests.',
  },
];

const faqs = [
  {
    question: 'Who exactly registers the building under BSA 2022?',
    answer:
      'Principal Accountable Person registers with the Building Safety Regulator. Registration includes the safety case and key building information.',
  },
  {
    question: 'When did the HRRB regime take effect?',
    answer:
      'BSA 2022 received Royal Assent April 2022. HRRB regime in occupation rolled out from 2023 onwards; gateway regime for new construction phasing in.',
  },
  {
    question: 'Are commercial buildings covered by BSA 2022?',
    answer:
      'Care homes and hospitals covered for design / construction phase. In-occupation regime focused on residential HRRBs. Wider commercial buildings affected indirectly via competence framework.',
  },
  {
    question: 'Can existing HRRBs be retro-improved to BSA standard?',
    answer:
      'Existing buildings being assessed against the new safety case framework. Where structural or fire-safety deficiencies are identified, remediation may be required — hence the cladding remediation programmes nationally.',
  },
  {
    question: 'How does golden thread record keeping affect electrical certs?',
    answer:
      'EIC, EICR, alteration certs, design records all become part of golden thread for HRRBs. Digital record format expected; paper-only insufficient.',
  },
  {
    question: 'What if I am an L3 working on an HRRB — do I need special training?',
    answer:
      'No specific BSA training required for routine L3 work. Awareness of HRRB context, PAP role, and golden-thread integration is part of L3 / supervisor competence.',
  },
  {
    question: 'Does the 18m / 7 storey threshold include below-ground storeys?',
    answer:
      'The Higher-Risk Buildings (Descriptions and Supplementary Provisions) Regulations 2023 measure height from ground level to the top of the floor surface of the topmost residential storey. Below-ground storeys do not generally count towards the height calculation; the threshold is about how far residents are from ground level for evacuation considerations.',
  },
  {
    question: 'How does BSA 2022 affect the way the Building Safety Regulator works with HSE?',
    answer:
      'The BSR sits within HSE structurally and shares HSE&apos;s enforcement powers framework. The BSR has its own dedicated leadership but draws on HSE resources for investigation and inspection. Coordination on dual-relevance cases is built into the regulatory architecture.',
  },
  {
  ...
  {
    question: 'How long is the PAP&apos;s record-keeping requirement under BSA 2022?',
    answer:
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 6 · Subsection 1"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'Remember from Section 1.7 - BSA 2022 framework intro. This Sub goes operational - HRRB definition, dutyholder roles, BSR gateways, golden thread implications for electrical work.'
          }
        </p>
        ...
        <ConceptBlock
          title="The HRRB definition and dutyholder cascade"
          plainEnglish="HRRB = 18m+ in height OR 7+ storeys, AND 2+ residential units (Higher-Risk Buildings Regs 2023). Care homes and hospitals also covered for design / construction phase but in-occupation regime applies primarily to residential definition."
          onSite="L3 awareness: when working on a building near the threshold, ask the responsible person about HRRB status. Misidentification can mean missed Reg 4 client awareness check + missed integration with PAP arrangements."
        >
          <p>In-occupation dutyholders:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Principal Accountable Person (PAP)</strong> - single per HRRB; responsible for
              structure and exterior; registers building; prepares safety case; engages residents;
              holds golden thread.
            </li>
            <li>
              <strong>Accountable Persons (AP)</strong> - multiple possible; each responsible for
              repair of a part of common parts including structure.
            </li>
            <li>
              <strong>Responsible Person (RP)</strong> - under Regulatory Reform (Fire Safety) Order
              2005; may be same as or different from PAP.
            </li>
            <li>
              <strong>Building Safety Manager (BSM)</strong> - optional; appointed by PAP for
              day-to-day management where PAP doesn't have direct competence. (Mandatory requirement
              was withdrawn but role remains appropriate in many cases.)
            </li>
          </ul>
        </ConceptBlock>

        <RegsCallout
          source="Higher-Risk Buildings (Descriptions and Supplementary Provisions) Regulations 2023"
          clause={
            <>
              "A building is a higher-risk building for the purposes of Part 4 of the Building
              Safety Act 2022 if it - (a) is at least 18 metres in height or has at least 7 storeys,
              and (b) contains at least 2 residential units."
            </>
          }
          meaning={
            <>
              The HRRB definition. 18m / 7 storeys are the height/storey thresholds; 2+ residential
              units is the residential threshold. Both must apply for HRRB status under the
              in-occupation regime.
            </>
          }
          cite="Source: Higher-Risk Buildings (Descriptions and Supplementary Provisions) Regulations 2023 (SI 2023/275)."
        />
        ...
        <ConceptBlock
          title="BSR oversight via three gateways"
          plainEnglish="BSR sits within HSE. Three statutory functions: building safety oversight, competence facilitation, HRRB regulatory regime. The HRRB regime uses three gateways for new construction."
          onSite="For an electrical contractor on an HRRB project, the gateway regime means design records and product traceability become non-negotiable. Late changes can trigger gateway re-review with significant programme impact."
        >
          <p>The three gateways:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Gateway 1 (planning)</strong> - fire safety and access considered before
              planning approval.
            </li>
            <li>
              <strong>Gateway 2 (pre-construction)</strong> - BSR reviews design and construction
              control plan; NO construction without approval.
            </li>
            <li>
              <strong>Gateway 3 (pre-occupation)</strong> - BSR signs off as-built against approved
              design and golden thread; NO occupation without approval.
            </li>
          </ul>
        ...
        <RegsCallout
          source="Building Safety Act 2022 - s.2(1)"
          clause={
            <>
              "The regulator&apos;s general functions are - (a) the building function, which is to
              secure the safety of people in or about buildings in relation to risks arising from
              buildings, and to improve the standard of buildings; (b) the competence function,
              which is to facilitate the improvement of the competence of industry; (c) such other
              functions as may be conferred on the regulator by or under any enactment."
            </>
          }
          meaning={
            <>
              BSR is established with three functions. Building safety + competence + others.
              Overseen by the HSE board; has statutory powers including notices and prosecution.
            </>
          }
        ...
        <ConceptBlock
          title="Why BSA 2022 reaches beyond HRRBs"
          plainEnglish="Even electricians who never work on an HRRB are affected indirectly: 30-year DPA liability, competence framework, Building Regs amendments, regulatory direction-of-travel emphasising traceability."
          onSite="L3 awareness: keep digital records indefinitely; design records form part of audit trail; competence certifications matter more for framework eligibility; Approved Document B (fire safety) tightening affects emergency lighting and fire alarm work."
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Approved Document B (fire safety) tightening affects fire-rated cable, smoke
              detection, emergency lighting.
            </li>
            <li>
              Defective Premises Act 30-year retrospective limit reaches old residential work.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock
          title="30-year retrospective for residential"
          plainEnglish="The Building Safety Act 2022 s.135 extended the Defective Premises Act 1972 limitation period to 30 years retrospective for past residential defect claims, and 15 years prospective for new work. Existing claims previously time-barred can now be brought; new work carries 15-year liability tail. The change applies to dwellings broadly, not only HRRBs."
          onSite="L3 supervisor culture: digital record retention indefinite; design records retained; certification packs complete and traceable for any residential work. Paper certs lost in 5 years are no defence in 25 years. The amendment is the most operationally significant non-HRRB consequence of BSA 2022."
        >
          <p>Limitation effects in operation:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              30-year retrospective limit applies to claims under DPA 1972 s.1 (fitness for
              habitation duty).
            </li>
        ...
        <RegsCallout
          source="Building Safety Act 2022 — s.135 (Limitation period for actions under Defective Premises Act 1972)"
          clause={
            <>
              &quot;In the Limitation Act 1980 (as amended by this section), in section 4B... the
              limitation period is 30 years where the relevant period began before the day on which
              section 135(1) of the Building Safety Act 2022 came into force; and 15 years in any
              other case.&quot;
            </>
          }
          meaning={
            <>
              The limitation extension. 30 years retrospective is the headline; 15 years prospective
              is the new normal. The L3 supervisor on residential work treats every job as creating
              long-tail liability — keep records accordingly.
            </>
          }
          cite="Source: Building Safety Act 2022 (2022 c.30), s.135."
        />

        <ConceptBlock
          title="Mandatory occurrence reporting for HRRBs"
          plainEnglish="BSA 2022 introduces mandatory occurrence reporting for HRRBs in occupation — defined safety occurrences (structural concerns, fire spread events, missing or defective fire-stopping) must be reported by the PAP to the BSR within prescribed timescales. Sits alongside RIDDOR for HRRBs but has wider trigger scope."
          onSite="L3 supervisor on HRRB work who finds something safety-relevant during routine works (e.g. fire-stopping breach in a riser, structural deflection in a corridor) flags it to the PAP same day. The PAP's mandatory occurrence duty depends on the contractor surfacing the finding promptly."
        >
        ...
        <ConceptBlock
          title="Competence framework changes — BSA-driven"
          plainEnglish="BSA 2022 set in motion a wider competence framework reform — the BSI Built Environment Competence Framework (BS 8670 series). New requirements for individuals working on HRRBs to demonstrate competence appropriate to role; for organisations to demonstrate competence management systems; for designers and contractors to evidence competence at appointment. Reaches beyond HRRBs over time as professional bodies and schemes adopt."
          onSite="L3 supervisor implication: JIB grading, NICEIC / NAPIT registration, manufacturer-specific certifications, ECS card all gain weight as competence evidence. Maintaining current registration and CPD becomes a procurement-relevant practice, not just a regulatory tick. Documented training records part of personal employability for HRRB-relevant work."
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Manufacturer-specific certifications for system installs (heat pumps, EV chargers,
              fire alarms).
            </li>
        ...
        <ConceptBlock
          title="Resident voice — the BSA 2022 cultural change"
          plainEnglish="A central thread of BSA 2022 is amplifying resident voice in building safety. Residents have new rights to information, to raise concerns, to participate in safety decisions. PAP has a statutory duty to engage residents and respond to concerns. Failure to respond can be reported to BSR."
          onSite="L3 supervisor on HRRB work: residents may approach with questions about the work, fire safety, the building. Respond respectfully and direct to the PAP for matters outside scope. Do not dismiss; the resident voice is the BSA 2022 system working as designed."
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Duty not to compromise building safety (e.g. removing fire doors, blocking exits).
            </li>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Identify HRRB status on arrival. Engage with PAP / AP / BSR-registered contractor for
              the project. Produce digital records integrated with golden thread.
            </>
          }
        />

        <CommonMistake
          title="Substituting products on an HRRB site without approval"
          whatHappens={
            <>
          ...
          doInstead={
            <>
              No site substitutions on HRRB. Equivalents need design team written approval. Slower
              but compliant.
            </>
          }
        />
        ...
        <Scenario
          title="Identifying an HRRB at the start of a job"
          situation={
            <>
              Your firm has been engaged for a small alteration in a residential block. Walking the
              site, you count 7 storeys above ground (residential floors 1-7); building
              approximately 22m to top occupied storey. Customer is a managing agent; says they
              manage \"a few buildings\".
            </>
          }
          whatToDo={
            <>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design and specification</strong> — drawings, schedules, calculations, product
              specifications, change records.
            </li>
            <li>
              <strong>Construction records</strong> — installation photos, test certificates,
              materials sourcing, batch numbers, operative records.
            </li>
            <li>
              <strong>Commissioning data</strong> — system tests, performance verification,
              hand-over documentation.
            </li>
            <li>
              <strong>Occupation records</strong> — periodic inspection, maintenance, alterations,
              defect reports, resident concerns.
            </li>
            <li>
              <strong>Safety case</strong> — the assessment of building safety risks and the
              controls in place; updated through the building&apos;s life.
            </li>
            <li>
              <strong>Resident engagement</strong> — communication, queries, concerns logged.
            </li>
            <li>
              <strong>Digital format</strong> — accessible, structured, machine- readable; not
              buried in PDF scans of paper records.
            </li>
            <li>
              <strong>Retention</strong> — for the life of the building; ownership transfers between
              successive PAPs.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Single national authority for HRRB building control — consistency across the country.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Agree standard response wording — what we are doing, who the PAP is, how to raise
              concerns.
            </li>
            <li>Respect and politeness — residents are not interruptions.</li>
            <li>Capture concerns raised — date, resident, concern, contact.</li>
            <li>
              Pass concerns to PAP same day — let the PAP&apos;s engagement strategy handle them.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Substitution records — where a different product from specification was installed,
              with approval.
            </li>
        ...
        <Scenario
          ...
          situation={
            <>
              You are running new data cabling in a 19-storey residential building. The building
              meets the HRRB threshold and the PAP is the managing agent. While running cable in a
              service riser between the 8th and 9th floors, you discover that an existing
              fire-stopping seal around an older cable bundle is missing — there is a clear gap
              where smoke and flame could pass between compartments. The gap is approximately the
              size of a fist, in a wall that should be 60-minute fire-rated per the building&apos;s
              safety case. You are several days into the project; your L2 mate is below you on the
              lower floor.
            </>
          }
          whatToDo={
            <>
              Stop the cable installation. Photograph the breach from multiple angles, noting time
              and floor location. This is not a defect created by your work — it is a pre-existing
              breach you have discovered — but it is safety-case-significant and likely a mandatory
              occurrence reporting trigger for the PAP. Phone the PAP immediately with the facts:
              location, dimensions, what was found, evidence available. The PAP will decide whether
              MOR is triggered (likely yes given compartmentation breach in an HRRB); they will also
              coordinate any interim fire-safety measure (resident notification, fire watch
              arrangements, temporary fire-stopping installation by a competent specialist). Brief
              your L2 mate; resume your own work elsewhere on the building where it does not
              interact with the breach area, pending PAP guidance. Document the finding and the PAP
              communication in the firm&apos;s system. Do not attempt to fire-stop the breach
              yourself unless the firm is competent to do so under the PAP&apos;s direction —
              fire-stopping in HRRBs is typically a specialist activity with specific product
              approval and certification requirements. The finding becomes part of the
              building&apos;s safety case update, the golden thread, and potentially a mandatory
              occurrence report to the BSR.
            </>
          }
          whyItMatters={
            <>
              This scenario reflects exactly the Hackitt-identified failure mode that BSA 2022 is
              designed to surface and address. Pre-existing compartmentation breaches that go
              un-noticed are the kind of cumulative defect that contributes to fire spread events in
              residential buildings. The L3 supervisor who flags the finding promptly is performing
              the role the framework expects of contractors on HRRB sites — &apos;eyes and
              ears&apos; for the PAP&apos;s safety case, with prompt communication of
              safety-relevant findings. The same finding on a non-HRRB might prompt informal mention
              to the building manager and a recommendation; on an HRRB it triggers a structured MOR
              / safety-case-update process with regulatory oversight.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Client</strong> — appoint competent PD and PC; ensure arrangements; provide
              pre-construction information; satisfy competence at appointment with HRRB-specific
              rigour.
            </li>
            <li>
              <strong>Principal Designer</strong> — plan, manage, monitor pre- construction phase;
              coordinate designers; produce pre-construction information; coordinate gateway 2
              submission.
            </li>
            <li>
              <strong>Principal Contractor</strong> — plan, manage, monitor construction phase;
              produce construction phase plan; manage interfaces; mandatory occurrence reporting;
              golden-thread contribution; gateway 3 handover.
            </li>
            <li>
              <strong>Designer</strong> — eliminate / reduce / control risks through design; provide
              information; competence evidence at appointment.
            </li>
            <li>
              <strong>Contractor</strong> — plan, manage, monitor work; coordinate with PC;
              competence evidence; building-safety findings flagged through MOR route.
            </li>
            <li>
              <strong>Worker</strong> — work safely, follow instructions, raise concerns; cooperate
              with site arrangements.
            </li>
            <li>
              <strong>Gateway 2 modification application</strong> — for any significant change after
              Gateway 2 approval.
            </li>
            <li>
              <strong>Gateway 3 handover</strong> — building safety information transferred to PAP
              at completion.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              allocation of sufficient time and other resources. Arrangements are suitable if they
              ensure that — (a) the construction work can be carried out, so far as is reasonably
              practicable, without risks to the health or safety of any person...&quot;
            </>
          }
          meaning={
            <>
              Reg 4 is the foundational client duty. On HRRBs it is enhanced by BSA 2022 — the
              client must satisfy themselves of competence at appointment with the additional rigour
              the HRRB regime requires. The Principal Designer and Principal Contractor appointed by
              the client carry the operational duties, but the client&apos;s appointment decision is
              what makes the whole framework work. A poorly-appointed PD / PC on an HRRB is the kind
              of failure mode Hackitt identified as systemic.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Mandatory occurrence report processing — investigation of safety-relevant events.
            </li>
            <li>Gateway 1 / 2 / 3 reviews — formal regulatory checkpoints for construction.</li>
            <li>
              Enforcement — improvement notices, compliance notices, restriction notices,
              prosecution.
            </li>
            ...
            <li>
              Thematic reviews — sector-wide findings (cladding, fire stopping, alarm systems).
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Manufacturer certifications — for system-specific competence (heat pumps, EV chargers,
              fire alarms).
            </li>
            ...
            <li>
              Direction of travel — competence evidence becoming procurement-relevant for non-HRRB
              work over time.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              CPR reaction-to-fire classification mandated for cable selection in fire-relevant
              applications.
            </li>
            ...
            <li>
              L3 supervisor checks current edition rather than relying on remembered framework.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Recommendation: single regulator (became BSR), gateways, dutyholder regime, golden
              thread, resident voice, mandatory occurrence reporting, competence framework.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Part 1</strong> — overview and key concepts.
            </li>
            <li>
              <strong>Part 2</strong> — Building Safety Regulator establishment and functions.
            </li>
            <li>
              <strong>Part 3</strong> — building safety in design and construction (gateways,
              dutyholders).
            </li>
            <li>
              <strong>Part 4</strong> — building safety in occupation (PAP, safety case, golden
              thread).
            </li>
            <li>
              <strong>Part 5</strong> — miscellaneous and supplementary (DPA amendments, competence
              basis).
            </li>
            <li>
              <strong>HRB Regs 2023 (Descriptions)</strong> — defines HRRB.
            </li>
            <li>
              <strong>HRB Regs 2023 (Key Building Information)</strong> — registration requirements.
            </li>
            <li>
              <strong>Building Safety Levy Regulations</strong> — funding for remediation.
            </li>
            <li>
              <strong>BSR guidance documents</strong> — operational expectations.
            </li>
            <li>
              <strong>PAP-published arrangements</strong> — building-specific implementations.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;An Act to make provision about the safety of people in or about buildings and
              the standard of buildings, to amend the Architects Act 1997, and to amend provision
              about complaints made to a housing ombudsman; and for connected purposes.&quot;
            </>
          }
          meaning={
            <>
              BSA 2022 is a wide-ranging Act covering the safety of people in buildings, the
              standard of buildings, professional regulation (Architects Act amendments) and
              complaints (housing ombudsman). The breadth reflects Hackitt&apos;s observation that
              the failures exposed by Grenfell were systemic, not narrowly technical. Reading the
              Act in isolation does not capture the regulatory culture shift; the policy intent is
              to drive culture change as well as legal change.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Is the building an HRRB? Confirm against the 18m / 7 storey + 2 residential threshold.
            </li>
            ...
            <li>
              What are the change-management arrangements? Approval process for substitutions?
            </li>
            ...
            <li>
              What is the mandatory occurrence reporting arrangement? Who do we flag findings to?
            </li>
            ...
            <li>
              What records are required for the golden thread? Format, content, submission route?
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;Where the higher-risk building has more than one accountable person, the
              principal accountable person is — (a) the accountable person for the structure and
              exterior of the building, or (b) if there is more than one such accountable person,
              the one determined in accordance with regulations made by the Secretary of
              State.&quot;
            </>
          }
          meaning={
            <>
              s.78 nominates the PAP. The PAP is the accountable person for the structure and
              exterior — typically the freeholder, managing agent or RP-type entity controlling the
              building&apos;s external envelope and structural elements. In multi-leasehold
              buildings this is determined by the regulations. The single-point-of-accountability
              approach is one of Hackitt&apos;s central recommendations and resolves the pre-BSA
              confusion about who was responsible for building-level safety when individual flat
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Developer Remediation Contract — obliges 50+ developers to fix buildings they
              constructed.
            </li>
            <li>
              Remediation work types: cladding replacement, fire-stopping retrofit, fire alarm
              upgrade, sprinkler retrofit, emergency lighting upgrade, structural strengthening.
            </li>
            <li>Electrical-trade impact: significant programme of work over 5-10 years.</li>
            <li>
              Occupied buildings — resident engagement, interim fire-safety measures, multi-trade
              coordination.
            </li>
            <li>
              Tight golden-thread requirements — every remediation feeds back into the safety case.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module1-section6-2')}
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">
              6.2 HRRB dutyholders + safety case
            </div>
          </button>
        </div>
      </HubBody>
