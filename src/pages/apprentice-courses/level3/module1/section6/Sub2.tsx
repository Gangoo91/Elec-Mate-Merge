...
const checks = [
  ...
  ], correctIndex: 0, explanation: 'PAP duties are extensive and ongoing — register with the BSR, prepare and revise the safety case, engage residents, manage building safety risks, maintain the golden thread, report to the BSR and respond to its notices. Single role per HRRB.' },
  ...
  ], correctIndex: 2, explanation: 'The safety case is the comprehensive evidence document — identification of building safety risks (fire and structural primarily), management strategies, residents engagement strategy, golden-thread links and periodic review. A living document, updated as the building changes.' },
  ...
  ], correctIndex: 1, explanation: 'Electrical records are foundational to the safety case — EIC at install, EICR cycles, alteration certs, commissioning of fire detection and alarm, EV charging infrastructure and emergency lighting, plus design records and product specifications all become golden-thread evidence.' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'Continuous, updated as the building evolves — on alterations, replacements and occupancy changes, after incidents or near-misses, and periodically (the PAP determines this, typically annually). The BSR can also request a review.' },
  ...
  ], correctAnswer: 2, explanation: 'Resident engagement is a mandatory safety-case element — communication, a complaints procedure, the chance to raise concerns and information about safety arrangements. BSA 2022 explicitly empowers resident voice, a direct post-Grenfell response.' },
  ...
  ], correctAnswer: 3, explanation: 'Multiple parties can or must access it: the BSR always, residents under BSA 2022 rights, contractors so they can integrate their work safely, and the fire and rescue service under RRFSO 2005 powers. Transparency is fundamental.' },
  ...
  ], correctAnswer: 0, explanation: 'The golden thread is digital — cloud-based certification platforms (NICEIC online, NAPIT online, contractor systems) produce records suitable for integration. Paper-only certs are increasingly inadequate for HRRB work; born-digital is preferred.' },
  ...
  ], correctAnswer: 1, explanation: 'Real consequences: the BSR can serve compliance notices and ultimately direct evacuation if risk is severe, the PAP can be prosecuted for failure to maintain the safety case, and Defective Premises Act and civil claims follow if defects later cause harm.' },
  ...
  ], correctAnswer: 2, explanation: 'The L3 contractor representative operationalises BSA 2022 on site — verify HRRB status, identify the PAP/AP, integrate the work plan with the safety case, produce digital records suitable for the golden thread, cooperate with PAP information requests and brief the team on HRRB-specific arrangements.' },
  ...
  ], correctAnswer: 3, explanation: 'The PAP is determined by ownership or control of the structure. Most BTL landlords own individual flats, not the whole building, so the freeholder or managing agent is typically PAP. Single ownership of an HRRB is rare; multi-leasehold structures are common.' },
  ...
  ], correctAnswer: 0, explanation: "Resident engagement extends to the contractor's work where relevant — brief affected residents per the PAP's strategy, provide information for newsletters and notices, answer questions about the work and handle complaints via the PAP's route." },
];
