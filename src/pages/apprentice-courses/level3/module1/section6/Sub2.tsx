...
const DESCRIPTION =
  'L3 deeper on PAP duties, the safety case, golden thread requirements and the L3 contractor representative role on HRRB sites.';

const checks = [
  {
    id: 'l3-m1-s6-sub2-pap',
    question: 'PAP main duties?',
    options: [
      'Register the building, prepare and revise the safety case, engage residents and maintain the golden thread.',
      'Plan, manage and monitor the construction phase and coordinate the work of all contractors on site.',
      'Carry out the fire risk assessment and maintain escape, fire alarm and emergency lighting under RRFSO 2005.',
      'Inspect and approve the detailed design at Gateway 2 and sign the building off at Gateway 3.',
    ],
    correctIndex: 0,
    explanation:
      'PAP duties are extensive and ongoing — register with the BSR, prepare and revise the safety case, engage residents, manage building safety risks, maintain the golden thread, report to the BSR and respond to its notices. Single role per HRRB.',
  },
  {
    id: 'l3-m1-s6-sub2-safety-case',
    question: "What's in a safety case?",
    options: [
      'A schedule of all contractors and their competence evidence, kept by the Principal Contractor.',
      'The fire risk assessment alone, prepared by the Responsible Person and reviewed annually.',
      'Building safety risks, the strategies to manage them and the evidence those strategies work.',
      'The set of as-built drawings and O&M manuals handed over to the client at practical completion.',
    ],
    correctIndex: 2,
    explanation:
      'The safety case is the comprehensive evidence document — identification of building safety risks (fire and structural primarily), management strategies, residents engagement strategy, golden-thread links and periodic review. A living document, updated as the building changes.',
  },
  {
    id: 'l3-m1-s6-sub2-electrical',
    question: 'How does electrical work integrate with the safety case?',
    options: [
      'Electrical certificates are filed separately and shared with the PAP only if the BSR requests them.',
      'EICs, EICRs, alteration certs, commissioning and design records all feed the golden thread.',
      'Only the final EICR is relevant; alteration and minor works certificates have no bearing on it.',
      'Electrical work feeds the fire risk assessment rather than the safety case, which is purely structural.',
    ],
    correctIndex: 1,
    explanation:
      'Electrical records are foundational to the safety case — EIC at install, EICR cycles, alteration certs, commissioning of fire detection and alarm, EV charging infrastructure and emergency lighting, plus design records and product specifications all become golden-thread evidence.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question: 'How often does the safety case need updating?',
    options: [
      'Once only, at registration — a fixed record that does not change for the life of the building.',
      'It is a living document, updated on significant changes, after incidents and periodically.',
      'Every five years, aligned to the maximum EICR inspection interval for residential common parts.',
      'Only when the Building Safety Regulator serves a formal notice requiring the PAP to revise it.',
    ],
    correctAnswer: 1,
    explanation:
      'Continuous, updated as the building evolves — on alterations, replacements and occupancy changes, after incidents or near-misses, and periodically (the PAP determines this, typically annually). The BSR can also request a review.',
  },
  {
    id: 2,
    question: "What's the residents engagement strategy?",
    options: [
      'A marketing plan for how the managing agent will attract new tenants to vacant flats.',
      'A voluntary scheme letting residents opt in to receive newsletters about planned maintenance.',
      'A required safety-case element setting out how the PAP engages residents on building safety.',
      'A contractual document between freeholder and leaseholders on service charges for safety works.',
    ],
    correctAnswer: 2,
    explanation:
      'Resident engagement is a mandatory safety-case element — communication, a complaints procedure, the chance to raise concerns and information about safety arrangements. BSA 2022 explicitly empowers resident voice, a direct post-Grenfell response.',
  },
  {
    id: 3,
    question: 'Who can request to see the safety case?',
    options: [
      'Only the Building Safety Regulator — the safety case is confidential to all other parties.',
      'Only the PAP and the Principal Contractor who built the building.',
      'Any member of the public, on payment of a fee, via an FOI request to the local authority.',
      'The BSR, residents, contractors working on the building and the fire and rescue service.',
    ],
    correctAnswer: 3,
    explanation:
      'Multiple parties can or must access it: the BSR always, residents under BSA 2022 rights, contractors so they can integrate their work safely, and the fire and rescue service under RRFSO 2005 powers. Transparency is fundamental.',
  },
  {
    id: 4,
    question: 'How does the golden thread work for electrical records?',
    options: [
      'Digital, accurate, accessible and secure — cloud certification platforms suit golden-thread integration.',
      "Paper certificates in the building manager's office are preferred because they cannot be altered.",
      'Only test results are retained; design records and product specifications are excluded.',
      'Records are held by the contractor for six years and then destroyed per standard retention practice.',
    ],
    correctAnswer: 0,
    explanation:
      'The golden thread is digital — cloud-based certification platforms (NICEIC online, NAPIT online, contractor systems) produce records suitable for integration. Paper-only certs are increasingly inadequate for HRRB work; born-digital is preferred.',
  },
  {
    id: 5,
    question: 'What happens if the safety case is inadequate?',
    options: [
      'Nothing formal — the BSR can only issue advisory guidance and has no enforcement powers.',
      'The BSR can serve compliance notices, direct evacuation in severe cases, and prosecute the PAP.',
      'The building is automatically de-registered and reverts to local authority building control.',
      'The Principal Contractor who built the building becomes liable to bring it up to standard.',
    ],
    correctAnswer: 1,
    explanation:
      'Real consequences: the BSR can serve compliance notices and ultimately direct evacuation if risk is severe, the PAP can be prosecuted for failure to maintain the safety case, and Defective Premises Act and civil claims follow if defects later cause harm.',
  },
  {
    id: 6,
    question: "What's the L3 contractor representative's role on HRRB work?",
    options: [
      "Prepare and submit the safety case to the BSR and respond to BSR notices on the PAP's behalf.",
      "Take over the PAP's legal accountability for the structure and exterior while works are in progress.",
      'Verify HRRB status, integrate the work plan with the safety case and produce golden-thread records.',
      'Carry out the fire risk assessment and update the evacuation strategy before any work begins.',
    ],
    correctAnswer: 2,
    explanation:
      'The L3 contractor representative operationalises BSA 2022 on site — verify HRRB status, identify the PAP/AP, integrate the work plan with the safety case, produce digital records suitable for the golden thread, cooperate with PAP information requests and brief the team on HRRB-specific arrangements.',
  },
  {
    id: 7,
    question: 'Are buy-to-let landlords typically PAPs?',
    options: [
      'Yes — any landlord who lets a flat in an HRRB automatically becomes the PAP for that flat.',
      'Yes — the landlord with the most flats in the building is designated PAP by the BSR.',
      'No — buy-to-let landlords are exempt from the BSA 2022 regime entirely as private individuals.',
      'Only if they own or control the structure and exterior, which most BTL landlords do not.',
    ],
    correctAnswer: 3,
    explanation:
      'The PAP is determined by ownership or control of the structure. Most BTL landlords own individual flats, not the whole building, so the freeholder or managing agent is typically PAP. Single ownership of an HRRB is rare; multi-leasehold structures are common.',
  },
  {
    id: 8,
    question: "How does the L3 cooperate with the PAP's residents engagement?",
    options: [
      "Brief affected residents per the PAP's strategy and route any complaints through the PAP.",
      'Deal with all resident concerns directly and independently, without involving the PAP.',
      'Decline to speak to residents at all, referring every query straight to the Building Safety Regulator.',
      "Hold the resident engagement meetings on the PAP's behalf and publish the engagement strategy.",
    ],
    correctAnswer: 0,
    explanation:
      "Resident engagement extends to the contractor's work where relevant — brief affected residents per the PAP's strategy, provide information for newsletters and notices, answer questions about the work and handle complaints via the PAP's route.",
  },
];

const faqs = [
  {
    question: 'Can a small electrical alteration trigger safety case update?',
    answer:
      'Significant alterations — yes. Routine maintenance — usually no. PAP makes the call; the contractor flags the work for PAP awareness.',
  },
  {
    question: 'How do I know who the PAP is?',
    answer:
      'Ask the managing agent / building manager / customer. The PAP should be identified in safety arrangements; if no-one knows, that itself is a red flag.',
  },
  {
    question: 'Are emergency lighting tests part of golden thread?',
    answer:
      'Yes — emergency lighting is safety-critical for the building’s evacuation strategy. Test records, maintenance records, repair records all part of the golden thread.',
  },
  {
    question: 'What if the PAP does not engage with my work plan?',
    answer:
      'Document the attempt. Escalate to firm. Do not proceed with significant common-parts work without PAP engagement; the alternative creates liability for the firm and potentially the PAP.',
  },
  {
    question: 'How do I get my certs into the golden thread?',
    answer:
      'Work with the PAP’s document management arrangements. Some PAPs have integrated systems (cert is uploaded directly); others receive certs and manually integrate. Confirm at start of project.',
  },
  {
    question:
      'Does the golden thread requirement apply to all building records or just safety-critical ones?',
    answer:
      'Primarily safety-critical (design, materials, installation, maintenance, alterations affecting structure / fire / safety systems). Routine non-safety records less critical.',
  },
  {
    question: 'Who decides whether an alteration triggers a safety case update?',
    answer:
      'The PAP. The contractor flags the work; the PAP applies their judgement on whether the safety case is materially affected. Where doubt exists, raising the flag is the correct response and lets the PAP decide.',
  },
  {
    question: 'How does the PAP demonstrate ongoing safety case validity to the BSR?',
    answer:
      'Periodic safety case review (typically annual), updated as conditions change, with evidence the strategies remain effective. The BSR can request the safety case at any time; the PAP must produce it without delay.',
  },
  {
    question: 'What is the difference between a PAP and an Accountable Person (AP)?',
    answer:
      'A PAP is the single accountable person for the structure and exterior of the HRRB. APs are accountable for repair of parts of common parts; an HRRB may have multiple APs but only one PAP. The PAP coordinates with the APs.',
  },
  {
    question: 'How does the L3 supervisor know if a PAP has been registered with the BSR?',
    answer:
      'The BSR maintains a register of HRRBs and their PAPs. The managing agent / building manager should be able to confirm registration. Where registration is missing on a building that meets the HRRB threshold, that is itself a BSR-reportable concern.',
  },
];
...
export default function Sub2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 6 · Subsection 2"
        title="HRRB dutyholders and the safety case"
        backTo="/study-centre/apprentice/level3-module1-section6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            "Remember from Section 6.1 - PAP holds the building. Here we go deeper on the safety case, golden thread integration and the L3 contractor representative's role."
          }
        </p>
        ...
        <ConceptBlock
          title="What the PAP actually does"
          plainEnglish="The PAP is single accountable person per HRRB. Duties include registering the building with BSR; preparing and revising the safety case; engaging residents; managing safety risks; maintaining the golden thread; responding to BSR notices; reporting incidents."
          onSite="L3 contractor working on HRRB needs to identify the PAP early. The PAP's arrangements drive what the contractor does on site - documentation format, sequencing, approvals, communication with residents."
        >
          <p>PAP duty list:</p>
        ...
        <RegsCallout
          source="Building Safety Act 2022 - s.83 (Safety case)"
          clause={
            <>
              "The principal accountable person for a higher-risk building must - (a) prepare a
              safety case report for the building, and (b) keep the safety case report under review
              and revise it as appropriate."
            </>
          }
          meaning={
            <>
              The safety case duty. PAP prepares and continuously revises. The safety case is the
              comprehensive evidence that the building is being safely managed and the strategies
              for managing risks are working.
            </>
          }
          cite="Source: Building Safety Act 2022 (2022 c.30), s.83."
        />
        ...
        <ConceptBlock
          title="What the safety case contains"
          plainEnglish="Safety case is comprehensive document covering identification of building safety risks (primary fire and structural), strategies to manage them, evidence the strategies work in practice, residents engagement strategy, and links to the golden thread."
          onSite="L3 contractor representative should be able to ask for / see relevant parts of the safety case for the work being undertaken. Common-parts electrical work, fire detection / alarm work, emergency lighting work all reference safety case content."
        >
        ...
        <ConceptBlock
          title="Where electrical records meet the golden thread"
          plainEnglish="Many electrical systems are safety-critical for HRRB safety case - fire detection / alarm, emergency lighting, EV charging electrical infrastructure (fire risk), wayfinding, smoke control. Test records, maintenance records, alteration certs all become part of golden thread."
          onSite="The L3 supervisor produces records in digital format from the start, suitable for direct integration with PAP's document system. NICEIC online, NAPIT online, contractor cloud systems all produce digital outputs. Paper-only certs require additional handling and may not be acceptable to all PAPs."
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              EV charging infrastructure (BS 7671 Section 722; Approved Doc B fire considerations).
            </li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The RP&apos;s fire risk assessment duty. &quot;Suitable and sufficient&quot; mirrors
              the MHSWR Reg 3 standard. Five-employee threshold for written record. The RP&apos;s
              FRA drives the design and maintenance of fire alarm, emergency lighting, fire-fighting
              equipment and means of escape — all touching electrical installation work.
            </>
          }
        ...
        <ConceptBlock
          title="Golden thread practical implementation"
          plainEnglish="The golden thread is the digital, accurate, accessible, secure information set covering an HRRB’s design, construction and ongoing management. Practical implementation: cloud-based document management with structured taxonomy, controlled access, version control, audit trail. Held by PAP; contractors contribute via digital records."
          onSite="L3 supervisor practical contribution: produce certs in cloud-based systems (NICEIC online, NAPIT online, contractor cloud) that output digital files; hand them to the PAP’s document system in agreed format (typically PDF + structured metadata or direct upload to portal). Confirm format with PAP at start of project; do not produce paper certs and assume scanning will work."
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Test and commissioning records (electrical EIC, fire alarm, emergency lighting).
            </li>
        ...
        <ConceptBlock
          title="Dutyholder cooperation under BSA 2022 + CDM 2015"
          plainEnglish="On HRRB construction the BSA 2022 dutyholder regime (Client / Principal Designer / Principal Contractor with extra HRRB-specific duties) sits on top of the CDM 2015 framework. Mandatory client-led design competence, gateway sign-offs, building safety information transfer at each stage, and tighter change-management discipline. The L3 supervisor on HRRB construction works inside both frameworks."
          onSite="Practical effect: more documentation, more design-team approvals, slower change cycles, formal sign-offs at gateways. Site substitutions are essentially banned without design-team approval. Operative competence checks (cards, schemes) are tighter. Plan accordingly; the project economics absorb the time."
        >
        ...
        <RegsCallout
          source="Fire Safety Act 2021 — s.1 (Premises to which the Order applies)"
          clause={
            <>
              &quot;Where a building contains two or more sets of domestic premises, the things to
              which [RRFSO] article 6(1A) applies are — (a) the building&apos;s structure and
              external walls and any common parts, and (b) all doors between the domestic premises
              and common parts.&quot;
            </>
          }
          meaning={
            <>
              The Fire Safety Act 2021 amendment clarifies that the RP&apos;s RRFSO duties extend to
              external walls (cladding) and flat entrance doors in multi-occupancy residential
              buildings. Direct response to Grenfell — closes a perceived gap in pre-2021 RRFSO
              scope. Reaches contractor electrical work where penetrations through external walls /
              flat doors are involved.
            </>
          }
          cite="Source: Fire Safety Act 2021 (2021 c.24), s.1."
        />

        <ConceptBlock
          title="BSR enforcement powers and notices"
          plainEnglish="The Building Safety Regulator has wide enforcement powers — improvement notices, compliance notices, restriction notices (effectively prohibition), prosecution. Can ultimately direct evacuation if building safety risk is severe. Operates similarly to HSE inspector model but with HRRB-specific mandate."
          onSite="L3 supervisor framing: BSR is real enforcement, not advisory. Contractors who fail to integrate with PAP / golden thread can themselves face BSR action where their failures contribute to safety case inadequacy. Standard expectation is full cooperation with PAP — non-cooperation is a regulatory red flag."
        >
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Use cloud-based certification system (NICEIC online, NAPIT online, contractor cloud)
              for born-digital outputs. Confirm format with PAP at start of project.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Flag any work that affects safety-critical systems to the PAP for safety case update.
              Brief written notification with the cert package.
            </>
          }
        />

        <Scenario
          title="Fire alarm alteration in an HRRB"
          situation={
            <>
              Your firm has been engaged to extend the fire detection and alarm system in an HRRB
              block of flats - additional smoke detectors in newly-converted communal storage area.
              PAP is the managing agent who is engaged but busy.
            </>
          }
          whatToDo={
            <>
              Pre-work: confirm scope with PAP / fire risk assessor; ensure design integrated with
              existing system; obtain commissioning protocol. During work: document each step;
              produce digital cert; integrate with existing fire alarm system. Post-work: brief PAP
              on changes; provide cert in digital format suitable for golden thread; flag for safety
              case update; brief commissioning to building manager. The fire alarm system is core
              safety case infrastructure; the alteration must be reflected in the case.
            </>
          }
          whyItMatters={
            <>
              Fire detection / alarm work in HRRBs is exactly the kind of safety-critical work that
              BSA 2022 was designed to govern. Failure to integrate with the safety case leaves the
              building protected by an outdated risk assessment - the failure mode that contributed
              to past incidents.
            </>
          }
        />
        ...
        <SectionRule />
        <ContentEyebrow>
          Building Safety Act gateways — the three regulatory checkpoints
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Gateway 1 (planning)</strong> — fire safety considered at planning application
              stage; HSE / BSR consulted; statutory consultee role.
            </li>
            <li>
              <strong>Gateway 2 (pre-construction)</strong> — BSR approval of detailed design,
              construction control plan, competence, golden-thread arrangements before work starts.
            </li>
            <li>
              <strong>Gateway 3 (pre-occupation)</strong> — BSR sign-off that the building has been
              constructed as approved and is safe to occupy.
            </li>
            <li>
              <strong>Change control between gateways</strong> — major changes need Gateway 2
              modification application.
            </li>
            <li>
              <strong>Mandatory occurrence reporting</strong> — BSR notified of
              building-safety-relevant events during construction (Reg 18 BSA 2022 Part 3).
            </li>
            <li>
              <strong>BSR-registered contractors</strong> — for high-risk work; the competence
              framework that backs the gateway approvals.
            </li>
            <li>
              <strong>Documentation discipline</strong> — golden thread maintained throughout;
              gateway 3 review relies on the records.
            </li>
            <li>
              <strong>Penalties for non-compliance</strong> — BSR enforcement powers including stop
              notices, prosecution, individual liability.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Direct BSR engagement increasingly reaches firms whose contractor practice falls below
              the published expectations.
            </li>
            <li>Contractor track record on HRRBs becomes its own procurement asset over time.</li>
            <li>
              Cultural alignment with the regulator&apos;s direction is the long-term commercial
              position.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Gateway 2 modification application for any significant design / construction change.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              MOR triage — receiving findings, deciding what reaches PAP for BSR notification.
            </li>
            <li>Site induction and contractor briefings on HRRB-specific arrangements.</li>
            <li>
              Coordination with RP under RRFSO 2005 (often same person or closely coordinated).
            </li>
            <li>
              Mandatory appointment was withdrawn but role remains appropriate in many structures.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Risk identification adequacy — primary fire and structural, plus contributing factors.
            </li>
            <li>
              Strategy appropriateness — controls match identified risks; hierarchy of control
              applied.
            </li>
            <li>
              Evidence of effectiveness — testing records, monitoring data, near-miss capture.
            </li>
            <li>
              Residents engagement operational — strategy implemented, concerns addressed, response
              timescales met.
            </li>
        ...
        <Scenario
          ...
          situation={
            <>
              Your firm has been engaged to extend the existing fire detection and alarm system in
              an HRRB block of flats. The PAP — a managing agent — wants additional smoke detection
              in a newly-converted communal storage area that was previously a vacant boiler room.
              The existing system is BS 5839-1 Category L2, addressable technology, manufactured by
              a known industry supplier. The new detection needs to integrate seamlessly. You are
              L3-qualified and have the firm&apos;s sign-off for routine fire alarm work; the firm
              is BAFE SP203 registered and BS 5839 competent.
            </>
          }
          whatToDo={
            <>
              Pre-work coordination. Confirm scope with PAP and the fire risk assessor — the new
              detection should be consistent with the category and integrated logically (zone
              assignment, panel address allocation, cause-and-effect updates). Obtain commissioning
              protocol from the existing system manufacturer or the firm&apos;s competent designer.
              Confirm product compatibility with existing panel and devices — same manufacturer or
              compatible-certified third party. Confirm any cause-and-effect changes are documented
              and approved. Confirm fire-stopping arrangements where new cabling penetrates
              fire-rated walls or floors. During work: document each step; preserve photographs of
              installation; record device addresses and locations. Post-work: full system test
              including the existing devices to confirm no disruption from the alteration;
              functional test of new devices; cause-and-effect verification; updated zone plan and
              as-built drawings. Produce digital cert suitable for golden thread integration. Brief
              PAP on changes; flag for safety case update if the alteration is significant enough to
              warrant case revision. Provide cert and supporting documentation in PAP&apos;s
              required format. Update the building log book and the fire risk assessment trigger
              list. The alteration becomes part of the safety case evidence; the PAP&apos;s next
              periodic review will reflect the updated coverage.
            </>
          }
          whyItMatters={
            <>
              Fire detection / alarm work on HRRBs is exactly the kind of safety-critical activity
              BSA 2022 was designed to govern. The integration of work with the building&apos;s
              safety case is what makes the framework operational. A high-quality alteration that is
              integrated properly strengthens the safety case; a technically-good alteration that is
              not integrated leaves the safety case out of date and the building protected by an
              outdated risk assessment. The L3 supervisor&apos;s coordination with the PAP, accurate
              documentation, and prompt cert production are what bridges the gap between technical
              work and regulatory framework. The competence layers (BAFE SP203, BS 5839 designer
              competence, NICEIC / NAPIT installer competence, operative training) all contribute to
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>L1 — Life protection</strong> — manual call points + automatic detection
              throughout.
            </li>
            <li>
              <strong>L2 — Life protection</strong> — manual call points + detection in specified
              high-risk areas + escape routes.
            </li>
            <li>
              <strong>L3 — Life protection</strong> — manual call points + detection in escape
              routes and certain adjoining rooms.
            </li>
            <li>
              <strong>L4 — Life protection</strong> — manual call points + detection in escape
              routes.
            </li>
            <li>
              <strong>L5 — Life protection</strong> — bespoke design for specific objectives.
            </li>
            <li>
              <strong>P1 — Property protection</strong> — automatic detection throughout.
            </li>
            <li>
              <strong>P2 — Property protection</strong> — automatic detection in specified high-risk
              areas.
            </li>
            <li>
              <strong>BS 5839-6</strong> — covers domestic premises (single dwellings).
            </li>
            <li>
              <strong>Post-Grenfell direction</strong> — generally towards higher categories on
              HRRBs.
            </li>
            <li>
              <strong>PAP safety case</strong> — specifies required category; contractor designs to
              specification.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Escape route lighting</strong> — minimum 1 lux across the full width.
            </li>
            <li>
              <strong>Open area (anti-panic) lighting</strong> — minimum 0.5 lux on floor.
            </li>
            <li>
              <strong>High-risk task area lighting</strong> — 10% of normal lighting, 15 lux
              minimum.
            </li>
            <li>
              <strong>Duration</strong> — typically 1 hour for residential, 3 hours for high-risk.
            </li>
            <li>
              <strong>Battery technology</strong> — sealed lead-acid or lithium typically;
              replacement programme.
            </li>
            <li>
              <strong>Monthly functional test</strong> — short duration, verify operation.
            </li>
            <li>
              <strong>Annual full duration test</strong> — full battery discharge.
            </li>
            <li>
              <strong>Test logs</strong> — part of golden thread; reviewed periodically.
            </li>
            <li>
              <strong>Self-test luminaires</strong> — automate testing; modern installations.
            </li>
            <li>
              <strong>System design</strong> — responds to evacuation strategy.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Structural failure or instability</strong> — deflection, cracking, fixing
              failure, settlement, vibration.
            </li>
            <li>
              <strong>Fire safety system failures</strong> — alarm panel unresolved faults, devices
              missing, emergency lighting failures, sprinkler isolation, smoke control inoperative.
            </li>
            <li>
              <strong>Compartmentation breaches</strong> — fire-stopping missing, fire doors damaged
              or wedged, walls / floors penetrated without restoration.
            </li>
            <li>
              <strong>External wall system concerns</strong> — cladding damage, sealant failure,
              cavity barrier missing, balcony integrity.
            </li>
            <li>
              <strong>Lift safety system failures</strong> — firefighters&apos; lift faults,
              evacuation lift faults, lift safety circuit anomalies.
            </li>
            <li>
              <strong>Defects threatening safety case validity</strong> — any finding that suggests
              the safety case assumes conditions materially different from what is actually present.
            </li>
            <li>
              <strong>Reportable in addition to RIDDOR triggers</strong> — not instead of; both
              regimes can apply.
            </li>
            <li>
              <strong>Timescale</strong> — initial notification as soon as reasonably practicable;
              full report within 10 days; PAP holds duty; contractor flags to PAP.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;The principal accountable person must establish and operate a mandatory
              occurrence reporting system for the higher-risk building, which must — (a) enable
              persons working on or in the building to report relevant safety occurrences to the
              principal accountable person; (b) require the principal accountable person to report
              such occurrences to the regulator in accordance with the requirements of these
              Regulations.&quot;
            </>
          }
          meaning={
            <>
              The PAP&apos;s MOR system must be capable of receiving reports from people working on
              or in the building — including contractors. The contractor&apos;s flagging route is
              part of the PAP&apos;s system. The PAP then decides whether the finding triggers BSR
              notification under the prescribed timescales. The regulations establish the framework;
              published BSR guidance gives operational detail.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;The principal accountable person for a higher-risk building must apply to the
              regulator for the building to be registered. An application for registration must be
              made before the building is occupied (if the building is not occupied immediately
              after it is built) or, in the case of a building which is occupied at the commencement
              of section 79, within the period specified by the regulator.&quot;
            </>
          }
          meaning={
            <>
              s.79 is the registration duty. Pre-occupation registration for new builds;
              transitional registration for buildings already occupied at BSA 2022 commencement. The
              registration is the BSR&apos;s formal record of the HRRB and triggers the
              in-occupation regulatory regime. Failure to register is a serious offence; PAP may be
              prosecuted directly.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Continuous updating as building changes (alterations, replacements, occupancy
              changes).
            </li>
            ...
            <li>
              Multiple parties contribute — PAP, AP, RP, contractors, residents, scheme inspectors.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Information provision — how residents are kept informed about safety arrangements.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Approved Doc B</strong> — Fire safety; post-Grenfell tightening of external
              wall, cable CPR, sprinkler, alarm, emergency lighting requirements.
            </li>
            <li>
              <strong>Approved Doc P</strong> — Electrical safety in dwellings; notifiable work +
              competent person schemes.
            </li>
            <li>
              <strong>Approved Doc L</strong> — Conservation of fuel and power; heat pump, LED, EV
              charging, renewables drive.
            </li>
            <li>
              <strong>Approved Doc S</strong> — Infrastructure for EV charging; new and renovated
              buildings.
            </li>
            <li>
              <strong>Approved Doc M</strong> — Access to and use of buildings; affects evacuation
              arrangements.
            </li>
            <li>
              <strong>Approved Doc 7</strong> — Materials and workmanship; cross-cutting
              fitness-for-purpose standard.
            </li>
            <li>
              BSA 2022 framework wraps the regulatory process around the Approved Document technical
              baselines.
            </li>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            onClick={() => navigate('/study-centre/apprentice/level3-module1-section6-1')}
