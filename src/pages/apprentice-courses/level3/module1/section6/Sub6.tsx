...
const checks = [
  ...
  { id: 'l3-m1-s6-sub6-near-miss', question: 'Why is near-miss culture the highest-impact preventive activity?', options: [
    'Because near-misses are leading indicators of where the next incident will occur. Reporting + analysis + lessons-learned + visible changes = systemic prevention. Cheap; effective; aligns with Reg 5 POCMR.',
  ...
  ], correctIndex: 0, explanation: 'Near-miss culture is the cheapest, most effective preventive practice. Many firms have weak near-miss reporting; mature firms have strong.' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 2, explanation: 'Specific Equality Act duty. Examples: ergonomic equipment, modified work patterns, accessible facilities, communication aids.' },
  ...
  ], correctAnswer: 3, explanation: 'PEEPs sit at the intersection of Equality Act + fire safety + risk assessment. Multiple legal obligations converge.' },
  ...
  ], correctAnswer: 0, explanation: 'Near-miss = potential incident that didn\'t cause harm. Reporting + analysis turns it into prevention.' },
  ...
  ], correctAnswer: 2, explanation: 'Multi-element culture. Each element supports the others; weak link breaks the system.' },
  ...
  ], correctAnswer: 3, explanation: 'Equality Act practice runs through the supervisor. Modelling, intervention, escalation.' },
  ...
  ], correctAnswer: 0, explanation: 'Culture built one report at a time. The L3 supervisor\'s consistent modelling is what shifts team behaviour.' },
];
