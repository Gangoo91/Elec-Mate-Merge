...
const DESCRIPTION =
  'L3 closing topics - Equality Act 2010 reasonable adjustments, PEEPs, and the L3 supervisor role in building near-miss culture.';
...
const checks = [
  {
    ...
    correctIndex: 0,
    explanation:
      'Nine protected characteristics. Equality Act covers all workplaces and many service contexts. L3 supervisor maintains inclusive practice.',
  },
  {
    id: 'l3-m1-s6-sub6-peep',
    question: 'Who needs a PEEP?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'PEEP needed where standard evacuation insufficient. Equality Act + RRFSO 2005 + MHSWR Reg 3.',
  },
  {
    id: 'l3-m1-s6-sub6-near-miss',
    question: 'Why is near-miss culture the highest-impact preventive activity?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'Reporting + analysis + lessons-learned + visible changes turns near-misses into systemic prevention - cheap, effective and aligned with MHSWR Reg 5. Near-miss culture is the cheapest, most effective preventive practice; many firms have weak reporting while mature firms have strong.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question: 'What does Equality Act 2010 require of employers?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Comprehensive duty. Workplace inclusion + reasonable adjustments + protection from harassment.',
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'A specific Equality Act duty; "reasonable" balances cost, disruption and effectiveness, and failure to make one is unlawful discrimination. Examples: ergonomic equipment, modified work patterns, accessible facilities, communication aids.',
  },
  {
    id: 3,
    question: "What's the relationship between PEEP and Equality Act?",
    options: [
    ...
    correctAnswer: 3,
    explanation:
      'PEEPs sit at the intersection of the Equality Act, RRFSO 2005 and MHSWR Reg 3 - failure to provide one for someone who needs it is both unlawful discrimination and a safety breach. Multiple legal obligations converge.',
  },
  {
    id: 4,
    question: "What's a near-miss?",
    options: [
    ...
    correctAnswer: 0,
    explanation:
      "Examples: slips without a fall, tool drops without injury, almost-contact with energised conductors, RAMS-procedure shortcuts spotted before an incident. A near-miss is a potential incident that didn't cause harm; reporting + analysis turns it into prevention.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      "Common formulations are around 300:30:1 (near-misses : minor injuries : serious injury). Heinrich's pyramid is conceptual not exact - the point is the relationship: many near-misses underlie each serious incident, so tackling near-misses reduces serious incidents.",
  },
  {
    id: 6,
    question: 'What does a strong near-miss culture look like?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'A multi-element culture: no-blame reporting, an easy reporting mechanism, structured analysis (5-whys, root cause), feedback to the team, visible changes in practice, trend tracking, celebrating the act of reporting (not the near-miss) and leadership modelling. Each element supports the others; a weak link breaks the system.',
  },
  {
    id: 7,
    question: "What's the L3 supervisor's role in inclusive practice?",
    options: [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "Analyse reports with the team, feed lessons forward and celebrate the report (not the near-miss); cultural change is cumulative over months and years. Culture is built one report at a time, and the L3 supervisor's consistent modelling is what shifts team behaviour.",
  },
];

const faqs = [
  {
    question: 'Is the Equality Act 2010 the same across UK?',
    answer:
...
export default function Sub6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 6 · Subsection 6"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'Closing topics for Module 1. Equality Act 2010 inclusive practice + PEEPs + the L3 supervisor role in building near-miss culture - the highest-impact preventive practice.'
          }
        </p>
        ...
        <ConceptBlock
          title="Inclusive workplace and reasonable adjustments"
          plainEnglish="Equality Act 2010 covers nine protected characteristics. Workplace duties: don't discriminate, make reasonable adjustments for disabled persons, protect from harassment and victimisation, ensure inclusive practices. Applies to employers regardless of size."
          onSite="L3 supervisor practices inclusion: model inclusive language; identify and accommodate reasonable adjustments where needed; intervene against discriminatory behaviour; document. The Act is operational not aspirational."
        >
        ...
        <RegsCallout
          source="Equality Act 2010 - s.20 (Duty to make adjustments)"
          clause={
            <>
              ...
              who are not disabled, the duty is to take such steps as it is reasonable to have to
              take to avoid the disadvantage."
            </>
          }
          meaning={
            <>
              The reasonable adjustment duty. Practical examples: ergonomic equipment, modified work
              patterns, accessible facilities, communication aids, PEEPs for evacuation.
              \"Reasonable\" balances cost, disruption, effectiveness in context of employer's
              resources.
            </>
          }
          cite="Source: Equality Act 2010 (2010 c.15), s.20."
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Refuge point - typically protected lobby on stair with two-way communication device.
            </li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>No-blame reporting</strong> - the goal is learning, not punishment.
            </li>
            <li>
              <strong>Easy reporting mechanism</strong> - form, app, verbal-then-logged.
            </li>
            <li>
            ...
            <li>
              <strong>Celebrate reporting</strong> - the act, not the near-miss.
            </li>
            <li>
              <strong>Trend tracking</strong> - what categories are emerging?
            </li>
            <li>
              <strong>Leadership modelling</strong> - L3 + supervisors report own near-misses
              openly.
            </li>
            <li>
              <strong>Integration with Reg 5 POCMR</strong> - near-miss data feeds the management
              cycle.
            </li>
            <li>
              <strong>Toolbox talks</strong> referencing recent near-misses for relevance.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock
          title="The four types of unlawful discrimination"
          plainEnglish="Equality Act 2010 distinguishes four types of unlawful discrimination: (1) Direct discrimination — less favourable treatment because of a protected characteristic; (2) Indirect discrimination — neutral practice that disadvantages a protected group disproportionately; (3) Harassment — unwanted conduct related to a characteristic, violating dignity or creating a hostile environment; (4) Victimisation — detriment for raising a discrimination complaint or supporting one. The L3 supervisor recognises and intervenes against all four."
          onSite="Common workplace examples: direct (refusing apprenticeship to a candidate because of pregnancy); indirect (a fitness requirement disadvantageous to women that is not job-essential); harassment (banter targeting religion or sexuality); victimisation (penalising someone for supporting a colleague's grievance). The L3 supervisor names the type when escalating."
        >
          <p>The four types in detail:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Direct</strong> — less favourable treatment because of characteristic; rarely
              justifiable except age (in limited cases).
            </li>
            <li>
              <strong>Indirect</strong> — neutral practice that disadvantages protected group;
              potentially justifiable if proportionate means to legitimate aim.
            </li>
            <li>
              <strong>Harassment</strong> — unwanted conduct related to characteristic, creating
              hostile / degrading / offensive environment; no justification defence.
            </li>
            <li>
              <strong>Victimisation</strong> — detriment for protected acts (raising / supporting
              complaint, giving evidence).
            </li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;A person (A) harasses another (B) if — (a) A engages in unwanted conduct related
              to a relevant protected characteristic, and (b) the conduct has the purpose or effect
              of — (i) violating B&apos;s dignity, or (ii) creating an intimidating, hostile,
              degrading, humiliating or offensive environment for B.&quot;
            </>
          }
          meaning={
            <>
              The harassment definition. &quot;Effect&quot; matters even if the perpetrator&apos;s
              purpose was different — &quot;banter&quot; that creates a hostile environment is
              harassment regardless of intent. The L3 supervisor framing on toolbox banter that
              targets a characteristic: name it, intervene, document. Employer is vicariously liable
              for harassment by employees in the course of employment.
            </>
          }
          cite="Source: Equality Act 2010 (2010 c.15), s.26."
        />

        <ConceptBlock
          title="Worker Protection (Amendment) Act 2023 — sexual harassment duty"
          plainEnglish="The Worker Protection (Amendment of Equality Act 2010) Act 2023 introduced a positive duty on employers to take reasonable steps to prevent sexual harassment of their workers. Came into force October 2024. Tribunal can uplift compensation by up to 25% where employer failed to comply with the duty. Brings sexual harassment prevention into proactive territory rather than reactive only."
          onSite="L3 supervisor framing: the firm has a positive duty now, not just a reactive one. Toolbox-talk content on respectful workplace behaviour, clear reporting routes, prompt action on reports — all part of the reasonable steps the firm must take. Failure visible in subsequent claim = compensation uplift."
        >
          <p>Worker Protection Act elements:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Positive duty on employers to take reasonable steps to prevent sexual harassment.
            </li>
            ...
            <li>
              Reasonable steps include: policy, training, clear reporting routes, action on reports.
            </li>
        ...
        <ConceptBlock
          title="Just Culture — the modern near-miss framing"
          plainEnglish="Just Culture (originally aviation-derived, now widely adopted) distinguishes between honest error (treat as learning), at-risk behaviour (coach), and reckless behaviour (discipline). The same near-miss can land in any category depending on the operative's decision-making — the framework lets organisations respond proportionately rather than blanket-blaming or blanket-protecting."
          onSite='L3 supervisor application: when analysing a near-miss, ask "was this honest error, at-risk, or reckless?". Honest error = system failure to prevent it; coach the system. At-risk = drift to lower-tier behaviour despite knowing better; coach the operative. Reckless = conscious disregard of substantial risk; discipline. Same incident, three different responses depending on decision quality.'
        >
          <p>Just Culture framework:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Honest error</strong> — slip, lapse, mistake despite reasonable care; system
              response (improve controls, training, design).
            </li>
            <li>
              <strong>At-risk behaviour</strong> — drift to lower-tier control without conscious
              choice; coach to restore standard.
            </li>
            <li>
              <strong>Reckless behaviour</strong> — conscious disregard of substantial risk;
        ...
        <ConceptBlock
          title="PEEPs in detail — designing the evacuation plan"
          plainEnglish="A Personal Emergency Evacuation Plan (PEEP) is a tailored evacuation plan for someone who cannot use the standard evacuation route unaided. Designed in consultation with the person; involves designated buddies; uses refuge points (typically protected lobby on stair with two-way communication device); may use evac chair or other equipment; rehearsed in drills; updated as needs change. Sits at intersection of Equality Act + RRFSO 2005 + MHSWR Reg 3."
          onSite="L3 supervisor on site evacuation considerations: who needs a PEEP? — wheelchair users, sensory-impaired colleagues, late-pregnancy, temporary impairment (recent injury, broken leg). On a customer site the customer's RP / PAP handles. On a project site the principal contractor handles. Confirm PEEPs are in place before any incident."
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Generic (GEEP) for visitors with similar needs (e.g. wheelchair users in public
              buildings).
            </li>
            <li>Updated when person&apos;s needs change or building layout changes.</li>
            <li>
              Failure to provide PEEP for someone needing one breaches Equality Act + RRFSO + MHSWR.
            </li>
          </ul>
        </ConceptBlock>

        <RegsCallout
          source="Equality Act 2010 — s.27 (Victimisation)"
          clause={
            <>
              &quot;A person (A) victimises another person (B) if A subjects B to a detriment
              because — (a) B does a protected act, or (b) A believes that B has done, or may do, a
              protected act.&quot;
            </>
          }
          meaning={
            <>
              Victimisation protection covers the act of raising a discrimination complaint,
              supporting a colleague&apos;s complaint, or giving evidence. The protected act does
              not need to succeed — the worker is protected from detriment for the act of raising or
              supporting. Mirrors ERA s.44 in structure for safety; together they form the
              workplace-voice protection framework.
            </>
          }
          cite="Source: Equality Act 2010 (2010 c.15), s.27."
        />

        <ConceptBlock
          title="Inclusive site practice — practical L3 supervisor actions"
          plainEnglish="Inclusive practice is operational: how the L3 supervisor speaks, briefs, allocates work, intervenes against unacceptable behaviour, accommodates needs, and models respect. Cumulative effect over time shapes team culture. Particular attention to apprentices, women in trade contexts, racially-minoritised workers, disabled colleagues, LGBT colleagues — all groups still under-represented in electrical trade."
          onSite="Daily practice: use chosen names; check in on apprentices; intervene against banter that targets characteristics; arrange reasonable adjustments without making a fuss; model the behaviour you expect. Inclusion is not a separate activity — it is the texture of how the team works."
        >
        ...
        <SectionRule />
        <CommonMistake
          title="Treating near-miss reports as opportunities to blame"
          whatHappens={
            <>
              Operative reports near-miss honestly; supervisor uses it to discipline / criticise /
              blame. Operative learns not to report; near-miss reporting collapses; latent risks
              accumulate; serious incident eventually follows.
            </>
          }
          doInstead={
            <>
              No-blame reporting culture. Treat the report as the act of professional integrity it
              is. Analyse for systemic causes (not personal blame). Feed lessons forward. The next
              operative who reports honestly is more important than the one in front of you.
            </>
          }
        />

        <CommonMistake
          title="Failing to provide reasonable adjustment for an apprentice with a disability"
          whatHappens={
            <>
          ...
          doInstead={
            <>
              Identify needs early; engage with the apprentice; implement reasonable adjustments.
              Inclusive practice + safety + commercial sense all aligned.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              The shift is gradual but powerful; mature firms have routinely 5-10x more near-miss
              reports per operative-hour than weak ones, and correspondingly fewer serious
              incidents.
            </>
          }
          whyItMatters={
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Apprentices with dyslexia</strong> — verbal briefings, recorded instructions,
              simplified RAMS summaries, additional time for written assessments.
            </li>
            <li>
              <strong>Hearing impairment</strong> — visual alarms, written communication,
              sign-language interpreter for key briefings, vibrating personal alarms.
            </li>
            <li>
              <strong>Mobility impairment</strong> — modified access, assistive equipment, work
              allocation suited to capability.
            </li>
            <li>
              <strong>Mental health conditions</strong> — supportive supervision, flexible working
              where reasonably practicable, EAP referral.
            </li>
            <li>
              <strong>Diabetic / medical conditions</strong> — break scheduling, food / drink
              access, awareness of hypoglycaemic warning signs in colleagues.
            </li>
            <li>
              <strong>Customer reasonable adjustments</strong> — alternative communication (written
              / face-to-face / phone), scheduling around vulnerability, additional explanation of
              safety arrangements.
            </li>
            <li>
              <strong>PEEPs for occupants</strong> — Personal Emergency Evacuation Plans for
              disabled residents in occupied premises; the work plan must not compromise PEEP routes
              or arrangements.
            </li>
            <li>
              <strong>Documentation</strong> — adjustments recorded as part of normal competence /
              training records; no special &apos;disability file&apos; that singles individuals out.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <SectionRule />
        <ContentEyebrow>
          Heinrich&apos;s pyramid, Bird&apos;s ratio and the modern critique
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lagging indicators</strong> — injuries, RIDDOR reports, claims, lost time.
            </li>
            <li>
              <strong>Leading indicators</strong> — near-miss reports, training currency, RAMS
              quality, audit findings.
            </li>
            <li>
              <strong>Behavioural observation programmes</strong> — peer observation; coaching;
              trend tracking.
            </li>
            <li>
              <strong>Reporting volume trend</strong> — falling = alarm; rising = healthy
              engagement.
            </li>
            <li>
              <strong>Training currency</strong> — % operatives within refresher window; leading
              indicator of competence.
            </li>
            <li>
              <strong>RAMS adequacy audit</strong> — sample review; gap identification.
            </li>
            <li>
              <strong>Toolbox frequency</strong> — culture-shaping mechanism; tracked.
            </li>
            <li>
              <strong>Mature firms</strong> — track both leading and lagging.
            </li>
            <li>
              <strong>L3 contribution</strong> — leading-indicator data from team level.
            </li>
            <li>
              <strong>HSE methodology</strong> — proactive safety management framework.
            </li>
            <li>
              <strong>HSG65</strong> — &quot;Managing for health and safety&quot; — HSE guidance
              underpinning the leading-indicator approach.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Report own near-misses</strong> — including embarrassing ones; signals
              reporting is normal.
            </li>
            <li>
              <strong>Prompt acknowledgement</strong> — thank the reporter; sets the tone.
            </li>
            <li>
              <strong>5-whys with team</strong> — collaborative analysis; teaches the method.
            </li>
            <li>
              <strong>Visible changes fed back</strong> — &quot;because of last week&apos;s report
              we changed X.&quot;
            </li>
            <li>
              <strong>Reporting volume tracked</strong> — leading indicator; rising = healthier
              culture.
            </li>
            <li>
              <strong>Celebrate reporting (the act)</strong> — at team meetings; small recognition.
            </li>
            <li>
              <strong>Protect reporters</strong> — from blame; from second-guessing by management.
            </li>
            <li>
              <strong>Reg 5 POCMR integration</strong> — feeds management cycle.
            </li>
            <li>
              <strong>Sustained over time</strong> — months and years; not a one-off campaign.
            </li>
            <li>
              <strong>Trend analysis</strong> — what categories are recurring? What does that tell
              us?
            </li>
            <li>
              <strong>Toolbox referencing</strong> — recent near-misses inform toolbox topics.
            </li>
            <li>
              <strong>Cross-team learning</strong> — share lessons across teams within the firm.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heinrich 1931</strong> — 1 major : 29 minor : 300 no-injury.
            </li>
            <li>
              <strong>Bird 1969</strong> — 1 serious : 10 minor : 30 property damage : 600
              near-misses.
            </li>
            <li>
              <strong>Qualitative principle valid</strong> — large base of low-consequence underlies
              apex of high-consequence.
            </li>
            <li>
              <strong>Specific numbers debated</strong> — industry / hazard / culture dependent.
            </li>
            <li>
              <strong>Modern critique</strong> — catastrophic events may have different precursors
              than routine injuries.
            </li>
            <li>
              <strong>Operational conclusion</strong> — near-miss reporting is leading indicator;
              complement with systemic risk register.
            </li>
            <li>
              <strong>Leverage point</strong> — invisible to injury-only metrics; visible to
              near-miss reporting.
            </li>
            <li>
              <strong>HSE position</strong> — proactive safety management includes both leading
              (near-miss) and lagging (injury) indicators.
            </li>
            <li>
              <strong>L3 supervisor application</strong> — drive near-miss reporting alongside
              engagement with systemic risk.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Management to supervisor</strong> — policy, RAMS, training schedule,
              resources.
            </li>
            <li>
              <strong>Supervisor to management</strong> — practical adequacy of policy; near-miss
              patterns; training gaps; resource needs.
            </li>
            <li>
              <strong>Safety committee</strong> — Safety Representatives and Safety Committees Regs
              1977; consultation mechanism.
            </li>
            <li>
              <strong>Reg 5 POCMR meetings</strong> — management cycle; supervisor contributes
              observations.
            </li>
            <li>
              <strong>Monthly H&amp;S report</strong> — supervisor contributions on team-level
              performance.
            </li>
            <li>
              <strong>Toolbox talk feedback</strong> — operative response noted; fed up.
            </li>
            <li>
              <strong>Health and Safety (Consultation with Employees) Regs 1996</strong> — applies
              where no recognised union.
            </li>
            <li>
              <strong>Bi-directional flow</strong> — both directions essential; one-way = policy
              drift.
            </li>
            <li>
              <strong>L3 craft</strong> — upward communication is part of the supervisor&apos;s
              role, not optional.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Structured rather than reactive</strong> — assessment before action;
              documented framework.
            </li>
            <li>
              <strong>Documented rather than verbal</strong> — paper trail underpins regulatory
              defence and incident response.
            </li>
            <li>
              <strong>Pro-active rather than waiting</strong> — near-miss reporting, proactive
              adjustment, anticipatory controls.
            </li>
            <li>
              <strong>Modelled rather than spoken</strong> — team learns from supervisor behaviour,
              not posters.
            </li>
            <li>
              <strong>Consistent rather than situational</strong> — same standards every day, every
              project.
            </li>
            <li>
              <strong>Protective rather than blame-allocating</strong> — no-blame reporting; Just
              Culture framework.
            </li>
            <li>
              <strong>Cross-regime integration</strong> — HASAWA / MHSWR / CDM / sector-specific
              regs operate together.
            </li>
            <li>
              <strong>Apprentice mentoring</strong> — teaches the next generation; equality
              dimension explicit.
            </li>
            <li>
              <strong>Customer-facing duty</strong> — Equality Act service-provider obligations;
              vulnerable adult awareness.
            </li>
            <li>
              <strong>Refusal protection</strong> — ERA s.44 + s.27 + s.26 (where applicable)
              protect raising concerns.
            </li>
            <li>
              <strong>Reg 5 POCMR cycle</strong> — Plan / Organise / Control / Monitor / Review —
              feeds back into continuous improvement.
            </li>
            <li>
              <strong>Sentencing Council framework</strong> — corporate and individual liability
              hooks; L3 supervisor aware of personal s.37 exposure.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Iterative why-questioning</strong> — typically 5 iterations from incident to
              root cause.
            </li>
            <li>
              <strong>Proximate to systemic</strong> — moves analysis from operative action to
              system permitting it.
            </li>
            <li>
              <strong>Worked example</strong> — &quot;tool dropped from height&quot; → why? slipped
              from belt → why? belt clip broken → why? not inspected → why? inspection schedule not
              set → why? PPE management procedure absent.
            </li>
            <li>
              <strong>Document the chain</strong> — record each why and answer for audit and
              learning.
            </li>
            <li>
              <strong>Feed into Reg 5 POCMR</strong> — root cause informs management cycle.
            </li>
            <li>
              <strong>10-minute toolbox practical</strong> — accessible for any team.
            </li>
            <li>
              <strong>Limitation</strong> — single linear chain; complex incidents need fishbone /
              fault tree.
            </li>
            <li>
              <strong>Validity check</strong> — the &quot;why&quot; chain should make sense in
              reverse: solving the root cause prevents the incident.
            </li>
            <li>
              <strong>L3 supervisor coaching</strong> — model once; coach team to apply; embed as
              standard practice.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Public Interest Disclosure Act 1998</strong> — amends ERA 1996 sections 43A-L.
            </li>
            <li>
              <strong>Qualifying disclosures</strong> — criminal, legal breach, miscarriage of
              justice, H&amp;S danger, environmental damage, concealment.
            </li>
            <li>
              <strong>Protected disclosure</strong> — must follow prescribed routes.
            </li>
            <li>
              <strong>Internal first</strong> — to employer.
            </li>
            <li>
              <strong>Prescribed person</strong> — HSE for H&amp;S; sector regulators for other
              matters.
            </li>
            <li>
              <strong>Wider disclosure</strong> — limited circumstances; usually after internal /
              prescribed inadequate.
            </li>
            <li>
              <strong>Protection from detriment</strong> — ERA s.47B.
            </li>
            <li>
              <strong>Protection from dismissal</strong> — ERA s.103A; automatic unfair dismissal.
            </li>
            <li>
              <strong>L3 supervisor application</strong> — serious systemic safety failures may
              attract PIDA.
            </li>
            <li>
              <strong>Complements ERA s.44</strong> — doesn&apos;t replace routine
              refusal-of-unsafe-work protection.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Individual identification</strong> — named person; nature of impairment.
            </li>
            <li>
              <strong>Designated buddies</strong> — primary + backup; trained; rota-aware.
            </li>
            <li>
              <strong>Refuge point</strong> — protected lobby on stair; two-way comms to building
              control.
            </li>
            <li>
              <strong>Equipment</strong> — evacuation chair, visual alert, vibrating pager, written
              maps.
            </li>
            <li>
              <strong>Communication path</strong> — refuge to fire-alarm panel or wardens.
            </li>
            <li>
              <strong>Re-entry sequence</strong> — controlled return after all-clear.
            </li>
            <li>
              <strong>Drill participation</strong> — confirms plan works; refines weaknesses.
            </li>
            <li>
              <strong>Review trigger</strong> — annual + needs change + layout change.
            </li>
            <li>
              <strong>GEEP for visitors</strong> — Generic plan for visitor categories with similar
              needs.
            </li>
            <li>
              <strong>Consultation</strong> — designed with the individual; their expertise on their
              own needs.
            </li>
            <li>
              <strong>Confidentiality</strong> — plan held appropriately; not broadcast across
              building.
            </li>
            <li>
              <strong>Multi-regime basis</strong> — Equality Act s.20 + RRFSO 2005 + MHSWR Reg 3.
            </li>
            <li>
              <strong>RRFSO 2005 Article 13</strong> — Fire safety arrangements; PEEPs are part of
              emergency arrangements.
            </li>
            <li>
              <strong>RRFSO 2005 Article 14</strong> — Emergency routes and exits; must accommodate
              disabled persons.
            </li>
            <li>
              <strong>Fire safety risk assessment</strong> — must consider disabled persons;
              document arrangements.
            </li>
            <li>
              <strong>Building Regulations Approved Document B</strong> — design consideration for
              accessible evacuation.
            </li>
            <li>
              <strong>Building Regulations Approved Document M</strong> — accessibility; intersects
              with evacuation design.
            </li>
            <li>
              <strong>Higher-Risk Residential Buildings</strong> — BSA 2022 + HRRB Regs 2023;
              particular attention to resident PEEPs.
            </li>
            <li>
              <strong>Grenfell aftermath</strong> — heightened focus on disabled-resident evacuation
        ...
        <RegsCallout
          ...
          meaning={
            <>
              s.4 lists the nine protected characteristics. Each attracts protection from direct /
              indirect discrimination, harassment and victimisation. The Act also imposes the
              reasonable adjustment duty in relation to disability specifically (s.20). The L3
              supervisor framing: the nine are the baseline; the firm&apos;s inclusive practice
              extends beyond compliance to genuine equality of opportunity. Memorise the nine; they
              come up in apprentice mentoring, customer interaction, and team management routinely.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Policy</strong> — specifically addressing sexual harassment; clear
              definitions; reporting routes.
            </li>
            <li>
              <strong>Training</strong> — all workers; recognition, prevention, reporting; refresher
              periodic.
            </li>
            <li>
              <strong>Reporting routes</strong> — multiple including confidential; accessible
              regardless of role.
            </li>
            <li>
              <strong>Investigation</strong> — prompt; proportionate; independent where appropriate.
            </li>
            <li>
              <strong>Victimisation protection</strong> — reporters and supporters protected from
              detriment.
            </li>
            <li>
              <strong>Risk assessment</strong> — periodic; identifies workplace-specific risks.
            </li>
            <li>
              <strong>Third-party action</strong> — customer / contractor / visitor harassment
              addressed.
            </li>
            <li>
              <strong>EHRC technical guidance</strong> — sets out expected reasonable steps.
            </li>
            <li>
              <strong>Tribunal uplift</strong> — up to 25% compensation increase on failure to
              comply.
            </li>
            <li>
              <strong>Sector-specific risk</strong> — male-dominated trades attract heightened risk;
              require enhanced response.
            </li>
            <li>
              <strong>L3 supervisor role</strong> — implements policy at team level; intervenes
              promptly; models respectful behaviour.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Regular 1-to-1</strong> — weekly; covers technical + workplace climate.
            </li>
            <li>
              <strong>Micro-aggression awareness</strong> — name patterns; intervene without making
              apprentice the focus.
            </li>
            <li>
              <strong>Development allocation</strong> — interesting tasks fairly distributed;
              tracked.
            </li>
            <li>
              <strong>Network effect counter</strong> — explicit allocation rather than by
              familiarity.
            </li>
            <li>
              <strong>College / training body engagement</strong> — where issues persist; raise
              formally.
            </li>
            <li>
              <strong>Apprentice voice</strong> — channels for raising concerns; protected from
              detriment.
            </li>
            <li>
              <strong>Trade-wide retention</strong> — under-represented group attrition is a
              measurable industry problem.
            </li>
            <li>
              <strong>Visible role modelling</strong> — apprentices observe supervisor behaviour;
              learn what&apos;s acceptable.
            </li>
            <li>
              <strong>Reasonable adjustment proactive</strong> — identify needs early; arrange
              without making a fuss.
            </li>
            <li>
              <strong>Documentation</strong> — mentoring conversations, adjustments, incidents
              recorded.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>At-risk behaviour</strong> — drift to lower standard without conscious risk
              decision; coach.
            </li>
            <li>
              <strong>Reckless behaviour</strong> — conscious disregard of substantial risk;
            ...
            <li>
              <strong>Decision-quality focus</strong> — not outcome; same incident can categorise
              differently.
            </li>
            <li>
              <strong>Investigation</strong> — gather facts on operative&apos;s knowledge, intent,
              decision process.
            </li>
            <li>
              <strong>Discipline allocation</strong> — most near-misses are honest error / at-risk;
              reckless is rare.
            </li>
            <li>
              <strong>System response</strong> — improve controls, training, equipment, procedure.
            </li>
            <li>
              <strong>Coaching</strong> — restore standard; reinforce why it matters.
            </li>
            <li>
              <strong>Discipline</strong> — proportionate to category; documented; consistent across
              team.
            </li>
            <li>
              <strong>Encourages reporting</strong> — honest error genuinely safe to report.
            </li>
            <li>
              <strong>Compatible with Reg 5 POCMR</strong> — feeds management cycle.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Service-provider duty</strong> — Equality Act 2010 Part 3; reasonable
              adjustment for customers.
            </li>
            <li>
              <strong>Communication adjustment</strong> — written / sign / interpreter where
              reasonable.
            </li>
            <li>
              <strong>Scheduling flexibility</strong> — around medical appointments, carer
              arrangements.
            </li>
            <li>
              <strong>Additional explanation</strong> — for customers with learning difficulties;
              check understanding.
            </li>
            <li>
              <strong>Accessible work practice</strong> — accommodate mobility impairment; minimise
              disruption.
            </li>
            <li>
              <strong>Vulnerable adult</strong> — Care Act 2014 definition; safeguarding referral
              route.
            </li>
            <li>
              <strong>Safeguarding concern</strong> — referral via firm policy; document; protect
              customer.
            </li>
            <li>
              <strong>Tone and pace</strong> — patience; respect; the customer is not the problem.
            </li>
            <li>
              <strong>Written follow-up</strong> — confirms what was discussed; supports
              understanding.
            </li>
            <li>
              <strong>Reputation effect</strong> — inclusive practice is part of the firm&apos;s
              brand.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Content rotation</strong> — hazards, near-misses, regs, inclusive practice,
              wellbeing, refreshers.
            </li>
            <li>
              <strong>Frequency</strong> — weekly typical; daily high-risk; site-specific on
              arrival.
            </li>
            <li>
              <strong>Format</strong> — short, discussion, specific, signed.
            </li>
            <li>
              <strong>Preparation</strong> — 24 hours ahead; relevant to today; sources cited.
            </li>
            <li>
              <strong>Team involvement</strong> — questions; contributions; not just supervisor
              talking.
            </li>
            <li>
              <strong>Tone</strong> — collegial; respectful; not policing.
            </li>
            <li>
              <strong>Takeaway</strong> — clear and actionable.
            </li>
            <li>
              <strong>Documentation</strong> — attendance signed; topic recorded; contributes to Reg
              16 / safety system evidence.
            </li>
            <li>
              <strong>Annual programme</strong> — designed deliberately rather than ad-hoc.
            </li>
            <li>
              <strong>Culture lever</strong> — cumulative effect over 50 per year is substantial.
            </li>
            <li>
              <strong>Inclusive content</strong> — Equality Act / Worker Protection Act 2023 topics
              included.
            </li>
            <li>
              <strong>Mental health</strong> — referenced; reduces stigma; signposts support.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Direct (s.13)</strong> — &quot;we don&apos;t want a female apprentice on this
              contract&quot;; less favourable treatment because of characteristic.
            </li>
            <li>
              <strong>Indirect (s.19)</strong> — apparently neutral practice (e.g. fitness test)
              disadvantaging protected group disproportionately.
            </li>
            <li>
              <strong>Harassment (s.26)</strong> — banter, jokes, comments targeting characteristic
              creating hostile environment.
            </li>
            <li>
              <strong>Victimisation (s.27)</strong> — detriment for raising / supporting complaint,
              giving evidence.
            </li>
            <li>
              <strong>Combinations</strong> — single incident can involve multiple types (e.g.
              harassment + direct).
            </li>
            <li>
              <strong>Justification</strong> — only indirect potentially justifiable (proportionate
              means to legitimate aim); direct rarely; harassment never.
            </li>
            <li>
              <strong>Burden of proof</strong> — shifts to employer once prima facie case
              established.
            </li>
            <li>
              <strong>Tribunal time limit</strong> — typically 3 months less one day from act
              complained of; extension possible.
            </li>
            <li>
              <strong>ACAS Early Conciliation</strong> — mandatory step before tribunal claim.
            </li>
            <li>
              <strong>Vicarious liability</strong> — employer liable for employee acts in course of
              employment; statutory defence requires reasonable preventive steps.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Industry context</strong> — elevated suicide rates; multiple drivers;
              under-reported.
            </li>
            <li>
              <strong>Notice signs</strong> — withdrawal, irritability, performance change,
              expressions of hopelessness.
            </li>
            <li>
              <strong>Open conversation</strong> — &quot;how are you really doing?&quot; with
              willingness to listen.
            </li>
            <li>
              <strong>Signposting</strong> — firm EAP; GP; Mates in Mind; Samaritans; Construction
              Industry Helpline.
            </li>
            <li>
              <strong>Stigma reduction</strong> — talk openly; model that wellbeing is part of
              safety.
            </li>
            <li>
              <strong>Confidentiality</strong> — operative&apos;s information held appropriately.
            </li>
            <li>
              <strong>Equality Act application</strong> — mental health as disability where
              substantial adverse effect.
            </li>
            <li>
              <strong>Reasonable adjustment</strong> — flexible hours, modified workload, role
              allocation.
            </li>
            <li>
              <strong>Team norms</strong> — supervisor modelling shifts what&apos;s acceptable to
              discuss.
            </li>
            <li>
              <strong>Crisis response</strong> — recognise risk; act promptly; emergency services if
              imminent.
            </li>
            <li>
              <strong>Mates in Mind</strong> — construction-specific mental health charity.
            </li>
            <li>
              <strong>Construction Industry Helpline</strong> — 0345 605 1956; charity-run; 24/7.
            </li>
            <li>
              <strong>Lighthouse Construction Industry Charity</strong> — practical support;
              financial assistance; counselling.
            </li>
            <li>
              <strong>Apprentice-specific support</strong> — younger workforce; isolation risk;
              supervisor especially attentive.
            </li>
            <li>
              <strong>Suicide-by-occupation data</strong> — ONS publication; construction elevated;
              reflects industry context.
            </li>
            <li>
              <strong>Toolbox topic content</strong> — wellbeing covered alongside hazards; reduces
              stigma.
            </li>
            <li>
              <strong>Mental Health First Aid</strong> — trained mental health first aiders
              alongside physical first aiders.
            </li>
            <li>
              <strong>Reasonable adjustment scope</strong> — mental health conditions as Equality
              Act disability where substantial.
            </li>
            <li>
              <strong>Wellbeing as safety</strong> — fatigue, distress impair safety performance;
              integrated framing.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Standard onboarding</strong> — adjustment question asked of every new starter.
            </li>
            <li>
              <strong>Standard equipment</strong> — ergonomic / accessibility variants available.
            </li>
            <li>
              <strong>Standard scheduling</strong> — flexibility built in where reasonably
              practicable.
            </li>
            <li>
              <strong>Standard communication</strong> — alternatives offered (written, visual,
              simplified).
            </li>
            <li>
              <strong>Disclosure handling</strong> — confidential; respect operative&apos;s framing.
            </li>
            <li>
              <strong>Consultation</strong> — work with the operative; their expertise on their own
              needs.
            </li>
            <li>
              <strong>Implementation timeframe</strong> — reasonable; without delay; documented.
            </li>
            <li>
              <strong>Review</strong> — adjustments revisited as needs change.
            </li>
            <li>
              <strong>Documentation</strong> — normal HR records; not a special file.
            </li>
            <li>
              <strong>Cost / disruption / effectiveness</strong> — the &quot;reasonable&quot; test
              factors all three.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Formal training</strong> — C&amp;G 2365 / 2357 / AM2 or AM2S.
            </li>
            <li>
              <strong>Accumulated experience</strong> — post-qualification site time across varied
              contexts.
            </li>
            <li>
              <strong>Supervised development</strong> — mentoring; complex projects; incident
              learning.
            </li>
            <li>
              <strong>EAS / ECS framework</strong> — recognised competence cards.
            </li>
            <li>
              <strong>Gold card</strong> — L3 supervisor competence.
            </li>
            <li>
              <strong>EAWR Reg 16</strong> — technical knowledge or supervision necessary.
            </li>
            <li>
              <strong>Self-awareness</strong> — competent to lead what; need senior supervision for
              what.
            </li>
            <li>
              <strong>Development plan</strong> — what competence to build this year.
            </li>
            <li>
              <strong>L2 / apprentice supervision</strong> — L3 IS the appropriate supervision for
              most electrical work.
            </li>
            <li>
              <strong>Refresher training</strong> — BS 7671 amendments; H&amp;S regs updates.
            </li>
            <li>
              <strong>Cross-discipline</strong> — gas safe / refrigeration / data / fire alarm —
              knowing limits prevents overreach.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re L3 supervising a team that includes a new apprentice who is Muslim. You
              notice over several weeks that two other operatives make repeated jokes referencing
              the apprentice&apos;s religion — comments about fasting during Ramadan, remarks about
              prayer breaks, mock-pronunciation of Arabic phrases. The apprentice doesn&apos;t
              complain explicitly but their participation in team conversations has reduced;
              they&apos;ve started taking lunch alone. The two operatives are senior and
              well-regarded technically; one is your peer; one was your trainer ten years ago.
            </>
          }
          whatToDo={
            <>
              This is harassment under Equality Act s.26 — unwanted conduct related to religion
              creating an intimidating / hostile environment for the apprentice. Whether the
              operatives intend it as banter is irrelevant; the s.26 test is the effect. Your duty
              as L3 is clear regardless of the operatives&apos; seniority or your personal
              relationship with them. (1) Intervene at next instance — name it. &quot;That&apos;s
              harassment under the Equality Act. It stops now.&quot; Calm, clear, not theatrical.
              (2) Speak privately with each operative — explain the regulatory position, the impact
              you&apos;ve observed on the apprentice, the firm&apos;s vicarious liability. Their
              seniority doesn&apos;t exempt them; if anything it raises their responsibility. (3)
              Check in with the apprentice — privately, supportively. Make clear you&apos;ve seen
              the behaviour, you&apos;ve intervened, you&apos;ll continue to. Don&apos;t require the
              apprentice to confirm or complain; the duty is yours not theirs. (4) Document — what
              you observed, what you said, what was said back, dates. (5) Escalate to firm&apos;s HR
              / contracts manager if behaviour recurs after your intervention. Vicarious liability
              is the firm&apos;s; failure to act is the firm&apos;s exposure. (6) Reflect — this is
              a culture issue; what in the team norms permitted this to start? What needs to change?
              Toolbox topic on respectful workplace behaviour referencing Worker Protection Act 2023
              duty. Don&apos;t pretend the issue is one-off; address the culture.
            </>
          }
          whyItMatters={
            <>
              This scenario captures the most common Equality Act issue an L3 supervisor faces —
              banter that targets characteristics, perpetrated by senior colleagues who don&apos;t
              see it as harassment but whose behaviour creates hostile environment for less powerful
              team members. The legal framework is unambiguous: s.26 applies; the firm is
              vicariously liable; the Worker Protection Act 2023 imposes positive duty; the
              apprentice is protected from detriment for raising or for the L3 raising on their
              behalf. The supervisor judgement is whether to act; the regulatory framework is the
              basis for acting. Failure to act condones the behaviour and extends the firm&apos;s
              liability. Acting decisively, even with senior colleagues, models the standard the
              team will adopt. This is the L3 supervisor&apos;s inclusive-practice moment — the test
              of whether the inclusive principles operate or whether they sit on a poster while the
              operatives drift.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Statutory Code under TULRCA s.207</strong> — courts and tribunals must take
              into account.
            </li>
            <li>
              <strong>Formal complaint</strong> — written grievance; signposted by supervisor.
            </li>
            <li>
              <strong>Investigation</strong> — prompt; proportionate; impartial.
            </li>
            <li>
              <strong>Meeting</strong> — with complainant; opportunity to put case; companion right.
            </li>
            <li>
              <strong>Decision</strong> — communicated in writing; reasoned.
            </li>
            <li>
              <strong>Appeal</strong> — right of appeal to higher level; impartial appeal panel.
            </li>
            <li>
              <strong>Compensation adjustment</strong> — up to 25% up or down for unreasonable
              failure to follow Code.
            </li>
            <li>
              <strong>Supervisor role</strong> — first escalation point; intervention authority;
              protect complainant.
            </li>
            <li>
              <strong>Confidentiality</strong> — appropriate; not absolute; informed of duty to
              disclose for investigation.
            </li>
            <li>
              <strong>Victimisation protection</strong> — complainant protected from detriment
              during process.
            </li>
            <li>
              <strong>
              ...
              — now consolidated in Equality Act 2010.
            </li>
          </ul>
        </ConceptBlock>
        ...
        />
        <Quiz
          title="Equality Act + near-miss culture - knowledge check"
