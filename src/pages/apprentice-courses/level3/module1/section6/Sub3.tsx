...
const DESCRIPTION =
  'L3 Approved Documents B (fire), L (energy efficiency), P (electrical safety) interactions with electrical work in dwellings.';

const checks = [
  {
    id: 'l3-m1-s6-sub3-p',
    question: 'Approved Doc P scope?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Approved Doc P = electrical safety in dwellings. Notifiable work must be done by a Competent Person Scheme registered installer OR notified to building control; Wales has equivalent provisions.',
  },
  {
    id: 'l3-m1-s6-sub3-b',
    question: 'How does Approved Doc B affect electrical work?',
    options: [
    ...
    correctIndex: 0,
    explanation:
      'Approved Doc B reaches deep into electrical design and installation — emergency lighting (BS 5266), fire detection (BS 5839), cable CPR class, penetrations through fire-rated walls and floors, EV charging fire considerations and smoke-control electrical systems.',
  },
  {
    id: 'l3-m1-s6-sub3-l',
    question: 'How does Approved Doc L affect electrical work?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'Approved Doc L drives the electrification of heating and the renewable / low-carbon transition — heat pumps (F-Gas + electrical), LED lighting, BMS controls, EV charging infrastructure and on-site renewables (solar PV, batteries). Major source of electrical work.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question: "What's the legal status of Approved Documents?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Approved Documents are guidance; Building Regulations 2010 is the statute. Compliance with an Approved Document is strong evidence of Building Regs compliance — the safe-harbour relationship, same as BS 7671 to EAWR.',
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'New circuits, CU replacement and special-locations work are all notifiable (kitchens were removed from the list in 2013). Notifiable work must be done by a Competent Person Scheme registered installer (NICEIC, NAPIT, ELECSA, Stroma etc) OR notified to building control.',
  },
  {
    id: 3,
    question: 'What does CPR (Construction Products Regulation) classification do for cables?',
    options: [
    ...
    correctAnswer: 3,
    explanation:
      'CPR class drives cable selection in fire-relevant applications; Approved Doc B may require a minimum classification in specific applications. Cable manufacturers mark the CPR class on the sheath.',
  },
  {
    id: 4,
    ...
    correctAnswer: 0,
    explanation:
      'Cable trays, conduit and individual cables passing through fire walls all require appropriate fire-stopping per Approved Doc B. Fire stopping is a routine but often-missed requirement. Inspectors check; failures are a common cause of fire spread.',
  },
  {
    id: 5,
    question: 'How does Approved Doc L drive heat pump work?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Heat pumps require electrical infrastructure (single-phase 32A+ or three-phase), F-Gas certified refrigerant work and controls integration. Heat pump rollout is a major trend driven by Approved Doc L (and the Future Homes Standard), with major electrical trade impact.',
  },
  {
    id: 6,
    question: 'When does the L3 need awareness of these Approved Documents?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Doc P is always relevant on a domestic install; Doc L (energy) and Doc B (fire) apply to most residential refurbishment; Doc B applies on commercial work where fire-safety circuits are involved. Awareness widens as the market shifts to heat pumps and EV charging. L3 awareness is operational, not academic.',
  },
  {
    id: 7,
    question: 'Are Approved Documents the same in Wales / Scotland / NI?',
    options: [
    ...
    correctAnswer: 3,
    explanation:
      'England has Approved Documents; Wales has its own equivalent set (similar but not identical); Scotland has Building Standards Technical Handbooks (a different framework); Northern Ireland has its own. Always check the local framework before relying on a specific document.',
  },
  {
    id: 8,
    question: 'How does Approved Doc P interact with Competent Person Schemes?',
    options: [
    ...
    correctAnswer: 0,
    explanation:
      'CPS registration (NICEIC, NAPIT, ELECSA, Stroma etc) is the practical route to compliance with Approved Doc P notifiable work; building control notification is the alternative.',
  },
];

const faqs = [
  {
    question: 'Is BS 7671 part of the Approved Documents?',
    answer:
      'No — BS 7671 is the IET wiring regulations (BSI standard). Approved Doc P references BS 7671 as the technical basis for safe electrical installation. Compliance with BS 7671 + Approved Doc P together discharges Building Regs electrical safety requirements.',
  },
  {
    question: 'What is the Future Homes Standard?',
    answer:
      'Government direction setting more demanding energy efficiency targets for new homes (heat pumps, no gas, low-carbon). Approved Doc L being progressively updated to align. Driving major electrification of heating sector.',
  },
  {
    question: 'Does Approved Doc P apply to all electrical work?',
    answer:
      'No — Approved Doc P specifically covers dwellings (and some shared parts). Commercial work governed by Building Regs more broadly + other guidance.',
  },
  {
    question: 'What is a thermal element under Approved Doc L?',
    answer:
      'A wall, floor or roof — element separating conditioned from unconditioned space. Energy efficiency requirements apply when these are altered. Affects insulation requirements and may indirectly drive electrical work (recessed luminaires require fire / thermal considerations).',
  },
  {
    question: 'Are EV chargers covered by specific Approved Documents?',
    answer:
      'Approved Doc S (Infrastructure for charging electric vehicles) introduced 2021 — requirements for new dwellings and non-residential buildings to provide EV charge points. Plus Approved Doc B fire considerations + BS 7671 Section 722 for the install itself.',
  },
  {
    question: 'How do Approved Documents update?',
    answer:
      'Periodically by government. Typically 5-10 year cycles for major revisions; interim updates and amendments more frequent. Approved Doc B has been updated multiple times post-Grenfell. Always check the current version.',
  },
  {
    question: 'Which Approved Document covers commercial / non-domestic electrical safety?',
    answer:
      'Approved Document P specifically covers dwellings. Non-domestic electrical safety is governed by Building Regulations requirement L1 / B1-B5 / and BS 7671 directly. EAWR 1989 applies as the workplace safety statute. There is no &quot;Approved Doc P for commercial&quot; — the framework operates differently.',
  },
  {
    question: 'How does Approved Doc M (Access to and use of buildings) affect electrical work?',
    answer:
      'Approved Doc M sets accessibility standards. Affects switch / socket heights, accessible-toilet electrical requirements, evacuation lift specifications, induction loop systems, accessible parking EV charger placement. Often considered alongside Doc P and Doc B.',
  },
  {
    question: 'Are Approved Documents tested in C&G assessments?',
    answer:
      'Conceptually yes — the relationship between Building Regulations and Approved Documents, the notifiable work framework under Doc P, the safe-harbour relationship to statute. The detailed content is reference material rather than memorisation.',
  },
  {
    question: 'What if the Approved Document is silent on something I need to do?',
    answer:
      'Apply BS 7671 plus relevant BS / EN standards plus manufacturer instructions plus industry good practice. The Approved Document is one route to Building Regs compliance — silence does not block the work, but it does require the contractor to demonstrate equivalent performance through other recognised standards.',
  },
];
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 6 · Subsection 3"
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'Remember from Section 1.7 - Approved Documents support Building Regs. At L3 you understand how B (fire) / L (energy) / P (electrical safety) interact with the work you do.'
          }
        </p>
        ...
        <ConceptBlock
          title="Notifiable work and Competent Person Schemes"
          plainEnglish="Approved Doc P sets electrical safety requirements for dwellings (England). Notifiable work (new circuits, consumer unit replacements, work in special locations) must be done by Competent Person Scheme registered installer OR notified to local building control."
          onSite="Most domestic electrical contractors are CPS registered (NICEIC, NAPIT, ELECSA, Stroma etc). The CPS issues the certificate and notifies building control. Without CPS registration, every notifiable job needs separate building-control notification with fees."
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Any addition or alteration to existing circuits in a special location (bathrooms,
              swimming pools, outdoor including gardens, sauna).
            </li>
            <li>(Kitchens were removed from notifiable list in 2013.)</li>
            <li>
              Notifiable work must be done by Competent Person Scheme installer or notified to
              building control before work starts.
            </li>
            <li>
              Non-notifiable work (most general repairs and replacements) doesn&apos;t require
              notification but still must comply with BS 7671.
            </li>
          </ul>
        </ConceptBlock>

        <RegsCallout
          source="Building Regulations 2010 - Approved Document P (England)"
          clause={
            <>
          ...
          meaning={
            <>
              The Approved Doc P statement of intent. Implemented through reference to BS 7671 + the
              notifiable work + competent person regime. Practical compliance route is BS 7671 + CPS
              registration.
            </>
          }
          cite="Source: Building Regulations 2010 (SI 2010/2214), Approved Document P (England) - published by MHCLG / DLUHC."
        />
        ...
        <ConceptBlock
          title="Fire safety reaches into electrical design"
          ...
          onSite="Post-Grenfell, Approved Doc B has been substantially updated. Current version (and any pending updates) should be referenced for any fire-safety-relevant work."
        >
          <p>Approved Doc B touchpoints for electrical work:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Emergency lighting design (BS 5266) - escape route illumination.</li>
            <li>
              Fire detection and alarm system design (BS 5839) - residential and non-residential.
            </li>
            ...
            <li>
              EV charging fire considerations - charge point location, separation, ventilation.
            </li>
        ...
        <ConceptBlock
          title="The electrification of heating"
          plainEnglish="Approved Doc L (Conservation of fuel and power - Volume 1 dwellings, Volume 2 other buildings) drives energy efficiency. The Future Homes Standard direction makes heat pumps standard for new builds. Significant electrical trade impact."
          onSite="L3 awareness on Approved Doc L: heat pump installs (electrical + F-Gas), LED retrofit, BMS controls, EV charging infrastructure, on-site renewables (PV, battery storage). Major and growing source of electrical work."
        >
        ...
        <ConceptBlock
          title="The new charging-infrastructure document"
          plainEnglish="Approved Document S (Infrastructure for charging electric vehicles) was introduced in 2021. Sets requirements for new dwellings, residential buildings and most non-residential buildings to provide EV charging or cabling infrastructure. Drives an entirely new category of electrical contractor work alongside Approved Doc P installation requirements and Doc B fire considerations."
          onSite="L3 supervisor on a new build or major refurbishment: Doc S sets the EV charging baseline; BS 7671 Section 722 governs the install detail; Doc B drives fire considerations (location, separation, ventilation); DNO notification may be required for higher-rated installs."
        >
        ...
        <RegsCallout
          source="Building Regulations 2010 — Approved Document B Volume 1 (Dwellings)"
          clause={
            <>
              &quot;Where a wall or floor is required to provide compartmentation, any opening for
              the passage of a pipe, duct, conduit, cable or chimney, or for any other reason,
              should be... fire stopped to maintain the integrity of the compartment.&quot;
            </>
          }
          meaning={
            <>
              The fire stopping requirement. Cable penetrations through fire-rated walls / floors /
              ceilings must be fire stopped using approved products (intumescent collar, fire batt,
              fire-rated sealant). Standard requirement on every penetration; routine inspector
              check; common EICR coding finding when missed.
            </>
          }
          cite="Source: Building Regulations 2010 (SI 2010/2214), Approved Document B Volume 1 — published by MHCLG / DLUHC."
        />

        <ConceptBlock
          title="Building Control routes — full plans, building notice, CPS"
          plainEnglish="Three routes to Building Control compliance: (1) Full Plans application — design submitted in advance, approved before work; (2) Building Notice — work proceeds, inspections at key stages; (3) Competent Person Scheme — self-certification by registered installer for notifiable work in scope. CPS route is the practical default for domestic electrical work; commercial work more often via Full Plans / BN through main contractor."
          onSite="L3 supervisor needs to know which route applies. Domestic electrical work via CPS (firm registration handles); building work alongside electrical (extension, conversion) via Full Plans / BN (main contractor handles). Where CPS does not apply (e.g. firm not registered), separate Building Control notification with fees is required."
        >
          <p>Three Building Control routes:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Full Plans</strong> — design submitted in advance, formal approval, inspection
              schedule.
            </li>
            <li>
              <strong>Building Notice</strong> — work proceeds with inspections at key stages, no
              advance approval.
            </li>
            <li>
              <strong>Competent Person Scheme</strong> — self-certification by registered installer
              for notifiable work in scope.
            </li>
            <li>CPS schemes for electrical work: NICEIC, NAPIT, ELECSA, Stroma.</li>
            <li>
              CPS issues Electrical Installation Certificate plus Building Regs compliance
              certificate to homeowner.
            </li>
            <li>CPS notifies local authority on the firm&apos;s behalf.</li>
            <li>
              Where CPS does not apply, Building Control notification with fees (typically £150-£500
              per notification).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock
          title="Approved Doc 7 — materials and workmanship"
          plainEnglish="Approved Document 7 (Materials and workmanship) is the cross-cutting document setting the general standard — materials should be appropriate for the circumstances; workmanship should be adequate. Underlies all other Approved Documents. The L3 supervisor reflex: BS standards, manufacturer instructions, industry good practice all evidence Doc 7 compliance."
          onSite='The Doc 7 framing matters when defending choices on inspection: "the cable selection / installation method / fixing was per BS 7671 / manufacturer instruction / industry practice — Doc 7 satisfied". Without that framing, "just because" choices are weak under scrutiny.'
        >
        ...
        <ConceptBlock
          title="The safe-harbour relationship and how it works"
          plainEnglish="Approved Documents are non-statutory guidance; the Building Regulations 2010 are the statute. The safe-harbour relationship: compliance with the Approved Document is strong evidence (not absolute) of compliance with the Building Regs. A different approach is permitted if it achieves the regulation's objective at least as well — but the burden falls on the designer / contractor to show it does. Same relationship as BS 7671 to EAWR Reg 4."
          onSite='L3 supervisor framing on inspection: "we followed Approved Doc P / B / L per the published guidance — Building Regs satisfied" is the standard defence. Where a non-Approved-Document approach is used, documentation of equivalent performance is required. The safer practice is to follow the published Approved Document unless there is strong technical reason to depart.'
        >
          <p>Safe-harbour mechanics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Building Regulations 2010 = statute; Approved Documents = guidance.</li>
            <li>
              Compliance with Approved Document = strong evidence of Building Regs compliance.
            </li>
            <li>
              Alternative approaches permitted if they achieve the regulation&apos;s objective at
              least as well.
            </li>
        ...
        <RegsCallout
          source="Building Regulations 2010 — Schedule 1, Requirement L1 (Conservation of fuel and power)"
          clause={
            <>
              &quot;Reasonable provision shall be made for the conservation of fuel and power in
              buildings by — (a) limiting heat gains and losses... (b) providing fixed building
              services which — (i) are energy efficient...&quot;
            </>
          }
          meaning={
            <>
              The energy efficiency requirement in the Building Regs schedule. Approved Document L
              gives the practical compliance route. Drives heat pump rollout, LED retrofit, BMS
              controls, EV charging infrastructure, on-site renewables — major source of electrical
              trade work over coming decade.
            </>
          }
          cite="Source: Building Regulations 2010 (SI 2010/2214), Schedule 1, Requirement L1."
        />

        <ConceptBlock
          title="Devolved nation frameworks — quick reference"
          plainEnglish="Approved Documents are England-specific. Wales has its own equivalent set (similar but not identical, published by Welsh Government); Scotland has Building Standards Technical Handbooks under Building (Scotland) Regulations 2004 (different framework with mandatory compliance route); Northern Ireland has Building Regulations (Northern Ireland) 2012 with Technical Booklets."
          onSite="L3 supervisor on cross-border work: check the local framework before quoting Approved Doc clauses. Most technical content aligns broadly but specifics differ — notification regimes, prescribed self-certification schemes, fire-safety classifications, energy-efficiency targets all have devolved variations."
        >
          <p>Devolved nation frameworks:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>England</strong> — Building Regulations 2010 + Approved Documents A-S.
            </li>
            <li>
              <strong>Wales</strong> — Welsh Building Regulations + Welsh Approved Documents.
            </li>
            <li>
              <strong>Scotland</strong> — Building (Scotland) Regulations 2004 + Technical Handbooks
              (mandatory framework).
            </li>
            <li>
              <strong>Northern Ireland</strong> — Building Regulations (NI) 2012 + Technical
              Booklets.
            </li>
        ...
        <CommonMistake
          title="Skipping fire stopping after running cables through compartmentation"
          whatHappens={
            <>
              Cables run through fire-rated wall; penetration not fire-stopped; fire
              compartmentation broken; risk of fire spread between compartments. Inspector finds
              during EICR; coded; remedial required. In HRRBs this is safety-case-significant; in
              domestic still a Building Regs / Approved Doc B compliance issue.
            </>
          }
          doInstead={
            <>
              Fire-stop every penetration through fire-rated elements. Use approved fire-stopping
              products (intumescent collar, fire batt etc); record the work. Standard cable run
              discipline.
            </>
          }
        />
        ...
        <Scenario
          title="Heat pump install on a domestic property"
          situation={
            <>
              Customer wants a heat pump fitted to replace gas boiler. Your firm has been engaged
              for the electrical infrastructure. The pump itself will be installed by an F-Gas
              certified contractor. The customer assumes \"you can just do it&quot;.
            </>
          }
          whatToDo={
            <>
              Apply Approved Doc framework. Doc L drives the energy efficiency case (heat pump =
              compliant); Doc P covers electrical safety in dwellings (likely involves new circuit =
              notifiable work, CPS registration covers); Doc B may apply if heat pump location
              affects fire compartmentation (boilers were sometimes in fire-rated cupboards). Doc S
              may apply if EV charge point being added at same time. Brief the customer: scope of
              electrical work, notification under Approved Doc P, F-Gas certified contractor for
              refrigerant work, expected commissioning sequence. Confirm CPS registration covers;
              produce notifiable cert via CPS. Coordinate with F-Gas contractor; integrate
              sequencing.
            </>
          }
          whyItMatters={
            <>
              Heat pump installs are a fast-growing trade area driven by Approved Doc L. Multiple
              Approved Documents may be relevant on a single job. The L3 supervisor identifies the
              framework and ensures compliance routes are followed. Customer&apos;s &quot;just do
              it&quot; framing skips the notification + competent contractor coordination
              that&apos;s mandatory.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>New dwellings with associated parking</strong> — minimum 1 chargepoint per
              dwelling, or cable route where chargepoint not currently installed.
            </li>
            <li>
              <strong>Renovated dwellings (major renovation) with parking</strong> — same as new
              where parking provision is being addressed.
            </li>
            <li>
              <strong>New non-residential buildings with parking</strong> — minimum 1 chargepoint
              per 10 spaces; cable route to all spaces.
            </li>
            <li>
              <strong>Renovated non-residential with parking &gt;10 spaces</strong> — cable route to
              1 in 5 spaces minimum.
            </li>
            <li>
              <strong>Mixed-use</strong> — provision proportionate to dwellings and non-residential
              elements.
            </li>
            <li>
              <strong>BS 7671 Section 722</strong> — technical requirements for the EV charging
              installation itself; integrates with Approved Doc S provision requirement.
            </li>
            <li>
              <strong>OCPP compatibility, OZEV-eligible products</strong> — for grant-funded
              installations; market-shaped by funding criteria.
            </li>
            <li>
              <strong>Load management considerations</strong> — site capacity may require active
              load management at higher chargepoint counts.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Accessible-toilet electrical requirements — emergency pull cord, alarm reset, light
              controls.
            </li>
            <li>
              Evacuation lift specifications — BS EN 81-76; safe evacuation of mobility-impaired
              residents.
            </li>
            <li>
              Induction loop systems — for residents with hearing aids; counter / reception areas.
            </li>
            ...
            <li>
              M4(1) visitable, M4(2) accessible and adaptable, M4(3) wheelchair user dwellings.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Identify fire-rated elements (compartmentation walls, fire-rated ceilings, fire-rated
              floors) before penetrating.
            </li>
            <li>Plan cable routes to minimise penetrations where possible.</li>
            <li>
              Use approved fire-stopping products — intumescent collar, fire batt, fire sealant,
              fire pillows.
            </li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;Where a wall or floor is required to provide compartmentation, any opening for
              the passage of a pipe, duct, conduit, cable or chimney, or for any other reason,
              should be — (a) provided with a fire-stopping system that has been tested to the
              relevant standard...; and (b) installed in accordance with the manufacturer&apos;s
              installation instructions to maintain the integrity of the compartmentation.&quot;
            </>
          }
          meaning={
            <>
              The fire-stopping requirement at the cable-installation level. Tested system;
              manufacturer installation instructions; maintain compartment integrity. The wording is
              similar across Volume 1 and Volume 2 with adjustments for residential context. Routine
              cable runs through fire-rated elements need stopping; the standard expectation is that
              competent contractors do this as part of normal practice without needing prompting.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Compliance with BS 7671 + Approved Doc P discharges Building Regs P1 requirement.
            </li>
            <li>
              BS 7671:2018 with Amendment 1 (2020), Amendment 2 (2022), Amendment 3 (2024),
              Amendment 4 (2026).
            </li>
            <li>
              Amendment 4 includes AFDD requirements, TN-C-S (PNB) provisions, schedule of test
              changes, model forms.
            </li>
            <li>
              Post-Grenfell direction reflected in 2026 amendment — stronger fire-safety
              integration.
            </li>
            <li>
              L3 supervisor needs current edition plus amendments — not the edition learned in
              training years ago.
            </li>
            <li>CPD record retention covers competence maintenance through scheme requirements.</li>
            <li>
              Section 700-series in BS 7671 covers special installations and locations — including
              dwellings, bathrooms, swimming pools, agricultural, hazardous, marinas, exhibitions,
              EV charging (S722), photovoltaic (S712), etc.
            </li>
            <li>
              BS 7671 is itself a BSI standard — used as evidence of EAWR Reg 4 compliance for
              installation safety.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>B1 — Means of warning and escape</strong> — fire detection / alarm + emergency
              lighting.
            </li>
            <li>
              <strong>B2 — Internal fire spread (linings)</strong> — wall and ceiling materials
              including conduit / containment.
            </li>
            <li>
              <strong>B3 — Internal fire spread (structure)</strong> — compartmentation;
              fire-stopping requirements.
            </li>
            <li>
              <strong>B4 — External fire spread</strong> — external wall systems; post-Grenfell
              tightening.
            </li>
            <li>
              <strong>B5 — Access and facilities for the fire service</strong> — firefighters&apos;
              lifts, fire mains, hydrants.
            </li>
            <li>
              <strong>L1 — Conservation of fuel and power (new dwellings)</strong> — heat pumps,
              LED, controls.
            </li>
            <li>
              <strong>L2 — Conservation of fuel and power (existing dwellings)</strong> — retrofit
              energy efficiency.
            </li>
            <li>
              <strong>M1 — Access to and use of buildings (dwellings / non-domestic)</strong> —
              accessibility, switch heights.
            </li>
            <li>
              <strong>P1 — Electrical safety (dwellings)</strong> — design, installation,
              certification.
            </li>
            <li>
              <strong>S1 — EV charging infrastructure</strong> — new builds, renovations.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              P1 is the Schedule 1 requirement for electrical safety in dwellings. &quot;Reasonable
              provision&quot; is the qualifier; compliance with BS 7671 plus the Approved Doc P
              notifiable-work regime is the standard route. Same safe-harbour mechanic as B1-B5 for
              fire safety — compliance with the Approved Document is strong evidence but not
              exclusive. Alternative approaches permitted if they achieve P1&apos;s objective.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Scheme assesses firm competence at registration — premises, equipment, knowledge,
              supervisor qualifications.
            </li>
            <li>Periodic re-assessment — typically annual.</li>
            <li>
              Firm carries out notifiable work; produces Electrical Installation Certificate (EIC).
            </li>
            ...
            <li>
              Periodic scheme inspections of registered firms&apos; ongoing work — sample basis.
            </li>
            <li>Customer complaint can trigger scheme technical investigation.</li>
            <li>
              Scheme sanctions range from advisory through conditional registration through to
              deregistration.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Notification fee — typically £150-£500 per notification depending on LA and
              complexity.
            </li>
            ...
            <li>
              Time / cost overhead per job typically makes CPS registration the viable commercial
              model.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">
              6.4 Asbestos CAR 2012 supervisor escalation
            </div>
          </button>
        </div>
      </HubBody>
