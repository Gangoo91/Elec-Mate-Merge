...
const checks = [
  { id: 'l3-m1-s6-sub3-p', question: 'Approved Doc P scope?', options: [
    ...
    'Electrical safety in dwellings (England). Sets out which electrical work is notifiable. Notifiable work must be done by Competent Person Scheme registered installer OR notified to building control. Wales has equivalent provisions.',
  ...
  ], correctIndex: 2, explanation: 'Approved Doc P = electrical safety in dwellings. Notifiable work + competent person regime.' },
  { id: 'l3-m1-s6-sub3-b', question: 'How does Approved Doc B affect electrical work?', options: [
    'Fire safety affects emergency lighting design (BS 5266), fire detection design (BS 5839), fire-rated cable selection (CPR class), penetrations through fire-rated walls and floors, EV charging fire risk considerations, smoke control electrical systems.',
  ...
  ], correctIndex: 0, explanation: 'Approved Doc B reaches deep into electrical design and installation - emergency lighting, fire detection, cable selection, penetrations.' },
  ...
  ], correctIndex: 2, explanation: 'Approved Doc L drives the electrification of heating and the renewable / low-carbon transition. Major source of electrical work.' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 1, explanation: 'Approved Documents are guidance; Building Regulations 2010 is the statute. Same safe-harbour relationship as BS 7671 to EAWR.' },
  ...
  ], correctAnswer: 2, explanation: 'New circuits, CU replacement, special-locations work all notifiable. Competent Person Scheme (NICEIC, NAPIT, ELECSA, Stroma etc) registration covers it.' },
  { id: 3, question: 'What does CPR (Construction Products Regulation) classification do for cables?', options: [
    ...
    'Classifies cables by reaction to fire (Aca/B1ca/B2ca/Cca/Dca/Eca/Fca). Approved Doc B may require minimum classification in specific applications. Cable manufacturers mark CPR class on the sheath.',
  ], correctAnswer: 3, explanation: 'CPR class drives cable selection in fire-relevant applications. Approved Doc B influences what class is required.' },
  ...
  ], correctAnswer: 0, explanation: 'Fire stopping is a routine but often-missed requirement. Inspectors check; failures are common cause of fire spread.' },
  { id: 5, question: 'How does Approved Doc L drive heat pump work?', options: [
    ...
    'When your VAT-taxable turnover crosses the HMRC threshold over the previous rolling 12 months (currently £90,000; check the live figure) — or when you reasonably expect to cross it in the next 30 days.',
  ], correctAnswer: 1, explanation: 'Heat pump rollout is a major trend driven by Approved Doc L (and Future Homes Standard). Major electrical trade impact.' },
  ...
  ], correctAnswer: 2, explanation: 'Approved Documents reach almost all electrical-trade residential work. L3 awareness is operational not academic.' },
  { id: 7, question: 'Are Approved Documents the same in Wales / Scotland / NI?', options: [
    ...
    'England has its set; Wales has its own equivalent set (similar but not identical); Scotland has Building Standards Technical Handbooks (different framework); Northern Ireland has its own. Direction of travel is broadly aligned but specifics differ. Check the relevant jurisdiction.',
  ], correctAnswer: 3, explanation: 'Devolved nation differences. Always check the local framework before relying on a specific document.' },
  ...
  ], correctAnswer: 0, explanation: 'CPS registration is THE practical route to compliance with Approved Doc P notifiable work. Building control notification is the alternative.' },
];
