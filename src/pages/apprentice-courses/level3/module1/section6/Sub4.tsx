...
const checks = [
  ...
  { id: 'l3-m1-s6-sub4-nnlw', question: 'What\'s NNLW?', options: [
    'Notifiable Non-Licensed Work - middle category between licensed and non-licensed. Trained operatives following written plan; HSE notification 14 days in advance; medical surveillance + records. Limited removal of less-friable materials.',
  ...
  ], correctIndex: 0, explanation: 'NNLW is the middle tier. Trained, written plan, advance notification, medical surveillance.' },
  { id: 'l3-m1-s6-sub4-discovery', question: 'Discovery procedure on suspected asbestos?', options: [
    ...
    'STOP work. Don\\\\\\\\\\\\\\\'t disturb. Vacate area; close off. Photograph from safe distance. Phone firm + dutyholder + PC (where applicable). Wait for confirmation (non-asbestos by survey OR licensed contractor takes over). Document everything.',
  ...
  ], correctIndex: 1, explanation: 'Six-step discovery procedure. The L3 supervisor reflex on suspect material.' },
];
...
const quizQuestions = [
  ...
  ], correctAnswer: 2, explanation: 'NNLW middle category. Specific notification + surveillance requirements.' },
  ...
  ], correctAnswer: 3, explanation: 'Non-licensed = lowest tier. Still requires CAR 2012 compliance + training.' },
  ...
  ], correctAnswer: 0, explanation: 'Multiple factors; technical judgement. The L3 supervisor doesn\'t make the call alone - escalates to specialist.' },
  ...
  ], correctAnswer: 1, explanation: 'L3 = escalator, not categoriser. Specialist makes the call.' },
  ...
  ], correctAnswer: 2, explanation: 'Reg 4 duty to manage. Register is the operational document. Ask for it before work.' },
  ...
  ], correctAnswer: 3, explanation: 'UKATA / IATP are recognised. Reg 10 mandatory for anyone potentially exposed.' },
  ...
  ], correctAnswer: 0, explanation: 'Specialist disposal regime. Mixing with general waste = multiple offences (CAR 2012 + Hazardous Waste Regs + EPA 1990).' },
];
