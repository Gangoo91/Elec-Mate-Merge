...
const checks = [
  { id: 'l3-m1-s6-sub4-licensed', question: 'Examples of licensed asbestos work?', options: [
  ...
  ], correctIndex: 0, explanation: 'Licensed work = high-risk activity. HSE-licensed contractor essential. The L3 supervisor recognises and escalates.' },
  { id: 'l3-m1-s6-sub4-nnlw', question: 'What\'s NNLW?', options: [
  ...
  ], correctIndex: 2, explanation: 'NNLW is the middle tier: trained operatives following a written plan, HSE notification 14 days in advance, medical surveillance and records, for limited removal of less-friable materials.' },
  { id: 'l3-m1-s6-sub4-discovery', question: 'Discovery procedure on suspected asbestos?', options: [
  ...
  ], correctIndex: 1, explanation: 'Six-step discovery procedure: STOP, don\'t disturb, vacate and close off, photograph from a safe distance, phone firm + dutyholder + principal contractor, and wait for confirmation (non-asbestos by survey OR licensed contractor takes over). Document everything. The L3 supervisor reflex on suspect material.' },
];

const quizQuestions = [
  { id: 1, question: 'When is asbestos work licensed?', options: [
  ...
  ], correctAnswer: 1, explanation: 'Licensed work = high-risk activity. HSE Approved Code of Practice L143 gives the detail.' },
  { id: 2, question: 'When is NNLW appropriate?', options: [
  ...
  ], correctAnswer: 2, explanation: 'NNLW is the middle category: trained operatives, written plan, 14-day HSE notification, medical surveillance and records. Specific notification and surveillance requirements apply.' },
  { id: 3, question: 'When is non-licensed work permitted?', options: [
  ...
  ], correctAnswer: 3, explanation: 'Non-licensed work is the lowest tier, below the NNLW threshold. It still requires full CAR 2012 controls (assessment, training, PPE, hygiene).' },
  { id: 4, question: 'How is the categorisation decided?', options: [
  ...
  ], correctAnswer: 0, explanation: 'The categorisation flows from CAR 2012 Reg 6 (assessment) + Reg 8 (licensed work) + HSE guidance L143, weighing asbestos type (chrysotile/amosite/crocidolite), friability, quantity, nature of work (removal vs encapsulation vs observation), duration and exposure level. Multiple factors and technical judgement — the L3 supervisor escalates to a specialist rather than making the call alone.' },
  ...
  ], correctAnswer: 1, explanation: 'The L3 is an escalator, not a categoriser — categorisation is for asbestos specialists, and work doesn\'t restart until confirmation OR a licensed contractor takes over. The specialist makes the call.' },
  { id: 6, question: 'What\'s the asbestos register and who maintains it?', options: [
  ...
  ], correctAnswer: 2, explanation: 'Under CAR 2012 Reg 4 (duty to manage) the dutyholder maintains the register; it must be available to anyone working on the fabric and updated as conditions change. It is the operational document — ask for it before work.' },
  { id: 7, question: 'How is asbestos awareness training delivered?', options: [
  ...
  ], correctAnswer: 3, explanation: 'UKATA / IATP-certified providers offer asbestos awareness (1 day, periodic refresher); non-licensed and licensed work require more advanced certified training. CAR 2012 Reg 10 mandates adequate training for anyone who may be exposed.' },
  { id: 8, question: 'What\'s the asbestos waste regime?', options: [
  ...
  ], correctAnswer: 0, explanation: 'Asbestos waste is double-bagged (red inner with asbestos label, clear outer with hazardous waste label), accompanied by a Hazardous Waste Consignment Note, transported by a licensed asbestos waste carrier and disposed of at a permitted asbestos waste facility. Mixing with general waste = multiple offences (CAR 2012 + Hazardous Waste Regs + EPA 1990).' },
];
