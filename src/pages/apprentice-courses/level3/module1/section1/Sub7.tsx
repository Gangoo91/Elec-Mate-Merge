...
const checks = [
  {
    ...
    question: "What's a 'Higher-Risk Building' (HRRB) under the Building Safety Act 2022?",
    options: [
  ...
  },
  {
    ...
    question: "What's the Building Safety Regulator (BSR) and where does it sit?",
    options: [
  ...
  },
  {
    ...
    question: "What's the 'golden thread' of information under BSA 2022?",
    options: [
...
export default function Sub7() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 1 · Subsection 7"
        title="Building Safety Act 2022 — the new framework"
        backTo="/study-centre/apprentice/level3-module1-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          L2 didn't cover BSA 2022 in any depth — it's post-Grenfell, post-Hackitt, post-2022. At L3
          you need the framework even if not directly working on HRRBs yet, because the wider effect
          (competence, documentation, 30-year liability) reaches every residential job.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Product testing and approval weak — fraudulent or misleading product claims went
              unchallenged.
            </li>
            <li>
              Accountability unclear — when something went wrong, no individual or body was clearly
              responsible.
            </li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;The regulator&apos;s general functions are — (a) the building function, which is
              to secure the safety of people in or about buildings in relation to risks arising from
              buildings, and to improve the standard of buildings; (b) the competence function,
              which is to facilitate the improvement of the competence of industry, including in
              particular the competence of registered building inspectors and registered building
              control approvers, and the competence of persons working on or in connection with
              buildings.&quot;
            </>
          }
          meaning={
            <>
              BSA 2022 s.2 establishes the Building Safety Regulator&apos;s remit. Two functions
              cited here — building safety and competence — apply across all buildings, not just
              HRRBs. The competence function is what reshapes the construction-industry training
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Principal Accountable Person (PAP)</strong> — single PAP per HRRB. Person
              responsible for the structure and exterior. Registers the building, prepares safety
              case, engages residents, holds the golden thread.
            </li>
            <li>
              <strong>Accountable Persons (AP)</strong> — any person responsible for repair of any
              part of the common parts including the structure. Multiple APs possible.
            </li>
            <li>
              <strong>Responsible Person (RP)</strong> — under the Regulatory Reform (Fire Safety)
              Order 2005. May or may not be the same person as the PAP.
            </li>
            <li>
              <strong>Building Safety Manager (BSM)</strong> — can be appointed by the PAP to
              discharge day-to-day safety management. Initial requirement was withdrawn from being
              mandatory but role still appropriate where the PAP doesn&apos;t have direct
              competence.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Design changes are formal — verbal &quot;just move it 200mm&quot; doesn&apos;t fly.
            </li>
            ...
            <li>
              Records of who did what, when and to what specification become part of the golden
              thread.
            </li>
            <li>
              Site induction includes BSA 2022 specifics — golden-thread input procedure,
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Accurate — reflects the as-built reality, not the original intent if it changed.
            </li>
            <li>
              Accessible — available to those with a duty or right to see it (residents, fire
              service, BSR, future contractors).
            </li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              (whether the dwelling is provided by the erection or by the conversion or enlargement
              of a building) owes a duty — (a) if the dwelling is provided to the order of any
              person, to that person; and (b) without prejudice to paragraph (a) above, to every
              person who acquires an interest (whether legal or equitable) in the dwelling; to see
              that the work which he takes on is done in a workmanlike or, as the case may be,
              professional manner, with proper materials and so that as regards that work the
              dwelling will be fit for habitation when completed.&quot; And BSA 2022 s.135 amended
              the Limitation Act 1980 to extend the limitation period to 30 years for retrospective
              claims and 15 years for prospective claims under the Defective Premises Act.
            </>
          }
          meaning={
            <>
              The 30-year retrospective limitation is the most commercially significant indirect
              effect of BSA 2022 on electrical contractors. Work installed up to 30 years ago can
              now generate claims if it&apos;s found to be defective in a way that makes the
              dwelling unfit for habitation. PI insurance, document retention and historical records
              become essential — even for firms that have never worked on an HRRB.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              EIC and EICR record retention extended in practice — keep digital copies indefinitely.
            </li>
            <li>
              Design records (cable calcs, fault-loop calcs) now treated as part of the audit trail.
            </li>
            <li>
              Competence frameworks from Industry Competence Steering Group affect JIB grading and
              CPD requirements.
            </li>
            <li>
              Product traceability — where did the cable / breaker / accessory come from? — matters
              more for forensic claims.
            </li>
            <li>
              Building Regs Approved Document B (fire safety) tightening affects fire-rated cable,
              smoke detection and emergency lighting design.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The legal HRRB definition for the in-occupation regime. The 18m / 7-storey threshold
              AND the 2-residential-unit threshold both have to be met. Hospitals and care homes are
              also covered for design and construction (Reg 7) but the in-occupation Accountable
              Person regime applies to the Reg 8 residential category. As a contractor, you decide
              whether BSA 2022 in-occupation duties are in play by measuring height and counting
              residential units — straightforward but easy to overlook on mixed-use buildings.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Fire-stopping around a service penetration found to be missing or compromised during
              electrical alteration.
            </li>
            <li>Smoke detection / fire alarm system failure or unplanned isolation.</li>
            <li>
              Loss of power to a life-safety system (firefighting lift, smoke ventilation, emergency
              lighting) that wasn&apos;t a planned isolation.
            </li>
            <li>
              Discovery during work of an installation defect that compromises fire compartmentation
              or structural integrity.
            </li>
            <li>Unintended fire or significant smoke event resulting from electrical work.</li>
            <li>
              Failure of a safety-critical alarm or monitoring system in occupied common parts.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          The competence framework — what&apos;s tightening for installers
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>L3 Diploma in Electrotechnical Services</strong> — the technical foundation.
              Plus the End Point Assessment for the Installation and Maintenance Electrician
            ...
            <li>
              <strong>ECS card</strong> (Electrotechnical Certification Scheme) — JIB-graded proof
              of identity, qualifications and H&amp;S knowledge. Required on most major sites.
            </li>
            <li>
              <strong>Scheme registration</strong> (NICEIC / NAPIT / Stroma / ELECSA) at the firm
              level; Qualified Supervisor at the individual level.
            </li>
            <li>
              <strong>Specialist competence</strong> where applicable — CompEx (hazardous area),
              F-Gas (refrigerant), BS 7671:2018+A4:2026 (current amendment).
            </li>
            <li>
            ...
            <li>
              ...
              requirements for installers working on HRRBs; expect role-specific accreditation over
              the next 5 years.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Information that residents are entitled to about the building, the safety case and
              material changes.
            </li>
            <li>
              How safety-relevant information will be provided (format, timing, accessibility).
            </li>
            <li>Procedure for residents to raise concerns or complaints.</li>
            <li>Timescales for responding to concerns and the escalation route to the BSR.</li>
            <li>
              Arrangements for consulting residents on significant changes to safety arrangements.
            </li>
            <li>Periodic review and update of the strategy.</li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice on a domestic alteration job dismisses BSA 2022 as &quot;tower block stuff
              that doesn&apos;t apply to me&quot;. They produce a paper EIC, hand it to the
              customer, take no copy. Twelve years later the property is sold; new owner discovers a
              defect; sues under Defective Premises Act (now extended to 15 years prospective). The
              original firm has no record of the work. Defence is essentially impossible.
            </>
          }
          doInstead={
            <>
              Treat all residential records as long-life. Keep digital copies of every EIC, EICR and
              alteration cert indefinitely. Use online certification platforms that retain records
              on your behalf. Design records and cable calcs are part of the package. The cost of
              digital record-keeping is trivial; the cost of an unwinnable Defective Premises Act
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Firm gets a small subcontract on an HRRB development. Doesn&apos;t realise gateway 2
              has been approved with specific design assumptions. Apprentice substitutes a different
              brand of MCB on site to save a day&apos;s wait. Substitution isn&apos;t fed back to
              the design team. Gateway 3 review picks up the discrepancy; building can&apos;t be
              occupied until either the substitution is justified in writing or the
              originally-specified MCBs are installed. Project programme blown by 3 weeks;
              subcontractor blamed and back-charged.
            </>
          }
          doInstead={
            <>
              On HRRB work, no design substitution without the design team&apos;s written approval —
              even for &quot;equivalent&quot; products. The gateway regime treats deviations from
              approved design as significant. Site induction will cover the change-control protocol;
              follow it.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Your firm has been engaged for a small electrical alteration on a residential block.
              Walking the site, you count 7 storeys above ground with a ground floor of commercial
              use; the residential parts are floors 1–7. The building is around 22m to top occupied
              storey. You&apos;re being asked to add three new sockets in a ground-floor service
              cupboard that supports landlord-side equipment. Your supervisor says &quot;just a
              quick socket job, get it done&quot;.
            </>
          }
          whatToDo={
            <>
              Pause. The building looks like an HRRB (over 18m / 7+ storeys + 2+ residential units).
              Confirm with the client / building managing agent. If it&apos;s an HRRB, a Principal
              Accountable Person exists and they must approve significant work to common parts and
              structure-affecting work. Even a small alteration to landlord-side electrical
              infrastructure may need to feed into the safety case and golden thread. Brief your
              supervisor: &quot;this is an HRRB; we need to confirm with the PAP what their approval
              process is for landlord-side electrical work before we proceed&quot;. The job may
              still go ahead but with proper design records, change-control documentation and
              digital cert integration. Refusing to do it without checking is the right call.
            </>
          }
          whyItMatters={
            <>
              BSA 2022 doesn&apos;t prohibit small electrical work on HRRBs — it requires that the
              work fits inside the building&apos;s safety management system. The PAP needs to know
              about changes; the golden thread needs to be updated; the certification needs to be
              digitally integrated. Doing the work without checking is the kind of incident that
              ends up in BSR enforcement after a future fire investigation. Your firm&apos;s
              commercial relationship with that managing agent depends on getting this right.
            </>
          }
        />
