...
const TITLE = 'MHSWR + CDM 2015 — the planning duty (1.1) | Level 3 Module 1.1.3 | Elec-Mate';
const DESCRIPTION =
...
const checks = [
  {
    ...
    question: 'What does MHSWR 1999 Reg 5 (Health and Safety arrangements) actually require?',
    options: [
  ...
  },
  {
    ...
    question: 'Under MHSWR Reg 3, who must the risk assessment cover?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 8,
    question: "What's the L2-to-L3 conceptual shift in how CDM 2015 applies to you?",
    options: [
...
const faqs = [
  ...
  {
    question:
      'Can a single person be both the CDM client AND the contractor on a small domestic job?',
    answer:
...
export default function Sub3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 1 · Subsection 3"
        title="MHSWR 1999 + CDM 2015 — the planning duty"
        backTo="/study-centre/apprentice/level3-module1-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Remember from L2 — MHSWR Reg 3 is where risk assessment lives. At L3 you also start
          carrying weight inside CDM 2015 Reg 9 (contractor) — sometimes before you realise.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Identifies who is at risk</strong> — including non-employees and vulnerable
              persons.
            </li>
            <li>
              <strong>Is kept current</strong> — reviewed when conditions change, after a near-miss,
              after an incident, periodically.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              &quot;Suitable and sufficient&quot; is a legal test that operates by reference to the
              actual hazards present. The 5+ employees recording threshold (Reg 3(6)) catches almost
              every electrical contracting firm.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Plan</strong> — H&S policy, RAMS templates, training matrix, competence
              requirements, equipment registers.
            </li>
            <li>
              <strong>Organise</strong> — roles defined (Qualified Supervisor, contracts manager,
              site supervisor, operative), reporting routes, document control.
            </li>
            <li>
            ...
            <li>
              <strong>Review</strong> — annual H&S review, post-incident lessons-learned, policy
              updates after regulation changes.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Client (Reg 4)</strong> — anyone for whom a project is carried out. Domestic
              clients have most duties cascaded to the contractor.
            </li>
            <li>
              <strong>Designer</strong> — anyone preparing or modifying designs (architect,
              consulting engineer, in-house designer at the contractor). Design duties under Reg
              9–11.
            </li>
            <li>
            ...
            <li>
              <strong>Contractor (Reg 8–10)</strong> — anyone carrying out, managing or controlling
              construction work. Plan, manage and monitor own work and workers' work.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 9(1) is the &quot;contractor-must-check-client&quot; duty. Before starting work on
              a domestic project the contractor must satisfy themselves the homeowner knows their
              CDM client duties (or, more commonly, that the contractor is taking them on by
              default). On a commercial project the contractor verifies the client knows their
              duties. The L3 step: this conversation often falls to the L3 or Approved Electrician
              on a small job — &quot;does the client know what they&apos;re signing up to under
              CDM?&quot; isn&apos;t a project-manager-only question.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              &quot;A worker must — (a) co-operate with the client, the principal designer, the
              principal contractor, any contractor and any other person performing a duty under
              these Regulations as is necessary to enable that person to perform that duty or
              function; (b) report to the principal contractor or, where there is no principal
              contractor, the contractor any defect or unsafe practice which they believe is likely
              to endanger their own health or safety or that of any other person.&quot;
            </>
          }
          meaning={
            <>
              Reg 15 is the worker&apos;s personal CDM duty. Limb (b) — the reporting duty — is the
              legal basis for raising near-misses and unsafe practices. It runs in parallel with
              HASAWA s.7 and MHSWR Reg 14. At L3 you may be both the worker under Reg 15 and the
              contractor&apos;s representative receiving the report from an L2 mate — both
              directions of the duty are live.
            </>
          }
        ...
        <ContentEyebrow>
          The L2-to-L3 shift — Worker becomes Contractor representative
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Monitor</strong> — observing safe-isolation procedure being followed, spotting
              near-misses, checking PPE compliance, intervening when necessary.
            </li>
            <li>
        ...
        >
          <p>
            How ERIC PD applies to a typical electrical task — chasing a wall in a 1980s commercial
            building (silica risk):
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Reduce / Substitute</strong> — drill-and-fix conduit clips instead of long
              chase runs; resin-bonded chase saw (lower dust) instead of hammer / bolster.
            </li>
            <li>
              <strong>Isolate (engineering)</strong> — on-tool extraction connected to an M-class
              vacuum; water suppression where compatible.
            </li>
            <li>
              <strong>Control (procedural)</strong> — limit duration; rotate operatives; restrict
              the area; clear at end of task.
            </li>
            <li>
            ...
            <li>
              <strong>Discipline</strong> — training in the technique, supervision of the novice,
              refresher on the COSHH assessment.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Re-training triggers</strong> — equipment change, regulation change, near-miss
              outcome, role change.
            </li>
            <li>
              <strong>Working time and fatigue</strong> — Reg 13(2) requires consideration of
              workers&apos; capabilities &quot;as regards health and safety&quot; — which includes
        ...
        <RegsCallout
          ...
          clause={
            <>
              <p className="mb-2">
                <strong>Reg 13(1)</strong> — &quot;Every employer shall, in entrusting tasks to his
                employees, take into account their capabilities as regards health and safety.&quot;
              </p>
              <p>
                <strong>Reg 13(2)</strong> — &quot;Every employer shall ensure that his employees
                are provided with adequate health and safety training — (a) on their being recruited
                into the employer&apos;s undertaking; and (b) on their being exposed to new or
                increased risks because of — (i) their being transferred or given a change of
                responsibilities within the employer&apos;s undertaking, (ii) the introduction of
                new work equipment into or a change respecting work equipment already in use within
                the employer&apos;s undertaking, (iii) the introduction of new technology into the
                employer&apos;s undertaking, or (iv) the introduction of a new system of work into
                or a change respecting a system of work already in use within the employer&apos;s
                undertaking.&quot;
              </p>
            </>
          }
          meaning={
            <>
              The general capabilities-and-training duty. Reg 13(3) adds that the training must be
              repeated periodically where appropriate, adapted to take account of new or changed
              risks, and take place during working hours. At L3 this is the regulation behind your
              CPD, your refresher courses and your firm&apos;s pre-task briefings. Working in a way
              that wasn&apos;t covered by your training is a Reg 13 + EAWR Reg 16 + HASAWA s.7 issue
              all at once.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Project description, address, dates, duration.</li>
            <li>Client details and confirmation of CDM client awareness.</li>
            <li>Site hazards identified and significant controls (RAMS reference).</li>
            <li>Welfare arrangements (toilet, hand wash, rest area).</li>
            <li>Emergency procedures — fire, evacuation, casualty handling, isolation points.</li>
            <li>First aid arrangements and nearest A&amp;E location.</li>
            <li>Site induction expectations for any subcontractors or visitors.</li>
            <li>Communication with the client and any neighbouring occupants.</li>
            <li>Programme and sequencing where it affects safety.</li>
            <li>Review and update mechanism if conditions change.</li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              thinking applied — &quot;it&apos;s a single contractor for one day, CDM doesn&apos;t
              apply&quot;. No construction phase plan, no client awareness check, no formal RAMS
              issued. Apprentice runs an extension lead across an emergency exit route to power
              tools. Customer&apos;s elderly visitor trips and breaks a hip. HSE attends, asks for
              the construction phase plan (it doesn&apos;t exist), the RAMS (a one-line generic
              template), and the Reg 9 evidence (none). Firm prosecuted under CDM Reg 9 + HASAWA s.3
              + MHSWR Reg 3.
            </>
          }
          doInstead={
            <>
              CDM 2015 applies to all construction work, no monetary threshold. For a small
              single-contractor job the construction phase plan can be brief (HSE CIS80 template),
              but it must exist before work starts. The client awareness check (Reg 9(1)) is a
              30-second conversation. The RAMS must reflect the actual hazards. None of this takes
              long; all of it is mandatory.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Serious and immediate danger to yourself or others.</li>
            <li>Equipment defects that compromise safety.</li>
            <li>Training gaps you&apos;ve identified in yourself or in colleagues.</li>
            <li>RAMS or method statements that don&apos;t match the actual conditions on site.</li>
            <li>PPE not issued, not appropriate or not maintained.</li>
            <li>Procedural shortcuts that have become normal but compromise safety.</li>
            <li>Customer or third-party behaviour creating risk to your work.</li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice copies last week&apos;s domestic CU change RAMS for this week&apos;s
              domestic CU change because &quot;they&apos;re basically the same&quot;. Last week the
              property was vacant; this week it&apos;s occupied with two children. Last week the
              meter was modern; this week it&apos;s a pre-2000 unit with no main switch. The RAMS
              doesn&apos;t identify either. Inspector reviews after a near-miss; finds the RAMS is a
              near-identical copy of an old job. &quot;Suitable and sufficient&quot; test fails —
              the assessment didn&apos;t engage with the actual hazards.
            </>
          }
          doInstead={
            <>
              Templates are fine as a starting point but must be adjusted to the actual site. Two
              minutes per job to add the site-specific hazards (occupancy, vulnerable persons,
              building condition, services found, weather) is the minimum. The dynamic risk
              assessment on arrival catches what the template cannot.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              Your firm has been engaged to install a new ring final and three sockets in a small
              private dental practice during their two-day weekend closure. The contracts manager
              asks you to lead the job — &quot;you&apos;ve done three of these now, you can run
              it&quot;. He hands you a one-page generic RAMS marked &quot;commercial socket
              installation&quot;. The dental practice owner (the client) is going to drop the keys
              off and disappear for the weekend. You&apos;ll have one L2 apprentice with you.
            </>
          }
          whatToDo={
            <>
              Pause and treat this as the L3 step it is. Your firm is the Contractor under CDM Reg
              9. There&apos;s no Principal Contractor because it&apos;s single-contractor. The
              dental practice owner is the Client; the domestic- style cascade doesn&apos;t apply
              (this is a non-domestic client, so the client retains the client duties under Reg 4).
              On arrival: (1) check the client knows their CDM duties or the contractor&apos;s
              taking them on, (2) walk through and update the RAMS to reflect the actual site —
              clinical waste, X-ray equipment, dental chairs you can&apos;t move, &quot;in case of
              weekend emergency&quot; building access, gas/water isolation positions, fire alarm
              zones, (3) brief the L2 apprentice on the Reg 15 worker duty and the day&apos;s plan,
              (4) decide as a competent contractor whether the planned safe-isolation strategy
              works. If anything looks wrong, ring the contracts manager and the client before tools
              come out. Document the dynamic assessment in the job pack.
            </>
          }
          whyItMatters={
            <>
              This is the moment the L2-to-L3 shift becomes real. At L2 you&apos;d have done what
              the contracts manager said and got on with it. At L3 you&apos;re acting as the
              firm&apos;s Reg 9 representative on site — the planning, managing and monitoring duty
              falls on you for the day. A generic RAMS is not &quot;suitable and sufficient&quot;
              under MHSWR Reg 3, and a CDM client-awareness conversation is part of Reg 9(1). Doing
              both takes 15 minutes; not doing either is what an HSE prosecution rests on if
              anything goes wrong over the weekend.
            </>
          }
        />
