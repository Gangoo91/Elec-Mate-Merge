...
const quizQuestions = [
  ...
  },
  {
    id: 7,
    question:
      "Under RIDDOR, what's the difference between a 'reportable disease' and a 'reportable dangerous occurrence'?",
    options: [
...
const faqs = [
  ...
  {
    question:
      'If I think a near-miss should be RIDDOR reportable but my supervisor disagrees, what should I do?',
    answer:
...
export default function Sub4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 1 · Subsection 4"
        title="RIDDOR, PUWER, COSHH, LOLER — depth refresher"
        backTo="/study-centre/apprentice/level3-module1-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The four daughter regulations you met at L2. L3 goes deeper — what actually triggers a
          RIDDOR report, supervisor judgement on COSHH and PUWER, and the LOLER inspection regime
          for the lifting kit you're using more often now.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Deaths (Reg 6)</strong> — work-related fatality. Telephone immediately; F2508
              within 10 days.
            </li>
            <li>
              ...
              scalpings, head-injury unconsciousness, enclosed-space injuries. F2508 within 10 days.
            </li>
            <li>
              <strong>Over-7-day injuries (Reg 4(2))</strong> — incapacity for normal duties for
              more than 7 consecutive days (excl day of accident). F2508A within 15 days.
            </li>
            <li>
              <strong>Dangerous occurrences (Reg 7 + Schedule 2)</strong> — listed events that COULD
              cause injury: lifting equipment collapse, escape of dangerous substances, electrical
              short circuit causing 24+ hours plant stoppage, structural collapse, pipeline
              incidents, certain hazardous-area events. F2508 within 10 days.
            </li>
            <li>
              <strong>Reportable diseases (Reg 8 + Schedule 3)</strong> — diagnosed work-related
              conditions: carpal tunnel from repetitive work, occupational asthma, HAVS, certain
              cancers from listed carcinogens. F2508A.
            </li>
            <li>
              <strong>Gas incidents (Regs 11–12)</strong> — separate scheme for gas suppliers and
              Gas Safe registered engineers; not normally electrical-trade territory but worth
              knowing exists.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              person must follow the reporting procedure.&quot; And Reg 4(2): &quot;Where any person
              at work suffers a specified injury (Schedule 1) as a result of a work-related
              accident, the responsible person must follow the reporting procedure.&quot;
            </>
          }
          meaning={
            <>
              The reporting procedure (Reg 6) is: notify the HSE without delay; send a report within
              10 days of the incident. For specified injuries notification by phone is normally
              expected before the F2508 follows. The L3 step: knowing the procedure exists and the
              timescales lets you escalate accurately to the responsible person — &quot;this looks
              like a Schedule 1 specified injury, you need to phone the HSE today and submit the
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 4 — suitability</strong> — equipment fit for its intended use, used only
              for that purpose. Your fish-tape isn&apos;t a torque wrench.
            </li>
            <li>
            ...
            <li>
              <strong>Reg 6 — inspection</strong> — formal inspection at intervals appropriate to
              the equipment, after exposure to deteriorating conditions, and (where there are higher
              risks) by a competent person.
            </li>
            <li>
            ...
            <li>
              <strong>Reg 9 — training</strong> — adequate training, including the methods that may
              be adopted and the precautions to be taken.
            </li>
            <li>
              <strong>Reg 11 — dangerous parts</strong> — protection from contact with moving or
              dangerous parts (guards, fixed enclosures, jigs, supervision).
            </li>
            <li>
              <strong>Reg 19 — isolation</strong> — work equipment must be capable of isolation from
              energy sources (the equipment-side echo of EAWR Reg 12).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Wood dust</strong> — particularly hardwood and MDF. Sensitiser; some hardwoods
            ...
            <li>
              <strong>Solder fume + flux</strong> — particularly rosin-based fluxes. Asthma trigger.
            </li>
            <li>
              <strong>Cleaning solvents</strong> — degreasers, contact cleaners.
            </li>
            <li>
              <strong>Battery electrolyte</strong> — particularly large-format lithium and lead-acid
            ...
            <li>
              <strong>Asbestos</strong> — pre-2000 buildings. Separately covered by CAR 2012 (full
              Sub later in this module).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Prevention first; control second. &quot;Adequately controlled&quot; is defined in Reg
              7(7) and tied to the workplace exposure limit and the hierarchy in Reg 7(3). PPE is
              the last line. The HSE prosecutes COSHH cases hardest where the hierarchy was inverted
              — &quot;mask only, no extraction, no time limit&quot; on routine silica or solder
              work.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 4 — strength &amp; stability</strong> — equipment of adequate strength for
              the load and stable in use.
            </li>
            <li>
            ...
            <li>
              <strong>Reg 9 — thorough examination &amp; inspection</strong> — before first use,
              after assembly, periodically (6/12 months), after exceptional circumstances.
            </li>
            <li>
              <strong>Reg 10 — reports &amp; defects</strong> — examination reports kept; defects
              reported to enforcing authority where appropriate.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Periodic detailed</strong> — by a competent person at intervals appropriate to
              the equipment, the use and the environment. Documented in the equipment register.
            </li>
            <li>
            ...
            <li>
              <strong>After installation or relocation</strong> — for equipment that depends on
              installation for safety. Lifting equipment, scaffold towers, fixed plant.
            </li>
            <li>
              <strong>Records</strong> — periodic and after-event inspections recorded. Pre-use
              checks usually only logged as exception when something is found.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Load</strong> — weight, dimensions, centre of gravity, attachment points.
            </li>
            <li>
              <strong>Equipment</strong> — Safe Working Load, current LOLER thorough examination
              certificate, any restrictions on use.
            </li>
            <li>
              <strong>Path</strong> — start, route, end. Clearances overhead and to the side. People
              kept clear of the load path.
            </li>
            <li>
              <strong>Operatives</strong> — competent operator, banksman where required, signaller.
              Comms agreed.
            </li>
            <li>
              <strong>Conditions</strong> — wind speed limit (for outdoor lifts), ground stability
              for outriggers, weather forecast.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The lift-planning duty. The plan must be appropriate to the complexity — short verbal
              plan for a routine lift, written plan for a complex one. HSE&apos;s guidance L113
              (Safe use of lifting equipment) sets out what counts as proportionate. At L3
              you&apos;ll often be the person doing or supervising the lift — that means you&apos;re
              the one Reg 8 expects to have planned it.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Respirable crystalline silica</strong> — 0.1 mg/m³ 8-hour TWA. Under review
              for reduction. Carcinogen.
            </li>
            <li>
            ...
            <li>
              <strong>Lead</strong> — separate Lead at Work Regs 2002. Action level 50 µg/m³ 8-hour
              TWA; biological monitoring also required.
            </li>
            <li>
              <strong>Solder fume (rosin-based flux)</strong> — 0.05 mg/m³ 8-hour TWA. Asthma
              trigger.
            </li>
            <li>
              <strong>Diesel engine exhaust emissions</strong> — under review; significant in
              confined-space and tunnel work.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              attended by fire or explosion which results in stoppage of the affected plant for more
              than 24 hours.
            </li>
            <li>
              <strong>Para 1–3 — lifting equipment collapse / overturn</strong> — applies to MEWPs,
              hoists, cranes, scaffold towers used in electrical work.
            </li>
            <li>
              <strong>Para 6 — scaffold collapse</strong> — over 5m height. Common during strip-out
              and refurbishment work.
            </li>
            <li>
              <strong>Para 9 — biological agents</strong> — rare in electrical but covers Legionella
              exposure during cooling-tower or hot-water-system work.
            </li>
            <li>
              <strong>Para 10–13 — explosion / hazardous substance release</strong> — covers F-Gas
              refrigerant releases above thresholds; some battery-fire scenarios.
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice signs out a hired scissor lift for high-level lighting work. The hire
              shop&apos;s LOLER cert is dated 11 months ago — fine. The apprentice doesn&apos;t do a
              pre-use check, doesn&apos;t check the platform load, and doesn&apos;t verify the
              operator competence has been transferred to them. The lift suffers a hydraulic leak
              partway through the day; the apprentice falls 3m. HSE prosecutes the FIRM (the user)
              under PUWER Reg 4–6 + LOLER Reg 8–9 — not the hire shop.
            </>
          }
          doInstead={
            <>
              Pre-use visual check on every lifting operation: examination cert in date,
              tyres/wheels intact, platform secure, controls operative, harness anchor points sound,
              SWL marked and within the planned load. PASMA / IPAF competence card for the
              operative. Documented lift plan. None of this is optional under LOLER.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice falls and bruises wrist; goes to A&amp;E next day; X-ray shows fracture.
              Firm decides to &quot;wait and see&quot; before reporting. The 10-day window passes,
              the fracture is later confirmed, the firm reports late. Two prosecutions follow — the
              underlying PUWER/MHSWR breach AND RIDDOR Reg 4 (failure to report within timescale).
              The late report converts a one-charge case into a two-charge case.
            </>
          }
          doInstead={
            <>
              When in doubt, report. The HSE doesn&apos;t penalise over-reporting. Late or missed
              reports are a separate offence. The 10-day clock starts at the incident, not at the
              diagnosis. F2508 online via riddor.hse.gov.uk; phone 0345 300 9923 for fatalities and
              specified injuries.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You&apos;re fault-finding on a 32A three-phase distribution circuit at a small
              manufacturing client. A sequence of events causes a controlled short-circuit at the
              DB; the upstream breaker trips correctly, no-one is hurt, but the client&apos;s
              production line is down for the rest of the day (8 hours) while the fault is
              rectified. Your supervisor says &quot;don&apos;t worry about RIDDOR, no-one was
              hurt&quot;. The plant stoppage will end up being 28 hours by the time the customer is
              back up and running.
            </>
          }
          whatToDo={
            <>
              Pause and check Schedule 2. RIDDOR Schedule 2 includes &quot;the unintended or
              uncontrolled release or escape of any substance which would be likely to cause the
              death of, or major injury to, any person; OR an electrical short circuit or overload
              attended by fire or explosion which results in the stoppage of the plant involved for
              more than 24 hours&quot;. Whether this event is reportable depends on (a) was it
              &quot;attended by fire or explosion&quot;? (b) is the plant stoppage more than 24
              hours? In this scenario the answer to (b) looks like yes (28 hours). The answer to (a)
              determines whether it&apos;s a Schedule 2 dangerous occurrence. Talk to the
              responsible person in your firm with the facts in front of you, and document your view
              in writing. If your supervisor refuses to report a Schedule 2 event, escalate to the
              H&amp;S manager or director. Failure to report is a separate offence under Reg 6.
            </>
          }
          whyItMatters={
            <>
              Dangerous occurrences are the &quot;no-injury but reportable&quot; category that L2
              framing skips. The L3 step is checking Schedule 2 every time — it&apos;s not long, the
              categories are specific, and the cost of missing one is a separate Reg 6 prosecution.
              Your firm&apos;s reluctance to report doesn&apos;t change the duty; the duty sits on
              the responsible person and you&apos;ve discharged your part by raising it in writing.
              The customer&apos;s 28-hour line stoppage is also a commercial-impact event; the
              RIDDOR report doesn&apos;t change that, but the absence of one later, when the HSE
              attends for an unrelated reason and finds the near-miss in the firm&apos;s logs, makes
              the conversation much worse.
            </>
          }
        />
