...
const TITLE = 'HASAWA dutyholder responsibilities (1.1) | Level 3 Module 1.1.1 | Elec-Mate';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    id: 6,
    question:
      "What does 'so far as is reasonably practicable' (SFAIRP) actually require, post-Edwards v NCB [1949]?",
    options: [
...
export default function Sub1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 1 · Subsection 1"
        title="HASAWA dutyholder responsibilities at L3"
        backTo="/study-centre/apprentice/level3-module1-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          You met s.2, s.3 and s.7 at L2. At L3 the act becomes a duty system you sit inside —
          director liability, the Sentencing Council guideline, and the cascade from one
          supervisor's call to a corporate prosecution.
        </p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              training, supervision, a written safety policy where there are 5+ employees. At L3 you
              are the employee, but you are also the operative the firm is supervising — so your
              conduct contributes directly to the firm's s.2 record.
            </li>
            <li>
            ...
            <li>
              <strong>s.7 (employee personal duty)</strong> — reasonable care for self and others,
              plus s.7(b) co-operation. At L3 the s.7(b) limb is where the L2→L3 step shows up.
              Co-operating includes refusing the unsafe instruction, escalating concerns and
              accepting that 'I was told to' is no defence.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              inspection regime in place, or inspection was done but the failed unit was not taken
              out of service.
            </li>
            <li>
            ...
            <li>
              ...
              carried out by competent persons. A fall almost always engages WAHR alongside HASAWA.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              practicable&quot; (SFAIRP) is the bit Edwards v NCB [1949] gives meaning to — cost,
              time and trouble must not be grossly disproportionate to the residual risk.
              Sub-clauses (2)(a)–(e) drill down: safe plant and systems, safe handling and storage,
              information and instruction, safe place of work and safe working environment.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              three-prong test. The Sentencing Council Definitive Guideline for Health and Safety
              Offences (2016) sets the personal sentence range — for high-culpability, serious-harm
              cases this includes immediate custody. This is the L3 step beyond L2: directors
              aren&apos;t shielded by the corporate veil from HSE prosecution.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Culpability</strong> — Very high (deliberate breach), High (systemic failure
              to address known risks), Medium (failures fell short of appropriate standards), Low
              (failure was minor).
            </li>
            <li>
            ...
            <li>
              <strong>Individual sentences</strong> — separate matrix; for high culpability × Level
              1 harm the starting point is custody, not a fine.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Apprentice on a domestic kitchen install assumes &quot;there&apos;s no construction
              site, no principal contractor, no CDM, so HASAWA isn&apos;t really in play&quot;. They
              cut corners on isolation because the customer is watching telly in the next room. The
              customer&apos;s elderly relative wanders in, brushes against an exposed live
              conductor, and is shocked. The HSE prosecutes the firm under s.3 (duty to
              non-employees) and the operative under s.7 — and the apprentice discovers HASAWA
              applies just as forcefully in a customer&apos;s kitchen as on a Tier 1 fit-out.
            </>
          }
          doInstead={
            <>
              Treat every workplace as a HASAWA workplace. Isolation, barriers, customer briefing,
              dynamic risk assessment — all apply on the smallest call-out as much as on the biggest
              site. The duty doesn&apos;t scale with the contract value.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              for the customer. They do it. The customer&apos;s appliance fault later causes a fire.
              The HSE prosecution names the apprentice under s.7 as well as the firm under s.2. The
              apprentice&apos;s defence — &quot;my supervisor told me to&quot; — is rejected. s.7 is
              a personal duty.
            </>
          }
          doInstead={
            <>
              Refuse the unsafe instruction. Document the refusal in writing — text, email, job-pack
              note — at the time. Escalate to a director if your immediate supervisor won&apos;t
              accept the refusal. ERA 1996 s.44 protects you from detriment for raising the concern.
              PIDA 1998 (whistleblowing) extends that protection for qualifying disclosures.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              client. Your firm&apos;s director has personally promised the client &quot;next-day
              completion&quot; on a 32A three-phase tail relocation in a live switchroom. The
              director arrives on site, sees you setting up isolation kit and lock-off padlocks, and
              tells you bluntly: &quot;we haven&apos;t got time for that — work it live, the
              panel&apos;s only 32A and you&apos;ve got rubber gloves, you&apos;ll be fine&quot;.
              Your immediate supervisor is on another job and your phone signal is patchy.
            </>
          }
          whatToDo={
            <>
              Stop. Live-working on three-phase distribution without the EAWR Reg 14 three-test (no
              reasonable to dead-work, properly-judged risk, suitable precautions) is one of the
              most prosecuted breaches in the trade. Your s.7 duty isn&apos;t reduced because the
              instruction came from a director — if anything, the director just walked themselves
              into a s.37 frame. Politely refuse: &quot;I&apos;m not able to do this live — EAWR Reg
              14 doesn&apos;t allow it on this kit&quot;. Send a text to your supervisor and a
              follow-up email to the director summarising what was asked, what you said and why,
              with timestamps. If the director persists, escalate to whoever is named on the
              firm&apos;s safety policy as the responsible person. Stay calm; the paper trail is
              your defence.
            </>
          }
          whyItMatters={
            <>
              This isn&apos;t a hypothetical — the HSE has prosecuted exactly this fact pattern
              multiple times. The director&apos;s &quot;next-day completion&quot; promise to the
              client is a commercial pressure point, not a legal defence. Your written refusal is
              what protects you under s.7 and ERA 1996 s.44 if the director tries to discipline you.
              The cascade is brutal: if you do the live work and someone is hurt, the firm gets
              prosecuted under s.2/s.3, the director under s.37, and you under s.7. Three
              convictions from one instruction.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Commercial fit-out</strong> — other trades, client&apos;s staff still in the
              building, members of the public passing entrances. Site induction and signage
              discharge a chunk of s.3.
            </li>
            <li>
              <strong>Retail / hospitality</strong> — public access. Cordon, signage and supervision
              are non-negotiable. The s.3 duty doesn&apos;t pause when the customer is busy.
            </li>
            <li>
              <strong>Healthcare / care home</strong> — vulnerable residents who can&apos;t follow
              standard barrier instructions. The s.3 bar is higher; PEEP-style arrangements are
              normal.
            </li>
            <li>
              <strong>Schools</strong> — children. Always work out of hours where possible; where
              not, the s.3 controls escalate sharply.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The non-employee duty. Same SFAIRP qualifier as s.2. Sub-sections (2) and (3) extend
              the duty to the self-employed. After the &quot;HSE v R&quot; line of cases (notably R
              v Associated Octel Co Ltd [1996]) the courts read s.3 widely — the employer&apos;s
              duty extends to the conduct of contractors and subcontractors within their
              undertaking. For an electrical firm that means the L3 apprentice&apos;s acts can put
              the firm in s.3 frame even when the casualty is someone else&apos;s customer.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Reporting a near-miss to the firm&apos;s safety system — co-operating with the Reg 5
              (MHSWR) review duty.
            </li>
            <li>
            ...
            <li>
              Wearing the issued PPE correctly — co-operating with the firm&apos;s Reg 4(4) EAWR /
              Reg 4 PUWER duty.
            </li>
            <li>
              Attending site induction and signing the RAMS — co-operating with the
              contractor&apos;s CDM Reg 8 duty.
            </li>
            <li>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>s.36</strong> — your act or default caused another person (your firm, your
              colleague) to commit a separate offence.
            </li>
            <li>
              <strong>s.37</strong> — director / senior manager personal liability for the corporate
              offence by consent, connivance or neglect.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              statutory provisions is due to the act or default of some other person, that other
              person shall be guilty of the offence, and a person may be charged with and convicted
              of the offence by virtue of this subsection whether or not proceedings are taken
              against the first-mentioned person.&quot;
            </>
          }
          meaning={
            <>
              The &quot;other person&quot; route. Allows prosecution of the individual whose act
              caused the corporate (or other party&apos;s) offence, even if the firm itself is not
              prosecuted. Pairs neatly with s.7 — s.7 covers the personal duty, s.36 covers the
              wider causation. Most L3 apprentices have never heard of s.36; knowing it exists
              raises the bar on personal conduct.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              The way in which those activities were managed or organised by senior management was a
              substantial element in the breach.
            </li>
            <li>
              Conviction = unlimited fine + publicity order requiring publication of the conviction
        ...
        <Quiz
          title="HASAWA dutyholder responsibilities — knowledge check"
