    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Complete guide to interpreting AM2 drawings and specifications - circuit diagrams, layout
        ...
        <ConceptBlock title="Drawings and Specifications Are Non-Negotiable">
          <p>
            <strong className="text-red-300">Critical.</strong> In the AM2 you'll be given drawings,
            wiring diagrams, and written specifications. These aren't suggestions — they are the
            blueprint you must follow exactly. Many candidates fail because they think "as long as
            it works, it's fine." Wrong. The assessor marks against compliance with the
        ...
        <ConceptBlock title="3. Common Drawing Interpretation Errors (NET Guidance)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-red-400/70">
            <li>
              Candidate installed all accessories neatly but put sockets 100mm too high — borderline
              fail
            </li>
            <li>
              Candidate used 2.5mm for a cooker radial instead of 4mm — failed installation section
            </li>
            <li>
        ...
        <ConceptBlock title="6. Measurement and Marking Techniques">
          ...
          <p>
            <strong className="text-green-400">Professional Tip.</strong> "Measure twice, cut once"
            applies especially to AM2. Incorrect positioning due to poor measuring loses marks that
            cannot be recovered, even if the final installation is electrically sound and
            well-crafted.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="7. What Assessors Look For - NET Assessment Criteria">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-red-400/70">
            <li>
              <strong>Safety segregation violations:</strong> LV and ELV cables in same containment
              when specification prohibits
            </li>
            <li>
        ...
        <ConceptBlock title="8. Real-World Industry Examples">
          ...
          <p>
            ...
            installed all accessories neatly but put sockets 100mm too high. Lost marks, borderline
            fail.
          </p>
          <p>
          ...
          <p>
            ...
            and mains in same trunking despite clear specification requiring segregation. Failed on
            safety compliance.
          </p>
          <p>
          ...
          <p>
            ...
            drawings and ran trunking across a doorway. Site inspector rejected the work, leading to
            costly remedial work and contract penalties.
          </p>
          <p>
            <strong className="text-orange-400">Compliance Failure.</strong> Installation completed
            to electrician's interpretation rather than specification. Failed electrical inspection
            and voided building regulations compliance.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              ticking. You consider just using 2.5 — the load calculations would still work for the
              test.
            </>
          }
          whatToDo={
            <>
              Don’t cut a single millimetre. Tell the assessor immediately. Either the materials are
              wrong (the centre fixes it) or you’ve misread the drawing (you re-check). Substituting
              silently is a deviation from spec — even if it would have been technically safe, it
              costs you the criterion and signals to the assessor that you treat the spec as
              optional.
            </>
          }
          whyItMatters={
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              double-pole isolation on the lighting circuit and have to unpick a finished accessory.
            </>
          }
          doInstead={
            <>
              Read the spec twice before you start. Highlight cable types, sizes, accessory types,
              mounting heights, routing constraints and any "must" or "shall" wording. Note anything
              unusual — they’re the easiest marks to lose.
            </>
          }
        />
