...
const AM2Module2Section3 = () => {
  ...
  return (
    ...
    >
        ...
        <div className="space-y-4 text-ios-callout text-white">
          ...
          <div className="mt-6 p-4 bg-red-500/10 border border-red-500/30 rounded-xl">
            ...
            <ul className="space-y-1 text-ios-callout text-white">
              ...
              <li>
                • Mixed ELV and LV in same trunking despite specification requiring segregation -
                fail
              </li>
              <li>
          ...
          <div className="p-4 bg-red-500/20 border-2 border-red-500/50 rounded-xl">
            ...
            <div className="space-y-2 text-ios-callout">
              ...
              <ul className="space-y-1 text-white text-ios-footnote">
                ...
                <li>
                  • <strong>Major cable size errors:</strong> Using cable insufficient for
                  protective device rating (safety issue)
                </li>
                <li>
                  • <strong>Specification abandonment:</strong> Deciding to "improve" the design
                  instead of following specifications
                </li>
                <li>
                  • <strong>Installation method breaches:</strong> Using methods that violate BS
                  7671 or specified requirements
                </li>
                <li>
                  • <strong>Protective device mismatches:</strong> Installing protection that
                  doesn't match circuit design requirements
                </li>
              </ul>
            </div>
          </div>
      ...
      {/* Navigation Footer */}
      <AM2NavigationFooter
        prevHref="/study-centre/apprentice/am2/module2/section2"
