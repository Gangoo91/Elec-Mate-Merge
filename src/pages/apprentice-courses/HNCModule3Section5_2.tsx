    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The retained Ecodesign regulation 548/2014 makes Tier-2 the legal minimum for new
              distribution transformers placed on the UK market since 2021. As BSE designer of any
              new substation you must verify the proposed transformer meets Tier-2 limits and
              document the compliance on the DNO connection / Building Control submission. Reusing
              pre-2021 stock for a new connection is not compliant.
            </>
          }
        ...
        <ConceptBlock title="In 30 seconds">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Turns ratio:</strong> V1/V2 = N1/N2 (voltage transformation)
            </li>
            <li>
              <strong>Current:</strong> I1/I2 = N2/N1 (inverse relationship)
            </li>
            <li>
              <strong>Losses:</strong> Core (constant) + Copper (load-dependent)
            </li>
            <li>
              <strong>Efficiency:</strong> Output / (Output + Losses) x 100%
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Building Services Context</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Distribution:</strong> 11kV/400V substations
            </li>
            <li>
              <strong>Isolation:</strong> IT systems, medical locations
            </li>
            <li>
              <strong>Efficiency:</strong> Typically 97-99% for modern units
            </li>
            <li>
              <strong>Ratings:</strong> kVA, impedance, tap positions
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="The Ideal Transformer">
          <p>
            ...
            induction, with no direct electrical connection between primary and secondary windings.
            An ideal transformer has no losses and 100% efficiency.
          </p>
          ...
          <p>Primary voltage : Secondary voltage = Primary turns : Secondary turns</p>

          <p className="text-sm font-medium text-white">Key ideal transformer relationships:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Step-down</strong> — N1 &gt; N2 — V2 &lt; V1 — I2 &gt; I1
            </li>
            <li>
              <strong>Step-up</strong> — N1 &lt; N2 — V2 &gt; V1 — I2 &lt; I1
            </li>
            <li>
              <strong>Isolation (1:1)</strong> — N1 = N2 — V2 = V1 — I2 = I1
            </li>
          </ul>
        ...
        <ConceptBlock title="Turns Ratio and Current Transformation">
          <p>
            ...
            this relationship is essential for sizing cables, protection devices and ensuring proper
            load matching.
          </p>
          ...
          <p>Current ratio is the inverse of the turns ratio</p>

          <p className="text-sm font-medium text-elec-yellow/80">Step-Down Example (11kV/400V)</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Practical Implications</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Grid to distribution</strong> — 33kV — 11kV — 3:1
            </li>
            <li>
              <strong>Substation (UK)</strong> — 11kV — 400V — 27.5:1
            </li>
            <li>
              <strong>Building intake</strong> — 400V — 230V — 1.74:1
            </li>
            <li>
              <strong>Control circuits</strong> — 400V — 110V — 3.64:1
            </li>
          </ul>
        ...
        <ConceptBlock title="Core Losses (Iron Losses)">
          ...
          <p>
            Core losses depend on applied voltage (which determines flux), not on load current. A
            transformer on no-load still experiences full core losses.
          </p>

          <p className="text-sm font-medium text-white">Measured by No-Load Test</p>
          <p>
            Open-circuit test at rated voltage measures core losses directly, as copper losses are
            negligible with no secondary current flowing.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Typical Core Loss Values</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>100</strong> — 300-400W — 0.3-0.4%
            </li>
            <li>
              <strong>500</strong> — 900-1200W — 0.18-0.24%
            </li>
            <li>
              <strong>1000</strong> — 1500-2000W — 0.15-0.2%
            </li>
          </ul>
        ...
        <ConceptBlock title="Copper Losses (Load Losses)">
          ...
          <p>Total copper loss = Primary I squared R loss + Secondary I squared R loss</p>

          <p className="text-sm font-medium text-elec-yellow/80">Characteristics</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Proportional to I squared (quadruples if current doubles)</li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>25%</strong> — 0.25 — 6.25%
            </li>
            <li>
              <strong>50%</strong> — 0.50 — 25%
            </li>
            <li>
              <strong>75%</strong> — 0.75 — 56.25%
            </li>
            <li>
              <strong>100%</strong> — 1.00 — 100%
            </li>
          </ul>
        ...
        <ConceptBlock title="Efficiency Calculation">
          ...
          <p>
            <strong>
              Efficiency = P<sub>out</sub> / (P<sub>out</sub> + P<sub>core</sub> + P<sub>cu</sub>) x
              100%
            </strong>
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Efficiency at Partial Load</p>
          <p>
          ...
          <p>
            Maximum efficiency occurs when <strong>copper losses equal core losses</strong>. This
            typically happens at 50-70% of full load for most transformers, making them most
            efficient under normal operating conditions rather than at full rated capacity.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">All-Day (Energy) Efficiency</p>
          <p>
            For transformers that operate at varying loads throughout the day, energy efficiency is
            more relevant:
          </p>
        ...
        <ConceptBlock title="Voltage Regulation">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Voltage Regulation Formula</p>
          ...
          <p>Expressed as a percentage of full-load voltage</p>

          <p className="text-sm font-medium text-white">Factors affecting voltage regulation:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Small distribution (&lt;100kVA)</strong> — 2-4% — Lower impedance
            </li>
            <li>
              <strong>Medium distribution (100-1000kVA)</strong> — 3-5% — Balanced design
            </li>
            <li>
              <strong>Large power (&gt;1MVA)</strong> — 5-8% — Higher impedance for fault limitation
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Tap Changers</p>
          <p>Tap changers adjust the turns ratio to compensate for voltage variations:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Off-load tap changer:</strong> Manual adjustment when de-energised (typical:
              plus/minus 5% in 2.5% steps)
            </li>
            <li>
              <strong>On-load tap changer (OLTC):</strong> Automatic adjustment under load (typical:
              plus/minus 10% in 1.25% steps)
            </li>
            <li>
        ...
        <ConceptBlock title="Transformer Ratings and Impedance">
          <p>
            ...
            system design, protection coordination and fault level calculations in building services
            installations.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Dyn11</strong> — Delta — Star (neutral) — -30 degrees
            </li>
            <li>
              <strong>Yyn0</strong> — Star — Star (neutral) — 0 degrees
            </li>
            <li>
              <strong>Dzn0</strong> — Delta — Zigzag (neutral) — 0 degrees
            </li>
          </ul>
        ...
        <ConceptBlock title="Building Services Applications">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Distribution Transformers</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Package substations:</strong> 11kV/400V transformers serving large buildings
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>IT systems:</strong> 1:1 ratio transformers for medical locations (Group 2)
            </li>
            <li>
            ...
            <li>
              <strong>Purpose:</strong> Galvanic separation, noise filtering, earth fault tolerance
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Main intake</strong> — 11kV/400V oil-filled — High efficiency, OLTC for
              voltage control
            </li>
            <li>
              <strong>Indoor substation</strong> — Dry-type cast resin — Fire safety, no oil,
              reduced clearances
            </li>
            <li>
              <strong>Medical IT system</strong> — 1:1 isolation — BS EN 61558-2-15, IMD monitoring
            </li>
            <li>
              <strong>SELV lighting</strong> — 230V/12V safety — BS EN 61558-2-6, double insulation
            </li>
            <li>
              <strong>BMS controls</strong> — 400V/24V control — Low power, galvanic isolation
            </li>
            <li>
              <strong>Site tools</strong> — 230V/110V CTE — Centre-tapped earth, max 55V to earth
            </li>
          </ul>
          ...
          <p>
            ...
            requirements for distribution transformers. Tier 2 (from 2021) requires peak efficiency
            of 98.25% for 400kVA units.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p className="text-sm font-medium text-elec-yellow/80">Example 1: Transformer Sizing</p>
          <p>
            <strong>Question:</strong> A commercial building has a maximum demand of 650kW at 0.85
            power factor. What minimum transformer kVA rating is required?
          </p>
          ...
          <p>
            <strong>Question:</strong> A 500kVA transformer has core losses of 1.1kW and full-load
            copper losses of 5.5kW. Calculate efficiency at 75% load with 0.8 power factor.
          </p>
          ...
          <p className="text-white mt-2">Switchgear must be rated at least 21kA fault withstand</p>
          ...
          <p className="text-white mt-2">This transformer is most efficient at half load</p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A new office HQ has assessed peak coincident demand of 720 kVA at 0.85 pf. The DNO is
              providing an 11 kV/415 V transformer in a private substation. The vendor has tendered
              three options: 800 kVA Tier-1 surplus stock, 1000 kVA Tier-2 cast-resin, 1000 kVA
              Tier-2 amorphous-core.
            </>
          }
          whatToDo={
            <>
              Reject the 800 kVA Tier-1 stock immediately — it is not legally placeable on the UK
              market for a new connection (Reg 548/2014 Tier-2 minimum since 2021), and it is
              undersized for the assessed demand with no headroom. Choose between 1000 kVA
              cast-resin and 1000 kVA amorphous-core: amorphous core has ~70 % lower no-load loss
              (perhaps 700 W vs 2000 W continuous) but capital uplift of &pound;3k&ndash;&pound;5k.
              At 24/7 operation the payback on amorphous is 3&ndash;4 years on energy alone, plus
              the BREEAM / Part L credit. Specify amorphous and document the lifecycle analysis.
            </>
          }
          whyItMatters={
            <>
              Distribution transformers run 24/7 for 25&ndash;40 years. No-load loss accumulates
              ceaselessly &mdash; an extra 1.3 kW continuous is 11,388 kWh/year. Specifying the
              wrong transformer at design stage is the single biggest avoidable energy cost on a BSE
              substation, and the cost differential is recoverable inside the building&rsquo;s
              BREEAM certification window.
            </>
          }
        />
