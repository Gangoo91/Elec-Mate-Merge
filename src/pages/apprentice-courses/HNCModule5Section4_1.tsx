      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>ISO 9001:2015:</strong> International quality management standard
              </li>
              <li className="pl-1">
                <strong>PDCA cycle:</strong> Plan-Do-Check-Act improvement method
              </li>
              <li className="pl-1">
                <strong>Document control:</strong> Ensures current approved versions in use
              </li>
              <li className="pl-1">
                <strong>NCRs:</strong> Formal recording and resolution of deviations
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>ITP:</strong> Inspection and Test Plans for works
              </li>
              <li className="pl-1">
                <strong>Hold points:</strong> Mandatory witness/approval stages
              </li>
              <li className="pl-1">
                <strong>O&M manuals:</strong> Controlled handover documentation
              </li>
              <li className="pl-1">
                <strong>Snagging:</strong> Systematic defect identification and closure
              </li>
            </ul>
          </div>
        </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Understanding internal/external issues, interested parties
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Management commitment, quality policy, roles
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Planning, control of processes, service delivery
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Monitoring, measurement, analysis, audits
                      </td>
                    </tr>
                    <tr>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="p-3 rounded bg-white/5">
                  <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                    ...
                    <li className="pl-1">
                      <strong>Process approach:</strong> Managing activities as interrelated
                      processes
                    </li>
                  </ul>
                </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                PDCA Example: Electrical Installation Testing
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Create ITP, identify hold points, calibrate instruments, schedule
                        inspections
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Conduct testing per BS 7671, complete test sheets, record results
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Check</td>
                      <td className="border border-white/10 px-3 py-2">
                        Review test results against requirements, identify failures, compare to
                        benchmarks
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Rectify failures, update procedures if systemic issues, improve for next
                        phase
                      </td>
                    </tr>
                  </tbody>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical Quality Procedures for Building Services
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Who receives controlled copies
                      </td>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Drawing Revision Control on Site
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 space-y-2">
                <div className="flex items-center gap-2">
                  <span className="bg-elec-yellow/20 text-elec-yellow px-2 py-1 rounded text-xs font-medium">
                    1
                  </span>
                  <span className="text-sm">
                    <strong>Identification:</strong> Non-conformance detected and reported
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="bg-elec-yellow/20 text-elec-yellow px-2 py-1 rounded text-xs font-medium">
                  ...
                  <span className="text-sm">
                    <strong>Recording:</strong> NCR raised with full details
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="bg-elec-yellow/20 text-elec-yellow px-2 py-1 rounded text-xs font-medium">
                  ...
                  <span className="text-sm">
                    <strong>Containment:</strong> Immediate action to prevent further impact
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="bg-elec-yellow/20 text-elec-yellow px-2 py-1 rounded text-xs font-medium">
                  ...
                  <span className="text-sm">
                    <strong>Investigation:</strong> Root cause analysis conducted
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="bg-elec-yellow/20 text-elec-yellow px-2 py-1 rounded text-xs font-medium">
                  ...
                  <span className="text-sm">
                    <strong>Correction:</strong> Work rectified or concession agreed
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="bg-elec-yellow/20 text-elec-yellow px-2 py-1 rounded text-xs font-medium">
                  ...
                  <span className="text-sm">
                    <strong>Corrective action:</strong> Measures to prevent recurrence
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="bg-elec-yellow/20 text-elec-yellow px-2 py-1 rounded text-xs font-medium">
                  ...
                  <span className="text-sm">
                    <strong>Verification:</strong> Effectiveness confirmed
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="bg-elec-yellow/20 text-elec-yellow px-2 py-1 rounded text-xs font-medium">
                  ...
                  <span className="text-sm">
                    <strong>Close-out:</strong> NCR formally closed
                  </span>
                </div>
              </div>
            </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Photos, test results, witness statements
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Why 1:</strong> Electrician installed in wrong position → Used wrong
                  drawing
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Why 5:</strong> Why no process? → Document control procedure doesn't
                  include collection step
                </li>
                <li className="pl-1 text-green-400">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Quality KPIs for Building Services
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: ITP Hold Point
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Scenario:</strong> An Inspection and Test Plan (ITP) for a distribution
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  → Hold points are mandatory; work cannot proceed without sign-off
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: NCR for Incorrect Installation
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  2. Concession: Accept at 2.7m if clearances acceptable (requires design approval)
                </p>
                <p className="mt-2 text-green-400">
                  → Corrective action: All marked-up drawings to be verified against current
                  revision weekly
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Document Control Audit Finding
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  → Corrective action: Implement weekly drawing register check by Site Engineer
                </p>
              </div>
            </div>
          </div>
