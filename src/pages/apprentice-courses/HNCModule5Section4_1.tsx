...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Clause 6', 'Clause 4', 'Clause 5', 'Clause 7'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          ISO 9001 requirements, quality procedures, documentation control and continual improvement
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ISO 9001 is fundamentally a leadership standard, not a paperwork standard. If the
              project team treats QMS as compliance theatre, audits will find non-conformities and
              projects will repeat the same mistakes. The PM's daily attention to procedures, NCRs
              and lessons-learned is what makes QMS deliver value.
            </>
          }
        ...
        <ConceptBlock title="ISO 9001:2015 Structure and Requirements">
          <p>
            ...
            (QMS). It provides a framework for organisations to consistently meet customer and
            regulatory requirements while continually improving their processes.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Clause 9:</strong> Performance Evaluation — Monitoring, measurement, analysis,
              audits
            </li>
            <li>
              <strong>Clause 10:</strong> Improvement — Non-conformity, corrective action, continual
              improvement
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="The PDCA Cycle and Quality Procedures">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Do:</strong> Conduct testing per BS 7671, complete test sheets, record results
            </li>
            <li>
            ...
            <li>
              <strong>Act:</strong> Rectify failures, update procedures if systemic issues, improve
              for next phase
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Document Control and Records Management">
          <p>
            Effective document control ensures that personnel always use current, approved versions
            of procedures, drawings, specifications, and other controlled documents. Poor document
            control leads to errors, rework, and non-conformances.
          </p>
          <p>
          ...
          <p>
            <strong>Common issue:</strong> Operatives working from superseded drawings is a frequent
            cause of rework. Establish a clear process for removing old drawings when new revisions
            are issued.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Non-Conformance Reporting and Continual Improvement">
          <p>
            ...
            and resolving deviations from specified requirements. A robust NCR process is essential
            for learning from mistakes and preventing recurrence.
          </p>
          <p>
          ...
          <p>
            <strong>
              Root cause analysis — the 5 Whys (example: cable installed in wrong location):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Root cause:</strong> Document control procedure inadequate → Update procedure
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Description:</strong> 25m of cable tray installed at 2.7m instead of 3.0m per
              DWG-E-201 Rev C
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              Your company holds ISO 9001:2015 certification. During a UKAS-accredited surveillance
              audit at one of your live MEP projects, the auditor finds 14 NCRs: missing site
              induction records, undated drawings on site, ITP hold-points unsigned, defective
              equipment installed without challenge, unsigned QA sign-offs at level 3. The
              certification body issues a major NCR, threatening certification suspension if not
              closed within 30 days.
            </>
          }
          whatToDo={
            <>
              Convene an urgent project quality review. Brief the site team. Implement a
              controlled-document register on site, with an out-of-date drawing amnesty followed by
              a controlled re-issue. Re-validate all open ITPs and sign retrospectively where work
              has been verified. Brief subcontractors on document control discipline. Implement
              weekly site QA walk-rounds by the PM. Close all NCRs within 30 days with corrective
              action evidence. Lessons learned across the wider business — every project needs the
              same baseline.
            </>
          }
          whyItMatters={
            <>
              QMS certification is reputational and commercial — many clients require it as PQQ
              pre-condition. A suspended certification can lock you out of pre-qualified frameworks
              for years. More importantly, the project quality issues that generate the NCRs are the
              same ones that generate defects, rework and client claims. QMS discipline is
