...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['WiFi', 'Bluetooth', 'BACnet', 'Modbus only'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['3 years', '6 months', '1 month', '10 years'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1 week', '6 months', '5 years', '12 months'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Approved Document L makes the building log book a legal handover deliverable. As HNC
              engineer you compile the log book using TM31 as the template, with the commissioning
              records, O&amp;M data, training records and Soft Landings aftercare plan. No log book
              = no L compliance sign-off.
            </>
          }
        ...
        >
          ...
          <p>
            ...
            saves far more during construction and operation. Early investment in coordination pays
            dividends.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Example 1 - Commissioning schedule:</strong> A new 3-storey office building with
            VAV air conditioning.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Week 1-2: Pre-commissioning - ductwork leakage tests, pipework pressure tests,
              electrical continuity and IR tests
            </li>
            <li>
              Week 3-4: Static commissioning - individual fan rotation checks, pump rotation and
              isolation, damper and valve stroke tests
            </li>
            <li>
              Week 5-6: Dynamic commissioning - AHU commissioning (Code A), CHW system balancing
              (Code W), VAV terminal commissioning
            </li>
            <li>
              Week 7-8: Controls and integration - BMS point-to-point verification, control sequence
              testing, integrated system tests
            </li>
            <li>Allow 6 months for seasonal commissioning</li>
          </ul>
          <p>
            <strong>Example 2 - Interface coordination:</strong> Coordinating fire alarm and HVAC
            systems.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Fire alarm → BMS interface: fire signal stops AHUs, fire dampers close automatically,
              smoke extract fans start, lifts return to ground
            </li>
            <li>
              Coordination checklist: interface cable route agreed, signal type defined (volt-free
              contact), response time requirements specified, testing procedure agreed, witness test
              scheduled
            </li>
            <li>Result: integrated fire/HVAC test passes</li>
          </ul>
          <p>
            <strong>Example 3 - First year optimisation:</strong> New office building energy higher
            than predicted after 6 months.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Investigation findings: heating running 6am-8pm (design 7am-6pm), night setback not
              activating, cooling setpoint 21°C (design 24°C), optimiser not enabled
            </li>
            <li>
              Optimisation actions: adjust schedules to match actual occupancy, enable night setback
              (16°C heating), reset cooling setpoint to 24°C, enable optimum start/stop, review
              holiday schedules
            </li>
            <li>
              Result: <strong>Energy reduced 25% to near design target</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A 12,000 m² secondary academy is reaching practical completion. Soft Landings is
              contractually mandated by the funding agreement. You are the M&amp;E lead handing over
              a complex BMS-driven HVAC + LED lighting + BIPV + ASHP system to an FM team with no
              prior experience of any of these technologies.
            </>
          }
          whatToDo={
            <>
              Run the formal Soft Landings handover: training sessions for FM (BMS, lighting, ASHP),
              seasonal commissioning over the first heating + cooling season, monthly aftercare
              reviews for 12 months. Compile the building log book per CIBSE TM31 with all
              commissioning records, O&amp;M manuals, as-built drawings and the energy model. Set
              the energy targets in the BMS dashboard. Hand over emergency contact lists. Schedule
              the 3-year POE (post-occupancy evaluation) review.
            </>
          }
          whyItMatters={
            <>
              Schools have a poor reputation for performance gaps because the FM teams are stretched
              and the kit is unfamiliar. Soft Landings is the framework that catches BMS
              misconfiguration, schedules energy reviews and stops the building drifting in
              year-one. Ofsted-rated schools with high energy bills face board- level scrutiny; Soft
              Landings buys insurance.
            </>
          }
        />
