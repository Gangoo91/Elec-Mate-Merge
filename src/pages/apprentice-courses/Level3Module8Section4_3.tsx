...
const DESCRIPTION =
  'Develop effective strategies to improve your exam performance. Learn targeted revision techniques, memory aids, calculation shortcuts, and approaches to overcome weak areas.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "Active recall forces your brain to retrieve information, strengthening memory pathways. It's significantly more effective than passive re-reading or highlighting.",
  },
  {
    id: 'check-2',
    ...
    correctIndex: 2,
    explanation:
      'Calculation skills improve through deliberate practice. Working through many varied problems builds fluency and helps you recognise different question formats.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 2,
    explanation:
      "Spaced repetition involves reviewing material just before you're about to forget it, at gradually increasing intervals. This is highly effective for long-term retention.",
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      'Effective mnemonics are personal and memorable to you. Creating your own links the information to your existing knowledge, making it easier to recall.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 2,
    explanation:
      'Calculation skills require practice. Working through problems yourself, then checking your method against correct solutions, builds fluency and identifies specific errors.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Active recall means retrieving information from memory without cues. This could be flashcards, practice questions, or explaining concepts from memory.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'Spaced repetition is most effective when you review just before forgetting. Typical intervals might be 1 day, 3 days, 1 week, 2 weeks, 1 month.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Regular timed practice builds awareness of pacing and helps identify which question types need faster technique. This makes time management automatic in the real exam.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'The Pomodoro Technique uses 25-minute focused work periods followed by 5-minute breaks. This maintains concentration and prevents mental fatigue.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Interleaving involves mixing different topics rather than blocking them. This improves discrimination between similar concepts and reflects how exam questions mix topics.',
  },
  {
    id: 7,
    ...
    correctAnswer: 3,
    explanation:
      "Note the difficulty, try alternative explanations (different books, videos), and if still stuck, seek help from tutors or peers. Don't let one concept block all progress.",
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      "Creating summaries requires processing information, making decisions about what's important, and expressing it in your own words - all of which reinforce learning.",
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      "Explaining concepts forces you to organise your understanding and express it clearly. Gaps in your knowledge become obvious when you can't explain something coherently.",
  },
  {
    id: 10,
    question:
      'For technical subjects like electrical installation, the best ratio of theory to practice is:',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Technical subjects require applying knowledge. After understanding theory, spend most time practicing application through problems, questions, and calculations.',
  },
  {
    id: 11,
    ...
    correctAnswer: 1,
    explanation:
      'Familiarity reduces anxiety. Practice under realistic conditions - timed, silent, no notes - so the exam environment feels familiar rather than threatening.',
  },
  {
    id: 12,
    ...
    correctAnswer: 2,
    explanation:
      "Understanding BS 7671's structure (Parts, Chapters, Sections) and regularly using it during practice builds familiarity. You'll naturally remember key references through use.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Quality matters more than quantity. 2-3 hours of focused, active study (with breaks) is more effective than 6 hours of passive reading. Consistency is key - daily shorter sessions beat occasional long sessions.',
  },
  {
    question: 'Should I focus on weak areas or strengthen my strong areas?',
    answer:
      "Prioritise weak areas that are likely to appear in exams, but don't neglect strong areas entirely. A good split is 70% on weak areas, 30% maintaining strengths. In final week, focus more on consolidating.",
  },
  {
    question: 'How do I stay motivated during long revision periods?',
    answer:
      'Set specific, achievable goals for each session. Track your progress visibly. Reward yourself for hitting targets. Study in focused blocks with breaks. Remember your end goal and visualise success.',
  },
  {
    question: 'Are study groups effective for exam preparation?',
    answer:
      'Study groups can be effective for explaining concepts to each other, discussing difficult topics, and staying accountable. However, ensure the group stays focused - social chat reduces effectiveness.',
  },
  {
    question: 'What should I do the day before the exam?',
    answer:
      'Light review only - no new material. Brief look at summary notes and key formulas. Get equipment ready (calculator, pens, ID). Plan your journey. Early night for good sleep. Avoid cramming.',
  },
  {
    question: 'How do I improve my reading speed for exam questions?',
    answer:
      "Practice reading questions carefully but efficiently. Train yourself to identify key information quickly - values, conditions, what's being asked. Regular timed practice improves reading speed naturally.",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Active recall:</strong> Test yourself, don't just read
              </li>
              <li>
                <strong>Spaced repetition:</strong> Review at increasing intervals
              </li>
              <li>
                <strong>Practice:</strong> 70-80% of study time on application
              </li>
              <li>
                <strong>Targeted:</strong> Focus on identified weak areas
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Topics causing consistent errors
              </li>
              <li>
                <strong>Use:</strong> Deliberate practice on weak areas
              </li>
              <li>
                <strong>Apply:</strong> Time yourself to build exam readiness
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Research into learning and memory has identified specific techniques that
              significantly improve retention and recall. These methods are more effective than
              passive reading or highlighting.
            </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white/80 space-y-2">
                ...
                <p>
                  <strong>5 min break</strong>
                </p>
                <p>
                  <strong>30-55 mins:</strong> New material study - read, make notes, self-explain
                </p>
                <p>
                  <strong>5 min break</strong>
                </p>
                <p>
                  <strong>60-85 mins:</strong> Practice problems - mixed topics (interleaving)
                </p>
                <p>
                  <strong>5 min break</strong>
                </p>
                <p>
                  <strong>90-115 mins:</strong> Review session - check practice answers, note
                  errors, update revision priorities
                </p>
                <p>
                  <strong>5 mins:</strong> Plan tomorrow's session
                </p>
              </div>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key Point:</strong> These techniques feel harder than passive reading - that
              difficulty is actually the learning happening. If revision feels too easy, you're
              probably not learning effectively.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Calculation questions often determine the difference between passing and failing.
              Improving calculation skills requires deliberate practice with immediate feedback.
            </p>

            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              <p className="text-sm font-medium text-white mb-3">
                Calculation Improvement Strategy:
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Strategic use of memory techniques helps recall specific facts, values, and sequences
              that frequently appear in exams. The best memory aids are ones you create yourself.
            </p>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <ul className="text-xs text-white/80 space-y-2">
                ...
                <li>
                  <strong>Make it vivid:</strong> Include colour, movement, sound, or emotion
                </li>
                <li>
                  <strong>Make it weird:</strong> Unusual or absurd associations stick better
                </li>
                <li>
                  <strong>Keep it simple:</strong> The aid should be easier to remember than what it
                  represents
                </li>
                <li>
                  <strong>Test it:</strong> Actually use the mnemonic to check it works for you
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20 my-6">
              ...
              <p className="text-xs text-white/90">
                ...
                quickly recall specific details.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Build Progressively:</strong> Create memory aids as you study rather than at
              the end. The act of creating them is itself effective learning.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Exam anxiety can significantly impact performance. Building confidence through
              preparation and familiarity helps you perform at your best when it matters.
            </p>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-white/10 my-6">
              ...
              <ul className="text-sm text-white/80 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Breathing:</strong> Slow, deep breaths (4 seconds in, 4 seconds out)
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Reframe:</strong> View nervousness as readiness - your body preparing to
                    perform
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Focus:</strong> Concentrate on the current question, not overall outcome
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow/70">4.</span>
                  <span>
                    <strong>Perspective:</strong> One exam doesn't define you - it's part of a
                    longer journey
                  </span>
                </li>
              </ul>
        ...
        <section className="mb-10">
          <div className="p-5 rounded-lg bg-transparent border border-elec-yellow/20">
            <h3 className="text-sm font-medium text-white mb-4">
              Quick Reference - Improvement Strategies
            </h3>
