...
const TITLE =
  'Understanding Site Roles and Responsibilities - Module 5.5.1 | Level 2 Electrical Course';
const DESCRIPTION =
  'Learn about key site roles, responsibilities, and chain of command on construction sites. Essential knowledge for effective teamwork and communication.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'Approving the project budget and variations',
      'Carrying out statutory building control inspections',
      'Daily task allocation and quality checks',
      'Liaising directly with the client over costs',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It removes the need for site briefings',
      'It allows you to bypass your supervisor',
      'It guarantees you finish your tasks faster',
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: "Who gives you your day-to-day tasks on site?",
    options: [
      "The client's representative",
      'Your supervisor or foreman',
      'The Health & Safety Officer',
      'Whichever trade is nearest',
    ],
    correctAnswer: 1,
    explanation:
      "Your supervisor or foreman gives you your day-to-day tasks and directs your work on site. Others, such as a client's representative, monitor overall progress but do not allocate daily tasks.",
  },
  {
    id: 4,
    question: 'What is the main role of the Health & Safety Officer?',
    options: [
      'To allocate daily tasks to each trade',
      'To approve project costs and variations',
  ...
  },
  {
    ...
    options: [
      'It lets you skip toolbox talks',
      'It means you can ignore the foreman',
      'It speeds up your own tasks regardless of others',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'For urgent safety issues, immediately stop work and alert others nearby before following normal reporting procedures.',
  },
  {
    id: 10,
  ...
  const faqs = [
    {
      ...
      answer:
        'Yes, unless it is an immediate danger — in which case you should stop work and alert everyone nearby straight away. For immediate dangers, personal safety and the safety of others takes priority over reporting procedures.',
    },
    {
      question: 'What if two trades give me conflicting instructions?',
      answer:
        "Always follow your supervisor's instructions and clarify the situation through them. Different trades may have different priorities, but your supervisor coordinates the overall workflow and safety requirements.",
    },
    {
      question: 'Do apprentices have specific responsibilities?',
      answer:
        'Yes — apprentices must work safely, follow instructions from qualified personnel, ask questions when unsure, and take responsibility for their own learning and development within the workplace.',
    },
    {
      question: 'How do I know who to report different types of issues to?',
      answer:
        'Create a simple reference: Safety issues → Supervisor/H&S Officer, Quality problems → Supervisor/Foreman, Material shortages → Supervisor, Client queries → Site Manager through supervisor.',
    },
    {
      question: 'What happens if I bypass the chain of command?',
      answer:
        'Bypassing can cause confusion, duplicate work, conflicting instructions, and undermine site coordination. It can also damage working relationships and affect your professional reputation.',
    },
    {
      question: 'Should I introduce myself to other trades on site?',
      answer:
        'Yes, brief introductions help with coordination and cooperation. However, remember that work instructions still come through your supervisor, not directly from other trades.',
    },
    {
      question: 'How often do site roles change during a project?',
      answer:
        'Key roles like Site Manager usually remain constant, but supervisors and trades may change depending on project phases. Always confirm current reporting structures when personnel change.',
    },
  ];
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white text-sm space-y-1 list-disc ml-4">
                  ...
                  <li>
                    <strong>Use:</strong> Clear reporting structures and communication chains.
                  </li>
                  <li>
                    <strong>Check:</strong> Always confirm reporting procedures on new sites.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                ensures that electricians can work effectively with supervisors, other trades, and
                site personnel. Misunderstanding roles can cause delays, duplication of work, or
                safety hazards.
              </p>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p>
                <strong>Real Impact:</strong> Sites with clearly defined roles and responsibilities
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-white text-sm">
                  ...
                  <li className="flex items-start">
                    <span className="text-elec-yellow mr-2">•</span>Understand the responsibilities
                    of each role
                  </li>
                  <li className="flex items-start">
                    <span className="text-elec-yellow mr-2">•</span>Recognise the chain of command
                    and reporting structure
                  </li>
                  <li className="flex items-start">
                    <span className="text-elec-yellow mr-2">•</span>Know who to approach for
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-white text-sm">
                  ...
                  <li className="flex items-start">
                    <span className="text-elec-yellow mr-2">•</span>Follow proper reporting
                    procedures and communication chains
                  </li>
                  <li className="flex items-start">
                    <span className="text-elec-yellow mr-2">•</span>Resolve conflicts and issues
                    through appropriate channels
                  </li>
                  <li className="flex items-start">
                    <span className="text-elec-yellow mr-2">•</span>Maintain professional
                    relationships with all site personnel
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    <strong>Site Manager / Project Manager</strong> – Overall responsibility for
                    site safety, progress, coordination, budgets, and client liaison.
                  </li>
                  <li>
                    <strong>Site Supervisor / Foreman</strong> – Day-to-day management of trades,
                    allocation of tasks, quality checks. Your main point of contact.
                  </li>
                  <li>
                    <strong>Health & Safety Officer</strong> – Ensures compliance with safety
                    regulations, monitors risks, delivers safety briefings.
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2 text-white">
                  ...
                  <li>
                    <strong>Other Trades</strong> – Joiners, plumbers, HVAC - responsible for their
                    specific trade tasks, coordination needed.
                  </li>
                  <li>
                    <strong>Client / Client Representative</strong> – May attend site to check
                    progress and approve variations.
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-1 text-white">
                  ...
                  <li>
                    <strong>Site Engineer:</strong> Provides technical support and sets out work
                    positions
                  </li>
                  <li>
                    <strong>CDM Coordinator:</strong> Ensures health and safety compliance under CDM
                    regulations
                  </li>
                  <li>
                    <strong>Building Control Inspector:</strong> Conducts statutory inspections and
                    approvals
                  </li>
                </ul>
              </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm mb-3">
                  <strong>
                    Apprentice → Qualified Electrician → Site Supervisor → Site Manager → Client
                  </strong>
                </p>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm text-white list-disc ml-4 space-y-1">
                  ...
                  <li>
                    <strong>Keeps workflow smooth and efficient</strong> – Everyone knows their
                    tasks and dependencies
                  </li>
                  <li>
                    <strong>Enhances safety</strong> – Ensures the right person deals with the right
                    problem
                  </li>
                  <li>
                    <strong>Improves decision-making speed</strong> – Issues reach the appropriate
                    authority faster
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <div className="space-y-3 text-sm text-white">
                ...
                <p>
                  <strong>Problem:</strong> The issue was not dealt with properly, causing a delay
                  in inspection and affecting the project timeline.
                </p>
                <p>
                  <strong>Solution:</strong> This could have been avoided by following the correct
                  reporting chain - supervisor first, then escalation if needed.
                </p>
                <p>
                  <strong>Learning:</strong> Always use proper communication channels, even when it
                  seems faster to go direct to the client.
                </p>
              </div>
            </div>
          </section>
