      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Planning Location and Environmental Requirements</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Safety clearances:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Weight limitations:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>BS 7671 Section 701 bathroom requirements:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Types of Lighting Points and Selection</h3>
            <p className="text-xs sm:text-sm text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Standard ceiling rose:</strong> Most common in domestic installations, providing connection points and strain relief.</p>
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Loop-in ceiling rose applications:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Ceiling rose specifications:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Decorative pendants:</strong> Aesthetic focus with varied materials, weights, and drop lengths.</p>
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Pendant classifications:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Functional pendant considerations:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Enclosed fittings:</strong> Essential for damp, dusty, or corrosive environments.</p>
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Environmental applications:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Downlight connection systems:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Wiring and Installation Procedures</h3>
            <p className="text-xs sm:text-sm text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Two-way switching systems:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Mechanical support systems:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Plug-in connection systems:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Testing and Safety Compliance</h3>
            <p className="text-xs sm:text-sm text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Switch operation verification:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Emergency lighting testing:</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Bathroom compliance verification (Section 701):</strong></p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-sm">
            <div>
              <h3 className="font-medium text-white mb-3">Planning and Installation</h3>
            ...
            <div>
              <h3 className="font-medium text-white mb-3">Quality and Finishing</h3>
              <ul className="space-y-2 text-white">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-muted/50 rounded-lg border">
              <p className="font-medium text-white mb-2">What is the minimum pendant height above floor level in walkways?</p>
              <p className="text-sm text-white">2.0m minimum clearance to prevent head contact and ensure safe passage in circulation areas.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg border">
              <p className="font-medium text-white mb-2">Which BS 7671 section covers bathroom lighting requirements?</p>
              <p className="text-sm text-white">Section 701 details special installations in locations containing a bath or shower, including lighting zone restrictions.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg border">
              <p className="font-medium text-white mb-2">Why must pendant fittings have mechanical support separate from electrical connections?</p>
              <p className="text-sm text-white">To prevent strain on electrical terminals, which could cause loose connections, arcing, and potential fire risk.</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-medium text-white mb-2">Q: Can I fit a pendant directly to plasterboard?</h3>
              <p className="text-sm text-white">A: Only if suitable fixings (e.g., toggle bolts) are used and the fitting weight is within limits. Heavy fittings require structural support independent of the ceiling.</p>
            </div>
            <Separator />
            <div>
              <h3 className="font-medium text-white mb-2">Q: Is a loop-in ceiling rose always required?</h3>
              <p className="text-sm text-white">A: No, some modern lighting systems use separate junction boxes or plug-in connectors, but connections must remain accessible for maintenance.</p>
            </div>
            <Separator />
            <div>
              <h3 className="font-medium text-white mb-2">Q: What's the best way to check pendant alignment?</h3>
              <p className="text-sm text-white">A: Use a plumb line or laser level to ensure it hangs straight and centrally, checking from multiple viewing positions for accuracy.</p>
            </div>
          </div>
        </Card>
