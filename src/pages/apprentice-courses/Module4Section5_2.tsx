...
const DESCRIPTION =
  'Master the installation of lighting points and pendants with correct positioning, secure mounting, safe wiring, and compliance with BS 7671. Learn planning, fixing methods, and testing procedures.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'BS 7671 Section 701 covers special installations in locations containing a bath or shower, including lighting requirements and IP ratings.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Ceiling roses provide both mechanical support for light fittings and electrical connection points, distributing the load safely to the ceiling structure.',
  },
  {
    id: 2,
    question:
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Room lighting:</strong> Centre points provide even distribution unless
                    furniture dictates otherwise
                  </li>
                  <li>
                    • <strong>Task lighting:</strong> Position directly over work surfaces for
                    shadow-free lighting
                  </li>
                  <li>
                    • <strong>Safety clearances:</strong> Minimum 2.0m above floor level in
                    circulation areas
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h4 className="font-medium text-white mb-2">
                  Ceiling Structure and Load Assessment
                </h4>
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Solid concrete:</strong> Direct fixing with suitable anchors and plugs
                  </li>
                  <li>
                    • <strong>Suspended plasterboard:</strong> Locate joists for structural fixings
                  </li>
                  <li>
                    • <strong>Weight limitations:</strong> Standard plasterboard: maximum 5kg per
                    fixing point
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h4 className="font-medium text-white mb-2">
                  Environmental and IP Rating Requirements
                </h4>
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Bathroom zones:</strong> IP44 minimum (IP65 in shower areas)
                  </li>
                  <li>
                    • <strong>Kitchen areas:</strong> IP44 recommended near sinks
                  </li>
                  <li>
                    • <strong>External covered:</strong> IP54 minimum for weather protection
                  </li>
                  <li>
                    • <strong>Industrial/workshop:</strong> IP65 for dust and moisture protection
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10 pt-8 border-t border-white/10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Standard ceiling rose:</strong> Most common in domestic, provides
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Lightweight:</strong> Up to 2kg, suitable for standard ceiling rose
                    mounting
                  </li>
                  <li>
                    • <strong>Medium weight:</strong> 2-5kg, requires secure ceiling fixing and
                    strain relief
                  </li>
                  <li>
                    • <strong>Heavy duty:</strong> Over 5kg, needs structural support independent of
          ...
          <section className="mb-10 pt-8 border-t border-white/10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Permanent live:</strong> Brown conductor from supply to rose and
                    onward
                  </li>
                  <li>
                    • <strong>Switched live:</strong> Brown return from switch to light fitting
                  </li>
                  <li>
                    • <strong>Neutral:</strong> Blue conductor linking through all points
                  </li>
                  <li>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h4 className="font-medium text-white mb-2">
                  Pendant Connection and Strain Relief
                </h4>
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Flexible cord:</strong> 3-core 0.75mm² minimum for standard pendants
                  </li>
                  <li>
                    • <strong>Heat-resistant cable:</strong> Required for high-temperature lamp
                    environments
                  </li>
                  <li>
                    • <strong>Cord grip:</strong> Position to clamp outer sheath, not individual
                    conductors
                  </li>
                </ul>
                <p className="text-xs text-white/60 mt-3 p-2 bg-black/20 rounded">
            ...
            <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
              ...
              <div className="p-3 bg-green-500/10 border border-green-500/20 rounded">
                <p className="text-green-400 text-sm">
                  <strong>Lesson learned:</strong> The restaurant closed for three days while all
                  pendants were reinstalled with independent ceiling hooks. Always assess fitting
                  weight against ceiling capacity and provide mechanical support separate from
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              environmental regulations ensure installations are safe, functional, and visually
              pleasing.
            </p>
          </div>
          ...
          <Quiz
            ...
            title="Test your knowledge of installing lighting points and pendants"
          />
