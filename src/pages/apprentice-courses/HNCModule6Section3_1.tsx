...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Superior', 'Excellent', 'Outstanding', 'Exceptional'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Materials', 'Management', 'Energy', 'Health and Wellbeing'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Very Good', 'Good', 'Outstanding', 'Excellent'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Pollution', 'Cost Efficiency', 'Transport', 'Land Use and Ecology'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Management', 'Health and Wellbeing', 'Energy', 'Pollution'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Two-stage assessment is mandatory: design-stage certification before construction
              starts, post-construction certification after handover. Skipping the design-stage
              assessment is the most common failure mode — credits that needed early procurement or
              design decisions are then lost. Minimum standards trump the overall rating; you cannot
              skip them by over-achieving elsewhere.
            </>
          }
        ...
        <ConceptBlock title="Introduction to BREEAM">
          <p>
            ...
            buildings. Developed by BRE in 1990, it has been used to certify over 2.3 million
            buildings globally and remains the predominant assessment method in the UK construction
            industry.
          </p>
          <p>
            <strong>Key BREEAM Schemes:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>New Construction:</strong> New buildings, major extensions — Design Stage +
              Post-Construction certification
            </li>
            <li>
              <strong>Refurbishment & Fit-Out:</strong> Existing building upgrades — Scalable scope:
              Part 1 (fabric), Part 2 (core services), Part 3 (local services), Part 4 (interior
              design)
            </li>
            <li>
              <strong>In-Use:</strong> Operational buildings — Asset, Building Management, Occupier
              Management assessments
            </li>
            <li>
              <strong>Communities:</strong> Masterplanning, neighbourhood scale — Assesses wider
              sustainability of developments
            </li>
            <li>
              <strong>Infrastructure:</strong> Civil engineering projects — Roads, railways,
              utilities, bridges
            </li>
          </ul>
          <p>
            <strong>Building Type-Specific Versions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BREEAM Healthcare:</strong> Hospitals and clinical facilities with infection
              control credits
            </li>
            <li>
            ...
            <li>
              <strong>BREEAM Industrial:</strong> Warehouses, factories with operational flexibility
            </li>
            <li>
          ...
          <p>
            <strong>Industry context:</strong> BREEAM certification is often a planning requirement,
            client specification, or funding condition - making it a standard consideration for
        ...
        <ConceptBlock title="Rating Levels and Scoring">
          ...
          <p>
            <strong>BREEAM Rating Levels</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pass:</strong> ≥30% — Minimum compliance — Below market expectation
            </li>
            <li>
              <strong>Good:</strong> ≥45% — Standard commercial — Market baseline
            </li>
            <li>
              <strong>Very Good:</strong> ≥55% — Common client requirement — Above average practice
            </li>
            <li>
              <strong>Excellent:</strong> ≥70% — Government, institutional — Best practice
            </li>
            <li>
              <strong>Outstanding:</strong> ≥85% — Landmark, exemplary — Innovation leader
            </li>
          </ul>
          <p>
            <strong>Mandatory Credits</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Innovation Credits</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Score Calculation Example</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Energy category:</strong> 12 credits achieved × 19% weighting = 2.28%
              contribution
            </li>
            <li>
              <strong>Health & Wellbeing:</strong> 9 credits achieved × 14% weighting = 1.26%
              contribution
            </li>
            <li>
              <strong>All categories summed:</strong> = Overall percentage score
            </li>
            <li>
              <strong>Plus innovation:</strong> + Up to 10% additional
            </li>
          </ul>
          <p>
            <strong>Target setting:</strong> Aim 5-10% above your target threshold to provide margin
            for credits that prove unachievable during construction.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Assessment Categories and Weightings">
          ...
          <p>
            <strong>Nine Assessment Categories (NC 2018 Offices)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Energy (Ene):</strong> 15-19% — Energy performance, sub-metering, external
              lighting, low carbon technologies
            </li>
            <li>
              <strong>Health & Wellbeing (Hea):</strong> 14% — Visual comfort, indoor air quality,
              thermal comfort, acoustic performance
            </li>
            <li>
              <strong>Materials (Mat):</strong> 12.5% — Responsible sourcing, environmental impact
              of M&E products
            </li>
            <li>
              <strong>Management (Man):</strong> 12% — Commissioning, seasonal commissioning,
              building user guide, aftercare
            </li>
            <li>
              <strong>Land Use & Ecology (LE):</strong> 10% — Limited M&E impact (ecological
              enhancement of site)
            </li>
            <li>
              <strong>Water (Wat):</strong> 6% — Water consumption, monitoring, leak detection
            </li>
            <li>
              <strong>Waste (Wst):</strong> 7.5% — Construction waste, operational waste,
              adaptability
            </li>
            <li>
              <strong>Pollution (Pol):</strong> 6.5% — Refrigerant GWP, NOx emissions, flood risk,
              surface water run-off
            </li>
            <li>
              <strong>Transport (Tra):</strong> 8% — EV charging provision, cyclist facilities
            </li>
          </ul>
          <p>
            <strong>Example Credits - Building Services Impact</strong>
          </p>
          <p>
            <strong>
          ...
          <p>
            Based on Energy Performance Ratio (EPR) comparing actual design to Part L notional
            building. Requires approved dynamic thermal modelling. Higher credits for better
            performance beyond regulation.
          </p>
          <p>
            <strong>Ene 02 - Energy monitoring (up to 2 credits)</strong>
          </p>
          <p>
            Sub-metering of major energy uses: heating, cooling, lighting, small power, renewables.
            Enables post-occupancy performance tracking and fault identification.
          </p>
          <p>
            <strong>Hea 01 - Visual comfort (up to 4 credits)</strong>
          </p>
          <p>
            Daylighting levels, view out, glare control, high-frequency lighting (≥3,000 Hz), colour
            rendering (Ra ≥80). Directly affects lighting design specifications.
          </p>
          <p>
            <strong>Pol 01 - Impact of refrigerants (up to 3 credits)</strong>
          </p>
          <p>
            Credits for low GWP refrigerants, leak detection systems, and eliminating refrigerants
            entirely. Affects HVAC system selection.
          </p>
          <p>
        ...
        <ConceptBlock title="Assessment Process and Assessor Role">
          ...
          <p>
            <strong>Assessment Process Stages</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pre-Assessment:</strong> Stage 2 — Credit targeting, feasibility review, cost
              implications — Pre-assessment report, target rating
            </li>
            <li>
              <strong>Registration:</strong> Stage 2-3 — Project registration with BRE, fees paid —
              Registration confirmation, project ID
            </li>
            <li>
              <strong>Design Stage:</strong> Stage 3-4 — Evidence collection, credit assessment, QA
              submission — Interim Design Stage certificate
            </li>
            <li>
              <strong>Post-Construction:</strong> Stage 6 — As-built verification, commissioning
              evidence, final submission — Final BREEAM certificate
            </li>
          </ul>
          <p>
            <strong>Assessor Responsibilities</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Design Team Responsibilities</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Evidence Types for M&E Credits</strong>
          </p>
          <p>
            <strong>Design Stage:</strong> Specifications, design drawings, energy models (IES/TAS),
            daylight calculations, commissioning specifications, product data sheets with
            environmental certifications.
          </p>
          <p>
            <strong>Post-Construction:</strong> As-built drawings, commissioning certificates, test
            results, sub-meter schedules, O&M manuals, building user guides, seasonal commissioning
            reports.
          </p>
          <p>
            <strong>Quality Assurance Process</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Submission:</strong> Assessor submits completed assessment via BREEAM Projects
              portal
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Specification gaps:</strong> Not including BREEAM requirements in M&E specs
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A planning condition requires BREEAM Excellent on a 12,000 m² mixed-use scheme.
              Design-stage certification predicted Excellent at 71%. Post-construction, Mat 03
              (Responsible Sourcing) evidence is incomplete — the steel frame package was procured
              without BES 6001 documentation and the contractor cannot retrospectively obtain it.
              Mat 03 is a minimum standard for Excellent.
            </>
          }
          whatToDo={
            <>
              Three options: (1) accept downgrade to Very Good (planning breach risk, possibly
              re-application required); (2) try to secure replacement BES 6001-certified material
              for a portion to reach the threshold (rarely possible at handover); (3) negotiate a
              planning variation accepting Very Good with offsetting commitments (additional BREEAM
              In-Use commitment, or higher BIK on operational performance). Going forward: every
              package on a BREEAM Excellent project must carry the responsible sourcing requirement
              in the procurement specification, with evidence collected at order, not at handover.
            </>
          }
          whyItMatters={
            <>
              Minimum standards are the silent killer of BREEAM ratings. Many credits can be earned
              by design tweaks at the eleventh hour; minimum standards almost always require
              procurement decisions that close out months earlier. The BREEAM Assessor
              Pre-Assessment is your one chance to map every minimum standard to a procurement
              clause.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Water category</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
