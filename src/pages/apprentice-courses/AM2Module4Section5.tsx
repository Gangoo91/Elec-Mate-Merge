...
const AM2Module4Section5 = () => {
  ...
  const quickCheckQuestions: Array<{
    ...
    },
    {
      ...
      options: ['1 MΩ', '200 MΩ', '0.5 MΩ', '2 MΩ'],
      correctIndex: 0,
      explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          It's not enough to complete an installation and test it - you must also be able to
          identify when something does not comply with BS 7671 or the specification.
        </p>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Professional competence includes identifying problems, not just completing tasks. Find
              faults, name them in technical language, cite the BS 7671 requirement that isn't met,
        ...
        >
          <p>
            ...
            copper or damaged insulation. Incorrect polarity. Zs values exceeding BS 7671 maximums.
            RCDs failing to trip within required times.
          </p>
          <p>
        ...
        >
          <p>
            <strong>Visual Inspection:</strong> Before energising — systematic visual checks. Damage
            to cables or accessories. Missing or incorrect sleeving. Poor alignment and workmanship.
          </p>
          <p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              board. <strong>Test Result Failures:</strong> Zs above permitted value for protective
              device. Insulation resistance below 1 MΩ. RCD trip times out of range. Continuity
              values indicating breaks.
            </>
          }
          doInstead={
            <>
              Sleeve every CPC. Verify polarity at every accessory. Run end-to-end ring continuity.
              Label every circuit at the DB. Compare every measured value against the BS 7671 limit
              and record both side-by-side.
            </>
          }
        />
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              conductor) and check Ra × IΔn ≤ 50 V. For a 30 mA RCD that means Ra ≤ 1666 Ω in theory
              — in practice every guidance source pushes you to ≤ 200 Ω because soil conditions vary
              across seasons. A reading above 200 Ω on a 30 mA RCD is a non-compliance you record on
              the EIC even if it meets the 50 V calculation.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              non-compliances. AM2 rigs plant workmanship defects (over-tight cable straps, missing
              grommets, accessories not flush) and the assessor wants to see you flag them with a
              reg reference, not just the test results.
            </>
          }
        ...
        <div className="my-6">
          ...
          <p className="text-xs sm:text-sm text-white/80 mb-3">
            ...
            B32 ≈ 1.37 Ω · B40 ≈ 1.09 Ω. Acceptance at verification: measured Zs must be at or below
            0.8 × Table 41.3 max (e.g. B32 → 1.10 Ω) to allow for cold-vs-hot correction. A
            measurement above 0.8 × max but below max = C2 on EICR (potentially dangerous). Plug U0
            = 230 V and your measured Zs into V and R to back out the prospective fault current the
            device must clear.
          </p>
          <OhmsCalculator />
        </div>
        ...
        >
          ...
          <p>
            <strong>What to Include in Reports:</strong> Specific location of non-compliance. Actual
            measured values where applicable. BS 7671 requirement that is not met. Clear description
            of the defect.
          </p>
          <p>
          ...
          <p>
            ...
            kitchen" — specific, clear, located. "Ring final broken at consumer unit — L conductor"
            — specific conductor and location. "RCD trip time 380ms at 1×IΔn — exceeds 300ms limit"
        ...
        >
          ...
          <p>
            <strong>Safety Awareness:</strong> Leaves installation safe, even if faults identified.
            Prioritises safety-critical non-compliances. Shows understanding of consequences.
        ...
        >
          <p>
            <strong>Know the Limits:</strong> Memorise maximum Zs values for common MCBs at A4:2026
            — B32=1.37Ω, B20=2.19Ω, B16=2.73Ω (Cmin = 0.95 applied). RCD trip limit (A4:2026):
            single AC test at 1×IΔn must trip within 300ms for 30mA devices (the 5×IΔn test was
            deleted at A4:2026). Minimum insulation resistance: 1MΩ for most circuits.
          </p>
          <p>
            <strong>Visual Inspection Tips:</strong> Check CPCs visually — assessors always look for
            sleeving. Look for obvious damage, poor workmanship, missing labels. Check accessibility
            and IP ratings for locations.
          </p>
          <p>
            <strong>Test Result Analysis:</strong> Work logically — if reading looks wrong, re-test.
            Record as non-compliant if still outside limits. Compare all readings with BS 7671
            requirements.
          </p>
          <p>
        ...
        >
          <p>
            <strong>Example 1: Missed High Zs Reading.</strong> Candidate measured Zs of 2.5 Ω on a
            B32 breaker (A4:2026 Table 41.3 limit 1.37 Ω exceeded). Failed to report — lost marks.
          ...
          <p>
            <strong>Example 3: Correct RCD Documentation.</strong> Candidate recorded RCD trip time
            at 1×IΔn = 280ms plus manual test button operation. Correctly recorded as pass — full
            marks. Lesson: Accurate recording of actual measured values, even when within limits,
            demonstrates professional competence under A4:2026.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>Next Steps:</strong> You're now ready to move on to Section 6, where we'll cover
            time management during testing — a critical skill for AM2 success.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              You spot a planted defect — Zs reads 1.40 Ω on a B32. You write "exceeds 1.44 Ω limit"
              because that's what your textbook said. Assessor reads it: the figure 1.44 Ω is the
              pre-A4 number. The current limit is 1.37 Ω. Your reasoning is right (it's
              non-compliant) but you've cited the wrong figure — and now your professional judgement
              looks shaky on a brand-new EIC.
            </>
          }
          doInstead={
            <>
              ...
              cold-vs-hot correction: measured cold Zs on a B32 must be ≤ 0.8 × 1.37 = 1.10 Ω. Your
              1.40 Ω reading is a non-compliance under both the table max AND the 0.8 rule — state
              both.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You're on visual inspection of the AM2 rig before energising. At socket-outlet S3, the
              CPC inside the back box is bare copper — no green/yellow sleeve over the bared
              conductor. R1+R2 readings on that circuit are fine (0.45 Ω). All other accessories are
              sleeved correctly.
            </>
          }
          whatToDo={
            <>
              ...
              sign off the EIC, re-inspect, then complete the certification. Recording the find, the
              fix and the re-inspection earns full marks.
            </>
          }
          whyItMatters={
            <>
