...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Multiply by 2', 'Divide by 10', 'Divide by 20', 'No conversion needed'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['8 l/s per person', '5 l/s per person', '15 l/s per person', '10 l/s per person'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['60 m³/h', '120 m³/h', '240 m³/h', '30 m³/h'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['1.2 kW', '12 kW', '2.4 kW', '4.8 kW'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['3.0m or greater', "Height doesn't affect stack effect", '2.4m', '2.7m'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Parts F and L are the regulatory bookends. As HNC engineer you size ventilation to
              Part F minimums (occupancy-driven), then verify the permeability target from Part L is
              achievable in build, and back-calculate the natural infiltration component for the
              heating-load schedule.
            </>
          }
        ...
        >
          ...
          <p>
            ...
            (m³/h), n = air changes per hour, Volume = room volume (m³). To convert: m³/h ÷ 3.6 =
            l/s.
          </p>
          <p>
          ...
          <p>
            <strong>Rule of thumb:</strong> Divide q50 by 20 to estimate normal infiltration rate. A
            building testing at 5 m³/h/m² would have ~0.25 ach infiltration under typical
            conditions.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>Stack pressure formula:</strong> ΔP = ρ × g × h × (Ti - To) / To. Simplified: ΔP
            ≈ 0.04 × h × ΔT (Pa) for typical conditions. Where h = height between openings (m), ΔT =
        ...
        >
          ...
          <p>
            <strong>Wind pressure formula:</strong> P_wind = ½ × ρ × Cp × v². Where ρ = air density
            (1.2 kg/m³), Cp = pressure coefficient, v = wind speed (m/s). Simplified: P ≈ 0.6 × Cp ×
            v² (Pa).
          </p>
          <p>
        ...
        >
          <p>
            <strong>Example 1 - Air change rate:</strong> An office (8m × 10m × 3m) requires 400 l/s
            ventilation. What is the air change rate?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 2 - Ventilation heat loss:</strong> Calculate the ventilation heat loss
            for a 500m³ room with 1.5 ach, internal temperature 21°C, external -2°C.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>ΔT = 21 - (-2) = 23K</li>
          ...
          <p>
            <strong>Example 4 - Wind pressure:</strong> Wind speed is 5 m/s. Calculate pressure on
            windward face (Cp = +0.6) and leeward face (Cp = -0.4). What is the cross-ventilation
            driving pressure?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>P = 0.6 × Cp × v²</li>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              BB101-compliant natural ventilation. Capacity 250 children + 20 staff, so Part F
              demands ~3 l/s/person × 270 = 810 l/s of fresh air during summer full-occupancy.
            </>
          }
          whatToDo={
            <>
              Calculate stack pressure ΔPstack from indoor 24 °C, outdoor 18 °C, stack height 4 m:
              ΔPstack ≈ ρ × g × h × ΔT/T ≈ 1.2 × 9.81 × 4 × 6/297 ≈ 0.95 Pa. Add a wind contribution
              from regional design wind pressure. Calculate equivalent area Aeq from V̇ = Cd × Aeq ×
              √(2ΔP/ρ). Specify high-level + low-level openings sized for the larger of stack-only
              and wind-only cases. Cross-check with CIBSE AM10 procedure.
            </>
          }
          whyItMatters={
            <>
              Schools designed to BB101 must demonstrate adequate ventilation by calculation, not
              assertion. Undersized openings means CO₂ rises above 1500 ppm during lessons, learning
              outcomes drop, and the design fails LA scrutiny. The AM10 methodology is the auditable
              design route.
            </>
          }
        />
