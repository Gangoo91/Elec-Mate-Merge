...
const Module7Section4_5 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        '2Ω is higher than typical but may be acceptable depending on circuit length. Investigation is warranted.',
    },
    {
      id: 3,
    ...
    },
    {
      id: 5,
      question:
        'True or False: Readings within limits but higher than expected should be investigated.',
      options: ['False', 'True'],
      correctAnswer: 1,
      explanation:
        'True. Unexpected readings often indicate developing problems that should be investigated.',
    },
    {
      id: 6,
  ...
  const faqs = [
    {
      question: 'Why might two identical circuits give different test readings?',
      answer:
        'Factors like cable length, ambient temperature, connection quality, and cable route can all affect readings even in identical installations. Small variations are normal, but significant differences warrant investigation.',
    },
    {
      question:
        'Should I always investigate readings that are within limits but higher than expected?',
      answer:
        "Yes, unexpected readings often indicate developing problems. It's better to investigate and find nothing than miss an emerging fault that could become dangerous.",
    },
    {
      question: "What's the difference between a reading that 'passes' and one that's 'good'?",
      answer:
        "A 'pass' means the reading meets minimum BS 7671 requirements. A 'good' reading has margin above minimums, indicating healthy installation with room for some deterioration before becoming problematic.",
    },
  ];
