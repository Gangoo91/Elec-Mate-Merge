...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'Increasing consumption during peak hours',
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'The energy supplier only',
      'National Grid',
      'The Distribution Network Operator (DNO)',
      "The customer's meter operator",
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Load shedding', 'Peak shaving', 'Load shifting', 'Demand response'],
    correctAnswer: 2,
    explanation:
