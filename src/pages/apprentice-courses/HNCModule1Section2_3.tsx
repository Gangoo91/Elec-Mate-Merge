        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Elimination:</strong> Remove the hazard completely
              </li>
              <li className="pl-1">
                <strong>Substitution:</strong> Replace with less hazardous alternative
              </li>
              <li className="pl-1">
                <strong>Engineering:</strong> Isolate, guard, or ventilate
              </li>
              <li className="pl-1">
                <strong>Administrative:</strong> Procedures, training, signage
              </li>
              <li className="pl-1">
                <strong>PPE:</strong> Last resort protection for the individual
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Legal basis:</strong> MHSWR 1999, CDM 2015
              </li>
              <li className="pl-1">
                <strong>Application:</strong> Risk assessments, method statements
              </li>
              <li className="pl-1">
                <strong>Electrical work:</strong> Isolation, permits, PPE layers
              </li>
              <li className="pl-1">
                <strong>Principle:</strong> Most effective first, PPE last
              </li>
            </ul>
          </div>
        </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Pre-fabricate at ground level
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Assemble cable trays, containment on floor
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Electrical shock</td>
                      <td className="border border-white/10 px-3 py-2">
                        Isolate supply before work
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Safe isolation removes the hazard entirely
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Asbestos exposure</td>
                      <td className="border border-white/10 px-3 py-2">
                        Route cables around asbestos
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Alternative route avoids any disturbance
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Confined space entry</td>
                      <td className="border border-white/10 px-3 py-2">
                        External installation point
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Design allows work from outside the space
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Manual handling</td>
                      <td className="border border-white/10 px-3 py-2">
                        Specify smaller, lighter equipment
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Multiple smaller units instead of one heavy one
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Finger-safe terminals, shrouded busbars
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Extraction at soldering stations
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Roof-mounted plant access routes
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Arc rating (cal/cm²) to match risk
                      </td>
                    </tr>
                    <tr>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Scenario: Working on a Live Distribution Board
              </h3>
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs text-white">
              <div>
                <p className="font-medium text-white mb-1">
                  Hierarchy Order (Most to Least Effective)
                </p>
