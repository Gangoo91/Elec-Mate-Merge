...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['1500 kgCO2e/m2', '100 kgCO2e/m2', '600 kgCO2e/m2', '300 kgCO2e/m2'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['25 years', '60 years', '50 years', '100 years'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['5-10%', '40-50%', '15-25%', '60-70%'],
    correctAnswer: 2,
    explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/h-n-c-module6-section6"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              RICS WLCA 2nd edition is now the UK standard. EPDs are the primary data source; ICE
              database fallback only. Iterative assessment at Stage 2 (baseline), Stage 4
              (detailed), Stage 6 (as-built) — informing design, not just reporting after the fact.
              London Plan requires WLCA submission for major referable schemes.
            </>
          }
        ...
        <ConceptBlock title="RICS Methodology Fundamentals">
          <p>
            ...
            (2nd edition, 2023) provides the standardised methodology for calculating whole life
            carbon in UK construction projects. It aligns with BS EN 15978 and establishes
            consistent approaches for assessment, reporting, and benchmarking.
          </p>
          <p>
            <strong>RICS WLC Framework Components:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>System boundary:</strong> Defines what is included/excluded from assessment
            </li>
            <li>
              <strong>Study period:</strong> 60 years as standard (can vary for specific building
              types)
            </li>
            <li>
              <strong>Functional unit:</strong> kgCO2e per m2 GIA (Gross Internal Area)
            </li>
            <li>
              <strong>Life cycle modules:</strong> A1-A5, B1-B7, C1-C4, D as per EN 15978
            </li>
          </ul>
          <p>
            <strong>Assessment Requirements by RIBA Stage</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stage 2 - Concept:</strong> Simplified (elemental) — Benchmark data, early
              estimates
            </li>
            <li>
              <strong>Stage 3 - Developed:</strong> Detailed (system level) — Generic database +
              some EPDs
            </li>
            <li>
              <strong>Stage 4 - Technical:</strong> Comprehensive (product level) — Product-specific
              EPDs preferred
            </li>
            <li>
              <strong>Completion:</strong> As-built verification — Actual products, quantities
              verified
            </li>
          </ul>
          <p>
            <strong>WLC Calculation Formula</strong>
          </p>
          ...
          <p>
            <strong>Key principle:</strong> Module D (benefits beyond system boundary) must be
            reported separately and cannot offset Modules A-C.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Life Cycle Stages (Modules A-D)">
          <p>
            EN 15978 defines life cycle stages using a modular structure. Understanding each module
            enables accurate carbon accounting and identifies reduction opportunities across the
            building's lifetime.
          </p>
          <p>
            <strong>Module A: Product and Construction Stage</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>A1:</strong> Raw material extraction — Copper ore mining, bauxite extraction
            </li>
            <li>
              <strong>A2:</strong> Transport to manufacturer — Ore to smelter, components to factory
            </li>
            <li>
              <strong>A3:</strong> Manufacturing — Cable production, AHU assembly, panel wiring
            </li>
            <li>
              <strong>A4:</strong> Transport to site — Factory to construction site delivery
            </li>
            <li>
              <strong>A5:</strong> Construction/installation — Site energy, waste, temporary works
            </li>
          </ul>
          <p>
            <strong>Module B: Use Stage</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>B1:</strong> Use (refrigerant leakage)
            </li>
            <li>
              <strong>B2:</strong> Maintenance (filter changes, servicing)
            </li>
            <li>
              <strong>B3:</strong> Repair (component failures)
            </li>
            <li>
              <strong>B4:</strong> Replacement (equipment end-of-life)
            </li>
            <li>
              <strong>B5:</strong> Refurbishment (major upgrades)
            </li>
            <li>
              <strong>B6:</strong> Operational energy use
            </li>
            <li>
              <strong>B7:</strong> Operational water use
            </li>
          </ul>
          <p>
            <strong>Module C & D: End-of-Life</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>C1:</strong> Deconstruction/demolition
            </li>
            <li>
              <strong>C2:</strong> Transport to waste processing
            </li>
            <li>
              <strong>C3:</strong> Waste processing for reuse/recycling
            </li>
            <li>
              <strong>C4:</strong> Disposal (landfill, incineration)
            </li>
            <li>
              <strong>D:</strong> Reuse/recycling benefits (reported separately)
            </li>
          </ul>
          <p>
            <strong>Module B4 Replacement Calculation</strong>
          </p>
          ...
          <p>
            <strong>MEP impact:</strong> Module B4 often dominates MEP embodied carbon due to
            multiple replacement cycles - a key reason to specify durable equipment.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Data Sources and Calculation Methodology">
          <p>
            Accurate WLC assessment requires reliable carbon data. A hierarchy of data sources
            ensures calculations use the best available information while maintaining transparency
            about data quality.
          </p>
          <p>
            <strong>Data Source Hierarchy (Best to Acceptable)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1:</strong> Product-specific EPD — Highest — Daikin VRV EPD for specific model
            </li>
            <li>
              <strong>2:</strong> Manufacturer EPD (product group) — High — Schneider switchgear
              range EPD
            </li>
            <li>
              <strong>3:</strong> Industry-average EPD — Medium — FETA heat pump average EPD
            </li>
            <li>
              <strong>4:</strong> Generic database (ICE, Ecoinvent) — Acceptable — ICE v3.0 copper
              cable factor
            </li>
            <li>
              <strong>5:</strong> Proxy/estimated data — Low — Similar product extrapolation
            </li>
          </ul>
          <p>
            <strong>Key MEP Carbon Factors (ICE v3.0)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Copper (primary): <strong>2.71 kgCO2e/kg</strong>
            </li>
            <li>
              Copper (recycled 60%): <strong>1.78 kgCO2e/kg</strong>
            </li>
            <li>
              Aluminium (primary): <strong>6.67 kgCO2e/kg</strong>
            </li>
            <li>
              Aluminium (recycled): <strong>0.43 kgCO2e/kg</strong>
            </li>
            <li>
              Steel (galvanised): <strong>2.76 kgCO2e/kg</strong>
            </li>
            <li>
              PVC: <strong>3.10 kgCO2e/kg</strong>
            </li>
            <li>
              XLPE insulation: <strong>2.50 kgCO2e/kg</strong>
            </li>
          </ul>
          <p>
            <strong>Refrigerant GWP Values (AR5)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              R-410A: <strong>2088</strong> GWP100
            </li>
            <li>
              R-32: <strong>675</strong> GWP100
            </li>
            <li>
              R-134a: <strong>1430</strong> GWP100
            </li>
            <li>
              R-1234yf: <strong>4</strong> GWP100
            </li>
            <li>
              R-290 (propane): <strong>3</strong> GWP100
            </li>
            <li>
              R-744 (CO2): <strong>1</strong> GWP100
            </li>
            <li>
              R-717 (ammonia): <strong>0</strong> GWP100
            </li>
          </ul>
          <p>
            <strong>EPD Resources for MEP</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EPD International:</strong> epd-international.com - Global programme operator
            </li>
            <li>
              <strong>IBU:</strong> ibu-epd.com - German EPD programme (many MEP products)
            </li>
            <li>
              <strong>BRE EPD:</strong> greenbooklive.com - UK-verified EPDs
            </li>
            <li>
              <strong>One Click LCA:</strong> Built-in database with 200,000+ materials
            </li>
            <li>
              <strong>EC3 (Embodied Carbon in Construction Calculator):</strong> Open database
            </li>
          </ul>
          <p>
            <strong>Best practice:</strong> Document all data sources in the WLC report and clearly
            identify data quality levels for transparency and future updates.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Benchmarking and Reduction Strategies">
          <p>
            Industry benchmarks provide targets for WLC performance. Understanding these benchmarks
            and implementing reduction strategies enables MEP designers to contribute to
            decarbonisation goals whilst maintaining system performance.
          </p>
          <p>
            <strong>LETI and RIBA Whole Life Carbon Targets</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Office:</strong> 1100 kgCO2e/m2 — 600 kgCO2e/m2 — 350 kgCO2e/m2
            </li>
            <li>
              <strong>Residential:</strong> 800 kgCO2e/m2 — 500 kgCO2e/m2 — 300 kgCO2e/m2
            </li>
            <li>
              <strong>School:</strong> 900 kgCO2e/m2 — 540 kgCO2e/m2 — 325 kgCO2e/m2
            </li>
            <li>
              <strong>Healthcare:</strong> 1400 kgCO2e/m2 — 800 kgCO2e/m2 — 500 kgCO2e/m2
            </li>
          </ul>
          <p>
            <strong>MEP Carbon Reduction Hierarchy</strong>
          </p>
          <p>
            <strong>1. Build Less (Demand Reduction)</strong>
          </p>
          <p>Fabric-first approach, passive design, reduce conditioned floor area</p>
          <p>
            <strong>2. Build Clever (Design Optimisation)</strong>
          </p>
          <p>Right-size systems, hybrid solutions, efficient distribution</p>
          <p>
            <strong>3. Build Efficiently (Low Carbon Materials)</strong>
          </p>
          <p>Low-GWP refrigerants, recycled content, aluminium cables</p>
          <p>
            <strong>4. Build for Longevity (Extended Life)</strong>
          </p>
          <p>Durable equipment, design for maintenance, modular systems</p>
          <p>
            <strong>MEP Embodied Carbon Strategies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Specify <strong>low-GWP refrigerants</strong> (R-32, R-290)
            </li>
            <li>
              Use <strong>aluminium submains</strong> where feasible
            </li>
            <li>
              Specify <strong>high recycled content</strong> materials
            </li>
            <li>
              Design for <strong>extended equipment life</strong>
            </li>
            <li>
              Use <strong>prefabricated modules</strong> (reduced waste)
            </li>
            <li>
              Optimise <strong>cable sizing</strong> (balance Cu vs losses)
            </li>
          </ul>
          <p>
            <strong>MEP Operational Carbon Strategies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Support <strong>fabric-first</strong> to reduce loads
            </li>
            <li>
              Maximise <strong>heat pump COPs</strong> (SCOP &gt;4)
            </li>
            <li>
              Implement <strong>demand-controlled ventilation</strong>
            </li>
            <li>
              Use <strong>high-efficiency motors</strong> (IE4/IE5)
            </li>
            <li>
              Integrate <strong>smart controls</strong> and BMS
            </li>
            <li>
              Design for <strong>renewable energy</strong> integration
            </li>
          </ul>
          <p>
            <strong>MEP Contribution to Building WLC (Typical Office)</strong>
          </p>
          <p>
            <strong>Carbon payback:</strong> Technologies like PV and heat pumps have embodied
            carbon but typically achieve carbon payback within 2-5 years through operational savings
            - always assess whole life impact, not just upfront carbon.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Calculate embodied carbon for 500m of 95mm2 4-core XLPE/SWA
            copper cable.
          </p>
          <p>Given:</p>
          ...
          <p>
            Copper = 2,100 x 0.65 x 2.71 kgCO2e/kg = <span>3,700 kgCO2e</span>
          </p>
          <p>
            Steel = 2,100 x 0.20 x 2.76 kgCO2e/kg = <span>1,159 kgCO2e</span>
          </p>
          <p>
            XLPE/PVC = 2,100 x 0.15 x 2.80 kgCO2e/kg = <span>882 kgCO2e</span>
          </p>
          ...
          <p>
            Al carbon = 1,050 x 0.43 (recycled) = <span>451 kgCO2e</span>
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Compare lifetime refrigerant emissions for two 200kW chiller
            options.
          </p>
          ...
          <p>
            20-year leakage = 4,698 x 20 = <span>93,960 kgCO2e</span>
          </p>
          ...
          <p>
            20-year leakage = 35 x 0.05 x 675 x 20 = <span>23,625 kgCO2e</span>
          </p>
          ...
          <p>
            200 x 8 = <span>1,600 kgCO2e</span>
          </p>
          ...
          <p>
            B4 = 200 x 4 x 3 = <span>2,400 kgCO2e</span>
          </p>
          <p>Total lighting WLC:</p>
          <p>
            A1-A3 + B4 = 1,600 + 2,400 = <span>4,000 kgCO2e</span>
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              LETI 2030 WLC target: <strong>600 kgCO2e/m2</strong> (non-domestic)
            </li>
            <li>
              MEP embodied carbon: <strong>15-25%</strong> of building total
            </li>
            <li>
              MEP services benchmark: <strong>100-200 kgCO2e/m2</strong>
            </li>
            <li>
              Standard study period: <strong>60 years</strong>
            </li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Ignoring B4 replacements</strong> - can double MEP embodied carbon
              </li>
              <li>
                <strong>Using outdated carbon factors</strong> - grid decarbonisation changes B6
              </li>
              <li>
                <strong>Omitting refrigerant leakage</strong> - can be 50%+ of HVAC carbon
              </li>
              <li>
                <strong>Mixing data quality levels</strong> without documentation
              </li>
              <li>
                <strong>Including Module D in main totals</strong> - must report separately
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A net-zero-aligned office building is targeting LETI Band B for both operational EUI
              (≤55 kWh/m²/year) and embodied carbon A1–A5 (≤625 kgCO₂e/m²). Stage 4 WLCA shows
              operational carbon (60-year life) at 850 kgCO₂e/m² (15 kWh/m²/year × 0.140 kgCO₂/kWh ×
              60 years), but embodied (A1–A5) at 720 kgCO₂e/m² — over the LETI band B target.
            </>
          }
          whatToDo={
            <>
              Embodied carbon reduction strategies in M&E: (1) re-use rather than replace
              switchgear, distribution boards, key MEP plant where possible; (2) specify EPD-backed
              plant with high recycled content (chillers, AHUs); (3) substitute aluminium for copper
              cabling where current rating allows; (4) reduce belt-and-braces over-specification
              (containment sized for actual cable population, not 100% spare capacity); (5)
              refrigerant choice — R32, R454B, R290 over R410A. Combined, these typically yield
              15-30% A1–A5 reduction. Re-model and verify against the LETI band.
            </>
          }
          whyItMatters={
            <>
              Operational carbon falls every year as the grid decarbonises — embodied is
              once-and-done. For a building completing in 2026 with a 60-year life, embodied may
              already be larger than operational over the lifetime. M&E embodied is dominated by
              metals (switchgear, cabling, refrigeration plant); M&E designers must now manage
              embodied as a first-order design decision, not an afterthought.
            </>
          }
        />
