...
const DESCRIPTION =
  'Comprehensive guide to designing outdoor electrical installations including IP ratings, UV protection, weatherproofing, and environmental considerations under BS 7671.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The first digit (0-6) indicates protection against solid objects and dust. IP6X means dust-tight (no ingress of dust). The second digit (0-9) indicates water protection level. IP65 therefore means dust-tight and protected against water jets.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'Ultraviolet radiation breaks down polymer chains in PVC and other cable sheaths, causing them to become brittle, crack, and eventually fail. This exposes conductors to moisture and creates shock and fire hazards. Black PVC or LSF cables have better UV resistance, or cables should be run in conduit.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 1,
    explanation:
      'Outdoor socket outlets must have 30mA RCD protection (Regulation 411.3.3) and meet IP44 minimum when closed. Many outdoor sockets achieve higher ratings. When in use with a plug inserted, IP protection is typically reduced, which is why RCD protection is critical.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      'Drip loops create a low point in the cable run before it enters an enclosure, so water runs off rather than following the cable sheath into the equipment. Cable entries should be at the bottom of enclosures where possible, with glands providing both mechanical retention and water sealing.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'An external light fitting is to be installed at 2.5m height on a house wall. What minimum IP rating is typically required?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'For general outdoor use where driving rain and splashing water are expected, IP44 is typically the minimum. Higher ratings (IP65) are preferable and often specified. The specific location and exposure level should guide the final selection.',
  },
  {
    id: 2,
    question:
      'What BS 7671 classification system describes environmental conditions affecting installations?',
    options: [
      'IP classification',
    ...
    correctAnswer: 1,
    explanation:
      'Appendix 5 of BS 7671 provides the external influences classification using a three-character code. The first letter indicates the environment category (A-ambient, B-utilisation, C-building structure), the second indicates the specific influence, and the number indicates severity.',
  },
  {
    id: 3,
    question:
      'Why is steel wire armoured (SWA) cable commonly specified for outdoor underground installations?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "SWA cable's steel wire armour provides excellent mechanical protection for direct burial, resistance to impact and rodent damage, and can serve as the circuit protective conductor (though a separate CPC is often included). It's suitable for outdoor and underground applications without additional conduit.",
  },
  {
    id: 4,
    question:
      'At what minimum depth should cables be buried when installed directly in the ground?',
    options: [
      '150mm below surface',
    ...
    correctAnswer: 1,
    explanation:
      'BS 7671 requires minimum 450mm depth in private locations (600mm recommended) and 500mm under vehicular areas. This provides protection from normal gardening activities and light loads. Cable route markers or warning tape should be installed above the cable.',
  },
  {
    id: 5,
    question:
      'What consideration applies to cable current ratings for outdoor installations in direct sunlight?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Direct sunlight can raise cable surface temperature significantly above ambient air temperature. This must be considered in the cable sizing calculation - effectively treating the installation as having a higher ambient temperature. Black surfaces absorb more heat than white.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      "The 'AD' prefix indicates water presence (A=environment, D=water). AD4 specifically means 'splashing water' - equivalent to IPX4 protection requirements. This classification helps designers select appropriate equipment ratings for the conditions.",
  },
  {
    id: 7,
    question:
      'Why should stainless steel or hot-dip galvanised fixings be used for outdoor electrical installations?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Standard zinc-plated fixings corrode quickly outdoors, especially in coastal or industrial areas. Corroded fixings can fail, allowing equipment to fall, and rust can track into enclosures. Stainless steel (A2 or A4 grade) or hot-dip galvanised fixings provide long-term durability.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      "While the SELV circuit itself doesn't require RCD protection, the 230V supply feeding the transformer must have 30mA RCD protection as it's an outdoor installation. The transformer provides the separation, but the mains supply side remains a standard outdoor circuit.",
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Coastal installations face accelerated corrosion from salt spray and salt-laden air. This requires stainless steel (marine grade A4/316), special anti-corrosion finishes, sealed enclosures, and potentially more frequent maintenance schedules. Standard galvanised or aluminium components may fail prematurely.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'BS 7671 cable ratings are based on 30 degrees C ambient. Higher temperatures require derating (lower current capacity); lower temperatures allow increased ratings. Outdoor installations must consider seasonal extremes and localised heating from solar gain.',
  },
  {
    id: 11,
    ...
    correctAnswer: 1,
    explanation:
      'Outdoor junction boxes must achieve the IP rating required for their exposure level (typically IP65 or higher), be suitable for the temperature range, and remain accessible for inspection and maintenance. Gel-filled or resin-filled junction boxes provide excellent protection for buried connections.',
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      'The IK rating (IK00 to IK10) measures impact resistance - how well an enclosure withstands mechanical impacts measured in joules. Outdoor installations in public areas or at low level may need higher IK ratings (IK07 to IK10) to resist vandalism and accidental damage.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>IP Ratings:</strong> First digit = solids (0-6), second = water (0-9)
              </li>
              <li>
                <strong>UV Protection:</strong> Standard PVC degrades - use UV-stable materials
              </li>
              <li>
                <strong>RCD Required:</strong> All outdoor circuits need 30mA RCD protection
              </li>
              <li>
                <strong>Burial Depth:</strong> 450mm minimum, 500mm under roads
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Cracked brittle conduit and yellowed enclosures from UV
                damage
              </li>
              <li>
                <strong>Use:</strong> External influence codes from Appendix 5 in specifications
              </li>
              <li>
                <strong>Apply:</strong> Drip loops and bottom-entry glands for water protection
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The IP (Ingress Protection) rating system, defined in BS EN 60529, provides a
              standardised method of describing the level of protection an enclosure offers against
              the intrusion of solid objects and water. Understanding this system is essential for
              specifying outdoor electrical equipment correctly.
            </p>
            <p>
              The IP code consists of two digits: the first indicates solid particle protection
              (0-6), and the second indicates water protection (0-9). An 'X' replaces either digit
              when that protection level is not specified or tested.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> IP ratings are tested under specific laboratory conditions.
              Real-world performance may vary with age, installation quality, and maintenance.
              Always select a higher rating than the minimum required for critical applications.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Ultraviolet radiation from sunlight is one of the most destructive environmental
              factors for electrical installation materials. UV radiation breaks down polymer chains
              in plastics, causing them to become brittle, discoloured, and eventually fail. This
              process is called photo-degradation.
            </p>
            <p>
              Standard PVC cable sheathing and white conduit are particularly vulnerable. In direct
              sunlight, these materials can show significant degradation within 3-5 years,
              potentially exposing conductors or allowing water ingress through cracks.
            </p>
            ...
            <p>
              The colour of materials affects UV resistance - black materials contain carbon black
              which absorbs UV radiation and protects the underlying polymer. This is why black
            ...
            <p className="text-sm text-white italic">
              ...
              specification would have been black UV-stabilised conduit or galvanised steel conduit
              with proper fixings.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 7671 Regulation 411.3.3 requires socket outlets rated up to 32A for use outdoors to
              have additional protection by means of a 30mA RCD. This applies whether the socket is
              wall-mounted, in a dedicated outdoor enclosure, or installed in an outbuilding.
            </p>
            <p>
              The combination of higher moisture levels, reduced footwear protection, and the
              likelihood of using portable equipment outdoors creates elevated shock risk compared
              to indoor locations. RCD protection provides rapid disconnection for earth faults
              before dangerous shock can occur.
            </p>
            ...
            <p>
              External distribution equipment and isolators must also be appropriately rated.
              Outdoor consumer units and switchgear should achieve IP65 or IP66 ratings, with gasket
              seals and cable entries properly maintained to preserve the protection level.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Underground cable installation is common for outdoor supplies to outbuildings, garden
              lighting, and external equipment. Proper installation protects cables from mechanical
              damage, provides a neat appearance, and enables maintenance access through the
              structure above.
            </p>
            <p>
              Steel wire armoured (SWA) cable is the standard choice for underground installation.
              The armour provides mechanical protection allowing direct burial, and the steel wires
              can serve as the circuit protective conductor (CPC) - though many designers include an
              additional copper CPC for belt-and-braces protection.
            </p>

            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-white mb-3">
                Underground Installation Depths:
              </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  5. Install cable tiles or covers for additional protection (optional but
                  recommended)
                </li>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Always record the actual route of buried cables with
              measurements from permanent features. As-built drawings are essential for future work
              and avoiding accidental damage. Consider using a GPS record for accuracy.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Specify IP ratings based on location exposure - IP44 minimum, IP65/66 for exposed
                  positions
                </li>
                <li>
                  Use stainless steel (A2/A4) or hot-dip galvanised fixings for all outdoor
                  applications
                </li>
                <li>
                  Select UV-stabilised conduit, trunking and accessories (usually black or grey)
                </li>
                <li>
                  Choose EPDM or silicone gaskets that maintain flexibility in temperature extremes
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Wrong IP specification</strong> - Using IP44 equipment where IP65 is
                  needed
                </li>
                <li>
                  <strong>Standard fixings</strong> - Using zinc-plated screws that corrode within
                  months
                </li>
                <li>
                  <strong>White conduit outdoors</strong> - Becomes brittle from UV within 2-3 years
                </li>
                <li>
                  <strong>Shallow cable burial</strong> - Cables damaged by gardening or ground
                  settlement
                </li>
                <li>
                  <strong>Missing drip loops</strong> - Water follows cables directly into
                  enclosures
                </li>
                <li>
                  <strong>No cable route records</strong> - Future excavations damage unknown cable
                  routes
                </li>
              </ul>
            </div>
