      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <header className="text-center mb-12">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3">
            Outdoor Installations and External Influences
          </h1>
          <p className="text-white/80">
            Designing robust electrical systems for outdoor environments - IP ratings, UV protection, and weatherproofing
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "IP rating system and equipment selection for outdoor use",
              "Effects of UV radiation on cables and enclosures",
              "Underground cable installation requirements",
              "External influences classification system",
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module6-section4-4-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous: Bathrooms
            </Link>
          </Button>
          <Button
            ...
            asChild
          >
            <Link to="../level3-module6-section4-4-3">
