...
const TITLE =
  'Mounting Socket Outlets, Switches, and Spurs - Module 4.5.1 | Level 2 Electrical Course';
const DESCRIPTION =
  'Master the correct procedures for mounting socket outlets, switches, and spurs. Learn positioning requirements, fixing methods, wiring connections, and testing procedures according to BS 7671 and Building Regulations Part M.';

const quickCheckQuestions = [
  {
    id: 1,
    question:
      'What is the typical mounting height for socket outlets in new builds according to Part M?',
    options: ['300mm', '450mm', '500mm'],
    correctIndex: 1,
    explanation:
      'Part M of Building Regulations requires socket outlets to be mounted at 450mm to the bottom edge from finished floor level in new builds for accessibility.',
  },
  {
    id: 2,
    ...
    correctIndex: 1,
    explanation:
      'Grommets protect cable insulation from damage caused by sharp edges of the knockout holes in back boxes.',
  },
  {
    id: 3,
    ...
    correctIndex: 0,
    explanation:
      'The modern UK standard uses green/yellow sleeving for earth conductors in accordance with BS 7671.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'The main types are flush-mounted (for plastered walls), surface-mounted (for workshops/garages), and dry-lining boxes (for partition walls).',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Grommets protect cables from sharp edges of knockout holes and prevent damage to cable insulation.',
  },
  {
    id: 6,
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Socket outlet heights:</strong> 450mm to bottom edge from finished
                    floor level in new builds
                  </li>
                  <li>
                    • <strong>Switch heights:</strong> 1200mm to centre from finished floor level
                    for accessibility
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h4 className="font-medium text-white mb-2">
                  BS 7671 Safety and Installation Requirements
                </h4>
                <ul className="space-y-2 text-sm">
                  <li>
                    • Safe zones for cable routes: Accessories must be positioned to maintain safe
                    cable routes
                  </li>
          ...
          <section className="mb-10 pt-8 border-t border-white/10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Flush-mounted boxes:</strong> For plastered walls in domestic and
                    commercial applications
                  </li>
                  <li>
                    • <strong>Surface-mounted boxes:</strong> Workshops, garages, temporary
                    installations
                  </li>
                  <li>
                    • <strong>Dry-lining boxes:</strong> Plasterboard partition walls without solid
                    backing
                  </li>
                </ul>
                <p className="text-xs text-white mt-3 p-2 bg-black/20 rounded">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h4 className="font-medium text-white mb-2">
                  Wall Construction and Fixing Selection
                </h4>
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Solid masonry:</strong> Brown plugs (size 6) for brick, grey plugs
                    (size 8) for concrete
                  </li>
                  <li>
                    • <strong>Hollow construction:</strong> Spring toggles for plasterboard,
                    expanding anchors for cavity walls
                  </li>
          ...
          <section className="mb-10 pt-8 border-t border-white/10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h4 className="font-medium text-white mb-2">
                  BS 7671 Harmonised Colours (post-2004)
                </h4>
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Live (Line):</strong> Brown conductor to L terminal
                  </li>
                  <li>
                    • <strong>Neutral:</strong> Blue conductor to N terminal
                  </li>
                  <li>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Unfused spur:</strong> Maximum one single or one double socket per
                    spur
                  </li>
                  <li>
                    • <strong>Fused spur:</strong> 13A fuse maximum, FCU must be accessible
                  </li>
          ...
          <section className="mb-10 pt-8 border-t border-white/10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    • <strong>Insulation resistance:</strong> minimum 1MΩ at 500V DC
                  </li>
                  <li>
                    • <strong>Earth continuity:</strong> typically 0.05-1.38Ω for domestic circuits
                  </li>
                  <li>
            ...
            <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
              ...
              <div className="p-3 bg-green-500/10 border border-green-500/20 rounded">
                <p className="text-green-400 text-sm">
                  <strong>Lesson learned:</strong> Always verify which regulations apply to specific
                  areas of a project. Check Part M compliance requirements during the design phase
                  and confirm mounting heights with building control before installation begins.
                </p>
              </div>
            </div>
          </section>
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              thorough testing ensure the installation is safe, compliant, and professional.
            </p>
          </div>
          ...
          <Quiz
            ...
            title="Test your knowledge of mounting socket outlets, switches, and spurs"
          />
