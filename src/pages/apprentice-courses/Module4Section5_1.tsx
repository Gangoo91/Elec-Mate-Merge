      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Regulatory Requirements and Standard Heights</h3>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Building Regulations Part M Requirements</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Socket outlet heights:</strong> 450mm to bottom edge from finished floor level in new builds.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Switch heights:</strong> 1200mm to centre from finished floor level for accessibility.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Special considerations:</strong></p>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">BS 7671 Safety and Installation Requirements</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Safe zones for cable routes:</strong> Accessories must be positioned to maintain safe cable routes.</p>
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Circuit protection and design:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Site-Specific Requirements and Client Specifications</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Design drawings take precedence:</strong> Always follow project specifications over general guidelines.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Special environment considerations:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Box Selection and Fixing Methods</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Flush-mounted boxes:</strong> For plastered walls in domestic and commercial applications.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Surface-mounted boxes:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Dry-lining boxes:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Solid masonry walls:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Hollow construction:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Accurate marking out:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Installation best practice:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Installation Procedures and Wiring</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Cable Preparation and Stripping</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Conductor preparation:</strong> Strip insulation carefully to avoid nicking copper conductors.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Cable types and preparation:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Earth conductor requirements:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Correct Terminal Connections</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>BS 7671 harmonised colours (post-2004):</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Terminal tightening procedure:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Ring final circuit connections:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Spur Connections and Protection</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Unfused spur limitations:</strong> Maximum one single or one double socket per spur.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Fused spur requirements:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Cable routing for spurs:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Testing and Quality Control</h3>
            <p className="text-xs sm:text-sm text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">Pre-Energising Safety Tests</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Continuity of protective conductors:</strong> Verify earth path integrity through all accessories.</p>
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Acceptable test values:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">Functional Testing and RCD Verification</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>RCD testing requirements:</strong> All socket circuits require 30mA RCD protection.</p>
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>RCD test procedure:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Socket outlet functional tests:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">Visual Inspection and Professional Finish</p>
                    ...
                    <p className="text-xs sm:text-sm text-foreground mb-2"><strong>Professional finishing standards:</strong></p>
                    <ul className="text-xs text-foreground ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-sm">
            <div>
              <h3 className="font-medium text-foreground mb-3">Planning and Measurement</h3>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-muted/50 rounded-lg border">
              <p className="font-medium text-foreground mb-2">What is the standard socket outlet height for new builds under Part M?</p>
              <p className="text-sm text-muted-foreground">450mm to the bottom edge from finished floor level for accessibility compliance in new construction.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg border">
              <p className="font-medium text-foreground mb-2">Why must earth conductors be sleeved in green/yellow?</p>
              <p className="text-sm text-muted-foreground">BS 7671 requires clear identification of protective conductors to prevent confusion and ensure safety during maintenance.</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg border">
              <p className="font-medium text-foreground mb-2">What is the maximum number of sockets allowed on an unfused spur?</p>
              <p className="text-sm text-muted-foreground">One single socket or one double socket maximum per unfused spur from a ring final circuit.</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-medium text-foreground mb-2">Q: Can socket heights vary from the standard Part M recommendation?</h3>
              <p className="text-sm text-muted-foreground">A: Yes, in retrofit works or special needs environments, different heights may be specified. Always follow project drawings and confirm with building control for new work.</p>
            </div>
            <Separator />
            <div>
              <h3 className="font-medium text-foreground mb-2">Q: What is the main reason for sleeving earth conductors?</h3>
              <p className="text-sm text-muted-foreground">A: To provide clear identification and prevent accidental contact with live parts during installation and maintenance work.</p>
            </div>
            <Separator />
            <div>
              <h3 className="font-medium text-foreground mb-2">Q: Do spurs need to be on the same RCD as the ring final circuit?</h3>
              <p className="text-sm text-muted-foreground">A: Yes, spurs must have the same protective device as the circuit they are fed from, including RCD protection for socket circuits.</p>
            </div>
          </div>
        </Card>
