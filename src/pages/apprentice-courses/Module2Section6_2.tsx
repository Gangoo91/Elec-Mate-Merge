...
const Module2Section6_2: React.FC = () => {
  ...
  const faqs = [
    {
      q: 'What is a kWh?',
      a: 'A kilowatt‑hour (kWh) is a unit of energy. 1 kWh is the energy used by a 1 kW appliance running for 1 hour.',
    },
    {
      q: 'How do I estimate cost?',
      a: 'Cost ≈ kWh × tariff. If tariff is in p/kWh, divide by 100 to get pounds.',
    },
    {
      q: 'Do standing charges apply?',
      a: 'Yes, most UK bills include a daily standing charge not covered in this simple estimate.',
    },
    {
      q: "What's a typical UK tariff?",
      a: 'As of 2024, around 25-35p/kWh for standard domestic tariffs, but varies by region and supplier. Business rates may differ.',
    },
    {
      q: 'How do time-of-use tariffs work?',
      a: 'Economy 7/10 offer cheaper night rates (~15p/kWh) vs day rates (~35p/kWh). Good for storage heaters, EV charging.',
    },
    {
      q: 'What about duty cycle?',
      a: "Many appliances don't run continuously. Fridges ~25%, thermostats 30-70%, PIR lights vary greatly. Affects energy calculations.",
    },
    {
      q: 'How do I read a smart meter?',
      a: 'Shows current usage (kW) and cumulative energy (kWh). Some display costs if tariff programmed. Check day/night registers separately.',
    },
    {
      q: "What's demand vs energy?",
      a: 'Demand (kW) is instantaneous power use - affects supply requirements. Energy (kWh) is total over time - affects bills.',
    },
    {
      q: 'How accurate are manufacturer ratings?',
      a: 'Usually maximum ratings. Actual consumption varies with load, temperature, efficiency. LED drivers often include losses.',
    },
    {
      q: 'What about seasonal variations?',
      a: 'Heating/cooling loads vary dramatically. Summer: AC, pool pumps. Winter: heating, more lighting hours. Plan accordingly.',
    },
    {
      q: 'How do I estimate unknown loads?',
      a: 'Use clamp meter for actual current, calculate P=VI×pf. Or use smart plugs for energy monitoring over time.',
    },
    {
      q: "What's the difference between input and output power?",
      a: 'Input is what you pay for (from supply). Output is useful work done. Efficiency = output/input. Motors ~85-95%, LED drivers ~90%.',
    },
  ];
    ...
    <div className="bg-[#1a1a1a] overflow-x-hidden">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Nameplates show W or kW; smart meters show kWh.
                </li>
                <li>
                  <strong>Use:</strong> Estimate kWh and cost to advise clients and compare options.
                </li>
                <li>
                  <strong>Check:</strong> Duty cycle and number of units (e.g., multiple lamps)
                  matter.
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <section className="mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
              <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
                ...
                <FormulaList
                  items={[{ text: 'Energy (kWh) = kW × time (h)' }, { text: 'kW = W ÷ 1000' }]}
                />
              </div>
              <div className="rounded-lg p-4 bg-transparent border border-amber-400/30">
                ...
                <FormulaList
                  items={[
                    { text: 'Cost (£) ≈ kWh × tariff (p/kWh) ÷ 100' },
                    { text: 'Daily cost ≈ (kW × h × tariff) ÷ 100' },
                  ]}
                />
                <p className="text-xs text-white mt-2">
                  Tariffs vary by supplier and time‑of‑use. Standing charges not included.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <Clock className="w-5 h-5 text-elec-yellow" /> Try it: Energy & cost calculator
            </h3>
            <p className="text-sm text-white mb-3">
              Estimate daily and period energy use and cost. Use duty cycle for intermittent loads
              (e.g., thermostats, lighting controls).
            </p>
            <EnergyCostCalc />
          </section>
          ...
          <section className="mb-6">
            ...
            <ul className="space-y-4 text-xs sm:text-sm text-white">
              <li className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
                ...
                <p>
                  <strong>Given:</strong> 8 lamps × 6 W = 48 W total, on for 5 h/day. Tariff 28
                  p/kWh.
                </p>
                <p>
                  <strong>Energy/day:</strong> 0.048 kW × 5 = 0.24 kWh. <strong>Cost/day:</strong>{' '}
                  0.24 × £0.28 ≈ £0.07.
                </p>
              </li>
              <li className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
                ...
                <p>
                  <strong>Given:</strong> 2.2 kW, 1.5 h per use, 3 uses/week. Tariff 30 p/kWh.
                </p>
                <p>
                  <strong>Weekly energy:</strong> 2.2 × 1.5 × 3 = 9.9 kWh.{' '}
                  <strong>Weekly cost:</strong> 9.9 × £0.30 ≈ £2.97.
                </p>
              </li>
              <li className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
                <p className="font-medium">3) Fridge (duty cycle)</p>
                <p>
                  <strong>Given:</strong> 120 W compressor but ~25% duty over 24 h.
                </p>
                <p>
                  <strong>Daily energy:</strong> 0.12 kW × 24 × 0.25 ≈ 0.72 kWh.
                </p>
              </li>
            </ul>
          </section>
                ...
                <div className="space-y-4">
                  <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-xs sm:text-sm text-white">
                      <p>
                        <strong>Power:</strong> 1kW = 1000W
                      </p>
                      <p>
                        <strong>Time:</strong> 1h = 60 min
                      </p>
                      <p>
                        <strong>Current est:</strong> 1kW ≈ 4.3A @ 230V
                      </p>
                      <p>
                        <strong>Cost:</strong> p/kWh ÷ 100 = £/kWh
                      </p>
                      <p>
                        <strong>Daily to annual:</strong> × 365
                      </p>
                    </div>
                  </div>
            ...
            <div className="space-y-6">
              ...
              <div className="border border-white/10 rounded-lg p-4 bg-elec-yellow/5">
                <h4 className="font-semibold text-white mb-3">
                  Scenario 1: Household Bill Shock Investigation
                </h4>
                ...
                <div className="mt-3 p-3 border border-amber-400/30 rounded text-sm">
                  ...
                  <p className="text-white">
                    Failed immersion thermostat (24/7 = 72 kWh/day extra), faulty storage heater
                    control, or heating left on 24/7. 400 kWh increase ≈ 17 kWh/day continuous load.
                  </p>
                </div>
              </div>
              ...
              <div className="border border-white/10 rounded-lg p-4 bg-transparent">
                <h4 className="font-semibold text-white mb-3">
                  Scenario 2: Office Energy Audit - LED vs Fluorescent
                </h4>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                ...
                <div className="mt-3 p-3 border border-elec-yellow/30 rounded text-sm">
                  ...
                  <p className="text-white">
                    At 25p/kWh: Annual saving = 21,000 × £0.25 = £5,250. Payback typically 2-3 years
              ...
              <div className="border border-white/10 rounded-lg p-4 bg-elec-yellow/5">
                <h4 className="font-semibold text-white mb-3">
                  Scenario 3: Home EV Charging - Tariff Optimisation
                </h4>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                ...
                <div className="mt-3 p-3 border border-border/30 rounded text-sm">
                  ...
                  <p className="text-white">
                    Standard: EV £849/year. Economy 7: EV £477/year. Annual EV saving: £372. But
                    check if house day usage increases overall bill.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
              ...
              <li>
                Always verify nameplate ratings; measured current may differ due to pf/efficiency.
              </li>
              <li>Document energy assessments for Part L compliance and carbon calculations.</li>
              <li>
                Consider smart controls and timers to optimise energy use and reduce demand charges.
              </li>
            </ul>
            <div
