...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['3.0 kW', '2.94 kW', '29.4 kW', '0.3 kW'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['2.12 kW', '3.83 kW', '4.08 kW', '2.94 kW'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Increase total head', 'Reduce cavitation', 'Increase flow rate', 'Improve priming'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['1.41 kW', '3.5 kW', '1.0 kW', '2.07 kW'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Pump types, performance curves, efficiency, the affinity laws, and NPSH for building
          services design.
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The ErP framework sets minimum efficiency for circulator pumps. As an HNC designer
              your pump selection must be both technically correct (BEP, NPSH) and regulatorily
              compliant (MEI, EEI ≤ 0.23 for glandless circulators).
            </>
          }
        ...
        >
          ...
          <p>
            <strong>Multi-stage centrifugal:</strong> Multiple impellers in series. Flow stays the
            same, heads add together. Used for high-rise buildings, booster sets, pressure boosting.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            A pump performance chart usually shows three curves overlaid: head (H) versus flow (Q),
            efficiency (η) versus Q, and power (P) versus Q.
          </p>
          <p>
          ...
          <p>
            <strong>Power curve:</strong> Power increases with flow. Useful for sizing the motor and
            checking it isn't overloaded across the full operating range.
          </p>
          <p>
            <strong>Trimmed impellers:</strong> Most curves show several impeller diameters.
            Trimming reduces head and power without changing the pump body — used to fine-tune to
            the duty point.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Hydraulic (water) power:</strong> Ph = ρgQH. The useful power delivered to the
            fluid.
          </p>
          <p>
          ...
          <p>
            <strong>Why VSDs save energy:</strong> Reducing pump speed by 20% drops power to 0.8³ =
            0.51 — nearly half. This is why variable speed drives are standard on variable-volume
            HVAC systems.
          </p>
          <p>
            <strong>BEP (Best Efficiency Point):</strong> The flow at which the pump runs most
            efficiently. Aim to operate within ±20% of BEP. Outside that band, vibration and wear
            increase.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            pressure. Vapour bubbles form, then collapse violently, causing noise, vibration, and
            erosion of impeller metal.
          </p>
          <p>
            <strong>NPSH available (NPSHa):</strong> What the system delivers to the pump suction.
            NPSHa = (Patm + ρgHs - Pvap) / ρg - Hf. Where Hs = static head above pump suction, Pvap
            = vapour pressure at fluid temperature, Hf = suction friction losses.
          </p>
          <p>
            <strong>NPSH required (NPSHr):</strong> Specified by pump manufacturer for each duty.
          ...
          <p>
            ...
            discharge valve. This minimises starting current — pump runs at shutoff head, low power.
            Open the valve once the motor is at full speed.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Ph = ρgQH = 1000 × 9.81 × 0.012 × 25 = <strong>2.94 kW</strong>
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Ps = 2.94 / 0.72 = <strong>4.08 kW</strong>
            </li>
            <li>Motor must deliver at least this much, with margin</li>
          </ul>
          <p>
            <strong>Example 3 - affinity laws (speed reduction):</strong> Duty point 15 l/s at 20 m
            head. Reduce speed to 80%.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Q₂ = 0.8 × 15 = <strong>12 l/s</strong>
            </li>
            <li>
              H₂ = 0.8² × 20 = <strong>12.8 m</strong>
            </li>
            <li>
              P₂ / P₁ = 0.8³ = <strong>0.512</strong> (49% energy saving)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Operating range: <strong>±20% of BEP flow</strong>
            </li>
            <li>
              NPSH safety margin: <strong>0.5-1.0 m</strong>
            </li>
            <li>
              Min VSD speed: <strong>30-40%</strong>
            </li>
            <li>
              Pump efficiency: <strong>typically 60-80%</strong>
            </li>
            <li>
              Motor efficiency: <strong>typically 85-95%</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Oversizing</strong> — Operating far left of BEP wastes energy and shortens
                life
              </li>
              <li>
              ...
              <li>
                <strong>Wrong control method</strong> — Throttling wastes energy; use VSD where flow
                varies
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A chilled-water riser pump has been replaced. After commissioning the pump makes a
              rattling noise and head drops 25% intermittently. Suction is from a 10 m vertical rise
              off a buffer vessel at 5 °C; pump is at the top of the rise.
            </>
          }
          whatToDo={
            <>
              Diagnose as cavitation. Calculate NPSHa = (P_atm + P_static - P_vapour)/ρg - friction
              loss in suction. With 10 m suction lift, only ~0 m static head is left after the lift;
              NPSHa likely below NPSHr. Reposition pump below the vessel to gain suction head,
              increase suction pipe size to reduce friction loss, or add a small booster on the
              suction. Recheck NPSHa &gt; NPSHr + 0.5 m margin. Document the change in the as-built.
            </>
          }
          whyItMatters={
            <>
              Cavitation pits the impeller, drops efficiency and shortens pump life from 15 years to
              18 months. NPSH is the single most-overlooked pump-selection check on a building
              services design.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Pipe sizing</div>
          </button>
          <button
