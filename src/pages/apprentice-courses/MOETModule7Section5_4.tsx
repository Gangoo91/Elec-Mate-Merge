...
const DESCRIPTION =
  'A comprehensive guide to what happens on EPA day for the MOET ST1426 standard: practical observation, professional discussion, what to bring, how to conduct yourself, dealing with unexpected situations and understanding the grading process.';
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Everyone can make mistakes under assessment pressure. What matters is how you handle it: recognise the error, explain what went wrong, take corrective action, and continue professionally. This demonstrates self-awareness, problem-solving and professional resilience — all positive assessment criteria. Trying to hide a mistake is far worse than handling one well.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Failing the EPA is not the end. You are entitled to retake the failed component(s) — the assessment plan specifies the retake window and process. Your training provider will help you understand what areas need improvement and support your preparation for the retake. Many successful technicians did not pass every assessment on the first attempt.',
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      'The EPA assesses your overall professional competence. This includes safety (always paramount), systematic working methods, technical knowledge, communication skills, and reflective practice. The assessor is looking for a well-rounded professional who works safely, thinks clearly, and can explain what they are doing and why. Consistency across the day matters more than any single brilliant moment.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'This depends on the components scheduled. The practical observation typically takes 3-5 hours (including preparation and clear-up), and the professional discussion takes 45-60 minutes. If both are on the same day, expect to be there for most of the day. Some EPAOs schedule components on different days — check with your training provider.',
  },
  {
    question: 'What happens if I am ill on EPA day?',
    answer:
      'Contact your training provider and the EPAO immediately. If you are genuinely unwell, the assessment will be rescheduled. Do not attend if you are too ill to perform to your best — it is better to rearrange than to underperform due to illness. Most EPAOs have clear policies for absence and rescheduling.',
  },
];
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              ...
              assessor who sees you encounter something unfamiliar and respond calmly,
