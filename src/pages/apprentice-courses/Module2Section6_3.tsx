...
const Module2Section6_3: React.FC = () => {
  ...
  const faqs = [
    {
      ...
      a: 'Efficiency (%) = (useful output power ÷ input power) × 100. Losses (heat, sound, vibration) reduce efficiency.',
    },
    {
      q: 'Is efficiency always below 100%?',
      a: 'Yes in real systems. Some input power is lost as heat and other non-useful outputs.',
    },
    {
      q: 'Why does it matter for BS 7671?',
      a: 'Lower efficiency means higher current for the same useful output, which impacts cable sizing, protection and energy costs.',
    },
    {
      q: 'What are typical efficiency values for common equipment?',
      a: 'LED lamps: 80-90%, transformers: 95-98%, motors: 80-95%, power supplies: 85-95%. Higher efficiency usually costs more initially but saves energy.',
    },
    {
      q: 'How does temperature affect efficiency?',
      a: 'Heat generally reduces efficiency in most equipment. Good ventilation and correct ambient conditions help maintain rated efficiency.',
    },
    {
      q: 'Can efficiency be improved after installation?',
      a: 'Limited options: ensure proper ventilation, clean contacts, correct loading, and consider replacing very old equipment with modern efficient alternatives.',
    },
    {
      q: "What's the difference between efficiency and power factor?",
      a: 'Efficiency is useful output ÷ total input. Power factor relates to AC phase relationships. Both affect current draw but in different ways.',
    },
    {
      q: 'Do voltage variations affect efficiency?',
      a: 'Yes. Equipment typically has optimal efficiency at rated voltage. Under-voltage can reduce efficiency in motors; over-voltage can increase losses in some equipment.',
    },
  ];
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: [
        'Conduction of useful power',
        'Heat in windings/cores',
        'Perfect conversion',
        'Power factor of 1',
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'More input power is needed for the same useful output → current increases (single‑phase).',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      options: [
        'Motors are always 100% efficient',
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'High ambient temperature increases internal component temperatures, raising resistance and reducing efficiency.',
    },
  ] as const;
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  Better efficiency → less input power for the same job → lower current and cost.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Motor and transformer datasheets list efficiency.
                </li>
                <li>
                  <strong>Use:</strong> Compare equipment and estimate running cost/current draw.
                </li>
                <li>
                  <strong>Check:</strong> Ventilation/cooling affects efficiency and safety.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
            ...
            <li>
              Relate efficiency to current draw, heat, cable sizing and BS 7671 considerations.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <Calculator className="w-5 h-5" /> Plain-English overview
            </h3>
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
              <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/10">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  ...
                  <li>
                    Example: A motor taking 1000 W and delivering 800 W is about 80% efficient.
                  </li>
                </ul>
              </div>
            ...
            <div className="mt-4 p-4 bg-gradient-to-r from-elec-yellow/10 to-indigo-500/10 border border-border/30 rounded-lg">
              <p className="font-medium mb-2 text-blue-700 text-elec-yellow">
              ...
              <ul className="grid md:grid-cols-2 gap-2 text-sm">
                <li>
                  ...
                  Input power - total electrical power consumed
                </li>
                <li>
                  <strong>
                    P<sub>out</sub> (or Pout):
                  </strong>{' '}
                  Output power - useful power delivered
                </li>
                <li>
                  <strong>η (eta):</strong> Efficiency symbol in calculations
                </li>
                <li>
                  <strong>Losses:</strong> Wasted power (usually as heat)
                </li>
              </ul>
            </div>

            <p className="mt-3 text-xs text-white">
              Tip: Good ventilation and correct installation help equipment run cooler and more
              efficiently.
            </p>
          </section>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <Settings className="w-5 h-5" /> Try it: Efficiency calculator
            </h3>
            <p className="text-sm text-white mb-3">
              Quickly estimate efficiency from input/output or find expected output from a known
              efficiency.
            </p>
          ...
          <section className="mb-6">
            ...
            <ul className="space-y-4 text-xs sm:text-sm text-white">
              <li className="rounded-lg p-4 bg-gradient-to-r from-elec-yellow/10 to-elec-yellow/10 border border-border/30">
                ...
                <p>
                  <strong>Given:</strong> P<sub>in</sub> = 1200 W, η = 85%.{' '}
                  <strong>
                    Find P<sub>out</sub>
                  </strong>
                </p>
                <p>
                  ...
                  ≈ 1200 × 0.85 = 1020 W. <strong>Loss</strong> ≈ 180 W (heat) – ensure ventilation.
                </p>
              </li>
              <li className="rounded-lg p-4 bg-gradient-to-r from-elec-yellow/10 to-elec-yellow/10 border border-elec-yellow/30">
                ...
                <p>
                  <strong>Given:</strong> P<sub>in</sub> = 2.0 kW, P<sub>out</sub> = 1.92 kW.{' '}
                  <strong>Find η</strong>
                </p>
                <p>
                  <strong>η</strong> ≈ 1.92/2.0 × 100 = 96%.
                </p>
              </li>
              <li className="rounded-lg p-4 bg-gradient-to-r from-amber-500/10 to-amber-600/10 border border-amber-400/30">
                ...
                <p>
                  <strong>Given:</strong> Driver η = 90%, lamp output 18 W.{' '}
                  <strong>Find approx. input</strong>
                </p>
                <p>
                  <strong>
                    P<sub>in</sub>
                  </strong>{' '}
                  ≈ 18 ÷ 0.9 = 20 W (ignoring pf). Higher driver losses mean more heat in fittings.
                </p>
              </li>
              <li className="rounded-lg p-4 bg-gradient-to-r from-purple-500/10 to-purple-600/10 border border-border/30">
                ...
                <p>
                  <strong>Scenario:</strong> Replace old 80% efficient motor with 90% efficient one
                  for same 5kW output.
                </p>
                <p>
                  <strong>Old input:</strong> 5 ÷ 0.8 = 6.25 kW. <strong>New input:</strong> 5 ÷ 0.9
                  = 5.56 kW. <strong>Saving:</strong> 0.69 kW (11% reduction).
                </p>
              </li>
              <li className="rounded-lg p-4 bg-gradient-to-r from-rose-500/10 to-rose-600/10 border border-rose-400/30">
                ...
                <p>
                  <strong>Scenario:</strong> 100W computer PSU, 85% vs 95% efficiency, 8 hours/day,
                  250 days/year.
                </p>
                <p>
                  <strong>85% efficient:</strong> 100 ÷ 0.85 = 118W input.{' '}
                  <strong>95% efficient:</strong> 100 ÷ 0.95 = 105W input.
                </p>
                <p>
                  <strong>Annual saving:</strong> (118-105) × 8 × 250 ÷ 1000 = 26 kWh/year ≈ £8/year
                  per unit.
                </p>
              </li>
            </ul>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <Settings className="w-5 h-5" /> Real-world applications and considerations
            </h3>
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
              <div className="rounded-lg p-4 bg-gradient-to-br from-card/10 to-card/5 border border-white/10">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  ...
                  <li>
                    Heat pump efficiency (COP): 3-4 times more efficient than direct electric
                    heating
                  </li>
              ...
              <div className="rounded-lg p-4 bg-gradient-to-br from-elec-yellow/10 to-elec-yellow/5 border border-elec-yellow/30">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  ...
                  <li>
                    Transformers: 95-98% typical, but 2-5% loss on large systems is significant
                  </li>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2">
              Understanding efficiency in different equipment types
            </h3>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-4 bg-gradient-to-r from-elec-yellow/10 to-elec-yellow/10 border border-border/30">
                ...
                <p className="text-sm mb-2">
                  Motor efficiency varies with load, speed, and design quality.
                </p>
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Efficiency classes:</strong> IE1 (standard), IE2 (high), IE3 (premium),
                    IE4 (super premium)
                  </li>
                  <li>
                    <strong>Load dependency:</strong> Most efficient at 75-100% rated load
                  </li>
                  <li>
                    <strong>Losses:</strong> Stator copper (I²R), rotor losses, iron losses,
                    friction/windage
                  </li>
                  <li>
                    <strong>Impact factors:</strong> Voltage imbalance, harmonics, temperature
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-lg p-4 bg-gradient-to-r from-elec-yellow/10 to-elec-yellow/10 border border-elec-yellow/30">
                ...
                <p className="text-sm mb-2">
                  High efficiency devices but losses matter on large installations.
                </p>
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>No-load losses:</strong> Core losses occur even when unloaded
                  </li>
                  <li>
                    <strong>Load losses:</strong> I²R losses in windings increase with loading
                  </li>
                  <li>
                    <strong>Typical efficiency:</strong> 95-98% at rated load
                  </li>
                  <li>
                    <strong>Best practice:</strong> Size appropriately, avoid prolonged light
                    loading
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-lg p-4 bg-gradient-to-r from-amber-500/10 to-amber-600/10 border border-amber-400/30">
                ...
                <p className="text-sm mb-2">
                  LED drivers, power supplies, inverters - efficiency crucial for heat management.
                </p>
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  <li>
                    <strong>Switch-mode supplies:</strong> 80-95% efficiency typical
                  </li>
                  <li>
                    <strong>Linear supplies:</strong> Much lower efficiency, mostly heat
                  </li>
                  <li>
                    <strong>Heat management:</strong> Poor efficiency = more cooling needed
                  </li>
                  <li>
                    <strong>Power factor:</strong> Not the same as efficiency but affects system
                    current
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-6">
            ...
            <div className="rounded-lg p-4 bg-gradient-to-r from-slate-500/10 to-slate-600/10 border border-slate-400/30">
              <p className="text-sm mb-3">
                While Level 2 electricians don't typically perform detailed efficiency measurements,
                understanding the concepts helps with:
              </p>
              <ul className="list-disc pl-6 space-y-1 text-sm">
                <li>
                  <strong>Equipment selection:</strong> Compare manufacturer specifications
                </li>
                <li>
                  <strong>Installation verification:</strong> Check equipment operates within design
                  parameters
                </li>
                <li>
                  <strong>Troubleshooting:</strong> Recognize when efficiency has degraded
                </li>
                <li>
                  <strong>Client advice:</strong> Explain energy-saving opportunities
                </li>
              </ul>

              <div className="mt-4 p-3 bg-[#121212]/20 rounded border border-elec-yellow/30">
                <p className="text-sm">
                  <strong>Simple check:</strong> If equipment runs much hotter than expected,
                  efficiency may be poor. Always check ventilation, loading, and supply voltage
                  first.
                </p>
              </div>
            </div>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-2 flex items-center gap-2">
              <ThermometerSun className="w-5 h-5" /> BS 7671 context and good practice
            </h3>
            <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
              <li>
                Lower efficiency → higher current for same useful output. Verify cable sizing,
                voltage drop and Zs (Appendix 4 guidance).
              </li>
              <li>
                Consider heat build‑up: enclosures and lofts can reduce efficiency further; allow
                for ventilation and manufacturer instructions.
              </li>
              <li>
                Document choices; where motors are involved, note efficiency class where available.
              </li>
            </ul>
            <div
