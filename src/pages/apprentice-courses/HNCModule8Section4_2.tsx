    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>DOL:</strong> 6-8× FLC starting current, simplest method
              </li>
              <li className="pl-1">
                <strong>Star-Delta:</strong> Reduces current to 1/3 of DOL
              </li>
              <li className="pl-1">
                <strong>Autotransformer:</strong> Adjustable voltage taps
              </li>
              <li className="pl-1">
                <strong>Soft Starter:</strong> Smooth ramp, 2-4× FLC typical
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Pumps:</strong> Soft start prevents water hammer
              </li>
              <li className="pl-1">
                <strong>Fans:</strong> Reduced mechanical stress on belts
              </li>
              <li className="pl-1">
                <strong>Chillers:</strong> Staggered starting for demand limit
              </li>
              <li className="pl-1">
                <strong>Voltage drop:</strong> Keep below 6% during start
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              three-phase induction motors. The motor is connected directly to the full supply
              voltage at the instant of starting, resulting in maximum starting torque but also
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Acceleration time:</strong> Typically 2-10 seconds depending on motor and
                  load inertia
                </li>
                <li className="pl-1">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Set to motor FLC (trip class 10-30)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Short circuit device</td>
                      <td className="border border-white/10 px-3 py-2">
                        Protects against fault currents
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        MCCB or fuses (type gG or aM)
                      </td>
                    </tr>
                    <tr>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Supply authority requirements:</strong> For motors exceeding 5.5kW, always
              check with the Distribution Network Operator (DNO) regarding acceptable starting
              arrangements. They may impose restrictions on starting current magnitude and
              frequency.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Motor disconnected briefly during changeover
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        High spike (can reach 8-10× FLC)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Closed transition</td>
                      <td className="border border-white/10 px-3 py-2">
                        Resistors maintain connection during changeover
                      </td>
            ...
            <div className="my-6 p-4 rounded-lg bg-amber-500/10 border border-amber-500/30">
              ...
              <p className="text-sm text-white">
                Star-delta starting requires motors with <strong>6 accessible terminals</strong>{' '}
                (both ends of each winding brought out). The motor must be rated for delta
                connection at the supply voltage (e.g., 400V delta for a 400V supply). Motors wound
                for 400V star/690V delta cannot be used with star-delta starting on a 400V supply.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Timing consideration:</strong> The star-delta transition timer should be set
              to allow the motor to reach at least 75-80% of full speed before switching to delta.
              Too early transition causes high current spikes; too late wastes energy and extends
              acceleration time.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Autotransformer starters provide reduced voltage starting using tapped
              autotransformers to supply the motor at a reduced voltage during starting. This method
              offers flexibility in selecting the voltage reduction level and works with any
              three-phase motor.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  After acceleration, transformer bypassed and full voltage applied
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Thyristor control:</strong> Back-to-back thyristor pairs in each phase
                  control voltage by phase-angle firing
                </li>
                <li className="pl-1">
                  <strong>Voltage ramp:</strong> Applied voltage gradually increases from initial
                  value (typically 30-50%) to full voltage
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Current limiting:</strong> Maximum starting current can be set (typically
                  2-4× FLC)
                </li>
                <li className="pl-1">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        30-70% of V<sub>L</sub>
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Starting point for voltage ramp
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Maximum starting current allowed
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Controlled deceleration period
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              ...
              <div className="text-sm space-y-2">
                <p>
                  <strong>Centrifugal pumps:</strong> Soft start (5-15 seconds) prevents water
                  hammer, soft stop (10-30 seconds) prevents reverse flow surge. Current limit
                  typically 300-350% FLC.
                </p>
                <p>
                  <strong>Supply fans:</strong> Extended ramp time (10-20 seconds) reduces belt
                  stress and prevents duct pressure surges. Initial voltage 40-50% for smooth
                  breakaway.
                </p>
                <p>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                Many soft starters include internal or external bypass contactors that engage once
                the motor reaches full speed. This removes the thyristors from the circuit during
                running, eliminating conduction losses (typically 1-2% of motor power) and reducing
                heat generation. The soft starter remains ready to provide soft stop when required.
              </p>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Starting motor:</strong> Extended acceleration time, possible failure to
                  start
                </li>
              </ul>
            </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Transient condition during starting
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Starting Method Selection Based on Current
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                    <tr className="bg-white/5">
                      ...
                      <th className="border border-white/10 px-3 py-2 text-left">
                        Typical Starting Method
                      </th>
                      <th className="border border-white/10 px-3 py-2 text-left">
                        Approximate Starting Current
                      </th>
                    </tr>
                  </thead>
                  <tbody>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Comparing Starting Methods
              </h3>
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-3 text-green-400">
                  All reduced voltage methods achieve significant current reduction
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Pump Starting Method Selection
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-green-400">
                  Recommendation: Soft starter with 350% current limit, 15s ramp, 20s soft stop
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Supply Assessment for Multiple Motors
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p className="mt-2 text-green-400">
                  Recommended: Soft starters with staggered starting sequence (60s intervals)
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Determine motor size and FLC from nameplate or manufacturer data
                </li>
                <li className="pl-1">Calculate DOL starting current (typically 6-8× FLC)</li>
                <li className="pl-1">
                  Check supply authority requirements for maximum starting current
                </li>
                <li className="pl-1">Assess voltage drop impact on other connected equipment</li>
                <li className="pl-1">
                  Consider load characteristics (starting torque requirement)
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Wrong motor winding:</strong> Using star-delta with 400V star motor on
                  400V supply
                </li>
                <li className="pl-1">
