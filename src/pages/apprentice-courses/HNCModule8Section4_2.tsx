...
const quickCheckQuestions = [
  {
    ...
    options: ['6-8 times FLC', '2-3 times FLC', '10-12 times FLC', '4-5 times FLC'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['DOL starter', 'Star-delta starter', 'Soft starter', 'Autotransformer starter'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1.5-2 times FLC', '6-8 times FLC', '5-6 times FLC', '2-4 times FLC'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['840-1120A', '1400-1680A', '280-420A', '420-700A'],
    correctAnswer: 0,
    explanation:
...
const HNCModule8Section4_2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 4 · Subsection 2"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Direct On Line (DOL) Starting">
          <p>
            ...
            at the instant of starting, resulting in maximum starting torque but also maximum
            starting current.
          </p>
          <p>
            <strong>DOL Starting Characteristics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Starting current:</strong> 6-8 times Full Load Current (FLC) - this high
              inrush occurs because motor impedance is low at standstill
            </li>
            <li>
              <strong>Starting torque:</strong> 150-300% of Full Load Torque (FLT) - maximum
              available torque for any starting method
            </li>
            <li>
              <strong>Acceleration time:</strong> Typically 2-10 seconds depending on motor and load
              inertia
            </li>
            <li>
              <strong>Application limit:</strong> Usually restricted to motors up to 7.5kW on
              standard supplies
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Starting Current Calculation</strong>
          </p>
          <p>
          ...
          <p>
            <strong>DOL Starter Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Main contactor:</strong> Switches motor supply on/off — AC-3 rated for motor
              FLC
            </li>
            <li>
              <strong>Thermal overload:</strong> Protects against sustained overload — Set to motor
              FLC (trip class 10-30)
            </li>
            <li>
              <strong>Short circuit device:</strong> Protects against fault currents — MCCB or fuses
              (type gG or aM)
            </li>
            <li>
              <strong>Isolator:</strong> Safe isolation for maintenance — Rated for motor FLC
              minimum
            </li>
          </ul>
          <p>
            <strong>Supply authority requirements:</strong> For motors exceeding 5.5kW, always check
            with the Distribution Network Operator (DNO) regarding acceptable starting arrangements.
            They may impose restrictions on starting current magnitude and frequency.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Star-Delta Starting">
          ...
          <p>
            <strong>Star Connection (Starting)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Winding voltage = V<sub>L</sub>/√3 (230V from 400V supply)
            </li>
          ...
          <p>
            <strong>Delta Connection (Running)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Winding voltage = V<sub>L</sub> (400V)
            </li>
          ...
          <p>
            <strong>Star-Delta Mathematics</strong>
          </p>
          <p>Current reduction factor:</p>
          <p>
            I<sub>star</sub> = I<sub>DOL</sub> × (1/√3)² = I<sub>DOL</sub> × <strong>1/3</strong>
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Open transition:</strong> Motor disconnected briefly during changeover — High
              spike (can reach 8-10× FLC)
            </li>
            <li>
              <strong>Closed transition:</strong> Resistors maintain connection during changeover —
              Reduced spike (2-4× FLC)
            </li>
          </ul>
          <p>
            <strong>Suitable Applications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Unsuitable Applications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Motor Requirements</strong>
          </p>
          <p>
            Star-delta starting requires motors with <strong>6 accessible terminals</strong> (both
            ends of each winding brought out). The motor must be rated for delta connection at the
            supply voltage (e.g., 400V delta for a 400V supply). Motors wound for 400V star/690V
            delta cannot be used with star-delta starting on a 400V supply.
          </p>
          <p>
            <strong>Timing consideration:</strong> The star-delta transition timer should be set to
            allow the motor to reach at least 75-80% of full speed before switching to delta. Too
            early transition causes high current spikes; too late wastes energy and extends
            acceleration time.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Autotransformer Starting">
          ...
          <p>
            <strong>Current and Torque Relationships</strong>
          </p>
          ...
          <p>
            Starting torque = DOL × 0.65² = <strong>42% of DOL</strong>
          </p>
          <p>
            <strong>Common Tap Settings</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>50%:</strong> 25% of DOL — 25% of DOL — Very light starting loads
            </li>
            <li>
              <strong>65%:</strong> 42% of DOL — 42% of DOL — Fans, centrifugal pumps
            </li>
            <li>
              <strong>80%:</strong> 64% of DOL — 64% of DOL — Moderate starting loads
            </li>
          </ul>
          <p>
            <strong>Advantages</strong>
          ...
          <p>
            <strong>Design tip:</strong> Autotransformer starters are particularly useful when
            retrofitting reduced voltage starting to existing motors that have only 3 terminals
            (internal star or delta connection) and cannot use star-delta starting.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Soft Starters">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Thyristor control:</strong> Back-to-back thyristor pairs in each phase control
              voltage by phase-angle firing
            </li>
            <li>
              <strong>Voltage ramp:</strong> Applied voltage gradually increases from initial value
              (typically 30-50%) to full voltage
            </li>
            <li>
              <strong>Ramp time:</strong> Adjustable from 1-60 seconds depending on application
              requirements
            </li>
            <li>
              <strong>Current limiting:</strong> Maximum starting current can be set (typically 2-4×
              FLC)
            </li>
            <li>
              <strong>Soft stop:</strong> Gradual voltage reduction for controlled deceleration
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Initial voltage:</strong> 30-70% of V<sub>L</sub> — Starting point for voltage
              ramp
            </li>
            <li>
              <strong>Ramp time:</strong> 1-60 seconds — Duration of voltage increase
            </li>
            <li>
              <strong>Current limit:</strong> 150-500% FLC — Maximum starting current allowed
            </li>
            <li>
              <strong>Soft stop time:</strong> 0-60 seconds — Controlled deceleration period
            </li>
          </ul>
          <p>
            <strong>Advantages</strong>
          ...
          <p>
            <strong>HVAC Applications</strong>
          </p>
          <p>
            <strong>Centrifugal pumps:</strong> Soft start (5-15 seconds) prevents water hammer,
            soft stop (10-30 seconds) prevents reverse flow surge. Current limit typically 300-350%
            FLC.
          </p>
          <p>
            <strong>Supply fans:</strong> Extended ramp time (10-20 seconds) reduces belt stress and
            prevents duct pressure surges. Initial voltage 40-50% for smooth breakaway.
          </p>
          <p>
            <strong>Chillers:</strong> Soft starters enable staggered starting of multiple
            compressors, managing electrical demand and preventing simultaneous inrush.
          </p>
          <p>
            <strong>Bypass Contactors</strong>
          </p>
          <p>
            Many soft starters include internal or external bypass contactors that engage once the
            motor reaches full speed. This removes the thyristors from the circuit during running,
            eliminating conduction losses (typically 1-2% of motor power) and reducing heat
            generation. The soft starter remains ready to provide soft stop when required.
          </p>
          <p>
            <strong>Selection tip:</strong> When specifying soft starters, consider the duty cycle
            (starts per hour), ambient temperature, and enclosure type. Derate the soft starter
            capacity for high-frequency starting or elevated ambient temperatures.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Starting Current Impact and Voltage Drop">
          <p>
            ...
            other connected equipment. Understanding and calculating these effects is essential for
            selecting appropriate starting methods and ensuring system compatibility.
          </p>
          <p>
            <strong>Effects of Excessive Voltage Drop</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lighting:</strong> Visible flicker causing occupant complaints
            </li>
            <li>
              <strong>IT equipment:</strong> Potential data corruption or system resets
            </li>
            <li>
              <strong>Other motors:</strong> Reduced torque, possible stalling
            </li>
            <li>
              <strong>Control systems:</strong> Contactor dropout, relay malfunction
            </li>
            <li>
              <strong>Starting motor:</strong> Extended acceleration time, possible failure to start
            </li>
          </ul>
          <p>
            <strong>Voltage Drop Calculation</strong>
          </p>
          ...
          <p>
            <strong>Voltage Drop Limits</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BS 7671 guidance:</strong> 6% maximum — Transient condition during starting
            </li>
            <li>
              <strong>DNO requirements:</strong> 3-6% (varies) — Check with local DNO
            </li>
            <li>
              <strong>Sensitive equipment:</strong> &lt;3% — IT, medical, process control
            </li>
          </ul>
          <p>
            <strong>Worked Example: Voltage Drop Assessment</strong>
          </p>
          <p>Given:</p>
          ...
          <p>
            Z<sub>transformer</sub> = (400² × 0.04) / 500,000 = 0.0128Ω
          </p>
          <p>
            Z<sub>cable</sub> = 50 × 0.022 = 1.1Ω (simplified)
          </p>
          <p>ΔV = 294 × (0.0128 + 0.0011) = 4.1V from transformer</p>
          <p>
            ΔV% at motor = approx. <strong>5-7%</strong> (detailed calc. required)
          </p>
          <p>Result: Reduced voltage starting recommended</p>
          <p>
            <strong>Starting Method Selection Based on Current</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>&lt;7.5kW:</strong> DOL — 6-8× FLC
            </li>
            <li>
              <strong>7.5-30kW:</strong> Star-delta or Soft starter — 2-4× FLC
            </li>
            <li>
              <strong>30-75kW:</strong> Soft starter preferred — 2-3× FLC
            </li>
            <li>
              <strong>&gt;75kW:</strong> Soft starter or VSD — 1.5-2.5× FLC
            </li>
          </ul>
          <p>
            <strong>Design consideration:</strong> For critical installations, perform detailed
            voltage drop calculations including supply impedance data from the DNO. Consider power
            factor correction and its interaction with motor starting currents.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Compare starting currents for a 37kW motor (FLC = 70A, 7× DOL
            multiplier) using different starting methods.
          </p>
          <p>DOL Starting:</p>
          <p>
          ...
          <p>
            <strong>Scenario:</strong> Select starting method for a 15kW chilled water pump.
            Requirements: prevent water hammer, supply authority limits starting current to 100A.
          </p>
          <p>Motor data:</p>
          ...
          <p>
            <strong>Scenario:</strong> HVAC plant room with 3 × 22kW motors. Can they all start DOL
            on a 200kVA transformer with 5% impedance?
          </p>
          <p>Motor data (each):</p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Star-delta current reduction: <strong>1/3 of DOL</strong>
            </li>
            <li>
              Star-delta torque reduction: <strong>1/3 of DOL</strong>
            </li>
            <li>
              Autotransformer reduction: <strong>(tap%)² of DOL</strong>
            </li>
            <li>
              Soft starter typical limit: <strong>2-4× FLC</strong>
            </li>
            <li>
              Maximum starting voltage drop: <strong>6%</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Wrong motor winding:</strong> Using star-delta with 400V star motor on 400V
                supply
              </li>
              <li>
                <strong>Premature transition:</strong> Star-delta timer set too short causing high
                spike
              </li>
              <li>
                <strong>Insufficient torque:</strong> Using star-delta for high-torque loads
              </li>
              <li>
                <strong>Ignoring soft stop:</strong> Not utilising soft stop for pump applications
              </li>
              <li>
                <strong>Under-sizing soft starter:</strong> Not accounting for starting duty cycle
              </li>
            </ul>
          }
