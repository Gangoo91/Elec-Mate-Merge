...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'part-l-u-value',
    question:
      'What is the Part L 2021 limiting (maximum) U-value for external walls in new dwellings?',
    options: ['0.35 W/m²K', '0.18 W/m²K', '0.15 W/m²K', '0.26 W/m²K'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['100-200 MN.s/g.m', '5 MN.s/g.m', '45-60 MN.s/g.m', '1500 MN.s/g.m'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['0.25 W/m²K', '0.18 W/m²K', '0.11 W/m²K', '0.15 W/m²K'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['0.15 W/m²K', '0.25 W/m²K', '0.05 W/m²K', '0.08 W/m²K'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Parts L and O are the dominant fabric-performance regulators. As HNC engineer you
              balance them: a more airtight, heavily insulated envelope (Part L) can push the
              building toward overheating (Part O) — the design must satisfy both. Cite both
              Approved Documents in the fabric performance summary.
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Surface:</strong> Internal surfaces - cold surfaces, high humidity. Prevent
              with insulation, ventilation, heating
            </li>
            <li>
              <strong>Interstitial:</strong> Within construction - vapour reaching cold zone.
              Prevent with VCL on warm side
            </li>
            <li>
              <strong>Reverse:</strong> Cold side of VCL - summer drying inward. Prevent with
              variable permeability membranes
            </li>
          </ul>
          <p>
            <strong>Typical internal conditions:</strong> Occupied buildings typically have
            temperature 20-22°C, RH 40-60% (higher in kitchens/bathrooms). At 20°C and 50% RH, dew
            point is approximately 9°C. Any surface below 9°C will experience condensation.
          </p>
          <p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Temperature profile:</strong> Calculated from layer resistances and boundary
              conditions
            </li>
            <li>
          ...
          <p>
            <strong>
              Vapour resistance of common materials (vapour resistivity / typical resistance):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            should be at least 5× that on cold side to minimise interstitial condensation risk. This
            ensures most moisture vapour is blocked before reaching the dew point zone within the
            construction.
          </p>
          <p>
        ...
        >
          ...
          <p>
            <strong>
              Thermal bridge heat loss (Psi-value, default ψ / good practice ψ in W/mK):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            average U-value. Part L default is 0.15 W/m²K; well-detailed buildings achieve 0.05-0.08
            W/m²K.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Part L (Conservation of fuel and power) sets minimum fabric standards and overall energy
            targets. Part O (Overheating) ensures that high insulation and airtightness don't cause
            summer discomfort. Designs must satisfy both simultaneously.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Glazing trade-off:</strong> Large south windows aid solar gain (Part L) but
              risk overheating (Part O)
            </li>
            <li>
            ...
            <li>
              <strong>Thermal mass:</strong> Exposed mass helps Part O but requires architectural
              coordination
            </li>
          </ul>
          <p>
            <strong>Future proofing:</strong> Consider Part O assessment with future weather files
            (2050s) to ensure homes remain comfortable as climate warms. Adaptation measures may be
            needed.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Example 1 - Dew point calculation:</strong> Room air is at 20°C and 50% RH. What
            is the minimum surface temperature to avoid condensation?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 2 - Temperature factor:</strong> At a window reveal, surface temperature
            is 12°C when internal air is 20°C and external is -5°C. Calculate fRsi and assess mould
            risk.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>FAIL:</strong> fRsi = 0.68 &lt; 0.75 required for dwellings
            </li>
          ...
          <p>
            ...
            junctions totalling 80m with ψ = 0.12 W/mK, and total envelope area 300m². Calculate the
          ...
          <p>
            <strong>Example 4 - Wall U-value check:</strong> A cavity wall has U-value 0.24 W/m²K.
            Does it meet Part L 2021 for a new dwelling?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Part L limiting U-value for walls = 0.26 W/m²K</li>
            <li>Part L notional building value = 0.18 W/m²K</li>
            <li>
              0.24 &lt; 0.26 → <strong>PASS limiting requirement</strong>
            </li>
        ...
        <Scenario
          ...
          situation={
            <>
              A Victorian solid-brick terrace is having internal wall insulation (IWI) fitted under
              a Cat-A refurb. The contractor proposes 60 mm PIR boards behind a vapour-permeable
              plaster finish, no separate VCL. You are asked to verify the build-up against
              interstitial condensation risk.
            </>
          }
          whatToDo={
            <>
              Plot the temperature profile through the build-up at design winter conditions (-3 °C
              external, 21 °C internal, 50% RH internal). Plot the vapour pressure profile and the
              saturation vapour pressure curve. Where the two cross, condensation risk exists. If
              the cross is inside the PIR layer or at the brick-PIR interface, recommend either: (a)
              reducing internal RH via MVHR; (b) switching to vapour-open wood-fibre insulation that
              can buffer; or (c) adding an intelligent VCL with variable Sd-value.
            </>
          }
          whyItMatters={
            <>
              Solid-wall IWI without proper hygrothermal design causes hidden interstitial
              condensation, slow timber rot in floor joists embedded in the external wall, and mould
              growth on cold spots. Damage often appears years after handover — long after defects
              liability has expired, but well within the 15-year Building Safety Act liability
              window.
            </>
          }
        />
