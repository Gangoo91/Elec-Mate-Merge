...
const DESCRIPTION =
  'Essential tools and equipment for safe electrical isolation procedures including lock-off kits, voltage testers, and proving units.';
  ...
  const quizQuestions = [
    {
      ...
      options: ['Multimeter', 'Proving unit', 'Oscilloscope', 'Clamp meter'],
      correctAnswer: 1,
      explanation:
        'A proving unit is a battery-powered device that provides a known voltage to test that your voltage tester is working before and after use.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        "Multimeters don't meet GS38 safety standards for proving dead circuits. They have exposed metal parts and aren't designed for this safety-critical task.",
    },
    {
      id: 3,
      ...
      correctAnswer: 1,
      explanation:
        'Lock-off devices prevent others from accidentally switching circuits back on while work is in progress, preventing serious injury or death.',
    },
    {
      id: 4,
      question: 'What standard should your voltage tester meet?',
      options: ['BS 7671', 'GS38', 'IEC 60364', 'BS EN 61010'],
      correctAnswer: 1,
      explanation:
        'GS38 is the UK standard for electrical test equipment safety, ensuring probes have insulated leads and meet safety requirements for proving dead.',
    },
    {
      id: 5,
      ...
      correctAnswer: 0,
      explanation:
        "True. You must test your voltage tester on a proving unit both before and after testing to ensure it's working correctly throughout the process.",
    },
    {
      id: 6,
      ...
      correctAnswer: 1,
      explanation:
        'GS38 requires a maximum of 4mm exposed metal at the probe tip to reduce the risk of accidental contact with live parts.',
    },
    {
      id: 7,
      ...
      correctAnswer: 2,
      explanation:
        "Replace proving units when the battery is low, it fails calibration, or doesn't provide accurate known voltage - reliability is critical for safety.",
    },
    {
      id: 8,
      ...
      correctAnswer: 2,
      explanation:
        'Always use the correct lock-off device for each isolator type. Improvised solutions like tape are not acceptable for safety-critical isolation.',
    },
    {
      id: 9,
      question: 'How often should isolation equipment be visually inspected?',
      options: ['Once a year', 'Before each use', 'Once a month', 'Only when it appears damaged'],
      correctAnswer: 1,
      explanation:
        'Visual inspection before each use is essential - check for damaged leads, cracked insulation, bent probes, and secure connections every time.',
    },
    {
      id: 10,
      ...
      correctAnswer: 2,
      explanation:
        "Complete isolation tags should include the electrician's name, date, time, nature of work, and contact details for emergencies or questions.",
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-foreground">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Lock-off kit:</strong> Prevents accidental re-energising during work.
                </li>
                <li>
                  <strong>Voltage tester:</strong> GS38-compliant device to prove circuits dead.
                </li>
                <li>
                  <strong>Proving unit:</strong> Tests your tester before and after use.
                </li>
                <li>
                  <strong>Warning labels:</strong> Alert others to work in progress.
                </li>
                <li>
                  <strong>Never substitute:</strong> Each tool has a specific safety purpose.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Missing lock-off, using multimeters, untested testers, no
                  warning signs.
                </li>
                <li>
                  <strong>Use:</strong> Complete isolation kit, GS38 testers,
                  prove-before-prove-after sequence.
                </li>
                <li>
                  <strong>Apply:</strong> Full equipment checklist every isolation.
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="mb-8 border-l-4 border-elec-yellow p-6 bg-card rounded-lg">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-foreground">
              Essential Equipment for Safe Isolation
            </h2>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-elec-yellow/5 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <p className="font-medium text-blue-800 dark:text-white mb-3">
                To carry out safe isolation correctly, electricians need the right tools and
                equipment. Each item plays a vital role in keeping you and others protected from
                electric shock and accidental energising.
              </p>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-red-800 dark:text-red-200 mb-2">
                    Important: Why Not Multimeters?
                  </p>
                  <p className="text-red-700 dark:text-elec-yellow text-sm">
                    Multimeters are not suitable for proving dead circuits because they don't meet
                    GS38 safety standards and have exposed metal parts that could be dangerous.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-muted/50 border border-border rounded-lg p-4">
              <ul className="space-y-3 text-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Insulated test leads</strong> with finger barriers or shrouded probes
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-4 w-4 text-elec-yellow mt-1 flex-shrink-0" />
                  <span>
                    <strong>Maximum 4mm exposed tip</strong> on test probes
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-4 w-4 text-elec-yellow mt-1 flex-shrink-0" />
                  <span>
                    <strong>Appropriate voltage rating</strong> for the system being tested
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-4 w-4 text-elec-yellow mt-1 flex-shrink-0" />
                  <span>
                    <strong>Clear indication</strong> when voltage is present
                  </span>
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-6">
                <div className="border-b border-border pb-4">
                  <h4 className="font-semibold mb-2 text-foreground">
                    Problem: "My voltage tester keeps giving inconsistent readings"
                  </h4>
                ...
                <div className="border-b border-border pb-4">
                  <h4 className="font-semibold mb-2 text-foreground">
                    Problem: "Lock-off device won't fit the isolator properly"
                  </h4>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <h5 className="font-medium text-white/80 mb-1">Likely Causes:</h5>
                ...
                <div>
                  <h4 className="font-semibold mb-2 text-foreground">
                    Problem: "Proving unit won't turn on when I need it"
                  </h4>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <h5 className="font-medium text-white/80 mb-1">Likely Causes:</h5>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-muted/50 border border-border rounded-lg p-4">
              <div className="space-y-6">
                <div className="border-b border-border pb-4">
                  <h4 className="font-semibold mb-2 text-foreground">
                    Case Study 1: The Faulty Tester
                  </h4>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <div className="mt-3 p-2 bg-elec-yellow/10 bg-elec-yellow/10 rounded text-sm">
                        <strong className="text-elec-yellow dark:text-elec-yellow">Result:</strong>
                        <span className="text-elec-yellow dark:text-elec-yellow">
                          {' '}
                          Site implemented mandatory proving unit checks - no incidents since.
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="border-b border-border pb-4">
                  <h4 className="font-semibold mb-2 text-foreground">
                    Case Study 2: The Missing Lock-off
                  </h4>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <h5 className="font-medium text-white/80 mb-2">The Incident:</h5>
                    ...
                    <div>
                      ...
                      <div className="mt-3 p-2 bg-amber-100 dark:bg-amber-900/30 rounded text-sm">
                        ...
                        <span className="text-amber-700 dark:text-amber-300">
                          {' '}
                          Minor shock, full recovery. Company now provides lock-off training to all
                          trades.
                        </span>
                      </div>
                    </div>
                ...
                <div>
                  <h4 className="font-semibold mb-2 text-foreground">
                    Case Study 3: The Equipment That Saved Lives
                  </h4>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <h5 className="font-medium text-white/80 mb-2">The Incident:</h5>
                    ...
                    <div>
                      ...
                      <div className="mt-3 p-2 bg-elec-yellow bg-elec-yellow rounded text-sm">
                        ...
                        <span className="text-white">
                          {' '}
                          Zero incidents. Project completed safely and on time.
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <ul className="space-y-2 text-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm">
                    Complete isolation kit includes lock-off devices, GS38 voltage tester, proving
                    unit, and warning labels
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-4 w-4 text-elec-yellow mt-1 flex-shrink-0" />
                  <span className="text-sm">
                    Always test your tester before and after use with a proving unit
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-4 w-4 text-elec-yellow mt-1 flex-shrink-0" />
                  <span className="text-sm">
                    Multimeters are not suitable for proving dead circuits in isolation procedures
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-4 w-4 text-elec-yellow mt-1 flex-shrink-0" />
                  <span className="text-sm">
                    Regular equipment inspection and maintenance is essential for safety
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-4 w-4 text-elec-yellow mt-1 flex-shrink-0" />
                  <span className="text-sm">
                    GS38 compliance ensures test equipment meets required safety standards
                  </span>
                </li>
              </ul>
            </div>
