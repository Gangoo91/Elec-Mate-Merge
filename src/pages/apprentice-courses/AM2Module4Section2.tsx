...
const AM2Module4Section2 = () => {
  ...
  const quickCheckQuestions: Array<{
  ...
  }> = [
    {
      ...
      options: ['1-2 mm maximum', '2-4 mm maximum', 'Any length is acceptable', '5-10 mm maximum'],
      correctIndex: 1,
      explanation:
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['5-8 mm maximum', '1 mm maximum', '2-4 mm maximum', '10 mm maximum'],
      correctAnswer: 2,
      explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/am2/module4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          In AM2, you will use a range of test instruments (multifunction testers, voltage
          indicators, continuity testers). These must be used safely and correctly in line with HSE
          GS38 and BS 7671 requirements. Unsafe use of test equipment can cause serious injury and
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              automatic AM2 failure. HSE GS38 requirements protect lives and must be followed
              exactly.
            </>
          }
          doInstead={
        ...
        >
          <p>
            <strong>Test Probes Must Be:</strong> Shrouded tips, with only 2-4 mm of metal exposed.
            Finger barriers or insulated handles. In good condition with no damage.
          </p>
          <p>
        ...
        >
          <p>
            ...
            which circuit or supply needs to be made safe for work. Use circuit charts, labels, and
            visual inspection. AM2 Actions: Check circuit labels and documentation. Verify circuit
            routes and connections. Confirm the scope of isolation required. Identify all sources of
            supply.
          </p>
          <p>
          ...
          <p>
            ...
            lock-off device if available. Remove fuses and keep them with you. Place warning notices
            if required. Ensure others cannot accidentally re-energise.
          </p>
          <p>
          ...
          <p>
            <strong>Safe Isolation Complete — Now Safe to Work.</strong> Only after completing ALL 6
            steps in sequence is it safe to begin work on the isolated circuit. The circuit is now
            proven dead and isolated. Maintain the isolation throughout your work, and follow the
            same proving sequence before re-energising.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The reg literally says continuity <strong>before</strong> loop impedance — that's why
              you can't reach for the Zs button until R1+R2 has come back clean. If the CPC has a
              break, your Zs reading would be meaningless (and you'd be passing fault current
              through your test leads in the wrong place). Continuity is the gate that opens the
        ...
        >
          <p>
            ...
            resistance 500V DC, continuity low resistance). Confirm leads are in the correct sockets
            before testing. Check lead condition and probe compliance. Zero leads before continuity
            resistance tests.
          </p>
          <p>
          ...
          <p>
            ...
            connecting to circuit. Use appropriate test voltage for the circuit being tested. Never
            force connections — use appropriate test accessories. Switch back to voltage mode when
            test complete. Explain your actions to the assessor as you work.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Approved Voltage Indicators — Two-Pole Voltage Indicators:</strong> Most common
            in NET AM2 centres. LED or LCD display. GS38 compliant probes essential. Battery or
          ...
          <p>
            <strong>Standard Proving Units:</strong> Usually 230V AC output. Self-contained battery
            operation. Clear indication of output status. Regular functionality checks required.
          </p>
          <p>
            <strong>Alternative Proving Sources:</strong> Known live socket outlets. Designated test
            points. Distribution board indicators. Must be reliable and safe.
          </p>
          <p>
          ...
          <p>
            <strong>NET AM2 Critical: Missing any step = Automatic Failure.</strong> Assessors will
            specifically watch for the complete sequence. Shortcuts or assumptions about equipment
            functionality are not acceptable.
          </p>
          <p>
            <strong>Common Proving Errors — Equipment Issues:</strong> Using non-GS38 compliant
            indicators. Assuming proving unit is working. Not checking battery levels. Using damaged
            proving units.
          </p>
          <p>
            <strong>Common Proving Errors — Procedure Failures:</strong> Skipping initial or final
            prove. Not testing all conductor combinations. Rushing through the sequence. Failing to
          ...
          <VideoCard
            ...
            caption={
              <>
                ...
                disconnect the main earth, test L to incoming earth. Your measured Ze feeds the PFC
                calculation below (PFC = U0 / Ze) — the next thing the assessor expects you to
                record on the EIC.
              </>
            }
          />
        ...
        <div className="my-6">
          ...
          <p className="text-xs sm:text-sm text-white/80 mb-3">
            Most multifunction testers display PFC alongside Ze. Check the maths with Ohm's Law: PFC
            = U0 / Ze. Worked: U0 = 230 V, Ze = 0.35 Ω (typical TN-C-S declared) → PFC ≈ 657 A at
            the origin. Enter your measured Ze as resistance R and U0 = 230 V to read the
        ...
        >
          ...
          <p>
            <strong>Assessment Excellence:</strong> Following GN3 procedures exactly. Demonstrating
            rather than describing. Managing time effectively. Maintaining professionalism
            throughout.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Before You Start:</strong> Inspect your kit first. Check leads, fuses, and probe
            tips. Verify calibration dates. Plan your testing sequence.
          </p>
          <p>
            <strong>During Testing:</strong> Always use proving unit or known live source. Hold
            probes safely behind finger barriers. Explain procedures as you work. Allow readings to
            stabilise.
          </p>
          <p>
            <strong>After Testing:</strong> Reset to safe mode (voltage). Switch tester off safely.
            Store leads properly. Record all results accurately.
          </p>
          <p>
            <strong>Key Success Tips:</strong> Practice test routines — make proving tester and lead
            checks a habit. Never rush — methodical and safe is better than fast. If readings seem
            wrong, re-check settings and prove the tester. Communicate with the assessor — explain
        ...
        >
          ...
          <p>
            <strong>Example 2: Forgot Re-proving.</strong> Candidate forgot to re-prove tester after
            safe isolation sequence. Automatic Fail. Lesson: The proving sequence is Prove — Test —
            Re-prove. All three steps are mandatory.
          </p>
          <p>
            <strong>Example 3: Proper Procedure.</strong> Candidate zeroed continuity leads before
            testing and explained procedure to assessor. Full Marks. Lesson: Demonstrating knowledge
            through proper procedure and clear communication earns top marks.
          </p>
          <p>
            <strong>Example 4: Real-Life Consequence.</strong> In real life, an electrician used a
            damaged probe, which arced and caused serious burns. Same unsafe practice in AM2 = fail.
        ...
        >
          <p>
            Safe use of test instruments is non-negotiable in AM2 — GS38 compliance protects lives.
          </p>
          <p>Probes must have shrouded tips (2-4 mm exposed), fused leads, and no damage.</p>
          <p>Proving sequence is mandatory: Prove — Test — Re-prove (skipping any step = fail).</p>
          ...
          <p>
            ...
            we'll cover the specific testing procedures and measurement techniques required for AM2
            assessment success.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              the point of work — all dead, good. You return to re-prove and the proving unit's LED
              won't light. Battery indicator is fine on the voltage indicator. Five minutes left in
              this test block.
            </>
          }
          whatToDo={
            <>
              Don't skip the re-prove and don't crack on. Tell the assessor what you've found. Try a
              known live source instead — a working socket-outlet on a different circuit, or a
              designated test point at the rig's distribution board. If the indicator shows voltage
              there, it has stayed functional and your "dead" reading at the point of work stands.
              If it doesn't, you've just discovered the indicator failed during the test —
              re-isolate, swap to a backup tester, and run the whole proving sequence again.
            </>
          }
          whyItMatters={
            <>
              The re-prove step exists for exactly this scenario. A tester that goes faulty between
              Step 4 and Step 6 would have given you a false "dead" reading at the point of work.
              Skipping the re-prove because the proving unit looks broken means you cannot rule out
              a tester failure — and you'd be cracking on into a circuit you haven't actually proved
              dead.
            </>
          }
        />
        ...
        <FAQ
          items={[
            ...
            {
              question: 'What if my leads have a small nick in the insulation but still work fine?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Test Sequence</div>
          </button>
          <button
