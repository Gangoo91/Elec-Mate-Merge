...
const DESCRIPTION =
  'Understand transformer theory, electromagnetic induction, turns ratio, voltage and current transformation, losses, efficiency, types, and maintenance testing procedures for electrical maintenance technicians.';
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "A transformer operates on Faraday's law of electromagnetic induction. An alternating current in the primary winding creates a changing magnetic flux in the core, which induces an EMF in the secondary winding. The two windings are magnetically coupled but electrically isolated.",
  },
  {
    id: 2,
    question:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A tap changer adjusts the turns ratio by connecting to different tapping points on the winding, thereby changing the output voltage. On-load tap changers (OLTCs) adjust automatically without interrupting supply. Off-load tap changers require the transformer to be de-energised before adjustment.',
  },
  {
    id: 6,
    question:
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              (the primary winding), it creates a changing magnetic field. If a second coil (the
              secondary winding) is placed within this changing magnetic field, an electromotive
              force (EMF) is induced in the secondary coil. The two windings share a common magnetic
              core but have no direct electrical connection — they are said to be magnetically
              coupled.
            </p>
            <p>
              Faraday's law of electromagnetic induction states that the EMF induced in a coil is
              proportional to the rate of change of magnetic flux linkage through the coil. In a
