...
const quickCheckQuestions = [
  {
    ...
    options: ['4 hours', '3 hours', '1 hour', '2 hours'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['72 hours', '24 hours', '48 hours', '12 hours'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['12V DC', '48V DC', '24V DC', '230V AC'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Standby (offline)', 'Online double conversion', 'Line-interactive', 'Rotary UPS'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['1.2Wh', '14.4Wh', '7.2Wh', '43.2Wh'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['1Ah at 6V', '2Ah at 6V', 'At least 3Ah at 6V', '18Ah at 6V'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['35 hours', '48 hours', '12 hours', '24 hours'],
    correctAnswer: 0,
    explanation:
...
const HNCModule3Section1_7 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 1 · Subsection 7"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The 24 h + 30 min duty cycle is a DC capacity calculation: I_quiescent × 24 h +
              I_alarm × 0.5 h, multiplied by an end-of-life and ambient derating factor (often
              ×1.25). The result is the minimum Ah rating of the sealed lead-acid or LiFePO₄ battery
              in the panel.
            </>
          }
        ...
        <ConceptBlock title="Emergency Lighting Systems">
          ...
          <p>
            <strong>C = P × t / V × 1.25</strong> — Where C = capacity (Ah), P = power (W), t = time
            (h), V = voltage (V), 1.25 = ageing factor.
          </p>
        ...
        <ConceptBlock title="Fire Alarm Systems">
          <p>
            Fire detection and alarm systems require reliable DC power for continuous monitoring. BS
            5839-1 mandates specific standby battery requirements ensuring operation during mains
            failure.
          </p>
        ...
        <ConceptBlock title="Standby Power Systems">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Online double conversion:</strong> Zero transfer, complete isolation, highest
              protection
            </li>
          </ul>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Energy required = Power × Time = 5W × 3h = <strong>15Wh</strong>
            </li>
            <li>Battery capacity at 3.6V: C = E / V = 15Wh / 3.6V = 4.17Ah</li>
            <li>
              With 25% ageing factor: C<sub>design</sub> = 4.17 × 1.25 ={' '}
              <strong>5.2Ah minimum</strong>
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Standby (24h): E<sub>standby</sub> = 0.18A × 24h = 4.32Ah
            </li>
            <li>
              Alarm (30 min): E<sub>alarm</sub> = 2.5A × 0.5h = 1.25Ah
            </li>
            <li>
              Total required: E<sub>total</sub> = 4.32 + 1.25 = 5.57Ah
            </li>
            <li>
              With 25% margin: C<sub>design</sub> = 5.57 × 1.25 = <strong>6.96Ah</strong>
            </li>
          ...
          <p>
            <strong>Question:</strong> A 24V DC sensor circuit runs 80m using 0.75mm² cable. Current
            is 40mA. Check voltage drop is within 5%.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Cable resistance (0.75mm²) = 24.5mΩ/m</li>
            <li>Loop resistance: R = 2 × 80m × 24.5mΩ/m = 3.92Ω</li>
            <li>
              Voltage drop: V<sub>drop</sub> = I × R = 0.04A × 3.92Ω = <strong>0.157V</strong>
            </li>
            <li>
              As percentage: (0.157 / 24) × 100 = <strong>0.65%</strong>
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Maximum length with 1.5mm² cable: L<sub>max</sub> = 40Ω / (2 × 12.1mΩ/m) ={' '}
              <strong>1653m</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              fire-resistant cable on fire alarm circuits. Undersizing generator starting batteries.
            </>
          }
          doInstead={
            <>
              Always ×2 for go and return. Apply a 25% ageing margin. Verify actuator AC/DC rating.
              Use FP200/MICC on detection and sounder circuits. Size starting batteries for the high
              CCA rating per generator class.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A new BS 5839-1 Category L2 fire-alarm system has a quiescent panel current of 250 mA
              and a full-alarm current (sounders + beacons + interfaces) of 2.4 A. The system
              requires the standard 24 h standby + 30 min alarm duty.
            </>
          }
          whatToDo={
            <>
              Compute the energy demand: 0.250 A × 24 h = 6.0 Ah quiescent + 2.4 A × 0.5 h = 1.2 Ah
              alarm = 7.2 Ah total. Apply BS 5839-1 derating (typically ×1.25 for end-of-life
              capacity loss) → 9.0 Ah minimum. Pick the next standard capacity above that —
              typically a pair of 12 V 12 Ah sealed lead-acid batteries in series. Document the
              calculation in the commissioning certificate and re-check at every annual service.
            </>
          }
          whyItMatters={
            <>
              A fire-alarm panel that drops out before the 24 h + 30 min duty is up is a life-safety
              failure and a Building Regulations non-compliance. The Ah calculation is a direct
              application of DC circuit theory — current × time × derating — and your name is on the
              cert.
            </>
          }
        />
